...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mirroring=mirroring, mstCurCfgState=mstCurCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoIndex=stpInfoIndex, stpInfoPortRole=stpInfoPortRole, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTable=stgCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortTable=cistInfoPortTable, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCfg=mstCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoTable=portTeamInfoTable, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortTable=stpInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsStpIndex=stgStatsStpIndex, mstGeneralCfg=mstGeneralCfg, vlanInfoTableEntry=vlanInfoTableEntry, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgState=stgNewCfgState, fdbSrcPort=fdbSrcPort, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfo=lacpInfo, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoRootPort=stpInfoRootPort, vlanInfoTable=vlanInfoTable, mirrPortMirr=mirrPortMirr, stpInfoPortState=stpInfoPortState, vlanInfoBwmContract=vlanInfoBwmContract, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Oper=layer2Oper, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfo=portTeamInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbTable=fdbTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsLookups=fdbStatsLookups, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgStg=vlanCurCfgStg, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortSelected=lacpInfoPortSelected, layer2=layer2, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgState=stgCurCfgState, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbLearnedPort=fdbLearnedPort, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTable=stpInfoTable, layer2Configs=layer2Configs, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoRootCost=stpInfoRootCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbVlan=fdbVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgState=mstNewCfgState, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, vlanInfoId=vlanInfoId, stgCurCfgAgingTime=stgCurCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, fdbClear=fdbClear, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortRole=cistInfoPortRole, stpStats=stpStats, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoState=portTeamInfoState, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoJumbo=vlanInfoJumbo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStats=fdbStats, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbMacAddr=fdbMacAddr, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, vlanInfo=vlanInfo, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfo=cistInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfo=stpInfo, mstCistBridgeCfg=mstCistBridgeCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkgroup=trunkgroup, stgCfg=stgCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistRootPort=cistRootPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbEntry=fdbEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbState=fdbState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortState=cistInfoPortState, cistGeneralInfo=cistGeneralInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, BridgeId=BridgeId, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoStatus=vlanInfoStatus, mstCistCfg=mstCistCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, PYSNMP_MODULE_ID=layer2, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCfg=portTeamCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoName=vlanInfoName, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, layer2Info=layer2Info, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortPriority=cistInfoPortPriority, fdbStatsDeletes=fdbStatsDeletes)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbInfo=fdbInfo, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortIndex=stgStatsPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, vlan=vlan, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgTable=stgNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoPorts=vlanInfoPorts, lacp=lacp, cistRootPathCost=cistRootPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortState=stgNewCfgPortState, layer2Stats=layer2Stats, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgDelete=vlanNewCfgDelete, cistRoot=cistRoot, lacpCurPortState=lacpCurPortState, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortLink=stgNewCfgPortLink)
