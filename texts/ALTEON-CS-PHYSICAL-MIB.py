...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistBridgeMaxAge=cistBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, lacp=lacp, stpInfoHelloTime=stpInfoHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, fdbEntry=fdbEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, stpInfoPortTable=stpInfoPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, layer2=layer2, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpStats=stpStats, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, layer2Oper=layer2Oper, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgState=portTeamNewCfgState, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbSrcPort=fdbSrcPort, vlanInfoLearn=vlanInfoLearn, stpInfo=stpInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTable=portTeamInfoTable, stgNewCfgIndex=stgNewCfgIndex, mstCfg=mstCfg, mstCistCfg=mstCistCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortState=lacpCurPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbState=fdbState, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgState=vlanCurCfgState, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgState=mstNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, cistGeneralInfo=cistGeneralInfo, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoIndex=stpInfoIndex, portTeamCfg=portTeamCfg, fdbMacAddr=fdbMacAddr, stpInfoPortIndex=stpInfoPortIndex, trunkgroup=trunkgroup, stpInfoPortState=stpInfoPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mirrPortMirr=mirrPortMirr, vlanInfoName=vlanInfoName, mstCurCfgState=mstCurCfgState, cistRootPort=cistRootPort, vlanInfoTable=vlanInfoTable, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, PYSNMP_MODULE_ID=layer2, layer2Configs=layer2Configs, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgStg=vlanNewCfgStg, vlanInfoId=vlanInfoId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoPorts=vlanInfoPorts, vlanNewCfgDelete=vlanNewCfgDelete, fdbStats=fdbStats, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbRefSps=fdbRefSps, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfo=vlanInfo, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfo=portTeamInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRootPathCost=cistRootPathCost, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpInfo=lacpInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, cistInfo=cistInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgTable=stgCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoIndex=portTeamInfoIndex, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanMaxEnt=vlanMaxEnt, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgState=stgNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgState=vlanNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, layer2Stats=layer2Stats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortTable=cistInfoPortTable, fdbClear=fdbClear, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, fdbTable=fdbTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortTable=stgStatsPortTable, BridgeId=BridgeId, vlanNewCfgTable=vlanNewCfgTable, cistRegionalRoot=cistRegionalRoot, stgCurCfgState=stgCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTable=stpInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoPorts=portTeamInfoPorts, vlan=vlan, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoRootPort=stpInfoRootPort, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCfg=stgCfg, lacpInfoPortIndex=lacpInfoPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortRole=stpInfoPortRole, lacpNewPortState=lacpNewPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTable=stgNewCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTable=portTeamNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistDefaultCfg=mstCistDefaultCfg, fdbInfo=fdbInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, layer2Info=layer2Info, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortState=cistInfoPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbVlan=fdbVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, cistRoot=cistRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry)
