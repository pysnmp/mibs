...
Counter32, Counter64, TimeTicks, NotificationType, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Bits, Gauge32, iso, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Bits", "Gauge32", "iso", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortEdge=stgNewCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortState=cistInfoPortState, stgNewCfgState=stgNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, layer2=layer2, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortState=lacpCurPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbState=fdbState, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortState=stpInfoPortState, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoIndex=stpInfoIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistRootPort=cistRootPort, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCfg=stgCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbTable=fdbTable, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgRegionName=mstCurCfgRegionName, mirroring=mirroring, stgNewCfgPriority=stgNewCfgPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRootPathCost=cistRootPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoState=portTeamInfoState, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPriority=stgCurCfgPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTable=stpInfoTable, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, vlanInfoName=vlanInfoName, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgState=vlanNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfo=lacpInfo, stpInfoRootPort=stpInfoRootPort, cistInfo=cistInfo, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRoot=cistRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoPorts=portTeamInfoPorts, vlanMaxEnt=vlanMaxEnt, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgState=portTeamNewCfgState, stpInfo=stpInfo, fdbLearnedPort=fdbLearnedPort, layer2Info=layer2Info, lacp=lacp, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortTable=stpInfoPortTable, stpStats=stpStats, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgTable=stgNewCfgTable, fdbStatsFindFails=fdbStatsFindFails, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlan=vlan, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoTable=portTeamInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistDefaultCfg=mstCistDefaultCfg, trunkgroup=trunkgroup, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistGeneralInfo=cistGeneralInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanInfoPorts=vlanInfoPorts, fdbStatsFinds=fdbStatsFinds, stpInfoHelloTime=stpInfoHelloTime, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsHiwat=fdbStatsHiwat, fdbInfo=fdbInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRegionalPathCost=cistRegionalPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbClear=fdbClear, vlanInfoId=vlanInfoId, fdbStatsCreates=fdbStatsCreates, layer2Configs=layer2Configs, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoTopChanges=stpInfoTopChanges, vlanInfoStatus=vlanInfoStatus, fdbEntry=fdbEntry, lacpNewPortState=lacpNewPortState, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortTable=stgStatsPortTable, fdbRefSps=fdbRefSps, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortTable=cistInfoPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbVlan=fdbVlan, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, fdbStatsCurrent=fdbStatsCurrent, fdbMacAddr=fdbMacAddr, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoRootCost=stpInfoRootCost, fdbStats=fdbStats, layer2Stats=layer2Stats, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoLearn=vlanInfoLearn, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2Oper=layer2Oper, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsOverflows=fdbStatsOverflows, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgState=portTeamCurCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortPriority=cistInfoPortPriority, vlanInfo=vlanInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, PYSNMP_MODULE_ID=layer2, portTeamInfoIndex=portTeamInfoIndex, fdbStatsLookups=fdbStatsLookups, mstCfg=mstCfg, stgStatsStpIndex=stgStatsStpIndex, mstGeneralCfg=mstGeneralCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCfg=mstCistCfg, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoTable=vlanInfoTable, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortRole=cistInfoPortRole, mstNewCfgState=mstNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, BridgeId=BridgeId, mirrPortMirr=mirrPortMirr, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
