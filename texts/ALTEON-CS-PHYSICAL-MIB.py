...
Counter64, NotificationType, Unsigned32, Bits, Counter32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, IpAddress, Gauge32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Unsigned32", "Bits", "Counter32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgStatsPortTable=stgStatsPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRoot=cistRoot, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortState=lacpCurPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbRefSps=fdbRefSps, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCfg=stgCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, fdbStatsCreates=fdbStatsCreates, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgState=vlanCurCfgState, stpInfoRootPort=stpInfoRootPort, mstCistCfg=mstCistCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbState=fdbState, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbEntry=fdbEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsOverflows=fdbStatsOverflows, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortState=cistInfoPortState, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoName=vlanInfoName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbSrcPort=fdbSrcPort, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgPorts=vlanNewCfgPorts, fdbLearnedPort=fdbLearnedPort, BridgeId=BridgeId, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCfg=portTeamCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2Info=layer2Info, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortState=stgCurCfgPortState, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoIndex=stpInfoIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirroring=mirroring, stgCurCfgTable=stgCurCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistGeneralInfo=cistGeneralInfo, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, layer2=layer2, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, cistRootPort=cistRootPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgState=mstCurCfgState, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoHelloTime=stpInfoHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistRegionalRoot=cistRegionalRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfo=vlanInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbClear=fdbClear, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoTable=vlanInfoTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, cistInfoPortTable=cistInfoPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, mstCistDefaultCfg=mstCistDefaultCfg, cistRootPathCost=cistRootPathCost, lacpNewPortState=lacpNewPortState, stpInfo=stpInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsHiwat=fdbStatsHiwat, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTable=stpInfoTable, stpStats=stpStats, stgNewCfgState=stgNewCfgState, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbVlan=fdbVlan, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgStpMode=mstCurCfgStpMode, mirrPortMirr=mirrPortMirr, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfo=cistInfo, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkgroup=trunkgroup, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortState=stpInfoPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoId=vlanInfoId, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortRole=stpInfoPortRole, PYSNMP_MODULE_ID=layer2, lacp=lacp, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTable=portTeamInfoTable, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortRole=cistInfoPortRole, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfo=portTeamInfo, layer2Oper=layer2Oper, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCurCfgIndex=portTeamCurCfgIndex, layer2Stats=layer2Stats, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbTable=fdbTable, stgCurCfgState=stgCurCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStats=fdbStats, mstCfg=mstCfg, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Configs=layer2Configs, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoPorts=vlanInfoPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoLearn=vlanInfoLearn, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfo=lacpInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgState=mstNewCfgState, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsLookups=fdbStatsLookups, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstGeneralCfg=mstGeneralCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, stpInfoRootCost=stpInfoRootCost, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlan=vlan, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbInfo=fdbInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex)
