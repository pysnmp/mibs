...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2Configs=layer2Configs, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCfg=stgCfg, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfo=vlanInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgState=vlanCurCfgState, vlanInfoTable=vlanInfoTable, vlan=vlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mirroring=mirroring, fdbTable=fdbTable, fdbVlan=fdbVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanInfoName=vlanInfoName, stgNewCfgState=stgNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFindFails=fdbStatsFindFails, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrPortMirr=mirrPortMirr, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortRole=stpInfoPortRole, stgCurCfgState=stgCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsStpIndex=stgStatsStpIndex, trunkgroup=trunkgroup, stpInfoHoldTime=stpInfoHoldTime, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoStatus=vlanInfoStatus, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortRole=cistInfoPortRole, mstCfg=mstCfg, vlanCurCfgStg=vlanCurCfgStg, portTeamInfo=portTeamInfo, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoBwmContract=vlanInfoBwmContract, cistRootPort=cistRootPort, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2Oper=layer2Oper, mstNewCfgState=mstNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortState=cistInfoPortState, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgState=mstCurCfgState, fdbEntry=fdbEntry, fdbStatsFinds=fdbStatsFinds, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbSrcTrunk=fdbSrcTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStats=fdbStats, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstGeneralCfg=mstGeneralCfg, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, BridgeId=BridgeId, layer2Info=layer2Info, PYSNMP_MODULE_ID=layer2, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbInfo=fdbInfo, stpInfoPortTable=stpInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistRegionalRoot=cistRegionalRoot, fdbClear=fdbClear, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, layer2Stats=layer2Stats, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcPort=fdbSrcPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortIndex=cistInfoPortIndex, vlanInfoLearn=vlanInfoLearn, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCfg=portTeamCfg, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortTable=cistInfoPortTable, fdbStatsHiwat=fdbStatsHiwat, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoState=portTeamInfoState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbLearnedPort=fdbLearnedPort, stpStats=stpStats, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanMaxEnt=vlanMaxEnt, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCfg=mstCistCfg, portTeamInfoTable=portTeamInfoTable, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfo=lacpInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortTable=stgCurCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRoot=cistRoot, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortState=stgNewCfgPortState, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbRefSps=fdbRefSps, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoTable=stpInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacp=lacp, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTableEntry=portTeamInfoTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoId=vlanInfoId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortState=lacpNewPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, fdbState=fdbState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortTable=lacpInfoPortTable, stpInfo=stpInfo, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfo=cistInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewSystemPriority=lacpNewSystemPriority)
