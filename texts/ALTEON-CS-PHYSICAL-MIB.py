...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortCfgTableId=lacpNewPortCfgTableId, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, stpInfoRootPort=stpInfoRootPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPriority=stgCurCfgPriority, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoHelloTime=stpInfoHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbVlan=fdbVlan, stpInfoMaxAge=stpInfoMaxAge, lacpInfo=lacpInfo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbRefSps=fdbRefSps, portTeamNewCfgState=portTeamNewCfgState, cistRootPort=cistRootPort, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurPortState=lacpCurPortState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgTable=stgNewCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoName=vlanInfoName, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortTable=cistInfoPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCfg=stgCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsFinds=fdbStatsFinds, fdbTable=fdbTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgState=stgCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortState=lacpNewPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoLearn=vlanInfoLearn, mirrPortMirr=mirrPortMirr, stpStats=stpStats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgTable=stgCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, cistGeneralInfo=cistGeneralInfo, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistRootPathCost=cistRootPathCost, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoIndex=stpInfoIndex, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortState=cistInfoPortState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanMaxEnt=vlanMaxEnt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfo=vlanInfo, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfo=stpInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, layer2Stats=layer2Stats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalPathCost=cistRegionalPathCost, vlanInfoPorts=vlanInfoPorts, stpInfoRootCost=stpInfoRootCost, vlan=vlan, mstNewCfgState=mstNewCfgState, fdbEntry=fdbEntry, stpInfoTableEntry=stpInfoTableEntry, layer2Info=layer2Info, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoTable=stpInfoTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsCreates=fdbStatsCreates, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, BridgeId=BridgeId, cistRoot=cistRoot, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortRole=cistInfoPortRole, cistInfo=cistInfo, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoTable=portTeamInfoTable, layer2=layer2, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkgroup=trunkgroup, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbLearnedPort=fdbLearnedPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Configs=layer2Configs, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortTable=stpInfoPortTable, portTeamCfg=portTeamCfg, fdbSrcPort=fdbSrcPort, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStats=fdbStats, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, PYSNMP_MODULE_ID=layer2, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbInfo=fdbInfo, lacp=lacp, mstCfg=mstCfg, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbMacAddr=fdbMacAddr, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, vlanInfoTable=vlanInfoTable, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, portTeamInfo=portTeamInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoState=portTeamInfoState, fdbStatsLookups=fdbStatsLookups, fdbState=fdbState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortRole=stpInfoPortRole, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mirroring=mirroring, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCfg=mstCistCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortTable=stgStatsPortTable, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoId=vlanInfoId, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, mstGeneralCfg=mstGeneralCfg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgPorts=portTeamNewCfgPorts)
