...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortState=stpInfoPortState, vlan=vlan, fdbStatsFindFails=fdbStatsFindFails, fdbRefSps=fdbRefSps, cistRegionalRoot=cistRegionalRoot, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsHiwat=fdbStatsHiwat, PYSNMP_MODULE_ID=layer2, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCfg=mstCistCfg, mirrPortMirr=mirrPortMirr, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, cistRoot=cistRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCfg=portTeamCfg, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortEdge=stpInfoPortEdge, mirroring=mirroring, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTable=portTeamInfoTable, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgTable=vlanNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfo=vlanInfo, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, fdbVlan=fdbVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoStatus=vlanInfoStatus, vlanCurCfgState=vlanCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoJumbo=vlanInfoJumbo, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanMaxEnt=vlanMaxEnt, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, stgCfg=stgCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortIndex=stpInfoPortIndex, layer2Stats=layer2Stats, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortPriority=cistInfoPortPriority, stpStats=stpStats, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, fdbMacAddr=fdbMacAddr, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPort=cistRootPort, stpInfoPortRole=stpInfoPortRole, lacpCurPortState=lacpCurPortState, mstCistBridgeCfg=mstCistBridgeCfg, cistGeneralInfo=cistGeneralInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoState=portTeamInfoState, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbSrcPort=fdbSrcPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsFinds=fdbStatsFinds, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgAgingTime=stgNewCfgAgingTime, BridgeId=BridgeId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoId=vlanInfoId, vlanNewCfgStg=vlanNewCfgStg, fdbClear=fdbClear, fdbState=fdbState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoTable=stpInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoName=vlanInfoName, mstGeneralCfg=mstGeneralCfg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistRootPathCost=cistRootPathCost, vlanInfoLearn=vlanInfoLearn, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, layer2=layer2, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Info=layer2Info, fdbEntry=fdbEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsLookups=fdbStatsLookups, fdbTable=fdbTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgState=portTeamCurCfgState, fdbSrcTrunk=fdbSrcTrunk, fdbStatsCurrent=fdbStatsCurrent, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortTable=cistInfoPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgState=vlanNewCfgState, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfo=lacpInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoHoldTime=stpInfoHoldTime, mstCurCfgState=mstCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbInfo=fdbInfo, layer2Oper=layer2Oper, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgTable=stgCurCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortState=cistInfoPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoTable=vlanInfoTable, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgState=mstNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoIndex=stpInfoIndex, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacp=lacp, stgCurCfgPortIndex=stgCurCfgPortIndex, layer2Configs=layer2Configs, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfo=stpInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoRootPort=stpInfoRootPort, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStats=fdbStats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfo=cistInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCfg=mstCfg, portTeamInfoPorts=portTeamInfoPorts, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoPorts=vlanInfoPorts, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfo=portTeamInfo, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootCost=stpInfoRootCost, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbLearnedPort=fdbLearnedPort, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk)
