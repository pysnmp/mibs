...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgState=stgNewCfgState, layer2=layer2, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistRootPathCost=cistRootPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, PYSNMP_MODULE_ID=layer2, fdbInfo=fdbInfo, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbMacAddr=fdbMacAddr, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortState=lacpCurPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgTable=vlanCurCfgTable, stpStats=stpStats, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoJumbo=vlanInfoJumbo, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoLearn=vlanInfoLearn, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTable=stpInfoTable, cistBridgeMaxAge=cistBridgeMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCfg=portTeamCfg, stpInfoPortState=stpInfoPortState, cistRootPort=cistRootPort, cistRoot=cistRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, layer2Info=layer2Info, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortLinkType=cistInfoPortLinkType, BridgeId=BridgeId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfo=lacpInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCfg=mstCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgLearn=vlanNewCfgLearn, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfo=cistInfo, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTable=stgNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTable=portTeamInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortLink=stgNewCfgPortLink, layer2Stats=layer2Stats, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortState=lacpNewPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortTable=lacpInfoPortTable, fdbStatsHiwat=fdbStatsHiwat, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgState=mstCurCfgState, vlanInfoTable=vlanInfoTable, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortLinkType=stpInfoPortLinkType, fdbTable=fdbTable, stgStatsPortTable=stgStatsPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbClear=fdbClear, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlan=vlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, layer2Oper=layer2Oper, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoId=vlanInfoId, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstGeneralCfg=mstGeneralCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoRootCost=stpInfoRootCost, fdbStatsCreates=fdbStatsCreates, stpInfoPortRole=stpInfoPortRole, fdbStats=fdbStats, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbState=fdbState, fdbStatsLookups=fdbStatsLookups, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortTable=stpInfoPortTable, fdbEntry=fdbEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgStg=vlanNewCfgStg, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTable=stgCurCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCfg=mstCistCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgState=vlanNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortEdge=stpInfoPortEdge, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortIndex=cistInfoPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortState=cistInfoPortState, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstNewCfgState=mstNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, trunkgroup=trunkgroup, cistGeneralInfo=cistGeneralInfo, portTeamInfo=portTeamInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfo=vlanInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgIndex=stgNewCfgIndex, lacp=lacp, stgCfg=stgCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortPriority=cistInfoPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, layer2Configs=layer2Configs, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsDeletes=fdbStatsDeletes, fdbVlan=fdbVlan, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRegionalPathCost=cistRegionalPathCost, vlanInfoPorts=vlanInfoPorts, mirrPortMirr=mirrPortMirr, stpInfo=stpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortRole=cistInfoPortRole, vlanInfoName=vlanInfoName, fdbStatsFinds=fdbStatsFinds, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgPorts=portTeamCurCfgPorts, mirroring=mirroring, portTeamInfoState=portTeamInfoState)
