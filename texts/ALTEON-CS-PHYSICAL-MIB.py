...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortTable=cistInfoPortTable, stpInfoPortTable=stpInfoPortTable, vlanMaxVlanID=vlanMaxVlanID, layer2=layer2, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortState=stgCurCfgPortState, cistRootPathCost=cistRootPathCost, stgNewCfgTable=stgNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgAddVlan=pmNewCfgAddVlan, layer2Stats=layer2Stats, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbInfo=fdbInfo, fdbStatsFinds=fdbStatsFinds, fdbLearnedPort=fdbLearnedPort, vlanInfo=vlanInfo, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoRootPort=stpInfoRootPort, cistGeneralInfo=cistGeneralInfo, fdbStatsDeletes=fdbStatsDeletes, vlanInfoName=vlanInfoName, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoTrunksState=portTeamInfoTrunksState, mstNewCfgState=mstNewCfgState, fdbStatsLookups=fdbStatsLookups, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbRefSps=fdbRefSps, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStats=fdbStats, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrPortMirr=mirrPortMirr, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstGeneralCfg=mstGeneralCfg, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoId=vlanInfoId, lacpInfoPortMoved=lacpInfoPortMoved, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, mirroring=mirroring, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoJumbo=vlanInfoJumbo, lacpInfo=lacpInfo, vlanCurCfgStg=vlanCurCfgStg, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgStpMode=mstCurCfgStpMode, fdbSrcPort=fdbSrcPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortEdge=stpInfoPortEdge, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoLearn=vlanInfoLearn, lacp=lacp, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoState=portTeamInfoState, portTeamCfg=portTeamCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoBwmContract=vlanInfoBwmContract, stgCfg=stgCfg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, cistRegionalRoot=cistRegionalRoot, stpInfo=stpInfo, trunkgroup=trunkgroup, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbEntry=fdbEntry, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortState=lacpNewPortState, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCfg=mstCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, PYSNMP_MODULE_ID=layer2, lacpCurPortState=lacpCurPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgState=mstCurCfgState, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCfg=mstCistCfg, BridgeId=BridgeId, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfo=portTeamInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, cistRoot=cistRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortTable=stgStatsPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortPriority=cistInfoPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortState=stpInfoPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Oper=layer2Oper, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxEnt=vlanMaxEnt, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfo=cistInfo, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTable=stpInfoTable, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortLinkType=cistInfoPortLinkType, layer2Info=layer2Info, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbVlan=fdbVlan, vlanCurCfgState=vlanCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbTable=fdbTable, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, stpStats=stpStats, stgNewCfgAddVlan=stgNewCfgAddVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPort=cistRootPort, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlan=vlan, layer2Configs=layer2Configs, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgState=vlanNewCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoStatus=vlanInfoStatus, vlanInfoPorts=vlanInfoPorts, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgStpMode=mstNewCfgStpMode, fdbClear=fdbClear, fdbState=fdbState, stgNewCfgState=stgNewCfgState, portTeamInfoTable=portTeamInfoTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates)
