...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoState=portTeamInfoState, stpInfoPortTable=stpInfoPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoLearn=vlanInfoLearn, vlanNewCfgVlanName=vlanNewCfgVlanName, layer2Stats=layer2Stats, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortNtt=lacpInfoPortNtt, fdbStats=fdbStats, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgAddPort=vlanNewCfgAddPort, cistRootPathCost=cistRootPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoTable=vlanInfoTable, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, layer2Oper=layer2Oper, portTeamCurCfgState=portTeamCurCfgState, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkgroup=trunkgroup, stgCfg=stgCfg, fdbSrcPort=fdbSrcPort, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortState=lacpCurPortState, stgStatsStpIndex=stgStatsStpIndex, vlanInfoId=vlanInfoId, cistInfoPortPriority=cistInfoPortPriority, PYSNMP_MODULE_ID=layer2, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortEdge=stpInfoPortEdge, fdbInfo=fdbInfo, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Info=layer2Info, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCfg=mstCistCfg, stpInfo=stpInfo, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgTable=vlanCurCfgTable, fdbState=fdbState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPorts=portTeamInfoPorts, cistRootPort=cistRootPort, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCfg=mstCfg, portTeamInfoTable=portTeamInfoTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, lacp=lacp, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortIndex=cistInfoPortIndex, mstNewCfgState=mstNewCfgState, fdbStatsDeletes=fdbStatsDeletes, fdbEntry=fdbEntry, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbVlan=fdbVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2Configs=layer2Configs, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoRootCost=stpInfoRootCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, portTeamInfo=portTeamInfo, BridgeId=BridgeId, lacpInfoPortTable=lacpInfoPortTable, vlanInfo=vlanInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRoot=cistRoot, vlanCurCfgState=vlanCurCfgState, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfo=lacpInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, fdbRefSps=fdbRefSps, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbClear=fdbClear, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortRole=stpInfoPortRole, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpStats=stpStats, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortRole=cistInfoPortRole, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgState=stgNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, mirrPortMirr=mirrPortMirr, layer2=layer2, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistRegionalRoot=cistRegionalRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCfg=portTeamCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoName=vlanInfoName, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, stpInfoRootPort=stpInfoRootPort, lacpInfoPortIndex=lacpInfoPortIndex, fdbLearnedPort=fdbLearnedPort, stpInfoTable=stpInfoTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgTable=stgNewCfgTable, stpInfoIndex=stpInfoIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistGeneralInfo=cistGeneralInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortIndex=stgStatsPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, fdbTable=fdbTable, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortState=stpInfoPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortTable=stgNewCfgPortTable, vlanMaxEnt=vlanMaxEnt, cistInfoPortTable=cistInfoPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortState=cistInfoPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgStg=vlanNewCfgStg, cistInfo=cistInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, mirroring=mirroring, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgState=mstCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgStgIndex=stgCurCfgStgIndex, vlan=vlan, portTeamNewCfgState=portTeamNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgState=stgCurCfgState, stgStatsPortTable=stgStatsPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable)
