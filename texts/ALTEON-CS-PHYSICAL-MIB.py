...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoPortsState=portTeamInfoPortsState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortState=lacpNewPortState, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsStpIndex=stgStatsStpIndex, mirrPortMirr=mirrPortMirr, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistRootPathCost=cistRootPathCost, mirroring=mirroring, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortState=lacpCurPortState, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootPort=stpInfoRootPort, fdbEntry=fdbEntry, layer2Info=layer2Info, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgState=mstCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRootPort=cistRootPort, vlanInfoPorts=vlanInfoPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfo=lacpInfo, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbClear=fdbClear, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoTableEntry=vlanInfoTableEntry, cistRegionalRoot=cistRegionalRoot, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortRole=stpInfoPortRole, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbVlan=fdbVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstNewCfgState=mstNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgTable=stgCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCfg=mstCistCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoState=portTeamInfoState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanInfoName=vlanInfoName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbMacAddr=fdbMacAddr, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfo=cistInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgRegionName=mstNewCfgRegionName, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCreates=fdbStatsCreates, stpInfoPortState=stpInfoPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoId=vlanInfoId, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortTable=cistInfoPortTable, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2=layer2, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkgroup=trunkgroup, fdbStatsFindFails=fdbStatsFindFails, stpInfoTable=stpInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbInfo=fdbInfo, stpInfo=stpInfo, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoLearn=vlanInfoLearn, fdbStats=fdbStats, stgCfg=stgCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacp=lacp, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, layer2Stats=layer2Stats, stpInfoForwardDelay=stpInfoForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Oper=layer2Oper, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistGeneralInfo=cistGeneralInfo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortState=cistInfoPortState, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlan=vlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfo=vlanInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoMaxAge=stpInfoMaxAge, vlanMaxEnt=vlanMaxEnt, layer2Configs=layer2Configs, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfo=portTeamInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCfg=mstCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, mstGeneralCfg=mstGeneralCfg, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoIndex=stpInfoIndex, fdbState=fdbState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbRefSps=fdbRefSps, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbTable=fdbTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortTable=stgStatsPortTable, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoStatus=vlanInfoStatus, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCfg=portTeamCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, BridgeId=BridgeId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRoot=cistRoot, stpStats=stpStats, stgCurCfgPortTable=stgCurCfgPortTable, fdbLearnedPort=fdbLearnedPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay)
