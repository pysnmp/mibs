...
iso, Counter64, Integer32, Bits, Gauge32, MibIdentifier, NotificationType, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Integer32", "Bits", "Gauge32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbInfo=fdbInfo, vlanNewCfgState=vlanNewCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCreates=fdbStatsCreates, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortState=stpInfoPortState, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgState=mstNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRoot=cistRoot, fdbStatsFinds=fdbStatsFinds, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPriority=stgCurCfgPriority, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortIndex=lacpInfoPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoBwmContract=vlanInfoBwmContract, cistRootPort=cistRootPort, layer2Info=layer2Info, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, mstGeneralCfg=mstGeneralCfg, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpCurPortState=lacpCurPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCurCfgTable=portTeamCurCfgTable, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsDeletes=fdbStatsDeletes, mirrPortMirr=mirrPortMirr, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoId=vlanInfoId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfo=lacpInfo, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoState=portTeamInfoState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsHiwat=fdbStatsHiwat, fdbMacAddr=fdbMacAddr, trunkgroup=trunkgroup, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgTable=stgNewCfgTable, mstCistCfg=mstCistCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoRootPort=stpInfoRootPort, fdbSrcPort=fdbSrcPort, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortPriority=cistInfoPortPriority, layer2Stats=layer2Stats, fdbStats=fdbStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgTable=stgCurCfgTable, fdbRefSps=fdbRefSps, mirroring=mirroring, lacpNewPortState=lacpNewPortState, layer2=layer2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbClear=fdbClear, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCfg=stgCfg, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortTable=stpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCfg=portTeamCfg, fdbLearnedPort=fdbLearnedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, layer2Configs=layer2Configs, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, vlanInfoTable=vlanInfoTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbState=fdbState, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamNewCfgState=portTeamNewCfgState, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgState=mstCurCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfo=portTeamInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoLearn=vlanInfoLearn, stpInfoPortRole=stpInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoName=vlanInfoName, stgNewCfgState=stgNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortLink=stgCurCfgPortLink, fdbTable=fdbTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsOverflows=fdbStatsOverflows, stgStatsStpIndex=stgStatsStpIndex, stpInfoTable=stpInfoTable, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacp=lacp, stpInfoPortTableEntry=stpInfoPortTableEntry, BridgeId=BridgeId, PYSNMP_MODULE_ID=layer2, stpStats=stpStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgState=vlanCurCfgState, portTeamInfoTable=portTeamInfoTable, mstCfg=mstCfg, stgNewCfgIndex=stgNewCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookups=fdbStatsLookups, vlanInfo=vlanInfo, cistInfo=cistInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsCurrent=fdbStatsCurrent, vlanMaxEnt=vlanMaxEnt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbVlan=fdbVlan, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgTable=vlanCurCfgTable, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbEntry=fdbEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfo=stpInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2Oper=layer2Oper, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortIndex=stpInfoPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlan=vlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortMoved=lacpInfoPortMoved, cistRootPathCost=cistRootPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRegionalRoot=cistRegionalRoot)
