...
ObjectIdentity, Integer32, ModuleIdentity, Gauge32, Bits, Counter64, iso, IpAddress, MibIdentifier, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "ModuleIdentity", "Gauge32", "Bits", "Counter64", "iso", "IpAddress", "MibIdentifier", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", BridgeId=BridgeId, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoState=portTeamInfoState, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrPortMirr=mirrPortMirr, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortMoved=lacpInfoPortMoved, stgCfg=stgCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgDelete=vlanNewCfgDelete, fdbLearnedPort=fdbLearnedPort, stpInfoIndex=stpInfoIndex, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortState=stpInfoPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfo=cistInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalRoot=cistRegionalRoot, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPriority=stgNewCfgPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortRole=cistInfoPortRole, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTable=stpInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortTable=cistInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, vlan=vlan, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsCurrent=fdbStatsCurrent, cistBridgeHelloTime=cistBridgeHelloTime, fdbSrcPort=fdbSrcPort, fdbVlan=fdbVlan, cistInfoPortPriority=cistInfoPortPriority, cistGeneralInfo=cistGeneralInfo, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, layer2=layer2, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, cistRoot=cistRoot, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCfg=portTeamCfg, stpInfoMaxAge=stpInfoMaxAge, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mirroring=mirroring, fdbClear=fdbClear, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTable=portTeamInfoTable, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, layer2Stats=layer2Stats, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStats=fdbStats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsLookups=fdbStatsLookups, fdbEntry=fdbEntry, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortRole=stpInfoPortRole, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoName=vlanInfoName, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgState=mstNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoRootCost=stpInfoRootCost, vlanInfoId=vlanInfoId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCfg=mstCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, PYSNMP_MODULE_ID=layer2, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpStats=stpStats, lacpNewSystemPriority=lacpNewSystemPriority, fdbInfo=fdbInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, stpInfo=stpInfo, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, vlanInfoLearn=vlanInfoLearn, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRootPort=cistRootPort, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoRootPort=stpInfoRootPort, fdbState=fdbState, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, lacp=lacp, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2Info=layer2Info, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoPorts=portTeamInfoPorts, fdbStatsFindFails=fdbStatsFindFails, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoPorts=vlanInfoPorts, stgNewCfgTable=stgNewCfgTable, layer2Oper=layer2Oper, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanMaxEnt=vlanMaxEnt, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfo=portTeamInfo, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgPorts=portTeamNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbRefSps=fdbRefSps, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfo=lacpInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfo=vlanInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkgroup=trunkgroup, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCfg=mstCistCfg, mstCistBridgeCfg=mstCistBridgeCfg, mstCurCfgState=mstCurCfgState, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbTable=fdbTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2Configs=layer2Configs)
