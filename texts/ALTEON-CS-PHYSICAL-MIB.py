...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, stpInfoIndex=stpInfoIndex, cistInfoPortTable=cistInfoPortTable, cistInfoPortState=cistInfoPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgTable=stgCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCfg=mstCfg, vlanNewCfgState=vlanNewCfgState, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanName=vlanNewCfgVlanName, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTable=portTeamInfoTable, layer2Oper=layer2Oper, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoName=vlanInfoName, layer2Stats=layer2Stats, mirroring=mirroring, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortTable=stpInfoPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfo=cistInfo, lacpNewPortState=lacpNewPortState, vlanNewCfgPorts=vlanNewCfgPorts, layer2Configs=layer2Configs, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpStats=stpStats, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgTable=vlanNewCfgTable, cistRegionalRoot=cistRegionalRoot, portTeamInfoState=portTeamInfoState, stpInfoPortIndex=stpInfoPortIndex, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoLearn=vlanInfoLearn, stgCfg=stgCfg, portTeamNewCfgTable=portTeamNewCfgTable, fdbSrcTrunk=fdbSrcTrunk, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortLink=stgCurCfgPortLink, fdbVlan=fdbVlan, stpInfoPortEdge=stpInfoPortEdge, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgIndex=stgNewCfgIndex, fdbTable=fdbTable, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoRootCost=stpInfoRootCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgStg=vlanNewCfgStg, fdbInfo=fdbInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoId=vlanInfoId, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, BridgeId=BridgeId, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Info=layer2Info, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortRole=cistInfoPortRole, fdbClear=fdbClear, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfo=lacpInfo, cistRoot=cistRoot, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortTable=stgStatsPortTable, vlanCurCfgPorts=vlanCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, fdbLearnedPort=fdbLearnedPort, fdbRefSps=fdbRefSps, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbState=fdbState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsLookups=fdbStatsLookups, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStats=fdbStats, lacpInfoPortSelected=lacpInfoPortSelected, mstNewCfgState=mstNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbEntry=fdbEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistBridgeHelloTime=cistBridgeHelloTime, mirrPortMirr=mirrPortMirr, portTeamInfo=portTeamInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacp=lacp, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCfg=mstCistCfg, stgNewCfgState=stgNewCfgState, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkgroup=trunkgroup, vlanInfoTable=vlanInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurPortState=lacpCurPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlan=vlan, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCfg=portTeamCfg, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsPortIndex=stgStatsPortIndex, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbSrcPort=fdbSrcPort, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortState=stpInfoPortState, stpInfoMaxAge=stpInfoMaxAge, cistRootPathCost=cistRootPathCost, cistRootPort=cistRootPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfo=stpInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgState=mstCurCfgState, vlanInfoPorts=vlanInfoPorts, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfo=vlanInfo, stpInfoTable=stpInfoTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanMaxEnt=vlanMaxEnt)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgState=stgCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgAddVlan=stgNewCfgAddVlan, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistGeneralInfo=cistGeneralInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsDeletes=fdbStatsDeletes, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgIndex=stgCurCfgIndex)
