...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoPorts=vlanInfoPorts, layer2=layer2, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoState=portTeamInfoState, fdbVlan=fdbVlan, stgCurCfgPriority=stgCurCfgPriority, cistRootPathCost=cistRootPathCost, stpInfoPortState=stpInfoPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfo=stpInfo, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, cistRootPort=cistRootPort, fdbSrcPort=fdbSrcPort, cistRegionalRoot=cistRegionalRoot, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbEntry=fdbEntry, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoTableEntry=stpInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoIndex=stpInfoIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortLink=stgNewCfgPortLink, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoId=vlanInfoId, fdbRefSps=fdbRefSps, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbState=fdbState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCfg=stgCfg, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbLearnedPort=fdbLearnedPort, stpInfoMaxAge=stpInfoMaxAge, layer2Info=layer2Info, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortTable=cistInfoPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2Configs=layer2Configs, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsHiwat=fdbStatsHiwat, layer2Stats=layer2Stats, lacp=lacp, fdbInfo=fdbInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgState=vlanCurCfgState, stpInfoTopChanges=stpInfoTopChanges, stpStats=stpStats, vlanMaxEnt=vlanMaxEnt, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTable=stpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortEdge=stpInfoPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsFindFails=fdbStatsFindFails, mstCurCfgState=mstCurCfgState, lacpInfoPortMoved=lacpInfoPortMoved, mstGeneralCfg=mstGeneralCfg, mirrPortMirr=mirrPortMirr, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistGeneralInfo=cistGeneralInfo, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbTable=fdbTable, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbClear=fdbClear, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortRole=cistInfoPortRole, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpCurPortState=lacpCurPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfo=vlanInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortState=cistInfoPortState, fdbMacAddr=fdbMacAddr, mirroring=mirroring, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCfg=mstCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlan=vlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, cistInfo=cistInfo, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsLookups=fdbStatsLookups, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, vlanInfoJumbo=vlanInfoJumbo, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstNewCfgState=mstNewCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFinds=fdbStatsFinds, layer2Oper=layer2Oper, fdbStats=fdbStats, portTeamInfo=portTeamInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgState=vlanNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoName=vlanInfoName, stgNewCfgPortState=stgNewCfgPortState, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCfg=portTeamCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfo=lacpInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCfg=mstCistCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoRootCost=stpInfoRootCost, BridgeId=BridgeId, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRoot=cistRoot, trunkgroup=trunkgroup, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortRole=stpInfoPortRole, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgStg=vlanNewCfgStg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn)
