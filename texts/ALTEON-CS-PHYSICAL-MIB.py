...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortLinkType=cistInfoPortLinkType, fdbTable=fdbTable, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbSrcTrunk=fdbSrcTrunk, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbRefSps=fdbRefSps, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, cistRegionalRoot=cistRegionalRoot, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbMacAddr=fdbMacAddr, portTeamInfo=portTeamInfo, layer2Oper=layer2Oper, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortRole=cistInfoPortRole, BridgeId=BridgeId, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, mstCistDefaultCfg=mstCistDefaultCfg, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPortsState=portTeamInfoPortsState, mstCurCfgState=mstCurCfgState, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoId=vlanInfoId, fdbStats=fdbStats, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbLearnedPort=fdbLearnedPort, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgState=stgCurCfgState, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mirroring=mirroring, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfo=cistInfo, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTable=stpInfoTable, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsCreates=fdbStatsCreates, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoState=portTeamInfoState, fdbStatsLookups=fdbStatsLookups, vlanInfoLearn=vlanInfoLearn, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortRole=stpInfoPortRole, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortPriority=cistInfoPortPriority, vlanInfo=vlanInfo, vlanInfoName=vlanInfoName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, PYSNMP_MODULE_ID=layer2, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTable=portTeamInfoTable, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgIndex=stgCurCfgIndex, fdbClear=fdbClear, fdbSrcPort=fdbSrcPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTable=cistInfoPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgLearn=vlanCurCfgLearn, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortState=lacpNewPortState, vlan=vlan, vlanInfoPorts=vlanInfoPorts, layer2=layer2, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortState=lacpCurPortState, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgState=vlanNewCfgState, stgStatsPortIndex=stgStatsPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoStatus=vlanInfoStatus, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2Info=layer2Info, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbInfo=fdbInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCfg=portTeamCfg, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCfg=mstCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbVlan=fdbVlan, stpStats=stpStats, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbState=fdbState, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTable=stgStatsPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkgroup=trunkgroup, stpInfoHoldTime=stpInfoHoldTime, cistRootPort=cistRootPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxEnt=vlanMaxEnt, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfo=stpInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsStpIndex=stgStatsStpIndex, lacp=lacp, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCfg=stgCfg, stgNewCfgTable=stgNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortIndex=stpInfoPortIndex, cistGeneralInfo=cistGeneralInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgState=portTeamNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, mstGeneralCfg=mstGeneralCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootPort=stpInfoRootPort, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2Stats=layer2Stats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsFinds=fdbStatsFinds, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbEntry=fdbEntry, stpInfoRootCost=stpInfoRootCost, stpInfoForwardDelay=stpInfoForwardDelay, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortState=cistInfoPortState, mstCistCfg=mstCistCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRoot=cistRoot, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortState=stpInfoPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoIndex=stpInfoIndex, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortTable=stpInfoPortTable, layer2Configs=layer2Configs, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistRootPathCost=cistRootPathCost, vlanCurCfgStg=vlanCurCfgStg)
