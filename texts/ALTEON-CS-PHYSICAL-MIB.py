...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCfg=mstCistCfg, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfo=portTeamInfo, mstGeneralCfg=mstGeneralCfg, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, fdbStatsLookups=fdbStatsLookups, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortState=stpInfoPortState, layer2Info=layer2Info, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoHelloTime=stpInfoHelloTime, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoState=portTeamInfoState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCfg=mstCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbVlan=fdbVlan, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoId=vlanInfoId, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgState=vlanCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortState=stgNewCfgPortState, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTable=vlanInfoTable, lacp=lacp, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoRootCost=stpInfoRootCost, stpStats=stpStats, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortPriority=cistInfoPortPriority, fdbTable=fdbTable, vlanInfoName=vlanInfoName, vlanInfoJumbo=vlanInfoJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbClear=fdbClear, portTeamCfg=portTeamCfg, lacpCurPortState=lacpCurPortState, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortTable=stgStatsPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortTable=lacpInfoPortTable, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsOverflows=fdbStatsOverflows, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistRoot=cistRoot, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgTable=stgNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortTable=stpInfoPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Stats=layer2Stats, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCfg=stgCfg, stgNewCfgIndex=stgNewCfgIndex, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRootPort=cistRootPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgState=vlanNewCfgState, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeMaxAge=cistBridgeMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2=layer2, layer2Configs=layer2Configs, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgTable=stgCurCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoIndex=stpInfoIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfo=vlanInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, cistRegionalRoot=cistRegionalRoot, mstCurCfgState=mstCurCfgState, vlanInfoLearn=vlanInfoLearn, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, vlan=vlan, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsDeletes=fdbStatsDeletes, lacpInfo=lacpInfo, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortRole=stpInfoPortRole, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCreates=fdbStatsCreates, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistGeneralInfo=cistGeneralInfo, vlanInfoStatus=vlanInfoStatus, trunkgroup=trunkgroup, fdbMacAddr=fdbMacAddr, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, cistRootPathCost=cistRootPathCost, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfo=cistInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, fdbEntry=fdbEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoRootPort=stpInfoRootPort, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTable=stpInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoTableEntry=vlanInfoTableEntry, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortState=lacpNewPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgState=stgCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbInfo=fdbInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStats=fdbStats, fdbRefSps=fdbRefSps, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanMaxEnt=vlanMaxEnt, fdbState=fdbState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortState=cistInfoPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfo=stpInfo, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgDelete=portTeamNewCfgDelete, BridgeId=BridgeId, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority)
