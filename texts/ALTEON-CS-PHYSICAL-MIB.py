...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgState=portTeamNewCfgState, cistInfoPortState=cistInfoPortState, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCfg=stgCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsFinds=fdbStatsFinds, lacpInfo=lacpInfo, stpInfoRootCost=stpInfoRootCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortIndex=stpInfoPortIndex, layer2Configs=layer2Configs, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbState=fdbState, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCfg=portTeamCfg, stpInfoPortPathCost=stpInfoPortPathCost, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacp=lacp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoIndex=stpInfoIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistRootPort=cistRootPort, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoPorts=vlanInfoPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortTable=cistInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbEntry=fdbEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbRefSps=fdbRefSps, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortTable=stgStatsPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbSrcPort=fdbSrcPort, mirroring=mirroring, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbMacAddr=fdbMacAddr, fdbTable=fdbTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbInfo=fdbInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCurCfgState=mstCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoStatus=vlanInfoStatus, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoId=vlanInfoId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurPortState=lacpCurPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookups=fdbStatsLookups, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortIndex=lacpInfoPortIndex, cistInfo=cistInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, PYSNMP_MODULE_ID=layer2, vlan=vlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, layer2Info=layer2Info, stpInfoPortRole=stpInfoPortRole, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, mirrPortMirr=mirrPortMirr, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsDeletes=fdbStatsDeletes, stpInfoTableEntry=stpInfoTableEntry, layer2=layer2, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2Stats=layer2Stats, mstCistCfg=mstCistCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Oper=layer2Oper, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortState=stpInfoPortState, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgState=mstNewCfgState, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCfg=mstCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistGeneralInfo=cistGeneralInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsCurrent=fdbStatsCurrent, mstCistBridgeCfg=mstCistBridgeCfg, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgAgingTime=stgCurCfgAgingTime, cistRoot=cistRoot, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgState=stgCurCfgState, fdbLearnedPort=fdbLearnedPort, fdbStats=fdbStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoHelloTime=stpInfoHelloTime, lacpNewPortState=lacpNewPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkgroup=trunkgroup, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgIndex=stgCurCfgIndex, fdbVlan=fdbVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsHiwat=fdbStatsHiwat, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsCreates=fdbStatsCreates, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgTable=stgNewCfgTable, fdbStatsOverflows=fdbStatsOverflows, vlanInfoTable=vlanInfoTable, cistRootPathCost=cistRootPathCost, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpStats=stpStats, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoName=vlanInfoName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbClear=fdbClear, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, stpInfoTable=stpInfoTable, cistRegionalPathCost=cistRegionalPathCost, vlanInfo=vlanInfo, stgNewCfgIndex=stgNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, BridgeId=BridgeId, stgNewCfgState=stgNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfo=stpInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxVlanID=vlanMaxVlanID, portTeamInfo=portTeamInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
