...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", BridgeId=BridgeId, fdbEntry=fdbEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, cistInfo=cistInfo, fdbTable=fdbTable, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbInfo=fdbInfo, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgState=vlanNewCfgState, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTable=stpInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, fdbStatsLookups=fdbStatsLookups, lacpInfoPortTable=lacpInfoPortTable, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfo=lacpInfo, cistRegionalRoot=cistRegionalRoot, lacp=lacp, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbLearnedPort=fdbLearnedPort, stpInfo=stpInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, fdbStatsCurrent=fdbStatsCurrent, stpInfoRootPort=stpInfoRootPort, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRoot=cistRoot, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Oper=layer2Oper, stgCurCfgState=stgCurCfgState, fdbSrcPort=fdbSrcPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortRole=stpInfoPortRole, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgTable=stgCurCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, fdbStats=fdbStats, PYSNMP_MODULE_ID=layer2, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCurCfgState=mstCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgIndex=stgCurCfgIndex, mstCistCfg=mstCistCfg, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCfg=stgCfg, mstCfg=mstCfg, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbMacAddr=fdbMacAddr, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCfg=portTeamCfg, portTeamInfoTable=portTeamInfoTable, layer2Configs=layer2Configs, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkgroup=trunkgroup, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoTable=vlanInfoTable, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPriority=cistInfoPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbSrcTrunk=fdbSrcTrunk, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsCreates=fdbStatsCreates, lacpNewPortState=lacpNewPortState, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoName=vlanInfoName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstGeneralCfg=mstGeneralCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbState=fdbState, cistRootPort=cistRootPort, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoPorts=vlanInfoPorts, stpInfoTableEntry=stpInfoTableEntry, stpStats=stpStats, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTable=stgNewCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgStgIndex=stgNewCfgStgIndex, vlan=vlan, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoId=vlanInfoId, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, fdbClear=fdbClear, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfo=portTeamInfo, fdbVlan=fdbVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstNewCfgState=mstNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortState=cistInfoPortState, layer2Stats=layer2Stats, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoIndex=portTeamInfoIndex, layer2Info=layer2Info, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgTable=portTeamNewCfgTable, cistGeneralInfo=cistGeneralInfo, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfo=vlanInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsDeletes=fdbStatsDeletes, vlanInfoStatus=vlanInfoStatus, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, mirroring=mirroring, stpInfoHoldTime=stpInfoHoldTime, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortTable=stgStatsPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgState=portTeamNewCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbRefSps=fdbRefSps, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeHelloTime=cistBridgeHelloTime, mirrPortMirr=mirrPortMirr, portTeamInfoState=portTeamInfoState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, layer2=layer2, stpInfoPortStpIndex=stpInfoPortStpIndex)
