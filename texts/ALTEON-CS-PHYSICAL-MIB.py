...
MibIdentifier, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Counter64, Unsigned32, TimeTicks, iso, IpAddress, Counter32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32", "TimeTicks", "iso", "IpAddress", "Counter32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTableEntry=stpInfoTableEntry, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistBridgeHelloTime=cistBridgeHelloTime, fdbClear=fdbClear, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, vlan=vlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsStpIndex=stgStatsStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRegionalRoot=cistRegionalRoot, mstCurCfgState=mstCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfo=portTeamInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCfg=portTeamCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortState=lacpCurPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgTable=stgNewCfgTable, mstCistCfg=mstCistCfg, stpInfoIndex=stpInfoIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgIndex=stgCurCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbInfo=fdbInfo, stpInfoPortRole=stpInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfoName=vlanInfoName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCurCfgRegionName=mstCurCfgRegionName, fdbEntry=fdbEntry, fdbSrcPort=fdbSrcPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistRoot=cistRoot, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirroring=mirroring, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgState=stgNewCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoTable=portTeamInfoTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, lacp=lacp, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgState=stgCurCfgState, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortState=lacpNewPortState, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbMacAddr=fdbMacAddr, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanMaxEnt=vlanMaxEnt, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkgroup=trunkgroup, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoLearn=vlanInfoLearn, cistRootPathCost=cistRootPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCfg=stgCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortLink=stgCurCfgPortLink, fdbTable=fdbTable, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPort=cistRootPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfo=vlanInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgState=vlanNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTable=stgNewCfgPortTable, cistInfo=cistInfo, stpInfoForwardDelay=stpInfoForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoPorts=vlanInfoPorts, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, stpInfoHoldTime=stpInfoHoldTime, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpStats=stpStats, layer2Oper=layer2Oper, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Configs=layer2Configs, fdbRefSps=fdbRefSps, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfo=lacpInfo, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, vlanMaxVlanID=vlanMaxVlanID, layer2=layer2, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, layer2Info=layer2Info, cistInfoPortState=cistInfoPortState, fdbStatsDeletes=fdbStatsDeletes, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, stpInfoTopChanges=stpInfoTopChanges, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcTrunk=fdbSrcTrunk, mirrPortMirr=mirrPortMirr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsFinds=fdbStatsFinds, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsOverflows=fdbStatsOverflows, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoTable=vlanInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgState=mstNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCfg=mstCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstGeneralCfg=mstGeneralCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortTable=cistInfoPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfo=stpInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortEdge=stpInfoPortEdge, vlanInfoId=vlanInfoId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStats=fdbStats, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortState=stpInfoPortState, fdbVlan=fdbVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbState=fdbState, stpInfoPortTable=stpInfoPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoState=portTeamInfoState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTable=stpInfoTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgDelete=vlanNewCfgDelete, mstNewCfgRegionName=mstNewCfgRegionName, layer2Stats=layer2Stats, stpInfoRootCost=stpInfoRootCost, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortPathCost=stpInfoPortPathCost, BridgeId=BridgeId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection)
