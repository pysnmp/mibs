...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsDeletes=fdbStatsDeletes, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoState=portTeamInfoState, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mirroring=mirroring, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgStg=vlanCurCfgStg, cistRegionalRoot=cistRegionalRoot, portTeamInfoPortsState=portTeamInfoPortsState, vlan=vlan, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortState=stpInfoPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mirrPortMirr=mirrPortMirr, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoBwmContract=vlanInfoBwmContract, layer2=layer2, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoLearn=vlanInfoLearn, vlanInfoTable=vlanInfoTable, layer2Stats=layer2Stats, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbRefSps=fdbRefSps, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbEntry=fdbEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfo=vlanInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortTable=stpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoId=vlanInfoId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Configs=layer2Configs, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsCreates=fdbStatsCreates, cistRootPort=cistRootPort, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, vlanMaxEnt=vlanMaxEnt, vlanNewCfgRemovePort=vlanNewCfgRemovePort, PYSNMP_MODULE_ID=layer2, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsStpIndex=stgStatsStpIndex, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCfg=stgCfg, portTeamNewCfgState=portTeamNewCfgState, layer2Oper=layer2Oper, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkgroup=trunkgroup, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, cistRoot=cistRoot, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, lacp=lacp, fdbVlan=fdbVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoName=vlanInfoName, stpStats=stpStats, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCfg=mstCistCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTopChanges=stpInfoTopChanges, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewSystemPriority=lacpNewSystemPriority, fdbClear=fdbClear, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, BridgeId=BridgeId, stpInfo=stpInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortTable=cistInfoPortTable, layer2Info=layer2Info, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgState=mstCurCfgState, stpInfoIndex=stpInfoIndex, vlanInfoPorts=vlanInfoPorts, portTeamCfg=portTeamCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbState=fdbState, stgCurCfgPriority=stgCurCfgPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfo=cistInfo, mstGeneralCfg=mstGeneralCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCfg=mstCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgStg=vlanNewCfgStg, fdbStats=fdbStats, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbTable=fdbTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsFinds=fdbStatsFinds, cistInfoPortLinkType=cistInfoPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfo=portTeamInfo, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTable=stpInfoTable, stpInfoRootPort=stpInfoRootPort, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortState=cistInfoPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, fdbInfo=fdbInfo, lacpCurPortState=lacpCurPortState, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortState=lacpNewPortState, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRootPathCost=cistRootPathCost, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgState=vlanCurCfgState, lacpInfo=lacpInfo, stgNewCfgState=stgNewCfgState, fdbMacAddr=fdbMacAddr, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoRootCost=stpInfoRootCost, cistInfoPortRole=cistInfoPortRole)
