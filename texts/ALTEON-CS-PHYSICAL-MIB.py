...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mirrPortMirr=mirrPortMirr, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortTable=cistInfoPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoPorts=portTeamInfoPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoName=vlanInfoName, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortState=lacpNewPortState, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbClear=fdbClear, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortState=stgNewCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, BridgeId=BridgeId, portTeamInfo=portTeamInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbTable=fdbTable, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgState=portTeamNewCfgState, fdbInfo=fdbInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsCurrent=fdbStatsCurrent, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoRootCost=stpInfoRootCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgJumbo=vlanNewCfgJumbo, cistGeneralInfo=cistGeneralInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoRootPort=stpInfoRootPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTableEntry=stpInfoTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgTable=stgNewCfgTable, layer2Configs=layer2Configs, lacpNewSystemPriority=lacpNewSystemPriority, mstCurCfgState=mstCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Oper=layer2Oper, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCfg=portTeamCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCfg=mstCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsLookups=fdbStatsLookups, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, PYSNMP_MODULE_ID=layer2, fdbSrcPort=fdbSrcPort, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRegionalRoot=cistRegionalRoot, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstGeneralCfg=mstGeneralCfg, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsCreates=fdbStatsCreates, cistRootPort=cistRootPort, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, trunkgroup=trunkgroup, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, layer2Info=layer2Info, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoIndex=stpInfoIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortState=lacpCurPortState, lacp=lacp, stpInfoPortTable=stpInfoPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgLearn=vlanNewCfgLearn, cistRoot=cistRoot, fdbStatsFindFails=fdbStatsFindFails, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCfg=stgCfg, vlanNewCfgState=vlanNewCfgState, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTable=stpInfoTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, stpStats=stpStats, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanMaxEnt=vlanMaxEnt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortState=cistInfoPortState, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortState=stpInfoPortState, fdbMacAddr=fdbMacAddr, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbEntry=fdbEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoId=vlanInfoId, layer2Stats=layer2Stats, lacpInfo=lacpInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, mirroring=mirroring, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoLearn=vlanInfoLearn, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoTable=vlanInfoTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortIndex=cistInfoPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortEdge=stpInfoPortEdge, fdbVlan=fdbVlan, portTeamInfoState=portTeamInfoState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTopChanges=stpInfoTopChanges, stpInfo=stpInfo, fdbStats=fdbStats, vlan=vlan, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfo=vlanInfo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2=layer2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfo=cistInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCfg=mstCistCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, fdbState=fdbState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTable=portTeamInfoTable, fdbLearnedPort=fdbLearnedPort, vlanInfoStatus=vlanInfoStatus, vlanNewCfgBwmContract=vlanNewCfgBwmContract)
