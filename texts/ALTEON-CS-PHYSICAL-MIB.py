...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbTable=fdbTable, layer2=layer2, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbVlan=fdbVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCfg=stgCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRootPort=cistRootPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, PYSNMP_MODULE_ID=layer2, lacpInfoPortReadyN=lacpInfoPortReadyN, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Oper=layer2Oper, cistInfo=cistInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, stgStatsPortTable=stgStatsPortTable, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Configs=layer2Configs, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortState=stgNewCfgPortState, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortIndex=stgStatsPortIndex, trunkgroup=trunkgroup, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTable=stpInfoTable, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRegionalRoot=cistRegionalRoot, cistInfoPortState=cistInfoPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoTable=portTeamInfoTable, lacpInfo=lacpInfo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacp=lacp, stpInfoPortRole=stpInfoPortRole, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsCreates=fdbStatsCreates, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortState=lacpCurPortState, mstCistCfg=mstCistCfg, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfo=portTeamInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbEntry=fdbEntry, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, layer2Stats=layer2Stats, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsDeletes=fdbStatsDeletes, cistRootPathCost=cistRootPathCost, vlanInfoTable=vlanInfoTable, vlanInfoStatus=vlanInfoStatus, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoHelloTime=stpInfoHelloTime, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgState=stgCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurSystemPriority=lacpCurSystemPriority, fdbMacAddr=fdbMacAddr, stpInfoPortEdge=stpInfoPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortPathCost=cistInfoPortPathCost, fdbInfo=fdbInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgState=portTeamNewCfgState, mstCfg=mstCfg, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortRole=cistInfoPortRole, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortTable=stpInfoPortTable, vlanCurCfgStg=vlanCurCfgStg, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbClear=fdbClear, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCfg=portTeamCfg, cistInfoPortTable=cistInfoPortTable, stpInfoIndex=stpInfoIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoName=vlanInfoName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2Info=layer2Info, cistRoot=cistRoot, vlanInfo=vlanInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoState=portTeamInfoState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpStats=stpStats, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbState=fdbState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, BridgeId=BridgeId, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgState=mstCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookups=fdbStatsLookups, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgTable=stgNewCfgTable, fdbRefSps=fdbRefSps, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgTable=stgCurCfgTable, fdbLearnedPort=fdbLearnedPort, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortState=stpInfoPortState, vlanInfoId=vlanInfoId, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgState=stgNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortTableEntry=cistInfoPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStats=fdbStats, lacpInfoPortTable=lacpInfoPortTable, vlanInfoPorts=vlanInfoPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfo=stpInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, fdbSrcPort=fdbSrcPort, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortState=lacpNewPortState, vlan=vlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mirroring=mirroring, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoLearn=vlanInfoLearn, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgTable=vlanNewCfgTable, mstNewCfgState=mstNewCfgState)
