...
TimeTicks, Bits, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, Counter32, Counter64, ModuleIdentity, iso, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "Counter32", "Counter64", "ModuleIdentity", "iso", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortState=lacpCurPortState, fdbStatsCreates=fdbStatsCreates, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortIndex=stgStatsPortIndex, cistRoot=cistRoot, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacp=lacp, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbClear=fdbClear, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoIndex=stpInfoIndex, PYSNMP_MODULE_ID=layer2, mirroring=mirroring, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTable=portTeamInfoTable, lacpInfo=lacpInfo, portTeamInfoState=portTeamInfoState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoTable=vlanInfoTable, vlanInfoName=vlanInfoName, stpInfoPortRole=stpInfoPortRole, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkgroup=trunkgroup, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbState=fdbState, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgState=stgNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbRefSps=fdbRefSps, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Info=layer2Info, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortTable=stgCurCfgPortTable, layer2Oper=layer2Oper, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortTable=cistInfoPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgTable=vlanCurCfgTable, cistInfo=cistInfo, mstNewCfgStpMode=mstNewCfgStpMode, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistRegionalRoot=cistRegionalRoot, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCfg=mstCistCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgIndex=stgCurCfgIndex, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStats=fdbStats, fdbStatsHiwat=fdbStatsHiwat, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, vlanMaxVlanID=vlanMaxVlanID, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFinds=fdbStatsFinds, stgCurCfgPortState=stgCurCfgPortState, vlanInfo=vlanInfo, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoRootCost=stpInfoRootCost, layer2=layer2, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortLinkType=stpInfoPortLinkType, stpStats=stpStats, vlanNewCfgPorts=vlanNewCfgPorts, mstCfg=mstCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, BridgeId=BridgeId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, cistInfoPortState=cistInfoPortState, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, fdbTable=fdbTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgState=mstCurCfgState, vlanInfoId=vlanInfoId, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, layer2Configs=layer2Configs, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRootPort=cistRootPort, portTeamCfg=portTeamCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfo=portTeamInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbInfo=fdbInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, mstGeneralCfg=mstGeneralCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbEntry=fdbEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsStpIndex=stgStatsStpIndex, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTable=stpInfoTable, vlanCurCfgState=vlanCurCfgState, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgState=stgCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgLearn=vlanCurCfgLearn, vlan=vlan, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoStatus=vlanInfoStatus, stpInfo=stpInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbVlan=fdbVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgTable=stgNewCfgTable, fdbSrcPort=fdbSrcPort, stgCfg=stgCfg, fdbSrcTrunk=fdbSrcTrunk, layer2Stats=layer2Stats, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoIndex=portTeamInfoIndex, fdbLearnedPort=fdbLearnedPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRootPathCost=cistRootPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey)
