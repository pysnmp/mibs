...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortEdge=stpInfoPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgTable=stgCurCfgTable, vlanMaxEnt=vlanMaxEnt, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, mirroring=mirroring, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsStpIndex=stgStatsStpIndex, fdbStatsCurrent=fdbStatsCurrent, stpInfoRootPort=stpInfoRootPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbInfo=fdbInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortState=lacpCurPortState, cistInfoPortLinkType=cistInfoPortLinkType, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, layer2=layer2, mstNewCfgStpMode=mstNewCfgStpMode, stgCfg=stgCfg, fdbVlan=fdbVlan, vlanCurCfgStg=vlanCurCfgStg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, layer2Stats=layer2Stats, cistInfoPortState=cistInfoPortState, vlanInfoJumbo=vlanInfoJumbo, cistGeneralInfo=cistGeneralInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTopChanges=stpInfoTopChanges, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoName=vlanInfoName, BridgeId=BridgeId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgTable=vlanNewCfgTable, fdbSrcPort=fdbSrcPort, stpStats=stpStats, mstGeneralCfg=mstGeneralCfg, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoMaxAge=stpInfoMaxAge, portTeamCfg=portTeamCfg, vlan=vlan, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbRefSps=fdbRefSps, mstCurCfgState=mstCurCfgState, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStats=fdbStats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTable=stpInfoTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoTable=vlanInfoTable, lacpInfoPortMoved=lacpInfoPortMoved, layer2Configs=layer2Configs, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgTable=stgNewCfgTable, mirrPortMirr=mirrPortMirr, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgState=stgNewCfgState, trunkgroup=trunkgroup, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortTable=stpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbTable=fdbTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbState=fdbState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbEntry=fdbEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortSelected=lacpInfoPortSelected, layer2Oper=layer2Oper, cistRegionalPathCost=cistRegionalPathCost, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgState=mstNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCfg=mstCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoStatus=vlanInfoStatus, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanMaxVlanID=vlanMaxVlanID, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCfg=mstCistCfg, portTeamCurCfgState=portTeamCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTable=portTeamInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsLookups=fdbStatsLookups, vlanCurCfgVlanName=vlanCurCfgVlanName, lacp=lacp, cistInfo=cistInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsFinds=fdbStatsFinds, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortState=stpInfoPortState, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortState=lacpNewPortState, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoState=portTeamInfoState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfo=portTeamInfo, stgCurCfgState=stgCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgStg=vlanNewCfgStg, cistRootPort=cistRootPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2Info=layer2Info, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, cistRoot=cistRoot, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoId=vlanInfoId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbClear=fdbClear, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRootPathCost=cistRootPathCost, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, vlanInfoPorts=vlanInfoPorts, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortTable=stgNewCfgPortTable, stpInfo=stpInfo, vlanInfo=vlanInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTable=lacpInfoPortTable, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfo=lacpInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgState=vlanCurCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, cistRegionalRoot=cistRegionalRoot)
