...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfo=vlanInfo, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTable=stpInfoTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanMaxEnt=vlanMaxEnt, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbInfo=fdbInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsLookups=fdbStatsLookups, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsStpIndex=stgStatsStpIndex, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortState=cistInfoPortState, mstGeneralCfg=mstGeneralCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgLearn=vlanCurCfgLearn, mstCfg=mstCfg, BridgeId=BridgeId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoId=vlanInfoId, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCfg=portTeamCfg, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbMacAddr=fdbMacAddr, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgStpMode=mstCurCfgStpMode, layer2Oper=layer2Oper, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbTable=fdbTable, fdbLearnedPort=fdbLearnedPort, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgState=portTeamNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbEntry=fdbEntry, mstCurCfgState=mstCurCfgState, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortPathCost=stpInfoPortPathCost, trunkgroup=trunkgroup, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbState=fdbState, stgNewCfgState=stgNewCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfo=cistInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsCreates=fdbStatsCreates, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgIndex=stgNewCfgIndex, mirroring=mirroring, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortState=stpInfoPortState, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, lacp=lacp, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbSrcPort=fdbSrcPort, lacpInfoPortSelected=lacpInfoPortSelected, stpStats=stpStats, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFinds=fdbStatsFinds, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortState=lacpNewPortState, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, stgCfg=stgCfg, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, stgStatsPortTable=stgStatsPortTable, PYSNMP_MODULE_ID=layer2, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgState=mstNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoName=vlanInfoName, fdbRefSps=fdbRefSps, cistRootPort=cistRootPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, layer2Configs=layer2Configs, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistBridgeCfg=mstCistBridgeCfg, cistGeneralInfo=cistGeneralInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCfg=mstCistCfg, stgCurCfgTable=stgCurCfgTable, cistRoot=cistRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbClear=fdbClear, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortTable=cistInfoPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoRootPort=stpInfoRootPort, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTable=portTeamInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgStg=vlanCurCfgStg, stpInfo=stpInfo, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStats=fdbStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbVlan=fdbVlan, vlanInfoLearn=vlanInfoLearn, cistInfoPortIndex=cistInfoPortIndex, cistRegionalRoot=cistRegionalRoot, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2Stats=layer2Stats, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortRole=stpInfoPortRole, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoState=portTeamInfoState, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsCurrent=fdbStatsCurrent)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTopChanges=stpInfoTopChanges, layer2=layer2, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortState=lacpCurPortState, vlanInfoPorts=vlanInfoPorts, vlan=vlan, stgCurCfgIndex=stgCurCfgIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfo=portTeamInfo, lacpInfo=lacpInfo, mstNewCfgRegionName=mstNewCfgRegionName)
