...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortPriority=cistInfoPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, mstNewCfgRegionName=mstNewCfgRegionName, stpStats=stpStats, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfo=lacpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortState=stpInfoPortState, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTable=stpInfoPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanInfoTable=vlanInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgState=mstCurCfgState, vlanInfoName=vlanInfoName, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgDelete=vlanNewCfgDelete, fdbTable=fdbTable, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgState=stgCurCfgState, fdbEntry=fdbEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortState=lacpNewPortState, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistRoot=cistRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbSrcPort=fdbSrcPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkgroup=trunkgroup, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortState=lacpCurPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, BridgeId=BridgeId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, fdbState=fdbState, mstCistCfg=mstCistCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlan=vlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoIndex=stpInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoState=portTeamInfoState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortTable=lacpInfoPortTable, fdbLearnedPort=fdbLearnedPort, cistRootPathCost=cistRootPathCost, stpInfoTableEntry=stpInfoTableEntry, cistRootPort=cistRootPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalRoot=cistRegionalRoot, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbInfo=fdbInfo, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsFinds=fdbStatsFinds, fdbSrcTrunk=fdbSrcTrunk, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgState=stgNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfo=portTeamInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanInfoStatus=vlanInfoStatus, vlanInfo=vlanInfo, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortNtt=lacpInfoPortNtt, cistRegionalPathCost=cistRegionalPathCost, PYSNMP_MODULE_ID=layer2, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbVlan=fdbVlan, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mirroring=mirroring, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgState=vlanNewCfgState, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCfg=portTeamCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, mstCfg=mstCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortSelected=lacpInfoPortSelected, cistInfo=cistInfo, fdbStats=fdbStats, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgState=mstNewCfgState, cistInfoPortRole=cistInfoPortRole, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsLookups=fdbStatsLookups, stgNewCfgTable=stgNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoId=vlanInfoId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, fdbClear=fdbClear, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Info=layer2Info, stpInfoTable=stpInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Stats=layer2Stats, lacp=lacp, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCfg=stgCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, layer2Oper=layer2Oper, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, layer2=layer2, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfo=stpInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoTable=portTeamInfoTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootCost=stpInfoRootCost, fdbRefSps=fdbRefSps, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortState=cistInfoPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortRole=stpInfoPortRole, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortTable=cistInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstGeneralCfg=mstGeneralCfg, layer2Configs=layer2Configs, stgCurCfgTable=stgCurCfgTable, fdbMacAddr=fdbMacAddr, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgStg=vlanNewCfgStg, cistBridgeForwardDelay=cistBridgeForwardDelay)
