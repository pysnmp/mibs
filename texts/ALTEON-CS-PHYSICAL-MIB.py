...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, cistInfo=cistInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortLinkType=cistInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbClear=fdbClear, layer2=layer2, mirroring=mirroring, mstCurCfgState=mstCurCfgState, stgCfg=stgCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgState=stgNewCfgState, lacp=lacp, vlanInfoLearn=vlanInfoLearn, stpInfoPortRole=stpInfoPortRole, vlanInfoId=vlanInfoId, cistRegionalRoot=cistRegionalRoot, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoTopChanges=stpInfoTopChanges, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfo=portTeamInfo, stgNewCfgPortState=stgNewCfgPortState, layer2Oper=layer2Oper, portTeamCurCfgState=portTeamCurCfgState, fdbEntry=fdbEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoIndex=stpInfoIndex, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortTable=stpInfoPortTable, cistInfoPortState=cistInfoPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoRootCost=stpInfoRootCost, cistRootPort=cistRootPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgRegionName=mstNewCfgRegionName, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgDelete=vlanNewCfgDelete, layer2Stats=layer2Stats, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCfg=portTeamCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgState=vlanNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoIndex=portTeamInfoIndex, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoName=vlanInfoName, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortState=lacpCurPortState, lacpInfo=lacpInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStats=fdbStats, vlanInfoStatus=vlanInfoStatus, trunkgroup=trunkgroup, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortLink=stgNewCfgPortLink, fdbTable=fdbTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, fdbState=fdbState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgPorts=vlanCurCfgPorts, mirrPortMirr=mirrPortMirr, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoTable=stpInfoTable, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTable=stgStatsPortTable, stpInfoPortPathCost=stpInfoPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCfg=mstCistCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCurCfgRegionName=mstCurCfgRegionName, fdbRefSps=fdbRefSps, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortTable=cistInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgState=portTeamNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfo=vlanInfo, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbVlan=fdbVlan, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Configs=layer2Configs, stpInfoRootPort=stpInfoRootPort, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbInfo=fdbInfo, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, vlan=vlan, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsLookups=fdbStatsLookups, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbMacAddr=fdbMacAddr, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoTable=portTeamInfoTable, stpInfoPortState=stpInfoPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, cistRootPathCost=cistRootPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsStpIndex=stgStatsStpIndex, mstCfg=mstCfg, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfo=stpInfo, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortState=lacpNewPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFindFails=fdbStatsFindFails, cistRoot=cistRoot, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstNewCfgState=mstNewCfgState, layer2Info=layer2Info, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortRole=cistInfoPortRole, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpStats=stpStats)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, BridgeId=BridgeId, cistGeneralInfo=cistGeneralInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoState=portTeamInfoState, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, mstGeneralCfg=mstGeneralCfg, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPriority=stgCurCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge)
