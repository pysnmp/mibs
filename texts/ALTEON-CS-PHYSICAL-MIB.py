...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, Gauge32, Counter32, Counter64, iso, MibIdentifier, NotificationType, IpAddress, Integer32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "Gauge32", "Counter32", "Counter64", "iso", "MibIdentifier", "NotificationType", "IpAddress", "Integer32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Stats=layer2Stats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgState=stgNewCfgState, vlanInfo=vlanInfo, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTable=vlanInfoTable, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoName=vlanInfoName, stpInfo=stpInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsCreates=fdbStatsCreates, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbRefSps=fdbRefSps, cistInfo=cistInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRootPathCost=cistRootPathCost, lacpInfoPortTable=lacpInfoPortTable, cistRegionalRoot=cistRegionalRoot, lacpInfo=lacpInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootCost=stpInfoRootCost, layer2Info=layer2Info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCfg=stgCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbVlan=fdbVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsHiwat=fdbStatsHiwat, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortTable=cistInfoPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgTable=stgNewCfgTable, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRootPort=cistRootPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortRole=stpInfoPortRole, layer2Oper=layer2Oper, stpInfoIndex=stpInfoIndex, stgCurCfgPriority=stgCurCfgPriority, mirroring=mirroring, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbClear=fdbClear, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoPorts=portTeamInfoPorts, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTable=stpInfoTable, stgCurCfgState=stgCurCfgState, mstCistCfg=mstCistCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortState=stpInfoPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStats=fdbStats, PYSNMP_MODULE_ID=layer2, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfoIndex=portTeamInfoIndex, layer2=layer2, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortPriority=stgNewCfgPortPriority, BridgeId=BridgeId, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortSelected=lacpInfoPortSelected, trunkgroup=trunkgroup, mirrPortMirr=mirrPortMirr, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTable=stgCurCfgTable, lacpCurPortState=lacpCurPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbState=fdbState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortState=lacpNewPortState, fdbStatsOverflows=fdbStatsOverflows, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCfg=mstCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortEdge=stgNewCfgPortEdge, vlan=vlan, vlanNewCfgState=vlanNewCfgState, fdbTable=fdbTable, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgTable=vlanCurCfgTable, lacp=lacp, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, fdbEntry=fdbEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Configs=layer2Configs, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortState=cistInfoPortState, stpInfoPortTable=stpInfoPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgIndex=stgNewCfgIndex, vlanInfoPorts=vlanInfoPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRoot=cistRoot, fdbStatsLookupFails=fdbStatsLookupFails, cistGeneralInfo=cistGeneralInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortPathCost=stpInfoPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgState=portTeamNewCfgState, stpInfoRootPort=stpInfoRootPort, stgStatsPortTable=stgStatsPortTable, stpInfoForwardDelay=stpInfoForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortPriority=cistInfoPortPriority, vlanInfoId=vlanInfoId, fdbLearnedPort=fdbLearnedPort, fdbInfo=fdbInfo, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoState=portTeamInfoState, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, stpStats=stpStats, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgState=mstNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, stgCurCfgPortState=stgCurCfgPortState, stpInfoHelloTime=stpInfoHelloTime, portTeamInfo=portTeamInfo, vlanInfoTableEntry=vlanInfoTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex)
