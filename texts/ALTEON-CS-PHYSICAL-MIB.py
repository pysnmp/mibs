...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortTable=stgStatsPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgState=stgCurCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Oper=layer2Oper, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortTable=cistInfoPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbEntry=fdbEntry, mirroring=mirroring, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbTable=fdbTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgRegionName=mstNewCfgRegionName, mstCistBridgeCfg=mstCistBridgeCfg, cistRootPathCost=cistRootPathCost, fdbMacAddr=fdbMacAddr, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfo=cistInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, cistGeneralInfo=cistGeneralInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgState=vlanCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortState=stpInfoPortState, lacpInfo=lacpInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoId=vlanInfoId, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, PYSNMP_MODULE_ID=layer2, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfo=portTeamInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfo=vlanInfo, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, layer2=layer2, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, fdbSrcPort=fdbSrcPort, stgStatsPortTableEntry=stgStatsPortTableEntry, BridgeId=BridgeId, stgCfg=stgCfg, fdbInfo=fdbInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTable=stpInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, vlanInfoName=vlanInfoName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortState=cistInfoPortState, stpInfoHoldTime=stpInfoHoldTime, vlanInfoPorts=vlanInfoPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, stpStats=stpStats, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortEdge=stpInfoPortEdge, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortState=stgNewCfgPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTable=stgCurCfgTable, lacp=lacp, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, layer2Stats=layer2Stats, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, mstCfg=mstCfg, stpInfo=stpInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcTrunk=fdbSrcTrunk, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgState=stgNewCfgState, mstCistCfg=mstCistCfg, vlanNewCfgState=vlanNewCfgState, stgNewCfgIndex=stgNewCfgIndex, fdbClear=fdbClear, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, trunkgroup=trunkgroup, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCfg=portTeamCfg, cistInfoPortPriority=cistInfoPortPriority, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoTable=portTeamInfoTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoRootCost=stpInfoRootCost, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortState=lacpCurPortState, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, layer2Info=layer2Info, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoTable=vlanInfoTable, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, layer2Configs=layer2Configs, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, fdbStatsCreates=fdbStatsCreates, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbVlan=fdbVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoStatus=vlanInfoStatus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortRole=stpInfoPortRole, cistRootPort=cistRootPort, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTopChanges=stpInfoTopChanges, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgTable=portTeamNewCfgTable, fdbStats=fdbStats, stpInfoIndex=stpInfoIndex, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirrPortMirr=mirrPortMirr, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgState=mstNewCfgState, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoLearn=vlanInfoLearn)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsFindFails=fdbStatsFindFails, vlan=vlan, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstGeneralCfg=mstGeneralCfg, cistRoot=cistRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbRefSps=fdbRefSps, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoJumbo=vlanInfoJumbo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbState=fdbState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgStpMode=mstCurCfgStpMode)
