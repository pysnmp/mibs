...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortLinkType=stpInfoPortLinkType, cistRegionalPathCost=cistRegionalPathCost, lacp=lacp, fdbStatsCreates=fdbStatsCreates, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRoot=cistRoot, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCfg=stgCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, mstCfg=mstCfg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRootPort=cistRootPort, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoName=vlanInfoName, vlanInfoLearn=vlanInfoLearn, stpInfo=stpInfo, fdbEntry=fdbEntry, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstNewCfgRegionName=mstNewCfgRegionName, vlanMaxEnt=vlanMaxEnt, fdbStatsFinds=fdbStatsFinds, fdbStatsOverflows=fdbStatsOverflows, vlanInfoTable=vlanInfoTable, vlanCurCfgState=vlanCurCfgState, cistInfoPortTable=cistInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoIndex=stpInfoIndex, vlanInfoPorts=vlanInfoPorts, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoRootPort=stpInfoRootPort, fdbInfo=fdbInfo, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistBridgeCfg=mstCistBridgeCfg, trunkgroup=trunkgroup, stgNewCfgState=stgNewCfgState, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortIndex=cistInfoPortIndex, lacpInfo=lacpInfo, lacpCurPortState=lacpCurPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, BridgeId=BridgeId, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCfg=portTeamCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbRefSps=fdbRefSps, cistRootPathCost=cistRootPathCost, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, PYSNMP_MODULE_ID=layer2, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, layer2Configs=layer2Configs, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgState=mstNewCfgState, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgState=portTeamCurCfgState, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortState=stpInfoPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgIndex=portTeamCurCfgIndex, layer2Info=layer2Info, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoIndex=portTeamInfoIndex, vlan=vlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgState=stgCurCfgState, vlanMaxVlanID=vlanMaxVlanID, fdbTable=fdbTable, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCfg=mstCistCfg, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgTable=stgNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortState=stgNewCfgPortState, fdbLearnedPort=fdbLearnedPort, cistInfo=cistInfo, layer2Oper=layer2Oper, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbSrcPort=fdbSrcPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfo=vlanInfo, fdbState=fdbState, vlanInfoJumbo=vlanInfoJumbo, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbVlan=fdbVlan, mirrPortMirr=mirrPortMirr, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, layer2Stats=layer2Stats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stpStats=stpStats, vlanInfoStatus=vlanInfoStatus, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortTable=mstCistCurCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, lacpInfoPortTable=lacpInfoPortTable, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbClear=fdbClear, fdbStats=fdbStats, stpInfoTable=stpInfoTable, stpInfoPortRole=stpInfoPortRole, stgStatsPortTable=stgStatsPortTable, portTeamInfoTable=portTeamInfoTable, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortLinkType=cistInfoPortLinkType, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistGeneralInfo=cistGeneralInfo, portTeamInfo=portTeamInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoId=vlanInfoId, portTeamInfoState=portTeamInfoState)
