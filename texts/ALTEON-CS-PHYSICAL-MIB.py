...
ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, Gauge32, Integer32, MibIdentifier, Counter32, NotificationType, TimeTicks, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "Gauge32", "Integer32", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoJumbo=vlanInfoJumbo, cistRoot=cistRoot, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgState=mstCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoName=vlanInfoName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbEntry=fdbEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfo=cistInfo, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortIndex=cistInfoPortIndex, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortState=stpInfoPortState, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbRefSps=fdbRefSps, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanMaxVlanID=vlanMaxVlanID, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfo=vlanInfo, stpInfoIndex=stpInfoIndex, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2Oper=layer2Oper, fdbStatsOverflows=fdbStatsOverflows, stgStatsStpIndex=stgStatsStpIndex, vlan=vlan, mstCfg=mstCfg, portTeamInfo=portTeamInfo, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoTable=stpInfoTable, portTeamNewCfgState=portTeamNewCfgState, fdbStatsFinds=fdbStatsFinds, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgState=stgNewCfgState, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Stats=layer2Stats, stgStatsPortTable=stgStatsPortTable, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortState=lacpNewPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortRole=stpInfoPortRole, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoPorts=vlanInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRootPort=cistRootPort, cistRegionalRoot=cistRegionalRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbSrcPort=fdbSrcPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgState=vlanNewCfgState, stgNewCfgTable=stgNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsDeletes=fdbStatsDeletes, lacpCurPortState=lacpCurPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCfg=portTeamCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, cistBridgeMaxAge=cistBridgeMaxAge, fdbMacAddr=fdbMacAddr, lacpCurSystemPriority=lacpCurSystemPriority, BridgeId=BridgeId, stpStats=stpStats, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfo=lacpInfo, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoRootCost=stpInfoRootCost, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbState=fdbState, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Info=layer2Info, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoState=portTeamInfoState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStats=fdbStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCfg=stgCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, layer2=layer2, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacp=lacp, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbTable=fdbTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgState=stgCurCfgState, cistRootPathCost=cistRootPathCost, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbClear=fdbClear, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbVlan=fdbVlan, fdbStatsCurrent=fdbStatsCurrent, stpInfo=stpInfo, vlanInfoTable=vlanInfoTable, vlanMaxEnt=vlanMaxEnt, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortState=cistInfoPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortEdge=stpInfoPortEdge, fdbInfo=fdbInfo, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgState=mstNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkgroup=trunkgroup, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgStg=vlanCurCfgStg, cistInfoPortTable=cistInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgVlanId=vlanCurCfgVlanId, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoId=vlanInfoId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTable=stgCurCfgPortTable, mirroring=mirroring, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstGeneralCfg=mstGeneralCfg, vlanInfoLearn=vlanInfoLearn, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2Configs=layer2Configs, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry)
