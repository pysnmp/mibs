...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, PYSNMP_MODULE_ID=layer2, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mirrPortMirr=mirrPortMirr, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoName=vlanInfoName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Stats=layer2Stats, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbSrcPort=fdbSrcPort, mstCurCfgState=mstCurCfgState, mirroring=mirroring, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgStpMode=mstNewCfgStpMode, BridgeId=BridgeId, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkgroup=trunkgroup, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoTable=stpInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbState=fdbState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortRole=stpInfoPortRole, cistRegionalPathCost=cistRegionalPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Info=layer2Info, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlan=vlan, vlanInfoLearn=vlanInfoLearn, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgState=vlanCurCfgState, fdbStats=fdbStats, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortState=lacpCurPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgState=stgCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Configs=layer2Configs, stgCfg=stgCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfo=portTeamInfo, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgState=portTeamCurCfgState, fdbVlan=fdbVlan, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsOverflows=fdbStatsOverflows, cistBridgeMaxAge=cistBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRoot=cistRoot, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgRegionName=mstNewCfgRegionName, mstCfg=mstCfg, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, stpInfo=stpInfo, cistInfoPortTable=cistInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbInfo=fdbInfo, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortState=stpInfoPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, layer2Oper=layer2Oper, portTeamInfoIndex=portTeamInfoIndex, stpInfoRootPort=stpInfoRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoRootCost=stpInfoRootCost, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortState=cistInfoPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfo=lacpInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRootPathCost=cistRootPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbEntry=fdbEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCfg=mstCistCfg, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgState=vlanNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfo=cistInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCfg=portTeamCfg, portTeamInfoState=portTeamInfoState, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbRefSps=fdbRefSps, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbSrcTrunk=fdbSrcTrunk, fdbStatsCreates=fdbStatsCreates, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStatsCurrent=fdbStatsCurrent, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortEdge=stpInfoPortEdge, cistRootPort=cistRootPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanMaxEnt=vlanMaxEnt, layer2=layer2, lacp=lacp, fdbLearnedPort=fdbLearnedPort, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortRole=cistInfoPortRole, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoId=vlanInfoId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoPorts=portTeamInfoPorts, mstGeneralCfg=mstGeneralCfg, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortTable=stpInfoPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoIndex=stpInfoIndex, fdbClear=fdbClear, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanName=vlanCurCfgVlanName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortTable=stgStatsPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgState=mstNewCfgState, stpStats=stpStats, fdbStatsFinds=fdbStatsFinds, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoTable=portTeamInfoTable, vlanInfoJumbo=vlanInfoJumbo, fdbTable=fdbTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoPorts=vlanInfoPorts, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbMacAddr=fdbMacAddr, vlanInfo=vlanInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsLookups=fdbStatsLookups, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority)
