...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoRootCost=stpInfoRootCost, lacpInfoPortNtt=lacpInfoPortNtt, lacp=lacp, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortTable=stgCurCfgPortTable, cistRegionalPathCost=cistRegionalPathCost, portTeamInfo=portTeamInfo, pmNewCfgAddVlan=pmNewCfgAddVlan, vlan=vlan, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTable=stpInfoTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRegionalRoot=cistRegionalRoot, stgCurCfgStgIndex=stgCurCfgStgIndex, cistBridgeHelloTime=cistBridgeHelloTime, layer2Configs=layer2Configs, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortEdge=stpInfoPortEdge, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbEntry=fdbEntry, layer2=layer2, fdbStatsOverflows=fdbStatsOverflows, BridgeId=BridgeId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoStatus=vlanInfoStatus, fdbTable=fdbTable, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfo=stpInfo, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbSrcTrunk=fdbSrcTrunk, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsLookups=fdbStatsLookups, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortTable=cistInfoPortTable, lacpNewPortState=lacpNewPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTable=stgStatsPortTable, mirrPortMirr=mirrPortMirr, stpInfoPortState=stpInfoPortState, lacpInfoPortTable=lacpInfoPortTable, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoIndex=stpInfoIndex, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoForwardDelay=stpInfoForwardDelay, fdbState=fdbState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbInfo=fdbInfo, stgCurCfgState=stgCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoJumbo=vlanInfoJumbo, lacpNewSystemPriority=lacpNewSystemPriority, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgTable=vlanCurCfgTable, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPorts=portTeamInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgState=vlanNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCfg=stgCfg, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbClear=fdbClear, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, layer2Stats=layer2Stats, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbMacAddr=fdbMacAddr, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbVlan=fdbVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbLearnedPort=fdbLearnedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoId=vlanInfoId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstGeneralCfg=mstGeneralCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortState=lacpCurPortState, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanMaxEnt=vlanMaxEnt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbRefSps=fdbRefSps, vlanCurCfgPorts=vlanCurCfgPorts, mirroring=mirroring, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoTable=vlanInfoTable, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortReadyN=lacpInfoPortReadyN, PYSNMP_MODULE_ID=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoName=vlanInfoName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortTable=stpInfoPortTable, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Info=layer2Info, mstCistBridgeCfg=mstCistBridgeCfg, layer2Oper=layer2Oper, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRootPort=cistRootPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCfg=mstCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgState=vlanCurCfgState, vlanInfo=vlanInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfo=cistInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStats=fdbStats, trunkgroup=trunkgroup, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbSrcPort=fdbSrcPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortRole=cistInfoPortRole, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpStats=stpStats, vlanInfoLearn=vlanInfoLearn, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPriority=stgNewCfgPriority, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsStpIndex=stgStatsStpIndex, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamCfg=portTeamCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTable=portTeamInfoTable, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTable=stgNewCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoRootPort=stpInfoRootPort, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgState=mstCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortState=cistInfoPortState, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsFinds=fdbStatsFinds, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortRole=stpInfoPortRole, cistRoot=cistRoot, lacpInfo=lacpInfo, cistGeneralInfo=cistGeneralInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCfg=mstCistCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus)
