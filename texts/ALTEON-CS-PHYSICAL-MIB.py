...
ModuleIdentity, Counter64, IpAddress, Unsigned32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, NotificationType, Counter32, Integer32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "IpAddress", "Unsigned32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "NotificationType", "Counter32", "Integer32", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Oper=layer2Oper, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbState=fdbState, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsHiwat=fdbStatsHiwat, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgTable=stgCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, mstGeneralCfg=mstGeneralCfg, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCreates=fdbStatsCreates, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRoot=cistRoot, cistInfoPortRole=cistInfoPortRole, layer2Info=layer2Info, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, cistRegionalRoot=cistRegionalRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoHelloTime=stpInfoHelloTime, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfo=portTeamInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2=layer2, vlanNewCfgLearn=vlanNewCfgLearn, BridgeId=BridgeId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistRootPathCost=cistRootPathCost, mstCistCfg=mstCistCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStats=fdbStats, portTeamInfoIndex=portTeamInfoIndex, vlanInfoId=vlanInfoId, stpInfoRootPort=stpInfoRootPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoIndex=stpInfoIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbRefSps=fdbRefSps, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbMacAddr=fdbMacAddr, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTable=portTeamInfoTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoTable=stpInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgState=stgNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCfg=mstCfg, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgTable=portTeamCurCfgTable, trunkgroup=trunkgroup, mirroring=mirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgState=stgCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbSrcPort=fdbSrcPort, cistInfoPortState=cistInfoPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortTable=stpInfoPortTable, layer2Stats=layer2Stats, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgPorts=vlanNewCfgPorts, stgCfg=stgCfg, lacpInfoPortMoved=lacpInfoPortMoved, cistRootPort=cistRootPort, cistBridgeMaxAge=cistBridgeMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, fdbVlan=fdbVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfo=stpInfo, cistInfo=cistInfo, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoState=portTeamInfoState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoTable=vlanInfoTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortRole=stpInfoPortRole, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgState=trunkGroupNewCfgState, layer2Configs=layer2Configs, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoPorts=vlanInfoPorts, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, cistGeneralInfo=cistGeneralInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfo=vlanInfo, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgState=mstCurCfgState, fdbInfo=fdbInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, fdbStatsOverflows=fdbStatsOverflows, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbSrcTrunk=fdbSrcTrunk, stpInfoRootCost=stpInfoRootCost, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfo=lacpInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortIndex=stpInfoPortIndex, PYSNMP_MODULE_ID=layer2, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, lacp=lacp, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoName=vlanInfoName, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsLookups=fdbStatsLookups, vlanNewCfgState=vlanNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode, mirrPortMirr=mirrPortMirr, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbClear=fdbClear, stpStats=stpStats, vlan=vlan, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbEntry=fdbEntry, stpInfoMaxAge=stpInfoMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgIndex=stgCurCfgIndex, fdbTable=fdbTable, lacpNewPortState=lacpNewPortState, stgCurCfgPriority=stgCurCfgPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanMaxEnt=vlanMaxEnt, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, portTeamCfg=portTeamCfg, vlanCurCfgState=vlanCurCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgTable=stgNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortState=stpInfoPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
