...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgTable=vlanCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgTable=stgNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoTableEntry=stpInfoTableEntry, mstCistCfg=mstCistCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistRoot=cistRoot, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortRole=stpInfoPortRole, vlanCurCfgJumbo=vlanCurCfgJumbo, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mirrPortMirr=mirrPortMirr, mstGeneralCfg=mstGeneralCfg, fdbEntry=fdbEntry, vlanInfoName=vlanInfoName, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTable=stpInfoTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistRootPort=cistRootPort, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTable=portTeamInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbSrcTrunk=fdbSrcTrunk, stgCfg=stgCfg, stgStatsStpIndex=stgStatsStpIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfo=vlanInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbRefSps=fdbRefSps, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoStatus=vlanInfoStatus, stpInfoPortState=stpInfoPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortTable=stpInfoPortTable, mirroring=mirroring, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCfg=portTeamCfg, stgCurCfgIndex=stgCurCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsDeletes=fdbStatsDeletes, fdbTable=fdbTable, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfo=portTeamInfo, stgNewCfgState=stgNewCfgState, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpStats=stpStats, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortPriority=cistInfoPortPriority, fdbMacAddr=fdbMacAddr, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbClear=fdbClear, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistRootPathCost=cistRootPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfo=cistInfo, portTeamInfoIndex=portTeamInfoIndex, fdbStatsFindFails=fdbStatsFindFails, layer2Oper=layer2Oper, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, layer2Configs=layer2Configs, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbState=fdbState, lacp=lacp, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgTable=stgCurCfgTable, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgState=stgCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgPorts=vlanCurCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoId=vlanInfoId, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2Info=layer2Info, vlanCurCfgState=vlanCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, PYSNMP_MODULE_ID=layer2, vlanInfoPorts=vlanInfoPorts, vlanInfoJumbo=vlanInfoJumbo, BridgeId=BridgeId, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, stpInfoRootPort=stpInfoRootPort, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoPorts=portTeamInfoPorts, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgStg=vlanNewCfgStg, stpInfoRootCost=stpInfoRootCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgState=mstNewCfgState, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortState=lacpCurPortState, lacpNewPortState=lacpNewPortState, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortEdge=stpInfoPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTable=portTeamNewCfgTable, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfo=stpInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, layer2Stats=layer2Stats, cistGeneralInfo=cistGeneralInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2=layer2, trunkgroup=trunkgroup, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortState=cistInfoPortState, fdbStatsCreates=fdbStatsCreates, fdbLearnedPort=fdbLearnedPort, mstCfg=mstCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoForwardDelay=stpInfoForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgStg=vlanCurCfgStg, fdbVlan=fdbVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlan=vlan, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoIndex=stpInfoIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbInfo=fdbInfo, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, lacpInfo=lacpInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStats=fdbStats, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk)
