...
ObjectIdentity, iso, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Integer32, Gauge32, Counter64, ModuleIdentity, MibIdentifier, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Integer32", "Gauge32", "Counter64", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortReadyN=lacpInfoPortReadyN, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortTable=lacpInfoPortTable, stgCfg=stgCfg, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortPriority=cistInfoPortPriority, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortTable=cistInfoPortTable, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortRole=cistInfoPortRole, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfo=cistInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbSrcPort=fdbSrcPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbInfo=fdbInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStats=fdbStats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, vlan=vlan, portTeamInfoState=portTeamInfoState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCurCfgTable=portTeamCurCfgTable, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgState=stgCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgStatsPortTable=stgStatsPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPathCost=cistRootPathCost, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortIndex=cistInfoPortIndex, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2=layer2, portTeamInfoTable=portTeamInfoTable, mstCistDefaultCfg=mstCistDefaultCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortState=lacpNewPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgState=mstNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoTrunks=portTeamInfoTrunks, cistGeneralInfo=cistGeneralInfo, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbLearnedPort=fdbLearnedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbRefSps=fdbRefSps, vlanNewCfgDelete=vlanNewCfgDelete, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoRootCost=stpInfoRootCost, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsFinds=fdbStatsFinds, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfoPortIndex=lacpInfoPortIndex, trunkgroup=trunkgroup, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgState=vlanNewCfgState, fdbClear=fdbClear, stpInfoTable=stpInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, vlanInfoLearn=vlanInfoLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCfg=portTeamCfg, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoStatus=vlanInfoStatus, stgNewCfgAddVlan=stgNewCfgAddVlan, layer2Info=layer2Info, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, layer2Stats=layer2Stats, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookups=fdbStatsLookups, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, stpInfoTableEntry=stpInfoTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsStpIndex=stgStatsStpIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoTable=vlanInfoTable, fdbMacAddr=fdbMacAddr, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgState=stgNewCfgState, cistRoot=cistRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortCfgTable=lacpCurPortCfgTable, mirroring=mirroring, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, BridgeId=BridgeId, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortState=lacpCurPortState, cistInfoPortState=cistInfoPortState, portTeamInfoIndex=portTeamInfoIndex, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbVlan=fdbVlan, stpInfoPortState=stpInfoPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbState=fdbState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFindFails=fdbStatsFindFails, layer2Configs=layer2Configs, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRootPort=cistRootPort, vlanCurCfgState=vlanCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstGeneralCfg=mstGeneralCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfo=vlanInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgTable=stgNewCfgTable, stpStats=stpStats, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoPorts=portTeamInfoPorts, stpInfoHelloTime=stpInfoHelloTime, mstCfg=mstCfg, portTeamInfo=portTeamInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgLearn=vlanNewCfgLearn, stpInfo=stpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgStgIndex=stgCurCfgStgIndex, lacp=lacp, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoId=vlanInfoId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbTable=fdbTable, lacpInfo=lacpInfo, mstCistCfg=mstCistCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanInfoName=vlanInfoName, layer2Oper=layer2Oper, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
