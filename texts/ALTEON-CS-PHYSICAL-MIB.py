...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, TimeTicks, Integer32, iso, Bits, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "TimeTicks", "Integer32", "iso", "Bits", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsLookups=fdbStatsLookups, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoRootCost=stpInfoRootCost, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbVlan=fdbVlan, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCurCfgState=mstCurCfgState, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Configs=layer2Configs, vlanInfoTable=vlanInfoTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortTable=stpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortIndex=stpInfoPortIndex, fdbTable=fdbTable, fdbEntry=fdbEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbRefSps=fdbRefSps, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, fdbClear=fdbClear, stpInfoPortEdge=stpInfoPortEdge, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortTable=stgStatsPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortRole=stpInfoPortRole, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCfg=portTeamCfg, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgState=mstNewCfgState, cistRoot=cistRoot, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbInfo=fdbInfo, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortTable=cistInfoPortTable, stpInfo=stpInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortPriority=cistInfoPortPriority, vlanInfoStatus=vlanInfoStatus, vlanCurCfgState=vlanCurCfgState, vlanInfo=vlanInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRootPort=cistRootPort, layer2Oper=layer2Oper, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsFinds=fdbStatsFinds, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoTable=stpInfoTable, fdbMacAddr=fdbMacAddr, stpInfoPortPathCost=stpInfoPortPathCost, BridgeId=BridgeId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgState=stgCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkgroup=trunkgroup, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgTable=stgNewCfgTable, stpInfoIndex=stpInfoIndex, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistRegionalRoot=cistRegionalRoot, vlanInfoLearn=vlanInfoLearn, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCfg=mstCistCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortIndex=stgStatsPortIndex, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoHelloTime=stpInfoHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfo=lacpInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortRole=cistInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, layer2Info=layer2Info, vlanInfoTableEntry=vlanInfoTableEntry, fdbSrcPort=fdbSrcPort, lacpCurPortState=lacpCurPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoMaxAge=stpInfoMaxAge, cistInfo=cistInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoId=vlanInfoId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortState=cistInfoPortState, fdbStatsDeletes=fdbStatsDeletes, layer2=layer2, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTable=portTeamInfoTable, fdbState=fdbState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortState=stgNewCfgPortState, stpStats=stpStats, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirroring=mirroring, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgRegionName=mstCurCfgRegionName, layer2Stats=layer2Stats, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoName=vlanInfoName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlan=vlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoState=portTeamInfoState, vlanMaxEnt=vlanMaxEnt, fdbStats=fdbStats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgState=stgNewCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfo=portTeamInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPriority=stgNewCfgPriority, mstCfg=mstCfg, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCfg=stgCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortState=stpInfoPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, lacp=lacp, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstGeneralCfg=mstGeneralCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge)
