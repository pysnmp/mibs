...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbLearnedPort=fdbLearnedPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfo=vlanInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsCreates=fdbStatsCreates, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbMacAddr=fdbMacAddr, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanMaxVlanID=vlanMaxVlanID, vlan=vlan, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfo=lacpInfo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, fdbSrcPort=fdbSrcPort, stgCurCfgPortTable=stgCurCfgPortTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortTableEntry=stpInfoPortTableEntry, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoTopChanges=stpInfoTopChanges, lacp=lacp, fdbClear=fdbClear, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoIndex=stpInfoIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgState=stgCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbTable=fdbTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgState=portTeamCurCfgState, stpInfo=stpInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortIndex=cistInfoPortIndex, fdbEntry=fdbEntry, cistInfoPortState=cistInfoPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistRootPathCost=cistRootPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstGeneralCfg=mstGeneralCfg, fdbStatsLookups=fdbStatsLookups, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurPortState=lacpCurPortState, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoJumbo=vlanInfoJumbo, mstCurCfgState=mstCurCfgState, vlanInfoTable=vlanInfoTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgState=stgNewCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoRootPort=stpInfoRootPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2=layer2, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoState=portTeamInfoState, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, stpStats=stpStats, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsCurrent=fdbStatsCurrent, portTeamCfg=portTeamCfg, trunkgroup=trunkgroup, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoName=vlanInfoName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCfg=mstCistCfg, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, cistRootPort=cistRootPort, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTable=stpInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoStatus=vlanInfoStatus, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfo=portTeamInfo, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortState=lacpNewPortState, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbState=fdbState, vlanMaxEnt=vlanMaxEnt, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, fdbRefSps=fdbRefSps, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgTable=vlanNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, layer2Stats=layer2Stats, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, BridgeId=BridgeId, stgNewCfgPriority=stgNewCfgPriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mirroring=mirroring, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, PYSNMP_MODULE_ID=layer2, mstCfg=mstCfg, stgCfg=stgCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTable=portTeamInfoTable, cistInfo=cistInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortState=stpInfoPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoRootCost=stpInfoRootCost, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgState=portTeamNewCfgState, layer2Oper=layer2Oper, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, layer2Info=layer2Info, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsStpIndex=stgStatsStpIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortPriority=stgCurCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgTable=stgCurCfgTable, fdbVlan=fdbVlan, fdbStats=fdbStats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Configs=layer2Configs, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortRole=cistInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortRole=stpInfoPortRole, cistGeneralInfo=cistGeneralInfo, vlanInfoId=vlanInfoId, lacpInfoPortTable=lacpInfoPortTable, fdbInfo=fdbInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts)
