...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, IpAddress, Counter32, Integer32, Bits, Counter64, Unsigned32, ObjectIdentity, iso, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "IpAddress", "Counter32", "Integer32", "Bits", "Counter64", "Unsigned32", "ObjectIdentity", "iso", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortPriority=cistInfoPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbVlan=fdbVlan, fdbTable=fdbTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsLookups=fdbStatsLookups, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortState=stgNewCfgPortState, fdbStatsCreates=fdbStatsCreates, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoState=portTeamInfoState, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbRefSps=fdbRefSps, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistBridgeCfg=mstCistBridgeCfg, stgCfg=stgCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2Stats=layer2Stats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoTable=stpInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgState=mstCurCfgState, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpStats=stpStats, vlanInfo=vlanInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mirroring=mirroring, cistRootPort=cistRootPort, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoPorts=vlanInfoPorts, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRegionalRoot=cistRegionalRoot, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbInfo=fdbInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgState=stgNewCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortIndex=cistInfoPortIndex, mstCistCfg=mstCistCfg, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsDeletes=fdbStatsDeletes, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, cistGeneralInfo=cistGeneralInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbEntry=fdbEntry, mirrPortMirr=mirrPortMirr, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStats=fdbStats, vlanInfoName=vlanInfoName, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Configs=layer2Configs, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbClear=fdbClear, fdbMacAddr=fdbMacAddr, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortState=stpInfoPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCfg=mstCfg, layer2Info=layer2Info, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgState=stgCurCfgState, vlanInfoStatus=vlanInfoStatus, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, cistRootPathCost=cistRootPathCost, cistInfoPortState=cistInfoPortState, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfo=stpInfo, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortState=lacpNewPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkgroup=trunkgroup, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsHiwat=fdbStatsHiwat, fdbState=fdbState, stpInfoIndex=stpInfoIndex, PYSNMP_MODULE_ID=layer2, cistRoot=cistRoot, cistRegionalPathCost=cistRegionalPathCost, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoLearn=vlanInfoLearn, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortTable=cistInfoPortTable, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfo=lacpInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortRole=stpInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2=layer2, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, vlan=vlan, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoBwmContract=vlanInfoBwmContract, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, layer2Oper=layer2Oper, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgJumbo=vlanNewCfgJumbo, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfo=portTeamInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbLearnedPort=fdbLearnedPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTable=stpInfoPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTable=stgNewCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfo=cistInfo, portTeamCfg=portTeamCfg, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurPortState=lacpCurPortState, stpInfoRootCost=stpInfoRootCost, vlanInfoId=vlanInfoId, stpInfoTableEntry=stpInfoTableEntry, BridgeId=BridgeId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoPorts=portTeamInfoPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacp=lacp, stgStatsPortTable=stgStatsPortTable, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
