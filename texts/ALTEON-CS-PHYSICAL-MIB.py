...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortTable=cistInfoPortTable, cistRootPort=cistRootPort, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortState=lacpNewPortState, stgCurCfgIndex=stgCurCfgIndex, stpInfoRootPort=stpInfoRootPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTable=lacpInfoPortTable, cistRegionalRoot=cistRegionalRoot, stpInfo=stpInfo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, fdbTable=fdbTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTable=stpInfoTable, fdbInfo=fdbInfo, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortRole=stpInfoPortRole, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacp=lacp, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfo=cistInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistGeneralInfo=cistGeneralInfo, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortTable=stgNewCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoState=portTeamInfoState, fdbStatsLookups=fdbStatsLookups, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgState=mstCurCfgState, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStats=fdbStats, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbMacAddr=fdbMacAddr, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoPorts=portTeamInfoPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpCurPortState=lacpCurPortState, cistRoot=cistRoot, cistInfoPortIndex=cistInfoPortIndex, PYSNMP_MODULE_ID=layer2, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, mirrPortMirr=mirrPortMirr, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgStg=vlanCurCfgStg, layer2Configs=layer2Configs, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbEntry=fdbEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPortState=stgNewCfgPortState, layer2Info=layer2Info, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoStatus=vlanInfoStatus, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfo=vlanInfo, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortEdge=stpInfoPortEdge, mirroring=mirroring, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFinds=fdbStatsFinds, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortTable=stgStatsPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlan=vlan, mstCistCfg=mstCistCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRootPathCost=cistRootPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistDefaultCfg=mstCistDefaultCfg, stpStats=stpStats, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgTable=stgCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbVlan=fdbVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, BridgeId=BridgeId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2=layer2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbState=fdbState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, vlanMaxEnt=vlanMaxEnt, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkgroup=trunkgroup, stgCfg=stgCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTable=portTeamInfoTable, stgNewCfgState=stgNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2Oper=layer2Oper, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortState=stpInfoPortState, portTeamCfg=portTeamCfg, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbClear=fdbClear, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoName=vlanInfoName, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgState=portTeamNewCfgState, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgState=mstNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfo=portTeamInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Stats=layer2Stats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfoId=vlanInfoId, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortState=cistInfoPortState, mstCfg=mstCfg, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, fdbLearnedPort=fdbLearnedPort, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoIndex=stpInfoIndex, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbRefSps=fdbRefSps, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortRole=cistInfoPortRole, stgNewCfgTable=stgNewCfgTable, lacpInfo=lacpInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoJumbo=vlanInfoJumbo, vlanInfoPorts=vlanInfoPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstGeneralCfg=mstGeneralCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgTable=vlanNewCfgTable)
