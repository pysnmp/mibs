...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCfg=mstCistCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbTable=fdbTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlan=vlan, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, cistRoot=cistRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfo=portTeamInfo, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoPorts=portTeamInfoPorts, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, lacp=lacp, lacpCurPortState=lacpCurPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgIndex=stgCurCfgIndex, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfo=stpInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpStats=stpStats, vlanInfoId=vlanInfoId, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsFinds=fdbStatsFinds, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoState=portTeamInfoState, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbSrcTrunk=fdbSrcTrunk, trunkgroup=trunkgroup, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeMaxAge=cistBridgeMaxAge, mirroring=mirroring, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortState=stpInfoPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortRole=stpInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, fdbState=fdbState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPriority=stgNewCfgPriority, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortRole=cistInfoPortRole, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgState=portTeamNewCfgState, layer2Stats=layer2Stats, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbEntry=fdbEntry, cistInfoPortIndex=cistInfoPortIndex, stpInfoHoldTime=stpInfoHoldTime, fdbClear=fdbClear, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, BridgeId=BridgeId, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoHelloTime=stpInfoHelloTime, mstCfg=mstCfg, PYSNMP_MODULE_ID=layer2, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgState=mstNewCfgState, portTeamInfoTable=portTeamInfoTable, fdbStatsCurrent=fdbStatsCurrent, fdbSrcPort=fdbSrcPort, lacpInfoPortMoved=lacpInfoPortMoved, layer2Oper=layer2Oper, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbInfo=fdbInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgState=vlanCurCfgState, stgCurCfgTable=stgCurCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, cistInfo=cistInfo, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgState=stgCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortTable=stpInfoPortTable, fdbStats=fdbStats, cistRegionalRoot=cistRegionalRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortLinkType=cistInfoPortLinkType, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoIndex=stpInfoIndex, fdbLearnedPort=fdbLearnedPort, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoName=vlanInfoName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, layer2=layer2, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoPortsState=portTeamInfoPortsState, fdbVlan=fdbVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbRefSps=fdbRefSps, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRootPathCost=cistRootPathCost, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortTableEntry=cistInfoPortTableEntry, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfo=vlanInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanMaxEnt=vlanMaxEnt, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfo=lacpInfo, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgState=mstCurCfgState, mirrPortMirr=mirrPortMirr, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortTable=cistInfoPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCfg=stgCfg, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortLinkType=stpInfoPortLinkType, lacpCurSystemPriority=lacpCurSystemPriority, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTable=stpInfoTable, cistRootPort=cistRootPort, layer2Info=layer2Info, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortState=lacpNewPortState, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFindFails=fdbStatsFindFails, layer2Configs=layer2Configs, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsCreates=fdbStatsCreates, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsLookups=fdbStatsLookups, portTeamCfg=portTeamCfg, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortIndex=stpInfoPortIndex, fdbMacAddr=fdbMacAddr, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry)
