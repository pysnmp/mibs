...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortState=cistInfoPortState, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfo=vlanInfo, fdbInfo=fdbInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoRootCost=stpInfoRootCost, stpInfoPortTable=stpInfoPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mirroring=mirroring, stpInfo=stpInfo, layer2Configs=layer2Configs, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCfg=mstCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, BridgeId=BridgeId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStats=fdbStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, mirrPortMirr=mirrPortMirr, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoPorts=portTeamInfoPorts, fdbState=fdbState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Info=layer2Info, cistRegionalPathCost=cistRegionalPathCost, stpStats=stpStats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoPorts=vlanInfoPorts, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgState=mstCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortIndex=stgStatsPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgTable=vlanCurCfgTable, vlanInfoId=vlanInfoId, PYSNMP_MODULE_ID=layer2, stgCurCfgTable=stgCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortTable=stgStatsPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoIndex=portTeamInfoIndex, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbRefSps=fdbRefSps, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsHiwat=fdbStatsHiwat, fdbStatsOverflows=fdbStatsOverflows, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoName=vlanInfoName, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTable=stpInfoTable, layer2Stats=layer2Stats, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortMoved=lacpInfoPortMoved, cistInfo=cistInfo, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortRole=cistInfoPortRole, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgState=stgNewCfgState, vlan=vlan, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTable=portTeamInfoTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, fdbEntry=fdbEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, layer2Oper=layer2Oper, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfo=lacpInfo, portTeamInfo=portTeamInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCfg=stgCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoIndex=stpInfoIndex, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoTableEntry=stpInfoTableEntry, portTeamCfg=portTeamCfg, layer2=layer2, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbVlan=fdbVlan, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgState=portTeamNewCfgState, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsDeletes=fdbStatsDeletes, fdbStatsLookups=fdbStatsLookups, fdbStatsFinds=fdbStatsFinds, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgState=stgCurCfgState, mstGeneralCfg=mstGeneralCfg, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortLink=stgCurCfgPortLink, trunkgroup=trunkgroup, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, cistRoot=cistRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortState=lacpCurPortState, stgCurCfgPriority=stgCurCfgPriority, fdbSrcPort=fdbSrcPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoHoldTime=stpInfoHoldTime, lacp=lacp, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, vlanCurCfgState=vlanCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoState=portTeamInfoState, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortIndex=cistInfoPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortState=stpInfoPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookupFails=fdbStatsLookupFails, cistRootPort=cistRootPort, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewPortState=lacpNewPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoTable=vlanInfoTable, stpInfoPortRole=stpInfoPortRole, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgState=mstNewCfgState, fdbClear=fdbClear, mstCistCfg=mstCistCfg, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbTable=fdbTable, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsCreates=fdbStatsCreates, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState)
