...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortIndex=stpInfoPortIndex, cistRegionalPathCost=cistRegionalPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortEdge=stpInfoPortEdge, stpInfo=stpInfo, fdbClear=fdbClear, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRootPort=cistRootPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacp=lacp, stpInfoRootCost=stpInfoRootCost, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, layer2Info=layer2Info, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Oper=layer2Oper, stpInfoPortState=stpInfoPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, mirrPortMirr=mirrPortMirr, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, vlanMaxEnt=vlanMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbMacAddr=fdbMacAddr, fdbVlan=fdbVlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCfg=stgCfg, lacpNewPortState=lacpNewPortState, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortTable=stgStatsPortTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCfg=portTeamCfg, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortRole=cistInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, mstGeneralCfg=mstGeneralCfg, cistInfoPortTable=cistInfoPortTable, trunkgroup=trunkgroup, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortSelected=lacpInfoPortSelected, layer2Stats=layer2Stats, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTable=stpInfoTable, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookups=fdbStatsLookups, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoName=vlanInfoName, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoState=portTeamInfoState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, fdbTable=fdbTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistRootPathCost=cistRootPathCost, mirroring=mirroring, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbEntry=fdbEntry, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgState=vlanNewCfgState, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, mstCfg=mstCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurPortState=lacpCurPortState, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgState=mstNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbSrcPort=fdbSrcPort, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsHiwat=fdbStatsHiwat, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, layer2=layer2, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortTable=stpInfoPortTable, fdbStats=fdbStats, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistRegionalRoot=cistRegionalRoot, fdbInfo=fdbInfo, lacpInfo=lacpInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, BridgeId=BridgeId, vlanMaxVlanID=vlanMaxVlanID, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgAddVlan=stgNewCfgAddVlan, PYSNMP_MODULE_ID=layer2, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlan=vlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortRole=stpInfoPortRole, mstCistCfg=mstCistCfg, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoIndex=stpInfoIndex, stgNewCfgPortTable=stgNewCfgPortTable, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHelloTime=stpInfoHelloTime, fdbState=fdbState, cistInfo=cistInfo, stgCurCfgState=stgCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoId=vlanInfoId, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgTable=stgNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTable=portTeamInfoTable, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsDeletes=fdbStatsDeletes, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbRefSps=fdbRefSps)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgAddVlan=pmNewCfgAddVlan, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, layer2Configs=layer2Configs, stpStats=stpStats, portTeamInfo=portTeamInfo, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgState=portTeamNewCfgState, vlanInfo=vlanInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsCreates=fdbStatsCreates, cistRoot=cistRoot, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortPriority=cistInfoPortPriority, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoStatus=vlanInfoStatus)
