...
TimeTicks, NotificationType, Gauge32, ObjectIdentity, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Unsigned32, Integer32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Unsigned32", "Integer32", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortTable=stpInfoPortTable, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsCreates=fdbStatsCreates, vlanMaxEnt=vlanMaxEnt, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistBridgeMaxAge=cistBridgeMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoTable=vlanInfoTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoId=vlanInfoId, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgTable=vlanCurCfgTable, BridgeId=BridgeId, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacp=lacp, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoRootCost=stpInfoRootCost, cistInfoPortTable=cistInfoPortTable, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfo=lacpInfo, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPort=cistRootPort, mirroring=mirroring, vlanCurCfgState=vlanCurCfgState, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Info=layer2Info, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoState=portTeamInfoState, cistInfoPortState=cistInfoPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortIndex=lacpInfoPortIndex, cistInfo=cistInfo, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgState=stgCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, vlanCurCfgStg=vlanCurCfgStg, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortState=stgCurCfgPortState, fdbTable=fdbTable, fdbRefSps=fdbRefSps, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortPathCost=cistInfoPortPathCost, cistRoot=cistRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, fdbVlan=fdbVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoTable=portTeamInfoTable, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfo=vlanInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortLink=stgNewCfgPortLink, fdbLearnedPort=fdbLearnedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, fdbInfo=fdbInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoIndex=stpInfoIndex, fdbEntry=fdbEntry, mstCfg=mstCfg, stpInfoPortRole=stpInfoPortRole, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCurCfgState=mstCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, PYSNMP_MODULE_ID=layer2, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgState=vlanNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfo=portTeamInfo, vlanInfoName=vlanInfoName, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCfg=stgCfg, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoPorts=vlanInfoPorts, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mirrPortMirr=mirrPortMirr, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkgroup=trunkgroup, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbClear=fdbClear, cistBridgeHelloTime=cistBridgeHelloTime, vlan=vlan, cistGeneralInfo=cistGeneralInfo, vlanNewCfgLearn=vlanNewCfgLearn, layer2Stats=layer2Stats, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCfg=mstCistCfg, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Oper=layer2Oper, layer2=layer2, stpStats=stpStats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, fdbMacAddr=fdbMacAddr, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Configs=layer2Configs, portTeamCfg=portTeamCfg, mstGeneralCfg=mstGeneralCfg, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsStpIndex=stgStatsStpIndex, stpInfo=stpInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsLookups=fdbStatsLookups, fdbStats=fdbStats, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoStatus=vlanInfoStatus, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbState=fdbState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgState=portTeamCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortState=lacpNewPortState, lacpCurPortState=lacpCurPortState, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgTable=stgNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistRegionalRoot=cistRegionalRoot, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoTable=stpInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoRootPort=stpInfoRootPort, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanMaxVlanID=vlanMaxVlanID, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbSrcPort=fdbSrcPort)
