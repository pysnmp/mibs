...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoIndex=stpInfoIndex, layer2Configs=layer2Configs, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbInfo=fdbInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoLearn=vlanInfoLearn, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortState=stpInfoPortState, cistBridgeHelloTime=cistBridgeHelloTime, fdbState=fdbState, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgState=stgCurCfgState, vlan=vlan, BridgeId=BridgeId, stpStats=stpStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgTable=vlanNewCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfo=stpInfo, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, layer2Stats=layer2Stats, fdbStatsCreates=fdbStatsCreates, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortState=lacpCurPortState, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootPort=stpInfoRootPort, vlanMaxEnt=vlanMaxEnt, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsDeletes=fdbStatsDeletes, fdbEntry=fdbEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCfg=stgCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbTable=fdbTable, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortEdge=stpInfoPortEdge, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfo=vlanInfo, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgAddVlan=stgNewCfgAddVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCfg=mstCistCfg, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCfg=mstCfg, mstCurCfgState=mstCurCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCfg=portTeamCfg, vlanCurCfgStg=vlanCurCfgStg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgState=vlanNewCfgState, stpInfoHelloTime=stpInfoHelloTime, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoName=vlanInfoName, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTable=stgStatsPortTable, lacpInfo=lacpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbLearnedPort=fdbLearnedPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTable=portTeamInfoTable, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPort=cistRootPort, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRoot=cistRoot, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkgroup=trunkgroup, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoPorts=vlanInfoPorts, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPriority=stgCurCfgPriority, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mirroring=mirroring, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mirrPortMirr=mirrPortMirr, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgState=vlanCurCfgState, layer2Oper=layer2Oper, stgCurCfgTable=stgCurCfgTable, portTeamInfo=portTeamInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbMacAddr=fdbMacAddr, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbVlan=fdbVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, layer2=layer2, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortTable=stpInfoPortTable, fdbStats=fdbStats, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgState=portTeamNewCfgState, fdbClear=fdbClear, vlanInfoTable=vlanInfoTable, cistInfoPortTable=cistInfoPortTable, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortIndex=cistInfoPortIndex, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoHoldTime=stpInfoHoldTime, vlanInfoJumbo=vlanInfoJumbo, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoState=portTeamInfoState, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsHiwat=fdbStatsHiwat, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortState=cistInfoPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoRootCost=stpInfoRootCost, stgNewCfgState=stgNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTable=stpInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortRole=stpInfoPortRole, lacp=lacp, cistInfoPortRole=cistInfoPortRole, cistInfo=cistInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbRefSps=fdbRefSps, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoId=vlanInfoId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
