...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfo=cistInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Stats=layer2Stats, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortStpIndex=stpInfoPortStpIndex, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgState=stgCurCfgState, fdbSrcPort=fdbSrcPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgState=vlanCurCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoIndex=stpInfoIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbTable=fdbTable, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortTable=cistInfoPortTable, layer2Configs=layer2Configs, fdbStatsLookups=fdbStatsLookups, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRootPort=cistRootPort, trunkgroup=trunkgroup, lacpNewPortState=lacpNewPortState, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoStatus=vlanInfoStatus, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, fdbMacAddr=fdbMacAddr, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgState=stgNewCfgState, fdbInfo=fdbInfo, fdbLearnedPort=fdbLearnedPort, cistInfoPortState=cistInfoPortState, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortTable=stpInfoPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, layer2Oper=layer2Oper, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRoot=cistRoot, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgStpMode=mstNewCfgStpMode, mstGeneralCfg=mstGeneralCfg, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbState=fdbState, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPriority=stgCurCfgPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlan=vlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, fdbStatsCreates=fdbStatsCreates, vlanInfoPorts=vlanInfoPorts, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortState=lacpCurPortState, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoHoldTime=stpInfoHoldTime, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCfg=mstCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortIndex=stpInfoPortIndex, cistRegionalRoot=cistRegionalRoot, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortIndex=cistInfoPortIndex, vlanInfoId=vlanInfoId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mirroring=mirroring, stgStatsPortTable=stgStatsPortTable, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPriority=stgNewCfgPriority, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFinds=fdbStatsFinds, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoName=vlanInfoName, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrPortMirr=mirrPortMirr, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfo=lacpInfo, portTeamInfoState=portTeamInfoState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoTable=vlanInfoTable, portTeamCfg=portTeamCfg, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortRole=stpInfoPortRole, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfo=portTeamInfo, layer2Info=layer2Info, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCfg=stgCfg, stpInfoPortState=stpInfoPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, BridgeId=BridgeId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgState=mstCurCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoHelloTime=stpInfoHelloTime, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsCurrent=fdbStatsCurrent, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTable=stgCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2=layer2, vlanNewCfgStg=vlanNewCfgStg, fdbRefSps=fdbRefSps, mstCistCfg=mstCistCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, lacp=lacp, vlanInfo=vlanInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, fdbVlan=fdbVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbClear=fdbClear, fdbStats=fdbStats, stpStats=stpStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfo=stpInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbEntry=fdbEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTable=stpInfoTable, cistInfoPortRole=cistInfoPortRole)
