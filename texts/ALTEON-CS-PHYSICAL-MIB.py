...
NotificationType, Gauge32, Counter64, Unsigned32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ObjectIdentity, IpAddress, MibIdentifier, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter64", "Unsigned32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32", "Bits")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgTable=portTeamCurCfgTable, fdbSrcPort=fdbSrcPort, trunkgroup=trunkgroup, stpInfoPortTableEntry=stpInfoPortTableEntry, BridgeId=BridgeId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfo=vlanInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTable=portTeamInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbTable=fdbTable, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgTable=stgNewCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortTable=cistInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortRole=stpInfoPortRole, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortIndex=cistInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, mirrPortMirr=mirrPortMirr, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoId=vlanInfoId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortIndex=stpInfoPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsLookups=fdbStatsLookups, fdbRefSps=fdbRefSps, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, layer2Oper=layer2Oper, fdbEntry=fdbEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortState=stpInfoPortState, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2=layer2, fdbStatsFindFails=fdbStatsFindFails, layer2Stats=layer2Stats, portTeamInfoTrunks=portTeamInfoTrunks, cistRegionalPathCost=cistRegionalPathCost, stpInfoTable=stpInfoTable, cistRootPathCost=cistRootPathCost, portTeamInfo=portTeamInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgState=stgCurCfgState, stpInfoPortEdge=stpInfoPortEdge, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistRoot=cistRoot, fdbInfo=fdbInfo, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortTable=stpInfoPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfo=stpInfo, fdbStatsHiwat=fdbStatsHiwat, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsCurrent=fdbStatsCurrent, cistRootPort=cistRootPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoName=vlanInfoName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoTableEntry=stpInfoTableEntry, stpStats=stpStats, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoRootCost=stpInfoRootCost, stpInfoIndex=stpInfoIndex, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoHelloTime=stpInfoHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCfg=stgCfg, PYSNMP_MODULE_ID=layer2, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfoPorts=vlanInfoPorts, mstCurCfgState=mstCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacp=lacp, stgStatsPortTable=stgStatsPortTable, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoState=portTeamInfoState, stgNewCfgState=stgNewCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStats=fdbStats, fdbLearnedPort=fdbLearnedPort, fdbSrcTrunk=fdbSrcTrunk, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Info=layer2Info, mstCfg=mstCfg, vlanMaxEnt=vlanMaxEnt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Configs=layer2Configs, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfo=cistInfo, lacpCurPortState=lacpCurPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgTable=stgCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbMacAddr=fdbMacAddr, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfo=lacpInfo, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, fdbStatsCreates=fdbStatsCreates, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortEdge=stgCurCfgPortEdge, mirroring=mirroring, vlanInfoTable=vlanInfoTable, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbVlan=fdbVlan, stgCurCfgPortState=stgCurCfgPortState, lacpNewPortState=lacpNewPortState, stgNewCfgPortEdge=stgNewCfgPortEdge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortPathCost=stpInfoPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoLearn=vlanInfoLearn, fdbState=fdbState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortState=cistInfoPortState, vlan=vlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCfg=mstCistCfg, mstNewCfgState=mstNewCfgState, portTeamCfg=portTeamCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistGeneralInfo=cistGeneralInfo, cistInfoPortRole=cistInfoPortRole, fdbClear=fdbClear, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoForwardDelay=stpInfoForwardDelay)
