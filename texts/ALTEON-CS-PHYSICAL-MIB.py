...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbInfo=fdbInfo, stpInfo=stpInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortRole=stpInfoPortRole, mstCistCfg=mstCistCfg, stgCfg=stgCfg, stgCurCfgState=stgCurCfgState, stgNewCfgTable=stgNewCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbLearnedPort=fdbLearnedPort, stpInfoIndex=stpInfoIndex, vlanInfo=vlanInfo, stpInfoHelloTime=stpInfoHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFindFails=fdbStatsFindFails, fdbTable=fdbTable, portTeamNewCfgState=portTeamNewCfgState, vlanInfoName=vlanInfoName, mirroring=mirroring, layer2Oper=layer2Oper, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoMaxAge=stpInfoMaxAge, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoStatus=vlanInfoStatus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfo=cistInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbRefSps=fdbRefSps, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCreates=fdbStatsCreates, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoJumbo=vlanInfoJumbo, lacp=lacp, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortState=lacpNewPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRegionalRoot=cistRegionalRoot, lacpInfo=lacpInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoId=vlanInfoId, stpInfoRootPort=stpInfoRootPort, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Stats=layer2Stats, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, layer2Configs=layer2Configs, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortTable=stpInfoPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoState=portTeamInfoState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRoot=cistRoot, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfo=portTeamInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, fdbState=fdbState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, BridgeId=BridgeId, fdbVlan=fdbVlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortState=cistInfoPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanMaxEnt=vlanMaxEnt, vlan=vlan, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTable=portTeamInfoTable, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoTable=vlanInfoTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcPort=fdbSrcPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsHiwat=fdbStatsHiwat, layer2Info=layer2Info, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2=layer2, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortState=lacpCurPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCfg=mstCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoLearn=vlanInfoLearn, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPriority=stgNewCfgPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistRootPathCost=cistRootPathCost, mirrPortMirr=mirrPortMirr, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkgroup=trunkgroup, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbEntry=fdbEntry, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistBridgeCfg=mstCistBridgeCfg, fdbClear=fdbClear, mstCurCfgState=mstCurCfgState, fdbMacAddr=fdbMacAddr, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistGeneralInfo=cistGeneralInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortRole=cistInfoPortRole, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRootPort=cistRootPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsFinds=fdbStatsFinds, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCfg=portTeamCfg, stpStats=stpStats, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookups=fdbStatsLookups)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTable=stpInfoTable, PYSNMP_MODULE_ID=layer2, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, fdbStats=fdbStats, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortPathCost=stpInfoPortPathCost, mstNewCfgState=mstNewCfgState, vlanNewCfgState=vlanNewCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortTable=lacpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgState=vlanCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable)
