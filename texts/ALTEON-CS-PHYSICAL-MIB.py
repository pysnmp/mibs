...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTable=stpInfoTable, stpInfoRootCost=stpInfoRootCost, vlanInfoLearn=vlanInfoLearn, stgStatsPortTable=stgStatsPortTable, cistInfoPortIndex=cistInfoPortIndex, portTeamCfg=portTeamCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbRefSps=fdbRefSps, stgCurCfgIndex=stgCurCfgIndex, stgStatsStpIndex=stgStatsStpIndex, fdbMacAddr=fdbMacAddr, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCfg=mstCistCfg, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortState=lacpNewPortState, BridgeId=BridgeId, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgState=mstCurCfgState, portTeamInfo=portTeamInfo, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoStatus=vlanInfoStatus, stgCfg=stgCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFinds=fdbStatsFinds, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2Oper=layer2Oper, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Info=layer2Info, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortState=lacpCurPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, stpInfoPortRole=stpInfoPortRole, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortRole=cistInfoPortRole, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfo=stpInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfo=cistInfo, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCfg=mstCfg, vlanNewCfgTable=vlanNewCfgTable, layer2Stats=layer2Stats, fdbSrcTrunk=fdbSrcTrunk, stpInfoIndex=stpInfoIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgState=portTeamCurCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbVlan=fdbVlan, fdbStatsLookups=fdbStatsLookups, cistGeneralInfo=cistGeneralInfo, fdbSrcPort=fdbSrcPort, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoId=vlanInfoId, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoName=vlanInfoName, fdbStats=fdbStats, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPort=cistRootPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlan=vlan, portTeamInfoTable=portTeamInfoTable, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistRoot=cistRoot, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortEdge=stpInfoPortEdge, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgState=mstNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoRootPort=stpInfoRootPort, fdbEntry=fdbEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortTable=cistInfoPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbInfo=fdbInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgTable=stgCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgState=stgNewCfgState, fdbLearnedPort=fdbLearnedPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanMaxEnt=vlanMaxEnt, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacp=lacp, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbState=fdbState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpStats=stpStats, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2Configs=layer2Configs, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, layer2=layer2, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortState=cistInfoPortState, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mirrPortMirr=mirrPortMirr, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortState=stpInfoPortState, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsDeletes=fdbStatsDeletes, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfo=vlanInfo, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoState=portTeamInfoState, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortTable=lacpInfoPortTable, trunkgroup=trunkgroup, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbTable=fdbTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfo=lacpInfo, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoTable=vlanInfoTable)
