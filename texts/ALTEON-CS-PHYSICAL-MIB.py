...
Bits, TimeTicks, iso, Integer32, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, IpAddress, Gauge32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "iso", "Integer32", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "IpAddress", "Gauge32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortRole=cistInfoPortRole, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortState=cistInfoPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCfg=mstCfg, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, layer2Oper=layer2Oper, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortState=stpInfoPortState, cistGeneralInfo=cistGeneralInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRootPathCost=cistRootPathCost, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, vlanInfoStatus=vlanInfoStatus, cistRoot=cistRoot, mstNewCfgState=mstNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, layer2=layer2, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, PYSNMP_MODULE_ID=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortLink=stgCurCfgPortLink, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, mstCistBridgeCfg=mstCistBridgeCfg, fdbState=fdbState, vlanInfoJumbo=vlanInfoJumbo, mstCistCfg=mstCistCfg, stpInfoTable=stpInfoTable, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoTable=portTeamInfoTable, stpInfoIndex=stpInfoIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoLearn=vlanInfoLearn, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoRootPort=stpInfoRootPort, vlanInfoPorts=vlanInfoPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoState=portTeamInfoState, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirroring=mirroring, fdbEntry=fdbEntry, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbTable=fdbTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mirrPortMirr=mirrPortMirr, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoRootCost=stpInfoRootCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoId=vlanInfoId, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortTable=stgStatsPortTable, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoHelloTime=stpInfoHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgState=mstCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbMacAddr=fdbMacAddr, stpInfoPortTable=stpInfoPortTable, stgNewCfgState=stgNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortState=lacpCurPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbClear=fdbClear, vlanMaxVlanID=vlanMaxVlanID, cistRegionalRoot=cistRegionalRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgState=vlanCurCfgState, fdbVlan=fdbVlan, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsCreates=fdbStatsCreates, stgNewCfgTable=stgNewCfgTable, lacpInfo=lacpInfo, vlanInfo=vlanInfo, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbRefSps=fdbRefSps, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbInfo=fdbInfo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpStats=stpStats, stpInfoHoldTime=stpInfoHoldTime, portTeamInfo=portTeamInfo, mstCurCfgRegionName=mstCurCfgRegionName, layer2Stats=layer2Stats, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Configs=layer2Configs, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortState=lacpNewPortState, mstGeneralCfg=mstGeneralCfg, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCfg=portTeamCfg, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgState=stgCurCfgState, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfo=stpInfo, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkgroup=trunkgroup, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCfg=stgCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, vlanInfoName=vlanInfoName, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlan=vlan, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, layer2Info=layer2Info, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgTable=stgCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoTable=vlanInfoTable, fdbStatsLookups=fdbStatsLookups, fdbSrcPort=fdbSrcPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsDeletes=fdbStatsDeletes, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRootPort=cistRootPort, BridgeId=BridgeId, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStats=fdbStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, cistInfo=cistInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacp=lacp, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortTable=cistInfoPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgTable=trunkGroupNewCfgTable)
