...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbEntry=fdbEntry, vlanNewCfgTable=vlanNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, stgCfg=stgCfg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTable=stpInfoTable, vlanInfo=vlanInfo, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfo=lacpInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2=layer2, lacpInfoPortMoved=lacpInfoPortMoved, layer2Configs=layer2Configs, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsFindFails=fdbStatsFindFails, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoTableEntry=stpInfoTableEntry, fdbSrcPort=fdbSrcPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoName=vlanInfoName, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortTable=stgStatsPortTable, stgStatsPortIndex=stgStatsPortIndex, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortState=stpInfoPortState, PYSNMP_MODULE_ID=layer2, mirrPortMirr=mirrPortMirr, fdbState=fdbState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, layer2Info=layer2Info, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlan=vlan, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfo=stpInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanMaxVlanID=vlanMaxVlanID, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, lacp=lacp, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoPorts=portTeamInfoPorts, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgStg=vlanCurCfgStg, fdbVlan=fdbVlan, fdbStats=fdbStats, cistInfoPortPriority=cistInfoPortPriority, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRootPort=cistRootPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, BridgeId=BridgeId, vlanInfoLearn=vlanInfoLearn, stgNewCfgState=stgNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgState=stgCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbLearnedPort=fdbLearnedPort, stpInfoPortIndex=stpInfoPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCfg=mstCistCfg, stpInfoRootPort=stpInfoRootPort, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistGeneralInfo=cistGeneralInfo, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Oper=layer2Oper, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsStpIndex=stgStatsStpIndex, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgState=vlanNewCfgState, portTeamInfoState=portTeamInfoState, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoId=vlanInfoId, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgTable=stgNewCfgTable, fdbInfo=fdbInfo, cistInfo=cistInfo, portTeamInfo=portTeamInfo, mstCfg=mstCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTrunks=portTeamInfoTrunks, fdbRefSps=fdbRefSps, stpInfoPortRole=stpInfoPortRole, stpInfoRootCost=stpInfoRootCost, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbMacAddr=fdbMacAddr, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgState=vlanCurCfgState, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbTable=fdbTable, cistRoot=cistRoot, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoPorts=vlanInfoPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Stats=layer2Stats, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCurCfgState=mstCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCreates=fdbStatsCreates, stpInfoHoldTime=stpInfoHoldTime, mstGeneralCfg=mstGeneralCfg, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoTable=vlanInfoTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortState=lacpNewPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTable=portTeamInfoTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbClear=fdbClear, portTeamCfg=portTeamCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgState=mstNewCfgState, mirroring=mirroring, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortTable=cistInfoPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkgroup=trunkgroup, stpStats=stpStats, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
