...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbRefSps=fdbRefSps, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortNtt=lacpInfoPortNtt, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRegionalRoot=cistRegionalRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoTable=vlanInfoTable, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistGeneralInfo=cistGeneralInfo, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTable=stgStatsPortTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCfg=stgCfg, stpInfoTopChanges=stpInfoTopChanges, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbLearnedPort=fdbLearnedPort, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgState=stgNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTable=portTeamInfoTable, cistRoot=cistRoot, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookups=fdbStatsLookups, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortTable=cistInfoPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoRootCost=stpInfoRootCost, BridgeId=BridgeId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoMaxAge=stpInfoMaxAge, fdbEntry=fdbEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpNewPortState=lacpNewPortState, vlanCurCfgState=vlanCurCfgState, fdbTable=fdbTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgPorts=vlanNewCfgPorts, layer2Info=layer2Info, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoName=vlanInfoName, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfo=portTeamInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, fdbSrcPort=fdbSrcPort, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoRootPort=stpInfoRootPort, cistRootPathCost=cistRootPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbState=fdbState, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoState=portTeamInfoState, fdbMacAddr=fdbMacAddr, stpInfoTable=stpInfoTable, PYSNMP_MODULE_ID=layer2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfo=vlanInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsFindFails=fdbStatsFindFails, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortRole=stpInfoPortRole, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfo=stpInfo, lacpCurPortState=lacpCurPortState, cistInfoPortState=cistInfoPortState, vlanNewCfgTable=vlanNewCfgTable, layer2Stats=layer2Stats, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFinds=fdbStatsFinds, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgStpMode=mstNewCfgStpMode, mstCfg=mstCfg, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoStatus=vlanInfoStatus, stpInfoPortStpIndex=stpInfoPortStpIndex, mstGeneralCfg=mstGeneralCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, mirroring=mirroring, lacpInfo=lacpInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbVlan=fdbVlan, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbClear=fdbClear, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, vlan=vlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoPorts=vlanInfoPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoId=vlanInfoId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStats=fdbStats, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgState=stgCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, layer2Configs=layer2Configs, mirrPortMirr=mirrPortMirr, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfo=cistInfo, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCfg=mstCistCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgTable=vlanCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2=layer2, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgState=mstCurCfgState, lacp=lacp, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, mstNewCfgState=mstNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, fdbInfo=fdbInfo, vlanNewCfgState=vlanNewCfgState, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCfg=portTeamCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRootPort=cistRootPort, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgTable=stgNewCfgTable, trunkgroup=trunkgroup, layer2Oper=layer2Oper, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpStats=stpStats, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
