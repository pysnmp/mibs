...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCfg=mstCistCfg, mstCurCfgState=mstCurCfgState, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgState=vlanNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, fdbState=fdbState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfo=cistInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbVlan=fdbVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbEntry=fdbEntry, stgNewCfgState=stgNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, cistRegionalRoot=cistRegionalRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, vlan=vlan, layer2Oper=layer2Oper, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, stpStats=stpStats, lacpCurSystemPriority=lacpCurSystemPriority, layer2=layer2, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortTable=stgStatsPortTable, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortState=lacpNewPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoIndex=stpInfoIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, BridgeId=BridgeId, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortState=cistInfoPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkgroup=trunkgroup, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCfg=mstCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgState=stgCurCfgState, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsFindFails=fdbStatsFindFails, vlanInfo=vlanInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgTable=vlanNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoId=vlanInfoId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Stats=layer2Stats, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsLookups=fdbStatsLookups, lacp=lacp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoTable=stpInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgIndex=stgCurCfgIndex, PYSNMP_MODULE_ID=layer2, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoLearn=vlanInfoLearn, stpInfoPortRole=stpInfoPortRole, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistRoot=cistRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstGeneralCfg=mstGeneralCfg, portTeamTableMaxSize=portTeamTableMaxSize, fdbClear=fdbClear, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcPort=fdbSrcPort, fdbLearnedPort=fdbLearnedPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCfg=stgCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mirrPortMirr=mirrPortMirr, lacpCurPortState=lacpCurPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistRootPathCost=cistRootPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgTable=stgCurCfgTable, portTeamCfg=portTeamCfg, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortEdge=stpInfoPortEdge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPriority=stgCurCfgPriority, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsStpIndex=stgStatsStpIndex, stpInfoTableEntry=stpInfoTableEntry, vlanInfoJumbo=vlanInfoJumbo, lacpInfoPortSelected=lacpInfoPortSelected, layer2Configs=layer2Configs, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfo=lacpInfo, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoState=portTeamInfoState, layer2Info=layer2Info, stpInfoHoldTime=stpInfoHoldTime, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgState=portTeamNewCfgState, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfo=stpInfo, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStats=fdbStats, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsHiwat=fdbStatsHiwat, fdbStatsLookupFails=fdbStatsLookupFails, mstNewCfgState=mstNewCfgState, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortTable=stpInfoPortTable, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, cistGeneralInfo=cistGeneralInfo, fdbStatsCurrent=fdbStatsCurrent, vlanInfoName=vlanInfoName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, vlanInfoStatus=vlanInfoStatus, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRootPort=cistRootPort, vlanCurCfgPorts=vlanCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoTable=portTeamInfoTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbRefSps=fdbRefSps, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoPorts=vlanInfoPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, fdbMacAddr=fdbMacAddr, fdbStatsCreates=fdbStatsCreates, portTeamInfo=portTeamInfo, fdbInfo=fdbInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbTable=fdbTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mirroring=mirroring, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortState=stpInfoPortState, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex)
