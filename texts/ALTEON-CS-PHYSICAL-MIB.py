...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirrPortMirr=mirrPortMirr, mirroring=mirroring, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCreates=fdbStatsCreates, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortTable=stgStatsPortTable, vlanMaxVlanID=vlanMaxVlanID, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbRefSps=fdbRefSps, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoRootCost=stpInfoRootCost, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgState=stgNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkgroup=trunkgroup, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Configs=layer2Configs, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTable=stpInfoTable, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbEntry=fdbEntry, mstCfg=mstCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstGeneralCfg=mstGeneralCfg, stgNewCfgTable=stgNewCfgTable, fdbSrcPort=fdbSrcPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, layer2=layer2, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsOverflows=fdbStatsOverflows, fdbStats=fdbStats, stgCfg=stgCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, vlanInfoTable=vlanInfoTable, cistRootPort=cistRootPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortState=stgCurCfgPortState, stpStats=stpStats, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, fdbState=fdbState, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoTable=portTeamInfoTable, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbVlan=fdbVlan, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortRole=stpInfoPortRole, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, mstCurCfgState=mstCurCfgState, vlanInfoName=vlanInfoName, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortEdge=stpInfoPortEdge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfo=vlanInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoId=vlanInfoId, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgState=vlanNewCfgState, lacpNewPortState=lacpNewPortState, fdbLearnedPort=fdbLearnedPort, stpInfoPortTable=stpInfoPortTable, cistRootPathCost=cistRootPathCost, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgState=stgCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgState=mstNewCfgState, fdbStatsDeletes=fdbStatsDeletes, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbInfo=fdbInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCfg=mstCistCfg, layer2Stats=layer2Stats, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortState=stpInfoPortState, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbTable=fdbTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoTopChanges=stpInfoTopChanges, lacpCurPortState=lacpCurPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsLookupFails=fdbStatsLookupFails, lacp=lacp, cistGeneralInfo=cistGeneralInfo, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoLearn=vlanInfoLearn, layer2Info=layer2Info, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRegionalRoot=cistRegionalRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoState=portTeamInfoState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFindFails=fdbStatsFindFails, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRoot=cistRoot, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortIndex=stpInfoPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsPortIndex=stgStatsPortIndex, vlanInfoStatus=vlanInfoStatus, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortPathCost=stpInfoPortPathCost, stpInfo=stpInfo, vlanCurCfgState=vlanCurCfgState, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, BridgeId=BridgeId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortIndex=lacpInfoPortIndex, fdbMacAddr=fdbMacAddr, cistInfo=cistInfo, lacpInfo=lacpInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanInfoJumbo=vlanInfoJumbo, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortRole=cistInfoPortRole, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, PYSNMP_MODULE_ID=layer2, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlan=vlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCfg=portTeamCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfo=portTeamInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, fdbClear=fdbClear, layer2Oper=layer2Oper, vlanMaxEnt=vlanMaxEnt, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortState=cistInfoPortState, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgTable=vlanNewCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg)
