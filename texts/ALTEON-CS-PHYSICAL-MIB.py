...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstGeneralCfg=mstGeneralCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTable=stpInfoTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgState=stgCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpNewPortState=lacpNewPortState, vlanCurCfgTable=vlanCurCfgTable, cistRoot=cistRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortRole=cistInfoPortRole, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlan=vlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, BridgeId=BridgeId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbInfo=fdbInfo, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRegionalRoot=cistRegionalRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, fdbVlan=fdbVlan, mstCurCfgState=mstCurCfgState, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsDeletes=fdbStatsDeletes, cistInfo=cistInfo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mirroring=mirroring, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoPorts=portTeamInfoPorts, trunkgroup=trunkgroup, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfo=lacpInfo, layer2=layer2, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacp=lacp, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoMaxAge=stpInfoMaxAge, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfo=vlanInfo, lacpCurPortState=lacpCurPortState, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortRole=stpInfoPortRole, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpStats=stpStats, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTopChanges=stpInfoTopChanges, fdbStatsFinds=fdbStatsFinds, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgState=portTeamCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgState=stgNewCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbSrcTrunk=fdbSrcTrunk, fdbTable=fdbTable, stgCfg=stgCfg, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStats=fdbStats, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, layer2Stats=layer2Stats, portTeamInfoState=portTeamInfoState, stpInfo=stpInfo, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsCreates=fdbStatsCreates, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortState=cistInfoPortState, fdbRefSps=fdbRefSps, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgIndex=stgNewCfgIndex, portTeamCfg=portTeamCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, mirrPortMirr=mirrPortMirr, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCfg=mstCistCfg, stpInfoPortEdge=stpInfoPortEdge, stgStatsPortTable=stgStatsPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCfg=mstCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbEntry=fdbEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbSrcPort=fdbSrcPort, stpInfoIndex=stpInfoIndex, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoId=vlanInfoId, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Info=layer2Info, cistGeneralInfo=cistGeneralInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, fdbState=fdbState, stpInfoHoldTime=stpInfoHoldTime, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2Oper=layer2Oper, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfo=portTeamInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, fdbLearnedPort=fdbLearnedPort, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoName=vlanInfoName, fdbMacAddr=fdbMacAddr, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, cistRootPathCost=cistRootPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortState=stpInfoPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbClear=fdbClear, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortTable=stpInfoPortTable, cistRootPort=cistRootPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgState=vlanCurCfgState, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTable=portTeamCurCfgTable, PYSNMP_MODULE_ID=layer2, stpInfoHelloTime=stpInfoHelloTime, stpInfoRootPort=stpInfoRootPort, portTeamInfoTable=portTeamInfoTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, layer2Configs=layer2Configs, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoPorts=vlanInfoPorts)
