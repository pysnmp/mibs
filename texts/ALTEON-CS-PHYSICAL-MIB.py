...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfo=lacpInfo, vlanInfoName=vlanInfoName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoTable=vlanInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRoot=cistRoot, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgState=mstCurCfgState, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCfg=stgCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgTable=vlanCurCfgTable, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, PYSNMP_MODULE_ID=layer2, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgPorts=vlanCurCfgPorts, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, mstGeneralCfg=mstGeneralCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCfg=mstCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbClear=fdbClear, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, layer2=layer2, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, cistInfo=cistInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoRootPort=stpInfoRootPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortTable=stgStatsPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsOverflows=fdbStatsOverflows, vlanInfoStatus=vlanInfoStatus, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2Stats=layer2Stats, cistRootPathCost=cistRootPathCost, vlanInfoId=vlanInfoId, lacpCurSystemPriority=lacpCurSystemPriority, fdbTable=fdbTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortTable=cistInfoPortTable, fdbStats=fdbStats, mirrPortMirr=mirrPortMirr, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoTableEntry=stpInfoTableEntry, cistRootPort=cistRootPort, stpStats=stpStats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgTable=stgCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, lacp=lacp, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfo=stpInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfo=portTeamInfo, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsLookups=fdbStatsLookups, fdbMacAddr=fdbMacAddr, portTeamCfg=portTeamCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoState=portTeamInfoState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgDelete=vlanNewCfgDelete, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, layer2Info=layer2Info, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkgroup=trunkgroup, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgState=mstNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbLearnedPort=fdbLearnedPort, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortState=stpInfoPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistGeneralInfo=cistGeneralInfo, cistBridgeHelloTime=cistBridgeHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortRole=stpInfoPortRole, fdbState=fdbState, lacpNewSystemPriority=lacpNewSystemPriority, vlanMaxEnt=vlanMaxEnt, stgNewCfgState=stgNewCfgState, fdbRefSps=fdbRefSps, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlan=vlan, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortState=lacpNewPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTable=stpInfoTable, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, stpInfoHelloTime=stpInfoHelloTime, fdbInfo=fdbInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoIndex=stpInfoIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbVlan=fdbVlan, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, BridgeId=BridgeId, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbEntry=fdbEntry, layer2Configs=layer2Configs, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbSrcPort=fdbSrcPort, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortRole=cistInfoPortRole, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgState=stgCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgState=vlanCurCfgState, fdbStatsHiwat=fdbStatsHiwat, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, layer2Oper=layer2Oper, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCfg=mstCistCfg, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgIndex=stgCurCfgIndex, vlanInfo=vlanInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurPortState=lacpCurPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortState=cistInfoPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgTable=stgNewCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge)
