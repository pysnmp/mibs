...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoState=portTeamInfoState, lacp=lacp, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, stpInfo=stpInfo, stgNewCfgTable=stgNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortTable=lacpInfoPortTable, mstGeneralCfg=mstGeneralCfg, portTeamTableMaxSize=portTeamTableMaxSize, fdbRefSps=fdbRefSps, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsLookups=fdbStatsLookups, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoId=vlanInfoId, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCfg=mstCistCfg, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortState=stpInfoPortState, fdbTable=fdbTable, mstCistDefaultCfg=mstCistDefaultCfg, stgCfg=stgCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootPort=stpInfoRootPort, fdbEntry=fdbEntry, portTeamCurCfgState=portTeamCurCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mirroring=mirroring, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortTable=cistInfoPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbState=fdbState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoIndex=stpInfoIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, stpInfoTable=stpInfoTable, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbVlan=fdbVlan, layer2Oper=layer2Oper, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgState=stgNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mirrPortMirr=mirrPortMirr, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfo=portTeamInfo, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgTable=stgCurCfgTable, mstCfg=mstCfg, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanMaxEnt=vlanMaxEnt, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpCurPortState=lacpCurPortState, stpInfoPortRole=stpInfoPortRole, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgState=stgCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2Info=layer2Info, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoRootCost=stpInfoRootCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfo=lacpInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stpStats=stpStats, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfo=vlanInfo, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbClear=fdbClear, cistInfoPortState=cistInfoPortState, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, portTeamCfg=portTeamCfg, cistRoot=cistRoot, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistRootPathCost=cistRootPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoPorts=vlanInfoPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Stats=layer2Stats, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, cistInfo=cistInfo, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStats=fdbStats, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoLearn=vlanInfoLearn, vlanNewCfgState=vlanNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoName=vlanInfoName, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Configs=layer2Configs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgState=mstNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoTable=vlanInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortTable=stpInfoPortTable, cistGeneralInfo=cistGeneralInfo, mstCurCfgState=mstCurCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgState=vlanCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkgroup=trunkgroup, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, PYSNMP_MODULE_ID=layer2, layer2=layer2, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbInfo=fdbInfo, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFinds=fdbStatsFinds, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoPorts=portTeamInfoPorts, cistRegionalRoot=cistRegionalRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalPathCost=cistRegionalPathCost, fdbStatsDeletes=fdbStatsDeletes, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTableEntry=vlanInfoTableEntry, BridgeId=BridgeId, stgCurCfgPriority=stgCurCfgPriority, stgStatsStpIndex=stgStatsStpIndex, cistRootPort=cistRootPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlan=vlan, stgStatsPortTable=stgStatsPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan)
