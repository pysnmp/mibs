...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, ObjectIdentity, NotificationType, Counter64, Integer32, Gauge32, iso, Bits, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "Gauge32", "iso", "Bits", "IpAddress", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortState=lacpNewPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsLookups=fdbStatsLookups, vlanInfo=vlanInfo, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRootPort=cistRootPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortLink=stgNewCfgPortLink, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortTable=cistInfoPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbInfo=fdbInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortNtt=lacpInfoPortNtt, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbClear=fdbClear, stpInfoTable=stpInfoTable, fdbStatsFinds=fdbStatsFinds, cistRootPathCost=cistRootPathCost, vlan=vlan, vlanNewCfgTable=vlanNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortState=cistInfoPortState, stgCurCfgState=stgCurCfgState, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgTable=stgCurCfgTable, fdbLearnedPort=fdbLearnedPort, vlanInfoPorts=vlanInfoPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgState=portTeamCurCfgState, layer2Info=layer2Info, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, vlanInfoName=vlanInfoName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsHiwat=fdbStatsHiwat, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTable=stgNewCfgPortTable, stpInfo=stpInfo, stpInfoRootPort=stpInfoRootPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStats=fdbStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacp=lacp, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbVlan=fdbVlan, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoJumbo=vlanInfoJumbo, cistRoot=cistRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistGeneralInfo=cistGeneralInfo, layer2Stats=layer2Stats, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbTable=fdbTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortRole=stpInfoPortRole, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpStats=stpStats, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfo=portTeamInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoTable=vlanInfoTable, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoStatus=vlanInfoStatus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkgroup=trunkgroup, fdbRefSps=fdbRefSps, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoIndex=portTeamInfoIndex, mstCistBridgeCfg=mstCistBridgeCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortState=lacpCurPortState, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortState=stgNewCfgPortState, layer2Oper=layer2Oper, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2=layer2, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoId=vlanInfoId, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortIndex=stgStatsPortIndex, mirrPortMirr=mirrPortMirr, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgIndex=stgCurCfgIndex, mstGeneralCfg=mstGeneralCfg, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoState=portTeamInfoState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortPriority=cistInfoPortPriority, cistInfo=cistInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCfg=mstCistCfg, fdbSrcPort=fdbSrcPort, mstNewCfgState=mstNewCfgState, portTeamCfg=portTeamCfg, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortState=stpInfoPortState, portTeamTableMaxSize=portTeamTableMaxSize, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbState=fdbState, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, BridgeId=BridgeId, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoLearn=vlanInfoLearn, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCfg=mstCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Configs=layer2Configs, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgState=vlanCurCfgState, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbEntry=fdbEntry, lacpInfoPortTable=lacpInfoPortTable, mirroring=mirroring, stgNewCfgState=stgNewCfgState, stpInfoPortPathCost=stpInfoPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCurCfgState=mstCurCfgState, stgCfg=stgCfg, stgCurCfgPortState=stgCurCfgPortState, fdbMacAddr=fdbMacAddr, cistInfoPortLinkType=cistInfoPortLinkType)
