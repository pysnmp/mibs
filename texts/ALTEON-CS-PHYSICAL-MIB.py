...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Configs=layer2Configs, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortTable=cistInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbRefSps=fdbRefSps, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCfg=stgCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgState=mstNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgStg=vlanCurCfgStg, mirrPortMirr=mirrPortMirr, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortState=stgCurCfgPortState, cistRoot=cistRoot, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortState=stpInfoPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRootPathCost=cistRootPathCost, mirroring=mirroring, lacpInfo=lacpInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, layer2Info=layer2Info, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsOverflows=fdbStatsOverflows, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstGeneralCfg=mstGeneralCfg, portTeamInfoState=portTeamInfoState, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgTable=stgNewCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistBridgeCfg=mstCistBridgeCfg, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgState=stgNewCfgState, stgCurCfgState=stgCurCfgState, fdbTable=fdbTable, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistRootPort=cistRootPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamInfo=portTeamInfo, fdbLearnedPort=fdbLearnedPort, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbMacAddr=fdbMacAddr, stgStatsPortTable=stgStatsPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortState=cistInfoPortState, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoIndex=stpInfoIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTable=stpInfoTable, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistGeneralInfo=cistGeneralInfo, fdbStatsCreates=fdbStatsCreates, fdbSrcPort=fdbSrcPort, vlanCurCfgLearn=vlanCurCfgLearn, layer2Oper=layer2Oper, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoTable=vlanInfoTable, stpInfoTopChanges=stpInfoTopChanges, portTeamCfg=portTeamCfg, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortState=lacpCurPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2=layer2, PYSNMP_MODULE_ID=layer2, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkgroup=trunkgroup, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfo=stpInfo, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortIndex=stpInfoPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfo=vlanInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbClear=fdbClear, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpStats=stpStats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCurCfgState=mstCurCfgState, BridgeId=BridgeId, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortTable=stpInfoPortTable, fdbInfo=fdbInfo, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoId=vlanInfoId, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoName=vlanInfoName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbVlan=fdbVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCfg=mstCistCfg, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, layer2Stats=layer2Stats, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbState=fdbState, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortStpIndex=stpInfoPortStpIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortEdge=stpInfoPortEdge, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgPorts=vlanCurCfgPorts, fdbStats=fdbStats, stgCurCfgPortTable=stgCurCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacp=lacp, vlan=vlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCfg=mstCfg, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgState=vlanCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalRoot=cistRegionalRoot, fdbEntry=fdbEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfo=cistInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry)
