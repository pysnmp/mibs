...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortTable=stgNewCfgPortTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTable=portTeamInfoTable, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRootPathCost=cistRootPathCost, fdbStats=fdbStats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCfg=mstCistCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTableEntry=vlanInfoTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, cistInfo=cistInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgState=mstNewCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2Oper=layer2Oper, stpInfoTable=stpInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, fdbInfo=fdbInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistGeneralInfo=cistGeneralInfo, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoPorts=portTeamInfoPorts, fdbVlan=fdbVlan, cistInfoPortIndex=cistInfoPortIndex, stgCfg=stgCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcPort=fdbSrcPort, stpInfoIndex=stpInfoIndex, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortState=cistInfoPortState, vlanMaxEnt=vlanMaxEnt, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortTable=stgStatsPortTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortState=stgNewCfgPortState, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfo=stpInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, cistRoot=cistRoot, fdbClear=fdbClear, vlanNewCfgLearn=vlanNewCfgLearn, layer2Stats=layer2Stats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortRole=stpInfoPortRole, vlanInfoId=vlanInfoId, lacpInfo=lacpInfo, mirroring=mirroring, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, cistBridgeForwardDelay=cistBridgeForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgState=stgNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistBridgeCfg=mstCistBridgeCfg, trunkgroup=trunkgroup, mstGeneralCfg=mstGeneralCfg, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortMoved=lacpInfoPortMoved, vlan=vlan, stgCurCfgAgingTime=stgCurCfgAgingTime, layer2Info=layer2Info, vlanCurCfgState=vlanCurCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortTable=cistInfoPortTable, stgCurCfgState=stgCurCfgState, layer2=layer2, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbRefSps=fdbRefSps, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoName=vlanInfoName, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortState=lacpNewPortState, vlanNewCfgTable=vlanNewCfgTable, cistRegionalRoot=cistRegionalRoot, stpInfoRootCost=stpInfoRootCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgStg=vlanCurCfgStg, vlanInfoPorts=vlanInfoPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortRole=cistInfoPortRole, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsDeletes=fdbStatsDeletes, vlanMaxVlanID=vlanMaxVlanID, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgTable=portTeamCurCfgTable, mirrPortMirr=mirrPortMirr, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbEntry=fdbEntry, vlanInfoTable=vlanInfoTable, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbLearnedPort=fdbLearnedPort, stpInfoRootPort=stpInfoRootPort, stpStats=stpStats, stpInfoMaxAge=stpInfoMaxAge, vlanInfoJumbo=vlanInfoJumbo, fdbStatsFinds=fdbStatsFinds, fdbMacAddr=fdbMacAddr, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, BridgeId=BridgeId, layer2Configs=layer2Configs, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgState=mstCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, PYSNMP_MODULE_ID=layer2, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbState=fdbState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoIndex=portTeamInfoIndex, cistRootPort=cistRootPort, stgCurCfgPortState=stgCurCfgPortState, vlanInfo=vlanInfo, stpInfoTopChanges=stpInfoTopChanges, lacpCurPortState=lacpCurPortState, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortPathCost=stgNewCfgPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsCreates=fdbStatsCreates, stpInfoPortState=stpInfoPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbTable=fdbTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoLearn=vlanInfoLearn, mstCfg=mstCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfo=portTeamInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCfg=portTeamCfg, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, lacp=lacp)
