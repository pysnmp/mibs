...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgState=stgCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoId=vlanInfoId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCfg=portTeamCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbTable=fdbTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbMacAddr=fdbMacAddr, fdbStatsOverflows=fdbStatsOverflows, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfo=vlanInfo, lacpInfo=lacpInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortIndex=stgStatsPortIndex, stgCfg=stgCfg, vlanMaxVlanID=vlanMaxVlanID, fdbSrcPort=fdbSrcPort, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoRootCost=stpInfoRootCost, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgState=vlanNewCfgState, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPriority=stgNewCfgPriority, fdbState=fdbState, cistInfoPortTable=cistInfoPortTable, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgTable=stgCurCfgTable, stpInfoPortTable=stpInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoTable=stpInfoTable, mirroring=mirroring, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, layer2=layer2, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoLearn=vlanInfoLearn, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstGeneralCfg=mstGeneralCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStats=fdbStats, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgTable=stgNewCfgTable, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, PYSNMP_MODULE_ID=layer2, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurPortState=lacpCurPortState, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgStpMode=mstNewCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistGeneralInfo=cistGeneralInfo, stgCurCfgPriority=stgCurCfgPriority, mstCistCfg=mstCistCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbVlan=fdbVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortIndex=cistInfoPortIndex, cistRoot=cistRoot, layer2Info=layer2Info, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfo=portTeamInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortTable=stgStatsPortTable, cistInfo=cistInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortState=stpInfoPortState, cistRootPathCost=cistRootPathCost, fdbStatsCreates=fdbStatsCreates, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, fdbLearnedPort=fdbLearnedPort, mirrPortMirr=mirrPortMirr, vlanInfoName=vlanInfoName, vlan=vlan, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, lacp=lacp, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbEntry=fdbEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpStats=stpStats, stpInfo=stpInfo, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbRefSps=fdbRefSps, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2Stats=layer2Stats, lacpInfoPortSelected=lacpInfoPortSelected, layer2Configs=layer2Configs, stpInfoIndex=stpInfoIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCfg=mstCfg, vlanCurCfgState=vlanCurCfgState, vlanInfoTable=vlanInfoTable, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgStgIndex=stgNewCfgStgIndex, BridgeId=BridgeId, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoPorts=vlanInfoPorts, stgNewCfgState=stgNewCfgState, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortRole=cistInfoPortRole, stpInfoTableEntry=stpInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistRegionalRoot=cistRegionalRoot, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgLearn=vlanCurCfgLearn, trunkgroup=trunkgroup, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsFinds=fdbStatsFinds, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoTrunks=portTeamInfoTrunks, layer2Oper=layer2Oper, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCurCfgState=mstCurCfgState, portTeamCurCfgState=portTeamCurCfgState, fdbStatsCurrent=fdbStatsCurrent, fdbInfo=fdbInfo, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoIndex=portTeamInfoIndex, cistRootPort=cistRootPort, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortState=lacpNewPortState)
