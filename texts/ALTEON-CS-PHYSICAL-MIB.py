...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanInfoStatus=vlanInfoStatus, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgState=mstNewCfgState, PYSNMP_MODULE_ID=layer2, vlan=vlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsFinds=fdbStatsFinds, stpInfoPortState=stpInfoPortState, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortIndex=cistInfoPortIndex, portTeamInfo=portTeamInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCfg=mstCfg, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgIndex=stgNewCfgIndex, vlanMaxEnt=vlanMaxEnt, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoHoldTime=stpInfoHoldTime, portTeamInfoTable=portTeamInfoTable, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCfg=mstCistCfg, vlanCurCfgState=vlanCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoIndex=portTeamInfoIndex, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortTable=cistInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2=layer2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoRootCost=stpInfoRootCost, vlanInfoName=vlanInfoName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, stpInfo=stpInfo, fdbClear=fdbClear, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCfg=stgCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgState=stgCurCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoRootPort=stpInfoRootPort, vlanInfoPorts=vlanInfoPorts, BridgeId=BridgeId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpStats=stpStats, fdbInfo=fdbInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortIndex=stgStatsPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfo=vlanInfo, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, layer2Info=layer2Info, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTable=stpInfoTable, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgState=mstCurCfgState, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortSelected=lacpInfoPortSelected, layer2Stats=layer2Stats, layer2Configs=layer2Configs, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStats=fdbStats, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbTable=fdbTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoLearn=vlanInfoLearn, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsCreates=fdbStatsCreates, stpInfoIndex=stpInfoIndex, cistInfo=cistInfo, mirroring=mirroring, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortTable=stgStatsPortTable, lacpNewPortState=lacpNewPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPriority=stgCurCfgPriority, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoTable=vlanInfoTable, mstNewCfgStpMode=mstNewCfgStpMode, cistBridgeMaxAge=cistBridgeMaxAge, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistBridgeHelloTime=cistBridgeHelloTime, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortRole=cistInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, fdbStatsCurrent=fdbStatsCurrent, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurPortState=lacpCurPortState, vlanInfoId=vlanInfoId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgTable=stgCurCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortState=cistInfoPortState, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoBwmContract=vlanInfoBwmContract, mirrPortMirr=mirrPortMirr, cistRoot=cistRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgState=vlanNewCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbVlan=fdbVlan, trunkgroup=trunkgroup, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbEntry=fdbEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbRefSps=fdbRefSps, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsLookups=fdbStatsLookups, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfo=lacpInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoTopChanges=stpInfoTopChanges, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCfg=portTeamCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbState=fdbState, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortTable=stpInfoPortTable, stgNewCfgTable=stgNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortLink=stgNewCfgPortLink, lacp=lacp, layer2Oper=layer2Oper, cistRootPathCost=cistRootPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistRootPort=cistRootPort)
