...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgDelete=vlanNewCfgDelete, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgTable=vlanCurCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mirroring=mirroring, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoName=vlanInfoName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbTable=fdbTable, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, cistInfo=cistInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, PYSNMP_MODULE_ID=layer2, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfo=stpInfo, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlan=vlan, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfo=lacpInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoHoldTime=stpInfoHoldTime, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgState=vlanNewCfgState, fdbState=fdbState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTable=portTeamInfoTable, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacp=lacp, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgIndex=stgNewCfgIndex, stpInfoHelloTime=stpInfoHelloTime, fdbClear=fdbClear, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoState=portTeamInfoState, fdbStatsCreates=fdbStatsCreates, fdbRefSps=fdbRefSps, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgState=stgCurCfgState, fdbSrcTrunk=fdbSrcTrunk, stpInfoTable=stpInfoTable, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsStpIndex=stgStatsStpIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStats=fdbStats, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, stpStats=stpStats, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgState=portTeamNewCfgState, cistGeneralInfo=cistGeneralInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, mstGeneralCfg=mstGeneralCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortTable=stgStatsPortTable, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, fdbSrcPort=fdbSrcPort, BridgeId=BridgeId, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortEdge=stpInfoPortEdge, layer2Configs=layer2Configs, mstCfg=mstCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRootPort=cistRootPort, vlanInfoId=vlanInfoId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortRole=stpInfoPortRole, cistRoot=cistRoot, fdbStatsLookups=fdbStatsLookups, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeForwardDelay=cistBridgeForwardDelay, mstNewCfgState=mstNewCfgState, stgNewCfgState=stgNewCfgState, vlanMaxEnt=vlanMaxEnt, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortState=stpInfoPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, layer2Stats=layer2Stats, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgTable=stgCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoIndex=stpInfoIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Oper=layer2Oper, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortEdge=stgNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbVlan=fdbVlan, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCfg=stgCfg, vlanNewCfgPorts=vlanNewCfgPorts, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfo=portTeamInfo, vlanInfoStatus=vlanInfoStatus, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgTable=stgNewCfgTable, vlanInfo=vlanInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortTable=stpInfoPortTable, fdbInfo=fdbInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgState=mstCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, vlanInfoLearn=vlanInfoLearn, stpInfoRootPort=stpInfoRootPort, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, fdbEntry=fdbEntry, stpInfoTableEntry=stpInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortRole=cistInfoPortRole, trunkgroup=trunkgroup, mstCistCfg=mstCistCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, layer2Info=layer2Info, lacpNewPortState=lacpNewPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbMacAddr=fdbMacAddr, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoTable=vlanInfoTable, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortState=lacpCurPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortTable=cistInfoPortTable, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCfg=portTeamCfg, vlanNewCfgTable=vlanNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortPathCost=stpInfoPortPathCost, fdbLearnedPort=fdbLearnedPort, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2=layer2, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk)
