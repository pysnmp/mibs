...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoMaxAge=stpInfoMaxAge, vlanMaxEnt=vlanMaxEnt, portTeamInfoTable=portTeamInfoTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, cistRoot=cistRoot, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoState=portTeamInfoState, cistRootPathCost=cistRootPathCost, stgNewCfgTable=stgNewCfgTable, lacp=lacp, stgCurCfgState=stgCurCfgState, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, BridgeId=BridgeId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistRootPort=cistRootPort, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsLookups=fdbStatsLookups, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCurCfgState=mstCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortState=cistInfoPortState, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgStatsStpIndex=stgStatsStpIndex, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoHoldTime=stpInfoHoldTime, lacpInfo=lacpInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbVlan=fdbVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoPorts=vlanInfoPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoRootPort=stpInfoRootPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgPorts=vlanNewCfgPorts, layer2Oper=layer2Oper, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortState=stgNewCfgPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortState=stpInfoPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortState=lacpCurPortState, stgNewCfgIndex=stgNewCfgIndex, layer2Info=layer2Info, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortRole=cistInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbLearnedPort=fdbLearnedPort, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortPriority=cistInfoPortPriority, vlanInfoJumbo=vlanInfoJumbo, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, stpInfoIndex=stpInfoIndex, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortState=lacpNewPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgStg=vlanNewCfgStg, vlanInfoName=vlanInfoName, vlanInfo=vlanInfo, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStats=fdbStats, stpInfoPortIndex=stpInfoPortIndex, mstCistCfg=mstCistCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfo=portTeamInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkgroup=trunkgroup, lacpNewSystemPriority=lacpNewSystemPriority, fdbEntry=fdbEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsOverflows=fdbStatsOverflows, vlan=vlan, stpInfoTable=stpInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamTableMaxSize=portTeamTableMaxSize, stpStats=stpStats, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortTable=cistInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2Stats=layer2Stats, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgVlanName=vlanNewCfgVlanName, layer2=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCfg=portTeamCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfo=cistInfo, mirroring=mirroring, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCfg=mstCfg, stpInfo=stpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Configs=layer2Configs, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortTable=stgCurCfgPortTable, fdbState=fdbState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbMacAddr=fdbMacAddr, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbSrcTrunk=fdbSrcTrunk, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTable=stgCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistBridgeMaxAge=cistBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoStatus=vlanInfoStatus, stpInfoPortTable=stpInfoPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoTable=vlanInfoTable, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortTableEntry=cistInfoPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgTable=vlanNewCfgTable, stgCfg=stgCfg, fdbInfo=fdbInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgState=vlanNewCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbSrcPort=fdbSrcPort, vlanInfoId=vlanInfoId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoRootCost=stpInfoRootCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbTable=fdbTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstGeneralCfg=mstGeneralCfg, fdbRefSps=fdbRefSps, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId)
