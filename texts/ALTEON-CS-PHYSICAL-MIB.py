...
NotificationType, Gauge32, MibIdentifier, IpAddress, iso, TimeTicks, ModuleIdentity, Integer32, ObjectIdentity, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "IpAddress", "iso", "TimeTicks", "ModuleIdentity", "Integer32", "ObjectIdentity", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, layer2Oper=layer2Oper, portTeamInfo=portTeamInfo, mstNewCfgRegionName=mstNewCfgRegionName, stpInfo=stpInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, fdbRefSps=fdbRefSps, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, cistRegionalPathCost=cistRegionalPathCost, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRootPort=cistRootPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoLearn=vlanInfoLearn, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoTable=vlanInfoTable, stgCurCfgState=stgCurCfgState, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbMacAddr=fdbMacAddr, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStats=fdbStats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Info=layer2Info, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortState=lacpCurPortState, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoRootPort=stpInfoRootPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortTable=cistInfoPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortTable=lacpInfoPortTable, fdbTable=fdbTable, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortSelected=lacpInfoPortSelected, BridgeId=BridgeId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsDeletes=fdbStatsDeletes, fdbLearnedPort=fdbLearnedPort, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgStgIndex=stgNewCfgStgIndex, lacp=lacp, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTable=stgStatsPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCfg=mstCfg, fdbStatsCreates=fdbStatsCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgDelete=vlanNewCfgDelete, cistInfo=cistInfo, portTeamInfoState=portTeamInfoState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortState=stpInfoPortState, fdbStatsLookups=fdbStatsLookups, mirroring=mirroring, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoName=vlanInfoName, mstGeneralCfg=mstGeneralCfg, fdbInfo=fdbInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgTable=stgCurCfgTable, cistInfoPortState=cistInfoPortState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgState=vlanCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, fdbEntry=fdbEntry, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgState=portTeamCurCfgState, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPriority=stgNewCfgPriority, stpStats=stpStats, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkgroup=trunkgroup, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoPortsState=portTeamInfoPortsState, fdbClear=fdbClear, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTable=portTeamInfoTable, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCfg=mstCistCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCfg=portTeamCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgState=mstNewCfgState, fdbSrcPort=fdbSrcPort, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, layer2=layer2, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortState=stgNewCfgPortState, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoPorts=vlanInfoPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoStatus=vlanInfoStatus, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Stats=layer2Stats, stgCfg=stgCfg, portTeamTableMaxSize=portTeamTableMaxSize, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRoot=cistRoot, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfo=vlanInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, cistGeneralInfo=cistGeneralInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbState=fdbState, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, PYSNMP_MODULE_ID=layer2)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoId=vlanInfoId, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortEdge=stpInfoPortEdge, cistRegionalRoot=cistRegionalRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoTable=stpInfoTable, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfo=lacpInfo, vlan=vlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortTable=stpInfoPortTable, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, layer2Configs=layer2Configs, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort)
