...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, trunkgroup=trunkgroup, mirroring=mirroring, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortIndex=cistInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortState=lacpNewPortState, portTeamInfoPorts=portTeamInfoPorts, stpInfoIndex=stpInfoIndex, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTable=portTeamInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsDeletes=fdbStatsDeletes, fdbSrcPort=fdbSrcPort, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgState=stgCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortState=lacpCurPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortTable=stgStatsPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgState=mstCurCfgState, vlanInfoTable=vlanInfoTable, stgCfg=stgCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoBwmContract=vlanInfoBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, stpInfo=stpInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoState=portTeamInfoState, cistInfoPortRole=cistInfoPortRole, cistGeneralInfo=cistGeneralInfo, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgIndex=stgNewCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, layer2Info=layer2Info, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortSelected=lacpInfoPortSelected, fdbLearnedPort=fdbLearnedPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoRootCost=stpInfoRootCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, portTeamInfoTrunks=portTeamInfoTrunks, layer2Stats=layer2Stats, lacp=lacp, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, PYSNMP_MODULE_ID=layer2, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoPorts=vlanInfoPorts, mstNewCfgState=mstNewCfgState, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoName=vlanInfoName, stpInfoPortRole=stpInfoPortRole, stgNewCfgState=stgNewCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgAgingTime=stgNewCfgAgingTime, mstNewCfgRegionName=mstNewCfgRegionName, cistRootPort=cistRootPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, BridgeId=BridgeId, stpInfoPortTable=stpInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stgCurCfgTable=stgCurCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Oper=layer2Oper, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortIndex=stgStatsPortIndex, stpInfoTable=stpInfoTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfo=portTeamInfo, portTeamInfoIndex=portTeamInfoIndex, vlan=vlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCfg=mstCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbClear=fdbClear, stpInfoRootPort=stpInfoRootPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbState=fdbState, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfo=vlanInfo, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoTableEntry=stpInfoTableEntry, fdbStats=fdbStats, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRegionalRoot=cistRegionalRoot, fdbMacAddr=fdbMacAddr, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbInfo=fdbInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoStatus=vlanInfoStatus, mstCistCfg=mstCistCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfo=cistInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamTableMaxSize=portTeamTableMaxSize, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbEntry=fdbEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRoot=cistRoot, fdbStatsCreates=fdbStatsCreates, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPriority=stgCurCfgPriority, fdbTable=fdbTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoMaxAge=stpInfoMaxAge, fdbRefSps=fdbRefSps, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfo=lacpInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, stpStats=stpStats, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortPathCost=cistInfoPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCfg=portTeamCfg, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortTable=cistInfoPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgIndex=stgCurCfgIndex, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortState=stpInfoPortState, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbVlan=fdbVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoId=vlanInfoId, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2=layer2, fdbStatsFinds=fdbStatsFinds)
