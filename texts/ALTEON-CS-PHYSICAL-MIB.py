...
NotificationType, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter32, TimeTicks, Counter64, ObjectIdentity, Unsigned32, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter32", "TimeTicks", "Counter64", "ObjectIdentity", "Unsigned32", "iso", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgIndex=stgCurCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoPorts=vlanInfoPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfo=cistInfo, stgCurCfgState=stgCurCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Configs=layer2Configs, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbEntry=fdbEntry, mirroring=mirroring, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoState=portTeamInfoState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoTrunks=portTeamInfoTrunks, fdbSrcPort=fdbSrcPort, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortTable=stpInfoPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoId=vlanInfoId, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, fdbTable=fdbTable, vlanNewCfgStg=vlanNewCfgStg, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoLearn=vlanInfoLearn, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortTable=cistInfoPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistGeneralInfo=cistGeneralInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgState=portTeamNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCreates=fdbStatsCreates, stpInfoHoldTime=stpInfoHoldTime, vlanInfo=vlanInfo, vlanMaxVlanID=vlanMaxVlanID, fdbStatsHiwat=fdbStatsHiwat, stgStatsStpIndex=stgStatsStpIndex, mirrPortMirr=mirrPortMirr, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfo=lacpInfo, fdbClear=fdbClear, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2=layer2, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoRootCost=stpInfoRootCost, layer2Info=layer2Info, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTable=stpInfoTable, stpInfoHelloTime=stpInfoHelloTime, fdbInfo=fdbInfo, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortState=stpInfoPortState, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, fdbVlan=fdbVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgState=vlanNewCfgState, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortLinkType=stpInfoPortLinkType, vlan=vlan, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Stats=layer2Stats, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstGeneralCfg=mstGeneralCfg, cistInfoPortState=cistInfoPortState, lacpNewSystemPriority=lacpNewSystemPriority, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgTable=stgNewCfgTable, lacpNewPortState=lacpNewPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFinds=fdbStatsFinds, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, layer2Oper=layer2Oper, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortRole=stpInfoPortRole, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgState=mstCurCfgState, cistRootPort=cistRootPort, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoTable=vlanInfoTable, stgNewCfgState=stgNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbRefSps=fdbRefSps, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortState=stgNewCfgPortState, fdbMacAddr=fdbMacAddr, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortLink=stgCurCfgPortLink, stpInfo=stpInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortPathCost=cistInfoPortPathCost, cistRegionalRoot=cistRegionalRoot, stgNewCfgIndex=stgNewCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfo=portTeamInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, stpStats=stpStats, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStats=fdbStats, fdbState=fdbState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTableEntry=stpInfoTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, BridgeId=BridgeId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacp=lacp, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, fdbLearnedPort=fdbLearnedPort, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortState=lacpCurPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCfg=mstCfg, stgCurCfgTable=stgCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoIndex=stpInfoIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCfg=mstCistCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortTable=stgStatsPortTable, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortIndex=cistInfoPortIndex, vlanMaxEnt=vlanMaxEnt, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamCfg=portTeamCfg, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRoot=cistRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoName=vlanInfoName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCfg=stgCfg, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPriority=stgNewCfgPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkgroup=trunkgroup, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsLookupFails=fdbStatsLookupFails)
