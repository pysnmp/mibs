...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortState=lacpNewPortState, fdbStatsLookupFails=fdbStatsLookupFails, mstGeneralCfg=mstGeneralCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgState=stgNewCfgState, portTeamNewCfgState=portTeamNewCfgState, fdbStatsDeletes=fdbStatsDeletes, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, stgCfg=stgCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, BridgeId=BridgeId, stpInfoPortRole=stpInfoPortRole, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, stpInfoPortEdge=stpInfoPortEdge, fdbEntry=fdbEntry, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgState=vlanNewCfgState, fdbStats=fdbStats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsLookups=fdbStatsLookups, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortState=lacpCurPortState, stgStatsPortIndex=stgStatsPortIndex, cistRootPort=cistRootPort, stgCurCfgPortState=stgCurCfgPortState, fdbVlan=fdbVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, stpInfo=stpInfo, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRoot=cistRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, layer2Oper=layer2Oper, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortTable=cistInfoPortTable, layer2Info=layer2Info, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoTable=vlanInfoTable, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgState=mstCurCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, vlanInfoLearn=vlanInfoLearn, fdbInfo=fdbInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbSrcPort=fdbSrcPort, cistGeneralInfo=cistGeneralInfo, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoIndex=stpInfoIndex, PYSNMP_MODULE_ID=layer2, portTeamInfoPortsState=portTeamInfoPortsState, cistInfo=cistInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkgroup=trunkgroup, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, mstNewCfgState=mstNewCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Configs=layer2Configs, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCfg=mstCistCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpStats=stpStats, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgIndex=stgCurCfgIndex, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCfg=portTeamCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRootPathCost=cistRootPathCost, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortState=cistInfoPortState, lacpInfo=lacpInfo, portTeamInfoState=portTeamInfoState, stgCurCfgState=stgCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbTable=fdbTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstNewCfgRegionName=mstNewCfgRegionName, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfo=vlanInfo, stpInfoTable=stpInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, fdbMacAddr=fdbMacAddr, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfo=portTeamInfo, fdbState=fdbState, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortLink=stgCurCfgPortLink, layer2=layer2, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirroring=mirroring, stpInfoPortTable=stpInfoPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsCurrent=fdbStatsCurrent, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbRefSps=fdbRefSps, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacp=lacp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoRootCost=stpInfoRootCost, pmNewCfgAddVlan=pmNewCfgAddVlan, cistRegionalPathCost=cistRegionalPathCost, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoName=vlanInfoName, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoJumbo=vlanInfoJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Stats=layer2Stats, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortState=stpInfoPortState, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCfg=mstCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbLearnedPort=fdbLearnedPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, vlanCurCfgTable=vlanCurCfgTable, vlanInfoId=vlanInfoId, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoBwmContract=vlanInfoBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbClear=fdbClear, fdbStatsFinds=fdbStatsFinds, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoIndex=portTeamInfoIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortIndex=cistInfoPortIndex, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoRootPort=stpInfoRootPort, cistInfoPortPriority=cistInfoPortPriority, vlan=vlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge)
