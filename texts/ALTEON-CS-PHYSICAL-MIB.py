...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgState=vlanCurCfgState, portTeamInfo=portTeamInfo, stpInfo=stpInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistGeneralInfo=cistGeneralInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgStpMode=mstCurCfgStpMode, layer2=layer2, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanMaxEnt=vlanMaxEnt, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbClear=fdbClear, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRootPort=cistRootPort, mirroring=mirroring, trunkgroup=trunkgroup, stgCurCfgIndex=stgCurCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsFindFails=fdbStatsFindFails, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirrPortMirr=mirrPortMirr, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCfg=mstCistCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStats=fdbStats, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, portTeamCfg=portTeamCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, lacp=lacp, vlanInfo=vlanInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortState=cistInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgState=stgCurCfgState, vlanInfoTable=vlanInfoTable, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcPort=fdbSrcPort, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoIndex=portTeamInfoIndex, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfo=lacpInfo, fdbVlan=fdbVlan, stpInfoPortTable=stpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortTable=cistInfoPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTable=stpInfoTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoName=vlanInfoName, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, layer2Configs=layer2Configs, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbState=fdbState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Info=layer2Info, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoState=portTeamInfoState, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgState=stgNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, layer2Stats=layer2Stats, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbInfo=fdbInfo, vlanInfoId=vlanInfoId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbEntry=fdbEntry, cistRoot=cistRoot, cistInfo=cistInfo, cistRegionalPathCost=cistRegionalPathCost, vlanInfoPorts=vlanInfoPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbRefSps=fdbRefSps, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTableEntry=vlanNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgState=mstCurCfgState, stpInfoHelloTime=stpInfoHelloTime, stpInfoIndex=stpInfoIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlan=vlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstGeneralCfg=mstGeneralCfg, BridgeId=BridgeId, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbMacAddr=fdbMacAddr, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoJumbo=vlanInfoJumbo, layer2Oper=layer2Oper, stpInfoPortState=stpInfoPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortState=lacpCurPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRegionalRoot=cistRegionalRoot, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCfg=stgCfg, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCfg=mstCfg, stpInfoRootCost=stpInfoRootCost, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbTable=fdbTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, fdbLearnedPort=fdbLearnedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortState=lacpNewPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgPorts=vlanNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, stpStats=stpStats, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFinds=fdbStatsFinds)
