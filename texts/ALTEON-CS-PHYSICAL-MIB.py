...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoState=portTeamInfoState, stgCurCfgTable=stgCurCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortRole=stpInfoPortRole, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStats=fdbStats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoPorts=portTeamInfoPorts, portTeamCfg=portTeamCfg, mirrPortMirr=mirrPortMirr, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRoot=cistRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCfg=mstCistCfg, vlanInfoStatus=vlanInfoStatus, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortCfgTable=lacpNewPortCfgTable, mstGeneralCfg=mstGeneralCfg, stgNewCfgTable=stgNewCfgTable, mirroring=mirroring, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoTable=portTeamInfoTable, fdbTable=fdbTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortTable=stgStatsPortTable, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoIndex=portTeamInfoIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsLookups=fdbStatsLookups, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgState=mstCurCfgState, fdbLearnedPort=fdbLearnedPort, stgCfg=stgCfg, fdbVlan=fdbVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2Configs=layer2Configs, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacp=lacp, fdbState=fdbState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, trunkgroup=trunkgroup, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoRootCost=stpInfoRootCost, cistRootPort=cistRootPort, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeMaxAge=cistBridgeMaxAge, vlan=vlan, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsHiwat=fdbStatsHiwat, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgState=vlanNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpStats=stpStats, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoName=vlanInfoName, fdbStatsDeletes=fdbStatsDeletes, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, PYSNMP_MODULE_ID=layer2, fdbInfo=fdbInfo, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, fdbClear=fdbClear, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgState=vlanCurCfgState, stpInfoTopChanges=stpInfoTopChanges, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Oper=layer2Oper, layer2Info=layer2Info, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgStg=vlanCurCfgStg, stpInfo=stpInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanInfoLearn=vlanInfoLearn, stpInfoIndex=stpInfoIndex, portTeamCurCfgTable=portTeamCurCfgTable, BridgeId=BridgeId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfo=cistInfo, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortState=stpInfoPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2=layer2, fdbStatsFinds=fdbStatsFinds, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgStg=vlanNewCfgStg, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortState=lacpCurPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRootPathCost=cistRootPathCost, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortRole=cistInfoPortRole, cistGeneralInfo=cistGeneralInfo, stgCurCfgState=stgCurCfgState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbMacAddr=fdbMacAddr, lacpNewPortState=lacpNewPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfo=vlanInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoId=vlanInfoId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortTable=lacpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgState=portTeamCurCfgState, fdbStatsCurrent=fdbStatsCurrent)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortState=cistInfoPortState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Stats=layer2Stats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemPriority=lacpNewSystemPriority, mstCfg=mstCfg, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortTable=stpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbRefSps=fdbRefSps, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfo=lacpInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsCreates=fdbStatsCreates, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfo=portTeamInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTable=stpInfoTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgState=stgNewCfgState, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay)
