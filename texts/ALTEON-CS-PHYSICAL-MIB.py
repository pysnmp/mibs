...
Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, iso, Counter32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, IpAddress, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "iso", "Counter32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStats=fdbStats, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoHelloTime=stpInfoHelloTime, portTeamCfg=portTeamCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbInfo=fdbInfo, stgNewCfgPriority=stgNewCfgPriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortState=stpInfoPortState, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoHoldTime=stpInfoHoldTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Configs=layer2Configs, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, fdbMacAddr=fdbMacAddr, vlan=vlan, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Info=layer2Info, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCfg=mstCfg, stpStats=stpStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgState=stgNewCfgState, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgPorts=vlanNewCfgPorts, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTable=stpInfoTable, vlanInfoPorts=vlanInfoPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2Oper=layer2Oper, fdbLearnedPort=fdbLearnedPort, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfo=portTeamInfo, mstCistCfg=mstCistCfg, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, cistRoot=cistRoot, cistInfoPortRole=cistInfoPortRole, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkgroup=trunkgroup, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgState=stgCurCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortIndex=cistInfoPortIndex, stgStatsStpIndex=stgStatsStpIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortTableEntry=cistInfoPortTableEntry, mirrPortMirr=mirrPortMirr, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortEdge=stpInfoPortEdge, fdbStatsCreates=fdbStatsCreates, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgJumbo=vlanNewCfgJumbo, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsFinds=fdbStatsFinds, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbClear=fdbClear, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbTable=fdbTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2=layer2, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRegionalRoot=cistRegionalRoot, vlanInfoLearn=vlanInfoLearn, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfo=lacpInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbState=fdbState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCfg=stgCfg, stpInfoTopChanges=stpInfoTopChanges, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTable=portTeamNewCfgTable, BridgeId=BridgeId, stpInfoPortRole=stpInfoPortRole, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgState=mstCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoId=vlanInfoId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, PYSNMP_MODULE_ID=layer2, layer2Stats=layer2Stats, fdbEntry=fdbEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortStpIndex=stpInfoPortStpIndex, mirroring=mirroring, vlanInfo=vlanInfo, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoState=portTeamInfoState, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, stpInfo=stpInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoRootPort=stpInfoRootPort, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTable=portTeamInfoTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoName=vlanInfoName, lacpCurPortState=lacpCurPortState, portTeamInfoPorts=portTeamInfoPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, fdbStatsLookups=fdbStatsLookups, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRootPathCost=cistRootPathCost, lacp=lacp, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgState=portTeamCurCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, cistRootPort=cistRootPort, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortLink=stgCurCfgPortLink, cistInfo=cistInfo, vlanNewCfgState=vlanNewCfgState, fdbVlan=fdbVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbRefSps=fdbRefSps, cistInfoPortTable=cistInfoPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap)
