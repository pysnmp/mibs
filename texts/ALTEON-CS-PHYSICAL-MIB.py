...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, layer2Info=layer2Info, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCfg=portTeamCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsCurrent=fdbStatsCurrent, stpInfo=stpInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoRootPort=stpInfoRootPort, stgStatsPortIndex=stgStatsPortIndex, mirrPortMirr=mirrPortMirr, mstCurCfgState=mstCurCfgState, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortState=lacpNewPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortTable=stpInfoPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfo=portTeamInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortTable=cistInfoPortTable, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2Configs=layer2Configs, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbVlan=fdbVlan, stpInfoTable=stpInfoTable, fdbLearnedPort=fdbLearnedPort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfo=vlanInfo, cistRootPort=cistRootPort, stgStatsPortTable=stgStatsPortTable, cistRootPathCost=cistRootPathCost, fdbRefSps=fdbRefSps, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlan=vlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCfg=stgCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsDeletes=fdbStatsDeletes, stpInfoIndex=stpInfoIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgState=stgCurCfgState, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstGeneralCfg=mstGeneralCfg, vlanInfoId=vlanInfoId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkgroup=trunkgroup, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgState=mstNewCfgState, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, vlanInfoName=vlanInfoName, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortIndex=stpInfoPortIndex, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortState=lacpCurPortState, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoStatus=vlanInfoStatus, stpInfoHelloTime=stpInfoHelloTime, mstCfg=mstCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbSrcPort=fdbSrcPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, layer2Oper=layer2Oper, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoTable=vlanInfoTable, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgState=stgNewCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbTable=fdbTable, stpInfoRootCost=stpInfoRootCost, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgTable=stgNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortSelected=lacpInfoPortSelected, mirroring=mirroring, cistGeneralInfo=cistGeneralInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbInfo=fdbInfo, layer2=layer2, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsLookups=fdbStatsLookups, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortRole=cistInfoPortRole, lacp=lacp, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoPorts=vlanInfoPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfo=lacpInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbMacAddr=fdbMacAddr, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Stats=layer2Stats, stpInfoPortEdge=stpInfoPortEdge, mstCistCfg=mstCistCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRoot=cistRoot, cistRegionalRoot=cistRegionalRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortState=cistInfoPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgTable=trunkGroupNewCfgTable, BridgeId=BridgeId, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgState=portTeamCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortRole=stpInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, stpStats=stpStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, fdbEntry=fdbEntry, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStats=fdbStats, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, cistInfo=cistInfo, vlanCurCfgState=vlanCurCfgState, vlanNewCfgState=vlanNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, PYSNMP_MODULE_ID=layer2, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortState=stpInfoPortState, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoState=portTeamInfoState, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn)
