...
Gauge32, Bits, IpAddress, TimeTicks, iso, NotificationType, ObjectIdentity, MibIdentifier, Integer32, Counter64, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "IpAddress", "TimeTicks", "iso", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter64", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortState=stpInfoPortState, portTeamInfo=portTeamInfo, stgNewCfgPortState=stgNewCfgPortState, portTeamCfg=portTeamCfg, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurSystemPriority=lacpCurSystemPriority, fdbStats=fdbStats, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsFinds=fdbStatsFinds, trunkgroup=trunkgroup, lacpInfo=lacpInfo, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoPortsState=portTeamInfoPortsState, fdbClear=fdbClear, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortRole=cistInfoPortRole, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamCurCfgTable=portTeamCurCfgTable, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfo=stpInfo, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgTable=vlanNewCfgTable, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbTable=fdbTable, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, layer2Stats=layer2Stats, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, layer2=layer2, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpStats=stpStats, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortTable=stpInfoPortTable, stgCfg=stgCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCfg=mstCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoState=portTeamInfoState, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoIndex=stpInfoIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoPorts=portTeamInfoPorts, fdbEntry=fdbEntry, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgTable=stgNewCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, BridgeId=BridgeId, lacpInfoPortTable=lacpInfoPortTable, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgState=stgNewCfgState, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoTable=stpInfoTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoRootCost=stpInfoRootCost, layer2Info=layer2Info, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoName=vlanInfoName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoIndex=portTeamInfoIndex, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsCreates=fdbStatsCreates, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Configs=layer2Configs, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mirrPortMirr=mirrPortMirr, mstNewCfgState=mstNewCfgState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPriority=stgNewCfgPriority, cistRoot=cistRoot, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoId=vlanInfoId, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbVlan=fdbVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbRefSps=fdbRefSps, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcTrunk=fdbSrcTrunk, mstCistDefaultCfg=mstCistDefaultCfg, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortState=lacpNewPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgState=mstCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, PYSNMP_MODULE_ID=layer2, portTeamInfoTable=portTeamInfoTable, stpInfoPortRole=stpInfoPortRole, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgState=stgCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalRoot=cistRegionalRoot, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortTable=cistInfoPortTable, vlan=vlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfo=vlanInfo, mstCistCfg=mstCistCfg, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRootPort=cistRootPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgState=vlanNewCfgState, vlanInfoPorts=vlanInfoPorts, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortIndex=stpInfoPortIndex, stgStatsStpIndex=stgStatsStpIndex, fdbInfo=fdbInfo, cistInfo=cistInfo, cistRootPathCost=cistRootPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mirroring=mirroring, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortState=lacpCurPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, layer2Oper=layer2Oper, fdbStatsCurrent=fdbStatsCurrent, mstCurCfgRegionName=mstCurCfgRegionName, lacp=lacp, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsLookups=fdbStatsLookups, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbState=fdbState, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoRootPort=stpInfoRootPort, vlanInfoLearn=vlanInfoLearn, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan)
