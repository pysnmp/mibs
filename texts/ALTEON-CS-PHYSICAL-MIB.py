...
Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter64, IpAddress, Integer32, NotificationType, Unsigned32, ModuleIdentity, MibIdentifier, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter64", "IpAddress", "Integer32", "NotificationType", "Unsigned32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCfg=mstCistCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoLearn=vlanInfoLearn, fdbStatsOverflows=fdbStatsOverflows, fdbClear=fdbClear, layer2Info=layer2Info, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgIndex=stgNewCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStats=fdbStats, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoJumbo=vlanInfoJumbo, stpInfoIndex=stpInfoIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoName=vlanInfoName, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortTable=cistInfoPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfo=portTeamInfo, vlanInfo=vlanInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, layer2Oper=layer2Oper, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortState=stpInfoPortState, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsHiwat=fdbStatsHiwat, fdbStatsLookups=fdbStatsLookups, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, mirroring=mirroring, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacp=lacp, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Configs=layer2Configs, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgStg=vlanCurCfgStg, BridgeId=BridgeId, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRootPort=cistRootPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbState=fdbState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgTable=stgNewCfgTable, vlanInfoPorts=vlanInfoPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoState=portTeamInfoState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, vlanCurCfgState=vlanCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlan=vlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoPorts=portTeamInfoPorts, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgState=portTeamNewCfgState, fdbStatsFinds=fdbStatsFinds, layer2=layer2, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbTable=fdbTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTable=vlanInfoTable, lacpNewPortState=lacpNewPortState, fdbEntry=fdbEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCfg=portTeamCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoRootPort=stpInfoRootPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCreates=fdbStatsCreates, stpInfoTable=stpInfoTable, portTeamInfoTable=portTeamInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfo=cistInfo, stgCurCfgPriority=stgCurCfgPriority, fdbInfo=fdbInfo, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, PYSNMP_MODULE_ID=layer2, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgState=stgCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Stats=layer2Stats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRoot=cistRoot, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortState=cistInfoPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbMacAddr=fdbMacAddr, vlanInfoTableEntry=vlanInfoTableEntry, mstCfg=mstCfg, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfo=stpInfo, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgState=stgNewCfgState, fdbVlan=fdbVlan, fdbRefSps=fdbRefSps, lacpNewSystemPriority=lacpNewSystemPriority, trunkgroup=trunkgroup, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgRegionName=mstCurCfgRegionName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortPathCost=stpInfoPortPathCost, mstCurCfgState=mstCurCfgState, cistRegionalPathCost=cistRegionalPathCost, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoId=vlanInfoId, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortTable=stpInfoPortTable, stgCfg=stgCfg, stpStats=stpStats)
