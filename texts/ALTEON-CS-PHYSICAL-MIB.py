...
Integer32, iso, Unsigned32, ObjectIdentity, IpAddress, ModuleIdentity, Counter32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Unsigned32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanMaxEnt=vlanMaxEnt, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoTable=portTeamInfoTable, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, fdbInfo=fdbInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfo=portTeamInfo, fdbStatsHiwat=fdbStatsHiwat, PYSNMP_MODULE_ID=layer2, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, trunkgroup=trunkgroup, lacpNewSystemPriority=lacpNewSystemPriority, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoId=vlanInfoId, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoStatus=vlanInfoStatus, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlan=vlan, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbState=fdbState, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbMacAddr=fdbMacAddr, cistBridgeHelloTime=cistBridgeHelloTime, cistRegionalRoot=cistRegionalRoot, portTeamInfoPorts=portTeamInfoPorts, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Info=layer2Info, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsStpIndex=stgStatsStpIndex, fdbClear=fdbClear, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, cistInfo=cistInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstGeneralCfg=mstGeneralCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoLearn=vlanInfoLearn, stgCfg=stgCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, BridgeId=BridgeId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfo=vlanInfo, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortState=cistInfoPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpStats=stpStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbVlan=fdbVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, stpInfoIndex=stpInfoIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoTable=vlanInfoTable, stgNewCfgState=stgNewCfgState, fdbTable=fdbTable, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortState=lacpNewPortState, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgVlanName=vlanNewCfgVlanName, lacp=lacp, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, layer2Oper=layer2Oper, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Configs=layer2Configs, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfo=stpInfo, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCfg=mstCistCfg, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbSrcPort=fdbSrcPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, stgNewCfgIndex=stgNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTable=stgNewCfgTable, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgIndex=stgCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortLinkType=stpInfoPortLinkType, cistRoot=cistRoot, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCfg=mstCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoHelloTime=stpInfoHelloTime, layer2=layer2, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoState=portTeamInfoState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbLearnedPort=fdbLearnedPort, vlanInfoName=vlanInfoName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortTable=stpInfoPortTable, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoRootPort=stpInfoRootPort, fdbStatsLookups=fdbStatsLookups, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistGeneralInfo=cistGeneralInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCfg=portTeamCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgState=vlanCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortPriority=cistInfoPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortState=lacpCurPortState, lacpInfo=lacpInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoTable=stpInfoTable, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoIndex=portTeamInfoIndex, fdbStatsDeletes=fdbStatsDeletes, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2Stats=layer2Stats, fdbStatsCreates=fdbStatsCreates, fdbStats=fdbStats, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCurCfgState=mstCurCfgState, fdbRefSps=fdbRefSps, stpInfoTableEntry=stpInfoTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoPorts=vlanInfoPorts, vlanCurCfgTable=vlanCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortRole=cistInfoPortRole, cistRootPort=cistRootPort, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost)
