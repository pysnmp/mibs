...
ObjectIdentity, Counter64, ModuleIdentity, Integer32, MibIdentifier, NotificationType, IpAddress, Bits, Counter32, iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "IpAddress", "Bits", "Counter32", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsStpIndex=stgStatsStpIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanMaxEnt=vlanMaxEnt, vlanNewCfgTable=vlanNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, cistRoot=cistRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoRootPort=stpInfoRootPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoTableEntry=stpInfoTableEntry, layer2Stats=layer2Stats, fdbVlan=fdbVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2=layer2, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlan=vlan, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgStg=vlanCurCfgStg, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsHiwat=fdbStatsHiwat, fdbStatsLookups=fdbStatsLookups, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCfg=mstCistCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortState=stgNewCfgPortState, vlanInfoId=vlanInfoId, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgState=stgCurCfgState, vlanInfoStatus=vlanInfoStatus, portTeamInfoState=portTeamInfoState, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCurCfgState=mstCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortRole=cistInfoPortRole, vlanInfoTable=vlanInfoTable, vlanNewCfgState=vlanNewCfgState, lacp=lacp, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfo=stpInfo, stgNewCfgTable=stgNewCfgTable, cistInfo=cistInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirroring=mirroring, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCfg=stgCfg, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoIndex=stpInfoIndex, cistRootPathCost=cistRootPathCost, mstGeneralCfg=mstGeneralCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistRootPort=cistRootPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, lacpInfoPortTable=lacpInfoPortTable, fdbStats=fdbStats, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortSelected=lacpInfoPortSelected, fdbClear=fdbClear, vlanInfo=vlanInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanInfoPorts=vlanInfoPorts, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, fdbMacAddr=fdbMacAddr, fdbLearnedPort=fdbLearnedPort, stpInfoPortEdge=stpInfoPortEdge, vlanInfoName=vlanInfoName, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortState=lacpCurPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCfg=portTeamCfg, fdbRefSps=fdbRefSps, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, stpInfoMaxAge=stpInfoMaxAge, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupCurCfgState=trunkGroupCurCfgState, cistRegionalRoot=cistRegionalRoot, cistRegionalPathCost=cistRegionalPathCost, fdbState=fdbState, BridgeId=BridgeId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortState=lacpNewPortState, PYSNMP_MODULE_ID=layer2, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTable=stpInfoTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbEntry=fdbEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Info=layer2Info, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsFindFails=fdbStatsFindFails, fdbTable=fdbTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoHelloTime=stpInfoHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, layer2Oper=layer2Oper, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortTable=cistInfoPortTable, lacpInfo=lacpInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgState=portTeamNewCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, mirrPortMirr=mirrPortMirr, stpStats=stpStats, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, layer2Configs=layer2Configs)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgState=vlanCurCfgState, fdbInfo=fdbInfo, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortTable=stgStatsPortTable, mstCfg=mstCfg, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoLearn=vlanInfoLearn, stpInfoPortRole=stpInfoPortRole, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkgroup=trunkgroup, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFinds=fdbStatsFinds, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState)
