...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgPortState=stgCurCfgPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfo=lacpInfo, vlanInfoLearn=vlanInfoLearn, fdbStatsLookups=fdbStatsLookups, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRegionalRoot=cistRegionalRoot, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgTable=stgNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortState=lacpCurPortState, stgCfg=stgCfg, cistInfo=cistInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgState=trunkGroupCurCfgState, cistRootPort=cistRootPort, fdbTable=fdbTable, vlanInfoTable=vlanInfoTable, vlanCurCfgPorts=vlanCurCfgPorts, cistRoot=cistRoot, layer2Stats=layer2Stats, fdbInfo=fdbInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoRootPort=stpInfoRootPort, trunkgroup=trunkgroup, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfoTrunks=portTeamInfoTrunks, fdbVlan=fdbVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortState=lacpNewPortState, stgStatsStpIndex=stgStatsStpIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgState=stgCurCfgState, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbClear=fdbClear, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCfg=mstCfg, cistGeneralInfo=cistGeneralInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortTable=cistInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Oper=layer2Oper, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortIndex=stpInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanMaxEnt=vlanMaxEnt, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFindFails=fdbStatsFindFails, vlanInfoStatus=vlanInfoStatus, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mirrPortMirr=mirrPortMirr, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortRole=stpInfoPortRole, vlanNewCfgLearn=vlanNewCfgLearn, cistRootPathCost=cistRootPathCost, vlanInfoId=vlanInfoId, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgStpMode=mstCurCfgStpMode, fdbRefSps=fdbRefSps, vlanInfoName=vlanInfoName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfo=portTeamInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCfg=mstCistCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStats=fdbStats, mstNewCfgStpMode=mstNewCfgStpMode, stpStats=stpStats, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortIndex=stgStatsPortIndex, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgState=vlanNewCfgState, layer2=layer2, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoState=portTeamInfoState, vlanInfo=vlanInfo, stgNewCfgPortLink=stgNewCfgPortLink, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortRole=cistInfoPortRole, mirroring=mirroring, cistInfoPortLinkType=cistInfoPortLinkType, mstGeneralCfg=mstGeneralCfg, fdbStatsDeletes=fdbStatsDeletes, BridgeId=BridgeId, stpInfo=stpInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortState=stgNewCfgPortState, vlan=vlan, fdbState=fdbState, stpInfoIndex=stpInfoIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortTable=stgStatsPortTable, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacp=lacp, fdbSrcPort=fdbSrcPort, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgTable=vlanNewCfgTable, layer2Configs=layer2Configs, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTable=stpInfoTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoPorts=vlanInfoPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortState=cistInfoPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbEntry=fdbEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortTable=stpInfoPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbMacAddr=fdbMacAddr, stpInfoTopChanges=stpInfoTopChanges, layer2Info=layer2Info, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort)
