...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, mirroring=mirroring, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoId=vlanInfoId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2=layer2, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortLink=stgNewCfgPortLink, layer2Configs=layer2Configs, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsStpIndex=stgStatsStpIndex, fdbClear=fdbClear, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortRole=cistInfoPortRole, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, layer2Oper=layer2Oper, vlanInfoJumbo=vlanInfoJumbo, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbVlan=fdbVlan, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortNtt=lacpInfoPortNtt, cistRoot=cistRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookups=fdbStatsLookups, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfo=stpInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgState=vlanCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbState=fdbState, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCfg=mstCfg, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgState=mstCurCfgState, cistInfo=cistInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortState=cistInfoPortState, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, PYSNMP_MODULE_ID=layer2, portTeamInfo=portTeamInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCfg=stgCfg, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoName=vlanInfoName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbTable=fdbTable, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTable=stpInfoTable, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootPort=stpInfoRootPort, stpInfoHelloTime=stpInfoHelloTime, cistRootPathCost=cistRootPathCost, stgStatsPortIndex=stgStatsPortIndex, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortTable=cistInfoPortTable, layer2Info=layer2Info, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgTable=stgCurCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbSrcPort=fdbSrcPort, stpInfoForwardDelay=stpInfoForwardDelay, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortTable=stgStatsPortTable, lacpCurPortState=lacpCurPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbInfo=fdbInfo, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPriority=stgNewCfgPriority, vlanMaxEnt=vlanMaxEnt, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgState=mstNewCfgState, cistInfoPortPriority=cistInfoPortPriority, stpInfoIndex=stpInfoIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, lacp=lacp, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRootPort=cistRootPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgState=stgNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, cistRegionalPathCost=cistRegionalPathCost, cistGeneralInfo=cistGeneralInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkgroup=trunkgroup, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanInfo=vlanInfo, vlanNewCfgState=vlanNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsFinds=fdbStatsFinds, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoTable=vlanInfoTable, portTeamTableMaxSize=portTeamTableMaxSize, stpStats=stpStats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoStatus=vlanInfoStatus, mstCistCfg=mstCistCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, fdbStatsCurrent=fdbStatsCurrent, stpInfoHoldTime=stpInfoHoldTime, fdbSrcTrunk=fdbSrcTrunk, fdbStats=fdbStats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfo=lacpInfo, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistBridgeForwardDelay=cistBridgeForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlan=vlan, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgState=stgCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, mirrPortMirr=mirrPortMirr, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, BridgeId=BridgeId, fdbMacAddr=fdbMacAddr, layer2Stats=layer2Stats, stpInfoPortState=stpInfoPortState, vlanInfoLearn=vlanInfoLearn, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbRefSps=fdbRefSps, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortState=lacpNewPortState, fdbEntry=fdbEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoState=portTeamInfoState)
