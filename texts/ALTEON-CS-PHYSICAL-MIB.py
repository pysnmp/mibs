...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgRegionName=mstNewCfgRegionName, cistRoot=cistRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbLearnedPort=fdbLearnedPort, cistRootPort=cistRootPort, BridgeId=BridgeId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, layer2Oper=layer2Oper, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbMacAddr=fdbMacAddr, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfo=vlanInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcPort=fdbSrcPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortIndex=stgStatsPortIndex, layer2Configs=layer2Configs, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortRole=stpInfoPortRole, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortState=cistInfoPortState, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgState=stgCurCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, fdbTable=fdbTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortTable=stgStatsPortTable, cistInfoPortRole=cistInfoPortRole, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbClear=fdbClear, PYSNMP_MODULE_ID=layer2, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkgroup=trunkgroup, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfo=lacpInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoTrunksState=portTeamInfoTrunksState, cistGeneralInfo=cistGeneralInfo, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoIndex=portTeamInfoIndex, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoIndex=stpInfoIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCfg=stgCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortPriority=cistInfoPortPriority, layer2Info=layer2Info, mstNewCfgState=mstNewCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbSrcTrunk=fdbSrcTrunk, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgStpMode=mstNewCfgStpMode, mstGeneralCfg=mstGeneralCfg, cistInfo=cistInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsFindFails=fdbStatsFindFails, stpInfo=stpInfo, cistRootPathCost=cistRootPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortIndex=stpInfoPortIndex, vlanInfoId=vlanInfoId, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeHelloTime=cistBridgeHelloTime, lacp=lacp, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortEdge=stpInfoPortEdge, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbEntry=fdbEntry, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgState=mstCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortState=lacpNewPortState, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortState=stpInfoPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgIndex=stgNewCfgIndex, vlanInfoLearn=vlanInfoLearn, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbState=fdbState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbInfo=fdbInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFinds=fdbStatsFinds, vlanInfoBwmContract=vlanInfoBwmContract, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoTable=vlanInfoTable, stgNewCfgState=stgNewCfgState, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoRootPort=stpInfoRootPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCfg=portTeamCfg, vlan=vlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, mirrPortMirr=mirrPortMirr, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgState=vlanCurCfgState, mirroring=mirroring, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortTable=stpInfoPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfo=portTeamInfo, cistRegionalRoot=cistRegionalRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgState=portTeamCurCfgState, stpInfoTable=stpInfoTable, fdbStats=fdbStats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpStats=stpStats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistBridgeCfg=mstCistBridgeCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCfg=mstCistCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCfg=mstCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbVlan=fdbVlan, fdbRefSps=fdbRefSps, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2=layer2, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoHoldTime=stpInfoHoldTime, vlanInfoName=vlanInfoName, layer2Stats=layer2Stats, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoState=portTeamInfoState, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsDeletes=fdbStatsDeletes, fdbStatsOverflows=fdbStatsOverflows, fdbStatsLookups=fdbStatsLookups, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus)
