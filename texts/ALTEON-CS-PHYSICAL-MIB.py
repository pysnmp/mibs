...
MibIdentifier, iso, NotificationType, Counter64, Counter32, IpAddress, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "Counter64", "Counter32", "IpAddress", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, portTeamInfo=portTeamInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2=layer2, stpInfo=stpInfo, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stpStats=stpStats, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgPriority=stgNewCfgPriority, fdbClear=fdbClear, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortTable=stpInfoPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbSrcPort=fdbSrcPort, vlanInfoPorts=vlanInfoPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgState=mstCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortRole=cistInfoPortRole, lacpCurPortState=lacpCurPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoIndex=stpInfoIndex, portTeamInfoPortsState=portTeamInfoPortsState, fdbLearnedPort=fdbLearnedPort, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsFindFails=fdbStatsFindFails, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbInfo=fdbInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbVlan=fdbVlan, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgState=stgNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCfg=portTeamCfg, trunkgroup=trunkgroup, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, cistRootPort=cistRootPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTable=stpInfoTable, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfo=vlanInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStats=fdbStats, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgPorts=portTeamNewCfgPorts, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTableEntry=stpInfoTableEntry, mstCfg=mstCfg, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfo=lacpInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsStpIndex=stgStatsStpIndex, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgState=mstNewCfgState, fdbTable=fdbTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamTableMaxSize=portTeamTableMaxSize, fdbRefSps=fdbRefSps, fdbStatsOverflows=fdbStatsOverflows, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbEntry=fdbEntry, cistRegionalPathCost=cistRegionalPathCost, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoLearn=vlanInfoLearn, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgTable=vlanCurCfgTable, layer2Stats=layer2Stats, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoState=portTeamInfoState, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsLookups=fdbStatsLookups, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortEdge=stpInfoPortEdge, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortState=cistInfoPortState, vlanInfoName=vlanInfoName, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortTable=stgStatsPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoRootPort=stpInfoRootPort, BridgeId=BridgeId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewSystemPriority=lacpNewSystemPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortLinkType=stpInfoPortLinkType, layer2Configs=layer2Configs, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoId=vlanInfoId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Info=layer2Info, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlan=vlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortRole=stpInfoPortRole, stgCurCfgTable=stgCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfo=cistInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbState=fdbState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoTable=portTeamInfoTable, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgState=vlanNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacp=lacp)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, layer2Oper=layer2Oper, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgState=portTeamNewCfgState, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRoot=cistRoot, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCfg=mstCistCfg, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoIndex=portTeamInfoIndex, fdbMacAddr=fdbMacAddr, stpInfoPortState=stpInfoPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstGeneralCfg=mstGeneralCfg, vlanInfoStatus=vlanInfoStatus, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCfg=stgCfg)
