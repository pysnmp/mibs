...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortState=lacpCurPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortRole=cistInfoPortRole, vlanInfo=vlanInfo, lacpInfo=lacpInfo, vlanCurCfgLearn=vlanCurCfgLearn, vlan=vlan, fdbClear=fdbClear, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbRefSps=fdbRefSps, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoTable=portTeamInfoTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewPortState=lacpNewPortState, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoTopChanges=stpInfoTopChanges, cistRootPathCost=cistRootPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoState=portTeamInfoState, fdbState=fdbState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortTable=cistInfoPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, layer2Stats=layer2Stats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbVlan=fdbVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkgroup=trunkgroup, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCfg=mstCistCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanMaxEnt=vlanMaxEnt, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, BridgeId=BridgeId, stpInfoPortRole=stpInfoPortRole, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCfg=mstCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, layer2Configs=layer2Configs, lacp=lacp, stgNewCfgState=stgNewCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpStats=stpStats, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mirroring=mirroring, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortState=cistInfoPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoName=vlanInfoName, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgTable=stgCurCfgTable, stpInfoPortState=stpInfoPortState, portTeamCurCfgTable=portTeamCurCfgTable, layer2=layer2, fdbStats=fdbStats, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortIndex=lacpInfoPortIndex, cistInfo=cistInfo, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoTable=vlanInfoTable, vlanInfoLearn=vlanInfoLearn, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Oper=layer2Oper, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgTable=stgNewCfgTable, fdbStatsFinds=fdbStatsFinds, fdbTable=fdbTable, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgPorts=vlanNewCfgPorts, PYSNMP_MODULE_ID=layer2, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTable=stpInfoTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgState=stgCurCfgState, vlanInfoId=vlanInfoId, fdbEntry=fdbEntry, fdbMacAddr=fdbMacAddr, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortPriority=stgCurCfgPortPriority, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoPorts=vlanInfoPorts, stgNewCfgIndex=stgNewCfgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCfg=portTeamCfg, stgCurCfgPortState=stgCurCfgPortState, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgState=mstNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, cistRootPort=cistRootPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCfg=stgCfg, fdbInfo=fdbInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcPort=fdbSrcPort, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistRegionalRoot=cistRegionalRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfo=stpInfo, fdbStatsLookups=fdbStatsLookups, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCurCfgState=mstCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRoot=cistRoot, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortPriority=cistInfoPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoBwmContract=vlanInfoBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgState=vlanNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoIndex=stpInfoIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbLearnedPort=fdbLearnedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsCreates=fdbStatsCreates, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsCurrent=fdbStatsCurrent, vlanMaxVlanID=vlanMaxVlanID, stpInfoRootCost=stpInfoRootCost, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2Info=layer2Info, stgNewCfgPortLink=stgNewCfgPortLink, mstGeneralCfg=mstGeneralCfg, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfo=portTeamInfo, portTeamNewCfgTable=portTeamNewCfgTable)
