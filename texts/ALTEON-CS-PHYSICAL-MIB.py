...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoState=portTeamInfoState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCfg=stgCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbSrcPort=fdbSrcPort, vlanMaxEnt=vlanMaxEnt, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortState=lacpNewPortState, cistRegionalRoot=cistRegionalRoot, stpStats=stpStats, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgTable=stgNewCfgTable, fdbState=fdbState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistRoot=cistRoot, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2=layer2, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoIndex=stpInfoIndex, cistRootPort=cistRootPort, vlanInfoPorts=vlanInfoPorts, layer2Configs=layer2Configs, stpInfo=stpInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbRefSps=fdbRefSps, vlanInfoStatus=vlanInfoStatus, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgState=mstNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortTable=stgStatsPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoId=vlanInfoId, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbEntry=fdbEntry, lacpInfoPortSelected=lacpInfoPortSelected, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortState=stpInfoPortState, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mirrPortMirr=mirrPortMirr, stgNewCfgState=stgNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRootPathCost=cistRootPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCfg=portTeamCfg, fdbStats=fdbStats, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, BridgeId=BridgeId, fdbStatsCreates=fdbStatsCreates, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortRole=cistInfoPortRole, portTeamInfo=portTeamInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortState=lacpCurPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, lacp=lacp, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoLearn=vlanInfoLearn, layer2Oper=layer2Oper, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoName=vlanInfoName, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgTable=vlanCurCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgState=stgCurCfgState, stpInfoPortPathCost=stpInfoPortPathCost, fdbClear=fdbClear, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, fdbVlan=fdbVlan, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortState=cistInfoPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortTable=cistInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgState=mstCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, mirroring=mirroring, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, mstGeneralCfg=mstGeneralCfg, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsFinds=fdbStatsFinds, vlan=vlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCfg=mstCfg, PYSNMP_MODULE_ID=layer2, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsCurrent=fdbStatsCurrent, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfo=vlanInfo, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTable=portTeamInfoTable, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortRole=stpInfoPortRole, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbInfo=fdbInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, trunkgroup=trunkgroup, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Info=layer2Info, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTable=stpInfoTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortPriority=cistInfoPortPriority, fdbTable=fdbTable, vlanNewCfgState=vlanNewCfgState, cistInfo=cistInfo, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfo=lacpInfo, fdbMacAddr=fdbMacAddr, portTeamCurCfgState=portTeamCurCfgState, layer2Stats=layer2Stats, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes, vlanMaxVlanID=vlanMaxVlanID)
