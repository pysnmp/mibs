...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFinds=fdbStatsFinds, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortNtt=lacpInfoPortNtt, layer2Configs=layer2Configs, cistRootPort=cistRootPort, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortEdge=stpInfoPortEdge, cistRootPathCost=cistRootPathCost, vlanInfoId=vlanInfoId, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbMacAddr=fdbMacAddr, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfo=stpInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoTable=stpInfoTable, vlanNewCfgAddPort=vlanNewCfgAddPort, cistRegionalRoot=cistRegionalRoot, mstCurCfgState=mstCurCfgState, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTable=stgNewCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortState=stgCurCfgPortState, portTeamInfo=portTeamInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoStatus=vlanInfoStatus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbLearnedPort=fdbLearnedPort, lacpInfoPortSelected=lacpInfoPortSelected, lacp=lacp, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgState=portTeamNewCfgState, fdbRefSps=fdbRefSps, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortState=lacpCurPortState, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoName=vlanInfoName, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, cistInfo=cistInfo, cistGeneralInfo=cistGeneralInfo, fdbSrcPort=fdbSrcPort, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfo=vlanInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgIndex=stgNewCfgIndex, layer2=layer2, stpInfoRootCost=stpInfoRootCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCreates=fdbStatsCreates, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Oper=layer2Oper, vlan=vlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStats=fdbStats, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTableEntry=stpInfoTableEntry, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoState=portTeamInfoState, stpStats=stpStats, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortState=stpInfoPortState, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoRootPort=stpInfoRootPort, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbInfo=fdbInfo, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoMaxAge=stpInfoMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewSystemPriority=lacpNewSystemPriority, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortState=cistInfoPortState, layer2Info=layer2Info, mirroring=mirroring, stpInfoPortTable=stpInfoPortTable, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoTable=portTeamInfoTable, stgCfg=stgCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCfg=mstCistCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, fdbTable=fdbTable, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortRole=stpInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, fdbEntry=fdbEntry, stgNewCfgPortState=stgNewCfgPortState, lacpCurSystemPriority=lacpCurSystemPriority, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsStpIndex=stgStatsStpIndex, portTeamCfg=portTeamCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCfg=mstCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbClear=fdbClear, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, BridgeId=BridgeId, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbVlan=fdbVlan, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgState=stgCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfo=lacpInfo, trunkgroup=trunkgroup, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mirrPortMirr=mirrPortMirr, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgVlanId=vlanCurCfgVlanId, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgState=stgNewCfgState, stgCurCfgTable=stgCurCfgTable, layer2Stats=layer2Stats, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsCurrent=fdbStatsCurrent, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsHiwat=fdbStatsHiwat, fdbState=fdbState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgState=vlanNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRoot=cistRoot, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsOverflows=fdbStatsOverflows)
