...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, lacp=lacp, mstCistCfg=mstCistCfg, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsFinds=fdbStatsFinds, lacpInfo=lacpInfo, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, layer2Configs=layer2Configs, portTeamInfoTable=portTeamInfoTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistGeneralInfo=cistGeneralInfo, trunkgroup=trunkgroup, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, cistRootPort=cistRootPort, mstGeneralCfg=mstGeneralCfg, cistInfoPortState=cistInfoPortState, cistRootPathCost=cistRootPathCost, stpInfoTableEntry=stpInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoId=vlanInfoId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbVlan=fdbVlan, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgState=vlanNewCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRegionalRoot=cistRegionalRoot, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, layer2Info=layer2Info, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortRole=cistInfoPortRole, portTeamCfg=portTeamCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoName=vlanInfoName, stgCurCfgState=stgCurCfgState, cistBridgeHelloTime=cistBridgeHelloTime, stpStats=stpStats, stgNewCfgPortState=stgNewCfgPortState, mstCfg=mstCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mirrPortMirr=mirrPortMirr, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanMaxVlanID=vlanMaxVlanID, vlan=vlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, lacpCurPortState=lacpCurPortState, fdbRefSps=fdbRefSps, lacpNewPortState=lacpNewPortState, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, layer2=layer2, cistInfo=cistInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, fdbEntry=fdbEntry, fdbClear=fdbClear, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgState=stgNewCfgState, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, fdbLearnedPort=fdbLearnedPort, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, layer2Stats=layer2Stats, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbInfo=fdbInfo, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoState=portTeamInfoState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoRootCost=stpInfoRootCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, fdbMacAddr=fdbMacAddr, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortRole=stpInfoPortRole, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, portTeamInfo=portTeamInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoTable=vlanInfoTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfo=stpInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgState=portTeamNewCfgState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortState=stpInfoPortState, cistRoot=cistRoot, vlanInfo=vlanInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbTable=fdbTable, stpInfoPortTable=stpInfoPortTable, vlanMaxEnt=vlanMaxEnt, fdbStats=fdbStats, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbState=fdbState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgStgIndex=stgNewCfgStgIndex, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgTable=stgCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgJumbo=vlanCurCfgJumbo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, layer2Oper=layer2Oper, portTeamInfoTrunks=portTeamInfoTrunks, stgCfg=stgCfg, stgStatsPortIndex=stgStatsPortIndex, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoJumbo=vlanInfoJumbo, BridgeId=BridgeId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgState=portTeamCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoTable=stpInfoTable, stpInfoIndex=stpInfoIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortCfgTableId=lacpCurPortCfgTableId)
