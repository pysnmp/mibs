...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsFinds=fdbStatsFinds, portTeamInfoPorts=portTeamInfoPorts, layer2=layer2, fdbStatsLookupFails=fdbStatsLookupFails, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsLookups=fdbStatsLookups, stgStatsPortTable=stgStatsPortTable, stpInfoPortRole=stpInfoPortRole, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, PYSNMP_MODULE_ID=layer2, vlanInfoTable=vlanInfoTable, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewSystemPriority=lacpNewSystemPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgState=stgNewCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, layer2Oper=layer2Oper, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortState=lacpCurPortState, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortState=stgNewCfgPortState, stpInfoHoldTime=stpInfoHoldTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgState=mstNewCfgState, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortTable=cistInfoPortTable, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkgroup=trunkgroup, fdbStatsCurrent=fdbStatsCurrent, fdbClear=fdbClear, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mirrPortMirr=mirrPortMirr, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortRole=cistInfoPortRole, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPort=cistRootPort, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoName=vlanInfoName, mirroring=mirroring, portTeamCfg=portTeamCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbState=fdbState, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoTable=stpInfoTable, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, mstCurCfgState=mstCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, BridgeId=BridgeId, cistInfo=cistInfo, stgNewCfgTable=stgNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfo=portTeamInfo, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsCreates=fdbStatsCreates, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbTable=fdbTable, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, fdbLearnedPort=fdbLearnedPort, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbSrcTrunk=fdbSrcTrunk, stpInfo=stpInfo, mstCfg=mstCfg, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfoPortIndex=lacpInfoPortIndex, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortPriority=cistInfoPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgLearn=vlanCurCfgLearn, fdbInfo=fdbInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, vlanInfo=vlanInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfo=lacpInfo, portTeamTableMaxSize=portTeamTableMaxSize, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgPriority=stgNewCfgPriority, vlanInfoStatus=vlanInfoStatus, fdbStatsDeletes=fdbStatsDeletes, cistRootPathCost=cistRootPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTable=stgCurCfgTable, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbVlan=fdbVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoState=portTeamInfoState, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanMaxEnt=vlanMaxEnt, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortState=lacpNewPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Info=layer2Info, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortPathCost=cistInfoPortPathCost, layer2Configs=layer2Configs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCfg=stgCfg, mstCistCfg=mstCistCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpStats=stpStats, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortState=stpInfoPortState, vlanInfoPorts=vlanInfoPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgState=portTeamNewCfgState, mstCistBridgeCfg=mstCistBridgeCfg, lacp=lacp, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTopChanges=stpInfoTopChanges, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoId=vlanInfoId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbEntry=fdbEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoRootCost=stpInfoRootCost, stgCurCfgState=stgCurCfgState, fdbStats=fdbStats, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortTable=stgCurCfgPortTable, fdbRefSps=fdbRefSps, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Stats=layer2Stats, mstCistDefaultCfg=mstCistDefaultCfg, cistRoot=cistRoot, vlan=vlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstGeneralCfg=mstGeneralCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry)
