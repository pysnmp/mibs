...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortLink=stgNewCfgPortLink, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgTable=stgCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfo=stpInfo, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfo=lacpInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgState=mstNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortState=lacpNewPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgState=stgNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbTable=fdbTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfo=cistInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoIndex=stpInfoIndex, fdbEntry=fdbEntry, PYSNMP_MODULE_ID=layer2, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCfg=mstCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunks=portTeamInfoTrunks, BridgeId=BridgeId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkgroup=trunkgroup, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, mstNewCfgRegionName=mstNewCfgRegionName, portTeamTableMaxSize=portTeamTableMaxSize, vlanMaxEnt=vlanMaxEnt, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgStg=vlanCurCfgStg, vlanInfo=vlanInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgIndex=stgCurCfgIndex, vlanInfoStatus=vlanInfoStatus, layer2Info=layer2Info, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortState=stpInfoPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpStats=stpStats, portTeamInfoTable=portTeamInfoTable, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbRefSps=fdbRefSps, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgState=vlanCurCfgState, stgStatsPortTable=stgStatsPortTable, vlanInfoId=vlanInfoId, fdbSrcPort=fdbSrcPort, cistGeneralInfo=cistGeneralInfo, stgCurCfgState=stgCurCfgState, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbClear=fdbClear, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTable=vlanInfoTable, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbVlan=fdbVlan, portTeamInfo=portTeamInfo, layer2Stats=layer2Stats, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortRole=stpInfoPortRole, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStats=fdbStats, cistRootPort=cistRootPort, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortState=cistInfoPortState, lacp=lacp, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbLearnedPort=fdbLearnedPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistRootPathCost=cistRootPathCost, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortTable=stpInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoLearn=vlanInfoLearn, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoTable=stpInfoTable, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2=layer2, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgStpMode=mstCurCfgStpMode, fdbState=fdbState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgTable=vlanNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoRootCost=stpInfoRootCost, fdbMacAddr=fdbMacAddr, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoRootPort=stpInfoRootPort, mirroring=mirroring, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortRole=cistInfoPortRole, mstCistCfg=mstCistCfg, portTeamCfg=portTeamCfg, layer2Configs=layer2Configs, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, mirrPortMirr=mirrPortMirr, fdbStatsLookups=fdbStatsLookups, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Oper=layer2Oper, fdbInfo=fdbInfo, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, stgCfg=stgCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoName=vlanInfoName, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, vlan=vlan, mstCurCfgState=mstCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortPathCost=stpInfoPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortIndex=stgCurCfgPortIndex)
