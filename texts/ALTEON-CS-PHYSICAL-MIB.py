...
ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, NotificationType, ModuleIdentity, Bits, IpAddress, MibIdentifier, Counter32, Counter64, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "NotificationType", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "Counter32", "Counter64", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, mirrPortMirr=mirrPortMirr, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsCreates=fdbStatsCreates, fdbLearnedPort=fdbLearnedPort, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCfg=mstCistCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, layer2=layer2, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, vlanMaxEnt=vlanMaxEnt, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoLearn=vlanInfoLearn, vlan=vlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoState=portTeamInfoState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, layer2Info=layer2Info, stgCurCfgPortState=stgCurCfgPortState, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbEntry=fdbEntry, mstCurCfgState=mstCurCfgState, fdbSrcTrunk=fdbSrcTrunk, cistInfo=cistInfo, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortIndex=stgNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, vlanInfoId=vlanInfoId, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortState=stpInfoPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Oper=layer2Oper, stpInfo=stpInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCfg=stgCfg, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoPorts=vlanInfoPorts, lacpInfo=lacpInfo, fdbState=fdbState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfo=portTeamInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgIndex=stgCurCfgIndex, cistRootPathCost=cistRootPathCost, mstCurCfgStpMode=mstCurCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoRootPort=stpInfoRootPort, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoName=vlanInfoName, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgTable=stgCurCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortTable=lacpInfoPortTable, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgStg=vlanCurCfgStg, fdbStats=fdbStats, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgState=vlanNewCfgState, cistGeneralInfo=cistGeneralInfo, lacpNewPortState=lacpNewPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookups=fdbStatsLookups, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2Configs=layer2Configs, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCfg=portTeamCfg, stpStats=stpStats, fdbInfo=fdbInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, BridgeId=BridgeId, fdbMacAddr=fdbMacAddr, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbVlan=fdbVlan, stpInfoIndex=stpInfoIndex, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbRefSps=fdbRefSps, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoStatus=vlanInfoStatus, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgState=stgCurCfgState, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortEdge=stgNewCfgPortEdge, mirroring=mirroring, layer2Stats=layer2Stats, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbSrcPort=fdbSrcPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstGeneralCfg=mstGeneralCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortTable=stpInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoTable=vlanInfoTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgState=mstNewCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistDefaultCfg=mstCistDefaultCfg, mstCfg=mstCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxVlanID=vlanMaxVlanID, lacp=lacp, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortState=lacpCurPortState, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistRoot=cistRoot, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRootPort=cistRootPort, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortState=cistInfoPortState, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoTable=portTeamInfoTable, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoPorts=portTeamInfoPorts, vlanInfo=vlanInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, PYSNMP_MODULE_ID=layer2, stpInfoForwardDelay=stpInfoForwardDelay, trunkgroup=trunkgroup)
