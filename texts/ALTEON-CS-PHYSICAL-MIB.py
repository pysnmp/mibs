...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfo=portTeamInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, fdbStats=fdbStats, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbEntry=fdbEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortRole=cistInfoPortRole, stgNewCfgPriority=stgNewCfgPriority, trunkgroup=trunkgroup, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsLookups=fdbStatsLookups, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCfg=mstCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgState=portTeamNewCfgState, fdbClear=fdbClear, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Oper=layer2Oper, cistGeneralInfo=cistGeneralInfo, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbState=fdbState, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoTable=portTeamInfoTable, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpStats=stpStats, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbSrcPort=fdbSrcPort, fdbLearnedPort=fdbLearnedPort, stpInfoTable=stpInfoTable, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPathCost=cistRootPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, layer2Configs=layer2Configs, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgState=stgNewCfgState, layer2Stats=layer2Stats, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgState=vlanNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRootPort=cistRootPort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortTable=stpInfoPortTable, stgCfg=stgCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlan=vlan, mstNewCfgState=mstNewCfgState, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfo=lacpInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCfg=portTeamCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCurCfgState=mstCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsCreates=fdbStatsCreates, fdbTable=fdbTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfo=vlanInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Info=layer2Info, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoId=vlanInfoId, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortTable=stgNewCfgPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoJumbo=vlanInfoJumbo, vlanInfoPorts=vlanInfoPorts, mstGeneralCfg=mstGeneralCfg, mirroring=mirroring, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortPriority=cistInfoPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsLookupFails=fdbStatsLookupFails, PYSNMP_MODULE_ID=layer2, fdbSrcTrunk=fdbSrcTrunk, cistRoot=cistRoot, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, stpInfoIndex=stpInfoIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortState=stpInfoPortState, fdbInfo=fdbInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortState=cistInfoPortState, vlanInfoLearn=vlanInfoLearn, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistRegionalRoot=cistRegionalRoot, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoState=portTeamInfoState, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, BridgeId=BridgeId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortTable=cistInfoPortTable, lacpNewPortState=lacpNewPortState, portTeamCurCfgState=portTeamCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfo=stpInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbVlan=fdbVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbRefSps=fdbRefSps, stpInfoRootPort=stpInfoRootPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mirrPortMirr=mirrPortMirr, lacpCurPortState=lacpCurPortState, stpInfoPortIndex=stpInfoPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortTable=stgCurCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgState=vlanCurCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, layer2=layer2, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoRootCost=stpInfoRootCost, vlanCurCfgStg=vlanCurCfgStg, lacp=lacp, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistBridgeMaxAge=cistBridgeMaxAge, cistInfo=cistInfo, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, vlanInfoName=vlanInfoName, stgNewCfgTable=stgNewCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgState=stgCurCfgState, mstCistCfg=mstCistCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortRole=stpInfoPortRole)
