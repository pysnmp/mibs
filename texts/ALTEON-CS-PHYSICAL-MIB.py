...
TimeTicks, Counter32, NotificationType, Bits, MibIdentifier, ModuleIdentity, Gauge32, Counter64, IpAddress, iso, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "Bits", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter64", "IpAddress", "iso", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortRole=stpInfoPortRole, lacpInfo=lacpInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, fdbStatsCurrent=fdbStatsCurrent, cistRootPort=cistRootPort, cistGeneralInfo=cistGeneralInfo, cistRegionalPathCost=cistRegionalPathCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfo=cistInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoIndex=stpInfoIndex, mstCistDefaultCfg=mstCistDefaultCfg, fdbSrcPort=fdbSrcPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgIndex=stgCurCfgIndex, vlanInfoTable=vlanInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCfg=stgCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortState=stpInfoPortState, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTable=stpInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrPortMirr=mirrPortMirr, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgState=stgCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortRole=cistInfoPortRole, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsCreates=fdbStatsCreates, stgCurCfgPriority=stgCurCfgPriority, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortState=lacpCurPortState, mstCistCfg=mstCistCfg, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRoot=cistRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgDelete=portTeamNewCfgDelete, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPriority=stgNewCfgPriority, trunkgroup=trunkgroup, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbClear=fdbClear, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTableEntry=stpInfoTableEntry, layer2=layer2, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, fdbVlan=fdbVlan, portTeamCfg=portTeamCfg, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, BridgeId=BridgeId, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbEntry=fdbEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stpStats=stpStats, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCfg=mstCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfo=stpInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortState=cistInfoPortState, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoHoldTime=stpInfoHoldTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbTable=fdbTable, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgTable=vlanNewCfgTable, PYSNMP_MODULE_ID=layer2, lacp=lacp, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbRefSps=fdbRefSps, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfoStatus=vlanInfoStatus, stgCurCfgTable=stgCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoId=vlanInfoId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortIndex=stgStatsPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, cistRegionalRoot=cistRegionalRoot, layer2Oper=layer2Oper, cistInfoPortPriority=cistInfoPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoName=vlanInfoName, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsHiwat=fdbStatsHiwat, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbMacAddr=fdbMacAddr, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgPorts=portTeamNewCfgPorts, layer2Configs=layer2Configs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, portTeamInfo=portTeamInfo, layer2Info=layer2Info, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsFinds=fdbStatsFinds, stpInfoTopChanges=stpInfoTopChanges, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoRootCost=stpInfoRootCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoPortsState=portTeamInfoPortsState, cistRootPathCost=cistRootPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamCurCfgState=portTeamCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortTable=stpInfoPortTable, fdbState=fdbState, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortTable=cistInfoPortTable, vlanInfo=vlanInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgStg=vlanCurCfgStg, fdbLearnedPort=fdbLearnedPort, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortState=lacpNewPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbInfo=fdbInfo, layer2Stats=layer2Stats, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortState=stgNewCfgPortState, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgState=stgNewCfgState, vlan=vlan, fdbStats=fdbStats, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey)
