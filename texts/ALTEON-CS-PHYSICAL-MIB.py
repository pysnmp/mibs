...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbState=fdbState, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTable=stpInfoTable, layer2Stats=layer2Stats, PYSNMP_MODULE_ID=layer2, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortRole=cistInfoPortRole, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoId=vlanInfoId, fdbEntry=fdbEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPort=cistRootPort, mstCfg=mstCfg, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoIndex=portTeamInfoIndex, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCfg=mstCistCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgState=mstNewCfgState, lacp=lacp, stgStatsPortTable=stgStatsPortTable, fdbVlan=fdbVlan, layer2Oper=layer2Oper, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2=layer2, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbInfo=fdbInfo, lacpInfo=lacpInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgPorts=portTeamNewCfgPorts, vlan=vlan, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortTable=cistInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbTable=fdbTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stpStats=stpStats, stgNewCfgState=stgNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoPorts=portTeamInfoPorts, vlanInfoName=vlanInfoName, fdbStatsHiwat=fdbStatsHiwat, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfo=vlanInfo, fdbClear=fdbClear, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, layer2Configs=layer2Configs, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, cistGeneralInfo=cistGeneralInfo, trunkgroup=trunkgroup, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfo=portTeamInfo, stgStatsPortIndex=stgStatsPortIndex, fdbLearnedPort=fdbLearnedPort, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoHoldTime=stpInfoHoldTime, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbRefSps=fdbRefSps, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mirroring=mirroring, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsLookups=fdbStatsLookups, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoTable=portTeamInfoTable, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, cistInfo=cistInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcPort=fdbSrcPort, cistRootPathCost=cistRootPathCost, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgTable=stgCurCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortState=stpInfoPortState, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoMaxAge=stpInfoMaxAge, mstGeneralCfg=mstGeneralCfg, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgState=stgCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCfg=portTeamCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfo=stpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, cistRegionalRoot=cistRegionalRoot, vlanNewCfgState=vlanNewCfgState, stpInfoIndex=stpInfoIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgCfg=stgCfg, stpInfoPortEdge=stpInfoPortEdge, layer2Info=layer2Info, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCurCfgState=mstCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoStatus=vlanInfoStatus, fdbStats=fdbStats, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortState=lacpCurPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortIndex=stpInfoPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoPorts=vlanInfoPorts, portTeamInfoState=portTeamInfoState, lacpInfoPortIndex=lacpInfoPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mirrPortMirr=mirrPortMirr, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTable=stpInfoPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFinds=fdbStatsFinds, cistInfoPortTableEntry=cistInfoPortTableEntry, BridgeId=BridgeId, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortRole=stpInfoPortRole, vlanInfoTable=vlanInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, cistRoot=cistRoot, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable)
