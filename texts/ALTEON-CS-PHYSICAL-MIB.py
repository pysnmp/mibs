...
ObjectIdentity, NotificationType, IpAddress, iso, Counter64, ModuleIdentity, MibIdentifier, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "IpAddress", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgTable=stgCurCfgTable, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortState=lacpNewPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoTable=portTeamInfoTable, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoPorts=vlanInfoPorts, layer2Stats=layer2Stats, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortRole=cistInfoPortRole, mstCurCfgState=mstCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, cistRegionalRoot=cistRegionalRoot, layer2=layer2, vlanNewCfgState=vlanNewCfgState, cistRootPort=cistRootPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCfg=portTeamCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoMaxAge=stpInfoMaxAge, vlanInfoJumbo=vlanInfoJumbo, vlanInfoId=vlanInfoId, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCfg=stgCfg, lacpInfoPortTable=lacpInfoPortTable, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCfg=mstCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortTable=stgStatsPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mirrPortMirr=mirrPortMirr, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoStatus=vlanInfoStatus, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsFindFails=fdbStatsFindFails, vlanInfoTable=vlanInfoTable, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTopChanges=stpInfoTopChanges, cistRoot=cistRoot, layer2Info=layer2Info, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgAgingTime=stgCurCfgAgingTime, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgState=stgNewCfgState, stgCurCfgState=stgCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbState=fdbState, lacpCurPortState=lacpCurPortState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfo=vlanInfo, BridgeId=BridgeId, PYSNMP_MODULE_ID=layer2, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsDeletes=fdbStatsDeletes, portTeamInfo=portTeamInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlan=vlan, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortIndex=cistInfoPortIndex, mstCistCfg=mstCistCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsCreates=fdbStatsCreates, cistInfoPortPathCost=cistInfoPortPathCost, stpInfo=stpInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgStpMode=mstNewCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, mirroring=mirroring, fdbStatsHiwat=fdbStatsHiwat, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbClear=fdbClear, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2Oper=layer2Oper, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTable=stpInfoTable, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbEntry=fdbEntry, fdbLearnedPort=fdbLearnedPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbInfo=fdbInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoState=portTeamInfoState, fdbStatsFinds=fdbStatsFinds, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkgroup=trunkgroup, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortTable=stpInfoPortTable, fdbRefSps=fdbRefSps, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoName=vlanInfoName, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, cistBridgeHelloTime=cistBridgeHelloTime, cistRootPathCost=cistRootPathCost, mstNewCfgState=mstNewCfgState, stpStats=stpStats, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfo=cistInfo, stpInfoPortState=stpInfoPortState, fdbStatsLookups=fdbStatsLookups, layer2Configs=layer2Configs, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbTable=fdbTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbMacAddr=fdbMacAddr, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbSrcPort=fdbSrcPort, fdbStats=fdbStats, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfo=lacpInfo, vlanMaxVlanID=vlanMaxVlanID, stpInfoRootPort=stpInfoRootPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacp=lacp, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxEnt=vlanMaxEnt, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortState=cistInfoPortState, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstGeneralCfg=mstGeneralCfg, fdbVlan=fdbVlan, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
