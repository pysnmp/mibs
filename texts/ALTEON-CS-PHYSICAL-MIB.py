...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPathCost=cistRootPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoLearn=vlanInfoLearn, stpInfoPortTable=stpInfoPortTable, stpInfoPortRole=stpInfoPortRole, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortState=stpInfoPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStats=fdbStats, layer2Oper=layer2Oper, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistGeneralInfo=cistGeneralInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortState=lacpNewPortState, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, fdbState=fdbState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfo=cistInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgTable=stgCurCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortTable=stgStatsPortTable, fdbRefSps=fdbRefSps, stpInfoTable=stpInfoTable, layer2Stats=layer2Stats, stpInfoIndex=stpInfoIndex, stgNewCfgPriority=stgNewCfgPriority, fdbLearnedPort=fdbLearnedPort, stgCurCfgState=stgCurCfgState, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCfg=mstCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, lacp=lacp, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortState=stgNewCfgPortState, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortEdge=stpInfoPortEdge, vlan=vlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfo=stpInfo, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgState=vlanCurCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbEntry=fdbEntry, stpInfoTopChanges=stpInfoTopChanges, fdbStatsDeletes=fdbStatsDeletes, cistRootPort=cistRootPort, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoId=vlanInfoId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurPortState=lacpCurPortState, layer2Info=layer2Info, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbInfo=fdbInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstGeneralCfg=mstGeneralCfg, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfo=portTeamInfo, cistInfoPortIndex=cistInfoPortIndex, stpStats=stpStats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfo=vlanInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoTableEntry=stpInfoTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgPorts=vlanCurCfgPorts, fdbClear=fdbClear, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsLookups=fdbStatsLookups, stgCfg=stgCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCfg=portTeamCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, lacpInfoPortTable=lacpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, BridgeId=BridgeId, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoPorts=vlanInfoPorts, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgTable=stgNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkgroup=trunkgroup, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoState=portTeamInfoState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoName=vlanInfoName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgState=mstCurCfgState, cistInfoPortState=cistInfoPortState, fdbTable=fdbTable, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoMaxAge=stpInfoMaxAge, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortRole=cistInfoPortRole, mstCistDefaultCfg=mstCistDefaultCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfo=lacpInfo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, PYSNMP_MODULE_ID=layer2, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistRegionalRoot=cistRegionalRoot, fdbStatsFinds=fdbStatsFinds, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, cistRoot=cistRoot, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortTable=cistInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbSrcPort=fdbSrcPort, vlanNewCfgStg=vlanNewCfgStg, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgStpMode=mstCurCfgStpMode)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, layer2Configs=layer2Configs, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCfg=mstCistCfg, mirroring=mirroring, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbVlan=fdbVlan, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2=layer2, fdbStatsFindFails=fdbStatsFindFails, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsCreates=fdbStatsCreates, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoTable=portTeamInfoTable)
