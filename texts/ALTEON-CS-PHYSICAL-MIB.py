...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfo=lacpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfo=portTeamInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortTable=cistInfoPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPriority=stgNewCfgPriority, layer2Oper=layer2Oper, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbState=fdbState, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Info=layer2Info, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTable=stpInfoTable, PYSNMP_MODULE_ID=layer2, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortTable=stpInfoPortTable, vlanMaxEnt=vlanMaxEnt, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortRole=stpInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2=layer2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortState=lacpCurPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbTable=fdbTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCurCfgState=mstCurCfgState, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbRefSps=fdbRefSps, fdbStats=fdbStats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgTable=vlanNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortIndex=stgStatsPortIndex, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanMaxVlanID=vlanMaxVlanID, vlanInfoId=vlanInfoId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFinds=fdbStatsFinds, vlanInfoPorts=vlanInfoPorts, fdbStatsCreates=fdbStatsCreates, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, BridgeId=BridgeId, vlanInfo=vlanInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbVlan=fdbVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, mirroring=mirroring, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoIndex=portTeamInfoIndex, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortState=stpInfoPortState, fdbClear=fdbClear, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortIndex=stpInfoPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCfg=mstCistCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgTable=stgCurCfgTable, vlan=vlan, vlanCurCfgStg=vlanCurCfgStg, lacp=lacp, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRootPort=cistRootPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgStg=vlanNewCfgStg, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoIndex=stpInfoIndex, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, fdbEntry=fdbEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgState=vlanCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Configs=layer2Configs, vlanCurCfgLearn=vlanCurCfgLearn, stpInfo=stpInfo, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortState=stgCurCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgTable=stgNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsOverflows=fdbStatsOverflows, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTableEntry=vlanInfoTableEntry, trunkgroup=trunkgroup, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbLearnedPort=fdbLearnedPort, fdbInfo=fdbInfo, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortState=stgNewCfgPortState, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpStats=stpStats, portTeamInfoState=portTeamInfoState, stgStatsStpIndex=stgStatsStpIndex, portTeamCfg=portTeamCfg, cistRootPathCost=cistRootPathCost, layer2Stats=layer2Stats, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCfg=stgCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoMaxAge=stpInfoMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, vlanInfoName=vlanInfoName, cistInfoPortRole=cistInfoPortRole, stpInfoRootPort=stpInfoRootPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsDeletes=fdbStatsDeletes, cistGeneralInfo=cistGeneralInfo, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortPriority=cistInfoPortPriority, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfo=cistInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCfg=mstCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoRootCost=stpInfoRootCost, mirrPortMirr=mirrPortMirr, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgState=mstNewCfgState, fdbStatsLookups=fdbStatsLookups, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgIndex=stgNewCfgIndex, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable)
