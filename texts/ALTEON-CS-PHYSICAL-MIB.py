...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mirroring=mirroring, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, layer2Stats=layer2Stats, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgState=stgCurCfgState, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTrunks=portTeamInfoTrunks, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, stpInfoIndex=stpInfoIndex, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Info=layer2Info, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortState=cistInfoPortState, PYSNMP_MODULE_ID=layer2, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, mirrPortMirr=mirrPortMirr, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortTable=cistInfoPortTable, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfo=portTeamInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbVlan=fdbVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRoot=cistRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCfg=mstCistCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlan=vlan, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoLearn=vlanInfoLearn, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbState=fdbState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsFinds=fdbStatsFinds, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFindFails=fdbStatsFindFails, portTeamCurCfgState=portTeamCurCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoName=vlanInfoName, cistRootPort=cistRootPort, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoTable=vlanInfoTable, layer2Oper=layer2Oper, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbInfo=fdbInfo, layer2Configs=layer2Configs, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcTrunk=fdbSrcTrunk, trunkgroup=trunkgroup, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortState=lacpCurPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortRole=stpInfoPortRole, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootPort=stpInfoRootPort, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTable=stpInfoTable, stpInfoRootCost=stpInfoRootCost, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCfg=stgCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgState=portTeamNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbMacAddr=fdbMacAddr, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRegionalRoot=cistRegionalRoot, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbLearnedPort=fdbLearnedPort, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoTable=portTeamInfoTable, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortPriority=cistInfoPortPriority, mstCfg=mstCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgState=vlanNewCfgState, vlanInfo=vlanInfo, lacp=lacp, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgState=stgNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, stpStats=stpStats, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbSrcPort=fdbSrcPort, fdbRefSps=fdbRefSps, fdbStats=fdbStats, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeHelloTime=cistBridgeHelloTime, fdbEntry=fdbEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgStg=vlanCurCfgStg, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfo=cistInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCfg=portTeamCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoTopChanges=stpInfoTopChanges, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbClear=fdbClear, fdbTable=fdbTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfo=stpInfo, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsHiwat=fdbStatsHiwat, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoId=vlanInfoId, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistGeneralInfo=cistGeneralInfo, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, layer2=layer2, vlanMaxVlanID=vlanMaxVlanID, lacpInfo=lacpInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanMaxEnt=vlanMaxEnt, portTeamInfoState=portTeamInfoState, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgTrunks=portTeamNewCfgTrunks, BridgeId=BridgeId)
