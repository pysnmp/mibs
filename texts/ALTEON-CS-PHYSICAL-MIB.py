...
Integer32, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, Gauge32, NotificationType, Bits, TimeTicks, MibIdentifier, iso, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Gauge32", "NotificationType", "Bits", "TimeTicks", "MibIdentifier", "iso", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbState=fdbState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbClear=fdbClear, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortState=lacpNewPortState, stgCurCfgState=stgCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, cistRoot=cistRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoStatus=vlanInfoStatus, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, cistRegionalRoot=cistRegionalRoot, vlanInfoName=vlanInfoName, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Stats=layer2Stats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbTable=fdbTable, cistRootPort=cistRootPort, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoTable=vlanInfoTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgState=stgNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfo=cistInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbInfo=fdbInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacp=lacp, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsLookups=fdbStatsLookups, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbVlan=fdbVlan, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Info=layer2Info, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfo=portTeamInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgState=mstNewCfgState, trunkgroup=trunkgroup, stgCurCfgIndex=stgCurCfgIndex, BridgeId=BridgeId, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgState=mstCurCfgState, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortRole=cistInfoPortRole, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoRootCost=stpInfoRootCost, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortRole=stpInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbMacAddr=fdbMacAddr, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mirroring=mirroring, fdbStatsOverflows=fdbStatsOverflows, layer2Configs=layer2Configs, PYSNMP_MODULE_ID=layer2, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCfg=stgCfg, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbRefSps=fdbRefSps, mstCurCfgStpMode=mstCurCfgStpMode, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoState=portTeamInfoState, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFinds=fdbStatsFinds, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTableEntry=stpInfoTableEntry, mstGeneralCfg=mstGeneralCfg, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoTable=portTeamInfoTable, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortState=cistInfoPortState, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2=layer2, stpInfoMaxAge=stpInfoMaxAge, cistRootPathCost=cistRootPathCost, vlanCurCfgState=vlanCurCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbSrcPort=fdbSrcPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortTable=cistInfoPortTable, mstCistCfg=mstCistCfg, fdbLearnedPort=fdbLearnedPort, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgTable=stgCurCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgState=vlanNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsDeletes=fdbStatsDeletes, stpInfoRootPort=stpInfoRootPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoLearn=vlanInfoLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsHiwat=fdbStatsHiwat, stpInfoTopChanges=stpInfoTopChanges, stpInfo=stpInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortTable=stpInfoPortTable, vlanInfoId=vlanInfoId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoPorts=portTeamInfoPorts, layer2Oper=layer2Oper, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoTable=stpInfoTable, vlanInfoPorts=vlanInfoPorts, vlan=vlan, stpInfoIndex=stpInfoIndex, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsStpIndex=stgStatsStpIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbEntry=fdbEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistGeneralInfo=cistGeneralInfo, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCfg=mstCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortState=lacpCurPortState, fdbStats=fdbStats, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mirrPortMirr=mirrPortMirr, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgTable=vlanCurCfgTable, portTeamCfg=portTeamCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfo=vlanInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpStats=stpStats, fdbStatsFindOrCreates=fdbStatsFindOrCreates)
