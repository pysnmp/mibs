...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfo=lacpInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgTable=vlanNewCfgTable, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortState=stpInfoPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsCreates=fdbStatsCreates, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCfg=mstCistCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, PYSNMP_MODULE_ID=layer2, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoLearn=vlanInfoLearn, stpInfoRootPort=stpInfoRootPort, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoPorts=vlanInfoPorts, fdbStatsFindFails=fdbStatsFindFails, stpInfoMaxAge=stpInfoMaxAge, portTeamInfo=portTeamInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, mirrPortMirr=mirrPortMirr, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortTable=stpInfoPortTable, stpInfoTable=stpInfoTable, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgState=vlanCurCfgState, fdbClear=fdbClear, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortTable=lacpInfoPortTable, layer2Configs=layer2Configs, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsCurrent=fdbStatsCurrent, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbMacAddr=fdbMacAddr, cistRootPort=cistRootPort, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, mstCurCfgStpMode=mstCurCfgStpMode, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgState=stgNewCfgState, stpInfoPortEdge=stpInfoPortEdge, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortState=stgCurCfgPortState, mstCfg=mstCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, layer2Stats=layer2Stats, stgCurCfgPriority=stgCurCfgPriority, BridgeId=BridgeId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbVlan=fdbVlan, stgCfg=stgCfg, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoIndex=stpInfoIndex, fdbEntry=fdbEntry, cistInfo=cistInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortState=lacpCurPortState, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbTable=fdbTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfo=vlanInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirroring=mirroring, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRoot=cistRoot, vlanInfoJumbo=vlanInfoJumbo, cistGeneralInfo=cistGeneralInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgRegionName=mstCurCfgRegionName, vlan=vlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoName=vlanInfoName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbInfo=fdbInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbState=fdbState, cistInfoPortRole=cistInfoPortRole, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoTable=vlanInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoPorts=portTeamInfoPorts, lacp=lacp, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortState=lacpNewPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortState=cistInfoPortState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbLearnedPort=fdbLearnedPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfo=stpInfo, stgCurCfgTable=stgCurCfgTable, layer2=layer2, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, layer2Oper=layer2Oper, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgState=mstCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgIndex=portTeamCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStats=fdbStats, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTable=portTeamInfoTable, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgState=portTeamNewCfgState, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCfg=portTeamCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkgroup=trunkgroup, mstNewCfgState=mstNewCfgState, stpStats=stpStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, fdbRefSps=fdbRefSps, cistRootPathCost=cistRootPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Info=layer2Info, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, vlanInfoId=vlanInfoId, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgState=stgCurCfgState, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, fdbStatsLookups=fdbStatsLookups, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcPort=fdbSrcPort, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
