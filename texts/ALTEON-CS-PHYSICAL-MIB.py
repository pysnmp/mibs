...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCfg=portTeamCfg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortIndex=cistInfoPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfo=cistInfo, fdbTable=fdbTable, layer2Info=layer2Info, mstCurCfgState=mstCurCfgState, fdbStatsCurrent=fdbStatsCurrent, layer2Oper=layer2Oper, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstGeneralCfg=mstGeneralCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoTable=vlanInfoTable, stpInfoHoldTime=stpInfoHoldTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortTable=mstCistCurCfgPortTable, layer2=layer2, stpStats=stpStats, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoTable=portTeamInfoTable, fdbSrcPort=fdbSrcPort, vlanInfoName=vlanInfoName, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoPorts=vlanInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFinds=fdbStatsFinds, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRootPort=cistRootPort, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoRootPort=stpInfoRootPort, cistInfoPortState=cistInfoPortState, vlanInfoBwmContract=vlanInfoBwmContract, fdbLearnedPort=fdbLearnedPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoId=vlanInfoId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCfg=stgCfg, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsHiwat=fdbStatsHiwat, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanMaxEnt=vlanMaxEnt, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, BridgeId=BridgeId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStats=fdbStats, stgNewCfgTable=stgNewCfgTable, vlan=vlan, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkgroup=trunkgroup, fdbState=fdbState, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurPortState=lacpCurPortState, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbEntry=fdbEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCfg=mstCfg, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortRole=cistInfoPortRole, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortIndex=stgStatsPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgIndex=stgNewCfgIndex, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacp=lacp, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoState=portTeamInfoState, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgState=vlanCurCfgState, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbMacAddr=fdbMacAddr, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Configs=layer2Configs, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfo=stpInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, mstCistBridgeCfg=mstCistBridgeCfg, fdbInfo=fdbInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgState=stgCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfo=lacpInfo, vlanInfo=vlanInfo, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, fdbClear=fdbClear, stpInfoPortTable=stpInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, layer2Stats=layer2Stats, mstCistCfg=mstCistCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbVlan=fdbVlan, stpInfoIndex=stpInfoIndex, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfo=portTeamInfo, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgState=portTeamCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoStatus=vlanInfoStatus, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortState=lacpNewPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFindFails=fdbStatsFindFails, cistRegionalPathCost=cistRegionalPathCost, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgStg=vlanNewCfgStg, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsDeletes=fdbStatsDeletes, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTable=stpInfoTable, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTable=stgStatsPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanMaxVlanID=vlanMaxVlanID, mstNewCfgState=mstNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable)
