...
Bits, iso, TimeTicks, Counter64, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Unsigned32, ObjectIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "TimeTicks", "Counter64", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgState=mstCurCfgState, fdbEntry=fdbEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortTable=stgStatsPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, cistRootPort=cistRootPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfo=portTeamInfo, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbClear=fdbClear, lacpInfo=lacpInfo, BridgeId=BridgeId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortState=stpInfoPortState, vlan=vlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoTable=vlanInfoTable, trunkgroup=trunkgroup, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoPorts=vlanInfoPorts, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgTable=stgNewCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistRoot=cistRoot, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgTable=vlanNewCfgTable, cistInfo=cistInfo, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoIndex=stpInfoIndex, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, layer2Configs=layer2Configs, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgStg=vlanNewCfgStg, lacp=lacp, mirrPortMirr=mirrPortMirr, stgCurCfgPortTable=stgCurCfgPortTable, layer2Oper=layer2Oper, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortRole=stpInfoPortRole, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoId=vlanInfoId, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2=layer2, stgCfg=stgCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStats=fdbStats, stgNewCfgPortState=stgNewCfgPortState, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgState=vlanNewCfgState, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgState=stgNewCfgState, vlanInfoLearn=vlanInfoLearn, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoName=vlanInfoName, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgIndex=portTeamNewCfgIndex, PYSNMP_MODULE_ID=layer2, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCfg=portTeamCfg, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFinds=fdbStatsFinds, fdbState=fdbState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, layer2Stats=layer2Stats, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfo=vlanInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCfg=mstCistCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortTable=stpInfoPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgState=stgCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbLearnedPort=fdbLearnedPort, fdbInfo=fdbInfo, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRootPathCost=cistRootPathCost, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbVlan=fdbVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgState=mstNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortState=lacpCurPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpStats=stpStats, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, fdbRefSps=fdbRefSps, fdbTable=fdbTable, stpInfoTable=stpInfoTable, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgTable=portTeamCurCfgTable, layer2Info=layer2Info, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortTable=stgNewCfgPortTable, mstCfg=mstCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookups=fdbStatsLookups, fdbSrcTrunk=fdbSrcTrunk, mstGeneralCfg=mstGeneralCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgTable=stgCurCfgTable, stpInfo=stpInfo, lacpNewPortState=lacpNewPortState, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex)
