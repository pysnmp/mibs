...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, stpInfoHelloTime=stpInfoHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfo=cistInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoState=portTeamInfoState, BridgeId=BridgeId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfoIndex=portTeamInfoIndex, stpInfoTableEntry=stpInfoTableEntry, vlanInfoName=vlanInfoName, lacpInfoPortTable=lacpInfoPortTable, fdbStats=fdbStats, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfo=stpInfo, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfo=vlanInfo, fdbStatsCreates=fdbStatsCreates, cistInfoPortPriority=cistInfoPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstNewCfgState=mstNewCfgState, cistInfoPortState=cistInfoPortState, portTeamInfo=portTeamInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoPorts=vlanInfoPorts, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortIndex=stpInfoPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, stpInfoRootPort=stpInfoRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoTable=portTeamInfoTable, stpInfoTable=stpInfoTable, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortState=lacpNewPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistRootPathCost=cistRootPathCost, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsFinds=fdbStatsFinds, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortRole=cistInfoPortRole, stpInfoHoldTime=stpInfoHoldTime, mstCistCfg=mstCistCfg, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, fdbRefSps=fdbRefSps, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgState=stgCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgTable=stgCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortState=stgNewCfgPortState, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCfg=mstCfg, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, fdbLearnedPort=fdbLearnedPort, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfoTable=vlanInfoTable, stgCfg=stgCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacp=lacp, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbTable=fdbTable, vlanInfoLearn=vlanInfoLearn, mstGeneralCfg=mstGeneralCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRootPort=cistRootPort, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgState=mstCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbState=fdbState, stpInfoRootCost=stpInfoRootCost, vlanNewCfgDelete=vlanNewCfgDelete, trunkgroup=trunkgroup, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirroring=mirroring, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanMaxEnt=vlanMaxEnt, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTrunks=portTeamInfoTrunks, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mirrPortMirr=mirrPortMirr, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbVlan=fdbVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoIndex=stpInfoIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, layer2=layer2, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, fdbClear=fdbClear, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCfg=portTeamCfg, layer2Oper=layer2Oper, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoJumbo=vlanInfoJumbo, cistRoot=cistRoot, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoStatus=vlanInfoStatus, mstNewCfgRegionName=mstNewCfgRegionName, fdbEntry=fdbEntry, vlanInfoBwmContract=vlanInfoBwmContract, cistGeneralInfo=cistGeneralInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Info=layer2Info, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpStats=stpStats, portTeamNewCfgTable=portTeamNewCfgTable, fdbMacAddr=fdbMacAddr, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsLookups=fdbStatsLookups, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsOverflows=fdbStatsOverflows, stpInfoPortTable=stpInfoPortTable, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortState=stpInfoPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2Configs=layer2Configs, stpInfoPortPathCost=stpInfoPortPathCost, layer2Stats=layer2Stats, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbSrcPort=fdbSrcPort, stgNewCfgPortTable=stgNewCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoId=vlanInfoId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfo=lacpInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortTable=stgStatsPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlan=vlan, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbInfo=fdbInfo, portTeamNewCfgPorts=portTeamNewCfgPorts)
