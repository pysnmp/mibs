...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkgroup=trunkgroup, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortState=lacpNewPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCfg=mstCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPriority=stgCurCfgPriority, lacp=lacp, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoState=portTeamInfoState, stgStatsPortIndex=stgStatsPortIndex, layer2Configs=layer2Configs, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCfg=mstCistCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStats=fdbStats, fdbInfo=fdbInfo, vlanNewCfgState=vlanNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, vlanInfoStatus=vlanInfoStatus, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTable=portTeamInfoTable, vlanInfoTable=vlanInfoTable, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbRefSps=fdbRefSps, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortState=stpInfoPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoName=vlanInfoName, fdbStatsLookups=fdbStatsLookups, stpInfoRootPort=stpInfoRootPort, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgIndex=portTeamCurCfgIndex, BridgeId=BridgeId, stpInfoRootCost=stpInfoRootCost, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgStg=vlanCurCfgStg, stpStats=stpStats, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCfg=portTeamCfg, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPorts=portTeamInfoPorts, mirrPortMirr=mirrPortMirr, portTeamInfoPortsState=portTeamInfoPortsState, cistRoot=cistRoot, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbEntry=fdbEntry, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPathCost=cistRootPathCost, vlanInfoPorts=vlanInfoPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbLearnedPort=fdbLearnedPort, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortTable=lacpInfoPortTable, fdbState=fdbState, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbSrcPort=fdbSrcPort, stpInfoIndex=stpInfoIndex, layer2Oper=layer2Oper, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfo=vlanInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbVlan=fdbVlan, cistRegionalRoot=cistRegionalRoot, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgVlanName=vlanCurCfgVlanName, mirroring=mirroring, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistGeneralInfo=cistGeneralInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCfg=stgCfg, stpInfo=stpInfo, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortRole=stpInfoPortRole, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgState=mstNewCfgState, stgNewCfgState=stgNewCfgState, layer2Info=layer2Info, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoId=vlanInfoId, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoMaxAge=stpInfoMaxAge, stpInfoHelloTime=stpInfoHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortRole=cistInfoPortRole, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfo=portTeamInfo, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgState=stgCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfo=lacpInfo, portTeamNewCfgDelete=portTeamNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Stats=layer2Stats, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbTable=fdbTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFinds=fdbStatsFinds, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlan=vlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistRootPort=cistRootPort, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurPortState=lacpCurPortState, fdbClear=fdbClear, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTable=stpInfoTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfo=cistInfo)
