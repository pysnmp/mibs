...
Counter32, MibIdentifier, iso, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits, ObjectIdentity, IpAddress, Integer32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits", "ObjectIdentity", "IpAddress", "Integer32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgDelete=vlanNewCfgDelete, layer2Configs=layer2Configs, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrPortMirr=mirrPortMirr, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfo=cistInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoJumbo=vlanInfoJumbo, cistRootPathCost=cistRootPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsOverflows=fdbStatsOverflows, fdbVlan=fdbVlan, layer2=layer2, stpInfoHelloTime=stpInfoHelloTime, stpStats=stpStats, portTeamInfo=portTeamInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoId=vlanInfoId, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortIndex=stgStatsPortIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsLookups=fdbStatsLookups, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfo=vlanInfo, mstCfg=mstCfg, vlanMaxEnt=vlanMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, fdbState=fdbState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRegionalRoot=cistRegionalRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, layer2Stats=layer2Stats, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortRole=cistInfoPortRole, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbTable=fdbTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStats=fdbStats, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfo=lacpInfo, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRoot=cistRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgTable=stgNewCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPriority=cistInfoPortPriority, layer2Oper=layer2Oper, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPriority=stgNewCfgPriority, vlanInfoPorts=vlanInfoPorts, fdbStatsFinds=fdbStatsFinds, cistGeneralInfo=cistGeneralInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbSrcPort=fdbSrcPort, mstCistCfg=mstCistCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortState=lacpNewPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoStatus=vlanInfoStatus, vlan=vlan, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortState=lacpCurPortState, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortLink=stgNewCfgPortLink, lacp=lacp, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortLinkType=cistInfoPortLinkType, fdbRefSps=fdbRefSps, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortIndex=cistInfoPortIndex, fdbEntry=fdbEntry, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortRole=stpInfoPortRole, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCfg=stgCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortNtt=lacpInfoPortNtt, trunkgroup=trunkgroup, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbInfo=fdbInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoRootCost=stpInfoRootCost, mirroring=mirroring, fdbLearnedPort=fdbLearnedPort, stgNewCfgState=stgNewCfgState, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoIndex=stpInfoIndex, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgState=vlanCurCfgState, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbMacAddr=fdbMacAddr, cistInfoPortState=cistInfoPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortState=stpInfoPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRootPort=cistRootPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCfg=portTeamCfg, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, BridgeId=BridgeId, vlanNewCfgState=vlanNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoState=portTeamInfoState, stgCurCfgTable=stgCurCfgTable, stgStatsPortTable=stgStatsPortTable, stpInfoPortTable=stpInfoPortTable, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, stpInfoTable=stpInfoTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoName=vlanInfoName, stpInfo=stpInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortTable=cistInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsCreates=fdbStatsCreates, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTableEntry=stpInfoTableEntry, fdbClear=fdbClear, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoTable=portTeamInfoTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete)
