...
TimeTicks, Integer32, iso, Unsigned32, ModuleIdentity, ObjectIdentity, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStats=fdbStats, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfo=vlanInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortTable=lacpInfoPortTable, trunkgroup=trunkgroup, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbEntry=fdbEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, PYSNMP_MODULE_ID=layer2, portTeamInfoTable=portTeamInfoTable, stpInfo=stpInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgState=stgCurCfgState, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Info=layer2Info, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoTable=stpInfoTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoState=portTeamInfoState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoPorts=vlanInfoPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortState=stpInfoPortState, stpInfoRootPort=stpInfoRootPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistRootPort=cistRootPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgState=mstCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgTable=stgCurCfgTable, fdbRefSps=fdbRefSps, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, fdbLearnedPort=fdbLearnedPort, mstNewCfgStpMode=mstNewCfgStpMode, cistRoot=cistRoot, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoRootCost=stpInfoRootCost, cistRootPathCost=cistRootPathCost, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbMacAddr=fdbMacAddr, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortRole=stpInfoPortRole, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoHoldTime=stpInfoHoldTime, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgState=vlanNewCfgState, stpStats=stpStats, stpInfoPortEdge=stpInfoPortEdge, portTeamInfo=portTeamInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbSrcPort=fdbSrcPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoStatus=vlanInfoStatus, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoIndex=stpInfoIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistGeneralInfo=cistGeneralInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoBwmContract=vlanInfoBwmContract, fdbTable=fdbTable, fdbState=fdbState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortTable=stpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, fdbVlan=fdbVlan, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortIndex=stgStatsPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbClear=fdbClear, vlanInfoId=vlanInfoId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortState=lacpCurPortState, layer2Stats=layer2Stats, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfo=lacpInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, layer2Oper=layer2Oper, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacp=lacp, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanMaxVlanID=vlanMaxVlanID, cistRegionalRoot=cistRegionalRoot, vlanInfoTable=vlanInfoTable, fdbStatsLookups=fdbStatsLookups, mirroring=mirroring, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, layer2=layer2, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoName=vlanInfoName, stgCfg=stgCfg, vlan=vlan, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCfg=portTeamCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2Configs=layer2Configs, mstCfg=mstCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbInfo=fdbInfo, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFinds=fdbStatsFinds, cistInfo=cistInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCfg=mstCistCfg, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRegionalPathCost=cistRegionalPathCost, fdbStatsOverflows=fdbStatsOverflows)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortState=lacpNewPortState, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mirrPortMirr=mirrPortMirr, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanMaxEnt=vlanMaxEnt, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgState=stgNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoLearn=vlanInfoLearn, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, BridgeId=BridgeId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost)
