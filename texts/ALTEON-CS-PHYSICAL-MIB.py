...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCfg=portTeamCfg, fdbStats=fdbStats, mirroring=mirroring, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCfg=mstCistCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortTable=stgStatsPortTable, lacpNewPortState=lacpNewPortState, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbVlan=fdbVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfo=portTeamInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, vlanInfo=vlanInfo, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistDefaultCfg=mstCistDefaultCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgState=mstNewCfgState, vlanInfoStatus=vlanInfoStatus, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgState=trunkGroupNewCfgState, cistRegionalPathCost=cistRegionalPathCost, vlanInfoTable=vlanInfoTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2Stats=layer2Stats, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stpStats=stpStats, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, layer2Info=layer2Info, mirrPortMirr=mirrPortMirr, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, fdbSrcPort=fdbSrcPort, stpInfoPortState=stpInfoPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgAgingTime=stgNewCfgAgingTime, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, layer2=layer2, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbInfo=fdbInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortRole=stpInfoPortRole, cistInfoPortTable=cistInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPriority=stgNewCfgPriority, stpInfoIndex=stpInfoIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgStpMode=mstCurCfgStpMode, fdbSrcTrunk=fdbSrcTrunk, PYSNMP_MODULE_ID=layer2, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCfg=stgCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTable=stpInfoTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortMoved=lacpInfoPortMoved, vlanMaxEnt=vlanMaxEnt, cistInfo=cistInfo, portTeamInfoState=portTeamInfoState, vlanInfoName=vlanInfoName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkgroup=trunkgroup, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortState=lacpCurPortState, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPorts=portTeamInfoPorts, stpInfoTopChanges=stpInfoTopChanges, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgTable=portTeamCurCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoPorts=vlanInfoPorts, stpInfoMaxAge=stpInfoMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsStpIndex=stgStatsStpIndex, fdbMacAddr=fdbMacAddr, fdbRefSps=fdbRefSps, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlan=vlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortEdge=stpInfoPortEdge, cistRoot=cistRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortState=cistInfoPortState, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoId=vlanInfoId, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgState=stgCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgAgingTime=stgCurCfgAgingTime, cistGeneralInfo=cistGeneralInfo, stgNewCfgState=stgNewCfgState, stgNewCfgTable=stgNewCfgTable, stpInfoTableEntry=stpInfoTableEntry, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortTable=lacpInfoPortTable, cistRootPort=cistRootPort, fdbLearnedPort=fdbLearnedPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortTable=stpInfoPortTable, stpInfo=stpInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbState=fdbState, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgTable=portTeamNewCfgTable, fdbEntry=fdbEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCfg=mstCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, layer2Oper=layer2Oper, lacpInfo=lacpInfo, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTable=portTeamInfoTable, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbClear=fdbClear, portTeamNewCfgPorts=portTeamNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacp=lacp, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoForwardDelay=stpInfoForwardDelay, fdbTable=fdbTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, layer2Configs=layer2Configs, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgState=mstCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoRootPort=stpInfoRootPort, BridgeId=BridgeId, fdbStatsLookups=fdbStatsLookups)
