...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoId=vlanInfoId, stgNewCfgState=stgNewCfgState, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, BridgeId=BridgeId, fdbStatsFindFails=fdbStatsFindFails, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoLearn=vlanInfoLearn, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCfg=mstCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistRootPathCost=cistRootPathCost, portTeamCurCfgState=portTeamCurCfgState, vlanInfoStatus=vlanInfoStatus, lacpNewPortState=lacpNewPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortEdge=stpInfoPortEdge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoRootPort=stpInfoRootPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbInfo=fdbInfo, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoTable=vlanInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Stats=layer2Stats, vlanMaxEnt=vlanMaxEnt, fdbMacAddr=fdbMacAddr, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgState=vlanNewCfgState, mstCistCfg=mstCistCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoForwardDelay=stpInfoForwardDelay, cistRoot=cistRoot, portTeamCfg=portTeamCfg, fdbRefSps=fdbRefSps, fdbState=fdbState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRegionalRoot=cistRegionalRoot, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsHiwat=fdbStatsHiwat, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2=layer2, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgState=stgCurCfgState, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurPortState=lacpCurPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpStats=stpStats, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoPorts=vlanInfoPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbVlan=fdbVlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, fdbClear=fdbClear, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortIndex=stpInfoPortIndex, stpInfo=stpInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoTable=stpInfoTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, vlanInfoName=vlanInfoName, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistRootPort=cistRootPort, fdbStats=fdbStats, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfo=lacpInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, fdbSrcPort=fdbSrcPort, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortRole=stpInfoPortRole, cistGeneralInfo=cistGeneralInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfo=portTeamInfo, layer2Oper=layer2Oper, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFinds=fdbStatsFinds, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfo=cistInfo, vlanInfo=vlanInfo, mstNewCfgState=mstNewCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, trunkgroup=trunkgroup, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mirroring=mirroring, fdbEntry=fdbEntry, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoState=portTeamInfoState, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlan=vlan, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, PYSNMP_MODULE_ID=layer2, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, lacp=lacp, stpInfoRootCost=stpInfoRootCost, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgTable=stgCurCfgTable, stpInfoPortTable=stpInfoPortTable, layer2Configs=layer2Configs, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbLearnedPort=fdbLearnedPort, mstCurCfgState=mstCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstGeneralCfg=mstGeneralCfg, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbTable=fdbTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortState=stpInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, stgCfg=stgCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Info=layer2Info)
