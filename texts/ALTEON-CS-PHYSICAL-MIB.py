...
MibIdentifier, Bits, Unsigned32, TimeTicks, Gauge32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, IpAddress, Integer32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Unsigned32", "TimeTicks", "Gauge32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoState=portTeamInfoState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCfg=stgCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoId=vlanInfoId, mirrPortMirr=mirrPortMirr, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2=layer2, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlan=vlan, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgState=mstCurCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgState=vlanNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, mstGeneralCfg=mstGeneralCfg, stgCurCfgTable=stgCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfo=vlanInfo, mirroring=mirroring, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoIndex=stpInfoIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRootPathCost=cistRootPathCost, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoName=vlanInfoName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRootPort=cistRootPort, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStats=fdbStats, stpInfoTable=stpInfoTable, PYSNMP_MODULE_ID=layer2, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortRole=stpInfoPortRole, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Oper=layer2Oper, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsDeletes=fdbStatsDeletes, vlanInfoJumbo=vlanInfoJumbo, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfo=stpInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgState=stgCurCfgState, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgStg=vlanCurCfgStg, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbTable=fdbTable, stgCurCfgStgIndex=stgCurCfgStgIndex, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkgroup=trunkgroup, portTeamCfg=portTeamCfg, layer2Configs=layer2Configs, fdbClear=fdbClear, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfo=lacpInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoHoldTime=stpInfoHoldTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbSrcTrunk=fdbSrcTrunk, fdbStatsFinds=fdbStatsFinds, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbVlan=fdbVlan, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbState=fdbState, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgState=vlanCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgStg=vlanNewCfgStg, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRegionalRoot=cistRegionalRoot, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpStats=stpStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbMacAddr=fdbMacAddr, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortSelected=lacpInfoPortSelected, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoRootCost=stpInfoRootCost, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPriority=stgNewCfgPriority, mstCistCfg=mstCistCfg, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortRole=cistInfoPortRole, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfo=portTeamInfo, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2Info=layer2Info, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, mstCfg=mstCfg, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfo=cistInfo, cistBridgeMaxAge=cistBridgeMaxAge, layer2Stats=layer2Stats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoRootPort=stpInfoRootPort, vlanMaxEnt=vlanMaxEnt, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsLookups=fdbStatsLookups, cistRoot=cistRoot, cistRegionalPathCost=cistRegionalPathCost, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoStatus=vlanInfoStatus, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsHiwat=fdbStatsHiwat)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbInfo=fdbInfo, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacp=lacp, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbSrcPort=fdbSrcPort, vlanInfoLearn=vlanInfoLearn, lacpCurPortState=lacpCurPortState, fdbEntry=fdbEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgState=portTeamNewCfgState, fdbRefSps=fdbRefSps, cistInfoPortState=cistInfoPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, BridgeId=BridgeId, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoTable=vlanInfoTable)
