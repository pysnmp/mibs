...
# Produced by pysmi-1.1.10 at Fri Feb 16 02:32:36 2024
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionName=mstCurCfgRegionName, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStats=fdbStats, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortState=lacpCurPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbSrcPort=fdbSrcPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgState=stgCurCfgState, lacp=lacp, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, cistRootPort=cistRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlan=vlan, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCfg=portTeamCfg, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgState=vlanCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoRootCost=stpInfoRootCost, vlanInfoId=vlanInfoId, stpInfoPortTable=stpInfoPortTable, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCfg=stgCfg, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRoot=cistRoot, stpInfoPortState=stpInfoPortState, mirroring=mirroring, vlanInfoName=vlanInfoName, vlanInfoJumbo=vlanInfoJumbo, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgState=mstNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, cistRootPathCost=cistRootPathCost, portTeamInfoTable=portTeamInfoTable, cistInfoPortRole=cistInfoPortRole, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortTable=stgStatsPortTable, vlanMaxEnt=vlanMaxEnt, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortRole=stpInfoPortRole, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortTable=cistInfoPortTable, stpInfoTable=stpInfoTable, fdbRefSps=fdbRefSps, mstGeneralCfg=mstGeneralCfg, cistGeneralInfo=cistGeneralInfo, vlanNewCfgState=vlanNewCfgState, stpInfoIndex=stpInfoIndex, fdbClear=fdbClear, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoTopChanges=stpInfoTopChanges, lacpNewSystemPriority=lacpNewSystemPriority, mirrPortMirr=mirrPortMirr, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgState=stgNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCfg=mstCistCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRegionalRoot=cistRegionalRoot, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbVlan=fdbVlan, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbTable=fdbTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFinds=fdbStatsFinds, lacpInfo=lacpInfo, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTableEntry=stpInfoTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbMacAddr=fdbMacAddr, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, layer2Stats=layer2Stats, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfo=cistInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbInfo=fdbInfo, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfo=vlanInfo, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortState=cistInfoPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoState=portTeamInfoState, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpStats=stpStats, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamInfo=portTeamInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbLearnedPort=fdbLearnedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, stpInfo=stpInfo, stgStatsPortIndex=stgStatsPortIndex, cistRegionalPathCost=cistRegionalPathCost, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPorts=portTeamInfoPorts, layer2Info=layer2Info)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, layer2Configs=layer2Configs, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCfg=mstCfg, fdbEntry=fdbEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortEdge=stpInfoPortEdge, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortIndex=stpInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, layer2Oper=layer2Oper, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbState=fdbState, BridgeId=BridgeId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime)
