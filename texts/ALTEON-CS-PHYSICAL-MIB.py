...
Unsigned32, Gauge32, iso, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, TimeTicks, ModuleIdentity, Bits, NotificationType, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "TimeTicks", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistRoot=cistRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortNtt=lacpInfoPortNtt, fdbVlan=fdbVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgState=portTeamNewCfgState, fdbState=fdbState, vlanCurCfgState=vlanCurCfgState, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbSrcTrunk=fdbSrcTrunk, BridgeId=BridgeId, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPriority=stgNewCfgPriority, portTeamCfg=portTeamCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgState=trunkGroupNewCfgState, stpStats=stpStats, stgStatsPortTable=stgStatsPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootPort=stpInfoRootPort, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoIndex=stpInfoIndex, cistRootPort=cistRootPort, portTeamTableMaxSize=portTeamTableMaxSize, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbInfo=fdbInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCfg=mstCfg, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortState=cistInfoPortState, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortSelected=lacpInfoPortSelected, fdbStats=fdbStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfo=vlanInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortLink=stgNewCfgPortLink, mirroring=mirroring, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTable=stpInfoTable, PYSNMP_MODULE_ID=layer2, layer2=layer2, mirrPortMirr=mirrPortMirr, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgState=stgCurCfgState, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgState=mstNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, cistGeneralInfo=cistGeneralInfo, layer2Configs=layer2Configs, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoRootCost=stpInfoRootCost, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoState=portTeamInfoState, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgState=mstCurCfgState, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbMacAddr=fdbMacAddr, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfo=portTeamInfo, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoTable=portTeamInfoTable, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortState=lacpNewPortState, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCreates=fdbStatsCreates, fdbStatsHiwat=fdbStatsHiwat, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoTopChanges=stpInfoTopChanges, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsOverflows=fdbStatsOverflows, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanMaxEnt=vlanMaxEnt, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, layer2Info=layer2Info, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCfg=stgCfg, stpInfoPortPathCost=stpInfoPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgTable=stgCurCfgTable, stpInfo=stpInfo, layer2Oper=layer2Oper, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortTable=cistInfoPortTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoHelloTime=stpInfoHelloTime, mstCistCfg=mstCistCfg, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRegionalRoot=cistRegionalRoot, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoName=vlanInfoName, vlanInfoStatus=vlanInfoStatus, lacpInfo=lacpInfo, stgNewCfgTable=stgNewCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkgroup=trunkgroup, fdbTable=fdbTable, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbSrcPort=fdbSrcPort, stgNewCfgState=stgNewCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfo=cistInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortStpIndex=stpInfoPortStpIndex, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoId=vlanInfoId, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortRole=cistInfoPortRole, vlan=vlan, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoTableEntry=vlanInfoTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsFindFails=fdbStatsFindFails, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoLearn=vlanInfoLearn, stpInfoPortState=stpInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, fdbEntry=fdbEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, mstGeneralCfg=mstGeneralCfg, lacpCurPortState=lacpCurPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbRefSps=fdbRefSps, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, layer2Stats=layer2Stats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistRegionalPathCost=cistRegionalPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacp=lacp, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority)
