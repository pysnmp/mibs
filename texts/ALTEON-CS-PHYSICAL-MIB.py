...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2=layer2, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgState=portTeamCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRootPort=cistRootPort, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbEntry=fdbEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortRole=cistInfoPortRole, BridgeId=BridgeId, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoStatus=vlanInfoStatus, layer2Info=layer2Info, cistInfoPortTable=cistInfoPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsDeletes=fdbStatsDeletes, fdbStatsFinds=fdbStatsFinds, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge, stpStats=stpStats, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoMaxAge=stpInfoMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbSrcPort=fdbSrcPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsOverflows=fdbStatsOverflows, stgCfg=stgCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoRootPort=stpInfoRootPort, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbState=fdbState, vlanInfoJumbo=vlanInfoJumbo, stpInfoHelloTime=stpInfoHelloTime, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortTable=lacpInfoPortTable, vlanInfo=vlanInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2Oper=layer2Oper, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, PYSNMP_MODULE_ID=layer2, stpInfoPortState=stpInfoPortState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbTable=fdbTable, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTable=stpInfoTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoId=vlanInfoId, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbVlan=fdbVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsPortTable=stgStatsPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistRegionalRoot=cistRegionalRoot, cistRegionalPathCost=cistRegionalPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgTable=vlanCurCfgTable, fdbClear=fdbClear, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, fdbMacAddr=fdbMacAddr, vlanInfoTable=vlanInfoTable, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, stpInfoRootCost=stpInfoRootCost, stgCurCfgTable=stgCurCfgTable, fdbInfo=fdbInfo, lacpInfo=lacpInfo, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRoot=cistRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgState=mstCurCfgState, lacpNewPortState=lacpNewPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortPathCost=cistInfoPortPathCost, mirroring=mirroring, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgState=mstNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgIndex=stgCurCfgIndex, vlan=vlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortState=lacpCurPortState, vlanInfoLearn=vlanInfoLearn, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfo=portTeamInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfo=stpInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, layer2Configs=layer2Configs, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortState=cistInfoPortState, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgIndex=stgNewCfgIndex, layer2Stats=layer2Stats, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfo=cistInfo, lacp=lacp, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCfg=portTeamCfg, vlanInfoName=vlanInfoName, stgCurCfgState=stgCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsLookups=fdbStatsLookups, mstCfg=mstCfg, portTeamInfoTable=portTeamInfoTable, fdbStats=fdbStats, cistGeneralInfo=cistGeneralInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistRootPathCost=cistRootPathCost, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPriority=stgNewCfgPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkgroup=trunkgroup, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbLearnedPort=fdbLearnedPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract)
