...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCfg=mstCistCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbMacAddr=fdbMacAddr, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgState=stgNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortTable=stpInfoPortTable, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCfg=stgCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgState=stgCurCfgState, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgState=portTeamNewCfgState, fdbEntry=fdbEntry, fdbSrcPort=fdbSrcPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfo=vlanInfo, vlan=vlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTable=stpInfoTable, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistRootPort=cistRootPort, mstCfg=mstCfg, fdbStatsHiwat=fdbStatsHiwat, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2=layer2, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortMoved=lacpInfoPortMoved, layer2Oper=layer2Oper, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbVlan=fdbVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurPortState=lacpCurPortState, cistBridgeMaxAge=cistBridgeMaxAge, BridgeId=BridgeId, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoRootCost=stpInfoRootCost, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoName=vlanInfoName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkgroup=trunkgroup, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfo=portTeamInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortState=lacpNewPortState, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgState=vlanCurCfgState, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbLearnedPort=fdbLearnedPort, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistGeneralInfo=cistGeneralInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, cistBridgeHelloTime=cistBridgeHelloTime, mirroring=mirroring, layer2Info=layer2Info, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsStpIndex=stgStatsStpIndex, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgState=vlanNewCfgState, stgCurCfgPriority=stgCurCfgPriority, vlanMaxEnt=vlanMaxEnt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoLearn=vlanInfoLearn, fdbClear=fdbClear, lacp=lacp, fdbStatsFinds=fdbStatsFinds, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbState=fdbState, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortIndex=stpInfoPortIndex, cistRegionalPathCost=cistRegionalPathCost, layer2Configs=layer2Configs, fdbTable=fdbTable, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgState=mstNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoStatus=vlanInfoStatus, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanInfoBwmContract=vlanInfoBwmContract, fdbInfo=fdbInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfo=lacpInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortState=cistInfoPortState, portTeamCfg=portTeamCfg, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsCreates=fdbStatsCreates, fdbStats=fdbStats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgState=mstCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTable=lacpInfoPortTable, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoPorts=portTeamInfoPorts, layer2Stats=layer2Stats, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRoot=cistRoot, vlanInfoId=vlanInfoId, stpInfoIndex=stpInfoIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoRootPort=stpInfoRootPort, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoHoldTime=stpInfoHoldTime, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsLookups=fdbStatsLookups, mstGeneralCfg=mstGeneralCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrPortMirr=mirrPortMirr, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfo=cistInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpStats=stpStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortRole=stpInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoState=portTeamInfoState, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortRole=cistInfoPortRole, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfo=stpInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRegionalRoot=cistRegionalRoot, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority)
