...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfo=vlanInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfo=stpInfo, fdbStats=fdbStats, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, BridgeId=BridgeId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortEdge=stpInfoPortEdge, trunkgroup=trunkgroup, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCfg=mstCistCfg, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, layer2Stats=layer2Stats, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgState=vlanCurCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsCreates=fdbStatsCreates, layer2Oper=layer2Oper, stgCfg=stgCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsFinds=fdbStatsFinds, portTeamCfg=portTeamCfg, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortState=stpInfoPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoIndex=stpInfoIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, mstGeneralCfg=mstGeneralCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgVlanName=vlanNewCfgVlanName, mirroring=mirroring, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgState=stgCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamInfoTrunks=portTeamInfoTrunks, fdbRefSps=fdbRefSps, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoPorts=vlanInfoPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoRootPort=stpInfoRootPort, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortIndex=cistInfoPortIndex, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpInfoPortTable=lacpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCfg=mstCfg, mstNewCfgStpMode=mstNewCfgStpMode, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortState=lacpNewPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPriority=stgCurCfgPriority, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbClear=fdbClear, cistInfoPortTable=cistInfoPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpStats=stpStats, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfo=portTeamInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfo=cistInfo, layer2Info=layer2Info, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbTable=fdbTable, fdbState=fdbState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpCurPortState=lacpCurPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoTable=vlanInfoTable, vlanInfoName=vlanInfoName, fdbStatsLookupFails=fdbStatsLookupFails, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbEntry=fdbEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mirrPortMirr=mirrPortMirr, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistGeneralInfo=cistGeneralInfo, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2=layer2, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Configs=layer2Configs, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbInfo=fdbInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTopChanges=stpInfoTopChanges, lacp=lacp, vlanInfoId=vlanInfoId, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgTable=stgNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRootPort=cistRootPort, lacpInfo=lacpInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoStatus=vlanInfoStatus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgState=vlanNewCfgState, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlan=vlan, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRoot=cistRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortIndex=stpInfoPortIndex, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanName=vlanCurCfgVlanName, cistRootPathCost=cistRootPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbMacAddr=fdbMacAddr, fdbSrcTrunk=fdbSrcTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgState=mstCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, fdbLearnedPort=fdbLearnedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortTable=stgStatsPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTable=portTeamInfoTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortState=cistInfoPortState, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgState=stgNewCfgState, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistRegionalRoot=cistRegionalRoot, fdbVlan=fdbVlan, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoTable=stpInfoTable, stgNewCfgPortIndex=stgNewCfgPortIndex)
