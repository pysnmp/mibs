...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkgroup=trunkgroup, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Stats=layer2Stats, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, fdbTable=fdbTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortState=cistInfoPortState, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortTable=stgStatsPortTable, portTeamInfoTable=portTeamInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgState=vlanCurCfgState, stgCurCfgTable=stgCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsFinds=fdbStatsFinds, stpInfoPortPathCost=stpInfoPortPathCost, stpInfo=stpInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, fdbClear=fdbClear, stpInfoTable=stpInfoTable, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortState=lacpNewPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortState=stgNewCfgPortState, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortState=stpInfoPortState, cistRegionalRoot=cistRegionalRoot, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsCreates=fdbStatsCreates, layer2Info=layer2Info, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mirroring=mirroring, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortIndex=stgStatsPortIndex, portTeamCfg=portTeamCfg, cistRootPathCost=cistRootPathCost, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, PYSNMP_MODULE_ID=layer2, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgState=mstCurCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRootPort=cistRootPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbState=fdbState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoMaxAge=stpInfoMaxAge, fdbSrcPort=fdbSrcPort, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoRootCost=stpInfoRootCost, cistRegionalPathCost=cistRegionalPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Configs=layer2Configs, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStatsOverflows=fdbStatsOverflows, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortTable=cistInfoPortTable, layer2Oper=layer2Oper, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortIndex=stpInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacp=lacp, vlanInfoId=vlanInfoId, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfo=lacpInfo, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTopChanges=stpInfoTopChanges, mstCistCfg=mstCistCfg, vlanInfoName=vlanInfoName, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCurrent=fdbStatsCurrent, portTeamInfo=portTeamInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortRole=stpInfoPortRole, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsStpIndex=stgStatsStpIndex, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoState=portTeamInfoState, fdbLearnedPort=fdbLearnedPort, mirrPortMirr=mirrPortMirr, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2=layer2, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbMacAddr=fdbMacAddr, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, stpStats=stpStats, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCfg=stgCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgState=stgCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbVlan=fdbVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanMaxVlanID=vlanMaxVlanID, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfo=vlanInfo, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCfg=mstCfg, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortTable=stgCurCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRoot=cistRoot, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindOrCreates=fdbStatsFindOrCreates, BridgeId=BridgeId, vlanNewCfgState=vlanNewCfgState, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, fdbStats=fdbStats, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, stpInfoIndex=stpInfoIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlan=vlan, fdbStatsLookupFails=fdbStatsLookupFails, fdbInfo=fdbInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortState=lacpCurPortState, vlanInfoTable=vlanInfoTable, cistInfo=cistInfo)
