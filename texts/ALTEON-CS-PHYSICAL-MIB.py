...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortTable=stgStatsPortTable, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsStpIndex=stgStatsStpIndex, layer2Stats=layer2Stats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCfg=stgCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoState=portTeamInfoState, mstNewCfgRegionName=mstNewCfgRegionName, BridgeId=BridgeId, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCfg=mstCistCfg, lacpInfo=lacpInfo, vlanInfoId=vlanInfoId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgIndex=stgCurCfgIndex, fdbRefSps=fdbRefSps, vlanInfoTable=vlanInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlanInfoPorts=vlanInfoPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlan=vlan, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfo=portTeamInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, fdbTable=fdbTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, PYSNMP_MODULE_ID=layer2, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgPorts=vlanCurCfgPorts, fdbSrcPort=fdbSrcPort, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFindFails=fdbStatsFindFails, fdbVlan=fdbVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbLearnedPort=fdbLearnedPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortState=lacpNewPortState, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanMaxVlanID=vlanMaxVlanID, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, stpInfoIndex=stpInfoIndex, portTeamCfg=portTeamCfg, layer2Oper=layer2Oper, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, vlanInfoName=vlanInfoName, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbMacAddr=fdbMacAddr, vlanCurCfgStg=vlanCurCfgStg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRoot=cistRoot, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCfg=mstCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbClear=fdbClear, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTable=portTeamInfoTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgState=vlanCurCfgState, vlanMaxEnt=vlanMaxEnt, cistInfo=cistInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfo=stpInfo, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortTable=stpInfoPortTable, stgNewCfgTable=stgNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistRegionalRoot=cistRegionalRoot, cistInfoPortState=cistInfoPortState, layer2=layer2, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbState=fdbState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortIndex=stgStatsPortIndex, layer2Configs=layer2Configs, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStats=fdbStats, trunkgroup=trunkgroup, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortState=stgNewCfgPortState, fdbInfo=fdbInfo, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgState=stgNewCfgState, stpInfoTable=stpInfoTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mirroring=mirroring, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistGeneralInfo=cistGeneralInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgIndex=stgNewCfgIndex, fdbEntry=fdbEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortRole=stpInfoPortRole, cistRootPathCost=cistRootPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistBridgeHelloTime=cistBridgeHelloTime, lacp=lacp, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoRootCost=stpInfoRootCost, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfo=vlanInfo, stpStats=stpStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoStatus=vlanInfoStatus, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, layer2Info=layer2Info, stgNewCfgTableEntry=stgNewCfgTableEntry, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortState=lacpCurPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRootPort=cistRootPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg)
