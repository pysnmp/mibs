...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbSrcPort=fdbSrcPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfo=vlanInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbEntry=fdbEntry, layer2Stats=layer2Stats, stpInfoPortTable=stpInfoPortTable, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgState=stgCurCfgState, fdbVlan=fdbVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstNewCfgRegionName=mstNewCfgRegionName, vlanMaxEnt=vlanMaxEnt, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbClear=fdbClear, vlanNewCfgAddPort=vlanNewCfgAddPort, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, vlan=vlan, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanInfoJumbo=vlanInfoJumbo, layer2Info=layer2Info, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCfg=stgCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfo=stpInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortTable=stgNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, stpInfoTableEntry=stpInfoTableEntry, vlanInfoLearn=vlanInfoLearn, stpInfoRootCost=stpInfoRootCost, stpInfoHelloTime=stpInfoHelloTime, portTeamInfoState=portTeamInfoState, stgNewCfgState=stgNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoId=vlanInfoId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsPortTable=stgStatsPortTable, lacpCurPortState=lacpCurPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoHoldTime=stpInfoHoldTime, fdbStatsFinds=fdbStatsFinds, mstCistCfg=mstCistCfg, cistInfoPortRole=cistInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPriority=stgNewCfgPriority, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTable=portTeamInfoTable, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, mstCfg=mstCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStats=fdbStats, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoIndex=stpInfoIndex, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2=layer2, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkgroup=trunkgroup, cistInfo=cistInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfo=lacpInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgIndex=stgCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRootPathCost=cistRootPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mirroring=mirroring, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoRootPort=stpInfoRootPort, cistRootPort=cistRootPort, cistRegionalRoot=cistRegionalRoot, fdbInfo=fdbInfo, mstNewCfgState=mstNewCfgState, stpInfoMaxAge=stpInfoMaxAge, vlanInfoTable=vlanInfoTable, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgTable=vlanCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTable=stpInfoTable, stgStatsStpIndex=stgStatsStpIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbState=fdbState, portTeamCfg=portTeamCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortState=cistInfoPortState, fdbStatsLookups=fdbStatsLookups, vlanCurCfgState=vlanCurCfgState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbRefSps=fdbRefSps, PYSNMP_MODULE_ID=layer2, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbTable=fdbTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortState=stpInfoPortState, vlanInfoName=vlanInfoName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortIndex=stgStatsPortIndex, fdbLearnedPort=fdbLearnedPort, layer2Configs=layer2Configs, mirrPortMirr=mirrPortMirr, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsCreates=fdbStatsCreates, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, BridgeId=BridgeId, layer2Oper=layer2Oper, vlanCurCfgVlanId=vlanCurCfgVlanId)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortTable=cistInfoPortTable, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, lacp=lacp, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, cistRoot=cistRoot, fdbMacAddr=fdbMacAddr, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfo=portTeamInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortRole=stpInfoPortRole, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgTable=stgCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbSrcTrunk=fdbSrcTrunk, stpStats=stpStats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex)
