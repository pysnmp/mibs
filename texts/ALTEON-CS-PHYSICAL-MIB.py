...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoPorts=vlanInfoPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCfg=mstCfg, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfo=lacpInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoName=vlanInfoName, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortState=lacpCurPortState, mstGeneralCfg=mstGeneralCfg, cistInfoPortPriority=cistInfoPortPriority, layer2Info=layer2Info, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfo=portTeamInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortIndex=stpInfoPortIndex, vlanMaxEnt=vlanMaxEnt, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortState=stpInfoPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbEntry=fdbEntry, stgCurCfgPortState=stgCurCfgPortState, cistRoot=cistRoot, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoStatus=vlanInfoStatus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbRefSps=fdbRefSps, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgState=stgNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortIndex=stgStatsPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRootPort=cistRootPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStats=fdbStats, stgStatsPortTable=stgStatsPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgState=mstCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mirrPortMirr=mirrPortMirr, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgTable=stgNewCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, layer2Configs=layer2Configs, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortRole=stpInfoPortRole, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCfg=stgCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRootPathCost=cistRootPathCost, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbClear=fdbClear, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Stats=layer2Stats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoTable=stpInfoTable, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoPorts=portTeamInfoPorts, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Oper=layer2Oper, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoIndex=stpInfoIndex, fdbVlan=fdbVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRegionalRoot=cistRegionalRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoState=portTeamInfoState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortTable=stpInfoPortTable, fdbInfo=fdbInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbMacAddr=fdbMacAddr, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsCreates=fdbStatsCreates, lacpNewPortState=lacpNewPortState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, layer2=layer2, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCfg=mstCistCfg, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortState=stgNewCfgPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbState=fdbState, mstNewCfgState=mstNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfo=cistInfo, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsLookups=fdbStatsLookups, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortState=cistInfoPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsStpIndex=stgStatsStpIndex, BridgeId=BridgeId, portTeamInfoIndex=portTeamInfoIndex, fdbLearnedPort=fdbLearnedPort, fdbSrcTrunk=fdbSrcTrunk, vlanInfoLearn=vlanInfoLearn, trunkgroup=trunkgroup, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbTable=fdbTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlan=vlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgPorts=portTeamNewCfgPorts, stpStats=stpStats, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTable=vlanInfoTable, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCfg=portTeamCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortSelected=lacpInfoPortSelected, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFinds=fdbStatsFinds, vlanInfo=vlanInfo, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mirroring=mirroring, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoTable=portTeamInfoTable, lacp=lacp, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfo=stpInfo, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoId=vlanInfoId)
