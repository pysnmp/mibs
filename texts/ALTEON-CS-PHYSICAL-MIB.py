...
ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter64, Unsigned32, NotificationType, iso, Counter32, Bits, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "iso", "Counter32", "Bits", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortState=cistInfoPortState, fdbSrcTrunk=fdbSrcTrunk, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2Configs=layer2Configs, stgNewCfgPortTable=stgNewCfgPortTable, fdbLearnedPort=fdbLearnedPort, stpInfoPortIndex=stpInfoPortIndex, vlanInfoId=vlanInfoId, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortMoved=lacpInfoPortMoved, mstCistBridgeCfg=mstCistBridgeCfg, fdbVlan=fdbVlan, stpInfoTable=stpInfoTable, layer2Info=layer2Info, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortRole=cistInfoPortRole, fdbRefSps=fdbRefSps, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCfg=mstCfg, stgCurCfgState=stgCurCfgState, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, BridgeId=BridgeId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbState=fdbState, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoIndex=stpInfoIndex, stpInfoRootCost=stpInfoRootCost, lacpInfoPortTable=lacpInfoPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRootPort=cistRootPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgStpMode=mstNewCfgStpMode, mstGeneralCfg=mstGeneralCfg, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCfg=portTeamCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgState=mstNewCfgState, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgState=vlanNewCfgState, stpStats=stpStats, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoRootPort=stpInfoRootPort, lacp=lacp, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, vlanInfoPorts=vlanInfoPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCfg=mstCistCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortState=stpInfoPortState, vlanCurCfgTable=vlanCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, cistRootPathCost=cistRootPathCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgState=stgNewCfgState, vlanInfoStatus=vlanInfoStatus, stpInfoPortPathCost=stpInfoPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRegionalRoot=cistRegionalRoot, fdbStats=fdbStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCfg=stgCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgState=portTeamNewCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoState=portTeamInfoState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgStg=vlanCurCfgStg, portTeamInfo=portTeamInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Stats=layer2Stats, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfo=stpInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkgroup=trunkgroup, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoLearn=vlanInfoLearn, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgLearn=vlanNewCfgLearn, vlanMaxVlanID=vlanMaxVlanID, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCreates=fdbStatsCreates, fdbStatsLookups=fdbStatsLookups, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortRole=stpInfoPortRole, vlanInfoName=vlanInfoName, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbMacAddr=fdbMacAddr, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbTable=fdbTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgState=mstCurCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortState=lacpCurPortState, layer2Oper=layer2Oper, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2=layer2, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, mirrPortMirr=mirrPortMirr, fdbStatsFinds=fdbStatsFinds, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoDesignatedRoot=stpInfoDesignatedRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirroring=mirroring, cistInfo=cistInfo, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortTable=cistInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, vlan=vlan, cistRoot=cistRoot, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, stgCurCfgTable=stgCurCfgTable, lacpNewPortState=lacpNewPortState, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbSrcPort=fdbSrcPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbClear=fdbClear, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbInfo=fdbInfo, lacpInfo=lacpInfo, fdbStatsOverflows=fdbStatsOverflows, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfo=vlanInfo)
