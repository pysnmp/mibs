...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgTable=stgCurCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortState=stpInfoPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbMacAddr=fdbMacAddr, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgState=mstNewCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgDelete=vlanNewCfgDelete, fdbInfo=fdbInfo, fdbStatsLookups=fdbStatsLookups, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFinds=fdbStatsFinds, layer2Oper=layer2Oper, vlanInfoId=vlanInfoId, lacpNewPortState=lacpNewPortState, mstCistCfg=mstCistCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoPorts=vlanInfoPorts, stgNewCfgState=stgNewCfgState, trunkgroup=trunkgroup, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Info=layer2Info, layer2Configs=layer2Configs, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootPort=stpInfoRootPort, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCreates=fdbStatsCreates, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTable=stgCurCfgPortTable, fdbSrcPort=fdbSrcPort, stpInfoTable=stpInfoTable, cistRootPathCost=cistRootPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortRole=cistInfoPortRole, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, lacpCurPortState=lacpCurPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoPorts=portTeamInfoPorts, fdbLearnedPort=fdbLearnedPort, cistInfoPortState=cistInfoPortState, fdbStatsLookupFails=fdbStatsLookupFails, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortLinkType=stpInfoPortLinkType, layer2=layer2, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgState=vlanCurCfgState, cistInfoPortTable=cistInfoPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, PYSNMP_MODULE_ID=layer2, stgCurCfgPriority=stgCurCfgPriority, vlanInfoName=vlanInfoName, lacpInfo=lacpInfo, fdbVlan=fdbVlan, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTable=stpInfoPortTable, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, cistGeneralInfo=cistGeneralInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, stpStats=stpStats, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoTable=vlanInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgStpMode=mstNewCfgStpMode, layer2Stats=layer2Stats, vlan=vlan, fdbStatsHiwat=fdbStatsHiwat, stpInfoTableEntry=stpInfoTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgState=mstCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgStg=vlanCurCfgStg, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoHelloTime=stpInfoHelloTime, cistRegionalRoot=cistRegionalRoot, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCfg=mstCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCurCfgStpMode=mstCurCfgStpMode, cistRoot=cistRoot, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, mirroring=mirroring, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbRefSps=fdbRefSps, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCfg=portTeamCfg, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, fdbTable=fdbTable, mstGeneralCfg=mstGeneralCfg, BridgeId=BridgeId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRootPort=cistRootPort, mirrPortMirr=mirrPortMirr, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbEntry=fdbEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoState=portTeamInfoState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortLink=stgNewCfgPortLink, fdbStats=fdbStats, vlanInfo=vlanInfo, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbClear=fdbClear)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfo=stpInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacp=lacp, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCfg=stgCfg, fdbState=fdbState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfo=cistInfo, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoRootCost=stpInfoRootCost, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState)
