...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfo=portTeamInfo, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbState=fdbState, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortIndex=stpInfoPortIndex, fdbRefSps=fdbRefSps, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTable=portTeamCurCfgTable, mstNewCfgState=mstNewCfgState, fdbStatsHiwat=fdbStatsHiwat, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCfg=portTeamCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, stpStats=stpStats, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsFinds=fdbStatsFinds, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgState=stgCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortState=lacpCurPortState, fdbEntry=fdbEntry, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCfg=stgCfg, fdbLearnedPort=fdbLearnedPort, stpInfoPortState=stpInfoPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoTable=portTeamInfoTable, portTeamInfoState=portTeamInfoState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortTable=cistInfoPortTable, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, mirrPortMirr=mirrPortMirr, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Stats=layer2Stats, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbInfo=fdbInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfoPortPriority=cistInfoPortPriority, vlanMaxEnt=vlanMaxEnt, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoRootCost=stpInfoRootCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, layer2=layer2, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStats=fdbStats, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTrunks=portTeamInfoTrunks, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, cistRootPort=cistRootPort, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfo=lacpInfo, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortTable=lacpInfoPortTable, BridgeId=BridgeId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, layer2Oper=layer2Oper, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCfg=mstCistCfg, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTable=stpInfoTable, fdbTable=fdbTable, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbVlan=fdbVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, lacpNewPortState=lacpNewPortState, cistRoot=cistRoot, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortState=cistInfoPortState, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacp=lacp, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, vlan=vlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, mirroring=mirroring, mstCistBridgeCfg=mstCistBridgeCfg, layer2Configs=layer2Configs, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortIndex=stgStatsPortIndex, fdbMacAddr=fdbMacAddr, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortTable=stpInfoPortTable, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoTable=vlanInfoTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfo=stpInfo, portTeamCurCfgState=portTeamCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, mstGeneralCfg=mstGeneralCfg, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortLink=stgCurCfgPortLink, fdbSrcPort=fdbSrcPort, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, fdbStatsCreates=fdbStatsCreates, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoPorts=vlanInfoPorts, PYSNMP_MODULE_ID=layer2, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortRole=stpInfoPortRole, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCfg=mstCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRootPathCost=cistRootPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsLookups=fdbStatsLookups, vlanInfoId=vlanInfoId, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgPorts=portTeamCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkgroup=trunkgroup, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoIndex=stpInfoIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgIndex=stgNewCfgIndex, vlanInfo=vlanInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistGeneralInfo=cistGeneralInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfo=cistInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, layer2Info=layer2Info, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbClear=fdbClear)
