...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2=layer2, mirroring=mirroring, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpCurPortState=lacpCurPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgState=mstNewCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortTable=lacpInfoPortTable, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, stgCfg=stgCfg, fdbStatsFinds=fdbStatsFinds, stpStats=stpStats, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfo=lacpInfo, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortRole=cistInfoPortRole, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoPorts=vlanInfoPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbSrcTrunk=fdbSrcTrunk, PYSNMP_MODULE_ID=layer2, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortIndex=cistInfoPortIndex, stpInfoRootPort=stpInfoRootPort, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgState=stgNewCfgState, stpInfoHoldTime=stpInfoHoldTime, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbLearnedPort=fdbLearnedPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, mstCurCfgState=mstCurCfgState, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, fdbTable=fdbTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbClear=fdbClear, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Configs=layer2Configs, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStats=fdbStats, vlanInfoLearn=vlanInfoLearn, mstCistBridgeCfg=mstCistBridgeCfg, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCfg=mstCistCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistRoot=cistRoot, vlanInfoId=vlanInfoId, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoTable=stpInfoTable, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTableEntry=stpInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortRole=stpInfoPortRole, vlan=vlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfo=portTeamInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortEdge=stpInfoPortEdge, fdbStatsOverflows=fdbStatsOverflows, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortState=cistInfoPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgState=portTeamNewCfgState, stpInfoMaxAge=stpInfoMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoState=portTeamInfoState, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRootPathCost=cistRootPathCost, vlanInfoTable=vlanInfoTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbMacAddr=fdbMacAddr, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsLookups=fdbStatsLookups, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoRootCost=stpInfoRootCost, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCfg=mstCfg, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkgroup=trunkgroup, fdbInfo=fdbInfo, stgStatsPortTable=stgStatsPortTable, vlanCurCfgLearn=vlanCurCfgLearn, BridgeId=BridgeId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mirrPortMirr=mirrPortMirr, lacpNewPortState=lacpNewPortState, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstGeneralCfg=mstGeneralCfg, vlanNewCfgState=vlanNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfo=vlanInfo, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPort=cistRootPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoName=vlanInfoName, layer2Info=layer2Info, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoTable=portTeamInfoTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfo=stpInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, layer2Stats=layer2Stats, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTable=cistInfoPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsStpIndex=stgStatsStpIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoIndex=portTeamInfoIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortTable=stpInfoPortTable, vlanCurCfgState=vlanCurCfgState, layer2Oper=layer2Oper, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoIndex=stpInfoIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacp=lacp, cistInfo=cistInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbVlan=fdbVlan, stpInfoPortState=stpInfoPortState, fdbState=fdbState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCfg=portTeamCfg, vlanNewCfgLearn=vlanNewCfgLearn)
