...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbSrcPort=fdbSrcPort, portTeamInfo=portTeamInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRootPathCost=cistRootPathCost, cistInfoPortTable=cistInfoPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacp=lacp, stgStatsPortTable=stgStatsPortTable, layer2Info=layer2Info, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsLookups=fdbStatsLookups, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, layer2Oper=layer2Oper, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRootPort=cistRootPort, fdbClear=fdbClear, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkgroup=trunkgroup, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, layer2Stats=layer2Stats, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbVlan=fdbVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortState=lacpCurPortState, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, PYSNMP_MODULE_ID=layer2, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbLearnedPort=fdbLearnedPort, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTable=stpInfoTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortState=cistInfoPortState, fdbEntry=fdbEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, layer2Configs=layer2Configs, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortState=stpInfoPortState, fdbInfo=fdbInfo, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, mirroring=mirroring, vlan=vlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCfg=mstCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCfg=stgCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRoot=cistRoot, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2=layer2, BridgeId=BridgeId, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoLearn=vlanInfoLearn, stpInfoHelloTime=stpInfoHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, mirrPortMirr=mirrPortMirr, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgState=portTeamNewCfgState, stpInfoTopChanges=stpInfoTopChanges, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfo=cistInfo, stpInfoPortTable=stpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCfg=portTeamCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStats=fdbStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortState=lacpNewPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortRole=stpInfoPortRole, mstGeneralCfg=mstGeneralCfg, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfoPortTable=lacpInfoPortTable, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgTable=stgNewCfgTable, vlanInfoTable=vlanInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoState=portTeamInfoState, stgCurCfgPortTable=stgCurCfgPortTable, fdbState=fdbState, vlanInfoStatus=vlanInfoStatus, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCfg=mstCistCfg, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbRefSps=fdbRefSps, fdbStatsCurrent=fdbStatsCurrent, stpInfoIndex=stpInfoIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbTable=fdbTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTable=portTeamInfoTable, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbSrcTrunk=fdbSrcTrunk, stgStatsPortIndex=stgStatsPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfo=vlanInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbMacAddr=fdbMacAddr, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpStats=stpStats, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPriority=stgNewCfgPriority, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, vlanInfoId=vlanInfoId, mstNewCfgState=mstNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfo=lacpInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortLinkType=stpInfoPortLinkType, mstCurCfgState=mstCurCfgState, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRegionalRoot=cistRegionalRoot, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgTable=vlanNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsLookupFails=fdbStatsLookupFails, stpInfo=stpInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoName=vlanInfoName, stgCurCfgTable=stgCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex)
