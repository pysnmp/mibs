...
ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, NotificationType, Unsigned32, Integer32, TimeTicks, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "NotificationType", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Configs=layer2Configs, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbClear=fdbClear, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbState=fdbState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stpInfoRootPort=stpInfoRootPort, layer2Info=layer2Info, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfo=vlanInfo, layer2=layer2, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoTable=stpInfoTable, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, fdbSrcPort=fdbSrcPort, fdbRefSps=fdbRefSps, fdbVlan=fdbVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCfg=stgCfg, stpStats=stpStats, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTable=portTeamInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoState=portTeamInfoState, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsLookups=fdbStatsLookups, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, cistRoot=cistRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortPriority=cistInfoPortPriority, vlan=vlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfo=portTeamInfo, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbTable=fdbTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, PYSNMP_MODULE_ID=layer2, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortState=lacpNewPortState, mirrPortMirr=mirrPortMirr, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortState=stgNewCfgPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistRegionalRoot=cistRegionalRoot, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgTable=vlanNewCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfo=stpInfo, stpInfoPortState=stpInfoPortState, mstCistCfg=mstCistCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoPorts=vlanInfoPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Stats=layer2Stats, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacp=lacp, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortTable=stgNewCfgPortTable, cistInfo=cistInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortPathCost=cistInfoPortPathCost, layer2Oper=layer2Oper, stgStatsPortTable=stgStatsPortTable, vlanInfoStatus=vlanInfoStatus, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoIndex=stpInfoIndex, lacpCurPortState=lacpCurPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfoLearn=vlanInfoLearn, stpInfoPortIndex=stpInfoPortIndex, lacpInfo=lacpInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsCreates=fdbStatsCreates, mstGeneralCfg=mstGeneralCfg, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortTable=stpInfoPortTable, vlanInfoId=vlanInfoId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHoldTime=stpInfoHoldTime, stpInfoTopChanges=stpInfoTopChanges, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCfg=mstCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgState=mstNewCfgState, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortRole=cistInfoPortRole, vlanNewCfgLearn=vlanNewCfgLearn, fdbMacAddr=fdbMacAddr, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgStg=vlanCurCfgStg, fdbInfo=fdbInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, BridgeId=BridgeId, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStats=fdbStats)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortEdge=stpInfoPortEdge, lacpNewSystemPriority=lacpNewSystemPriority, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPriority=stgNewCfgPriority, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgState=vlanNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkgroup=trunkgroup, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbEntry=fdbEntry, cistInfoPortTable=cistInfoPortTable, stpInfoRootCost=stpInfoRootCost, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, cistRootPort=cistRootPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTableEntry=stpInfoTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCfg=portTeamCfg, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable)
