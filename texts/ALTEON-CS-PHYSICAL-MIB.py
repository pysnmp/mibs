...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbLearnedPort=fdbLearnedPort, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortRole=stpInfoPortRole, portTeamInfo=portTeamInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoTable=portTeamInfoTable, fdbStatsOverflows=fdbStatsOverflows, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortTable=stpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCfg=mstCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoStatus=vlanInfoStatus, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortIndex=stgStatsPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbEntry=fdbEntry, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistDefaultCfg=mstCistDefaultCfg, cistRoot=cistRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoRootPort=stpInfoRootPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewPortState=lacpNewPortState, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, layer2Info=layer2Info, portTeamCfg=portTeamCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortTable=stgStatsPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgState=stgCurCfgState, cistRegionalRoot=cistRegionalRoot, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbTable=fdbTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, PYSNMP_MODULE_ID=layer2, layer2=layer2, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgPorts=vlanNewCfgPorts, BridgeId=BridgeId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTable=stgCurCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRegionalPathCost=cistRegionalPathCost, layer2Stats=layer2Stats, fdbStatsCurrent=fdbStatsCurrent, stpInfoHelloTime=stpInfoHelloTime, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpStats=stpStats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoId=vlanInfoId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgState=stgNewCfgState, cistRootPort=cistRootPort, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTable=stpInfoTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsCreates=fdbStatsCreates, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirroring=mirroring, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbMacAddr=fdbMacAddr, vlanInfoJumbo=vlanInfoJumbo, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgAddVlan=stgNewCfgAddVlan, mstGeneralCfg=mstGeneralCfg, fdbStats=fdbStats, stgNewCfgTable=stgNewCfgTable, fdbState=fdbState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgState=vlanCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfo=vlanInfo, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoState=portTeamInfoState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacp=lacp, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Configs=layer2Configs, stpInfoPortState=stpInfoPortState, portTeamNewCfgState=portTeamNewCfgState, fdbSrcTrunk=fdbSrcTrunk, vlanInfoName=vlanInfoName, cistRootPathCost=cistRootPathCost, vlanMaxVlanID=vlanMaxVlanID, fdbInfo=fdbInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstNewCfgState=mstNewCfgState, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistBridgeMaxAge=cistBridgeMaxAge, vlan=vlan, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbRefSps=fdbRefSps, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCfg=stgCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgState=trunkGroupCurCfgState, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbClear=fdbClear, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2Oper=layer2Oper, mstCistCfg=mstCistCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoTable=vlanInfoTable, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortTable=cistInfoPortTable, stpInfo=stpInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortState=lacpCurPortState, fdbVlan=fdbVlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbSrcPort=fdbSrcPort, vlanInfoPorts=vlanInfoPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCurCfgState=mstCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfo=cistInfo, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgIndex=stgNewCfgIndex, fdbStatsLookups=fdbStatsLookups, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanMaxEnt=vlanMaxEnt, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkgroup=trunkgroup)
