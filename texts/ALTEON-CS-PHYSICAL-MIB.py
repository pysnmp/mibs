...
NotificationType, MibIdentifier, Integer32, Gauge32, Counter64, Counter32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Integer32", "Gauge32", "Counter64", "Counter32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstGeneralCfg=mstGeneralCfg, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortState=lacpNewPortState, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoPorts=vlanInfoPorts, stpInfoTable=stpInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoState=portTeamInfoState, stgNewCfgState=stgNewCfgState, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, PYSNMP_MODULE_ID=layer2, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfo=stpInfo, fdbTable=fdbTable, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, fdbState=fdbState, fdbStats=fdbStats, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, cistRootPort=cistRootPort, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortPriority=cistInfoPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistRegionalPathCost=cistRegionalPathCost, mstCistCfg=mstCistCfg, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoIndex=stpInfoIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsFinds=fdbStatsFinds, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortTable=stpInfoPortTable, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgStg=vlanCurCfgStg, fdbClear=fdbClear, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanMaxEnt=vlanMaxEnt, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbRefSps=fdbRefSps, trunkgroup=trunkgroup, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistRoot=cistRoot, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoRootCost=stpInfoRootCost, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, stpInfoPortRole=stpInfoPortRole, stgStatsPortTable=stgStatsPortTable, layer2Stats=layer2Stats, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortIndex=stpInfoPortIndex, lacp=lacp, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoJumbo=vlanInfoJumbo, layer2=layer2, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgStg=vlanNewCfgStg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbEntry=fdbEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirroring=mirroring, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurPortState=lacpCurPortState, layer2Configs=layer2Configs, BridgeId=BridgeId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoName=vlanInfoName, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortState=stpInfoPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfo=vlanInfo, cistInfoPortTable=cistInfoPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCfg=mstCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlan=vlan, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgTable=stgNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgState=mstCurCfgState, portTeamNewCfgState=portTeamNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCfg=stgCfg, layer2Info=layer2Info, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoRootPort=stpInfoRootPort, fdbVlan=fdbVlan, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoId=vlanInfoId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRootPathCost=cistRootPathCost, portTeamCfg=portTeamCfg, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Oper=layer2Oper, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoTable=portTeamInfoTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbInfo=fdbInfo, lacpNewSystemPriority=lacpNewSystemPriority, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortSelected=lacpInfoPortSelected, cistGeneralInfo=cistGeneralInfo, stgCurCfgState=stgCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoTable=vlanInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbLearnedPort=fdbLearnedPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortState=cistInfoPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfo=cistInfo, stgStatsPortIndex=stgStatsPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRegionalRoot=cistRegionalRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfo=lacpInfo, stpStats=stpStats, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsStpIndex=stgStatsStpIndex, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbSrcPort=fdbSrcPort, portTeamInfo=portTeamInfo, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable)
