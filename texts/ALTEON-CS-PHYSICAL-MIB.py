...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortRole=stpInfoPortRole, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Configs=layer2Configs, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRoot=cistRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, stpInfoTable=stpInfoTable, vlanCurCfgPorts=vlanCurCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCfg=stgCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoRootCost=stpInfoRootCost, cistBridgeHelloTime=cistBridgeHelloTime, cistInfo=cistInfo, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, cistGeneralInfo=cistGeneralInfo, lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfo=vlanInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgState=portTeamCurCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgState=stgCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, cistRootPort=cistRootPort, vlanCurCfgTable=vlanCurCfgTable, mirroring=mirroring, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbEntry=fdbEntry, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2Oper=layer2Oper, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpStats=stpStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortState=lacpCurPortState, mstNewCfgState=mstNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfo=portTeamInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortState=cistInfoPortState, trunkgroup=trunkgroup, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, BridgeId=BridgeId, portTeamCfg=portTeamCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfoName=vlanInfoName, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStats=fdbStats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mirrPortMirr=mirrPortMirr, stgNewCfgState=stgNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPriority=stgCurCfgPriority, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsCreates=fdbStatsCreates, stgStatsStpIndex=stgStatsStpIndex, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortState=stpInfoPortState, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoTable=portTeamInfoTable, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoHelloTime=stpInfoHelloTime, cistRegionalRoot=cistRegionalRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortEdge=stpInfoPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistBridgeForwardDelay=cistBridgeForwardDelay, lacp=lacp, mstCistCfg=mstCistCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, stpInfo=stpInfo, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortTable=cistInfoPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsHiwat=fdbStatsHiwat, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbInfo=fdbInfo, layer2=layer2, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoId=vlanInfoId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlan=vlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, layer2Stats=layer2Stats, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortRole=cistInfoPortRole, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoTable=vlanInfoTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoState=portTeamInfoState, PYSNMP_MODULE_ID=layer2, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, layer2Info=layer2Info, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCfg=mstCfg, stgNewCfgPortState=stgNewCfgPortState, fdbClear=fdbClear, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbRefSps=fdbRefSps, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbState=fdbState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPathCost=cistRootPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgTable=stgCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbTable=fdbTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCurCfgState=mstCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsDeletes=fdbStatsDeletes, lacpNewPortState=lacpNewPortState, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstGeneralCfg=mstGeneralCfg, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortIndex=stpInfoPortIndex, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbSrcPort=fdbSrcPort, stpInfoRootPort=stpInfoRootPort, fdbVlan=fdbVlan, vlanNewCfgJumbo=vlanNewCfgJumbo)
