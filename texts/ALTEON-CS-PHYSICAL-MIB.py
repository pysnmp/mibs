...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlan=vlan, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoHoldTime=stpInfoHoldTime, mstCfg=mstCfg, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTable=cistInfoPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfo=portTeamInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgState=stgNewCfgState, stpInfoTableEntry=stpInfoTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoId=vlanInfoId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortLink=stgCurCfgPortLink, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, PYSNMP_MODULE_ID=layer2, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsCreates=fdbStatsCreates, stgCurCfgTable=stgCurCfgTable, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, layer2Oper=layer2Oper, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, BridgeId=BridgeId, stpStats=stpStats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCfg=stgCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbLearnedPort=fdbLearnedPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRoot=cistRoot, cistRegionalRoot=cistRegionalRoot, stgNewCfgPriority=stgNewCfgPriority, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTable=lacpInfoPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Info=layer2Info, mirroring=mirroring, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, fdbClear=fdbClear, layer2Configs=layer2Configs, cistRootPort=cistRootPort, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mirrPortMirr=mirrPortMirr, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfo=lacpInfo, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgState=portTeamCurCfgState, fdbInfo=fdbInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgState=vlanNewCfgState, stpInfoRootCost=stpInfoRootCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoIndex=stpInfoIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfo=cistInfo, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortIndex=stgStatsPortIndex, fdbEntry=fdbEntry, vlanMaxEnt=vlanMaxEnt, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcPort=fdbSrcPort, layer2Stats=layer2Stats, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoPorts=vlanInfoPorts, fdbMacAddr=fdbMacAddr, stpInfoPortState=stpInfoPortState, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgState=portTeamNewCfgState, cistRegionalPathCost=cistRegionalPathCost, lacpNewSystemPriority=lacpNewSystemPriority, cistRootPathCost=cistRootPathCost, fdbStatsCurrent=fdbStatsCurrent, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortTable=stpInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortState=stgCurCfgPortState, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoTable=stpInfoTable, stpInfoHelloTime=stpInfoHelloTime, lacp=lacp, stgStatsPortTable=stgStatsPortTable, vlanInfoName=vlanInfoName, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, mstCurCfgState=mstCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStats=fdbStats, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortRole=stpInfoPortRole, lacpCurPortState=lacpCurPortState, fdbState=fdbState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoRootPort=stpInfoRootPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, stpInfo=stpInfo, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgState=stgCurCfgState, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkgroup=trunkgroup, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoMaxAge=stpInfoMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, layer2=layer2, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortState=stgNewCfgPortState, vlanInfo=vlanInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbSrcTrunk=fdbSrcTrunk, cistGeneralInfo=cistGeneralInfo, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCfg=mstCistCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbRefSps=fdbRefSps, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoTable=vlanInfoTable, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCfg=portTeamCfg, stpInfoPortEdge=stpInfoPortEdge, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbVlan=fdbVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbTable=fdbTable)
