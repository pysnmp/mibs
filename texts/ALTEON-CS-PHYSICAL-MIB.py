...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfo=portTeamInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbRefSps=fdbRefSps, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRootPort=cistRootPort, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgState=stgCurCfgState, vlanInfoName=vlanInfoName, fdbClear=fdbClear, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbSrcPort=fdbSrcPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortTable=cistInfoPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsFinds=fdbStatsFinds, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, fdbStatsCurrent=fdbStatsCurrent, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, vlanInfoId=vlanInfoId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoPorts=portTeamInfoPorts, fdbStatsDeletes=fdbStatsDeletes, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgIndex=stgNewCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalPathCost=cistRegionalPathCost, PYSNMP_MODULE_ID=layer2, vlanCurCfgState=vlanCurCfgState, vlanInfoStatus=vlanInfoStatus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortState=lacpCurPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCfg=mstCfg, stgStatsPortIndex=stgStatsPortIndex, fdbState=fdbState, vlanInfoTable=vlanInfoTable, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCfg=mstCistCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionName=mstNewCfgRegionName, fdbEntry=fdbEntry, vlanInfo=vlanInfo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTable=stpInfoTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStats=fdbStats, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Configs=layer2Configs, stgStatsPortTable=stgStatsPortTable, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, stpStats=stpStats, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstGeneralCfg=mstGeneralCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbSrcTrunk=fdbSrcTrunk, layer2Stats=layer2Stats, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortRole=cistInfoPortRole, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortState=lacpNewPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, layer2Info=layer2Info, layer2Oper=layer2Oper, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, layer2=layer2, stgCurCfgPriority=stgCurCfgPriority, stpInfoHoldTime=stpInfoHoldTime, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacp=lacp, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCfg=stgCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, mirrPortMirr=mirrPortMirr, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoState=portTeamInfoState, fdbStatsFindFails=fdbStatsFindFails, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistRoot=cistRoot, vlanInfoPorts=vlanInfoPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfo=cistInfo, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbLearnedPort=fdbLearnedPort, trunkgroup=trunkgroup, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortIndex=cistInfoPortIndex, lacpInfo=lacpInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlan=vlan, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbVlan=fdbVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, fdbInfo=fdbInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortState=cistInfoPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgState=stgNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, cistGeneralInfo=cistGeneralInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, fdbMacAddr=fdbMacAddr, portTeamNewCfgState=portTeamNewCfgState, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mirroring=mirroring)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCurCfgState=mstCurCfgState, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurSystemPriority=lacpCurSystemPriority, BridgeId=BridgeId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgState=portTeamCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgTable=vlanNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanMaxEnt=vlanMaxEnt, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTable=portTeamInfoTable, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoLearn=vlanInfoLearn, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoRootPort=stpInfoRootPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbTable=fdbTable, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCfg=portTeamCfg, vlanCurCfgTable=vlanCurCfgTable, stpInfo=stpInfo)
