...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgState=stgCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfo=vlanInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCfg=portTeamCfg, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpStats=stpStats, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacp=lacp, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2=layer2, stgStatsStpIndex=stgStatsStpIndex, mirroring=mirroring, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbSrcPort=fdbSrcPort, mirrPortMirr=mirrPortMirr, PYSNMP_MODULE_ID=layer2, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, BridgeId=BridgeId, stpInfoIndex=stpInfoIndex, portTeamInfoState=portTeamInfoState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRoot=cistRoot, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbEntry=fdbEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, vlanInfoPorts=vlanInfoPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstGeneralCfg=mstGeneralCfg, cistRegionalPathCost=cistRegionalPathCost, stpInfoRootPort=stpInfoRootPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, stpInfoTableEntry=stpInfoTableEntry, trunkgroup=trunkgroup, fdbLearnedPort=fdbLearnedPort, cistInfoPortState=cistInfoPortState, layer2Info=layer2Info, fdbInfo=fdbInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbMacAddr=fdbMacAddr, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortIndex=cistInfoPortIndex, fdbTable=fdbTable, stgNewCfgPriority=stgNewCfgPriority, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, cistRegionalRoot=cistRegionalRoot, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTable=portTeamInfoTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStats=fdbStats, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgTable=stgCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortRole=cistInfoPortRole, fdbVlan=fdbVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfo=portTeamInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortState=lacpNewPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbState=fdbState, cistRootPort=cistRootPort, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortTable=cistInfoPortTable, mstCurCfgState=mstCurCfgState, fdbStatsDeletes=fdbStatsDeletes, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCfg=stgCfg, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoRootCost=stpInfoRootCost, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTable=stpInfoTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfo=stpInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfo=lacpInfo, vlanMaxVlanID=vlanMaxVlanID, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRootPathCost=cistRootPathCost, mstNewCfgState=mstNewCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortState=lacpCurPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2Stats=layer2Stats, vlanInfoId=vlanInfoId, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbRefSps=fdbRefSps, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortState=stgCurCfgPortState, vlan=vlan, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoTable=vlanInfoTable, portTeamInfoPorts=portTeamInfoPorts, mstCfg=mstCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, layer2Oper=layer2Oper, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortState=stpInfoPortState, fdbClear=fdbClear, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoName=vlanInfoName, stgCurCfgPortTable=stgCurCfgPortTable, layer2Configs=layer2Configs, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoLearn=vlanInfoLearn, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanMaxEnt=vlanMaxEnt)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgState=stgNewCfgState, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCfg=mstCistCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfo=cistInfo)
