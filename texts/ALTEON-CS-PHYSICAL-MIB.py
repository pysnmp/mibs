...
Gauge32, Unsigned32, ModuleIdentity, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacp=lacp, fdbTable=fdbTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortRole=cistInfoPortRole, vlanInfoId=vlanInfoId, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoHoldTime=stpInfoHoldTime, stpInfoTable=stpInfoTable, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbMacAddr=fdbMacAddr, stpInfoHelloTime=stpInfoHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, stpStats=stpStats, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgIndex=stgCurCfgIndex, vlanInfoStatus=vlanInfoStatus, fdbRefSps=fdbRefSps, stgNewCfgPriority=stgNewCfgPriority, fdbSrcPort=fdbSrcPort, fdbState=fdbState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsHiwat=fdbStatsHiwat, fdbEntry=fdbEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mirroring=mirroring, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbLearnedPort=fdbLearnedPort, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortPathCost=stpInfoPortPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortState=lacpNewPortState, stpInfoRootCost=stpInfoRootCost, mstNewCfgStpMode=mstNewCfgStpMode, fdbVlan=fdbVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCfg=portTeamCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, cistRegionalPathCost=cistRegionalPathCost, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgState=portTeamCurCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Oper=layer2Oper, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoLearn=vlanInfoLearn, cistBridgeForwardDelay=cistBridgeForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsFinds=fdbStatsFinds, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoIndex=stpInfoIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgState=stgNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgState=vlanCurCfgState, stpInfoPortState=stpInfoPortState, stgStatsPortTable=stgStatsPortTable, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRootPort=cistRootPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2=layer2, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfo=cistInfo, portTeamInfoTable=portTeamInfoTable, stgCfg=stgCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoRootPort=stpInfoRootPort, lacpCurPortState=lacpCurPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Stats=layer2Stats, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgState=stgCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfo=portTeamInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoPorts=vlanInfoPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortRole=stpInfoPortRole, vlanNewCfgState=vlanNewCfgState, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgTable=portTeamNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstGeneralCfg=mstGeneralCfg, mstCurCfgState=mstCurCfgState, cistRootPathCost=cistRootPathCost, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTable=vlanInfoTable, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortTable=cistInfoPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfo=vlanInfo, fdbInfo=fdbInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortState=cistInfoPortState, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Info=layer2Info, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoState=portTeamInfoState, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCreates=fdbStatsCreates, mstCurCfgStpMode=mstCurCfgStpMode, vlan=vlan, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgTable=stgCurCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortTable=stpInfoPortTable, fdbStats=fdbStats, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfo=lacpInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCfg=mstCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkgroup=trunkgroup, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2Configs=layer2Configs, mstCistCfg=mstCistCfg, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortTable=mstCistCurCfgPortTable, BridgeId=BridgeId, cistRoot=cistRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsStpIndex=stgStatsStpIndex, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortIndex=cistInfoPortIndex, cistGeneralInfo=cistGeneralInfo, stpInfo=stpInfo, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbClear=fdbClear, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoName=vlanInfoName, cistInfoPortTableEntry=cistInfoPortTableEntry, mstNewCfgState=mstNewCfgState, stpInfoPortEdge=stpInfoPortEdge)
