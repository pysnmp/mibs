...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistDefaultCfg=mstCistDefaultCfg, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, cistInfo=cistInfo, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTable=stgCurCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortTable=lacpInfoPortTable, vlanInfoId=vlanInfoId, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbLearnedPort=fdbLearnedPort, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCfg=mstCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTable=vlanCurCfgTable, vlanInfoLearn=vlanInfoLearn, portTeamInfoPortsState=portTeamInfoPortsState, stpInfo=stpInfo, vlanInfo=vlanInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRoot=cistRoot, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfo=lacpInfo, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgState=vlanCurCfgState, stgCurCfgIndex=stgCurCfgIndex, trunkgroup=trunkgroup, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortIndex=stgStatsPortIndex, stpInfoIndex=stpInfoIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoTableEntry=vlanInfoTableEntry, layer2=layer2, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPriority=stgNewCfgPriority, fdbState=fdbState, vlanNewCfgLearn=vlanNewCfgLearn, layer2Configs=layer2Configs, fdbStatsFinds=fdbStatsFinds, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbMacAddr=fdbMacAddr, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, BridgeId=BridgeId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsLookups=fdbStatsLookups, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbInfo=fdbInfo, cistInfoPortState=cistInfoPortState, fdbEntry=fdbEntry, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortPriority=cistInfoPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbRefSps=fdbRefSps, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortState=lacpCurPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgIndex=stgNewCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortIndex=stpInfoPortIndex, vlan=vlan, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsHiwat=fdbStatsHiwat, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoStatus=vlanInfoStatus, mirroring=mirroring, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortLink=stgCurCfgPortLink, fdbClear=fdbClear, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, stpStats=stpStats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgState=stgCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCfg=portTeamCfg, stgNewCfgState=stgNewCfgState, mstNewCfgState=mstNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, cistRootPathCost=cistRootPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoName=vlanInfoName, fdbVlan=fdbVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgRegionName=mstCurCfgRegionName, cistRootPort=cistRootPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoTable=portTeamInfoTable, fdbStatsFindFails=fdbStatsFindFails, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbTable=fdbTable, lacpNewPortState=lacpNewPortState, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgState=mstCurCfgState, lacp=lacp, layer2Stats=layer2Stats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, stpInfoTable=stpInfoTable, vlanInfoTable=vlanInfoTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCfg=mstCistCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStats=fdbStats, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoState=portTeamInfoState, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, stpInfoRootPort=stpInfoRootPort, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortTable=stgStatsPortTable, stpInfoPortState=stpInfoPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfo=portTeamInfo, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCfg=stgCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgState=trunkGroupNewCfgState, PYSNMP_MODULE_ID=layer2, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, fdbSrcPort=fdbSrcPort, mstGeneralCfg=mstGeneralCfg, layer2Info=layer2Info, vlanCurCfgVlanName=vlanCurCfgVlanName, layer2Oper=layer2Oper)
