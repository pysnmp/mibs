...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgTable=vlanCurCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortLinkType=cistInfoPortLinkType, mstGeneralCfg=mstGeneralCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfo=vlanInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoTable=stpInfoTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfo=portTeamInfo, vlanNewCfgState=vlanNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgDelete=portTeamNewCfgDelete, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortNtt=lacpInfoPortNtt, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCurrent=fdbStatsCurrent, layer2Stats=layer2Stats, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbTable=fdbTable, portTeamCfg=portTeamCfg, fdbStatsFinds=fdbStatsFinds, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCfg=stgCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoIndex=stpInfoIndex, lacpNewSystemPriority=lacpNewSystemPriority, mstCurCfgState=mstCurCfgState, portTeamTableMaxSize=portTeamTableMaxSize, layer2Oper=layer2Oper, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbEntry=fdbEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbLearnedPort=fdbLearnedPort, lacpCurPortState=lacpCurPortState, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsLookups=fdbStatsLookups, vlanNewCfgDelete=vlanNewCfgDelete, mirroring=mirroring, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Info=layer2Info, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortRole=stpInfoPortRole, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortIndex=stgCurCfgPortIndex, stpStats=stpStats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCfg=mstCistCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, cistRootPort=cistRootPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbInfo=fdbInfo, fdbState=fdbState, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoJumbo=vlanInfoJumbo, vlanInfoName=vlanInfoName, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlan=vlan, vlanCurCfgState=vlanCurCfgState, cistRegionalPathCost=cistRegionalPathCost, stpInfo=stpInfo, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortLinkType=stpInfoPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkgroup=trunkgroup, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortRole=cistInfoPortRole, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbClear=fdbClear, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsHiwat=fdbStatsHiwat, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoHelloTime=stpInfoHelloTime, fdbStatsFindFails=fdbStatsFindFails, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgState=stgNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanMaxEnt=vlanMaxEnt, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRoot=cistRoot, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbRefSps=fdbRefSps, mstCfg=mstCfg, stpInfoPortState=stpInfoPortState, cistInfo=cistInfo, stpInfoPortEdge=stpInfoPortEdge, mirrPortMirr=mirrPortMirr, lacpInfoPortTable=lacpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, fdbStats=fdbStats, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfo=lacpInfo, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPriority=stgCurCfgPriority, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, BridgeId=BridgeId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortState=cistInfoPortState, vlanNewCfgTable=vlanNewCfgTable, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortTable=stgStatsPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpNewPortState=lacpNewPortState, fdbVlan=fdbVlan, layer2Configs=layer2Configs, vlanInfoId=vlanInfoId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoTable=portTeamInfoTable, lacpInfoPortSelected=lacpInfoPortSelected)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoLearn=vlanInfoLearn, layer2=layer2, portTeamInfoIndex=portTeamInfoIndex, vlanInfoTable=vlanInfoTable, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgStg=vlanNewCfgStg, lacp=lacp, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoState=portTeamInfoState, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgState=mstNewCfgState, stgCurCfgState=stgCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry)
