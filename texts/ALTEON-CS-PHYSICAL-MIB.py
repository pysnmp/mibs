...
Gauge32, Counter32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter64, IpAddress, iso, TimeTicks, Bits, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter64", "IpAddress", "iso", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgPorts=vlanCurCfgPorts, BridgeId=BridgeId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, vlanInfoTableEntry=vlanInfoTableEntry, cistRoot=cistRoot, vlanInfoBwmContract=vlanInfoBwmContract, cistRootPort=cistRootPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTable=stgNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoTableEntry=stpInfoTableEntry, stgCfg=stgCfg, lacp=lacp, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfo=vlanInfo, portTeamInfo=portTeamInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRegionalRoot=cistRegionalRoot, vlanInfoName=vlanInfoName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgState=vlanCurCfgState, stpInfoIndex=stpInfoIndex, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoRootCost=stpInfoRootCost, stpInfoPortEdge=stpInfoPortEdge, layer2Info=layer2Info, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgState=vlanNewCfgState, vlanInfoTable=vlanInfoTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortTable=stpInfoPortTable, vlanInfoId=vlanInfoId, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgTable=vlanNewCfgTable, stpInfo=stpInfo, cistGeneralInfo=cistGeneralInfo, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, lacpInfo=lacpInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsHiwat=fdbStatsHiwat, layer2Oper=layer2Oper, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbMacAddr=fdbMacAddr, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfo=cistInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpNewPortState=lacpNewPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoPorts=vlanInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Stats=layer2Stats, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCfg=mstCfg, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoTable=portTeamInfoTable, stgStatsPortIndex=stgStatsPortIndex, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbEntry=fdbEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbVlan=fdbVlan, cistInfoPortTable=cistInfoPortTable, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPriority=stgNewCfgPriority, layer2Configs=layer2Configs, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbState=fdbState, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgState=stgCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRootPathCost=cistRootPathCost, fdbSrcPort=fdbSrcPort, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbLearnedPort=fdbLearnedPort, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoState=portTeamInfoState, cistBridgeMaxAge=cistBridgeMaxAge, fdbInfo=fdbInfo, portTeamCurCfgState=portTeamCurCfgState, stgStatsStpIndex=stgStatsStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgIndex=stgNewCfgIndex, fdbTable=fdbTable, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortState=cistInfoPortState, layer2=layer2, vlan=vlan, portTeamCfg=portTeamCfg, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFindFails=fdbStatsFindFails, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurSystemPriority=lacpCurSystemPriority, fdbClear=fdbClear, mstCistCfg=mstCistCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgState=mstNewCfgState, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoTable=stpInfoTable, mstCistBridgeCfg=mstCistBridgeCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbRefSps=fdbRefSps, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgTable=vlanCurCfgTable, fdbStatsLookups=fdbStatsLookups, lacpInfoPortNtt=lacpInfoPortNtt, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortState=lacpCurPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgState=stgNewCfgState, fdbStatsCreates=fdbStatsCreates, stgStatsPortTableEntry=stgStatsPortTableEntry, stpStats=stpStats, fdbStats=fdbStats, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkgroup=trunkgroup, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mirroring=mirroring)
