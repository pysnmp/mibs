...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, mstCistCfg=mstCistCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortTable=stgStatsPortTable, fdbEntry=fdbEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbSrcTrunk=fdbSrcTrunk, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStats=fdbStats, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbRefSps=fdbRefSps, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCfg=portTeamCfg, BridgeId=BridgeId, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCfg=mstCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgState=mstCurCfgState, cistInfo=cistInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortState=cistInfoPortState, cistInfoPortRole=cistInfoPortRole, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgState=mstNewCfgState, fdbClear=fdbClear, stgNewCfgState=stgNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRoot=cistRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgStatsPortIndex=stgStatsPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsHiwat=fdbStatsHiwat, cistGeneralInfo=cistGeneralInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsLookups=fdbStatsLookups, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgRegionName=mstCurCfgRegionName, layer2Info=layer2Info, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamInfo=portTeamInfo, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, trunkgroup=trunkgroup, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Stats=layer2Stats, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbVlan=fdbVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoName=vlanInfoName, vlanMaxEnt=vlanMaxEnt, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCfg=stgCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoIndex=stpInfoIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgState=stgCurCfgState, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPriority=stgNewCfgPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Oper=layer2Oper, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgTable=stgNewCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoId=vlanInfoId, vlanInfoLearn=vlanInfoLearn, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfo=vlanInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoPorts=vlanInfoPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbTable=fdbTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortState=lacpCurPortState, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsFinds=fdbStatsFinds, stpInfoPortIndex=stpInfoPortIndex, cistRootPathCost=cistRootPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, fdbState=fdbState, lacp=lacp, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPorts=portTeamInfoPorts, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTable=portTeamInfoTable, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mirrPortMirr=mirrPortMirr, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgTable=vlanNewCfgTable, lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortRole=stpInfoPortRole, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbInfo=fdbInfo, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortState=stpInfoPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Configs=layer2Configs, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistRootPort=cistRootPort, stgNewCfgAgingTime=stgNewCfgAgingTime, vlan=vlan, mirroring=mirroring, stpInfoPortTable=stpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbMacAddr=fdbMacAddr, vlanInfoStatus=vlanInfoStatus, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgTable=stgCurCfgTable, stpInfo=stpInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbSrcPort=fdbSrcPort, portTeamCurCfgPorts=portTeamCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpStats=stpStats, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgIndex=stgNewCfgIndex, layer2=layer2, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistDefaultCfg=mstCistDefaultCfg, PYSNMP_MODULE_ID=layer2, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoState=portTeamInfoState, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoTable=vlanInfoTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTable=stpInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoIndex=portTeamInfoIndex, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgTableEntry=vlanCurCfgTableEntry)
