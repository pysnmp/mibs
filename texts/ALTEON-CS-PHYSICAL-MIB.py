...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTable=stgNewCfgPortTable, BridgeId=BridgeId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortTable=lacpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Oper=layer2Oper, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstGeneralCfg=mstGeneralCfg, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgState=stgNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, fdbStats=fdbStats, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoRootPort=stpInfoRootPort, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfo=portTeamInfo, stgCurCfgTable=stgCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsOverflows=fdbStatsOverflows, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCfg=mstCistCfg, stpInfoTable=stpInfoTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsLookupFails=fdbStatsLookupFails, fdbState=fdbState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoIndex=stpInfoIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortTableEntry=stpInfoPortTableEntry, PYSNMP_MODULE_ID=layer2, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfo=cistInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortState=cistInfoPortState, vlanCurCfgState=vlanCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortRole=cistInfoPortRole, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistGeneralInfo=cistGeneralInfo, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortTable=stpInfoPortTable, fdbStatsFinds=fdbStatsFinds, stpInfoPortStpIndex=stpInfoPortStpIndex, stpStats=stpStats, fdbTable=fdbTable, mstCurCfgState=mstCurCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfo=lacpInfo, trunkgroup=trunkgroup, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mirrPortMirr=mirrPortMirr, fdbRefSps=fdbRefSps, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, mstCistBridgeCfg=mstCistBridgeCfg, cistRootPort=cistRootPort, mirroring=mirroring, portTeamInfoPorts=portTeamInfoPorts, stpInfoForwardDelay=stpInfoForwardDelay, cistRoot=cistRoot, layer2Configs=layer2Configs, vlanMaxEnt=vlanMaxEnt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgVlanName=vlanCurCfgVlanName, vlan=vlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfo=vlanInfo, fdbStatsCreates=fdbStatsCreates, lacpCurPortState=lacpCurPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgRegionName=mstCurCfgRegionName, layer2Info=layer2Info, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoId=vlanInfoId, cistRootPathCost=cistRootPathCost, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoJumbo=vlanInfoJumbo, vlanInfoLearn=vlanInfoLearn, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2=layer2, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Stats=layer2Stats, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbClear=fdbClear, fdbEntry=fdbEntry, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgTable=vlanCurCfgTable, mstCfg=mstCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, lacp=lacp, stpInfoHoldTime=stpInfoHoldTime, vlanMaxVlanID=vlanMaxVlanID, vlanInfoPorts=vlanInfoPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFindFails=fdbStatsFindFails, fdbStatsDeletes=fdbStatsDeletes, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPriority=stgCurCfgPriority, fdbVlan=fdbVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbInfo=fdbInfo, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgState=stgCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortRole=stpInfoPortRole, stpInfoHelloTime=stpInfoHelloTime, vlanInfoName=vlanInfoName, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRegionalRoot=cistRegionalRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCfg=portTeamCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCfg=stgCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbSrcPort=fdbSrcPort, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortTable=stgStatsPortTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortState=stpInfoPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfo=stpInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbMacAddr=fdbMacAddr, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks)
