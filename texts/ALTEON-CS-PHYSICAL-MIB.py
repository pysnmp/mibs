...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortTable=cistInfoPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, vlanInfoStatus=vlanInfoStatus, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTable=stpInfoTable, vlanNewCfgLearn=vlanNewCfgLearn, stpInfo=stpInfo, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbMacAddr=fdbMacAddr, stgNewCfgPriority=stgNewCfgPriority, fdbStatsCurrent=fdbStatsCurrent, mirroring=mirroring, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbSrcTrunk=fdbSrcTrunk, mstCfg=mstCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbState=fdbState, stpInfoPortEdge=stpInfoPortEdge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2Oper=layer2Oper, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsHiwat=fdbStatsHiwat, fdbInfo=fdbInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgState=mstNewCfgState, trunkgroup=trunkgroup, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoId=vlanInfoId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoTable=vlanInfoTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, lacp=lacp, portTeamInfoIndex=portTeamInfoIndex, BridgeId=BridgeId, vlanMaxEnt=vlanMaxEnt, vlanInfoLearn=vlanInfoLearn, PYSNMP_MODULE_ID=layer2, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPorts=portTeamInfoPorts, fdbTable=fdbTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCfg=portTeamCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortIndex=lacpInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, cistInfo=cistInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfo=lacpInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsDeletes=fdbStatsDeletes, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbClear=fdbClear, fdbVlan=fdbVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewPortState=lacpNewPortState, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfo=vlanInfo, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortTable=stgStatsPortTable, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortTableEntry=cistInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTopChanges=stpInfoTopChanges, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortTable=stpInfoPortTable, stpStats=stpStats, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlan=vlan, mstCistCfg=mstCistCfg, stgNewCfgTable=stgNewCfgTable, fdbRefSps=fdbRefSps, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgState=vlanCurCfgState, mstGeneralCfg=mstGeneralCfg, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgIndex=stgNewCfgIndex, layer2Stats=layer2Stats, stgNewCfgPortState=stgNewCfgPortState, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoName=vlanInfoName, stgCfg=stgCfg, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgPorts=vlanCurCfgPorts, layer2Info=layer2Info, portTeamInfo=portTeamInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortState=stpInfoPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbSrcPort=fdbSrcPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCurCfgState=mstCurCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoIndex=stpInfoIndex, portTeamInfoTable=portTeamInfoTable, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoRootPort=stpInfoRootPort, layer2=layer2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortState=lacpCurPortState, fdbStatsCreates=fdbStatsCreates, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortIndex=cistInfoPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoJumbo=vlanInfoJumbo, fdbStatsOverflows=fdbStatsOverflows, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistGeneralInfo=cistGeneralInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPriority=stgCurCfgPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgState=stgNewCfgState, fdbEntry=fdbEntry, cistRegionalPathCost=cistRegionalPathCost, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoRootCost=stpInfoRootCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStats=fdbStats, cistRoot=cistRoot, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgState=portTeamNewCfgState, stpInfoForwardDelay=stpInfoForwardDelay, layer2Configs=layer2Configs, fdbStatsLookups=fdbStatsLookups, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, cistRootPort=cistRootPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortState=cistInfoPortState)
