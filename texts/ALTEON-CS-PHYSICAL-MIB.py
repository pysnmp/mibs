...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortTable=stgStatsPortTable, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgTable=vlanNewCfgTable, trunkgroup=trunkgroup, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgState=mstCurCfgState, cistInfoPortState=cistInfoPortState, stgNewCfgPriority=stgNewCfgPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRoot=cistRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, layer2Configs=layer2Configs, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortRole=stpInfoPortRole, cistRootPathCost=cistRootPathCost, fdbSrcPort=fdbSrcPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbRefSps=fdbRefSps, lacpInfo=lacpInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, fdbTable=fdbTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, layer2Stats=layer2Stats, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoName=vlanInfoName, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgStg=vlanCurCfgStg, mirrPortMirr=mirrPortMirr, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgLearn=vlanCurCfgLearn, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbMacAddr=fdbMacAddr, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoId=vlanInfoId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortTable=stpInfoPortTable, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, BridgeId=BridgeId, stgStatsStpIndex=stgStatsStpIndex, vlanInfoPorts=vlanInfoPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, PYSNMP_MODULE_ID=layer2, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, fdbInfo=fdbInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanMaxVlanID=vlanMaxVlanID, cistRegionalRoot=cistRegionalRoot, mstCfg=mstCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfo=portTeamInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortState=lacpNewPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgState=vlanNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbEntry=fdbEntry, fdbStats=fdbStats, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfo=vlanInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgState=mstNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, stpInfo=stpInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgTable=stgCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortTable=cistInfoPortTable, fdbState=fdbState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, mstCistCfg=mstCistCfg, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortRole=cistInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoRootPort=stpInfoRootPort, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPort=cistRootPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbLearnedPort=fdbLearnedPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoTable=vlanInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortState=stpInfoPortState, mirroring=mirroring, fdbSrcTrunk=fdbSrcTrunk, vlan=vlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoStatus=vlanInfoStatus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistGeneralInfo=cistGeneralInfo, cistInfo=cistInfo, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTable=portTeamInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, layer2=layer2, lacpCurPortState=lacpCurPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoMaxAge=stpInfoMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoState=portTeamInfoState, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Oper=layer2Oper, stgCfg=stgCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsCreates=fdbStatsCreates, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, fdbStatsDeletes=fdbStatsDeletes, stpStats=stpStats, fdbStatsFindFails=fdbStatsFindFails, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTable=stpInfoTable, fdbVlan=fdbVlan, layer2Info=layer2Info, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacp=lacp, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgState=vlanCurCfgState, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState)
