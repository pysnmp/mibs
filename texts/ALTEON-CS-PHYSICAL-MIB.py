...
TimeTicks, NotificationType, Integer32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter64, Gauge32, ObjectIdentity, ModuleIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCfg=mstCistCfg, fdbState=fdbState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfo=portTeamInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgTable=stgNewCfgTable, cistInfo=cistInfo, cistRoot=cistRoot, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgState=stgNewCfgState, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortRole=stpInfoPortRole, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanInfoId=vlanInfoId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Info=layer2Info, vlan=vlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCfg=stgCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTable=vlanInfoTable, mstCfg=mstCfg, fdbInfo=fdbInfo, vlanInfoTableEntry=vlanInfoTableEntry, mirroring=mirroring, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCfg=portTeamCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgTableEntry=stgNewCfgTableEntry, lacp=lacp, lacpCurPortState=lacpCurPortState, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoTable=stpInfoTable, stpInfoPortTable=stpInfoPortTable, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRegionalPathCost=cistRegionalPathCost, fdbClear=fdbClear, lacpNewPortState=lacpNewPortState, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbEntry=fdbEntry, stgNewCfgIndex=stgNewCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistDefaultCfg=mstCistDefaultCfg, fdbTable=fdbTable, fdbRefSps=fdbRefSps, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortIndex=cistInfoPortIndex, vlanInfoName=vlanInfoName, vlanCurCfgState=vlanCurCfgState, fdbStatsCreates=fdbStatsCreates, lacpInfo=lacpInfo, mstNewCfgState=mstNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbSrcPort=fdbSrcPort, BridgeId=BridgeId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsFinds=fdbStatsFinds, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortState=cistInfoPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkgroup=trunkgroup, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgState=mstCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbLearnedPort=fdbLearnedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortState=stpInfoPortState, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstGeneralCfg=mstGeneralCfg, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCurCfgTable=portTeamCurCfgTable, PYSNMP_MODULE_ID=layer2, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, layer2Configs=layer2Configs, cistInfoPortRole=cistInfoPortRole, vlanInfoStatus=vlanInfoStatus, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, vlanInfo=vlanInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTable=portTeamInfoTable, fdbStatsFindFails=fdbStatsFindFails, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbVlan=fdbVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgStpMode=mstNewCfgStpMode, stpInfo=stpInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfoPortTable=lacpInfoPortTable, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRootPort=cistRootPort, stgNewCfgAgingTime=stgNewCfgAgingTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Oper=layer2Oper)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Stats=layer2Stats, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, layer2=layer2, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortIndex=stpInfoPortIndex, fdbStats=fdbStats, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRootPathCost=cistRootPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoState=portTeamInfoState, stpInfoPortPathCost=stpInfoPortPathCost, stpStats=stpStats, vlanInfoLearn=vlanInfoLearn, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgState=stgCurCfgState, cistGeneralInfo=cistGeneralInfo, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoRootCost=stpInfoRootCost, mirrPortMirr=mirrPortMirr, stgCurCfgPortPriority=stgCurCfgPortPriority)
