...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTable=stpInfoTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortTable=lacpInfoPortTable, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoTable=portTeamInfoTable, fdbMacAddr=fdbMacAddr, cistRootPort=cistRootPort, vlanInfoId=vlanInfoId, stgCurCfgPriority=stgCurCfgPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsFindFails=fdbStatsFindFails, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbLearnedPort=fdbLearnedPort, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgAddVlan=stgNewCfgAddVlan, cistRegionalRoot=cistRegionalRoot, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgState=mstCurCfgState, stpInfo=stpInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacp=lacp, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgLearn=vlanNewCfgLearn, layer2Configs=layer2Configs, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfo=lacpInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortPriority=cistInfoPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfo=cistInfo, vlanNewCfgDelete=vlanNewCfgDelete, cistRoot=cistRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistRootPathCost=cistRootPathCost, stgCurCfgState=stgCurCfgState, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoPorts=vlanInfoPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgLearn=vlanCurCfgLearn, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCfg=mstCfg, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkgroup=trunkgroup, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbInfo=fdbInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortTable=cistInfoPortTable, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstNewCfgState=mstNewCfgState, stgCurCfgIndex=stgCurCfgIndex, fdbSrcPort=fdbSrcPort, vlan=vlan, stgCurCfgTable=stgCurCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStats=fdbStats, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCfg=stgCfg, fdbStatsCreates=fdbStatsCreates, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbClear=fdbClear, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgState=stgNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, BridgeId=BridgeId, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortState=stpInfoPortState, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoLearn=vlanInfoLearn, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortRole=cistInfoPortRole, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, vlanInfoName=vlanInfoName, fdbTable=fdbTable, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsFinds=fdbStatsFinds, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgTable=vlanCurCfgTable, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbRefSps=fdbRefSps, vlanInfoStatus=vlanInfoStatus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsStpIndex=stgStatsStpIndex, layer2=layer2, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoHoldTime=stpInfoHoldTime, portTeamInfo=portTeamInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortRole=stpInfoPortRole, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortState=cistInfoPortState, mirrPortMirr=mirrPortMirr, vlanInfo=vlanInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortState=lacpNewPortState, layer2Info=layer2Info, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoJumbo=vlanInfoJumbo, layer2Stats=layer2Stats, cistGeneralInfo=cistGeneralInfo, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbState=fdbState, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoTable=vlanInfoTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, PYSNMP_MODULE_ID=layer2, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurSystemPriority=lacpCurSystemPriority, layer2Oper=layer2Oper, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCfg=portTeamCfg, stpStats=stpStats, vlanInfoTableEntry=vlanInfoTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, fdbEntry=fdbEntry, stpInfoRootPort=stpInfoRootPort, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanMaxEnt=vlanMaxEnt, fdbVlan=fdbVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract)
