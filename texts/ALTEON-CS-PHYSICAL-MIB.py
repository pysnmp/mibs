...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgState=mstNewCfgState, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgTable=stgNewCfgTable, mstCurCfgState=mstCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, fdbStats=fdbStats, mstCistCfg=mstCistCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoHelloTime=stpInfoHelloTime, fdbStatsCreates=fdbStatsCreates, vlanCurCfgLearn=vlanCurCfgLearn, fdbRefSps=fdbRefSps, portTeamCfg=portTeamCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoState=portTeamInfoState, cistRegionalRoot=cistRegionalRoot, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortRole=stpInfoPortRole, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2Info=layer2Info, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, cistRoot=cistRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoId=vlanInfoId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgState=vlanCurCfgState, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfo=vlanInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgState=stgCurCfgState, cistRootPathCost=cistRootPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTable=cistInfoPortTable, stpInfoPortState=stpInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTable=portTeamCurCfgTable, vlanMaxEnt=vlanMaxEnt, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stpStats=stpStats, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoTable=vlanInfoTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoMaxAge=stpInfoMaxAge, vlanInfoName=vlanInfoName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsFindFails=fdbStatsFindFails, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, lacp=lacp, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortTable=stgStatsPortTable, BridgeId=BridgeId, stgCurCfgTable=stgCurCfgTable, portTeamInfo=portTeamInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbEntry=fdbEntry, mstGeneralCfg=mstGeneralCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCurCfgState=portTeamCurCfgState, stpInfoHoldTime=stpInfoHoldTime, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfo=cistInfo, fdbStatsFinds=fdbStatsFinds, mstCfg=mstCfg, mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfo=lacpInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoRootPort=stpInfoRootPort, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2Oper=layer2Oper, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, layer2Stats=layer2Stats, vlan=vlan, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, layer2=layer2, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbMacAddr=fdbMacAddr, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, vlanInfoStatus=vlanInfoStatus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfo=stpInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPriority=stgCurCfgPriority, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, cistBridgeMaxAge=cistBridgeMaxAge, PYSNMP_MODULE_ID=layer2, stpInfoPortTable=stpInfoPortTable, fdbLearnedPort=fdbLearnedPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistRootPort=cistRootPort, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistGeneralInfo=cistGeneralInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoPortsState=portTeamInfoPortsState, fdbTable=fdbTable, stgNewCfgState=stgNewCfgState, stgCfg=stgCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortState=lacpNewPortState, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoTable=stpInfoTable, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgState=portTeamNewCfgState, stpInfoTopChanges=stpInfoTopChanges, fdbInfo=fdbInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortPriority=cistInfoPortPriority, vlanInfoPorts=vlanInfoPorts, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsDeletes=fdbStatsDeletes, mirrPortMirr=mirrPortMirr, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkgroup=trunkgroup, vlanMaxVlanID=vlanMaxVlanID)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoIndex=stpInfoIndex, stpInfoRootCost=stpInfoRootCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortState=cistInfoPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbVlan=fdbVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbState=fdbState, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbClear=fdbClear, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoPorts=portTeamInfoPorts, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoTrunks=portTeamInfoTrunks)
