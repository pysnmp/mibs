...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsFinds=fdbStatsFinds, fdbEntry=fdbEntry, mstNewCfgState=mstNewCfgState, lacp=lacp, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfo=cistInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoPorts=vlanInfoPorts, lacpNewPortState=lacpNewPortState, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortIndex=stgStatsPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgLearn=vlanCurCfgLearn, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRootPathCost=cistRootPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, BridgeId=BridgeId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortState=lacpCurPortState, fdbVlan=fdbVlan, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortState=stpInfoPortState, layer2Info=layer2Info, cistRootPort=cistRootPort, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoState=portTeamInfoState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortRole=stpInfoPortRole, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgIndex=stgNewCfgIndex, trunkgroup=trunkgroup, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgTable=stgNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, mirroring=mirroring, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgState=vlanCurCfgState, fdbInfo=fdbInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Stats=layer2Stats, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, PYSNMP_MODULE_ID=layer2, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCfg=mstCistCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoTable=vlanInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoTableEntry=vlanInfoTableEntry, fdbRefSps=fdbRefSps, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCreates=fdbStatsCreates, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfo=lacpInfo, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbLearnedPort=fdbLearnedPort, stgCurCfgTable=stgCurCfgTable, stpInfoTable=stpInfoTable, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortTable=cistInfoPortTable, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsOverflows=fdbStatsOverflows, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCfg=stgCfg, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, layer2=layer2, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbTable=fdbTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Configs=layer2Configs, stpInfo=stpInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mirrPortMirr=mirrPortMirr, portTeamCfg=portTeamCfg, vlan=vlan, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortState=cistInfoPortState, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbMacAddr=fdbMacAddr, mstCurCfgState=mstCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoStatus=vlanInfoStatus, vlanNewCfgState=vlanNewCfgState, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoId=vlanInfoId, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPriority=stgCurCfgPriority, portTeamInfo=portTeamInfo, fdbClear=fdbClear, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistRoot=cistRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Oper=layer2Oper, stpStats=stpStats, cistGeneralInfo=cistGeneralInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbState=fdbState, stpInfoIndex=stpInfoIndex, vlanInfoName=vlanInfoName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStats=fdbStats, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgState=stgNewCfgState, vlanInfoLearn=vlanInfoLearn, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortTable=stgStatsPortTable, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoTable=portTeamInfoTable, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgStg=vlanCurCfgStg, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPathCost=cistInfoPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, stpInfoTopChanges=stpInfoTopChanges, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCfg=mstCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, vlanInfo=vlanInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable)
