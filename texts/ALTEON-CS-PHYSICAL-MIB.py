...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsFinds=fdbStatsFinds, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Oper=layer2Oper, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortState=cistInfoPortState, fdbTable=fdbTable, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoName=vlanInfoName, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfo=cistInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCfg=stgCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpStats=stpStats, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortState=lacpNewPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, cistRegionalRoot=cistRegionalRoot, layer2Configs=layer2Configs, mstCfg=mstCfg, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRegionalPathCost=cistRegionalPathCost, layer2=layer2, cistRoot=cistRoot, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, BridgeId=BridgeId, vlanInfo=vlanInfo, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoTable=portTeamInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfo=portTeamInfo, lacp=lacp, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgPorts=portTeamNewCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgAddVlan=stgNewCfgAddVlan, PYSNMP_MODULE_ID=layer2, vlanInfoId=vlanInfoId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoPorts=vlanInfoPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbClear=fdbClear, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgTable=stgCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoRootPort=stpInfoRootPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbLearnedPort=fdbLearnedPort, lacpInfo=lacpInfo, lacpCurPortState=lacpCurPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoStatus=vlanInfoStatus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortTable=stgStatsPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortRole=stpInfoPortRole, vlanInfoLearn=vlanInfoLearn, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgIndex=stgCurCfgIndex, fdbInfo=fdbInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortRole=cistInfoPortRole, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfoState=portTeamInfoState, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkgroup=trunkgroup, mirrPortMirr=mirrPortMirr, stpInfo=stpInfo, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbState=fdbState, fdbStats=fdbStats, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortTable=stpInfoPortTable, stpInfoPortState=stpInfoPortState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstGeneralCfg=mstGeneralCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRootPort=cistRootPort, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoIndex=stpInfoIndex, layer2Stats=layer2Stats, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbVlan=fdbVlan, vlanCurCfgTable=vlanCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, fdbStatsDeletes=fdbStatsDeletes, fdbEntry=fdbEntry, lacpInfoPortNtt=lacpInfoPortNtt, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlan=vlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgIndex=stgNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgState=stgNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRootPathCost=cistRootPathCost, portTeamCfg=portTeamCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbRefSps=fdbRefSps, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirroring=mirroring, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgTable=stgNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Info=layer2Info, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoTable=vlanInfoTable, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgState=mstNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTable=stpInfoTable, stgCurCfgState=stgCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgState=portTeamCurCfgState, fdbStatsCreates=fdbStatsCreates, fdbStatsLookups=fdbStatsLookups, lacpInfoPortTable=lacpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, stpInfoHelloTime=stpInfoHelloTime, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgState=vlanNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortMoved=lacpInfoPortMoved, fdbSrcPort=fdbSrcPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, cistGeneralInfo=cistGeneralInfo, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion)
