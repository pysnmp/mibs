...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortTable=stgStatsPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Configs=layer2Configs, portTeamCfg=portTeamCfg, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgTable=vlanNewCfgTable, layer2Stats=layer2Stats, cistRegionalPathCost=cistRegionalPathCost, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpStats=stpStats, layer2=layer2, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCfg=stgCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortTable=cistInfoPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRootPathCost=cistRootPathCost, fdbStatsFindFails=fdbStatsFindFails, fdbEntry=fdbEntry, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgTable=vlanCurCfgTable, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbVlan=fdbVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbRefSps=fdbRefSps, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanMaxEnt=vlanMaxEnt, vlanInfo=vlanInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTable=stpInfoTable, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoStatus=vlanInfoStatus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoRootCost=stpInfoRootCost, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortIndex=stpInfoPortIndex, mstCfg=mstCfg, cistGeneralInfo=cistGeneralInfo, lacpNewPortState=lacpNewPortState, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFinds=fdbStatsFinds, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbLearnedPort=fdbLearnedPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortState=stpInfoPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgTable=stgCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstGeneralCfg=mstGeneralCfg, lacpInfo=lacpInfo, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgState=mstNewCfgState, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRoot=cistRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoId=vlanInfoId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsLookups=fdbStatsLookups, stgNewCfgIndex=stgNewCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsCreates=fdbStatsCreates, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoTable=vlanInfoTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortRole=cistInfoPortRole, stpInfoMaxAge=stpInfoMaxAge, layer2Oper=layer2Oper, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, PYSNMP_MODULE_ID=layer2, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootPort=stpInfoRootPort, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbTable=fdbTable, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurPortState=lacpCurPortState, cistInfo=cistInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoState=portTeamInfoState, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStats=fdbStats, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortRole=stpInfoPortRole, layer2Info=layer2Info, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanMaxVlanID=vlanMaxVlanID, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortTable=stgCurCfgPortTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTopChanges=stpInfoTopChanges, BridgeId=BridgeId, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbSrcPort=fdbSrcPort, vlanCurCfgState=vlanCurCfgState, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbState=fdbState, stgNewCfgTable=stgNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgState=stgCurCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCurCfgState=mstCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfo=stpInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoIndex=stpInfoIndex, stpInfoHoldTime=stpInfoHoldTime, lacp=lacp, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoTable=portTeamInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbInfo=fdbInfo, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, fdbMacAddr=fdbMacAddr, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbClear=fdbClear, cistRegionalRoot=cistRegionalRoot, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mirroring=mirroring, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgTableEntry=stgNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlan=vlan, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoName=vlanInfoName, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistRootPort=cistRootPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCfg=mstCistCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortState=cistInfoPortState, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgPorts=vlanNewCfgPorts, trunkgroup=trunkgroup, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState)
