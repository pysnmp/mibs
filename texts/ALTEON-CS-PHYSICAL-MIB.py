...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, TimeTicks, Unsigned32, NotificationType, Gauge32, IpAddress, Integer32, ObjectIdentity, Counter64, iso, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "TimeTicks", "Unsigned32", "NotificationType", "Gauge32", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "iso", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, layer2Info=layer2Info, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortLink=stgNewCfgPortLink, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2=layer2, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortTable=stpInfoPortTable, stpStats=stpStats, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirroring=mirroring, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgState=mstNewCfgState, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortState=stpInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoState=portTeamInfoState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortTable=cistInfoPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, BridgeId=BridgeId, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCurCfgState=mstCurCfgState, fdbStatsCurrent=fdbStatsCurrent, lacp=lacp, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, layer2Oper=layer2Oper, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoPorts=portTeamInfoPorts, cistRootPort=cistRootPort, stpInfoRootCost=stpInfoRootCost, vlanInfoJumbo=vlanInfoJumbo, fdbClear=fdbClear, vlanCurCfgState=vlanCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbTable=fdbTable, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, PYSNMP_MODULE_ID=layer2, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfo=vlanInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgIndex=stgCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgState=stgNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbRefSps=fdbRefSps, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, mstCistCfg=mstCistCfg, portTeamInfo=portTeamInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, fdbStatsLookups=fdbStatsLookups, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortState=lacpNewPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoTable=vlanInfoTable, stgNewCfgPortState=stgNewCfgPortState, fdbMacAddr=fdbMacAddr, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsFindFails=fdbStatsFindFails, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanName=vlanCurCfgVlanName, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgStg=vlanCurCfgStg, lacpInfoPortSelected=lacpInfoPortSelected, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgState=vlanNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoRootPort=stpInfoRootPort, fdbStatsOverflows=fdbStatsOverflows, lacpInfo=lacpInfo, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCfg=mstCfg, fdbState=fdbState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkgroup=trunkgroup, vlanNewCfgLearn=vlanNewCfgLearn, layer2Stats=layer2Stats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbVlan=fdbVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortState=lacpCurPortState, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfo=cistInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgLearn=vlanCurCfgLearn, cistRegionalRoot=cistRegionalRoot, cistInfoPortState=cistInfoPortState, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfo=stpInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPriority=stgCurCfgPriority, stpInfoTopChanges=stpInfoTopChanges, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRoot=cistRoot, fdbStatsCreates=fdbStatsCreates, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStats=fdbStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoId=vlanInfoId, stgStatsPortTable=stgStatsPortTable, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCfg=portTeamCfg, stgCurCfgState=stgCurCfgState, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortIndex=stpInfoPortIndex, fdbSrcPort=fdbSrcPort, vlanInfoName=vlanInfoName, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbInfo=fdbInfo, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortEdge=stpInfoPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistGeneralInfo=cistGeneralInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, layer2Configs=layer2Configs, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, vlan=vlan, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTable=stgCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbLearnedPort=fdbLearnedPort, vlanInfoPorts=vlanInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRootPathCost=cistRootPathCost, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortState=stgCurCfgPortState, fdbEntry=fdbEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFinds=fdbStatsFinds, vlanNewCfgTable=vlanNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfoPortRole=cistInfoPortRole, stgCfg=stgCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
