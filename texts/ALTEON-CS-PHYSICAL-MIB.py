...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoBwmContract=vlanInfoBwmContract, mstCfg=mstCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, stpStats=stpStats, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, mstCistCfg=mstCistCfg, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStats=fdbStats, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacp=lacp, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbVlan=fdbVlan, fdbEntry=fdbEntry, stgCurCfgState=stgCurCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkgroup=trunkgroup, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Configs=layer2Configs, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, BridgeId=BridgeId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistGeneralInfo=cistGeneralInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortCfgTable=lacpCurPortCfgTable, cistRootPort=cistRootPort, layer2Oper=layer2Oper, vlanInfoTable=vlanInfoTable, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbTable=fdbTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2Stats=layer2Stats, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoJumbo=vlanInfoJumbo, vlanInfoPorts=vlanInfoPorts, stpInfoPortRole=stpInfoPortRole, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoState=portTeamInfoState, stpInfoRootPort=stpInfoRootPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortState=cistInfoPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2=layer2, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgState=vlanNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfo=portTeamInfo, fdbStatsLookups=fdbStatsLookups, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgState=vlanCurCfgState, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, fdbMacAddr=fdbMacAddr, vlanNewCfgTable=vlanNewCfgTable, vlanInfoId=vlanInfoId, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mirrPortMirr=mirrPortMirr, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfo=lacpInfo, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPriority=stgCurCfgPriority, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortLink=stgCurCfgPortLink, cistBridgeHelloTime=cistBridgeHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, stpInfoIndex=stpInfoIndex, fdbState=fdbState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoHoldTime=stpInfoHoldTime, stpInfoMaxAge=stpInfoMaxAge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootCost=stpInfoRootCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbRefSps=fdbRefSps, mstCurCfgState=mstCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortState=stpInfoPortState, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoHelloTime=stpInfoHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortIndex=stpInfoPortIndex, vlanInfoName=vlanInfoName, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfo=stpInfo, stgNewCfgPortLink=stgNewCfgPortLink, mirroring=mirroring, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, fdbClear=fdbClear, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoPorts=portTeamInfoPorts, vlanInfo=vlanInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbInfo=fdbInfo, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlan=vlan, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortRole=cistInfoPortRole, cistRootPathCost=cistRootPathCost, stgCfg=stgCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsStpIndex=stgStatsStpIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRoot=cistRoot, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstGeneralCfg=mstGeneralCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortState=lacpCurPortState, fdbStatsCreates=fdbStatsCreates, mstCurCfgRegionName=mstCurCfgRegionName, cistRegionalRoot=cistRegionalRoot, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCfg=portTeamCfg, layer2Info=layer2Info, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFinds=fdbStatsFinds, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfoLearn=vlanInfoLearn, fdbSrcPort=fdbSrcPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortTable=cistInfoPortTable, cistInfo=cistInfo, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortState=lacpNewPortState, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost)
