...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbClear=fdbClear, stpInfoPortState=stpInfoPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfo=portTeamInfo, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoTable=stpInfoTable, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanMaxVlanID=vlanMaxVlanID, layer2Oper=layer2Oper, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCurCfgState=mstCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, BridgeId=BridgeId, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoRootCost=stpInfoRootCost, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Stats=layer2Stats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgState=vlanNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mirroring=mirroring, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlan=vlan, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTable=portTeamInfoTable, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, layer2=layer2, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsHiwat=fdbStatsHiwat, vlanInfoName=vlanInfoName, cistInfoPortIndex=cistInfoPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbRefSps=fdbRefSps, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortState=cistInfoPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkgroup=trunkgroup, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacp=lacp, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanInfoLearn=vlanInfoLearn, vlanCurCfgLearn=vlanCurCfgLearn, stgCfg=stgCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbTable=fdbTable, fdbInfo=fdbInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, cistRootPathCost=cistRootPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistGeneralInfo=cistGeneralInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRootPort=cistRootPort, stpInfoPortRole=stpInfoPortRole, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbEntry=fdbEntry, stpInfoPortIndex=stpInfoPortIndex, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfo=lacpInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCfg=portTeamCfg, stgCurCfgPortState=stgCurCfgPortState, vlanInfoTable=vlanInfoTable, vlanInfoId=vlanInfoId, mstGeneralCfg=mstGeneralCfg, portTeamInfoState=portTeamInfoState, PYSNMP_MODULE_ID=layer2, fdbState=fdbState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgState=portTeamNewCfgState, mstCistCfg=mstCistCfg, vlanInfo=vlanInfo, stpStats=stpStats, fdbLearnedPort=fdbLearnedPort, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeHelloTime=cistBridgeHelloTime, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanMaxEnt=vlanMaxEnt, stpInfoIndex=stpInfoIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpNewPortState=lacpNewPortState, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsLookups=fdbStatsLookups, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrPortMirr=mirrPortMirr, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgState=stgNewCfgState, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsFinds=fdbStatsFinds, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortEdge=stpInfoPortEdge, lacpNewSystemPriority=lacpNewSystemPriority, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoIndex=portTeamInfoIndex, cistRoot=cistRoot, cistInfoPortTable=cistInfoPortTable, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbSrcPort=fdbSrcPort, vlanCurCfgState=vlanCurCfgState, fdbMacAddr=fdbMacAddr, stgCurCfgState=stgCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, layer2Info=layer2Info, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStats=fdbStats, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortState=lacpCurPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoStatus=vlanInfoStatus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2Configs=layer2Configs, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCfg=mstCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfo=cistInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsCreates=fdbStatsCreates, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfo=stpInfo, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbVlan=fdbVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTable=stgCurCfgTable, cistBridgeMaxAge=cistBridgeMaxAge)
