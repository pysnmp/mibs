...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCfg=stgCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbMacAddr=fdbMacAddr, fdbLearnedPort=fdbLearnedPort, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, fdbStatsCreates=fdbStatsCreates, mstCistCfg=mstCistCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewSystemPriority=lacpNewSystemPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfo=stpInfo, stpInfoRootCost=stpInfoRootCost, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRoot=cistRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, mirroring=mirroring, fdbStatsFindFails=fdbStatsFindFails, mstGeneralCfg=mstGeneralCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortTable=cistInfoPortTable, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2Stats=layer2Stats, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfo=cistInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortEdge=stpInfoPortEdge, fdbStatsOverflows=fdbStatsOverflows, lacpCurPortState=lacpCurPortState, layer2=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgState=vlanNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkgroup=trunkgroup, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mirrPortMirr=mirrPortMirr, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbStats=fdbStats, mstCfg=mstCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortLinkType=stpInfoPortLinkType, cistGeneralInfo=cistGeneralInfo, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoTable=stpInfoTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfo=vlanInfo, vlanInfoLearn=vlanInfoLearn, fdbTable=fdbTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortRole=stpInfoPortRole, fdbState=fdbState, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgLearn=vlanCurCfgLearn, cistRegionalRoot=cistRegionalRoot, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortTable=stgStatsPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortRole=cistInfoPortRole, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsLookups=fdbStatsLookups, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoRootPort=stpInfoRootPort, vlanInfoName=vlanInfoName, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCfg=portTeamCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, lacpInfo=lacpInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgState=mstNewCfgState, vlanInfoId=vlanInfoId, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgState=vlanCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoState=portTeamInfoState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsCurrent=fdbStatsCurrent, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgState=mstCurCfgState, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, fdbSrcPort=fdbSrcPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortState=cistInfoPortState, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoTable=vlanInfoTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlan=vlan, stgCurCfgState=stgCurCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbVlan=fdbVlan, stpInfoIndex=stpInfoIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortPriority=cistInfoPortPriority, fdbEntry=fdbEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpStats=stpStats, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortIndex=lacpInfoPortIndex, layer2Oper=layer2Oper, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, PYSNMP_MODULE_ID=layer2, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Info=layer2Info, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgState=trunkGroupCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRootPort=cistRootPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, BridgeId=BridgeId, vlanCurCfgStg=vlanCurCfgStg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacp=lacp, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfo=portTeamInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbClear=fdbClear, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortNtt=lacpInfoPortNtt, fdbInfo=fdbInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgState=portTeamCurCfgState, vlanInfoJumbo=vlanInfoJumbo, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortState=lacpNewPortState, portTeamNewCfgState=portTeamNewCfgState, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortState=stpInfoPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbRefSps=fdbRefSps, mstCurCfgRegionName=mstCurCfgRegionName)
