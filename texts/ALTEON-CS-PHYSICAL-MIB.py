...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsOverflows=fdbStatsOverflows, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoName=vlanInfoName, cistRootPort=cistRootPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpStats=stpStats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCfg=stgCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbEntry=fdbEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortState=stpInfoPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfoPortSelected=lacpInfoPortSelected, BridgeId=BridgeId, layer2Oper=layer2Oper, cistInfoPortState=cistInfoPortState, mstGeneralCfg=mstGeneralCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoIndex=stpInfoIndex, vlanInfoPorts=vlanInfoPorts, fdbVlan=fdbVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCfg=portTeamCfg, layer2Stats=layer2Stats, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, fdbTable=fdbTable, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCreates=fdbStatsCreates, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortTable=stgStatsPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStats=fdbStats, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbClear=fdbClear, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistRoot=cistRoot, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTable=portTeamInfoTable, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoState=portTeamInfoState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbMacAddr=fdbMacAddr, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbSrcPort=fdbSrcPort, fdbState=fdbState, stpInfoMaxAge=stpInfoMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoIndex=portTeamInfoIndex, layer2=layer2, mirrPortMirr=mirrPortMirr, cistInfo=cistInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCfg=mstCfg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortTable=cistInfoPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfo=vlanInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, vlanInfoId=vlanInfoId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoLearn=vlanInfoLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mirroring=mirroring, stpInfoPortRole=stpInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, stpInfoTable=stpInfoTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortTable=stpInfoPortTable, fdbInfo=fdbInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortRole=cistInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTable=lacpCurPortCfgTable, vlan=vlan, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoTopChanges=stpInfoTopChanges, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRegionalRoot=cistRegionalRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewSystemPriority=lacpNewSystemPriority, layer2Configs=layer2Configs, layer2Info=layer2Info, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsLookups=fdbStatsLookups, lacpInfoPortTable=lacpInfoPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortTable=stgNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgTable=stgNewCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfo=lacpInfo, stpInfoRootCost=stpInfoRootCost, cistGeneralInfo=cistGeneralInfo, stpInfo=stpInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistRootPathCost=cistRootPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgState=stgCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoTable=vlanInfoTable, trunkgroup=trunkgroup, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoRootPort=stpInfoRootPort, fdbRefSps=fdbRefSps, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTable=portTeamNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoPorts=portTeamInfoPorts, lacp=lacp, mstCurCfgState=mstCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsFinds=fdbStatsFinds, stgCurCfgIndex=stgCurCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfo=portTeamInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstNewCfgRegionName=mstNewCfgRegionName, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn)
