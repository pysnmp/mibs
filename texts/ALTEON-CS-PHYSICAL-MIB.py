...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgStpMode=mstCurCfgStpMode, layer2Configs=layer2Configs, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRootPathCost=cistRootPathCost, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfo=lacpInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbSrcTrunk=fdbSrcTrunk, vlanInfoStatus=vlanInfoStatus, lacpNewPortState=lacpNewPortState, cistInfoPortRole=cistInfoPortRole, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortPathCost=stpInfoPortPathCost, vlan=vlan, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortIndex=stgStatsPortIndex, layer2Info=layer2Info, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCfg=mstCistCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFindFails=fdbStatsFindFails, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoMaxAge=stpInfoMaxAge, BridgeId=BridgeId, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgState=mstCurCfgState, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamCfg=portTeamCfg, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoId=vlanInfoId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgPorts=vlanNewCfgPorts, fdbState=fdbState, vlanInfo=vlanInfo, lacpInfoPortTable=lacpInfoPortTable, PYSNMP_MODULE_ID=layer2, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTable=stgNewCfgTable, stgStatsStpIndex=stgStatsStpIndex, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, layer2Stats=layer2Stats, lacp=lacp, stpInfoTable=stpInfoTable, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbLearnedPort=fdbLearnedPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoTable=vlanInfoTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortSelected=lacpInfoPortSelected, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsFinds=fdbStatsFinds, lacpCurPortState=lacpCurPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgState=portTeamCurCfgState, fdbVlan=fdbVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRoot=cistRoot, mstNewCfgState=mstNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsLookups=fdbStatsLookups, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortTable=stgStatsPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortIndex=stpInfoPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfo=portTeamInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpStats=stpStats, fdbTable=fdbTable, fdbEntry=fdbEntry, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoRootPort=stpInfoRootPort, vlanInfoPorts=vlanInfoPorts, stpInfoIndex=stpInfoIndex, vlanMaxEnt=vlanMaxEnt, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mirrPortMirr=mirrPortMirr, layer2=layer2, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, stgCfg=stgCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgState=vlanNewCfgState, cistRootPort=cistRootPort, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbMacAddr=fdbMacAddr, mstGeneralCfg=mstGeneralCfg, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCurrent=fdbStatsCurrent, fdbStats=fdbStats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortTable=stpInfoPortTable, vlanInfoName=vlanInfoName, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortRole=stpInfoPortRole, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortIndex=cistInfoPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortState=stpInfoPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbRefSps=fdbRefSps, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCfg=mstCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoState=portTeamInfoState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgStg=vlanCurCfgStg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbSrcPort=fdbSrcPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkgroup=trunkgroup, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortState=stgCurCfgPortState, fdbInfo=fdbInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewSystemPriority=lacpNewSystemPriority, cistInfo=cistInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgState=portTeamNewCfgState, stpInfoRootCost=stpInfoRootCost, mirroring=mirroring, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Oper=layer2Oper, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbClear=fdbClear, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfo=stpInfo)
