...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoIndex=stpInfoIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, mstNewCfgStpMode=mstNewCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsOverflows=fdbStatsOverflows, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbRefSps=fdbRefSps, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTable=stpInfoPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsFindFails=fdbStatsFindFails, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTable=portTeamInfoTable, stpInfoRootCost=stpInfoRootCost, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsLookups=fdbStatsLookups, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortTable=stgStatsPortTable, fdbStats=fdbStats, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgState=vlanCurCfgState, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgIndex=stgNewCfgIndex, mirroring=mirroring, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfo=vlanInfo, cistInfoPortTable=cistInfoPortTable, cistInfoPortState=cistInfoPortState, vlanCurCfgTable=vlanCurCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoIndex=portTeamInfoIndex, layer2Stats=layer2Stats, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgDelete=portTeamNewCfgDelete, lacp=lacp, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbSrcPort=fdbSrcPort, stpInfoPortIndex=stpInfoPortIndex, vlanInfoTable=vlanInfoTable, stpInfoRootPort=stpInfoRootPort, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgTable=stgNewCfgTable, stpInfo=stpInfo, stgNewCfgPortState=stgNewCfgPortState, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbInfo=fdbInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfo=lacpInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPorts=portTeamInfoPorts, vlanMaxEnt=vlanMaxEnt, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoName=vlanInfoName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgState=mstNewCfgState, cistGeneralInfo=cistGeneralInfo, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbVlan=fdbVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfo=portTeamInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, BridgeId=BridgeId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbState=fdbState, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCfg=stgCfg, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbLearnedPort=fdbLearnedPort, cistRootPathCost=cistRootPathCost, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlan=vlan, mirrPortMirr=mirrPortMirr, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsStpIndex=stgStatsStpIndex, stpInfoTable=stpInfoTable, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoId=vlanInfoId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortMoved=lacpInfoPortMoved, layer2Configs=layer2Configs, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbTable=fdbTable, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCurCfgState=mstCurCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfo=cistInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgStg=vlanCurCfgStg, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoLearn=vlanInfoLearn, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoStatus=vlanInfoStatus, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCfg=portTeamCfg, mstCistCfg=mstCistCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortState=lacpNewPortState, stgCurCfgState=stgCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPriority=stgNewCfgPriority, stpStats=stpStats, stgNewCfgState=stgNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRegionalPathCost=cistRegionalPathCost, cistRoot=cistRoot, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRootPort=cistRootPort, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbClear=fdbClear, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortState=lacpCurPortState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2Info=layer2Info)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbEntry=fdbEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoHoldTime=stpInfoHoldTime, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2Oper=layer2Oper, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCfg=mstCfg, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2=layer2, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstGeneralCfg=mstGeneralCfg, mstCurCfgRegionName=mstCurCfgRegionName, trunkgroup=trunkgroup, vlanNewCfgLearn=vlanNewCfgLearn, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable)
