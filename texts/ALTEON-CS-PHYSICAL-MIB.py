...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, iso, MibIdentifier, Counter32, Gauge32, Bits, Counter64, Unsigned32, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "iso", "MibIdentifier", "Counter32", "Gauge32", "Bits", "Counter64", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfo=cistInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgState=stgCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoMaxAge=stpInfoMaxAge, cistRootPathCost=cistRootPathCost, fdbStatsFinds=fdbStatsFinds, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, fdbMacAddr=fdbMacAddr, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoState=portTeamInfoState, portTeamInfoPorts=portTeamInfoPorts, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortState=stpInfoPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCfg=mstCistCfg, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgIndex=stgNewCfgIndex, BridgeId=BridgeId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortPriority=cistInfoPortPriority, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoName=vlanInfoName, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsCreates=fdbStatsCreates, mirroring=mirroring, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoRootPort=stpInfoRootPort, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortEdge=stgNewCfgPortEdge, stpStats=stpStats, cistRegionalRoot=cistRegionalRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRootPort=cistRootPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2=layer2, portTeamInfo=portTeamInfo, layer2Stats=layer2Stats, lacpNewPortState=lacpNewPortState, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoLearn=vlanInfoLearn, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbClear=fdbClear, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgLearn=vlanCurCfgLearn, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfo=vlanInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortState=cistInfoPortState, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgStg=vlanNewCfgStg, mstCfg=mstCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Configs=layer2Configs, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoRootCost=stpInfoRootCost, fdbState=fdbState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoTable=stpInfoTable, vlanCurCfgState=vlanCurCfgState, vlanInfoTable=vlanInfoTable, stgStatsPortTable=stgStatsPortTable, stpInfoIndex=stpInfoIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortRole=stpInfoPortRole, stgNewCfgPriority=stgNewCfgPriority, fdbStatsHiwat=fdbStatsHiwat, mstGeneralCfg=mstGeneralCfg, cistInfoPortPathCost=cistInfoPortPathCost, fdbStats=fdbStats, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfo=stpInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortMoved=lacpInfoPortMoved, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, fdbRefSps=fdbRefSps, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortNtt=lacpInfoPortNtt, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkgroup=trunkgroup, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbTable=fdbTable, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbSrcPort=fdbSrcPort, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortRole=cistInfoPortRole, vlanCurCfgPorts=vlanCurCfgPorts, lacp=lacp, vlanNewCfgVlanId=vlanNewCfgVlanId, vlan=vlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortState=lacpCurPortState, fdbStatsLookups=fdbStatsLookups, vlanNewCfgTable=vlanNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCurCfgState=mstCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoForwardDelay=stpInfoForwardDelay, cistRoot=cistRoot, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgState=mstNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mirrPortMirr=mirrPortMirr, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgStg=vlanCurCfgStg, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfo=lacpInfo, portTeamTableMaxSize=portTeamTableMaxSize, fdbEntry=fdbEntry, fdbLearnedPort=fdbLearnedPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbVlan=fdbVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoPorts=vlanInfoPorts, stgCfg=stgCfg, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoHelloTime=stpInfoHelloTime, layer2Info=layer2Info, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCfg=portTeamCfg, PYSNMP_MODULE_ID=layer2, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbSrcTrunk=fdbSrcTrunk, vlanInfoId=vlanInfoId, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbInfo=fdbInfo, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Oper=layer2Oper)
