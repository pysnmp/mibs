...
Gauge32, Counter64, iso, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter32, Integer32, IpAddress, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "iso", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, layer2=layer2, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, trunkgroup=trunkgroup, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortRole=stpInfoPortRole, stpInfoPortEdge=stpInfoPortEdge, stgStatsPortIndex=stgStatsPortIndex, stpInfoRootPort=stpInfoRootPort, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, vlanInfoTable=vlanInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbVlan=fdbVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgState=portTeamNewCfgState, stgCfg=stgCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTableEntry=stpInfoTableEntry, cistRootPathCost=cistRootPathCost, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stpStats=stpStats, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoIndex=stpInfoIndex, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsCreates=fdbStatsCreates, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, mirroring=mirroring, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoPorts=vlanInfoPorts, cistGeneralInfo=cistGeneralInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Info=layer2Info, mstNewCfgState=mstNewCfgState, cistInfoPortPriority=cistInfoPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacp=lacp, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfo=portTeamInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStats=fdbStats, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, BridgeId=BridgeId, vlan=vlan, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortState=lacpCurPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoTableEntry=vlanInfoTableEntry, mstGeneralCfg=mstGeneralCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfo=lacpInfo, mstCistCfg=mstCistCfg, stgNewCfgState=stgNewCfgState, cistRoot=cistRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsDeletes=fdbStatsDeletes, fdbRefSps=fdbRefSps, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortState=stpInfoPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Stats=layer2Stats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbInfo=fdbInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbMacAddr=fdbMacAddr, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCfg=mstCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistRootPort=cistRootPort, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPriority=stgCurCfgPriority, vlanInfo=vlanInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTable=stpInfoTable, fdbStatsLookups=fdbStatsLookups, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgTable=portTeamNewCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, fdbClear=fdbClear, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbTable=fdbTable, cistInfoPortRole=cistInfoPortRole, vlanInfoId=vlanInfoId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoName=vlanInfoName, PYSNMP_MODULE_ID=layer2, cistInfo=cistInfo, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanInfoLearn=vlanInfoLearn, fdbState=fdbState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoRootCost=stpInfoRootCost, layer2Oper=layer2Oper, layer2Configs=layer2Configs, fdbEntry=fdbEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortTable=cistInfoPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsCurrent=fdbStatsCurrent, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, stgNewCfgPortLink=stgNewCfgPortLink, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgState=mstCurCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTable=stgNewCfgTable, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortState=cistInfoPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, stpInfo=stpInfo)
