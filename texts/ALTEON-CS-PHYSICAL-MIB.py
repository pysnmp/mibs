...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortState=lacpNewPortState, cistInfoPortPriority=cistInfoPortPriority, stpInfo=stpInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortState=cistInfoPortState, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, fdbClear=fdbClear, fdbVlan=fdbVlan, stpInfoMaxAge=stpInfoMaxAge, cistRoot=cistRoot, lacpInfoPortTable=lacpInfoPortTable, fdbRefSps=fdbRefSps, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortTable=cistInfoPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mirroring=mirroring, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfo=portTeamInfo, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfo=lacpInfo, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRootPathCost=cistRootPathCost, vlanInfoLearn=vlanInfoLearn, portTeamInfoTableEntry=portTeamInfoTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPriority=stgCurCfgPriority, cistGeneralInfo=cistGeneralInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Configs=layer2Configs, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgIndex=stgNewCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, BridgeId=BridgeId, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCfg=mstCistCfg, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCfg=mstCfg, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Oper=layer2Oper, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsCreates=fdbStatsCreates, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCurCfgTable=portTeamCurCfgTable, fdbStats=fdbStats, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoHelloTime=stpInfoHelloTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoJumbo=vlanInfoJumbo, layer2Stats=layer2Stats, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacp=lacp, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTable=stpInfoTable, portTeamInfoTable=portTeamInfoTable, PYSNMP_MODULE_ID=layer2, vlanInfoTable=vlanInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2Info=layer2Info, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRegionalRoot=cistRegionalRoot, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbState=fdbState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, fdbTable=fdbTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortEdge=stpInfoPortEdge, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTable=stgCurCfgTable, stpStats=stpStats, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoRootCost=stpInfoRootCost, vlanInfoPorts=vlanInfoPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfo=vlanInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsStpIndex=stgStatsStpIndex, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCfg=portTeamCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfo=cistInfo, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortState=lacpCurPortState, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortRole=cistInfoPortRole, mstNewCfgState=mstNewCfgState, stpInfoHoldTime=stpInfoHoldTime, vlanInfoName=vlanInfoName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortIndex=cistInfoPortIndex, fdbStatsFindFails=fdbStatsFindFails, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortPriority=stgCurCfgPortPriority, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCfg=stgCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgState=stgCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoIndex=stpInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, vlan=vlan, layer2=layer2)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgState=stgNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, fdbMacAddr=fdbMacAddr, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRootPort=cistRootPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoId=vlanInfoId, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbInfo=fdbInfo, stgNewCfgTable=stgNewCfgTable, fdbEntry=fdbEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkgroup=trunkgroup, mstGeneralCfg=mstGeneralCfg, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsLookups=fdbStatsLookups)
