...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoRootPort=stpInfoRootPort, layer2Info=layer2Info, vlanNewCfgVlanId=vlanNewCfgVlanId, BridgeId=BridgeId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistRootPort=cistRootPort, mstCistCfg=mstCistCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortState=stpInfoPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortIndex=cistInfoPortIndex, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, fdbRefSps=fdbRefSps, vlanInfoName=vlanInfoName, stpStats=stpStats, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRootPathCost=cistRootPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbTable=fdbTable, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfo=portTeamInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, cistInfo=cistInfo, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortRole=stpInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortState=cistInfoPortState, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortState=lacpCurPortState, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, fdbState=fdbState, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfo=lacpInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistGeneralInfo=cistGeneralInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstGeneralCfg=mstGeneralCfg, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfoTable=vlanInfoTable, fdbSrcTrunk=fdbSrcTrunk, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortSelected=lacpInfoPortSelected, layer2=layer2, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsCurrent=fdbStatsCurrent, fdbEntry=fdbEntry, stgNewCfgState=stgNewCfgState, mstCurCfgState=mstCurCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, lacp=lacp, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, fdbClear=fdbClear, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoId=vlanInfoId, mstNewCfgRegionName=mstNewCfgRegionName, fdbMacAddr=fdbMacAddr, vlanMaxEnt=vlanMaxEnt, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkgroup=trunkgroup, mirroring=mirroring, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgState=vlanNewCfgState, fdbStatsCreates=fdbStatsCreates, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortTable=cistInfoPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoLearn=vlanInfoLearn, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgTable=stgCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbInfo=fdbInfo, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoState=portTeamInfoState, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, stgCfg=stgCfg, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoPorts=vlanInfoPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRoot=cistRoot, fdbSrcPort=fdbSrcPort, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCfg=portTeamCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfo=vlanInfo, mstNewCfgState=mstNewCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPriority=stgNewCfgPriority, layer2Stats=layer2Stats, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbVlan=fdbVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, stgStatsStpIndex=stgStatsStpIndex, fdbStats=fdbStats, stgStatsPortTable=stgStatsPortTable, vlanNewCfgStg=vlanNewCfgStg, fdbLearnedPort=fdbLearnedPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCfg=mstCfg, layer2Oper=layer2Oper, layer2Configs=layer2Configs, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortIndex=stgCurCfgPortIndex, vlan=vlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTable=portTeamNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsLookups=fdbStatsLookups, stgCurCfgState=stgCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfo=stpInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoTable=stpInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState)
