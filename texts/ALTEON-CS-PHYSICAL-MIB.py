...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortState=cistInfoPortState, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoTable=portTeamInfoTable, vlanCurCfgTable=vlanCurCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoLearn=vlanInfoLearn, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoState=portTeamInfoState, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortSelected=lacpInfoPortSelected, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbRefSps=fdbRefSps, fdbEntry=fdbEntry, fdbLearnedPort=fdbLearnedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCfg=portTeamCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, PYSNMP_MODULE_ID=layer2, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsLookups=fdbStatsLookups, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoName=vlanInfoName, vlanInfo=vlanInfo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortRole=cistInfoPortRole, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortState=stgNewCfgPortState, vlanInfoStatus=vlanInfoStatus, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortNtt=lacpInfoPortNtt, fdbState=fdbState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoTable=stpInfoTable, stpInfoRootPort=stpInfoRootPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistRegionalRoot=cistRegionalRoot, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Oper=layer2Oper, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortTable=cistInfoPortTable, mstNewCfgState=mstNewCfgState, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbVlan=fdbVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgState=portTeamNewCfgState, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfo=cistInfo, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsFinds=fdbStatsFinds, stgCfg=stgCfg, stpStats=stpStats, fdbInfo=fdbInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbSrcPort=fdbSrcPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2=layer2, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortTable=stpInfoPortTable, lacpNewPortState=lacpNewPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRootPort=cistRootPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkgroup=trunkgroup, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoId=vlanInfoId, lacpCurPortState=lacpCurPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgState=vlanCurCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCfg=mstCistCfg, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortIndex=cistInfoPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoTable=vlanInfoTable, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, mstGeneralCfg=mstGeneralCfg, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortState=stpInfoPortState, BridgeId=BridgeId, layer2Configs=layer2Configs, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortIndex=stpInfoPortIndex, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortLinkType=stpInfoPortLinkType, stpInfo=stpInfo, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortIndex=lacpInfoPortIndex, vlan=vlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfo=lacpInfo, vlanMaxEnt=vlanMaxEnt, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacp=lacp, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRootPathCost=cistRootPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mirroring=mirroring, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Info=layer2Info, stgCurCfgState=stgCurCfgState, mstCfg=mstCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortTable=stgStatsPortTable, mstCurCfgState=mstCurCfgState, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, layer2Stats=layer2Stats, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgTable=stgNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRoot=cistRoot, stgStatsPortIndex=stgStatsPortIndex, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoIndex=portTeamInfoIndex, fdbStats=fdbStats, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoJumbo=vlanInfoJumbo, portTeamInfo=portTeamInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbTable=fdbTable, stgCurCfgTable=stgCurCfgTable, vlanNewCfgState=vlanNewCfgState, fdbClear=fdbClear)
