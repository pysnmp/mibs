...
iso, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter64, Counter32, ObjectIdentity, ModuleIdentity, Unsigned32, NotificationType, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter64", "Counter32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgState=mstCurCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoMaxAge=stpInfoMaxAge, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, layer2Oper=layer2Oper, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, PYSNMP_MODULE_ID=layer2, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortSelected=lacpInfoPortSelected, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, layer2Stats=layer2Stats, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortTable=lacpInfoPortTable, stpInfoTableEntry=stpInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTable=stpInfoTable, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, cistRegionalRoot=cistRegionalRoot, portTeamInfoTable=portTeamInfoTable, stpStats=stpStats, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoHelloTime=stpInfoHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbRefSps=fdbRefSps, fdbSrcPort=fdbSrcPort, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortIndex=cistInfoPortIndex, vlanInfoPorts=vlanInfoPorts, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoName=vlanInfoName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfo=cistInfo, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoRootCost=stpInfoRootCost, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsOverflows=fdbStatsOverflows, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgState=stgNewCfgState, fdbEntry=fdbEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCfg=stgCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbState=fdbState, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, trunkgroup=trunkgroup, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbInfo=fdbInfo, portTeamInfo=portTeamInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCfg=mstCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirroring=mirroring, mstCistCfg=mstCistCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCfg=portTeamCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoId=vlanInfoId, vlanNewCfgState=vlanNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortState=stpInfoPortState, cistRoot=cistRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacp=lacp, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfo=lacpInfo, cistInfoPortPriority=cistInfoPortPriority, layer2Info=layer2Info, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortState=cistInfoPortState, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsStpIndex=stgStatsStpIndex, stpInfoIndex=stpInfoIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfo=vlanInfo, layer2=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, layer2Configs=layer2Configs, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbLearnedPort=fdbLearnedPort, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbVlan=fdbVlan, cistRootPort=cistRootPort, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewPortState=lacpNewPortState, stpInfo=stpInfo, mirrPortMirr=mirrPortMirr, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoState=portTeamInfoState, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoTopChanges=stpInfoTopChanges, BridgeId=BridgeId, stpInfoPortEdge=stpInfoPortEdge, vlanInfoLearn=vlanInfoLearn, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgTable=stgNewCfgTable, fdbStatsLookups=fdbStatsLookups, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgVlanId=vlanNewCfgVlanId, cistGeneralInfo=cistGeneralInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPriority=stgNewCfgPriority, vlanMaxEnt=vlanMaxEnt, stgCurCfgTable=stgCurCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbMacAddr=fdbMacAddr, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStats=fdbStats, stgCurCfgPortEdge=stgCurCfgPortEdge, mstGeneralCfg=mstGeneralCfg, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbTable=fdbTable, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTrunks=portTeamInfoTrunks, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoHoldTime=stpInfoHoldTime, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgRegionName=mstCurCfgRegionName, vlan=vlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortRole=stpInfoPortRole, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgState=stgCurCfgState, cistRootPathCost=cistRootPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgState=vlanCurCfgState, fdbStatsCreates=fdbStatsCreates, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg)
