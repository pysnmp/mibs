...
MibIdentifier, Gauge32, Bits, IpAddress, Counter32, Counter64, Unsigned32, ModuleIdentity, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "Counter32", "Counter64", "Unsigned32", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortPriority=cistInfoPortPriority, vlan=vlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistRootPathCost=cistRootPathCost, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortState=lacpCurPortState, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortIndex=stgStatsPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTable=vlanInfoTable, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoHelloTime=stpInfoHelloTime, portTeamCfg=portTeamCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortRole=cistInfoPortRole, vlanInfoPorts=vlanInfoPorts, mstNewCfgState=mstNewCfgState, vlanInfoLearn=vlanInfoLearn, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Oper=layer2Oper, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfo=lacpInfo, portTeamInfoTable=portTeamInfoTable, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgPorts=portTeamNewCfgPorts, cistRoot=cistRoot, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgState=vlanNewCfgState, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortIndex=lacpInfoPortIndex, BridgeId=BridgeId, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfo=portTeamInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbSrcPort=fdbSrcPort, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfo=cistInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbClear=fdbClear, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfo=vlanInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbTable=fdbTable, stpInfoPortState=stpInfoPortState, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortTable=cistInfoPortTable, layer2Configs=layer2Configs, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoIndex=stpInfoIndex, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbEntry=fdbEntry, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbRefSps=fdbRefSps, stpStats=stpStats, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgStpMode=mstNewCfgStpMode, stpInfo=stpInfo, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, mirrPortMirr=mirrPortMirr, stpInfoRootPort=stpInfoRootPort, cistInfoPortState=cistInfoPortState, stgCurCfgState=stgCurCfgState, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, stgCfg=stgCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRegionalRoot=cistRegionalRoot, PYSNMP_MODULE_ID=layer2, mstCfg=mstCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkgroup=trunkgroup, lacpInfoPortMoved=lacpInfoPortMoved, cistRootPort=cistRootPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, layer2Stats=layer2Stats, stgStatsPortTable=stgStatsPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortState=lacpNewPortState, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookups=fdbStatsLookups, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStatsHiwat=fdbStatsHiwat, fdbInfo=fdbInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortTable=stpInfoPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mirroring=mirroring, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoName=vlanInfoName, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortLinkType=cistInfoPortLinkType, lacp=lacp, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCfg=mstCistCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStats=fdbStats, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgTable=stgCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, layer2=layer2, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCreates=fdbStatsCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbVlan=fdbVlan, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2Info=layer2Info, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoId=vlanInfoId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgState=mstCurCfgState, fdbMacAddr=fdbMacAddr, fdbState=fdbState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTable=stpInfoTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistBridgeHelloTime=cistBridgeHelloTime)
