...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortEdge=stpInfoPortEdge, layer2Configs=layer2Configs, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkgroup=trunkgroup, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbRefSps=fdbRefSps, portTeamNewCfgState=portTeamNewCfgState, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacp=lacp, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStats=fdbStats, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbTable=fdbTable, stpInfoPortState=stpInfoPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPriority=stgCurCfgPriority, mstCfg=mstCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Info=layer2Info, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, mirroring=mirroring, trunkGroupCurCfgState=trunkGroupCurCfgState, PYSNMP_MODULE_ID=layer2, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, vlan=vlan, fdbSrcPort=fdbSrcPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistGeneralInfo=cistGeneralInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortState=lacpCurPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Stats=layer2Stats, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsLookups=fdbStatsLookups, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, fdbState=fdbState, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstGeneralCfg=mstGeneralCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2=layer2, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, mstNewCfgState=mstNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortIndex=stgStatsPortIndex, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbInfo=fdbInfo, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsCreates=fdbStatsCreates, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoIndex=stpInfoIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgState=mstCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgStg=vlanCurCfgStg, cistRootPort=cistRootPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2Oper=layer2Oper, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgState=stgCurCfgState, fdbStatsFinds=fdbStatsFinds, stpInfoTable=stpInfoTable, stpInfoRootPort=stpInfoRootPort, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfo=cistInfo, lacpNewPortState=lacpNewPortState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgTable=stgCurCfgTable, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortState=cistInfoPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPriority=stgNewCfgPriority, lacpInfo=lacpInfo, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRoot=cistRoot, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbClear=fdbClear, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoHoldTime=stpInfoHoldTime, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoId=vlanInfoId, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoName=vlanInfoName, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoState=portTeamInfoState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortTable=lacpInfoPortTable, stpInfo=stpInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRootPathCost=cistRootPathCost, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoPorts=portTeamInfoPorts, stpStats=stpStats, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfo=vlanInfo, fdbEntry=fdbEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCfg=stgCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortState=stgCurCfgPortState, cistRegionalRoot=cistRegionalRoot, mirrPortMirr=mirrPortMirr, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTable=portTeamInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbLearnedPort=fdbLearnedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbVlan=fdbVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCfg=portTeamCfg, stgStatsPortTable=stgStatsPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortRole=stpInfoPortRole, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfo=portTeamInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, BridgeId=BridgeId, mstCistCfg=mstCistCfg, stpInfoTopChanges=stpInfoTopChanges, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgTable=stgNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortTable=cistInfoPortTable)
