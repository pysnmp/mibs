...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoJumbo=vlanInfoJumbo, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgTable=stgNewCfgTable, vlanCurCfgState=vlanCurCfgState, fdbLearnedPort=fdbLearnedPort, fdbStatsOverflows=fdbStatsOverflows, cistRootPort=cistRootPort, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfoTable=portTeamInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortState=stgNewCfgPortState, mirroring=mirroring, stpInfoHelloTime=stpInfoHelloTime, vlan=vlan, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfo=cistInfo, trunkgroup=trunkgroup, layer2Oper=layer2Oper, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortIndex=stgStatsPortIndex, vlanInfo=vlanInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgState=mstNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoState=portTeamInfoState, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgTable=stgCurCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgState=stgNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCfg=mstCistCfg, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoTable=vlanInfoTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortIndex=cistInfoPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRootPathCost=cistRootPathCost, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoRootCost=stpInfoRootCost, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortTable=stpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgIndex=stgCurCfgIndex, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgState=mstCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbSrcPort=fdbSrcPort, lacpNewPortState=lacpNewPortState, BridgeId=BridgeId, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoIndex=stpInfoIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, mstGeneralCfg=mstGeneralCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortRole=stpInfoPortRole, cistRoot=cistRoot, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpStats=stpStats, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoName=vlanInfoName, stgNewCfgPortLink=stgNewCfgPortLink, mstCfg=mstCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookups=fdbStatsLookups, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootPort=stpInfoRootPort, fdbStatsFinds=fdbStatsFinds, mirrPortMirr=mirrPortMirr, vlanNewCfgStg=vlanNewCfgStg, cistRegionalRoot=cistRegionalRoot, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbState=fdbState, vlanInfoId=vlanInfoId, stpInfoMaxAge=stpInfoMaxAge, vlanInfoLearn=vlanInfoLearn, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbTable=fdbTable, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgState=stgCurCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStats=fdbStats, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, fdbStatsHiwat=fdbStatsHiwat, fdbInfo=fdbInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortState=cistInfoPortState, fdbClear=fdbClear, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbRefSps=fdbRefSps, lacpCurPortState=lacpCurPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortTable=stgStatsPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTrunks=portTeamInfoTrunks, PYSNMP_MODULE_ID=layer2, cistGeneralInfo=cistGeneralInfo, vlanMaxVlanID=vlanMaxVlanID, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoIndex=portTeamInfoIndex, portTeamInfo=portTeamInfo, layer2Info=layer2Info, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbEntry=fdbEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCfg=stgCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfo=lacpInfo, fdbVlan=fdbVlan, stpInfo=stpInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTable=stpInfoTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsDeletes=fdbStatsDeletes, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortState=stpInfoPortState, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCfg=portTeamCfg, lacp=lacp, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsCreates=fdbStatsCreates, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbMacAddr=fdbMacAddr, layer2=layer2, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Configs=layer2Configs, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Stats=layer2Stats)
