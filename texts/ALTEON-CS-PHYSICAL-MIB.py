...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsLookups=fdbStatsLookups, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Configs=layer2Configs, portTeamInfo=portTeamInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbMacAddr=fdbMacAddr, vlanInfoId=vlanInfoId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoTable=vlanInfoTable, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoState=portTeamInfoState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgState=stgNewCfgState, stgStatsPortTable=stgStatsPortTable, trunkgroup=trunkgroup, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanMaxEnt=vlanMaxEnt, stpInfoRootCost=stpInfoRootCost, mirrPortMirr=mirrPortMirr, stgCurCfgPortLink=stgCurCfgPortLink, fdbState=fdbState, cistRegionalRoot=cistRegionalRoot, PYSNMP_MODULE_ID=layer2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgState=mstNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCfg=mstCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortTable=cistInfoPortTable, vlanCurCfgState=vlanCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, stgStatsStpIndex=stgStatsStpIndex, cistInfo=cistInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgState=stgCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCfg=mstCistCfg, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoLearn=vlanInfoLearn, fdbTable=fdbTable, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbSrcPort=fdbSrcPort, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCfg=portTeamCfg, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfo=vlanInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortMoved=lacpInfoPortMoved, lacp=lacp, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoIndex=stpInfoIndex, stpInfoPortIndex=stpInfoPortIndex, fdbStatsCreates=fdbStatsCreates, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortState=stpInfoPortState, layer2=layer2, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindFails=fdbStatsFindFails, fdbRefSps=fdbRefSps, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRootPort=cistRootPort, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortPriority=cistInfoPortPriority, stpStats=stpStats, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPriority=stgNewCfgPriority, layer2Stats=layer2Stats, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, BridgeId=BridgeId, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Info=layer2Info, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, mirroring=mirroring, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbInfo=fdbInfo, stgCfg=stgCfg, mstGeneralCfg=mstGeneralCfg, vlanCurCfgTable=vlanCurCfgTable, cistRootPathCost=cistRootPathCost, fdbVlan=fdbVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcTrunk=fdbSrcTrunk, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, vlanMaxVlanID=vlanMaxVlanID, stpInfoTable=stpInfoTable, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbClear=fdbClear, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgState=mstCurCfgState, portTeamInfoTable=portTeamInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoPorts=vlanInfoPorts, cistGeneralInfo=cistGeneralInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbLearnedPort=fdbLearnedPort, vlan=vlan, vlanInfoName=vlanInfoName, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfo=stpInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortState=lacpNewPortState, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHoldTime=stpInfoHoldTime, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistRoot=cistRoot, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFinds=fdbStatsFinds, lacpInfo=lacpInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStats=fdbStats, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Oper=layer2Oper, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortTable=stpInfoPortTable, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgState=vlanNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortTableEntry=cistInfoPortTableEntry)
