...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Bits, Counter32, NotificationType, Counter64, Unsigned32, IpAddress, ObjectIdentity, Integer32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Bits", "Counter32", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "ObjectIdentity", "Integer32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfo=portTeamInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTable=stgCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoForwardDelay=stpInfoForwardDelay, mstGeneralCfg=mstGeneralCfg, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortIndex=lacpInfoPortIndex, BridgeId=BridgeId, stpInfoRootPort=stpInfoRootPort, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgLearn=vlanCurCfgLearn, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTable=stpInfoTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlan=vlan, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTable=stgNewCfgTable, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsHiwat=fdbStatsHiwat, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Oper=layer2Oper, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbVlan=fdbVlan, stgCurCfgIndex=stgCurCfgIndex, vlanInfoStatus=vlanInfoStatus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbClear=fdbClear, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortNtt=lacpInfoPortNtt, trunkgroup=trunkgroup, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpStats=stpStats, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgAddVlan=stgNewCfgAddVlan, cistRegionalPathCost=cistRegionalPathCost, vlanMaxEnt=vlanMaxEnt, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbLearnedPort=fdbLearnedPort, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, vlanCurCfgStg=vlanCurCfgStg, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfo=stpInfo, fdbStatsLookups=fdbStatsLookups, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTable=stpInfoPortTable, vlanInfoId=vlanInfoId, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortState=lacpCurPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortState=cistInfoPortState, lacpNewPortState=lacpNewPortState, mstCfg=mstCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistRootPathCost=cistRootPathCost, layer2Configs=layer2Configs, cistRoot=cistRoot, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, PYSNMP_MODULE_ID=layer2, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCfg=portTeamCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoName=vlanInfoName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoPorts=portTeamInfoPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbSrcPort=fdbSrcPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortRole=cistInfoPortRole, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsOverflows=fdbStatsOverflows, stgCfg=stgCfg, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfo=lacpInfo, vlanCurCfgState=vlanCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgState=portTeamCurCfgState, layer2Info=layer2Info, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoIndex=portTeamInfoIndex, vlanInfoPorts=vlanInfoPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, layer2Stats=layer2Stats, fdbStats=fdbStats, cistInfo=cistInfo, stgCurCfgState=stgCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, fdbState=fdbState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortTable=stgStatsPortTable, cistRootPort=cistRootPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbRefSps=fdbRefSps, fdbEntry=fdbEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacp=lacp, stgNewCfgIndex=stgNewCfgIndex, fdbMacAddr=fdbMacAddr, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTable=vlanInfoTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortState=stpInfoPortState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgState=portTeamNewCfgState, mirroring=mirroring, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCfg=mstCistCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoIndex=stpInfoIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortRole=stpInfoPortRole, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfo=vlanInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoRootCost=stpInfoRootCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbTable=fdbTable, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgState=mstNewCfgState, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgState=stgNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbSrcTrunk=fdbSrcTrunk, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbInfo=fdbInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2=layer2)
