...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfo=stpInfo, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortRole=stpInfoPortRole, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2Info=layer2Info, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortState=stpInfoPortState, cistRegionalPathCost=cistRegionalPathCost, fdbMacAddr=fdbMacAddr, cistGeneralInfo=cistGeneralInfo, fdbVlan=fdbVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortState=lacpNewPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoTable=stpInfoTable, vlanNewCfgLearn=vlanNewCfgLearn, BridgeId=BridgeId, vlanInfoName=vlanInfoName, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgState=vlanCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortTable=stgStatsPortTable, fdbStats=fdbStats, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbEntry=fdbEntry, layer2Stats=layer2Stats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbSrcPort=fdbSrcPort, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgState=stgCurCfgState, fdbSrcTrunk=fdbSrcTrunk, fdbState=fdbState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCurCfgState=mstCurCfgState, vlanInfoLearn=vlanInfoLearn, stpInfoIndex=stpInfoIndex, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortIndex=cistInfoPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoJumbo=vlanInfoJumbo, fdbLearnedPort=fdbLearnedPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCfg=mstCistCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, PYSNMP_MODULE_ID=layer2, mirroring=mirroring, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgIndex=stgNewCfgIndex, vlanInfoId=vlanInfoId, portTeamNewCfgState=portTeamNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, stpStats=stpStats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortTableEntry=stgStatsPortTableEntry, lacp=lacp, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgLearn=vlanCurCfgLearn, cistRootPathCost=cistRootPathCost, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootPort=stpInfoRootPort, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkgroup=trunkgroup, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsLookups=fdbStatsLookups, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTable=portTeamInfoTable, stpInfoRootCost=stpInfoRootCost, vlanInfoTable=vlanInfoTable, mstNewCfgStpMode=mstNewCfgStpMode, layer2Oper=layer2Oper, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgTable=stgCurCfgTable, stgNewCfgState=stgNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFindFails=fdbStatsFindFails, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoState=portTeamInfoState, fdbClear=fdbClear, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCfg=mstCfg, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortTable=cistInfoPortTable, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortPathCost=stpInfoPortPathCost, mstGeneralCfg=mstGeneralCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfo=vlanInfo, cistRoot=cistRoot, layer2Configs=layer2Configs, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgState=mstNewCfgState, fdbStatsHiwat=fdbStatsHiwat, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgState=vlanNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfo=cistInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortEdge=stpInfoPortEdge, portTeamInfo=portTeamInfo, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortPathCost=cistInfoPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrPortMirr=mirrPortMirr, cistRootPort=cistRootPort, vlanInfoStatus=vlanInfoStatus, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgTable=vlanNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgTable=stgNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortIndex=stgStatsPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime, layer2=layer2, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlan=vlan, lacpInfo=lacpInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, fdbRefSps=fdbRefSps, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbInfo=fdbInfo, stgCfg=stgCfg, portTeamCfg=portTeamCfg, mstCurCfgRegionName=mstCurCfgRegionName, fdbTable=fdbTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortTable=lacpInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortRole=cistInfoPortRole)
