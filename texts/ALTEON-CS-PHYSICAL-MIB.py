...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoStatus=vlanInfoStatus, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgIndex=stgCurCfgIndex, mirroring=mirroring, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoPorts=vlanInfoPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTable=portTeamNewCfgTable, fdbTable=fdbTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgState=vlanCurCfgState, portTeamInfo=portTeamInfo, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoIndex=stpInfoIndex, mirrPortMirr=mirrPortMirr, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, cistRootPathCost=cistRootPathCost, portTeamInfoTable=portTeamInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortIndex=stgStatsPortIndex, stpInfoRootCost=stpInfoRootCost, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbRefSps=fdbRefSps, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbState=fdbState, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortState=stgCurCfgPortState, layer2=layer2, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRootPort=cistRootPort, cistInfoPortIndex=cistInfoPortIndex, vlanInfo=vlanInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbClear=fdbClear, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsLookupFails=fdbStatsLookupFails, cistRegionalRoot=cistRegionalRoot, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRoot=cistRoot, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoMaxAge=stpInfoMaxAge, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFindFails=fdbStatsFindFails, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgStg=vlanNewCfgStg, lacp=lacp, fdbSrcPort=fdbSrcPort, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCurCfgState=mstCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoId=vlanInfoId, fdbStatsCreates=fdbStatsCreates, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbLearnedPort=fdbLearnedPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, PYSNMP_MODULE_ID=layer2, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoName=vlanInfoName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, stgNewCfgState=stgNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, BridgeId=BridgeId, vlanCurCfgTable=vlanCurCfgTable, fdbStatsDeletes=fdbStatsDeletes, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortMoved=lacpInfoPortMoved, stpStats=stpStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2Oper=layer2Oper, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgState=portTeamCurCfgState, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, layer2Info=layer2Info, stpInfo=stpInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbVlan=fdbVlan, stgNewCfgTable=stgNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, vlan=vlan, cistInfoPortState=cistInfoPortState, lacpCurPortState=lacpCurPortState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoRootPort=stpInfoRootPort, fdbStatsLookups=fdbStatsLookups, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStats=fdbStats, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, cistInfoPortRole=cistInfoPortRole, layer2Stats=layer2Stats, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkgroup=trunkgroup, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCfg=portTeamCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbMacAddr=fdbMacAddr, cistRegionalPathCost=cistRegionalPathCost, stpInfoTable=stpInfoTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Configs=layer2Configs, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortRole=stpInfoPortRole, cistInfo=cistInfo, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCfg=mstCistCfg, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsFinds=fdbStatsFinds, fdbStatsCurrent=fdbStatsCurrent)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgState=vlanNewCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfo=lacpInfo, lacpNewPortState=lacpNewPortState, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbInfo=fdbInfo, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoState=portTeamInfoState, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, mstCfg=mstCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsOverflows=fdbStatsOverflows, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeMaxAge=cistBridgeMaxAge, stgCfg=stgCfg)
