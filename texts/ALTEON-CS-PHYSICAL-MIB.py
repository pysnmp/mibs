...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, layer2Configs=layer2Configs, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoPorts=vlanInfoPorts, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFinds=fdbStatsFinds, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortIndex=stpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbClear=fdbClear, lacp=lacp, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, stgCurCfgTable=stgCurCfgTable, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCfg=portTeamCfg, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoTable=portTeamInfoTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanMaxEnt=vlanMaxEnt, cistRootPort=cistRootPort, layer2=layer2, stgCfg=stgCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, stpInfoHoldTime=stpInfoHoldTime, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbMacAddr=fdbMacAddr, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbInfo=fdbInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgState=stgCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortState=stgNewCfgPortState, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgTable=stgNewCfgTable, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgState=vlanNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoState=portTeamInfoState, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgState=stgNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortState=lacpCurPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCfg=mstCistCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoTable=stpInfoTable, stpInfoMaxAge=stpInfoMaxAge, cistRegionalRoot=cistRegionalRoot, BridgeId=BridgeId, stgStatsStpIndex=stgStatsStpIndex, vlanInfoId=vlanInfoId, vlanInfoName=vlanInfoName, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfo=lacpInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortTable=stgStatsPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortRole=stpInfoPortRole, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgStg=vlanNewCfgStg, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfo=stpInfo, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirrPortMirr=mirrPortMirr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbTable=fdbTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpStats=stpStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoTable=vlanInfoTable, vlanInfoJumbo=vlanInfoJumbo, fdbStats=fdbStats, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortTable=cistInfoPortTable, fdbRefSps=fdbRefSps, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRoot=cistRoot, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistBridgeCfg=mstCistBridgeCfg, layer2Stats=layer2Stats, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbSrcPort=fdbSrcPort, stpInfoPortTable=stpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, layer2Oper=layer2Oper, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortState=stpInfoPortState, portTeamInfo=portTeamInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgState=mstNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlan=vlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoIndex=stpInfoIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoPorts=portTeamInfoPorts, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoTrunks=portTeamInfoTrunks, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortRole=cistInfoPortRole, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgTable=vlanCurCfgTable, cistInfo=cistInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoStatus=vlanInfoStatus)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbVlan=fdbVlan, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCfg=mstCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfo=vlanInfo, cistGeneralInfo=cistGeneralInfo, mirroring=mirroring, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbState=fdbState, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortState=lacpNewPortState, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbEntry=fdbEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2Info=layer2Info)
