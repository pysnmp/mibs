...
iso, Counter32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Bits, ObjectIdentity, IpAddress, Gauge32, MibIdentifier, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Bits", "ObjectIdentity", "IpAddress", "Gauge32", "MibIdentifier", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, PYSNMP_MODULE_ID=layer2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbEntry=fdbEntry, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoId=vlanInfoId, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRoot=cistRoot, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoStatus=vlanInfoStatus, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbState=fdbState, BridgeId=BridgeId, layer2Info=layer2Info, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTable=stgNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstGeneralCfg=mstGeneralCfg, layer2Configs=layer2Configs, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewPortState=lacpNewPortState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgState=stgCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoTable=portTeamInfoTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStats=fdbStats, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgState=stgNewCfgState, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrPortMirr=mirrPortMirr, stpInfoPortStpIndex=stpInfoPortStpIndex, layer2Oper=layer2Oper, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortState=cistInfoPortState, layer2Stats=layer2Stats, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoName=vlanInfoName, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortTableEntry=stpInfoPortTableEntry, mirroring=mirroring, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgState=vlanCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, vlan=vlan, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfo=vlanInfo, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCreates=fdbStatsCreates, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoForwardDelay=stpInfoForwardDelay, cistGeneralInfo=cistGeneralInfo, trunkgroup=trunkgroup, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbSrcPort=fdbSrcPort, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbRefSps=fdbRefSps, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfo=stpInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortRole=cistInfoPortRole, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoTable=vlanInfoTable, stgCfg=stgCfg, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortState=lacpCurPortState, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfo=portTeamInfo, portTeamCfg=portTeamCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoIndex=stpInfoIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortTable=lacpInfoPortTable, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgTable=stgCurCfgTable, cistInfoPortTable=cistInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoState=portTeamInfoState, portTeamInfoIndex=portTeamInfoIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCfg=mstCistCfg, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortRole=stpInfoPortRole, lacp=lacp, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistRootPathCost=cistRootPathCost, vlanInfoPorts=vlanInfoPorts, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbTable=fdbTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoHoldTime=stpInfoHoldTime, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortState=stgCurCfgPortState, lacpInfo=lacpInfo, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, stpStats=stpStats, stpInfoTableEntry=stpInfoTableEntry, cistRootPort=cistRootPort, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgState=mstCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortState=stpInfoPortState, fdbInfo=fdbInfo, fdbStatsLookups=fdbStatsLookups, portTeamCurCfgIndex=portTeamCurCfgIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsFinds=fdbStatsFinds, stpInfoMaxAge=stpInfoMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCfg=mstCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, fdbMacAddr=fdbMacAddr, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2=layer2, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfo=cistInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoTable=stpInfoTable, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbVlan=fdbVlan)
