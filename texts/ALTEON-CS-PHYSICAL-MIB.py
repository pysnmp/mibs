...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsLookups=fdbStatsLookups, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mirrPortMirr=mirrPortMirr, cistInfoPortTable=cistInfoPortTable, cistInfo=cistInfo, fdbSrcPort=fdbSrcPort, cistRegionalRoot=cistRegionalRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgState=stgNewCfgState, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTable=stpInfoTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsFinds=fdbStatsFinds, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPort=cistRootPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, fdbLearnedPort=fdbLearnedPort, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfo=portTeamInfo, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortPathCost=cistInfoPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCfg=stgCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoTable=portTeamInfoTable, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoStatus=vlanInfoStatus, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, fdbRefSps=fdbRefSps, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRoot=cistRoot, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, fdbEntry=fdbEntry, vlanCurCfgLearn=vlanCurCfgLearn, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgTable=stgNewCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortRole=cistInfoPortRole, vlanInfo=vlanInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, fdbMacAddr=fdbMacAddr, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbClear=fdbClear, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCfg=mstCistCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsCreates=fdbStatsCreates, layer2Configs=layer2Configs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstNewCfgState=mstNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortState=lacpNewPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanMaxVlanID=vlanMaxVlanID, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgVlanName=vlanNewCfgVlanName, BridgeId=BridgeId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRootPathCost=cistRootPathCost, vlanInfoId=vlanInfoId, vlanInfoName=vlanInfoName, vlanInfoTableEntry=vlanInfoTableEntry, layer2Stats=layer2Stats, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbTable=fdbTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, PYSNMP_MODULE_ID=layer2, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortState=stpInfoPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoJumbo=vlanInfoJumbo, vlanMaxEnt=vlanMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCfg=portTeamCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortTable=stgStatsPortTable, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgState=vlanNewCfgState, mstCurCfgState=mstCurCfgState, fdbInfo=fdbInfo, vlanInfoTable=vlanInfoTable, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStats=fdbStats, cistInfoPortState=cistInfoPortState, stgCurCfgTable=stgCurCfgTable, stpStats=stpStats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoRootCost=stpInfoRootCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgState=trunkGroupNewCfgState, vlan=vlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoIndex=stpInfoIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfo=lacpInfo, layer2=layer2, mstGeneralCfg=mstGeneralCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkgroup=trunkgroup, lacp=lacp, mstCfg=mstCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbState=fdbState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgState=vlanCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgState=portTeamNewCfgState, vlanInfoLearn=vlanInfoLearn, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoState=portTeamInfoState, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, layer2Oper=layer2Oper)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsHiwat=fdbStatsHiwat, layer2Info=layer2Info, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoIndex=portTeamInfoIndex, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mirroring=mirroring, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbVlan=fdbVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfo=stpInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime)
