...
Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, ObjectIdentity, Counter64, IpAddress, Integer32, Bits, MibIdentifier, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "ObjectIdentity", "Counter64", "IpAddress", "Integer32", "Bits", "MibIdentifier", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPriority=stgCurCfgPriority, mirroring=mirroring, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortTable=cistInfoPortTable, lacpInfoPortSelected=lacpInfoPortSelected, layer2Oper=layer2Oper, stpStats=stpStats, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRoot=cistRoot, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistRootPathCost=cistRootPathCost, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortTable=stgStatsPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoTable=portTeamInfoTable, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbClear=fdbClear, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortIndex=cistInfoPortIndex, cistRegionalPathCost=cistRegionalPathCost, vlanMaxEnt=vlanMaxEnt, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistRootPort=cistRootPort, mstCistCfg=mstCistCfg, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgTable=stgCurCfgTable, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfo=portTeamInfo, stgNewCfgPortTable=stgNewCfgPortTable, cistInfo=cistInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, vlanInfo=vlanInfo, fdbEntry=fdbEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbInfo=fdbInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortTable=stpInfoPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortTable=lacpInfoPortTable, vlanInfoPorts=vlanInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortRole=cistInfoPortRole, mirrPortMirr=mirrPortMirr, layer2Configs=layer2Configs, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgTable=vlanNewCfgTable, stpInfoTable=stpInfoTable, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFinds=fdbStatsFinds, stgCurCfgState=stgCurCfgState, vlanCurCfgState=vlanCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbVlan=fdbVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoRootPort=stpInfoRootPort, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoRootCost=stpInfoRootCost, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortState=cistInfoPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCfg=mstCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoIndex=stpInfoIndex, stpInfo=stpInfo, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsCreates=fdbStatsCreates, vlanInfoId=vlanInfoId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, layer2Stats=layer2Stats, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stgCfg=stgCfg, vlan=vlan, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgState=mstNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbState=fdbState, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbLearnedPort=fdbLearnedPort, mstCurCfgState=mstCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, PYSNMP_MODULE_ID=layer2, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstGeneralCfg=mstGeneralCfg, layer2Info=layer2Info, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortLink=stgCurCfgPortLink, fdbStats=fdbStats, lacp=lacp, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCurCfgIndex=portTeamCurCfgIndex, cistGeneralInfo=cistGeneralInfo, BridgeId=BridgeId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTopChanges=stpInfoTopChanges, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTable=vlanInfoTable, portTeamCfg=portTeamCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoName=vlanInfoName, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortRole=stpInfoPortRole, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoLearn=vlanInfoLearn, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookups=fdbStatsLookups, lacpNewPortState=lacpNewPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbRefSps=fdbRefSps, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortState=lacpCurPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRegionalRoot=cistRegionalRoot, layer2=layer2, stpInfoPortState=stpInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortLinkType=cistInfoPortLinkType, trunkgroup=trunkgroup, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbTable=fdbTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent)
