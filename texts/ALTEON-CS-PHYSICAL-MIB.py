...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortState=cistInfoPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortRole=stpInfoPortRole, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Configs=layer2Configs, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCfg=stgCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbSrcPort=fdbSrcPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanMaxVlanID=vlanMaxVlanID, PYSNMP_MODULE_ID=layer2, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mirroring=mirroring, lacpInfoPortMoved=lacpInfoPortMoved, mstNewCfgRegionName=mstNewCfgRegionName, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoHoldTime=stpInfoHoldTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCfg=mstCistCfg, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgState=stgNewCfgState, fdbStatsFindFails=fdbStatsFindFails, stpStats=stpStats, vlanCurCfgState=vlanCurCfgState, vlanMaxEnt=vlanMaxEnt, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfo=cistInfo, fdbLearnedPort=fdbLearnedPort, stpInfoHelloTime=stpInfoHelloTime, layer2=layer2, portTeamInfo=portTeamInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoId=vlanInfoId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCfg=mstCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStats=fdbStats, layer2Oper=layer2Oper, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgState=stgCurCfgState, stpInfoPortState=stpInfoPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfo=vlanInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgStg=vlanCurCfgStg, portTeamInfoTable=portTeamInfoTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoMaxAge=stpInfoMaxAge, fdbMacAddr=fdbMacAddr, layer2Info=layer2Info, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, mstCurCfgState=mstCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbInfo=fdbInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgState=mstNewCfgState, fdbTable=fdbTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortTable=cistInfoPortTable, lacpNewPortState=lacpNewPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mirrPortMirr=mirrPortMirr, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacp=lacp, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsHiwat=fdbStatsHiwat, stpInfoRootPort=stpInfoRootPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbVlan=fdbVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfo=lacpInfo, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, cistGeneralInfo=cistGeneralInfo, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbClear=fdbClear, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRoot=cistRoot, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, vlan=vlan, vlanInfoPorts=vlanInfoPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCfg=portTeamCfg, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbEntry=fdbEntry, stpInfo=stpInfo, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistRegionalRoot=cistRegionalRoot, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfoName=vlanInfoName, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoIndex=stpInfoIndex, vlanInfoStatus=vlanInfoStatus, pmNewCfgAddVlan=pmNewCfgAddVlan, cistRootPort=cistRootPort, layer2Stats=layer2Stats, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfoTableEntry=portTeamInfoTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoState=portTeamInfoState, BridgeId=BridgeId, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortState=lacpCurPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkgroup=trunkgroup, fdbRefSps=fdbRefSps, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoTable=stpInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFinds=fdbStatsFinds, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbState=fdbState, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks)
