...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCfg=stgCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsHiwat=fdbStatsHiwat, cistInfo=cistInfo, fdbLearnedPort=fdbLearnedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoPortsState=portTeamInfoPortsState, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfo=vlanInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoMaxAge=stpInfoMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgState=stgNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfo=lacpInfo, fdbTable=fdbTable, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoTable=portTeamInfoTable, stpInfoPortIndex=stpInfoPortIndex, fdbEntry=fdbEntry, stpInfoForwardDelay=stpInfoForwardDelay, fdbStats=fdbStats, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsOverflows=fdbStatsOverflows, fdbVlan=fdbVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortNtt=lacpInfoPortNtt, mstCistBridgeCfg=mstCistBridgeCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistGeneralInfo=cistGeneralInfo, stgCurCfgState=stgCurCfgState, fdbClear=fdbClear, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPorts=portTeamInfoPorts, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpStats=stpStats, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortTable=stpInfoPortTable, stpInfoTable=stpInfoTable, fdbMacAddr=fdbMacAddr, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRootPathCost=cistRootPathCost, fdbState=fdbState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Oper=layer2Oper, cistRegionalRoot=cistRegionalRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mirrPortMirr=mirrPortMirr, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistRoot=cistRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstGeneralCfg=mstGeneralCfg, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgState=mstCurCfgState, stpInfoRootPort=stpInfoRootPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortState=lacpCurPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbInfo=fdbInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanInfoName=vlanInfoName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, stpInfo=stpInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsCreates=fdbStatsCreates, cistRootPort=cistRootPort, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoState=portTeamInfoState, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacp=lacp, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortState=stpInfoPortState, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgTable=stgCurCfgTable, fdbStatsCurrent=fdbStatsCurrent, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortState=cistInfoPortState, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgTable=portTeamCurCfgTable, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Info=layer2Info, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbRefSps=fdbRefSps, vlanInfoTable=vlanInfoTable, vlanNewCfgState=vlanNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, mirroring=mirroring, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortState=lacpNewPortState, stgNewCfgTable=stgNewCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortRole=stpInfoPortRole, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, layer2Stats=layer2Stats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, layer2=layer2, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortIndex=cistInfoPortIndex, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoIndex=stpInfoIndex, stpInfoTopChanges=stpInfoTopChanges, trunkgroup=trunkgroup, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, stpInfoHelloTime=stpInfoHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, layer2Configs=layer2Configs, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlan=vlan, portTeamCfg=portTeamCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfoPortPriority=cistInfoPortPriority, vlanInfoId=vlanInfoId, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, BridgeId=BridgeId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoRootCost=stpInfoRootCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoLearn=vlanInfoLearn, portTeamInfo=portTeamInfo, mstCfg=mstCfg, lacpCurPortCfgTable=lacpCurPortCfgTable)
