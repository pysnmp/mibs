...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCfg=stgCfg, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, cistRegionalRoot=cistRegionalRoot, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortPriority=cistInfoPortPriority, vlanInfo=vlanInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfo=stpInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortIndex=stgStatsPortIndex, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoTopChanges=stpInfoTopChanges, vlanInfoId=vlanInfoId, mstGeneralCfg=mstGeneralCfg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbSrcPort=fdbSrcPort, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2Stats=layer2Stats, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, stpStats=stpStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, mstCistCfg=mstCistCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacp=lacp, stpInfoMaxAge=stpInfoMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbInfo=fdbInfo, portTeamNewCfgState=portTeamNewCfgState, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbMacAddr=fdbMacAddr, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTable=stpInfoTable, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbState=fdbState, layer2Oper=layer2Oper, lacpInfoPortMoved=lacpInfoPortMoved, fdbLearnedPort=fdbLearnedPort, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgState=stgNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsFinds=fdbStatsFinds, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootPort=stpInfoRootPort, mstNewCfgState=mstNewCfgState, stgCurCfgState=stgCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbVlan=fdbVlan, fdbStats=fdbStats, stpInfoIndex=stpInfoIndex, vlanInfoJumbo=vlanInfoJumbo, vlanInfoPorts=vlanInfoPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortRole=cistInfoPortRole, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgTable=vlanCurCfgTable, stgStatsStpIndex=stgStatsStpIndex, vlanMaxEnt=vlanMaxEnt, stpInfoPortState=stpInfoPortState, fdbStatsFindFails=fdbStatsFindFails, mirrPortMirr=mirrPortMirr, cistInfoPortTable=cistInfoPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRootPathCost=cistRootPathCost, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortState=lacpCurPortState, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgIndex=stgCurCfgIndex, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoIndex=portTeamInfoIndex, layer2Info=layer2Info, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, cistRoot=cistRoot, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRootPort=cistRootPort, stgCurCfgPriority=stgCurCfgPriority, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortLinkType=stpInfoPortLinkType, cistInfo=cistInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, layer2Configs=layer2Configs, stpInfoPortIndex=stpInfoPortIndex, fdbClear=fdbClear, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlan=vlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsDeletes=fdbStatsDeletes, fdbRefSps=fdbRefSps, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkgroup=trunkgroup, mirroring=mirroring, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTable=portTeamInfoTable, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbTable=fdbTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsOverflows=fdbStatsOverflows, lacpInfo=lacpInfo, fdbStatsCurrent=fdbStatsCurrent, fdbStatsCreates=fdbStatsCreates, mstCurCfgState=mstCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsLookups=fdbStatsLookups, vlanNewCfgTable=vlanNewCfgTable, mstCfg=mstCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2=layer2, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortRole=stpInfoPortRole, BridgeId=BridgeId, stgNewCfgTable=stgNewCfgTable, vlanInfoStatus=vlanInfoStatus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoTable=vlanInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoName=vlanInfoName, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCfg=portTeamCfg, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex)
