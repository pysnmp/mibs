...
MibIdentifier, ModuleIdentity, Unsigned32, TimeTicks, Counter64, NotificationType, ObjectIdentity, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter64", "NotificationType", "ObjectIdentity", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortRole=cistInfoPortRole, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacp=lacp, fdbTable=fdbTable, portTeamNewCfgState=portTeamNewCfgState, mstCfg=mstCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfo=vlanInfo, vlanInfoPorts=vlanInfoPorts, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsFinds=fdbStatsFinds, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbSrcPort=fdbSrcPort, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoId=vlanInfoId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbRefSps=fdbRefSps, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortState=cistInfoPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanMaxVlanID=vlanMaxVlanID, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgTable=stgCurCfgTable, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, PYSNMP_MODULE_ID=layer2, portTeamInfoPorts=portTeamInfoPorts, mstCistCfg=mstCistCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, vlanInfoLearn=vlanInfoLearn, stpStats=stpStats, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistRootPathCost=cistRootPathCost, mstNewCfgState=mstNewCfgState, trunkgroup=trunkgroup, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlan=vlan, stpInfoPortTable=stpInfoPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgState=vlanNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, cistRootPort=cistRootPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistRoot=cistRoot, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfo=portTeamInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoRootCost=stpInfoRootCost, layer2Oper=layer2Oper, mirroring=mirroring, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortIndex=stpInfoPortIndex, cistGeneralInfo=cistGeneralInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoState=portTeamInfoState, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTable=stgStatsPortTable, fdbInfo=fdbInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStats=fdbStats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsCurrent=fdbStatsCurrent, fdbEntry=fdbEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, layer2Configs=layer2Configs, lacpCurPortState=lacpCurPortState, stgCfg=stgCfg, fdbSrcTrunk=fdbSrcTrunk, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, fdbLearnedPort=fdbLearnedPort, layer2=layer2, lacpNewPortState=lacpNewPortState, stgNewCfgPortState=stgNewCfgPortState, fdbClear=fdbClear, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoIndex=stpInfoIndex, lacpInfo=lacpInfo, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoName=vlanInfoName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstGeneralCfg=mstGeneralCfg, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTable=stpInfoTable, mirrPortMirr=mirrPortMirr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgState=vlanCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, BridgeId=BridgeId, fdbVlan=fdbVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, portTeamCfg=portTeamCfg, stpInfo=stpInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, fdbMacAddr=fdbMacAddr, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPriority=stgCurCfgPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsLookups=fdbStatsLookups, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortTable=cistInfoPortTable, mstCurCfgState=mstCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Stats=layer2Stats, cistInfo=cistInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistBridgeCfg=mstCistBridgeCfg, fdbState=fdbState, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortState=stpInfoPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanMaxEnt=vlanMaxEnt, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Info=layer2Info, stgCurCfgState=stgCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgState=stgNewCfgState)
