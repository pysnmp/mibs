...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoIndex=stpInfoIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoHoldTime=stpInfoHoldTime, layer2=layer2, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbInfo=fdbInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbSrcPort=fdbSrcPort, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, PYSNMP_MODULE_ID=layer2, stgCfg=stgCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, mstNewCfgState=mstNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsLookupFails=fdbStatsLookupFails, layer2Oper=layer2Oper, fdbStats=fdbStats, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortRole=cistInfoPortRole, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRoot=cistRoot, stgCurCfgTable=stgCurCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoRootPort=stpInfoRootPort, cistInfo=cistInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortPathCost=cistInfoPortPathCost, vlan=vlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortEdge=stgNewCfgPortEdge, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortState=cistInfoPortState, vlanInfoPorts=vlanInfoPorts, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mirrPortMirr=mirrPortMirr, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanInfoId=vlanInfoId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, lacp=lacp, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCfg=portTeamCfg, cistRegionalRoot=cistRegionalRoot, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistBridgeHelloTime=cistBridgeHelloTime, fdbRefSps=fdbRefSps, portTeamInfo=portTeamInfo, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCfg=mstCfg, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortRole=stpInfoPortRole, cistInfoPortIndex=cistInfoPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoPorts=portTeamInfoPorts, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgState=vlanCurCfgState, stgNewCfgTable=stgNewCfgTable, stgNewCfgState=stgNewCfgState, layer2Stats=layer2Stats, lacpCurSystemPriority=lacpCurSystemPriority, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbTable=fdbTable, vlanInfoJumbo=vlanInfoJumbo, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirroring=mirroring, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfo=stpInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortState=lacpCurPortState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbEntry=fdbEntry, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortTable=stgStatsPortTable, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortState=stpInfoPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkgroup=trunkgroup, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCfg=mstCistCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfo=vlanInfo, lacpNewPortState=lacpNewPortState, lacpInfo=lacpInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoRootCost=stpInfoRootCost, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, layer2Configs=layer2Configs, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgAddVlan=stgNewCfgAddVlan, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, cistRootPathCost=cistRootPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbVlan=fdbVlan, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgState=vlanNewCfgState, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, BridgeId=BridgeId, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCurCfgState=mstCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoState=portTeamInfoState, fdbState=fdbState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbMacAddr=fdbMacAddr, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Info=layer2Info, stpStats=stpStats, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbClear=fdbClear, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgState=portTeamNewCfgState, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistRootPort=cistRootPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgState=stgCurCfgState, portTeamInfoTable=portTeamInfoTable, stpInfoTable=stpInfoTable, mstNewCfgRegionName=mstNewCfgRegionName)
