...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgState=portTeamNewCfgState, layer2Stats=layer2Stats, vlanInfoStatus=vlanInfoStatus, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, vlanInfoPorts=vlanInfoPorts, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortState=cistInfoPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfo=vlanInfo, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, PYSNMP_MODULE_ID=layer2, cistBridgeForwardDelay=cistBridgeForwardDelay, mirrPortMirr=mirrPortMirr, cistRegionalRoot=cistRegionalRoot, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCfg=mstCistCfg, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, BridgeId=BridgeId, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTable=cistInfoPortTable, vlanCurCfgState=vlanCurCfgState, fdbTable=fdbTable, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortTable=stgNewCfgPortTable, cistRootPathCost=cistRootPathCost, fdbStatsFindFails=fdbStatsFindFails, fdbSrcPort=fdbSrcPort, vlanInfoId=vlanInfoId, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbState=fdbState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbInfo=fdbInfo, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortRole=cistInfoPortRole, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoJumbo=vlanInfoJumbo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCfg=stgCfg, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortState=lacpCurPortState, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, lacpInfo=lacpInfo, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbRefSps=fdbRefSps, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, vlan=vlan, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbEntry=fdbEntry, layer2=layer2, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsLookups=fdbStatsLookups, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsFinds=fdbStatsFinds, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoRootCost=stpInfoRootCost, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, lacp=lacp, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgTable=stgNewCfgTable, cistInfo=cistInfo, vlanInfoName=vlanInfoName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsCreates=fdbStatsCreates, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortTable=stpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgState=mstCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortRole=stpInfoPortRole, mstCfg=mstCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbLearnedPort=fdbLearnedPort, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTable=portTeamInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgState=vlanNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortState=lacpNewPortState, stgCurCfgState=stgCurCfgState, fdbStats=fdbStats, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsStpIndex=stgStatsStpIndex, stpInfoIndex=stpInfoIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, mstGeneralCfg=mstGeneralCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfo=portTeamInfo, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Info=layer2Info, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, layer2Oper=layer2Oper, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgStpMode=mstCurCfgStpMode, cistRootPort=cistRootPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbMacAddr=fdbMacAddr, portTeamInfoState=portTeamInfoState, fdbStatsCurrent=fdbStatsCurrent, mirroring=mirroring, cistGeneralInfo=cistGeneralInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, stpStats=stpStats, stgNewCfgPortPathCost=stgNewCfgPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoTable=stpInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgState=mstNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoTable=vlanInfoTable, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortPriority=cistInfoPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgState=stgNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbVlan=fdbVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Configs=layer2Configs, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortEdge=stpInfoPortEdge, stpInfo=stpInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRoot=cistRoot, fdbClear=fdbClear, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortState=stpInfoPortState)
