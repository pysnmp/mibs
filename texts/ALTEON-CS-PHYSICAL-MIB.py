...
ObjectIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, NotificationType, IpAddress, Gauge32, MibIdentifier, Counter64, Counter32, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbEntry=fdbEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, vlan=vlan, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoTable=stpInfoTable, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoStatus=vlanInfoStatus, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgState=mstCurCfgState, lacpCurPortState=lacpCurPortState, vlanInfoId=vlanInfoId, portTeamInfoState=portTeamInfoState, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, layer2Stats=layer2Stats, stgNewCfgState=stgNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacp=lacp, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgPorts=vlanCurCfgPorts, fdbClear=fdbClear, vlanInfoBwmContract=vlanInfoBwmContract, fdbSrcTrunk=fdbSrcTrunk, lacpCurSystemPriority=lacpCurSystemPriority, mirroring=mirroring, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortTable=cistInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, BridgeId=BridgeId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTable=portTeamInfoTable, fdbRefSps=fdbRefSps, stpInfoRootPort=stpInfoRootPort, lacpInfo=lacpInfo, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpStats=stpStats, cistRootPathCost=cistRootPathCost, mstCistBridgeCfg=mstCistBridgeCfg, cistRootPort=cistRootPort, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoIndex=portTeamInfoIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortState=cistInfoPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortState=lacpNewPortState, vlanMaxEnt=vlanMaxEnt, stpInfoPortPathCost=stpInfoPortPathCost, layer2Info=layer2Info, stpInfoPortLinkType=stpInfoPortLinkType, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Oper=layer2Oper, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoMaxAge=stpInfoMaxAge, layer2=layer2, fdbStatsDeletes=fdbStatsDeletes, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortPathCost=cistInfoPortPathCost, fdbStats=fdbStats, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgState=vlanNewCfgState, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgState=vlanCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoIndex=stpInfoIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanInfoTable=vlanInfoTable, vlanInfoName=vlanInfoName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortTable=stpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCfg=portTeamCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, cistRegionalRoot=cistRegionalRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoRootCost=stpInfoRootCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbTable=fdbTable, mstNewCfgState=mstNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgIndex=stgNewCfgIndex, fdbStatsLookups=fdbStatsLookups, vlanInfo=vlanInfo, stpInfoPortState=stpInfoPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgState=stgCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, cistGeneralInfo=cistGeneralInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbVlan=fdbVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCfg=stgCfg, mstGeneralCfg=mstGeneralCfg, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortTable=lacpInfoPortTable, mstCfg=mstCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPriority=stgNewCfgPriority, fdbState=fdbState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoJumbo=vlanInfoJumbo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfo=portTeamInfo, fdbStatsFindFails=fdbStatsFindFails, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoHelloTime=stpInfoHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, layer2Configs=layer2Configs, stgStatsPortTable=stgStatsPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortIndex=stgStatsPortIndex, fdbLearnedPort=fdbLearnedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortMoved=lacpInfoPortMoved, stpInfo=stpInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCfg=mstCistCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsStpIndex=stgStatsStpIndex, cistInfo=cistInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkgroup=trunkgroup, fdbInfo=fdbInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrPortMirr=mirrPortMirr, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbMacAddr=fdbMacAddr, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortRole=stpInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoLearn=vlanInfoLearn, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistRoot=cistRoot, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortRole=cistInfoPortRole, fdbStatsFinds=fdbStatsFinds, vlanNewCfgJumbo=vlanNewCfgJumbo)
