...
TimeTicks, Integer32, Unsigned32, ModuleIdentity, MibIdentifier, ObjectIdentity, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfo=cistInfo, layer2Oper=layer2Oper, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfo=stpInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCfg=stgCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistRootPathCost=cistRootPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgTable=stgCurCfgTable, mstCistCfg=mstCistCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgState=portTeamNewCfgState, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfo=vlanInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCurCfgState=portTeamCurCfgState, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoId=vlanInfoId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbTable=fdbTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortNtt=lacpInfoPortNtt, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbMacAddr=fdbMacAddr, stpInfoPortState=stpInfoPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mirroring=mirroring, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbVlan=fdbVlan, stpStats=stpStats, cistRoot=cistRoot, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCfg=portTeamCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewPortState=lacpNewPortState, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoRootCost=stpInfoRootCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortState=cistInfoPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbInfo=fdbInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, fdbState=fdbState, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Configs=layer2Configs, fdbStatsLookups=fdbStatsLookups, cistRegionalPathCost=cistRegionalPathCost, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStats=fdbStats, vlanInfoPorts=vlanInfoPorts, portTeamInfo=portTeamInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, cistInfoPortRole=cistInfoPortRole, mstGeneralCfg=mstGeneralCfg, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2Stats=layer2Stats, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Info=layer2Info, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgState=mstNewCfgState, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, cistGeneralInfo=cistGeneralInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfo=lacpInfo, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mirrPortMirr=mirrPortMirr, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbRefSps=fdbRefSps, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortTable=cistInfoPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortTable=lacpInfoPortTable, lacp=lacp, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRootPort=cistRootPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTable=stpInfoPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, PYSNMP_MODULE_ID=layer2, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlan=vlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoTable=vlanInfoTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, BridgeId=BridgeId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgState=stgCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoTable=portTeamInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoIndex=stpInfoIndex, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgState=stgNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgState=mstCurCfgState, fdbStatsOverflows=fdbStatsOverflows, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortRole=stpInfoPortRole, stgStatsPortTable=stgStatsPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgState=vlanCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCfg=mstCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTable=stpInfoTable, vlanInfoName=vlanInfoName, fdbSrcPort=fdbSrcPort, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsHiwat=fdbStatsHiwat, trunkgroup=trunkgroup, fdbClear=fdbClear, vlanNewCfgState=vlanNewCfgState, layer2=layer2, stgCurCfgPortPriority=stgCurCfgPortPriority)
