...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortRole=stpInfoPortRole, stgNewCfgTable=stgNewCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgDelete=vlanNewCfgDelete, mstCfg=mstCfg, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbMacAddr=fdbMacAddr, fdbRefSps=fdbRefSps, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2=layer2, cistInfoPortIndex=cistInfoPortIndex, fdbInfo=fdbInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsLookupFails=fdbStatsLookupFails, portTeamTableMaxSize=portTeamTableMaxSize, BridgeId=BridgeId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortTableEntry=stgStatsPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgTable=stgCurCfgTable, fdbStatsHiwat=fdbStatsHiwat, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfo=cistInfo, fdbLearnedPort=fdbLearnedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoName=vlanInfoName, cistInfoPortTableEntry=cistInfoPortTableEntry, vlan=vlan, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstNewCfgStpMode=mstNewCfgStpMode, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mirrPortMirr=mirrPortMirr, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgState=stgCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfo=vlanInfo, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoState=portTeamInfoState, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTable=portTeamInfoTable, cistRoot=cistRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbTable=fdbTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgState=mstCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mirroring=mirroring, layer2Stats=layer2Stats, portTeamInfo=portTeamInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortIndex=stgStatsPortIndex, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortPriority=stgCurCfgPortPriority, cistRootPathCost=cistRootPathCost, PYSNMP_MODULE_ID=layer2, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStats=fdbStats, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoTable=stpInfoTable, mstGeneralCfg=mstGeneralCfg, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgState=stgNewCfgState, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, fdbStatsCreates=fdbStatsCreates, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistRootPort=cistRootPort, vlanInfoId=vlanInfoId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbEntry=fdbEntry, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, vlanInfoStatus=vlanInfoStatus, fdbState=fdbState, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbSrcPort=fdbSrcPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfo=stpInfo, vlanCurCfgStg=vlanCurCfgStg, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, lacpNewSystemPriority=lacpNewSystemPriority, layer2Oper=layer2Oper, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTable=stgStatsPortTable, stpInfoRootCost=stpInfoRootCost, lacpCurPortState=lacpCurPortState, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoMaxAge=stpInfoMaxAge, stgStatsStpIndex=stgStatsStpIndex, lacpInfo=lacpInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistRegionalPathCost=cistRegionalPathCost, trunkgroup=trunkgroup, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFinds=fdbStatsFinds, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoIndex=stpInfoIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbVlan=fdbVlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRegionalRoot=cistRegionalRoot, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgState=vlanNewCfgState, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgState=mstNewCfgState, lacp=lacp, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpStats=stpStats, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortState=lacpNewPortState, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortState=cistInfoPortState, stpInfoPortState=stpInfoPortState, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, layer2Configs=layer2Configs, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Info=layer2Info, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistGeneralInfo=cistGeneralInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistBridgeCfg=mstCistBridgeCfg, stgCfg=stgCfg, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortRole=cistInfoPortRole, portTeamCfg=portTeamCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime)
