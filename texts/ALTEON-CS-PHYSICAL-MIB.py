...
ObjectIdentity, IpAddress, ModuleIdentity, TimeTicks, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Gauge32, Counter32, NotificationType, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "ModuleIdentity", "TimeTicks", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Gauge32", "Counter32", "NotificationType", "iso", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoId=vlanInfoId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortTable=stpInfoPortTable, stpInfoIndex=stpInfoIndex, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoJumbo=vlanInfoJumbo, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, mirrPortMirr=mirrPortMirr, lacpNewPortState=lacpNewPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCfg=mstCistCfg, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgTable=stgNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoLearn=vlanInfoLearn, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgState=vlanCurCfgState, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, lacp=lacp, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, layer2Info=layer2Info, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgState=portTeamCurCfgState, cistRoot=cistRoot, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, stpInfo=stpInfo, vlan=vlan, vlanMaxEnt=vlanMaxEnt, fdbLearnedPort=fdbLearnedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurPortState=lacpCurPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgState=mstNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCfg=stgCfg, portTeamNewCfgState=portTeamNewCfgState, fdbEntry=fdbEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfo=portTeamInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortTable=stgStatsPortTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoHelloTime=stpInfoHelloTime, vlanInfo=vlanInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortRole=stpInfoPortRole, portTeamCurCfgPorts=portTeamCurCfgPorts, PYSNMP_MODULE_ID=layer2, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, cistRootPathCost=cistRootPathCost, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoPorts=portTeamInfoPorts, cistBridgeMaxAge=cistBridgeMaxAge, layer2Configs=layer2Configs, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCfg=portTeamCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, stpStats=stpStats, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCfg=mstCfg, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTableEntry=stpInfoTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFinds=fdbStatsFinds, cistInfoPortRole=cistInfoPortRole, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2=layer2, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbSrcPort=fdbSrcPort, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgStg=vlanCurCfgStg, vlanInfoPorts=vlanInfoPorts, mstCurCfgState=mstCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkgroup=trunkgroup, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgState=stgNewCfgState, fdbStats=fdbStats, layer2Oper=layer2Oper, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgPorts=vlanNewCfgPorts, BridgeId=BridgeId, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbClear=fdbClear, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbTable=fdbTable, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoTable=stpInfoTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbVlan=fdbVlan, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsHiwat=fdbStatsHiwat, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbInfo=fdbInfo, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirroring=mirroring, stgCurCfgPriority=stgCurCfgPriority, fdbRefSps=fdbRefSps, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbState=fdbState, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoStatus=vlanInfoStatus, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistRegionalPathCost=cistRegionalPathCost, cistInfo=cistInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRootPort=cistRootPort, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgState=stgCurCfgState, cistInfoPortState=cistInfoPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTable=portTeamInfoTable, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTrunks=portTeamInfoTrunks, mstGeneralCfg=mstGeneralCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortState=stpInfoPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRegionalRoot=cistRegionalRoot, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfo=lacpInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortSelected=lacpInfoPortSelected, layer2Stats=layer2Stats, portTeamInfoState=portTeamInfoState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract)
