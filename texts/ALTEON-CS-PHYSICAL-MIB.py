...
Integer32, Unsigned32, Counter64, IpAddress, MibIdentifier, ObjectIdentity, ModuleIdentity, NotificationType, Counter32, iso, Gauge32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "IpAddress", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter32", "iso", "Gauge32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacp=lacp, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbEntry=fdbEntry, layer2Configs=layer2Configs, fdbSrcTrunk=fdbSrcTrunk, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkgroup=trunkgroup, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoIndex=stpInfoIndex, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgIndex=stgNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbTable=fdbTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, stpStats=stpStats, stpInfoPortEdge=stpInfoPortEdge, BridgeId=BridgeId, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbState=fdbState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTableEntry=stpInfoTableEntry, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, cistRootPort=cistRootPort, vlanInfoLearn=vlanInfoLearn, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, fdbClear=fdbClear, fdbStats=fdbStats, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFindFails=fdbStatsFindFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortState=cistInfoPortState, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTopChanges=stpInfoTopChanges, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortState=stgCurCfgPortState, vlanInfo=vlanInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoRootCost=stpInfoRootCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoBwmContract=vlanInfoBwmContract, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfo=lacpInfo, lacpNewPortState=lacpNewPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoTable=stpInfoTable, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, layer2Stats=layer2Stats, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoPorts=vlanInfoPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoName=vlanInfoName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbInfo=fdbInfo, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoTable=portTeamInfoTable, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, layer2Info=layer2Info, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, vlan=vlan, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgState=mstNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, stgCfg=stgCfg, stgCurCfgPriority=stgCurCfgPriority, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFinds=fdbStatsFinds, fdbStatsHiwat=fdbStatsHiwat, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortRole=cistInfoPortRole, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsLookups=fdbStatsLookups, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoState=portTeamInfoState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortState=stpInfoPortState, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoId=vlanInfoId, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Oper=layer2Oper, fdbLearnedPort=fdbLearnedPort, cistRoot=cistRoot, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoRootPort=stpInfoRootPort, vlanInfoJumbo=vlanInfoJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeMaxAge=cistBridgeMaxAge, fdbMacAddr=fdbMacAddr, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfo=stpInfo, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcPort=fdbSrcPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCfg=portTeamCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsDeletes=fdbStatsDeletes, mirroring=mirroring, mirrPortMirr=mirrPortMirr, cistRegionalRoot=cistRegionalRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfo=cistInfo, fdbVlan=fdbVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCfg=mstCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfo=portTeamInfo, stgCurCfgState=stgCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCfg=mstCistCfg, fdbStatsOverflows=fdbStatsOverflows, fdbRefSps=fdbRefSps, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortPathCost=stpInfoPortPathCost, layer2=layer2, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTable=portTeamNewCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoIndex=portTeamInfoIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortTable=stgStatsPortTable, mstCurCfgState=mstCurCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgDelete=portTeamNewCfgDelete, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, cistRootPathCost=cistRootPathCost, vlanNewCfgTable=vlanNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgJumbo=vlanCurCfgJumbo)
