...
ModuleIdentity, Unsigned32, Gauge32, Integer32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, MibIdentifier, TimeTicks, Bits, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Gauge32", "Integer32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistGeneralInfo=cistGeneralInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbRefSps=fdbRefSps, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoTable=stpInfoTable, cistRoot=cistRoot, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkgroup=trunkgroup, vlanCurCfgPorts=vlanCurCfgPorts, layer2Stats=layer2Stats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTable=portTeamInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, BridgeId=BridgeId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortState=stpInfoPortState, stgCfg=stgCfg, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCistDefaultCfg=mstCistDefaultCfg, cistRootPort=cistRootPort, stpInfoRootCost=stpInfoRootCost, cistInfoPortTable=cistInfoPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortPriority=cistInfoPortPriority, stgStatsStpIndex=stgStatsStpIndex, layer2=layer2, lacpInfo=lacpInfo, stpInfoPortTable=stpInfoPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbLearnedPort=fdbLearnedPort, lacpCurPortState=lacpCurPortState, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfo=cistInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoTable=vlanInfoTable, cistRegionalPathCost=cistRegionalPathCost, mstNewCfgState=mstNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoPorts=vlanInfoPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbMacAddr=fdbMacAddr, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfo=portTeamInfo, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsLookups=fdbStatsLookups, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgPorts=vlanNewCfgPorts, fdbTable=fdbTable, fdbState=fdbState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, fdbVlan=fdbVlan, cistInfoPortRole=cistInfoPortRole, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrPortMirr=mirrPortMirr, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortState=cistInfoPortState, layer2Configs=layer2Configs, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsDeletes=fdbStatsDeletes, fdbInfo=fdbInfo, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgState=portTeamCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoLearn=vlanInfoLearn, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbClear=fdbClear, portTeamCurCfgTable=portTeamCurCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortMoved=lacpInfoPortMoved, fdbStats=fdbStats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacp=lacp, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Info=layer2Info, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFindFails=fdbStatsFindFails, fdbEntry=fdbEntry, cistRootPathCost=cistRootPathCost, cistInfoPortIndex=cistInfoPortIndex, vlanInfoName=vlanInfoName, stpInfoPortEdge=stpInfoPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoState=portTeamInfoState, vlanInfo=vlanInfo, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgState=stgNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRegionalRoot=cistRegionalRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsCurrent=fdbStatsCurrent, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoId=vlanInfoId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgState=mstCurCfgState, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgTable=stgCurCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoStatus=vlanInfoStatus, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCfg=portTeamCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgState=vlanCurCfgState, layer2Oper=layer2Oper, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoRootPort=stpInfoRootPort, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbSrcPort=fdbSrcPort, fdbStatsHiwat=fdbStatsHiwat, vlanMaxVlanID=vlanMaxVlanID)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortRole=stpInfoPortRole, portTeamInfoPorts=portTeamInfoPorts, fdbStatsLookupFails=fdbStatsLookupFails, vlan=vlan, stpInfoPortPathCost=stpInfoPortPathCost, stpInfo=stpInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpStats=stpStats, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsCreates=fdbStatsCreates, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgState=stgCurCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, PYSNMP_MODULE_ID=layer2, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCfg=mstCistCfg, mirroring=mirroring, mstCfg=mstCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry)
