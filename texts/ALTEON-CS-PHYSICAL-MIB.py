...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoTableEntry=vlanInfoTableEntry, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoTable=vlanInfoTable, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2Info=layer2Info, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfo=cistInfo, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mirrPortMirr=mirrPortMirr, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoMaxAge=stpInfoMaxAge, portTeamCfg=portTeamCfg, layer2Stats=layer2Stats, cistInfoPortPriority=cistInfoPortPriority, mstCistCfg=mstCistCfg, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgTable=stgNewCfgTable, stgCurCfgState=stgCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoTable=portTeamInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortEdge=stgNewCfgPortEdge, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoState=portTeamInfoState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortCfgTableId=lacpNewPortCfgTableId, BridgeId=BridgeId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoRootCost=stpInfoRootCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, mirroring=mirroring, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortState=stpInfoPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbClear=fdbClear, fdbSrcPort=fdbSrcPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistRegionalRoot=cistRegionalRoot, vlanInfoPorts=vlanInfoPorts, fdbVlan=fdbVlan, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoName=vlanInfoName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgTable=vlanCurCfgTable, portTeamCurCfgState=portTeamCurCfgState, stpInfoIndex=stpInfoIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPriority=stgNewCfgPriority, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpStats=stpStats, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstNewCfgState=mstNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfo=lacpInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortEdge=stpInfoPortEdge, fdbTable=fdbTable, cistRootPort=cistRootPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTableEntry=stpInfoTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCfg=mstCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgState=stgNewCfgState, cistGeneralInfo=cistGeneralInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortState=cistInfoPortState, lacpNewPortState=lacpNewPortState, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfo=vlanInfo, PYSNMP_MODULE_ID=layer2, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, layer2Oper=layer2Oper, stgCfg=stgCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbInfo=fdbInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoTable=stpInfoTable, vlanInfoJumbo=vlanInfoJumbo, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, fdbRefSps=fdbRefSps, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgStg=vlanCurCfgStg, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, cistRoot=cistRoot, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfo=portTeamInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanMaxEnt=vlanMaxEnt, stpInfoRootPort=stpInfoRootPort, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbMacAddr=fdbMacAddr, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfo=stpInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2=layer2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoId=vlanInfoId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgStg=vlanNewCfgStg, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgTable=stgCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgTable=vlanNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, vlan=vlan, fdbStatsFinds=fdbStatsFinds, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortLinkType=cistInfoPortLinkType, fdbEntry=fdbEntry, lacp=lacp, stpInfoPortPathCost=stpInfoPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStats=fdbStats, vlanInfoStatus=vlanInfoStatus, mstCurCfgStpMode=mstCurCfgStpMode, layer2Configs=layer2Configs, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistDefaultCfg=mstCistDefaultCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, fdbStatsCreates=fdbStatsCreates, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurPortState=lacpCurPortState, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkgroup=trunkgroup, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgState=vlanCurCfgState)
