...
Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, MibIdentifier, NotificationType, iso, Unsigned32, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCfg=portTeamCfg, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsCreates=fdbStatsCreates, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, layer2Info=layer2Info, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbClear=fdbClear, vlanInfo=vlanInfo, trunkgroup=trunkgroup, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCurCfgState=mstCurCfgState, lacp=lacp, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCfg=mstCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbTable=fdbTable, portTeamInfo=portTeamInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, BridgeId=BridgeId, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTable=stpInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsLookups=fdbStatsLookups, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoName=vlanInfoName, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortRole=cistInfoPortRole, cistRegionalPathCost=cistRegionalPathCost, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbRefSps=fdbRefSps, fdbStatsFindFails=fdbStatsFindFails, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortState=lacpNewPortState, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsDeletes=fdbStatsDeletes, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoTable=vlanInfoTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, PYSNMP_MODULE_ID=layer2, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoPorts=portTeamInfoPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbEntry=fdbEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, vlan=vlan, stgCurCfgPortState=stgCurCfgPortState, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoRootPort=stpInfoRootPort, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoIndex=stpInfoIndex, fdbLearnedPort=fdbLearnedPort, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistBridgeCfg=mstCistBridgeCfg, cistRootPort=cistRootPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortState=stpInfoPortState, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsOverflows=fdbStatsOverflows, fdbVlan=fdbVlan, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoIndex=portTeamInfoIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortPathCost=stpInfoPortPathCost, stpInfo=stpInfo, vlanCurCfgState=vlanCurCfgState, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgTable=stgNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgTable=stgCurCfgTable, layer2=layer2, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, mirrPortMirr=mirrPortMirr, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTable=portTeamInfoTable, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgState=vlanNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortTable=stgStatsPortTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoLearn=vlanInfoLearn, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortState=lacpCurPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbInfo=fdbInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbMacAddr=fdbMacAddr, fdbStatsFinds=fdbStatsFinds, vlanNewCfgStg=vlanNewCfgStg, cistInfo=cistInfo, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mirroring=mirroring, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoHelloTime=stpInfoHelloTime, vlanInfoId=vlanInfoId, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2Oper=layer2Oper, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoStatus=vlanInfoStatus, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCfg=stgCfg, vlanCurCfgTable=vlanCurCfgTable, layer2Stats=layer2Stats, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCfg=mstCistCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfo=lacpInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpStats=stpStats, layer2Configs=layer2Configs, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoRootCost=stpInfoRootCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstGeneralCfg=mstGeneralCfg, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRoot=cistRoot, cistInfoPortTable=cistInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRegionalRoot=cistRegionalRoot, vlanInfoTableEntry=vlanInfoTableEntry, cistGeneralInfo=cistGeneralInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStats=fdbStats, cistInfoPortState=cistInfoPortState, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, mstNewCfgState=mstNewCfgState, fdbState=fdbState, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
