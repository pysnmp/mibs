...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCfg=mstCistCfg, stpStats=stpStats, fdbMacAddr=fdbMacAddr, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortState=stpInfoPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFindFails=fdbStatsFindFails, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbInfo=fdbInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, cistRegionalRoot=cistRegionalRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoStatus=vlanInfoStatus, portTeamInfoState=portTeamInfoState, portTeamInfo=portTeamInfo, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, vlan=vlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbSrcPort=fdbSrcPort, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfo=cistInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoLearn=vlanInfoLearn, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewPortState=lacpNewPortState, cistRoot=cistRoot, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsFinds=fdbStatsFinds, fdbLearnedPort=fdbLearnedPort, stgCurCfgPortLink=stgCurCfgPortLink, layer2Stats=layer2Stats, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRootPathCost=cistRootPathCost, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRootPort=cistRootPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mirroring=mirroring, stpInfoTableEntry=stpInfoTableEntry, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgState=portTeamNewCfgState, fdbState=fdbState, trunkgroup=trunkgroup, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, vlanInfoName=vlanInfoName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoTableEntry=vlanInfoTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Oper=layer2Oper, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortState=stgCurCfgPortState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTable=portTeamInfoTable, stgStatsStpIndex=stgStatsStpIndex, mstNewCfgState=mstNewCfgState, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanMaxVlanID=vlanMaxVlanID, mstGeneralCfg=mstGeneralCfg, fdbStatsLookups=fdbStatsLookups, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, fdbStats=fdbStats, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgTable=stgCurCfgTable, stpInfoPortEdge=stpInfoPortEdge, mstCfg=mstCfg, stgNewCfgIndex=stgNewCfgIndex, cistGeneralInfo=cistGeneralInfo, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgStg=vlanNewCfgStg, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbRefSps=fdbRefSps, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTable=stpInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoTable=vlanInfoTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortPriority=cistInfoPortPriority, PYSNMP_MODULE_ID=layer2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsHiwat=fdbStatsHiwat, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbTable=fdbTable, vlanNewCfgState=vlanNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgStatsPortTable=stgStatsPortTable, lacpInfo=lacpInfo, stgNewCfgTable=stgNewCfgTable, stpInfoPortIndex=stpInfoPortIndex, stpInfoHelloTime=stpInfoHelloTime, BridgeId=BridgeId, layer2=layer2, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Configs=layer2Configs, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoId=vlanInfoId, stgCfg=stgCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurPortState=lacpCurPortState, stpInfo=stpInfo, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbEntry=fdbEntry, stpInfoIndex=stpInfoIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbVlan=fdbVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPriority=stgCurCfgPriority, layer2Info=layer2Info, vlanInfo=vlanInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortState=cistInfoPortState, lacp=lacp, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortRole=stpInfoPortRole, mstCurCfgState=mstCurCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbClear=fdbClear, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCfg=portTeamCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortTable=lacpInfoPortTable, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime)
