...
Gauge32, Bits, iso, NotificationType, IpAddress, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "iso", "NotificationType", "IpAddress", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgState=mstCurCfgState, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortState=stgNewCfgPortState, cistRegionalRoot=cistRegionalRoot, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoState=portTeamInfoState, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfo=portTeamInfo, lacpInfo=lacpInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, cistRootPort=cistRootPort, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortMoved=lacpInfoPortMoved, PYSNMP_MODULE_ID=layer2, trunkgroup=trunkgroup, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRoot=cistRoot, fdbStatsDeletes=fdbStatsDeletes, vlanInfoId=vlanInfoId, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, cistRegionalPathCost=cistRegionalPathCost, fdbEntry=fdbEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortState=lacpNewPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgState=stgNewCfgState, layer2Stats=layer2Stats, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Oper=layer2Oper, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbTable=fdbTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortTable=stgStatsPortTable, vlanInfoTable=vlanInfoTable, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2=layer2, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortState=lacpCurPortState, cistInfoPortState=cistInfoPortState, mstCistCfg=mstCistCfg, stpInfoHoldTime=stpInfoHoldTime, fdbStats=fdbStats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Configs=layer2Configs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoRootPort=stpInfoRootPort, cistInfo=cistInfo, fdbState=fdbState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortRole=cistInfoPortRole, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPathCost=cistRootPathCost, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCfg=portTeamCfg, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoIndex=stpInfoIndex, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mirrPortMirr=mirrPortMirr, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, stpInfoHelloTime=stpInfoHelloTime, mirroring=mirroring, stgNewCfgTable=stgNewCfgTable, stgCurCfgTable=stgCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbVlan=fdbVlan, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgRegionName=mstCurCfgRegionName, stgCfg=stgCfg, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgState=stgCurCfgState, vlanNewCfgState=vlanNewCfgState, mstNewCfgState=mstNewCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfo=stpInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortTable=stpInfoPortTable, vlanInfoLearn=vlanInfoLearn, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgState=portTeamCurCfgState, fdbStatsFinds=fdbStatsFinds, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbInfo=fdbInfo, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoName=vlanInfoName, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbRefSps=fdbRefSps, cistInfoPortTable=cistInfoPortTable, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortEdge=stpInfoPortEdge, lacp=lacp, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbSrcPort=fdbSrcPort, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, vlanMaxEnt=vlanMaxEnt, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTable=stpInfoTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, stpInfoRootCost=stpInfoRootCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, BridgeId=BridgeId, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlan=vlan, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbLearnedPort=fdbLearnedPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2Info=layer2Info, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbMacAddr=fdbMacAddr, stpStats=stpStats, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfo=vlanInfo, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCfg=mstCfg, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbClear=fdbClear, vlanNewCfgVlanId=vlanNewCfgVlanId)
