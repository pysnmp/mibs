...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStats=fdbStats, layer2=layer2, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfo=cistInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkgroup=trunkgroup, stpInfoPortRole=stpInfoPortRole, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbTable=fdbTable, lacpNewSystemPriority=lacpNewSystemPriority, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbSrcPort=fdbSrcPort, cistGeneralInfo=cistGeneralInfo, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoName=vlanInfoName, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortState=lacpCurPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFindFails=fdbStatsFindFails, vlanInfoStatus=vlanInfoStatus, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfo=lacpInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoIndex=stpInfoIndex, layer2Info=layer2Info, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbInfo=fdbInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortIndex=cistInfoPortIndex, portTeamCfg=portTeamCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRoot=cistRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbEntry=fdbEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoPorts=vlanInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoLearn=vlanInfoLearn, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsCreates=fdbStatsCreates, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbClear=fdbClear, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoTable=portTeamInfoTable, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortPriority=stgCurCfgPortPriority, BridgeId=BridgeId, fdbStatsHiwat=fdbStatsHiwat, fdbState=fdbState, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTopChanges=stpInfoTopChanges, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoTable=vlanInfoTable, vlanNewCfgState=vlanNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCfg=mstCistCfg, vlanCurCfgPorts=vlanCurCfgPorts, lacp=lacp, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgState=portTeamNewCfgState, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, fdbRefSps=fdbRefSps, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRootPort=cistRootPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, PYSNMP_MODULE_ID=layer2, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTable=stgCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortIndex=lacpInfoPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgState=mstNewCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgState=stgNewCfgState, fdbLearnedPort=fdbLearnedPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortTable=cistInfoPortTable, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgTable=stgNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortPriority=cistInfoPortPriority, stpStats=stpStats, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoId=vlanInfoId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Configs=layer2Configs, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortState=cistInfoPortState, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgState=vlanCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortState=stgNewCfgPortState, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Oper=layer2Oper, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootPort=stpInfoRootPort, cistInfoPortRole=cistInfoPortRole, layer2Stats=layer2Stats, mirroring=mirroring, portTeamInfo=portTeamInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoTable=stpInfoTable, stgCfg=stgCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortState=lacpNewPortState, mstCurCfgState=mstCurCfgState, stpInfo=stpInfo, vlanInfo=vlanInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsFinds=fdbStatsFinds, fdbVlan=fdbVlan, vlan=vlan, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanMaxEnt=vlanMaxEnt, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCfg=mstCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortTable=stgNewCfgPortTable, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortEdge=stpInfoPortEdge, mstGeneralCfg=mstGeneralCfg, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoState=portTeamInfoState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
