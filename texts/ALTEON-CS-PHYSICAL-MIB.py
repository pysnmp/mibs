...
ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, IpAddress, MibIdentifier, Counter64, Integer32, Unsigned32, iso, Bits, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "Counter64", "Integer32", "Unsigned32", "iso", "Bits", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoState=portTeamInfoState, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanMaxEnt=vlanMaxEnt, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgState=stgCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbTable=fdbTable, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStats=fdbStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, layer2Info=layer2Info, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTable=stpInfoPortTable, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortTable=lacpInfoPortTable, lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCfg=stgCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbVlan=fdbVlan, cistInfoPortState=cistInfoPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacp=lacp, vlan=vlan, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortEdge=stpInfoPortEdge, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoIndex=stpInfoIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mirroring=mirroring, portTeamInfo=portTeamInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortIndex=stgStatsPortIndex, fdbState=fdbState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoRootPort=stpInfoRootPort, BridgeId=BridgeId, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgTable=vlanCurCfgTable, fdbLearnedPort=fdbLearnedPort, stpInfoTable=stpInfoTable, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbSrcPort=fdbSrcPort, fdbStatsLookups=fdbStatsLookups, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurSystemPriority=lacpCurSystemPriority, layer2Oper=layer2Oper, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgTable=portTeamNewCfgTable, cistRoot=cistRoot, mstNewCfgState=mstNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, cistBridgeHelloTime=cistBridgeHelloTime, layer2=layer2, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoLearn=vlanInfoLearn, stpInfo=stpInfo, vlanNewCfgState=vlanNewCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfo=cistInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbRefSps=fdbRefSps, lacpInfoPortNtt=lacpInfoPortNtt, fdbInfo=fdbInfo, stgNewCfgState=stgNewCfgState, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, fdbClear=fdbClear, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfo=vlanInfo, layer2Configs=layer2Configs, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCfg=mstCistCfg, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortState=stpInfoPortState, lacpCurPortState=lacpCurPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortRole=cistInfoPortRole, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoTable=vlanInfoTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, fdbStatsCreates=fdbStatsCreates, stgCurCfgIndex=stgCurCfgIndex, cistRootPort=cistRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, vlanInfoId=vlanInfoId, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoName=vlanInfoName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsFinds=fdbStatsFinds, fdbMacAddr=fdbMacAddr, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCfg=portTeamCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCfg=mstCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoHoldTime=stpInfoHoldTime, cistRegionalRoot=cistRegionalRoot, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Stats=layer2Stats, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortTable=stgStatsPortTable, lacpNewPortState=lacpNewPortState, stgStatsStpIndex=stgStatsStpIndex, PYSNMP_MODULE_ID=layer2, stpInfoRootCost=stpInfoRootCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortIndex=lacpInfoPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoMaxAge=stpInfoMaxAge, fdbEntry=fdbEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, trunkgroup=trunkgroup, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgAddVlan=stgNewCfgAddVlan, stpStats=stpStats, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent)
