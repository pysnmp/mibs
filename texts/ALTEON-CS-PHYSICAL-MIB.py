...
MibIdentifier, TimeTicks, Integer32, iso, IpAddress, Counter32, Bits, Gauge32, NotificationType, ObjectIdentity, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Integer32", "iso", "IpAddress", "Counter32", "Bits", "Gauge32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgState=mstNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoState=portTeamInfoState, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalRoot=cistRegionalRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkgroup=trunkgroup, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, stpInfo=stpInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCfg=mstCfg, stpInfoPortRole=stpInfoPortRole, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfo=portTeamInfo, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortIndex=stpInfoPortIndex, lacpInfo=lacpInfo, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, layer2Stats=layer2Stats, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbMacAddr=fdbMacAddr, stpInfoIndex=stpInfoIndex, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacp=lacp, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFindFails=fdbStatsFindFails, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistRegionalPathCost=cistRegionalPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlan=vlan, fdbStatsFinds=fdbStatsFinds, vlanNewCfgStg=vlanNewCfgStg, fdbRefSps=fdbRefSps, stpInfoPortStpIndex=stpInfoPortStpIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStats=fdbStats, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgIndex=stgNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstGeneralCfg=mstGeneralCfg, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortRole=cistInfoPortRole, mstCistCfg=mstCistCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoName=vlanInfoName, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistGeneralInfo=cistGeneralInfo, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, layer2Info=layer2Info, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortEdge=stpInfoPortEdge, fdbInfo=fdbInfo, vlanNewCfgState=vlanNewCfgState, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbClear=fdbClear, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortState=stpInfoPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoId=vlanInfoId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTable=portTeamInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, stpInfoMaxAge=stpInfoMaxAge, vlanInfoTable=vlanInfoTable, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortTable=cistInfoPortTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoHoldTime=stpInfoHoldTime, fdbStatsLookups=fdbStatsLookups, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoRootCost=stpInfoRootCost, vlanMaxEnt=vlanMaxEnt, lacpCurPortState=lacpCurPortState, BridgeId=BridgeId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortTable=stpInfoPortTable, vlanCurCfgState=vlanCurCfgState, layer2Configs=layer2Configs, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortState=lacpNewPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stpStats=stpStats, stpInfoTopChanges=stpInfoTopChanges, cistRootPort=cistRootPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbEntry=fdbEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTable=stpInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortState=cistInfoPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbState=fdbState, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoRootPort=stpInfoRootPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsCreates=fdbStatsCreates, cistRootPathCost=cistRootPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCfg=portTeamCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsHiwat=fdbStatsHiwat, fdbTable=fdbTable, mirrPortMirr=mirrPortMirr, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfo=vlanInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortIndex=cistInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbVlan=fdbVlan, layer2Oper=layer2Oper, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCfg=stgCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirroring=mirroring, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfo=cistInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRoot=cistRoot, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgState=mstCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, layer2=layer2, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgStg=vlanCurCfgStg, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn)
