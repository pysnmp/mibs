...
ModuleIdentity, IpAddress, iso, Unsigned32, TimeTicks, Integer32, Gauge32, Counter32, MibIdentifier, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "iso", "Unsigned32", "TimeTicks", "Integer32", "Gauge32", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbInfo=fdbInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbLearnedPort=fdbLearnedPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbState=fdbState, cistRoot=cistRoot, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbSrcTrunk=fdbSrcTrunk, portTeamInfo=portTeamInfo, cistRootPort=cistRootPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindFails=fdbStatsFindFails, mstGeneralCfg=mstGeneralCfg, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mirroring=mirroring, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, layer2=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoTable=stpInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbTable=fdbTable, mstCfg=mstCfg, layer2Stats=layer2Stats, stgCurCfgState=stgCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbMacAddr=fdbMacAddr, stgNewCfgPriority=stgNewCfgPriority, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, stpInfoIndex=stpInfoIndex, fdbStatsCreates=fdbStatsCreates, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgState=vlanNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCfg=portTeamCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbClear=fdbClear, fdbStatsLookups=fdbStatsLookups, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortState=cistInfoPortState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortIndex=stpInfoPortIndex, vlanMaxEnt=vlanMaxEnt, mstCistCfg=mstCistCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgStg=vlanCurCfgStg, layer2Configs=layer2Configs, stpInfo=stpInfo, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsDeletes=fdbStatsDeletes, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbVlan=fdbVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfo=vlanInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortTable=stgStatsPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, BridgeId=BridgeId, stpStats=stpStats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortState=lacpCurPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoLearn=vlanInfoLearn, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Oper=layer2Oper, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoState=portTeamInfoState, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoId=vlanInfoId, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgState=stgNewCfgState, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortState=lacpNewPortState, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacp=lacp, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2Info=layer2Info, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgState=mstCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, cistRegionalRoot=cistRegionalRoot, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfo=cistInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkgroup=trunkgroup, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoRootPort=stpInfoRootPort, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoName=vlanInfoName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbSrcPort=fdbSrcPort, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgTable=vlanNewCfgTable, vlanInfoTable=vlanInfoTable, stgCurCfgIndex=stgCurCfgIndex, fdbStats=fdbStats, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortState=stpInfoPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbEntry=fdbEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, PYSNMP_MODULE_ID=layer2, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoJumbo=vlanInfoJumbo, stgCfg=stgCfg, mstNewCfgState=mstNewCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortSelected=lacpInfoPortSelected, vlan=vlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoStatus=vlanInfoStatus, cistGeneralInfo=cistGeneralInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPathCost=cistRootPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortRole=cistInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsFinds=fdbStatsFinds, stpInfoPortTable=stpInfoPortTable, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfo=lacpInfo, lacpInfoPortTable=lacpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState)
