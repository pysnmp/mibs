...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanMaxVlanID=vlanMaxVlanID, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbMacAddr=fdbMacAddr, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortIndex=stpInfoPortIndex, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, mstGeneralCfg=mstGeneralCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgState=mstNewCfgState, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, PYSNMP_MODULE_ID=layer2, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortState=lacpCurPortState, fdbEntry=fdbEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgState=stgCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Configs=layer2Configs, lacpNewPortState=lacpNewPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRootPort=cistRootPort, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortEdge=stpInfoPortEdge, cistInfo=cistInfo, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfo=vlanInfo, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2Info=layer2Info, cistInfoPortState=cistInfoPortState, vlanInfoLearn=vlanInfoLearn, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, stpStats=stpStats, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbClear=fdbClear, vlanInfoTable=vlanInfoTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbInfo=fdbInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortRole=stpInfoPortRole, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortIndex=cistInfoPortIndex, layer2Stats=layer2Stats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgState=stgNewCfgState, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, stpInfoTopChanges=stpInfoTopChanges, vlan=vlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbTable=fdbTable, stpInfoForwardDelay=stpInfoForwardDelay, layer2Oper=layer2Oper, mstCurCfgState=mstCurCfgState, BridgeId=BridgeId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfo=stpInfo, lacpInfo=lacpInfo, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbRefSps=fdbRefSps, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsLookups=fdbStatsLookups, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsFinds=fdbStatsFinds, vlanInfoName=vlanInfoName, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfo=portTeamInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbSrcPort=fdbSrcPort, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortLinkType=cistInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTable=stpInfoTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCfg=mstCfg, cistRoot=cistRoot, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, lacp=lacp, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStats=fdbStats, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbVlan=fdbVlan, stgNewCfgTableEntry=stgNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgState=vlanNewCfgState, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoRootCost=stpInfoRootCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCfg=stgCfg, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCfg=mstCistCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoTable=portTeamInfoTable, vlanInfoId=vlanInfoId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgPorts=vlanCurCfgPorts, mirrPortMirr=mirrPortMirr, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoState=portTeamInfoState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortState=stpInfoPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkgroup=trunkgroup)
