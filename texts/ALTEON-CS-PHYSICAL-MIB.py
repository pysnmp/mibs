...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortTable=stgStatsPortTable, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacp=lacp, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mirroring=mirroring, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgIndex=stgCurCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgLearn=vlanCurCfgLearn, cistInfo=cistInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFinds=fdbStatsFinds, lacpCurPortState=lacpCurPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortState=stpInfoPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoStatus=vlanInfoStatus, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfo=stpInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortPathCost=cistInfoPortPathCost, fdbVlan=fdbVlan, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgState=mstNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbSrcPort=fdbSrcPort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRootPort=cistRootPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlan=vlan, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoMaxAge=stpInfoMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, fdbSrcTrunk=fdbSrcTrunk, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootPort=stpInfoRootPort, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpStats=stpStats, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortEdge=stpInfoPortEdge, fdbMacAddr=fdbMacAddr, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortState=stgCurCfgPortState, stpInfoIndex=stpInfoIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoTable=vlanInfoTable, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTable=portTeamInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoName=vlanInfoName, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistRoot=cistRoot, stgNewCfgState=stgNewCfgState, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgStg=vlanCurCfgStg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsCurrent=fdbStatsCurrent, fdbStats=fdbStats, mstCfg=mstCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCfg=stgCfg, vlanInfoId=vlanInfoId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistBridgeHelloTime=cistBridgeHelloTime, trunkgroup=trunkgroup, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, layer2Info=layer2Info, stpInfoPortTable=stpInfoPortTable, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortState=cistInfoPortState, layer2Configs=layer2Configs, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfo=lacpInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoState=portTeamInfoState, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistRegionalPathCost=cistRegionalPathCost, vlanInfoPorts=vlanInfoPorts, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistRootPathCost=cistRootPathCost, cistInfoPortTable=cistInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCfg=mstCistCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Stats=layer2Stats, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbClear=fdbClear, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfo=vlanInfo, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgPorts=portTeamCurCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, fdbState=fdbState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbInfo=fdbInfo, fdbRefSps=fdbRefSps, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTable=stpInfoTable, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgState=stgCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbTable=fdbTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortRole=stpInfoPortRole, cistInfoPortIndex=cistInfoPortIndex, vlanMaxEnt=vlanMaxEnt, fdbEntry=fdbEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsStpIndex=stgStatsStpIndex, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, PYSNMP_MODULE_ID=layer2, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortRole=cistInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgStg=vlanNewCfgStg, cistGeneralInfo=cistGeneralInfo, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, BridgeId=BridgeId)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Oper=layer2Oper, lacpNewPortState=lacpNewPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoLearn=vlanInfoLearn, vlanNewCfgTable=vlanNewCfgTable, portTeamCfg=portTeamCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgTable=stgCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgState=mstCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2=layer2, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortTable=stgCurCfgPortTable, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState)
