...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPriority=stgNewCfgPriority, cistGeneralInfo=cistGeneralInfo, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTableEntry=stpInfoTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTable=stgCurCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2Configs=layer2Configs, stpInfoRootCost=stpInfoRootCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfo=stpInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortTable=stgStatsPortTable, stpInfoTable=stpInfoTable, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbClear=fdbClear, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfo=vlanInfo, BridgeId=BridgeId, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortEdge=stpInfoPortEdge, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortRole=cistInfoPortRole, vlanCurCfgStg=vlanCurCfgStg, portTeamInfoState=portTeamInfoState, cistInfo=cistInfo, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsStpIndex=stgStatsStpIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoIndex=stpInfoIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistRegionalRoot=cistRegionalRoot, cistInfoPortLinkType=cistInfoPortLinkType, fdbStats=fdbStats, stgNewCfgState=stgNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgState=mstCurCfgState, cistInfoPortState=cistInfoPortState, vlanNewCfgState=vlanNewCfgState, PYSNMP_MODULE_ID=layer2, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoName=vlanInfoName, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgState=vlanCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkgroup=trunkgroup, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, cistRoot=cistRoot, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2=layer2, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacp=lacp, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, layer2Stats=layer2Stats, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfoTable=vlanInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortState=stgNewCfgPortState, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, mirroring=mirroring, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoPorts=vlanInfoPorts, stpInfoPortRole=stpInfoPortRole, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTable=cistInfoPortTable, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortState=stpInfoPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgVlanId=vlanCurCfgVlanId, cistRootPathCost=cistRootPathCost, vlanInfoId=vlanInfoId, stpInfoPortTable=stpInfoPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbState=fdbState, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbEntry=fdbEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpStats=stpStats, fdbTable=fdbTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbRefSps=fdbRefSps, cistRootPort=cistRootPort, mirrPortMirr=mirrPortMirr, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Info=layer2Info, mstNewCfgState=mstNewCfgState, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgIndex=stgNewCfgIndex, mstCfg=mstCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, vlan=vlan, lacpInfo=lacpInfo, portTeamInfoPorts=portTeamInfoPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoStatus=vlanInfoStatus, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgState=stgCurCfgState, layer2Oper=layer2Oper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPriority=stgCurCfgPriority, lacpInfoPortMoved=lacpInfoPortMoved, stgCfg=stgCfg, stpInfoHoldTime=stpInfoHoldTime, mstCistCfg=mstCistCfg, fdbInfo=fdbInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortState=lacpCurPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, fdbStatsLookups=fdbStatsLookups, portTeamInfo=portTeamInfo, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, fdbLearnedPort=fdbLearnedPort, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCfg=portTeamCfg, stgNewCfgTable=stgNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortState=lacpNewPortState)
