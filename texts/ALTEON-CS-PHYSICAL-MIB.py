...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsLookups=fdbStatsLookups, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanMaxEnt=vlanMaxEnt, cistRoot=cistRoot, vlanInfoTable=vlanInfoTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, PYSNMP_MODULE_ID=layer2, mstCistCfg=mstCistCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortRole=stpInfoPortRole, mstCistDefaultCfg=mstCistDefaultCfg, fdbSrcTrunk=fdbSrcTrunk, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoTable=stpInfoTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortState=cistInfoPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mirroring=mirroring, portTeamCfg=portTeamCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoIndex=stpInfoIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkgroup=trunkgroup, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Info=layer2Info, fdbStats=fdbStats, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamInfoTable=portTeamInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, BridgeId=BridgeId, stgCfg=stgCfg, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstNewCfgState=mstNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTable=stgCurCfgTable, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoId=vlanInfoId, vlanCurCfgStg=vlanCurCfgStg, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeMaxAge=cistBridgeMaxAge, layer2Oper=layer2Oper, cistInfoPortRole=cistInfoPortRole, lacpInfoPortMoved=lacpInfoPortMoved, layer2=layer2, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoTopChanges=stpInfoTopChanges, fdbTable=fdbTable, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfo=portTeamInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortState=lacpCurPortState, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbVlan=fdbVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsFinds=fdbStatsFinds, fdbMacAddr=fdbMacAddr, cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgState=portTeamCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoName=vlanInfoName, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbLearnedPort=fdbLearnedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoPorts=portTeamInfoPorts, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfo=lacpInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistRootPort=cistRootPort, portTeamNewCfgTable=portTeamNewCfgTable, lacp=lacp, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbClear=fdbClear, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortTable=cistInfoPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgState=mstCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbRefSps=fdbRefSps, vlanMaxVlanID=vlanMaxVlanID, vlanInfo=vlanInfo, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgState=vlanNewCfgState, cistRegionalRoot=cistRegionalRoot, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsLookupFails=fdbStatsLookupFails, stpInfo=stpInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoRootPort=stpInfoRootPort, fdbStatsDeletes=fdbStatsDeletes, cistGeneralInfo=cistGeneralInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistRootPathCost=cistRootPathCost, mirrPortMirr=mirrPortMirr, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortState=lacpNewPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, layer2Stats=layer2Stats, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoPorts=vlanInfoPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stpStats=stpStats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbInfo=fdbInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlan=vlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCfg=mstCfg, stpInfoHelloTime=stpInfoHelloTime, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortState=stpInfoPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortState=stgCurCfgPortState, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbEntry=fdbEntry, layer2Configs=layer2Configs, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbState=fdbState, cistInfo=cistInfo, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg)
