...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortState=lacpNewPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoRootPort=stpInfoRootPort, stpInfoTable=stpInfoTable, cistInfoPortRole=cistInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCreates=fdbStatsCreates, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgTable=stgCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, fdbRefSps=fdbRefSps, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurPortState=lacpCurPortState, fdbVlan=fdbVlan, stgNewCfgTable=stgNewCfgTable, lacp=lacp, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoHelloTime=stpInfoHelloTime, vlanMaxEnt=vlanMaxEnt, vlanInfoId=vlanInfoId, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTable=stpInfoPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoTable=portTeamInfoTable, layer2Stats=layer2Stats, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkgroup=trunkgroup, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPortsState=portTeamInfoPortsState, BridgeId=BridgeId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortState=cistInfoPortState, stgStatsPortTable=stgStatsPortTable, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstGeneralCfg=mstGeneralCfg, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, layer2Info=layer2Info, vlanInfoLearn=vlanInfoLearn, fdbSrcPort=fdbSrcPort, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCfg=mstCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsLookupFails=fdbStatsLookupFails, mstCurCfgStpMode=mstCurCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoPorts=vlanInfoPorts, mstCistCfg=mstCistCfg, cistGeneralInfo=cistGeneralInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCfg=stgCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCfg=portTeamCfg, mirrPortMirr=mirrPortMirr, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortIndex=cistInfoPortIndex, layer2Oper=layer2Oper, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbMacAddr=fdbMacAddr, mstNewCfgState=mstNewCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortTable=cistInfoPortTable, layer2Configs=layer2Configs, portTeamInfo=portTeamInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoName=vlanInfoName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgState=mstCurCfgState, cistRootPathCost=cistRootPathCost, vlanInfoBwmContract=vlanInfoBwmContract, PYSNMP_MODULE_ID=layer2, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsFinds=fdbStatsFinds, stpInfoPortIndex=stpInfoPortIndex, fdbStatsFindFails=fdbStatsFindFails, lacpInfo=lacpInfo, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortEdge=stpInfoPortEdge, stpInfoTableEntry=stpInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoState=portTeamInfoState, fdbEntry=fdbEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalRoot=cistRegionalRoot, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, cistInfo=cistInfo, fdbStatsDeletes=fdbStatsDeletes, fdbTable=fdbTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpStats=stpStats, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoIndex=stpInfoIndex, fdbStatsCurrent=fdbStatsCurrent, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgState=vlanCurCfgState, stpInfoPortState=stpInfoPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbLearnedPort=fdbLearnedPort, cistRoot=cistRoot, stgStatsStpIndex=stgStatsStpIndex, stpInfo=stpInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbClear=fdbClear, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbState=fdbState, vlan=vlan, mirroring=mirroring, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, cistRootPort=cistRootPort, vlanInfoTable=vlanInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfo=vlanInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsHiwat=fdbStatsHiwat, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgDelete=vlanNewCfgDelete, fdbStats=fdbStats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, layer2=layer2, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortNtt=lacpInfoPortNtt, fdbInfo=fdbInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay)
