...
# Produced by pysmi-1.1.8 at Fri Jan 13 11:57:59 2023
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbRefSps=fdbRefSps, portTeamNewCfgIndex=portTeamNewCfgIndex, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgState=mstNewCfgState, stgCurCfgState=stgCurCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCfg=mstCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, PYSNMP_MODULE_ID=layer2, fdbStats=fdbStats, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoStatus=vlanInfoStatus, mirroring=mirroring, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2Info=layer2Info, stgStatsPortIndex=stgStatsPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbTable=fdbTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRootPort=cistRootPort, vlanInfoTable=vlanInfoTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRoot=cistRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanMaxVlanID=vlanMaxVlanID, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRootPathCost=cistRootPathCost, vlanCurCfgState=vlanCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsCurrent=fdbStatsCurrent, trunkgroup=trunkgroup, mirrPortMirr=mirrPortMirr, vlanCurCfgLearn=vlanCurCfgLearn, stpInfo=stpInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbVlan=fdbVlan, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoIndex=stpInfoIndex, stpInfoPortRole=stpInfoPortRole, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortIndex=lacpInfoPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortTable=stpInfoPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsDeletes=fdbStatsDeletes, fdbState=fdbState, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Configs=layer2Configs, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbMacAddr=fdbMacAddr, stgCurCfgTable=stgCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgState=portTeamNewCfgState, stpStats=stpStats, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoLearn=vlanInfoLearn, portTeamTableMaxSize=portTeamTableMaxSize, stgCfg=stgCfg, portTeamInfoTable=portTeamInfoTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortPriority=cistInfoPortPriority, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2=layer2, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbEntry=fdbEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsStpIndex=stgStatsStpIndex, layer2Oper=layer2Oper, portTeamInfoState=portTeamInfoState, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortState=stpInfoPortState, lacpCurPortState=lacpCurPortState, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgTable=portTeamNewCfgTable, lacp=lacp, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortState=cistInfoPortState, fdbClear=fdbClear, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRegionalPathCost=cistRegionalPathCost, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfo=lacpInfo, mstCurCfgState=mstCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortTable=stgStatsPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, mstCurCfgStpMode=mstCurCfgStpMode, cistInfo=cistInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfo=vlanInfo, mstGeneralCfg=mstGeneralCfg, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbInfo=fdbInfo, cistRegionalRoot=cistRegionalRoot, cistInfoPortRole=cistInfoPortRole, stgNewCfgTable=stgNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCfg=mstCistCfg, vlan=vlan, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFinds=fdbStatsFinds, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgState=stgNewCfgState, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Stats=layer2Stats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoId=vlanInfoId, vlanNewCfgDelete=vlanNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbSrcPort=fdbSrcPort, portTeamInfo=portTeamInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, BridgeId=BridgeId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanMaxEnt=vlanMaxEnt, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoName=vlanInfoName, stpInfoRootCost=stpInfoRootCost, portTeamCfg=portTeamCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoTableEntry=stpInfoTableEntry, stpInfoTable=stpInfoTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortEdge=stpInfoPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortState=lacpNewPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortIndex=cistInfoPortIndex)
