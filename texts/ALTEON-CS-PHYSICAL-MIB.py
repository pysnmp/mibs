...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbInfo=fdbInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStats=fdbStats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStatsCurrent=fdbStatsCurrent, lacpInfo=lacpInfo, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoStatus=vlanInfoStatus, stgStatsPortTable=stgStatsPortTable, stpInfo=stpInfo, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCfg=mstCistCfg, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTable=portTeamInfoTable, stpInfoTable=stpInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortState=stpInfoPortState, cistRegionalPathCost=cistRegionalPathCost, lacp=lacp, layer2Oper=layer2Oper, mstNewCfgState=mstNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoMaxAge=stpInfoMaxAge, vlanInfoPorts=vlanInfoPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortTable=stpInfoPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbClear=fdbClear, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfo=vlanInfo, fdbEntry=fdbEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfoIndex=portTeamInfoIndex, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, fdbStatsHiwat=fdbStatsHiwat, vlanMaxEnt=vlanMaxEnt, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbLearnedPort=fdbLearnedPort, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, PYSNMP_MODULE_ID=layer2, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgTable=stgCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoTable=vlanInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoState=portTeamInfoState, mirroring=mirroring, fdbTable=fdbTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoId=vlanInfoId, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoLearn=vlanInfoLearn, portTeamCfg=portTeamCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoName=vlanInfoName, cistInfo=cistInfo, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortTable=lacpInfoPortTable, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsLookups=fdbStatsLookups, portTeamInfoTrunks=portTeamInfoTrunks, layer2Configs=layer2Configs, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortState=stgCurCfgPortState, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlan=vlan, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortIndex=lacpInfoPortIndex, cistGeneralInfo=cistGeneralInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortState=lacpCurPortState, stpInfoHoldTime=stpInfoHoldTime, BridgeId=BridgeId, trunkgroup=trunkgroup, cistInfoPortLinkType=cistInfoPortLinkType, stgCfg=stgCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPriority=stgCurCfgPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfo=portTeamInfo, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbState=fdbState, stpInfoPortRole=stpInfoPortRole, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stpStats=stpStats, cistRootPort=cistRootPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoTableEntry=vlanInfoTableEntry, mirrPortMirr=mirrPortMirr, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortTable=cistInfoPortTable, layer2Info=layer2Info, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootCost=stpInfoRootCost, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2Stats=layer2Stats, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbSrcPort=fdbSrcPort, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsDeletes=fdbStatsDeletes, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRootPathCost=cistRootPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanMaxVlanID=vlanMaxVlanID, mstCfg=mstCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, stpInfoIndex=stpInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbMacAddr=fdbMacAddr, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2=layer2, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbRefSps=fdbRefSps, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoRootPort=stpInfoRootPort, cistRoot=cistRoot, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRegionalRoot=cistRegionalRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbVlan=fdbVlan, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime)
