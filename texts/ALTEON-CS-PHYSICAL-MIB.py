...
Counter32, Counter64, MibIdentifier, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Integer32, Bits, Gauge32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "MibIdentifier", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoTable=vlanInfoTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirroring=mirroring, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsHiwat=fdbStatsHiwat, trunkgroup=trunkgroup, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoPorts=vlanInfoPorts, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, fdbEntry=fdbEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeMaxAge=cistBridgeMaxAge, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortState=stgCurCfgPortState, mstCistDefaultCfg=mstCistDefaultCfg, stpStats=stpStats, mstGeneralCfg=mstGeneralCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortTable=stpInfoPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortState=cistInfoPortState, cistRegionalPathCost=cistRegionalPathCost, layer2=layer2, fdbStatsCreates=fdbStatsCreates, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfo=cistInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanInfo=vlanInfo, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbClear=fdbClear, fdbLearnedPort=fdbLearnedPort, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Info=layer2Info, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfo=portTeamInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanInfoId=vlanInfoId, stgStatsStpIndex=stgStatsStpIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfo=lacpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbSrcPort=fdbSrcPort, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsLookups=fdbStatsLookups, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgIndex=stgNewCfgIndex, cistRegionalRoot=cistRegionalRoot, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, layer2Stats=layer2Stats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCfg=mstCfg, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRoot=cistRoot, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRootPort=cistRootPort, layer2Oper=layer2Oper, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbTable=fdbTable, cistGeneralInfo=cistGeneralInfo, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortState=lacpNewPortState, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortIndex=cistInfoPortIndex, fdbStatsFinds=fdbStatsFinds, stpInfoTable=stpInfoTable, lacp=lacp, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoName=vlanInfoName, fdbStats=fdbStats, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, BridgeId=BridgeId, fdbState=fdbState, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbRefSps=fdbRefSps, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbInfo=fdbInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortState=stpInfoPortState, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgState=portTeamCurCfgState, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, layer2Configs=layer2Configs, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoRootPort=stpInfoRootPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, fdbVlan=fdbVlan, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgState=stgCurCfgState, mstCurCfgState=mstCurCfgState, mstNewCfgState=mstNewCfgState, lacpCurPortState=lacpCurPortState, stgCurCfgTable=stgCurCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfo=stpInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, fdbMacAddr=fdbMacAddr, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgTable=vlanCurCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoLearn=vlanInfoLearn, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCfg=portTeamCfg, vlan=vlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoRootCost=stpInfoRootCost, cistInfoPortRole=cistInfoPortRole, portTeamInfoState=portTeamInfoState, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCfg=stgCfg, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, mirrPortMirr=mirrPortMirr, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgLearn=vlanCurCfgLearn, cistRootPathCost=cistRootPathCost, stpInfoPortEdge=stpInfoPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState)
