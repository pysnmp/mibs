...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgTable=vlanCurCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortTable=stpInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, layer2=layer2, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoName=vlanInfoName, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacp=lacp, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, fdbStatsFindFails=fdbStatsFindFails, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCfg=mstCistCfg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoPorts=vlanInfoPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortTable=stgStatsPortTable, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgIndex=stgNewCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfo=portTeamInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgState=mstNewCfgState, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgState=stgNewCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstGeneralCfg=mstGeneralCfg, lacpInfoPortTable=lacpInfoPortTable, fdbMacAddr=fdbMacAddr, cistRootPort=cistRootPort, fdbState=fdbState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortIndex=cistInfoPortIndex, stpInfo=stpInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgState=stgCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoTable=vlanInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgState=mstCurCfgState, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortState=stpInfoPortState, portTeamInfoState=portTeamInfoState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, cistInfoPortRole=cistInfoPortRole, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortIndex=lacpInfoPortIndex, fdbTable=fdbTable, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbInfo=fdbInfo, layer2Stats=layer2Stats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mirroring=mirroring, cistRootPathCost=cistRootPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsDeletes=fdbStatsDeletes, layer2Oper=layer2Oper, lacpInfo=lacpInfo, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoTable=portTeamInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCfg=stgCfg, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanMaxEnt=vlanMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsStpIndex=stgStatsStpIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkgroup=trunkgroup, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoJumbo=vlanInfoJumbo, fdbStatsFinds=fdbStatsFinds, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfo=vlanInfo, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, fdbVlan=fdbVlan, cistInfoPortState=cistInfoPortState, cistGeneralInfo=cistGeneralInfo, portTeamCfg=portTeamCfg, cistRoot=cistRoot, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, BridgeId=BridgeId, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoId=vlanInfoId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbEntry=fdbEntry, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoRootPort=stpInfoRootPort, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoIndex=stpInfoIndex, cistInfo=cistInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, layer2Configs=layer2Configs, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsCreates=fdbStatsCreates, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcTrunk=fdbSrcTrunk, fdbClear=fdbClear, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoIndex=portTeamInfoIndex, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoHoldTime=stpInfoHoldTime, mstCfg=mstCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistRegionalRoot=cistRegionalRoot, vlanCurCfgState=vlanCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStats=fdbStats, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsLookups=fdbStatsLookups, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlan=vlan, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoStatus=vlanInfoStatus, layer2Info=layer2Info, stpStats=stpStats, lacpNewPortState=lacpNewPortState, stpInfoTable=stpInfoTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbSrcPort=fdbSrcPort, vlanNewCfgStg=vlanNewCfgStg, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoLearn=vlanInfoLearn, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbLearnedPort=fdbLearnedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName)
