...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfo=vlanInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoTable=vlanInfoTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgPorts=vlanNewCfgPorts, fdbTable=fdbTable, layer2Oper=layer2Oper, stgCurCfgState=stgCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortState=cistInfoPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoName=vlanInfoName, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgState=mstCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTable=stpInfoTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistRegionalRoot=cistRegionalRoot, vlanInfoLearn=vlanInfoLearn, mstCistCfg=mstCistCfg, stpStats=stpStats, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbVlan=fdbVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCfg=portTeamCfg, vlanMaxEnt=vlanMaxEnt, fdbLearnedPort=fdbLearnedPort, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCfg=mstCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, BridgeId=BridgeId, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Stats=layer2Stats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbClear=fdbClear, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRoot=cistRoot, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mirroring=mirroring, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoPorts=portTeamInfoPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfo=lacpInfo, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbInfo=fdbInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgState=stgNewCfgState, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, layer2=layer2, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2Info=layer2Info, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfo=portTeamInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbRefSps=fdbRefSps, vlan=vlan, stgNewCfgTable=stgNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoRootCost=stpInfoRootCost, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTable=portTeamInfoTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoIndex=stpInfoIndex, mstNewCfgState=mstNewCfgState, fdbState=fdbState, cistInfoPortTable=cistInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgIndex=stgNewCfgIndex, vlanInfoPorts=vlanInfoPorts, vlanNewCfgStg=vlanNewCfgStg, vlanInfoId=vlanInfoId, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgPorts=vlanCurCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoState=portTeamInfoState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortPathCost=stpInfoPortPathCost, cistInfo=cistInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgState=vlanCurCfgState, vlanInfoStatus=vlanInfoStatus, layer2Configs=layer2Configs, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRootPathCost=cistRootPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfo=stpInfo, mirrPortMirr=mirrPortMirr, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRegionalPathCost=cistRegionalPathCost, trunkgroup=trunkgroup, fdbStats=fdbStats, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortLinkType=stpInfoPortLinkType, fdbSrcPort=fdbSrcPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortState=lacpNewPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgTable=stgCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgState=vlanNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoRootPort=stpInfoRootPort, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRootPort=cistRootPort, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPriority=stgNewCfgPriority, stpInfoMaxAge=stpInfoMaxAge, fdbStatsCurrent=fdbStatsCurrent, lacpCurSystemPriority=lacpCurSystemPriority, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortTable=stgCurCfgPortTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, stgCfg=stgCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, PYSNMP_MODULE_ID=layer2, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsStpIndex=stgStatsStpIndex, cistBridgeHelloTime=cistBridgeHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, cistGeneralInfo=cistGeneralInfo, stgStatsPortTable=stgStatsPortTable, lacp=lacp, fdbStatsLookups=fdbStatsLookups, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbEntry=fdbEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgAddVlan=pmNewCfgAddVlan)
