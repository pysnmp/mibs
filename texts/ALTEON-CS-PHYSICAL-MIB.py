...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbClear=fdbClear, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgState=mstCurCfgState, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoIndex=portTeamInfoIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcPort=fdbSrcPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirrPortMirr=mirrPortMirr, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbTable=fdbTable, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCfg=stgCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTableEntry=stpInfoTableEntry, fdbState=fdbState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCfg=mstCistCfg, fdbStats=fdbStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgStg=vlanNewCfgStg, fdbVlan=fdbVlan, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoPorts=vlanInfoPorts, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsDeletes=fdbStatsDeletes, stpInfoIndex=stpInfoIndex, stpInfoRootPort=stpInfoRootPort, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlan=vlan, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRootPort=cistRootPort, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsCreates=fdbStatsCreates, fdbMacAddr=fdbMacAddr, fdbInfo=fdbInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoTable=vlanInfoTable, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfo=vlanInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgTable=stgCurCfgTable, mstCfg=mstCfg, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTable=stpInfoPortTable, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfo=stpInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTable=stpInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortTable=cistInfoPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsLookups=fdbStatsLookups, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, lacpCurPortState=lacpCurPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, fdbLearnedPort=fdbLearnedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mirroring=mirroring, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCfg=portTeamCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgState=vlanNewCfgState, PYSNMP_MODULE_ID=layer2, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbEntry=fdbEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortState=lacpNewPortState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoId=vlanInfoId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfo=lacpInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Info=layer2Info, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRoot=cistRoot, layer2=layer2, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, layer2Stats=layer2Stats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, mstGeneralCfg=mstGeneralCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortRole=cistInfoPortRole, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkgroup=trunkgroup, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoName=vlanInfoName, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRootPathCost=cistRootPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortRole=stpInfoPortRole, cistInfo=cistInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, BridgeId=BridgeId, stgCurCfgState=stgCurCfgState, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistGeneralInfo=cistGeneralInfo, mstNewCfgState=mstNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTable=stgStatsPortTable, portTeamInfoState=portTeamInfoState, vlanNewCfgAddPort=vlanNewCfgAddPort, stpStats=stpStats, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoBwmContract=vlanInfoBwmContract, layer2Configs=layer2Configs, portTeamInfoTable=portTeamInfoTable, mstNewCfgRegionName=mstNewCfgRegionName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, fdbRefSps=fdbRefSps, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, layer2Oper=layer2Oper, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacp=lacp, vlanMaxEnt=vlanMaxEnt, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortState=stpInfoPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfo=portTeamInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime)
