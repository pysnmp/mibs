...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgState=mstCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCurCfgStpMode=mstCurCfgStpMode, PYSNMP_MODULE_ID=layer2, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsStpIndex=stgStatsStpIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Oper=layer2Oper, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbRefSps=fdbRefSps, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoRootPort=stpInfoRootPort, mirrPortMirr=mirrPortMirr, mstNewCfgState=mstNewCfgState, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgState=vlanCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgState=vlanNewCfgState, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoHoldTime=stpInfoHoldTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbVlan=fdbVlan, trunkgroup=trunkgroup, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFinds=fdbStatsFinds, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgState=stgCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTable=stpInfoTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsOverflows=fdbStatsOverflows, lacpInfo=lacpInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoName=vlanInfoName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, vlanInfo=vlanInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstGeneralCfg=mstGeneralCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsLookups=fdbStatsLookups, portTeamInfoTable=portTeamInfoTable, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPriority=stgNewCfgPriority, layer2Info=layer2Info, fdbClear=fdbClear, cistRegionalRoot=cistRegionalRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Configs=layer2Configs, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortTable=stpInfoPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoId=vlanInfoId, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, cistRootPathCost=cistRootPathCost, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbEntry=fdbEntry, fdbLearnedPort=fdbLearnedPort, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortIndex=cistInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, stpStats=stpStats, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistRoot=cistRoot, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoLearn=vlanInfoLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCfg=mstCfg, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoIndex=stpInfoIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoPorts=vlanInfoPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTable=vlanInfoTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, vlan=vlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbState=fdbState, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoState=portTeamInfoState, stpInfoPortRole=stpInfoPortRole, mstCistCfg=mstCistCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortRole=cistInfoPortRole, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfo=cistInfo, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2=layer2, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortState=lacpCurPortState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoPorts=portTeamInfoPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfo=stpInfo, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistGeneralInfo=cistGeneralInfo, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, BridgeId=BridgeId, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortState=cistInfoPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsHiwat=fdbStatsHiwat, portTeamInfo=portTeamInfo, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoIndex=portTeamInfoIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanMaxEnt=vlanMaxEnt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortCfgTable=lacpCurPortCfgTable, lacp=lacp, stgNewCfgTable=stgNewCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbTable=fdbTable, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortState=stgNewCfgPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamCfg=portTeamCfg, fdbInfo=fdbInfo, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCfg=stgCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, fdbStats=fdbStats, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRootPort=cistRootPort, mstCistBridgeCfg=mstCistBridgeCfg, mirroring=mirroring, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, layer2Stats=layer2Stats, cistInfoPortTable=cistInfoPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType)
