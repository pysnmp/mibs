...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2=layer2, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortIndex=lacpInfoPortIndex, BridgeId=BridgeId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoTable=portTeamInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoId=vlanInfoId, fdbStats=fdbStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, stgStatsStpIndex=stgStatsStpIndex, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Configs=layer2Configs, stpStats=stpStats, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoPorts=vlanInfoPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mirroring=mirroring, portTeamCfg=portTeamCfg, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortLinkType=stpInfoPortLinkType, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRegionalRoot=cistRegionalRoot, mstCfg=mstCfg, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfo=stpInfo, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgState=stgNewCfgState, cistInfoPortTable=cistInfoPortTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgRegionName=mstNewCfgRegionName, fdbSrcPort=fdbSrcPort, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbState=fdbState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoState=portTeamInfoState, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, lacp=lacp, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbLearnedPort=fdbLearnedPort, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoTable=vlanInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgTable=stgNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, cistGeneralInfo=cistGeneralInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbMacAddr=fdbMacAddr, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTable=stpInfoTable, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, cistRootPort=cistRootPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsFinds=fdbStatsFinds, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortIndex=cistInfoPortIndex, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortState=cistInfoPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfo=lacpInfo, stgCurCfgTable=stgCurCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, PYSNMP_MODULE_ID=layer2, cistInfoPortRole=cistInfoPortRole, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Stats=layer2Stats, stgCfg=stgCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoRootCost=stpInfoRootCost, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlan=vlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgState=vlanCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbSrcTrunk=fdbSrcTrunk, fdbInfo=fdbInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbClear=fdbClear, stpInfoHelloTime=stpInfoHelloTime, lacpNewPortState=lacpNewPortState, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoRootPort=stpInfoRootPort, vlanInfoStatus=vlanInfoStatus, vlanCurCfgLearn=vlanCurCfgLearn, trunkgroup=trunkgroup, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistRoot=cistRoot, portTeamInfo=portTeamInfo, fdbVlan=fdbVlan, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgState=stgCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortTable=stpInfoPortTable, layer2Oper=layer2Oper, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoTopChanges=stpInfoTopChanges, fdbRefSps=fdbRefSps, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, mstNewCfgState=mstNewCfgState, vlanInfo=vlanInfo, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortState=stpInfoPortState, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRegionalPathCost=cistRegionalPathCost, fdbEntry=fdbEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortState=lacpCurPortState, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsCurrent=fdbStatsCurrent, fdbTable=fdbTable, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoLearn=vlanInfoLearn, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoName=vlanInfoName, layer2Info=layer2Info, cistInfo=cistInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgTable=vlanNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgState=trunkGroupCurCfgState)
