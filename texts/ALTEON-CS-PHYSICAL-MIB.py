...
Bits, Unsigned32, Integer32, Gauge32, ModuleIdentity, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, IpAddress, NotificationType, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortState=lacpNewPortState, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Info=layer2Info, portTeamCfg=portTeamCfg, lacpInfoPortSelected=lacpInfoPortSelected, cistRegionalRoot=cistRegionalRoot, fdbInfo=fdbInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortState=stpInfoPortState, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoName=vlanInfoName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, fdbStats=fdbStats, portTeamCurCfgTable=portTeamCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortState=cistInfoPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, stpInfo=stpInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTable=cistInfoPortTable, trunkgroup=trunkgroup, stpInfoRootCost=stpInfoRootCost, portTeamInfo=portTeamInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstGeneralCfg=mstGeneralCfg, mstCfg=mstCfg, lacpInfo=lacpInfo, lacp=lacp, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgState=mstNewCfgState, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, fdbLearnedPort=fdbLearnedPort, cistRootPathCost=cistRootPathCost, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistDefaultCfg=mstCistDefaultCfg, BridgeId=BridgeId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgState=stgCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanInfo=vlanInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbState=fdbState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortState=lacpCurPortState, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortTable=stgStatsPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoTrunks=portTeamInfoTrunks, fdbMacAddr=fdbMacAddr, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, layer2Stats=layer2Stats, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoTable=portTeamInfoTable, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcTrunk=fdbSrcTrunk, stpInfoIndex=stpInfoIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortRole=stpInfoPortRole, cistInfo=cistInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoState=portTeamInfoState, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgState=mstCurCfgState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoStatus=vlanInfoStatus, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mirrPortMirr=mirrPortMirr, fdbRefSps=fdbRefSps, layer2=layer2, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortTable=stgNewCfgPortTable, stgCfg=stgCfg, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortRole=cistInfoPortRole, cistRootPort=cistRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, PYSNMP_MODULE_ID=layer2, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortPriority=cistInfoPortPriority, fdbEntry=fdbEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortTableEntry=stgStatsPortTableEntry, stpStats=stpStats, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoPorts=vlanInfoPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgState=portTeamNewCfgState, cistRoot=cistRoot, vlanInfoTable=vlanInfoTable, vlanMaxEnt=vlanMaxEnt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoId=vlanInfoId, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbSrcPort=fdbSrcPort, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, fdbVlan=fdbVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookups=fdbStatsLookups, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsCreates=fdbStatsCreates, mstCistCfg=mstCistCfg, stgNewCfgPortLink=stgNewCfgPortLink, vlan=vlan, mirroring=mirroring, stpInfoMaxAge=stpInfoMaxAge, layer2Oper=layer2Oper, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbClear=fdbClear, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, layer2Configs=layer2Configs, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbTable=fdbTable, stpInfoTable=stpInfoTable, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime)
