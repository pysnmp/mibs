...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgState=portTeamNewCfgState, mstCurCfgState=mstCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurPortState=lacpCurPortState, stpInfoPortEdge=stpInfoPortEdge, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2=layer2, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, fdbVlan=fdbVlan, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, layer2Info=layer2Info, cistInfoPortLinkType=cistInfoPortLinkType, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortState=stgNewCfgPortState, fdbRefSps=fdbRefSps, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, vlan=vlan, mstCistCfg=mstCistCfg, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoTrunks=portTeamInfoTrunks, fdbLearnedPort=fdbLearnedPort, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, vlanMaxEnt=vlanMaxEnt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, vlanNewCfgPorts=vlanNewCfgPorts, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoTable=portTeamInfoTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbInfo=fdbInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoPorts=portTeamInfoPorts, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTable=cistInfoPortTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgTable=vlanNewCfgTable, stpInfoRootCost=stpInfoRootCost, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoState=portTeamInfoState, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfo=vlanInfo, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbEntry=fdbEntry, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgState=stgCurCfgState, portTeamCfg=portTeamCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoName=vlanInfoName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsFinds=fdbStatsFinds, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortTable=stgStatsPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTable=portTeamNewCfgTable, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistGeneralInfo=cistGeneralInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, cistRegionalRoot=cistRegionalRoot, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpStats=stpStats, cistInfoPortRole=cistInfoPortRole, stgCurCfgTable=stgCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfo=lacpInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2Stats=layer2Stats, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoPorts=vlanInfoPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortState=lacpNewPortState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkgroup=trunkgroup, cistRootPathCost=cistRootPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStats=fdbStats, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgState=vlanCurCfgState, stgNewCfgTable=stgNewCfgTable, layer2Oper=layer2Oper, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCfg=stgCfg, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoId=vlanInfoId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortIndex=cistInfoPortIndex, mirroring=mirroring, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfo=cistInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCfg=mstCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistRootPort=cistRootPort, stpInfo=stpInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTable=stpInfoTable, layer2Configs=layer2Configs, stgNewCfgState=stgNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgStg=vlanNewCfgStg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoHelloTime=stpInfoHelloTime, fdbTable=fdbTable, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortState=cistInfoPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mirrPortMirr=mirrPortMirr, fdbStatsCreates=fdbStatsCreates, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, BridgeId=BridgeId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsLookups=fdbStatsLookups, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbClear=fdbClear, fdbSrcPort=fdbSrcPort, stpInfoIndex=stpInfoIndex, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgTable=vlanCurCfgTable, lacp=lacp, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfo=portTeamInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry)
