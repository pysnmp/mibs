...
Unsigned32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Bits, IpAddress, ModuleIdentity, Integer32, MibIdentifier, NotificationType, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Bits", "IpAddress", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "iso", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoPorts=vlanInfoPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsFindFails=fdbStatsFindFails, vlanInfoId=vlanInfoId, mstNewCfgState=mstNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsStpIndex=stgStatsStpIndex, fdbTable=fdbTable, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortTable=stpInfoPortTable, vlanInfoName=vlanInfoName, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCfg=mstCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, cistRootPathCost=cistRootPathCost, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbVlan=fdbVlan, stgCfg=stgCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgTable=vlanNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgIndex=stgNewCfgIndex, fdbEntry=fdbEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCurCfgState=mstCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, layer2Configs=layer2Configs, layer2Stats=layer2Stats, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortTable=lacpInfoPortTable, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortTable=stgStatsPortTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStats=fdbStats, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfo=lacpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirrPortMirr=mirrPortMirr, fdbInfo=fdbInfo, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortState=lacpNewPortState, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoState=portTeamInfoState, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRootPort=cistRootPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsLookups=fdbStatsLookups, stpInfoPortState=stpInfoPortState, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, layer2Oper=layer2Oper, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, stpInfo=stpInfo, mirroring=mirroring, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgStg=vlanCurCfgStg, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoTable=portTeamInfoTable, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTable=stgCurCfgTable, cistInfo=cistInfo, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, layer2=layer2, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgTable=stgNewCfgTable, stpStats=stpStats, cistInfoPortState=cistInfoPortState, mstCistCfg=mstCistCfg, portTeamCfg=portTeamCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortRole=stpInfoPortRole, fdbStatsCreates=fdbStatsCreates, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortLink=stgCurCfgPortLink, cistRoot=cistRoot, cistInfoPortRole=cistInfoPortRole, portTeamInfo=portTeamInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPriority=stgCurCfgPriority, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbState=fdbState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgState=stgNewCfgState, portTeamNewCfgState=portTeamNewCfgState, lacp=lacp, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Info=layer2Info, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcPort=fdbSrcPort, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortTable=stgNewCfgPortTable, fdbClear=fdbClear, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbRefSps=fdbRefSps, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortLink=stgNewCfgPortLink, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgStgIndex=stgCurCfgStgIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoIndex=portTeamInfoIndex, cistRegionalRoot=cistRegionalRoot, vlanMaxEnt=vlanMaxEnt, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, BridgeId=BridgeId, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTableEntry=stpInfoTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkgroup=trunkgroup, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbMacAddr=fdbMacAddr, stpInfoTopChanges=stpInfoTopChanges, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistGeneralInfo=cistGeneralInfo, vlan=vlan, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgState=vlanCurCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, vlanInfo=vlanInfo, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, stpInfoTable=stpInfoTable, stgStatsPortIndex=stgStatsPortIndex)
