...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortTable=lacpInfoPortTable, vlanInfoName=vlanInfoName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgState=vlanNewCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mirroring=mirroring, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfo=stpInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTable=stgCurCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, BridgeId=BridgeId, stgCurCfgState=stgCurCfgState, portTeamInfoState=portTeamInfoState, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootCost=stpInfoRootCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTable=portTeamInfoTable, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortTable=cistInfoPortTable, vlan=vlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbTable=fdbTable, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbMacAddr=fdbMacAddr, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbInfo=fdbInfo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortState=lacpCurPortState, fdbVlan=fdbVlan, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFindFails=fdbStatsFindFails, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortRole=cistInfoPortRole, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortEdge=stpInfoPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCfg=mstCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortState=lacpNewPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mirrPortMirr=mirrPortMirr, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, stpInfoHoldTime=stpInfoHoldTime, fdbStatsLookupFails=fdbStatsLookupFails, fdbRefSps=fdbRefSps, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortTable=stgStatsPortTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanMaxVlanID=vlanMaxVlanID, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortState=stgNewCfgPortState, stpInfoHelloTime=stpInfoHelloTime, fdbStatsFinds=fdbStatsFinds, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRootPathCost=cistRootPathCost, cistRootPort=cistRootPort, fdbEntry=fdbEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoForwardDelay=stpInfoForwardDelay, PYSNMP_MODULE_ID=layer2, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoStatus=vlanInfoStatus, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsStpIndex=stgStatsStpIndex, stpStats=stpStats, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, lacp=lacp, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCfg=stgCfg, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbState=fdbState, vlanInfo=vlanInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoIndex=stpInfoIndex, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCfg=portTeamCfg, vlanCurCfgState=vlanCurCfgState, mstNewCfgState=mstNewCfgState, stpInfoPortRole=stpInfoPortRole, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoRootPort=stpInfoRootPort, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, fdbStatsLookups=fdbStatsLookups, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPriority=stgNewCfgPriority, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortState=cistInfoPortState, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTable=stpInfoTable, cistInfo=cistInfo, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoMaxAge=stpInfoMaxAge, fdbSrcTrunk=fdbSrcTrunk, mstCistCfg=mstCistCfg, vlanInfoId=vlanInfoId, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, fdbClear=fdbClear, layer2Configs=layer2Configs, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsCreates=fdbStatsCreates, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, layer2=layer2, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, cistGeneralInfo=cistGeneralInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfo=lacpInfo, stgNewCfgPortLink=stgNewCfgPortLink, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2Info=layer2Info, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanMaxEnt=vlanMaxEnt, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, cistRoot=cistRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, layer2Stats=layer2Stats, fdbStats=fdbStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfo=portTeamInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoTable=vlanInfoTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistBridgeHelloTime=cistBridgeHelloTime)
