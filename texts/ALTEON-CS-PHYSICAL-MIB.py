...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgPorts=vlanNewCfgPorts, fdbLearnedPort=fdbLearnedPort, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoLearn=vlanInfoLearn, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortTable=stpInfoPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbMacAddr=fdbMacAddr, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortTable=cistInfoPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoHoldTime=stpInfoHoldTime, mstCurCfgStpMode=mstCurCfgStpMode, fdbTable=fdbTable, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Stats=layer2Stats, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoName=vlanInfoName, stgNewCfgIndex=stgNewCfgIndex, fdbInfo=fdbInfo, portTeamCfg=portTeamCfg, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgState=mstCurCfgState, fdbVlan=fdbVlan, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfo=cistInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortIndex=stpInfoPortIndex, layer2=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRegionalPathCost=cistRegionalPathCost, trunkgroup=trunkgroup, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoStatus=vlanInfoStatus, vlanInfo=vlanInfo, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgState=mstNewCfgState, stpInfoTopChanges=stpInfoTopChanges, fdbClear=fdbClear, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortTable=stgStatsPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoRootCost=stpInfoRootCost, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbEntry=fdbEntry, mirroring=mirroring, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbState=fdbState, stgCurCfgIndex=stgCurCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfoTable=portTeamInfoTable, stpInfoPortEdge=stpInfoPortEdge, vlanInfoId=vlanInfoId, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfo=portTeamInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistGeneralInfo=cistGeneralInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbRefSps=fdbRefSps, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRootPort=cistRootPort, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistRoot=cistRoot, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, lacp=lacp, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCfg=mstCistCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoState=portTeamInfoState, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, cistRootPathCost=cistRootPathCost, stgStatsStpIndex=stgStatsStpIndex, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPriority=stgCurCfgPriority, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCfg=stgCfg, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoPorts=vlanInfoPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoTable=stpInfoTable, BridgeId=BridgeId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgState=stgNewCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStats=fdbStats, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCfg=mstCfg, mstNewCfgStpMode=mstNewCfgStpMode, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCreates=fdbStatsCreates, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortState=lacpCurPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, stpInfo=stpInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoTrunks=portTeamInfoTrunks, layer2Oper=layer2Oper, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortRole=cistInfoPortRole)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Configs=layer2Configs, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsLookups=fdbStatsLookups, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortPriority=cistInfoPortPriority, vlanInfoTable=vlanInfoTable, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgStg=vlanCurCfgStg, vlan=vlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFinds=fdbStatsFinds, mstCistBridgeCfg=mstCistBridgeCfg, layer2Info=layer2Info, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortState=lacpNewPortState, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfo=lacpInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpStats=stpStats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoRootPort=stpInfoRootPort, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex)
