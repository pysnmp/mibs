...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, NotificationType, Bits, Gauge32, Counter32, TimeTicks, ObjectIdentity, MibIdentifier, IpAddress, ModuleIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "NotificationType", "Bits", "Gauge32", "Counter32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "IpAddress", "ModuleIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHelloTime=stpInfoHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfo=lacpInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfo=portTeamInfo, mstNewCfgState=mstNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode, fdbSrcPort=fdbSrcPort, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfo=cistInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortState=stgNewCfgPortState, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbLearnedPort=fdbLearnedPort, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, mirrPortMirr=mirrPortMirr, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2Configs=layer2Configs, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacp=lacp, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgTable=stgNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistBridgeCfg=mstCistBridgeCfg, vlan=vlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgLearn=vlanCurCfgLearn, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, BridgeId=BridgeId, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgState=mstCurCfgState, portTeamInfoPorts=portTeamInfoPorts, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoStatus=vlanInfoStatus, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoIndex=stpInfoIndex, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mirroring=mirroring, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Stats=layer2Stats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfo=stpInfo, cistRoot=cistRoot, layer2Info=layer2Info, fdbInfo=fdbInfo, lacpNewPortState=lacpNewPortState, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStats=fdbStats, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, vlanInfo=vlanInfo, stpInfoRootCost=stpInfoRootCost, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbVlan=fdbVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRootPort=cistRootPort, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFinds=fdbStatsFinds, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCfg=mstCfg, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPriority=stgCurCfgPriority, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCfg=mstCistCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoId=vlanInfoId, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, layer2Oper=layer2Oper, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbRefSps=fdbRefSps, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoRootPort=stpInfoRootPort, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTable=vlanInfoTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortIndex=cistInfoPortIndex, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoState=portTeamInfoState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbTable=fdbTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbState=fdbState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpStats=stpStats, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortTable=lacpInfoPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRootPathCost=cistRootPathCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoPorts=vlanInfoPorts, stpInfoHoldTime=stpInfoHoldTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRegionalPathCost=cistRegionalPathCost, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortTable=stpInfoPortTable, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortState=stpInfoPortState, stpInfoPortEdge=stpInfoPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRegionalRoot=cistRegionalRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsFindFails=fdbStatsFindFails, trunkgroup=trunkgroup, fdbEntry=fdbEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCfg=portTeamCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoTable=stpInfoTable, mstGeneralCfg=mstGeneralCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgState=vlanNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortState=cistInfoPortState, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbClear=fdbClear, fdbMacAddr=fdbMacAddr, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgState=stgCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, PYSNMP_MODULE_ID=layer2, lacpInfoPortMoved=lacpInfoPortMoved, stgCfg=stgCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgTable=stgCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoTable=portTeamInfoTable, vlanInfoName=vlanInfoName, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
