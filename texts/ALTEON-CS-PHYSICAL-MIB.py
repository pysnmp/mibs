...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoTable=portTeamInfoTable, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootPort=stpInfoRootPort, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgIndex=stgNewCfgIndex, mstCistCfg=mstCistCfg, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsLookups=fdbStatsLookups, fdbMacAddr=fdbMacAddr, cistInfoPortTable=cistInfoPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurPortState=lacpCurPortState, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortRole=cistInfoPortRole, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoIndex=portTeamInfoIndex, vlanInfo=vlanInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, BridgeId=BridgeId, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortPathCost=stpInfoPortPathCost, layer2=layer2, cistRootPort=cistRootPort, fdbState=fdbState, stpInfoPortTable=stpInfoPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCfg=mstCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistBridgeCfg=mstCistBridgeCfg, layer2Oper=layer2Oper, stgStatsStpIndex=stgStatsStpIndex, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbTable=fdbTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Stats=layer2Stats, stpInfoPortEdge=stpInfoPortEdge, cistInfo=cistInfo, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbSrcPort=fdbSrcPort, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgTable=stgCurCfgTable, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, PYSNMP_MODULE_ID=layer2, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortState=cistInfoPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgState=mstCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfo=lacpInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortMoved=lacpInfoPortMoved, trunkgroup=trunkgroup, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbClear=fdbClear, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoHoldTime=stpInfoHoldTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoTable=vlanInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortRole=stpInfoPortRole, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgPorts=vlanCurCfgPorts, vlan=vlan, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgTable=stgNewCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsHiwat=fdbStatsHiwat, mirrPortMirr=mirrPortMirr, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbLearnedPort=fdbLearnedPort, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoId=vlanInfoId, cistRootPathCost=cistRootPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstGeneralCfg=mstGeneralCfg, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgState=trunkGroupCurCfgState, mirroring=mirroring, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbVlan=fdbVlan, stgNewCfgPortLink=stgNewCfgPortLink, fdbInfo=fdbInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, cistRoot=cistRoot, portTeamCfg=portTeamCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanMaxVlanID=vlanMaxVlanID, fdbStatsDeletes=fdbStatsDeletes, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, lacp=lacp, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Info=layer2Info, portTeamInfoState=portTeamInfoState, stpInfoRootCost=stpInfoRootCost, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoMaxAge=stpInfoMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsFinds=fdbStatsFinds, fdbRefSps=fdbRefSps, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Configs=layer2Configs, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfo=stpInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgState=stgCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfo=portTeamInfo, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsCreates=fdbStatsCreates, stpInfoTable=stpInfoTable, stgCfg=stgCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoName=vlanInfoName, fdbStats=fdbStats, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbEntry=fdbEntry, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortState=lacpNewPortState, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoPorts=vlanInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpStats=stpStats)
