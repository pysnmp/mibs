...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistBridgeMaxAge=cistBridgeMaxAge, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCfg=portTeamCfg, portTeamInfoTable=portTeamInfoTable, cistRoot=cistRoot, layer2Info=layer2Info, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlan=vlan, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTableEntry=stpInfoTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortIndex=stgStatsPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, trunkgroup=trunkgroup, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbState=fdbState, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, fdbStats=fdbStats, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbMacAddr=fdbMacAddr, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistRegionalRoot=cistRegionalRoot, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgState=vlanCurCfgState, stpInfoTopChanges=stpInfoTopChanges, mstCfg=mstCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfo=portTeamInfo, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoName=vlanInfoName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortEdge=stpInfoPortEdge, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoTable=vlanInfoTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, lacp=lacp, BridgeId=BridgeId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbClear=fdbClear, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbInfo=fdbInfo, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Configs=layer2Configs, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCfg=mstCistCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoPorts=portTeamInfoPorts, cistInfo=cistInfo, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfo=stpInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistRootPort=cistRootPort, cistRootPathCost=cistRootPathCost, mstGeneralCfg=mstGeneralCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoRootPort=stpInfoRootPort, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortState=lacpCurPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortRole=stpInfoPortRole, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mirroring=mirroring, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsFinds=fdbStatsFinds, vlanMaxVlanID=vlanMaxVlanID, fdbTable=fdbTable, fdbSrcPort=fdbSrcPort, stpInfoTable=stpInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, vlanMaxEnt=vlanMaxEnt, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsLookups=fdbStatsLookups, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgState=portTeamCurCfgState, fdbStatsHiwat=fdbStatsHiwat, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgState=stgNewCfgState, lacpNewPortState=lacpNewPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoJumbo=vlanInfoJumbo, layer2=layer2, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortIndex=stgCurCfgPortIndex, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoId=vlanInfoId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfo=lacpInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortTable=stgStatsPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortLinkType=stpInfoPortLinkType, cistGeneralInfo=cistGeneralInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpStats=stpStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoBwmContract=vlanInfoBwmContract, mstNewCfgState=mstNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, fdbEntry=fdbEntry, cistInfoPortRole=cistInfoPortRole, vlanInfo=vlanInfo, portTeamInfoIndex=portTeamInfoIndex, fdbVlan=fdbVlan, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, layer2Stats=layer2Stats, fdbRefSps=fdbRefSps, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgState=mstCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Oper=layer2Oper, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCfg=stgCfg, portTeamInfoState=portTeamInfoState)
