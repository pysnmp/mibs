...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, vlanNewCfgJumbo=vlanNewCfgJumbo, BridgeId=BridgeId, fdbClear=fdbClear, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoTableEntry=vlanInfoTableEntry, lacp=lacp, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstGeneralCfg=mstGeneralCfg, layer2Oper=layer2Oper, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsLookups=fdbStatsLookups, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPriority=stgNewCfgPriority, cistBridgeHelloTime=cistBridgeHelloTime, cistRegionalRoot=cistRegionalRoot, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfo=vlanInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortTable=cistInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortState=stpInfoPortState, stgCfg=stgCfg, stgNewCfgIndex=stgNewCfgIndex, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCfg=mstCistCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanMaxVlanID=vlanMaxVlanID, stpStats=stpStats, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, mirrPortMirr=mirrPortMirr, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoId=vlanInfoId, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTable=vlanInfoTable, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoName=vlanInfoName, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCfg=portTeamCfg, stpInfoRootPort=stpInfoRootPort, lacpCurPortState=lacpCurPortState, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgState=mstCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgState=stgCurCfgState, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2Stats=layer2Stats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortRole=cistInfoPortRole, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoState=portTeamInfoState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTable=portTeamInfoTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbState=fdbState, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlan=vlan, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortIndex=stpInfoPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfo=lacpInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortRole=stpInfoPortRole, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfo=stpInfo, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgState=stgNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbTable=fdbTable, fdbSrcPort=fdbSrcPort, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoIndex=stpInfoIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, PYSNMP_MODULE_ID=layer2, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, trunkgroup=trunkgroup, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2=layer2, layer2Info=layer2Info, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, fdbMacAddr=fdbMacAddr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, stpInfoTopChanges=stpInfoTopChanges, stpInfoHelloTime=stpInfoHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsFinds=fdbStatsFinds, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortSelected=lacpInfoPortSelected, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Configs=layer2Configs, stgStatsPortTable=stgStatsPortTable, stgCurCfgTable=stgCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCfg=mstCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbVlan=fdbVlan, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfo=cistInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoPorts=portTeamInfoPorts, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortState=stgCurCfgPortState, cistRoot=cistRoot, stgCurCfgPriority=stgCurCfgPriority, stpInfoRootCost=stpInfoRootCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoPorts=vlanInfoPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistRootPort=cistRootPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgState=mstNewCfgState, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, cistGeneralInfo=cistGeneralInfo, vlanNewCfgState=vlanNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRootPathCost=cistRootPathCost, cistInfoPortState=cistInfoPortState, lacpCurSystemPriority=lacpCurSystemPriority, fdbEntry=fdbEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoLearn=vlanInfoLearn, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbLearnedPort=fdbLearnedPort, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortState=lacpNewPortState, fdbStats=fdbStats, stpInfoTable=stpInfoTable, fdbInfo=fdbInfo, portTeamNewCfgPorts=portTeamNewCfgPorts)
