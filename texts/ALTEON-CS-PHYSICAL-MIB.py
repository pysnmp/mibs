...
TimeTicks, IpAddress, Unsigned32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter64, Counter32, iso, NotificationType, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Unsigned32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter64", "Counter32", "iso", "NotificationType", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoTable=vlanInfoTable, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCurCfgState=portTeamCurCfgState, fdbStatsDeletes=fdbStatsDeletes, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, mstCfg=mstCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgIndex=stgNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortTable=stgCurCfgPortTable, stpInfo=stpInfo, vlanInfoLearn=vlanInfoLearn, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, stgCfg=stgCfg, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurPortState=lacpCurPortState, vlanInfoId=vlanInfoId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mirrPortMirr=mirrPortMirr, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbTable=fdbTable, vlanInfo=vlanInfo, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistGeneralInfo=cistGeneralInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsCreates=fdbStatsCreates, vlanCurCfgStg=vlanCurCfgStg, stpInfoIndex=stpInfoIndex, PYSNMP_MODULE_ID=layer2, trunkgroup=trunkgroup, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookups=fdbStatsLookups, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRoot=cistRoot, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfo=portTeamInfo, layer2Configs=layer2Configs, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbClear=fdbClear, vlanCurCfgTable=vlanCurCfgTable, stpStats=stpStats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCfg=mstCistCfg, portTeamCfg=portTeamCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgState=stgNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, BridgeId=BridgeId, fdbStats=fdbStats, layer2Info=layer2Info, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortState=lacpNewPortState, vlanInfoTableEntry=vlanInfoTableEntry, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortState=stpInfoPortState, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortTable=cistInfoPortTable, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsHiwat=fdbStatsHiwat, vlanInfoName=vlanInfoName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, fdbStatsFinds=fdbStatsFinds, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoMaxAge=stpInfoMaxAge, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoTable=stpInfoTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortIndex=cistInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbState=fdbState, stgStatsStpIndex=stgStatsStpIndex, cistRegionalRoot=cistRegionalRoot, mirroring=mirroring, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoPorts=vlanInfoPorts, vlan=vlan, fdbInfo=fdbInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfo=lacpInfo, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbEntry=fdbEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoBwmContract=vlanInfoBwmContract, cistRootPort=cistRootPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistRootPathCost=cistRootPathCost, vlanNewCfgState=vlanNewCfgState, stpInfoPortTable=stpInfoPortTable, lacp=lacp, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfo=cistInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2Oper=layer2Oper, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbLearnedPort=fdbLearnedPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgState=stgCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgState=mstCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbSrcPort=fdbSrcPort, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoRootCost=stpInfoRootCost, cistInfoPortState=cistInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgIndex=portTeamNewCfgIndex, layer2Stats=layer2Stats, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgState=portTeamNewCfgState, fdbRefSps=fdbRefSps, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgRegionName=mstCurCfgRegionName, fdbVlan=fdbVlan, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbMacAddr=fdbMacAddr, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgTable=stgCurCfgTable, layer2=layer2, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
