...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoTable=vlanInfoTable, stgCurCfgState=stgCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2=layer2, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsLookups=fdbStatsLookups, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgTable=portTeamNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgState=portTeamNewCfgState, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2Stats=layer2Stats, mstGeneralCfg=mstGeneralCfg, stpInfo=stpInfo, BridgeId=BridgeId, fdbSrcPort=fdbSrcPort, portTeamInfoPorts=portTeamInfoPorts, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortTable=cistInfoPortTable, mstNewCfgState=mstNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkgroup=trunkgroup, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoPorts=vlanInfoPorts, cistGeneralInfo=cistGeneralInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoTable=stpInfoTable, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStats=fdbStats, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortTable=stgStatsPortTable, layer2Configs=layer2Configs, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, cistRootPort=cistRootPort, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbEntry=fdbEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbInfo=fdbInfo, stpStats=stpStats, cistInfoPortState=cistInfoPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanMaxEnt=vlanMaxEnt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortTable=stpInfoPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoRootCost=stpInfoRootCost, cistInfoPortLinkType=cistInfoPortLinkType, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanMaxVlanID=vlanMaxVlanID, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoTopChanges=stpInfoTopChanges, cistRootPathCost=cistRootPathCost, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoState=portTeamInfoState, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTable=portTeamInfoTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mirroring=mirroring, stgCfg=stgCfg, layer2Oper=layer2Oper, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbTable=fdbTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbRefSps=fdbRefSps, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, PYSNMP_MODULE_ID=layer2, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfo=portTeamInfo, layer2Info=layer2Info, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgState=vlanNewCfgState, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTable=stgNewCfgTable, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPriority=stgNewCfgPriority, fdbStatsDeletes=fdbStatsDeletes, fdbLearnedPort=fdbLearnedPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCfg=portTeamCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewPortState=lacpNewPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, lacp=lacp, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfo=lacpInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsCurrent=fdbStatsCurrent, stpInfoIndex=stpInfoIndex, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, cistRoot=cistRoot, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgTable=stgCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCfg=mstCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortState=lacpCurPortState, vlanInfoLearn=vlanInfoLearn, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortRole=stpInfoPortRole, cistInfoPortRole=cistInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistRegionalRoot=cistRegionalRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgState=mstCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortTable=lacpInfoPortTable, vlan=vlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfo=vlanInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCfg=mstCistCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbState=fdbState, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoHoldTime=stpInfoHoldTime, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoId=vlanInfoId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfo=cistInfo, mstCistDefaultCfg=mstCistDefaultCfg, fdbMacAddr=fdbMacAddr, cistInfoPortIndex=cistInfoPortIndex, fdbStatsCreates=fdbStatsCreates, vlanInfoName=vlanInfoName, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable)
