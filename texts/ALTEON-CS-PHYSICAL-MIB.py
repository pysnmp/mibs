...
Counter64, ObjectIdentity, IpAddress, Integer32, Gauge32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, ModuleIdentity, iso, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "ModuleIdentity", "iso", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortTable=stgStatsPortTable, fdbVlan=fdbVlan, vlan=vlan, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStats=fdbStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgState=vlanCurCfgState, cistInfoPortState=cistInfoPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfo=vlanInfo, lacpNewPortState=lacpNewPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbMacAddr=fdbMacAddr, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsFindFails=fdbStatsFindFails, vlanInfoPorts=vlanInfoPorts, stgCurCfgIndex=stgCurCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoId=vlanInfoId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoTable=stpInfoTable, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortState=stpInfoPortState, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStatsLookupFails=fdbStatsLookupFails, layer2Info=layer2Info, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, PYSNMP_MODULE_ID=layer2, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpStats=stpStats, vlanInfoStatus=vlanInfoStatus, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstGeneralCfg=mstGeneralCfg, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortRole=cistInfoPortRole, fdbRefSps=fdbRefSps, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbSrcTrunk=fdbSrcTrunk, fdbStatsOverflows=fdbStatsOverflows, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRootPathCost=cistRootPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCfg=stgCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgTable=stgNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortIndex=stpInfoPortIndex, cistRegionalRoot=cistRegionalRoot, mstNewCfgState=mstNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfo=stpInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgState=stgCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2Oper=layer2Oper, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, mstNewCfgStpMode=mstNewCfgStpMode, cistRoot=cistRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurSystemPriority=lacpCurSystemPriority, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoBwmContract=vlanInfoBwmContract, layer2Stats=layer2Stats, lacpInfo=lacpInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoName=vlanInfoName, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, cistRootPort=cistRootPort, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkgroup=trunkgroup, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, mirroring=mirroring, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbLearnedPort=fdbLearnedPort, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortLinkType=stpInfoPortLinkType, cistInfo=cistInfo, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, BridgeId=BridgeId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgState=mstCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, lacp=lacp, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbSrcPort=fdbSrcPort, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoTable=portTeamInfoTable, fdbStatsHiwat=fdbStatsHiwat, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, mirrPortMirr=mirrPortMirr, fdbStatsFinds=fdbStatsFinds, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoRootPort=stpInfoRootPort, stpInfoMaxAge=stpInfoMaxAge, fdbState=fdbState, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoState=portTeamInfoState, layer2=layer2, layer2Configs=layer2Configs, mstCfg=mstCfg, lacpCurPortState=lacpCurPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCfg=portTeamCfg, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbEntry=fdbEntry, stpInfoRootCost=stpInfoRootCost, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, fdbTable=fdbTable, mstCistCfg=mstCistCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfo=portTeamInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbInfo=fdbInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortRole=stpInfoPortRole, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry)
