...
Bits, ObjectIdentity, TimeTicks, Counter32, IpAddress, Counter64, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, ModuleIdentity, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "IpAddress", "Counter64", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "ModuleIdentity", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbRefSps=fdbRefSps, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstGeneralCfg=mstGeneralCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortTable=lacpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortEdge=stpInfoPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoIndex=stpInfoIndex, vlanInfoStatus=vlanInfoStatus, cistInfo=cistInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgState=portTeamNewCfgState, vlanInfoTable=vlanInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbSrcTrunk=fdbSrcTrunk, fdbSrcPort=fdbSrcPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRoot=cistRoot, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortState=cistInfoPortState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTable=stpInfoTable, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistRootPort=cistRootPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbClear=fdbClear, stgCfg=stgCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacp=lacp, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, BridgeId=BridgeId, fdbStatsFinds=fdbStatsFinds, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Oper=layer2Oper, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfo=vlanInfo, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortIndex=stgStatsPortIndex, vlanInfoLearn=vlanInfoLearn, fdbStats=fdbStats, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, layer2Configs=layer2Configs, mstCfg=mstCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortState=stgNewCfgPortState, PYSNMP_MODULE_ID=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortRole=cistInfoPortRole, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoId=vlanInfoId, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgIndex=stgNewCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlan=vlan, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortTableEntry=lacpInfoPortTableEntry, layer2=layer2, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoName=vlanInfoName, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortState=lacpCurPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkgroup=trunkgroup, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, layer2Info=layer2Info, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistGeneralInfo=cistGeneralInfo, stpInfoRootCost=stpInfoRootCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoState=portTeamInfoState, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgState=vlanNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoTable=portTeamInfoTable, stpStats=stpStats, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortStpIndex=stpInfoPortStpIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgIndex=stgCurCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mirrPortMirr=mirrPortMirr, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbEntry=fdbEntry, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortLinkType=stpInfoPortLinkType, stpInfo=stpInfo, stgCurCfgTable=stgCurCfgTable, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, fdbState=fdbState, vlanCurCfgTable=vlanCurCfgTable, stpInfoHelloTime=stpInfoHelloTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgState=portTeamCurCfgState, fdbInfo=fdbInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsLookups=fdbStatsLookups, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbLearnedPort=fdbLearnedPort, portTeamCfg=portTeamCfg, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgState=stgNewCfgState, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, mstCistCfg=mstCistCfg, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgState=stgCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoIndex=portTeamInfoIndex, mirroring=mirroring, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Stats=layer2Stats, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRegionalRoot=cistRegionalRoot, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbMacAddr=fdbMacAddr, lacpInfo=lacpInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfo=portTeamInfo, stgNewCfgPriority=stgNewCfgPriority, fdbTable=fdbTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRootPathCost=cistRootPathCost, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbVlan=fdbVlan, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgState=mstCurCfgState)
