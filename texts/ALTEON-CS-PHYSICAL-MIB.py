...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemPriority=lacpCurSystemPriority, portTeamCfg=portTeamCfg, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, layer2Configs=layer2Configs, stgCurCfgPriority=stgCurCfgPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, trunkgroup=trunkgroup, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoState=portTeamInfoState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortIndex=cistInfoPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoTable=portTeamInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRootPathCost=cistRootPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbVlan=fdbVlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgLearn=vlanCurCfgLearn, mirrPortMirr=mirrPortMirr, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacp=lacp, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStats=fdbStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoRootCost=stpInfoRootCost, stgNewCfgState=stgNewCfgState, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mirroring=mirroring, portTeamInfo=portTeamInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsFinds=fdbStatsFinds, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCfg=stgCfg, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortState=cistInfoPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgTable=stgCurCfgTable, layer2Stats=layer2Stats, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfo=stpInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2=layer2, vlanCurCfgTable=vlanCurCfgTable, vlanInfoLearn=vlanInfoLearn, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfo=vlanInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCreates=fdbStatsCreates, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistRegionalRoot=cistRegionalRoot, lacpCurPortState=lacpCurPortState, mstGeneralCfg=mstGeneralCfg, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCfg=mstCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsLookups=fdbStatsLookups, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, cistRootPort=cistRootPort, cistInfoPortTable=cistInfoPortTable, stgStatsPortIndex=stgStatsPortIndex, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRoot=cistRoot, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfo=lacpInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortIndex=stpInfoPortIndex, mstNewCfgState=mstNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbEntry=fdbEntry, fdbRefSps=fdbRefSps, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfo=cistInfo, stgNewCfgPortState=stgNewCfgPortState, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbTable=fdbTable, mstCistCfg=mstCistCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoHelloTime=stpInfoHelloTime, layer2Info=layer2Info, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, BridgeId=BridgeId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanMaxEnt=vlanMaxEnt, cistInfoPortPriority=cistInfoPortPriority, vlanInfoName=vlanInfoName, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoPorts=vlanInfoPorts, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortRole=stpInfoPortRole, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2Oper=layer2Oper, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoTable=vlanInfoTable, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlan=vlan, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortRole=cistInfoPortRole, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, stpInfoTable=stpInfoTable, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgState=vlanCurCfgState, stpStats=stpStats, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbInfo=fdbInfo, mstCurCfgState=mstCurCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoId=vlanInfoId, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsFindFails=fdbStatsFindFails, fdbStatsHiwat=fdbStatsHiwat, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgState=vlanNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoIndex=stpInfoIndex)
