...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTopChanges=stpInfoTopChanges, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoName=vlanInfoName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Info=layer2Info, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgState=mstNewCfgState, fdbSrcPort=fdbSrcPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgState=vlanCurCfgState, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbVlan=fdbVlan, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoIndex=portTeamInfoIndex, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgTable=vlanNewCfgTable, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsCreates=fdbStatsCreates, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoTable=portTeamInfoTable, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoIndex=stpInfoIndex, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoState=portTeamInfoState, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfo=portTeamInfo, stgNewCfgState=stgNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, layer2Configs=layer2Configs, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbState=fdbState, BridgeId=BridgeId, lacpInfo=lacpInfo, vlanInfoStatus=vlanInfoStatus, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, mstCfg=mstCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, layer2=layer2, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistGeneralInfo=cistGeneralInfo, stgStatsPortIndex=stgStatsPortIndex, fdbStatsFinds=fdbStatsFinds, PYSNMP_MODULE_ID=layer2, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoForwardDelay=stpInfoForwardDelay, cistRootPathCost=cistRootPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortState=stpInfoPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortState=lacpCurPortState, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortLink=stgNewCfgPortLink, mirrPortMirr=mirrPortMirr, cistInfo=cistInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpInfoPortTable=lacpInfoPortTable, trunkgroup=trunkgroup, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoRootPort=stpInfoRootPort, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stpStats=stpStats, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCurCfgState=mstCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, stpInfo=stpInfo, fdbStats=fdbStats, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortTable=stpInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCfg=mstCistCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbEntry=fdbEntry, vlanInfoId=vlanInfoId, cistBridgeMaxAge=cistBridgeMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoMaxAge=stpInfoMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgRegionName=mstCurCfgRegionName, mirroring=mirroring, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbClear=fdbClear, cistRegionalRoot=cistRegionalRoot, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsLookups=fdbStatsLookups, vlanNewCfgDelete=vlanNewCfgDelete, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRootPort=cistRootPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgState=stgCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfo=vlanInfo, vlanMaxEnt=vlanMaxEnt, layer2Oper=layer2Oper, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCfg=portTeamCfg, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbInfo=fdbInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortPathCost=stpInfoPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, cistRoot=cistRoot, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbLearnedPort=fdbLearnedPort, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbRefSps=fdbRefSps, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortState=cistInfoPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacp=lacp, layer2Stats=layer2Stats, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, vlan=vlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsLookupFails=fdbStatsLookupFails, mstGeneralCfg=mstGeneralCfg, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCfg=stgCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoTable=stpInfoTable, vlanInfoPorts=vlanInfoPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable)
