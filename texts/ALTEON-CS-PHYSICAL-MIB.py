...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortPathCost=cistInfoPortPathCost, cistInfo=cistInfo, vlanInfoId=vlanInfoId, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoLearn=vlanInfoLearn, stpInfoPortState=stpInfoPortState, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, vlanInfoTable=vlanInfoTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoName=vlanInfoName, fdbVlan=fdbVlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistRootPathCost=cistRootPathCost, stpInfoTopChanges=stpInfoTopChanges, stgStatsStpIndex=stgStatsStpIndex, cistRegionalPathCost=cistRegionalPathCost, fdbLearnedPort=fdbLearnedPort, vlanInfoBwmContract=vlanInfoBwmContract, layer2=layer2, mirrPortMirr=mirrPortMirr, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCfg=mstCfg, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2Stats=layer2Stats, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTable=portTeamInfoTable, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRoot=cistRoot, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortState=stgCurCfgPortState, lacp=lacp, stgCurCfgPriority=stgCurCfgPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbClear=fdbClear, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTable=vlanNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, BridgeId=BridgeId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, PYSNMP_MODULE_ID=layer2, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, stpInfoRootPort=stpInfoRootPort, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoForwardDelay=stpInfoForwardDelay, fdbEntry=fdbEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbTable=fdbTable, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanMaxEnt=vlanMaxEnt, vlanInfo=vlanInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkgroup=trunkgroup, lacpNewPortState=lacpNewPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpStats=stpStats, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistGeneralInfo=cistGeneralInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgStg=vlanCurCfgStg, fdbStatsDeletes=fdbStatsDeletes, mstCistCfg=mstCistCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStats=fdbStats, fdbInfo=fdbInfo, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, fdbSrcPort=fdbSrcPort, stpInfoPortTable=stpInfoPortTable, cistInfoPortTable=cistInfoPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfo=lacpInfo, stpInfoPortRole=stpInfoPortRole, mstCurCfgRegionName=mstCurCfgRegionName, stgCfg=stgCfg, fdbStatsLookups=fdbStatsLookups, vlan=vlan, portTeamInfoPorts=portTeamInfoPorts, fdbMacAddr=fdbMacAddr, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCurCfgState=mstCurCfgState, stpInfoTable=stpInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortTable=stgStatsPortTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, vlanNewCfgPorts=vlanNewCfgPorts, mirroring=mirroring, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortIndex=cistInfoPortIndex, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortState=cistInfoPortState, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfo=portTeamInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Configs=layer2Configs, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgTable=stgCurCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgState=stgCurCfgState, fdbStatsFinds=fdbStatsFinds)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCfg=portTeamCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfo=stpInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoIndex=stpInfoIndex, cistRootPort=cistRootPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurPortState=lacpCurPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2Oper=layer2Oper, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbState=fdbState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbRefSps=fdbRefSps, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Info=layer2Info, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortState=stgNewCfgPortState)
