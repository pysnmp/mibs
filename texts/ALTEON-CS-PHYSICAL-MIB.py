...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, cistRootPathCost=cistRootPathCost, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoRootPort=stpInfoRootPort, fdbStatsCurrent=fdbStatsCurrent, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortTable=stgCurCfgPortTable, fdbEntry=fdbEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, vlanInfoName=vlanInfoName, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPriority=stgCurCfgPriority, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgStg=vlanCurCfgStg, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2Configs=layer2Configs, stpInfoPortTable=stpInfoPortTable, fdbClear=fdbClear, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoTable=stpInfoTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstGeneralCfg=mstGeneralCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoTable=vlanInfoTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoState=portTeamInfoState, layer2Info=layer2Info, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbTable=fdbTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistDefaultCfg=mstCistDefaultCfg, stgCfg=stgCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgState=vlanCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgIndex=stgNewCfgIndex, mirrPortMirr=mirrPortMirr, trunkgroup=trunkgroup, fdbStats=fdbStats, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfo=lacpInfo, vlanNewCfgTable=vlanNewCfgTable, layer2=layer2, fdbRefSps=fdbRefSps, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortIndex=lacpInfoPortIndex, cistRoot=cistRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoStatus=vlanInfoStatus, layer2Oper=layer2Oper, vlanInfoId=vlanInfoId, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsLookups=fdbStatsLookups, cistInfoPortTable=cistInfoPortTable, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoPorts=vlanInfoPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpStats=stpStats, vlanInfo=vlanInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCfg=mstCistCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgState=mstCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCfg=mstCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortState=cistInfoPortState, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgState=stgNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbInfo=fdbInfo, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgState=vlanNewCfgState, layer2Stats=layer2Stats, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoRootCost=stpInfoRootCost, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortPathCost=cistInfoPortPathCost, stpInfo=stpInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoLearn=vlanInfoLearn, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortState=lacpNewPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, fdbMacAddr=fdbMacAddr, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, BridgeId=BridgeId, portTeamCfg=portTeamCfg, lacpCurSystemPriority=lacpCurSystemPriority, mirroring=mirroring, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbState=fdbState, PYSNMP_MODULE_ID=layer2, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbVlan=fdbVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsCreates=fdbStatsCreates, portTeamInfo=portTeamInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortPathCost=stpInfoPortPathCost, vlan=vlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfo=cistInfo, vlanMaxVlanID=vlanMaxVlanID, mstNewCfgState=mstNewCfgState, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortState=stpInfoPortState, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgStpMode=mstNewCfgStpMode, cistRootPort=cistRootPort, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacp=lacp, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsFinds=fdbStatsFinds, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge)
