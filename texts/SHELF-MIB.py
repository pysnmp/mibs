...
mibBuilder.exportSymbols("SHELF-MIB", boardSlotName=boardSlotName, boardFirstPortIndex=boardFirstPortIndex, boardProtectionType=boardProtectionType, eowClockMode=eowClockMode, eow=eow, PYSNMP_MODULE_ID=shelf, LedType=LedType, laserNumber=laserNumber, eowEntry=eowEntry, softInventoryNumber=softInventoryNumber, boardSeverity=boardSeverity, laserTxEnable=laserTxEnable, hardInventoryNumber=hardInventoryNumber, eowSrcType=eowSrcType, boardFailure=boardFailure, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryDescr=hardInventoryDescr, EOWClockMode=EOWClockMode, holdTime=holdTime, softInventoryBoard=softInventoryBoard, adrHotReset=adrHotReset, laserTable=laserTable, led=led, softInventoryExt=softInventoryExt, boardIndex=boardIndex, hardInventoryEntry=hardInventoryEntry, eowIndex=eowIndex, boardDefectiveSev=boardDefectiveSev, eowName=eowName, hardInventoryIndex=hardInventoryIndex, boardListTable=boardListTable, eowTable=eowTable, boardListIndex=boardListIndex, boardMissingSev=boardMissingSev, boardListType=boardListType, laserEntry=laserEntry, boardList=boardList, eowSrcPtr=eowSrcPtr, EOWType=EOWType, board=board, boardInsertType=boardInsertType, ledEntry=ledEntry, boardMonitor=boardMonitor, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryCode=softInventoryCode, hardInventoryTable=hardInventoryTable, ledTable=ledTable, ProtectionType=ProtectionType, ledNumber=ledNumber, ledPosition=ledPosition, eowNumber=eowNumber, laser=laser, hardInv=hardInv, softInventoryIndex=softInventoryIndex, softInventoryEntry=softInventoryEntry, LedStatus=LedStatus, boardExpectFamily=boardExpectFamily, ledStatus=ledStatus, ledIndex=ledIndex, boardListSlot=boardListSlot, softInventoryTable=softInventoryTable, HoldTime=HoldTime, hardInventoryBoard=hardInventoryBoard, boardListNumber=boardListNumber, boardEntry=boardEntry, softInv=softInv, boardMismatchSev=boardMismatchSev, boardExpectType=boardExpectType, laserIndex=laserIndex, eowSinkType=eowSinkType, boardInsertFamily=boardInsertFamily, laserALSEnable=laserALSEnable, boardNumber=boardNumber, BoardFailure=BoardFailure, boardListEntry=boardListEntry, softInventoryType=softInventoryType, laserALSRestart2s=laserALSRestart2s, eowSinkPtr=eowSinkPtr, boardTable=boardTable, shelf=shelf, boardActive=boardActive, laserALSRestart90s=laserALSRestart90s, ledType=ledType)
