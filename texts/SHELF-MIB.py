...
IpAddress, MibIdentifier, ObjectIdentity, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, NotificationType, Unsigned32, Bits, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "NotificationType", "Unsigned32", "Bits", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SHELF-MIB", laserNumber=laserNumber, boardFirstPortIndex=boardFirstPortIndex, boardDefectiveSev=boardDefectiveSev, ProtectionType=ProtectionType, ledIndex=ledIndex, laserEntry=laserEntry, LedStatus=LedStatus, laserIndex=laserIndex, softInventoryIndex=softInventoryIndex, led=led, softInventoryBoard=softInventoryBoard, boardExpectFamily=boardExpectFamily, BoardFailure=BoardFailure, boardListSlot=boardListSlot, softInventoryTable=softInventoryTable, boardActive=boardActive, softInventoryType=softInventoryType, laserTable=laserTable, boardNumber=boardNumber, eowNumber=eowNumber, LedType=LedType, boardEntry=boardEntry, adrHotReset=adrHotReset, boardIndex=boardIndex, softInventoryNumber=softInventoryNumber, laserALSEnable=laserALSEnable, ledStatus=ledStatus, softInventoryEntry=softInventoryEntry, shelf=shelf, boardProtectionType=boardProtectionType, EOWType=EOWType, ledNumber=ledNumber, HoldTime=HoldTime, hardInventoryTable=hardInventoryTable, adrFailHoldOnTime=adrFailHoldOnTime, boardTable=boardTable, laserALSRestart2s=laserALSRestart2s, hardInventoryBoard=hardInventoryBoard, hardInventoryIndex=hardInventoryIndex, eowSinkType=eowSinkType, boardList=boardList, eowSinkPtr=eowSinkPtr, adrFailHoldOffTime=adrFailHoldOffTime, laser=laser, softInventoryCode=softInventoryCode, ledPosition=ledPosition, boardListNumber=boardListNumber, boardSlotName=boardSlotName, boardMissingSev=boardMissingSev, holdTime=holdTime, eowClockMode=eowClockMode, boardListIndex=boardListIndex, ledTable=ledTable, hardInv=hardInv, EOWClockMode=EOWClockMode, laserTxEnable=laserTxEnable, eow=eow, hardInventoryNumber=hardInventoryNumber, ledType=ledType, eowSrcType=eowSrcType, eowTable=eowTable, softInv=softInv, board=board, boardExpectType=boardExpectType, boardMismatchSev=boardMismatchSev, boardListEntry=boardListEntry, ledEntry=ledEntry, softInventoryExt=softInventoryExt, boardInsertType=boardInsertType, eowIndex=eowIndex, boardListType=boardListType, boardMonitor=boardMonitor, laserALSRestart90s=laserALSRestart90s, eowSrcPtr=eowSrcPtr, boardFailure=boardFailure, eowName=eowName, boardListTable=boardListTable, PYSNMP_MODULE_ID=shelf, hardInventoryDescr=hardInventoryDescr, boardSeverity=boardSeverity, boardInsertFamily=boardInsertFamily, hardInventoryEntry=hardInventoryEntry, eowEntry=eowEntry)
