...
mibBuilder.exportSymbols("SHELF-MIB", ledNumber=ledNumber, holdTime=holdTime, laserNumber=laserNumber, hardInventoryDescr=hardInventoryDescr, boardListTable=boardListTable, softInventoryExt=softInventoryExt, adrFailHoldOffTime=adrFailHoldOffTime, ledTable=ledTable, hardInventoryBoard=hardInventoryBoard, hardInventoryNumber=hardInventoryNumber, boardExpectType=boardExpectType, eowEntry=eowEntry, led=led, boardEntry=boardEntry, boardListType=boardListType, ProtectionType=ProtectionType, BoardFailure=BoardFailure, LedStatus=LedStatus, ledEntry=ledEntry, softInventoryCode=softInventoryCode, laserEntry=laserEntry, softInventoryEntry=softInventoryEntry, laserALSEnable=laserALSEnable, eowSinkPtr=eowSinkPtr, boardMismatchSev=boardMismatchSev, board=board, boardTable=boardTable, boardListSlot=boardListSlot, laserALSRestart90s=laserALSRestart90s, boardSeverity=boardSeverity, hardInventoryIndex=hardInventoryIndex, boardDefectiveSev=boardDefectiveSev, boardListEntry=boardListEntry, hardInv=hardInv, ledIndex=ledIndex, softInventoryIndex=softInventoryIndex, eowName=eowName, softInventoryBoard=softInventoryBoard, eowTable=eowTable, PYSNMP_MODULE_ID=shelf, eow=eow, laserALSRestart2s=laserALSRestart2s, laser=laser, eowClockMode=eowClockMode, boardMonitor=boardMonitor, ledStatus=ledStatus, boardFailure=boardFailure, eowSrcType=eowSrcType, hardInventoryEntry=hardInventoryEntry, boardFirstPortIndex=boardFirstPortIndex, shelf=shelf, ledType=ledType, boardSlotName=boardSlotName, softInventoryTable=softInventoryTable, boardProtectionType=boardProtectionType, boardMissingSev=boardMissingSev, softInv=softInv, HoldTime=HoldTime, eowSinkType=eowSinkType, boardListIndex=boardListIndex, softInventoryType=softInventoryType, boardInsertFamily=boardInsertFamily, boardNumber=boardNumber, LedType=LedType, EOWType=EOWType, ledPosition=ledPosition, laserIndex=laserIndex, EOWClockMode=EOWClockMode, softInventoryNumber=softInventoryNumber, eowIndex=eowIndex, boardInsertType=boardInsertType, hardInventoryTable=hardInventoryTable, boardActive=boardActive, boardIndex=boardIndex, adrFailHoldOnTime=adrFailHoldOnTime, eowNumber=eowNumber, eowSrcPtr=eowSrcPtr, adrHotReset=adrHotReset, laserTxEnable=laserTxEnable, boardList=boardList, laserTable=laserTable, boardListNumber=boardListNumber, boardExpectFamily=boardExpectFamily)
