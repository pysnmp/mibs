...
mibBuilder.exportSymbols("SHELF-MIB", shelf=shelf, eowSrcPtr=eowSrcPtr, eowNumber=eowNumber, LedStatus=LedStatus, softInventoryIndex=softInventoryIndex, ledTable=ledTable, boardActive=boardActive, softInventoryEntry=softInventoryEntry, boardIndex=boardIndex, hardInventoryNumber=hardInventoryNumber, hardInventoryEntry=hardInventoryEntry, softInventoryType=softInventoryType, HoldTime=HoldTime, ledStatus=ledStatus, eowIndex=eowIndex, boardExpectType=boardExpectType, boardExpectFamily=boardExpectFamily, holdTime=holdTime, softInventoryTable=softInventoryTable, boardList=boardList, boardInsertFamily=boardInsertFamily, eowSinkType=eowSinkType, hardInventoryTable=hardInventoryTable, eow=eow, boardSlotName=boardSlotName, eowEntry=eowEntry, led=led, softInventoryNumber=softInventoryNumber, softInventoryBoard=softInventoryBoard, boardMonitor=boardMonitor, boardProtectionType=boardProtectionType, boardMismatchSev=boardMismatchSev, laser=laser, PYSNMP_MODULE_ID=shelf, hardInventoryBoard=hardInventoryBoard, eowClockMode=eowClockMode, EOWType=EOWType, hardInventoryIndex=hardInventoryIndex, laserNumber=laserNumber, laserTxEnable=laserTxEnable, eowSinkPtr=eowSinkPtr, ledEntry=ledEntry, boardDefectiveSev=boardDefectiveSev, adrHotReset=adrHotReset, softInventoryExt=softInventoryExt, boardInsertType=boardInsertType, boardNumber=boardNumber, laserALSRestart90s=laserALSRestart90s, eowTable=eowTable, boardListTable=boardListTable, softInv=softInv, adrFailHoldOffTime=adrFailHoldOffTime, boardListType=boardListType, hardInventoryDescr=hardInventoryDescr, adrFailHoldOnTime=adrFailHoldOnTime, boardMissingSev=boardMissingSev, boardListIndex=boardListIndex, boardEntry=boardEntry, laserEntry=laserEntry, boardListNumber=boardListNumber, EOWClockMode=EOWClockMode, laserIndex=laserIndex, laserALSRestart2s=laserALSRestart2s, hardInv=hardInv, BoardFailure=BoardFailure, ledType=ledType, eowName=eowName, boardListSlot=boardListSlot, boardFailure=boardFailure, laserALSEnable=laserALSEnable, board=board, softInventoryCode=softInventoryCode, boardListEntry=boardListEntry, LedType=LedType, boardFirstPortIndex=boardFirstPortIndex, boardSeverity=boardSeverity, ProtectionType=ProtectionType, eowSrcType=eowSrcType, ledPosition=ledPosition, boardTable=boardTable, ledIndex=ledIndex, laserTable=laserTable, ledNumber=ledNumber)
