...
mibBuilder.exportSymbols("SHELF-MIB", laserNumber=laserNumber, laserALSEnable=laserALSEnable, ledIndex=ledIndex, softInventoryCode=softInventoryCode, ledNumber=ledNumber, EOWType=EOWType, boardMissingSev=boardMissingSev, boardActive=boardActive, boardListTable=boardListTable, board=board, boardSlotName=boardSlotName, boardTable=boardTable, laserEntry=laserEntry, softInventoryTable=softInventoryTable, eowNumber=eowNumber, boardEntry=boardEntry, laserTable=laserTable, HoldTime=HoldTime, softInventoryType=softInventoryType, softInventoryIndex=softInventoryIndex, boardListNumber=boardListNumber, boardList=boardList, softInventoryEntry=softInventoryEntry, hardInv=hardInv, PYSNMP_MODULE_ID=shelf, LedStatus=LedStatus, adrFailHoldOnTime=adrFailHoldOnTime, ProtectionType=ProtectionType, boardExpectType=boardExpectType, EOWClockMode=EOWClockMode, laserIndex=laserIndex, boardFirstPortIndex=boardFirstPortIndex, boardListType=boardListType, adrHotReset=adrHotReset, eowIndex=eowIndex, boardMismatchSev=boardMismatchSev, boardSeverity=boardSeverity, eowSinkType=eowSinkType, ledEntry=ledEntry, boardListSlot=boardListSlot, shelf=shelf, holdTime=holdTime, BoardFailure=BoardFailure, ledStatus=ledStatus, laser=laser, boardListIndex=boardListIndex, eowTable=eowTable, eowSrcPtr=eowSrcPtr, boardMonitor=boardMonitor, softInventoryExt=softInventoryExt, LedType=LedType, boardProtectionType=boardProtectionType, hardInventoryBoard=hardInventoryBoard, softInventoryBoard=softInventoryBoard, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryEntry=hardInventoryEntry, boardListEntry=boardListEntry, softInventoryNumber=softInventoryNumber, boardInsertType=boardInsertType, softInv=softInv, hardInventoryNumber=hardInventoryNumber, ledPosition=ledPosition, boardFailure=boardFailure, hardInventoryDescr=hardInventoryDescr, eowSinkPtr=eowSinkPtr, eowClockMode=eowClockMode, ledType=ledType, led=led, hardInventoryIndex=hardInventoryIndex, eow=eow, laserALSRestart90s=laserALSRestart90s, hardInventoryTable=hardInventoryTable, boardInsertFamily=boardInsertFamily, ledTable=ledTable, laserTxEnable=laserTxEnable, boardIndex=boardIndex, eowName=eowName, boardDefectiveSev=boardDefectiveSev, eowEntry=eowEntry, boardNumber=boardNumber, boardExpectFamily=boardExpectFamily, laserALSRestart2s=laserALSRestart2s, eowSrcType=eowSrcType)
