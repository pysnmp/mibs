...
Bits, Counter64, Gauge32, ObjectIdentity, Counter32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Unsigned32, IpAddress, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "Counter32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SHELF-MIB", eowSinkPtr=eowSinkPtr, ledNumber=ledNumber, boardInsertFamily=boardInsertFamily, eowSrcPtr=eowSrcPtr, softInventoryCode=softInventoryCode, laserNumber=laserNumber, ledPosition=ledPosition, EOWClockMode=EOWClockMode, laserTable=laserTable, LedStatus=LedStatus, boardTable=boardTable, boardInsertType=boardInsertType, hardInventoryEntry=hardInventoryEntry, boardListSlot=boardListSlot, softInventoryIndex=softInventoryIndex, led=led, ledStatus=ledStatus, softInventoryExt=softInventoryExt, boardEntry=boardEntry, boardExpectFamily=boardExpectFamily, softInventoryBoard=softInventoryBoard, hardInventoryDescr=hardInventoryDescr, boardListType=boardListType, laserTxEnable=laserTxEnable, eowName=eowName, hardInv=hardInv, BoardFailure=BoardFailure, boardSlotName=boardSlotName, boardListEntry=boardListEntry, boardNumber=boardNumber, boardList=boardList, boardExpectType=boardExpectType, laserALSRestart90s=laserALSRestart90s, HoldTime=HoldTime, laserIndex=laserIndex, boardDefectiveSev=boardDefectiveSev, adrFailHoldOnTime=adrFailHoldOnTime, ProtectionType=ProtectionType, ledTable=ledTable, adrHotReset=adrHotReset, hardInventoryNumber=hardInventoryNumber, laserALSRestart2s=laserALSRestart2s, holdTime=holdTime, softInv=softInv, boardMonitor=boardMonitor, hardInventoryIndex=hardInventoryIndex, boardIndex=boardIndex, softInventoryTable=softInventoryTable, boardSeverity=boardSeverity, eowSinkType=eowSinkType, shelf=shelf, eowIndex=eowIndex, hardInventoryTable=hardInventoryTable, boardFirstPortIndex=boardFirstPortIndex, boardMismatchSev=boardMismatchSev, EOWType=EOWType, adrFailHoldOffTime=adrFailHoldOffTime, eowEntry=eowEntry, eow=eow, softInventoryType=softInventoryType, laser=laser, PYSNMP_MODULE_ID=shelf, board=board, softInventoryNumber=softInventoryNumber, ledType=ledType, hardInventoryBoard=hardInventoryBoard, eowSrcType=eowSrcType, eowNumber=eowNumber, laserEntry=laserEntry, LedType=LedType, laserALSEnable=laserALSEnable, ledEntry=ledEntry, eowClockMode=eowClockMode, boardFailure=boardFailure, boardMissingSev=boardMissingSev, boardListNumber=boardListNumber, boardListTable=boardListTable, softInventoryEntry=softInventoryEntry, boardProtectionType=boardProtectionType, ledIndex=ledIndex, eowTable=eowTable, boardListIndex=boardListIndex, boardActive=boardActive)
