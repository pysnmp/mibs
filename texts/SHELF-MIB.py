...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, ObjectIdentity, IpAddress, NotificationType, Counter32, iso, Bits, Unsigned32, ModuleIdentity, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "iso", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("SHELF-MIB", board=board, hardInventoryNumber=hardInventoryNumber, boardIndex=boardIndex, boardDefectiveSev=boardDefectiveSev, BoardFailure=BoardFailure, led=led, boardListSlot=boardListSlot, boardMissingSev=boardMissingSev, boardTable=boardTable, boardListNumber=boardListNumber, shelf=shelf, boardList=boardList, laserIndex=laserIndex, adrFailHoldOffTime=adrFailHoldOffTime, eowNumber=eowNumber, ProtectionType=ProtectionType, softInventoryTable=softInventoryTable, ledIndex=ledIndex, softInventoryCode=softInventoryCode, laserNumber=laserNumber, boardNumber=boardNumber, laser=laser, adrHotReset=adrHotReset, boardInsertType=boardInsertType, boardMismatchSev=boardMismatchSev, boardFailure=boardFailure, softInventoryExt=softInventoryExt, laserTxEnable=laserTxEnable, hardInventoryEntry=hardInventoryEntry, adrFailHoldOnTime=adrFailHoldOnTime, boardListEntry=boardListEntry, PYSNMP_MODULE_ID=shelf, ledType=ledType, eowClockMode=eowClockMode, eow=eow, eowTable=eowTable, laserEntry=laserEntry, laserTable=laserTable, eowSrcType=eowSrcType, softInventoryNumber=softInventoryNumber, boardListIndex=boardListIndex, softInventoryEntry=softInventoryEntry, hardInv=hardInv, softInventoryIndex=softInventoryIndex, boardProtectionType=boardProtectionType, softInventoryBoard=softInventoryBoard, laserALSRestart90s=laserALSRestart90s, boardListTable=boardListTable, eowSinkType=eowSinkType, laserALSRestart2s=laserALSRestart2s, boardExpectType=boardExpectType, boardEntry=boardEntry, hardInventoryDescr=hardInventoryDescr, eowSrcPtr=eowSrcPtr, ledPosition=ledPosition, boardSeverity=boardSeverity, softInv=softInv, ledTable=ledTable, ledStatus=ledStatus, eowSinkPtr=eowSinkPtr, EOWClockMode=EOWClockMode, eowName=eowName, boardInsertFamily=boardInsertFamily, boardExpectFamily=boardExpectFamily, boardSlotName=boardSlotName, boardMonitor=boardMonitor, eowEntry=eowEntry, boardFirstPortIndex=boardFirstPortIndex, EOWType=EOWType, LedType=LedType, ledNumber=ledNumber, eowIndex=eowIndex, softInventoryType=softInventoryType, holdTime=holdTime, boardActive=boardActive, hardInventoryIndex=hardInventoryIndex, HoldTime=HoldTime, hardInventoryBoard=hardInventoryBoard, hardInventoryTable=hardInventoryTable, ledEntry=ledEntry, laserALSEnable=laserALSEnable, LedStatus=LedStatus, boardListType=boardListType)
