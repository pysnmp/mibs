...
Integer32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, iso, MibIdentifier, Counter64, Unsigned32, ModuleIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryType=softInventoryType, boardList=boardList, softInventoryCode=softInventoryCode, boardMissingSev=boardMissingSev, eowClockMode=eowClockMode, led=led, BoardFailure=BoardFailure, softInventoryTable=softInventoryTable, LedStatus=LedStatus, boardIndex=boardIndex, EOWClockMode=EOWClockMode, eow=eow, board=board, laserALSRestart90s=laserALSRestart90s, ledType=ledType, eowEntry=eowEntry, boardSeverity=boardSeverity, softInv=softInv, HoldTime=HoldTime, ledEntry=ledEntry, eowIndex=eowIndex, ledStatus=ledStatus, eowNumber=eowNumber, boardProtectionType=boardProtectionType, hardInventoryDescr=hardInventoryDescr, boardListType=boardListType, laserTable=laserTable, boardSlotName=boardSlotName, boardListSlot=boardListSlot, boardListIndex=boardListIndex, eowSrcPtr=eowSrcPtr, shelf=shelf, laserEntry=laserEntry, ledNumber=ledNumber, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, laserNumber=laserNumber, ledIndex=ledIndex, boardExpectType=boardExpectType, boardInsertType=boardInsertType, boardEntry=boardEntry, eowSrcType=eowSrcType, boardInsertFamily=boardInsertFamily, hardInventoryNumber=hardInventoryNumber, holdTime=holdTime, boardTable=boardTable, laserALSEnable=laserALSEnable, softInventoryNumber=softInventoryNumber, adrFailHoldOnTime=adrFailHoldOnTime, PYSNMP_MODULE_ID=shelf, laserIndex=laserIndex, laser=laser, hardInventoryBoard=hardInventoryBoard, adrFailHoldOffTime=adrFailHoldOffTime, boardFailure=boardFailure, EOWType=EOWType, ledTable=ledTable, softInventoryExt=softInventoryExt, softInventoryIndex=softInventoryIndex, hardInventoryTable=hardInventoryTable, softInventoryBoard=softInventoryBoard, eowSinkType=eowSinkType, LedType=LedType, hardInv=hardInv, laserTxEnable=laserTxEnable, boardNumber=boardNumber, eowSinkPtr=eowSinkPtr, boardExpectFamily=boardExpectFamily, boardDefectiveSev=boardDefectiveSev, boardListTable=boardListTable, ledPosition=ledPosition, ProtectionType=ProtectionType, hardInventoryIndex=hardInventoryIndex, softInventoryEntry=softInventoryEntry, boardMismatchSev=boardMismatchSev, eowName=eowName, laserALSRestart2s=laserALSRestart2s, hardInventoryEntry=hardInventoryEntry, boardListEntry=boardListEntry, boardActive=boardActive, adrHotReset=adrHotReset, eowTable=eowTable, boardListNumber=boardListNumber)
