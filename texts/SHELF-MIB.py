...
Integer32, ModuleIdentity, Bits, iso, Counter32, TimeTicks, Counter64, NotificationType, Gauge32, Unsigned32, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "iso", "Counter32", "TimeTicks", "Counter64", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SHELF-MIB", hardInventoryNumber=hardInventoryNumber, LedType=LedType, laserTable=laserTable, eowTable=eowTable, eowSinkType=eowSinkType, boardIndex=boardIndex, boardSlotName=boardSlotName, eowName=eowName, softInventoryBoard=softInventoryBoard, hardInventoryIndex=hardInventoryIndex, boardProtectionType=boardProtectionType, hardInventoryBoard=hardInventoryBoard, laserEntry=laserEntry, laserTxEnable=laserTxEnable, boardFailure=boardFailure, softInventoryIndex=softInventoryIndex, boardInsertFamily=boardInsertFamily, laserALSRestart2s=laserALSRestart2s, softInv=softInv, laserNumber=laserNumber, adrFailHoldOffTime=adrFailHoldOffTime, ledTable=ledTable, hardInventoryEntry=hardInventoryEntry, BoardFailure=BoardFailure, led=led, ledStatus=ledStatus, hardInventoryTable=hardInventoryTable, adrHotReset=adrHotReset, HoldTime=HoldTime, softInventoryType=softInventoryType, laser=laser, ledNumber=ledNumber, eowIndex=eowIndex, boardMissingSev=boardMissingSev, laserALSEnable=laserALSEnable, boardInsertType=boardInsertType, softInventoryExt=softInventoryExt, LedStatus=LedStatus, boardListTable=boardListTable, eowClockMode=eowClockMode, ledPosition=ledPosition, boardList=boardList, laserALSRestart90s=laserALSRestart90s, boardTable=boardTable, boardEntry=boardEntry, hardInv=hardInv, boardFirstPortIndex=boardFirstPortIndex, eowEntry=eowEntry, softInventoryCode=softInventoryCode, ledIndex=ledIndex, boardSeverity=boardSeverity, laserIndex=laserIndex, boardMonitor=boardMonitor, eowSrcType=eowSrcType, shelf=shelf, softInventoryEntry=softInventoryEntry, boardNumber=boardNumber, EOWClockMode=EOWClockMode, EOWType=EOWType, boardListNumber=boardListNumber, ledType=ledType, ProtectionType=ProtectionType, adrFailHoldOnTime=adrFailHoldOnTime, ledEntry=ledEntry, eowSrcPtr=eowSrcPtr, PYSNMP_MODULE_ID=shelf, softInventoryTable=softInventoryTable, holdTime=holdTime, eow=eow, boardListEntry=boardListEntry, softInventoryNumber=softInventoryNumber, eowSinkPtr=eowSinkPtr, board=board, boardListIndex=boardListIndex, boardMismatchSev=boardMismatchSev, boardListSlot=boardListSlot, hardInventoryDescr=hardInventoryDescr, boardDefectiveSev=boardDefectiveSev, eowNumber=eowNumber, boardActive=boardActive, boardExpectType=boardExpectType, boardListType=boardListType, boardExpectFamily=boardExpectFamily)
