...
mibBuilder.exportSymbols("SHELF-MIB", boardListEntry=boardListEntry, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryEntry=softInventoryEntry, eowTable=eowTable, eowEntry=eowEntry, eowIndex=eowIndex, laserALSEnable=laserALSEnable, eowName=eowName, boardInsertFamily=boardInsertFamily, boardSlotName=boardSlotName, softInventoryNumber=softInventoryNumber, laserTxEnable=laserTxEnable, eowSinkPtr=eowSinkPtr, eow=eow, laserALSRestart2s=laserALSRestart2s, ledPosition=ledPosition, hardInventoryEntry=hardInventoryEntry, ledStatus=ledStatus, hardInventoryBoard=hardInventoryBoard, boardFirstPortIndex=boardFirstPortIndex, softInventoryCode=softInventoryCode, boardListNumber=boardListNumber, BoardFailure=BoardFailure, adrFailHoldOffTime=adrFailHoldOffTime, LedType=LedType, eowSrcPtr=eowSrcPtr, laserALSRestart90s=laserALSRestart90s, softInventoryType=softInventoryType, boardTable=boardTable, hardInventoryIndex=hardInventoryIndex, ProtectionType=ProtectionType, boardListIndex=boardListIndex, boardExpectFamily=boardExpectFamily, boardNumber=boardNumber, boardActive=boardActive, boardListTable=boardListTable, hardInventoryTable=hardInventoryTable, boardMissingSev=boardMissingSev, softInventoryTable=softInventoryTable, laser=laser, boardDefectiveSev=boardDefectiveSev, softInv=softInv, softInventoryIndex=softInventoryIndex, ledEntry=ledEntry, adrHotReset=adrHotReset, hardInventoryDescr=hardInventoryDescr, laserTable=laserTable, ledIndex=ledIndex, PYSNMP_MODULE_ID=shelf, shelf=shelf, boardProtectionType=boardProtectionType, boardFailure=boardFailure, boardMonitor=boardMonitor, laserNumber=laserNumber, EOWClockMode=EOWClockMode, hardInventoryNumber=hardInventoryNumber, ledTable=ledTable, softInventoryExt=softInventoryExt, eowClockMode=eowClockMode, hardInv=hardInv, eowSrcType=eowSrcType, ledType=ledType, holdTime=holdTime, boardEntry=boardEntry, laserEntry=laserEntry, EOWType=EOWType, eowNumber=eowNumber, boardSeverity=boardSeverity, HoldTime=HoldTime, LedStatus=LedStatus, boardListType=boardListType, eowSinkType=eowSinkType, boardMismatchSev=boardMismatchSev, led=led, boardListSlot=boardListSlot, board=board, laserIndex=laserIndex, boardExpectType=boardExpectType, ledNumber=ledNumber, boardIndex=boardIndex, boardList=boardList, softInventoryBoard=softInventoryBoard, boardInsertType=boardInsertType)
