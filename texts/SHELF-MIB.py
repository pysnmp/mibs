...
mibBuilder.exportSymbols("SHELF-MIB", boardDefectiveSev=boardDefectiveSev, laserTable=laserTable, eowTable=eowTable, boardIndex=boardIndex, EOWClockMode=EOWClockMode, boardInsertFamily=boardInsertFamily, led=led, laser=laser, boardActive=boardActive, laserALSRestart90s=laserALSRestart90s, hardInventoryBoard=hardInventoryBoard, boardMonitor=boardMonitor, ledNumber=ledNumber, softInventoryNumber=softInventoryNumber, boardProtectionType=boardProtectionType, board=board, adrHotReset=adrHotReset, boardSeverity=boardSeverity, boardMissingSev=boardMissingSev, boardListIndex=boardListIndex, boardListTable=boardListTable, eowSrcPtr=eowSrcPtr, boardInsertType=boardInsertType, ledTable=ledTable, holdTime=holdTime, laserALSEnable=laserALSEnable, eowSrcType=eowSrcType, boardFirstPortIndex=boardFirstPortIndex, boardList=boardList, ProtectionType=ProtectionType, eowSinkPtr=eowSinkPtr, boardListType=boardListType, softInventoryType=softInventoryType, adrFailHoldOnTime=adrFailHoldOnTime, boardTable=boardTable, laserALSRestart2s=laserALSRestart2s, laserTxEnable=laserTxEnable, ledEntry=ledEntry, eowEntry=eowEntry, hardInventoryIndex=hardInventoryIndex, boardMismatchSev=boardMismatchSev, eow=eow, eowIndex=eowIndex, boardListEntry=boardListEntry, LedStatus=LedStatus, softInventoryBoard=softInventoryBoard, softInventoryEntry=softInventoryEntry, boardEntry=boardEntry, softInventoryCode=softInventoryCode, ledType=ledType, hardInv=hardInv, BoardFailure=BoardFailure, eowNumber=eowNumber, LedType=LedType, softInv=softInv, boardListSlot=boardListSlot, shelf=shelf, laserIndex=laserIndex, softInventoryIndex=softInventoryIndex, ledPosition=ledPosition, boardFailure=boardFailure, hardInventoryEntry=hardInventoryEntry, laserNumber=laserNumber, eowClockMode=eowClockMode, hardInventoryDescr=hardInventoryDescr, hardInventoryNumber=hardInventoryNumber, ledStatus=ledStatus, PYSNMP_MODULE_ID=shelf, boardNumber=boardNumber, eowSinkType=eowSinkType, hardInventoryTable=hardInventoryTable, softInventoryTable=softInventoryTable, HoldTime=HoldTime, boardExpectType=boardExpectType, boardExpectFamily=boardExpectFamily, eowName=eowName, boardListNumber=boardListNumber, adrFailHoldOffTime=adrFailHoldOffTime, laserEntry=laserEntry, softInventoryExt=softInventoryExt, EOWType=EOWType, boardSlotName=boardSlotName, ledIndex=ledIndex)
