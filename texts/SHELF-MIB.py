...
ModuleIdentity, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Counter32, Integer32, Gauge32, Counter64, Unsigned32, TimeTicks, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Counter32", "Integer32", "Gauge32", "Counter64", "Unsigned32", "TimeTicks", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SHELF-MIB", adrHotReset=adrHotReset, hardInventoryIndex=hardInventoryIndex, hardInventoryBoard=hardInventoryBoard, laserIndex=laserIndex, laserTxEnable=laserTxEnable, shelf=shelf, boardList=boardList, softInventoryType=softInventoryType, boardEntry=boardEntry, ProtectionType=ProtectionType, ledTable=ledTable, laserALSRestart2s=laserALSRestart2s, ledType=ledType, boardListType=boardListType, holdTime=holdTime, boardSlotName=boardSlotName, eowSrcType=eowSrcType, eowSinkPtr=eowSinkPtr, hardInventoryNumber=hardInventoryNumber, BoardFailure=BoardFailure, ledPosition=ledPosition, eowSrcPtr=eowSrcPtr, boardMissingSev=boardMissingSev, EOWClockMode=EOWClockMode, boardListIndex=boardListIndex, PYSNMP_MODULE_ID=shelf, boardListTable=boardListTable, boardIndex=boardIndex, boardNumber=boardNumber, eowClockMode=eowClockMode, HoldTime=HoldTime, ledIndex=ledIndex, eowEntry=eowEntry, boardTable=boardTable, boardActive=boardActive, softInventoryNumber=softInventoryNumber, laserTable=laserTable, hardInventoryDescr=hardInventoryDescr, laserALSRestart90s=laserALSRestart90s, ledStatus=ledStatus, boardInsertType=boardInsertType, eowNumber=eowNumber, laser=laser, boardSeverity=boardSeverity, adrFailHoldOnTime=adrFailHoldOnTime, boardInsertFamily=boardInsertFamily, boardMismatchSev=boardMismatchSev, boardFailure=boardFailure, softInventoryTable=softInventoryTable, boardDefectiveSev=boardDefectiveSev, softInventoryEntry=softInventoryEntry, eowIndex=eowIndex, hardInv=hardInv, laserALSEnable=laserALSEnable, ledEntry=ledEntry, eowName=eowName, boardListNumber=boardListNumber, ledNumber=ledNumber, boardMonitor=boardMonitor, eowSinkType=eowSinkType, laserNumber=laserNumber, hardInventoryEntry=hardInventoryEntry, eow=eow, softInventoryExt=softInventoryExt, boardExpectType=boardExpectType, eowTable=eowTable, softInventoryCode=softInventoryCode, softInv=softInv, boardListSlot=boardListSlot, EOWType=EOWType, LedType=LedType, laserEntry=laserEntry, softInventoryIndex=softInventoryIndex, boardListEntry=boardListEntry, softInventoryBoard=softInventoryBoard, boardProtectionType=boardProtectionType, boardFirstPortIndex=boardFirstPortIndex, led=led, board=board, boardExpectFamily=boardExpectFamily, LedStatus=LedStatus, hardInventoryTable=hardInventoryTable, adrFailHoldOffTime=adrFailHoldOffTime)
