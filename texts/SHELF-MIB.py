...
mibBuilder.exportSymbols("SHELF-MIB", boardIndex=boardIndex, eowSinkType=eowSinkType, boardInsertFamily=boardInsertFamily, boardInsertType=boardInsertType, boardListTable=boardListTable, adrFailHoldOnTime=adrFailHoldOnTime, eowIndex=eowIndex, PYSNMP_MODULE_ID=shelf, eowNumber=eowNumber, boardExpectType=boardExpectType, laserTxEnable=laserTxEnable, boardSeverity=boardSeverity, laserEntry=laserEntry, ledEntry=ledEntry, softInventoryIndex=softInventoryIndex, hardInventoryEntry=hardInventoryEntry, eowEntry=eowEntry, ledStatus=ledStatus, eowSinkPtr=eowSinkPtr, hardInventoryIndex=hardInventoryIndex, boardFailure=boardFailure, boardMonitor=boardMonitor, laser=laser, softInventoryBoard=softInventoryBoard, LedStatus=LedStatus, boardDefectiveSev=boardDefectiveSev, shelf=shelf, led=led, boardFirstPortIndex=boardFirstPortIndex, laserNumber=laserNumber, boardMissingSev=boardMissingSev, boardTable=boardTable, hardInventoryDescr=hardInventoryDescr, boardListSlot=boardListSlot, softInventoryExt=softInventoryExt, eow=eow, ledTable=ledTable, BoardFailure=BoardFailure, softInventoryEntry=softInventoryEntry, laserTable=laserTable, boardListNumber=boardListNumber, eowSrcType=eowSrcType, adrHotReset=adrHotReset, adrFailHoldOffTime=adrFailHoldOffTime, boardExpectFamily=boardExpectFamily, boardListType=boardListType, softInventoryType=softInventoryType, hardInventoryNumber=hardInventoryNumber, eowTable=eowTable, laserIndex=laserIndex, softInventoryCode=softInventoryCode, boardActive=boardActive, softInv=softInv, boardNumber=boardNumber, board=board, boardEntry=boardEntry, softInventoryNumber=softInventoryNumber, LedType=LedType, boardListEntry=boardListEntry, HoldTime=HoldTime, softInventoryTable=softInventoryTable, ledNumber=ledNumber, boardMismatchSev=boardMismatchSev, laserALSRestart90s=laserALSRestart90s, EOWType=EOWType, eowSrcPtr=eowSrcPtr, boardSlotName=boardSlotName, eowName=eowName, holdTime=holdTime, hardInventoryBoard=hardInventoryBoard, eowClockMode=eowClockMode, ledType=ledType, ledIndex=ledIndex, laserALSEnable=laserALSEnable, boardList=boardList, boardListIndex=boardListIndex, boardProtectionType=boardProtectionType, laserALSRestart2s=laserALSRestart2s, EOWClockMode=EOWClockMode, hardInv=hardInv, ledPosition=ledPosition, hardInventoryTable=hardInventoryTable, ProtectionType=ProtectionType)
