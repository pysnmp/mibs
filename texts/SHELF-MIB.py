...
Counter64, Integer32, NotificationType, ModuleIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Bits, iso, TimeTicks, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Bits", "iso", "TimeTicks", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("SHELF-MIB", eow=eow, boardExpectType=boardExpectType, eowEntry=eowEntry, HoldTime=HoldTime, eowSinkPtr=eowSinkPtr, board=board, eowClockMode=eowClockMode, eowSrcType=eowSrcType, ledPosition=ledPosition, boardActive=boardActive, BoardFailure=BoardFailure, boardListEntry=boardListEntry, laserALSRestart90s=laserALSRestart90s, EOWClockMode=EOWClockMode, LedType=LedType, laserALSEnable=laserALSEnable, hardInventoryIndex=hardInventoryIndex, boardSlotName=boardSlotName, hardInventoryEntry=hardInventoryEntry, laserNumber=laserNumber, eowIndex=eowIndex, adrFailHoldOffTime=adrFailHoldOffTime, adrHotReset=adrHotReset, laserTxEnable=laserTxEnable, ledIndex=ledIndex, boardMonitor=boardMonitor, laserEntry=laserEntry, hardInventoryTable=hardInventoryTable, boardFirstPortIndex=boardFirstPortIndex, EOWType=EOWType, ledNumber=ledNumber, shelf=shelf, ledTable=ledTable, boardTable=boardTable, softInventoryType=softInventoryType, boardNumber=boardNumber, boardMissingSev=boardMissingSev, PYSNMP_MODULE_ID=shelf, laserIndex=laserIndex, ledEntry=ledEntry, boardList=boardList, LedStatus=LedStatus, hardInventoryBoard=hardInventoryBoard, led=led, ledType=ledType, hardInventoryDescr=hardInventoryDescr, boardProtectionType=boardProtectionType, laser=laser, boardFailure=boardFailure, hardInv=hardInv, boardExpectFamily=boardExpectFamily, eowSrcPtr=eowSrcPtr, eowTable=eowTable, boardListSlot=boardListSlot, holdTime=holdTime, ProtectionType=ProtectionType, boardEntry=boardEntry, laserTable=laserTable, softInventoryTable=softInventoryTable, boardListNumber=boardListNumber, softInventoryCode=softInventoryCode, boardInsertType=boardInsertType, eowNumber=eowNumber, boardListIndex=boardListIndex, boardInsertFamily=boardInsertFamily, boardListType=boardListType, boardListTable=boardListTable, laserALSRestart2s=laserALSRestart2s, softInventoryEntry=softInventoryEntry, eowName=eowName, softInventoryIndex=softInventoryIndex, boardIndex=boardIndex, ledStatus=ledStatus, boardDefectiveSev=boardDefectiveSev, softInventoryNumber=softInventoryNumber, eowSinkType=eowSinkType, boardMismatchSev=boardMismatchSev, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryNumber=hardInventoryNumber, softInventoryBoard=softInventoryBoard, softInv=softInv, softInventoryExt=softInventoryExt, boardSeverity=boardSeverity)
