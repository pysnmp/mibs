...
mibBuilder.exportSymbols("SHELF-MIB", HoldTime=HoldTime, boardListType=boardListType, eowNumber=eowNumber, boardList=boardList, boardExpectFamily=boardExpectFamily, board=board, boardFailure=boardFailure, laserNumber=laserNumber, hardInventoryTable=hardInventoryTable, ledEntry=ledEntry, softInventoryTable=softInventoryTable, boardListEntry=boardListEntry, ledIndex=ledIndex, boardEntry=boardEntry, adrHotReset=adrHotReset, laserALSEnable=laserALSEnable, boardListNumber=boardListNumber, adrFailHoldOnTime=adrFailHoldOnTime, eowIndex=eowIndex, boardMissingSev=boardMissingSev, holdTime=holdTime, LedStatus=LedStatus, boardIndex=boardIndex, hardInventoryEntry=hardInventoryEntry, LedType=LedType, ProtectionType=ProtectionType, boardProtectionType=boardProtectionType, boardListIndex=boardListIndex, softInventoryNumber=softInventoryNumber, eow=eow, laserALSRestart2s=laserALSRestart2s, laserTxEnable=laserTxEnable, hardInventoryNumber=hardInventoryNumber, eowSinkType=eowSinkType, BoardFailure=BoardFailure, laserEntry=laserEntry, hardInventoryBoard=hardInventoryBoard, eowTable=eowTable, eowSinkPtr=eowSinkPtr, softInv=softInv, eowSrcType=eowSrcType, eowEntry=eowEntry, hardInv=hardInv, boardInsertFamily=boardInsertFamily, ledTable=ledTable, boardDefectiveSev=boardDefectiveSev, ledPosition=ledPosition, EOWClockMode=EOWClockMode, EOWType=EOWType, eowName=eowName, softInventoryEntry=softInventoryEntry, eowClockMode=eowClockMode, boardListSlot=boardListSlot, boardMonitor=boardMonitor, softInventoryType=softInventoryType, softInventoryCode=softInventoryCode, softInventoryIndex=softInventoryIndex, laserIndex=laserIndex, ledNumber=ledNumber, laserALSRestart90s=laserALSRestart90s, shelf=shelf, boardExpectType=boardExpectType, boardActive=boardActive, boardInsertType=boardInsertType, laser=laser, laserTable=laserTable, softInventoryBoard=softInventoryBoard, boardMismatchSev=boardMismatchSev, led=led, hardInventoryDescr=hardInventoryDescr, ledType=ledType, boardListTable=boardListTable, adrFailHoldOffTime=adrFailHoldOffTime, PYSNMP_MODULE_ID=shelf, boardSeverity=boardSeverity, boardTable=boardTable, boardSlotName=boardSlotName, softInventoryExt=softInventoryExt, boardNumber=boardNumber, boardFirstPortIndex=boardFirstPortIndex, ledStatus=ledStatus, eowSrcPtr=eowSrcPtr, hardInventoryIndex=hardInventoryIndex)
