...
ObjectIdentity, Bits, Gauge32, ModuleIdentity, Integer32, Unsigned32, Counter64, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Gauge32", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SHELF-MIB", eowSinkPtr=eowSinkPtr, LedStatus=LedStatus, hardInventoryNumber=hardInventoryNumber, boardActive=boardActive, softInventoryEntry=softInventoryEntry, ledIndex=ledIndex, boardIndex=boardIndex, ledEntry=ledEntry, hardInventoryDescr=hardInventoryDescr, boardInsertType=boardInsertType, shelf=shelf, ledStatus=ledStatus, boardDefectiveSev=boardDefectiveSev, ledNumber=ledNumber, LedType=LedType, EOWClockMode=EOWClockMode, softInventoryBoard=softInventoryBoard, adrHotReset=adrHotReset, softInventoryType=softInventoryType, boardSeverity=boardSeverity, boardListEntry=boardListEntry, eowSrcPtr=eowSrcPtr, adrFailHoldOffTime=adrFailHoldOffTime, eowEntry=eowEntry, softInventoryIndex=softInventoryIndex, laserEntry=laserEntry, eowTable=eowTable, eow=eow, boardMonitor=boardMonitor, laserTable=laserTable, boardListType=boardListType, hardInventoryTable=hardInventoryTable, laserALSEnable=laserALSEnable, boardSlotName=boardSlotName, eowNumber=eowNumber, boardNumber=boardNumber, boardInsertFamily=boardInsertFamily, boardExpectType=boardExpectType, softInv=softInv, boardList=boardList, eowSrcType=eowSrcType, boardListTable=boardListTable, hardInv=hardInv, boardEntry=boardEntry, led=led, laserALSRestart90s=laserALSRestart90s, ProtectionType=ProtectionType, softInventoryNumber=softInventoryNumber, eowIndex=eowIndex, BoardFailure=BoardFailure, laserTxEnable=laserTxEnable, ledType=ledType, boardListNumber=boardListNumber, softInventoryExt=softInventoryExt, holdTime=holdTime, laserALSRestart2s=laserALSRestart2s, EOWType=EOWType, hardInventoryEntry=hardInventoryEntry, boardProtectionType=boardProtectionType, eowSinkType=eowSinkType, softInventoryCode=softInventoryCode, laser=laser, boardMissingSev=boardMissingSev, hardInventoryBoard=hardInventoryBoard, boardTable=boardTable, laserIndex=laserIndex, PYSNMP_MODULE_ID=shelf, eowName=eowName, boardFailure=boardFailure, ledPosition=ledPosition, ledTable=ledTable, hardInventoryIndex=hardInventoryIndex, laserNumber=laserNumber, boardListIndex=boardListIndex, boardFirstPortIndex=boardFirstPortIndex, boardListSlot=boardListSlot, boardMismatchSev=boardMismatchSev, HoldTime=HoldTime, eowClockMode=eowClockMode, boardExpectFamily=boardExpectFamily, softInventoryTable=softInventoryTable, board=board, adrFailHoldOnTime=adrFailHoldOnTime)
