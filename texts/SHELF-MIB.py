...
mibBuilder.exportSymbols("SHELF-MIB", eowTable=eowTable, laserNumber=laserNumber, boardInsertFamily=boardInsertFamily, softInventoryType=softInventoryType, holdTime=holdTime, ledStatus=ledStatus, boardExpectType=boardExpectType, eowSinkType=eowSinkType, boardMissingSev=boardMissingSev, boardListEntry=boardListEntry, ledIndex=ledIndex, eowSrcType=eowSrcType, led=led, hardInventoryBoard=hardInventoryBoard, boardDefectiveSev=boardDefectiveSev, PYSNMP_MODULE_ID=shelf, softInventoryTable=softInventoryTable, LedType=LedType, softInventoryCode=softInventoryCode, eowClockMode=eowClockMode, ledEntry=ledEntry, boardListType=boardListType, boardMonitor=boardMonitor, softInventoryExt=softInventoryExt, eowNumber=eowNumber, softInventoryEntry=softInventoryEntry, boardSlotName=boardSlotName, adrHotReset=adrHotReset, ledNumber=ledNumber, board=board, boardTable=boardTable, softInv=softInv, ProtectionType=ProtectionType, eowName=eowName, softInventoryBoard=softInventoryBoard, laserTxEnable=laserTxEnable, hardInv=hardInv, boardMismatchSev=boardMismatchSev, EOWClockMode=EOWClockMode, boardFirstPortIndex=boardFirstPortIndex, hardInventoryIndex=hardInventoryIndex, shelf=shelf, boardListSlot=boardListSlot, boardActive=boardActive, softInventoryNumber=softInventoryNumber, hardInventoryDescr=hardInventoryDescr, laserALSRestart2s=laserALSRestart2s, LedStatus=LedStatus, ledType=ledType, boardInsertType=boardInsertType, eowEntry=eowEntry, laserEntry=laserEntry, ledPosition=ledPosition, boardIndex=boardIndex, EOWType=EOWType, laserIndex=laserIndex, boardFailure=boardFailure, hardInventoryTable=hardInventoryTable, laser=laser, boardListIndex=boardListIndex, eowSrcPtr=eowSrcPtr, boardListNumber=boardListNumber, boardExpectFamily=boardExpectFamily, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryIndex=softInventoryIndex, adrFailHoldOnTime=adrFailHoldOnTime, eow=eow, boardListTable=boardListTable, laserALSRestart90s=laserALSRestart90s, laserALSEnable=laserALSEnable, eowSinkPtr=eowSinkPtr, boardProtectionType=boardProtectionType, boardSeverity=boardSeverity, ledTable=ledTable, boardList=boardList, BoardFailure=BoardFailure, hardInventoryNumber=hardInventoryNumber, laserTable=laserTable, eowIndex=eowIndex, boardEntry=boardEntry, hardInventoryEntry=hardInventoryEntry, boardNumber=boardNumber, HoldTime=HoldTime)
