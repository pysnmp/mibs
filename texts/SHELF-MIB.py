...
Gauge32, Integer32, Unsigned32, TimeTicks, Counter64, iso, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, ModuleIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Unsigned32", "TimeTicks", "Counter64", "iso", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "ModuleIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("SHELF-MIB", laserALSEnable=laserALSEnable, boardFirstPortIndex=boardFirstPortIndex, softInventoryCode=softInventoryCode, ledStatus=ledStatus, ledNumber=ledNumber, boardListIndex=boardListIndex, boardExpectFamily=boardExpectFamily, board=board, boardListSlot=boardListSlot, boardMissingSev=boardMissingSev, boardListNumber=boardListNumber, LedType=LedType, laserTable=laserTable, boardList=boardList, hardInventoryIndex=hardInventoryIndex, ledType=ledType, eowIndex=eowIndex, eowSinkType=eowSinkType, eowNumber=eowNumber, boardListTable=boardListTable, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryNumber=hardInventoryNumber, hardInventoryEntry=hardInventoryEntry, boardSlotName=boardSlotName, EOWType=EOWType, softInventoryBoard=softInventoryBoard, shelf=shelf, eowClockMode=eowClockMode, boardProtectionType=boardProtectionType, BoardFailure=BoardFailure, boardIndex=boardIndex, boardListType=boardListType, boardTable=boardTable, eowSinkPtr=eowSinkPtr, eowSrcType=eowSrcType, eowEntry=eowEntry, laserALSRestart2s=laserALSRestart2s, softInv=softInv, boardActive=boardActive, HoldTime=HoldTime, ledPosition=ledPosition, boardSeverity=boardSeverity, eowTable=eowTable, ledTable=ledTable, softInventoryEntry=softInventoryEntry, boardExpectType=boardExpectType, boardInsertType=boardInsertType, boardListEntry=boardListEntry, boardInsertFamily=boardInsertFamily, boardEntry=boardEntry, hardInventoryTable=hardInventoryTable, adrHotReset=adrHotReset, EOWClockMode=EOWClockMode, softInventoryIndex=softInventoryIndex, boardMonitor=boardMonitor, ledIndex=ledIndex, hardInventoryDescr=hardInventoryDescr, laserNumber=laserNumber, led=led, laser=laser, softInventoryExt=softInventoryExt, LedStatus=LedStatus, boardMismatchSev=boardMismatchSev, holdTime=holdTime, laserTxEnable=laserTxEnable, boardFailure=boardFailure, boardNumber=boardNumber, hardInventoryBoard=hardInventoryBoard, adrFailHoldOffTime=adrFailHoldOffTime, hardInv=hardInv, PYSNMP_MODULE_ID=shelf, softInventoryNumber=softInventoryNumber, laserALSRestart90s=laserALSRestart90s, eowSrcPtr=eowSrcPtr, eow=eow, ProtectionType=ProtectionType, boardDefectiveSev=boardDefectiveSev, ledEntry=ledEntry, softInventoryType=softInventoryType, softInventoryTable=softInventoryTable, laserIndex=laserIndex, eowName=eowName, laserEntry=laserEntry)
