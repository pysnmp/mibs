...
ModuleIdentity, Bits, NotificationType, ObjectIdentity, Gauge32, IpAddress, Integer32, TimeTicks, Counter64, MibIdentifier, iso, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "ObjectIdentity", "Gauge32", "IpAddress", "Integer32", "TimeTicks", "Counter64", "MibIdentifier", "iso", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryCode=softInventoryCode, BoardFailure=BoardFailure, softInventoryNumber=softInventoryNumber, boardIndex=boardIndex, hardInventoryTable=hardInventoryTable, laserALSRestart2s=laserALSRestart2s, eowSrcPtr=eowSrcPtr, boardListTable=boardListTable, hardInv=hardInv, boardListEntry=boardListEntry, softInventoryExt=softInventoryExt, laserIndex=laserIndex, ledPosition=ledPosition, ledTable=ledTable, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryDescr=hardInventoryDescr, boardMismatchSev=boardMismatchSev, boardFailure=boardFailure, boardMonitor=boardMonitor, boardInsertType=boardInsertType, ledStatus=ledStatus, laserTable=laserTable, boardTable=boardTable, boardDefectiveSev=boardDefectiveSev, softInventoryIndex=softInventoryIndex, hardInventoryBoard=hardInventoryBoard, softInventoryEntry=softInventoryEntry, boardMissingSev=boardMissingSev, laserTxEnable=laserTxEnable, laserNumber=laserNumber, boardExpectFamily=boardExpectFamily, laserALSEnable=laserALSEnable, EOWClockMode=EOWClockMode, softInv=softInv, ledType=ledType, EOWType=EOWType, eowSrcType=eowSrcType, boardExpectType=boardExpectType, eowSinkPtr=eowSinkPtr, boardSlotName=boardSlotName, eow=eow, boardListSlot=boardListSlot, eowName=eowName, eowNumber=eowNumber, softInventoryBoard=softInventoryBoard, HoldTime=HoldTime, eowEntry=eowEntry, ledEntry=ledEntry, holdTime=holdTime, laserALSRestart90s=laserALSRestart90s, ledNumber=ledNumber, shelf=shelf, ledIndex=ledIndex, boardListNumber=boardListNumber, laser=laser, boardListIndex=boardListIndex, boardListType=boardListType, board=board, LedStatus=LedStatus, boardSeverity=boardSeverity, led=led, LedType=LedType, boardProtectionType=boardProtectionType, hardInventoryEntry=hardInventoryEntry, adrFailHoldOffTime=adrFailHoldOffTime, eowClockMode=eowClockMode, softInventoryTable=softInventoryTable, ProtectionType=ProtectionType, eowTable=eowTable, boardEntry=boardEntry, adrHotReset=adrHotReset, hardInventoryIndex=hardInventoryIndex, eowIndex=eowIndex, softInventoryType=softInventoryType, hardInventoryNumber=hardInventoryNumber, boardActive=boardActive, eowSinkType=eowSinkType, boardList=boardList, boardFirstPortIndex=boardFirstPortIndex, laserEntry=laserEntry, boardNumber=boardNumber, PYSNMP_MODULE_ID=shelf, boardInsertFamily=boardInsertFamily)
