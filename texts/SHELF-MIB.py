...
mibBuilder.exportSymbols("SHELF-MIB", hardInventoryTable=hardInventoryTable, softInventoryNumber=softInventoryNumber, adrFailHoldOnTime=adrFailHoldOnTime, softInv=softInv, eowSinkType=eowSinkType, boardProtectionType=boardProtectionType, ProtectionType=ProtectionType, boardList=boardList, boardListTable=boardListTable, boardMissingSev=boardMissingSev, LedStatus=LedStatus, ledTable=ledTable, laserALSEnable=laserALSEnable, boardEntry=boardEntry, ledEntry=ledEntry, boardActive=boardActive, eowEntry=eowEntry, boardExpectFamily=boardExpectFamily, eowTable=eowTable, laserNumber=laserNumber, softInventoryIndex=softInventoryIndex, boardTable=boardTable, hardInventoryIndex=hardInventoryIndex, softInventoryBoard=softInventoryBoard, boardMismatchSev=boardMismatchSev, BoardFailure=BoardFailure, laserTable=laserTable, eow=eow, laserIndex=laserIndex, ledNumber=ledNumber, holdTime=holdTime, eowSinkPtr=eowSinkPtr, adrFailHoldOffTime=adrFailHoldOffTime, hardInv=hardInv, laserALSRestart2s=laserALSRestart2s, boardSlotName=boardSlotName, ledIndex=ledIndex, softInventoryEntry=softInventoryEntry, laserEntry=laserEntry, softInventoryExt=softInventoryExt, boardFirstPortIndex=boardFirstPortIndex, boardFailure=boardFailure, hardInventoryEntry=hardInventoryEntry, boardListIndex=boardListIndex, boardListEntry=boardListEntry, ledPosition=ledPosition, PYSNMP_MODULE_ID=shelf, boardExpectType=boardExpectType, softInventoryTable=softInventoryTable, boardIndex=boardIndex, eowSrcPtr=eowSrcPtr, boardInsertType=boardInsertType, hardInventoryNumber=hardInventoryNumber, LedType=LedType, laser=laser, board=board, HoldTime=HoldTime, EOWType=EOWType, boardListSlot=boardListSlot, softInventoryType=softInventoryType, eowSrcType=eowSrcType, shelf=shelf, boardMonitor=boardMonitor, EOWClockMode=EOWClockMode, eowIndex=eowIndex, boardListNumber=boardListNumber, ledType=ledType, laserTxEnable=laserTxEnable, hardInventoryDescr=hardInventoryDescr, hardInventoryBoard=hardInventoryBoard, led=led, ledStatus=ledStatus, boardDefectiveSev=boardDefectiveSev, eowName=eowName, softInventoryCode=softInventoryCode, boardSeverity=boardSeverity, adrHotReset=adrHotReset, boardListType=boardListType, boardInsertFamily=boardInsertFamily, laserALSRestart90s=laserALSRestart90s, eowClockMode=eowClockMode, boardNumber=boardNumber, eowNumber=eowNumber)
