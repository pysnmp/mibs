...
mibBuilder.exportSymbols("SHELF-MIB", boardListType=boardListType, laserTxEnable=laserTxEnable, eowSrcType=eowSrcType, ledPosition=ledPosition, laser=laser, laserALSEnable=laserALSEnable, ledStatus=ledStatus, softInventoryCode=softInventoryCode, LedType=LedType, board=board, boardMissingSev=boardMissingSev, shelf=shelf, boardListSlot=boardListSlot, boardList=boardList, laserTable=laserTable, laserALSRestart2s=laserALSRestart2s, boardTable=boardTable, boardEntry=boardEntry, boardInsertFamily=boardInsertFamily, softInventoryType=softInventoryType, hardInventoryBoard=hardInventoryBoard, softInventoryNumber=softInventoryNumber, ledEntry=ledEntry, boardSlotName=boardSlotName, hardInventoryEntry=hardInventoryEntry, boardExpectFamily=boardExpectFamily, hardInv=hardInv, laserALSRestart90s=laserALSRestart90s, softInventoryExt=softInventoryExt, boardListEntry=boardListEntry, ledIndex=ledIndex, laserIndex=laserIndex, EOWType=EOWType, adrFailHoldOnTime=adrFailHoldOnTime, boardListIndex=boardListIndex, softInventoryBoard=softInventoryBoard, eowEntry=eowEntry, hardInventoryNumber=hardInventoryNumber, led=led, holdTime=holdTime, hardInventoryDescr=hardInventoryDescr, boardNumber=boardNumber, softInventoryEntry=softInventoryEntry, eowClockMode=eowClockMode, boardSeverity=boardSeverity, boardIndex=boardIndex, boardListNumber=boardListNumber, laserNumber=laserNumber, eowTable=eowTable, ledType=ledType, boardListTable=boardListTable, eowName=eowName, BoardFailure=BoardFailure, adrFailHoldOffTime=adrFailHoldOffTime, LedStatus=LedStatus, ProtectionType=ProtectionType, ledNumber=ledNumber, hardInventoryIndex=hardInventoryIndex, softInventoryIndex=softInventoryIndex, ledTable=ledTable, softInv=softInv, boardActive=boardActive, boardMonitor=boardMonitor, boardInsertType=boardInsertType, eowNumber=eowNumber, boardFailure=boardFailure, adrHotReset=adrHotReset, PYSNMP_MODULE_ID=shelf, boardDefectiveSev=boardDefectiveSev, eowSinkPtr=eowSinkPtr, boardProtectionType=boardProtectionType, eowSinkType=eowSinkType, hardInventoryTable=hardInventoryTable, eow=eow, boardFirstPortIndex=boardFirstPortIndex, eowIndex=eowIndex, eowSrcPtr=eowSrcPtr, softInventoryTable=softInventoryTable, laserEntry=laserEntry, boardExpectType=boardExpectType, boardMismatchSev=boardMismatchSev, EOWClockMode=EOWClockMode, HoldTime=HoldTime)
