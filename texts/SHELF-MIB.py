...
mibBuilder.exportSymbols("SHELF-MIB", boardExpectType=boardExpectType, ledStatus=ledStatus, boardFailure=boardFailure, hardInventoryEntry=hardInventoryEntry, adrHotReset=adrHotReset, ledIndex=ledIndex, softInventoryType=softInventoryType, boardFirstPortIndex=boardFirstPortIndex, ProtectionType=ProtectionType, BoardFailure=BoardFailure, adrFailHoldOffTime=adrFailHoldOffTime, hardInv=hardInv, laserALSRestart2s=laserALSRestart2s, eowIndex=eowIndex, eowSinkType=eowSinkType, ledNumber=ledNumber, boardListSlot=boardListSlot, hardInventoryDescr=hardInventoryDescr, hardInventoryBoard=hardInventoryBoard, eowEntry=eowEntry, eowSinkPtr=eowSinkPtr, boardIndex=boardIndex, softInventoryTable=softInventoryTable, laserIndex=laserIndex, laserALSRestart90s=laserALSRestart90s, boardDefectiveSev=boardDefectiveSev, boardListIndex=boardListIndex, boardSlotName=boardSlotName, boardMonitor=boardMonitor, hardInventoryTable=hardInventoryTable, EOWType=EOWType, boardEntry=boardEntry, eowTable=eowTable, led=led, laserNumber=laserNumber, eowNumber=eowNumber, laser=laser, boardTable=boardTable, hardInventoryIndex=hardInventoryIndex, boardListTable=boardListTable, boardListNumber=boardListNumber, boardMismatchSev=boardMismatchSev, ledTable=ledTable, boardSeverity=boardSeverity, softInventoryExt=softInventoryExt, laserALSEnable=laserALSEnable, ledType=ledType, boardInsertType=boardInsertType, board=board, boardInsertFamily=boardInsertFamily, EOWClockMode=EOWClockMode, boardProtectionType=boardProtectionType, eowSrcType=eowSrcType, softInv=softInv, eowSrcPtr=eowSrcPtr, ledPosition=ledPosition, boardActive=boardActive, LedType=LedType, laserTable=laserTable, boardExpectFamily=boardExpectFamily, eowName=eowName, laserEntry=laserEntry, holdTime=holdTime, eow=eow, adrFailHoldOnTime=adrFailHoldOnTime, LedStatus=LedStatus, laserTxEnable=laserTxEnable, PYSNMP_MODULE_ID=shelf, HoldTime=HoldTime, shelf=shelf, boardNumber=boardNumber, ledEntry=ledEntry, hardInventoryNumber=hardInventoryNumber, softInventoryIndex=softInventoryIndex, eowClockMode=eowClockMode, boardList=boardList, softInventoryBoard=softInventoryBoard, boardListEntry=boardListEntry, softInventoryNumber=softInventoryNumber, boardMissingSev=boardMissingSev, softInventoryEntry=softInventoryEntry, softInventoryCode=softInventoryCode, boardListType=boardListType)
