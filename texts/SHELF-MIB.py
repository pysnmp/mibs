...
mibBuilder.exportSymbols("SHELF-MIB", ledStatus=ledStatus, laserALSRestart2s=laserALSRestart2s, boardListIndex=boardListIndex, ledPosition=ledPosition, eowNumber=eowNumber, boardSlotName=boardSlotName, boardListNumber=boardListNumber, eowClockMode=eowClockMode, holdTime=holdTime, boardFailure=boardFailure, boardProtectionType=boardProtectionType, LedStatus=LedStatus, softInventoryIndex=softInventoryIndex, led=led, LedType=LedType, ProtectionType=ProtectionType, laserTxEnable=laserTxEnable, softInventoryCode=softInventoryCode, laserEntry=laserEntry, boardDefectiveSev=boardDefectiveSev, boardListTable=boardListTable, adrFailHoldOnTime=adrFailHoldOnTime, BoardFailure=BoardFailure, ledEntry=ledEntry, eow=eow, hardInventoryTable=hardInventoryTable, hardInventoryIndex=hardInventoryIndex, eowSrcType=eowSrcType, hardInv=hardInv, softInventoryExt=softInventoryExt, boardNumber=boardNumber, softInventoryNumber=softInventoryNumber, adrHotReset=adrHotReset, eowSinkType=eowSinkType, softInventoryType=softInventoryType, laserALSRestart90s=laserALSRestart90s, softInventoryTable=softInventoryTable, laserALSEnable=laserALSEnable, adrFailHoldOffTime=adrFailHoldOffTime, shelf=shelf, boardListSlot=boardListSlot, boardEntry=boardEntry, boardMismatchSev=boardMismatchSev, hardInventoryNumber=hardInventoryNumber, ledTable=ledTable, hardInventoryDescr=hardInventoryDescr, boardIndex=boardIndex, boardSeverity=boardSeverity, board=board, boardTable=boardTable, eowEntry=eowEntry, hardInventoryEntry=hardInventoryEntry, laserTable=laserTable, boardListType=boardListType, ledType=ledType, boardFirstPortIndex=boardFirstPortIndex, eowIndex=eowIndex, softInventoryEntry=softInventoryEntry, eowTable=eowTable, laserNumber=laserNumber, boardExpectFamily=boardExpectFamily, EOWType=EOWType, boardInsertFamily=boardInsertFamily, boardActive=boardActive, HoldTime=HoldTime, boardMissingSev=boardMissingSev, softInventoryBoard=softInventoryBoard, ledNumber=ledNumber, boardMonitor=boardMonitor, boardExpectType=boardExpectType, laser=laser, boardListEntry=boardListEntry, eowSinkPtr=eowSinkPtr, laserIndex=laserIndex, eowName=eowName, EOWClockMode=EOWClockMode, boardInsertType=boardInsertType, softInv=softInv, PYSNMP_MODULE_ID=shelf, ledIndex=ledIndex, eowSrcPtr=eowSrcPtr, hardInventoryBoard=hardInventoryBoard, boardList=boardList)
