...
mibBuilder.exportSymbols("SHELF-MIB", eowName=eowName, boardDefectiveSev=boardDefectiveSev, boardIndex=boardIndex, boardListEntry=boardListEntry, BoardFailure=BoardFailure, eow=eow, eowEntry=eowEntry, eowIndex=eowIndex, eowSrcType=eowSrcType, boardSlotName=boardSlotName, boardEntry=boardEntry, PYSNMP_MODULE_ID=shelf, boardSeverity=boardSeverity, softInventoryEntry=softInventoryEntry, softInventoryNumber=softInventoryNumber, led=led, boardListType=boardListType, LedStatus=LedStatus, boardTable=boardTable, boardFailure=boardFailure, eowSrcPtr=eowSrcPtr, adrFailHoldOnTime=adrFailHoldOnTime, laserTable=laserTable, adrHotReset=adrHotReset, boardFirstPortIndex=boardFirstPortIndex, hardInventoryNumber=hardInventoryNumber, boardExpectFamily=boardExpectFamily, hardInventoryIndex=hardInventoryIndex, boardInsertType=boardInsertType, ProtectionType=ProtectionType, eowSinkPtr=eowSinkPtr, ledTable=ledTable, laserNumber=laserNumber, board=board, LedType=LedType, ledPosition=ledPosition, softInventoryIndex=softInventoryIndex, shelf=shelf, laserIndex=laserIndex, softInventoryCode=softInventoryCode, hardInventoryTable=hardInventoryTable, boardListIndex=boardListIndex, boardMonitor=boardMonitor, hardInventoryBoard=hardInventoryBoard, boardListTable=boardListTable, boardMismatchSev=boardMismatchSev, softInventoryBoard=softInventoryBoard, boardListNumber=boardListNumber, laserTxEnable=laserTxEnable, ledEntry=ledEntry, softInv=softInv, ledStatus=ledStatus, eowClockMode=eowClockMode, ledNumber=ledNumber, boardMissingSev=boardMissingSev, softInventoryExt=softInventoryExt, eowTable=eowTable, boardList=boardList, ledType=ledType, boardExpectType=boardExpectType, boardActive=boardActive, EOWClockMode=EOWClockMode, softInventoryType=softInventoryType, softInventoryTable=softInventoryTable, ledIndex=ledIndex, hardInventoryEntry=hardInventoryEntry, boardNumber=boardNumber, holdTime=holdTime, eowNumber=eowNumber, laserALSRestart2s=laserALSRestart2s, HoldTime=HoldTime, boardInsertFamily=boardInsertFamily, laserALSEnable=laserALSEnable, laserALSRestart90s=laserALSRestart90s, adrFailHoldOffTime=adrFailHoldOffTime, laser=laser, EOWType=EOWType, boardListSlot=boardListSlot, hardInventoryDescr=hardInventoryDescr, laserEntry=laserEntry, hardInv=hardInv, eowSinkType=eowSinkType, boardProtectionType=boardProtectionType)
