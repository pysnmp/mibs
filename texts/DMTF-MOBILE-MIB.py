...
mibBuilder.exportSymbols("DMTF-MOBILE-MIB", dmtfInfraredPortState=dmtfInfraredPortState, ringEventResume=ringEventResume, colorSupport=colorSupport, index2=index2, dmtfPortableBatteryEvSub=dmtfPortableBatteryEvSub, dmtfPointingDeviceTable=dmtfPointingDeviceTable, iREnableState=iREnableState, fullChargeCapacity=fullChargeCapacity, smartBatteryVersion=smartBatteryVersion, powerManagementEnabledDisabled=powerManagementEnabledDisabled, pointingDeviceButtons=pointingDeviceButtons, dmtfDeviceBayState=dmtfDeviceBayState, portableBatteryDeviceName=portableBatteryDeviceName, DmiGauge=DmiGauge, DmiCompId=DmiCompId, dmtfPortableBatteryTable=dmtfPortableBatteryTable, dmtfVideoOutputDeviceEntry=dmtfVideoOutputDeviceEntry, contrast=contrast, dmtfSystemPowerManagementEntry=dmtfSystemPowerManagementEntry, maximumError=maximumError, DmiCounter=DmiCounter, d3TimerValue=d3TimerValue, dmtfInfraredPortTable=dmtfInfraredPortTable, iRVirtualCOMPortName=iRVirtualCOMPortName, portableBatteryLocation=portableBatteryLocation, deviceBayLocation=deviceBayLocation, portableBatteryManufacturer=portableBatteryManufacturer, DmiCounter64=DmiCounter64, dmtfPointingDeviceEntry=dmtfPointingDeviceEntry, pointingDevicePortName=pointingDevicePortName, reducedCPUClockSpeed=reducedCPUClockSpeed, pointingDeviceType=pointingDeviceType, dmtfDeviceBayTable=dmtfDeviceBayTable, overrideAC=overrideAC, pointingDeviceInterface=pointingDeviceInterface, builtIn=builtIn, iRIndex=iRIndex, dmtfPortableBatteryMaintenanceRequired=dmtfPortableBatteryMaintenanceRequired, dmtfPortableBatteryTraps=dmtfPortableBatteryTraps, index=index, type=type, d1TimerValue=d1TimerValue, DmiInteger=DmiInteger, pointingDeviceDriverName=pointingDeviceDriverName, iRSpeedLimit=iRSpeedLimit, dmtfPortableBatteryEvSys=dmtfPortableBatteryEvSys, portableBatteryDesignCapacity=portableBatteryDesignCapacity, portableBatteryManufactureDate=portableBatteryManufactureDate, remainingBatteryTime=remainingBatteryTime, aCLineStatus=aCLineStatus, dmtfStdMifs=dmtfStdMifs, portableBatteryDeviceChemistry=portableBatteryDeviceChemistry, powerUnitIndex=powerUnitIndex, dockingStatus=dockingStatus, dmtf=dmtf, dmtfDynOids=dmtfDynOids, remainingTimeToFullBattery=remainingTimeToFullBattery, dmtfPowerManagementBinaryAssociationTableState=dmtfPowerManagementBinaryAssociationTableState, iRVirtualLPTPortName=iRVirtualLPTPortName, dmtfPowerManagementBinaryAssociationTable=dmtfPowerManagementBinaryAssociationTable, type2=type2, dmtfPowerManagementTableState=dmtfPowerManagementTableState, dmtfPortableBatteryLowCombinedBatterysCharge=dmtfPortableBatteryLowCombinedBatterysCharge, portableBatterySerialNumber=portableBatterySerialNumber, dmtfPowerManagementTable=dmtfPowerManagementTable, dmtfVideoOutputDeviceState=dmtfVideoOutputDeviceState, iRProtocol=iRProtocol, dmtfPortableBatteryState=dmtfPortableBatteryState, alarmResume=alarmResume, dmtfMobileComputerMIF=dmtfMobileComputerMIF, ref1=ref1, dmtfPortableBatteryEntry=dmtfPortableBatteryEntry, securitySettings=securitySettings, deviceBayType=deviceBayType, dmtfSystemPowerManagementTable=dmtfSystemPowerManagementTable, dmtfPortableBatteryCriticalCombinedBatterysCharge=dmtfPortableBatteryCriticalCombinedBatterysCharge, deviceCurrentlyAttached=deviceCurrentlyAttached, dmtfPowerManagementEntry=dmtfPowerManagementEntry, brightness=brightness, iRLimitSpeedEnable=iRLimitSpeedEnable, portableBatteryDesignVoltage=portableBatteryDesignVoltage, devicesSupported=devicesSupported, dmtfDynamicStatesEntry=dmtfDynamicStatesEntry, videoGroupReference=videoGroupReference, pointingDeviceIRQ=pointingDeviceIRQ, pointingDeviceDriverVersion=pointingDeviceDriverVersion, dmtfDeviceBayEntry=dmtfDeviceBayEntry, dmtfDynamicStatesTable=dmtfDynamicStatesTable, iRPhysicalPortName=iRPhysicalPortName, portableBatteryChargingStatus=portableBatteryChargingStatus, iRLocation=iRLocation, powerManagementCapabilities=powerManagementCapabilities, PYSNMP_MODULE_ID=dmtfMobileComputerMIF, d2TimerValue=d2TimerValue, currentPowerManagementState=currentPowerManagementState, DmiGroupId=DmiGroupId, portableBatteryIndex=portableBatteryIndex, deviceBayIndex=deviceBayIndex, remainingCapacity=remainingCapacity, ref2=ref2, dmtfInfraredPortEntry=dmtfInfraredPortEntry, DmiOctetstring=DmiOctetstring, dmtfPowerManagementBinaryAssociationEntry=dmtfPowerManagementBinaryAssociationEntry, operationalGroupIndex=operationalGroupIndex, dmtfVideoOutputDeviceTable=dmtfVideoOutputDeviceTable, fRUGroupIndex=fRUGroupIndex)
