...
reportsIfJackIndex, reportsL2IfaceSlot, prvt_products, reportsL2IfaceUnit, reportsL2IfacePort = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsIfJackIndex", "reportsL2IfaceSlot", "prvt-products", "reportsL2IfaceUnit", "reportsL2IfacePort")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", monPortOverSize=monPortOverSize, sfpConnector=sfpConnector, sysMonLed=sysMonLed, EnableStatus=EnableStatus, ramFreeSpaceExceeded=ramFreeSpaceExceeded, prvtSysMonObjects=prvtSysMonObjects, laserPortThresholdTable=laserPortThresholdTable, sfpMonStatusChanged=sfpMonStatusChanged, sfpLenght=sfpLenght, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonTrap=sysMonTrap, prvtSysMonNotifications=prvtSysMonNotifications, laserPortValueTable=laserPortValueTable, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, portsCRCErrExceeded=portsCRCErrExceeded, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sysMonNotificationGroup=sysMonNotificationGroup, sfpRevision=sfpRevision, cpuUtilizationExceeded=cpuUtilizationExceeded, sysMonConfig=sysMonConfig, monPortBroadcast=monPortBroadcast, portsBroadcastExceeded=portsBroadcastExceeded, ramBytesFreeThreshold=ramBytesFreeThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, monPortsEntry=monPortsEntry, sfpPortManTable=sfpPortManTable, sysMonConfigEntry=sysMonConfigEntry, prvtSysMonMib=prvtSysMonMib, monPortsTable=monPortsTable, portErrorsThreshold=portErrorsThreshold, monRamBytesFree=monRamBytesFree, sysMonValues=sysMonValues, sfpMonStatus=sfpMonStatus, sfpVendor=sfpVendor, portErrorsExceeded=portErrorsExceeded, portsOverSizeExceeded=portsOverSizeExceeded, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sysMonEnable=sysMonEnable, sfpStatus=sfpStatus, software=software, sysMonMIBGroups=sysMonMIBGroups, laserRxPowerLowThreshold=laserRxPowerLowThreshold, portsRuntsExceeded=portsRuntsExceeded, laserTxPowerLowThreshold=laserTxPowerLowThreshold, PYSNMP_MODULE_ID=prvtSysMonMib, portsRuntsThreshold=portsRuntsThreshold, prvtSysMonConformance=prvtSysMonConformance, laserTemperatureHighThreshold=laserTemperatureHighThreshold, sysMonDefaults=sysMonDefaults, sfpPN=sfpPN, portsOverSizeThreshold=portsOverSizeThreshold, monPortCRCErr=monPortCRCErr, sysMonIndicator=sysMonIndicator, sfpPortManEntry=sfpPortManEntry, portsBroadcastThreshold=portsBroadcastThreshold, laserTemperature=laserTemperature, portsCRCErrThreshold=portsCRCErrThreshold, laserPortThresholdEntry=laserPortThresholdEntry, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sysMonConfigTable=sysMonConfigTable, sysMonPeriod=sysMonPeriod, sysMonThreshold=sysMonThreshold, monPortErrors=monPortErrors, laserTxPower=laserTxPower, laserRxPower=laserRxPower, sysMonLog=sysMonLog, laserPortValueEntry=laserPortValueEntry, monPortRunts=monPortRunts, monCpuUtilization=monCpuUtilization)
