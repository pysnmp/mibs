...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonIndicator=sysMonIndicator, sfpConnector=sfpConnector, monPortOverSize=monPortOverSize, sysMonLed=sysMonLed, laserPortThresholdTable=laserPortThresholdTable, monCpuUtilization=monCpuUtilization, portErrorsExceeded=portErrorsExceeded, portsOverSizeThreshold=portsOverSizeThreshold, monPortRunts=monPortRunts, sfpLenght=sfpLenght, sysMonPeriod=sysMonPeriod, monPortsEntry=monPortsEntry, sfpRevision=sfpRevision, PYSNMP_MODULE_ID=prvtSysMonMib, sysMonTrap=sysMonTrap, cpuUtilizationThreshold=cpuUtilizationThreshold, portsRuntsExceeded=portsRuntsExceeded, sfpMonStatusChanged=sfpMonStatusChanged, sysMonValues=sysMonValues, prvtSysMonNotifications=prvtSysMonNotifications, sysMonConfig=sysMonConfig, monPortsTable=monPortsTable, ramBytesFreeThreshold=ramBytesFreeThreshold, laserPortValueEntry=laserPortValueEntry, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sfpVendor=sfpVendor, portErrorsThreshold=portErrorsThreshold, sfpPN=sfpPN, monPortBroadcast=monPortBroadcast, sfpPortManEntry=sfpPortManEntry, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, laserPortValueTable=laserPortValueTable, monPortErrors=monPortErrors, sysMonConfigTable=sysMonConfigTable, sfpStatus=sfpStatus, laserTemperatureHighThreshold=laserTemperatureHighThreshold, sfpPortManTable=sfpPortManTable, software=software, portsBroadcastExceeded=portsBroadcastExceeded, sysMonLog=sysMonLog, portsCRCErrThreshold=portsCRCErrThreshold, cpuUtilizationExceeded=cpuUtilizationExceeded, prvtSysMonConformance=prvtSysMonConformance, sysMonConfigEntry=sysMonConfigEntry, laserTxPowerLowThreshold=laserTxPowerLowThreshold, prvtSysMonObjects=prvtSysMonObjects, laserTemperature=laserTemperature, sysMonDefaults=sysMonDefaults, laserPortThresholdEntry=laserPortThresholdEntry, monPortCRCErr=monPortCRCErr, laserTxPowerHighThreshold=laserTxPowerHighThreshold, sysMonEnable=sysMonEnable, sysMonThreshold=sysMonThreshold, portsOverSizeExceeded=portsOverSizeExceeded, portsCRCErrExceeded=portsCRCErrExceeded, sysMonMIBGroups=sysMonMIBGroups, sysMonNotificationGroup=sysMonNotificationGroup, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, portsRuntsThreshold=portsRuntsThreshold, prvtSysMonMib=prvtSysMonMib, sfpMonStatus=sfpMonStatus, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, monRamBytesFree=monRamBytesFree, laserRxPowerLowThreshold=laserRxPowerLowThreshold, EnableStatus=EnableStatus, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserTxPower=laserTxPower, laserRxPower=laserRxPower, portsBroadcastThreshold=portsBroadcastThreshold)
