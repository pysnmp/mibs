...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", monPortOverSize=monPortOverSize, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sfpLenght=sfpLenght, sysMonEnable=sysMonEnable, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, laserTxPowerHighThreshold=laserTxPowerHighThreshold, sysMonIndicator=sysMonIndicator, sysMonNotificationGroup=sysMonNotificationGroup, prvtSysMonConformance=prvtSysMonConformance, sfpMonStatus=sfpMonStatus, sysMonPeriod=sysMonPeriod, portsOverSizeExceeded=portsOverSizeExceeded, laserTemperature=laserTemperature, portsCRCErrExceeded=portsCRCErrExceeded, laserTemperatureHighThreshold=laserTemperatureHighThreshold, laserPortThresholdTable=laserPortThresholdTable, laserTxPower=laserTxPower, software=software, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonTrap=sysMonTrap, laserTxPowerLowThreshold=laserTxPowerLowThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, EnableStatus=EnableStatus, ramBytesFreeThreshold=ramBytesFreeThreshold, laserRxPowerHighThreshold=laserRxPowerHighThreshold, monPortsEntry=monPortsEntry, monPortRunts=monPortRunts, sfpPortManTable=sfpPortManTable, portsRuntsThreshold=portsRuntsThreshold, portsRuntsExceeded=portsRuntsExceeded, sysMonValues=sysMonValues, laserRxPower=laserRxPower, laserPortThresholdEntry=laserPortThresholdEntry, portErrorsExceeded=portErrorsExceeded, sfpPN=sfpPN, prvtSysMonMib=prvtSysMonMib, sfpMonStatusChanged=sfpMonStatusChanged, cpuUtilizationExceeded=cpuUtilizationExceeded, monPortBroadcast=monPortBroadcast, sysMonLed=sysMonLed, monRamBytesFree=monRamBytesFree, portsCRCErrThreshold=portsCRCErrThreshold, portsBroadcastThreshold=portsBroadcastThreshold, sysMonThreshold=sysMonThreshold, sysMonConfigTable=sysMonConfigTable, monPortErrors=monPortErrors, laserPortValueTable=laserPortValueTable, portsOverSizeThreshold=portsOverSizeThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sfpVendor=sfpVendor, sysMonMIBGroups=sysMonMIBGroups, prvtSysMonNotifications=prvtSysMonNotifications, prvtSysMonObjects=prvtSysMonObjects, PYSNMP_MODULE_ID=prvtSysMonMib, portErrorsThreshold=portErrorsThreshold, sysMonConfig=sysMonConfig, monCpuUtilization=monCpuUtilization, monPortsTable=monPortsTable, monPortCRCErr=monPortCRCErr, sfpStatus=sfpStatus, laserPortValueEntry=laserPortValueEntry, sysMonDefaults=sysMonDefaults, portsBroadcastExceeded=portsBroadcastExceeded, sysMonConfigEntry=sysMonConfigEntry, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sysMonLog=sysMonLog, sfpRevision=sfpRevision, sfpConnector=sfpConnector, laserRxPowerLowThreshold=laserRxPowerLowThreshold, sfpPortManEntry=sfpPortManEntry)
