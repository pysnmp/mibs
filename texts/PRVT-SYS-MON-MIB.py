...
reportsIfJackIndex, reportsL2IfaceSlot, reportsL2IfaceUnit, reportsL2IfacePort, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsIfJackIndex", "reportsL2IfaceSlot", "reportsL2IfaceUnit", "reportsL2IfacePort", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sfpPN=sfpPN, PYSNMP_MODULE_ID=prvtSysMonMib, sysMonConfig=sysMonConfig, laserPortValueTable=laserPortValueTable, sysMonMIBGroups=sysMonMIBGroups, laserTemperatureLowThreshold=laserTemperatureLowThreshold, prvtSysMonMib=prvtSysMonMib, prvtSysMonConformance=prvtSysMonConformance, laserRxPowerLowThreshold=laserRxPowerLowThreshold, monPortErrors=monPortErrors, laserTxPower=laserTxPower, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sysMonPeriod=sysMonPeriod, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, ramBytesFreeThreshold=ramBytesFreeThreshold, monPortCRCErr=monPortCRCErr, sysMonLog=sysMonLog, laserPortThresholdTable=laserPortThresholdTable, monPortRunts=monPortRunts, sfpRevision=sfpRevision, monRamBytesFree=monRamBytesFree, monPortBroadcast=monPortBroadcast, portsOverSizeThreshold=portsOverSizeThreshold, laserRxPowerHighThreshold=laserRxPowerHighThreshold, monPortsEntry=monPortsEntry, sfpStatus=sfpStatus, laserPortValueEntry=laserPortValueEntry, prvtSysMonNotifications=prvtSysMonNotifications, sfpConnector=sfpConnector, portsBroadcastExceeded=portsBroadcastExceeded, software=software, laserTxPowerLowThreshold=laserTxPowerLowThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, portsRuntsThreshold=portsRuntsThreshold, portErrorsThreshold=portErrorsThreshold, monCpuUtilization=monCpuUtilization, sfpLenght=sfpLenght, laserTemperatureHighThreshold=laserTemperatureHighThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, laserTemperature=laserTemperature, sfpMonStatus=sfpMonStatus, portsRuntsExceeded=portsRuntsExceeded, portsOverSizeExceeded=portsOverSizeExceeded, prvtSysMonObjects=prvtSysMonObjects, EnableStatus=EnableStatus, sfpPortManEntry=sfpPortManEntry, sysMonDefaults=sysMonDefaults, sysMonConfigEntry=sysMonConfigEntry, sysMonLed=sysMonLed, sysMonNotificationGroup=sysMonNotificationGroup, sysMonEnable=sysMonEnable, sysMonIndicator=sysMonIndicator, monPortOverSize=monPortOverSize, monPortsTable=monPortsTable, cpuUtilizationExceeded=cpuUtilizationExceeded, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonTrap=sysMonTrap, sysMonConfigTable=sysMonConfigTable, sfpMonStatusChanged=sfpMonStatusChanged, ramFreeSpaceExceeded=ramFreeSpaceExceeded, portsCRCErrThreshold=portsCRCErrThreshold, sysMonThreshold=sysMonThreshold, laserPortThresholdEntry=laserPortThresholdEntry, portErrorsExceeded=portErrorsExceeded, sfpVendor=sfpVendor, portsCRCErrExceeded=portsCRCErrExceeded, sfpPortManTable=sfpPortManTable, sysMonValues=sysMonValues, portsBroadcastThreshold=portsBroadcastThreshold, laserRxPower=laserRxPower)
