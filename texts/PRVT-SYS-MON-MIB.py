...
reportsL2IfacePort, reportsL2IfaceSlot, reportsL2IfaceUnit, reportsIfJackIndex, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfacePort", "reportsL2IfaceSlot", "reportsL2IfaceUnit", "reportsIfJackIndex", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", laserPortThresholdTable=laserPortThresholdTable, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserPortValueEntry=laserPortValueEntry, monCpuUtilization=monCpuUtilization, portsBroadcastThreshold=portsBroadcastThreshold, sfpMonStatusChanged=sfpMonStatusChanged, sysMonLed=sysMonLed, portsOverSizeExceeded=portsOverSizeExceeded, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sfpRevision=sfpRevision, portsOverSizeThreshold=portsOverSizeThreshold, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monRamBytesFree=monRamBytesFree, laserTemperature=laserTemperature, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonIndicator=sysMonIndicator, laserTxPowerLowThreshold=laserTxPowerLowThreshold, monPortBroadcast=monPortBroadcast, sfpLenght=sfpLenght, portsRuntsExceeded=portsRuntsExceeded, sfpConnector=sfpConnector, portErrorsExceeded=portErrorsExceeded, prvtSysMonMib=prvtSysMonMib, software=software, sysMonValues=sysMonValues, sysMonMIBGroups=sysMonMIBGroups, prvtSysMonConformance=prvtSysMonConformance, sfpPN=sfpPN, laserPortThresholdEntry=laserPortThresholdEntry, sysMonEnable=sysMonEnable, portsCRCErrExceeded=portsCRCErrExceeded, sysMonPeriod=sysMonPeriod, sysMonThreshold=sysMonThreshold, prvtSysMonObjects=prvtSysMonObjects, portErrorsThreshold=portErrorsThreshold, EnableStatus=EnableStatus, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sfpPortManEntry=sfpPortManEntry, PYSNMP_MODULE_ID=prvtSysMonMib, sfpStatus=sfpStatus, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sfpPortManTable=sfpPortManTable, laserTxPowerHighThreshold=laserTxPowerHighThreshold, portsBroadcastExceeded=portsBroadcastExceeded, sysMonLog=sysMonLog, ramBytesFreeThreshold=ramBytesFreeThreshold, laserTemperatureLowThreshold=laserTemperatureLowThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, monPortOverSize=monPortOverSize, laserRxPower=laserRxPower, cpuUtilizationExceeded=cpuUtilizationExceeded, monPortsTable=monPortsTable, laserPortValueTable=laserPortValueTable, sysMonConfigTable=sysMonConfigTable, monPortsEntry=monPortsEntry, sysMonNotificationGroup=sysMonNotificationGroup, monPortCRCErr=monPortCRCErr, sysMonDefaults=sysMonDefaults, monPortRunts=monPortRunts, portsRuntsThreshold=portsRuntsThreshold, laserTxPower=laserTxPower, sysMonConfigEntry=sysMonConfigEntry, sysMonTrap=sysMonTrap, monPortErrors=monPortErrors, sfpMonStatus=sfpMonStatus, sfpVendor=sfpVendor, portsCRCErrThreshold=portsCRCErrThreshold, sysMonConfig=sysMonConfig, laserRxPowerLowThreshold=laserRxPowerLowThreshold, prvtSysMonNotifications=prvtSysMonNotifications)
