...
reportsL2IfaceSlot, reportsL2IfacePort, reportsIfJackIndex, prvt_products, reportsL2IfaceUnit = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfaceSlot", "reportsL2IfacePort", "reportsIfJackIndex", "prvt-products", "reportsL2IfaceUnit")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", monCpuUtilization=monCpuUtilization, portsOverSizeThreshold=portsOverSizeThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, monPortBroadcast=monPortBroadcast, laserPortValueTable=laserPortValueTable, laserTemperatureHighThreshold=laserTemperatureHighThreshold, sysMonTrap=sysMonTrap, portErrorsThreshold=portErrorsThreshold, cpuUtilizationExceeded=cpuUtilizationExceeded, laserTemperature=laserTemperature, sfpRevision=sfpRevision, portsRuntsThreshold=portsRuntsThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonMIBGroups=sysMonMIBGroups, sfpPortManTable=sfpPortManTable, sysMonValues=sysMonValues, monPortCRCErr=monPortCRCErr, cpuUtilizationThreshold=cpuUtilizationThreshold, portsCRCErrExceeded=portsCRCErrExceeded, sfpStatus=sfpStatus, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, software=software, monPortsTable=monPortsTable, prvtSysMonConformance=prvtSysMonConformance, sfpMonStatus=sfpMonStatus, prvtSysMonMib=prvtSysMonMib, portsBroadcastExceeded=portsBroadcastExceeded, ramFreeSpaceExceeded=ramFreeSpaceExceeded, prvtSysMonNotifications=prvtSysMonNotifications, portsOverSizeExceeded=portsOverSizeExceeded, sysMonLed=sysMonLed, monPortRunts=monPortRunts, portsBroadcastThreshold=portsBroadcastThreshold, laserPortValueEntry=laserPortValueEntry, laserRxPowerLowThreshold=laserRxPowerLowThreshold, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sysMonConfig=sysMonConfig, laserRxPower=laserRxPower, sfpVendor=sfpVendor, laserRxPowerHighThreshold=laserRxPowerHighThreshold, monRamBytesFree=monRamBytesFree, sfpConnector=sfpConnector, sfpLenght=sfpLenght, sysMonEnable=sysMonEnable, laserTxPower=laserTxPower, sysMonConfigEntry=sysMonConfigEntry, sfpPN=sfpPN, sysMonConfigTable=sysMonConfigTable, EnableStatus=EnableStatus, portsCRCErrThreshold=portsCRCErrThreshold, monPortErrors=monPortErrors, portErrorsExceeded=portErrorsExceeded, laserPortThresholdTable=laserPortThresholdTable, sysMonDefaults=sysMonDefaults, monPortsEntry=monPortsEntry, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sysMonPeriod=sysMonPeriod, sysMonLog=sysMonLog, sysMonThreshold=sysMonThreshold, prvtSysMonObjects=prvtSysMonObjects, sfpMonStatusChanged=sfpMonStatusChanged, sfpPortManEntry=sfpPortManEntry, PYSNMP_MODULE_ID=prvtSysMonMib, portsRuntsExceeded=portsRuntsExceeded, sysMonIndicator=sysMonIndicator, laserPortThresholdEntry=laserPortThresholdEntry, laserTxPowerLowThreshold=laserTxPowerLowThreshold, monPortOverSize=monPortOverSize, sysMonNotificationGroup=sysMonNotificationGroup)
