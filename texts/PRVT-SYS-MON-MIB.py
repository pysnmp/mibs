...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sfpPortManEntry=sfpPortManEntry, monPortBroadcast=monPortBroadcast, sfpMonStatusChanged=sfpMonStatusChanged, laserPortValueTable=laserPortValueTable, laserRxPower=laserRxPower, sfpRevision=sfpRevision, monPortOverSize=monPortOverSize, monPortsEntry=monPortsEntry, prvtSysMonNotifications=prvtSysMonNotifications, sysMonValues=sysMonValues, sysMonConfig=sysMonConfig, monRamBytesFree=monRamBytesFree, laserTemperature=laserTemperature, sysMonConfigEntry=sysMonConfigEntry, laserTemperatureHighThreshold=laserTemperatureHighThreshold, sfpStatus=sfpStatus, sfpVendor=sfpVendor, sysMonLog=sysMonLog, monCpuUtilization=monCpuUtilization, portsBroadcastExceeded=portsBroadcastExceeded, cpuUtilizationThreshold=cpuUtilizationThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, laserRxPowerLowThreshold=laserRxPowerLowThreshold, sysMonConfigTable=sysMonConfigTable, laserTxPower=laserTxPower, prvtSysMonConformance=prvtSysMonConformance, sysMonLed=sysMonLed, sysMonMIBGroups=sysMonMIBGroups, monPortErrors=monPortErrors, laserPortValueEntry=laserPortValueEntry, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sfpConnector=sfpConnector, sysMonIndicator=sysMonIndicator, portsBroadcastThreshold=portsBroadcastThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, sysMonTrap=sysMonTrap, portsOverSizeExceeded=portsOverSizeExceeded, portsRuntsThreshold=portsRuntsThreshold, monPortRunts=monPortRunts, prvtSysMonMib=prvtSysMonMib, sysMonThreshold=sysMonThreshold, portsCRCErrThreshold=portsCRCErrThreshold, portsOverSizeThreshold=portsOverSizeThreshold, laserPortThresholdTable=laserPortThresholdTable, monPortCRCErr=monPortCRCErr, portsCRCErrExceeded=portsCRCErrExceeded, portsRuntsExceeded=portsRuntsExceeded, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, monPortsTable=monPortsTable, cpuUtilizationExceeded=cpuUtilizationExceeded, sfpLenght=sfpLenght, laserPortThresholdEntry=laserPortThresholdEntry, sfpMonStatus=sfpMonStatus, laserRxPowerHighThreshold=laserRxPowerHighThreshold, sfpPortManTable=sfpPortManTable, PYSNMP_MODULE_ID=prvtSysMonMib, sysMonNotificationGroup=sysMonNotificationGroup, sfpPN=sfpPN, prvtSysMonObjects=prvtSysMonObjects, ramBytesFreeThreshold=ramBytesFreeThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonPeriod=sysMonPeriod, portErrorsThreshold=portErrorsThreshold, software=software, portErrorsExceeded=portErrorsExceeded, sysMonEnable=sysMonEnable, EnableStatus=EnableStatus, sysMonDefaults=sysMonDefaults, laserTemperatureLowThreshold=laserTemperatureLowThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold)
