...
reportsIfJackIndex, prvt_products, reportsL2IfaceUnit, reportsL2IfaceSlot, reportsL2IfacePort = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsIfJackIndex", "prvt-products", "reportsL2IfaceUnit", "reportsL2IfaceSlot", "reportsL2IfacePort")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", laserTxPowerHighThreshold=laserTxPowerHighThreshold, portsCRCErrThreshold=portsCRCErrThreshold, monPortRunts=monPortRunts, monPortOverSize=monPortOverSize, software=software, sysMonEnable=sysMonEnable, monPortsTable=monPortsTable, portErrorsThreshold=portErrorsThreshold, monPortErrors=monPortErrors, sysMonConfig=sysMonConfig, portsRuntsThreshold=portsRuntsThreshold, sysMonTrap=sysMonTrap, prvtSysMonConformance=prvtSysMonConformance, laserTemperatureHighThreshold=laserTemperatureHighThreshold, laserPortThresholdEntry=laserPortThresholdEntry, sysMonDefaults=sysMonDefaults, monCpuUtilization=monCpuUtilization, sfpPN=sfpPN, sysMonMIBGroups=sysMonMIBGroups, prvtSysMonObjects=prvtSysMonObjects, laserRxPower=laserRxPower, prvtSysMonNotifications=prvtSysMonNotifications, sysMonIndicator=sysMonIndicator, sysMonLog=sysMonLog, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sfpVendor=sfpVendor, sysMonValues=sysMonValues, laserRxPowerLowThreshold=laserRxPowerLowThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, monRamBytesFree=monRamBytesFree, sfpRevision=sfpRevision, ramBytesFreeThreshold=ramBytesFreeThreshold, sfpMonStatusChanged=sfpMonStatusChanged, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sfpMonStatus=sfpMonStatus, laserPortValueEntry=laserPortValueEntry, sfpConnector=sfpConnector, monPortCRCErr=monPortCRCErr, sysMonThreshold=sysMonThreshold, sfpPortManTable=sfpPortManTable, sfpStatus=sfpStatus, sysMonConfigTable=sysMonConfigTable, laserTemperature=laserTemperature, PYSNMP_MODULE_ID=prvtSysMonMib, cpuUtilizationThreshold=cpuUtilizationThreshold, EnableStatus=EnableStatus, laserPortValueTable=laserPortValueTable, sysMonPeriod=sysMonPeriod, portErrorsExceeded=portErrorsExceeded, cpuUtilizationExceeded=cpuUtilizationExceeded, portsBroadcastExceeded=portsBroadcastExceeded, portsOverSizeExceeded=portsOverSizeExceeded, sfpPortManEntry=sfpPortManEntry, portsOverSizeThreshold=portsOverSizeThreshold, sysMonConfigEntry=sysMonConfigEntry, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, prvtSysMonMib=prvtSysMonMib, sysMonNotificationGroup=sysMonNotificationGroup, laserPortThresholdTable=laserPortThresholdTable, laserRxPowerHighThreshold=laserRxPowerHighThreshold, portsBroadcastThreshold=portsBroadcastThreshold, monPortBroadcast=monPortBroadcast, portsCRCErrExceeded=portsCRCErrExceeded, monPortsEntry=monPortsEntry, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, portsRuntsExceeded=portsRuntsExceeded, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sfpLenght=sfpLenght, sysMonLed=sysMonLed, laserTxPower=laserTxPower)
