...
reportsL2IfacePort, reportsL2IfaceUnit, prvt_products, reportsL2IfaceSlot, reportsIfJackIndex = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfacePort", "reportsL2IfaceUnit", "prvt-products", "reportsL2IfaceSlot", "reportsIfJackIndex")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", prvtSysMonObjects=prvtSysMonObjects, sysMonLog=sysMonLog, monPortOverSize=monPortOverSize, laserTxPowerHighThreshold=laserTxPowerHighThreshold, portsRuntsThreshold=portsRuntsThreshold, sfpPN=sfpPN, sfpConnector=sfpConnector, monPortsEntry=monPortsEntry, sysMonValues=sysMonValues, monCpuUtilization=monCpuUtilization, sysMonConfig=sysMonConfig, portsCRCErrExceeded=portsCRCErrExceeded, sysMonConfigEntry=sysMonConfigEntry, laserRxPowerHighThreshold=laserRxPowerHighThreshold, ramBytesFreeThreshold=ramBytesFreeThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonLed=sysMonLed, sysMonEnable=sysMonEnable, laserRxPower=laserRxPower, sysMonTrap=sysMonTrap, prvtSysMonMib=prvtSysMonMib, sfpMonStatusChanged=sfpMonStatusChanged, sfpStatus=sfpStatus, portsOverSizeThreshold=portsOverSizeThreshold, monPortErrors=monPortErrors, monPortRunts=monPortRunts, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, laserPortValueEntry=laserPortValueEntry, laserTxPowerLowThreshold=laserTxPowerLowThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, sfpMonStatus=sfpMonStatus, EnableStatus=EnableStatus, sfpLenght=sfpLenght, sysMonThreshold=sysMonThreshold, monPortsTable=monPortsTable, PYSNMP_MODULE_ID=prvtSysMonMib, portsOverSizeExceeded=portsOverSizeExceeded, sfpRevision=sfpRevision, sysMonPeriod=sysMonPeriod, laserPortThresholdEntry=laserPortThresholdEntry, sysMonConfigTable=sysMonConfigTable, prvtSysMonNotifications=prvtSysMonNotifications, monPortCRCErr=monPortCRCErr, laserPortValueTable=laserPortValueTable, laserTxPower=laserTxPower, portsBroadcastThreshold=portsBroadcastThreshold, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sfpPortManTable=sfpPortManTable, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sfpVendor=sfpVendor, laserPortThresholdTable=laserPortThresholdTable, portsBroadcastExceeded=portsBroadcastExceeded, laserTemperature=laserTemperature, monPortBroadcast=monPortBroadcast, portsRuntsExceeded=portsRuntsExceeded, sysMonDefaults=sysMonDefaults, portErrorsThreshold=portErrorsThreshold, prvtSysMonConformance=prvtSysMonConformance, portErrorsExceeded=portErrorsExceeded, sfpPortManEntry=sfpPortManEntry, sysMonIndicator=sysMonIndicator, cpuUtilizationExceeded=cpuUtilizationExceeded, sysMonMIBGroups=sysMonMIBGroups, software=software, sysMonNotificationGroup=sysMonNotificationGroup, laserRxPowerLowThreshold=laserRxPowerLowThreshold, portsCRCErrThreshold=portsCRCErrThreshold, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monRamBytesFree=monRamBytesFree)
