...
reportsL2IfaceUnit, reportsL2IfaceSlot, reportsL2IfacePort, reportsIfJackIndex, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfaceUnit", "reportsL2IfaceSlot", "reportsL2IfacePort", "reportsIfJackIndex", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", laserTxPowerHighThreshold=laserTxPowerHighThreshold, monPortRunts=monPortRunts, software=software, PYSNMP_MODULE_ID=prvtSysMonMib, sysMonConfig=sysMonConfig, monPortsTable=monPortsTable, sfpMonStatus=sfpMonStatus, prvtSysMonObjects=prvtSysMonObjects, sfpLenght=sfpLenght, sysMonTrap=sysMonTrap, laserRxPowerHighThreshold=laserRxPowerHighThreshold, sysMonConfigTable=sysMonConfigTable, laserPortValueEntry=laserPortValueEntry, monRamBytesFree=monRamBytesFree, monPortBroadcast=monPortBroadcast, portsRuntsExceeded=portsRuntsExceeded, prvtSysMonNotifications=prvtSysMonNotifications, portsCRCErrThreshold=portsCRCErrThreshold, sysMonThreshold=sysMonThreshold, sfpVendor=sfpVendor, portsOverSizeThreshold=portsOverSizeThreshold, laserPortThresholdEntry=laserPortThresholdEntry, laserPortValueTable=laserPortValueTable, prvtSysMonConformance=prvtSysMonConformance, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonLed=sysMonLed, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sysMonMIBGroups=sysMonMIBGroups, monPortOverSize=monPortOverSize, sysMonPeriod=sysMonPeriod, sfpConnector=sfpConnector, laserTxPowerLowThreshold=laserTxPowerLowThreshold, laserTxPower=laserTxPower, EnableStatus=EnableStatus, portsRuntsThreshold=portsRuntsThreshold, laserPortThresholdTable=laserPortThresholdTable, sfpStatus=sfpStatus, cpuUtilizationExceeded=cpuUtilizationExceeded, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sfpPN=sfpPN, sfpPortManEntry=sfpPortManEntry, sysMonDefaults=sysMonDefaults, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, prvtSysMonMib=prvtSysMonMib, portErrorsThreshold=portErrorsThreshold, monPortsEntry=monPortsEntry, monPortErrors=monPortErrors, portsBroadcastExceeded=portsBroadcastExceeded, sfpMonStatusChanged=sfpMonStatusChanged, sysMonConfigEntry=sysMonConfigEntry, sysMonNotificationGroup=sysMonNotificationGroup, portsOverSizeExceeded=portsOverSizeExceeded, ramBytesFreeThreshold=ramBytesFreeThreshold, sfpPortManTable=sfpPortManTable, portsCRCErrExceeded=portsCRCErrExceeded, monCpuUtilization=monCpuUtilization, sysMonEnable=sysMonEnable, sysMonLog=sysMonLog, portsBroadcastThreshold=portsBroadcastThreshold, laserRxPower=laserRxPower, cpuUtilizationThreshold=cpuUtilizationThreshold, laserRxPowerLowThreshold=laserRxPowerLowThreshold, sfpRevision=sfpRevision, portErrorsExceeded=portErrorsExceeded, sysMonIndicator=sysMonIndicator, sysMonValues=sysMonValues, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monPortCRCErr=monPortCRCErr, laserTemperature=laserTemperature)
