...
reportsL2IfaceUnit, reportsIfJackIndex, reportsL2IfacePort, reportsL2IfaceSlot, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfaceUnit", "reportsIfJackIndex", "reportsL2IfacePort", "reportsL2IfaceSlot", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sysMonConfigEntry=sysMonConfigEntry, portsCRCErrThreshold=portsCRCErrThreshold, prvtSysMonConformance=prvtSysMonConformance, laserRxPowerLowThreshold=laserRxPowerLowThreshold, sysMonTrap=sysMonTrap, sysMonMIBGroups=sysMonMIBGroups, monCpuUtilization=monCpuUtilization, ramBytesFreeThreshold=ramBytesFreeThreshold, EnableStatus=EnableStatus, prvtSysMonMib=prvtSysMonMib, laserTxPowerHighThreshold=laserTxPowerHighThreshold, monPortErrors=monPortErrors, sfpPortManEntry=sfpPortManEntry, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, portsOverSizeThreshold=portsOverSizeThreshold, laserPortThresholdTable=laserPortThresholdTable, laserTemperatureLowThreshold=laserTemperatureLowThreshold, portsOverSizeExceeded=portsOverSizeExceeded, laserRxPowerHighThreshold=laserRxPowerHighThreshold, sfpMonStatusChanged=sfpMonStatusChanged, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sysMonPeriod=sysMonPeriod, portsBroadcastExceeded=portsBroadcastExceeded, monPortRunts=monPortRunts, sysMonThreshold=sysMonThreshold, sfpPN=sfpPN, monPortsEntry=monPortsEntry, monPortsTable=monPortsTable, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonLog=sysMonLog, portsCRCErrExceeded=portsCRCErrExceeded, laserPortThresholdEntry=laserPortThresholdEntry, portErrorsExceeded=portErrorsExceeded, portsRuntsThreshold=portsRuntsThreshold, portErrorsThreshold=portErrorsThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, monRamBytesFree=monRamBytesFree, prvtSysMonNotifications=prvtSysMonNotifications, laserRxPower=laserRxPower, portsRuntsExceeded=portsRuntsExceeded, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sfpPortManTable=sfpPortManTable, sysMonEnable=sysMonEnable, PYSNMP_MODULE_ID=prvtSysMonMib, sysMonConfigTable=sysMonConfigTable, cpuUtilizationThreshold=cpuUtilizationThreshold, sfpStatus=sfpStatus, monPortCRCErr=monPortCRCErr, laserTemperature=laserTemperature, sfpMonStatus=sfpMonStatus, sysMonDefaults=sysMonDefaults, laserTxPower=laserTxPower, sysMonConfig=sysMonConfig, software=software, prvtSysMonObjects=prvtSysMonObjects, sfpRevision=sfpRevision, sfpLenght=sfpLenght, laserPortValueTable=laserPortValueTable, sfpConnector=sfpConnector, sysMonValues=sysMonValues, sysMonIndicator=sysMonIndicator, sysMonLed=sysMonLed, laserPortValueEntry=laserPortValueEntry, monPortBroadcast=monPortBroadcast, cpuUtilizationExceeded=cpuUtilizationExceeded, portsBroadcastThreshold=portsBroadcastThreshold, monPortOverSize=monPortOverSize, sfpVendor=sfpVendor, sysMonNotificationGroup=sysMonNotificationGroup, laserTemperatureHighThreshold=laserTemperatureHighThreshold)
