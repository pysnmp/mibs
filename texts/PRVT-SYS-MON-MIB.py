...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", laserRxPowerHighThreshold=laserRxPowerHighThreshold, portsCRCErrExceeded=portsCRCErrExceeded, monPortErrors=monPortErrors, sysMonConfigEntry=sysMonConfigEntry, cpuUtilizationThreshold=cpuUtilizationThreshold, sysMonTrap=sysMonTrap, PYSNMP_MODULE_ID=prvtSysMonMib, laserTemperatureLowThreshold=laserTemperatureLowThreshold, monRamBytesFree=monRamBytesFree, monPortOverSize=monPortOverSize, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sfpMonStatus=sfpMonStatus, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonThreshold=sysMonThreshold, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sfpVendor=sfpVendor, sfpStatus=sfpStatus, monPortBroadcast=monPortBroadcast, laserRxPower=laserRxPower, EnableStatus=EnableStatus, laserTemperature=laserTemperature, prvtSysMonConformance=prvtSysMonConformance, portsOverSizeExceeded=portsOverSizeExceeded, sfpPortManTable=sfpPortManTable, sysMonLog=sysMonLog, sysMonNotificationGroup=sysMonNotificationGroup, portErrorsExceeded=portErrorsExceeded, portsOverSizeThreshold=portsOverSizeThreshold, sysMonValues=sysMonValues, sfpLenght=sfpLenght, monPortCRCErr=monPortCRCErr, portsBroadcastExceeded=portsBroadcastExceeded, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonIndicator=sysMonIndicator, sysMonDefaults=sysMonDefaults, sysMonConfigTable=sysMonConfigTable, laserTxPowerHighThreshold=laserTxPowerHighThreshold, sfpMonStatusChanged=sfpMonStatusChanged, monPortsTable=monPortsTable, cpuUtilizationExceeded=cpuUtilizationExceeded, prvtSysMonObjects=prvtSysMonObjects, sysMonConfig=sysMonConfig, sysMonLed=sysMonLed, portsCRCErrThreshold=portsCRCErrThreshold, laserPortValueTable=laserPortValueTable, sysMonMIBGroups=sysMonMIBGroups, prvtSysMonNotifications=prvtSysMonNotifications, laserTxPower=laserTxPower, portsRuntsExceeded=portsRuntsExceeded, laserPortThresholdEntry=laserPortThresholdEntry, laserRxPowerLowThreshold=laserRxPowerLowThreshold, monCpuUtilization=monCpuUtilization, sfpRevision=sfpRevision, sfpConnector=sfpConnector, monPortRunts=monPortRunts, portsRuntsThreshold=portsRuntsThreshold, sysMonEnable=sysMonEnable, laserTxPowerLowThreshold=laserTxPowerLowThreshold, prvtSysMonMib=prvtSysMonMib, sfpPortManEntry=sfpPortManEntry, laserPortThresholdTable=laserPortThresholdTable, portsBroadcastThreshold=portsBroadcastThreshold, sfpPN=sfpPN, laserTemperatureHighThreshold=laserTemperatureHighThreshold, software=software, laserPortValueEntry=laserPortValueEntry, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, portErrorsThreshold=portErrorsThreshold, monPortsEntry=monPortsEntry, sysMonPeriod=sysMonPeriod)
