...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sysMonLog=sysMonLog, sysMonIndicator=sysMonIndicator, portsRuntsThreshold=portsRuntsThreshold, laserTemperatureLowThreshold=laserTemperatureLowThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonThreshold=sysMonThreshold, laserPortValueTable=laserPortValueTable, laserPortValueEntry=laserPortValueEntry, sfpPortManTable=sfpPortManTable, sysMonConfigTable=sysMonConfigTable, sysMonEnable=sysMonEnable, monPortBroadcast=monPortBroadcast, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, portErrorsExceeded=portErrorsExceeded, EnableStatus=EnableStatus, portsOverSizeExceeded=portsOverSizeExceeded, sfpMonStatusChanged=sfpMonStatusChanged, prvtSysMonMib=prvtSysMonMib, sysMonPeriod=sysMonPeriod, prvtSysMonConformance=prvtSysMonConformance, monPortRunts=monPortRunts, portsCRCErrExceeded=portsCRCErrExceeded, sysMonTrap=sysMonTrap, monPortOverSize=monPortOverSize, prvtSysMonNotifications=prvtSysMonNotifications, monPortCRCErr=monPortCRCErr, sysMonValues=sysMonValues, portsBroadcastExceeded=portsBroadcastExceeded, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sfpConnector=sfpConnector, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, monPortErrors=monPortErrors, portErrorsThreshold=portErrorsThreshold, sfpStatus=sfpStatus, sysMonLed=sysMonLed, sfpRevision=sfpRevision, laserPortThresholdEntry=laserPortThresholdEntry, portsOverSizeThreshold=portsOverSizeThreshold, laserPortThresholdTable=laserPortThresholdTable, laserTxPowerLowThreshold=laserTxPowerLowThreshold, sysMonNotificationGroup=sysMonNotificationGroup, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monRamBytesFree=monRamBytesFree, PYSNMP_MODULE_ID=prvtSysMonMib, sfpPN=sfpPN, prvtSysMonObjects=prvtSysMonObjects, sfpVendor=sfpVendor, cpuUtilizationThreshold=cpuUtilizationThreshold, portsRuntsExceeded=portsRuntsExceeded, sysMonConfigEntry=sysMonConfigEntry, sysMonDefaults=sysMonDefaults, sfpMonStatus=sfpMonStatus, sysMonConfig=sysMonConfig, cpuUtilizationExceeded=cpuUtilizationExceeded, monCpuUtilization=monCpuUtilization, laserTemperature=laserTemperature, ramFreeSpaceExceeded=ramFreeSpaceExceeded, portsCRCErrThreshold=portsCRCErrThreshold, monPortsTable=monPortsTable, laserRxPower=laserRxPower, sfpLenght=sfpLenght, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonMIBGroups=sysMonMIBGroups, sfpPortManEntry=sfpPortManEntry, laserTxPower=laserTxPower, laserRxPowerLowThreshold=laserRxPowerLowThreshold, portsBroadcastThreshold=portsBroadcastThreshold, software=software, monPortsEntry=monPortsEntry)
