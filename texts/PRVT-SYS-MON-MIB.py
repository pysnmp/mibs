...
reportsIfJackIndex, reportsL2IfacePort, reportsL2IfaceSlot, reportsL2IfaceUnit, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsIfJackIndex", "reportsL2IfacePort", "reportsL2IfaceSlot", "reportsL2IfaceUnit", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sysMonConfigEntry=sysMonConfigEntry, sfpStatus=sfpStatus, sysMonTrap=sysMonTrap, laserTemperature=laserTemperature, EnableStatus=EnableStatus, portsBroadcastExceeded=portsBroadcastExceeded, portsRuntsExceeded=portsRuntsExceeded, portsOverSizeExceeded=portsOverSizeExceeded, sfpMonStatus=sfpMonStatus, sysMonLog=sysMonLog, sysMonEnable=sysMonEnable, laserPortValueEntry=laserPortValueEntry, laserPortThresholdTable=laserPortThresholdTable, sfpRevision=sfpRevision, laserRxPowerHighThreshold=laserRxPowerHighThreshold, PYSNMP_MODULE_ID=prvtSysMonMib, laserTemperatureLowThreshold=laserTemperatureLowThreshold, portsCRCErrExceeded=portsCRCErrExceeded, sfpMonStatusChanged=sfpMonStatusChanged, sysMonThreshold=sysMonThreshold, sysMonMIBGroups=sysMonMIBGroups, portErrorsExceeded=portErrorsExceeded, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, monPortsEntry=monPortsEntry, portErrorsThreshold=portErrorsThreshold, monPortRunts=monPortRunts, laserPortValueTable=laserPortValueTable, sysMonConfigTable=sysMonConfigTable, monPortBroadcast=monPortBroadcast, sysMonIndicator=sysMonIndicator, prvtSysMonConformance=prvtSysMonConformance, monPortErrors=monPortErrors, cpuUtilizationThreshold=cpuUtilizationThreshold, laserPortThresholdEntry=laserPortThresholdEntry, laserRxPowerLowThreshold=laserRxPowerLowThreshold, laserTxPower=laserTxPower, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sfpPortManTable=sfpPortManTable, sfpLenght=sfpLenght, sysMonLed=sysMonLed, prvtSysMonMib=prvtSysMonMib, monPortCRCErr=monPortCRCErr, portsCRCErrThreshold=portsCRCErrThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sfpPortManEntry=sfpPortManEntry, sfpPN=sfpPN, sysMonNotificationGroup=sysMonNotificationGroup, laserTxPowerLowThreshold=laserTxPowerLowThreshold, sysMonValues=sysMonValues, sysMonDefaults=sysMonDefaults, prvtSysMonNotifications=prvtSysMonNotifications, monPortsTable=monPortsTable, sysMonPeriod=sysMonPeriod, monPortOverSize=monPortOverSize, prvtSysMonObjects=prvtSysMonObjects, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, laserRxPower=laserRxPower, laserTxPowerHighThreshold=laserTxPowerHighThreshold, monCpuUtilization=monCpuUtilization, sfpConnector=sfpConnector, portsBroadcastThreshold=portsBroadcastThreshold, portsRuntsThreshold=portsRuntsThreshold, monRamBytesFree=monRamBytesFree, ramBytesFreeThreshold=ramBytesFreeThreshold, sfpVendor=sfpVendor, laserTemperatureHighThreshold=laserTemperatureHighThreshold, cpuUtilizationExceeded=cpuUtilizationExceeded, sysMonConfig=sysMonConfig, portsOverSizeThreshold=portsOverSizeThreshold, software=software)
