...
reportsL2IfaceUnit, prvt_products, reportsIfJackIndex, reportsL2IfaceSlot, reportsL2IfacePort = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfaceUnit", "prvt-products", "reportsIfJackIndex", "reportsL2IfaceSlot", "reportsL2IfacePort")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", ramBytesFreeThreshold=ramBytesFreeThreshold, prvtSysMonConformance=prvtSysMonConformance, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, software=software, monCpuUtilization=monCpuUtilization, EnableStatus=EnableStatus, laserTxPower=laserTxPower, cpuUtilizationExceeded=cpuUtilizationExceeded, monPortsEntry=monPortsEntry, portsBroadcastExceeded=portsBroadcastExceeded, monRamBytesFree=monRamBytesFree, monPortErrors=monPortErrors, sysMonIndicator=sysMonIndicator, sysMonTrap=sysMonTrap, sysMonMIBGroups=sysMonMIBGroups, sysMonNotificationGroup=sysMonNotificationGroup, portsCRCErrExceeded=portsCRCErrExceeded, monPortBroadcast=monPortBroadcast, sysMonConfig=sysMonConfig, portsBroadcastThreshold=portsBroadcastThreshold, sfpPortManEntry=sfpPortManEntry, laserTxPowerHighThreshold=laserTxPowerHighThreshold, portsOverSizeExceeded=portsOverSizeExceeded, prvtSysMonMib=prvtSysMonMib, laserPortThresholdTable=laserPortThresholdTable, monPortOverSize=monPortOverSize, sfpPortManTable=sfpPortManTable, portsCRCErrThreshold=portsCRCErrThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, laserPortValueEntry=laserPortValueEntry, monPortCRCErr=monPortCRCErr, sysMonEnable=sysMonEnable, portErrorsExceeded=portErrorsExceeded, sfpVendor=sfpVendor, laserPortThresholdEntry=laserPortThresholdEntry, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserPortValueTable=laserPortValueTable, monPortsTable=monPortsTable, sfpRevision=sfpRevision, portsRuntsExceeded=portsRuntsExceeded, sysMonDefaults=sysMonDefaults, cpuUtilizationThreshold=cpuUtilizationThreshold, portsOverSizeThreshold=portsOverSizeThreshold, laserRxPower=laserRxPower, sysMonConfigEntry=sysMonConfigEntry, PYSNMP_MODULE_ID=prvtSysMonMib, prvtSysMonNotifications=prvtSysMonNotifications, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, portErrorsThreshold=portErrorsThreshold, sysMonLog=sysMonLog, sfpMonStatusChanged=sfpMonStatusChanged, sfpStatus=sfpStatus, sfpPN=sfpPN, monPortRunts=monPortRunts, sfpConnector=sfpConnector, sysMonConfigTable=sysMonConfigTable, sysMonLed=sysMonLed, laserTemperatureHighThreshold=laserTemperatureHighThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonPeriod=sysMonPeriod, sfpLenght=sfpLenght, sfpMonStatus=sfpMonStatus, sysMonValues=sysMonValues, sysMonThreshold=sysMonThreshold, portsRuntsThreshold=portsRuntsThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, laserRxPowerLowThreshold=laserRxPowerLowThreshold, laserTemperatureLowThreshold=laserTemperatureLowThreshold, laserTemperature=laserTemperature, prvtSysMonObjects=prvtSysMonObjects)
