...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sfpLenght=sfpLenght, portsBroadcastExceeded=portsBroadcastExceeded, monPortErrors=monPortErrors, laserPortValueEntry=laserPortValueEntry, software=software, sfpConnector=sfpConnector, prvtSysMonNotifications=prvtSysMonNotifications, portsOverSizeThreshold=portsOverSizeThreshold, sfpRevision=sfpRevision, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sfpVendor=sfpVendor, cpuUtilizationExceeded=cpuUtilizationExceeded, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sfpPN=sfpPN, portsRuntsThreshold=portsRuntsThreshold, portsBroadcastThreshold=portsBroadcastThreshold, sfpMonStatus=sfpMonStatus, portErrorsExceeded=portErrorsExceeded, cpuUtilizationThreshold=cpuUtilizationThreshold, sfpMonStatusChanged=sfpMonStatusChanged, monPortCRCErr=monPortCRCErr, sysMonIndicator=sysMonIndicator, sysMonTrap=sysMonTrap, monPortsEntry=monPortsEntry, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonNotificationGroup=sysMonNotificationGroup, portsOverSizeExceeded=portsOverSizeExceeded, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, portsCRCErrThreshold=portsCRCErrThreshold, laserPortThresholdTable=laserPortThresholdTable, sysMonConfigEntry=sysMonConfigEntry, laserRxPowerHighThreshold=laserRxPowerHighThreshold, sysMonValues=sysMonValues, sfpPortManEntry=sfpPortManEntry, sysMonDefaults=sysMonDefaults, EnableStatus=EnableStatus, PYSNMP_MODULE_ID=prvtSysMonMib, laserPortThresholdEntry=laserPortThresholdEntry, monPortRunts=monPortRunts, sfpStatus=sfpStatus, ramBytesFreeThreshold=ramBytesFreeThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monRamBytesFree=monRamBytesFree, monPortBroadcast=monPortBroadcast, sysMonMIBGroups=sysMonMIBGroups, sysMonConfigTable=sysMonConfigTable, sysMonPeriod=sysMonPeriod, laserRxPowerLowThreshold=laserRxPowerLowThreshold, laserTemperature=laserTemperature, sysMonLed=sysMonLed, sfpPortManTable=sfpPortManTable, prvtSysMonMib=prvtSysMonMib, laserRxPower=laserRxPower, portsCRCErrExceeded=portsCRCErrExceeded, portsRuntsExceeded=portsRuntsExceeded, monPortsTable=monPortsTable, portErrorsThreshold=portErrorsThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, sysMonLog=sysMonLog, prvtSysMonConformance=prvtSysMonConformance, prvtSysMonObjects=prvtSysMonObjects, laserTxPower=laserTxPower, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sysMonConfig=sysMonConfig, monCpuUtilization=monCpuUtilization, sysMonEnable=sysMonEnable, laserPortValueTable=laserPortValueTable, monPortOverSize=monPortOverSize, sysMonThreshold=sysMonThreshold)
