...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", monCpuUtilization=monCpuUtilization, sfpStatus=sfpStatus, monPortOverSize=monPortOverSize, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sfpRevision=sfpRevision, sysMonConfigEntry=sysMonConfigEntry, sysMonPeriod=sysMonPeriod, sysMonLog=sysMonLog, portsRuntsThreshold=portsRuntsThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, sysMonValues=sysMonValues, sysMonTrap=sysMonTrap, laserRxPowerHighThreshold=laserRxPowerHighThreshold, sysMonLed=sysMonLed, sfpConnector=sfpConnector, software=software, monPortBroadcast=monPortBroadcast, portsCRCErrExceeded=portsCRCErrExceeded, portsOverSizeThreshold=portsOverSizeThreshold, sysMonThreshold=sysMonThreshold, sfpPortManEntry=sfpPortManEntry, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonNotificationGroup=sysMonNotificationGroup, laserPortThresholdEntry=laserPortThresholdEntry, laserTemperatureHighThreshold=laserTemperatureHighThreshold, portErrorsExceeded=portErrorsExceeded, prvtSysMonMib=prvtSysMonMib, laserPortValueEntry=laserPortValueEntry, sysMonIndicator=sysMonIndicator, laserRxPower=laserRxPower, sysMonMIBGroups=sysMonMIBGroups, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, prvtSysMonConformance=prvtSysMonConformance, cpuUtilizationThreshold=cpuUtilizationThreshold, sfpPortManTable=sfpPortManTable, laserTemperatureLowThreshold=laserTemperatureLowThreshold, monRamBytesFree=monRamBytesFree, laserTxPower=laserTxPower, monPortErrors=monPortErrors, monPortsEntry=monPortsEntry, monPortCRCErr=monPortCRCErr, prvtSysMonObjects=prvtSysMonObjects, sysMonConfig=sysMonConfig, laserPortThresholdTable=laserPortThresholdTable, ramFreeSpaceExceeded=ramFreeSpaceExceeded, portsBroadcastExceeded=portsBroadcastExceeded, sfpMonStatusChanged=sfpMonStatusChanged, sfpPN=sfpPN, monPortRunts=monPortRunts, laserPortValueTable=laserPortValueTable, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, cpuUtilizationExceeded=cpuUtilizationExceeded, sfpVendor=sfpVendor, sysMonEnable=sysMonEnable, monPortsTable=monPortsTable, portsRuntsExceeded=portsRuntsExceeded, sysMonConfigTable=sysMonConfigTable, PYSNMP_MODULE_ID=prvtSysMonMib, EnableStatus=EnableStatus, portsOverSizeExceeded=portsOverSizeExceeded, prvtSysMonNotifications=prvtSysMonNotifications, portsCRCErrThreshold=portsCRCErrThreshold, sfpMonStatus=sfpMonStatus, portsBroadcastThreshold=portsBroadcastThreshold, laserRxPowerLowThreshold=laserRxPowerLowThreshold, sfpLenght=sfpLenght, sysMonDefaults=sysMonDefaults, laserTemperature=laserTemperature, laserTxPowerLowThreshold=laserTxPowerLowThreshold, portErrorsThreshold=portErrorsThreshold)
