...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", portsRuntsThreshold=portsRuntsThreshold, portErrorsExceeded=portErrorsExceeded, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sfpPN=sfpPN, sfpPortManTable=sfpPortManTable, prvtSysMonObjects=prvtSysMonObjects, sfpConnector=sfpConnector, sysMonTrap=sysMonTrap, portsCRCErrThreshold=portsCRCErrThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, portsBroadcastExceeded=portsBroadcastExceeded, sysMonThreshold=sysMonThreshold, monPortOverSize=monPortOverSize, monPortBroadcast=monPortBroadcast, monPortRunts=monPortRunts, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonEnable=sysMonEnable, sfpVendor=sfpVendor, prvtSysMonConformance=prvtSysMonConformance, sysMonLog=sysMonLog, sysMonNotificationGroup=sysMonNotificationGroup, sysMonIndicator=sysMonIndicator, sysMonConfigTable=sysMonConfigTable, PYSNMP_MODULE_ID=prvtSysMonMib, software=software, portsOverSizeThreshold=portsOverSizeThreshold, cpuUtilizationExceeded=cpuUtilizationExceeded, portsRuntsExceeded=portsRuntsExceeded, sfpPortManEntry=sfpPortManEntry, laserRxPower=laserRxPower, sfpLenght=sfpLenght, portErrorsThreshold=portErrorsThreshold, laserTxPower=laserTxPower, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, monPortsEntry=monPortsEntry, sysMonPeriod=sysMonPeriod, prvtSysMonMib=prvtSysMonMib, sysMonLed=sysMonLed, monPortErrors=monPortErrors, laserTemperature=laserTemperature, sysMonValues=sysMonValues, portsOverSizeExceeded=portsOverSizeExceeded, prvtSysMonNotifications=prvtSysMonNotifications, sfpStatus=sfpStatus, sysMonDefaults=sysMonDefaults, laserPortValueEntry=laserPortValueEntry, portsCRCErrExceeded=portsCRCErrExceeded, sfpMonStatus=sfpMonStatus, monPortsTable=monPortsTable, laserTemperatureHighThreshold=laserTemperatureHighThreshold, ramBytesFreeThreshold=ramBytesFreeThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, laserRxPowerHighThreshold=laserRxPowerHighThreshold, EnableStatus=EnableStatus, sysMonMIBGroups=sysMonMIBGroups, portsBroadcastThreshold=portsBroadcastThreshold, sfpRevision=sfpRevision, monPortCRCErr=monPortCRCErr, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, laserPortThresholdTable=laserPortThresholdTable, sysMonConfig=sysMonConfig, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, laserRxPowerLowThreshold=laserRxPowerLowThreshold, monRamBytesFree=monRamBytesFree, sysMonConfigEntry=sysMonConfigEntry, laserPortValueTable=laserPortValueTable, monCpuUtilization=monCpuUtilization, laserTxPowerLowThreshold=laserTxPowerLowThreshold, laserPortThresholdEntry=laserPortThresholdEntry, sfpMonStatusChanged=sfpMonStatusChanged)
