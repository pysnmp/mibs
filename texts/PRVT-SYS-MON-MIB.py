...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", laserTemperatureLowThreshold=laserTemperatureLowThreshold, prvtSysMonMib=prvtSysMonMib, portErrorsThreshold=portErrorsThreshold, sysMonTrap=sysMonTrap, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserTemperature=laserTemperature, portsBroadcastThreshold=portsBroadcastThreshold, portsOverSizeThreshold=portsOverSizeThreshold, laserPortValueTable=laserPortValueTable, EnableStatus=EnableStatus, laserRxPower=laserRxPower, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sysMonEnable=sysMonEnable, laserPortValueEntry=laserPortValueEntry, laserPortThresholdEntry=laserPortThresholdEntry, PYSNMP_MODULE_ID=prvtSysMonMib, portsRuntsThreshold=portsRuntsThreshold, monPortCRCErr=monPortCRCErr, sysMonIndicator=sysMonIndicator, monRamBytesFree=monRamBytesFree, portsBroadcastExceeded=portsBroadcastExceeded, cpuUtilizationExceeded=cpuUtilizationExceeded, portErrorsExceeded=portErrorsExceeded, monPortOverSize=monPortOverSize, sfpStatus=sfpStatus, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonDefaults=sysMonDefaults, sfpPN=sfpPN, sysMonLed=sysMonLed, portsCRCErrThreshold=portsCRCErrThreshold, sfpLenght=sfpLenght, portsCRCErrExceeded=portsCRCErrExceeded, sfpPortManTable=sfpPortManTable, laserTxPowerLowThreshold=laserTxPowerLowThreshold, sfpMonStatusChanged=sfpMonStatusChanged, prvtSysMonObjects=prvtSysMonObjects, monPortRunts=monPortRunts, laserRxPowerLowThreshold=laserRxPowerLowThreshold, sfpMonStatus=sfpMonStatus, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonConfigTable=sysMonConfigTable, sysMonValues=sysMonValues, laserPortThresholdTable=laserPortThresholdTable, monPortsTable=monPortsTable, software=software, portsRuntsExceeded=portsRuntsExceeded, prvtSysMonNotifications=prvtSysMonNotifications, sysMonMIBGroups=sysMonMIBGroups, cpuUtilizationThreshold=cpuUtilizationThreshold, sfpVendor=sfpVendor, monPortsEntry=monPortsEntry, sysMonNotificationGroup=sysMonNotificationGroup, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sfpRevision=sfpRevision, laserTxPower=laserTxPower, sysMonLog=sysMonLog, sfpPortManEntry=sfpPortManEntry, laserTxPowerHighThreshold=laserTxPowerHighThreshold, monPortBroadcast=monPortBroadcast, monPortErrors=monPortErrors, sysMonConfig=sysMonConfig, prvtSysMonConformance=prvtSysMonConformance, sysMonConfigEntry=sysMonConfigEntry, sysMonThreshold=sysMonThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, portsOverSizeExceeded=portsOverSizeExceeded, laserTemperatureHighThreshold=laserTemperatureHighThreshold, sfpConnector=sfpConnector, sysMonPeriod=sysMonPeriod, monCpuUtilization=monCpuUtilization)
