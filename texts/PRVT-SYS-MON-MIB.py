...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", laserPortThresholdEntry=laserPortThresholdEntry, monPortOverSize=monPortOverSize, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, portsOverSizeExceeded=portsOverSizeExceeded, monPortsTable=monPortsTable, laserPortValueTable=laserPortValueTable, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sfpLenght=sfpLenght, sysMonConfigEntry=sysMonConfigEntry, EnableStatus=EnableStatus, sysMonNotificationGroup=sysMonNotificationGroup, monPortRunts=monPortRunts, portsRuntsThreshold=portsRuntsThreshold, sfpPortManTable=sfpPortManTable, sysMonMIBGroups=sysMonMIBGroups, portsBroadcastExceeded=portsBroadcastExceeded, monPortErrors=monPortErrors, prvtSysMonNotifications=prvtSysMonNotifications, sfpVendor=sfpVendor, sysMonPeriod=sysMonPeriod, sysMonLed=sysMonLed, laserRxPower=laserRxPower, sysMonTrap=sysMonTrap, sfpMonStatus=sfpMonStatus, sfpPortManEntry=sfpPortManEntry, sysMonIndicator=sysMonIndicator, portsCRCErrExceeded=portsCRCErrExceeded, sysMonEnable=sysMonEnable, sfpMonStatusChanged=sfpMonStatusChanged, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonValues=sysMonValues, monPortsEntry=monPortsEntry, sysMonLog=sysMonLog, sysMonThreshold=sysMonThreshold, monPortCRCErr=monPortCRCErr, sfpPN=sfpPN, prvtSysMonObjects=prvtSysMonObjects, monCpuUtilization=monCpuUtilization, sysMonConfigTable=sysMonConfigTable, laserTxPowerHighThreshold=laserTxPowerHighThreshold, sfpRevision=sfpRevision, cpuUtilizationExceeded=cpuUtilizationExceeded, laserRxPowerHighThreshold=laserRxPowerHighThreshold, monRamBytesFree=monRamBytesFree, ramFreeSpaceExceeded=ramFreeSpaceExceeded, prvtSysMonMib=prvtSysMonMib, sfpStatus=sfpStatus, PYSNMP_MODULE_ID=prvtSysMonMib, software=software, portErrorsExceeded=portErrorsExceeded, sysMonConfig=sysMonConfig, sysMonDefaults=sysMonDefaults, portsBroadcastThreshold=portsBroadcastThreshold, portsOverSizeThreshold=portsOverSizeThreshold, laserRxPowerLowThreshold=laserRxPowerLowThreshold, portsCRCErrThreshold=portsCRCErrThreshold, laserPortThresholdTable=laserPortThresholdTable, monPortBroadcast=monPortBroadcast, laserTemperature=laserTemperature, laserTxPower=laserTxPower, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, laserTxPowerLowThreshold=laserTxPowerLowThreshold, portsRuntsExceeded=portsRuntsExceeded, cpuUtilizationThreshold=cpuUtilizationThreshold, portErrorsThreshold=portErrorsThreshold, sfpConnector=sfpConnector, laserPortValueEntry=laserPortValueEntry, prvtSysMonConformance=prvtSysMonConformance, laserTemperatureHighThreshold=laserTemperatureHighThreshold)
