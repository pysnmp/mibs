...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", monPortErrors=monPortErrors, sfpLenght=sfpLenght, portErrorsExceeded=portErrorsExceeded, sysMonConfig=sysMonConfig, portsCRCErrThreshold=portsCRCErrThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sysMonDefaults=sysMonDefaults, sysMonConfigTable=sysMonConfigTable, sfpRevision=sfpRevision, software=software, laserPortThresholdEntry=laserPortThresholdEntry, laserTxPowerLowThreshold=laserTxPowerLowThreshold, portsOverSizeThreshold=portsOverSizeThreshold, laserRxPowerLowThreshold=laserRxPowerLowThreshold, cpuUtilizationExceeded=cpuUtilizationExceeded, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, portErrorsThreshold=portErrorsThreshold, sysMonValues=sysMonValues, PYSNMP_MODULE_ID=prvtSysMonMib, laserPortThresholdTable=laserPortThresholdTable, monCpuUtilization=monCpuUtilization, ramBytesFreeThreshold=ramBytesFreeThreshold, sysMonIndicator=sysMonIndicator, EnableStatus=EnableStatus, sysMonThreshold=sysMonThreshold, prvtSysMonNotifications=prvtSysMonNotifications, monPortBroadcast=monPortBroadcast, monPortCRCErr=monPortCRCErr, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, portsRuntsThreshold=portsRuntsThreshold, portsBroadcastThreshold=portsBroadcastThreshold, laserTxPowerHighThreshold=laserTxPowerHighThreshold, monPortRunts=monPortRunts, laserTemperatureLowThreshold=laserTemperatureLowThreshold, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monPortOverSize=monPortOverSize, laserTemperature=laserTemperature, sfpPortManEntry=sfpPortManEntry, sysMonConfigEntry=sysMonConfigEntry, sfpStatus=sfpStatus, prvtSysMonConformance=prvtSysMonConformance, laserRxPower=laserRxPower, laserPortValueEntry=laserPortValueEntry, laserRxPowerHighThreshold=laserRxPowerHighThreshold, sysMonMIBGroups=sysMonMIBGroups, portsOverSizeExceeded=portsOverSizeExceeded, cpuUtilizationThreshold=cpuUtilizationThreshold, sysMonTrap=sysMonTrap, portsCRCErrExceeded=portsCRCErrExceeded, sfpPortManTable=sfpPortManTable, sysMonLed=sysMonLed, sysMonLog=sysMonLog, sysMonNotificationGroup=sysMonNotificationGroup, sysMonEnable=sysMonEnable, portsBroadcastExceeded=portsBroadcastExceeded, monPortsTable=monPortsTable, sfpVendor=sfpVendor, sfpMonStatus=sfpMonStatus, monPortsEntry=monPortsEntry, prvtSysMonMib=prvtSysMonMib, laserPortValueTable=laserPortValueTable, sysMonPeriod=sysMonPeriod, laserTxPower=laserTxPower, sfpMonStatusChanged=sfpMonStatusChanged, monRamBytesFree=monRamBytesFree, portsRuntsExceeded=portsRuntsExceeded, prvtSysMonObjects=prvtSysMonObjects, sfpConnector=sfpConnector, sfpPN=sfpPN)
