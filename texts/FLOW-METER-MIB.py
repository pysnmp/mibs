...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: flowMIB.setRevisionsDescriptions(('Initial Version, published as RFC 2720.', 'UTF8OwnerString Textual Convention added, and used to\n         replace OwnerString.  Conceptually the same as OwnerString,\n         but facilitating internationalisation by using UTF-8\n         encoding for its characters rather than US-ASCII.', 'Changes to SIZE specification for two variables:\n          - flowRuleInfoName SIZE specified as (0..127)\n          - flowRuleIndex SIZE increased to (1..2147483647)', 'Two further variables deprecated:\n          - flowRuleInfoRulesReady (use flowRuleInfoStatus intead)\n          - flowDataStatus (contains no useful information)', 'Significant changes since RFC 2064 include:\n          - flowDataPackageTable added\n          - flowColumnActivityTable deprecated\n          - flowManagerCounterWrap deprecated', 'Initial version of this MIB (RFC 2064)',))
