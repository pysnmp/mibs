...
ModuleIdentity, NotificationType, Gauge32, Counter32, MibIdentifier, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, TimeTicks, Bits, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "MibIdentifier", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "TimeTicks", "Bits", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", hardwareFailureDone=hardwareFailureDone, peakflowSPTraps=peakflowSPTraps, spMitigationName=spMitigationName, configChange=configChange, spLicenseErrType=spLicenseErrType, bgpHijack=bgpHijack, spUsageType=spUsageType, spLicenseErrLimit=spLicenseErrLimit, mitigationDone=mitigationDone, spFlowspecCommunity=spFlowspecCommunity, spBlackholeTimeout=spBlackholeTimeout, spReportID=spReportID, spUsername=spUsername, spcommFailureDone=spcommFailureDone, peakflowSPCMI=peakflowSPCMI, spHijackAttr=spHijackAttr, spManagedObjectFamily=spManagedObjectFamily, spServiceElement=spServiceElement, bgpInstability=bgpInstability, spRouter=spRouter, spServiceName=spServiceName, hardwareFailure=hardwareFailure, spThirdPartyZone=spThirdPartyZone, spScriptPort=spScriptPort, spMitigationID=spMitigationID, snmpUp=snmpUp, spVersion=spVersion, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, reportDone=reportDone, spUnit=spUnit, flowDown=flowDown, spBlackholePrefix=spBlackholePrefix, spBGPInstability=spBGPInstability, spFingerprintName=spFingerprintName, serviceUsageDone=serviceUsageDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spCollector=spCollector, spTMSCommunity=spTMSCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceHealth=deviceHealth, devicePhysicalMemory=devicePhysicalMemory, collectorUp=collectorUp, interfaceUsageDone=interfaceUsageDone, spDuration=spDuration, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spScriptCommand=spScriptCommand, spFlowspecTimeout=spFlowspecTimeout, managedObjectUsage=managedObjectUsage, fingerprintFeedback=fingerprintFeedback, routingFailover=routingFailover, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, serviceUsage=serviceUsage, spInterfaceIndex=spInterfaceIndex, spThreshold=spThreshold, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceTotalFlowsHC=deviceTotalFlowsHC, spDNSExpected=spDNSExpected, alertScript=alertScript, spDNSObserved=spDNSObserved, spInetAddressType=spInetAddressType, spHardwareFailureDescription=spHardwareFailureDescription, licenseErrorDone=licenseErrorDone, spFingerprintMessage=spFingerprintMessage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spcommFailure=spcommFailure, spFingerprintFeedback=spFingerprintFeedback, greDown=greDown, collectorStart=collectorStart, mitigationBlackholeStart=mitigationBlackholeStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spImpactBps=spImpactBps, spGreTunnelName=spGreTunnelName, peakflowSPMgr=peakflowSPMgr, bgpDown=bgpDown, snmpDown=snmpDown, spManagedObject=spManagedObject, greDownDone=greDownDone, spScriptHost=spScriptHost, flowUp=flowUp, trafficAutoMitigation=trafficAutoMitigation, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPEvent=spBGPEvent, spInterfaceUsage=spInterfaceUsage, spImpactPps=spImpactPps, managedObjectUsageDone=managedObjectUsageDone, mitigationTMSStart=mitigationTMSStart, spUsage=spUsage, spHijackRoute=spHijackRoute, cloudSignalingFault=cloudSignalingFault, spDetectedCountries=spDetectedCountries, deviceDiskUsage=deviceDiskUsage, spBlackholeNexthop=spBlackholeNexthop, spDetector=spDetector, spSystemErrorType=spSystemErrorType, mitigationFlowspecStart=mitigationFlowspecStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPMIB=peakflowSPMIB, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrDescription=spLicenseErrDescription, spBGPTrapEvent=spBGPTrapEvent, spReportURL=spReportURL, spThirdPartyAddr=spThirdPartyAddr, deviceSystemErrorDone=deviceSystemErrorDone, spTMSTimeout=spTMSTimeout, spApplicationName=spApplicationName, PYSNMP_MODULE_ID=peakflowSPMIB, licenseError=licenseError, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spMitigationStart=spMitigationStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spLicenseErrCount=spLicenseErrCount, spDNSObservedMean=spDNSObservedMean, deviceSystemError=deviceSystemError, spTMSPrefix=spTMSPrefix, spDNSName=spDNSName, spInterface=spInterface, spInterfaceUsageHC=spInterfaceUsageHC, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spAlertID=spAlertID, deviceSwapSpace=deviceSwapSpace, fingerprintUsage=fingerprintUsage, spGreTunnelDestination=spGreTunnelDestination, spScriptStart=spScriptStart, spBGPTrapName=spBGPTrapName, deviceTotalFlows=deviceTotalFlows, bgpUp=bgpUp, mitigationThirdPartyStart=mitigationThirdPartyStart, spFingerprintSender=spFingerprintSender, spCommFailureDescription=spCommFailureDescription, fingerprintUsageDone=fingerprintUsageDone, bgpTrap=bgpTrap, spBlackholeCommunity=spBlackholeCommunity, spCloudSignalFaultDescription=spCloudSignalFaultDescription, autoclassifyStart=autoclassifyStart, spSystemErrorDescription=spSystemErrorDescription, spInetAddress=spInetAddress, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, notificationLimit=notificationLimit, spCommFailureDestination=spCommFailureDestination, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpInstabilityDone=bgpInstabilityDone, dnsBaseline=dnsBaseline, dnsBaselineDone=dnsBaselineDone, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObservedMax=spDNSObservedMax, spManagedObjects=spManagedObjects, spBGPTrapPrefix=spBGPTrapPrefix, dosHostDetectionAlert=dosHostDetectionAlert, spReportName=spReportName, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, collectorDown=collectorDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spInterfaceSpeed=spInterfaceSpeed, fingerprintReceive=fingerprintReceive, spHijackLocal=spHijackLocal, spPravail=spPravail, interfaceUsage=interfaceUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone)
