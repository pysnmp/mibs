...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso, MibIdentifier, Gauge32, TimeTicks, Bits, ObjectIdentity, Counter32, NotificationType, IpAddress, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso", "MibIdentifier", "Gauge32", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spAlertID=spAlertID, alertScript=alertScript, bgpHijack=bgpHijack, spBlackholeTimeout=spBlackholeTimeout, spBlackholeNexthop=spBlackholeNexthop, collectorStart=collectorStart, managedObjectUsage=managedObjectUsage, spDNSObserved=spDNSObserved, spHijackRoute=spHijackRoute, fingerprintUsage=fingerprintUsage, deviceSwapSpace=deviceSwapSpace, spBGPTrapEvent=spBGPTrapEvent, spInterfaceUsage=spInterfaceUsage, greDownDone=greDownDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spRouter=spRouter, spDNSExpected=spDNSExpected, routingFailover=routingFailover, spUsername=spUsername, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spcommFailureDone=spcommFailureDone, managedObjectUsageDone=managedObjectUsageDone, spGreTunnelName=spGreTunnelName, spSystemErrorDescription=spSystemErrorDescription, spMitigationName=spMitigationName, spInetAddress=spInetAddress, spFlowspecTimeout=spFlowspecTimeout, spInterfaceIndex=spInterfaceIndex, spTMSPrefix=spTMSPrefix, collectorUp=collectorUp, spTMSTimeout=spTMSTimeout, spCommFailureDescription=spCommFailureDescription, fingerprintReceive=fingerprintReceive, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSystemError=deviceSystemError, spScriptHost=spScriptHost, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, interfaceUsageDone=interfaceUsageDone, snmpDown=snmpDown, spBlackholePrefix=spBlackholePrefix, deviceHealth=deviceHealth, snmpUp=snmpUp, dosHostDetectionAlertDone=dosHostDetectionAlertDone, licenseErrorDone=licenseErrorDone, spReportName=spReportName, spScriptPort=spScriptPort, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInterfaceSpeed=spInterfaceSpeed, spFingerprintName=spFingerprintName, serviceUsageDone=serviceUsageDone, spCommFailureDestination=spCommFailureDestination, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spMitigationStart=spMitigationStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSCommunity=spTMSCommunity, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, bgpInstabilityDone=bgpInstabilityDone, spApplicationName=spApplicationName, peakflowSPMgr=peakflowSPMgr, spBGPTrapName=spBGPTrapName, spDuration=spDuration, spHardwareFailureDescription=spHardwareFailureDescription, spMitigationID=spMitigationID, spBGPInstability=spBGPInstability, collectorDown=collectorDown, spcommFailure=spcommFailure, spDNSObservedMax=spDNSObservedMax, spReportID=spReportID, spDetectedCountries=spDetectedCountries, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterfaceUsageHC=spInterfaceUsageHC, dnsBaselineDone=dnsBaselineDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDNSObservedMean=spDNSObservedMean, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapPrefix=spBGPTrapPrefix, spSystemErrorType=spSystemErrorType, spGreTunnelDestination=spGreTunnelDestination, spScriptCommand=spScriptCommand, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsage=spUsage, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintUsageDone=fingerprintUsageDone, peakflowSPTraps=peakflowSPTraps, spFingerprintSender=spFingerprintSender, licenseError=licenseError, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrType=spLicenseErrType, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, mitigationTMSStart=mitigationTMSStart, spBGPTrapOldAttributes=spBGPTrapOldAttributes, fingerprintFeedback=fingerprintFeedback, spReportURL=spReportURL, spHijackAttr=spHijackAttr, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationFlowspecStart=mitigationFlowspecStart, spImpactPps=spImpactPps, spFlowspecCommunity=spFlowspecCommunity, flowDown=flowDown, spServiceElement=spServiceElement, devicePhysicalMemory=devicePhysicalMemory, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpUp=bgpUp, spBGPTrapNewAttributes=spBGPTrapNewAttributes, mitigationTMSStartV2=mitigationTMSStartV2, autoclassifyStart=autoclassifyStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spManagedObject=spManagedObject, flowUp=flowUp, spBlackholeCommunity=spBlackholeCommunity, spVersion=spVersion, spFingerprintFeedback=spFingerprintFeedback, spDetector=spDetector, spLicenseErrCount=spLicenseErrCount, spInterface=spInterface, serviceUsage=serviceUsage, spDNSName=spDNSName, spCollector=spCollector, spLicenseErrLimit=spLicenseErrLimit, spInetAddressType=spInetAddressType, mitigationDone=mitigationDone, notificationLimit=notificationLimit, spUsageType=spUsageType, spImpactBps=spImpactBps, peakflowSPCMI=peakflowSPCMI, spThirdPartyAddr=spThirdPartyAddr, spFingerprintMessage=spFingerprintMessage, peakflowSPMIB=peakflowSPMIB, deviceDiskUsage=deviceDiskUsage, configChange=configChange, spScriptStart=spScriptStart, dnsBaseline=dnsBaseline, mitigationBlackholeStart=mitigationBlackholeStart, spManagedObjectFamily=spManagedObjectFamily, bgpDown=bgpDown, bgpInstability=bgpInstability, spUnit=spUnit, dosHostDetectionAlert=dosHostDetectionAlert, spManagedObjects=spManagedObjects, spInterfaceSpeedHC=spInterfaceSpeedHC, spThreshold=spThreshold, spPravail=spPravail, spBGPEvent=spBGPEvent, interfaceUsage=interfaceUsage, hardwareFailureDone=hardwareFailureDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spThirdPartyZone=spThirdPartyZone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrDescription=spLicenseErrDescription, bgpTrap=bgpTrap, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, greDown=greDown, spServiceName=spServiceName, reportDone=reportDone, hardwareFailure=hardwareFailure, cloudSignalingFault=cloudSignalingFault, deviceTotalFlowsHC=deviceTotalFlowsHC, trafficAutoMitigation=trafficAutoMitigation, spHijackLocal=spHijackLocal, deviceTotalFlows=deviceTotalFlows)
