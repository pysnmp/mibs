...
MibIdentifier, TimeTicks, Counter32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, iso, NotificationType, Integer32, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Counter32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "iso", "NotificationType", "Integer32", "Bits", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spFlowspecTimeout=spFlowspecTimeout, snmpDown=snmpDown, spReportID=spReportID, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPMgr=peakflowSPMgr, spCommFailureDescription=spCommFailureDescription, spThreshold=spThreshold, mitigationThirdPartyStart=mitigationThirdPartyStart, spHijackRoute=spHijackRoute, hardwareFailureDone=hardwareFailureDone, spReportURL=spReportURL, bgpHijack=bgpHijack, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceSwapSpace=deviceSwapSpace, spUnit=spUnit, deviceHealth=deviceHealth, spReportName=spReportName, spBlackholeNexthop=spBlackholeNexthop, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceTotalFlowsHC=deviceTotalFlowsHC, notificationLimit=notificationLimit, spScriptStart=spScriptStart, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObjects=spManagedObjects, interfaceUsage=interfaceUsage, fingerprintUsage=fingerprintUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, flowDown=flowDown, deviceSystemError=deviceSystemError, fingerprintFeedback=fingerprintFeedback, spcommFailureDone=spcommFailureDone, licenseErrorDone=licenseErrorDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, greDownDone=greDownDone, spInterfaceUsageHC=spInterfaceUsageHC, spDNSName=spDNSName, spCommFailureDestination=spCommFailureDestination, spCloudSignalFaultDescription=spCloudSignalFaultDescription, serviceUsageDone=serviceUsageDone, spCollector=spCollector, spTMSPrefix=spTMSPrefix, bgpInstability=bgpInstability, spLicenseErrCount=spLicenseErrCount, spBGPInstability=spBGPInstability, spLicenseErrDescription=spLicenseErrDescription, spManagedObject=spManagedObject, spDetector=spDetector, deviceSystemErrorDone=deviceSystemErrorDone, greDown=greDown, collectorUp=collectorUp, spBlackholeCommunity=spBlackholeCommunity, routingFailover=routingFailover, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spLicenseErrLimit=spLicenseErrLimit, peakflowSPCMI=peakflowSPCMI, mitigationTMSStart=mitigationTMSStart, spInterfaceIndex=spInterfaceIndex, dnsBaseline=dnsBaseline, spHijackAttr=spHijackAttr, collectorStart=collectorStart, spApplicationName=spApplicationName, spManagedObjectFamily=spManagedObjectFamily, spInetAddress=spInetAddress, PYSNMP_MODULE_ID=peakflowSPMIB, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintName=spFingerprintName, peakflowSPMIB=peakflowSPMIB, flowUp=flowUp, spHardwareFailureDescription=spHardwareFailureDescription, spScriptCommand=spScriptCommand, spScriptHost=spScriptHost, alertScript=alertScript, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, cloudSignalingFault=cloudSignalingFault, spScriptPort=spScriptPort, deviceTotalFlows=deviceTotalFlows, dosNetworkProfiledAlert=dosNetworkProfiledAlert, dnsBaselineDone=dnsBaselineDone, serviceUsage=serviceUsage, spDNSObservedMax=spDNSObservedMax, spGreTunnelDestination=spGreTunnelDestination, mitigationTMSStartV2=mitigationTMSStartV2, spHijackLocal=spHijackLocal, spTMSTimeout=spTMSTimeout, spBGPTrapPrefix=spBGPTrapPrefix, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrType=spLicenseErrType, spInetAddressType=spInetAddressType, managedObjectUsageDone=managedObjectUsageDone, spSystemErrorType=spSystemErrorType, spRouter=spRouter, spThirdPartyAddr=spThirdPartyAddr, spDNSObservedMean=spDNSObservedMean, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spAlertDetectionSignatures=spAlertDetectionSignatures, spVersion=spVersion, peakflowSPTraps=peakflowSPTraps, fingerprintReceive=fingerprintReceive, spInterfaceSpeed=spInterfaceSpeed, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spFingerprintFeedback=spFingerprintFeedback, spFingerprintSender=spFingerprintSender, spFingerprintMessage=spFingerprintMessage, spUsername=spUsername, configChange=configChange, spDetectedCountries=spDetectedCountries, spThirdPartyZone=spThirdPartyZone, deviceDiskUsage=deviceDiskUsage, spAlertID=spAlertID, bgpDown=bgpDown, collectorDown=collectorDown, spBGPTrapName=spBGPTrapName, mitigationDone=mitigationDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, hardwareFailure=hardwareFailure, mitigationBlackholeStart=mitigationBlackholeStart, snmpUp=snmpUp, spServiceName=spServiceName, bgpUp=bgpUp, trafficAutoMitigation=trafficAutoMitigation, fingerprintUsageDone=fingerprintUsageDone, managedObjectUsage=managedObjectUsage, spBlackholeTimeout=spBlackholeTimeout, spcommFailure=spcommFailure, autoclassifyStart=autoclassifyStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsage=spUsage, spBGPTrapEvent=spBGPTrapEvent, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, licenseError=licenseError, spServiceElement=spServiceElement, spInterfaceUsage=spInterfaceUsage, interfaceUsageDone=interfaceUsageDone, bgpInstabilityDone=bgpInstabilityDone, spSystemErrorDescription=spSystemErrorDescription, spGreTunnelName=spGreTunnelName, spImpactPps=spImpactPps, spBlackholePrefix=spBlackholePrefix, spUsageType=spUsageType, dosHostDetectionAlertDone=dosHostDetectionAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spMitigationID=spMitigationID, spFlowspecCommunity=spFlowspecCommunity, spDuration=spDuration, spMitigationName=spMitigationName, spDNSExpected=spDNSExpected, spBGPEvent=spBGPEvent, spImpactBps=spImpactBps, spTMSCommunity=spTMSCommunity, reportDone=reportDone, spDNSObserved=spDNSObserved, spMitigationStart=spMitigationStart, spTMSMultiPrefix=spTMSMultiPrefix, bgpTrap=bgpTrap, devicePhysicalMemory=devicePhysicalMemory, spPravail=spPravail)
