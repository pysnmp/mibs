...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, NotificationType, Counter32, ObjectIdentity, IpAddress, Integer32, Gauge32, ModuleIdentity, Counter64, Bits, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "NotificationType", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "ModuleIdentity", "Counter64", "Bits", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spUnit=spUnit, spScriptStart=spScriptStart, spManagedObjects=spManagedObjects, spFlowspecCommunity=spFlowspecCommunity, autoclassifyStart=autoclassifyStart, spFingerprintFeedback=spFingerprintFeedback, spBlackholeNexthop=spBlackholeNexthop, bgpInstabilityDone=bgpInstabilityDone, collectorUp=collectorUp, spSystemErrorType=spSystemErrorType, spVersion=spVersion, spLicenseErrLimit=spLicenseErrLimit, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjectFamily=spManagedObjectFamily, deviceSystemErrorDone=deviceSystemErrorDone, spHijackAttr=spHijackAttr, spTMSTimeout=spTMSTimeout, peakflowSPMgr=peakflowSPMgr, deviceHealth=deviceHealth, spDNSObservedMax=spDNSObservedMax, spMitigationStart=spMitigationStart, spDetectedCountries=spDetectedCountries, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spGreTunnelDestination=spGreTunnelDestination, flowUp=flowUp, spCollector=spCollector, fingerprintReceive=fingerprintReceive, dnsBaselineDone=dnsBaselineDone, spPravail=spPravail, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, bgpHijack=bgpHijack, reportDone=reportDone, spcommFailureDone=spcommFailureDone, dnsBaseline=dnsBaseline, spReportURL=spReportURL, spBlackholeTimeout=spBlackholeTimeout, spAlertID=spAlertID, spCommFailureDestination=spCommFailureDestination, spManagedObject=spManagedObject, spTMSCommunity=spTMSCommunity, spBGPInstability=spBGPInstability, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSPrefix=spTMSPrefix, spDNSName=spDNSName, configChange=configChange, spBlackholeCommunity=spBlackholeCommunity, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, collectorStart=collectorStart, peakflowSPMIB=peakflowSPMIB, snmpDown=snmpDown, spApplicationName=spApplicationName, spRouter=spRouter, spSystemErrorDescription=spSystemErrorDescription, spInterfaceIndex=spInterfaceIndex, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, serviceUsageDone=serviceUsageDone, spLicenseErrType=spLicenseErrType, alertScript=alertScript, spDNSObserved=spDNSObserved, spBGPTrapEvent=spBGPTrapEvent, dosHostDetectionAlert=dosHostDetectionAlert, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPCMI=peakflowSPCMI, collectorDown=collectorDown, spFingerprintSender=spFingerprintSender, managedObjectUsageDone=managedObjectUsageDone, spUsageType=spUsageType, spLicenseErrCount=spLicenseErrCount, bgpDown=bgpDown, spScriptPort=spScriptPort, spThirdPartyZone=spThirdPartyZone, mitigationThirdPartyStart=mitigationThirdPartyStart, spcommFailure=spcommFailure, spServiceElement=spServiceElement, spScriptHost=spScriptHost, devicePhysicalMemory=devicePhysicalMemory, spFlowspecTimeout=spFlowspecTimeout, spImpactPps=spImpactPps, peakflowSPTraps=peakflowSPTraps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationDone=mitigationDone, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintName=spFingerprintName, spInterface=spInterface, spFingerprintMessage=spFingerprintMessage, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDuration=spDuration, serviceUsage=serviceUsage, cloudSignalingFault=cloudSignalingFault, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapPrefix=spBGPTrapPrefix, spMitigationID=spMitigationID, spServiceName=spServiceName, deviceTotalFlows=deviceTotalFlows, notificationLimit=notificationLimit, spBlackholePrefix=spBlackholePrefix, deviceSystemError=deviceSystemError, PYSNMP_MODULE_ID=peakflowSPMIB, flowDown=flowDown, spThirdPartyAddr=spThirdPartyAddr, mitigationTMSStart=mitigationTMSStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, interfaceUsage=interfaceUsage, routingFailover=routingFailover, spInetAddressType=spInetAddressType, spUsage=spUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spDNSExpected=spDNSExpected, spBGPEvent=spBGPEvent, spImpactBps=spImpactBps, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapOldAttributes=spBGPTrapOldAttributes, bgpTrap=bgpTrap, deviceDiskUsage=deviceDiskUsage, spInetAddress=spInetAddress, spLicenseErrDescription=spLicenseErrDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, greDown=greDown, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptCommand=spScriptCommand, spUsername=spUsername, spInterfaceSpeedHC=spInterfaceSpeedHC, spReportName=spReportName, spThreshold=spThreshold, spReportID=spReportID, hardwareFailure=hardwareFailure, spDNSObservedMean=spDNSObservedMean, spInterfaceUsageHC=spInterfaceUsageHC, spMitigationName=spMitigationName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, bgpInstability=bgpInstability, snmpUp=snmpUp, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpUp=bgpUp, interfaceUsageDone=interfaceUsageDone, licenseError=licenseError, mitigationBlackholeStart=mitigationBlackholeStart, spHijackRoute=spHijackRoute, fingerprintUsage=fingerprintUsage, hardwareFailureDone=hardwareFailureDone, spInterfaceUsage=spInterfaceUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPTrapName=spBGPTrapName, spCommFailureDescription=spCommFailureDescription, greDownDone=greDownDone, spDetector=spDetector, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, trafficAutoMitigation=trafficAutoMitigation, deviceSwapSpace=deviceSwapSpace, spInterfaceSpeed=spInterfaceSpeed, fingerprintFeedback=fingerprintFeedback, licenseErrorDone=licenseErrorDone, spHijackLocal=spHijackLocal, managedObjectUsage=managedObjectUsage, mitigationFlowspecStart=mitigationFlowspecStart, deviceSwapSpaceUsage=deviceSwapSpaceUsage)
