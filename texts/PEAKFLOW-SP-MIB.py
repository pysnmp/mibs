...
Gauge32, Unsigned32, NotificationType, iso, MibIdentifier, Counter64, Integer32, ModuleIdentity, Counter32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "NotificationType", "iso", "MibIdentifier", "Counter64", "Integer32", "ModuleIdentity", "Counter32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spImpactPps=spImpactPps, fingerprintUsageDone=fingerprintUsageDone, mitigationTMSStart=mitigationTMSStart, cloudSignalingFault=cloudSignalingFault, spServiceElement=spServiceElement, spUsageType=spUsageType, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spCollector=spCollector, spInetAddressType=spInetAddressType, mitigationDone=mitigationDone, spcommFailureDone=spcommFailureDone, spDNSName=spDNSName, spMitigationStart=spMitigationStart, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spImpactBps=spImpactBps, spInetAddress=spInetAddress, deviceTotalFlowsHC=deviceTotalFlowsHC, spReportURL=spReportURL, spLicenseErrType=spLicenseErrType, spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPCMI=peakflowSPCMI, deviceSwapSpaceUsage=deviceSwapSpaceUsage, fingerprintFeedback=fingerprintFeedback, spFingerprintSender=spFingerprintSender, spCloudSignalFaultDescription=spCloudSignalFaultDescription, reportDone=reportDone, bgpHijack=bgpHijack, spBGPInstability=spBGPInstability, spBGPTrapPrefix=spBGPTrapPrefix, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSTimeout=spTMSTimeout, spScriptPort=spScriptPort, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterface=spInterface, spFlowspecCommunity=spFlowspecCommunity, spcommFailure=spcommFailure, spDNSExpected=spDNSExpected, spCommFailureDescription=spCommFailureDescription, routingFailover=routingFailover, mitigationFlowspecStart=mitigationFlowspecStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spHardwareFailureDescription=spHardwareFailureDescription, spBGPTrapEvent=spBGPTrapEvent, spAlertID=spAlertID, spSystemErrorType=spSystemErrorType, spGreTunnelDestination=spGreTunnelDestination, deviceSwapSpace=deviceSwapSpace, cloudSignalingFaultDone=cloudSignalingFaultDone, hardwareFailure=hardwareFailure, spFingerprintMessage=spFingerprintMessage, spInterfaceIndex=spInterfaceIndex, spUsage=spUsage, spVersion=spVersion, spUnit=spUnit, serviceUsage=serviceUsage, bgpTrap=bgpTrap, collectorDown=collectorDown, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationID=spMitigationID, spHijackLocal=spHijackLocal, collectorStart=collectorStart, spDNSObservedMean=spDNSObservedMean, spScriptStart=spScriptStart, spManagedObject=spManagedObject, peakflowSPTraps=peakflowSPTraps, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spLicenseErrDescription=spLicenseErrDescription, spUsername=spUsername, spScriptCommand=spScriptCommand, dnsBaseline=dnsBaseline, interfaceUsageDone=interfaceUsageDone, deviceSystemErrorDone=deviceSystemErrorDone, deviceHealth=deviceHealth, dosHostDetectionAlert=dosHostDetectionAlert, spMitigationName=spMitigationName, spServiceName=spServiceName, configChange=configChange, spThreshold=spThreshold, spThirdPartyAddr=spThirdPartyAddr, notificationLimit=notificationLimit, dnsBaselineDone=dnsBaselineDone, spCommFailureDestination=spCommFailureDestination, greDownDone=greDownDone, spHijackRoute=spHijackRoute, spDetector=spDetector, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationBlackholeStart=mitigationBlackholeStart, spDNSObserved=spDNSObserved, spSystemErrorDescription=spSystemErrorDescription, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholePrefix=spBlackholePrefix, mitigationTMSStartV2=mitigationTMSStartV2, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, devicePhysicalMemory=devicePhysicalMemory, spDNSObservedMax=spDNSObservedMax, flowDown=flowDown, spRouter=spRouter, deviceSystemError=deviceSystemError, licenseErrorDone=licenseErrorDone, fingerprintReceive=fingerprintReceive, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, snmpDown=snmpDown, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterfaceSpeed=spInterfaceSpeed, spGreTunnelName=spGreTunnelName, spFlowspecTimeout=spFlowspecTimeout, trafficAutoMitigation=trafficAutoMitigation, spHijackAttr=spHijackAttr, bgpInstabilityDone=bgpInstabilityDone, spManagedObjects=spManagedObjects, spApplicationName=spApplicationName, alertScript=alertScript, spFingerprintFeedback=spFingerprintFeedback, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, serviceUsageDone=serviceUsageDone, spScriptHost=spScriptHost, fingerprintUsage=fingerprintUsage, spBGPEvent=spBGPEvent, spBlackholeCommunity=spBlackholeCommunity, greDown=greDown, collectorUp=collectorUp, spInterfaceUsage=spInterfaceUsage, autoclassifyStart=autoclassifyStart, bgpInstability=bgpInstability, spBGPTrapName=spBGPTrapName, spBlackholeTimeout=spBlackholeTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpUp=bgpUp, bgpDown=bgpDown, spLicenseErrCount=spLicenseErrCount, spManagedObjectFamily=spManagedObjectFamily, spBlackholeNexthop=spBlackholeNexthop, spThirdPartyZone=spThirdPartyZone, spLicenseErrLimit=spLicenseErrLimit, spTMSPrefix=spTMSPrefix, spReportName=spReportName, deviceTotalFlows=deviceTotalFlows, peakflowSPMgr=peakflowSPMgr, spReportID=spReportID, managedObjectUsage=managedObjectUsage, spFingerprintName=spFingerprintName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spDuration=spDuration, flowUp=flowUp, snmpUp=snmpUp, licenseError=licenseError, managedObjectUsageDone=managedObjectUsageDone, peakflowSPMIB=peakflowSPMIB, deviceDiskUsage=deviceDiskUsage, hardwareFailureDone=hardwareFailureDone, spDetectedCountries=spDetectedCountries, interfaceUsage=interfaceUsage, spPravail=spPravail)
