...
Integer32, Gauge32, IpAddress, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, TimeTicks, iso, Bits, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "IpAddress", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "TimeTicks", "iso", "Bits", "NotificationType", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDescription=spCommFailureDescription, notificationLimit=notificationLimit, mitigationThirdPartyStart=mitigationThirdPartyStart, spThreshold=spThreshold, spLicenseErrType=spLicenseErrType, licenseError=licenseError, spScriptCommand=spScriptCommand, spGreTunnelName=spGreTunnelName, fingerprintFeedback=fingerprintFeedback, managedObjectUsageDone=managedObjectUsageDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInetAddress=spInetAddress, spDNSObservedMean=spDNSObservedMean, spFlowspecTimeout=spFlowspecTimeout, interfaceUsage=interfaceUsage, spScriptHost=spScriptHost, mitigationDone=mitigationDone, cloudSignalingFault=cloudSignalingFault, spFingerprintSender=spFingerprintSender, spReportURL=spReportURL, spUsage=spUsage, spTMSPrefix=spTMSPrefix, dnsBaseline=dnsBaseline, spRouter=spRouter, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spManagedObjects=spManagedObjects, deviceHealth=deviceHealth, managedObjectUsage=managedObjectUsage, deviceDiskUsage=deviceDiskUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, serviceUsageDone=serviceUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, greDown=greDown, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingFaultDone=cloudSignalingFaultDone, spThirdPartyAddr=spThirdPartyAddr, fingerprintUsageDone=fingerprintUsageDone, devicePhysicalMemory=devicePhysicalMemory, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spcommFailure=spcommFailure, spSystemErrorDescription=spSystemErrorDescription, routingFailover=routingFailover, spScriptStart=spScriptStart, spImpactBps=spImpactBps, spReportID=spReportID, collectorDown=collectorDown, spBGPInstability=spBGPInstability, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spHijackAttr=spHijackAttr, spDNSObservedMax=spDNSObservedMax, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spSystemErrorType=spSystemErrorType, hardwareFailureDone=hardwareFailureDone, spHardwareFailureDescription=spHardwareFailureDescription, spCommFailureDestination=spCommFailureDestination, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spReportName=spReportName, serviceUsage=serviceUsage, spBGPTrapPrefix=spBGPTrapPrefix, flowDown=flowDown, spThirdPartyZone=spThirdPartyZone, bgpHijack=bgpHijack, spInterfaceUsage=spInterfaceUsage, spTMSCommunity=spTMSCommunity, deviceSwapSpace=deviceSwapSpace, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spVersion=spVersion, spFingerprintName=spFingerprintName, spBGPTrapEvent=spBGPTrapEvent, spDuration=spDuration, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spMitigationID=spMitigationID, spDetectedCountries=spDetectedCountries, spAlertDetectionSignatures=spAlertDetectionSignatures, spFingerprintFeedback=spFingerprintFeedback, deviceSystemError=deviceSystemError, spInterfaceSpeedHC=spInterfaceSpeedHC, spFlowspecCommunity=spFlowspecCommunity, reportDone=reportDone, spBlackholeCommunity=spBlackholeCommunity, spGreTunnelDestination=spGreTunnelDestination, spInterfaceUsageHC=spInterfaceUsageHC, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpUp=bgpUp, bgpDown=bgpDown, spScriptPort=spScriptPort, spBGPEvent=spBGPEvent, spInetAddressType=spInetAddressType, bgpInstabilityDone=bgpInstabilityDone, spBlackholePrefix=spBlackholePrefix, spHijackRoute=spHijackRoute, spManagedObjectFamily=spManagedObjectFamily, autoclassifyStart=autoclassifyStart, PYSNMP_MODULE_ID=peakflowSPMIB, spCollector=spCollector, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPCMI=peakflowSPCMI, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationFlowspecStart=mitigationFlowspecStart, configChange=configChange, collectorStart=collectorStart, spUsername=spUsername, bgpTrap=bgpTrap, peakflowSPMgr=peakflowSPMgr, spMitigationName=spMitigationName, deviceTotalFlows=deviceTotalFlows, spAlertID=spAlertID, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spDNSObserved=spDNSObserved, spServiceElement=spServiceElement, fingerprintUsage=fingerprintUsage, spPravail=spPravail, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, interfaceUsageDone=interfaceUsageDone, spTMSTimeout=spTMSTimeout, spDetector=spDetector, hardwareFailure=hardwareFailure, spcommFailureDone=spcommFailureDone, spDNSName=spDNSName, snmpUp=snmpUp, spMitigationStart=spMitigationStart, bgpInstability=bgpInstability, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dnsBaselineDone=dnsBaselineDone, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPMIB=peakflowSPMIB, spTMSMultiPrefix=spTMSMultiPrefix, greDownDone=greDownDone, spBlackholeNexthop=spBlackholeNexthop, fingerprintReceive=fingerprintReceive, spLicenseErrCount=spLicenseErrCount, collectorUp=collectorUp, licenseErrorDone=licenseErrorDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, peakflowSPTraps=peakflowSPTraps, spFingerprintMessage=spFingerprintMessage, spDNSExpected=spDNSExpected, mitigationTMSStart=mitigationTMSStart, snmpDown=snmpDown, spInterfaceSpeed=spInterfaceSpeed, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapName=spBGPTrapName, spImpactPps=spImpactPps, alertScript=alertScript, spLicenseErrLimit=spLicenseErrLimit, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObject=spManagedObject, spInterface=spInterface, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHijackLocal=spHijackLocal, trafficAutoMitigation=trafficAutoMitigation, spUsageType=spUsageType, spUnit=spUnit, spApplicationName=spApplicationName, flowUp=flowUp, spInterfaceIndex=spInterfaceIndex, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spServiceName=spServiceName)
