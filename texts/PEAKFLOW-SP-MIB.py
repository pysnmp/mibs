...
NotificationType, Unsigned32, ModuleIdentity, MibIdentifier, Counter32, iso, Counter64, Integer32, Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter32", "iso", "Counter64", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", fingerprintUsage=fingerprintUsage, spMitigationStart=spMitigationStart, reportDone=reportDone, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPTraps=peakflowSPTraps, spCommFailureDescription=spCommFailureDescription, spcommFailureDone=spcommFailureDone, spThreshold=spThreshold, spImpactPps=spImpactPps, spGreTunnelName=spGreTunnelName, spInterfaceIndex=spInterfaceIndex, spManagedObject=spManagedObject, autoclassifyStart=autoclassifyStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, collectorDown=collectorDown, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterfaceUsage=spInterfaceUsage, spTMSTimeout=spTMSTimeout, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSName=spDNSName, spBlackholeNexthop=spBlackholeNexthop, spBlackholePrefix=spBlackholePrefix, spRouter=spRouter, spManagedObjectFamily=spManagedObjectFamily, bgpDown=bgpDown, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spGreTunnelDestination=spGreTunnelDestination, spInterfaceSpeed=spInterfaceSpeed, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spDetectedCountries=spDetectedCountries, spLicenseErrCount=spLicenseErrCount, bgpUp=bgpUp, managedObjectUsage=managedObjectUsage, spBGPEvent=spBGPEvent, spUnit=spUnit, hardwareFailure=hardwareFailure, deviceHealth=deviceHealth, spFingerprintFeedback=spFingerprintFeedback, spFlowspecTimeout=spFlowspecTimeout, deviceTotalFlows=deviceTotalFlows, spScriptStart=spScriptStart, deviceSystemErrorDone=deviceSystemErrorDone, routingFailover=routingFailover, collectorUp=collectorUp, spcommFailure=spcommFailure, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, greDown=greDown, hardwareFailureDone=hardwareFailureDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptCommand=spScriptCommand, spMitigationID=spMitigationID, deviceSwapSpace=deviceSwapSpace, bgpTrap=bgpTrap, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyAddr=spThirdPartyAddr, spHijackAttr=spHijackAttr, mitigationBlackholeStart=mitigationBlackholeStart, spVersion=spVersion, peakflowSPMgr=peakflowSPMgr, devicePhysicalMemory=devicePhysicalMemory, spInetAddressType=spInetAddressType, dnsBaselineDone=dnsBaselineDone, spInetAddress=spInetAddress, fingerprintUsageDone=fingerprintUsageDone, flowDown=flowDown, interfaceUsage=interfaceUsage, spLicenseErrLimit=spLicenseErrLimit, spFingerprintName=spFingerprintName, spInterfaceUsageHC=spInterfaceUsageHC, spHardwareFailureDescription=spHardwareFailureDescription, mitigationDone=mitigationDone, collectorStart=collectorStart, cloudSignalingFaultDone=cloudSignalingFaultDone, alertScript=alertScript, bgpInstabilityDone=bgpInstabilityDone, spDNSExpected=spDNSExpected, spFingerprintSender=spFingerprintSender, spCollector=spCollector, spScriptPort=spScriptPort, spDNSObserved=spDNSObserved, spInterfaceSpeedHC=spInterfaceSpeedHC, fingerprintReceive=fingerprintReceive, bgpInstability=bgpInstability, spReportURL=spReportURL, spMitigationName=spMitigationName, configChange=configChange, bgpHijack=bgpHijack, notificationLimit=notificationLimit, licenseErrorDone=licenseErrorDone, spDuration=spDuration, spPravail=spPravail, spReportName=spReportName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, serviceUsage=serviceUsage, spServiceName=spServiceName, greDownDone=greDownDone, spSystemErrorDescription=spSystemErrorDescription, fingerprintFeedback=fingerprintFeedback, mitigationThirdPartyStart=mitigationThirdPartyStart, spUsageType=spUsageType, managedObjectUsageDone=managedObjectUsageDone, spImpactBps=spImpactBps, spBlackholeCommunity=spBlackholeCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, snmpDown=snmpDown, spFingerprintMessage=spFingerprintMessage, spScriptHost=spScriptHost, spAlertID=spAlertID, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapEvent=spBGPTrapEvent, flowUp=flowUp, spBGPTrapPrefix=spBGPTrapPrefix, spManagedObjects=spManagedObjects, mitigationTMSStart=mitigationTMSStart, spBlackholeTimeout=spBlackholeTimeout, spUsage=spUsage, spDNSObservedMax=spDNSObservedMax, dosHostDetectionAlertDone=dosHostDetectionAlertDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSPrefix=spTMSPrefix, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spThirdPartyZone=spThirdPartyZone, spLicenseErrType=spLicenseErrType, spHijackLocal=spHijackLocal, trafficAutoMitigation=trafficAutoMitigation, spDetector=spDetector, spApplicationName=spApplicationName, mitigationTMSStartV2=mitigationTMSStartV2, spTMSCommunity=spTMSCommunity, spBGPTrapName=spBGPTrapName, deviceSystemError=deviceSystemError, spFlowspecCommunity=spFlowspecCommunity, spHijackRoute=spHijackRoute, mitigationFlowspecStart=mitigationFlowspecStart, deviceDiskUsage=deviceDiskUsage, serviceUsageDone=serviceUsageDone, spUsername=spUsername, peakflowSPCMI=peakflowSPCMI, snmpUp=snmpUp, spBGPInstability=spBGPInstability, spCommFailureDestination=spCommFailureDestination, spSystemErrorType=spSystemErrorType, spServiceElement=spServiceElement, spTMSMultiPrefix=spTMSMultiPrefix, dnsBaseline=dnsBaseline, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, licenseError=licenseError, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInterface=spInterface, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spReportID=spReportID, peakflowSPMIB=peakflowSPMIB, cloudSignalingFault=cloudSignalingFault, spDNSObservedMean=spDNSObservedMean, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapNewAttributes=spBGPTrapNewAttributes, interfaceUsageDone=interfaceUsageDone)
