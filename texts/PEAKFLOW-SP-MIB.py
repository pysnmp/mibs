...
Integer32, NotificationType, MibIdentifier, ModuleIdentity, Counter32, Bits, TimeTicks, iso, Counter64, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "iso", "Counter64", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", snmpDown=snmpDown, mitigationTMSStart=mitigationTMSStart, spMitigationStart=spMitigationStart, spcommFailure=spcommFailure, spFingerprintName=spFingerprintName, spImpactPps=spImpactPps, spFlowspecTimeout=spFlowspecTimeout, spInetAddress=spInetAddress, deviceTotalFlowsHC=deviceTotalFlowsHC, spTMSMultiPrefix=spTMSMultiPrefix, greDown=greDown, spInetAddressType=spInetAddressType, serviceUsageDone=serviceUsageDone, spInterfaceUsage=spInterfaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObject=spManagedObject, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBlackholeTimeout=spBlackholeTimeout, spSystemErrorType=spSystemErrorType, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterfaceSpeed=spInterfaceSpeed, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSPrefix=spTMSPrefix, spServiceElement=spServiceElement, collectorUp=collectorUp, fingerprintFeedback=fingerprintFeedback, spDetectedCountries=spDetectedCountries, dnsBaselineDone=dnsBaselineDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spVersion=spVersion, dnsBaseline=dnsBaseline, spLicenseErrType=spLicenseErrType, mitigationDone=mitigationDone, snmpUp=snmpUp, trafficAutoMitigation=trafficAutoMitigation, spUsageType=spUsageType, spFingerprintMessage=spFingerprintMessage, managedObjectUsage=managedObjectUsage, spFingerprintFeedback=spFingerprintFeedback, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spLicenseErrDescription=spLicenseErrDescription, hardwareFailureDone=hardwareFailureDone, spCommFailureDestination=spCommFailureDestination, dosHostDetectionAlert=dosHostDetectionAlert, spcommFailureDone=spcommFailureDone, spThreshold=spThreshold, spMitigationName=spMitigationName, mitigationFlowspecStart=mitigationFlowspecStart, fingerprintUsage=fingerprintUsage, spRouter=spRouter, bgpInstability=bgpInstability, spBGPInstability=spBGPInstability, spInterfaceUsageHC=spInterfaceUsageHC, licenseErrorDone=licenseErrorDone, spSystemErrorDescription=spSystemErrorDescription, spTMSTimeout=spTMSTimeout, spFlowspecCommunity=spFlowspecCommunity, spReportID=spReportID, spUsage=spUsage, spImpactBps=spImpactBps, collectorDown=collectorDown, collectorStart=collectorStart, deviceSwapSpace=deviceSwapSpace, spAlertID=spAlertID, deviceSystemError=deviceSystemError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationThirdPartyStart=mitigationThirdPartyStart, cloudSignalingFault=cloudSignalingFault, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPEvent=spBGPEvent, spDNSObservedMean=spDNSObservedMean, devicePhysicalMemory=devicePhysicalMemory, spCommFailureDescription=spCommFailureDescription, spHardwareFailureDescription=spHardwareFailureDescription, spCollector=spCollector, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBGPTrapName=spBGPTrapName, spDetector=spDetector, deviceHealth=deviceHealth, peakflowSPMIB=peakflowSPMIB, spServiceName=spServiceName, flowDown=flowDown, spBlackholeCommunity=spBlackholeCommunity, spManagedObjects=spManagedObjects, fingerprintUsageDone=fingerprintUsageDone, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelName=spGreTunnelName, reportDone=reportDone, spHijackAttr=spHijackAttr, spMitigationID=spMitigationID, spReportURL=spReportURL, spDNSName=spDNSName, spScriptHost=spScriptHost, spInterface=spInterface, managedObjectUsageDone=managedObjectUsageDone, interfaceUsageDone=interfaceUsageDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, licenseError=licenseError, peakflowSPCMI=peakflowSPCMI, routingFailover=routingFailover, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptCommand=spScriptCommand, bgpInstabilityDone=bgpInstabilityDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, serviceUsage=serviceUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spUnit=spUnit, cloudSignalingFaultDone=cloudSignalingFaultDone, spGreTunnelDestination=spGreTunnelDestination, spTMSCommunity=spTMSCommunity, spApplicationName=spApplicationName, notificationLimit=notificationLimit, spScriptPort=spScriptPort, spBGPTrapPrefix=spBGPTrapPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceIndex=spInterfaceIndex, peakflowSPMgr=peakflowSPMgr, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptStart=spScriptStart, spUsername=spUsername, bgpDown=bgpDown, deviceTotalFlows=deviceTotalFlows, spHijackRoute=spHijackRoute, spBlackholeNexthop=spBlackholeNexthop, spDuration=spDuration, spFingerprintSender=spFingerprintSender, bgpHijack=bgpHijack, flowUp=flowUp, spThirdPartyZone=spThirdPartyZone, hardwareFailure=hardwareFailure, spPravail=spPravail, fingerprintReceive=fingerprintReceive, spBlackholePrefix=spBlackholePrefix, spDNSExpected=spDNSExpected, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapEvent=spBGPTrapEvent, deviceDiskUsage=deviceDiskUsage, autoclassifyStart=autoclassifyStart, spManagedObjectFamily=spManagedObjectFamily, bgpTrap=bgpTrap, spReportName=spReportName, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPTrapNewAttributes=spBGPTrapNewAttributes, mitigationBlackholeStart=mitigationBlackholeStart, spLicenseErrLimit=spLicenseErrLimit, interfaceUsage=interfaceUsage, spDNSObserved=spDNSObserved, alertScript=alertScript, bgpUp=bgpUp, PYSNMP_MODULE_ID=peakflowSPMIB, greDownDone=greDownDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spAlertDetectionSignatures=spAlertDetectionSignatures, configChange=configChange, peakflowSPTraps=peakflowSPTraps, spDNSObservedMax=spDNSObservedMax, deviceSystemErrorDone=deviceSystemErrorDone, spHijackLocal=spHijackLocal)
