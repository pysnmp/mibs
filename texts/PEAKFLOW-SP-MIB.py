...
Unsigned32, ObjectIdentity, IpAddress, Counter64, Bits, Counter32, iso, TimeTicks, Gauge32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter64", "Bits", "Counter32", "iso", "TimeTicks", "Gauge32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", hardwareFailure=hardwareFailure, spTMSTimeout=spTMSTimeout, peakflowSPTraps=peakflowSPTraps, bgpUp=bgpUp, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceTotalFlows=deviceTotalFlows, spScriptStart=spScriptStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spReportID=spReportID, spHijackAttr=spHijackAttr, configChange=configChange, dnsBaselineDone=dnsBaselineDone, managedObjectUsageDone=managedObjectUsageDone, spImpactBps=spImpactBps, alertScript=alertScript, greDown=greDown, collectorUp=collectorUp, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportName=spReportName, spHardwareFailureDescription=spHardwareFailureDescription, spBGPInstability=spBGPInstability, serviceUsageDone=serviceUsageDone, spBlackholePrefix=spBlackholePrefix, spBGPTrapEvent=spBGPTrapEvent, spImpactPps=spImpactPps, spFlowspecTimeout=spFlowspecTimeout, spUsageType=spUsageType, bgpDown=bgpDown, spFlowspecCommunity=spFlowspecCommunity, bgpTrap=bgpTrap, mitigationTMSStart=mitigationTMSStart, routingFailover=routingFailover, spThreshold=spThreshold, spInterfaceIndex=spInterfaceIndex, snmpDown=snmpDown, cloudSignalingFault=cloudSignalingFault, collectorStart=collectorStart, spInetAddressType=spInetAddressType, autoclassifyStart=autoclassifyStart, spMitigationStart=spMitigationStart, deviceSystemError=deviceSystemError, spFingerprintFeedback=spFingerprintFeedback, spBlackholeNexthop=spBlackholeNexthop, peakflowSPMIB=peakflowSPMIB, spFingerprintSender=spFingerprintSender, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spManagedObjects=spManagedObjects, spDNSObservedMax=spDNSObservedMax, reportDone=reportDone, spCommFailureDestination=spCommFailureDestination, spcommFailureDone=spcommFailureDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spServiceElement=spServiceElement, spScriptPort=spScriptPort, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spPravail=spPravail, dosHostDetectionAlert=dosHostDetectionAlert, PYSNMP_MODULE_ID=peakflowSPMIB, hardwareFailureDone=hardwareFailureDone, spTMSCommunity=spTMSCommunity, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spUnit=spUnit, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSwapSpace=deviceSwapSpace, fingerprintUsageDone=fingerprintUsageDone, snmpUp=snmpUp, deviceDiskUsage=deviceDiskUsage, spInterfaceSpeed=spInterfaceSpeed, spManagedObject=spManagedObject, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintName=spFingerprintName, spDetector=spDetector, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapName=spBGPTrapName, spInterface=spInterface, spServiceName=spServiceName, spFingerprintMessage=spFingerprintMessage, spDNSObserved=spDNSObserved, spSystemErrorType=spSystemErrorType, deviceHealth=deviceHealth, spGreTunnelName=spGreTunnelName, spCommFailureDescription=spCommFailureDescription, spcommFailure=spcommFailure, spHijackLocal=spHijackLocal, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrCount=spLicenseErrCount, spInterfaceUsage=spInterfaceUsage, spVersion=spVersion, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spSystemErrorDescription=spSystemErrorDescription, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, collectorDown=collectorDown, mitigationTMSStartV2=mitigationTMSStartV2, spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPCMI=peakflowSPCMI, trafficAutoMitigation=trafficAutoMitigation, spReportURL=spReportURL, spDetectedCountries=spDetectedCountries, spInetAddress=spInetAddress, notificationLimit=notificationLimit, spBlackholeCommunity=spBlackholeCommunity, spLicenseErrDescription=spLicenseErrDescription, peakflowSPMgr=peakflowSPMgr, spMitigationID=spMitigationID, spManagedObjectFamily=spManagedObjectFamily, spBGPTrapPrefix=spBGPTrapPrefix, greDownDone=greDownDone, flowDown=flowDown, spDNSName=spDNSName, licenseErrorDone=licenseErrorDone, spDNSObservedMean=spDNSObservedMean, mitigationFlowspecStart=mitigationFlowspecStart, spTMSPrefix=spTMSPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, dnsBaseline=dnsBaseline, fingerprintReceive=fingerprintReceive, spDNSExpected=spDNSExpected, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBGPEvent=spBGPEvent, spThirdPartyZone=spThirdPartyZone, spApplicationName=spApplicationName, spAlertDetectionSignatures=spAlertDetectionSignatures, spMitigationName=spMitigationName, spScriptHost=spScriptHost, spInterfaceUsageHC=spInterfaceUsageHC, spCollector=spCollector, deviceTotalFlowsHC=deviceTotalFlowsHC, licenseError=licenseError, spThirdPartyAddr=spThirdPartyAddr, spAlertID=spAlertID, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackRoute=spHijackRoute, managedObjectUsage=managedObjectUsage, interfaceUsageDone=interfaceUsageDone, spScriptCommand=spScriptCommand, interfaceUsage=interfaceUsage, bgpInstabilityDone=bgpInstabilityDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDuration=spDuration, bgpHijack=bgpHijack, flowUp=flowUp, fingerprintFeedback=fingerprintFeedback, fingerprintUsage=fingerprintUsage, spRouter=spRouter, spUsername=spUsername, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spUsage=spUsage, spLicenseErrType=spLicenseErrType, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpInstability=bgpInstability, mitigationDone=mitigationDone, serviceUsage=serviceUsage, spLicenseErrLimit=spLicenseErrLimit)
