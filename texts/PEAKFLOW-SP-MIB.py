...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Integer32, IpAddress, Counter32, Unsigned32, TimeTicks, iso, ObjectIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Integer32", "IpAddress", "Counter32", "Unsigned32", "TimeTicks", "iso", "ObjectIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationFlowspecStart=mitigationFlowspecStart, collectorDown=collectorDown, mitigationBlackholeStart=mitigationBlackholeStart, spDNSName=spDNSName, spTMSPrefix=spTMSPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, spDetectedCountries=spDetectedCountries, devicePhysicalMemory=devicePhysicalMemory, peakflowSPMIB=peakflowSPMIB, flowUp=flowUp, bgpInstabilityDone=bgpInstabilityDone, greDownDone=greDownDone, spPravail=spPravail, bgpUp=bgpUp, deviceSystemError=deviceSystemError, spBlackholeTimeout=spBlackholeTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFault=cloudSignalingFault, spMitigationName=spMitigationName, bgpInstability=bgpInstability, spDuration=spDuration, spBGPInstability=spBGPInstability, spMitigationID=spMitigationID, dosHostDetectionAlertDone=dosHostDetectionAlertDone, serviceUsage=serviceUsage, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptStart=spScriptStart, spcommFailureDone=spcommFailureDone, spUnit=spUnit, PYSNMP_MODULE_ID=peakflowSPMIB, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, managedObjectUsage=managedObjectUsage, deviceHealth=deviceHealth, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spCommFailureDestination=spCommFailureDestination, mitigationDone=mitigationDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spLicenseErrCount=spLicenseErrCount, snmpDown=snmpDown, fingerprintUsageDone=fingerprintUsageDone, spManagedObject=spManagedObject, spScriptPort=spScriptPort, dnsBaselineDone=dnsBaselineDone, spDNSExpected=spDNSExpected, spLicenseErrLimit=spLicenseErrLimit, spUsername=spUsername, spFlowspecTimeout=spFlowspecTimeout, cloudSignalingFaultDone=cloudSignalingFaultDone, spBlackholePrefix=spBlackholePrefix, mitigationTMSStartV2=mitigationTMSStartV2, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintReceive=fingerprintReceive, spFingerprintName=spFingerprintName, spTMSTimeout=spTMSTimeout, spInetAddressType=spInetAddressType, collectorStart=collectorStart, spManagedObjects=spManagedObjects, spFingerprintFeedback=spFingerprintFeedback, spLicenseErrDescription=spLicenseErrDescription, mitigationTMSStart=mitigationTMSStart, spReportName=spReportName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, hardwareFailureDone=hardwareFailureDone, bgpDown=bgpDown, spDetector=spDetector, spServiceName=spServiceName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpTrap=bgpTrap, spTMSMultiPrefix=spTMSMultiPrefix, spcommFailure=spcommFailure, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceSpeed=spInterfaceSpeed, interfaceUsage=interfaceUsage, fingerprintUsage=fingerprintUsage, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterfaceUsage=spInterfaceUsage, greDown=greDown, spHijackRoute=spHijackRoute, spDNSObservedMax=spDNSObservedMax, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptHost=spScriptHost, collectorUp=collectorUp, spThreshold=spThreshold, serviceUsageDone=serviceUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spRouter=spRouter, spTMSCommunity=spTMSCommunity, spApplicationName=spApplicationName, managedObjectUsageDone=managedObjectUsageDone, snmpUp=snmpUp, spImpactBps=spImpactBps, reportDone=reportDone, licenseError=licenseError, licenseErrorDone=licenseErrorDone, spInterface=spInterface, alertScript=alertScript, spBGPTrapName=spBGPTrapName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spFingerprintMessage=spFingerprintMessage, spFingerprintSender=spFingerprintSender, spHijackAttr=spHijackAttr, notificationLimit=notificationLimit, spUsage=spUsage, spThirdPartyAddr=spThirdPartyAddr, spReportURL=spReportURL, spGreTunnelDestination=spGreTunnelDestination, spUsageType=spUsageType, bgpHijack=bgpHijack, spDNSObserved=spDNSObserved, spBGPTrapEvent=spBGPTrapEvent, spReportID=spReportID, mitigationThirdPartyStart=mitigationThirdPartyStart, spManagedObjectFamily=spManagedObjectFamily, spSystemErrorDescription=spSystemErrorDescription, spFlowspecCommunity=spFlowspecCommunity, spThirdPartyZone=spThirdPartyZone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spCommFailureDescription=spCommFailureDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHijackLocal=spHijackLocal, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrType=spLicenseErrType, spImpactPps=spImpactPps, spCollector=spCollector, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dnsBaseline=dnsBaseline, peakflowSPMgr=peakflowSPMgr, routingFailover=routingFailover, interfaceUsageDone=interfaceUsageDone, spInterfaceIndex=spInterfaceIndex, spMitigationStart=spMitigationStart, deviceTotalFlowsHC=deviceTotalFlowsHC, spServiceElement=spServiceElement, deviceDiskUsage=deviceDiskUsage, spBlackholeNexthop=spBlackholeNexthop, spInetAddress=spInetAddress, spAlertID=spAlertID, fingerprintFeedback=fingerprintFeedback, spDNSObservedMean=spDNSObservedMean, spBGPTrapPrefix=spBGPTrapPrefix, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptCommand=spScriptCommand, spVersion=spVersion, autoclassifyStart=autoclassifyStart, configChange=configChange, deviceTotalFlows=deviceTotalFlows, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spSystemErrorType=spSystemErrorType, peakflowSPCMI=peakflowSPCMI, hardwareFailure=hardwareFailure, flowDown=flowDown, peakflowSPTraps=peakflowSPTraps, deviceSwapSpace=deviceSwapSpace, spBlackholeCommunity=spBlackholeCommunity, deviceSystemErrorDone=deviceSystemErrorDone, spBGPEvent=spBGPEvent)
