...
Bits, NotificationType, Counter64, ModuleIdentity, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, IpAddress, Counter32, Gauge32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "IpAddress", "Counter32", "Gauge32", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptStart=spScriptStart, spBGPTrapPrefix=spBGPTrapPrefix, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spMitigationID=spMitigationID, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceIndex=spInterfaceIndex, deviceDiskUsage=deviceDiskUsage, bgpUp=bgpUp, serviceUsageDone=serviceUsageDone, PYSNMP_MODULE_ID=peakflowSPMIB, spRouter=spRouter, spBGPTrapEvent=spBGPTrapEvent, collectorStart=collectorStart, interfaceUsageDone=interfaceUsageDone, spReportName=spReportName, spBGPEvent=spBGPEvent, spManagedObjectFamily=spManagedObjectFamily, licenseError=licenseError, spUsageType=spUsageType, bgpHijack=bgpHijack, fingerprintFeedback=fingerprintFeedback, spBGPTrapName=spBGPTrapName, interfaceUsage=interfaceUsage, spcommFailure=spcommFailure, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationTMSStart=mitigationTMSStart, spAlertID=spAlertID, spInetAddress=spInetAddress, mitigationBlackholeStart=mitigationBlackholeStart, spBlackholeTimeout=spBlackholeTimeout, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spLicenseErrType=spLicenseErrType, devicePhysicalMemory=devicePhysicalMemory, notificationLimit=notificationLimit, spFingerprintName=spFingerprintName, spTMSCommunity=spTMSCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackAttr=spHijackAttr, spTMSMultiPrefix=spTMSMultiPrefix, reportDone=reportDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSwapSpace=deviceSwapSpace, spReportID=spReportID, deviceSystemError=deviceSystemError, fingerprintUsageDone=fingerprintUsageDone, peakflowSPMIB=peakflowSPMIB, spApplicationName=spApplicationName, spUnit=spUnit, flowUp=flowUp, peakflowSPCMI=peakflowSPCMI, spVersion=spVersion, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosHostDetectionAlert=dosHostDetectionAlert, spMitigationName=spMitigationName, spScriptHost=spScriptHost, autoclassifyStart=autoclassifyStart, deviceHealth=deviceHealth, mitigationThirdPartyStart=mitigationThirdPartyStart, greDown=greDown, spInterface=spInterface, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, mitigationTMSStartV2=mitigationTMSStartV2, spTMSPrefix=spTMSPrefix, spManagedObject=spManagedObject, deviceSystemErrorDone=deviceSystemErrorDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObserved=spDNSObserved, managedObjectUsageDone=managedObjectUsageDone, snmpDown=snmpDown, spTMSTimeout=spTMSTimeout, spImpactBps=spImpactBps, deviceTotalFlowsHC=deviceTotalFlowsHC, licenseErrorDone=licenseErrorDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingFault=cloudSignalingFault, deviceSwapSpaceUsage=deviceSwapSpaceUsage, snmpUp=snmpUp, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, peakflowSPTraps=peakflowSPTraps, spDNSExpected=spDNSExpected, spThirdPartyZone=spThirdPartyZone, spDNSObservedMax=spDNSObservedMax, spFingerprintMessage=spFingerprintMessage, mitigationFlowspecStart=mitigationFlowspecStart, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSName=spDNSName, spDetectedCountries=spDetectedCountries, spGreTunnelName=spGreTunnelName, spLicenseErrDescription=spLicenseErrDescription, spLicenseErrLimit=spLicenseErrLimit, hardwareFailure=hardwareFailure, spDetector=spDetector, spServiceName=spServiceName, spCommFailureDescription=spCommFailureDescription, peakflowSPMgr=peakflowSPMgr, spDuration=spDuration, hardwareFailureDone=hardwareFailureDone, spUsage=spUsage, spHijackRoute=spHijackRoute, spAlertDetectionSignatures=spAlertDetectionSignatures, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spScriptPort=spScriptPort, spGreTunnelDestination=spGreTunnelDestination, spDNSObservedMean=spDNSObservedMean, alertScript=alertScript, spManagedObjects=spManagedObjects, spPravail=spPravail, dnsBaseline=dnsBaseline, fingerprintReceive=fingerprintReceive, collectorDown=collectorDown, collectorUp=collectorUp, deviceSwapSpaceInUse=deviceSwapSpaceInUse, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, configChange=configChange, mitigationDone=mitigationDone, fingerprintUsage=fingerprintUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, flowDown=flowDown, spMitigationStart=spMitigationStart, bgpTrap=bgpTrap, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFaultDone=cloudSignalingFaultDone, bgpDown=bgpDown, routingFailover=routingFailover, spFingerprintFeedback=spFingerprintFeedback, dnsBaselineDone=dnsBaselineDone, spReportURL=spReportURL, spFlowspecTimeout=spFlowspecTimeout, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceUsage=spInterfaceUsage, spScriptCommand=spScriptCommand, spCollector=spCollector, spInterfaceSpeed=spInterfaceSpeed, spHijackLocal=spHijackLocal, spBlackholePrefix=spBlackholePrefix, spcommFailureDone=spcommFailureDone, spBlackholeNexthop=spBlackholeNexthop, spServiceElement=spServiceElement, bgpInstabilityDone=bgpInstabilityDone, serviceUsage=serviceUsage, spCommFailureDestination=spCommFailureDestination, spUsername=spUsername, greDownDone=greDownDone, spBlackholeCommunity=spBlackholeCommunity, bgpInstability=bgpInstability, spThreshold=spThreshold, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spFingerprintSender=spFingerprintSender, trafficAutoMitigation=trafficAutoMitigation, deviceTotalFlows=deviceTotalFlows, spThirdPartyAddr=spThirdPartyAddr, spLicenseErrCount=spLicenseErrCount, managedObjectUsage=managedObjectUsage, spBGPInstability=spBGPInstability, spHardwareFailureDescription=spHardwareFailureDescription, spSystemErrorDescription=spSystemErrorDescription, spInetAddressType=spInetAddressType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spSystemErrorType=spSystemErrorType, spImpactPps=spImpactPps)
