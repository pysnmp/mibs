...
MibIdentifier, IpAddress, ModuleIdentity, Counter32, Counter64, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Bits, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter32", "Counter64", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Bits", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpInstabilityDone=bgpInstabilityDone, deviceSystemErrorDone=deviceSystemErrorDone, spHijackAttr=spHijackAttr, fingerprintFeedback=fingerprintFeedback, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapName=spBGPTrapName, mitigationDone=mitigationDone, bgpUp=bgpUp, spScriptCommand=spScriptCommand, peakflowSPMIB=peakflowSPMIB, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiPrefix=spTMSMultiPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, PYSNMP_MODULE_ID=peakflowSPMIB, spScriptHost=spScriptHost, alertScript=alertScript, deviceHealth=deviceHealth, spLicenseErrCount=spLicenseErrCount, spFingerprintSender=spFingerprintSender, spTMSTimeout=spTMSTimeout, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, managedObjectUsageDone=managedObjectUsageDone, spFingerprintMessage=spFingerprintMessage, mitigationTMSStart=mitigationTMSStart, spDNSExpected=spDNSExpected, reportDone=reportDone, spDNSObservedMax=spDNSObservedMax, bgpDown=bgpDown, spBlackholeTimeout=spBlackholeTimeout, spUsage=spUsage, fingerprintUsageDone=fingerprintUsageDone, licenseErrorDone=licenseErrorDone, spMitigationID=spMitigationID, spLicenseErrType=spLicenseErrType, spBGPTrapEvent=spBGPTrapEvent, spDNSName=spDNSName, spManagedObjects=spManagedObjects, spDuration=spDuration, spHardwareFailureDescription=spHardwareFailureDescription, spBGPInstability=spBGPInstability, spReportID=spReportID, peakflowSPMgr=peakflowSPMgr, spFingerprintName=spFingerprintName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUsername=spUsername, spMitigationStart=spMitigationStart, spInetAddress=spInetAddress, spInterfaceUsage=spInterfaceUsage, peakflowSPTraps=peakflowSPTraps, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spSystemErrorDescription=spSystemErrorDescription, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationTMSStartV2=mitigationTMSStartV2, serviceUsageDone=serviceUsageDone, interfaceUsage=interfaceUsage, spUsageType=spUsageType, spScriptStart=spScriptStart, spInterfaceSpeedHC=spInterfaceSpeedHC, spFlowspecTimeout=spFlowspecTimeout, deviceTotalFlows=deviceTotalFlows, fingerprintUsage=fingerprintUsage, spThirdPartyZone=spThirdPartyZone, spCollector=spCollector, spVersion=spVersion, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, interfaceUsageDone=interfaceUsageDone, bgpHijack=bgpHijack, spDetectedCountries=spDetectedCountries, spFingerprintFeedback=spFingerprintFeedback, flowDown=flowDown, spCommFailureDestination=spCommFailureDestination, spServiceName=spServiceName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, routingFailover=routingFailover, spDNSObserved=spDNSObserved, spLicenseErrLimit=spLicenseErrLimit, greDown=greDown, dosHostDetectionAlert=dosHostDetectionAlert, bgpInstability=bgpInstability, spDNSObservedMean=spDNSObservedMean, licenseError=licenseError, hardwareFailure=hardwareFailure, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, devicePhysicalMemory=devicePhysicalMemory, serviceUsage=serviceUsage, spInterfaceIndex=spInterfaceIndex, spMitigationName=spMitigationName, deviceTotalFlowsHC=deviceTotalFlowsHC, spImpactPps=spImpactPps, cloudSignalingFault=cloudSignalingFault, spThirdPartyAddr=spThirdPartyAddr, fingerprintReceive=fingerprintReceive, dosHostDetectionAlertDone=dosHostDetectionAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceSwapSpace=deviceSwapSpace, spHijackLocal=spHijackLocal, spImpactBps=spImpactBps, spSystemErrorType=spSystemErrorType, autoclassifyStart=autoclassifyStart, spTMSPrefix=spTMSPrefix, spReportURL=spReportURL, spManagedObject=spManagedObject, spApplicationName=spApplicationName, spPravail=spPravail, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spcommFailure=spcommFailure, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spManagedObjectFamily=spManagedObjectFamily, spBlackholePrefix=spBlackholePrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, spAlertID=spAlertID, snmpDown=snmpDown, collectorUp=collectorUp, greDownDone=greDownDone, spInterfaceSpeed=spInterfaceSpeed, spUnit=spUnit, deviceSystemError=deviceSystemError, spLicenseErrDescription=spLicenseErrDescription, bgpTrap=bgpTrap, spServiceElement=spServiceElement, spRouter=spRouter, mitigationThirdPartyStart=mitigationThirdPartyStart, spInterface=spInterface, spGreTunnelDestination=spGreTunnelDestination, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spReportName=spReportName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCommFailureDescription=spCommFailureDescription, spDetector=spDetector, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, dnsBaseline=dnsBaseline, dnsBaselineDone=dnsBaselineDone, collectorDown=collectorDown, mitigationFlowspecStart=mitigationFlowspecStart, hardwareFailureDone=hardwareFailureDone, spInetAddressType=spInetAddressType, trafficAutoMitigation=trafficAutoMitigation, spFlowspecCommunity=spFlowspecCommunity, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPCMI=peakflowSPCMI, spBlackholeCommunity=spBlackholeCommunity, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, cloudSignalingFaultDone=cloudSignalingFaultDone, flowUp=flowUp, spBGPEvent=spBGPEvent, managedObjectUsage=managedObjectUsage, spGreTunnelName=spGreTunnelName, mitigationBlackholeStart=mitigationBlackholeStart, collectorStart=collectorStart, configChange=configChange, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThreshold=spThreshold, spBlackholeNexthop=spBlackholeNexthop, deviceDiskUsage=deviceDiskUsage, spScriptPort=spScriptPort, spInterfaceUsageHC=spInterfaceUsageHC, spcommFailureDone=spcommFailureDone, notificationLimit=notificationLimit, spHijackRoute=spHijackRoute, snmpUp=snmpUp)
