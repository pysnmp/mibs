...
TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Gauge32, Unsigned32, Integer32, MibIdentifier, ObjectIdentity, ModuleIdentity, NotificationType, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Gauge32", "Unsigned32", "Integer32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "NotificationType", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInetAddress=spInetAddress, spDNSExpected=spDNSExpected, deviceSystemErrorDone=deviceSystemErrorDone, hardwareFailure=hardwareFailure, alertScript=alertScript, spMitigationStart=spMitigationStart, spFingerprintName=spFingerprintName, spDNSName=spDNSName, cloudSignalingFault=cloudSignalingFault, managedObjectUsage=managedObjectUsage, spcommFailure=spcommFailure, spDetector=spDetector, collectorStart=collectorStart, spVersion=spVersion, spInterfaceUsageHC=spInterfaceUsageHC, spServiceName=spServiceName, spInterfaceUsage=spInterfaceUsage, spManagedObjectFamily=spManagedObjectFamily, spServiceElement=spServiceElement, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceSpeedHC=spInterfaceSpeedHC, spLicenseErrType=spLicenseErrType, trafficAutoMitigation=trafficAutoMitigation, spDetectedCountries=spDetectedCountries, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSPrefix=spTMSPrefix, greDownDone=greDownDone, peakflowSPTraps=peakflowSPTraps, spAlertID=spAlertID, spApplicationName=spApplicationName, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spMitigationName=spMitigationName, dnsBaseline=dnsBaseline, mitigationDone=mitigationDone, spUsername=spUsername, dosHostDetectionAlert=dosHostDetectionAlert, spBGPEvent=spBGPEvent, spSystemErrorType=spSystemErrorType, routingFailover=routingFailover, interfaceUsage=interfaceUsage, spBlackholeTimeout=spBlackholeTimeout, mitigationFlowspecStart=mitigationFlowspecStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, serviceUsage=serviceUsage, spScriptStart=spScriptStart, spScriptPort=spScriptPort, spBGPTrapPrefix=spBGPTrapPrefix, spDNSObserved=spDNSObserved, spInterface=spInterface, spBlackholeCommunity=spBlackholeCommunity, spReportID=spReportID, spBlackholePrefix=spBlackholePrefix, spFingerprintFeedback=spFingerprintFeedback, spScriptHost=spScriptHost, spPravail=spPravail, deviceDiskUsage=deviceDiskUsage, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapOldAttributes=spBGPTrapOldAttributes, notificationLimit=notificationLimit, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapName=spBGPTrapName, spImpactBps=spImpactBps, flowUp=flowUp, bgpHijack=bgpHijack, spDuration=spDuration, spFlowspecCommunity=spFlowspecCommunity, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSTimeout=spTMSTimeout, spReportURL=spReportURL, spManagedObject=spManagedObject, spTMSCommunity=spTMSCommunity, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpInstabilityDone=bgpInstabilityDone, managedObjectUsageDone=managedObjectUsageDone, deviceSwapSpace=deviceSwapSpace, spHijackLocal=spHijackLocal, serviceUsageDone=serviceUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, hardwareFailureDone=hardwareFailureDone, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrDescription=spLicenseErrDescription, interfaceUsageDone=interfaceUsageDone, spCollector=spCollector, spDNSObservedMax=spDNSObservedMax, spCloudSignalFaultDescription=spCloudSignalFaultDescription, reportDone=reportDone, spInetAddressType=spInetAddressType, licenseErrorDone=licenseErrorDone, spBlackholeNexthop=spBlackholeNexthop, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spReportName=spReportName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spGreTunnelDestination=spGreTunnelDestination, fingerprintUsage=fingerprintUsage, autoclassifyStart=autoclassifyStart, spCommFailureDestination=spCommFailureDestination, spManagedObjects=spManagedObjects, spImpactPps=spImpactPps, devicePhysicalMemory=devicePhysicalMemory, fingerprintReceive=fingerprintReceive, spThirdPartyZone=spThirdPartyZone, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsageType=spUsageType, collectorUp=collectorUp, mitigationThirdPartyStart=mitigationThirdPartyStart, spCommFailureDescription=spCommFailureDescription, spInterfaceIndex=spInterfaceIndex, spGreTunnelName=spGreTunnelName, licenseError=licenseError, spFlowspecTimeout=spFlowspecTimeout, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spMitigationID=spMitigationID, spBGPTrapEvent=spBGPTrapEvent, spBGPInstability=spBGPInstability, spcommFailureDone=spcommFailureDone, spFingerprintSender=spFingerprintSender, dnsBaselineDone=dnsBaselineDone, spLicenseErrCount=spLicenseErrCount, spHijackRoute=spHijackRoute, mitigationTMSStart=mitigationTMSStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpInstability=bgpInstability, spUnit=spUnit, spFingerprintMessage=spFingerprintMessage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsageDone=fingerprintUsageDone, bgpUp=bgpUp, spHijackAttr=spHijackAttr, greDown=greDown, spRouter=spRouter, spThirdPartyAddr=spThirdPartyAddr, peakflowSPMIB=peakflowSPMIB, peakflowSPCMI=peakflowSPCMI, deviceTotalFlows=deviceTotalFlows, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, flowDown=flowDown, bgpDown=bgpDown, spLicenseErrLimit=spLicenseErrLimit, dosNetworkProfiledAlert=dosNetworkProfiledAlert, snmpUp=snmpUp, collectorDown=collectorDown, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSMultiPrefix=spTMSMultiPrefix, bgpTrap=bgpTrap, snmpDown=snmpDown, spSystemErrorDescription=spSystemErrorDescription, spThreshold=spThreshold, configChange=configChange, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPMgr=peakflowSPMgr, spScriptCommand=spScriptCommand, deviceSystemError=deviceSystemError, spDNSObservedMean=spDNSObservedMean, deviceHealth=deviceHealth, spUsage=spUsage)
