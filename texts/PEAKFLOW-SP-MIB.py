...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Counter32, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, Bits, Integer32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Counter32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "Bits", "Integer32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", devicePhysicalMemory=devicePhysicalMemory, spAlertDetectionSignatures=spAlertDetectionSignatures, mitigationDone=mitigationDone, spGreTunnelName=spGreTunnelName, greDown=greDown, spBlackholeTimeout=spBlackholeTimeout, cloudSignalingFaultDone=cloudSignalingFaultDone, interfaceUsage=interfaceUsage, dnsBaselineDone=dnsBaselineDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceSpeed=spInterfaceSpeed, spManagedObjectFamily=spManagedObjectFamily, deviceHealth=deviceHealth, spBlackholePrefix=spBlackholePrefix, deviceSystemErrorDone=deviceSystemErrorDone, spFlowspecCommunity=spFlowspecCommunity, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spImpactBps=spImpactBps, deviceSystemError=deviceSystemError, bgpInstabilityDone=bgpInstabilityDone, hardwareFailureDone=hardwareFailureDone, spAlertID=spAlertID, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPMgr=peakflowSPMgr, spDetectedCountries=spDetectedCountries, spReportName=spReportName, peakflowSPMIB=peakflowSPMIB, spApplicationName=spApplicationName, spHijackAttr=spHijackAttr, spTMSMultiPrefix=spTMSMultiPrefix, spInetAddress=spInetAddress, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptHost=spScriptHost, managedObjectUsage=managedObjectUsage, spInterfaceSpeedHC=spInterfaceSpeedHC, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceTotalFlowsHC=deviceTotalFlowsHC, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spServiceName=spServiceName, fingerprintUsage=fingerprintUsage, reportDone=reportDone, spcommFailure=spcommFailure, bgpDown=bgpDown, spUsage=spUsage, spUsageType=spUsageType, spLicenseErrCount=spLicenseErrCount, spFingerprintSender=spFingerprintSender, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPTraps=peakflowSPTraps, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dosHostDetectionAlert=dosHostDetectionAlert, fingerprintReceive=fingerprintReceive, spScriptCommand=spScriptCommand, spTMSTimeout=spTMSTimeout, autoclassifyStart=autoclassifyStart, deviceSwapSpace=deviceSwapSpace, alertScript=alertScript, spDNSName=spDNSName, spcommFailureDone=spcommFailureDone, greDownDone=greDownDone, spReportURL=spReportURL, spInetAddressType=spInetAddressType, spManagedObject=spManagedObject, spGreTunnelDestination=spGreTunnelDestination, collectorUp=collectorUp, bgpHijack=bgpHijack, fingerprintFeedback=fingerprintFeedback, spInterfaceUsage=spInterfaceUsage, spFlowspecTimeout=spFlowspecTimeout, spInterface=spInterface, spFingerprintFeedback=spFingerprintFeedback, mitigationThirdPartyStart=mitigationThirdPartyStart, managedObjectUsageDone=managedObjectUsageDone, mitigationTMSStartV2=mitigationTMSStartV2, interfaceUsageDone=interfaceUsageDone, spReportID=spReportID, spFingerprintName=spFingerprintName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorStart=collectorStart, notificationLimit=notificationLimit, trafficAutoMitigation=trafficAutoMitigation, spBlackholeNexthop=spBlackholeNexthop, spUsername=spUsername, spBlackholeCommunity=spBlackholeCommunity, deviceDiskUsage=deviceDiskUsage, spRouter=spRouter, snmpDown=snmpDown, spTMSCommunity=spTMSCommunity, spLicenseErrLimit=spLicenseErrLimit, spInterfaceIndex=spInterfaceIndex, routingFailover=routingFailover, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationTMSStart=mitigationTMSStart, cloudSignalingFault=cloudSignalingFault, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spScriptPort=spScriptPort, bgpInstability=bgpInstability, spThirdPartyAddr=spThirdPartyAddr, spCommFailureDescription=spCommFailureDescription, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintMessage=spFingerprintMessage, spCommFailureDestination=spCommFailureDestination, hardwareFailure=hardwareFailure, spManagedObjects=spManagedObjects, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPEvent=spBGPEvent, spHijackLocal=spHijackLocal, collectorDown=collectorDown, fingerprintUsageDone=fingerprintUsageDone, peakflowSPCMI=peakflowSPCMI, licenseErrorDone=licenseErrorDone, spPravail=spPravail, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceTotalFlows=deviceTotalFlows, spThreshold=spThreshold, spDetector=spDetector, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpUp=bgpUp, spDNSObservedMean=spDNSObservedMean, spImpactPps=spImpactPps, spVersion=spVersion, spHijackRoute=spHijackRoute, spMitigationStart=spMitigationStart, spLicenseErrType=spLicenseErrType, spBGPInstability=spBGPInstability, bgpTrap=bgpTrap, mitigationBlackholeStart=mitigationBlackholeStart, spSystemErrorDescription=spSystemErrorDescription, serviceUsageDone=serviceUsageDone, licenseError=licenseError, spMitigationName=spMitigationName, spDuration=spDuration, snmpUp=snmpUp, spTMSPrefix=spTMSPrefix, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapName=spBGPTrapName, spDNSObservedMax=spDNSObservedMax, spDNSExpected=spDNSExpected, flowUp=flowUp, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spScriptStart=spScriptStart, dnsBaseline=dnsBaseline, spSystemErrorType=spSystemErrorType, mitigationFlowspecStart=mitigationFlowspecStart, flowDown=flowDown, spServiceElement=spServiceElement, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, serviceUsage=serviceUsage, spUnit=spUnit, configChange=configChange, spLicenseErrDescription=spLicenseErrDescription, spMitigationID=spMitigationID, spDNSObserved=spDNSObserved)
