...
TimeTicks, IpAddress, Counter32, Bits, Counter64, iso, ObjectIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter32", "Bits", "Counter64", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", trafficAutoMitigation=trafficAutoMitigation, greDown=greDown, spRouter=spRouter, interfaceUsage=interfaceUsage, spSystemErrorType=spSystemErrorType, flowUp=flowUp, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spServiceName=spServiceName, spBlackholeNexthop=spBlackholeNexthop, spInterfaceUsageHC=spInterfaceUsageHC, spBGPEvent=spBGPEvent, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUnit=spUnit, bgpInstabilityDone=bgpInstabilityDone, spPravail=spPravail, spManagedObject=spManagedObject, cloudSignalingFault=cloudSignalingFault, spScriptStart=spScriptStart, spImpactBps=spImpactBps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, interfaceUsageDone=interfaceUsageDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spThirdPartyAddr=spThirdPartyAddr, peakflowSPCMI=peakflowSPCMI, spDetector=spDetector, licenseError=licenseError, spBGPTrapEvent=spBGPTrapEvent, mitigationTMSStartV2=mitigationTMSStartV2, mitigationThirdPartyStart=mitigationThirdPartyStart, spThirdPartyZone=spThirdPartyZone, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapName=spBGPTrapName, mitigationDone=mitigationDone, spVersion=spVersion, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spDNSObservedMean=spDNSObservedMean, spAlertDetectionSignatures=spAlertDetectionSignatures, configChange=configChange, spUsageType=spUsageType, spcommFailure=spcommFailure, spManagedObjects=spManagedObjects, spAlertID=spAlertID, spTMSCommunity=spTMSCommunity, spBlackholePrefix=spBlackholePrefix, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spLicenseErrType=spLicenseErrType, deviceSystemError=deviceSystemError, devicePhysicalMemory=devicePhysicalMemory, spFingerprintFeedback=spFingerprintFeedback, spReportName=spReportName, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintName=spFingerprintName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, fingerprintUsage=fingerprintUsage, bgpUp=bgpUp, collectorDown=collectorDown, spLicenseErrCount=spLicenseErrCount, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBlackholeCommunity=spBlackholeCommunity, mitigationTMSStart=mitigationTMSStart, spGreTunnelDestination=spGreTunnelDestination, serviceUsageDone=serviceUsageDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPInstability=spBGPInstability, spScriptCommand=spScriptCommand, spFlowspecCommunity=spFlowspecCommunity, spTMSMultiPrefix=spTMSMultiPrefix, collectorUp=collectorUp, spMitigationName=spMitigationName, licenseErrorDone=licenseErrorDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSTimeout=spTMSTimeout, spFingerprintMessage=spFingerprintMessage, spManagedObjectFamily=spManagedObjectFamily, dnsBaselineDone=dnsBaselineDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, fingerprintReceive=fingerprintReceive, spcommFailureDone=spcommFailureDone, spTMSPrefix=spTMSPrefix, reportDone=reportDone, spScriptHost=spScriptHost, deviceTotalFlows=deviceTotalFlows, spImpactPps=spImpactPps, spInterfaceSpeed=spInterfaceSpeed, greDownDone=greDownDone, bgpTrap=bgpTrap, bgpHijack=bgpHijack, spDNSObserved=spDNSObserved, spCollector=spCollector, managedObjectUsageDone=managedObjectUsageDone, autoclassifyStart=autoclassifyStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPMIB=peakflowSPMIB, spLicenseErrLimit=spLicenseErrLimit, dosHostDetectionAlert=dosHostDetectionAlert, serviceUsage=serviceUsage, spInterfaceIndex=spInterfaceIndex, spReportID=spReportID, spFingerprintSender=spFingerprintSender, collectorStart=collectorStart, deviceSwapSpace=deviceSwapSpace, spReportURL=spReportURL, mitigationFlowspecStart=mitigationFlowspecStart, fingerprintFeedback=fingerprintFeedback, spHardwareFailureDescription=spHardwareFailureDescription, spBlackholeTimeout=spBlackholeTimeout, spMitigationStart=spMitigationStart, spHijackLocal=spHijackLocal, spThreshold=spThreshold, deviceDiskUsage=deviceDiskUsage, managedObjectUsage=managedObjectUsage, peakflowSPMgr=peakflowSPMgr, routingFailover=routingFailover, mitigationBlackholeStart=mitigationBlackholeStart, spServiceElement=spServiceElement, spUsername=spUsername, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spMitigationID=spMitigationID, deviceTotalFlowsHC=deviceTotalFlowsHC, spCommFailureDestination=spCommFailureDestination, peakflowSPTraps=peakflowSPTraps, hardwareFailureDone=hardwareFailureDone, hardwareFailure=hardwareFailure, spSystemErrorDescription=spSystemErrorDescription, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spApplicationName=spApplicationName, spUsage=spUsage, flowDown=flowDown, notificationLimit=notificationLimit, spDNSName=spDNSName, spDNSExpected=spDNSExpected, cloudSignalingFaultDone=cloudSignalingFaultDone, spCommFailureDescription=spCommFailureDescription, spInetAddressType=spInetAddressType, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackAttr=spHijackAttr, spGreTunnelName=spGreTunnelName, bgpInstability=bgpInstability, spScriptPort=spScriptPort, bgpDown=bgpDown, spDNSObservedMax=spDNSObservedMax, deviceHealth=deviceHealth, spLicenseErrDescription=spLicenseErrDescription, snmpDown=snmpDown, dnsBaseline=dnsBaseline, snmpUp=snmpUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDetectedCountries=spDetectedCountries, alertScript=alertScript, deviceSystemErrorDone=deviceSystemErrorDone, spHijackRoute=spHijackRoute, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceUsage=spInterfaceUsage, spInetAddress=spInetAddress, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterface=spInterface, spDuration=spDuration)
