...
Bits, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, IpAddress, Counter32, iso, Gauge32, Counter64, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "Counter32", "iso", "Gauge32", "Counter64", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spManagedObject=spManagedObject, mitigationTMSStartV2=mitigationTMSStartV2, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationThirdPartyStart=mitigationThirdPartyStart, notificationLimit=notificationLimit, spScriptPort=spScriptPort, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, managedObjectUsageDone=managedObjectUsageDone, autoclassifyStart=autoclassifyStart, spReportURL=spReportURL, spFlowspecTimeout=spFlowspecTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spUsageType=spUsageType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spImpactBps=spImpactBps, interfaceUsage=interfaceUsage, spDNSObservedMean=spDNSObservedMean, spInterfaceSpeedHC=spInterfaceSpeedHC, dnsBaseline=dnsBaseline, peakflowSPCMI=peakflowSPCMI, managedObjectUsage=managedObjectUsage, spVersion=spVersion, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, licenseErrorDone=licenseErrorDone, trafficAutoMitigation=trafficAutoMitigation, spCommFailureDestination=spCommFailureDestination, spTMSMultiPrefix=spTMSMultiPrefix, bgpHijack=bgpHijack, spBGPEvent=spBGPEvent, spScriptStart=spScriptStart, spPravail=spPravail, collectorDown=collectorDown, spMitigationID=spMitigationID, cloudSignalingFaultDone=cloudSignalingFaultDone, spBlackholeNexthop=spBlackholeNexthop, hardwareFailure=hardwareFailure, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spFlowspecCommunity=spFlowspecCommunity, hardwareFailureDone=hardwareFailureDone, spCollector=spCollector, spRouter=spRouter, spInterfaceIndex=spInterfaceIndex, cloudSignalingFault=cloudSignalingFault, spCommFailureDescription=spCommFailureDescription, spThirdPartyZone=spThirdPartyZone, spBlackholePrefix=spBlackholePrefix, spServiceName=spServiceName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dosHostDetectionAlert=dosHostDetectionAlert, fingerprintFeedback=fingerprintFeedback, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, flowUp=flowUp, spUnit=spUnit, spManagedObjectFamily=spManagedObjectFamily, devicePhysicalMemory=devicePhysicalMemory, spcommFailureDone=spcommFailureDone, PYSNMP_MODULE_ID=peakflowSPMIB, spHijackAttr=spHijackAttr, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spcommFailure=spcommFailure, deviceTotalFlowsHC=deviceTotalFlowsHC, collectorStart=collectorStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapEvent=spBGPTrapEvent, spInetAddressType=spInetAddressType, spScriptHost=spScriptHost, spGreTunnelName=spGreTunnelName, deviceTotalFlows=deviceTotalFlows, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationDone=mitigationDone, serviceUsage=serviceUsage, flowDown=flowDown, spThreshold=spThreshold, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spAlertDetectionSignatures=spAlertDetectionSignatures, dnsBaselineDone=dnsBaselineDone, spScriptCommand=spScriptCommand, spGreTunnelDestination=spGreTunnelDestination, spFingerprintSender=spFingerprintSender, spHijackRoute=spHijackRoute, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUsage=spUsage, alertScript=alertScript, spDuration=spDuration, peakflowSPMgr=peakflowSPMgr, spBlackholeTimeout=spBlackholeTimeout, spDNSObservedMax=spDNSObservedMax, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPTraps=peakflowSPTraps, spHardwareFailureDescription=spHardwareFailureDescription, collectorUp=collectorUp, spFingerprintMessage=spFingerprintMessage, deviceSwapSpace=deviceSwapSpace, dosNetworkProfiledAlert=dosNetworkProfiledAlert, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spInterface=spInterface, fingerprintUsage=fingerprintUsage, mitigationTMSStart=mitigationTMSStart, bgpUp=bgpUp, greDownDone=greDownDone, spReportID=spReportID, spDNSObserved=spDNSObserved, spTMSPrefix=spTMSPrefix, reportDone=reportDone, spServiceElement=spServiceElement, spBlackholeCommunity=spBlackholeCommunity, bgpDown=bgpDown, spMitigationName=spMitigationName, spBGPTrapName=spBGPTrapName, fingerprintReceive=fingerprintReceive, mitigationFlowspecStart=mitigationFlowspecStart, spInterfaceUsage=spInterfaceUsage, spDetector=spDetector, bgpTrap=bgpTrap, deviceHealth=deviceHealth, spThirdPartyAddr=spThirdPartyAddr, spImpactPps=spImpactPps, spHijackLocal=spHijackLocal, spMitigationStart=spMitigationStart, spLicenseErrType=spLicenseErrType, fingerprintUsageDone=fingerprintUsageDone, spSystemErrorType=spSystemErrorType, spInetAddress=spInetAddress, configChange=configChange, spDetectedCountries=spDetectedCountries, spAlertID=spAlertID, spManagedObjects=spManagedObjects, greDown=greDown, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrLimit=spLicenseErrLimit, spTMSTimeout=spTMSTimeout, spDNSExpected=spDNSExpected, bgpInstabilityDone=bgpInstabilityDone, mitigationBlackholeStart=mitigationBlackholeStart, spReportName=spReportName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, peakflowSPMIB=peakflowSPMIB, spTMSCommunity=spTMSCommunity, bgpInstability=bgpInstability, deviceDiskUsage=deviceDiskUsage, spBGPInstability=spBGPInstability, spDNSName=spDNSName, spFingerprintName=spFingerprintName, deviceSystemError=deviceSystemError, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrCount=spLicenseErrCount, interfaceUsageDone=interfaceUsageDone, spUsername=spUsername, spInterfaceUsageHC=spInterfaceUsageHC, snmpUp=snmpUp, licenseError=licenseError, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapPrefix=spBGPTrapPrefix, snmpDown=snmpDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, routingFailover=routingFailover, serviceUsageDone=serviceUsageDone, spApplicationName=spApplicationName)
