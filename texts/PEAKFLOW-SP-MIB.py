...
Counter32, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, Counter64, iso, Gauge32, Unsigned32, Integer32, TimeTicks, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "iso", "Gauge32", "Unsigned32", "Integer32", "TimeTicks", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInterface=spInterface, spInterfaceSpeed=spInterfaceSpeed, spMitigationName=spMitigationName, spInterfaceSpeedHC=spInterfaceSpeedHC, dnsBaselineDone=dnsBaselineDone, spInetAddressType=spInetAddressType, interfaceUsageDone=interfaceUsageDone, peakflowSPTraps=peakflowSPTraps, spSystemErrorType=spSystemErrorType, spPravail=spPravail, spVersion=spVersion, spLicenseErrLimit=spLicenseErrLimit, snmpUp=snmpUp, greDownDone=greDownDone, spInterfaceUsageHC=spInterfaceUsageHC, bgpDown=bgpDown, spBGPTrapName=spBGPTrapName, peakflowSPMIB=peakflowSPMIB, deviceHealth=deviceHealth, spTMSMultiPrefix=spTMSMultiPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spHijackRoute=spHijackRoute, configChange=configChange, interfaceUsage=interfaceUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceSystemError=deviceSystemError, spTMSTimeout=spTMSTimeout, licenseErrorDone=licenseErrorDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUnit=spUnit, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPEvent=spBGPEvent, spManagedObjectFamily=spManagedObjectFamily, spServiceName=spServiceName, bgpInstabilityDone=bgpInstabilityDone, managedObjectUsageDone=managedObjectUsageDone, greDown=greDown, devicePhysicalMemory=devicePhysicalMemory, deviceSwapSpaceInUse=deviceSwapSpaceInUse, cloudSignalingFaultDone=cloudSignalingFaultDone, spFlowspecTimeout=spFlowspecTimeout, deviceTotalFlowsHC=deviceTotalFlowsHC, spcommFailure=spcommFailure, serviceUsage=serviceUsage, cloudSignalingFault=cloudSignalingFault, spBlackholePrefix=spBlackholePrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spReportID=spReportID, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, notificationLimit=notificationLimit, spDNSName=spDNSName, dnsBaseline=dnsBaseline, spGreTunnelDestination=spGreTunnelDestination, spDNSObservedMean=spDNSObservedMean, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpTrap=bgpTrap, hardwareFailureDone=hardwareFailureDone, deviceSwapSpace=deviceSwapSpace, spMitigationStart=spMitigationStart, fingerprintUsageDone=fingerprintUsageDone, spManagedObject=spManagedObject, collectorUp=collectorUp, bgpUp=bgpUp, spRouter=spRouter, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, licenseError=licenseError, fingerprintUsage=fingerprintUsage, mitigationFlowspecStart=mitigationFlowspecStart, spcommFailureDone=spcommFailureDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spServiceElement=spServiceElement, spInterfaceIndex=spInterfaceIndex, spUsername=spUsername, spInterfaceUsage=spInterfaceUsage, autoclassifyStart=autoclassifyStart, spReportURL=spReportURL, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintFeedback=spFingerprintFeedback, serviceUsageDone=serviceUsageDone, spScriptStart=spScriptStart, collectorStart=collectorStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceDiskUsage=deviceDiskUsage, flowDown=flowDown, spFlowspecCommunity=spFlowspecCommunity, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceTotalFlows=deviceTotalFlows, bgpInstability=bgpInstability, snmpDown=snmpDown, spDetectedCountries=spDetectedCountries, managedObjectUsage=managedObjectUsage, spFingerprintName=spFingerprintName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintReceive=fingerprintReceive, reportDone=reportDone, spBGPTrapEvent=spBGPTrapEvent, spUsageType=spUsageType, spManagedObjects=spManagedObjects, spBlackholeTimeout=spBlackholeTimeout, spLicenseErrCount=spLicenseErrCount, mitigationTMSStart=mitigationTMSStart, spBlackholeNexthop=spBlackholeNexthop, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintSender=spFingerprintSender, alertScript=alertScript, spSystemErrorDescription=spSystemErrorDescription, dosHostDetectionAlert=dosHostDetectionAlert, spInetAddress=spInetAddress, spCollector=spCollector, spDuration=spDuration, spScriptPort=spScriptPort, spHijackAttr=spHijackAttr, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrDescription=spLicenseErrDescription, spTMSCommunity=spTMSCommunity, spThirdPartyZone=spThirdPartyZone, spHardwareFailureDescription=spHardwareFailureDescription, trafficAutoMitigation=trafficAutoMitigation, spDNSExpected=spDNSExpected, peakflowSPMgr=peakflowSPMgr, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyAddr=spThirdPartyAddr, spApplicationName=spApplicationName, spLicenseErrType=spLicenseErrType, mitigationBlackholeStart=mitigationBlackholeStart, bgpHijack=bgpHijack, spDetector=spDetector, spHijackLocal=spHijackLocal, mitigationDone=mitigationDone, spBGPInstability=spBGPInstability, spThreshold=spThreshold, spDNSObserved=spDNSObserved, routingFailover=routingFailover, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptHost=spScriptHost, spBlackholeCommunity=spBlackholeCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, spGreTunnelName=spGreTunnelName, spImpactBps=spImpactBps, collectorDown=collectorDown, spFingerprintMessage=spFingerprintMessage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spTMSPrefix=spTMSPrefix, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, spScriptCommand=spScriptCommand, spReportName=spReportName, spCommFailureDescription=spCommFailureDescription, spImpactPps=spImpactPps, spDNSObservedMax=spDNSObservedMax, spAlertID=spAlertID, flowUp=flowUp, spUsage=spUsage, spMitigationID=spMitigationID, peakflowSPCMI=peakflowSPCMI)
