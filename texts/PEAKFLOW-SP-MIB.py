...
ModuleIdentity, MibIdentifier, Gauge32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, ObjectIdentity, iso, Integer32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Gauge32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "ObjectIdentity", "iso", "Integer32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpInstabilityDone=bgpInstabilityDone, spReportName=spReportName, spImpactBps=spImpactBps, spTMSCommunity=spTMSCommunity, collectorDown=collectorDown, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spMitigationID=spMitigationID, interfaceUsage=interfaceUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFlowspecCommunity=spFlowspecCommunity, spInterfaceUsage=spInterfaceUsage, spHijackLocal=spHijackLocal, fingerprintFeedback=fingerprintFeedback, spManagedObjectFamily=spManagedObjectFamily, mitigationDone=mitigationDone, spMitigationName=spMitigationName, bgpInstability=bgpInstability, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDetector=spDetector, spServiceName=spServiceName, spBGPInstability=spBGPInstability, spBlackholeCommunity=spBlackholeCommunity, spCommFailureDescription=spCommFailureDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, fingerprintReceive=fingerprintReceive, greDownDone=greDownDone, hardwareFailureDone=hardwareFailureDone, spUsername=spUsername, configChange=configChange, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dosHostDetectionAlert=dosHostDetectionAlert, spServiceElement=spServiceElement, spTMSPrefix=spTMSPrefix, spCollector=spCollector, spHijackRoute=spHijackRoute, devicePhysicalMemory=devicePhysicalMemory, spUsage=spUsage, spDNSObservedMax=spDNSObservedMax, spGreTunnelName=spGreTunnelName, spDetectedCountries=spDetectedCountries, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceSystemError=deviceSystemError, reportDone=reportDone, peakflowSPTraps=peakflowSPTraps, spDNSExpected=spDNSExpected, spMitigationStart=spMitigationStart, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPMIB=peakflowSPMIB, spLicenseErrType=spLicenseErrType, spFlowspecTimeout=spFlowspecTimeout, serviceUsageDone=serviceUsageDone, spVersion=spVersion, deviceSystemErrorDone=deviceSystemErrorDone, spCommFailureDestination=spCommFailureDestination, spBlackholePrefix=spBlackholePrefix, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpDown=bgpDown, spSystemErrorType=spSystemErrorType, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spFingerprintName=spFingerprintName, spcommFailureDone=spcommFailureDone, spDNSObservedMean=spDNSObservedMean, snmpUp=snmpUp, spReportURL=spReportURL, spThreshold=spThreshold, spTMSTimeout=spTMSTimeout, spPravail=spPravail, collectorUp=collectorUp, spLicenseErrCount=spLicenseErrCount, spAlertID=spAlertID, deviceTotalFlows=deviceTotalFlows, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceIndex=spInterfaceIndex, spManagedObject=spManagedObject, spLicenseErrDescription=spLicenseErrDescription, peakflowSPMgr=peakflowSPMgr, spFingerprintFeedback=spFingerprintFeedback, spScriptStart=spScriptStart, serviceUsage=serviceUsage, spGreTunnelDestination=spGreTunnelDestination, spHardwareFailureDescription=spHardwareFailureDescription, bgpTrap=bgpTrap, spInetAddress=spInetAddress, deviceSwapSpace=deviceSwapSpace, interfaceUsageDone=interfaceUsageDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingFault=cloudSignalingFault, spHijackAttr=spHijackAttr, deviceDiskUsage=deviceDiskUsage, managedObjectUsageDone=managedObjectUsageDone, spDNSObserved=spDNSObserved, collectorStart=collectorStart, mitigationBlackholeStart=mitigationBlackholeStart, PYSNMP_MODULE_ID=peakflowSPMIB, spThirdPartyAddr=spThirdPartyAddr, deviceHealth=deviceHealth, mitigationFlowspecStart=mitigationFlowspecStart, spInetAddressType=spInetAddressType, spcommFailure=spcommFailure, spRouter=spRouter, spUnit=spUnit, flowDown=flowDown, bgpHijack=bgpHijack, alertScript=alertScript, licenseErrorDone=licenseErrorDone, spInterfaceUsageHC=spInterfaceUsageHC, snmpDown=snmpDown, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, hardwareFailure=hardwareFailure, spInterface=spInterface, managedObjectUsage=managedObjectUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholeTimeout=spBlackholeTimeout, spManagedObjects=spManagedObjects, routingFailover=routingFailover, spScriptCommand=spScriptCommand, flowUp=flowUp, trafficAutoMitigation=trafficAutoMitigation, greDown=greDown, mitigationTMSStart=mitigationTMSStart, spUsageType=spUsageType, spApplicationName=spApplicationName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spLicenseErrLimit=spLicenseErrLimit, spScriptPort=spScriptPort, spThirdPartyZone=spThirdPartyZone, spFingerprintSender=spFingerprintSender, spBGPEvent=spBGPEvent, spDNSName=spDNSName, autoclassifyStart=autoclassifyStart, spReportID=spReportID, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spDuration=spDuration, peakflowSPCMI=peakflowSPCMI, spFingerprintMessage=spFingerprintMessage, bgpUp=bgpUp, spScriptHost=spScriptHost, spInterfaceSpeed=spInterfaceSpeed, spImpactPps=spImpactPps, dnsBaselineDone=dnsBaselineDone, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapEvent=spBGPTrapEvent, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBlackholeNexthop=spBlackholeNexthop, dnsBaseline=dnsBaseline, spBGPTrapName=spBGPTrapName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, fingerprintUsage=fingerprintUsage, notificationLimit=notificationLimit, spBGPTrapPrefix=spBGPTrapPrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, fingerprintUsageDone=fingerprintUsageDone, spSystemErrorDescription=spSystemErrorDescription, licenseError=licenseError, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSMultiPrefix=spTMSMultiPrefix)
