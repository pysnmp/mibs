...
Integer32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, TimeTicks, Counter32, ObjectIdentity, Bits, Gauge32, MibIdentifier, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "TimeTicks", "Counter32", "ObjectIdentity", "Bits", "Gauge32", "MibIdentifier", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", collectorDown=collectorDown, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, mitigationThirdPartyStart=mitigationThirdPartyStart, spUnit=spUnit, spManagedObject=spManagedObject, spHijackLocal=spHijackLocal, spDNSExpected=spDNSExpected, spDetector=spDetector, spBlackholeNexthop=spBlackholeNexthop, spBGPTrapEvent=spBGPTrapEvent, spDNSName=spDNSName, spScriptHost=spScriptHost, bgpUp=bgpUp, spManagedObjects=spManagedObjects, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, flowUp=flowUp, bgpTrap=bgpTrap, flowDown=flowDown, spBGPInstability=spBGPInstability, spInterfaceUsage=spInterfaceUsage, spTMSTimeout=spTMSTimeout, fingerprintReceive=fingerprintReceive, deviceHealth=deviceHealth, spMitigationName=spMitigationName, mitigationDone=mitigationDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, dnsBaselineDone=dnsBaselineDone, spFingerprintName=spFingerprintName, spUsage=spUsage, spDuration=spDuration, spcommFailure=spcommFailure, spHardwareFailureDescription=spHardwareFailureDescription, spBlackholeCommunity=spBlackholeCommunity, spScriptStart=spScriptStart, spBlackholePrefix=spBlackholePrefix, spLicenseErrCount=spLicenseErrCount, serviceUsage=serviceUsage, snmpUp=snmpUp, mitigationTMSStart=mitigationTMSStart, spDNSObserved=spDNSObserved, deviceSystemErrorDone=deviceSystemErrorDone, spInetAddressType=spInetAddressType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, fingerprintFeedback=fingerprintFeedback, spTMSMultiPrefix=spTMSMultiPrefix, spBGPEvent=spBGPEvent, cloudSignalingFaultDone=cloudSignalingFaultDone, autoclassifyStart=autoclassifyStart, spFlowspecCommunity=spFlowspecCommunity, spImpactBps=spImpactBps, spHijackAttr=spHijackAttr, deviceSystemError=deviceSystemError, spDNSObservedMax=spDNSObservedMax, collectorUp=collectorUp, mitigationFlowspecStart=mitigationFlowspecStart, spInterface=spInterface, reportDone=reportDone, interfaceUsageDone=interfaceUsageDone, spLicenseErrType=spLicenseErrType, spInterfaceSpeed=spInterfaceSpeed, spScriptPort=spScriptPort, spThirdPartyZone=spThirdPartyZone, snmpDown=snmpDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceTotalFlows=deviceTotalFlows, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpInstability=bgpInstability, mitigationBlackholeStart=mitigationBlackholeStart, greDown=greDown, serviceUsageDone=serviceUsageDone, managedObjectUsage=managedObjectUsage, spThreshold=spThreshold, cloudSignalingFault=cloudSignalingFault, spInetAddress=spInetAddress, hardwareFailure=hardwareFailure, greDownDone=greDownDone, spFingerprintFeedback=spFingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, spLicenseErrDescription=spLicenseErrDescription, spTMSCommunity=spTMSCommunity, spServiceElement=spServiceElement, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceSwapSpace=deviceSwapSpace, spTMSPrefix=spTMSPrefix, routingFailover=routingFailover, spGreTunnelDestination=spGreTunnelDestination, dnsBaseline=dnsBaseline, spBGPTrapPrefix=spBGPTrapPrefix, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapName=spBGPTrapName, spcommFailureDone=spcommFailureDone, spMitigationID=spMitigationID, spAlertID=spAlertID, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, peakflowSPMIB=peakflowSPMIB, spReportName=spReportName, spFingerprintSender=spFingerprintSender, spSystemErrorType=spSystemErrorType, spMitigationStart=spMitigationStart, spDNSObservedMean=spDNSObservedMean, trafficAutoMitigation=trafficAutoMitigation, spVersion=spVersion, spLicenseErrLimit=spLicenseErrLimit, spCollector=spCollector, collectorStart=collectorStart, notificationLimit=notificationLimit, spPravail=spPravail, fingerprintUsage=fingerprintUsage, spUsageType=spUsageType, spCommFailureDestination=spCommFailureDestination, spDetectedCountries=spDetectedCountries, spCommFailureDescription=spCommFailureDescription, devicePhysicalMemory=devicePhysicalMemory, spReportID=spReportID, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPCMI=peakflowSPCMI, mitigationTMSStartV2=mitigationTMSStartV2, bgpHijack=bgpHijack, spApplicationName=spApplicationName, spImpactPps=spImpactPps, deviceDiskUsage=deviceDiskUsage, licenseErrorDone=licenseErrorDone, spFingerprintMessage=spFingerprintMessage, spBlackholeTimeout=spBlackholeTimeout, configChange=configChange, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObjectFamily=spManagedObjectFamily, peakflowSPMgr=peakflowSPMgr, spInterfaceIndex=spInterfaceIndex, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, licenseError=licenseError, spUsername=spUsername, interfaceUsage=interfaceUsage, bgpDown=bgpDown, dosNetworkProfiledAlert=dosNetworkProfiledAlert, hardwareFailureDone=hardwareFailureDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterfaceUsageHC=spInterfaceUsageHC, spAlertDetectionSignatures=spAlertDetectionSignatures, spScriptCommand=spScriptCommand, spReportURL=spReportURL, spThirdPartyAddr=spThirdPartyAddr, spServiceName=spServiceName, spHijackRoute=spHijackRoute, alertScript=alertScript, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, peakflowSPTraps=peakflowSPTraps, spGreTunnelName=spGreTunnelName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spFlowspecTimeout=spFlowspecTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, managedObjectUsageDone=managedObjectUsageDone, spSystemErrorDescription=spSystemErrorDescription, bgpInstabilityDone=bgpInstabilityDone)
