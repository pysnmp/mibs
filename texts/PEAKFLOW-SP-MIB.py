...
Bits, MibIdentifier, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, TimeTicks, Counter32, iso, IpAddress, Counter64, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "TimeTicks", "Counter32", "iso", "IpAddress", "Counter64", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceIndex=spInterfaceIndex, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceDiskUsage=deviceDiskUsage, greDown=greDown, spFlowspecTimeout=spFlowspecTimeout, bgpUp=bgpUp, spPravail=spPravail, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, fingerprintUsageDone=fingerprintUsageDone, spDetectedCountries=spDetectedCountries, spLicenseErrType=spLicenseErrType, spDetector=spDetector, spBlackholeCommunity=spBlackholeCommunity, spServiceElement=spServiceElement, spLicenseErrLimit=spLicenseErrLimit, hardwareFailureDone=hardwareFailureDone, spHardwareFailureDescription=spHardwareFailureDescription, spcommFailureDone=spcommFailureDone, spReportID=spReportID, spFingerprintName=spFingerprintName, spFlowspecCommunity=spFlowspecCommunity, bgpTrap=bgpTrap, spUnit=spUnit, deviceHealth=deviceHealth, peakflowSPMIB=peakflowSPMIB, autoclassifyStart=autoclassifyStart, mitigationBlackholeStart=mitigationBlackholeStart, spMitigationID=spMitigationID, spInterfaceUsage=spInterfaceUsage, bgpHijack=bgpHijack, spDNSObserved=spDNSObserved, mitigationDone=mitigationDone, spManagedObject=spManagedObject, spInterface=spInterface, hardwareFailure=hardwareFailure, cloudSignalingFault=cloudSignalingFault, spBGPInstability=spBGPInstability, licenseError=licenseError, spTMSTimeout=spTMSTimeout, PYSNMP_MODULE_ID=peakflowSPMIB, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInetAddressType=spInetAddressType, alertScript=alertScript, spUsage=spUsage, spUsageType=spUsageType, spSystemErrorType=spSystemErrorType, spCollector=spCollector, spInterfaceSpeedHC=spInterfaceSpeedHC, cloudSignalingFaultDone=cloudSignalingFaultDone, spGreTunnelDestination=spGreTunnelDestination, mitigationTMSStart=mitigationTMSStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThreshold=spThreshold, spBGPTrapName=spBGPTrapName, mitigationThirdPartyStart=mitigationThirdPartyStart, spGreTunnelName=spGreTunnelName, dosHostDetectionAlert=dosHostDetectionAlert, deviceSystemError=deviceSystemError, deviceSwapSpaceUsage=deviceSwapSpaceUsage, reportDone=reportDone, spFingerprintFeedback=spFingerprintFeedback, spDNSObservedMax=spDNSObservedMax, fingerprintReceive=fingerprintReceive, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInetAddress=spInetAddress, mitigationFlowspecStart=mitigationFlowspecStart, devicePhysicalMemory=devicePhysicalMemory, spBGPTrapPrefix=spBGPTrapPrefix, spMitigationStart=spMitigationStart, spHijackRoute=spHijackRoute, bgpInstability=bgpInstability, serviceUsageDone=serviceUsageDone, spTMSMultiPrefix=spTMSMultiPrefix, mitigationTMSStartV2=mitigationTMSStartV2, spThirdPartyAddr=spThirdPartyAddr, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spcommFailure=spcommFailure, spBlackholePrefix=spBlackholePrefix, peakflowSPMgr=peakflowSPMgr, spSystemErrorDescription=spSystemErrorDescription, spAlertID=spAlertID, spHijackLocal=spHijackLocal, collectorStart=collectorStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spMitigationName=spMitigationName, snmpUp=snmpUp, collectorDown=collectorDown, greDownDone=greDownDone, spReportURL=spReportURL, spTMSCommunity=spTMSCommunity, spBlackholeNexthop=spBlackholeNexthop, interfaceUsage=interfaceUsage, spManagedObjectFamily=spManagedObjectFamily, spApplicationName=spApplicationName, fingerprintUsage=fingerprintUsage, spDNSName=spDNSName, spFingerprintMessage=spFingerprintMessage, spLicenseErrDescription=spLicenseErrDescription, spFingerprintSender=spFingerprintSender, spCommFailureDestination=spCommFailureDestination, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, managedObjectUsage=managedObjectUsage, interfaceUsageDone=interfaceUsageDone, fingerprintFeedback=fingerprintFeedback, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsername=spUsername, configChange=configChange, licenseErrorDone=licenseErrorDone, spReportName=spReportName, spLicenseErrCount=spLicenseErrCount, routingFailover=routingFailover, deviceSwapSpace=deviceSwapSpace, collectorUp=collectorUp, spBGPTrapEvent=spBGPTrapEvent, spTMSPrefix=spTMSPrefix, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spScriptCommand=spScriptCommand, spScriptPort=spScriptPort, dnsBaselineDone=dnsBaselineDone, spBGPEvent=spBGPEvent, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, notificationLimit=notificationLimit, deviceTotalFlows=deviceTotalFlows, bgpInstabilityDone=bgpInstabilityDone, peakflowSPTraps=peakflowSPTraps, spInterfaceSpeed=spInterfaceSpeed, spScriptHost=spScriptHost, spScriptStart=spScriptStart, spDuration=spDuration, spDNSExpected=spDNSExpected, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spHijackAttr=spHijackAttr, spDNSObservedMean=spDNSObservedMean, flowDown=flowDown, spManagedObjects=spManagedObjects, trafficAutoMitigation=trafficAutoMitigation, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSystemErrorDone=deviceSystemErrorDone, spImpactBps=spImpactBps, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, managedObjectUsageDone=managedObjectUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spCommFailureDescription=spCommFailureDescription, spThirdPartyZone=spThirdPartyZone, flowUp=flowUp, spImpactPps=spImpactPps, peakflowSPCMI=peakflowSPCMI, serviceUsage=serviceUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spRouter=spRouter, bgpDown=bgpDown, dnsBaseline=dnsBaseline, snmpDown=snmpDown, spVersion=spVersion, spServiceName=spServiceName)
