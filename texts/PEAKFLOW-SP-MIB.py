...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, TimeTicks, ModuleIdentity, Unsigned32, Integer32, Counter64, Gauge32, MibIdentifier, IpAddress, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "TimeTicks", "ModuleIdentity", "Unsigned32", "Integer32", "Counter64", "Gauge32", "MibIdentifier", "IpAddress", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapName=spBGPTrapName, devicePhysicalMemory=devicePhysicalMemory, spInterfaceSpeedHC=spInterfaceSpeedHC, spReportName=spReportName, spScriptStart=spScriptStart, collectorUp=collectorUp, spDetectedCountries=spDetectedCountries, spBlackholeTimeout=spBlackholeTimeout, bgpDown=bgpDown, spLicenseErrLimit=spLicenseErrLimit, spThirdPartyZone=spThirdPartyZone, deviceDiskUsage=deviceDiskUsage, spScriptCommand=spScriptCommand, spHijackRoute=spHijackRoute, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceSpeed=spInterfaceSpeed, spDetector=spDetector, bgpInstabilityDone=bgpInstabilityDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spcommFailureDone=spcommFailureDone, snmpDown=snmpDown, spManagedObjectFamily=spManagedObjectFamily, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFlowspecCommunity=spFlowspecCommunity, configChange=configChange, spcommFailure=spcommFailure, spManagedObjects=spManagedObjects, spTMSPrefix=spTMSPrefix, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceIndex=spInterfaceIndex, routingFailover=routingFailover, spCommFailureDescription=spCommFailureDescription, cloudSignalingFault=cloudSignalingFault, spServiceName=spServiceName, dnsBaselineDone=dnsBaselineDone, flowDown=flowDown, greDown=greDown, spInetAddressType=spInetAddressType, peakflowSPTraps=peakflowSPTraps, spSystemErrorType=spSystemErrorType, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationTMSStart=mitigationTMSStart, spAlertID=spAlertID, fingerprintReceive=fingerprintReceive, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyAddr=spThirdPartyAddr, spLicenseErrType=spLicenseErrType, spUnit=spUnit, PYSNMP_MODULE_ID=peakflowSPMIB, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFingerprintFeedback=spFingerprintFeedback, bgpUp=bgpUp, spDNSObservedMean=spDNSObservedMean, deviceSwapSpace=deviceSwapSpace, spHardwareFailureDescription=spHardwareFailureDescription, interfaceUsageDone=interfaceUsageDone, deviceTotalFlowsHC=deviceTotalFlowsHC, spBlackholePrefix=spBlackholePrefix, spPravail=spPravail, autoclassifyStart=autoclassifyStart, fingerprintUsageDone=fingerprintUsageDone, spDNSObservedMax=spDNSObservedMax, spManagedObject=spManagedObject, mitigationDone=mitigationDone, mitigationBlackholeStart=mitigationBlackholeStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, snmpUp=snmpUp, spVersion=spVersion, spMitigationID=spMitigationID, spHijackLocal=spHijackLocal, spBGPTrapPrefix=spBGPTrapPrefix, interfaceUsage=interfaceUsage, spTMSCommunity=spTMSCommunity, bgpTrap=bgpTrap, deviceTotalFlows=deviceTotalFlows, spInetAddress=spInetAddress, collectorDown=collectorDown, spDuration=spDuration, spScriptHost=spScriptHost, spCloudSignalFaultDescription=spCloudSignalFaultDescription, hardwareFailureDone=hardwareFailureDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spApplicationName=spApplicationName, alertScript=alertScript, greDownDone=greDownDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, reportDone=reportDone, spTMSTimeout=spTMSTimeout, fingerprintUsage=fingerprintUsage, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrCount=spLicenseErrCount, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spUsage=spUsage, spBlackholeNexthop=spBlackholeNexthop, notificationLimit=notificationLimit, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsername=spUsername, mitigationFlowspecStart=mitigationFlowspecStart, spImpactBps=spImpactBps, spGreTunnelName=spGreTunnelName, spMitigationStart=spMitigationStart, spReportID=spReportID, spFlowspecTimeout=spFlowspecTimeout, spImpactPps=spImpactPps, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosHostDetectionAlert=dosHostDetectionAlert, serviceUsage=serviceUsage, spScriptPort=spScriptPort, spInterface=spInterface, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSExpected=spDNSExpected, spDNSName=spDNSName, spCollector=spCollector, managedObjectUsageDone=managedObjectUsageDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, peakflowSPMIB=peakflowSPMIB, managedObjectUsage=managedObjectUsage, licenseError=licenseError, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spReportURL=spReportURL, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSystemError=deviceSystemError, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPInstability=spBGPInstability, spMitigationName=spMitigationName, deviceSystemErrorDone=deviceSystemErrorDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInterfaceUsage=spInterfaceUsage, peakflowSPCMI=peakflowSPCMI, peakflowSPMgr=peakflowSPMgr, bgpHijack=bgpHijack, spUsageType=spUsageType, serviceUsageDone=serviceUsageDone, fingerprintFeedback=fingerprintFeedback, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, bgpInstability=bgpInstability, hardwareFailure=hardwareFailure, trafficAutoMitigation=trafficAutoMitigation, spHijackAttr=spHijackAttr, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCommFailureDestination=spCommFailureDestination, spThreshold=spThreshold, spFingerprintSender=spFingerprintSender, flowUp=flowUp, spDNSObserved=spDNSObserved, deviceHealth=deviceHealth, licenseErrorDone=licenseErrorDone, spFingerprintName=spFingerprintName, spBGPEvent=spBGPEvent, spRouter=spRouter, dnsBaseline=dnsBaseline, spFingerprintMessage=spFingerprintMessage, spServiceElement=spServiceElement, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrDescription=spLicenseErrDescription, spTMSMultiPrefix=spTMSMultiPrefix, collectorStart=collectorStart, spBlackholeCommunity=spBlackholeCommunity, spSystemErrorDescription=spSystemErrorDescription)
