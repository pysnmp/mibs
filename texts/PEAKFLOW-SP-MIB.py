...
Unsigned32, ModuleIdentity, Counter32, Bits, ObjectIdentity, iso, NotificationType, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter32", "Bits", "ObjectIdentity", "iso", "NotificationType", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapPrefix=spBGPTrapPrefix, spManagedObjects=spManagedObjects, deviceSystemError=deviceSystemError, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, fingerprintReceive=fingerprintReceive, devicePhysicalMemory=devicePhysicalMemory, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSCommunity=spTMSCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBlackholePrefix=spBlackholePrefix, snmpDown=snmpDown, bgpHijack=bgpHijack, bgpUp=bgpUp, collectorUp=collectorUp, spcommFailure=spcommFailure, spUsageType=spUsageType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceDiskUsage=deviceDiskUsage, spGreTunnelDestination=spGreTunnelDestination, spBlackholeTimeout=spBlackholeTimeout, spInterfaceUsageHC=spInterfaceUsageHC, spLicenseErrDescription=spLicenseErrDescription, dosHostDetectionAlert=dosHostDetectionAlert, spReportID=spReportID, spHijackAttr=spHijackAttr, peakflowSPMIB=peakflowSPMIB, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationDone=mitigationDone, spFlowspecTimeout=spFlowspecTimeout, interfaceUsage=interfaceUsage, spLicenseErrCount=spLicenseErrCount, licenseErrorDone=licenseErrorDone, spBGPTrapName=spBGPTrapName, spBlackholeCommunity=spBlackholeCommunity, mitigationFlowspecStart=mitigationFlowspecStart, spUsername=spUsername, peakflowSPCMI=peakflowSPCMI, hardwareFailureDone=hardwareFailureDone, spScriptHost=spScriptHost, reportDone=reportDone, mitigationTMSStart=mitigationTMSStart, spInetAddress=spInetAddress, spServiceName=spServiceName, spFlowspecCommunity=spFlowspecCommunity, fingerprintUsageDone=fingerprintUsageDone, spScriptCommand=spScriptCommand, spServiceElement=spServiceElement, spLicenseErrType=spLicenseErrType, serviceUsage=serviceUsage, greDownDone=greDownDone, spInetAddressType=spInetAddressType, managedObjectUsageDone=managedObjectUsageDone, spImpactBps=spImpactBps, flowUp=flowUp, collectorDown=collectorDown, spTMSPrefix=spTMSPrefix, notificationLimit=notificationLimit, spThirdPartyZone=spThirdPartyZone, collectorStart=collectorStart, spInterfaceIndex=spInterfaceIndex, spRouter=spRouter, spInterfaceSpeed=spInterfaceSpeed, spBGPInstability=spBGPInstability, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationBlackholeStart=mitigationBlackholeStart, interfaceUsageDone=interfaceUsageDone, spCollector=spCollector, spBlackholeNexthop=spBlackholeNexthop, spPravail=spPravail, greDown=greDown, deviceHealth=deviceHealth, spDNSObserved=spDNSObserved, deviceTotalFlowsHC=deviceTotalFlowsHC, spApplicationName=spApplicationName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFault=cloudSignalingFault, licenseError=licenseError, flowDown=flowDown, configChange=configChange, spSystemErrorDescription=spSystemErrorDescription, fingerprintFeedback=fingerprintFeedback, spInterface=spInterface, spUnit=spUnit, spThreshold=spThreshold, serviceUsageDone=serviceUsageDone, spGreTunnelName=spGreTunnelName, deviceSystemErrorDone=deviceSystemErrorDone, spMitigationName=spMitigationName, routingFailover=routingFailover, alertScript=alertScript, spVersion=spVersion, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptStart=spScriptStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, autoclassifyStart=autoclassifyStart, spUsage=spUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDetector=spDetector, trafficAutoMitigation=trafficAutoMitigation, spDetectedCountries=spDetectedCountries, spHijackLocal=spHijackLocal, spAlertDetectionSignatures=spAlertDetectionSignatures, hardwareFailure=hardwareFailure, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, snmpUp=snmpUp, spDuration=spDuration, spReportName=spReportName, spMitigationStart=spMitigationStart, spCommFailureDescription=spCommFailureDescription, spHardwareFailureDescription=spHardwareFailureDescription, spMitigationID=spMitigationID, spDNSObservedMax=spDNSObservedMax, spAlertID=spAlertID, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintUsage=fingerprintUsage, deviceSwapSpace=deviceSwapSpace, spScriptPort=spScriptPort, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpInstability=bgpInstability, managedObjectUsage=managedObjectUsage, mitigationTMSStartV2=mitigationTMSStartV2, dnsBaselineDone=dnsBaselineDone, bgpInstabilityDone=bgpInstabilityDone, spInterfaceSpeedHC=spInterfaceSpeedHC, bgpTrap=bgpTrap, spDNSObservedMean=spDNSObservedMean, spDNSExpected=spDNSExpected, peakflowSPMgr=peakflowSPMgr, spReportURL=spReportURL, spManagedObjectFamily=spManagedObjectFamily, spFingerprintSender=spFingerprintSender, spDNSName=spDNSName, spCommFailureDestination=spCommFailureDestination, spHijackRoute=spHijackRoute, spInterfaceUsage=spInterfaceUsage, spManagedObject=spManagedObject, bgpDown=bgpDown, spFingerprintFeedback=spFingerprintFeedback, spFingerprintName=spFingerprintName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spThirdPartyAddr=spThirdPartyAddr, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spImpactPps=spImpactPps, PYSNMP_MODULE_ID=peakflowSPMIB, spSystemErrorType=spSystemErrorType, spFingerprintMessage=spFingerprintMessage, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPTraps=peakflowSPTraps, spBGPEvent=spBGPEvent, spBGPTrapEvent=spBGPTrapEvent, spTMSTimeout=spTMSTimeout, spLicenseErrLimit=spLicenseErrLimit, spcommFailureDone=spcommFailureDone, dnsBaseline=dnsBaseline, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceTotalFlows=deviceTotalFlows)
