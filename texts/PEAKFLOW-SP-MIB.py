...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Unsigned32, Bits, MibIdentifier, TimeTicks, NotificationType, Counter32, ModuleIdentity, IpAddress, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "ModuleIdentity", "IpAddress", "Integer32", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, collectorStart=collectorStart, dnsBaseline=dnsBaseline, snmpUp=snmpUp, spDNSExpected=spDNSExpected, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spSystemErrorType=spSystemErrorType, deviceHealth=deviceHealth, managedObjectUsageDone=managedObjectUsageDone, fingerprintReceive=fingerprintReceive, spBGPInstability=spBGPInstability, spInterfaceUsageHC=spInterfaceUsageHC, spBlackholeNexthop=spBlackholeNexthop, mitigationTMSStartV2=mitigationTMSStartV2, deviceDiskUsage=deviceDiskUsage, spHijackRoute=spHijackRoute, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, cloudSignalingFaultDone=cloudSignalingFaultDone, licenseErrorDone=licenseErrorDone, spBlackholeCommunity=spBlackholeCommunity, spUnit=spUnit, managedObjectUsage=managedObjectUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThreshold=spThreshold, spImpactPps=spImpactPps, spInterfaceIndex=spInterfaceIndex, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spLicenseErrLimit=spLicenseErrLimit, spBGPTrapEvent=spBGPTrapEvent, spSystemErrorDescription=spSystemErrorDescription, hardwareFailure=hardwareFailure, spManagedObjects=spManagedObjects, peakflowSPCMI=peakflowSPCMI, spGreTunnelName=spGreTunnelName, spScriptCommand=spScriptCommand, spBlackholeTimeout=spBlackholeTimeout, spMitigationStart=spMitigationStart, interfaceUsageDone=interfaceUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spUsername=spUsername, deviceSystemErrorDone=deviceSystemErrorDone, deviceTotalFlows=deviceTotalFlows, spBGPTrapOldAttributes=spBGPTrapOldAttributes, cloudSignalingFault=cloudSignalingFault, spTMSCommunity=spTMSCommunity, greDownDone=greDownDone, spDNSObservedMax=spDNSObservedMax, serviceUsage=serviceUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, reportDone=reportDone, spHijackAttr=spHijackAttr, spBGPTrapPrefix=spBGPTrapPrefix, spDetectedCountries=spDetectedCountries, autoclassifyStart=autoclassifyStart, collectorDown=collectorDown, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSPrefix=spTMSPrefix, spUsageType=spUsageType, deviceSwapSpace=deviceSwapSpace, routingFailover=routingFailover, licenseError=licenseError, bgpUp=bgpUp, spGreTunnelDestination=spGreTunnelDestination, spFingerprintName=spFingerprintName, spHijackLocal=spHijackLocal, spServiceElement=spServiceElement, spLicenseErrDescription=spLicenseErrDescription, mitigationTMSStart=mitigationTMSStart, spApplicationName=spApplicationName, spCommFailureDestination=spCommFailureDestination, spFlowspecTimeout=spFlowspecTimeout, spInterfaceUsage=spInterfaceUsage, spFingerprintMessage=spFingerprintMessage, spDNSObserved=spDNSObserved, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObject=spManagedObject, spCommFailureDescription=spCommFailureDescription, spRouter=spRouter, bgpInstabilityDone=bgpInstabilityDone, mitigationFlowspecStart=mitigationFlowspecStart, deviceTotalFlowsHC=deviceTotalFlowsHC, configChange=configChange, spLicenseErrType=spLicenseErrType, spcommFailureDone=spcommFailureDone, peakflowSPMIB=peakflowSPMIB, spThirdPartyAddr=spThirdPartyAddr, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPTrapName=spBGPTrapName, peakflowSPTraps=peakflowSPTraps, spLicenseErrCount=spLicenseErrCount, bgpDown=bgpDown, spDNSName=spDNSName, spInetAddress=spInetAddress, spDNSObservedMean=spDNSObservedMean, spMitigationName=spMitigationName, spScriptStart=spScriptStart, spBlackholePrefix=spBlackholePrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, interfaceUsage=interfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, spcommFailure=spcommFailure, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spUsage=spUsage, spReportName=spReportName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptPort=spScriptPort, serviceUsageDone=serviceUsageDone, snmpDown=snmpDown, spReportURL=spReportURL, spInterfaceSpeedHC=spInterfaceSpeedHC, spInetAddressType=spInetAddressType, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, fingerprintFeedback=fingerprintFeedback, peakflowSPMgr=peakflowSPMgr, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, trafficAutoMitigation=trafficAutoMitigation, bgpTrap=bgpTrap, spAlertID=spAlertID, flowDown=flowDown, spInterface=spInterface, spMitigationID=spMitigationID, spHardwareFailureDescription=spHardwareFailureDescription, spDetector=spDetector, devicePhysicalMemory=devicePhysicalMemory, spPravail=spPravail, spServiceName=spServiceName, greDown=greDown, alertScript=alertScript, bgpHijack=bgpHijack, notificationLimit=notificationLimit, spFingerprintSender=spFingerprintSender, spFlowspecCommunity=spFlowspecCommunity, spVersion=spVersion, spCollector=spCollector, spManagedObjectFamily=spManagedObjectFamily, spTMSTimeout=spTMSTimeout, spThirdPartyZone=spThirdPartyZone, spBGPEvent=spBGPEvent, dosHostDetectionAlert=dosHostDetectionAlert, spDuration=spDuration, spTMSMultiPrefix=spTMSMultiPrefix, spScriptHost=spScriptHost, spImpactBps=spImpactBps, spReportID=spReportID, fingerprintUsage=fingerprintUsage, spFingerprintFeedback=spFingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, flowUp=flowUp, bgpInstability=bgpInstability, mitigationDone=mitigationDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSystemError=deviceSystemError, dosNetworkProfiledAlert=dosNetworkProfiledAlert, dnsBaselineDone=dnsBaselineDone, hardwareFailureDone=hardwareFailureDone, collectorUp=collectorUp)
