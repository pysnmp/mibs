...
Counter32, iso, Counter64, Unsigned32, NotificationType, Bits, Gauge32, Integer32, TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Counter64", "Unsigned32", "NotificationType", "Bits", "Gauge32", "Integer32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrType=spLicenseErrType, deviceTotalFlows=deviceTotalFlows, deviceSwapSpace=deviceSwapSpace, spFingerprintName=spFingerprintName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spScriptPort=spScriptPort, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spMitigationStart=spMitigationStart, spBlackholeCommunity=spBlackholeCommunity, deviceDiskUsage=deviceDiskUsage, spMitigationID=spMitigationID, spInterfaceIndex=spInterfaceIndex, spBlackholePrefix=spBlackholePrefix, spRouter=spRouter, deviceSystemError=deviceSystemError, spInetAddress=spInetAddress, deviceHealth=deviceHealth, spBlackholeNexthop=spBlackholeNexthop, deviceTotalFlowsHC=deviceTotalFlowsHC, spcommFailure=spcommFailure, spManagedObjects=spManagedObjects, alertScript=alertScript, autoclassifyStart=autoclassifyStart, collectorStart=collectorStart, spServiceName=spServiceName, peakflowSPMgr=peakflowSPMgr, spScriptHost=spScriptHost, spTMSTimeout=spTMSTimeout, fingerprintReceive=fingerprintReceive, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spPravail=spPravail, configChange=configChange, collectorUp=collectorUp, spInterfaceUsageHC=spInterfaceUsageHC, spLicenseErrDescription=spLicenseErrDescription, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUsername=spUsername, fingerprintUsageDone=fingerprintUsageDone, spBGPEvent=spBGPEvent, spHijackLocal=spHijackLocal, spTMSCommunity=spTMSCommunity, peakflowSPCMI=peakflowSPCMI, serviceUsage=serviceUsage, spDNSObserved=spDNSObserved, peakflowSPMIB=peakflowSPMIB, spLicenseErrLimit=spLicenseErrLimit, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptStart=spScriptStart, spDNSObservedMax=spDNSObservedMax, licenseError=licenseError, spCommFailureDestination=spCommFailureDestination, spInterface=spInterface, spUsageType=spUsageType, spTMSPrefix=spTMSPrefix, spTMSMultiPrefix=spTMSMultiPrefix, dnsBaselineDone=dnsBaselineDone, spScriptCommand=spScriptCommand, managedObjectUsage=managedObjectUsage, devicePhysicalMemory=devicePhysicalMemory, spManagedObjectFamily=spManagedObjectFamily, spHardwareFailureDescription=spHardwareFailureDescription, spDetectedCountries=spDetectedCountries, spcommFailureDone=spcommFailureDone, notificationLimit=notificationLimit, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spLicenseErrCount=spLicenseErrCount, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapName=spBGPTrapName, spManagedObject=spManagedObject, PYSNMP_MODULE_ID=peakflowSPMIB, licenseErrorDone=licenseErrorDone, mitigationBlackholeStart=mitigationBlackholeStart, spDNSObservedMean=spDNSObservedMean, fingerprintUsage=fingerprintUsage, mitigationTMSStartV2=mitigationTMSStartV2, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spUnit=spUnit, interfaceUsage=interfaceUsage, trafficAutoMitigation=trafficAutoMitigation, bgpInstability=bgpInstability, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpDown=bgpDown, spFlowspecCommunity=spFlowspecCommunity, spReportURL=spReportURL, greDown=greDown, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceSpeed=spInterfaceSpeed, serviceUsageDone=serviceUsageDone, spDNSName=spDNSName, deviceSystemErrorDone=deviceSystemErrorDone, spMitigationName=spMitigationName, flowUp=flowUp, cloudSignalingFault=cloudSignalingFault, spSystemErrorType=spSystemErrorType, spVersion=spVersion, bgpHijack=bgpHijack, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpTrap=bgpTrap, managedObjectUsageDone=managedObjectUsageDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dosHostDetectionAlert=dosHostDetectionAlert, spReportName=spReportName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spThreshold=spThreshold, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintFeedback=fingerprintFeedback, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapPrefix=spBGPTrapPrefix, spDetector=spDetector, spInterfaceUsage=spInterfaceUsage, mitigationFlowspecStart=mitigationFlowspecStart, spInterfaceSpeedHC=spInterfaceSpeedHC, snmpUp=snmpUp, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spFingerprintMessage=spFingerprintMessage, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapEvent=spBGPTrapEvent, spDNSExpected=spDNSExpected, spFingerprintSender=spFingerprintSender, greDownDone=greDownDone, mitigationDone=mitigationDone, spFingerprintFeedback=spFingerprintFeedback, spUsage=spUsage, spInetAddressType=spInetAddressType, spReportID=spReportID, spImpactPps=spImpactPps, peakflowSPTraps=peakflowSPTraps, routingFailover=routingFailover, bgpUp=bgpUp, hardwareFailureDone=hardwareFailureDone, spCollector=spCollector, spImpactBps=spImpactBps, spGreTunnelName=spGreTunnelName, spHijackRoute=spHijackRoute, spSystemErrorDescription=spSystemErrorDescription, collectorDown=collectorDown, spAlertDetectionSignatures=spAlertDetectionSignatures, spThirdPartyZone=spThirdPartyZone, mitigationTMSStart=mitigationTMSStart, bgpInstabilityDone=bgpInstabilityDone, spAlertID=spAlertID, spHijackAttr=spHijackAttr, spApplicationName=spApplicationName, spBGPInstability=spBGPInstability, snmpDown=snmpDown, spBlackholeTimeout=spBlackholeTimeout, dnsBaseline=dnsBaseline, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spDuration=spDuration, spCommFailureDescription=spCommFailureDescription, flowDown=flowDown, reportDone=reportDone, spServiceElement=spServiceElement, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, hardwareFailure=hardwareFailure, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min)
