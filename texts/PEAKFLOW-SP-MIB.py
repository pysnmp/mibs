...
ObjectIdentity, Gauge32, Bits, IpAddress, iso, Counter64, MibIdentifier, TimeTicks, Unsigned32, NotificationType, Counter32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Bits", "IpAddress", "iso", "Counter64", "MibIdentifier", "TimeTicks", "Unsigned32", "NotificationType", "Counter32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spManagedObjects=spManagedObjects, spManagedObject=spManagedObject, spHardwareFailureDescription=spHardwareFailureDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, fingerprintReceive=fingerprintReceive, spInterfaceUsageHC=spInterfaceUsageHC, spBlackholeTimeout=spBlackholeTimeout, deviceSystemError=deviceSystemError, dosHostDetectionAlert=dosHostDetectionAlert, spDNSObserved=spDNSObserved, interfaceUsageDone=interfaceUsageDone, spBGPEvent=spBGPEvent, spInterfaceIndex=spInterfaceIndex, peakflowSPCMI=peakflowSPCMI, hardwareFailure=hardwareFailure, spInterfaceSpeed=spInterfaceSpeed, spUsageType=spUsageType, spThirdPartyAddr=spThirdPartyAddr, collectorUp=collectorUp, managedObjectUsage=managedObjectUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, devicePhysicalMemory=devicePhysicalMemory, spReportName=spReportName, spHijackAttr=spHijackAttr, licenseError=licenseError, spCommFailureDescription=spCommFailureDescription, spDNSExpected=spDNSExpected, spServiceName=spServiceName, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, fingerprintUsageDone=fingerprintUsageDone, spTMSMultiPrefix=spTMSMultiPrefix, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, trafficAutoMitigation=trafficAutoMitigation, PYSNMP_MODULE_ID=peakflowSPMIB, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, snmpDown=snmpDown, autoclassifyStart=autoclassifyStart, deviceSystemErrorDone=deviceSystemErrorDone, spCommFailureDestination=spCommFailureDestination, spServiceElement=spServiceElement, spBGPTrapName=spBGPTrapName, mitigationTMSStartV2=mitigationTMSStartV2, spTMSTimeout=spTMSTimeout, spInterface=spInterface, greDownDone=greDownDone, greDown=greDown, deviceSwapSpace=deviceSwapSpace, serviceUsageDone=serviceUsageDone, dnsBaselineDone=dnsBaselineDone, spMitigationName=spMitigationName, spReportID=spReportID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spApplicationName=spApplicationName, spScriptCommand=spScriptCommand, spCollector=spCollector, mitigationTMSStart=mitigationTMSStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spRouter=spRouter, spScriptStart=spScriptStart, notificationLimit=notificationLimit, deviceTotalFlows=deviceTotalFlows, spFlowspecCommunity=spFlowspecCommunity, peakflowSPTraps=peakflowSPTraps, licenseErrorDone=licenseErrorDone, bgpInstability=bgpInstability, spBGPInstability=spBGPInstability, fingerprintUsage=fingerprintUsage, flowDown=flowDown, spUsage=spUsage, peakflowSPMgr=peakflowSPMgr, spBlackholeNexthop=spBlackholeNexthop, spUnit=spUnit, routingFailover=routingFailover, spReportURL=spReportURL, collectorDown=collectorDown, spSystemErrorType=spSystemErrorType, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spThreshold=spThreshold, spGreTunnelDestination=spGreTunnelDestination, spHijackLocal=spHijackLocal, managedObjectUsageDone=managedObjectUsageDone, alertScript=alertScript, serviceUsage=serviceUsage, bgpInstabilityDone=bgpInstabilityDone, bgpHijack=bgpHijack, snmpUp=snmpUp, spcommFailure=spcommFailure, peakflowSPMIB=peakflowSPMIB, spBGPTrapEvent=spBGPTrapEvent, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPTrapOldAttributes=spBGPTrapOldAttributes, configChange=configChange, spMitigationStart=spMitigationStart, spcommFailureDone=spcommFailureDone, spDuration=spDuration, spThirdPartyZone=spThirdPartyZone, hardwareFailureDone=hardwareFailureDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spDetector=spDetector, spHijackRoute=spHijackRoute, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spFlowspecTimeout=spFlowspecTimeout, spImpactPps=spImpactPps, bgpTrap=bgpTrap, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, cloudSignalingFault=cloudSignalingFault, spInetAddressType=spInetAddressType, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholePrefix=spBlackholePrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsername=spUsername, spMitigationID=spMitigationID, spBGPTrapPrefix=spBGPTrapPrefix, spFingerprintFeedback=spFingerprintFeedback, spLicenseErrCount=spLicenseErrCount, spInterfaceUsage=spInterfaceUsage, fingerprintFeedback=fingerprintFeedback, mitigationDone=mitigationDone, spFingerprintMessage=spFingerprintMessage, spPravail=spPravail, bgpUp=bgpUp, mitigationBlackholeStart=mitigationBlackholeStart, spAlertID=spAlertID, spBlackholeCommunity=spBlackholeCommunity, spTMSPrefix=spTMSPrefix, spDNSName=spDNSName, spFingerprintName=spFingerprintName, collectorStart=collectorStart, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceDiskUsage=deviceDiskUsage, spLicenseErrLimit=spLicenseErrLimit, spInetAddress=spInetAddress, reportDone=reportDone, flowUp=flowUp, spVersion=spVersion, spDNSObservedMax=spDNSObservedMax, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceHealth=deviceHealth, spFingerprintSender=spFingerprintSender, spDetectedCountries=spDetectedCountries, spDNSObservedMean=spDNSObservedMean, spScriptPort=spScriptPort, mitigationFlowspecStart=mitigationFlowspecStart, bgpDown=bgpDown, dnsBaseline=dnsBaseline, spTMSCommunity=spTMSCommunity, spScriptHost=spScriptHost, interfaceUsage=interfaceUsage, spLicenseErrType=spLicenseErrType, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spImpactBps=spImpactBps, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spSystemErrorDescription=spSystemErrorDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spGreTunnelName=spGreTunnelName, spManagedObjectFamily=spManagedObjectFamily)
