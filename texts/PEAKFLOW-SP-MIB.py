...
Bits, Unsigned32, Integer32, ObjectIdentity, TimeTicks, Counter64, iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Integer32", "ObjectIdentity", "TimeTicks", "Counter64", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpHijack=bgpHijack, hardwareFailureDone=hardwareFailureDone, interfaceUsage=interfaceUsage, spInterfaceSpeed=spInterfaceSpeed, spServiceName=spServiceName, serviceUsageDone=serviceUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptStart=spScriptStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, snmpUp=snmpUp, spThirdPartyAddr=spThirdPartyAddr, deviceDiskUsage=deviceDiskUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spMitigationStart=spMitigationStart, spLicenseErrCount=spLicenseErrCount, reportDone=reportDone, dnsBaseline=dnsBaseline, spCommFailureDestination=spCommFailureDestination, spDNSObserved=spDNSObserved, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spRouter=spRouter, spManagedObjectFamily=spManagedObjectFamily, greDownDone=greDownDone, spLicenseErrLimit=spLicenseErrLimit, spScriptHost=spScriptHost, spcommFailure=spcommFailure, spHijackLocal=spHijackLocal, spBlackholeTimeout=spBlackholeTimeout, trafficAutoMitigation=trafficAutoMitigation, deviceTotalFlows=deviceTotalFlows, collectorDown=collectorDown, spDNSObservedMean=spDNSObservedMean, spCollector=spCollector, spMitigationName=spMitigationName, spMitigationID=spMitigationID, spUnit=spUnit, spInterfaceSpeedHC=spInterfaceSpeedHC, spScriptPort=spScriptPort, spDuration=spDuration, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintUsage=fingerprintUsage, spManagedObjects=spManagedObjects, autoclassifyStart=autoclassifyStart, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, collectorStart=collectorStart, mitigationTMSStartV2=mitigationTMSStartV2, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInetAddressType=spInetAddressType, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationDone=mitigationDone, bgpInstabilityDone=bgpInstabilityDone, spDNSName=spDNSName, bgpInstability=bgpInstability, mitigationFlowspecStart=mitigationFlowspecStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spSystemErrorType=spSystemErrorType, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spHijackAttr=spHijackAttr, spAlertID=spAlertID, spServiceElement=spServiceElement, cloudSignalingFaultDone=cloudSignalingFaultDone, greDown=greDown, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapPrefix=spBGPTrapPrefix, spFlowspecTimeout=spFlowspecTimeout, bgpUp=bgpUp, licenseError=licenseError, spReportName=spReportName, spInetAddress=spInetAddress, spVersion=spVersion, devicePhysicalMemory=devicePhysicalMemory, spImpactBps=spImpactBps, spImpactPps=spImpactPps, bgpDown=bgpDown, alertScript=alertScript, spInterfaceUsage=spInterfaceUsage, dnsBaselineDone=dnsBaselineDone, spManagedObject=spManagedObject, peakflowSPTraps=peakflowSPTraps, spPravail=spPravail, fingerprintUsageDone=fingerprintUsageDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spFingerprintSender=spFingerprintSender, hardwareFailure=hardwareFailure, bgpTrap=bgpTrap, spDNSExpected=spDNSExpected, cloudSignalingFault=cloudSignalingFault, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosHostDetectionAlertDone=dosHostDetectionAlertDone, managedObjectUsageDone=managedObjectUsageDone, spFingerprintName=spFingerprintName, spLicenseErrDescription=spLicenseErrDescription, spCommFailureDescription=spCommFailureDescription, configChange=configChange, spInterfaceUsageHC=spInterfaceUsageHC, spTMSCommunity=spTMSCommunity, spGreTunnelName=spGreTunnelName, PYSNMP_MODULE_ID=peakflowSPMIB, peakflowSPMgr=peakflowSPMgr, collectorUp=collectorUp, managedObjectUsage=managedObjectUsage, licenseErrorDone=licenseErrorDone, spLicenseErrType=spLicenseErrType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, serviceUsage=serviceUsage, spFlowspecCommunity=spFlowspecCommunity, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlert=dosHostDetectionAlert, spUsageType=spUsageType, spHijackRoute=spHijackRoute, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintReceive=fingerprintReceive, routingFailover=routingFailover, peakflowSPMIB=peakflowSPMIB, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPCMI=peakflowSPCMI, spBGPInstability=spBGPInstability, spTMSTimeout=spTMSTimeout, mitigationTMSStart=mitigationTMSStart, spThreshold=spThreshold, spBGPTrapEvent=spBGPTrapEvent, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPEvent=spBGPEvent, spDNSObservedMax=spDNSObservedMax, spBGPTrapName=spBGPTrapName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSystemError=deviceSystemError, flowDown=flowDown, spFingerprintFeedback=spFingerprintFeedback, spReportID=spReportID, spHardwareFailureDescription=spHardwareFailureDescription, spReportURL=spReportURL, spBlackholeCommunity=spBlackholeCommunity, spBlackholeNexthop=spBlackholeNexthop, mitigationBlackholeStart=mitigationBlackholeStart, flowUp=flowUp, snmpDown=snmpDown, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDetector=spDetector, deviceTotalFlowsHC=deviceTotalFlowsHC, spApplicationName=spApplicationName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spGreTunnelDestination=spGreTunnelDestination, interfaceUsageDone=interfaceUsageDone, spFingerprintMessage=spFingerprintMessage, notificationLimit=notificationLimit, spTMSPrefix=spTMSPrefix, spBlackholePrefix=spBlackholePrefix, spTMSMultiPrefix=spTMSMultiPrefix, spcommFailureDone=spcommFailureDone, spDetectedCountries=spDetectedCountries, deviceSwapSpace=deviceSwapSpace, deviceHealth=deviceHealth, spScriptCommand=spScriptCommand, spInterfaceIndex=spInterfaceIndex, spUsername=spUsername, spThirdPartyZone=spThirdPartyZone, spUsage=spUsage, spInterface=spInterface, spSystemErrorDescription=spSystemErrorDescription)
