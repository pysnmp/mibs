...
ObjectIdentity, Counter32, IpAddress, TimeTicks, NotificationType, Counter64, Unsigned32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "NotificationType", "Counter64", "Unsigned32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spSystemErrorDescription=spSystemErrorDescription, mitigationDone=mitigationDone, snmpUp=snmpUp, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spSystemErrorType=spSystemErrorType, hardwareFailureDone=hardwareFailureDone, spManagedObjects=spManagedObjects, spServiceName=spServiceName, fingerprintUsage=fingerprintUsage, spCommFailureDestination=spCommFailureDestination, spHijackLocal=spHijackLocal, bgpInstability=bgpInstability, spScriptStart=spScriptStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spThreshold=spThreshold, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpHijack=bgpHijack, spcommFailureDone=spcommFailureDone, spReportURL=spReportURL, spApplicationName=spApplicationName, spInterfaceUsageHC=spInterfaceUsageHC, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDetector=spDetector, peakflowSPMIB=peakflowSPMIB, spVersion=spVersion, dnsBaselineDone=dnsBaselineDone, spBGPTrapEvent=spBGPTrapEvent, bgpInstabilityDone=bgpInstabilityDone, reportDone=reportDone, spManagedObjectFamily=spManagedObjectFamily, flowUp=flowUp, mitigationBlackholeStart=mitigationBlackholeStart, spDNSObservedMax=spDNSObservedMax, spUnit=spUnit, alertScript=alertScript, peakflowSPTraps=peakflowSPTraps, deviceHealth=deviceHealth, interfaceUsage=interfaceUsage, spBlackholeTimeout=spBlackholeTimeout, spImpactPps=spImpactPps, spcommFailure=spcommFailure, spGreTunnelDestination=spGreTunnelDestination, fingerprintReceive=fingerprintReceive, bgpDown=bgpDown, mitigationThirdPartyStart=mitigationThirdPartyStart, spDetectedCountries=spDetectedCountries, spTMSPrefix=spTMSPrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, serviceUsage=serviceUsage, spDNSObserved=spDNSObserved, spHijackAttr=spHijackAttr, collectorDown=collectorDown, spTMSCommunity=spTMSCommunity, spBGPTrapName=spBGPTrapName, spImpactBps=spImpactBps, hardwareFailure=hardwareFailure, spRouter=spRouter, mitigationTMSStartV2=mitigationTMSStartV2, bgpUp=bgpUp, configChange=configChange, bgpTrap=bgpTrap, spInterface=spInterface, spLicenseErrType=spLicenseErrType, spTMSTimeout=spTMSTimeout, fingerprintUsageDone=fingerprintUsageDone, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, spInetAddressType=spInetAddressType, spBGPInstability=spBGPInstability, licenseError=licenseError, spInterfaceIndex=spInterfaceIndex, spBGPTrapPrefix=spBGPTrapPrefix, cloudSignalingFault=cloudSignalingFault, serviceUsageDone=serviceUsageDone, spFingerprintSender=spFingerprintSender, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spGreTunnelName=spGreTunnelName, spInterfaceSpeedHC=spInterfaceSpeedHC, spHardwareFailureDescription=spHardwareFailureDescription, snmpDown=snmpDown, managedObjectUsageDone=managedObjectUsageDone, PYSNMP_MODULE_ID=peakflowSPMIB, spFlowspecTimeout=spFlowspecTimeout, peakflowSPCMI=peakflowSPCMI, interfaceUsageDone=interfaceUsageDone, spAlertID=spAlertID, fingerprintFeedback=fingerprintFeedback, peakflowSPMgr=peakflowSPMgr, dnsBaseline=dnsBaseline, devicePhysicalMemory=devicePhysicalMemory, spUsage=spUsage, greDown=greDown, deviceSystemErrorDone=deviceSystemErrorDone, spManagedObject=spManagedObject, licenseErrorDone=licenseErrorDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, routingFailover=routingFailover, spFingerprintName=spFingerprintName, spCommFailureDescription=spCommFailureDescription, spFingerprintMessage=spFingerprintMessage, deviceSwapSpace=deviceSwapSpace, deviceSwapSpaceInUse=deviceSwapSpaceInUse, cloudSignalingFaultDone=cloudSignalingFaultDone, flowDown=flowDown, spBlackholePrefix=spBlackholePrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, trafficAutoMitigation=trafficAutoMitigation, autoclassifyStart=autoclassifyStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFlowspecCommunity=spFlowspecCommunity, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPEvent=spBGPEvent, managedObjectUsage=managedObjectUsage, spThirdPartyZone=spThirdPartyZone, spServiceElement=spServiceElement, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrLimit=spLicenseErrLimit, mitigationFlowspecStart=mitigationFlowspecStart, collectorStart=collectorStart, greDownDone=greDownDone, spInterfaceUsage=spInterfaceUsage, spMitigationStart=spMitigationStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceTotalFlows=deviceTotalFlows, spLicenseErrDescription=spLicenseErrDescription, spThirdPartyAddr=spThirdPartyAddr, mitigationTMSStart=mitigationTMSStart, spInetAddress=spInetAddress, spMitigationName=spMitigationName, spMitigationID=spMitigationID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spCollector=spCollector, spScriptCommand=spScriptCommand, spTMSMultiPrefix=spTMSMultiPrefix, spScriptPort=spScriptPort, spDNSObservedMean=spDNSObservedMean, deviceDiskUsage=deviceDiskUsage, collectorUp=collectorUp, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spUsername=spUsername, spInterfaceSpeed=spInterfaceSpeed, spBlackholeCommunity=spBlackholeCommunity, spDNSName=spDNSName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptHost=spScriptHost, spReportName=spReportName, dosHostDetectionAlert=dosHostDetectionAlert, spPravail=spPravail, spHijackRoute=spHijackRoute, spDuration=spDuration, deviceTotalFlowsHC=deviceTotalFlowsHC, notificationLimit=notificationLimit, spBlackholeNexthop=spBlackholeNexthop, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spLicenseErrCount=spLicenseErrCount, spDNSExpected=spDNSExpected, deviceSystemError=deviceSystemError, spReportID=spReportID, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage)
