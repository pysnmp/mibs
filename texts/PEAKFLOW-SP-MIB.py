...
Bits, MibIdentifier, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64, iso, ObjectIdentity, Integer32, Gauge32, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64", "iso", "ObjectIdentity", "Integer32", "Gauge32", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spFingerprintSender=spFingerprintSender, spLicenseErrCount=spLicenseErrCount, peakflowSPMIB=peakflowSPMIB, deviceDiskUsage=deviceDiskUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spMitigationID=spMitigationID, licenseError=licenseError, spBlackholeNexthop=spBlackholeNexthop, spImpactBps=spImpactBps, spBGPTrapName=spBGPTrapName, PYSNMP_MODULE_ID=peakflowSPMIB, spInterfaceSpeedHC=spInterfaceSpeedHC, spThirdPartyZone=spThirdPartyZone, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapEvent=spBGPTrapEvent, spApplicationName=spApplicationName, spScriptStart=spScriptStart, flowUp=flowUp, spPravail=spPravail, spServiceElement=spServiceElement, spDuration=spDuration, spBGPTrapPrefix=spBGPTrapPrefix, spServiceName=spServiceName, spDNSObservedMax=spDNSObservedMax, devicePhysicalMemory=devicePhysicalMemory, spFingerprintMessage=spFingerprintMessage, hardwareFailureDone=hardwareFailureDone, mitigationBlackholeStart=mitigationBlackholeStart, serviceUsage=serviceUsage, managedObjectUsageDone=managedObjectUsageDone, trafficAutoMitigation=trafficAutoMitigation, spBlackholeCommunity=spBlackholeCommunity, fingerprintUsage=fingerprintUsage, snmpUp=snmpUp, dosHostDetectionAlert=dosHostDetectionAlert, spReportID=spReportID, spFingerprintName=spFingerprintName, interfaceUsage=interfaceUsage, spMitigationName=spMitigationName, spDetectedCountries=spDetectedCountries, spInetAddressType=spInetAddressType, spDetector=spDetector, spTMSMultiPrefix=spTMSMultiPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spThreshold=spThreshold, bgpHijack=bgpHijack, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyAddr=spThirdPartyAddr, spInterfaceUsage=spInterfaceUsage, spCommFailureDestination=spCommFailureDestination, bgpDown=bgpDown, spUsageType=spUsageType, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spGreTunnelDestination=spGreTunnelDestination, spHijackLocal=spHijackLocal, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spImpactPps=spImpactPps, spDNSObservedMean=spDNSObservedMean, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spGreTunnelName=spGreTunnelName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, reportDone=reportDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spLicenseErrType=spLicenseErrType, spInterface=spInterface, spHijackAttr=spHijackAttr, spMitigationStart=spMitigationStart, fingerprintFeedback=fingerprintFeedback, spTMSPrefix=spTMSPrefix, spLicenseErrDescription=spLicenseErrDescription, serviceUsageDone=serviceUsageDone, spLicenseErrLimit=spLicenseErrLimit, spInetAddress=spInetAddress, spTMSTimeout=spTMSTimeout, flowDown=flowDown, collectorStart=collectorStart, spUsage=spUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintFeedback=spFingerprintFeedback, mitigationFlowspecStart=mitigationFlowspecStart, greDown=greDown, spBlackholeTimeout=spBlackholeTimeout, deviceHealth=deviceHealth, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, collectorUp=collectorUp, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPCMI=peakflowSPCMI, spHijackRoute=spHijackRoute, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spSystemErrorType=spSystemErrorType, spcommFailureDone=spcommFailureDone, spReportName=spReportName, spFlowspecTimeout=spFlowspecTimeout, mitigationTMSStart=mitigationTMSStart, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPEvent=spBGPEvent, spAlertDetectionSignatures=spAlertDetectionSignatures, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSwapSpace=deviceSwapSpace, snmpDown=snmpDown, spInterfaceIndex=spInterfaceIndex, deviceTotalFlowsHC=deviceTotalFlowsHC, routingFailover=routingFailover, peakflowSPTraps=peakflowSPTraps, deviceTotalFlows=deviceTotalFlows, spDNSExpected=spDNSExpected, bgpTrap=bgpTrap, spUnit=spUnit, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, fingerprintUsageDone=fingerprintUsageDone, bgpInstabilityDone=bgpInstabilityDone, spCollector=spCollector, spUsername=spUsername, mitigationTMSStartV2=mitigationTMSStartV2, spScriptCommand=spScriptCommand, spHardwareFailureDescription=spHardwareFailureDescription, configChange=configChange, managedObjectUsage=managedObjectUsage, collectorDown=collectorDown, hardwareFailure=hardwareFailure, dnsBaseline=dnsBaseline, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptPort=spScriptPort, bgpInstability=bgpInstability, notificationLimit=notificationLimit, spCommFailureDescription=spCommFailureDescription, spAlertID=spAlertID, spRouter=spRouter, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObjectFamily=spManagedObjectFamily, spManagedObjects=spManagedObjects, deviceSystemError=deviceSystemError, spInterfaceSpeed=spInterfaceSpeed, spDNSName=spDNSName, spManagedObject=spManagedObject, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceUsageHC=spInterfaceUsageHC, autoclassifyStart=autoclassifyStart, interfaceUsageDone=interfaceUsageDone, cloudSignalingFault=cloudSignalingFault, spVersion=spVersion, dnsBaselineDone=dnsBaselineDone, alertScript=alertScript, greDownDone=greDownDone, bgpUp=bgpUp, spBGPInstability=spBGPInstability, peakflowSPMgr=peakflowSPMgr, spReportURL=spReportURL, mitigationDone=mitigationDone, spBlackholePrefix=spBlackholePrefix, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spScriptHost=spScriptHost, spTMSCommunity=spTMSCommunity, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintReceive=fingerprintReceive, spFlowspecCommunity=spFlowspecCommunity, spcommFailure=spcommFailure, licenseErrorDone=licenseErrorDone, spDNSObserved=spDNSObserved)
