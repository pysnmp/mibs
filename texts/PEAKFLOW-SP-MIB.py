...
Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, MibIdentifier, iso, Unsigned32, TimeTicks, ModuleIdentity, Counter32, Gauge32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter32", "Gauge32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThreshold=spThreshold, deviceSystemErrorDone=deviceSystemErrorDone, spBlackholeNexthop=spBlackholeNexthop, spManagedObject=spManagedObject, hardwareFailure=hardwareFailure, mitigationTMSStart=mitigationTMSStart, spFingerprintFeedback=spFingerprintFeedback, spRouter=spRouter, spInterfaceUsageHC=spInterfaceUsageHC, fingerprintUsageDone=fingerprintUsageDone, spServiceElement=spServiceElement, interfaceUsage=interfaceUsage, spScriptCommand=spScriptCommand, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, bgpHijack=bgpHijack, spImpactPps=spImpactPps, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceHealth=deviceHealth, spLicenseErrLimit=spLicenseErrLimit, spCloudSignalFaultDescription=spCloudSignalFaultDescription, interfaceUsageDone=interfaceUsageDone, spDNSObservedMean=spDNSObservedMean, spUnit=spUnit, bgpTrap=bgpTrap, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosHostDetectionAlertDone=dosHostDetectionAlertDone, PYSNMP_MODULE_ID=peakflowSPMIB, spPravail=spPravail, flowUp=flowUp, spHijackLocal=spHijackLocal, spBGPInstability=spBGPInstability, peakflowSPCMI=peakflowSPCMI, reportDone=reportDone, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrType=spLicenseErrType, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spGreTunnelDestination=spGreTunnelDestination, spUsage=spUsage, alertScript=alertScript, mitigationBlackholeStart=mitigationBlackholeStart, spGreTunnelName=spGreTunnelName, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSExpected=spDNSExpected, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spDNSObserved=spDNSObserved, spServiceName=spServiceName, spReportID=spReportID, spReportURL=spReportURL, spInterfaceSpeedHC=spInterfaceSpeedHC, devicePhysicalMemory=devicePhysicalMemory, spHijackAttr=spHijackAttr, spMitigationID=spMitigationID, dnsBaselineDone=dnsBaselineDone, spDNSName=spDNSName, spMitigationName=spMitigationName, spThirdPartyAddr=spThirdPartyAddr, spInetAddressType=spInetAddressType, fingerprintFeedback=fingerprintFeedback, deviceSystemError=deviceSystemError, spInterface=spInterface, deviceSwapSpace=deviceSwapSpace, bgpInstability=bgpInstability, routingFailover=routingFailover, spMitigationStart=spMitigationStart, spBGPTrapName=spBGPTrapName, spUsageType=spUsageType, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObjects=spManagedObjects, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spCommFailureDescription=spCommFailureDescription, greDownDone=greDownDone, peakflowSPMgr=peakflowSPMgr, snmpDown=snmpDown, spInetAddress=spInetAddress, spDNSObservedMax=spDNSObservedMax, managedObjectUsageDone=managedObjectUsageDone, snmpUp=snmpUp, fingerprintReceive=fingerprintReceive, spcommFailure=spcommFailure, spDetectedCountries=spDetectedCountries, spFlowspecCommunity=spFlowspecCommunity, spTMSMultiPrefix=spTMSMultiPrefix, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spVersion=spVersion, spScriptStart=spScriptStart, bgpInstabilityDone=bgpInstabilityDone, spBGPTrapPrefix=spBGPTrapPrefix, spcommFailureDone=spcommFailureDone, spImpactBps=spImpactBps, flowDown=flowDown, spAlertID=spAlertID, spBGPTrapEvent=spBGPTrapEvent, spDetector=spDetector, spApplicationName=spApplicationName, deviceTotalFlows=deviceTotalFlows, hardwareFailureDone=hardwareFailureDone, licenseError=licenseError, spFingerprintMessage=spFingerprintMessage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dnsBaseline=dnsBaseline, spInterfaceSpeed=spInterfaceSpeed, spBGPEvent=spBGPEvent, spFlowspecTimeout=spFlowspecTimeout, spBlackholeCommunity=spBlackholeCommunity, spLicenseErrDescription=spLicenseErrDescription, bgpUp=bgpUp, deviceTotalFlowsHC=deviceTotalFlowsHC, spThirdPartyZone=spThirdPartyZone, spBlackholeTimeout=spBlackholeTimeout, spCollector=spCollector, peakflowSPTraps=peakflowSPTraps, serviceUsage=serviceUsage, autoclassifyStart=autoclassifyStart, spDuration=spDuration, spHijackRoute=spHijackRoute, spScriptHost=spScriptHost, spFingerprintName=spFingerprintName, spUsername=spUsername, serviceUsageDone=serviceUsageDone, mitigationFlowspecStart=mitigationFlowspecStart, spInterfaceIndex=spInterfaceIndex, cloudSignalingFault=cloudSignalingFault, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, peakflowSPMIB=peakflowSPMIB, bgpDown=bgpDown, collectorStart=collectorStart, spInterfaceUsage=spInterfaceUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spTMSPrefix=spTMSPrefix, collectorUp=collectorUp, spLicenseErrCount=spLicenseErrCount, mitigationDone=mitigationDone, notificationLimit=notificationLimit, spTMSTimeout=spTMSTimeout, mitigationTMSStartV2=mitigationTMSStartV2, licenseErrorDone=licenseErrorDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsage=fingerprintUsage, spHardwareFailureDescription=spHardwareFailureDescription, managedObjectUsage=managedObjectUsage, collectorDown=collectorDown, spSystemErrorDescription=spSystemErrorDescription, spReportName=spReportName, spTMSCommunity=spTMSCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCommFailureDestination=spCommFailureDestination, spBlackholePrefix=spBlackholePrefix, spManagedObjectFamily=spManagedObjectFamily, greDown=greDown, deviceDiskUsage=deviceDiskUsage, trafficAutoMitigation=trafficAutoMitigation, spSystemErrorType=spSystemErrorType, configChange=configChange, spFingerprintSender=spFingerprintSender, spScriptPort=spScriptPort)
