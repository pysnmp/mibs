...
Integer32, Bits, Gauge32, Counter64, TimeTicks, ModuleIdentity, Counter32, Unsigned32, NotificationType, IpAddress, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity", "Counter32", "Unsigned32", "NotificationType", "IpAddress", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDescription=spCommFailureDescription, serviceUsageDone=serviceUsageDone, spcommFailure=spcommFailure, fingerprintReceive=fingerprintReceive, greDownDone=greDownDone, snmpUp=snmpUp, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpInstabilityDone=bgpInstabilityDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, peakflowSPMgr=peakflowSPMgr, spInterfaceUsage=spInterfaceUsage, spUnit=spUnit, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintSender=spFingerprintSender, managedObjectUsageDone=managedObjectUsageDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterface=spInterface, spDuration=spDuration, spBlackholeTimeout=spBlackholeTimeout, spScriptCommand=spScriptCommand, devicePhysicalMemory=devicePhysicalMemory, licenseError=licenseError, spCommFailureDestination=spCommFailureDestination, spMitigationStart=spMitigationStart, spManagedObjects=spManagedObjects, spLicenseErrCount=spLicenseErrCount, spFingerprintName=spFingerprintName, peakflowSPTraps=peakflowSPTraps, deviceSwapSpaceUsage=deviceSwapSpaceUsage, notificationLimit=notificationLimit, spTMSMultiPrefix=spTMSMultiPrefix, trafficAutoMitigation=trafficAutoMitigation, spMitigationName=spMitigationName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spHijackAttr=spHijackAttr, spDNSObserved=spDNSObserved, spManagedObject=spManagedObject, spDetector=spDetector, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFlowspecCommunity=spFlowspecCommunity, spBlackholeCommunity=spBlackholeCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, reportDone=reportDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, routingFailover=routingFailover, spInetAddress=spInetAddress, serviceUsage=serviceUsage, fingerprintUsageDone=fingerprintUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spTMSPrefix=spTMSPrefix, spInterfaceUsageHC=spInterfaceUsageHC, deviceSystemErrorDone=deviceSystemErrorDone, spUsername=spUsername, spManagedObjectFamily=spManagedObjectFamily, spServiceElement=spServiceElement, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrLimit=spLicenseErrLimit, PYSNMP_MODULE_ID=peakflowSPMIB, bgpUp=bgpUp, spUsageType=spUsageType, spFingerprintMessage=spFingerprintMessage, mitigationBlackholeStart=mitigationBlackholeStart, dnsBaseline=dnsBaseline, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, configChange=configChange, spTMSCommunity=spTMSCommunity, flowDown=flowDown, spInterfaceIndex=spInterfaceIndex, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, snmpDown=snmpDown, spcommFailureDone=spcommFailureDone, spRouter=spRouter, spAlertID=spAlertID, spDetectedCountries=spDetectedCountries, spBGPTrapPrefix=spBGPTrapPrefix, spPravail=spPravail, bgpInstability=bgpInstability, mitigationTMSStartV2=mitigationTMSStartV2, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, fingerprintFeedback=fingerprintFeedback, dnsBaselineDone=dnsBaselineDone, spBGPEvent=spBGPEvent, spScriptHost=spScriptHost, managedObjectUsage=managedObjectUsage, spReportName=spReportName, spScriptStart=spScriptStart, hardwareFailureDone=hardwareFailureDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spScriptPort=spScriptPort, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, interfaceUsage=interfaceUsage, spThirdPartyAddr=spThirdPartyAddr, spInetAddressType=spInetAddressType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationFlowspecStart=mitigationFlowspecStart, mitigationDone=mitigationDone, deviceSwapSpace=deviceSwapSpace, bgpDown=bgpDown, deviceHealth=deviceHealth, spSystemErrorType=spSystemErrorType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFingerprintFeedback=spFingerprintFeedback, spGreTunnelDestination=spGreTunnelDestination, spReportURL=spReportURL, spThreshold=spThreshold, spLicenseErrType=spLicenseErrType, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintUsage=fingerprintUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceDiskUsage=deviceDiskUsage, spDNSObservedMean=spDNSObservedMean, spBlackholePrefix=spBlackholePrefix, spImpactBps=spImpactBps, interfaceUsageDone=interfaceUsageDone, spGreTunnelName=spGreTunnelName, spFlowspecTimeout=spFlowspecTimeout, spSystemErrorDescription=spSystemErrorDescription, spBGPInstability=spBGPInstability, peakflowSPMIB=peakflowSPMIB, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpTrap=bgpTrap, spHijackLocal=spHijackLocal, deviceTotalFlows=deviceTotalFlows, spServiceName=spServiceName, spLicenseErrDescription=spLicenseErrDescription, hardwareFailure=hardwareFailure, deviceTotalFlowsHC=deviceTotalFlowsHC, spInterfaceSpeed=spInterfaceSpeed, flowUp=flowUp, spBGPTrapName=spBGPTrapName, collectorDown=collectorDown, spDNSName=spDNSName, mitigationTMSStart=mitigationTMSStart, alertScript=alertScript, bgpHijack=bgpHijack, spThirdPartyZone=spThirdPartyZone, greDown=greDown, peakflowSPCMI=peakflowSPCMI, spUsage=spUsage, cloudSignalingFault=cloudSignalingFault, spHijackRoute=spHijackRoute, spReportID=spReportID, spMitigationID=spMitigationID, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spCollector=spCollector, spVersion=spVersion, spApplicationName=spApplicationName, spDNSObservedMax=spDNSObservedMax, spTMSTimeout=spTMSTimeout, deviceSystemError=deviceSystemError, spDNSExpected=spDNSExpected, collectorStart=collectorStart, spImpactPps=spImpactPps, licenseErrorDone=licenseErrorDone, spBlackholeNexthop=spBlackholeNexthop, collectorUp=collectorUp)
