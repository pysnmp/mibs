...
MibIdentifier, Unsigned32, ModuleIdentity, Counter32, Bits, Gauge32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, TimeTicks, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBlackholeNexthop=spBlackholeNexthop, collectorUp=collectorUp, serviceUsageDone=serviceUsageDone, spBGPInstability=spBGPInstability, spcommFailure=spcommFailure, hardwareFailure=hardwareFailure, snmpUp=snmpUp, spGreTunnelName=spGreTunnelName, spInterface=spInterface, spFingerprintMessage=spFingerprintMessage, spInetAddressType=spInetAddressType, spThirdPartyZone=spThirdPartyZone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, devicePhysicalMemory=devicePhysicalMemory, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDNSExpected=spDNSExpected, interfaceUsageDone=interfaceUsageDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObserved=spDNSObserved, reportDone=reportDone, spScriptPort=spScriptPort, peakflowSPMgr=peakflowSPMgr, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spUsageType=spUsageType, spUsage=spUsage, spVersion=spVersion, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSystemError=deviceSystemError, spFingerprintFeedback=spFingerprintFeedback, spAlertID=spAlertID, bgpUp=bgpUp, spRouter=spRouter, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptHost=spScriptHost, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spReportName=spReportName, spScriptCommand=spScriptCommand, spTMSTimeout=spTMSTimeout, mitigationTMSStartV2=mitigationTMSStartV2, spFlowspecCommunity=spFlowspecCommunity, spFingerprintName=spFingerprintName, peakflowSPCMI=peakflowSPCMI, spSystemErrorType=spSystemErrorType, spDNSName=spDNSName, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapEvent=spBGPTrapEvent, peakflowSPTraps=peakflowSPTraps, spDetector=spDetector, fingerprintUsage=fingerprintUsage, cloudSignalingFault=cloudSignalingFault, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spUnit=spUnit, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceDiskUsage=deviceDiskUsage, spThreshold=spThreshold, spLicenseErrDescription=spLicenseErrDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, spFingerprintSender=spFingerprintSender, spLicenseErrLimit=spLicenseErrLimit, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceUsageHC=spInterfaceUsageHC, spBlackholeCommunity=spBlackholeCommunity, spLicenseErrCount=spLicenseErrCount, spFlowspecTimeout=spFlowspecTimeout, bgpInstabilityDone=bgpInstabilityDone, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSMultiPrefix=spTMSMultiPrefix, spTMSPrefix=spTMSPrefix, flowUp=flowUp, peakflowSPMIB=peakflowSPMIB, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, trafficAutoMitigation=trafficAutoMitigation, spServiceElement=spServiceElement, mitigationThirdPartyStart=mitigationThirdPartyStart, dosHostDetectionAlert=dosHostDetectionAlert, deviceSwapSpace=deviceSwapSpace, spMitigationStart=spMitigationStart, fingerprintUsageDone=fingerprintUsageDone, spInterfaceUsage=spInterfaceUsage, fingerprintReceive=fingerprintReceive, spCommFailureDestination=spCommFailureDestination, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spThirdPartyAddr=spThirdPartyAddr, greDownDone=greDownDone, spBlackholePrefix=spBlackholePrefix, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSObservedMax=spDNSObservedMax, spcommFailureDone=spcommFailureDone, serviceUsage=serviceUsage, spHijackLocal=spHijackLocal, spCommFailureDescription=spCommFailureDescription, spInterfaceIndex=spInterfaceIndex, mitigationTMSStart=mitigationTMSStart, collectorDown=collectorDown, spHardwareFailureDescription=spHardwareFailureDescription, spDetectedCountries=spDetectedCountries, spDuration=spDuration, spPravail=spPravail, dnsBaselineDone=dnsBaselineDone, spHijackRoute=spHijackRoute, bgpDown=bgpDown, notificationLimit=notificationLimit, licenseError=licenseError, deviceSwapSpaceUsage=deviceSwapSpaceUsage, configChange=configChange, deviceTotalFlows=deviceTotalFlows, snmpDown=snmpDown, spManagedObjects=spManagedObjects, spHijackAttr=spHijackAttr, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spManagedObjectFamily=spManagedObjectFamily, spInterfaceSpeedHC=spInterfaceSpeedHC, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterfaceSpeed=spInterfaceSpeed, spImpactPps=spImpactPps, routingFailover=routingFailover, deviceTotalFlowsHC=deviceTotalFlowsHC, spScriptStart=spScriptStart, greDown=greDown, interfaceUsage=interfaceUsage, flowDown=flowDown, bgpHijack=bgpHijack, managedObjectUsage=managedObjectUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, mitigationBlackholeStart=mitigationBlackholeStart, alertScript=alertScript, spDNSObservedMean=spDNSObservedMean, deviceHealth=deviceHealth, spBGPEvent=spBGPEvent, spServiceName=spServiceName, spInetAddress=spInetAddress, spImpactBps=spImpactBps, bgpInstability=bgpInstability, dnsBaseline=dnsBaseline, spApplicationName=spApplicationName, autoclassifyStart=autoclassifyStart, licenseErrorDone=licenseErrorDone, spBGPTrapName=spBGPTrapName, collectorStart=collectorStart, hardwareFailureDone=hardwareFailureDone, mitigationDone=mitigationDone, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, managedObjectUsageDone=managedObjectUsageDone, spManagedObject=spManagedObject, spReportURL=spReportURL, spCollector=spCollector, spUsername=spUsername, spBlackholeTimeout=spBlackholeTimeout, spReportID=spReportID, spSystemErrorDescription=spSystemErrorDescription, bgpTrap=bgpTrap, mitigationFlowspecStart=mitigationFlowspecStart, spMitigationName=spMitigationName, spMitigationID=spMitigationID)
