...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, ModuleIdentity, Counter32, Counter64, Bits, Gauge32, MibIdentifier, IpAddress, iso, ObjectIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "ModuleIdentity", "Counter32", "Counter64", "Bits", "Gauge32", "MibIdentifier", "IpAddress", "iso", "ObjectIdentity", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", dnsBaseline=dnsBaseline, spImpactPps=spImpactPps, peakflowSPCMI=peakflowSPCMI, dosNetworkProfiledAlert=dosNetworkProfiledAlert, licenseError=licenseError, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, collectorDown=collectorDown, spTMSCommunity=spTMSCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpDown=bgpDown, spManagedObjectFamily=spManagedObjectFamily, spFingerprintName=spFingerprintName, peakflowSPMgr=peakflowSPMgr, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spcommFailure=spcommFailure, managedObjectUsageDone=managedObjectUsageDone, mitigationDone=mitigationDone, spLicenseErrCount=spLicenseErrCount, spFingerprintMessage=spFingerprintMessage, spCommFailureDestination=spCommFailureDestination, spLicenseErrDescription=spLicenseErrDescription, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceTotalFlowsHC=deviceTotalFlowsHC, spDNSObservedMax=spDNSObservedMax, bgpInstability=bgpInstability, deviceDiskUsage=deviceDiskUsage, trafficAutoMitigation=trafficAutoMitigation, spUsage=spUsage, flowUp=flowUp, autoclassifyStart=autoclassifyStart, interfaceUsageDone=interfaceUsageDone, configChange=configChange, fingerprintUsageDone=fingerprintUsageDone, spInterfaceIndex=spInterfaceIndex, spLicenseErrType=spLicenseErrType, spInterfaceSpeed=spInterfaceSpeed, spTMSPrefix=spTMSPrefix, snmpDown=snmpDown, collectorUp=collectorUp, reportDone=reportDone, bgpUp=bgpUp, deviceSystemErrorDone=deviceSystemErrorDone, dnsBaselineDone=dnsBaselineDone, spSystemErrorType=spSystemErrorType, spHijackRoute=spHijackRoute, PYSNMP_MODULE_ID=peakflowSPMIB, spInterface=spInterface, spBGPTrapPrefix=spBGPTrapPrefix, bgpTrap=bgpTrap, spUsageType=spUsageType, spScriptHost=spScriptHost, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spAlertID=spAlertID, spMitigationName=spMitigationName, spVersion=spVersion, interfaceUsage=interfaceUsage, fingerprintUsage=fingerprintUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spRouter=spRouter, spThreshold=spThreshold, collectorStart=collectorStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spUnit=spUnit, spInterfaceUsageHC=spInterfaceUsageHC, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintSender=spFingerprintSender, spManagedObjects=spManagedObjects, spHijackAttr=spHijackAttr, spScriptPort=spScriptPort, spThirdPartyAddr=spThirdPartyAddr, spDNSExpected=spDNSExpected, alertScript=alertScript, spGreTunnelDestination=spGreTunnelDestination, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSName=spDNSName, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintFeedback=spFingerprintFeedback, spServiceName=spServiceName, spLicenseErrLimit=spLicenseErrLimit, spInetAddressType=spInetAddressType, cloudSignalingFault=cloudSignalingFault, spBlackholeTimeout=spBlackholeTimeout, spInterfaceUsage=spInterfaceUsage, spBlackholeCommunity=spBlackholeCommunity, spFlowspecCommunity=spFlowspecCommunity, spBlackholePrefix=spBlackholePrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationFlowspecStart=mitigationFlowspecStart, greDown=greDown, deviceSwapSpace=deviceSwapSpace, spUsername=spUsername, spImpactBps=spImpactBps, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationBlackholeStart=mitigationBlackholeStart, spMitigationStart=spMitigationStart, fingerprintReceive=fingerprintReceive, spcommFailureDone=spcommFailureDone, deviceTotalFlows=deviceTotalFlows, spGreTunnelName=spGreTunnelName, spMitigationID=spMitigationID, spTMSMultiPrefix=spTMSMultiPrefix, devicePhysicalMemory=devicePhysicalMemory, peakflowSPTraps=peakflowSPTraps, spScriptCommand=spScriptCommand, deviceSystemError=deviceSystemError, bgpHijack=bgpHijack, mitigationTMSStartV2=mitigationTMSStartV2, spBGPInstability=spBGPInstability, spInetAddress=spInetAddress, deviceHealth=deviceHealth, spBlackholeNexthop=spBlackholeNexthop, cloudSignalingFaultDone=cloudSignalingFaultDone, spAlertDetectionSignatures=spAlertDetectionSignatures, hardwareFailureDone=hardwareFailureDone, spCollector=spCollector, notificationLimit=notificationLimit, serviceUsage=serviceUsage, spReportURL=spReportURL, serviceUsageDone=serviceUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpUp=snmpUp, mitigationTMSStart=mitigationTMSStart, spCommFailureDescription=spCommFailureDescription, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlert=dosHostDetectionAlert, spScriptStart=spScriptStart, licenseErrorDone=licenseErrorDone, flowDown=flowDown, spDNSObservedMean=spDNSObservedMean, spThirdPartyZone=spThirdPartyZone, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, spDNSObserved=spDNSObserved, spReportID=spReportID, spServiceElement=spServiceElement, routingFailover=routingFailover, spPravail=spPravail, spApplicationName=spApplicationName, spDetectedCountries=spDetectedCountries, managedObjectUsage=managedObjectUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapName=spBGPTrapName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationThirdPartyStart=mitigationThirdPartyStart, greDownDone=greDownDone, spReportName=spReportName, spTMSTimeout=spTMSTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spHijackLocal=spHijackLocal, spSystemErrorDescription=spSystemErrorDescription, spDetector=spDetector, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPEvent=spBGPEvent, spManagedObject=spManagedObject, spFlowspecTimeout=spFlowspecTimeout, peakflowSPMIB=peakflowSPMIB, spDuration=spDuration)
