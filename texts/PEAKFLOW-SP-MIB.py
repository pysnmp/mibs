...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso, Bits, Unsigned32, TimeTicks, Gauge32, MibIdentifier, Counter32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso", "Bits", "Unsigned32", "TimeTicks", "Gauge32", "MibIdentifier", "Counter32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThirdPartyZone=spThirdPartyZone, spInterfaceSpeedHC=spInterfaceSpeedHC, interfaceUsage=interfaceUsage, spScriptCommand=spScriptCommand, spInterfaceIndex=spInterfaceIndex, spReportURL=spReportURL, licenseErrorDone=licenseErrorDone, spDetector=spDetector, spReportName=spReportName, spBGPTrapPrefix=spBGPTrapPrefix, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintName=spFingerprintName, spInterfaceUsageHC=spInterfaceUsageHC, licenseError=licenseError, spSystemErrorDescription=spSystemErrorDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spLicenseErrLimit=spLicenseErrLimit, spUsageType=spUsageType, spScriptHost=spScriptHost, spTMSTimeout=spTMSTimeout, spHijackAttr=spHijackAttr, spThreshold=spThreshold, spDNSName=spDNSName, spImpactPps=spImpactPps, deviceTotalFlowsHC=deviceTotalFlowsHC, spCollector=spCollector, spCommFailureDescription=spCommFailureDescription, spGreTunnelDestination=spGreTunnelDestination, trafficAutoMitigation=trafficAutoMitigation, spRouter=spRouter, spCloudSignalFaultDescription=spCloudSignalFaultDescription, flowDown=flowDown, managedObjectUsageDone=managedObjectUsageDone, fingerprintFeedback=fingerprintFeedback, spLicenseErrType=spLicenseErrType, interfaceUsageDone=interfaceUsageDone, spMitigationID=spMitigationID, greDown=greDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, routingFailover=routingFailover, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spHijackRoute=spHijackRoute, spFlowspecCommunity=spFlowspecCommunity, spBlackholeTimeout=spBlackholeTimeout, bgpHijack=bgpHijack, spFingerprintSender=spFingerprintSender, spFlowspecTimeout=spFlowspecTimeout, deviceTotalFlows=deviceTotalFlows, greDownDone=greDownDone, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPMIB=peakflowSPMIB, spInetAddressType=spInetAddressType, spHijackLocal=spHijackLocal, spServiceName=spServiceName, cloudSignalingFaultDone=cloudSignalingFaultDone, spUnit=spUnit, spScriptPort=spScriptPort, hardwareFailure=hardwareFailure, spUsername=spUsername, spDNSObserved=spDNSObserved, spcommFailureDone=spcommFailureDone, serviceUsage=serviceUsage, spBlackholeCommunity=spBlackholeCommunity, snmpDown=snmpDown, bgpInstabilityDone=bgpInstabilityDone, spReportID=spReportID, collectorUp=collectorUp, spInterface=spInterface, mitigationDone=mitigationDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationThirdPartyStart=mitigationThirdPartyStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spInterfaceUsage=spInterfaceUsage, bgpTrap=bgpTrap, reportDone=reportDone, bgpUp=bgpUp, deviceDiskUsage=deviceDiskUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemory=devicePhysicalMemory, spPravail=spPravail, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spMitigationStart=spMitigationStart, serviceUsageDone=serviceUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spcommFailure=spcommFailure, spScriptStart=spScriptStart, hardwareFailureDone=hardwareFailureDone, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrCount=spLicenseErrCount, spBGPEvent=spBGPEvent, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spVersion=spVersion, spDuration=spDuration, peakflowSPCMI=peakflowSPCMI, spMitigationName=spMitigationName, spManagedObject=spManagedObject, fingerprintUsage=fingerprintUsage, dnsBaselineDone=dnsBaselineDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSPrefix=spTMSPrefix, spDNSExpected=spDNSExpected, spFingerprintFeedback=spFingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapEvent=spBGPTrapEvent, mitigationTMSStartV2=mitigationTMSStartV2, flowUp=flowUp, spApplicationName=spApplicationName, spImpactBps=spImpactBps, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, snmpUp=snmpUp, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObservedMean=spDNSObservedMean, deviceHealth=deviceHealth, deviceSwapSpace=deviceSwapSpace, spFingerprintMessage=spFingerprintMessage, spManagedObjects=spManagedObjects, spBGPInstability=spBGPInstability, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, bgpInstability=bgpInstability, bgpDown=bgpDown, spHardwareFailureDescription=spHardwareFailureDescription, spThirdPartyAddr=spThirdPartyAddr, mitigationFlowspecStart=mitigationFlowspecStart, spCommFailureDestination=spCommFailureDestination, dnsBaseline=dnsBaseline, cloudSignalingFault=cloudSignalingFault, spManagedObjectFamily=spManagedObjectFamily, deviceSystemErrorDone=deviceSystemErrorDone, spServiceElement=spServiceElement, spBGPTrapName=spBGPTrapName, peakflowSPMgr=peakflowSPMgr, spLicenseErrDescription=spLicenseErrDescription, spBlackholePrefix=spBlackholePrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, collectorDown=collectorDown, spBlackholeNexthop=spBlackholeNexthop, collectorStart=collectorStart, spGreTunnelName=spGreTunnelName, configChange=configChange, spDNSObservedMax=spDNSObservedMax, fingerprintReceive=fingerprintReceive, spSystemErrorType=spSystemErrorType, managedObjectUsage=managedObjectUsage, mitigationTMSStart=mitigationTMSStart, deviceSystemError=deviceSystemError, spTMSMultiPrefix=spTMSMultiPrefix, autoclassifyStart=autoclassifyStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDetectedCountries=spDetectedCountries, spAlertID=spAlertID, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spUsage=spUsage, spInetAddress=spInetAddress, peakflowSPTraps=peakflowSPTraps, mitigationBlackholeStart=mitigationBlackholeStart, notificationLimit=notificationLimit, alertScript=alertScript)
