...
MibIdentifier, Counter64, ModuleIdentity, TimeTicks, Unsigned32, iso, Counter32, Bits, ObjectIdentity, NotificationType, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ModuleIdentity", "TimeTicks", "Unsigned32", "iso", "Counter32", "Bits", "ObjectIdentity", "NotificationType", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spReportID=spReportID, dosHostDetectionAlert=dosHostDetectionAlert, spFingerprintSender=spFingerprintSender, fingerprintFeedback=fingerprintFeedback, spBlackholePrefix=spBlackholePrefix, spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spManagedObjectFamily=spManagedObjectFamily, bgpDown=bgpDown, interfaceUsageDone=interfaceUsageDone, mitigationTMSStart=mitigationTMSStart, spVersion=spVersion, spcommFailureDone=spcommFailureDone, spManagedObjects=spManagedObjects, spLicenseErrType=spLicenseErrType, trafficAutoMitigation=trafficAutoMitigation, snmpUp=snmpUp, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowUp=flowUp, spAlertID=spAlertID, dnsBaseline=dnsBaseline, spImpactPps=spImpactPps, spFlowspecTimeout=spFlowspecTimeout, spcommFailure=spcommFailure, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spHijackAttr=spHijackAttr, autoclassifyStart=autoclassifyStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spApplicationName=spApplicationName, spUsage=spUsage, spBGPInstability=spBGPInstability, spImpactBps=spImpactBps, peakflowSPMgr=peakflowSPMgr, spServiceName=spServiceName, spInterfaceSpeed=spInterfaceSpeed, spInterface=spInterface, flowDown=flowDown, spCommFailureDestination=spCommFailureDestination, spTMSPrefix=spTMSPrefix, notificationLimit=notificationLimit, spFlowspecCommunity=spFlowspecCommunity, peakflowSPCMI=peakflowSPCMI, managedObjectUsageDone=managedObjectUsageDone, spScriptPort=spScriptPort, bgpInstabilityDone=bgpInstabilityDone, fingerprintUsageDone=fingerprintUsageDone, deviceSystemErrorDone=deviceSystemErrorDone, spBlackholeTimeout=spBlackholeTimeout, spThirdPartyZone=spThirdPartyZone, spFingerprintMessage=spFingerprintMessage, fingerprintUsage=fingerprintUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInterfaceUsageHC=spInterfaceUsageHC, spPravail=spPravail, mitigationBlackholeStart=mitigationBlackholeStart, spBGPTrapPrefix=spBGPTrapPrefix, spMitigationName=spMitigationName, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpTrap=bgpTrap, spBGPEvent=spBGPEvent, deviceHealth=deviceHealth, peakflowSPMIB=peakflowSPMIB, spScriptHost=spScriptHost, spDNSObserved=spDNSObserved, spGreTunnelName=spGreTunnelName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spScriptCommand=spScriptCommand, spBlackholeNexthop=spBlackholeNexthop, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorUp=collectorUp, spUsername=spUsername, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceUsage=spInterfaceUsage, spDetector=spDetector, serviceUsageDone=serviceUsageDone, alertScript=alertScript, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDNSObservedMean=spDNSObservedMean, interfaceUsage=interfaceUsage, spManagedObject=spManagedObject, cloudSignalingFaultDone=cloudSignalingFaultDone, spMitigationID=spMitigationID, spSystemErrorDescription=spSystemErrorDescription, spLicenseErrLimit=spLicenseErrLimit, spBGPTrapEvent=spBGPTrapEvent, licenseErrorDone=licenseErrorDone, greDownDone=greDownDone, spInetAddress=spInetAddress, hardwareFailureDone=hardwareFailureDone, spAlertDetectionSignatures=spAlertDetectionSignatures, configChange=configChange, spRouter=spRouter, hardwareFailure=hardwareFailure, spDNSObservedMax=spDNSObservedMax, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationStart=spMitigationStart, deviceTotalFlowsHC=deviceTotalFlowsHC, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrDescription=spLicenseErrDescription, collectorStart=collectorStart, spFingerprintName=spFingerprintName, deviceTotalFlows=deviceTotalFlows, bgpHijack=bgpHijack, spThreshold=spThreshold, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapName=spBGPTrapName, greDown=greDown, spTMSCommunity=spTMSCommunity, spTMSMultiPrefix=spTMSMultiPrefix, mitigationDone=mitigationDone, dnsBaselineDone=dnsBaselineDone, mitigationFlowspecStart=mitigationFlowspecStart, spInterfaceIndex=spInterfaceIndex, spDuration=spDuration, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackRoute=spHijackRoute, collectorDown=collectorDown, spGreTunnelDestination=spGreTunnelDestination, managedObjectUsage=managedObjectUsage, devicePhysicalMemory=devicePhysicalMemory, spBGPTrapOldAttributes=spBGPTrapOldAttributes, licenseError=licenseError, spHijackLocal=spHijackLocal, deviceDiskUsage=deviceDiskUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spCommFailureDescription=spCommFailureDescription, spHardwareFailureDescription=spHardwareFailureDescription, spDNSName=spDNSName, spServiceElement=spServiceElement, spUsageType=spUsageType, peakflowSPTraps=peakflowSPTraps, spSystemErrorType=spSystemErrorType, deviceSwapSpace=deviceSwapSpace, spReportName=spReportName, spBlackholeCommunity=spBlackholeCommunity, spScriptStart=spScriptStart, spThirdPartyAddr=spThirdPartyAddr, spTMSTimeout=spTMSTimeout, spDNSExpected=spDNSExpected, spReportURL=spReportURL, reportDone=reportDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spCollector=spCollector, fingerprintReceive=fingerprintReceive, routingFailover=routingFailover, deviceSystemError=deviceSystemError, PYSNMP_MODULE_ID=peakflowSPMIB, snmpDown=snmpDown, spInetAddressType=spInetAddressType, bgpInstability=bgpInstability, spUnit=spUnit, spLicenseErrCount=spLicenseErrCount, cloudSignalingFault=cloudSignalingFault, bgpUp=bgpUp, serviceUsage=serviceUsage, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min)
