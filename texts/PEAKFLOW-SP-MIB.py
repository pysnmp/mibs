...
Gauge32, NotificationType, MibIdentifier, ObjectIdentity, IpAddress, TimeTicks, Unsigned32, Integer32, Counter64, iso, ModuleIdentity, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "MibIdentifier", "ObjectIdentity", "IpAddress", "TimeTicks", "Unsigned32", "Integer32", "Counter64", "iso", "ModuleIdentity", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpDown=bgpDown, spScriptStart=spScriptStart, spFingerprintMessage=spFingerprintMessage, serviceUsageDone=serviceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, bgpHijack=bgpHijack, routingFailover=routingFailover, spBGPEvent=spBGPEvent, spInterfaceUsageHC=spInterfaceUsageHC, spReportURL=spReportURL, spLicenseErrDescription=spLicenseErrDescription, spHijackAttr=spHijackAttr, cloudSignalingFault=cloudSignalingFault, spFingerprintName=spFingerprintName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spServiceName=spServiceName, spBGPTrapName=spBGPTrapName, spAlertID=spAlertID, spDNSObserved=spDNSObserved, spBGPInstability=spBGPInstability, spFlowspecTimeout=spFlowspecTimeout, spScriptCommand=spScriptCommand, spThirdPartyZone=spThirdPartyZone, bgpUp=bgpUp, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, notificationLimit=notificationLimit, spApplicationName=spApplicationName, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintReceive=fingerprintReceive, trafficAutoMitigation=trafficAutoMitigation, spDuration=spDuration, spUsageType=spUsageType, greDown=greDown, spDNSObservedMax=spDNSObservedMax, licenseError=licenseError, spScriptHost=spScriptHost, spHijackLocal=spHijackLocal, deviceHealth=deviceHealth, fingerprintUsageDone=fingerprintUsageDone, deviceSwapSpace=deviceSwapSpace, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorDown=collectorDown, dnsBaseline=dnsBaseline, alertScript=alertScript, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, interfaceUsageDone=interfaceUsageDone, hardwareFailureDone=hardwareFailureDone, spFingerprintFeedback=spFingerprintFeedback, cloudSignalingFaultDone=cloudSignalingFaultDone, spTMSCommunity=spTMSCommunity, spInetAddressType=spInetAddressType, spInetAddress=spInetAddress, mitigationFlowspecStart=mitigationFlowspecStart, spUsage=spUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, snmpUp=snmpUp, snmpDown=snmpDown, interfaceUsage=interfaceUsage, spCommFailureDestination=spCommFailureDestination, bgpTrap=bgpTrap, spSystemErrorDescription=spSystemErrorDescription, spCollector=spCollector, spFingerprintSender=spFingerprintSender, spPravail=spPravail, spThirdPartyAddr=spThirdPartyAddr, bgpInstability=bgpInstability, collectorUp=collectorUp, spImpactPps=spImpactPps, spMitigationStart=spMitigationStart, reportDone=reportDone, spcommFailure=spcommFailure, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPMIB=peakflowSPMIB, spBGPTrapPrefix=spBGPTrapPrefix, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInterfaceIndex=spInterfaceIndex, spServiceElement=spServiceElement, deviceTotalFlowsHC=deviceTotalFlowsHC, mitigationThirdPartyStart=mitigationThirdPartyStart, flowDown=flowDown, dosNetworkProfiledAlert=dosNetworkProfiledAlert, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spInterfaceUsage=spInterfaceUsage, flowUp=flowUp, fingerprintFeedback=fingerprintFeedback, licenseErrorDone=licenseErrorDone, dnsBaselineDone=dnsBaselineDone, hardwareFailure=hardwareFailure, spTMSTimeout=spTMSTimeout, spSystemErrorType=spSystemErrorType, peakflowSPCMI=peakflowSPCMI, spImpactBps=spImpactBps, spcommFailureDone=spcommFailureDone, managedObjectUsageDone=managedObjectUsageDone, fingerprintUsage=fingerprintUsage, spDNSName=spDNSName, deviceDiskUsage=deviceDiskUsage, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, managedObjectUsage=managedObjectUsage, spBlackholeTimeout=spBlackholeTimeout, PYSNMP_MODULE_ID=peakflowSPMIB, spFlowspecCommunity=spFlowspecCommunity, peakflowSPTraps=peakflowSPTraps, devicePhysicalMemory=devicePhysicalMemory, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapNewAttributes=spBGPTrapNewAttributes, collectorStart=collectorStart, spLicenseErrType=spLicenseErrType, spGreTunnelName=spGreTunnelName, mitigationDone=mitigationDone, deviceSystemError=deviceSystemError, spManagedObjectFamily=spManagedObjectFamily, spBGPTrapEvent=spBGPTrapEvent, spHijackRoute=spHijackRoute, spBlackholeCommunity=spBlackholeCommunity, spBlackholePrefix=spBlackholePrefix, spCommFailureDescription=spCommFailureDescription, configChange=configChange, mitigationTMSStartV2=mitigationTMSStartV2, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spReportID=spReportID, spScriptPort=spScriptPort, spDetectedCountries=spDetectedCountries, peakflowSPMgr=peakflowSPMgr, spTMSPrefix=spTMSPrefix, autoclassifyStart=autoclassifyStart, spUsername=spUsername, spMitigationID=spMitigationID, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spLicenseErrCount=spLicenseErrCount, spDNSObservedMean=spDNSObservedMean, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spLicenseErrLimit=spLicenseErrLimit, deviceTotalFlows=deviceTotalFlows, spMitigationName=spMitigationName, spInterfaceSpeed=spInterfaceSpeed, mitigationTMSStart=mitigationTMSStart, spDetector=spDetector, spGreTunnelDestination=spGreTunnelDestination, serviceUsage=serviceUsage, spInterface=spInterface, spRouter=spRouter, spManagedObject=spManagedObject, spThreshold=spThreshold, spAlertDetectionSignatures=spAlertDetectionSignatures, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpInstabilityDone=bgpInstabilityDone, spVersion=spVersion, spReportName=spReportName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationBlackholeStart=mitigationBlackholeStart, greDownDone=greDownDone, spManagedObjects=spManagedObjects, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSExpected=spDNSExpected, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUnit=spUnit, spBlackholeNexthop=spBlackholeNexthop)
