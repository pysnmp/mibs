...
Counter64, iso, Integer32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter32, TimeTicks, Bits, Unsigned32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter32", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceSwapSpace=deviceSwapSpace, spInterfaceSpeed=spInterfaceSpeed, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPTraps=peakflowSPTraps, spRouter=spRouter, spHijackRoute=spHijackRoute, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spHardwareFailureDescription=spHardwareFailureDescription, greDown=greDown, spTMSPrefix=spTMSPrefix, spDNSExpected=spDNSExpected, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPEvent=spBGPEvent, spInterface=spInterface, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spDNSName=spDNSName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, PYSNMP_MODULE_ID=peakflowSPMIB, devicePhysicalMemory=devicePhysicalMemory, mitigationBlackholeStart=mitigationBlackholeStart, spUsageType=spUsageType, spCommFailureDestination=spCommFailureDestination, spBGPInstability=spBGPInstability, deviceSystemErrorDone=deviceSystemErrorDone, spHijackAttr=spHijackAttr, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSwapSpaceUsage=deviceSwapSpaceUsage, alertScript=alertScript, spCollector=spCollector, spVersion=spVersion, trafficAutoMitigation=trafficAutoMitigation, dnsBaseline=dnsBaseline, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, snmpUp=snmpUp, spcommFailure=spcommFailure, spImpactPps=spImpactPps, spTMSCommunity=spTMSCommunity, spReportURL=spReportURL, spInetAddress=spInetAddress, spMitigationStart=spMitigationStart, spGreTunnelDestination=spGreTunnelDestination, spManagedObjects=spManagedObjects, spDetectedCountries=spDetectedCountries, spLicenseErrType=spLicenseErrType, peakflowSPCMI=peakflowSPCMI, mitigationDone=mitigationDone, cloudSignalingFault=cloudSignalingFault, spFlowspecCommunity=spFlowspecCommunity, mitigationFlowspecStart=mitigationFlowspecStart, spFlowspecTimeout=spFlowspecTimeout, deviceDiskUsage=deviceDiskUsage, spReportID=spReportID, spScriptPort=spScriptPort, spMitigationID=spMitigationID, serviceUsage=serviceUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyAddr=spThirdPartyAddr, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, snmpDown=snmpDown, managedObjectUsage=managedObjectUsage, peakflowSPMgr=peakflowSPMgr, managedObjectUsageDone=managedObjectUsageDone, spAlertID=spAlertID, bgpTrap=bgpTrap, spMitigationName=spMitigationName, flowDown=flowDown, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholePrefix=spBlackholePrefix, configChange=configChange, deviceHealth=deviceHealth, spBGPTrapPrefix=spBGPTrapPrefix, greDownDone=greDownDone, spInterfaceIndex=spInterfaceIndex, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpInstabilityDone=bgpInstabilityDone, spDNSObservedMax=spDNSObservedMax, fingerprintReceive=fingerprintReceive, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spPravail=spPravail, spDetector=spDetector, spDuration=spDuration, spServiceElement=spServiceElement, bgpDown=bgpDown, spFingerprintFeedback=spFingerprintFeedback, licenseError=licenseError, interfaceUsage=interfaceUsage, fingerprintUsage=fingerprintUsage, spFingerprintMessage=spFingerprintMessage, spThirdPartyZone=spThirdPartyZone, spcommFailureDone=spcommFailureDone, deviceTotalFlowsHC=deviceTotalFlowsHC, spDNSObservedMean=spDNSObservedMean, deviceTotalFlows=deviceTotalFlows, spImpactBps=spImpactBps, spBlackholeTimeout=spBlackholeTimeout, spGreTunnelName=spGreTunnelName, collectorDown=collectorDown, routingFailover=routingFailover, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spReportName=spReportName, spLicenseErrDescription=spLicenseErrDescription, collectorStart=collectorStart, hardwareFailureDone=hardwareFailureDone, spLicenseErrLimit=spLicenseErrLimit, flowUp=flowUp, deviceSystemError=deviceSystemError, fingerprintUsageDone=fingerprintUsageDone, spScriptCommand=spScriptCommand, peakflowSPMIB=peakflowSPMIB, dnsBaselineDone=dnsBaselineDone, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spTMSTimeout=spTMSTimeout, spUsage=spUsage, interfaceUsageDone=interfaceUsageDone, spApplicationName=spApplicationName, spInetAddressType=spInetAddressType, bgpUp=bgpUp, bgpHijack=bgpHijack, spCommFailureDescription=spCommFailureDescription, licenseErrorDone=licenseErrorDone, spUnit=spUnit, spFingerprintSender=spFingerprintSender, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spUsername=spUsername, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintName=spFingerprintName, mitigationTMSStart=mitigationTMSStart, fingerprintFeedback=fingerprintFeedback, spBGPTrapEvent=spBGPTrapEvent, reportDone=reportDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, autoclassifyStart=autoclassifyStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spHijackLocal=spHijackLocal, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceUsage=spInterfaceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObserved=spDNSObserved, spBlackholeNexthop=spBlackholeNexthop, serviceUsageDone=serviceUsageDone, spManagedObject=spManagedObject, spServiceName=spServiceName, bgpInstability=bgpInstability, spSystemErrorType=spSystemErrorType, spScriptStart=spScriptStart, spSystemErrorDescription=spSystemErrorDescription, notificationLimit=notificationLimit, spThreshold=spThreshold, spBGPTrapName=spBGPTrapName, spBlackholeCommunity=spBlackholeCommunity, spLicenseErrCount=spLicenseErrCount, hardwareFailure=hardwareFailure, collectorUp=collectorUp, spScriptHost=spScriptHost, spManagedObjectFamily=spManagedObjectFamily)
