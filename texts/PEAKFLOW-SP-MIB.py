...
MibIdentifier, iso, ModuleIdentity, Counter32, Unsigned32, NotificationType, Bits, IpAddress, ObjectIdentity, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "ModuleIdentity", "Counter32", "Unsigned32", "NotificationType", "Bits", "IpAddress", "ObjectIdentity", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSMultiPrefix=spTMSMultiPrefix, spBGPEvent=spBGPEvent, flowUp=flowUp, collectorUp=collectorUp, spcommFailure=spcommFailure, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapPrefix=spBGPTrapPrefix, bgpDown=bgpDown, cloudSignalingFaultDone=cloudSignalingFaultDone, snmpUp=snmpUp, spImpactPps=spImpactPps, flowDown=flowDown, configChange=configChange, spBlackholeCommunity=spBlackholeCommunity, spScriptHost=spScriptHost, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spDetectedCountries=spDetectedCountries, spUsername=spUsername, fingerprintUsage=fingerprintUsage, fingerprintUsageDone=fingerprintUsageDone, peakflowSPCMI=peakflowSPCMI, licenseError=licenseError, spInterfaceUsageHC=spInterfaceUsageHC, interfaceUsageDone=interfaceUsageDone, spSystemErrorDescription=spSystemErrorDescription, managedObjectUsageDone=managedObjectUsageDone, spAlertID=spAlertID, spServiceElement=spServiceElement, spManagedObjects=spManagedObjects, spLicenseErrCount=spLicenseErrCount, spCollector=spCollector, spInterfaceIndex=spInterfaceIndex, PYSNMP_MODULE_ID=peakflowSPMIB, dnsBaselineDone=dnsBaselineDone, licenseErrorDone=licenseErrorDone, spFingerprintMessage=spFingerprintMessage, spFingerprintSender=spFingerprintSender, spDNSExpected=spDNSExpected, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spMitigationName=spMitigationName, mitigationDone=mitigationDone, managedObjectUsage=managedObjectUsage, spSystemErrorType=spSystemErrorType, spInterfaceSpeedHC=spInterfaceSpeedHC, spScriptCommand=spScriptCommand, devicePhysicalMemory=devicePhysicalMemory, spManagedObjectFamily=spManagedObjectFamily, spHijackLocal=spHijackLocal, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDNSObserved=spDNSObserved, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, spDNSObservedMean=spDNSObservedMean, reportDone=reportDone, spBlackholePrefix=spBlackholePrefix, spInetAddress=spInetAddress, collectorDown=collectorDown, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapName=spBGPTrapName, spHijackRoute=spHijackRoute, peakflowSPTraps=peakflowSPTraps, peakflowSPMgr=peakflowSPMgr, spScriptPort=spScriptPort, spFingerprintName=spFingerprintName, deviceDiskUsage=deviceDiskUsage, spDNSObservedMax=spDNSObservedMax, spFlowspecCommunity=spFlowspecCommunity, spMitigationStart=spMitigationStart, serviceUsage=serviceUsage, spDuration=spDuration, dnsBaseline=dnsBaseline, bgpTrap=bgpTrap, spLicenseErrLimit=spLicenseErrLimit, spApplicationName=spApplicationName, mitigationFlowspecStart=mitigationFlowspecStart, spReportID=spReportID, spAlertDetectionSignatures=spAlertDetectionSignatures, dosHostDetectionAlert=dosHostDetectionAlert, spInterfaceUsage=spInterfaceUsage, serviceUsageDone=serviceUsageDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spLicenseErrDescription=spLicenseErrDescription, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spInetAddressType=spInetAddressType, spUsage=spUsage, spScriptStart=spScriptStart, spBlackholeNexthop=spBlackholeNexthop, deviceHealth=deviceHealth, spcommFailureDone=spcommFailureDone, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelDestination=spGreTunnelDestination, spDetector=spDetector, bgpHijack=bgpHijack, spTMSCommunity=spTMSCommunity, spInterface=spInterface, spUsageType=spUsageType, spCommFailureDestination=spCommFailureDestination, deviceSystemErrorDone=deviceSystemErrorDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapOldAttributes=spBGPTrapOldAttributes, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationTMSStart=mitigationTMSStart, spReportName=spReportName, spVersion=spVersion, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spImpactBps=spImpactBps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceSwapSpace=deviceSwapSpace, spManagedObject=spManagedObject, spMitigationID=spMitigationID, spLicenseErrType=spLicenseErrType, spDNSName=spDNSName, spBGPInstability=spBGPInstability, interfaceUsage=interfaceUsage, spTMSPrefix=spTMSPrefix, spServiceName=spServiceName, spFlowspecTimeout=spFlowspecTimeout, spThreshold=spThreshold, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSystemError=deviceSystemError, spThirdPartyZone=spThirdPartyZone, greDownDone=greDownDone, deviceTotalFlowsHC=deviceTotalFlowsHC, spRouter=spRouter, deviceTotalFlows=deviceTotalFlows, mitigationBlackholeStart=mitigationBlackholeStart, routingFailover=routingFailover, spPravail=spPravail, spUnit=spUnit, collectorStart=collectorStart, notificationLimit=notificationLimit, bgpUp=bgpUp, hardwareFailure=hardwareFailure, alertScript=alertScript, cloudSignalingFault=cloudSignalingFault, spTMSTimeout=spTMSTimeout, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapEvent=spBGPTrapEvent, fingerprintReceive=fingerprintReceive, spCommFailureDescription=spCommFailureDescription, spGreTunnelName=spGreTunnelName, trafficAutoMitigation=trafficAutoMitigation, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterfaceSpeed=spInterfaceSpeed, spReportURL=spReportURL, spHijackAttr=spHijackAttr, spCloudSignalFaultDescription=spCloudSignalFaultDescription, hardwareFailureDone=hardwareFailureDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, autoclassifyStart=autoclassifyStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, peakflowSPMIB=peakflowSPMIB, snmpDown=snmpDown, fingerprintFeedback=fingerprintFeedback, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpInstability=bgpInstability, spHardwareFailureDescription=spHardwareFailureDescription)
