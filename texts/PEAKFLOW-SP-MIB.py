...
Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ModuleIdentity, iso, MibIdentifier, IpAddress, NotificationType, ObjectIdentity, TimeTicks, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ModuleIdentity", "iso", "MibIdentifier", "IpAddress", "NotificationType", "ObjectIdentity", "TimeTicks", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spUnit=spUnit, spFingerprintName=spFingerprintName, dnsBaselineDone=dnsBaselineDone, spUsageType=spUsageType, spFingerprintSender=spFingerprintSender, spDNSObservedMax=spDNSObservedMax, deviceSwapSpaceUsage=deviceSwapSpaceUsage, snmpDown=snmpDown, hardwareFailureDone=hardwareFailureDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, bgpUp=bgpUp, managedObjectUsage=managedObjectUsage, spFingerprintFeedback=spFingerprintFeedback, spDNSObservedMean=spDNSObservedMean, spGreTunnelDestination=spGreTunnelDestination, collectorStart=collectorStart, spHijackRoute=spHijackRoute, dnsBaseline=dnsBaseline, spInterfaceIndex=spInterfaceIndex, flowDown=flowDown, spAlertID=spAlertID, spDNSExpected=spDNSExpected, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceUsage=spInterfaceUsage, fingerprintUsageDone=fingerprintUsageDone, spDetector=spDetector, spThreshold=spThreshold, spApplicationName=spApplicationName, deviceTotalFlows=deviceTotalFlows, flowUp=flowUp, spImpactBps=spImpactBps, deviceTotalFlowsHC=deviceTotalFlowsHC, spFingerprintMessage=spFingerprintMessage, mitigationFlowspecStart=mitigationFlowspecStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBlackholeCommunity=spBlackholeCommunity, spManagedObjectFamily=spManagedObjectFamily, spDNSName=spDNSName, spcommFailure=spcommFailure, spDNSObserved=spDNSObserved, bgpInstability=bgpInstability, reportDone=reportDone, deviceHealth=deviceHealth, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spImpactPps=spImpactPps, routingFailover=routingFailover, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPTrapEvent=spBGPTrapEvent, spCloudSignalFaultDescription=spCloudSignalFaultDescription, PYSNMP_MODULE_ID=peakflowSPMIB, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPTrapName=spBGPTrapName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, hardwareFailure=hardwareFailure, spServiceElement=spServiceElement, spGreTunnelName=spGreTunnelName, spScriptHost=spScriptHost, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapNewAttributes=spBGPTrapNewAttributes, bgpInstabilityDone=bgpInstabilityDone, fingerprintFeedback=fingerprintFeedback, spTMSPrefix=spTMSPrefix, peakflowSPMIB=peakflowSPMIB, interfaceUsageDone=interfaceUsageDone, alertScript=alertScript, spCommFailureDescription=spCommFailureDescription, configChange=configChange, spcommFailureDone=spcommFailureDone, bgpTrap=bgpTrap, spInetAddressType=spInetAddressType, spReportName=spReportName, collectorDown=collectorDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, peakflowSPCMI=peakflowSPCMI, spHardwareFailureDescription=spHardwareFailureDescription, spManagedObjects=spManagedObjects, spLicenseErrLimit=spLicenseErrLimit, greDownDone=greDownDone, deviceDiskUsage=deviceDiskUsage, spLicenseErrCount=spLicenseErrCount, spBlackholeNexthop=spBlackholeNexthop, mitigationTMSStart=mitigationTMSStart, bgpDown=bgpDown, spRouter=spRouter, peakflowSPTraps=peakflowSPTraps, autoclassifyStart=autoclassifyStart, spMitigationName=spMitigationName, fingerprintReceive=fingerprintReceive, spMitigationID=spMitigationID, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceSystemErrorDone=deviceSystemErrorDone, bgpHijack=bgpHijack, spReportURL=spReportURL, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spVersion=spVersion, spHijackAttr=spHijackAttr, spPravail=spPravail, spCommFailureDestination=spCommFailureDestination, managedObjectUsageDone=managedObjectUsageDone, spThirdPartyAddr=spThirdPartyAddr, notificationLimit=notificationLimit, spInterface=spInterface, spInterfaceSpeedHC=spInterfaceSpeedHC, licenseErrorDone=licenseErrorDone, spInetAddress=spInetAddress, spMitigationStart=spMitigationStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spReportID=spReportID, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemError=deviceSystemError, spScriptStart=spScriptStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPInstability=spBGPInstability, spFlowspecCommunity=spFlowspecCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsername=spUsername, mitigationDone=mitigationDone, spFlowspecTimeout=spFlowspecTimeout, snmpUp=snmpUp, spUsage=spUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSTimeout=spTMSTimeout, trafficAutoMitigation=trafficAutoMitigation, serviceUsageDone=serviceUsageDone, collectorUp=collectorUp, spManagedObject=spManagedObject, peakflowSPMgr=peakflowSPMgr, spSystemErrorType=spSystemErrorType, spLicenseErrDescription=spLicenseErrDescription, interfaceUsage=interfaceUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, greDown=greDown, licenseError=licenseError, spInterfaceUsageHC=spInterfaceUsageHC, devicePhysicalMemory=devicePhysicalMemory, spScriptCommand=spScriptCommand, spDetectedCountries=spDetectedCountries, dosHostDetectionAlert=dosHostDetectionAlert, spHijackLocal=spHijackLocal, spInterfaceSpeed=spInterfaceSpeed, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, fingerprintUsage=fingerprintUsage, cloudSignalingFault=cloudSignalingFault, deviceSwapSpace=deviceSwapSpace, spBlackholePrefix=spBlackholePrefix, spBGPTrapPrefix=spBGPTrapPrefix, spScriptPort=spScriptPort, dosHostDetectionAlertDone=dosHostDetectionAlertDone, serviceUsage=serviceUsage, spDuration=spDuration, spBGPEvent=spBGPEvent, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholeTimeout=spBlackholeTimeout, mitigationTMSStartV2=mitigationTMSStartV2, spTMSCommunity=spTMSCommunity, spServiceName=spServiceName, dosNetworkProfiledAlert=dosNetworkProfiledAlert)
