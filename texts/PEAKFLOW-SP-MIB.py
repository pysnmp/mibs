...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, NotificationType, ModuleIdentity, TimeTicks, ObjectIdentity, Integer32, Bits, MibIdentifier, Unsigned32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "NotificationType", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Integer32", "Bits", "MibIdentifier", "Unsigned32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", collectorUp=collectorUp, spScriptStart=spScriptStart, flowUp=flowUp, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, greDownDone=greDownDone, spGreTunnelDestination=spGreTunnelDestination, spSystemErrorDescription=spSystemErrorDescription, bgpDown=bgpDown, spAlertID=spAlertID, deviceSystemError=deviceSystemError, spInterfaceUsage=spInterfaceUsage, spFingerprintMessage=spFingerprintMessage, peakflowSPMgr=peakflowSPMgr, collectorDown=collectorDown, greDown=greDown, mitigationBlackholeStart=mitigationBlackholeStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSwapSpace=deviceSwapSpace, peakflowSPMIB=peakflowSPMIB, spTMSPrefix=spTMSPrefix, spInterfaceSpeed=spInterfaceSpeed, managedObjectUsage=managedObjectUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackRoute=spHijackRoute, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpUp=bgpUp, spBGPTrapEvent=spBGPTrapEvent, spCollector=spCollector, spDNSObservedMean=spDNSObservedMean, spBlackholeTimeout=spBlackholeTimeout, spLicenseErrDescription=spLicenseErrDescription, spUsageType=spUsageType, spGreTunnelName=spGreTunnelName, spFingerprintFeedback=spFingerprintFeedback, spManagedObject=spManagedObject, autoclassifyStart=autoclassifyStart, dnsBaselineDone=dnsBaselineDone, licenseError=licenseError, alertScript=alertScript, spLicenseErrLimit=spLicenseErrLimit, spReportURL=spReportURL, spFingerprintSender=spFingerprintSender, spThirdPartyZone=spThirdPartyZone, peakflowSPCMI=peakflowSPCMI, spUsername=spUsername, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObserved=spDNSObserved, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spReportID=spReportID, deviceSystemErrorDone=deviceSystemErrorDone, spScriptPort=spScriptPort, spMitigationStart=spMitigationStart, PYSNMP_MODULE_ID=peakflowSPMIB, spScriptCommand=spScriptCommand, spDetector=spDetector, spPravail=spPravail, devicePhysicalMemory=devicePhysicalMemory, mitigationTMSStart=mitigationTMSStart, collectorStart=collectorStart, spUnit=spUnit, spInetAddressType=spInetAddressType, spApplicationName=spApplicationName, spFlowspecTimeout=spFlowspecTimeout, notificationLimit=notificationLimit, spFlowspecCommunity=spFlowspecCommunity, spVersion=spVersion, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPEvent=spBGPEvent, spTMSMultiPrefix=spTMSMultiPrefix, spcommFailure=spcommFailure, dnsBaseline=dnsBaseline, spBGPInstability=spBGPInstability, deviceHealth=deviceHealth, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, serviceUsage=serviceUsage, deviceTotalFlows=deviceTotalFlows, fingerprintFeedback=fingerprintFeedback, spBlackholeNexthop=spBlackholeNexthop, spCommFailureDescription=spCommFailureDescription, spHijackLocal=spHijackLocal, spInterface=spInterface, spBGPTrapPrefix=spBGPTrapPrefix, fingerprintUsageDone=fingerprintUsageDone, spBlackholePrefix=spBlackholePrefix, mitigationDone=mitigationDone, spImpactBps=spImpactBps, spFingerprintName=spFingerprintName, spThirdPartyAddr=spThirdPartyAddr, spServiceElement=spServiceElement, interfaceUsage=interfaceUsage, hardwareFailureDone=hardwareFailureDone, spTMSCommunity=spTMSCommunity, spRouter=spRouter, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, flowDown=flowDown, spInetAddress=spInetAddress, spInterfaceSpeedHC=spInterfaceSpeedHC, spImpactPps=spImpactPps, spLicenseErrCount=spLicenseErrCount, reportDone=reportDone, spBlackholeCommunity=spBlackholeCommunity, dosNetworkProfiledAlert=dosNetworkProfiledAlert, configChange=configChange, spCommFailureDestination=spCommFailureDestination, trafficAutoMitigation=trafficAutoMitigation, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInterfaceUsageHC=spInterfaceUsageHC, bgpInstability=bgpInstability, spHardwareFailureDescription=spHardwareFailureDescription, spDetectedCountries=spDetectedCountries, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spServiceName=spServiceName, spManagedObjectFamily=spManagedObjectFamily, spcommFailureDone=spcommFailureDone, spInterfaceIndex=spInterfaceIndex, spBGPTrapName=spBGPTrapName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, licenseErrorDone=licenseErrorDone, spHijackAttr=spHijackAttr, fingerprintUsage=fingerprintUsage, snmpUp=snmpUp, serviceUsageDone=serviceUsageDone, spMitigationName=spMitigationName, bgpInstabilityDone=bgpInstabilityDone, deviceDiskUsage=deviceDiskUsage, dosHostDetectionAlert=dosHostDetectionAlert, spDNSName=spDNSName, cloudSignalingFault=cloudSignalingFault, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spUsage=spUsage, spDuration=spDuration, hardwareFailure=hardwareFailure, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, snmpDown=snmpDown, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spManagedObjects=spManagedObjects, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPTraps=peakflowSPTraps, spScriptHost=spScriptHost, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSExpected=spDNSExpected, managedObjectUsageDone=managedObjectUsageDone, mitigationFlowspecStart=mitigationFlowspecStart, spLicenseErrType=spLicenseErrType, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spThreshold=spThreshold, bgpHijack=bgpHijack, routingFailover=routingFailover, spReportName=spReportName, spDNSObservedMax=spDNSObservedMax, fingerprintReceive=fingerprintReceive, spTMSTimeout=spTMSTimeout, spSystemErrorType=spSystemErrorType, bgpTrap=bgpTrap, spMitigationID=spMitigationID, cloudSignalingFaultDone=cloudSignalingFaultDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, interfaceUsageDone=interfaceUsageDone)
