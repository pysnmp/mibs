...
NotificationType, TimeTicks, Gauge32, Integer32, ModuleIdentity, Counter32, MibIdentifier, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Gauge32", "Integer32", "ModuleIdentity", "Counter32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Counter64", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpHijack=bgpHijack, spMitigationStart=spMitigationStart, spLicenseErrType=spLicenseErrType, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, fingerprintUsage=fingerprintUsage, serviceUsage=serviceUsage, autoclassifyStart=autoclassifyStart, spMitigationID=spMitigationID, hardwareFailure=hardwareFailure, spInterfaceSpeedHC=spInterfaceSpeedHC, spServiceElement=spServiceElement, fingerprintReceive=fingerprintReceive, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, interfaceUsageDone=interfaceUsageDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationTMSStart=mitigationTMSStart, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationThirdPartyStart=mitigationThirdPartyStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSObservedMean=spDNSObservedMean, spManagedObjectFamily=spManagedObjectFamily, peakflowSPMIB=peakflowSPMIB, spUnit=spUnit, fingerprintFeedback=fingerprintFeedback, spMitigationName=spMitigationName, spFlowspecTimeout=spFlowspecTimeout, peakflowSPMgr=peakflowSPMgr, reportDone=reportDone, spInterface=spInterface, dnsBaseline=dnsBaseline, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spDNSObservedMax=spDNSObservedMax, spManagedObjects=spManagedObjects, spInterfaceUsage=spInterfaceUsage, flowDown=flowDown, dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFault=cloudSignalingFault, spRouter=spRouter, spUsageType=spUsageType, serviceUsageDone=serviceUsageDone, spGreTunnelName=spGreTunnelName, spInterfaceIndex=spInterfaceIndex, deviceSystemError=deviceSystemError, bgpUp=bgpUp, spcommFailureDone=spcommFailureDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spFingerprintSender=spFingerprintSender, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBGPTrapPrefix=spBGPTrapPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, greDownDone=greDownDone, bgpTrap=bgpTrap, spDuration=spDuration, mitigationFlowspecStart=mitigationFlowspecStart, mitigationDone=mitigationDone, spGreTunnelDestination=spGreTunnelDestination, spUsername=spUsername, spLicenseErrLimit=spLicenseErrLimit, spReportURL=spReportURL, spImpactPps=spImpactPps, deviceSwapSpaceUsage=deviceSwapSpaceUsage, licenseError=licenseError, spPravail=spPravail, deviceHealth=deviceHealth, spAlertID=spAlertID, spManagedObject=spManagedObject, spDetectedCountries=spDetectedCountries, spTMSPrefix=spTMSPrefix, spDNSObserved=spDNSObserved, spScriptHost=spScriptHost, spScriptStart=spScriptStart, mitigationTMSStartV2=mitigationTMSStartV2, spThreshold=spThreshold, configChange=configChange, deviceSystemErrorDone=deviceSystemErrorDone, notificationLimit=notificationLimit, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterfaceSpeed=spInterfaceSpeed, spDNSName=spDNSName, spBlackholeCommunity=spBlackholeCommunity, dnsBaselineDone=dnsBaselineDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceSwapSpace=deviceSwapSpace, spThirdPartyAddr=spThirdPartyAddr, spInetAddressType=spInetAddressType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, peakflowSPTraps=peakflowSPTraps, snmpDown=snmpDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spHardwareFailureDescription=spHardwareFailureDescription, spReportName=spReportName, flowUp=flowUp, deviceTotalFlows=deviceTotalFlows, spInetAddress=spInetAddress, spFingerprintMessage=spFingerprintMessage, spScriptCommand=spScriptCommand, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spSystemErrorDescription=spSystemErrorDescription, bgpDown=bgpDown, spTMSCommunity=spTMSCommunity, spBGPEvent=spBGPEvent, collectorDown=collectorDown, spFlowspecCommunity=spFlowspecCommunity, spScriptPort=spScriptPort, spHijackAttr=spHijackAttr, deviceDiskUsage=deviceDiskUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spTMSTimeout=spTMSTimeout, devicePhysicalMemory=devicePhysicalMemory, trafficAutoMitigation=trafficAutoMitigation, mitigationBlackholeStart=mitigationBlackholeStart, spReportID=spReportID, spServiceName=spServiceName, spCollector=spCollector, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spCommFailureDestination=spCommFailureDestination, spBlackholeTimeout=spBlackholeTimeout, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, routingFailover=routingFailover, fingerprintUsageDone=fingerprintUsageDone, spImpactBps=spImpactBps, spDetector=spDetector, spLicenseErrCount=spLicenseErrCount, spInterfaceUsageHC=spInterfaceUsageHC, interfaceUsage=interfaceUsage, licenseErrorDone=licenseErrorDone, managedObjectUsageDone=managedObjectUsageDone, spUsage=spUsage, bgpInstability=bgpInstability, spBlackholePrefix=spBlackholePrefix, snmpUp=snmpUp, spThirdPartyZone=spThirdPartyZone, spBGPTrapName=spBGPTrapName, spFingerprintName=spFingerprintName, spSystemErrorType=spSystemErrorType, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapEvent=spBGPTrapEvent, spHijackLocal=spHijackLocal, spFingerprintFeedback=spFingerprintFeedback, peakflowSPCMI=peakflowSPCMI, spcommFailure=spcommFailure, dosHostDetectionAlert=dosHostDetectionAlert, managedObjectUsage=managedObjectUsage, collectorStart=collectorStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, hardwareFailureDone=hardwareFailureDone, spDNSExpected=spDNSExpected, spVersion=spVersion, alertScript=alertScript, spApplicationName=spApplicationName, collectorUp=collectorUp, spBGPInstability=spBGPInstability, spHijackRoute=spHijackRoute, spBlackholeNexthop=spBlackholeNexthop, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spCommFailureDescription=spCommFailureDescription, spLicenseErrDescription=spLicenseErrDescription)
