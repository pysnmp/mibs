...
TimeTicks, ModuleIdentity, Counter32, Counter64, NotificationType, Bits, Gauge32, ObjectIdentity, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Counter32", "Counter64", "NotificationType", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", cloudSignalingFault=cloudSignalingFault, spFingerprintSender=spFingerprintSender, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spReportURL=spReportURL, spBGPInstability=spBGPInstability, spManagedObject=spManagedObject, spDetector=spDetector, spSystemErrorDescription=spSystemErrorDescription, collectorStart=collectorStart, peakflowSPTraps=peakflowSPTraps, spcommFailure=spcommFailure, spHijackAttr=spHijackAttr, spVersion=spVersion, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spDNSObserved=spDNSObserved, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpTrap=bgpTrap, spInterfaceIndex=spInterfaceIndex, dnsBaseline=dnsBaseline, spcommFailureDone=spcommFailureDone, spImpactPps=spImpactPps, spDNSExpected=spDNSExpected, mitigationFlowspecStart=mitigationFlowspecStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spInterfaceUsageHC=spInterfaceUsageHC, deviceTotalFlowsHC=deviceTotalFlowsHC, spFingerprintMessage=spFingerprintMessage, spServiceElement=spServiceElement, spLicenseErrCount=spLicenseErrCount, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSObservedMean=spDNSObservedMean, spRouter=spRouter, spMitigationName=spMitigationName, spScriptHost=spScriptHost, collectorUp=collectorUp, snmpUp=snmpUp, peakflowSPMIB=peakflowSPMIB, notificationLimit=notificationLimit, spAlertDetectionSignatures=spAlertDetectionSignatures, spAlertID=spAlertID, bgpInstabilityDone=bgpInstabilityDone, spBGPEvent=spBGPEvent, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, reportDone=reportDone, spUsageType=spUsageType, managedObjectUsage=managedObjectUsage, spApplicationName=spApplicationName, flowDown=flowDown, mitigationDone=mitigationDone, fingerprintFeedback=fingerprintFeedback, spHijackLocal=spHijackLocal, spInterfaceSpeed=spInterfaceSpeed, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholeCommunity=spBlackholeCommunity, spScriptPort=spScriptPort, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSwapSpaceUsage=deviceSwapSpaceUsage, greDownDone=greDownDone, alertScript=alertScript, spCommFailureDestination=spCommFailureDestination, spInetAddressType=spInetAddressType, trafficAutoMitigation=trafficAutoMitigation, spThreshold=spThreshold, spUnit=spUnit, configChange=configChange, serviceUsage=serviceUsage, interfaceUsageDone=interfaceUsageDone, serviceUsageDone=serviceUsageDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationBlackholeStart=mitigationBlackholeStart, routingFailover=routingFailover, spFingerprintName=spFingerprintName, deviceSystemError=deviceSystemError, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceSystemErrorDone=deviceSystemErrorDone, greDown=greDown, spBGPTrapName=spBGPTrapName, spScriptStart=spScriptStart, spDNSName=spDNSName, bgpHijack=bgpHijack, peakflowSPCMI=peakflowSPCMI, mitigationTMSStart=mitigationTMSStart, deviceDiskUsage=deviceDiskUsage, spInterface=spInterface, spGreTunnelName=spGreTunnelName, spPravail=spPravail, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeedHC=spInterfaceSpeedHC, spManagedObjects=spManagedObjects, spFlowspecTimeout=spFlowspecTimeout, bgpUp=bgpUp, hardwareFailureDone=hardwareFailureDone, PYSNMP_MODULE_ID=peakflowSPMIB, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPMgr=peakflowSPMgr, spInetAddress=spInetAddress, collectorDown=collectorDown, fingerprintUsageDone=fingerprintUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spTMSCommunity=spTMSCommunity, spFlowspecCommunity=spFlowspecCommunity, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintFeedback=spFingerprintFeedback, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, devicePhysicalMemory=devicePhysicalMemory, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, spTMSTimeout=spTMSTimeout, spScriptCommand=spScriptCommand, spDuration=spDuration, spHijackRoute=spHijackRoute, spCommFailureDescription=spCommFailureDescription, snmpDown=snmpDown, mitigationTMSStartV2=mitigationTMSStartV2, spHardwareFailureDescription=spHardwareFailureDescription, spMitigationStart=spMitigationStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, managedObjectUsageDone=managedObjectUsageDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spReportID=spReportID, spLicenseErrType=spLicenseErrType, spManagedObjectFamily=spManagedObjectFamily, spSystemErrorType=spSystemErrorType, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUsage=spUsage, fingerprintUsage=fingerprintUsage, spBGPTrapEvent=spBGPTrapEvent, bgpDown=bgpDown, spServiceName=spServiceName, licenseErrorDone=licenseErrorDone, spInterfaceUsage=spInterfaceUsage, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, spLicenseErrDescription=spLicenseErrDescription, interfaceUsage=interfaceUsage, spUsername=spUsername, licenseError=licenseError, spBlackholePrefix=spBlackholePrefix, fingerprintReceive=fingerprintReceive, flowUp=flowUp, spDNSObservedMax=spDNSObservedMax, deviceHealth=deviceHealth, spLicenseErrLimit=spLicenseErrLimit, bgpInstability=bgpInstability, autoclassifyStart=autoclassifyStart, dnsBaselineDone=dnsBaselineDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spDetectedCountries=spDetectedCountries, deviceSwapSpace=deviceSwapSpace, spReportName=spReportName, spMitigationID=spMitigationID, spBlackholeNexthop=spBlackholeNexthop, spBlackholeTimeout=spBlackholeTimeout, spGreTunnelDestination=spGreTunnelDestination, deviceTotalFlows=deviceTotalFlows, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBGPTrapPrefix=spBGPTrapPrefix, spTMSPrefix=spTMSPrefix)
