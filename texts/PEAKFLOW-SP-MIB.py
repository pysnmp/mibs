...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, ModuleIdentity, ObjectIdentity, Gauge32, Counter64, Bits, NotificationType, Counter32, Unsigned32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter64", "Bits", "NotificationType", "Counter32", "Unsigned32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, licenseError=licenseError, managedObjectUsageDone=managedObjectUsageDone, spServiceElement=spServiceElement, dosHostDetectionAlert=dosHostDetectionAlert, deviceSystemError=deviceSystemError, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPTrapEvent=spBGPTrapEvent, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spRouter=spRouter, spScriptHost=spScriptHost, managedObjectUsage=managedObjectUsage, spBlackholeTimeout=spBlackholeTimeout, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapOldAttributes=spBGPTrapOldAttributes, serviceUsage=serviceUsage, spReportID=spReportID, serviceUsageDone=serviceUsageDone, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObserved=spDNSObserved, spApplicationName=spApplicationName, spBlackholePrefix=spBlackholePrefix, deviceHealth=deviceHealth, mitigationDone=mitigationDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationBlackholeStart=mitigationBlackholeStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUsername=spUsername, spInetAddressType=spInetAddressType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpDown=bgpDown, spGreTunnelName=spGreTunnelName, greDownDone=greDownDone, dnsBaselineDone=dnsBaselineDone, fingerprintUsage=fingerprintUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpHijack=bgpHijack, spBlackholeCommunity=spBlackholeCommunity, spDNSObservedMean=spDNSObservedMean, spScriptStart=spScriptStart, spUsageType=spUsageType, spFingerprintSender=spFingerprintSender, spSystemErrorDescription=spSystemErrorDescription, spPravail=spPravail, spGreTunnelDestination=spGreTunnelDestination, spInetAddress=spInetAddress, routingFailover=routingFailover, spServiceName=spServiceName, spReportURL=spReportURL, spHijackRoute=spHijackRoute, spSystemErrorType=spSystemErrorType, snmpUp=snmpUp, spCommFailureDescription=spCommFailureDescription, peakflowSPTraps=peakflowSPTraps, spBGPTrapPrefix=spBGPTrapPrefix, mitigationTMSStart=mitigationTMSStart, spFingerprintName=spFingerprintName, hardwareFailureDone=hardwareFailureDone, spDuration=spDuration, spManagedObjects=spManagedObjects, spInterfaceSpeedHC=spInterfaceSpeedHC, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpInstabilityDone=bgpInstabilityDone, spAlertID=spAlertID, spDNSExpected=spDNSExpected, spScriptPort=spScriptPort, spScriptCommand=spScriptCommand, spTMSCommunity=spTMSCommunity, fingerprintReceive=fingerprintReceive, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailure=spcommFailure, spCommFailureDestination=spCommFailureDestination, spImpactPps=spImpactPps, spVersion=spVersion, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDetector=spDetector, deviceDiskUsage=deviceDiskUsage, cloudSignalingFault=cloudSignalingFault, collectorUp=collectorUp, spLicenseErrLimit=spLicenseErrLimit, spManagedObject=spManagedObject, spFingerprintMessage=spFingerprintMessage, spBGPTrapName=spBGPTrapName, reportDone=reportDone, flowDown=flowDown, configChange=configChange, deviceSwapSpace=deviceSwapSpace, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, notificationLimit=notificationLimit, bgpInstability=bgpInstability, spFlowspecTimeout=spFlowspecTimeout, spDNSName=spDNSName, fingerprintFeedback=fingerprintFeedback, spReportName=spReportName, spUsage=spUsage, bgpUp=bgpUp, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlows=deviceTotalFlows, spFlowspecCommunity=spFlowspecCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, spThirdPartyZone=spThirdPartyZone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dnsBaseline=dnsBaseline, alertScript=alertScript, interfaceUsage=interfaceUsage, licenseErrorDone=licenseErrorDone, spHijackAttr=spHijackAttr, spManagedObjectFamily=spManagedObjectFamily, spCloudSignalFaultDescription=spCloudSignalFaultDescription, trafficAutoMitigation=trafficAutoMitigation, snmpDown=snmpDown, mitigationFlowspecStart=mitigationFlowspecStart, spMitigationID=spMitigationID, spcommFailureDone=spcommFailureDone, spFingerprintFeedback=spFingerprintFeedback, spHardwareFailureDescription=spHardwareFailureDescription, spLicenseErrCount=spLicenseErrCount, spImpactBps=spImpactBps, spBGPEvent=spBGPEvent, hardwareFailure=hardwareFailure, spBGPInstability=spBGPInstability, spInterfaceSpeed=spInterfaceSpeed, interfaceUsageDone=interfaceUsageDone, spCollector=spCollector, spUnit=spUnit, spMitigationStart=spMitigationStart, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsageDone=fingerprintUsageDone, spThreshold=spThreshold, spTMSMultiPrefix=spTMSMultiPrefix, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, mitigationTMSStartV2=mitigationTMSStartV2, deviceTotalFlowsHC=deviceTotalFlowsHC, autoclassifyStart=autoclassifyStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spTMSPrefix=spTMSPrefix, spInterface=spInterface, spBlackholeNexthop=spBlackholeNexthop, spLicenseErrType=spLicenseErrType, spInterfaceUsage=spInterfaceUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, flowUp=flowUp, peakflowSPMgr=peakflowSPMgr, spLicenseErrDescription=spLicenseErrDescription, peakflowSPCMI=peakflowSPCMI, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpTrap=bgpTrap, spDNSObservedMax=spDNSObservedMax, collectorStart=collectorStart, spThirdPartyAddr=spThirdPartyAddr, collectorDown=collectorDown, peakflowSPMIB=peakflowSPMIB, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spTMSTimeout=spTMSTimeout, spMitigationName=spMitigationName, spHijackLocal=spHijackLocal, spInterfaceIndex=spInterfaceIndex, greDown=greDown)
