...
Counter32, ModuleIdentity, iso, Bits, MibIdentifier, IpAddress, Counter64, TimeTicks, Unsigned32, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "Bits", "MibIdentifier", "IpAddress", "Counter64", "TimeTicks", "Unsigned32", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spFingerprintFeedback=spFingerprintFeedback, cloudSignalingFaultDone=cloudSignalingFaultDone, spDNSName=spDNSName, bgpUp=bgpUp, collectorUp=collectorUp, spTMSCommunity=spTMSCommunity, spDetector=spDetector, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spImpactPps=spImpactPps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInetAddressType=spInetAddressType, greDownDone=greDownDone, deviceSystemErrorDone=deviceSystemErrorDone, trafficAutoMitigation=trafficAutoMitigation, spScriptStart=spScriptStart, peakflowSPMgr=peakflowSPMgr, spcommFailure=spcommFailure, dnsBaselineDone=dnsBaselineDone, spLicenseErrDescription=spLicenseErrDescription, dosHostDetectionAlert=dosHostDetectionAlert, interfaceUsage=interfaceUsage, bgpDown=bgpDown, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, serviceUsageDone=serviceUsageDone, spGreTunnelDestination=spGreTunnelDestination, licenseError=licenseError, spCommFailureDescription=spCommFailureDescription, hardwareFailure=hardwareFailure, routingFailover=routingFailover, spHijackAttr=spHijackAttr, spBGPTrapPrefix=spBGPTrapPrefix, collectorDown=collectorDown, mitigationBlackholeStart=mitigationBlackholeStart, notificationLimit=notificationLimit, spServiceElement=spServiceElement, PYSNMP_MODULE_ID=peakflowSPMIB, alertScript=alertScript, spMitigationStart=spMitigationStart, spReportID=spReportID, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dnsBaseline=dnsBaseline, peakflowSPMIB=peakflowSPMIB, spDNSExpected=spDNSExpected, spPravail=spPravail, spAlertDetectionSignatures=spAlertDetectionSignatures, autoclassifyStart=autoclassifyStart, spTMSMultiPrefix=spTMSMultiPrefix, spScriptHost=spScriptHost, devicePhysicalMemory=devicePhysicalMemory, spThirdPartyAddr=spThirdPartyAddr, spDuration=spDuration, spHardwareFailureDescription=spHardwareFailureDescription, spMitigationID=spMitigationID, bgpHijack=bgpHijack, snmpUp=snmpUp, spTMSTimeout=spTMSTimeout, serviceUsage=serviceUsage, spBGPTrapEvent=spBGPTrapEvent, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spReportURL=spReportURL, flowDown=flowDown, interfaceUsageDone=interfaceUsageDone, spBlackholeNexthop=spBlackholeNexthop, spFingerprintSender=spFingerprintSender, spManagedObject=spManagedObject, deviceTotalFlowsHC=deviceTotalFlowsHC, spInterfaceUsage=spInterfaceUsage, spFlowspecCommunity=spFlowspecCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptPort=spScriptPort, spFingerprintName=spFingerprintName, spFingerprintMessage=spFingerprintMessage, licenseErrorDone=licenseErrorDone, spInterface=spInterface, managedObjectUsage=managedObjectUsage, spCommFailureDestination=spCommFailureDestination, spInterfaceIndex=spInterfaceIndex, spBlackholeTimeout=spBlackholeTimeout, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spcommFailureDone=spcommFailureDone, spReportName=spReportName, spHijackRoute=spHijackRoute, spLicenseErrLimit=spLicenseErrLimit, spHijackLocal=spHijackLocal, spRouter=spRouter, collectorStart=collectorStart, deviceDiskUsage=deviceDiskUsage, spMitigationName=spMitigationName, fingerprintUsage=fingerprintUsage, spThirdPartyZone=spThirdPartyZone, spDNSObservedMean=spDNSObservedMean, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPTrapName=spBGPTrapName, mitigationFlowspecStart=mitigationFlowspecStart, cloudSignalingFault=cloudSignalingFault, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spSystemErrorType=spSystemErrorType, spVersion=spVersion, spManagedObjects=spManagedObjects, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSystemError=deviceSystemError, mitigationDone=mitigationDone, spAlertID=spAlertID, spInetAddress=spInetAddress, managedObjectUsageDone=managedObjectUsageDone, bgpInstability=bgpInstability, reportDone=reportDone, spUsageType=spUsageType, snmpDown=snmpDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSObserved=spDNSObserved, spScriptCommand=spScriptCommand, spGreTunnelName=spGreTunnelName, spUsername=spUsername, peakflowSPTraps=peakflowSPTraps, spUsage=spUsage, deviceHealth=deviceHealth, flowUp=flowUp, fingerprintFeedback=fingerprintFeedback, spLicenseErrType=spLicenseErrType, spApplicationName=spApplicationName, spServiceName=spServiceName, spTMSPrefix=spTMSPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, hardwareFailureDone=hardwareFailureDone, peakflowSPCMI=peakflowSPCMI, spManagedObjectFamily=spManagedObjectFamily, spBlackholePrefix=spBlackholePrefix, mitigationTMSStartV2=mitigationTMSStartV2, spUnit=spUnit, spFlowspecTimeout=spFlowspecTimeout, spLicenseErrCount=spLicenseErrCount, deviceSwapSpace=deviceSwapSpace, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDetectedCountries=spDetectedCountries, spBGPInstability=spBGPInstability, spDNSObservedMax=spDNSObservedMax, mitigationTMSStart=mitigationTMSStart, bgpTrap=bgpTrap, spBGPEvent=spBGPEvent, greDown=greDown, fingerprintUsageDone=fingerprintUsageDone, spThreshold=spThreshold, spBlackholeCommunity=spBlackholeCommunity, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, configChange=configChange, fingerprintReceive=fingerprintReceive, mitigationThirdPartyStart=mitigationThirdPartyStart, spSystemErrorDescription=spSystemErrorDescription, spInterfaceUsageHC=spInterfaceUsageHC, bgpInstabilityDone=bgpInstabilityDone, deviceTotalFlows=deviceTotalFlows, spImpactBps=spImpactBps, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceSpeed=spInterfaceSpeed, spInterfaceSpeedHC=spInterfaceSpeedHC, spCollector=spCollector)
