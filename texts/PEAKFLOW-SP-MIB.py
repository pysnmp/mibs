...
ModuleIdentity, TimeTicks, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, IpAddress, Gauge32, NotificationType, iso, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "IpAddress", "Gauge32", "NotificationType", "iso", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDetector=spDetector, interfaceUsage=interfaceUsage, mitigationTMSStart=mitigationTMSStart, spBGPTrapPrefix=spBGPTrapPrefix, dosHostDetectionAlert=dosHostDetectionAlert, spInterface=spInterface, spBlackholeTimeout=spBlackholeTimeout, spBlackholeNexthop=spBlackholeNexthop, spUsage=spUsage, serviceUsageDone=serviceUsageDone, hardwareFailureDone=hardwareFailureDone, spUsername=spUsername, hardwareFailure=hardwareFailure, spUsageType=spUsageType, spDNSObservedMax=spDNSObservedMax, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCommFailureDescription=spCommFailureDescription, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spThirdPartyZone=spThirdPartyZone, spApplicationName=spApplicationName, spInterfaceUsageHC=spInterfaceUsageHC, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSCommunity=spTMSCommunity, spImpactBps=spImpactBps, alertScript=alertScript, spDuration=spDuration, spCommFailureDestination=spCommFailureDestination, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spRouter=spRouter, deviceSystemErrorDone=deviceSystemErrorDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, managedObjectUsage=managedObjectUsage, spReportID=spReportID, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingFault=cloudSignalingFault, spInetAddressType=spInetAddressType, spCollector=spCollector, spReportURL=spReportURL, spUnit=spUnit, PYSNMP_MODULE_ID=peakflowSPMIB, spLicenseErrDescription=spLicenseErrDescription, collectorStart=collectorStart, flowDown=flowDown, spThreshold=spThreshold, peakflowSPCMI=peakflowSPCMI, spScriptCommand=spScriptCommand, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrLimit=spLicenseErrLimit, spInterfaceSpeed=spInterfaceSpeed, deviceHealth=deviceHealth, bgpTrap=bgpTrap, mitigationDone=mitigationDone, spInterfaceUsage=spInterfaceUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDNSObservedMean=spDNSObservedMean, spFingerprintSender=spFingerprintSender, snmpDown=snmpDown, reportDone=reportDone, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationBlackholeStart=mitigationBlackholeStart, spSystemErrorDescription=spSystemErrorDescription, spThirdPartyAddr=spThirdPartyAddr, mitigationFlowspecStart=mitigationFlowspecStart, fingerprintFeedback=fingerprintFeedback, spBGPEvent=spBGPEvent, spVersion=spVersion, bgpUp=bgpUp, spDetectedCountries=spDetectedCountries, spTMSMultiPrefix=spTMSMultiPrefix, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spGreTunnelDestination=spGreTunnelDestination, spServiceElement=spServiceElement, spFingerprintName=spFingerprintName, greDownDone=greDownDone, spFlowspecCommunity=spFlowspecCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spTMSPrefix=spTMSPrefix, spGreTunnelName=spGreTunnelName, mitigationThirdPartyStart=mitigationThirdPartyStart, spScriptPort=spScriptPort, licenseErrorDone=licenseErrorDone, spManagedObject=spManagedObject, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceTotalFlows=deviceTotalFlows, configChange=configChange, fingerprintUsageDone=fingerprintUsageDone, snmpUp=snmpUp, spMitigationID=spMitigationID, spServiceName=spServiceName, spPravail=spPravail, fingerprintReceive=fingerprintReceive, spInterfaceIndex=spInterfaceIndex, spHijackLocal=spHijackLocal, collectorUp=collectorUp, bgpInstability=bgpInstability, deviceSystemError=deviceSystemError, trafficAutoMitigation=trafficAutoMitigation, spcommFailure=spcommFailure, routingFailover=routingFailover, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spAlertID=spAlertID, spInetAddress=spInetAddress, spInterfaceSpeedHC=spInterfaceSpeedHC, spFingerprintMessage=spFingerprintMessage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spLicenseErrType=spLicenseErrType, spScriptHost=spScriptHost, bgpDown=bgpDown, spcommFailureDone=spcommFailureDone, mitigationTMSStartV2=mitigationTMSStartV2, spDNSName=spDNSName, peakflowSPMIB=peakflowSPMIB, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, autoclassifyStart=autoclassifyStart, dnsBaseline=dnsBaseline, licenseError=licenseError, notificationLimit=notificationLimit, bgpHijack=bgpHijack, spFingerprintFeedback=spFingerprintFeedback, spReportName=spReportName, spLicenseErrCount=spLicenseErrCount, spMitigationStart=spMitigationStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spHardwareFailureDescription=spHardwareFailureDescription, managedObjectUsageDone=managedObjectUsageDone, spTMSTimeout=spTMSTimeout, fingerprintUsage=fingerprintUsage, spBlackholePrefix=spBlackholePrefix, spFlowspecTimeout=spFlowspecTimeout, flowUp=flowUp, spDNSExpected=spDNSExpected, spBGPInstability=spBGPInstability, spHijackAttr=spHijackAttr, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, interfaceUsageDone=interfaceUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemory=devicePhysicalMemory, spImpactPps=spImpactPps, spBlackholeCommunity=spBlackholeCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spHijackRoute=spHijackRoute, deviceSwapSpace=deviceSwapSpace, spMitigationName=spMitigationName, collectorDown=collectorDown, spManagedObjectFamily=spManagedObjectFamily, peakflowSPTraps=peakflowSPTraps, spBGPTrapEvent=spBGPTrapEvent, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dnsBaselineDone=dnsBaselineDone, deviceDiskUsage=deviceDiskUsage, serviceUsage=serviceUsage, spManagedObjects=spManagedObjects, spDNSObserved=spDNSObserved, spBGPTrapName=spBGPTrapName, spSystemErrorType=spSystemErrorType, peakflowSPMgr=peakflowSPMgr, spScriptStart=spScriptStart)
