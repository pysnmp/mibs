...
Unsigned32, Integer32, ObjectIdentity, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, MibIdentifier, iso, NotificationType, IpAddress, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "ObjectIdentity", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "MibIdentifier", "iso", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBlackholePrefix=spBlackholePrefix, spScriptPort=spScriptPort, collectorDown=collectorDown, dnsBaseline=dnsBaseline, spBlackholeCommunity=spBlackholeCommunity, spTMSTimeout=spTMSTimeout, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPTraps=peakflowSPTraps, spGreTunnelName=spGreTunnelName, spFingerprintSender=spFingerprintSender, fingerprintUsageDone=fingerprintUsageDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, deviceDiskUsage=deviceDiskUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, fingerprintUsage=fingerprintUsage, spInterfaceIndex=spInterfaceIndex, spVersion=spVersion, spBGPEvent=spBGPEvent, spSystemErrorDescription=spSystemErrorDescription, spInetAddressType=spInetAddressType, spDNSExpected=spDNSExpected, spServiceElement=spServiceElement, serviceUsageDone=serviceUsageDone, spInterface=spInterface, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHijackAttr=spHijackAttr, spBGPTrapName=spBGPTrapName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBlackholeTimeout=spBlackholeTimeout, spBGPInstability=spBGPInstability, spDNSObservedMax=spDNSObservedMax, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spCommFailureDestination=spCommFailureDestination, spManagedObjects=spManagedObjects, spInterfaceUsage=spInterfaceUsage, spDNSName=spDNSName, mitigationTMSStart=mitigationTMSStart, interfaceUsage=interfaceUsage, cloudSignalingFault=cloudSignalingFault, spBlackholeNexthop=spBlackholeNexthop, spAlertDetectionSignatures=spAlertDetectionSignatures, bgpDown=bgpDown, PYSNMP_MODULE_ID=peakflowSPMIB, spDuration=spDuration, spUnit=spUnit, deviceSwapSpace=deviceSwapSpace, alertScript=alertScript, spCommFailureDescription=spCommFailureDescription, dnsBaselineDone=dnsBaselineDone, peakflowSPMIB=peakflowSPMIB, peakflowSPMgr=peakflowSPMgr, spBGPTrapEvent=spBGPTrapEvent, spDetectedCountries=spDetectedCountries, licenseError=licenseError, spManagedObjectFamily=spManagedObjectFamily, spPravail=spPravail, trafficAutoMitigation=trafficAutoMitigation, greDown=greDown, spLicenseErrDescription=spLicenseErrDescription, spScriptStart=spScriptStart, spServiceName=spServiceName, spReportID=spReportID, mitigationFlowspecStart=mitigationFlowspecStart, spAlertID=spAlertID, spReportName=spReportName, spUsername=spUsername, bgpTrap=bgpTrap, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spLicenseErrType=spLicenseErrType, hardwareFailureDone=hardwareFailureDone, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailure=spcommFailure, flowDown=flowDown, spLicenseErrLimit=spLicenseErrLimit, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spThreshold=spThreshold, spSystemErrorType=spSystemErrorType, deviceSystemError=deviceSystemError, spReportURL=spReportURL, devicePhysicalMemory=devicePhysicalMemory, bgpHijack=bgpHijack, spTMSPrefix=spTMSPrefix, snmpUp=snmpUp, spMitigationStart=spMitigationStart, spInetAddress=spInetAddress, snmpDown=snmpDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spGreTunnelDestination=spGreTunnelDestination, deviceTotalFlows=deviceTotalFlows, dosHostDetectionAlert=dosHostDetectionAlert, fingerprintFeedback=fingerprintFeedback, fingerprintReceive=fingerprintReceive, spThirdPartyAddr=spThirdPartyAddr, mitigationBlackholeStart=mitigationBlackholeStart, mitigationDone=mitigationDone, spScriptCommand=spScriptCommand, spHijackRoute=spHijackRoute, spMitigationID=spMitigationID, spFingerprintName=spFingerprintName, spHijackLocal=spHijackLocal, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintMessage=spFingerprintMessage, spInterfaceUsageHC=spInterfaceUsageHC, deviceTotalFlowsHC=deviceTotalFlowsHC, spFlowspecTimeout=spFlowspecTimeout, spMitigationName=spMitigationName, bgpInstability=bgpInstability, collectorUp=collectorUp, licenseErrorDone=licenseErrorDone, configChange=configChange, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, managedObjectUsage=managedObjectUsage, mitigationThirdPartyStart=mitigationThirdPartyStart, autoclassifyStart=autoclassifyStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spManagedObject=spManagedObject, routingFailover=routingFailover, spThirdPartyZone=spThirdPartyZone, spDNSObserved=spDNSObserved, spFlowspecCommunity=spFlowspecCommunity, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, reportDone=reportDone, spApplicationName=spApplicationName, spImpactPps=spImpactPps, spTMSMultiPrefix=spTMSMultiPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, greDownDone=greDownDone, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spFingerprintFeedback=spFingerprintFeedback, spScriptHost=spScriptHost, managedObjectUsageDone=managedObjectUsageDone, spUsageType=spUsageType, interfaceUsageDone=interfaceUsageDone, spLicenseErrCount=spLicenseErrCount, bgpUp=bgpUp, spCollector=spCollector, collectorStart=collectorStart, deviceHealth=deviceHealth, spUsage=spUsage, spDNSObservedMean=spDNSObservedMean, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapPrefix=spBGPTrapPrefix, notificationLimit=notificationLimit, peakflowSPCMI=peakflowSPCMI, spTMSCommunity=spTMSCommunity, spcommFailureDone=spcommFailureDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, flowUp=flowUp, serviceUsage=serviceUsage, spDetector=spDetector)
