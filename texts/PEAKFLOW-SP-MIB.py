...
TimeTicks, ModuleIdentity, Counter64, Bits, Gauge32, Integer32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Counter64", "Bits", "Gauge32", "Integer32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", interfaceUsageDone=interfaceUsageDone, spServiceElement=spServiceElement, spUsername=spUsername, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpInstability=bgpInstability, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, notificationLimit=notificationLimit, spCommFailureDestination=spCommFailureDestination, spLicenseErrType=spLicenseErrType, spUsageType=spUsageType, spScriptStart=spScriptStart, collectorStart=collectorStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyAddr=spThirdPartyAddr, PYSNMP_MODULE_ID=peakflowSPMIB, fingerprintUsage=fingerprintUsage, spTMSPrefix=spTMSPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, dnsBaseline=dnsBaseline, managedObjectUsage=managedObjectUsage, spHijackAttr=spHijackAttr, peakflowSPMIB=peakflowSPMIB, spcommFailureDone=spcommFailureDone, spMitigationID=spMitigationID, managedObjectUsageDone=managedObjectUsageDone, spThreshold=spThreshold, spFingerprintMessage=spFingerprintMessage, spMitigationStart=spMitigationStart, serviceUsageDone=serviceUsageDone, spAlertID=spAlertID, spHijackLocal=spHijackLocal, spBlackholeCommunity=spBlackholeCommunity, spcommFailure=spcommFailure, spCollector=spCollector, spLicenseErrCount=spLicenseErrCount, spMitigationName=spMitigationName, spServiceName=spServiceName, spDNSObservedMean=spDNSObservedMean, spPravail=spPravail, spBGPInstability=spBGPInstability, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceUsage=spInterfaceUsage, spGreTunnelDestination=spGreTunnelDestination, greDownDone=greDownDone, spLicenseErrDescription=spLicenseErrDescription, bgpUp=bgpUp, spReportURL=spReportURL, peakflowSPCMI=peakflowSPCMI, collectorDown=collectorDown, spDetectedCountries=spDetectedCountries, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyZone=spThirdPartyZone, spDNSObservedMax=spDNSObservedMax, spUnit=spUnit, spFlowspecCommunity=spFlowspecCommunity, spManagedObjectFamily=spManagedObjectFamily, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spImpactPps=spImpactPps, deviceSwapSpace=deviceSwapSpace, routingFailover=routingFailover, peakflowSPMgr=peakflowSPMgr, flowUp=flowUp, spInetAddressType=spInetAddressType, spInterface=spInterface, reportDone=reportDone, spScriptCommand=spScriptCommand, alertScript=alertScript, spTMSCommunity=spTMSCommunity, spImpactBps=spImpactBps, flowDown=flowDown, spInterfaceSpeed=spInterfaceSpeed, interfaceUsage=interfaceUsage, spInterfaceUsageHC=spInterfaceUsageHC, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spApplicationName=spApplicationName, hardwareFailure=hardwareFailure, peakflowSPTraps=peakflowSPTraps, spHijackRoute=spHijackRoute, spManagedObject=spManagedObject, spBGPTrapName=spBGPTrapName, spFingerprintFeedback=spFingerprintFeedback, snmpDown=snmpDown, spGreTunnelName=spGreTunnelName, spDuration=spDuration, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spTMSTimeout=spTMSTimeout, spVersion=spVersion, spScriptPort=spScriptPort, spBGPTrapNewAttributes=spBGPTrapNewAttributes, trafficAutoMitigation=trafficAutoMitigation, licenseError=licenseError, spScriptHost=spScriptHost, cloudSignalingFaultDone=cloudSignalingFaultDone, spSystemErrorDescription=spSystemErrorDescription, dnsBaselineDone=dnsBaselineDone, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceTotalFlowsHC=deviceTotalFlowsHC, spRouter=spRouter, devicePhysicalMemory=devicePhysicalMemory, spHardwareFailureDescription=spHardwareFailureDescription, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationTMSStart=mitigationTMSStart, spInterfaceIndex=spInterfaceIndex, spReportID=spReportID, spUsage=spUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingFault=cloudSignalingFault, mitigationBlackholeStart=mitigationBlackholeStart, licenseErrorDone=licenseErrorDone, spInetAddress=spInetAddress, hardwareFailureDone=hardwareFailureDone, serviceUsage=serviceUsage, fingerprintFeedback=fingerprintFeedback, spDNSName=spDNSName, fingerprintUsageDone=fingerprintUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, fingerprintReceive=fingerprintReceive, spReportName=spReportName, bgpDown=bgpDown, spBlackholeTimeout=spBlackholeTimeout, deviceTotalFlows=deviceTotalFlows, spManagedObjects=spManagedObjects, spSystemErrorType=spSystemErrorType, deviceSystemErrorDone=deviceSystemErrorDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, mitigationDone=mitigationDone, spFlowspecTimeout=spFlowspecTimeout, snmpUp=snmpUp, spCommFailureDescription=spCommFailureDescription, spFingerprintName=spFingerprintName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSystemError=deviceSystemError, deviceHealth=deviceHealth, greDown=greDown, spBGPTrapPrefix=spBGPTrapPrefix, dosHostDetectionAlert=dosHostDetectionAlert, mitigationTMSStartV2=mitigationTMSStartV2, spDetector=spDetector, bgpTrap=bgpTrap, deviceDiskUsage=deviceDiskUsage, spBGPEvent=spBGPEvent, spLicenseErrLimit=spLicenseErrLimit, spDNSObserved=spDNSObserved, collectorUp=collectorUp, spDNSExpected=spDNSExpected, spBlackholePrefix=spBlackholePrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpInstabilityDone=bgpInstabilityDone, autoclassifyStart=autoclassifyStart, spFingerprintSender=spFingerprintSender, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpHijack=bgpHijack, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBlackholeNexthop=spBlackholeNexthop, mitigationFlowspecStart=mitigationFlowspecStart, configChange=configChange)
