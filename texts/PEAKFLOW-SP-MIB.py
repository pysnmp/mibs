...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, IpAddress, ModuleIdentity, iso, Gauge32, ObjectIdentity, Bits, Counter64, MibIdentifier, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "IpAddress", "ModuleIdentity", "iso", "Gauge32", "ObjectIdentity", "Bits", "Counter64", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spcommFailure=spcommFailure, spImpactPps=spImpactPps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spReportURL=spReportURL, spScriptStart=spScriptStart, spCommFailureDescription=spCommFailureDescription, fingerprintReceive=fingerprintReceive, spBGPTrapPrefix=spBGPTrapPrefix, mitigationTMSStart=mitigationTMSStart, spFingerprintSender=spFingerprintSender, spDNSExpected=spDNSExpected, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, interfaceUsageDone=interfaceUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, fingerprintUsage=fingerprintUsage, spHijackRoute=spHijackRoute, mitigationTMSStartV2=mitigationTMSStartV2, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spHijackAttr=spHijackAttr, spCloudSignalFaultDescription=spCloudSignalFaultDescription, managedObjectUsageDone=managedObjectUsageDone, spDuration=spDuration, spScriptPort=spScriptPort, spInetAddress=spInetAddress, dnsBaselineDone=dnsBaselineDone, spTMSCommunity=spTMSCommunity, spReportID=spReportID, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spUsageType=spUsageType, spManagedObject=spManagedObject, spBlackholeTimeout=spBlackholeTimeout, spInterfaceSpeed=spInterfaceSpeed, spThreshold=spThreshold, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spApplicationName=spApplicationName, reportDone=reportDone, spInterface=spInterface, spTMSTimeout=spTMSTimeout, spMitigationStart=spMitigationStart, spBlackholePrefix=spBlackholePrefix, spDNSObservedMean=spDNSObservedMean, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spPravail=spPravail, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, collectorStart=collectorStart, deviceDiskUsage=deviceDiskUsage, bgpHijack=bgpHijack, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPMIB=peakflowSPMIB, bgpDown=bgpDown, spTMSPrefix=spTMSPrefix, spManagedObjectFamily=spManagedObjectFamily, spcommFailureDone=spcommFailureDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spHardwareFailureDescription=spHardwareFailureDescription, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, interfaceUsage=interfaceUsage, spUnit=spUnit, trafficAutoMitigation=trafficAutoMitigation, spUsage=spUsage, spSystemErrorType=spSystemErrorType, bgpTrap=bgpTrap, spScriptHost=spScriptHost, deviceSystemErrorDone=deviceSystemErrorDone, cloudSignalingFault=cloudSignalingFault, spReportName=spReportName, greDownDone=greDownDone, spLicenseErrType=spLicenseErrType, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPInstability=spBGPInstability, bgpInstabilityDone=bgpInstabilityDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spLicenseErrCount=spLicenseErrCount, spDNSName=spDNSName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSMultiPrefix=spTMSMultiPrefix, spDNSObservedMax=spDNSObservedMax, spLicenseErrDescription=spLicenseErrDescription, spManagedObjects=spManagedObjects, collectorUp=collectorUp, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapEvent=spBGPTrapEvent, spAlertID=spAlertID, fingerprintUsageDone=fingerprintUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPMgr=peakflowSPMgr, deviceSystemError=deviceSystemError, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpUp=bgpUp, peakflowSPCMI=peakflowSPCMI, greDown=greDown, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, hardwareFailureDone=hardwareFailureDone, spFingerprintName=spFingerprintName, spMitigationID=spMitigationID, collectorDown=collectorDown, spDNSObserved=spDNSObserved, spRouter=spRouter, spFingerprintFeedback=spFingerprintFeedback, spDetector=spDetector, spInterfaceSpeedHC=spInterfaceSpeedHC, routingFailover=routingFailover, licenseErrorDone=licenseErrorDone, autoclassifyStart=autoclassifyStart, spFingerprintMessage=spFingerprintMessage, dnsBaseline=dnsBaseline, spBGPEvent=spBGPEvent, deviceTotalFlows=deviceTotalFlows, spDetectedCountries=spDetectedCountries, spInterfaceUsageHC=spInterfaceUsageHC, flowUp=flowUp, spInetAddressType=spInetAddressType, snmpDown=snmpDown, spLicenseErrLimit=spLicenseErrLimit, spUsername=spUsername, spHijackLocal=spHijackLocal, flowDown=flowDown, spServiceElement=spServiceElement, notificationLimit=notificationLimit, mitigationDone=mitigationDone, dosHostDetectionAlert=dosHostDetectionAlert, cloudSignalingFaultDone=cloudSignalingFaultDone, spGreTunnelDestination=spGreTunnelDestination, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceTotalFlowsHC=deviceTotalFlowsHC, devicePhysicalMemory=devicePhysicalMemory, spScriptCommand=spScriptCommand, spBlackholeCommunity=spBlackholeCommunity, managedObjectUsage=managedObjectUsage, spThirdPartyAddr=spThirdPartyAddr, spBlackholeNexthop=spBlackholeNexthop, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spSystemErrorDescription=spSystemErrorDescription, peakflowSPTraps=peakflowSPTraps, serviceUsageDone=serviceUsageDone, serviceUsage=serviceUsage, mitigationFlowspecStart=mitigationFlowspecStart, spVersion=spVersion, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceUsage=spInterfaceUsage, spServiceName=spServiceName, alertScript=alertScript, spCommFailureDestination=spCommFailureDestination, snmpUp=snmpUp, configChange=configChange, spBGPTrapName=spBGPTrapName, spInterfaceIndex=spInterfaceIndex, spMitigationName=spMitigationName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceHealth=deviceHealth, bgpInstability=bgpInstability, licenseError=licenseError, deviceSwapSpace=deviceSwapSpace, spFlowspecCommunity=spFlowspecCommunity)
