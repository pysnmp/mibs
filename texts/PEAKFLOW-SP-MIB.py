...
IpAddress, TimeTicks, Integer32, ModuleIdentity, ObjectIdentity, Gauge32, MibIdentifier, Counter32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Integer32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceUsageHC=spInterfaceUsageHC, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPEvent=spBGPEvent, spTMSPrefix=spTMSPrefix, spGreTunnelDestination=spGreTunnelDestination, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObject=spManagedObject, flowDown=flowDown, snmpDown=snmpDown, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationTMSStart=mitigationTMSStart, spPravail=spPravail, spHardwareFailureDescription=spHardwareFailureDescription, serviceUsageDone=serviceUsageDone, configChange=configChange, snmpUp=snmpUp, spcommFailureDone=spcommFailureDone, spMitigationName=spMitigationName, spCommFailureDescription=spCommFailureDescription, peakflowSPTraps=peakflowSPTraps, peakflowSPMIB=peakflowSPMIB, spApplicationName=spApplicationName, spImpactPps=spImpactPps, spLicenseErrType=spLicenseErrType, spServiceName=spServiceName, managedObjectUsageDone=managedObjectUsageDone, spDuration=spDuration, spMitigationID=spMitigationID, deviceHealth=deviceHealth, licenseError=licenseError, spRouter=spRouter, spDNSExpected=spDNSExpected, spFingerprintMessage=spFingerprintMessage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spUsageType=spUsageType, collectorStart=collectorStart, spSystemErrorType=spSystemErrorType, spInterfaceUsage=spInterfaceUsage, spAlertID=spAlertID, spBGPTrapName=spBGPTrapName, spBlackholeCommunity=spBlackholeCommunity, deviceSystemErrorDone=deviceSystemErrorDone, mitigationBlackholeStart=mitigationBlackholeStart, spInetAddress=spInetAddress, dnsBaseline=dnsBaseline, spThreshold=spThreshold, interfaceUsage=interfaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintName=spFingerprintName, spUsage=spUsage, spManagedObjects=spManagedObjects, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceDiskUsage=deviceDiskUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationTMSStartV2=mitigationTMSStartV2, fingerprintFeedback=fingerprintFeedback, spUsername=spUsername, reportDone=reportDone, PYSNMP_MODULE_ID=peakflowSPMIB, spLicenseErrDescription=spLicenseErrDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapEvent=spBGPTrapEvent, spCollector=spCollector, spMitigationStart=spMitigationStart, devicePhysicalMemory=devicePhysicalMemory, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spTMSTimeout=spTMSTimeout, spInterfaceIndex=spInterfaceIndex, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpInstabilityDone=bgpInstabilityDone, peakflowSPMgr=peakflowSPMgr, spDNSName=spDNSName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spHijackRoute=spHijackRoute, bgpUp=bgpUp, collectorDown=collectorDown, notificationLimit=notificationLimit, spLicenseErrCount=spLicenseErrCount, trafficAutoMitigation=trafficAutoMitigation, fingerprintUsage=fingerprintUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spDetector=spDetector, spScriptHost=spScriptHost, spScriptCommand=spScriptCommand, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiPrefix=spTMSMultiPrefix, dnsBaselineDone=dnsBaselineDone, fingerprintReceive=fingerprintReceive, greDownDone=greDownDone, alertScript=alertScript, spHijackLocal=spHijackLocal, dosHostDetectionAlertDone=dosHostDetectionAlertDone, licenseErrorDone=licenseErrorDone, spFlowspecCommunity=spFlowspecCommunity, spManagedObjectFamily=spManagedObjectFamily, bgpHijack=bgpHijack, spSystemErrorDescription=spSystemErrorDescription, spReportName=spReportName, routingFailover=routingFailover, spReportID=spReportID, spLicenseErrLimit=spLicenseErrLimit, deviceSystemError=deviceSystemError, spReportURL=spReportURL, spDNSObservedMean=spDNSObservedMean, spDetectedCountries=spDetectedCountries, spScriptPort=spScriptPort, managedObjectUsage=managedObjectUsage, spThirdPartyAddr=spThirdPartyAddr, spThirdPartyZone=spThirdPartyZone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spServiceElement=spServiceElement, cloudSignalingFaultDone=cloudSignalingFaultDone, spAlertDetectionSignatures=spAlertDetectionSignatures, hardwareFailure=hardwareFailure, peakflowSPCMI=peakflowSPCMI, spDNSObserved=spDNSObserved, deviceTotalFlows=deviceTotalFlows, greDown=greDown, spScriptStart=spScriptStart, mitigationFlowspecStart=mitigationFlowspecStart, cloudSignalingFault=cloudSignalingFault, spInterfaceSpeed=spInterfaceSpeed, bgpTrap=bgpTrap, interfaceUsageDone=interfaceUsageDone, spDNSObservedMax=spDNSObservedMax, spInterface=spInterface, serviceUsage=serviceUsage, fingerprintUsageDone=fingerprintUsageDone, spHijackAttr=spHijackAttr, spUnit=spUnit, spBlackholeTimeout=spBlackholeTimeout, spBGPInstability=spBGPInstability, spGreTunnelName=spGreTunnelName, deviceSwapSpace=deviceSwapSpace, bgpDown=bgpDown, spBlackholePrefix=spBlackholePrefix, dosHostDetectionAlert=dosHostDetectionAlert, spCommFailureDestination=spCommFailureDestination, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, collectorUp=collectorUp, spTMSCommunity=spTMSCommunity, bgpInstability=bgpInstability, flowUp=flowUp, spcommFailure=spcommFailure, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spImpactBps=spImpactBps, spVersion=spVersion, hardwareFailureDone=hardwareFailureDone, spInetAddressType=spInetAddressType, spBlackholeNexthop=spBlackholeNexthop, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFlowspecTimeout=spFlowspecTimeout, mitigationDone=mitigationDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintSender=spFingerprintSender, spFingerprintFeedback=spFingerprintFeedback)
