...
Integer32, Gauge32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, TimeTicks, IpAddress, MibIdentifier, iso, ObjectIdentity, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDescription=spCommFailureDescription, spHijackLocal=spHijackLocal, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spApplicationName=spApplicationName, spBlackholeNexthop=spBlackholeNexthop, spSystemErrorType=spSystemErrorType, bgpHijack=bgpHijack, spInterface=spInterface, deviceTotalFlows=deviceTotalFlows, spHijackAttr=spHijackAttr, spUsage=spUsage, managedObjectUsage=managedObjectUsage, spInetAddress=spInetAddress, spImpactPps=spImpactPps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spReportURL=spReportURL, spUnit=spUnit, spDNSObservedMean=spDNSObservedMean, spScriptStart=spScriptStart, spReportName=spReportName, interfaceUsageDone=interfaceUsageDone, spInterfaceUsageHC=spInterfaceUsageHC, collectorUp=collectorUp, spBGPTrapNewAttributes=spBGPTrapNewAttributes, licenseErrorDone=licenseErrorDone, hardwareFailureDone=hardwareFailureDone, snmpUp=snmpUp, spInterfaceSpeedHC=spInterfaceSpeedHC, fingerprintFeedback=fingerprintFeedback, greDown=greDown, routingFailover=routingFailover, spTMSCommunity=spTMSCommunity, spRouter=spRouter, spBGPInstability=spBGPInstability, managedObjectUsageDone=managedObjectUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSwapSpace=deviceSwapSpace, PYSNMP_MODULE_ID=peakflowSPMIB, cloudSignalingFault=cloudSignalingFault, spAlertDetectionSignatures=spAlertDetectionSignatures, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptCommand=spScriptCommand, dnsBaselineDone=dnsBaselineDone, spTMSPrefix=spTMSPrefix, bgpUp=bgpUp, spCollector=spCollector, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFlowspecCommunity=spFlowspecCommunity, spHijackRoute=spHijackRoute, spReportID=spReportID, hardwareFailure=hardwareFailure, spLicenseErrLimit=spLicenseErrLimit, deviceTotalFlowsHC=deviceTotalFlowsHC, spcommFailureDone=spcommFailureDone, spDNSName=spDNSName, mitigationTMSStartV2=mitigationTMSStartV2, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dnsBaseline=dnsBaseline, snmpDown=snmpDown, licenseError=licenseError, spScriptHost=spScriptHost, spCommFailureDestination=spCommFailureDestination, spInetAddressType=spInetAddressType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, fingerprintUsageDone=fingerprintUsageDone, spLicenseErrType=spLicenseErrType, collectorStart=collectorStart, spTMSTimeout=spTMSTimeout, spDNSObservedMax=spDNSObservedMax, mitigationDone=mitigationDone, spFingerprintFeedback=spFingerprintFeedback, spFingerprintName=spFingerprintName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, serviceUsage=serviceUsage, spInterfaceSpeed=spInterfaceSpeed, serviceUsageDone=serviceUsageDone, spFlowspecTimeout=spFlowspecTimeout, spDetector=spDetector, spVersion=spVersion, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, spServiceElement=spServiceElement, interfaceUsage=interfaceUsage, bgpInstability=bgpInstability, bgpInstabilityDone=bgpInstabilityDone, spGreTunnelDestination=spGreTunnelDestination, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPCMI=peakflowSPCMI, spBlackholePrefix=spBlackholePrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPMgr=peakflowSPMgr, flowUp=flowUp, spThreshold=spThreshold, spcommFailure=spcommFailure, cloudSignalingFaultDone=cloudSignalingFaultDone, fingerprintUsage=fingerprintUsage, collectorDown=collectorDown, alertScript=alertScript, spCloudSignalFaultDescription=spCloudSignalFaultDescription, notificationLimit=notificationLimit, reportDone=reportDone, flowDown=flowDown, spScriptPort=spScriptPort, spDuration=spDuration, deviceSystemError=deviceSystemError, spFingerprintSender=spFingerprintSender, spAlertID=spAlertID, spUsername=spUsername, bgpDown=bgpDown, spBGPTrapPrefix=spBGPTrapPrefix, spPravail=spPravail, spBGPEvent=spBGPEvent, spUsageType=spUsageType, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrDescription=spLicenseErrDescription, spManagedObjectFamily=spManagedObjectFamily, spManagedObjects=spManagedObjects, spManagedObject=spManagedObject, spFingerprintMessage=spFingerprintMessage, spThirdPartyAddr=spThirdPartyAddr, deviceDiskUsage=deviceDiskUsage, spGreTunnelName=spGreTunnelName, deviceHealth=deviceHealth, spMitigationID=spMitigationID, bgpTrap=bgpTrap, peakflowSPMIB=peakflowSPMIB, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemory=devicePhysicalMemory, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceUsage=spInterfaceUsage, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrCount=spLicenseErrCount, spBGPTrapName=spBGPTrapName, autoclassifyStart=autoclassifyStart, spDNSExpected=spDNSExpected, peakflowSPTraps=peakflowSPTraps, spMitigationStart=spMitigationStart, spMitigationName=spMitigationName, spSystemErrorDescription=spSystemErrorDescription, spBlackholeCommunity=spBlackholeCommunity, configChange=configChange, mitigationFlowspecStart=mitigationFlowspecStart, spBlackholeTimeout=spBlackholeTimeout, fingerprintReceive=fingerprintReceive, spDetectedCountries=spDetectedCountries, spInterfaceIndex=spInterfaceIndex, deviceSystemErrorDone=deviceSystemErrorDone, spHardwareFailureDescription=spHardwareFailureDescription, spImpactBps=spImpactBps, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDNSObserved=spDNSObserved, spServiceName=spServiceName, spThirdPartyZone=spThirdPartyZone, greDownDone=greDownDone, dosHostDetectionAlert=dosHostDetectionAlert, trafficAutoMitigation=trafficAutoMitigation, mitigationTMSStart=mitigationTMSStart)
