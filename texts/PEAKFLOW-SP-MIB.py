...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Gauge32, iso, Unsigned32, ObjectIdentity, IpAddress, Integer32, ModuleIdentity, Counter32, NotificationType, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Gauge32", "iso", "Unsigned32", "ObjectIdentity", "IpAddress", "Integer32", "ModuleIdentity", "Counter32", "NotificationType", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDNSObservedMean=spDNSObservedMean, spLicenseErrType=spLicenseErrType, mitigationBlackholeStart=mitigationBlackholeStart, spHardwareFailureDescription=spHardwareFailureDescription, spCommFailureDestination=spCommFailureDestination, cloudSignalingFault=cloudSignalingFault, peakflowSPTraps=peakflowSPTraps, spPravail=spPravail, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyAddr=spThirdPartyAddr, licenseError=licenseError, spBGPTrapPrefix=spBGPTrapPrefix, routingFailover=routingFailover, spHijackRoute=spHijackRoute, spAlertID=spAlertID, greDownDone=greDownDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spUnit=spUnit, deviceTotalFlowsHC=deviceTotalFlowsHC, fingerprintUsage=fingerprintUsage, PYSNMP_MODULE_ID=peakflowSPMIB, spFlowspecTimeout=spFlowspecTimeout, snmpDown=snmpDown, managedObjectUsage=managedObjectUsage, spBGPInstability=spBGPInstability, spBlackholePrefix=spBlackholePrefix, spHijackLocal=spHijackLocal, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spInterfaceUsage=spInterfaceUsage, spInterfaceUsageHC=spInterfaceUsageHC, autoclassifyStart=autoclassifyStart, spDNSName=spDNSName, deviceSystemError=deviceSystemError, spManagedObjects=spManagedObjects, spMitigationName=spMitigationName, collectorStart=collectorStart, bgpInstability=bgpInstability, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spThirdPartyZone=spThirdPartyZone, snmpUp=snmpUp, spInterfaceSpeed=spInterfaceSpeed, spMitigationStart=spMitigationStart, bgpDown=bgpDown, spInterfaceIndex=spInterfaceIndex, spUsername=spUsername, configChange=configChange, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spRouter=spRouter, greDown=greDown, spThreshold=spThreshold, spBlackholeNexthop=spBlackholeNexthop, collectorDown=collectorDown, serviceUsage=serviceUsage, spTMSTimeout=spTMSTimeout, spInetAddressType=spInetAddressType, dnsBaselineDone=dnsBaselineDone, peakflowSPMIB=peakflowSPMIB, spGreTunnelName=spGreTunnelName, licenseErrorDone=licenseErrorDone, spFingerprintFeedback=spFingerprintFeedback, mitigationTMSStart=mitigationTMSStart, spVersion=spVersion, spLicenseErrLimit=spLicenseErrLimit, fingerprintReceive=fingerprintReceive, mitigationThirdPartyStart=mitigationThirdPartyStart, dosHostDetectionAlert=dosHostDetectionAlert, cloudSignalingFaultDone=cloudSignalingFaultDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, flowDown=flowDown, notificationLimit=notificationLimit, spScriptStart=spScriptStart, spDuration=spDuration, spTMSMultiPrefix=spTMSMultiPrefix, fingerprintUsageDone=fingerprintUsageDone, spMitigationID=spMitigationID, spGreTunnelDestination=spGreTunnelDestination, bgpHijack=bgpHijack, spScriptHost=spScriptHost, spManagedObjectFamily=spManagedObjectFamily, spScriptCommand=spScriptCommand, spBGPEvent=spBGPEvent, spApplicationName=spApplicationName, spDetector=spDetector, spLicenseErrDescription=spLicenseErrDescription, spUsage=spUsage, spSystemErrorType=spSystemErrorType, spServiceElement=spServiceElement, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemory=devicePhysicalMemory, spImpactBps=spImpactBps, spFingerprintName=spFingerprintName, spTMSCommunity=spTMSCommunity, spImpactPps=spImpactPps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDNSExpected=spDNSExpected, trafficAutoMitigation=trafficAutoMitigation, spReportURL=spReportURL, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceHealth=deviceHealth, hardwareFailure=hardwareFailure, spFingerprintSender=spFingerprintSender, spManagedObject=spManagedObject, spCollector=spCollector, deviceSwapSpace=deviceSwapSpace, spServiceName=spServiceName, spDNSObserved=spDNSObserved, spReportName=spReportName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceTotalFlows=deviceTotalFlows, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowUp=flowUp, peakflowSPCMI=peakflowSPCMI, dnsBaseline=dnsBaseline, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceDiskUsage=deviceDiskUsage, bgpInstabilityDone=bgpInstabilityDone, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObservedMax=spDNSObservedMax, interfaceUsage=interfaceUsage, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInetAddress=spInetAddress, bgpUp=bgpUp, collectorUp=collectorUp, spScriptPort=spScriptPort, mitigationFlowspecStart=mitigationFlowspecStart, managedObjectUsageDone=managedObjectUsageDone, spInterface=spInterface, spUsageType=spUsageType, spReportID=spReportID, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, peakflowSPMgr=peakflowSPMgr, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFlowspecCommunity=spFlowspecCommunity, spcommFailureDone=spcommFailureDone, serviceUsageDone=serviceUsageDone, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBlackholeCommunity=spBlackholeCommunity, bgpTrap=bgpTrap, reportDone=reportDone, spCommFailureDescription=spCommFailureDescription, spAlertDetectionSignatures=spAlertDetectionSignatures, alertScript=alertScript, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapEvent=spBGPTrapEvent, hardwareFailureDone=hardwareFailureDone, spBGPTrapName=spBGPTrapName, spHijackAttr=spHijackAttr, spcommFailure=spcommFailure, mitigationDone=mitigationDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSPrefix=spTMSPrefix, spFingerprintMessage=spFingerprintMessage, spBlackholeTimeout=spBlackholeTimeout, spSystemErrorDescription=spSystemErrorDescription)
