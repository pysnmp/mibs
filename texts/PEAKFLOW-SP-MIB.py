...
TimeTicks, Gauge32, MibIdentifier, Counter64, Counter32, Bits, IpAddress, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "Bits", "IpAddress", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapPrefix=spBGPTrapPrefix, spScriptHost=spScriptHost, flowDown=flowDown, spFingerprintSender=spFingerprintSender, deviceSwapSpace=deviceSwapSpace, spFlowspecCommunity=spFlowspecCommunity, spDNSObserved=spDNSObserved, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spHardwareFailureDescription=spHardwareFailureDescription, spInetAddressType=spInetAddressType, serviceUsage=serviceUsage, bgpHijack=bgpHijack, licenseErrorDone=licenseErrorDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceDiskUsage=deviceDiskUsage, routingFailover=routingFailover, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spUsername=spUsername, spDetectedCountries=spDetectedCountries, snmpDown=snmpDown, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceUsage=spInterfaceUsage, serviceUsageDone=serviceUsageDone, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrCount=spLicenseErrCount, notificationLimit=notificationLimit, peakflowSPTraps=peakflowSPTraps, spGreTunnelDestination=spGreTunnelDestination, fingerprintUsage=fingerprintUsage, spReportID=spReportID, interfaceUsageDone=interfaceUsageDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spMitigationStart=spMitigationStart, spScriptPort=spScriptPort, spReportURL=spReportURL, spRouter=spRouter, licenseError=licenseError, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spVersion=spVersion, spUsage=spUsage, dnsBaseline=dnsBaseline, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPCMI=peakflowSPCMI, spFingerprintName=spFingerprintName, spInterfaceSpeed=spInterfaceSpeed, mitigationTMSStart=mitigationTMSStart, spInterfaceSpeedHC=spInterfaceSpeedHC, spThirdPartyZone=spThirdPartyZone, spBGPEvent=spBGPEvent, fingerprintUsageDone=fingerprintUsageDone, mitigationFlowspecStart=mitigationFlowspecStart, spTMSCommunity=spTMSCommunity, greDownDone=greDownDone, bgpDown=bgpDown, spDNSObservedMax=spDNSObservedMax, collectorDown=collectorDown, spGreTunnelName=spGreTunnelName, spReportName=spReportName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, flowUp=flowUp, cloudSignalingFault=cloudSignalingFault, spScriptCommand=spScriptCommand, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpInstability=bgpInstability, peakflowSPMgr=peakflowSPMgr, spImpactBps=spImpactBps, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spCommFailureDestination=spCommFailureDestination, spLicenseErrType=spLicenseErrType, reportDone=reportDone, spPravail=spPravail, spThreshold=spThreshold, spDetector=spDetector, spLicenseErrLimit=spLicenseErrLimit, spServiceName=spServiceName, spInterfaceIndex=spInterfaceIndex, cloudSignalingFaultDone=cloudSignalingFaultDone, spMitigationID=spMitigationID, hardwareFailure=hardwareFailure, spBGPInstability=spBGPInstability, dosHostDetectionAlert=dosHostDetectionAlert, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorType=spSystemErrorType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, managedObjectUsage=managedObjectUsage, autoclassifyStart=autoclassifyStart, deviceHealth=deviceHealth, spHijackAttr=spHijackAttr, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlows=deviceTotalFlows, fingerprintFeedback=fingerprintFeedback, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, spFlowspecTimeout=spFlowspecTimeout, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapEvent=spBGPTrapEvent, spAlertID=spAlertID, fingerprintReceive=fingerprintReceive, spApplicationName=spApplicationName, spBlackholeNexthop=spBlackholeNexthop, spManagedObject=spManagedObject, spBlackholePrefix=spBlackholePrefix, spcommFailureDone=spcommFailureDone, spThirdPartyAddr=spThirdPartyAddr, spBlackholeCommunity=spBlackholeCommunity, spInetAddress=spInetAddress, bgpTrap=bgpTrap, spAlertDetectionSignatures=spAlertDetectionSignatures, spServiceElement=spServiceElement, spTMSPrefix=spTMSPrefix, spTMSMultiPrefix=spTMSMultiPrefix, spManagedObjectFamily=spManagedObjectFamily, spDNSObservedMean=spDNSObservedMean, bgpInstabilityDone=bgpInstabilityDone, managedObjectUsageDone=managedObjectUsageDone, configChange=configChange, mitigationDone=mitigationDone, collectorUp=collectorUp, mitigationBlackholeStart=mitigationBlackholeStart, PYSNMP_MODULE_ID=peakflowSPMIB, hardwareFailureDone=hardwareFailureDone, spCommFailureDescription=spCommFailureDescription, spDuration=spDuration, spMitigationName=spMitigationName, spCollector=spCollector, dnsBaselineDone=dnsBaselineDone, interfaceUsage=interfaceUsage, spSystemErrorDescription=spSystemErrorDescription, spHijackRoute=spHijackRoute, spFingerprintMessage=spFingerprintMessage, spTMSTimeout=spTMSTimeout, spInterface=spInterface, spLicenseErrDescription=spLicenseErrDescription, alertScript=alertScript, spcommFailure=spcommFailure, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPMIB=peakflowSPMIB, spManagedObjects=spManagedObjects, spBGPTrapName=spBGPTrapName, spDNSName=spDNSName, greDown=greDown, mitigationTMSStartV2=mitigationTMSStartV2, spImpactPps=spImpactPps, spBlackholeTimeout=spBlackholeTimeout, snmpUp=snmpUp, spScriptStart=spScriptStart, spUnit=spUnit, deviceSystemError=deviceSystemError, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpUp=bgpUp, collectorStart=collectorStart, spHijackLocal=spHijackLocal, spDNSExpected=spDNSExpected)
