...
iso, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Bits, Unsigned32, NotificationType, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Bits", "Unsigned32", "NotificationType", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDuration=spDuration, managedObjectUsageDone=managedObjectUsageDone, spThirdPartyAddr=spThirdPartyAddr, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSwapSpace=deviceSwapSpace, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsername=spUsername, spApplicationName=spApplicationName, spInterfaceIndex=spInterfaceIndex, bgpDown=bgpDown, spScriptPort=spScriptPort, licenseErrorDone=licenseErrorDone, serviceUsageDone=serviceUsageDone, spFlowspecCommunity=spFlowspecCommunity, spBlackholeTimeout=spBlackholeTimeout, hardwareFailure=hardwareFailure, mitigationDone=mitigationDone, spBGPInstability=spBGPInstability, spLicenseErrType=spLicenseErrType, spBlackholePrefix=spBlackholePrefix, bgpTrap=bgpTrap, configChange=configChange, mitigationBlackholeStart=mitigationBlackholeStart, spMitigationName=spMitigationName, spImpactPps=spImpactPps, spHijackLocal=spHijackLocal, collectorUp=collectorUp, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapEvent=spBGPTrapEvent, spManagedObject=spManagedObject, spCommFailureDescription=spCommFailureDescription, spInetAddressType=spInetAddressType, spBGPTrapName=spBGPTrapName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationTMSStart=mitigationTMSStart, spInterface=spInterface, spDetector=spDetector, spTMSPrefix=spTMSPrefix, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObserved=spDNSObserved, greDownDone=greDownDone, collectorDown=collectorDown, licenseError=licenseError, spLicenseErrCount=spLicenseErrCount, spPravail=spPravail, spGreTunnelName=spGreTunnelName, devicePhysicalMemory=devicePhysicalMemory, spInterfaceSpeed=spInterfaceSpeed, spBlackholeNexthop=spBlackholeNexthop, deviceTotalFlows=deviceTotalFlows, spServiceName=spServiceName, greDown=greDown, mitigationFlowspecStart=mitigationFlowspecStart, interfaceUsageDone=interfaceUsageDone, spBGPEvent=spBGPEvent, deviceSystemError=deviceSystemError, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObservedMax=spDNSObservedMax, spcommFailureDone=spcommFailureDone, peakflowSPMgr=peakflowSPMgr, spUsageType=spUsageType, spFingerprintMessage=spFingerprintMessage, dosNetworkProfiledAlert=dosNetworkProfiledAlert, trafficAutoMitigation=trafficAutoMitigation, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spReportName=spReportName, spTMSCommunity=spTMSCommunity, spFingerprintName=spFingerprintName, dosHostDetectionAlert=dosHostDetectionAlert, spInterfaceUsage=spInterfaceUsage, serviceUsage=serviceUsage, cloudSignalingFault=cloudSignalingFault, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapPrefix=spBGPTrapPrefix, snmpDown=snmpDown, spFingerprintFeedback=spFingerprintFeedback, spFingerprintSender=spFingerprintSender, spMitigationStart=spMitigationStart, notificationLimit=notificationLimit, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spGreTunnelDestination=spGreTunnelDestination, fingerprintFeedback=fingerprintFeedback, spRouter=spRouter, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, managedObjectUsage=managedObjectUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spMitigationID=spMitigationID, spSystemErrorType=spSystemErrorType, peakflowSPTraps=peakflowSPTraps, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, PYSNMP_MODULE_ID=peakflowSPMIB, bgpHijack=bgpHijack, spUnit=spUnit, spImpactBps=spImpactBps, spManagedObjectFamily=spManagedObjectFamily, dnsBaseline=dnsBaseline, spThirdPartyZone=spThirdPartyZone, spInetAddress=spInetAddress, spSystemErrorDescription=spSystemErrorDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, flowDown=flowDown, spAlertID=spAlertID, peakflowSPCMI=peakflowSPCMI, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spScriptStart=spScriptStart, hardwareFailureDone=hardwareFailureDone, spReportURL=spReportURL, spDNSExpected=spDNSExpected, spHijackAttr=spHijackAttr, spScriptCommand=spScriptCommand, fingerprintUsageDone=fingerprintUsageDone, deviceSystemErrorDone=deviceSystemErrorDone, collectorStart=collectorStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, fingerprintUsage=fingerprintUsage, peakflowSPMIB=peakflowSPMIB, interfaceUsage=interfaceUsage, snmpUp=snmpUp, fingerprintReceive=fingerprintReceive, autoclassifyStart=autoclassifyStart, spVersion=spVersion, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrLimit=spLicenseErrLimit, spLicenseErrDescription=spLicenseErrDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spCommFailureDestination=spCommFailureDestination, deviceSwapSpaceInUse=deviceSwapSpaceInUse, cloudSignalingFaultDone=cloudSignalingFaultDone, bgpInstability=bgpInstability, spScriptHost=spScriptHost, deviceDiskUsage=deviceDiskUsage, spDetectedCountries=spDetectedCountries, flowUp=flowUp, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spHijackRoute=spHijackRoute, alertScript=alertScript, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, dnsBaselineDone=dnsBaselineDone, spDNSObservedMean=spDNSObservedMean, mitigationThirdPartyStart=mitigationThirdPartyStart, spHardwareFailureDescription=spHardwareFailureDescription, spManagedObjects=spManagedObjects, spReportID=spReportID, spUsage=spUsage, spTMSTimeout=spTMSTimeout, bgpInstabilityDone=bgpInstabilityDone, spInterfaceUsageHC=spInterfaceUsageHC, spFlowspecTimeout=spFlowspecTimeout, spCollector=spCollector, spServiceElement=spServiceElement, spBGPTrapNewAttributes=spBGPTrapNewAttributes, routingFailover=routingFailover, spDNSName=spDNSName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spThreshold=spThreshold, bgpUp=bgpUp, spcommFailure=spcommFailure, deviceHealth=deviceHealth, reportDone=reportDone, spBlackholeCommunity=spBlackholeCommunity)
