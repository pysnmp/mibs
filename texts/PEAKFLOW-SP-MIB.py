...
iso, Unsigned32, Integer32, IpAddress, TimeTicks, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, MibIdentifier, Counter32, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Integer32", "IpAddress", "TimeTicks", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "MibIdentifier", "Counter32", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrType=spLicenseErrType, spScriptHost=spScriptHost, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationFlowspecStart=mitigationFlowspecStart, spLicenseErrDescription=spLicenseErrDescription, spUnit=spUnit, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spMitigationName=spMitigationName, spBGPTrapEvent=spBGPTrapEvent, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpUp=bgpUp, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceTotalFlowsHC=deviceTotalFlowsHC, serviceUsageDone=serviceUsageDone, spThreshold=spThreshold, spInterfaceIndex=spInterfaceIndex, mitigationThirdPartyStart=mitigationThirdPartyStart, spVersion=spVersion, notificationLimit=notificationLimit, flowDown=flowDown, spScriptStart=spScriptStart, greDown=greDown, bgpTrap=bgpTrap, spUsage=spUsage, spDNSObservedMax=spDNSObservedMax, bgpHijack=bgpHijack, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptPort=spScriptPort, spFlowspecTimeout=spFlowspecTimeout, peakflowSPTraps=peakflowSPTraps, interfaceUsageDone=interfaceUsageDone, spBlackholeTimeout=spBlackholeTimeout, spSystemErrorType=spSystemErrorType, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSTimeout=spTMSTimeout, spUsername=spUsername, deviceSystemErrorDone=deviceSystemErrorDone, spApplicationName=spApplicationName, peakflowSPMgr=peakflowSPMgr, spReportName=spReportName, deviceTotalFlows=deviceTotalFlows, spManagedObject=spManagedObject, reportDone=reportDone, spReportURL=spReportURL, spTMSCommunity=spTMSCommunity, spTMSPrefix=spTMSPrefix, spMitigationStart=spMitigationStart, spHardwareFailureDescription=spHardwareFailureDescription, spDuration=spDuration, spBGPTrapNewAttributes=spBGPTrapNewAttributes, managedObjectUsage=managedObjectUsage, routingFailover=routingFailover, licenseErrorDone=licenseErrorDone, PYSNMP_MODULE_ID=peakflowSPMIB, spBlackholeCommunity=spBlackholeCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSName=spDNSName, dnsBaselineDone=dnsBaselineDone, spInterfaceUsage=spInterfaceUsage, spManagedObjects=spManagedObjects, spFingerprintSender=spFingerprintSender, mitigationTMSStartV2=mitigationTMSStartV2, spBGPEvent=spBGPEvent, deviceDiskUsage=deviceDiskUsage, dnsBaseline=dnsBaseline, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, hardwareFailureDone=hardwareFailureDone, spRouter=spRouter, spThirdPartyAddr=spThirdPartyAddr, interfaceUsage=interfaceUsage, spUsageType=spUsageType, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, serviceUsage=serviceUsage, spDNSObservedMean=spDNSObservedMean, licenseError=licenseError, dosNetworkProfiledAlert=dosNetworkProfiledAlert, bgpDown=bgpDown, collectorDown=collectorDown, mitigationBlackholeStart=mitigationBlackholeStart, spCommFailureDescription=spCommFailureDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrLimit=spLicenseErrLimit, deviceSwapSpace=deviceSwapSpace, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapName=spBGPTrapName, spHijackAttr=spHijackAttr, spManagedObjectFamily=spManagedObjectFamily, spFingerprintName=spFingerprintName, spBlackholePrefix=spBlackholePrefix, snmpUp=snmpUp, autoclassifyStart=autoclassifyStart, spInterface=spInterface, peakflowSPMIB=peakflowSPMIB, peakflowSPCMI=peakflowSPCMI, configChange=configChange, greDownDone=greDownDone, trafficAutoMitigation=trafficAutoMitigation, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFingerprintMessage=spFingerprintMessage, flowUp=flowUp, hardwareFailure=hardwareFailure, spScriptCommand=spScriptCommand, fingerprintReceive=fingerprintReceive, spBGPInstability=spBGPInstability, mitigationDone=mitigationDone, spBGPTrapPrefix=spBGPTrapPrefix, spHijackRoute=spHijackRoute, spFlowspecCommunity=spFlowspecCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInetAddress=spInetAddress, spImpactBps=spImpactBps, spThirdPartyZone=spThirdPartyZone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spGreTunnelName=spGreTunnelName, spDNSExpected=spDNSExpected, spImpactPps=spImpactPps, spBGPTrapOldAttributes=spBGPTrapOldAttributes, collectorStart=collectorStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spCommFailureDestination=spCommFailureDestination, spMitigationID=spMitigationID, spServiceElement=spServiceElement, collectorUp=collectorUp, cloudSignalingFault=cloudSignalingFault, spDetectedCountries=spDetectedCountries, spTMSMultiPrefix=spTMSMultiPrefix, spAlertID=spAlertID, spInterfaceUsageHC=spInterfaceUsageHC, bgpInstabilityDone=bgpInstabilityDone, spcommFailureDone=spcommFailureDone, spCollector=spCollector, spGreTunnelDestination=spGreTunnelDestination, deviceHealth=deviceHealth, dosHostDetectionAlert=dosHostDetectionAlert, alertScript=alertScript, deviceSystemError=deviceSystemError, spSystemErrorDescription=spSystemErrorDescription, spReportID=spReportID, spServiceName=spServiceName, snmpDown=snmpDown, spInetAddressType=spInetAddressType, spPravail=spPravail, spDetector=spDetector, spLicenseErrCount=spLicenseErrCount, fingerprintFeedback=fingerprintFeedback, spInterfaceSpeed=spInterfaceSpeed, managedObjectUsageDone=managedObjectUsageDone, spDNSObserved=spDNSObserved, spBlackholeNexthop=spBlackholeNexthop, bgpInstability=bgpInstability, mitigationTMSStart=mitigationTMSStart, spcommFailure=spcommFailure, spHijackLocal=spHijackLocal, cloudSignalingFaultDone=cloudSignalingFaultDone, devicePhysicalMemory=devicePhysicalMemory, fingerprintUsage=fingerprintUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, fingerprintUsageDone=fingerprintUsageDone)
