...
TimeTicks, Unsigned32, ObjectIdentity, Counter32, Bits, NotificationType, ModuleIdentity, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter32", "Bits", "NotificationType", "ModuleIdentity", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDNSObservedMax=spDNSObservedMax, peakflowSPCMI=peakflowSPCMI, spFlowspecCommunity=spFlowspecCommunity, snmpUp=snmpUp, spBlackholeNexthop=spBlackholeNexthop, dnsBaseline=dnsBaseline, spScriptPort=spScriptPort, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationThirdPartyStart=mitigationThirdPartyStart, greDown=greDown, spVersion=spVersion, collectorUp=collectorUp, spApplicationName=spApplicationName, bgpDown=bgpDown, spDNSObservedMean=spDNSObservedMean, spBlackholePrefix=spBlackholePrefix, spInterface=spInterface, mitigationTMSStartV2=mitigationTMSStartV2, collectorDown=collectorDown, spManagedObject=spManagedObject, fingerprintFeedback=fingerprintFeedback, spDetectedCountries=spDetectedCountries, serviceUsage=serviceUsage, spTMSCommunity=spTMSCommunity, spFingerprintFeedback=spFingerprintFeedback, routingFailover=routingFailover, hardwareFailure=hardwareFailure, spSystemErrorType=spSystemErrorType, bgpUp=bgpUp, spReportName=spReportName, spInterfaceUsageHC=spInterfaceUsageHC, spGreTunnelName=spGreTunnelName, deviceHealth=deviceHealth, fingerprintUsageDone=fingerprintUsageDone, serviceUsageDone=serviceUsageDone, spHardwareFailureDescription=spHardwareFailureDescription, spReportURL=spReportURL, spImpactPps=spImpactPps, spInterfaceUsage=spInterfaceUsage, spTMSMultiPrefix=spTMSMultiPrefix, spScriptCommand=spScriptCommand, trafficAutoMitigation=trafficAutoMitigation, cloudSignalingFault=cloudSignalingFault, spDNSName=spDNSName, spGreTunnelDestination=spGreTunnelDestination, collectorStart=collectorStart, spRouter=spRouter, spMitigationStart=spMitigationStart, spHijackLocal=spHijackLocal, spHijackAttr=spHijackAttr, spFingerprintMessage=spFingerprintMessage, dnsBaselineDone=dnsBaselineDone, mitigationDone=mitigationDone, fingerprintUsage=fingerprintUsage, peakflowSPTraps=peakflowSPTraps, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapName=spBGPTrapName, fingerprintReceive=fingerprintReceive, licenseErrorDone=licenseErrorDone, deviceTotalFlows=deviceTotalFlows, spTMSPrefix=spTMSPrefix, spDNSObserved=spDNSObserved, flowDown=flowDown, alertScript=alertScript, deviceSwapSpace=deviceSwapSpace, spMitigationID=spMitigationID, spCommFailureDescription=spCommFailureDescription, spInterfaceIndex=spInterfaceIndex, spBlackholeTimeout=spBlackholeTimeout, spInetAddress=spInetAddress, interfaceUsage=interfaceUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spPravail=spPravail, deviceSystemError=deviceSystemError, spLicenseErrDescription=spLicenseErrDescription, bgpInstability=bgpInstability, spInetAddressType=spInetAddressType, deviceDiskUsage=deviceDiskUsage, reportDone=reportDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUsage=spUsage, configChange=configChange, hardwareFailureDone=hardwareFailureDone, snmpDown=snmpDown, spAlertID=spAlertID, spLicenseErrLimit=spLicenseErrLimit, spInterfaceSpeedHC=spInterfaceSpeedHC, spUsername=spUsername, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPMgr=peakflowSPMgr, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spLicenseErrCount=spLicenseErrCount, licenseError=licenseError, spUsageType=spUsageType, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceTotalFlowsHC=deviceTotalFlowsHC, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spHijackRoute=spHijackRoute, spBGPTrapNewAttributes=spBGPTrapNewAttributes, mitigationFlowspecStart=mitigationFlowspecStart, spReportID=spReportID, spThreshold=spThreshold, spFingerprintSender=spFingerprintSender, bgpHijack=bgpHijack, spDNSExpected=spDNSExpected, spTMSTimeout=spTMSTimeout, spFlowspecTimeout=spFlowspecTimeout, spScriptHost=spScriptHost, spBGPTrapPrefix=spBGPTrapPrefix, spServiceElement=spServiceElement, devicePhysicalMemory=devicePhysicalMemory, flowUp=flowUp, spInterfaceSpeed=spInterfaceSpeed, spCollector=spCollector, spDetector=spDetector, spMitigationName=spMitigationName, spImpactBps=spImpactBps, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPMIB=peakflowSPMIB, spThirdPartyZone=spThirdPartyZone, dosHostDetectionAlert=dosHostDetectionAlert, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spThirdPartyAddr=spThirdPartyAddr, notificationLimit=notificationLimit, mitigationTMSStart=mitigationTMSStart, mitigationBlackholeStart=mitigationBlackholeStart, spManagedObjects=spManagedObjects, spUnit=spUnit, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spFingerprintName=spFingerprintName, bgpInstabilityDone=bgpInstabilityDone, spBGPTrapEvent=spBGPTrapEvent, autoclassifyStart=autoclassifyStart, spcommFailureDone=spcommFailureDone, spLicenseErrType=spLicenseErrType, spDuration=spDuration, spBGPEvent=spBGPEvent, managedObjectUsage=managedObjectUsage, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptStart=spScriptStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpTrap=bgpTrap, deviceSwapSpaceUsage=deviceSwapSpaceUsage, managedObjectUsageDone=managedObjectUsageDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spCommFailureDestination=spCommFailureDestination, spServiceName=spServiceName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spManagedObjectFamily=spManagedObjectFamily, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPInstability=spBGPInstability, spcommFailure=spcommFailure, greDownDone=greDownDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, interfaceUsageDone=interfaceUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures)
