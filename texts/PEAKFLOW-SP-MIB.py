...
NotificationType, TimeTicks, iso, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Gauge32, ObjectIdentity, MibIdentifier, Integer32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "iso", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThirdPartyAddr=spThirdPartyAddr, spDetectedCountries=spDetectedCountries, fingerprintUsage=fingerprintUsage, spHijackAttr=spHijackAttr, interfaceUsage=interfaceUsage, spUsage=spUsage, mitigationThirdPartyStart=mitigationThirdPartyStart, dosHostDetectionAlert=dosHostDetectionAlert, spApplicationName=spApplicationName, spMitigationID=spMitigationID, spReportID=spReportID, spUnit=spUnit, spHijackRoute=spHijackRoute, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSMultiPrefix=spTMSMultiPrefix, spServiceName=spServiceName, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPCMI=peakflowSPCMI, deviceTotalFlowsHC=deviceTotalFlowsHC, collectorDown=collectorDown, spFingerprintFeedback=spFingerprintFeedback, spManagedObject=spManagedObject, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationDone=mitigationDone, spServiceElement=spServiceElement, spInterface=spInterface, spVersion=spVersion, deviceSwapSpace=deviceSwapSpace, spInterfaceUsageHC=spInterfaceUsageHC, spLicenseErrLimit=spLicenseErrLimit, snmpDown=snmpDown, serviceUsageDone=serviceUsageDone, spHijackLocal=spHijackLocal, spInetAddressType=spInetAddressType, spDNSObserved=spDNSObserved, spCommFailureDescription=spCommFailureDescription, collectorUp=collectorUp, spGreTunnelDestination=spGreTunnelDestination, dnsBaselineDone=dnsBaselineDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapEvent=spBGPTrapEvent, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDetector=spDetector, spBGPTrapPrefix=spBGPTrapPrefix, spBlackholePrefix=spBlackholePrefix, spThirdPartyZone=spThirdPartyZone, spDNSObservedMax=spDNSObservedMax, mitigationTMSStart=mitigationTMSStart, spUsername=spUsername, spLicenseErrCount=spLicenseErrCount, notificationLimit=notificationLimit, spReportName=spReportName, spScriptPort=spScriptPort, spBGPTrapName=spBGPTrapName, flowDown=flowDown, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spRouter=spRouter, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, fingerprintReceive=fingerprintReceive, spFingerprintMessage=spFingerprintMessage, spDuration=spDuration, deviceTotalFlows=deviceTotalFlows, hardwareFailureDone=hardwareFailureDone, spSystemErrorType=spSystemErrorType, spTMSPrefix=spTMSPrefix, spFingerprintSender=spFingerprintSender, interfaceUsageDone=interfaceUsageDone, spThreshold=spThreshold, spImpactBps=spImpactBps, spCollector=spCollector, spBlackholeTimeout=spBlackholeTimeout, bgpUp=bgpUp, spTMSTimeout=spTMSTimeout, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBlackholeNexthop=spBlackholeNexthop, dnsBaseline=dnsBaseline, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPMIB=peakflowSPMIB, spMitigationName=spMitigationName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, fingerprintFeedback=fingerprintFeedback, PYSNMP_MODULE_ID=peakflowSPMIB, spFlowspecTimeout=spFlowspecTimeout, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spcommFailureDone=spcommFailureDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spcommFailure=spcommFailure, greDown=greDown, spScriptHost=spScriptHost, spScriptStart=spScriptStart, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrDescription=spLicenseErrDescription, licenseError=licenseError, spScriptCommand=spScriptCommand, reportDone=reportDone, snmpUp=snmpUp, spInetAddress=spInetAddress, cloudSignalingFaultDone=cloudSignalingFaultDone, collectorStart=collectorStart, autoclassifyStart=autoclassifyStart, spDNSObservedMean=spDNSObservedMean, spInterfaceUsage=spInterfaceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, managedObjectUsageDone=managedObjectUsageDone, spPravail=spPravail, peakflowSPTraps=peakflowSPTraps, spTMSCommunity=spTMSCommunity, spLicenseErrType=spLicenseErrType, managedObjectUsage=managedObjectUsage, spBGPInstability=spBGPInstability, spManagedObjectFamily=spManagedObjectFamily, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spDNSExpected=spDNSExpected, flowUp=flowUp, hardwareFailure=hardwareFailure, serviceUsage=serviceUsage, spInterfaceIndex=spInterfaceIndex, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spImpactPps=spImpactPps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceSpeed=spInterfaceSpeed, deviceSystemError=deviceSystemError, peakflowSPMgr=peakflowSPMgr, spUsageType=spUsageType, configChange=configChange, spFingerprintName=spFingerprintName, bgpDown=bgpDown, fingerprintUsageDone=fingerprintUsageDone, spReportURL=spReportURL, mitigationFlowspecStart=mitigationFlowspecStart, spMitigationStart=spMitigationStart, deviceHealth=deviceHealth, spAlertID=spAlertID, devicePhysicalMemory=devicePhysicalMemory, spBlackholeCommunity=spBlackholeCommunity, alertScript=alertScript, greDownDone=greDownDone, spCommFailureDestination=spCommFailureDestination, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPEvent=spBGPEvent, licenseErrorDone=licenseErrorDone, deviceDiskUsage=deviceDiskUsage, spHardwareFailureDescription=spHardwareFailureDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpInstability=bgpInstability, deviceSystemErrorDone=deviceSystemErrorDone, spManagedObjects=spManagedObjects, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDNSName=spDNSName, spSystemErrorDescription=spSystemErrorDescription, spFlowspecCommunity=spFlowspecCommunity, bgpTrap=bgpTrap, cloudSignalingFault=cloudSignalingFault, bgpInstabilityDone=bgpInstabilityDone, routingFailover=routingFailover, bgpHijack=bgpHijack, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage)
