...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceSpeed=spInterfaceSpeed, bgpTrap=bgpTrap, notificationLimit=notificationLimit, hardwareFailure=hardwareFailure, hardwareFailureDone=hardwareFailureDone, bgpInstability=bgpInstability, spTMSTimeout=spTMSTimeout, spScriptHost=spScriptHost, managedObjectUsage=managedObjectUsage, spManagedObjectFamily=spManagedObjectFamily, spDNSObservedMean=spDNSObservedMean, configChange=configChange, mitigationFlowspecStart=mitigationFlowspecStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spMitigationStart=spMitigationStart, spInetAddress=spInetAddress, spManagedObjects=spManagedObjects, spServiceElement=spServiceElement, cloudSignalingFaultDone=cloudSignalingFaultDone, spLicenseErrDescription=spLicenseErrDescription, spcommFailureDone=spcommFailureDone, licenseErrorDone=licenseErrorDone, fingerprintFeedback=fingerprintFeedback, spHijackAttr=spHijackAttr, spFingerprintFeedback=spFingerprintFeedback, alertScript=alertScript, spTMSMultiPrefix=spTMSMultiPrefix, dnsBaseline=dnsBaseline, spScriptStart=spScriptStart, spSystemErrorType=spSystemErrorType, spVersion=spVersion, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spManagedObject=spManagedObject, spBGPEvent=spBGPEvent, spLicenseErrType=spLicenseErrType, spDNSName=spDNSName, spUsageType=spUsageType, spBGPInstability=spBGPInstability, greDownDone=greDownDone, fingerprintUsage=fingerprintUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, spInetAddressType=spInetAddressType, spBGPTrapEvent=spBGPTrapEvent, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSCommunity=spTMSCommunity, spCommFailureDescription=spCommFailureDescription, spBGPTrapName=spBGPTrapName, spServiceName=spServiceName, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPTraps=peakflowSPTraps, spUsername=spUsername, spBlackholeCommunity=spBlackholeCommunity, spAlertID=spAlertID, spCommFailureDestination=spCommFailureDestination, spInterfaceSpeedHC=spInterfaceSpeedHC, spMitigationName=spMitigationName, spThreshold=spThreshold, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationTMSStartV2=mitigationTMSStartV2, serviceUsageDone=serviceUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintName=spFingerprintName, spReportID=spReportID, spGreTunnelDestination=spGreTunnelDestination, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spRouter=spRouter, spThirdPartyAddr=spThirdPartyAddr, spFingerprintMessage=spFingerprintMessage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, mitigationTMSStart=mitigationTMSStart, spDNSExpected=spDNSExpected, bgpInstabilityDone=bgpInstabilityDone, spDNSObserved=spDNSObserved, spFlowspecCommunity=spFlowspecCommunity, interfaceUsage=interfaceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, flowDown=flowDown, mitigationThirdPartyStart=mitigationThirdPartyStart, collectorStart=collectorStart, spcommFailure=spcommFailure, licenseError=licenseError, deviceSwapSpace=deviceSwapSpace, spImpactBps=spImpactBps, mitigationDone=mitigationDone, spBlackholeNexthop=spBlackholeNexthop, spLicenseErrLimit=spLicenseErrLimit, mitigationBlackholeStart=mitigationBlackholeStart, collectorUp=collectorUp, flowUp=flowUp, fingerprintUsageDone=fingerprintUsageDone, spUsage=spUsage, deviceSystemError=deviceSystemError, serviceUsage=serviceUsage, spCollector=spCollector, cloudSignalingFault=cloudSignalingFault, dnsBaselineDone=dnsBaselineDone, spInterface=spInterface, devicePhysicalMemory=devicePhysicalMemory, autoclassifyStart=autoclassifyStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spUnit=spUnit, spInterfaceUsage=spInterfaceUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintSender=spFingerprintSender, interfaceUsageDone=interfaceUsageDone, spPravail=spPravail, spDetector=spDetector, spMitigationID=spMitigationID, deviceDiskUsage=deviceDiskUsage, managedObjectUsageDone=managedObjectUsageDone, spScriptPort=spScriptPort, routingFailover=routingFailover, spTMSPrefix=spTMSPrefix, trafficAutoMitigation=trafficAutoMitigation, bgpDown=bgpDown, peakflowSPMgr=peakflowSPMgr, greDown=greDown, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spHijackRoute=spHijackRoute, spReportName=spReportName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInterfaceIndex=spInterfaceIndex, bgpHijack=bgpHijack, spBlackholePrefix=spBlackholePrefix, spHijackLocal=spHijackLocal, spSystemErrorDescription=spSystemErrorDescription, peakflowSPCMI=peakflowSPCMI, deviceHealth=deviceHealth, reportDone=reportDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dosHostDetectionAlert=dosHostDetectionAlert, spDuration=spDuration, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spApplicationName=spApplicationName, deviceTotalFlows=deviceTotalFlows, spBGPTrapPrefix=spBGPTrapPrefix, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintReceive=fingerprintReceive, spImpactPps=spImpactPps, spFlowspecTimeout=spFlowspecTimeout, snmpUp=snmpUp, snmpDown=snmpDown, spScriptCommand=spScriptCommand, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spDNSObservedMax=spDNSObservedMax, spDetectedCountries=spDetectedCountries, spThirdPartyZone=spThirdPartyZone, collectorDown=collectorDown, spReportURL=spReportURL, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPMIB=peakflowSPMIB, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpUp=bgpUp, spLicenseErrCount=spLicenseErrCount, spBlackholeTimeout=spBlackholeTimeout)
