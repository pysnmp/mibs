...
Unsigned32, IpAddress, NotificationType, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, TimeTicks, Counter64, iso, ObjectIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "NotificationType", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Counter64", "iso", "ObjectIdentity", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationFlowspecStart=mitigationFlowspecStart, bgpDown=bgpDown, spDuration=spDuration, dnsBaselineDone=dnsBaselineDone, spMitigationName=spMitigationName, mitigationBlackholeStart=mitigationBlackholeStart, spManagedObjects=spManagedObjects, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, collectorStart=collectorStart, spMitigationID=spMitigationID, spScriptCommand=spScriptCommand, fingerprintUsage=fingerprintUsage, peakflowSPMIB=peakflowSPMIB, spFingerprintFeedback=spFingerprintFeedback, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSystemError=deviceSystemError, spDNSName=spDNSName, spTMSCommunity=spTMSCommunity, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spScriptHost=spScriptHost, spInterfaceUsage=spInterfaceUsage, bgpInstabilityDone=bgpInstabilityDone, spDNSObservedMax=spDNSObservedMax, spBGPTrapNewAttributes=spBGPTrapNewAttributes, cloudSignalingFault=cloudSignalingFault, spHijackRoute=spHijackRoute, cloudSignalingFaultDone=cloudSignalingFaultDone, greDownDone=greDownDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholePrefix=spBlackholePrefix, spReportName=spReportName, spCommFailureDescription=spCommFailureDescription, spHijackLocal=spHijackLocal, spScriptStart=spScriptStart, licenseErrorDone=licenseErrorDone, deviceSystemErrorDone=deviceSystemErrorDone, spSystemErrorDescription=spSystemErrorDescription, spInterfaceUsageHC=spInterfaceUsageHC, spTMSMultiPrefix=spTMSMultiPrefix, spHardwareFailureDescription=spHardwareFailureDescription, managedObjectUsage=managedObjectUsage, spLicenseErrLimit=spLicenseErrLimit, peakflowSPMgr=peakflowSPMgr, spInetAddress=spInetAddress, spBlackholeTimeout=spBlackholeTimeout, alertScript=alertScript, spSystemErrorType=spSystemErrorType, spBGPTrapEvent=spBGPTrapEvent, autoclassifyStart=autoclassifyStart, spCommFailureDestination=spCommFailureDestination, spFlowspecTimeout=spFlowspecTimeout, spUsage=spUsage, spInetAddressType=spInetAddressType, spImpactPps=spImpactPps, mitigationTMSStart=mitigationTMSStart, spApplicationName=spApplicationName, spRouter=spRouter, spBGPTrapName=spBGPTrapName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, interfaceUsage=interfaceUsage, spBlackholeNexthop=spBlackholeNexthop, spReportID=spReportID, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, collectorDown=collectorDown, routingFailover=routingFailover, spBGPInstability=spBGPInstability, collectorUp=collectorUp, spDNSObservedMean=spDNSObservedMean, spBGPEvent=spBGPEvent, managedObjectUsageDone=managedObjectUsageDone, serviceUsageDone=serviceUsageDone, bgpUp=bgpUp, spGreTunnelDestination=spGreTunnelDestination, mitigationTMSStartV2=mitigationTMSStartV2, spLicenseErrDescription=spLicenseErrDescription, spDetectedCountries=spDetectedCountries, spFingerprintName=spFingerprintName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spUsageType=spUsageType, bgpHijack=bgpHijack, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemory=devicePhysicalMemory, spScriptPort=spScriptPort, dosNetworkProfiledAlert=dosNetworkProfiledAlert, snmpUp=snmpUp, spBlackholeCommunity=spBlackholeCommunity, licenseError=licenseError, spLicenseErrCount=spLicenseErrCount, peakflowSPCMI=peakflowSPCMI, mitigationDone=mitigationDone, spVersion=spVersion, spGreTunnelName=spGreTunnelName, bgpTrap=bgpTrap, dnsBaseline=dnsBaseline, greDown=greDown, spThirdPartyAddr=spThirdPartyAddr, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spUnit=spUnit, spLicenseErrType=spLicenseErrType, spManagedObjectFamily=spManagedObjectFamily, spManagedObject=spManagedObject, spInterfaceSpeedHC=spInterfaceSpeedHC, dosHostDetectionAlertDone=dosHostDetectionAlertDone, hardwareFailureDone=hardwareFailureDone, hardwareFailure=hardwareFailure, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spPravail=spPravail, deviceSwapSpace=deviceSwapSpace, spcommFailureDone=spcommFailureDone, deviceTotalFlows=deviceTotalFlows, spFingerprintSender=spFingerprintSender, fingerprintReceive=fingerprintReceive, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDetector=spDetector, spAlertID=spAlertID, spImpactBps=spImpactBps, spUsername=spUsername, bgpInstability=bgpInstability, spTMSTimeout=spTMSTimeout, spServiceElement=spServiceElement, deviceSwapSpaceUsage=deviceSwapSpaceUsage, notificationLimit=notificationLimit, spThreshold=spThreshold, deviceTotalFlowsHC=deviceTotalFlowsHC, fingerprintFeedback=fingerprintFeedback, spCollector=spCollector, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapPrefix=spBGPTrapPrefix, spFlowspecCommunity=spFlowspecCommunity, mitigationThirdPartyStart=mitigationThirdPartyStart, spInterfaceIndex=spInterfaceIndex, configChange=configChange, flowDown=flowDown, fingerprintUsageDone=fingerprintUsageDone, spDNSObserved=spDNSObserved, spThirdPartyZone=spThirdPartyZone, deviceDiskUsage=deviceDiskUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, interfaceUsageDone=interfaceUsageDone, serviceUsage=serviceUsage, snmpDown=snmpDown, spHijackAttr=spHijackAttr, spcommFailure=spcommFailure, spMitigationStart=spMitigationStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintMessage=spFingerprintMessage, trafficAutoMitigation=trafficAutoMitigation, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, flowUp=flowUp, spTMSPrefix=spTMSPrefix, spReportURL=spReportURL, peakflowSPTraps=peakflowSPTraps, spDNSExpected=spDNSExpected, spServiceName=spServiceName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spAlertDetectionSignatures=spAlertDetectionSignatures, reportDone=reportDone, deviceHealth=deviceHealth, spInterface=spInterface, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dosHostDetectionAlert=dosHostDetectionAlert)
