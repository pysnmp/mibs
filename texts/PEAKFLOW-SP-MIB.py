...
Integer32, Counter64, ModuleIdentity, iso, Gauge32, NotificationType, ObjectIdentity, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "iso", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spServiceName=spServiceName, spDetector=spDetector, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBlackholePrefix=spBlackholePrefix, spRouter=spRouter, reportDone=reportDone, spPravail=spPravail, mitigationThirdPartyStart=mitigationThirdPartyStart, serviceUsageDone=serviceUsageDone, spHijackAttr=spHijackAttr, spTMSTimeout=spTMSTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptHost=spScriptHost, spCommFailureDescription=spCommFailureDescription, bgpInstability=bgpInstability, bgpTrap=bgpTrap, spFingerprintName=spFingerprintName, spcommFailure=spcommFailure, spDNSExpected=spDNSExpected, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, greDown=greDown, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBlackholeNexthop=spBlackholeNexthop, spDNSName=spDNSName, managedObjectUsageDone=managedObjectUsageDone, spDNSObserved=spDNSObserved, spcommFailureDone=spcommFailureDone, spThreshold=spThreshold, spFingerprintSender=spFingerprintSender, alertScript=alertScript, spReportName=spReportName, collectorStart=collectorStart, spDetectedCountries=spDetectedCountries, mitigationTMSStartV2=mitigationTMSStartV2, spMitigationStart=spMitigationStart, spScriptCommand=spScriptCommand, spCollector=spCollector, mitigationFlowspecStart=mitigationFlowspecStart, notificationLimit=notificationLimit, fingerprintUsageDone=fingerprintUsageDone, cloudSignalingFault=cloudSignalingFault, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDNSObservedMean=spDNSObservedMean, peakflowSPMgr=peakflowSPMgr, spBlackholeCommunity=spBlackholeCommunity, snmpUp=snmpUp, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrType=spLicenseErrType, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapOldAttributes=spBGPTrapOldAttributes, flowUp=flowUp, spBGPTrapName=spBGPTrapName, dnsBaseline=dnsBaseline, spGreTunnelName=spGreTunnelName, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceSpeed=spInterfaceSpeed, spAlertID=spAlertID, flowDown=flowDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInetAddressType=spInetAddressType, spThirdPartyZone=spThirdPartyZone, deviceSwapSpace=deviceSwapSpace, hardwareFailure=hardwareFailure, autoclassifyStart=autoclassifyStart, peakflowSPTraps=peakflowSPTraps, spGreTunnelDestination=spGreTunnelDestination, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spImpactBps=spImpactBps, dosHostDetectionAlert=dosHostDetectionAlert, spThirdPartyAddr=spThirdPartyAddr, spReportID=spReportID, spInterfaceIndex=spInterfaceIndex, spBGPInstability=spBGPInstability, spUsageType=spUsageType, spTMSMultiPrefix=spTMSMultiPrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, devicePhysicalMemory=devicePhysicalMemory, deviceDiskUsage=deviceDiskUsage, fingerprintUsage=fingerprintUsage, routingFailover=routingFailover, spBlackholeTimeout=spBlackholeTimeout, spInterface=spInterface, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDuration=spDuration, spFlowspecCommunity=spFlowspecCommunity, spManagedObjects=spManagedObjects, spInetAddress=spInetAddress, interfaceUsageDone=interfaceUsageDone, hardwareFailureDone=hardwareFailureDone, deviceSystemError=deviceSystemError, spSystemErrorType=spSystemErrorType, mitigationTMSStart=mitigationTMSStart, spTMSPrefix=spTMSPrefix, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spLicenseErrDescription=spLicenseErrDescription, deviceHealth=deviceHealth, bgpInstabilityDone=bgpInstabilityDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintFeedback=spFingerprintFeedback, spHardwareFailureDescription=spHardwareFailureDescription, collectorDown=collectorDown, deviceTotalFlowsHC=deviceTotalFlowsHC, spCommFailureDestination=spCommFailureDestination, serviceUsage=serviceUsage, spFingerprintMessage=spFingerprintMessage, spScriptStart=spScriptStart, licenseError=licenseError, spBGPTrapPrefix=spBGPTrapPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, interfaceUsage=interfaceUsage, spSystemErrorDescription=spSystemErrorDescription, spInterfaceUsage=spInterfaceUsage, spServiceElement=spServiceElement, spReportURL=spReportURL, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spUsername=spUsername, spUsage=spUsage, spMitigationName=spMitigationName, bgpDown=bgpDown, bgpHijack=bgpHijack, peakflowSPCMI=peakflowSPCMI, dnsBaselineDone=dnsBaselineDone, mitigationDone=mitigationDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, licenseErrorDone=licenseErrorDone, collectorUp=collectorUp, managedObjectUsage=managedObjectUsage, spDNSObservedMax=spDNSObservedMax, spLicenseErrLimit=spLicenseErrLimit, configChange=configChange, spTMSCommunity=spTMSCommunity, spManagedObjectFamily=spManagedObjectFamily, spVersion=spVersion, spBGPTrapEvent=spBGPTrapEvent, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceTotalFlows=deviceTotalFlows, bgpUp=bgpUp, spImpactPps=spImpactPps, deviceSwapSpaceInUse=deviceSwapSpaceInUse, snmpDown=snmpDown, spHijackRoute=spHijackRoute, fingerprintFeedback=fingerprintFeedback, spScriptPort=spScriptPort, spInterfaceUsageHC=spInterfaceUsageHC, trafficAutoMitigation=trafficAutoMitigation, spApplicationName=spApplicationName, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPMIB=peakflowSPMIB, spUnit=spUnit, spBGPEvent=spBGPEvent, fingerprintReceive=fingerprintReceive, spMitigationID=spMitigationID, greDownDone=greDownDone, spLicenseErrCount=spLicenseErrCount, spManagedObject=spManagedObject, spHijackLocal=spHijackLocal)
