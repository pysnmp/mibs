...
NotificationType, Gauge32, MibIdentifier, Unsigned32, TimeTicks, Integer32, Counter32, Bits, Counter64, IpAddress, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "Unsigned32", "TimeTicks", "Integer32", "Counter32", "Bits", "Counter64", "IpAddress", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", collectorUp=collectorUp, spInterface=spInterface, spTMSPrefix=spTMSPrefix, spScriptPort=spScriptPort, peakflowSPMIB=peakflowSPMIB, spDetectedCountries=spDetectedCountries, spPravail=spPravail, spDetector=spDetector, mitigationDone=mitigationDone, spLicenseErrLimit=spLicenseErrLimit, fingerprintUsageDone=fingerprintUsageDone, spReportURL=spReportURL, bgpDown=bgpDown, spThirdPartyZone=spThirdPartyZone, spLicenseErrCount=spLicenseErrCount, deviceHealth=deviceHealth, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spHardwareFailureDescription=spHardwareFailureDescription, autoclassifyStart=autoclassifyStart, spcommFailureDone=spcommFailureDone, snmpDown=snmpDown, spBGPTrapEvent=spBGPTrapEvent, spInterfaceUsageHC=spInterfaceUsageHC, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spManagedObjectFamily=spManagedObjectFamily, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholeCommunity=spBlackholeCommunity, peakflowSPTraps=peakflowSPTraps, spInterfaceIndex=spInterfaceIndex, spHijackAttr=spHijackAttr, mitigationTMSStart=mitigationTMSStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpInstabilityDone=bgpInstabilityDone, managedObjectUsageDone=managedObjectUsageDone, spManagedObject=spManagedObject, spImpactBps=spImpactBps, spBGPInstability=spBGPInstability, fingerprintFeedback=fingerprintFeedback, serviceUsageDone=serviceUsageDone, spGreTunnelName=spGreTunnelName, spDNSObservedMax=spDNSObservedMax, spHijackRoute=spHijackRoute, spFingerprintMessage=spFingerprintMessage, collectorStart=collectorStart, spMitigationName=spMitigationName, spBGPTrapPrefix=spBGPTrapPrefix, spBlackholeTimeout=spBlackholeTimeout, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, fingerprintUsage=fingerprintUsage, spcommFailure=spcommFailure, deviceTotalFlows=deviceTotalFlows, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBlackholePrefix=spBlackholePrefix, spCommFailureDescription=spCommFailureDescription, spTMSCommunity=spTMSCommunity, licenseErrorDone=licenseErrorDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSName=spDNSName, spTMSMultiPrefix=spTMSMultiPrefix, spSystemErrorDescription=spSystemErrorDescription, spApplicationName=spApplicationName, spImpactPps=spImpactPps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObjects=spManagedObjects, spThirdPartyAddr=spThirdPartyAddr, spRouter=spRouter, deviceSwapSpaceInUse=deviceSwapSpaceInUse, alertScript=alertScript, serviceUsage=serviceUsage, spInterfaceSpeedHC=spInterfaceSpeedHC, dosHostDetectionAlert=dosHostDetectionAlert, mitigationThirdPartyStart=mitigationThirdPartyStart, spFingerprintSender=spFingerprintSender, spAlertDetectionSignatures=spAlertDetectionSignatures, hardwareFailureDone=hardwareFailureDone, spCommFailureDestination=spCommFailureDestination, spDNSObserved=spDNSObserved, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInetAddress=spInetAddress, flowUp=flowUp, spTMSTimeout=spTMSTimeout, spBGPEvent=spBGPEvent, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, spCollector=spCollector, spInterfaceUsage=spInterfaceUsage, bgpUp=bgpUp, spHijackLocal=spHijackLocal, fingerprintReceive=fingerprintReceive, spSystemErrorType=spSystemErrorType, spReportID=spReportID, spFingerprintName=spFingerprintName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dnsBaseline=dnsBaseline, PYSNMP_MODULE_ID=peakflowSPMIB, routingFailover=routingFailover, notificationLimit=notificationLimit, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInetAddressType=spInetAddressType, cloudSignalingFault=cloudSignalingFault, snmpUp=snmpUp, spLicenseErrType=spLicenseErrType, greDownDone=greDownDone, devicePhysicalMemory=devicePhysicalMemory, dnsBaselineDone=dnsBaselineDone, deviceSystemError=deviceSystemError, trafficAutoMitigation=trafficAutoMitigation, greDown=greDown, bgpHijack=bgpHijack, spUnit=spUnit, bgpInstability=bgpInstability, collectorDown=collectorDown, spFlowspecTimeout=spFlowspecTimeout, spDNSExpected=spDNSExpected, spGreTunnelDestination=spGreTunnelDestination, spServiceElement=spServiceElement, licenseError=licenseError, cloudSignalingFaultDone=cloudSignalingFaultDone, spFlowspecCommunity=spFlowspecCommunity, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationTMSStartV2=mitigationTMSStartV2, mitigationBlackholeStart=mitigationBlackholeStart, flowDown=flowDown, bgpTrap=bgpTrap, spAlertID=spAlertID, spThreshold=spThreshold, deviceSystemErrorDone=deviceSystemErrorDone, configChange=configChange, spDuration=spDuration, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBlackholeNexthop=spBlackholeNexthop, spBGPTrapName=spBGPTrapName, spMitigationStart=spMitigationStart, spMitigationID=spMitigationID, peakflowSPMgr=peakflowSPMgr, deviceSwapSpace=deviceSwapSpace, spUsage=spUsage, spInterfaceSpeed=spInterfaceSpeed, managedObjectUsage=managedObjectUsage, spDNSObservedMean=spDNSObservedMean, reportDone=reportDone, spScriptStart=spScriptStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPCMI=peakflowSPCMI, spServiceName=spServiceName, spScriptHost=spScriptHost, spLicenseErrDescription=spLicenseErrDescription, interfaceUsageDone=interfaceUsageDone, spReportName=spReportName, spVersion=spVersion, deviceDiskUsage=deviceDiskUsage, interfaceUsage=interfaceUsage, spUsername=spUsername, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, hardwareFailure=hardwareFailure, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, spScriptCommand=spScriptCommand, spBGPTrapNewAttributes=spBGPTrapNewAttributes)
