...
TimeTicks, IpAddress, Bits, NotificationType, iso, ObjectIdentity, Unsigned32, Integer32, Counter32, Counter64, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Bits", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "Integer32", "Counter32", "Counter64", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInetAddress=spInetAddress, spTMSMultiPrefix=spTMSMultiPrefix, managedObjectUsageDone=managedObjectUsageDone, spVersion=spVersion, spTMSCommunity=spTMSCommunity, spDNSName=spDNSName, spBGPInstability=spBGPInstability, spDNSObservedMean=spDNSObservedMean, spTMSTimeout=spTMSTimeout, spDuration=spDuration, spFingerprintMessage=spFingerprintMessage, deviceTotalFlows=deviceTotalFlows, greDownDone=greDownDone, bgpHijack=bgpHijack, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingFault=cloudSignalingFault, collectorStart=collectorStart, peakflowSPMIB=peakflowSPMIB, flowDown=flowDown, spDNSExpected=spDNSExpected, spBlackholeCommunity=spBlackholeCommunity, spImpactPps=spImpactPps, bgpInstability=bgpInstability, dnsBaseline=dnsBaseline, spCollector=spCollector, spApplicationName=spApplicationName, mitigationFlowspecStart=mitigationFlowspecStart, trafficAutoMitigation=trafficAutoMitigation, licenseError=licenseError, spPravail=spPravail, spInterfaceSpeed=spInterfaceSpeed, hardwareFailureDone=hardwareFailureDone, spBGPEvent=spBGPEvent, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholeTimeout=spBlackholeTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spGreTunnelName=spGreTunnelName, spServiceName=spServiceName, snmpUp=snmpUp, managedObjectUsage=managedObjectUsage, serviceUsageDone=serviceUsageDone, spUsage=spUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spReportName=spReportName, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceTotalFlowsHC=deviceTotalFlowsHC, reportDone=reportDone, spInetAddressType=spInetAddressType, mitigationBlackholeStart=mitigationBlackholeStart, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, spManagedObjectFamily=spManagedObjectFamily, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSObserved=spDNSObserved, spInterfaceUsageHC=spInterfaceUsageHC, spTMSPrefix=spTMSPrefix, routingFailover=routingFailover, deviceSwapSpace=deviceSwapSpace, spHijackRoute=spHijackRoute, spHijackAttr=spHijackAttr, mitigationTMSStartV2=mitigationTMSStartV2, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUsername=spUsername, fingerprintReceive=fingerprintReceive, spFingerprintSender=spFingerprintSender, PYSNMP_MODULE_ID=peakflowSPMIB, spRouter=spRouter, spDetector=spDetector, spcommFailure=spcommFailure, spInterfaceUsage=spInterfaceUsage, spLicenseErrDescription=spLicenseErrDescription, spDNSObservedMax=spDNSObservedMax, peakflowSPCMI=peakflowSPCMI, deviceDiskUsage=deviceDiskUsage, spcommFailureDone=spcommFailureDone, serviceUsage=serviceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrType=spLicenseErrType, bgpUp=bgpUp, spCommFailureDescription=spCommFailureDescription, notificationLimit=notificationLimit, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapPrefix=spBGPTrapPrefix, licenseErrorDone=licenseErrorDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, interfaceUsage=interfaceUsage, spFingerprintName=spFingerprintName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spLicenseErrLimit=spLicenseErrLimit, spFingerprintFeedback=spFingerprintFeedback, spDetectedCountries=spDetectedCountries, fingerprintUsage=fingerprintUsage, spSystemErrorType=spSystemErrorType, spManagedObject=spManagedObject, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spHijackLocal=spHijackLocal, spThirdPartyZone=spThirdPartyZone, bgpTrap=bgpTrap, spReportID=spReportID, mitigationDone=mitigationDone, spBGPTrapEvent=spBGPTrapEvent, spBlackholePrefix=spBlackholePrefix, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpDown=bgpDown, spThirdPartyAddr=spThirdPartyAddr, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInterfaceIndex=spInterfaceIndex, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, collectorUp=collectorUp, autoclassifyStart=autoclassifyStart, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapName=spBGPTrapName, spMitigationStart=spMitigationStart, peakflowSPMgr=peakflowSPMgr, mitigationThirdPartyStart=mitigationThirdPartyStart, spInterface=spInterface, spFlowspecTimeout=spFlowspecTimeout, greDown=greDown, deviceSystemError=deviceSystemError, deviceSystemErrorDone=deviceSystemErrorDone, spAlertID=spAlertID, snmpDown=snmpDown, spFlowspecCommunity=spFlowspecCommunity, peakflowSPTraps=peakflowSPTraps, spScriptStart=spScriptStart, spManagedObjects=spManagedObjects, spUnit=spUnit, spScriptHost=spScriptHost, collectorDown=collectorDown, spGreTunnelDestination=spGreTunnelDestination, spUsageType=spUsageType, configChange=configChange, spCommFailureDestination=spCommFailureDestination, spBlackholeNexthop=spBlackholeNexthop, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spMitigationName=spMitigationName, flowUp=flowUp, spServiceElement=spServiceElement, bgpInstabilityDone=bgpInstabilityDone, interfaceUsageDone=interfaceUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, fingerprintUsageDone=fingerprintUsageDone, spMitigationID=spMitigationID, dnsBaselineDone=dnsBaselineDone, deviceHealth=deviceHealth, mitigationTMSStart=mitigationTMSStart, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, alertScript=alertScript, spImpactBps=spImpactBps, spLicenseErrCount=spLicenseErrCount, spReportURL=spReportURL, spThreshold=spThreshold, spAlertDetectionSignatures=spAlertDetectionSignatures, dosHostDetectionAlert=dosHostDetectionAlert, spScriptCommand=spScriptCommand, spScriptPort=spScriptPort, spInterfaceSpeedHC=spInterfaceSpeedHC)
