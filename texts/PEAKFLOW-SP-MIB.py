...
iso, Counter64, MibIdentifier, Gauge32, IpAddress, Integer32, Bits, Counter32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "MibIdentifier", "Gauge32", "IpAddress", "Integer32", "Bits", "Counter32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThirdPartyZone=spThirdPartyZone, spReportName=spReportName, bgpTrap=bgpTrap, routingFailover=routingFailover, spBGPTrapName=spBGPTrapName, spLicenseErrType=spLicenseErrType, fingerprintUsage=fingerprintUsage, trafficAutoMitigation=trafficAutoMitigation, peakflowSPMgr=peakflowSPMgr, serviceUsageDone=serviceUsageDone, greDownDone=greDownDone, spReportURL=spReportURL, spCommFailureDestination=spCommFailureDestination, licenseError=licenseError, bgpHijack=bgpHijack, cloudSignalingFault=cloudSignalingFault, spMitigationStart=spMitigationStart, licenseErrorDone=licenseErrorDone, bgpInstability=bgpInstability, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spUsage=spUsage, mitigationFlowspecStart=mitigationFlowspecStart, spMitigationName=spMitigationName, spUsageType=spUsageType, dnsBaseline=dnsBaseline, spLicenseErrCount=spLicenseErrCount, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrLimit=spLicenseErrLimit, spFingerprintSender=spFingerprintSender, spServiceName=spServiceName, spDNSObserved=spDNSObserved, spDNSObservedMean=spDNSObservedMean, spScriptHost=spScriptHost, spInterfaceUsage=spInterfaceUsage, snmpDown=snmpDown, spManagedObjectFamily=spManagedObjectFamily, flowUp=flowUp, spDuration=spDuration, spGreTunnelName=spGreTunnelName, serviceUsage=serviceUsage, deviceSwapSpace=deviceSwapSpace, deviceHealth=deviceHealth, spUsername=spUsername, spDetector=spDetector, managedObjectUsageDone=managedObjectUsageDone, deviceSystemErrorDone=deviceSystemErrorDone, hardwareFailure=hardwareFailure, spTMSPrefix=spTMSPrefix, managedObjectUsage=managedObjectUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationBlackholeStart=mitigationBlackholeStart, spScriptStart=spScriptStart, spFlowspecTimeout=spFlowspecTimeout, deviceTotalFlowsHC=deviceTotalFlowsHC, dnsBaselineDone=dnsBaselineDone, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiPrefix=spTMSMultiPrefix, spHardwareFailureDescription=spHardwareFailureDescription, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceIndex=spInterfaceIndex, spInterfaceSpeed=spInterfaceSpeed, spBGPInstability=spBGPInstability, spAlertID=spAlertID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spPravail=spPravail, interfaceUsage=interfaceUsage, mitigationTMSStart=mitigationTMSStart, mitigationTMSStartV2=mitigationTMSStartV2, deviceTotalFlows=deviceTotalFlows, spFingerprintName=spFingerprintName, spInetAddressType=spInetAddressType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spRouter=spRouter, spInetAddress=spInetAddress, spGreTunnelDestination=spGreTunnelDestination, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPEvent=spBGPEvent, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceSystemError=deviceSystemError, spHijackLocal=spHijackLocal, spThreshold=spThreshold, spInterfaceUsageHC=spInterfaceUsageHC, spcommFailureDone=spcommFailureDone, spHijackAttr=spHijackAttr, dosNetworkProfiledAlert=dosNetworkProfiledAlert, collectorStart=collectorStart, hardwareFailureDone=hardwareFailureDone, spCollector=spCollector, spInterface=spInterface, spInterfaceSpeedHC=spInterfaceSpeedHC, interfaceUsageDone=interfaceUsageDone, spBlackholeTimeout=spBlackholeTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, flowDown=flowDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, fingerprintFeedback=fingerprintFeedback, alertScript=alertScript, spDNSObservedMax=spDNSObservedMax, greDown=greDown, spBGPTrapEvent=spBGPTrapEvent, peakflowSPTraps=peakflowSPTraps, peakflowSPCMI=peakflowSPCMI, autoclassifyStart=autoclassifyStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spTMSCommunity=spTMSCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDNSExpected=spDNSExpected, bgpDown=bgpDown, spThirdPartyAddr=spThirdPartyAddr, spVersion=spVersion, spBlackholeNexthop=spBlackholeNexthop, spBlackholePrefix=spBlackholePrefix, spCommFailureDescription=spCommFailureDescription, spManagedObjects=spManagedObjects, mitigationDone=mitigationDone, spMitigationID=spMitigationID, collectorUp=collectorUp, spManagedObject=spManagedObject, spImpactBps=spImpactBps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spFingerprintFeedback=spFingerprintFeedback, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSTimeout=spTMSTimeout, spFingerprintMessage=spFingerprintMessage, reportDone=reportDone, spScriptCommand=spScriptCommand, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spApplicationName=spApplicationName, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlert=dosHostDetectionAlert, fingerprintUsageDone=fingerprintUsageDone, spImpactPps=spImpactPps, cloudSignalingFaultDone=cloudSignalingFaultDone, spcommFailure=spcommFailure, spDNSName=spDNSName, spScriptPort=spScriptPort, spFlowspecCommunity=spFlowspecCommunity, fingerprintReceive=fingerprintReceive, deviceDiskUsage=deviceDiskUsage, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, configChange=configChange, spReportID=spReportID, devicePhysicalMemory=devicePhysicalMemory, spDetectedCountries=spDetectedCountries, spServiceElement=spServiceElement, spUnit=spUnit, spHijackRoute=spHijackRoute, peakflowSPMIB=peakflowSPMIB, spLicenseErrDescription=spLicenseErrDescription, collectorDown=collectorDown, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spSystemErrorType=spSystemErrorType, snmpUp=snmpUp, notificationLimit=notificationLimit, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpUp=bgpUp)
