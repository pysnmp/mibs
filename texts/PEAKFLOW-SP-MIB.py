...
Unsigned32, Integer32, ObjectIdentity, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Bits, Gauge32, IpAddress, Counter64, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Bits", "Gauge32", "IpAddress", "Counter64", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spScriptHost=spScriptHost, dosHostDetectionAlertDone=dosHostDetectionAlertDone, snmpUp=snmpUp, spInterfaceSpeed=spInterfaceSpeed, spTMSMultiPrefix=spTMSMultiPrefix, spPravail=spPravail, deviceHealth=deviceHealth, spDNSObservedMean=spDNSObservedMean, spInterfaceUsage=spInterfaceUsage, spCommFailureDescription=spCommFailureDescription, spCommFailureDestination=spCommFailureDestination, bgpInstabilityDone=bgpInstabilityDone, spScriptCommand=spScriptCommand, spHardwareFailureDescription=spHardwareFailureDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spMitigationName=spMitigationName, interfaceUsage=interfaceUsage, spBlackholePrefix=spBlackholePrefix, bgpInstability=bgpInstability, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPMIB=peakflowSPMIB, autoclassifyStart=autoclassifyStart, spUnit=spUnit, dnsBaseline=dnsBaseline, collectorUp=collectorUp, spTMSPrefix=spTMSPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spFingerprintName=spFingerprintName, bgpDown=bgpDown, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjects=spManagedObjects, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceUsageHC=spInterfaceUsageHC, spUsername=spUsername, spThirdPartyAddr=spThirdPartyAddr, spDNSObservedMax=spDNSObservedMax, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, peakflowSPMgr=peakflowSPMgr, spDNSName=spDNSName, configChange=configChange, spReportURL=spReportURL, interfaceUsageDone=interfaceUsageDone, notificationLimit=notificationLimit, managedObjectUsage=managedObjectUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spMitigationStart=spMitigationStart, collectorStart=collectorStart, spDNSObserved=spDNSObserved, fingerprintUsageDone=fingerprintUsageDone, trafficAutoMitigation=trafficAutoMitigation, fingerprintFeedback=fingerprintFeedback, bgpUp=bgpUp, hardwareFailure=hardwareFailure, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDNSExpected=spDNSExpected, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObject=spManagedObject, spScriptPort=spScriptPort, bgpTrap=bgpTrap, spBGPTrapEvent=spBGPTrapEvent, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapName=spBGPTrapName, spcommFailureDone=spcommFailureDone, spTMSCommunity=spTMSCommunity, spBlackholeNexthop=spBlackholeNexthop, greDownDone=greDownDone, spTMSTimeout=spTMSTimeout, routingFailover=routingFailover, spUsageType=spUsageType, deviceDiskUsage=deviceDiskUsage, spManagedObjectFamily=spManagedObjectFamily, flowUp=flowUp, spImpactPps=spImpactPps, spRouter=spRouter, deviceSwapSpace=deviceSwapSpace, spThirdPartyZone=spThirdPartyZone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPInstability=spBGPInstability, PYSNMP_MODULE_ID=peakflowSPMIB, spApplicationName=spApplicationName, spHijackRoute=spHijackRoute, serviceUsage=serviceUsage, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingFault=cloudSignalingFault, spScriptStart=spScriptStart, spReportID=spReportID, mitigationDone=mitigationDone, spFingerprintFeedback=spFingerprintFeedback, licenseError=licenseError, spDuration=spDuration, spHijackAttr=spHijackAttr, serviceUsageDone=serviceUsageDone, spGreTunnelName=spGreTunnelName, spLicenseErrType=spLicenseErrType, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrCount=spLicenseErrCount, snmpDown=snmpDown, spInetAddressType=spInetAddressType, spServiceName=spServiceName, licenseErrorDone=licenseErrorDone, spServiceElement=spServiceElement, flowDown=flowDown, fingerprintReceive=fingerprintReceive, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationThirdPartyStart=mitigationThirdPartyStart, mitigationBlackholeStart=mitigationBlackholeStart, spSystemErrorDescription=spSystemErrorDescription, bgpHijack=bgpHijack, spDetectedCountries=spDetectedCountries, deviceSystemErrorDone=deviceSystemErrorDone, spVersion=spVersion, spMitigationID=spMitigationID, spFlowspecCommunity=spFlowspecCommunity, spReportName=spReportName, mitigationTMSStart=mitigationTMSStart, spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPTraps=peakflowSPTraps, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spcommFailure=spcommFailure, spBGPTrapPrefix=spBGPTrapPrefix, spInterface=spInterface, hardwareFailureDone=hardwareFailureDone, spFingerprintSender=spFingerprintSender, deviceTotalFlows=deviceTotalFlows, spBlackholeTimeout=spBlackholeTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, greDown=greDown, collectorDown=collectorDown, alertScript=alertScript, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, fingerprintUsage=fingerprintUsage, spCollector=spCollector, spInterfaceIndex=spInterfaceIndex, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spHijackLocal=spHijackLocal, managedObjectUsageDone=managedObjectUsageDone, spSystemErrorType=spSystemErrorType, deviceSystemError=deviceSystemError, spBGPEvent=spBGPEvent, dnsBaselineDone=dnsBaselineDone, peakflowSPCMI=peakflowSPCMI, spInetAddress=spInetAddress, spBlackholeCommunity=spBlackholeCommunity, spAlertID=spAlertID, spDetector=spDetector, spFingerprintMessage=spFingerprintMessage, spImpactBps=spImpactBps, spUsage=spUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, reportDone=reportDone, mitigationFlowspecStart=mitigationFlowspecStart, spFlowspecTimeout=spFlowspecTimeout, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spThreshold=spThreshold, spLicenseErrLimit=spLicenseErrLimit, deviceSwapSpaceUsage=deviceSwapSpaceUsage)
