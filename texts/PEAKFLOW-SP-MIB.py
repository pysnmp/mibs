...
MibIdentifier, NotificationType, Integer32, ObjectIdentity, Counter64, Bits, Unsigned32, TimeTicks, Counter32, IpAddress, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrType=spLicenseErrType, spScriptCommand=spScriptCommand, spcommFailureDone=spcommFailureDone, managedObjectUsage=managedObjectUsage, spScriptPort=spScriptPort, spTMSPrefix=spTMSPrefix, spSystemErrorDescription=spSystemErrorDescription, peakflowSPTraps=peakflowSPTraps, spTMSTimeout=spTMSTimeout, spBlackholeNexthop=spBlackholeNexthop, spReportName=spReportName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBGPInstability=spBGPInstability, spThreshold=spThreshold, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPMgr=peakflowSPMgr, mitigationTMSStart=mitigationTMSStart, spDNSObservedMax=spDNSObservedMax, collectorDown=collectorDown, licenseErrorDone=licenseErrorDone, spDetector=spDetector, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, bgpInstability=bgpInstability, fingerprintFeedback=fingerprintFeedback, spManagedObjectFamily=spManagedObjectFamily, spInterface=spInterface, spAlertID=spAlertID, spDuration=spDuration, spManagedObject=spManagedObject, dnsBaselineDone=dnsBaselineDone, fingerprintUsage=fingerprintUsage, bgpHijack=bgpHijack, cloudSignalingFaultDone=cloudSignalingFaultDone, spDNSExpected=spDNSExpected, interfaceUsageDone=interfaceUsageDone, reportDone=reportDone, spLicenseErrDescription=spLicenseErrDescription, interfaceUsage=interfaceUsage, snmpDown=snmpDown, snmpUp=snmpUp, spHijackRoute=spHijackRoute, hardwareFailure=hardwareFailure, spThirdPartyZone=spThirdPartyZone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spSystemErrorType=spSystemErrorType, greDownDone=greDownDone, spcommFailure=spcommFailure, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spPravail=spPravail, mitigationThirdPartyStart=mitigationThirdPartyStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spMitigationID=spMitigationID, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationBlackholeStart=mitigationBlackholeStart, spFlowspecCommunity=spFlowspecCommunity, spInterfaceUsageHC=spInterfaceUsageHC, spUsage=spUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpTrap=bgpTrap, spRouter=spRouter, greDown=greDown, flowUp=flowUp, spFingerprintName=spFingerprintName, spUnit=spUnit, spTMSMultiPrefix=spTMSMultiPrefix, bgpInstabilityDone=bgpInstabilityDone, spInetAddress=spInetAddress, mitigationTMSStartV2=mitigationTMSStartV2, flowDown=flowDown, spBGPTrapPrefix=spBGPTrapPrefix, spImpactBps=spImpactBps, spCommFailureDestination=spCommFailureDestination, spDNSObservedMean=spDNSObservedMean, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPEvent=spBGPEvent, collectorStart=collectorStart, spBlackholeCommunity=spBlackholeCommunity, spMitigationStart=spMitigationStart, spTMSCommunity=spTMSCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, serviceUsageDone=serviceUsageDone, spHijackAttr=spHijackAttr, deviceSwapSpaceUsage=deviceSwapSpaceUsage, fingerprintUsageDone=fingerprintUsageDone, deviceTotalFlows=deviceTotalFlows, deviceDiskUsage=deviceDiskUsage, spDNSName=spDNSName, spManagedObjects=spManagedObjects, routingFailover=routingFailover, spCommFailureDescription=spCommFailureDescription, spInterfaceIndex=spInterfaceIndex, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBlackholeTimeout=spBlackholeTimeout, dosHostDetectionAlert=dosHostDetectionAlert, devicePhysicalMemory=devicePhysicalMemory, spUsageType=spUsageType, spReportURL=spReportURL, spHijackLocal=spHijackLocal, peakflowSPMIB=peakflowSPMIB, hardwareFailureDone=hardwareFailureDone, peakflowSPCMI=peakflowSPCMI, trafficAutoMitigation=trafficAutoMitigation, spFingerprintMessage=spFingerprintMessage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, notificationLimit=notificationLimit, serviceUsage=serviceUsage, deviceSystemError=deviceSystemError, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterfaceSpeed=spInterfaceSpeed, spBlackholePrefix=spBlackholePrefix, spCollector=spCollector, deviceSwapSpace=deviceSwapSpace, dnsBaseline=dnsBaseline, deviceSystemErrorDone=deviceSystemErrorDone, spFingerprintSender=spFingerprintSender, mitigationDone=mitigationDone, configChange=configChange, spDetectedCountries=spDetectedCountries, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInetAddressType=spInetAddressType, spImpactPps=spImpactPps, managedObjectUsageDone=managedObjectUsageDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpUp=bgpUp, spBGPTrapName=spBGPTrapName, bgpDown=bgpDown, spUsername=spUsername, spVersion=spVersion, spDNSObserved=spDNSObserved, spInterfaceUsage=spInterfaceUsage, cloudSignalingFault=cloudSignalingFault, spApplicationName=spApplicationName, spScriptStart=spScriptStart, PYSNMP_MODULE_ID=peakflowSPMIB, deviceSwapSpaceInUse=deviceSwapSpaceInUse, autoclassifyStart=autoclassifyStart, alertScript=alertScript, spFlowspecTimeout=spFlowspecTimeout, spReportID=spReportID, spFingerprintFeedback=spFingerprintFeedback, licenseError=licenseError, spBGPTrapEvent=spBGPTrapEvent, fingerprintReceive=fingerprintReceive, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrCount=spLicenseErrCount, spMitigationName=spMitigationName, spThirdPartyAddr=spThirdPartyAddr, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationFlowspecStart=mitigationFlowspecStart, deviceHealth=deviceHealth, spScriptHost=spScriptHost, spServiceName=spServiceName, spHardwareFailureDescription=spHardwareFailureDescription, spGreTunnelName=spGreTunnelName, collectorUp=collectorUp, spLicenseErrLimit=spLicenseErrLimit, spServiceElement=spServiceElement)
