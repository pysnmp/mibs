...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter32, iso, Unsigned32, Gauge32, Bits, NotificationType, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter32", "iso", "Unsigned32", "Gauge32", "Bits", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDescription=spCommFailureDescription, managedObjectUsageDone=managedObjectUsageDone, spDNSObserved=spDNSObserved, spUsername=spUsername, spAlertID=spAlertID, licenseError=licenseError, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpUp=bgpUp, spInterfaceUsageHC=spInterfaceUsageHC, spServiceElement=spServiceElement, bgpTrap=bgpTrap, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintUsage=fingerprintUsage, spInterfaceIndex=spInterfaceIndex, spPravail=spPravail, snmpDown=snmpDown, spUsageType=spUsageType, deviceTotalFlows=deviceTotalFlows, spSystemErrorType=spSystemErrorType, spFingerprintSender=spFingerprintSender, spVersion=spVersion, spBlackholeTimeout=spBlackholeTimeout, mitigationTMSStartV2=mitigationTMSStartV2, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, devicePhysicalMemory=devicePhysicalMemory, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintName=spFingerprintName, spCollector=spCollector, dnsBaseline=dnsBaseline, spInetAddress=spInetAddress, alertScript=alertScript, flowDown=flowDown, spServiceName=spServiceName, interfaceUsage=interfaceUsage, spThirdPartyAddr=spThirdPartyAddr, spHijackRoute=spHijackRoute, spHardwareFailureDescription=spHardwareFailureDescription, PYSNMP_MODULE_ID=peakflowSPMIB, spInterface=spInterface, peakflowSPMgr=peakflowSPMgr, spLicenseErrDescription=spLicenseErrDescription, notificationLimit=notificationLimit, greDown=greDown, deviceSystemError=deviceSystemError, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spImpactBps=spImpactBps, deviceSystemErrorDone=deviceSystemErrorDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapEvent=spBGPTrapEvent, collectorUp=collectorUp, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spManagedObject=spManagedObject, deviceTotalFlowsHC=deviceTotalFlowsHC, serviceUsage=serviceUsage, spScriptPort=spScriptPort, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationTMSStart=mitigationTMSStart, managedObjectUsage=managedObjectUsage, spUsage=spUsage, spBGPTrapName=spBGPTrapName, cloudSignalingFault=cloudSignalingFault, spLicenseErrLimit=spLicenseErrLimit, routingFailover=routingFailover, spcommFailure=spcommFailure, spScriptCommand=spScriptCommand, dosHostDetectionAlert=dosHostDetectionAlert, hardwareFailure=hardwareFailure, spSystemErrorDescription=spSystemErrorDescription, spTMSPrefix=spTMSPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, spReportID=spReportID, spThreshold=spThreshold, bgpInstabilityDone=bgpInstabilityDone, spScriptStart=spScriptStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSObservedMax=spDNSObservedMax, peakflowSPMIB=peakflowSPMIB, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPTrapPrefix=spBGPTrapPrefix, spDNSExpected=spDNSExpected, peakflowSPCMI=peakflowSPCMI, spDNSObservedMean=spDNSObservedMean, deviceDiskUsage=deviceDiskUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spInetAddressType=spInetAddressType, spFingerprintMessage=spFingerprintMessage, hardwareFailureDone=hardwareFailureDone, mitigationDone=mitigationDone, spFingerprintFeedback=spFingerprintFeedback, deviceSwapSpace=deviceSwapSpace, autoclassifyStart=autoclassifyStart, spInterfaceUsage=spInterfaceUsage, snmpUp=snmpUp, peakflowSPTraps=peakflowSPTraps, spBlackholePrefix=spBlackholePrefix, deviceHealth=deviceHealth, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spImpactPps=spImpactPps, spReportName=spReportName, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSwapSpaceInUse=deviceSwapSpaceInUse, bgpInstability=bgpInstability, spBlackholeCommunity=spBlackholeCommunity, spScriptHost=spScriptHost, fingerprintFeedback=fingerprintFeedback, spDuration=spDuration, configChange=configChange, spReportURL=spReportURL, spFlowspecTimeout=spFlowspecTimeout, mitigationFlowspecStart=mitigationFlowspecStart, spTMSMultiPrefix=spTMSMultiPrefix, fingerprintUsageDone=fingerprintUsageDone, flowUp=flowUp, spInterfaceSpeed=spInterfaceSpeed, spUnit=spUnit, spMitigationStart=spMitigationStart, spDetectedCountries=spDetectedCountries, spFlowspecCommunity=spFlowspecCommunity, spManagedObjectFamily=spManagedObjectFamily, interfaceUsageDone=interfaceUsageDone, reportDone=reportDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spLicenseErrType=spLicenseErrType, spGreTunnelName=spGreTunnelName, greDownDone=greDownDone, spBGPEvent=spBGPEvent, serviceUsageDone=serviceUsageDone, spMitigationID=spMitigationID, spHijackAttr=spHijackAttr, spCommFailureDestination=spCommFailureDestination, spBlackholeNexthop=spBlackholeNexthop, spLicenseErrCount=spLicenseErrCount, spRouter=spRouter, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSTimeout=spTMSTimeout, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationBlackholeStart=mitigationBlackholeStart, collectorStart=collectorStart, spApplicationName=spApplicationName, trafficAutoMitigation=trafficAutoMitigation, bgpDown=bgpDown, spDetector=spDetector, licenseErrorDone=licenseErrorDone, spBGPInstability=spBGPInstability, dnsBaselineDone=dnsBaselineDone, bgpHijack=bgpHijack, spHijackLocal=spHijackLocal, spDNSName=spDNSName, spcommFailureDone=spcommFailureDone, spGreTunnelDestination=spGreTunnelDestination, collectorDown=collectorDown, fingerprintReceive=fingerprintReceive, spManagedObjects=spManagedObjects, spMitigationName=spMitigationName, spThirdPartyZone=spThirdPartyZone, spTMSCommunity=spTMSCommunity)
