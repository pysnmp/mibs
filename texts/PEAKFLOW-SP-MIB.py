...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, NotificationType, IpAddress, Gauge32, iso, TimeTicks, Counter64, Bits, MibIdentifier, ObjectIdentity, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "Gauge32", "iso", "TimeTicks", "Counter64", "Bits", "MibIdentifier", "ObjectIdentity", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, alertScript=alertScript, spHijackAttr=spHijackAttr, deviceTotalFlows=deviceTotalFlows, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSName=spDNSName, PYSNMP_MODULE_ID=peakflowSPMIB, spFlowspecCommunity=spFlowspecCommunity, spCommFailureDescription=spCommFailureDescription, autoclassifyStart=autoclassifyStart, bgpInstability=bgpInstability, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpTrap=bgpTrap, spDNSObserved=spDNSObserved, spBGPTrapPrefix=spBGPTrapPrefix, spHardwareFailureDescription=spHardwareFailureDescription, collectorUp=collectorUp, spSystemErrorType=spSystemErrorType, spTMSCommunity=spTMSCommunity, spDNSExpected=spDNSExpected, trafficAutoMitigation=trafficAutoMitigation, spFingerprintName=spFingerprintName, fingerprintReceive=fingerprintReceive, spMitigationStart=spMitigationStart, spLicenseErrCount=spLicenseErrCount, flowUp=flowUp, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, bgpDown=bgpDown, licenseError=licenseError, spFlowspecTimeout=spFlowspecTimeout, spGreTunnelDestination=spGreTunnelDestination, spThirdPartyAddr=spThirdPartyAddr, devicePhysicalMemory=devicePhysicalMemory, peakflowSPMIB=peakflowSPMIB, peakflowSPCMI=peakflowSPCMI, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapOldAttributes=spBGPTrapOldAttributes, collectorDown=collectorDown, peakflowSPMgr=peakflowSPMgr, spCollector=spCollector, spTMSMultiPrefix=spTMSMultiPrefix, interfaceUsage=interfaceUsage, spLicenseErrLimit=spLicenseErrLimit, serviceUsage=serviceUsage, deviceSystemError=deviceSystemError, spManagedObjects=spManagedObjects, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, interfaceUsageDone=interfaceUsageDone, spBGPEvent=spBGPEvent, serviceUsageDone=serviceUsageDone, spScriptHost=spScriptHost, peakflowSPTraps=peakflowSPTraps, spInterfaceIndex=spInterfaceIndex, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spFingerprintSender=spFingerprintSender, spcommFailureDone=spcommFailureDone, managedObjectUsage=managedObjectUsage, spScriptPort=spScriptPort, spUsage=spUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSystemErrorDone=deviceSystemErrorDone, snmpDown=snmpDown, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapNewAttributes=spBGPTrapNewAttributes, fingerprintUsageDone=fingerprintUsageDone, spReportName=spReportName, greDown=greDown, spManagedObject=spManagedObject, spTMSPrefix=spTMSPrefix, fingerprintUsage=fingerprintUsage, spReportID=spReportID, spInetAddress=spInetAddress, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spMitigationName=spMitigationName, spReportURL=spReportURL, spBlackholeCommunity=spBlackholeCommunity, spDNSObservedMean=spDNSObservedMean, spAlertID=spAlertID, spFingerprintFeedback=spFingerprintFeedback, mitigationTMSStart=mitigationTMSStart, hardwareFailure=hardwareFailure, deviceTotalFlowsHC=deviceTotalFlowsHC, dnsBaselineDone=dnsBaselineDone, spDuration=spDuration, hardwareFailureDone=hardwareFailureDone, reportDone=reportDone, mitigationDone=mitigationDone, spBlackholePrefix=spBlackholePrefix, notificationLimit=notificationLimit, spCommFailureDestination=spCommFailureDestination, spInterface=spInterface, dnsBaseline=dnsBaseline, spDNSObservedMax=spDNSObservedMax, spDetectedCountries=spDetectedCountries, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spSystemErrorDescription=spSystemErrorDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, bgpHijack=bgpHijack, spBGPTrapName=spBGPTrapName, spBlackholeTimeout=spBlackholeTimeout, spManagedObjectFamily=spManagedObjectFamily, spThreshold=spThreshold, spServiceElement=spServiceElement, deviceHealth=deviceHealth, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDetector=spDetector, spUsageType=spUsageType, configChange=configChange, spInterfaceUsageHC=spInterfaceUsageHC, cloudSignalingFault=cloudSignalingFault, deviceSwapSpace=deviceSwapSpace, deviceDiskUsage=deviceDiskUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spApplicationName=spApplicationName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, snmpUp=snmpUp, bgpInstabilityDone=bgpInstabilityDone, spPravail=spPravail, spBlackholeNexthop=spBlackholeNexthop, spScriptStart=spScriptStart, spLicenseErrType=spLicenseErrType, spTMSTimeout=spTMSTimeout, bgpUp=bgpUp, spRouter=spRouter, spInterfaceSpeedHC=spInterfaceSpeedHC, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spImpactBps=spImpactBps, spInterfaceSpeed=spInterfaceSpeed, spFingerprintMessage=spFingerprintMessage, spHijackRoute=spHijackRoute, spBGPInstability=spBGPInstability, spVersion=spVersion, spServiceName=spServiceName, spMitigationID=spMitigationID, flowDown=flowDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInetAddressType=spInetAddressType, licenseErrorDone=licenseErrorDone, spInterfaceUsage=spInterfaceUsage, spScriptCommand=spScriptCommand, spUnit=spUnit, fingerprintFeedback=fingerprintFeedback, mitigationFlowspecStart=mitigationFlowspecStart, spThirdPartyZone=spThirdPartyZone, mitigationBlackholeStart=mitigationBlackholeStart, spHijackLocal=spHijackLocal, mitigationTMSStartV2=mitigationTMSStartV2, spUsername=spUsername, spcommFailure=spcommFailure, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spLicenseErrDescription=spLicenseErrDescription, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spImpactPps=spImpactPps, greDownDone=greDownDone, collectorStart=collectorStart, managedObjectUsageDone=managedObjectUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures, routingFailover=routingFailover)
