...
TimeTicks, Gauge32, MibIdentifier, IpAddress, ObjectIdentity, Counter32, iso, Integer32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress", "ObjectIdentity", "Counter32", "iso", "Integer32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spcommFailureDone=spcommFailureDone, spScriptCommand=spScriptCommand, spTMSPrefix=spTMSPrefix, snmpDown=snmpDown, notificationLimit=notificationLimit, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, alertScript=alertScript, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spUsageType=spUsageType, deviceTotalFlows=deviceTotalFlows, spInterfaceUsage=spInterfaceUsage, greDownDone=greDownDone, spScriptPort=spScriptPort, spDNSObservedMax=spDNSObservedMax, licenseErrorDone=licenseErrorDone, spThirdPartyZone=spThirdPartyZone, dnsBaseline=dnsBaseline, mitigationTMSStartV2=mitigationTMSStartV2, spMitigationStart=spMitigationStart, spSystemErrorType=spSystemErrorType, spHijackRoute=spHijackRoute, serviceUsageDone=serviceUsageDone, snmpUp=snmpUp, spAlertID=spAlertID, spCollector=spCollector, spServiceName=spServiceName, fingerprintUsage=fingerprintUsage, spDetector=spDetector, deviceSystemError=deviceSystemError, spApplicationName=spApplicationName, interfaceUsage=interfaceUsage, spSystemErrorDescription=spSystemErrorDescription, serviceUsage=serviceUsage, spRouter=spRouter, spServiceElement=spServiceElement, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrDescription=spLicenseErrDescription, peakflowSPMgr=peakflowSPMgr, configChange=configChange, autoclassifyStart=autoclassifyStart, spFingerprintMessage=spFingerprintMessage, spFingerprintName=spFingerprintName, spHijackLocal=spHijackLocal, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, collectorUp=collectorUp, dnsBaselineDone=dnsBaselineDone, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapPrefix=spBGPTrapPrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPTrapName=spBGPTrapName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spThreshold=spThreshold, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelName=spGreTunnelName, spManagedObject=spManagedObject, bgpInstabilityDone=bgpInstabilityDone, spLicenseErrCount=spLicenseErrCount, reportDone=reportDone, spImpactPps=spImpactPps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUnit=spUnit, deviceDiskUsage=deviceDiskUsage, spInterfaceSpeed=spInterfaceSpeed, flowUp=flowUp, interfaceUsageDone=interfaceUsageDone, routingFailover=routingFailover, dosHostDetectionAlert=dosHostDetectionAlert, trafficAutoMitigation=trafficAutoMitigation, spTMSMultiPrefix=spTMSMultiPrefix, bgpInstability=bgpInstability, hardwareFailure=hardwareFailure, spReportURL=spReportURL, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spHijackAttr=spHijackAttr, spUsage=spUsage, spInterfaceSpeedHC=spInterfaceSpeedHC, spBlackholeTimeout=spBlackholeTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDetectedCountries=spDetectedCountries, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, managedObjectUsageDone=managedObjectUsageDone, peakflowSPMIB=peakflowSPMIB, spcommFailure=spcommFailure, spBlackholePrefix=spBlackholePrefix, spInetAddressType=spInetAddressType, spLicenseErrType=spLicenseErrType, devicePhysicalMemory=devicePhysicalMemory, fingerprintFeedback=fingerprintFeedback, mitigationTMSStart=mitigationTMSStart, spInterfaceIndex=spInterfaceIndex, bgpDown=bgpDown, hardwareFailureDone=hardwareFailureDone, cloudSignalingFault=cloudSignalingFault, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spLicenseErrLimit=spLicenseErrLimit, deviceHealth=deviceHealth, spMitigationName=spMitigationName, collectorDown=collectorDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPEvent=spBGPEvent, spFlowspecTimeout=spFlowspecTimeout, flowDown=flowDown, spCloudSignalFaultDescription=spCloudSignalFaultDescription, peakflowSPTraps=peakflowSPTraps, spScriptStart=spScriptStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholeCommunity=spBlackholeCommunity, spManagedObjects=spManagedObjects, spCommFailureDestination=spCommFailureDestination, spDNSExpected=spDNSExpected, bgpUp=bgpUp, spReportName=spReportName, bgpHijack=bgpHijack, managedObjectUsage=managedObjectUsage, deviceSwapSpace=deviceSwapSpace, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpTrap=bgpTrap, spDNSObserved=spDNSObserved, spFingerprintFeedback=spFingerprintFeedback, spFlowspecCommunity=spFlowspecCommunity, spFingerprintSender=spFingerprintSender, greDown=greDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, mitigationDone=mitigationDone, spGreTunnelDestination=spGreTunnelDestination, spInterface=spInterface, spHardwareFailureDescription=spHardwareFailureDescription, spManagedObjectFamily=spManagedObjectFamily, PYSNMP_MODULE_ID=peakflowSPMIB, spReportID=spReportID, spInterfaceUsageHC=spInterfaceUsageHC, spScriptHost=spScriptHost, licenseError=licenseError, spDNSObservedMean=spDNSObservedMean, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spVersion=spVersion, spDNSName=spDNSName, spDuration=spDuration, fingerprintReceive=fingerprintReceive, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsername=spUsername, spInetAddress=spInetAddress, spBlackholeNexthop=spBlackholeNexthop, spTMSCommunity=spTMSCommunity, spBGPTrapNewAttributes=spBGPTrapNewAttributes, peakflowSPCMI=peakflowSPCMI, spImpactBps=spImpactBps, mitigationFlowspecStart=mitigationFlowspecStart, deviceTotalFlowsHC=deviceTotalFlowsHC, collectorStart=collectorStart, spBGPInstability=spBGPInstability, spPravail=spPravail, spTMSTimeout=spTMSTimeout, fingerprintUsageDone=fingerprintUsageDone, spCommFailureDescription=spCommFailureDescription, mitigationBlackholeStart=mitigationBlackholeStart, spMitigationID=spMitigationID)
