...
Bits, ModuleIdentity, Counter32, Gauge32, Unsigned32, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, MibIdentifier, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter32", "Gauge32", "Unsigned32", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "MibIdentifier", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpInstabilityDone=bgpInstabilityDone, hardwareFailure=hardwareFailure, snmpDown=snmpDown, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationDone=mitigationDone, fingerprintUsageDone=fingerprintUsageDone, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrType=spLicenseErrType, mitigationThirdPartyStart=mitigationThirdPartyStart, spScriptStart=spScriptStart, mitigationBlackholeStart=mitigationBlackholeStart, collectorUp=collectorUp, greDown=greDown, routingFailover=routingFailover, devicePhysicalMemory=devicePhysicalMemory, spInetAddress=spInetAddress, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spDNSObserved=spDNSObserved, dosNetworkProfiledAlert=dosNetworkProfiledAlert, autoclassifyStart=autoclassifyStart, managedObjectUsage=managedObjectUsage, spInterfaceUsage=spInterfaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceSpeed=spInterfaceSpeed, spBGPInstability=spBGPInstability, spHijackLocal=spHijackLocal, spImpactPps=spImpactPps, spBGPEvent=spBGPEvent, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrLimit=spLicenseErrLimit, spManagedObject=spManagedObject, cloudSignalingFault=cloudSignalingFault, configChange=configChange, spGreTunnelName=spGreTunnelName, alertScript=alertScript, spFingerprintSender=spFingerprintSender, spTMSPrefix=spTMSPrefix, spLicenseErrDescription=spLicenseErrDescription, spHijackRoute=spHijackRoute, spFingerprintName=spFingerprintName, spManagedObjectFamily=spManagedObjectFamily, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, collectorStart=collectorStart, bgpTrap=bgpTrap, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spDNSName=spDNSName, collectorDown=collectorDown, serviceUsageDone=serviceUsageDone, spBlackholeNexthop=spBlackholeNexthop, dnsBaselineDone=dnsBaselineDone, fingerprintFeedback=fingerprintFeedback, spDNSObservedMean=spDNSObservedMean, deviceDiskUsage=deviceDiskUsage, spBlackholePrefix=spBlackholePrefix, deviceTotalFlows=deviceTotalFlows, interfaceUsage=interfaceUsage, spHijackAttr=spHijackAttr, spThirdPartyZone=spThirdPartyZone, licenseErrorDone=licenseErrorDone, spCollector=spCollector, spTMSTimeout=spTMSTimeout, deviceSwapSpace=deviceSwapSpace, interfaceUsageDone=interfaceUsageDone, spScriptPort=spScriptPort, spFingerprintMessage=spFingerprintMessage, spGreTunnelDestination=spGreTunnelDestination, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spUnit=spUnit, flowDown=flowDown, spBlackholeCommunity=spBlackholeCommunity, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, reportDone=reportDone, spMitigationID=spMitigationID, spCommFailureDescription=spCommFailureDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, spcommFailure=spcommFailure, spServiceElement=spServiceElement, dnsBaseline=dnsBaseline, hardwareFailureDone=hardwareFailureDone, spDNSExpected=spDNSExpected, spApplicationName=spApplicationName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spTMSCommunity=spTMSCommunity, spcommFailureDone=spcommFailureDone, spVersion=spVersion, deviceSystemError=deviceSystemError, bgpDown=bgpDown, spThreshold=spThreshold, notificationLimit=notificationLimit, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, flowUp=flowUp, spServiceName=spServiceName, spDetectedCountries=spDetectedCountries, PYSNMP_MODULE_ID=peakflowSPMIB, spDNSObservedMax=spDNSObservedMax, spBGPTrapEvent=spBGPTrapEvent, spFlowspecCommunity=spFlowspecCommunity, bgpInstability=bgpInstability, spReportURL=spReportURL, spReportID=spReportID, deviceHealth=deviceHealth, serviceUsage=serviceUsage, fingerprintReceive=fingerprintReceive, spAlertID=spAlertID, spScriptHost=spScriptHost, spMitigationName=spMitigationName, spLicenseErrCount=spLicenseErrCount, peakflowSPMIB=peakflowSPMIB, spRouter=spRouter, spInterfaceUsageHC=spInterfaceUsageHC, spBlackholeTimeout=spBlackholeTimeout, peakflowSPTraps=peakflowSPTraps, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spSystemErrorDescription=spSystemErrorDescription, greDownDone=greDownDone, snmpUp=snmpUp, spBGPTrapPrefix=spBGPTrapPrefix, spBGPTrapName=spBGPTrapName, spReportName=spReportName, spMitigationStart=spMitigationStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spHardwareFailureDescription=spHardwareFailureDescription, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spCommFailureDestination=spCommFailureDestination, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPCMI=peakflowSPCMI, spUsername=spUsername, peakflowSPMgr=peakflowSPMgr, mitigationTMSStart=mitigationTMSStart, spTMSMultiPrefix=spTMSMultiPrefix, bgpHijack=bgpHijack, fingerprintUsage=fingerprintUsage, spThirdPartyAddr=spThirdPartyAddr, spScriptCommand=spScriptCommand, spInterfaceIndex=spInterfaceIndex, spInterface=spInterface, dosHostDetectionAlert=dosHostDetectionAlert, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spImpactBps=spImpactBps, spManagedObjects=spManagedObjects, spUsage=spUsage, managedObjectUsageDone=managedObjectUsageDone, spDuration=spDuration, trafficAutoMitigation=trafficAutoMitigation, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, mitigationFlowspecStart=mitigationFlowspecStart, spInetAddressType=spInetAddressType, licenseError=licenseError, spFlowspecTimeout=spFlowspecTimeout, spDetector=spDetector, spPravail=spPravail, spSystemErrorType=spSystemErrorType, bgpUp=bgpUp, deviceTotalFlowsHC=deviceTotalFlowsHC)
