...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Integer32, ModuleIdentity, iso, Unsigned32, MibIdentifier, NotificationType, TimeTicks, ObjectIdentity, Counter64, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Integer32", "ModuleIdentity", "iso", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spTMSPrefix=spTMSPrefix, bgpDown=bgpDown, fingerprintUsage=fingerprintUsage, spFingerprintName=spFingerprintName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, snmpUp=snmpUp, interfaceUsage=interfaceUsage, licenseErrorDone=licenseErrorDone, fingerprintReceive=fingerprintReceive, spBGPTrapNewAttributes=spBGPTrapNewAttributes, collectorUp=collectorUp, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintMessage=spFingerprintMessage, spHijackLocal=spHijackLocal, spDetectedCountries=spDetectedCountries, spCommFailureDestination=spCommFailureDestination, routingFailover=routingFailover, spThirdPartyZone=spThirdPartyZone, deviceTotalFlowsHC=deviceTotalFlowsHC, spCommFailureDescription=spCommFailureDescription, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spImpactPps=spImpactPps, bgpHijack=bgpHijack, peakflowSPMgr=peakflowSPMgr, spcommFailure=spcommFailure, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPInstability=spBGPInstability, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorType=spSystemErrorType, spMitigationName=spMitigationName, deviceTotalFlows=deviceTotalFlows, spBlackholePrefix=spBlackholePrefix, snmpDown=snmpDown, licenseError=licenseError, spMitigationStart=spMitigationStart, mitigationTMSStartV2=mitigationTMSStartV2, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, flowDown=flowDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, hardwareFailureDone=hardwareFailureDone, spDNSName=spDNSName, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapPrefix=spBGPTrapPrefix, spPravail=spPravail, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceIndex=spInterfaceIndex, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spInetAddressType=spInetAddressType, bgpInstability=bgpInstability, peakflowSPTraps=peakflowSPTraps, spScriptPort=spScriptPort, spBlackholeNexthop=spBlackholeNexthop, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapEvent=spBGPTrapEvent, spThreshold=spThreshold, collectorStart=collectorStart, spInterfaceSpeed=spInterfaceSpeed, spUsername=spUsername, spLicenseErrDescription=spLicenseErrDescription, spHijackAttr=spHijackAttr, spScriptStart=spScriptStart, spServiceName=spServiceName, spApplicationName=spApplicationName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceDiskUsage=deviceDiskUsage, spLicenseErrLimit=spLicenseErrLimit, mitigationDone=mitigationDone, fingerprintFeedback=fingerprintFeedback, managedObjectUsageDone=managedObjectUsageDone, spInetAddress=spInetAddress, greDownDone=greDownDone, fingerprintUsageDone=fingerprintUsageDone, trafficAutoMitigation=trafficAutoMitigation, spMitigationID=spMitigationID, spFingerprintFeedback=spFingerprintFeedback, spCollector=spCollector, spLicenseErrType=spLicenseErrType, notificationLimit=notificationLimit, spReportURL=spReportURL, spImpactBps=spImpactBps, spInterfaceUsage=spInterfaceUsage, autoclassifyStart=autoclassifyStart, cloudSignalingFault=cloudSignalingFault, deviceHealth=deviceHealth, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, hardwareFailure=hardwareFailure, managedObjectUsage=managedObjectUsage, spBGPEvent=spBGPEvent, spDNSObserved=spDNSObserved, configChange=configChange, reportDone=reportDone, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObjectFamily=spManagedObjectFamily, spFlowspecCommunity=spFlowspecCommunity, spUnit=spUnit, spBlackholeTimeout=spBlackholeTimeout, spInterfaceUsageHC=spInterfaceUsageHC, collectorDown=collectorDown, deviceSystemError=deviceSystemError, spGreTunnelName=spGreTunnelName, spUsageType=spUsageType, spBGPTrapName=spBGPTrapName, spFingerprintSender=spFingerprintSender, spTMSTimeout=spTMSTimeout, spTMSCommunity=spTMSCommunity, spDuration=spDuration, devicePhysicalMemory=devicePhysicalMemory, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, dnsBaselineDone=dnsBaselineDone, flowUp=flowUp, peakflowSPMIB=peakflowSPMIB, spBlackholeCommunity=spBlackholeCommunity, spSystemErrorDescription=spSystemErrorDescription, spDNSExpected=spDNSExpected, spScriptCommand=spScriptCommand, spHijackRoute=spHijackRoute, mitigationTMSStart=mitigationTMSStart, spDNSObservedMean=spDNSObservedMean, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPCMI=peakflowSPCMI, spVersion=spVersion, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, spReportName=spReportName, spDetector=spDetector, bgpTrap=bgpTrap, PYSNMP_MODULE_ID=peakflowSPMIB, interfaceUsageDone=interfaceUsageDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrCount=spLicenseErrCount, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterface=spInterface, greDown=greDown, spUsage=spUsage, spReportID=spReportID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpUp=bgpUp, spManagedObject=spManagedObject, deviceSystemErrorDone=deviceSystemErrorDone, spDNSObservedMax=spDNSObservedMax, spScriptHost=spScriptHost, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, alertScript=alertScript, serviceUsage=serviceUsage, serviceUsageDone=serviceUsageDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spServiceElement=spServiceElement, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spManagedObjects=spManagedObjects, dnsBaseline=dnsBaseline, spcommFailureDone=spcommFailureDone, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelDestination=spGreTunnelDestination, bgpInstabilityDone=bgpInstabilityDone, deviceSwapSpace=deviceSwapSpace, spAlertID=spAlertID, mitigationBlackholeStart=mitigationBlackholeStart)
