...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, TimeTicks, NotificationType, Counter64, Bits, Integer32, ModuleIdentity, Unsigned32, MibIdentifier, IpAddress, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "TimeTicks", "NotificationType", "Counter64", "Bits", "Integer32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "Counter32", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapNewAttributes=spBGPTrapNewAttributes, interfaceUsage=interfaceUsage, greDownDone=greDownDone, flowDown=flowDown, spLicenseErrType=spLicenseErrType, spLicenseErrCount=spLicenseErrCount, spReportID=spReportID, spFingerprintFeedback=spFingerprintFeedback, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholeTimeout=spBlackholeTimeout, spFlowspecCommunity=spFlowspecCommunity, spBGPTrapEvent=spBGPTrapEvent, spTMSPrefix=spTMSPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spSystemErrorDescription=spSystemErrorDescription, snmpDown=snmpDown, spDuration=spDuration, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spImpactBps=spImpactBps, spInterfaceUsageHC=spInterfaceUsageHC, deviceTotalFlowsHC=deviceTotalFlowsHC, spUsageType=spUsageType, bgpInstability=bgpInstability, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObservedMax=spDNSObservedMax, spApplicationName=spApplicationName, spGreTunnelDestination=spGreTunnelDestination, spBGPEvent=spBGPEvent, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spImpactPps=spImpactPps, peakflowSPMIB=peakflowSPMIB, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDetectedCountries=spDetectedCountries, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportName=spReportName, spBGPTrapPrefix=spBGPTrapPrefix, flowUp=flowUp, spCommFailureDestination=spCommFailureDestination, spThirdPartyAddr=spThirdPartyAddr, reportDone=reportDone, deviceSystemErrorDone=deviceSystemErrorDone, spFingerprintMessage=spFingerprintMessage, spInterfaceSpeedHC=spInterfaceSpeedHC, spHijackRoute=spHijackRoute, spFingerprintName=spFingerprintName, bgpTrap=bgpTrap, dnsBaseline=dnsBaseline, mitigationFlowspecStart=mitigationFlowspecStart, spUsername=spUsername, dosHostDetectionAlertDone=dosHostDetectionAlertDone, trafficAutoMitigation=trafficAutoMitigation, spGreTunnelName=spGreTunnelName, spManagedObjects=spManagedObjects, spInterfaceSpeed=spInterfaceSpeed, spTMSTimeout=spTMSTimeout, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spTMSMultiPrefix=spTMSMultiPrefix, hardwareFailure=hardwareFailure, spServiceElement=spServiceElement, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spScriptPort=spScriptPort, spMitigationName=spMitigationName, spInetAddress=spInetAddress, mitigationThirdPartyStart=mitigationThirdPartyStart, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterface=spInterface, bgpUp=bgpUp, spPravail=spPravail, spDNSExpected=spDNSExpected, deviceSwapSpaceUsage=deviceSwapSpaceUsage, licenseErrorDone=licenseErrorDone, collectorUp=collectorUp, hardwareFailureDone=hardwareFailureDone, autoclassifyStart=autoclassifyStart, spBGPInstability=spBGPInstability, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, serviceUsage=serviceUsage, spDNSObserved=spDNSObserved, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPCMI=peakflowSPCMI, dnsBaselineDone=dnsBaselineDone, spDetector=spDetector, devicePhysicalMemory=devicePhysicalMemory, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, licenseError=licenseError, PYSNMP_MODULE_ID=peakflowSPMIB, peakflowSPMgr=peakflowSPMgr, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spVersion=spVersion, spCollector=spCollector, mitigationDone=mitigationDone, spLicenseErrLimit=spLicenseErrLimit, deviceSystemError=deviceSystemError, spcommFailure=spcommFailure, spcommFailureDone=spcommFailureDone, spSystemErrorType=spSystemErrorType, spLicenseErrDescription=spLicenseErrDescription, spInterfaceIndex=spInterfaceIndex, spInterfaceUsage=spInterfaceUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, cloudSignalingFault=cloudSignalingFault, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpHijack=bgpHijack, managedObjectUsage=managedObjectUsage, spManagedObject=spManagedObject, fingerprintReceive=fingerprintReceive, spHijackLocal=spHijackLocal, mitigationTMSStart=mitigationTMSStart, bgpDown=bgpDown, spTMSCommunity=spTMSCommunity, deviceTotalFlows=deviceTotalFlows, collectorDown=collectorDown, managedObjectUsageDone=managedObjectUsageDone, spUnit=spUnit, spDNSName=spDNSName, spBlackholePrefix=spBlackholePrefix, spHijackAttr=spHijackAttr, spBlackholeNexthop=spBlackholeNexthop, spCommFailureDescription=spCommFailureDescription, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpace=deviceSwapSpace, notificationLimit=notificationLimit, spServiceName=spServiceName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPTrapName=spBGPTrapName, configChange=configChange, bgpInstabilityDone=bgpInstabilityDone, spManagedObjectFamily=spManagedObjectFamily, spDNSObservedMean=spDNSObservedMean, spMitigationStart=spMitigationStart, routingFailover=routingFailover, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spFingerprintSender=spFingerprintSender, deviceDiskUsage=deviceDiskUsage, spThirdPartyZone=spThirdPartyZone, spBlackholeCommunity=spBlackholeCommunity, deviceHealth=deviceHealth, fingerprintUsage=fingerprintUsage, spAlertID=spAlertID, peakflowSPTraps=peakflowSPTraps, serviceUsageDone=serviceUsageDone, spScriptStart=spScriptStart, greDown=greDown, collectorStart=collectorStart, mitigationBlackholeStart=mitigationBlackholeStart, spInetAddressType=spInetAddressType, alertScript=alertScript, spFlowspecTimeout=spFlowspecTimeout, spReportURL=spReportURL, spScriptCommand=spScriptCommand, spRouter=spRouter, snmpUp=snmpUp, fingerprintUsageDone=fingerprintUsageDone, spUsage=spUsage, spScriptHost=spScriptHost, spMitigationID=spMitigationID, spThreshold=spThreshold, fingerprintFeedback=fingerprintFeedback, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, interfaceUsageDone=interfaceUsageDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert)
