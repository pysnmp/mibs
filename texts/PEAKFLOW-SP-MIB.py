...
Gauge32, Bits, TimeTicks, Counter32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Counter64, iso, ObjectIdentity, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "TimeTicks", "Counter32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spVersion=spVersion, mitigationBlackholeStart=mitigationBlackholeStart, spPravail=spPravail, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spThirdPartyZone=spThirdPartyZone, spUsage=spUsage, flowUp=flowUp, spInterface=spInterface, spcommFailureDone=spcommFailureDone, spDetectedCountries=spDetectedCountries, spInetAddress=spInetAddress, routingFailover=routingFailover, peakflowSPCMI=peakflowSPCMI, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSystemErrorDone=deviceSystemErrorDone, spTMSMultiPrefix=spTMSMultiPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrLimit=spLicenseErrLimit, spBGPEvent=spBGPEvent, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowDown=flowDown, spCommFailureDescription=spCommFailureDescription, spInetAddressType=spInetAddressType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorStart=collectorStart, spUsageType=spUsageType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, managedObjectUsageDone=managedObjectUsageDone, managedObjectUsage=managedObjectUsage, peakflowSPMIB=peakflowSPMIB, spFlowspecTimeout=spFlowspecTimeout, spMitigationName=spMitigationName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, serviceUsageDone=serviceUsageDone, peakflowSPTraps=peakflowSPTraps, spUnit=spUnit, collectorDown=collectorDown, licenseError=licenseError, interfaceUsageDone=interfaceUsageDone, spHijackRoute=spHijackRoute, spDNSObservedMax=spDNSObservedMax, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSCommunity=spTMSCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spThreshold=spThreshold, spScriptHost=spScriptHost, spBGPTrapEvent=spBGPTrapEvent, spSystemErrorType=spSystemErrorType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, hardwareFailureDone=hardwareFailureDone, spCollector=spCollector, deviceHealth=deviceHealth, deviceSwapSpace=deviceSwapSpace, mitigationTMSStartV2=mitigationTMSStartV2, bgpTrap=bgpTrap, greDownDone=greDownDone, spHardwareFailureDescription=spHardwareFailureDescription, spMitigationStart=spMitigationStart, autoclassifyStart=autoclassifyStart, spReportID=spReportID, spDNSObserved=spDNSObserved, spImpactPps=spImpactPps, bgpInstabilityDone=bgpInstabilityDone, mitigationTMSStart=mitigationTMSStart, spGreTunnelDestination=spGreTunnelDestination, spImpactBps=spImpactBps, spInterfaceUsage=spInterfaceUsage, spDNSObservedMean=spDNSObservedMean, spFingerprintFeedback=spFingerprintFeedback, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, PYSNMP_MODULE_ID=peakflowSPMIB, spBlackholeCommunity=spBlackholeCommunity, spInterfaceUsageHC=spInterfaceUsageHC, fingerprintUsage=fingerprintUsage, spRouter=spRouter, spFlowspecCommunity=spFlowspecCommunity, reportDone=reportDone, spFingerprintName=spFingerprintName, fingerprintFeedback=fingerprintFeedback, spDetector=spDetector, spFingerprintMessage=spFingerprintMessage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, greDown=greDown, spHijackLocal=spHijackLocal, spBlackholeTimeout=spBlackholeTimeout, spBlackholeNexthop=spBlackholeNexthop, bgpDown=bgpDown, mitigationDone=mitigationDone, spFingerprintSender=spFingerprintSender, dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFaultDone=cloudSignalingFaultDone, interfaceUsage=interfaceUsage, cloudSignalingFault=cloudSignalingFault, spServiceElement=spServiceElement, dnsBaselineDone=dnsBaselineDone, bgpInstability=bgpInstability, spTMSTimeout=spTMSTimeout, spBGPTrapPrefix=spBGPTrapPrefix, spBlackholePrefix=spBlackholePrefix, configChange=configChange, mitigationThirdPartyStart=mitigationThirdPartyStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, bgpHijack=bgpHijack, spManagedObjects=spManagedObjects, snmpUp=snmpUp, spReportName=spReportName, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSystemError=deviceSystemError, fingerprintUsageDone=fingerprintUsageDone, spHijackAttr=spHijackAttr, spReportURL=spReportURL, licenseErrorDone=licenseErrorDone, spInterfaceIndex=spInterfaceIndex, devicePhysicalMemory=devicePhysicalMemory, spDNSExpected=spDNSExpected, spMitigationID=spMitigationID, dnsBaseline=dnsBaseline, deviceDiskUsage=deviceDiskUsage, notificationLimit=notificationLimit, spManagedObjectFamily=spManagedObjectFamily, deviceTotalFlows=deviceTotalFlows, spScriptPort=spScriptPort, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spAlertID=spAlertID, spDNSName=spDNSName, spGreTunnelName=spGreTunnelName, spSystemErrorDescription=spSystemErrorDescription, hardwareFailure=hardwareFailure, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCommFailureDestination=spCommFailureDestination, spcommFailure=spcommFailure, snmpDown=snmpDown, bgpUp=bgpUp, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPInstability=spBGPInstability, spServiceName=spServiceName, spApplicationName=spApplicationName, spScriptStart=spScriptStart, spUsername=spUsername, spInterfaceSpeed=spInterfaceSpeed, mitigationFlowspecStart=mitigationFlowspecStart, spBGPTrapName=spBGPTrapName, spTMSPrefix=spTMSPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrCount=spLicenseErrCount, dosHostDetectionAlert=dosHostDetectionAlert, trafficAutoMitigation=trafficAutoMitigation, alertScript=alertScript, collectorUp=collectorUp, spDuration=spDuration, spManagedObject=spManagedObject, serviceUsage=serviceUsage, spLicenseErrDescription=spLicenseErrDescription, spScriptCommand=spScriptCommand, peakflowSPMgr=peakflowSPMgr, fingerprintReceive=fingerprintReceive, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyAddr=spThirdPartyAddr, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest)
