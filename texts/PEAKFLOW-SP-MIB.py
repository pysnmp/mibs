...
Counter32, MibIdentifier, iso, NotificationType, ObjectIdentity, Gauge32, TimeTicks, Unsigned32, Counter64, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "NotificationType", "ObjectIdentity", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spGreTunnelName=spGreTunnelName, deviceTotalFlowsHC=deviceTotalFlowsHC, collectorDown=collectorDown, spHijackLocal=spHijackLocal, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spMitigationName=spMitigationName, spServiceName=spServiceName, spBlackholeTimeout=spBlackholeTimeout, spInterfaceUsageHC=spInterfaceUsageHC, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBlackholeNexthop=spBlackholeNexthop, reportDone=reportDone, spTMSPrefix=spTMSPrefix, mitigationDone=mitigationDone, cloudSignalingFault=cloudSignalingFault, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spDNSObservedMean=spDNSObservedMean, spBGPEvent=spBGPEvent, spScriptHost=spScriptHost, spDNSObservedMax=spDNSObservedMax, bgpHijack=bgpHijack, spLicenseErrCount=spLicenseErrCount, greDown=greDown, spBGPTrapEvent=spBGPTrapEvent, spPravail=spPravail, trafficAutoMitigation=trafficAutoMitigation, licenseErrorDone=licenseErrorDone, dosHostDetectionAlert=dosHostDetectionAlert, mitigationFlowspecStart=mitigationFlowspecStart, spTMSTimeout=spTMSTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpTrap=bgpTrap, dnsBaseline=dnsBaseline, spServiceElement=spServiceElement, managedObjectUsage=managedObjectUsage, spLicenseErrDescription=spLicenseErrDescription, greDownDone=greDownDone, spInterfaceUsage=spInterfaceUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationBlackholeStart=mitigationBlackholeStart, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spUsername=spUsername, spCommFailureDestination=spCommFailureDestination, spDNSName=spDNSName, spImpactBps=spImpactBps, spManagedObject=spManagedObject, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintUsageDone=fingerprintUsageDone, spInterfaceIndex=spInterfaceIndex, spcommFailureDone=spcommFailureDone, spDNSExpected=spDNSExpected, spDetector=spDetector, spMitigationStart=spMitigationStart, spGreTunnelDestination=spGreTunnelDestination, spFingerprintMessage=spFingerprintMessage, bgpUp=bgpUp, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spAlertID=spAlertID, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapName=spBGPTrapName, spHijackAttr=spHijackAttr, spFlowspecCommunity=spFlowspecCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceSwapSpace=deviceSwapSpace, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spInterfaceSpeedHC=spInterfaceSpeedHC, spFingerprintSender=spFingerprintSender, routingFailover=routingFailover, spRouter=spRouter, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpInstability=bgpInstability, spHijackRoute=spHijackRoute, serviceUsageDone=serviceUsageDone, spFlowspecTimeout=spFlowspecTimeout, spFingerprintName=spFingerprintName, spDuration=spDuration, flowDown=flowDown, spMitigationID=spMitigationID, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationTMSStart=mitigationTMSStart, spTMSCommunity=spTMSCommunity, spDNSObserved=spDNSObserved, peakflowSPMIB=peakflowSPMIB, deviceDiskUsage=deviceDiskUsage, alertScript=alertScript, spSystemErrorDescription=spSystemErrorDescription, dnsBaselineDone=dnsBaselineDone, serviceUsage=serviceUsage, snmpUp=snmpUp, fingerprintFeedback=fingerprintFeedback, spBlackholePrefix=spBlackholePrefix, spReportID=spReportID, spFingerprintFeedback=spFingerprintFeedback, deviceSystemErrorDone=deviceSystemErrorDone, spReportName=spReportName, spBGPInstability=spBGPInstability, spThreshold=spThreshold, deviceHealth=deviceHealth, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsage=fingerprintUsage, spBlackholeCommunity=spBlackholeCommunity, spApplicationName=spApplicationName, hardwareFailureDone=hardwareFailureDone, cloudSignalingFaultDone=cloudSignalingFaultDone, interfaceUsageDone=interfaceUsageDone, spReportURL=spReportURL, spUnit=spUnit, autoclassifyStart=autoclassifyStart, spThirdPartyAddr=spThirdPartyAddr, spAlertDetectionSignatures=spAlertDetectionSignatures, interfaceUsage=interfaceUsage, spManagedObjects=spManagedObjects, spThirdPartyZone=spThirdPartyZone, spDetectedCountries=spDetectedCountries, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceTotalFlows=deviceTotalFlows, spCollector=spCollector, spScriptPort=spScriptPort, spManagedObjectFamily=spManagedObjectFamily, spInetAddressType=spInetAddressType, spImpactPps=spImpactPps, peakflowSPTraps=peakflowSPTraps, bgpDown=bgpDown, spUsage=spUsage, peakflowSPMgr=peakflowSPMgr, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, managedObjectUsageDone=managedObjectUsageDone, spCommFailureDescription=spCommFailureDescription, deviceSystemError=deviceSystemError, mitigationTMSStartV2=mitigationTMSStartV2, licenseError=licenseError, spcommFailure=spcommFailure, spInterface=spInterface, snmpDown=snmpDown, spLicenseErrType=spLicenseErrType, spInterfaceSpeed=spInterfaceSpeed, spScriptCommand=spScriptCommand, spHardwareFailureDescription=spHardwareFailureDescription, spVersion=spVersion, devicePhysicalMemory=devicePhysicalMemory, spInetAddress=spInetAddress, configChange=configChange, spLicenseErrLimit=spLicenseErrLimit, collectorUp=collectorUp, spSystemErrorType=spSystemErrorType, collectorStart=collectorStart, spScriptStart=spScriptStart, spUsageType=spUsageType, peakflowSPCMI=peakflowSPCMI, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, notificationLimit=notificationLimit, hardwareFailure=hardwareFailure, fingerprintReceive=fingerprintReceive, flowUp=flowUp)
