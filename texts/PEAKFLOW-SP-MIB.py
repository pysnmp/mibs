...
Unsigned32, ModuleIdentity, Counter64, TimeTicks, IpAddress, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Integer32, NotificationType, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter64", "TimeTicks", "IpAddress", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Integer32", "NotificationType", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosHostDetectionAlert=dosHostDetectionAlert, spCommFailureDestination=spCommFailureDestination, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceIndex=spInterfaceIndex, spBlackholeTimeout=spBlackholeTimeout, spPravail=spPravail, spLicenseErrLimit=spLicenseErrLimit, mitigationTMSStartV2=mitigationTMSStartV2, spScriptPort=spScriptPort, mitigationThirdPartyStart=mitigationThirdPartyStart, serviceUsageDone=serviceUsageDone, spLicenseErrCount=spLicenseErrCount, spSystemErrorDescription=spSystemErrorDescription, bgpUp=bgpUp, spInterfaceSpeed=spInterfaceSpeed, bgpTrap=bgpTrap, fingerprintReceive=fingerprintReceive, spUnit=spUnit, fingerprintUsage=fingerprintUsage, spLicenseErrType=spLicenseErrType, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInetAddress=spInetAddress, spInterface=spInterface, deviceSystemErrorDone=deviceSystemErrorDone, spManagedObjectFamily=spManagedObjectFamily, trafficAutoMitigation=trafficAutoMitigation, spHardwareFailureDescription=spHardwareFailureDescription, spCollector=spCollector, greDownDone=greDownDone, peakflowSPMgr=peakflowSPMgr, spServiceElement=spServiceElement, spDetectedCountries=spDetectedCountries, spReportURL=spReportURL, hardwareFailure=hardwareFailure, spThirdPartyAddr=spThirdPartyAddr, mitigationDone=mitigationDone, spAlertID=spAlertID, spBGPInstability=spBGPInstability, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDetector=spDetector, spServiceName=spServiceName, spInterfaceSpeedHC=spInterfaceSpeedHC, spUsage=spUsage, spFingerprintFeedback=spFingerprintFeedback, spGreTunnelDestination=spGreTunnelDestination, licenseErrorDone=licenseErrorDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spUsername=spUsername, spFingerprintSender=spFingerprintSender, spManagedObjects=spManagedObjects, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptCommand=spScriptCommand, spThreshold=spThreshold, peakflowSPTraps=peakflowSPTraps, deviceHealth=deviceHealth, collectorStart=collectorStart, mitigationFlowspecStart=mitigationFlowspecStart, spHijackAttr=spHijackAttr, spFingerprintMessage=spFingerprintMessage, spInterfaceUsage=spInterfaceUsage, spDNSObserved=spDNSObserved, spMitigationName=spMitigationName, spCommFailureDescription=spCommFailureDescription, dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFaultDone=cloudSignalingFaultDone, spVersion=spVersion, spImpactBps=spImpactBps, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spGreTunnelName=spGreTunnelName, collectorUp=collectorUp, deviceDiskUsage=deviceDiskUsage, spReportID=spReportID, spDNSExpected=spDNSExpected, spSystemErrorType=spSystemErrorType, managedObjectUsageDone=managedObjectUsageDone, mitigationTMSStart=mitigationTMSStart, spScriptStart=spScriptStart, reportDone=reportDone, spDNSObservedMean=spDNSObservedMean, peakflowSPCMI=peakflowSPCMI, spBlackholePrefix=spBlackholePrefix, peakflowSPMIB=peakflowSPMIB, flowUp=flowUp, spDNSObservedMax=spDNSObservedMax, deviceSwapSpace=deviceSwapSpace, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpUp=snmpUp, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpDown=bgpDown, spInterfaceUsageHC=spInterfaceUsageHC, bgpInstabilityDone=bgpInstabilityDone, collectorDown=collectorDown, notificationLimit=notificationLimit, spHijackLocal=spHijackLocal, spUsageType=spUsageType, dnsBaseline=dnsBaseline, spTMSTimeout=spTMSTimeout, spFingerprintName=spFingerprintName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, fingerprintUsageDone=fingerprintUsageDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, greDown=greDown, fingerprintFeedback=fingerprintFeedback, alertScript=alertScript, interfaceUsage=interfaceUsage, spMitigationID=spMitigationID, PYSNMP_MODULE_ID=peakflowSPMIB, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, spcommFailureDone=spcommFailureDone, mitigationBlackholeStart=mitigationBlackholeStart, spBGPEvent=spBGPEvent, spImpactPps=spImpactPps, spHijackRoute=spHijackRoute, spDuration=spDuration, spBGPTrapEvent=spBGPTrapEvent, snmpDown=snmpDown, cloudSignalingFault=cloudSignalingFault, configChange=configChange, deviceSystemError=deviceSystemError, spApplicationName=spApplicationName, spThirdPartyZone=spThirdPartyZone, spBGPTrapName=spBGPTrapName, spTMSCommunity=spTMSCommunity, spcommFailure=spcommFailure, autoclassifyStart=autoclassifyStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spRouter=spRouter, bgpInstability=bgpInstability, spDNSName=spDNSName, licenseError=licenseError, spLicenseErrDescription=spLicenseErrDescription, managedObjectUsage=managedObjectUsage, devicePhysicalMemory=devicePhysicalMemory, spFlowspecTimeout=spFlowspecTimeout, interfaceUsageDone=interfaceUsageDone, spBlackholeNexthop=spBlackholeNexthop, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholeCommunity=spBlackholeCommunity, spManagedObject=spManagedObject, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, hardwareFailureDone=hardwareFailureDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, routingFailover=routingFailover, spTMSPrefix=spTMSPrefix, serviceUsage=serviceUsage, flowDown=flowDown, spInetAddressType=spInetAddressType, deviceTotalFlows=deviceTotalFlows, spReportName=spReportName, dnsBaselineDone=dnsBaselineDone, bgpHijack=bgpHijack, spScriptHost=spScriptHost, spTMSMultiPrefix=spTMSMultiPrefix, spFlowspecCommunity=spFlowspecCommunity, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spMitigationStart=spMitigationStart)
