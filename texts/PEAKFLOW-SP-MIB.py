...
Counter32, NotificationType, Bits, iso, Integer32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Counter64, ModuleIdentity, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Bits", "iso", "Integer32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrCount=spLicenseErrCount, peakflowSPTraps=peakflowSPTraps, mitigationTMSStart=mitigationTMSStart, bgpInstabilityDone=bgpInstabilityDone, licenseErrorDone=licenseErrorDone, spInterface=spInterface, spTMSCommunity=spTMSCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spcommFailureDone=spcommFailureDone, spFingerprintSender=spFingerprintSender, spCollector=spCollector, spUnit=spUnit, spInterfaceUsageHC=spInterfaceUsageHC, hardwareFailure=hardwareFailure, spServiceElement=spServiceElement, spTMSTimeout=spTMSTimeout, spMitigationStart=spMitigationStart, spLicenseErrLimit=spLicenseErrLimit, spDNSObservedMean=spDNSObservedMean, spBlackholeNexthop=spBlackholeNexthop, bgpUp=bgpUp, spMitigationName=spMitigationName, spApplicationName=spApplicationName, spBGPTrapName=spBGPTrapName, spBGPEvent=spBGPEvent, interfaceUsageDone=interfaceUsageDone, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpDown=bgpDown, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spHijackRoute=spHijackRoute, spMitigationID=spMitigationID, spManagedObjectFamily=spManagedObjectFamily, spUsageType=spUsageType, mitigationBlackholeStart=mitigationBlackholeStart, autoclassifyStart=autoclassifyStart, deviceHealth=deviceHealth, snmpDown=snmpDown, spDNSExpected=spDNSExpected, spTMSMultiPrefix=spTMSMultiPrefix, spThirdPartyAddr=spThirdPartyAddr, spCommFailureDescription=spCommFailureDescription, spCommFailureDestination=spCommFailureDestination, configChange=configChange, fingerprintUsageDone=fingerprintUsageDone, peakflowSPMIB=peakflowSPMIB, spHardwareFailureDescription=spHardwareFailureDescription, collectorUp=collectorUp, spInterfaceUsage=spInterfaceUsage, spInterfaceIndex=spInterfaceIndex, spDetectedCountries=spDetectedCountries, spLicenseErrDescription=spLicenseErrDescription, bgpTrap=bgpTrap, spRouter=spRouter, spBlackholePrefix=spBlackholePrefix, flowUp=flowUp, snmpUp=snmpUp, devicePhysicalMemory=devicePhysicalMemory, fingerprintFeedback=fingerprintFeedback, spImpactBps=spImpactBps, spManagedObject=spManagedObject, spDuration=spDuration, spPravail=spPravail, spFingerprintName=spFingerprintName, fingerprintUsage=fingerprintUsage, spThirdPartyZone=spThirdPartyZone, spLicenseErrType=spLicenseErrType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceTotalFlows=deviceTotalFlows, hardwareFailureDone=hardwareFailureDone, spFlowspecTimeout=spFlowspecTimeout, spHijackLocal=spHijackLocal, cloudSignalingFault=cloudSignalingFault, mitigationDone=mitigationDone, spReportURL=spReportURL, bgpInstability=bgpInstability, collectorDown=collectorDown, peakflowSPMgr=peakflowSPMgr, spBlackholeTimeout=spBlackholeTimeout, cloudSignalingFaultDone=cloudSignalingFaultDone, spDNSObservedMax=spDNSObservedMax, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPCMI=peakflowSPCMI, mitigationThirdPartyStart=mitigationThirdPartyStart, spInetAddress=spInetAddress, spScriptHost=spScriptHost, deviceSystemError=deviceSystemError, spThreshold=spThreshold, spFingerprintFeedback=spFingerprintFeedback, deviceDiskUsage=deviceDiskUsage, greDownDone=greDownDone, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintReceive=fingerprintReceive, spReportName=spReportName, spBlackholeCommunity=spBlackholeCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, PYSNMP_MODULE_ID=peakflowSPMIB, spSystemErrorDescription=spSystemErrorDescription, collectorStart=collectorStart, spTMSPrefix=spTMSPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spScriptPort=spScriptPort, spDetector=spDetector, managedObjectUsage=managedObjectUsage, spImpactPps=spImpactPps, flowDown=flowDown, spInterfaceSpeed=spInterfaceSpeed, spReportID=spReportID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsage=spUsage, dosNetworkProfiledAlert=dosNetworkProfiledAlert, dnsBaseline=dnsBaseline, spInterfaceSpeedHC=spInterfaceSpeedHC, spServiceName=spServiceName, routingFailover=routingFailover, spGreTunnelName=spGreTunnelName, spAlertID=spAlertID, mitigationTMSStartV2=mitigationTMSStartV2, spScriptStart=spScriptStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, managedObjectUsageDone=managedObjectUsageDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSName=spDNSName, reportDone=reportDone, spInetAddressType=spInetAddressType, spUsername=spUsername, spBGPTrapPrefix=spBGPTrapPrefix, deviceSwapSpace=deviceSwapSpace, dnsBaselineDone=dnsBaselineDone, spManagedObjects=spManagedObjects, spGreTunnelDestination=spGreTunnelDestination, spSystemErrorType=spSystemErrorType, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, trafficAutoMitigation=trafficAutoMitigation, spVersion=spVersion, spcommFailure=spcommFailure, interfaceUsage=interfaceUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, greDown=greDown, serviceUsage=serviceUsage, serviceUsageDone=serviceUsageDone, bgpHijack=bgpHijack, spBGPTrapEvent=spBGPTrapEvent, spFlowspecCommunity=spFlowspecCommunity, spFingerprintMessage=spFingerprintMessage, spScriptCommand=spScriptCommand, alertScript=alertScript, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, notificationLimit=notificationLimit, licenseError=licenseError, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosHostDetectionAlert=dosHostDetectionAlert, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, mitigationFlowspecStart=mitigationFlowspecStart, spBGPInstability=spBGPInstability, spDNSObserved=spDNSObserved, spHijackAttr=spHijackAttr)
