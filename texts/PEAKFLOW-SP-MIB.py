...
Bits, ObjectIdentity, TimeTicks, Counter32, iso, ModuleIdentity, Unsigned32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "iso", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", dosHostDetectionAlert=dosHostDetectionAlert, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceUsage=spInterfaceUsage, spDNSName=spDNSName, snmpDown=snmpDown, spGreTunnelDestination=spGreTunnelDestination, deviceHealth=deviceHealth, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackLocal=spHijackLocal, spInterfaceSpeedHC=spInterfaceSpeedHC, flowUp=flowUp, mitigationDone=mitigationDone, spBGPInstability=spBGPInstability, spBlackholeTimeout=spBlackholeTimeout, spInterfaceUsageHC=spInterfaceUsageHC, spCommFailureDescription=spCommFailureDescription, reportDone=reportDone, spInterfaceIndex=spInterfaceIndex, spLicenseErrCount=spLicenseErrCount, deviceSwapSpace=deviceSwapSpace, spBlackholeCommunity=spBlackholeCommunity, greDownDone=greDownDone, spManagedObjectFamily=spManagedObjectFamily, dnsBaselineDone=dnsBaselineDone, spDNSExpected=spDNSExpected, spUsage=spUsage, managedObjectUsage=managedObjectUsage, collectorDown=collectorDown, spInterfaceSpeed=spInterfaceSpeed, spCommFailureDestination=spCommFailureDestination, bgpDown=bgpDown, spDNSObservedMax=spDNSObservedMax, spBGPEvent=spBGPEvent, dnsBaseline=dnsBaseline, deviceDiskUsage=deviceDiskUsage, spThirdPartyZone=spThirdPartyZone, hardwareFailureDone=hardwareFailureDone, spFlowspecTimeout=spFlowspecTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spSystemErrorType=spSystemErrorType, serviceUsageDone=serviceUsageDone, spReportURL=spReportURL, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, trafficAutoMitigation=trafficAutoMitigation, managedObjectUsageDone=managedObjectUsageDone, bgpUp=bgpUp, spImpactPps=spImpactPps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPTrapPrefix=spBGPTrapPrefix, spScriptHost=spScriptHost, cloudSignalingFaultDone=cloudSignalingFaultDone, spFlowspecCommunity=spFlowspecCommunity, spPravail=spPravail, spManagedObject=spManagedObject, deviceTotalFlows=deviceTotalFlows, interfaceUsage=interfaceUsage, spBlackholePrefix=spBlackholePrefix, spcommFailure=spcommFailure, spApplicationName=spApplicationName, spBGPTrapName=spBGPTrapName, spServiceElement=spServiceElement, bgpInstability=bgpInstability, spInetAddress=spInetAddress, spTMSMultiPrefix=spTMSMultiPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, serviceUsage=serviceUsage, fingerprintUsage=fingerprintUsage, spManagedObjects=spManagedObjects, bgpHijack=bgpHijack, spDNSObserved=spDNSObserved, spDuration=spDuration, peakflowSPTraps=peakflowSPTraps, spDetectedCountries=spDetectedCountries, spAlertID=spAlertID, bgpTrap=bgpTrap, fingerprintFeedback=fingerprintFeedback, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPMgr=peakflowSPMgr, bgpInstabilityDone=bgpInstabilityDone, spHijackRoute=spHijackRoute, spUnit=spUnit, spGreTunnelName=spGreTunnelName, PYSNMP_MODULE_ID=peakflowSPMIB, spServiceName=spServiceName, deviceSystemErrorDone=deviceSystemErrorDone, spRouter=spRouter, spVersion=spVersion, spMitigationName=spMitigationName, spBlackholeNexthop=spBlackholeNexthop, spAlertDetectionSignatures=spAlertDetectionSignatures, spScriptStart=spScriptStart, spFingerprintSender=spFingerprintSender, deviceTotalFlowsHC=deviceTotalFlowsHC, spReportName=spReportName, spHijackAttr=spHijackAttr, spMitigationID=spMitigationID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spLicenseErrLimit=spLicenseErrLimit, spcommFailureDone=spcommFailureDone, spInetAddressType=spInetAddressType, greDown=greDown, spMitigationStart=spMitigationStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spThirdPartyAddr=spThirdPartyAddr, collectorStart=collectorStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationFlowspecStart=mitigationFlowspecStart, deviceSystemError=deviceSystemError, spFingerprintName=spFingerprintName, collectorUp=collectorUp, configChange=configChange, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spCollector=spCollector, fingerprintReceive=fingerprintReceive, mitigationTMSStart=mitigationTMSStart, spBGPTrapEvent=spBGPTrapEvent, mitigationTMSStartV2=mitigationTMSStartV2, spLicenseErrDescription=spLicenseErrDescription, licenseErrorDone=licenseErrorDone, spTMSPrefix=spTMSPrefix, spThreshold=spThreshold, fingerprintUsageDone=fingerprintUsageDone, spSystemErrorDescription=spSystemErrorDescription, spImpactBps=spImpactBps, licenseError=licenseError, spReportID=spReportID, spUsername=spUsername, spTMSTimeout=spTMSTimeout, peakflowSPMIB=peakflowSPMIB, interfaceUsageDone=interfaceUsageDone, alertScript=alertScript, hardwareFailure=hardwareFailure, mitigationThirdPartyStart=mitigationThirdPartyStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowDown=flowDown, spHardwareFailureDescription=spHardwareFailureDescription, notificationLimit=notificationLimit, spDetector=spDetector, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spFingerprintFeedback=spFingerprintFeedback, spDNSObservedMean=spDNSObservedMean, spInterface=spInterface, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrType=spLicenseErrType, cloudSignalingFault=cloudSignalingFault, snmpUp=snmpUp, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUsageType=spUsageType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spScriptCommand=spScriptCommand, peakflowSPCMI=peakflowSPCMI, autoclassifyStart=autoclassifyStart, spScriptPort=spScriptPort, spTMSCommunity=spTMSCommunity, routingFailover=routingFailover, devicePhysicalMemory=devicePhysicalMemory, spFingerprintMessage=spFingerprintMessage)
