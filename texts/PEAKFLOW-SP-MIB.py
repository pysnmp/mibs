...
ModuleIdentity, TimeTicks, MibIdentifier, Counter32, Counter64, iso, Unsigned32, NotificationType, Bits, IpAddress, Gauge32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Counter32", "Counter64", "iso", "Unsigned32", "NotificationType", "Bits", "IpAddress", "Gauge32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrCount=spLicenseErrCount, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpInstabilityDone=bgpInstabilityDone, spDNSObserved=spDNSObserved, spCollector=spCollector, spBlackholeNexthop=spBlackholeNexthop, spTMSCommunity=spTMSCommunity, serviceUsageDone=serviceUsageDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBlackholeCommunity=spBlackholeCommunity, dnsBaselineDone=dnsBaselineDone, spUsername=spUsername, serviceUsage=serviceUsage, spCommFailureDestination=spCommFailureDestination, peakflowSPMgr=peakflowSPMgr, spDNSExpected=spDNSExpected, deviceSwapSpace=deviceSwapSpace, spFingerprintFeedback=spFingerprintFeedback, spDuration=spDuration, hardwareFailure=hardwareFailure, spApplicationName=spApplicationName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSystemError=deviceSystemError, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spScriptStart=spScriptStart, spTMSTimeout=spTMSTimeout, fingerprintReceive=fingerprintReceive, spSystemErrorType=spSystemErrorType, spcommFailure=spcommFailure, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spLicenseErrLimit=spLicenseErrLimit, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceHealth=deviceHealth, alertScript=alertScript, spManagedObjectFamily=spManagedObjectFamily, mitigationBlackholeStart=mitigationBlackholeStart, greDownDone=greDownDone, spSystemErrorDescription=spSystemErrorDescription, notificationLimit=notificationLimit, spInetAddress=spInetAddress, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, fingerprintUsage=fingerprintUsage, spMitigationID=spMitigationID, spBGPEvent=spBGPEvent, spThreshold=spThreshold, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spReportName=spReportName, spVersion=spVersion, spFlowspecCommunity=spFlowspecCommunity, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spReportURL=spReportURL, spReportID=spReportID, flowDown=flowDown, trafficAutoMitigation=trafficAutoMitigation, configChange=configChange, spServiceElement=spServiceElement, spBGPTrapPrefix=spBGPTrapPrefix, spAlertID=spAlertID, spThirdPartyZone=spThirdPartyZone, spInterfaceIndex=spInterfaceIndex, collectorUp=collectorUp, spBGPTrapEvent=spBGPTrapEvent, spScriptCommand=spScriptCommand, spRouter=spRouter, spFingerprintName=spFingerprintName, spInetAddressType=spInetAddressType, spDNSObservedMax=spDNSObservedMax, fingerprintFeedback=fingerprintFeedback, cloudSignalingFaultDone=cloudSignalingFaultDone, spFlowspecTimeout=spFlowspecTimeout, spInterfaceUsage=spInterfaceUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spScriptHost=spScriptHost, snmpDown=snmpDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceTotalFlows=deviceTotalFlows, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, licenseErrorDone=licenseErrorDone, spLicenseErrDescription=spLicenseErrDescription, bgpUp=bgpUp, spInterfaceUsageHC=spInterfaceUsageHC, interfaceUsageDone=interfaceUsageDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterface=spInterface, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, reportDone=reportDone, bgpDown=bgpDown, spTMSPrefix=spTMSPrefix, spManagedObjects=spManagedObjects, hardwareFailureDone=hardwareFailureDone, fingerprintUsageDone=fingerprintUsageDone, peakflowSPTraps=peakflowSPTraps, spDetector=spDetector, snmpUp=snmpUp, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spDetectedCountries=spDetectedCountries, spPravail=spPravail, managedObjectUsageDone=managedObjectUsageDone, flowUp=flowUp, spImpactPps=spImpactPps, spFingerprintSender=spFingerprintSender, spGreTunnelDestination=spGreTunnelDestination, mitigationFlowspecStart=mitigationFlowspecStart, spThirdPartyAddr=spThirdPartyAddr, deviceDiskUsage=deviceDiskUsage, spScriptPort=spScriptPort, spCommFailureDescription=spCommFailureDescription, spUsage=spUsage, spUnit=spUnit, interfaceUsage=interfaceUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpTrap=bgpTrap, mitigationTMSStart=mitigationTMSStart, dnsBaseline=dnsBaseline, spImpactBps=spImpactBps, bgpInstability=bgpInstability, spcommFailureDone=spcommFailureDone, mitigationTMSStartV2=mitigationTMSStartV2, bgpHijack=bgpHijack, spHardwareFailureDescription=spHardwareFailureDescription, spDNSName=spDNSName, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationDone=mitigationDone, peakflowSPMIB=peakflowSPMIB, spServiceName=spServiceName, spBGPTrapName=spBGPTrapName, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPCMI=peakflowSPCMI, cloudSignalingFault=cloudSignalingFault, licenseError=licenseError, spHijackRoute=spHijackRoute, spMitigationName=spMitigationName, collectorStart=collectorStart, spUsageType=spUsageType, spDNSObservedMean=spDNSObservedMean, dosHostDetectionAlert=dosHostDetectionAlert, routingFailover=routingFailover, managedObjectUsage=managedObjectUsage, spBlackholePrefix=spBlackholePrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spMitigationStart=spMitigationStart, spInterfaceSpeed=spInterfaceSpeed, greDown=greDown, spManagedObject=spManagedObject, spHijackLocal=spHijackLocal, deviceTotalFlowsHC=deviceTotalFlowsHC, spFingerprintMessage=spFingerprintMessage, spHijackAttr=spHijackAttr, collectorDown=collectorDown, spGreTunnelName=spGreTunnelName, spBGPInstability=spBGPInstability, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrType=spLicenseErrType)
