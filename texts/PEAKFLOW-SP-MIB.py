...
Integer32, ObjectIdentity, Counter32, NotificationType, TimeTicks, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Gauge32, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "TimeTicks", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Gauge32", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", greDown=greDown, spcommFailureDone=spcommFailureDone, routingFailover=routingFailover, deviceHealth=deviceHealth, spHardwareFailureDescription=spHardwareFailureDescription, spUsage=spUsage, spInterface=spInterface, spDNSExpected=spDNSExpected, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpInstabilityDone=bgpInstabilityDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, autoclassifyStart=autoclassifyStart, hardwareFailure=hardwareFailure, spThirdPartyZone=spThirdPartyZone, interfaceUsage=interfaceUsage, spHijackAttr=spHijackAttr, spInetAddress=spInetAddress, spTMSMultiPrefix=spTMSMultiPrefix, spImpactPps=spImpactPps, spCommFailureDescription=spCommFailureDescription, spSystemErrorType=spSystemErrorType, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceSystemError=deviceSystemError, spMitigationStart=spMitigationStart, collectorStart=collectorStart, spVersion=spVersion, spInterfaceUsageHC=spInterfaceUsageHC, snmpDown=snmpDown, peakflowSPTraps=peakflowSPTraps, PYSNMP_MODULE_ID=peakflowSPMIB, spReportName=spReportName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, configChange=configChange, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spReportID=spReportID, interfaceUsageDone=interfaceUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spFingerprintName=spFingerprintName, mitigationFlowspecStart=mitigationFlowspecStart, spServiceElement=spServiceElement, spScriptCommand=spScriptCommand, alertScript=alertScript, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceDiskUsage=deviceDiskUsage, flowDown=flowDown, spImpactBps=spImpactBps, deviceSystemErrorDone=deviceSystemErrorDone, deviceSwapSpace=deviceSwapSpace, spDetectedCountries=spDetectedCountries, spBGPTrapOldAttributes=spBGPTrapOldAttributes, cloudSignalingFaultDone=cloudSignalingFaultDone, spDNSName=spDNSName, spFingerprintMessage=spFingerprintMessage, spGreTunnelName=spGreTunnelName, fingerprintUsageDone=fingerprintUsageDone, spcommFailure=spcommFailure, spBGPInstability=spBGPInstability, spHijackLocal=spHijackLocal, spFlowspecCommunity=spFlowspecCommunity, peakflowSPCMI=peakflowSPCMI, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObservedMean=spDNSObservedMean, dnsBaseline=dnsBaseline, flowUp=flowUp, spServiceName=spServiceName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemory=devicePhysicalMemory, hardwareFailureDone=hardwareFailureDone, dosHostDetectionAlert=dosHostDetectionAlert, spTMSPrefix=spTMSPrefix, spInetAddressType=spInetAddressType, spFlowspecTimeout=spFlowspecTimeout, bgpInstability=bgpInstability, spBGPTrapPrefix=spBGPTrapPrefix, spSystemErrorDescription=spSystemErrorDescription, spMitigationID=spMitigationID, spInterfaceUsage=spInterfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, dnsBaselineDone=dnsBaselineDone, licenseError=licenseError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spReportURL=spReportURL, spDuration=spDuration, deviceTotalFlowsHC=deviceTotalFlowsHC, spFingerprintSender=spFingerprintSender, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spScriptPort=spScriptPort, spBlackholeNexthop=spBlackholeNexthop, trafficAutoMitigation=trafficAutoMitigation, serviceUsage=serviceUsage, spFingerprintFeedback=spFingerprintFeedback, spUsername=spUsername, licenseErrorDone=licenseErrorDone, spManagedObject=spManagedObject, notificationLimit=notificationLimit, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPEvent=spBGPEvent, spThirdPartyAddr=spThirdPartyAddr, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceTotalFlows=deviceTotalFlows, spTMSCommunity=spTMSCommunity, snmpUp=snmpUp, serviceUsageDone=serviceUsageDone, peakflowSPMIB=peakflowSPMIB, bgpTrap=bgpTrap, spMitigationName=spMitigationName, spAlertID=spAlertID, spBlackholeCommunity=spBlackholeCommunity, spScriptStart=spScriptStart, spTMSTimeout=spTMSTimeout, bgpUp=bgpUp, bgpHijack=bgpHijack, managedObjectUsage=managedObjectUsage, mitigationDone=mitigationDone, spBGPTrapEvent=spBGPTrapEvent, spInterfaceIndex=spInterfaceIndex, spCloudSignalFaultDescription=spCloudSignalFaultDescription, greDownDone=greDownDone, spPravail=spPravail, collectorDown=collectorDown, spDetector=spDetector, spBlackholePrefix=spBlackholePrefix, fingerprintFeedback=fingerprintFeedback, fingerprintUsage=fingerprintUsage, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrType=spLicenseErrType, spScriptHost=spScriptHost, spBlackholeTimeout=spBlackholeTimeout, spUnit=spUnit, spLicenseErrDescription=spLicenseErrDescription, spManagedObjects=spManagedObjects, spBGPTrapName=spBGPTrapName, spLicenseErrCount=spLicenseErrCount, spCollector=spCollector, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spHijackRoute=spHijackRoute, spUsageType=spUsageType, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spManagedObjectFamily=spManagedObjectFamily, fingerprintReceive=fingerprintReceive, cloudSignalingFault=cloudSignalingFault, spLicenseErrLimit=spLicenseErrLimit, managedObjectUsageDone=managedObjectUsageDone, spThreshold=spThreshold, mitigationTMSStart=mitigationTMSStart, peakflowSPMgr=peakflowSPMgr, collectorUp=collectorUp, spApplicationName=spApplicationName, bgpDown=bgpDown, spCommFailureDestination=spCommFailureDestination, spGreTunnelDestination=spGreTunnelDestination, spDNSObserved=spDNSObserved, spRouter=spRouter, spDNSObservedMax=spDNSObservedMax, reportDone=reportDone)
