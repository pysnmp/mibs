...
alertSeverity, alertTimeStamp, alertEffect, f5AlertNotificationGroup, f5Alerts, alertDescription, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertTimeStamp", "alertEffect", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", raidEvent=raidEvent, drive_capacity_fault=drive_capacity_fault, cpu_fault=cpu_fault, txPwrHiAlarm=txPwrHiAlarm, txPwrLoAlarm=txPwrLoAlarm, psu_fault=psu_fault, pcie_fault=pcie_fault, ddmVccLoWarn=ddmVccLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, txBiasLoAlarm=txBiasLoAlarm, txPwrHiWarn=txPwrHiWarn, drive_utilization=drive_utilization, txBiasHiWarn=txBiasHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, power_fault=power_fault, txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, firmware_fault=firmware_fault, txBiasHiAlarm=txBiasHiAlarm, f5AlertNotification=f5AlertNotification, service_health=service_health, ddmVccLoAlarm=ddmVccLoAlarm, thermal_fault=thermal_fault, firmware_update_status=firmware_update_status, rxPwrHiAlarm=rxPwrHiAlarm, module_present=module_present, memory_fault=memory_fault, core_dump=core_dump, ddmTempHiAlarm=ddmTempHiAlarm, backplane=backplane, rxPwrHiWarn=rxPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, lcd_fault=lcd_fault, blade_thermal_fault=blade_thermal_fault, aom_fault=aom_fault, blade_hardware_fault=blade_hardware_fault, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempHiWarn=ddmTempHiWarn, rxPwrLoWarn=rxPwrLoWarn, unknown_alarm=unknown_alarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, fipsError=fipsError, drive_thermal_throttle=drive_thermal_throttle, ddmTempLoAlarm=ddmTempLoAlarm, drive_fault=drive_fault, hardware_device_fault=hardware_device_fault)
