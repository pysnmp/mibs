...
alertEffect, f5Alerts, alertSource, alertTimeStamp, alertDescription, f5AlertNotificationGroup, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "f5Alerts", "alertSource", "alertTimeStamp", "alertDescription", "f5AlertNotificationGroup", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", service_health=service_health, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasLoWarn=txBiasLoWarn, memory_fault=memory_fault, module_communication_error=module_communication_error, psu_fault=psu_fault, cpu_fault=cpu_fault, lcd_fault=lcd_fault, f5AlertNotification=f5AlertNotification, module_present=module_present, txPwrLoWarn=txPwrLoWarn, blade_hardware_fault=blade_hardware_fault, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, pcie_fault=pcie_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccLoWarn=ddmVccLoWarn, rxPwrLoWarn=rxPwrLoWarn, hardware_device_fault=hardware_device_fault, blade_thermal_fault=blade_thermal_fault, firmware_fault=firmware_fault, drive_fault=drive_fault, core_dump=core_dump, rxPwrHiWarn=rxPwrHiWarn, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, txBiasHiWarn=txBiasHiWarn, thermal_fault=thermal_fault, drive_utilization=drive_utilization, ddmVccHiAlarm=ddmVccHiAlarm, firmware_update_status=firmware_update_status, power_fault=power_fault, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, unknown_alarm=unknown_alarm, ddmVccHiWarn=ddmVccHiWarn, raidEvent=raidEvent, aom_fault=aom_fault, backplane=backplane, txPwrHiWarn=txPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, drive_thermal_throttle=drive_thermal_throttle, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempHiWarn=ddmTempHiWarn, fipsError=fipsError, drive_capacity_fault=drive_capacity_fault)
