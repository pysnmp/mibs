...
alertSource, f5AlertNotificationGroup, alertTimeStamp, alertEffect, f5Alerts, alertSeverity, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "f5AlertNotificationGroup", "alertTimeStamp", "alertEffect", "f5Alerts", "alertSeverity", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempLoAlarm=ddmTempLoAlarm, blade_thermal_fault=blade_thermal_fault, psu_fault=psu_fault, module_communication_error=module_communication_error, raidEvent=raidEvent, rxPwrHiWarn=rxPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, cpu_fault=cpu_fault, txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, blade_hardware_fault=blade_hardware_fault, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, drive_thermal_throttle=drive_thermal_throttle, drive_utilization=drive_utilization, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrLoWarn=rxPwrLoWarn, txPwrLoAlarm=txPwrLoAlarm, lcd_fault=lcd_fault, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, aom_fault=aom_fault, hardware_device_fault=hardware_device_fault, unknown_alarm=unknown_alarm, firmware_fault=firmware_fault, module_present=module_present, txBiasLoAlarm=txBiasLoAlarm, drive_fault=drive_fault, PYSNMP_MODULE_ID=f5AlertNotification, backplane=backplane, f5AlertNotification=f5AlertNotification, fipsError=fipsError, rxPwrHiAlarm=rxPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, memory_fault=memory_fault, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempHiWarn=ddmTempHiWarn, thermal_fault=thermal_fault, firmware_update_status=firmware_update_status, txPwrLoWarn=txPwrLoWarn, power_fault=power_fault, txPwrHiWarn=txPwrHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, service_health=service_health)
