...
alertSource, alertTimeStamp, alertSeverity, f5AlertNotificationGroup, f5Alerts, alertDescription, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertTimeStamp", "alertSeverity", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasHiWarn=txBiasHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempLoWarn=ddmTempLoWarn, psu_fault=psu_fault, ddmVccLoAlarm=ddmVccLoAlarm, txPwrHiWarn=txPwrHiWarn, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, ddmVccHiAlarm=ddmVccHiAlarm, txPwrHiAlarm=txPwrHiAlarm, rxPwrHiWarn=rxPwrHiWarn, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, fipsError=fipsError, ddmVccHiWarn=ddmVccHiWarn, power_fault=power_fault, unknown_alarm=unknown_alarm, rxPwrLoAlarm=rxPwrLoAlarm, aom_fault=aom_fault, firmware_update_status=firmware_update_status, service_health=service_health, backplane=backplane, blade_thermal_fault=blade_thermal_fault, memory_fault=memory_fault, cpu_fault=cpu_fault, ddmTempHiWarn=ddmTempHiWarn, drive_fault=drive_fault, module_communication_error=module_communication_error, txBiasLoWarn=txBiasLoWarn, rxPwrLoWarn=rxPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoWarn=ddmVccLoWarn, txBiasLoAlarm=txBiasLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, hardware_device_fault=hardware_device_fault, txPwrLoWarn=txPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, drive_capacity_fault=drive_capacity_fault, blade_hardware_fault=blade_hardware_fault, core_dump=core_dump, txPwrLoAlarm=txPwrLoAlarm, firmware_fault=firmware_fault, drive_utilization=drive_utilization, thermal_fault=thermal_fault, module_present=module_present)
