...
alertTimeStamp, alertEffect, alertSeverity, f5AlertNotificationGroup, alertDescription, alertSource, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertEffect", "alertSeverity", "f5AlertNotificationGroup", "alertDescription", "alertSource", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasHiAlarm=txBiasHiAlarm, txBiasHiWarn=txBiasHiWarn, blade_thermal_fault=blade_thermal_fault, ddmVccHiAlarm=ddmVccHiAlarm, module_communication_error=module_communication_error, rxPwrHiAlarm=rxPwrHiAlarm, firmware_update_status=firmware_update_status, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, aom_fault=aom_fault, drive_utilization=drive_utilization, blade_hardware_fault=blade_hardware_fault, thermal_fault=thermal_fault, psu_fault=psu_fault, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, unknown_alarm=unknown_alarm, ddmVccLoWarn=ddmVccLoWarn, txPwrHiWarn=txPwrHiWarn, drive_capacity_fault=drive_capacity_fault, cpu_fault=cpu_fault, fipsError=fipsError, txPwrHiAlarm=txPwrHiAlarm, module_present=module_present, backplane=backplane, hardware_device_fault=hardware_device_fault, f5AlertNotification=f5AlertNotification, firmware_fault=firmware_fault, power_fault=power_fault, core_dump=core_dump, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrHiWarn=rxPwrHiWarn, raidEvent=raidEvent, pcie_fault=pcie_fault, service_health=service_health, ddmTempHiAlarm=ddmTempHiAlarm, lcd_fault=lcd_fault, txPwrLoWarn=txPwrLoWarn, txBiasLoWarn=txBiasLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, txBiasLoAlarm=txBiasLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, memory_fault=memory_fault, ddmVccHiWarn=ddmVccHiWarn, drive_thermal_throttle=drive_thermal_throttle, ddmTempLoWarn=ddmTempLoWarn, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm)
