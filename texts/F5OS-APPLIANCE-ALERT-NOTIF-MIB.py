...
alertDescription, alertEffect, f5AlertNotificationGroup, alertTimeStamp, alertSource, f5Alerts, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertEffect", "f5AlertNotificationGroup", "alertTimeStamp", "alertSource", "f5Alerts", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", firmware_update_status=firmware_update_status, blade_hardware_fault=blade_hardware_fault, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, txPwrHiWarn=txPwrHiWarn, module_present=module_present, firmware_fault=firmware_fault, ddmTempHiAlarm=ddmTempHiAlarm, cpu_fault=cpu_fault, power_fault=power_fault, drive_capacity_fault=drive_capacity_fault, txBiasLoAlarm=txBiasLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrLoWarn=rxPwrLoWarn, fipsError=fipsError, txBiasLoWarn=txBiasLoWarn, txPwrHiAlarm=txPwrHiAlarm, memory_fault=memory_fault, lcd_fault=lcd_fault, rxPwrHiWarn=rxPwrHiWarn, backplane=backplane, ddmVccHiAlarm=ddmVccHiAlarm, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, txPwrLoWarn=txPwrLoWarn, f5AlertNotification=f5AlertNotification, ddmTempLoWarn=ddmTempLoWarn, core_dump=core_dump, drive_thermal_throttle=drive_thermal_throttle, raidEvent=raidEvent, ddmVccLoWarn=ddmVccLoWarn, blade_thermal_fault=blade_thermal_fault, hardware_device_fault=hardware_device_fault, thermal_fault=thermal_fault, drive_utilization=drive_utilization, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, pcie_fault=pcie_fault, unknown_alarm=unknown_alarm, ddmTempLoAlarm=ddmTempLoAlarm, service_health=service_health, ddmVccHiWarn=ddmVccHiWarn, txBiasHiWarn=txBiasHiWarn, aom_fault=aom_fault, module_communication_error=module_communication_error, f5AlertsNotifyGroup=f5AlertsNotifyGroup, psu_fault=psu_fault, drive_fault=drive_fault)
