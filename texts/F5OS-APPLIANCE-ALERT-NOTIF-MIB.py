...
alertDescription, alertTimeStamp, f5Alerts, alertEffect, f5AlertNotificationGroup, alertSeverity, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertTimeStamp", "f5Alerts", "alertEffect", "f5AlertNotificationGroup", "alertSeverity", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", thermal_fault=thermal_fault, module_present=module_present, txPwrHiWarn=txPwrHiWarn, aom_fault=aom_fault, firmware_update_status=firmware_update_status, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, lcd_fault=lcd_fault, f5AlertNotification=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, cpu_fault=cpu_fault, drive_thermal_throttle=drive_thermal_throttle, core_dump=core_dump, txBiasLoAlarm=txBiasLoAlarm, drive_utilization=drive_utilization, psu_fault=psu_fault, ddmTempLoWarn=ddmTempLoWarn, txPwrLoWarn=txPwrLoWarn, ddmVccHiWarn=ddmVccHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_fault=drive_fault, txBiasHiAlarm=txBiasHiAlarm, power_fault=power_fault, unknown_alarm=unknown_alarm, drive_capacity_fault=drive_capacity_fault, fipsError=fipsError, service_health=service_health, ddmVccHiAlarm=ddmVccHiAlarm, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, firmware_fault=firmware_fault, rxPwrLoWarn=rxPwrLoWarn, blade_thermal_fault=blade_thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrHiWarn=rxPwrHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, raidEvent=raidEvent, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, hardware_device_fault=hardware_device_fault, blade_hardware_fault=blade_hardware_fault, module_communication_error=module_communication_error, txBiasLoWarn=txBiasLoWarn, backplane=backplane, txPwrHiAlarm=txPwrHiAlarm)
