...
alertTimeStamp, alertSource, alertDescription, f5Alerts, alertSeverity, alertEffect, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSource", "alertDescription", "f5Alerts", "alertSeverity", "alertEffect", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", module_communication_error=module_communication_error, firmware_update_status=firmware_update_status, rxPwrHiAlarm=rxPwrHiAlarm, fipsError=fipsError, firmware_fault=firmware_fault, blade_thermal_fault=blade_thermal_fault, unknown_alarm=unknown_alarm, drive_thermal_throttle=drive_thermal_throttle, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, lcd_fault=lcd_fault, ddmTempHiAlarm=ddmTempHiAlarm, hardware_device_fault=hardware_device_fault, pcie_fault=pcie_fault, psu_fault=psu_fault, module_present=module_present, f5AlertNotification=f5AlertNotification, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, power_fault=power_fault, txBiasHiWarn=txBiasHiWarn, txPwrLoWarn=txPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, raidEvent=raidEvent, service_health=service_health, memory_fault=memory_fault, ddmTempLoWarn=ddmTempLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, txPwrLoAlarm=txPwrLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, txBiasLoWarn=txBiasLoWarn, aom_fault=aom_fault, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, core_dump=core_dump, drive_fault=drive_fault, rxPwrHiWarn=rxPwrHiWarn, backplane=backplane, txPwrHiWarn=txPwrHiWarn, ddmVccLoWarn=ddmVccLoWarn, drive_capacity_fault=drive_capacity_fault, thermal_fault=thermal_fault, ddmVccHiWarn=ddmVccHiWarn, blade_hardware_fault=blade_hardware_fault)
