...
f5AlertNotificationGroup, alertSource, alertSeverity, alertEffect, f5Alerts, alertTimeStamp, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSource", "alertSeverity", "alertEffect", "f5Alerts", "alertTimeStamp", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertNotification=f5AlertNotification, drive_utilization=drive_utilization, firmware_update_status=firmware_update_status, ddmTempLoAlarm=ddmTempLoAlarm, hardware_device_fault=hardware_device_fault, drive_thermal_throttle=drive_thermal_throttle, service_health=service_health, power_fault=power_fault, drive_fault=drive_fault, lcd_fault=lcd_fault, pcie_fault=pcie_fault, txBiasHiWarn=txBiasHiWarn, txPwrLoAlarm=txPwrLoAlarm, blade_thermal_fault=blade_thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, drive_capacity_fault=drive_capacity_fault, ddmTempHiWarn=ddmTempHiWarn, txPwrLoWarn=txPwrLoWarn, aom_fault=aom_fault, firmware_fault=firmware_fault, fipsError=fipsError, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiWarn=ddmVccHiWarn, blade_hardware_fault=blade_hardware_fault, txPwrHiAlarm=txPwrHiAlarm, psu_fault=psu_fault, module_present=module_present, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, backplane=backplane, cpu_fault=cpu_fault, txPwrHiWarn=txPwrHiWarn, unknown_alarm=unknown_alarm, ddmVccHiAlarm=ddmVccHiAlarm, thermal_fault=thermal_fault, ddmVccLoWarn=ddmVccLoWarn, txBiasHiAlarm=txBiasHiAlarm, ddmTempLoWarn=ddmTempLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrHiWarn=rxPwrHiWarn, module_communication_error=module_communication_error, core_dump=core_dump, raidEvent=raidEvent, memory_fault=memory_fault, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrLoWarn=rxPwrLoWarn)
