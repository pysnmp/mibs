...
alertDescription, alertSource, alertSeverity, f5AlertNotificationGroup, alertTimeStamp, f5Alerts, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSource", "alertSeverity", "f5AlertNotificationGroup", "alertTimeStamp", "f5Alerts", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, ddmTempHiWarn=ddmTempHiWarn, txPwrHiWarn=txPwrHiWarn, lcd_fault=lcd_fault, raidEvent=raidEvent, f5AlertNotification=f5AlertNotification, txBiasHiAlarm=txBiasHiAlarm, core_dump=core_dump, firmware_update_status=firmware_update_status, txBiasLoAlarm=txBiasLoAlarm, service_health=service_health, txPwrLoAlarm=txPwrLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoWarn=ddmTempLoWarn, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, aom_fault=aom_fault, firmware_fault=firmware_fault, txBiasHiWarn=txBiasHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, power_fault=power_fault, rxPwrLoWarn=rxPwrLoWarn, blade_hardware_fault=blade_hardware_fault, PYSNMP_MODULE_ID=f5AlertNotification, drive_fault=drive_fault, rxPwrHiWarn=rxPwrHiWarn, psu_fault=psu_fault, txPwrHiAlarm=txPwrHiAlarm, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, module_present=module_present, ddmVccHiAlarm=ddmVccHiAlarm, pcie_fault=pcie_fault, thermal_fault=thermal_fault, txPwrLoWarn=txPwrLoWarn, drive_thermal_throttle=drive_thermal_throttle, hardware_device_fault=hardware_device_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, ddmVccHiWarn=ddmVccHiWarn, module_communication_error=module_communication_error, cpu_fault=cpu_fault, blade_thermal_fault=blade_thermal_fault, backplane=backplane, drive_capacity_fault=drive_capacity_fault)
