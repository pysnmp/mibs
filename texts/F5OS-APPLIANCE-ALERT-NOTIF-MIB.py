...
f5Alerts, f5AlertNotificationGroup, alertDescription, alertTimeStamp, alertSeverity, alertSource, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "f5AlertNotificationGroup", "alertDescription", "alertTimeStamp", "alertSeverity", "alertSource", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccHiAlarm=ddmVccHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, core_dump=core_dump, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiWarn=txBiasHiWarn, ddmTempLoWarn=ddmTempLoWarn, f5AlertNotification=f5AlertNotification, ddmTempLoAlarm=ddmTempLoAlarm, thermal_fault=thermal_fault, lcd_fault=lcd_fault, txBiasLoWarn=txBiasLoWarn, firmware_update_status=firmware_update_status, aom_fault=aom_fault, module_communication_error=module_communication_error, raidEvent=raidEvent, service_health=service_health, ddmTempHiAlarm=ddmTempHiAlarm, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, txPwrHiAlarm=txPwrHiAlarm, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault, firmware_fault=firmware_fault, fipsError=fipsError, rxPwrLoWarn=rxPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, drive_fault=drive_fault, backplane=backplane, module_present=module_present, drive_utilization=drive_utilization, hardware_device_fault=hardware_device_fault, power_fault=power_fault, unknown_alarm=unknown_alarm, psu_fault=psu_fault, ddmVccLoWarn=ddmVccLoWarn, ddmVccHiWarn=ddmVccHiWarn, txPwrLoAlarm=txPwrLoAlarm, blade_thermal_fault=blade_thermal_fault, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiWarn=ddmTempHiWarn, cpu_fault=cpu_fault, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm)
