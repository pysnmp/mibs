...
alertSource, alertTimeStamp, f5Alerts, f5AlertNotificationGroup, alertSeverity, alertEffect, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertTimeStamp", "f5Alerts", "f5AlertNotificationGroup", "alertSeverity", "alertEffect", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", power_fault=power_fault, txBiasHiAlarm=txBiasHiAlarm, lcd_fault=lcd_fault, rxPwrHiWarn=rxPwrHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, cpu_fault=cpu_fault, drive_thermal_throttle=drive_thermal_throttle, module_communication_error=module_communication_error, txPwrLoAlarm=txPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, core_dump=core_dump, rxPwrLoWarn=rxPwrLoWarn, f5AlertNotification=f5AlertNotification, drive_fault=drive_fault, ddmVccLoWarn=ddmVccLoWarn, hardware_device_fault=hardware_device_fault, memory_fault=memory_fault, pcie_fault=pcie_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccLoAlarm=ddmVccLoAlarm, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, aom_fault=aom_fault, psu_fault=psu_fault, txBiasLoWarn=txBiasLoWarn, txPwrHiWarn=txPwrHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, txPwrLoWarn=txPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, thermal_fault=thermal_fault, drive_utilization=drive_utilization, drive_capacity_fault=drive_capacity_fault, ddmTempHiWarn=ddmTempHiWarn, module_present=module_present, blade_hardware_fault=blade_hardware_fault, raidEvent=raidEvent, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, firmware_fault=firmware_fault, backplane=backplane, unknown_alarm=unknown_alarm, ddmTempHiAlarm=ddmTempHiAlarm, blade_thermal_fault=blade_thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccHiWarn=ddmVccHiWarn, ddmTempLoWarn=ddmTempLoWarn, service_health=service_health, firmware_update_status=firmware_update_status)
