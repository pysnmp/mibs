...
alertDescription, f5AlertNotificationGroup, alertTimeStamp, f5Alerts, alertSeverity, alertSource, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "f5AlertNotificationGroup", "alertTimeStamp", "f5Alerts", "alertSeverity", "alertSource", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, txBiasHiAlarm=txBiasHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, aom_fault=aom_fault, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertNotification=f5AlertNotification, blade_hardware_fault=blade_hardware_fault, drive_utilization=drive_utilization, ddmTempLoWarn=ddmTempLoWarn, power_fault=power_fault, backplane=backplane, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, pcie_fault=pcie_fault, thermal_fault=thermal_fault, service_health=service_health, firmware_fault=firmware_fault, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoWarn=ddmVccLoWarn, drive_capacity_fault=drive_capacity_fault, cpu_fault=cpu_fault, rxPwrLoAlarm=rxPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, lcd_fault=lcd_fault, rxPwrHiAlarm=rxPwrHiAlarm, module_communication_error=module_communication_error, fipsError=fipsError, drive_fault=drive_fault, hardware_device_fault=hardware_device_fault, txBiasHiWarn=txBiasHiWarn, txPwrHiAlarm=txPwrHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, ddmVccHiWarn=ddmVccHiWarn, txPwrHiWarn=txPwrHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, unknown_alarm=unknown_alarm, drive_thermal_throttle=drive_thermal_throttle, blade_thermal_fault=blade_thermal_fault, module_present=module_present, txPwrLoAlarm=txPwrLoAlarm, psu_fault=psu_fault, core_dump=core_dump, txBiasLoAlarm=txBiasLoAlarm, firmware_update_status=firmware_update_status, ddmTempHiAlarm=ddmTempHiAlarm, raidEvent=raidEvent, memory_fault=memory_fault)
