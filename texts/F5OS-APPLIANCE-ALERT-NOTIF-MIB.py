...
alertTimeStamp, alertDescription, alertSource, alertEffect, f5AlertNotificationGroup, f5Alerts, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertDescription", "alertSource", "alertEffect", "f5AlertNotificationGroup", "f5Alerts", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", firmware_fault=firmware_fault, drive_thermal_throttle=drive_thermal_throttle, module_communication_error=module_communication_error, rxPwrHiAlarm=rxPwrHiAlarm, backplane=backplane, ddmTempHiAlarm=ddmTempHiAlarm, power_fault=power_fault, ddmTempHiWarn=ddmTempHiWarn, txBiasHiAlarm=txBiasHiAlarm, lcd_fault=lcd_fault, drive_capacity_fault=drive_capacity_fault, service_health=service_health, unknown_alarm=unknown_alarm, ddmTempLoAlarm=ddmTempLoAlarm, raidEvent=raidEvent, pcie_fault=pcie_fault, ddmTempLoWarn=ddmTempLoWarn, cpu_fault=cpu_fault, ddmVccHiWarn=ddmVccHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, blade_thermal_fault=blade_thermal_fault, firmware_update_status=firmware_update_status, txBiasLoWarn=txBiasLoWarn, aom_fault=aom_fault, txPwrHiAlarm=txPwrHiAlarm, hardware_device_fault=hardware_device_fault, txPwrLoAlarm=txPwrLoAlarm, drive_utilization=drive_utilization, ddmVccLoAlarm=ddmVccLoAlarm, memory_fault=memory_fault, drive_fault=drive_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasLoAlarm=txBiasLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, fipsError=fipsError, blade_hardware_fault=blade_hardware_fault, txPwrHiWarn=txPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, core_dump=core_dump, module_present=module_present, txBiasHiWarn=txBiasHiWarn, thermal_fault=thermal_fault, ddmVccLoWarn=ddmVccLoWarn, txPwrLoWarn=txPwrLoWarn, f5AlertNotification=f5AlertNotification, rxPwrHiWarn=rxPwrHiWarn, psu_fault=psu_fault, PYSNMP_MODULE_ID=f5AlertNotification)
