...
alertSource, alertTimeStamp, alertDescription, f5Alerts, alertSeverity, f5AlertNotificationGroup, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertTimeStamp", "alertDescription", "f5Alerts", "alertSeverity", "f5AlertNotificationGroup", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, lcd_fault=lcd_fault, aom_fault=aom_fault, rxPwrLoAlarm=rxPwrLoAlarm, core_dump=core_dump, drive_thermal_throttle=drive_thermal_throttle, pcie_fault=pcie_fault, backplane=backplane, ddmTempHiAlarm=ddmTempHiAlarm, txPwrHiWarn=txPwrHiWarn, blade_hardware_fault=blade_hardware_fault, firmware_update_status=firmware_update_status, psu_fault=psu_fault, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, txPwrLoAlarm=txPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, drive_capacity_fault=drive_capacity_fault, txBiasHiAlarm=txBiasHiAlarm, raidEvent=raidEvent, ddmVccLoWarn=ddmVccLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, module_communication_error=module_communication_error, thermal_fault=thermal_fault, fipsError=fipsError, drive_utilization=drive_utilization, service_health=service_health, PYSNMP_MODULE_ID=f5AlertNotification, unknown_alarm=unknown_alarm, rxPwrHiWarn=rxPwrHiWarn, blade_thermal_fault=blade_thermal_fault, drive_fault=drive_fault, txBiasLoAlarm=txBiasLoAlarm, firmware_fault=firmware_fault, txBiasHiWarn=txBiasHiWarn, module_present=module_present, f5AlertNotification=f5AlertNotification, power_fault=power_fault, hardware_device_fault=hardware_device_fault, ddmVccHiWarn=ddmVccHiWarn)
