...
f5Alerts, alertTimeStamp, alertDescription, alertEffect, f5AlertNotificationGroup, alertSource, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertTimeStamp", "alertDescription", "alertEffect", "f5AlertNotificationGroup", "alertSource", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrLoAlarm=txPwrLoAlarm, psu_fault=psu_fault, drive_utilization=drive_utilization, backplane=backplane, txBiasLoAlarm=txBiasLoAlarm, txPwrHiAlarm=txPwrHiAlarm, rxPwrHiAlarm=rxPwrHiAlarm, memory_fault=memory_fault, firmware_update_status=firmware_update_status, unknown_alarm=unknown_alarm, blade_hardware_fault=blade_hardware_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, blade_thermal_fault=blade_thermal_fault, lcd_fault=lcd_fault, ddmTempLoAlarm=ddmTempLoAlarm, module_communication_error=module_communication_error, ddmTempHiWarn=ddmTempHiWarn, service_health=service_health, power_fault=power_fault, module_present=module_present, txPwrLoWarn=txPwrLoWarn, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoWarn=ddmVccLoWarn, f5AlertNotification=f5AlertNotification, rxPwrLoWarn=rxPwrLoWarn, txBiasLoWarn=txBiasLoWarn, hardware_device_fault=hardware_device_fault, ddmTempLoWarn=ddmTempLoWarn, core_dump=core_dump, drive_thermal_throttle=drive_thermal_throttle, txPwrHiWarn=txPwrHiWarn, rxPwrHiWarn=rxPwrHiWarn, txBiasHiAlarm=txBiasHiAlarm, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, fipsError=fipsError, f5AlertsNotifyGroup=f5AlertsNotifyGroup, raidEvent=raidEvent, ddmVccHiAlarm=ddmVccHiAlarm, drive_capacity_fault=drive_capacity_fault, drive_fault=drive_fault, firmware_fault=firmware_fault, thermal_fault=thermal_fault, aom_fault=aom_fault, cpu_fault=cpu_fault)
