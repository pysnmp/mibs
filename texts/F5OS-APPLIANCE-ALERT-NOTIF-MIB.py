...
alertDescription, alertEffect, alertTimeStamp, alertSeverity, alertSource, f5Alerts, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertEffect", "alertTimeStamp", "alertSeverity", "alertSource", "f5Alerts", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, ddmTempLoAlarm=ddmTempLoAlarm, fipsError=fipsError, module_present=module_present, module_communication_error=module_communication_error, ddmVccLoWarn=ddmVccLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, hardware_device_fault=hardware_device_fault, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiAlarm=rxPwrHiAlarm, txPwrHiAlarm=txPwrHiAlarm, service_health=service_health, power_fault=power_fault, psu_fault=psu_fault, rxPwrLoWarn=rxPwrLoWarn, firmware_fault=firmware_fault, txPwrLoWarn=txPwrLoWarn, txBiasHiWarn=txBiasHiWarn, aom_fault=aom_fault, txPwrHiWarn=txPwrHiWarn, lcd_fault=lcd_fault, txBiasLoWarn=txBiasLoWarn, drive_capacity_fault=drive_capacity_fault, ddmVccHiWarn=ddmVccHiWarn, drive_fault=drive_fault, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertNotification=f5AlertNotification, firmware_update_status=firmware_update_status, rxPwrHiWarn=rxPwrHiWarn, txBiasHiAlarm=txBiasHiAlarm, ddmTempLoWarn=ddmTempLoWarn, cpu_fault=cpu_fault, txBiasLoAlarm=txBiasLoAlarm, blade_thermal_fault=blade_thermal_fault, raidEvent=raidEvent, backplane=backplane, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, core_dump=core_dump, blade_hardware_fault=blade_hardware_fault, unknown_alarm=unknown_alarm, drive_utilization=drive_utilization, thermal_fault=thermal_fault, ddmVccHiAlarm=ddmVccHiAlarm, memory_fault=memory_fault)
