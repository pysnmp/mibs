...
alertSeverity, alertTimeStamp, alertEffect, f5AlertNotificationGroup, alertDescription, f5Alerts, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertTimeStamp", "alertEffect", "f5AlertNotificationGroup", "alertDescription", "f5Alerts", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", backplane=backplane, service_health=service_health, ddmVccLoAlarm=ddmVccLoAlarm, thermal_fault=thermal_fault, rxPwrLoWarn=rxPwrLoWarn, lcd_fault=lcd_fault, module_communication_error=module_communication_error, ddmVccHiWarn=ddmVccHiWarn, ddmTempHiWarn=ddmTempHiWarn, raidEvent=raidEvent, ddmTempLoWarn=ddmTempLoWarn, txPwrLoAlarm=txPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, f5AlertNotification=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoWarn=ddmVccLoWarn, memory_fault=memory_fault, fipsError=fipsError, ddmVccHiAlarm=ddmVccHiAlarm, drive_fault=drive_fault, txPwrHiWarn=txPwrHiWarn, drive_capacity_fault=drive_capacity_fault, firmware_update_status=firmware_update_status, hardware_device_fault=hardware_device_fault, unknown_alarm=unknown_alarm, txBiasLoWarn=txBiasLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, aom_fault=aom_fault, module_present=module_present, psu_fault=psu_fault, drive_thermal_throttle=drive_thermal_throttle, blade_thermal_fault=blade_thermal_fault, blade_hardware_fault=blade_hardware_fault, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, power_fault=power_fault, core_dump=core_dump, txBiasHiAlarm=txBiasHiAlarm, pcie_fault=pcie_fault, cpu_fault=cpu_fault, rxPwrHiAlarm=rxPwrHiAlarm, firmware_fault=firmware_fault, txBiasLoAlarm=txBiasLoAlarm, txPwrHiAlarm=txPwrHiAlarm)
