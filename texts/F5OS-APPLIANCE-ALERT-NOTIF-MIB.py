...
f5AlertNotificationGroup, f5Alerts, alertDescription, alertTimeStamp, alertSeverity, alertEffect, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertTimeStamp", "alertSeverity", "alertEffect", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrLoWarn=rxPwrLoWarn, drive_capacity_fault=drive_capacity_fault, rxPwrHiWarn=rxPwrHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, raidEvent=raidEvent, PYSNMP_MODULE_ID=f5AlertNotification, blade_hardware_fault=blade_hardware_fault, drive_utilization=drive_utilization, txBiasHiWarn=txBiasHiWarn, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm, ddmTempLoWarn=ddmTempLoWarn, cpu_fault=cpu_fault, core_dump=core_dump, lcd_fault=lcd_fault, memory_fault=memory_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, hardware_device_fault=hardware_device_fault, rxPwrLoAlarm=rxPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, thermal_fault=thermal_fault, blade_thermal_fault=blade_thermal_fault, psu_fault=psu_fault, service_health=service_health, ddmVccLoWarn=ddmVccLoWarn, aom_fault=aom_fault, fipsError=fipsError, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, module_communication_error=module_communication_error, firmware_fault=firmware_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasLoWarn=txBiasLoWarn, module_present=module_present, firmware_update_status=firmware_update_status, backplane=backplane, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, unknown_alarm=unknown_alarm, txPwrHiWarn=txPwrHiWarn, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, power_fault=power_fault)
