...
f5Alerts, f5AlertNotificationGroup, alertEffect, alertDescription, alertSeverity, alertSource, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "f5AlertNotificationGroup", "alertEffect", "alertDescription", "alertSeverity", "alertSource", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiAlarm=rxPwrHiAlarm, module_communication_error=module_communication_error, ddmTempLoWarn=ddmTempLoWarn, txBiasLoWarn=txBiasLoWarn, core_dump=core_dump, ddmVccHiAlarm=ddmVccHiAlarm, drive_fault=drive_fault, fipsError=fipsError, service_health=service_health, PYSNMP_MODULE_ID=f5AlertNotification, txBiasHiAlarm=txBiasHiAlarm, txPwrLoWarn=txPwrLoWarn, ddmTempHiWarn=ddmTempHiWarn, drive_capacity_fault=drive_capacity_fault, lcd_fault=lcd_fault, ddmVccLoAlarm=ddmVccLoAlarm, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, f5AlertNotification=f5AlertNotification, aom_fault=aom_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, unknown_alarm=unknown_alarm, thermal_fault=thermal_fault, psu_fault=psu_fault, pcie_fault=pcie_fault, blade_thermal_fault=blade_thermal_fault, txBiasLoAlarm=txBiasLoAlarm, ddmVccLoWarn=ddmVccLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, drive_thermal_throttle=drive_thermal_throttle, txPwrLoAlarm=txPwrLoAlarm, blade_hardware_fault=blade_hardware_fault, module_present=module_present, cpu_fault=cpu_fault, backplane=backplane, ddmVccHiWarn=ddmVccHiWarn, txPwrHiWarn=txPwrHiWarn, firmware_update_status=firmware_update_status, txBiasHiWarn=txBiasHiWarn, txPwrHiAlarm=txPwrHiAlarm, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault, raidEvent=raidEvent, power_fault=power_fault, ddmTempLoAlarm=ddmTempLoAlarm, hardware_device_fault=hardware_device_fault, firmware_fault=firmware_fault)
