...
f5Alerts, alertDescription, alertEffect, alertSeverity, alertTimeStamp, f5AlertNotificationGroup, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertDescription", "alertEffect", "alertSeverity", "alertTimeStamp", "f5AlertNotificationGroup", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_utilization=drive_utilization, power_fault=power_fault, rxPwrHiAlarm=rxPwrHiAlarm, psu_fault=psu_fault, txBiasLoWarn=txBiasLoWarn, f5AlertNotification=f5AlertNotification, memory_fault=memory_fault, raidEvent=raidEvent, pcie_fault=pcie_fault, txBiasHiAlarm=txBiasHiAlarm, backplane=backplane, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccLoAlarm=ddmVccLoAlarm, lcd_fault=lcd_fault, ddmVccHiWarn=ddmVccHiWarn, fipsError=fipsError, thermal_fault=thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, service_health=service_health, cpu_fault=cpu_fault, core_dump=core_dump, module_communication_error=module_communication_error, txBiasHiWarn=txBiasHiWarn, rxPwrHiWarn=rxPwrHiWarn, firmware_update_status=firmware_update_status, firmware_fault=firmware_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoWarn=ddmTempLoWarn, txPwrHiWarn=txPwrHiWarn, unknown_alarm=unknown_alarm, drive_thermal_throttle=drive_thermal_throttle, blade_thermal_fault=blade_thermal_fault, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, drive_fault=drive_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccLoWarn=ddmVccLoWarn, module_present=module_present, aom_fault=aom_fault, ddmTempHiAlarm=ddmTempHiAlarm, blade_hardware_fault=blade_hardware_fault, rxPwrLoWarn=rxPwrLoWarn, drive_capacity_fault=drive_capacity_fault, hardware_device_fault=hardware_device_fault, txPwrLoAlarm=txPwrLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, txPwrLoWarn=txPwrLoWarn)
