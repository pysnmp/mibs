...
f5AlertNotificationGroup, alertSeverity, alertEffect, alertSource, alertDescription, alertTimeStamp, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "alertEffect", "alertSource", "alertDescription", "alertTimeStamp", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempLoWarn=ddmTempLoWarn, psu_fault=psu_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccHiWarn=ddmVccHiWarn, aom_fault=aom_fault, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, rxPwrLoWarn=rxPwrLoWarn, txPwrLoAlarm=txPwrLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, hardware_device_fault=hardware_device_fault, service_health=service_health, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, fipsError=fipsError, memory_fault=memory_fault, rxPwrHiAlarm=rxPwrHiAlarm, f5AlertNotification=f5AlertNotification, firmware_update_status=firmware_update_status, drive_utilization=drive_utilization, txPwrHiAlarm=txPwrHiAlarm, thermal_fault=thermal_fault, module_present=module_present, txPwrLoWarn=txPwrLoWarn, power_fault=power_fault, txPwrHiWarn=txPwrHiWarn, blade_thermal_fault=blade_thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, raidEvent=raidEvent, backplane=backplane, txBiasHiWarn=txBiasHiWarn, core_dump=core_dump, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, drive_fault=drive_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_capacity_fault=drive_capacity_fault, firmware_fault=firmware_fault, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, cpu_fault=cpu_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempHiWarn=ddmTempHiWarn, pcie_fault=pcie_fault, module_communication_error=module_communication_error, rxPwrHiWarn=rxPwrHiWarn)
