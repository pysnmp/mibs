...
alertDescription, alertSeverity, alertTimeStamp, alertEffect, alertSource, f5AlertNotificationGroup, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSeverity", "alertTimeStamp", "alertEffect", "alertSource", "f5AlertNotificationGroup", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_utilization=drive_utilization, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm, raidEvent=raidEvent, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, lcd_fault=lcd_fault, module_communication_error=module_communication_error, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, power_fault=power_fault, ddmTempLoWarn=ddmTempLoWarn, service_health=service_health, txBiasLoWarn=txBiasLoWarn, txPwrHiWarn=txPwrHiWarn, blade_thermal_fault=blade_thermal_fault, txPwrHiAlarm=txPwrHiAlarm, memory_fault=memory_fault, ddmTempLoAlarm=ddmTempLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, hardware_device_fault=hardware_device_fault, rxPwrLoWarn=rxPwrLoWarn, txPwrLoWarn=txPwrLoWarn, thermal_fault=thermal_fault, ddmVccLoAlarm=ddmVccLoAlarm, module_present=module_present, core_dump=core_dump, blade_hardware_fault=blade_hardware_fault, backplane=backplane, rxPwrHiWarn=rxPwrHiWarn, cpu_fault=cpu_fault, rxPwrHiAlarm=rxPwrHiAlarm, drive_thermal_throttle=drive_thermal_throttle, firmware_fault=firmware_fault, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, psu_fault=psu_fault, ddmVccHiAlarm=ddmVccHiAlarm, fipsError=fipsError, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrLoAlarm=rxPwrLoAlarm, firmware_update_status=firmware_update_status, aom_fault=aom_fault, txBiasHiWarn=txBiasHiWarn)
