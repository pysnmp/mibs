...
alertDescription, f5Alerts, alertSeverity, alertSource, alertTimeStamp, alertEffect, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "f5Alerts", "alertSeverity", "alertSource", "alertTimeStamp", "alertEffect", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccHiAlarm=ddmVccHiAlarm, f5AlertNotification=f5AlertNotification, PYSNMP_MODULE_ID=f5AlertNotification, backplane=backplane, txPwrHiWarn=txPwrHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, ddmVccLoWarn=ddmVccLoWarn, fipsError=fipsError, memory_fault=memory_fault, firmware_fault=firmware_fault, power_fault=power_fault, module_communication_error=module_communication_error, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiWarn=ddmVccHiWarn, thermal_fault=thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, drive_fault=drive_fault, pcie_fault=pcie_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoWarn=ddmTempLoWarn, txBiasLoWarn=txBiasLoWarn, module_present=module_present, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, drive_thermal_throttle=drive_thermal_throttle, rxPwrLoWarn=rxPwrLoWarn, blade_hardware_fault=blade_hardware_fault, psu_fault=psu_fault, service_health=service_health, txBiasHiWarn=txBiasHiWarn, cpu_fault=cpu_fault, drive_capacity_fault=drive_capacity_fault, ddmTempLoAlarm=ddmTempLoAlarm, raidEvent=raidEvent, drive_utilization=drive_utilization, rxPwrHiWarn=rxPwrHiWarn, txPwrLoWarn=txPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, unknown_alarm=unknown_alarm, txPwrHiAlarm=txPwrHiAlarm, aom_fault=aom_fault, blade_thermal_fault=blade_thermal_fault, firmware_update_status=firmware_update_status, core_dump=core_dump, ddmTempHiAlarm=ddmTempHiAlarm, hardware_device_fault=hardware_device_fault, txPwrLoAlarm=txPwrLoAlarm)
