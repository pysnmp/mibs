...
alertSeverity, f5Alerts, alertSource, alertEffect, alertDescription, alertTimeStamp, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5Alerts", "alertSource", "alertEffect", "alertDescription", "alertTimeStamp", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", backplane=backplane, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, drive_capacity_fault=drive_capacity_fault, ddmTempLoAlarm=ddmTempLoAlarm, drive_fault=drive_fault, service_health=service_health, fipsError=fipsError, rxPwrHiWarn=rxPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, module_present=module_present, thermal_fault=thermal_fault, memory_fault=memory_fault, txBiasLoAlarm=txBiasLoAlarm, firmware_fault=firmware_fault, aom_fault=aom_fault, txPwrHiAlarm=txPwrHiAlarm, firmware_update_status=firmware_update_status, psu_fault=psu_fault, ddmVccLoAlarm=ddmVccLoAlarm, module_communication_error=module_communication_error, blade_hardware_fault=blade_hardware_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempLoWarn=ddmTempLoWarn, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, PYSNMP_MODULE_ID=f5AlertNotification, core_dump=core_dump, txPwrHiWarn=txPwrHiWarn, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, power_fault=power_fault, txBiasLoWarn=txBiasLoWarn, unknown_alarm=unknown_alarm, hardware_device_fault=hardware_device_fault, blade_thermal_fault=blade_thermal_fault, drive_utilization=drive_utilization)
