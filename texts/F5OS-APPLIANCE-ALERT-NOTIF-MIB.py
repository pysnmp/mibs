...
alertTimeStamp, alertEffect, alertSeverity, alertDescription, f5AlertNotificationGroup, alertSource, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertEffect", "alertSeverity", "alertDescription", "f5AlertNotificationGroup", "alertSource", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", PYSNMP_MODULE_ID=f5AlertNotification, raidEvent=raidEvent, txPwrHiWarn=txPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, txBiasHiWarn=txBiasHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, core_dump=core_dump, cpu_fault=cpu_fault, module_present=module_present, rxPwrLoAlarm=rxPwrLoAlarm, power_fault=power_fault, module_communication_error=module_communication_error, drive_fault=drive_fault, txBiasHiAlarm=txBiasHiAlarm, drive_capacity_fault=drive_capacity_fault, ddmVccLoWarn=ddmVccLoWarn, thermal_fault=thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, service_health=service_health, f5AlertsNotifyGroup=f5AlertsNotifyGroup, blade_hardware_fault=blade_hardware_fault, pcie_fault=pcie_fault, f5AlertNotification=f5AlertNotification, hardware_device_fault=hardware_device_fault, ddmVccHiAlarm=ddmVccHiAlarm, aom_fault=aom_fault, txPwrHiAlarm=txPwrHiAlarm, txBiasLoWarn=txBiasLoWarn, fipsError=fipsError, blade_thermal_fault=blade_thermal_fault, ddmTempHiWarn=ddmTempHiWarn, txPwrLoWarn=txPwrLoWarn, ddmVccHiWarn=ddmVccHiWarn, drive_utilization=drive_utilization, firmware_update_status=firmware_update_status, unknown_alarm=unknown_alarm, firmware_fault=firmware_fault, backplane=backplane, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, rxPwrHiWarn=rxPwrHiWarn, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, psu_fault=psu_fault, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, ddmTempLoWarn=ddmTempLoWarn)
