...
alertTimeStamp, f5Alerts, alertDescription, alertEffect, alertSource, alertSeverity, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "f5Alerts", "alertDescription", "alertEffect", "alertSource", "alertSeverity", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", module_communication_error=module_communication_error, core_dump=core_dump, memory_fault=memory_fault, f5AlertNotification=f5AlertNotification, drive_capacity_fault=drive_capacity_fault, txBiasHiAlarm=txBiasHiAlarm, pcie_fault=pcie_fault, rxPwrHiAlarm=rxPwrHiAlarm, raidEvent=raidEvent, ddmTempLoAlarm=ddmTempLoAlarm, txPwrLoWarn=txPwrLoWarn, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoWarn=ddmTempLoWarn, thermal_fault=thermal_fault, fipsError=fipsError, unknown_alarm=unknown_alarm, firmware_fault=firmware_fault, txBiasLoAlarm=txBiasLoAlarm, drive_thermal_throttle=drive_thermal_throttle, firmware_update_status=firmware_update_status, psu_fault=psu_fault, blade_thermal_fault=blade_thermal_fault, aom_fault=aom_fault, service_health=service_health, rxPwrHiWarn=rxPwrHiWarn, drive_fault=drive_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempHiWarn=ddmTempHiWarn, txBiasHiWarn=txBiasHiWarn, drive_utilization=drive_utilization, rxPwrLoAlarm=rxPwrLoAlarm, hardware_device_fault=hardware_device_fault, module_present=module_present, cpu_fault=cpu_fault, lcd_fault=lcd_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiWarn=ddmVccHiWarn, txPwrHiWarn=txPwrHiWarn, backplane=backplane, blade_hardware_fault=blade_hardware_fault, ddmVccLoWarn=ddmVccLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, power_fault=power_fault, ddmTempHiAlarm=ddmTempHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup)
