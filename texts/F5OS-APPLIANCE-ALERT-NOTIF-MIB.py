...
alertDescription, alertTimeStamp, alertEffect, f5AlertNotificationGroup, alertSource, f5Alerts, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertTimeStamp", "alertEffect", "f5AlertNotificationGroup", "alertSource", "f5Alerts", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_capacity_fault=drive_capacity_fault, txBiasLoWarn=txBiasLoWarn, core_dump=core_dump, aom_fault=aom_fault, power_fault=power_fault, pcie_fault=pcie_fault, txBiasHiAlarm=txBiasHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, raidEvent=raidEvent, memory_fault=memory_fault, service_health=service_health, drive_thermal_throttle=drive_thermal_throttle, firmware_update_status=firmware_update_status, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoWarn=ddmTempLoWarn, rxPwrHiWarn=rxPwrHiWarn, txPwrHiAlarm=txPwrHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, txPwrLoWarn=txPwrLoWarn, drive_fault=drive_fault, lcd_fault=lcd_fault, hardware_device_fault=hardware_device_fault, txBiasHiWarn=txBiasHiWarn, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, unknown_alarm=unknown_alarm, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccLoWarn=ddmVccLoWarn, module_present=module_present, ddmTempLoAlarm=ddmTempLoAlarm, blade_thermal_fault=blade_thermal_fault, txPwrHiWarn=txPwrHiWarn, firmware_fault=firmware_fault, backplane=backplane, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, module_communication_error=module_communication_error, ddmVccHiAlarm=ddmVccHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, fipsError=fipsError, drive_utilization=drive_utilization, psu_fault=psu_fault, ddmVccHiWarn=ddmVccHiWarn, cpu_fault=cpu_fault)
