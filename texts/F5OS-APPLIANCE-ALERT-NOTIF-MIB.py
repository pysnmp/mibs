...
alertDescription, alertSeverity, f5Alerts, alertTimeStamp, f5AlertNotificationGroup, alertSource, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSeverity", "f5Alerts", "alertTimeStamp", "f5AlertNotificationGroup", "alertSource", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, aom_fault=aom_fault, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, service_health=service_health, module_communication_error=module_communication_error, unknown_alarm=unknown_alarm, ddmVccLoAlarm=ddmVccLoAlarm, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, txPwrHiWarn=txPwrHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, firmware_update_status=firmware_update_status, txBiasHiAlarm=txBiasHiAlarm, txPwrLoWarn=txPwrLoWarn, memory_fault=memory_fault, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrLoWarn=rxPwrLoWarn, fipsError=fipsError, ddmVccLoWarn=ddmVccLoWarn, psu_fault=psu_fault, drive_fault=drive_fault, txBiasHiWarn=txBiasHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrHiWarn=rxPwrHiWarn, module_present=module_present, txPwrLoAlarm=txPwrLoAlarm, core_dump=core_dump, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempLoWarn=ddmTempLoWarn, hardware_device_fault=hardware_device_fault, ddmVccHiWarn=ddmVccHiWarn, drive_capacity_fault=drive_capacity_fault, firmware_fault=firmware_fault, txBiasLoAlarm=txBiasLoAlarm, raidEvent=raidEvent, rxPwrLoAlarm=rxPwrLoAlarm, blade_thermal_fault=blade_thermal_fault, drive_utilization=drive_utilization, ddmVccHiAlarm=ddmVccHiAlarm, power_fault=power_fault, txPwrHiAlarm=txPwrHiAlarm, lcd_fault=lcd_fault, cpu_fault=cpu_fault, thermal_fault=thermal_fault, backplane=backplane)
