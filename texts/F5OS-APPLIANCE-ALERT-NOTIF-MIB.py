...
f5Alerts, alertEffect, alertDescription, alertTimeStamp, f5AlertNotificationGroup, alertSource, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertEffect", "alertDescription", "alertTimeStamp", "f5AlertNotificationGroup", "alertSource", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_utilization=drive_utilization, drive_fault=drive_fault, cpu_fault=cpu_fault, rxPwrLoWarn=rxPwrLoWarn, module_communication_error=module_communication_error, drive_thermal_throttle=drive_thermal_throttle, thermal_fault=thermal_fault, txPwrLoAlarm=txPwrLoAlarm, psu_fault=psu_fault, lcd_fault=lcd_fault, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempLoWarn=ddmTempLoWarn, firmware_fault=firmware_fault, aom_fault=aom_fault, blade_thermal_fault=blade_thermal_fault, blade_hardware_fault=blade_hardware_fault, txPwrHiAlarm=txPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, rxPwrHiWarn=rxPwrHiWarn, raidEvent=raidEvent, memory_fault=memory_fault, core_dump=core_dump, rxPwrLoAlarm=rxPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, ddmVccLoWarn=ddmVccLoWarn, backplane=backplane, ddmVccHiAlarm=ddmVccHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, unknown_alarm=unknown_alarm, hardware_device_fault=hardware_device_fault, ddmVccHiWarn=ddmVccHiWarn, drive_capacity_fault=drive_capacity_fault, txBiasLoWarn=txBiasLoWarn, pcie_fault=pcie_fault, module_present=module_present, firmware_update_status=firmware_update_status, f5AlertsNotifyGroup=f5AlertsNotifyGroup, service_health=service_health, txBiasHiWarn=txBiasHiWarn, txBiasLoAlarm=txBiasLoAlarm, fipsError=fipsError, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, f5AlertNotification=f5AlertNotification, txPwrHiWarn=txPwrHiWarn, power_fault=power_fault, ddmTempHiAlarm=ddmTempHiAlarm)
