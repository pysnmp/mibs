...
f5AlertNotificationGroup, alertEffect, alertTimeStamp, f5Alerts, alertSource, alertDescription, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertEffect", "alertTimeStamp", "f5Alerts", "alertSource", "alertDescription", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", psu_fault=psu_fault, pcie_fault=pcie_fault, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, drive_fault=drive_fault, cpu_fault=cpu_fault, module_present=module_present, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, txPwrHiWarn=txPwrHiWarn, hardware_device_fault=hardware_device_fault, blade_thermal_fault=blade_thermal_fault, ddmVccHiAlarm=ddmVccHiAlarm, core_dump=core_dump, rxPwrLoAlarm=rxPwrLoAlarm, drive_utilization=drive_utilization, txBiasHiAlarm=txBiasHiAlarm, aom_fault=aom_fault, txBiasLoWarn=txBiasLoWarn, blade_hardware_fault=blade_hardware_fault, backplane=backplane, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempHiWarn=ddmTempHiWarn, module_communication_error=module_communication_error, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, ddmTempLoWarn=ddmTempLoWarn, unknown_alarm=unknown_alarm, txBiasLoAlarm=txBiasLoAlarm, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiWarn=ddmVccHiWarn, firmware_fault=firmware_fault, txPwrLoAlarm=txPwrLoAlarm, drive_capacity_fault=drive_capacity_fault, ddmVccLoWarn=ddmVccLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, fipsError=fipsError, firmware_update_status=firmware_update_status, ddmVccLoAlarm=ddmVccLoAlarm, memory_fault=memory_fault, power_fault=power_fault, thermal_fault=thermal_fault, ddmTempHiAlarm=ddmTempHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, service_health=service_health, txBiasHiWarn=txBiasHiWarn)
