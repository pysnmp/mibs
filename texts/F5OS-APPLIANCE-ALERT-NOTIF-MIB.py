...
alertSeverity, f5AlertNotificationGroup, f5Alerts, alertTimeStamp, alertSource, alertEffect, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5AlertNotificationGroup", "f5Alerts", "alertTimeStamp", "alertSource", "alertEffect", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrHiAlarm=txPwrHiAlarm, drive_utilization=drive_utilization, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmTempHiWarn=ddmTempHiWarn, txPwrLoAlarm=txPwrLoAlarm, cpu_fault=cpu_fault, rxPwrHiWarn=rxPwrHiWarn, drive_capacity_fault=drive_capacity_fault, service_health=service_health, ddmVccLoWarn=ddmVccLoWarn, txPwrHiWarn=txPwrHiWarn, module_communication_error=module_communication_error, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, blade_hardware_fault=blade_hardware_fault, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccHiWarn=ddmVccHiWarn, firmware_update_status=firmware_update_status, aom_fault=aom_fault, fipsError=fipsError, psu_fault=psu_fault, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, module_present=module_present, firmware_fault=firmware_fault, raidEvent=raidEvent, ddmVccLoAlarm=ddmVccLoAlarm, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, backplane=backplane, memory_fault=memory_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, unknown_alarm=unknown_alarm, PYSNMP_MODULE_ID=f5AlertNotification, pcie_fault=pcie_fault, rxPwrLoWarn=rxPwrLoWarn, hardware_device_fault=hardware_device_fault, power_fault=power_fault, txPwrLoWarn=txPwrLoWarn, drive_fault=drive_fault, blade_thermal_fault=blade_thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, core_dump=core_dump)
