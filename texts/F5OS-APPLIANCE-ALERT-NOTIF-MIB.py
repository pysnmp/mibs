...
alertTimeStamp, f5Alerts, alertSource, alertSeverity, alertDescription, f5AlertNotificationGroup, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "f5Alerts", "alertSource", "alertSeverity", "alertDescription", "f5AlertNotificationGroup", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", unknown_alarm=unknown_alarm, lcd_fault=lcd_fault, backplane=backplane, psu_fault=psu_fault, memory_fault=memory_fault, txPwrHiAlarm=txPwrHiAlarm, txPwrLoAlarm=txPwrLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, firmware_fault=firmware_fault, raidEvent=raidEvent, core_dump=core_dump, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, power_fault=power_fault, txBiasHiAlarm=txBiasHiAlarm, drive_utilization=drive_utilization, module_communication_error=module_communication_error, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasLoAlarm=txBiasLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, drive_thermal_throttle=drive_thermal_throttle, rxPwrLoWarn=rxPwrLoWarn, service_health=service_health, hardware_device_fault=hardware_device_fault, blade_thermal_fault=blade_thermal_fault, drive_fault=drive_fault, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempHiWarn=ddmTempHiWarn, txBiasHiWarn=txBiasHiWarn, txBiasLoWarn=txBiasLoWarn, aom_fault=aom_fault, blade_hardware_fault=blade_hardware_fault, drive_capacity_fault=drive_capacity_fault, pcie_fault=pcie_fault, module_present=module_present, ddmTempHiAlarm=ddmTempHiAlarm, cpu_fault=cpu_fault, fipsError=fipsError, txPwrHiWarn=txPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoWarn=ddmVccLoWarn, firmware_update_status=firmware_update_status, txPwrLoWarn=txPwrLoWarn)
