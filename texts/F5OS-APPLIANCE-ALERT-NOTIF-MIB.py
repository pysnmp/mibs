...
alertDescription, alertEffect, f5Alerts, alertTimeStamp, f5AlertNotificationGroup, alertSource, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertEffect", "f5Alerts", "alertTimeStamp", "f5AlertNotificationGroup", "alertSource", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", lcd_fault=lcd_fault, rxPwrHiWarn=rxPwrHiWarn, txPwrHiAlarm=txPwrHiAlarm, service_health=service_health, rxPwrLoAlarm=rxPwrLoAlarm, blade_thermal_fault=blade_thermal_fault, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, txBiasLoWarn=txBiasLoWarn, raidEvent=raidEvent, drive_utilization=drive_utilization, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertNotification=f5AlertNotification, thermal_fault=thermal_fault, ddmTempLoWarn=ddmTempLoWarn, aom_fault=aom_fault, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, ddmVccLoWarn=ddmVccLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_fault=drive_fault, hardware_device_fault=hardware_device_fault, txBiasHiWarn=txBiasHiWarn, drive_capacity_fault=drive_capacity_fault, unknown_alarm=unknown_alarm, txPwrHiWarn=txPwrHiWarn, backplane=backplane, psu_fault=psu_fault, txPwrLoAlarm=txPwrLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, module_present=module_present, txBiasHiAlarm=txBiasHiAlarm, pcie_fault=pcie_fault, rxPwrHiAlarm=rxPwrHiAlarm, power_fault=power_fault, core_dump=core_dump, fipsError=fipsError, ddmVccHiWarn=ddmVccHiWarn, cpu_fault=cpu_fault, drive_thermal_throttle=drive_thermal_throttle, rxPwrLoWarn=rxPwrLoWarn, firmware_update_status=firmware_update_status, ddmVccLoAlarm=ddmVccLoAlarm, firmware_fault=firmware_fault, memory_fault=memory_fault, ddmTempLoAlarm=ddmTempLoAlarm)
