...
f5Alerts, alertEffect, alertTimeStamp, alertDescription, alertSeverity, f5AlertNotificationGroup, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertEffect", "alertTimeStamp", "alertDescription", "alertSeverity", "f5AlertNotificationGroup", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, ddmVccLoWarn=ddmVccLoWarn, raidEvent=raidEvent, pcie_fault=pcie_fault, power_fault=power_fault, module_communication_error=module_communication_error, psu_fault=psu_fault, txBiasHiWarn=txBiasHiWarn, service_health=service_health, ddmTempLoWarn=ddmTempLoWarn, core_dump=core_dump, module_present=module_present, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccHiWarn=ddmVccHiWarn, blade_thermal_fault=blade_thermal_fault, rxPwrLoWarn=rxPwrLoWarn, backplane=backplane, ddmTempHiAlarm=ddmTempHiAlarm, drive_utilization=drive_utilization, txBiasHiAlarm=txBiasHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, txPwrHiAlarm=txPwrHiAlarm, txPwrLoAlarm=txPwrLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, firmware_update_status=firmware_update_status, drive_fault=drive_fault, unknown_alarm=unknown_alarm, ddmTempLoAlarm=ddmTempLoAlarm, firmware_fault=firmware_fault, PYSNMP_MODULE_ID=f5AlertNotification, blade_hardware_fault=blade_hardware_fault, thermal_fault=thermal_fault, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, drive_capacity_fault=drive_capacity_fault, txPwrHiWarn=txPwrHiWarn, hardware_device_fault=hardware_device_fault, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, aom_fault=aom_fault, lcd_fault=lcd_fault, txPwrLoWarn=txPwrLoWarn, memory_fault=memory_fault, drive_thermal_throttle=drive_thermal_throttle, cpu_fault=cpu_fault, ddmTempHiWarn=ddmTempHiWarn, txBiasLoAlarm=txBiasLoAlarm, f5AlertNotification=f5AlertNotification)
