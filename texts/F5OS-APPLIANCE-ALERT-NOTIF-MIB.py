...
alertEffect, alertDescription, alertSource, f5Alerts, f5AlertNotificationGroup, alertTimeStamp, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertDescription", "alertSource", "f5Alerts", "f5AlertNotificationGroup", "alertTimeStamp", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", thermal_fault=thermal_fault, backplane=backplane, module_present=module_present, service_health=service_health, drive_capacity_fault=drive_capacity_fault, drive_utilization=drive_utilization, drive_fault=drive_fault, ddmTempHiWarn=ddmTempHiWarn, lcd_fault=lcd_fault, txPwrLoWarn=txPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, txPwrHiWarn=txPwrHiWarn, cpu_fault=cpu_fault, f5AlertNotification=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoWarn=ddmVccLoWarn, txBiasHiWarn=txBiasHiWarn, txBiasLoAlarm=txBiasLoAlarm, blade_hardware_fault=blade_hardware_fault, txBiasLoWarn=txBiasLoWarn, aom_fault=aom_fault, fipsError=fipsError, firmware_fault=firmware_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_thermal_throttle=drive_thermal_throttle, pcie_fault=pcie_fault, unknown_alarm=unknown_alarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempLoWarn=ddmTempLoWarn, module_communication_error=module_communication_error, blade_thermal_fault=blade_thermal_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, memory_fault=memory_fault, power_fault=power_fault, ddmVccHiWarn=ddmVccHiWarn, psu_fault=psu_fault, rxPwrHiWarn=rxPwrHiWarn, hardware_device_fault=hardware_device_fault, ddmVccLoAlarm=ddmVccLoAlarm, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, firmware_update_status=firmware_update_status, txPwrLoAlarm=txPwrLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, raidEvent=raidEvent)
