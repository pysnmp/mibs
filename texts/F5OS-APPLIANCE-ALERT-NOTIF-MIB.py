...
alertTimeStamp, alertEffect, alertDescription, alertSeverity, f5Alerts, alertSource, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertEffect", "alertDescription", "alertSeverity", "f5Alerts", "alertSource", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", pcie_fault=pcie_fault, drive_utilization=drive_utilization, blade_thermal_fault=blade_thermal_fault, txPwrLoAlarm=txPwrLoAlarm, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, txBiasLoWarn=txBiasLoWarn, service_health=service_health, rxPwrLoAlarm=rxPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, ddmVccHiWarn=ddmVccHiWarn, firmware_fault=firmware_fault, lcd_fault=lcd_fault, drive_fault=drive_fault, ddmTempLoAlarm=ddmTempLoAlarm, module_communication_error=module_communication_error, blade_hardware_fault=blade_hardware_fault, module_present=module_present, rxPwrHiWarn=rxPwrHiWarn, psu_fault=psu_fault, core_dump=core_dump, fipsError=fipsError, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccLoWarn=ddmVccLoWarn, rxPwrLoWarn=rxPwrLoWarn, drive_capacity_fault=drive_capacity_fault, txBiasHiWarn=txBiasHiWarn, aom_fault=aom_fault, ddmTempHiWarn=ddmTempHiWarn, drive_thermal_throttle=drive_thermal_throttle, backplane=backplane, thermal_fault=thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, memory_fault=memory_fault, unknown_alarm=unknown_alarm, hardware_device_fault=hardware_device_fault, power_fault=power_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_update_status=firmware_update_status, txPwrHiWarn=txPwrHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertNotification=f5AlertNotification, cpu_fault=cpu_fault)
