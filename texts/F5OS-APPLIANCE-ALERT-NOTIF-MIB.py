...
f5AlertNotificationGroup, alertTimeStamp, f5Alerts, alertEffect, alertDescription, alertSource, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertTimeStamp", "f5Alerts", "alertEffect", "alertDescription", "alertSource", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoAlarm=txBiasLoAlarm, drive_thermal_throttle=drive_thermal_throttle, ddmVccHiAlarm=ddmVccHiAlarm, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, firmware_update_status=firmware_update_status, ddmVccLoWarn=ddmVccLoWarn, lcd_fault=lcd_fault, drive_fault=drive_fault, module_communication_error=module_communication_error, f5AlertNotification=f5AlertNotification, blade_thermal_fault=blade_thermal_fault, hardware_device_fault=hardware_device_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoWarn=ddmTempLoWarn, txPwrHiWarn=txPwrHiWarn, aom_fault=aom_fault, rxPwrHiWarn=rxPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, psu_fault=psu_fault, power_fault=power_fault, ddmTempHiWarn=ddmTempHiWarn, pcie_fault=pcie_fault, service_health=service_health, module_present=module_present, rxPwrLoAlarm=rxPwrLoAlarm, raidEvent=raidEvent, backplane=backplane, fipsError=fipsError, drive_capacity_fault=drive_capacity_fault, unknown_alarm=unknown_alarm, txBiasLoWarn=txBiasLoWarn, thermal_fault=thermal_fault, blade_hardware_fault=blade_hardware_fault, core_dump=core_dump, memory_fault=memory_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiWarn=ddmVccHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, firmware_fault=firmware_fault, ddmTempLoAlarm=ddmTempLoAlarm, txBiasHiWarn=txBiasHiWarn, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn)
