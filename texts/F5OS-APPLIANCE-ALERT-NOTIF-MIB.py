...
alertDescription, alertSource, alertTimeStamp, f5Alerts, f5AlertNotificationGroup, alertSeverity, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSource", "alertTimeStamp", "f5Alerts", "f5AlertNotificationGroup", "alertSeverity", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiAlarm=rxPwrHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, lcd_fault=lcd_fault, power_fault=power_fault, ddmVccLoWarn=ddmVccLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, thermal_fault=thermal_fault, backplane=backplane, drive_capacity_fault=drive_capacity_fault, ddmVccHiWarn=ddmVccHiWarn, firmware_update_status=firmware_update_status, ddmTempLoAlarm=ddmTempLoAlarm, txBiasHiWarn=txBiasHiWarn, aom_fault=aom_fault, service_health=service_health, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, module_communication_error=module_communication_error, memory_fault=memory_fault, ddmTempLoWarn=ddmTempLoWarn, txPwrHiWarn=txPwrHiWarn, txBiasLoWarn=txBiasLoWarn, psu_fault=psu_fault, drive_utilization=drive_utilization, rxPwrLoAlarm=rxPwrLoAlarm, f5AlertNotification=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, blade_hardware_fault=blade_hardware_fault, hardware_device_fault=hardware_device_fault, pcie_fault=pcie_fault, core_dump=core_dump, rxPwrLoWarn=rxPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, unknown_alarm=unknown_alarm, fipsError=fipsError, txPwrHiAlarm=txPwrHiAlarm, raidEvent=raidEvent, drive_fault=drive_fault, module_present=module_present, cpu_fault=cpu_fault, blade_thermal_fault=blade_thermal_fault, rxPwrHiWarn=rxPwrHiWarn, firmware_fault=firmware_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoWarn=txPwrLoWarn, drive_thermal_throttle=drive_thermal_throttle, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiWarn=ddmTempHiWarn)
