...
f5Alerts, alertDescription, f5AlertNotificationGroup, alertTimeStamp, alertSource, alertEffect, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertDescription", "f5AlertNotificationGroup", "alertTimeStamp", "alertSource", "alertEffect", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", PYSNMP_MODULE_ID=f5AlertNotification, drive_utilization=drive_utilization, psu_fault=psu_fault, raidEvent=raidEvent, blade_thermal_fault=blade_thermal_fault, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoWarn=ddmVccLoWarn, rxPwrLoWarn=rxPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, blade_hardware_fault=blade_hardware_fault, aom_fault=aom_fault, txBiasHiAlarm=txBiasHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, txBiasHiWarn=txBiasHiWarn, backplane=backplane, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, firmware_fault=firmware_fault, unknown_alarm=unknown_alarm, drive_capacity_fault=drive_capacity_fault, cpu_fault=cpu_fault, txPwrLoAlarm=txPwrLoAlarm, module_communication_error=module_communication_error, firmware_update_status=firmware_update_status, ddmVccHiWarn=ddmVccHiWarn, f5AlertNotification=f5AlertNotification, pcie_fault=pcie_fault, txBiasLoWarn=txBiasLoWarn, thermal_fault=thermal_fault, power_fault=power_fault, rxPwrHiAlarm=rxPwrHiAlarm, hardware_device_fault=hardware_device_fault, ddmVccHiAlarm=ddmVccHiAlarm, txBiasLoAlarm=txBiasLoAlarm, drive_fault=drive_fault, module_present=module_present, ddmTempLoWarn=ddmTempLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, txPwrHiWarn=txPwrHiWarn, memory_fault=memory_fault, core_dump=core_dump, ddmTempHiWarn=ddmTempHiWarn, txPwrLoWarn=txPwrLoWarn, lcd_fault=lcd_fault, fipsError=fipsError, service_health=service_health, f5AlertsNotifyGroup=f5AlertsNotifyGroup)
