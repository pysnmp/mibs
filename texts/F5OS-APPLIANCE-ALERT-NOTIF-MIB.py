...
alertSeverity, alertEffect, alertDescription, alertTimeStamp, f5AlertNotificationGroup, f5Alerts, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertEffect", "alertDescription", "alertTimeStamp", "f5AlertNotificationGroup", "f5Alerts", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", memory_fault=memory_fault, drive_utilization=drive_utilization, f5AlertNotification=f5AlertNotification, drive_thermal_throttle=drive_thermal_throttle, hardware_device_fault=hardware_device_fault, blade_thermal_fault=blade_thermal_fault, backplane=backplane, aom_fault=aom_fault, PYSNMP_MODULE_ID=f5AlertNotification, unknown_alarm=unknown_alarm, firmware_update_status=firmware_update_status, lcd_fault=lcd_fault, raidEvent=raidEvent, rxPwrLoAlarm=rxPwrLoAlarm, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiWarn=ddmVccHiWarn, txPwrLoWarn=txPwrLoWarn, ddmVccLoWarn=ddmVccLoWarn, firmware_fault=firmware_fault, ddmTempLoAlarm=ddmTempLoAlarm, txBiasLoWarn=txBiasLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, cpu_fault=cpu_fault, service_health=service_health, psu_fault=psu_fault, power_fault=power_fault, rxPwrHiWarn=rxPwrHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, drive_capacity_fault=drive_capacity_fault, module_communication_error=module_communication_error, rxPwrLoWarn=rxPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, txBiasHiWarn=txBiasHiWarn, module_present=module_present, txPwrHiWarn=txPwrHiWarn, txPwrHiAlarm=txPwrHiAlarm, pcie_fault=pcie_fault, txPwrLoAlarm=txPwrLoAlarm, core_dump=core_dump, thermal_fault=thermal_fault, fipsError=fipsError, drive_fault=drive_fault, ddmVccLoAlarm=ddmVccLoAlarm)
