...
alertSource, alertTimeStamp, f5Alerts, alertEffect, alertDescription, f5AlertNotificationGroup, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertTimeStamp", "f5Alerts", "alertEffect", "alertDescription", "f5AlertNotificationGroup", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", blade_thermal_fault=blade_thermal_fault, backplane=backplane, ddmVccLoWarn=ddmVccLoWarn, ddmTempHiWarn=ddmTempHiWarn, aom_fault=aom_fault, txPwrLoAlarm=txPwrLoAlarm, psu_fault=psu_fault, fipsError=fipsError, cpu_fault=cpu_fault, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, blade_hardware_fault=blade_hardware_fault, txPwrHiAlarm=txPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, power_fault=power_fault, ddmVccLoAlarm=ddmVccLoAlarm, module_communication_error=module_communication_error, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, hardware_device_fault=hardware_device_fault, f5AlertNotification=f5AlertNotification, rxPwrHiAlarm=rxPwrHiAlarm, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, ddmVccHiWarn=ddmVccHiWarn, rxPwrLoWarn=rxPwrLoWarn, firmware_update_status=firmware_update_status, thermal_fault=thermal_fault, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, module_present=module_present, rxPwrLoAlarm=rxPwrLoAlarm, service_health=service_health, ddmVccHiAlarm=ddmVccHiAlarm, drive_utilization=drive_utilization, drive_fault=drive_fault, raidEvent=raidEvent, rxPwrHiWarn=rxPwrHiWarn, ddmTempLoWarn=ddmTempLoWarn, txPwrLoWarn=txPwrLoWarn, firmware_fault=firmware_fault, txBiasHiWarn=txBiasHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, memory_fault=memory_fault, core_dump=core_dump, txBiasLoWarn=txBiasLoWarn, lcd_fault=lcd_fault, unknown_alarm=unknown_alarm)
