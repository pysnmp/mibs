...
alertDescription, alertSource, alertTimeStamp, alertEffect, f5Alerts, alertSeverity, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSource", "alertTimeStamp", "alertEffect", "f5Alerts", "alertSeverity", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrHiWarn=txPwrHiWarn, pcie_fault=pcie_fault, blade_thermal_fault=blade_thermal_fault, core_dump=core_dump, ddmTempHiAlarm=ddmTempHiAlarm, drive_fault=drive_fault, txBiasLoAlarm=txBiasLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, firmware_fault=firmware_fault, PYSNMP_MODULE_ID=f5AlertNotification, memory_fault=memory_fault, service_health=service_health, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiWarn=rxPwrHiWarn, txPwrLoWarn=txPwrLoWarn, ddmVccLoWarn=ddmVccLoWarn, f5AlertNotification=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, module_present=module_present, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, hardware_device_fault=hardware_device_fault, drive_utilization=drive_utilization, aom_fault=aom_fault, txBiasHiAlarm=txBiasHiAlarm, txBiasHiWarn=txBiasHiWarn, power_fault=power_fault, thermal_fault=thermal_fault, rxPwrLoWarn=rxPwrLoWarn, lcd_fault=lcd_fault, blade_hardware_fault=blade_hardware_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, module_communication_error=module_communication_error, unknown_alarm=unknown_alarm, rxPwrLoAlarm=rxPwrLoAlarm, psu_fault=psu_fault, txPwrHiAlarm=txPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, cpu_fault=cpu_fault, txBiasLoWarn=txBiasLoWarn, fipsError=fipsError, ddmTempLoAlarm=ddmTempLoAlarm, backplane=backplane, ddmTempLoWarn=ddmTempLoWarn, firmware_update_status=firmware_update_status, drive_capacity_fault=drive_capacity_fault, raidEvent=raidEvent)
