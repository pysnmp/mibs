...
alertSource, alertSeverity, f5AlertNotificationGroup, alertTimeStamp, alertDescription, f5Alerts, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertSeverity", "f5AlertNotificationGroup", "alertTimeStamp", "alertDescription", "f5Alerts", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", module_present=module_present, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, firmware_fault=firmware_fault, raidEvent=raidEvent, rxPwrLoWarn=rxPwrLoWarn, blade_thermal_fault=blade_thermal_fault, fipsError=fipsError, firmware_update_status=firmware_update_status, cpu_fault=cpu_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempHiWarn=ddmTempHiWarn, thermal_fault=thermal_fault, ddmTempHiAlarm=ddmTempHiAlarm, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoWarn=ddmTempLoWarn, service_health=service_health, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasHiAlarm=txBiasHiAlarm, drive_capacity_fault=drive_capacity_fault, power_fault=power_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertNotification=f5AlertNotification, backplane=backplane, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccHiWarn=ddmVccHiWarn, drive_thermal_throttle=drive_thermal_throttle, drive_fault=drive_fault, rxPwrHiAlarm=rxPwrHiAlarm, unknown_alarm=unknown_alarm, PYSNMP_MODULE_ID=f5AlertNotification, drive_utilization=drive_utilization, txBiasHiWarn=txBiasHiWarn, memory_fault=memory_fault, txPwrHiWarn=txPwrHiWarn, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, hardware_device_fault=hardware_device_fault, pcie_fault=pcie_fault, lcd_fault=lcd_fault, aom_fault=aom_fault, module_communication_error=module_communication_error, psu_fault=psu_fault)
