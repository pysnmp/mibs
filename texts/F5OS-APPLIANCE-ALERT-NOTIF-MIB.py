...
f5Alerts, alertSeverity, f5AlertNotificationGroup, alertEffect, alertSource, alertDescription, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertSeverity", "f5AlertNotificationGroup", "alertEffect", "alertSource", "alertDescription", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasHiAlarm=txBiasHiAlarm, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoWarn=ddmVccLoWarn, txBiasLoWarn=txBiasLoWarn, pcie_fault=pcie_fault, memory_fault=memory_fault, unknown_alarm=unknown_alarm, fipsError=fipsError, rxPwrHiWarn=rxPwrHiWarn, psu_fault=psu_fault, blade_hardware_fault=blade_hardware_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiWarn=ddmVccHiWarn, power_fault=power_fault, aom_fault=aom_fault, drive_utilization=drive_utilization, drive_fault=drive_fault, raidEvent=raidEvent, ddmTempHiWarn=ddmTempHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, firmware_update_status=firmware_update_status, rxPwrHiAlarm=rxPwrHiAlarm, thermal_fault=thermal_fault, cpu_fault=cpu_fault, service_health=service_health, f5AlertNotification=f5AlertNotification, backplane=backplane, ddmVccHiAlarm=ddmVccHiAlarm, txPwrHiWarn=txPwrHiWarn, ddmTempLoWarn=ddmTempLoWarn, core_dump=core_dump, lcd_fault=lcd_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_fault=firmware_fault, hardware_device_fault=hardware_device_fault, module_communication_error=module_communication_error, txBiasHiWarn=txBiasHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, drive_capacity_fault=drive_capacity_fault, txPwrHiAlarm=txPwrHiAlarm, txPwrLoWarn=txPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, blade_thermal_fault=blade_thermal_fault, txPwrLoAlarm=txPwrLoAlarm, module_present=module_present)
