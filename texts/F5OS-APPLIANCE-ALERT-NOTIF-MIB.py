...
f5AlertNotificationGroup, alertDescription, f5Alerts, alertSource, alertSeverity, alertTimeStamp, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertDescription", "f5Alerts", "alertSource", "alertSeverity", "alertTimeStamp", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempHiAlarm=ddmTempHiAlarm, core_dump=core_dump, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, unknown_alarm=unknown_alarm, firmware_update_status=firmware_update_status, hardware_device_fault=hardware_device_fault, txPwrHiWarn=txPwrHiWarn, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, drive_capacity_fault=drive_capacity_fault, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoWarn=txBiasLoWarn, blade_thermal_fault=blade_thermal_fault, lcd_fault=lcd_fault, ddmTempHiWarn=ddmTempHiWarn, blade_hardware_fault=blade_hardware_fault, rxPwrLoWarn=rxPwrLoWarn, drive_fault=drive_fault, ddmTempLoWarn=ddmTempLoWarn, psu_fault=psu_fault, ddmVccLoWarn=ddmVccLoWarn, module_communication_error=module_communication_error, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, raidEvent=raidEvent, aom_fault=aom_fault, backplane=backplane, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, fipsError=fipsError, drive_utilization=drive_utilization, memory_fault=memory_fault, module_present=module_present, power_fault=power_fault, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiWarn=ddmVccHiWarn, thermal_fault=thermal_fault, rxPwrHiWarn=rxPwrHiWarn, f5AlertNotification=f5AlertNotification, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_fault=firmware_fault, ddmVccLoAlarm=ddmVccLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, service_health=service_health)
