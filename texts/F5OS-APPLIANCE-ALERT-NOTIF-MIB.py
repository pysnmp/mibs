...
f5Alerts, f5AlertNotificationGroup, alertTimeStamp, alertSeverity, alertDescription, alertSource, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "f5AlertNotificationGroup", "alertTimeStamp", "alertSeverity", "alertDescription", "alertSource", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccLoWarn=ddmVccLoWarn, module_present=module_present, PYSNMP_MODULE_ID=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, firmware_fault=firmware_fault, blade_hardware_fault=blade_hardware_fault, lcd_fault=lcd_fault, raidEvent=raidEvent, fipsError=fipsError, power_fault=power_fault, thermal_fault=thermal_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, pcie_fault=pcie_fault, drive_fault=drive_fault, psu_fault=psu_fault, rxPwrLoWarn=rxPwrLoWarn, unknown_alarm=unknown_alarm, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, drive_thermal_throttle=drive_thermal_throttle, drive_capacity_fault=drive_capacity_fault, rxPwrHiAlarm=rxPwrHiAlarm, blade_thermal_fault=blade_thermal_fault, aom_fault=aom_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasLoAlarm=txBiasLoAlarm, txPwrLoWarn=txPwrLoWarn, ddmVccHiWarn=ddmVccHiWarn, f5AlertNotification=f5AlertNotification, drive_utilization=drive_utilization, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, core_dump=core_dump, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, backplane=backplane, firmware_update_status=firmware_update_status, cpu_fault=cpu_fault, module_communication_error=module_communication_error, ddmVccLoAlarm=ddmVccLoAlarm, memory_fault=memory_fault, service_health=service_health, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, rxPwrHiWarn=rxPwrHiWarn, hardware_device_fault=hardware_device_fault, txPwrHiWarn=txPwrHiWarn)
