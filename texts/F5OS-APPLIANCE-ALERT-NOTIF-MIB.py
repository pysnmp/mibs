...
f5AlertNotificationGroup, alertSeverity, alertSource, alertTimeStamp, f5Alerts, alertDescription, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "alertSource", "alertTimeStamp", "f5Alerts", "alertDescription", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoAlarm=txBiasLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, fipsError=fipsError, raidEvent=raidEvent, txPwrLoWarn=txPwrLoWarn, ddmTempLoWarn=ddmTempLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, txPwrLoAlarm=txPwrLoAlarm, drive_thermal_throttle=drive_thermal_throttle, txBiasHiAlarm=txBiasHiAlarm, blade_thermal_fault=blade_thermal_fault, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault, ddmVccHiAlarm=ddmVccHiAlarm, blade_hardware_fault=blade_hardware_fault, power_fault=power_fault, psu_fault=psu_fault, drive_capacity_fault=drive_capacity_fault, rxPwrLoWarn=rxPwrLoWarn, core_dump=core_dump, ddmVccLoWarn=ddmVccLoWarn, cpu_fault=cpu_fault, firmware_fault=firmware_fault, module_present=module_present, ddmVccHiWarn=ddmVccHiWarn, lcd_fault=lcd_fault, ddmTempHiAlarm=ddmTempHiAlarm, txPwrHiWarn=txPwrHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, service_health=service_health, module_communication_error=module_communication_error, backplane=backplane, txPwrHiAlarm=txPwrHiAlarm, drive_fault=drive_fault, firmware_update_status=firmware_update_status, unknown_alarm=unknown_alarm, ddmTempHiWarn=ddmTempHiWarn, hardware_device_fault=hardware_device_fault, aom_fault=aom_fault, txBiasHiWarn=txBiasHiWarn, txBiasLoWarn=txBiasLoWarn, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, pcie_fault=pcie_fault, drive_utilization=drive_utilization, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccLoAlarm=ddmVccLoAlarm)
