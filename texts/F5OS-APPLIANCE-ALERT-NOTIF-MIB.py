...
alertTimeStamp, alertDescription, f5AlertNotificationGroup, alertSeverity, alertSource, alertEffect, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertDescription", "f5AlertNotificationGroup", "alertSeverity", "alertSource", "alertEffect", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasHiWarn=txBiasHiWarn, module_communication_error=module_communication_error, raidEvent=raidEvent, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, lcd_fault=lcd_fault, txPwrHiWarn=txPwrHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiWarn=ddmVccHiWarn, fipsError=fipsError, cpu_fault=cpu_fault, ddmVccHiAlarm=ddmVccHiAlarm, drive_thermal_throttle=drive_thermal_throttle, ddmVccLoWarn=ddmVccLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_update_status=firmware_update_status, rxPwrHiWarn=rxPwrHiWarn, thermal_fault=thermal_fault, PYSNMP_MODULE_ID=f5AlertNotification, drive_fault=drive_fault, txBiasLoAlarm=txBiasLoAlarm, power_fault=power_fault, txBiasHiAlarm=txBiasHiAlarm, blade_hardware_fault=blade_hardware_fault, txPwrLoWarn=txPwrLoWarn, hardware_device_fault=hardware_device_fault, txPwrHiAlarm=txPwrHiAlarm, pcie_fault=pcie_fault, txPwrLoAlarm=txPwrLoAlarm, ddmTempLoWarn=ddmTempLoWarn, module_present=module_present, memory_fault=memory_fault, blade_thermal_fault=blade_thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, firmware_fault=firmware_fault, drive_utilization=drive_utilization, core_dump=core_dump, psu_fault=psu_fault, aom_fault=aom_fault, backplane=backplane, rxPwrLoWarn=rxPwrLoWarn, txBiasLoWarn=txBiasLoWarn, drive_capacity_fault=drive_capacity_fault, service_health=service_health, f5AlertNotification=f5AlertNotification, unknown_alarm=unknown_alarm)
