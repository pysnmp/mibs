...
alertSource, f5Alerts, alertTimeStamp, alertEffect, f5AlertNotificationGroup, alertSeverity, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "f5Alerts", "alertTimeStamp", "alertEffect", "f5AlertNotificationGroup", "alertSeverity", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, unknown_alarm=unknown_alarm, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, cpu_fault=cpu_fault, power_fault=power_fault, PYSNMP_MODULE_ID=f5AlertNotification, firmware_update_status=firmware_update_status, drive_thermal_throttle=drive_thermal_throttle, drive_utilization=drive_utilization, blade_hardware_fault=blade_hardware_fault, backplane=backplane, txBiasHiWarn=txBiasHiWarn, drive_fault=drive_fault, f5AlertNotification=f5AlertNotification, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempHiWarn=ddmTempHiWarn, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, hardware_device_fault=hardware_device_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_capacity_fault=drive_capacity_fault, txPwrLoWarn=txPwrLoWarn, aom_fault=aom_fault, module_communication_error=module_communication_error, blade_thermal_fault=blade_thermal_fault, rxPwrHiWarn=rxPwrHiWarn, thermal_fault=thermal_fault, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmVccHiWarn=ddmVccHiWarn, txPwrHiWarn=txPwrHiWarn, service_health=service_health, psu_fault=psu_fault, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, firmware_fault=firmware_fault, txBiasHiAlarm=txBiasHiAlarm, memory_fault=memory_fault, module_present=module_present, fipsError=fipsError, lcd_fault=lcd_fault, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, pcie_fault=pcie_fault, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn)
