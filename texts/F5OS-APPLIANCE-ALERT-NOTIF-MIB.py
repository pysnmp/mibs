...
f5Alerts, alertSource, alertEffect, alertDescription, alertTimeStamp, f5AlertNotificationGroup, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertSource", "alertEffect", "alertDescription", "alertTimeStamp", "f5AlertNotificationGroup", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_capacity_fault=drive_capacity_fault, txBiasLoAlarm=txBiasLoAlarm, firmware_fault=firmware_fault, module_communication_error=module_communication_error, psu_fault=psu_fault, txBiasLoWarn=txBiasLoWarn, unknown_alarm=unknown_alarm, pcie_fault=pcie_fault, ddmVccLoWarn=ddmVccLoWarn, hardware_device_fault=hardware_device_fault, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault, blade_thermal_fault=blade_thermal_fault, drive_fault=drive_fault, power_fault=power_fault, rxPwrLoAlarm=rxPwrLoAlarm, fipsError=fipsError, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccHiWarn=ddmVccHiWarn, module_present=module_present, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoAlarm=txPwrLoAlarm, firmware_update_status=firmware_update_status, txPwrLoWarn=txPwrLoWarn, drive_utilization=drive_utilization, ddmTempHiAlarm=ddmTempHiAlarm, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoWarn=ddmTempLoWarn, rxPwrLoWarn=rxPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, lcd_fault=lcd_fault, raidEvent=raidEvent, txBiasHiWarn=txBiasHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertNotification=f5AlertNotification, ddmTempLoAlarm=ddmTempLoAlarm, txPwrHiWarn=txPwrHiWarn, cpu_fault=cpu_fault, aom_fault=aom_fault, service_health=service_health, core_dump=core_dump, txBiasHiAlarm=txBiasHiAlarm, backplane=backplane, drive_thermal_throttle=drive_thermal_throttle, thermal_fault=thermal_fault, txPwrHiAlarm=txPwrHiAlarm)
