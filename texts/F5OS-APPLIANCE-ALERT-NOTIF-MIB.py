...
alertDescription, alertSource, f5AlertNotificationGroup, alertSeverity, f5Alerts, alertTimeStamp, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSource", "f5AlertNotificationGroup", "alertSeverity", "f5Alerts", "alertTimeStamp", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrHiWarn=txPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, drive_capacity_fault=drive_capacity_fault, txPwrHiAlarm=txPwrHiAlarm, rxPwrHiWarn=rxPwrHiWarn, txBiasLoWarn=txBiasLoWarn, drive_fault=drive_fault, psu_fault=psu_fault, rxPwrHiAlarm=rxPwrHiAlarm, firmware_fault=firmware_fault, module_present=module_present, power_fault=power_fault, txPwrLoAlarm=txPwrLoAlarm, service_health=service_health, ddmTempLoWarn=ddmTempLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, module_communication_error=module_communication_error, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoWarn=ddmVccLoWarn, pcie_fault=pcie_fault, txBiasHiWarn=txBiasHiWarn, thermal_fault=thermal_fault, ddmTempLoAlarm=ddmTempLoAlarm, hardware_device_fault=hardware_device_fault, firmware_update_status=firmware_update_status, drive_utilization=drive_utilization, memory_fault=memory_fault, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, blade_thermal_fault=blade_thermal_fault, rxPwrLoWarn=rxPwrLoWarn, fipsError=fipsError, txBiasHiAlarm=txBiasHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, unknown_alarm=unknown_alarm, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, lcd_fault=lcd_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, raidEvent=raidEvent, cpu_fault=cpu_fault, backplane=backplane, f5AlertNotification=f5AlertNotification, aom_fault=aom_fault, drive_thermal_throttle=drive_thermal_throttle, txPwrLoWarn=txPwrLoWarn, core_dump=core_dump)
