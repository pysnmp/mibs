...
alertTimeStamp, f5AlertNotificationGroup, alertDescription, alertEffect, alertSource, f5Alerts, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "f5AlertNotificationGroup", "alertDescription", "alertEffect", "alertSource", "f5Alerts", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, firmware_update_status=firmware_update_status, aom_fault=aom_fault, power_fault=power_fault, module_present=module_present, pcie_fault=pcie_fault, blade_thermal_fault=blade_thermal_fault, txPwrHiAlarm=txPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, module_communication_error=module_communication_error, rxPwrLoWarn=rxPwrLoWarn, backplane=backplane, ddmVccHiWarn=ddmVccHiWarn, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoAlarm=txPwrLoAlarm, unknown_alarm=unknown_alarm, drive_fault=drive_fault, txBiasLoWarn=txBiasLoWarn, drive_thermal_throttle=drive_thermal_throttle, ddmTempLoWarn=ddmTempLoWarn, f5AlertNotification=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, service_health=service_health, thermal_fault=thermal_fault, hardware_device_fault=hardware_device_fault, drive_utilization=drive_utilization, ddmTempHiAlarm=ddmTempHiAlarm, txPwrLoWarn=txPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, fipsError=fipsError, ddmVccLoAlarm=ddmVccLoAlarm, firmware_fault=firmware_fault, raidEvent=raidEvent, drive_capacity_fault=drive_capacity_fault, txPwrHiWarn=txPwrHiWarn, lcd_fault=lcd_fault, core_dump=core_dump, ddmVccLoWarn=ddmVccLoWarn, psu_fault=psu_fault, cpu_fault=cpu_fault, blade_hardware_fault=blade_hardware_fault, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault)
