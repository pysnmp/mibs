...
alertSource, alertDescription, alertSeverity, alertEffect, f5Alerts, f5AlertNotificationGroup, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertDescription", "alertSeverity", "alertEffect", "f5Alerts", "f5AlertNotificationGroup", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", blade_thermal_fault=blade_thermal_fault, drive_capacity_fault=drive_capacity_fault, psu_fault=psu_fault, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, aom_fault=aom_fault, core_dump=core_dump, ddmTempLoWarn=ddmTempLoWarn, txPwrLoAlarm=txPwrLoAlarm, unknown_alarm=unknown_alarm, power_fault=power_fault, ddmVccHiWarn=ddmVccHiWarn, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, PYSNMP_MODULE_ID=f5AlertNotification, ddmVccHiAlarm=ddmVccHiAlarm, txBiasHiAlarm=txBiasHiAlarm, blade_hardware_fault=blade_hardware_fault, memory_fault=memory_fault, thermal_fault=thermal_fault, ddmTempHiWarn=ddmTempHiWarn, service_health=service_health, txBiasHiWarn=txBiasHiWarn, txPwrHiAlarm=txPwrHiAlarm, txPwrHiWarn=txPwrHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, pcie_fault=pcie_fault, ddmVccLoWarn=ddmVccLoWarn, lcd_fault=lcd_fault, ddmVccLoAlarm=ddmVccLoAlarm, drive_fault=drive_fault, drive_utilization=drive_utilization, module_communication_error=module_communication_error, txBiasLoWarn=txBiasLoWarn, backplane=backplane, fipsError=fipsError, hardware_device_fault=hardware_device_fault, rxPwrLoWarn=rxPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, module_present=module_present, firmware_update_status=firmware_update_status, firmware_fault=firmware_fault, txPwrLoWarn=txPwrLoWarn, drive_thermal_throttle=drive_thermal_throttle)
