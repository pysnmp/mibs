...
f5AlertNotificationGroup, alertTimeStamp, alertEffect, f5Alerts, alertSeverity, alertSource, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertTimeStamp", "alertEffect", "f5Alerts", "alertSeverity", "alertSource", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", blade_thermal_fault=blade_thermal_fault, service_health=service_health, ddmVccHiWarn=ddmVccHiWarn, drive_utilization=drive_utilization, txBiasHiWarn=txBiasHiWarn, hardware_device_fault=hardware_device_fault, blade_hardware_fault=blade_hardware_fault, psu_fault=psu_fault, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, f5AlertNotification=f5AlertNotification, core_dump=core_dump, memory_fault=memory_fault, txPwrLoWarn=txPwrLoWarn, pcie_fault=pcie_fault, fipsError=fipsError, firmware_fault=firmware_fault, drive_capacity_fault=drive_capacity_fault, module_communication_error=module_communication_error, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoWarn=ddmTempLoWarn, cpu_fault=cpu_fault, unknown_alarm=unknown_alarm, drive_fault=drive_fault, raidEvent=raidEvent, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccHiAlarm=ddmVccHiAlarm, firmware_update_status=firmware_update_status, power_fault=power_fault, backplane=backplane, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, txPwrHiWarn=txPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, lcd_fault=lcd_fault, ddmTempHiWarn=ddmTempHiWarn, rxPwrHiWarn=rxPwrHiWarn, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, txPwrHiAlarm=txPwrHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, aom_fault=aom_fault, ddmTempHiAlarm=ddmTempHiAlarm, drive_thermal_throttle=drive_thermal_throttle, thermal_fault=thermal_fault)
