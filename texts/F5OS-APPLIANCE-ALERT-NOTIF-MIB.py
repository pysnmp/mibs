...
f5Alerts, alertEffect, alertSource, alertDescription, alertTimeStamp, f5AlertNotificationGroup, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertEffect", "alertSource", "alertDescription", "alertTimeStamp", "f5AlertNotificationGroup", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrLoAlarm=txPwrLoAlarm, firmware_update_status=firmware_update_status, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, f5AlertNotification=f5AlertNotification, rxPwrLoAlarm=rxPwrLoAlarm, firmware_fault=firmware_fault, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, unknown_alarm=unknown_alarm, module_present=module_present, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, hardware_device_fault=hardware_device_fault, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, power_fault=power_fault, PYSNMP_MODULE_ID=f5AlertNotification, psu_fault=psu_fault, txBiasLoAlarm=txBiasLoAlarm, fipsError=fipsError, cpu_fault=cpu_fault, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, txBiasHiAlarm=txBiasHiAlarm, blade_thermal_fault=blade_thermal_fault, ddmTempHiAlarm=ddmTempHiAlarm, drive_fault=drive_fault, memory_fault=memory_fault, lcd_fault=lcd_fault, ddmVccLoWarn=ddmVccLoWarn, ddmTempLoWarn=ddmTempLoWarn, txBiasLoWarn=txBiasLoWarn, service_health=service_health, backplane=backplane, txPwrHiAlarm=txPwrHiAlarm, blade_hardware_fault=blade_hardware_fault, thermal_fault=thermal_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasHiWarn=txBiasHiWarn, aom_fault=aom_fault, drive_utilization=drive_utilization, ddmVccHiWarn=ddmVccHiWarn, raidEvent=raidEvent, core_dump=core_dump)
