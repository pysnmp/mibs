...
alertSeverity, alertEffect, alertDescription, f5AlertNotificationGroup, alertSource, alertTimeStamp, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertEffect", "alertDescription", "f5AlertNotificationGroup", "alertSource", "alertTimeStamp", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoAlarm=txBiasLoAlarm, aom_fault=aom_fault, hardware_device_fault=hardware_device_fault, backplane=backplane, PYSNMP_MODULE_ID=f5AlertNotification, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempHiWarn=ddmTempHiWarn, cpu_fault=cpu_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmTempHiAlarm=ddmTempHiAlarm, psu_fault=psu_fault, memory_fault=memory_fault, power_fault=power_fault, ddmTempLoAlarm=ddmTempLoAlarm, firmware_fault=firmware_fault, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, firmware_update_status=firmware_update_status, ddmVccHiAlarm=ddmVccHiAlarm, thermal_fault=thermal_fault, blade_hardware_fault=blade_hardware_fault, txPwrHiAlarm=txPwrHiAlarm, drive_capacity_fault=drive_capacity_fault, ddmVccLoWarn=ddmVccLoWarn, module_communication_error=module_communication_error, fipsError=fipsError, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoWarn=ddmTempLoWarn, service_health=service_health, txPwrLoAlarm=txPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, raidEvent=raidEvent, f5AlertNotification=f5AlertNotification, txPwrHiWarn=txPwrHiWarn, drive_fault=drive_fault, ddmVccHiWarn=ddmVccHiWarn, unknown_alarm=unknown_alarm, module_present=module_present, lcd_fault=lcd_fault, blade_thermal_fault=blade_thermal_fault, pcie_fault=pcie_fault, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiWarn=txBiasHiWarn, core_dump=core_dump, drive_utilization=drive_utilization)
