...
alertTimeStamp, alertDescription, alertSeverity, alertEffect, alertSource, f5AlertNotificationGroup, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertDescription", "alertSeverity", "alertEffect", "alertSource", "f5AlertNotificationGroup", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", cpu_fault=cpu_fault, module_present=module_present, psu_fault=psu_fault, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, memory_fault=memory_fault, ddmVccHiAlarm=ddmVccHiAlarm, firmware_fault=firmware_fault, rxPwrLoWarn=rxPwrLoWarn, f5AlertNotification=f5AlertNotification, ddmVccHiWarn=ddmVccHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, power_fault=power_fault, raidEvent=raidEvent, rxPwrLoAlarm=rxPwrLoAlarm, txPwrHiWarn=txPwrHiWarn, txPwrHiAlarm=txPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, hardware_device_fault=hardware_device_fault, firmware_update_status=firmware_update_status, unknown_alarm=unknown_alarm, drive_capacity_fault=drive_capacity_fault, txBiasHiAlarm=txBiasHiAlarm, backplane=backplane, txPwrLoWarn=txPwrLoWarn, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, drive_utilization=drive_utilization, ddmTempHiWarn=ddmTempHiWarn, blade_hardware_fault=blade_hardware_fault, txBiasLoWarn=txBiasLoWarn, drive_fault=drive_fault, blade_thermal_fault=blade_thermal_fault, fipsError=fipsError, rxPwrHiWarn=rxPwrHiWarn, txPwrLoAlarm=txPwrLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, module_communication_error=module_communication_error, txBiasHiWarn=txBiasHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, core_dump=core_dump, ddmTempLoWarn=ddmTempLoWarn, ddmVccLoWarn=ddmVccLoWarn, aom_fault=aom_fault, txBiasLoAlarm=txBiasLoAlarm, thermal_fault=thermal_fault, service_health=service_health, ddmVccLoAlarm=ddmVccLoAlarm)
