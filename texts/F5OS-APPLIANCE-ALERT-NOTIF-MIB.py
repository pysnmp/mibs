...
f5Alerts, alertTimeStamp, f5AlertNotificationGroup, alertEffect, alertSource, alertDescription, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertTimeStamp", "f5AlertNotificationGroup", "alertEffect", "alertSource", "alertDescription", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", raidEvent=raidEvent, rxPwrHiAlarm=rxPwrHiAlarm, psu_fault=psu_fault, memory_fault=memory_fault, ddmVccHiAlarm=ddmVccHiAlarm, hardware_device_fault=hardware_device_fault, backplane=backplane, unknown_alarm=unknown_alarm, fipsError=fipsError, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccHiWarn=ddmVccHiWarn, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, txBiasLoWarn=txBiasLoWarn, blade_thermal_fault=blade_thermal_fault, drive_capacity_fault=drive_capacity_fault, txPwrLoWarn=txPwrLoWarn, aom_fault=aom_fault, ddmVccLoAlarm=ddmVccLoAlarm, drive_fault=drive_fault, drive_thermal_throttle=drive_thermal_throttle, pcie_fault=pcie_fault, ddmTempLoWarn=ddmTempLoWarn, txBiasHiWarn=txBiasHiWarn, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, firmware_update_status=firmware_update_status, power_fault=power_fault, lcd_fault=lcd_fault, service_health=service_health, rxPwrLoWarn=rxPwrLoWarn, txPwrHiWarn=txPwrHiWarn, cpu_fault=cpu_fault, f5AlertNotification=f5AlertNotification, core_dump=core_dump, firmware_fault=firmware_fault, ddmVccLoWarn=ddmVccLoWarn, txPwrHiAlarm=txPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasHiAlarm=txBiasHiAlarm, drive_utilization=drive_utilization, rxPwrHiWarn=rxPwrHiWarn, module_communication_error=module_communication_error, module_present=module_present, thermal_fault=thermal_fault, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm)
