...
f5AlertNotificationGroup, f5Alerts, alertSource, alertEffect, alertTimeStamp, alertDescription, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "f5Alerts", "alertSource", "alertEffect", "alertTimeStamp", "alertDescription", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_fault=drive_fault, service_health=service_health, ddmTempHiWarn=ddmTempHiWarn, pcie_fault=pcie_fault, blade_hardware_fault=blade_hardware_fault, rxPwrLoAlarm=rxPwrLoAlarm, firmware_fault=firmware_fault, memory_fault=memory_fault, rxPwrHiWarn=rxPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, drive_capacity_fault=drive_capacity_fault, firmware_update_status=firmware_update_status, hardware_device_fault=hardware_device_fault, drive_thermal_throttle=drive_thermal_throttle, drive_utilization=drive_utilization, unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, fipsError=fipsError, PYSNMP_MODULE_ID=f5AlertNotification, module_present=module_present, txPwrHiWarn=txPwrHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoAlarm=txBiasLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, core_dump=core_dump, module_communication_error=module_communication_error, txBiasHiWarn=txBiasHiWarn, blade_thermal_fault=blade_thermal_fault, aom_fault=aom_fault, thermal_fault=thermal_fault, ddmVccHiWarn=ddmVccHiWarn, cpu_fault=cpu_fault, f5AlertNotification=f5AlertNotification, txPwrLoWarn=txPwrLoWarn, backplane=backplane, ddmTempLoAlarm=ddmTempLoAlarm, psu_fault=psu_fault, lcd_fault=lcd_fault, ddmTempLoWarn=ddmTempLoWarn, raidEvent=raidEvent, power_fault=power_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccHiAlarm=ddmVccHiAlarm)
