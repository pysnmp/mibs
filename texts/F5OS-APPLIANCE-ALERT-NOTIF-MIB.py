...
alertTimeStamp, f5Alerts, alertSeverity, f5AlertNotificationGroup, alertDescription, alertEffect, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "f5Alerts", "alertSeverity", "f5AlertNotificationGroup", "alertDescription", "alertEffect", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempHiAlarm=ddmTempHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrHiWarn=txPwrHiWarn, raidEvent=raidEvent, ddmVccLoWarn=ddmVccLoWarn, blade_hardware_fault=blade_hardware_fault, firmware_update_status=firmware_update_status, core_dump=core_dump, f5AlertNotification=f5AlertNotification, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, service_health=service_health, txBiasHiAlarm=txBiasHiAlarm, drive_thermal_throttle=drive_thermal_throttle, txBiasLoAlarm=txBiasLoAlarm, backplane=backplane, power_fault=power_fault, txPwrLoAlarm=txPwrLoAlarm, txPwrHiAlarm=txPwrHiAlarm, blade_thermal_fault=blade_thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, firmware_fault=firmware_fault, ddmVccLoAlarm=ddmVccLoAlarm, drive_capacity_fault=drive_capacity_fault, drive_fault=drive_fault, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiWarn=ddmVccHiWarn, aom_fault=aom_fault, hardware_device_fault=hardware_device_fault, rxPwrHiWarn=rxPwrHiWarn, txBiasLoWarn=txBiasLoWarn, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, txBiasHiWarn=txBiasHiWarn, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, thermal_fault=thermal_fault, module_present=module_present, ddmVccHiAlarm=ddmVccHiAlarm, cpu_fault=cpu_fault, memory_fault=memory_fault, psu_fault=psu_fault, lcd_fault=lcd_fault, unknown_alarm=unknown_alarm, rxPwrLoAlarm=rxPwrLoAlarm, fipsError=fipsError)
