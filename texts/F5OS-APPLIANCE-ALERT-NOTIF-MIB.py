...
alertTimeStamp, f5Alerts, alertSeverity, f5AlertNotificationGroup, alertSource, alertEffect, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "f5Alerts", "alertSeverity", "f5AlertNotificationGroup", "alertSource", "alertEffect", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccLoWarn=ddmVccLoWarn, txPwrLoAlarm=txPwrLoAlarm, firmware_update_status=firmware_update_status, hardware_device_fault=hardware_device_fault, rxPwrHiAlarm=rxPwrHiAlarm, core_dump=core_dump, drive_capacity_fault=drive_capacity_fault, txBiasLoAlarm=txBiasLoAlarm, rxPwrHiWarn=rxPwrHiWarn, cpu_fault=cpu_fault, txBiasHiAlarm=txBiasHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, ddmVccHiWarn=ddmVccHiWarn, backplane=backplane, pcie_fault=pcie_fault, ddmVccHiAlarm=ddmVccHiAlarm, thermal_fault=thermal_fault, module_present=module_present, ddmTempHiWarn=ddmTempHiWarn, txBiasHiWarn=txBiasHiWarn, drive_thermal_throttle=drive_thermal_throttle, unknown_alarm=unknown_alarm, module_communication_error=module_communication_error, aom_fault=aom_fault, fipsError=fipsError, memory_fault=memory_fault, raidEvent=raidEvent, txPwrLoWarn=txPwrLoWarn, power_fault=power_fault, txPwrHiWarn=txPwrHiWarn, ddmTempLoWarn=ddmTempLoWarn, psu_fault=psu_fault, drive_fault=drive_fault, service_health=service_health, firmware_fault=firmware_fault, txBiasLoWarn=txBiasLoWarn, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiAlarm=txPwrHiAlarm, f5AlertNotification=f5AlertNotification, blade_thermal_fault=blade_thermal_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, blade_hardware_fault=blade_hardware_fault, lcd_fault=lcd_fault, ddmTempHiAlarm=ddmTempHiAlarm)
