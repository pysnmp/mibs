...
f5Alerts, alertEffect, alertTimeStamp, alertSeverity, alertDescription, alertSource, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertEffect", "alertTimeStamp", "alertSeverity", "alertDescription", "alertSource", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempLoAlarm=ddmTempLoAlarm, blade_hardware_fault=blade_hardware_fault, fipsError=fipsError, module_present=module_present, rxPwrLoAlarm=rxPwrLoAlarm, service_health=service_health, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, memory_fault=memory_fault, aom_fault=aom_fault, firmware_fault=firmware_fault, txPwrHiAlarm=txPwrHiAlarm, drive_utilization=drive_utilization, module_communication_error=module_communication_error, thermal_fault=thermal_fault, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrLoWarn=rxPwrLoWarn, txPwrHiWarn=txPwrHiWarn, power_fault=power_fault, lcd_fault=lcd_fault, blade_thermal_fault=blade_thermal_fault, pcie_fault=pcie_fault, unknown_alarm=unknown_alarm, txBiasHiAlarm=txBiasHiAlarm, rxPwrHiWarn=rxPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, drive_thermal_throttle=drive_thermal_throttle, drive_fault=drive_fault, backplane=backplane, f5AlertsNotifyGroup=f5AlertsNotifyGroup, psu_fault=psu_fault, ddmTempLoWarn=ddmTempLoWarn, txPwrLoWarn=txPwrLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, hardware_device_fault=hardware_device_fault, txBiasLoWarn=txBiasLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, drive_capacity_fault=drive_capacity_fault, firmware_update_status=firmware_update_status, txBiasHiWarn=txBiasHiWarn, cpu_fault=cpu_fault, raidEvent=raidEvent, core_dump=core_dump, ddmVccLoWarn=ddmVccLoWarn)
