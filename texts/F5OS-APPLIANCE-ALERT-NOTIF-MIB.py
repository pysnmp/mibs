...
f5AlertNotificationGroup, alertSource, alertEffect, alertTimeStamp, alertDescription, alertSeverity, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSource", "alertEffect", "alertTimeStamp", "alertDescription", "alertSeverity", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", f5AlertNotification=f5AlertNotification, drive_utilization=drive_utilization, service_health=service_health, blade_thermal_fault=blade_thermal_fault, txBiasHiWarn=txBiasHiWarn, txPwrHiAlarm=txPwrHiAlarm, firmware_update_status=firmware_update_status, backplane=backplane, rxPwrLoWarn=rxPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, power_fault=power_fault, psu_fault=psu_fault, txPwrLoWarn=txPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, module_communication_error=module_communication_error, txPwrLoAlarm=txPwrLoAlarm, pcie_fault=pcie_fault, lcd_fault=lcd_fault, unknown_alarm=unknown_alarm, blade_hardware_fault=blade_hardware_fault, txBiasLoWarn=txBiasLoWarn, core_dump=core_dump, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiWarn=ddmTempHiWarn, thermal_fault=thermal_fault, drive_fault=drive_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, fipsError=fipsError, hardware_device_fault=hardware_device_fault, ddmTempHiAlarm=ddmTempHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, aom_fault=aom_fault, cpu_fault=cpu_fault, module_present=module_present, ddmTempLoWarn=ddmTempLoWarn, drive_capacity_fault=drive_capacity_fault, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccHiWarn=ddmVccHiWarn, firmware_fault=firmware_fault, ddmVccLoWarn=ddmVccLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, raidEvent=raidEvent)
