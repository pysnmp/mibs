...
f5Alerts, f5AlertNotificationGroup, alertEffect, alertSource, alertSeverity, alertTimeStamp, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "f5AlertNotificationGroup", "alertEffect", "alertSource", "alertSeverity", "alertTimeStamp", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccHiWarn=ddmVccHiWarn, thermal_fault=thermal_fault, drive_fault=drive_fault, module_present=module_present, rxPwrLoAlarm=rxPwrLoAlarm, aom_fault=aom_fault, ddmTempLoAlarm=ddmTempLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmTempHiAlarm=ddmTempHiAlarm, lcd_fault=lcd_fault, txBiasHiWarn=txBiasHiWarn, module_communication_error=module_communication_error, ddmVccLoWarn=ddmVccLoWarn, rxPwrHiWarn=rxPwrHiWarn, firmware_fault=firmware_fault, psu_fault=psu_fault, drive_utilization=drive_utilization, pcie_fault=pcie_fault, fipsError=fipsError, ddmVccLoAlarm=ddmVccLoAlarm, drive_thermal_throttle=drive_thermal_throttle, hardware_device_fault=hardware_device_fault, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, service_health=service_health, txBiasLoWarn=txBiasLoWarn, memory_fault=memory_fault, power_fault=power_fault, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoWarn=ddmTempLoWarn, txBiasHiAlarm=txBiasHiAlarm, firmware_update_status=firmware_update_status, drive_capacity_fault=drive_capacity_fault, blade_hardware_fault=blade_hardware_fault, backplane=backplane, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiWarn=ddmTempHiWarn, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, txPwrHiWarn=txPwrHiWarn, f5AlertNotification=f5AlertNotification, core_dump=core_dump, blade_thermal_fault=blade_thermal_fault, ddmVccHiAlarm=ddmVccHiAlarm)
