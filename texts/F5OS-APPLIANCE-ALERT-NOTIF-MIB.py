...
f5Alerts, alertDescription, alertSeverity, alertEffect, alertTimeStamp, f5AlertNotificationGroup, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertDescription", "alertSeverity", "alertEffect", "alertTimeStamp", "f5AlertNotificationGroup", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", power_fault=power_fault, txPwrLoWarn=txPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, backplane=backplane, rxPwrLoWarn=rxPwrLoWarn, firmware_update_status=firmware_update_status, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_capacity_fault=drive_capacity_fault, blade_hardware_fault=blade_hardware_fault, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, service_health=service_health, txBiasHiWarn=txBiasHiWarn, unknown_alarm=unknown_alarm, PYSNMP_MODULE_ID=f5AlertNotification, module_present=module_present, core_dump=core_dump, firmware_fault=firmware_fault, txBiasLoWarn=txBiasLoWarn, pcie_fault=pcie_fault, cpu_fault=cpu_fault, ddmVccLoAlarm=ddmVccLoAlarm, module_communication_error=module_communication_error, txPwrHiWarn=txPwrHiWarn, aom_fault=aom_fault, drive_thermal_throttle=drive_thermal_throttle, f5AlertNotification=f5AlertNotification, psu_fault=psu_fault, fipsError=fipsError, ddmVccHiWarn=ddmVccHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoWarn=ddmTempLoWarn, txBiasLoAlarm=txBiasLoAlarm, drive_fault=drive_fault, memory_fault=memory_fault, ddmVccLoWarn=ddmVccLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, raidEvent=raidEvent, hardware_device_fault=hardware_device_fault, rxPwrHiWarn=rxPwrHiWarn, lcd_fault=lcd_fault, blade_thermal_fault=blade_thermal_fault, txPwrLoAlarm=txPwrLoAlarm, drive_utilization=drive_utilization, thermal_fault=thermal_fault, txPwrHiAlarm=txPwrHiAlarm)
