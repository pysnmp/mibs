...
alertEffect, alertTimeStamp, alertSeverity, f5AlertNotificationGroup, f5Alerts, alertDescription, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertTimeStamp", "alertSeverity", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", hardware_device_fault=hardware_device_fault, module_present=module_present, firmware_fault=firmware_fault, rxPwrHiAlarm=rxPwrHiAlarm, power_fault=power_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, cpu_fault=cpu_fault, core_dump=core_dump, txBiasLoWarn=txBiasLoWarn, txPwrLoWarn=txPwrLoWarn, memory_fault=memory_fault, drive_utilization=drive_utilization, backplane=backplane, ddmTempHiWarn=ddmTempHiWarn, rxPwrLoWarn=rxPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, thermal_fault=thermal_fault, rxPwrHiWarn=rxPwrHiWarn, psu_fault=psu_fault, ddmVccHiAlarm=ddmVccHiAlarm, aom_fault=aom_fault, drive_capacity_fault=drive_capacity_fault, txBiasLoAlarm=txBiasLoAlarm, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, drive_thermal_throttle=drive_thermal_throttle, service_health=service_health, drive_fault=drive_fault, PYSNMP_MODULE_ID=f5AlertNotification, module_communication_error=module_communication_error, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, unknown_alarm=unknown_alarm, firmware_update_status=firmware_update_status, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, txPwrHiWarn=txPwrHiWarn, blade_hardware_fault=blade_hardware_fault, fipsError=fipsError, blade_thermal_fault=blade_thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, f5AlertNotification=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, raidEvent=raidEvent)
