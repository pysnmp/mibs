...
alertEffect, alertDescription, alertSource, alertSeverity, f5Alerts, alertTimeStamp, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertDescription", "alertSource", "alertSeverity", "f5Alerts", "alertTimeStamp", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrHiAlarm=txPwrHiAlarm, firmware_fault=firmware_fault, pcie_fault=pcie_fault, f5AlertNotification=f5AlertNotification, hardware_device_fault=hardware_device_fault, blade_thermal_fault=blade_thermal_fault, cpu_fault=cpu_fault, psu_fault=psu_fault, aom_fault=aom_fault, core_dump=core_dump, memory_fault=memory_fault, ddmVccLoWarn=ddmVccLoWarn, txBiasLoAlarm=txBiasLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, blade_hardware_fault=blade_hardware_fault, txPwrLoWarn=txPwrLoWarn, drive_capacity_fault=drive_capacity_fault, ddmTempLoWarn=ddmTempLoWarn, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, power_fault=power_fault, txBiasHiWarn=txBiasHiWarn, drive_thermal_throttle=drive_thermal_throttle, drive_fault=drive_fault, thermal_fault=thermal_fault, txPwrHiWarn=txPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, raidEvent=raidEvent, ddmVccLoAlarm=ddmVccLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrHiAlarm=rxPwrHiAlarm, firmware_update_status=firmware_update_status, rxPwrHiWarn=rxPwrHiWarn, txBiasLoWarn=txBiasLoWarn, rxPwrLoWarn=rxPwrLoWarn, service_health=service_health, module_present=module_present, backplane=backplane, fipsError=fipsError, ddmTempHiWarn=ddmTempHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, drive_utilization=drive_utilization, txPwrLoAlarm=txPwrLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, module_communication_error=module_communication_error, ddmVccHiWarn=ddmVccHiWarn, unknown_alarm=unknown_alarm)
