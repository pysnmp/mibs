...
alertSource, alertTimeStamp, alertDescription, f5AlertNotificationGroup, alertSeverity, f5Alerts, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertTimeStamp", "alertDescription", "f5AlertNotificationGroup", "alertSeverity", "f5Alerts", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", service_health=service_health, ddmTempHiAlarm=ddmTempHiAlarm, drive_utilization=drive_utilization, txPwrHiAlarm=txPwrHiAlarm, psu_fault=psu_fault, blade_thermal_fault=blade_thermal_fault, txBiasLoWarn=txBiasLoWarn, module_present=module_present, txPwrHiWarn=txPwrHiWarn, raidEvent=raidEvent, firmware_update_status=firmware_update_status, thermal_fault=thermal_fault, memory_fault=memory_fault, rxPwrLoAlarm=rxPwrLoAlarm, blade_hardware_fault=blade_hardware_fault, f5AlertNotification=f5AlertNotification, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiWarn=rxPwrHiWarn, firmware_fault=firmware_fault, txPwrLoAlarm=txPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, drive_capacity_fault=drive_capacity_fault, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, cpu_fault=cpu_fault, power_fault=power_fault, ddmVccHiWarn=ddmVccHiWarn, module_communication_error=module_communication_error, txBiasLoAlarm=txBiasLoAlarm, aom_fault=aom_fault, drive_fault=drive_fault, ddmTempLoWarn=ddmTempLoWarn, core_dump=core_dump, hardware_device_fault=hardware_device_fault, lcd_fault=lcd_fault, txPwrLoWarn=txPwrLoWarn, ddmVccLoWarn=ddmVccLoWarn, txBiasHiWarn=txBiasHiWarn, pcie_fault=pcie_fault, unknown_alarm=unknown_alarm, fipsError=fipsError, backplane=backplane)
