...
alertDescription, alertEffect, alertTimeStamp, f5Alerts, f5AlertNotificationGroup, alertSeverity, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertEffect", "alertTimeStamp", "f5Alerts", "f5AlertNotificationGroup", "alertSeverity", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiAlarm=ddmTempHiAlarm, txPwrLoAlarm=txPwrLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiAlarm=txPwrHiAlarm, ddmTempLoWarn=ddmTempLoWarn, thermal_fault=thermal_fault, blade_hardware_fault=blade_hardware_fault, ddmVccHiAlarm=ddmVccHiAlarm, service_health=service_health, psu_fault=psu_fault, module_communication_error=module_communication_error, blade_thermal_fault=blade_thermal_fault, txBiasLoAlarm=txBiasLoAlarm, raidEvent=raidEvent, lcd_fault=lcd_fault, drive_fault=drive_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, cpu_fault=cpu_fault, drive_capacity_fault=drive_capacity_fault, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrHiWarn=rxPwrHiWarn, firmware_fault=firmware_fault, firmware_update_status=firmware_update_status, txPwrHiWarn=txPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, core_dump=core_dump, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, backplane=backplane, drive_utilization=drive_utilization, unknown_alarm=unknown_alarm, hardware_device_fault=hardware_device_fault, power_fault=power_fault, module_present=module_present, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiWarn=ddmVccHiWarn, memory_fault=memory_fault, pcie_fault=pcie_fault, aom_fault=aom_fault, txPwrLoWarn=txPwrLoWarn, fipsError=fipsError, f5AlertNotification=f5AlertNotification)
