...
alertSeverity, alertDescription, f5AlertNotificationGroup, alertTimeStamp, f5Alerts, alertSource, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertDescription", "f5AlertNotificationGroup", "alertTimeStamp", "f5Alerts", "alertSource", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", aom_fault=aom_fault, ddmTempHiWarn=ddmTempHiWarn, txBiasLoAlarm=txBiasLoAlarm, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, drive_fault=drive_fault, lcd_fault=lcd_fault, blade_thermal_fault=blade_thermal_fault, fipsError=fipsError, hardware_device_fault=hardware_device_fault, drive_thermal_throttle=drive_thermal_throttle, blade_hardware_fault=blade_hardware_fault, raidEvent=raidEvent, txPwrLoWarn=txPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, thermal_fault=thermal_fault, txPwrHiWarn=txPwrHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, txBiasLoWarn=txBiasLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, psu_fault=psu_fault, pcie_fault=pcie_fault, ddmVccHiWarn=ddmVccHiWarn, backplane=backplane, rxPwrLoWarn=rxPwrLoWarn, module_communication_error=module_communication_error, firmware_fault=firmware_fault, cpu_fault=cpu_fault, service_health=service_health, core_dump=core_dump, module_present=module_present, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_update_status=firmware_update_status, txPwrLoAlarm=txPwrLoAlarm, power_fault=power_fault, drive_utilization=drive_utilization, txPwrHiAlarm=txPwrHiAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, rxPwrHiWarn=rxPwrHiWarn, drive_capacity_fault=drive_capacity_fault, ddmTempLoWarn=ddmTempLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, unknown_alarm=unknown_alarm, f5AlertNotification=f5AlertNotification, memory_fault=memory_fault)
