...
alertSeverity, f5Alerts, f5AlertNotificationGroup, alertDescription, alertSource, alertTimeStamp, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5Alerts", "f5AlertNotificationGroup", "alertDescription", "alertSource", "alertTimeStamp", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoAlarm=txBiasLoAlarm, blade_thermal_fault=blade_thermal_fault, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, pcie_fault=pcie_fault, blade_hardware_fault=blade_hardware_fault, memory_fault=memory_fault, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrHiWarn=rxPwrHiWarn, hardware_device_fault=hardware_device_fault, lcd_fault=lcd_fault, service_health=service_health, drive_thermal_throttle=drive_thermal_throttle, aom_fault=aom_fault, ddmTempLoWarn=ddmTempLoWarn, module_communication_error=module_communication_error, backplane=backplane, ddmVccHiAlarm=ddmVccHiAlarm, firmware_update_status=firmware_update_status, txPwrHiAlarm=txPwrHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, unknown_alarm=unknown_alarm, ddmVccHiWarn=ddmVccHiWarn, module_present=module_present, txPwrLoWarn=txPwrLoWarn, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, psu_fault=psu_fault, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, drive_utilization=drive_utilization, core_dump=core_dump, firmware_fault=firmware_fault, rxPwrHiAlarm=rxPwrHiAlarm, drive_fault=drive_fault, cpu_fault=cpu_fault, thermal_fault=thermal_fault, raidEvent=raidEvent, drive_capacity_fault=drive_capacity_fault, txBiasHiWarn=txBiasHiWarn, power_fault=power_fault, txPwrHiWarn=txPwrHiWarn, fipsError=fipsError)
