...
alertSeverity, alertSource, alertEffect, alertTimeStamp, f5AlertNotificationGroup, alertDescription, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertSource", "alertEffect", "alertTimeStamp", "f5AlertNotificationGroup", "alertDescription", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", aom_fault=aom_fault, firmware_update_status=firmware_update_status, backplane=backplane, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_capacity_fault=drive_capacity_fault, blade_thermal_fault=blade_thermal_fault, service_health=service_health, thermal_fault=thermal_fault, txPwrHiAlarm=txPwrHiAlarm, txPwrHiWarn=txPwrHiWarn, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, raidEvent=raidEvent, f5AlertNotification=f5AlertNotification, blade_hardware_fault=blade_hardware_fault, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoWarn=ddmTempLoWarn, psu_fault=psu_fault, txBiasHiWarn=txBiasHiWarn, txPwrLoAlarm=txPwrLoAlarm, pcie_fault=pcie_fault, rxPwrLoWarn=rxPwrLoWarn, hardware_device_fault=hardware_device_fault, cpu_fault=cpu_fault, unknown_alarm=unknown_alarm, rxPwrHiWarn=rxPwrHiWarn, module_present=module_present, rxPwrHiAlarm=rxPwrHiAlarm, core_dump=core_dump, memory_fault=memory_fault, power_fault=power_fault, txPwrLoWarn=txPwrLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, drive_thermal_throttle=drive_thermal_throttle, txBiasLoWarn=txBiasLoWarn, ddmVccHiWarn=ddmVccHiWarn, lcd_fault=lcd_fault, drive_fault=drive_fault, ddmTempLoAlarm=ddmTempLoAlarm, txBiasLoAlarm=txBiasLoAlarm, ddmVccLoWarn=ddmVccLoWarn, module_communication_error=module_communication_error, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, firmware_fault=firmware_fault, drive_utilization=drive_utilization)
