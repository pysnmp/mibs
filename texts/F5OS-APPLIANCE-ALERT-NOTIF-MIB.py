...
alertSource, f5AlertNotificationGroup, alertTimeStamp, f5Alerts, alertDescription, alertSeverity, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "f5AlertNotificationGroup", "alertTimeStamp", "f5Alerts", "alertDescription", "alertSeverity", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasHiWarn=txBiasHiWarn, unknown_alarm=unknown_alarm, aom_fault=aom_fault, hardware_device_fault=hardware_device_fault, ddmVccLoAlarm=ddmVccLoAlarm, psu_fault=psu_fault, txPwrLoWarn=txPwrLoWarn, backplane=backplane, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, cpu_fault=cpu_fault, drive_utilization=drive_utilization, ddmVccHiAlarm=ddmVccHiAlarm, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, ddmVccHiWarn=ddmVccHiWarn, rxPwrLoWarn=rxPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, service_health=service_health, memory_fault=memory_fault, module_present=module_present, drive_capacity_fault=drive_capacity_fault, firmware_update_status=firmware_update_status, txBiasLoWarn=txBiasLoWarn, ddmVccLoWarn=ddmVccLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoWarn=ddmTempLoWarn, blade_thermal_fault=blade_thermal_fault, pcie_fault=pcie_fault, f5AlertNotification=f5AlertNotification, firmware_fault=firmware_fault, thermal_fault=thermal_fault, drive_thermal_throttle=drive_thermal_throttle, fipsError=fipsError, txPwrLoAlarm=txPwrLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasLoAlarm=txBiasLoAlarm, drive_fault=drive_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, module_communication_error=module_communication_error, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiWarn=txPwrHiWarn, rxPwrHiWarn=rxPwrHiWarn, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, power_fault=power_fault)
