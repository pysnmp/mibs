...
alertTimeStamp, alertEffect, alertDescription, alertSource, f5AlertNotificationGroup, f5Alerts, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertEffect", "alertDescription", "alertSource", "f5AlertNotificationGroup", "f5Alerts", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccHiWarn=ddmVccHiWarn, pcie_fault=pcie_fault, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoWarn=ddmTempLoWarn, txPwrHiAlarm=txPwrHiAlarm, drive_utilization=drive_utilization, memory_fault=memory_fault, PYSNMP_MODULE_ID=f5AlertNotification, txBiasLoAlarm=txBiasLoAlarm, txBiasLoWarn=txBiasLoWarn, lcd_fault=lcd_fault, drive_capacity_fault=drive_capacity_fault, ddmTempHiWarn=ddmTempHiWarn, psu_fault=psu_fault, firmware_fault=firmware_fault, ddmTempLoAlarm=ddmTempLoAlarm, cpu_fault=cpu_fault, aom_fault=aom_fault, module_present=module_present, power_fault=power_fault, hardware_device_fault=hardware_device_fault, rxPwrLoWarn=rxPwrLoWarn, blade_hardware_fault=blade_hardware_fault, fipsError=fipsError, f5AlertNotification=f5AlertNotification, rxPwrLoAlarm=rxPwrLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, thermal_fault=thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, txPwrLoAlarm=txPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, backplane=backplane, service_health=service_health, ddmTempHiAlarm=ddmTempHiAlarm, module_communication_error=module_communication_error, txPwrHiWarn=txPwrHiWarn, raidEvent=raidEvent, txBiasHiWarn=txBiasHiWarn, drive_thermal_throttle=drive_thermal_throttle, ddmVccHiAlarm=ddmVccHiAlarm, firmware_update_status=firmware_update_status, ddmVccLoWarn=ddmVccLoWarn, core_dump=core_dump, drive_fault=drive_fault, unknown_alarm=unknown_alarm, blade_thermal_fault=blade_thermal_fault)
