...
f5Alerts, alertSeverity, alertDescription, alertTimeStamp, f5AlertNotificationGroup, alertEffect, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertSeverity", "alertDescription", "alertTimeStamp", "f5AlertNotificationGroup", "alertEffect", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", memory_fault=memory_fault, ddmVccHiWarn=ddmVccHiWarn, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, blade_thermal_fault=blade_thermal_fault, psu_fault=psu_fault, cpu_fault=cpu_fault, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, aom_fault=aom_fault, module_communication_error=module_communication_error, lcd_fault=lcd_fault, ddmTempLoAlarm=ddmTempLoAlarm, txPwrHiAlarm=txPwrHiAlarm, firmware_fault=firmware_fault, raidEvent=raidEvent, core_dump=core_dump, drive_thermal_throttle=drive_thermal_throttle, txPwrHiWarn=txPwrHiWarn, blade_hardware_fault=blade_hardware_fault, power_fault=power_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasLoWarn=txBiasLoWarn, hardware_device_fault=hardware_device_fault, fipsError=fipsError, thermal_fault=thermal_fault, txPwrLoAlarm=txPwrLoAlarm, drive_fault=drive_fault, f5AlertNotification=f5AlertNotification, rxPwrHiWarn=rxPwrHiWarn, service_health=service_health, drive_utilization=drive_utilization, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasHiWarn=txBiasHiWarn, drive_capacity_fault=drive_capacity_fault, rxPwrLoAlarm=rxPwrLoAlarm, firmware_update_status=firmware_update_status, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, pcie_fault=pcie_fault, backplane=backplane, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoWarn=txPwrLoWarn, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoWarn=ddmTempLoWarn)
