...
alertTimeStamp, alertSeverity, alertSource, alertEffect, f5Alerts, f5AlertNotificationGroup, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSeverity", "alertSource", "alertEffect", "f5Alerts", "f5AlertNotificationGroup", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", backplane=backplane, thermal_fault=thermal_fault, ddmVccHiAlarm=ddmVccHiAlarm, txBiasLoAlarm=txBiasLoAlarm, txBiasHiWarn=txBiasHiWarn, aom_fault=aom_fault, ddmTempHiWarn=ddmTempHiWarn, unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, lcd_fault=lcd_fault, firmware_fault=firmware_fault, hardware_device_fault=hardware_device_fault, ddmVccLoWarn=ddmVccLoWarn, blade_hardware_fault=blade_hardware_fault, drive_fault=drive_fault, raidEvent=raidEvent, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, power_fault=power_fault, txPwrHiAlarm=txPwrHiAlarm, module_communication_error=module_communication_error, txPwrHiWarn=txPwrHiWarn, f5AlertNotification=f5AlertNotification, txBiasHiAlarm=txBiasHiAlarm, psu_fault=psu_fault, rxPwrHiWarn=rxPwrHiWarn, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiAlarm=rxPwrHiAlarm, blade_thermal_fault=blade_thermal_fault, service_health=service_health, ddmTempLoAlarm=ddmTempLoAlarm, firmware_update_status=firmware_update_status, core_dump=core_dump, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiWarn=ddmVccHiWarn, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, drive_capacity_fault=drive_capacity_fault, txPwrLoWarn=txPwrLoWarn, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, cpu_fault=cpu_fault, module_present=module_present, txBiasLoWarn=txBiasLoWarn, memory_fault=memory_fault)
