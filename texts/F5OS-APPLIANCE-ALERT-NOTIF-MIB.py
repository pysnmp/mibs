...
alertSeverity, f5AlertNotificationGroup, f5Alerts, alertDescription, alertTimeStamp, alertSource, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertTimeStamp", "alertSource", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", cpu_fault=cpu_fault, drive_fault=drive_fault, ddmVccHiWarn=ddmVccHiWarn, module_communication_error=module_communication_error, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, drive_thermal_throttle=drive_thermal_throttle, hardware_device_fault=hardware_device_fault, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoWarn=txPwrLoWarn, aom_fault=aom_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, blade_thermal_fault=blade_thermal_fault, blade_hardware_fault=blade_hardware_fault, backplane=backplane, rxPwrHiWarn=rxPwrHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmTempLoAlarm=ddmTempLoAlarm, firmware_fault=firmware_fault, txPwrHiAlarm=txPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, service_health=service_health, memory_fault=memory_fault, txBiasHiWarn=txBiasHiWarn, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, fipsError=fipsError, power_fault=power_fault, pcie_fault=pcie_fault, rxPwrHiAlarm=rxPwrHiAlarm, psu_fault=psu_fault, firmware_update_status=firmware_update_status, module_present=module_present, core_dump=core_dump, lcd_fault=lcd_fault, raidEvent=raidEvent, txPwrHiWarn=txPwrHiWarn, thermal_fault=thermal_fault, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiWarn=ddmTempHiWarn, drive_capacity_fault=drive_capacity_fault, f5AlertNotification=f5AlertNotification, drive_utilization=drive_utilization, ddmVccHiAlarm=ddmVccHiAlarm)
