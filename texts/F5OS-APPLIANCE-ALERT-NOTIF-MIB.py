...
alertTimeStamp, alertSeverity, alertDescription, f5AlertNotificationGroup, alertSource, f5Alerts, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSeverity", "alertDescription", "f5AlertNotificationGroup", "alertSource", "f5Alerts", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", fipsError=fipsError, ddmTempLoAlarm=ddmTempLoAlarm, rxPwrHiWarn=rxPwrHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, txPwrLoAlarm=txPwrLoAlarm, firmware_fault=firmware_fault, psu_fault=psu_fault, drive_thermal_throttle=drive_thermal_throttle, drive_fault=drive_fault, txPwrHiWarn=txPwrHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, ddmVccLoWarn=ddmVccLoWarn, power_fault=power_fault, ddmVccLoAlarm=ddmVccLoAlarm, blade_hardware_fault=blade_hardware_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasLoAlarm=txBiasLoAlarm, firmware_update_status=firmware_update_status, txPwrLoWarn=txPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, cpu_fault=cpu_fault, unknown_alarm=unknown_alarm, core_dump=core_dump, rxPwrLoWarn=rxPwrLoWarn, backplane=backplane, aom_fault=aom_fault, hardware_device_fault=hardware_device_fault, module_communication_error=module_communication_error, raidEvent=raidEvent, drive_capacity_fault=drive_capacity_fault, thermal_fault=thermal_fault, txBiasHiWarn=txBiasHiWarn, f5AlertNotification=f5AlertNotification, txPwrHiAlarm=txPwrHiAlarm, service_health=service_health, ddmVccHiWarn=ddmVccHiWarn, lcd_fault=lcd_fault, pcie_fault=pcie_fault, txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, memory_fault=memory_fault, module_present=module_present, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, txBiasHiAlarm=txBiasHiAlarm, blade_thermal_fault=blade_thermal_fault)
