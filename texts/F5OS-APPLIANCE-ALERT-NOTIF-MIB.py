...
alertEffect, alertSeverity, f5Alerts, f5AlertNotificationGroup, alertSource, alertTimeStamp, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertSeverity", "f5Alerts", "f5AlertNotificationGroup", "alertSource", "alertTimeStamp", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiWarn=rxPwrHiWarn, txBiasLoWarn=txBiasLoWarn, unknown_alarm=unknown_alarm, blade_hardware_fault=blade_hardware_fault, drive_capacity_fault=drive_capacity_fault, drive_thermal_throttle=drive_thermal_throttle, ddmVccHiAlarm=ddmVccHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertsNotifyGroup=f5AlertsNotifyGroup, power_fault=power_fault, aom_fault=aom_fault, ddmVccHiWarn=ddmVccHiWarn, txBiasHiAlarm=txBiasHiAlarm, blade_thermal_fault=blade_thermal_fault, ddmTempLoAlarm=ddmTempLoAlarm, psu_fault=psu_fault, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoWarn=ddmTempLoWarn, txPwrHiAlarm=txPwrHiAlarm, drive_utilization=drive_utilization, raidEvent=raidEvent, firmware_update_status=firmware_update_status, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, backplane=backplane, service_health=service_health, fipsError=fipsError, rxPwrLoWarn=rxPwrLoWarn, firmware_fault=firmware_fault, core_dump=core_dump, txBiasHiWarn=txBiasHiWarn, f5AlertNotification=f5AlertNotification, hardware_device_fault=hardware_device_fault, ddmTempHiAlarm=ddmTempHiAlarm, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, drive_fault=drive_fault, pcie_fault=pcie_fault, lcd_fault=lcd_fault, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, thermal_fault=thermal_fault, txPwrHiWarn=txPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, memory_fault=memory_fault, module_communication_error=module_communication_error)
