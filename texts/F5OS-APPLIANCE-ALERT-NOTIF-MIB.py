...
alertSource, alertDescription, f5AlertNotificationGroup, alertTimeStamp, alertEffect, alertSeverity, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertDescription", "f5AlertNotificationGroup", "alertTimeStamp", "alertEffect", "alertSeverity", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", PYSNMP_MODULE_ID=f5AlertNotification, aom_fault=aom_fault, drive_capacity_fault=drive_capacity_fault, drive_thermal_throttle=drive_thermal_throttle, txBiasHiWarn=txBiasHiWarn, blade_thermal_fault=blade_thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempHiWarn=ddmTempHiWarn, firmware_fault=firmware_fault, ddmTempLoWarn=ddmTempLoWarn, unknown_alarm=unknown_alarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrLoWarn=rxPwrLoWarn, drive_utilization=drive_utilization, txBiasLoWarn=txBiasLoWarn, backplane=backplane, ddmTempLoAlarm=ddmTempLoAlarm, service_health=service_health, power_fault=power_fault, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, hardware_device_fault=hardware_device_fault, raidEvent=raidEvent, txBiasLoAlarm=txBiasLoAlarm, f5AlertNotification=f5AlertNotification, rxPwrHiWarn=rxPwrHiWarn, fipsError=fipsError, rxPwrHiAlarm=rxPwrHiAlarm, memory_fault=memory_fault, module_communication_error=module_communication_error, module_present=module_present, psu_fault=psu_fault, firmware_update_status=firmware_update_status, txPwrLoAlarm=txPwrLoAlarm, thermal_fault=thermal_fault, core_dump=core_dump, txPwrHiAlarm=txPwrHiAlarm, blade_hardware_fault=blade_hardware_fault, drive_fault=drive_fault, pcie_fault=pcie_fault, ddmVccHiWarn=ddmVccHiWarn, lcd_fault=lcd_fault, ddmVccLoWarn=ddmVccLoWarn, txBiasHiAlarm=txBiasHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, txPwrHiWarn=txPwrHiWarn)
