...
alertTimeStamp, alertSource, alertSeverity, f5AlertNotificationGroup, f5Alerts, alertDescription, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSource", "alertSeverity", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", thermal_fault=thermal_fault, power_fault=power_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiWarn=ddmVccHiWarn, memory_fault=memory_fault, blade_thermal_fault=blade_thermal_fault, unknown_alarm=unknown_alarm, rxPwrHiAlarm=rxPwrHiAlarm, service_health=service_health, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_update_status=firmware_update_status, firmware_fault=firmware_fault, ddmVccLoWarn=ddmVccLoWarn, f5AlertNotification=f5AlertNotification, ddmTempLoAlarm=ddmTempLoAlarm, txBiasHiWarn=txBiasHiWarn, cpu_fault=cpu_fault, aom_fault=aom_fault, backplane=backplane, ddmVccLoAlarm=ddmVccLoAlarm, hardware_device_fault=hardware_device_fault, raidEvent=raidEvent, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, txPwrLoAlarm=txPwrLoAlarm, drive_capacity_fault=drive_capacity_fault, drive_thermal_throttle=drive_thermal_throttle, txPwrHiWarn=txPwrHiWarn, core_dump=core_dump, rxPwrLoAlarm=rxPwrLoAlarm, psu_fault=psu_fault, module_present=module_present, ddmTempHiWarn=ddmTempHiWarn, rxPwrLoWarn=rxPwrLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, txBiasLoAlarm=txBiasLoAlarm, pcie_fault=pcie_fault, txBiasHiAlarm=txBiasHiAlarm, blade_hardware_fault=blade_hardware_fault, ddmTempHiAlarm=ddmTempHiAlarm, txPwrHiAlarm=txPwrHiAlarm, fipsError=fipsError, drive_fault=drive_fault, drive_utilization=drive_utilization, rxPwrHiWarn=rxPwrHiWarn, txBiasLoWarn=txBiasLoWarn, lcd_fault=lcd_fault)
