...
f5Alerts, alertSeverity, f5AlertNotificationGroup, alertDescription, alertEffect, alertSource, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertSeverity", "f5AlertNotificationGroup", "alertDescription", "alertEffect", "alertSource", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempHiWarn=ddmTempHiWarn, fipsError=fipsError, aom_fault=aom_fault, drive_utilization=drive_utilization, raidEvent=raidEvent, firmware_update_status=firmware_update_status, f5AlertNotification=f5AlertNotification, txPwrHiAlarm=txPwrHiAlarm, module_present=module_present, rxPwrLoWarn=rxPwrLoWarn, ddmVccHiWarn=ddmVccHiWarn, core_dump=core_dump, rxPwrHiAlarm=rxPwrHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempLoWarn=ddmTempLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, pcie_fault=pcie_fault, ddmVccLoWarn=ddmVccLoWarn, blade_thermal_fault=blade_thermal_fault, service_health=service_health, firmware_fault=firmware_fault, cpu_fault=cpu_fault, psu_fault=psu_fault, drive_capacity_fault=drive_capacity_fault, drive_thermal_throttle=drive_thermal_throttle, backplane=backplane, txPwrHiWarn=txPwrHiWarn, module_communication_error=module_communication_error, hardware_device_fault=hardware_device_fault, rxPwrLoAlarm=rxPwrLoAlarm, lcd_fault=lcd_fault, txPwrLoWarn=txPwrLoWarn, txBiasLoWarn=txBiasLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, unknown_alarm=unknown_alarm, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, power_fault=power_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasHiAlarm=txBiasHiAlarm, thermal_fault=thermal_fault, drive_fault=drive_fault, txBiasHiWarn=txBiasHiWarn, txPwrLoAlarm=txPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn)
