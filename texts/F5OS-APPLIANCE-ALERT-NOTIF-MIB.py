...
alertSource, alertSeverity, alertEffect, alertTimeStamp, f5Alerts, alertDescription, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertSeverity", "alertEffect", "alertTimeStamp", "f5Alerts", "alertDescription", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrHiAlarm=txPwrHiAlarm, pcie_fault=pcie_fault, thermal_fault=thermal_fault, blade_hardware_fault=blade_hardware_fault, rxPwrHiWarn=rxPwrHiWarn, txPwrHiWarn=txPwrHiWarn, txBiasLoWarn=txBiasLoWarn, fipsError=fipsError, txBiasHiAlarm=txBiasHiAlarm, ddmVccLoWarn=ddmVccLoWarn, txPwrLoWarn=txPwrLoWarn, backplane=backplane, core_dump=core_dump, ddmTempHiWarn=ddmTempHiWarn, blade_thermal_fault=blade_thermal_fault, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, cpu_fault=cpu_fault, ddmVccLoAlarm=ddmVccLoAlarm, raidEvent=raidEvent, lcd_fault=lcd_fault, ddmVccHiWarn=ddmVccHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertNotification=f5AlertNotification, drive_fault=drive_fault, hardware_device_fault=hardware_device_fault, drive_utilization=drive_utilization, module_present=module_present, module_communication_error=module_communication_error, psu_fault=psu_fault, drive_capacity_fault=drive_capacity_fault, memory_fault=memory_fault, firmware_fault=firmware_fault, power_fault=power_fault, service_health=service_health, aom_fault=aom_fault, ddmTempLoWarn=ddmTempLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_update_status=firmware_update_status, unknown_alarm=unknown_alarm, drive_thermal_throttle=drive_thermal_throttle, txBiasHiWarn=txBiasHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, txBiasLoAlarm=txBiasLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm)
