...
alertSeverity, alertTimeStamp, alertSource, f5Alerts, alertEffect, f5AlertNotificationGroup, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertTimeStamp", "alertSource", "f5Alerts", "alertEffect", "f5AlertNotificationGroup", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempLoWarn=ddmTempLoWarn, hardware_device_fault=hardware_device_fault, txBiasLoWarn=txBiasLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, memory_fault=memory_fault, module_communication_error=module_communication_error, core_dump=core_dump, ddmVccHiWarn=ddmVccHiWarn, psu_fault=psu_fault, drive_utilization=drive_utilization, module_present=module_present, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm, firmware_update_status=firmware_update_status, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, raidEvent=raidEvent, txPwrLoAlarm=txPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, txPwrLoWarn=txPwrLoWarn, rxPwrLoWarn=rxPwrLoWarn, txPwrHiWarn=txPwrHiWarn, fipsError=fipsError, aom_fault=aom_fault, power_fault=power_fault, drive_thermal_throttle=drive_thermal_throttle, firmware_fault=firmware_fault, drive_capacity_fault=drive_capacity_fault, service_health=service_health, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasLoAlarm=txBiasLoAlarm, backplane=backplane, drive_fault=drive_fault, ddmVccLoWarn=ddmVccLoWarn, pcie_fault=pcie_fault, thermal_fault=thermal_fault, lcd_fault=lcd_fault, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, cpu_fault=cpu_fault, blade_hardware_fault=blade_hardware_fault, txPwrHiAlarm=txPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, blade_thermal_fault=blade_thermal_fault, unknown_alarm=unknown_alarm)
