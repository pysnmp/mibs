...
alertSeverity, alertEffect, f5AlertNotificationGroup, alertDescription, alertTimeStamp, f5Alerts, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertEffect", "f5AlertNotificationGroup", "alertDescription", "alertTimeStamp", "f5Alerts", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoWarn=txBiasLoWarn, ddmTempLoWarn=ddmTempLoWarn, ddmVccLoWarn=ddmVccLoWarn, fipsError=fipsError, hardware_device_fault=hardware_device_fault, backplane=backplane, txPwrHiAlarm=txPwrHiAlarm, thermal_fault=thermal_fault, txBiasHiWarn=txBiasHiWarn, firmware_fault=firmware_fault, txBiasHiAlarm=txBiasHiAlarm, lcd_fault=lcd_fault, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, service_health=service_health, rxPwrHiWarn=rxPwrHiWarn, txPwrHiWarn=txPwrHiWarn, raidEvent=raidEvent, firmware_update_status=firmware_update_status, memory_fault=memory_fault, ddmVccHiWarn=ddmVccHiWarn, f5AlertNotification=f5AlertNotification, psu_fault=psu_fault, drive_fault=drive_fault, aom_fault=aom_fault, PYSNMP_MODULE_ID=f5AlertNotification, pcie_fault=pcie_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, drive_thermal_throttle=drive_thermal_throttle, drive_capacity_fault=drive_capacity_fault, txPwrLoAlarm=txPwrLoAlarm, module_communication_error=module_communication_error, ddmTempHiWarn=ddmTempHiWarn, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, power_fault=power_fault, unknown_alarm=unknown_alarm, blade_thermal_fault=blade_thermal_fault, blade_hardware_fault=blade_hardware_fault, txPwrLoWarn=txPwrLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, core_dump=core_dump)
