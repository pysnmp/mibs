...
alertTimeStamp, alertSeverity, alertEffect, alertDescription, f5AlertNotificationGroup, f5Alerts, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSeverity", "alertEffect", "alertDescription", "f5AlertNotificationGroup", "f5Alerts", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", firmware_fault=firmware_fault, firmware_update_status=firmware_update_status, txPwrHiWarn=txPwrHiWarn, txPwrLoWarn=txPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, blade_thermal_fault=blade_thermal_fault, ddmVccHiWarn=ddmVccHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrHiWarn=rxPwrHiWarn, txBiasHiWarn=txBiasHiWarn, fipsError=fipsError, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, f5AlertNotification=f5AlertNotification, ddmTempHiWarn=ddmTempHiWarn, memory_fault=memory_fault, ddmTempLoWarn=ddmTempLoWarn, module_present=module_present, lcd_fault=lcd_fault, txBiasLoAlarm=txBiasLoAlarm, pcie_fault=pcie_fault, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, drive_fault=drive_fault, psu_fault=psu_fault, drive_utilization=drive_utilization, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccLoWarn=ddmVccLoWarn, core_dump=core_dump, module_communication_error=module_communication_error, hardware_device_fault=hardware_device_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_capacity_fault=drive_capacity_fault, aom_fault=aom_fault, cpu_fault=cpu_fault, rxPwrLoWarn=rxPwrLoWarn, drive_thermal_throttle=drive_thermal_throttle, service_health=service_health, txBiasHiAlarm=txBiasHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, thermal_fault=thermal_fault, backplane=backplane, power_fault=power_fault, blade_hardware_fault=blade_hardware_fault, PYSNMP_MODULE_ID=f5AlertNotification)
