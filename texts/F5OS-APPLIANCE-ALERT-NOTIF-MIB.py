...
alertDescription, alertSource, alertSeverity, f5AlertNotificationGroup, alertEffect, f5Alerts, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSource", "alertSeverity", "f5AlertNotificationGroup", "alertEffect", "f5Alerts", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrLoAlarm=rxPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, aom_fault=aom_fault, pcie_fault=pcie_fault, raidEvent=raidEvent, backplane=backplane, firmware_update_status=firmware_update_status, memory_fault=memory_fault, psu_fault=psu_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasLoWarn=txBiasLoWarn, unknown_alarm=unknown_alarm, blade_thermal_fault=blade_thermal_fault, cpu_fault=cpu_fault, thermal_fault=thermal_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, power_fault=power_fault, PYSNMP_MODULE_ID=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, rxPwrHiAlarm=rxPwrHiAlarm, module_communication_error=module_communication_error, txBiasHiAlarm=txBiasHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccLoWarn=ddmVccLoWarn, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiWarn=ddmTempHiWarn, module_present=module_present, ddmVccHiWarn=ddmVccHiWarn, ddmTempLoWarn=ddmTempLoWarn, service_health=service_health, f5AlertNotification=f5AlertNotification, drive_capacity_fault=drive_capacity_fault, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, drive_utilization=drive_utilization, txPwrLoWarn=txPwrLoWarn, firmware_fault=firmware_fault, txPwrHiAlarm=txPwrHiAlarm, blade_hardware_fault=blade_hardware_fault, core_dump=core_dump, drive_fault=drive_fault, txBiasLoAlarm=txBiasLoAlarm, lcd_fault=lcd_fault, fipsError=fipsError, hardware_device_fault=hardware_device_fault)
