...
f5Alerts, alertEffect, alertSource, alertDescription, alertSeverity, alertTimeStamp, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertEffect", "alertSource", "alertDescription", "alertSeverity", "alertTimeStamp", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccLoWarn=ddmVccLoWarn, thermal_fault=thermal_fault, raidEvent=raidEvent, power_fault=power_fault, hardware_device_fault=hardware_device_fault, unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, fipsError=fipsError, txBiasHiAlarm=txBiasHiAlarm, ddmVccHiWarn=ddmVccHiWarn, memory_fault=memory_fault, ddmVccLoAlarm=ddmVccLoAlarm, service_health=service_health, drive_thermal_throttle=drive_thermal_throttle, module_communication_error=module_communication_error, rxPwrHiAlarm=rxPwrHiAlarm, pcie_fault=pcie_fault, f5AlertNotification=f5AlertNotification, blade_thermal_fault=blade_thermal_fault, psu_fault=psu_fault, blade_hardware_fault=blade_hardware_fault, module_present=module_present, PYSNMP_MODULE_ID=f5AlertNotification, core_dump=core_dump, txPwrLoWarn=txPwrLoWarn, txBiasHiWarn=txBiasHiWarn, drive_utilization=drive_utilization, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, cpu_fault=cpu_fault, backplane=backplane, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoWarn=ddmTempLoWarn, txPwrHiWarn=txPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, rxPwrHiWarn=rxPwrHiWarn, drive_fault=drive_fault, aom_fault=aom_fault, lcd_fault=lcd_fault, rxPwrLoAlarm=rxPwrLoAlarm, firmware_fault=firmware_fault, rxPwrLoWarn=rxPwrLoWarn, firmware_update_status=firmware_update_status, txPwrHiAlarm=txPwrHiAlarm, drive_capacity_fault=drive_capacity_fault, txBiasLoWarn=txBiasLoWarn, ddmVccHiAlarm=ddmVccHiAlarm)
