...
alertDescription, alertEffect, alertSeverity, f5AlertNotificationGroup, alertSource, alertTimeStamp, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertEffect", "alertSeverity", "f5AlertNotificationGroup", "alertSource", "alertTimeStamp", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", blade_hardware_fault=blade_hardware_fault, unknown_alarm=unknown_alarm, drive_fault=drive_fault, power_fault=power_fault, fipsError=fipsError, f5AlertNotification=f5AlertNotification, service_health=service_health, txBiasLoWarn=txBiasLoWarn, drive_utilization=drive_utilization, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoWarn=ddmVccLoWarn, pcie_fault=pcie_fault, txPwrHiAlarm=txPwrHiAlarm, module_present=module_present, firmware_update_status=firmware_update_status, psu_fault=psu_fault, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, drive_capacity_fault=drive_capacity_fault, txBiasHiWarn=txBiasHiWarn, hardware_device_fault=hardware_device_fault, lcd_fault=lcd_fault, ddmVccHiWarn=ddmVccHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, aom_fault=aom_fault, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrLoWarn=rxPwrLoWarn, core_dump=core_dump, txPwrHiWarn=txPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, txPwrLoAlarm=txPwrLoAlarm, drive_thermal_throttle=drive_thermal_throttle, module_communication_error=module_communication_error, memory_fault=memory_fault, ddmVccLoAlarm=ddmVccLoAlarm, thermal_fault=thermal_fault, raidEvent=raidEvent, cpu_fault=cpu_fault, ddmTempLoWarn=ddmTempLoWarn, firmware_fault=firmware_fault, backplane=backplane, blade_thermal_fault=blade_thermal_fault)
