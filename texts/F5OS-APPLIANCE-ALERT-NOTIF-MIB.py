...
alertTimeStamp, alertDescription, alertSeverity, alertEffect, f5Alerts, alertSource, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertDescription", "alertSeverity", "alertEffect", "f5Alerts", "alertSource", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrLoWarn=rxPwrLoWarn, cpu_fault=cpu_fault, txBiasLoAlarm=txBiasLoAlarm, drive_utilization=drive_utilization, ddmTempLoAlarm=ddmTempLoAlarm, firmware_update_status=firmware_update_status, ddmTempLoWarn=ddmTempLoWarn, module_present=module_present, txBiasHiAlarm=txBiasHiAlarm, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, txPwrHiWarn=txPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, rxPwrHiWarn=rxPwrHiWarn, aom_fault=aom_fault, ddmVccLoWarn=ddmVccLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, module_communication_error=module_communication_error, lcd_fault=lcd_fault, raidEvent=raidEvent, ddmTempHiWarn=ddmTempHiWarn, drive_capacity_fault=drive_capacity_fault, txPwrLoAlarm=txPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, blade_thermal_fault=blade_thermal_fault, unknown_alarm=unknown_alarm, ddmVccHiAlarm=ddmVccHiAlarm, memory_fault=memory_fault, power_fault=power_fault, core_dump=core_dump, backplane=backplane, txPwrHiAlarm=txPwrHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, psu_fault=psu_fault, txBiasHiWarn=txBiasHiWarn, service_health=service_health, ddmTempHiAlarm=ddmTempHiAlarm, txBiasLoWarn=txBiasLoWarn, drive_thermal_throttle=drive_thermal_throttle, hardware_device_fault=hardware_device_fault, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, firmware_fault=firmware_fault, drive_fault=drive_fault, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, blade_hardware_fault=blade_hardware_fault)
