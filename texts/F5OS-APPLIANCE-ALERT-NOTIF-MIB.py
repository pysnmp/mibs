...
f5Alerts, f5AlertNotificationGroup, alertEffect, alertSeverity, alertDescription, alertTimeStamp, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "f5AlertNotificationGroup", "alertEffect", "alertSeverity", "alertDescription", "alertTimeStamp", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", blade_hardware_fault=blade_hardware_fault, pcie_fault=pcie_fault, rxPwrHiWarn=rxPwrHiWarn, fipsError=fipsError, ddmVccHiWarn=ddmVccHiWarn, aom_fault=aom_fault, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, txBiasLoAlarm=txBiasLoAlarm, ddmVccLoWarn=ddmVccLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, firmware_update_status=firmware_update_status, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, unknown_alarm=unknown_alarm, backplane=backplane, thermal_fault=thermal_fault, drive_fault=drive_fault, ddmTempLoAlarm=ddmTempLoAlarm, txPwrHiWarn=txPwrHiWarn, drive_capacity_fault=drive_capacity_fault, cpu_fault=cpu_fault, blade_thermal_fault=blade_thermal_fault, hardware_device_fault=hardware_device_fault, service_health=service_health, txPwrLoWarn=txPwrLoWarn, module_communication_error=module_communication_error, f5AlertNotification=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, firmware_fault=firmware_fault, memory_fault=memory_fault, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoWarn=ddmTempLoWarn, module_present=module_present, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, txPwrHiAlarm=txPwrHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, core_dump=core_dump, psu_fault=psu_fault, txBiasHiWarn=txBiasHiWarn, power_fault=power_fault, raidEvent=raidEvent, drive_thermal_throttle=drive_thermal_throttle)
