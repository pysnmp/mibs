...
alertDescription, alertSource, alertEffect, alertTimeStamp, f5AlertNotificationGroup, f5Alerts, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertSource", "alertEffect", "alertTimeStamp", "f5AlertNotificationGroup", "f5Alerts", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", module_communication_error=module_communication_error, service_health=service_health, backplane=backplane, ddmTempHiWarn=ddmTempHiWarn, raidEvent=raidEvent, ddmTempHiAlarm=ddmTempHiAlarm, firmware_update_status=firmware_update_status, drive_capacity_fault=drive_capacity_fault, blade_hardware_fault=blade_hardware_fault, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, rxPwrLoWarn=rxPwrLoWarn, txBiasLoWarn=txBiasLoWarn, txPwrLoWarn=txPwrLoWarn, thermal_fault=thermal_fault, core_dump=core_dump, memory_fault=memory_fault, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, lcd_fault=lcd_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, power_fault=power_fault, rxPwrHiAlarm=rxPwrHiAlarm, txPwrHiAlarm=txPwrHiAlarm, txPwrLoAlarm=txPwrLoAlarm, unknown_alarm=unknown_alarm, rxPwrHiWarn=rxPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, f5AlertNotification=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, fipsError=fipsError, ddmVccLoAlarm=ddmVccLoAlarm, cpu_fault=cpu_fault, blade_thermal_fault=blade_thermal_fault, txPwrHiWarn=txPwrHiWarn, ddmVccLoWarn=ddmVccLoWarn, psu_fault=psu_fault, aom_fault=aom_fault, firmware_fault=firmware_fault, module_present=module_present, txBiasHiAlarm=txBiasHiAlarm, drive_fault=drive_fault, drive_thermal_throttle=drive_thermal_throttle, PYSNMP_MODULE_ID=f5AlertNotification, hardware_device_fault=hardware_device_fault, ddmVccHiWarn=ddmVccHiWarn)
