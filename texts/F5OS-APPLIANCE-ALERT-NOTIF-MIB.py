...
alertSeverity, f5Alerts, alertSource, alertTimeStamp, alertEffect, alertDescription, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5Alerts", "alertSource", "alertTimeStamp", "alertEffect", "alertDescription", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", firmware_fault=firmware_fault, psu_fault=psu_fault, txBiasHiAlarm=txBiasHiAlarm, lcd_fault=lcd_fault, txPwrLoAlarm=txPwrLoAlarm, core_dump=core_dump, txPwrHiWarn=txPwrHiWarn, thermal_fault=thermal_fault, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, memory_fault=memory_fault, pcie_fault=pcie_fault, aom_fault=aom_fault, txPwrLoWarn=txPwrLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, blade_thermal_fault=blade_thermal_fault, blade_hardware_fault=blade_hardware_fault, service_health=service_health, ddmVccHiWarn=ddmVccHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiAlarm=txPwrHiAlarm, firmware_update_status=firmware_update_status, drive_thermal_throttle=drive_thermal_throttle, txBiasLoAlarm=txBiasLoAlarm, drive_capacity_fault=drive_capacity_fault, unknown_alarm=unknown_alarm, raidEvent=raidEvent, rxPwrHiWarn=rxPwrHiWarn, txBiasHiWarn=txBiasHiWarn, drive_fault=drive_fault, txBiasLoWarn=txBiasLoWarn, hardware_device_fault=hardware_device_fault, ddmVccLoWarn=ddmVccLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, module_present=module_present, fipsError=fipsError, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempLoWarn=ddmTempLoWarn, module_communication_error=module_communication_error, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, power_fault=power_fault, cpu_fault=cpu_fault, backplane=backplane)
