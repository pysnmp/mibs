...
alertDescription, f5Alerts, alertEffect, alertSource, f5AlertNotificationGroup, alertTimeStamp, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "f5Alerts", "alertEffect", "alertSource", "f5AlertNotificationGroup", "alertTimeStamp", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", f5AlertNotification=f5AlertNotification, thermal_fault=thermal_fault, txBiasHiWarn=txBiasHiWarn, raidEvent=raidEvent, txPwrLoWarn=txPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, ddmVccLoWarn=ddmVccLoWarn, fipsError=fipsError, backplane=backplane, lcd_fault=lcd_fault, rxPwrLoAlarm=rxPwrLoAlarm, power_fault=power_fault, txPwrHiAlarm=txPwrHiAlarm, module_present=module_present, rxPwrHiWarn=rxPwrHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, hardware_device_fault=hardware_device_fault, cpu_fault=cpu_fault, ddmTempHiWarn=ddmTempHiWarn, txPwrHiWarn=txPwrHiWarn, pcie_fault=pcie_fault, blade_thermal_fault=blade_thermal_fault, core_dump=core_dump, txBiasHiAlarm=txBiasHiAlarm, unknown_alarm=unknown_alarm, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiWarn=ddmVccHiWarn, firmware_update_status=firmware_update_status, drive_utilization=drive_utilization, txBiasLoAlarm=txBiasLoAlarm, txBiasLoWarn=txBiasLoWarn, psu_fault=psu_fault, ddmTempHiAlarm=ddmTempHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoAlarm=txPwrLoAlarm, rxPwrLoWarn=rxPwrLoWarn, blade_hardware_fault=blade_hardware_fault, drive_fault=drive_fault, module_communication_error=module_communication_error, ddmVccHiAlarm=ddmVccHiAlarm, firmware_fault=firmware_fault, drive_thermal_throttle=drive_thermal_throttle, service_health=service_health, drive_capacity_fault=drive_capacity_fault, aom_fault=aom_fault)
