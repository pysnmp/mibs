...
alertTimeStamp, alertDescription, alertSource, alertSeverity, f5Alerts, alertEffect, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertDescription", "alertSource", "alertSeverity", "f5Alerts", "alertEffect", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccHiWarn=ddmVccHiWarn, core_dump=core_dump, firmware_update_status=firmware_update_status, drive_thermal_throttle=drive_thermal_throttle, ddmTempLoWarn=ddmTempLoWarn, drive_utilization=drive_utilization, psu_fault=psu_fault, backplane=backplane, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempLoAlarm=ddmTempLoAlarm, drive_fault=drive_fault, txPwrHiWarn=txPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, power_fault=power_fault, ddmVccHiAlarm=ddmVccHiAlarm, txBiasLoWarn=txBiasLoWarn, txBiasLoAlarm=txBiasLoAlarm, txPwrLoAlarm=txPwrLoAlarm, blade_thermal_fault=blade_thermal_fault, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, fipsError=fipsError, firmware_fault=firmware_fault, raidEvent=raidEvent, ddmTempHiAlarm=ddmTempHiAlarm, thermal_fault=thermal_fault, unknown_alarm=unknown_alarm, memory_fault=memory_fault, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, lcd_fault=lcd_fault, cpu_fault=cpu_fault, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, ddmTempHiWarn=ddmTempHiWarn, hardware_device_fault=hardware_device_fault, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrHiAlarm=txPwrHiAlarm, service_health=service_health, module_present=module_present, aom_fault=aom_fault, txBiasHiAlarm=txBiasHiAlarm, blade_hardware_fault=blade_hardware_fault, f5AlertNotification=f5AlertNotification, rxPwrHiAlarm=rxPwrHiAlarm)
