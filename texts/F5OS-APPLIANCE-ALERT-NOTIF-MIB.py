...
f5AlertNotificationGroup, alertSeverity, alertDescription, alertEffect, alertTimeStamp, f5Alerts, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "alertDescription", "alertEffect", "alertTimeStamp", "f5Alerts", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", thermal_fault=thermal_fault, drive_utilization=drive_utilization, txBiasLoAlarm=txBiasLoAlarm, memory_fault=memory_fault, ddmTempLoAlarm=ddmTempLoAlarm, backplane=backplane, txPwrLoWarn=txPwrLoWarn, core_dump=core_dump, module_present=module_present, rxPwrLoWarn=rxPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, txBiasHiAlarm=txBiasHiAlarm, txBiasLoWarn=txBiasLoWarn, PYSNMP_MODULE_ID=f5AlertNotification, raidEvent=raidEvent, cpu_fault=cpu_fault, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoWarn=ddmVccLoWarn, txPwrHiWarn=txPwrHiWarn, txPwrHiAlarm=txPwrHiAlarm, psu_fault=psu_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, power_fault=power_fault, unknown_alarm=unknown_alarm, lcd_fault=lcd_fault, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, drive_thermal_throttle=drive_thermal_throttle, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, blade_hardware_fault=blade_hardware_fault, module_communication_error=module_communication_error, firmware_update_status=firmware_update_status, hardware_device_fault=hardware_device_fault, txBiasHiWarn=txBiasHiWarn, drive_capacity_fault=drive_capacity_fault, firmware_fault=firmware_fault, blade_thermal_fault=blade_thermal_fault, service_health=service_health, txPwrLoAlarm=txPwrLoAlarm, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoWarn=ddmTempLoWarn, drive_fault=drive_fault, f5AlertNotification=f5AlertNotification, pcie_fault=pcie_fault, ddmVccHiAlarm=ddmVccHiAlarm, aom_fault=aom_fault)
