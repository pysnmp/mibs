...
f5Alerts, f5AlertNotificationGroup, alertSource, alertTimeStamp, alertEffect, alertDescription, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "f5AlertNotificationGroup", "alertSource", "alertTimeStamp", "alertEffect", "alertDescription", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", psu_fault=psu_fault, blade_thermal_fault=blade_thermal_fault, lcd_fault=lcd_fault, txPwrHiWarn=txPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, raidEvent=raidEvent, thermal_fault=thermal_fault, fipsError=fipsError, ddmVccHiAlarm=ddmVccHiAlarm, drive_utilization=drive_utilization, rxPwrHiWarn=rxPwrHiWarn, ddmVccLoWarn=ddmVccLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, core_dump=core_dump, service_health=service_health, backplane=backplane, aom_fault=aom_fault, drive_capacity_fault=drive_capacity_fault, drive_fault=drive_fault, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, txBiasHiAlarm=txBiasHiAlarm, firmware_update_status=firmware_update_status, txBiasHiWarn=txBiasHiWarn, firmware_fault=firmware_fault, drive_thermal_throttle=drive_thermal_throttle, blade_hardware_fault=blade_hardware_fault, ddmTempLoWarn=ddmTempLoWarn, txBiasLoAlarm=txBiasLoAlarm, txPwrHiAlarm=txPwrHiAlarm, power_fault=power_fault, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertNotification=f5AlertNotification, module_present=module_present, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, module_communication_error=module_communication_error, pcie_fault=pcie_fault, txPwrLoAlarm=txPwrLoAlarm, unknown_alarm=unknown_alarm, txPwrLoWarn=txPwrLoWarn, cpu_fault=cpu_fault, memory_fault=memory_fault, hardware_device_fault=hardware_device_fault, txBiasLoWarn=txBiasLoWarn, rxPwrLoWarn=rxPwrLoWarn)
