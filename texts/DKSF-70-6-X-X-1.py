...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:16:36 2024
...
TimeTicks, Gauge32, MibIdentifier, Counter32, Unsigned32, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ObjectIdentity, ModuleIdentity, Integer32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibIdentifier", "Counter32", "Unsigned32", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter64", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npCurLoopTrapI=npCurLoopTrapI, npThermoTraps=npThermoTraps, npSmokePower=npSmokePower, npIr=npIr, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoMemo=npThermoMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopPower=npCurLoopPower, npThermoTrapValue=npThermoTrapValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npThermoValuePrecise=npThermoValuePrecise, npThermoHigh=npThermoHigh, npIrStatus=npIrStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoLow=npThermoLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npGsmTrap=npGsmTrap, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npThermoTrapHigh=npThermoTrapHigh, npThermo=npThermo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoop=npCurLoop, npCurLoopV=npCurLoopV, npForcedReboot=npForcedReboot, npThermoTrap=npThermoTrap, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npThermoEntry=npThermoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrap=npRelHumTrap, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMemo=npRelayMemo, npCurLoopR=npCurLoopR, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npGsm=npGsm, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, lightcom=lightcom, npRelayEntry=npRelayEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npGsmFailed=npGsmFailed, npRelayState=npRelayState, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumN=npRelHumN, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, npIo=npIo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npRelHumidity=npRelHumidity, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npIoTraps=npIoTraps, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npCurLoopEntry=npCurLoopEntry, npGsmInfo=npGsmInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npTrapInfo=npTrapInfo)
