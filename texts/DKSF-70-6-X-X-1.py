...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:03:39 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso, ObjectIdentity, Gauge32, Counter32, Bits, TimeTicks, IpAddress, enterprises, ModuleIdentity, MibIdentifier, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso", "ObjectIdentity", "Gauge32", "Counter32", "Bits", "TimeTicks", "IpAddress", "enterprises", "ModuleIdentity", "MibIdentifier", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTable=npCurLoopTable, npThermoLow=npThermoLow, npCurLoopTrap=npCurLoopTrap, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelay=npRelay, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumEntry=npRelHumEntry, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npIoTable=npIoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempValue=npRelHumTempValue, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npThermoTraps=npThermoTraps, npCurLoop=npCurLoop, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValuePrecise=npThermoValuePrecise, npIrReset=npIrReset, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npResetStack=npResetStack, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapN=npCurLoopTrapN, npRelHumMemo=npRelHumMemo, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeSensorN=npSmokeSensorN, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npGsm=npGsm, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoSensorN=npThermoSensorN, npSmokeMemo=npSmokeMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npRelHumTrapSafe=npRelHumTrapSafe, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npRelayTable=npRelayTable, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npGsmInfo=npGsmInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps)
