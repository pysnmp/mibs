...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:14:46 2024
...
enterprises, IpAddress, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, TimeTicks, Unsigned32, iso, Integer32, Bits, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Unsigned32", "iso", "Integer32", "Bits", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempValue=npRelHumTempValue, npSmokeStatus=npSmokeStatus, npRelay=npRelay, npThermoTrapLow=npThermoTrapLow, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, npThermoMemo=npThermoMemo, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npCurLoopR=npCurLoopR, npRelHumidity=npRelHumidity, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrReset=npIrReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npResetStack=npResetStack, npRelHumEntry=npRelHumEntry, npSmokeReset=npSmokeReset, npGsmFailed=npGsmFailed, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npIrCtrl=npIrCtrl, npCurLoopPower=npCurLoopPower, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npIoLineN=npIoLineN, npIr=npIr, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npIoPulseCounter=npIoPulseCounter, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npRelayState=npRelayState, npGsmTrap=npGsmTrap, npSmokeTraps=npSmokeTraps, npIo=npIo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopN=npCurLoopN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsm=npGsm, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopV=npCurLoopV, npSmokeTrap=npSmokeTrap, npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeMemo=npSmokeMemo, npRelHumValue=npRelHumValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npThermo=npThermo, npCurLoop=npCurLoop, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npIoTable=npIoTable, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npSoftReboot=npSoftReboot, npGsmInfo=npGsmInfo, npThermoLow=npThermoLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo)
