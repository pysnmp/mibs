...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:12:55 2022
...
Integer32, iso, ObjectIdentity, enterprises, TimeTicks, Counter64, IpAddress, MibIdentifier, Counter32, Unsigned32, ModuleIdentity, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ObjectIdentity", "enterprises", "TimeTicks", "Counter64", "IpAddress", "MibIdentifier", "Counter32", "Unsigned32", "ModuleIdentity", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npIr=npIr, npResetStack=npResetStack, npThermoTable=npThermoTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmInfo=npGsmInfo, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npRelHumTable=npRelHumTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npSmokeTraps=npSmokeTraps, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npSmokeSensorN=npSmokeSensorN, npSmoke=npSmoke, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npIoTraps=npIoTraps, npGsm=npGsm, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npIoLevelOut=npIoLevelOut, npReboot=npReboot, npIo=npIo, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npThermoTrap=npThermoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npThermoValue=npThermoValue, npIoTrapMemo=npIoTrapMemo, npRelayTable=npRelayTable, npIrReset=npIrReset, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npRelayMode=npRelayMode, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrap=npSmokeTrap, npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npIrCtrl=npIrCtrl, npIoTrapLineN=npIoTrapLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopEntry=npCurLoopEntry, npGsmRegistration=npGsmRegistration, npThermoStatus=npThermoStatus, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npThermoMemo=npThermoMemo, lightcom=lightcom, FixedPoint1000=FixedPoint1000, npThermoEntry=npThermoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopR=npCurLoopR, npCurLoopTrap=npCurLoopTrap, npThermoTraps=npThermoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npThermoValuePrecise=npThermoValuePrecise, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npIoPulseCounter=npIoPulseCounter, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8)
