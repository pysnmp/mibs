...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:15:09 2024
...
Counter32, Unsigned32, Integer32, ObjectIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, ModuleIdentity, Counter64, MibIdentifier, IpAddress, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Integer32", "ObjectIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npReboot=npReboot, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapI=npCurLoopTrapI, npSmokeTable=npSmokeTable, npRelayMode=npRelayMode, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumN=npRelHumN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMemo=npRelayMemo, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npGsmFailed=npGsmFailed, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npRelHumTrap=npRelHumTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoLow=npThermoLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npRelay=npRelay, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapR=npCurLoopTrapR, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npIoLevelOut=npIoLevelOut, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, npRelayN=npRelayN, npIoEntry=npIoEntry, npThermoTrapLow=npThermoTrapLow, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoHigh=npThermoHigh, npIo=npIo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npThermoTrapSensorN=npThermoTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopI=npCurLoopI, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npIrPlayCmd=npIrPlayCmd, npResetStack=npResetStack, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npThermoStatus=npThermoStatus, FixedPoint1000=FixedPoint1000, npThermoTraps=npThermoTraps, npRelHumStatus=npRelHumStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTable=npThermoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapN=npCurLoopTrapN, npThermoTrap=npThermoTrap, npCurLoopN=npCurLoopN, npThermoValue=npThermoValue, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents)
