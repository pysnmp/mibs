...
IpAddress, ModuleIdentity, Counter32, TimeTicks, ObjectIdentity, Counter64, Gauge32, Integer32, NotificationType, iso, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Counter32", "TimeTicks", "ObjectIdentity", "Counter64", "Gauge32", "Integer32", "NotificationType", "iso", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapN=npCurLoopTrapN, npCurLoop=npCurLoop, npSmokePower=npSmokePower, lightcom=lightcom, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npCurLoopTraps=npCurLoopTraps, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTable=npRelHumTable, npIoMemo=npIoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmInfo=npGsmInfo, npThermoStatus=npThermoStatus, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTable=npIoTable, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumN=npRelHumN, npRelHumidity=npRelHumidity, npRelHumTrapData=npRelHumTrapData, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsm=npGsm, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, npCurLoopI=npCurLoopI, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npRelHumTrap=npRelHumTrap, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumStatus=npRelHumStatus, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npThermoValue=npThermoValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npReboot=npReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npCurLoopPower=npCurLoopPower, npForcedReboot=npForcedReboot, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrap=npCurLoopTrap, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npGsmRegistration=npGsmRegistration, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npSmokeEntry=npSmokeEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npIrReset=npIrReset, npRelayState=npRelayState, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumMemo=npRelHumMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack)
