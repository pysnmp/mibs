...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:37:36 2023
...
iso, MibIdentifier, Counter32, NotificationType, ModuleIdentity, enterprises, Counter64, TimeTicks, Integer32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Counter32", "NotificationType", "ModuleIdentity", "enterprises", "Counter64", "TimeTicks", "Integer32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTable=npCurLoopTable, npThermoValue=npThermoValue, npThermoTrap=npThermoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npRelHumTempValue=npRelHumTempValue, npThermoLow=npThermoLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmFailed=npGsmFailed, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npSoftReboot=npSoftReboot, npCurLoopN=npCurLoopN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumN=npRelHumN, npSmokeTable=npSmokeTable, npIr=npIr, npForcedReboot=npForcedReboot, npIrCtrl=npIrCtrl, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npGsm=npGsm, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npIoEntry=npIoEntry, npRelay=npRelay, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npSmokePower=npSmokePower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrap=npIoTrap, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayN=npRelayN, npSmokeStatus=npSmokeStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npRelHumTrapData=npRelHumTrapData, npRelayMemo=npRelayMemo, npGsmInfo=npGsmInfo, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN, npIoLevelIn=npIoLevelIn, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLineN=npIoTrapLineN, npGsmTraps=npGsmTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, lightcom=lightcom, npIo=npIo, npSmokeEntry=npSmokeEntry, npReboot=npReboot, npCurLoopV=npCurLoopV, npSmoke=npSmoke, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopI=npCurLoopI, npRelHumTrap=npRelHumTrap, npRelHumStatus=npRelHumStatus, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npGsmTrap=npGsmTrap)
