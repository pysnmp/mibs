...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:02:09 2023
...
Counter32, Counter64, Gauge32, MibIdentifier, Integer32, ObjectIdentity, TimeTicks, Unsigned32, enterprises, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "Integer32", "ObjectIdentity", "TimeTicks", "Unsigned32", "enterprises", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopN=npCurLoopN, npCurLoop=npCurLoop, npIoPulseCounter=npIoPulseCounter, npRelHumEntry=npRelHumEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npIrReset=npIrReset, npSmokeStatus=npSmokeStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIr=npIr, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsm=npGsm, npGsmTraps=npGsmTraps, npIoTrapLineN=npIoTrapLineN, npRelHumTrap=npRelHumTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npRelHumTrapSafe=npRelHumTrapSafe, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npGsmTrap=npGsmTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapHigh=npThermoTrapHigh, lightcom=lightcom, npCurLoopTrapR=npCurLoopTrapR, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTable=npCurLoopTable, npSmokeTraps=npSmokeTraps, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npIoTable=npIoTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npIoTrap=npIoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npTrapEmailTo=npTrapEmailTo, npRelHumTempValue=npRelHumTempValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npThermoTraps=npThermoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTemp=npRelHumTrapTemp, npReboot=npReboot, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npThermo=npThermo, npRelHumValue=npRelHumValue, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npIrStatus=npIrStatus, npRelay=npRelay, npResetStack=npResetStack, npIoMemo=npIoMemo, npSmoke=npSmoke, npIoTrapLevelLegend=npIoTrapLevelLegend, npIo=npIo, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npSoftReboot=npSoftReboot)
