...
Gauge32, Counter64, enterprises, ModuleIdentity, Integer32, Unsigned32, Counter32, NotificationType, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "enterprises", "ModuleIdentity", "Integer32", "Unsigned32", "Counter32", "NotificationType", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", lightcom=lightcom, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrap=npRelHumTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npSmokeSensorN=npSmokeSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelayN=npRelayN, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrap=npSmokeTrap, npThermoValue=npThermoValue, npThermoHigh=npThermoHigh, npThermo=npThermo, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumEntry=npRelHumEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayTable=npRelayTable, npSmokePower=npSmokePower, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npIoTrapLineN=npIoTrapLineN, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapStatus=npThermoTrapStatus, npRelayEntry=npRelayEntry, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npThermoTrapHigh=npThermoTrapHigh, npTrapEmailTo=npTrapEmailTo, npThermoEntry=npThermoEntry, npIoTrapMemo=npIoTrapMemo, npGsmFailed=npGsmFailed, npRelHumMemo=npRelHumMemo, npCurLoopN=npCurLoopN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoop=npCurLoop, npResetStack=npResetStack, npReboot=npReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npThermoStatus=npThermoStatus, npRelay=npRelay, npIoEntry=npIoEntry, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeMemo=npSmokeMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapSensorN=npThermoTrapSensorN, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npCurLoopPower=npCurLoopPower, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npForcedReboot=npForcedReboot, npIoMemo=npIoMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npRelayMode=npRelayMode, npGsm=npGsm, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npGsmInfo=npGsmInfo, npCurLoopTraps=npCurLoopTraps, npIrCtrl=npIrCtrl, npIoTrap=npIoTrap, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npIo=npIo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempValue=npRelHumTempValue, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npIr=npIr, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmStrength=npGsmStrength, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter)
