...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:02:00 2023
...
Integer32, iso, Gauge32, ModuleIdentity, Counter64, MibIdentifier, Unsigned32, IpAddress, TimeTicks, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "ModuleIdentity", "Counter64", "MibIdentifier", "Unsigned32", "IpAddress", "TimeTicks", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapMemo=npIoTrapMemo, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoLow=npThermoLow, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npIrReset=npIrReset, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoSensorN=npThermoSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrap=npSmokeTrap, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMemo=npRelayMemo, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapI=npCurLoopTrapI, npIo=npIo, npRelay=npRelay, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npCurLoopI=npCurLoopI, npRelHumTable=npRelHumTable, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npThermoTrapLow=npThermoTrapLow, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npThermo=npThermo, npIoTraps=npIoTraps, npIoLineN=npIoLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopStatus=npCurLoopStatus, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, npGsmTraps=npGsmTraps, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSoftReboot=npSoftReboot, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npRelHumN=npRelHumN, npSmokeTable=npSmokeTable, npThermoTrapSensorN=npThermoTrapSensorN, npThermoEntry=npThermoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseStart=npIoSinglePulseStart, uniPingServerSolutionV3=uniPingServerSolutionV3, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npTrapEmailTo=npTrapEmailTo, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npResetStack=npResetStack, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoMemo=npIoMemo, npRelayN=npRelayN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npSmokeStatus=npSmokeStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayEntry=npRelayEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npIoTable=npIoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTable=npCurLoopTable, npThermoHigh=npThermoHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmFailed=npGsmFailed)
