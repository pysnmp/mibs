...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:10:29 2023
...
ModuleIdentity, Bits, Integer32, ObjectIdentity, iso, NotificationType, IpAddress, TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Integer32", "ObjectIdentity", "iso", "NotificationType", "IpAddress", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrap=npIoTrap, npCurLoopStatus=npCurLoopStatus, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapPrefix=npSmokeTrapPrefix, lightcom=lightcom, npThermoSensorN=npThermoSensorN, npRelayTable=npRelayTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npSmokeMemo=npSmokeMemo, npThermoMemo=npThermoMemo, npIrPlayCmd=npIrPlayCmd, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npRelHumTempStatus=npRelHumTempStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npIrCtrl=npIrCtrl, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npGsmInfo=npGsmInfo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npGsmTrap=npGsmTrap, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npTrapInfo=npTrapInfo, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npCurLoopV=npCurLoopV, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npSmokeReset=npSmokeReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTable=npThermoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npIoTable=npIoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelOut=npIoLevelOut, npThermoTrapStatus=npThermoTrapStatus, npIoMemo=npIoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIo=npIo, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npCurLoopPower=npCurLoopPower, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeEntry=npSmokeEntry, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTable=npCurLoopTable, npIr=npIr, npSmokeStatus=npSmokeStatus, npThermoHigh=npThermoHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoop=npCurLoop, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npThermo=npThermo, npForcedReboot=npForcedReboot, npSoftReboot=npSoftReboot, npRelayN=npRelayN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmoke=npSmoke, npRelayStartReset=npRelayStartReset, npIoTrapMemo=npIoTrapMemo)
