...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:42:35 2022
...
ModuleIdentity, Bits, Integer32, iso, Counter64, IpAddress, ObjectIdentity, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Unsigned32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Integer32", "iso", "Counter64", "IpAddress", "ObjectIdentity", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Unsigned32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npIrPlayCmd=npIrPlayCmd, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTraps=npCurLoopTraps, npReboot=npReboot, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopI=npCurLoopI, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeReset=npSmokeReset, npSmokeSensorN=npSmokeSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelOut=npIoLevelOut, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npRelayN=npRelayN, npThermoLow=npThermoLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrap=npThermoTrap, npThermoTraps=npThermoTraps, npIr=npIr, npIoTable=npIoTable, npRelHumN=npRelHumN, npRelHumTempStatus=npRelHumTempStatus, npResetStack=npResetStack, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLineN=npIoLineN, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npSoftReboot=npSoftReboot, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npIo=npIo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelIn=npIoTrapLevelIn, npIrCtrl=npIrCtrl, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npSmokeStatus=npSmokeStatus, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npThermoHigh=npThermoHigh, npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npIoLevelIn=npIoLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapPrefix=npIoTrapPrefix, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelay=npRelay, npIoMemo=npIoMemo, npThermo=npThermo, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npIrStatus=npIrStatus, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npSmokeEntry=npSmokeEntry, npCurLoopPower=npCurLoopPower, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart)
