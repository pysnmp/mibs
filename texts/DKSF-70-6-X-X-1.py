...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:18:59 2024
...
Bits, Integer32, TimeTicks, NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, IpAddress, iso, Counter32, MibIdentifier, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "TimeTicks", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "IpAddress", "iso", "Counter32", "MibIdentifier", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npIoLevelOut=npIoLevelOut, npSmokePower=npSmokePower, npGsm=npGsm, npThermoTraps=npThermoTraps, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayN=npRelayN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapSafe=npRelHumTrapSafe, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npRelayTable=npRelayTable, npCurLoopTrapN=npCurLoopTrapN, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumN=npRelHumN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npCurLoopTrap=npCurLoopTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumStatus=npRelHumStatus, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npRelayStartReset=npRelayStartReset, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoHigh=npThermoHigh, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npThermoEntry=npThermoEntry, npThermoTrapMemo=npThermoTrapMemo, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npRelay=npRelay, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npCurLoopI=npCurLoopI, npCurLoop=npCurLoop, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, npIrCtrl=npIrCtrl, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopStatus=npCurLoopStatus, npCurLoopV=npCurLoopV, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npIoLineN=npIoLineN, npRelayMode=npRelayMode, npCurLoopTable=npCurLoopTable, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npTrapInfo=npTrapInfo, npThermoTrapLow=npThermoTrapLow, npIoMemo=npIoMemo, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npResetStack=npResetStack, npSmoke=npSmoke, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN)
