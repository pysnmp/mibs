...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:07:50 2023
...
Counter32, MibIdentifier, enterprises, NotificationType, Bits, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Counter64, TimeTicks, Gauge32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "enterprises", "NotificationType", "Bits", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Counter64", "TimeTicks", "Gauge32", "Integer32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayTable=npRelayTable, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npThermoTrapLow=npThermoTrapLow, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopPower=npCurLoopPower, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npIoLevelIn=npIoLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npGsm=npGsm, npSmoke=npSmoke, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoEntry=npIoEntry, npGsmRegistration=npGsmRegistration, npIrReset=npIrReset, npRelay=npRelay, npRelayMode=npRelayMode, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npIr=npIr, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTable=npCurLoopTable, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, lightcom=lightcom, npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npIoPulseCounter=npIoPulseCounter, npSmokePower=npSmokePower, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrap=npRelHumTrap, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npCurLoop=npCurLoop, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopN=npCurLoopN, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPower=npCurLoopTrapPower, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npIoTrap=npIoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npIoTraps=npIoTraps, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npThermo=npThermo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus)
