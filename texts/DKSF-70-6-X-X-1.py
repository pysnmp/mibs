...
# Produced by pysmi-1.1.12 at Wed May 29 10:25:27 2024
...
iso, IpAddress, Integer32, Counter32, Counter64, NotificationType, ObjectIdentity, Unsigned32, TimeTicks, MibIdentifier, enterprises, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Integer32", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "enterprises", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npThermo=npThermo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npCurLoopStatus=npCurLoopStatus, npIoTrap=npIoTrap, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npThermoHigh=npThermoHigh, npSmokeTrapStatus=npSmokeTrapStatus, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npThermoTraps=npThermoTraps, FixedPoint1000=FixedPoint1000, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npThermoTrapStatus=npThermoTrapStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoop=npCurLoop, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValuePrecise=npThermoValuePrecise, npTrapInfo=npTrapInfo, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npRelHumTrapTemp=npRelHumTrapTemp, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npSmokeStatus=npSmokeStatus, npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumidity=npRelHumidity, npForcedReboot=npForcedReboot, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTable=npSmokeTable, npReboot=npReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, npThermoTrapLow=npThermoTrapLow, npRelayStartReset=npRelayStartReset, npSmokePower=npSmokePower, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npSmoke=npSmoke, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npRelay=npRelay, npCurLoopR=npCurLoopR, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeReset=npSmokeReset, npIoMemo=npIoMemo, npCurLoopN=npCurLoopN, npCurLoopTrapR=npCurLoopTrapR, npResetStack=npResetStack, npIoTrapLineN=npIoTrapLineN, npIo=npIo, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm)
