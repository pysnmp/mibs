...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:58:02 2022
...
NotificationType, ObjectIdentity, TimeTicks, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, enterprises, Integer32, MibIdentifier, Counter32, IpAddress, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "enterprises", "Integer32", "MibIdentifier", "Counter32", "IpAddress", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npIr=npIr, npTrapInfo=npTrapInfo, npGsmRegistration=npGsmRegistration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npRelayMode=npRelayMode, npSmokePower=npSmokePower, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumidity=npRelHumidity, npIrCtrl=npIrCtrl, lightcom=lightcom, npIrReset=npIrReset, npThermoLow=npThermoLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumValue=npRelHumValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npIoTrapLineN=npIoTrapLineN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeReset=npSmokeReset, npCurLoopTrapV=npCurLoopTrapV, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npRelHumTable=npRelHumTable, npResetStack=npResetStack, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npIo=npIo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTraps=npSmokeTraps, npRelayStartReset=npRelayStartReset, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTable=npThermoTable, npCurLoopTrap=npCurLoopTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npIoLineN=npIoLineN, npCurLoopEntry=npCurLoopEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npIoTraps=npIoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npGsmInfo=npGsmInfo, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npThermoTrapLow=npThermoTrapLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeStatus=npSmokeStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayTable=npRelayTable, npIoTrap=npIoTrap, npRelHumEntry=npRelHumEntry, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npThermo=npThermo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap, npGsm=npGsm, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npCurLoopStatus=npCurLoopStatus, npGsmTraps=npGsmTraps, npThermoTrap=npThermoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapStatus=npThermoTrapStatus, npThermoMemo=npThermoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopI=npCurLoopI, npRelHumTrapData=npRelHumTrapData, npRelHumN=npRelHumN, npCurLoop=npCurLoop)
