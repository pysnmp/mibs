...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:02:20 2023
...
Bits, iso, Counter32, MibIdentifier, Integer32, ModuleIdentity, Gauge32, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, IpAddress, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Counter32", "MibIdentifier", "Integer32", "ModuleIdentity", "Gauge32", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTraps=npThermoTraps, npRelHumEntry=npRelHumEntry, npReboot=npReboot, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, npIr=npIr, npCurLoopR=npCurLoopR, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelay=npRelay, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npGsmInfo=npGsmInfo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoHigh=npThermoHigh, npIoLineN=npIoLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npIoEntry=npIoEntry, npRelHumTrapData=npRelHumTrapData, npTrapInfo=npTrapInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npForcedReboot=npForcedReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopStatus=npCurLoopStatus, npThermoLow=npThermoLow, npIoTrap=npIoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, FixedPoint1000=FixedPoint1000, npGsmTrap=npGsmTrap, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npIoSinglePulseStart=npIoSinglePulseStart, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npThermoTrap=npThermoTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npCurLoopTrapI=npCurLoopTrapI, npThermoStatus=npThermoStatus, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npGsmTraps=npGsmTraps, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLevelOut=npIoLevelOut, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapEmailTo=npTrapEmailTo, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npSmokeTrapMemo=npSmokeTrapMemo, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npRelHumMemo=npRelHumMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMemo=npRelayMemo, npIoTable=npIoTable, npThermoTable=npThermoTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTable=npCurLoopTable, npGsmFailed=npGsmFailed, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTraps=npIoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npCurLoopPower=npCurLoopPower, npThermoSensorN=npThermoSensorN, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumidity=npRelHumidity, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTraps=npSmokeTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npRelHumTable=npRelHumTable, npThermoTrapHigh=npThermoTrapHigh, npGsmStrength=npGsmStrength, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeReset=npSmokeReset, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable)
