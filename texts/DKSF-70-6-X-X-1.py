...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:33:10 2024
...
Bits, Counter32, enterprises, Gauge32, iso, TimeTicks, Unsigned32, MibIdentifier, Integer32, NotificationType, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "enterprises", "Gauge32", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTraps=npIoTraps, npRelHumTable=npRelHumTable, npIoLevelOut=npIoLevelOut, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npThermoTrap=npThermoTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npTrapInfo=npTrapInfo, npRelayMode=npRelayMode, npThermoTable=npThermoTable, npIr=npIr, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayN=npRelayN, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npSmokeTrap=npSmokeTrap, npRelHumValue=npRelHumValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npRelay=npRelay, npIoLineN=npIoLineN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoEntry=npThermoEntry, npCurLoopI=npCurLoopI, npResetStack=npResetStack, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopN=npCurLoopN, npCurLoopEntry=npCurLoopEntry, npRelHumTrapData=npRelHumTrapData, npRelHumTrapFail=npRelHumTrapFail, npGsm=npGsm, npRelayTable=npRelayTable, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npSmokeMemo=npSmokeMemo, npIoTrapPrefix=npIoTrapPrefix, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npReboot=npReboot, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapV=npCurLoopTrapV, npGsmFailed=npGsmFailed, npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeEntry=npSmokeEntry, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npRelHumN=npRelHumN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIo=npIo, npGsmStrength=npGsmStrength, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempValue=npRelHumTempValue, npThermoTrapMemo=npThermoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npIrPlayCmd=npIrPlayCmd, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npCurLoopPower=npCurLoopPower, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeSensorN=npSmokeSensorN, npIoMemo=npIoMemo, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npRelHumEntry=npRelHumEntry, npSmokeTable=npSmokeTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumStatus=npRelHumStatus)
