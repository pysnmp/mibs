...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:16:32 2022
...
enterprises, Gauge32, iso, Integer32, Counter64, TimeTicks, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, ObjectIdentity, ModuleIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "iso", "Integer32", "Counter64", "TimeTicks", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoop=npCurLoop, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npSmokeReset=npSmokeReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npThermoTrapHigh=npThermoTrapHigh, npCurLoopI=npCurLoopI, npCurLoopTrap=npCurLoopTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npSmokeTraps=npSmokeTraps, npGsm=npGsm, npIrCtrl=npIrCtrl, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumN=npRelHumN, npThermoLow=npThermoLow, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmInfo=npGsmInfo, npGsmFailed=npGsmFailed, npThermo=npThermo, npThermoHigh=npThermoHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelayState=npRelayState, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempFail=npRelHumTrapTempFail, FixedPoint1000=FixedPoint1000, npIrStatus=npIrStatus, npGsmTraps=npGsmTraps, npTrapInfo=npTrapInfo, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIo=npIo, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npCurLoopStatus=npCurLoopStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npRelayMode=npRelayMode, npThermoTraps=npThermoTraps, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npSmoke=npSmoke, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTable=npRelayTable, npRelHumTable=npRelHumTable, npThermoValue=npThermoValue)
