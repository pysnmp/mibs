...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:49:02 2022
...
Integer32, NotificationType, Counter32, ModuleIdentity, ObjectIdentity, IpAddress, Counter64, Gauge32, TimeTicks, Bits, enterprises, Unsigned32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter64", "Gauge32", "TimeTicks", "Bits", "enterprises", "Unsigned32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npReboot=npReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npCurLoopTable=npCurLoopTable, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTable=npIoTable, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npCurLoopR=npCurLoopR, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelIn=npIoLevelIn, npThermoTrapValue=npThermoTrapValue, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npCurLoopTrap=npCurLoopTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoStatus=npThermoStatus, npGsmInfo=npGsmInfo, npSmokeStatus=npSmokeStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTable=npRelHumTable, npRelayN=npRelayN, npIoLineN=npIoLineN, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npThermoLow=npThermoLow, npRelHumidity=npRelHumidity, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValue=npThermoValue, npRelay=npRelay, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npThermoTraps=npThermoTraps, npGsmStrength=npGsmStrength, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumStatus=npRelHumStatus, npIoTrapPrefix=npIoTrapPrefix, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopV=npCurLoopV, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npForcedReboot=npForcedReboot, npSmokePower=npSmokePower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npThermoMemo=npThermoMemo, npThermoValuePrecise=npThermoValuePrecise, npGsmRegistration=npGsmRegistration, npCurLoopI=npCurLoopI, npSoftReboot=npSoftReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npSmokeEntry=npSmokeEntry, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoMemo=npIoMemo, npSmoke=npSmoke, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npRelHumN=npRelHumN, npRelHumTempValue=npRelHumTempValue)
