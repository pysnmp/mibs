...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:54:44 2021
...
ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Bits, IpAddress, iso, enterprises, Counter32, TimeTicks, Counter64, Integer32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Bits", "IpAddress", "iso", "enterprises", "Counter32", "TimeTicks", "Counter64", "Integer32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npRelayMemo=npRelayMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npIoEntry=npIoEntry, npThermoHigh=npThermoHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npRelHumN=npRelHumN, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValuePrecise=npThermoValuePrecise, npCurLoopI=npCurLoopI, lightcom=lightcom, npThermoTraps=npThermoTraps, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npGsmRegistration=npGsmRegistration, npCurLoop=npCurLoop, npRelHumMemo=npRelHumMemo, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrStatus=npIrStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npIr=npIr, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTraps=npSmokeTraps, npThermoTrapPrefix=npThermoTrapPrefix, npGsmStrength=npGsmStrength, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npReboot=npReboot, npRelHumidity=npRelHumidity, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, npCurLoopTable=npCurLoopTable, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npRelayTable=npRelayTable, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npGsm=npGsm, npThermoEntry=npThermoEntry, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npSmokeStatus=npSmokeStatus, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayStartReset=npRelayStartReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeMemo=npSmokeMemo, npIo=npIo, npThermoTrapMemo=npThermoTrapMemo)
