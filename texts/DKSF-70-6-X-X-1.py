...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:51:31 2023
...
Integer32, TimeTicks, iso, IpAddress, Gauge32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Unsigned32, ModuleIdentity, enterprises, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "iso", "IpAddress", "Gauge32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Unsigned32", "ModuleIdentity", "enterprises", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokePower=npSmokePower, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopStatus=npCurLoopStatus, npThermoTrapHigh=npThermoTrapHigh, npThermoLow=npThermoLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLineN=npIoLineN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npIrCtrl=npIrCtrl, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTable=npRelHumTable, npIo=npIo, npIrPlayCmd=npIrPlayCmd, npGsm=npGsm, npSmokeMemo=npSmokeMemo, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopI=npCurLoopI, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npThermoTable=npThermoTable, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npThermoSensorN=npThermoSensorN, npGsmFailed=npGsmFailed, npIoTrapMemo=npIoTrapMemo, npThermoStatus=npThermoStatus, npTrapInfo=npTrapInfo, npCurLoopPower=npCurLoopPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoMemo=npThermoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npIrReset=npIrReset, npThermoEntry=npThermoEntry, npRelayStartReset=npRelayStartReset, npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoEntry=npIoEntry, npCurLoopTrapN=npCurLoopTrapN, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeStatus=npSmokeStatus, npCurLoop=npCurLoop, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopR=npCurLoopR, npIoLevelIn=npIoLevelIn, FixedPoint1000=FixedPoint1000, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapLow=npThermoTrapLow, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopV=npCurLoopV, npThermoTraps=npThermoTraps, npTrapEmailTo=npTrapEmailTo, npIoTrapPrefix=npIoTrapPrefix, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, lightcom=lightcom, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, npRelHumTempStatus=npRelHumTempStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npThermoValue=npThermoValue, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh)
