...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:20:01 2023
...
Counter64, IpAddress, Counter32, NotificationType, Unsigned32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Integer32, ModuleIdentity, ObjectIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Counter32", "NotificationType", "Unsigned32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Integer32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopStatus=npCurLoopStatus, npGsm=npGsm, npIr=npIr, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npRelHumN=npRelHumN, npGsmStrength=npGsmStrength, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npRelayTable=npRelayTable, npRelayState=npRelayState, npThermo=npThermo, npThermoLow=npThermoLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLineN=npIoTrapLineN, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npThermoSensorN=npThermoSensorN, npIoTrapPrefix=npIoTrapPrefix, npReboot=npReboot, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npIoMemo=npIoMemo, npThermoMemo=npThermoMemo, npIrStatus=npIrStatus, npThermoHigh=npThermoHigh, lightcom=lightcom, npRelHumEntry=npRelHumEntry, npIoLevelOut=npIoLevelOut, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npGsmTraps=npGsmTraps, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIo=npIo, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npCurLoopTrapN=npCurLoopTrapN, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrReset=npIrReset, npRelHumTrapFail=npRelHumTrapFail, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopEntry=npCurLoopEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapR=npCurLoopTrapR, npThermoTraps=npThermoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npIoEntry=npIoEntry, npRelHumTrapTemp=npRelHumTrapTemp)
