...
# Produced by pysmi-1.1.10 at Fri Nov 10 07:44:49 2023
...
Counter32, iso, NotificationType, Bits, enterprises, Gauge32, ObjectIdentity, Integer32, Unsigned32, IpAddress, TimeTicks, ModuleIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "NotificationType", "Bits", "enterprises", "Gauge32", "ObjectIdentity", "Integer32", "Unsigned32", "IpAddress", "TimeTicks", "ModuleIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, lightcom=lightcom, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npIoTrapMemo=npIoTrapMemo, npRelHumidity=npRelHumidity, npIoPulseCounter=npIoPulseCounter, npRelHumN=npRelHumN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npIoTrapLevelIn=npIoTrapLevelIn, npThermoStatus=npThermoStatus, npIoLineN=npIoLineN, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npIrStatus=npIrStatus, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrap=npSmokeTrap, npForcedReboot=npForcedReboot, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npRelHumTrapData=npRelHumTrapData, npIoMemo=npIoMemo, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIo=npIo, npThermoSensorN=npThermoSensorN, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrReset=npIrReset, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npThermoValue=npThermoValue, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopPower=npCurLoopPower, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTable=npIoTable, npRelayEntry=npRelayEntry, npIoEntry=npIoEntry, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrap=npCurLoopTrap, npIoTrapPrefix=npIoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, FixedPoint1000=FixedPoint1000, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopR=npCurLoopR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermo=npThermo, npRelayTable=npRelayTable, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTrapSafe=npRelHumTrapSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapMemo=npThermoTrapMemo, npRelHumTable=npRelHumTable)
