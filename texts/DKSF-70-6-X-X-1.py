...
# Produced by pysmi-1.1.12 at Mon Jul  1 10:57:26 2024
...
Bits, TimeTicks, MibIdentifier, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter32, Counter64, Integer32, ObjectIdentity, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibIdentifier", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter32", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoMemo=npIoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npIo=npIo, npRelayTable=npRelayTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npCurLoopTrapPower=npCurLoopTrapPower, npIrCtrl=npIrCtrl, npGsmFailed=npGsmFailed, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npCurLoopV=npCurLoopV, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npThermo=npThermo, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npCurLoopTrap=npCurLoopTrap, npThermoEntry=npThermoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npSmokeMemo=npSmokeMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npReboot=npReboot, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, npThermoStatus=npThermoStatus, npRelayState=npRelayState, npIoLevelIn=npIoLevelIn, npRelHumidity=npRelHumidity, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopN=npCurLoopN, npIrReset=npIrReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npIoTraps=npIoTraps, npIoTrapLineN=npIoTrapLineN, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmoke=npSmoke, npRelayN=npRelayN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npCurLoopStatus=npCurLoopStatus, npThermoTable=npThermoTable, npRelay=npRelay, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeEntry=npSmokeEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
