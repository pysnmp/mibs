...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:05:50 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Unsigned32, NotificationType, Bits, IpAddress, TimeTicks, Counter64, enterprises, Integer32, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Unsigned32", "NotificationType", "Bits", "IpAddress", "TimeTicks", "Counter64", "enterprises", "Integer32", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npGsmTrapPrefix=npGsmTrapPrefix, npThermoHigh=npThermoHigh, npRelHumValue=npRelHumValue, npGsmStrength=npGsmStrength, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npGsmInfo=npGsmInfo, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npIoTable=npIoTable, npTrapInfo=npTrapInfo, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapLow=npThermoTrapLow, npRelayEntry=npRelayEntry, npRelHumTable=npRelHumTable, npSoftReboot=npSoftReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapN=npCurLoopTrapN, npRelayMemo=npRelayMemo, lightcom=lightcom, npCurLoopN=npCurLoopN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempValue=npRelHumTempValue, npIr=npIr, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npReboot=npReboot, npThermoTrapValue=npThermoTrapValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npSmokeSensorN=npSmokeSensorN, npRelayState=npRelayState, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npCurLoopTable=npCurLoopTable, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npIo=npIo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelay=npRelay, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTraps=npGsmTraps, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumEntry=npRelHumEntry, npThermoLow=npThermoLow, npRelHumTrap=npRelHumTrap, npSmokeStatus=npSmokeStatus, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLineN=npIoLineN, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npThermoTrapPrefix=npThermoTrapPrefix, npIrCtrl=npIrCtrl, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumN=npRelHumN, npResetStack=npResetStack, npSmokeTable=npSmokeTable, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npThermoValuePrecise=npThermoValuePrecise, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeEntry=npSmokeEntry, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumidity=npRelHumidity, npRelHumTrapDataStatus=npRelHumTrapDataStatus)
