...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:11:31 2023
...
Counter32, Gauge32, enterprises, Unsigned32, iso, ModuleIdentity, Bits, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "enterprises", "Unsigned32", "iso", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapLow=npThermoTrapLow, npIoTraps=npIoTraps, npSmokeTraps=npSmokeTraps, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npSmokePower=npSmokePower, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapStatus=npThermoTrapStatus, npIrStatus=npIrStatus, npCurLoopTrap=npCurLoopTrap, npRelHumEntry=npRelHumEntry, npRelHumTable=npRelHumTable, npRelayStartReset=npRelayStartReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npRelayTable=npRelayTable, npSoftReboot=npSoftReboot, npRelHumMemo=npRelHumMemo, npSmokeStatus=npSmokeStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoEntry=npIoEntry, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npThermoSensorN=npThermoSensorN, npIr=npIr, npTrapInfo=npTrapInfo, npThermoTrapValue=npThermoTrapValue, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npRelHumTrapFail=npRelHumTrapFail, npThermoEntry=npThermoEntry, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npRelayState=npRelayState, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npGsmTrap=npGsmTrap, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npReboot=npReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npRelayMemo=npRelayMemo, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npRelHumValue=npRelHumValue, npThermo=npThermo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPower=npCurLoopTrapPower, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npSmoke=npSmoke, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoLow=npThermoLow, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, FixedPoint1000=FixedPoint1000, npIo=npIo, npThermoTrap=npThermoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npThermoTraps=npThermoTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npIoPulseCounter=npIoPulseCounter, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempValue=npRelHumTempValue, npCurLoopV=npCurLoopV, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npIrPlayCmd=npIrPlayCmd, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, lightcom=lightcom, npGsmInfo=npGsmInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents)
