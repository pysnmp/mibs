...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:07:25 2022
...
Counter64, ObjectIdentity, TimeTicks, Counter32, Gauge32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, iso, Bits, IpAddress, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32", "Gauge32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "iso", "Bits", "IpAddress", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npRelHumTempStatus=npRelHumTempStatus, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npRelayState=npRelayState, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npThermoLow=npThermoLow, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npThermoTrapPrefix=npThermoTrapPrefix, npResetStack=npResetStack, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoEntry=npThermoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMode=npRelayMode, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npRelayMemo=npRelayMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npCurLoopEntry=npCurLoopEntry, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTable=npRelHumTable, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npRelHumidity=npRelHumidity, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeLow=npRelHumSafeRangeLow, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopN=npCurLoopN, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npGsmFailed=npGsmFailed, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npGsmRegistration=npGsmRegistration, npIoLineN=npIoLineN, lightcom=lightcom, npSmokeReset=npSmokeReset, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTable=npSmokeTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoSensorN=npThermoSensorN, npRelayN=npRelayN, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npIr=npIr, npIoLevelIn=npIoLevelIn, npIoTrapLineN=npIoTrapLineN, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmoke=npSmoke, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTable=npThermoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap)
