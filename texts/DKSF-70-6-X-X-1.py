...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:12:49 2022
...
MibIdentifier, ObjectIdentity, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, NotificationType, ModuleIdentity, Bits, Integer32, Counter64, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "NotificationType", "ModuleIdentity", "Bits", "Integer32", "Counter64", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npRelHumN=npRelHumN, npCurLoopStatus=npCurLoopStatus, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npResetStack=npResetStack, npRelay=npRelay, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npRelHumMemo=npRelHumMemo, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npThermoTable=npThermoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npThermoHigh=npThermoHigh, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npRelHumTempValue=npRelHumTempValue, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrap=npIoTrap, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoPulseCounter=npIoPulseCounter, npThermoTrapPrefix=npThermoTrapPrefix, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrReset=npIrReset, npGsmStrength=npGsmStrength, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npRelHumTempStatus=npRelHumTempStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npThermoValue=npThermoValue, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npForcedReboot=npForcedReboot, npRelayState=npRelayState, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npCurLoop=npCurLoop, npGsmTraps=npGsmTraps, npCurLoopPower=npCurLoopPower, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npIo=npIo, npThermoEntry=npThermoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmRegistration=npGsmRegistration, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity)
