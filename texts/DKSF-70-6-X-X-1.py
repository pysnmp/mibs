...
# Produced by pysmi-1.1.12 at Fri Jul 19 08:58:23 2024
...
Unsigned32, Gauge32, MibIdentifier, enterprises, TimeTicks, Bits, Counter64, IpAddress, Integer32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "MibIdentifier", "enterprises", "TimeTicks", "Bits", "Counter64", "IpAddress", "Integer32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npThermoTrapStatus=npThermoTrapStatus, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npCurLoopPower=npCurLoopPower, npCurLoop=npCurLoop, npThermo=npThermo, lightcom=lightcom, npRelayMode=npRelayMode, npRelHumTempStatus=npRelHumTempStatus, npSmokeTraps=npSmokeTraps, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npSmokePower=npSmokePower, npIoEntry=npIoEntry, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumN=npRelHumN, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npIoMemo=npIoMemo, npThermoTrapMemo=npThermoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npForcedReboot=npForcedReboot, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrStatus=npIrStatus, npRelay=npRelay, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npRelHumTable=npRelHumTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeReset=npSmokeReset, npIr=npIr, npGsmFailed=npGsmFailed, npIoTrapMemo=npIoTrapMemo, npIoTraps=npIoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelayEntry=npRelayEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npIrCtrl=npIrCtrl, npRelHumTrapFail=npRelHumTrapFail, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npSmokeEntry=npSmokeEntry, npIrReset=npIrReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npIoTrap=npIoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npThermoTraps=npThermoTraps, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npReboot=npReboot, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumValue=npRelHumValue, npCurLoopV=npCurLoopV, npSmokeMemo=npSmokeMemo, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npTrapEmailTo=npTrapEmailTo, npSmoke=npSmoke, npThermoEntry=npThermoEntry, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayStartReset=npRelayStartReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npRelayState=npRelayState, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
