...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:34:24 2023
...
IpAddress, enterprises, MibIdentifier, ModuleIdentity, iso, ObjectIdentity, Bits, Gauge32, Unsigned32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "MibIdentifier", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "Gauge32", "Unsigned32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTable=npThermoTable, npIoTrap=npIoTrap, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayStartReset=npRelayStartReset, npCurLoopR=npCurLoopR, FixedPoint1000=FixedPoint1000, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npRelayState=npRelayState, npRelHumN=npRelHumN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoLow=npThermoLow, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelIn=npIoLevelIn, npSmokeMemo=npSmokeMemo, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTable=npCurLoopTable, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npIr=npIr, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, npThermoTrapValue=npThermoTrapValue, npIoTraps=npIoTraps, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npReboot=npReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, lightcom=lightcom, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npIoLineN=npIoLineN, npRelHumValue=npRelHumValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npThermoEntry=npThermoEntry, npResetStack=npResetStack, npSmokeStatus=npSmokeStatus, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npCurLoopN=npCurLoopN, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npThermoMemo=npThermoMemo, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelayTable=npRelayTable, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npCurLoopTrap=npCurLoopTrap, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npCurLoop=npCurLoop, npRelayN=npRelayN, npThermo=npThermo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoHigh=npThermoHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npGsmTrap=npGsmTrap, npIoLevelOut=npIoLevelOut, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npThermoValuePrecise=npThermoValuePrecise, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix)
