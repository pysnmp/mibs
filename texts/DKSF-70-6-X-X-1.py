...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:55:04 2021
...
IpAddress, enterprises, ObjectIdentity, Unsigned32, MibIdentifier, Integer32, Counter32, Counter64, NotificationType, ModuleIdentity, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Integer32", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoPulseCounter=npIoPulseCounter, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npRelayMode=npRelayMode, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npRelayTable=npRelayTable, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapTemp=npRelHumTrapTemp, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npCurLoopTable=npCurLoopTable, npGsm=npGsm, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npSmokeTable=npSmokeTable, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npThermoHigh=npThermoHigh, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelayState=npRelayState, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValue=npThermoValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapFail=npRelHumTrapFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npCurLoopR=npCurLoopR, npCurLoop=npCurLoop, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrap=npCurLoopTrap, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npThermoTable=npThermoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTraps=npCurLoopTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopPower=npCurLoopPower, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrStatus=npIrStatus, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npIoEntry=npIoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, npGsmInfo=npGsmInfo, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermo=npThermo, npGsmStrength=npGsmStrength, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npIo=npIo, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npIoTraps=npIoTraps)
