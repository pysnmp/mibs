...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:59:31 2024
...
Integer32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, ObjectIdentity, TimeTicks, NotificationType, Unsigned32, Counter32, Gauge32, ModuleIdentity, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "ObjectIdentity", "TimeTicks", "NotificationType", "Unsigned32", "Counter32", "Gauge32", "ModuleIdentity", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npRelHumTrapFail=npRelHumTrapFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoStatus=npThermoStatus, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, FixedPoint1000=FixedPoint1000, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npForcedReboot=npForcedReboot, npTrapInfo=npTrapInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrap=npGsmTrap, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npThermoHigh=npThermoHigh, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npRelHumEntry=npRelHumEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmFailed=npGsmFailed, npIoLevelOut=npIoLevelOut, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoPulseCounter=npIoPulseCounter, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelay=npRelay, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npSmokePower=npSmokePower, npThermo=npThermo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npRelHumN=npRelHumN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npThermoValue=npThermoValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTable=npIoTable, npSmokeEntry=npSmokeEntry, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapMemo=npThermoTrapMemo, npResetStack=npResetStack, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIo=npIo, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npCurLoopStatus=npCurLoopStatus, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npSmokeStatus=npSmokeStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npReboot=npReboot, npIrReset=npIrReset, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npCurLoopV=npCurLoopV, npCurLoopTraps=npCurLoopTraps, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo)
