...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:10:22 2022
...
iso, Bits, enterprises, ModuleIdentity, TimeTicks, Integer32, MibIdentifier, Unsigned32, IpAddress, NotificationType, ObjectIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "enterprises", "ModuleIdentity", "TimeTicks", "Integer32", "MibIdentifier", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npSmokeTraps=npSmokeTraps, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapLow=npThermoTrapLow, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npThermoTraps=npThermoTraps, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npThermoStatus=npThermoStatus, npGsmFailed=npGsmFailed, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npRelayTable=npRelayTable, npRelayN=npRelayN, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npRelHumTrapData=npRelHumTrapData, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, npIoEntry=npIoEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoHigh=npThermoHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermo=npThermo, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npCurLoopR=npCurLoopR, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmInfo=npGsmInfo, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayState=npRelayState, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrap=npGsmTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoEntry=npThermoEntry, npIrStatus=npIrStatus, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npCurLoopTrapI=npCurLoopTrapI, npIoMemo=npIoMemo, npSoftReboot=npSoftReboot, npGsmStrength=npGsmStrength, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelay=npRelay, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrPlayCmd=npIrPlayCmd, npRelHumStatus=npRelHumStatus, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npThermoLow=npThermoLow, npIo=npIo, npSmokeTrap=npSmokeTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npReboot=npReboot, npRelHumEntry=npRelHumEntry, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npThermoTrapSensorN=npThermoTrapSensorN)
