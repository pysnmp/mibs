...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:09:39 2022
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Gauge32, TimeTicks, iso, Integer32, NotificationType, MibIdentifier, ObjectIdentity, enterprises, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Gauge32", "TimeTicks", "iso", "Integer32", "NotificationType", "MibIdentifier", "ObjectIdentity", "enterprises", "Counter32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npSmokeTrapMemo=npSmokeTrapMemo, npRelayState=npRelayState, npGsm=npGsm, npIoLineN=npIoLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelIn=npIoLevelIn, npCurLoop=npCurLoop, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeReset=npSmokeReset, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npRelayTable=npRelayTable, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, lightcom=lightcom, npSmoke=npSmoke, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npThermoHigh=npThermoHigh, npIoTrapLineN=npIoTrapLineN, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTraps=npThermoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npResetStack=npResetStack, npCurLoopPower=npCurLoopPower, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayEntry=npRelayEntry, npGsmTraps=npGsmTraps, npIoTrapMemo=npIoTrapMemo, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npRelHumTrapSafe=npRelHumTrapSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumN=npRelHumN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npRelay=npRelay, npThermoTrap=npThermoTrap, npSmokeStatus=npSmokeStatus, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIrPlayCmd=npIrPlayCmd, npThermoMemo=npThermoMemo, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npForcedReboot=npForcedReboot, npThermoLow=npThermoLow, npRelHumEntry=npRelHumEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumMemo=npRelHumMemo, npGsmTrap=npGsmTrap, npReboot=npReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npCurLoopTrapR=npCurLoopTrapR, FixedPoint1000=FixedPoint1000, npThermoTable=npThermoTable, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmRegistration=npGsmRegistration, npIrCtrl=npIrCtrl, npThermoTrapStatus=npThermoTrapStatus, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npRelayN=npRelayN, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npRelayMemo=npRelayMemo)
