...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:47:35 2023
...
Bits, MibIdentifier, ObjectIdentity, NotificationType, iso, Counter32, Gauge32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, ModuleIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "Counter32", "Gauge32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIo=npIo, npCurLoopTrapI=npCurLoopTrapI, npRelayTable=npRelayTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTable=npSmokeTable, npRelayMemo=npRelayMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmInfo=npGsmInfo, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrap=npThermoTrap, npTrapInfo=npTrapInfo, npIr=npIr, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npThermoTable=npThermoTable, npRelayN=npRelayN, npRelayStartReset=npRelayStartReset, npGsmStrength=npGsmStrength, npSmokeMemo=npSmokeMemo, npCurLoopTraps=npCurLoopTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npCurLoopTrap=npCurLoopTrap, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npSmokeTraps=npSmokeTraps, npTrapEmailTo=npTrapEmailTo, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeSensorN=npSmokeSensorN, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeStatus=npSmokeStatus, npCurLoopPower=npCurLoopPower, npForcedReboot=npForcedReboot, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, lightcom=lightcom, npGsmFailed=npGsmFailed, npGsmTrap=npGsmTrap, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npRelayMode=npRelayMode, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValuePrecise=npThermoValuePrecise, npThermoHigh=npThermoHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopN=npCurLoopN, npReboot=npReboot, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTable=npRelHumTable, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npCurLoopI=npCurLoopI, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoEntry=npThermoEntry, npRelayState=npRelayState, FixedPoint1000=FixedPoint1000, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumN=npRelHumN, npIrReset=npIrReset, npThermo=npThermo, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npGsmTraps=npGsmTraps, npThermoTraps=npThermoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry)
