...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:28:38 2023
...
Unsigned32, Bits, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, IpAddress, enterprises, MibIdentifier, Counter64, Integer32, Counter32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "IpAddress", "enterprises", "MibIdentifier", "Counter64", "Integer32", "Counter32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrap=npIoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npGsmFailed=npGsmFailed, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseStart=npIoSinglePulseStart, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npThermoTrapLow=npThermoTrapLow, npIr=npIr, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempStatus=npRelHumTempStatus, npGsmTrap=npGsmTrap, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npRelHumTrapData=npRelHumTrapData, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapR=npCurLoopTrapR, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeStatus=npSmokeStatus, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower, npCurLoopEntry=npCurLoopEntry, npThermo=npThermo, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npResetStack=npResetStack, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayState=npRelayState, npForcedReboot=npForcedReboot, npCurLoopTraps=npCurLoopTraps, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npSoftReboot=npSoftReboot, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npThermoEntry=npThermoEntry, npCurLoopR=npCurLoopR, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npRelayStartReset=npRelayStartReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrap=npThermoTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npRelHumTrap=npRelHumTrap, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npRelHumStatus=npRelHumStatus, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTable=npCurLoopTable, npIoLevelIn=npIoLevelIn, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumidity=npRelHumidity, npRelayMemo=npRelayMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, lightcom=lightcom)
