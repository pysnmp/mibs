...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:38:46 2024
...
ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Integer32, NotificationType, Counter32, Bits, IpAddress, TimeTicks, Unsigned32, iso, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Integer32", "NotificationType", "Counter32", "Bits", "IpAddress", "TimeTicks", "Unsigned32", "iso", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLineN=npIoTrapLineN, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoMemo=npThermoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npCurLoopPower=npCurLoopPower, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsm=npGsm, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npSmoke=npSmoke, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npRelHumTable=npRelHumTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npRelayStartReset=npRelayStartReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npThermoTrapHigh=npThermoTrapHigh, npThermoTrap=npThermoTrap, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoEntry=npIoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayN=npRelayN, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npThermoSensorN=npThermoSensorN, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, lightcom=lightcom, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npSmokeEntry=npSmokeEntry, npCurLoopI=npCurLoopI, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMode=npRelayMode, npCurLoopTrapV=npCurLoopTrapV, npCurLoopEntry=npCurLoopEntry, npIrPlayCmd=npIrPlayCmd, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelIn=npIoLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmFailed=npGsmFailed, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrap=npIoTrap, npRelHumN=npRelHumN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumEntry=npRelHumEntry, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npSmokeTraps=npSmokeTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTable=npThermoTable, npRelayTable=npRelayTable, npIoTrapLevelLegend=npIoTrapLevelLegend)
