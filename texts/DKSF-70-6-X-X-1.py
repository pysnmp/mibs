...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:16:01 2021
...
NotificationType, iso, Bits, Gauge32, enterprises, Integer32, ModuleIdentity, Counter64, Counter32, ObjectIdentity, Unsigned32, IpAddress, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Bits", "Gauge32", "enterprises", "Integer32", "ModuleIdentity", "Counter64", "Counter32", "ObjectIdentity", "Unsigned32", "IpAddress", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npCurLoopTrapPower=npCurLoopTrapPower, npIrStatus=npIrStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayTable=npRelayTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoHigh=npThermoHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, lightcom=lightcom, npRelHumN=npRelHumN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoEntry=npIoEntry, FixedPoint1000=FixedPoint1000, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapHigh=npThermoTrapHigh, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npSoftReboot=npSoftReboot, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopV=npCurLoopV, npRelHumidity=npRelHumidity, npCurLoopEntry=npCurLoopEntry, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmInfo=npGsmInfo, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumValue=npRelHumValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npForcedReboot=npForcedReboot, npCurLoopTrapR=npCurLoopTrapR, npCurLoopI=npCurLoopI, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npCurLoop=npCurLoop, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npCurLoopPower=npCurLoopPower, npSmokeTraps=npSmokeTraps, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npCurLoopStatus=npCurLoopStatus, npRelayState=npRelayState, npThermoTable=npThermoTable, npIoTrap=npIoTrap, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMemo=npRelayMemo, npGsm=npGsm, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmRegistration=npGsmRegistration, npThermoSensorN=npThermoSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTraps=npCurLoopTraps, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npTrapEmailTo=npTrapEmailTo, npSmoke=npSmoke, npThermoTraps=npThermoTraps, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npIoMemo=npIoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npRelayStartReset=npRelayStartReset, npRelayN=npRelayN, npRelHumTrapData=npRelHumTrapData, npReboot=npReboot, npSmokeEntry=npSmokeEntry, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npIr=npIr, npCurLoopN=npCurLoopN)
