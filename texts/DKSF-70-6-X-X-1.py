...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:10:13 2022
...
NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Gauge32, enterprises, ModuleIdentity, Counter64, Integer32, Bits, Unsigned32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Gauge32", "enterprises", "ModuleIdentity", "Counter64", "Integer32", "Bits", "Unsigned32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeReset=npSmokeReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIo=npIo, npRelayMode=npRelayMode, npSmokeEntry=npSmokeEntry, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, npGsmTrap=npGsmTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrPlayCmd=npIrPlayCmd, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoMemo=npIoMemo, npThermoSensorN=npThermoSensorN, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npThermoTrapHigh=npThermoTrapHigh, npThermoTrap=npThermoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, npThermoStatus=npThermoStatus, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, lightcom=lightcom, npThermo=npThermo, npCurLoopTrapPower=npCurLoopTrapPower, npTrapInfo=npTrapInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npIrCtrl=npIrCtrl, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npIoLineN=npIoLineN, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npGsmRegistration=npGsmRegistration, npRelayTable=npRelayTable, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npGsm=npGsm, npIrStatus=npIrStatus, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, npIoTable=npIoTable, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npCurLoopTrapN=npCurLoopTrapN, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npThermoMemo=npThermoMemo, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopStatus=npCurLoopStatus, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npCurLoopTrapI=npCurLoopTrapI, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset)
