...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:36:00 2024
...
Counter64, Counter32, ModuleIdentity, Bits, Unsigned32, Gauge32, TimeTicks, MibIdentifier, Integer32, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ModuleIdentity", "Bits", "Unsigned32", "Gauge32", "TimeTicks", "MibIdentifier", "Integer32", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npSmokeTable=npSmokeTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npRelHumTable=npRelHumTable, npRelayMode=npRelayMode, npIr=npIr, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npIoTraps=npIoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayN=npRelayN, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npCurLoopTrapR=npCurLoopTrapR, npIoLineN=npIoLineN, npRelHumValue=npRelHumValue, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npRelayEntry=npRelayEntry, npSmokeEntry=npSmokeEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, lightcom=lightcom, npSmoke=npSmoke, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopTraps=npCurLoopTraps, npCurLoopR=npCurLoopR, npGsmFailed=npGsmFailed, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npResetStack=npResetStack, npRelayState=npRelayState, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeMemo=npSmokeMemo, npSmokePower=npSmokePower, npIrStatus=npIrStatus, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoMemo=npThermoMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npForcedReboot=npForcedReboot, npIoTable=npIoTable, npIoTrap=npIoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoEntry=npThermoEntry, npRelHumEntry=npRelHumEntry, npThermoTrapStatus=npThermoTrapStatus, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npRelayStartReset=npRelayStartReset, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npGsmRegistration=npGsmRegistration, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npCurLoopV=npCurLoopV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npCurLoopTrapI=npCurLoopTrapI, npIo=npIo, npCurLoopI=npCurLoopI)
