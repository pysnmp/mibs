...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:27:05 2021
...
ObjectIdentity, Unsigned32, Gauge32, Counter64, NotificationType, iso, MibIdentifier, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Bits, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter64", "NotificationType", "iso", "MibIdentifier", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Bits", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npSmokeEntry=npSmokeEntry, npRelHumTrapDataN=npRelHumTrapDataN, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayState=npRelayState, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmStrength=npGsmStrength, npCurLoopTraps=npCurLoopTraps, npThermoHigh=npThermoHigh, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npIo=npIo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npGsm=npGsm, npRelHumidity=npRelHumidity, npRelHumTrapSafe=npRelHumTrapSafe, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, lightcom=lightcom, npRelayMode=npRelayMode, npIoTrapMemo=npIoTrapMemo, npIrCtrl=npIrCtrl, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npRelHumTable=npRelHumTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelOut=npIoLevelOut, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIr=npIr, npIoTraps=npIoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmoke=npSmoke, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npGsmFailed=npGsmFailed, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLineN=npIoLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopV=npCurLoopV, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrap=npRelHumTrap, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValue=npThermoValue, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npIrPlayCmd=npIrPlayCmd, npRelHumMemo=npRelHumMemo, npSmokeTable=npSmokeTable, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npResetStack=npResetStack, npIoMemo=npIoMemo, npCurLoopI=npCurLoopI, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npRelHumValue=npRelHumValue, npThermo=npThermo, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap)
