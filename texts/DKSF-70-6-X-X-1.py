...
# Produced by pysmi-1.1.12 at Thu Sep 26 02:16:48 2024
...
Gauge32, Counter64, IpAddress, ObjectIdentity, iso, NotificationType, Integer32, Counter32, ModuleIdentity, enterprises, Unsigned32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "Unsigned32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmFailed=npGsmFailed, npSmokeTrapStatus=npSmokeTrapStatus, npThermoMemo=npThermoMemo, npIo=npIo, npThermoValuePrecise=npThermoValuePrecise, npSmokeReset=npSmokeReset, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npRelay=npRelay, npCurLoopEntry=npCurLoopEntry, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npGsm=npGsm, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npSmokeTraps=npSmokeTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapR=npCurLoopTrapR, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npIoLineN=npIoLineN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTraps=npCurLoopTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTable=npRelHumTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npRelHumTrapFail=npRelHumTrapFail, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npCurLoopR=npCurLoopR, npIoLevelOut=npIoLevelOut, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIr=npIr, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npSmokeMemo=npSmokeMemo, npThermoTrapHigh=npThermoTrapHigh, npResetStack=npResetStack, npRelHumN=npRelHumN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, lightcom=lightcom, npSmoke=npSmoke, npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapValue=npThermoTrapValue, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npReboot=npReboot, npSmokeEntry=npSmokeEntry, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTable=npIoTable, npRelayTable=npRelayTable, npCurLoopI=npCurLoopI, npIrCtrl=npIrCtrl, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTable=npThermoTable, npCurLoopTrapV=npCurLoopTrapV, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, npRelayEntry=npRelayEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeStatus=npSmokeStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower)
