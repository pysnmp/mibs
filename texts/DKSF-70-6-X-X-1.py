...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:18:52 2023
...
TimeTicks, ModuleIdentity, ObjectIdentity, NotificationType, enterprises, IpAddress, MibIdentifier, iso, Gauge32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "NotificationType", "enterprises", "IpAddress", "MibIdentifier", "iso", "Gauge32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTraps=npCurLoopTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npIrReset=npIrReset, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopV=npCurLoopV, npIoLevelIn=npIoLevelIn, npThermoHigh=npThermoHigh, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npThermoValue=npThermoValue, npRelHumidity=npRelHumidity, npRelay=npRelay, npIo=npIo, npIoTrapLineN=npIoTrapLineN, npIoTrapPrefix=npIoTrapPrefix, npReboot=npReboot, npGsmInfo=npGsmInfo, npIoTrapLevelIn=npIoTrapLevelIn, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npIr=npIr, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrap=npCurLoopTrap, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npRelayTable=npRelayTable, lightcom=lightcom, npCurLoop=npCurLoop, npSmokeReset=npSmokeReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTable=npSmokeTable, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMemo=npRelayMemo, npResetStack=npResetStack, npIoEntry=npIoEntry, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npRelayEntry=npRelayEntry, npRelHumTrapData=npRelHumTrapData, npThermoTrapLow=npThermoTrapLow, npTrapInfo=npTrapInfo, npCurLoopTable=npCurLoopTable, npSmokePower=npSmokePower, npRelayState=npRelayState, npRelayN=npRelayN, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, FixedPoint1000=FixedPoint1000, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrap=npIoTrap, npThermoTrapMemo=npThermoTrapMemo, npIoTable=npIoTable, npSmokeEntry=npSmokeEntry, npTrapEmailTo=npTrapEmailTo, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempValue=npRelHumTempValue, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelayStartReset=npRelayStartReset, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrap=npRelHumTrap, npSmoke=npSmoke, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapMemo=npIoTrapMemo, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeMemo=npSmokeMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopN=npCurLoopN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapValue=npThermoTrapValue)
