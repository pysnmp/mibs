...
Unsigned32, Gauge32, enterprises, iso, ModuleIdentity, NotificationType, ObjectIdentity, Integer32, Counter32, IpAddress, Counter64, Bits, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "enterprises", "iso", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Integer32", "Counter32", "IpAddress", "Counter64", "Bits", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh, npGsmFailed=npGsmFailed, npIoMemo=npIoMemo, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayMemo=npRelayMemo, npRelayEntry=npRelayEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsm=npGsm, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npThermo=npThermo, npCurLoop=npCurLoop, npIr=npIr, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npReboot=npReboot, npRelHumValue=npRelHumValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npIo=npIo, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLineN=npIoTrapLineN, npSmoke=npSmoke, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrap=npIoTrap, lightcom=lightcom, npRelHumidity=npRelHumidity, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npThermoMemo=npThermoMemo, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npCurLoopPower=npCurLoopPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npRelHumStatus=npRelHumStatus, npThermoTraps=npThermoTraps, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npRelayMode=npRelayMode, npCurLoopR=npCurLoopR, npSmokeTable=npSmokeTable, npIoTrapPrefix=npIoTrapPrefix, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN)
