...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:22:37 2022
...
TimeTicks, Bits, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Integer32, Unsigned32, MibIdentifier, ObjectIdentity, Counter64, ModuleIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Integer32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Counter64", "ModuleIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npRelayState=npRelayState, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumStatus=npRelHumStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, npThermoTrap=npThermoTrap, npTrapInfo=npTrapInfo, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npRelHumTrapTemp=npRelHumTrapTemp, npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrap=npIoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumN=npRelHumN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, npGsm=npGsm, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npCurLoopTraps=npCurLoopTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npGsmInfo=npGsmInfo, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumValue=npRelHumValue, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npRelayEntry=npRelayEntry, npIrCtrl=npIrCtrl, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapFail=npRelHumTrapFail, npCurLoopV=npCurLoopV, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npIoTraps=npIoTraps, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSoftReboot=npSoftReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelay=npRelay, npIo=npIo, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npThermoTrapMemo=npThermoTrapMemo, npResetStack=npResetStack, npThermoEntry=npThermoEntry, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npIoMemo=npIoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTraps=npGsmTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMode=npRelayMode, npCurLoopPower=npCurLoopPower, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoop=npCurLoop, npSmokeReset=npSmokeReset, npSmokeTraps=npSmokeTraps, npTrapEmailTo=npTrapEmailTo, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npForcedReboot=npForcedReboot, npThermo=npThermo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npIrReset=npIrReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npRelHumTempValue=npRelHumTempValue, npRelayMemo=npRelayMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npCurLoopTable=npCurLoopTable, npReboot=npReboot)
