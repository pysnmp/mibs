...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:21:04 2024
...
Bits, MibIdentifier, Integer32, TimeTicks, NotificationType, IpAddress, Unsigned32, Counter32, Counter64, ModuleIdentity, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Integer32", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npGsmRegistration=npGsmRegistration, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeStatus=npSmokeStatus, npThermoValue=npThermoValue, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npIoLevelOut=npIoLevelOut, npSoftReboot=npSoftReboot, npIrStatus=npIrStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npIrPlayCmd=npIrPlayCmd, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmFailed=npGsmFailed, npThermoLow=npThermoLow, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npThermoTrapMemo=npThermoTrapMemo, npCurLoopV=npCurLoopV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMemo=npRelayMemo, npThermoEntry=npThermoEntry, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npSmokeTraps=npSmokeTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, npCurLoopTraps=npCurLoopTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, npIr=npIr, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npThermo=npThermo, npSmokePower=npSmokePower, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapLow=npThermoTrapLow, npCurLoopR=npCurLoopR, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npIo=npIo, npThermoTrap=npThermoTrap, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoEntry=npIoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npResetStack=npResetStack, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTraps=npThermoTraps, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npRelHumTable=npRelHumTable, npRelayState=npRelayState, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npThermoStatus=npThermoStatus, npRelHumTempStatus=npRelHumTempStatus, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npRelHumStatus=npRelHumStatus)
