...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:10:17 2021
...
ObjectIdentity, Integer32, TimeTicks, MibIdentifier, ModuleIdentity, Bits, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, iso, NotificationType, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Bits", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "iso", "NotificationType", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npCurLoopTraps=npCurLoopTraps, npIoEntry=npIoEntry, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npCurLoopV=npCurLoopV, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npIrPlayCmd=npIrPlayCmd, npRelHumidity=npRelHumidity, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeReset=npSmokeReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npIo=npIo, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapValue=npThermoTrapValue, npRelayTable=npRelayTable, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npIrStatus=npIrStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoop=npCurLoop, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMode=npRelayMode, npRelHumTempStatus=npRelHumTempStatus, npTrapEmailTo=npTrapEmailTo, npSmokeTraps=npSmokeTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopPower=npCurLoopPower, npIoTable=npIoTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npCurLoopTrap=npCurLoopTrap, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npGsmRegistration=npGsmRegistration, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npResetStack=npResetStack, npThermoTrapSensorN=npThermoTrapSensorN, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npGsmTrap=npGsmTrap, npSmokeTrap=npSmokeTrap, npIr=npIr, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npRelHumEntry=npRelHumEntry, npGsmTraps=npGsmTraps, npThermoValuePrecise=npThermoValuePrecise, npCurLoopStatus=npCurLoopStatus, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, FixedPoint1000=FixedPoint1000, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayN=npRelayN, npIoLevelOut=npIoLevelOut, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
