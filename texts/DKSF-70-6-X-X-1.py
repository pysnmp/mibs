...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:51:05 2021
...
ModuleIdentity, Counter32, Unsigned32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Counter64, TimeTicks, MibIdentifier, iso, Integer32, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Counter64", "TimeTicks", "MibIdentifier", "iso", "Integer32", "Bits", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMode=npRelayMode, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapR=npCurLoopTrapR, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumValue=npRelHumValue, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npTrapInfo=npTrapInfo, npReboot=npReboot, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, lightcom=lightcom, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrReset=npIrReset, npCurLoopTrapPower=npCurLoopTrapPower, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npIoLineN=npIoLineN, npIr=npIr, npThermo=npThermo, npGsmTrap=npGsmTrap, npRelayTable=npRelayTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapMemo=npIoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopEntry=npCurLoopEntry, npThermoTrapHigh=npThermoTrapHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npSmokeMemo=npSmokeMemo, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmStrength=npGsmStrength, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLineN=npIoTrapLineN, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npThermoTrapValue=npThermoTrapValue, npIoTraps=npIoTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npIoTrapPrefix=npIoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npCurLoopTrapI=npCurLoopTrapI, npResetStack=npResetStack, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapLow=npThermoTrapLow, npThermoLow=npThermoLow, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npSmokeReset=npSmokeReset, npIoEntry=npIoEntry, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npSmokeTrap=npSmokeTrap, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmoke=npSmoke, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrCtrl=npIrCtrl, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npCurLoopTrapN=npCurLoopTrapN, npRelayN=npRelayN, npRelayMemo=npRelayMemo)
