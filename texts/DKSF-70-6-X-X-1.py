...
# Produced by pysmi-1.1.8 at Sat Jan 15 16:47:41 2022
...
Bits, Gauge32, ObjectIdentity, TimeTicks, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Counter64, NotificationType, iso, IpAddress, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Counter64", "NotificationType", "iso", "IpAddress", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npIoTable=npIoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTraps=npIoTraps, npCurLoopR=npCurLoopR, npThermoTrapSensorN=npThermoTrapSensorN, npGsmRegistration=npGsmRegistration, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npThermoTable=npThermoTable, npGsmTrap=npGsmTrap, npGsmStrength=npGsmStrength, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npGsm=npGsm, npThermoLow=npThermoLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, npRelHumStatus=npRelHumStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeReset=npSmokeReset, npCurLoopTrapI=npCurLoopTrapI, npResetStack=npResetStack, npSmokeTrap=npSmokeTrap, npIr=npIr, npCurLoopTrapV=npCurLoopTrapV, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopV=npCurLoopV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npIo=npIo, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npReboot=npReboot, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npRelayMemo=npRelayMemo, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapStatus=npThermoTrapStatus, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo, lightcom=lightcom, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, npIoTrapPrefix=npIoTrapPrefix, npSmoke=npSmoke, npCurLoopTable=npCurLoopTable, npSoftReboot=npSoftReboot, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus)
