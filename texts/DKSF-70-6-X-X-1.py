...
# Produced by pysmi-1.1.8 at Thu Oct 26 12:20:08 2023
...
Counter32, MibIdentifier, enterprises, TimeTicks, Integer32, Counter64, iso, IpAddress, NotificationType, Bits, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "enterprises", "TimeTicks", "Integer32", "Counter64", "iso", "IpAddress", "NotificationType", "Bits", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrCtrl=npIrCtrl, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npThermoHigh=npThermoHigh, npThermoTrap=npThermoTrap, npSmoke=npSmoke, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrap=npGsmTrap, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoLow=npThermoLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLineN=npIoLineN, npIrReset=npIrReset, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopV=npCurLoopV, npIoTrapMemo=npIoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npSoftReboot=npSoftReboot, npThermoTraps=npThermoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempStatus=npRelHumTempStatus, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npThermoTrapStatus=npThermoTrapStatus, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npIo=npIo, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npRelHumTrap=npRelHumTrap, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npRelayMemo=npRelayMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npCurLoopI=npCurLoopI, npIr=npIr, npRelayN=npRelayN, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npGsmStrength=npGsmStrength, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayStartReset=npRelayStartReset, npReboot=npReboot, npForcedReboot=npForcedReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopR=npCurLoopR, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop, npTrapEmailTo=npTrapEmailTo, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npRelayMode=npRelayMode, npRelayState=npRelayState, npIoPulseCounter=npIoPulseCounter, npThermoMemo=npThermoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapValue=npThermoTrapValue, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npThermoEntry=npThermoEntry, npRelHumTrapData=npRelHumTrapData, npThermoTrapLow=npThermoTrapLow, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npIoTable=npIoTable)
