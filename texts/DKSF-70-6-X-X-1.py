...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:46:52 2021
...
Gauge32, iso, MibIdentifier, ObjectIdentity, NotificationType, Integer32, Counter32, TimeTicks, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "MibIdentifier", "ObjectIdentity", "NotificationType", "Integer32", "Counter32", "TimeTicks", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, npRelHumValue=npRelHumValue, npGsmRegistration=npGsmRegistration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumidity=npRelHumidity, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTable=npIoTable, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npThermoValue=npThermoValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopPower=npCurLoopPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelIn=npIoLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npThermoLow=npThermoLow, npIo=npIo, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npSmokeTrapStatus=npSmokeTrapStatus, npThermoStatus=npThermoStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npResetStack=npResetStack, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npGsmInfo=npGsmInfo, npThermoTrapMemo=npThermoTrapMemo, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npSmokeMemo=npSmokeMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokePower=npSmokePower, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npRelayState=npRelayState, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npSmokeTrap=npSmokeTrap, npGsm=npGsm, npThermoTrapValue=npThermoTrapValue, npThermoTrapSensorN=npThermoTrapSensorN, npTrapEmailTo=npTrapEmailTo, npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npIoEntry=npIoEntry, lightcom=lightcom, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeReset=npSmokeReset, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoHigh=npThermoHigh, npIrReset=npIrReset, npCurLoopV=npCurLoopV, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayTable=npRelayTable, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npReboot=npReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapI=npCurLoopTrapI, npCurLoopI=npCurLoopI, npIoTraps=npIoTraps)
