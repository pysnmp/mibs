...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, enterprises, Gauge32, Integer32, MibIdentifier, NotificationType, Counter64, Unsigned32, IpAddress, ModuleIdentity, Bits, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "enterprises", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "Bits", "iso", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoMemo=npIoMemo, lightcom=lightcom, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapR=npCurLoopTrapR, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npSmokeSensorN=npSmokeSensorN, npSmokeReset=npSmokeReset, npRelHumidity=npRelHumidity, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npTrapInfo=npTrapInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumN=npRelHumN, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npCurLoopN=npCurLoopN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npResetStack=npResetStack, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npRelHumMemo=npRelHumMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopStatus=npCurLoopStatus, npThermoLow=npThermoLow, npGsm=npGsm, npCurLoopTraps=npCurLoopTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeEntry=npSmokeEntry, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMode=npRelayMode, npRelHumStatus=npRelHumStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumEntry=npRelHumEntry, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npRelayState=npRelayState, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoMemo=npThermoMemo, npGsmStrength=npGsmStrength, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, npIoTraps=npIoTraps, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npIo=npIo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npReboot=npReboot, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoEntry=npIoEntry, npRelayEntry=npRelayEntry, npCurLoopEntry=npCurLoopEntry, npIrReset=npIrReset, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npIoTable=npIoTable, npThermoTable=npThermoTable, npRelayN=npRelayN, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmInfo=npGsmInfo, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempStatus=npRelHumTempStatus, npIoTrapMemo=npIoTrapMemo, npIr=npIr, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokePower=npSmokePower, npSoftReboot=npSoftReboot, npCurLoopTrapStatus=npCurLoopTrapStatus)
