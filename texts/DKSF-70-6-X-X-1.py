...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:27:17 2021
...
MibIdentifier, NotificationType, enterprises, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, Counter32, Unsigned32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "enterprises", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapMemo=npThermoTrapMemo, npRelayMemo=npRelayMemo, npSmokeTraps=npSmokeTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTable=npRelHumTable, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumN=npRelHumN, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npIoMemo=npIoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseStart=npIoSinglePulseStart, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npRelay=npRelay, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoMemo=npThermoMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npRelayTable=npRelayTable, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTable=npSmokeTable, npSmokeStatus=npSmokeStatus, npRelayEntry=npRelayEntry, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npThermoValue=npThermoValue, npGsmTrap=npGsmTrap, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npIoTrapPrefix=npIoTrapPrefix, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapMemo=npSmokeTrapMemo, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npCurLoopN=npCurLoopN, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npThermoTrap=npThermoTrap, npCurLoopTrap=npCurLoopTrap, npThermoTrapLow=npThermoTrapLow, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npResetStack=npResetStack, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrStatus=npIrStatus, npIoTrap=npIoTrap, npRelHumTempValue=npRelHumTempValue, npThermoHigh=npThermoHigh, npRelHumidity=npRelHumidity, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npForcedReboot=npForcedReboot, npCurLoop=npCurLoop, npGsmStrength=npGsmStrength, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npGsm=npGsm, npReboot=npReboot, npRelHumTempStatus=npRelHumTempStatus, npIoTable=npIoTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npSmokeReset=npSmokeReset, npThermoStatus=npThermoStatus, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapHigh=npThermoTrapHigh, npRelayState=npRelayState, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeEntry=npSmokeEntry)
