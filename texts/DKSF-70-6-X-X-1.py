...
ObjectIdentity, enterprises, Gauge32, TimeTicks, Integer32, NotificationType, MibIdentifier, Counter64, IpAddress, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "Gauge32", "TimeTicks", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npGsm=npGsm, npCurLoopTrapR=npCurLoopTrapR, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npRelHumTempValue=npRelHumTempValue, npGsmInfo=npGsmInfo, npIoTrapLineN=npIoTrapLineN, npSmokeTable=npSmokeTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeMemo=npSmokeMemo, npIoLevelOut=npIoLevelOut, npCurLoopPower=npCurLoopPower, npSmokeTraps=npSmokeTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npCurLoopTrap=npCurLoopTrap, npGsmTraps=npGsmTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMemo=npRelayMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMode=npRelayMode, npSmokeEntry=npSmokeEntry, npThermoSensorN=npThermoSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelIn=npIoLevelIn, npIo=npIo, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelayN=npRelayN, npRelHumidity=npRelHumidity, npResetStack=npResetStack, npSmokeReset=npSmokeReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npCurLoopN=npCurLoopN, npRelHumTempStatus=npRelHumTempStatus, npRelHumEntry=npRelHumEntry, npReboot=npReboot, lightcom=lightcom, npRelayState=npRelayState, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoLow=npThermoLow, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npRelHumTrapData=npRelHumTrapData, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSoftReboot=npSoftReboot, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npIoPulseCounter=npIoPulseCounter, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npForcedReboot=npForcedReboot, npCurLoopI=npCurLoopI, npThermoMemo=npThermoMemo, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npIoTrap=npIoTrap)
