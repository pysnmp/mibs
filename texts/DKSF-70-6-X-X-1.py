...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:51:18 2022
...
Gauge32, Bits, enterprises, Integer32, iso, Unsigned32, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "enterprises", "Integer32", "iso", "Unsigned32", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npThermoSensorN=npThermoSensorN, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npCurLoop=npCurLoop, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeStatus=npSmokeStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTable=npThermoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoEntry=npIoEntry, npThermoTraps=npThermoTraps, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npReboot=npReboot, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npThermoValuePrecise=npThermoValuePrecise, npResetStack=npResetStack, npRelayMode=npRelayMode, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelay=npRelay, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsm=npGsm, npIoTrap=npIoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopN=npCurLoopN, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npRelayState=npRelayState, npThermo=npThermo, npIrPlayCmd=npIrPlayCmd, npRelayTable=npRelayTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npThermoTrapStatus=npThermoTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npGsmStrength=npGsmStrength, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrap=npRelHumTrap, npIrStatus=npIrStatus, npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmInfo=npGsmInfo, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelIn=npIoLevelIn, npIoMemo=npIoMemo, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoLow=npThermoLow, npRelayMemo=npRelayMemo, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npRelHumEntry=npRelHumEntry, npRelHumN=npRelHumN, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopEntry=npCurLoopEntry, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npIr=npIr, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrCtrl=npIrCtrl, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npCurLoopTrapI=npCurLoopTrapI, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, npSmokeReset=npSmokeReset, lightcom=lightcom, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps)
