...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:56:32 2022
...
iso, Unsigned32, ObjectIdentity, Counter32, Gauge32, Integer32, TimeTicks, NotificationType, Bits, Counter64, IpAddress, MibIdentifier, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "ObjectIdentity", "Counter32", "Gauge32", "Integer32", "TimeTicks", "NotificationType", "Bits", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoop=npCurLoop, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npRelayN=npRelayN, npSmokePower=npSmokePower, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npThermoTable=npThermoTable, npRelHumEntry=npRelHumEntry, npSmoke=npSmoke, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapInfo=npTrapInfo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npGsmStrength=npGsmStrength, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npRelayMemo=npRelayMemo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoMemo=npThermoMemo, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npGsm=npGsm, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermo=npThermo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npThermoSensorN=npThermoSensorN, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npSmokeTable=npSmokeTable, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrap=npSmokeTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmRegistration=npGsmRegistration, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumValue=npRelHumValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npIrCtrl=npIrCtrl, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npResetStack=npResetStack, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npCurLoopR=npCurLoopR, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npIrStatus=npIrStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmFailed=npGsmFailed, lightcom=lightcom, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npSoftReboot=npSoftReboot, npIoPulseCounter=npIoPulseCounter)
