...
Gauge32, TimeTicks, Bits, NotificationType, Counter64, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Integer32, Counter32, ModuleIdentity, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Bits", "NotificationType", "Counter64", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Integer32", "Counter32", "ModuleIdentity", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npRelHumidity=npRelHumidity, npGsmInfo=npGsmInfo, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npGsmTrapPrefix=npGsmTrapPrefix, npSoftReboot=npSoftReboot, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npIrReset=npIrReset, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npRelayEntry=npRelayEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTraps=npCurLoopTraps, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npRelHumEntry=npRelHumEntry, npThermoTrapValue=npThermoTrapValue, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npCurLoopI=npCurLoopI, npCurLoopTrap=npCurLoopTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npThermoValue=npThermoValue, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokePower=npSmokePower, npCurLoopTrapN=npCurLoopTrapN, npResetStack=npResetStack, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapData=npRelHumTrapData, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrCtrl=npIrCtrl, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapLow=npThermoTrapLow, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npThermoMemo=npThermoMemo, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, lightcom=lightcom, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npRelHumValue=npRelHumValue, npReboot=npReboot, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npRelayStartReset=npRelayStartReset, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermo=npThermo, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeEntry=npSmokeEntry, npGsmFailed=npGsmFailed, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npSmoke=npSmoke, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIr=npIr, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayTable=npRelayTable, npIoSinglePulseStart=npIoSinglePulseStart, FixedPoint1000=FixedPoint1000, npRelayState=npRelayState, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npIoLineN=npIoLineN)
