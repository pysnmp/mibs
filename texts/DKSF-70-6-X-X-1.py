...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:13:49 2024
...
Integer32, Bits, MibIdentifier, Gauge32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, enterprises, TimeTicks, iso, Unsigned32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibIdentifier", "Gauge32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "enterprises", "TimeTicks", "iso", "Unsigned32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMode=npRelayMode, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoMemo=npIoMemo, npIoTraps=npIoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapHigh=npThermoTrapHigh, npGsm=npGsm, npRelHumEntry=npRelHumEntry, npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npCurLoopTrap=npCurLoopTrap, npCurLoop=npCurLoop, npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelayEntry=npRelayEntry, npGsmRegistration=npGsmRegistration, npThermoTrapSensorN=npThermoTrapSensorN, npIo=npIo, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTable=npSmokeTable, npIrStatus=npIrStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumValue=npRelHumValue, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLineN=npIoTrapLineN, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrap=npSmokeTrap, npSmokeStatus=npSmokeStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npThermoTrapPrefix=npThermoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npThermoTable=npThermoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelLegend=npIoTrapLevelLegend, npResetStack=npResetStack, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npRelHumTrap=npRelHumTrap, npIoSinglePulseStart=npIoSinglePulseStart, FixedPoint1000=FixedPoint1000, lightcom=lightcom, npRelHumN=npRelHumN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npThermoTrap=npThermoTrap, npRelay=npRelay, npSmokePower=npSmokePower, npRelHumidity=npRelHumidity, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelOut=npIoLevelOut, npThermoValuePrecise=npThermoValuePrecise, npCurLoopStatus=npCurLoopStatus, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npThermoValue=npThermoValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl)
