...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:19:11 2021
...
Integer32, Bits, enterprises, ObjectIdentity, ModuleIdentity, iso, Gauge32, Counter32, Unsigned32, Counter64, TimeTicks, MibIdentifier, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "enterprises", "ObjectIdentity", "ModuleIdentity", "iso", "Gauge32", "Counter32", "Unsigned32", "Counter64", "TimeTicks", "MibIdentifier", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npCurLoopTrapN=npCurLoopTrapN, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npRelay=npRelay, npSmokePower=npSmokePower, npThermoTraps=npThermoTraps, lightcom=lightcom, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npIoMemo=npIoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npRelHumTable=npRelHumTable, npGsmRegistration=npGsmRegistration, npSmokeSensorN=npSmokeSensorN, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLineN=npIoTrapLineN, npRelayTable=npRelayTable, npSmokeReset=npSmokeReset, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npCurLoop=npCurLoop, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npIoTraps=npIoTraps, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npGsmStrength=npGsmStrength, npCurLoopI=npCurLoopI, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTraps=npCurLoopTraps, npRelayState=npRelayState, npRelayMemo=npRelayMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npIrPlayCmd=npIrPlayCmd, npGsmTrapPrefix=npGsmTrapPrefix, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npSmokeTrapStatus=npSmokeTrapStatus, npThermoEntry=npThermoEntry, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapData=npRelHumTrapData, npGsmInfo=npGsmInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npIo=npIo, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npRelayN=npRelayN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npRelayMode=npRelayMode, npIoTrap=npIoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoMemo=npThermoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValue=npThermoValue, npGsm=npGsm, npReboot=npReboot, npSmokeEntry=npSmokeEntry, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeStatus=npSmokeStatus, npIoPulseCounter=npIoPulseCounter)
