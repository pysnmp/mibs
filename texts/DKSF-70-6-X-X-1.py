...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:35:19 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, ModuleIdentity, Unsigned32, Counter32, TimeTicks, Counter64, NotificationType, MibIdentifier, enterprises, IpAddress, Gauge32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "ModuleIdentity", "Unsigned32", "Counter32", "TimeTicks", "Counter64", "NotificationType", "MibIdentifier", "enterprises", "IpAddress", "Gauge32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoEntry=npIoEntry, npCurLoop=npCurLoop, npGsmStrength=npGsmStrength, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayN=npRelayN, npThermoTrapPrefix=npThermoTrapPrefix, npResetStack=npResetStack, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npThermoValue=npThermoValue, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npIoTrap=npIoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npThermoValuePrecise=npThermoValuePrecise, npThermoHigh=npThermoHigh, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMemo=npRelayMemo, npSoftReboot=npSoftReboot, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrStatus=npIrStatus, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npGsm=npGsm, npCurLoopTrapN=npCurLoopTrapN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrCtrl=npIrCtrl, npRelay=npRelay, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npRelHumEntry=npRelHumEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeReset=npSmokeReset, npThermoEntry=npThermoEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, npRelayStartReset=npRelayStartReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoLow=npThermoLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTable=npThermoTable, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npGsmInfo=npGsmInfo, npSmokeEntry=npSmokeEntry, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrap=npRelHumTrap, npSmoke=npSmoke, npRelayState=npRelayState, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, npTrapInfo=npTrapInfo, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npRelHumTrapData=npRelHumTrapData)
