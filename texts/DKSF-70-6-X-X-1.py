...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:06:04 2023
...
Counter32, enterprises, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, ModuleIdentity, MibIdentifier, NotificationType, Bits, ObjectIdentity, TimeTicks, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMode=npRelayMode, npThermoTrapSensorN=npThermoTrapSensorN, npSmoke=npSmoke, npThermoTraps=npThermoTraps, npIoTrapLineN=npIoTrapLineN, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npResetStack=npResetStack, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeEntry=npSmokeEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npThermoHigh=npThermoHigh, npIoTrapMemo=npIoTrapMemo, lightcom=lightcom, npRelayStartReset=npRelayStartReset, npThermoValuePrecise=npThermoValuePrecise, npRelHumEntry=npRelHumEntry, npThermoValue=npThermoValue, npIo=npIo, npCurLoopV=npCurLoopV, npCurLoopEntry=npCurLoopEntry, npThermoSensorN=npThermoSensorN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npRelay=npRelay, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npGsmInfo=npGsmInfo, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapInfo=npTrapInfo, npCurLoop=npCurLoop, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npRelHumN=npRelHumN, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npThermo=npThermo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoPulseCounter=npIoPulseCounter, npThermoTable=npThermoTable, npRelayTable=npRelayTable, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npIrStatus=npIrStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLineN=npIoLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapI=npCurLoopTrapI, npIoEntry=npIoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopR=npCurLoopR, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npSmokeMemo=npSmokeMemo, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumMemo=npRelHumMemo, npGsmStrength=npGsmStrength, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrReset=npIrReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npThermoMemo=npThermoMemo, npIoLevelOut=npIoLevelOut, npSmokePower=npSmokePower, npGsmTraps=npGsmTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npSmokeTrapMemo=npSmokeTrapMemo)
