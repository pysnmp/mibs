...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:10:39 2023
...
ModuleIdentity, Counter32, MibIdentifier, enterprises, Integer32, Unsigned32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, ObjectIdentity, IpAddress, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibIdentifier", "enterprises", "Integer32", "Unsigned32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "ObjectIdentity", "IpAddress", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelay=npRelay, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLineN=npIoLineN, npIoTrapPrefix=npIoTrapPrefix, npRelHumValue=npRelHumValue, npCurLoopTable=npCurLoopTable, npRelayEntry=npRelayEntry, npRelHumTable=npRelHumTable, npRelHumTrapFail=npRelHumTrapFail, npRelayMemo=npRelayMemo, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npIo=npIo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npGsmFailed=npGsmFailed, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmStrength=npGsmStrength, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npCurLoopPower=npCurLoopPower, npRelHumTempValue=npRelHumTempValue, npThermoTrap=npThermoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmoke=npSmoke, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, npSmokeTable=npSmokeTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTraps=npIoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrCtrl=npIrCtrl, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npIoTrapLineN=npIoTrapLineN, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoEntry=npIoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npReboot=npReboot, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npGsmTrap=npGsmTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapInfo=npTrapInfo, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, npThermoTrapMemo=npThermoTrapMemo, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npResetStack=npResetStack, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoMemo=npThermoMemo, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap)
