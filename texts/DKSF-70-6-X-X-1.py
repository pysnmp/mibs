...
ModuleIdentity, iso, ObjectIdentity, Bits, MibIdentifier, Gauge32, Integer32, NotificationType, Counter32, Counter64, TimeTicks, IpAddress, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "MibIdentifier", "Gauge32", "Integer32", "NotificationType", "Counter32", "Counter64", "TimeTicks", "IpAddress", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npSmokeEntry=npSmokeEntry, npIoTrap=npIoTrap, npIoEntry=npIoEntry, npIrStatus=npIrStatus, npSmokeTable=npSmokeTable, npRelHumTrapDataN=npRelHumTrapDataN, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npIoMemo=npIoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npThermo=npThermo, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npCurLoopN=npCurLoopN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npSmoke=npSmoke, npTrapInfo=npTrapInfo, npRelHumEntry=npRelHumEntry, npSmokeReset=npSmokeReset, npRelHumTable=npRelHumTable, npSoftReboot=npSoftReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumN=npRelHumN, npRelayN=npRelayN, npIr=npIr, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoop=npCurLoop, npThermoTrapValue=npThermoTrapValue, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTraps=npSmokeTraps, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npIrReset=npIrReset, npResetStack=npResetStack, npRelHumMemo=npRelHumMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTable=npIoTable, npGsm=npGsm, npCurLoopTable=npCurLoopTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npCurLoopTrapR=npCurLoopTrapR, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npReboot=npReboot, npCurLoopI=npCurLoopI, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeStatus=npSmokeStatus, npCurLoopR=npCurLoopR, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopStatus=npCurLoopStatus, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npThermoLow=npThermoLow, npRelHumidity=npRelHumidity, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npCurLoopTrap=npCurLoopTrap, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeMemo=npSmokeMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npRelHumTrapSafe=npRelHumTrapSafe, npGsmFailed=npGsmFailed, npRelayTable=npRelayTable, npForcedReboot=npForcedReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npIoTraps=npIoTraps)
