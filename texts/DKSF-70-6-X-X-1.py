...
# Produced by pysmi-1.1.10 at Mon Feb 19 03:00:15 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, iso, ObjectIdentity, Gauge32, NotificationType, Counter32, Unsigned32, MibIdentifier, enterprises, Bits, IpAddress, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "iso", "ObjectIdentity", "Gauge32", "NotificationType", "Counter32", "Unsigned32", "MibIdentifier", "enterprises", "Bits", "IpAddress", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempValue=npRelHumTempValue, npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLineN=npIoLineN, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelIn=npIoLevelIn, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npRelHumEntry=npRelHumEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIr=npIr, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npSoftReboot=npSoftReboot, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapFail=npRelHumTrapFail, npIoTrapPrefix=npIoTrapPrefix, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npReboot=npReboot, npRelayN=npRelayN, npThermoLow=npThermoLow, npCurLoopN=npCurLoopN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTraps=npSmokeTraps, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, npSmoke=npSmoke, npCurLoopStatus=npCurLoopStatus, npThermo=npThermo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npRelay=npRelay, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npCurLoopV=npCurLoopV, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npCurLoopTrapI=npCurLoopTrapI, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npSmokeEntry=npSmokeEntry, npRelHumMemo=npRelHumMemo, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npForcedReboot=npForcedReboot, npIoLevelOut=npIoLevelOut, npCurLoopI=npCurLoopI, npThermoSensorN=npThermoSensorN, npRelayStartReset=npRelayStartReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumValue=npRelHumValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrap=npRelHumTrap, lightcom=lightcom, npIo=npIo, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLineN=npIoTrapLineN, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npCurLoopTrapN=npCurLoopTrapN, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopPower=npCurLoopPower, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumN=npRelHumN, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3)
