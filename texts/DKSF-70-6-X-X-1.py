...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:42:26 2022
...
Gauge32, MibIdentifier, ModuleIdentity, ObjectIdentity, Bits, IpAddress, Counter64, Integer32, Unsigned32, NotificationType, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Bits", "IpAddress", "Counter64", "Integer32", "Unsigned32", "NotificationType", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapN=npCurLoopTrapN, npRelHumN=npRelHumN, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapFail=npRelHumTrapFail, npRelayEntry=npRelayEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTable=npThermoTable, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSoftReboot=npSoftReboot, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npRelayStartReset=npRelayStartReset, npSmokePower=npSmokePower, npThermoValue=npThermoValue, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npIrReset=npIrReset, npThermoLow=npThermoLow, npTrapInfo=npTrapInfo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumEntry=npRelHumEntry, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTraps=npSmokeTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npSmoke=npSmoke, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npGsm=npGsm, npIrStatus=npIrStatus, npIoTraps=npIoTraps, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoMemo=npIoMemo, npRelayMode=npRelayMode, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npRelHumTable=npRelHumTable, npCurLoopI=npCurLoopI, npForcedReboot=npForcedReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapMemo=npIoTrapMemo, npIo=npIo, npIoEntry=npIoEntry, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npRelayState=npRelayState, npCurLoopTable=npCurLoopTable, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoEntry=npThermoEntry, npSmokeTrapStatus=npSmokeTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapPrefix=npThermoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrap=npIoTrap, npIoLineN=npIoLineN, npRelay=npRelay, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue)
