...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:09:07 2024
...
iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, MibIdentifier, enterprises, Counter64, Unsigned32, Bits, Gauge32, Integer32, TimeTicks, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "MibIdentifier", "enterprises", "Counter64", "Unsigned32", "Bits", "Gauge32", "Integer32", "TimeTicks", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumN=npRelHumN, npTrapEmailTo=npTrapEmailTo, npSoftReboot=npSoftReboot, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npReboot=npReboot, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npRelayEntry=npRelayEntry, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npRelayMemo=npRelayMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npRelHumidity=npRelHumidity, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, npThermoTrapPrefix=npThermoTrapPrefix, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npForcedReboot=npForcedReboot, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokePower=npSmokePower, npThermoSensorN=npThermoSensorN, npSmokeEntry=npSmokeEntry, npIoTrapLineN=npIoTrapLineN, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, npCurLoopTraps=npCurLoopTraps, npThermoTrapLow=npThermoTrapLow, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npRelHumTable=npRelHumTable, npThermoLow=npThermoLow, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npIoPulseCounter=npIoPulseCounter, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapData=npRelHumTrapData, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npRelHumTempStatus=npRelHumTempStatus, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npGsmFailed=npGsmFailed, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npGsmTrap=npGsmTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npRelayState=npRelayState, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npCurLoopN=npCurLoopN, npRelay=npRelay, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npGsm=npGsm, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoMemo=npIoMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValue=npThermoValue, npThermo=npThermo, npRelHumTrapFail=npRelHumTrapFail, npSmokeSensorN=npSmokeSensorN, npCurLoopI=npCurLoopI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npResetStack=npResetStack, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeMemo=npSmokeMemo, npIo=npIo, npRelayMode=npRelayMode)
