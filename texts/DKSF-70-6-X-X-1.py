...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:10:23 2023
...
MibIdentifier, NotificationType, enterprises, ModuleIdentity, Counter32, Bits, IpAddress, iso, ObjectIdentity, Counter64, Gauge32, Integer32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "enterprises", "ModuleIdentity", "Counter32", "Bits", "IpAddress", "iso", "ObjectIdentity", "Counter64", "Gauge32", "Integer32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapValue=npThermoTrapValue, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npReboot=npReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npThermoTrapPrefix=npThermoTrapPrefix, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTable=npRelHumTable, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npThermoTrapMemo=npThermoTrapMemo, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npIoTrap=npIoTrap, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLevelIn=npIoTrapLevelIn, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoHigh=npThermoHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npIoMemo=npIoMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npRelayEntry=npRelayEntry, npThermo=npThermo, npSmokeTable=npSmokeTable, npRelayState=npRelayState, npIrStatus=npIrStatus, npSmokeStatus=npSmokeStatus, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmoke=npSmoke, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMemo=npRelayMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoop=npCurLoop, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npThermoSensorN=npThermoSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumEntry=npRelHumEntry, npRelay=npRelay, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoLow=npThermoLow, npGsmTraps=npGsmTraps, npGsmRegistration=npGsmRegistration, npCurLoopR=npCurLoopR, npThermoValue=npThermoValue, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npGsm=npGsm, npSmokeEntry=npSmokeEntry, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npThermoTraps=npThermoTraps, npCurLoopPower=npCurLoopPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLineN=npIoLineN, npRelayN=npRelayN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npIoTraps=npIoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npTrapInfo=npTrapInfo, npResetStack=npResetStack, npThermoTrapHigh=npThermoTrapHigh, lightcom=lightcom, npIoTrapLineN=npIoTrapLineN)
