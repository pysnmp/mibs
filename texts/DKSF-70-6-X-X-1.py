...
Gauge32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, MibIdentifier, Counter64, iso, ObjectIdentity, ModuleIdentity, TimeTicks, Bits, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "MibIdentifier", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Bits", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npRelay=npRelay, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npIoTraps=npIoTraps, npCurLoop=npCurLoop, npThermoStatus=npThermoStatus, npGsmTraps=npGsmTraps, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelayMemo=npRelayMemo, npThermoHigh=npThermoHigh, npRelHumN=npRelHumN, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npSmokeSensorN=npSmokeSensorN, npForcedReboot=npForcedReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoEntry=npIoEntry, npIrReset=npIrReset, npCurLoopTrapN=npCurLoopTrapN, npRelHumidity=npRelHumidity, npGsm=npGsm, npCurLoopEntry=npCurLoopEntry, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npSmoke=npSmoke, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npRelayState=npRelayState, npCurLoopI=npCurLoopI, npThermoSensorN=npThermoSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrap=npIoTrap, npIrPlayCmd=npIrPlayCmd, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npThermoMemo=npThermoMemo, npCurLoopTrapR=npCurLoopTrapR, npIrStatus=npIrStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npRelHumTable=npRelHumTable, npGsmFailed=npGsmFailed, npSoftReboot=npSoftReboot, npThermoTrapHigh=npThermoTrapHigh, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npThermoEntry=npThermoEntry, npRelHumMemo=npRelHumMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npGsmRegistration=npGsmRegistration, npRelHumEntry=npRelHumEntry, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npIr=npIr, npIoLevelIn=npIoLevelIn, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npRelHumValue=npRelHumValue, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValuePrecise=npThermoValuePrecise, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTable=npIoTable, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayN=npRelayN, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe)
