...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:41:13 2022
...
Counter32, Integer32, IpAddress, Counter64, Bits, Gauge32, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, iso, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "IpAddress", "Counter64", "Bits", "Gauge32", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapPrefix=npIoTrapPrefix, npRelHumN=npRelHumN, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npIr=npIr, npIoTrap=npIoTrap, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npSmokeTraps=npSmokeTraps, npThermo=npThermo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopPower=npCurLoopPower, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npGsmRegistration=npGsmRegistration, npGsmTrapPrefix=npGsmTrapPrefix, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapMemo=npIoTrapMemo, npRelayMode=npRelayMode, npSmokePower=npSmokePower, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npThermoSensorN=npThermoSensorN, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npIoLineN=npIoLineN, npIoLevelIn=npIoLevelIn, npIoTable=npIoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npGsm=npGsm, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeReset=npSmokeReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npResetStack=npResetStack, npRelay=npRelay, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI, npCurLoopTraps=npCurLoopTraps, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npThermoTrapLow=npThermoTrapLow, npThermoTrapValue=npThermoTrapValue, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npRelayEntry=npRelayEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapHigh=npThermoTrapHigh, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, FixedPoint1000=FixedPoint1000, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npIrStatus=npIrStatus, npRelayStartReset=npRelayStartReset, npSmokeStatus=npSmokeStatus, npCurLoopTrapR=npCurLoopTrapR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN)
