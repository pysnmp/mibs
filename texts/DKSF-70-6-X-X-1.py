...
# Produced by pysmi-1.1.12 at Wed May 29 10:58:28 2024
...
Counter32, Counter64, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks, iso, Unsigned32, Bits, IpAddress, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks", "iso", "Unsigned32", "Bits", "IpAddress", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npGsmStrength=npGsmStrength, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrap=npRelHumTrap, npRelHumTrapData=npRelHumTrapData, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npIoLevelOut=npIoLevelOut, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopN=npCurLoopN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, lightcom=lightcom, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeReset=npSmokeReset, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npRelayStartReset=npRelayStartReset, npIo=npIo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npThermoLow=npThermoLow, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npThermoHigh=npThermoHigh, FixedPoint1000=FixedPoint1000, npReboot=npReboot, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npGsm=npGsm, npIoMemo=npIoMemo, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npIoTable=npIoTable, npSmokePower=npSmokePower, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npThermoMemo=npThermoMemo, npIoTrapPrefix=npIoTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayN=npRelayN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopI=npCurLoopI, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npRelHumTempValue=npRelHumTempValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npIrCtrl=npIrCtrl, npRelHumTable=npRelHumTable, npThermoTrapStatus=npThermoTrapStatus, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelay=npRelay, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npIrReset=npIrReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLineN=npIoTrapLineN, npRelHumTrapSafe=npRelHumTrapSafe, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN)
