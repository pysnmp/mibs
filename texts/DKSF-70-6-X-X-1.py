...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, iso, NotificationType, Unsigned32, ModuleIdentity, Counter64, ObjectIdentity, Counter32, enterprises, TimeTicks, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter64", "ObjectIdentity", "Counter32", "enterprises", "TimeTicks", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapR=npCurLoopTrapR, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrPlayCmd=npIrPlayCmd, npResetStack=npResetStack, npRelHumStatus=npRelHumStatus, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayState=npRelayState, npCurLoopI=npCurLoopI, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapHigh=npThermoTrapHigh, npSmokeReset=npSmokeReset, npSoftReboot=npSoftReboot, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npThermoHigh=npThermoHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npSmoke=npSmoke, npIoMemo=npIoMemo, npCurLoopTable=npCurLoopTable, npRelHumValue=npRelHumValue, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, lightcom=lightcom, npGsmRegistration=npGsmRegistration, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopR=npCurLoopR, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npThermoTable=npThermoTable, npRelay=npRelay, npThermoMemo=npThermoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopN=npCurLoopN, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapV=npCurLoopTrapV, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npThermoValue=npThermoValue, npIrCtrl=npIrCtrl, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npIoLevelIn=npIoLevelIn, npRelayStartReset=npRelayStartReset, npIo=npIo, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npRelayEntry=npRelayEntry, npForcedReboot=npForcedReboot, npRelHumN=npRelHumN, npIoEntry=npIoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npRelHumTable=npRelHumTable, npGsmStrength=npGsmStrength, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMemo=npRelayMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npThermoTrapValue=npThermoTrapValue, npSmokeEntry=npSmokeEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npRelayMode=npRelayMode, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
