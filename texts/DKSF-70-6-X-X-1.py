...
# Produced by pysmi-1.1.8 at Thu Feb  9 12:05:20 2023
...
NotificationType, ObjectIdentity, TimeTicks, IpAddress, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Bits, Counter64, enterprises, Counter32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "TimeTicks", "IpAddress", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Bits", "Counter64", "enterprises", "Counter32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npIrStatus=npIrStatus, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopI=npCurLoopI, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsm=npGsm, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopN=npCurLoopN, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npIoLineN=npIoLineN, npRelHumN=npRelHumN, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelayState=npRelayState, npRelayStartReset=npRelayStartReset, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npSmokeTable=npSmokeTable, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, npResetStack=npResetStack, npForcedReboot=npForcedReboot, npThermoTraps=npThermoTraps, npRelHumTempStatus=npRelHumTempStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTraps=npGsmTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoEntry=npIoEntry, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMode=npRelayMode, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, npIoPulseCounter=npIoPulseCounter, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npThermoTable=npThermoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapN=npCurLoopTrapN, npSmokePower=npSmokePower, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npSmoke=npSmoke, npThermoLow=npThermoLow, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeStatus=npSmokeStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npRelayN=npRelayN, npIr=npIr, npRelHumidity=npRelHumidity, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npSmokeTrap=npSmokeTrap, lightcom=lightcom, FixedPoint1000=FixedPoint1000)
