...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:18:37 2022
...
MibIdentifier, Gauge32, enterprises, Counter32, Counter64, ModuleIdentity, ObjectIdentity, TimeTicks, iso, Unsigned32, IpAddress, NotificationType, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "enterprises", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "IpAddress", "NotificationType", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npRelHumMemo=npRelHumMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrap=npThermoTrap, npIrStatus=npIrStatus, npCurLoop=npCurLoop, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npGsmInfo=npGsmInfo, npSmokeTraps=npSmokeTraps, npGsmRegistration=npGsmRegistration, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npSmokeReset=npSmokeReset, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoEntry=npThermoEntry, npThermoStatus=npThermoStatus, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npIo=npIo, npThermoMemo=npThermoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeEntry=npSmokeEntry, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npThermoTrapStatus=npThermoTrapStatus, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npTrapInfo=npTrapInfo, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayTable=npRelayTable, npGsmFailed=npGsmFailed, npRelHumTrapFail=npRelHumTrapFail, npGsm=npGsm, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npRelHumTrapDataN=npRelHumTrapDataN, npRelayState=npRelayState, npIoTraps=npIoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npRelayN=npRelayN, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npIr=npIr, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoHigh=npThermoHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npIrReset=npIrReset, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLevelIn=npIoLevelIn, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npIoPulseCounter=npIoPulseCounter, npSmokeTable=npSmokeTable, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumEntry=npRelHumEntry, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npSmokeTrap=npSmokeTrap, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapHigh=npThermoTrapHigh)
