...
# Produced by pysmi-1.1.12 at Mon Apr 22 02:15:55 2024
...
ObjectIdentity, Gauge32, Unsigned32, NotificationType, Integer32, Counter32, enterprises, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Unsigned32", "NotificationType", "Integer32", "Counter32", "enterprises", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npIrReset=npIrReset, npIrCtrl=npIrCtrl, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, npRelHumTrapData=npRelHumTrapData, npIoTrapPrefix=npIoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapN=npCurLoopTrapN, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npCurLoop=npCurLoop, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npCurLoopR=npCurLoopR, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npThermo=npThermo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoMemo=npIoMemo, npSoftReboot=npSoftReboot, npCurLoopV=npCurLoopV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempValue=npRelHumTempValue, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, FixedPoint1000=FixedPoint1000, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, lightcom=lightcom, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npIr=npIr, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npSmokePower=npSmokePower, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npThermoValue=npThermoValue, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npThermoTrap=npThermoTrap, npSmoke=npSmoke, npRelay=npRelay, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npTrapEmailTo=npTrapEmailTo, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npThermoTraps=npThermoTraps, npIoTrap=npIoTrap, npRelHumTable=npRelHumTable, npThermoHigh=npThermoHigh, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo)
