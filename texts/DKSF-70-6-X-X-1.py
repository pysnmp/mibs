...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:05:05 2023
...
enterprises, Gauge32, Counter32, TimeTicks, NotificationType, ModuleIdentity, ObjectIdentity, MibIdentifier, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter32", "TimeTicks", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayState=npRelayState, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npCurLoopTrapN=npCurLoopTrapN, npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npIoLineN=npIoLineN, npResetStack=npResetStack, npRelayMode=npRelayMode, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapLow=npThermoTrapLow, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValuePrecise=npThermoValuePrecise, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmTraps=npGsmTraps, npIoEntry=npIoEntry, npThermoTraps=npThermoTraps, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npSoftReboot=npSoftReboot, npIrReset=npIrReset, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmStrength=npGsmStrength, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npIo=npIo, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npIrCtrl=npIrCtrl, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumMemo=npRelHumMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npGsm=npGsm, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npSmokeTable=npSmokeTable, npIrStatus=npIrStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npRelHumTable=npRelHumTable, npGsmFailed=npGsmFailed, npCurLoopPower=npCurLoopPower, npIoPulseCounter=npIoPulseCounter, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTraps=npIoTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseStart=npIoSinglePulseStart, lightcom=lightcom, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npSmoke=npSmoke)
