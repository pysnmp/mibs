...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:46:25 2022
...
ModuleIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Unsigned32, MibIdentifier, IpAddress, Counter64, enterprises, Integer32, Gauge32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "IpAddress", "Counter64", "enterprises", "Integer32", "Gauge32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npGsmTraps=npGsmTraps, npIoTrap=npIoTrap, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeEntry=npSmokeEntry, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npResetStack=npResetStack, npIoTraps=npIoTraps, npRelayMode=npRelayMode, npSmokeReset=npSmokeReset, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npRelHumTable=npRelHumTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopN=npCurLoopN, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrStatus=npIrStatus, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npThermo=npThermo, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoEntry=npThermoEntry, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelay=npRelay, npIoPulseCounter=npIoPulseCounter, npGsmInfo=npGsmInfo, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopR=npCurLoopR, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, npRelHumN=npRelHumN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npGsm=npGsm, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npForcedReboot=npForcedReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npSoftReboot=npSoftReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npCurLoopPower=npCurLoopPower, npCurLoop=npCurLoop, npGsmStrength=npGsmStrength, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapSafe=npRelHumTrapSafe, npIo=npIo, npRelHumMemo=npRelHumMemo, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopI=npCurLoopI, npThermoHigh=npThermoHigh, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokePower=npSmokePower, npIoMemo=npIoMemo, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npIoEntry=npIoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npRelHumEntry=npRelHumEntry, npThermoTraps=npThermoTraps, npCurLoopTrapN=npCurLoopTrapN)
