...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:18:52 2021
...
ModuleIdentity, ObjectIdentity, IpAddress, enterprises, Gauge32, MibIdentifier, iso, Integer32, Counter64, TimeTicks, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "IpAddress", "enterprises", "Gauge32", "MibIdentifier", "iso", "Integer32", "Counter64", "TimeTicks", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTraps=npThermoTraps, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIoTrap=npIoTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npThermoTrapPrefix=npThermoTrapPrefix, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeMemo=npSmokeMemo, npSmoke=npSmoke, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrap=npGsmTrap, npRelayStartReset=npRelayStartReset, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTable=npRelHumTable, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npIrCtrl=npIrCtrl, npRelHumTrapData=npRelHumTrapData, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeReset=npSmokeReset, npThermoTrapStatus=npThermoTrapStatus, npRelHumidity=npRelHumidity, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npThermoTrapLow=npThermoTrapLow, npGsmStrength=npGsmStrength, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeEntry=npSmokeEntry, npRelHumN=npRelHumN, npCurLoopTrap=npCurLoopTrap, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoSensorN=npThermoSensorN, npIr=npIr, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npThermoEntry=npThermoEntry, npRelHumMemo=npRelHumMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npGsm=npGsm, npResetStack=npResetStack, npCurLoopTrapPower=npCurLoopTrapPower, npIrReset=npIrReset, npThermoTrapSensorN=npThermoTrapSensorN, npRelayMode=npRelayMode, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrap=npThermoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npSmokeTraps=npSmokeTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSoftReboot=npSoftReboot, npRelayN=npRelayN, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, lightcom=lightcom, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npRelay=npRelay, npCurLoopR=npCurLoopR, npIo=npIo, npCurLoopI=npCurLoopI, npThermoHigh=npThermoHigh, npSmokeStatus=npSmokeStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLineN=npIoLineN, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopV=npCurLoopV, npIoLevelIn=npIoLevelIn)
