...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:59:00 2024
...
Counter64, TimeTicks, iso, Unsigned32, Integer32, ObjectIdentity, NotificationType, Counter32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "iso", "Unsigned32", "Integer32", "ObjectIdentity", "NotificationType", "Counter32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npThermoLow=npThermoLow, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelayState=npRelayState, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npThermoEntry=npThermoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npGsm=npGsm, npCurLoopTrapI=npCurLoopTrapI, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npReboot=npReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npSmokeTraps=npSmokeTraps, npRelHumEntry=npRelHumEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumN=npRelHumN, npThermoValue=npThermoValue, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmInfo=npGsmInfo, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopR=npCurLoopR, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npIoTrap=npIoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npThermo=npThermo, npForcedReboot=npForcedReboot, npCurLoopStatus=npCurLoopStatus, npGsmRegistration=npGsmRegistration, npRelHumTable=npRelHumTable, npThermoTrapLow=npThermoTrapLow, npIoLevelIn=npIoLevelIn, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIr=npIr, npSmokeMemo=npSmokeMemo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMode=npRelayMode, npIoTrapPrefix=npIoTrapPrefix, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npGsmTrapPrefix=npGsmTrapPrefix, npGsmFailed=npGsmFailed, npIrStatus=npIrStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTempValue=npRelHumTempValue, npRelayEntry=npRelayEntry, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapV=npCurLoopTrapV, npTrapInfo=npTrapInfo, lightcom=lightcom, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapPrefix=npSmokeTrapPrefix, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMemo=npRelayMemo, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayN=npRelayN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeReset=npSmokeReset, npCurLoopI=npCurLoopI, npIoSinglePulseStart=npIoSinglePulseStart)
