...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:26:01 2023
...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, enterprises, Gauge32, ModuleIdentity, iso, ObjectIdentity, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "enterprises", "Gauge32", "ModuleIdentity", "iso", "ObjectIdentity", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapStatus=npThermoTrapStatus, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelay=npRelay, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrap=npIoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npThermoTable=npThermoTable, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npRelayEntry=npRelayEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npReboot=npReboot, npCurLoopPower=npCurLoopPower, npCurLoopTraps=npCurLoopTraps, npIoTraps=npIoTraps, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopN=npCurLoopN, npRelHumTrapTemp=npRelHumTrapTemp, npThermo=npThermo, npSmoke=npSmoke, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npCurLoop=npCurLoop, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelHumN=npRelHumN, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npRelHumValue=npRelHumValue, npSmokeTraps=npSmokeTraps, npRelHumMemo=npRelHumMemo, npRelHumStatus=npRelHumStatus, npGsmFailed=npGsmFailed, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npRelayMemo=npRelayMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrStatus=npIrStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npIo=npIo, FixedPoint1000=FixedPoint1000, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npRelayN=npRelayN, npIoTable=npIoTable, npRelayStartReset=npRelayStartReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapData=npRelHumTrapData, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrap=npSmokeTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrap=npCurLoopTrap, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataN=npRelHumTrapDataN, npForcedReboot=npForcedReboot, npSmokeReset=npSmokeReset, npSoftReboot=npSoftReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npIoLineN=npIoLineN, npThermoStatus=npThermoStatus, npGsm=npGsm, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumEntry=npRelHumEntry, lightcom=lightcom, npIoEntry=npIoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npIoLevelOut=npIoLevelOut, npResetStack=npResetStack, npIoLevelIn=npIoLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoHigh=npThermoHigh, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow)
