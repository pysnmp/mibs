...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:08:57 2024
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Unsigned32, ModuleIdentity, Gauge32, iso, ObjectIdentity, Bits, Counter32, MibIdentifier, NotificationType, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Unsigned32", "ModuleIdentity", "Gauge32", "iso", "ObjectIdentity", "Bits", "Counter32", "MibIdentifier", "NotificationType", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataN=npRelHumTrapDataN, npGsmInfo=npGsmInfo, npIoPulseCounter=npIoPulseCounter, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, npSmokeTrap=npSmokeTrap, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npCurLoopTrapPower=npCurLoopTrapPower, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npSmokeTraps=npSmokeTraps, npThermo=npThermo, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npGsmTrap=npGsmTrap, npIr=npIr, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapStatus=npSmokeTrapStatus, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokePower=npSmokePower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npIrReset=npIrReset, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npThermoTrap=npThermoTrap, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrap=npCurLoopTrap, npThermoEntry=npThermoEntry, npRelayEntry=npRelayEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValue=npThermoValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoSensorN=npThermoSensorN, npCurLoopR=npCurLoopR, npIoTrap=npIoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npThermoTrapValue=npThermoTrapValue, npIrCtrl=npIrCtrl, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npIoTraps=npIoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npReboot=npReboot, npRelayState=npRelayState, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npRelayMemo=npRelayMemo, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npCurLoop=npCurLoop, npRelHumN=npRelHumN, npCurLoopStatus=npCurLoopStatus, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTable=npSmokeTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapSensorN=npThermoTrapSensorN, npRelayStartReset=npRelayStartReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeMemo=npSmokeMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTraps=npGsmTraps, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npRelay=npRelay, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTable=npCurLoopTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapEmailTo=npTrapEmailTo, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npThermoHigh=npThermoHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npCurLoopTrapR=npCurLoopTrapR)
