...
Integer32, ObjectIdentity, Gauge32, Counter64, Counter32, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, enterprises, iso, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Gauge32", "Counter64", "Counter32", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "enterprises", "iso", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeMemo=npSmokeMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npIo=npIo, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataN=npRelHumTrapDataN, npIrReset=npIrReset, npIoEntry=npIoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelayTable=npRelayTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, npSmokeTrap=npSmokeTrap, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempValue=npRelHumTempValue, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapHigh=npThermoTrapHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValue=npThermoValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermo=npThermo, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npRelHumEntry=npRelHumEntry, npIrCtrl=npIrCtrl, npRelHumTrapFail=npRelHumTrapFail, npSmokeStatus=npSmokeStatus, npGsm=npGsm, npThermoStatus=npThermoStatus, npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumidity=npRelHumidity, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npIr=npIr, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayState=npRelayState, npRelay=npRelay, npRelHumN=npRelHumN, npThermoTrapLow=npThermoTrapLow, npThermoTrapStatus=npThermoTrapStatus, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTraps=npThermoTraps, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTemp=npRelHumTrapTemp, npGsmFailed=npGsmFailed, npRelayMode=npRelayMode, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npSmoke=npSmoke, npCurLoopTrapI=npCurLoopTrapI, npGsmStrength=npGsmStrength, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayStartReset=npRelayStartReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTable=npIoTable, npCurLoopPower=npCurLoopPower, npThermoTrapValue=npThermoTrapValue, npIoMemo=npIoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npRelayN=npRelayN, npThermoTable=npThermoTable, npCurLoopTrap=npCurLoopTrap, npIoLevelIn=npIoLevelIn, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000)
