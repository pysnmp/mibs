...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:38:04 2021
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, enterprises, TimeTicks, Bits, Counter64, IpAddress, MibIdentifier, Counter32, ModuleIdentity, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "enterprises", "TimeTicks", "Bits", "Counter64", "IpAddress", "MibIdentifier", "Counter32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npCurLoopI=npCurLoopI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapMemo=npSmokeTrapMemo, npIrCtrl=npIrCtrl, npIoLineN=npIoLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npGsmTrap=npGsmTrap, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npCurLoopV=npCurLoopV, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npIrStatus=npIrStatus, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmoke=npSmoke, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokePower=npSmokePower, npCurLoopTrapPower=npCurLoopTrapPower, npIrReset=npIrReset, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npRelHumN=npRelHumN, npRelHumTrap=npRelHumTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npRelayN=npRelayN, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npThermoTrap=npThermoTrap, npSmokeStatus=npSmokeStatus, npCurLoopR=npCurLoopR, npRelHumTempStatus=npRelHumTempStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTraps=npSmokeTraps, npRelayState=npRelayState, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npIrPlayCmd=npIrPlayCmd, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npRelayMode=npRelayMode, npGsmTraps=npGsmTraps, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npSmokeTable=npSmokeTable, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoHigh=npThermoHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npReboot=npReboot, npTrapEmailTo=npTrapEmailTo, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npIo=npIo, npThermoTrapHigh=npThermoTrapHigh, npIoEntry=npIoEntry, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npSmokeTrap=npSmokeTrap, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable)
