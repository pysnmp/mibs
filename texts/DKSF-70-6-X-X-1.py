...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:35:13 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ModuleIdentity, NotificationType, Counter64, Unsigned32, Bits, IpAddress, enterprises, ObjectIdentity, iso, Gauge32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter64", "Unsigned32", "Bits", "IpAddress", "enterprises", "ObjectIdentity", "iso", "Gauge32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumN=npRelHumN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempValue=npRelHumTempValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npIr=npIr, npReboot=npReboot, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npGsmTrap=npGsmTrap, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrPlayCmd=npIrPlayCmd, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npGsmFailed=npGsmFailed, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumValue=npRelHumValue, npRelHumEntry=npRelHumEntry, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapI=npCurLoopTrapI, npRelay=npRelay, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npGsm=npGsm, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN, npIoTrapMemo=npIoTrapMemo, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npSoftReboot=npSoftReboot, npRelHumTrapSafe=npRelHumTrapSafe, npIoLineN=npIoLineN, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapPower=npCurLoopTrapPower, npIrStatus=npIrStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMode=npRelayMode, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npThermoValuePrecise=npThermoValuePrecise, npTrapInfo=npTrapInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npIo=npIo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTable=npSmokeTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npThermoTrapLow=npThermoTrapLow, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npSmoke=npSmoke, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npCurLoopPower=npCurLoopPower, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251)
