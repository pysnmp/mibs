...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:22:05 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, TimeTicks, ModuleIdentity, Counter32, NotificationType, Unsigned32, MibIdentifier, Bits, IpAddress, Gauge32, enterprises, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "TimeTicks", "ModuleIdentity", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "enterprises", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npSmokePower=npSmokePower, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npGsm=npGsm, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npIr=npIr, npSmoke=npSmoke, npRelayMemo=npRelayMemo, npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumidity=npRelHumidity, npRelayStartReset=npRelayStartReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoHigh=npThermoHigh, npIrPlayCmd=npIrPlayCmd, npRelayTable=npRelayTable, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapStatus=npThermoTrapStatus, npCurLoopN=npCurLoopN, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumEntry=npRelHumEntry, npReboot=npReboot, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmStrength=npGsmStrength, npCurLoop=npCurLoop, npTrapInfo=npTrapInfo, npRelayEntry=npRelayEntry, npThermoValue=npThermoValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoEntry=npIoEntry, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npRelHumMemo=npRelHumMemo, npIoTable=npIoTable, npRelayMode=npRelayMode, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, FixedPoint1000=FixedPoint1000, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrap=npThermoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopV=npCurLoopV, npIoTrap=npIoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npIoLineN=npIoLineN, npSmokeEntry=npSmokeEntry, npThermoEntry=npThermoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npForcedReboot=npForcedReboot, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapLow=npThermoTrapLow, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumN=npRelHumN, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, lightcom=lightcom, npIoTraps=npIoTraps, npThermoMemo=npThermoMemo, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrap=npSmokeTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npIrCtrl=npIrCtrl, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, npGsmFailed=npGsmFailed, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npSoftReboot=npSoftReboot, npSmokeReset=npSmokeReset)
