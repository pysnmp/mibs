...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:59:57 2023
...
Integer32, Gauge32, enterprises, ObjectIdentity, NotificationType, Unsigned32, Counter32, iso, ModuleIdentity, TimeTicks, MibIdentifier, IpAddress, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "enterprises", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter32", "iso", "ModuleIdentity", "TimeTicks", "MibIdentifier", "IpAddress", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npThermoTrapLow=npThermoTrapLow, npCurLoopPower=npCurLoopPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeStatus=npSmokeStatus, npIoTrap=npIoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npIoTrapMemo=npIoTrapMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsm=npGsm, npIoLineN=npIoLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValue=npThermoValue, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npSmokeSensorN=npSmokeSensorN, npThermoMemo=npThermoMemo, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npRelayTable=npRelayTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npGsmFailed=npGsmFailed, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npIo=npIo, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npCurLoopN=npCurLoopN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npRelHumTrapTemp=npRelHumTrapTemp, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayN=npRelayN, npIoMemo=npIoMemo, npSmokeEntry=npSmokeEntry, npIoEntry=npIoEntry, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npThermoEntry=npThermoEntry, npRelay=npRelay, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTable=npThermoTable, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npSmokeTrap=npSmokeTrap, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMemo=npRelayMemo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npThermoTrap=npThermoTrap, npThermoHigh=npThermoHigh, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npCurLoopTable=npCurLoopTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopR=npCurLoopR, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmRegistration=npGsmRegistration, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npSoftReboot=npSoftReboot, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npThermoTraps=npThermoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, lightcom=lightcom, npSmokeTraps=npSmokeTraps, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npGsmTraps=npGsmTraps)
