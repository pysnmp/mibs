...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:05:52 2024
...
Gauge32, TimeTicks, Unsigned32, enterprises, ObjectIdentity, Counter64, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, ModuleIdentity, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Unsigned32", "enterprises", "ObjectIdentity", "Counter64", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "ModuleIdentity", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npRelHumStatus=npRelHumStatus, npRelayN=npRelayN, npSmokeTrap=npSmokeTrap, npCurLoopTable=npCurLoopTable, npIoTrapPrefix=npIoTrapPrefix, npGsm=npGsm, npCurLoopTrap=npCurLoopTrap, npThermoMemo=npThermoMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapInfo=npTrapInfo, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npSmokeTable=npSmokeTable, npThermoStatus=npThermoStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npIoTable=npIoTable, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npThermoTrapValue=npThermoTrapValue, npGsmRegistration=npGsmRegistration, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIrCtrl=npIrCtrl, npGsmFailed=npGsmFailed, npIr=npIr, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npResetStack=npResetStack, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npGsmInfo=npGsmInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npRelay=npRelay, npRelayMode=npRelayMode, npRelHumTrapData=npRelHumTrapData, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npIoLineN=npIoLineN, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayTable=npRelayTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npCurLoopV=npCurLoopV, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempValue=npRelHumTempValue, npCurLoopEntry=npCurLoopEntry, npGsmStrength=npGsmStrength, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapMemo=npSmokeTrapMemo, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npRelHumEntry=npRelHumEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npRelHumTrap=npRelHumTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTraps=npCurLoopTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumValue=npRelHumValue, npIrReset=npIrReset, npReboot=npReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapMemo=npThermoTrapMemo, npIrStatus=npIrStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumN=npRelHumN, npCurLoopTrapPower=npCurLoopTrapPower, npSmoke=npSmoke, npThermoValuePrecise=npThermoValuePrecise, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopN=npCurLoopN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopR=npCurLoopR)
