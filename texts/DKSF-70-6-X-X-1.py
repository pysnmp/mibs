...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:26:30 2021
...
MibIdentifier, Counter64, TimeTicks, iso, NotificationType, Unsigned32, Gauge32, enterprises, IpAddress, Bits, ModuleIdentity, ObjectIdentity, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "TimeTicks", "iso", "NotificationType", "Unsigned32", "Gauge32", "enterprises", "IpAddress", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npForcedReboot=npForcedReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npRelay=npRelay, npRelHumidity=npRelHumidity, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopPower=npCurLoopPower, npIoLevelOut=npIoLevelOut, npThermoLow=npThermoLow, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIr=npIr, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoSensorN=npThermoSensorN, npGsm=npGsm, npCurLoopV=npCurLoopV, npCurLoopTable=npCurLoopTable, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npGsmInfo=npGsmInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopR=npCurLoopR, npSmokeEntry=npSmokeEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMode=npRelayMode, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npResetStack=npResetStack, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoEntry=npThermoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npSmokeMemo=npSmokeMemo, npRelayTable=npRelayTable, lightcom=lightcom, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npThermoTrapValue=npThermoTrapValue, npSmokeTrap=npSmokeTrap, npRelayStartReset=npRelayStartReset, npIo=npIo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoEntry=npIoEntry, npSmoke=npSmoke, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmStrength=npGsmStrength, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npThermoTable=npThermoTable, npSmokeReset=npSmokeReset, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, npIoTrap=npIoTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo)
