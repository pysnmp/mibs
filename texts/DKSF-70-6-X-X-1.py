...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:00:23 2021
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, iso, TimeTicks, Bits, Gauge32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "TimeTicks", "Bits", "Gauge32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMemo=npRelayMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoEntry=npThermoEntry, npThermoHigh=npThermoHigh, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npRelHumTrapFail=npRelHumTrapFail, npThermo=npThermo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npThermoLow=npThermoLow, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumEntry=npRelHumEntry, npCurLoopI=npCurLoopI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopN=npCurLoopN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npReboot=npReboot, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumValue=npRelHumValue, npIoTraps=npIoTraps, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npThermoValuePrecise=npThermoValuePrecise, npIo=npIo, npThermoStatus=npThermoStatus, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npIoLevelIn=npIoLevelIn, npIoMemo=npIoMemo, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npCurLoopTable=npCurLoopTable, npThermoMemo=npThermoMemo, npIoTrapMemo=npIoTrapMemo, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npResetStack=npResetStack, npThermoTrapHigh=npThermoTrapHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumN=npRelHumN, npCurLoop=npCurLoop, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopStatus=npCurLoopStatus, npIoPulseCounter=npIoPulseCounter, npRelHumMemo=npRelHumMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npIrStatus=npIrStatus, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN)
