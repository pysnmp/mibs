...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:32:30 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, iso, NotificationType, Bits, Unsigned32, ObjectIdentity, TimeTicks, Gauge32, Counter32, Counter64, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "iso", "NotificationType", "Bits", "Unsigned32", "ObjectIdentity", "TimeTicks", "Gauge32", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTraps=npThermoTraps, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeMemo=npSmokeMemo, npIrCtrl=npIrCtrl, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npGsmStrength=npGsmStrength, npSmokeTrap=npSmokeTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTable=npRelHumTable, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTable=npCurLoopTable, npIoTrapMemo=npIoTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumMemo=npRelHumMemo, npSmoke=npSmoke, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npIrReset=npIrReset, npTrapInfo=npTrapInfo, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npGsmFailed=npGsmFailed, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npSmokeStatus=npSmokeStatus, npRelHumStatus=npRelHumStatus, npRelay=npRelay, npGsmTraps=npGsmTraps, lightcom=lightcom, npIoMemo=npIoMemo, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npThermoLow=npThermoLow, FixedPoint1000=FixedPoint1000, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npTrapEmailTo=npTrapEmailTo, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, npRelayN=npRelayN, npGsmInfo=npGsmInfo, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopN=npCurLoopN, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelayState=npRelayState, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapData=npRelHumTrapData, npThermoStatus=npThermoStatus, npRelayStartReset=npRelayStartReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapStatus=npSmokeTrapStatus, npSoftReboot=npSoftReboot, npIr=npIr, npIo=npIo, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoHigh=npThermoHigh, npCurLoop=npCurLoop, npThermoTrapMemo=npThermoTrapMemo, npRelayTable=npRelayTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npThermo=npThermo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
