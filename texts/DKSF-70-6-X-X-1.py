...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:45:33 2023
...
NotificationType, MibIdentifier, Counter32, TimeTicks, Integer32, enterprises, Bits, IpAddress, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter32", "TimeTicks", "Integer32", "enterprises", "Bits", "IpAddress", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npGsmInfo=npGsmInfo, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npSmokeStatus=npSmokeStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeMemo=npSmokeMemo, npThermoTraps=npThermoTraps, npTrapInfo=npTrapInfo, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopV=npCurLoopV, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npThermoValuePrecise=npThermoValuePrecise, npSmokeEntry=npSmokeEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapEmailTo=npTrapEmailTo, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIo=npIo, npGsmRegistration=npGsmRegistration, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrap=npSmokeTrap, npReboot=npReboot, FixedPoint1000=FixedPoint1000, npForcedReboot=npForcedReboot, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayTable=npRelayTable, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoSensorN=npThermoSensorN, npRelHumidity=npRelHumidity, npIr=npIr, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, lightcom=lightcom, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrap=npIoTrap, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npCurLoopPower=npCurLoopPower, npRelayMemo=npRelayMemo, npRelayEntry=npRelayEntry, npRelHumTempValue=npRelHumTempValue, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npRelayState=npRelayState, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npThermoTrapValue=npThermoTrapValue, npSoftReboot=npSoftReboot, npThermoTrapStatus=npThermoTrapStatus, npRelHumValue=npRelHumValue, npIrCtrl=npIrCtrl, npIoMemo=npIoMemo, npSmokeReset=npSmokeReset, npRelHumTrapData=npRelHumTrapData, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermo=npThermo, npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempStatus=npRelHumTempStatus, npIoTrapMemo=npIoTrapMemo, npGsmTraps=npGsmTraps, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npRelHumStatus=npRelHumStatus, npThermoTable=npThermoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo)
