...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:18:51 2023
...
Bits, ObjectIdentity, Integer32, Unsigned32, TimeTicks, IpAddress, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Gauge32, MibIdentifier, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Integer32", "Unsigned32", "TimeTicks", "IpAddress", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Gauge32", "MibIdentifier", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoop=npCurLoop, npCurLoopStatus=npCurLoopStatus, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npRelayN=npRelayN, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumMemo=npRelHumMemo, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npCurLoopTrapPower=npCurLoopTrapPower, npIoPulseCounter=npIoPulseCounter, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npGsmInfo=npGsmInfo, npSmokeTable=npSmokeTable, npIr=npIr, npRelHumTempStatus=npRelHumTempStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelIn=npIoLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokePower=npSmokePower, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npIoLineN=npIoLineN, npRelHumTable=npRelHumTable, npGsmRegistration=npGsmRegistration, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapMemo=npIoTrapMemo, npRelayState=npRelayState, npIoTrapPrefix=npIoTrapPrefix, npIoEntry=npIoEntry, npTrapInfo=npTrapInfo, npRelay=npRelay, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoValue=npThermoValue, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSoftReboot=npSoftReboot, npIo=npIo, npGsmTraps=npGsmTraps, npRelHumN=npRelHumN, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopEntry=npCurLoopEntry, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npSmokeReset=npSmokeReset, npGsm=npGsm, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempValue=npRelHumTempValue, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmStrength=npGsmStrength, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npThermoTrap=npThermoTrap)
