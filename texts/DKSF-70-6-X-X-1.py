...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:19:30 2022
...
Unsigned32, Integer32, TimeTicks, iso, Counter64, MibIdentifier, Counter32, ModuleIdentity, IpAddress, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "TimeTicks", "iso", "Counter64", "MibIdentifier", "Counter32", "ModuleIdentity", "IpAddress", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopStatus=npCurLoopStatus, npGsm=npGsm, npThermoValue=npThermoValue, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapInfo=npTrapInfo, npIoTrapLevelIn=npIoTrapLevelIn, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npRelHumN=npRelHumN, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrap=npRelHumTrap, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npThermoTrap=npThermoTrap, npIoTable=npIoTable, npSmokeTrapStatus=npSmokeTrapStatus, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npRelHumEntry=npRelHumEntry, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npThermo=npThermo, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeReset=npSmokeReset, npThermoSensorN=npThermoSensorN, npIo=npIo, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npRelHumMemo=npRelHumMemo, npReboot=npReboot, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npRelayN=npRelayN, npIrReset=npIrReset, npRelHumTrapDataN=npRelHumTrapDataN, npRelayState=npRelayState, npSmokeTraps=npSmokeTraps, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npRelayMemo=npRelayMemo, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLineN=npIoTrapLineN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmRegistration=npGsmRegistration, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npSmoke=npSmoke, npIoLevelIn=npIoLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeEntry=npSmokeEntry, npCurLoopV=npCurLoopV, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMode=npRelayMode, npSmokeTable=npSmokeTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayTable=npRelayTable)
