...
# Produced by pysmi-1.1.12 at Fri Nov 22 16:03:29 2024
...
enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Counter32, NotificationType, Counter64, ObjectIdentity, IpAddress, MibIdentifier, iso, ModuleIdentity, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Counter32", "NotificationType", "Counter64", "ObjectIdentity", "IpAddress", "MibIdentifier", "iso", "ModuleIdentity", "Integer32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmRegistration=npGsmRegistration, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTable=npRelHumTable, npRelayTable=npRelayTable, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npSoftReboot=npSoftReboot, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmoke=npSmoke, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npSmokeTable=npSmokeTable, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPower=npCurLoopTrapPower, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npRelHumTempValue=npRelHumTempValue, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npCurLoopStatus=npCurLoopStatus, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapV=npCurLoopTrapV, npGsm=npGsm, npSmokeEntry=npSmokeEntry, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npReboot=npReboot, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npCurLoopPower=npCurLoopPower, npRelay=npRelay, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTraps=npGsmTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npIoTrap=npIoTrap, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrReset=npIrReset, npIoTrapMemo=npIoTrapMemo, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMode=npRelayMode, npIrPlayCmd=npIrPlayCmd, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, lightcom=lightcom, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoEntry=npThermoEntry, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npCurLoopTrapN=npCurLoopTrapN, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps)
