...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:40:40 2023
...
NotificationType, Unsigned32, MibIdentifier, ObjectIdentity, Counter32, IpAddress, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Counter32", "IpAddress", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npRelHumEntry=npRelHumEntry, npGsmTrap=npGsmTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeSensorN=npSmokeSensorN, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapPrefix=npThermoTrapPrefix, npIrStatus=npIrStatus, npIoEntry=npIoEntry, npRelHumTempValue=npRelHumTempValue, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayN=npRelayN, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmInfo=npGsmInfo, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, lightcom=lightcom, npSmokeTable=npSmokeTable, npIoTrap=npIoTrap, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, FixedPoint1000=FixedPoint1000, npThermoTrapMemo=npThermoTrapMemo, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npIrReset=npIrReset, npRelayMode=npRelayMode, npIoLevelOut=npIoLevelOut, npIr=npIr, npSmoke=npSmoke, npSoftReboot=npSoftReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npRelHumValue=npRelHumValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelayStartReset=npRelayStartReset, npIoTrapMemo=npIoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npGsmFailed=npGsmFailed, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npGsm=npGsm, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npRelay=npRelay, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npRelHumTrap=npRelHumTrap, npCurLoopN=npCurLoopN, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoop=npCurLoop, npRelayTable=npRelayTable, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npIo=npIo, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npTrapInfo=npTrapInfo)
