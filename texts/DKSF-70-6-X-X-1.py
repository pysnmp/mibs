...
# Produced by pysmi-1.1.12 at Fri Nov 22 11:58:30 2024
...
enterprises, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, TimeTicks, ObjectIdentity, Bits, Integer32, MibIdentifier, Counter32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "ObjectIdentity", "Bits", "Integer32", "MibIdentifier", "Counter32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopStatus=npCurLoopStatus, npThermoLow=npThermoLow, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npRelay=npRelay, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npThermoTrapLow=npThermoTrapLow, npThermoStatus=npThermoStatus, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopPower=npCurLoopPower, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npIoLevelOut=npIoLevelOut, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npRelayMemo=npRelayMemo, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npResetStack=npResetStack, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrap=npThermoTrap, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npRelayState=npRelayState, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTable=npSmokeTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermo=npThermo, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, npGsmInfo=npGsmInfo, npIr=npIr, npSmokeReset=npSmokeReset, npThermoMemo=npThermoMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npGsmTraps=npGsmTraps, npRelHumStatus=npRelHumStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTrapSafe=npRelHumTrapSafe, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTable=npIoTable, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npRelHumMemo=npRelHumMemo, npIo=npIo, npIoTrap=npIoTrap, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npIoTrapLevelIn=npIoTrapLevelIn, npTrapInfo=npTrapInfo, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelIn=npIoLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npReboot=npReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe)
