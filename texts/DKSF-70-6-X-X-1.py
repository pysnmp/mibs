...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:32:17 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Bits, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, IpAddress, Gauge32, iso, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32", "iso", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumStatus=npRelHumStatus, npReboot=npReboot, npTrapInfo=npTrapInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npIoTraps=npIoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npResetStack=npResetStack, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npSmokeEntry=npSmokeEntry, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npForcedReboot=npForcedReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoSensorN=npThermoSensorN, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npRelayMemo=npRelayMemo, npIoLevelIn=npIoLevelIn, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npIoLevelOut=npIoLevelOut, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTable=npRelHumTable, npIr=npIr, lightcom=lightcom, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelayTable=npRelayTable, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npThermoEntry=npThermoEntry, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, npCurLoopR=npCurLoopR, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npRelayN=npRelayN, npRelHumN=npRelHumN, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrap=npIoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npRelHumEntry=npRelHumEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayEntry=npRelayEntry, npIrCtrl=npIrCtrl, npSmokeStatus=npSmokeStatus, npCurLoopV=npCurLoopV, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoEntry=npIoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapData=npRelHumTrapData, npCurLoop=npCurLoop, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npRelayState=npRelayState, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npSmokeMemo=npSmokeMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npThermoValue=npThermoValue, npSmokeTrapStatus=npSmokeTrapStatus, npThermoStatus=npThermoStatus, npSmoke=npSmoke, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTable=npCurLoopTable, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataN=npRelHumTrapDataN, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTable=npSmokeTable)
