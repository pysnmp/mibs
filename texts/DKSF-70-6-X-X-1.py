...
# Produced by pysmi-1.1.10 at Fri Nov 10 11:15:04 2023
...
enterprises, TimeTicks, Gauge32, iso, ObjectIdentity, Integer32, Unsigned32, MibIdentifier, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "Integer32", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Counter32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoMemo=npIoMemo, npRelHumEntry=npRelHumEntry, npCurLoopEntry=npCurLoopEntry, npCurLoopTraps=npCurLoopTraps, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npCurLoopPower=npCurLoopPower, npIo=npIo, npThermoSensorN=npThermoSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeMemo=npSmokeMemo, FixedPoint1000=FixedPoint1000, npRelHumTempStatus=npRelHumTempStatus, npRelHumN=npRelHumN, npThermoHigh=npThermoHigh, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoStatus=npThermoStatus, npRelayMode=npRelayMode, npRelayEntry=npRelayEntry, npRelayN=npRelayN, npRelHumTable=npRelHumTable, npGsmTrap=npGsmTrap, npRelHumMemo=npRelHumMemo, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTraps=npIoTraps, npSmoke=npSmoke, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npIrCtrl=npIrCtrl, npIoEntry=npIoEntry, npRelayState=npRelayState, npIrPlayCmd=npIrPlayCmd, npCurLoopV=npCurLoopV, npThermoTraps=npThermoTraps, npThermoTrapValue=npThermoTrapValue, npRelHumTrap=npRelHumTrap, npThermoTrap=npThermoTrap, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeStatus=npSmokeStatus, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npIr=npIr, npRelHumStatus=npRelHumStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npIoTable=npIoTable, npCurLoopN=npCurLoopN, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npRelay=npRelay, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npIoLineN=npIoLineN, npIrReset=npIrReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npGsmStrength=npGsmStrength, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npGsmRegistration=npGsmRegistration, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npCurLoopR=npCurLoopR, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsm=npGsm, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npThermo=npThermo, npRelHumValue=npRelHumValue, npTrapEmailTo=npTrapEmailTo, npSmokeTraps=npSmokeTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapLow=npThermoTrapLow, npCurLoopTrap=npCurLoopTrap, npRelHumTrapData=npRelHumTrapData, npSmokeEntry=npSmokeEntry, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrStatus=npIrStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh)
