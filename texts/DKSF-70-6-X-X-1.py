...
# Produced by pysmi-1.1.12 at Tue May 28 12:15:49 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, TimeTicks, Counter32, enterprises, ObjectIdentity, Gauge32, iso, Bits, Unsigned32, NotificationType, ModuleIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "TimeTicks", "Counter32", "enterprises", "ObjectIdentity", "Gauge32", "iso", "Bits", "Unsigned32", "NotificationType", "ModuleIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npRelHumValue=npRelHumValue, npRelayEntry=npRelayEntry, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npThermoTraps=npThermoTraps, npSmokeMemo=npSmokeMemo, npGsmTrap=npGsmTrap, npThermoTrapLow=npThermoTrapLow, npRelHumTempValue=npRelHumTempValue, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npCurLoopN=npCurLoopN, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npIoTrapMemo=npIoTrapMemo, npSmokePower=npSmokePower, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npThermoValue=npThermoValue, lightcom=lightcom, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npIo=npIo, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npSmokeTable=npSmokeTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelay=npRelay, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrap=npSmokeTrap, npThermoTable=npThermoTable, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npGsmInfo=npGsmInfo, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrReset=npIrReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapN=npCurLoopTrapN, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoEntry=npThermoEntry, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoLow=npThermoLow, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npRelHumEntry=npRelHumEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npThermoSensorN=npThermoSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npIoPulseCounter=npIoPulseCounter, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoop=npCurLoop, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoMemo=npIoMemo)
