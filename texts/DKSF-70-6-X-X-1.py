...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:56:07 2022
...
Integer32, IpAddress, Gauge32, NotificationType, enterprises, Unsigned32, Bits, MibIdentifier, Counter32, ModuleIdentity, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Gauge32", "NotificationType", "enterprises", "Unsigned32", "Bits", "MibIdentifier", "Counter32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapLow=npThermoTrapLow, npThermoValue=npThermoValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npGsmTrap=npGsmTrap, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmStrength=npGsmStrength, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npThermoMemo=npThermoMemo, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npSmokeTraps=npSmokeTraps, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npThermoLow=npThermoLow, npThermo=npThermo, npRelHumTrapData=npRelHumTrapData, npIr=npIr, npTrapEmailTo=npTrapEmailTo, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, lightcom=lightcom, npRelHumTable=npRelHumTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempStatus=npRelHumTempStatus, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npIrPlayCmd=npIrPlayCmd, npCurLoopTraps=npCurLoopTraps, npRelHumN=npRelHumN, npRelay=npRelay, npGsm=npGsm, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npResetStack=npResetStack, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npRelayMemo=npRelayMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, npRelayState=npRelayState, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npThermoTable=npThermoTable, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npIo=npIo, npCurLoopStatus=npCurLoopStatus, npRelHumEntry=npRelHumEntry, npForcedReboot=npForcedReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrStatus=npIrStatus, npReboot=npReboot, npCurLoopPower=npCurLoopPower, npThermoTrap=npThermoTrap, npIoPulseCounter=npIoPulseCounter, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe)
