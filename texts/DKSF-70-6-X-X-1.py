...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:44:46 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter32, NotificationType, Gauge32, iso, TimeTicks, Unsigned32, Counter64, IpAddress, ObjectIdentity, Bits, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter32", "NotificationType", "Gauge32", "iso", "TimeTicks", "Unsigned32", "Counter64", "IpAddress", "ObjectIdentity", "Bits", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npIoTraps=npIoTraps, npThermoTrapHigh=npThermoTrapHigh, npIrReset=npIrReset, npThermoTrapValue=npThermoTrapValue, npGsm=npGsm, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npCurLoopV=npCurLoopV, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npRelayN=npRelayN, npRelayMode=npRelayMode, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoHigh=npThermoHigh, npSmokeSensorN=npSmokeSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapLow=npThermoTrapLow, npCurLoopStatus=npCurLoopStatus, npRelHumEntry=npRelHumEntry, npIoTrapLineN=npIoTrapLineN, npSmokeReset=npSmokeReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapInfo=npTrapInfo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTable=npCurLoopTable, npThermoTrapStatus=npThermoTrapStatus, npCurLoopI=npCurLoopI, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npIr=npIr, npSmokeTable=npSmokeTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npIoSinglePulseStart=npIoSinglePulseStart, npForcedReboot=npForcedReboot, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npGsmRegistration=npGsmRegistration, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTraps=npThermoTraps, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npRelHumN=npRelHumN, npIrStatus=npIrStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npResetStack=npResetStack, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumStatus=npRelHumStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumMemo=npRelHumMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTable=npRelHumTable, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTable=npIoTable, npThermo=npThermo, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251)
