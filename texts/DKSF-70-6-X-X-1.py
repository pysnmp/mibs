...
# Produced by pysmi-1.1.12 at Wed May 29 02:46:53 2024
...
Unsigned32, ModuleIdentity, TimeTicks, Gauge32, Integer32, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Counter64, Bits, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "Integer32", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Counter64", "Bits", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMemo=npRelayMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumidity=npRelHumidity, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapV=npCurLoopTrapV, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopN=npCurLoopN, npIrCtrl=npIrCtrl, npIoSinglePulseStart=npIoSinglePulseStart, npReboot=npReboot, npThermoHigh=npThermoHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTraps=npSmokeTraps, npThermoEntry=npThermoEntry, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npResetStack=npResetStack, FixedPoint1000=FixedPoint1000, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, npRelHumTempValue=npRelHumTempValue, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npGsmFailed=npGsmFailed, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMode=npRelayMode, npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npForcedReboot=npForcedReboot, npThermo=npThermo, npIoEntry=npIoEntry, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npGsmTraps=npGsmTraps, npRelayState=npRelayState, npCurLoopTrapR=npCurLoopTrapR, npCurLoopI=npCurLoopI, npGsm=npGsm, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopPower=npCurLoopPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npSmokeMemo=npSmokeMemo, npRelHumTrapDataN=npRelHumTrapDataN)
