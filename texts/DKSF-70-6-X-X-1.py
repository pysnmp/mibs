...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:24:15 2024
...
Counter32, Bits, ModuleIdentity, enterprises, Unsigned32, iso, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ModuleIdentity", "enterprises", "Unsigned32", "iso", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopStatus=npCurLoopStatus, npGsmStrength=npGsmStrength, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npIoTraps=npIoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npIo=npIo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLineN=npIoTrapLineN, npRelay=npRelay, npRelHumN=npRelHumN, npGsmTraps=npGsmTraps, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npSoftReboot=npSoftReboot, npCurLoopTrapR=npCurLoopTrapR, npThermoSensorN=npThermoSensorN, npCurLoopR=npCurLoopR, npThermoEntry=npThermoEntry, npRelayN=npRelayN, npGsmTrap=npGsmTrap, npThermoValuePrecise=npThermoValuePrecise, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumValue=npRelHumValue, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npSmokeStatus=npSmokeStatus, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npForcedReboot=npForcedReboot, npThermoLow=npThermoLow, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npThermoMemo=npThermoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npThermoTable=npThermoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayTable=npRelayTable, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, lightcom=lightcom, npRelHumEntry=npRelHumEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIr=npIr, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, npRelayMode=npRelayMode, npResetStack=npResetStack, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npGsmRegistration=npGsmRegistration, npThermoValue=npThermoValue, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npRelHumTrapFail=npRelHumTrapFail, npReboot=npReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npIoEntry=npIoEntry, npGsmFailed=npGsmFailed, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrap=npRelHumTrap, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo)
