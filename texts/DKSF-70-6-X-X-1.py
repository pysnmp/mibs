...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:39:56 2021
...
Counter64, iso, Bits, Gauge32, Unsigned32, TimeTicks, enterprises, NotificationType, Integer32, ObjectIdentity, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Bits", "Gauge32", "Unsigned32", "TimeTicks", "enterprises", "NotificationType", "Integer32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapStatus=npSmokeTrapStatus, npCurLoop=npCurLoop, npRelHumTrap=npRelHumTrap, npCurLoopTrapPower=npCurLoopTrapPower, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmFailed=npGsmFailed, npIoMemo=npIoMemo, npThermoTable=npThermoTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npIoPulseCounter=npIoPulseCounter, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npResetStack=npResetStack, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npThermoLow=npThermoLow, npSmokeTable=npSmokeTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npSmokeSensorN=npSmokeSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrap=npIoTrap, npRelayState=npRelayState, npSmoke=npSmoke, npCurLoopTrapI=npCurLoopTrapI, npCurLoopI=npCurLoopI, npRelayStartReset=npRelayStartReset, npThermoTraps=npThermoTraps, npGsmInfo=npGsmInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeReset=npSmokeReset, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLineN=npIoLineN, npThermo=npThermo, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrPlayCmd=npIrPlayCmd, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npGsmTrap=npGsmTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelay=npRelay, npIrReset=npIrReset, lightcom=lightcom, npRelayMemo=npRelayMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMode=npRelayMode, npIoLevelOut=npIoLevelOut, npThermoTrap=npThermoTrap, npIr=npIr, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npSmokePower=npSmokePower, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npCurLoopTrap=npCurLoopTrap, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npIo=npIo, npIrStatus=npIrStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmRegistration=npGsmRegistration, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npRelayTable=npRelayTable, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npIoTable=npIoTable, npRelHumValue=npRelHumValue)
