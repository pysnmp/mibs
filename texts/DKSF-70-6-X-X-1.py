...
# Produced by pysmi-1.1.8 at Wed Sep 13 12:56:00 2023
...
Integer32, Gauge32, Counter64, Counter32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Unsigned32, enterprises, iso, MibIdentifier, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter64", "Counter32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "enterprises", "iso", "MibIdentifier", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSoftReboot=npSoftReboot, npRelHumidity=npRelHumidity, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapStatus=npThermoTrapStatus, npSmokeEntry=npSmokeEntry, FixedPoint1000=FixedPoint1000, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrap=npGsmTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npIoEntry=npIoEntry, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npThermoHigh=npThermoHigh, npSmokeReset=npSmokeReset, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npSmokeTable=npSmokeTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeStatus=npSmokeStatus, npThermoTrapValue=npThermoTrapValue, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrap=npSmokeTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumEntry=npRelHumEntry, npIrPlayCmd=npIrPlayCmd, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, npCurLoopTable=npCurLoopTable, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmFailed=npGsmFailed, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npResetStack=npResetStack, npRelHumTrap=npRelHumTrap, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npThermoTable=npThermoTable, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmoke=npSmoke, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopV=npCurLoopV, npCurLoop=npCurLoop, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npCurLoopR=npCurLoopR, npThermo=npThermo, npThermoTrap=npThermoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npIr=npIr, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoMemo=npIoMemo, npThermoEntry=npThermoEntry)
