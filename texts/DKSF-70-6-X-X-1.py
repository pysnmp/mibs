...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:46:28 2024
...
Counter32, Integer32, ModuleIdentity, IpAddress, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Bits, TimeTicks, Unsigned32, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Bits", "TimeTicks", "Unsigned32", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npResetStack=npResetStack, npRelHumEntry=npRelHumEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapStatus=npThermoTrapStatus, npIoEntry=npIoEntry, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npSmokeReset=npSmokeReset, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoLow=npThermoLow, npIrPlayCmd=npIrPlayCmd, npTrapInfo=npTrapInfo, npThermo=npThermo, npRelayTable=npRelayTable, npRelHumTrap=npRelHumTrap, npCurLoopEntry=npCurLoopEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npIoLevelIn=npIoLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, npThermoValue=npThermoValue, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopI=npCurLoopI, npCurLoopV=npCurLoopV, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, npIrStatus=npIrStatus, npRelHumStatus=npRelHumStatus, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumidity=npRelHumidity, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npGsmFailed=npGsmFailed, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrap=npCurLoopTrap, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMode=npRelayMode, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapLow=npThermoTrapLow, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npSoftReboot=npSoftReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npRelayState=npRelayState, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npSmoke=npSmoke, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npThermoTable=npThermoTable, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npGsm=npGsm, npIo=npIo, npThermoEntry=npThermoEntry, npThermoHigh=npThermoHigh, npRelay=npRelay, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrap=npGsmTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, FixedPoint1000=FixedPoint1000, npCurLoopTrapR=npCurLoopTrapR, npRelayN=npRelayN)
