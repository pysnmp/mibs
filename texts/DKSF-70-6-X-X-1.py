...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:39:19 2024
...
Counter32, Gauge32, MibIdentifier, Counter64, ObjectIdentity, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Bits, ModuleIdentity, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "Counter64", "ObjectIdentity", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Bits", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npGsm=npGsm, npIoPulseCounter=npIoPulseCounter, npForcedReboot=npForcedReboot, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTable=npThermoTable, npIr=npIr, FixedPoint1000=FixedPoint1000, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npThermo=npThermo, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npRelayMemo=npRelayMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, lightcom=lightcom, npThermoTrapHigh=npThermoTrapHigh, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npIrPlayCmd=npIrPlayCmd, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npRelHumTable=npRelHumTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npRelHumEntry=npRelHumEntry, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npRelayEntry=npRelayEntry, npRelayTable=npRelayTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrReset=npIrReset, npThermoEntry=npThermoEntry, npSmokeTraps=npSmokeTraps, npThermoTrapValue=npThermoTrapValue, npCurLoop=npCurLoop, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLineN=npIoTrapLineN, npIoLineN=npIoLineN, npIoEntry=npIoEntry, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTable=npCurLoopTable, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npThermoValue=npThermoValue, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npSmokeTable=npSmokeTable, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npResetStack=npResetStack, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npRelHumN=npRelHumN, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopI=npCurLoopI, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npCurLoopN=npCurLoopN, npReboot=npReboot, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npCurLoopStatus=npCurLoopStatus, npRelHumStatus=npRelHumStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrap=npSmokeTrap, npIrStatus=npIrStatus, npIrCtrl=npIrCtrl)
