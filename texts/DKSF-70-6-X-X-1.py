...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:21:50 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ModuleIdentity, Integer32, IpAddress, Counter64, Gauge32, Bits, Counter32, ObjectIdentity, iso, Unsigned32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ModuleIdentity", "Integer32", "IpAddress", "Counter64", "Gauge32", "Bits", "Counter32", "ObjectIdentity", "iso", "Unsigned32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayTable=npRelayTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npIrCtrl=npIrCtrl, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npCurLoop=npCurLoop, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npCurLoopN=npCurLoopN, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopR=npCurLoopR, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npSmokeTable=npSmokeTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, FixedPoint1000=FixedPoint1000, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTraps=npCurLoopTraps, npReboot=npReboot, npSmokeStatus=npSmokeStatus, npCurLoopTable=npCurLoopTable, npGsmTrapPrefix=npGsmTrapPrefix, npIoPulseCounter=npIoPulseCounter, npThermoTrap=npThermoTrap, npIoTraps=npIoTraps, npThermoTrapLow=npThermoTrapLow, npSmokeReset=npSmokeReset, npIoMemo=npIoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npGsmRegistration=npGsmRegistration, npIoTrapMemo=npIoTrapMemo, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npThermoTable=npThermoTable, npRelayMemo=npRelayMemo, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo, npCurLoopTrap=npCurLoopTrap, npSmokeEntry=npSmokeEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTraps=npThermoTraps, npRelayN=npRelayN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npIoTrap=npIoTrap, npRelHumEntry=npRelHumEntry, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, lightcom=lightcom, npResetStack=npResetStack, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValue=npThermoValue, npSoftReboot=npSoftReboot, npCurLoopPower=npCurLoopPower, npIoLevelOut=npIoLevelOut, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npThermo=npThermo, npThermoEntry=npThermoEntry, npGsmStrength=npGsmStrength, npIoLineN=npIoLineN, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTable=npIoTable, npSmoke=npSmoke, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npGsmTrap=npGsmTrap, npRelHumN=npRelHumN, npSmokeMemo=npSmokeMemo, npIo=npIo, npRelHumidity=npRelHumidity, npRelayStartReset=npRelayStartReset)
