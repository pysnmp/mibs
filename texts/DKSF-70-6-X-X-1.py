...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:16:09 2024
...
Gauge32, enterprises, Counter64, iso, NotificationType, ModuleIdentity, Counter32, TimeTicks, Integer32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Counter64", "iso", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks", "Integer32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npForcedReboot=npForcedReboot, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapMemo=npIoTrapMemo, npResetStack=npResetStack, npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npRelay=npRelay, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopR=npCurLoopR, FixedPoint1000=FixedPoint1000, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npGsm=npGsm, npRelHumTrapSafe=npRelHumTrapSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npThermoStatus=npThermoStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempValue=npRelHumTempValue, npGsmTrapPrefix=npGsmTrapPrefix, npIrCtrl=npIrCtrl, npIr=npIr, npIoLevelOut=npIoLevelOut, npIo=npIo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapEmailTo=npTrapEmailTo, npIrPlayCmd=npIrPlayCmd, npRelHumTempStatus=npRelHumTempStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrap=npGsmTrap, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npReboot=npReboot, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeReset=npSmokeReset, npCurLoopTraps=npCurLoopTraps, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npGsmInfo=npGsmInfo, npRelayMode=npRelayMode, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npRelHumTrap=npRelHumTrap, npCurLoopEntry=npCurLoopEntry, npSmokeTrap=npSmokeTrap, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopN=npCurLoopN, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npRelHumN=npRelHumN, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npIrStatus=npIrStatus, npThermoLow=npThermoLow, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npRelHumEntry=npRelHumEntry, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokePower=npSmokePower, npIoMemo=npIoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelayState=npRelayState, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap)
