...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:57:32 2022
...
Integer32, Bits, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Counter64, Unsigned32, ModuleIdentity, NotificationType, iso, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Counter64", "Unsigned32", "ModuleIdentity", "NotificationType", "iso", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npReboot=npReboot, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrap=npThermoTrap, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npIrReset=npIrReset, npSmoke=npSmoke, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumEntry=npRelHumEntry, npIoMemo=npIoMemo, npTrapInfo=npTrapInfo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npResetStack=npResetStack, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrap=npIoTrap, npCurLoopTrapR=npCurLoopTrapR, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npSmokeTraps=npSmokeTraps, npRelayStartReset=npRelayStartReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npIr=npIr, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npRelayN=npRelayN, npRelayState=npRelayState, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npCurLoopTrapV=npCurLoopTrapV, npIoLevelOut=npIoLevelOut, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npRelayMemo=npRelayMemo, npRelHumTable=npRelHumTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed, npRelHumidity=npRelHumidity, npThermoMemo=npThermoMemo, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, lightcom=lightcom, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npThermoValue=npThermoValue, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrap=npRelHumTrap, npIoPulseCounter=npIoPulseCounter, npGsmTraps=npGsmTraps, npCurLoopI=npCurLoopI, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npThermoTraps=npThermoTraps, npForcedReboot=npForcedReboot, npSmokeReset=npSmokeReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npIo=npIo, npCurLoopStatus=npCurLoopStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npThermoEntry=npThermoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrStatus=npIrStatus, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable)
