...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:17:44 2023
...
Counter32, iso, Unsigned32, IpAddress, ObjectIdentity, NotificationType, MibIdentifier, enterprises, Gauge32, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType", "MibIdentifier", "enterprises", "Gauge32", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npThermoSensorN=npThermoSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npCurLoopTraps=npCurLoopTraps, npGsmStrength=npGsmStrength, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIo=npIo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSoftReboot=npSoftReboot, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npIoSinglePulseStart=npIoSinglePulseStart, npForcedReboot=npForcedReboot, npSmokeTable=npSmokeTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeReset=npSmokeReset, npIr=npIr, npThermoHigh=npThermoHigh, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npThermo=npThermo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npCurLoopV=npCurLoopV, npCurLoopR=npCurLoopR, npRelayTable=npRelayTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrap=npSmokeTrap, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npRelayMode=npRelayMode, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npRelHumTrap=npRelHumTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoStatus=npThermoStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataN=npRelHumTrapDataN, npReboot=npReboot, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npIrStatus=npIrStatus, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npRelHumStatus=npRelHumStatus, npRelayStartReset=npRelayStartReset, npRelHumidity=npRelHumidity, npGsm=npGsm, npCurLoopTrap=npCurLoopTrap, npRelHumEntry=npRelHumEntry, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npIoMemo=npIoMemo, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTraps=npGsmTraps, npRelayMemo=npRelayMemo, npThermoEntry=npThermoEntry, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npCurLoopTrapI=npCurLoopTrapI)
