...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:13:29 2022
...
enterprises, Bits, Counter32, ModuleIdentity, iso, Gauge32, NotificationType, IpAddress, Counter64, MibIdentifier, Unsigned32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Counter32", "ModuleIdentity", "iso", "Gauge32", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "Unsigned32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumN=npRelHumN, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npCurLoopTable=npCurLoopTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npIoLineN=npIoLineN, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopN=npCurLoopN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npIo=npIo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npSmokeSensorN=npSmokeSensorN, npThermoEntry=npThermoEntry, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayState=npRelayState, npIrReset=npIrReset, npCurLoopTrapN=npCurLoopTrapN, npRelayMemo=npRelayMemo, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npCurLoop=npCurLoop, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValuePrecise=npThermoValuePrecise, npIoTrapMemo=npIoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapR=npCurLoopTrapR, FixedPoint1000=FixedPoint1000, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTable=npSmokeTable, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumEntry=npRelHumEntry, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, lightcom=lightcom, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrap=npCurLoopTrap, npSmokeReset=npSmokeReset, npRelHumidity=npRelHumidity, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npRelayMode=npRelayMode, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npThermo=npThermo, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmStrength=npGsmStrength, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npThermoTable=npThermoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoHigh=npThermoHigh, npGsm=npGsm, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npForcedReboot=npForcedReboot, npIoLevelIn=npIoLevelIn, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayEntry=npRelayEntry, npGsmInfo=npGsmInfo)
