...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:03:11 2023
...
ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, iso, ModuleIdentity, Counter64, TimeTicks, Integer32, Bits, Unsigned32, enterprises, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "iso", "ModuleIdentity", "Counter64", "TimeTicks", "Integer32", "Bits", "Unsigned32", "enterprises", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npIrReset=npIrReset, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npRelayState=npRelayState, npThermoTrap=npThermoTrap, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npIo=npIo, npForcedReboot=npForcedReboot, npRelayN=npRelayN, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTable=npRelHumTable, npIoEntry=npIoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumMemo=npRelHumMemo, npIr=npIr, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npIoTraps=npIoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npRelayEntry=npRelayEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npCurLoopN=npCurLoopN, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLineN=npIoLineN, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTraps=npGsmTraps, npSmokeEntry=npSmokeEntry, npGsmFailed=npGsmFailed, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValue=npThermoValue, npCurLoopR=npCurLoopR, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npGsmTrap=npGsmTrap, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npSmokeTraps=npSmokeTraps, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npIoTrap=npIoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoop=npCurLoop, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumValue=npRelHumValue, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npIrPlayCmd=npIrPlayCmd, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npRelayMemo=npRelayMemo, npSmoke=npSmoke, npCurLoopTraps=npCurLoopTraps, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, lightcom=lightcom, npThermoHigh=npThermoHigh, npCurLoopTrapPower=npCurLoopTrapPower)
