...
# Produced by pysmi-1.1.12 at Mon Sep 16 14:58:31 2024
...
Bits, Unsigned32, IpAddress, NotificationType, Integer32, Gauge32, iso, Counter64, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "IpAddress", "NotificationType", "Integer32", "Gauge32", "iso", "Counter64", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npGsmStrength=npGsmStrength, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoLow=npThermoLow, npSmoke=npSmoke, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPower=npCurLoopTrapPower, lightcom=lightcom, npRelayN=npRelayN, npRelHumEntry=npRelHumEntry, npRelHumN=npRelHumN, npTrapEmailTo=npTrapEmailTo, npRelayTable=npRelayTable, npGsmRegistration=npGsmRegistration, npRelHumStatus=npRelHumStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopI=npCurLoopI, npRelHumTempValue=npRelHumTempValue, npForcedReboot=npForcedReboot, npIoTable=npIoTable, npIoMemo=npIoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsm=npGsm, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npCurLoopN=npCurLoopN, npThermoHigh=npThermoHigh, npThermoTrapHigh=npThermoTrapHigh, npResetStack=npResetStack, npRelayState=npRelayState, npRelayMode=npRelayMode, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npIr=npIr, npSmokeTrapMemo=npSmokeTrapMemo, npReboot=npReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npIoLevelOut=npIoLevelOut, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npCurLoopTrap=npCurLoopTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoop=npCurLoop, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumidity=npRelHumidity, npCurLoopV=npCurLoopV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npSmokePower=npSmokePower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npCurLoopPower=npCurLoopPower, npThermoTrapStatus=npThermoTrapStatus, npThermoStatus=npThermoStatus, npIo=npIo, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npRelayEntry=npRelayEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npGsmFailed=npGsmFailed, npCurLoopTable=npCurLoopTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayStartReset=npRelayStartReset, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapLow=npThermoTrapLow, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl)
