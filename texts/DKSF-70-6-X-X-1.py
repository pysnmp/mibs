...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:53:11 2021
...
NotificationType, ModuleIdentity, Integer32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, enterprises, TimeTicks, Gauge32, Bits, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "enterprises", "TimeTicks", "Gauge32", "Bits", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeEntry=npSmokeEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoHigh=npThermoHigh, npIrCtrl=npIrCtrl, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTraps=npGsmTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npGsmTrapPrefix=npGsmTrapPrefix, npGsmStrength=npGsmStrength, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npIoLineN=npIoLineN, npCurLoopTrapR=npCurLoopTrapR, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npSmokeSensorN=npSmokeSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIr=npIr, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumStatus=npRelHumStatus, npRelHumN=npRelHumN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npTrapInfo=npTrapInfo, npRelayState=npRelayState, npCurLoop=npCurLoop, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrap=npThermoTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npReboot=npReboot, npThermoTrapValue=npThermoTrapValue, npIoTrapLineN=npIoTrapLineN, FixedPoint1000=FixedPoint1000, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokePower=npSmokePower, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npCurLoopPower=npCurLoopPower, npSoftReboot=npSoftReboot, npCurLoopN=npCurLoopN, npCurLoopEntry=npCurLoopEntry, npSmokeTraps=npSmokeTraps, npThermoEntry=npThermoEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrap=npIoTrap, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npRelHumTable=npRelHumTable, npIoEntry=npIoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumValue=npRelHumValue, npIrReset=npIrReset, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumEntry=npRelHumEntry, npRelayMode=npRelayMode, npSmoke=npSmoke, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopI=npCurLoopI, npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npGsmInfo=npGsmInfo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTable=npThermoTable, npCurLoopR=npCurLoopR, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npIoLevelIn=npIoLevelIn, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npIo=npIo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npTrapEmailTo=npTrapEmailTo, npThermoLow=npThermoLow, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoMemo=npThermoMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataValue=npRelHumTrapDataValue)
