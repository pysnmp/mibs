...
# Produced by pysmi-1.1.12 at Thu Apr  4 03:00:32 2024
...
Counter64, enterprises, NotificationType, ModuleIdentity, MibIdentifier, iso, Counter32, Gauge32, Bits, ObjectIdentity, IpAddress, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso", "Counter32", "Gauge32", "Bits", "ObjectIdentity", "IpAddress", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSoftReboot=npSoftReboot, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npTrapInfo=npTrapInfo, npCurLoopPower=npCurLoopPower, npSmoke=npSmoke, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopEntry=npCurLoopEntry, npSmokeEntry=npSmokeEntry, lightcom=lightcom, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npCurLoopTable=npCurLoopTable, FixedPoint1000=FixedPoint1000, npCurLoopTrapN=npCurLoopTrapN, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapValue=npThermoTrapValue, npRelHumTrap=npRelHumTrap, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, npIoTraps=npIoTraps, npRelHumTempValue=npRelHumTempValue, npIoLevelOut=npIoLevelOut, npReboot=npReboot, npThermoMemo=npThermoMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npThermoTrap=npThermoTrap, npRelHumN=npRelHumN, npRelayTable=npRelayTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npRelayState=npRelayState, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npGsmTrap=npGsmTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npIoTrap=npIoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelay=npRelay, npCurLoopN=npCurLoopN, npThermoTrapPrefix=npThermoTrapPrefix, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npThermoLow=npThermoLow, npThermo=npThermo, npRelayMemo=npRelayMemo, npRelHumStatus=npRelHumStatus, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npIr=npIr, npGsmRegistration=npGsmRegistration, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelIn=npIoLevelIn, npGsm=npGsm, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrReset=npIrReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTable=npThermoTable, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopI=npCurLoopI, npSmokePower=npSmokePower, npSmokeTrapSensorN=npSmokeTrapSensorN, npIo=npIo)
