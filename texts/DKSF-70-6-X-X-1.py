...
# Produced by pysmi-1.1.10 at Wed Nov 15 02:40:46 2023
...
ModuleIdentity, NotificationType, Counter64, ObjectIdentity, IpAddress, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, enterprises, MibIdentifier, iso, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "enterprises", "MibIdentifier", "iso", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumidity=npRelHumidity, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npIoTraps=npIoTraps, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrap=npRelHumTrap, npIoTrap=npIoTrap, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npRelHumN=npRelHumN, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapEmailTo=npTrapEmailTo, lightcom=lightcom, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoEntry=npThermoEntry, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npGsm=npGsm, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataN=npRelHumTrapDataN, npResetStack=npResetStack, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSoftReboot=npSoftReboot, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npRelayTable=npRelayTable, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npRelHumEntry=npRelHumEntry, npIoMemo=npIoMemo, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npReboot=npReboot, npGsmRegistration=npGsmRegistration, npSmoke=npSmoke, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npIo=npIo, npForcedReboot=npForcedReboot, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeReset=npSmokeReset, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npRelay=npRelay, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npIoEntry=npIoEntry, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue)
