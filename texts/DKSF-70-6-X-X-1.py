...
enterprises, Counter64, iso, Gauge32, Counter32, ModuleIdentity, ObjectIdentity, Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "iso", "Gauge32", "Counter32", "ModuleIdentity", "ObjectIdentity", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmoke=npSmoke, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLineN=npIoTrapLineN, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npSmokeTraps=npSmokeTraps, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTraps=npThermoTraps, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npReboot=npReboot, npRelayN=npRelayN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npRelayState=npRelayState, npSmokeTrap=npSmokeTrap, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapI=npCurLoopTrapI, npCurLoopR=npCurLoopR, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npIrCtrl=npIrCtrl, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopI=npCurLoopI, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumMemo=npRelHumMemo, npCurLoopV=npCurLoopV, npRelay=npRelay, npCurLoop=npCurLoop, npThermo=npThermo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npRelayTable=npRelayTable, npIoTrap=npIoTrap, npIoLineN=npIoLineN, npThermoTrapMemo=npThermoTrapMemo, npThermoTrap=npThermoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npCurLoopPower=npCurLoopPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapData=npRelHumTrapData, npRelHumN=npRelHumN, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapInfo=npTrapInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrap=npCurLoopTrap, npIo=npIo, npIoLevelOut=npIoLevelOut, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, FixedPoint1000=FixedPoint1000, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npIr=npIr, npGsmTraps=npGsmTraps, npResetStack=npResetStack, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npIoTrapMemo=npIoTrapMemo)
