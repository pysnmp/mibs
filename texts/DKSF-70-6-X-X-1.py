...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:00:27 2023
...
Counter32, Unsigned32, ModuleIdentity, IpAddress, Integer32, TimeTicks, iso, NotificationType, ObjectIdentity, Counter64, MibIdentifier, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "ModuleIdentity", "IpAddress", "Integer32", "TimeTicks", "iso", "NotificationType", "ObjectIdentity", "Counter64", "MibIdentifier", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npGsm=npGsm, npGsmFailed=npGsmFailed, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelIn=npIoLevelIn, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIrCtrl=npIrCtrl, npThermoStatus=npThermoStatus, npRelHumStatus=npRelHumStatus, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npReboot=npReboot, npSoftReboot=npSoftReboot, npIo=npIo, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, npRelayN=npRelayN, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelOut=npIoLevelOut, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrap=npIoTrap, npRelHumTable=npRelHumTable, npIoEntry=npIoEntry, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopPower=npCurLoopPower, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npSmokeTable=npSmokeTable, npRelHumValue=npRelHumValue, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIr=npIr, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npCurLoopR=npCurLoopR, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npIrPlayCmd=npIrPlayCmd, npGsmInfo=npGsmInfo, npRelayState=npRelayState, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokePower=npSmokePower, npCurLoopI=npCurLoopI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapR=npCurLoopTrapR, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npThermoValue=npThermoValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTraps=npThermoTraps, npSmokeStatus=npSmokeStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapStatus=npThermoTrapStatus, npTrapInfo=npTrapInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npIrStatus=npIrStatus, npThermoEntry=npThermoEntry, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelay=npRelay, npCurLoop=npCurLoop, npThermo=npThermo, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTable=npThermoTable, npThermoTrapMemo=npThermoTrapMemo, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapLow=npThermoTrapLow, npCurLoopN=npCurLoopN, npIoTrapMemo=npIoTrapMemo, npRelHumN=npRelHumN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTraps=npIoTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npResetStack=npResetStack, npSmokeTrapPrefix=npSmokeTrapPrefix)
