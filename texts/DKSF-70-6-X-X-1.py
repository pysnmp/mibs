...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:11:04 2023
...
Integer32, Counter32, Counter64, ModuleIdentity, Bits, TimeTicks, IpAddress, enterprises, iso, NotificationType, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "ModuleIdentity", "Bits", "TimeTicks", "IpAddress", "enterprises", "iso", "NotificationType", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npGsm=npGsm, npGsmTraps=npGsmTraps, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTable=npCurLoopTable, npIrCtrl=npIrCtrl, npSmokeTrapStatus=npSmokeTrapStatus, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoStatus=npThermoStatus, npThermoHigh=npThermoHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npRelayStartReset=npRelayStartReset, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, lightcom=lightcom, npRelHumidity=npRelHumidity, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npRelHumTempValue=npRelHumTempValue, npTrapEmailTo=npTrapEmailTo, npCurLoopI=npCurLoopI, npRelayState=npRelayState, npRelayTable=npRelayTable, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npReboot=npReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoSensorN=npThermoSensorN, npSmokeTrap=npSmokeTrap, npThermoMemo=npThermoMemo, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npSmokeTable=npSmokeTable, npCurLoopStatus=npCurLoopStatus, npThermo=npThermo, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelay=npRelay, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTable=npThermoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npRelHumMemo=npRelHumMemo, npSmokeTraps=npSmokeTraps, npThermoTrap=npThermoTrap, npGsmRegistration=npGsmRegistration, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry)
