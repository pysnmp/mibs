...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:00:58 2024
...
iso, IpAddress, NotificationType, enterprises, TimeTicks, ObjectIdentity, Gauge32, Unsigned32, Integer32, Counter64, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "enterprises", "TimeTicks", "ObjectIdentity", "Gauge32", "Unsigned32", "Integer32", "Counter64", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumidity=npRelHumidity, npSmokeEntry=npSmokeEntry, npSmoke=npSmoke, npIoTrapLevelIn=npIoTrapLevelIn, npIoPulseCounter=npIoPulseCounter, npSmokeMemo=npSmokeMemo, npRelayMode=npRelayMode, npSmokePower=npSmokePower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npIoEntry=npIoEntry, npCurLoopTrap=npCurLoopTrap, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTrap=npRelHumTrap, npSmokeReset=npSmokeReset, npRelayStartReset=npRelayStartReset, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npIrReset=npIrReset, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npSmokeSensorN=npSmokeSensorN, npSmokeTable=npSmokeTable, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, npSmokeTrapMemo=npSmokeTrapMemo, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npRelHumTrapFail=npRelHumTrapFail, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, lightcom=lightcom, npCurLoopR=npCurLoopR, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npRelayEntry=npRelayEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelay=npRelay, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapValue=npThermoTrapValue, npGsmTraps=npGsmTraps, npCurLoopTable=npCurLoopTable, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap, npSoftReboot=npSoftReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npIoTrapMemo=npIoTrapMemo, npReboot=npReboot, npThermoValue=npThermoValue, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npIoLevelOut=npIoLevelOut, npThermoEntry=npThermoEntry, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npIoLevelIn=npIoLevelIn, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npIrStatus=npIrStatus)
