...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:11:47 2022
...
Integer32, TimeTicks, NotificationType, enterprises, Unsigned32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, ObjectIdentity, Counter64, MibIdentifier, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "NotificationType", "enterprises", "Unsigned32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibIdentifier", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopV=npCurLoopV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempValue=npRelHumTempValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npIoTable=npIoTable, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npRelayState=npRelayState, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npSmokeReset=npSmokeReset, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelOut=npIoLevelOut, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTable=npThermoTable, npGsm=npGsm, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, lightcom=lightcom, npGsmTraps=npGsmTraps, npIoMemo=npIoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeStatus=npSmokeStatus, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIr=npIr, npIrReset=npIrReset, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelayEntry=npRelayEntry, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npRelayN=npRelayN, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIo=npIo, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npSmokeTable=npSmokeTable, npSmoke=npSmoke, npIoLineN=npIoLineN, npResetStack=npResetStack, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npGsmInfo=npGsmInfo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npReboot=npReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeEntry=npSmokeEntry, npRelHumTable=npRelHumTable, npRelayMode=npRelayMode, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npGsmTrap=npGsmTrap, npTrapInfo=npTrapInfo, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npGsmRegistration=npGsmRegistration, npSmokeTraps=npSmokeTraps, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npTrapEmailTo=npTrapEmailTo, npSoftReboot=npSoftReboot, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayStartReset=npRelayStartReset, npCurLoopTrap=npCurLoopTrap, npSmokeSensorN=npSmokeSensorN, npIoPulseCounter=npIoPulseCounter, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, npRelHumidity=npRelHumidity, npCurLoopTrapN=npCurLoopTrapN)
