...
Counter64, TimeTicks, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, Integer32, ModuleIdentity, enterprises, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "Integer32", "ModuleIdentity", "enterprises", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTraps=npIoTraps, npSmokePower=npSmokePower, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayStartReset=npRelayStartReset, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npIo=npIo, npIrCtrl=npIrCtrl, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npThermoEntry=npThermoEntry, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopPower=npCurLoopPower, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoop=npCurLoop, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npRelayMemo=npRelayMemo, lightcom=lightcom, npThermoLow=npThermoLow, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npIoTrapPrefix=npIoTrapPrefix, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npCurLoopV=npCurLoopV, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npCurLoopTrap=npCurLoopTrap, npGsmTrapPrefix=npGsmTrapPrefix, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapR=npCurLoopTrapR, npIrStatus=npIrStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npRelHumEntry=npRelHumEntry, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npRelHumTempStatus=npRelHumTempStatus, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npSoftReboot=npSoftReboot, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npRelHumTrap=npRelHumTrap, npThermoTable=npThermoTable, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npRelHumValue=npRelHumValue, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, FixedPoint1000=FixedPoint1000)
