...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:02:03 2024
...
TimeTicks, Counter32, NotificationType, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, Gauge32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "Gauge32", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeMemo=npSmokeMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, lightcom=lightcom, npIoMemo=npIoMemo, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, npCurLoopTable=npCurLoopTable, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npSmokePower=npSmokePower, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npThermoHigh=npThermoHigh, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npIoSinglePulseStart=npIoSinglePulseStart, npIoLineN=npIoLineN, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npCurLoopStatus=npCurLoopStatus, npIoTrapLineN=npIoTrapLineN, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npSmokeStatus=npSmokeStatus, npRelHumTable=npRelHumTable, npGsm=npGsm, npIrReset=npIrReset, npSoftReboot=npSoftReboot, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayState=npRelayState, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoSensorN=npThermoSensorN, npIo=npIo, npSmokeSensorN=npSmokeSensorN, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npRelHumTrapData=npRelHumTrapData, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npIr=npIr, npThermoLow=npThermoLow, npRelHumValue=npRelHumValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npCurLoopTrap=npCurLoopTrap, npRelayMemo=npRelayMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopV=npCurLoopV, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTraps=npThermoTraps, npThermoTrapHigh=npThermoTrapHigh, npRelHumEntry=npRelHumEntry, npThermoEntry=npThermoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npGsmInfo=npGsmInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopR=npCurLoopR, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
