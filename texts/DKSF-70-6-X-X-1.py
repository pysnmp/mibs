...
ObjectIdentity, Unsigned32, enterprises, IpAddress, iso, MibIdentifier, Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Counter32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "enterprises", "IpAddress", "iso", "MibIdentifier", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npIr=npIr, npRelayMode=npRelayMode, npCurLoopPower=npCurLoopPower, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npCurLoopTrapN=npCurLoopTrapN, npTrapInfo=npTrapInfo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npRelayState=npRelayState, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npGsm=npGsm, npRelayEntry=npRelayEntry, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npSmokePower=npSmokePower, npThermoTrapStatus=npThermoTrapStatus, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npSmokeSensorN=npSmokeSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapEmailTo=npTrapEmailTo, npThermoTrapValue=npThermoTrapValue, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npSmoke=npSmoke, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelIn=npIoLevelIn, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npReboot=npReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npIrCtrl=npIrCtrl, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npResetStack=npResetStack, npRelayN=npRelayN, npThermoLow=npThermoLow, npCurLoopTable=npCurLoopTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempStatus=npRelHumTempStatus, npThermoSensorN=npThermoSensorN, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapStatus=npSmokeTrapStatus, npIoPulseCounter=npIoPulseCounter, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumEntry=npRelHumEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npThermoTrapSensorN=npThermoTrapSensorN, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npIoTraps=npIoTraps, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npThermoTraps=npThermoTraps, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, lightcom=lightcom, npRelHumTrap=npRelHumTrap, npGsmTraps=npGsmTraps)
