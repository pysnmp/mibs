...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:53:46 2022
...
Counter32, Gauge32, MibIdentifier, NotificationType, ObjectIdentity, Counter64, enterprises, ModuleIdentity, Unsigned32, Bits, Integer32, TimeTicks, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "enterprises", "ModuleIdentity", "Unsigned32", "Bits", "Integer32", "TimeTicks", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTraps=npThermoTraps, npRelHumTempValue=npRelHumTempValue, npCurLoop=npCurLoop, npCurLoopTable=npCurLoopTable, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npReboot=npReboot, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npIoTrapMemo=npIoTrapMemo, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapLow=npThermoTrapLow, lightcom=lightcom, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTable=npThermoTable, npSmokePower=npSmokePower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npIoEntry=npIoEntry, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTraps=npCurLoopTraps, npSoftReboot=npSoftReboot, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelayMemo=npRelayMemo, npThermo=npThermo, npThermoLow=npThermoLow, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmoke=npSmoke, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npRelay=npRelay, npRelHumTrapData=npRelHumTrapData, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npRelayEntry=npRelayEntry, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npSmokeTrapMemo=npSmokeTrapMemo, npIo=npIo, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npGsmRegistration=npGsmRegistration, npSmokeSensorN=npSmokeSensorN, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npThermoTrap=npThermoTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopR=npCurLoopR, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npSmokeTable=npSmokeTable, npCurLoopStatus=npCurLoopStatus, npRelayTable=npRelayTable, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npRelayStartReset=npRelayStartReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTraps=npIoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npSmokeEntry=npSmokeEntry, npRelHumMemo=npRelHumMemo)
