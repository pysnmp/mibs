...
# Produced by pysmi-1.1.10 at Mon Feb 12 02:25:43 2024
...
Integer32, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits, enterprises, Unsigned32, NotificationType, ObjectIdentity, Gauge32, iso, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits", "enterprises", "Unsigned32", "NotificationType", "ObjectIdentity", "Gauge32", "iso", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, npRelHumMemo=npRelHumMemo, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npGsmRegistration=npGsmRegistration, npThermoTrapLow=npThermoTrapLow, npRelayN=npRelayN, npRelHumTrapTempFail=npRelHumTrapTempFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npTrapEmailTo=npTrapEmailTo, npIoTable=npIoTable, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps, lightcom=lightcom, npThermoMemo=npThermoMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npRelayState=npRelayState, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npRelHumidity=npRelHumidity, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoop=npCurLoop, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npIoTraps=npIoTraps, npRelayEntry=npRelayEntry, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeMemo=npSmokeMemo, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npGsmTraps=npGsmTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npReboot=npReboot, npGsmFailed=npGsmFailed, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmStrength=npGsmStrength, npIr=npIr, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npRelayMode=npRelayMode, npRelHumValue=npRelHumValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokePower=npSmokePower, npThermoSensorN=npThermoSensorN, npRelHumTempValue=npRelHumTempValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npGsmInfo=npGsmInfo, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npRelayTable=npRelayTable, npResetStack=npResetStack, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrCtrl=npIrCtrl, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npSmokeTrap=npSmokeTrap, npThermoTrapValue=npThermoTrapValue, npForcedReboot=npForcedReboot, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapMemo=npIoTrapMemo, npIoLevelIn=npIoLevelIn, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow)
