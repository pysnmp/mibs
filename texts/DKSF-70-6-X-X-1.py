...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:30:58 2022
...
Gauge32, enterprises, ModuleIdentity, Integer32, iso, Counter32, TimeTicks, NotificationType, Counter64, IpAddress, MibIdentifier, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ModuleIdentity", "Integer32", "iso", "Counter32", "TimeTicks", "NotificationType", "Counter64", "IpAddress", "MibIdentifier", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, npIoTable=npIoTable, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npSmoke=npSmoke, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npReboot=npReboot, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npCurLoop=npCurLoop, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npSoftReboot=npSoftReboot, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npGsm=npGsm, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npIoLevelOut=npIoLevelOut, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npThermoTrapStatus=npThermoTrapStatus, npSmokeMemo=npSmokeMemo, npCurLoopI=npCurLoopI, npCurLoopStatus=npCurLoopStatus, npThermoMemo=npThermoMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTable=npRelHumTable, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npIr=npIr, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npIrCtrl=npIrCtrl, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npRelayN=npRelayN, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIo=npIo, npIrPlayCmd=npIrPlayCmd, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npThermoValue=npThermoValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, npThermoTraps=npThermoTraps, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus)
