...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:23:01 2024
...
Integer32, Bits, ObjectIdentity, Gauge32, IpAddress, NotificationType, TimeTicks, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ObjectIdentity", "Gauge32", "IpAddress", "NotificationType", "TimeTicks", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumEntry=npRelHumEntry, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npGsmRegistration=npGsmRegistration, FixedPoint1000=FixedPoint1000, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npIoTraps=npIoTraps, npSmoke=npSmoke, npThermoTrapValue=npThermoTrapValue, npGsm=npGsm, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npRelayStartReset=npRelayStartReset, npSmokePower=npSmokePower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrap=npIoTrap, npForcedReboot=npForcedReboot, npRelayN=npRelayN, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermo=npThermo, npGsmInfo=npGsmInfo, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTemp=npRelHumTrapTemp, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npGsmTraps=npGsmTraps, npIrStatus=npIrStatus, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrap=npGsmTrap, npIo=npIo, npIoLevelOut=npIoLevelOut, npThermoLow=npThermoLow, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npCurLoopI=npCurLoopI, npIr=npIr, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, lightcom=lightcom, npTrapInfo=npTrapInfo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npRelHumTempStatus=npRelHumTempStatus, npSoftReboot=npSoftReboot, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTable=npSmokeTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopEntry=npCurLoopEntry, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTraps=npCurLoopTraps, npIrCtrl=npIrCtrl, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npRelHumTrapData=npRelHumTrapData, npRelayTable=npRelayTable, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLineN=npIoTrapLineN, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopN=npCurLoopN, npResetStack=npResetStack)
