...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:10:22 2023
...
TimeTicks, Bits, Unsigned32, IpAddress, enterprises, Counter64, iso, NotificationType, Counter32, Integer32, Gauge32, ModuleIdentity, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "enterprises", "Counter64", "iso", "NotificationType", "Counter32", "Integer32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapFail=npRelHumTrapFail, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, FixedPoint1000=FixedPoint1000, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npGsm=npGsm, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValuePrecise=npThermoValuePrecise, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npThermoTrapStatus=npThermoTrapStatus, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npSmokeReset=npSmokeReset, npSoftReboot=npSoftReboot, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npIoTrapLevelLegend=npIoTrapLevelLegend, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npTrapEmailTo=npTrapEmailTo, npGsmRegistration=npGsmRegistration, npGsmStrength=npGsmStrength, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npThermoTable=npThermoTable, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrap=npCurLoopTrap, npThermoMemo=npThermoMemo, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npRelHumTrapData=npRelHumTrapData, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npRelayStartReset=npRelayStartReset, npIo=npIo, npRelayN=npRelayN, npRelHumTrap=npRelHumTrap, npRelHumMemo=npRelHumMemo, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoPulseCounter=npIoPulseCounter, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrPlayCmd=npIrPlayCmd, lightcom=lightcom, npIrReset=npIrReset, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, npThermoTraps=npThermoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapLow=npThermoTrapLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npIoTrap=npIoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoLow=npThermoLow, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npGsmFailed=npGsmFailed, npThermo=npThermo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npRelHumTempStatus=npRelHumTempStatus, npSmokeTable=npSmokeTable)
