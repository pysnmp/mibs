...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, enterprises, Bits, ModuleIdentity, Counter32, Unsigned32, Integer32, Gauge32, iso, IpAddress, NotificationType, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "enterprises", "Bits", "ModuleIdentity", "Counter32", "Unsigned32", "Integer32", "Gauge32", "iso", "IpAddress", "NotificationType", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumMemo=npRelHumMemo, npRelayEntry=npRelayEntry, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npGsm=npGsm, npIrCtrl=npIrCtrl, npRelHumStatus=npRelHumStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoHigh=npThermoHigh, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npReboot=npReboot, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npIoSinglePulseStart=npIoSinglePulseStart, npIoTable=npIoTable, npGsmTraps=npGsmTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeMemo=npSmokeMemo, npThermoTable=npThermoTable, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumValue=npRelHumValue, npThermoTrapHigh=npThermoTrapHigh, npRelayState=npRelayState, npSmokeReset=npSmokeReset, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTable=npRelHumTable, npThermoStatus=npThermoStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrap=npThermoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrap=npIoTrap, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayStartReset=npRelayStartReset, npIoMemo=npIoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npCurLoopTrapN=npCurLoopTrapN, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTable=npSmokeTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npForcedReboot=npForcedReboot, npRelHumEntry=npRelHumEntry, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npIo=npIo, npGsmStrength=npGsmStrength, npThermoLow=npThermoLow, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npTrapInfo=npTrapInfo, npCurLoop=npCurLoop, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npRelHumTrap=npRelHumTrap, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayTable=npRelayTable, npCurLoopTrapV=npCurLoopTrapV, npCurLoopN=npCurLoopN, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn)
