...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:38:50 2023
...
Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Integer32, iso, ModuleIdentity, Counter32, NotificationType, Unsigned32, IpAddress, TimeTicks, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Integer32", "iso", "ModuleIdentity", "Counter32", "NotificationType", "Unsigned32", "IpAddress", "TimeTicks", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npCurLoop=npCurLoop, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npRelayEntry=npRelayEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npCurLoopPower=npCurLoopPower, npResetStack=npResetStack, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npSmokeTraps=npSmokeTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTempStatus=npRelHumTempStatus, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrap=npSmokeTrap, npSmokeEntry=npSmokeEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npRelHumTable=npRelHumTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, lightcom=lightcom, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopI=npCurLoopI, npGsmFailed=npGsmFailed, npCurLoopTrapR=npCurLoopTrapR, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npCurLoopEntry=npCurLoopEntry, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTable=npThermoTable, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTable=npCurLoopTable, npIo=npIo, npGsm=npGsm, npThermoHigh=npThermoHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, npIoEntry=npIoEntry, npIr=npIr, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npRelayMemo=npRelayMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeStatus=npSmokeStatus, npRelayState=npRelayState, npGsmTraps=npGsmTraps, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapLow=npThermoTrapLow, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmInfo=npGsmInfo)
