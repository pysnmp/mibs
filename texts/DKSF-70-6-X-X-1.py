...
iso, ObjectIdentity, Unsigned32, Integer32, Bits, Counter64, IpAddress, enterprises, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Unsigned32", "Integer32", "Bits", "Counter64", "IpAddress", "enterprises", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npIoTrap=npIoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoMemo=npThermoMemo, npIoTrapMemo=npIoTrapMemo, npSmokeTraps=npSmokeTraps, npIoLevelOut=npIoLevelOut, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npSmokeStatus=npSmokeStatus, npGsmFailed=npGsmFailed, npIoLevelIn=npIoLevelIn, npRelHumEntry=npRelHumEntry, npIrStatus=npIrStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npIoEntry=npIoEntry, npRelHumStatus=npRelHumStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayState=npRelayState, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npThermoTraps=npThermoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrap=npSmokeTrap, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npIoTable=npIoTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npResetStack=npResetStack, npForcedReboot=npForcedReboot, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npSoftReboot=npSoftReboot, npThermo=npThermo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npIr=npIr, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npCurLoopPower=npCurLoopPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npSmokeSensorN=npSmokeSensorN, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npCurLoopN=npCurLoopN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeEntry=npSmokeEntry, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npCurLoopI=npCurLoopI, npCurLoopTable=npCurLoopTable, npIrReset=npIrReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValue=npThermoValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npThermoHigh=npThermoHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumMemo=npRelHumMemo, npIoMemo=npIoMemo, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npReboot=npReboot, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npIo=npIo, npGsmTraps=npGsmTraps, npThermoTrap=npThermoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayEntry=npRelayEntry, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR)
