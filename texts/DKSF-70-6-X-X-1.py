...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:29:54 2023
...
NotificationType, iso, MibIdentifier, Unsigned32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter64, enterprises, IpAddress, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibIdentifier", "Unsigned32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter64", "enterprises", "IpAddress", "ModuleIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoEntry=npIoEntry, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapMemo=npSmokeTrapMemo, npIrCtrl=npIrCtrl, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npResetStack=npResetStack, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npSmokePower=npSmokePower, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npIo=npIo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npTrapInfo=npTrapInfo, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npIr=npIr, npIoLevelIn=npIoLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelayMode=npRelayMode, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npSmokeMemo=npSmokeMemo, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npCurLoopR=npCurLoopR, npGsmTraps=npGsmTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npReboot=npReboot, npRelHumTrap=npRelHumTrap, npSmokeTraps=npSmokeTraps, npThermoStatus=npThermoStatus, npThermo=npThermo, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npCurLoopPower=npCurLoopPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoMemo=npIoMemo, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npRelayN=npRelayN, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npGsm=npGsm, npThermoHigh=npThermoHigh, lightcom=lightcom, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npIoTrap=npIoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable)
