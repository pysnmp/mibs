...
# Produced by pysmi-1.1.12 at Wed Oct  9 02:22:49 2024
...
Counter32, Integer32, ModuleIdentity, Bits, ObjectIdentity, Counter64, TimeTicks, NotificationType, Unsigned32, enterprises, Gauge32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "Bits", "ObjectIdentity", "Counter64", "TimeTicks", "NotificationType", "Unsigned32", "enterprises", "Gauge32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapInfo=npTrapInfo, npRelay=npRelay, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npSmokeEntry=npSmokeEntry, npIoTrap=npIoTrap, npGsm=npGsm, npSoftReboot=npSoftReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoMemo=npThermoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayState=npRelayState, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npForcedReboot=npForcedReboot, npIrReset=npIrReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeSensorN=npSmokeSensorN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npThermoValuePrecise=npThermoValuePrecise, npThermoStatus=npThermoStatus, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmoke=npSmoke, npRelHumTrap=npRelHumTrap, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTraps=npThermoTraps, npIrStatus=npIrStatus, npThermo=npThermo, npIo=npIo, npGsmTrap=npGsmTrap, npIoTable=npIoTable, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, npIr=npIr, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npIoPulseCounter=npIoPulseCounter, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npIrCtrl=npIrCtrl, npThermoSensorN=npThermoSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrap=npThermoTrap, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumStatus=npRelHumStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, npCurLoopPower=npCurLoopPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopN=npCurLoopN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npSmokeReset=npSmokeReset, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npCurLoopEntry=npCurLoopEntry, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npRelHumTrapDataN=npRelHumTrapDataN, npIoEntry=npIoEntry, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, npRelayMemo=npRelayMemo, npCurLoopV=npCurLoopV, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable)
