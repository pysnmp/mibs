...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:03:09 2023
...
Counter32, Unsigned32, MibIdentifier, IpAddress, Bits, Gauge32, Integer32, NotificationType, enterprises, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "Integer32", "NotificationType", "enterprises", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npIrCtrl=npIrCtrl, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrap=npRelHumTrap, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npRelHumMemo=npRelHumMemo, npSmokeEntry=npSmokeEntry, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrStatus=npIrStatus, npThermoSensorN=npThermoSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npIoTable=npIoTable, npSmokeReset=npSmokeReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrap=npThermoTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapValue=npThermoTrapValue, npThermo=npThermo, npTrapInfo=npTrapInfo, npRelayN=npRelayN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npReboot=npReboot, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npGsmFailed=npGsmFailed, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npIo=npIo, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTraps=npGsmTraps, npCurLoopEntry=npCurLoopEntry, npIr=npIr, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npForcedReboot=npForcedReboot, npGsmTrap=npGsmTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npCurLoopN=npCurLoopN, npIoTrapPrefix=npIoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumTrapFail=npRelHumTrapFail, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npThermoMemo=npThermoMemo, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npSmoke=npSmoke, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npRelHumidity=npRelHumidity, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTraps=npSmokeTraps, npThermoStatus=npThermoStatus, npCurLoopI=npCurLoopI, npRelHumN=npRelHumN, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumEntry=npRelHumEntry)
