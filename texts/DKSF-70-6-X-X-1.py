...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:43:03 2023
...
Counter64, Integer32, Bits, ObjectIdentity, ModuleIdentity, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, MibIdentifier, TimeTicks, NotificationType, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Bits", "ObjectIdentity", "ModuleIdentity", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "MibIdentifier", "TimeTicks", "NotificationType", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, npSmokeEntry=npSmokeEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npIoEntry=npIoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelIn=npIoLevelIn, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLineN=npIoLineN, npIoTrapPrefix=npIoTrapPrefix, npRelHumN=npRelHumN, npThermoStatus=npThermoStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npGsm=npGsm, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeMemo=npSmokeMemo, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npIoLevelOut=npIoLevelOut, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrap=npSmokeTrap, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npCurLoopTrapR=npCurLoopTrapR, npResetStack=npResetStack, npRelay=npRelay, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npThermoValuePrecise=npThermoValuePrecise, lightcom=lightcom, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmInfo=npGsmInfo, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTable=npIoTable, npRelHumTempValue=npRelHumTempValue, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumValue=npRelHumValue, npReboot=npReboot, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTraps=npIoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayEntry=npRelayEntry, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIr=npIr, npIrStatus=npIrStatus, npGsmTrap=npGsmTrap, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrapPrefix=npGsmTrapPrefix, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npThermoTable=npThermoTable, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokeReset=npSmokeReset, npGsmFailed=npGsmFailed, npThermo=npThermo, npRelayStartReset=npRelayStartReset, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTraps=npThermoTraps)
