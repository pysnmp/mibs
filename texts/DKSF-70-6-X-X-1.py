...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:36:15 2022
...
NotificationType, enterprises, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Counter64, Integer32, Bits, ObjectIdentity, Gauge32, ModuleIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Counter64", "Integer32", "Bits", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermo=npThermo, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, npRelHumStatus=npRelHumStatus, npGsmTraps=npGsmTraps, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npThermoTrapLow=npThermoTrapLow, npIoTraps=npIoTraps, npSoftReboot=npSoftReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumValue=npRelHumValue, npIrPlayCmd=npIrPlayCmd, npGsmStrength=npGsmStrength, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapMemo=npIoTrapMemo, npIo=npIo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopV=npCurLoopV, npIrStatus=npIrStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrap=npSmokeTrap, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npSmokeReset=npSmokeReset, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, npIrReset=npIrReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npGsmInfo=npGsmInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapInfo=npTrapInfo, npRelayState=npRelayState, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTable=npCurLoopTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoMemo=npIoMemo, npRelHumMemo=npRelHumMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npGsmRegistration=npGsmRegistration, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeMemo=npSmokeMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npThermoTrapStatus=npThermoTrapStatus, npReboot=npReboot, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npRelayMode=npRelayMode, npThermoValuePrecise=npThermoValuePrecise, npIrCtrl=npIrCtrl, npIr=npIr, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npSmokeStatus=npSmokeStatus, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npRelayTable=npRelayTable, npSmoke=npSmoke)
