...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:26:34 2024
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, IpAddress, Counter64, ModuleIdentity, enterprises, Bits, TimeTicks, NotificationType, Gauge32, Counter32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "enterprises", "Bits", "TimeTicks", "NotificationType", "Gauge32", "Counter32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrReset=npIrReset, npIrStatus=npIrStatus, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npThermoTrapHigh=npThermoTrapHigh, npIoTrapPrefix=npIoTrapPrefix, npGsm=npGsm, npThermoHigh=npThermoHigh, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapMemo=npIoTrapMemo, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npIr=npIr, npIoTraps=npIoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayEntry=npRelayEntry, npThermoSensorN=npThermoSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npIoSinglePulseStart=npIoSinglePulseStart, npIoMemo=npIoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmFailed=npGsmFailed, npCurLoopTrap=npCurLoopTrap, npGsmInfo=npGsmInfo, npIoLevelOut=npIoLevelOut, npThermoMemo=npThermoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmRegistration=npGsmRegistration, npIoTrapLevelIn=npIoTrapLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npRelayMode=npRelayMode, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTable=npThermoTable, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npCurLoopTrapV=npCurLoopTrapV, npRelHumN=npRelHumN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npThermoEntry=npThermoEntry, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npThermo=npThermo, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npRelayMemo=npRelayMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npIoLevelIn=npIoLevelIn, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopI=npCurLoopI, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokePower=npSmokePower, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npIoTrapLineN=npIoTrapLineN, npIo=npIo, npSmokeTraps=npSmokeTraps, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npSmoke=npSmoke, npIoEntry=npIoEntry, npRelay=npRelay, npTrapInfo=npTrapInfo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npGsmStrength=npGsmStrength, npThermoTrapStatus=npThermoTrapStatus, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry)
