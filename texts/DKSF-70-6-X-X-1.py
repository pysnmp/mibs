...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:22:13 2023
...
Bits, IpAddress, enterprises, MibIdentifier, Counter64, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Gauge32, ObjectIdentity, ModuleIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "enterprises", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapInfo=npTrapInfo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoPulseCounter=npIoPulseCounter, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npRelHumN=npRelHumN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npIoTable=npIoTable, npResetStack=npResetStack, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumEntry=npRelHumEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, npSmokeStatus=npSmokeStatus, npThermo=npThermo, npCurLoopR=npCurLoopR, npRelayMode=npRelayMode, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeEntry=npSmokeEntry, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npCurLoopI=npCurLoopI, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmStrength=npGsmStrength, npIoLevelOut=npIoLevelOut, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npSmokeSensorN=npSmokeSensorN, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npIoSinglePulseStart=npIoSinglePulseStart, npThermoEntry=npThermoEntry, npIoEntry=npIoEntry, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrap=npCurLoopTrap, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npThermoTraps=npThermoTraps, npRelayState=npRelayState, npThermoTrap=npThermoTrap, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, lightcom=lightcom, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTrapSafe=npRelHumTrapSafe, npIrCtrl=npIrCtrl, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npGsmTrap=npGsmTrap, npGsm=npGsm, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoMemo=npIoMemo, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npIoTrapPrefix=npIoTrapPrefix, npRelayEntry=npRelayEntry, npIoLevelIn=npIoLevelIn, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npCurLoopN=npCurLoopN, npGsmRegistration=npGsmRegistration, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npSmokeReset=npSmokeReset, npThermoTrapValue=npThermoTrapValue, npThermoTable=npThermoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe)
