...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:53:29 2021
...
MibIdentifier, Gauge32, Counter32, TimeTicks, Unsigned32, Counter64, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, enterprises, ObjectIdentity, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Counter32", "TimeTicks", "Unsigned32", "Counter64", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "enterprises", "ObjectIdentity", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npReboot=npReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTraps=npCurLoopTraps, lightcom=lightcom, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIoTraps=npIoTraps, npRelHumidity=npRelHumidity, npSmokeMemo=npSmokeMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npIoTable=npIoTable, npIrPlayCmd=npIrPlayCmd, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelHumMemo=npRelHumMemo, npRelayN=npRelayN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrap=npRelHumTrap, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npGsmInfo=npGsmInfo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumEntry=npRelHumEntry, npGsmStrength=npGsmStrength, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npIoLineN=npIoLineN, npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npSmoke=npSmoke, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopN=npCurLoopN, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelIn=npIoLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTraps=npSmokeTraps, npIrReset=npIrReset, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npIoTrapLineN=npIoTrapLineN, npTrapEmailTo=npTrapEmailTo, npRelay=npRelay, npGsmTraps=npGsmTraps, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npIoLevelOut=npIoLevelOut, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npCurLoopV=npCurLoopV, npThermoStatus=npThermoStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npGsm=npGsm, npRelHumTempStatus=npRelHumTempStatus, npThermo=npThermo, npRelHumStatus=npRelHumStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTable=npThermoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoEntry=npIoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempValue=npRelHumTempValue, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npCurLoopTable=npCurLoopTable, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
