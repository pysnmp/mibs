...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:11:56 2022
...
ModuleIdentity, TimeTicks, NotificationType, MibIdentifier, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ObjectIdentity, Bits, Gauge32, Integer32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ObjectIdentity", "Bits", "Gauge32", "Integer32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npSmokeReset=npSmokeReset, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npRelHumMemo=npRelHumMemo, npSoftReboot=npSoftReboot, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopI=npCurLoopI, npRelayStartReset=npRelayStartReset, npThermoTrapHigh=npThermoTrapHigh, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, FixedPoint1000=FixedPoint1000, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npRelayTable=npRelayTable, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, lightcom=lightcom, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTable=npRelHumTable, npThermoTable=npThermoTable, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npReboot=npReboot, npIoLevelOut=npIoLevelOut, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoMemo=npThermoMemo, npRelay=npRelay, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npSmokeTrapMemo=npSmokeTrapMemo, npThermoSensorN=npThermoSensorN, npRelHumStatus=npRelHumStatus, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npCurLoopV=npCurLoopV, npRelHumEntry=npRelHumEntry, npThermoStatus=npThermoStatus, npSmokeTable=npSmokeTable, npThermoHigh=npThermoHigh, npThermoTrapLow=npThermoTrapLow, npCurLoopN=npCurLoopN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayState=npRelayState, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npRelHumTrap=npRelHumTrap, npRelayMode=npRelayMode, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumN=npRelHumN, npSmokeMemo=npSmokeMemo, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npRelHumidity=npRelHumidity, npCurLoopTrapR=npCurLoopTrapR, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelayEntry=npRelayEntry, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapN=npCurLoopTrapN)
