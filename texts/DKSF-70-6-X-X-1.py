...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:35:30 2023
...
enterprises, MibIdentifier, TimeTicks, NotificationType, iso, Bits, IpAddress, Counter64, Counter32, ModuleIdentity, ObjectIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "TimeTicks", "NotificationType", "iso", "Bits", "IpAddress", "Counter64", "Counter32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIo=npIo, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npCurLoopTraps=npCurLoopTraps, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValue=npThermoValue, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npThermoSensorN=npThermoSensorN, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelOut=npIoLevelOut, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoEntry=npIoEntry, npResetStack=npResetStack, npRelHumEntry=npRelHumEntry, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npThermoTrap=npThermoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npSmokeReset=npSmokeReset, npRelHumTrapSafe=npRelHumTrapSafe, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapMemo=npIoTrapMemo, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npCurLoopStatus=npCurLoopStatus, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLineN=npIoTrapLineN, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelayMemo=npRelayMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrap=npRelHumTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeStatus=npSmokeStatus, npForcedReboot=npForcedReboot, npIr=npIr, npRelayState=npRelayState, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTable=npThermoTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npThermoEntry=npThermoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmFailed=npGsmFailed, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoStatus=npThermoStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npGsmTrapPrefix=npGsmTrapPrefix, npGsm=npGsm, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npSmoke=npSmoke, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN)
