...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:57:17 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, IpAddress, NotificationType, Unsigned32, Bits, MibIdentifier, Counter32, enterprises, Counter64, Integer32, ObjectIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "Bits", "MibIdentifier", "Counter32", "enterprises", "Counter64", "Integer32", "ObjectIdentity", "Gauge32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, lightcom=lightcom, npIoMemo=npIoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoLow=npThermoLow, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npCurLoopEntry=npCurLoopEntry, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npRelayState=npRelayState, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npCurLoopTraps=npCurLoopTraps, npGsmTrap=npGsmTrap, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapData=npRelHumTrapData, npThermoTrap=npThermoTrap, npIrCtrl=npIrCtrl, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npIoLineN=npIoLineN, npCurLoopTrapR=npCurLoopTrapR, npRelay=npRelay, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrap=npRelHumTrap, FixedPoint1000=FixedPoint1000, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTable=npThermoTable, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelIn=npIoLevelIn, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npThermoTraps=npThermoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke, npResetStack=npResetStack, npRelayTable=npRelayTable, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npSmokeSensorN=npSmokeSensorN, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npThermoTrapLow=npThermoTrapLow, npGsmRegistration=npGsmRegistration, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npThermoSensorN=npThermoSensorN, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoHigh=npThermoHigh, npRelayMemo=npRelayMemo, npIoEntry=npIoEntry, npSmokeTraps=npSmokeTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeReset=npSmokeReset, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopPower=npCurLoopPower, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIr=npIr, npIrReset=npIrReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumValue=npRelHumValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmInfo=npGsmInfo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo)
