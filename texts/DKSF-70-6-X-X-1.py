...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:28:06 2022
...
IpAddress, Counter32, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, MibIdentifier, iso, Counter64, TimeTicks, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "iso", "Counter64", "TimeTicks", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npResetStack=npResetStack, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npIoMemo=npIoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npIr=npIr, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npRelHumTempStatus=npRelHumTempStatus, npRelayMode=npRelayMode, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelOut=npIoLevelOut, npRelHumTrapFail=npRelHumTrapFail, npRelayN=npRelayN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npTrapEmailTo=npTrapEmailTo, npRelayStartReset=npRelayStartReset, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, FixedPoint1000=FixedPoint1000, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrap=npIoTrap, npCurLoopStatus=npCurLoopStatus, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npThermoMemo=npThermoMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npIoEntry=npIoEntry, npThermoValue=npThermoValue, npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, lightcom=lightcom, npCurLoopV=npCurLoopV, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapLow=npThermoTrapLow, npRelHumTable=npRelHumTable, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npCurLoopTable=npCurLoopTable, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoLow=npThermoLow, npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmoke=npSmoke, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelay=npRelay, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npThermoTrapHigh=npThermoTrapHigh, npCurLoop=npCurLoop, npCurLoopEntry=npCurLoopEntry, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN)
