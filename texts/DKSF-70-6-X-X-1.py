...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:20:26 2023
...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, ModuleIdentity, MibIdentifier, Bits, ObjectIdentity, NotificationType, IpAddress, TimeTicks, Counter64, enterprises, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "ModuleIdentity", "MibIdentifier", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "Counter64", "enterprises", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npSmokeEntry=npSmokeEntry, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSoftReboot=npSoftReboot, npCurLoopR=npCurLoopR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopPower=npCurLoopPower, npCurLoopTrap=npCurLoopTrap, npRelayMode=npRelayMode, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrap=npRelHumTrap, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokePower=npSmokePower, npIrReset=npIrReset, npThermoTrapLow=npThermoTrapLow, npGsmRegistration=npGsmRegistration, npSmokeReset=npSmokeReset, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npRelHumTrapData=npRelHumTrapData, npGsmStrength=npGsmStrength, npSmokeTraps=npSmokeTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npCurLoop=npCurLoop, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumStatus=npRelHumStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npCurLoopTrapV=npCurLoopTrapV, npGsm=npGsm, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, npReboot=npReboot, npThermoTraps=npThermoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelayStartReset=npRelayStartReset, npRelHumN=npRelHumN, lightcom=lightcom, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npThermoMemo=npThermoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npRelayTable=npRelayTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npIo=npIo, npRelHumEntry=npRelHumEntry, npTrapEmailTo=npTrapEmailTo, npGsmFailed=npGsmFailed, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npThermo=npThermo, npIrCtrl=npIrCtrl)
