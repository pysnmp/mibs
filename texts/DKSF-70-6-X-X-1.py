...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:50:40 2023
...
TimeTicks, Integer32, ModuleIdentity, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, Bits, enterprises, iso, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "Bits", "enterprises", "iso", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSoftReboot=npSoftReboot, npIoLevelOut=npIoLevelOut, npCurLoopTraps=npCurLoopTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npIo=npIo, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmInfo=npGsmInfo, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npIrReset=npIrReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npGsmFailed=npGsmFailed, npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npThermo=npThermo, npRelayN=npRelayN, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npTrapInfo=npTrapInfo, npIrStatus=npIrStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopI=npCurLoopI, npIoTrap=npIoTrap, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrap=npRelHumTrap, npCurLoop=npCurLoop, npSmoke=npSmoke, npRelayEntry=npRelayEntry, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValue=npThermoValue, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIoLineN=npIoLineN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumN=npRelHumN, npRelayMode=npRelayMode, npCurLoopN=npCurLoopN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapN=npCurLoopTrapN, npThermoHigh=npThermoHigh, npResetStack=npResetStack, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapHigh=npThermoTrapHigh, npIoTable=npIoTable, lightcom=lightcom, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npThermoSensorN=npThermoSensorN, npIr=npIr, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npSmokePower=npSmokePower, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumidity=npRelHumidity, npRelay=npRelay, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable)
