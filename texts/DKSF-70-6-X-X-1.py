...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:05:10 2023
...
MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, IpAddress, NotificationType, TimeTicks, Counter32, Integer32, Gauge32, Counter64, Unsigned32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "IpAddress", "NotificationType", "TimeTicks", "Counter32", "Integer32", "Gauge32", "Counter64", "Unsigned32", "iso", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npCurLoopTrap=npCurLoopTrap, npSmokeEntry=npSmokeEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npRelayStartReset=npRelayStartReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npGsmTraps=npGsmTraps, npRelay=npRelay, npCurLoopV=npCurLoopV, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo, npRelayTable=npRelayTable, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npGsmStrength=npGsmStrength, npReboot=npReboot, npRelayEntry=npRelayEntry, npThermoStatus=npThermoStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npSmokeReset=npSmokeReset, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataMemo=npRelHumTrapDataMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoSensorN=npThermoSensorN, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npCurLoopR=npCurLoopR, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npRelHumTrapSafe=npRelHumTrapSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapLow=npThermoTrapLow, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoTraps=npIoTraps, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTable=npThermoTable, npIo=npIo, npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npIr=npIr, lightcom=lightcom, npIoMemo=npIoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelIn=npIoTrapLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTraps=npCurLoopTraps, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMode=npRelayMode, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npCurLoop=npCurLoop, npThermo=npThermo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npRelHumMemo=npRelHumMemo, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapR=npCurLoopTrapR, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus)
