...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:12:21 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Counter64, Gauge32, enterprises, ModuleIdentity, Counter32, IpAddress, ObjectIdentity, MibIdentifier, iso, Integer32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Counter64", "Gauge32", "enterprises", "ModuleIdentity", "Counter32", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "Integer32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempStatus=npRelHumTempStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTraps=npThermoTraps, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npIoTrapLineN=npIoTrapLineN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrap=npRelHumTrap, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsm=npGsm, npRelHumTrapDataN=npRelHumTrapDataN, npTrapEmailTo=npTrapEmailTo, lightcom=lightcom, npCurLoopTrap=npCurLoopTrap, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumidity=npRelHumidity, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumStatus=npRelHumStatus, npRelHumTrapFail=npRelHumTrapFail, npTrapInfo=npTrapInfo, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npIr=npIr, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npCurLoopPower=npCurLoopPower, FixedPoint1000=FixedPoint1000, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npThermoEntry=npThermoEntry, npThermoTable=npThermoTable, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npIoTable=npIoTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrap=npIoTrap, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmoke=npSmoke, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npResetStack=npResetStack, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npSmokeEntry=npSmokeEntry, npThermoTrapLow=npThermoTrapLow, npRelayN=npRelayN, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmFailed=npGsmFailed, npCurLoopTrapN=npCurLoopTrapN, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npRelayStartReset=npRelayStartReset, npCurLoopR=npCurLoopR, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
