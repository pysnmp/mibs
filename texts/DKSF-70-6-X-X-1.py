...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:09:36 2024
...
Counter32, Unsigned32, enterprises, Counter64, iso, Bits, ObjectIdentity, ModuleIdentity, Gauge32, NotificationType, IpAddress, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "enterprises", "Counter64", "iso", "Bits", "ObjectIdentity", "ModuleIdentity", "Gauge32", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npThermoTable=npThermoTable, npIoLevelIn=npIoLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npRelay=npRelay, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npRelHumTempValue=npRelHumTempValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIo=npIo, npRelHumValue=npRelHumValue, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npIrStatus=npIrStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumEntry=npRelHumEntry, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npSmokePower=npSmokePower, npCurLoopStatus=npCurLoopStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrap=npThermoTrap, npIrReset=npIrReset, npThermo=npThermo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMode=npRelayMode, npCurLoopTable=npCurLoopTable, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopI=npCurLoopI, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npRelHumTable=npRelHumTable, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npGsmFailed=npGsmFailed, npCurLoopN=npCurLoopN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npCurLoop=npCurLoop, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrap=npRelHumTrap, npThermoTraps=npThermoTraps, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmInfo=npGsmInfo, npGsm=npGsm, npCurLoopTrapI=npCurLoopTrapI, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, npSmokeStatus=npSmokeStatus, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npIoTable=npIoTable, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npIoMemo=npIoMemo, npRelHumidity=npRelHumidity, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, lightcom=lightcom, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npThermoTrapHigh=npThermoTrapHigh, npIoTraps=npIoTraps, npThermoTrapValue=npThermoTrapValue, npRelayStartReset=npRelayStartReset, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeMemo=npSmokeMemo, npSmoke=npSmoke, npRelayState=npRelayState, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix)
