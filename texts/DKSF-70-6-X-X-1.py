...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:17:18 2021
...
enterprises, NotificationType, MibIdentifier, Counter64, Gauge32, Unsigned32, iso, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "MibIdentifier", "Counter64", "Gauge32", "Unsigned32", "iso", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Integer32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeTable=npSmokeTable, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoHigh=npThermoHigh, npSmoke=npSmoke, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npThermoSensorN=npThermoSensorN, npThermoEntry=npThermoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npIoTrapLineN=npIoTrapLineN, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrStatus=npIrStatus, npIoEntry=npIoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npIo=npIo, npRelHumEntry=npRelHumEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npRelHumTable=npRelHumTable, npRelayMemo=npRelayMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrPlayCmd=npIrPlayCmd, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumMemo=npRelHumMemo, npGsmStrength=npGsmStrength, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npRelayMode=npRelayMode, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, npThermoTable=npThermoTable, npSmokeMemo=npSmokeMemo, npRelayN=npRelayN, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npThermo=npThermo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempValue=npRelHumTempValue, npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoMemo=npThermoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrap=npSmokeTrap, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npResetStack=npResetStack, npSmokePower=npSmokePower, npThermoTrapHigh=npThermoTrapHigh, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npCurLoopV=npCurLoopV, npIr=npIr, npReboot=npReboot, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npThermoTraps=npThermoTraps, npRelayState=npRelayState, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTable=npCurLoopTable, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npCurLoop=npCurLoop, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npIoTable=npIoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, uniPingServerSolutionV3=uniPingServerSolutionV3)
