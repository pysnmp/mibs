...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:31:31 2021
...
Counter64, Gauge32, NotificationType, iso, Bits, Unsigned32, ObjectIdentity, IpAddress, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "NotificationType", "iso", "Bits", "Unsigned32", "ObjectIdentity", "IpAddress", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapStatus=npThermoTrapStatus, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npRelayMemo=npRelayMemo, npSmokePower=npSmokePower, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npRelayState=npRelayState, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrap=npSmokeTrap, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, npGsmFailed=npGsmFailed, npThermoLow=npThermoLow, npRelayN=npRelayN, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTable=npSmokeTable, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npResetStack=npResetStack, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npIoTrapPrefix=npIoTrapPrefix, npIrStatus=npIrStatus, npSoftReboot=npSoftReboot, npIo=npIo, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npThermoTrap=npThermoTrap, npRelHumTable=npRelHumTable, npCurLoopStatus=npCurLoopStatus, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTraps=npCurLoopTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npSmokeTrapMemo=npSmokeTrapMemo, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopR=npCurLoopR, npGsmTrap=npGsmTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTraps=npIoTraps, npCurLoopV=npCurLoopV, npRelHumEntry=npRelHumEntry, npThermoMemo=npThermoMemo, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npIr=npIr, npThermoHigh=npThermoHigh, lightcom=lightcom, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npSmokeEntry=npSmokeEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npRelHumMemo=npRelHumMemo, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npRelayStartReset=npRelayStartReset, npSmokeTrapPrefix=npSmokeTrapPrefix)
