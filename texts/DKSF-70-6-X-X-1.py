...
# Produced by pysmi-1.1.10 at Fri Nov 10 13:26:22 2023
...
MibIdentifier, iso, Counter32, NotificationType, ObjectIdentity, Gauge32, IpAddress, TimeTicks, Integer32, Bits, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "IpAddress", "TimeTicks", "Integer32", "Bits", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npGsmFailed=npGsmFailed, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelIn=npIoLevelIn, npCurLoopTable=npCurLoopTable, npSmokeEntry=npSmokeEntry, npThermoTraps=npThermoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoStatus=npThermoStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeStatus=npSmokeStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayTable=npRelayTable, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npCurLoopTrap=npCurLoopTrap, npIr=npIr, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapN=npCurLoopTrapN, npSmokeTraps=npSmokeTraps, npIo=npIo, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapMemo=npThermoTrapMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npThermoHigh=npThermoHigh, npGsm=npGsm, npGsmTraps=npGsmTraps, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopV=npCurLoopV, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npThermoMemo=npThermoMemo, npRelayMode=npRelayMode, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npThermoTrapLow=npThermoTrapLow, npRelayState=npRelayState, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npIrReset=npIrReset, npSoftReboot=npSoftReboot, npIoLineN=npIoLineN, npReboot=npReboot, npSmokeTrapMemo=npSmokeTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npRelayEntry=npRelayEntry, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npResetStack=npResetStack, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
