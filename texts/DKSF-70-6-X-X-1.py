...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:37:52 2023
...
Gauge32, Counter32, Integer32, enterprises, NotificationType, Unsigned32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Bits, TimeTicks, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Integer32", "enterprises", "NotificationType", "Unsigned32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Bits", "TimeTicks", "Counter64", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIoLevelOut=npIoLevelOut, npSmokeTrapMemo=npSmokeTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npIr=npIr, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npIoTrapLineN=npIoTrapLineN, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npThermo=npThermo, npThermoTable=npThermoTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npIo=npIo, npSmokeReset=npSmokeReset, npGsmTraps=npGsmTraps, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npIoLevelIn=npIoLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapDataN=npRelHumTrapDataN, npGsmInfo=npGsmInfo, npRelayN=npRelayN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMode=npRelayMode, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npReboot=npReboot, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npCurLoopR=npCurLoopR, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npSmokeSensorN=npSmokeSensorN, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npThermoTrapValue=npThermoTrapValue, npGsmRegistration=npGsmRegistration, npCurLoopN=npCurLoopN, npRelHumTrapData=npRelHumTrapData, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npRelHumTrap=npRelHumTrap, npIoLineN=npIoLineN, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npSmokePower=npSmokePower, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTraps=npThermoTraps, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npIoTraps=npIoTraps, npTrapInfo=npTrapInfo, npSmokeEntry=npSmokeEntry, npSmokeTraps=npSmokeTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoLow=npThermoLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumN=npRelHumN, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus)
