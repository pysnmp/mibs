...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:32:14 2022
...
MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, TimeTicks, Gauge32, Integer32, Unsigned32, enterprises, ObjectIdentity, iso, Bits, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "TimeTicks", "Gauge32", "Integer32", "Unsigned32", "enterprises", "ObjectIdentity", "iso", "Bits", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npIrReset=npIrReset, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTraps=npThermoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTable=npCurLoopTable, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npCurLoopTrapN=npCurLoopTrapN, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoHigh=npThermoHigh, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npCurLoopI=npCurLoopI, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npTrapInfo=npTrapInfo, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoMemo=npThermoMemo, npRelayTable=npRelayTable, npGsm=npGsm, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npGsmTrapPrefix=npGsmTrapPrefix, npIoTable=npIoTable, npCurLoopN=npCurLoopN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npReboot=npReboot, npResetStack=npResetStack, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npIrCtrl=npIrCtrl, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTraps=npSmokeTraps, npIoLineN=npIoLineN, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempValue=npRelHumTempValue, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, npThermoTrapStatus=npThermoTrapStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeMemo=npSmokeMemo, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npGsmTrap=npGsmTrap, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npIrStatus=npIrStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopV=npCurLoopV, npSmoke=npSmoke, npRelHumidity=npRelHumidity, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npThermo=npThermo, npGsmRegistration=npGsmRegistration, npThermoTrapLow=npThermoTrapLow, npIrPlayCmd=npIrPlayCmd)
