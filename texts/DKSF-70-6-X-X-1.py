...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:19:42 2021
...
Integer32, Gauge32, Counter32, Bits, IpAddress, MibIdentifier, iso, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, NotificationType, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter32", "Bits", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopN=npCurLoopN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumN=npRelHumN, npThermoTrapHigh=npThermoTrapHigh, npSmokeStatus=npSmokeStatus, npIoTrap=npIoTrap, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, npRelay=npRelay, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npReboot=npReboot, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npIoEntry=npIoEntry, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npGsmInfo=npGsmInfo, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, npRelayMemo=npRelayMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npSmoke=npSmoke, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopV=npCurLoopV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npCurLoopTrap=npCurLoopTrap, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npThermoLow=npThermoLow, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npSmokeMemo=npSmokeMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npIo=npIo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrap=npRelHumTrap, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopPower=npCurLoopPower, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapLow=npThermoTrapLow, npGsmStrength=npGsmStrength, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npRelHumValue=npRelHumValue)
