...
# Produced by pysmi-1.1.8 at Thu Feb  3 21:10:29 2022
...
ModuleIdentity, iso, IpAddress, ObjectIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, TimeTicks, Gauge32, Unsigned32, Counter32, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "Unsigned32", "Counter32", "enterprises", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumStatus=npRelHumStatus, lightcom=lightcom, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npCurLoopTable=npCurLoopTable, npIoTrap=npIoTrap, npIoTable=npIoTable, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumN=npRelHumN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npThermoTrapStatus=npThermoTrapStatus, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumValue=npRelHumValue, npRelayMemo=npRelayMemo, npThermoTrapPrefix=npThermoTrapPrefix, npReboot=npReboot, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTable=npRelayTable, npThermoEntry=npThermoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npRelHumidity=npRelHumidity, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapR=npCurLoopTrapR, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npIr=npIr, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumMemo=npRelHumMemo, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermo=npThermo, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTable=npThermoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npThermoTraps=npThermoTraps, npSmoke=npSmoke, npIoTraps=npIoTraps, npSmokeEntry=npSmokeEntry, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN, npSoftReboot=npSoftReboot, npResetStack=npResetStack, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLineN=npIoTrapLineN, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npIoMemo=npIoMemo, npIo=npIo, npRelHumTempValue=npRelHumTempValue, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npGsmTrap=npGsmTrap, npIoLevelIn=npIoLevelIn, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayStartReset=npRelayStartReset, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeSensorN=npSmokeSensorN)
