...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:28:39 2023
...
IpAddress, ObjectIdentity, enterprises, NotificationType, TimeTicks, Integer32, iso, MibIdentifier, ModuleIdentity, Gauge32, Counter32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "enterprises", "NotificationType", "TimeTicks", "Integer32", "iso", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npReboot=npReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npSmokeTrap=npSmokeTrap, npGsm=npGsm, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npGsmInfo=npGsmInfo, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npSoftReboot=npSoftReboot, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeEntry=npSmokeEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmFailed=npGsmFailed, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npGsmTraps=npGsmTraps, npThermoLow=npThermoLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokePower=npSmokePower, npCurLoopTrapN=npCurLoopTrapN, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npThermoTraps=npThermoTraps, npThermoValuePrecise=npThermoValuePrecise, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npRelHumValue=npRelHumValue, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrap=npThermoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopR=npCurLoopR, npThermo=npThermo, npRelay=npRelay, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, npGsmStrength=npGsmStrength, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npIoMemo=npIoMemo, npIoTable=npIoTable, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npCurLoopPower=npCurLoopPower, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTable=npThermoTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
