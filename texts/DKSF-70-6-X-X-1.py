...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:15:18 2023
...
Unsigned32, TimeTicks, Bits, iso, Gauge32, ModuleIdentity, IpAddress, Counter32, NotificationType, enterprises, MibIdentifier, Counter64, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Bits", "iso", "Gauge32", "ModuleIdentity", "IpAddress", "Counter32", "NotificationType", "enterprises", "MibIdentifier", "Counter64", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValue=npThermoValue, npThermoTraps=npThermoTraps, npGsmInfo=npGsmInfo, npSmokeTrap=npSmokeTrap, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrap=npRelHumTrap, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayEntry=npRelayEntry, npIoTrapLineN=npIoTrapLineN, npCurLoopR=npCurLoopR, npThermoEntry=npThermoEntry, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTable=npCurLoopTable, npThermo=npThermo, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npThermoTable=npThermoTable, npThermoMemo=npThermoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npGsmTrap=npGsmTrap, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npReboot=npReboot, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npSoftReboot=npSoftReboot, npIoTable=npIoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npCurLoopN=npCurLoopN, npRelayMemo=npRelayMemo, npSmokeTraps=npSmokeTraps, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, npRelayTable=npRelayTable, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrap=npCurLoopTrap, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npCurLoopEntry=npCurLoopEntry, npSmokeStatus=npSmokeStatus, npIrStatus=npIrStatus, npSmokeTable=npSmokeTable, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIo=npIo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npRelHumStatus=npRelHumStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npCurLoopTrapI=npCurLoopTrapI, npGsmStrength=npGsmStrength, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay)
