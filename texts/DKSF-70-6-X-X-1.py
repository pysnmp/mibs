...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:20:11 2022
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, NotificationType, Unsigned32, Counter64, IpAddress, Integer32, ObjectIdentity, ModuleIdentity, Bits, MibIdentifier, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "NotificationType", "Unsigned32", "Counter64", "IpAddress", "Integer32", "ObjectIdentity", "ModuleIdentity", "Bits", "MibIdentifier", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrap=npGsmTrap, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npSmoke=npSmoke, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapFail=npRelHumTrapFail, npIoTrap=npIoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npIoLineN=npIoLineN, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmStrength=npGsmStrength, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopStatus=npCurLoopStatus, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npThermoStatus=npThermoStatus, npIr=npIr, npRelayEntry=npRelayEntry, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrStatus=npIrStatus, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTraps=npIoTraps, npRelHumTempValue=npRelHumTempValue, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npIrCtrl=npIrCtrl, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoHigh=npThermoHigh, npSmokeTraps=npSmokeTraps, npIoTable=npIoTable, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npReboot=npReboot, npRelHumTrap=npRelHumTrap, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValue=npThermoValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelay=npRelay, npSmokePower=npSmokePower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npRelHumTrapData=npRelHumTrapData, npIoMemo=npIoMemo, npTrapEmailTo=npTrapEmailTo, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npSmokeSensorN=npSmokeSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npRelHumN=npRelHumN, npRelayState=npRelayState, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npRelHumTrapTempFail=npRelHumTrapTempFail)
