...
# Produced by pysmi-1.1.12 at Tue Jun  4 09:33:36 2024
...
Bits, enterprises, Gauge32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, ObjectIdentity, IpAddress, Integer32, MibIdentifier, Unsigned32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "Gauge32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "ObjectIdentity", "IpAddress", "Integer32", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npSmokeTrap=npSmokeTrap, npIoTraps=npIoTraps, npCurLoop=npCurLoop, npCurLoopPower=npCurLoopPower, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npForcedReboot=npForcedReboot, npThermoTrap=npThermoTrap, npRelayMode=npRelayMode, npIoTrapMemo=npIoTrapMemo, npRelHumMemo=npRelHumMemo, npResetStack=npResetStack, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npGsm=npGsm, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTable=npCurLoopTable, npRelayStartReset=npRelayStartReset, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrap=npIoTrap, npRelay=npRelay, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npIoEntry=npIoEntry, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npGsmTraps=npGsmTraps, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npRelHumTable=npRelHumTable, npThermoTable=npThermoTable, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npIoSinglePulseStart=npIoSinglePulseStart, npIo=npIo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrap=npRelHumTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeEntry=npSmokeEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTraps=npThermoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npReboot=npReboot, npCurLoopR=npCurLoopR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npIoPulseCounter=npIoPulseCounter, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npSmokeMemo=npSmokeMemo, npIrPlayCmd=npIrPlayCmd, npSmokeTrapStatus=npSmokeTrapStatus, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix)
