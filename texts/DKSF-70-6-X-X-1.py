...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:38:39 2024
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Gauge32, enterprises, ObjectIdentity, IpAddress, ModuleIdentity, Unsigned32, Counter32, TimeTicks, MibIdentifier, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Gauge32", "enterprises", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32", "TimeTicks", "MibIdentifier", "iso", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npIoPulseCounter=npIoPulseCounter, npRelayN=npRelayN, npIr=npIr, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopN=npCurLoopN, npRelHumValue=npRelHumValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelayMode=npRelayMode, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, FixedPoint1000=FixedPoint1000, npIrCtrl=npIrCtrl, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npGsmStrength=npGsmStrength, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeMemo=npSmokeMemo, npIoLevelOut=npIoLevelOut, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrap=npSmokeTrap, lightcom=lightcom, npIoTrapMemo=npIoTrapMemo, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npSmokeTrapSensorN=npSmokeTrapSensorN, npForcedReboot=npForcedReboot, npCurLoopTrapI=npCurLoopTrapI, npThermoValue=npThermoValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoStatus=npThermoStatus, npThermoValuePrecise=npThermoValuePrecise, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npRelHumTrapFail=npRelHumTrapFail, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopI=npCurLoopI, npIoTraps=npIoTraps, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTrap=npRelHumTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npThermoHigh=npThermoHigh, npThermoEntry=npThermoEntry, npReboot=npReboot, npSoftReboot=npSoftReboot, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIrReset=npIrReset, npRelHumidity=npRelHumidity, npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npThermo=npThermo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npIoTable=npIoTable, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npRelay=npRelay)
