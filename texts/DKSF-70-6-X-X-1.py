...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:38:27 2022
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, TimeTicks, NotificationType, Unsigned32, Counter64, ModuleIdentity, iso, IpAddress, enterprises, Bits, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "TimeTicks", "NotificationType", "Unsigned32", "Counter64", "ModuleIdentity", "iso", "IpAddress", "enterprises", "Bits", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValue=npThermoValue, npCurLoopTable=npCurLoopTable, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, npCurLoopV=npCurLoopV, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npRelHumEntry=npRelHumEntry, npReboot=npReboot, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokePower=npSmokePower, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, npGsmRegistration=npGsmRegistration, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npThermoTable=npThermoTable, npIoMemo=npIoMemo, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npIoEntry=npIoEntry, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npGsm=npGsm, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npResetStack=npResetStack, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoStatus=npThermoStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayState=npRelayState, npIoSinglePulseStart=npIoSinglePulseStart, npThermoLow=npThermoLow, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npIrStatus=npIrStatus, npCurLoopN=npCurLoopN, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npIr=npIr, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npSmokeTrap=npSmokeTrap, npSmokeStatus=npSmokeStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npCurLoopTrapR=npCurLoopTrapR, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npRelHumValue=npRelHumValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, npIo=npIo, npIoLevelIn=npIoLevelIn, npRelayTable=npRelayTable, npRelHumTempValue=npRelHumTempValue, npCurLoopPower=npCurLoopPower, npRelHumTempStatus=npRelHumTempStatus, npCurLoopI=npCurLoopI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke)
