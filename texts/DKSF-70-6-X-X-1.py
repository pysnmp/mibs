...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:11:36 2023
...
IpAddress, Gauge32, Integer32, Counter32, iso, NotificationType, Unsigned32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, Bits, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Integer32", "Counter32", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "Bits", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeReset=npSmokeReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTraps=npThermoTraps, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npGsmStrength=npGsmStrength, npThermoTrapMemo=npThermoTrapMemo, npSmokeMemo=npSmokeMemo, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, lightcom=lightcom, npIrReset=npIrReset, npIrCtrl=npIrCtrl, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npSmokeSensorN=npSmokeSensorN, npIr=npIr, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npReboot=npReboot, npIoMemo=npIoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoTrap=npIoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTable=npThermoTable, npSoftReboot=npSoftReboot, npCurLoopTable=npCurLoopTable, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrap=npSmokeTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npRelayState=npRelayState, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npThermoStatus=npThermoStatus, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrap=npGsmTrap, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeStatus=npSmokeStatus, npCurLoopV=npCurLoopV, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npCurLoopTraps=npCurLoopTraps, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermo=npThermo, npResetStack=npResetStack, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumidity=npRelHumidity, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelIn=npIoLevelIn, npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npRelHumValue=npRelHumValue, npTrapInfo=npTrapInfo, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npRelay=npRelay, npThermoValue=npThermoValue, FixedPoint1000=FixedPoint1000, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe)
