...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:52:56 2021
...
Gauge32, IpAddress, enterprises, Bits, Counter32, Unsigned32, iso, Counter64, TimeTicks, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "enterprises", "Bits", "Counter32", "Unsigned32", "iso", "Counter64", "TimeTicks", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeMemo=npSmokeMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTable=npRelHumTable, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, lightcom=lightcom, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npIr=npIr, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npThermo=npThermo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npSoftReboot=npSoftReboot, npThermoLow=npThermoLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npIrStatus=npIrStatus, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npIrPlayCmd=npIrPlayCmd, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokePower=npSmokePower, npCurLoopTraps=npCurLoopTraps, npRelayTable=npRelayTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapInfo=npTrapInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopI=npCurLoopI, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npCurLoopPower=npCurLoopPower, npIrCtrl=npIrCtrl, npSmokeReset=npSmokeReset, npGsm=npGsm, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPower=npCurLoopTrapPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumStatus=npRelHumStatus, npReboot=npReboot, npCurLoopR=npCurLoopR, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapPrefix=npIoTrapPrefix, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npRelayEntry=npRelayEntry, npIoMemo=npIoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npRelHumTrapData=npRelHumTrapData, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelay=npRelay, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npThermoTraps=npThermoTraps)
