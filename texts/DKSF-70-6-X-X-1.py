...
# Produced by pysmi-1.1.8 at Mon Jan  9 11:07:23 2023
...
Bits, Counter32, Gauge32, enterprises, IpAddress, MibIdentifier, TimeTicks, Counter64, iso, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "enterprises", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "iso", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapHigh=npThermoTrapHigh, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsm=npGsm, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npSmokeTable=npSmokeTable, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayEntry=npRelayEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIoLineN=npIoLineN, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npIoMemo=npIoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValue=npThermoValue, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npResetStack=npResetStack, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npSmoke=npSmoke, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoHigh=npThermoHigh, npThermoTable=npThermoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npIrStatus=npIrStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapDataN=npRelHumTrapDataN, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npReboot=npReboot, npForcedReboot=npForcedReboot, npGsmFailed=npGsmFailed, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npRelayMode=npRelayMode, npThermoTrapLow=npThermoTrapLow, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrap=npCurLoopTrap, npIrReset=npIrReset, npIrCtrl=npIrCtrl, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelOut=npIoLevelOut, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npRelHumidity=npRelHumidity, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npRelHumEntry=npRelHumEntry, npThermoStatus=npThermoStatus, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelIn=npIoLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, lightcom=lightcom, npIoPulseCounter=npIoPulseCounter, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npThermoTraps=npThermoTraps)
