...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:08:16 2024
...
Counter64, Counter32, Gauge32, TimeTicks, Bits, enterprises, NotificationType, iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "Gauge32", "TimeTicks", "Bits", "enterprises", "NotificationType", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npResetStack=npResetStack, npGsmStrength=npGsmStrength, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, npSmokeTable=npSmokeTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelIn=npIoLevelIn, npCurLoop=npCurLoop, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npRelayStartReset=npRelayStartReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsm=npGsm, npCurLoopV=npCurLoopV, npTrapEmailTo=npTrapEmailTo, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npThermoSensorN=npThermoSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npRelayMode=npRelayMode, npIoTrapLevelLegend=npIoTrapLevelLegend, lightcom=lightcom, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLineN=npIoTrapLineN, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npCurLoopTrapI=npCurLoopTrapI, npRelHumMemo=npRelHumMemo, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTable=npThermoTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npThermoEntry=npThermoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npThermoLow=npThermoLow, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npIrPlayCmd=npIrPlayCmd, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmFailed=npGsmFailed, npCurLoopI=npCurLoopI, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npSmokeReset=npSmokeReset, npCurLoopTrap=npCurLoopTrap, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapLow=npThermoTrapLow, npIoLevelOut=npIoLevelOut, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermo=npThermo, npIo=npIo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npSmoke=npSmoke, npSmokeTrapStatus=npSmokeTrapStatus, npIoEntry=npIoEntry)
