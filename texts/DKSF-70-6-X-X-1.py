...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:10:12 2024
...
enterprises, iso, Counter32, Gauge32, TimeTicks, ModuleIdentity, Bits, ObjectIdentity, NotificationType, IpAddress, Counter64, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Counter32", "Gauge32", "TimeTicks", "ModuleIdentity", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npIoEntry=npIoEntry, npRelHumTrapFail=npRelHumTrapFail, npCurLoopN=npCurLoopN, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelay=npRelay, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npIoLevelOut=npIoLevelOut, npRelayN=npRelayN, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npThermoTrapMemo=npThermoTrapMemo, FixedPoint1000=FixedPoint1000, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumN=npRelHumN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npResetStack=npResetStack, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeReset=npSmokeReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokePower=npSmokePower, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapHigh=npThermoTrapHigh, npRelayStartReset=npRelayStartReset, npGsmFailed=npGsmFailed, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npCurLoopTable=npCurLoopTable, npGsm=npGsm, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapStatus=npThermoTrapStatus, npSmokeEntry=npSmokeEntry, npGsmTraps=npGsmTraps, npIr=npIr, npCurLoopV=npCurLoopV, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValue=npThermoValue, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npThermoTrapLow=npThermoTrapLow, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npRelHumMemo=npRelHumMemo, npIoMemo=npIoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npRelayTable=npRelayTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTraps=npThermoTraps, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npRelHumTable=npRelHumTable, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npThermoEntry=npThermoEntry, npRelHumEntry=npRelHumEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue)
