...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:16:44 2022
...
TimeTicks, enterprises, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, MibIdentifier, Integer32, Counter64, ModuleIdentity, Counter32, IpAddress, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "IpAddress", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapValue=npThermoTrapValue, lightcom=lightcom, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npReboot=npReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumValue=npRelHumValue, npIo=npIo, npCurLoopV=npCurLoopV, npCurLoopTable=npCurLoopTable, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmInfo=npGsmInfo, npThermoValuePrecise=npThermoValuePrecise, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMode=npRelayMode, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermo=npThermo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, FixedPoint1000=FixedPoint1000, npThermoTable=npThermoTable, npRelHumTempStatus=npRelHumTempStatus, npThermoSensorN=npThermoSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npCurLoopTrapV=npCurLoopTrapV, npIoSinglePulseStart=npIoSinglePulseStart, npRelayN=npRelayN, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npGsmTraps=npGsmTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopN=npCurLoopN, npIrPlayCmd=npIrPlayCmd, npRelHumStatus=npRelHumStatus, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npRelay=npRelay, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npCurLoopPower=npCurLoopPower, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npSmoke=npSmoke, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoHigh=npThermoHigh, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValue=npThermoValue, npIr=npIr, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrap=npThermoTrap, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTraps=npSmokeTraps, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npThermoTraps=npThermoTraps, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npResetStack=npResetStack, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData)
