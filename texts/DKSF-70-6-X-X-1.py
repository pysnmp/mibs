...
# Produced by pysmi-1.1.12 at Tue Sep 17 10:03:38 2024
...
iso, TimeTicks, Counter64, IpAddress, Unsigned32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, MibIdentifier, Integer32, Counter32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "IpAddress", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "MibIdentifier", "Integer32", "Counter32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npSmokeMemo=npSmokeMemo, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npIoEntry=npIoEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTraps=npGsmTraps, npThermoValue=npThermoValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, lightcom=lightcom, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npIoTrap=npIoTrap, npRelHumTempValue=npRelHumTempValue, npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, npReboot=npReboot, npSmokeSensorN=npSmokeSensorN, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npRelay=npRelay, npSmokeTrapStatus=npSmokeTrapStatus, npRelayTable=npRelayTable, npThermoTrapValue=npThermoTrapValue, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npThermoTrapLow=npThermoTrapLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npIr=npIr, npGsm=npGsm, npRelayMemo=npRelayMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npRelayStartReset=npRelayStartReset, npThermo=npThermo, npRelHumStatus=npRelHumStatus, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopN=npCurLoopN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTable=npSmokeTable, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIrReset=npIrReset, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoMemo=npThermoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeEntry=npSmokeEntry)
