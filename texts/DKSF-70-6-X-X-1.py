...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:04:14 2023
...
Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, Gauge32, ModuleIdentity, Bits, ObjectIdentity, Unsigned32, enterprises, Counter64, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "Gauge32", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "enterprises", "Counter64", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapData=npRelHumTrapData, npIr=npIr, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLevelIn=npIoLevelIn, npIoTraps=npIoTraps, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npIo=npIo, npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npThermoEntry=npThermoEntry, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTraps=npCurLoopTraps, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npCurLoopN=npCurLoopN, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeSensorN=npSmokeSensorN, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npThermo=npThermo, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npRelayTable=npRelayTable, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumStatus=npRelHumStatus, npIoEntry=npIoEntry, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsm=npGsm, npCurLoopI=npCurLoopI, npCurLoopV=npCurLoopV, npCurLoopTable=npCurLoopTable, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPower=npCurLoopTrapPower, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrap=npGsmTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npCurLoop=npCurLoop, npIoLevelOut=npIoLevelOut, npRelHumN=npRelHumN, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn)
