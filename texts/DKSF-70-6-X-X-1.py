...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:56:39 2023
...
enterprises, Unsigned32, ObjectIdentity, Integer32, Counter32, ModuleIdentity, Gauge32, iso, TimeTicks, NotificationType, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "ObjectIdentity", "Integer32", "Counter32", "ModuleIdentity", "Gauge32", "iso", "TimeTicks", "NotificationType", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npRelayEntry=npRelayEntry, npCurLoopV=npCurLoopV, npIrStatus=npIrStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTable=npCurLoopTable, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npIoTrapLineN=npIoTrapLineN, npThermoEntry=npThermoEntry, npIrReset=npIrReset, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npThermo=npThermo, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumValue=npRelHumValue, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npIoTable=npIoTable, lightcom=lightcom, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapInfo=npTrapInfo, npIrCtrl=npIrCtrl, npSmokeTable=npSmokeTable, npGsm=npGsm, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npIoTrap=npIoTrap, npGsmInfo=npGsmInfo, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npThermoTrapMemo=npThermoTrapMemo, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npForcedReboot=npForcedReboot, npGsmStrength=npGsmStrength, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npCurLoopTrap=npCurLoopTrap, npThermoMemo=npThermoMemo, npThermoTrapHigh=npThermoTrapHigh, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npSoftReboot=npSoftReboot, npSmokeTrap=npSmokeTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, npGsmTrap=npGsmTrap, npCurLoopPower=npCurLoopPower, npIr=npIr, npRelHumidity=npRelHumidity, npRelHumTable=npRelHumTable, npThermoLow=npThermoLow, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopI=npCurLoopI)
