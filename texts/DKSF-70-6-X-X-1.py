...
# Produced by pysmi-1.1.12 at Fri Nov 22 16:46:23 2024
...
TimeTicks, IpAddress, ModuleIdentity, NotificationType, enterprises, Unsigned32, Counter32, Integer32, Counter64, MibIdentifier, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "ModuleIdentity", "NotificationType", "enterprises", "Unsigned32", "Counter32", "Integer32", "Counter64", "MibIdentifier", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npThermoTrapLow=npThermoTrapLow, npCurLoopStatus=npCurLoopStatus, npThermoTrapStatus=npThermoTrapStatus, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npRelay=npRelay, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopPower=npCurLoopPower, npIo=npIo, npGsm=npGsm, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npThermoMemo=npThermoMemo, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap, npResetStack=npResetStack, npGsmFailed=npGsmFailed, npIoTraps=npIoTraps, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npCurLoopN=npCurLoopN, npCurLoopR=npCurLoopR, npThermoTrap=npThermoTrap, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTraps=npThermoTraps, npGsmRegistration=npGsmRegistration, npThermoStatus=npThermoStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTable=npIoTable, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npCurLoop=npCurLoop, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTable=npRelHumTable, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayN=npRelayN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokePower=npSmokePower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumMemo=npRelHumMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrap=npSmokeTrap, npSmokeTrapStatus=npSmokeTrapStatus, npSmoke=npSmoke, npIoMemo=npIoMemo, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry)
