...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:24:06 2021
...
Gauge32, MibIdentifier, TimeTicks, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, iso, Bits, ModuleIdentity, Counter32, IpAddress, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "TimeTicks", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "iso", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapInfo=npTrapInfo, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopI=npCurLoopI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumN=npRelHumN, npThermoSensorN=npThermoSensorN, npRelHumidity=npRelHumidity, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrap=npRelHumTrap, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapMemo=npThermoTrapMemo, npSmokeMemo=npSmokeMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempStatus=npRelHumTempStatus, npCurLoopR=npCurLoopR, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataN=npRelHumTrapDataN, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npIrReset=npIrReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermo=npThermo, npThermoLow=npThermoLow, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npIoLevelIn=npIoLevelIn, npIoEntry=npIoEntry, npIoTable=npIoTable, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npIo=npIo, npResetStack=npResetStack, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, npRelHumEntry=npRelHumEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npThermoHigh=npThermoHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npRelHumTrapData=npRelHumTrapData, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumMemo=npRelHumMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumStatus=npRelHumStatus, npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTable=npCurLoopTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayEntry=npRelayEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npThermoTraps=npThermoTraps)
