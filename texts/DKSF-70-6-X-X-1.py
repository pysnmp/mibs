...
# Produced by pysmi-1.1.12 at Wed Sep 18 06:48:54 2024
...
Unsigned32, Gauge32, Integer32, Counter64, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, enterprises, TimeTicks, ObjectIdentity, Counter32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "Integer32", "Counter64", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "enterprises", "TimeTicks", "ObjectIdentity", "Counter32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npSmoke=npSmoke, npSmokePower=npSmokePower, npThermoHigh=npThermoHigh, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npIo=npIo, npIoEntry=npIoEntry, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumStatus=npRelHumStatus, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npSoftReboot=npSoftReboot, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npThermoLow=npThermoLow, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npIrPlayCmd=npIrPlayCmd, npRelHumMemo=npRelHumMemo, npReboot=npReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npSmokeTraps=npSmokeTraps, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopI=npCurLoopI, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTraps=npIoTraps, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npRelHumTable=npRelHumTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npIoLevelOut=npIoLevelOut, npRelHumTrapAllChannels=npRelHumTrapAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npThermoTrap=npThermoTrap, npIoTrapMemo=npIoTrapMemo, npGsmTrap=npGsmTrap, npRelHumTrapFail=npRelHumTrapFail, npRelayN=npRelayN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npRelHumTrapData=npRelHumTrapData, npIoTrap=npIoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLineN=npIoLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npThermo=npThermo, npGsm=npGsm, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npCurLoopR=npCurLoopR, npRelHumEntry=npRelHumEntry, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed, npThermoSensorN=npThermoSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npSmokeEntry=npSmokeEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumN=npRelHumN, npResetStack=npResetStack, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents)
