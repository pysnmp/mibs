...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:32:57 2023
...
MibIdentifier, ModuleIdentity, NotificationType, TimeTicks, Gauge32, Counter64, enterprises, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Unsigned32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "TimeTicks", "Gauge32", "Counter64", "enterprises", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Unsigned32", "iso", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopPower=npCurLoopPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTraps=npIoTraps, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npIr=npIr, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npCurLoopTraps=npCurLoopTraps, FixedPoint1000=FixedPoint1000, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokePower=npSmokePower, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmoke=npSmoke, npRelHumidity=npRelHumidity, npCurLoopEntry=npCurLoopEntry, npSmokeSensorN=npSmokeSensorN, npRelay=npRelay, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npResetStack=npResetStack, npGsmTraps=npGsmTraps, npIoTable=npIoTable, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npRelayEntry=npRelayEntry, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeReset=npSmokeReset, npThermoSensorN=npThermoSensorN, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumValue=npRelHumValue, npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npGsmTrapPrefix=npGsmTrapPrefix, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npIo=npIo, npIoEntry=npIoEntry, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npGsmTrap=npGsmTrap, npIrPlayCmd=npIrPlayCmd, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npIrReset=npIrReset, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npRelHumTempStatus=npRelHumTempStatus, npThermoStatus=npThermoStatus, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npIoTrap=npIoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoLow=npThermoLow, npRelayN=npRelayN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayTable=npRelayTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npCurLoopV=npCurLoopV, npGsmRegistration=npGsmRegistration, npGsm=npGsm, npCurLoopN=npCurLoopN)
