...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:30:08 2022
...
Counter64, enterprises, TimeTicks, Integer32, Counter32, Gauge32, Bits, Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "TimeTicks", "Integer32", "Counter32", "Gauge32", "Bits", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrapPrefix=npGsmTrapPrefix, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrap=npThermoTrap, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npGsm=npGsm, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, npThermoTrapHigh=npThermoTrapHigh, npIoLevelOut=npIoLevelOut, npIrPlayCmd=npIrPlayCmd, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npTrapInfo=npTrapInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrap=npGsmTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopEntry=npCurLoopEntry, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npIoTrapMemo=npIoTrapMemo, npResetStack=npResetStack, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, lightcom=lightcom, npIoLineN=npIoLineN, npThermoLow=npThermoLow, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npRelayN=npRelayN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, npCurLoopI=npCurLoopI, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmInfo=npGsmInfo, npThermoTrapValue=npThermoTrapValue, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmoke=npSmoke, npCurLoopStatus=npCurLoopStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTable=npCurLoopTable, npCurLoopN=npCurLoopN, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrap=npCurLoopTrap, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npThermoTrapLow=npThermoTrapLow, npRelayMode=npRelayMode, npIoTrap=npIoTrap, npIoTable=npIoTable, npCurLoopR=npCurLoopR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npIrStatus=npIrStatus, npGsmTraps=npGsmTraps, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npRelHumValue=npRelHumValue, npIoTrapLevelIn=npIoTrapLevelIn, npSoftReboot=npSoftReboot, npIr=npIr)
