...
# Produced by pysmi-1.1.8 at Wed Sep 13 08:05:34 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Counter32, iso, Bits, Integer32, NotificationType, ObjectIdentity, Gauge32, TimeTicks, enterprises, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Counter32", "iso", "Bits", "Integer32", "NotificationType", "ObjectIdentity", "Gauge32", "TimeTicks", "enterprises", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTraps=npThermoTraps, npSoftReboot=npSoftReboot, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoLow=npThermoLow, npGsmTraps=npGsmTraps, npRelay=npRelay, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npIoEntry=npIoEntry, npCurLoopTrapI=npCurLoopTrapI, npIrCtrl=npIrCtrl, npThermoTrapHigh=npThermoTrapHigh, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIo=npIo, npThermoTrapMemo=npThermoTrapMemo, npThermoTable=npThermoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npSmokePower=npSmokePower, npIoTrapPrefix=npIoTrapPrefix, npRelHumStatus=npRelHumStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npGsmInfo=npGsmInfo, npThermoSensorN=npThermoSensorN, npRelayTable=npRelayTable, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npRelayState=npRelayState, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, lightcom=lightcom, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npTrapInfo=npTrapInfo, npRelayMemo=npRelayMemo, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npIoLineN=npIoLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npIoTrapLineN=npIoTrapLineN, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoop=npCurLoop, npSmoke=npSmoke, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npCurLoopTable=npCurLoopTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npSmokeTable=npSmokeTable, npIoPulseCounter=npIoPulseCounter, npCurLoopStatus=npCurLoopStatus, npGsmStrength=npGsmStrength, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npIoTable=npIoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapFail=npRelHumTrapFail)
