...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:16:30 2022
...
ModuleIdentity, NotificationType, Integer32, Unsigned32, MibIdentifier, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Bits, Counter64, IpAddress, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "MibIdentifier", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Bits", "Counter64", "IpAddress", "iso", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, FixedPoint1000=FixedPoint1000, lightcom=lightcom, npCurLoopR=npCurLoopR, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npTrapInfo=npTrapInfo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumEntry=npRelHumEntry, npSmokeEntry=npSmokeEntry, npTrapEmailTo=npTrapEmailTo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopI=npCurLoopI, npThermo=npThermo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMemo=npRelayMemo, npThermoTrap=npThermoTrap, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npReboot=npReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeSensorN=npSmokeSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npRelayState=npRelayState, npRelHumidity=npRelHumidity, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npThermoTrapLow=npThermoTrapLow, npRelayEntry=npRelayEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npCurLoopTraps=npCurLoopTraps, npThermoTrapPrefix=npThermoTrapPrefix, npForcedReboot=npForcedReboot, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTraps=npThermoTraps, npCurLoopEntry=npCurLoopEntry, npRelayStartReset=npRelayStartReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTable=npCurLoopTable, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npIoTrapLevelIn=npIoTrapLevelIn, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTraps=npGsmTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumN=npRelHumN, npThermoSensorN=npThermoSensorN, npGsm=npGsm, npSmokeStatus=npSmokeStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npThermoValuePrecise=npThermoValuePrecise, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npRelHumTrap=npRelHumTrap, npThermoLow=npThermoLow, npRelay=npRelay, npRelHumTrapTempFail=npRelHumTrapTempFail, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npIoTrapLineN=npIoTrapLineN, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayTable=npRelayTable, npThermoStatus=npThermoStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npRelayN=npRelayN, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npResetStack=npResetStack, npSmokeMemo=npSmokeMemo, npCurLoopTrapPower=npCurLoopTrapPower)
