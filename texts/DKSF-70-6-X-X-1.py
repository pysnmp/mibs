...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:27:51 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Counter32, enterprises, Integer32, IpAddress, MibIdentifier, Gauge32, TimeTicks, ObjectIdentity, Unsigned32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Counter32", "enterprises", "Integer32", "IpAddress", "MibIdentifier", "Gauge32", "TimeTicks", "ObjectIdentity", "Unsigned32", "iso", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npRelHumTrap=npRelHumTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npReboot=npReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopR=npCurLoopR, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npIoEntry=npIoEntry, npGsmInfo=npGsmInfo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSoftReboot=npSoftReboot, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTable=npThermoTable, npThermoMemo=npThermoMemo, npRelayN=npRelayN, npRelHumidity=npRelHumidity, npGsmStrength=npGsmStrength, npRelHumTable=npRelHumTable, npSmokeSensorN=npSmokeSensorN, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npIrReset=npIrReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npIr=npIr, npRelay=npRelay, npRelayMode=npRelayMode, npRelHumN=npRelHumN, npCurLoopTrapI=npCurLoopTrapI, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npGsmRegistration=npGsmRegistration, npIoLineN=npIoLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapStatus=npThermoTrapStatus, npRelayState=npRelayState, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoop=npCurLoop, npSmoke=npSmoke, npIo=npIo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeEntry=npSmokeEntry, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npThermoEntry=npThermoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npThermoTraps=npThermoTraps, npIrPlayCmd=npIrPlayCmd, npThermoLow=npThermoLow, npCurLoopTraps=npCurLoopTraps, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npRelHumTempStatus=npRelHumTempStatus, npCurLoopV=npCurLoopV, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npSmokeTraps=npSmokeTraps, npRelHumEntry=npRelHumEntry, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmFailed=npGsmFailed, npCurLoopTable=npCurLoopTable, npThermo=npThermo, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut)
