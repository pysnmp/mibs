...
# Produced by pysmi-1.1.12 at Wed May 29 10:08:54 2024
...
TimeTicks, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, Gauge32, enterprises, Counter64, Bits, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "enterprises", "Counter64", "Bits", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npIoTrap=npIoTrap, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npThermoTrapValue=npThermoTrapValue, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npSmoke=npSmoke, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValue=npThermoValue, npIoLineN=npIoLineN, npSmokeTrapStatus=npSmokeTrapStatus, npGsmFailed=npGsmFailed, npThermoTraps=npThermoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npTrapInfo=npTrapInfo, npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, npRelay=npRelay, npCurLoopR=npCurLoopR, npRelayMode=npRelayMode, npIoTable=npIoTable, npSmokeEntry=npSmokeEntry, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npCurLoopTable=npCurLoopTable, npGsm=npGsm, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopN=npCurLoopN, npIrReset=npIrReset, npIo=npIo, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npGsmTraps=npGsmTraps, npGsmInfo=npGsmInfo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npThermo=npThermo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrap=npCurLoopTrap, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npCurLoopTrapN=npCurLoopTrapN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopPower=npCurLoopPower, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npSmokeStatus=npSmokeStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapStatus=npCurLoopTrapStatus, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npThermoTrapPrefix=npThermoTrapPrefix)
