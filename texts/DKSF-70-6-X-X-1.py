...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:26:56 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Integer32, ModuleIdentity, enterprises, MibIdentifier, IpAddress, Bits, TimeTicks, Counter32, Unsigned32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Integer32", "ModuleIdentity", "enterprises", "MibIdentifier", "IpAddress", "Bits", "TimeTicks", "Counter32", "Unsigned32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrap=npGsmTrap, npThermoTrapValue=npThermoTrapValue, npIoTrapLineN=npIoTrapLineN, npIoTable=npIoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npRelHumTrapFail=npRelHumTrapFail, npCurLoopEntry=npCurLoopEntry, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npIoEntry=npIoEntry, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTraps=npGsmTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumN=npRelHumN, npGsm=npGsm, npGsmStrength=npGsmStrength, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npThermo=npThermo, npSmokeReset=npSmokeReset, npCurLoopN=npCurLoopN, npIrReset=npIrReset, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, npThermoLow=npThermoLow, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npForcedReboot=npForcedReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTraps=npSmokeTraps, npReboot=npReboot, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, FixedPoint1000=FixedPoint1000, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSoftReboot=npSoftReboot, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npIr=npIr, npCurLoopTrapR=npCurLoopTrapR, npSmoke=npSmoke, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npGsmRegistration=npGsmRegistration, npThermoValuePrecise=npThermoValuePrecise, npCurLoopStatus=npCurLoopStatus, npRelHumTempStatus=npRelHumTempStatus, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLineN=npIoLineN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npResetStack=npResetStack, npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoHigh=npThermoHigh, npIo=npIo, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251)
