...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:57:17 2023
...
Counter32, Bits, Counter64, ModuleIdentity, iso, Integer32, TimeTicks, ObjectIdentity, MibIdentifier, NotificationType, IpAddress, enterprises, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Counter64", "ModuleIdentity", "iso", "Integer32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "NotificationType", "IpAddress", "enterprises", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npReboot=npReboot, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrCtrl=npIrCtrl, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapStatus=npSmokeTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoPulseCounter=npIoPulseCounter, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npRelayState=npRelayState, npThermoTrapPrefix=npThermoTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapHigh=npThermoTrapHigh, npGsmRegistration=npGsmRegistration, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrStatus=npIrStatus, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrap=npCurLoopTrap, npRelayStartReset=npRelayStartReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumidity=npRelHumidity, npForcedReboot=npForcedReboot, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npThermoValue=npThermoValue, npSmoke=npSmoke, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIo=npIo, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npCurLoopI=npCurLoopI, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npCurLoopN=npCurLoopN, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, FixedPoint1000=FixedPoint1000, npIoTable=npIoTable, npCurLoopStatus=npCurLoopStatus, npThermoTable=npThermoTable, npThermoStatus=npThermoStatus, npThermoTraps=npThermoTraps, npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npRelayN=npRelayN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTable=npCurLoopTable, npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npRelHumMemo=npRelHumMemo, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npRelayMemo=npRelayMemo, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npSmokePower=npSmokePower, npIoMemo=npIoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapValue=npThermoTrapValue, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapMemo=npSmokeTrapMemo)
