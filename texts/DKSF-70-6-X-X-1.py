...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:16:49 2023
...
Unsigned32, enterprises, Counter32, iso, ObjectIdentity, IpAddress, ModuleIdentity, MibIdentifier, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Counter32", "iso", "ObjectIdentity", "IpAddress", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTable=npCurLoopTable, npRelHumStatus=npRelHumStatus, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapLow=npThermoTrapLow, npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap, npSmokeTrapStatus=npSmokeTrapStatus, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, npCurLoopTrapR=npCurLoopTrapR, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npCurLoopI=npCurLoopI, npThermoMemo=npThermoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npRelHumTrapDataN=npRelHumTrapDataN, npSmokePower=npSmokePower, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npIoLineN=npIoLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npThermoValue=npThermoValue, lightcom=lightcom, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIo=npIo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelay=npRelay, npRelHumTempStatus=npRelHumTempStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npTrapInfo=npTrapInfo, npIr=npIr, npSmokeStatus=npSmokeStatus, npCurLoopStatus=npCurLoopStatus, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopPower=npCurLoopPower, npCurLoopEntry=npCurLoopEntry, npIoTrap=npIoTrap, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npThermo=npThermo, npIoTable=npIoTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelIn=npIoLevelIn, npGsmRegistration=npGsmRegistration, npResetStack=npResetStack, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npGsmTraps=npGsmTraps, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npRelHumTempValue=npRelHumTempValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npRelHumTrapFail=npRelHumTrapFail, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoPulseCounter=npIoPulseCounter)
