...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:12:26 2021
...
ObjectIdentity, Integer32, NotificationType, IpAddress, enterprises, Counter64, Unsigned32, iso, ModuleIdentity, MibIdentifier, TimeTicks, Gauge32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress", "enterprises", "Counter64", "Unsigned32", "iso", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Gauge32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLineN=npIoTrapLineN, npGsmTraps=npGsmTraps, lightcom=lightcom, npTrapInfo=npTrapInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, FixedPoint1000=FixedPoint1000, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npCurLoopTrapR=npCurLoopTrapR, npSoftReboot=npSoftReboot, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npThermoTrapStatus=npThermoTrapStatus, npCurLoopN=npCurLoopN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npRelHumTrapData=npRelHumTrapData, npGsmTrap=npGsmTrap, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npGsmInfo=npGsmInfo, npThermoEntry=npThermoEntry, npIo=npIo, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npCurLoop=npCurLoop, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npThermoTraps=npThermoTraps, npRelayEntry=npRelayEntry, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npGsmFailed=npGsmFailed, npSmokeTable=npSmokeTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npReboot=npReboot, npIoMemo=npIoMemo, npThermoTable=npThermoTable, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapLow=npThermoTrapLow, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmoke=npSmoke, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npThermo=npThermo, npIrReset=npIrReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelayTable=npRelayTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokePower=npSmokePower, npRelayState=npRelayState, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoHigh=npThermoHigh, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npIr=npIr, npRelHumStatus=npRelHumStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npGsmStrength=npGsmStrength, npCurLoopTraps=npCurLoopTraps, npThermoMemo=npThermoMemo, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelayStartReset=npRelayStartReset)
