...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:29:39 2023
...
NotificationType, Counter32, Integer32, IpAddress, MibIdentifier, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, ModuleIdentity, ObjectIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTable=npThermoTable, npIoLevelOut=npIoLevelOut, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoStatus=npThermoStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, npThermoTrapLow=npThermoTrapLow, npGsmTraps=npGsmTraps, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npCurLoop=npCurLoop, npRelay=npRelay, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, FixedPoint1000=FixedPoint1000, npGsm=npGsm, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumMemo=npRelHumMemo, npThermoValue=npThermoValue, npIrStatus=npIrStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmStrength=npGsmStrength, npIoTrap=npIoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npIrPlayCmd=npIrPlayCmd, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npThermoLow=npThermoLow, npCurLoopEntry=npCurLoopEntry, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npRelayN=npRelayN, npIoTable=npIoTable, npRelayMode=npRelayMode, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokePower=npSmokePower, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npCurLoopR=npCurLoopR, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, lightcom=lightcom, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npIoEntry=npIoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, npIoLevelIn=npIoLevelIn, npForcedReboot=npForcedReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npSmokeReset=npSmokeReset, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapMemo=npIoTrapMemo, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npSmokeEntry=npSmokeEntry, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot)
