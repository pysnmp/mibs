...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:06:07 2024
...
NotificationType, Counter64, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ObjectIdentity, enterprises, Gauge32, IpAddress, MibIdentifier, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ObjectIdentity", "enterprises", "Gauge32", "IpAddress", "MibIdentifier", "Counter32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapPrefix=npThermoTrapPrefix, npResetStack=npResetStack, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapValue=npThermoTrapValue, npSmokeTable=npSmokeTable, npIoLevelIn=npIoLevelIn, lightcom=lightcom, npRelayTable=npRelayTable, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npCurLoopTable=npCurLoopTable, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmRegistration=npGsmRegistration, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npGsmStrength=npGsmStrength, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npRelHumN=npRelHumN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapLow=npThermoTrapLow, npThermoStatus=npThermoStatus, npIrStatus=npIrStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTraps=npGsmTraps, npIoEntry=npIoEntry, npSmokeMemo=npSmokeMemo, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npReboot=npReboot, npRelayEntry=npRelayEntry, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIr=npIr, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayStartReset=npRelayStartReset, npForcedReboot=npForcedReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSoftReboot=npSoftReboot, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npCurLoopTraps=npCurLoopTraps, npCurLoopN=npCurLoopN, npRelayMode=npRelayMode, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrap=npThermoTrap, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npIrPlayCmd=npIrPlayCmd, npIoTraps=npIoTraps, npSmokeStatus=npSmokeStatus, npRelHumTrapData=npRelHumTrapData, npCurLoopPower=npCurLoopPower, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npRelHumidity=npRelHumidity, npSmokePower=npSmokePower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npIoLineN=npIoLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsm=npGsm, npRelayState=npRelayState, npThermoTable=npThermoTable, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeReset=npSmokeReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npSmokeTraps=npSmokeTraps, npCurLoopTrapV=npCurLoopTrapV, npGsmTrap=npGsmTrap, npThermo=npThermo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npRelHumTable=npRelHumTable)
