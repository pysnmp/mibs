...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:23:28 2022
...
IpAddress, Bits, Counter64, NotificationType, MibIdentifier, ModuleIdentity, Integer32, ObjectIdentity, TimeTicks, iso, Unsigned32, enterprises, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Counter64", "NotificationType", "MibIdentifier", "ModuleIdentity", "Integer32", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "enterprises", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npCurLoopR=npCurLoopR, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrap=npSmokeTrap, npThermoTrapStatus=npThermoTrapStatus, npCurLoopStatus=npCurLoopStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npRelHumN=npRelHumN, npCurLoopTable=npCurLoopTable, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npIo=npIo, npIoTrapMemo=npIoTrapMemo, lightcom=lightcom, npGsmFailed=npGsmFailed, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npRelay=npRelay, npThermoEntry=npThermoEntry, npSmokeTraps=npSmokeTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermo=npThermo, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npRelayMode=npRelayMode, npSmokeStatus=npSmokeStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoLow=npThermoLow, npCurLoopTraps=npCurLoopTraps, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npRelayMemo=npRelayMemo, npIoTable=npIoTable, npGsmInfo=npGsmInfo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npGsmStrength=npGsmStrength, npRelayEntry=npRelayEntry, npIoTrap=npIoTrap, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npIoTraps=npIoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npCurLoopTrapI=npCurLoopTrapI, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoop=npCurLoop, npCurLoopV=npCurLoopV, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npResetStack=npResetStack, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npSmokeMemo=npSmokeMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrPlayCmd=npIrPlayCmd)
