...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:50:56 2023
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Gauge32, TimeTicks, MibIdentifier, Integer32, Bits, enterprises, NotificationType, Unsigned32, IpAddress, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Gauge32", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "enterprises", "NotificationType", "Unsigned32", "IpAddress", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapFail=npRelHumTrapFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npIrCtrl=npIrCtrl, npCurLoopTable=npCurLoopTable, npForcedReboot=npForcedReboot, npReboot=npReboot, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTrap=npGsmTrap, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapData=npRelHumTrapData, npIoLineN=npIoLineN, npThermoTraps=npThermoTraps, npRelayTable=npRelayTable, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npIr=npIr, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokePower=npSmokePower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npIrPlayCmd=npIrPlayCmd, npCurLoopN=npCurLoopN, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, FixedPoint1000=FixedPoint1000, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npSmokeSensorN=npSmokeSensorN, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npThermoValue=npThermoValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTable=npIoTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npSmoke=npSmoke, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelayStartReset=npRelayStartReset, npRelHumStatus=npRelHumStatus, npSmokeEntry=npSmokeEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelay=npRelay, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, npGsmStrength=npGsmStrength, npIrReset=npIrReset, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSoftReboot=npSoftReboot, npSmokeTraps=npSmokeTraps, npThermoHigh=npThermoHigh, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npGsmFailed=npGsmFailed, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, npRelHumEntry=npRelHumEntry, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npIrStatus=npIrStatus, npCurLoopI=npCurLoopI, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue)
