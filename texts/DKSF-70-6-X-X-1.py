...
# Produced by pysmi-1.1.12 at Mon Oct 28 02:12:56 2024
...
Counter32, TimeTicks, Counter64, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, Bits, enterprises, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Bits", "enterprises", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npGsmStrength=npGsmStrength, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, npIrStatus=npIrStatus, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npIoMemo=npIoMemo, npIr=npIr, npCurLoop=npCurLoop, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npReboot=npReboot, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, npIo=npIo, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTable=npCurLoopTable, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npGsmTrapPrefix=npGsmTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelIn=npIoLevelIn, npIoTraps=npIoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmoke=npSmoke, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npRelay=npRelay, npThermoValue=npThermoValue, npThermoTrap=npThermoTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npThermo=npThermo, npCurLoopI=npCurLoopI, npIoTable=npIoTable, npSmokeStatus=npSmokeStatus, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npCurLoopTraps=npCurLoopTraps, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npSmokeTrapStatus=npSmokeTrapStatus, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmInfo=npGsmInfo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npThermoTrapValue=npThermoTrapValue, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapData=npRelHumTrapData, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npGsmFailed=npGsmFailed)
