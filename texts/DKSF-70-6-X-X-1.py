...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:34:34 2023
...
Counter64, TimeTicks, iso, enterprises, IpAddress, NotificationType, MibIdentifier, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "iso", "enterprises", "IpAddress", "NotificationType", "MibIdentifier", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Gauge32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npIrCtrl=npIrCtrl, npThermoTable=npThermoTable, npRelHumMemo=npRelHumMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmFailed=npGsmFailed, npThermoTrapHigh=npThermoTrapHigh, npGsmStrength=npGsmStrength, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrap=npIoTrap, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npIr=npIr, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npGsmTraps=npGsmTraps, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npSmokePower=npSmokePower, npRelayTable=npRelayTable, npReboot=npReboot, npCurLoopTrapR=npCurLoopTrapR, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npCurLoopTable=npCurLoopTable, npRelayEntry=npRelayEntry, npRelHumEntry=npRelHumEntry, npCurLoopN=npCurLoopN, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapInfo=npTrapInfo, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, npCurLoop=npCurLoop, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataN=npRelHumTrapDataN, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTraps=npIoTraps, npThermoTrap=npThermoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoEntry=npIoEntry, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumValue=npRelHumValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npIrStatus=npIrStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npThermoStatus=npThermoStatus, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseStart=npIoSinglePulseStart, npIo=npIo, npGsm=npGsm, npCurLoopR=npCurLoopR, npCurLoopI=npCurLoopI, npGsmRegistration=npGsmRegistration, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npGsmInfo=npGsmInfo, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npThermoTrapMemo=npThermoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npThermoTraps=npThermoTraps)
