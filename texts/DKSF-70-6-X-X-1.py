...
# ASN.1 source DKSF-70-6-X-X-1
# Source digest sha256:454540dfe02c80f32f639e76afa02b816511e6b609c2286d792ecbcf2771ef9b
...
if mibBuilder.loadTexts: uniPingServerSolutionV3.setLastUpdated('2016-08-24 00:00')
...
npRelayTable = MibTable((1, 3, 6, 1, 4, 1, 25728, 5500, 5), ).setMaxAccess("notaccessible")
...
npRelayEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 5500, 5, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DKSF-70-6-X-X-1", "npRelayN"))
...
npThermoTable = MibTable((1, 3, 6, 1, 4, 1, 25728, 8800, 1), ).setMaxAccess("notaccessible")
...
npThermoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8800, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DKSF-70-6-X-X-1", "npThermoSensorN"))
...
npIoTable = MibTable((1, 3, 6, 1, 4, 1, 25728, 8900, 1), ).setMaxAccess("notaccessible")
...
npIoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8900, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DKSF-70-6-X-X-1", "npIoLineN"))
...
npCurLoopTable = MibTable((1, 3, 6, 1, 4, 1, 25728, 8300, 1), ).setMaxAccess("notaccessible")
...
npCurLoopEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8300, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DKSF-70-6-X-X-1", "npCurLoopN"))
...
npSmokeTable = MibTable((1, 3, 6, 1, 4, 1, 25728, 8200, 1), ).setMaxAccess("notaccessible")
...
npSmokeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8200, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DKSF-70-6-X-X-1", "npSmokeSensorN"))
...
npRelHumTable = MibTable((1, 3, 6, 1, 4, 1, 25728, 8400, 1), ).setMaxAccess("notaccessible")
...
npRelHumEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8400, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DKSF-70-6-X-X-1", "npRelHumN"))
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npCurLoop=npCurLoop, npCurLoopEntry=npCurLoopEntry, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, npCurLoopPower=npCurLoopPower, npCurLoopR=npCurLoopR, npCurLoopStatus=npCurLoopStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npForcedReboot=npForcedReboot, npGsm=npGsm, npGsmFailed=npGsmFailed, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmStrength=npGsmStrength, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npIo=npIo, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npIoTable=npIoTable, npIoTrap=npIoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npIoTrapMemo=npIoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npIoTraps=npIoTraps, npIr=npIr, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npIrReset=npIrReset, npIrStatus=npIrStatus, npReboot=npReboot, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npRelHumN=npRelHumN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npRelay=npRelay, npRelayEntry=npRelayEntry, npRelayMemo=npRelayMemo, npRelayMode=npRelayMode, npRelayN=npRelayN, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npRelayTable=npRelayTable, npResetStack=npResetStack, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTraps=npSmokeTraps, npSoftReboot=npSoftReboot, npThermo=npThermo, npThermoEntry=npThermoEntry, npThermoHigh=npThermoHigh, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapLow=npThermoTrapLow, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapValue=npThermoTrapValue, npThermoTraps=npThermoTraps, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, uniPingServerSolutionV3=uniPingServerSolutionV3)
