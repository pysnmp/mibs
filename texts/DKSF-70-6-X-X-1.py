...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:18:49 2023
...
ModuleIdentity, Counter32, Unsigned32, IpAddress, Integer32, NotificationType, MibIdentifier, ObjectIdentity, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "IpAddress", "Integer32", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeSensorN=npSmokeSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npCurLoop=npCurLoop, npThermoHigh=npThermoHigh, npRelayTable=npRelayTable, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npRelay=npRelay, npRelHumTrap=npRelHumTrap, lightcom=lightcom, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelayN=npRelayN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, npSmokeTrapStatus=npSmokeTrapStatus, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npSmokeTable=npSmokeTable, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npIoTable=npIoTable, npIoLineN=npIoLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npIoTrap=npIoTrap, npRelHumEntry=npRelHumEntry, npIrStatus=npIrStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npResetStack=npResetStack, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayState=npRelayState, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopV=npCurLoopV, npIoLevelIn=npIoLevelIn, npIrPlayCmd=npIrPlayCmd, npGsm=npGsm, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npRelHumN=npRelHumN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, npIoEntry=npIoEntry, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npSmoke=npSmoke, npIr=npIr, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapInfo=npTrapInfo, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npIoMemo=npIoMemo, npThermoSensorN=npThermoSensorN, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermo=npThermo, npThermoEntry=npThermoEntry, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, npSmokeStatus=npSmokeStatus)
