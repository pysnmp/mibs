...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:20:18 2023
...
NotificationType, MibIdentifier, iso, Integer32, ObjectIdentity, Counter64, TimeTicks, Counter32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "iso", "Integer32", "ObjectIdentity", "Counter64", "TimeTicks", "Counter32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npSmokeTable=npSmokeTable, npIr=npIr, npThermoLow=npThermoLow, npRelHumTempValue=npRelHumTempValue, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npThermoMemo=npThermoMemo, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npCurLoopV=npCurLoopV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npRelHumEntry=npRelHumEntry, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrap=npCurLoopTrap, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN, npCurLoopN=npCurLoopN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrap=npThermoTrap, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npIoTable=npIoTable, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npIoPulseCounter=npIoPulseCounter, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelOut=npIoLevelOut, npRelayState=npRelayState, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTraps=npCurLoopTraps, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npRelayN=npRelayN, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValue=npThermoValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelay=npRelay, npIoTraps=npIoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npResetStack=npResetStack, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix)
