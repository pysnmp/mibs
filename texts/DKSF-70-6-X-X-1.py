...
# Produced by pysmi-1.1.8 at Tue Jan 18 15:13:38 2022
...
Unsigned32, IpAddress, ObjectIdentity, iso, enterprises, Integer32, TimeTicks, NotificationType, Counter32, Counter64, ModuleIdentity, Bits, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ObjectIdentity", "iso", "enterprises", "Integer32", "TimeTicks", "NotificationType", "Counter32", "Counter64", "ModuleIdentity", "Bits", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npThermoSensorN=npThermoSensorN, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npResetStack=npResetStack, npRelHumTrap=npRelHumTrap, npThermoMemo=npThermoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermo=npThermo, npThermoValue=npThermoValue, npGsmTraps=npGsmTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npCurLoopTrapI=npCurLoopTrapI, npThermoTrap=npThermoTrap, npRelHumTempValue=npRelHumTempValue, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTable=npCurLoopTable, npRelHumTable=npRelHumTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTraps=npThermoTraps, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrap=npIoTrap, npSmokeStatus=npSmokeStatus, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapMemo=npIoTrapMemo, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npIoMemo=npIoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmInfo=npGsmInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrPlayCmd=npIrPlayCmd, npThermoTrapValue=npThermoTrapValue, npThermoEntry=npThermoEntry, npCurLoopEntry=npCurLoopEntry, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, npRelHumValue=npRelHumValue, npIoPulseCounter=npIoPulseCounter, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npIr=npIr, npSmokeTraps=npSmokeTraps, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npSmokeReset=npSmokeReset, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokePower=npSmokePower, npIoLevelIn=npIoLevelIn, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLineN=npIoTrapLineN, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIrCtrl=npIrCtrl, npRelayState=npRelayState, npCurLoop=npCurLoop, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrap=npGsmTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npSmoke=npSmoke, npThermoTrapHigh=npThermoTrapHigh, npIoTraps=npIoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npIrStatus=npIrStatus, npCurLoopTraps=npCurLoopTraps)
