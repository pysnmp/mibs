...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:26:59 2023
...
ObjectIdentity, iso, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Bits, Counter32, enterprises, NotificationType, Integer32, IpAddress, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Bits", "Counter32", "enterprises", "NotificationType", "Integer32", "IpAddress", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npThermoMemo=npThermoMemo, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npIoTrapLineN=npIoTrapLineN, npSmokeTrapStatus=npSmokeTrapStatus, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npRelayMode=npRelayMode, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npIrPlayCmd=npIrPlayCmd, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, FixedPoint1000=FixedPoint1000, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrCtrl=npIrCtrl, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npSmokeReset=npSmokeReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npIoEntry=npIoEntry, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npThermoTrapHigh=npThermoTrapHigh, npSoftReboot=npSoftReboot, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokeSensorN=npSmokeSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npIr=npIr, npThermoEntry=npThermoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npRelayStartReset=npRelayStartReset, npRelHumTempStatus=npRelHumTempStatus, npReboot=npReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npRelayMemo=npRelayMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npCurLoopStatus=npCurLoopStatus, npResetStack=npResetStack, npGsmStrength=npGsmStrength, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayTable=npRelayTable, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npSmoke=npSmoke, npThermoTrap=npThermoTrap, npThermo=npThermo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npRelayState=npRelayState, lightcom=lightcom, npRelay=npRelay, npRelayEntry=npRelayEntry, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTraps=npCurLoopTraps)
