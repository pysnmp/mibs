...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:24:34 2024
...
Counter32, NotificationType, ObjectIdentity, Counter64, MibIdentifier, IpAddress, TimeTicks, Unsigned32, ModuleIdentity, Integer32, iso, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "Counter64", "MibIdentifier", "IpAddress", "TimeTicks", "Unsigned32", "ModuleIdentity", "Integer32", "iso", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npThermoMemo=npThermoMemo, npRelHumN=npRelHumN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempStatus=npRelHumTempStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npGsmStrength=npGsmStrength, npCurLoopPower=npCurLoopPower, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npCurLoop=npCurLoop, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoSensorN=npThermoSensorN, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempValue=npRelHumTempValue, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npIoLineN=npIoLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumStatus=npRelHumStatus, npThermoEntry=npThermoEntry, npIrStatus=npIrStatus, npIr=npIr, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npIoLevelOut=npIoLevelOut, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npIrCtrl=npIrCtrl, npThermoTraps=npThermoTraps, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npRelayMemo=npRelayMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayState=npRelayState, npCurLoopTable=npCurLoopTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTraps=npIoTraps, npCurLoopR=npCurLoopR, npCurLoopTrapN=npCurLoopTrapN, npGsmFailed=npGsmFailed, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npSmokeTrapMemo=npSmokeTrapMemo, npThermo=npThermo, npThermoTable=npThermoTable, npSmokeMemo=npSmokeMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTraps=npCurLoopTraps, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npGsm=npGsm, npSmokeStatus=npSmokeStatus, npRelayMode=npRelayMode, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npReboot=npReboot, npThermoHigh=npThermoHigh, npRelHumValue=npRelHumValue, npSmokeReset=npSmokeReset, npGsmTrapPrefix=npGsmTrapPrefix, npIoEntry=npIoEntry, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoStatus=npThermoStatus, npTrapEmailTo=npTrapEmailTo, npIoPulseCounter=npIoPulseCounter, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npThermoValue=npThermoValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataN=npRelHumTrapDataN, FixedPoint1000=FixedPoint1000, npRelayTable=npRelayTable)
