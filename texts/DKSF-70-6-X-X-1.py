...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:33:20 2022
...
iso, MibIdentifier, NotificationType, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, Bits, IpAddress, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Bits", "IpAddress", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npRelHumValue=npRelHumValue, npIoTable=npIoTable, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npForcedReboot=npForcedReboot, npSmokeTable=npSmokeTable, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npSmokeReset=npSmokeReset, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTable=npRelHumTable, npThermoValuePrecise=npThermoValuePrecise, npGsmFailed=npGsmFailed, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npGsmStrength=npGsmStrength, npReboot=npReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTraps=npSmokeTraps, npGsmInfo=npGsmInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopV=npCurLoopV, npTrapEmailTo=npTrapEmailTo, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npThermoValue=npThermoValue, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npResetStack=npResetStack, npSmokeEntry=npSmokeEntry, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopEntry=npCurLoopEntry, npRelayStartReset=npRelayStartReset, npTrapInfo=npTrapInfo, npGsmTraps=npGsmTraps, npIoTrap=npIoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npRelayState=npRelayState, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLineN=npIoTrapLineN, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npGsmTrap=npGsmTrap, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, lightcom=lightcom, npSmoke=npSmoke, npCurLoopTrap=npCurLoopTrap, npRelHumEntry=npRelHumEntry, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopN=npCurLoopN, npThermo=npThermo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopR=npCurLoopR, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLineN=npIoLineN, npIo=npIo, npRelHumTrap=npRelHumTrap, npRelHumMemo=npRelHumMemo, npRelay=npRelay, npGsm=npGsm, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npRelayMode=npRelayMode, npRelHumN=npRelHumN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npCurLoopTraps=npCurLoopTraps, npIrStatus=npIrStatus, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend)
