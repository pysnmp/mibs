...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:07:17 2021
...
MibIdentifier, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, IpAddress, enterprises, TimeTicks, Gauge32, ObjectIdentity, Bits, ModuleIdentity, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "IpAddress", "enterprises", "TimeTicks", "Gauge32", "ObjectIdentity", "Bits", "ModuleIdentity", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npRelayMode=npRelayMode, npGsmInfo=npGsmInfo, npIr=npIr, npRelHumStatus=npRelHumStatus, npIoTraps=npIoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmoke=npSmoke, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npCurLoopI=npCurLoopI, npThermoHigh=npThermoHigh, npIrPlayCmd=npIrPlayCmd, npThermoValuePrecise=npThermoValuePrecise, npRelHumTable=npRelHumTable, npThermoLow=npThermoLow, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npRelayTable=npRelayTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapV=npCurLoopTrapV, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrCtrl=npIrCtrl, npCurLoopTrapI=npCurLoopTrapI, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmStrength=npGsmStrength, npIoTrapPrefix=npIoTrapPrefix, npSmokePower=npSmokePower, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayEntry=npRelayEntry, npSmokeReset=npSmokeReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npRelay=npRelay, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapLow=npThermoTrapLow, npIrReset=npIrReset, npIoTrap=npIoTrap, npIoTable=npIoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopV=npCurLoopV, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npSmokeMemo=npSmokeMemo, npThermoTrap=npThermoTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeEntry=npSmokeEntry, npSmokeTrap=npSmokeTrap, npRelayState=npRelayState, npCurLoop=npCurLoop, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npIoTrapLineN=npIoTrapLineN, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npRelayStartReset=npRelayStartReset, npIo=npIo, lightcom=lightcom, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npSmokeSensorN=npSmokeSensorN, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npIoLevelOut=npIoLevelOut, npCurLoopTraps=npCurLoopTraps, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh)
