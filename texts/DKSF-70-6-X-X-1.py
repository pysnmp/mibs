...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:59:21 2024
...
Unsigned32, MibIdentifier, ModuleIdentity, Gauge32, Integer32, TimeTicks, Bits, ObjectIdentity, IpAddress, Counter64, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Gauge32", "Integer32", "TimeTicks", "Bits", "ObjectIdentity", "IpAddress", "Counter64", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npSmokeTraps=npSmokeTraps, npIr=npIr, npRelayEntry=npRelayEntry, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npIo=npIo, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI, npSmokeTable=npSmokeTable, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTraps=npGsmTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npRelayStartReset=npRelayStartReset, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npCurLoopN=npCurLoopN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSoftReboot=npSoftReboot, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npIoLevelOut=npIoLevelOut, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTable=npCurLoopTable, npThermoTrap=npThermoTrap, npResetStack=npResetStack, npIoTraps=npIoTraps, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npCurLoopEntry=npCurLoopEntry, npThermoHigh=npThermoHigh, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopI=npCurLoopI, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npCurLoopR=npCurLoopR, npThermo=npThermo, lightcom=lightcom, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, npGsmStrength=npGsmStrength, npReboot=npReboot, npGsmInfo=npGsmInfo, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrap=npCurLoopTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npGsm=npGsm, npSmokeStatus=npSmokeStatus, npThermoTraps=npThermoTraps, npIoTrapLineN=npIoTrapLineN, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npThermoTrapMemo=npThermoTrapMemo)
