...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:36:42 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, TimeTicks, Integer32, Unsigned32, Counter32, ModuleIdentity, Counter64, Gauge32, NotificationType, IpAddress, ObjectIdentity, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "TimeTicks", "Integer32", "Unsigned32", "Counter32", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "IpAddress", "ObjectIdentity", "enterprises", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapMemo=npIoTrapMemo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, npThermoTable=npThermoTable, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapInfo=npTrapInfo, npThermoTrap=npThermoTrap, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npThermo=npThermo, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLineN=npIoTrapLineN, npTrapEmailTo=npTrapEmailTo, npIoLevelOut=npIoLevelOut, npIoLineN=npIoLineN, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelayStartReset=npRelayStartReset, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npCurLoopPower=npCurLoopPower, npRelHumTable=npRelHumTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeSensorN=npSmokeSensorN, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npIoTraps=npIoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSoftReboot=npSoftReboot, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npCurLoopN=npCurLoopN, npIrStatus=npIrStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmInfo=npGsmInfo, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapData=npRelHumTrapData, npRelHumTempStatus=npRelHumTempStatus, npRelHumidity=npRelHumidity, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npRelayState=npRelayState, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npIrReset=npIrReset, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npThermoTraps=npThermoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrPlayCmd=npIrPlayCmd, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoLow=npThermoLow, npThermoTrapValue=npThermoTrapValue, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npIr=npIr)
