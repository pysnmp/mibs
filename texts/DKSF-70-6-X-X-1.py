...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:17:55 2023
...
Integer32, NotificationType, TimeTicks, IpAddress, Gauge32, Counter64, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, enterprises, iso, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Gauge32", "Counter64", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "enterprises", "iso", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npIr=npIr, npReboot=npReboot, npSmokeReset=npSmokeReset, npThermoEntry=npThermoEntry, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npThermoLow=npThermoLow, npThermoTrapValue=npThermoTrapValue, npCurLoopN=npCurLoopN, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npThermoMemo=npThermoMemo, npIoLevelIn=npIoLevelIn, npIoTrapPrefix=npIoTrapPrefix, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npThermoTable=npThermoTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npSmokeTraps=npSmokeTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelIn=npIoTrapLevelIn, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npRelHumidity=npRelHumidity, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npIoEntry=npIoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npCurLoopStatus=npCurLoopStatus, npIoTrap=npIoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTable=npCurLoopTable, npThermoTraps=npThermoTraps, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npIo=npIo, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npIrReset=npIrReset, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npRelayMode=npRelayMode, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLineN=npIoLineN, npCurLoopTrapV=npCurLoopTrapV, npTrapInfo=npTrapInfo, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npRelHumEntry=npRelHumEntry, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npGsmFailed=npGsmFailed, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npForcedReboot=npForcedReboot, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN)
