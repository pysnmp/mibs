...
# Produced by pysmi-1.1.12 at Wed Jun 26 13:37:26 2024
...
Counter32, Gauge32, Counter64, Bits, Unsigned32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, enterprises, ModuleIdentity, IpAddress, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Counter64", "Bits", "Unsigned32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "enterprises", "ModuleIdentity", "IpAddress", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermo=npThermo, npThermoLow=npThermoLow, npIr=npIr, npIoTable=npIoTable, npCurLoopV=npCurLoopV, npGsmInfo=npGsmInfo, npIrCtrl=npIrCtrl, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayTable=npRelayTable, npGsm=npGsm, npCurLoopTable=npCurLoopTable, npIoTrapPrefix=npIoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npRelHumEntry=npRelHumEntry, npIoPulseCounter=npIoPulseCounter, npSmokeStatus=npSmokeStatus, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npRelayEntry=npRelayEntry, npRelayState=npRelayState, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, lightcom=lightcom, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npResetStack=npResetStack, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrap=npIoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npSmokeTable=npSmokeTable, npGsmTraps=npGsmTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTemp=npRelHumTrapTemp, npSoftReboot=npSoftReboot, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npThermoHigh=npThermoHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npTrapInfo=npTrapInfo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokePower=npSmokePower, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npIo=npIo, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe)
