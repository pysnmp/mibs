...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:09:54 2023
...
Gauge32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, TimeTicks, enterprises, ObjectIdentity, Counter64, Unsigned32, iso, Counter32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "TimeTicks", "enterprises", "ObjectIdentity", "Counter64", "Unsigned32", "iso", "Counter32", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npCurLoop=npCurLoop, npIrStatus=npIrStatus, npThermoEntry=npThermoEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoEntry=npIoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapV=npCurLoopTrapV, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npReboot=npReboot, npSmokePower=npSmokePower, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npRelayMemo=npRelayMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeSensorN=npSmokeSensorN, npGsmStrength=npGsmStrength, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npThermoLow=npThermoLow, npRelHumEntry=npRelHumEntry, npTrapInfo=npTrapInfo, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTraps=npCurLoopTraps, npRelHumStatus=npRelHumStatus, npIr=npIr, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumMemo=npRelHumMemo, npCurLoopN=npCurLoopN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayStartReset=npRelayStartReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumN=npRelHumN, npCurLoopStatus=npCurLoopStatus, npThermoValuePrecise=npThermoValuePrecise, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValue=npThermoValue, npIrReset=npIrReset, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npCurLoopPower=npCurLoopPower, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrap=npIoTrap, npThermoTable=npThermoTable, lightcom=lightcom, npIoTraps=npIoTraps, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration)
