...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:52:22 2022
...
IpAddress, enterprises, MibIdentifier, Counter64, Integer32, Gauge32, TimeTicks, Unsigned32, iso, Counter32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "MibIdentifier", "Counter64", "Integer32", "Gauge32", "TimeTicks", "Unsigned32", "iso", "Counter32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopI=npCurLoopI, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayN=npRelayN, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npIrReset=npIrReset, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsm=npGsm, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTraps=npIoTraps, npRelHumidity=npRelHumidity, npReboot=npReboot, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrap=npSmokeTrap, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npIr=npIr, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMemo=npRelayMemo, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelIn=npIoLevelIn, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayEntry=npRelayEntry, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, npSmokeSensorN=npSmokeSensorN, npIoTrapLineN=npIoTrapLineN, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapN=npCurLoopTrapN, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npThermoEntry=npThermoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npForcedReboot=npForcedReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npSmokeStatus=npSmokeStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npGsmStrength=npGsmStrength, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npIoLineN=npIoLineN, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npSoftReboot=npSoftReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapEmailTo=npTrapEmailTo, lightcom=lightcom, npTrapInfo=npTrapInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumN=npRelHumN, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIo=npIo, npCurLoopTrapPower=npCurLoopTrapPower, npIoPulseCounter=npIoPulseCounter, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTemp=npRelHumTrapTemp, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npResetStack=npResetStack, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npRelayTable=npRelayTable, npIrStatus=npIrStatus)
