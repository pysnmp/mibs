...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:25:55 2021
...
Unsigned32, IpAddress, ModuleIdentity, enterprises, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, MibIdentifier, Counter32, Gauge32, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "MibIdentifier", "Counter32", "Gauge32", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npSmokeStatus=npSmokeStatus, npSmokeTrapMemo=npSmokeTrapMemo, npGsm=npGsm, npSmoke=npSmoke, npThermoTrapStatus=npThermoTrapStatus, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLineN=npIoLineN, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npReboot=npReboot, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumValue=npRelHumValue, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npRelayN=npRelayN, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, npGsmFailed=npGsmFailed, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npTrapInfo=npTrapInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npIoLevelIn=npIoLevelIn, npSmokeSensorN=npSmokeSensorN, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npResetStack=npResetStack, npSmokeTrap=npSmokeTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, lightcom=lightcom, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopPower=npCurLoopPower, npRelHumTable=npRelHumTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npIr=npIr, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTable=npIoTable, npIoTraps=npIoTraps, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npCurLoopI=npCurLoopI, npIo=npIo, npThermoTrap=npThermoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npRelayStartReset=npRelayStartReset, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoop=npCurLoop, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npThermo=npThermo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npIoEntry=npIoEntry, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251)
