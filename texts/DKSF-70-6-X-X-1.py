...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:22:24 2022
...
NotificationType, ModuleIdentity, Counter32, enterprises, IpAddress, TimeTicks, Bits, MibIdentifier, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Counter32", "enterprises", "IpAddress", "TimeTicks", "Bits", "MibIdentifier", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npThermoStatus=npThermoStatus, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmoke=npSmoke, npRelayN=npRelayN, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTable=npCurLoopTable, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayState=npRelayState, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTable=npSmokeTable, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npCurLoopTrapN=npCurLoopTrapN, npReboot=npReboot, npCurLoopEntry=npCurLoopEntry, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npRelHumStatus=npRelHumStatus, npIoTraps=npIoTraps, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npResetStack=npResetStack, npThermo=npThermo, npThermoTrapStatus=npThermoTrapStatus, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npRelHumEntry=npRelHumEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npCurLoopN=npCurLoopN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTraps=npSmokeTraps, npRelay=npRelay, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npIo=npIo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npThermoLow=npThermoLow, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npSmokeTrapStatus=npSmokeTrapStatus, npThermoMemo=npThermoMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoSensorN=npThermoSensorN, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmFailed=npGsmFailed, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npCurLoopTrapV=npCurLoopTrapV, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapFail=npRelHumTrapFail)
