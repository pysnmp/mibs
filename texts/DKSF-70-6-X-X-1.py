...
# Produced by pysmi-1.1.10 at Thu Oct 26 12:34:32 2023
...
Gauge32, MibIdentifier, iso, Counter64, IpAddress, ModuleIdentity, enterprises, NotificationType, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "Counter64", "IpAddress", "ModuleIdentity", "enterprises", "NotificationType", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npCurLoopN=npCurLoopN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npResetStack=npResetStack, npIoTable=npIoTable, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrap=npGsmTrap, npIo=npIo, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumN=npRelHumN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoop=npCurLoop, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npRelHumStatus=npRelHumStatus, npSmokeStatus=npSmokeStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, lightcom=lightcom, npThermo=npThermo, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npIoLevelOut=npIoLevelOut, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelay=npRelay, npRelayN=npRelayN, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npReboot=npReboot, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapInfo=npTrapInfo, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npThermoValue=npThermoValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npCurLoopR=npCurLoopR, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npCurLoopEntry=npCurLoopEntry, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npThermoMemo=npThermoMemo, npRelHumTempStatus=npRelHumTempStatus, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN)
