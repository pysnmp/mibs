...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Gauge32, iso, ObjectIdentity, enterprises, Bits, NotificationType, Counter64, TimeTicks, MibIdentifier, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Gauge32", "iso", "ObjectIdentity", "enterprises", "Bits", "NotificationType", "Counter64", "TimeTicks", "MibIdentifier", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npSmokeTrapSensorN=npSmokeTrapSensorN, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumEntry=npRelHumEntry, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npThermoHigh=npThermoHigh, npIoTrapPrefix=npIoTrapPrefix, npRelayState=npRelayState, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npRelHumN=npRelHumN, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npCurLoopStatus=npCurLoopStatus, npIoPulseCounter=npIoPulseCounter, npGsmTraps=npGsmTraps, npSmokeTraps=npSmokeTraps, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, npRelHumStatus=npRelHumStatus, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npRelHumTempValue=npRelHumTempValue, npRelayStartReset=npRelayStartReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npThermoValuePrecise=npThermoValuePrecise, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrStatus=npIrStatus, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npThermo=npThermo, npRelayN=npRelayN, npRelayEntry=npRelayEntry, npIoEntry=npIoEntry, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npSmokeTrapStatus=npSmokeTrapStatus, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npSmokeEntry=npSmokeEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayTable=npRelayTable, npGsmRegistration=npGsmRegistration, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTable=npCurLoopTable, npIrReset=npIrReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopN=npCurLoopN, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrap=npThermoTrap, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIr=npIr, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npIo=npIo, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopV=npCurLoopV, npRelHumTrapDataStatus=npRelHumTrapDataStatus)
