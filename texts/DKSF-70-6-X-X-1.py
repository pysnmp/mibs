...
# Produced by pysmi-1.1.12 at Tue May 28 12:38:10 2024
...
Integer32, Counter32, ObjectIdentity, IpAddress, enterprises, iso, ModuleIdentity, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ObjectIdentity", "IpAddress", "enterprises", "iso", "ModuleIdentity", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Bits", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeStatus=npSmokeStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrap=npGsmTrap, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmFailed=npGsmFailed, npCurLoopTrapI=npCurLoopTrapI, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npForcedReboot=npForcedReboot, npIoTrapLineN=npIoTrapLineN, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npRelHumStatus=npRelHumStatus, npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap, npRelHumMemo=npRelHumMemo, npTrapInfo=npTrapInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npIo=npIo, npGsmStrength=npGsmStrength, npResetStack=npResetStack, npIoLineN=npIoLineN, npRelayMemo=npRelayMemo, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrReset=npIrReset, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npThermoTraps=npThermoTraps, npRelHumTrap=npRelHumTrap, npRelHumEntry=npRelHumEntry, npRelayStartReset=npRelayStartReset, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npRelayN=npRelayN, lightcom=lightcom, npIoMemo=npIoMemo, npIoPulseCounter=npIoPulseCounter, npSmokeEntry=npSmokeEntry, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTraps=npSmokeTraps, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelayMode=npRelayMode, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npCurLoopN=npCurLoopN, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopV=npCurLoopV, npThermoHigh=npThermoHigh, npGsm=npGsm, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npIrCtrl=npIrCtrl, npRelHumTrapFail=npRelHumTrapFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermo=npThermo, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoMemo=npThermoMemo, npCurLoopPower=npCurLoopPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopR=npCurLoopR, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npIoEntry=npIoEntry, npCurLoopTraps=npCurLoopTraps)
