...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:06:57 2024
...
ModuleIdentity, TimeTicks, Counter32, Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, ObjectIdentity, NotificationType, iso, Integer32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "ObjectIdentity", "NotificationType", "iso", "Integer32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, npIoLevelIn=npIoLevelIn, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTable=npRelHumTable, npGsm=npGsm, npRelayState=npRelayState, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npRelHumMemo=npRelHumMemo, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopR=npCurLoopR, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npRelHumValue=npRelHumValue, npRelayEntry=npRelayEntry, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npIr=npIr, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npCurLoopPower=npCurLoopPower, npCurLoopTrap=npCurLoopTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempValue=npRelHumTempValue, npCurLoopEntry=npCurLoopEntry, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, FixedPoint1000=FixedPoint1000, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapI=npCurLoopTrapI, lightcom=lightcom, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npResetStack=npResetStack, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTraps=npIoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapStatus=npSmokeTrapStatus, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npThermoTrap=npThermoTrap, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npSmokeTraps=npSmokeTraps, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumN=npRelHumN, npGsmFailed=npGsmFailed, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopV=npCurLoopV, npRelayN=npRelayN, npSmokeStatus=npSmokeStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus, npIrCtrl=npIrCtrl, npThermoLow=npThermoLow, npTrapInfo=npTrapInfo, npIoTrapMemo=npIoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npCurLoopI=npCurLoopI, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npGsmStrength=npGsmStrength, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap)
