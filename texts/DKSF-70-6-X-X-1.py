...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:03:02 2022
...
Bits, NotificationType, Counter64, ObjectIdentity, TimeTicks, Integer32, Gauge32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "TimeTicks", "Integer32", "Gauge32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "iso", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopEntry=npCurLoopEntry, npIoEntry=npIoEntry, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npIoTraps=npIoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapSafe=npRelHumTrapSafe, npThermoStatus=npThermoStatus, npRelayMode=npRelayMode, npIo=npIo, npRelayStartReset=npRelayStartReset, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumN=npRelHumN, npSmokeMemo=npSmokeMemo, npRelHumEntry=npRelHumEntry, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrap=npGsmTrap, npGsmStrength=npGsmStrength, npIoSinglePulseStart=npIoSinglePulseStart, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npGsm=npGsm, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npReboot=npReboot, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempValue=npRelHumTempValue, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrCtrl=npIrCtrl, npCurLoopStatus=npCurLoopStatus, npRelayState=npRelayState, npRelayMemo=npRelayMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npSmokePower=npSmokePower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapPrefix=npIoTrapPrefix, npIrStatus=npIrStatus, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npRelayN=npRelayN, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npThermoEntry=npThermoEntry, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npGsmRegistration=npGsmRegistration, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npSmokeTable=npSmokeTable, npIoTable=npIoTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npResetStack=npResetStack, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npIoTrapMemo=npIoTrapMemo, npRelHumTable=npRelHumTable, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoMemo=npThermoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapFail=npRelHumTrapFail, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeEntry=npSmokeEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe)
