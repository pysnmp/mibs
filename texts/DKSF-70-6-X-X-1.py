...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:03:24 2021
...
ModuleIdentity, Integer32, Bits, MibIdentifier, NotificationType, Unsigned32, TimeTicks, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Counter32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Bits", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Counter32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npSmokeMemo=npSmokeMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npCurLoopTraps=npCurLoopTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseStart=npIoSinglePulseStart, npSoftReboot=npSoftReboot, npIoPulseCounter=npIoPulseCounter, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npSmokePower=npSmokePower, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npSmokeEntry=npSmokeEntry, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npCurLoopTrapV=npCurLoopTrapV, npThermoTrap=npThermoTrap, npThermoTrapLow=npThermoTrapLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayEntry=npRelayEntry, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npRelay=npRelay, npIoLevelOut=npIoLevelOut, npRelHumTrapFail=npRelHumTrapFail, npThermoSensorN=npThermoSensorN, npRelHumN=npRelHumN, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npGsmRegistration=npGsmRegistration, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoEntry=npIoEntry, npReboot=npReboot, npSmokeStatus=npSmokeStatus, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npRelHumTempStatus=npRelHumTempStatus, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npResetStack=npResetStack, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npSmokeReset=npSmokeReset, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npRelayStartReset=npRelayStartReset, npIoMemo=npIoMemo, npIrReset=npIrReset, npCurLoopTrap=npCurLoopTrap, npIoLevelIn=npIoLevelIn, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, FixedPoint1000=FixedPoint1000, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npRelayState=npRelayState, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIo=npIo, npSmokeSensorN=npSmokeSensorN, npIr=npIr, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npCurLoopTrapR=npCurLoopTrapR, npTrapInfo=npTrapInfo)
