...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:38:49 2023
...
Unsigned32, enterprises, MibIdentifier, IpAddress, Bits, Gauge32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npIrStatus=npIrStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapValue=npThermoTrapValue, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npReboot=npReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopI=npCurLoopI, npRelHumTrapTemp=npRelHumTrapTemp, npIoLineN=npIoLineN, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumMemo=npRelHumMemo, npIr=npIr, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npCurLoopTrap=npCurLoopTrap, npIoMemo=npIoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIrCtrl=npIrCtrl, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npIo=npIo, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npThermo=npThermo, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopEntry=npCurLoopEntry, npCurLoopV=npCurLoopV, npIoTable=npIoTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npSmokeStatus=npSmokeStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npThermoValuePrecise=npThermoValuePrecise, lightcom=lightcom, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npSmokePower=npSmokePower, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npRelHumEntry=npRelHumEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npThermoHigh=npThermoHigh, npRelay=npRelay, npIoTrap=npIoTrap, npResetStack=npResetStack, npThermoLow=npThermoLow, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npSmoke=npSmoke, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumValue=npRelHumValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe)
