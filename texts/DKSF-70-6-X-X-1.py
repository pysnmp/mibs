...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:36:47 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Integer32, IpAddress, Bits, ObjectIdentity, enterprises, Gauge32, Unsigned32, ModuleIdentity, NotificationType, MibIdentifier, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Integer32", "IpAddress", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "Unsigned32", "ModuleIdentity", "NotificationType", "MibIdentifier", "Counter64", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempValue=npRelHumTempValue, npRelayTable=npRelayTable, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npIr=npIr, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npIoPulseCounter=npIoPulseCounter, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapHigh=npThermoTrapHigh, npSoftReboot=npSoftReboot, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, npCurLoopTrapN=npCurLoopTrapN, npRelayMemo=npRelayMemo, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrPlayCmd=npIrPlayCmd, npTrapInfo=npTrapInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumStatus=npRelHumStatus, npThermoTraps=npThermoTraps, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapData=npRelHumTrapData, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npCurLoop=npCurLoop, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTable=npRelHumTable, npRelayState=npRelayState, npThermoTable=npThermoTable, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npTrapEmailTo=npTrapEmailTo, npIoTable=npIoTable, npRelayStartReset=npRelayStartReset, npThermoTrapPrefix=npThermoTrapPrefix, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npRelHumN=npRelHumN, npRelHumTrap=npRelHumTrap, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempStatus=npRelHumTempStatus, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelOut=npIoLevelOut, npIrReset=npIrReset, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npRelayEntry=npRelayEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapSensorN=npThermoTrapSensorN, npThermoEntry=npThermoEntry, npGsmStrength=npGsmStrength, npRelayN=npRelayN, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrCtrl=npIrCtrl, npRelHumTrapAllChannels=npRelHumTrapAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN)
