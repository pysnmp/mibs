...
# Produced by pysmi-1.1.8 at Fri Dec  2 15:58:53 2022
...
Integer32, enterprises, Gauge32, Counter64, Unsigned32, NotificationType, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, ObjectIdentity, TimeTicks, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Gauge32", "Counter64", "Unsigned32", "NotificationType", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapValue=npThermoTrapValue, npThermo=npThermo, npRelHumTempStatus=npRelHumTempStatus, npIoTraps=npIoTraps, npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npIr=npIr, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelayTable=npRelayTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmStrength=npGsmStrength, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npRelHumValue=npRelHumValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npReboot=npReboot, npRelay=npRelay, npIoTrap=npIoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsm=npGsm, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIo=npIo, npThermoTable=npThermoTable, npThermoTrapLow=npThermoTrapLow, npThermoLow=npThermoLow, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npResetStack=npResetStack, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npCurLoopStatus=npCurLoopStatus, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npCurLoopI=npCurLoopI, npIoLevelIn=npIoLevelIn, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayN=npRelayN, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npIrReset=npIrReset, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npRelHumN=npRelHumN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoHigh=npThermoHigh, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayState=npRelayState, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeEntry=npSmokeEntry, npRelHumTrapDataN=npRelHumTrapDataN)
