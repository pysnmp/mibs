...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:24:53 2022
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Bits, Unsigned32, IpAddress, MibIdentifier, NotificationType, Integer32, Gauge32, Counter64, Counter32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Integer32", "Gauge32", "Counter64", "Counter32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrCtrl=npIrCtrl, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npCurLoopTrapR=npCurLoopTrapR, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npTrapEmailTo=npTrapEmailTo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npIoLevelOut=npIoLevelOut, npGsmInfo=npGsmInfo, npGsm=npGsm, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npThermo=npThermo, npSmokeStatus=npSmokeStatus, npThermoTrapLow=npThermoTrapLow, npCurLoopR=npCurLoopR, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMemo=npRelayMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumStatus=npRelHumStatus, npThermoTrap=npThermoTrap, npCurLoopTrapI=npCurLoopTrapI, npThermoValue=npThermoValue, npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npResetStack=npResetStack, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npIoMemo=npIoMemo, npGsmStrength=npGsmStrength, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npIrPlayCmd=npIrPlayCmd, npSmoke=npSmoke, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoStatus=npThermoStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoEntry=npThermoEntry, npIoTraps=npIoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrStatus=npIrStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npThermoLow=npThermoLow, npRelHumTrapDataN=npRelHumTrapDataN, npReboot=npReboot, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, uniPingServerSolutionV3=uniPingServerSolutionV3, npIr=npIr, FixedPoint1000=FixedPoint1000, npTrapInfo=npTrapInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npCurLoopTrapPower=npCurLoopTrapPower, npIoEntry=npIoEntry, npRelayN=npRelayN, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npCurLoopTrapV=npCurLoopTrapV, npCurLoopEntry=npCurLoopEntry, npThermoTraps=npThermoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npCurLoop=npCurLoop, npCurLoopPower=npCurLoopPower, npRelHumValue=npRelHumValue, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo)
