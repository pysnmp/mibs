...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:05:59 2021
...
MibIdentifier, Gauge32, Counter64, IpAddress, TimeTicks, ObjectIdentity, iso, Integer32, NotificationType, Bits, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Counter64", "IpAddress", "TimeTicks", "ObjectIdentity", "iso", "Integer32", "NotificationType", "Bits", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeMemo=npSmokeMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npRelHumTrapAllChannels=npRelHumTrapAllChannels, lightcom=lightcom, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTable=npThermoTable, npCurLoopStatus=npCurLoopStatus, npIr=npIr, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsm=npGsm, npCurLoopR=npCurLoopR, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTraps=npSmokeTraps, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npReboot=npReboot, npRelHumValue=npRelHumValue, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npResetStack=npResetStack, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npCurLoopTable=npCurLoopTable, npCurLoopTrap=npCurLoopTrap, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npIrStatus=npIrStatus, FixedPoint1000=FixedPoint1000, npRelayN=npRelayN, npCurLoopTrapPower=npCurLoopTrapPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npSmokeStatus=npSmokeStatus, npThermoSensorN=npThermoSensorN, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npIoTrap=npIoTrap, npTrapInfo=npTrapInfo, npRelayMemo=npRelayMemo, npRelayMode=npRelayMode, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npCurLoopTrapV=npCurLoopTrapV, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npRelayStartReset=npRelayStartReset, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTable=npSmokeTable, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeReset=npSmokeReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapMemo=npIoTrapMemo, npGsmTrap=npGsmTrap, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapI=npCurLoopTrapI, npThermo=npThermo, npRelHumTrapFail=npRelHumTrapFail, npGsmRegistration=npGsmRegistration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTable=npRelHumTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh)
