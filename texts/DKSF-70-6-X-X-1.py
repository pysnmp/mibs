...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:01:08 2021
...
Integer32, MibIdentifier, NotificationType, iso, ObjectIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Counter64, Gauge32, Unsigned32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "NotificationType", "iso", "ObjectIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Counter64", "Gauge32", "Unsigned32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npRelayMemo=npRelayMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumidity=npRelHumidity, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeMemo=npSmokeMemo, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrCtrl=npIrCtrl, npThermoValuePrecise=npThermoValuePrecise, npGsm=npGsm, npIr=npIr, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npSmokeEntry=npSmokeEntry, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npGsmInfo=npGsmInfo, npCurLoopN=npCurLoopN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapFail=npRelHumTrapFail, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeReset=npSmokeReset, FixedPoint1000=FixedPoint1000, npRelHumTrapDataN=npRelHumTrapDataN, npRelayTable=npRelayTable, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrap=npRelHumTrap, npThermoTrapValue=npThermoTrapValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npThermoTable=npThermoTable, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npRelHumStatus=npRelHumStatus, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, npThermo=npThermo, npCurLoopI=npCurLoopI, npCurLoopR=npCurLoopR, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npGsmTrap=npGsmTrap, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npIrReset=npIrReset, npGsmStrength=npGsmStrength, lightcom=lightcom, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npIoLineN=npIoLineN, npThermoTrapSensorN=npThermoTrapSensorN, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npIo=npIo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npForcedReboot=npForcedReboot, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npCurLoopTrap=npCurLoopTrap)
