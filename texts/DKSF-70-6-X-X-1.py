...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:26:13 2023
...
Gauge32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, iso, enterprises, Integer32, TimeTicks, Bits, ModuleIdentity, Counter64, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "iso", "enterprises", "Integer32", "TimeTicks", "Bits", "ModuleIdentity", "Counter64", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeReset=npSmokeReset, npThermoMemo=npThermoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLineN=npIoTrapLineN, npIrStatus=npIrStatus, npIr=npIr, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npRelay=npRelay, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrap=npIoTrap, npForcedReboot=npForcedReboot, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npThermoLow=npThermoLow, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npCurLoopEntry=npCurLoopEntry, npSmokeMemo=npSmokeMemo, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, lightcom=lightcom, npIoTable=npIoTable, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npGsmInfo=npGsmInfo, npRelayStartReset=npRelayStartReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMode=npRelayMode, npThermoTable=npThermoTable, npIoLevelIn=npIoLevelIn, npRelayState=npRelayState, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopV=npCurLoopV, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrap=npThermoTrap, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoStatus=npThermoStatus, npRelHumN=npRelHumN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumEntry=npRelHumEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npResetStack=npResetStack, npThermoTrapLow=npThermoTrapLow, npThermoEntry=npThermoEntry, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npIrCtrl=npIrCtrl, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapValue=npThermoTrapValue, npThermo=npThermo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npCurLoopN=npCurLoopN, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npCurLoopTrap=npCurLoopTrap, npIoPulseCounter=npIoPulseCounter)
