...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:09:37 2024
...
Gauge32, Integer32, enterprises, IpAddress, Bits, MibIdentifier, iso, TimeTicks, ObjectIdentity, Counter32, NotificationType, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "enterprises", "IpAddress", "Bits", "MibIdentifier", "iso", "TimeTicks", "ObjectIdentity", "Counter32", "NotificationType", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTraps=npSmokeTraps, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, FixedPoint1000=FixedPoint1000, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelIn=npIoLevelIn, npTrapInfo=npTrapInfo, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npCurLoopTrapR=npCurLoopTrapR, npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelay=npRelay, npForcedReboot=npForcedReboot, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npRelayEntry=npRelayEntry, npRelHumidity=npRelHumidity, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npSmokeTrap=npSmokeTrap, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npIoTable=npIoTable, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npThermoStatus=npThermoStatus, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npCurLoopI=npCurLoopI, npTrapEmailTo=npTrapEmailTo, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npReboot=npReboot, npIoMemo=npIoMemo, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmStrength=npGsmStrength, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIo=npIo, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npIoTrapMemo=npIoTrapMemo, npThermoTrap=npThermoTrap, npIoLevelOut=npIoLevelOut, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapStatus=npSmokeTrapStatus, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopEntry=npCurLoopEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npIoTraps=npIoTraps)
