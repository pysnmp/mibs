...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:14:06 2023
...
ObjectIdentity, Counter32, iso, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ModuleIdentity, Counter64, Integer32, NotificationType, enterprises, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "iso", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter64", "Integer32", "NotificationType", "enterprises", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrap=npRelHumTrap, npIoTable=npIoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npForcedReboot=npForcedReboot, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npGsmInfo=npGsmInfo, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npCurLoopR=npCurLoopR, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopN=npCurLoopN, npReboot=npReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumMemo=npRelHumMemo, npIoPulseCounter=npIoPulseCounter, npRelHumValue=npRelHumValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npIoLevelIn=npIoLevelIn, npSmokeMemo=npSmokeMemo, npThermoTrapPrefix=npThermoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npCurLoopPower=npCurLoopPower, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npCurLoopTrapPower=npCurLoopTrapPower, npIoMemo=npIoMemo, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npRelHumTrapDataMemo=npRelHumTrapDataMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTable=npRelHumTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, npThermoTraps=npThermoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npThermoTable=npThermoTable, npIo=npIo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, npSmoke=npSmoke, npIoLineN=npIoLineN, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrap=npSmokeTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npThermoMemo=npThermoMemo, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npSmokeTable=npSmokeTable, npRelayEntry=npRelayEntry, npRelayN=npRelayN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempValue=npRelHumTempValue, npIoEntry=npIoEntry, npGsmStrength=npGsmStrength, npSmokeTrapStatus=npSmokeTrapStatus, npIrReset=npIrReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopI=npCurLoopI, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npRelHumTrapFail=npRelHumTrapFail, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npGsm=npGsm, npRelayTable=npRelayTable, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npThermoStatus=npThermoStatus)
