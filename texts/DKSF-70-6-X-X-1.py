...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:21:32 2023
...
Integer32, enterprises, Counter32, NotificationType, Unsigned32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, IpAddress, ObjectIdentity, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Counter32", "NotificationType", "Unsigned32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "IpAddress", "ObjectIdentity", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumEntry=npRelHumEntry, npThermoTable=npThermoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npThermoEntry=npThermoEntry, npCurLoop=npCurLoop, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npSmokeTable=npSmokeTable, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTraps=npGsmTraps, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npThermoMemo=npThermoMemo, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npReboot=npReboot, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapEmailTo=npTrapEmailTo, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelayTable=npRelayTable, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix, npRelayN=npRelayN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npThermo=npThermo, npGsm=npGsm, npRelayStartReset=npRelayStartReset, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npThermoValue=npThermoValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrStatus=npIrStatus, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npRelHumTrapData=npRelHumTrapData, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumMemo=npRelHumMemo, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmInfo=npGsmInfo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npIoEntry=npIoEntry, npSmokeStatus=npSmokeStatus, npTrapInfo=npTrapInfo, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapI=npCurLoopTrapI, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npGsmStrength=npGsmStrength, lightcom=lightcom, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npIo=npIo, npSmokeMemo=npSmokeMemo, npSoftReboot=npSoftReboot, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry)
