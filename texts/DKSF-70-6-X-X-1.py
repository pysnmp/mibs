...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:12:41 2022
...
iso, TimeTicks, Counter64, Integer32, ObjectIdentity, MibIdentifier, Bits, Unsigned32, NotificationType, IpAddress, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSoftReboot=npSoftReboot, npCurLoopTable=npCurLoopTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLineN=npIoLineN, npThermoTrap=npThermoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npThermoSensorN=npThermoSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, npIoSinglePulseStart=npIoSinglePulseStart, npIoPulseCounter=npIoPulseCounter, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npTrapInfo=npTrapInfo, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npGsmRegistration=npGsmRegistration, npSmokeTable=npSmokeTable, npRelHumValue=npRelHumValue, npThermoEntry=npThermoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npIoTrap=npIoTrap, npIoMemo=npIoMemo, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, lightcom=lightcom, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npSmokeStatus=npSmokeStatus, npCurLoopR=npCurLoopR, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npResetStack=npResetStack, npIr=npIr, npRelay=npRelay, npCurLoopI=npCurLoopI, npIo=npIo, npIoTable=npIoTable, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapHigh=npThermoTrapHigh, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTraps=npIoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoEntry=npIoEntry, npCurLoopTrap=npCurLoopTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, npForcedReboot=npForcedReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npRelayTable=npRelayTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoStatus=npThermoStatus, npReboot=npReboot, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npThermoTable=npThermoTable, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npRelHumTable=npRelHumTable, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapLow=npThermoTrapLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npIrReset=npIrReset, npSmokeEntry=npSmokeEntry)
