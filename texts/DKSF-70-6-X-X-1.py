...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:34:42 2022
...
TimeTicks, NotificationType, ModuleIdentity, Counter64, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, enterprises, Counter32, Unsigned32, Gauge32, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter64", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "enterprises", "Counter32", "Unsigned32", "Gauge32", "Bits", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npReboot=npReboot, npThermoLow=npThermoLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrap=npIoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTraps=npIoTraps, npIo=npIo, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npRelayN=npRelayN, npSmokeReset=npSmokeReset, npTrapEmailTo=npTrapEmailTo, npGsmFailed=npGsmFailed, npSmokeTrap=npSmokeTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopN=npCurLoopN, npGsmRegistration=npGsmRegistration, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumStatus=npRelHumStatus, npRelHumN=npRelHumN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoMemo=npThermoMemo, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npGsm=npGsm, npGsmTrap=npGsmTrap, npSmokeTable=npSmokeTable, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopPower=npCurLoopPower, npIoSinglePulseStart=npIoSinglePulseStart, npRelay=npRelay, npIoLevelOut=npIoLevelOut, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, lightcom=lightcom, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npSoftReboot=npSoftReboot, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npThermoTrapMemo=npThermoTrapMemo, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, FixedPoint1000=FixedPoint1000, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeEntry=npSmokeEntry, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npThermoHigh=npThermoHigh, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npIoEntry=npIoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokePower=npSmokePower, npThermoSensorN=npThermoSensorN, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npCurLoopTraps=npCurLoopTraps, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npIoTrapLineN=npIoTrapLineN, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow)
