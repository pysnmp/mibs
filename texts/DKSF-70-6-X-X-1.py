...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:18:30 2021
...
Unsigned32, Bits, IpAddress, ModuleIdentity, Counter64, iso, Integer32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, enterprises, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "ModuleIdentity", "Counter64", "iso", "Integer32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "enterprises", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npGsmStrength=npGsmStrength, npCurLoopI=npCurLoopI, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIo=npIo, npSmokePower=npSmokePower, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrReset=npIrReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, npIrStatus=npIrStatus, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npSmokeSensorN=npSmokeSensorN, npCurLoopV=npCurLoopV, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npRelHumN=npRelHumN, npSmokeReset=npSmokeReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayN=npRelayN, npGsm=npGsm, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npReboot=npReboot, npResetStack=npResetStack, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npCurLoop=npCurLoop, npThermoTraps=npThermoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, lightcom=lightcom, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapSafe=npRelHumTrapSafe, npThermoHigh=npThermoHigh, npSmoke=npSmoke, npRelayState=npRelayState, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmInfo=npGsmInfo, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npGsmTraps=npGsmTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTable=npThermoTable, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrap=npGsmTrap, npRelHumValue=npRelHumValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrCtrl=npIrCtrl, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopN=npCurLoopN, npTrapInfo=npTrapInfo, npThermoValue=npThermoValue, npIoLineN=npIoLineN, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npRelHumEntry=npRelHumEntry, npRelayEntry=npRelayEntry, npThermoStatus=npThermoStatus, npThermo=npThermo, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopPower=npCurLoopPower)
