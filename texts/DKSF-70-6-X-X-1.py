...
# Produced by pysmi-1.1.12 at Thu May 30 02:19:24 2024
...
IpAddress, Counter32, Gauge32, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, NotificationType, TimeTicks, Bits, Counter64, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "NotificationType", "TimeTicks", "Bits", "Counter64", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npRelayN=npRelayN, npGsmStrength=npGsmStrength, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopN=npCurLoopN, npCurLoopR=npCurLoopR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrPlayCmd=npIrPlayCmd, npIoMemo=npIoMemo, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoPulseCounter=npIoPulseCounter, npResetStack=npResetStack, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npGsm=npGsm, npSmokeReset=npSmokeReset, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npGsmRegistration=npGsmRegistration, npRelayTable=npRelayTable, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npGsmFailed=npGsmFailed, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrap=npThermoTrap, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npRelHumTrap=npRelHumTrap, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapEmailTo=npTrapEmailTo, npGsmTrap=npGsmTrap, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIr=npIr, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npRelHumTrapData=npRelHumTrapData, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npIrCtrl=npIrCtrl, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npGsmInfo=npGsmInfo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIo=npIo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoSensorN=npThermoSensorN, npSmokeTraps=npSmokeTraps, npSmokeMemo=npSmokeMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapN=npCurLoopTrapN, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npCurLoopTraps=npCurLoopTraps, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry)
