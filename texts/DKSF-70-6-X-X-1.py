...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:35:19 2022
...
Integer32, MibIdentifier, TimeTicks, iso, Counter64, Bits, Unsigned32, enterprises, ModuleIdentity, NotificationType, ObjectIdentity, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "TimeTicks", "iso", "Counter64", "Bits", "Unsigned32", "enterprises", "ModuleIdentity", "NotificationType", "ObjectIdentity", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTable=npCurLoopTable, npIo=npIo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npIoTraps=npIoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npSmokeStatus=npSmokeStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npThermo=npThermo, npThermoStatus=npThermoStatus, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelIn=npIoLevelIn, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npRelHumidity=npRelHumidity, npRelayStartReset=npRelayStartReset, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrap=npSmokeTrap, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npSmokeTable=npSmokeTable, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, npRelHumN=npRelHumN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrap=npRelHumTrap, npSmokeEntry=npSmokeEntry, npThermoValuePrecise=npThermoValuePrecise, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmFailed=npGsmFailed, npIoMemo=npIoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npForcedReboot=npForcedReboot, npThermoTraps=npThermoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumEntry=npRelHumEntry, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrap=npIoTrap, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumValue=npRelHumValue, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npIoTrapMemo=npIoTrapMemo, npThermoTable=npThermoTable, npTrapEmailTo=npTrapEmailTo, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npSmokeReset=npSmokeReset, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumMemo=npRelHumMemo, npSmoke=npSmoke, npThermoLow=npThermoLow, npTrapInfo=npTrapInfo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopN=npCurLoopN, npSmokeSensorN=npSmokeSensorN, npRelayMode=npRelayMode, npThermoTrapMemo=npThermoTrapMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npReboot=npReboot, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLineN=npIoLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayTable=npRelayTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoPulseCounter=npIoPulseCounter, npIr=npIr, npIrCtrl=npIrCtrl, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix)
