...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:05:21 2024
...
Integer32, Bits, ObjectIdentity, NotificationType, IpAddress, TimeTicks, iso, MibIdentifier, Gauge32, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "iso", "MibIdentifier", "Gauge32", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npCurLoopTrapR=npCurLoopTrapR, npForcedReboot=npForcedReboot, npIoTrapLineN=npIoTrapLineN, npRelayN=npRelayN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npIrReset=npIrReset, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, lightcom=lightcom, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npGsmStrength=npGsmStrength, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npTrapEmailTo=npTrapEmailTo, npSoftReboot=npSoftReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeMemo=npSmokeMemo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npCurLoopV=npCurLoopV, npThermo=npThermo, npGsmRegistration=npGsmRegistration, npThermoTrapStatus=npThermoTrapStatus, npSmokeEntry=npSmokeEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelayState=npRelayState, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npReboot=npReboot, npRelayTable=npRelayTable, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npCurLoopPower=npCurLoopPower, npRelHumTable=npRelHumTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npThermoTrapValue=npThermoTrapValue, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapV=npCurLoopTrapV, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npRelHumStatus=npRelHumStatus, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopI=npCurLoopI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrap=npSmokeTrap, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npThermoStatus=npThermoStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataN=npRelHumTrapDataN, npIoEntry=npIoEntry, npResetStack=npResetStack, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower)
