...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:45:28 2023
...
NotificationType, TimeTicks, IpAddress, MibIdentifier, enterprises, Gauge32, Counter32, ModuleIdentity, iso, Bits, ObjectIdentity, Counter64, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "Counter32", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npRelayStartReset=npRelayStartReset, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayState=npRelayState, npThermoTrapValue=npThermoTrapValue, npRelHumN=npRelHumN, npIoPulseCounter=npIoPulseCounter, npSmokeTable=npSmokeTable, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npRelHumMemo=npRelHumMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopV=npCurLoopV, npRelay=npRelay, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoStatus=npThermoStatus, npIrCtrl=npIrCtrl, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapLow=npThermoTrapLow, npSmokeEntry=npSmokeEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopEntry=npCurLoopEntry, npCurLoopR=npCurLoopR, npReboot=npReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, npThermoMemo=npThermoMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapSafe=npRelHumTrapSafe, FixedPoint1000=FixedPoint1000, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, npIoTable=npIoTable, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmoke=npSmoke, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, npRelayTable=npRelayTable, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npTrapInfo=npTrapInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, lightcom=lightcom, npIoSinglePulseStart=npIoSinglePulseStart, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npIrReset=npIrReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapData=npRelHumTrapData, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoMemo=npIoMemo, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npIoTrapLevelIn=npIoTrapLevelIn, npIo=npIo, npSmokeReset=npSmokeReset, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npThermoTrapHigh=npThermoTrapHigh, npCurLoop=npCurLoop, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npThermo=npThermo, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix)
