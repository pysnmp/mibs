...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:03:53 2022
...
Counter32, Gauge32, MibIdentifier, Counter64, TimeTicks, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, ObjectIdentity, IpAddress, iso, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "Counter64", "TimeTicks", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "ObjectIdentity", "IpAddress", "iso", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempValue=npRelHumTempValue, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npIoMemo=npIoMemo, npRelayN=npRelayN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumidity=npRelHumidity, npThermoMemo=npThermoMemo, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopPower=npCurLoopPower, npIrReset=npIrReset, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeStatus=npSmokeStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npRelayStartReset=npRelayStartReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npSmokeMemo=npSmokeMemo, npRelHumEntry=npRelHumEntry, npRelHumStatus=npRelHumStatus, npGsmInfo=npGsmInfo, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npIoLevelOut=npIoLevelOut, npIoLineN=npIoLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTraps=npThermoTraps, npSmokeReset=npSmokeReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npResetStack=npResetStack, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npCurLoopI=npCurLoopI, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npRelHumTable=npRelHumTable, npGsmStrength=npGsmStrength, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsm=npGsm, npSoftReboot=npSoftReboot, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopV=npCurLoopV, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npIrPlayCmd=npIrPlayCmd, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npSmokeTable=npSmokeTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npIr=npIr, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayState=npRelayState, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoHigh=npThermoHigh, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npRelayEntry=npRelayEntry, npSmoke=npSmoke, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npCurLoopN=npCurLoopN, npCurLoop=npCurLoop, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelay=npRelay, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed)
