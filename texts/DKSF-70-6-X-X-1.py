...
IpAddress, iso, MibIdentifier, Bits, Counter64, enterprises, NotificationType, ObjectIdentity, Unsigned32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "MibIdentifier", "Bits", "Counter64", "enterprises", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npIoMemo=npIoMemo, npGsm=npGsm, npRelHumStatus=npRelHumStatus, FixedPoint1000=FixedPoint1000, npThermoTable=npThermoTable, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npRelHumMemo=npRelHumMemo, npCurLoopTrap=npCurLoopTrap, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npSmokePower=npSmokePower, npTrapEmailTo=npTrapEmailTo, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npRelHumValue=npRelHumValue, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npGsmInfo=npGsmInfo, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npCurLoopV=npCurLoopV, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumEntry=npRelHumEntry, npIoTraps=npIoTraps, npThermoEntry=npThermoEntry, npResetStack=npResetStack, npRelayTable=npRelayTable, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmFailed=npGsmFailed, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTraps=npThermoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npSmokeMemo=npSmokeMemo, npRelayState=npRelayState, npIoLineN=npIoLineN, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npIoTrapLineN=npIoTrapLineN, npThermoHigh=npThermoHigh, npIr=npIr, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npThermoValue=npThermoValue, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermo=npThermo, npRelHumN=npRelHumN, npRelHumTrap=npRelHumTrap, npCurLoopN=npCurLoopN, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npRelay=npRelay, npRelayN=npRelayN, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMemo=npRelayMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseDuration=npIoSinglePulseDuration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npGsmStrength=npGsmStrength, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop)
