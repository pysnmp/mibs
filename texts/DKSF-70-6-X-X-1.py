...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:19:03 2023
...
NotificationType, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Bits, IpAddress, MibIdentifier, ObjectIdentity, Unsigned32, Counter32, enterprises, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Counter32", "enterprises", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrap=npCurLoopTrap, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumEntry=npRelHumEntry, npTrapInfo=npTrapInfo, npIoSinglePulseStart=npIoSinglePulseStart, npRelayN=npRelayN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, npSmokePower=npSmokePower, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npIoTrap=npIoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npGsmInfo=npGsmInfo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSoftReboot=npSoftReboot, npCurLoopN=npCurLoopN, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npGsmFailed=npGsmFailed, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npIo=npIo, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npThermoStatus=npThermoStatus, npSmokeReset=npSmokeReset, npGsmTrap=npGsmTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempValue=npRelHumTempValue, npSmokeTrapStatus=npSmokeTrapStatus, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npIoTrapMemo=npIoTrapMemo, npThermoHigh=npThermoHigh, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npCurLoopTable=npCurLoopTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npGsmTraps=npGsmTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npIoEntry=npIoEntry, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npThermoMemo=npThermoMemo, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapLow=npThermoTrapLow, npRelayStartReset=npRelayStartReset, npSmoke=npSmoke, lightcom=lightcom, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npRelHumValue=npRelHumValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npRelayTable=npRelayTable, npResetStack=npResetStack, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npSmokeEntry=npSmokeEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelOut=npIoLevelOut, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay)
