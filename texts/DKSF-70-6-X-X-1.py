...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:31:14 2023
...
ModuleIdentity, iso, MibIdentifier, Bits, TimeTicks, enterprises, Counter64, NotificationType, Unsigned32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "Bits", "TimeTicks", "enterprises", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSoftReboot=npSoftReboot, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrap=npIoTrap, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npSmokeReset=npSmokeReset, npCurLoopTraps=npCurLoopTraps, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokePower=npSmokePower, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npSmokeMemo=npSmokeMemo, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npCurLoopTrapPower=npCurLoopTrapPower, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npThermoTrapValue=npThermoTrapValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopEntry=npCurLoopEntry, npGsm=npGsm, npRelHumValue=npRelHumValue, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npGsmRegistration=npGsmRegistration, npRelHumStatus=npRelHumStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npGsmTrap=npGsmTrap, npCurLoopTable=npCurLoopTable, npIoTable=npIoTable, npThermoTable=npThermoTable, npIoTrapPrefix=npIoTrapPrefix, npTrapInfo=npTrapInfo, npRelayState=npRelayState, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npForcedReboot=npForcedReboot, npSmokeTraps=npSmokeTraps, npCurLoopPower=npCurLoopPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npCurLoopI=npCurLoopI, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npGsmInfo=npGsmInfo, npIrCtrl=npIrCtrl, npRelHumTrapData=npRelHumTrapData, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumidity=npRelHumidity, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIr=npIr, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npIrStatus=npIrStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrap=npThermoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, lightcom=lightcom, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMode=npRelayMode, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npIoTrapMemo=npIoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoop=npCurLoop)
