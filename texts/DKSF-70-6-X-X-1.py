...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:12:46 2023
...
ModuleIdentity, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter64, IpAddress, iso, ObjectIdentity, Unsigned32, TimeTicks, MibIdentifier, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter64", "IpAddress", "iso", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npThermoLow=npThermoLow, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoEntry=npThermoEntry, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npCurLoopTraps=npCurLoopTraps, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npThermoSensorN=npThermoSensorN, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapN=npCurLoopTrapN, npThermoTable=npThermoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumStatus=npRelHumStatus, npRelayTable=npRelayTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermo=npThermo, npRelHumidity=npRelHumidity, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npThermoTraps=npThermoTraps, npThermoValue=npThermoValue, npGsmFailed=npGsmFailed, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npRelHumEntry=npRelHumEntry, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeReset=npSmokeReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrPlayCmd=npIrPlayCmd, npIo=npIo, npRelHumTable=npRelHumTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapFail=npRelHumTrapFail, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npIoTrap=npIoTrap, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npTrapInfo=npTrapInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npIrReset=npIrReset, npSmokeTraps=npSmokeTraps, npGsmInfo=npGsmInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npTrapEmailTo=npTrapEmailTo, npThermoStatus=npThermoStatus, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npThermoTrapValue=npThermoTrapValue, npThermoHigh=npThermoHigh, npRelHumN=npRelHumN, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopR=npCurLoopR, npIrStatus=npIrStatus, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo)
