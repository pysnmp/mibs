...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:32:18 2024
...
Counter32, Bits, ObjectIdentity, IpAddress, Gauge32, Counter64, NotificationType, ModuleIdentity, enterprises, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ObjectIdentity", "IpAddress", "Gauge32", "Counter64", "NotificationType", "ModuleIdentity", "enterprises", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeEntry=npSmokeEntry, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npIrCtrl=npIrCtrl, npSmokeReset=npSmokeReset, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTraps=npThermoTraps, npIr=npIr, npThermoLow=npThermoLow, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapN=npCurLoopTrapN, npCurLoopPower=npCurLoopPower, npSmokeTrapMemo=npSmokeTrapMemo, npReboot=npReboot, npRelayState=npRelayState, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npTrapEmailTo=npTrapEmailTo, npCurLoop=npCurLoop, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, npRelayN=npRelayN, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumStatus=npRelHumStatus, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry, npRelHumTrapData=npRelHumTrapData, npThermoEntry=npThermoEntry, npSoftReboot=npSoftReboot, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTable=npSmokeTable, npRelayTable=npRelayTable, npGsmInfo=npGsmInfo, npCurLoopTable=npCurLoopTable, npIoTrap=npIoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npSmokeTrap=npSmokeTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, npRelHumTable=npRelHumTable, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npCurLoopI=npCurLoopI, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapSafe=npRelHumTrapSafe, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTraps=npIoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npRelHumTempValue=npRelHumTempValue, npThermoTrapValue=npThermoTrapValue, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, lightcom=lightcom, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapHigh=npThermoTrapHigh)
