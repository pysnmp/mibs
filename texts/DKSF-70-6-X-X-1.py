...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:11:19 2024
...
Counter64, iso, TimeTicks, ObjectIdentity, MibIdentifier, enterprises, Unsigned32, Counter32, IpAddress, NotificationType, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "TimeTicks", "ObjectIdentity", "MibIdentifier", "enterprises", "Unsigned32", "Counter32", "IpAddress", "NotificationType", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumEntry=npRelHumEntry, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npRelayState=npRelayState, npIrCtrl=npIrCtrl, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npThermoTrap=npThermoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npThermoMemo=npThermoMemo, npIoLevelIn=npIoLevelIn, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTable=npRelHumTable, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npCurLoopTable=npCurLoopTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npTrapEmailTo=npTrapEmailTo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoHigh=npThermoHigh, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npResetStack=npResetStack, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npGsmStrength=npGsmStrength, npRelayTable=npRelayTable, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTable=npThermoTable, npSmokePower=npSmokePower, npIoTraps=npIoTraps, npThermo=npThermo, npRelayStartReset=npRelayStartReset, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npIoEntry=npIoEntry, npThermoTrapHigh=npThermoTrapHigh, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIo=npIo, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npRelHumStatus=npRelHumStatus, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelay=npRelay, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npGsm=npGsm, npThermoValue=npThermoValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumValue=npRelHumValue, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npReboot=npReboot, npThermoTraps=npThermoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopV=npCurLoopV, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npIoTrapLineN=npIoTrapLineN, npGsmTrapPrefix=npGsmTrapPrefix, npTrapInfo=npTrapInfo, npGsmTraps=npGsmTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLineN=npIoLineN, npCurLoopTrapN=npCurLoopTrapN, npRelayEntry=npRelayEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmoke=npSmoke, npThermoTrapValue=npThermoTrapValue)
