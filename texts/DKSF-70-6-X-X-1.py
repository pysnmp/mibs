...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:23:36 2023
...
Unsigned32, ObjectIdentity, Gauge32, Integer32, Counter64, Counter32, iso, IpAddress, MibIdentifier, ModuleIdentity, enterprises, Bits, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Gauge32", "Integer32", "Counter64", "Counter32", "iso", "IpAddress", "MibIdentifier", "ModuleIdentity", "enterprises", "Bits", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMemo=npRelayMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npRelay=npRelay, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npThermoHigh=npThermoHigh, npRelayTable=npRelayTable, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npRelayEntry=npRelayEntry, npSmoke=npSmoke, npRelayStartReset=npRelayStartReset, npIrCtrl=npIrCtrl, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npSmokeTraps=npSmokeTraps, npThermoLow=npThermoLow, npIo=npIo, npRelHumTempValue=npRelHumTempValue, lightcom=lightcom, npRelayState=npRelayState, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npSoftReboot=npSoftReboot, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npThermoTraps=npThermoTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeReset=npSmokeReset, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumN=npRelHumN, npSmokeEntry=npSmokeEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValuePrecise=npThermoValuePrecise, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npGsm=npGsm, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npIr=npIr, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npIoTraps=npIoTraps, npIoTrap=npIoTrap, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopR=npCurLoopR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npReboot=npReboot, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npTrapInfo=npTrapInfo, npTrapEmailTo=npTrapEmailTo, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelayN=npRelayN, npCurLoopV=npCurLoopV, npCurLoopTraps=npCurLoopTraps, npGsmStrength=npGsmStrength, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelOut=npIoLevelOut, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrReset=npIrReset, npThermoSensorN=npThermoSensorN, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npResetStack=npResetStack, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npSmokeTrapSensorN=npSmokeTrapSensorN)
