...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:52:14 2022
...
NotificationType, Gauge32, Counter64, ObjectIdentity, IpAddress, MibIdentifier, Integer32, Bits, TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrStatus=npIrStatus, npGsmStrength=npGsmStrength, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTable=npThermoTable, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapValue=npThermoTrapValue, npRelayEntry=npRelayEntry, npCurLoopR=npCurLoopR, npRelayN=npRelayN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, npRelay=npRelay, npIoTrapMemo=npIoTrapMemo, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npRelayTable=npRelayTable, npForcedReboot=npForcedReboot, npThermoValuePrecise=npThermoValuePrecise, npGsmRegistration=npGsmRegistration, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npThermoTraps=npThermoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npRelHumTempValue=npRelHumTempValue, npIoMemo=npIoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumValue=npRelHumValue, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npGsm=npGsm, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapN=npCurLoopTrapN, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npThermoStatus=npThermoStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, FixedPoint1000=FixedPoint1000, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npSmoke=npSmoke, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npCurLoopN=npCurLoopN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoEntry=npThermoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npTrapEmailTo=npTrapEmailTo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npReboot=npReboot, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, npGsmTrap=npGsmTrap, npIrPlayCmd=npIrPlayCmd, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npIrCtrl=npIrCtrl, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npResetStack=npResetStack, npRelayMode=npRelayMode, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTable=npCurLoopTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLineN=npIoLineN, npRelHumidity=npRelHumidity, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npIrReset=npIrReset, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail)
