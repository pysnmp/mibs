...
# Produced by pysmi-1.1.12 at Thu Nov 28 03:01:07 2024
...
enterprises, ModuleIdentity, Gauge32, Integer32, Counter32, IpAddress, Bits, Unsigned32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Gauge32", "Integer32", "Counter32", "IpAddress", "Bits", "Unsigned32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapValue=npThermoTrapValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTraps=npCurLoopTraps, npIoTrapLineN=npIoTrapLineN, npCurLoop=npCurLoop, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI, npIoMemo=npIoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npSmoke=npSmoke, npIoLevelIn=npIoLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTable=npThermoTable, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayTable=npRelayTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npRelayMemo=npRelayMemo, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npRelHumN=npRelHumN, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, npRelayEntry=npRelayEntry, npRelay=npRelay, npThermoLow=npThermoLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeReset=npSmokeReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoHigh=npThermoHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, lightcom=lightcom, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumidity=npRelHumidity, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npRelayState=npRelayState, npGsmTraps=npGsmTraps, npCurLoopR=npCurLoopR, npSmokeMemo=npSmokeMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npForcedReboot=npForcedReboot, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayStartReset=npRelayStartReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npReboot=npReboot, npIo=npIo, FixedPoint1000=FixedPoint1000, npTrapInfo=npTrapInfo, npSmokeSensorN=npSmokeSensorN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIr=npIr, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npIoTrap=npIoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempValue=npRelHumTempValue, npThermoTrap=npThermoTrap, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npThermoTrapMemo=npThermoTrapMemo, npIrCtrl=npIrCtrl, npGsmTrapPrefix=npGsmTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npIoTraps=npIoTraps, npGsmRegistration=npGsmRegistration, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npThermoTrapHigh=npThermoTrapHigh, npIoLevelOut=npIoLevelOut, npIrStatus=npIrStatus, npSmokeTrap=npSmokeTrap, npIrReset=npIrReset)
