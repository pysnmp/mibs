...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:06:32 2022
...
Integer32, Gauge32, Unsigned32, ObjectIdentity, MibIdentifier, enterprises, NotificationType, Bits, TimeTicks, Counter32, Counter64, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "enterprises", "NotificationType", "Bits", "TimeTicks", "Counter32", "Counter64", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrap=npSmokeTrap, npIo=npIo, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npThermoHigh=npThermoHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLevelOut=npIoLevelOut, npIrStatus=npIrStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npThermoTraps=npThermoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npIoTrapLineN=npIoTrapLineN, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npReboot=npReboot, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTraps=npIoTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npTrapInfo=npTrapInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmoke=npSmoke, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npRelayStartReset=npRelayStartReset, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTable=npThermoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npCurLoopR=npCurLoopR, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npRelHumTrapData=npRelHumTrapData, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npIoMemo=npIoMemo, npSoftReboot=npSoftReboot, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumEntry=npRelHumEntry, npRelayMode=npRelayMode, npRelHumN=npRelHumN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npIrCtrl=npIrCtrl, npTrapEmailTo=npTrapEmailTo, npIoTable=npIoTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopV=npCurLoopV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTraps=npGsmTraps, npRelayN=npRelayN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow)
