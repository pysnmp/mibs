...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:59:18 2022
...
Gauge32, Counter64, ModuleIdentity, ObjectIdentity, enterprises, Bits, Integer32, NotificationType, IpAddress, MibIdentifier, iso, Counter32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity", "enterprises", "Bits", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "iso", "Counter32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npSmokeStatus=npSmokeStatus, npThermo=npThermo, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npCurLoopI=npCurLoopI, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npGsmTraps=npGsmTraps, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTable=npCurLoopTable, npThermoValue=npThermoValue, npRelayState=npRelayState, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npCurLoopStatus=npCurLoopStatus, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrap=npThermoTrap, npSoftReboot=npSoftReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTable=npSmokeTable, npThermoTraps=npThermoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npResetStack=npResetStack, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumValue=npRelHumValue, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapStatus=npThermoTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npSmokeTraps=npSmokeTraps, npIr=npIr, npReboot=npReboot, npTrapInfo=npTrapInfo, npThermoValuePrecise=npThermoValuePrecise, npThermoLow=npThermoLow, npCurLoopEntry=npCurLoopEntry, npThermoSensorN=npThermoSensorN, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelay=npRelay, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumN=npRelHumN, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npIrStatus=npIrStatus, npCurLoop=npCurLoop, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeReset=npSmokeReset, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopR=npCurLoopR, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npSmoke=npSmoke, npRelHumTrapSafe=npRelHumTrapSafe, npIoEntry=npIoEntry, npRelayN=npRelayN, npIo=npIo)
