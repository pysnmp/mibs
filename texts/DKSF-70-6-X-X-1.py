...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:45:17 2022
...
ObjectIdentity, Unsigned32, Integer32, Bits, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, enterprises, iso, Counter32, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Integer32", "Bits", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "enterprises", "iso", "Counter32", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayState=npRelayState, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npIrCtrl=npIrCtrl, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempStatus=npRelHumTempStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, lightcom=lightcom, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npSmokeTrap=npSmokeTrap, npRelayMode=npRelayMode, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmInfo=npGsmInfo, npCurLoop=npCurLoop, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npThermoTraps=npThermoTraps, npIoLevelOut=npIoLevelOut, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npSoftReboot=npSoftReboot, npSmokeStatus=npSmokeStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npRelayN=npRelayN, npCurLoopTrap=npCurLoopTrap, npCurLoopI=npCurLoopI, npThermoTrapHigh=npThermoTrapHigh, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npForcedReboot=npForcedReboot, npSmokeReset=npSmokeReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoHigh=npThermoHigh, npIoLineN=npIoLineN, npRelHumidity=npRelHumidity, npRelayStartReset=npRelayStartReset, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrReset=npIrReset, npThermoTable=npThermoTable, npTrapEmailTo=npTrapEmailTo, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npResetStack=npResetStack, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumN=npRelHumN, npRelHumTable=npRelHumTable, npThermoStatus=npThermoStatus, npIo=npIo, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npGsmTrap=npGsmTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npThermo=npThermo, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npRelHumTrapDataValue=npRelHumTrapDataValue)
