...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:53:08 2024
...
Gauge32, NotificationType, iso, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Integer32, IpAddress, enterprises, Counter32, MibIdentifier, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "iso", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Integer32", "IpAddress", "enterprises", "Counter32", "MibIdentifier", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapMemo=npIoTrapMemo, npGsmTrap=npGsmTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIrStatus=npIrStatus, npThermoEntry=npThermoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npRelayStartReset=npRelayStartReset, npCurLoopTrapV=npCurLoopTrapV, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopN=npCurLoopN, npIr=npIr, npRelHumEntry=npRelHumEntry, npForcedReboot=npForcedReboot, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLineN=npIoLineN, npRelHumTrapData=npRelHumTrapData, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npReboot=npReboot, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeEntry=npSmokeEntry, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npRelHumStatus=npRelHumStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npIoMemo=npIoMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npResetStack=npResetStack, npRelayTable=npRelayTable, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTable=npThermoTable, npRelHumN=npRelHumN, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npIo=npIo, npGsm=npGsm, npIrReset=npIrReset, npSmoke=npSmoke, npRelHumTrap=npRelHumTrap, FixedPoint1000=FixedPoint1000, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrap=npSmokeTrap, npIrCtrl=npIrCtrl, npRelay=npRelay, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeStatus=npSmokeStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe)
