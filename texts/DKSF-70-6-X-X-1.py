...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:39:07 2022
...
Integer32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, TimeTicks, Bits, ObjectIdentity, iso, ModuleIdentity, Counter64, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "TimeTicks", "Bits", "ObjectIdentity", "iso", "ModuleIdentity", "Counter64", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npSmokeTraps=npSmokeTraps, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoLow=npThermoLow, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, npIo=npIo, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npThermoStatus=npThermoStatus, npCurLoopTrapR=npCurLoopTrapR, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npSmokeMemo=npSmokeMemo, npSmoke=npSmoke, npRelayStartReset=npRelayStartReset, npRelayN=npRelayN, FixedPoint1000=FixedPoint1000, npTrapInfo=npTrapInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTraps=npIoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npGsm=npGsm, npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayTable=npRelayTable, npCurLoopTrapN=npCurLoopTrapN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npIoTrap=npIoTrap, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumValue=npRelHumValue, npIrReset=npIrReset, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npIrStatus=npIrStatus, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npSmokeTrapStatus=npSmokeTrapStatus, npSmokePower=npSmokePower, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopV=npCurLoopV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapData=npRelHumTrapData, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npIoMemo=npIoMemo, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, lightcom=lightcom, npGsmStrength=npGsmStrength, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrPlayCmd=npIrPlayCmd, npRelayState=npRelayState, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrCtrl=npIrCtrl, npRelHumStatus=npRelHumStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValue=npThermoValue, npIr=npIr, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumEntry=npRelHumEntry, npCurLoopI=npCurLoopI, npGsmRegistration=npGsmRegistration)
