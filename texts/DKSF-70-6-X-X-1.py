...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:07:08 2023
...
Gauge32, Counter32, IpAddress, NotificationType, TimeTicks, Unsigned32, ModuleIdentity, iso, Integer32, Counter64, MibIdentifier, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32", "ModuleIdentity", "iso", "Integer32", "Counter64", "MibIdentifier", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npGsmInfo=npGsmInfo, npRelHumidity=npRelHumidity, npSoftReboot=npSoftReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, npSmokeEntry=npSmokeEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npSmokePower=npSmokePower, npIrReset=npIrReset, npTrapEmailTo=npTrapEmailTo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, npThermoValue=npThermoValue, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npSmokeSensorN=npSmokeSensorN, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npIo=npIo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoEntry=npIoEntry, npCurLoopN=npCurLoopN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTable=npCurLoopTable, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npSmokeReset=npSmokeReset, npGsmTrap=npGsmTrap, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npThermoTable=npThermoTable, npSmokeMemo=npSmokeMemo, npThermo=npThermo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeStatus=npSmokeStatus, npCurLoopR=npCurLoopR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrStatus=npIrStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap, npIoTrapLineN=npIoTrapLineN, npReboot=npReboot, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npIoTable=npIoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npRelayState=npRelayState, npIoTraps=npIoTraps, npCurLoopI=npCurLoopI, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npRelayMemo=npRelayMemo, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npResetStack=npResetStack)
