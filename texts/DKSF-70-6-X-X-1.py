...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:45:43 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso, Bits, NotificationType, IpAddress, MibIdentifier, Gauge32, Counter64, Integer32, enterprises, ModuleIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso", "Bits", "NotificationType", "IpAddress", "MibIdentifier", "Gauge32", "Counter64", "Integer32", "enterprises", "ModuleIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTable=npRelayTable, npReboot=npReboot, npRelHumTable=npRelHumTable, npThermoValue=npThermoValue, npGsmTrap=npGsmTrap, npRelHumValue=npRelHumValue, npIoTrap=npIoTrap, npRelHumN=npRelHumN, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npSmoke=npSmoke, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npThermo=npThermo, npRelay=npRelay, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npIoPulseCounter=npIoPulseCounter, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseStart=npIoSinglePulseStart, npRelayState=npRelayState, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrap=npRelHumTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIr=npIr, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npGsmInfo=npGsmInfo, npRelayStartReset=npRelayStartReset, npRelHumidity=npRelHumidity, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npCurLoop=npCurLoop, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npIoLevelOut=npIoLevelOut, npCurLoopTrap=npCurLoopTrap, npSmokeMemo=npSmokeMemo, npGsm=npGsm, npIrReset=npIrReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npRelHumMemo=npRelHumMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npSmokeSensorN=npSmokeSensorN, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npIoLevelIn=npIoLevelIn, lightcom=lightcom, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npRelayMode=npRelayMode, npSmokeTable=npSmokeTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npThermoEntry=npThermoEntry, npThermoTable=npThermoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapV=npCurLoopTrapV, npThermoTrap=npThermoTrap, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, FixedPoint1000=FixedPoint1000, npCurLoopStatus=npCurLoopStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoStatus=npThermoStatus, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npCurLoopN=npCurLoopN, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry)
