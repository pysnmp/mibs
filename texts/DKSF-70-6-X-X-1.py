...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:29:42 2022
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Bits, Counter32, ModuleIdentity, MibIdentifier, enterprises, Integer32, ObjectIdentity, IpAddress, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Bits", "Counter32", "ModuleIdentity", "MibIdentifier", "enterprises", "Integer32", "ObjectIdentity", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, npCurLoopTraps=npCurLoopTraps, npGsmStrength=npGsmStrength, npRelayState=npRelayState, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumN=npRelHumN, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npThermoTraps=npThermoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npSmoke=npSmoke, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npTrapInfo=npTrapInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumStatus=npRelHumStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npSoftReboot=npSoftReboot, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumidity=npRelHumidity, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npCurLoop=npCurLoop, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npIoPulseCounter=npIoPulseCounter, npThermoTrap=npThermoTrap, npIrStatus=npIrStatus, npRelHumTrapDataN=npRelHumTrapDataN, npGsmFailed=npGsmFailed, npIoTable=npIoTable, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIo=npIo, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npSmokeTrap=npSmokeTrap, FixedPoint1000=FixedPoint1000, npIoTrapPrefix=npIoTrapPrefix, npIoMemo=npIoMemo, npThermo=npThermo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelIn=npIoLevelIn, npRelayMode=npRelayMode, npCurLoopI=npCurLoopI, npThermoTrapStatus=npThermoTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npRelay=npRelay, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npSmokeEntry=npSmokeEntry, npThermoSensorN=npThermoSensorN, npRelHumTable=npRelHumTable, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset)
