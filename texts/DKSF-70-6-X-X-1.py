...
# Produced by pysmi-1.1.8 at Fri Oct 13 14:09:35 2023
...
Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Gauge32, IpAddress, NotificationType, enterprises, MibIdentifier, Bits, Counter64, ObjectIdentity, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Gauge32", "IpAddress", "NotificationType", "enterprises", "MibIdentifier", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrap=npCurLoopTrap, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTable=npCurLoopTable, npReboot=npReboot, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npSmokePower=npSmokePower, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npIr=npIr, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeReset=npSmokeReset, npThermoTrapLow=npThermoTrapLow, npThermoValue=npThermoValue, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoEntry=npThermoEntry, npIrCtrl=npIrCtrl, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npSmokeTable=npSmokeTable, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, FixedPoint1000=FixedPoint1000, npRelayN=npRelayN, npRelay=npRelay, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopV=npCurLoopV, npIrPlayCmd=npIrPlayCmd, npRelHumTrapData=npRelHumTrapData, npSmokeStatus=npSmokeStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumidity=npRelHumidity, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npIoTrapPrefix=npIoTrapPrefix, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npThermo=npThermo, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npTrapEmailTo=npTrapEmailTo, npCurLoop=npCurLoop, npIoTrapLevelIn=npIoTrapLevelIn, lightcom=lightcom, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelayTable=npRelayTable, npIrReset=npIrReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap)
