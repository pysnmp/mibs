...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:28:59 2023
...
Counter32, iso, Bits, TimeTicks, Unsigned32, MibIdentifier, enterprises, Gauge32, ObjectIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "enterprises", "Gauge32", "ObjectIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumValue=npRelHumValue, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npGsmInfo=npGsmInfo, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npIrStatus=npIrStatus, npThermoTrap=npThermoTrap, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npIoTraps=npIoTraps, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrap=npSmokeTrap, npCurLoopPower=npCurLoopPower, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npCurLoopTrap=npCurLoopTrap, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelayTable=npRelayTable, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npSmoke=npSmoke, npSoftReboot=npSoftReboot, npRelayStartReset=npRelayStartReset, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumMemo=npRelHumMemo, npRelHumTrapFail=npRelHumTrapFail, npResetStack=npResetStack, npRelayMode=npRelayMode, npIoTable=npIoTable, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npRelHumTempValue=npRelHumTempValue, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npSmokeMemo=npSmokeMemo, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npCurLoopR=npCurLoopR, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumN=npRelHumN, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npCurLoopV=npCurLoopV, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTraps=npSmokeTraps, npIoLineN=npIoLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npThermoStatus=npThermoStatus, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npThermoLow=npThermoLow, npIo=npIo, npIrReset=npIrReset, npTrapInfo=npTrapInfo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeReset=npSmokeReset, npSmokeEntry=npSmokeEntry, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN)
