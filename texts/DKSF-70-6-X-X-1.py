...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:18:22 2021
...
ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, enterprises, Integer32, Counter64, Unsigned32, ModuleIdentity, NotificationType, TimeTicks, IpAddress, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "enterprises", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity", "NotificationType", "TimeTicks", "IpAddress", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTraps=npSmokeTraps, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTable=npSmokeTable, npIrReset=npIrReset, npRelHumTrapDataValue=npRelHumTrapDataValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npSmokeReset=npSmokeReset, npGsmFailed=npGsmFailed, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npSmokeSensorN=npSmokeSensorN, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, FixedPoint1000=FixedPoint1000, lightcom=lightcom, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTraps=npGsmTraps, npIr=npIr, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTraps=npThermoTraps, npRelHumTempValue=npRelHumTempValue, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapStatus=npThermoTrapStatus, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoStatus=npThermoStatus, npThermoHigh=npThermoHigh, npThermoTrapMemo=npThermoTrapMemo, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npCurLoopTrapR=npCurLoopTrapR, npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTraps=npCurLoopTraps, npThermoMemo=npThermoMemo, npIrCtrl=npIrCtrl, npSoftReboot=npSoftReboot, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrap=npThermoTrap, npThermoTrapLow=npThermoTrapLow, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npIoTable=npIoTable, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npIoTrapLineN=npIoTrapLineN, npThermoEntry=npThermoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npReboot=npReboot, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npIo=npIo, npGsm=npGsm, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npCurLoopPower=npCurLoopPower, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoSensorN=npThermoSensorN, npRelHumValue=npRelHumValue, npResetStack=npResetStack, npTrapInfo=npTrapInfo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumN=npRelHumN, npRelHumTrap=npRelHumTrap, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, npRelay=npRelay, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMemo=npRelayMemo, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry)
