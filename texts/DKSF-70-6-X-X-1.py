...
# Produced by pysmi-1.1.12 at Sat Jul  6 01:11:51 2024
...
IpAddress, MibIdentifier, Counter64, TimeTicks, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter32, ObjectIdentity, ModuleIdentity, NotificationType, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrap=npGsmTrap, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoLow=npThermoLow, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npIoLineN=npIoLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npRelHumTempStatus=npRelHumTempStatus, npIoTrap=npIoTrap, npResetStack=npResetStack, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npIoMemo=npIoMemo, npRelHumN=npRelHumN, npCurLoopTable=npCurLoopTable, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npCurLoopN=npCurLoopN, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrPlayCmd=npIrPlayCmd, npIrReset=npIrReset, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npCurLoopR=npCurLoopR, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTraps=npSmokeTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npGsm=npGsm, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoop=npCurLoop, npThermoTrapMemo=npThermoTrapMemo, npRelayMemo=npRelayMemo, npRelayEntry=npRelayEntry, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npIo=npIo, npIoTable=npIoTable, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelOut=npIoLevelOut, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npReboot=npReboot, npCurLoopTrapPower=npCurLoopTrapPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npCurLoopV=npCurLoopV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npSmokeStatus=npSmokeStatus, npRelHumMemo=npRelHumMemo, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npIoTraps=npIoTraps, npThermoEntry=npThermoEntry, npThermoMemo=npThermoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npRelay=npRelay, npRelayStartReset=npRelayStartReset)
