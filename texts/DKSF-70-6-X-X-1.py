...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:30:29 2021
...
Bits, ModuleIdentity, Gauge32, Counter64, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, MibIdentifier, Counter32, TimeTicks, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "MibIdentifier", "Counter32", "TimeTicks", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLineN=npIoLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, FixedPoint1000=FixedPoint1000, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoop=npCurLoop, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelIn=npIoLevelIn, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumN=npRelHumN, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npSmoke=npSmoke, npResetStack=npResetStack, npThermoTable=npThermoTable, npRelHumTrapFail=npRelHumTrapFail, npSmokePower=npSmokePower, npIoPulseCounter=npIoPulseCounter, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npIoTraps=npIoTraps, npSoftReboot=npSoftReboot, npIrPlayCmd=npIrPlayCmd, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npThermo=npThermo, npThermoTrapHigh=npThermoTrapHigh, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npSmokeTable=npSmokeTable, npIoSinglePulseDuration=npIoSinglePulseDuration, lightcom=lightcom, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npSmokeEntry=npSmokeEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npGsmFailed=npGsmFailed, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrap=npIoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIo=npIo, npReboot=npReboot, npCurLoopN=npCurLoopN, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, npCurLoopR=npCurLoopR, npGsm=npGsm, npIoEntry=npIoEntry, npRelHumMemo=npRelHumMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npThermoTrapPrefix=npThermoTrapPrefix, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopStatus=npCurLoopStatus, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrap=npCurLoopTrap, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot)
