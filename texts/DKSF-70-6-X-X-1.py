...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:40:41 2023
...
ObjectIdentity, ModuleIdentity, iso, Bits, Counter64, MibIdentifier, Integer32, enterprises, Unsigned32, Counter32, Gauge32, NotificationType, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "iso", "Bits", "Counter64", "MibIdentifier", "Integer32", "enterprises", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npIoTraps=npIoTraps, npThermoTrap=npThermoTrap, npRelHumValue=npRelHumValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIo=npIo, npGsmRegistration=npGsmRegistration, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, lightcom=lightcom, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapLow=npThermoTrapLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayN=npRelayN, npResetStack=npResetStack, npRelHumStatus=npRelHumStatus, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokePower=npSmokePower, npSmoke=npSmoke, npRelayTable=npRelayTable, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumMemo=npRelHumMemo, npRelayMode=npRelayMode, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempValue=npRelHumTempValue, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npReboot=npReboot, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npCurLoop=npCurLoop, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapEmailTo=npTrapEmailTo, FixedPoint1000=FixedPoint1000, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermoLow=npThermoLow, npSmokeTable=npSmokeTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumidity=npRelHumidity, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npThermo=npThermo, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npThermoEntry=npThermoEntry, npIrCtrl=npIrCtrl, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayEntry=npRelayEntry, npSoftReboot=npSoftReboot, npSmokeStatus=npSmokeStatus, npIoTrap=npIoTrap, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npThermoTraps=npThermoTraps, npIoLevelIn=npIoLevelIn, npIoTrapLineN=npIoTrapLineN, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopN=npCurLoopN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTemp=npRelHumTrapTemp, npIr=npIr, npRelHumN=npRelHumN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npGsmTraps=npGsmTraps, npCurLoopEntry=npCurLoopEntry, npThermoTrapMemo=npThermoTrapMemo, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap)
