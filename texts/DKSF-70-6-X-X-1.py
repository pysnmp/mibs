...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:11:52 2022
...
enterprises, Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Integer32, Unsigned32, ModuleIdentity, IpAddress, Bits, NotificationType, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "Bits", "NotificationType", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTraps=npIoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npThermoTrap=npThermoTrap, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrap=npRelHumTrap, npIoTable=npIoTable, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npIoTrapPrefix=npIoTrapPrefix, npGsmInfo=npGsmInfo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelayStartReset=npRelayStartReset, npReboot=npReboot, npIo=npIo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempStatus=npRelHumTempStatus, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npThermo=npThermo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSoftReboot=npSoftReboot, npThermoSensorN=npThermoSensorN, npIr=npIr, FixedPoint1000=FixedPoint1000, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapStatus=npSmokeTrapStatus, npThermoStatus=npThermoStatus, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npRelHumStatus=npRelHumStatus, npSmokeStatus=npSmokeStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumidity=npRelHumidity, npSmokeReset=npSmokeReset, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npThermoEntry=npThermoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npRelayState=npRelayState, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseStart=npIoSinglePulseStart, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrap=npIoTrap, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npThermoHigh=npThermoHigh, npRelHumTempValue=npRelHumTempValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, npRelHumEntry=npRelHumEntry, npRelay=npRelay, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, npCurLoopV=npCurLoopV, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npRelayTable=npRelayTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoMemo=npThermoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npThermoTable=npThermoTable, npIoMemo=npIoMemo)
