...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:42:36 2024
...
Bits, ModuleIdentity, enterprises, Counter32, TimeTicks, NotificationType, Counter64, Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "enterprises", "Counter32", "TimeTicks", "NotificationType", "Counter64", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npThermoEntry=npThermoEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayTable=npRelayTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npRelayStartReset=npRelayStartReset, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermo=npThermo, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelayEntry=npRelayEntry, npIoTraps=npIoTraps, npIrStatus=npIrStatus, npCurLoopR=npCurLoopR, npCurLoopEntry=npCurLoopEntry, npIrReset=npIrReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopI=npCurLoopI, npIr=npIr, npThermoLow=npThermoLow, npGsmTraps=npGsmTraps, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopStatus=npCurLoopStatus, npIo=npIo, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npSmokePower=npSmokePower, npIoTable=npIoTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPower=npCurLoopTrapPower, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npReboot=npReboot, npCurLoop=npCurLoop, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMemo=npRelayMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumValue=npRelHumValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapMemo=npIoTrapMemo, npThermoTraps=npThermoTraps, npRelHumTempValue=npRelHumTempValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, npThermoTrap=npThermoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIoLineN=npIoLineN, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npGsmInfo=npGsmInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo)
