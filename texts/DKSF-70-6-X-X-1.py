...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:10:04 2022
...
TimeTicks, NotificationType, ObjectIdentity, IpAddress, Bits, enterprises, Unsigned32, ModuleIdentity, iso, MibIdentifier, Gauge32, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "enterprises", "Unsigned32", "ModuleIdentity", "iso", "MibIdentifier", "Gauge32", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopPower=npCurLoopPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumN=npRelHumN, npGsmStrength=npGsmStrength, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npRelHumTrapData=npRelHumTrapData, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoTraps=npIoTraps, npRelay=npRelay, npCurLoop=npCurLoop, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npIo=npIo, npRelayN=npRelayN, npSmokeTraps=npSmokeTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npIoLineN=npIoLineN, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npCurLoopN=npCurLoopN, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npIr=npIr, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npResetStack=npResetStack, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npSmokePower=npSmokePower, npRelHumTrap=npRelHumTrap, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npRelayTable=npRelayTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npSoftReboot=npSoftReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, lightcom=lightcom, npRelHumidity=npRelHumidity, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npCurLoopTraps=npCurLoopTraps, npTrapInfo=npTrapInfo, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumValue=npRelHumValue, npCurLoopTrapV=npCurLoopTrapV, npThermoTable=npThermoTable, npIrReset=npIrReset)
