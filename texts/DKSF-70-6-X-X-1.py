...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:30:34 2022
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, IpAddress, NotificationType, Unsigned32, iso, MibIdentifier, Counter64, Counter32, ModuleIdentity, Integer32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "IpAddress", "NotificationType", "Unsigned32", "iso", "MibIdentifier", "Counter64", "Counter32", "ModuleIdentity", "Integer32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npIoEntry=npIoEntry, npResetStack=npResetStack, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npSmokeReset=npSmokeReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npCurLoopTrap=npCurLoopTrap, npCurLoopTable=npCurLoopTable, npTrapInfo=npTrapInfo, npThermoTrap=npThermoTrap, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPower=npCurLoopTrapPower, npThermo=npThermo, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npRelay=npRelay, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npIoTraps=npIoTraps, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npCurLoopPower=npCurLoopPower, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npRelHumEntry=npRelHumEntry, npThermoMemo=npThermoMemo, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap, FixedPoint1000=FixedPoint1000, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npIr=npIr, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed, npSmokeMemo=npSmokeMemo, npRelHumMemo=npRelHumMemo, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrap=npIoTrap, lightcom=lightcom, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npCurLoopN=npCurLoopN, npThermoHigh=npThermoHigh, npReboot=npReboot, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayN=npRelayN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npIoTrapPrefix=npIoTrapPrefix, npThermoLow=npThermoLow, npRelayMemo=npRelayMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npCurLoopV=npCurLoopV, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npRelHumTable=npRelHumTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapHigh=npThermoTrapHigh, npRelayStartReset=npRelayStartReset, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npRelHumTrap=npRelHumTrap, npRelayEntry=npRelayEntry, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npForcedReboot=npForcedReboot, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength)
