...
# Produced by pysmi-1.1.12 at Tue May 28 12:51:55 2024
...
NotificationType, iso, Unsigned32, MibIdentifier, ModuleIdentity, enterprises, Bits, Counter64, ObjectIdentity, Integer32, Counter32, IpAddress, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "ModuleIdentity", "enterprises", "Bits", "Counter64", "ObjectIdentity", "Integer32", "Counter32", "IpAddress", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokePower=npSmokePower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npRelHumTempValue=npRelHumTempValue, npIr=npIr, npIrStatus=npIrStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmInfo=npGsmInfo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayN=npRelayN, npSmokeReset=npSmokeReset, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoMemo=npIoMemo, npThermoTrapMemo=npThermoTrapMemo, npIoLevelOut=npIoLevelOut, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLineN=npIoTrapLineN, npReboot=npReboot, npRelHumMemo=npRelHumMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npIo=npIo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermo=npThermo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npThermoStatus=npThermoStatus, npGsmTrap=npGsmTrap, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrap=npThermoTrap, npCurLoopI=npCurLoopI, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npGsm=npGsm, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npCurLoopN=npCurLoopN, npGsmStrength=npGsmStrength, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoSensorN=npThermoSensorN, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, FixedPoint1000=FixedPoint1000, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumidity=npRelHumidity, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmoke=npSmoke, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn)
