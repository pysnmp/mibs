...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:47:48 2024
...
IpAddress, enterprises, TimeTicks, NotificationType, Gauge32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, MibIdentifier, Unsigned32, Counter64, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "TimeTicks", "NotificationType", "Gauge32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeReset=npSmokeReset, npIoEntry=npIoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npCurLoopTrap=npCurLoopTrap, npIoTraps=npIoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npRelHumidity=npRelHumidity, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npIo=npIo, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npIoTrapLineN=npIoTrapLineN, npGsmTraps=npGsmTraps, npCurLoopV=npCurLoopV, npIr=npIr, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npGsm=npGsm, npThermoTraps=npThermoTraps, npSmokePower=npSmokePower, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npIoLevelIn=npIoLevelIn, npSmokeStatus=npSmokeStatus, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo, npSmokeTraps=npSmokeTraps, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npThermo=npThermo, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumValue=npRelHumValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTable=npRelayTable, npSoftReboot=npSoftReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npGsmStrength=npGsmStrength, npIoLevelOut=npIoLevelOut, npSmokeTrapStatus=npSmokeTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumN=npRelHumN, npSmokeTrap=npSmokeTrap, npSmokeSensorN=npSmokeSensorN, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrap=npIoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npIoTable=npIoTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrap=npRelHumTrap, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npSmoke=npSmoke, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npThermoTrapStatus=npThermoTrapStatus, npCurLoopN=npCurLoopN, lightcom=lightcom, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe)
