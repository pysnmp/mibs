...
ModuleIdentity, IpAddress, Gauge32, iso, Counter32, Counter64, MibIdentifier, Bits, ObjectIdentity, TimeTicks, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Gauge32", "iso", "Counter32", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "TimeTicks", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoMemo=npThermoMemo, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValue=npThermoValue, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapFail=npRelHumTrapFail, npRelHumN=npRelHumN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumMemo=npRelHumMemo, npSmokeTraps=npSmokeTraps, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelOut=npIoLevelOut, npCurLoopTrapR=npCurLoopTrapR, npSmokePower=npSmokePower, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npGsm=npGsm, npRelHumValue=npRelHumValue, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoStatus=npThermoStatus, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, npCurLoopTrapI=npCurLoopTrapI, npRelayStartReset=npRelayStartReset, npTrapInfo=npTrapInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npIo=npIo, npGsmInfo=npGsmInfo, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npRelayTable=npRelayTable, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrap=npThermoTrap, lightcom=lightcom, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npThermoTraps=npThermoTraps, npSmokeMemo=npSmokeMemo, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelIn=npIoLevelIn, npSmokeTrap=npSmokeTrap, npThermoSensorN=npThermoSensorN, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npThermoTrapStatus=npThermoTrapStatus, npIr=npIr, npCurLoopR=npCurLoopR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npThermo=npThermo, npGsmStrength=npGsmStrength, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTable=npRelHumTable, npRelHumStatus=npRelHumStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npSmokeReset=npSmokeReset, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npThermoTrapLow=npThermoTrapLow, npRelayN=npRelayN, npCurLoopTrap=npCurLoopTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrStatus=npIrStatus, npIoTable=npIoTable, npCurLoopV=npCurLoopV, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npThermoTable=npThermoTable, npRelHumEntry=npRelHumEntry)
