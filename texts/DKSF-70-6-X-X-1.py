...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:49:09 2024
...
enterprises, ObjectIdentity, ModuleIdentity, Bits, TimeTicks, Gauge32, iso, Integer32, Unsigned32, Counter32, IpAddress, NotificationType, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32", "iso", "Integer32", "Unsigned32", "Counter32", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npRelHumTrapSafe=npRelHumTrapSafe, npIr=npIr, npIoLineN=npIoLineN, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelIn=npIoLevelIn, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrap=npIoTrap, npThermoTrap=npThermoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npCurLoopN=npCurLoopN, npIrReset=npIrReset, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npSmokeTable=npSmokeTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, npIoMemo=npIoMemo, npGsm=npGsm, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMode=npRelayMode, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npIoEntry=npIoEntry, npRelayState=npRelayState, npSmokeTraps=npSmokeTraps, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npForcedReboot=npForcedReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTraps=npCurLoopTraps, npThermoTrapValue=npThermoTrapValue, npGsmFailed=npGsmFailed, npRelHumTempStatus=npRelHumTempStatus, npIo=npIo, npSmokePower=npSmokePower, npSmokeStatus=npSmokeStatus, npSmokeEntry=npSmokeEntry, npRelHumStatus=npRelHumStatus, npThermo=npThermo, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrPlayCmd=npIrPlayCmd, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrap=npSmokeTrap, npCurLoop=npCurLoop, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npGsmTraps=npGsmTraps, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npCurLoopTrapR=npCurLoopTrapR, npIoTraps=npIoTraps, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npResetStack=npResetStack, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix)
