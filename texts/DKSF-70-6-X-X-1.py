...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:36:44 2021
...
MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Gauge32, Bits, Unsigned32, iso, NotificationType, IpAddress, enterprises, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Gauge32", "Bits", "Unsigned32", "iso", "NotificationType", "IpAddress", "enterprises", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumMemo=npRelHumMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopN=npCurLoopN, npCurLoopTraps=npCurLoopTraps, npThermoLow=npThermoLow, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npSoftReboot=npSoftReboot, npIr=npIr, npThermoHigh=npThermoHigh, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npTrapEmailTo=npTrapEmailTo, npThermoTrapPrefix=npThermoTrapPrefix, npRelayMemo=npRelayMemo, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayN=npRelayN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, FixedPoint1000=FixedPoint1000, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTempStatus=npRelHumTempStatus, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopPower=npCurLoopPower, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npThermo=npThermo, npIrPlayCmd=npIrPlayCmd, npSmokePower=npSmokePower, npGsmStrength=npGsmStrength, npIoTable=npIoTable, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumEntry=npRelHumEntry, npIo=npIo, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumValue=npRelHumValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npIoLineN=npIoLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopV=npCurLoopV, npRelHumTempValue=npRelHumTempValue, npCurLoopTable=npCurLoopTable, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npGsmRegistration=npGsmRegistration, npCurLoopI=npCurLoopI, npGsmFailed=npGsmFailed, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, lightcom=lightcom, npIoTrap=npIoTrap)
