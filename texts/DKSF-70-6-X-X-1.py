...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:36:46 2021
...
NotificationType, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, ModuleIdentity, ObjectIdentity, Bits, Gauge32, TimeTicks, Integer32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Bits", "Gauge32", "TimeTicks", "Integer32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrap=npIoTrap, npRelayTable=npRelayTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrap=npRelHumTrap, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIr=npIr, npThermoMemo=npThermoMemo, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIo=npIo, npSmokeStatus=npSmokeStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npGsmTraps=npGsmTraps, npGsmStrength=npGsmStrength, npCurLoopN=npCurLoopN, npSmokeMemo=npSmokeMemo, npSmokeEntry=npSmokeEntry, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopStatus=npCurLoopStatus, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTable=npIoTable, npThermoLow=npThermoLow, npSmoke=npSmoke, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npCurLoopTrapR=npCurLoopTrapR, npThermoTraps=npThermoTraps, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npIrStatus=npIrStatus, lightcom=lightcom, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npGsmFailed=npGsmFailed, npThermoStatus=npThermoStatus, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoMemo=npIoMemo, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopR=npCurLoopR, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempValue=npRelHumTempValue, npIoEntry=npIoEntry, npSmokeTable=npSmokeTable, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npReboot=npReboot, npSmokeTrap=npSmokeTrap, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npThermoSensorN=npThermoSensorN, npThermoTable=npThermoTable, npIoLevelIn=npIoLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMemo=npRelayMemo, npCurLoopTrapI=npCurLoopTrapI, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo)
