...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:54:51 2023
...
ModuleIdentity, IpAddress, MibIdentifier, Unsigned32, Gauge32, Integer32, Counter64, TimeTicks, NotificationType, enterprises, Counter32, iso, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "Gauge32", "Integer32", "Counter64", "TimeTicks", "NotificationType", "enterprises", "Counter32", "iso", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npIoTrapPrefix=npIoTrapPrefix, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npSmokeTraps=npSmokeTraps, npIrReset=npIrReset, npIr=npIr, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTraps=npThermoTraps, npRelayN=npRelayN, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npRelayEntry=npRelayEntry, npGsm=npGsm, npRelHumidity=npRelHumidity, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npCurLoopTable=npCurLoopTable, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npThermoStatus=npThermoStatus, npSmokeSensorN=npSmokeSensorN, npThermoSensorN=npThermoSensorN, npCurLoopR=npCurLoopR, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npCurLoopV=npCurLoopV, npReboot=npReboot, npRelHumTempStatus=npRelHumTempStatus, npThermo=npThermo, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrStatus=npIrStatus, npCurLoopI=npCurLoopI, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrap=npRelHumTrap, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoop=npCurLoop, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumEntry=npRelHumEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIoLineN=npIoLineN, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npRelayStartReset=npRelayStartReset, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrap=npThermoTrap, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npCurLoopEntry=npCurLoopEntry, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoLow=npThermoLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npThermoTrapLow=npThermoTrapLow, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npGsmStrength=npGsmStrength, npGsmFailed=npGsmFailed, npIoPulseCounter=npIoPulseCounter, npForcedReboot=npForcedReboot, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npSmokeMemo=npSmokeMemo, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration)
