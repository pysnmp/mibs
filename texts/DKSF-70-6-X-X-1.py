...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:38:48 2023
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, iso, ObjectIdentity, Integer32, Counter32, ModuleIdentity, IpAddress, NotificationType, MibIdentifier, Counter64, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "iso", "ObjectIdentity", "Integer32", "Counter32", "ModuleIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npIo=npIo, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMemo=npRelayMemo, npIoLevelOut=npIoLevelOut, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTemp=npRelHumTrapTemp, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npIoEntry=npIoEntry, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npIoTrapLevelIn=npIoTrapLevelIn, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapValue=npThermoTrapValue, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelayN=npRelayN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npIrStatus=npIrStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumStatus=npRelHumStatus, npReboot=npReboot, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npCurLoop=npCurLoop, npThermo=npThermo, npRelayMode=npRelayMode, npRelHumTrapData=npRelHumTrapData, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npThermoTrap=npThermoTrap, npIoTable=npIoTable, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npRelayStartReset=npRelayStartReset, npSmokeMemo=npSmokeMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npGsm=npGsm, npIrReset=npIrReset, npIoTrap=npIoTrap, npSmokeTable=npSmokeTable, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npCurLoopTable=npCurLoopTable, npCurLoopTrapI=npCurLoopTrapI, npIrPlayCmd=npIrPlayCmd, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow)
