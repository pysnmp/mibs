...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:09:44 2024
...
TimeTicks, Unsigned32, NotificationType, iso, IpAddress, Integer32, Gauge32, Counter64, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "NotificationType", "iso", "IpAddress", "Integer32", "Gauge32", "Counter64", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npCurLoopTrapV=npCurLoopTrapV, npCurLoopN=npCurLoopN, npThermo=npThermo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npIoTrapMemo=npIoTrapMemo, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsm=npGsm, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npIoLevelOut=npIoLevelOut, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, npRelayN=npRelayN, npSmokeMemo=npSmokeMemo, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, lightcom=lightcom, npSmoke=npSmoke, npSmokeStatus=npSmokeStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npSmokeEntry=npSmokeEntry, npRelayMemo=npRelayMemo, npThermoValue=npThermoValue, npCurLoopTrapPower=npCurLoopTrapPower, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npRelayState=npRelayState, npThermoTable=npThermoTable, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrap=npSmokeTrap, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npThermoTrapStatus=npThermoTrapStatus, npIrCtrl=npIrCtrl, npIoTrapPrefix=npIoTrapPrefix, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumN=npRelHumN, npRelayEntry=npRelayEntry, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npCurLoopV=npCurLoopV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npIoEntry=npIoEntry, npIrStatus=npIrStatus, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
