...
# Produced by pysmi-1.1.0 at Mon Nov 15 19:54:44 2021
...
enterprises, TimeTicks, ModuleIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32, Counter32, IpAddress, Counter64, Bits, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "ModuleIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32", "Counter32", "IpAddress", "Counter64", "Bits", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npIrStatus=npIrStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npGsmTrapPrefix=npGsmTrapPrefix, npIrReset=npIrReset, npReboot=npReboot, npRelayN=npRelayN, npCurLoopStatus=npCurLoopStatus, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npRelay=npRelay, npCurLoopI=npCurLoopI, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, FixedPoint1000=FixedPoint1000, npIrPlayCmd=npIrPlayCmd, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npGsm=npGsm, npThermoHigh=npThermoHigh, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermo=npThermo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapData=npRelHumTrapData, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumMemo=npRelHumMemo, npIo=npIo, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmFailed=npGsmFailed, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npForcedReboot=npForcedReboot, npThermoEntry=npThermoEntry, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTable=npRelHumTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npSmoke=npSmoke, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, npIoEntry=npIoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTable=npThermoTable, npRelHumN=npRelHumN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopV=npCurLoopV, npResetStack=npResetStack, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopR=npCurLoopR, npIoLevelOut=npIoLevelOut, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npGsmTraps=npGsmTraps, npCurLoopTrapR=npCurLoopTrapR, npSmokeTraps=npSmokeTraps, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npIrCtrl=npIrCtrl, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npSoftReboot=npSoftReboot, npIoTrapMemo=npIoTrapMemo, npSmokeReset=npSmokeReset, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeSensorN=npSmokeSensorN)
