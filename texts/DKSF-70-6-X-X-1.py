...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:49:00 2022
...
MibIdentifier, TimeTicks, ObjectIdentity, Integer32, Gauge32, enterprises, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Counter64, iso, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Integer32", "Gauge32", "enterprises", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Counter64", "iso", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumN=npRelHumN, npThermo=npThermo, npIoEntry=npIoEntry, npThermoMemo=npThermoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npThermoHigh=npThermoHigh, npForcedReboot=npForcedReboot, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopR=npCurLoopR, npThermoValuePrecise=npThermoValuePrecise, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npSmokeReset=npSmokeReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrap=npIoTrap, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npThermoTraps=npThermoTraps, npGsmStrength=npGsmStrength, npThermoSensorN=npThermoSensorN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npCurLoopStatus=npCurLoopStatus, npIrCtrl=npIrCtrl, npSmokeTable=npSmokeTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTraps=npIoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npCurLoop=npCurLoop, npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, FixedPoint1000=FixedPoint1000, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npRelHumidity=npRelHumidity, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoMemo=npIoMemo, npThermoTrapStatus=npThermoTrapStatus, npRelayState=npRelayState, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npRelayTable=npRelayTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npGsmTraps=npGsmTraps, npReboot=npReboot, npSmokeTraps=npSmokeTraps, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumValue=npRelHumValue, npIr=npIr, npIrReset=npIrReset, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumEntry=npRelHumEntry, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npIoTrapLevelLegend=npIoTrapLevelLegend, npSoftReboot=npSoftReboot, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIo=npIo, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npRelHumTempStatus=npRelHumTempStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumMemo=npRelHumMemo)
