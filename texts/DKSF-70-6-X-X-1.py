...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:24:07 2021
...
Unsigned32, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, NotificationType, Counter32, iso, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "NotificationType", "Counter32", "iso", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npThermoLow=npThermoLow, npIr=npIr, npReboot=npReboot, npCurLoopTrap=npCurLoopTrap, npCurLoopTraps=npCurLoopTraps, npRelayMode=npRelayMode, npSmokeTrapMemo=npSmokeTrapMemo, npResetStack=npResetStack, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopEntry=npCurLoopEntry, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapV=npCurLoopTrapV, npIoLevelOut=npIoLevelOut, npThermoValue=npThermoValue, npRelayState=npRelayState, npGsmTraps=npGsmTraps, npThermo=npThermo, npCurLoopTable=npCurLoopTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, FixedPoint1000=FixedPoint1000, npRelayMemo=npRelayMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIrStatus=npIrStatus, npIo=npIo, npGsm=npGsm, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npIrCtrl=npIrCtrl, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npSoftReboot=npSoftReboot, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npCurLoopPower=npCurLoopPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumValue=npRelHumValue, npCurLoop=npCurLoop, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npIoMemo=npIoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelay=npRelay, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeEntry=npSmokeEntry)
