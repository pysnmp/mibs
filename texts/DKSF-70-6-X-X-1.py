...
# Produced by pysmi-1.1.12 at Wed May 29 07:25:54 2024
...
Bits, MibIdentifier, Gauge32, Counter64, NotificationType, Integer32, ModuleIdentity, iso, Counter32, TimeTicks, ObjectIdentity, IpAddress, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Gauge32", "Counter64", "NotificationType", "Integer32", "ModuleIdentity", "iso", "Counter32", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsm=npGsm, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelayN=npRelayN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npCurLoopV=npCurLoopV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npCurLoopPower=npCurLoopPower, npRelHumidity=npRelHumidity, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTraps=npSmokeTraps, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npIr=npIr, npIrCtrl=npIrCtrl, npForcedReboot=npForcedReboot, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npSmokeReset=npSmokeReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapInfo=npTrapInfo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, lightcom=lightcom, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npSmoke=npSmoke, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npIoEntry=npIoEntry, npRelHumMemo=npRelHumMemo, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npSoftReboot=npSoftReboot, npRelayState=npRelayState, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npRelayMode=npRelayMode, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapR=npCurLoopTrapR, npGsmTrap=npGsmTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, npGsmStrength=npGsmStrength, npThermoHigh=npThermoHigh, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoStatus=npThermoStatus, npReboot=npReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npRelayStartReset=npRelayStartReset, npThermoTraps=npThermoTraps, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npIoTrap=npIoTrap, npRelHumTempValue=npRelHumTempValue, npThermoTrapMemo=npThermoTrapMemo)
