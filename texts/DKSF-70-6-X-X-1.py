...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:41:41 2022
...
IpAddress, NotificationType, Bits, Integer32, ObjectIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, ModuleIdentity, iso, Unsigned32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Bits", "Integer32", "ObjectIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "ModuleIdentity", "iso", "Unsigned32", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npIoPulseCounter=npIoPulseCounter, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npThermoLow=npThermoLow, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npIr=npIr, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npResetStack=npResetStack, npThermoTrapSensorN=npThermoTrapSensorN, npRelayMemo=npRelayMemo, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelIn=npIoTrapLevelIn, npThermoHigh=npThermoHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npSmokeTable=npSmokeTable, npRelayN=npRelayN, npCurLoopV=npCurLoopV, npRelHumTempStatus=npRelHumTempStatus, npIoTrapPrefix=npIoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValue=npThermoValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npSmokeEntry=npSmokeEntry, npGsmStrength=npGsmStrength, npThermoMemo=npThermoMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopTrap=npCurLoopTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsm=npGsm, npIrStatus=npIrStatus, npIrCtrl=npIrCtrl, npCurLoopN=npCurLoopN, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npGsmRegistration=npGsmRegistration, npGsmInfo=npGsmInfo, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrap=npThermoTrap, npIo=npIo, npRelHumTempValue=npRelHumTempValue, npReboot=npReboot, npRelay=npRelay, npGsmTrap=npGsmTrap, npIoTable=npIoTable, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps, npRelHumN=npRelHumN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npThermo=npThermo, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npIoLineN=npIoLineN, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npIoLevelOut=npIoLevelOut, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus)
