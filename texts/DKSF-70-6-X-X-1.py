...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:25:56 2023
...
ModuleIdentity, enterprises, Unsigned32, IpAddress, MibIdentifier, Counter32, Integer32, Counter64, Bits, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier", "Counter32", "Integer32", "Counter64", "Bits", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npRelHumTempValue=npRelHumTempValue, npRelHumN=npRelHumN, npIoLevelOut=npIoLevelOut, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npIrReset=npIrReset, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npSoftReboot=npSoftReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npSmokeMemo=npSmokeMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrap=npCurLoopTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIr=npIr, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npThermoTrapValue=npThermoTrapValue, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapFail=npRelHumTrapFail, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmFailed=npGsmFailed, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, npRelayState=npRelayState, npIoTrap=npIoTrap, npThermoTrap=npThermoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, lightcom=lightcom, npResetStack=npResetStack, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npSmokeEntry=npSmokeEntry, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmoke=npSmoke, npThermoMemo=npThermoMemo, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, npRelay=npRelay, npIoPulseCounter=npIoPulseCounter, npCurLoopTraps=npCurLoopTraps, npSmokeStatus=npSmokeStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmInfo=npGsmInfo, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeReset=npSmokeReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable)
