...
# Produced by pysmi-1.1.12 at Tue May 28 13:12:08 2024
...
ModuleIdentity, Counter32, Gauge32, MibIdentifier, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Unsigned32, iso, Bits, TimeTicks, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Gauge32", "MibIdentifier", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "Bits", "TimeTicks", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelay=npRelay, npCurLoopEntry=npCurLoopEntry, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, lightcom=lightcom, npCurLoop=npCurLoop, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npThermoTraps=npThermoTraps, npIoTrapPrefix=npIoTrapPrefix, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npCurLoopTrap=npCurLoopTrap, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npIrCtrl=npIrCtrl, npSmokeTrap=npSmokeTrap, npIoEntry=npIoEntry, npRelayStartReset=npRelayStartReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npCurLoopR=npCurLoopR, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npThermoTrap=npThermoTrap, npIrStatus=npIrStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npThermoMemo=npThermoMemo, npCurLoopPower=npCurLoopPower, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapLow=npThermoTrapLow, npGsmRegistration=npGsmRegistration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPower=npCurLoopTrapPower, npIoTable=npIoTable, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npThermo=npThermo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTraps=npIoTraps, npGsm=npGsm, npSmokeEntry=npSmokeEntry, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npThermoEntry=npThermoEntry, npRelayMemo=npRelayMemo, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumValue=npRelHumValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeMemo=npSmokeMemo, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npTrapInfo=npTrapInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npThermoLow=npThermoLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmoke=npSmoke)
