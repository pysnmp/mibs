...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:12:52 2022
...
Bits, ObjectIdentity, Unsigned32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, NotificationType, Gauge32, Counter64, iso, IpAddress, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "NotificationType", "Gauge32", "Counter64", "iso", "IpAddress", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npThermoValue=npThermoValue, npCurLoop=npCurLoop, npGsmInfo=npGsmInfo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumStatus=npRelHumStatus, npSmokeEntry=npSmokeEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npGsmFailed=npGsmFailed, npThermoTable=npThermoTable, npRelHumidity=npRelHumidity, npThermoSensorN=npThermoSensorN, npRelHumTrap=npRelHumTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsm=npGsm, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelIn=npIoLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelHumEntry=npRelHumEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopPower=npCurLoopPower, npCurLoopTrapR=npCurLoopTrapR, npSmokeStatus=npSmokeStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempValue=npRelHumTempValue, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npRelHumTable=npRelHumTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokePower=npSmokePower, npSmokeSensorN=npSmokeSensorN, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npRelHumTrapFail=npRelHumTrapFail, npIoPulseCounter=npIoPulseCounter, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npRelayTable=npRelayTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTraps=npSmokeTraps, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapV=npCurLoopTrapV, npSmokeMemo=npSmokeMemo, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npReboot=npReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermo=npThermo, npIrCtrl=npIrCtrl, npIoLevelOut=npIoLevelOut, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopEntry=npCurLoopEntry, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapData=npRelHumTrapData, npIrReset=npIrReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap, npRelayState=npRelayState, npIoTraps=npIoTraps, npSmokeReset=npSmokeReset, npCurLoopV=npCurLoopV, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke)
