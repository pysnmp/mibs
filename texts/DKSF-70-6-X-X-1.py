...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:16:10 2024
...
iso, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, TimeTicks, Bits, ObjectIdentity, Counter64, Integer32, Gauge32, IpAddress, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "TimeTicks", "Bits", "ObjectIdentity", "Counter64", "Integer32", "Gauge32", "IpAddress", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIr=npIr, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrap=npRelHumTrap, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npRelHumTrapDataN=npRelHumTrapDataN, npRelayN=npRelayN, npCurLoopTrapV=npCurLoopTrapV, npCurLoopPower=npCurLoopPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npCurLoopI=npCurLoopI, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npRelay=npRelay, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npRelHumMemo=npRelHumMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npIoTable=npIoTable, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTable=npRelHumTable, npIoLevelIn=npIoLevelIn, npTrapInfo=npTrapInfo, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMemo=npRelayMemo, npIoSinglePulseStart=npIoSinglePulseStart, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npResetStack=npResetStack, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npSmokeEntry=npSmokeEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npIoLevelOut=npIoLevelOut, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npIo=npIo, npRelHumidity=npRelHumidity, npSmokeMemo=npSmokeMemo, npThermoSensorN=npThermoSensorN, npIoPulseCounter=npIoPulseCounter, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npRelHumStatus=npRelHumStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, lightcom=lightcom, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps)
