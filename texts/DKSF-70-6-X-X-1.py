...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:24:21 2021
...
Bits, ModuleIdentity, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Counter64, Counter32, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Counter64", "Counter32", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmFailed=npGsmFailed, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npGsm=npGsm, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npIoTraps=npIoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTable=npIoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npRelHumTrap=npRelHumTrap, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npRelHumTrapTemp=npRelHumTrapTemp, npIoPulseCounter=npIoPulseCounter, npRelayN=npRelayN, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopN=npCurLoopN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrap=npGsmTrap, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, npRelayTable=npRelayTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npResetStack=npResetStack, npCurLoop=npCurLoop, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTraps=npGsmTraps, npSmokeEntry=npSmokeEntry, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npCurLoopTrapPower=npCurLoopTrapPower, npForcedReboot=npForcedReboot, npThermoEntry=npThermoEntry, npRelHumStatus=npRelHumStatus, npThermoTrap=npThermoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrStatus=npIrStatus, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npSmokePower=npSmokePower, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumMemo=npRelHumMemo, npRelayMode=npRelayMode, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npTrapInfo=npTrapInfo, npIoTrapMemo=npIoTrapMemo, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeReset=npSmokeReset, npCurLoopTrapN=npCurLoopTrapN, npCurLoopPower=npCurLoopPower, npThermo=npThermo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopV=npCurLoopV, npCurLoopTraps=npCurLoopTraps, npCurLoopTable=npCurLoopTable, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npThermoMemo=npThermoMemo, npSmokeTrap=npSmokeTrap, npIoLevelOut=npIoLevelOut)
