...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:27:43 2021
...
TimeTicks, Counter32, enterprises, Integer32, Counter64, MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "enterprises", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopI=npCurLoopI, npIoTable=npIoTable, npRelHumTable=npRelHumTable, lightcom=lightcom, npCurLoopTrapR=npCurLoopTrapR, npIoTrap=npIoTrap, npThermoMemo=npThermoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npThermo=npThermo, npSoftReboot=npSoftReboot, npIoPulseCounter=npIoPulseCounter, npSmokeTable=npSmokeTable, npIo=npIo, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npCurLoopTraps=npCurLoopTraps, npCurLoopTable=npCurLoopTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayN=npRelayN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumidity=npRelHumidity, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMemo=npRelayMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapMemo=npIoTrapMemo, npRelHumN=npRelHumN, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npThermoTrap=npThermoTrap, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npSmoke=npSmoke, npForcedReboot=npForcedReboot, npIrCtrl=npIrCtrl, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npSmokeReset=npSmokeReset, npCurLoopTrapI=npCurLoopTrapI, npRelayState=npRelayState, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npThermoTraps=npThermoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npReboot=npReboot, npThermoEntry=npThermoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npRelayTable=npRelayTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmFailed=npGsmFailed, npIr=npIr, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npRelHumTrapTemp=npRelHumTrapTemp, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npSmokeSensorN=npSmokeSensorN, npCurLoop=npCurLoop, npSmokeEntry=npSmokeEntry, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValue=npThermoValue, npCurLoopPower=npCurLoopPower)
