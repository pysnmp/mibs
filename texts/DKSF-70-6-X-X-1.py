...
# Produced by pysmi-1.1.8 at Wed Feb  2 19:33:08 2022
...
MibIdentifier, Counter32, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, Counter64, ObjectIdentity, Integer32, IpAddress, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "Counter64", "ObjectIdentity", "Integer32", "IpAddress", "ModuleIdentity", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npIo=npIo, npThermoTrapMemo=npThermoTrapMemo, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npRelayMemo=npRelayMemo, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npThermoHigh=npThermoHigh, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataN=npRelHumTrapDataN, npGsmStrength=npGsmStrength, npRelayTable=npRelayTable, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeMemo=npSmokeMemo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npSmokeTraps=npSmokeTraps, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npRelayMode=npRelayMode, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npGsmFailed=npGsmFailed, npThermoTraps=npThermoTraps, npGsmTrap=npGsmTrap, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelay=npRelay, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npThermoTable=npThermoTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrap=npRelHumTrap, npThermoValue=npThermoValue, npSmokeReset=npSmokeReset, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermo=npThermo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelIn=npIoLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumMemo=npRelHumMemo, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npCurLoopTrapV=npCurLoopTrapV, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npIoPulseCounter=npIoPulseCounter)
