...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:44:38 2023
...
ModuleIdentity, Counter64, TimeTicks, IpAddress, Counter32, Bits, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Gauge32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "TimeTicks", "IpAddress", "Counter32", "Bits", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Gauge32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTraps=npIoTraps, npRelayMemo=npRelayMemo, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npRelayEntry=npRelayEntry, npRelHumMemo=npRelHumMemo, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, npIr=npIr, npRelHumValue=npRelHumValue, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npReboot=npReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npRelayN=npRelayN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoMemo=npIoMemo, npRelHumidity=npRelHumidity, npIo=npIo, npForcedReboot=npForcedReboot, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopR=npCurLoopR, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapData=npRelHumTrapData, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npRelay=npRelay, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npIoTrapLineN=npIoTrapLineN, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npThermoTrapMemo=npThermoTrapMemo, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTable=npThermoTable, npRelayTable=npRelayTable, npSmokeMemo=npSmokeMemo, npIrCtrl=npIrCtrl, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npIrStatus=npIrStatus, npSmokePower=npSmokePower, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopV=npCurLoopV, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, npRelHumTable=npRelHumTable, npCurLoopStatus=npCurLoopStatus, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npCurLoopTable=npCurLoopTable, npGsm=npGsm, lightcom=lightcom, npThermoLow=npThermoLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, npIoLevelOut=npIoLevelOut, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeEntry=npSmokeEntry, npSmokeTrapMemo=npSmokeTrapMemo, npResetStack=npResetStack, npIrReset=npIrReset, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npCurLoopEntry=npCurLoopEntry, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
