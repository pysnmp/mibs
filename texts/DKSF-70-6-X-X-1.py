...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:35:03 2023
...
Unsigned32, Bits, enterprises, IpAddress, ObjectIdentity, ModuleIdentity, MibIdentifier, Counter64, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "enterprises", "IpAddress", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Counter64", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapStatus=npSmokeTrapStatus, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapR=npCurLoopTrapR, npIrPlayCmd=npIrPlayCmd, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopStatus=npCurLoopStatus, npThermoTraps=npThermoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapLow=npThermoTrapLow, npRelHumN=npRelHumN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIrStatus=npIrStatus, npRelay=npRelay, npIoLevelOut=npIoLevelOut, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelayMemo=npRelayMemo, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTraps=npCurLoopTraps, npIoLineN=npIoLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeEntry=npSmokeEntry, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npReboot=npReboot, npSmoke=npSmoke, npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npThermoTrap=npThermoTrap, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTable=npRelHumTable, npSmokeTable=npSmokeTable, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrReset=npIrReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npIr=npIr, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npCurLoopV=npCurLoopV, lightcom=lightcom, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeSensorN=npSmokeSensorN, npThermoLow=npThermoLow, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelHumEntry=npRelHumEntry, npIoTable=npIoTable, npRelayN=npRelayN, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npCurLoopPower=npCurLoopPower, npTrapInfo=npTrapInfo, npIoPulseCounter=npIoPulseCounter, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npResetStack=npResetStack, npIoTrapMemo=npIoTrapMemo, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTable=npCurLoopTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, npSmokeReset=npSmokeReset, npIo=npIo, npThermoMemo=npThermoMemo, npIoLevelIn=npIoLevelIn, npRelayTable=npRelayTable, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npThermoValue=npThermoValue, npRelayMode=npRelayMode, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrap=npSmokeTrap)
