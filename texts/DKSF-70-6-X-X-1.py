...
ModuleIdentity, Counter64, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ObjectIdentity, TimeTicks, NotificationType, iso, Bits, Unsigned32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ObjectIdentity", "TimeTicks", "NotificationType", "iso", "Bits", "Unsigned32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmRegistration=npGsmRegistration, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsm=npGsm, npThermoEntry=npThermoEntry, npRelHumTrap=npRelHumTrap, npCurLoopTrapR=npCurLoopTrapR, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, npRelay=npRelay, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npIoLevelOut=npIoLevelOut, npThermoTraps=npThermoTraps, npGsmTraps=npGsmTraps, npRelHumTable=npRelHumTable, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npGsmTrap=npGsmTrap, npThermoTrapMemo=npThermoTrapMemo, npForcedReboot=npForcedReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npIo=npIo, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npRelayTable=npRelayTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npThermoStatus=npThermoStatus, npCurLoopI=npCurLoopI, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npGsmFailed=npGsmFailed, npThermoValue=npThermoValue, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeMemo=npSmokeMemo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopR=npCurLoopR, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapInfo=npTrapInfo, npIrReset=npIrReset, npIoEntry=npIoEntry, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrap=npIoTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npIoMemo=npIoMemo, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayStartReset=npRelayStartReset)
