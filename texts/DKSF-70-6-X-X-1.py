...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:41:44 2024
...
enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, Bits, IpAddress, Counter64, Integer32, Counter32, Unsigned32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Bits", "IpAddress", "Counter64", "Integer32", "Counter32", "Unsigned32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, npIr=npIr, npIoLevelOut=npIoLevelOut, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npGsmInfo=npGsmInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLineN=npIoLineN, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npGsmStrength=npGsmStrength, npIrCtrl=npIrCtrl, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npRelay=npRelay, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npThermoStatus=npThermoStatus, npSoftReboot=npSoftReboot, npGsmFailed=npGsmFailed, npIoMemo=npIoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npThermoMemo=npThermoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopI=npCurLoopI, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npCurLoopStatus=npCurLoopStatus, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoLow=npThermoLow, npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npRelHumMemo=npRelHumMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, lightcom=lightcom, npCurLoopTraps=npCurLoopTraps, npRelHumTempValue=npRelHumTempValue, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npThermoValue=npThermoValue, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npSmokeTable=npSmokeTable, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, npThermoTraps=npThermoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeReset=npSmokeReset, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIo=npIo, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh)
