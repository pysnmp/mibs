...
# Produced by pysmi-1.1.12 at Tue Jun 18 01:42:01 2024
...
MibIdentifier, ModuleIdentity, TimeTicks, Counter32, Unsigned32, Counter64, ObjectIdentity, IpAddress, enterprises, iso, Integer32, Bits, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Counter32", "Unsigned32", "Counter64", "ObjectIdentity", "IpAddress", "enterprises", "iso", "Integer32", "Bits", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npRelayTable=npRelayTable, npCurLoopTable=npCurLoopTable, npSmokeMemo=npSmokeMemo, npTrapEmailTo=npTrapEmailTo, npIr=npIr, npThermoHigh=npThermoHigh, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npGsmInfo=npGsmInfo, npIoTraps=npIoTraps, npRelHumTable=npRelHumTable, npIoTrapLineN=npIoTrapLineN, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeSensorN=npSmokeSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npIo=npIo, npCurLoopI=npCurLoopI, npRelHumN=npRelHumN, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npRelayN=npRelayN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npCurLoopV=npCurLoopV, lightcom=lightcom, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumStatus=npRelHumStatus, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoMemo=npIoMemo, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npTrapInfo=npTrapInfo, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npIoLevelIn=npIoLevelIn, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, npThermoTrapSensorN=npThermoTrapSensorN, npSmoke=npSmoke, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npReboot=npReboot, npThermoTraps=npThermoTraps, npCurLoopPower=npCurLoopPower, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrap=npSmokeTrap, npIoSinglePulseStart=npIoSinglePulseStart, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelayState=npRelayState, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumMemo=npRelHumMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npCurLoopTrap=npCurLoopTrap, npRelayMode=npRelayMode, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl)
