...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:05:50 2023
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, MibIdentifier, iso, NotificationType, ObjectIdentity, Counter64, TimeTicks, IpAddress, Integer32, Bits, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "ObjectIdentity", "Counter64", "TimeTicks", "IpAddress", "Integer32", "Bits", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayState=npRelayState, npSmoke=npSmoke, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIr=npIr, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMemo=npRelayMemo, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npGsmFailed=npGsmFailed, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npSmokeReset=npSmokeReset, npIoTrapPrefix=npIoTrapPrefix, npIoMemo=npIoMemo, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npResetStack=npResetStack, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, npThermoSensorN=npThermoSensorN, npThermoLow=npThermoLow, npCurLoop=npCurLoop, npSmokeEntry=npSmokeEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumValue=npRelHumValue, npRelayN=npRelayN, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, FixedPoint1000=FixedPoint1000, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npIoTable=npIoTable, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumEntry=npRelHumEntry, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npIoEntry=npIoEntry, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, lightcom=lightcom, npSmokeTrapStatus=npSmokeTrapStatus, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayTable=npRelayTable, npGsmTrap=npGsmTrap, npRelHumMemo=npRelHumMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumidity=npRelHumidity, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumStatus=npRelHumStatus, npIrPlayCmd=npIrPlayCmd, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npIrCtrl=npIrCtrl, npRelay=npRelay, npCurLoopEntry=npCurLoopEntry, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npCurLoopPower=npCurLoopPower)
