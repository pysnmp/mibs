...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:45:36 2021
...
Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, NotificationType, Unsigned32, Gauge32, iso, Bits, MibIdentifier, ModuleIdentity, IpAddress, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "NotificationType", "Unsigned32", "Gauge32", "iso", "Bits", "MibIdentifier", "ModuleIdentity", "IpAddress", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npRelayTable=npRelayTable, npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npRelayState=npRelayState, npIrPlayCmd=npIrPlayCmd, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsm=npGsm, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npThermoTraps=npThermoTraps, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npSmoke=npSmoke, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoLow=npThermoLow, npThermoTable=npThermoTable, npIoLevelOut=npIoLevelOut, npGsmFailed=npGsmFailed, npCurLoopTrap=npCurLoopTrap, npThermo=npThermo, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopI=npCurLoopI, npRelHumTable=npRelHumTable, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npResetStack=npResetStack, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmInfo=npGsmInfo, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npIr=npIr, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npThermoStatus=npThermoStatus, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopN=npCurLoopN, npRelHumStatus=npRelHumStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopR=npCurLoopR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeReset=npSmokeReset)
