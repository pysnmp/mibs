...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:54:52 2021
...
Bits, ObjectIdentity, iso, Counter32, ModuleIdentity, IpAddress, Counter64, Unsigned32, NotificationType, Integer32, MibIdentifier, Gauge32, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "iso", "Counter32", "ModuleIdentity", "IpAddress", "Counter64", "Unsigned32", "NotificationType", "Integer32", "MibIdentifier", "Gauge32", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npIr=npIr, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npResetStack=npResetStack, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelayStartReset=npRelayStartReset, npThermoTraps=npThermoTraps, npRelHumTable=npRelHumTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, FixedPoint1000=FixedPoint1000, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npRelHumTrapFail=npRelHumTrapFail, npRelay=npRelay, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumValue=npRelHumValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npGsmTraps=npGsmTraps, npIoTable=npIoTable, npThermoLow=npThermoLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeReset=npSmokeReset, npSmokeEntry=npSmokeEntry, npRelHumStatus=npRelHumStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrap=npIoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npThermoEntry=npThermoEntry, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopR=npCurLoopR, npGsmTrap=npGsmTrap, npCurLoopStatus=npCurLoopStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelIn=npIoLevelIn, npThermoTrapLow=npThermoTrapLow, npRelHumTempValue=npRelHumTempValue, npRelayEntry=npRelayEntry, npCurLoopTrap=npCurLoopTrap, npGsmFailed=npGsmFailed, npRelHumTrapTemp=npRelHumTrapTemp, npThermoHigh=npThermoHigh, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumN=npRelHumN, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIrStatus=npIrStatus, npIoMemo=npIoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npForcedReboot=npForcedReboot, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npSmoke=npSmoke, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTraps=npSmokeTraps, npSmokeTable=npSmokeTable, npThermoTrap=npThermoTrap, npReboot=npReboot, npRelHumTrapData=npRelHumTrapData, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npCurLoopI=npCurLoopI, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npRelHumidity=npRelHumidity, npCurLoopTrapR=npCurLoopTrapR, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo)
