...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:53:17 2021
...
enterprises, Bits, iso, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Gauge32, ModuleIdentity, IpAddress, NotificationType, Counter32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "iso", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Gauge32", "ModuleIdentity", "IpAddress", "NotificationType", "Counter32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumN=npRelHumN, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayN=npRelayN, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npIoTable=npIoTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npRelayTable=npRelayTable, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmFailed=npGsmFailed, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeStatus=npSmokeStatus, npRelHumTempValue=npRelHumTempValue, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npSmokePower=npSmokePower, lightcom=lightcom, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npIoEntry=npIoEntry, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npIr=npIr, npSmokeReset=npSmokeReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npIoTraps=npIoTraps, npReboot=npReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoop=npCurLoop, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npRelHumValue=npRelHumValue, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npRelay=npRelay, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTraps=npGsmTraps, npTrapInfo=npTrapInfo, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npRelHumTrapFail=npRelHumTrapFail, FixedPoint1000=FixedPoint1000, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npGsmTrap=npGsmTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumMemo=npRelHumMemo, npCurLoopTrapI=npCurLoopTrapI, npGsmInfo=npGsmInfo, npThermo=npThermo, npCurLoopTrap=npCurLoopTrap, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npSmokeTable=npSmokeTable, npSmoke=npSmoke, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npRelHumStatus=npRelHumStatus, npRelayMode=npRelayMode, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh)
