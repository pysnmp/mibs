...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:01:02 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Counter64, Unsigned32, iso, TimeTicks, Bits, Integer32, Counter32, ObjectIdentity, NotificationType, enterprises, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Counter64", "Unsigned32", "iso", "TimeTicks", "Bits", "Integer32", "Counter32", "ObjectIdentity", "NotificationType", "enterprises", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npIoTable=npIoTable, npRelHumTempStatus=npRelHumTempStatus, npGsmRegistration=npGsmRegistration, npRelHumTempValue=npRelHumTempValue, npThermoTrap=npThermoTrap, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, npSmokeTraps=npSmokeTraps, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npSmoke=npSmoke, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npGsmStrength=npGsmStrength, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumidity=npRelHumidity, npRelayMode=npRelayMode, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npResetStack=npResetStack, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoMemo=npIoMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumValue=npRelHumValue, npRelayStartReset=npRelayStartReset, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npSoftReboot=npSoftReboot, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npReboot=npReboot, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopV=npCurLoopV, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeEntry=npSmokeEntry, npSmokeTrapStatus=npSmokeTrapStatus, npTrapInfo=npTrapInfo, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLineN=npIoTrapLineN, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoHigh=npThermoHigh, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npIr=npIr, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npIoEntry=npIoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npIoTrapMemo=npIoTrapMemo, npRelayMemo=npRelayMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopR=npCurLoopR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npGsm=npGsm, npThermoStatus=npThermoStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI, lightcom=lightcom, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, npGsmTraps=npGsmTraps, npIoTraps=npIoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable)
