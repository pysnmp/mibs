...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:22:09 2022
...
Counter32, Gauge32, enterprises, Counter64, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, IpAddress, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "enterprises", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "IpAddress", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumN=npRelHumN, lightcom=lightcom, npSmokePower=npSmokePower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npRelHumStatus=npRelHumStatus, npRelHumEntry=npRelHumEntry, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npSmoke=npSmoke, npSmokeStatus=npSmokeStatus, npCurLoopTrapN=npCurLoopTrapN, npRelay=npRelay, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npSmokeTable=npSmokeTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npGsmFailed=npGsmFailed, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npIrStatus=npIrStatus, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npCurLoopTable=npCurLoopTable, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npForcedReboot=npForcedReboot, npGsm=npGsm, npIoTrap=npIoTrap, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayState=npRelayState, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopTrap=npCurLoopTrap, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npThermoTrapMemo=npThermoTrapMemo, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, npCurLoopTrapR=npCurLoopTrapR, npGsmTraps=npGsmTraps, npRelHumValue=npRelHumValue, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npThermoTrapHigh=npThermoTrapHigh, npThermoStatus=npThermoStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmInfo=npGsmInfo, npIo=npIo, npIrReset=npIrReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, npRelHumTrap=npRelHumTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, FixedPoint1000=FixedPoint1000, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npGsmRegistration=npGsmRegistration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npRelayMemo=npRelayMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npThermoEntry=npThermoEntry)
