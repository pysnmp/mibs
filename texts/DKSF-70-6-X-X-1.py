...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:48:47 2022
...
iso, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, IpAddress, enterprises, Counter64, Unsigned32, NotificationType, Bits, Integer32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "IpAddress", "enterprises", "Counter64", "Unsigned32", "NotificationType", "Bits", "Integer32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npIrReset=npIrReset, npIo=npIo, npThermoEntry=npThermoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npIoTrapPrefix=npIoTrapPrefix, npGsmTraps=npGsmTraps, npSmokeStatus=npSmokeStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmoke=npSmoke, lightcom=lightcom, npForcedReboot=npForcedReboot, npReboot=npReboot, npRelHumValue=npRelHumValue, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npThermoHigh=npThermoHigh, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npIrPlayCmd=npIrPlayCmd, npRelHumidity=npRelHumidity, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapStatus=npThermoTrapStatus, npThermoTable=npThermoTable, npGsmStrength=npGsmStrength, npRelHumTrap=npRelHumTrap, npSmokeReset=npSmokeReset, npRelHumStatus=npRelHumStatus, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoop=npCurLoop, npCurLoopTrap=npCurLoopTrap, npThermoMemo=npThermoMemo, npTrapInfo=npTrapInfo, npCurLoopTable=npCurLoopTable, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapR=npCurLoopTrapR, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npIoTrapLineN=npIoTrapLineN, npGsmInfo=npGsmInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelIn=npIoLevelIn, npThermoTrapHigh=npThermoTrapHigh, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIr=npIr, npRelayState=npRelayState, npThermoStatus=npThermoStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTable=npSmokeTable, npRelayMode=npRelayMode, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npGsmTrap=npGsmTrap, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelay=npRelay, npRelHumN=npRelHumN, npIoTable=npIoTable, npIrCtrl=npIrCtrl, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed, npSmokeEntry=npSmokeEntry, npRelHumTable=npRelHumTable, npRelayTable=npRelayTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npThermoSensorN=npThermoSensorN)
