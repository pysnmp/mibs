...
# Produced by pysmi-1.1.12 at Tue May 28 14:01:51 2024
...
TimeTicks, MibIdentifier, Unsigned32, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Gauge32, Counter32, NotificationType, Counter64, iso, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Unsigned32", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Gauge32", "Counter32", "NotificationType", "Counter64", "iso", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayStartReset=npRelayStartReset, npGsm=npGsm, npResetStack=npResetStack, npCurLoopR=npCurLoopR, npTrapEmailTo=npTrapEmailTo, npSmokeTrapPrefix=npSmokeTrapPrefix, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumMemo=npRelHumMemo, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopPower=npCurLoopPower, npThermoSensorN=npThermoSensorN, npGsmTrap=npGsmTrap, npSmokeSensorN=npSmokeSensorN, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTable=npSmokeTable, npIrCtrl=npIrCtrl, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npCurLoopTraps=npCurLoopTraps, npThermoMemo=npThermoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrap=npIoTrap, npThermoTrap=npThermoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTraps=npIoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npThermoTraps=npThermoTraps, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npIoMemo=npIoMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmoke=npSmoke, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIr=npIr, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npRelHumTrapData=npRelHumTrapData, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npIo=npIo, npSmokePower=npSmokePower, npSmokeStatus=npSmokeStatus, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npThermoStatus=npThermoStatus, npThermoEntry=npThermoEntry, npForcedReboot=npForcedReboot, npIoTrapMemo=npIoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTable=npThermoTable, lightcom=lightcom, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapValue=npThermoTrapValue, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npGsmInfo=npGsmInfo, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLineN=npIoTrapLineN, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, npIoEntry=npIoEntry, npGsmStrength=npGsmStrength, npRelayN=npRelayN, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay)
