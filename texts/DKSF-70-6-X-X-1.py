...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:19:43 2022
...
Bits, enterprises, IpAddress, Counter64, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ModuleIdentity, iso, Integer32, ObjectIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "IpAddress", "Counter64", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ModuleIdentity", "iso", "Integer32", "ObjectIdentity", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npThermoValue=npThermoValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npIoMemo=npIoMemo, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npCurLoopTrapPower=npCurLoopTrapPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npReboot=npReboot, npThermoTable=npThermoTable, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npCurLoop=npCurLoop, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, npThermo=npThermo, npIoLineN=npIoLineN, npRelay=npRelay, npIrCtrl=npIrCtrl, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempValue=npRelHumTempValue, npCurLoopPower=npCurLoopPower, npIo=npIo, npSmokeMemo=npSmokeMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrap=npCurLoopTrap, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npTrapInfo=npTrapInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeEntry=npSmokeEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npResetStack=npResetStack, npGsmRegistration=npGsmRegistration, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTrapData=npRelHumTrapData, npRelayMemo=npRelayMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npRelHumTable=npRelHumTable, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npGsmTrap=npGsmTrap, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npCurLoopN=npCurLoopN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npCurLoopR=npCurLoopR, npGsmTraps=npGsmTraps, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npThermoTrapHigh=npThermoTrapHigh, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, lightcom=lightcom)
