...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:21:09 2021
...
NotificationType, Integer32, ModuleIdentity, Unsigned32, Gauge32, Counter64, TimeTicks, Bits, IpAddress, MibIdentifier, ObjectIdentity, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter64", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npRelHumTempStatus=npRelHumTempStatus, npIrCtrl=npIrCtrl, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTraps=npThermoTraps, npCurLoopPower=npCurLoopPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npIo=npIo, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npRelHumEntry=npRelHumEntry, npRelHumTrapFail=npRelHumTrapFail, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npThermoSensorN=npThermoSensorN, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npThermoStatus=npThermoStatus, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmoke=npSmoke, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npThermoTrapValue=npThermoTrapValue, npCurLoopTraps=npCurLoopTraps, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokePower=npSmokePower, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLevelIn=npIoLevelIn, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapV=npCurLoopTrapV, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTable=npSmokeTable, lightcom=lightcom, npCurLoopN=npCurLoopN, npRelHumTrap=npRelHumTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npForcedReboot=npForcedReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npIoTrapLevelIn=npIoTrapLevelIn, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npReboot=npReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npRelayN=npRelayN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoEntry=npIoEntry, npThermoHigh=npThermoHigh, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npSmokeReset=npSmokeReset, npIoTraps=npIoTraps, npThermoTrapLow=npThermoTrapLow, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus)
