...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:08:54 2023
...
TimeTicks, enterprises, Bits, Counter64, Gauge32, ObjectIdentity, iso, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoPulseCounter=npIoPulseCounter, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npIoTraps=npIoTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapMemo=npIoTrapMemo, npIoMemo=npIoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npRelayState=npRelayState, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npIoEntry=npIoEntry, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTraps=npGsmTraps, npThermoSensorN=npThermoSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopStatus=npCurLoopStatus, npSmokeReset=npSmokeReset, npIoLevelIn=npIoLevelIn, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npThermoTraps=npThermoTraps, npSmokeMemo=npSmokeMemo, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeStatus=npSmokeStatus, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelay=npRelay, lightcom=lightcom, npIoTrap=npIoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapValue=npThermoTrapValue, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoStatus=npThermoStatus, npGsm=npGsm, npCurLoopTrapV=npCurLoopTrapV, npIoLevelOut=npIoLevelOut, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapR=npCurLoopTrapR, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrCtrl=npIrCtrl, npSmokeTrap=npSmokeTrap, npIrReset=npIrReset, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npThermoMemo=npThermoMemo, npRelayN=npRelayN, npRelHumTrapSafe=npRelHumTrapSafe, npForcedReboot=npForcedReboot, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTable=npRelHumTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIr=npIr, npIoTable=npIoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumMemo=npRelHumMemo, npCurLoopV=npCurLoopV, npThermoTrap=npThermoTrap, npSmokeTable=npSmokeTable, npRelHumValue=npRelHumValue, npIoLineN=npIoLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopEntry=npCurLoopEntry, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTable=npThermoTable, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npRelayEntry=npRelayEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npCurLoop=npCurLoop, npRelHumTrapFail=npRelHumTrapFail)
