...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:50:12 2022
...
iso, Counter64, Gauge32, Counter32, NotificationType, Unsigned32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Integer32, ModuleIdentity, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Gauge32", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps, npSmokeEntry=npSmokeEntry, npThermoLow=npThermoLow, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npRelayEntry=npRelayEntry, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, lightcom=lightcom, npReboot=npReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapInfo=npTrapInfo, FixedPoint1000=FixedPoint1000, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTable=npCurLoopTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npRelay=npRelay, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npThermoStatus=npThermoStatus, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumidity=npRelHumidity, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npSoftReboot=npSoftReboot, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npIrStatus=npIrStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npRelHumTempStatus=npRelHumTempStatus, npIoTrapMemo=npIoTrapMemo, npRelayTable=npRelayTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayN=npRelayN, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npIr=npIr, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapHigh=npThermoTrapHigh, npIoLineN=npIoLineN, npRelHumN=npRelHumN, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npIoTraps=npIoTraps, npThermoTrap=npThermoTrap, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npTrapEmailTo=npTrapEmailTo, npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTable=npThermoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopPower=npCurLoopPower, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut)
