...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:21:41 2023
...
NotificationType, Bits, enterprises, Gauge32, ObjectIdentity, Counter64, Integer32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, TimeTicks, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "enterprises", "Gauge32", "ObjectIdentity", "Counter64", "Integer32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeEntry=npSmokeEntry, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrap=npIoTrap, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npGsmTrap=npGsmTrap, npGsm=npGsm, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npIoTable=npIoTable, npThermoTrapMemo=npThermoTrapMemo, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapR=npCurLoopTrapR, npSmoke=npSmoke, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npSmokeTrapStatus=npSmokeTrapStatus, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npSmokeSensorN=npSmokeSensorN, npIo=npIo, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, npIoEntry=npIoEntry, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, npSmokeTable=npSmokeTable, npThermoTrapStatus=npThermoTrapStatus, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoStatus=npThermoStatus, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrStatus=npIrStatus, npThermo=npThermo, npSmokeStatus=npSmokeStatus, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopR=npCurLoopR, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npThermoTrap=npThermoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrap=npSmokeTrap, npGsmTraps=npGsmTraps, npThermoHigh=npThermoHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npRelay=npRelay, npSmokeTrapMemo=npSmokeTrapMemo)
