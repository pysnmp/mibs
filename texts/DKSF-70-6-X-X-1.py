...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:04:57 2023
...
iso, Integer32, Gauge32, Counter64, enterprises, Bits, ObjectIdentity, MibIdentifier, NotificationType, TimeTicks, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Gauge32", "Counter64", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npSoftReboot=npSoftReboot, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, npThermoTrapMemo=npThermoTrapMemo, npIo=npIo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npGsmFailed=npGsmFailed, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npCurLoopEntry=npCurLoopEntry, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npThermo=npThermo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumN=npRelHumN, npIoTrapMemo=npIoTrapMemo, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npThermoSensorN=npThermoSensorN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmRegistration=npGsmRegistration, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npRelHumEntry=npRelHumEntry, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npReboot=npReboot, npIr=npIr, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npForcedReboot=npForcedReboot, npIoTraps=npIoTraps, npThermoHigh=npThermoHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopR=npCurLoopR, npThermoValue=npThermoValue, npRelay=npRelay, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npCurLoopV=npCurLoopV, npSmokeTrapMemo=npSmokeTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrap=npSmokeTrap, npRelayTable=npRelayTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTable=npSmokeTable, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTable=npThermoTable, npIrCtrl=npIrCtrl, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npGsm=npGsm, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npThermoTrap=npThermoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLineN=npIoTrapLineN, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut)
