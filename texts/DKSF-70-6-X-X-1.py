...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:09:55 2022
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Counter64, Unsigned32, MibIdentifier, TimeTicks, ModuleIdentity, enterprises, Counter32, Bits, IpAddress, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Counter64", "Unsigned32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "enterprises", "Counter32", "Bits", "IpAddress", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumMemo=npRelHumMemo, npThermoTable=npThermoTable, npSmokeEntry=npSmokeEntry, npSmokeTrap=npSmokeTrap, npSmokeReset=npSmokeReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npRelay=npRelay, npForcedReboot=npForcedReboot, npCurLoopStatus=npCurLoopStatus, npRelHumTrapData=npRelHumTrapData, npCurLoopTable=npCurLoopTable, npIoLevelIn=npIoLevelIn, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrap=npCurLoopTrap, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npIoTrapMemo=npIoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTraps=npGsmTraps, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrReset=npIrReset, npRelayN=npRelayN, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIo=npIo, npThermo=npThermo, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrStatus=npIrStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npCurLoopTrapR=npCurLoopTrapR, npRelayMode=npRelayMode, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTraps=npIoTraps, npThermoLow=npThermoLow, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeStatus=npSmokeStatus, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrCtrl=npIrCtrl, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npTrapInfo=npTrapInfo, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npIoEntry=npIoEntry, npReboot=npReboot, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npThermoTrap=npThermoTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayState=npRelayState, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIr=npIr, npThermoEntry=npThermoEntry, npThermoStatus=npThermoStatus)
