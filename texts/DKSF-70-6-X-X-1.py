...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:42:03 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Unsigned32, Counter32, enterprises, MibIdentifier, Counter64, TimeTicks, Gauge32, NotificationType, ModuleIdentity, ObjectIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Unsigned32", "Counter32", "enterprises", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npCurLoop=npCurLoop, npResetStack=npResetStack, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumN=npRelHumN, npIoMemo=npIoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npReboot=npReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTraps=npSmokeTraps, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npGsmFailed=npGsmFailed, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npRelayEntry=npRelayEntry, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLineN=npIoTrapLineN, npCurLoopV=npCurLoopV, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npThermoMemo=npThermoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npIoTrap=npIoTrap, npThermoTraps=npThermoTraps, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopEntry=npCurLoopEntry, npGsmRegistration=npGsmRegistration, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npCurLoopTrapV=npCurLoopTrapV, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npRelHumTable=npRelHumTable, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermo=npThermo, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npThermoStatus=npThermoStatus, npSmokeReset=npSmokeReset, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npSmokeTrapMemo=npSmokeTrapMemo, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapInfo=npTrapInfo, npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayTable=npRelayTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npForcedReboot=npForcedReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents)
