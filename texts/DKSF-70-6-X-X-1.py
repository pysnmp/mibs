...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:07:01 2021
...
TimeTicks, Unsigned32, Counter32, Integer32, iso, MibIdentifier, NotificationType, Bits, enterprises, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "Integer32", "iso", "MibIdentifier", "NotificationType", "Bits", "enterprises", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmRegistration=npGsmRegistration, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayState=npRelayState, npThermoTrap=npThermoTrap, npRelHumN=npRelHumN, npRelHumEntry=npRelHumEntry, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npRelayN=npRelayN, npReboot=npReboot, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npIoLevelIn=npIoLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTraps=npThermoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, lightcom=lightcom, npIo=npIo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npCurLoop=npCurLoop, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npRelay=npRelay, npIrCtrl=npIrCtrl, npRelHumTrap=npRelHumTrap, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeStatus=npSmokeStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npCurLoopV=npCurLoopV, npSmokeEntry=npSmokeEntry, npIrPlayCmd=npIrPlayCmd, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeMemo=npSmokeMemo, npCurLoopTraps=npCurLoopTraps, npIoEntry=npIoEntry, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npThermoTrapMemo=npThermoTrapMemo, npGsmTraps=npGsmTraps, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTraps=npSmokeTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopR=npCurLoopR, npIoLineN=npIoLineN, npThermoStatus=npThermoStatus, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npSmokePower=npSmokePower, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValuePrecise=npThermoValuePrecise, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npIoTable=npIoTable, npThermoHigh=npThermoHigh, npIoTrap=npIoTrap, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmInfo=npGsmInfo, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapInfo=npTrapInfo, npThermoValue=npThermoValue, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npTrapEmailTo=npTrapEmailTo, npGsmStrength=npGsmStrength, npCurLoopTable=npCurLoopTable, npIr=npIr, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, npCurLoopEntry=npCurLoopEntry, npSmokeReset=npSmokeReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTable=npSmokeTable)
