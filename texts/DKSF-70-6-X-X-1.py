...
# Produced by pysmi-1.1.12 at Fri Nov 22 16:01:10 2024
...
Gauge32, MibIdentifier, Counter32, ModuleIdentity, Unsigned32, Integer32, ObjectIdentity, TimeTicks, NotificationType, iso, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Counter32", "ModuleIdentity", "Unsigned32", "Integer32", "ObjectIdentity", "TimeTicks", "NotificationType", "iso", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIo=npIo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npSmokeMemo=npSmokeMemo, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, npThermoMemo=npThermoMemo, npReboot=npReboot, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokePower=npSmokePower, npRelHumTrapFail=npRelHumTrapFail, npIoLevelOut=npIoLevelOut, npThermoEntry=npThermoEntry, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npCurLoopN=npCurLoopN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTraps=npThermoTraps, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npIoTraps=npIoTraps, lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, FixedPoint1000=FixedPoint1000, npTrapInfo=npTrapInfo, npIoLineN=npIoLineN, npThermo=npThermo, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npCurLoopEntry=npCurLoopEntry, npSmokeReset=npSmokeReset, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npIoTrapLevelIn=npIoTrapLevelIn, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoEntry=npIoEntry, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npCurLoopV=npCurLoopV, npRelHumTempStatus=npRelHumTempStatus, npRelayMode=npRelayMode, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npSoftReboot=npSoftReboot, npRelayStartReset=npRelayStartReset, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsm=npGsm, npSmokeTraps=npSmokeTraps, npIoTrapMemo=npIoTrapMemo, npSmoke=npSmoke, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npRelHumN=npRelHumN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapValue=npThermoTrapValue, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoop=npCurLoop, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI)
