...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:12:46 2022
...
Integer32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Unsigned32, IpAddress, ModuleIdentity, Counter32, iso, Gauge32, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "iso", "Gauge32", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npResetStack=npResetStack, npRelHumTrapDataStatus=npRelHumTrapDataStatus, lightcom=lightcom, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npThermoTrap=npThermoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npThermoTable=npThermoTable, npRelayN=npRelayN, npCurLoopV=npCurLoopV, npThermoTrapLow=npThermoTrapLow, npCurLoopStatus=npCurLoopStatus, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npThermoHigh=npThermoHigh, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npRelHumValue=npRelHumValue, npRelayStartReset=npRelayStartReset, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopPower=npCurLoopPower, npCurLoopTable=npCurLoopTable, npRelayTable=npRelayTable, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npSmokeTrapStatus=npSmokeTrapStatus, npThermoValue=npThermoValue, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTable=npRelHumTable, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npSmoke=npSmoke, npGsmTrap=npGsmTrap, npThermoSensorN=npThermoSensorN, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMemo=npRelayMemo, npSmokeTrapMemo=npSmokeTrapMemo, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrPlayCmd=npIrPlayCmd, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLineN=npIoTrapLineN, npRelHumMemo=npRelHumMemo, npRelHumTempValue=npRelHumTempValue, npThermoTrapPrefix=npThermoTrapPrefix, npThermoLow=npThermoLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoEntry=npThermoEntry, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npSmokePower=npSmokePower, npIr=npIr, npReboot=npReboot, npSmokeTraps=npSmokeTraps, npIoPulseCounter=npIoPulseCounter, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopR=npCurLoopR, FixedPoint1000=FixedPoint1000, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
