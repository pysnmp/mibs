...
# Produced by pysmi-1.1.3 at Sat Nov 20 22:35:35 2021
...
Counter64, TimeTicks, Integer32, enterprises, ModuleIdentity, NotificationType, MibIdentifier, ObjectIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Integer32", "enterprises", "ModuleIdentity", "NotificationType", "MibIdentifier", "ObjectIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npIoTable=npIoTable, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npIoEntry=npIoEntry, npSmokeSensorN=npSmokeSensorN, npTrapInfo=npTrapInfo, npCurLoopR=npCurLoopR, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopEntry=npCurLoopEntry, npSmokePower=npSmokePower, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTable=npThermoTable, npForcedReboot=npForcedReboot, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npGsmTraps=npGsmTraps, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npSmokeTraps=npSmokeTraps, npThermoTrapHigh=npThermoTrapHigh, npThermoStatus=npThermoStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopPower=npCurLoopPower, npRelHumN=npRelHumN, npThermoLow=npThermoLow, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npIrPlayCmd=npIrPlayCmd, npResetStack=npResetStack, npIr=npIr, npGsmStrength=npGsmStrength, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npCurLoopTrapR=npCurLoopTrapR, npThermoMemo=npThermoMemo, npSmoke=npSmoke, npRelHumidity=npRelHumidity, npIrCtrl=npIrCtrl, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTraps=npIoTraps, npRelHumTrap=npRelHumTrap, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrStatus=npIrStatus, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npCurLoopI=npCurLoopI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIo=npIo, npRelayN=npRelayN, npIoLevelIn=npIoLevelIn, npRelHumEntry=npRelHumEntry, npThermoTrapValue=npThermoTrapValue, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, lightcom=lightcom, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npIoMemo=npIoMemo, npSoftReboot=npSoftReboot, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npRelHumStatus=npRelHumStatus, npThermoValuePrecise=npThermoValuePrecise)
