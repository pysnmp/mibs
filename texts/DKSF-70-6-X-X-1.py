...
# Produced by pysmi-1.1.8 at Tue Feb  1 21:09:14 2022
...
iso, ObjectIdentity, Gauge32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, IpAddress, MibIdentifier, enterprises, Unsigned32, Counter32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Gauge32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "enterprises", "Unsigned32", "Counter32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrap=npRelHumTrap, npIrCtrl=npIrCtrl, npIoTable=npIoTable, npIoTraps=npIoTraps, npGsmStrength=npGsmStrength, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPower=npCurLoopTrapPower, lightcom=lightcom, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoEntry=npIoEntry, npThermoTrapHigh=npThermoTrapHigh, npSmokeReset=npSmokeReset, npThermoValuePrecise=npThermoValuePrecise, npIoLineN=npIoLineN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopI=npCurLoopI, npIoTrap=npIoTrap, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npReboot=npReboot, npSoftReboot=npSoftReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npRelHumMemo=npRelHumMemo, npResetStack=npResetStack, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapEmailTo=npTrapEmailTo, npIo=npIo, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelayN=npRelayN, npIoTrapPrefix=npIoTrapPrefix, npRelayStartReset=npRelayStartReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npThermoEntry=npThermoEntry, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npRelayState=npRelayState, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapMemo=npIoTrapMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelHumN=npRelHumN, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapV=npCurLoopTrapV, npThermo=npThermo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapI=npCurLoopTrapI, npGsmRegistration=npGsmRegistration, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npThermoTrapValue=npThermoTrapValue, npThermoLow=npThermoLow, npCurLoopTraps=npCurLoopTraps, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npIr=npIr, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumidity=npRelHumidity, npThermoTrap=npThermoTrap, npThermoHigh=npThermoHigh, npSmoke=npSmoke, npGsmInfo=npGsmInfo, npThermoMemo=npThermoMemo, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeMemo=npSmokeMemo)
