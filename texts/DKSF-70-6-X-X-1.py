...
# Produced by pysmi-1.1.12 at Wed May 29 08:13:45 2024
...
ObjectIdentity, Unsigned32, Integer32, TimeTicks, MibIdentifier, ModuleIdentity, Bits, IpAddress, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Integer32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Bits", "IpAddress", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npResetStack=npResetStack, npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npRelHumEntry=npRelHumEntry, npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTraps=npGsmTraps, npRelHumStatus=npRelHumStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelay=npRelay, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npIoTrap=npIoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npThermoMemo=npThermoMemo, npSmoke=npSmoke, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapInfo=npTrapInfo, npRelayN=npRelayN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, lightcom=lightcom, npRelHumMemo=npRelHumMemo, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTraps=npIoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoMemo=npIoMemo, npRelayMemo=npRelayMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTable=npSmokeTable, npGsmTrap=npGsmTrap, npGsmRegistration=npGsmRegistration, npThermoTrapMemo=npThermoTrapMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumN=npRelHumN, npIoTrapMemo=npIoTrapMemo, npCurLoopV=npCurLoopV, npRelayState=npRelayState, npGsm=npGsm, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npThermoStatus=npThermoStatus, npSmokeTrapStatus=npSmokeTrapStatus, FixedPoint1000=FixedPoint1000, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npRelayStartReset=npRelayStartReset, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoEntry=npThermoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npCurLoopTable=npCurLoopTable, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npSmokeStatus=npSmokeStatus, npSmokeTraps=npSmokeTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelOut=npIoLevelOut, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npThermoTraps=npThermoTraps, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npIoTable=npIoTable, npForcedReboot=npForcedReboot, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, npCurLoopTrap=npCurLoopTrap, npGsmFailed=npGsmFailed, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npSmokeEntry=npSmokeEntry, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npGsmStrength=npGsmStrength, npIr=npIr, npRelHumTempValue=npRelHumTempValue)
