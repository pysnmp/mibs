...
# Produced by pysmi-1.1.12 at Tue Jun 25 14:15:08 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, IpAddress, Unsigned32, Counter64, TimeTicks, Integer32, MibIdentifier, Bits, Gauge32, iso, NotificationType, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "IpAddress", "Unsigned32", "Counter64", "TimeTicks", "Integer32", "MibIdentifier", "Bits", "Gauge32", "iso", "NotificationType", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, npSmoke=npSmoke, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTable=npSmokeTable, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLineN=npIoTrapLineN, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsm=npGsm, npThermoEntry=npThermoEntry, npThermo=npThermo, npCurLoopTrap=npCurLoopTrap, npRelHumTrap=npRelHumTrap, npGsmStrength=npGsmStrength, npCurLoopI=npCurLoopI, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, npGsmInfo=npGsmInfo, npRelHumTempStatus=npRelHumTempStatus, npIoLineN=npIoLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npIoPulseCounter=npIoPulseCounter, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTraps=npIoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npResetStack=npResetStack, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npSmokeTrapMemo=npSmokeTrapMemo, npIr=npIr, npIoTrap=npIoTrap, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npRelay=npRelay, npSoftReboot=npSoftReboot, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokeReset=npSmokeReset, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npRelHumidity=npRelHumidity, npThermoTraps=npThermoTraps, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npIrPlayCmd=npIrPlayCmd, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npRelHumStatus=npRelHumStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, FixedPoint1000=FixedPoint1000, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoLow=npThermoLow, npRelHumN=npRelHumN, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTraps=npGsmTraps, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npCurLoopPower=npCurLoopPower, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail)
