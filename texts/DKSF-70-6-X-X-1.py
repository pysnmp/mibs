...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:11:10 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, Counter64, ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, enterprises, Unsigned32, Integer32, Counter32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "Counter64", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "enterprises", "Unsigned32", "Integer32", "Counter32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npRelayTable=npRelayTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npSmokeMemo=npSmokeMemo, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, npThermo=npThermo, npThermoMemo=npThermoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npResetStack=npResetStack, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npSmokeTraps=npSmokeTraps, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, FixedPoint1000=FixedPoint1000, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npRelay=npRelay, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npRelayState=npRelayState, npSoftReboot=npSoftReboot, npRelHumTable=npRelHumTable, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapData=npRelHumTrapData, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayMode=npRelayMode, npGsmInfo=npGsmInfo, npGsm=npGsm, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npReboot=npReboot, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npGsmFailed=npGsmFailed, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npIo=npIo, npThermoHigh=npThermoHigh, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npCurLoopTraps=npCurLoopTraps, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapI=npCurLoopTrapI, lightcom=lightcom, npCurLoopN=npCurLoopN, npRelHumValue=npRelHumValue, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npRelHumTrap=npRelHumTrap, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npSmokePower=npSmokePower, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npTrapEmailTo=npTrapEmailTo, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npIoPulseCounter=npIoPulseCounter, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npThermoTrap=npThermoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe)
