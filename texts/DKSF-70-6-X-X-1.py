...
# Produced by pysmi-1.1.12 at Tue Jun  4 14:14:52 2024
...
Unsigned32, ModuleIdentity, Counter32, Gauge32, Counter64, TimeTicks, MibIdentifier, IpAddress, NotificationType, iso, enterprises, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "TimeTicks", "MibIdentifier", "IpAddress", "NotificationType", "iso", "enterprises", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npIoLevelIn=npIoLevelIn, npForcedReboot=npForcedReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMemo=npRelayMemo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTraps=npGsmTraps, npIoTable=npIoTable, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapR=npCurLoopTrapR, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npThermoTrapValue=npThermoTrapValue, npCurLoopN=npCurLoopN, npGsmTrap=npGsmTrap, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npIoTraps=npIoTraps, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npCurLoopV=npCurLoopV, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npThermoHigh=npThermoHigh, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeEntry=npSmokeEntry, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed, npThermoTable=npThermoTable, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoLow=npThermoLow, npRelay=npRelay, npIrPlayCmd=npIrPlayCmd, npIrReset=npIrReset, npRelayMode=npRelayMode, npThermoTrapLow=npThermoTrapLow, npIoTrapLineN=npIoTrapLineN, npGsmTrapPrefix=npGsmTrapPrefix, npIo=npIo, npThermoEntry=npThermoEntry, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npResetStack=npResetStack, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrap=npIoTrap, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmoke=npSmoke, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npThermo=npThermo, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopPower=npCurLoopPower, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npCurLoop=npCurLoop, npSmokeReset=npSmokeReset)
