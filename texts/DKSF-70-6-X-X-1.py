...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:47:01 2023
...
Gauge32, ModuleIdentity, iso, enterprises, Unsigned32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "iso", "enterprises", "Unsigned32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npRelHumStatus=npRelHumStatus, npSmokeTable=npSmokeTable, npIoEntry=npIoEntry, npGsmStrength=npGsmStrength, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeMemo=npSmokeMemo, npCurLoopN=npCurLoopN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapLow=npThermoTrapLow, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npRelayN=npRelayN, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmInfo=npGsmInfo, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npThermoTable=npThermoTable, npTrapInfo=npTrapInfo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npReboot=npReboot, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npRelHumTempStatus=npRelHumTempStatus, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTable=npCurLoopTable, npIoTable=npIoTable, npIoLevelOut=npIoLevelOut, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npForcedReboot=npForcedReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrap=npSmokeTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npThermoStatus=npThermoStatus, npSmoke=npSmoke, npCurLoopEntry=npCurLoopEntry, npGsmTraps=npGsmTraps, npIoTrapMemo=npIoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npIr=npIr, npIrReset=npIrReset, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npCurLoop=npCurLoop, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrCtrl=npIrCtrl, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopPower=npCurLoopPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLineN=npIoLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumValue=npRelHumValue, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npRelayMemo=npRelayMemo, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents)
