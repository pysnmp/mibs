...
# Produced by pysmi-1.1.12 at Mon May 13 02:41:37 2024
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, NotificationType, Integer32, iso, TimeTicks, Unsigned32, ModuleIdentity, MibIdentifier, Counter64, IpAddress, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "NotificationType", "Integer32", "iso", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter64", "IpAddress", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npIr=npIr, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopV=npCurLoopV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npIrPlayCmd=npIrPlayCmd, npIo=npIo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumMemo=npRelHumMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoStatus=npThermoStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npForcedReboot=npForcedReboot, npIoTraps=npIoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoop=npCurLoop, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npIoTrap=npIoTrap, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npIrReset=npIrReset, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, npCurLoopTable=npCurLoopTable, npSmokeTraps=npSmokeTraps, npRelayState=npRelayState, npRelayTable=npRelayTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopI=npCurLoopI, npResetStack=npResetStack, npThermoValue=npThermoValue, npSoftReboot=npSoftReboot, npRelHumTempValue=npRelHumTempValue, npSmokeEntry=npSmokeEntry, npIrCtrl=npIrCtrl, npCurLoopTrapPrefix=npCurLoopTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npRelHumTrapFail=npRelHumTrapFail, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npReboot=npReboot, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3)
