...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:47:17 2022
...
Integer32, Gauge32, Counter32, TimeTicks, ModuleIdentity, Counter64, Bits, Unsigned32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter32", "TimeTicks", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npForcedReboot=npForcedReboot, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npSmoke=npSmoke, npCurLoopTraps=npCurLoopTraps, npRelayMemo=npRelayMemo, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npCurLoopI=npCurLoopI, npRelHumTrapData=npRelHumTrapData, npThermoTrapLow=npThermoTrapLow, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopN=npCurLoopN, npCurLoopTrap=npCurLoopTrap, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopV=npCurLoopV, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmFailed=npGsmFailed, npRelay=npRelay, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapInfo=npTrapInfo, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npRelHumN=npRelHumN, npThermoLow=npThermoLow, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npThermo=npThermo, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npCurLoopTable=npCurLoopTable, npIr=npIr, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeSensorN=npSmokeSensorN, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTraps=npThermoTraps, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npCurLoopR=npCurLoopR, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npGsm=npGsm, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoop=npCurLoop, npGsmTraps=npGsmTraps, npThermoHigh=npThermoHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumMemo=npRelHumMemo, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, npThermoTrapMemo=npThermoTrapMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrStatus=npIrStatus, npCurLoopTrapV=npCurLoopTrapV, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npResetStack=npResetStack, npRelayMode=npRelayMode, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npThermoTable=npThermoTable, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN)
