...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:46:42 2022
...
TimeTicks, NotificationType, Bits, MibIdentifier, iso, Counter32, Counter64, Unsigned32, IpAddress, ModuleIdentity, enterprises, ObjectIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Bits", "MibIdentifier", "iso", "Counter32", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "ObjectIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrStatus=npIrStatus, npGsm=npGsm, npRelHumTrap=npRelHumTrap, npThermoTrapValue=npThermoTrapValue, npRelHumEntry=npRelHumEntry, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npThermoTrapHigh=npThermoTrapHigh, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npThermo=npThermo, npSmokePower=npSmokePower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npSmoke=npSmoke, npIoTable=npIoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps, npRelayMode=npRelayMode, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npIo=npIo, npRelHumTempStatus=npRelHumTempStatus, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelay=npRelay, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npGsmRegistration=npGsmRegistration, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapN=npCurLoopTrapN, npCurLoopN=npCurLoopN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npSmokeSensorN=npSmokeSensorN, npCurLoopTraps=npCurLoopTraps, npCurLoopStatus=npCurLoopStatus, npResetStack=npResetStack, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoop=npCurLoop, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTable=npRelHumTable, npTrapInfo=npTrapInfo, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npForcedReboot=npForcedReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npIrReset=npIrReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoPulseCounter=npIoPulseCounter, npGsmStrength=npGsmStrength, npIoLevelOut=npIoLevelOut, npIrCtrl=npIrCtrl, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapLow=npThermoTrapLow, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, lightcom=lightcom, npReboot=npReboot, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
