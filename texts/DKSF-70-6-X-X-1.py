...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:13:24 2022
...
NotificationType, Counter32, IpAddress, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, iso, Bits, TimeTicks, Integer32, MibIdentifier, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "IpAddress", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "iso", "Bits", "TimeTicks", "Integer32", "MibIdentifier", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npSmokeTable=npSmokeTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumStatus=npRelHumStatus, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopPower=npCurLoopPower, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapN=npCurLoopTrapN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npIrPlayCmd=npIrPlayCmd, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoLow=npThermoLow, npCurLoopStatus=npCurLoopStatus, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npSmokeStatus=npSmokeStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoValue=npThermoValue, npCurLoopTrapPower=npCurLoopTrapPower, npIo=npIo, npRelHumidity=npRelHumidity, npThermoTrap=npThermoTrap, npThermoTrapMemo=npThermoTrapMemo, npTrapInfo=npTrapInfo, npSmokePower=npSmokePower, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npTrapEmailTo=npTrapEmailTo, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npThermoTrapStatus=npThermoTrapStatus, npForcedReboot=npForcedReboot, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npReboot=npReboot, npIrCtrl=npIrCtrl, npThermo=npThermo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npIoLineN=npIoLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, npThermoSensorN=npThermoSensorN, npRelHumValue=npRelHumValue, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTraps=npGsmTraps, npResetStack=npResetStack, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapValue=npThermoTrapValue, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopV=npCurLoopV, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npCurLoopTrapR=npCurLoopTrapR, npRelay=npRelay, npRelHumTable=npRelHumTable, npSmokeTrapMemo=npSmokeTrapMemo, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoStatus=npThermoStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayEntry=npRelayEntry, npCurLoopTrapV=npCurLoopTrapV, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npSmokeTrap=npSmokeTrap, npRelayN=npRelayN)
