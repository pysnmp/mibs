...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:07:46 2021
...
Counter64, ObjectIdentity, IpAddress, NotificationType, Counter32, Integer32, enterprises, TimeTicks, Bits, Gauge32, Unsigned32, iso, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "Integer32", "enterprises", "TimeTicks", "Bits", "Gauge32", "Unsigned32", "iso", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npGsm=npGsm, npIrStatus=npIrStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npIoTraps=npIoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLineN=npIoTrapLineN, npRelayTable=npRelayTable, npReboot=npReboot, npThermo=npThermo, npIrReset=npIrReset, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npThermoHigh=npThermoHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumStatus=npRelHumStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopI=npCurLoopI, lightcom=lightcom, npThermoTraps=npThermoTraps, npGsmFailed=npGsmFailed, npCurLoopTrapR=npCurLoopTrapR, npCurLoop=npCurLoop, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelayN=npRelayN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npResetStack=npResetStack, npCurLoopTrap=npCurLoopTrap, npSmokeStatus=npSmokeStatus, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapLow=npThermoTrapLow, npThermoEntry=npThermoEntry, npForcedReboot=npForcedReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npRelHumValue=npRelHumValue, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrap=npThermoTrap, npThermoLow=npThermoLow, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelOut=npIoLevelOut, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npRelayState=npRelayState, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npCurLoopPower=npCurLoopPower, npRelay=npRelay, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapValue=npThermoTrapValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopV=npCurLoopV, npGsmTraps=npGsmTraps, npRelHumN=npRelHumN, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npIoEntry=npIoEntry, npThermoTrapStatus=npThermoTrapStatus, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTable=npThermoTable)
