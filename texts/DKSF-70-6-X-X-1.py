...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:00:12 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Gauge32, enterprises, ObjectIdentity, Unsigned32, TimeTicks, NotificationType, ModuleIdentity, Integer32, iso, IpAddress, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Gauge32", "enterprises", "ObjectIdentity", "Unsigned32", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "iso", "IpAddress", "Counter32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapValue=npThermoTrapValue, npIrCtrl=npIrCtrl, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrReset=npIrReset, npSmokeStatus=npSmokeStatus, npThermoTrapLow=npThermoTrapLow, npGsmTrapPrefix=npGsmTrapPrefix, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npCurLoopN=npCurLoopN, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTraps=npIoTraps, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npRelHumidity=npRelHumidity, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npRelayMemo=npRelayMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapR=npCurLoopTrapR, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npIo=npIo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumValue=npRelHumValue, npSmokeSensorN=npSmokeSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut, npRelayMode=npRelayMode, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopR=npCurLoopR, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npSmokePower=npSmokePower, npIoMemo=npIoMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermo=npThermo, npRelHumMemo=npRelHumMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapData=npRelHumTrapData, npRelayStartReset=npRelayStartReset, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapMemo=npThermoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npRelHumTrapDataN=npRelHumTrapDataN, npGsmInfo=npGsmInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npTrapEmailTo=npTrapEmailTo, npThermoEntry=npThermoEntry, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npCurLoopPower=npCurLoopPower, npReboot=npReboot, lightcom=lightcom, npRelayN=npRelayN)
