...
# Produced by pysmi-1.1.8 at Tue Feb  8 23:20:11 2022
...
Counter32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, IpAddress, MibIdentifier, TimeTicks, Integer32, ModuleIdentity, ObjectIdentity, enterprises, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "Integer32", "ModuleIdentity", "ObjectIdentity", "enterprises", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", lightcom=lightcom, FixedPoint1000=FixedPoint1000, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTable=npRelHumTable, npRelayStartReset=npRelayStartReset, npCurLoopTrapI=npCurLoopTrapI, npRelHumMemo=npRelHumMemo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopV=npCurLoopV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelayTable=npRelayTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npSmokeTable=npSmokeTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoEntry=npThermoEntry, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npIoTraps=npIoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapFail=npRelHumTrapFail, npThermoValuePrecise=npThermoValuePrecise, npRelHumEntry=npRelHumEntry, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokePower=npSmokePower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npIoLineN=npIoLineN, npTrapEmailTo=npTrapEmailTo, npThermoStatus=npThermoStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npThermoTrap=npThermoTrap, npRelHumN=npRelHumN, npGsm=npGsm, npGsmTrap=npGsmTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npRelayState=npRelayState, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npThermoValue=npThermoValue, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npResetStack=npResetStack, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, npThermoTraps=npThermoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npIrReset=npIrReset, npThermoTrapStatus=npThermoTrapStatus, npSmokeTraps=npSmokeTraps, npCurLoopTable=npCurLoopTable, npThermoTrapMemo=npThermoTrapMemo, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npIoTrapMemo=npIoTrapMemo, npSoftReboot=npSoftReboot, npCurLoopN=npCurLoopN)
