...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:20:44 2021
...
iso, NotificationType, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Gauge32, Counter32, Unsigned32, enterprises, Counter64, Integer32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Gauge32", "Counter32", "Unsigned32", "enterprises", "Counter64", "Integer32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npRelayEntry=npRelayEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLineN=npIoLineN, npCurLoopPower=npCurLoopPower, npResetStack=npResetStack, npThermo=npThermo, npThermoTrapValue=npThermoTrapValue, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumN=npRelHumN, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopR=npCurLoopR, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTable=npRelHumTable, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npThermoSensorN=npThermoSensorN, npIoTrapLineN=npIoTrapLineN, npIr=npIr, npCurLoopTable=npCurLoopTable, npRelay=npRelay, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrap=npGsmTrap, npIo=npIo, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npSmokePower=npSmokePower, npGsm=npGsm, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npRelHumValue=npRelHumValue, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTable=npIoTable, npIoMemo=npIoMemo, npThermoTrapMemo=npThermoTrapMemo, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npRelayN=npRelayN, npThermoTable=npThermoTable, npRelHumEntry=npRelHumEntry, npCurLoopTrapN=npCurLoopTrapN, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSoftReboot=npSoftReboot, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npThermoHigh=npThermoHigh, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npRelayTable=npRelayTable, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npGsmStrength=npGsmStrength, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeReset=npSmokeReset, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelIn=npIoTrapLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapR=npCurLoopTrapR, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npThermoStatus=npThermoStatus, npReboot=npReboot)
