...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:15:39 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Gauge32, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Integer32, Unsigned32, iso, enterprises, Bits, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32", "Unsigned32", "iso", "enterprises", "Bits", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTable=npThermoTable, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npGsm=npGsm, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeEntry=npSmokeEntry, npThermoTrapHigh=npThermoTrapHigh, npSmoke=npSmoke, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopN=npCurLoopN, npResetStack=npResetStack, npSmokeReset=npSmokeReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npThermoSensorN=npThermoSensorN, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValue=npThermoValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npRelayState=npRelayState, npRelHumEntry=npRelHumEntry, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, npIrReset=npIrReset, npRelayN=npRelayN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npGsmTrapPrefix=npGsmTrapPrefix, npSmokePower=npSmokePower, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable, npIrStatus=npIrStatus, npThermoTrapLow=npThermoTrapLow, npTrapEmailTo=npTrapEmailTo, npCurLoopI=npCurLoopI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npRelayMemo=npRelayMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npIoTable=npIoTable, npReboot=npReboot, npCurLoopTraps=npCurLoopTraps, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, npIr=npIr, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoHigh=npThermoHigh, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeStatus=npSmokeStatus, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npSmokeTrap=npSmokeTrap, npRelHumValue=npRelHumValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npSoftReboot=npSoftReboot, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npIo=npIo, npIoLineN=npIoLineN, npGsmRegistration=npGsmRegistration)
