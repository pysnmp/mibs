...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:41:22 2024
...
Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, enterprises, Gauge32, iso, Counter32, IpAddress, TimeTicks, ObjectIdentity, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "enterprises", "Gauge32", "iso", "Counter32", "IpAddress", "TimeTicks", "ObjectIdentity", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrap=npThermoTrap, npThermoTraps=npThermoTraps, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npResetStack=npResetStack, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelay=npRelay, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTraps=npIoTraps, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut, npThermoValuePrecise=npThermoValuePrecise, npRelayN=npRelayN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTable=npCurLoopTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npThermoMemo=npThermoMemo, npIoLineN=npIoLineN, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLineN=npIoTrapLineN, FixedPoint1000=FixedPoint1000, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayTable=npRelayTable, npGsmTrap=npGsmTrap, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npSoftReboot=npSoftReboot, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopR=npCurLoopR, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npRelHumTrapData=npRelHumTrapData, npThermoTrapSensorN=npThermoTrapSensorN, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npThermoHigh=npThermoHigh, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npReboot=npReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npCurLoopN=npCurLoopN, npIr=npIr, npThermoTrapHigh=npThermoTrapHigh, npRelayEntry=npRelayEntry, npRelHumN=npRelHumN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npCurLoopTrapR=npCurLoopTrapR, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npIrCtrl=npIrCtrl, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayState=npRelayState, npIrStatus=npIrStatus, npGsmStrength=npGsmStrength, npCurLoopTrap=npCurLoopTrap, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix)
