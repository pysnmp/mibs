...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:56:47 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Counter32, Gauge32, enterprises, Unsigned32, ModuleIdentity, Bits, MibIdentifier, iso, NotificationType, ObjectIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Counter32", "Gauge32", "enterprises", "Unsigned32", "ModuleIdentity", "Bits", "MibIdentifier", "iso", "NotificationType", "ObjectIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumValue=npRelHumValue, npThermoEntry=npThermoEntry, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npResetStack=npResetStack, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npCurLoopTrapR=npCurLoopTrapR, npCurLoopI=npCurLoopI, npGsmTraps=npGsmTraps, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTable=npIoTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoMemo=npThermoMemo, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoop=npCurLoop, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsm=npGsm, npThermoHigh=npThermoHigh, npSmokeTrap=npSmokeTrap, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npSmokePower=npSmokePower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapV=npCurLoopTrapV, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npIoLevelIn=npIoLevelIn, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npThermo=npThermo, npSmokeTable=npSmokeTable, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeStatus=npSmokeStatus, npSmoke=npSmoke, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, lightcom=lightcom, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npIo=npIo, npIoLevelOut=npIoLevelOut, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npRelHumStatus=npRelHumStatus, npSmokeMemo=npSmokeMemo, npIoTrapLineN=npIoTrapLineN)
