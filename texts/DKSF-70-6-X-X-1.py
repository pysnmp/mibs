...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:37:38 2023
...
ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Bits, NotificationType, iso, TimeTicks, Counter64, ObjectIdentity, IpAddress, MibIdentifier, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Bits", "NotificationType", "iso", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "MibIdentifier", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSoftReboot=npSoftReboot, npCurLoopI=npCurLoopI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npGsmInfo=npGsmInfo, npThermoEntry=npThermoEntry, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npRelayMemo=npRelayMemo, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npCurLoopEntry=npCurLoopEntry, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npGsm=npGsm, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npCurLoop=npCurLoop, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokePower=npSmokePower, npRelHumValue=npRelHumValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopV=npCurLoopV, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayN=npRelayN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npReboot=npReboot, npIo=npIo, npSmokeTrapMemo=npSmokeTrapMemo, npIoEntry=npIoEntry, npIrPlayCmd=npIrPlayCmd, npRelHumMemo=npRelHumMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npSmokeTable=npSmokeTable, lightcom=lightcom, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeMemo=npSmokeMemo, npRelHumTrapFail=npRelHumTrapFail, npThermoSensorN=npThermoSensorN, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npCurLoopPower=npCurLoopPower, npIoTrapMemo=npIoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrap=npGsmTrap, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIr=npIr, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMode=npRelayMode, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopN=npCurLoopN, npIoTable=npIoTable, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npRelayState=npRelayState, npIoTrap=npIoTrap, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapPrefix=npThermoTrapPrefix, FixedPoint1000=FixedPoint1000, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumidity=npRelHumidity, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npCurLoopStatus=npCurLoopStatus)
