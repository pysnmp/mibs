...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:32:51 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, IpAddress, MibIdentifier, Integer32, Gauge32, Bits, Unsigned32, iso, ObjectIdentity, Counter32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "IpAddress", "MibIdentifier", "Integer32", "Gauge32", "Bits", "Unsigned32", "iso", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopR=npCurLoopR, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopN=npCurLoopN, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npForcedReboot=npForcedReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeReset=npSmokeReset, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumStatus=npRelHumStatus, npRelayEntry=npRelayEntry, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmFailed=npGsmFailed, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, FixedPoint1000=FixedPoint1000, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapLow=npThermoTrapLow, npGsmTrapPrefix=npGsmTrapPrefix, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmInfo=npGsmInfo, npRelHumN=npRelHumN, npIoTraps=npIoTraps, npReboot=npReboot, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npSmoke=npSmoke, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npCurLoopEntry=npCurLoopEntry, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoMemo=npThermoMemo, npRelHumTempStatus=npRelHumTempStatus, npGsmRegistration=npGsmRegistration, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npRelayTable=npRelayTable, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npIr=npIr, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, npResetStack=npResetStack, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npRelay=npRelay, npThermoLow=npThermoLow, npSmokeTable=npSmokeTable, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState)
