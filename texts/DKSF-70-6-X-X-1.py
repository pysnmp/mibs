...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:19:32 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, Unsigned32, iso, Counter64, ObjectIdentity, Counter32, IpAddress, TimeTicks, Bits, enterprises, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32", "iso", "Counter64", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "Bits", "enterprises", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoPulseCounter=npIoPulseCounter, npCurLoopI=npCurLoopI, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npIoTrapMemo=npIoTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npSoftReboot=npSoftReboot, npRelHumTempStatus=npRelHumTempStatus, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npSmokeTable=npSmokeTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoStatus=npThermoStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeStatus=npSmokeStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npIoEntry=npIoEntry, npRelayN=npRelayN, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npResetStack=npResetStack, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npTrapInfo=npTrapInfo, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoSensorN=npThermoSensorN, npThermoHigh=npThermoHigh, npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermo=npThermo, npCurLoopR=npCurLoopR, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrap=npRelHumTrap, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelIn=npIoLevelIn, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelIn=npIoTrapLevelIn, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npRelayTable=npRelayTable, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, npSmoke=npSmoke, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npGsmFailed=npGsmFailed, npCurLoopTrapPower=npCurLoopTrapPower, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrap=npCurLoopTrap, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapValue=npThermoTrapValue, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npRelayEntry=npRelayEntry, npThermoEntry=npThermoEntry, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, npRelay=npRelay, npIoLineN=npIoLineN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npForcedReboot=npForcedReboot, npRelHumTempValue=npRelHumTempValue, npRelayState=npRelayState)
