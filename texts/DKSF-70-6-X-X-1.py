...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:22:09 2022
...
Gauge32, TimeTicks, MibIdentifier, Integer32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, enterprises, Counter32, Counter64, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibIdentifier", "Integer32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "enterprises", "Counter32", "Counter64", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npGsm=npGsm, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npRelHumTempValue=npRelHumTempValue, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapR=npCurLoopTrapR, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, npIrCtrl=npIrCtrl, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmRegistration=npGsmRegistration, npSmokeStatus=npSmokeStatus, npIoTrapPrefix=npIoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npIo=npIo, npRelHumMemo=npRelHumMemo, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npIoTable=npIoTable, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npRelayEntry=npRelayEntry, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npResetStack=npResetStack, npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapEmailTo=npTrapEmailTo, npCurLoopI=npCurLoopI, npThermo=npThermo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npSmokeTrap=npSmokeTrap, npThermoTrapPrefix=npThermoTrapPrefix, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmFailed=npGsmFailed, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npGsmTrap=npGsmTrap, npRelHumN=npRelHumN, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoMemo=npThermoMemo, npThermoStatus=npThermoStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMode=npRelayMode, npSmoke=npSmoke, npRelay=npRelay, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, npCurLoop=npCurLoop, npThermoTrapSensorN=npThermoTrapSensorN, npForcedReboot=npForcedReboot, npThermoSensorN=npThermoSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npThermoTrapMemo=npThermoTrapMemo, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable)
