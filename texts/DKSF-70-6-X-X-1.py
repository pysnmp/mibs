...
# Produced by pysmi-1.1.12 at Tue May 28 11:50:22 2024
...
MibIdentifier, Counter32, Integer32, NotificationType, iso, Unsigned32, IpAddress, Counter64, ModuleIdentity, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "Integer32", "NotificationType", "iso", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumEntry=npRelHumEntry, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npIoTrapMemo=npIoTrapMemo, npThermoHigh=npThermoHigh, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npCurLoopN=npCurLoopN, npRelHumTempStatus=npRelHumTempStatus, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npRelayEntry=npRelayEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTable=npSmokeTable, npRelHumTrapTemp=npRelHumTrapTemp, npReboot=npReboot, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTable=npCurLoopTable, npSmokeEntry=npSmokeEntry, npIo=npIo, npTrapInfo=npTrapInfo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayState=npRelayState, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayN=npRelayN, npTrapEmailTo=npTrapEmailTo, npThermoTrapMemo=npThermoTrapMemo, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npIr=npIr, npCurLoopR=npCurLoopR, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npCurLoopPower=npCurLoopPower, npRelHumTrap=npRelHumTrap, npRelHumTrapData=npRelHumTrapData, npForcedReboot=npForcedReboot, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npRelay=npRelay, npSmokeMemo=npSmokeMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, lightcom=lightcom, npThermoLow=npThermoLow, npGsmTraps=npGsmTraps, npSmokeStatus=npSmokeStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrap=npCurLoopTrap, npResetStack=npResetStack, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTable=npRelHumTable, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npGsm=npGsm, npThermoValue=npThermoValue, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoEntry=npThermoEntry, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npIoEntry=npIoEntry, npIrCtrl=npIrCtrl, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npRelHumTempValue=npRelHumTempValue, npRelHumN=npRelHumN, npThermo=npThermo)
