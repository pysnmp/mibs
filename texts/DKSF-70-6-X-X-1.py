...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:12:15 2022
...
enterprises, Bits, Integer32, Unsigned32, ModuleIdentity, IpAddress, Counter32, Gauge32, NotificationType, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "Counter32", "Gauge32", "NotificationType", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapI=npCurLoopTrapI, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTraps=npIoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMemo=npRelayMemo, npGsmTrap=npGsmTrap, npSmoke=npSmoke, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npIrCtrl=npIrCtrl, npIoLevelOut=npIoLevelOut, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npThermoTraps=npThermoTraps, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npThermoEntry=npThermoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrap=npSmokeTrap, npGsmRegistration=npGsmRegistration, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npResetStack=npResetStack, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN, npIoLineN=npIoLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npReboot=npReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npCurLoopTrapPower=npCurLoopTrapPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeReset=npSmokeReset, npIoEntry=npIoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoop=npCurLoop, npSmokeEntry=npSmokeEntry, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npRelHumTempValue=npRelHumTempValue, npIoTrapPrefix=npIoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo, npGsmFailed=npGsmFailed, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npIo=npIo, npRelHumN=npRelHumN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, npThermoMemo=npThermoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npRelayN=npRelayN, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay, npSmokeTable=npSmokeTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npSmokeMemo=npSmokeMemo, npRelHumStatus=npRelHumStatus, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumEntry=npRelHumEntry, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
