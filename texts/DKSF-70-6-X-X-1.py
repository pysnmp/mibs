...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:28:28 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Gauge32, iso, Bits, enterprises, NotificationType, Unsigned32, ObjectIdentity, Counter32, TimeTicks, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Gauge32", "iso", "Bits", "enterprises", "NotificationType", "Unsigned32", "ObjectIdentity", "Counter32", "TimeTicks", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoEntry=npIoEntry, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npReboot=npReboot, npSmokePower=npSmokePower, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelayStartReset=npRelayStartReset, npIrReset=npIrReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumStatus=npRelHumStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npRelHumTrap=npRelHumTrap, npGsmInfo=npGsmInfo, npThermoTraps=npThermoTraps, npGsmTraps=npGsmTraps, npIrStatus=npIrStatus, npSmoke=npSmoke, npRelHumTrapData=npRelHumTrapData, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTable=npThermoTable, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npResetStack=npResetStack, npIoTable=npIoTable, npThermoTrap=npThermoTrap, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmFailed=npGsmFailed, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npThermoMemo=npThermoMemo, npThermoTrapPrefix=npThermoTrapPrefix, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npForcedReboot=npForcedReboot, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayEntry=npRelayEntry, npSmokeEntry=npSmokeEntry, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npGsmTrapPrefix=npGsmTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumN=npRelHumN, npGsmRegistration=npGsmRegistration, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npIoLineN=npIoLineN, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrPlayCmd=npIrPlayCmd, npSmokeReset=npSmokeReset, npRelHumMemo=npRelHumMemo, npSmokeStatus=npSmokeStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrap=npSmokeTrap, npSoftReboot=npSoftReboot, npRelayMode=npRelayMode, npThermoValuePrecise=npThermoValuePrecise, npIoMemo=npIoMemo, npIo=npIo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeMemo=npSmokeMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelIn=npIoLevelIn, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npCurLoopV=npCurLoopV)
