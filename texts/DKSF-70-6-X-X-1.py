...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:54:23 2024
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, iso, Counter32, Unsigned32, Gauge32, ModuleIdentity, Counter64, NotificationType, Bits, MibIdentifier, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "iso", "Counter32", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "NotificationType", "Bits", "MibIdentifier", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npSmokeStatus=npSmokeStatus, npCurLoopI=npCurLoopI, npCurLoopTrapPower=npCurLoopTrapPower, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIo=npIo, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npIrCtrl=npIrCtrl, npThermoTable=npThermoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npCurLoopV=npCurLoopV, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npRelayN=npRelayN, npThermoLow=npThermoLow, npIr=npIr, npIoTrapLevelIn=npIoTrapLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, lightcom=lightcom, npRelHumValue=npRelHumValue, npSmokePower=npSmokePower, npCurLoopStatus=npCurLoopStatus, npIoLevelIn=npIoLevelIn, npCurLoopEntry=npCurLoopEntry, npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeMemo=npSmokeMemo, npThermo=npThermo, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrap=npIoTrap, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npReboot=npReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrStatus=npIrStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npResetStack=npResetStack, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmoke=npSmoke, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npCurLoopN=npCurLoopN, npIoTraps=npIoTraps, npRelHumTable=npRelHumTable, npCurLoopTrapI=npCurLoopTrapI, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npThermoValue=npThermoValue, npRelHumMemo=npRelHumMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeReset=npSmokeReset, npThermoTrapValue=npThermoTrapValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelayEntry=npRelayEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, npThermoSensorN=npThermoSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npIoTable=npIoTable, npCurLoopTrapV=npCurLoopTrapV, npRelayMode=npRelayMode, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, npGsm=npGsm, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npIoPulseCounter=npIoPulseCounter, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npSoftReboot=npSoftReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrap=npThermoTrap, npGsmStrength=npGsmStrength, npIoEntry=npIoEntry, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayStartReset=npRelayStartReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
