...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:54:29 2022
...
TimeTicks, NotificationType, Bits, Gauge32, IpAddress, Integer32, Counter64, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, MibIdentifier, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Bits", "Gauge32", "IpAddress", "Integer32", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "MibIdentifier", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeReset=npSmokeReset, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npIoLineN=npIoLineN, npGsmTrapPrefix=npGsmTrapPrefix, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayState=npRelayState, npRelayMemo=npRelayMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayStartReset=npRelayStartReset, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npIo=npIo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npForcedReboot=npForcedReboot, npRelayTable=npRelayTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npIoTrap=npIoTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npGsmFailed=npGsmFailed, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelIn=npIoTrapLevelIn, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npSoftReboot=npSoftReboot, npCurLoopR=npCurLoopR, npThermoTrapStatus=npThermoTrapStatus, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, FixedPoint1000=FixedPoint1000, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npTrapInfo=npTrapInfo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLineN=npIoTrapLineN, npIoLevelOut=npIoLevelOut, npGsm=npGsm, npIoMemo=npIoMemo, npRelHumTable=npRelHumTable, npResetStack=npResetStack, npIrStatus=npIrStatus, npCurLoopEntry=npCurLoopEntry, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npSmokeStatus=npSmokeStatus, npCurLoop=npCurLoop, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npSmokeTraps=npSmokeTraps, lightcom=lightcom, npThermoSensorN=npThermoSensorN, npSmokeEntry=npSmokeEntry, npSmokeTable=npSmokeTable, npThermoHigh=npThermoHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npIoTrapPrefix=npIoTrapPrefix, npIrReset=npIrReset, npSmokePower=npSmokePower, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumidity=npRelHumidity, npThermoTrapHigh=npThermoTrapHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumEntry=npRelHumEntry, npGsmTrap=npGsmTrap, npThermo=npThermo, npThermoStatus=npThermoStatus, npRelayN=npRelayN)
