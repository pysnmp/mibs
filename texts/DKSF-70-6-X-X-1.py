...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:10:50 2023
...
Integer32, Counter64, Counter32, enterprises, Bits, MibIdentifier, TimeTicks, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, iso, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Counter32", "enterprises", "Bits", "MibIdentifier", "TimeTicks", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "iso", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npReboot=npReboot, npSmokeEntry=npSmokeEntry, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npThermoSensorN=npThermoSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npIoMemo=npIoMemo, npRelayTable=npRelayTable, npGsmInfo=npGsmInfo, npCurLoopTrapN=npCurLoopTrapN, npThermo=npThermo, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npGsmTrap=npGsmTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npIr=npIr, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopN=npCurLoopN, npRelayStartReset=npRelayStartReset, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumMemo=npRelHumMemo, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelay=npRelay, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npCurLoopTable=npCurLoopTable, npSoftReboot=npSoftReboot, npGsmTraps=npGsmTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopR=npCurLoopR, npRelHumTrap=npRelHumTrap, npCurLoopTraps=npCurLoopTraps, npGsmStrength=npGsmStrength, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npIoTable=npIoTable, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npSmokeTraps=npSmokeTraps, npCurLoopStatus=npCurLoopStatus, npThermoHigh=npThermoHigh, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npCurLoopTrap=npCurLoopTrap, npRelayMode=npRelayMode, npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeReset=npSmokeReset, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIo=npIo, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue)
