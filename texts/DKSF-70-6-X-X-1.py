...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:47:42 2023
...
NotificationType, Counter32, Bits, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, enterprises, ObjectIdentity, Unsigned32, IpAddress, TimeTicks, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "enterprises", "ObjectIdentity", "Unsigned32", "IpAddress", "TimeTicks", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTable=npCurLoopTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npForcedReboot=npForcedReboot, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumEntry=npRelHumEntry, npGsmFailed=npGsmFailed, npCurLoopTrapN=npCurLoopTrapN, npRelayStartReset=npRelayStartReset, npCurLoopTraps=npCurLoopTraps, npThermoHigh=npThermoHigh, npRelayMemo=npRelayMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npSmokeSensorN=npSmokeSensorN, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npRelay=npRelay, npGsmTrap=npGsmTrap, lightcom=lightcom, npRelHumTempStatus=npRelHumTempStatus, npSmokeTable=npSmokeTable, npThermoTrapValue=npThermoTrapValue, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermo=npThermo, npRelHumidity=npRelHumidity, npThermoTable=npThermoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npIrPlayCmd=npIrPlayCmd, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeMemo=npSmokeMemo, npReboot=npReboot, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npRelHumTrapData=npRelHumTrapData, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npRelHumMemo=npRelHumMemo, npRelHumN=npRelHumN, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelayMode=npRelayMode, npGsm=npGsm, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npIrReset=npIrReset, npIoTable=npIoTable, npIoLevelIn=npIoLevelIn, npGsmRegistration=npGsmRegistration, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLineN=npIoTrapLineN, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopEntry=npCurLoopEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npThermoTrapSensorN=npThermoTrapSensorN, npIo=npIo, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrap=npRelHumTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrStatus=npIrStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseDuration=npIoSinglePulseDuration)
