...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:15:09 2022
...
Unsigned32, ObjectIdentity, TimeTicks, NotificationType, Counter32, MibIdentifier, Bits, Integer32, IpAddress, enterprises, ModuleIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "TimeTicks", "NotificationType", "Counter32", "MibIdentifier", "Bits", "Integer32", "IpAddress", "enterprises", "ModuleIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npIrReset=npIrReset, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npThermoTrapPrefix=npThermoTrapPrefix, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npThermoValue=npThermoValue, npCurLoopTrapR=npCurLoopTrapR, npIr=npIr, npSmokeTrapMemo=npSmokeTrapMemo, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npThermoStatus=npThermoStatus, npGsm=npGsm, npRelayMode=npRelayMode, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npIoTable=npIoTable, npTrapInfo=npTrapInfo, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumValue=npRelHumValue, npIoTraps=npIoTraps, npRelHumTable=npRelHumTable, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopTrap=npCurLoopTrap, npSmokeReset=npSmokeReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npRelHumStatus=npRelHumStatus, npRelHumEntry=npRelHumEntry, npRelayMemo=npRelayMemo, npIrStatus=npIrStatus, npSmokeTrapStatus=npSmokeTrapStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopEntry=npCurLoopEntry, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npRelayN=npRelayN, npGsmInfo=npGsmInfo, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npIo=npIo, npThermoTraps=npThermoTraps, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npIrCtrl=npIrCtrl, npGsmFailed=npGsmFailed, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npThermoSensorN=npThermoSensorN, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus)
