...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:17:39 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, enterprises, TimeTicks, Unsigned32, ObjectIdentity, iso, IpAddress, Gauge32, MibIdentifier, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "enterprises", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "IpAddress", "Gauge32", "MibIdentifier", "Bits", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapSensorN=npThermoTrapSensorN, npIrStatus=npIrStatus, npSmokeStatus=npSmokeStatus, npIoTrapLevelIn=npIoTrapLevelIn, npThermoSensorN=npThermoSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumStatus=npRelHumStatus, npCurLoopTable=npCurLoopTable, npRelHumEntry=npRelHumEntry, npSmokeSensorN=npSmokeSensorN, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npSmokeReset=npSmokeReset, npRelay=npRelay, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoop=npCurLoop, npSmokePower=npSmokePower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempValue=npRelHumTempValue, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopStatus=npCurLoopStatus, npRelHumTrap=npRelHumTrap, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npThermoMemo=npThermoMemo, npSmokeMemo=npSmokeMemo, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelayN=npRelayN, npSoftReboot=npSoftReboot, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npGsmTraps=npGsmTraps, npCurLoopTrapR=npCurLoopTrapR, npSmoke=npSmoke, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValuePrecise=npThermoValuePrecise, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTable=npIoTable, npIo=npIo, npIrCtrl=npIrCtrl, npReboot=npReboot, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npCurLoopR=npCurLoopR, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npThermoTraps=npThermoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapSensorN=npSmokeTrapSensorN, npTrapInfo=npTrapInfo, npIoTrapLineN=npIoTrapLineN, npSmokeTrap=npSmokeTrap, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTraps=npSmokeTraps, npIoLineN=npIoLineN, npResetStack=npResetStack, npIoMemo=npIoMemo, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npThermo=npThermo, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapLow=npThermoTrapLow, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable)
