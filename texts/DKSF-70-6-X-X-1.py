...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:25:49 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Unsigned32, iso, Gauge32, ModuleIdentity, IpAddress, Integer32, ObjectIdentity, enterprises, TimeTicks, MibIdentifier, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Unsigned32", "iso", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "ObjectIdentity", "enterprises", "TimeTicks", "MibIdentifier", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npThermoValuePrecise=npThermoValuePrecise, npIoLevelIn=npIoLevelIn, npRelHumTrap=npRelHumTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npThermo=npThermo, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapLow=npThermoTrapLow, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, npIoEntry=npIoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npRelHumTable=npRelHumTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTraps=npCurLoopTraps, npGsm=npGsm, npCurLoopTable=npCurLoopTable, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIoSinglePulseDuration=npIoSinglePulseDuration, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayState=npRelayState, npIrCtrl=npIrCtrl, npRelHumStatus=npRelHumStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrap=npIoTrap, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npIoTable=npIoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npCurLoopTrap=npCurLoopTrap, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmoke=npSmoke, npCurLoopN=npCurLoopN, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npIrPlayCmd=npIrPlayCmd, npIoTrapMemo=npIoTrapMemo, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npIrStatus=npIrStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTraps=npIoTraps, npResetStack=npResetStack, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npTrapInfo=npTrapInfo, npIoMemo=npIoMemo, npRelayMemo=npRelayMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npRelayEntry=npRelayEntry, npRelay=npRelay, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, npRelHumTrapFail=npRelHumTrapFail, npGsmInfo=npGsmInfo, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIo=npIo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npRelayStartReset=npRelayStartReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopPower=npCurLoopPower)
