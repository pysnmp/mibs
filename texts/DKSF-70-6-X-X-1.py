...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:31:43 2023
...
Bits, Gauge32, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, Integer32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "Integer32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npRelayStartReset=npRelayStartReset, npGsm=npGsm, npRelayMode=npRelayMode, npCurLoopTraps=npCurLoopTraps, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIr=npIr, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npRelHumTrapData=npRelHumTrapData, npRelayState=npRelayState, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoStatus=npThermoStatus, npIrStatus=npIrStatus, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npRelayEntry=npRelayEntry, npThermoValuePrecise=npThermoValuePrecise, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npRelay=npRelay, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npCurLoopPower=npCurLoopPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrap=npSmokeTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTable=npCurLoopTable, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npIoTable=npIoTable, npThermo=npThermo, npGsmInfo=npGsmInfo, lightcom=lightcom, npReboot=npReboot, npRelayMemo=npRelayMemo, npIoTrapMemo=npIoTrapMemo, npRelHumStatus=npRelHumStatus, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npIoTraps=npIoTraps, npThermoLow=npThermoLow, npIoEntry=npIoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npRelayN=npRelayN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npCurLoopTrap=npCurLoopTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLineN=npIoLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, npSmokeSensorN=npSmokeSensorN, npSmokeReset=npSmokeReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npIrCtrl=npIrCtrl, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npTrapEmailTo=npTrapEmailTo, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npThermoTrapValue=npThermoTrapValue, npForcedReboot=npForcedReboot, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopI=npCurLoopI, npThermoValue=npThermoValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue)
