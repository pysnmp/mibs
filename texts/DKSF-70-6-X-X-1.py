...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:51:22 2023
...
ObjectIdentity, IpAddress, NotificationType, Counter32, Unsigned32, Counter64, MibIdentifier, iso, Bits, TimeTicks, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "Unsigned32", "Counter64", "MibIdentifier", "iso", "Bits", "TimeTicks", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npRelayEntry=npRelayEntry, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, npThermo=npThermo, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempValue=npRelHumTempValue, npTrapEmailTo=npTrapEmailTo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumMemo=npRelHumMemo, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npThermoTrap=npThermoTrap, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npCurLoop=npCurLoop, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrap=npSmokeTrap, npIoTraps=npIoTraps, npRelHumidity=npRelHumidity, npResetStack=npResetStack, npThermoTraps=npThermoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npSmokeStatus=npSmokeStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayState=npRelayState, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, FixedPoint1000=FixedPoint1000, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumStatus=npRelHumStatus, npRelayMode=npRelayMode, npIr=npIr, npRelay=npRelay, npRelayMemo=npRelayMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npIo=npIo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeReset=npSmokeReset, npIoTable=npIoTable, npRelHumTrap=npRelHumTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoLow=npThermoLow, npRelayTable=npRelayTable, npIoTrapPrefix=npIoTrapPrefix, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npReboot=npReboot, npIrReset=npIrReset, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npThermoValuePrecise=npThermoValuePrecise, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopI=npCurLoopI, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npSmokeTraps=npSmokeTraps)
