...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:56:28 2021
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, enterprises, Bits, Counter64, Integer32, iso, IpAddress, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "enterprises", "Bits", "Counter64", "Integer32", "iso", "IpAddress", "Unsigned32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npCurLoopI=npCurLoopI, npRelHumN=npRelHumN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npSmokeTable=npSmokeTable, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoEntry=npThermoEntry, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npIoTraps=npIoTraps, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npResetStack=npResetStack, npIoTrapLineN=npIoTrapLineN, npIr=npIr, npThermoLow=npThermoLow, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeSensorN=npSmokeSensorN, npCurLoopPower=npCurLoopPower, npThermoTrapPrefix=npThermoTrapPrefix, npRelayMemo=npRelayMemo, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npCurLoopTrapR=npCurLoopTrapR, npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npReboot=npReboot, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npRelayStartReset=npRelayStartReset, npIoLevelOut=npIoLevelOut, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npGsmInfo=npGsmInfo, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeReset=npSmokeReset, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npThermoTraps=npThermoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrap=npThermoTrap, npThermoValue=npThermoValue, npThermoTrapStatus=npThermoTrapStatus, npForcedReboot=npForcedReboot, npRelayN=npRelayN, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npThermoTrapSensorN=npThermoTrapSensorN, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopN=npCurLoopN, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npCurLoopTable=npCurLoopTable, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npIrPlayCmd=npIrPlayCmd, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeStatus=npSmokeStatus, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npRelayEntry=npRelayEntry, npRelayState=npRelayState, npIoTrap=npIoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus)
