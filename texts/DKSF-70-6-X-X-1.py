...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:06:29 2024
...
ObjectIdentity, Integer32, NotificationType, Counter64, iso, enterprises, TimeTicks, Bits, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "iso", "enterprises", "TimeTicks", "Bits", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npRelHumTable=npRelHumTable, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopV=npCurLoopV, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npGsmInfo=npGsmInfo, npThermo=npThermo, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTraps=npGsmTraps, npThermoValue=npThermoValue, npIr=npIr, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPower=npCurLoopTrapPower, npGsmRegistration=npGsmRegistration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelayState=npRelayState, npIoLineN=npIoLineN, npCurLoopTrapR=npCurLoopTrapR, npResetStack=npResetStack, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npIrPlayCmd=npIrPlayCmd, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapValue=npThermoTrapValue, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, lightcom=lightcom, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumTrapData=npRelHumTrapData, npSoftReboot=npSoftReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npThermoTraps=npThermoTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npRelHumN=npRelHumN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npGsmTrap=npGsmTrap, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npTrapInfo=npTrapInfo, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npRelHumTrapDataN=npRelHumTrapDataN, npIoTable=npIoTable, npIoEntry=npIoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npCurLoop=npCurLoop)
