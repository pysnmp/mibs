...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:29:15 2021
...
Bits, enterprises, Unsigned32, MibIdentifier, Gauge32, ModuleIdentity, NotificationType, Integer32, IpAddress, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "Unsigned32", "MibIdentifier", "Gauge32", "ModuleIdentity", "NotificationType", "Integer32", "IpAddress", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeEntry=npSmokeEntry, npThermo=npThermo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayTable=npRelayTable, npIoTrap=npIoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapInfo=npTrapInfo, npCurLoopN=npCurLoopN, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapData=npRelHumTrapData, npGsmTraps=npGsmTraps, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumValue=npRelHumValue, npThermoSensorN=npThermoSensorN, npSoftReboot=npSoftReboot, npRelHumTable=npRelHumTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoValue=npThermoValue, npRelHumTrapFail=npRelHumTrapFail, npGsmTrap=npGsmTrap, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npRelHumStatus=npRelHumStatus, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npThermoTrapLow=npThermoTrapLow, npRelayN=npRelayN, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npThermoTraps=npThermoTraps, npCurLoopR=npCurLoopR, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokePower=npSmokePower, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTable=npCurLoopTable, npIoLineN=npIoLineN, npIr=npIr, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoMemo=npThermoMemo, npGsm=npGsm, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npSmokeTraps=npSmokeTraps, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempValue=npRelHumTempValue, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npResetStack=npResetStack, npRelayState=npRelayState, npThermoStatus=npThermoStatus, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npGsmTrapPrefix=npGsmTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmFailed=npGsmFailed, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelay=npRelay, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelOut=npIoLevelOut, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, npRelHumTrap=npRelHumTrap)
