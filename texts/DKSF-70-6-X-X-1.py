...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:47:58 2024
...
enterprises, Integer32, IpAddress, Bits, Unsigned32, TimeTicks, MibIdentifier, iso, ModuleIdentity, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "IpAddress", "Bits", "Unsigned32", "TimeTicks", "MibIdentifier", "iso", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapMemo=npThermoTrapMemo, npCurLoopV=npCurLoopV, npIrCtrl=npIrCtrl, npRelayStartReset=npRelayStartReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npTrapInfo=npTrapInfo, npSoftReboot=npSoftReboot, npIoEntry=npIoEntry, npThermoSensorN=npThermoSensorN, npThermoLow=npThermoLow, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npIrReset=npIrReset, npCurLoopTrapV=npCurLoopTrapV, npThermoTrap=npThermoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopN=npCurLoopN, npRelHumValue=npRelHumValue, npGsm=npGsm, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmStrength=npGsmStrength, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npThermo=npThermo, npRelHumTable=npRelHumTable, npSmokeMemo=npSmokeMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapN=npCurLoopTrapN, npGsmFailed=npGsmFailed, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npSmokeTrapMemo=npSmokeTrapMemo, npRelay=npRelay, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeReset=npSmokeReset, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npRelHumTempStatus=npRelHumTempStatus, npIoTable=npIoTable, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopPower=npCurLoopPower, npCurLoopEntry=npCurLoopEntry, npThermoHigh=npThermoHigh, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, npGsmInfo=npGsmInfo, npSmokeStatus=npSmokeStatus, npThermoTraps=npThermoTraps, npThermoEntry=npThermoEntry, npIoMemo=npIoMemo, npRelayN=npRelayN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopStatus=npCurLoopStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapData=npRelHumTrapData, npCurLoopTrap=npCurLoopTrap, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIr=npIr, npForcedReboot=npForcedReboot, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npIoLevelOut=npIoLevelOut, npSmokeTrap=npSmokeTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npRelHumTempValue=npRelHumTempValue, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTraps=npIoTraps)
