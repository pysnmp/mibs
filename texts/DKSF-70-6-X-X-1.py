...
# Produced by pysmi-1.1.12 at Tue May 28 13:39:42 2024
...
enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, Integer32, ObjectIdentity, ModuleIdentity, Counter64, Counter32, iso, IpAddress, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "Integer32", "ObjectIdentity", "ModuleIdentity", "Counter64", "Counter32", "iso", "IpAddress", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npRelHumTrapSafe=npRelHumTrapSafe, npGsmFailed=npGsmFailed, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npThermoLow=npThermoLow, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npRelHumMemo=npRelHumMemo, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npThermo=npThermo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTraps=npCurLoopTraps, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npRelHumTable=npRelHumTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npThermoValuePrecise=npThermoValuePrecise, npThermoMemo=npThermoMemo, npThermoTrapHigh=npThermoTrapHigh, npIoPulseCounter=npIoPulseCounter, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, lightcom=lightcom, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopV=npCurLoopV, npGsmRegistration=npGsmRegistration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrap=npIoTrap, npRelHumidity=npRelHumidity, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npReboot=npReboot, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapV=npCurLoopTrapV, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIr=npIr, npThermoTraps=npThermoTraps, npRelayMode=npRelayMode, npIoTable=npIoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npIoTrapMemo=npIoTrapMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTable=npCurLoopTable, npRelHumStatus=npRelHumStatus, npForcedReboot=npForcedReboot, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npRelHumN=npRelHumN, npGsmTrap=npGsmTrap, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, npSmokeTraps=npSmokeTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npGsmStrength=npGsmStrength)
