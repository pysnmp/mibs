...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:24:40 2022
...
Counter64, Counter32, TimeTicks, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Bits, ObjectIdentity, Unsigned32, Integer32, MibIdentifier, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "TimeTicks", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Bits", "ObjectIdentity", "Unsigned32", "Integer32", "MibIdentifier", "enterprises", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmStrength=npGsmStrength, npCurLoopV=npCurLoopV, npSmokeEntry=npSmokeEntry, npSmokeTraps=npSmokeTraps, npIoLevelOut=npIoLevelOut, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTraps=npThermoTraps, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npTrapInfo=npTrapInfo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapData=npRelHumTrapData, npCurLoopTable=npCurLoopTable, npCurLoopTraps=npCurLoopTraps, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, lightcom=lightcom, npSmokeTable=npSmokeTable, npGsmTraps=npGsmTraps, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npGsmFailed=npGsmFailed, npSoftReboot=npSoftReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npThermoSensorN=npThermoSensorN, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npIoTraps=npIoTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumMemo=npRelHumMemo, npReboot=npReboot, npRelay=npRelay, npSmokeTrapMemo=npSmokeTrapMemo, npRelayTable=npRelayTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTable=npThermoTable, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npGsm=npGsm, npIrPlayCmd=npIrPlayCmd, npSmokeMemo=npSmokeMemo, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npRelayEntry=npRelayEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npIoTrapLevelIn=npIoTrapLevelIn, npRelayN=npRelayN, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npRelayState=npRelayState, npIrCtrl=npIrCtrl, npIr=npIr, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopEntry=npCurLoopEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npSmokePower=npSmokePower, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npThermo=npThermo, npIoEntry=npIoEntry, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npRelayMemo=npRelayMemo, npSmokeStatus=npSmokeStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrap=npSmokeTrap, npSmokeReset=npSmokeReset, npCurLoopN=npCurLoopN, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapValue=npThermoTrapValue, npIoTrapMemo=npIoTrapMemo, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow)
