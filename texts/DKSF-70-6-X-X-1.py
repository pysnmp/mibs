...
# Produced by pysmi-1.1.8 at Wed Oct 11 07:59:17 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Counter32, IpAddress, enterprises, MibIdentifier, Gauge32, TimeTicks, Unsigned32, Counter64, NotificationType, Bits, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Counter32", "IpAddress", "enterprises", "MibIdentifier", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npRelayState=npRelayState, npThermoValue=npThermoValue, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMode=npRelayMode, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npGsm=npGsm, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npResetStack=npResetStack, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, npSmoke=npSmoke, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npIoLineN=npIoLineN, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npSmokeTrap=npSmokeTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapLow=npThermoTrapLow, npIrStatus=npIrStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopR=npCurLoopR, npIoTrapPrefix=npIoTrapPrefix, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, lightcom=lightcom, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npThermoStatus=npThermoStatus, npSoftReboot=npSoftReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoMemo=npIoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npIr=npIr, npThermoTrapSensorN=npThermoTrapSensorN, npRelayStartReset=npRelayStartReset, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable, npCurLoopTable=npCurLoopTable, npCurLoopV=npCurLoopV, npIrReset=npIrReset, npGsmFailed=npGsmFailed, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npIo=npIo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayEntry=npRelayEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopN=npCurLoopN)
