...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:29:12 2023
...
enterprises, Integer32, NotificationType, Counter64, Unsigned32, MibIdentifier, iso, ObjectIdentity, ModuleIdentity, IpAddress, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "NotificationType", "Counter64", "Unsigned32", "MibIdentifier", "iso", "ObjectIdentity", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npThermoTrap=npThermoTrap, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npSmokePower=npSmokePower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoEntry=npThermoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumValue=npRelHumValue, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeReset=npSmokeReset, npIrPlayCmd=npIrPlayCmd, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npThermo=npThermo, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrReset=npIrReset, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelay=npRelay, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelIn=npIoLevelIn, npIoTable=npIoTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npRelayMemo=npRelayMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npRelayStartReset=npRelayStartReset, npIoMemo=npIoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npIo=npIo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumEntry=npRelHumEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npThermoTrapValue=npThermoTrapValue, npGsm=npGsm, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTraps=npThermoTraps, npRelHumTable=npRelHumTable, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, npSmokeTraps=npSmokeTraps, npIoPulseCounter=npIoPulseCounter, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npSmoke=npSmoke, npIrCtrl=npIrCtrl, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npResetStack=npResetStack, npRelHumTrap=npRelHumTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIr=npIr, npGsmStrength=npGsmStrength, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, lightcom=lightcom, npSmokeTrap=npSmokeTrap, npCurLoopTable=npCurLoopTable, npIrStatus=npIrStatus)
