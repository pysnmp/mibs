...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:42:27 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, iso, TimeTicks, Bits, ObjectIdentity, MibIdentifier, Counter64, Integer32, IpAddress, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "iso", "TimeTicks", "Bits", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32", "IpAddress", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelayMemo=npRelayMemo, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npGsmRegistration=npGsmRegistration, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrReset=npIrReset, npSmokeMemo=npSmokeMemo, npThermoTrapStatus=npThermoTrapStatus, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopPower=npCurLoopPower, npRelHumTrapSafe=npRelHumTrapSafe, npIrPlayCmd=npIrPlayCmd, npRelayState=npRelayState, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npThermoValuePrecise=npThermoValuePrecise, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npCurLoopR=npCurLoopR, npCurLoopTraps=npCurLoopTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npSmokePower=npSmokePower, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npIr=npIr, npThermoLow=npThermoLow, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npCurLoop=npCurLoop, npSmokeEntry=npSmokeEntry, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npIoTable=npIoTable, npRelayStartReset=npRelayStartReset, npSmokeTraps=npSmokeTraps, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIo=npIo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapI=npCurLoopTrapI, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, npTrapInfo=npTrapInfo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumTrapTemp=npRelHumTrapTemp, npIoLineN=npIoLineN, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npSmoke=npSmoke, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmFailed=npGsmFailed, npReboot=npReboot, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npSmokeTrap=npSmokeTrap, npRelHumStatus=npRelHumStatus, npSmokeTable=npSmokeTable, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapEmailTo=npTrapEmailTo)
