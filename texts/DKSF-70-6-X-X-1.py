...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:30:36 2023
...
Unsigned32, Integer32, iso, Counter64, Counter32, enterprises, Bits, MibIdentifier, ModuleIdentity, Gauge32, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "iso", "Counter64", "Counter32", "enterprises", "Bits", "MibIdentifier", "ModuleIdentity", "Gauge32", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoSensorN=npThermoSensorN, npGsm=npGsm, npIrStatus=npIrStatus, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npRelayStartReset=npRelayStartReset, npRelHumTrap=npRelHumTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npGsmTraps=npGsmTraps, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npRelHumValue=npRelHumValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npRelayState=npRelayState, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, FixedPoint1000=FixedPoint1000, npCurLoopEntry=npCurLoopEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npThermoMemo=npThermoMemo, npThermoHigh=npThermoHigh, npSmoke=npSmoke, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTable=npCurLoopTable, npIoLevelOut=npIoLevelOut, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, npRelayMode=npRelayMode, npIoPulseCounter=npIoPulseCounter, npTrapEmailTo=npTrapEmailTo, npSmokePower=npSmokePower, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npRelHumidity=npRelHumidity, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValue=npThermoValue, npIoTraps=npIoTraps, npThermoTrapHigh=npThermoTrapHigh, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTable=npSmokeTable, npRelayTable=npRelayTable, npCurLoopTraps=npCurLoopTraps, npThermoEntry=npThermoEntry, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLineN=npIoTrapLineN, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npGsmTrapPrefix=npGsmTrapPrefix, npThermo=npThermo, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmFailed=npGsmFailed, npIo=npIo, npThermoStatus=npThermoStatus, npForcedReboot=npForcedReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npSmokeEntry=npSmokeEntry, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopV=npCurLoopV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopI=npCurLoopI, npThermoTrapSensorN=npThermoTrapSensorN, npRelayN=npRelayN, npIoTrapMemo=npIoTrapMemo, npCurLoopN=npCurLoopN, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, npSmokeStatus=npSmokeStatus)
