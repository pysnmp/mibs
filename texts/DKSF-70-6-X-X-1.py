...
# Produced by pysmi-1.1.12 at Wed May 29 06:49:09 2024
...
MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, IpAddress, iso, NotificationType, Unsigned32, Integer32, Counter64, Gauge32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "IpAddress", "iso", "NotificationType", "Unsigned32", "Integer32", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmStrength=npGsmStrength, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrap=npThermoTrap, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npRelayStartReset=npRelayStartReset, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopStatus=npCurLoopStatus, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelOut=npIoLevelOut, npGsm=npGsm, npResetStack=npResetStack, npThermoTrapStatus=npThermoTrapStatus, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npRelayState=npRelayState, npIr=npIr, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npGsmFailed=npGsmFailed, npCurLoopTrapR=npCurLoopTrapR, npThermo=npThermo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, lightcom=lightcom, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayN=npRelayN, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoEntry=npIoEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npThermoTraps=npThermoTraps, npForcedReboot=npForcedReboot, npThermoTrapPrefix=npThermoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npSoftReboot=npSoftReboot, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npCurLoopR=npCurLoopR, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapMemo=npThermoTrapMemo, npRelHumStatus=npRelHumStatus, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTraps=npSmokeTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npRelHumN=npRelHumN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npRelayMemo=npRelayMemo, npIo=npIo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopN=npCurLoopN, npRelay=npRelay, npSmokeMemo=npSmokeMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npIoTrapLineN=npIoTrapLineN, npRelHumidity=npRelHumidity, npThermoTable=npThermoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoMemo=npThermoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTable=npCurLoopTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower)
