...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:50:34 2021
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ModuleIdentity, TimeTicks, Counter64, Integer32, iso, Bits, enterprises, Unsigned32, NotificationType, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter64", "Integer32", "iso", "Bits", "enterprises", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npSmokeReset=npSmokeReset, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapInfo=npTrapInfo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrap=npIoTrap, npIrCtrl=npIrCtrl, npRelHumTempStatus=npRelHumTempStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumMemo=npRelHumMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapSensorN=npThermoTrapSensorN, npGsmInfo=npGsmInfo, npRelayMemo=npRelayMemo, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npForcedReboot=npForcedReboot, npIrPlayCmd=npIrPlayCmd, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, lightcom=lightcom, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npGsmRegistration=npGsmRegistration, npRelHumStatus=npRelHumStatus, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npIoMemo=npIoMemo, npThermoSensorN=npThermoSensorN, npTrapEmailTo=npTrapEmailTo, npRelHumTrap=npRelHumTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLevelOut=npIoLevelOut, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTraps=npSmokeTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSoftReboot=npSoftReboot, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo, npThermoEntry=npThermoEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumValue=npRelHumValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoLow=npThermoLow, npRelayN=npRelayN, npReboot=npReboot, npSmokeEntry=npSmokeEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npRelHumTable=npRelHumTable, npIo=npIo, npGsm=npGsm, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npThermoTraps=npThermoTraps, npIoTable=npIoTable, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npRelayTable=npRelayTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npCurLoopI=npCurLoopI, npResetStack=npResetStack, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npIrReset=npIrReset, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npThermoStatus=npThermoStatus, npCurLoopTrap=npCurLoopTrap, npGsmFailed=npGsmFailed)
