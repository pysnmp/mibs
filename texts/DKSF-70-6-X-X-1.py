...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:30:03 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Bits, IpAddress, Unsigned32, Counter32, iso, ObjectIdentity, Integer32, NotificationType, Gauge32, Counter64, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Bits", "IpAddress", "Unsigned32", "Counter32", "iso", "ObjectIdentity", "Integer32", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npResetStack=npResetStack, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npThermoTrapLow=npThermoTrapLow, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npIoEntry=npIoEntry, npSoftReboot=npSoftReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrCtrl=npIrCtrl, lightcom=lightcom, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npThermoMemo=npThermoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIr=npIr, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npThermoHigh=npThermoHigh, npSmokePower=npSmokePower, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrap=npGsmTrap, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopTable=npCurLoopTable, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npSmoke=npSmoke, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npRelayMode=npRelayMode, npCurLoopN=npCurLoopN, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeStatus=npSmokeStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopEntry=npCurLoopEntry, npRelHumMemo=npRelHumMemo, npGsmInfo=npGsmInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npForcedReboot=npForcedReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTable=npThermoTable, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npCurLoopV=npCurLoopV, npCurLoopTrap=npCurLoopTrap, npIrStatus=npIrStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeEntry=npSmokeEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npRelay=npRelay, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopI=npCurLoopI, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset)
