...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:34:44 2022
...
ObjectIdentity, iso, IpAddress, Integer32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, enterprises, Counter32, Unsigned32, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "IpAddress", "Integer32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "enterprises", "Counter32", "Unsigned32", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMemo=npRelayMemo, npIoTable=npIoTable, lightcom=lightcom, npIoLineN=npIoLineN, npThermoStatus=npThermoStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrap=npRelHumTrap, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npRelHumN=npRelHumN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsm=npGsm, npRelHumidity=npRelHumidity, npThermoLow=npThermoLow, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npGsmTrap=npGsmTrap, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npCurLoopTrapV=npCurLoopTrapV, npCurLoopR=npCurLoopR, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npIrReset=npIrReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npIoLevelIn=npIoLevelIn, npIr=npIr, npSmokeReset=npSmokeReset, npCurLoopTrapN=npCurLoopTrapN, npThermoValue=npThermoValue, npForcedReboot=npForcedReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npGsmFailed=npGsmFailed, npThermoTrapHigh=npThermoTrapHigh, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npRelHumTrapFail=npRelHumTrapFail, npIo=npIo, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npTrapEmailTo=npTrapEmailTo, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopI=npCurLoopI, npThermoTraps=npThermoTraps, npGsmRegistration=npGsmRegistration, npThermoTrapLow=npThermoTrapLow)
