...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:11:21 2024
...
Bits, NotificationType, ObjectIdentity, TimeTicks, enterprises, IpAddress, ModuleIdentity, Integer32, MibIdentifier, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ObjectIdentity", "TimeTicks", "enterprises", "IpAddress", "ModuleIdentity", "Integer32", "MibIdentifier", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npRelHumTrap=npRelHumTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, lightcom=lightcom, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumMemo=npRelHumMemo, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelIn=npIoLevelIn, npThermoLow=npThermoLow, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npCurLoopTrap=npCurLoopTrap, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLineN=npIoTrapLineN, npIrCtrl=npIrCtrl, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npCurLoopTable=npCurLoopTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npGsm=npGsm, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npSoftReboot=npSoftReboot, npCurLoopPower=npCurLoopPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npRelayMemo=npRelayMemo, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable, npIoTrapPrefix=npIoTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTable=npIoTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokePower=npSmokePower, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npRelHumEntry=npRelHumEntry, npIrStatus=npIrStatus, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npResetStack=npResetStack, npSmokeSensorN=npSmokeSensorN, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoEntry=npIoEntry, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npSmokeTrapMemo=npSmokeTrapMemo, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmRegistration=npGsmRegistration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelay=npRelay, npIo=npIo, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap)
