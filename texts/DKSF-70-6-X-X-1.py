...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:56:28 2024
...
ModuleIdentity, Gauge32, Integer32, ObjectIdentity, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, iso, Unsigned32, enterprises, MibIdentifier, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "iso", "Unsigned32", "enterprises", "MibIdentifier", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npRelayEntry=npRelayEntry, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrap=npThermoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopEntry=npCurLoopEntry, npIoEntry=npIoEntry, npThermoHigh=npThermoHigh, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTraps=npGsmTraps, npIoTrap=npIoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npCurLoopPower=npCurLoopPower, npGsmRegistration=npGsmRegistration, npRelHumEntry=npRelHumEntry, npIrReset=npIrReset, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTraps=npIoTraps, npReboot=npReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapLow=npThermoTrapLow, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrap=npSmokeTrap, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTable=npThermoTable, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, lightcom=lightcom, npRelayMemo=npRelayMemo, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npSmokeTable=npSmokeTable, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, FixedPoint1000=FixedPoint1000, npIo=npIo, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npRelHumStatus=npRelHumStatus, npRelHumTrapSafe=npRelHumTrapSafe, npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npSmokeReset=npSmokeReset, npGsmInfo=npGsmInfo, npSmokeTraps=npSmokeTraps, npIoLevelIn=npIoLevelIn, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npThermoStatus=npThermoStatus, npRelHumTrapFail=npRelHumTrapFail, npForcedReboot=npForcedReboot, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLineN=npIoLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npGsmFailed=npGsmFailed, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npThermoEntry=npThermoEntry, npGsmTrap=npGsmTrap, npCurLoopTable=npCurLoopTable, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelay=npRelay, npIoTable=npIoTable, npRelayStartReset=npRelayStartReset)
