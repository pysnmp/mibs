...
# Produced by pysmi-1.1.11 at Wed Dec  6 03:04:41 2023
...
iso, Integer32, ModuleIdentity, Bits, IpAddress, MibIdentifier, TimeTicks, NotificationType, Unsigned32, Gauge32, ObjectIdentity, Counter32, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npCurLoopPower=npCurLoopPower, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, FixedPoint1000=FixedPoint1000, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npResetStack=npResetStack, npRelayMode=npRelayMode, npCurLoopTraps=npCurLoopTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, npRelHumValue=npRelHumValue, npRelHumTrap=npRelHumTrap, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npSmoke=npSmoke, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTable=npThermoTable, lightcom=lightcom, npIoMemo=npIoMemo, npThermoTrap=npThermoTrap, npThermo=npThermo, npRelayMemo=npRelayMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npIo=npIo, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumN=npRelHumN, npThermoSensorN=npThermoSensorN, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoPulseCounter=npIoPulseCounter, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npGsmFailed=npGsmFailed, npCurLoopR=npCurLoopR, npIoTable=npIoTable, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempStatus=npRelHumTempStatus, npSmokeSensorN=npSmokeSensorN, npIoTrapLineN=npIoTrapLineN, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npGsm=npGsm, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTraps=npIoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTraps=npSmokeTraps, npIoEntry=npIoEntry, npGsmInfo=npGsmInfo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npRelHumEntry=npRelHumEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap, npThermoTraps=npThermoTraps, npIrCtrl=npIrCtrl, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npIr=npIr, npRelayTable=npRelayTable, npSmokeReset=npSmokeReset, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN)
