...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:05:52 2024
...
Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter64, ModuleIdentity, NotificationType, TimeTicks, Integer32, iso, enterprises, ObjectIdentity, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter64", "ModuleIdentity", "NotificationType", "TimeTicks", "Integer32", "iso", "enterprises", "ObjectIdentity", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMemo=npRelayMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npReboot=npReboot, npCurLoopV=npCurLoopV, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npSmokeTrap=npSmokeTrap, npIoTrap=npIoTrap, npCurLoopTrapR=npCurLoopTrapR, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumidity=npRelHumidity, npThermoTable=npThermoTable, npRelayTable=npRelayTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npIrReset=npIrReset, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, npGsmTrap=npGsmTrap, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoEntry=npThermoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopR=npCurLoopR, npIoTable=npIoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumEntry=npRelHumEntry, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npCurLoopTrap=npCurLoopTrap, npRelHumTrapData=npRelHumTrapData, npIrStatus=npIrStatus, npRelHumStatus=npRelHumStatus, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumMemo=npRelHumMemo, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrCtrl=npIrCtrl, npThermoSensorN=npThermoSensorN, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npIoTrapLineN=npIoTrapLineN, npThermoTrap=npThermoTrap, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopEntry=npCurLoopEntry, npIoLevelOut=npIoLevelOut, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npRelHumTrapFail=npRelHumTrapFail, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npResetStack=npResetStack, npRelayState=npRelayState, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopPower=npCurLoopPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npSmokeReset=npSmokeReset, npIoTraps=npIoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIr=npIr, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmStrength=npGsmStrength, lightcom=lightcom, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npCurLoopI=npCurLoopI, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus)
