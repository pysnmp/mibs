...
# Produced by pysmi-1.1.3 at Wed Dec  1 14:54:40 2021
...
enterprises, Unsigned32, ObjectIdentity, IpAddress, Bits, Counter32, Integer32, ModuleIdentity, MibIdentifier, Counter64, iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "ObjectIdentity", "IpAddress", "Bits", "Counter32", "Integer32", "ModuleIdentity", "MibIdentifier", "Counter64", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumMemo=npRelHumMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npSmokeSensorN=npSmokeSensorN, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelIn=npIoLevelIn, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npSmokeStatus=npSmokeStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npThermoTraps=npThermoTraps, npResetStack=npResetStack, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npGsmTrap=npGsmTrap, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrPlayCmd=npIrPlayCmd, npCurLoopN=npCurLoopN, npRelay=npRelay, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npThermoLow=npThermoLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npIoPulseCounter=npIoPulseCounter, npThermoTrapStatus=npThermoTrapStatus, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npThermoTrapMemo=npThermoTrapMemo, npIr=npIr, npSmokeEntry=npSmokeEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmFailed=npGsmFailed, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopStatus=npCurLoopStatus, npGsm=npGsm, npIoTable=npIoTable, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeMemo=npSmokeMemo, npIoTraps=npIoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npIrReset=npIrReset, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npThermo=npThermo, npRelHumN=npRelHumN, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npRelayState=npRelayState, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npSmokePower=npSmokePower, npGsmRegistration=npGsmRegistration, npRelHumTrapSafe=npRelHumTrapSafe, npIrCtrl=npIrCtrl, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, lightcom=lightcom, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npIo=npIo, npIoLineN=npIoLineN, npThermoTrapLow=npThermoTrapLow)
