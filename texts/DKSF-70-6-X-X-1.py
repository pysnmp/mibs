...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:31:54 2022
...
iso, Gauge32, ObjectIdentity, IpAddress, Integer32, Counter32, Counter64, Bits, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "Counter64", "Bits", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npThermoValue=npThermoValue, npRelHumMemo=npRelHumMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npRelayTable=npRelayTable, npCurLoopI=npCurLoopI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npTrapEmailTo=npTrapEmailTo, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, lightcom=lightcom, npResetStack=npResetStack, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeSensorN=npSmokeSensorN, npThermoHigh=npThermoHigh, npIr=npIr, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrCtrl=npIrCtrl, npRelHumTrap=npRelHumTrap, npIoTraps=npIoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npThermoTrap=npThermoTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrStatus=npIrStatus, npIoTrap=npIoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npReboot=npReboot, npRelHumidity=npRelHumidity, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npThermoSensorN=npThermoSensorN, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npThermoTrapMemo=npThermoTrapMemo, npGsm=npGsm, npRelHumStatus=npRelHumStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, npSmokeMemo=npSmokeMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, npSmokeTable=npSmokeTable, npRelHumTrapFail=npRelHumTrapFail, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npCurLoopPower=npCurLoopPower, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapN=npCurLoopTrapN, npIoMemo=npIoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npSmokeReset=npSmokeReset, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, npIo=npIo, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn)
