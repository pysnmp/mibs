...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:49:15 2024
...
Integer32, enterprises, ObjectIdentity, Unsigned32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, MibIdentifier, TimeTicks, IpAddress, ModuleIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "ObjectIdentity", "Unsigned32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "MibIdentifier", "TimeTicks", "IpAddress", "ModuleIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npGsmInfo=npGsmInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, npThermoTrap=npThermoTrap, npIoPulseCounter=npIoPulseCounter, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapI=npCurLoopTrapI, npSmokeMemo=npSmokeMemo, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeSensorN=npSmokeSensorN, npSmokeEntry=npSmokeEntry, npThermoSensorN=npThermoSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npRelayMode=npRelayMode, npRelayState=npRelayState, npIo=npIo, npIr=npIr, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelIn=npIoTrapLevelIn, npThermoEntry=npThermoEntry, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npThermoLow=npThermoLow, npThermoTrapStatus=npThermoTrapStatus, npCurLoopV=npCurLoopV, npSmoke=npSmoke, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsm=npGsm, npRelay=npRelay, npIoTrapMemo=npIoTrapMemo, npGsmTraps=npGsmTraps, npCurLoopTrapR=npCurLoopTrapR, npIoLevelOut=npIoLevelOut, npResetStack=npResetStack, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npRelHumValue=npRelHumValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoStatus=npThermoStatus, npThermoHigh=npThermoHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapMemo=npThermoTrapMemo, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayEntry=npRelayEntry, lightcom=lightcom, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTable=npThermoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npIoTrapLineN=npIoTrapLineN, npIrStatus=npIrStatus, npThermoValue=npThermoValue, npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, npForcedReboot=npForcedReboot, npCurLoopI=npCurLoopI, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npThermoMemo=npThermoMemo, npCurLoopPower=npCurLoopPower)
