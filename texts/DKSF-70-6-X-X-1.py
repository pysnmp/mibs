...
# Produced by pysmi-1.1.11 at Wed Apr  3 15:18:29 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, NotificationType, iso, Bits, Counter32, Gauge32, enterprises, Counter64, Integer32, Unsigned32, ObjectIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "NotificationType", "iso", "Bits", "Counter32", "Gauge32", "enterprises", "Counter64", "Integer32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelay=npRelay, npThermoHigh=npThermoHigh, npRelayState=npRelayState, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapPrefix=npSmokeTrapPrefix, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npIr=npIr, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npSmokeTraps=npSmokeTraps, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npCurLoopTraps=npCurLoopTraps, npRelHumMemo=npRelHumMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npResetStack=npResetStack, npRelayTable=npRelayTable, npThermoValue=npThermoValue, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumEntry=npRelHumEntry, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLineN=npIoTrapLineN, npSmokePower=npSmokePower, npThermoEntry=npThermoEntry, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npTrapEmailTo=npTrapEmailTo, npReboot=npReboot, npCurLoopTable=npCurLoopTable, npSmokeSensorN=npSmokeSensorN, npCurLoop=npCurLoop, npGsmStrength=npGsmStrength, npSmoke=npSmoke, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopPower=npCurLoopPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSoftReboot=npSoftReboot, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumidity=npRelHumidity, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTable=npRelHumTable, npSmokeReset=npSmokeReset, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npCurLoopV=npCurLoopV, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapInfo=npTrapInfo, npIoLevelOut=npIoLevelOut, npSmokeMemo=npSmokeMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumValue=npRelHumValue, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapValue=npThermoTrapValue, npThermoStatus=npThermoStatus, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, npSmokeTable=npSmokeTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npCurLoopI=npCurLoopI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npRelayMode=npRelayMode)
