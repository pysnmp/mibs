...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:52:14 2023
...
IpAddress, MibIdentifier, ObjectIdentity, NotificationType, TimeTicks, Bits, Unsigned32, ModuleIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "ModuleIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoPulseCounter=npIoPulseCounter, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopStatus=npCurLoopStatus, npRelHumValue=npRelHumValue, npRelayTable=npRelayTable, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelay=npRelay, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npSmokeEntry=npSmokeEntry, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayState=npRelayState, npThermoTrapMemo=npThermoTrapMemo, npSmokeTable=npSmokeTable, npReboot=npReboot, npTrapInfo=npTrapInfo, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npCurLoopEntry=npCurLoopEntry, npRelHumidity=npRelHumidity, npSmokeStatus=npSmokeStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npIoTrapPrefix=npIoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npIrPlayCmd=npIrPlayCmd, npRelayEntry=npRelayEntry, npForcedReboot=npForcedReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopN=npCurLoopN, npGsm=npGsm, npIrStatus=npIrStatus, npRelHumTable=npRelHumTable, npThermoEntry=npThermoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoop=npCurLoop, npSoftReboot=npSoftReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrCtrl=npIrCtrl, npThermo=npThermo, lightcom=lightcom, npRelayN=npRelayN, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npSmokeMemo=npSmokeMemo, npThermoTable=npThermoTable, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npSmokeReset=npSmokeReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrap=npIoTrap, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumMemo=npRelHumMemo, npSmokeTrap=npSmokeTrap, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTempValue=npRelHumTempValue, npThermoMemo=npThermoMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapR=npCurLoopTrapR, npIo=npIo, npCurLoopV=npCurLoopV, npRelHumStatus=npRelHumStatus, npResetStack=npResetStack, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTraps=npIoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npIoMemo=npIoMemo, npCurLoopTable=npCurLoopTable, npIr=npIr, npThermoSensorN=npThermoSensorN, npCurLoopTrapI=npCurLoopTrapI, npThermoTraps=npThermoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue)
