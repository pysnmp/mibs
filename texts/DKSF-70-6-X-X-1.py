...
# Produced by pysmi-1.1.8 at Mon Jan 17 10:06:23 2022
...
Bits, iso, enterprises, MibIdentifier, NotificationType, IpAddress, ObjectIdentity, Integer32, Counter32, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "enterprises", "MibIdentifier", "NotificationType", "IpAddress", "ObjectIdentity", "Integer32", "Counter32", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopStatus=npCurLoopStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npThermoValue=npThermoValue, npGsmFailed=npGsmFailed, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npIo=npIo, npGsmTraps=npGsmTraps, npIoTrapLineN=npIoTrapLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTable=npCurLoopTable, npIoTrap=npIoTrap, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npCurLoopTraps=npCurLoopTraps, npThermoEntry=npThermoEntry, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npRelHumidity=npRelHumidity, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapValue=npThermoTrapValue, npRelayEntry=npRelayEntry, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npSmokeEntry=npSmokeEntry, npIr=npIr, lightcom=lightcom, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayTable=npRelayTable, npThermoTable=npThermoTable, npIoLevelIn=npIoLevelIn, npRelHumN=npRelHumN, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npIoPulseCounter=npIoPulseCounter, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeStatus=npSmokeStatus, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrap=npCurLoopTrap, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npRelayStartReset=npRelayStartReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npIrReset=npIrReset, npGsm=npGsm, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npThermoTraps=npThermoTraps, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npCurLoopTrapN=npCurLoopTrapN)
