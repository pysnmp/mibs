...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:44:13 2021
...
enterprises, Counter32, TimeTicks, IpAddress, NotificationType, Counter64, ModuleIdentity, Unsigned32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "TimeTicks", "IpAddress", "NotificationType", "Counter64", "ModuleIdentity", "Unsigned32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Integer32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npIrStatus=npIrStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npTrapEmailTo=npTrapEmailTo, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTable=npCurLoopTable, npThermoSensorN=npThermoSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapValue=npThermoTrapValue, npThermoLow=npThermoLow, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npThermoHigh=npThermoHigh, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npSmokePower=npSmokePower, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTable=npThermoTable, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npGsmStrength=npGsmStrength, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopEntry=npCurLoopEntry, npIrPlayCmd=npIrPlayCmd, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npIoLineN=npIoLineN, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoStatus=npThermoStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npForcedReboot=npForcedReboot, npGsmFailed=npGsmFailed, npSmokeTrap=npSmokeTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrap=npCurLoopTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npIr=npIr, npSmokeEntry=npSmokeEntry, npSmoke=npSmoke, npRelHumTempStatus=npRelHumTempStatus, npRelayMemo=npRelayMemo, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, npTrapInfo=npTrapInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, npIoTrapLineN=npIoTrapLineN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsm=npGsm, npGsmTraps=npGsmTraps, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoop=npCurLoop, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrap=npRelHumTrap, npIrCtrl=npIrCtrl, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npIoTable=npIoTable, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoEntry=npThermoEntry, npSoftReboot=npSoftReboot, npReboot=npReboot, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npResetStack=npResetStack, npThermoTrapLow=npThermoTrapLow, npCurLoopPower=npCurLoopPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npIoPulseCounter=npIoPulseCounter, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayTable=npRelayTable, npThermoTrapSensorN=npThermoTrapSensorN)
