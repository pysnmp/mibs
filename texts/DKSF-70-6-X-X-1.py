...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:54:17 2022
...
enterprises, ObjectIdentity, IpAddress, iso, MibIdentifier, TimeTicks, Unsigned32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "TimeTicks", "Unsigned32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelayStartReset=npRelayStartReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, npSmokeTraps=npSmokeTraps, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapStatus=npThermoTrapStatus, npCurLoopStatus=npCurLoopStatus, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npThermoTrapMemo=npThermoTrapMemo, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopV=npCurLoopV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapMemo=npIoTrapMemo, npThermoTrapLow=npThermoTrapLow, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npGsmTrap=npGsmTrap, npReboot=npReboot, lightcom=lightcom, npThermo=npThermo, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npRelHumTrapData=npRelHumTrapData, npSmokePower=npSmokePower, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npSoftReboot=npSoftReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoSensorN=npThermoSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrap=npIoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelOut=npIoLevelOut, npSmokeStatus=npSmokeStatus, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npGsmStrength=npGsmStrength, npThermoMemo=npThermoMemo, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumidity=npRelHumidity, npThermoTrapHigh=npThermoTrapHigh, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayState=npRelayState, npThermoStatus=npThermoStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTable=npCurLoopTable, npCurLoopR=npCurLoopR, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npSmokeSensorN=npSmokeSensorN, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoLow=npThermoLow, npGsm=npGsm, npRelayMode=npRelayMode, npIo=npIo, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npIr=npIr)
