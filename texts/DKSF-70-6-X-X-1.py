...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:40:14 2021
...
Counter32, Gauge32, Unsigned32, Integer32, Bits, IpAddress, Counter64, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, ObjectIdentity, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Unsigned32", "Integer32", "Bits", "IpAddress", "Counter64", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npCurLoopI=npCurLoopI, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npThermoTrapMemo=npThermoTrapMemo, npIrCtrl=npIrCtrl, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npSmokeReset=npSmokeReset, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, FixedPoint1000=FixedPoint1000, npCurLoopTrapV=npCurLoopTrapV, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npRelayTable=npRelayTable, npRelHumTrapDataN=npRelHumTrapDataN, npResetStack=npResetStack, npIoTrapLineN=npIoTrapLineN, npIoTable=npIoTable, npThermoTable=npThermoTable, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeMemo=npSmokeMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmStrength=npGsmStrength, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrStatus=npIrStatus, npCurLoopTrapR=npCurLoopTrapR, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npRelayMemo=npRelayMemo, npCurLoopPower=npCurLoopPower, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npSmokeEntry=npSmokeEntry, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npSmokeTraps=npSmokeTraps, npIoPulseCounter=npIoPulseCounter, npSmokeStatus=npSmokeStatus, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmFailed=npGsmFailed, npRelHumStatus=npRelHumStatus, npGsm=npGsm, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npThermo=npThermo, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npThermoMemo=npThermoMemo, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTable=npSmokeTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoop=npCurLoop, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapHigh=npThermoTrapHigh, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumEntry=npRelHumEntry, npForcedReboot=npForcedReboot, npThermoTrapValue=npThermoTrapValue, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npIoLevelIn=npIoLevelIn, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopV=npCurLoopV, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npCurLoopTrapI=npCurLoopTrapI, lightcom=lightcom, npThermoTrapStatus=npThermoTrapStatus)
