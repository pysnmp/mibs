...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:21:21 2024
...
Integer32, Bits, ModuleIdentity, NotificationType, MibIdentifier, Unsigned32, Counter64, enterprises, Gauge32, IpAddress, Counter32, iso, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ModuleIdentity", "NotificationType", "MibIdentifier", "Unsigned32", "Counter64", "enterprises", "Gauge32", "IpAddress", "Counter32", "iso", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npSmokeSensorN=npSmokeSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npRelayStartReset=npRelayStartReset, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrap=npSmokeTrap, npIoEntry=npIoEntry, npIr=npIr, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrap=npIoTrap, npIo=npIo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTable=npThermoTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, npIoTrapLineN=npIoTrapLineN, npGsmTrap=npGsmTrap, FixedPoint1000=FixedPoint1000, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoMemo=npThermoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelayEntry=npRelayEntry, npSoftReboot=npSoftReboot, npThermoStatus=npThermoStatus, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, npRelHumN=npRelHumN, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npSmokeStatus=npSmokeStatus, npIoTrapMemo=npIoTrapMemo, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopV=npCurLoopV, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsm=npGsm, npThermo=npThermo, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npReboot=npReboot, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npCurLoopTrapI=npCurLoopTrapI, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npSmokePower=npSmokePower, npRelayState=npRelayState, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumEntry=npRelHumEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapData=npRelHumTrapData, npThermoLow=npThermoLow, npThermoValue=npThermoValue, npGsmInfo=npGsmInfo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, lightcom=lightcom, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npThermoTraps=npThermoTraps, npRelHumTable=npRelHumTable, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopN=npCurLoopN, npThermoHigh=npThermoHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe)
