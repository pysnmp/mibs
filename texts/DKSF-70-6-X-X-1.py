...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:29:22 2021
...
Bits, MibIdentifier, TimeTicks, ObjectIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, enterprises, iso, NotificationType, Gauge32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "enterprises", "iso", "NotificationType", "Gauge32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTable=npCurLoopTable, npGsm=npGsm, npIrStatus=npIrStatus, npIr=npIr, npThermoHigh=npThermoHigh, npIoTable=npIoTable, lightcom=lightcom, npCurLoopN=npCurLoopN, npGsmStrength=npGsmStrength, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopR=npCurLoopR, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npIo=npIo, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue, npRelayMemo=npRelayMemo, npRelHumTempStatus=npRelHumTempStatus, npIoLineN=npIoLineN, npCurLoopTrapR=npCurLoopTrapR, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npRelay=npRelay, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTraps=npThermoTraps, npTrapEmailTo=npTrapEmailTo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumEntry=npRelHumEntry, npRelayN=npRelayN, npIrReset=npIrReset, npSmoke=npSmoke, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npGsmRegistration=npGsmRegistration, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapMemo=npThermoTrapMemo, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeStatus=npSmokeStatus, npCurLoopPower=npCurLoopPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npSmokeSensorN=npSmokeSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTable=npRelHumTable, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npRelHumTrapAllChannels=npRelHumTrapAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrPlayCmd=npIrPlayCmd, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapInfo=npTrapInfo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npThermo=npThermo, npSmokeMemo=npSmokeMemo, npRelHumTempValue=npRelHumTempValue, npCurLoop=npCurLoop, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumMemo=npRelHumMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npThermoEntry=npThermoEntry, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npReboot=npReboot, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelayTable=npRelayTable, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayState=npRelayState)
