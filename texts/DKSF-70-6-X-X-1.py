...
Unsigned32, iso, Counter64, IpAddress, Bits, NotificationType, enterprises, Counter32, Integer32, ModuleIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter64", "IpAddress", "Bits", "NotificationType", "enterprises", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npThermo=npThermo, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapI=npCurLoopTrapI, lightcom=lightcom, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npSmokePower=npSmokePower, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumEntry=npRelHumEntry, npIoTraps=npIoTraps, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npRelayEntry=npRelayEntry, npIrStatus=npIrStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npRelayMode=npRelayMode, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npSmokeTraps=npSmokeTraps, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrap=npGsmTrap, npIoLineN=npIoLineN, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoPulseCounter=npIoPulseCounter, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npCurLoopN=npCurLoopN, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npIrPlayCmd=npIrPlayCmd, npRelayTable=npRelayTable, npIo=npIo, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrap=npThermoTrap, npSmokeTable=npSmokeTable, npReboot=npReboot, npGsmTrapPrefix=npGsmTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMemo=npRelayMemo, npSmokeSensorN=npSmokeSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrap=npIoTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npRelay=npRelay, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrCtrl=npIrCtrl, npRelHumTable=npRelHumTable, npCurLoopTrap=npCurLoopTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoLow=npThermoLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npSoftReboot=npSoftReboot, npSmokeReset=npSmokeReset, npThermoHigh=npThermoHigh)
