...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:48:56 2021
...
NotificationType, Counter32, Gauge32, Integer32, IpAddress, Counter64, iso, Unsigned32, MibIdentifier, TimeTicks, Bits, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "Integer32", "IpAddress", "Counter64", "iso", "Unsigned32", "MibIdentifier", "TimeTicks", "Bits", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npReboot=npReboot, npSmoke=npSmoke, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npThermoTrapMemo=npThermoTrapMemo, npRelHumN=npRelHumN, npIrReset=npIrReset, npThermoTrapValue=npThermoTrapValue, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npRelHumStatus=npRelHumStatus, npSmokeMemo=npSmokeMemo, npRelayMode=npRelayMode, npIo=npIo, npIoSinglePulseStart=npIoSinglePulseStart, npIr=npIr, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npCurLoopN=npCurLoopN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLineN=npIoTrapLineN, npThermoTrap=npThermoTrap, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, lightcom=lightcom, npRelHumTrapFail=npRelHumTrapFail, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempStatus=npRelHumTempStatus, npThermoEntry=npThermoEntry, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npRelayN=npRelayN, npSmokeTrapStatus=npSmokeTrapStatus, npThermoHigh=npThermoHigh, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTraps=npIoTraps, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, npRelHumTempValue=npRelHumTempValue, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayTable=npRelayTable, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npSmokeSensorN=npSmokeSensorN, npCurLoopTable=npCurLoopTable, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokePower=npSmokePower, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrStatus=npIrStatus, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npGsmTrap=npGsmTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsm=npGsm, npSmokeEntry=npSmokeEntry, npSmokeReset=npSmokeReset, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npSoftReboot=npSoftReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npGsmStrength=npGsmStrength, npResetStack=npResetStack, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npIoLineN=npIoLineN, npRelHumMemo=npRelHumMemo, npSmokeStatus=npSmokeStatus, npCurLoopI=npCurLoopI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npRelayMemo=npRelayMemo, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo)
