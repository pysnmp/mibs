...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:31:40 2022
...
ObjectIdentity, MibIdentifier, ModuleIdentity, Bits, Counter64, Gauge32, Integer32, NotificationType, iso, Unsigned32, Counter32, IpAddress, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Bits", "Counter64", "Gauge32", "Integer32", "NotificationType", "iso", "Unsigned32", "Counter32", "IpAddress", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempFail=npRelHumTrapTempFail, npGsm=npGsm, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npCurLoopTrapV=npCurLoopTrapV, npRelHumEntry=npRelHumEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npCurLoopV=npCurLoopV, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumValue=npRelHumValue, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npRelayTable=npRelayTable, npThermoEntry=npThermoEntry, npIo=npIo, npGsmFailed=npGsmFailed, npForcedReboot=npForcedReboot, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npIoSinglePulseStart=npIoSinglePulseStart, npThermoLow=npThermoLow, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayEntry=npRelayEntry, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrap=npRelHumTrap, npCurLoopN=npCurLoopN, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelIn=npIoLevelIn, npThermoTrap=npThermoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmInfo=npGsmInfo, npThermoValue=npThermoValue, npIrStatus=npIrStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npIoTable=npIoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npRelayState=npRelayState, npSmokeMemo=npSmokeMemo, npThermoStatus=npThermoStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLineN=npIoLineN, npRelHumMemo=npRelHumMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npGsmRegistration=npGsmRegistration, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npIoTrapLineN=npIoTrapLineN, npIrCtrl=npIrCtrl, npThermoHigh=npThermoHigh, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataN=npRelHumTrapDataN, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npThermo=npThermo, npCurLoop=npCurLoop, npIoTrap=npIoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmoke=npSmoke, npReboot=npReboot, npRelHumTable=npRelHumTable)
