...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:06:05 2022
...
TimeTicks, Unsigned32, IpAddress, Integer32, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ObjectIdentity, enterprises, Gauge32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTable=npSmokeTable, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopV=npCurLoopV, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopN=npCurLoopN, npThermoTrapValue=npThermoTrapValue, npIo=npIo, npGsmRegistration=npGsmRegistration, npSmoke=npSmoke, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npRelayMemo=npRelayMemo, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMode=npRelayMode, npIrStatus=npIrStatus, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapLow=npThermoTrapLow, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrap=npThermoTrap, npRelayState=npRelayState, npThermoValue=npThermoValue, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelayTable=npRelayTable, npGsm=npGsm, npCurLoopTrapV=npCurLoopTrapV, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumEntry=npRelHumEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTraps=npThermoTraps, npThermoValuePrecise=npThermoValuePrecise, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npSmokeTraps=npSmokeTraps, npThermoMemo=npThermoMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npForcedReboot=npForcedReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrap=npSmokeTrap, npTrapInfo=npTrapInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmInfo=npGsmInfo, npRelHumValue=npRelHumValue, npRelHumTempStatus=npRelHumTempStatus, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npIr=npIr, npThermoLow=npThermoLow, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoSensorN=npThermoSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoHigh=npThermoHigh, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npGsmStrength=npGsmStrength, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrap=npRelHumTrap, npResetStack=npResetStack, npRelHumStatus=npRelHumStatus, npGsmFailed=npGsmFailed, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npCurLoopTraps=npCurLoopTraps, npCurLoopTable=npCurLoopTable, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrReset=npIrReset, npReboot=npReboot, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPower=npCurLoopTrapPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI)
