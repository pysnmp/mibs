...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:12:41 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Gauge32, ObjectIdentity, Unsigned32, Bits, MibIdentifier, enterprises, Counter64, Integer32, NotificationType, IpAddress, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "enterprises", "Counter64", "Integer32", "NotificationType", "IpAddress", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeSensorN=npSmokeSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTraps=npCurLoopTraps, npIoLineN=npIoLineN, npIrStatus=npIrStatus, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npGsmInfo=npGsmInfo, npIoEntry=npIoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapValue=npThermoTrapValue, npTrapEmailTo=npTrapEmailTo, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npIoTraps=npIoTraps, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npCurLoop=npCurLoop, npSoftReboot=npSoftReboot, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMemo=npRelayMemo, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapR=npCurLoopTrapR, npIoTrapMemo=npIoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npRelayStartReset=npRelayStartReset, npThermoStatus=npThermoStatus, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npIoTable=npIoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIo=npIo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelay=npRelay, npIoTrap=npIoTrap, npThermo=npThermo, npThermoMemo=npThermoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoLow=npThermoLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npResetStack=npResetStack, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTable=npRelHumTable, npCurLoopR=npCurLoopR, npThermoValuePrecise=npThermoValuePrecise, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTable=npSmokeTable, npRelayN=npRelayN, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValue=npThermoValue, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npRelHumTempValue=npRelHumTempValue, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopEntry=npCurLoopEntry, npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, lightcom=lightcom, npThermoTrapPrefix=npThermoTrapPrefix, npRelayTable=npRelayTable, npSmoke=npSmoke, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTable=npCurLoopTable, npGsm=npGsm, npRelayMode=npRelayMode, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopPower=npCurLoopPower, npIrCtrl=npIrCtrl, npSmokeTrapMemo=npSmokeTrapMemo, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npThermoTable=npThermoTable)
