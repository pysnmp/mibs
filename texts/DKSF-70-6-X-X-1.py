...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:47:08 2022
...
ModuleIdentity, Counter32, iso, Counter64, NotificationType, Unsigned32, IpAddress, Bits, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "iso", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "Bits", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npGsmTraps=npGsmTraps, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoLineN=npIoLineN, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npThermoLow=npThermoLow, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npRelayStartReset=npRelayStartReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelIn=npIoLevelIn, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTable=npRelHumTable, npIo=npIo, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npRelHumEntry=npRelHumEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempStatus=npRelHumTempStatus, npIoEntry=npIoEntry, npIoLevelOut=npIoLevelOut, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTable=npThermoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumMemo=npRelHumMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npSmokeReset=npSmokeReset, npGsmInfo=npGsmInfo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npTrapEmailTo=npTrapEmailTo, npResetStack=npResetStack, npRelayMode=npRelayMode, npRelayTable=npRelayTable, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npReboot=npReboot, npIoTraps=npIoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, lightcom=lightcom, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npIrStatus=npIrStatus, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npThermo=npThermo, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapValue=npThermoTrapValue, npIoTrapPrefix=npIoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npRelHumValue=npRelHumValue, npCurLoopPower=npCurLoopPower, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopR=npCurLoopR, npCurLoopTable=npCurLoopTable)
