...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:59:33 2022
...
Bits, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Gauge32, MibIdentifier, Integer32, Counter64, ObjectIdentity, TimeTicks, Counter32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTemp=npRelHumTrapTemp, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSoftReboot=npSoftReboot, npRelHumTempStatus=npRelHumTempStatus, npIoTraps=npIoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoSensorN=npThermoSensorN, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopStatus=npCurLoopStatus, npSmokeTrap=npSmokeTrap, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npThermoTrapStatus=npThermoTrapStatus, npRelHumStatus=npRelHumStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npSmokeEntry=npSmokeEntry, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoMemo=npThermoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopI=npCurLoopI, npRelay=npRelay, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npThermoStatus=npThermoStatus, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npIrStatus=npIrStatus, npSmoke=npSmoke, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapMemo=npThermoTrapMemo, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrap=npIoTrap, npSmokeTraps=npSmokeTraps, npRelHumTrapFail=npRelHumTrapFail, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npIoEntry=npIoEntry, npThermoTrapValue=npThermoTrapValue, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npRelayTable=npRelayTable, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmStrength=npGsmStrength, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapPrefix=npIoTrapPrefix, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmRegistration=npGsmRegistration, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoop=npCurLoop, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTable=npCurLoopTable, npRelHumTrapDataValue=npRelHumTrapDataValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npThermoTrapLow=npThermoTrapLow, npRelHumN=npRelHumN, npSmokeTable=npSmokeTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopN=npCurLoopN, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe)
