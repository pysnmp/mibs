...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:32:48 2022
...
IpAddress, TimeTicks, MibIdentifier, Counter32, ModuleIdentity, Gauge32, iso, Bits, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "MibIdentifier", "Counter32", "ModuleIdentity", "Gauge32", "iso", "Bits", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrCtrl=npIrCtrl, npGsmTrap=npGsmTrap, npRelayMode=npRelayMode, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npIoLineN=npIoLineN, npRelHumTempStatus=npRelHumTempStatus, npRelHumValue=npRelHumValue, npIrStatus=npIrStatus, npIr=npIr, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoHigh=npThermoHigh, npThermoMemo=npThermoMemo, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npRelayN=npRelayN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npRelHumMemo=npRelHumMemo, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npThermoValue=npThermoValue, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, npForcedReboot=npForcedReboot, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npRelayMemo=npRelayMemo, npRelay=npRelay, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npCurLoopTable=npCurLoopTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npGsm=npGsm, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeMemo=npSmokeMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, lightcom=lightcom, npSmokeTrapStatus=npSmokeTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npCurLoopR=npCurLoopR, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npIrPlayCmd=npIrPlayCmd, npIrReset=npIrReset, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npResetStack=npResetStack, npSmokePower=npSmokePower, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npRelHumN=npRelHumN, npThermoTrapHigh=npThermoTrapHigh, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN)
