...
# Produced by pysmi-1.1.8 at Mon Jan 17 17:59:02 2022
...
iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, enterprises, Counter64, TimeTicks, NotificationType, IpAddress, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "enterprises", "Counter64", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npForcedReboot=npForcedReboot, npSmoke=npSmoke, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npThermoTrap=npThermoTrap, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumN=npRelHumN, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayN=npRelayN, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npResetStack=npResetStack, npSmokeMemo=npSmokeMemo, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTraps=npCurLoopTraps, npGsmTraps=npGsmTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumMemo=npRelHumMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npSmokeEntry=npSmokeEntry, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npThermoHigh=npThermoHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumStatus=npRelHumStatus, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValue=npThermoValue, npRelHumTrapFail=npRelHumTrapFail, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapValue=npThermoTrapValue, npRelHumTrapSafe=npRelHumTrapSafe, npSmokePower=npSmokePower, npCurLoopV=npCurLoopV, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, npThermo=npThermo, npRelayMode=npRelayMode, npRelayTable=npRelayTable, npCurLoopI=npCurLoopI, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npSmokeReset=npSmokeReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npReboot=npReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapInfo=npTrapInfo, npGsmFailed=npGsmFailed, npIrStatus=npIrStatus)
