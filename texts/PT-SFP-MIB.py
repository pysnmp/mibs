...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, PortInterfaceTC=PortInterfaceTC, brNominal=brNominal, installedSFP=installedSFP, connectorType=connectorType, length50m10m=length50m10m, vendorName=vendorName, temperature=temperature, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, lengthCopper1m=lengthCopper1m, rxPower=rxPower, vendorPn=vendorPn, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, installState=installState, ptSFPFullCompliance=ptSFPFullCompliance, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, vendorSn=vendorSn, ptSFPGroups=ptSFPGroups, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, levelRx=levelRx, vendorOui=vendorOui, ConnectorTypeTC=ConnectorTypeTC, WaveLengthTC=WaveLengthTC, length9m1km=length9m1km, vcc=vcc, biasCurrent=biasCurrent, length62m10m=length62m10m)
