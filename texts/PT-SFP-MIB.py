...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPTable=ptSFPTable, ptSFPGroups=ptSFPGroups, ptSFP=ptSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m1km=length9m1km, connectorType=connectorType, vcc=vcc, lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, length9m100m=length9m100m, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, vendorSn=vendorSn, installState=installState, WaveLengthTC=WaveLengthTC, length62m10m=length62m10m, ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, biasCurrent=biasCurrent, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, temperature=temperature, ptSFPEntry=ptSFPEntry, vendorName=vendorName, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, vendorRev=vendorRev, InstallStateTC=InstallStateTC, length50m10m=length50m10m, vendorPn=vendorPn, levelRx=levelRx, saleableEntityCode=saleableEntityCode, brNominal=brNominal, PortInterfaceTC=PortInterfaceTC, vendorOui=vendorOui)
