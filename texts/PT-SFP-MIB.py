...
mibBuilder.exportSymbols("PT-SFP-MIB", installedSFP=installedSFP, ptSFPTable=ptSFPTable, ptSFPEntry=ptSFPEntry, temperature=temperature, ptSFPCompliances=ptSFPCompliances, levelRx=levelRx, InstallStateTC=InstallStateTC, brNominal=brNominal, length50m10m=length50m10m, ptSFP=ptSFP, vcc=vcc, connectorType=connectorType, length9m100m=length9m100m, saleableEntityCode=saleableEntityCode, ptSFPCompleteGroup=ptSFPCompleteGroup, PortInterfaceTC=PortInterfaceTC, lengthCopper1m=lengthCopper1m, txPower=txPower, biasCurrent=biasCurrent, WaveLengthTC=WaveLengthTC, ptSFPGroups=ptSFPGroups, installState=installState, PYSNMP_MODULE_ID=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, installedWavelength=installedWavelength, vendorSn=vendorSn, vendorPn=vendorPn, length9m1km=length9m1km, ConnectorTypeTC=ConnectorTypeTC, rxPower=rxPower, length62m10m=length62m10m, ptSFPConformance=ptSFPConformance, vendorOui=vendorOui, vendorRev=vendorRev, vendorName=vendorName)
