...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, ptSFPCompliances=ptSFPCompliances, WaveLengthTC=WaveLengthTC, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, biasCurrent=biasCurrent, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, vendorName=vendorName, length62m10m=length62m10m, PYSNMP_MODULE_ID=ptSFP, rxPower=rxPower, ptSFPTable=ptSFPTable, saleableEntityCode=saleableEntityCode, vendorRev=vendorRev, vendorSn=vendorSn, length9m100m=length9m100m, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups, length9m1km=length9m1km, ptSFP=ptSFP, levelRx=levelRx, vendorPn=vendorPn, installedWavelength=installedWavelength, vcc=vcc, ptSFPEntry=ptSFPEntry, PortInterfaceTC=PortInterfaceTC, temperature=temperature, InstallStateTC=InstallStateTC, brNominal=brNominal, txPower=txPower, length50m10m=length50m10m, ConnectorTypeTC=ConnectorTypeTC, installState=installState, lengthCopper1m=lengthCopper1m)
