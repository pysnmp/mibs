...
mibBuilder.exportSymbols("PT-SFP-MIB", PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, txPower=txPower, ptSFP=ptSFP, ptSFPCompliances=ptSFPCompliances, biasCurrent=biasCurrent, InstallStateTC=InstallStateTC, ptSFPEntry=ptSFPEntry, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, length9m100m=length9m100m, connectorType=connectorType, installState=installState, ptSFPCompleteGroup=ptSFPCompleteGroup, brNominal=brNominal, length50m10m=length50m10m, temperature=temperature, installedWavelength=installedWavelength, WaveLengthTC=WaveLengthTC, installedSFP=installedSFP, levelRx=levelRx, rxPower=rxPower, vendorOui=vendorOui, length9m1km=length9m1km, vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, ConnectorTypeTC=ConnectorTypeTC, ptSFPFullCompliance=ptSFPFullCompliance, vcc=vcc, saleableEntityCode=saleableEntityCode, length62m10m=length62m10m, vendorName=vendorName, vendorSn=vendorSn)
