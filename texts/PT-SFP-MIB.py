...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m1km=length9m1km, biasCurrent=biasCurrent, levelRx=levelRx, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, brNominal=brNominal, installedSFP=installedSFP, ptSFPConformance=ptSFPConformance, vendorName=vendorName, rxPower=rxPower, vendorPn=vendorPn, PYSNMP_MODULE_ID=ptSFP, ptSFPGroups=ptSFPGroups, WaveLengthTC=WaveLengthTC, PortInterfaceTC=PortInterfaceTC, vcc=vcc, InstallStateTC=InstallStateTC, temperature=temperature, ptSFPEntry=ptSFPEntry, length62m10m=length62m10m, ptSFP=ptSFP, vendorRev=vendorRev, vendorOui=vendorOui, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompleteGroup=ptSFPCompleteGroup, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, length50m10m=length50m10m, vendorSn=vendorSn, installState=installState, connectorType=connectorType, txPower=txPower, lengthCopper1m=lengthCopper1m)
