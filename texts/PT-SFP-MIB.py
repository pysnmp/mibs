...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPGroups=ptSFPGroups, installedWavelength=installedWavelength, length50m10m=length50m10m, length9m1km=length9m1km, vendorName=vendorName, vendorPn=vendorPn, PYSNMP_MODULE_ID=ptSFP, connectorType=connectorType, length62m10m=length62m10m, ptSFPTable=ptSFPTable, InstallStateTC=InstallStateTC, temperature=temperature, lengthCopper1m=lengthCopper1m, ptSFP=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, brNominal=brNominal, PortInterfaceTC=PortInterfaceTC, rxPower=rxPower, biasCurrent=biasCurrent, levelRx=levelRx, WaveLengthTC=WaveLengthTC, ptSFPConformance=ptSFPConformance, ConnectorTypeTC=ConnectorTypeTC, installState=installState, vendorOui=vendorOui, ptSFPCompliances=ptSFPCompliances, length9m100m=length9m100m, ptSFPEntry=ptSFPEntry, txPower=txPower, vendorRev=vendorRev, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn, installedSFP=installedSFP, saleableEntityCode=saleableEntityCode, vcc=vcc)
