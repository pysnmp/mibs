...
mibBuilder.exportSymbols("PT-SFP-MIB", brNominal=brNominal, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, rxPower=rxPower, WaveLengthTC=WaveLengthTC, PortInterfaceTC=PortInterfaceTC, saleableEntityCode=saleableEntityCode, ptSFPFullCompliance=ptSFPFullCompliance, vendorRev=vendorRev, temperature=temperature, ConnectorTypeTC=ConnectorTypeTC, vendorPn=vendorPn, ptSFP=ptSFP, InstallStateTC=InstallStateTC, biasCurrent=biasCurrent, installedSFP=installedSFP, levelRx=levelRx, length62m10m=length62m10m, ptSFPConformance=ptSFPConformance, length9m100m=length9m100m, vendorName=vendorName, vendorSn=vendorSn, connectorType=connectorType, installState=installState, length9m1km=length9m1km, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups, vcc=vcc, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable)
