...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorOui=vendorOui, ptSFPEntry=ptSFPEntry, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, installedWavelength=installedWavelength, levelRx=levelRx, vcc=vcc, vendorPn=vendorPn, ptSFPTable=ptSFPTable, vendorSn=vendorSn, ptSFPCompliances=ptSFPCompliances, length50m10m=length50m10m, ptSFPConformance=ptSFPConformance, InstallStateTC=InstallStateTC, biasCurrent=biasCurrent, PYSNMP_MODULE_ID=ptSFP, ptSFP=ptSFP, temperature=temperature, WaveLengthTC=WaveLengthTC, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, vendorName=vendorName, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, installedSFP=installedSFP, ptSFPGroups=ptSFPGroups, rxPower=rxPower, lengthCopper1m=lengthCopper1m, connectorType=connectorType, saleableEntityCode=saleableEntityCode, length9m100m=length9m100m, length62m10m=length62m10m, length9m1km=length9m1km)
