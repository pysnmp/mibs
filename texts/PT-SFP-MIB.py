...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompleteGroup=ptSFPCompleteGroup, saleableEntityCode=saleableEntityCode, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, ptSFPEntry=ptSFPEntry, brNominal=brNominal, ptSFPConformance=ptSFPConformance, length9m100m=length9m100m, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, ptSFPGroups=ptSFPGroups, vendorName=vendorName, installState=installState, length50m10m=length50m10m, PortInterfaceTC=PortInterfaceTC, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, ptSFPFullCompliance=ptSFPFullCompliance, WaveLengthTC=WaveLengthTC, InstallStateTC=InstallStateTC, ptSFPTable=ptSFPTable, temperature=temperature, vcc=vcc, biasCurrent=biasCurrent, vendorRev=vendorRev, vendorSn=vendorSn, installedWavelength=installedWavelength, installedSFP=installedSFP, ptSFP=ptSFP, connectorType=connectorType, levelRx=levelRx, rxPower=rxPower, vendorPn=vendorPn, vendorOui=vendorOui, length9m1km=length9m1km)
