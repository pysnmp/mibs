...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, levelRx=levelRx, rxPower=rxPower, WaveLengthTC=WaveLengthTC, vendorSn=vendorSn, InstallStateTC=InstallStateTC, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, ptSFPConformance=ptSFPConformance, vendorOui=vendorOui, installState=installState, PortInterfaceTC=PortInterfaceTC, ptSFPTable=ptSFPTable, vendorPn=vendorPn, temperature=temperature, vendorName=vendorName, connectorType=connectorType, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, installedSFP=installedSFP, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, txPower=txPower, length9m1km=length9m1km, ptSFPCompliances=ptSFPCompliances, ptSFP=ptSFP, brNominal=brNominal, length9m100m=length9m100m, length62m10m=length62m10m)
