...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorSn=vendorSn, length50m10m=length50m10m, temperature=temperature, ptSFPGroups=ptSFPGroups, vcc=vcc, ptSFP=ptSFP, vendorName=vendorName, PortInterfaceTC=PortInterfaceTC, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m, length9m100m=length9m100m, InstallStateTC=InstallStateTC, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, biasCurrent=biasCurrent, ptSFPEntry=ptSFPEntry, saleableEntityCode=saleableEntityCode, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPConformance=ptSFPConformance, connectorType=connectorType, txPower=txPower, ptSFPCompliances=ptSFPCompliances, installedWavelength=installedWavelength, levelRx=levelRx, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, installState=installState, brNominal=brNominal, ptSFPTable=ptSFPTable, vendorPn=vendorPn, length9m1km=length9m1km)
