...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m1km=length9m1km, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, installState=installState, lengthCopper1m=lengthCopper1m, ptSFPCompliances=ptSFPCompliances, PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, connectorType=connectorType, ptSFPCompleteGroup=ptSFPCompleteGroup, txPower=txPower, vendorName=vendorName, WaveLengthTC=WaveLengthTC, biasCurrent=biasCurrent, length50m10m=length50m10m, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPTable=ptSFPTable, rxPower=rxPower, ptSFPConformance=ptSFPConformance, vendorPn=vendorPn, levelRx=levelRx, installedSFP=installedSFP, temperature=temperature, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, length62m10m=length62m10m, saleableEntityCode=saleableEntityCode, ptSFPEntry=ptSFPEntry, ptSFPGroups=ptSFPGroups, InstallStateTC=InstallStateTC, brNominal=brNominal, ptSFP=ptSFP, vcc=vcc, vendorSn=vendorSn, vendorOui=vendorOui)
