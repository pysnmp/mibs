...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorRev=vendorRev, temperature=temperature, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, ptSFPEntry=ptSFPEntry, length9m1km=length9m1km, rxPower=rxPower, biasCurrent=biasCurrent, ptSFPConformance=ptSFPConformance, vendorOui=vendorOui, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, vendorPn=vendorPn, PYSNMP_MODULE_ID=ptSFP, length62m10m=length62m10m, saleableEntityCode=saleableEntityCode, vendorSn=vendorSn, lengthCopper1m=lengthCopper1m, brNominal=brNominal, ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC, ptSFPTable=ptSFPTable, levelRx=levelRx, length9m100m=length9m100m, ptSFP=ptSFP, vendorName=vendorName, vcc=vcc, installState=installState, installedWavelength=installedWavelength, WaveLengthTC=WaveLengthTC, connectorType=connectorType, PortInterfaceTC=PortInterfaceTC, txPower=txPower, ptSFPGroups=ptSFPGroups, InstallStateTC=InstallStateTC)
