...
mibBuilder.exportSymbols("PT-SFP-MIB", installedSFP=installedSFP, ptSFPConformance=ptSFPConformance, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, installedWavelength=installedWavelength, brNominal=brNominal, length9m1km=length9m1km, ptSFPCompliances=ptSFPCompliances, temperature=temperature, ptSFP=ptSFP, InstallStateTC=InstallStateTC, WaveLengthTC=WaveLengthTC, txPower=txPower, lengthCopper1m=lengthCopper1m, vendorPn=vendorPn, installState=installState, length62m10m=length62m10m, vcc=vcc, vendorSn=vendorSn, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, PortInterfaceTC=PortInterfaceTC, ptSFPTable=ptSFPTable, ptSFPGroups=ptSFPGroups, vendorName=vendorName, vendorOui=vendorOui, levelRx=levelRx, ConnectorTypeTC=ConnectorTypeTC, saleableEntityCode=saleableEntityCode, rxPower=rxPower, ptSFPEntry=ptSFPEntry, biasCurrent=biasCurrent, length50m10m=length50m10m, connectorType=connectorType)
