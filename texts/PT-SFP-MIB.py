...
# ASN.1 source PT-SFP-MIB
# Source digest sha256:e083a0acc9813f6156ddf2891a0acab779fce3a137bb8bcfd9047e4f16c034b5
...
if mibBuilder.loadTexts: ptSFP.setLastUpdated('2016-05-22 10:30')
...
ptSFPTable = MibTable((1, 3, 6, 1, 4, 1, 193, 223, 2, 6, 1), ).setMaxAccess("notaccessible")
...
ptSFPEntry = MibTableRow((1, 3, 6, 1, 4, 1, 193, 223, 2, 6, 1, 1), ).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("PT-SFP-MIB", ConnectorTypeTC=ConnectorTypeTC, InstallStateTC=InstallStateTC, PYSNMP_MODULE_ID=ptSFP, PortInterfaceTC=PortInterfaceTC, WaveLengthTC=WaveLengthTC, biasCurrent=biasCurrent, brNominal=brNominal, connectorType=connectorType, installState=installState, installedSFP=installedSFP, installedWavelength=installedWavelength, length50m10m=length50m10m, length62m10m=length62m10m, length9m100m=length9m100m, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, levelRx=levelRx, ptSFP=ptSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPCompliances=ptSFPCompliances, ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, rxPower=rxPower, saleableEntityCode=saleableEntityCode, temperature=temperature, txPower=txPower, vcc=vcc, vendorName=vendorName, vendorOui=vendorOui, vendorPn=vendorPn, vendorRev=vendorRev, vendorSn=vendorSn)
