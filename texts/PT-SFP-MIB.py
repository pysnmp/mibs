...
mibBuilder.exportSymbols("PT-SFP-MIB", lengthCopper1m=lengthCopper1m, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, brNominal=brNominal, length9m1km=length9m1km, ptSFP=ptSFP, length62m10m=length62m10m, vendorName=vendorName, vcc=vcc, vendorOui=vendorOui, installState=installState, ptSFPCompleteGroup=ptSFPCompleteGroup, biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, ptSFPConformance=ptSFPConformance, installedSFP=installedSFP, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, InstallStateTC=InstallStateTC, PYSNMP_MODULE_ID=ptSFP, connectorType=connectorType, temperature=temperature, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, vendorPn=vendorPn, length50m10m=length50m10m, levelRx=levelRx, txPower=txPower, WaveLengthTC=WaveLengthTC, saleableEntityCode=saleableEntityCode, vendorSn=vendorSn, vendorRev=vendorRev)
