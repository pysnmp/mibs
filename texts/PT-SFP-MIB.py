...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m100m=length9m100m, WaveLengthTC=WaveLengthTC, saleableEntityCode=saleableEntityCode, txPower=txPower, PortInterfaceTC=PortInterfaceTC, ptSFPFullCompliance=ptSFPFullCompliance, length9m1km=length9m1km, temperature=temperature, length50m10m=length50m10m, ptSFPEntry=ptSFPEntry, length62m10m=length62m10m, brNominal=brNominal, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, biasCurrent=biasCurrent, vendorOui=vendorOui, rxPower=rxPower, vendorRev=vendorRev, installedSFP=installedSFP, vendorName=vendorName, ptSFPCompleteGroup=ptSFPCompleteGroup, lengthCopper1m=lengthCopper1m, connectorType=connectorType, InstallStateTC=InstallStateTC, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, ptSFPCompliances=ptSFPCompliances, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, ptSFP=ptSFP, ptSFPGroups=ptSFPGroups, vendorPn=vendorPn, installState=installState, vendorSn=vendorSn, vcc=vcc)
