...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, vendorSn=vendorSn, ConnectorTypeTC=ConnectorTypeTC, ptSFPFullCompliance=ptSFPFullCompliance, vendorRev=vendorRev, WaveLengthTC=WaveLengthTC, biasCurrent=biasCurrent, vendorName=vendorName, txPower=txPower, ptSFPTable=ptSFPTable, length62m10m=length62m10m, length9m1km=length9m1km, ptSFP=ptSFP, ptSFPEntry=ptSFPEntry, vcc=vcc, lengthCopper1m=lengthCopper1m, levelRx=levelRx, temperature=temperature, ptSFPCompliances=ptSFPCompliances, length9m100m=length9m100m, installedWavelength=installedWavelength, brNominal=brNominal, ptSFPGroups=ptSFPGroups, rxPower=rxPower, length50m10m=length50m10m, installState=installState, ptSFPConformance=ptSFPConformance, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, PYSNMP_MODULE_ID=ptSFP, vendorOui=vendorOui, connectorType=connectorType, saleableEntityCode=saleableEntityCode, installedSFP=installedSFP)
