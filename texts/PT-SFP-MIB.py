...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m100m=length9m100m, temperature=temperature, connectorType=connectorType, lengthCopper1m=lengthCopper1m, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn, length50m10m=length50m10m, rxPower=rxPower, ptSFP=ptSFP, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, txPower=txPower, PYSNMP_MODULE_ID=ptSFP, length9m1km=length9m1km, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, vendorName=vendorName, levelRx=levelRx, installState=installState, ptSFPFullCompliance=ptSFPFullCompliance, installedSFP=installedSFP, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable, vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, vendorRev=vendorRev, ConnectorTypeTC=ConnectorTypeTC, vcc=vcc, brNominal=brNominal, WaveLengthTC=WaveLengthTC)
