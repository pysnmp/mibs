...
mibBuilder.exportSymbols("PT-SFP-MIB", vcc=vcc, length9m1km=length9m1km, installedWavelength=installedWavelength, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, txPower=txPower, biasCurrent=biasCurrent, lengthCopper1m=lengthCopper1m, vendorName=vendorName, ptSFPConformance=ptSFPConformance, length50m10m=length50m10m, ptSFP=ptSFP, saleableEntityCode=saleableEntityCode, PYSNMP_MODULE_ID=ptSFP, InstallStateTC=InstallStateTC, vendorPn=vendorPn, levelRx=levelRx, length9m100m=length9m100m, installedSFP=installedSFP, ptSFPGroups=ptSFPGroups, rxPower=rxPower, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, vendorRev=vendorRev, temperature=temperature, ptSFPEntry=ptSFPEntry, vendorSn=vendorSn, brNominal=brNominal, length62m10m=length62m10m)
