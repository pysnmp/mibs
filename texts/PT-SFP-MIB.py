...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorRev=vendorRev, ptSFPCompliances=ptSFPCompliances, length9m1km=length9m1km, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, ptSFPGroups=ptSFPGroups, ptSFP=ptSFP, ptSFPEntry=ptSFPEntry, InstallStateTC=InstallStateTC, connectorType=connectorType, PYSNMP_MODULE_ID=ptSFP, ptSFPConformance=ptSFPConformance, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m100m=length9m100m, PortInterfaceTC=PortInterfaceTC, biasCurrent=biasCurrent, installedWavelength=installedWavelength, vendorSn=vendorSn, vendorName=vendorName, ptSFPTable=ptSFPTable, vcc=vcc, levelRx=levelRx, rxPower=rxPower, length62m10m=length62m10m, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, installState=installState, length50m10m=length50m10m, vendorOui=vendorOui, txPower=txPower, saleableEntityCode=saleableEntityCode, vendorPn=vendorPn)
