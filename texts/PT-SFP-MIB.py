...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m1km=length9m1km, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, installState=installState, biasCurrent=biasCurrent, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, lengthCopper1m=lengthCopper1m, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, txPower=txPower, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, rxPower=rxPower, InstallStateTC=InstallStateTC, saleableEntityCode=saleableEntityCode, vendorOui=vendorOui, ptSFPTable=ptSFPTable, installedSFP=installedSFP, installedWavelength=installedWavelength, length9m100m=length9m100m, vendorPn=vendorPn, ptSFPCompliances=ptSFPCompliances, temperature=temperature, connectorType=connectorType, vcc=vcc, length62m10m=length62m10m, length50m10m=length50m10m, vendorName=vendorName, brNominal=brNominal, WaveLengthTC=WaveLengthTC, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn)
