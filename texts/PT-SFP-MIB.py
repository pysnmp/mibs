...
mibBuilder.exportSymbols("PT-SFP-MIB", PortInterfaceTC=PortInterfaceTC, vendorOui=vendorOui, WaveLengthTC=WaveLengthTC, length50m10m=length50m10m, vendorSn=vendorSn, txPower=txPower, ptSFP=ptSFP, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, PYSNMP_MODULE_ID=ptSFP, levelRx=levelRx, length62m10m=length62m10m, temperature=temperature, vendorRev=vendorRev, length9m100m=length9m100m, ptSFPFullCompliance=ptSFPFullCompliance, brNominal=brNominal, vendorName=vendorName, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, vendorPn=vendorPn, saleableEntityCode=saleableEntityCode, lengthCopper1m=lengthCopper1m, installState=installState, ptSFPTable=ptSFPTable, vcc=vcc, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, connectorType=connectorType, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, biasCurrent=biasCurrent, rxPower=rxPower)
