...
mibBuilder.exportSymbols("PT-SFP-MIB", biasCurrent=biasCurrent, PortInterfaceTC=PortInterfaceTC, installState=installState, vendorPn=vendorPn, installedWavelength=installedWavelength, temperature=temperature, length50m10m=length50m10m, vcc=vcc, ptSFPGroups=ptSFPGroups, ptSFPCompliances=ptSFPCompliances, saleableEntityCode=saleableEntityCode, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorRev=vendorRev, vendorSn=vendorSn, vendorOui=vendorOui, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, vendorName=vendorName, ptSFPConformance=ptSFPConformance, length9m100m=length9m100m, connectorType=connectorType, WaveLengthTC=WaveLengthTC, levelRx=levelRx, ptSFPTable=ptSFPTable, brNominal=brNominal, ptSFPFullCompliance=ptSFPFullCompliance, InstallStateTC=InstallStateTC, txPower=txPower, length9m1km=length9m1km, ptSFPEntry=ptSFPEntry, rxPower=rxPower, lengthCopper1m=lengthCopper1m, ptSFP=ptSFP, installedSFP=installedSFP, PYSNMP_MODULE_ID=ptSFP)
