...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, vcc=vcc, ptSFP=ptSFP, connectorType=connectorType, ptSFPGroups=ptSFPGroups, txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPFullCompliance=ptSFPFullCompliance, installedWavelength=installedWavelength, length62m10m=length62m10m, biasCurrent=biasCurrent, InstallStateTC=InstallStateTC, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, brNominal=brNominal, vendorOui=vendorOui, vendorRev=vendorRev, vendorPn=vendorPn, ptSFPCompliances=ptSFPCompliances, rxPower=rxPower, vendorName=vendorName, PYSNMP_MODULE_ID=ptSFP, vendorSn=vendorSn, length9m100m=length9m100m, installedSFP=installedSFP, ConnectorTypeTC=ConnectorTypeTC, ptSFPConformance=ptSFPConformance, installState=installState, levelRx=levelRx, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, temperature=temperature, length9m1km=length9m1km, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC)
