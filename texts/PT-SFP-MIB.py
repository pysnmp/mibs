...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, ptSFPCompleteGroup=ptSFPCompleteGroup, length50m10m=length50m10m, rxPower=rxPower, temperature=temperature, vcc=vcc, ptSFPEntry=ptSFPEntry, vendorPn=vendorPn, ptSFPFullCompliance=ptSFPFullCompliance, WaveLengthTC=WaveLengthTC, vendorRev=vendorRev, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, ConnectorTypeTC=ConnectorTypeTC, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, ptSFPCompliances=ptSFPCompliances, txPower=txPower, brNominal=brNominal, length9m100m=length9m100m, length62m10m=length62m10m, installState=installState, installedSFP=installedSFP, vendorName=vendorName, installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, vendorOui=vendorOui, length9m1km=length9m1km, connectorType=connectorType, levelRx=levelRx, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, PYSNMP_MODULE_ID=ptSFP, ptSFP=ptSFP, vendorSn=vendorSn)
