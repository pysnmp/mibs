...
mibBuilder.exportSymbols("PT-SFP-MIB", length62m10m=length62m10m, length9m100m=length9m100m, InstallStateTC=InstallStateTC, vendorSn=vendorSn, installedWavelength=installedWavelength, vendorPn=vendorPn, ptSFPCompliances=ptSFPCompliances, installState=installState, vendorOui=vendorOui, ptSFP=ptSFP, ptSFPTable=ptSFPTable, saleableEntityCode=saleableEntityCode, PYSNMP_MODULE_ID=ptSFP, levelRx=levelRx, PortInterfaceTC=PortInterfaceTC, vcc=vcc, ptSFPEntry=ptSFPEntry, biasCurrent=biasCurrent, installedSFP=installedSFP, vendorRev=vendorRev, temperature=temperature, length9m1km=length9m1km, brNominal=brNominal, rxPower=rxPower, WaveLengthTC=WaveLengthTC, vendorName=vendorName, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC, ptSFPConformance=ptSFPConformance, lengthCopper1m=lengthCopper1m, connectorType=connectorType, txPower=txPower, ptSFPGroups=ptSFPGroups, length50m10m=length50m10m)
