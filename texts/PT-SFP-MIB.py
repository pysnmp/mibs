...
mibBuilder.exportSymbols("PT-SFP-MIB", installedWavelength=installedWavelength, ConnectorTypeTC=ConnectorTypeTC, ptSFPEntry=ptSFPEntry, vendorName=vendorName, WaveLengthTC=WaveLengthTC, ptSFPGroups=ptSFPGroups, levelRx=levelRx, vendorPn=vendorPn, connectorType=connectorType, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorOui=vendorOui, saleableEntityCode=saleableEntityCode, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, installState=installState, installedSFP=installedSFP, length9m1km=length9m1km, temperature=temperature, brNominal=brNominal, ptSFP=ptSFP, length9m100m=length9m100m, PortInterfaceTC=PortInterfaceTC, vendorSn=vendorSn, length62m10m=length62m10m, length50m10m=length50m10m, txPower=txPower, ptSFPTable=ptSFPTable, lengthCopper1m=lengthCopper1m, vendorRev=vendorRev, rxPower=rxPower, biasCurrent=biasCurrent, ptSFPConformance=ptSFPConformance, ptSFPCompliances=ptSFPCompliances, InstallStateTC=InstallStateTC)
