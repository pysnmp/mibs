...
mibBuilder.exportSymbols("PT-SFP-MIB", ConnectorTypeTC=ConnectorTypeTC, vendorPn=vendorPn, length9m1km=length9m1km, installState=installState, vendorRev=vendorRev, saleableEntityCode=saleableEntityCode, installedWavelength=installedWavelength, length9m100m=length9m100m, PYSNMP_MODULE_ID=ptSFP, brNominal=brNominal, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFP=ptSFP, rxPower=rxPower, vendorOui=vendorOui, vendorName=vendorName, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, txPower=txPower, vendorSn=vendorSn, ptSFPFullCompliance=ptSFPFullCompliance, vcc=vcc, PortInterfaceTC=PortInterfaceTC, biasCurrent=biasCurrent, temperature=temperature, ptSFPConformance=ptSFPConformance, levelRx=levelRx, InstallStateTC=InstallStateTC, WaveLengthTC=WaveLengthTC, connectorType=connectorType, length62m10m=length62m10m, ptSFPGroups=ptSFPGroups, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, ptSFPTable=ptSFPTable)
