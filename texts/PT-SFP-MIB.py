...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, rxPower=rxPower, vendorRev=vendorRev, ptSFPEntry=ptSFPEntry, length50m10m=length50m10m, vendorPn=vendorPn, vendorName=vendorName, length9m1km=length9m1km, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, PortInterfaceTC=PortInterfaceTC, ptSFPConformance=ptSFPConformance, saleableEntityCode=saleableEntityCode, ptSFP=ptSFP, length9m100m=length9m100m, vcc=vcc, levelRx=levelRx, vendorSn=vendorSn, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, biasCurrent=biasCurrent, installedSFP=installedSFP, temperature=temperature, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, lengthCopper1m=lengthCopper1m, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, connectorType=connectorType, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui)
