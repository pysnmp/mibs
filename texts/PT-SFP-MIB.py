...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, vendorSn=vendorSn, vcc=vcc, length62m10m=length62m10m, vendorName=vendorName, ptSFPConformance=ptSFPConformance, WaveLengthTC=WaveLengthTC, ptSFPCompleteGroup=ptSFPCompleteGroup, levelRx=levelRx, PortInterfaceTC=PortInterfaceTC, txPower=txPower, brNominal=brNominal, installState=installState, ptSFPGroups=ptSFPGroups, rxPower=rxPower, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, installedSFP=installedSFP, installedWavelength=installedWavelength, connectorType=connectorType, vendorRev=vendorRev, length50m10m=length50m10m, ConnectorTypeTC=ConnectorTypeTC, ptSFP=ptSFP, length9m100m=length9m100m, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, PYSNMP_MODULE_ID=ptSFP, vendorOui=vendorOui, temperature=temperature, InstallStateTC=InstallStateTC, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, length9m1km=length9m1km)
