...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPGroups=ptSFPGroups, installedSFP=installedSFP, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, ptSFPTable=ptSFPTable, saleableEntityCode=saleableEntityCode, PortInterfaceTC=PortInterfaceTC, length9m1km=length9m1km, ptSFPConformance=ptSFPConformance, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, ConnectorTypeTC=ConnectorTypeTC, InstallStateTC=InstallStateTC, length62m10m=length62m10m, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, vendorSn=vendorSn, installedWavelength=installedWavelength, connectorType=connectorType, brNominal=brNominal, length9m100m=length9m100m, biasCurrent=biasCurrent, ptSFP=ptSFP, vendorPn=vendorPn, txPower=txPower, levelRx=levelRx, temperature=temperature, vcc=vcc, WaveLengthTC=WaveLengthTC, ptSFPEntry=ptSFPEntry, installState=installState, vendorName=vendorName, rxPower=rxPower, ptSFPCompleteGroup=ptSFPCompleteGroup)
