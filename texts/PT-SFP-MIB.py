...
mibBuilder.exportSymbols("PT-SFP-MIB", connectorType=connectorType, ptSFPTable=ptSFPTable, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, rxPower=rxPower, installedWavelength=installedWavelength, vendorName=vendorName, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, ConnectorTypeTC=ConnectorTypeTC, vendorPn=vendorPn, temperature=temperature, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, installState=installState, vcc=vcc, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, brNominal=brNominal, vendorSn=vendorSn, length9m100m=length9m100m, levelRx=levelRx, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorRev=vendorRev, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, vendorOui=vendorOui, ptSFP=ptSFP, length9m1km=length9m1km)
