...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, brNominal=brNominal, connectorType=connectorType, vendorRev=vendorRev, ptSFPCompliances=ptSFPCompliances, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, ptSFPTable=ptSFPTable, vendorPn=vendorPn, vendorName=vendorName, ptSFPFullCompliance=ptSFPFullCompliance, biasCurrent=biasCurrent, length50m10m=length50m10m, ptSFP=ptSFP, rxPower=rxPower, PYSNMP_MODULE_ID=ptSFP, installedSFP=installedSFP, levelRx=levelRx, length9m1km=length9m1km, length9m100m=length9m100m, ptSFPGroups=ptSFPGroups, vendorSn=vendorSn, saleableEntityCode=saleableEntityCode, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, vcc=vcc, installState=installState, ptSFPCompleteGroup=ptSFPCompleteGroup, temperature=temperature, txPower=txPower, lengthCopper1m=lengthCopper1m, InstallStateTC=InstallStateTC, installedWavelength=installedWavelength)
