...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, vendorRev=vendorRev, connectorType=connectorType, installedWavelength=installedWavelength, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn, levelRx=levelRx, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, installState=installState, biasCurrent=biasCurrent, ConnectorTypeTC=ConnectorTypeTC, ptSFP=ptSFP, installedSFP=installedSFP, brNominal=brNominal, length9m100m=length9m100m, length62m10m=length62m10m, temperature=temperature, ptSFPGroups=ptSFPGroups, InstallStateTC=InstallStateTC, PYSNMP_MODULE_ID=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, txPower=txPower, PortInterfaceTC=PortInterfaceTC, length9m1km=length9m1km, WaveLengthTC=WaveLengthTC, vcc=vcc, vendorOui=vendorOui, vendorName=vendorName, rxPower=rxPower)
