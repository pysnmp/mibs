...
mibBuilder.exportSymbols("PT-SFP-MIB", WaveLengthTC=WaveLengthTC, vcc=vcc, txPower=txPower, temperature=temperature, ptSFPCompleteGroup=ptSFPCompleteGroup, levelRx=levelRx, length62m10m=length62m10m, vendorSn=vendorSn, InstallStateTC=InstallStateTC, installedWavelength=installedWavelength, brNominal=brNominal, length50m10m=length50m10m, PYSNMP_MODULE_ID=ptSFP, ptSFPCompliances=ptSFPCompliances, length9m100m=length9m100m, ptSFP=ptSFP, biasCurrent=biasCurrent, PortInterfaceTC=PortInterfaceTC, ptSFPConformance=ptSFPConformance, connectorType=connectorType, installedSFP=installedSFP, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, vendorOui=vendorOui, vendorName=vendorName, vendorRev=vendorRev, rxPower=rxPower, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, saleableEntityCode=saleableEntityCode, ConnectorTypeTC=ConnectorTypeTC, ptSFPTable=ptSFPTable, vendorPn=vendorPn, installState=installState)
