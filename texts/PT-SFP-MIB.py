...
mibBuilder.exportSymbols("PT-SFP-MIB", PYSNMP_MODULE_ID=ptSFP, length9m100m=length9m100m, installedSFP=installedSFP, installedWavelength=installedWavelength, vendorPn=vendorPn, ptSFPFullCompliance=ptSFPFullCompliance, ptSFP=ptSFP, vendorRev=vendorRev, connectorType=connectorType, vcc=vcc, ptSFPEntry=ptSFPEntry, installState=installState, vendorOui=vendorOui, ptSFPCompliances=ptSFPCompliances, txPower=txPower, levelRx=levelRx, ConnectorTypeTC=ConnectorTypeTC, vendorName=vendorName, length62m10m=length62m10m, biasCurrent=biasCurrent, rxPower=rxPower, saleableEntityCode=saleableEntityCode, ptSFPTable=ptSFPTable, WaveLengthTC=WaveLengthTC, vendorSn=vendorSn, length50m10m=length50m10m, PortInterfaceTC=PortInterfaceTC, lengthCopper1m=lengthCopper1m, temperature=temperature, ptSFPGroups=ptSFPGroups, ptSFPCompleteGroup=ptSFPCompleteGroup, brNominal=brNominal, length9m1km=length9m1km, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance)
