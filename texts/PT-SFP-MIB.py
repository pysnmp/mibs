...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP, connectorType=connectorType, ptSFPTable=ptSFPTable, vendorRev=vendorRev, length9m1km=length9m1km, installedWavelength=installedWavelength, vendorSn=vendorSn, length62m10m=length62m10m, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, lengthCopper1m=lengthCopper1m, length9m100m=length9m100m, biasCurrent=biasCurrent, ptSFPGroups=ptSFPGroups, brNominal=brNominal, InstallStateTC=InstallStateTC, ptSFPCompleteGroup=ptSFPCompleteGroup, installState=installState, ptSFPEntry=ptSFPEntry, PortInterfaceTC=PortInterfaceTC, levelRx=levelRx, vendorOui=vendorOui, vcc=vcc, saleableEntityCode=saleableEntityCode, ptSFPConformance=ptSFPConformance, vendorName=vendorName, txPower=txPower, rxPower=rxPower, ptSFP=ptSFP, installedSFP=installedSFP, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC)
