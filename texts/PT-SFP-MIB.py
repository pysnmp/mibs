...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorSn=vendorSn, biasCurrent=biasCurrent, txPower=txPower, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, PortInterfaceTC=PortInterfaceTC, vendorPn=vendorPn, saleableEntityCode=saleableEntityCode, connectorType=connectorType, InstallStateTC=InstallStateTC, vcc=vcc, rxPower=rxPower, length62m10m=length62m10m, length9m1km=length9m1km, installedSFP=installedSFP, lengthCopper1m=lengthCopper1m, vendorOui=vendorOui, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, ptSFP=ptSFP, levelRx=levelRx, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, temperature=temperature, ptSFPEntry=ptSFPEntry, vendorName=vendorName, WaveLengthTC=WaveLengthTC, installState=installState)
