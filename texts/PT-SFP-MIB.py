...
mibBuilder.exportSymbols("PT-SFP-MIB", temperature=temperature, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, connectorType=connectorType, vcc=vcc, brNominal=brNominal, length50m10m=length50m10m, txPower=txPower, ptSFP=ptSFP, ConnectorTypeTC=ConnectorTypeTC, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, levelRx=levelRx, ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, ptSFPTable=ptSFPTable, lengthCopper1m=lengthCopper1m, length9m100m=length9m100m, installState=installState, vendorName=vendorName, ptSFPCompliances=ptSFPCompliances, biasCurrent=biasCurrent, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorOui=vendorOui, vendorSn=vendorSn, installedWavelength=installedWavelength, installedSFP=installedSFP, rxPower=rxPower, length62m10m=length62m10m, WaveLengthTC=WaveLengthTC, vendorPn=vendorPn, InstallStateTC=InstallStateTC, length9m1km=length9m1km, ptSFPEntry=ptSFPEntry)
