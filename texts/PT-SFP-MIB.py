...
mibBuilder.exportSymbols("PT-SFP-MIB", levelRx=levelRx, length62m10m=length62m10m, vendorRev=vendorRev, lengthCopper1m=lengthCopper1m, ptSFPConformance=ptSFPConformance, installState=installState, length9m1km=length9m1km, ptSFPGroups=ptSFPGroups, vendorName=vendorName, installedSFP=installedSFP, txPower=txPower, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, connectorType=connectorType, biasCurrent=biasCurrent, ptSFPCompliances=ptSFPCompliances, length9m100m=length9m100m, saleableEntityCode=saleableEntityCode, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, PortInterfaceTC=PortInterfaceTC, ptSFPFullCompliance=ptSFPFullCompliance, temperature=temperature, vendorPn=vendorPn, ptSFPEntry=ptSFPEntry, vendorOui=vendorOui, installedWavelength=installedWavelength, InstallStateTC=InstallStateTC, rxPower=rxPower, ptSFP=ptSFP, vendorSn=vendorSn, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, vcc=vcc, ptSFPTable=ptSFPTable)
