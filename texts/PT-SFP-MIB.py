...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m100m=length9m100m, ptSFPConformance=ptSFPConformance, InstallStateTC=InstallStateTC, vendorSn=vendorSn, ptSFPCompliances=ptSFPCompliances, temperature=temperature, vendorPn=vendorPn, ptSFPCompleteGroup=ptSFPCompleteGroup, installState=installState, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, ptSFPTable=ptSFPTable, biasCurrent=biasCurrent, WaveLengthTC=WaveLengthTC, saleableEntityCode=saleableEntityCode, brNominal=brNominal, ptSFPEntry=ptSFPEntry, ptSFPGroups=ptSFPGroups, installedWavelength=installedWavelength, ptSFP=ptSFP, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, rxPower=rxPower, length50m10m=length50m10m, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, vendorName=vendorName, length62m10m=length62m10m, vendorRev=vendorRev, installedSFP=installedSFP, vcc=vcc, vendorOui=vendorOui, ptSFPFullCompliance=ptSFPFullCompliance, length9m1km=length9m1km, levelRx=levelRx)
