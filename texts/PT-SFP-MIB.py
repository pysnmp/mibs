...
mibBuilder.exportSymbols("PT-SFP-MIB", installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, temperature=temperature, vendorName=vendorName, ptSFPCompliances=ptSFPCompliances, vendorSn=vendorSn, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, rxPower=rxPower, lengthCopper1m=lengthCopper1m, installedSFP=installedSFP, ptSFPTable=ptSFPTable, installState=installState, vendorRev=vendorRev, ptSFPFullCompliance=ptSFPFullCompliance, levelRx=levelRx, ptSFPCompleteGroup=ptSFPCompleteGroup, biasCurrent=biasCurrent, InstallStateTC=InstallStateTC, length62m10m=length62m10m, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, ptSFPEntry=ptSFPEntry, PYSNMP_MODULE_ID=ptSFP, vendorPn=vendorPn, brNominal=brNominal, length50m10m=length50m10m, connectorType=connectorType, ptSFP=ptSFP, vcc=vcc, length9m1km=length9m1km, PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, txPower=txPower, ConnectorTypeTC=ConnectorTypeTC)
