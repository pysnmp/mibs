...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, vendorOui=vendorOui, ConnectorTypeTC=ConnectorTypeTC, ptSFPCompliances=ptSFPCompliances, ptSFPGroups=ptSFPGroups, length50m10m=length50m10m, ptSFPFullCompliance=ptSFPFullCompliance, levelRx=levelRx, installedWavelength=installedWavelength, brNominal=brNominal, biasCurrent=biasCurrent, installedSFP=installedSFP, PortInterfaceTC=PortInterfaceTC, installState=installState, vendorName=vendorName, connectorType=connectorType, length62m10m=length62m10m, vcc=vcc, ptSFP=ptSFP, length9m1km=length9m1km, ptSFPEntry=ptSFPEntry, lengthCopper1m=lengthCopper1m, WaveLengthTC=WaveLengthTC, InstallStateTC=InstallStateTC, vendorSn=vendorSn, rxPower=rxPower, temperature=temperature, vendorPn=vendorPn, txPower=txPower, vendorRev=vendorRev, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPTable=ptSFPTable, ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, length9m100m=length9m100m)
