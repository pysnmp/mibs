...
mibBuilder.exportSymbols("PT-SFP-MIB", temperature=temperature, PYSNMP_MODULE_ID=ptSFP, length9m100m=length9m100m, vendorRev=vendorRev, installedWavelength=installedWavelength, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorName=vendorName, length50m10m=length50m10m, length62m10m=length62m10m, WaveLengthTC=WaveLengthTC, txPower=txPower, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, connectorType=connectorType, vcc=vcc, levelRx=levelRx, brNominal=brNominal, ptSFPCompliances=ptSFPCompliances, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, ptSFP=ptSFP, vendorPn=vendorPn, rxPower=rxPower, saleableEntityCode=saleableEntityCode, vendorOui=vendorOui, ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC, length9m1km=length9m1km, installState=installState, installedSFP=installedSFP, vendorSn=vendorSn, ptSFPTable=ptSFPTable, biasCurrent=biasCurrent)
