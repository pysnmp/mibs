...
mibBuilder.exportSymbols("PT-SFP-MIB", installedSFP=installedSFP, ptSFP=ptSFP, levelRx=levelRx, saleableEntityCode=saleableEntityCode, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, PYSNMP_MODULE_ID=ptSFP, installedWavelength=installedWavelength, txPower=txPower, brNominal=brNominal, length62m10m=length62m10m, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, installState=installState, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, ptSFPTable=ptSFPTable, vendorPn=vendorPn, vendorSn=vendorSn, biasCurrent=biasCurrent, vendorRev=vendorRev, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, length50m10m=length50m10m, rxPower=rxPower, ptSFPCompliances=ptSFPCompliances, ConnectorTypeTC=ConnectorTypeTC, WaveLengthTC=WaveLengthTC, PortInterfaceTC=PortInterfaceTC, vcc=vcc, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorName=vendorName, vendorOui=vendorOui)
