...
mibBuilder.exportSymbols("PT-SFP-MIB", length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, vcc=vcc, length62m10m=length62m10m, levelRx=levelRx, lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, txPower=txPower, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, saleableEntityCode=saleableEntityCode, ptSFPFullCompliance=ptSFPFullCompliance, rxPower=rxPower, brNominal=brNominal, PYSNMP_MODULE_ID=ptSFP, connectorType=connectorType, vendorOui=vendorOui, ptSFPCompleteGroup=ptSFPCompleteGroup, ConnectorTypeTC=ConnectorTypeTC, vendorSn=vendorSn, installState=installState, vendorPn=vendorPn, biasCurrent=biasCurrent, ptSFP=ptSFP, vendorName=vendorName, temperature=temperature, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, installedSFP=installedSFP, InstallStateTC=InstallStateTC, vendorRev=vendorRev)
