...
mibBuilder.exportSymbols("PT-SFP-MIB", ConnectorTypeTC=ConnectorTypeTC, vendorOui=vendorOui, installState=installState, brNominal=brNominal, temperature=temperature, vcc=vcc, vendorName=vendorName, length62m10m=length62m10m, rxPower=rxPower, ptSFP=ptSFP, txPower=txPower, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, connectorType=connectorType, ptSFPCompliances=ptSFPCompliances, ptSFPConformance=ptSFPConformance, PortInterfaceTC=PortInterfaceTC, length9m1km=length9m1km, PYSNMP_MODULE_ID=ptSFP, length9m100m=length9m100m, biasCurrent=biasCurrent, vendorPn=vendorPn, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPTable=ptSFPTable, vendorSn=vendorSn, levelRx=levelRx, installedWavelength=installedWavelength, InstallStateTC=InstallStateTC, saleableEntityCode=saleableEntityCode, WaveLengthTC=WaveLengthTC, installedSFP=installedSFP, ptSFPEntry=ptSFPEntry, vendorRev=vendorRev, ptSFPCompleteGroup=ptSFPCompleteGroup)
