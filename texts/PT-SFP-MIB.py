...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, length9m100m=length9m100m, ptSFPTable=ptSFPTable, saleableEntityCode=saleableEntityCode, ptSFPEntry=ptSFPEntry, PortInterfaceTC=PortInterfaceTC, vcc=vcc, rxPower=rxPower, PYSNMP_MODULE_ID=ptSFP, installedSFP=installedSFP, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, WaveLengthTC=WaveLengthTC, levelRx=levelRx, ptSFPGroups=ptSFPGroups, vendorName=vendorName, installState=installState, vendorPn=vendorPn, vendorRev=vendorRev, biasCurrent=biasCurrent, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, connectorType=connectorType, vendorSn=vendorSn, ptSFP=ptSFP, txPower=txPower, brNominal=brNominal, lengthCopper1m=lengthCopper1m, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, ptSFPCompliances=ptSFPCompliances)
