...
mibBuilder.exportSymbols("PT-SFP-MIB", vcc=vcc, vendorPn=vendorPn, connectorType=connectorType, ptSFPFullCompliance=ptSFPFullCompliance, saleableEntityCode=saleableEntityCode, ptSFPGroups=ptSFPGroups, InstallStateTC=InstallStateTC, WaveLengthTC=WaveLengthTC, txPower=txPower, installedWavelength=installedWavelength, length9m100m=length9m100m, ptSFPCompliances=ptSFPCompliances, length50m10m=length50m10m, installState=installState, vendorOui=vendorOui, ptSFPTable=ptSFPTable, ptSFPEntry=ptSFPEntry, ptSFPConformance=ptSFPConformance, vendorSn=vendorSn, rxPower=rxPower, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, PYSNMP_MODULE_ID=ptSFP, biasCurrent=biasCurrent, ptSFPCompleteGroup=ptSFPCompleteGroup, length62m10m=length62m10m, ptSFP=ptSFP, PortInterfaceTC=PortInterfaceTC, temperature=temperature, length9m1km=length9m1km, installedSFP=installedSFP, brNominal=brNominal, vendorName=vendorName, vendorRev=vendorRev)
