...
mibBuilder.exportSymbols("PT-SFP-MIB", rxPower=rxPower, vendorName=vendorName, ptSFPTable=ptSFPTable, InstallStateTC=InstallStateTC, vendorOui=vendorOui, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, connectorType=connectorType, brNominal=brNominal, length62m10m=length62m10m, ptSFPGroups=ptSFPGroups, PYSNMP_MODULE_ID=ptSFP, vendorPn=vendorPn, vendorRev=vendorRev, installedWavelength=installedWavelength, installedSFP=installedSFP, ConnectorTypeTC=ConnectorTypeTC, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, vcc=vcc, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPConformance=ptSFPConformance, vendorSn=vendorSn, levelRx=levelRx, length9m1km=length9m1km, WaveLengthTC=WaveLengthTC, biasCurrent=biasCurrent, txPower=txPower, length9m100m=length9m100m, temperature=temperature, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, ptSFP=ptSFP)
