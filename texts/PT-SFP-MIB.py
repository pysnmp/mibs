...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, installedWavelength=installedWavelength, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPEntry=ptSFPEntry, ptSFPTable=ptSFPTable, vcc=vcc, ptSFPGroups=ptSFPGroups, length62m10m=length62m10m, vendorName=vendorName, InstallStateTC=InstallStateTC, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, vendorOui=vendorOui, ptSFPConformance=ptSFPConformance, temperature=temperature, vendorSn=vendorSn, connectorType=connectorType, rxPower=rxPower, ptSFPCompliances=ptSFPCompliances, length9m100m=length9m100m, length9m1km=length9m1km, ptSFP=ptSFP, WaveLengthTC=WaveLengthTC, levelRx=levelRx, biasCurrent=biasCurrent, PYSNMP_MODULE_ID=ptSFP, length50m10m=length50m10m, vendorRev=vendorRev, saleableEntityCode=saleableEntityCode, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, installState=installState)
