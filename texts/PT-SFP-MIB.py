...
mibBuilder.exportSymbols("PT-SFP-MIB", WaveLengthTC=WaveLengthTC, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, vendorName=vendorName, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPEntry=ptSFPEntry, ConnectorTypeTC=ConnectorTypeTC, length62m10m=length62m10m, length50m10m=length50m10m, connectorType=connectorType, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m1km=length9m1km, levelRx=levelRx, vendorOui=vendorOui, lengthCopper1m=lengthCopper1m, rxPower=rxPower, ptSFP=ptSFP, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, biasCurrent=biasCurrent, saleableEntityCode=saleableEntityCode, vendorPn=vendorPn, installState=installState, brNominal=brNominal, ptSFPConformance=ptSFPConformance, vcc=vcc, PYSNMP_MODULE_ID=ptSFP, ptSFPGroups=ptSFPGroups, vendorSn=vendorSn, vendorRev=vendorRev, temperature=temperature, length9m100m=length9m100m, txPower=txPower, InstallStateTC=InstallStateTC, installedWavelength=installedWavelength)
