...
mibBuilder.exportSymbols("PT-SFP-MIB", installedSFP=installedSFP, vendorOui=vendorOui, txPower=txPower, vendorSn=vendorSn, PortInterfaceTC=PortInterfaceTC, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, ptSFP=ptSFP, brNominal=brNominal, ptSFPCompliances=ptSFPCompliances, WaveLengthTC=WaveLengthTC, length9m1km=length9m1km, vcc=vcc, ptSFPConformance=ptSFPConformance, lengthCopper1m=lengthCopper1m, InstallStateTC=InstallStateTC, vendorRev=vendorRev, saleableEntityCode=saleableEntityCode, vendorName=vendorName, temperature=temperature, biasCurrent=biasCurrent, PYSNMP_MODULE_ID=ptSFP, connectorType=connectorType, length50m10m=length50m10m, installedWavelength=installedWavelength, length62m10m=length62m10m, length9m100m=length9m100m, ptSFPTable=ptSFPTable, installState=installState, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompleteGroup=ptSFPCompleteGroup, levelRx=levelRx, vendorPn=vendorPn)
