...
mibBuilder.exportSymbols("PT-SFP-MIB", brNominal=brNominal, ptSFPTable=ptSFPTable, rxPower=rxPower, levelRx=levelRx, vendorPn=vendorPn, ConnectorTypeTC=ConnectorTypeTC, PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, ptSFPFullCompliance=ptSFPFullCompliance, ptSFP=ptSFP, txPower=txPower, vendorOui=vendorOui, installState=installState, vcc=vcc, temperature=temperature, saleableEntityCode=saleableEntityCode, installedSFP=installedSFP, length50m10m=length50m10m, length9m1km=length9m1km, ptSFPCompliances=ptSFPCompliances, InstallStateTC=InstallStateTC, vendorSn=vendorSn, vendorRev=vendorRev, connectorType=connectorType, ptSFPConformance=ptSFPConformance, ptSFPGroups=ptSFPGroups, WaveLengthTC=WaveLengthTC, ptSFPEntry=ptSFPEntry, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorName=vendorName, installedWavelength=installedWavelength, length62m10m=length62m10m, PYSNMP_MODULE_ID=ptSFP)
