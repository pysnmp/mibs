...
mibBuilder.exportSymbols("PT-SFP-MIB", levelRx=levelRx, ptSFPCompliances=ptSFPCompliances, length62m10m=length62m10m, vendorName=vendorName, PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, length9m1km=length9m1km, ptSFPConformance=ptSFPConformance, installedWavelength=installedWavelength, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, rxPower=rxPower, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, ptSFP=ptSFP, vcc=vcc, vendorOui=vendorOui, ptSFPEntry=ptSFPEntry, vendorSn=vendorSn, ptSFPCompleteGroup=ptSFPCompleteGroup, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, biasCurrent=biasCurrent, txPower=txPower, brNominal=brNominal, vendorPn=vendorPn, ConnectorTypeTC=ConnectorTypeTC, installedSFP=installedSFP, ptSFPGroups=ptSFPGroups, connectorType=connectorType, vendorRev=vendorRev, installState=installState, ptSFPTable=ptSFPTable, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m)
