...
mibBuilder.exportSymbols("PT-SFP-MIB", brNominal=brNominal, temperature=temperature, length9m1km=length9m1km, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, vendorName=vendorName, txPower=txPower, ptSFPTable=ptSFPTable, ConnectorTypeTC=ConnectorTypeTC, vendorPn=vendorPn, installedSFP=installedSFP, installState=installState, lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, levelRx=levelRx, ptSFPConformance=ptSFPConformance, saleableEntityCode=saleableEntityCode, InstallStateTC=InstallStateTC, ptSFPEntry=ptSFPEntry, length50m10m=length50m10m, vendorSn=vendorSn, length62m10m=length62m10m, ptSFPGroups=ptSFPGroups, vendorOui=vendorOui, PortInterfaceTC=PortInterfaceTC, vcc=vcc, biasCurrent=biasCurrent, ptSFPCompliances=ptSFPCompliances, connectorType=connectorType, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPFullCompliance=ptSFPFullCompliance, ptSFP=ptSFP, rxPower=rxPower)
