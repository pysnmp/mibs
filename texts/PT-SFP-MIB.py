...
mibBuilder.exportSymbols("PT-SFP-MIB", lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, installedSFP=installedSFP, vendorRev=vendorRev, connectorType=connectorType, ptSFPGroups=ptSFPGroups, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, ptSFPCompliances=ptSFPCompliances, PortInterfaceTC=PortInterfaceTC, vendorSn=vendorSn, PYSNMP_MODULE_ID=ptSFP, InstallStateTC=InstallStateTC, brNominal=brNominal, vendorPn=vendorPn, vendorName=vendorName, length50m10m=length50m10m, ptSFP=ptSFP, length9m1km=length9m1km, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, ConnectorTypeTC=ConnectorTypeTC, length62m10m=length62m10m, ptSFPEntry=ptSFPEntry, ptSFPFullCompliance=ptSFPFullCompliance, txPower=txPower, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, temperature=temperature, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m100m=length9m100m, rxPower=rxPower, vcc=vcc, levelRx=levelRx, installState=installState)
