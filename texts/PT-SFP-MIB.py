...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, length50m10m=length50m10m, vendorRev=vendorRev, biasCurrent=biasCurrent, connectorType=connectorType, PortInterfaceTC=PortInterfaceTC, vendorOui=vendorOui, ptSFPCompleteGroup=ptSFPCompleteGroup, installState=installState, ConnectorTypeTC=ConnectorTypeTC, lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, rxPower=rxPower, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, vendorSn=vendorSn, ptSFPConformance=ptSFPConformance, vendorName=vendorName, vendorPn=vendorPn, length62m10m=length62m10m, vcc=vcc, ptSFPFullCompliance=ptSFPFullCompliance, txPower=txPower, installedSFP=installedSFP, ptSFPGroups=ptSFPGroups, ptSFP=ptSFP, saleableEntityCode=saleableEntityCode, ptSFPTable=ptSFPTable, length9m1km=length9m1km, ptSFPCompliances=ptSFPCompliances, temperature=temperature, levelRx=levelRx, PYSNMP_MODULE_ID=ptSFP, brNominal=brNominal, ptSFPEntry=ptSFPEntry)
