...
mibBuilder.exportSymbols("PT-SFP-MIB", rxPower=rxPower, ptSFPEntry=ptSFPEntry, vendorName=vendorName, biasCurrent=biasCurrent, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, brNominal=brNominal, WaveLengthTC=WaveLengthTC, length62m10m=length62m10m, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, installState=installState, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, InstallStateTC=InstallStateTC, length9m100m=length9m100m, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFP=ptSFP, levelRx=levelRx, txPower=txPower, temperature=temperature, connectorType=connectorType, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, length50m10m=length50m10m, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, vendorPn=vendorPn, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, vcc=vcc, vendorSn=vendorSn, installedSFP=installedSFP)
