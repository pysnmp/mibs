...
mibBuilder.exportSymbols("PT-SFP-MIB", ConnectorTypeTC=ConnectorTypeTC, installState=installState, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, connectorType=connectorType, InstallStateTC=InstallStateTC, biasCurrent=biasCurrent, vendorOui=vendorOui, temperature=temperature, ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, rxPower=rxPower, levelRx=levelRx, length9m1km=length9m1km, vendorRev=vendorRev, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, txPower=txPower, vendorName=vendorName, length62m10m=length62m10m, ptSFPTable=ptSFPTable, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, ptSFPGroups=ptSFPGroups, installedSFP=installedSFP, length50m10m=length50m10m, saleableEntityCode=saleableEntityCode, ptSFP=ptSFP, brNominal=brNominal, vendorSn=vendorSn, installedWavelength=installedWavelength, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorPn=vendorPn, length9m100m=length9m100m, vcc=vcc)
