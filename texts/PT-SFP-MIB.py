...
mibBuilder.exportSymbols("PT-SFP-MIB", PYSNMP_MODULE_ID=ptSFP, ptSFPTable=ptSFPTable, vendorRev=vendorRev, ptSFPCompleteGroup=ptSFPCompleteGroup, temperature=temperature, ConnectorTypeTC=ConnectorTypeTC, ptSFPConformance=ptSFPConformance, vendorOui=vendorOui, ptSFPFullCompliance=ptSFPFullCompliance, rxPower=rxPower, length9m1km=length9m1km, txPower=txPower, ptSFP=ptSFP, ptSFPEntry=ptSFPEntry, vendorName=vendorName, length9m100m=length9m100m, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, vcc=vcc, length62m10m=length62m10m, levelRx=levelRx, PortInterfaceTC=PortInterfaceTC, brNominal=brNominal, WaveLengthTC=WaveLengthTC, InstallStateTC=InstallStateTC, connectorType=connectorType, vendorPn=vendorPn, lengthCopper1m=lengthCopper1m, installedSFP=installedSFP, ptSFPCompliances=ptSFPCompliances, installState=installState, vendorSn=vendorSn, ptSFPGroups=ptSFPGroups, installedWavelength=installedWavelength, biasCurrent=biasCurrent)
