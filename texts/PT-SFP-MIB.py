...
mibBuilder.exportSymbols("PT-SFP-MIB", vcc=vcc, ptSFPConformance=ptSFPConformance, vendorSn=vendorSn, vendorOui=vendorOui, txPower=txPower, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, ptSFPCompliances=ptSFPCompliances, PortInterfaceTC=PortInterfaceTC, ptSFPFullCompliance=ptSFPFullCompliance, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, vendorName=vendorName, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, length50m10m=length50m10m, ptSFPGroups=ptSFPGroups, length62m10m=length62m10m, rxPower=rxPower, installState=installState, ptSFP=ptSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorRev=vendorRev, InstallStateTC=InstallStateTC, brNominal=brNominal, installedSFP=installedSFP, length9m100m=length9m100m, ptSFPEntry=ptSFPEntry, length9m1km=length9m1km, vendorPn=vendorPn, temperature=temperature, connectorType=connectorType, saleableEntityCode=saleableEntityCode)
