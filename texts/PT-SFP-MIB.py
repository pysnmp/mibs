...
mibBuilder.exportSymbols("PT-SFP-MIB", WaveLengthTC=WaveLengthTC, InstallStateTC=InstallStateTC, installState=installState, installedWavelength=installedWavelength, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, vendorName=vendorName, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, PortInterfaceTC=PortInterfaceTC, length50m10m=length50m10m, biasCurrent=biasCurrent, levelRx=levelRx, ptSFPConformance=ptSFPConformance, temperature=temperature, connectorType=connectorType, vendorRev=vendorRev, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, ptSFPCompliances=ptSFPCompliances, brNominal=brNominal, saleableEntityCode=saleableEntityCode, vendorSn=vendorSn, txPower=txPower, vendorPn=vendorPn, ptSFPEntry=ptSFPEntry, installedSFP=installedSFP, PYSNMP_MODULE_ID=ptSFP, vendorOui=vendorOui, ptSFP=ptSFP, rxPower=rxPower, ptSFPTable=ptSFPTable, vcc=vcc, ConnectorTypeTC=ConnectorTypeTC, length62m10m=length62m10m)
