...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFP=ptSFP, brNominal=brNominal, levelRx=levelRx, length9m100m=length9m100m, vendorSn=vendorSn, length9m1km=length9m1km, temperature=temperature, vcc=vcc, ConnectorTypeTC=ConnectorTypeTC, vendorRev=vendorRev, rxPower=rxPower, installedSFP=installedSFP, ptSFPGroups=ptSFPGroups, vendorName=vendorName, ptSFPTable=ptSFPTable, connectorType=connectorType, saleableEntityCode=saleableEntityCode, InstallStateTC=InstallStateTC, PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, ptSFPConformance=ptSFPConformance, length50m10m=length50m10m, vendorOui=vendorOui, PortInterfaceTC=PortInterfaceTC, biasCurrent=biasCurrent, txPower=txPower, WaveLengthTC=WaveLengthTC, ptSFPFullCompliance=ptSFPFullCompliance, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPCompliances=ptSFPCompliances, installState=installState, installedWavelength=installedWavelength, vendorPn=vendorPn)
