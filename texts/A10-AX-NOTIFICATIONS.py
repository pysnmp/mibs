...
Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Bits, Gauge32, Unsigned32, ObjectIdentity, Counter64, ModuleIdentity, Integer32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Bits", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64", "ModuleIdentity", "Integer32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axSystemControlCpuHigh=axSystemControlCpuHigh, axServerDown=axServerDown, axNotificationSLBPort=axNotificationSLBPort, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationUpDown=axNotificationUpDown, axNotifications=axNotifications, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axSyslogMsg=axSyslogMsg, axSyslogTrapObjects=axSyslogTrapObjects, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axSystemNotifications=axSystemNotifications, axNotificationDroppedPackets=axNotificationDroppedPackets, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axSystemLicenseRequired=axSystemLicenseRequired, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axHAActive=axHAActive, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationTrunkID=axNotificationTrunkID, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axHAStandby=axHAStandby, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axVrrpStandby=axVrrpStandby, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axSystemFanFailure=axSystemFanFailure, axHighPrioritySyslog=axHighPrioritySyslog, axSyslogModuleName=axSyslogModuleName, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axHardDiskUsageHigh=axHardDiskUsageHigh, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationPartitionId=axNotificationPartitionId, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axSystemStart=axSystemStart, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationOldVcsState=axNotificationOldVcsState, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axServerDisabled=axServerDisabled, axVcsStateChange=axVcsStateChange, axNotificationPartitionName=axNotificationPartitionName, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axServiceDown=axServiceDown, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axGatewayUp=axGatewayUp, axSystemDataCpuHigh=axSystemDataCpuHigh, axServerConnResume=axServerConnResume, axNotificationFanName=axNotificationFanName, axServiceConnRateLimit=axServiceConnRateLimit, axServiceGroupMemberUp=axServiceGroupMemberUp, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationSLBServer=axNotificationSLBServer, axSystemShutdownForReason=axSystemShutdownForReason, axServiceConnResume=axServiceConnResume, axSyslogTrap=axSyslogTrap, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNetworkNotifications=axNetworkNotifications, axSystemShutdown=axSystemShutdown, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axMemoryUsageHigh=axMemoryUsageHigh, axServiceGroupDown=axServiceGroupDown, axVirtualServerUp=axVirtualServerUp, axFan1Failure=axFan1Failure, axNotificationLsnProtoType=axNotificationLsnProtoType, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axServerCreateDelete=axServerCreateDelete, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationDateTime=axNotificationDateTime, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axHAActiveActive=axHAActiveActive, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axServerUp=axServerUp, axNotificationConnLimit=axNotificationConnLimit, axServiceConnLimit=axServiceConnLimit, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationLsnPoolName=axNotificationLsnPoolName, axSystemTempHigh=axSystemTempHigh, axServiceUp=axServiceUp, axSlbNotifications=axSlbNotifications, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationMsg=axNotificationMsg, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axVirtualServerDown=axVirtualServerDown, axNotificationPortThreshold=axNotificationPortThreshold, axServerSelectionFailure=axServerSelectionFailure, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationHAGroup=axNotificationHAGroup, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axAppNotifications=axAppNotifications, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationShutdownReason=axNotificationShutdownReason, axServerConnRateLimit=axServerConnRateLimit, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationVrid=axNotificationVrid, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationIpAddressType=axNotificationIpAddressType, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axVrrpActive=axVrrpActive, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationObjects=axNotificationObjects, axSslServerCertificateErr=axSslServerCertificateErr, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axFan2Failure=axFan2Failure, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axServerConnLimit=axServerConnLimit, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axVirtualServerPortDown=axVirtualServerPortDown, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSystemRestart=axSystemRestart, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axGslbNotifications=axGslbNotifications, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axServerPortCreateDelete=axServerPortCreateDelete, axSystemFanRecover=axSystemFanRecover, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axServiceGroupUp=axServiceGroupUp, axGatewayDown=axGatewayDown, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationCertificateName=axNotificationCertificateName, axVirtualServerPortUp=axVirtualServerPortUp, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axSyslogPriority=axSyslogPriority, axNotificationNewVcsState=axNotificationNewVcsState, axFan3Failure=axFan3Failure, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSystemTempBecomeNormal=axSystemTempBecomeNormal)
