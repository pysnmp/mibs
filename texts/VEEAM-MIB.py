...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:13:40 2022
...
iso, enterprises, Integer32, IpAddress, NotificationType, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, MibIdentifier, Unsigned32, Bits, ObjectIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Integer32", "IpAddress", "NotificationType", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "MibIdentifier", "Unsigned32", "Bits", "ObjectIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryId=repositoryId, extentStatusEntry=extentStatusEntry, onVmBackupCompleted=onVmBackupCompleted, sessionId=sessionId, onWebDownloadFinished=onWebDownloadFinished, traps=traps, extentStatus=extentStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobComment=backupJobComment, veeam=veeam, targetDir=targetDir, cdpRpoThreshold=cdpRpoThreshold, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, backupJobResult=backupJobResult, extentStatusList=extentStatusList, transferFileList=transferFileList, onWinFLRMountStarted=onWinFLRMountStarted, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobId=backupJobId, csvReportFilePath=csvReportFilePath, transferStatus=transferStatus, mountServerName=mountServerName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferTime=transferTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorSid=initiatorSid, notTransferFileList=notTransferFileList, extentName=extentName, vmBackupComment=vmBackupComment, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, repositoryStatus=repositoryStatus, sourceHostName=sourceHostName, onWebDownloadStart=onWebDownloadStart, cdpPolicyName=cdpPolicyName, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobName=backupJobName, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backup=backup)
