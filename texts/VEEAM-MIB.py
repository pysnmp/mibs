...
ObjectIdentity, iso, Counter32, NotificationType, enterprises, TimeTicks, ModuleIdentity, Unsigned32, Bits, IpAddress, NotificationType, MibIdentifier, Integer32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter32", "NotificationType", "enterprises", "TimeTicks", "ModuleIdentity", "Unsigned32", "Bits", "IpAddress", "NotificationType", "MibIdentifier", "Integer32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobName=backupJobName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferStatus=transferStatus, csvReportFilePath=csvReportFilePath, onBackupJobCompleted=onBackupJobCompleted, onSobrOffloadFinished=onSobrOffloadFinished, backupJobComment=backupJobComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorSid=initiatorSid, cdpSla=cdpSla, transferFileList=transferFileList, products=products, extentName=extentName, backupJobId=backupJobId, vmBackupResult=vmBackupResult, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, extentStatusEntry=extentStatusEntry, initiatorName=initiatorName, backup=backup, cdpPolicyName=cdpPolicyName, vmBackupComment=vmBackupComment, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, extentStatus=extentStatus, sourceHostName=sourceHostName, onWinFLRMountStarted=onWinFLRMountStarted, sessionId=sessionId, targetHost=targetHost, transferTime=transferTime, repositoryName=repositoryName, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryId=repositoryId, targetDir=targetDir, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmName=vmName, mountServerName=mountServerName, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusList=extentStatusList, traps=traps, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, veeam=veeam, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobResult=backupJobResult)
