...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:28:28 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobResult=backupJobResult, notTransferFileList=notTransferFileList, veeam=veeam, products=products, onWebDownloadStart=onWebDownloadStart, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, traps=traps, transferFileList=transferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onBackupJobCompleted=onBackupJobCompleted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, transferTime=transferTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobName=backupJobName, onWinFLRMountStarted=onWinFLRMountStarted, csvReportFilePath=csvReportFilePath, extentStatusList=extentStatusList, onSobrOffloadFinished=onSobrOffloadFinished, backup=backup, repositoryName=repositoryName, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, vmName=vmName, transferStatus=transferStatus, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, sourceHostName=sourceHostName, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpSla=cdpSla, extentName=extentName, backupJobId=backupJobId, cdpPolicyName=cdpPolicyName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, targetHost=targetHost, mountServerName=mountServerName, initiatorSid=initiatorSid, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatus=extentStatus, repositoryId=repositoryId, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId)
