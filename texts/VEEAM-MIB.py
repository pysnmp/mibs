...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:18:02 2023
...
enterprises, NotificationType, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity, Counter32, Unsigned32, IpAddress, iso, Bits, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter32", "Unsigned32", "IpAddress", "iso", "Bits", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", traps=traps, targetHost=targetHost, targetDir=targetDir, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, backup=backup, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, mountServerName=mountServerName, vmBackupComment=vmBackupComment, transferStatus=transferStatus, cdpRpoStatus=cdpRpoStatus, repositoryName=repositoryName, extentStatus=extentStatus, repositoryId=repositoryId, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryStatus=repositoryStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentName=extentName, transferTime=transferTime, sessionId=sessionId, csvReportFilePath=csvReportFilePath, vmName=vmName, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, onWebDownloadFinished=onWebDownloadFinished, backupJobResult=backupJobResult, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToFinished=onWinFLRCopyToFinished, veeam=veeam, initiatorName=initiatorName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, initiatorSid=initiatorSid, sourceHostName=sourceHostName, extentStatusEntry=extentStatusEntry, backupJobName=backupJobName, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupResult=vmBackupResult, transferFileList=transferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted)
