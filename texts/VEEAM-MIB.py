...
iso, Integer32, Counter32, Gauge32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, NotificationType, Counter64, enterprises, TimeTicks, Unsigned32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Counter32", "Gauge32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "NotificationType", "Counter64", "enterprises", "TimeTicks", "Unsigned32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, backupJobComment=backupJobComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onVmBackupCompleted=onVmBackupCompleted, onWinFLRMountStarted=onWinFLRMountStarted, onCdpRpoReport=onCdpRpoReport, sourceHostName=sourceHostName, traps=traps, targetHost=targetHost, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpMaxDelay=cdpMaxDelay, vmBackupResult=vmBackupResult, products=products, repositoryName=repositoryName, onWebDownloadFinished=onWebDownloadFinished, transferFileList=transferFileList, cdpRpoThreshold=cdpRpoThreshold, backupJobName=backupJobName, sessionId=sessionId, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmName=vmName, extentName=extentName, csvReportFilePath=csvReportFilePath, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, notTransferFileList=notTransferFileList, initiatorName=initiatorName, cdpSla=cdpSla, targetDir=targetDir, cdpPolicyName=cdpPolicyName, extentStatusList=extentStatusList, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, repositoryId=repositoryId, vmBackupComment=vmBackupComment, backup=backup, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, backupJobId=backupJobId, extentStatus=extentStatus, backupJobResult=backupJobResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, veeam=veeam, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished)
