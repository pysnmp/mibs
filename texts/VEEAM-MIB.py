...
ObjectIdentity, Bits, ModuleIdentity, IpAddress, Unsigned32, Counter32, iso, Integer32, Counter64, NotificationType, Gauge32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "ModuleIdentity", "IpAddress", "Unsigned32", "Counter32", "iso", "Integer32", "Counter64", "NotificationType", "Gauge32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusList=extentStatusList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatus=extentStatus, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobName=backupJobName, sessionId=sessionId, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobId=backupJobId, targetDir=targetDir, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, mountServerName=mountServerName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, extentName=extentName, backupJobResult=backupJobResult, veeam=veeam, initiatorSid=initiatorSid, vmBackupComment=vmBackupComment, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpSla=cdpSla, backupJobComment=backupJobComment, targetHost=targetHost, onWebDownloadStart=onWebDownloadStart, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryId=repositoryId, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferTime=transferTime, onCdpRpoReport=onCdpRpoReport, transferFileList=transferFileList, cdpRpoThreshold=cdpRpoThreshold, products=products, onBackupJobCompleted=onBackupJobCompleted, vmName=vmName, backup=backup, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName)
