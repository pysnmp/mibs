...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:37:48 2023
...
Unsigned32, Integer32, Gauge32, Bits, iso, TimeTicks, Counter32, IpAddress, NotificationType, MibIdentifier, ModuleIdentity, ObjectIdentity, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Gauge32", "Bits", "iso", "TimeTicks", "Counter32", "IpAddress", "NotificationType", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobId=backupJobId, transferStatus=transferStatus, transferFileList=transferFileList, extentName=extentName, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToStarted=onWinFLRCopyToStarted, traps=traps, vmName=vmName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetHost=targetHost, sourceHostName=sourceHostName, repositoryStatus=repositoryStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobComment=backupJobComment, sessionId=sessionId, vmBackupResult=vmBackupResult, backupJobName=backupJobName, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, transferTime=transferTime, extentStatusList=extentStatusList, products=products, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, mountServerName=mountServerName, csvReportFilePath=csvReportFilePath, repositoryId=repositoryId, targetDir=targetDir, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onBackupJobCompleted=onBackupJobCompleted, cdpRpoStatus=cdpRpoStatus, extentStatus=extentStatus, backup=backup, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, cdpMaxDelay=cdpMaxDelay, cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, repositoryName=repositoryName, notTransferFileList=notTransferFileList, extentStatusEntry=extentStatusEntry, onWebDownloadStart=onWebDownloadStart, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished)
