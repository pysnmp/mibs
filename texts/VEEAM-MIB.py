...
NotificationType, Counter32, iso, Integer32, NotificationType, enterprises, ModuleIdentity, Counter64, Gauge32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "Integer32", "NotificationType", "enterprises", "ModuleIdentity", "Counter64", "Gauge32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpPolicyName=cdpPolicyName, transferStatus=transferStatus, vmBackupResult=vmBackupResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, traps=traps, onWebDownloadStart=onWebDownloadStart, mountServerName=mountServerName, backupJobName=backupJobName, sourceHostName=sourceHostName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpRpoStatus=cdpRpoStatus, extentStatusList=extentStatusList, backupJobComment=backupJobComment, transferTime=transferTime, targetDir=targetDir, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sessionId=sessionId, repositoryId=repositoryId, backupJobResult=backupJobResult, repositoryStatus=repositoryStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, initiatorSid=initiatorSid, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, transferFileList=transferFileList, repositoryName=repositoryName, onVmBackupCompleted=onVmBackupCompleted, veeam=veeam, backupJobId=backupJobId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmName=vmName, extentName=extentName, products=products, notTransferFileList=notTransferFileList, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, extentStatusEntry=extentStatusEntry, backup=backup, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath)
