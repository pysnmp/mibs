...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:05:26 2021
...
Gauge32, MibIdentifier, NotificationType, NotificationType, TimeTicks, Bits, IpAddress, enterprises, ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "NotificationType", "NotificationType", "TimeTicks", "Bits", "IpAddress", "enterprises", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, vmRestorePointId=vmRestorePointId, csvReportFilePath=csvReportFilePath, onWebDownloadStart=onWebDownloadStart, transferStatus=transferStatus, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, traps=traps, sourceHostName=sourceHostName, products=products, extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold, repositoryName=repositoryName, vmBackupComment=vmBackupComment, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, cdpMaxDelay=cdpMaxDelay, backupJobResult=backupJobResult, cdpSla=cdpSla, extentName=extentName, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatus=extentStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryStatus=repositoryStatus, targetDir=targetDir, vmBackupResult=vmBackupResult, mountServerName=mountServerName, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobComment=backupJobComment, sessionId=sessionId, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, transferFileList=transferFileList, repositoryId=repositoryId, cdpRpoStatus=cdpRpoStatus, onCdpRpoReport=onCdpRpoReport, extentStatusList=extentStatusList, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobId=backupJobId, initiatorSid=initiatorSid, backupJobName=backupJobName, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmName=vmName, backup=backup, veeam=veeam, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted)
