...
enterprises, ObjectIdentity, Integer32, NotificationType, Gauge32, Counter64, iso, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, NotificationType, IpAddress, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Integer32", "NotificationType", "Gauge32", "Counter64", "iso", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "NotificationType", "IpAddress", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWebDownloadStart=onWebDownloadStart, cdpMaxDelay=cdpMaxDelay, transferFileList=transferFileList, repositoryId=repositoryId, repositoryName=repositoryName, cdpRpoThreshold=cdpRpoThreshold, extentName=extentName, backupJobResult=backupJobResult, backup=backup, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobId=backupJobId, vmRestorePointId=vmRestorePointId, onWinFLRMountStarted=onWinFLRMountStarted, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, extentStatusList=extentStatusList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatus=extentStatus, notTransferFileList=notTransferFileList, veeam=veeam, onBackupJobCompleted=onBackupJobCompleted, vmBackupComment=vmBackupComment, targetDir=targetDir, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, mountServerName=mountServerName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, vmBackupResult=vmBackupResult, transferTime=transferTime, traps=traps, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, backupJobName=backupJobName, vmRestorePointCreationTime=vmRestorePointCreationTime, sourceHostName=sourceHostName, onVmBackupCompleted=onVmBackupCompleted, products=products, initiatorName=initiatorName, transferStatus=transferStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmName=vmName, onSobrOffloadFinished=onSobrOffloadFinished)
