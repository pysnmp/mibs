...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, IpAddress, ModuleIdentity, ObjectIdentity, Counter64, NotificationType, Bits, MibIdentifier, Counter32, Gauge32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType", "Bits", "MibIdentifier", "Counter32", "Gauge32", "enterprises", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupComment=vmBackupComment, backup=backup, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, extentStatusList=extentStatusList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, transferTime=transferTime, initiatorName=initiatorName, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, veeam=veeam, mountServerName=mountServerName, traps=traps, cdpPolicyName=cdpPolicyName, onSobrOffloadFinished=onSobrOffloadFinished, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointId=vmRestorePointId, targetHost=targetHost, backupJobId=backupJobId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentName=extentName, repositoryStatus=repositoryStatus, sourceHostName=sourceHostName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobResult=backupJobResult, sessionId=sessionId, products=products, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, extentStatus=extentStatus, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, backupJobName=backupJobName, transferFileList=transferFileList, repositoryId=repositoryId, cdpRpoStatus=cdpRpoStatus, backupJobComment=backupJobComment)
