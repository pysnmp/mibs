...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:08:50 2023
...
mibBuilder.exportSymbols("VEEAM-MIB", transferStatus=transferStatus, onWebDownloadFinished=onWebDownloadFinished, products=products, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorSid=initiatorSid, repositoryName=repositoryName, veeam=veeam, traps=traps, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobId=backupJobId, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, extentStatusList=extentStatusList, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryId=repositoryId, onWinFLRMountStarted=onWinFLRMountStarted, extentStatus=extentStatus, backup=backup, csvReportFilePath=csvReportFilePath, onVmBackupCompleted=onVmBackupCompleted, extentStatusEntry=extentStatusEntry, transferTime=transferTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, mountServerName=mountServerName, vmName=vmName, vmBackupResult=vmBackupResult, initiatorName=initiatorName, notTransferFileList=notTransferFileList, extentName=extentName, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, sessionId=sessionId, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupComment=vmBackupComment, onWebDownloadStart=onWebDownloadStart, backupJobResult=backupJobResult, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName)
