...
iso, ObjectIdentity, ModuleIdentity, Gauge32, Counter64, Counter32, enterprises, Bits, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, IpAddress, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Counter64", "Counter32", "enterprises", "Bits", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "IpAddress", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupResult=vmBackupResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, veeam=veeam, transferTime=transferTime, extentName=extentName, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupComment=vmBackupComment, products=products, extentStatusList=extentStatusList, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sourceHostName=sourceHostName, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpPolicyName=cdpPolicyName, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, onVmBackupCompleted=onVmBackupCompleted, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, onBackupJobCompleted=onBackupJobCompleted, backupJobId=backupJobId, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusEntry=extentStatusEntry, backupJobName=backupJobName, backupJobResult=backupJobResult, vmName=vmName, extentStatus=extentStatus, repositoryStatus=repositoryStatus, cdpSla=cdpSla, targetDir=targetDir, backup=backup, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, traps=traps, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorName=initiatorName, initiatorSid=initiatorSid, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, csvReportFilePath=csvReportFilePath)
