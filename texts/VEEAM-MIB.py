...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:53:50 2022
...
MibIdentifier, iso, IpAddress, ModuleIdentity, enterprises, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Integer32, Gauge32, ObjectIdentity, TimeTicks, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "IpAddress", "ModuleIdentity", "enterprises", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Integer32", "Gauge32", "ObjectIdentity", "TimeTicks", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", traps=traps, extentStatus=extentStatus, csvReportFilePath=csvReportFilePath, targetDir=targetDir, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, onWebDownloadStart=onWebDownloadStart, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmRestorePointId=vmRestorePointId, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, vmBackupComment=vmBackupComment, onWebDownloadFinished=onWebDownloadFinished, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, notTransferFileList=notTransferFileList, onBackupJobCompleted=onBackupJobCompleted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobResult=backupJobResult, vmBackupResult=vmBackupResult, initiatorName=initiatorName, transferStatus=transferStatus, extentStatusList=extentStatusList, backup=backup, veeam=veeam, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobName=backupJobName, sourceHostName=sourceHostName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, repositoryStatus=repositoryStatus, products=products, sessionId=sessionId, mountServerName=mountServerName, transferFileList=transferFileList, onCdpRpoReport=onCdpRpoReport, repositoryId=repositoryId, backupJobId=backupJobId, extentStatusEntry=extentStatusEntry, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, vmName=vmName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobComment=backupJobComment, extentName=extentName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryName=repositoryName)
