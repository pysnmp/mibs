...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:24:05 2021
...
Integer32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, IpAddress, Gauge32, NotificationType, enterprises, iso, Counter64, MibIdentifier, ModuleIdentity, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "NotificationType", "enterprises", "iso", "Counter64", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferFileList=transferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, sourceHostName=sourceHostName, repositoryStatus=repositoryStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, cdpPolicyName=cdpPolicyName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, mountServerName=mountServerName, backupJobName=backupJobName, targetHost=targetHost, repositoryId=repositoryId, vmRestorePointId=vmRestorePointId, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWebDownloadStart=onWebDownloadStart, extentStatus=extentStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorSid=initiatorSid, vmBackupResult=vmBackupResult, targetDir=targetDir, extentStatusList=extentStatusList, onWebDownloadFinished=onWebDownloadFinished, extentName=extentName, products=products, onVmBackupCompleted=onVmBackupCompleted, backup=backup, traps=traps, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, cdpSla=cdpSla, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, transferTime=transferTime, onBackupJobCompleted=onBackupJobCompleted, backupJobResult=backupJobResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatusEntry=extentStatusEntry)
