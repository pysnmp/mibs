...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:55:50 2023
...
Gauge32, Bits, TimeTicks, Unsigned32, IpAddress, iso, Integer32, ModuleIdentity, ObjectIdentity, Counter32, NotificationType, Counter64, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "TimeTicks", "Unsigned32", "IpAddress", "iso", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatus=extentStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, backupJobResult=backupJobResult, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupResult=vmBackupResult, transferStatus=transferStatus, initiatorName=initiatorName, targetDir=targetDir, backupJobComment=backupJobComment, backupJobId=backupJobId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorSid=initiatorSid, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmRestorePointId=vmRestorePointId, targetHost=targetHost, notTransferFileList=notTransferFileList, backup=backup, products=products, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, repositoryId=repositoryId, sourceHostName=sourceHostName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, repositoryStatus=repositoryStatus, repositoryName=repositoryName, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferTime=transferTime, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, veeam=veeam, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, csvReportFilePath=csvReportFilePath, transferFileList=transferFileList, mountServerName=mountServerName, backupJobName=backupJobName, onBackupJobCompleted=onBackupJobCompleted, extentStatusList=extentStatusList, extentName=extentName, sessionId=sessionId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished)
