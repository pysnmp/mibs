...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:49:41 2021
...
ObjectIdentity, Counter32, Bits, NotificationType, Unsigned32, MibIdentifier, Gauge32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, TimeTicks, Counter64, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Bits", "NotificationType", "Unsigned32", "MibIdentifier", "Gauge32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "TimeTicks", "Counter64", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobResult=backupJobResult, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, onWebDownloadStart=onWebDownloadStart, traps=traps, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, cdpRpoThreshold=cdpRpoThreshold, transferFileList=transferFileList, repositoryName=repositoryName, vmBackupResult=vmBackupResult, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, repositoryStatus=repositoryStatus, veeam=veeam, backupJobName=backupJobName, vmBackupComment=vmBackupComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmRestorePointId=vmRestorePointId, cdpRpoStatus=cdpRpoStatus, notTransferFileList=notTransferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, products=products, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobComment=backupJobComment, onWebDownloadFinished=onWebDownloadFinished, sourceHostName=sourceHostName, extentStatusList=extentStatusList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmName=vmName, transferStatus=transferStatus, initiatorSid=initiatorSid, cdpPolicyName=cdpPolicyName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, sessionId=sessionId, extentStatusEntry=extentStatusEntry, extentStatus=extentStatus, onCdpRpoReport=onCdpRpoReport, onWinFLRMountStarted=onWinFLRMountStarted, initiatorName=initiatorName, transferTime=transferTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, onSobrOffloadFinished=onSobrOffloadFinished, backup=backup, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, csvReportFilePath=csvReportFilePath, mountServerName=mountServerName, targetHost=targetHost, vmRestorePointCreationTime=vmRestorePointCreationTime)
