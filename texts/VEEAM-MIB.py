...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:53:21 2023
...
Gauge32, TimeTicks, Unsigned32, Counter64, NotificationType, Integer32, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, MibIdentifier, IpAddress, Bits, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "NotificationType", "Integer32", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", onVmBackupCompleted=onVmBackupCompleted, initiatorSid=initiatorSid, vmRestorePointCreationTime=vmRestorePointCreationTime, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, backupJobId=backupJobId, cdpMaxDelay=cdpMaxDelay, onWebDownloadFinished=onWebDownloadFinished, traps=traps, targetDir=targetDir, cdpRpoStatus=cdpRpoStatus, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, repositoryStatus=repositoryStatus, extentName=extentName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, veeam=veeam, repositoryId=repositoryId, backup=backup, onCdpRpoReport=onCdpRpoReport, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpSla=cdpSla, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, backupJobComment=backupJobComment, targetHost=targetHost, transferTime=transferTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobResult=backupJobResult, repositoryName=repositoryName, extentStatus=extentStatus, vmName=vmName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, vmBackupComment=vmBackupComment, sourceHostName=sourceHostName, cdpRpoThreshold=cdpRpoThreshold, sessionId=sessionId, transferStatus=transferStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, products=products, initiatorName=initiatorName, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName)
