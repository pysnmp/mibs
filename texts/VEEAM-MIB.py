...
NotificationType, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, Counter32, TimeTicks, NotificationType, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRMountStarted=onWinFLRMountStarted, traps=traps, extentStatusEntry=extentStatusEntry, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, targetHost=targetHost, vmBackupResult=vmBackupResult, transferStatus=transferStatus, transferFileList=transferFileList, onWebDownloadFinished=onWebDownloadFinished, extentStatus=extentStatus, backupJobId=backupJobId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferTime=transferTime, extentStatusList=extentStatusList, backup=backup, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, vmName=vmName, cdpPolicyName=cdpPolicyName, extentName=extentName, cdpRpoStatus=cdpRpoStatus, backupJobName=backupJobName, veeam=veeam, initiatorName=initiatorName, onBackupJobCompleted=onBackupJobCompleted, onWebDownloadStart=onWebDownloadStart, backupJobResult=backupJobResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, sessionId=sessionId, mountServerName=mountServerName, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, repositoryId=repositoryId, cdpRpoThreshold=cdpRpoThreshold, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobComment=backupJobComment, targetDir=targetDir, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupComment=vmBackupComment, vmRestorePointCreationTime=vmRestorePointCreationTime, notTransferFileList=notTransferFileList, sourceHostName=sourceHostName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpSla=cdpSla, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted)
