...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:52:45 2022
...
Bits, Counter64, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Gauge32, TimeTicks, ObjectIdentity, iso, Integer32, NotificationType, enterprises, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Gauge32", "TimeTicks", "ObjectIdentity", "iso", "Integer32", "NotificationType", "enterprises", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadFinished=onWebDownloadFinished, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusEntry=extentStatusEntry, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult, onWinFLRMountStarted=onWinFLRMountStarted, backupJobComment=backupJobComment, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, transferStatus=transferStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, products=products, backupJobResult=backupJobResult, targetHost=targetHost, veeam=veeam, cdpSla=cdpSla, targetDir=targetDir, sessionId=sessionId, cdpRpoThreshold=cdpRpoThreshold, extentName=extentName, extentStatus=extentStatus, repositoryStatus=repositoryStatus, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, backup=backup, onCdpRpoReport=onCdpRpoReport, sourceHostName=sourceHostName, vmRestorePointId=vmRestorePointId, backupJobId=backupJobId, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onVmBackupCompleted=onVmBackupCompleted, transferFileList=transferFileList, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, vmBackupComment=vmBackupComment, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobName=backupJobName, extentStatusList=extentStatusList, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished)
