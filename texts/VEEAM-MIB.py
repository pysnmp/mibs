...
Counter32, ModuleIdentity, MibIdentifier, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Gauge32, NotificationType, ObjectIdentity, Unsigned32, Integer32, IpAddress, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Gauge32", "NotificationType", "ObjectIdentity", "Unsigned32", "Integer32", "IpAddress", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", mountServerName=mountServerName, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, initiatorSid=initiatorSid, onSobrOffloadFinished=onSobrOffloadFinished, backupJobResult=backupJobResult, onCdpRpoReport=onCdpRpoReport, cdpRpoThreshold=cdpRpoThreshold, backup=backup, repositoryId=repositoryId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatus=extentStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, traps=traps, onWebDownloadFinished=onWebDownloadFinished, onWebDownloadStart=onWebDownloadStart, repositoryName=repositoryName, notTransferFileList=notTransferFileList, transferTime=transferTime, sessionId=sessionId, initiatorName=initiatorName, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, veeam=veeam, csvReportFilePath=csvReportFilePath, backupJobId=backupJobId, vmBackupResult=vmBackupResult, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetDir=targetDir, cdpPolicyName=cdpPolicyName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmName=vmName, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, sourceHostName=sourceHostName, cdpSla=cdpSla, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, products=products, extentName=extentName, transferStatus=transferStatus, transferFileList=transferFileList)
