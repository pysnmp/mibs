...
ObjectIdentity, Gauge32, MibIdentifier, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Integer32, TimeTicks, Counter64, NotificationType, iso, Counter32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "MibIdentifier", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Integer32", "TimeTicks", "Counter64", "NotificationType", "iso", "Counter32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", onCdpRpoReport=onCdpRpoReport, backupJobComment=backupJobComment, onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, transferTime=transferTime, traps=traps, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, cdpPolicyName=cdpPolicyName, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, notTransferFileList=notTransferFileList, onVmBackupCompleted=onVmBackupCompleted, extentName=extentName, backup=backup, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, products=products, targetHost=targetHost, extentStatusList=extentStatusList, backupJobResult=backupJobResult, veeam=veeam, cdpRpoStatus=cdpRpoStatus, vmName=vmName, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorSid=initiatorSid, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, mountServerName=mountServerName, repositoryStatus=repositoryStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatus=extentStatus, cdpSla=cdpSla, backupJobId=backupJobId, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, repositoryId=repositoryId, initiatorName=initiatorName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferStatus=transferStatus, sessionId=sessionId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferFileList=transferFileList, targetDir=targetDir, vmBackupComment=vmBackupComment)
