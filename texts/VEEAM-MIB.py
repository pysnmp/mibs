...
# Produced by pysmi-1.1.12 at Tue May 28 14:04:33 2024
...
Gauge32, enterprises, Counter64, Integer32, NotificationType, ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Bits, Counter32, NotificationType, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Bits", "Counter32", "NotificationType", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusList=extentStatusList, targetHost=targetHost, initiatorName=initiatorName, backupJobName=backupJobName, transferFileList=transferFileList, vmBackupComment=vmBackupComment, mountServerName=mountServerName, targetDir=targetDir, backupJobComment=backupJobComment, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, repositoryName=repositoryName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorSid=initiatorSid, transferTime=transferTime, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmName=vmName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, onWebDownloadFinished=onWebDownloadFinished, sourceHostName=sourceHostName, repositoryId=repositoryId, onWebDownloadStart=onWebDownloadStart, cdpPolicyName=cdpPolicyName, csvReportFilePath=csvReportFilePath, backup=backup, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, cdpRpoStatus=cdpRpoStatus, onWinFLRMountStarted=onWinFLRMountStarted, backupJobResult=backupJobResult, cdpSla=cdpSla, cdpMaxDelay=cdpMaxDelay, products=products, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferStatus=transferStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentName=extentName, cdpRpoThreshold=cdpRpoThreshold, repositoryStatus=repositoryStatus, onBackupJobCompleted=onBackupJobCompleted, notTransferFileList=notTransferFileList, sessionId=sessionId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, extentStatusEntry=extentStatusEntry, backupJobId=backupJobId, traps=traps, extentStatus=extentStatus, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted)
