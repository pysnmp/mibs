...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, IpAddress, TimeTicks, Counter32, MibIdentifier, Bits, ObjectIdentity, NotificationType, enterprises, Gauge32, Integer32, Unsigned32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "IpAddress", "TimeTicks", "Counter32", "MibIdentifier", "Bits", "ObjectIdentity", "NotificationType", "enterprises", "Gauge32", "Integer32", "Unsigned32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onBackupJobCompleted=onBackupJobCompleted, csvReportFilePath=csvReportFilePath, backup=backup, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, repositoryStatus=repositoryStatus, vmBackupResult=vmBackupResult, vmBackupComment=vmBackupComment, transferStatus=transferStatus, vmName=vmName, sessionId=sessionId, onWebDownloadFinished=onWebDownloadFinished, extentStatusEntry=extentStatusEntry, traps=traps, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, targetHost=targetHost, backupJobComment=backupJobComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, mountServerName=mountServerName, backupJobId=backupJobId, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, cdpSla=cdpSla, transferTime=transferTime, extentStatus=extentStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpRpoStatus=cdpRpoStatus, initiatorSid=initiatorSid, repositoryId=repositoryId, products=products, backupJobName=backupJobName, transferFileList=transferFileList, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetDir=targetDir, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobResult=backupJobResult, extentName=extentName, extentStatusList=extentStatusList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList)
