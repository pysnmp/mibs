...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:12:21 2023
...
Gauge32, Unsigned32, Counter32, Counter64, TimeTicks, ModuleIdentity, NotificationType, enterprises, NotificationType, ObjectIdentity, IpAddress, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Counter32", "Counter64", "TimeTicks", "ModuleIdentity", "NotificationType", "enterprises", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferTime=transferTime, products=products, backupJobId=backupJobId, vmBackupResult=vmBackupResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryStatus=repositoryStatus, onWebDownloadFinished=onWebDownloadFinished, onWebDownloadStart=onWebDownloadStart, onBackupJobCompleted=onBackupJobCompleted, targetDir=targetDir, notTransferFileList=notTransferFileList, backupJobComment=backupJobComment, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, repositoryId=repositoryId, sessionId=sessionId, repositoryName=repositoryName, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusList=extentStatusList, mountServerName=mountServerName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentName=extentName, extentStatus=extentStatus, veeam=veeam, extentStatusEntry=extentStatusEntry, cdpSla=cdpSla, vmName=vmName, backupJobResult=backupJobResult, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, cdpMaxDelay=cdpMaxDelay, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoThreshold=cdpRpoThreshold, traps=traps, onVmBackupCompleted=onVmBackupCompleted, onWinFLRMountStarted=onWinFLRMountStarted, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, initiatorSid=initiatorSid, backup=backup)
