...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:29:24 2021
...
Counter32, ObjectIdentity, MibIdentifier, NotificationType, Integer32, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Unsigned32, Counter64, enterprises, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Unsigned32", "Counter64", "enterprises", "NotificationType", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmName=vmName, sessionId=sessionId, vmBackupResult=vmBackupResult, notTransferFileList=notTransferFileList, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sourceHostName=sourceHostName, onCdpRpoReport=onCdpRpoReport, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, targetHost=targetHost, transferFileList=transferFileList, targetDir=targetDir, backupJobId=backupJobId, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, backupJobComment=backupJobComment, transferTime=transferTime, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryStatus=repositoryStatus, cdpRpoStatus=cdpRpoStatus, cdpMaxDelay=cdpMaxDelay, vmRestorePointId=vmRestorePointId, products=products, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, initiatorSid=initiatorSid, backup=backup, backupJobResult=backupJobResult, transferStatus=transferStatus, extentStatus=extentStatus, extentStatusList=extentStatusList, cdpPolicyName=cdpPolicyName, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, extentName=extentName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, mountServerName=mountServerName, repositoryName=repositoryName, repositoryId=repositoryId, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted)
