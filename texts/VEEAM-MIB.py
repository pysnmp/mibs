...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:03:49 2023
...
TimeTicks, Integer32, Counter64, Bits, Gauge32, ModuleIdentity, Counter32, NotificationType, MibIdentifier, Unsigned32, enterprises, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter64", "Bits", "Gauge32", "ModuleIdentity", "Counter32", "NotificationType", "MibIdentifier", "Unsigned32", "enterprises", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferStatus=transferStatus, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onBackupJobCompleted=onBackupJobCompleted, notTransferFileList=notTransferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobResult=backupJobResult, vmBackupResult=vmBackupResult, extentStatus=extentStatus, traps=traps, extentName=extentName, targetHost=targetHost, repositoryId=repositoryId, vmRestorePointId=vmRestorePointId, extentStatusEntry=extentStatusEntry, vmRestorePointCreationTime=vmRestorePointCreationTime, onSobrOffloadFinished=onSobrOffloadFinished, targetDir=targetDir, vmName=vmName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryName=repositoryName, sessionId=sessionId, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, backupJobName=backupJobName, onWinFLRMountStarted=onWinFLRMountStarted, backupJobId=backupJobId, initiatorSid=initiatorSid, cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, veeam=veeam, backupJobComment=backupJobComment, extentStatusList=extentStatusList, mountServerName=mountServerName, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferTime=transferTime, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadFinished=onWebDownloadFinished, vmBackupComment=vmBackupComment, backup=backup, products=products, initiatorName=initiatorName, csvReportFilePath=csvReportFilePath)
