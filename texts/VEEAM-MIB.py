...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:47:43 2022
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Bits, MibIdentifier, iso, TimeTicks, NotificationType, NotificationType, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Bits", "MibIdentifier", "iso", "TimeTicks", "NotificationType", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, targetDir=targetDir, veeam=veeam, vmBackupComment=vmBackupComment, backupJobId=backupJobId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmName=vmName, backupJobComment=backupJobComment, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferFileList=transferFileList, initiatorSid=initiatorSid, targetHost=targetHost, products=products, notTransferFileList=notTransferFileList, extentStatusList=extentStatusList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, mountServerName=mountServerName, backupJobName=backupJobName, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, csvReportFilePath=csvReportFilePath, cdpPolicyName=cdpPolicyName, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted, cdpSla=cdpSla, extentStatusEntry=extentStatusEntry, cdpMaxDelay=cdpMaxDelay, onCdpRpoReport=onCdpRpoReport, onWebDownloadFinished=onWebDownloadFinished, extentStatus=extentStatus, repositoryId=repositoryId, backup=backup, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, sessionId=sessionId, transferStatus=transferStatus, repositoryName=repositoryName, initiatorName=initiatorName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobResult=backupJobResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferTime=transferTime, traps=traps, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, extentName=extentName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sourceHostName=sourceHostName, onWebDownloadStart=onWebDownloadStart)
