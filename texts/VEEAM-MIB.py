...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:09:51 2023
...
TimeTicks, IpAddress, Unsigned32, ModuleIdentity, Integer32, Counter32, enterprises, iso, Counter64, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Unsigned32", "ModuleIdentity", "Integer32", "Counter32", "enterprises", "iso", "Counter64", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", sourceHostName=sourceHostName, onWebDownloadStart=onWebDownloadStart, repositoryName=repositoryName, transferTime=transferTime, cdpRpoStatus=cdpRpoStatus, extentStatusList=extentStatusList, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorSid=initiatorSid, traps=traps, initiatorName=initiatorName, backupJobId=backupJobId, extentName=extentName, vmBackupComment=vmBackupComment, sessionId=sessionId, onWinFLRMountStarted=onWinFLRMountStarted, notTransferFileList=notTransferFileList, vmName=vmName, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, vmBackupResult=vmBackupResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpSla=cdpSla, transferStatus=transferStatus, extentStatus=extentStatus, vmRestorePointId=vmRestorePointId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferFileList=transferFileList, mountServerName=mountServerName, vmRestorePointCreationTime=vmRestorePointCreationTime, backup=backup, backupJobName=backupJobName, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, cdpMaxDelay=cdpMaxDelay, cdpPolicyName=cdpPolicyName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryStatus=repositoryStatus, targetDir=targetDir, veeam=veeam, backupJobComment=backupJobComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryId=repositoryId, targetHost=targetHost, products=products, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished)
