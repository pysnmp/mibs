...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Counter32, Counter64, Gauge32, NotificationType, Bits, enterprises, ModuleIdentity, ObjectIdentity, Unsigned32, NotificationType, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Counter32", "Counter64", "Gauge32", "NotificationType", "Bits", "enterprises", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", initiatorName=initiatorName, cdpPolicyName=cdpPolicyName, products=products, backupJobName=backupJobName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryId=repositoryId, extentStatusEntry=extentStatusEntry, targetHost=targetHost, cdpMaxDelay=cdpMaxDelay, backupJobResult=backupJobResult, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backup=backup, repositoryName=repositoryName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobComment=backupJobComment, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusList=extentStatusList, vmName=vmName, vmBackupComment=vmBackupComment, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, transferFileList=transferFileList, mountServerName=mountServerName, onWebDownloadFinished=onWebDownloadFinished, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, sessionId=sessionId, initiatorSid=initiatorSid, extentName=extentName, onCdpRpoReport=onCdpRpoReport, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, onWinFLRMountStarted=onWinFLRMountStarted, transferTime=transferTime, csvReportFilePath=csvReportFilePath, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, traps=traps, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, onBackupJobCompleted=onBackupJobCompleted, targetDir=targetDir, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobId=backupJobId, sourceHostName=sourceHostName, extentStatus=extentStatus)
