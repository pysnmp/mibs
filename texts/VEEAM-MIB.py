...
TimeTicks, Unsigned32, NotificationType, NotificationType, iso, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, enterprises, Integer32, Counter64, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "NotificationType", "NotificationType", "iso", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "enterprises", "Integer32", "Counter64", "ObjectIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, vmName=vmName, notTransferFileList=notTransferFileList, extentStatusEntry=extentStatusEntry, sessionId=sessionId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatus=extentStatus, targetHost=targetHost, cdpRpoThreshold=cdpRpoThreshold, cdpPolicyName=cdpPolicyName, backup=backup, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onVmBackupCompleted=onVmBackupCompleted, repositoryId=repositoryId, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, repositoryName=repositoryName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sourceHostName=sourceHostName, veeam=veeam, extentStatusList=extentStatusList, backupJobComment=backupJobComment, mountServerName=mountServerName, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, vmBackupResult=vmBackupResult, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpSla=cdpSla, backupJobName=backupJobName, onSobrOffloadFinished=onSobrOffloadFinished, transferStatus=transferStatus, backupJobResult=backupJobResult, initiatorSid=initiatorSid, extentName=extentName, csvReportFilePath=csvReportFilePath, traps=traps, targetDir=targetDir, onBackupJobCompleted=onBackupJobCompleted, vmBackupComment=vmBackupComment, backupJobId=backupJobId, repositoryStatus=repositoryStatus)
