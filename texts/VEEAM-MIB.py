...
# Produced by pysmi-1.1.10 at Fri Nov 10 13:28:56 2023
...
Bits, TimeTicks, Counter32, Unsigned32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Integer32, Counter64, MibIdentifier, NotificationType, NotificationType, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter32", "Unsigned32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "NotificationType", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpMaxDelay=cdpMaxDelay, cdpSla=cdpSla, backupJobName=backupJobName, extentStatus=extentStatus, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, extentStatusList=extentStatusList, backup=backup, initiatorName=initiatorName, mountServerName=mountServerName, onCdpRpoReport=onCdpRpoReport, sourceHostName=sourceHostName, targetHost=targetHost, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobComment=backupJobComment, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, traps=traps, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmName=vmName, repositoryId=repositoryId, repositoryName=repositoryName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupComment=vmBackupComment, targetDir=targetDir, transferTime=transferTime, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpPolicyName=cdpPolicyName, veeam=veeam, initiatorSid=initiatorSid, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmBackupResult=vmBackupResult, sessionId=sessionId, repositoryStatus=repositoryStatus, onWebDownloadStart=onWebDownloadStart, products=products, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, onBackupJobCompleted=onBackupJobCompleted, backupJobResult=backupJobResult, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, extentName=extentName, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadFinished=onWebDownloadFinished)
