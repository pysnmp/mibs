...
Bits, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, NotificationType, enterprises, TimeTicks, iso, ModuleIdentity, MibIdentifier, IpAddress, Gauge32, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "NotificationType", "enterprises", "TimeTicks", "iso", "ModuleIdentity", "MibIdentifier", "IpAddress", "Gauge32", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatus=extentStatus, cdpRpoThreshold=cdpRpoThreshold, backup=backup, repositoryName=repositoryName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobComment=backupJobComment, extentStatusEntry=extentStatusEntry, veeam=veeam, vmName=vmName, transferStatus=transferStatus, initiatorSid=initiatorSid, extentStatusList=extentStatusList, targetHost=targetHost, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryId=repositoryId, transferTime=transferTime, backupJobId=backupJobId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, notTransferFileList=notTransferFileList, sessionId=sessionId, cdpPolicyName=cdpPolicyName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, backupJobName=backupJobName, vmRestorePointId=vmRestorePointId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupComment=vmBackupComment, repositoryStatus=repositoryStatus, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpRpoStatus=cdpRpoStatus, onWebDownloadFinished=onWebDownloadFinished, cdpSla=cdpSla, mountServerName=mountServerName, extentName=extentName, initiatorName=initiatorName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, csvReportFilePath=csvReportFilePath, sourceHostName=sourceHostName, cdpMaxDelay=cdpMaxDelay, onSobrOffloadFinished=onSobrOffloadFinished, traps=traps, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetDir=targetDir, onBackupJobCompleted=onBackupJobCompleted, products=products, transferFileList=transferFileList)
