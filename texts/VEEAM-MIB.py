...
Bits, iso, Integer32, TimeTicks, Counter32, Unsigned32, IpAddress, ModuleIdentity, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter64, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Integer32", "TimeTicks", "Counter32", "Unsigned32", "IpAddress", "ModuleIdentity", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter64", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobComment=backupJobComment, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, initiatorName=initiatorName, targetHost=targetHost, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointId=vmRestorePointId, mountServerName=mountServerName, extentStatusList=extentStatusList, extentName=extentName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferTime=transferTime, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, transferStatus=transferStatus, vmBackupResult=vmBackupResult, targetDir=targetDir, onCdpRpoReport=onCdpRpoReport, initiatorSid=initiatorSid, csvReportFilePath=csvReportFilePath, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryId=repositoryId, backupJobResult=backupJobResult, cdpSla=cdpSla, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupComment=vmBackupComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, veeam=veeam, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, backupJobName=backupJobName, extentStatusEntry=extentStatusEntry, cdpRpoStatus=cdpRpoStatus, backup=backup, repositoryStatus=repositoryStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, products=products, vmName=vmName, transferFileList=transferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobId=backupJobId, onWebDownloadStart=onWebDownloadStart, traps=traps, cdpMaxDelay=cdpMaxDelay, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryName=repositoryName, sourceHostName=sourceHostName)
