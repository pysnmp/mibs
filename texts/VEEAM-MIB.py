...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:17:47 2022
...
enterprises, Bits, Gauge32, ModuleIdentity, iso, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, Counter32, Unsigned32, ObjectIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Gauge32", "ModuleIdentity", "iso", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "Counter32", "Unsigned32", "ObjectIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, sessionId=sessionId, notTransferFileList=notTransferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backup=backup, onBackupJobCompleted=onBackupJobCompleted, onVmBackupCompleted=onVmBackupCompleted, targetHost=targetHost, transferTime=transferTime, mountServerName=mountServerName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, transferStatus=transferStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobName=backupJobName, repositoryStatus=repositoryStatus, sourceHostName=sourceHostName, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, repositoryName=repositoryName, onWebDownloadStart=onWebDownloadStart, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, products=products, cdpSla=cdpSla, vmRestorePointCreationTime=vmRestorePointCreationTime, vmRestorePointId=vmRestorePointId, initiatorSid=initiatorSid, onCdpRpoReport=onCdpRpoReport, backupJobComment=backupJobComment, vmName=vmName, csvReportFilePath=csvReportFilePath, veeam=veeam, backupJobId=backupJobId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatusList=extentStatusList, cdpPolicyName=cdpPolicyName, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, extentName=extentName, initiatorName=initiatorName, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferFileList=transferFileList, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, backupJobResult=backupJobResult, traps=traps, repositoryId=repositoryId)
