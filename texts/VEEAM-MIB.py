...
# Produced by pysmi-1.1.12 at Mon Oct 28 02:15:27 2024
...
TimeTicks, Counter32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Integer32, ObjectIdentity, NotificationType, ModuleIdentity, Counter64, NotificationType, iso, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Integer32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter64", "NotificationType", "iso", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sessionId=sessionId, transferTime=transferTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetHost=targetHost, products=products, sourceHostName=sourceHostName, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, cdpRpoStatus=cdpRpoStatus, cdpMaxDelay=cdpMaxDelay, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onSobrOffloadFinished=onSobrOffloadFinished, cdpSla=cdpSla, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, traps=traps, backupJobId=backupJobId, backupJobName=backupJobName, cdpPolicyName=cdpPolicyName, vmRestorePointId=vmRestorePointId, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, onWebDownloadStart=onWebDownloadStart, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryId=repositoryId, backup=backup, extentStatusEntry=extentStatusEntry, veeam=veeam, extentStatusList=extentStatusList, onWebDownloadFinished=onWebDownloadFinished, backupJobResult=backupJobResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, mountServerName=mountServerName, onWinFLRMountStarted=onWinFLRMountStarted, initiatorSid=initiatorSid, transferFileList=transferFileList, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentName=extentName, vmBackupResult=vmBackupResult, vmName=vmName, onBackupJobCompleted=onBackupJobCompleted, transferStatus=transferStatus, targetDir=targetDir)
