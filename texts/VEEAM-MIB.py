...
# Produced by pysmi-1.1.12 at Tue Jun  4 14:17:17 2024
...
Bits, iso, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, NotificationType, Gauge32, Unsigned32, NotificationType, Counter64, ModuleIdentity, ObjectIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "ObjectIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmName=vmName, targetDir=targetDir, veeam=veeam, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorName=initiatorName, products=products, transferTime=transferTime, mountServerName=mountServerName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobName=backupJobName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, onCdpRpoReport=onCdpRpoReport, vmBackupComment=vmBackupComment, backupJobComment=backupJobComment, backup=backup, repositoryName=repositoryName, extentStatusList=extentStatusList, transferFileList=transferFileList, cdpRpoStatus=cdpRpoStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferStatus=transferStatus, vmRestorePointId=vmRestorePointId, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadStart=onWebDownloadStart, cdpRpoThreshold=cdpRpoThreshold, extentStatusEntry=extentStatusEntry, backupJobId=backupJobId, vmBackupResult=vmBackupResult, sourceHostName=sourceHostName, cdpPolicyName=cdpPolicyName, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, notTransferFileList=notTransferFileList, onWebDownloadFinished=onWebDownloadFinished, initiatorSid=initiatorSid, extentName=extentName, sessionId=sessionId, extentStatus=extentStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpSla=cdpSla, traps=traps, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath)
