...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:17:52 2023
...
Bits, Unsigned32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, IpAddress, MibIdentifier, Counter64, NotificationType, enterprises, Gauge32, TimeTicks, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter64", "NotificationType", "enterprises", "Gauge32", "TimeTicks", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupComment=vmBackupComment, onSobrOffloadFinished=onSobrOffloadFinished, transferFileList=transferFileList, onWebDownloadFinished=onWebDownloadFinished, cdpPolicyName=cdpPolicyName, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sessionId=sessionId, repositoryName=repositoryName, onWebDownloadStart=onWebDownloadStart, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, vmBackupResult=vmBackupResult, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentName=extentName, veeam=veeam, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, initiatorSid=initiatorSid, mountServerName=mountServerName, sourceHostName=sourceHostName, extentStatus=extentStatus, backupJobId=backupJobId, onCdpRpoReport=onCdpRpoReport, csvReportFilePath=csvReportFilePath, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmName=vmName, targetDir=targetDir, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobName=backupJobName, targetHost=targetHost, onBackupJobCompleted=onBackupJobCompleted, repositoryId=repositoryId, traps=traps, products=products, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, backupJobResult=backupJobResult, backupJobComment=backupJobComment, transferTime=transferTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryStatus=repositoryStatus, extentStatusList=extentStatusList, backup=backup)
