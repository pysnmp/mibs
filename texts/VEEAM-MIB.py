...
iso, ObjectIdentity, Gauge32, Counter32, TimeTicks, Bits, NotificationType, Integer32, Unsigned32, NotificationType, Counter64, ModuleIdentity, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "Bits", "NotificationType", "Integer32", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobComment=backupJobComment, backupJobResult=backupJobResult, backupJobName=backupJobName, onWebDownloadFinished=onWebDownloadFinished, veeam=veeam, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, csvReportFilePath=csvReportFilePath, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, mountServerName=mountServerName, extentStatusList=extentStatusList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, cdpPolicyName=cdpPolicyName, extentStatusEntry=extentStatusEntry, repositoryName=repositoryName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, repositoryStatus=repositoryStatus, cdpRpoThreshold=cdpRpoThreshold, sessionId=sessionId, cdpRpoStatus=cdpRpoStatus, notTransferFileList=notTransferFileList, repositoryId=repositoryId, cdpMaxDelay=cdpMaxDelay, vmName=vmName, onWebDownloadStart=onWebDownloadStart, extentName=extentName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, traps=traps, vmBackupComment=vmBackupComment, targetHost=targetHost, cdpSla=cdpSla, backupJobId=backupJobId, backup=backup, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorSid=initiatorSid, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatus=extentStatus, transferFileList=transferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted)
