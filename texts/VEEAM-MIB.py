...
Gauge32, MibIdentifier, enterprises, IpAddress, Unsigned32, ModuleIdentity, Integer32, iso, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, NotificationType, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "enterprises", "IpAddress", "Unsigned32", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "NotificationType", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobId=backupJobId, vmName=vmName, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadStart=onWebDownloadStart, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, repositoryName=repositoryName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferFileList=transferFileList, initiatorName=initiatorName, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, backup=backup, extentStatusEntry=extentStatusEntry, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, extentStatusList=extentStatusList, vmRestorePointId=vmRestorePointId, veeam=veeam, backupJobResult=backupJobResult, extentStatus=extentStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobName=backupJobName, targetDir=targetDir, onLinuxFLRMountStarted=onLinuxFLRMountStarted, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, notTransferFileList=notTransferFileList, onWebDownloadFinished=onWebDownloadFinished, cdpRpoThreshold=cdpRpoThreshold, sourceHostName=sourceHostName, transferStatus=transferStatus, extentName=extentName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpPolicyName=cdpPolicyName, traps=traps, vmBackupResult=vmBackupResult, backupJobComment=backupJobComment, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, mountServerName=mountServerName, repositoryId=repositoryId, cdpSla=cdpSla, initiatorSid=initiatorSid, onVmBackupCompleted=onVmBackupCompleted, repositoryStatus=repositoryStatus, vmBackupComment=vmBackupComment)
