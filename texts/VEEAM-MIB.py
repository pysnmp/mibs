...
# Produced by pysmi-1.1.12 at Thu Nov 28 03:03:39 2024
...
ModuleIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, NotificationType, Integer32, Counter64, NotificationType, iso, Bits, TimeTicks, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "NotificationType", "Integer32", "Counter64", "NotificationType", "iso", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", notTransferFileList=notTransferFileList, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, targetDir=targetDir, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupComment=vmBackupComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRMountStarted=onWinFLRMountStarted, backupJobResult=backupJobResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, csvReportFilePath=csvReportFilePath, onVmBackupCompleted=onVmBackupCompleted, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointId=vmRestorePointId, extentStatusList=extentStatusList, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, backupJobComment=backupJobComment, initiatorName=initiatorName, backupJobName=backupJobName, vmName=vmName, cdpMaxDelay=cdpMaxDelay, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, targetHost=targetHost, transferFileList=transferFileList, repositoryName=repositoryName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sourceHostName=sourceHostName, extentStatus=extentStatus, traps=traps, transferTime=transferTime, backupJobId=backupJobId, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpPolicyName=cdpPolicyName, backup=backup, veeam=veeam, cdpSla=cdpSla, extentName=extentName, products=products, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatusEntry=extentStatusEntry)
