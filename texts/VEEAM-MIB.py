...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:38:25 2023
...
NotificationType, Counter64, NotificationType, Integer32, Unsigned32, ModuleIdentity, IpAddress, MibIdentifier, Bits, Gauge32, enterprises, Counter32, iso, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "NotificationType", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "MibIdentifier", "Bits", "Gauge32", "enterprises", "Counter32", "iso", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryId=repositoryId, mountServerName=mountServerName, csvReportFilePath=csvReportFilePath, vmBackupResult=vmBackupResult, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferTime=transferTime, transferStatus=transferStatus, backup=backup, extentStatusEntry=extentStatusEntry, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryStatus=repositoryStatus, onCdpRpoReport=onCdpRpoReport, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, extentStatus=extentStatus, extentStatusList=extentStatusList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, products=products, extentName=extentName, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferFileList=transferFileList, traps=traps, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, notTransferFileList=notTransferFileList, onWebDownloadFinished=onWebDownloadFinished, initiatorSid=initiatorSid, targetDir=targetDir, cdpPolicyName=cdpPolicyName, onBackupJobCompleted=onBackupJobCompleted, targetHost=targetHost, backupJobResult=backupJobResult, onWebDownloadStart=onWebDownloadStart, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, sourceHostName=sourceHostName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorName=initiatorName, vmRestorePointId=vmRestorePointId, repositoryName=repositoryName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobComment=backupJobComment, cdpSla=cdpSla, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
