...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:01:45 2021
...
iso, Counter64, Gauge32, Integer32, IpAddress, ModuleIdentity, enterprises, Unsigned32, Bits, NotificationType, TimeTicks, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Gauge32", "Integer32", "IpAddress", "ModuleIdentity", "enterprises", "Unsigned32", "Bits", "NotificationType", "TimeTicks", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", sessionId=sessionId, repositoryId=repositoryId, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryName=repositoryName, targetHost=targetHost, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, csvReportFilePath=csvReportFilePath, veeam=veeam, backupJobName=backupJobName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupComment=vmBackupComment, vmRestorePointCreationTime=vmRestorePointCreationTime, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointId=vmRestorePointId, extentStatusList=extentStatusList, backupJobResult=backupJobResult, onWebDownloadStart=onWebDownloadStart, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmName=vmName, extentStatus=extentStatus, cdpRpoStatus=cdpRpoStatus, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, traps=traps, transferTime=transferTime, backup=backup, backupJobId=backupJobId, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, initiatorSid=initiatorSid, mountServerName=mountServerName, products=products, onVmBackupCompleted=onVmBackupCompleted, extentName=extentName, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobComment=backupJobComment, transferStatus=transferStatus, cdpSla=cdpSla, repositoryStatus=repositoryStatus, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpRpoThreshold=cdpRpoThreshold, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult)
