...
Integer32, NotificationType, Bits, IpAddress, ModuleIdentity, Gauge32, enterprises, TimeTicks, ObjectIdentity, NotificationType, MibIdentifier, Counter64, Unsigned32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "enterprises", "TimeTicks", "ObjectIdentity", "NotificationType", "MibIdentifier", "Counter64", "Unsigned32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupComment=vmBackupComment, initiatorSid=initiatorSid, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, traps=traps, vmName=vmName, repositoryId=repositoryId, backupJobResult=backupJobResult, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, extentName=extentName, onVmBackupCompleted=onVmBackupCompleted, transferFileList=transferFileList, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryName=repositoryName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backup=backup, notTransferFileList=notTransferFileList, onWebDownloadStart=onWebDownloadStart, targetHost=targetHost, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold, vmBackupResult=vmBackupResult, extentStatus=extentStatus, extentStatusList=extentStatusList, cdpMaxDelay=cdpMaxDelay, transferTime=transferTime, cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, sessionId=sessionId, veeam=veeam, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, mountServerName=mountServerName, onBackupJobCompleted=onBackupJobCompleted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, targetDir=targetDir, transferStatus=transferStatus, backupJobName=backupJobName, cdpSla=cdpSla, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryStatus=repositoryStatus)
