...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:51:28 2022
...
Counter32, Integer32, enterprises, NotificationType, TimeTicks, IpAddress, iso, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Counter64, ModuleIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "enterprises", "NotificationType", "TimeTicks", "IpAddress", "iso", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Counter64", "ModuleIdentity", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobResult=backupJobResult, products=products, backupJobComment=backupJobComment, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusList=extentStatusList, onSobrOffloadFinished=onSobrOffloadFinished, vmName=vmName, vmBackupResult=vmBackupResult, repositoryStatus=repositoryStatus, vmBackupComment=vmBackupComment, cdpPolicyName=cdpPolicyName, backup=backup, backupJobName=backupJobName, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, targetHost=targetHost, initiatorName=initiatorName, transferTime=transferTime, onVmBackupCompleted=onVmBackupCompleted, extentName=extentName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpSla=cdpSla, repositoryId=repositoryId, cdpRpoStatus=cdpRpoStatus, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, traps=traps, extentStatusEntry=extentStatusEntry, sourceHostName=sourceHostName, onWinFLRMountStarted=onWinFLRMountStarted, csvReportFilePath=csvReportFilePath, repositoryName=repositoryName, onCdpRpoReport=onCdpRpoReport, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, backupJobId=backupJobId, veeam=veeam, targetDir=targetDir, mountServerName=mountServerName, transferFileList=transferFileList, notTransferFileList=notTransferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, vmRestorePointId=vmRestorePointId)
