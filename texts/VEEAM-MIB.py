...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:35:55 2023
...
Bits, Gauge32, Counter32, enterprises, Unsigned32, iso, Counter64, ObjectIdentity, IpAddress, TimeTicks, NotificationType, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Counter32", "enterprises", "Unsigned32", "iso", "Counter64", "ObjectIdentity", "IpAddress", "TimeTicks", "NotificationType", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, initiatorSid=initiatorSid, transferTime=transferTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, veeam=veeam, backupJobId=backupJobId, backupJobName=backupJobName, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointId=vmRestorePointId, cdpRpoThreshold=cdpRpoThreshold, repositoryId=repositoryId, backupJobComment=backupJobComment, targetHost=targetHost, targetDir=targetDir, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, vmName=vmName, notTransferFileList=notTransferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, repositoryName=repositoryName, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupResult=vmBackupResult, extentStatusList=extentStatusList, onCdpRpoReport=onCdpRpoReport, transferStatus=transferStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backup=backup, extentStatus=extentStatus, repositoryStatus=repositoryStatus, sessionId=sessionId, extentStatusEntry=extentStatusEntry, extentName=extentName, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, products=products, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, cdpSla=cdpSla, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, traps=traps)
