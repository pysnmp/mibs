...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:28:50 2024
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferStatus=transferStatus, extentName=extentName, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorSid=initiatorSid, repositoryName=repositoryName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, onBackupJobCompleted=onBackupJobCompleted, onCdpRpoReport=onCdpRpoReport, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, veeam=veeam, targetDir=targetDir, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobName=backupJobName, repositoryId=repositoryId, sourceHostName=sourceHostName, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, transferTime=transferTime, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay, vmBackupComment=vmBackupComment, traps=traps, cdpPolicyName=cdpPolicyName, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, sessionId=sessionId, transferFileList=transferFileList, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, products=products, backupJobResult=backupJobResult, vmName=vmName, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, backup=backup, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, extentStatus=extentStatus, targetHost=targetHost)
