...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:33:35 2023
...
NotificationType, Integer32, ModuleIdentity, Gauge32, TimeTicks, NotificationType, Counter32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, MibIdentifier, Bits, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "Gauge32", "TimeTicks", "NotificationType", "Counter32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "MibIdentifier", "Bits", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, onVmBackupCompleted=onVmBackupCompleted, sourceHostName=sourceHostName, products=products, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferStatus=transferStatus, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, notTransferFileList=notTransferFileList, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupComment=vmBackupComment, transferTime=transferTime, extentStatus=extentStatus, transferFileList=transferFileList, sessionId=sessionId, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobName=backupJobName, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, vmRestorePointCreationTime=vmRestorePointCreationTime, extentName=extentName, targetDir=targetDir, extentStatusEntry=extentStatusEntry, repositoryId=repositoryId, initiatorSid=initiatorSid, repositoryName=repositoryName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupResult=vmBackupResult, mountServerName=mountServerName, onBackupJobCompleted=onBackupJobCompleted, backupJobResult=backupJobResult, backup=backup, backupJobId=backupJobId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToFinished=onWinFLRCopyToFinished, targetHost=targetHost, csvReportFilePath=csvReportFilePath, traps=traps, onWebDownloadFinished=onWebDownloadFinished, extentStatusList=extentStatusList, vmName=vmName, onWebDownloadStart=onWebDownloadStart, backupJobComment=backupJobComment)
