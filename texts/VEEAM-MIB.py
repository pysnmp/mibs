...
# Produced by pysmi-1.1.12 at Mon Sep 16 15:01:29 2024
...
Bits, MibIdentifier, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter32, IpAddress, iso, enterprises, Unsigned32, Integer32, ObjectIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "iso", "enterprises", "Unsigned32", "Integer32", "ObjectIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", csvReportFilePath=csvReportFilePath, transferStatus=transferStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, backup=backup, targetDir=targetDir, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetHost=targetHost, transferFileList=transferFileList, repositoryName=repositoryName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobComment=backupJobComment, veeam=veeam, cdpSla=cdpSla, cdpMaxDelay=cdpMaxDelay, transferTime=transferTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointId=vmRestorePointId, cdpPolicyName=cdpPolicyName, vmBackupComment=vmBackupComment, onWebDownloadStart=onWebDownloadStart, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryStatus=repositoryStatus, initiatorName=initiatorName, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobResult=backupJobResult, vmBackupResult=vmBackupResult, traps=traps, sourceHostName=sourceHostName, onBackupJobCompleted=onBackupJobCompleted, products=products, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, backupJobName=backupJobName, notTransferFileList=notTransferFileList, repositoryId=repositoryId, backupJobId=backupJobId, extentStatusEntry=extentStatusEntry, sessionId=sessionId, extentName=extentName, initiatorSid=initiatorSid, vmName=vmName, extentStatus=extentStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted)
