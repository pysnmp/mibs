...
ObjectIdentity, TimeTicks, Bits, MibIdentifier, ModuleIdentity, IpAddress, Gauge32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Unsigned32, Counter32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Unsigned32", "Counter32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, mountServerName=mountServerName, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, products=products, transferTime=transferTime, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, cdpRpoThreshold=cdpRpoThreshold, backupJobId=backupJobId, transferStatus=transferStatus, vmName=vmName, repositoryName=repositoryName, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatusEntry=extentStatusEntry, extentName=extentName, veeam=veeam, cdpSla=cdpSla, backupJobComment=backupJobComment, traps=traps, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatus=extentStatus, onWebDownloadFinished=onWebDownloadFinished, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupComment=vmBackupComment, targetHost=targetHost, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, onBackupJobCompleted=onBackupJobCompleted, notTransferFileList=notTransferFileList, backupJobResult=backupJobResult, initiatorSid=initiatorSid, sessionId=sessionId, extentStatusList=extentStatusList, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, sourceHostName=sourceHostName, backup=backup, targetDir=targetDir, vmBackupResult=vmBackupResult, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onVmBackupCompleted=onVmBackupCompleted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
