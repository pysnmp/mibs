...
iso, Gauge32, MibIdentifier, NotificationType, ObjectIdentity, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Integer32, NotificationType, Unsigned32, Bits, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Integer32", "NotificationType", "Unsigned32", "Bits", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetHost=targetHost, targetDir=targetDir, repositoryStatus=repositoryStatus, onWebDownloadStart=onWebDownloadStart, backupJobId=backupJobId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, extentName=extentName, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, onCdpRpoReport=onCdpRpoReport, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, vmName=vmName, notTransferFileList=notTransferFileList, cdpRpoThreshold=cdpRpoThreshold, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, traps=traps, repositoryId=repositoryId, veeam=veeam, backup=backup, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, onWebDownloadFinished=onWebDownloadFinished, initiatorSid=initiatorSid, onWinFLRMountStarted=onWinFLRMountStarted, products=products, transferStatus=transferStatus, repositoryName=repositoryName, mountServerName=mountServerName, backupJobName=backupJobName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusEntry=extentStatusEntry, vmBackupResult=vmBackupResult, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobResult=backupJobResult, sessionId=sessionId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, sourceHostName=sourceHostName, onBackupJobCompleted=onBackupJobCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatus=extentStatus, cdpSla=cdpSla, transferFileList=transferFileList, initiatorName=initiatorName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpPolicyName=cdpPolicyName)
