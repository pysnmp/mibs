...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:15:12 2023
...
ModuleIdentity, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, NotificationType, IpAddress, Bits, TimeTicks, MibIdentifier, enterprises, Counter32, iso, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "NotificationType", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "enterprises", "Counter32", "iso", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, initiatorSid=initiatorSid, traps=traps, targetHost=targetHost, notTransferFileList=notTransferFileList, backupJobId=backupJobId, initiatorName=initiatorName, transferFileList=transferFileList, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, extentName=extentName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryId=repositoryId, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupResult=vmBackupResult, transferStatus=transferStatus, backupJobName=backupJobName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backup=backup, extentStatusList=extentStatusList, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sessionId=sessionId, products=products, targetDir=targetDir, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, repositoryStatus=repositoryStatus, transferTime=transferTime, onCdpRpoReport=onCdpRpoReport, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobResult=backupJobResult, onVmBackupCompleted=onVmBackupCompleted, sourceHostName=sourceHostName, mountServerName=mountServerName, extentStatusEntry=extentStatusEntry, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, extentStatus=extentStatus, vmName=vmName, vmRestorePointId=vmRestorePointId, cdpPolicyName=cdpPolicyName, repositoryName=repositoryName, cdpSla=cdpSla)
