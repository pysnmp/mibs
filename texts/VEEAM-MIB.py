...
Bits, NotificationType, NotificationType, ObjectIdentity, Gauge32, MibIdentifier, TimeTicks, Counter64, iso, ModuleIdentity, IpAddress, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "NotificationType", "ObjectIdentity", "Gauge32", "MibIdentifier", "TimeTicks", "Counter64", "iso", "ModuleIdentity", "IpAddress", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, transferTime=transferTime, vmName=vmName, veeam=veeam, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmBackupResult=vmBackupResult, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, notTransferFileList=notTransferFileList, traps=traps, initiatorName=initiatorName, onVmBackupCompleted=onVmBackupCompleted, transferStatus=transferStatus, repositoryId=repositoryId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, extentStatus=extentStatus, backupJobId=backupJobId, transferFileList=transferFileList, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpPolicyName=cdpPolicyName, extentStatusList=extentStatusList, backupJobName=backupJobName, onWebDownloadStart=onWebDownloadStart, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryStatus=repositoryStatus, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, extentName=extentName, backupJobResult=backupJobResult, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, initiatorSid=initiatorSid, cdpRpoStatus=cdpRpoStatus, repositoryName=repositoryName, cdpSla=cdpSla, onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir)
