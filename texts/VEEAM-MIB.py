...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:50:46 2023
...
Bits, iso, NotificationType, Integer32, IpAddress, ModuleIdentity, MibIdentifier, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter64, Counter32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "NotificationType", "Integer32", "IpAddress", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter64", "Counter32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", notTransferFileList=notTransferFileList, targetDir=targetDir, extentName=extentName, transferStatus=transferStatus, vmBackupComment=vmBackupComment, sessionId=sessionId, backup=backup, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryName=repositoryName, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, traps=traps, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpSla=cdpSla, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onCdpRpoReport=onCdpRpoReport, sourceHostName=sourceHostName, extentStatusEntry=extentStatusEntry, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorName=initiatorName, cdpMaxDelay=cdpMaxDelay, veeam=veeam, backupJobId=backupJobId, targetHost=targetHost, vmRestorePointId=vmRestorePointId, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath, vmBackupResult=vmBackupResult, backupJobComment=backupJobComment, initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmName=vmName, extentStatusList=extentStatusList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRMountStarted=onWinFLRMountStarted, transferTime=transferTime, backupJobResult=backupJobResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatus=extentStatus, repositoryStatus=repositoryStatus, mountServerName=mountServerName, transferFileList=transferFileList, cdpPolicyName=cdpPolicyName, products=products)
