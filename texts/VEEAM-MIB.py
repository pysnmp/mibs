...
Counter32, Bits, ObjectIdentity, Gauge32, TimeTicks, ModuleIdentity, iso, NotificationType, Integer32, Counter64, NotificationType, enterprises, Unsigned32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ObjectIdentity", "Gauge32", "TimeTicks", "ModuleIdentity", "iso", "NotificationType", "Integer32", "Counter64", "NotificationType", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobComment=backupJobComment, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backup=backup, vmBackupResult=vmBackupResult, vmName=vmName, backupJobResult=backupJobResult, extentStatus=extentStatus, mountServerName=mountServerName, cdpRpoStatus=cdpRpoStatus, repositoryId=repositoryId, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryStatus=repositoryStatus, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sourceHostName=sourceHostName, sessionId=sessionId, initiatorName=initiatorName, traps=traps, backupJobId=backupJobId, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, vmBackupComment=vmBackupComment, cdpSla=cdpSla, onWebDownloadStart=onWebDownloadStart, veeam=veeam, extentStatusEntry=extentStatusEntry, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, transferTime=transferTime, cdpMaxDelay=cdpMaxDelay, extentStatusList=extentStatusList, onSobrOffloadFinished=onSobrOffloadFinished, extentName=extentName, repositoryName=repositoryName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, notTransferFileList=notTransferFileList, targetDir=targetDir, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmRestorePointId=vmRestorePointId)
