...
NotificationType, ModuleIdentity, IpAddress, Counter64, Counter32, Integer32, Gauge32, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "Counter32", "Integer32", "Gauge32", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferFileList=transferFileList, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, onWinFLRMountStarted=onWinFLRMountStarted, extentName=extentName, backup=backup, mountServerName=mountServerName, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpPolicyName=cdpPolicyName, onBackupJobCompleted=onBackupJobCompleted, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryName=repositoryName, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToFinished=onWinFLRCopyToFinished, sessionId=sessionId, repositoryStatus=repositoryStatus, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorName=initiatorName, transferStatus=transferStatus, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferTime=transferTime, vmBackupResult=vmBackupResult, cdpSla=cdpSla, targetDir=targetDir, veeam=veeam, vmName=vmName, targetHost=targetHost, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, extentStatusEntry=extentStatusEntry, traps=traps, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, backupJobId=backupJobId, backupJobName=backupJobName, vmBackupComment=vmBackupComment, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorSid=initiatorSid, extentStatus=extentStatus, notTransferFileList=notTransferFileList, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, extentStatusList=extentStatusList)
