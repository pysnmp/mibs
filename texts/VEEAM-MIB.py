...
# Produced by pysmi-1.1.12 at Tue Sep 17 10:06:14 2024
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, IpAddress, Bits, ObjectIdentity, Integer32, Gauge32, enterprises, Counter32, Counter64, Unsigned32, iso, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "ObjectIdentity", "Integer32", "Gauge32", "enterprises", "Counter32", "Counter64", "Unsigned32", "iso", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, sessionId=sessionId, backupJobResult=backupJobResult, onWebDownloadStart=onWebDownloadStart, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backup=backup, vmBackupResult=vmBackupResult, extentStatusList=extentStatusList, onVmBackupCompleted=onVmBackupCompleted, backupJobComment=backupJobComment, cdpPolicyName=cdpPolicyName, products=products, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, csvReportFilePath=csvReportFilePath, repositoryStatus=repositoryStatus, targetHost=targetHost, extentStatusEntry=extentStatusEntry, repositoryId=repositoryId, backupJobId=backupJobId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentName=extentName, vmRestorePointCreationTime=vmRestorePointCreationTime, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, onWebDownloadFinished=onWebDownloadFinished, mountServerName=mountServerName, cdpRpoThreshold=cdpRpoThreshold, cdpRpoStatus=cdpRpoStatus, backupJobName=backupJobName, onBackupJobCompleted=onBackupJobCompleted, extentStatus=extentStatus, cdpSla=cdpSla, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, sourceHostName=sourceHostName, veeam=veeam, initiatorName=initiatorName, initiatorSid=initiatorSid, vmName=vmName, repositoryName=repositoryName, targetDir=targetDir, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, transferFileList=transferFileList)
