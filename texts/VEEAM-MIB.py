...
Counter32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Unsigned32, iso, Gauge32, IpAddress, TimeTicks, MibIdentifier, ObjectIdentity, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Unsigned32", "iso", "Gauge32", "IpAddress", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", sourceHostName=sourceHostName, initiatorSid=initiatorSid, cdpSla=cdpSla, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, backup=backup, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatus=extentStatus, csvReportFilePath=csvReportFilePath, sessionId=sessionId, transferTime=transferTime, extentStatusEntry=extentStatusEntry, cdpRpoStatus=cdpRpoStatus, products=products, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, repositoryName=repositoryName, cdpRpoThreshold=cdpRpoThreshold, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName, backupJobId=backupJobId, vmBackupComment=vmBackupComment, veeam=veeam, cdpPolicyName=cdpPolicyName, repositoryId=repositoryId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, targetHost=targetHost, vmName=vmName, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, vmBackupResult=vmBackupResult, transferStatus=transferStatus, cdpMaxDelay=cdpMaxDelay, transferFileList=transferFileList, onCdpRpoReport=onCdpRpoReport, initiatorName=initiatorName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, notTransferFileList=notTransferFileList, extentStatusList=extentStatusList, backupJobResult=backupJobResult, backupJobComment=backupJobComment, onWebDownloadStart=onWebDownloadStart, repositoryStatus=repositoryStatus, traps=traps, onWinFLRCopyToFinished=onWinFLRCopyToFinished, mountServerName=mountServerName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onVmBackupCompleted=onVmBackupCompleted, onWinFLRCopyToStarted=onWinFLRCopyToStarted)
