...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:32:31 2023
...
Gauge32, Counter32, Integer32, MibIdentifier, iso, enterprises, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, IpAddress, Unsigned32, ObjectIdentity, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Integer32", "MibIdentifier", "iso", "enterprises", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "IpAddress", "Unsigned32", "ObjectIdentity", "Counter64", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, vmName=vmName, vmRestorePointId=vmRestorePointId, extentStatus=extentStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, targetHost=targetHost, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobId=backupJobId, repositoryId=repositoryId, traps=traps, targetDir=targetDir, veeam=veeam, onWebDownloadStart=onWebDownloadStart, onWebDownloadFinished=onWebDownloadFinished, backupJobResult=backupJobResult, onSobrOffloadFinished=onSobrOffloadFinished, repositoryName=repositoryName, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, mountServerName=mountServerName, transferFileList=transferFileList, extentName=extentName, vmRestorePointCreationTime=vmRestorePointCreationTime, onVmBackupCompleted=onVmBackupCompleted, transferStatus=transferStatus, products=products, sourceHostName=sourceHostName, vmBackupResult=vmBackupResult, sessionId=sessionId, extentStatusList=extentStatusList, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, backup=backup, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentStatusEntry=extentStatusEntry, transferTime=transferTime)
