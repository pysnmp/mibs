...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:49:44 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, initiatorName=initiatorName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, transferFileList=transferFileList, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, repositoryId=repositoryId, repositoryStatus=repositoryStatus, extentName=extentName, backupJobResult=backupJobResult, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, extentStatus=extentStatus, notTransferFileList=notTransferFileList, vmName=vmName, onWebDownloadStart=onWebDownloadStart, cdpSla=cdpSla, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, cdpPolicyName=cdpPolicyName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, cdpMaxDelay=cdpMaxDelay, transferStatus=transferStatus, transferTime=transferTime, repositoryName=repositoryName, targetHost=targetHost, backupJobName=backupJobName, traps=traps, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, backup=backup, sourceHostName=sourceHostName, mountServerName=mountServerName, onWinFLRMountStarted=onWinFLRMountStarted, extentStatusEntry=extentStatusEntry, sessionId=sessionId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetDir=targetDir, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, csvReportFilePath=csvReportFilePath, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorSid=initiatorSid, products=products)
