...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:49:52 2022
...
enterprises, Bits, ObjectIdentity, MibIdentifier, ModuleIdentity, NotificationType, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, IpAddress, NotificationType, Counter64, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "NotificationType", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "IpAddress", "NotificationType", "Counter64", "iso", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferTime=transferTime, repositoryId=repositoryId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetDir=targetDir, transferFileList=transferFileList, extentStatus=extentStatus, cdpPolicyName=cdpPolicyName, mountServerName=mountServerName, vmBackupComment=vmBackupComment, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, sourceHostName=sourceHostName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetHost=targetHost, veeam=veeam, products=products, onLinuxFLRMountStarted=onLinuxFLRMountStarted, csvReportFilePath=csvReportFilePath, extentName=extentName, transferStatus=transferStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, onBackupJobCompleted=onBackupJobCompleted, traps=traps, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, vmBackupResult=vmBackupResult, backupJobName=backupJobName, vmRestorePointId=vmRestorePointId, extentStatusEntry=extentStatusEntry, backupJobId=backupJobId, onVmBackupCompleted=onVmBackupCompleted, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRMountStarted=onWinFLRMountStarted, cdpSla=cdpSla, backupJobResult=backupJobResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, notTransferFileList=notTransferFileList, initiatorSid=initiatorSid, backup=backup, initiatorName=initiatorName, backupJobComment=backupJobComment, sessionId=sessionId)
