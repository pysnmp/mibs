...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:26:39 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Unsigned32, Bits, enterprises, iso, NotificationType, MibIdentifier, Counter64, Counter32, IpAddress, TimeTicks, ObjectIdentity, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Unsigned32", "Bits", "enterprises", "iso", "NotificationType", "MibIdentifier", "Counter64", "Counter32", "IpAddress", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpSla=cdpSla, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, notTransferFileList=notTransferFileList, targetDir=targetDir, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferFileList=transferFileList, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, vmBackupComment=vmBackupComment, sourceHostName=sourceHostName, repositoryStatus=repositoryStatus, extentName=extentName, onWebDownloadStart=onWebDownloadStart, mountServerName=mountServerName, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, transferStatus=transferStatus, extentStatusList=extentStatusList, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, repositoryId=repositoryId, cdpMaxDelay=cdpMaxDelay, targetHost=targetHost, backupJobResult=backupJobResult, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferTime=transferTime, initiatorName=initiatorName, initiatorSid=initiatorSid, extentStatusEntry=extentStatusEntry, traps=traps, vmName=vmName, vmRestorePointId=vmRestorePointId, veeam=veeam, onWebDownloadFinished=onWebDownloadFinished, onWinFLRMountStarted=onWinFLRMountStarted, backupJobName=backupJobName, repositoryName=repositoryName, backup=backup, cdpPolicyName=cdpPolicyName, products=products)
