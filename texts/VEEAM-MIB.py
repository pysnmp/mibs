...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:06:07 2023
...
iso, Bits, ModuleIdentity, NotificationType, NotificationType, Integer32, Gauge32, Counter64, Unsigned32, MibIdentifier, Counter32, IpAddress, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ModuleIdentity", "NotificationType", "NotificationType", "Integer32", "Gauge32", "Counter64", "Unsigned32", "MibIdentifier", "Counter32", "IpAddress", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferFileList=transferFileList, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, csvReportFilePath=csvReportFilePath, onBackupJobCompleted=onBackupJobCompleted, notTransferFileList=notTransferFileList, sourceHostName=sourceHostName, extentStatusEntry=extentStatusEntry, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, onSobrOffloadFinished=onSobrOffloadFinished, targetHost=targetHost, vmBackupResult=vmBackupResult, sessionId=sessionId, veeam=veeam, cdpPolicyName=cdpPolicyName, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatusList=extentStatusList, products=products, onCdpRpoReport=onCdpRpoReport, vmRestorePointCreationTime=vmRestorePointCreationTime, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorSid=initiatorSid, repositoryStatus=repositoryStatus, vmRestorePointId=vmRestorePointId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatus=extentStatus, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorName=initiatorName, repositoryId=repositoryId, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, transferTime=transferTime, cdpSla=cdpSla, traps=traps, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, backupJobId=backupJobId, backup=backup, backupJobResult=backupJobResult, transferStatus=transferStatus, vmName=vmName, repositoryName=repositoryName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted)
