...
ModuleIdentity, Gauge32, MibIdentifier, NotificationType, Counter32, Counter64, iso, TimeTicks, NotificationType, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "iso", "TimeTicks", "NotificationType", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, extentName=extentName, transferFileList=transferFileList, initiatorName=initiatorName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmName=vmName, transferStatus=transferStatus, notTransferFileList=notTransferFileList, cdpRpoThreshold=cdpRpoThreshold, onSobrOffloadFinished=onSobrOffloadFinished, cdpMaxDelay=cdpMaxDelay, vmBackupComment=vmBackupComment, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, mountServerName=mountServerName, extentStatusEntry=extentStatusEntry, cdpPolicyName=cdpPolicyName, products=products, csvReportFilePath=csvReportFilePath, vmRestorePointId=vmRestorePointId, sessionId=sessionId, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, backupJobName=backupJobName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryName=repositoryName, traps=traps, cdpRpoStatus=cdpRpoStatus, backup=backup, onWebDownloadFinished=onWebDownloadFinished, repositoryId=repositoryId, extentStatusList=extentStatusList, targetDir=targetDir, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatus=extentStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpSla=cdpSla, onWinFLRMountStarted=onWinFLRMountStarted, veeam=veeam, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupResult=vmBackupResult, onWebDownloadStart=onWebDownloadStart, backupJobResult=backupJobResult, onVmBackupCompleted=onVmBackupCompleted, backupJobComment=backupJobComment, initiatorSid=initiatorSid, sourceHostName=sourceHostName)
