...
NotificationType, Integer32, ModuleIdentity, MibIdentifier, Counter32, enterprises, Gauge32, ObjectIdentity, Unsigned32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "MibIdentifier", "Counter32", "enterprises", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, extentName=extentName, onWebDownloadStart=onWebDownloadStart, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmName=vmName, vmRestorePointId=vmRestorePointId, sessionId=sessionId, targetDir=targetDir, veeam=veeam, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupResult=vmBackupResult, traps=traps, initiatorSid=initiatorSid, backupJobName=backupJobName, vmBackupComment=vmBackupComment, cdpMaxDelay=cdpMaxDelay, onSobrOffloadFinished=onSobrOffloadFinished, backupJobResult=backupJobResult, vmRestorePointCreationTime=vmRestorePointCreationTime, sourceHostName=sourceHostName, repositoryName=repositoryName, backupJobId=backupJobId, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, targetHost=targetHost, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, repositoryId=repositoryId, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWebDownloadFinished=onWebDownloadFinished, extentStatus=extentStatus, backup=backup, products=products, transferFileList=transferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus)
