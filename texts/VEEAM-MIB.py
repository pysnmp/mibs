...
Gauge32, enterprises, NotificationType, NotificationType, Integer32, IpAddress, Counter64, Counter32, ObjectIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "NotificationType", "NotificationType", "Integer32", "IpAddress", "Counter64", "Counter32", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorSid=initiatorSid, onBackupJobCompleted=onBackupJobCompleted, extentStatus=extentStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, extentName=extentName, traps=traps, repositoryStatus=repositoryStatus, notTransferFileList=notTransferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobName=backupJobName, repositoryId=repositoryId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpSla=cdpSla, backup=backup, cdpRpoStatus=cdpRpoStatus, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, backupJobComment=backupJobComment, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, vmName=vmName, veeam=veeam, products=products, initiatorName=initiatorName, sessionId=sessionId, transferStatus=transferStatus, repositoryName=repositoryName, cdpPolicyName=cdpPolicyName, transferTime=transferTime, extentStatusEntry=extentStatusEntry, sourceHostName=sourceHostName, cdpRpoThreshold=cdpRpoThreshold, backupJobResult=backupJobResult, vmBackupComment=vmBackupComment, backupJobId=backupJobId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferFileList=transferFileList)
