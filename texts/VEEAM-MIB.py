...
TimeTicks, ObjectIdentity, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Gauge32, NotificationType, Counter64, enterprises, Bits, NotificationType, MibIdentifier, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "Counter64", "enterprises", "Bits", "NotificationType", "MibIdentifier", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onVmBackupCompleted=onVmBackupCompleted, sessionId=sessionId, targetHost=targetHost, backupJobResult=backupJobResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, veeam=veeam, cdpRpoStatus=cdpRpoStatus, mountServerName=mountServerName, vmBackupComment=vmBackupComment, transferTime=transferTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferFileList=transferFileList, notTransferFileList=notTransferFileList, extentStatusEntry=extentStatusEntry, vmBackupResult=vmBackupResult, products=products, backupJobName=backupJobName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorName=initiatorName, vmRestorePointId=vmRestorePointId, backup=backup, vmRestorePointCreationTime=vmRestorePointCreationTime, sourceHostName=sourceHostName, repositoryId=repositoryId, backupJobId=backupJobId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, repositoryStatus=repositoryStatus, cdpMaxDelay=cdpMaxDelay, transferStatus=transferStatus, extentName=extentName, initiatorSid=initiatorSid, targetDir=targetDir, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryName=repositoryName, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onCdpRpoReport=onCdpRpoReport, onBackupJobCompleted=onBackupJobCompleted, onSobrOffloadFinished=onSobrOffloadFinished, backupJobComment=backupJobComment, vmName=vmName, cdpPolicyName=cdpPolicyName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadStart=onWebDownloadStart, cdpSla=cdpSla, traps=traps, extentStatus=extentStatus)
