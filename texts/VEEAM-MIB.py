...
# Produced by pysmi-1.1.8 at Mon Jan 17 10:10:51 2022
...
enterprises, Counter64, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, iso, Counter32, ObjectIdentity, IpAddress, Integer32, Bits, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "iso", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "Bits", "NotificationType", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpSla=cdpSla, targetDir=targetDir, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoThreshold=cdpRpoThreshold, onWebDownloadStart=onWebDownloadStart, products=products, backupJobId=backupJobId, backupJobName=backupJobName, vmRestorePointId=vmRestorePointId, cdpPolicyName=cdpPolicyName, sessionId=sessionId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorName=initiatorName, extentName=extentName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobComment=backupJobComment, extentStatus=extentStatus, veeam=veeam, onVmBackupCompleted=onVmBackupCompleted, vmName=vmName, repositoryStatus=repositoryStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, transferStatus=transferStatus, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorSid=initiatorSid, backup=backup, mountServerName=mountServerName, sourceHostName=sourceHostName, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, extentStatusList=extentStatusList, traps=traps, transferFileList=transferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusEntry=extentStatusEntry, vmBackupResult=vmBackupResult, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobResult=backupJobResult, repositoryName=repositoryName, onBackupJobCompleted=onBackupJobCompleted, vmBackupComment=vmBackupComment, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted)
