...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:16:06 2022
...
NotificationType, ObjectIdentity, Unsigned32, TimeTicks, Integer32, MibIdentifier, Counter64, Bits, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, enterprises, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Unsigned32", "TimeTicks", "Integer32", "MibIdentifier", "Counter64", "Bits", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "enterprises", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", traps=traps, onWebDownloadStart=onWebDownloadStart, veeam=veeam, sessionId=sessionId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onBackupJobCompleted=onBackupJobCompleted, csvReportFilePath=csvReportFilePath, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, sourceHostName=sourceHostName, extentStatusList=extentStatusList, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryStatus=repositoryStatus, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, extentName=extentName, initiatorSid=initiatorSid, vmBackupResult=vmBackupResult, targetDir=targetDir, onSobrOffloadFinished=onSobrOffloadFinished, backupJobComment=backupJobComment, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, vmRestorePointId=vmRestorePointId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryName=repositoryName, onCdpRpoReport=onCdpRpoReport, products=products, cdpRpoStatus=cdpRpoStatus, backupJobId=backupJobId, cdpRpoThreshold=cdpRpoThreshold, transferTime=transferTime, backupJobResult=backupJobResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, notTransferFileList=notTransferFileList, mountServerName=mountServerName, cdpSla=cdpSla, cdpPolicyName=cdpPolicyName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backup=backup, transferFileList=transferFileList, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, extentStatus=extentStatus, targetHost=targetHost, vmBackupComment=vmBackupComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted)
