...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:35:41 2023
...
TimeTicks, Counter32, Integer32, ModuleIdentity, Counter64, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, MibIdentifier, ObjectIdentity, iso, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Integer32", "ModuleIdentity", "Counter64", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "MibIdentifier", "ObjectIdentity", "iso", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, onBackupJobCompleted=onBackupJobCompleted, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, backupJobResult=backupJobResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferTime=transferTime, targetDir=targetDir, extentStatus=extentStatus, vmRestorePointId=vmRestorePointId, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmName=vmName, repositoryStatus=repositoryStatus, cdpSla=cdpSla, repositoryId=repositoryId, backup=backup, backupJobId=backupJobId, mountServerName=mountServerName, vmBackupResult=vmBackupResult, vmBackupComment=vmBackupComment, onWinFLRMountStarted=onWinFLRMountStarted, extentName=extentName, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, traps=traps, backupJobComment=backupJobComment, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, sourceHostName=sourceHostName, transferStatus=transferStatus, targetHost=targetHost, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, products=products, cdpMaxDelay=cdpMaxDelay, extentStatusList=extentStatusList, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryName=repositoryName, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry)
