...
Counter64, Bits, Integer32, TimeTicks, ObjectIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, NotificationType, ModuleIdentity, MibIdentifier, Gauge32, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "NotificationType", "ModuleIdentity", "MibIdentifier", "Gauge32", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", notTransferFileList=notTransferFileList, mountServerName=mountServerName, cdpPolicyName=cdpPolicyName, onWinFLRMountStarted=onWinFLRMountStarted, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, vmRestorePointId=vmRestorePointId, backup=backup, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobId=backupJobId, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpSla=cdpSla, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetHost=targetHost, repositoryName=repositoryName, extentName=extentName, repositoryStatus=repositoryStatus, repositoryId=repositoryId, onCdpRpoReport=onCdpRpoReport, initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, traps=traps, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onSobrOffloadFinished=onSobrOffloadFinished, transferFileList=transferFileList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobName=backupJobName, targetDir=targetDir, onWinFLRCopyToFinished=onWinFLRCopyToFinished, csvReportFilePath=csvReportFilePath, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay, extentStatusEntry=extentStatusEntry, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorName=initiatorName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadStart=onWebDownloadStart, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, extentStatusList=extentStatusList, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, products=products, sessionId=sessionId, veeam=veeam)
