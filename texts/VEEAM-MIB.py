...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:57:06 2022
...
Bits, TimeTicks, Unsigned32, Counter32, NotificationType, ObjectIdentity, Counter64, Integer32, ModuleIdentity, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Unsigned32", "Counter32", "NotificationType", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryId=repositoryId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupResult=vmBackupResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobName=backupJobName, veeam=veeam, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatusEntry=extentStatusEntry, onWinFLRMountStarted=onWinFLRMountStarted, cdpPolicyName=cdpPolicyName, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorSid=initiatorSid, repositoryName=repositoryName, backupJobResult=backupJobResult, cdpSla=cdpSla, onWebDownloadStart=onWebDownloadStart, cdpMaxDelay=cdpMaxDelay, extentName=extentName, extentStatus=extentStatus, extentStatusList=extentStatusList, vmRestorePointId=vmRestorePointId, targetDir=targetDir, csvReportFilePath=csvReportFilePath, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sessionId=sessionId, mountServerName=mountServerName, onBackupJobCompleted=onBackupJobCompleted, backupJobComment=backupJobComment, notTransferFileList=notTransferFileList, backup=backup, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobId=backupJobId, targetHost=targetHost, products=products, transferTime=transferTime, transferFileList=transferFileList, onVmBackupCompleted=onVmBackupCompleted, transferStatus=transferStatus, onWebDownloadFinished=onWebDownloadFinished, repositoryStatus=repositoryStatus, onCdpRpoReport=onCdpRpoReport, vmName=vmName, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, traps=traps, initiatorName=initiatorName)
