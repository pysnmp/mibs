...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, Counter32, ModuleIdentity, enterprises, TimeTicks, Integer32, ObjectIdentity, NotificationType, Unsigned32, Bits, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "Counter32", "ModuleIdentity", "enterprises", "TimeTicks", "Integer32", "ObjectIdentity", "NotificationType", "Unsigned32", "Bits", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold, vmBackupResult=vmBackupResult, initiatorSid=initiatorSid, repositoryName=repositoryName, transferFileList=transferFileList, notTransferFileList=notTransferFileList, transferTime=transferTime, onVmBackupCompleted=onVmBackupCompleted, sessionId=sessionId, cdpSla=cdpSla, backupJobResult=backupJobResult, cdpPolicyName=cdpPolicyName, onWebDownloadFinished=onWebDownloadFinished, onWebDownloadStart=onWebDownloadStart, mountServerName=mountServerName, backupJobId=backupJobId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, extentStatus=extentStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorName=initiatorName, vmName=vmName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sourceHostName=sourceHostName, cdpMaxDelay=cdpMaxDelay, backup=backup, transferStatus=transferStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onBackupJobCompleted=onBackupJobCompleted, targetHost=targetHost, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, vmRestorePointId=vmRestorePointId, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, traps=traps, backupJobName=backupJobName, extentName=extentName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, targetDir=targetDir, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime)
