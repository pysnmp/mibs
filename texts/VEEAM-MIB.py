...
enterprises, Integer32, Unsigned32, IpAddress, NotificationType, TimeTicks, ObjectIdentity, Counter32, Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Unsigned32", "IpAddress", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter32", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", products=products, targetHost=targetHost, sourceHostName=sourceHostName, transferTime=transferTime, cdpSla=cdpSla, backupJobComment=backupJobComment, extentStatusList=extentStatusList, extentName=extentName, backupJobId=backupJobId, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, transferStatus=transferStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, notTransferFileList=notTransferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryStatus=repositoryStatus, targetDir=targetDir, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, mountServerName=mountServerName, cdpMaxDelay=cdpMaxDelay, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, onWinFLRMountStarted=onWinFLRMountStarted, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, veeam=veeam, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupComment=vmBackupComment, backup=backup, transferFileList=transferFileList, repositoryId=repositoryId, vmName=vmName, backupJobResult=backupJobResult, traps=traps, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold)
