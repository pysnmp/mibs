...
Counter32, Counter64, Unsigned32, Integer32, iso, Gauge32, ObjectIdentity, IpAddress, NotificationType, NotificationType, enterprises, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "Integer32", "iso", "Gauge32", "ObjectIdentity", "IpAddress", "NotificationType", "NotificationType", "enterprises", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobComment=backupJobComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpPolicyName=cdpPolicyName, repositoryName=repositoryName, sessionId=sessionId, vmBackupComment=vmBackupComment, cdpMaxDelay=cdpMaxDelay, cdpSla=cdpSla, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, cdpRpoStatus=cdpRpoStatus, transferTime=transferTime, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferStatus=transferStatus, repositoryId=repositoryId, extentName=extentName, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, initiatorName=initiatorName, veeam=veeam, transferFileList=transferFileList, backupJobName=backupJobName, onWebDownloadStart=onWebDownloadStart, vmName=vmName, vmBackupResult=vmBackupResult, targetDir=targetDir, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted, initiatorSid=initiatorSid, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, sourceHostName=sourceHostName, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, mountServerName=mountServerName, targetHost=targetHost, backupJobResult=backupJobResult, notTransferFileList=notTransferFileList, traps=traps, backupJobId=backupJobId, cdpRpoThreshold=cdpRpoThreshold, products=products, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backup=backup, onWebDownloadFinished=onWebDownloadFinished, extentStatus=extentStatus, extentStatusEntry=extentStatusEntry)
