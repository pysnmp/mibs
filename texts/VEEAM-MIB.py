...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:57:05 2023
...
iso, enterprises, MibIdentifier, Counter32, NotificationType, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ObjectIdentity, Bits, Counter64, Gauge32, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibIdentifier", "Counter32", "NotificationType", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ObjectIdentity", "Bits", "Counter64", "Gauge32", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferTime=transferTime, backupJobResult=backupJobResult, vmRestorePointId=vmRestorePointId, extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryName=repositoryName, cdpRpoThreshold=cdpRpoThreshold, sourceHostName=sourceHostName, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, targetHost=targetHost, mountServerName=mountServerName, extentStatus=extentStatus, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryStatus=repositoryStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, onWebDownloadFinished=onWebDownloadFinished, vmBackupComment=vmBackupComment, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobComment=backupJobComment, cdpSla=cdpSla, veeam=veeam, transferFileList=transferFileList, backup=backup, traps=traps, notTransferFileList=notTransferFileList, onBackupJobCompleted=onBackupJobCompleted, cdpRpoStatus=cdpRpoStatus, products=products, onWinFLRMountStarted=onWinFLRMountStarted, sessionId=sessionId, initiatorName=initiatorName, backupJobName=backupJobName, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorSid=initiatorSid, vmName=vmName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusList=extentStatusList, cdpPolicyName=cdpPolicyName)
