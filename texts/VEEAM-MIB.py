...
Counter64, ModuleIdentity, TimeTicks, iso, Counter32, ObjectIdentity, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, IpAddress, NotificationType, MibIdentifier, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "TimeTicks", "iso", "Counter32", "ObjectIdentity", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "IpAddress", "NotificationType", "MibIdentifier", "Bits", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetHost=targetHost, sourceHostName=sourceHostName, transferFileList=transferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, mountServerName=mountServerName, transferStatus=transferStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryId=repositoryId, repositoryName=repositoryName, traps=traps, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, backupJobResult=backupJobResult, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName, cdpPolicyName=cdpPolicyName, sessionId=sessionId, transferTime=transferTime, extentStatusEntry=extentStatusEntry, onWebDownloadStart=onWebDownloadStart, targetDir=targetDir, extentStatusList=extentStatusList, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobComment=backupJobComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, products=products, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, cdpSla=cdpSla, onWinFLRMountStarted=onWinFLRMountStarted, initiatorName=initiatorName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatus=extentStatus, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay, backupJobId=backupJobId, vmRestorePointCreationTime=vmRestorePointCreationTime, onVmBackupCompleted=onVmBackupCompleted, vmBackupComment=vmBackupComment, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, extentName=extentName, cdpRpoStatus=cdpRpoStatus, csvReportFilePath=csvReportFilePath, backup=backup, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished)
