...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:36:24 2022
...
NotificationType, MibIdentifier, iso, TimeTicks, Integer32, Gauge32, ModuleIdentity, Counter64, Unsigned32, NotificationType, enterprises, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "iso", "TimeTicks", "Integer32", "Gauge32", "ModuleIdentity", "Counter64", "Unsigned32", "NotificationType", "enterprises", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onVmBackupCompleted=onVmBackupCompleted, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, repositoryName=repositoryName, veeam=veeam, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, targetDir=targetDir, vmRestorePointId=vmRestorePointId, vmBackupComment=vmBackupComment, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, backupJobName=backupJobName, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, extentName=extentName, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetHost=targetHost, onWebDownloadStart=onWebDownloadStart, sessionId=sessionId, traps=traps, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorSid=initiatorSid, backup=backup, cdpRpoThreshold=cdpRpoThreshold, products=products, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, notTransferFileList=notTransferFileList, extentStatusList=extentStatusList, extentStatus=extentStatus, sourceHostName=sourceHostName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, backupJobComment=backupJobComment, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpMaxDelay=cdpMaxDelay, cdpRpoStatus=cdpRpoStatus, transferTime=transferTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpSla=cdpSla, repositoryStatus=repositoryStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmName=vmName)
