...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:03:48 2023
...
iso, TimeTicks, MibIdentifier, Bits, enterprises, ModuleIdentity, Counter64, IpAddress, NotificationType, ObjectIdentity, Unsigned32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibIdentifier", "Bits", "enterprises", "ModuleIdentity", "Counter64", "IpAddress", "NotificationType", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, csvReportFilePath=csvReportFilePath, backupJobName=backupJobName, vmRestorePointCreationTime=vmRestorePointCreationTime, backup=backup, notTransferFileList=notTransferFileList, cdpSla=cdpSla, transferStatus=transferStatus, transferFileList=transferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, vmName=vmName, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorName=initiatorName, backupJobResult=backupJobResult, repositoryName=repositoryName, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, onBackupJobCompleted=onBackupJobCompleted, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sessionId=sessionId, initiatorSid=initiatorSid, traps=traps, mountServerName=mountServerName, repositoryId=repositoryId, vmBackupResult=vmBackupResult, extentStatus=extentStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusEntry=extentStatusEntry, products=products, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, onVmBackupCompleted=onVmBackupCompleted, cdpPolicyName=cdpPolicyName, cdpRpoThreshold=cdpRpoThreshold, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, targetHost=targetHost, onWebDownloadStart=onWebDownloadStart, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, transferTime=transferTime)
