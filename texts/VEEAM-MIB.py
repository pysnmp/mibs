...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Integer32, MibIdentifier, IpAddress, Counter32, ObjectIdentity, NotificationType, Gauge32, ModuleIdentity, iso, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Integer32", "MibIdentifier", "IpAddress", "Counter32", "ObjectIdentity", "NotificationType", "Gauge32", "ModuleIdentity", "iso", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpMaxDelay=cdpMaxDelay, cdpPolicyName=cdpPolicyName, onSobrOffloadFinished=onSobrOffloadFinished, targetDir=targetDir, backupJobName=backupJobName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferStatus=transferStatus, transferFileList=transferFileList, backupJobResult=backupJobResult, cdpRpoThreshold=cdpRpoThreshold, repositoryStatus=repositoryStatus, backupJobComment=backupJobComment, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatus=extentStatus, cdpSla=cdpSla, onWebDownloadFinished=onWebDownloadFinished, traps=traps, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, mountServerName=mountServerName, onWinFLRMountStarted=onWinFLRMountStarted, cdpRpoStatus=cdpRpoStatus, backupJobId=backupJobId, transferTime=transferTime, initiatorName=initiatorName, sourceHostName=sourceHostName, notTransferFileList=notTransferFileList, vmName=vmName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryName=repositoryName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, initiatorSid=initiatorSid, extentStatusList=extentStatusList, veeam=veeam, onCdpRpoReport=onCdpRpoReport, repositoryId=repositoryId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, onWebDownloadStart=onWebDownloadStart, extentStatusEntry=extentStatusEntry, sessionId=sessionId, products=products, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmBackupResult=vmBackupResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentName=extentName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetHost=targetHost, vmBackupComment=vmBackupComment, backup=backup, csvReportFilePath=csvReportFilePath)
