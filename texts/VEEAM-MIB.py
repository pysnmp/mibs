...
enterprises, MibIdentifier, iso, Integer32, NotificationType, Counter32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, ModuleIdentity, Bits, TimeTicks, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "iso", "Integer32", "NotificationType", "Counter32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "ModuleIdentity", "Bits", "TimeTicks", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatus=extentStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobName=backupJobName, targetHost=targetHost, transferStatus=transferStatus, cdpRpoStatus=cdpRpoStatus, veeam=veeam, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointId=vmRestorePointId, targetDir=targetDir, traps=traps, extentStatusList=extentStatusList, repositoryId=repositoryId, initiatorName=initiatorName, sessionId=sessionId, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, backup=backup, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobId=backupJobId, backupJobComment=backupJobComment, vmName=vmName, extentStatusEntry=extentStatusEntry, sourceHostName=sourceHostName, onSobrOffloadFinished=onSobrOffloadFinished, initiatorSid=initiatorSid, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferFileList=transferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, onWebDownloadFinished=onWebDownloadFinished, repositoryName=repositoryName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, products=products, vmBackupComment=vmBackupComment, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, transferTime=transferTime)
