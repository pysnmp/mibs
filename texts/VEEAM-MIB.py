...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:30:03 2023
...
ModuleIdentity, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, IpAddress, Counter64, MibIdentifier, ObjectIdentity, enterprises, Unsigned32, TimeTicks, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "ObjectIdentity", "enterprises", "Unsigned32", "TimeTicks", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, notTransferFileList=notTransferFileList, extentStatusEntry=extentStatusEntry, extentName=extentName, products=products, traps=traps, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, initiatorSid=initiatorSid, onWebDownloadFinished=onWebDownloadFinished, transferStatus=transferStatus, vmBackupResult=vmBackupResult, backupJobResult=backupJobResult, backupJobName=backupJobName, vmBackupComment=vmBackupComment, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadStart=onWebDownloadStart, onVmBackupCompleted=onVmBackupCompleted, csvReportFilePath=csvReportFilePath, cdpMaxDelay=cdpMaxDelay, veeam=veeam, repositoryStatus=repositoryStatus, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmName=vmName, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpRpoThreshold=cdpRpoThreshold, transferTime=transferTime, transferFileList=transferFileList, sessionId=sessionId, backupJobId=backupJobId, targetDir=targetDir, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpSla=cdpSla, targetHost=targetHost, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryName=repositoryName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusList=extentStatusList, backup=backup, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, repositoryId=repositoryId, extentStatus=extentStatus, cdpPolicyName=cdpPolicyName, vmRestorePointId=vmRestorePointId)
