...
MibIdentifier, IpAddress, Bits, TimeTicks, Counter32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, Counter64, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Bits", "TimeTicks", "Counter32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "Integer32", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointId=vmRestorePointId, sourceHostName=sourceHostName, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, products=products, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, cdpSla=cdpSla, veeam=veeam, transferStatus=transferStatus, transferFileList=transferFileList, cdpRpoStatus=cdpRpoStatus, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, backupJobName=backupJobName, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, mountServerName=mountServerName, repositoryId=repositoryId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backup=backup, vmName=vmName, initiatorSid=initiatorSid, initiatorName=initiatorName, backupJobId=backupJobId, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetDir=targetDir, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onVmBackupCompleted=onVmBackupCompleted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, traps=traps, onWinFLRMountStarted=onWinFLRMountStarted, notTransferFileList=notTransferFileList, extentStatusList=extentStatusList, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, vmBackupComment=vmBackupComment, backupJobResult=backupJobResult, extentStatus=extentStatus, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpPolicyName=cdpPolicyName, extentName=extentName, vmBackupResult=vmBackupResult)
