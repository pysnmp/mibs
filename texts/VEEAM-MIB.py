...
Counter32, IpAddress, ModuleIdentity, Bits, enterprises, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, NotificationType, ObjectIdentity, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "ModuleIdentity", "Bits", "enterprises", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "NotificationType", "ObjectIdentity", "TimeTicks", "Integer32", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryId=repositoryId, cdpRpoThreshold=cdpRpoThreshold, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, veeam=veeam, sourceHostName=sourceHostName, onVmBackupCompleted=onVmBackupCompleted, transferFileList=transferFileList, cdpSla=cdpSla, products=products, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onBackupJobCompleted=onBackupJobCompleted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, traps=traps, transferTime=transferTime, transferStatus=transferStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmName=vmName, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, onSobrOffloadFinished=onSobrOffloadFinished, targetHost=targetHost, backupJobResult=backupJobResult, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, cdpRpoStatus=cdpRpoStatus, backupJobName=backupJobName, targetDir=targetDir, onWebDownloadStart=onWebDownloadStart, initiatorSid=initiatorSid, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupResult=vmBackupResult, sessionId=sessionId, vmRestorePointId=vmRestorePointId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatusList=extentStatusList, notTransferFileList=notTransferFileList, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobId=backupJobId, initiatorName=initiatorName, repositoryStatus=repositoryStatus, backup=backup, repositoryName=repositoryName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, mountServerName=mountServerName, extentName=extentName, extentStatus=extentStatus)
