...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:06:04 2023
...
MibIdentifier, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, NotificationType, ObjectIdentity, IpAddress, iso, TimeTicks, Counter64, NotificationType, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "TimeTicks", "Counter64", "NotificationType", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryStatus=repositoryStatus, extentStatus=extentStatus, extentName=extentName, backupJobId=backupJobId, sourceHostName=sourceHostName, mountServerName=mountServerName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, extentStatusList=extentStatusList, transferTime=transferTime, targetHost=targetHost, sessionId=sessionId, targetDir=targetDir, initiatorSid=initiatorSid, cdpRpoStatus=cdpRpoStatus, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryName=repositoryName, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backup=backup, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, initiatorName=initiatorName, products=products, vmBackupComment=vmBackupComment, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, onWebDownloadStart=onWebDownloadStart, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, backupJobResult=backupJobResult, cdpSla=cdpSla, transferFileList=transferFileList, vmBackupResult=vmBackupResult, onWebDownloadFinished=onWebDownloadFinished, notTransferFileList=notTransferFileList, onBackupJobCompleted=onBackupJobCompleted)
