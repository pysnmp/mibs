...
# Produced by pysmi-1.1.8 at Tue Feb  8 23:23:34 2022
...
ObjectIdentity, MibIdentifier, Bits, ModuleIdentity, Counter64, TimeTicks, Integer32, Counter32, Gauge32, enterprises, NotificationType, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Bits", "ModuleIdentity", "Counter64", "TimeTicks", "Integer32", "Counter32", "Gauge32", "enterprises", "NotificationType", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetDir=targetDir, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, cdpMaxDelay=cdpMaxDelay, notTransferFileList=notTransferFileList, onBackupJobCompleted=onBackupJobCompleted, cdpPolicyName=cdpPolicyName, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, csvReportFilePath=csvReportFilePath, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupComment=vmBackupComment, backupJobName=backupJobName, onVmBackupCompleted=onVmBackupCompleted, extentStatusList=extentStatusList, repositoryId=repositoryId, onWebDownloadFinished=onWebDownloadFinished, traps=traps, onCdpRpoReport=onCdpRpoReport, cdpSla=cdpSla, extentStatus=extentStatus, backupJobResult=backupJobResult, vmName=vmName, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, backup=backup, extentName=extentName, mountServerName=mountServerName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, repositoryStatus=repositoryStatus, backupJobId=backupJobId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, targetHost=targetHost, products=products, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sessionId=sessionId, initiatorName=initiatorName, initiatorSid=initiatorSid, backupJobComment=backupJobComment, sourceHostName=sourceHostName, veeam=veeam)
