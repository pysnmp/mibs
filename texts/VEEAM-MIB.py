...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:05:14 2021
...
TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, NotificationType, MibIdentifier, NotificationType, iso, Counter64, ObjectIdentity, Integer32, enterprises, Counter32, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "NotificationType", "iso", "Counter64", "ObjectIdentity", "Integer32", "enterprises", "Counter32", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, products=products, onLinuxFLRMountStarted=onLinuxFLRMountStarted, mountServerName=mountServerName, backupJobResult=backupJobResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatus=extentStatus, extentStatusList=extentStatusList, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onCdpRpoReport=onCdpRpoReport, vmBackupResult=vmBackupResult, repositoryStatus=repositoryStatus, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupComment=vmBackupComment, sessionId=sessionId, initiatorName=initiatorName, vmName=vmName, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpSla=cdpSla, backup=backup, cdpMaxDelay=cdpMaxDelay, targetHost=targetHost, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferStatus=transferStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sourceHostName=sourceHostName, extentName=extentName, cdpPolicyName=cdpPolicyName, repositoryName=repositoryName, repositoryId=repositoryId, vmRestorePointId=vmRestorePointId, backupJobId=backupJobId, initiatorSid=initiatorSid, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, traps=traps, transferTime=transferTime, notTransferFileList=notTransferFileList, onWebDownloadFinished=onWebDownloadFinished, onBackupJobCompleted=onBackupJobCompleted, targetDir=targetDir, onSobrOffloadFinished=onSobrOffloadFinished, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished)
