...
Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, TimeTicks, NotificationType, Gauge32, ObjectIdentity, IpAddress, ModuleIdentity, MibIdentifier, NotificationType, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentName=extentName, backupJobResult=backupJobResult, backupJobComment=backupJobComment, extentStatus=extentStatus, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, initiatorName=initiatorName, products=products, backup=backup, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, initiatorSid=initiatorSid, notTransferFileList=notTransferFileList, repositoryId=repositoryId, extentStatusList=extentStatusList, cdpSla=cdpSla, backupJobName=backupJobName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpPolicyName=cdpPolicyName, repositoryStatus=repositoryStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, backupJobId=backupJobId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusEntry=extentStatusEntry, mountServerName=mountServerName, vmName=vmName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, vmBackupResult=vmBackupResult, transferStatus=transferStatus, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRMountStarted=onWinFLRMountStarted, traps=traps, repositoryName=repositoryName, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, veeam=veeam, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, targetDir=targetDir, targetHost=targetHost, onBackupJobCompleted=onBackupJobCompleted)
