...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:35:40 2023
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, repositoryStatus=repositoryStatus, extentName=extentName, backup=backup, cdpPolicyName=cdpPolicyName, repositoryName=repositoryName, sessionId=sessionId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, veeam=veeam, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointId=vmRestorePointId, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onCdpRpoReport=onCdpRpoReport, initiatorName=initiatorName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferFileList=transferFileList, mountServerName=mountServerName, products=products, transferTime=transferTime, extentStatusList=extentStatusList, backupJobComment=backupJobComment, vmName=vmName, onVmBackupCompleted=onVmBackupCompleted, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, initiatorSid=initiatorSid, traps=traps, sourceHostName=sourceHostName, extentStatus=extentStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobId=backupJobId, csvReportFilePath=csvReportFilePath, cdpSla=cdpSla, vmBackupResult=vmBackupResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupComment=vmBackupComment, onWebDownloadStart=onWebDownloadStart, targetHost=targetHost, repositoryId=repositoryId, targetDir=targetDir, cdpRpoStatus=cdpRpoStatus, cdpMaxDelay=cdpMaxDelay)
