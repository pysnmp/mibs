...
MibIdentifier, Integer32, enterprises, Bits, NotificationType, TimeTicks, ModuleIdentity, iso, NotificationType, ObjectIdentity, Counter64, Counter32, Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "enterprises", "Bits", "NotificationType", "TimeTicks", "ModuleIdentity", "iso", "NotificationType", "ObjectIdentity", "Counter64", "Counter32", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryName=repositoryName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadStart=onWebDownloadStart, backupJobComment=backupJobComment, repositoryId=repositoryId, onWebDownloadFinished=onWebDownloadFinished, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, vmBackupComment=vmBackupComment, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, products=products, backupJobResult=backupJobResult, vmName=vmName, targetHost=targetHost, notTransferFileList=notTransferFileList, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, vmRestorePointId=vmRestorePointId, extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, transferFileList=transferFileList, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpSla=cdpSla, sessionId=sessionId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, mountServerName=mountServerName, repositoryStatus=repositoryStatus, initiatorName=initiatorName, transferTime=transferTime, vmBackupResult=vmBackupResult, backup=backup, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobId=backupJobId, targetDir=targetDir, extentName=extentName, cdpRpoStatus=cdpRpoStatus, sourceHostName=sourceHostName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatus=extentStatus, traps=traps)
