...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:30:46 2022
...
TimeTicks, Counter32, NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, iso, enterprises, IpAddress, Bits, Integer32, NotificationType, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "iso", "enterprises", "IpAddress", "Bits", "Integer32", "NotificationType", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupResult=vmBackupResult, repositoryStatus=repositoryStatus, extentName=extentName, cdpSla=cdpSla, backupJobResult=backupJobResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, notTransferFileList=notTransferFileList, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusEntry=extentStatusEntry, cdpPolicyName=cdpPolicyName, cdpMaxDelay=cdpMaxDelay, transferStatus=transferStatus, mountServerName=mountServerName, targetHost=targetHost, backupJobId=backupJobId, sessionId=sessionId, cdpRpoStatus=cdpRpoStatus, initiatorSid=initiatorSid, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, extentStatus=extentStatus, repositoryName=repositoryName, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, onBackupJobCompleted=onBackupJobCompleted, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupComment=vmBackupComment, backupJobComment=backupJobComment, products=products, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferTime=transferTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetDir=targetDir, transferFileList=transferFileList, veeam=veeam, traps=traps, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, repositoryId=repositoryId, extentStatusList=extentStatusList, backup=backup)
