...
# Produced by pysmi-1.1.8 at Fri Oct 13 14:14:50 2023
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupResult=vmBackupResult, cdpRpoThreshold=cdpRpoThreshold, initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryStatus=repositoryStatus, targetHost=targetHost, backup=backup, vmBackupComment=vmBackupComment, transferStatus=transferStatus, repositoryName=repositoryName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferFileList=transferFileList, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, extentName=extentName, backupJobId=backupJobId, notTransferFileList=notTransferFileList, cdpPolicyName=cdpPolicyName, onVmBackupCompleted=onVmBackupCompleted, vmName=vmName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatusEntry=extentStatusEntry, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobResult=backupJobResult, traps=traps, extentStatus=extentStatus, sessionId=sessionId, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, backupJobName=backupJobName, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, products=products, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sourceHostName=sourceHostName, initiatorName=initiatorName, veeam=veeam, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId)
