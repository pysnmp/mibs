...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:15:14 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, TimeTicks, NotificationType, MibIdentifier, Counter64, Unsigned32, NotificationType, iso, ModuleIdentity, IpAddress, Counter32, Bits, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "TimeTicks", "NotificationType", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "iso", "ModuleIdentity", "IpAddress", "Counter32", "Bits", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobId=backupJobId, onBackupJobCompleted=onBackupJobCompleted, onCdpRpoReport=onCdpRpoReport, vmBackupResult=vmBackupResult, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, backupJobResult=backupJobResult, onWebDownloadStart=onWebDownloadStart, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, products=products, transferStatus=transferStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryId=repositoryId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorSid=initiatorSid, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatus=extentStatus, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry, extentName=extentName, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, initiatorName=initiatorName, onVmBackupCompleted=onVmBackupCompleted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpPolicyName=cdpPolicyName, traps=traps, backup=backup, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, sessionId=sessionId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, onSobrOffloadFinished=onSobrOffloadFinished, notTransferFileList=notTransferFileList, veeam=veeam, repositoryName=repositoryName)
