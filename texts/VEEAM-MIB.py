...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Integer32, MibIdentifier, Counter32, iso, NotificationType, IpAddress, ModuleIdentity, Bits, Unsigned32, Gauge32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Integer32", "MibIdentifier", "Counter32", "iso", "NotificationType", "IpAddress", "ModuleIdentity", "Bits", "Unsigned32", "Gauge32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, sessionId=sessionId, backup=backup, repositoryId=repositoryId, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, initiatorSid=initiatorSid, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, cdpRpoThreshold=cdpRpoThreshold, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatus=extentStatus, onVmBackupCompleted=onVmBackupCompleted, cdpSla=cdpSla, veeam=veeam, vmName=vmName, initiatorName=initiatorName, extentName=extentName, backupJobComment=backupJobComment, traps=traps, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, backupJobName=backupJobName, targetDir=targetDir, sourceHostName=sourceHostName, targetHost=targetHost, csvReportFilePath=csvReportFilePath, onWinFLRMountStarted=onWinFLRMountStarted, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, backupJobId=backupJobId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatusList=extentStatusList, onBackupJobCompleted=onBackupJobCompleted, backupJobResult=backupJobResult, repositoryName=repositoryName, transferStatus=transferStatus, products=products, transferTime=transferTime, cdpPolicyName=cdpPolicyName)
