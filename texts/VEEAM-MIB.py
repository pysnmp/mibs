...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:20:00 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, products=products, backupJobId=backupJobId, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryStatus=repositoryStatus, cdpSla=cdpSla, targetHost=targetHost, sourceHostName=sourceHostName, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, vmName=vmName, initiatorName=initiatorName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, traps=traps, csvReportFilePath=csvReportFilePath, transferTime=transferTime, cdpRpoStatus=cdpRpoStatus, onSobrOffloadFinished=onSobrOffloadFinished, initiatorSid=initiatorSid, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobResult=backupJobResult, cdpPolicyName=cdpPolicyName, repositoryId=repositoryId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, veeam=veeam, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, transferStatus=transferStatus, mountServerName=mountServerName, extentStatusList=extentStatusList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, backup=backup, targetDir=targetDir, extentStatus=extentStatus, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onBackupJobCompleted=onBackupJobCompleted, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, repositoryName=repositoryName, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRMountStarted=onWinFLRMountStarted)
