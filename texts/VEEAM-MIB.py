...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:26:34 2022
...
iso, Integer32, Bits, ObjectIdentity, IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, enterprises, MibIdentifier, ModuleIdentity, NotificationType, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Bits", "ObjectIdentity", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "enterprises", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpPolicyName=cdpPolicyName, targetDir=targetDir, sessionId=sessionId, vmRestorePointCreationTime=vmRestorePointCreationTime, vmBackupComment=vmBackupComment, veeam=veeam, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, extentStatus=extentStatus, extentStatusList=extentStatusList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryName=repositoryName, targetHost=targetHost, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, cdpMaxDelay=cdpMaxDelay, backup=backup, transferTime=transferTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmName=vmName, backupJobName=backupJobName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, initiatorName=initiatorName, backupJobComment=backupJobComment, repositoryStatus=repositoryStatus, products=products, traps=traps, mountServerName=mountServerName, cdpSla=cdpSla, notTransferFileList=notTransferFileList, onCdpRpoReport=onCdpRpoReport, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadStart=onWebDownloadStart, initiatorSid=initiatorSid, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, cdpRpoThreshold=cdpRpoThreshold, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, backupJobResult=backupJobResult, transferStatus=transferStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, sourceHostName=sourceHostName, transferFileList=transferFileList, extentName=extentName, csvReportFilePath=csvReportFilePath, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId)
