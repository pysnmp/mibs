...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:34:49 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, TimeTicks, Counter32, MibIdentifier, enterprises, Bits, Counter64, ModuleIdentity, NotificationType, ObjectIdentity, NotificationType, Integer32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "TimeTicks", "Counter32", "MibIdentifier", "enterprises", "Bits", "Counter64", "ModuleIdentity", "NotificationType", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadStart=onWebDownloadStart, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobResult=backupJobResult, cdpRpoStatus=cdpRpoStatus, vmBackupResult=vmBackupResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobComment=backupJobComment, extentStatusEntry=extentStatusEntry, mountServerName=mountServerName, backupJobId=backupJobId, repositoryName=repositoryName, onBackupJobCompleted=onBackupJobCompleted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backup=backup, backupJobName=backupJobName, extentName=extentName, transferStatus=transferStatus, repositoryId=repositoryId, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, notTransferFileList=notTransferFileList, sourceHostName=sourceHostName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetDir=targetDir, sessionId=sessionId, veeam=veeam, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusList=extentStatusList, onWebDownloadFinished=onWebDownloadFinished, onVmBackupCompleted=onVmBackupCompleted, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, vmBackupComment=vmBackupComment, transferTime=transferTime, vmRestorePointId=vmRestorePointId, initiatorName=initiatorName, onWinFLRMountStarted=onWinFLRMountStarted, onCdpRpoReport=onCdpRpoReport, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, traps=traps, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryStatus=repositoryStatus, targetHost=targetHost, initiatorSid=initiatorSid, cdpSla=cdpSla, cdpMaxDelay=cdpMaxDelay, extentStatus=extentStatus, products=products)
