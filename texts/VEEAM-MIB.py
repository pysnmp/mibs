...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:25:55 2022
...
NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, TimeTicks, IpAddress, Bits, Integer32, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity, Unsigned32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "TimeTicks", "IpAddress", "Bits", "Integer32", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Unsigned32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusEntry=extentStatusEntry, initiatorName=initiatorName, extentStatusList=extentStatusList, initiatorSid=initiatorSid, backup=backup, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay, transferFileList=transferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryId=repositoryId, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, backupJobComment=backupJobComment, vmName=vmName, traps=traps, transferStatus=transferStatus, mountServerName=mountServerName, extentName=extentName, repositoryName=repositoryName, targetDir=targetDir, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, veeam=veeam, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointId=vmRestorePointId, sessionId=sessionId, extentStatus=extentStatus, notTransferFileList=notTransferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetHost=targetHost, cdpPolicyName=cdpPolicyName, vmBackupComment=vmBackupComment, products=products, backupJobName=backupJobName, repositoryStatus=repositoryStatus, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, backupJobId=backupJobId, vmRestorePointCreationTime=vmRestorePointCreationTime, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted)
