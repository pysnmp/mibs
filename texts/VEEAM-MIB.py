...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:16:06 2021
...
NotificationType, Gauge32, ObjectIdentity, Counter64, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, IpAddress, Counter32, MibIdentifier, iso, enterprises, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "Counter64", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter32", "MibIdentifier", "iso", "enterprises", "Integer32", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRMountStarted=onWinFLRMountStarted, products=products, targetDir=targetDir, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmName=vmName, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, backupJobComment=backupJobComment, initiatorSid=initiatorSid, extentStatus=extentStatus, initiatorName=initiatorName, backup=backup, extentStatusList=extentStatusList, veeam=veeam, sessionId=sessionId, onBackupJobCompleted=onBackupJobCompleted, backupJobId=backupJobId, extentName=extentName, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetHost=targetHost, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToStarted=onWinFLRCopyToStarted, traps=traps, backupJobName=backupJobName, vmBackupResult=vmBackupResult, mountServerName=mountServerName, repositoryId=repositoryId, onCdpRpoReport=onCdpRpoReport, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, notTransferFileList=notTransferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, repositoryName=repositoryName, repositoryStatus=repositoryStatus, transferTime=transferTime, vmRestorePointId=vmRestorePointId, transferStatus=transferStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobResult=backupJobResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
