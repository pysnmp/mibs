...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:07:28 2023
...
mibBuilder.exportSymbols("VEEAM-MIB", onSobrOffloadFinished=onSobrOffloadFinished, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName, vmName=vmName, repositoryId=repositoryId, extentStatus=extentStatus, extentStatusEntry=extentStatusEntry, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sessionId=sessionId, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, transferStatus=transferStatus, initiatorSid=initiatorSid, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, targetDir=targetDir, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, products=products, cdpSla=cdpSla, backup=backup, onVmBackupCompleted=onVmBackupCompleted, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, transferFileList=transferFileList, veeam=veeam, repositoryName=repositoryName, traps=traps, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, onWebDownloadStart=onWebDownloadStart, repositoryStatus=repositoryStatus, transferTime=transferTime, vmBackupResult=vmBackupResult, initiatorName=initiatorName, mountServerName=mountServerName, extentStatusList=extentStatusList, cdpRpoThreshold=cdpRpoThreshold, backupJobComment=backupJobComment, notTransferFileList=notTransferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, targetHost=targetHost, extentName=extentName, vmBackupComment=vmBackupComment)
