...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:46:44 2021
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, IpAddress, Counter32, NotificationType, Integer32, TimeTicks, iso, enterprises, MibIdentifier, Bits, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "Integer32", "TimeTicks", "iso", "enterprises", "MibIdentifier", "Bits", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, veeam=veeam, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, onSobrOffloadFinished=onSobrOffloadFinished, targetDir=targetDir, csvReportFilePath=csvReportFilePath, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, backupJobResult=backupJobResult, onWebDownloadFinished=onWebDownloadFinished, notTransferFileList=notTransferFileList, sessionId=sessionId, transferStatus=transferStatus, vmBackupComment=vmBackupComment, extentStatusList=extentStatusList, cdpSla=cdpSla, transferTime=transferTime, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, extentStatusEntry=extentStatusEntry, sourceHostName=sourceHostName, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorSid=initiatorSid, targetHost=targetHost, backupJobComment=backupJobComment, cdpMaxDelay=cdpMaxDelay, traps=traps, repositoryName=repositoryName, products=products, onWinFLRMountStarted=onWinFLRMountStarted, repositoryStatus=repositoryStatus, backup=backup, mountServerName=mountServerName, backupJobId=backupJobId, extentStatus=extentStatus, vmRestorePointId=vmRestorePointId, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, onBackupJobCompleted=onBackupJobCompleted, cdpRpoThreshold=cdpRpoThreshold, vmName=vmName, initiatorName=initiatorName, repositoryId=repositoryId, onCdpRpoReport=onCdpRpoReport)
