...
NotificationType, NotificationType, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Gauge32, IpAddress, Bits, iso, MibIdentifier, Unsigned32, Counter64, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Gauge32", "IpAddress", "Bits", "iso", "MibIdentifier", "Unsigned32", "Counter64", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadStart=onWebDownloadStart, transferFileList=transferFileList, vmBackupComment=vmBackupComment, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferStatus=transferStatus, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmRestorePointId=vmRestorePointId, backup=backup, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, backupJobResult=backupJobResult, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobName=backupJobName, extentStatusEntry=extentStatusEntry, cdpSla=cdpSla, vmName=vmName, vmBackupResult=vmBackupResult, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, transferTime=transferTime, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpMaxDelay=cdpMaxDelay, products=products, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRMountStarted=onWinFLRMountStarted, veeam=veeam, extentStatusList=extentStatusList, targetDir=targetDir, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, onCdpRpoReport=onCdpRpoReport, repositoryStatus=repositoryStatus, repositoryName=repositoryName, traps=traps, extentStatus=extentStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, sessionId=sessionId, sourceHostName=sourceHostName, notTransferFileList=notTransferFileList)
