...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:15:47 2023
...
enterprises, iso, Unsigned32, NotificationType, Counter64, Bits, MibIdentifier, TimeTicks, Counter32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Unsigned32", "NotificationType", "Counter64", "Bits", "MibIdentifier", "TimeTicks", "Counter32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatus=extentStatus, csvReportFilePath=csvReportFilePath, sourceHostName=sourceHostName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, backup=backup, backupJobName=backupJobName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, vmRestorePointId=vmRestorePointId, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobId=backupJobId, transferStatus=transferStatus, veeam=veeam, vmName=vmName, repositoryId=repositoryId, vmBackupComment=vmBackupComment, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentName=extentName, mountServerName=mountServerName, cdpRpoThreshold=cdpRpoThreshold, extentStatusEntry=extentStatusEntry, backupJobComment=backupJobComment, vmBackupResult=vmBackupResult, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorSid=initiatorSid, extentStatusList=extentStatusList, cdpSla=cdpSla, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, transferFileList=transferFileList, repositoryStatus=repositoryStatus, notTransferFileList=notTransferFileList, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorName=initiatorName, targetHost=targetHost, cdpRpoStatus=cdpRpoStatus, onSobrOffloadFinished=onSobrOffloadFinished, cdpMaxDelay=cdpMaxDelay, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, onWebDownloadStart=onWebDownloadStart, traps=traps, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted)
