...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:58:03 2021
...
TimeTicks, ModuleIdentity, Unsigned32, Gauge32, iso, MibIdentifier, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Integer32, Counter64, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Unsigned32", "Gauge32", "iso", "MibIdentifier", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Integer32", "Counter64", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onVmBackupCompleted=onVmBackupCompleted, extentStatusEntry=extentStatusEntry, repositoryId=repositoryId, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, sessionId=sessionId, sourceHostName=sourceHostName, mountServerName=mountServerName, extentName=extentName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorName=initiatorName, vmBackupComment=vmBackupComment, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpRpoStatus=cdpRpoStatus, csvReportFilePath=csvReportFilePath, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, traps=traps, onWinFLRMountStarted=onWinFLRMountStarted, backup=backup, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onBackupJobCompleted=onBackupJobCompleted, backupJobComment=backupJobComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferStatus=transferStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatus=extentStatus, vmName=vmName, cdpMaxDelay=cdpMaxDelay, targetHost=targetHost, notTransferFileList=notTransferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpSla=cdpSla, onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, backupJobId=backupJobId, veeam=veeam, cdpRpoThreshold=cdpRpoThreshold, targetDir=targetDir, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, products=products, repositoryName=repositoryName, onSobrOffloadFinished=onSobrOffloadFinished, initiatorSid=initiatorSid)
