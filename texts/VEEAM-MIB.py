...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:22:51 2023
...
Integer32, ObjectIdentity, Bits, IpAddress, iso, Unsigned32, NotificationType, ModuleIdentity, NotificationType, MibIdentifier, Counter32, enterprises, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Bits", "IpAddress", "iso", "Unsigned32", "NotificationType", "ModuleIdentity", "NotificationType", "MibIdentifier", "Counter32", "enterprises", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobResult=backupJobResult, backupJobName=backupJobName, traps=traps, vmName=vmName, cdpMaxDelay=cdpMaxDelay, onWebDownloadStart=onWebDownloadStart, backupJobId=backupJobId, initiatorName=initiatorName, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, cdpSla=cdpSla, sessionId=sessionId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, extentName=extentName, cdpPolicyName=cdpPolicyName, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, onVmBackupCompleted=onVmBackupCompleted, repositoryName=repositoryName, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorSid=initiatorSid, transferFileList=transferFileList, csvReportFilePath=csvReportFilePath, notTransferFileList=notTransferFileList, extentStatus=extentStatus, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, products=products, veeam=veeam, extentStatusList=extentStatusList, onSobrOffloadFinished=onSobrOffloadFinished, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryStatus=repositoryStatus, cdpRpoStatus=cdpRpoStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusEntry=extentStatusEntry, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, backupJobComment=backupJobComment, backup=backup)
