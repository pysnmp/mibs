...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:16:04 2022
...
Gauge32, NotificationType, MibIdentifier, TimeTicks, Integer32, IpAddress, iso, Unsigned32, enterprises, Bits, Counter32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "MibIdentifier", "TimeTicks", "Integer32", "IpAddress", "iso", "Unsigned32", "enterprises", "Bits", "Counter32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, extentStatusList=extentStatusList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatus=extentStatus, cdpSla=cdpSla, sourceHostName=sourceHostName, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorSid=initiatorSid, backupJobId=backupJobId, repositoryName=repositoryName, vmRestorePointId=vmRestorePointId, extentName=extentName, veeam=veeam, targetDir=targetDir, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, backup=backup, repositoryId=repositoryId, traps=traps, vmName=vmName, vmBackupComment=vmBackupComment, transferStatus=transferStatus, cdpPolicyName=cdpPolicyName, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, backupJobResult=backupJobResult, sessionId=sessionId, initiatorName=initiatorName, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, repositoryStatus=repositoryStatus, onVmBackupCompleted=onVmBackupCompleted, targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult, onBackupJobCompleted=onBackupJobCompleted, cdpMaxDelay=cdpMaxDelay, products=products, backupJobName=backupJobName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted)
