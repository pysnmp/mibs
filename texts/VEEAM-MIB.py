...
iso, Gauge32, Bits, IpAddress, ObjectIdentity, TimeTicks, Counter32, Integer32, Unsigned32, ModuleIdentity, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Bits", "IpAddress", "ObjectIdentity", "TimeTicks", "Counter32", "Integer32", "Unsigned32", "ModuleIdentity", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("VEEAM-MIB", initiatorSid=initiatorSid, vmBackupComment=vmBackupComment, extentName=extentName, repositoryName=repositoryName, transferFileList=transferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, notTransferFileList=notTransferFileList, backupJobName=backupJobName, veeam=veeam, cdpRpoThreshold=cdpRpoThreshold, sourceHostName=sourceHostName, onWebDownloadStart=onWebDownloadStart, targetHost=targetHost, repositoryId=repositoryId, vmBackupResult=vmBackupResult, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, csvReportFilePath=csvReportFilePath, backupJobResult=backupJobResult, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmName=vmName, vmRestorePointCreationTime=vmRestorePointCreationTime, onVmBackupCompleted=onVmBackupCompleted, products=products, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, traps=traps, sessionId=sessionId, initiatorName=initiatorName, transferStatus=transferStatus, backupJobId=backupJobId, cdpSla=cdpSla, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusList=extentStatusList, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, mountServerName=mountServerName, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, transferTime=transferTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatus=extentStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backup=backup, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted)
