...
Gauge32, Bits, NotificationType, Integer32, Counter64, ModuleIdentity, Counter32, NotificationType, MibIdentifier, enterprises, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "NotificationType", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "NotificationType", "MibIdentifier", "enterprises", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", notTransferFileList=notTransferFileList, backupJobId=backupJobId, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, backupJobName=backupJobName, onWebDownloadStart=onWebDownloadStart, sessionId=sessionId, vmRestorePointId=vmRestorePointId, mountServerName=mountServerName, backup=backup, backupJobComment=backupJobComment, vmBackupResult=vmBackupResult, repositoryName=repositoryName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryStatus=repositoryStatus, onVmBackupCompleted=onVmBackupCompleted, sourceHostName=sourceHostName, traps=traps, transferStatus=transferStatus, targetDir=targetDir, cdpRpoThreshold=cdpRpoThreshold, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, initiatorSid=initiatorSid, transferFileList=transferFileList, cdpSla=cdpSla, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentName=extentName, onWinFLRMountStarted=onWinFLRMountStarted, transferTime=transferTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpPolicyName=cdpPolicyName, veeam=veeam, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, products=products, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryId=repositoryId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, extentStatus=extentStatus, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorName=initiatorName, backupJobResult=backupJobResult, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted)
