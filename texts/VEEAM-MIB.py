...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:57:57 2022
...
ObjectIdentity, NotificationType, Counter64, Unsigned32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter32, MibIdentifier, TimeTicks, iso, NotificationType, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter32", "MibIdentifier", "TimeTicks", "iso", "NotificationType", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", initiatorSid=initiatorSid, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointId=vmRestorePointId, cdpMaxDelay=cdpMaxDelay, sessionId=sessionId, repositoryStatus=repositoryStatus, backupJobName=backupJobName, transferFileList=transferFileList, veeam=veeam, backupJobId=backupJobId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sourceHostName=sourceHostName, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupComment=vmBackupComment, traps=traps, initiatorName=initiatorName, backupJobResult=backupJobResult, cdpPolicyName=cdpPolicyName, transferStatus=transferStatus, cdpSla=cdpSla, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferTime=transferTime, extentStatus=extentStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backup=backup, cdpRpoThreshold=cdpRpoThreshold, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentName=extentName, products=products, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, targetHost=targetHost, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath, vmName=vmName, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, repositoryName=repositoryName, extentStatusList=extentStatusList, notTransferFileList=notTransferFileList, mountServerName=mountServerName, backupJobComment=backupJobComment, cdpRpoStatus=cdpRpoStatus)
