...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:26:00 2023
...
enterprises, NotificationType, IpAddress, Counter32, ModuleIdentity, Gauge32, Counter64, NotificationType, Bits, ObjectIdentity, TimeTicks, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "IpAddress", "Counter32", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, initiatorSid=initiatorSid, cdpMaxDelay=cdpMaxDelay, targetHost=targetHost, cdpRpoThreshold=cdpRpoThreshold, onCdpRpoReport=onCdpRpoReport, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, veeam=veeam, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, backupJobResult=backupJobResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, transferTime=transferTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferStatus=transferStatus, products=products, csvReportFilePath=csvReportFilePath, targetDir=targetDir, extentStatus=extentStatus, onWebDownloadStart=onWebDownloadStart, vmName=vmName, extentStatusList=extentStatusList, transferFileList=transferFileList, extentName=extentName, repositoryId=repositoryId, backup=backup, onWinFLRMountStarted=onWinFLRMountStarted, cdpSla=cdpSla, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorName=initiatorName, backupJobId=backupJobId, backupJobName=backupJobName, extentStatusEntry=extentStatusEntry, repositoryName=repositoryName, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, mountServerName=mountServerName, traps=traps, sessionId=sessionId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished)
