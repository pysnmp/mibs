...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:38:49 2022
...
TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, Gauge32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Counter32, iso, enterprises, NotificationType, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Counter32", "iso", "enterprises", "NotificationType", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, backupJobResult=backupJobResult, backupJobName=backupJobName, targetHost=targetHost, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, vmBackupComment=vmBackupComment, vmBackupResult=vmBackupResult, extentName=extentName, targetDir=targetDir, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, traps=traps, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, backupJobId=backupJobId, products=products, sessionId=sessionId, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, onVmBackupCompleted=onVmBackupCompleted, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, extentStatusList=extentStatusList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, backup=backup, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sourceHostName=sourceHostName, transferTime=transferTime, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, repositoryId=repositoryId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpRpoStatus=cdpRpoStatus, initiatorSid=initiatorSid, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryStatus=repositoryStatus, cdpPolicyName=cdpPolicyName, veeam=veeam)
