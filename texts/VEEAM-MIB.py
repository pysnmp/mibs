...
ObjectIdentity, TimeTicks, NotificationType, Gauge32, ModuleIdentity, Bits, iso, Unsigned32, NotificationType, IpAddress, MibIdentifier, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "Gauge32", "ModuleIdentity", "Bits", "iso", "Unsigned32", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("VEEAM-MIB", onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmName=vmName, transferFileList=transferFileList, extentName=extentName, veeam=veeam, transferStatus=transferStatus, targetDir=targetDir, csvReportFilePath=csvReportFilePath, notTransferFileList=notTransferFileList, transferTime=transferTime, cdpRpoStatus=cdpRpoStatus, backupJobComment=backupJobComment, repositoryName=repositoryName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, sessionId=sessionId, extentStatusList=extentStatusList, sourceHostName=sourceHostName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, backupJobId=backupJobId, extentStatusEntry=extentStatusEntry, products=products, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, cdpPolicyName=cdpPolicyName, onWebDownloadStart=onWebDownloadStart, onSobrOffloadFinished=onSobrOffloadFinished, extentStatus=extentStatus, onCdpRpoReport=onCdpRpoReport, mountServerName=mountServerName, initiatorSid=initiatorSid, traps=traps, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, backupJobName=backupJobName, vmRestorePointId=vmRestorePointId, vmBackupResult=vmBackupResult, backup=backup, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, repositoryStatus=repositoryStatus, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
