...
iso, TimeTicks, IpAddress, Bits, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter64, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "Bits", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter64", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobId=backupJobId, backupJobName=backupJobName, backupJobResult=backupJobResult, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, traps=traps, vmName=vmName, initiatorSid=initiatorSid, extentStatusList=extentStatusList, vmRestorePointId=vmRestorePointId, vmBackupResult=vmBackupResult, repositoryId=repositoryId, backupJobComment=backupJobComment, transferStatus=transferStatus, extentName=extentName, cdpMaxDelay=cdpMaxDelay, veeam=veeam, onVmBackupCompleted=onVmBackupCompleted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpPolicyName=cdpPolicyName, notTransferFileList=notTransferFileList, repositoryName=repositoryName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpSla=cdpSla, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, mountServerName=mountServerName, csvReportFilePath=csvReportFilePath, onWebDownloadFinished=onWebDownloadFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, products=products, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadStart=onWebDownloadStart, vmBackupComment=vmBackupComment, cdpRpoStatus=cdpRpoStatus, sourceHostName=sourceHostName, transferTime=transferTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backup=backup, onCdpRpoReport=onCdpRpoReport, initiatorName=initiatorName, transferFileList=transferFileList, targetDir=targetDir, sessionId=sessionId, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry)
