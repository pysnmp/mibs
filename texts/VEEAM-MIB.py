...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, IpAddress, TimeTicks, NotificationType, iso, MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, Counter32, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "IpAddress", "TimeTicks", "NotificationType", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", backup=backup, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, veeam=veeam, vmBackupResult=vmBackupResult, sessionId=sessionId, traps=traps, backupJobResult=backupJobResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, transferTime=transferTime, cdpPolicyName=cdpPolicyName, backupJobComment=backupJobComment, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, onWinFLRMountStarted=onWinFLRMountStarted, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatus=extentStatus, extentStatusEntry=extentStatusEntry, onSobrOffloadFinished=onSobrOffloadFinished, onVmBackupCompleted=onVmBackupCompleted, transferFileList=transferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, products=products, initiatorName=initiatorName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryName=repositoryName, notTransferFileList=notTransferFileList, extentName=extentName, backupJobName=backupJobName, mountServerName=mountServerName, onWebDownloadFinished=onWebDownloadFinished, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, extentStatusList=extentStatusList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sourceHostName=sourceHostName, transferStatus=transferStatus, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpSla=cdpSla, vmBackupComment=vmBackupComment, onWebDownloadStart=onWebDownloadStart, repositoryId=repositoryId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmName=vmName, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetHost=targetHost, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
