...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:02:50 2024
...
enterprises, Counter32, Unsigned32, MibIdentifier, NotificationType, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Counter64, Bits, Gauge32, IpAddress, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Unsigned32", "MibIdentifier", "NotificationType", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Counter64", "Bits", "Gauge32", "IpAddress", "iso", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, csvReportFilePath=csvReportFilePath, transferFileList=transferFileList, backupJobResult=backupJobResult, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, targetDir=targetDir, traps=traps, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, veeam=veeam, extentStatusEntry=extentStatusEntry, extentName=extentName, sessionId=sessionId, mountServerName=mountServerName, repositoryStatus=repositoryStatus, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, vmBackupComment=vmBackupComment, cdpSla=cdpSla, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmName=vmName, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, vmBackupResult=vmBackupResult, initiatorName=initiatorName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorSid=initiatorSid, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, backupJobName=backupJobName, transferTime=transferTime, extentStatus=extentStatus, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobComment=backupJobComment, backup=backup, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, vmRestorePointId=vmRestorePointId, products=products, transferStatus=transferStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryId=repositoryId, extentStatusList=extentStatusList, backupJobId=backupJobId, repositoryName=repositoryName, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus)
