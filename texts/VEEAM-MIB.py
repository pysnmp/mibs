...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:42:18 2021
...
mibBuilder.exportSymbols("VEEAM-MIB", csvReportFilePath=csvReportFilePath, cdpMaxDelay=cdpMaxDelay, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferTime=transferTime, transferStatus=transferStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, mountServerName=mountServerName, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, products=products, transferFileList=transferFileList, vmName=vmName, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupResult=vmBackupResult, veeam=veeam, extentStatusList=extentStatusList, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobResult=backupJobResult, traps=traps, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sessionId=sessionId, extentName=extentName, backupJobComment=backupJobComment, sourceHostName=sourceHostName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryStatus=repositoryStatus, extentStatus=extentStatus, cdpRpoStatus=cdpRpoStatus, repositoryName=repositoryName, backup=backup, backupJobId=backupJobId, initiatorName=initiatorName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRMountStarted=onWinFLRMountStarted, cdpSla=cdpSla, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpRpoThreshold=cdpRpoThreshold, extentStatusEntry=extentStatusEntry, targetDir=targetDir, onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, repositoryId=repositoryId, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, cdpPolicyName=cdpPolicyName, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, onBackupJobCompleted=onBackupJobCompleted, vmBackupComment=vmBackupComment)
