...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter32, IpAddress, NotificationType, iso, Unsigned32, ObjectIdentity, Integer32, Gauge32, Counter64, MibIdentifier, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter32", "IpAddress", "NotificationType", "iso", "Unsigned32", "ObjectIdentity", "Integer32", "Gauge32", "Counter64", "MibIdentifier", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobId=backupJobId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobName=backupJobName, backup=backup, transferStatus=transferStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, veeam=veeam, extentStatusList=extentStatusList, cdpSla=cdpSla, cdpRpoStatus=cdpRpoStatus, repositoryStatus=repositoryStatus, repositoryName=repositoryName, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, sourceHostName=sourceHostName, extentStatusEntry=extentStatusEntry, extentStatus=extentStatus, cdpMaxDelay=cdpMaxDelay, traps=traps, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, mountServerName=mountServerName, cdpRpoThreshold=cdpRpoThreshold, vmBackupResult=vmBackupResult, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, transferFileList=transferFileList, initiatorSid=initiatorSid, onWebDownloadFinished=onWebDownloadFinished, vmBackupComment=vmBackupComment, initiatorName=initiatorName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobResult=backupJobResult, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, extentName=extentName, products=products, targetDir=targetDir, sessionId=sessionId, cdpPolicyName=cdpPolicyName, targetHost=targetHost, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointId=vmRestorePointId, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, notTransferFileList=notTransferFileList, csvReportFilePath=csvReportFilePath)
