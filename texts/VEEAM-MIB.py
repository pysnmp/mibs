...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:26:23 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", traps=traps, cdpMaxDelay=cdpMaxDelay, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferFileList=transferFileList, targetDir=targetDir, backupJobComment=backupJobComment, cdpPolicyName=cdpPolicyName, targetHost=targetHost, backup=backup, backupJobResult=backupJobResult, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferTime=transferTime, backupJobId=backupJobId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorSid=initiatorSid, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, repositoryName=repositoryName, extentName=extentName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, vmBackupComment=vmBackupComment, repositoryId=repositoryId, sourceHostName=sourceHostName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, onVmBackupCompleted=onVmBackupCompleted, csvReportFilePath=csvReportFilePath, vmName=vmName, cdpRpoThreshold=cdpRpoThreshold, sessionId=sessionId, repositoryStatus=repositoryStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobName=backupJobName, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, products=products, onBackupJobCompleted=onBackupJobCompleted, veeam=veeam, extentStatus=extentStatus, cdpSla=cdpSla, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, mountServerName=mountServerName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusList=extentStatusList, notTransferFileList=notTransferFileList, onWinFLRMountStarted=onWinFLRMountStarted)
