...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:27:54 2021
...
MibIdentifier, Counter64, Counter32, TimeTicks, NotificationType, ModuleIdentity, iso, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, IpAddress, Bits, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Counter32", "TimeTicks", "NotificationType", "ModuleIdentity", "iso", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "IpAddress", "Bits", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentName=extentName, onBackupJobCompleted=onBackupJobCompleted, onVmBackupCompleted=onVmBackupCompleted, onWinFLRMountStarted=onWinFLRMountStarted, transferStatus=transferStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryName=repositoryName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, products=products, backupJobResult=backupJobResult, backup=backup, vmBackupComment=vmBackupComment, targetDir=targetDir, transferTime=transferTime, extentStatusEntry=extentStatusEntry, extentStatusList=extentStatusList, sessionId=sessionId, initiatorSid=initiatorSid, repositoryStatus=repositoryStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, cdpRpoStatus=cdpRpoStatus, backupJobId=backupJobId, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryId=repositoryId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpMaxDelay=cdpMaxDelay, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, mountServerName=mountServerName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpSla=cdpSla, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmName=vmName, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, traps=traps, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, targetHost=targetHost, extentStatus=extentStatus, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, vmRestorePointId=vmRestorePointId)
