...
ObjectIdentity, MibIdentifier, Integer32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter64, TimeTicks, Counter32, IpAddress, iso, NotificationType, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Integer32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter64", "TimeTicks", "Counter32", "IpAddress", "iso", "NotificationType", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobComment=backupJobComment, extentStatus=extentStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, repositoryId=repositoryId, extentStatusEntry=extentStatusEntry, transferTime=transferTime, traps=traps, veeam=veeam, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadFinished=onWebDownloadFinished, transferStatus=transferStatus, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, backupJobId=backupJobId, vmBackupResult=vmBackupResult, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, mountServerName=mountServerName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpSla=cdpSla, products=products, initiatorName=initiatorName, cdpRpoStatus=cdpRpoStatus, transferFileList=transferFileList, onWebDownloadStart=onWebDownloadStart, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobResult=backupJobResult, onBackupJobCompleted=onBackupJobCompleted, vmName=vmName, vmBackupComment=vmBackupComment, initiatorSid=initiatorSid, backupJobName=backupJobName, vmRestorePointId=vmRestorePointId, targetDir=targetDir, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpMaxDelay=cdpMaxDelay, onCdpRpoReport=onCdpRpoReport, repositoryName=repositoryName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusList=extentStatusList, cdpPolicyName=cdpPolicyName, backup=backup, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished)
