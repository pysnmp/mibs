...
Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter64, iso, ModuleIdentity, TimeTicks, Gauge32, NotificationType, ObjectIdentity, Counter32, IpAddress, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter64", "iso", "ModuleIdentity", "TimeTicks", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "IpAddress", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, sourceHostName=sourceHostName, targetHost=targetHost, transferFileList=transferFileList, onSobrOffloadFinished=onSobrOffloadFinished, transferTime=transferTime, cdpRpoStatus=cdpRpoStatus, repositoryId=repositoryId, vmRestorePointId=vmRestorePointId, vmBackupComment=vmBackupComment, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, extentName=extentName, sessionId=sessionId, traps=traps, backupJobComment=backupJobComment, transferStatus=transferStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, products=products, initiatorSid=initiatorSid, backup=backup, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatus=extentStatus, backupJobId=backupJobId, backupJobResult=backupJobResult, onWebDownloadFinished=onWebDownloadFinished, onBackupJobCompleted=onBackupJobCompleted, csvReportFilePath=csvReportFilePath, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatusList=extentStatusList, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, backupJobName=backupJobName, vmName=vmName, repositoryName=repositoryName, initiatorName=initiatorName, veeam=veeam, notTransferFileList=notTransferFileList, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, onVmBackupCompleted=onVmBackupCompleted, extentStatusEntry=extentStatusEntry, repositoryStatus=repositoryStatus)
