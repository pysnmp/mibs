...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:12:52 2024
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupResult=vmBackupResult, onWinFLRMountStarted=onWinFLRMountStarted, extentStatusList=extentStatusList, notTransferFileList=notTransferFileList, transferFileList=transferFileList, mountServerName=mountServerName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, sourceHostName=sourceHostName, vmRestorePointId=vmRestorePointId, cdpPolicyName=cdpPolicyName, onCdpRpoReport=onCdpRpoReport, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobName=backupJobName, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, targetDir=targetDir, traps=traps, onWebDownloadStart=onWebDownloadStart, repositoryStatus=repositoryStatus, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatusEntry=extentStatusEntry, vmBackupComment=vmBackupComment, onWebDownloadFinished=onWebDownloadFinished, cdpRpoStatus=cdpRpoStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, initiatorSid=initiatorSid, backupJobId=backupJobId, products=products, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sessionId=sessionId, onBackupJobCompleted=onBackupJobCompleted, transferStatus=transferStatus, transferTime=transferTime, cdpSla=cdpSla, extentStatus=extentStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backup=backup, backupJobResult=backupJobResult, extentName=extentName, targetHost=targetHost, initiatorName=initiatorName, repositoryName=repositoryName, repositoryId=repositoryId)
