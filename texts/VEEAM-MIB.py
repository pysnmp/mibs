...
Gauge32, Unsigned32, Integer32, IpAddress, enterprises, iso, MibIdentifier, NotificationType, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Counter64, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Integer32", "IpAddress", "enterprises", "iso", "MibIdentifier", "NotificationType", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobComment=backupJobComment, onVmBackupCompleted=onVmBackupCompleted, repositoryStatus=repositoryStatus, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryName=repositoryName, vmBackupComment=vmBackupComment, extentStatusList=extentStatusList, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryId=repositoryId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWebDownloadStart=onWebDownloadStart, veeam=veeam, vmBackupResult=vmBackupResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, cdpMaxDelay=cdpMaxDelay, transferTime=transferTime, onWinFLRMountStarted=onWinFLRMountStarted, initiatorName=initiatorName, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, traps=traps, vmRestorePointId=vmRestorePointId, targetDir=targetDir, cdpPolicyName=cdpPolicyName, backupJobName=backupJobName, extentStatus=extentStatus, backupJobResult=backupJobResult, transferFileList=transferFileList, onCdpRpoReport=onCdpRpoReport, extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, targetHost=targetHost, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorSid=initiatorSid, onLinuxFLRMountStarted=onLinuxFLRMountStarted, csvReportFilePath=csvReportFilePath, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, backup=backup, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentName=extentName, sessionId=sessionId)
