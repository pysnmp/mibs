...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:54:41 2022
...
IpAddress, enterprises, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ModuleIdentity, ObjectIdentity, NotificationType, NotificationType, Counter32, Unsigned32, MibIdentifier, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ModuleIdentity", "ObjectIdentity", "NotificationType", "NotificationType", "Counter32", "Unsigned32", "MibIdentifier", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmName=vmName, cdpRpoThreshold=cdpRpoThreshold, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadFinished=onWebDownloadFinished, repositoryStatus=repositoryStatus, extentStatus=extentStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusEntry=extentStatusEntry, traps=traps, targetHost=targetHost, vmRestorePointId=vmRestorePointId, onVmBackupCompleted=onVmBackupCompleted, extentName=extentName, backup=backup, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferStatus=transferStatus, cdpPolicyName=cdpPolicyName, notTransferFileList=notTransferFileList, products=products, initiatorName=initiatorName, vmRestorePointCreationTime=vmRestorePointCreationTime, transferFileList=transferFileList, veeam=veeam, transferTime=transferTime, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, cdpRpoStatus=cdpRpoStatus, backupJobComment=backupJobComment, backupJobId=backupJobId, vmBackupComment=vmBackupComment, sessionId=sessionId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, repositoryName=repositoryName, backupJobName=backupJobName, targetDir=targetDir, extentStatusList=extentStatusList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadStart=onWebDownloadStart, initiatorSid=initiatorSid, sourceHostName=sourceHostName)
