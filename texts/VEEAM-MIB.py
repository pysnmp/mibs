...
# Produced by pysmi-1.1.8 at Thu Sep 29 09:02:06 2022
...
Counter32, Integer32, iso, Bits, Unsigned32, ObjectIdentity, IpAddress, NotificationType, Counter64, MibIdentifier, Gauge32, ModuleIdentity, enterprises, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "iso", "Bits", "Unsigned32", "ObjectIdentity", "IpAddress", "NotificationType", "Counter64", "MibIdentifier", "Gauge32", "ModuleIdentity", "enterprises", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, csvReportFilePath=csvReportFilePath, vmBackupComment=vmBackupComment, cdpSla=cdpSla, repositoryStatus=repositoryStatus, transferStatus=transferStatus, backupJobId=backupJobId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onCdpRpoReport=onCdpRpoReport, extentStatus=extentStatus, extentName=extentName, vmRestorePointId=vmRestorePointId, veeam=veeam, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay, targetHost=targetHost, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmName=vmName, cdpRpoThreshold=cdpRpoThreshold, onBackupJobCompleted=onBackupJobCompleted, sessionId=sessionId, mountServerName=mountServerName, cdpPolicyName=cdpPolicyName, vmRestorePointCreationTime=vmRestorePointCreationTime, targetDir=targetDir, backupJobName=backupJobName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onWinFLRMountStarted=onWinFLRMountStarted, repositoryName=repositoryName, sourceHostName=sourceHostName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, products=products, extentStatusList=extentStatusList, backupJobComment=backupJobComment, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, traps=traps, initiatorSid=initiatorSid, transferTime=transferTime, transferFileList=transferFileList, backup=backup, extentStatusEntry=extentStatusEntry, initiatorName=initiatorName, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, notTransferFileList=notTransferFileList, repositoryId=repositoryId, onVmBackupCompleted=onVmBackupCompleted)
