...
NotificationType, iso, Counter32, MibIdentifier, Integer32, Counter64, enterprises, Bits, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter32", "MibIdentifier", "Integer32", "Counter64", "enterprises", "Bits", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onCdpRpoReport=onCdpRpoReport, onVmBackupCompleted=onVmBackupCompleted, traps=traps, onWebDownloadFinished=onWebDownloadFinished, extentStatusEntry=extentStatusEntry, vmName=vmName, extentStatus=extentStatus, backupJobId=backupJobId, backupJobResult=backupJobResult, transferFileList=transferFileList, sourceHostName=sourceHostName, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, products=products, vmBackupResult=vmBackupResult, extentName=extentName, veeam=veeam, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetHost=targetHost, mountServerName=mountServerName, sessionId=sessionId, transferTime=transferTime, cdpMaxDelay=cdpMaxDelay, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryStatus=repositoryStatus, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, onBackupJobCompleted=onBackupJobCompleted, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onSobrOffloadFinished=onSobrOffloadFinished, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusList=extentStatusList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetDir=targetDir, transferStatus=transferStatus, initiatorSid=initiatorSid, backupJobName=backupJobName, backup=backup)
