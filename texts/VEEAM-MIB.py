...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Unsigned32, Gauge32, enterprises, iso, ModuleIdentity, Counter64, MibIdentifier, Bits, NotificationType, NotificationType, Counter32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Unsigned32", "Gauge32", "enterprises", "iso", "ModuleIdentity", "Counter64", "MibIdentifier", "Bits", "NotificationType", "NotificationType", "Counter32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentName=extentName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, vmBackupResult=vmBackupResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupComment=vmBackupComment, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, onSobrOffloadFinished=onSobrOffloadFinished, backupJobId=backupJobId, transferTime=transferTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, cdpRpoStatus=cdpRpoStatus, repositoryId=repositoryId, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, backup=backup, sessionId=sessionId, veeam=veeam, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatus=extentStatus, cdpSla=cdpSla, products=products, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, traps=traps, sourceHostName=sourceHostName, repositoryName=repositoryName, extentStatusList=extentStatusList, extentStatusEntry=extentStatusEntry, mountServerName=mountServerName, onWebDownloadFinished=onWebDownloadFinished, targetHost=targetHost, backupJobResult=backupJobResult, transferStatus=transferStatus, initiatorSid=initiatorSid, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, repositoryStatus=repositoryStatus, vmName=vmName, onLinuxFLRMountStarted=onLinuxFLRMountStarted)
