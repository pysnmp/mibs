...
NotificationType, Integer32, Unsigned32, Bits, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Unsigned32", "Bits", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatus=extentStatus, vmBackupResult=vmBackupResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupComment=vmBackupComment, transferTime=transferTime, cdpSla=cdpSla, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, sessionId=sessionId, backup=backup, initiatorName=initiatorName, targetDir=targetDir, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferFileList=transferFileList, repositoryName=repositoryName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, traps=traps, transferStatus=transferStatus, extentName=extentName, products=products, onWebDownloadStart=onWebDownloadStart, backupJobResult=backupJobResult, mountServerName=mountServerName, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, csvReportFilePath=csvReportFilePath, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusList=extentStatusList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, cdpRpoThreshold=cdpRpoThreshold, veeam=veeam, cdpPolicyName=cdpPolicyName, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay, sourceHostName=sourceHostName, targetHost=targetHost, backupJobName=backupJobName, onWinFLRMountStarted=onWinFLRMountStarted, extentStatusEntry=extentStatusEntry, initiatorSid=initiatorSid, repositoryId=repositoryId, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, backupJobComment=backupJobComment, vmRestorePointCreationTime=vmRestorePointCreationTime)
