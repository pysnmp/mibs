...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:47:50 2023
...
NotificationType, Counter64, NotificationType, iso, Gauge32, TimeTicks, Bits, ModuleIdentity, Counter32, ObjectIdentity, IpAddress, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "NotificationType", "iso", "Gauge32", "TimeTicks", "Bits", "ModuleIdentity", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryName=repositoryName, sourceHostName=sourceHostName, vmBackupResult=vmBackupResult, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, cdpPolicyName=cdpPolicyName, vmName=vmName, extentStatusList=extentStatusList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, extentStatus=extentStatus, traps=traps, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, products=products, sessionId=sessionId, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, repositoryId=repositoryId, repositoryStatus=repositoryStatus, cdpSla=cdpSla, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoStatus=cdpRpoStatus, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, onWinFLRCopyToFinished=onWinFLRCopyToFinished, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, backupJobComment=backupJobComment, cdpRpoThreshold=cdpRpoThreshold, initiatorSid=initiatorSid, onWinFLRMountStarted=onWinFLRMountStarted, veeam=veeam, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backup=backup, notTransferFileList=notTransferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, onBackupJobCompleted=onBackupJobCompleted, extentName=extentName, transferTime=transferTime, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobId=backupJobId, backupJobName=backupJobName)
