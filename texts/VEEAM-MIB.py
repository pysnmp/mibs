...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:48:22 2022
...
MibIdentifier, NotificationType, IpAddress, Gauge32, ModuleIdentity, Bits, NotificationType, enterprises, TimeTicks, Unsigned32, Integer32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "Bits", "NotificationType", "enterprises", "TimeTicks", "Unsigned32", "Integer32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetDir=targetDir, onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferFileList=transferFileList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentName=extentName, products=products, sourceHostName=sourceHostName, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onCdpRpoReport=onCdpRpoReport, repositoryId=repositoryId, targetHost=targetHost, backupJobComment=backupJobComment, notTransferFileList=notTransferFileList, cdpPolicyName=cdpPolicyName, onBackupJobCompleted=onBackupJobCompleted, extentStatus=extentStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatusEntry=extentStatusEntry, transferTime=transferTime, vmRestorePointCreationTime=vmRestorePointCreationTime, veeam=veeam, sessionId=sessionId, backupJobResult=backupJobResult, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, transferStatus=transferStatus, backup=backup, initiatorName=initiatorName, repositoryStatus=repositoryStatus, vmBackupComment=vmBackupComment, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobName=backupJobName, traps=traps, cdpSla=cdpSla, vmBackupResult=vmBackupResult, extentStatusList=extentStatusList, repositoryName=repositoryName, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, onSobrOffloadFinished=onSobrOffloadFinished, cdpMaxDelay=cdpMaxDelay)
