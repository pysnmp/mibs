...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:46:39 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", mountServerName=mountServerName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetDir=targetDir, repositoryId=repositoryId, veeam=veeam, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobResult=backupJobResult, repositoryName=repositoryName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onSobrOffloadFinished=onSobrOffloadFinished, products=products, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, notTransferFileList=notTransferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpPolicyName=cdpPolicyName, sessionId=sessionId, extentStatusList=extentStatusList, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, extentName=extentName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, initiatorSid=initiatorSid, onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferFileList=transferFileList, vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, traps=traps, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointId=vmRestorePointId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferStatus=transferStatus, backupJobId=backupJobId, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, sourceHostName=sourceHostName, cdpRpoStatus=cdpRpoStatus, transferTime=transferTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, vmBackupComment=vmBackupComment, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, initiatorName=initiatorName, extentStatusEntry=extentStatusEntry, backup=backup, onBackupJobCompleted=onBackupJobCompleted, cdpSla=cdpSla, vmBackupResult=vmBackupResult)
