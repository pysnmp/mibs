...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:59:29 2022
...
NotificationType, MibIdentifier, NotificationType, TimeTicks, Counter64, ModuleIdentity, Integer32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, enterprises, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64", "ModuleIdentity", "Integer32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "enterprises", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobId=backupJobId, transferTime=transferTime, repositoryId=repositoryId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatus=extentStatus, backupJobName=backupJobName, backupJobResult=backupJobResult, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, targetHost=targetHost, sourceHostName=sourceHostName, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, traps=traps, transferStatus=transferStatus, cdpSla=cdpSla, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpPolicyName=cdpPolicyName, csvReportFilePath=csvReportFilePath, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, repositoryName=repositoryName, extentName=extentName, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobComment=backupJobComment, onWebDownloadFinished=onWebDownloadFinished, cdpRpoStatus=cdpRpoStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusList=extentStatusList, onWebDownloadStart=onWebDownloadStart, sessionId=sessionId, vmName=vmName, products=products, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, onWinFLRMountStarted=onWinFLRMountStarted, notTransferFileList=notTransferFileList, vmRestorePointCreationTime=vmRestorePointCreationTime, mountServerName=mountServerName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onVmBackupCompleted=onVmBackupCompleted, repositoryStatus=repositoryStatus, backup=backup, onCdpRpoReport=onCdpRpoReport, transferFileList=transferFileList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted)
