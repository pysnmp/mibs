...
enterprises, Integer32, Unsigned32, MibIdentifier, ObjectIdentity, Counter32, iso, TimeTicks, Bits, NotificationType, NotificationType, Counter64, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "Bits", "NotificationType", "NotificationType", "Counter64", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, mountServerName=mountServerName, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, notTransferFileList=notTransferFileList, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, onWinFLRCopyToStarted=onWinFLRCopyToStarted, targetHost=targetHost, sessionId=sessionId, cdpSla=cdpSla, repositoryName=repositoryName, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, onWebDownloadStart=onWebDownloadStart, veeam=veeam, onBackupJobCompleted=onBackupJobCompleted, cdpPolicyName=cdpPolicyName, transferFileList=transferFileList, onWinFLRMountStarted=onWinFLRMountStarted, repositoryStatus=repositoryStatus, extentName=extentName, extentStatus=extentStatus, vmName=vmName, initiatorSid=initiatorSid, traps=traps, initiatorName=initiatorName, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, backupJobId=backupJobId, backup=backup, transferTime=transferTime, products=products, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, sourceHostName=sourceHostName, backupJobComment=backupJobComment, repositoryId=repositoryId, vmBackupResult=vmBackupResult, targetDir=targetDir)
