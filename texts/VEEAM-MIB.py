...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:55:54 2022
...
Integer32, Counter64, Counter32, IpAddress, Bits, TimeTicks, Gauge32, ModuleIdentity, Unsigned32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Counter32", "IpAddress", "Bits", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "enterprises", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryId=repositoryId, products=products, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferFileList=transferFileList, csvReportFilePath=csvReportFilePath, vmName=vmName, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, extentName=extentName, targetDir=targetDir, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, veeam=veeam, onWinFLRMountStarted=onWinFLRMountStarted, backup=backup, extentStatusEntry=extentStatusEntry, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, backupJobResult=backupJobResult, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, onCdpRpoReport=onCdpRpoReport, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay, vmBackupResult=vmBackupResult, extentStatus=extentStatus, vmRestorePointId=vmRestorePointId, backupJobId=backupJobId, backupJobName=backupJobName, transferTime=transferTime, sessionId=sessionId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorSid=initiatorSid, onLinuxFLRMountStarted=onLinuxFLRMountStarted, traps=traps, onWebDownloadStart=onWebDownloadStart, transferStatus=transferStatus, repositoryStatus=repositoryStatus, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoThreshold=cdpRpoThreshold, backupJobComment=backupJobComment)
