...
Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Counter64, MibIdentifier, NotificationType, ModuleIdentity, enterprises, Gauge32, TimeTicks, NotificationType, iso, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity", "enterprises", "Gauge32", "TimeTicks", "NotificationType", "iso", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpRpoStatus=cdpRpoStatus, backup=backup, initiatorName=initiatorName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, vmName=vmName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobResult=backupJobResult, vmRestorePointId=vmRestorePointId, products=products, sourceHostName=sourceHostName, repositoryId=repositoryId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, initiatorSid=initiatorSid, backupJobId=backupJobId, vmBackupComment=vmBackupComment, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmBackupResult=vmBackupResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onCdpRpoReport=onCdpRpoReport, transferTime=transferTime, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, extentStatusList=extentStatusList, extentName=extentName, onWebDownloadFinished=onWebDownloadFinished, transferStatus=transferStatus, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadStart=onWebDownloadStart, cdpPolicyName=cdpPolicyName, repositoryStatus=repositoryStatus, cdpRpoThreshold=cdpRpoThreshold, mountServerName=mountServerName, notTransferFileList=notTransferFileList, backupJobComment=backupJobComment, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, repositoryName=repositoryName, onSobrOffloadFinished=onSobrOffloadFinished, traps=traps, veeam=veeam, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, cdpSla=cdpSla)
