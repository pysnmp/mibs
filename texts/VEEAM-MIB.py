...
IpAddress, ModuleIdentity, Unsigned32, iso, Gauge32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, MibIdentifier, Integer32, NotificationType, TimeTicks, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Unsigned32", "iso", "Gauge32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks", "Counter64", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, backupJobId=backupJobId, backup=backup, vmBackupResult=vmBackupResult, mountServerName=mountServerName, repositoryId=repositoryId, products=products, backupJobComment=backupJobComment, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, onWebDownloadStart=onWebDownloadStart, targetHost=targetHost, transferTime=transferTime, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, cdpPolicyName=cdpPolicyName, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onCdpRpoReport=onCdpRpoReport, onBackupJobCompleted=onBackupJobCompleted, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, csvReportFilePath=csvReportFilePath, repositoryStatus=repositoryStatus, cdpSla=cdpSla, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, repositoryName=repositoryName, sessionId=sessionId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, traps=traps, vmName=vmName, targetDir=targetDir, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, initiatorSid=initiatorSid, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusList=extentStatusList, extentStatus=extentStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult)
