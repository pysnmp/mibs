...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:14:01 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, iso, Gauge32, Integer32, MibIdentifier, NotificationType, Counter64, Counter32, TimeTicks, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "iso", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "Counter64", "Counter32", "TimeTicks", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobName=backupJobName, targetHost=targetHost, extentStatusEntry=extentStatusEntry, onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, veeam=veeam, repositoryStatus=repositoryStatus, onWinFLRMountStarted=onWinFLRMountStarted, mountServerName=mountServerName, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobId=backupJobId, transferStatus=transferStatus, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, notTransferFileList=notTransferFileList, repositoryName=repositoryName, traps=traps, cdpSla=cdpSla, backupJobResult=backupJobResult, sessionId=sessionId, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorName=initiatorName, sourceHostName=sourceHostName, backup=backup, vmBackupComment=vmBackupComment, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, vmName=vmName, extentStatusList=extentStatusList, extentName=extentName, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupResult=vmBackupResult, cdpPolicyName=cdpPolicyName, backupJobComment=backupJobComment, repositoryId=repositoryId, csvReportFilePath=csvReportFilePath, transferFileList=transferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, cdpRpoThreshold=cdpRpoThreshold, onBackupJobCompleted=onBackupJobCompleted, products=products, extentStatus=extentStatus, transferTime=transferTime)
