...
Gauge32, MibIdentifier, NotificationType, TimeTicks, Integer32, NotificationType, ModuleIdentity, iso, Unsigned32, Counter32, IpAddress, Counter64, enterprises, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "NotificationType", "ModuleIdentity", "iso", "Unsigned32", "Counter32", "IpAddress", "Counter64", "enterprises", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir, repositoryId=repositoryId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentName=extentName, onBackupJobCompleted=onBackupJobCompleted, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, transferFileList=transferFileList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, extentStatusList=extentStatusList, backupJobId=backupJobId, vmName=vmName, targetHost=targetHost, onVmBackupCompleted=onVmBackupCompleted, cdpSla=cdpSla, onCdpRpoReport=onCdpRpoReport, csvReportFilePath=csvReportFilePath, sessionId=sessionId, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, repositoryName=repositoryName, onSobrOffloadFinished=onSobrOffloadFinished, extentStatus=extentStatus, notTransferFileList=notTransferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpPolicyName=cdpPolicyName, cdpMaxDelay=cdpMaxDelay, transferStatus=transferStatus, repositoryStatus=repositoryStatus, traps=traps, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobName=backupJobName, transferTime=transferTime, cdpRpoThreshold=cdpRpoThreshold, products=products, backupJobResult=backupJobResult, initiatorSid=initiatorSid, sourceHostName=sourceHostName, mountServerName=mountServerName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorName=initiatorName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmRestorePointId=vmRestorePointId, veeam=veeam, vmBackupResult=vmBackupResult)
