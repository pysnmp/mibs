...
iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Integer32, TimeTicks, IpAddress, Counter32, Counter64, NotificationType, NotificationType, ModuleIdentity, Bits, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Integer32", "TimeTicks", "IpAddress", "Counter32", "Counter64", "NotificationType", "NotificationType", "ModuleIdentity", "Bits", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusEntry=extentStatusEntry, repositoryId=repositoryId, backupJobName=backupJobName, mountServerName=mountServerName, traps=traps, sourceHostName=sourceHostName, backup=backup, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetHost=targetHost, repositoryName=repositoryName, cdpRpoStatus=cdpRpoStatus, extentStatusList=extentStatusList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobId=backupJobId, transferTime=transferTime, backupJobResult=backupJobResult, extentName=extentName, onWebDownloadFinished=onWebDownloadFinished, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, transferStatus=transferStatus, vmName=vmName, vmBackupResult=vmBackupResult, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorSid=initiatorSid, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, products=products, vmBackupComment=vmBackupComment, cdpSla=cdpSla, transferFileList=transferFileList, onWinFLRMountStarted=onWinFLRMountStarted, cdpPolicyName=cdpPolicyName, extentStatus=extentStatus, targetDir=targetDir, csvReportFilePath=csvReportFilePath)
