...
NotificationType, Counter64, NotificationType, enterprises, Integer32, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, Gauge32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "NotificationType", "enterprises", "Integer32", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Gauge32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentName=extentName, onBackupJobCompleted=onBackupJobCompleted, repositoryStatus=repositoryStatus, initiatorSid=initiatorSid, backup=backup, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryId=repositoryId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, backupJobComment=backupJobComment, onWebDownloadFinished=onWebDownloadFinished, cdpRpoStatus=cdpRpoStatus, products=products, cdpPolicyName=cdpPolicyName, backupJobId=backupJobId, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpRpoThreshold=cdpRpoThreshold, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, extentStatusEntry=extentStatusEntry, targetHost=targetHost, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath, vmRestorePointId=vmRestorePointId, traps=traps, transferStatus=transferStatus, vmBackupComment=vmBackupComment, repositoryName=repositoryName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onCdpRpoReport=onCdpRpoReport, transferTime=transferTime, backupJobName=backupJobName, sessionId=sessionId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorName=initiatorName, extentStatusList=extentStatusList, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadStart=onWebDownloadStart, notTransferFileList=notTransferFileList, veeam=veeam, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, mountServerName=mountServerName, transferFileList=transferFileList, extentStatus=extentStatus, vmName=vmName)
