...
Integer32, Counter64, Gauge32, Counter32, Unsigned32, enterprises, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, iso, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Gauge32", "Counter32", "Unsigned32", "enterprises", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointCreationTime=vmRestorePointCreationTime, vmBackupResult=vmBackupResult, cdpSla=cdpSla, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpMaxDelay=cdpMaxDelay, repositoryName=repositoryName, onBackupJobCompleted=onBackupJobCompleted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoThreshold=cdpRpoThreshold, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, backup=backup, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, sourceHostName=sourceHostName, targetDir=targetDir, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpPolicyName=cdpPolicyName, transferTime=transferTime, onCdpRpoReport=onCdpRpoReport, vmRestorePointId=vmRestorePointId, onSobrOffloadFinished=onSobrOffloadFinished, transferFileList=transferFileList, sessionId=sessionId, veeam=veeam, transferStatus=transferStatus, mountServerName=mountServerName, traps=traps, backupJobName=backupJobName, products=products, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, notTransferFileList=notTransferFileList, backupJobId=backupJobId, repositoryStatus=repositoryStatus, backupJobResult=backupJobResult, extentName=extentName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, initiatorName=initiatorName, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, repositoryId=repositoryId, extentStatus=extentStatus, extentStatusList=extentStatusList, onVmBackupCompleted=onVmBackupCompleted, initiatorSid=initiatorSid, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted)
