...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:08:05 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobResult=backupJobResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferTime=transferTime, vmRestorePointCreationTime=vmRestorePointCreationTime, veeam=veeam, products=products, repositoryId=repositoryId, cdpPolicyName=cdpPolicyName, onSobrOffloadFinished=onSobrOffloadFinished, extentStatus=extentStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, transferStatus=transferStatus, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, onWebDownloadFinished=onWebDownloadFinished, repositoryName=repositoryName, backupJobName=backupJobName, vmName=vmName, targetDir=targetDir, initiatorName=initiatorName, mountServerName=mountServerName, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, backup=backup, repositoryStatus=repositoryStatus, targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, notTransferFileList=notTransferFileList, traps=traps, initiatorSid=initiatorSid, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, extentName=extentName, cdpRpoThreshold=cdpRpoThreshold, sessionId=sessionId, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, backupJobComment=backupJobComment, cdpRpoStatus=cdpRpoStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted)
