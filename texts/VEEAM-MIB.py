...
Bits, NotificationType, Counter32, Unsigned32, IpAddress, Gauge32, TimeTicks, ObjectIdentity, NotificationType, enterprises, ModuleIdentity, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "TimeTicks", "ObjectIdentity", "NotificationType", "enterprises", "ModuleIdentity", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", notTransferFileList=notTransferFileList, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryId=repositoryId, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, backupJobResult=backupJobResult, extentStatusEntry=extentStatusEntry, sessionId=sessionId, repositoryStatus=repositoryStatus, targetDir=targetDir, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorName=initiatorName, cdpSla=cdpSla, onWebDownloadFinished=onWebDownloadFinished, targetHost=targetHost, vmBackupResult=vmBackupResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentName=extentName, veeam=veeam, mountServerName=mountServerName, transferStatus=transferStatus, onCdpRpoReport=onCdpRpoReport, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, extentStatus=extentStatus, onWebDownloadStart=onWebDownloadStart, backupJobId=backupJobId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, transferTime=transferTime, onBackupJobCompleted=onBackupJobCompleted, repositoryName=repositoryName, products=products, backupJobComment=backupJobComment, sourceHostName=sourceHostName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorSid=initiatorSid, cdpPolicyName=cdpPolicyName, backup=backup, traps=traps, cdpMaxDelay=cdpMaxDelay, transferFileList=transferFileList, onVmBackupCompleted=onVmBackupCompleted, extentStatusList=extentStatusList)
