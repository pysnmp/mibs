...
NotificationType, Counter32, ModuleIdentity, iso, enterprises, Counter64, Integer32, Gauge32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, IpAddress, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ModuleIdentity", "iso", "enterprises", "Counter64", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "IpAddress", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, initiatorName=initiatorName, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatus=extentStatus, onCdpRpoReport=onCdpRpoReport, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, onWebDownloadStart=onWebDownloadStart, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, initiatorSid=initiatorSid, vmBackupComment=vmBackupComment, transferTime=transferTime, traps=traps, targetHost=targetHost, backup=backup, vmBackupResult=vmBackupResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferStatus=transferStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryId=repositoryId, vmName=vmName, repositoryStatus=repositoryStatus, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobResult=backupJobResult, backupJobComment=backupJobComment, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, onSobrOffloadFinished=onSobrOffloadFinished, extentName=extentName, csvReportFilePath=csvReportFilePath, onLinuxFLRMountStarted=onLinuxFLRMountStarted, sourceHostName=sourceHostName, targetDir=targetDir, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, sessionId=sessionId, transferFileList=transferFileList, backupJobId=backupJobId, repositoryName=repositoryName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, extentStatusEntry=extentStatusEntry, onBackupJobCompleted=onBackupJobCompleted, cdpSla=cdpSla)
