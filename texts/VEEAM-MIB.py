...
enterprises, iso, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, Bits, Gauge32, Counter64, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "Counter64", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadFinished=onWebDownloadFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, extentName=extentName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, backupJobName=backupJobName, backupJobId=backupJobId, extentStatus=extentStatus, transferStatus=transferStatus, onWinFLRMountStarted=onWinFLRMountStarted, backupJobResult=backupJobResult, transferFileList=transferFileList, notTransferFileList=notTransferFileList, onWebDownloadStart=onWebDownloadStart, vmBackupComment=vmBackupComment, repositoryId=repositoryId, extentStatusList=extentStatusList, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, initiatorName=initiatorName, vmRestorePointId=vmRestorePointId, mountServerName=mountServerName, onVmBackupCompleted=onVmBackupCompleted, targetHost=targetHost, vmBackupResult=vmBackupResult, cdpSla=cdpSla, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusEntry=extentStatusEntry, cdpRpoStatus=cdpRpoStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, traps=traps, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, vmName=vmName, cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, backup=backup, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorSid=initiatorSid, sessionId=sessionId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpRpoThreshold=cdpRpoThreshold, targetDir=targetDir, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sourceHostName=sourceHostName, veeam=veeam)
