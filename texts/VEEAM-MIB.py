...
TimeTicks, Bits, IpAddress, enterprises, Unsigned32, ObjectIdentity, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, iso, Counter64, ModuleIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "IpAddress", "enterprises", "Unsigned32", "ObjectIdentity", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobResult=backupJobResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, mountServerName=mountServerName, cdpPolicyName=cdpPolicyName, repositoryId=repositoryId, backupJobName=backupJobName, onBackupJobCompleted=onBackupJobCompleted, backupJobComment=backupJobComment, sourceHostName=sourceHostName, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, vmRestorePointId=vmRestorePointId, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentName=extentName, extentStatus=extentStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupResult=vmBackupResult, sessionId=sessionId, repositoryStatus=repositoryStatus, backup=backup, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime, onWebDownloadFinished=onWebDownloadFinished, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, vmName=vmName, transferFileList=transferFileList, traps=traps, cdpSla=cdpSla, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpMaxDelay=cdpMaxDelay, repositoryName=repositoryName, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, transferTime=transferTime, notTransferFileList=notTransferFileList, targetDir=targetDir, extentStatusList=extentStatusList, extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, targetHost=targetHost, initiatorSid=initiatorSid)
