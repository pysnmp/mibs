...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter64, Gauge32, enterprises, Integer32, Unsigned32, Counter32, TimeTicks, IpAddress, MibIdentifier, Bits, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter64", "Gauge32", "enterprises", "Integer32", "Unsigned32", "Counter32", "TimeTicks", "IpAddress", "MibIdentifier", "Bits", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, initiatorSid=initiatorSid, onVmBackupCompleted=onVmBackupCompleted, transferTime=transferTime, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, traps=traps, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, initiatorName=initiatorName, cdpSla=cdpSla, onCdpRpoReport=onCdpRpoReport, extentStatus=extentStatus, backupJobResult=backupJobResult, targetHost=targetHost, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusEntry=extentStatusEntry, veeam=veeam, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, csvReportFilePath=csvReportFilePath, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, repositoryStatus=repositoryStatus, vmName=vmName, notTransferFileList=notTransferFileList, targetDir=targetDir, repositoryName=repositoryName, onBackupJobCompleted=onBackupJobCompleted, cdpRpoThreshold=cdpRpoThreshold, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupComment=vmBackupComment, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, mountServerName=mountServerName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpRpoStatus=cdpRpoStatus, backupJobComment=backupJobComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentName=extentName, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, sessionId=sessionId, cdpMaxDelay=cdpMaxDelay, repositoryId=repositoryId, backup=backup, products=products)
