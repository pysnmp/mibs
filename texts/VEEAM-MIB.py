...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:44:48 2023
...
MibIdentifier, iso, NotificationType, NotificationType, Gauge32, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Integer32, enterprises, Bits, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Integer32", "enterprises", "Bits", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onVmBackupCompleted=onVmBackupCompleted, csvReportFilePath=csvReportFilePath, vmBackupComment=vmBackupComment, initiatorName=initiatorName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, transferStatus=transferStatus, mountServerName=mountServerName, extentStatusList=extentStatusList, repositoryStatus=repositoryStatus, onCdpRpoReport=onCdpRpoReport, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, cdpRpoStatus=cdpRpoStatus, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, onWebDownloadFinished=onWebDownloadFinished, sessionId=sessionId, transferFileList=transferFileList, backup=backup, onWinFLRMountStarted=onWinFLRMountStarted, repositoryName=repositoryName, backupJobResult=backupJobResult, notTransferFileList=notTransferFileList, cdpPolicyName=cdpPolicyName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryId=repositoryId, extentStatus=extentStatus, vmRestorePointId=vmRestorePointId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetDir=targetDir, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorSid=initiatorSid, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, traps=traps, veeam=veeam, backupJobId=backupJobId, products=products, vmName=vmName, sourceHostName=sourceHostName, backupJobName=backupJobName, vmBackupResult=vmBackupResult, targetHost=targetHost, cdpSla=cdpSla, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpRpoThreshold=cdpRpoThreshold)
