...
# Produced by pysmi-1.1.8 at Thu Oct 26 12:25:09 2023
...
Counter32, Bits, iso, enterprises, ModuleIdentity, Unsigned32, ObjectIdentity, NotificationType, Counter64, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "iso", "enterprises", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "NotificationType", "Counter64", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, cdpMaxDelay=cdpMaxDelay, vmRestorePointId=vmRestorePointId, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, notTransferFileList=notTransferFileList, initiatorSid=initiatorSid, cdpRpoStatus=cdpRpoStatus, repositoryName=repositoryName, extentStatus=extentStatus, backupJobId=backupJobId, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, mountServerName=mountServerName, transferStatus=transferStatus, extentName=extentName, vmBackupResult=vmBackupResult, targetDir=targetDir, backup=backup, initiatorName=initiatorName, backupJobName=backupJobName, csvReportFilePath=csvReportFilePath, backupJobComment=backupJobComment, transferTime=transferTime, repositoryStatus=repositoryStatus, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, repositoryId=repositoryId, cdpRpoThreshold=cdpRpoThreshold, products=products, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, traps=traps, vmName=vmName, onWebDownloadStart=onWebDownloadStart, transferFileList=transferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, veeam=veeam, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onBackupJobCompleted=onBackupJobCompleted, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, targetHost=targetHost, backupJobResult=backupJobResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
