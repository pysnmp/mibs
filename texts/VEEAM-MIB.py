...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:34:42 2023
...
iso, ObjectIdentity, NotificationType, TimeTicks, Counter32, ModuleIdentity, enterprises, NotificationType, Gauge32, Integer32, Counter64, IpAddress, Unsigned32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "ModuleIdentity", "enterprises", "NotificationType", "Gauge32", "Integer32", "Counter64", "IpAddress", "Unsigned32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryName=repositoryName, sourceHostName=sourceHostName, notTransferFileList=notTransferFileList, cdpSla=cdpSla, vmBackupComment=vmBackupComment, onWinFLRMountStarted=onWinFLRMountStarted, onSobrOffloadFinished=onSobrOffloadFinished, cdpMaxDelay=cdpMaxDelay, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, veeam=veeam, cdpRpoStatus=cdpRpoStatus, backupJobComment=backupJobComment, traps=traps, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, extentStatus=extentStatus, cdpPolicyName=cdpPolicyName, mountServerName=mountServerName, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobName=backupJobName, transferTime=transferTime, targetDir=targetDir, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatusList=extentStatusList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferFileList=transferFileList, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetHost=targetHost, repositoryId=repositoryId, vmRestorePointId=vmRestorePointId, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport, extentStatusEntry=extentStatusEntry, initiatorSid=initiatorSid, initiatorName=initiatorName, transferStatus=transferStatus, backupJobId=backupJobId, backupJobResult=backupJobResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, cdpRpoThreshold=cdpRpoThreshold, products=products, onWebDownloadFinished=onWebDownloadFinished, backup=backup, vmName=vmName)
