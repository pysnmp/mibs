...
TimeTicks, ModuleIdentity, Unsigned32, Gauge32, IpAddress, Integer32, Bits, ObjectIdentity, NotificationType, iso, Counter32, Counter64, NotificationType, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Unsigned32", "Gauge32", "IpAddress", "Integer32", "Bits", "ObjectIdentity", "NotificationType", "iso", "Counter32", "Counter64", "NotificationType", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatus=extentStatus, veeam=veeam, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatusEntry=extentStatusEntry, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpMaxDelay=cdpMaxDelay, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, cdpPolicyName=cdpPolicyName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, vmBackupResult=vmBackupResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, mountServerName=mountServerName, onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir, cdpSla=cdpSla, onWinFLRMountStarted=onWinFLRMountStarted, transferStatus=transferStatus, backupJobName=backupJobName, onSobrOffloadFinished=onSobrOffloadFinished, onBackupJobCompleted=onBackupJobCompleted, sourceHostName=sourceHostName, extentName=extentName, notTransferFileList=notTransferFileList, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onCdpRpoReport=onCdpRpoReport, initiatorSid=initiatorSid, traps=traps, cdpRpoThreshold=cdpRpoThreshold, onWebDownloadStart=onWebDownloadStart, repositoryName=repositoryName, transferFileList=transferFileList, vmName=vmName, products=products, vmBackupComment=vmBackupComment, transferTime=transferTime, initiatorName=initiatorName, extentStatusList=extentStatusList, sessionId=sessionId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobId=backupJobId, targetHost=targetHost, backupJobResult=backupJobResult, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup)
