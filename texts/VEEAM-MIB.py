...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, MibIdentifier, ModuleIdentity, Counter64, Gauge32, TimeTicks, IpAddress, Counter32, Unsigned32, Integer32, iso, Bits, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "MibIdentifier", "ModuleIdentity", "Counter64", "Gauge32", "TimeTicks", "IpAddress", "Counter32", "Unsigned32", "Integer32", "iso", "Bits", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetDir=targetDir, mountServerName=mountServerName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, initiatorName=initiatorName, traps=traps, initiatorSid=initiatorSid, cdpMaxDelay=cdpMaxDelay, extentStatus=extentStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobName=backupJobName, extentStatusEntry=extentStatusEntry, products=products, cdpRpoThreshold=cdpRpoThreshold, onSobrOffloadFinished=onSobrOffloadFinished, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, vmBackupComment=vmBackupComment, transferFileList=transferFileList, backupJobComment=backupJobComment, repositoryName=repositoryName, backup=backup, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, veeam=veeam, extentStatusList=extentStatusList, onWebDownloadStart=onWebDownloadStart, extentName=extentName, vmBackupResult=vmBackupResult, onBackupJobCompleted=onBackupJobCompleted, repositoryId=repositoryId, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, sessionId=sessionId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, notTransferFileList=notTransferFileList, onCdpRpoReport=onCdpRpoReport, vmName=vmName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, transferTime=transferTime, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus)
