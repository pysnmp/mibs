...
enterprises, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, Unsigned32, Counter32, iso, TimeTicks, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "iso", "TimeTicks", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, lcdDaemon=lcdDaemon, system=system, dhcpLeaseHostname=dhcpLeaseHostname, trapDNSDaemon=trapDNSDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEntry=dhcpLeaseEntry, licenseExpiry=licenseExpiry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSize=dhcpPoolSize, haReplicationBinding=haReplicationBinding, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolEntry=dhcpPoolEntry, PYSNMP_MODULE_ID=adonis, licenseValid=licenseValid, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTPDaemon=trapTFTPDaemon, haService=haService, trapCommandServerDaemon=trapCommandServerDaemon, ha=ha, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpIP=dhcpIP, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, adonisObjects=adonisObjects, dhcpSubnetUsed=dhcpSubnetUsed, systemState=systemState, trapCommandServer=trapCommandServer, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIP=dhcpFixedIP, tftpDaemon=tftpDaemon, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, trapTFTP=trapTFTP, dnsStatsRecursion=dnsStatsRecursion, haServiceNodeType=haServiceNodeType, lcd=lcd, trapHA=trapHA, dhcp=dhcp, trapDHCP=trapDHCP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, systemDaemon=systemDaemon, dnsStatsReferral=dnsStatsReferral, dhcpStats=dhcpStats, dhcpPoolTable=dhcpPoolTable, dhcpConfig=dhcpConfig, dhcpDaemon=dhcpDaemon, tftp=tftp, dhcpDaemonRunning=dhcpDaemonRunning, dns=dns, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dnsStats=dnsStats, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetIP=dhcpSubnetIP)
