...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Unsigned32, Counter32, ModuleIdentity, IpAddress, iso, TimeTicks, MibIdentifier, NotificationType, Integer32, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Unsigned32", "Counter32", "ModuleIdentity", "IpAddress", "iso", "TimeTicks", "MibIdentifier", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemon=dhcpDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, dns=dns, dhcpFailOverState=dhcpFailOverState, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, dhcpSubnetTable=dhcpSubnetTable, tftp=tftp, dhcpLeaseTable=dhcpLeaseTable, lcd=lcd, PYSNMP_MODULE_ID=adonis, trapReplicationFailure=trapReplicationFailure, dnsDaemonRunning=dnsDaemonRunning, commandServer=commandServer, dhcp=dhcp, dhcpPoolStartIP=dhcpPoolStartIP, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, systemDaemon=systemDaemon, trapReplication=trapReplication, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, adonis=adonis, system=system, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, ha=ha, dhcpLeaseEntry=dhcpLeaseEntry, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemonRunning=tftpDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCP=trapDHCP, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsFailure=dnsStatsFailure, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, licenseExpiry=licenseExpiry, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapHA=trapHA, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolSize=dhcpPoolSize, dhcpStats=dhcpStats, dhcpIP=dhcpIP, systemState=systemState, trapDNS=trapDNS, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTP=trapTFTP, adonisObjects=adonisObjects, dnsStats=dnsStats, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetEntry=dhcpSubnetEntry, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonRunning=dhcpDaemonRunning)
