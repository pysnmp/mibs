...
Gauge32, Counter64, NotificationType, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, IpAddress, Integer32, ModuleIdentity, Unsigned32, Bits, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "NotificationType", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "IpAddress", "Integer32", "ModuleIdentity", "Unsigned32", "Bits", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsRecursion=dnsStatsRecursion, trapSystem=trapSystem, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIP=dhcpFixedIP, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, adonisTraps=adonisTraps, dnsDaemonRunning=dnsDaemonRunning, dnsDaemon=dnsDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, trapTFTP=trapTFTP, haReplicationBinding=haReplicationBinding, systemState=systemState, haService=haService, system=system, ha=ha, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisObjects=adonisObjects, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolEndIP=dhcpPoolEndIP, trapDNSDaemon=trapDNSDaemon, dhcpFailOverState=dhcpFailOverState, tftp=tftp, licenseExpiry=licenseExpiry, trapDNS=trapDNS, dhcpDaemon=dhcpDaemon, PYSNMP_MODULE_ID=adonis, trapDHCP=trapDHCP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dns=dns, trapCommandServer=trapCommandServer, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetTable=dhcpSubnetTable, dhcpIP=dhcpIP, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceRunning=haServiceRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, dhcpPoolTable=dhcpPoolTable, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcd=lcd, trapCommandServerDaemon=trapCommandServerDaemon, trapSystemDaemon=trapSystemDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcp=dhcp, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStats=dnsStats, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSize=dhcpPoolSize, commandServerDaemon=commandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEntry=dhcpPoolEntry, trapHA=trapHA, tftpDaemon=tftpDaemon, adonis=adonis, trapReplication=trapReplication, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, dhcpStats=dhcpStats, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHostname=dhcpLeaseHostname, trapDHCPDaemon=trapDHCPDaemon, systemDaemon=systemDaemon, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonRunning=dhcpDaemonRunning, dhcpConfig=dhcpConfig, lcdDaemon=lcdDaemon, dhcpPoolAlert=dhcpPoolAlert, trapReplicationFailure=trapReplicationFailure)
