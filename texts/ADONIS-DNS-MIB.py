...
MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter64, iso, Unsigned32, Bits, ObjectIdentity, Counter32, NotificationType, TimeTicks, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter64", "iso", "Unsigned32", "Bits", "ObjectIdentity", "Counter32", "NotificationType", "TimeTicks", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", ha=ha, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemon=dnsDaemon, trapReplicationFailure=trapReplicationFailure, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemon=tftpDaemon, trapReplication=trapReplication, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsReferral=dnsStatsReferral, trapHA=trapHA, dhcpLeaseHostname=dhcpLeaseHostname, trapDHCP=trapDHCP, commandServerDaemon=commandServerDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, licenseExpiry=licenseExpiry, haServiceNodeType=haServiceNodeType, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, adonisObjects=adonisObjects, trapSystem=trapSystem, dhcpLeaseBindState=dhcpLeaseBindState, tftp=tftp, trapSystemDaemon=trapSystemDaemon, dhcp=dhcp, dhcpDaemon=dhcpDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetMask=dhcpSubnetMask, trapCommandServer=trapCommandServer, dhcpPoolStartIP=dhcpPoolStartIP, adonisTraps=adonisTraps, haService=haService, dhcpLeaseTable=dhcpLeaseTable, system=system, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, dns=dns, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetAlert=dhcpSubnetAlert, adonis=adonis, systemDaemon=systemDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXRRSet=dnsStatsNXRRSet, haReplicationBinding=haReplicationBinding, dhcpFailOverState=dhcpFailOverState, systemState=systemState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetEntry=dhcpSubnetEntry, haServiceRunning=haServiceRunning, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, licenseValid=licenseValid, lcdDaemon=lcdDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsRecursion=dnsStatsRecursion, dhcpStats=dhcpStats, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolUsed=dhcpPoolUsed, commandServer=commandServer, PYSNMP_MODULE_ID=adonis, lcd=lcd, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress)
