...
Unsigned32, Integer32, Gauge32, ModuleIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Bits, TimeTicks, iso, enterprises, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Bits", "TimeTicks", "iso", "enterprises", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetSize=dhcpSubnetSize, tftpDaemon=tftpDaemon, haServiceNodeType=haServiceNodeType, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEntry=dhcpLeaseEntry, adonis=adonis, lcd=lcd, trapCommandServer=trapCommandServer, trapSystem=trapSystem, trapSystemDaemon=trapSystemDaemon, trapDNSDaemon=trapDNSDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpFailOverState=dhcpFailOverState, dnsDaemonRunning=dnsDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsSuccess=dnsStatsSuccess, dnsStatsFailure=dnsStatsFailure, systemDaemon=systemDaemon, dnsStats=dnsStats, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, systemState=systemState, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseBindState=dhcpLeaseBindState, trapReplication=trapReplication, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcp=dhcp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisTraps=adonisTraps, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolTable=dhcpPoolTable, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemon=commandServerDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplicationFailure=trapReplicationFailure, dhcpConfig=dhcpConfig, lcdDaemon=lcdDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolSize=dhcpPoolSize, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpIP=dhcpIP, dhcpSubnetIP=dhcpSubnetIP, dnsDaemon=dnsDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapTFTP=trapTFTP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHA=trapHA, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsNXDomain=dnsStatsNXDomain, ha=ha, dhcpPoolUsed=dhcpPoolUsed, commandServer=commandServer, system=system, licenseValid=licenseValid, tftp=tftp, dhcpStats=dhcpStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemonRunning=commandServerDaemonRunning, haReplicationBinding=haReplicationBinding, dnsStatsReferral=dnsStatsReferral, licenseExpiry=licenseExpiry, adonisObjects=adonisObjects, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemon=dhcpDaemon, dhcpFixedIP=dhcpFixedIP, dns=dns, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel)
