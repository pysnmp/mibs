...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFixedIPTable=dhcpFixedIPTable, licenseExpiry=licenseExpiry, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, dhcpFixedIP=dhcpFixedIP, dhcpDaemon=dhcpDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, ha=ha, trapHA=trapHA, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPEntry=dhcpFixedIPEntry, trapTFTP=trapTFTP, haReplicationBinding=haReplicationBinding, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemon=tftpDaemon, trapDNSDaemon=trapDNSDaemon, dns=dns, adonisObjects=adonisObjects, trapReplicationFailure=trapReplicationFailure, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, PYSNMP_MODULE_ID=adonis, dhcpPoolSize=dhcpPoolSize, tftp=tftp, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haServiceNodeType=haServiceNodeType, trapSystemDaemon=trapSystemDaemon, systemState=systemState, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetMask=dhcpSubnetMask, trapSystem=trapSystem, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, dhcpPoolEntry=dhcpPoolEntry, trapCommandServer=trapCommandServer, adonisTraps=adonisTraps, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, dhcp=dhcp, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, systemDaemon=systemDaemon, dhcpConfig=dhcpConfig, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, dhcpStats=dhcpStats, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, system=system, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNS=trapDNS, haServiceRunning=haServiceRunning, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolTable=dhcpPoolTable, dhcpSubnetSize=dhcpSubnetSize, trapDHCP=trapDHCP, commandServer=commandServer, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEndIP=dhcpPoolEndIP, adonis=adonis, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, lcd=lcd)
