...
IpAddress, Unsigned32, Counter32, Counter64, ModuleIdentity, NotificationType, MibIdentifier, ObjectIdentity, TimeTicks, Gauge32, iso, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Counter32", "Counter64", "ModuleIdentity", "NotificationType", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Gauge32", "iso", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolTable=dhcpPoolTable, dnsStatsSuccess=dnsStatsSuccess, dns=dns, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonis=adonis, dhcpSubnetEntry=dhcpSubnetEntry, licenseExpiry=licenseExpiry, dhcpFixedIP=dhcpFixedIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, trapSystemDaemon=trapSystemDaemon, dnsDaemon=dnsDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, system=system, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpConfig=dhcpConfig, haReplicationBinding=haReplicationBinding, trapHA=trapHA, dhcp=dhcp, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFailOverState=dhcpFailOverState, trapDHCPDaemon=trapDHCPDaemon, commandServer=commandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, haService=haService, lcdDaemon=lcdDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHostname=dhcpLeaseHostname, trapReplicationFailure=trapReplicationFailure, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemon=dhcpDaemon, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, trapSystem=trapSystem, tftp=tftp, systemDaemon=systemDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSize=dhcpPoolSize, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, adonisTraps=adonisTraps, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, adonisObjects=adonisObjects, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServer=trapCommandServer, dhcpPoolEntry=dhcpPoolEntry, dnsStatsFailure=dnsStatsFailure, dhcpIP=dhcpIP, lcd=lcd, haServiceRunning=haServiceRunning, dhcpFixedIPTable=dhcpFixedIPTable)
