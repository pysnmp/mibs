...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFailOverState=dhcpFailOverState, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, dhcpLeaseTable=dhcpLeaseTable, haReplicationBinding=haReplicationBinding, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonis=adonis, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCP=trapDHCP, dhcpPoolEndIP=dhcpPoolEndIP, trapSystemDaemon=trapSystemDaemon, haServiceNodeType=haServiceNodeType, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemonRunning=tftpDaemonRunning, trapCommandServer=trapCommandServer, licenseExpiry=licenseExpiry, trapTFTP=trapTFTP, dhcpSubnetAlert=dhcpSubnetAlert, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, PYSNMP_MODULE_ID=adonis, adonisObjects=adonisObjects, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemDaemon=systemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, trapDNSDaemon=trapDNSDaemon, trapCommandServerDaemon=trapCommandServerDaemon, lcd=lcd, dhcpStats=dhcpStats, dhcpPoolTable=dhcpPoolTable, ha=ha, dhcp=dhcp, lcdDaemon=lcdDaemon, adonisTraps=adonisTraps, haServiceRunning=haServiceRunning, dhcpPoolAlert=dhcpPoolAlert, commandServerDaemon=commandServerDaemon, tftpDaemon=tftpDaemon, systemState=systemState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIP=dhcpFixedIP, commandServer=commandServer, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, trapDNS=trapDNS, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHAServiceFailOver=trapHAServiceFailOver, dnsStats=dnsStats, system=system, licenseValid=licenseValid, dnsStatsSuccess=dnsStatsSuccess, dns=dns, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsReferral=dnsStatsReferral, dnsDaemonRunning=dnsDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemon=dnsDaemon, trapHA=trapHA, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, haService=haService)
