...
Counter64, MibIdentifier, ModuleIdentity, Bits, TimeTicks, iso, ObjectIdentity, Gauge32, NotificationType, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "ModuleIdentity", "Bits", "TimeTicks", "iso", "ObjectIdentity", "Gauge32", "NotificationType", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, dhcp=dhcp, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, system=system, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHA=trapHA, dhcpFailOverState=dhcpFailOverState, haServiceNodeType=haServiceNodeType, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcdDaemon=lcdDaemon, dhcpPoolUsed=dhcpPoolUsed, PYSNMP_MODULE_ID=adonis, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonRunning=dnsDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetSize=dhcpSubnetSize, trapDHCP=trapDHCP, trapTFTPDaemon=trapTFTPDaemon, adonisTraps=adonisTraps, dhcpIP=dhcpIP, trapSystemDaemon=trapSystemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, systemDaemon=systemDaemon, dnsStats=dnsStats, haReplicationBinding=haReplicationBinding, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseValid=licenseValid, commandServerDaemonRunning=commandServerDaemonRunning, systemState=systemState, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemon=dnsDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIP=dhcpFixedIP, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, haService=haService, dhcpDaemon=dhcpDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTP=trapTFTP, tftp=tftp, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, commandServer=commandServer, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, trapReplication=trapReplication, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dns=dns, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, trapDNS=trapDNS, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapSystem=trapSystem, licenseExpiry=licenseExpiry, lcd=lcd, trapReplicationFailure=trapReplicationFailure, dhcpPoolEndIP=dhcpPoolEndIP)
