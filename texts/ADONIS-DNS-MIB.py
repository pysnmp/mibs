...
Counter64, IpAddress, Unsigned32, iso, Gauge32, Bits, ModuleIdentity, Counter32, MibIdentifier, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Unsigned32", "iso", "Gauge32", "Bits", "ModuleIdentity", "Counter32", "MibIdentifier", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseBindState=dhcpLeaseBindState, licenseValid=licenseValid, systemState=systemState, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolSize=dhcpPoolSize, dhcpFixedIPEntry=dhcpFixedIPEntry, tftp=tftp, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEndTime=dhcpLeaseEndTime, tftpDaemon=tftpDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemon=dhcpDaemon, trapSystem=trapSystem, haReplicationBinding=haReplicationBinding, trapCommandServer=trapCommandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIP=dhcpFixedIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, haService=haService, dhcpLeaseTable=dhcpLeaseTable, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, trapHA=trapHA, dns=dns, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServer=commandServer, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetTable=dhcpSubnetTable, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetIP=dhcpSubnetIP, systemDaemon=systemDaemon, dhcpConfig=dhcpConfig, trapTFTP=trapTFTP, ha=ha, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, adonis=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, system=system, trapDNSDaemon=trapDNSDaemon, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, haServiceNodeType=haServiceNodeType, dnsDaemon=dnsDaemon, dnsStats=dnsStats, trapDHCP=trapDHCP, adonisObjects=adonisObjects, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFailOverState=dhcpFailOverState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetAlert=dhcpSubnetAlert, trapReplication=trapReplication, trapDNS=trapDNS, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsFailure=dnsStatsFailure, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapSystemDaemon=trapSystemDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, dhcp=dhcp, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpStats=dhcpStats, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemonRunning=tftpDaemonRunning)
