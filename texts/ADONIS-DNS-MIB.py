...
Counter32, Unsigned32, ModuleIdentity, Bits, enterprises, MibIdentifier, iso, TimeTicks, ObjectIdentity, IpAddress, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "ModuleIdentity", "Bits", "enterprises", "MibIdentifier", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolUsed=dhcpPoolUsed, haServiceNodeType=haServiceNodeType, trapCommandServer=trapCommandServer, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHA=trapHA, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemonRunning=commandServerDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, PYSNMP_MODULE_ID=adonis, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTP=trapTFTP, dhcp=dhcp, dhcpFailOverState=dhcpFailOverState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonisTraps=adonisTraps, dhcpLeaseBindState=dhcpLeaseBindState, haServiceRunning=haServiceRunning, systemState=systemState, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetMask=dhcpSubnetMask, trapReplication=trapReplication, adonis=adonis, dnsDaemon=dnsDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, dhcpPoolTable=dhcpPoolTable, trapDNS=trapDNS, tftp=tftp, dhcpPoolEntry=dhcpPoolEntry, lcdDaemon=lcdDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTable=dhcpLeaseTable, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetTable=dhcpSubnetTable, trapDHCP=trapDHCP, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetSize=dhcpSubnetSize, licenseExpiry=licenseExpiry, dns=dns, trapDNSDaemon=trapDNSDaemon, dhcpPoolStartIP=dhcpPoolStartIP, adonisObjects=adonisObjects, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, haReplicationBinding=haReplicationBinding, dnsStatsRecursion=dnsStatsRecursion, commandServerDaemon=commandServerDaemon, dhcpIP=dhcpIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, lcd=lcd, systemDaemon=systemDaemon, dnsStatsReferral=dnsStatsReferral, haService=haService, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, trapSystemDaemon=trapSystemDaemon, commandServer=commandServer, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolSize=dhcpPoolSize, dnsStats=dnsStats, ha=ha, dhcpFixedIPTable=dhcpFixedIPTable, dhcpConfig=dhcpConfig, trapSystem=trapSystem, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure)
