...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, enterprises, Integer32, IpAddress, Counter32, NotificationType, iso, ModuleIdentity, Bits, ObjectIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "enterprises", "Integer32", "IpAddress", "Counter32", "NotificationType", "iso", "ModuleIdentity", "Bits", "ObjectIdentity", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisObjects=adonisObjects, commandServer=commandServer, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapSystemDaemon=trapSystemDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, ha=ha, dhcpLeaseStartTime=dhcpLeaseStartTime, lcdDaemon=lcdDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, licenseExpiry=licenseExpiry, dhcpStats=dhcpStats, tftpDaemon=tftpDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, haReplicationBinding=haReplicationBinding, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonRunning=dhcpDaemonRunning, system=system, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpIP=dhcpIP, haServiceNodeType=haServiceNodeType, systemDaemon=systemDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftp=tftp, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCP=trapDHCP, dhcpPoolEndIP=dhcpPoolEndIP, trapSystem=trapSystem, dnsStatsNXDomain=dnsStatsNXDomain, trapDNS=trapDNS, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, trapCommandServer=trapCommandServer, dhcpSubnetEntry=dhcpSubnetEntry, trapHA=trapHA, dhcpLeaseEndTime=dhcpLeaseEndTime, systemState=systemState, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsRecursion=dnsStatsRecursion, trapDNSDaemon=trapDNSDaemon, trapHAServiceFailOver=trapHAServiceFailOver, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, adonis=adonis, trapReplication=trapReplication, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dhcpConfig=dhcpConfig, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisTraps=adonisTraps, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolUsed=dhcpPoolUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, dns=dns, dhcpDaemon=dhcpDaemon, dhcpPoolAlert=dhcpPoolAlert, lcd=lcd, dhcpFailOverState=dhcpFailOverState, licenseValid=licenseValid, dhcp=dhcp, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, haServiceRunning=haServiceRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, haService=haService, dnsStatsFailure=dnsStatsFailure)
