...
Counter64, ModuleIdentity, Integer32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, MibIdentifier, Counter32, Gauge32, enterprises, IpAddress, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "MibIdentifier", "Counter32", "Gauge32", "enterprises", "IpAddress", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolTable=dhcpPoolTable, trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, PYSNMP_MODULE_ID=adonis, haServiceNodeType=haServiceNodeType, dhcpDaemon=dhcpDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpIP=dhcpIP, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIP=dhcpFixedIP, dhcpPoolSize=dhcpPoolSize, trapSystem=trapSystem, dhcpLeaseEndTime=dhcpLeaseEndTime, haReplicationBinding=haReplicationBinding, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisTraps=adonisTraps, adonisObjects=adonisObjects, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonis=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dns=dns, lcdDaemon=lcdDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp, dhcpFailOverState=dhcpFailOverState, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStats=dnsStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDNSDaemon=trapDNSDaemon, dhcpSubnetIP=dhcpSubnetIP, haServiceRunning=haServiceRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemon=dnsDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, dhcpConfig=dhcpConfig, dhcpPoolEntry=dhcpPoolEntry, trapSystemDaemon=trapSystemDaemon, systemState=systemState, system=system, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplication=trapReplication, dhcpDaemonRunning=dhcpDaemonRunning, haService=haService, dhcpLeaseBindState=dhcpLeaseBindState, trapHA=trapHA, licenseExpiry=licenseExpiry, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, ha=ha, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServer=trapCommandServer, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolAlert=dhcpPoolAlert, trapDHCP=trapDHCP, dhcpStats=dhcpStats, licenseValid=licenseValid, trapReplicationFailure=trapReplicationFailure, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, systemDaemon=systemDaemon, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemon=tftpDaemon, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, tftp=tftp, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonRunning=dnsDaemonRunning, lcd=lcd, commandServerDaemon=commandServerDaemon, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, dnsStatsSuccess=dnsStatsSuccess)
