...
Unsigned32, TimeTicks, IpAddress, iso, NotificationType, Integer32, enterprises, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "IpAddress", "iso", "NotificationType", "Integer32", "enterprises", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter32", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsReferral=dnsStatsReferral, lcd=lcd, adonis=adonis, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCP=trapDHCP, dnsStatsFailure=dnsStatsFailure, dhcpSubnetTable=dhcpSubnetTable, dnsStats=dnsStats, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, systemDaemon=systemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolEndIP=dhcpPoolEndIP, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, dnsStatsSuccess=dnsStatsSuccess, dhcpConfig=dhcpConfig, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolSize=dhcpPoolSize, dhcp=dhcp, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemon=tftpDaemon, dhcpDaemon=dhcpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetIP=dhcpSubnetIP, lcdDaemon=lcdDaemon, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, dns=dns, trapCommandServerDaemon=trapCommandServerDaemon, haServiceNodeType=haServiceNodeType, trapTFTPDaemon=trapTFTPDaemon, trapCommandServer=trapCommandServer, tftp=tftp, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsRecursion=dnsStatsRecursion, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, commandServerDaemon=commandServerDaemon, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNSDaemon=trapDNSDaemon, dhcpPoolAlert=dhcpPoolAlert, tftpDaemonRunning=tftpDaemonRunning, licenseValid=licenseValid, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXDomain=dnsStatsNXDomain, system=system, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, trapTFTP=trapTFTP, trapSystem=trapSystem, systemState=systemState, commandServer=commandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haReplicationBinding=haReplicationBinding, haService=haService, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, ha=ha, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpStats=dhcpStats, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystemDaemon=trapSystemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry)
