...
Gauge32, Counter32, IpAddress, Counter64, Integer32, ModuleIdentity, enterprises, ObjectIdentity, Bits, TimeTicks, iso, MibIdentifier, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "IpAddress", "Counter64", "Integer32", "ModuleIdentity", "enterprises", "ObjectIdentity", "Bits", "TimeTicks", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftpDaemonRunning=tftpDaemonRunning, trapCommandServer=trapCommandServer, dhcpDaemon=dhcpDaemon, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseValid=licenseValid, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemon=dnsDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, haService=haService, trapDHCPDaemon=trapDHCPDaemon, trapHA=trapHA, dnsStatsRecursion=dnsStatsRecursion, haServiceNodeType=haServiceNodeType, commandServerDaemon=commandServerDaemon, trapDNS=trapDNS, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapReplication=trapReplication, dnsStats=dnsStats, system=system, haServiceRunning=haServiceRunning, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisObjects=adonisObjects, dhcpFailOverState=dhcpFailOverState, PYSNMP_MODULE_ID=adonis, dhcpPoolEntry=dhcpPoolEntry, dhcp=dhcp, trapTFTP=trapTFTP, systemDaemon=systemDaemon, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonis=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolTable=dhcpPoolTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystem=trapSystem, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, haReplicationBinding=haReplicationBinding, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIP=dhcpFixedIP, lcd=lcd, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetSize=dhcpSubnetSize, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolSize=dhcpPoolSize, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsFailure=dnsStatsFailure, dhcpPoolStartIP=dhcpPoolStartIP, licenseExpiry=licenseExpiry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, lcdDaemon=lcdDaemon, dns=dns, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServer=commandServer, trapDNSDaemon=trapDNSDaemon, dhcpPoolAlert=dhcpPoolAlert)
