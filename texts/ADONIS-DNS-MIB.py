...
ObjectIdentity, Integer32, TimeTicks, Unsigned32, Gauge32, enterprises, Bits, Counter32, MibIdentifier, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "TimeTicks", "Unsigned32", "Gauge32", "enterprises", "Bits", "Counter32", "MibIdentifier", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftp=tftp, dnsStatsReferral=dnsStatsReferral, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, dns=dns, tftpDaemon=tftpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, PYSNMP_MODULE_ID=adonis, lcdDaemon=lcdDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonis=adonis, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServer=commandServer, dnsDaemonRunning=dnsDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsStatsFailure=dnsStatsFailure, dhcpIP=dhcpIP, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemon=dhcpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetSize=dhcpSubnetSize, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, haReplicationBinding=haReplicationBinding, trapTFTP=trapTFTP, haServiceNodeType=haServiceNodeType, trapReplicationFailure=trapReplicationFailure, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetTable=dhcpSubnetTable, trapTFTPDaemon=trapTFTPDaemon, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisObjects=adonisObjects, dhcpPoolStartIP=dhcpPoolStartIP, licenseExpiry=licenseExpiry, trapHAServiceFailOver=trapHAServiceFailOver, dhcp=dhcp, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, system=system, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, adonisTraps=adonisTraps, trapReplication=trapReplication, trapSystem=trapSystem, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpConfig=dhcpConfig, trapHA=trapHA, dnsDaemon=dnsDaemon, dhcpStats=dhcpStats, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, dnsStats=dnsStats, lcd=lcd, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, ha=ha, commandServerDaemonRunning=commandServerDaemonRunning, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, systemDaemon=systemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseStartTime=dhcpLeaseStartTime)
