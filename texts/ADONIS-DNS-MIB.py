...
IpAddress, ModuleIdentity, Unsigned32, Integer32, enterprises, Counter64, MibIdentifier, Bits, NotificationType, Counter32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Unsigned32", "Integer32", "enterprises", "Counter64", "MibIdentifier", "Bits", "NotificationType", "Counter32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftp=tftp, trapSystemDaemon=trapSystemDaemon, dhcpIP=dhcpIP, system=system, trapDHCPDaemon=trapDHCPDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemon=dhcpDaemon, adonisTraps=adonisTraps, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, haServiceRunning=haServiceRunning, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, dnsStatsReferral=dnsStatsReferral, dnsDaemon=dnsDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, lcd=lcd, dnsStats=dnsStats, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapSystem=trapSystem, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, systemDaemon=systemDaemon, dns=dns, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseExpiry=licenseExpiry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, trapCommandServer=trapCommandServer, dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisObjects=adonisObjects, trapCommandServerDaemon=trapCommandServerDaemon, trapReplication=trapReplication, dhcp=dhcp, tftpDaemon=tftpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemState=systemState, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolTable=dhcpPoolTable, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDNSDaemon=trapDNSDaemon, haService=haService, dhcpSubnetIP=dhcpSubnetIP, adonis=adonis, dhcpSubnetUsed=dhcpSubnetUsed, commandServer=commandServer, ha=ha, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetMask=dhcpSubnetMask, haServiceNodeType=haServiceNodeType, dnsStatsFailure=dnsStatsFailure)
