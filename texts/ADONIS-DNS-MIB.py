...
Unsigned32, Integer32, Counter64, IpAddress, ObjectIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Counter32, Bits, MibIdentifier, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Counter64", "IpAddress", "ObjectIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Counter32", "Bits", "MibIdentifier", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpIP=dhcpIP, dhcp=dhcp, haReplicationBinding=haReplicationBinding, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemon=dhcpDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpStats=dhcpStats, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemon=commandServerDaemon, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, trapCommandServer=trapCommandServer, dhcpPoolUsed=dhcpPoolUsed, lcdDaemon=lcdDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetMask=dhcpSubnetMask, adonisObjects=adonisObjects, dns=dns, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haService=haService, trapDHCP=trapDHCP, haServiceNodeType=haServiceNodeType, system=system, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemon=dnsDaemon, lcd=lcd, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFailOverState=dhcpFailOverState, ha=ha, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServerDaemon=trapCommandServerDaemon, trapDNS=trapDNS, trapReplication=trapReplication, tftp=tftp, dnsStatsSuccess=dnsStatsSuccess, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolTable=dhcpPoolTable, trapSystem=trapSystem, adonis=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapHA=trapHA, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapTFTP=trapTFTP, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsReferral=dnsStatsReferral, systemState=systemState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetSize=dhcpSubnetSize, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, licenseValid=licenseValid, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolSize=dhcpPoolSize, systemDaemon=systemDaemon, dhcpSubnetTable=dhcpSubnetTable, trapSystemDaemon=trapSystemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStats=dnsStats, dhcpLeaseTable=dhcpLeaseTable, trapTFTPDaemon=trapTFTPDaemon, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, adonisTraps=adonisTraps, dhcpFixedIP=dhcpFixedIP)
