...
iso, ObjectIdentity, enterprises, IpAddress, Counter32, MibIdentifier, NotificationType, Integer32, Gauge32, TimeTicks, Unsigned32, Counter64, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "enterprises", "IpAddress", "Counter32", "MibIdentifier", "NotificationType", "Integer32", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolUsed=dhcpPoolUsed, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, trapDNS=trapDNS, dhcp=dhcp, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, lcd=lcd, dhcpFixedIP=dhcpFixedIP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapReplication=trapReplication, dnsStatsFailure=dnsStatsFailure, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystem=trapSystem, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTable=dhcpLeaseTable, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemon=dnsDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseHostname=dhcpLeaseHostname, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, trapHA=trapHA, dnsStatsSuccess=dnsStatsSuccess, dns=dns, trapCommandServer=trapCommandServer, tftp=tftp, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, ha=ha, dhcpSubnetIP=dhcpSubnetIP, dnsStats=dnsStats, dhcpIP=dhcpIP, adonisObjects=adonisObjects, trapSystemDaemon=trapSystemDaemon, commandServer=commandServer, licenseValid=licenseValid, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, dhcpSubnetEntry=dhcpSubnetEntry, systemState=systemState, dhcpDaemon=dhcpDaemon, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon, system=system, dhcpPoolTable=dhcpPoolTable, adonisTraps=adonisTraps, lcdDaemon=lcdDaemon, trapReplicationFailure=trapReplicationFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemDaemon=systemDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPTable=dhcpFixedIPTable, trapDNSDaemon=trapDNSDaemon, adonis=adonis, trapTFTP=trapTFTP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpStats=dhcpStats, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEntry=dhcpPoolEntry)
