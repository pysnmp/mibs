...
MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter64, iso, Unsigned32, enterprises, ModuleIdentity, Gauge32, NotificationType, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter64", "iso", "Unsigned32", "enterprises", "ModuleIdentity", "Gauge32", "NotificationType", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStats=dnsStats, dhcpSubnetSize=dhcpSubnetSize, haServiceRunning=haServiceRunning, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSize=dhcpPoolSize, system=system, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDNS=trapDNS, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetIP=dhcpSubnetIP, tftp=tftp, adonis=adonis, dhcpDaemon=dhcpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseStartTime=dhcpLeaseStartTime, ha=ha, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDHCPDaemon=trapDHCPDaemon, dnsStatsFailure=dnsStatsFailure, dhcp=dhcp, dhcpFailOverState=dhcpFailOverState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpConfig=dhcpConfig, dhcpLeaseTable=dhcpLeaseTable, trapTFTP=trapTFTP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplication=trapReplication, trapSystem=trapSystem, commandServerDaemon=commandServerDaemon, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, trapDNSDaemon=trapDNSDaemon, trapHA=trapHA, dns=dns, dhcpPoolTable=dhcpPoolTable, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetEntry=dhcpSubnetEntry, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftpDaemon=tftpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolUsed=dhcpPoolUsed, adonisTraps=adonisTraps, dhcpStats=dhcpStats, trapDHCP=trapDHCP, PYSNMP_MODULE_ID=adonis, lcdDaemon=lcdDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsReferral=dnsStatsReferral, licenseValid=licenseValid, lcd=lcd, licenseExpiry=licenseExpiry, dhcpFixedIP=dhcpFixedIP, haServiceNodeType=haServiceNodeType, dhcpDaemonRunning=dhcpDaemonRunning, systemDaemon=systemDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpIP=dhcpIP, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolAlert=dhcpPoolAlert, trapReplicationFailure=trapReplicationFailure, systemState=systemState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServer=commandServer, dnsDaemon=dnsDaemon, trapSystemDaemon=trapSystemDaemon, haReplicationBinding=haReplicationBinding, commandServerDaemonRunning=commandServerDaemonRunning)
