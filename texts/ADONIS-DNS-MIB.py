...
Bits, ObjectIdentity, Integer32, iso, enterprises, TimeTicks, Counter32, MibIdentifier, IpAddress, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Integer32", "iso", "enterprises", "TimeTicks", "Counter32", "MibIdentifier", "IpAddress", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemonRunning=tftpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, trapTFTP=trapTFTP, tftpDaemon=tftpDaemon, trapCommandServer=trapCommandServer, dhcpSubnetAlert=dhcpSubnetAlert, haServiceRunning=haServiceRunning, dnsStatsSuccess=dnsStatsSuccess, dnsStats=dnsStats, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetSize=dhcpSubnetSize, commandServer=commandServer, dhcpFixedIP=dhcpFixedIP, tftp=tftp, dhcpDaemon=dhcpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisObjects=adonisObjects, dhcp=dhcp, lcd=lcd, dnsDaemonRunning=dnsDaemonRunning, trapSystemDaemon=trapSystemDaemon, trapHA=trapHA, dhcpLeaseBindState=dhcpLeaseBindState, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFailOverState=dhcpFailOverState, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, dns=dns, systemDaemon=systemDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpStats=dhcpStats, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolStartIP=dhcpPoolStartIP, system=system, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpConfig=dhcpConfig, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseTable=dhcpLeaseTable, haServiceNodeType=haServiceNodeType, dnsStatsReferral=dnsStatsReferral, dhcpPoolEndIP=dhcpPoolEndIP, trapReplication=trapReplication, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, trapHAServiceFailOver=trapHAServiceFailOver, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemon=commandServerDaemon, dhcpLeaseHostname=dhcpLeaseHostname, trapDNSDaemon=trapDNSDaemon, licenseValid=licenseValid, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolTable=dhcpPoolTable, dhcpSubnetIP=dhcpSubnetIP, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, systemState=systemState, haReplicationBinding=haReplicationBinding, adonis=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSize=dhcpPoolSize, dnsStatsNXRRSet=dnsStatsNXRRSet)
