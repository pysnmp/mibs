...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpIP=dhcpIP, dhcpPoolEntry=dhcpPoolEntry, dnsStats=dnsStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, trapCommandServer=trapCommandServer, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, trapSystem=trapSystem, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, trapTFTPDaemon=trapTFTPDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNSDaemon=trapDNSDaemon, adonisTraps=adonisTraps, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNS=trapDNS, lcdDaemon=lcdDaemon, trapReplication=trapReplication, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, system=system, PYSNMP_MODULE_ID=adonis, dhcpStats=dhcpStats, haService=haService, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, dnsDaemon=dnsDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetAlert=dhcpSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonRunning=dnsDaemonRunning, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetSize=dhcpSubnetSize, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, trapReplicationFailure=trapReplicationFailure, dns=dns, trapTFTP=trapTFTP, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetEntry=dhcpSubnetEntry, dhcp=dhcp, haReplicationBinding=haReplicationBinding, dhcpSubnetUsed=dhcpSubnetUsed, systemDaemon=systemDaemon, trapHA=trapHA, ha=ha, tftpDaemon=tftpDaemon, dhcpDaemon=dhcpDaemon, dhcpConfig=dhcpConfig, commandServerDaemon=commandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemonRunning=tftpDaemonRunning, lcd=lcd, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHAServiceFailOver=trapHAServiceFailOver, adonis=adonis, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftp=tftp, dhcpSubnetMask=dhcpSubnetMask, dhcpFailOverState=dhcpFailOverState, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolTable=dhcpPoolTable, systemState=systemState, trapDHCP=trapDHCP)
