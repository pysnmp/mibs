...
enterprises, Bits, TimeTicks, ObjectIdentity, NotificationType, Counter64, iso, MibIdentifier, ModuleIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter64", "iso", "MibIdentifier", "ModuleIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNSDaemon=trapDNSDaemon, trapDNS=trapDNS, tftpDaemonRunning=tftpDaemonRunning, dhcpFailOverState=dhcpFailOverState, dnsStatsReferral=dnsStatsReferral, dhcp=dhcp, dhcpPoolTable=dhcpPoolTable, licenseValid=licenseValid, trapHA=trapHA, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServer=trapCommandServer, dns=dns, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, dnsStatsRecursion=dnsStatsRecursion, adonis=adonis, dhcpPoolEntry=dhcpPoolEntry, lcdDaemon=lcdDaemon, dnsDaemon=dnsDaemon, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemon=dhcpDaemon, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsFailure=dnsStatsFailure, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetMask=dhcpSubnetMask, haService=haService, dhcpLeaseStartTime=dhcpLeaseStartTime, systemState=systemState, adonisObjects=adonisObjects, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSize=dhcpPoolSize, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpConfig=dhcpConfig, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCPDaemon=trapDHCPDaemon, dhcpIP=dhcpIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseTable=dhcpLeaseTable, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, tftp=tftp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, lcd=lcd, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, ha=ha, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceNodeType=haServiceNodeType, trapReplication=trapReplication, system=system, licenseExpiry=licenseExpiry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFixedIP=dhcpFixedIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, systemDaemon=systemDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, adonisTraps=adonisTraps, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonRunning=dnsDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, trapSystem=trapSystem, commandServer=commandServer, dnsStatsSuccess=dnsStatsSuccess, trapReplicationFailure=trapReplicationFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetTable=dhcpSubnetTable)
