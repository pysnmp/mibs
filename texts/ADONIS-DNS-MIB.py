...
ObjectIdentity, Counter64, enterprises, Unsigned32, MibIdentifier, Integer32, iso, NotificationType, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "enterprises", "Unsigned32", "MibIdentifier", "Integer32", "iso", "NotificationType", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIP=dhcpFixedIP, dhcpSubnetSize=dhcpSubnetSize, ha=ha, tftpDaemonRunning=tftpDaemonRunning, dhcpFailOverState=dhcpFailOverState, trapTFTP=trapTFTP, dhcpSubnetIP=dhcpSubnetIP, licenseExpiry=licenseExpiry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, trapSystem=trapSystem, dhcpSubnetUsed=dhcpSubnetUsed, lcdDaemon=lcdDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolSize=dhcpPoolSize, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsNXRRSet=dnsStatsNXRRSet, haService=haService, adonis=adonis, dhcpPoolUsed=dhcpPoolUsed, lcd=lcd, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolTable=dhcpPoolTable, dhcpConfig=dhcpConfig, dhcp=dhcp, trapReplicationFailure=trapReplicationFailure, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, system=system, dhcpSubnetMask=dhcpSubnetMask, systemDaemon=systemDaemon, trapHA=trapHA, haServiceNodeType=haServiceNodeType, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemon=commandServerDaemon, trapCommandServer=trapCommandServer, trapReplication=trapReplication, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemon=dnsDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseEntry=dhcpLeaseEntry, adonisObjects=adonisObjects, dnsStatsReferral=dnsStatsReferral, dhcpStats=dhcpStats, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, dhcpDaemonRunning=dhcpDaemonRunning, systemState=systemState, trapDHCP=trapDHCP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsStats=dnsStats, trapSystemDaemon=trapSystemDaemon, dnsDaemonRunning=dnsDaemonRunning, dns=dns, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceRunning=haServiceRunning, commandServer=commandServer, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftp=tftp, tftpDaemon=tftpDaemon, dhcpIP=dhcpIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsFailure=dnsStatsFailure, dnsStatsSuccess=dnsStatsSuccess, adonisTraps=adonisTraps, haReplicationBinding=haReplicationBinding, dhcpLeaseEndTime=dhcpLeaseEndTime)
