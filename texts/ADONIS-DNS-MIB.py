...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsReferral=dnsStatsReferral, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCP=trapDHCP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftp=tftp, dhcpFailOverState=dhcpFailOverState, dhcpPoolUsed=dhcpPoolUsed, dnsDaemon=dnsDaemon, trapCommandServer=trapCommandServer, adonis=adonis, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, commandServerDaemon=commandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisObjects=adonisObjects, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetTable=dhcpSubnetTable, licenseValid=licenseValid, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetAlert=dhcpSubnetAlert, dhcp=dhcp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXDomain=dnsStatsNXDomain, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcd=lcd, haReplicationBinding=haReplicationBinding, lcdDaemon=lcdDaemon, dhcpDaemon=dhcpDaemon, trapHA=trapHA, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, trapDNSDaemon=trapDNSDaemon, trapSystem=trapSystem, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, trapReplicationFailure=trapReplicationFailure, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, ha=ha, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDHCPDaemon=trapDHCPDaemon, adonisTraps=adonisTraps, trapReplication=trapReplication, system=system, dhcpPoolAlert=dhcpPoolAlert, dnsStats=dnsStats, dhcpPoolSize=dhcpPoolSize, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsFailure=dnsStatsFailure, dhcpSubnetEntry=dhcpSubnetEntry, systemState=systemState, trapDNS=trapDNS, dhcpLeaseEndTime=dhcpLeaseEndTime, tftpDaemon=tftpDaemon, dhcpSubnetMask=dhcpSubnetMask, systemDaemon=systemDaemon, licenseExpiry=licenseExpiry, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, dhcpIP=dhcpIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServer=commandServer, dns=dns, dhcpSubnetIP=dhcpSubnetIP, haServiceNodeType=haServiceNodeType, haService=haService, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname)
