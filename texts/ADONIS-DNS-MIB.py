...
enterprises, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Unsigned32, ModuleIdentity, MibIdentifier, Counter32, NotificationType, Counter64, TimeTicks, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter32", "NotificationType", "Counter64", "TimeTicks", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDNSDaemon=trapDNSDaemon, commandServerDaemon=commandServerDaemon, haReplicationBinding=haReplicationBinding, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemon=tftpDaemon, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServer=trapCommandServer, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcp=dhcp, PYSNMP_MODULE_ID=adonis, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapReplicationFailure=trapReplicationFailure, trapDHCP=trapDHCP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetIP=dhcpSubnetIP, trapDNS=trapDNS, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseExpiry=licenseExpiry, dnsDaemon=dnsDaemon, adonisObjects=adonisObjects, dns=dns, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEndIP=dhcpPoolEndIP, dnsStats=dnsStats, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolEntry=dhcpPoolEntry, dhcpStats=dhcpStats, dnsStatsReferral=dnsStatsReferral, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseValid=licenseValid, dnsStatsNXDomain=dnsStatsNXDomain, haService=haService, systemDaemon=systemDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, ha=ha, dhcpIP=dhcpIP, dhcpDaemon=dhcpDaemon, trapSystem=trapSystem, dhcpPoolTable=dhcpPoolTable, dhcpFixedIP=dhcpFixedIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFailOverState=dhcpFailOverState, trapSystemDaemon=trapSystemDaemon, adonisTraps=adonisTraps, tftp=tftp, lcdDaemon=lcdDaemon, dnsDaemonRunning=dnsDaemonRunning, trapReplication=trapReplication, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetTable=dhcpSubnetTable, lcd=lcd, dhcpLeaseHostname=dhcpLeaseHostname, trapCommandServerDaemon=trapCommandServerDaemon, trapHA=trapHA, system=system, systemState=systemState, dhcpSubnetEntry=dhcpSubnetEntry, dhcpConfig=dhcpConfig, dnsStatsFailure=dnsStatsFailure, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haServiceNodeType=haServiceNodeType, adonis=adonis)
