...
enterprises, NotificationType, TimeTicks, Integer32, Unsigned32, ModuleIdentity, IpAddress, MibIdentifier, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "TimeTicks", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "MibIdentifier", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsReferral=dnsStatsReferral, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, trapReplicationFailure=trapReplicationFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetIP=dhcpSubnetIP, haService=haService, tftpDaemonRunning=tftpDaemonRunning, licenseValid=licenseValid, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftp=tftp, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceRunning=haServiceRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHA=trapHA, dhcpPoolTable=dhcpPoolTable, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcp=dhcp, dhcpConfig=dhcpConfig, PYSNMP_MODULE_ID=adonis, systemState=systemState, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dns=dns, adonis=adonis, dhcpPoolUsed=dhcpPoolUsed, system=system, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemon=tftpDaemon, dnsStats=dnsStats, trapReplication=trapReplication, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsRecursion=dnsStatsRecursion, adonisObjects=adonisObjects, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSize=dhcpPoolSize, trapDNS=trapDNS, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetAlert=dhcpSubnetAlert, haReplicationBinding=haReplicationBinding, dhcpSubnetSize=dhcpSubnetSize, dhcpIP=dhcpIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceNodeType=haServiceNodeType, commandServer=commandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemon=dhcpDaemon, lcd=lcd, dhcpFailOverState=dhcpFailOverState, trapTFTP=trapTFTP, trapCommandServer=trapCommandServer, dhcpFixedIP=dhcpFixedIP, trapDNSDaemon=trapDNSDaemon, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemon=commandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcdDaemon=lcdDaemon, ha=ha, trapCommandServerDaemon=trapCommandServerDaemon, systemDaemon=systemDaemon, adonisTraps=adonisTraps, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystem=trapSystem, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetTable=dhcpSubnetTable)
