...
Counter64, Integer32, Counter32, MibIdentifier, enterprises, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, IpAddress, Bits, ObjectIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Counter32", "MibIdentifier", "enterprises", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "IpAddress", "Bits", "ObjectIdentity", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolAlert=dhcpPoolAlert, dhcpPoolTable=dhcpPoolTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolEntry=dhcpPoolEntry, trapReplication=trapReplication, trapTFTP=trapTFTP, dhcpPoolSize=dhcpPoolSize, lcdDaemon=lcdDaemon, PYSNMP_MODULE_ID=adonis, adonisTraps=adonisTraps, dnsStatsNXDomain=dnsStatsNXDomain, haServiceRunning=haServiceRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haService=haService, trapDHCPDaemon=trapDHCPDaemon, dhcpStats=dhcpStats, adonis=adonis, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetSize=dhcpSubnetSize, dhcp=dhcp, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemon=dhcpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, systemDaemon=systemDaemon, trapCommandServer=trapCommandServer, dnsStats=dnsStats, commandServer=commandServer, licenseValid=licenseValid, commandServerDaemon=commandServerDaemon, trapReplicationFailure=trapReplicationFailure, adonisObjects=adonisObjects, trapHA=trapHA, trapSystemDaemon=trapSystemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, systemState=systemState, dhcpLeaseTable=dhcpLeaseTable, trapDHCP=trapDHCP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dns=dns, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonRunning=dnsDaemonRunning, ha=ha, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftp=tftp, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, system=system, dhcpPoolUsed=dhcpPoolUsed, tftpDaemon=tftpDaemon, dhcpLeaseEntry=dhcpLeaseEntry, licenseExpiry=licenseExpiry, dhcpFixedIP=dhcpFixedIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP)
