...
MibIdentifier, Gauge32, TimeTicks, Unsigned32, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, enterprises, ModuleIdentity, ObjectIdentity, Counter64, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "TimeTicks", "Unsigned32", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemonRunning=commandServerDaemonRunning, trapHA=trapHA, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, commandServerDaemon=commandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonRunning=dnsDaemonRunning, adonis=adonis, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseBindState=dhcpLeaseBindState, lcd=lcd, trapDNSDaemon=trapDNSDaemon, dhcpIP=dhcpIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, haReplicationBinding=haReplicationBinding, trapTFTP=trapTFTP, licenseValid=licenseValid, haServiceRunning=haServiceRunning, dhcpFixedIPTable=dhcpFixedIPTable, licenseExpiry=licenseExpiry, system=system, dhcpSubnetIP=dhcpSubnetIP, dnsDaemon=dnsDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStats=dnsStats, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolTable=dhcpPoolTable, dhcpFixedIP=dhcpFixedIP, trapTFTPDaemon=trapTFTPDaemon, dns=dns, trapDHCP=trapDHCP, systemState=systemState, dnsStatsReferral=dnsStatsReferral, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, adonisObjects=adonisObjects, dhcpFailOverState=dhcpFailOverState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, systemDaemon=systemDaemon, PYSNMP_MODULE_ID=adonis, trapCommandServer=trapCommandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolEntry=dhcpPoolEntry, lcdDaemon=lcdDaemon, haService=haService, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, ha=ha, dhcpPoolUsed=dhcpPoolUsed, trapDHCPDaemon=trapDHCPDaemon, tftp=tftp, dhcpLeaseHostname=dhcpLeaseHostname, trapSystemDaemon=trapSystemDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemon=dhcpDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpConfig=dhcpConfig, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, trapSystem=trapSystem, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcp=dhcp, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetEntry=dhcpSubnetEntry, dhcpStats=dhcpStats, dhcpDaemonRunning=dhcpDaemonRunning, adonisTraps=adonisTraps, trapDNS=trapDNS, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemon=tftpDaemon)
