...
IpAddress, NotificationType, Bits, MibIdentifier, enterprises, Gauge32, Unsigned32, ObjectIdentity, TimeTicks, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Bits", "MibIdentifier", "enterprises", "Gauge32", "Unsigned32", "ObjectIdentity", "TimeTicks", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, lcdDaemon=lcdDaemon, tftpDaemon=tftpDaemon, ha=ha, systemState=systemState, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, dhcpPoolAlert=dhcpPoolAlert, trapReplication=trapReplication, dhcpDaemonRunning=dhcpDaemonRunning, trapHA=trapHA, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, haServiceRunning=haServiceRunning, adonisTraps=adonisTraps, dhcpDaemon=dhcpDaemon, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemDaemon=systemDaemon, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServer=commandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, lcd=lcd, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetEntry=dhcpSubnetEntry, trapReplicationFailure=trapReplicationFailure, haServiceNodeType=haServiceNodeType, dhcpStats=dhcpStats, dhcpLeaseTable=dhcpLeaseTable, dhcpConfig=dhcpConfig, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTPDaemon=trapTFTPDaemon, tftp=tftp, dhcpFixedIP=dhcpFixedIP, haReplicationBinding=haReplicationBinding, dnsStatsNXRRSet=dnsStatsNXRRSet, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServer=trapCommandServer, dhcpFailOverState=dhcpFailOverState, trapSystem=trapSystem, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcp=dhcp, trapDHCP=trapDHCP, trapSystemDaemon=trapSystemDaemon, dhcpFixedIPTable=dhcpFixedIPTable, licenseValid=licenseValid, dnsDaemonRunning=dnsDaemonRunning, adonis=adonis, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapTFTP=trapTFTP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServerDaemon=commandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, dnsStatsRecursion=dnsStatsRecursion, dns=dns)
