...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, enterprises, NotificationType, ObjectIdentity, ModuleIdentity, Counter32, Bits, Counter64, MibIdentifier, TimeTicks, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "enterprises", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter32", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNSDaemon=trapDNSDaemon, trapHA=trapHA, dhcpLeaseHostname=dhcpLeaseHostname, haServiceNodeType=haServiceNodeType, dhcpFailOverState=dhcpFailOverState, dnsStats=dnsStats, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCP=trapDHCP, system=system, dhcpLeaseBindState=dhcpLeaseBindState, trapReplicationFailure=trapReplicationFailure, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsNXRRSet=dnsStatsNXRRSet, systemState=systemState, dhcpSubnetTable=dhcpSubnetTable, haService=haService, trapHAServiceFailOver=trapHAServiceFailOver, licenseValid=licenseValid, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapSystemDaemon=trapSystemDaemon, dhcpIP=dhcpIP, dhcpPoolTable=dhcpPoolTable, trapTFTP=trapTFTP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsFailure=dnsStatsFailure, dns=dns, dhcpPoolAlert=dhcpPoolAlert, dnsDaemon=dnsDaemon, dhcpSubnetAlert=dhcpSubnetAlert, lcdDaemon=lcdDaemon, tftpDaemonRunning=tftpDaemonRunning, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsReferral=dnsStatsReferral, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, dhcpFixedIP=dhcpFixedIP, tftpDaemon=tftpDaemon, licenseExpiry=licenseExpiry, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystem=trapSystem, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsSuccess=dnsStatsSuccess, lcd=lcd, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, systemDaemon=systemDaemon, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, dhcpLeaseTable=dhcpLeaseTable, adonisObjects=adonisObjects, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTPDaemon=trapTFTPDaemon, haServiceRunning=haServiceRunning, trapReplication=trapReplication, dhcpDaemon=dhcpDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpStats=dhcpStats, haReplicationBinding=haReplicationBinding, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, dhcp=dhcp, commandServer=commandServer, adonis=adonis)
