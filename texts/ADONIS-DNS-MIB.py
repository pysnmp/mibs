...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNSDaemon=trapDNSDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, dnsStats=dnsStats, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpConfig=dhcpConfig, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcp=dhcp, adonisObjects=adonisObjects, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolTable=dhcpPoolTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, haServiceRunning=haServiceRunning, dhcpPoolAlert=dhcpPoolAlert, dnsStatsSuccess=dnsStatsSuccess, adonis=adonis, trapHA=trapHA, trapReplication=trapReplication, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemState=systemState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetEntry=dhcpSubnetEntry, commandServer=commandServer, dhcpPoolStartIP=dhcpPoolStartIP, tftp=tftp, dnsDaemonRunning=dnsDaemonRunning, trapSystemDaemon=trapSystemDaemon, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, ha=ha, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, tftpDaemon=tftpDaemon, trapSystem=trapSystem, licenseExpiry=licenseExpiry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIP=dhcpFixedIP, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonRunning=dhcpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, haReplicationBinding=haReplicationBinding, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, PYSNMP_MODULE_ID=adonis, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHostname=dhcpLeaseHostname, trapTFTP=trapTFTP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpStats=dhcpStats, trapCommandServerDaemon=trapCommandServerDaemon, dns=dns, systemDaemon=systemDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServerDaemon=commandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, lcd=lcd, dhcpDaemon=dhcpDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNS=trapDNS, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, system=system, trapReplicationFailure=trapReplicationFailure, haServiceNodeType=haServiceNodeType, lcdDaemon=lcdDaemon, dhcpPoolSize=dhcpPoolSize, haService=haService, trapCommandServer=trapCommandServer, dnsStatsReferral=dnsStatsReferral, trapTFTPDaemon=trapTFTPDaemon, licenseValid=licenseValid)
