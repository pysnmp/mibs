...
Integer32, Gauge32, ModuleIdentity, Counter64, iso, Bits, ObjectIdentity, MibIdentifier, IpAddress, Unsigned32, TimeTicks, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "Counter64", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "IpAddress", "Unsigned32", "TimeTicks", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFixedIP=dhcpFixedIP, haServiceRunning=haServiceRunning, haReplicationBinding=haReplicationBinding, trapDNSDaemon=trapDNSDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolUsed=dhcpPoolUsed, dnsStats=dnsStats, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServer=commandServer, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, dnsStatsSuccess=dnsStatsSuccess, trapCommandServer=trapCommandServer, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, systemDaemon=systemDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcdDaemon=lcdDaemon, adonis=adonis, dhcpPoolSize=dhcpPoolSize, PYSNMP_MODULE_ID=adonis, dns=dns, trapReplicationFailure=trapReplicationFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemon=commandServerDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolTable=dhcpPoolTable, systemState=systemState, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolAlert=dhcpPoolAlert, licenseExpiry=licenseExpiry, adonisObjects=adonisObjects, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, dnsStatsReferral=dnsStatsReferral, trapTFTPDaemon=trapTFTPDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapReplication=trapReplication, adonisTraps=adonisTraps, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, trapHAServiceFailOver=trapHAServiceFailOver, dhcp=dhcp, lcd=lcd, haService=haService, tftpDaemon=tftpDaemon, tftp=tftp, dhcpSubnetMask=dhcpSubnetMask, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsFailure=dnsStatsFailure, dhcpStats=dhcpStats, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, system=system, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemon=dnsDaemon, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, trapSystem=trapSystem, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceNodeType=haServiceNodeType, licenseValid=licenseValid, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEndTime=dhcpLeaseEndTime)
