...
ObjectIdentity, Bits, Gauge32, Integer32, ModuleIdentity, iso, enterprises, TimeTicks, Unsigned32, IpAddress, Counter64, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Gauge32", "Integer32", "ModuleIdentity", "iso", "enterprises", "TimeTicks", "Unsigned32", "IpAddress", "Counter64", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNSDaemon=trapDNSDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapCommandServer=trapCommandServer, trapReplication=trapReplication, dhcpDaemon=dhcpDaemon, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dhcpIP=dhcpIP, haReplicationBinding=haReplicationBinding, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDHCP=trapDHCP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftp=tftp, dhcpPoolSize=dhcpPoolSize, dns=dns, trapDNS=trapDNS, dhcpStats=dhcpStats, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable, dhcpFailOverState=dhcpFailOverState, dhcpConfig=dhcpConfig, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, systemDaemon=systemDaemon, system=system, trapTFTP=trapTFTP, PYSNMP_MODULE_ID=adonis, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIP=dhcpFixedIP, tftpDaemon=tftpDaemon, dhcpSubnetSize=dhcpSubnetSize, lcd=lcd, dhcpPoolTable=dhcpPoolTable, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, haServiceNodeType=haServiceNodeType, haService=haService, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseValid=licenseValid, trapSystemDaemon=trapSystemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, dnsStats=dnsStats, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseBindState=dhcpLeaseBindState, lcdDaemon=lcdDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, adonisTraps=adonisTraps, systemState=systemState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapHA=trapHA, dnsDaemon=dnsDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapHAServiceFailOver=trapHAServiceFailOver, haServiceRunning=haServiceRunning, dhcpPoolUsed=dhcpPoolUsed, dnsStatsFailure=dnsStatsFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsReferral=dnsStatsReferral)
