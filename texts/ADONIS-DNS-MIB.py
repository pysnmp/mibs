...
Counter64, iso, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, ObjectIdentity, Bits, NotificationType, Gauge32, Unsigned32, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "ObjectIdentity", "Bits", "NotificationType", "Gauge32", "Unsigned32", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", system=system, dhcpPoolSize=dhcpPoolSize, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, dhcpStats=dhcpStats, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haService=haService, trapHA=trapHA, dnsDaemon=dnsDaemon, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, dns=dns, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemon=dhcpDaemon, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemonRunning=commandServerDaemonRunning, lcdDaemon=lcdDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpIP=dhcpIP, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetMask=dhcpSubnetMask, trapCommandServer=trapCommandServer, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetIP=dhcpSubnetIP, PYSNMP_MODULE_ID=adonis, ha=ha, adonis=adonis, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIP=dhcpFixedIP, haServiceRunning=haServiceRunning, dhcp=dhcp, dhcpSubnetEntry=dhcpSubnetEntry, trapDNS=trapDNS, tftpDaemonRunning=tftpDaemonRunning, dnsStatsFailure=dnsStatsFailure, trapSystem=trapSystem, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplication=trapReplication, systemDaemon=systemDaemon, haReplicationBinding=haReplicationBinding, commandServer=commandServer, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemon=commandServerDaemon, tftpDaemon=tftpDaemon, trapTFTPDaemon=trapTFTPDaemon, licenseValid=licenseValid, haServiceNodeType=haServiceNodeType, trapSystemDaemon=trapSystemDaemon, dhcpSubnetTable=dhcpSubnetTable, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, licenseExpiry=licenseExpiry, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseStartTime=dhcpLeaseStartTime, tftp=tftp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolTable=dhcpPoolTable, dhcpFailOverState=dhcpFailOverState, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsStats=dnsStats, adonisObjects=adonisObjects, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetAlert=dhcpSubnetAlert, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, adonisTraps=adonisTraps)
