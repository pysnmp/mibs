...
NotificationType, MibIdentifier, Counter32, iso, enterprises, Unsigned32, Gauge32, Counter64, TimeTicks, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter32", "iso", "enterprises", "Unsigned32", "Gauge32", "Counter64", "TimeTicks", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcd=lcd, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTP=trapTFTP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, systemDaemon=systemDaemon, trapReplication=trapReplication, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIP=dhcpFixedIP, trapCommandServerDaemon=trapCommandServerDaemon, dhcp=dhcp, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemon=dnsDaemon, dhcpFailOverState=dhcpFailOverState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpStats=dhcpStats, trapDHCP=trapDHCP, trapDNSDaemon=trapDNSDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haReplicationBinding=haReplicationBinding, trapCommandServer=trapCommandServer, haService=haService, lcdDaemon=lcdDaemon, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetMask=dhcpSubnetMask, adonisTraps=adonisTraps, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNS=trapDNS, tftpDaemon=tftpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, system=system, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemon=dhcpDaemon, haServiceRunning=haServiceRunning, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState, trapHAServiceFailOver=trapHAServiceFailOver, tftp=tftp, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpIP=dhcpIP, trapHA=trapHA, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolSize=dhcpPoolSize, commandServerDaemon=commandServerDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsFailure=dnsStatsFailure, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, adonis=adonis, trapTFTPDaemon=trapTFTPDaemon, adonisObjects=adonisObjects, dhcpSubnetSize=dhcpSubnetSize, dns=dns, trapSystemDaemon=trapSystemDaemon, trapSystem=trapSystem, dhcpConfig=dhcpConfig, commandServer=commandServer, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTable=dhcpLeaseTable, trapReplicationFailure=trapReplicationFailure, tftpDaemonRunning=tftpDaemonRunning)
