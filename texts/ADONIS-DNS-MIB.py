...
Gauge32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, MibIdentifier, ObjectIdentity, Bits, enterprises, NotificationType, iso, Counter32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "MibIdentifier", "ObjectIdentity", "Bits", "enterprises", "NotificationType", "iso", "Counter32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dns=dns, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemon=commandServerDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServer=trapCommandServer, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetAlert=dhcpSubnetAlert, PYSNMP_MODULE_ID=adonis, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemon=tftpDaemon, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, lcd=lcd, adonis=adonis, ha=ha, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, haService=haService, trapDNSDaemon=trapDNSDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemon=dhcpDaemon, dhcpFixedIP=dhcpFixedIP, trapTFTP=trapTFTP, systemDaemon=systemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetTable=dhcpSubnetTable, trapDHCP=trapDHCP, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, dnsStats=dnsStats, dhcpFailOverState=dhcpFailOverState, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, licenseExpiry=licenseExpiry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetMask=dhcpSubnetMask, trapDNS=trapDNS, dhcpPoolTable=dhcpPoolTable, system=system, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisTraps=adonisTraps, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsFailure=dnsStatsFailure, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, tftp=tftp, trapHA=trapHA, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP, systemState=systemState, trapTFTPDaemon=trapTFTPDaemon, dnsDaemon=dnsDaemon, licenseValid=licenseValid, dnsStatsReferral=dnsStatsReferral, dhcpStats=dhcpStats, dhcp=dhcp, lcdDaemon=lcdDaemon, haServiceNodeType=haServiceNodeType, dhcpLeaseStartTime=dhcpLeaseStartTime, adonisObjects=adonisObjects, trapSystem=trapSystem)
