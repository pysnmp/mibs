...
MibIdentifier, TimeTicks, Gauge32, IpAddress, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Counter64, NotificationType, enterprises, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Gauge32", "IpAddress", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Counter64", "NotificationType", "enterprises", "iso", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsReferral=dnsStatsReferral, dhcpDaemon=dhcpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetIP=dhcpSubnetIP, trapSystem=trapSystem, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, lcd=lcd, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTPDaemon=trapTFTPDaemon, trapDNS=trapDNS, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsRecursion=dnsStatsRecursion, dhcpStats=dhcpStats, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFailOverState=dhcpFailOverState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolTable=dhcpPoolTable, dhcpConfig=dhcpConfig, trapReplicationFailure=trapReplicationFailure, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTP=trapTFTP, dhcpPoolSize=dhcpPoolSize, dnsStatsNXDomain=dnsStatsNXDomain, adonis=adonis, dns=dns, dhcpLeaseEndTime=dhcpLeaseEndTime, adonisTraps=adonisTraps, trapDNSDaemon=trapDNSDaemon, system=system, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemon=tftpDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsDaemon=dnsDaemon, dhcpSubnetTable=dhcpSubnetTable, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapHA=trapHA, dhcp=dhcp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemon=commandServerDaemon, systemState=systemState, dnsStats=dnsStats, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpIP=dhcpIP, dhcpLeaseEntry=dhcpLeaseEntry, tftp=tftp, lcdDaemon=lcdDaemon, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dhcpLeaseTable=dhcpLeaseTable, systemDaemon=systemDaemon, dhcpPoolUsed=dhcpPoolUsed, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, licenseValid=licenseValid, commandServer=commandServer, ha=ha, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEndIP=dhcpPoolEndIP, trapHAServiceFailOver=trapHAServiceFailOver, PYSNMP_MODULE_ID=adonis, adonisObjects=adonisObjects, haService=haService, dnsStatsFailure=dnsStatsFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
