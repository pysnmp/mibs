...
ModuleIdentity, Bits, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, enterprises, NotificationType, Counter64, iso, Integer32, TimeTicks, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "enterprises", "NotificationType", "Counter64", "iso", "Integer32", "TimeTicks", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonisTraps=adonisTraps, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIP=dhcpFixedIP, PYSNMP_MODULE_ID=adonis, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEndIP=dhcpPoolEndIP, trapDNSDaemon=trapDNSDaemon, dhcpStats=dhcpStats, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, trapHA=trapHA, trapSystem=trapSystem, commandServer=commandServer, dnsStatsReferral=dnsStatsReferral, dhcpSubnetMask=dhcpSubnetMask, dnsDaemon=dnsDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dns=dns, trapTFTPDaemon=trapTFTPDaemon, tftp=tftp, trapDNS=trapDNS, dnsStatsRecursion=dnsStatsRecursion, trapDHCP=trapDHCP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, adonis=adonis, dhcpIP=dhcpIP, dhcpLeaseTable=dhcpLeaseTable, systemState=systemState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplicationFailure=trapReplicationFailure, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolUsed=dhcpPoolUsed, dhcpConfig=dhcpConfig, licenseValid=licenseValid, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServer=trapCommandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, haServiceRunning=haServiceRunning, adonisObjects=adonisObjects, dhcpFailOverState=dhcpFailOverState, commandServerDaemon=commandServerDaemon, haService=haService, system=system, dhcpPoolTable=dhcpPoolTable, dhcp=dhcp, dhcpSubnetEntry=dhcpSubnetEntry, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEntry=dhcpPoolEntry, lcd=lcd, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEndTime=dhcpLeaseEndTime, systemDaemon=systemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolSize=dhcpPoolSize, dhcpDaemonRunning=dhcpDaemonRunning, trapReplication=trapReplication, licenseExpiry=licenseExpiry)
