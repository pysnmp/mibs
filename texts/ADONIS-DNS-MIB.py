...
Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Counter32, MibIdentifier, Unsigned32, iso, ObjectIdentity, IpAddress, enterprises, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Counter32", "MibIdentifier", "Unsigned32", "iso", "ObjectIdentity", "IpAddress", "enterprises", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHAServiceFailOver=trapHAServiceFailOver, ha=ha, dhcpFailOverState=dhcpFailOverState, adonisTraps=adonisTraps, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, dnsStatsFailure=dnsStatsFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dns=dns, dhcpDaemon=dhcpDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolSize=dhcpPoolSize, trapTFTP=trapTFTP, tftp=tftp, adonisObjects=adonisObjects, trapDHCP=trapDHCP, trapDNSDaemon=trapDNSDaemon, dhcpStats=dhcpStats, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseExpiry=licenseExpiry, trapHA=trapHA, tftpDaemonRunning=tftpDaemonRunning, tftpDaemon=tftpDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolUsed=dhcpPoolUsed, trapDNS=trapDNS, dhcpIP=dhcpIP, lcdDaemon=lcdDaemon, dhcp=dhcp, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, lcd=lcd, dhcpLeaseStartTime=dhcpLeaseStartTime, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseEntry=dhcpLeaseEntry, dnsStats=dnsStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServer=trapCommandServer, dhcpFixedIP=dhcpFixedIP, trapReplicationFailure=trapReplicationFailure, dnsStatsNXDomain=dnsStatsNXDomain, haReplicationBinding=haReplicationBinding, trapReplication=trapReplication, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServerDaemon=trapCommandServerDaemon, commandServer=commandServer, haService=haService, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, systemDaemon=systemDaemon, PYSNMP_MODULE_ID=adonis, system=system, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemon=dnsDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemon=commandServerDaemon, adonis=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetEntry=dhcpSubnetEntry, trapSystem=trapSystem, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceNodeType=haServiceNodeType, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure)
