...
ModuleIdentity, Bits, Gauge32, ObjectIdentity, enterprises, IpAddress, iso, Integer32, Unsigned32, Counter64, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "ObjectIdentity", "enterprises", "IpAddress", "iso", "Integer32", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolTable=dhcpPoolTable, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, adonis=adonis, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapReplication=trapReplication, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcp=dhcp, trapSystem=trapSystem, dhcpSubnetTable=dhcpSubnetTable, licenseExpiry=licenseExpiry, dhcpSubnetMask=dhcpSubnetMask, trapCommandServer=trapCommandServer, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, haServiceNodeType=haServiceNodeType, trapDNS=trapDNS, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, trapDNSDaemon=trapDNSDaemon, trapHA=trapHA, licenseValid=licenseValid, trapSystemDaemon=trapSystemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemon=dnsDaemon, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDHCP=trapDHCP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolAlert=dhcpPoolAlert, system=system, lcd=lcd, dnsStats=dnsStats, dhcpFailOverState=dhcpFailOverState, dhcpStats=dhcpStats, trapReplicationFailure=trapReplicationFailure, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haService=haService, tftp=tftp, adonisObjects=adonisObjects, systemState=systemState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXDomain=dnsStatsNXDomain, PYSNMP_MODULE_ID=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, adonisTraps=adonisTraps, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIP=dhcpFixedIP, lcdDaemon=lcdDaemon, commandServerDaemonRunning=commandServerDaemonRunning, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpIP=dhcpIP, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haServiceRunning=haServiceRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftpDaemon=tftpDaemon, dhcpDaemon=dhcpDaemon, dnsStatsFailure=dnsStatsFailure, dhcpLeaseStartTime=dhcpLeaseStartTime)
