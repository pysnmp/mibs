...
Integer32, Counter64, iso, IpAddress, ObjectIdentity, NotificationType, Unsigned32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, Counter32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "iso", "IpAddress", "ObjectIdentity", "NotificationType", "Unsigned32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "Counter32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, licenseExpiry=licenseExpiry, ha=ha, trapHA=trapHA, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, licenseValid=licenseValid, dhcp=dhcp, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpConfig=dhcpConfig, dhcpSubnetTable=dhcpSubnetTable, adonisObjects=adonisObjects, dnsDaemon=dnsDaemon, dnsStatsSuccess=dnsStatsSuccess, PYSNMP_MODULE_ID=adonis, adonis=adonis, adonisTraps=adonisTraps, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dhcpDaemonRunning=dhcpDaemonRunning, trapReplicationFailure=trapReplicationFailure, dnsStatsRecursion=dnsStatsRecursion, dns=dns, haReplicationBinding=haReplicationBinding, tftp=tftp, dhcpPoolEntry=dhcpPoolEntry, dnsStats=dnsStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemon=dhcpDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemonRunning=tftpDaemonRunning, lcd=lcd, dhcpStats=dhcpStats, trapTFTP=trapTFTP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapSystem=trapSystem, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dhcpPoolStartIP=dhcpPoolStartIP, haServiceRunning=haServiceRunning, dhcpSubnetMask=dhcpSubnetMask, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, lcdDaemon=lcdDaemon, system=system, dnsStatsFailure=dnsStatsFailure, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpIP=dhcpIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsReferral=dnsStatsReferral, trapTFTPDaemon=trapTFTPDaemon, dhcpFailOverState=dhcpFailOverState, tftpDaemon=tftpDaemon, dhcpPoolSize=dhcpPoolSize, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseTable=dhcpLeaseTable, systemDaemon=systemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, haService=haService, trapHAServiceFailOver=trapHAServiceFailOver, commandServerDaemon=commandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP)
