...
Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, ObjectIdentity, NotificationType, Counter64, Integer32, ModuleIdentity, iso, Counter32, TimeTicks, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "ModuleIdentity", "iso", "Counter32", "TimeTicks", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceRunning=haServiceRunning, dhcp=dhcp, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceNodeType=haServiceNodeType, lcd=lcd, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, dhcpFixedIP=dhcpFixedIP, dhcpStats=dhcpStats, dnsDaemon=dnsDaemon, dnsStatsNXDomain=dnsStatsNXDomain, tftp=tftp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServer=commandServer, trapReplication=trapReplication, dhcpPoolEntry=dhcpPoolEntry, lcdDaemon=lcdDaemon, haReplicationBinding=haReplicationBinding, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, dhcpIP=dhcpIP, dhcpLeaseHostname=dhcpLeaseHostname, tftpDaemon=tftpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, trapReplicationFailure=trapReplicationFailure, dhcpConfig=dhcpConfig, dhcpLeaseEntry=dhcpLeaseEntry, systemState=systemState, licenseExpiry=licenseExpiry, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFailOverState=dhcpFailOverState, trapCommandServerDaemon=trapCommandServerDaemon, commandServerDaemon=commandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolTable=dhcpPoolTable, dhcpPoolAlert=dhcpPoolAlert, trapSystem=trapSystem, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, PYSNMP_MODULE_ID=adonis, trapSystemDaemon=trapSystemDaemon, dhcpSubnetSize=dhcpSubnetSize, system=system, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsFailure=dnsStatsFailure, dnsStatsReferral=dnsStatsReferral, dhcpSubnetAlert=dhcpSubnetAlert, trapCommandServer=trapCommandServer, dnsStatsSuccess=dnsStatsSuccess, ha=ha, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, dns=dns, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, dnsStats=dnsStats, dhcpLeaseTable=dhcpLeaseTable, adonis=adonis, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, haService=haService, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsRecursion=dnsStatsRecursion, trapHA=trapHA, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, trapDNS=trapDNS, systemDaemon=systemDaemon, adonisObjects=adonisObjects, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState)
