...
IpAddress, enterprises, Gauge32, Bits, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, TimeTicks, Integer32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Gauge32", "Bits", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "TimeTicks", "Integer32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsFailure=dnsStatsFailure, trapHA=trapHA, lcdDaemon=lcdDaemon, PYSNMP_MODULE_ID=adonis, adonis=adonis, dhcpSubnetUsed=dhcpSubnetUsed, trapSystem=trapSystem, trapReplication=trapReplication, dhcpDaemon=dhcpDaemon, haReplicationBinding=haReplicationBinding, trapDNS=trapDNS, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServer=trapCommandServer, commandServerDaemonRunning=commandServerDaemonRunning, dhcpIP=dhcpIP, licenseValid=licenseValid, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetSize=dhcpSubnetSize, dnsDaemon=dnsDaemon, dhcp=dhcp, trapDHCP=trapDHCP, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsNXDomain=dnsStatsNXDomain, lcd=lcd, tftp=tftp, tftpDaemon=tftpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpStats=dhcpStats, trapHAServiceFailOver=trapHAServiceFailOver, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsSuccess=dnsStatsSuccess, adonisObjects=adonisObjects, trapTFTP=trapTFTP, ha=ha, systemDaemon=systemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpConfig=dhcpConfig, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dns=dns, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDNSDaemon=trapDNSDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTPDaemon=trapTFTPDaemon, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, haServiceRunning=haServiceRunning, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolSize=dhcpPoolSize, dhcpFixedIP=dhcpFixedIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolTable=dhcpPoolTable, haServiceNodeType=haServiceNodeType, dnsStats=dnsStats, trapSystemDaemon=trapSystemDaemon, adonisTraps=adonisTraps, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, systemState=systemState, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, haService=haService, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsReferral=dnsStatsReferral, system=system, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemon=commandServerDaemon, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapReplicationFailure=trapReplicationFailure)
