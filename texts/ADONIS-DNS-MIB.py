...
Counter64, iso, ModuleIdentity, Bits, Integer32, Gauge32, Counter32, Unsigned32, MibIdentifier, enterprises, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "ModuleIdentity", "Bits", "Integer32", "Gauge32", "Counter32", "Unsigned32", "MibIdentifier", "enterprises", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftp=tftp, dhcpSubnetTable=dhcpSubnetTable, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, lcdDaemon=lcdDaemon, dnsDaemon=dnsDaemon, systemDaemon=systemDaemon, dhcpFixedIPTable=dhcpFixedIPTable, licenseValid=licenseValid, dnsStatsReferral=dnsStatsReferral, dnsStatsRecursion=dnsStatsRecursion, trapCommandServer=trapCommandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemon=dhcpDaemon, system=system, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEntry=dhcpLeaseEntry, trapDNS=trapDNS, dhcpFixedIP=dhcpFixedIP, dhcpFailOverState=dhcpFailOverState, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetSize=dhcpSubnetSize, lcd=lcd, dnsStatsSuccess=dnsStatsSuccess, trapReplication=trapReplication, haServiceRunning=haServiceRunning, adonisObjects=adonisObjects, haServiceNodeType=haServiceNodeType, dhcpFixedIPEntry=dhcpFixedIPEntry, ha=ha, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haReplicationBinding=haReplicationBinding, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetUsed=dhcpSubnetUsed, trapSystemDaemon=trapSystemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetEntry=dhcpSubnetEntry, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, trapReplicationFailure=trapReplicationFailure, adonis=adonis, dhcpSubnetMask=dhcpSubnetMask, dhcpIP=dhcpIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEndIP=dhcpPoolEndIP, dns=dns, dhcpDaemonRunning=dhcpDaemonRunning, adonisTraps=adonisTraps, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, systemState=systemState, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolTable=dhcpPoolTable, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapHA=trapHA, dnsStats=dnsStats, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemon=commandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, trapSystem=trapSystem, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet)
