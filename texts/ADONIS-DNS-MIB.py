...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, Integer32, IpAddress, enterprises, MibIdentifier, TimeTicks, ModuleIdentity, Bits, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "Integer32", "IpAddress", "enterprises", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Bits", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemon=dnsDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpConfig=dhcpConfig, dhcpLeaseBindState=dhcpLeaseBindState, haReplicationBinding=haReplicationBinding, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolAlert=dhcpPoolAlert, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, trapDNS=trapDNS, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpIP=dhcpIP, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIPTable=dhcpFixedIPTable, system=system, trapHA=trapHA, trapReplication=trapReplication, dnsStatsFailure=dnsStatsFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, dnsStatsReferral=dnsStatsReferral, trapDHCPDaemon=trapDHCPDaemon, licenseExpiry=licenseExpiry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, licenseValid=licenseValid, dhcpPoolSize=dhcpPoolSize, haServiceNodeType=haServiceNodeType, ha=ha, systemState=systemState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTP=trapTFTP, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, dhcp=dhcp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpStats=dhcpStats, systemDaemon=systemDaemon, dhcpSubnetSize=dhcpSubnetSize, tftp=tftp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, lcdDaemon=lcdDaemon, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIP=dhcpFixedIP, dhcpPoolTable=dhcpPoolTable, trapDHCP=trapDHCP, dhcpSubnetEntry=dhcpSubnetEntry, PYSNMP_MODULE_ID=adonis, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolStartIP=dhcpPoolStartIP, adonis=adonis, haService=haService, trapReplicationFailure=trapReplicationFailure, tftpDaemon=tftpDaemon, trapDNSDaemon=trapDNSDaemon, dns=dns, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystem=trapSystem, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, trapCommandServer=trapCommandServer, dhcpPoolEndIP=dhcpPoolEndIP, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseTable=dhcpLeaseTable, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, adonisObjects=adonisObjects)
