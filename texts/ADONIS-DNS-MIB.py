...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemon=dhcpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, commandServer=commandServer, dhcpPoolEndIP=dhcpPoolEndIP, systemDaemon=systemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystem=trapSystem, dhcpLeaseEndTime=dhcpLeaseEndTime, trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIPTable=dhcpFixedIPTable, system=system, systemState=systemState, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEntry=dhcpLeaseEntry, dns=dns, trapReplicationFailure=trapReplicationFailure, haService=haService, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonisObjects=adonisObjects, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, PYSNMP_MODULE_ID=adonis, tftp=tftp, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, adonis=adonis, dhcpFailOverState=dhcpFailOverState, ha=ha, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetIP=dhcpSubnetIP, lcd=lcd, trapCommandServer=trapCommandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHostname=dhcpLeaseHostname, dhcp=dhcp, commandServerDaemon=commandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIP=dhcpFixedIP, haServiceRunning=haServiceRunning, dhcpIP=dhcpIP, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetTable=dhcpSubnetTable, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, dhcpPoolUsed=dhcpPoolUsed, trapDNSDaemon=trapDNSDaemon, trapDNS=trapDNS, lcdDaemon=lcdDaemon, haReplicationBinding=haReplicationBinding, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpStats=dhcpStats, adonisTraps=adonisTraps, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapSystemDaemon=trapSystemDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseValid=licenseValid, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemon=dnsDaemon, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTP=trapTFTP, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetAlert=dhcpSubnetAlert)
