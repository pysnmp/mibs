...
enterprises, ObjectIdentity, Counter32, IpAddress, Counter64, Unsigned32, TimeTicks, NotificationType, iso, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Counter32", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "NotificationType", "iso", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsSuccess=dnsStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, haService=haService, trapDNSDaemon=trapDNSDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, tftpDaemonRunning=tftpDaemonRunning, licenseExpiry=licenseExpiry, trapSystem=trapSystem, haServiceNodeType=haServiceNodeType, licenseValid=licenseValid, dhcpLeaseEntry=dhcpLeaseEntry, lcd=lcd, ha=ha, systemDaemon=systemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplication=trapReplication, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNS=trapDNS, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemon=tftpDaemon, adonisObjects=adonisObjects, systemState=systemState, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, adonisTraps=adonisTraps, dhcpPoolUsed=dhcpPoolUsed, trapSystemDaemon=trapSystemDaemon, dnsStatsFailure=dnsStatsFailure, dhcpFailOverState=dhcpFailOverState, dnsDaemon=dnsDaemon, trapReplicationFailure=trapReplicationFailure, dhcp=dhcp, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFixedIP=dhcpFixedIP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, trapTFTP=trapTFTP, tftp=tftp, dhcpPoolSize=dhcpPoolSize, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemon=dhcpDaemon, commandServerDaemon=commandServerDaemon, haReplicationBinding=haReplicationBinding, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, dhcpIP=dhcpIP, dnsStats=dnsStats, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCP=trapDHCP, dns=dns, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, system=system, dnsStatsReferral=dnsStatsReferral, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, trapHA=trapHA, adonis=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, lcdDaemon=lcdDaemon, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, haServiceRunning=haServiceRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert)
