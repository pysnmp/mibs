...
ModuleIdentity, Bits, NotificationType, enterprises, Gauge32, Integer32, IpAddress, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, iso, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "enterprises", "Gauge32", "Integer32", "IpAddress", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpIP=dhcpIP, ha=ha, dhcpPoolStartIP=dhcpPoolStartIP, trapReplication=trapReplication, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dns=dns, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon, haReplicationBinding=haReplicationBinding, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpStats=dhcpStats, dhcpSubnetTable=dhcpSubnetTable, adonis=adonis, dhcpFailOverState=dhcpFailOverState, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, dhcpConfig=dhcpConfig, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, adonisObjects=adonisObjects, trapDHCP=trapDHCP, trapHA=trapHA, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, PYSNMP_MODULE_ID=adonis, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, dnsStatsFailure=dnsStatsFailure, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNSDaemon=trapDNSDaemon, dnsDaemon=dnsDaemon, dhcpPoolSize=dhcpPoolSize, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsNXRRSet=dnsStatsNXRRSet, system=system, dhcpSubnetUsed=dhcpSubnetUsed, licenseExpiry=licenseExpiry, dnsStatsSuccess=dnsStatsSuccess, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, systemState=systemState, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, dhcpDaemon=dhcpDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStats=dnsStats, trapSystemDaemon=trapSystemDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, haServiceRunning=haServiceRunning, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemDaemon=systemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceNodeType=haServiceNodeType, dhcpPoolUsed=dhcpPoolUsed, trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, haService=haService, dhcpLeaseTable=dhcpLeaseTable, lcdDaemon=lcdDaemon, tftpDaemon=tftpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp)
