...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpConfig=dhcpConfig, haServiceNodeType=haServiceNodeType, trapDNSDaemon=trapDNSDaemon, dnsStatsReferral=dnsStatsReferral, PYSNMP_MODULE_ID=adonis, dhcpFailOverState=dhcpFailOverState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystem=trapSystem, haReplicationBinding=haReplicationBinding, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsSuccess=dnsStatsSuccess, tftpDaemon=tftpDaemon, dns=dns, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServer=trapCommandServer, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, systemState=systemState, trapReplicationFailure=trapReplicationFailure, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemon=commandServerDaemon, dnsStatsFailure=dnsStatsFailure, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, haService=haService, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemon=dnsDaemon, trapHA=trapHA, systemDaemon=systemDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseBindState=dhcpLeaseBindState, lcdDaemon=lcdDaemon, dnsDaemonRunning=dnsDaemonRunning, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolSize=dhcpPoolSize, dnsStats=dnsStats, licenseExpiry=licenseExpiry, adonisObjects=adonisObjects, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIP=dhcpFixedIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetIP=dhcpSubnetIP, ha=ha, dhcpIP=dhcpIP, dhcpPoolTable=dhcpPoolTable, trapDHCPDaemon=trapDHCPDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpStats=dhcpStats, system=system, licenseValid=licenseValid, dhcpSubnetEntry=dhcpSubnetEntry, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetMask=dhcpSubnetMask, dhcp=dhcp, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolUsed=dhcpPoolUsed, trapHAServiceFailOver=trapHAServiceFailOver, lcd=lcd, trapDHCP=trapDHCP, trapTFTP=trapTFTP, commandServer=commandServer, adonisTraps=adonisTraps, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemon=dhcpDaemon, tftp=tftp, haServiceRunning=haServiceRunning, dhcpPoolStartIP=dhcpPoolStartIP)
