...
ModuleIdentity, Bits, TimeTicks, MibIdentifier, IpAddress, enterprises, Gauge32, Counter32, Integer32, Unsigned32, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "TimeTicks", "MibIdentifier", "IpAddress", "enterprises", "Gauge32", "Counter32", "Integer32", "Unsigned32", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, licenseExpiry=licenseExpiry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpConfig=dhcpConfig, dhcpPoolEntry=dhcpPoolEntry, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemon=commandServerDaemon, haReplicationBinding=haReplicationBinding, trapSystemDaemon=trapSystemDaemon, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSize=dhcpPoolSize, PYSNMP_MODULE_ID=adonis, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetIP=dhcpSubnetIP, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpFailOverState=dhcpFailOverState, dhcpPoolEndIP=dhcpPoolEndIP, licenseValid=licenseValid, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServer=commandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, adonis=adonis, dhcpSubnetSize=dhcpSubnetSize, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, haService=haService, systemState=systemState, tftpDaemon=tftpDaemon, trapReplicationFailure=trapReplicationFailure, dhcp=dhcp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftp=tftp, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolTable=dhcpPoolTable, trapSystem=trapSystem, trapDHCP=trapDHCP, ha=ha, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNS=trapDNS, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIP=dhcpFixedIP, trapDNSDaemon=trapDNSDaemon, adonisTraps=adonisTraps, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, trapReplication=trapReplication, dhcpFixedIPTable=dhcpFixedIPTable, lcd=lcd, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemDaemon=systemDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsFailure=dnsStatsFailure, dhcpDaemonRunning=dhcpDaemonRunning, adonisObjects=adonisObjects, dhcpLeaseHostname=dhcpLeaseHostname, haServiceNodeType=haServiceNodeType, dns=dns, dhcpSubnetAlert=dhcpSubnetAlert, system=system, trapTFTP=trapTFTP, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed)
