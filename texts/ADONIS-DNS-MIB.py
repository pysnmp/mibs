...
Integer32, iso, Gauge32, ModuleIdentity, Unsigned32, Counter64, Bits, IpAddress, MibIdentifier, TimeTicks, ObjectIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "ModuleIdentity", "Unsigned32", "Counter64", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, dhcpSubnetSize=dhcpSubnetSize, licenseExpiry=licenseExpiry, tftp=tftp, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolSize=dhcpPoolSize, trapSystem=trapSystem, trapReplicationFailure=trapReplicationFailure, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetIP=dhcpSubnetIP, dnsStatsFailure=dnsStatsFailure, lcdDaemon=lcdDaemon, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetEntry=dhcpSubnetEntry, system=system, dhcpLeaseTable=dhcpLeaseTable, trapDHCP=trapDHCP, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, dnsStatsRecursion=dnsStatsRecursion, dhcpStats=dhcpStats, dns=dns, PYSNMP_MODULE_ID=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpIP=dhcpIP, dnsStatsNXRRSet=dnsStatsNXRRSet, lcd=lcd, dnsStatsReferral=dnsStatsReferral, dhcpFailOverState=dhcpFailOverState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolAlert=dhcpPoolAlert, haService=haService, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, adonisObjects=adonisObjects, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapReplication=trapReplication, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEntry=dhcpLeaseEntry, systemState=systemState, trapCommandServer=trapCommandServer, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, licenseValid=licenseValid, trapDNSDaemon=trapDNSDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXDomain=dnsStatsNXDomain, haReplicationBinding=haReplicationBinding, ha=ha, dnsDaemon=dnsDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemon=dhcpDaemon, adonis=adonis, dhcp=dhcp, trapTFTPDaemon=trapTFTPDaemon, haServiceNodeType=haServiceNodeType, dhcpFixedIP=dhcpFixedIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
