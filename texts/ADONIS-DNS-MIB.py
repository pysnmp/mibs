...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFailOverState=dhcpFailOverState, dnsDaemon=dnsDaemon, ha=ha, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, adonisObjects=adonisObjects, dnsStatsSuccess=dnsStatsSuccess, lcdDaemon=lcdDaemon, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, dnsDaemonRunning=dnsDaemonRunning, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEntry=dhcpLeaseEntry, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolEntry=dhcpPoolEntry, trapHA=trapHA, dhcpLeaseStartTime=dhcpLeaseStartTime, system=system, systemDaemon=systemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIP=dhcpFixedIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dns=dns, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, dhcpIP=dhcpIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, trapDHCPDaemon=trapDHCPDaemon, adonisTraps=adonisTraps, haReplicationBinding=haReplicationBinding, dhcpDaemon=dhcpDaemon, trapSystem=trapSystem, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapSystemDaemon=trapSystemDaemon, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHostname=dhcpLeaseHostname, trapTFTP=trapTFTP, trapReplicationFailure=trapReplicationFailure, dnsStatsRecursion=dnsStatsRecursion, dhcp=dhcp, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServerDaemon=commandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable, licenseExpiry=licenseExpiry, commandServer=commandServer, tftpDaemonRunning=tftpDaemonRunning, dnsStats=dnsStats, dhcpConfig=dhcpConfig, lcd=lcd, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemon=tftpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, haServiceRunning=haServiceRunning, systemState=systemState, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftp=tftp, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, dhcpPoolUsed=dhcpPoolUsed)
