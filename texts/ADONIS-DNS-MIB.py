...
IpAddress, Unsigned32, Bits, iso, TimeTicks, Counter64, Gauge32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Bits", "iso", "TimeTicks", "Counter64", "Gauge32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetSize=dhcpSubnetSize, dnsDaemon=dnsDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDHCP=trapDHCP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, trapReplicationFailure=trapReplicationFailure, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsReferral=dnsStatsReferral, trapCommandServer=trapCommandServer, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, tftp=tftp, dhcpPoolAlert=dhcpPoolAlert, systemDaemon=systemDaemon, haService=haService, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dhcpPoolEntry=dhcpPoolEntry, haReplicationBinding=haReplicationBinding, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, trapDNS=trapDNS, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetAlert=dhcpSubnetAlert, haServiceNodeType=haServiceNodeType, dhcpDaemonRunning=dhcpDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSize=dhcpPoolSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, ha=ha, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, tftpDaemon=tftpDaemon, adonisTraps=adonisTraps, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIP=dhcpFixedIP, lcdDaemon=lcdDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetMask=dhcpSubnetMask, licenseExpiry=licenseExpiry, trapSystem=trapSystem, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPTable=dhcpFixedIPTable, systemState=systemState, dhcpDaemon=dhcpDaemon, trapTFTP=trapTFTP, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolUsed=dhcpPoolUsed, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcp=dhcp, dhcpSubnetEntry=dhcpSubnetEntry, dnsStats=dnsStats, dhcpIP=dhcpIP, adonis=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystemDaemon=trapSystemDaemon, lcd=lcd, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dns=dns, adonisObjects=adonisObjects, dhcpConfig=dhcpConfig, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, licenseValid=licenseValid, dnsDaemonRunning=dnsDaemonRunning)
