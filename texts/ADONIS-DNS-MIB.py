...
enterprises, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, iso, Unsigned32, IpAddress, Gauge32, MibIdentifier, TimeTicks, Integer32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "iso", "Unsigned32", "IpAddress", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftpDaemon=tftpDaemon, dnsStats=dnsStats, dhcpLeaseBindState=dhcpLeaseBindState, dhcpConfig=dhcpConfig, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftp=tftp, lcdDaemon=lcdDaemon, dhcpPoolAlert=dhcpPoolAlert, commandServerDaemon=commandServerDaemon, trapTFTP=trapTFTP, dhcpFixedIP=dhcpFixedIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonis=adonis, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, trapDNS=trapDNS, trapReplication=trapReplication, dhcpSubnetUsed=dhcpSubnetUsed, adonisTraps=adonisTraps, trapHA=trapHA, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, dns=dns, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, dnsDaemonRunning=dnsDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, haReplicationBinding=haReplicationBinding, dhcp=dhcp, dhcpPoolTable=dhcpPoolTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolStartIP=dhcpPoolStartIP, systemDaemon=systemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, system=system, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSize=dhcpPoolSize, dnsDaemon=dnsDaemon, dhcpLeaseEntry=dhcpLeaseEntry, haServiceRunning=haServiceRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haService=haService, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, dhcpSubnetIP=dhcpSubnetIP, trapDHCPDaemon=trapDHCPDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetTable=dhcpSubnetTable, systemState=systemState, dhcpSubnetEntry=dhcpSubnetEntry, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemon=dhcpDaemon, dhcpIP=dhcpIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCP=trapDHCP, trapSystem=trapSystem, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, trapReplicationFailure=trapReplicationFailure, dhcpLeaseTable=dhcpLeaseTable, adonisObjects=adonisObjects, trapDNSDaemon=trapDNSDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsSuccess=dnsStatsSuccess, dhcpFailOverState=dhcpFailOverState, trapCommandServer=trapCommandServer, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress)
