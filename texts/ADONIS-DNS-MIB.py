...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, dnsDaemonDebugLevel=dnsDaemonDebugLevel, system=system, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, adonisObjects=adonisObjects, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, licenseExpiry=licenseExpiry, trapReplication=trapReplication, trapDHCP=trapDHCP, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTable=dhcpLeaseTable, dnsStatsFailure=dnsStatsFailure, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXDomain=dnsStatsNXDomain, trapDNS=trapDNS, trapSystemDaemon=trapSystemDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcp=dhcp, trapHAServiceFailOver=trapHAServiceFailOver, dhcpStats=dhcpStats, trapDHCPDaemon=trapDHCPDaemon, systemDaemon=systemDaemon, commandServerDaemon=commandServerDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemon=dhcpDaemon, dhcpIP=dhcpIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseBindState=dhcpLeaseBindState, trapCommandServer=trapCommandServer, trapTFTP=trapTFTP, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftpDaemonRunning=tftpDaemonRunning, adonisTraps=adonisTraps, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dnsStatsReferral=dnsStatsReferral, dhcpFixedIP=dhcpFixedIP, lcd=lcd, dhcpLeaseHostname=dhcpLeaseHostname, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dns=dns, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, lcdDaemon=lcdDaemon, trapDNSDaemon=trapDNSDaemon, PYSNMP_MODULE_ID=adonis, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSize=dhcpPoolSize, dhcpPoolAlert=dhcpPoolAlert, tftp=tftp, tftpDaemon=tftpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpConfig=dhcpConfig, adonis=adonis, dnsDaemon=dnsDaemon, trapSystem=trapSystem, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, haReplicationBinding=haReplicationBinding, haService=haService, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServer=commandServer, haServiceNodeType=haServiceNodeType, dnsStats=dnsStats, haServiceRunning=haServiceRunning, ha=ha)
