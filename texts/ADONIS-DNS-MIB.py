...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcd=lcd, tftp=tftp, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServer=trapCommandServer, dhcpPoolTable=dhcpPoolTable, dnsDaemonRunning=dnsDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dnsStatsReferral=dnsStatsReferral, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemon=dhcpDaemon, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dnsStatsFailure=dnsStatsFailure, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemon=tftpDaemon, haService=haService, commandServerDaemonRunning=commandServerDaemonRunning, dhcpStats=dhcpStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, trapDHCP=trapDHCP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, licenseExpiry=licenseExpiry, dnsDaemon=dnsDaemon, haReplicationBinding=haReplicationBinding, licenseValid=licenseValid, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, dhcpIP=dhcpIP, dnsStatsNXRRSet=dnsStatsNXRRSet, haServiceRunning=haServiceRunning, dnsStats=dnsStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, trapReplication=trapReplication, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonis=adonis, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, trapDHCPDaemon=trapDHCPDaemon, haServiceNodeType=haServiceNodeType, dhcpPoolSize=dhcpPoolSize, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIP=dhcpFixedIP, system=system, systemDaemon=systemDaemon, trapSystem=trapSystem, dhcpConfig=dhcpConfig, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFailOverState=dhcpFailOverState, trapDNS=trapDNS, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, PYSNMP_MODULE_ID=adonis, trapDNSDaemon=trapDNSDaemon, trapHAServiceFailOver=trapHAServiceFailOver, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEntry=dhcpLeaseEntry, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcp=dhcp, lcdDaemon=lcdDaemon, trapReplicationFailure=trapReplicationFailure, adonisTraps=adonisTraps, trapHA=trapHA, dhcpSubnetAlert=dhcpSubnetAlert, adonisObjects=adonisObjects, ha=ha)
