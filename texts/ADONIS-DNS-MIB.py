...
Gauge32, Bits, enterprises, ModuleIdentity, Unsigned32, Integer32, iso, IpAddress, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "enterprises", "ModuleIdentity", "Unsigned32", "Integer32", "iso", "IpAddress", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpIP=dhcpIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSize=dhcpPoolSize, tftp=tftp, lcdDaemon=lcdDaemon, dhcpSubnetMask=dhcpSubnetMask, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, dhcpFixedIP=dhcpFixedIP, lcd=lcd, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, haReplicationBinding=haReplicationBinding, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemon=dhcpDaemon, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetEntry=dhcpSubnetEntry, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapReplicationFailure=trapReplicationFailure, dhcpPoolUsed=dhcpPoolUsed, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetSize=dhcpSubnetSize, systemDaemon=systemDaemon, ha=ha, system=system, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemon=dnsDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonisObjects=adonisObjects, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, licenseExpiry=licenseExpiry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHostname=dhcpLeaseHostname, PYSNMP_MODULE_ID=adonis, trapHA=trapHA, trapDNS=trapDNS, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, dhcp=dhcp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, trapSystem=trapSystem, trapTFTP=trapTFTP, dhcpPoolTable=dhcpPoolTable, trapReplication=trapReplication, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFailOverState=dhcpFailOverState, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, dns=dns, dnsStatsRecursion=dnsStatsRecursion, haServiceRunning=haServiceRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, adonis=adonis, dnsDaemonRunning=dnsDaemonRunning, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, systemState=systemState, commandServerDaemon=commandServerDaemon)
