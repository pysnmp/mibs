...
Gauge32, enterprises, TimeTicks, Counter64, MibIdentifier, Integer32, ObjectIdentity, Unsigned32, Counter32, Bits, ModuleIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "TimeTicks", "Counter64", "MibIdentifier", "Integer32", "ObjectIdentity", "Unsigned32", "Counter32", "Bits", "ModuleIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, dhcpPoolUsed=dhcpPoolUsed, system=system, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSize=dhcpPoolSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplication=trapReplication, dhcpIP=dhcpIP, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, haReplicationBinding=haReplicationBinding, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetIP=dhcpSubnetIP, commandServerDaemon=commandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, ha=ha, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolAlert=dhcpPoolAlert, tftpDaemon=tftpDaemon, dnsStatsFailure=dnsStatsFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStats=dnsStats, dnsDaemon=dnsDaemon, adonisObjects=adonisObjects, trapDNSDaemon=trapDNSDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemonRunning=commandServerDaemonRunning, trapReplicationFailure=trapReplicationFailure, dhcpFailOverState=dhcpFailOverState, dns=dns, trapCommandServer=trapCommandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapHAServiceFailOver=trapHAServiceFailOver, lcdDaemon=lcdDaemon, dhcpConfig=dhcpConfig, commandServer=commandServer, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, haServiceNodeType=haServiceNodeType, systemState=systemState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTable=dhcpLeaseTable, dhcp=dhcp, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEntry=dhcpPoolEntry, tftp=tftp, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemon=dhcpDaemon, haServiceRunning=haServiceRunning, adonisTraps=adonisTraps, trapDHCP=trapDHCP, haService=haService, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystem=trapSystem, lcd=lcd, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, trapDHCPDaemon=trapDHCPDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapHA=trapHA, adonis=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure)
