...
Counter64, ModuleIdentity, IpAddress, iso, Gauge32, Bits, Counter32, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, NotificationType, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "IpAddress", "iso", "Gauge32", "Bits", "Counter32", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "NotificationType", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, dhcpSubnetEntry=dhcpSubnetEntry, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP, trapSystemDaemon=trapSystemDaemon, adonisObjects=adonisObjects, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHAServiceFailOver=trapHAServiceFailOver, licenseExpiry=licenseExpiry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTP=trapTFTP, systemDaemon=systemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, systemState=systemState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, licenseValid=licenseValid, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolAlert=dhcpPoolAlert, trapCommandServerDaemon=trapCommandServerDaemon, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSize=dhcpPoolSize, dhcpSubnetTable=dhcpSubnetTable, dnsStatsReferral=dnsStatsReferral, dhcp=dhcp, ha=ha, dhcpSubnetMask=dhcpSubnetMask, PYSNMP_MODULE_ID=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonRunning=dhcpDaemonRunning, trapHA=trapHA, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTable=dhcpLeaseTable, trapCommandServer=trapCommandServer, dnsDaemonRunning=dnsDaemonRunning, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemon=dhcpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haService=haService, lcd=lcd, haServiceNodeType=haServiceNodeType, haServiceRunning=haServiceRunning, tftp=tftp, tftpDaemon=tftpDaemon, haReplicationBinding=haReplicationBinding, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, dhcpConfig=dhcpConfig, dhcpSubnetIP=dhcpSubnetIP, commandServer=commandServer, system=system, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, trapDHCPDaemon=trapDHCPDaemon, dns=dns, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpIP=dhcpIP, dhcpStats=dhcpStats, lcdDaemon=lcdDaemon, dnsStatsFailure=dnsStatsFailure, dnsStatsRecursion=dnsStatsRecursion, adonis=adonis, trapDNS=trapDNS, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress)
