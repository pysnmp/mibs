...
MibIdentifier, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter64, ModuleIdentity, TimeTicks, iso, Bits, Unsigned32, Integer32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity", "TimeTicks", "iso", "Bits", "Unsigned32", "Integer32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, adonisObjects=adonisObjects, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, licenseExpiry=licenseExpiry, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpConfig=dhcpConfig, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcdDaemon=lcdDaemon, trapHA=trapHA, dhcpPoolTable=dhcpPoolTable, dhcpSubnetSize=dhcpSubnetSize, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, trapSystem=trapSystem, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, ha=ha, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsReferral=dnsStatsReferral, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemon=commandServerDaemon, dhcpIP=dhcpIP, trapCommandServer=trapCommandServer, trapDNS=trapDNS, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetTable=dhcpSubnetTable, haReplicationBinding=haReplicationBinding, dhcpDaemonRunning=dhcpDaemonRunning, trapReplication=trapReplication, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTP=trapTFTP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemon=dnsDaemon, licenseValid=licenseValid, dnsStatsFailure=dnsStatsFailure, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haService=haService, dhcpStats=dhcpStats, dnsStatsSuccess=dnsStatsSuccess, systemDaemon=systemDaemon, trapDHCP=trapDHCP, dhcpSubnetUsed=dhcpSubnetUsed, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIP=dhcpFixedIP, dns=dns, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, haServiceNodeType=haServiceNodeType, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcd=lcd, trapTFTPDaemon=trapTFTPDaemon, tftp=tftp, dhcpPoolSize=dhcpPoolSize, dhcpSubnetAlert=dhcpSubnetAlert, dhcp=dhcp, trapSystemDaemon=trapSystemDaemon, haServiceRunning=haServiceRunning, adonis=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, system=system)
