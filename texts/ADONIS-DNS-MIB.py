...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Integer32, NotificationType, iso, enterprises, Bits, ModuleIdentity, ObjectIdentity, MibIdentifier, Counter64, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Integer32", "NotificationType", "iso", "enterprises", "Bits", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter64", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsRecursion=dnsStatsRecursion, tftp=tftp, dhcpDaemon=dhcpDaemon, dnsStatsFailure=dnsStatsFailure, adonisTraps=adonisTraps, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, dhcpSubnetMask=dhcpSubnetMask, dnsStatsNXDomain=dnsStatsNXDomain, haServiceRunning=haServiceRunning, trapSystem=trapSystem, dhcpSubnetTable=dhcpSubnetTable, dnsStatsReferral=dnsStatsReferral, lcd=lcd, dhcpLeaseHostname=dhcpLeaseHostname, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpConfig=dhcpConfig, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDNS=trapDNS, trapReplicationFailure=trapReplicationFailure, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolSize=dhcpPoolSize, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemonRunning=tftpDaemonRunning, haServiceNodeType=haServiceNodeType, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, tftpDaemon=tftpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, licenseExpiry=licenseExpiry, dhcpStats=dhcpStats, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEndIP=dhcpPoolEndIP, systemState=systemState, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetEntry=dhcpSubnetEntry, lcdDaemon=lcdDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, adonisObjects=adonisObjects, trapTFTP=trapTFTP, commandServer=commandServer, dhcpLeaseEntry=dhcpLeaseEntry, trapDHCPDaemon=trapDHCPDaemon, system=system, trapDNSDaemon=trapDNSDaemon, systemDaemon=systemDaemon, dhcpFixedIP=dhcpFixedIP, dnsDaemon=dnsDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDHCP=trapDHCP, dhcpIP=dhcpIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, trapReplication=trapReplication, adonis=adonis, haReplicationBinding=haReplicationBinding, dhcp=dhcp, dns=dns, dnsStats=dnsStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFailOverState=dhcpFailOverState)
