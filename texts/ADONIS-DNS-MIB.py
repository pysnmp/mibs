...
Counter64, enterprises, Bits, Unsigned32, Counter32, TimeTicks, IpAddress, Gauge32, ObjectIdentity, Integer32, ModuleIdentity, NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Bits", "Unsigned32", "Counter32", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Integer32", "ModuleIdentity", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, haServiceNodeType=haServiceNodeType, dnsDaemon=dnsDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolTable=dhcpPoolTable, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, dnsStatsReferral=dnsStatsReferral, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNS=trapDNS, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFailOverState=dhcpFailOverState, haService=haService, PYSNMP_MODULE_ID=adonis, system=system, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, licenseExpiry=licenseExpiry, trapCommandServer=trapCommandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonRunning=dhcpDaemonRunning, trapReplicationFailure=trapReplicationFailure, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haReplicationBinding=haReplicationBinding, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemon=commandServerDaemon, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, dns=dns, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, dnsStats=dnsStats, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTP=trapTFTP, trapHA=trapHA, dnsStatsNXRRSet=dnsStatsNXRRSet, trapSystem=trapSystem, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, licenseValid=licenseValid, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCP=trapDHCP, dhcp=dhcp, trapReplication=trapReplication, dhcpSubnetSize=dhcpSubnetSize, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, dhcpPoolEntry=dhcpPoolEntry, haServiceRunning=haServiceRunning, trapHAServiceFailOver=trapHAServiceFailOver, adonisTraps=adonisTraps, dhcpStats=dhcpStats, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, adonisObjects=adonisObjects, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemon=dhcpDaemon, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIP=dhcpFixedIP, lcd=lcd, dhcpIP=dhcpIP, dhcpPoolSize=dhcpPoolSize, ha=ha, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolStartIP=dhcpPoolStartIP, lcdDaemon=lcdDaemon)
