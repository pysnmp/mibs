...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", systemState=systemState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, licenseValid=licenseValid, dhcpLeaseTable=dhcpLeaseTable, dhcpStats=dhcpStats, dnsStatsReferral=dnsStatsReferral, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemon=tftpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, haServiceRunning=haServiceRunning, dhcpConfig=dhcpConfig, dhcpPoolSize=dhcpPoolSize, haService=haService, trapDNS=trapDNS, dhcpSubnetMask=dhcpSubnetMask, trapCommandServerDaemon=trapCommandServerDaemon, commandServerDaemonRunning=commandServerDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, lcdDaemon=lcdDaemon, dhcpDaemon=dhcpDaemon, trapHA=trapHA, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetTable=dhcpSubnetTable, PYSNMP_MODULE_ID=adonis, trapReplicationFailure=trapReplicationFailure, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpFailOverState=dhcpFailOverState, trapDHCPDaemon=trapDHCPDaemon, dnsStats=dnsStats, dhcpPoolTable=dhcpPoolTable, commandServer=commandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDHCP=trapDHCP, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonis=adonis, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haServiceNodeType=haServiceNodeType, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcp=dhcp, dnsStatsFailure=dnsStatsFailure, trapReplication=trapReplication, dhcpDaemonRunning=dhcpDaemonRunning, lcd=lcd, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dns=dns, trapTFTP=trapTFTP, adonisTraps=adonisTraps, trapCommandServer=trapCommandServer, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetSize=dhcpSubnetSize, haReplicationBinding=haReplicationBinding, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystem=trapSystem, dhcpPoolAlert=dhcpPoolAlert, systemDaemon=systemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPTable=dhcpFixedIPTable)
