...
IpAddress, Counter32, MibIdentifier, TimeTicks, Counter64, enterprises, ObjectIdentity, iso, Unsigned32, Integer32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "MibIdentifier", "TimeTicks", "Counter64", "enterprises", "ObjectIdentity", "iso", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseBindState=dhcpLeaseBindState, trapReplication=trapReplication, dhcp=dhcp, dhcpIP=dhcpIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIP=dhcpFixedIP, tftpDaemon=tftpDaemon, dnsStatsFailure=dnsStatsFailure, trapTFTPDaemon=trapTFTPDaemon, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, lcdDaemon=lcdDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetIP=dhcpSubnetIP, tftp=tftp, haService=haService, systemDaemon=systemDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisTraps=adonisTraps, trapDNSDaemon=trapDNSDaemon, dhcpConfig=dhcpConfig, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemon=dnsDaemon, trapSystem=trapSystem, dhcpLeaseHostname=dhcpLeaseHostname, licenseValid=licenseValid, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapHA=trapHA, dhcpFailOverState=dhcpFailOverState, dhcpPoolSize=dhcpPoolSize, dhcpPoolUsed=dhcpPoolUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, lcd=lcd, dnsStatsSuccess=dnsStatsSuccess, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceNodeType=haServiceNodeType, dhcpPoolAlert=dhcpPoolAlert, trapSystemDaemon=trapSystemDaemon, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, commandServer=commandServer, haServiceRunning=haServiceRunning, dhcpStats=dhcpStats, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonis=adonis, dhcpSubnetMask=dhcpSubnetMask, system=system, dns=dns, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, systemState=systemState, commandServerDaemon=commandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCP=trapDHCP, dhcpLeaseEntry=dhcpLeaseEntry, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp)
