...
IpAddress, Gauge32, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Counter32, MibIdentifier, Unsigned32, ModuleIdentity, Integer32, NotificationType, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Counter32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, haServiceNodeType=haServiceNodeType, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, tftpDaemon=tftpDaemon, trapHA=trapHA, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolEntry=dhcpPoolEntry, ha=ha, trapSystem=trapSystem, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemon=dnsDaemon, dhcpConfig=dhcpConfig, trapCommandServer=trapCommandServer, commandServer=commandServer, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetSize=dhcpSubnetSize, tftp=tftp, dhcpPoolSize=dhcpPoolSize, licenseExpiry=licenseExpiry, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, dnsStatsFailure=dnsStatsFailure, lcd=lcd, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, systemDaemon=systemDaemon, trapTFTP=trapTFTP, haService=haService, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsStatsReferral=dnsStatsReferral, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpIP=dhcpIP, commandServerDaemon=commandServerDaemon, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, dnsStats=dnsStats, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, lcdDaemon=lcdDaemon, dhcpFixedIP=dhcpFixedIP, adonisTraps=adonisTraps, dhcp=dhcp, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolTable=dhcpPoolTable, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCP=trapDHCP, dns=dns, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, trapReplicationFailure=trapReplicationFailure, haReplicationBinding=haReplicationBinding, haServiceRunning=haServiceRunning, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetTable=dhcpSubnetTable, system=system, dhcpStats=dhcpStats)
