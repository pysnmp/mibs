...
Counter32, ModuleIdentity, ObjectIdentity, Bits, TimeTicks, iso, Gauge32, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter64, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "Bits", "TimeTicks", "iso", "Gauge32", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemon=dhcpDaemon, dhcp=dhcp, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCP=trapDHCP, trapSystem=trapSystem, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcpIP=dhcpIP, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIP=dhcpFixedIP, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsFailure=dnsStatsFailure, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dnsStatsReferral=dnsStatsReferral, dns=dns, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, lcd=lcd, tftpDaemon=tftpDaemon, licenseValid=licenseValid, haServiceNodeType=haServiceNodeType, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemon=commandServerDaemon, adonisObjects=adonisObjects, dhcpSubnetUsed=dhcpSubnetUsed, system=system, dnsStatsRecursion=dnsStatsRecursion, systemState=systemState, dhcpSubnetAlert=dhcpSubnetAlert, trapDNS=trapDNS, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, commandServer=commandServer, ha=ha, dhcpFixedIPEntry=dhcpFixedIPEntry, adonis=adonis, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolEndIP=dhcpPoolEndIP, haReplicationBinding=haReplicationBinding, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemDaemon=systemDaemon, dhcpFailOverState=dhcpFailOverState, lcdDaemon=lcdDaemon, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsDaemon=dnsDaemon, trapHA=trapHA, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, trapCommandServer=trapCommandServer, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftp=tftp, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, dhcpPoolStartIP=dhcpPoolStartIP, haService=haService, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTP=trapTFTP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolTable=dhcpPoolTable, dhcpLeaseTable=dhcpLeaseTable, trapSystemDaemon=trapSystemDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert)
