...
IpAddress, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter64, enterprises, Gauge32, NotificationType, ModuleIdentity, Bits, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter64", "enterprises", "Gauge32", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemon=dhcpDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, systemDaemon=systemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, commandServer=commandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsReferral=dnsStatsReferral, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonisObjects=adonisObjects, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolTable=dhcpPoolTable, trapDHCP=trapDHCP, trapCommandServer=trapCommandServer, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetIP=dhcpSubnetIP, haServiceNodeType=haServiceNodeType, dhcpPoolEntry=dhcpPoolEntry, lcd=lcd, dhcpPoolSize=dhcpPoolSize, dhcpPoolAlert=dhcpPoolAlert, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIPTable=dhcpFixedIPTable, tftp=tftp, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonRunning=dnsDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHostname=dhcpLeaseHostname, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, trapHA=trapHA, trapSystem=trapSystem, dnsStatsFailure=dnsStatsFailure, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, trapReplication=trapReplication, dnsDaemon=dnsDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, systemState=systemState, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemon=commandServerDaemon, trapTFTP=trapTFTP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNS=trapDNS, adonis=adonis, dhcpFailOverState=dhcpFailOverState, dhcpFixedIP=dhcpFixedIP, haServiceRunning=haServiceRunning, system=system, dhcpSubnetTable=dhcpSubnetTable, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, licenseExpiry=licenseExpiry, tftpDaemon=tftpDaemon, trapSystemDaemon=trapSystemDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, trapTFTPDaemon=trapTFTPDaemon, dnsStats=dnsStats, licenseValid=licenseValid, dns=dns, dhcp=dhcp, haService=haService, lcdDaemon=lcdDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcpStats=dhcpStats, trapDNSDaemon=trapDNSDaemon)
