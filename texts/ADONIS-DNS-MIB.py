...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Unsigned32, TimeTicks, IpAddress, iso, Counter32, ModuleIdentity, Bits, Gauge32, MibIdentifier, enterprises, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Unsigned32", "TimeTicks", "IpAddress", "iso", "Counter32", "ModuleIdentity", "Bits", "Gauge32", "MibIdentifier", "enterprises", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, dhcpStats=dhcpStats, lcdDaemon=lcdDaemon, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFailOverState=dhcpFailOverState, trapSystem=trapSystem, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseStartTime=dhcpLeaseStartTime, tftpDaemon=tftpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, tftp=tftp, dhcpSubnetAlert=dhcpSubnetAlert, haServiceNodeType=haServiceNodeType, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemon=dhcpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolTable=dhcpPoolTable, dnsStatsFailure=dnsStatsFailure, dhcpIP=dhcpIP, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, systemState=systemState, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, dhcpConfig=dhcpConfig, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemon=commandServerDaemon, dhcpPoolUsed=dhcpPoolUsed, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceRunning=haServiceRunning, trapHA=trapHA, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseTable=dhcpLeaseTable, dnsStats=dnsStats, trapReplication=trapReplication, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemon=dnsDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dns=dns, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, adonis=adonis, licenseValid=licenseValid, dhcp=dhcp, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, lcd=lcd, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsRecursion=dnsStatsRecursion, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetSize=dhcpSubnetSize, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, licenseExpiry=licenseExpiry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCP=trapDHCP, system=system, commandServer=commandServer, dhcpFixedIP=dhcpFixedIP, dhcpPoolEntry=dhcpPoolEntry, haReplicationBinding=haReplicationBinding, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress)
