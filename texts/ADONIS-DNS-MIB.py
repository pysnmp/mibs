...
enterprises, IpAddress, ObjectIdentity, Counter64, Unsigned32, Gauge32, ModuleIdentity, iso, Bits, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "ObjectIdentity", "Counter64", "Unsigned32", "Gauge32", "ModuleIdentity", "iso", "Bits", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcdDaemon=lcdDaemon, trapHA=trapHA, dhcpFixedIP=dhcpFixedIP, trapTFTP=trapTFTP, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServerDaemon=commandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolAlert=dhcpPoolAlert, haReplicationBinding=haReplicationBinding, haServiceNodeType=haServiceNodeType, dhcp=dhcp, trapDHCPDaemon=trapDHCPDaemon, haService=haService, dnsStats=dnsStats, dhcpLeaseEndTime=dhcpLeaseEndTime, PYSNMP_MODULE_ID=adonis, haServiceRunning=haServiceRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, licenseValid=licenseValid, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, ha=ha, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolSize=dhcpPoolSize, adonis=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsReferral=dnsStatsReferral, dnsDaemon=dnsDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapReplicationFailure=trapReplicationFailure, trapDHCP=trapDHCP, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsFailure=dnsStatsFailure, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemon=dhcpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpStats=dhcpStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemon=tftpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapSystem=trapSystem, trapDNS=trapDNS, system=system, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPTable=dhcpFixedIPTable, adonisTraps=adonisTraps, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, trapReplication=trapReplication, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftp=tftp, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsSuccess=dnsStatsSuccess, trapSystemDaemon=trapSystemDaemon, systemDaemon=systemDaemon, lcd=lcd, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, trapDNSDaemon=trapDNSDaemon, dns=dns, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetMask=dhcpSubnetMask, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetEntry=dhcpSubnetEntry)
