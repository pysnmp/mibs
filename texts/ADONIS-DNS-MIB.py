...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServerDaemon=commandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, PYSNMP_MODULE_ID=adonis, dhcpConfig=dhcpConfig, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsReferral=dnsStatsReferral, dnsDaemon=dnsDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpIP=dhcpIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolUsed=dhcpPoolUsed, dnsStatsFailure=dnsStatsFailure, adonis=adonis, trapTFTPDaemon=trapTFTPDaemon, tftpDaemon=tftpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemState=systemState, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, haReplicationBinding=haReplicationBinding, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, ha=ha, trapDHCP=trapDHCP, dnsStats=dnsStats, trapSystem=trapSystem, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, licenseValid=licenseValid, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, commandServerDaemonRunning=commandServerDaemonRunning, lcdDaemon=lcdDaemon, dhcpStats=dhcpStats, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHAServiceFailOver=trapHAServiceFailOver, tftp=tftp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisObjects=adonisObjects, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haService=haService, dnsStatsNXRRSet=dnsStatsNXRRSet, adonisTraps=adonisTraps, trapTFTP=trapTFTP, trapDNS=trapDNS, licenseExpiry=licenseExpiry, trapReplication=trapReplication, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTable=dhcpLeaseTable, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseStartTime=dhcpLeaseStartTime, lcd=lcd, system=system, dhcp=dhcp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNSDaemon=trapDNSDaemon, dhcpDaemon=dhcpDaemon, trapSystemDaemon=trapSystemDaemon, dhcpPoolTable=dhcpPoolTable, dns=dns, dhcpSubnetSize=dhcpSubnetSize, tftpDaemonRunning=tftpDaemonRunning, trapHA=trapHA, trapCommandServer=trapCommandServer, dhcpFixedIP=dhcpFixedIP, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
