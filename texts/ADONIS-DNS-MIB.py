...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, enterprises, MibIdentifier, IpAddress, ModuleIdentity, NotificationType, Unsigned32, Gauge32, Counter64, Bits, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "enterprises", "MibIdentifier", "IpAddress", "ModuleIdentity", "NotificationType", "Unsigned32", "Gauge32", "Counter64", "Bits", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetMask=dhcpSubnetMask, dns=dns, dhcpPoolSize=dhcpPoolSize, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFailOverState=dhcpFailOverState, dhcpDaemon=dhcpDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, trapHAServiceFailOver=trapHAServiceFailOver, ha=ha, adonisObjects=adonisObjects, lcdDaemon=lcdDaemon, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, trapDNSDaemon=trapDNSDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsFailure=dnsStatsFailure, haServiceRunning=haServiceRunning, dnsStats=dnsStats, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonRunning=dhcpDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemon=tftpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetTable=dhcpSubnetTable, haServiceNodeType=haServiceNodeType, commandServer=commandServer, haReplicationBinding=haReplicationBinding, haService=haService, trapTFTP=trapTFTP, trapDHCP=trapDHCP, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsReferral=dnsStatsReferral, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServer=trapCommandServer, tftp=tftp, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIP=dhcpFixedIP, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystem=trapSystem, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonRunning=dnsDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpIP=dhcpIP, licenseValid=licenseValid, adonisTraps=adonisTraps, trapHA=trapHA, dhcp=dhcp, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, dhcpPoolEntry=dhcpPoolEntry, dhcpConfig=dhcpConfig, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolTable=dhcpPoolTable, trapReplication=trapReplication, trapDNS=trapDNS, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsSuccess=dnsStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, systemDaemon=systemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemState=systemState, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, system=system, dhcpLeaseStartTime=dhcpLeaseStartTime, adonis=adonis, licenseExpiry=licenseExpiry)
