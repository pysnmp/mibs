...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapCommandServer=trapCommandServer, dhcpStats=dhcpStats, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsReferral=dnsStatsReferral, licenseExpiry=licenseExpiry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEntry=dhcpPoolEntry, PYSNMP_MODULE_ID=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, trapSystem=trapSystem, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, lcdDaemon=lcdDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, adonis=adonis, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSize=dhcpPoolSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpSubnetSize=dhcpSubnetSize, haServiceRunning=haServiceRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonRunning=dnsDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, trapHA=trapHA, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcpPoolTable=dhcpPoolTable, dhcp=dhcp, dns=dns, systemDaemon=systemDaemon, licenseValid=licenseValid, dnsStatsFailure=dnsStatsFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIP=dhcpFixedIP, ha=ha, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolUsed=dhcpPoolUsed, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetEntry=dhcpSubnetEntry, tftp=tftp, adonisObjects=adonisObjects, commandServerDaemon=commandServerDaemon, trapSystemDaemon=trapSystemDaemon, dnsStats=dnsStats, trapDNS=trapDNS, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpIP=dhcpIP, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemon=dhcpDaemon, trapReplicationFailure=trapReplicationFailure, trapDHCP=trapDHCP, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXDomain=dnsStatsNXDomain, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemonRunning=commandServerDaemonRunning, trapReplication=trapReplication, system=system, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetTable=dhcpSubnetTable, dnsDaemon=dnsDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServer=commandServer, trapTFTP=trapTFTP, dhcpConfig=dhcpConfig)
