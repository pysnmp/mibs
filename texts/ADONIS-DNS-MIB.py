...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftpDaemonRunning=tftpDaemonRunning, system=system, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, trapDNSDaemon=trapDNSDaemon, adonisTraps=adonisTraps, adonis=adonis, systemDaemon=systemDaemon, haServiceRunning=haServiceRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, PYSNMP_MODULE_ID=adonis, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetMask=dhcpSubnetMask, licenseExpiry=licenseExpiry, trapSystem=trapSystem, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dns=dns, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsRecursion=dnsStatsRecursion, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemState=systemState, dhcpDaemon=dhcpDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, dhcpLeaseEntry=dhcpLeaseEntry, trapDHCP=trapDHCP, dnsDaemonRunning=dnsDaemonRunning, adonisObjects=adonisObjects, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, tftpDaemon=tftpDaemon, dnsStatsReferral=dnsStatsReferral, tftp=tftp, dhcpLeaseTable=dhcpLeaseTable, trapHA=trapHA, trapCommandServerDaemon=trapCommandServerDaemon, commandServerDaemon=commandServerDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolAlert=dhcpPoolAlert, trapReplicationFailure=trapReplicationFailure, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTP=trapTFTP, dnsDaemon=dnsDaemon, haReplicationBinding=haReplicationBinding, dhcpIP=dhcpIP, dnsStatsNXRRSet=dnsStatsNXRRSet, haService=haService, dhcpPoolTable=dhcpPoolTable, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, dhcp=dhcp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, trapDNS=trapDNS, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsFailure=dnsStatsFailure, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIP=dhcpFixedIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystemDaemon=trapSystemDaemon, dhcpPoolUsed=dhcpPoolUsed, haServiceNodeType=haServiceNodeType, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetTable=dhcpSubnetTable, dnsStats=dnsStats, dhcpPoolEndIP=dhcpPoolEndIP)
