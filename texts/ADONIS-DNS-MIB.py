...
Counter32, Gauge32, iso, enterprises, Bits, Integer32, IpAddress, ObjectIdentity, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "iso", "enterprises", "Bits", "Integer32", "IpAddress", "ObjectIdentity", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, licenseValid=licenseValid, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, licenseExpiry=licenseExpiry, dhcpStats=dhcpStats, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, tftp=tftp, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, system=system, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHostname=dhcpLeaseHostname, trapDNS=trapDNS, dhcpPoolSize=dhcpPoolSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, PYSNMP_MODULE_ID=adonis, trapTFTP=trapTFTP, haServiceRunning=haServiceRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsFailure=dnsStatsFailure, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, dnsStatsRecursion=dnsStatsRecursion, lcd=lcd, trapCommandServerDaemon=trapCommandServerDaemon, trapHAServiceFailOver=trapHAServiceFailOver, adonis=adonis, haServiceNodeType=haServiceNodeType, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemon=dhcpDaemon, trapDNSDaemon=trapDNSDaemon, dhcpPoolTable=dhcpPoolTable, ha=ha, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystem=trapSystem, commandServer=commandServer, haService=haService, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCPDaemon=trapDHCPDaemon, dhcpIP=dhcpIP, systemState=systemState, dnsStatsSuccess=dnsStatsSuccess, dns=dns, commandServerDaemonRunning=commandServerDaemonRunning, dhcp=dhcp, dhcpLeaseEntry=dhcpLeaseEntry, tftpDaemon=tftpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, haReplicationBinding=haReplicationBinding, trapReplication=trapReplication, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCP=trapDHCP, dhcpSubnetSize=dhcpSubnetSize, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStats=dnsStats, trapReplicationFailure=trapReplicationFailure, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolStartIP=dhcpPoolStartIP, adonisObjects=adonisObjects, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, dhcpConfig=dhcpConfig, trapHA=trapHA)
