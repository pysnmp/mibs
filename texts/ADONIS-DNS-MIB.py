...
ObjectIdentity, NotificationType, Bits, Integer32, Gauge32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Counter32, Counter64, TimeTicks, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "Integer32", "Gauge32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Counter32", "Counter64", "TimeTicks", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsSuccess=dnsStatsSuccess, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcp=dhcp, dhcpPoolTable=dhcpPoolTable, dhcpPoolEndIP=dhcpPoolEndIP, trapHA=trapHA, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, lcdDaemon=lcdDaemon, dns=dns, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolAlert=dhcpPoolAlert, lcd=lcd, dhcpDaemon=dhcpDaemon, dhcpFailOverState=dhcpFailOverState, dhcpConfig=dhcpConfig, commandServer=commandServer, tftpDaemon=tftpDaemon, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP, dhcpPoolUsed=dhcpPoolUsed, trapTFTP=trapTFTP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsReferral=dnsStatsReferral, trapReplication=trapReplication, system=system, dhcpSubnetTable=dhcpSubnetTable, haServiceNodeType=haServiceNodeType, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSize=dhcpPoolSize, PYSNMP_MODULE_ID=adonis, dnsStats=dnsStats, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapSystemDaemon=trapSystemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetSize=dhcpSubnetSize, trapSystem=trapSystem, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, commandServerDaemon=commandServerDaemon, adonis=adonis, systemState=systemState, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetEntry=dhcpSubnetEntry, tftp=tftp, trapDNSDaemon=trapDNSDaemon, dhcpIP=dhcpIP, adonisTraps=adonisTraps, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIPTable=dhcpFixedIPTable, systemDaemon=systemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftpDaemonRunning=tftpDaemonRunning, licenseValid=licenseValid, haReplicationBinding=haReplicationBinding, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsFailure=dnsStatsFailure, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTPDaemon=trapTFTPDaemon, haServiceRunning=haServiceRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, ha=ha, dhcpLeaseStartTime=dhcpLeaseStartTime, adonisObjects=adonisObjects, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemon=dnsDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetMask=dhcpSubnetMask, trapCommandServer=trapCommandServer)
