...
Counter32, TimeTicks, MibIdentifier, NotificationType, IpAddress, ObjectIdentity, iso, Gauge32, Unsigned32, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "MibIdentifier", "NotificationType", "IpAddress", "ObjectIdentity", "iso", "Gauge32", "Unsigned32", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, adonisObjects=adonisObjects, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapCommandServerDaemon=trapCommandServerDaemon, dnsStats=dnsStats, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsNXRRSet=dnsStatsNXRRSet, trapHA=trapHA, lcd=lcd, tftp=tftp, dhcpSubnetMask=dhcpSubnetMask, dns=dns, tftpDaemon=tftpDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcdDaemon=lcdDaemon, dhcpDaemon=dhcpDaemon, dhcpFailOverState=dhcpFailOverState, dhcp=dhcp, trapReplication=trapReplication, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTable=dhcpLeaseTable, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapReplicationFailure=trapReplicationFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIP=dhcpFixedIP, dnsStatsReferral=dnsStatsReferral, dnsStatsFailure=dnsStatsFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, ha=ha, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEntry=dhcpPoolEntry, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolEndIP=dhcpPoolEndIP, haService=haService, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, systemState=systemState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapSystem=trapSystem, dhcpConfig=dhcpConfig, systemDaemon=systemDaemon, system=system, trapDNSDaemon=trapDNSDaemon, trapTFTP=trapTFTP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCP=trapDHCP, licenseValid=licenseValid, dnsDaemon=dnsDaemon, dhcpPoolTable=dhcpPoolTable, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetEntry=dhcpSubnetEntry, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, trapDNS=trapDNS, dhcpFixedIPTable=dhcpFixedIPTable, dhcpStats=dhcpStats, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetSize=dhcpSubnetSize, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolSize=dhcpPoolSize, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, adonisTraps=adonisTraps, dhcpIP=dhcpIP, trapSystemDaemon=trapSystemDaemon, dhcpPoolUsed=dhcpPoolUsed, trapCommandServer=trapCommandServer, dnsDaemonRunning=dnsDaemonRunning)
