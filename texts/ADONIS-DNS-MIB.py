...
enterprises, iso, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, ModuleIdentity, Bits, Unsigned32, Counter32, NotificationType, TimeTicks, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Bits", "Unsigned32", "Counter32", "NotificationType", "TimeTicks", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, dnsStats=dnsStats, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIP=dhcpFixedIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFailOverState=dhcpFailOverState, haServiceRunning=haServiceRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemDaemon=systemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, trapSystem=trapSystem, dhcpLeaseBindState=dhcpLeaseBindState, lcdDaemon=lcdDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, system=system, dhcpPoolSize=dhcpPoolSize, trapDHCPDaemon=trapDHCPDaemon, adonisTraps=adonisTraps, dhcpLeaseTable=dhcpLeaseTable, trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, dhcpConfig=dhcpConfig, PYSNMP_MODULE_ID=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, adonis=adonis, commandServer=commandServer, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, licenseValid=licenseValid, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemon=tftpDaemon, systemState=systemState, dhcp=dhcp, dnsStatsReferral=dnsStatsReferral, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServerDaemon=commandServerDaemon, dhcpSubnetTable=dhcpSubnetTable, haService=haService, dnsStatsFailure=dnsStatsFailure, dhcpStats=dhcpStats, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsSuccess=dnsStatsSuccess, dns=dns, trapSystemDaemon=trapSystemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCP=trapDHCP, tftp=tftp, dhcpIP=dhcpIP, trapDNSDaemon=trapDNSDaemon, haServiceNodeType=haServiceNodeType, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemon=dhcpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, tftpDaemonRunning=tftpDaemonRunning, trapTFTP=trapTFTP, ha=ha, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, licenseExpiry=licenseExpiry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHostname=dhcpLeaseHostname, lcd=lcd, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisObjects=adonisObjects, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert)
