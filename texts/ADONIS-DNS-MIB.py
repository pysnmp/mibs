...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Bits, IpAddress, ObjectIdentity, Counter32, MibIdentifier, Integer32, NotificationType, TimeTicks, ModuleIdentity, Unsigned32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Bits", "IpAddress", "ObjectIdentity", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks", "ModuleIdentity", "Unsigned32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, trapTFTPDaemon=trapTFTPDaemon, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, lcd=lcd, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonRunning=dhcpDaemonRunning, dnsStats=dnsStats, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, dhcpSubnetUsed=dhcpSubnetUsed, licenseValid=licenseValid, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, dns=dns, lcdDaemon=lcdDaemon, trapDNSDaemon=trapDNSDaemon, commandServerDaemon=commandServerDaemon, systemDaemon=systemDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, dnsStatsReferral=dnsStatsReferral, tftp=tftp, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCP=trapDHCP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haServiceNodeType=haServiceNodeType, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, dhcpDaemon=dhcpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpIP=dhcpIP, trapHA=trapHA, dhcpPoolSize=dhcpPoolSize, dnsDaemon=dnsDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServerDaemon=trapCommandServerDaemon, licenseExpiry=licenseExpiry, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEntry=dhcpLeaseEntry, tftpDaemon=tftpDaemon, dhcpConfig=dhcpConfig, dhcpSubnetAlert=dhcpSubnetAlert, adonisTraps=adonisTraps, commandServerDaemonRunning=commandServerDaemonRunning, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisObjects=adonisObjects, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFixedIP=dhcpFixedIP, trapReplicationFailure=trapReplicationFailure, systemState=systemState, dhcpSubnetTable=dhcpSubnetTable, trapSystem=trapSystem, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcp=dhcp, trapTFTP=trapTFTP, system=system, ha=ha, dhcpPoolStartIP=dhcpPoolStartIP)
