...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Gauge32, enterprises, iso, IpAddress, Unsigned32, Bits, ModuleIdentity, Counter64, ObjectIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Gauge32", "enterprises", "iso", "IpAddress", "Unsigned32", "Bits", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetTable=dhcpSubnetTable, dhcpStats=dhcpStats, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, haServiceRunning=haServiceRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonRunning=dnsDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, haService=haService, systemDaemon=systemDaemon, dnsStatsReferral=dnsStatsReferral, dnsStatsFailure=dnsStatsFailure, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, tftpDaemon=tftpDaemon, commandServerDaemon=commandServerDaemon, dhcpIP=dhcpIP, trapTFTPDaemon=trapTFTPDaemon, dns=dns, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, PYSNMP_MODULE_ID=adonis, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, licenseValid=licenseValid, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSize=dhcpPoolSize, haServiceNodeType=haServiceNodeType, trapTFTP=trapTFTP, tftp=tftp, trapDNSDaemon=trapDNSDaemon, dhcpPoolStartIP=dhcpPoolStartIP, adonis=adonis, system=system, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, dhcpLeaseBindState=dhcpLeaseBindState, lcdDaemon=lcdDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCP=trapDHCP, haReplicationBinding=haReplicationBinding, commandServer=commandServer, dhcpConfig=dhcpConfig, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisObjects=adonisObjects, trapHA=trapHA, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCPDaemon=trapDHCPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, ha=ha, dhcpFixedIPTable=dhcpFixedIPTable, adonisTraps=adonisTraps, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, dhcpDaemon=dhcpDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, licenseExpiry=licenseExpiry, trapReplication=trapReplication, trapCommandServer=trapCommandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, lcd=lcd, dhcp=dhcp, dnsStatsRecursion=dnsStatsRecursion)
