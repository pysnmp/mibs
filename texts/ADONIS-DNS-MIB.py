...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpIP=dhcpIP, lcdDaemon=lcdDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haServiceNodeType=haServiceNodeType, dnsStatsFailure=dnsStatsFailure, trapReplication=trapReplication, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolAlert=dhcpPoolAlert, dnsStats=dnsStats, trapCommandServer=trapCommandServer, dhcpSubnetUsed=dhcpSubnetUsed, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, dnsDaemon=dnsDaemon, trapDHCP=trapDHCP, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemon=dhcpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haService=haService, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemon=tftpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, adonis=adonis, dhcpFixedIP=dhcpFixedIP, trapTFTP=trapTFTP, tftpDaemonRunning=tftpDaemonRunning, systemState=systemState, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSize=dhcpPoolSize, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetIP=dhcpSubnetIP, dnsStatsNXDomain=dnsStatsNXDomain, trapHA=trapHA, commandServerDaemon=commandServerDaemon, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetMask=dhcpSubnetMask, dns=dns, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpDaemonRunning=dhcpDaemonRunning, adonisTraps=adonisTraps, dhcpConfig=dhcpConfig, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcd=lcd, dhcpFailOverState=dhcpFailOverState, dhcpSubnetTable=dhcpSubnetTable, dnsStatsSuccess=dnsStatsSuccess, haReplicationBinding=haReplicationBinding, adonisObjects=adonisObjects, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dhcpPoolTable=dhcpPoolTable, commandServer=commandServer, system=system, trapSystem=trapSystem, dhcpLeaseHostname=dhcpLeaseHostname, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, tftp=tftp, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetEntry=dhcpSubnetEntry, trapSystemDaemon=trapSystemDaemon, licenseValid=licenseValid, dhcpSubnetAlert=dhcpSubnetAlert)
