...
Unsigned32, IpAddress, Integer32, ObjectIdentity, ModuleIdentity, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, TimeTicks, Counter32, MibIdentifier, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "ObjectIdentity", "ModuleIdentity", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "TimeTicks", "Counter32", "MibIdentifier", "Counter64", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, dnsStatsSuccess=dnsStatsSuccess, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, trapSystem=trapSystem, dhcpConfig=dhcpConfig, system=system, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolTable=dhcpPoolTable, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemon=dnsDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpFailOverState=dhcpFailOverState, haServiceNodeType=haServiceNodeType, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDNS=trapDNS, ha=ha, dhcpFixedIP=dhcpFixedIP, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServerDaemon=trapCommandServerDaemon, lcd=lcd, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsRecursion=dnsStatsRecursion, dns=dns, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSize=dhcpPoolSize, lcdDaemon=lcdDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServerDaemon=commandServerDaemon, dnsStatsFailure=dnsStatsFailure, licenseExpiry=licenseExpiry, trapDHCP=trapDHCP, dnsStatsNXRRSet=dnsStatsNXRRSet, tftp=tftp, licenseValid=licenseValid, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapReplication=trapReplication, haService=haService, dhcpPoolAlert=dhcpPoolAlert, dhcp=dhcp, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, trapTFTP=trapTFTP, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpStats=dhcpStats, adonisObjects=adonisObjects, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNSDaemon=trapDNSDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, trapHA=trapHA, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTPDaemon=trapTFTPDaemon, trapCommandServer=trapCommandServer, dhcpDaemon=dhcpDaemon, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonisTraps=adonisTraps, systemDaemon=systemDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState)
