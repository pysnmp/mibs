...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, ha=ha, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSize=dhcpPoolSize, dnsDaemon=dnsDaemon, trapDNS=trapDNS, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplication=trapReplication, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolTable=dhcpPoolTable, system=system, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haService=haService, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, dnsStats=dnsStats, trapSystemDaemon=trapSystemDaemon, adonisObjects=adonisObjects, commandServer=commandServer, dhcpFailOverState=dhcpFailOverState, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIP=dhcpFixedIP, tftpDaemonRunning=tftpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTP=trapTFTP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemon=tftpDaemon, dhcpDaemon=dhcpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dns=dns, dhcpPoolStartIP=dhcpPoolStartIP, trapSystem=trapSystem, dhcpPoolEndIP=dhcpPoolEndIP, lcdDaemon=lcdDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haReplicationBinding=haReplicationBinding, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, adonisTraps=adonisTraps, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftp=tftp, dnsStatsNXDomain=dnsStatsNXDomain, dhcpConfig=dhcpConfig, PYSNMP_MODULE_ID=adonis, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, licenseValid=licenseValid, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServerDaemon=commandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceNodeType=haServiceNodeType, dhcpIP=dhcpIP, dnsStatsFailure=dnsStatsFailure, systemState=systemState, lcd=lcd, dhcp=dhcp, licenseExpiry=licenseExpiry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseBindState=dhcpLeaseBindState, dhcpStats=dhcpStats)
