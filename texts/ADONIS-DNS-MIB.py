...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Gauge32, Bits, NotificationType, TimeTicks, Counter32, enterprises, IpAddress, ModuleIdentity, MibIdentifier, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Gauge32", "Bits", "NotificationType", "TimeTicks", "Counter32", "enterprises", "IpAddress", "ModuleIdentity", "MibIdentifier", "iso", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolStartIP=dhcpPoolStartIP, trapHA=trapHA, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, systemState=systemState, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTPDaemon=trapTFTPDaemon, adonisTraps=adonisTraps, PYSNMP_MODULE_ID=adonis, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolTable=dhcpPoolTable, dhcpIP=dhcpIP, commandServerDaemon=commandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, tftpDaemonRunning=tftpDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsStatsReferral=dnsStatsReferral, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, dnsStatsFailure=dnsStatsFailure, dhcp=dhcp, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, lcd=lcd, tftp=tftp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, dhcpPoolAlert=dhcpPoolAlert, dnsStatsSuccess=dnsStatsSuccess, ha=ha, trapDNS=trapDNS, dhcpLeaseHostname=dhcpLeaseHostname, haServiceNodeType=haServiceNodeType, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemon=dnsDaemon, dhcpPoolUsed=dhcpPoolUsed, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, trapSystem=trapSystem, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEndIP=dhcpPoolEndIP, trapCommandServerDaemon=trapCommandServerDaemon, licenseValid=licenseValid, dhcpSubnetSize=dhcpSubnetSize, haReplicationBinding=haReplicationBinding, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTable=dhcpLeaseTable, dns=dns, commandServer=commandServer, haServiceRunning=haServiceRunning, trapTFTP=trapTFTP, licenseExpiry=licenseExpiry, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, trapReplication=trapReplication, trapSystemDaemon=trapSystemDaemon, dnsStats=dnsStats, trapDHCP=trapDHCP, haService=haService, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcdDaemon=lcdDaemon, system=system, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert)
