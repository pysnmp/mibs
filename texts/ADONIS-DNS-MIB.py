...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemon=dnsDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPTable=dhcpFixedIPTable, lcdDaemon=lcdDaemon, adonisTraps=adonisTraps, trapHA=trapHA, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, dhcpDaemon=dhcpDaemon, trapSystemDaemon=trapSystemDaemon, dhcp=dhcp, haServiceNodeType=haServiceNodeType, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCP=trapDHCP, lcd=lcd, dhcpSubnetIP=dhcpSubnetIP, haServiceRunning=haServiceRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNSDaemon=trapDNSDaemon, dns=dns, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXDomain=dnsStatsNXDomain, licenseValid=licenseValid, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapReplication=trapReplication, trapTFTP=trapTFTP, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsFailure=dnsStatsFailure, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, adonisObjects=adonisObjects, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSize=dhcpPoolSize, adonis=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, tftp=tftp, trapCommandServer=trapCommandServer, dhcpFailOverState=dhcpFailOverState, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, ha=ha, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, trapDNS=trapDNS, commandServer=commandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, system=system, dhcpSubnetAlert=dhcpSubnetAlert, trapReplicationFailure=trapReplicationFailure, dhcpIP=dhcpIP, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, dhcpStats=dhcpStats, systemDaemon=systemDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolUsed=dhcpPoolUsed, tftpDaemon=tftpDaemon, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, haService=haService, haReplicationBinding=haReplicationBinding, dnsStatsRecursion=dnsStatsRecursion)
