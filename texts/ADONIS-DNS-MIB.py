...
Counter64, Integer32, IpAddress, ObjectIdentity, iso, TimeTicks, Counter32, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Bits, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "IpAddress", "ObjectIdentity", "iso", "TimeTicks", "Counter32", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Bits", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, dnsStatsNXDomain=dnsStatsNXDomain, dhcpConfig=dhcpConfig, dhcpPoolSize=dhcpPoolSize, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemon=commandServerDaemon, trapDHCP=trapDHCP, adonis=adonis, dhcpIP=dhcpIP, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolEndIP=dhcpPoolEndIP, dnsStats=dnsStats, adonisTraps=adonisTraps, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapReplicationFailure=trapReplicationFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, system=system, dhcpSubnetSize=dhcpSubnetSize, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, dns=dns, dnsStatsFailure=dnsStatsFailure, trapCommandServer=trapCommandServer, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIPTable=dhcpFixedIPTable, systemDaemon=systemDaemon, tftpDaemon=tftpDaemon, commandServer=commandServer, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetAlert=dhcpSubnetAlert, haService=haService, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, licenseExpiry=licenseExpiry, trapHA=trapHA, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonRunning=dnsDaemonRunning, ha=ha, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseValid=licenseValid, lcd=lcd, dhcp=dhcp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemState=systemState, dhcpFixedIP=dhcpFixedIP, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetUsed=dhcpSubnetUsed, PYSNMP_MODULE_ID=adonis, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haServiceNodeType=haServiceNodeType, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, tftp=tftp, tftpDaemonRunning=tftpDaemonRunning, dnsDaemon=dnsDaemon, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable, trapSystemDaemon=trapSystemDaemon, trapDNSDaemon=trapDNSDaemon, adonisObjects=adonisObjects, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, trapDHCPDaemon=trapDHCPDaemon)
