...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, system=system, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, dhcpFailOverState=dhcpFailOverState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsReferral=dnsStatsReferral, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTable=dhcpLeaseTable, dnsStatsNXDomain=dnsStatsNXDomain, lcdDaemon=lcdDaemon, trapReplication=trapReplication, trapSystem=trapSystem, dnsStatsFailure=dnsStatsFailure, dhcpDaemonRunning=dhcpDaemonRunning, systemState=systemState, dhcpPoolSize=dhcpPoolSize, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemon=commandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, trapDNS=trapDNS, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolUsed=dhcpPoolUsed, adonisObjects=adonisObjects, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, adonis=adonis, ha=ha, licenseExpiry=licenseExpiry, lcd=lcd, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystemDaemon=trapSystemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseEntry=dhcpLeaseEntry, trapReplicationFailure=trapReplicationFailure, PYSNMP_MODULE_ID=adonis, haServiceRunning=haServiceRunning, dnsDaemon=dnsDaemon, trapDNSDaemon=trapDNSDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpConfig=dhcpConfig, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsRecursion=dnsStatsRecursion, trapDHCP=trapDHCP, dns=dns, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, systemDaemon=systemDaemon, commandServerDaemonRunning=commandServerDaemonRunning, adonisTraps=adonisTraps, tftp=tftp, trapHA=trapHA, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, haServiceNodeType=haServiceNodeType, dhcpStats=dhcpStats, tftpDaemon=tftpDaemon, dhcpDaemon=dhcpDaemon, dhcp=dhcp, trapTFTP=trapTFTP, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolTable=dhcpPoolTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, trapCommandServer=trapCommandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
