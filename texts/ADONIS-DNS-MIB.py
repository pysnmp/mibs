...
IpAddress, ModuleIdentity, Integer32, ObjectIdentity, iso, NotificationType, Counter64, MibIdentifier, enterprises, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Integer32", "ObjectIdentity", "iso", "NotificationType", "Counter64", "MibIdentifier", "enterprises", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, dhcpConfig=dhcpConfig, tftp=tftp, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServer=trapCommandServer, dnsDaemon=dnsDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIP=dhcpFixedIP, dhcpIP=dhcpIP, licenseExpiry=licenseExpiry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolEntry=dhcpPoolEntry, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemState=systemState, dhcpPoolAlert=dhcpPoolAlert, trapReplication=trapReplication, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEntry=dhcpLeaseEntry, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, lcd=lcd, commandServerDaemon=commandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServerDaemonRunning=commandServerDaemonRunning, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, dns=dns, haServiceNodeType=haServiceNodeType, trapTFTP=trapTFTP, adonisTraps=adonisTraps, dhcpDaemon=dhcpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, adonisObjects=adonisObjects, dhcpPoolSize=dhcpPoolSize, dnsDaemonRunning=dnsDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, PYSNMP_MODULE_ID=adonis, dhcpSubnetUsed=dhcpSubnetUsed, haServiceRunning=haServiceRunning, adonis=adonis, dnsStatsReferral=dnsStatsReferral, trapDNSDaemon=trapDNSDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolUsed=dhcpPoolUsed, haReplicationBinding=haReplicationBinding, tftpDaemon=tftpDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetSize=dhcpSubnetSize, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, ha=ha, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, haService=haService, licenseValid=licenseValid, commandServer=commandServer, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, trapDNS=trapDNS, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcp=dhcp, trapHA=trapHA, trapSystem=trapSystem, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTable=dhcpLeaseTable)
