...
IpAddress, Counter64, TimeTicks, Counter32, iso, enterprises, Unsigned32, Bits, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "TimeTicks", "Counter32", "iso", "enterprises", "Unsigned32", "Bits", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseHostname=dhcpLeaseHostname, haService=haService, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, commandServerDaemonRunning=commandServerDaemonRunning, dnsStats=dnsStats, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseExpiry=licenseExpiry, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, adonis=adonis, adonisObjects=adonisObjects, lcdDaemon=lcdDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolStartIP=dhcpPoolStartIP, PYSNMP_MODULE_ID=adonis, licenseValid=licenseValid, dhcpLeaseTable=dhcpLeaseTable, tftp=tftp, dnsStatsReferral=dnsStatsReferral, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcp=dhcp, trapReplication=trapReplication, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIP=dhcpFixedIP, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapHA=trapHA, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, dnsStatsFailure=dnsStatsFailure, system=system, dhcpPoolSize=dhcpPoolSize, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haServiceRunning=haServiceRunning, trapReplicationFailure=trapReplicationFailure, dhcpIP=dhcpIP, adonisTraps=adonisTraps, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFailOverState=dhcpFailOverState, systemState=systemState, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCP=trapDHCP, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXRRSet=dnsStatsNXRRSet, dns=dns, systemDaemon=systemDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseBindState=dhcpLeaseBindState, trapDHCPDaemon=trapDHCPDaemon, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime, haServiceNodeType=haServiceNodeType, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystemDaemon=trapSystemDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemon=dhcpDaemon, dnsStatsNXDomain=dnsStatsNXDomain, commandServer=commandServer, trapSystem=trapSystem)
