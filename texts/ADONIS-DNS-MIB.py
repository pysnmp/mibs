...
Counter64, Unsigned32, Counter32, enterprises, Integer32, Bits, IpAddress, Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Counter32", "enterprises", "Integer32", "Bits", "IpAddress", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIP=dhcpFixedIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseStartTime=dhcpLeaseStartTime, tftp=tftp, systemState=systemState, trapReplicationFailure=trapReplicationFailure, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTable=dhcpLeaseTable, dnsStatsSuccess=dnsStatsSuccess, dns=dns, trapDHCP=trapDHCP, dhcpSubnetMask=dhcpSubnetMask, licenseExpiry=licenseExpiry, dhcpLeaseHostname=dhcpLeaseHostname, ha=ha, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dnsDaemon=dnsDaemon, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, lcdDaemon=lcdDaemon, tftpDaemon=tftpDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haReplicationBinding=haReplicationBinding, dnsStatsRecursion=dnsStatsRecursion, dhcpFailOverState=dhcpFailOverState, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNSDaemon=trapDNSDaemon, systemDaemon=systemDaemon, dhcp=dhcp, dhcpStats=dhcpStats, trapTFTP=trapTFTP, trapSystemDaemon=trapSystemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, trapHA=trapHA, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, lcd=lcd, dhcpPoolEndIP=dhcpPoolEndIP, trapSystem=trapSystem, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisTraps=adonisTraps, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetSize=dhcpSubnetSize, haServiceNodeType=haServiceNodeType, system=system, licenseValid=licenseValid, commandServer=commandServer, dnsDaemonRunning=dnsDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpIP=dhcpIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDHCPDaemon=trapDHCPDaemon, adonis=adonis, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsFailure=dnsStatsFailure, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolUsed=dhcpPoolUsed, trapReplication=trapReplication, adonisObjects=adonisObjects, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
