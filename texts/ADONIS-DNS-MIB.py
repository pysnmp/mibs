...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", ha=ha, dhcpPoolEntry=dhcpPoolEntry, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceRunning=haServiceRunning, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, licenseValid=licenseValid, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIP=dhcpFixedIP, trapReplication=trapReplication, dhcpPoolUsed=dhcpPoolUsed, lcdDaemon=lcdDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSize=dhcpPoolSize, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd, trapSystemDaemon=trapSystemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapHA=trapHA, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetMask=dhcpSubnetMask, adonis=adonis, dnsDaemonRunning=dnsDaemonRunning, system=system, dnsStatsNXDomain=dnsStatsNXDomain, trapSystem=trapSystem, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTP=trapTFTP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, dhcpPoolEndIP=dhcpPoolEndIP, PYSNMP_MODULE_ID=adonis, dhcpConfig=dhcpConfig, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, commandServerDaemonRunning=commandServerDaemonRunning, commandServer=commandServer, dhcpPoolStartIP=dhcpPoolStartIP, adonisObjects=adonisObjects, dhcpSubnetSize=dhcpSubnetSize, dnsDaemon=dnsDaemon, systemDaemon=systemDaemon, trapDNS=trapDNS, dnsStatsSuccess=dnsStatsSuccess, dhcp=dhcp, dhcpStats=dhcpStats, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, tftp=tftp, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolTable=dhcpPoolTable, dhcpLeaseEndTime=dhcpLeaseEndTime, systemState=systemState, dnsStatsReferral=dnsStatsReferral, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonisTraps=adonisTraps, dnsStats=dnsStats, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServerDaemon=commandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, haReplicationBinding=haReplicationBinding, trapCommandServer=trapCommandServer, dhcpDaemon=dhcpDaemon, dns=dns, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpIP=dhcpIP)
