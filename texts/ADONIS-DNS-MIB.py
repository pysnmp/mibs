...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, ModuleIdentity, ObjectIdentity, enterprises, Bits, NotificationType, Counter32, Unsigned32, Counter64, Gauge32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "enterprises", "Bits", "NotificationType", "Counter32", "Unsigned32", "Counter64", "Gauge32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetMask=dhcpSubnetMask, ha=ha, trapReplication=trapReplication, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEntry=dhcpPoolEntry, trapDNSDaemon=trapDNSDaemon, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTPDaemon=trapTFTPDaemon, system=system, haServiceRunning=haServiceRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpStats=dhcpStats, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemon=dhcpDaemon, dhcpIP=dhcpIP, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisTraps=adonisTraps, haReplicationBinding=haReplicationBinding, dnsStatsSuccess=dnsStatsSuccess, dnsStatsFailure=dnsStatsFailure, dhcpPoolEndIP=dhcpPoolEndIP, systemDaemon=systemDaemon, lcdDaemon=lcdDaemon, dns=dns, tftpDaemon=tftpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolUsed=dhcpPoolUsed, systemState=systemState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftpDaemonRunning=tftpDaemonRunning, trapCommandServer=trapCommandServer, dhcpSubnetAlert=dhcpSubnetAlert, dhcp=dhcp, dnsStats=dnsStats, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolTable=dhcpPoolTable, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, trapSystemDaemon=trapSystemDaemon, trapTFTP=trapTFTP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEntry=dhcpLeaseEntry, tftp=tftp, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsReferral=dnsStatsReferral, trapSystem=trapSystem, haServiceNodeType=haServiceNodeType, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haService=haService, PYSNMP_MODULE_ID=adonis, commandServer=commandServer, adonisObjects=adonisObjects, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, trapHA=trapHA, dhcpFailOverState=dhcpFailOverState, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, lcd=lcd, dhcpDaemonRunning=dhcpDaemonRunning, licenseExpiry=licenseExpiry, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemon=dnsDaemon, commandServerDaemon=commandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNS=trapDNS, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseHostname=dhcpLeaseHostname, licenseValid=licenseValid, dhcpConfig=dhcpConfig)
