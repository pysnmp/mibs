...
Counter64, iso, Counter32, ObjectIdentity, Integer32, ModuleIdentity, Bits, IpAddress, Gauge32, NotificationType, Unsigned32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "ObjectIdentity", "Integer32", "ModuleIdentity", "Bits", "IpAddress", "Gauge32", "NotificationType", "Unsigned32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetAlert=dhcpSubnetAlert, tftp=tftp, dnsStatsFailure=dnsStatsFailure, adonisTraps=adonisTraps, haService=haService, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolTable=dhcpPoolTable, dnsStatsReferral=dnsStatsReferral, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEntry=dhcpLeaseEntry, haServiceRunning=haServiceRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, system=system, trapSystem=trapSystem, systemState=systemState, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, trapTFTP=trapTFTP, dnsStatsRecursion=dnsStatsRecursion, trapReplication=trapReplication, dhcpConfig=dhcpConfig, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSize=dhcpPoolSize, trapHA=trapHA, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpStats=dhcpStats, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemon=dnsDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, lcd=lcd, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetIP=dhcpSubnetIP, licenseValid=licenseValid, trapReplicationFailure=trapReplicationFailure, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemonRunning=commandServerDaemonRunning, dhcpIP=dhcpIP, trapSystemDaemon=trapSystemDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, adonis=adonis, dnsStats=dnsStats, dhcpFailOverState=dhcpFailOverState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemon=dhcpDaemon, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, trapDHCP=trapDHCP, trapCommandServer=trapCommandServer, dhcpFixedIP=dhcpFixedIP, dnsStatsNXRRSet=dnsStatsNXRRSet, ha=ha, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemon=commandServerDaemon, dhcp=dhcp)
