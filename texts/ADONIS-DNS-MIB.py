...
ObjectIdentity, Counter64, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, enterprises, IpAddress, Bits, Counter32, Gauge32, ModuleIdentity, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "enterprises", "IpAddress", "Bits", "Counter32", "Gauge32", "ModuleIdentity", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemon=tftpDaemon, trapDHCPDaemon=trapDHCPDaemon, licenseExpiry=licenseExpiry, dhcpLeaseHostname=dhcpLeaseHostname, dhcp=dhcp, dnsStatsReferral=dnsStatsReferral, dhcpIP=dhcpIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemState=systemState, dnsDaemonRunning=dnsDaemonRunning, dns=dns, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, tftpDaemonRunning=tftpDaemonRunning, adonis=adonis, tftp=tftp, dnsStats=dnsStats, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, lcdDaemon=lcdDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, trapReplication=trapReplication, dhcpStats=dhcpStats, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolSize=dhcpPoolSize, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServer=trapCommandServer, dhcpPoolTable=dhcpPoolTable, commandServerDaemon=commandServerDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIP=dhcpFixedIP, adonisObjects=adonisObjects, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haServiceNodeType=haServiceNodeType, licenseValid=licenseValid, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXRRSet=dnsStatsNXRRSet, haService=haService, haReplicationBinding=haReplicationBinding, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapSystem=trapSystem, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, ha=ha, adonisTraps=adonisTraps, dhcpSubnetTable=dhcpSubnetTable, system=system, trapDNS=trapDNS, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceRunning=haServiceRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemon=dhcpDaemon, dnsDaemon=dnsDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapHA=trapHA, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCP=trapDHCP, dhcpPoolSubnetIP=dhcpPoolSubnetIP)
