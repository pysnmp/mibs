...
ModuleIdentity, Bits, Counter64, Counter32, Unsigned32, MibIdentifier, iso, NotificationType, enterprises, ObjectIdentity, IpAddress, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter64", "Counter32", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "enterprises", "ObjectIdentity", "IpAddress", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", systemDaemon=systemDaemon, trapDNS=trapDNS, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHA=trapHA, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpConfig=dhcpConfig, dhcpDaemon=dhcpDaemon, dnsDaemon=dnsDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServer=trapCommandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsFailure=dnsStatsFailure, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpStats=dhcpStats, dhcpPoolSize=dhcpPoolSize, dhcp=dhcp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, trapDHCPDaemon=trapDHCPDaemon, adonis=adonis, ha=ha, dhcpPoolEntry=dhcpPoolEntry, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, licenseExpiry=licenseExpiry, dnsDaemonRunning=dnsDaemonRunning, PYSNMP_MODULE_ID=adonis, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, trapReplication=trapReplication, system=system, lcd=lcd, commandServer=commandServer, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, dnsStatsNXDomain=dnsStatsNXDomain, licenseValid=licenseValid, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpIP=dhcpIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haServiceNodeType=haServiceNodeType, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemon=tftpDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapReplicationFailure=trapReplicationFailure, haService=haService, dhcpSubnetMask=dhcpSubnetMask, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolTable=dhcpPoolTable, systemState=systemState, dhcpFailOverState=dhcpFailOverState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapCommandServerDaemon=trapCommandServerDaemon, trapSystem=trapSystem, dns=dns, haReplicationBinding=haReplicationBinding, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetTable=dhcpSubnetTable, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haServiceRunning=haServiceRunning, trapSystemDaemon=trapSystemDaemon, adonisTraps=adonisTraps, commandServerDaemon=commandServerDaemon, adonisObjects=adonisObjects, dnsStatsReferral=dnsStatsReferral, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dnsStatsSuccess=dnsStatsSuccess)
