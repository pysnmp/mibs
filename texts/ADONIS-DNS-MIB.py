...
Unsigned32, MibIdentifier, enterprises, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, IpAddress, Gauge32, iso, Bits, Counter32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "enterprises", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "IpAddress", "Gauge32", "iso", "Bits", "Counter32", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsSuccess=dnsStatsSuccess, dhcpPoolEntry=dhcpPoolEntry, trapDNS=trapDNS, systemState=systemState, dhcpLeaseBindState=dhcpLeaseBindState, dns=dns, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, tftp=tftp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseStartTime=dhcpLeaseStartTime, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonRunning=dhcpDaemonRunning, dhcp=dhcp, dhcpStats=dhcpStats, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemon=dhcpDaemon, commandServerDaemon=commandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapHA=trapHA, dhcpLeaseEndTime=dhcpLeaseEndTime, adonisTraps=adonisTraps, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseHostname=dhcpLeaseHostname, dhcpIP=dhcpIP, lcdDaemon=lcdDaemon, trapDNSDaemon=trapDNSDaemon, adonis=adonis, dhcpPoolTable=dhcpPoolTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisObjects=adonisObjects, dhcpConfig=dhcpConfig, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, lcd=lcd, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapTFTPDaemon=trapTFTPDaemon, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haReplicationBinding=haReplicationBinding, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, dhcpSubnetTable=dhcpSubnetTable, licenseValid=licenseValid, dhcpSubnetSize=dhcpSubnetSize, dnsDaemon=dnsDaemon, dnsStatsFailure=dnsStatsFailure, commandServerDaemonRunning=commandServerDaemonRunning, system=system, trapTFTP=trapTFTP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapReplication=trapReplication, trapSystem=trapSystem, dhcpFailOverState=dhcpFailOverState, systemDaemon=systemDaemon, trapCommandServer=trapCommandServer, tftpDaemon=tftpDaemon, trapDHCPDaemon=trapDHCPDaemon, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, haServiceNodeType=haServiceNodeType, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haService=haService, licenseExpiry=licenseExpiry, dnsStatsReferral=dnsStatsReferral, trapSystemDaemon=trapSystemDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCP=trapDHCP, haServiceRunning=haServiceRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonRunning=dnsDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP)
