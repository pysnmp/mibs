...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonisObjects=adonisObjects, dhcpFixedIP=dhcpFixedIP, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemon=dhcpDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetSize=dhcpSubnetSize, dnsStatsReferral=dnsStatsReferral, tftpDaemonRunning=tftpDaemonRunning, commandServer=commandServer, licenseValid=licenseValid, dhcpPoolSize=dhcpPoolSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftp=tftp, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseExpiry=licenseExpiry, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNSDaemon=trapDNSDaemon, dnsDaemonRunning=dnsDaemonRunning, trapSystem=trapSystem, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFailOverState=dhcpFailOverState, trapReplicationFailure=trapReplicationFailure, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTPDaemon=trapTFTPDaemon, PYSNMP_MODULE_ID=adonis, commandServerDaemon=commandServerDaemon, adonis=adonis, trapHAServiceFailOver=trapHAServiceFailOver, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, dhcpLeaseEntry=dhcpLeaseEntry, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTable=dhcpLeaseTable, dhcpStats=dhcpStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpIP=dhcpIP, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsFailure=dnsStatsFailure, system=system, trapCommandServer=trapCommandServer, trapDHCP=trapDHCP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcp=dhcp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, adonisTraps=adonisTraps, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haService=haService, dnsDaemon=dnsDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, haServiceRunning=haServiceRunning, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIPTable=dhcpFixedIPTable, systemDaemon=systemDaemon, trapHA=trapHA, tftpDaemon=tftpDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsNXRRSet=dnsStatsNXRRSet, lcdDaemon=lcdDaemon, dhcpSubnetUsed=dhcpSubnetUsed, haServiceNodeType=haServiceNodeType, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, lcd=lcd, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, trapDNS=trapDNS, systemState=systemState, trapReplication=trapReplication, haReplicationBinding=haReplicationBinding)
