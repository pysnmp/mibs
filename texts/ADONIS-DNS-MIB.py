...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, lcdDaemon=lcdDaemon, system=system, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonRunning=dnsDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsReferral=dnsStatsReferral, dnsStatsSuccess=dnsStatsSuccess, dhcpIP=dhcpIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServer=commandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcp=dhcp, dhcpFixedIPTable=dhcpFixedIPTable, dns=dns, dhcpConfig=dhcpConfig, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, systemDaemon=systemDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolTable=dhcpPoolTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapSystem=trapSystem, dhcpPoolSize=dhcpPoolSize, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, trapHA=trapHA, dhcpLeaseEntry=dhcpLeaseEntry, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemon=dhcpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseStartTime=dhcpLeaseStartTime, tftpDaemon=tftpDaemon, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, trapDNSDaemon=trapDNSDaemon, tftp=tftp, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisObjects=adonisObjects, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemon=commandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, adonisTraps=adonisTraps, dhcpDaemonRunning=dhcpDaemonRunning, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, haReplicationBinding=haReplicationBinding, dhcpSubnetIP=dhcpSubnetIP, PYSNMP_MODULE_ID=adonis, dhcpLeaseBindState=dhcpLeaseBindState, lcd=lcd, haServiceRunning=haServiceRunning, haServiceNodeType=haServiceNodeType, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCP=trapDHCP, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, licenseExpiry=licenseExpiry, systemState=systemState, trapReplication=trapReplication, trapTFTPDaemon=trapTFTPDaemon, adonis=adonis, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHostname=dhcpLeaseHostname, haService=haService, commandServerDaemonRunning=commandServerDaemonRunning, ha=ha, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIP=dhcpFixedIP, dnsDaemon=dnsDaemon)
