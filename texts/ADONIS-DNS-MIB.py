...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, iso, enterprises, Counter64, Bits, Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, Integer32, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "iso", "enterprises", "Counter64", "Bits", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTP=trapTFTP, dhcpConfig=dhcpConfig, trapSystem=trapSystem, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServer=commandServer, licenseExpiry=licenseExpiry, trapDNS=trapDNS, dnsStatsSuccess=dnsStatsSuccess, adonisTraps=adonisTraps, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, haService=haService, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, system=system, licenseValid=licenseValid, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, dnsStats=dnsStats, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcp=dhcp, dhcpDaemonRunning=dhcpDaemonRunning, haReplicationBinding=haReplicationBinding, tftp=tftp, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapHA=trapHA, dnsDaemon=dnsDaemon, dnsStatsFailure=dnsStatsFailure, dhcpFixedIP=dhcpFixedIP, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpStats=dhcpStats, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, dns=dns, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpIP=dhcpIP, dhcpPoolSize=dhcpPoolSize, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseBindState=dhcpLeaseBindState, ha=ha, dhcpPoolUsed=dhcpPoolUsed, lcd=lcd, adonis=adonis, dhcpSubnetUsed=dhcpSubnetUsed, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemon=dhcpDaemon, trapDHCP=trapDHCP, dhcpFixedIPTable=dhcpFixedIPTable, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftpDaemon=tftpDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetTable=dhcpSubnetTable, adonisObjects=adonisObjects, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, PYSNMP_MODULE_ID=adonis, trapReplication=trapReplication, commandServerDaemon=commandServerDaemon, lcdDaemon=lcdDaemon, trapDNSDaemon=trapDNSDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolTable=dhcpPoolTable, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFailOverState=dhcpFailOverState, dnsStatsReferral=dnsStatsReferral)
