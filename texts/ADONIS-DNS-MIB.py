...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, lcd=lcd, dnsStatsFailure=dnsStatsFailure, haService=haService, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, trapDNSDaemon=trapDNSDaemon, dhcpConfig=dhcpConfig, trapTFTPDaemon=trapTFTPDaemon, dhcp=dhcp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, licenseValid=licenseValid, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServerDaemon=commandServerDaemon, PYSNMP_MODULE_ID=adonis, dhcpFixedIP=dhcpFixedIP, trapDHCPDaemon=trapDHCPDaemon, tftp=tftp, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpIP=dhcpIP, dnsStatsRecursion=dnsStatsRecursion, tftpDaemon=tftpDaemon, trapHA=trapHA, trapReplicationFailure=trapReplicationFailure, dnsStatsReferral=dnsStatsReferral, dhcpPoolAlert=dhcpPoolAlert, dns=dns, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, haReplicationBinding=haReplicationBinding, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplication=trapReplication, adonisTraps=adonisTraps, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, trapTFTP=trapTFTP, licenseExpiry=licenseExpiry, dhcpPoolTable=dhcpPoolTable, dhcpLeaseBindState=dhcpLeaseBindState, adonis=adonis, systemDaemon=systemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFailOverState=dhcpFailOverState, lcdDaemon=lcdDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystem=trapSystem, trapDNS=trapDNS, dhcpLeaseTable=dhcpLeaseTable, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, dhcpLeaseEndTime=dhcpLeaseEndTime, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSize=dhcpPoolSize, dnsDaemonRunning=dnsDaemonRunning, haServiceNodeType=haServiceNodeType, adonisObjects=adonisObjects, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCP=trapDHCP, system=system, trapCommandServer=trapCommandServer, systemState=systemState, haServiceRunning=haServiceRunning, dhcpFixedIPTable=dhcpFixedIPTable)
