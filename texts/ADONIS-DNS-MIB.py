...
ObjectIdentity, MibIdentifier, Counter64, Bits, ModuleIdentity, enterprises, Gauge32, TimeTicks, IpAddress, Counter32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "ModuleIdentity", "enterprises", "Gauge32", "TimeTicks", "IpAddress", "Counter32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dns=dns, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseTable=dhcpLeaseTable, adonisTraps=adonisTraps, dhcpLeaseHostname=dhcpLeaseHostname, haService=haService, dhcpPoolSize=dhcpPoolSize, haServiceNodeType=haServiceNodeType, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetSize=dhcpSubnetSize, commandServer=commandServer, system=system, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseValid=licenseValid, dhcpPoolTable=dhcpPoolTable, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon, licenseExpiry=licenseExpiry, haReplicationBinding=haReplicationBinding, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTP=trapTFTP, PYSNMP_MODULE_ID=adonis, dhcpIP=dhcpIP, trapDHCP=trapDHCP, trapReplicationFailure=trapReplicationFailure, dnsStatsFailure=dnsStatsFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, dhcp=dhcp, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, trapSystem=trapSystem, tftpDaemonRunning=tftpDaemonRunning, dnsDaemon=dnsDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpStats=dhcpStats, trapHA=trapHA, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNSDaemon=trapDNSDaemon, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, tftpDaemon=tftpDaemon, dhcpFixedIP=dhcpFixedIP, tftp=tftp, ha=ha, lcdDaemon=lcdDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapDNS=trapDNS, systemState=systemState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolUsed=dhcpPoolUsed, dnsStatsReferral=dnsStatsReferral, dnsStatsRecursion=dnsStatsRecursion, haServiceRunning=haServiceRunning, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisObjects=adonisObjects, dhcpSubnetEntry=dhcpSubnetEntry, lcd=lcd, commandServerDaemonRunning=commandServerDaemonRunning, systemDaemon=systemDaemon, dnsStats=dnsStats, dnsDaemonRunning=dnsDaemonRunning, adonis=adonis, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemon=dhcpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplication=trapReplication, commandServerDaemon=commandServerDaemon)
