...
Gauge32, iso, ModuleIdentity, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Bits, MibIdentifier, Integer32, enterprises, TimeTicks, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ModuleIdentity", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Bits", "MibIdentifier", "Integer32", "enterprises", "TimeTicks", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNSDaemon=trapDNSDaemon, trapSystem=trapSystem, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonis=adonis, dhcpConfig=dhcpConfig, trapReplication=trapReplication, dns=dns, dhcpPoolAlert=dhcpPoolAlert, licenseExpiry=licenseExpiry, system=system, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServer=commandServer, dnsStats=dnsStats, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, ha=ha, trapCommandServer=trapCommandServer, adonisTraps=adonisTraps, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, tftpDaemon=tftpDaemon, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, adonisObjects=adonisObjects, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsFailure=dnsStatsFailure, dhcpPoolStartIP=dhcpPoolStartIP, commandServerDaemon=commandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFailOverState=dhcpFailOverState, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServerDaemon=trapCommandServerDaemon, systemState=systemState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEndTime=dhcpLeaseEndTime, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpDaemon=dhcpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftp=tftp, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcp=dhcp, dnsDaemon=dnsDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonRunning=dnsDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, haService=haService, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, dhcpLeaseBindState=dhcpLeaseBindState, trapSystemDaemon=trapSystemDaemon, trapHA=trapHA, dhcpIP=dhcpIP, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcd=lcd, haServiceNodeType=haServiceNodeType, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIP=dhcpFixedIP, dhcpLeaseEntry=dhcpLeaseEntry, dhcpStats=dhcpStats, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCP=trapDHCP, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonRunning=dhcpDaemonRunning)
