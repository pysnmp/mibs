...
MibIdentifier, iso, Unsigned32, Bits, ModuleIdentity, IpAddress, Gauge32, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Unsigned32", "Bits", "ModuleIdentity", "IpAddress", "Gauge32", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEntry=dhcpPoolEntry, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsNXRRSet=dnsStatsNXRRSet, trapHA=trapHA, dhcpPoolStartIP=dhcpPoolStartIP, lcdDaemon=lcdDaemon, haReplicationBinding=haReplicationBinding, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolTable=dhcpPoolTable, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetUsed=dhcpSubnetUsed, ha=ha, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, trapTFTP=trapTFTP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStats=dnsStats, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, trapDNS=trapDNS, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplicationFailure=trapReplicationFailure, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsReferral=dnsStatsReferral, dhcpStats=dhcpStats, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapCommandServerDaemon=trapCommandServerDaemon, adonis=adonis, system=system, dhcpSubnetMask=dhcpSubnetMask, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemon=dnsDaemon, haService=haService, commandServerDaemon=commandServerDaemon, trapReplication=trapReplication, systemDaemon=systemDaemon, dnsStatsSuccess=dnsStatsSuccess, PYSNMP_MODULE_ID=adonis, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, tftpDaemon=tftpDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haServiceRunning=haServiceRunning, lcd=lcd, dhcpIP=dhcpIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftp=tftp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolUsed=dhcpPoolUsed, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemon=dhcpDaemon, trapDHCP=trapDHCP, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseExpiry=licenseExpiry, dhcpLeaseTable=dhcpLeaseTable, dnsStatsFailure=dnsStatsFailure, trapSystem=trapSystem)
