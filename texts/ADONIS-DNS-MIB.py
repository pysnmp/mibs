...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcp=dhcp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemon=dnsDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetEntry=dhcpSubnetEntry, haServiceNodeType=haServiceNodeType, tftp=tftp, dhcpPoolAlert=dhcpPoolAlert, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, system=system, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemon=dhcpDaemon, lcd=lcd, adonisTraps=adonisTraps, commandServer=commandServer, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, trapHA=trapHA, dhcpFixedIPEntry=dhcpFixedIPEntry, systemDaemon=systemDaemon, trapReplicationFailure=trapReplicationFailure, adonisObjects=adonisObjects, dnsStatsReferral=dnsStatsReferral, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, dhcpFailOverState=dhcpFailOverState, licenseValid=licenseValid, trapDHCP=trapDHCP, dns=dns, haService=haService, trapTFTPDaemon=trapTFTPDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, systemState=systemState, dhcpPoolTable=dhcpPoolTable, trapHAServiceFailOver=trapHAServiceFailOver, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, lcdDaemon=lcdDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseExpiry=licenseExpiry, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNSDaemon=trapDNSDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonis=adonis, trapCommandServerDaemon=trapCommandServerDaemon, haServiceRunning=haServiceRunning, dnsStats=dnsStats, dhcpLeaseHostname=dhcpLeaseHostname, trapCommandServer=trapCommandServer, dhcpPoolSize=dhcpPoolSize, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, trapReplication=trapReplication, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystem=trapSystem, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon)
