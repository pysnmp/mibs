...
iso, Bits, IpAddress, Gauge32, ModuleIdentity, ObjectIdentity, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter64, Integer32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "IpAddress", "Gauge32", "ModuleIdentity", "ObjectIdentity", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter64", "Integer32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpConfig=dhcpConfig, dnsStatsReferral=dnsStatsReferral, tftp=tftp, lcd=lcd, dhcpDaemonRunning=dhcpDaemonRunning, commandServer=commandServer, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHA=trapHA, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemon=tftpDaemon, dnsStatsRecursion=dnsStatsRecursion, dns=dns, systemDaemon=systemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseHostname=dhcpLeaseHostname, dnsStats=dnsStats, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcp=dhcp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisObjects=adonisObjects, lcdDaemon=lcdDaemon, haReplicationBinding=haReplicationBinding, dhcpPoolSize=dhcpPoolSize, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseBindState=dhcpLeaseBindState, PYSNMP_MODULE_ID=adonis, dhcpSubnetUsed=dhcpSubnetUsed, trapSystemDaemon=trapSystemDaemon, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, dhcpSubnetTable=dhcpSubnetTable, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, adonisTraps=adonisTraps, trapDNSDaemon=trapDNSDaemon, systemState=systemState, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, dnsStatsFailure=dnsStatsFailure, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTP=trapTFTP, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetMask=dhcpSubnetMask, dnsStatsSuccess=dnsStatsSuccess, system=system, dhcpFailOverState=dhcpFailOverState, trapReplicationFailure=trapReplicationFailure, dhcpIP=dhcpIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemon=dhcpDaemon, commandServerDaemonRunning=commandServerDaemonRunning, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, trapReplication=trapReplication, licenseValid=licenseValid, trapTFTPDaemon=trapTFTPDaemon, haService=haService, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonis=adonis, dnsDaemon=dnsDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEntry=dhcpLeaseEntry, trapSystem=trapSystem, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning)
