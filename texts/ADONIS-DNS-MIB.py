...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, trapHA=trapHA, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, haService=haService, trapSystem=trapSystem, licenseValid=licenseValid, ha=ha, haServiceNodeType=haServiceNodeType, adonisObjects=adonisObjects, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemon=commandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetMask=dhcpSubnetMask, dhcpStats=dhcpStats, dnsStatsRecursion=dnsStatsRecursion, tftpDaemon=tftpDaemon, system=system, trapSystemDaemon=trapSystemDaemon, adonis=adonis, lcd=lcd, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, adonisTraps=adonisTraps, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haReplicationBinding=haReplicationBinding, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, dnsStats=dnsStats, trapReplication=trapReplication, systemState=systemState, dnsStatsNXDomain=dnsStatsNXDomain, lcdDaemon=lcdDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolUsed=dhcpPoolUsed, tftp=tftp, dhcpPoolSize=dhcpPoolSize, trapTFTP=trapTFTP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcp=dhcp, dhcpPoolAlert=dhcpPoolAlert, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dns=dns, dnsStatsSuccess=dnsStatsSuccess, dnsDaemon=dnsDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemDaemon=systemDaemon, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred)
