...
iso, MibIdentifier, ObjectIdentity, Gauge32, IpAddress, enterprises, ModuleIdentity, NotificationType, Bits, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "ObjectIdentity", "Gauge32", "IpAddress", "enterprises", "ModuleIdentity", "NotificationType", "Bits", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, dhcp=dhcp, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCP=trapDHCP, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEndTime=dhcpLeaseEndTime, haService=haService, PYSNMP_MODULE_ID=adonis, trapDNSDaemon=trapDNSDaemon, trapDNS=trapDNS, licenseValid=licenseValid, haServiceNodeType=haServiceNodeType, trapTFTP=trapTFTP, dhcpPoolTable=dhcpPoolTable, dnsStatsRecursion=dnsStatsRecursion, dhcpStats=dhcpStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpConfig=dhcpConfig, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFailOverState=dhcpFailOverState, dhcpFixedIP=dhcpFixedIP, dns=dns, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpIP=dhcpIP, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetSize=dhcpSubnetSize, adonis=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, systemState=systemState, haReplicationBinding=haReplicationBinding, commandServerDaemon=commandServerDaemon, dnsStatsReferral=dnsStatsReferral, trapSystem=trapSystem, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStats=dnsStats, tftpDaemon=tftpDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcd=lcd, lcdDaemon=lcdDaemon, licenseExpiry=licenseExpiry, adonisObjects=adonisObjects, adonisTraps=adonisTraps, dhcpPoolAlert=dhcpPoolAlert, dnsStatsFailure=dnsStatsFailure, trapCommandServer=trapCommandServer, dhcpPoolSize=dhcpPoolSize, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftp=tftp, trapHA=trapHA, tftpDaemonRunning=tftpDaemonRunning, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, dhcpDaemon=dhcpDaemon, system=system)
