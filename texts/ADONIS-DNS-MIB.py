...
iso, IpAddress, NotificationType, Counter32, enterprises, Counter64, TimeTicks, Gauge32, Integer32, Bits, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Counter32", "enterprises", "Counter64", "TimeTicks", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsRecursion=dnsStatsRecursion, dhcpPoolAlert=dhcpPoolAlert, PYSNMP_MODULE_ID=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, system=system, lcd=lcd, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, dhcpStats=dhcpStats, commandServer=commandServer, commandServerDaemon=commandServerDaemon, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemon=tftpDaemon, dnsStats=dnsStats, dhcpSubnetEntry=dhcpSubnetEntry, trapReplicationFailure=trapReplicationFailure, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, dhcpFailOverState=dhcpFailOverState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, trapCommandServer=trapCommandServer, adonisTraps=adonisTraps, dhcpPoolEndIP=dhcpPoolEndIP, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, adonisObjects=adonisObjects, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapReplication=trapReplication, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, dhcp=dhcp, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNSDaemon=trapDNSDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, haServiceRunning=haServiceRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftpDaemonRunning=tftpDaemonRunning, trapTFTP=trapTFTP, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsFailure=dnsStatsFailure, trapHA=trapHA, commandServerDaemonRunning=commandServerDaemonRunning, haServiceNodeType=haServiceNodeType, tftp=tftp, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, haService=haService, trapSystem=trapSystem, dhcpSubnetSize=dhcpSubnetSize, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolEntry=dhcpPoolEntry, ha=ha, trapDHCP=trapDHCP, licenseValid=licenseValid, dns=dns, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, licenseExpiry=licenseExpiry, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEntry=dhcpLeaseEntry)
