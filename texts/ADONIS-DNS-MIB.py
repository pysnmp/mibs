...
MibIdentifier, NotificationType, Bits, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, TimeTicks, Integer32, Counter64, Unsigned32, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Bits", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "TimeTicks", "Integer32", "Counter64", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpConfig=dhcpConfig, system=system, licenseValid=licenseValid, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetMask=dhcpSubnetMask, dhcpStats=dhcpStats, tftpDaemonRunning=tftpDaemonRunning, adonisTraps=adonisTraps, trapHA=trapHA, trapReplication=trapReplication, licenseExpiry=licenseExpiry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemon=dnsDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcp=dhcp, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDNSDaemon=trapDNSDaemon, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcdDaemon=lcdDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dns=dns, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dnsStatsReferral=dnsStatsReferral, commandServerDaemonRunning=commandServerDaemonRunning, trapSystem=trapSystem, dhcpSubnetTable=dhcpSubnetTable, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, trapTFTP=trapTFTP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpIP=dhcpIP, haServiceNodeType=haServiceNodeType, trapDHCPDaemon=trapDHCPDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonis=adonis, dhcpFailOverState=dhcpFailOverState, dnsDaemonRunning=dnsDaemonRunning, haReplicationBinding=haReplicationBinding, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsNXDomain=dnsStatsNXDomain, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, dnsStats=dnsStats, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServer=commandServer, lcd=lcd, ha=ha, adonisObjects=adonisObjects, trapDHCP=trapDHCP, dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIP=dhcpFixedIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, systemState=systemState, tftpDaemon=tftpDaemon, haService=haService)
