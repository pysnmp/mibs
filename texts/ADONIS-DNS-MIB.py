...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, dhcpFixedIP=dhcpFixedIP, system=system, trapDNSDaemon=trapDNSDaemon, dhcp=dhcp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, PYSNMP_MODULE_ID=adonis, dhcpConfig=dhcpConfig, haReplicationBinding=haReplicationBinding, tftp=tftp, dhcpSubnetMask=dhcpSubnetMask, trapHA=trapHA, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, systemDaemon=systemDaemon, systemState=systemState, dhcpDaemonRunning=dhcpDaemonRunning, commandServer=commandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemon=dnsDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, haService=haService, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNS=trapDNS, lcd=lcd, lcdDaemon=lcdDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haServiceNodeType=haServiceNodeType, dnsStatsReferral=dnsStatsReferral, trapReplication=trapReplication, adonisTraps=adonisTraps, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseValid=licenseValid, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystem=trapSystem, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsFailure=dnsStatsFailure, dhcpPoolSize=dhcpPoolSize, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemon=commandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemon=tftpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXDomain=dnsStatsNXDomain, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, trapCommandServer=trapCommandServer, dns=dns, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, dhcpStats=dhcpStats, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCP=trapDHCP, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemonRunning=tftpDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpLeaseBindState=dhcpLeaseBindState, dhcpIP=dhcpIP, trapTFTP=trapTFTP, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolUsed=dhcpPoolUsed)
