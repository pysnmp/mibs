...
Unsigned32, Counter64, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, enterprises, ModuleIdentity, iso, ObjectIdentity, Integer32, Bits, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "enterprises", "ModuleIdentity", "iso", "ObjectIdentity", "Integer32", "Bits", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, tftp=tftp, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, trapSystem=trapSystem, dnsStatsFailure=dnsStatsFailure, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolStartIP=dhcpPoolStartIP, trapSystemDaemon=trapSystemDaemon, trapReplicationFailure=trapReplicationFailure, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, commandServer=commandServer, dhcpStats=dhcpStats, trapReplication=trapReplication, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStats=dnsStats, PYSNMP_MODULE_ID=adonis, ha=ha, lcdDaemon=lcdDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftpDaemon=tftpDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolEntry=dhcpPoolEntry, dhcpConfig=dhcpConfig, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisObjects=adonisObjects, dhcpDaemon=dhcpDaemon, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonRunning=dnsDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, system=system, dhcpPoolUsed=dhcpPoolUsed, haReplicationBinding=haReplicationBinding, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, haService=haService, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpIP=dhcpIP, dhcpPoolAlert=dhcpPoolAlert, systemDaemon=systemDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIP=dhcpFixedIP, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, trapDNS=trapDNS, commandServerDaemonRunning=commandServerDaemonRunning, systemState=systemState, dhcp=dhcp, adonisTraps=adonisTraps, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseExpiry=licenseExpiry, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapTFTP=trapTFTP, adonis=adonis, commandServerDaemon=commandServerDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, licenseValid=licenseValid, haServiceNodeType=haServiceNodeType, dhcpLeaseEntry=dhcpLeaseEntry, haServiceRunning=haServiceRunning)
