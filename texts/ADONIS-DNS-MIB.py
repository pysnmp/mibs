...
Bits, ModuleIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, iso, IpAddress, Integer32, Counter64, TimeTicks, Gauge32, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "iso", "IpAddress", "Integer32", "Counter64", "TimeTicks", "Gauge32", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftpDaemon=tftpDaemon, trapDNS=trapDNS, commandServerDaemonRunning=commandServerDaemonRunning, licenseValid=licenseValid, trapDHCP=trapDHCP, dhcpFixedIP=dhcpFixedIP, system=system, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHA=trapHA, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, lcd=lcd, trapSystem=trapSystem, lcdDaemon=lcdDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplication=trapReplication, dhcpLeaseHostname=dhcpLeaseHostname, trapSystemDaemon=trapSystemDaemon, haReplicationBinding=haReplicationBinding, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetTable=dhcpSubnetTable, trapReplicationFailure=trapReplicationFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStats=dnsStats, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, adonisObjects=adonisObjects, trapTFTPDaemon=trapTFTPDaemon, systemDaemon=systemDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServer=trapCommandServer, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsReferral=dnsStatsReferral, dhcpDaemonRunning=dhcpDaemonRunning, commandServer=commandServer, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpIP=dhcpIP, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsFailure=dnsStatsFailure, trapDNSDaemon=trapDNSDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, dns=dns, dhcpPoolSize=dhcpPoolSize, dhcpSubnetUsed=dhcpSubnetUsed, haService=haService, commandServerDaemon=commandServerDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, tftpDaemonRunning=tftpDaemonRunning, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, trapHAServiceFailOver=trapHAServiceFailOver, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dhcpSubnetAlert=dhcpSubnetAlert, dhcpStats=dhcpStats, trapTFTP=trapTFTP, dnsDaemon=dnsDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEntry=dhcpPoolEntry, dnsStatsRecursion=dnsStatsRecursion, dhcp=dhcp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFailOverState=dhcpFailOverState, dhcpDaemon=dhcpDaemon)
