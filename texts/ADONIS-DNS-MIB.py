...
Gauge32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, ModuleIdentity, TimeTicks, iso, NotificationType, enterprises, Bits, Counter32, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "ModuleIdentity", "TimeTicks", "iso", "NotificationType", "enterprises", "Bits", "Counter32", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftp=tftp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsFailure=dnsStatsFailure, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, PYSNMP_MODULE_ID=adonis, dhcpPoolEntry=dhcpPoolEntry, lcd=lcd, dnsStatsNXDomain=dnsStatsNXDomain, trapDNSDaemon=trapDNSDaemon, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStats=dnsStats, trapSystem=trapSystem, dnsDaemon=dnsDaemon, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTP=trapTFTP, dhcpSubnetIP=dhcpSubnetIP, system=system, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, adonisObjects=adonisObjects, dhcpLeaseHostname=dhcpLeaseHostname, haReplicationBinding=haReplicationBinding, dhcpFailOverState=dhcpFailOverState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpIP=dhcpIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseValid=licenseValid, ha=ha, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemon=commandServerDaemon, lcdDaemon=lcdDaemon, haServiceRunning=haServiceRunning, dhcpConfig=dhcpConfig, dhcpDaemon=dhcpDaemon, trapCommandServer=trapCommandServer, haServiceNodeType=haServiceNodeType, trapDHCP=trapDHCP, trapReplicationFailure=trapReplicationFailure, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, trapTFTPDaemon=trapTFTPDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, trapHA=trapHA, tftpDaemon=tftpDaemon, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, commandServer=commandServer, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolAlert=dhcpPoolAlert, dhcp=dhcp, adonisTraps=adonisTraps, dhcpPoolSize=dhcpPoolSize, dhcpPoolTable=dhcpPoolTable, haService=haService, dnsStatsReferral=dnsStatsReferral, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemState=systemState)
