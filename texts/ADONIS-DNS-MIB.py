...
NotificationType, Unsigned32, MibIdentifier, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Bits, TimeTicks, enterprises, iso, ModuleIdentity, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Bits", "TimeTicks", "enterprises", "iso", "ModuleIdentity", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, haService=haService, dhcpConfig=dhcpConfig, dnsStatsSuccess=dnsStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, lcd=lcd, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHA=trapHA, trapReplication=trapReplication, lcdDaemon=lcdDaemon, commandServer=commandServer, dhcpSubnetTable=dhcpSubnetTable, system=system, dhcpStats=dhcpStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, haServiceNodeType=haServiceNodeType, haReplicationBinding=haReplicationBinding, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemon=dnsDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemDaemon=systemDaemon, licenseExpiry=licenseExpiry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, tftp=tftp, dns=dns, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseEntry=dhcpLeaseEntry, trapReplicationFailure=trapReplicationFailure, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolTable=dhcpPoolTable, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetUsed=dhcpSubnetUsed, licenseValid=licenseValid, trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetEntry=dhcpSubnetEntry, trapSystem=trapSystem, haServiceRunning=haServiceRunning, tftpDaemonRunning=tftpDaemonRunning, dhcp=dhcp, PYSNMP_MODULE_ID=adonis, adonis=adonis, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCP=trapDHCP, trapDHCPDaemon=trapDHCPDaemon, trapCommandServer=trapCommandServer, dnsStatsReferral=dnsStatsReferral, dhcpPoolEndIP=dhcpPoolEndIP, systemState=systemState, dhcpFixedIP=dhcpFixedIP, dhcpDaemon=dhcpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemon=tftpDaemon, ha=ha, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisTraps=adonisTraps, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServerDaemon=trapCommandServerDaemon, trapDNSDaemon=trapDNSDaemon, adonisObjects=adonisObjects, dhcpFailOverState=dhcpFailOverState, commandServerDaemon=commandServerDaemon, trapSystemDaemon=trapSystemDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpIP=dhcpIP)
