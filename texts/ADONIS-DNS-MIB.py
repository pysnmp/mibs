...
IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, TimeTicks, NotificationType, enterprises, ObjectIdentity, iso, Unsigned32, MibIdentifier, Integer32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "TimeTicks", "NotificationType", "enterprises", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplication=trapReplication, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, trapHAServiceFailOver=trapHAServiceFailOver, trapSystemDaemon=trapSystemDaemon, dhcpSubnetIP=dhcpSubnetIP, PYSNMP_MODULE_ID=adonis, dhcpConfig=dhcpConfig, trapCommandServer=trapCommandServer, dhcpSubnetMask=dhcpSubnetMask, ha=ha, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsReferral=dnsStatsReferral, licenseValid=licenseValid, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolStartIP=dhcpPoolStartIP, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcp=dhcp, systemDaemon=systemDaemon, haReplicationBinding=haReplicationBinding, lcd=lcd, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, system=system, trapReplicationFailure=trapReplicationFailure, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetAlert=dhcpSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemon=dhcpDaemon, haService=haService, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcdDaemon=lcdDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, dnsStatsFailure=dnsStatsFailure, dnsDaemon=dnsDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftp=tftp, dhcpLeaseStartTime=dhcpLeaseStartTime, adonisTraps=adonisTraps, trapDNSDaemon=trapDNSDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEntry=dhcpLeaseEntry, dhcpStats=dhcpStats, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, dnsStats=dnsStats, dns=dns, systemState=systemState, trapHA=trapHA, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemon=tftpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haServiceNodeType=haServiceNodeType, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolTable=dhcpPoolTable, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolUsed=dhcpPoolUsed, adonis=adonis, dhcpIP=dhcpIP, trapSystem=trapSystem, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure)
