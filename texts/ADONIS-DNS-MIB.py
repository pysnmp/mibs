...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolUsed=dhcpPoolUsed, trapCommandServer=trapCommandServer, trapTFTP=trapTFTP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStats=dnsStats, lcd=lcd, dhcpIP=dhcpIP, trapCommandServerDaemon=trapCommandServerDaemon, commandServer=commandServer, haServiceRunning=haServiceRunning, adonisTraps=adonisTraps, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, systemState=systemState, dhcpPoolEndIP=dhcpPoolEndIP, trapSystemDaemon=trapSystemDaemon, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapSystem=trapSystem, dhcpPoolEntry=dhcpPoolEntry, commandServerDaemon=commandServerDaemon, licenseValid=licenseValid, haService=haService, dhcpPoolSize=dhcpPoolSize, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetTable=dhcpSubnetTable, ha=ha, trapDHCPDaemon=trapDHCPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapReplication=trapReplication, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIP=dhcpFixedIP, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemon=dnsDaemon, dhcpPoolTable=dhcpPoolTable, dhcpLeaseBindState=dhcpLeaseBindState, licenseExpiry=licenseExpiry, dhcp=dhcp, dnsStatsFailure=dnsStatsFailure, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, haReplicationBinding=haReplicationBinding, dhcpConfig=dhcpConfig, dhcpDaemon=dhcpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, lcdDaemon=lcdDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dns=dns, dnsDaemonRunning=dnsDaemonRunning, tftp=tftp, tftpDaemon=tftpDaemon, dhcpStats=dhcpStats, trapDNS=trapDNS, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, dhcpLeaseStartTime=dhcpLeaseStartTime, system=system, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplicationFailure=trapReplicationFailure, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNSDaemon=trapDNSDaemon, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress)
