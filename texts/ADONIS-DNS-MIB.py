...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ObjectIdentity, Unsigned32, Bits, TimeTicks, Counter32, Counter64, enterprises, iso, Integer32, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "Counter32", "Counter64", "enterprises", "iso", "Integer32", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemonRunning=commandServerDaemonRunning, haService=haService, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, dnsDaemonRunning=dnsDaemonRunning, trapCommandServer=trapCommandServer, adonis=adonis, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, ha=ha, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXDomain=dnsStatsNXDomain, systemState=systemState, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceNodeType=haServiceNodeType, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, trapSystem=trapSystem, dhcpIP=dhcpIP, dhcpFailOverState=dhcpFailOverState, systemDaemon=systemDaemon, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSize=dhcpPoolSize, tftp=tftp, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, dhcpDaemon=dhcpDaemon, PYSNMP_MODULE_ID=adonis, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, lcdDaemon=lcdDaemon, trapSystemDaemon=trapSystemDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServerDaemon=commandServerDaemon, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, adonisTraps=adonisTraps, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, system=system, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCPDaemon=trapDHCPDaemon, dns=dns, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpStats=dhcpStats, adonisObjects=adonisObjects, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpConfig=dhcpConfig, dhcp=dhcp, trapReplication=trapReplication, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNS=trapDNS, lcd=lcd, dhcpSubnetSize=dhcpSubnetSize, trapHA=trapHA, dnsStatsReferral=dnsStatsReferral, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP, dhcpLeaseBindState=dhcpLeaseBindState)
