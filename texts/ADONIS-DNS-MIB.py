...
Counter64, Integer32, iso, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Gauge32, Counter32, Bits, TimeTicks, Unsigned32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "iso", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Gauge32", "Counter32", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemonRunning=tftpDaemonRunning, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, licenseExpiry=licenseExpiry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEndIP=dhcpPoolEndIP, dhcpStats=dhcpStats, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dnsStats=dnsStats, dhcpSubnetTable=dhcpSubnetTable, lcd=lcd, trapSystem=trapSystem, PYSNMP_MODULE_ID=adonis, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIP=dhcpFixedIP, trapHA=trapHA, dhcpDaemon=dhcpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftpDaemon=tftpDaemon, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, system=system, trapHAServiceFailOver=trapHAServiceFailOver, haReplicationBinding=haReplicationBinding, dhcpSubnetMask=dhcpSubnetMask, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcp=dhcp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplication=trapReplication, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolTable=dhcpPoolTable, dnsStatsFailure=dnsStatsFailure, licenseValid=licenseValid, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, commandServer=commandServer, trapSystemDaemon=trapSystemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, lcdDaemon=lcdDaemon, dhcpFailOverState=dhcpFailOverState, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceNodeType=haServiceNodeType, commandServerDaemon=commandServerDaemon, dhcpPoolSize=dhcpPoolSize, trapTFTPDaemon=trapTFTPDaemon, trapDNS=trapDNS, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, adonisObjects=adonisObjects, dhcpConfig=dhcpConfig, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, adonisTraps=adonisTraps, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, tftp=tftp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXRRSet=dnsStatsNXRRSet, ha=ha, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonis=adonis, dhcpLeaseEntry=dhcpLeaseEntry, systemDaemon=systemDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsStatsRecursion=dnsStatsRecursion)
