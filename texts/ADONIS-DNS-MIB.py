...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, Gauge32, Bits, IpAddress, Integer32, iso, NotificationType, MibIdentifier, TimeTicks, ModuleIdentity, Unsigned32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "Gauge32", "Bits", "IpAddress", "Integer32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIP=dhcpFixedIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemDaemon=systemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpIP=dhcpIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServerDaemon=commandServerDaemon, dhcpStats=dhcpStats, ha=ha, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime, lcd=lcd, systemState=systemState, dns=dns, trapDHCP=trapDHCP, dhcpSubnetUsed=dhcpSubnetUsed, haServiceRunning=haServiceRunning, dhcpPoolSize=dhcpPoolSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, system=system, trapHA=trapHA, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetEntry=dhcpSubnetEntry, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftpDaemon=tftpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, tftpDaemonRunning=tftpDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, trapDNS=trapDNS, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetTable=dhcpSubnetTable, trapDHCPDaemon=trapDHCPDaemon, dnsStatsReferral=dnsStatsReferral, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServerDaemon=trapCommandServerDaemon, licenseValid=licenseValid, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystem=trapSystem, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEndIP=dhcpPoolEndIP, haReplicationBinding=haReplicationBinding, dnsStats=dnsStats, tftp=tftp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, dhcpLeaseBindState=dhcpLeaseBindState, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, trapReplication=trapReplication, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetAlert=dhcpSubnetAlert, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, adonisTraps=adonisTraps, dhcp=dhcp, trapSystemDaemon=trapSystemDaemon, commandServer=commandServer, dhcpPoolTable=dhcpPoolTable, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServer=trapCommandServer, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, commandServerDaemonRunning=commandServerDaemonRunning)
