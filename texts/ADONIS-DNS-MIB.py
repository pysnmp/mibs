...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Gauge32, ModuleIdentity, IpAddress, Counter32, Integer32, TimeTicks, enterprises, iso, NotificationType, ObjectIdentity, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Gauge32", "ModuleIdentity", "IpAddress", "Counter32", "Integer32", "TimeTicks", "enterprises", "iso", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, dnsStatsReferral=dnsStatsReferral, trapDNS=trapDNS, adonisObjects=adonisObjects, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, haServiceRunning=haServiceRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemon=dhcpDaemon, trapReplication=trapReplication, dhcpSubnetIP=dhcpSubnetIP, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNSDaemon=trapDNSDaemon, systemDaemon=systemDaemon, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, adonis=adonis, dhcpLeaseStartTime=dhcpLeaseStartTime, adonisTraps=adonisTraps, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetEntry=dhcpSubnetEntry, haReplicationBinding=haReplicationBinding, dhcpFixedIP=dhcpFixedIP, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, licenseExpiry=licenseExpiry, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystem=trapSystem, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, systemState=systemState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpStats=dhcpStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftpDaemon=tftpDaemon, dhcpFailOverState=dhcpFailOverState, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolUsed=dhcpPoolUsed, PYSNMP_MODULE_ID=adonis, dnsStatsFailure=dnsStatsFailure, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemon=commandServerDaemon, dnsStats=dnsStats, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonRunning=dnsDaemonRunning, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemon=dnsDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapTFTP=trapTFTP, lcdDaemon=lcdDaemon, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, lcd=lcd, dhcpConfig=dhcpConfig, dhcpPoolTable=dhcpPoolTable, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseEntry=dhcpLeaseEntry, haServiceNodeType=haServiceNodeType, tftp=tftp, trapDHCP=trapDHCP, ha=ha, dhcp=dhcp, dhcpDaemonRunning=dhcpDaemonRunning)
