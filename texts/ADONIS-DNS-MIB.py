...
iso, ModuleIdentity, Unsigned32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, ObjectIdentity, Gauge32, Counter64, enterprises, Integer32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Unsigned32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "ObjectIdentity", "Gauge32", "Counter64", "enterprises", "Integer32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTPDaemon=trapTFTPDaemon, haServiceNodeType=haServiceNodeType, ha=ha, dhcpPoolTable=dhcpPoolTable, licenseExpiry=licenseExpiry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStats=dnsStats, trapDNS=trapDNS, commandServerDaemonRunning=commandServerDaemonRunning, dhcp=dhcp, dhcpSubnetTable=dhcpSubnetTable, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetAlert=dhcpSubnetAlert, systemState=systemState, trapCommandServer=trapCommandServer, commandServer=commandServer, lcdDaemon=lcdDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpStats=dhcpStats, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftp=tftp, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystemDaemon=trapSystemDaemon, adonis=adonis, haService=haService, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolEntry=dhcpPoolEntry, tftpDaemon=tftpDaemon, trapHA=trapHA, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, system=system, trapDHCP=trapDHCP, PYSNMP_MODULE_ID=adonis, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapSystem=trapSystem, dnsDaemon=dnsDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplicationFailure=trapReplicationFailure, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolSize=dhcpPoolSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFailOverState=dhcpFailOverState, dhcpDaemonRunning=dhcpDaemonRunning, haServiceRunning=haServiceRunning, dhcpSubnetSize=dhcpSubnetSize, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNSDaemon=trapDNSDaemon, adonisTraps=adonisTraps, trapHAServiceFailOver=trapHAServiceFailOver, lcd=lcd, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, dhcpIP=dhcpIP, dhcpSubnetIP=dhcpSubnetIP, systemDaemon=systemDaemon, haReplicationBinding=haReplicationBinding, commandServerDaemon=commandServerDaemon, dhcpConfig=dhcpConfig, adonisObjects=adonisObjects, dhcpLeaseHostname=dhcpLeaseHostname, licenseValid=licenseValid, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsSuccess=dnsStatsSuccess)
