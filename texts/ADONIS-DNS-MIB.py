...
Counter64, Unsigned32, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, MibIdentifier, IpAddress, TimeTicks, Counter32, Gauge32, ObjectIdentity, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "MibIdentifier", "IpAddress", "TimeTicks", "Counter32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, dhcpPoolTable=dhcpPoolTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetMask=dhcpSubnetMask, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, systemDaemon=systemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsSuccess=dnsStatsSuccess, adonisTraps=adonisTraps, commandServerDaemon=commandServerDaemon, haServiceNodeType=haServiceNodeType, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, licenseExpiry=licenseExpiry, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFailOverState=dhcpFailOverState, systemState=systemState, tftpDaemon=tftpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, PYSNMP_MODULE_ID=adonis, system=system, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisObjects=adonisObjects, dhcpSubnetEntry=dhcpSubnetEntry, dhcp=dhcp, adonis=adonis, dnsStatsRecursion=dnsStatsRecursion, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, dhcpStats=dhcpStats, lcd=lcd, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPTable=dhcpFixedIPTable, lcdDaemon=lcdDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, tftp=tftp, dhcpSubnetTable=dhcpSubnetTable, ha=ha, dhcpIP=dhcpIP, trapCommandServer=trapCommandServer, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, trapHA=trapHA, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, haReplicationBinding=haReplicationBinding, dhcpConfig=dhcpConfig, trapSystemDaemon=trapSystemDaemon, haService=haService, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNSDaemon=trapDNSDaemon, dhcpLeaseBindState=dhcpLeaseBindState)
