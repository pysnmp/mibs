...
Counter32, Counter64, NotificationType, enterprises, TimeTicks, ObjectIdentity, Bits, iso, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "NotificationType", "enterprises", "TimeTicks", "ObjectIdentity", "Bits", "iso", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", licenseValid=licenseValid, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapReplicationFailure=trapReplicationFailure, adonisTraps=adonisTraps, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonRunning=dnsDaemonRunning, lcdDaemon=lcdDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsReferral=dnsStatsReferral, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemonRunning=commandServerDaemonRunning, system=system, ha=ha, dnsStatsFailure=dnsStatsFailure, adonis=adonis, trapReplication=trapReplication, tftp=tftp, dnsStats=dnsStats, trapDNSDaemon=trapDNSDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haServiceNodeType=haServiceNodeType, dhcpStats=dhcpStats, dhcpDaemon=dhcpDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, trapDNS=trapDNS, trapHA=trapHA, dnsStatsRecursion=dnsStatsRecursion, haServiceRunning=haServiceRunning, dhcpSubnetSize=dhcpSubnetSize, systemDaemon=systemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, dhcpPoolSize=dhcpPoolSize, PYSNMP_MODULE_ID=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonRunning=dhcpDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpSubnetMask=dhcpSubnetMask, trapDHCPDaemon=trapDHCPDaemon, adonisObjects=adonisObjects, tftpDaemon=tftpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcp=dhcp, trapTFTPDaemon=trapTFTPDaemon, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolUsed=dhcpPoolUsed, trapCommandServer=trapCommandServer, systemState=systemState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServer=commandServer, dhcpConfig=dhcpConfig, lcd=lcd, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, licenseExpiry=licenseExpiry, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetEntry=dhcpSubnetEntry, dns=dns, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, haService=haService, trapTFTP=trapTFTP, haReplicationBinding=haReplicationBinding, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEntry=dhcpLeaseEntry)
