...
TimeTicks, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, iso, MibIdentifier, IpAddress, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "iso", "MibIdentifier", "IpAddress", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCP=trapDHCP, dnsStatsReferral=dnsStatsReferral, haServiceRunning=haServiceRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, haService=haService, commandServerDaemonRunning=commandServerDaemonRunning, commandServerDaemon=commandServerDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, trapDNS=trapDNS, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsFailure=dnsStatsFailure, dhcpPoolUsed=dhcpPoolUsed, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIP=dhcpFixedIP, dhcp=dhcp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTable=dhcpLeaseTable, dnsStats=dnsStats, trapReplication=trapReplication, dhcpLeaseHostname=dhcpLeaseHostname, dhcpConfig=dhcpConfig, trapHA=trapHA, dhcpDaemon=dhcpDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, trapCommandServer=trapCommandServer, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetSize=dhcpSubnetSize, trapSystem=trapSystem, adonisObjects=adonisObjects, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, dhcpStats=dhcpStats, trapDNSDaemon=trapDNSDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftp=tftp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemState=systemState, systemDaemon=systemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpIP=dhcpIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFailOverState=dhcpFailOverState, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemon=tftpDaemon, dhcpPoolTable=dhcpPoolTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseStartTime=dhcpLeaseStartTime, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, dns=dns, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, haServiceNodeType=haServiceNodeType, adonis=adonis, system=system, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, lcd=lcd, lcdDaemon=lcdDaemon, dhcpPoolSize=dhcpPoolSize, licenseValid=licenseValid)
