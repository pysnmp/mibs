...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetIP=dhcpSubnetIP, licenseExpiry=licenseExpiry, dhcpDaemonRunning=dhcpDaemonRunning, trapHA=trapHA, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseBindState=dhcpLeaseBindState, haReplicationBinding=haReplicationBinding, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, tftp=tftp, trapDNSDaemon=trapDNSDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIP=dhcpFixedIP, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, adonisObjects=adonisObjects, dhcpDaemon=dhcpDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolSize=dhcpPoolSize, dhcpPoolTable=dhcpPoolTable, system=system, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, haServiceNodeType=haServiceNodeType, trapReplicationFailure=trapReplicationFailure, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, systemDaemon=systemDaemon, lcd=lcd, trapReplication=trapReplication, trapHAServiceFailOver=trapHAServiceFailOver, commandServerDaemon=commandServerDaemon, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcp=dhcp, PYSNMP_MODULE_ID=adonis, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpIP=dhcpIP, tftpDaemon=tftpDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapSystem=trapSystem, dnsDaemon=dnsDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServer=trapCommandServer, haService=haService, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, adonisTraps=adonisTraps, haServiceRunning=haServiceRunning, dnsStatsNXDomain=dnsStatsNXDomain, dnsStats=dnsStats, dhcpSubnetMask=dhcpSubnetMask, dnsStatsReferral=dnsStatsReferral, systemState=systemState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetSize=dhcpSubnetSize, trapDHCP=trapDHCP, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcdDaemon=lcdDaemon, commandServer=commandServer, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpConfig=dhcpConfig, dnsStatsFailure=dnsStatsFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNS=trapDNS)
