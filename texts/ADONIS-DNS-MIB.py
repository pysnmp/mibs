...
IpAddress, ModuleIdentity, Bits, TimeTicks, Gauge32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso, enterprises, Counter32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso", "enterprises", "Counter32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetMask=dhcpSubnetMask, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, system=system, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPTable=dhcpFixedIPTable, adonisTraps=adonisTraps, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDNS=trapDNS, dhcpLeaseHostname=dhcpLeaseHostname, trapDHCP=trapDHCP, dhcpFixedIP=dhcpFixedIP, haServiceNodeType=haServiceNodeType, dhcpSubnetEntry=dhcpSubnetEntry, trapSystem=trapSystem, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, tftp=tftp, dhcp=dhcp, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXDomain=dnsStatsNXDomain, lcd=lcd, lcdDaemon=lcdDaemon, PYSNMP_MODULE_ID=adonis, dnsStats=dnsStats, dnsDaemon=dnsDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpIP=dhcpIP, dhcpLeaseEndTime=dhcpLeaseEndTime, haServiceRunning=haServiceRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dns=dns, trapTFTP=trapTFTP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpConfig=dhcpConfig, dhcpPoolTable=dhcpPoolTable, systemDaemon=systemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseEntry=dhcpLeaseEntry, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystemDaemon=trapSystemDaemon, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsNXRRSet=dnsStatsNXRRSet, adonis=adonis, dnsStatsSuccess=dnsStatsSuccess, commandServer=commandServer, haReplicationBinding=haReplicationBinding, dhcpSubnetIP=dhcpSubnetIP, adonisObjects=adonisObjects, trapDNSDaemon=trapDNSDaemon, dhcpStats=dhcpStats, dhcpDaemon=dhcpDaemon, dhcpSubnetSize=dhcpSubnetSize, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolEntry=dhcpPoolEntry, trapHAServiceFailOver=trapHAServiceFailOver, licenseExpiry=licenseExpiry, trapCommandServer=trapCommandServer, dnsStatsReferral=dnsStatsReferral, dnsStatsRecursion=dnsStatsRecursion, trapHA=trapHA, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemon=tftpDaemon, dhcpPoolUsed=dhcpPoolUsed, systemState=systemState, dnsDaemonRunning=dnsDaemonRunning, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable)
