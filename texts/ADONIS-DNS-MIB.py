...
ModuleIdentity, NotificationType, IpAddress, Counter64, iso, MibIdentifier, Gauge32, Bits, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "IpAddress", "Counter64", "iso", "MibIdentifier", "Gauge32", "Bits", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisObjects=adonisObjects, tftpDaemon=tftpDaemon, dhcp=dhcp, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystem=trapSystem, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemon=dhcpDaemon, trapTFTPDaemon=trapTFTPDaemon, licenseExpiry=licenseExpiry, adonis=adonis, dhcpSubnetUsed=dhcpSubnetUsed, PYSNMP_MODULE_ID=adonis, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsRecursion=dnsStatsRecursion, system=system, trapReplication=trapReplication, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplicationFailure=trapReplicationFailure, dhcpDaemonRunning=dhcpDaemonRunning, trapDNSDaemon=trapDNSDaemon, systemDaemon=systemDaemon, trapTFTP=trapTFTP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsReferral=dnsStatsReferral, dhcpPoolSize=dhcpPoolSize, dhcpPoolStartIP=dhcpPoolStartIP, ha=ha, systemState=systemState, dhcpPoolEndIP=dhcpPoolEndIP, trapHA=trapHA, dnsStatsFailure=dnsStatsFailure, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCP=trapDHCP, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, tftp=tftp, dhcpIP=dhcpIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStats=dnsStats, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemon=commandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, haReplicationBinding=haReplicationBinding, dhcpSubnetMask=dhcpSubnetMask, adonisTraps=adonisTraps, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, licenseValid=licenseValid, lcdDaemon=lcdDaemon, commandServer=commandServer, tftpDaemonRunning=tftpDaemonRunning, haServiceNodeType=haServiceNodeType, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIPTable=dhcpFixedIPTable, dns=dns, trapDNS=trapDNS, haServiceRunning=haServiceRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, lcd=lcd, dnsStatsNXDomain=dnsStatsNXDomain, haService=haService, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFailOverState=dhcpFailOverState, trapCommandServer=trapCommandServer, dhcpLeaseHostname=dhcpLeaseHostname, trapSystemDaemon=trapSystemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpConfig=dhcpConfig, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetIP=dhcpSubnetIP, dnsStatsNXRRSet=dnsStatsNXRRSet)
