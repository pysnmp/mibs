...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolAlert=dhcpPoolAlert, adonisObjects=adonisObjects, dhcpLeaseEntry=dhcpLeaseEntry, dns=dns, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseStartTime=dhcpLeaseStartTime, lcdDaemon=lcdDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, dnsStatsRecursion=dnsStatsRecursion, haServiceRunning=haServiceRunning, dnsStatsFailure=dnsStatsFailure, trapReplicationFailure=trapReplicationFailure, systemDaemon=systemDaemon, dnsDaemon=dnsDaemon, PYSNMP_MODULE_ID=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpConfig=dhcpConfig, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonisTraps=adonisTraps, trapSystem=trapSystem, dhcpSubnetSize=dhcpSubnetSize, dhcpIP=dhcpIP, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, dhcpSubnetEntry=dhcpSubnetEntry, dnsStats=dnsStats, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemon=tftpDaemon, dhcpStats=dhcpStats, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsReferral=dnsStatsReferral, trapSystemDaemon=trapSystemDaemon, system=system, systemState=systemState, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIP=dhcpFixedIP, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, trapHA=trapHA, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcd=lcd, trapCommandServer=trapCommandServer, haService=haService, dhcpLeaseBindState=dhcpLeaseBindState, haReplicationBinding=haReplicationBinding, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonis=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapReplication=trapReplication, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, tftp=tftp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNS=trapDNS, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXDomain=dnsStatsNXDomain, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDHCP=trapDHCP, commandServer=commandServer, licenseValid=licenseValid, licenseExpiry=licenseExpiry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolTable=dhcpPoolTable, dnsDaemonRunning=dnsDaemonRunning, commandServerDaemon=commandServerDaemon, trapDNSDaemon=trapDNSDaemon, dhcpFailOverState=dhcpFailOverState, dhcpDaemon=dhcpDaemon, dhcp=dhcp)
