...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFailOverState=dhcpFailOverState, dnsStatsReferral=dnsStatsReferral, dhcpFixedIPEntry=dhcpFixedIPEntry, systemDaemon=systemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haReplicationBinding=haReplicationBinding, dhcpPoolSize=dhcpPoolSize, adonis=adonis, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemon=tftpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCPDaemon=trapDHCPDaemon, dhcp=dhcp, commandServerDaemon=commandServerDaemon, dns=dns, dhcpPoolTable=dhcpPoolTable, trapTFTPDaemon=trapTFTPDaemon, adonisTraps=adonisTraps, dhcpPoolAlert=dhcpPoolAlert, haService=haService, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetMask=dhcpSubnetMask, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemon=dnsDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDNSDaemon=trapDNSDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, lcdDaemon=lcdDaemon, dhcpSubnetSize=dhcpSubnetSize, adonisObjects=adonisObjects, trapCommandServerDaemon=trapCommandServerDaemon, trapSystemDaemon=trapSystemDaemon, trapHA=trapHA, trapSystem=trapSystem, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemon=dhcpDaemon, dhcpLeaseBindState=dhcpLeaseBindState, tftp=tftp, PYSNMP_MODULE_ID=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetAlert=dhcpSubnetAlert, licenseExpiry=licenseExpiry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, haServiceRunning=haServiceRunning, dhcpConfig=dhcpConfig, systemState=systemState, licenseValid=licenseValid, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTP=trapTFTP, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, trapCommandServer=trapCommandServer, dhcpFixedIP=dhcpFixedIP, dhcpPoolUsed=dhcpPoolUsed, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, trapReplicationFailure=trapReplicationFailure, dhcpStats=dhcpStats, dnsDaemonRunning=dnsDaemonRunning, dnsStatsFailure=dnsStatsFailure, lcd=lcd, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetUsed=dhcpSubnetUsed, trapDNS=trapDNS, dhcpIP=dhcpIP, trapReplication=trapReplication, ha=ha)
