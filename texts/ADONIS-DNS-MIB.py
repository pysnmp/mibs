...
Integer32, Counter32, iso, IpAddress, enterprises, ModuleIdentity, MibIdentifier, Bits, TimeTicks, ObjectIdentity, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "iso", "IpAddress", "enterprises", "ModuleIdentity", "MibIdentifier", "Bits", "TimeTicks", "ObjectIdentity", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplicationFailure=trapReplicationFailure, commandServer=commandServer, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemon=dhcpDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, lcdDaemon=lcdDaemon, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, dns=dns, adonis=adonis, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsRecursion=dnsStatsRecursion, trapCommandServerDaemon=trapCommandServerDaemon, systemDaemon=systemDaemon, dnsStatsSuccess=dnsStatsSuccess, trapSystem=trapSystem, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP, haReplicationBinding=haReplicationBinding, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemState=systemState, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServer=trapCommandServer, system=system, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, dnsStats=dnsStats, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemon=dnsDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, haServiceNodeType=haServiceNodeType, trapSystemDaemon=trapSystemDaemon, lcd=lcd, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonisObjects=adonisObjects, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcp=dhcp, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, trapHAServiceFailOver=trapHAServiceFailOver, haService=haService, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, ha=ha, commandServerDaemonRunning=commandServerDaemonRunning, adonisTraps=adonisTraps, trapTFTPDaemon=trapTFTPDaemon, tftp=tftp, dhcpFailOverState=dhcpFailOverState, trapTFTP=trapTFTP, haServiceRunning=haServiceRunning, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonRunning=dnsDaemonRunning, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsReferral=dnsStatsReferral, dhcpSubnetTable=dhcpSubnetTable, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSize=dhcpPoolSize)
