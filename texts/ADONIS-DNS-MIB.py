...
Gauge32, IpAddress, Bits, Counter32, Unsigned32, Integer32, ModuleIdentity, iso, ObjectIdentity, TimeTicks, MibIdentifier, Counter64, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Bits", "Counter32", "Unsigned32", "Integer32", "ModuleIdentity", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter64", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisObjects=adonisObjects, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTP=trapTFTP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolStartIP=dhcpPoolStartIP, trapDNSDaemon=trapDNSDaemon, trapSystemDaemon=trapSystemDaemon, dhcpPoolTable=dhcpPoolTable, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, system=system, dnsStatsReferral=dnsStatsReferral, dhcp=dhcp, dns=dns, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, ha=ha, PYSNMP_MODULE_ID=adonis, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServer=trapCommandServer, haService=haService, dhcpPoolUsed=dhcpPoolUsed, trapReplication=trapReplication, tftp=tftp, dnsStats=dnsStats, dnsDaemon=dnsDaemon, dhcpStats=dhcpStats, dhcpSubnetTable=dhcpSubnetTable, licenseExpiry=licenseExpiry, trapTFTPDaemon=trapTFTPDaemon, tftpDaemon=tftpDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIP=dhcpFixedIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDNS=trapDNS, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemon=commandServerDaemon, dnsStatsFailure=dnsStatsFailure, lcd=lcd, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemon=dhcpDaemon, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDHCP=trapDHCP, dhcpFailOverState=dhcpFailOverState, lcdDaemon=lcdDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSize=dhcpPoolSize, trapReplicationFailure=trapReplicationFailure, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsRecursion=dnsStatsRecursion, adonis=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXDomain=dnsStatsNXDomain, trapHA=trapHA, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, adonisTraps=adonisTraps, haReplicationBinding=haReplicationBinding, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, commandServer=commandServer, trapSystem=trapSystem, dnsDaemonRunning=dnsDaemonRunning)
