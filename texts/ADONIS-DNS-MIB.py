...
Integer32, Gauge32, IpAddress, Bits, Counter32, TimeTicks, ObjectIdentity, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, ModuleIdentity, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "IpAddress", "Bits", "Counter32", "TimeTicks", "ObjectIdentity", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "ModuleIdentity", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemon=dnsDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTable=dhcpLeaseTable, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetUsed=dhcpSubnetUsed, trapDNS=trapDNS, haServiceRunning=haServiceRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsFailure=dnsStatsFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsReferral=dnsStatsReferral, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, ha=ha, dhcp=dhcp, adonisTraps=adonisTraps, commandServerDaemon=commandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, tftp=tftp, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, licenseValid=licenseValid, dhcpDaemon=dhcpDaemon, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServer=trapCommandServer, systemDaemon=systemDaemon, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemon=tftpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapReplicationFailure=trapReplicationFailure, adonis=adonis, dhcpStats=dhcpStats, trapHA=trapHA, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, adonisObjects=adonisObjects, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolTable=dhcpPoolTable, dhcpPoolSize=dhcpPoolSize, system=system, dhcpIP=dhcpIP, dns=dns, trapDNSDaemon=trapDNSDaemon, lcd=lcd, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFailOverState=dhcpFailOverState, lcdDaemon=lcdDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetSize=dhcpSubnetSize, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIP=dhcpFixedIP, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCP=trapDHCP, dhcpSubnetTable=dhcpSubnetTable, trapSystem=trapSystem, dhcpDaemonRunning=dhcpDaemonRunning, haReplicationBinding=haReplicationBinding, systemState=systemState, licenseExpiry=licenseExpiry, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolAlert=dhcpPoolAlert, haService=haService, haServiceNodeType=haServiceNodeType, trapReplication=trapReplication, dnsStats=dnsStats, dhcpPoolEntry=dhcpPoolEntry)
