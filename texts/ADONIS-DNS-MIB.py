...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", systemDaemon=systemDaemon, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServer=commandServer, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceNodeType=haServiceNodeType, dhcpConfig=dhcpConfig, tftp=tftp, dhcpDaemonRunning=dhcpDaemonRunning, trapReplication=trapReplication, haService=haService, ha=ha, dhcpSubnetUsed=dhcpSubnetUsed, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTPDaemon=trapTFTPDaemon, dhcp=dhcp, trapSystem=trapSystem, dhcpLeaseTable=dhcpLeaseTable, systemState=systemState, trapDNSDaemon=trapDNSDaemon, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCP=trapDHCP, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, lcdDaemon=lcdDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolTable=dhcpPoolTable, haReplicationBinding=haReplicationBinding, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEntry=dhcpLeaseEntry, lcd=lcd, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEndIP=dhcpPoolEndIP, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemon=commandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetSize=dhcpSubnetSize, dhcpIP=dhcpIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIP=dhcpFixedIP, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, licenseExpiry=licenseExpiry, adonisObjects=adonisObjects, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dhcpStats=dhcpStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDNS=trapDNS, dnsStatsNXDomain=dnsStatsNXDomain, PYSNMP_MODULE_ID=adonis, licenseValid=licenseValid, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, tftpDaemonRunning=tftpDaemonRunning, tftpDaemon=tftpDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, haServiceRunning=haServiceRunning, trapReplicationFailure=trapReplicationFailure, dnsDaemon=dnsDaemon, trapHA=trapHA, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, system=system, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer)
