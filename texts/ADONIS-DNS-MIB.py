...
Counter32, Unsigned32, enterprises, IpAddress, Gauge32, Counter64, TimeTicks, NotificationType, MibIdentifier, ObjectIdentity, Bits, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "enterprises", "IpAddress", "Gauge32", "Counter64", "TimeTicks", "NotificationType", "MibIdentifier", "ObjectIdentity", "Bits", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXDomain=dnsStatsNXDomain, trapHA=trapHA, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonisObjects=adonisObjects, dhcp=dhcp, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpStats=dhcpStats, trapSystem=trapSystem, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, dhcpIP=dhcpIP, haServiceRunning=haServiceRunning, trapTFTPDaemon=trapTFTPDaemon, systemState=systemState, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, tftp=tftp, ha=ha, trapDHCP=trapDHCP, systemDaemon=systemDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, haService=haService, dnsDaemonRunning=dnsDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, trapSystemDaemon=trapSystemDaemon, licenseValid=licenseValid, dhcpFailOverState=dhcpFailOverState, system=system, dhcpFixedIP=dhcpFixedIP, dhcpPoolStartIP=dhcpPoolStartIP, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, lcdDaemon=lcdDaemon, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, commandServer=commandServer, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, dhcpConfig=dhcpConfig, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceNodeType=haServiceNodeType, trapReplicationFailure=trapReplicationFailure, adonis=adonis, dhcpDaemonRunning=dhcpDaemonRunning, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetTable=dhcpSubnetTable, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, trapHAServiceFailOver=trapHAServiceFailOver, trapReplication=trapReplication, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, dhcpPoolSize=dhcpPoolSize, dhcpPoolAlert=dhcpPoolAlert, trapDNS=trapDNS, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, dhcpPoolEntry=dhcpPoolEntry, trapDHCPDaemon=trapDHCPDaemon, dnsStatsReferral=dnsStatsReferral)
