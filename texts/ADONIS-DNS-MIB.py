...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsRecursion=dnsStatsRecursion, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, dnsStats=dnsStats, systemState=systemState, trapCommandServer=trapCommandServer, lcdDaemon=lcdDaemon, haService=haService, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTable=dhcpLeaseTable, system=system, ha=ha, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetSize=dhcpSubnetSize, trapCommandServerDaemon=trapCommandServerDaemon, trapDNSDaemon=trapDNSDaemon, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, lcd=lcd, haServiceRunning=haServiceRunning, commandServer=commandServer, dns=dns, dnsDaemon=dnsDaemon, trapSystemDaemon=trapSystemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dhcpDaemonRunning=dhcpDaemonRunning, trapHA=trapHA, dhcpDaemon=dhcpDaemon, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetTable=dhcpSubnetTable, adonis=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapReplication=trapReplication, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpStats=dhcpStats, dnsStatsFailure=dnsStatsFailure, dhcpPoolSize=dhcpPoolSize, dnsStatsSuccess=dnsStatsSuccess, tftpDaemon=tftpDaemon, trapSystem=trapSystem, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapTFTP=trapTFTP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEntry=dhcpPoolEntry, haReplicationBinding=haReplicationBinding, dhcpLeaseStartTime=dhcpLeaseStartTime, PYSNMP_MODULE_ID=adonis, trapDHCP=trapDHCP, adonisTraps=adonisTraps, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, licenseExpiry=licenseExpiry, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolTable=dhcpPoolTable, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolStartIP=dhcpPoolStartIP, dhcpConfig=dhcpConfig, tftpDaemonRunning=tftpDaemonRunning, trapDNS=trapDNS, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, dhcp=dhcp)
