...
LecDataFrameFormat, VpiInteger, VciInteger, LecDataFrameSize, atmfLanEmulation = mibBuilder.importSymbols("LAN-EMULATION-CLIENT-MIB", "LecDataFrameFormat", "VpiInteger", "VciInteger", "LecDataFrameSize", "atmfLanEmulation")
...
mibBuilder.exportSymbols("LAN-EMULATION-ELAN-MIB", elanPolicyIndex=elanPolicyIndex, AtmLaneMask=AtmLaneMask, elanConfGroup=elanConfGroup, elanConfEntry=elanConfEntry, elanPolicyTable=elanPolicyTable, lecsStatInBadFrames=lecsStatInBadFrames, elanConfTable=elanConfTable, lecsErrCtlEntry=lecsErrCtlEntry, elanLecMacAddress=elanLecMacAddress, elanLecMacAddrTable=elanLecMacAddrTable, elanPolicySelectorIndex=elanPolicySelectorIndex, elanConfNextId=elanConfNextId, lecsErrCtlClearLog=lecsErrCtlClearLog, lecsStatInvalidDest=lecsStatInvalidDest, lecsElanTable=lecsElanTable, TlvSelectorIndexType=TlvSelectorIndexType, elanLesAtmAddress=elanLesAtmAddress, byPktSize=byPktSize, lecsStatInsufRes=lecsStatInsufRes, lecsConfTable=lecsConfTable, lecsStatNoConf=lecsStatNoConf, lecsErrCtlTable=lecsErrCtlTable, elanLecFrameSize=elanLecFrameSize, elanLecNameEntry=elanLecNameEntry, lecsTlvEntry=lecsTlvEntry, lecsVccTable=lecsVccTable, elanLecsGroup=elanLecsGroup, lecsStatConfError=lecsStatConfError, lecsPolicySelIndex=lecsPolicySelIndex, byElanName=byElanName, lecsTlvTable=lecsTlvTable, elanAdminPolicyVal=elanAdminPolicyVal, elanLecRdSegId=elanLecRdSegId, elanLesRowStatus=elanLesRowStatus, elanLecPktSizeRowStatus=elanLecPktSizeRowStatus, lecsStatSuccessful=lecsStatSuccessful, elanLecNameTable=elanLecNameTable, byAtmAddr=byAtmAddr, lecsConfEntry=lecsConfEntry, elanMIB=elanMIB, lecsTlvVal=lecsTlvVal, byMacAddr=byMacAddr, lecsAtmIfIndex=lecsAtmIfIndex, AtmLaneAddress=AtmLaneAddress, elanLecElanName=elanLecElanName, RowStatus=RowStatus, elanLecAtmAddrEntry=elanLecAtmAddrEntry, lecsTlvIndex=lecsTlvIndex, lecsAtmAddrMask=lecsAtmAddrMask, elanLecAtmMask=elanLecAtmMask, elanLecRdBridgeNum=elanLecRdBridgeNum, lecsErrLogErrCode=lecsErrLogErrCode, lecsVccVci=lecsVccVci, lecsErrLogTime=lecsErrLogTime, elanLecsStatGroup=elanLecsStatGroup, elanPolicyRowStatus=elanPolicyRowStatus, LecsErrLogIndexType=LecsErrLogIndexType, PolicySelectorIndexType=PolicySelectorIndexType, MacAddress=MacAddress, ElanLocalIndex=ElanLocalIndex, elanConfIndex=elanConfIndex, elanConfMaxFrameSize=elanConfMaxFrameSize, elanPolicyPriority=elanPolicyPriority, elanLecMacAddrEntry=elanLecMacAddrEntry, lecsStatAccDenied=lecsStatAccDenied, lecsErrLogEntry=lecsErrLogEntry, lecsConfNextId=lecsConfNextId, byLanType=byLanType, lecsTlvTag=lecsTlvTag, lecsStatInvalidReq=lecsStatInvalidReq, elanLecNameRowStatus=elanLecNameRowStatus, lecsErrCtlOperStatus=lecsErrCtlOperStatus, lecsStatsTable=lecsStatsTable, lecsErrLogIndex=lecsErrLogIndex, byRouteDescriptor=byRouteDescriptor, elanLecAtmAddress=elanLecAtmAddress, lecsErrCtlMaxEntries=lecsErrCtlMaxEntries, lecsVccRowStatus=lecsVccRowStatus, AutonomousType=AutonomousType, elanPolicyType=elanPolicyType, elanAdminGroup=elanAdminGroup, elanLecPktSizeTable=elanLecPktSizeTable, lecsErrLogTable=lecsErrLogTable, lecsErrCtlAdminStatus=lecsErrCtlAdminStatus, elanLecPktSizeEntry=elanLecPktSizeEntry, lecsAdminStatus=lecsAdminStatus, lecsVccEntry=lecsVccEntry, elanLesIndex=elanLesIndex, lecsVccIfIndex=lecsVccIfIndex, elanConfRowStatus=elanConfRowStatus, lecsStatInsufInfo=lecsStatInsufInfo, lecsErrCtlLastEntry=lecsErrCtlLastEntry, elanLecAtmAddrTable=elanLecAtmAddrTable, lecsConfIndex=lecsConfIndex, elanLecsFaultGroup=elanLecsFaultGroup, lecsRowStatus=lecsRowStatus, elanLecRdTable=elanLecRdTable, Integer=Integer, lecsStatsEntry=lecsStatsEntry, lecsOperStatus=lecsOperStatus, elanLesTable=elanLesTable, elanLecAtmRowStatus=elanLecAtmRowStatus, lecsTlvRowStatus=lecsTlvRowStatus, lecsVccVpi=lecsVccVpi, elanConfTlvIndex=elanConfTlvIndex, lecsAtmAddrActual=lecsAtmAddrActual, elanLesEntry=elanLesEntry, TIMESTAMP=TIMESTAMP, lecsElanRowStatus=lecsElanRowStatus, elanLecMacRowStatus=elanLecMacRowStatus, IfIndexOrZero=IfIndexOrZero, lecsAtmAddrSpec=lecsAtmAddrSpec, elanConfLanType=elanConfLanType, lecsElanEntry=lecsElanEntry, lecsStatInvalidAddr=lecsStatInvalidAddr, lecsStatInvalidParam=lecsStatInvalidParam, elanConfName=elanConfName, lecsErrLogAtmAddr=lecsErrLogAtmAddr, elanLecRdEntry=elanLecRdEntry, elanPolicyEntry=elanPolicyEntry, elanLecsConfGroup=elanLecsConfGroup, lecsLastInitialized=lecsLastInitialized, lecsTlvSelectorIndex=lecsTlvSelectorIndex, elanLecRdRowStatus=elanLecRdRowStatus)
