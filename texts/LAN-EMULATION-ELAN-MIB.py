...
LecDataFrameFormat, LecDataFrameSize, atmfLanEmulation, VpiInteger, VciInteger = mibBuilder.importSymbols("LAN-EMULATION-CLIENT-MIB", "LecDataFrameFormat", "LecDataFrameSize", "atmfLanEmulation", "VpiInteger", "VciInteger")
...
mibBuilder.exportSymbols("LAN-EMULATION-ELAN-MIB", lecsStatNoConf=lecsStatNoConf, MacAddress=MacAddress, elanLecAtmAddrEntry=elanLecAtmAddrEntry, lecsStatsEntry=lecsStatsEntry, RowStatus=RowStatus, elanConfLanType=elanConfLanType, lecsConfNextId=lecsConfNextId, lecsElanTable=lecsElanTable, lecsTlvTag=lecsTlvTag, elanLecAtmMask=elanLecAtmMask, lecsErrCtlClearLog=lecsErrCtlClearLog, lecsAdminStatus=lecsAdminStatus, elanLecMacAddrEntry=elanLecMacAddrEntry, lecsErrLogIndex=lecsErrLogIndex, elanConfTable=elanConfTable, ElanLocalIndex=ElanLocalIndex, lecsErrLogTime=lecsErrLogTime, lecsErrLogAtmAddr=lecsErrLogAtmAddr, lecsConfTable=lecsConfTable, elanLecMacAddress=elanLecMacAddress, Integer=Integer, elanLecRdEntry=elanLecRdEntry, elanLesIndex=elanLesIndex, lecsAtmIfIndex=lecsAtmIfIndex, elanLesAtmAddress=elanLesAtmAddress, elanConfRowStatus=elanConfRowStatus, lecsVccIfIndex=lecsVccIfIndex, elanConfEntry=elanConfEntry, lecsVccVpi=lecsVccVpi, lecsErrCtlOperStatus=lecsErrCtlOperStatus, elanConfMaxFrameSize=elanConfMaxFrameSize, elanLecAtmRowStatus=elanLecAtmRowStatus, elanLecNameRowStatus=elanLecNameRowStatus, lecsTlvTable=lecsTlvTable, lecsStatInBadFrames=lecsStatInBadFrames, lecsErrCtlMaxEntries=lecsErrCtlMaxEntries, TlvSelectorIndexType=TlvSelectorIndexType, elanPolicyPriority=elanPolicyPriority, lecsStatsTable=lecsStatsTable, lecsConfEntry=lecsConfEntry, lecsStatInvalidAddr=lecsStatInvalidAddr, elanPolicyTable=elanPolicyTable, elanLecRdRowStatus=elanLecRdRowStatus, lecsConfIndex=lecsConfIndex, lecsStatAccDenied=lecsStatAccDenied, lecsErrLogErrCode=lecsErrLogErrCode, elanPolicyType=elanPolicyType, PolicySelectorIndexType=PolicySelectorIndexType, lecsVccVci=lecsVccVci, lecsVccRowStatus=lecsVccRowStatus, lecsStatSuccessful=lecsStatSuccessful, lecsErrCtlTable=lecsErrCtlTable, lecsOperStatus=lecsOperStatus, lecsTlvRowStatus=lecsTlvRowStatus, lecsElanEntry=lecsElanEntry, lecsStatInvalidDest=lecsStatInvalidDest, elanLecsFaultGroup=elanLecsFaultGroup, AutonomousType=AutonomousType, elanAdminGroup=elanAdminGroup, elanConfIndex=elanConfIndex, elanLecPktSizeTable=elanLecPktSizeTable, elanLecMacRowStatus=elanLecMacRowStatus, lecsRowStatus=lecsRowStatus, lecsStatInsufRes=lecsStatInsufRes, lecsTlvSelectorIndex=lecsTlvSelectorIndex, elanConfName=elanConfName, TIMESTAMP=TIMESTAMP, elanLecMacAddrTable=elanLecMacAddrTable, lecsStatConfError=lecsStatConfError, elanPolicySelectorIndex=elanPolicySelectorIndex, elanLesEntry=elanLesEntry, elanLecAtmAddrTable=elanLecAtmAddrTable, LecsErrLogIndexType=LecsErrLogIndexType, lecsAtmAddrActual=lecsAtmAddrActual, elanPolicyIndex=elanPolicyIndex, lecsErrCtlEntry=lecsErrCtlEntry, elanAdminPolicyVal=elanAdminPolicyVal, elanLesRowStatus=elanLesRowStatus, lecsStatInvalidReq=lecsStatInvalidReq, lecsVccTable=lecsVccTable, elanLecRdBridgeNum=elanLecRdBridgeNum, elanPolicyEntry=elanPolicyEntry, byElanName=byElanName, lecsAtmAddrSpec=lecsAtmAddrSpec, elanLecNameTable=elanLecNameTable, elanLecElanName=elanLecElanName, lecsElanRowStatus=lecsElanRowStatus, IfIndexOrZero=IfIndexOrZero, lecsPolicySelIndex=lecsPolicySelIndex, lecsErrLogTable=lecsErrLogTable, lecsErrCtlLastEntry=lecsErrCtlLastEntry, lecsLastInitialized=lecsLastInitialized, lecsStatInsufInfo=lecsStatInsufInfo, elanLecFrameSize=elanLecFrameSize, elanMIB=elanMIB, AtmLaneAddress=AtmLaneAddress, lecsTlvVal=lecsTlvVal, elanLecPktSizeEntry=elanLecPktSizeEntry, lecsStatInvalidParam=lecsStatInvalidParam, elanLecsGroup=elanLecsGroup, elanConfGroup=elanConfGroup, byMacAddr=byMacAddr, byPktSize=byPktSize, elanLecNameEntry=elanLecNameEntry, elanPolicyRowStatus=elanPolicyRowStatus, lecsTlvEntry=lecsTlvEntry, elanLecAtmAddress=elanLecAtmAddress, elanConfNextId=elanConfNextId, byRouteDescriptor=byRouteDescriptor, byLanType=byLanType, lecsTlvIndex=lecsTlvIndex, lecsVccEntry=lecsVccEntry, elanLecsConfGroup=elanLecsConfGroup, elanLecPktSizeRowStatus=elanLecPktSizeRowStatus, elanLesTable=elanLesTable, elanLecRdSegId=elanLecRdSegId, elanConfTlvIndex=elanConfTlvIndex, lecsErrLogEntry=lecsErrLogEntry, lecsAtmAddrMask=lecsAtmAddrMask, byAtmAddr=byAtmAddr, lecsErrCtlAdminStatus=lecsErrCtlAdminStatus, elanLecsStatGroup=elanLecsStatGroup, elanLecRdTable=elanLecRdTable, AtmLaneMask=AtmLaneMask)
