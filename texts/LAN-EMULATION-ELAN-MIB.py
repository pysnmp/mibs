...
LecDataFrameSize, VciInteger, LecDataFrameFormat, VpiInteger, atmfLanEmulation = mibBuilder.importSymbols("LAN-EMULATION-CLIENT-MIB", "LecDataFrameSize", "VciInteger", "LecDataFrameFormat", "VpiInteger", "atmfLanEmulation")
...
mibBuilder.exportSymbols("LAN-EMULATION-ELAN-MIB", elanConfRowStatus=elanConfRowStatus, elanPolicyTable=elanPolicyTable, elanPolicyEntry=elanPolicyEntry, elanLecMacAddress=elanLecMacAddress, lecsOperStatus=lecsOperStatus, lecsTlvSelectorIndex=lecsTlvSelectorIndex, elanLesIndex=elanLesIndex, elanPolicyType=elanPolicyType, elanLecMacAddrEntry=elanLecMacAddrEntry, lecsTlvEntry=lecsTlvEntry, elanLecsConfGroup=elanLecsConfGroup, MacAddress=MacAddress, elanConfGroup=elanConfGroup, lecsErrCtlOperStatus=lecsErrCtlOperStatus, elanLesTable=elanLesTable, elanLesEntry=elanLesEntry, lecsVccEntry=lecsVccEntry, RowStatus=RowStatus, elanLecNameEntry=elanLecNameEntry, lecsStatNoConf=lecsStatNoConf, PolicySelectorIndexType=PolicySelectorIndexType, elanLecPktSizeEntry=elanLecPktSizeEntry, elanLecAtmRowStatus=elanLecAtmRowStatus, lecsRowStatus=lecsRowStatus, lecsStatConfError=lecsStatConfError, ElanLocalIndex=ElanLocalIndex, elanLecPktSizeRowStatus=elanLecPktSizeRowStatus, lecsErrLogTable=lecsErrLogTable, byElanName=byElanName, lecsElanRowStatus=lecsElanRowStatus, elanLecElanName=elanLecElanName, lecsStatInsufInfo=lecsStatInsufInfo, lecsConfNextId=lecsConfNextId, Integer=Integer, elanLesRowStatus=elanLesRowStatus, elanLecAtmAddrEntry=elanLecAtmAddrEntry, elanLecsFaultGroup=elanLecsFaultGroup, lecsAtmIfIndex=lecsAtmIfIndex, elanLecRdRowStatus=elanLecRdRowStatus, lecsTlvTable=lecsTlvTable, lecsAtmAddrActual=lecsAtmAddrActual, lecsErrLogIndex=lecsErrLogIndex, elanLecAtmMask=elanLecAtmMask, lecsStatsTable=lecsStatsTable, TIMESTAMP=TIMESTAMP, AtmLaneMask=AtmLaneMask, lecsErrLogErrCode=lecsErrLogErrCode, elanLecRdTable=elanLecRdTable, TlvSelectorIndexType=TlvSelectorIndexType, lecsErrLogAtmAddr=lecsErrLogAtmAddr, elanLecNameRowStatus=elanLecNameRowStatus, AutonomousType=AutonomousType, lecsErrCtlAdminStatus=lecsErrCtlAdminStatus, byMacAddr=byMacAddr, lecsConfIndex=lecsConfIndex, lecsTlvRowStatus=lecsTlvRowStatus, elanLecRdBridgeNum=elanLecRdBridgeNum, elanAdminPolicyVal=elanAdminPolicyVal, lecsVccTable=lecsVccTable, LecsErrLogIndexType=LecsErrLogIndexType, byPktSize=byPktSize, lecsStatInBadFrames=lecsStatInBadFrames, elanLecRdEntry=elanLecRdEntry, elanLecFrameSize=elanLecFrameSize, lecsLastInitialized=lecsLastInitialized, lecsElanTable=lecsElanTable, byAtmAddr=byAtmAddr, elanConfIndex=elanConfIndex, elanAdminGroup=elanAdminGroup, elanLecAtmAddrTable=elanLecAtmAddrTable, lecsStatInvalidDest=lecsStatInvalidDest, lecsAtmAddrSpec=lecsAtmAddrSpec, lecsStatAccDenied=lecsStatAccDenied, lecsErrLogTime=lecsErrLogTime, byLanType=byLanType, elanPolicyRowStatus=elanPolicyRowStatus, lecsVccVci=lecsVccVci, elanLecsGroup=elanLecsGroup, elanConfMaxFrameSize=elanConfMaxFrameSize, lecsErrCtlTable=lecsErrCtlTable, elanLecMacRowStatus=elanLecMacRowStatus, lecsStatInvalidReq=lecsStatInvalidReq, lecsConfEntry=lecsConfEntry, lecsElanEntry=lecsElanEntry, lecsStatInsufRes=lecsStatInsufRes, lecsErrLogEntry=lecsErrLogEntry, lecsStatSuccessful=lecsStatSuccessful, elanMIB=elanMIB, lecsAtmAddrMask=lecsAtmAddrMask, lecsPolicySelIndex=lecsPolicySelIndex, elanConfEntry=elanConfEntry, elanConfTlvIndex=elanConfTlvIndex, elanLecAtmAddress=elanLecAtmAddress, elanPolicySelectorIndex=elanPolicySelectorIndex, lecsVccVpi=lecsVccVpi, lecsVccIfIndex=lecsVccIfIndex, lecsStatInvalidAddr=lecsStatInvalidAddr, lecsErrCtlLastEntry=lecsErrCtlLastEntry, elanConfNextId=elanConfNextId, elanLecsStatGroup=elanLecsStatGroup, byRouteDescriptor=byRouteDescriptor, elanConfTable=elanConfTable, lecsConfTable=lecsConfTable, IfIndexOrZero=IfIndexOrZero, elanConfLanType=elanConfLanType, elanLecNameTable=elanLecNameTable, lecsAdminStatus=lecsAdminStatus, lecsErrCtlClearLog=lecsErrCtlClearLog, lecsTlvTag=lecsTlvTag, lecsVccRowStatus=lecsVccRowStatus, elanPolicyIndex=elanPolicyIndex, elanLesAtmAddress=elanLesAtmAddress, lecsStatsEntry=lecsStatsEntry, elanPolicyPriority=elanPolicyPriority, elanConfName=elanConfName, lecsErrCtlMaxEntries=lecsErrCtlMaxEntries, elanLecRdSegId=elanLecRdSegId, AtmLaneAddress=AtmLaneAddress, lecsTlvIndex=lecsTlvIndex, lecsTlvVal=lecsTlvVal, elanLecMacAddrTable=elanLecMacAddrTable, elanLecPktSizeTable=elanLecPktSizeTable, lecsErrCtlEntry=lecsErrCtlEntry, lecsStatInvalidParam=lecsStatInvalidParam)
