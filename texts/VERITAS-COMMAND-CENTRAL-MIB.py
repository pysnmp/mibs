...
mibBuilder.exportSymbols("VERITAS-COMMAND-CENTRAL-MIB", policyName=policyName, alertDescription=alertDescription, ccHost=ccHost, sourceId=sourceId, ccTrapVarsBranch=ccTrapVarsBranch, ccTrapBranch=ccTrapBranch, sampleData=sampleData, ccError=ccError, ccInformational=ccInformational, ccTrapDefinitionsBranch=ccTrapDefinitionsBranch, veritascc=veritascc, ccWarning=ccWarning, objectType=objectType, ccAlertSeverity=ccAlertSeverity, ccCritical=ccCritical, ccTrapVarsGroup=ccTrapVarsGroup, alertRecipients=alertRecipients, alertSummary=alertSummary, ccAlertTime=ccAlertTime, ccTrapGroup=ccTrapGroup, ccObject=ccObject, collectorName=collectorName, ccTrapBranchPrefix=ccTrapBranchPrefix, PYSNMP_MODULE_ID=veritascc)
