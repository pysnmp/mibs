...
# Produced by pysmi-1.1.12 at Thu Apr  4 03:03:13 2024
...
Counter32, ModuleIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, Integer32, Unsigned32, ObjectIdentity, Counter64, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "Integer32", "Unsigned32", "ObjectIdentity", "Counter64", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuTable=vmwCpuTable, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vpxdVMName=vpxdVMName, vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrap=vpxdTrap, vmwMemShares=vmwMemShares, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmwDiskShares=vmwDiskShares, vmPoweredOff=vmPoweredOff, vmHBDetected=vmHBDetected, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaIdx=vmwHbaIdx, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID, vmwNetIdx=vmwNetIdx, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vpxdOldStatus=vpxdOldStatus, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmHBLost=vmHBLost, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID)
