...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:11:13 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Bits, IpAddress, NotificationType, iso, MibIdentifier, Gauge32, Counter64, Unsigned32, Counter32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Bits", "IpAddress", "NotificationType", "iso", "MibIdentifier", "Gauge32", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vmwMemTable=vmwMemTable, vmwHbaVMID=vmwHbaVMID, vmPoweredOff=vmPoweredOff, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vpxdHostName=vpxdHostName, vmwNetHCKbRx=vmwNetHCKbRx, vpxdNewStatus=vpxdNewStatus, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOn=vmPoweredOn, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vmwCpuUtil=vmwCpuUtil, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwKbWritten=vmwKbWritten, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads)
