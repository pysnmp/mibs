...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:24:09 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Bits, IpAddress, TimeTicks, NotificationType, Counter32, ObjectIdentity, ModuleIdentity, MibIdentifier, iso, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Bits", "IpAddress", "TimeTicks", "NotificationType", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "iso", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetVMID=vmwNetVMID, vmHBLost=vmHBLost, vmwCpuUtil=vmwCpuUtil, vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vpxdTrap=vpxdTrap, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwMemShares=vmwMemShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuEntry=vmwCpuEntry, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdVMName=vpxdVMName, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetName=vmwNetName, vpxdHostName=vpxdHostName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vpxdOldStatus=vpxdOldStatus, vmwNetPktsRx=vmwNetPktsRx, vmwHBATable=vmwHBATable, vmwNumWrites=vmwNumWrites, vmwMemVMID=vmwMemVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn)
