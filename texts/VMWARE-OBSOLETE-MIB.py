...
NotificationType, ModuleIdentity, Integer32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Counter32, Counter64, Bits, Gauge32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Counter32", "Counter64", "Bits", "Gauge32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetTable=vmwNetTable, vmwObsoleteGroup=vmwObsoleteGroup, vpxdOldStatus=vpxdOldStatus, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vmwNetPktsRx=vmwNetPktsRx, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumWrites=vmwNumWrites, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwNetName=vmwNetName, vmwMemUtil=vmwMemUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmHBDetected=vmHBDetected, vmwHbaName=vmwHbaName, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmwHbaIdx=vmwHbaIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmPoweredOn=vmPoweredOn, vmwHBATable=vmwHBATable, vmwNetIfAddr=vmwNetIfAddr, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vpxdVMName=vpxdVMName, vmwNetVMID=vmwNetVMID, vmwDiskShares=vmwDiskShares, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmwMemVMID=vmwMemVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended)
