...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:13:00 2024
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Counter64, Counter32, ModuleIdentity, MibIdentifier, TimeTicks, Bits, Unsigned32, ObjectIdentity, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Counter64", "Counter32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetVMID=vmwNetVMID, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemConfigured=vmwMemConfigured, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmkLoaded=vmkLoaded, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmHBLost=vmHBLost, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBATable=vmwHBATable, vmwNumWrites=vmwNumWrites, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vmwNumReads=vmwNumReads, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended)
