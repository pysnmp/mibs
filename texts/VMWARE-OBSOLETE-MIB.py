...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:23:36 2022
...
IpAddress, MibIdentifier, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Gauge32, Counter32, iso, ModuleIdentity, Counter64, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Gauge32", "Counter32", "iso", "ModuleIdentity", "Counter64", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrap=vpxdTrap, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmwCpuShares=vmwCpuShares, vmwMemConfigured=vmwMemConfigured, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrapType=vpxdTrapType, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwNetPktsRx=vmwNetPktsRx, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwDiskShares=vmwDiskShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmwNetHCKbTx=vmwNetHCKbTx, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID)
