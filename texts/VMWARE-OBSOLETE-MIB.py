...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:54:53 2022
...
Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ObjectIdentity, Integer32, NotificationType, Unsigned32, IpAddress, Counter64, ModuleIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ObjectIdentity", "Integer32", "NotificationType", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwNetIdx=vmwNetIdx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBLost=vmHBLost, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vpxdVMName=vpxdVMName, vmwMemEntry=vmwMemEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn)
