...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:16:22 2022
...
NotificationType, Counter64, Integer32, iso, IpAddress, ModuleIdentity, MibIdentifier, Unsigned32, Bits, Gauge32, Counter32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Integer32", "iso", "IpAddress", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Bits", "Gauge32", "Counter32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaIdx=vmwHbaIdx, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdNewStatus=vpxdNewStatus, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmPoweredOff=vmPoweredOff, vpxdHostName=vpxdHostName, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwMemVMID=vmwMemVMID, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable)
