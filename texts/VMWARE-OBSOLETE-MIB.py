...
Gauge32, ObjectIdentity, IpAddress, iso, NotificationType, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, TimeTicks, Counter32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "IpAddress", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "TimeTicks", "Counter32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemVMID=vmwMemVMID, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmwNumReads=vmwNumReads, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vmwDiskShares=vmwDiskShares, vpxdHostName=vpxdHostName, vmkLoaded=vmkLoaded, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwNetName=vmwNetName, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vpxdNewStatus=vpxdNewStatus, vmwNetIdx=vmwNetIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwNetPktsRx=vmwNetPktsRx, vmwNetShares=vmwNetShares, vmwNetIfAddr=vmwNetIfAddr, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwCpuTable=vmwCpuTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, vmwHBATable=vmwHBATable, vmHBDetected=vmHBDetected, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
