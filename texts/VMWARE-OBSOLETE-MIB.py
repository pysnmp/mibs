...
TimeTicks, Counter64, Counter32, iso, Bits, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Counter32", "iso", "Bits", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdNewStatus=vpxdNewStatus, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmwHBATable=vmwHBATable, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwCpuUtil=vmwCpuUtil, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmwCpuShares=vmwCpuShares, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance)
