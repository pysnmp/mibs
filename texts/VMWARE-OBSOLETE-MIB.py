...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:51:00 2022
...
NotificationType, IpAddress, Integer32, TimeTicks, MibIdentifier, Counter32, Counter64, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "Counter32", "Counter64", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwKbWritten=vmwKbWritten, vmwNumReads=vmwNumReads, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwKbRead=vmwKbRead, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vpxdHostName=vpxdHostName, vmwHBATable=vmwHBATable, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwCpuTable=vmwCpuTable, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vmwMemUtil=vmwMemUtil, vmwCpuEntry=vmwCpuEntry, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwCpuVMID=vmwCpuVMID, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vmwNetName=vmwNetName, vmwMemTable=vmwMemTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetShares=vmwNetShares, vmwCpuUtil=vmwCpuUtil, vmwNetKbRx=vmwNetKbRx, vpxdVMName=vpxdVMName, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB)
