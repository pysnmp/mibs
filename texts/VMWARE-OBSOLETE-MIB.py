...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:22:56 2022
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaIdx=vmwHbaIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrap=vpxdTrap, vmwNetIfAddr=vmwNetIfAddr, vmwMemShares=vmwMemShares, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmwNetShares=vmwNetShares, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwHbaName=vmwHbaName, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vmSuspended=vmSuspended, vmwCpuUtil=vmwCpuUtil, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue)
