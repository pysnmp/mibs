...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:40:36 2023
...
MibIdentifier, TimeTicks, ModuleIdentity, Counter64, ObjectIdentity, Bits, NotificationType, Gauge32, IpAddress, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter64", "ObjectIdentity", "Bits", "NotificationType", "Gauge32", "IpAddress", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdVMName=vpxdVMName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmHBDetected=vmHBDetected, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vpxdTrap=vpxdTrap, vmwNetVMID=vmwNetVMID, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, vmwObsoleteGroup=vmwObsoleteGroup, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwCpuUtil=vmwCpuUtil, vmwNumReads=vmwNumReads, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmwMemShares=vmwMemShares, vmwNetKbTx=vmwNetKbTx, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry)
