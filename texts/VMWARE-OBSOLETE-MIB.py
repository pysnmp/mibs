...
# Produced by pysmi-1.1.8 at Thu Feb  9 12:09:10 2023
...
ModuleIdentity, Counter64, NotificationType, IpAddress, iso, MibIdentifier, Bits, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "IpAddress", "iso", "MibIdentifier", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwMemConfigured=vmwMemConfigured, vpxdTrap=vpxdTrap, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vpxdObjValue=vpxdObjValue, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumReads=vmwNumReads, vmwObsoleteMIB=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vmPoweredOff=vmPoweredOff, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrapType=vpxdTrapType, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwNetVMID=vmwNetVMID, vmSuspended=vmSuspended, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsMIBGroups=vmwObsMIBGroups)
