...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:33:51 2023
...
NotificationType, IpAddress, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, TimeTicks, Unsigned32, MibIdentifier, ModuleIdentity, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaIdx=vmwHbaIdx, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, vmwNetEntry=vmwNetEntry, vmwCpuShares=vmwCpuShares, vpxdHostName=vpxdHostName, vmwCpuUtil=vmwCpuUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBATable=vmwHBATable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemConfigured=vmwMemConfigured, vmwDiskShares=vmwDiskShares, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwNetShares=vmwNetShares, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vpxdObjValue=vpxdObjValue)
