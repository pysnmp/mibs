...
MibIdentifier, ObjectIdentity, ModuleIdentity, Bits, Integer32, Counter64, NotificationType, Unsigned32, iso, IpAddress, TimeTicks, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Bits", "Integer32", "Counter64", "NotificationType", "Unsigned32", "iso", "IpAddress", "TimeTicks", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIB=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmPoweredOn=vmPoweredOn, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmwNetShares=vmwNetShares, vmwObsoleteGroup=vmwObsoleteGroup)
