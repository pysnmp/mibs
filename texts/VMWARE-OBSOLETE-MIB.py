...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:59:57 2023
...
TimeTicks, Counter32, MibIdentifier, ObjectIdentity, Bits, NotificationType, Unsigned32, Counter64, Gauge32, iso, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibIdentifier", "ObjectIdentity", "Bits", "NotificationType", "Unsigned32", "Counter64", "Gauge32", "iso", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemUtil=vmwMemUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwCpuVMID=vmwCpuVMID, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemConfigured=vmwMemConfigured, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdNewStatus=vpxdNewStatus, vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwNetIdx=vmwNetIdx, vpxdTrapType=vpxdTrapType, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwNetKbRx=vmwNetKbRx, vmwMemVMID=vmwMemVMID, vpxdOldStatus=vpxdOldStatus, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaVMID=vmwHbaVMID, vmwNetName=vmwNetName, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwKbWritten=vmwKbWritten, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwNetHCKbTx=vmwNetHCKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB)
