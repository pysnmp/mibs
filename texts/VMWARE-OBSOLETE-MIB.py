...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:36:25 2021
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, TimeTicks, Unsigned32, NotificationType, Counter64, Integer32, Counter32, Gauge32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "TimeTicks", "Unsigned32", "NotificationType", "Counter64", "Integer32", "Counter32", "Gauge32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vmwDiskShares=vmwDiskShares, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwMemVMID=vmwMemVMID, vmwObsMIBGroups=vmwObsMIBGroups)
