...
# Produced by pysmi-1.1.12 at Tue May 28 11:53:08 2024
...
ModuleIdentity, iso, Counter32, Counter64, NotificationType, Integer32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Counter32", "Counter64", "NotificationType", "Integer32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vpxdHostName=vpxdHostName, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuUtil=vmwCpuUtil, vmwMemVMID=vmwMemVMID, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrapType=vpxdTrapType, vmwNumWrites=vmwNumWrites, vmwDiskShares=vmwDiskShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOff=vmPoweredOff, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwNetKbTx=vmwNetKbTx, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances)
