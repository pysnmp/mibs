...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:46:02 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter32, ObjectIdentity, Integer32, NotificationType, ModuleIdentity, Gauge32, TimeTicks, Counter64, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "Integer32", "NotificationType", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter64", "MibIdentifier", "IpAddress", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbWritten=vmwKbWritten, vmHBLost=vmHBLost, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwMemConfigured=vmwMemConfigured, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vmwNetIdx=vmwNetIdx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vmSuspended=vmSuspended, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsRx=vmwNetPktsRx, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vpxdTrap=vpxdTrap, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vmwNetIfAddr=vmwNetIfAddr)
