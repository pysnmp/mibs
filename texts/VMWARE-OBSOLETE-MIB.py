...
# Produced by pysmi-1.1.12 at Tue May 28 13:14:53 2024
...
iso, Bits, ObjectIdentity, IpAddress, ModuleIdentity, MibIdentifier, TimeTicks, Counter32, Unsigned32, NotificationType, Gauge32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ObjectIdentity", "IpAddress", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaIdx=vmwHbaIdx, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwCpuTable=vmwCpuTable, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vmwNetEntry=vmwNetEntry, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vpxdTrapType=vpxdTrapType, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmHBLost=vmHBLost, vmwKbWritten=vmwKbWritten, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
