...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:03:45 2024
...
MibIdentifier, TimeTicks, Counter32, IpAddress, NotificationType, iso, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Counter32", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdVMName=vpxdVMName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwMemConfigured=vmwMemConfigured, vmwHbaIdx=vmwHbaIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwHbaVMID=vmwHbaVMID, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vpxdHostName=vpxdHostName, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended, vmwHBATable=vmwHBATable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
