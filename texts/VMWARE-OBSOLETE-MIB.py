...
ModuleIdentity, Integer32, Unsigned32, Gauge32, Counter32, NotificationType, IpAddress, Counter64, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Unsigned32", "Gauge32", "Counter32", "NotificationType", "IpAddress", "Counter64", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwNetPktsTx=vmwNetPktsTx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmwMemConfigured=vmwMemConfigured, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmwKbRead=vmwKbRead, vpxdHostName=vpxdHostName, vmwDiskShares=vmwDiskShares, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBDetected=vmHBDetected, vmwNetEntry=vmwNetEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemUtil=vmwMemUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmwMemTable=vmwMemTable)
