...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:48:35 2022
...
Unsigned32, Counter32, MibIdentifier, NotificationType, ModuleIdentity, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Gauge32, Integer32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "MibIdentifier", "NotificationType", "ModuleIdentity", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuEntry=vmwCpuEntry, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOff=vmPoweredOff, vpxdHostName=vpxdHostName, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwCpuVMID=vmwCpuVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vpxdOldStatus=vpxdOldStatus, vpxdVMName=vpxdVMName, vmwMemVMID=vmwMemVMID, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup)
