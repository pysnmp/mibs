...
# Produced by pysmi-1.1.12 at Thu May 30 02:23:11 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, iso, Bits, Counter64, TimeTicks, Counter32, Unsigned32, ObjectIdentity, MibIdentifier, Integer32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "iso", "Bits", "Counter64", "TimeTicks", "Counter32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Integer32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbRead=vmwKbRead, vmwNetVMID=vmwNetVMID, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumReads=vmwNumReads, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmPoweredOff=vmPoweredOff, vmwNetPktsRx=vmwNetPktsRx, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBATable=vmwHBATable, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbWritten=vmwKbWritten, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwMemTable=vmwMemTable, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOn=vmPoweredOn, vpxdVMName=vpxdVMName, vmwNetEntry=vmwNetEntry)
