...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:14:19 2023
...
ModuleIdentity, ObjectIdentity, Bits, NotificationType, Integer32, Counter64, Unsigned32, MibIdentifier, Gauge32, Counter32, IpAddress, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Bits", "NotificationType", "Integer32", "Counter64", "Unsigned32", "MibIdentifier", "Gauge32", "Counter32", "IpAddress", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vpxdHostName=vpxdHostName, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumReads=vmwNumReads, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwNetShares=vmwNetShares, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmSuspended=vmSuspended, vpxdVMName=vpxdVMName, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuUtil=vmwCpuUtil, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx)
