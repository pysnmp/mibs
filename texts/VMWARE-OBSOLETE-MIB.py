...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:31:48 2022
...
Unsigned32, Counter64, IpAddress, ModuleIdentity, Gauge32, MibIdentifier, Bits, NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "IpAddress", "ModuleIdentity", "Gauge32", "MibIdentifier", "Bits", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdHostName=vpxdHostName, vmwKbWritten=vmwKbWritten, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBLost=vmHBLost, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmwHbaName=vmwHbaName, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemShares=vmwMemShares, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwNetPktsRx=vmwNetPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmkLoaded=vmkLoaded, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetShares=vmwNetShares)
