...
ObjectIdentity, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, Unsigned32, NotificationType, Counter64, ModuleIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdObjValue=vpxdObjValue, vmwNetVMID=vmwNetVMID, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vmwKbRead=vmwKbRead, vmwCpuEntry=vmwCpuEntry, vmPoweredOff=vmPoweredOff, vmwMemShares=vmwMemShares, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwCpuTable=vmwCpuTable, vpxdTrap=vpxdTrap, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwNetKbTx=vmwNetKbTx, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmSuspended=vmSuspended, vmPoweredOn=vmPoweredOn, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vmwHbaName=vmwHbaName, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuShares=vmwCpuShares, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
