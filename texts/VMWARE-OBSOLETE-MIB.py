...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:45:23 2024
...
Gauge32, Integer32, Counter32, MibIdentifier, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ObjectIdentity, IpAddress, Unsigned32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter32", "MibIdentifier", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetTable=vmwNetTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vpxdTrap=vpxdTrap, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwDiskShares=vmwDiskShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vmwKbRead=vmwKbRead, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwCpuEntry=vmwCpuEntry, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx)
