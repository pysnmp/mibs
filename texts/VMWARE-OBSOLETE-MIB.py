...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:56:33 2022
...
TimeTicks, Counter64, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Integer32, IpAddress, NotificationType, ObjectIdentity, ModuleIdentity, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Integer32", "IpAddress", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuVMID=vmwCpuVMID, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwNetVMID=vmwNetVMID, vmwCpuEntry=vmwCpuEntry, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmwObsoleteGroup=vmwObsoleteGroup, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vmwHbaVMID=vmwHbaVMID)
