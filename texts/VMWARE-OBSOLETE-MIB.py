...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:38:10 2023
...
ObjectIdentity, Unsigned32, Gauge32, Counter32, MibIdentifier, Integer32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter64, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter32", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter64", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuShares=vmwCpuShares, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwMemConfigured=vmwMemConfigured, vpxdOldStatus=vpxdOldStatus, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vmwNetEntry=vmwNetEntry, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwCpuTable=vmwCpuTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap)
