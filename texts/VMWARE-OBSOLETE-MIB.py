...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:50:15 2023
...
Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, TimeTicks, Gauge32, NotificationType, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "TimeTicks", "Gauge32", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwNetKbRx=vmwNetKbRx, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwMemVMID=vmwMemVMID, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vpxdNewStatus=vpxdNewStatus, vmwHbaIdx=vmwHbaIdx, vmwHbaName=vmwHbaName, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwDiskShares=vmwDiskShares, vmwHbaVMID=vmwHbaVMID, vmwNetEntry=vmwNetEntry)
