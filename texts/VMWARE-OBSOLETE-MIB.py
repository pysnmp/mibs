...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:01:55 2023
...
MibIdentifier, ObjectIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, ModuleIdentity, Counter32, iso, Bits, Integer32, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "ModuleIdentity", "Counter32", "iso", "Bits", "Integer32", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetShares=vmwNetShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmHBDetected=vmHBDetected, vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vpxdHostName=vpxdHostName, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vpxdTrapType=vpxdTrapType, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwHbaIdx=vmwHbaIdx)
