...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:02:21 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmkLoaded=vmkLoaded, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vmSuspended=vmSuspended, vmwCpuUtil=vmwCpuUtil, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwKbRead=vmwKbRead, vmwMemTable=vmwMemTable, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuShares=vmwCpuShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwDiskShares=vmwDiskShares, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmHBDetected=vmHBDetected, vmwCpuEntry=vmwCpuEntry, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumReads=vmwNumReads, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwCpuVMID=vmwCpuVMID, vpxdHostName=vpxdHostName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmHBLost=vmHBLost, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry)
