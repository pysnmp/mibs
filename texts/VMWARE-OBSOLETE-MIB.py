...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:35:03 2024
...
iso, NotificationType, Bits, Counter64, Integer32, ObjectIdentity, Counter32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Bits", "Counter64", "Integer32", "ObjectIdentity", "Counter32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemShares=vmwMemShares, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwNumWrites=vmwNumWrites, vmwHbaVMID=vmwHbaVMID, vmwCpuVMID=vmwCpuVMID, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdObjValue=vpxdObjValue, vmwMemConfigured=vmwMemConfigured, vmwMemVMID=vmwMemVMID, vmHBDetected=vmHBDetected, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vmPoweredOn=vmPoweredOn, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwNetPktsTx=vmwNetPktsTx, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwHbaIdx=vmwHbaIdx)
