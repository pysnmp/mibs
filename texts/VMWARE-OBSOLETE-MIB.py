...
# Produced by pysmi-1.1.8 at Fri Jan  7 18:07:28 2022
...
TimeTicks, MibIdentifier, ModuleIdentity, IpAddress, ObjectIdentity, Unsigned32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vmwMemShares=vmwMemShares, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmwMemUtil=vmwMemUtil, vmwCpuShares=vmwCpuShares, vpxdNewStatus=vpxdNewStatus, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vpxdOldStatus=vpxdOldStatus, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vpxdObjValue=vpxdObjValue, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmHBDetected=vmHBDetected, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwMemTable=vmwMemTable)
