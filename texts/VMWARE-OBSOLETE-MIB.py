...
# Produced by pysmi-1.1.8 at Sat Jan 15 16:55:40 2022
...
TimeTicks, NotificationType, Counter32, iso, Gauge32, Bits, Counter64, IpAddress, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Counter32", "iso", "Gauge32", "Bits", "Counter64", "IpAddress", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwMemUtil=vmwMemUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vmwHBAEntry=vmwHBAEntry, vpxdObjValue=vpxdObjValue, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vmwNetIdx=vmwNetIdx, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwNetEntry=vmwNetEntry, vmwDiskShares=vmwDiskShares, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vmwCpuEntry=vmwCpuEntry)
