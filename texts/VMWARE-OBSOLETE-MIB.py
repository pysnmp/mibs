...
TimeTicks, IpAddress, ModuleIdentity, MibIdentifier, ObjectIdentity, NotificationType, iso, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwNetTable=vmwNetTable, vmwCpuUtil=vmwCpuUtil, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vmwNetVMID=vmwNetVMID, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vmwCpuEntry=vmwCpuEntry, vmwNetKbRx=vmwNetKbRx, vmwCpuVMID=vmwCpuVMID, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vpxdTrapType=vpxdTrapType, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry)
