...
# Produced by pysmi-1.1.8 at Tue Feb  8 23:23:48 2022
...
NotificationType, Gauge32, TimeTicks, Unsigned32, ModuleIdentity, Counter32, iso, MibIdentifier, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter32", "iso", "MibIdentifier", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemConfigured=vmwMemConfigured, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwNetIdx=vmwNetIdx, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwHbaName=vmwHbaName, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetTable=vmwNetTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetShares=vmwNetShares, vmPoweredOff=vmPoweredOff, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwKbWritten=vmwKbWritten, vmwNumWrites=vmwNumWrites, vpxdOldStatus=vpxdOldStatus)
