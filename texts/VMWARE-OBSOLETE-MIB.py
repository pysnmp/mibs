...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:25:57 2023
...
Counter32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter64, iso, Unsigned32, Bits, MibIdentifier, TimeTicks, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter64", "iso", "Unsigned32", "Bits", "MibIdentifier", "TimeTicks", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vmwDiskShares=vmwDiskShares, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwCpuUtil=vmwCpuUtil, vmwHBATable=vmwHBATable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vmwNetVMID=vmwNetVMID, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdOldStatus=vpxdOldStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vpxdVMName=vpxdVMName, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vpxdTrap=vpxdTrap, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwNetShares=vmwNetShares, vmwMemTable=vmwMemTable, vmwHbaName=vmwHbaName, vmPoweredOn=vmPoweredOn, vmwNetPktsTx=vmwNetPktsTx)
