...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:04:47 2024
...
ObjectIdentity, IpAddress, MibIdentifier, Counter32, iso, Integer32, Bits, Unsigned32, Counter64, TimeTicks, NotificationType, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter32", "iso", "Integer32", "Bits", "Unsigned32", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdHostName=vpxdHostName, vpxdTrapType=vpxdTrapType, vmwNumWrites=vmwNumWrites, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwNetEntry=vmwNetEntry, vmwNetShares=vmwNetShares, vmwCpuUtil=vmwCpuUtil, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwNetKbTx=vmwNetKbTx, vmwNetIfAddr=vmwNetIfAddr, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance)
