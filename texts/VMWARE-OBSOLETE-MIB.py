...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:59:09 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwNetHCKbRx=vmwNetHCKbRx, vpxdNewStatus=vpxdNewStatus, vmwKbWritten=vmwKbWritten, vpxdTrapType=vpxdTrapType, vmwObsoleteMIB=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwObsMIBGroups=vmwObsMIBGroups, vpxdOldStatus=vpxdOldStatus, vmwHbaVMID=vmwHbaVMID, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwMemShares=vmwMemShares, vmwNetShares=vmwNetShares, vmwCpuTable=vmwCpuTable, vpxdVMName=vpxdVMName, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwHbaName=vmwHbaName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbTx=vmwNetHCKbTx, vmwNumReads=vmwNumReads)
