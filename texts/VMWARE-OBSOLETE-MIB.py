...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:39:59 2023
...
Unsigned32, NotificationType, IpAddress, TimeTicks, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, MibIdentifier, ModuleIdentity, Gauge32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "IpAddress", "TimeTicks", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "MibIdentifier", "ModuleIdentity", "Gauge32", "iso", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmwMemTable=vmwMemTable, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuTable=vmwCpuTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost)
