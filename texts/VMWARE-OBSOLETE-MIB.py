...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:03:02 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, ObjectIdentity, Bits, ModuleIdentity, Unsigned32, NotificationType, Counter64, Counter32, TimeTicks, IpAddress, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "ObjectIdentity", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter64", "Counter32", "TimeTicks", "IpAddress", "MibIdentifier", "Integer32")
...
vmwObsolete, vmwTraps, vmwResources, vmwNotifications = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwObsolete", "vmwTraps", "vmwResources", "vmwNotifications")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetName=vmwNetName, vmwHbaIdx=vmwHbaIdx, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwMemVMID=vmwMemVMID, vmwCpuShares=vmwCpuShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmwCpuTable=vmwCpuTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vmwHBATable=vmwHBATable, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmwNetKbRx=vmwNetKbRx, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwNetVMID=vmwNetVMID, vmwNetKbTx=vmwNetKbTx, vpxdTrap=vpxdTrap, vpxdObjValue=vpxdObjValue, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwMemConfigured=vmwMemConfigured, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff)
