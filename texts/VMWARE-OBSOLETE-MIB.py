...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:23:49 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, Gauge32, Counter64, TimeTicks, IpAddress, Bits, Unsigned32, ObjectIdentity, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "Gauge32", "Counter64", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "ObjectIdentity", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuTable=vmwCpuTable, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsRx=vmwNetPktsRx, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmwHbaName=vmwHbaName, vmkLoaded=vmkLoaded, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmHBDetected=vmHBDetected, vpxdNewStatus=vpxdNewStatus, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vpxdTrap=vpxdTrap)
