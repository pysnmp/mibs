...
# Produced by pysmi-1.1.8 at Mon Jan 17 21:50:32 2022
...
Integer32, Gauge32, ObjectIdentity, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier, iso, ModuleIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ObjectIdentity", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetKbTx=vmwNetKbTx, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmwMemUtil=vmwMemUtil, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdNewStatus=vpxdNewStatus, vmwMemEntry=vmwMemEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwNetIfAddr=vmwNetIfAddr, vpxdTrap=vpxdTrap, vmwNetName=vmwNetName, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vmwObsMIBGroups=vmwObsMIBGroups, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, vmwCpuShares=vmwCpuShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vpxdOldStatus=vpxdOldStatus, vmwNetTable=vmwNetTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vmwHBAEntry=vmwHBAEntry, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vpxdVMName=vpxdVMName, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vmwNetVMID=vmwNetVMID, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmkLoaded=vmkLoaded)
