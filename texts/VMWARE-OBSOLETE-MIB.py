...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:59:47 2021
...
Counter32, Integer32, iso, NotificationType, ModuleIdentity, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, MibIdentifier, Unsigned32, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "iso", "NotificationType", "ModuleIdentity", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "MibIdentifier", "Unsigned32", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbTx=vmwNetHCKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwMemShares=vmwMemShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwNetEntry=vmwNetEntry, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwNetVMID=vmwNetVMID, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn)
