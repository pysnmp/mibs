...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:15:19 2024
...
NotificationType, Counter32, Gauge32, TimeTicks, Unsigned32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Bits, MibIdentifier, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "TimeTicks", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Bits", "MibIdentifier", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus, vmwHbaName=vmwHbaName, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwNetShares=vmwNetShares, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOff=vmPoweredOff, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwMemUtil=vmwMemUtil, vmwMemVMID=vmwMemVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetKbTx=vmwNetKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmSuspended=vmSuspended, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetEntry=vmwNetEntry, vmwCpuTable=vmwCpuTable)
