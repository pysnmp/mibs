...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:51:41 2022
...
IpAddress, Bits, TimeTicks, Unsigned32, iso, MibIdentifier, NotificationType, Counter32, ModuleIdentity, Integer32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "NotificationType", "Counter32", "ModuleIdentity", "Integer32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOff=vmPoweredOff, vmwMemConfigured=vmwMemConfigured, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vmwMemShares=vmwMemShares, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vpxdHostName=vpxdHostName, vmwNetPktsRx=vmwNetPktsRx, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID)
