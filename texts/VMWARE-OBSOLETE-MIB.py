...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:14:50 2022
...
Gauge32, Counter64, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, ObjectIdentity, Counter32, iso, TimeTicks, NotificationType, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "NotificationType", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbTx=vmwNetHCKbTx, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwMemUtil=vmwMemUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwDiskShares=vmwDiskShares, vmwNetName=vmwNetName, vpxdVMName=vpxdVMName)
