...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:31:19 2023
...
Integer32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, TimeTicks, Gauge32, Unsigned32, Bits, ObjectIdentity, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "TimeTicks", "Gauge32", "Unsigned32", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaName=vmwHbaName, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vmwNetTable=vmwNetTable, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwNetKbRx=vmwNetKbRx, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdNewStatus=vpxdNewStatus, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuUtil=vmwCpuUtil, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vpxdHostName=vpxdHostName)
