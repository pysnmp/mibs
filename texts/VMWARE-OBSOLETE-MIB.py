...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:30:20 2023
...
TimeTicks, ModuleIdentity, IpAddress, ObjectIdentity, NotificationType, Counter64, Bits, Unsigned32, Gauge32, MibIdentifier, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "IpAddress", "ObjectIdentity", "NotificationType", "Counter64", "Bits", "Unsigned32", "Gauge32", "MibIdentifier", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbRx=vmwNetKbRx, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vpxdNewStatus=vpxdNewStatus, vpxdTrapType=vpxdTrapType, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmwNetIfAddr=vmwNetIfAddr, vmwHBATable=vmwHBATable, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwMemShares=vmwMemShares, vpxdTrap=vpxdTrap, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemUtil=vmwMemUtil, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwNetKbTx=vmwNetKbTx)
