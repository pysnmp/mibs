...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:46:16 2022
...
ObjectIdentity, TimeTicks, NotificationType, ModuleIdentity, Integer32, MibIdentifier, Bits, Counter32, Unsigned32, Counter64, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "MibIdentifier", "Bits", "Counter32", "Unsigned32", "Counter64", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaIdx=vmwHbaIdx, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumWrites=vmwNumWrites, vmwHbaName=vmwHbaName, vmwCpuVMID=vmwCpuVMID, vmwNumReads=vmwNumReads, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrap=vpxdTrap, vmwNetShares=vmwNetShares, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmSuspended=vmSuspended, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmwMemVMID=vmwMemVMID, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwCpuTable=vmwCpuTable, vmwMemShares=vmwMemShares, vmkLoaded=vmkLoaded, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdVMName=vpxdVMName, vmwNetIfAddr=vmwNetIfAddr, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmwMemConfigured=vmwMemConfigured)
