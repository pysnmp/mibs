...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:07:58 2023
...
Bits, NotificationType, Counter32, Gauge32, Counter64, IpAddress, MibIdentifier, ModuleIdentity, TimeTicks, Integer32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter32", "Gauge32", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Integer32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vmPoweredOff=vmPoweredOff, vpxdHostName=vpxdHostName, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuEntry=vmwCpuEntry, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbRx=vmwNetKbRx, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmwNetEntry=vmwNetEntry, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetTable=vmwNetTable, vpxdNewStatus=vpxdNewStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwNetVMID=vmwNetVMID, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx)
