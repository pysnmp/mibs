...
Counter32, MibIdentifier, ObjectIdentity, Unsigned32, NotificationType, Integer32, iso, Counter64, Gauge32, ModuleIdentity, IpAddress, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "NotificationType", "Integer32", "iso", "Counter64", "Gauge32", "ModuleIdentity", "IpAddress", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwKbWritten=vmwKbWritten, vmwNetName=vmwNetName, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemUtil=vmwMemUtil, vmHBLost=vmHBLost, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmHBDetected=vmHBDetected, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwMemShares=vmwMemShares, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended, vpxdHostName=vpxdHostName, vpxdObjValue=vpxdObjValue, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, vmwCpuUtil=vmwCpuUtil)
