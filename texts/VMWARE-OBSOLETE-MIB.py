...
Bits, TimeTicks, ObjectIdentity, Unsigned32, Integer32, Counter64, iso, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32", "Integer32", "Counter64", "iso", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumReads=vmwNumReads, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmwDiskShares=vmwDiskShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwCpuShares=vmwCpuShares, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vpxdObjValue=vpxdObjValue, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vpxdHostName=vpxdHostName, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaName=vmwHbaName, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus)
