...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaIdx=vmwHbaIdx, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwHbaName=vmwHbaName, vpxdTrap=vpxdTrap, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, vmwCpuVMID=vmwCpuVMID, vmPoweredOn=vmPoweredOn, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vmwNetIfAddr=vmwNetIfAddr, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmSuspended=vmSuspended, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups)
