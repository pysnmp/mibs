...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:14:20 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter64, TimeTicks, Bits, ModuleIdentity, MibIdentifier, iso, NotificationType, Counter32, Integer32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter64", "TimeTicks", "Bits", "ModuleIdentity", "MibIdentifier", "iso", "NotificationType", "Counter32", "Integer32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vpxdObjValue=vpxdObjValue, vmwHbaVMID=vmwHbaVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwNetShares=vmwNetShares, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vmwNetIfAddr=vmwNetIfAddr, vmwNetEntry=vmwNetEntry, vmwCpuTable=vmwCpuTable, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwNetVMID=vmwNetVMID, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwDiskShares=vmwDiskShares, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten)
