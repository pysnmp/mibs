...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:07:27 2022
...
Bits, Integer32, TimeTicks, Unsigned32, ModuleIdentity, Gauge32, IpAddress, MibIdentifier, iso, Counter32, Counter64, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "TimeTicks", "Unsigned32", "ModuleIdentity", "Gauge32", "IpAddress", "MibIdentifier", "iso", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdObjValue=vpxdObjValue, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetTable=vmwNetTable, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwCpuTable=vmwCpuTable, vmwMemUtil=vmwMemUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOff=vmPoweredOff, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vpxdTrap=vpxdTrap, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbWritten=vmwKbWritten, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwHbaName=vmwHbaName, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwCpuUtil=vmwCpuUtil, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vmHBLost=vmHBLost, vmwMemEntry=vmwMemEntry, vpxdNewStatus=vpxdNewStatus, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vpxdVMName=vpxdVMName, vmwKbRead=vmwKbRead, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured)
