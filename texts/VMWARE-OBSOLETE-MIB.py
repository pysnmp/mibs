...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:43:22 2023
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, TimeTicks, ModuleIdentity, Integer32, Unsigned32, Counter32, iso, NotificationType, IpAddress, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "TimeTicks", "ModuleIdentity", "Integer32", "Unsigned32", "Counter32", "iso", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumReads=vmwNumReads, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vpxdOldStatus=vpxdOldStatus, vmwNetKbTx=vmwNetKbTx, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmwCpuVMID=vmwCpuVMID, vmwMemEntry=vmwMemEntry, vmwMemUtil=vmwMemUtil, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwNetIdx=vmwNetIdx, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost, vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmSuspended=vmSuspended, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vpxdTrap=vpxdTrap, vmwKbRead=vmwKbRead, vmwMemTable=vmwMemTable, vmwHbaName=vmwHbaName, vmwNetPktsRx=vmwNetPktsRx, vmHBDetected=vmHBDetected, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry)
