...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:17:49 2023
...
Counter64, NotificationType, iso, Bits, MibIdentifier, Integer32, TimeTicks, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "iso", "Bits", "MibIdentifier", "Integer32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwCpuShares=vmwCpuShares, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdObjValue=vpxdObjValue, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwNetShares=vmwNetShares, vmwHbaName=vmwHbaName, vpxdNewStatus=vpxdNewStatus, vmwNetName=vmwNetName, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsTx=vmwNetPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwNetHCKbRx=vmwNetHCKbRx)
