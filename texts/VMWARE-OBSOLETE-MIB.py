...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:26:58 2022
...
ObjectIdentity, Integer32, Gauge32, NotificationType, Bits, Counter32, Unsigned32, Counter64, iso, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "Bits", "Counter32", "Unsigned32", "Counter64", "iso", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwHbaIdx=vmwHbaIdx, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vmwCpuVMID=vmwCpuVMID, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx)
