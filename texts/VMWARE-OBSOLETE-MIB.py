...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:27:21 2024
...
iso, Bits, NotificationType, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Integer32, TimeTicks, Counter64, MibIdentifier, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Integer32", "TimeTicks", "Counter64", "MibIdentifier", "IpAddress", "ObjectIdentity")
...
vmwTraps, vmwObsolete, vmwNotifications, vmwResources = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwTraps", "vmwObsolete", "vmwNotifications", "vmwResources")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetPktsRx=vmwNetPktsRx, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuShares=vmwCpuShares, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vmwNetName=vmwNetName, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vmPoweredOff=vmPoweredOff, vmwMemUtil=vmwMemUtil, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumReads=vmwNumReads, vmPoweredOn=vmPoweredOn)
