...
# Produced by pysmi-1.1.12 at Mon May 13 02:44:21 2024
...
TimeTicks, MibIdentifier, Unsigned32, ModuleIdentity, Counter32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, NotificationType, Integer32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "NotificationType", "Integer32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemVMID=vmwMemVMID, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNumReads=vmwNumReads, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwCpuTable=vmwCpuTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemConfigured=vmwMemConfigured, vmwNetIdx=vmwNetIdx, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmwNumWrites=vmwNumWrites, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwNetKbTx=vmwNetKbTx, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetEntry=vmwNetEntry, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable)
