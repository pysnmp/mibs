...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:16:17 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, iso, Counter32, Bits, Gauge32, Counter64, ModuleIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "Bits", "Gauge32", "Counter64", "ModuleIdentity", "Unsigned32", "Integer32")
...
vmwResources, vmwObsolete, vmwNotifications, vmwTraps = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwResources", "vmwObsolete", "vmwNotifications", "vmwTraps")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmwNetEntry=vmwNetEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vpxdHostName=vpxdHostName, vmwMemUtil=vmwMemUtil, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwMemVMID=vmwMemVMID, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwCpuShares=vmwCpuShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwKbRead=vmwKbRead, vpxdNewStatus=vpxdNewStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmPoweredOff=vmPoweredOff, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbRx=vmwNetKbRx, vmwMemShares=vmwMemShares, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vmwNetName=vmwNetName)
