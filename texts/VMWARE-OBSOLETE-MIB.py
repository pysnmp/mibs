...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:57:22 2023
...
NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, Counter32, Counter64, iso, Bits, TimeTicks, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "Counter32", "Counter64", "iso", "Bits", "TimeTicks", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwHbaVMID=vmwHbaVMID, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbTx=vmwNetKbTx, vmwCpuTable=vmwCpuTable, vpxdVMName=vpxdVMName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwNetIdx=vmwNetIdx, vmwNetEntry=vmwNetEntry, vpxdHostName=vpxdHostName, vpxdTrap=vpxdTrap, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry)
