...
# Produced by pysmi-1.1.12 at Wed May 29 06:51:56 2024
...
TimeTicks, Integer32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, ObjectIdentity, Unsigned32, ModuleIdentity, Bits, Counter64, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Bits", "Counter64", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmSuspended=vmSuspended, vpxdHostName=vpxdHostName, vmwCpuTable=vmwCpuTable, vmwNetIdx=vmwNetIdx, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmwCpuEntry=vmwCpuEntry, vmwMemUtil=vmwMemUtil, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vmwNetVMID=vmwNetVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemTable=vmwMemTable, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmHBDetected=vmHBDetected, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsTx=vmwNetHCPktsTx)
