...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:43:25 2023
...
NotificationType, Integer32, MibIdentifier, Unsigned32, Bits, Counter64, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, TimeTicks, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibIdentifier", "Unsigned32", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "TimeTicks", "Gauge32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwObsoleteMIB=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwKbRead=vmwKbRead, vmwCpuVMID=vmwCpuVMID, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwNetHCKbRx=vmwNetHCKbRx, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwMemConfigured=vmwMemConfigured, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetTable=vmwNetTable, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn, vmwNetVMID=vmwNetVMID)
