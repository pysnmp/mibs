...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:10:57 2022
...
Counter64, Counter32, TimeTicks, Integer32, Unsigned32, Gauge32, iso, IpAddress, NotificationType, Bits, MibIdentifier, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "TimeTicks", "Integer32", "Unsigned32", "Gauge32", "iso", "IpAddress", "NotificationType", "Bits", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetTable=vmwNetTable, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwNetVMID=vmwNetVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vpxdTrapType=vpxdTrapType, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwMemShares=vmwMemShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmSuspended=vmSuspended, vmwNetPktsTx=vmwNetPktsTx, vmwHBATable=vmwHBATable, vmwCpuEntry=vmwCpuEntry, vmPoweredOn=vmPoweredOn, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID)
