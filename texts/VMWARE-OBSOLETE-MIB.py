...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:35:48 2023
...
Counter64, ObjectIdentity, Bits, Gauge32, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, NotificationType, iso, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Bits", "Gauge32", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "NotificationType", "iso", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemConfigured=vmwMemConfigured, vmwNetPktsRx=vmwNetPktsRx, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, vpxdTrap=vpxdTrap, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwHBAEntry=vmwHBAEntry, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmwNetName=vmwNetName, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID)
