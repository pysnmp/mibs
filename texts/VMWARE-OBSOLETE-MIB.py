...
# ASN.1 source VMWARE-OBSOLETE-MIB
# Source digest sha256:312612ae78750068ebe3d4dc6b1ec957961c7515fbefa179a74893cba47ed449
...
if mibBuilder.loadTexts: vmwObsoleteMIB.setLastUpdated('2008-10-15 11:59')
...
vmwCpuTable = MibTable((1, 3, 6, 1, 4, 1, 6876, 3, 1, 2), ).setMaxAccess("notaccessible")
...
vmwCpuEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6876, 3, 1, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "VMWARE-OBSOLETE-MIB", "vmwCpuVMID"))
...
vmwCpuVMID = MibTableColumn((1, 3, 6, 1, 4, 1, 6876, 3, 1, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 1023))).setMaxAccess("notaccessible")
...
vmwMemTable = MibTable((1, 3, 6, 1, 4, 1, 6876, 3, 2, 4), ).setMaxAccess("notaccessible")
...
vmwMemEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6876, 3, 2, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "VMWARE-OBSOLETE-MIB", "vmwMemVMID"))
...
vmwMemVMID = MibTableColumn((1, 3, 6, 1, 4, 1, 6876, 3, 2, 4, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 1023))).setMaxAccess("notaccessible")
...
vmwHBATable = MibTable((1, 3, 6, 1, 4, 1, 6876, 3, 3), ).setMaxAccess("notaccessible")
...
vmwHBAEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6876, 3, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "VMWARE-OBSOLETE-MIB", "vmwHbaIdx"))
...
vmwHbaIdx = MibTableColumn((1, 3, 6, 1, 4, 1, 6876, 3, 3, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 1023))).setMaxAccess("notaccessible")
...
vmwNetTable = MibTable((1, 3, 6, 1, 4, 1, 6876, 3, 4), ).setMaxAccess("notaccessible")
...
vmwNetEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6876, 3, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "VMWARE-OBSOLETE-MIB", "vmwNetIdx"))
...
vmwNetIdx = MibTableColumn((1, 3, 6, 1, 4, 1, 6876, 3, 4, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmPoweredOff=vmPoweredOff, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwCpuVMID=vmwCpuVMID, vmwDiskShares=vmwDiskShares, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwMemShares=vmwMemShares, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmwNetKbTx=vmwNetKbTx, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetShares=vmwNetShares, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vpxdNewStatus=vpxdNewStatus, vpxdObjValue=vpxdObjValue, vpxdOldStatus=vpxdOldStatus, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName)
