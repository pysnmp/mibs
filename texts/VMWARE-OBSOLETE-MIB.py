...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:10:11 2023
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmPoweredOff=vmPoweredOff, vmHBDetected=vmHBDetected, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwCpuTable=vmwCpuTable, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwNetTable=vmwNetTable, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetName=vmwNetName, vpxdHostName=vpxdHostName, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx)
