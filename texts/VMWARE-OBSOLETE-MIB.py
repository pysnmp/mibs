...
IpAddress, Integer32, ObjectIdentity, Gauge32, ModuleIdentity, TimeTicks, NotificationType, iso, Bits, Counter32, MibIdentifier, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "ObjectIdentity", "Gauge32", "ModuleIdentity", "TimeTicks", "NotificationType", "iso", "Bits", "Counter32", "MibIdentifier", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwNetShares=vmwNetShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vpxdVMName=vpxdVMName, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff, vmwNetName=vmwNetName, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwMemEntry=vmwMemEntry, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vmwNumWrites=vmwNumWrites, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuUtil=vmwCpuUtil, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vmwHbaName=vmwHbaName, vmwMemShares=vmwMemShares)
