...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:20:52 2022
...
Bits, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Counter64, ObjectIdentity, Gauge32, NotificationType, Integer32, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Counter64", "ObjectIdentity", "Gauge32", "NotificationType", "Integer32", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, vmwKbWritten=vmwKbWritten, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmwHbaIdx=vmwHbaIdx, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vpxdHostName=vpxdHostName, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwKbRead=vmwKbRead, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vpxdTrap=vpxdTrap, vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaName=vmwHbaName, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetIdx=vmwNetIdx, vmwHBATable=vmwHBATable)
