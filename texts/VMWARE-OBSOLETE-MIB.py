...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaVMID=vmwHbaVMID, vmwHBATable=vmwHBATable, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetName=vmwNetName, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbRx=vmwNetKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vmwNetIfAddr=vmwNetIfAddr, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwCpuVMID=vmwCpuVMID, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmwCpuEntry=vmwCpuEntry, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable)
