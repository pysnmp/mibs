...
Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ModuleIdentity, Unsigned32, IpAddress, Counter64, MibIdentifier, Counter32, TimeTicks, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter64", "MibIdentifier", "Counter32", "TimeTicks", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwKbRead=vmwKbRead, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vmwNetIfAddr=vmwNetIfAddr, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwNumWrites=vmwNumWrites, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwHbaName=vmwHbaName, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vpxdOldStatus=vpxdOldStatus, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwHbaIdx=vmwHbaIdx, vmwMemEntry=vmwMemEntry, vpxdNewStatus=vpxdNewStatus)
