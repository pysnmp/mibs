...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:21:57 2024
...
MibIdentifier, Bits, Unsigned32, ObjectIdentity, ModuleIdentity, NotificationType, Counter32, Gauge32, TimeTicks, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter32", "Gauge32", "TimeTicks", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwNumWrites=vmwNumWrites, vmwNetHCKbRx=vmwNetHCKbRx, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, vmwCpuUtil=vmwCpuUtil, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwKbRead=vmwKbRead, vmkLoaded=vmkLoaded, vmwNetIfAddr=vmwNetIfAddr, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwNumReads=vmwNumReads, vmwHbaName=vmwHbaName, vmwNetEntry=vmwNetEntry, vmwDiskShares=vmwDiskShares, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemTable=vmwMemTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsRx=vmwNetPktsRx, vpxdTrap=vpxdTrap, vmwHbaIdx=vmwHbaIdx, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID)
