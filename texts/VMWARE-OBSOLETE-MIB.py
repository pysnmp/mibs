...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:30:00 2023
...
Integer32, ModuleIdentity, Bits, Counter64, iso, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, IpAddress, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "Counter64", "iso", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBLost=vmHBLost, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vpxdTrapType=vpxdTrapType, vmwHbaName=vmwHbaName, vmSuspended=vmSuspended, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumReads=vmwNumReads, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwNetTable=vmwNetTable, vmwCpuShares=vmwCpuShares, vpxdNewStatus=vpxdNewStatus, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwNetIdx=vmwNetIdx)
