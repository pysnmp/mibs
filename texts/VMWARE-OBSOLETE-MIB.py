...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, Counter64, Unsigned32, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "Unsigned32", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdHostName=vpxdHostName, vmwHBATable=vmwHBATable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vmwKbRead=vmwKbRead, vmkLoaded=vmkLoaded, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID, vmwNumWrites=vmwNumWrites, vmwMemTable=vmwMemTable, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmwNumReads=vmwNumReads, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vpxdObjValue=vpxdObjValue, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable)
