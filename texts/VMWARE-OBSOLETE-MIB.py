...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:03:07 2022
...
ModuleIdentity, Counter32, NotificationType, Integer32, IpAddress, Bits, MibIdentifier, ObjectIdentity, Gauge32, Counter64, TimeTicks, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "NotificationType", "Integer32", "IpAddress", "Bits", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter64", "TimeTicks", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vpxdTrapType=vpxdTrapType, vmwNetPktsTx=vmwNetPktsTx, vmwNetIdx=vmwNetIdx, vmwCpuShares=vmwCpuShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuEntry=vmwCpuEntry, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vpxdNewStatus=vpxdNewStatus, vmwNetPktsRx=vmwNetPktsRx, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemUtil=vmwMemUtil, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwHBAEntry=vmwHBAEntry, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmkLoaded=vmkLoaded, vmwMemTable=vmwMemTable, vmwNumWrites=vmwNumWrites, vmwCpuTable=vmwCpuTable, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable)
