...
TimeTicks, Gauge32, ModuleIdentity, Counter32, Unsigned32, MibIdentifier, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Bits, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "ModuleIdentity", "Counter32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Bits", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vmwCpuTable=vmwCpuTable, vmwNetPktsRx=vmwNetPktsRx, vmwMemVMID=vmwMemVMID, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwMemShares=vmwMemShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vmwNumReads=vmwNumReads, vmwNetTable=vmwNetTable, vpxdVMName=vpxdVMName, vmwCpuUtil=vmwCpuUtil, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbRx=vmwNetHCKbRx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwObsoleteGroup=vmwObsoleteGroup, vpxdTrapType=vpxdTrapType, vmwNetShares=vmwNetShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwDiskShares=vmwDiskShares, vmwCpuEntry=vmwCpuEntry, vmPoweredOff=vmPoweredOff, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmwCpuShares=vmwCpuShares, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName)
