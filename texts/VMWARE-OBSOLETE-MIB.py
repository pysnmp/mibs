...
ObjectIdentity, Unsigned32, Gauge32, iso, IpAddress, Counter64, MibIdentifier, NotificationType, TimeTicks, ModuleIdentity, Bits, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "iso", "IpAddress", "Counter64", "MibIdentifier", "NotificationType", "TimeTicks", "ModuleIdentity", "Bits", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuEntry=vmwCpuEntry, vpxdTrapType=vpxdTrapType, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwNetPktsTx=vmwNetPktsTx, vmwDiskShares=vmwDiskShares, vmwCpuShares=vmwCpuShares, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuTable=vmwCpuTable, vmwHbaIdx=vmwHbaIdx, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmwNumWrites=vmwNumWrites, vmwNetHCKbRx=vmwNetHCKbRx, vpxdHostName=vpxdHostName, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwNetIfAddr=vmwNetIfAddr, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwObsoleteMIB=vmwObsoleteMIB)
