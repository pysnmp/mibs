...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:41:24 2024
...
TimeTicks, Counter64, Integer32, Bits, MibIdentifier, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Integer32", "Bits", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBLost=vmHBLost, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmwHBAEntry=vmwHBAEntry, vpxdOldStatus=vpxdOldStatus, vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmwNetKbRx=vmwNetKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOff=vmPoweredOff, vpxdVMName=vpxdVMName, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsRx=vmwNetPktsRx, vmwHBATable=vmwHBATable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vpxdNewStatus=vpxdNewStatus, vmkLoaded=vmkLoaded, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites)
