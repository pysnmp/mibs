...
Counter64, Gauge32, Bits, MibIdentifier, Counter32, IpAddress, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, iso, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Bits", "MibIdentifier", "Counter32", "IpAddress", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "iso", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrapType=vpxdTrapType, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwMemConfigured=vmwMemConfigured, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwMemTable=vmwMemTable, vpxdTrap=vpxdTrap, vmwNetName=vmwNetName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetKbTx=vmwNetKbTx, vmwNetIdx=vmwNetIdx, vmwMemVMID=vmwMemVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwHbaVMID=vmwHbaVMID, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwCpuVMID=vmwCpuVMID)
