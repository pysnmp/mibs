...
NotificationType, Integer32, Counter32, Gauge32, IpAddress, MibIdentifier, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ModuleIdentity, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Counter32", "Gauge32", "IpAddress", "MibIdentifier", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOff=vmPoweredOff, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vmSuspended=vmSuspended, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwHbaName=vmwHbaName, vmwNetName=vmwNetName, vmwMemVMID=vmwMemVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmwCpuShares=vmwCpuShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwNumReads=vmwNumReads, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetTable=vmwNetTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwKbRead=vmwKbRead, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwNetKbRx=vmwNetKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB)
