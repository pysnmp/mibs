...
# Produced by pysmi-1.1.12 at Wed May 29 07:23:31 2024
...
TimeTicks, NotificationType, Counter64, Bits, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, Counter32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Counter64", "Bits", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmwHbaVMID=vmwHbaVMID, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vmwHBATable=vmwHBATable, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemShares=vmwMemShares, vmwKbRead=vmwKbRead, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff)
