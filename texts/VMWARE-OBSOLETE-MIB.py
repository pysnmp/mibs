...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:35:56 2024
...
Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, TimeTicks, Gauge32, Bits, Unsigned32, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwMemVMID=vmwMemVMID, vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vpxdNewStatus=vpxdNewStatus, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwCpuShares=vmwCpuShares, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwHbaIdx=vmwHbaIdx, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vmwHbaName=vmwHbaName, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwKbWritten=vmwKbWritten, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmkLoaded=vmkLoaded, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID)
