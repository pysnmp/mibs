...
# Produced by pysmi-1.1.12 at Thu Nov 28 03:03:47 2024
...
Counter32, TimeTicks, ModuleIdentity, ObjectIdentity, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Bits, IpAddress, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Bits", "IpAddress", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vmwNetShares=vmwNetShares, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmwNetHCKbRx=vmwNetHCKbRx, vmHBDetected=vmHBDetected, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwHBATable=vmwHBATable, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmHBLost=vmHBLost, vmPoweredOn=vmPoweredOn, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vpxdObjValue=vpxdObjValue, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended, vpxdHostName=vpxdHostName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmkLoaded=vmkLoaded)
