...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:03:41 2022
...
Unsigned32, Bits, ModuleIdentity, IpAddress, Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, Counter64, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "ModuleIdentity", "IpAddress", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbRead=vmwKbRead, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwNetPktsRx=vmwNetPktsRx, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwHBATable=vmwHBATable, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrap=vpxdTrap, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vmwMemConfigured=vmwMemConfigured, vmwNetShares=vmwNetShares, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vmwCpuEntry=vmwCpuEntry)
