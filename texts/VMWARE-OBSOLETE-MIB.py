...
Counter64, Bits, IpAddress, TimeTicks, Counter32, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, Integer32, iso, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Integer32", "iso", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmwCpuUtil=vmwCpuUtil, vmwNetKbRx=vmwNetKbRx, vpxdVMName=vpxdVMName, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vmwMemUtil=vmwMemUtil, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwCpuEntry=vmwCpuEntry, vmwMemShares=vmwMemShares, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vpxdTrapType=vpxdTrapType, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vpxdHostName=vpxdHostName, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwNumReads=vmwNumReads, vmwDiskShares=vmwDiskShares, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup)
