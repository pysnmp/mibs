...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:11:34 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vpxdTrapType=vpxdTrapType, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vmwCpuTable=vmwCpuTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vpxdOldStatus=vpxdOldStatus, vmwNumWrites=vmwNumWrites, vmwMemTable=vmwMemTable, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, vmwNetVMID=vmwNetVMID, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmHBLost=vmHBLost, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vmwNetPktsRx=vmwNetPktsRx, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBATable=vmwHBATable)
