...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:24:09 2021
...
Counter32, Integer32, Counter64, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, ModuleIdentity, Gauge32, Bits, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Gauge32", "Bits", "IpAddress", "TimeTicks")
...
vmwResources, vmwTraps, vmwNotifications, vmwObsolete = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwResources", "vmwTraps", "vmwNotifications", "vmwObsolete")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vpxdTrap=vpxdTrap, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwHbaName=vmwHbaName, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwKbRead=vmwKbRead, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetShares=vmwNetShares, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID)
