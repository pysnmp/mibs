...
# Produced by pysmi-1.1.12 at Wed May 29 11:01:48 2024
...
Gauge32, Counter32, ObjectIdentity, Bits, MibIdentifier, TimeTicks, iso, IpAddress, Counter64, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ObjectIdentity", "Bits", "MibIdentifier", "TimeTicks", "iso", "IpAddress", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwNetKbTx=vmwNetKbTx, vpxdTrap=vpxdTrap, vmwNetPktsRx=vmwNetPktsRx, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwHbaName=vmwHbaName, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwNetEntry=vmwNetEntry, vmwCpuUtil=vmwCpuUtil, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmwMemTable=vmwMemTable, vmwMemEntry=vmwMemEntry, vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwMemShares=vmwMemShares, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwKbWritten=vmwKbWritten, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vpxdOldStatus=vpxdOldStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vmwNetHCPktsRx=vmwNetHCPktsRx)
