...
# Produced by pysmi-1.1.10 at Mon Feb 12 02:28:27 2024
...
Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, IpAddress, ObjectIdentity, Unsigned32, Counter32, TimeTicks, MibIdentifier, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Gauge32")
...
vmwTraps, vmwResources, vmwNotifications, vmwObsolete = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwTraps", "vmwResources", "vmwNotifications", "vmwObsolete")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwCpuVMID=vmwCpuVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmwNumReads=vmwNumReads, vpxdTrapType=vpxdTrapType, vmwNetIdx=vmwNetIdx, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vpxdHostName=vpxdHostName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbTx=vmwNetHCKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwHBATable=vmwHBATable, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil, vmwNetKbRx=vmwNetKbRx, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable)
