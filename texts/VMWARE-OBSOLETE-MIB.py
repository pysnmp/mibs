...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwNetEntry=vmwNetEntry, vmwKbRead=vmwKbRead, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwHBATable=vmwHBATable, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwNumReads=vmwNumReads, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuVMID=vmwCpuVMID, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vmwMemUtil=vmwMemUtil, vmwHbaIdx=vmwHbaIdx)
