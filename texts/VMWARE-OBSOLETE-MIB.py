...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:08:46 2024
...
ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter64, Counter32, Integer32, iso, MibIdentifier, IpAddress, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter64", "Counter32", "Integer32", "iso", "MibIdentifier", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetVMID=vmwNetVMID, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwMemEntry=vmwMemEntry, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwNetName=vmwNetName, vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vpxdTrap=vpxdTrap, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetEntry=vmwNetEntry, vmwMemVMID=vmwMemVMID, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaVMID=vmwHbaVMID, vmPoweredOn=vmPoweredOn, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBATable=vmwHBATable, vmwNetHCKbTx=vmwNetHCKbTx)
