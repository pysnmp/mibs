...
ModuleIdentity, TimeTicks, ObjectIdentity, Bits, Counter32, IpAddress, MibIdentifier, Gauge32, Integer32, Unsigned32, Counter64, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "MibIdentifier", "Gauge32", "Integer32", "Unsigned32", "Counter64", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vpxdObjValue=vpxdObjValue, vmwNetEntry=vmwNetEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vpxdHostName=vpxdHostName, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vmwHbaVMID=vmwHbaVMID, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrap=vpxdTrap, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwMemConfigured=vmwMemConfigured, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vpxdNewStatus=vpxdNewStatus, vmwNetName=vmwNetName, vmwKbRead=vmwKbRead, vmSuspended=vmSuspended, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry)
