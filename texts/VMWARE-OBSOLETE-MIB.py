...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:35:19 2021
...
ModuleIdentity, iso, IpAddress, ObjectIdentity, Counter64, Bits, NotificationType, TimeTicks, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "IpAddress", "ObjectIdentity", "Counter64", "Bits", "NotificationType", "TimeTicks", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmHBLost=vmHBLost, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetKbTx=vmwNetKbTx, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaVMID=vmwHbaVMID, vmwCpuTable=vmwCpuTable, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vmwCpuShares=vmwCpuShares, vmwNumWrites=vmwNumWrites, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vmwDiskShares=vmwDiskShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmkLoaded=vmkLoaded, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vpxdTrapType=vpxdTrapType)
