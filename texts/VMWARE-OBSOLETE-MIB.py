...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:09:01 2023
...
MibIdentifier, ObjectIdentity, Unsigned32, IpAddress, Gauge32, Counter32, Bits, NotificationType, Counter64, iso, Integer32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Unsigned32", "IpAddress", "Gauge32", "Counter32", "Bits", "NotificationType", "Counter64", "iso", "Integer32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmwKbRead=vmwKbRead, vmwMemTable=vmwMemTable, vmwHbaName=vmwHbaName, vmwNetShares=vmwNetShares, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBDetected=vmHBDetected, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwHbaVMID=vmwHbaVMID, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwNetHCPktsTx=vmwNetHCPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuShares=vmwCpuShares, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vpxdHostName=vpxdHostName, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID)
