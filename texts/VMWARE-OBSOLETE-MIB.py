...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:14:11 2024
...
NotificationType, MibIdentifier, Counter32, TimeTicks, ObjectIdentity, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, IpAddress, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "IpAddress", "Bits", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vmwNetTable=vmwNetTable, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwMemUtil=vmwMemUtil, vmwHbaIdx=vmwHbaIdx, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vmSuspended=vmSuspended, vmwNetName=vmwNetName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwNetKbTx=vmwNetKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmwMemShares=vmwMemShares, vmwNetKbRx=vmwNetKbRx, vmwKbWritten=vmwKbWritten)
