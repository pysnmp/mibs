...
MibIdentifier, Bits, ModuleIdentity, Gauge32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, TimeTicks, NotificationType, ObjectIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "ModuleIdentity", "Gauge32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmwCpuTable=vmwCpuTable, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetName=vmwNetName, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vpxdTrap=vpxdTrap, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwCpuEntry=vmwCpuEntry, vmHBDetected=vmHBDetected, vpxdHostName=vpxdHostName, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwNetIdx=vmwNetIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmPoweredOn=vmPoweredOn, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemUtil=vmwMemUtil, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName)
