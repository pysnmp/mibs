...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:22:48 2023
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vmwKbWritten=vmwKbWritten, vmwNumWrites=vmwNumWrites, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuUtil=vmwCpuUtil, vpxdTrapType=vpxdTrapType, vmwMemUtil=vmwMemUtil, vmwMemShares=vmwMemShares, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaVMID=vmwHbaVMID, vmHBDetected=vmHBDetected, vmwKbRead=vmwKbRead, vmwHbaName=vmwHbaName, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuShares=vmwCpuShares, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded)
