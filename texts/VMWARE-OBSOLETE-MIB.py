...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:04:11 2022
...
Integer32, iso, ObjectIdentity, Counter32, TimeTicks, Bits, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ObjectIdentity", "Counter32", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwNetKbTx=vmwNetKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetName=vmwNetName, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vmHBDetected=vmHBDetected, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vpxdHostName=vpxdHostName, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNumWrites=vmwNumWrites, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmHBLost=vmHBLost, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuTable=vmwCpuTable, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID)
