...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vpxdTrap=vpxdTrap, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vpxdObjValue=vpxdObjValue, vmwHbaVMID=vmwHbaVMID, vmwNetName=vmwNetName, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemVMID=vmwMemVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vmHBDetected=vmHBDetected, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmwCpuVMID=vmwCpuVMID, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmPoweredOff=vmPoweredOff, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares)
