...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:56:03 2023
...
TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter64, IpAddress, MibIdentifier, Bits, Unsigned32, NotificationType, Counter32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter64", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "NotificationType", "Counter32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbTx=vmwNetKbTx, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vmwNetIfAddr=vmwNetIfAddr, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, vmPoweredOn=vmPoweredOn, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vmwKbRead=vmwKbRead, vmwNetEntry=vmwNetEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vpxdObjValue=vpxdObjValue, vmwCpuShares=vmwCpuShares, vpxdTrap=vpxdTrap, vmwMemVMID=vmwMemVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwMemTable=vmwMemTable, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwCpuVMID=vmwCpuVMID, vpxdOldStatus=vpxdOldStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx)
