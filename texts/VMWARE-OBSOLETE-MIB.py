...
IpAddress, Counter32, TimeTicks, MibIdentifier, Integer32, Gauge32, Unsigned32, Bits, iso, Counter64, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "TimeTicks", "MibIdentifier", "Integer32", "Gauge32", "Unsigned32", "Bits", "iso", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdHostName=vpxdHostName, vmwNetIdx=vmwNetIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbRead=vmwKbRead, vmwDiskShares=vmwDiskShares, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vpxdObjValue=vpxdObjValue, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmPoweredOn=vmPoweredOn, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vmSuspended=vmSuspended, vmwNetPktsRx=vmwNetPktsRx, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmwCpuTable=vmwCpuTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwNumWrites=vmwNumWrites)
