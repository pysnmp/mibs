...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:38:12 2022
...
iso, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, ModuleIdentity, Gauge32, Integer32, ObjectIdentity, TimeTicks, IpAddress, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "ModuleIdentity", "Gauge32", "Integer32", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBLost=vmHBLost, vpxdOldStatus=vpxdOldStatus, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuTable=vmwCpuTable, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsTx=vmwNetPktsTx, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vmwNetKbTx=vmwNetKbTx, vmwNumWrites=vmwNumWrites, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNetIfAddr=vmwNetIfAddr, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmSuspended=vmSuspended)
