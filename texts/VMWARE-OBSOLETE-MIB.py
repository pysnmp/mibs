...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:51:59 2023
...
Integer32, ObjectIdentity, TimeTicks, MibIdentifier, Counter32, Counter64, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter32", "Counter64", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vmwCpuShares=vmwCpuShares, vmwNetPktsTx=vmwNetPktsTx, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwMemVMID=vmwMemVMID, vmwNetVMID=vmwNetVMID, vmwCpuUtil=vmwCpuUtil, vmwHbaName=vmwHbaName, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vmwKbRead=vmwKbRead, vpxdHostName=vpxdHostName, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured, vmwNumReads=vmwNumReads, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vpxdOldStatus=vpxdOldStatus, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vmwMemShares=vmwMemShares)
