...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:16:21 2022
...
ModuleIdentity, Unsigned32, NotificationType, Gauge32, IpAddress, Counter64, TimeTicks, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "IpAddress", "Counter64", "TimeTicks", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmwHbaName=vmwHbaName, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmSuspended=vmSuspended, vmPoweredOn=vmPoweredOn, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmwHBATable=vmwHBATable, vmwCpuVMID=vmwCpuVMID, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuUtil=vmwCpuUtil, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetShares=vmwNetShares, vpxdOldStatus=vpxdOldStatus, vmwNetIfAddr=vmwNetIfAddr, vmwHBAEntry=vmwHBAEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaIdx=vmwHbaIdx, vpxdTrapType=vpxdTrapType, vmwNumWrites=vmwNumWrites, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetEntry=vmwNetEntry, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID)
