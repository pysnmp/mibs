...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:16:36 2024
...
ObjectIdentity, NotificationType, Integer32, iso, TimeTicks, Counter64, MibIdentifier, Counter32, Unsigned32, Gauge32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Integer32", "iso", "TimeTicks", "Counter64", "MibIdentifier", "Counter32", "Unsigned32", "Gauge32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwMemVMID=vmwMemVMID, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemUtil=vmwMemUtil, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwNetPktsRx=vmwNetPktsRx, vmwMemTable=vmwMemTable, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwCpuShares=vmwCpuShares, vmkLoaded=vmkLoaded, vpxdTrap=vpxdTrap, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx)
