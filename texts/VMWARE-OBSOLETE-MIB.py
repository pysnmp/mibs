...
Unsigned32, Integer32, Gauge32, Bits, TimeTicks, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, MibIdentifier, Counter64, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Gauge32", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "MibIdentifier", "Counter64", "NotificationType", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemUtil=vmwMemUtil, vmwKbWritten=vmwKbWritten, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwHbaVMID=vmwHbaVMID, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuUtil=vmwCpuUtil, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbRx=vmwNetHCKbRx, vmHBDetected=vmHBDetected, vmwNetPktsRx=vmwNetPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue)
