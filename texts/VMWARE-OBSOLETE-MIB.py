...
# Produced by pysmi-1.1.10 at Fri Nov 10 07:47:40 2023
...
TimeTicks, Unsigned32, ModuleIdentity, MibIdentifier, IpAddress, Gauge32, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Gauge32", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdHostName=vpxdHostName, vmwNetKbTx=vmwNetKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuVMID=vmwCpuVMID, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrapType=vpxdTrapType, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwNetPktsRx=vmwNetPktsRx, vmwHbaIdx=vmwHbaIdx, vpxdTrap=vpxdTrap, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNetPktsTx=vmwNetPktsTx, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIB=vmwObsoleteMIB)
