...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:43:24 2022
...
MibIdentifier, ModuleIdentity, iso, Counter32, Counter64, Integer32, Bits, NotificationType, IpAddress, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "iso", "Counter32", "Counter64", "Integer32", "Bits", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBLost=vmHBLost, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwMemEntry=vmwMemEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsRx=vmwNetPktsRx, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwHBATable=vmwHBATable, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmwMemConfigured=vmwMemConfigured, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbWritten=vmwKbWritten)
