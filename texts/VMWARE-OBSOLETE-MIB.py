...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:30:20 2023
...
Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, IpAddress, TimeTicks, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "IpAddress", "TimeTicks", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOff=vmPoweredOff, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vmwDiskShares=vmwDiskShares, vmwObsoleteGroup=vmwObsoleteGroup, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vmwMemUtil=vmwMemUtil, vmwMemShares=vmwMemShares)
