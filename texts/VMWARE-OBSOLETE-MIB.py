...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:11:08 2022
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity, Counter32, TimeTicks, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter32", "TimeTicks", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vpxdNewStatus=vpxdNewStatus, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, vmwObsoleteGroup=vmwObsoleteGroup, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwKbWritten=vmwKbWritten, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBATable=vmwHBATable, vmwCpuEntry=vmwCpuEntry, vmwKbRead=vmwKbRead, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuTable=vmwCpuTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx)
