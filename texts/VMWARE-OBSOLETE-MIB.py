...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:08:11 2023
...
Counter32, Counter64, Unsigned32, ObjectIdentity, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Bits, Integer32, iso, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Bits", "Integer32", "iso", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrap=vpxdTrap, vpxdVMName=vpxdVMName, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwHbaVMID=vmwHbaVMID, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vpxdHostName=vpxdHostName, vmwDiskShares=vmwDiskShares, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrapType=vpxdTrapType, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwCpuUtil=vmwCpuUtil, vmwHBATable=vmwHBATable, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmkLoaded=vmkLoaded, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwCpuTable=vmwCpuTable, vmwCpuShares=vmwCpuShares)
