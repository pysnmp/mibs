...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:00:01 2024
...
Unsigned32, TimeTicks, Counter64, MibIdentifier, NotificationType, Gauge32, IpAddress, ModuleIdentity, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Counter64", "MibIdentifier", "NotificationType", "Gauge32", "IpAddress", "ModuleIdentity", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vmwHbaVMID=vmwHbaVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsTx=vmwNetPktsTx, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmwMemEntry=vmwMemEntry, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vpxdTrapType=vpxdTrapType, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmwNumWrites=vmwNumWrites)
