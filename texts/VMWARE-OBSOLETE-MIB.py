...
iso, TimeTicks, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Integer32, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Integer32", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdObjValue=vpxdObjValue, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwMemUtil=vmwMemUtil, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwNetEntry=vmwNetEntry, vmwHBATable=vmwHBATable, vmwKbWritten=vmwKbWritten, vpxdTrapType=vpxdTrapType, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumReads=vmwNumReads)
