...
# Produced by pysmi-1.1.8 at Thu Feb  3 21:15:25 2022
...
TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, iso, NotificationType, Unsigned32, IpAddress, Counter32, Gauge32, Integer32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "iso", "NotificationType", "Unsigned32", "IpAddress", "Counter32", "Gauge32", "Integer32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vmwHbaVMID=vmwHbaVMID, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmwCpuUtil=vmwCpuUtil, vpxdOldStatus=vpxdOldStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdObjValue=vpxdObjValue, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmwNumWrites=vmwNumWrites, vmkLoaded=vmkLoaded, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwNetVMID=vmwNetVMID, vmwHBATable=vmwHBATable, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmwNetEntry=vmwNetEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vmwNetTable=vmwNetTable, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwHbaName=vmwHbaName, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry)
