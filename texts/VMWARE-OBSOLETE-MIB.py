...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIdx=vmwNetIdx, vpxdOldStatus=vpxdOldStatus, vmwMemEntry=vmwMemEntry, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwKbRead=vmwKbRead, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmwNetTable=vmwNetTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmHBLost=vmHBLost, vpxdObjValue=vpxdObjValue, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemUtil=vmwMemUtil, vmwMemShares=vmwMemShares, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vpxdNewStatus=vpxdNewStatus)
