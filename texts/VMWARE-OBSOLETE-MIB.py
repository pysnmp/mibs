...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:24:47 2023
...
ObjectIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, TimeTicks, IpAddress, NotificationType, MibIdentifier, Unsigned32, Counter32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "TimeTicks", "IpAddress", "NotificationType", "MibIdentifier", "Unsigned32", "Counter32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwNetKbRx=vmwNetKbRx, vmwMemVMID=vmwMemVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwKbWritten=vmwKbWritten, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, vpxdNewStatus=vpxdNewStatus, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetEntry=vmwNetEntry, vmwNumWrites=vmwNumWrites, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwHBAEntry=vmwHBAEntry, vmwMemTable=vmwMemTable, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwMemConfigured=vmwMemConfigured, vmHBDetected=vmHBDetected, vpxdTrapType=vpxdTrapType, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuVMID=vmwCpuVMID, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable)
