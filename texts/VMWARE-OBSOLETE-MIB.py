...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:16:19 2022
...
Counter64, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, iso, ModuleIdentity, TimeTicks, Integer32, Bits, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "iso", "ModuleIdentity", "TimeTicks", "Integer32", "Bits", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwNetTable=vmwNetTable, vmwNetEntry=vmwNetEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetShares=vmwNetShares, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwNetVMID=vmwNetVMID, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwCpuTable=vmwCpuTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwNumReads=vmwNumReads)
