...
Gauge32, ObjectIdentity, ModuleIdentity, Integer32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, MibIdentifier, iso, NotificationType, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmwMemShares=vmwMemShares, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwNetIdx=vmwNetIdx, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwMemTable=vmwMemTable, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrapType=vpxdTrapType, vmwNetPktsRx=vmwNetPktsRx, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwCpuTable=vmwCpuTable, vmwHBATable=vmwHBATable, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwDiskShares=vmwDiskShares)
