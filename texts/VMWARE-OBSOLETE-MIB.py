...
Counter64, iso, Counter32, Gauge32, ModuleIdentity, TimeTicks, Unsigned32, Bits, NotificationType, IpAddress, MibIdentifier, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "Gauge32", "ModuleIdentity", "TimeTicks", "Unsigned32", "Bits", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdHostName=vpxdHostName, vmkLoaded=vmkLoaded, vmwNetKbTx=vmwNetKbTx, vmPoweredOff=vmPoweredOff, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwNetIdx=vmwNetIdx, vmHBLost=vmHBLost, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemUtil=vmwMemUtil, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vmwHBAEntry=vmwHBAEntry, vpxdObjValue=vpxdObjValue, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOn=vmPoweredOn, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwNumWrites=vmwNumWrites, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwKbRead=vmwKbRead, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx)
