...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaName=vmwHbaName, vmwCpuTable=vmwCpuTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vmwNetIdx=vmwNetIdx, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemTable=vmwMemTable, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vmwKbRead=vmwKbRead, vmwCpuShares=vmwCpuShares, vpxdTrap=vpxdTrap, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmPoweredOn=vmPoweredOn, vmwHBATable=vmwHBATable, vmwCpuVMID=vmwCpuVMID, vmwNetEntry=vmwNetEntry, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmwMemConfigured=vmwMemConfigured, vpxdHostName=vpxdHostName, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmHBLost=vmHBLost, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID)
