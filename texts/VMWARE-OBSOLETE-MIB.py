...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:49:34 2021
...
iso, ObjectIdentity, Counter64, ModuleIdentity, Gauge32, Bits, Integer32, NotificationType, TimeTicks, IpAddress, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Counter64", "ModuleIdentity", "Gauge32", "Bits", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vpxdOldStatus=vpxdOldStatus, vmwHBATable=vmwHBATable, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vpxdHostName=vpxdHostName, vmSuspended=vmSuspended, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwKbRead=vmwKbRead, vmwNetShares=vmwNetShares, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetIdx=vmwNetIdx, vpxdTrap=vpxdTrap, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemTable=vmwMemTable, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil)
