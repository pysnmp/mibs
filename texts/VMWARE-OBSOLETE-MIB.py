...
# Produced by pysmi-1.1.12 at Tue Jun  4 09:36:24 2024
...
Unsigned32, Integer32, TimeTicks, Counter64, Counter32, ModuleIdentity, MibIdentifier, IpAddress, Gauge32, iso, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "Counter32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Gauge32", "iso", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vpxdVMName=vpxdVMName, vmwNetIdx=vmwNetIdx, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vmwCpuVMID=vmwCpuVMID, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemVMID=vmwMemVMID, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwCpuShares=vmwCpuShares, vmwCpuUtil=vmwCpuUtil, vmHBDetected=vmHBDetected, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwCpuEntry=vmwCpuEntry, vmwKbRead=vmwKbRead, vmwObsoleteGroup=vmwObsoleteGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwMemShares=vmwMemShares, vmwMemUtil=vmwMemUtil, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
