...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:52:45 2022
...
TimeTicks, Unsigned32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, iso, Counter32, ObjectIdentity, Gauge32, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "iso", "Counter32", "ObjectIdentity", "Gauge32", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdVMName=vpxdVMName, vmwCpuShares=vmwCpuShares, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwCpuEntry=vmwCpuEntry, vmwKbWritten=vmwKbWritten, vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdHostName=vpxdHostName, vpxdTrap=vpxdTrap, vmwNetShares=vmwNetShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vmwNetName=vmwNetName)
