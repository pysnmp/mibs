...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:53:52 2022
...
IpAddress, Gauge32, Counter64, ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Unsigned32, Counter32, NotificationType, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetName=vmwNetName, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwNetPktsTx=vmwNetPktsTx, vpxdTrapType=vpxdTrapType, vmwCpuUtil=vmwCpuUtil, vmkLoaded=vmkLoaded, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwMemShares=vmwMemShares, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmwCpuTable=vmwCpuTable, vpxdNewStatus=vpxdNewStatus, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetIfAddr=vmwNetIfAddr)
