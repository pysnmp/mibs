...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:41:32 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, MibIdentifier, Counter64, Counter32, TimeTicks, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "MibIdentifier", "Counter64", "Counter32", "TimeTicks", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwDiskShares=vmwDiskShares, vmwHbaVMID=vmwHbaVMID, vmwHBATable=vmwHBATable, vmSuspended=vmSuspended, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuShares=vmwCpuShares, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwMemVMID=vmwMemVMID, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff, vpxdTrapType=vpxdTrapType, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmHBLost=vmHBLost, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected)
