...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:26:59 2024
...
Counter64, Unsigned32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Bits, Integer32, NotificationType, Gauge32, Counter32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Bits", "Integer32", "NotificationType", "Gauge32", "Counter32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOn=vmPoweredOn, vmwNetVMID=vmwNetVMID, vmHBLost=vmHBLost, vpxdOldStatus=vpxdOldStatus, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetShares=vmwNetShares, vmwCpuEntry=vmwCpuEntry, vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmSuspended=vmSuspended, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmwHBAEntry=vmwHBAEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vpxdHostName=vpxdHostName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemEntry=vmwMemEntry, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwCpuShares=vmwCpuShares, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmwDiskShares=vmwDiskShares)
