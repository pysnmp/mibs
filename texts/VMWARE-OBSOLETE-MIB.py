...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:15:02 2023
...
ObjectIdentity, Unsigned32, Integer32, MibIdentifier, Counter64, Bits, ModuleIdentity, iso, Gauge32, NotificationType, IpAddress, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Integer32", "MibIdentifier", "Counter64", "Bits", "ModuleIdentity", "iso", "Gauge32", "NotificationType", "IpAddress", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vpxdHostName=vpxdHostName, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, vmwNetVMID=vmwNetVMID, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwMemVMID=vmwMemVMID, vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vmwHbaVMID=vmwHbaVMID, vmwMemTable=vmwMemTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwCpuVMID=vmwCpuVMID, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares, vmwNetEntry=vmwNetEntry, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB)
