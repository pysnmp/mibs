...
# Produced by pysmi-1.1.12 at Fri Nov 22 12:01:06 2024
...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, ObjectIdentity, Integer32, iso, ModuleIdentity, Bits, IpAddress, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "ObjectIdentity", "Integer32", "iso", "ModuleIdentity", "Bits", "IpAddress", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaIdx=vmwHbaIdx, vmwMemShares=vmwMemShares, vmwCpuShares=vmwCpuShares, vmwNetName=vmwNetName, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmwHBAEntry=vmwHBAEntry, vmwNetTable=vmwNetTable, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwNetKbTx=vmwNetKbTx, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmPoweredOff=vmPoweredOff, vmwKbRead=vmwKbRead, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumReads=vmwNumReads, vmwCpuTable=vmwCpuTable, vpxdOldStatus=vpxdOldStatus, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwCpuUtil=vmwCpuUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmkLoaded=vmkLoaded, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID)
