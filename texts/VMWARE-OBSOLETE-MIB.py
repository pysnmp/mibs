...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwNetIdx=vmwNetIdx, vmwHBATable=vmwHBATable, vmwNumWrites=vmwNumWrites, vmwMemTable=vmwMemTable, vmPoweredOff=vmPoweredOff, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vpxdOldStatus=vpxdOldStatus, vmwNetKbRx=vmwNetKbRx, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetKbTx=vmwNetKbTx, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwMemVMID=vmwMemVMID, vmwNetShares=vmwNetShares, vmwMemUtil=vmwMemUtil, vmwMemConfigured=vmwMemConfigured, vmwNetHCPktsTx=vmwNetHCPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vpxdTrapType=vpxdTrapType, vmwKbRead=vmwKbRead, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vmwNetPktsRx=vmwNetPktsRx, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx)
