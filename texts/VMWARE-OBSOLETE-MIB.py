...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:07:55 2022
...
Integer32, NotificationType, Bits, MibIdentifier, Counter32, Unsigned32, IpAddress, iso, Gauge32, TimeTicks, ModuleIdentity, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Bits", "MibIdentifier", "Counter32", "Unsigned32", "IpAddress", "iso", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmwMemTable=vmwMemTable, vpxdVMName=vpxdVMName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwCpuEntry=vmwCpuEntry, vmwMemShares=vmwMemShares, vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsRx=vmwNetPktsRx, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmSuspended=vmSuspended, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemUtil=vmwMemUtil, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbWritten=vmwKbWritten, vmkLoaded=vmkLoaded, vmwNumReads=vmwNumReads, vmwDiskShares=vmwDiskShares, vmwMemVMID=vmwMemVMID, vmwNetShares=vmwNetShares, vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuVMID=vmwCpuVMID, vmwNetEntry=vmwNetEntry, vmwCpuShares=vmwCpuShares, vpxdNewStatus=vpxdNewStatus)
