...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:12:25 2024
...
Bits, IpAddress, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, TimeTicks, MibIdentifier, Counter64, ModuleIdentity, Unsigned32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "ModuleIdentity", "Unsigned32", "iso", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vmwNetIdx=vmwNetIdx, vmwMemTable=vmwMemTable, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmwMemVMID=vmwMemVMID, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwCpuTable=vmwCpuTable, vmwMemUtil=vmwMemUtil, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdHostName=vpxdHostName, vmwMemConfigured=vmwMemConfigured, vmwDiskShares=vmwDiskShares, vmwMemShares=vmwMemShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmHBDetected=vmHBDetected, vmwHbaVMID=vmwHbaVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetEntry=vmwNetEntry, vmwNetPktsTx=vmwNetPktsTx, vmwCpuVMID=vmwCpuVMID, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwHBATable=vmwHBATable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff)
