...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:45:05 2024
...
ObjectIdentity, TimeTicks, iso, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Gauge32, IpAddress, NotificationType, Counter64, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "iso", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Gauge32", "IpAddress", "NotificationType", "Counter64", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwMemTable=vmwMemTable, vmwNetPktsRx=vmwNetPktsRx, vmkLoaded=vmkLoaded, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vpxdTrapType=vpxdTrapType, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, vmwHBATable=vmwHBATable, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwKbRead=vmwKbRead, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vmwNumReads=vmwNumReads, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdObjValue=vpxdObjValue, vmwCpuUtil=vmwCpuUtil, vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName)
