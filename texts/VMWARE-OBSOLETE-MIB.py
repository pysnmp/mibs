...
# Produced by pysmi-1.1.8 at Wed Sep 13 08:09:29 2023
...
Unsigned32, Integer32, Counter32, iso, IpAddress, ModuleIdentity, Bits, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Counter32", "iso", "IpAddress", "ModuleIdentity", "Bits", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vpxdHostName=vpxdHostName, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vpxdNewStatus=vpxdNewStatus, vpxdTrapType=vpxdTrapType)
