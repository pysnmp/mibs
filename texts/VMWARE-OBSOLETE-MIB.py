...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:55:26 2023
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vpxdObjValue=vpxdObjValue, vmwCpuUtil=vmwCpuUtil, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwNetKbRx=vmwNetKbRx, vmwNetTable=vmwNetTable, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwCpuShares=vmwCpuShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwNetName=vmwNetName, vmwMemUtil=vmwMemUtil, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwDiskShares=vmwDiskShares, vmwKbWritten=vmwKbWritten, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vmwHBATable=vmwHBATable, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwMemEntry=vmwMemEntry, vmwNetShares=vmwNetShares, vmwCpuEntry=vmwCpuEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx)
