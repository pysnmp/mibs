...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:36:55 2023
...
Counter32, NotificationType, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Unsigned32, IpAddress, Gauge32, ModuleIdentity, TimeTicks, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Unsigned32", "IpAddress", "Gauge32", "ModuleIdentity", "TimeTicks", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmPoweredOff=vmPoweredOff, vmwHbaIdx=vmwHbaIdx, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwNetPktsRx=vmwNetPktsRx, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwObsMIBGroups=vmwObsMIBGroups, vmSuspended=vmSuspended, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmwCpuTable=vmwCpuTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBAEntry=vmwHBAEntry, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, vmwNumWrites=vmwNumWrites, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmkLoaded=vmkLoaded, vmwHBATable=vmwHBATable, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx)
