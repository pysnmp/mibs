...
# Produced by pysmi-1.1.12 at Tue Jun 25 14:17:48 2024
...
Counter32, TimeTicks, IpAddress, Bits, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Gauge32, MibIdentifier, ObjectIdentity, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "IpAddress", "Bits", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Gauge32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vpxdTrap=vpxdTrap, vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vmwMemTable=vmwMemTable, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vpxdHostName=vpxdHostName, vmwKbRead=vmwKbRead, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuVMID=vmwCpuVMID, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwNetIdx=vmwNetIdx, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwDiskShares=vmwDiskShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vpxdObjValue=vpxdObjValue, vmwHbaName=vmwHbaName, vmwNetVMID=vmwNetVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmwKbWritten=vmwKbWritten)
