...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:04:46 2024
...
ModuleIdentity, Counter64, iso, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, MibIdentifier, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "iso", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "MibIdentifier", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdObjValue=vpxdObjValue, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemEntry=vmwMemEntry, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsRx=vmwNetPktsRx, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBLost=vmHBLost, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vmwCpuShares=vmwCpuShares, vmwNetShares=vmwNetShares, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdNewStatus=vpxdNewStatus, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwNumReads=vmwNumReads, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vpxdTrapType=vpxdTrapType, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIB=vmwObsoleteMIB)
