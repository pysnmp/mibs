...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:42:36 2023
...
ObjectIdentity, Unsigned32, ModuleIdentity, NotificationType, Gauge32, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "NotificationType", "Gauge32", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "Integer32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemConfigured=vmwMemConfigured, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetTable=vmwNetTable, vpxdNewStatus=vpxdNewStatus, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmHBDetected=vmHBDetected, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNetName=vmwNetName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwKbWritten=vmwKbWritten, vmkLoaded=vmkLoaded, vmwMemUtil=vmwMemUtil, vmwCpuVMID=vmwCpuVMID, vmwCpuEntry=vmwCpuEntry, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances)
