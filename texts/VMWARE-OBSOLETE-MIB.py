...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:13:52 2022
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares, vmwNumReads=vmwNumReads, vmwCpuShares=vmwCpuShares, vmwNetKbRx=vmwNetKbRx, vmHBDetected=vmHBDetected, vmwMemTable=vmwMemTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwDiskShares=vmwDiskShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmPoweredOn=vmPoweredOn, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vpxdHostName=vpxdHostName, vmwNetIdx=vmwNetIdx, vmkLoaded=vmkLoaded, vmHBLost=vmHBLost, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry)
