...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:28:51 2024
...
MibIdentifier, iso, TimeTicks, IpAddress, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Counter32, Bits, Counter64, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "TimeTicks", "IpAddress", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Counter32", "Bits", "Counter64", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwNumWrites=vmwNumWrites, vmwHbaIdx=vmwHbaIdx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwMemConfigured=vmwMemConfigured, vmwCpuEntry=vmwCpuEntry, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwKbWritten=vmwKbWritten, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuVMID=vmwCpuVMID, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vmHBLost=vmHBLost, vmwMemEntry=vmwMemEntry, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vmwNetKbTx=vmwNetKbTx, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwHBAEntry=vmwHBAEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx)
