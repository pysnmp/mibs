...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:56:06 2022
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwCpuShares=vmwCpuShares, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vmwNetVMID=vmwNetVMID, vmwMemVMID=vmwMemVMID, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vpxdObjValue=vpxdObjValue, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmHBLost=vmHBLost, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwHbaVMID=vmwHbaVMID, vmwNetName=vmwNetName, vmwNetTable=vmwNetTable, vmwHbaName=vmwHbaName, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetShares=vmwNetShares, vmwKbWritten=vmwKbWritten)
