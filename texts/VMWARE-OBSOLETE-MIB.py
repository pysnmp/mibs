...
# Produced by pysmi-1.1.12 at Fri Apr 12 00:34:09 2024
...
iso, Gauge32, MibIdentifier, Bits, NotificationType, ObjectIdentity, Unsigned32, Counter64, IpAddress, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter64", "IpAddress", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetName=vmwNetName, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwKbRead=vmwKbRead, vmwNetVMID=vmwNetVMID, vmwCpuShares=vmwCpuShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbTx=vmwNetHCKbTx, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vpxdTrapType=vpxdTrapType, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetEntry=vmwNetEntry, vmwCpuEntry=vmwCpuEntry, vmPoweredOff=vmPoweredOff, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwMemShares=vmwMemShares, vpxdOldStatus=vpxdOldStatus, vmwNetShares=vmwNetShares)
