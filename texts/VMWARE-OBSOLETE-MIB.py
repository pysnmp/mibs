...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:09:29 2022
...
ObjectIdentity, MibIdentifier, NotificationType, Unsigned32, iso, Gauge32, Counter64, ModuleIdentity, Bits, Integer32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "iso", "Gauge32", "Counter64", "ModuleIdentity", "Bits", "Integer32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwMemShares=vmwMemShares, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdNewStatus=vpxdNewStatus, vmwKbWritten=vmwKbWritten, vmwNetShares=vmwNetShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumReads=vmwNumReads, vpxdHostName=vpxdHostName, vpxdTrapType=vpxdTrapType, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwHbaVMID=vmwHbaVMID)
