...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:14:18 2023
...
Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, Integer32, Bits, IpAddress, MibIdentifier, iso, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Integer32", "Bits", "IpAddress", "MibIdentifier", "iso", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmwMemShares=vmwMemShares, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwNetIdx=vmwNetIdx, vmwHbaIdx=vmwHbaIdx, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbWritten=vmwKbWritten, vmwCpuTable=vmwCpuTable, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmwKbRead=vmwKbRead, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vpxdVMName=vpxdVMName, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumReads=vmwNumReads, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vmwObsoleteGroup=vmwObsoleteGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwNetKbTx=vmwNetKbTx, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx)
