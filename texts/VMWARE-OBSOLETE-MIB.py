...
iso, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, NotificationType, Integer32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "Integer32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmkLoaded=vmkLoaded, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vpxdHostName=vpxdHostName, vmwNetIfAddr=vmwNetIfAddr, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten)
