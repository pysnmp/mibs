...
TimeTicks, Bits, NotificationType, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, Gauge32, iso, Counter64, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "Gauge32", "iso", "Counter64", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaName=vmwHbaName, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vpxdHostName=vpxdHostName, vmwKbWritten=vmwKbWritten, vmwNetKbRx=vmwNetKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIdx=vmwNetIdx, vmHBLost=vmHBLost, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwMemUtil=vmwMemUtil, vmwMemShares=vmwMemShares, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbTx=vmwNetKbTx, vmwMemTable=vmwMemTable, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrapType=vpxdTrapType, vmwNumWrites=vmwNumWrites, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwMemVMID=vmwMemVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwNetShares=vmwNetShares, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIB=vmwObsoleteMIB)
