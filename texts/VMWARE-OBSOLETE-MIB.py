...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Integer32, NotificationType, Unsigned32, iso, TimeTicks, MibIdentifier, ModuleIdentity, Gauge32, Counter64, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Integer32", "NotificationType", "Unsigned32", "iso", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter64", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwNumWrites=vmwNumWrites, vmwKbRead=vmwKbRead, vmwNetPktsTx=vmwNetPktsTx, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdVMName=vpxdVMName, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwNumReads=vmwNumReads, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwNetVMID=vmwNetVMID, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx)
