...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vpxdNewStatus=vpxdNewStatus, vmwNetPktsRx=vmwNetPktsRx, vmwMemUtil=vmwMemUtil, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmwNetIfAddr=vmwNetIfAddr, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuVMID=vmwCpuVMID, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemTable=vmwMemTable, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vpxdHostName=vpxdHostName)
