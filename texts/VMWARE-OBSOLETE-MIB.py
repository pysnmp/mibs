...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:28:00 2022
...
Counter64, ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter32, Integer32, Unsigned32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter32", "Integer32", "Unsigned32", "iso", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetEntry=vmwNetEntry, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwKbWritten=vmwKbWritten, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemEntry=vmwMemEntry, vmwNetName=vmwNetName, vmwNumReads=vmwNumReads, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbTx=vmwNetHCKbTx)
