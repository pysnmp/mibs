...
# Produced by pysmi-1.1.12 at Wed Sep 18 06:51:34 2024
...
IpAddress, Integer32, iso, TimeTicks, Unsigned32, MibIdentifier, Counter64, Bits, ModuleIdentity, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "Counter64", "Bits", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwKbRead=vmwKbRead, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmkLoaded=vmkLoaded, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vmwHbaName=vmwHbaName, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetTable=vmwNetTable, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemShares=vmwMemShares, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vpxdVMName=vpxdVMName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwMemEntry=vmwMemEntry, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap)
