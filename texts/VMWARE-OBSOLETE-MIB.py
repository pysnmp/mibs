...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:33:01 2023
...
NotificationType, Counter32, Unsigned32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, IpAddress, Integer32, Gauge32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Unsigned32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "IpAddress", "Integer32", "Gauge32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vpxdOldStatus=vpxdOldStatus, vmwKbRead=vmwKbRead, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBAEntry=vmwHBAEntry, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vmwCpuEntry=vmwCpuEntry, vpxdObjValue=vpxdObjValue, vmwHbaName=vmwHbaName, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vpxdTrap=vpxdTrap, vmwNetTable=vmwNetTable, vmkLoaded=vmkLoaded, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmHBLost=vmHBLost, vmwHbaVMID=vmwHbaVMID, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsTx=vmwNetHCPktsTx)
