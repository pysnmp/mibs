...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:59:37 2024
...
IpAddress, iso, Counter32, Counter64, MibIdentifier, NotificationType, Bits, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Counter32", "Counter64", "MibIdentifier", "NotificationType", "Bits", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "TimeTicks", "Integer32")
...
vmwTraps, vmwResources, vmwObsolete, vmwNotifications = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwTraps", "vmwResources", "vmwObsolete", "vmwNotifications")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuUtil=vmwCpuUtil, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vmwMemEntry=vmwMemEntry, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdNewStatus=vpxdNewStatus, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetIdx=vmwNetIdx, vmwHbaIdx=vmwHbaIdx, vmwCpuShares=vmwCpuShares, vmwCpuVMID=vmwCpuVMID, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vpxdHostName=vpxdHostName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetTable=vmwNetTable, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmwDiskShares=vmwDiskShares, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmwMemVMID=vmwMemVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vpxdVMName=vpxdVMName, vmwNetIfAddr=vmwNetIfAddr, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx)
