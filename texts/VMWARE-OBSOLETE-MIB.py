...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrap=vpxdTrap, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vpxdObjValue=vpxdObjValue, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured)
