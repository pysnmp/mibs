...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:46:56 2023
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmwKbWritten=vmwKbWritten, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmHBDetected=vmHBDetected, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff, vpxdVMName=vpxdVMName, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuUtil=vmwCpuUtil, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vpxdOldStatus=vpxdOldStatus, vmwCpuTable=vmwCpuTable, vmwNetEntry=vmwNetEntry, vmwMemConfigured=vmwMemConfigured, vmwNetShares=vmwNetShares, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwHBATable=vmwHBATable, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vpxdNewStatus=vpxdNewStatus, vmwNetVMID=vmwNetVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmwNetPktsRx=vmwNetPktsRx, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwNumWrites=vmwNumWrites)
