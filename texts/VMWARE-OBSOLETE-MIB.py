...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:26:39 2022
...
NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Unsigned32, IpAddress, ModuleIdentity, Integer32, Bits, MibIdentifier, Counter32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Unsigned32", "IpAddress", "ModuleIdentity", "Integer32", "Bits", "MibIdentifier", "Counter32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetShares=vmwNetShares, vmwNetTable=vmwNetTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwMemTable=vmwMemTable, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, vpxdOldStatus=vpxdOldStatus, vmwMemShares=vmwMemShares, vmSuspended=vmSuspended, vmwNumReads=vmwNumReads, vmwMemVMID=vmwMemVMID, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetName=vmwNetName, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwDiskShares=vmwDiskShares, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vpxdTrapType=vpxdTrapType, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOff=vmPoweredOff, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx)
