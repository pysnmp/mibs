...
# Produced by pysmi-1.1.12 at Tue May 28 12:41:01 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBLost=vmHBLost, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vpxdTrap=vpxdTrap, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vpxdNewStatus=vpxdNewStatus, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmPoweredOn=vmPoweredOn, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBDetected=vmHBDetected, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vmSuspended=vmSuspended, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff)
