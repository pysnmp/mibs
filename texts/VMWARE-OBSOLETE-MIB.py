...
Gauge32, TimeTicks, IpAddress, Integer32, Counter32, Counter64, NotificationType, ModuleIdentity, MibIdentifier, Bits, Unsigned32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "IpAddress", "Integer32", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "MibIdentifier", "Bits", "Unsigned32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmkLoaded=vmkLoaded, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vmwCpuTable=vmwCpuTable, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetShares=vmwNetShares, vmwNumWrites=vmwNumWrites, vmwHBATable=vmwHBATable, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwCpuEntry=vmwCpuEntry, vpxdObjValue=vpxdObjValue, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmHBDetected=vmHBDetected, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup)
