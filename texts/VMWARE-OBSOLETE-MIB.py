...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwMemEntry=vmwMemEntry, vpxdTrap=vpxdTrap, vmPoweredOff=vmPoweredOff, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumReads=vmwNumReads, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbRx=vmwNetKbRx, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vpxdHostName=vpxdHostName, vmwMemShares=vmwMemShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwCpuEntry=vmwCpuEntry, vmwMemConfigured=vmwMemConfigured, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwMemTable=vmwMemTable, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwHBAEntry=vmwHBAEntry, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmwHbaVMID=vmwHbaVMID, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmwCpuTable=vmwCpuTable)
