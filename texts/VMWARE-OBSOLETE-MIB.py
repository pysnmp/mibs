...
# Produced by pysmi-1.1.8 at Mon Jan  2 14:01:25 2023
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwCpuShares=vmwCpuShares, vmwHbaVMID=vmwHbaVMID, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vpxdTrapType=vpxdTrapType, vmwNetIdx=vmwNetIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmwNetIfAddr=vmwNetIfAddr, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwMemEntry=vmwMemEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemShares=vmwMemShares)
