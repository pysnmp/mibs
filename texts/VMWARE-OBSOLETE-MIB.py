...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:22:44 2023
...
ModuleIdentity, Counter64, TimeTicks, Unsigned32, ObjectIdentity, Gauge32, Integer32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "TimeTicks", "Unsigned32", "ObjectIdentity", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteGroup=vmwObsoleteGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vpxdNewStatus=vpxdNewStatus, vmwKbWritten=vmwKbWritten, vmHBDetected=vmHBDetected, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetEntry=vmwNetEntry, vmwCpuShares=vmwCpuShares, vmwMemUtil=vmwMemUtil, vmwHbaIdx=vmwHbaIdx, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmPoweredOn=vmPoweredOn, vmwNetTable=vmwNetTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemEntry=vmwMemEntry, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwCpuVMID=vmwCpuVMID, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetVMID=vmwNetVMID, vmSuspended=vmSuspended)
