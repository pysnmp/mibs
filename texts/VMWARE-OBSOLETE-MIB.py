...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:18:02 2023
...
Counter64, NotificationType, TimeTicks, Unsigned32, iso, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Gauge32, Bits, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "Unsigned32", "iso", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Gauge32", "Bits", "ObjectIdentity", "MibIdentifier")
...
vmwNotifications, vmwResources, vmwObsolete, vmwTraps = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwNotifications", "vmwResources", "vmwObsolete", "vmwTraps")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmwKbRead=vmwKbRead, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwKbWritten=vmwKbWritten, vmwDiskShares=vmwDiskShares, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwNetTable=vmwNetTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBLost=vmHBLost, vmwMemShares=vmwMemShares, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vpxdTrap=vpxdTrap, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwMemUtil=vmwMemUtil)
