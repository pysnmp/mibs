...
iso, TimeTicks, Bits, ModuleIdentity, IpAddress, NotificationType, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Gauge32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Bits", "ModuleIdentity", "IpAddress", "NotificationType", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Gauge32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrapType=vpxdTrapType, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmkLoaded=vmkLoaded, vmPoweredOn=vmPoweredOn, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmHBDetected=vmHBDetected, vpxdOldStatus=vpxdOldStatus, vmwMemEntry=vmwMemEntry, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwHBATable=vmwHBATable, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vpxdVMName=vpxdVMName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vmwNetEntry=vmwNetEntry, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemUtil=vmwMemUtil, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares)
