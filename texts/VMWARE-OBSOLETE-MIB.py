...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:39:15 2023
...
ModuleIdentity, Counter32, IpAddress, Counter64, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, NotificationType, Integer32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "NotificationType", "Integer32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemVMID=vmwMemVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwMemUtil=vmwMemUtil, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaName=vmwHbaName, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmwNetShares=vmwNetShares, vmwMemTable=vmwMemTable, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOn=vmPoweredOn, vmwHBATable=vmwHBATable, vpxdVMName=vpxdVMName, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vpxdObjValue=vpxdObjValue, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmwHBAEntry=vmwHBAEntry, vmwNetEntry=vmwNetEntry, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwCpuUtil=vmwCpuUtil, vmSuspended=vmSuspended, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, vmwNetName=vmwNetName, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwMemShares=vmwMemShares, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsTx=vmwNetHCPktsTx)
