...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:45:16 2023
...
NotificationType, Gauge32, iso, Counter32, ModuleIdentity, MibIdentifier, Counter64, ObjectIdentity, Unsigned32, Bits, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "iso", "Counter32", "ModuleIdentity", "MibIdentifier", "Counter64", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vpxdTrapType=vpxdTrapType, vmwNetPktsRx=vmwNetPktsRx, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmwCpuShares=vmwCpuShares, vmwNetPktsTx=vmwNetPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetName=vmwNetName, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vpxdNewStatus=vpxdNewStatus, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmHBDetected=vmHBDetected, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten)
