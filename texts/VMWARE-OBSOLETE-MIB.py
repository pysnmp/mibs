...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:21:36 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, ModuleIdentity, Unsigned32, MibIdentifier, Integer32, Counter64, Counter32, TimeTicks, IpAddress, Bits, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "Counter32", "TimeTicks", "IpAddress", "Bits", "Gauge32", "NotificationType")
...
vmwObsolete, vmwResources, vmwTraps, vmwNotifications = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwObsolete", "vmwResources", "vmwTraps", "vmwNotifications")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vmwNetName=vmwNetName, vmwMemVMID=vmwMemVMID, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmwCpuTable=vmwCpuTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbRx=vmwNetKbRx, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNumReads=vmwNumReads, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmwObsoleteGroup=vmwObsoleteGroup, vpxdTrap=vpxdTrap, vmwNetPktsTx=vmwNetPktsTx, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable)
