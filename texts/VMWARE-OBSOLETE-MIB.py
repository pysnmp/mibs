...
# Produced by pysmi-1.1.8 at Fri Jan 14 00:11:16 2022
...
iso, IpAddress, NotificationType, Bits, TimeTicks, Unsigned32, MibIdentifier, Counter32, ModuleIdentity, Gauge32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "Counter32", "ModuleIdentity", "Gauge32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdObjValue=vpxdObjValue, vmwNetPktsRx=vmwNetPktsRx, vmkLoaded=vmkLoaded, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmHBDetected=vmHBDetected, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwCpuVMID=vmwCpuVMID, vmwNumWrites=vmwNumWrites, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteGroup=vmwObsoleteGroup, vpxdVMName=vpxdVMName, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmwNetKbTx=vmwNetKbTx, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetName=vmwNetName, vmSuspended=vmSuspended, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumReads=vmwNumReads, vmwNetPktsTx=vmwNetPktsTx, vmwCpuEntry=vmwCpuEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry)
