...
# Produced by pysmi-1.1.10 at Fri Oct 27 08:01:21 2023
...
iso, ModuleIdentity, TimeTicks, Integer32, Counter32, MibIdentifier, NotificationType, Counter64, IpAddress, Unsigned32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "TimeTicks", "Integer32", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "IpAddress", "Unsigned32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumReads=vmwNumReads, vpxdNewStatus=vpxdNewStatus, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwCpuUtil=vmwCpuUtil, vmkLoaded=vmkLoaded, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBDetected=vmHBDetected, vmwMemShares=vmwMemShares, vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vmwNetKbRx=vmwNetKbRx, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwMemUtil=vmwMemUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx)
