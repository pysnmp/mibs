...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwKbRead=vmwKbRead, vpxdVMName=vpxdVMName, vpxdHostName=vpxdHostName, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmwMemUtil=vmwMemUtil, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry, vmwMemTable=vmwMemTable, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwNetIdx=vmwNetIdx, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwHBAEntry=vmwHBAEntry, vmSuspended=vmSuspended, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwNetKbTx=vmwNetKbTx, vmwDiskShares=vmwDiskShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaVMID=vmwHbaVMID)
