...
ModuleIdentity, TimeTicks, iso, IpAddress, Counter64, Bits, Unsigned32, Counter32, ObjectIdentity, MibIdentifier, Gauge32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "iso", "IpAddress", "Counter64", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "MibIdentifier", "Gauge32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwMemEntry=vmwMemEntry, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vpxdOldStatus=vpxdOldStatus, vmwKbRead=vmwKbRead, vpxdObjValue=vpxdObjValue, vmwDiskShares=vmwDiskShares, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vmwCpuShares=vmwCpuShares, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwNetEntry=vmwNetEntry, vpxdVMName=vpxdVMName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwHbaVMID=vmwHbaVMID, vmwMemUtil=vmwMemUtil)
