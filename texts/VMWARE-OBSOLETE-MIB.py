...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:41:35 2024
...
Counter32, MibIdentifier, Gauge32, ObjectIdentity, iso, Integer32, Counter64, NotificationType, TimeTicks, ModuleIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Gauge32", "ObjectIdentity", "iso", "Integer32", "Counter64", "NotificationType", "TimeTicks", "ModuleIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vpxdTrap=vpxdTrap, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrapType=vpxdTrapType, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmwNetTable=vmwNetTable, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbTx=vmwNetHCKbTx, vpxdObjValue=vpxdObjValue, vmwMemConfigured=vmwMemConfigured, vmwHbaVMID=vmwHbaVMID, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmkLoaded=vmkLoaded, vmwNetHCKbRx=vmwNetHCKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwCpuEntry=vmwCpuEntry, vmPoweredOff=vmPoweredOff, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmwKbRead=vmwKbRead, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmwNetEntry=vmwNetEntry, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmSuspended=vmSuspended, vpxdHostName=vpxdHostName, vmwCpuTable=vmwCpuTable, vmwNetPktsRx=vmwNetPktsRx, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vmwNumReads=vmwNumReads, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx)
