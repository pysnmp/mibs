...
TimeTicks, IpAddress, Counter64, Gauge32, ObjectIdentity, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Integer32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwNetKbRx=vmwNetKbRx, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbWritten=vmwKbWritten, vpxdObjValue=vpxdObjValue, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmPoweredOn=vmPoweredOn, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmSuspended=vmSuspended, vmwNetPktsRx=vmwNetPktsRx, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemEntry=vmwMemEntry, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwCpuShares=vmwCpuShares, vpxdVMName=vpxdVMName, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwNumReads=vmwNumReads, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOff=vmPoweredOff, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded)
