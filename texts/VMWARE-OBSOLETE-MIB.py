...
NotificationType, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Counter32, Integer32, Counter64, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "Integer32", "Counter64", "iso", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOff=vmPoweredOff, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vpxdObjValue=vpxdObjValue, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwMemEntry=vmwMemEntry, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwNumWrites=vmwNumWrites, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbRead=vmwKbRead, vmkLoaded=vmkLoaded, vmHBDetected=vmHBDetected, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vmwDiskShares=vmwDiskShares, vmwNetVMID=vmwNetVMID, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance)
