...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:24:37 2023
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, ObjectIdentity, iso, Integer32, Unsigned32, IpAddress, TimeTicks, MibIdentifier, Counter64, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "ObjectIdentity", "iso", "Integer32", "Unsigned32", "IpAddress", "TimeTicks", "MibIdentifier", "Counter64", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vpxdObjValue=vpxdObjValue, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemShares=vmwMemShares, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumWrites=vmwNumWrites, vmwHBAEntry=vmwHBAEntry, vpxdHostName=vpxdHostName, vmPoweredOff=vmPoweredOff, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwNetPktsRx=vmwNetPktsRx)
