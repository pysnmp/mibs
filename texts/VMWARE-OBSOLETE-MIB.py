...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:47:56 2022
...
Unsigned32, Counter32, NotificationType, TimeTicks, iso, Bits, Integer32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "NotificationType", "TimeTicks", "iso", "Bits", "Integer32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, vmwKbRead=vmwKbRead, vpxdHostName=vpxdHostName, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwMemVMID=vmwMemVMID, vmwCpuShares=vmwCpuShares, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vpxdTrap=vpxdTrap, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance)
