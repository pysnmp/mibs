...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:32:53 2023
...
Counter32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Bits, IpAddress, Counter64, Integer32, NotificationType, ModuleIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Bits", "IpAddress", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vmwNumReads=vmwNumReads, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbRead=vmwKbRead, vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwKbWritten=vmwKbWritten, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBATable=vmwHBATable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBAEntry=vmwHBAEntry, vmwCpuEntry=vmwCpuEntry, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwNetEntry=vmwNetEntry, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup)
