...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vpxdHostName=vpxdHostName, vpxdObjValue=vpxdObjValue, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIfAddr=vmwNetIfAddr, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwCpuVMID=vmwCpuVMID, vmSuspended=vmSuspended, vmwNetEntry=vmwNetEntry, vmwHbaVMID=vmwHbaVMID, vmwHbaName=vmwHbaName, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBAEntry=vmwHBAEntry, vmkLoaded=vmkLoaded, vmHBDetected=vmHBDetected, vmwNetShares=vmwNetShares, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vmwKbRead=vmwKbRead, vmwCpuShares=vmwCpuShares, vmwNetPktsTx=vmwNetPktsTx, vmHBLost=vmHBLost, vmwMemUtil=vmwMemUtil, vmPoweredOff=vmPoweredOff, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwCpuTable=vmwCpuTable, vmwMemShares=vmwMemShares, vmwNetKbTx=vmwNetKbTx, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vmwNumReads=vmwNumReads, vpxdTrap=vpxdTrap, vpxdOldStatus=vpxdOldStatus)
