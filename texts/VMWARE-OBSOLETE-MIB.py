...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:26:48 2022
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwNetVMID=vmwNetVMID, vmwNetPktsRx=vmwNetPktsRx, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmwNetKbRx=vmwNetKbRx, vmSuspended=vmSuspended, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwKbRead=vmwKbRead, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuShares=vmwCpuShares, vmwNetName=vmwNetName, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB)
