...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:38:42 2023
...
ModuleIdentity, Gauge32, NotificationType, Bits, iso, TimeTicks, MibIdentifier, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "NotificationType", "Bits", "iso", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrapType=vpxdTrapType, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsRx=vmwNetPktsRx, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbWritten=vmwKbWritten, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmwCpuVMID=vmwCpuVMID, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwHbaIdx=vmwHbaIdx, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vpxdTrap=vpxdTrap, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vmwNetTable=vmwNetTable, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName)
