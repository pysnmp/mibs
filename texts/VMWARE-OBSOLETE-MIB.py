...
# Produced by pysmi-1.1.12 at Wed May 29 10:11:42 2024
...
Gauge32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, MibIdentifier, ModuleIdentity, TimeTicks, iso, Unsigned32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "TimeTicks", "iso", "Unsigned32", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, vmwCpuShares=vmwCpuShares, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwHBAEntry=vmwHBAEntry, vmwCpuEntry=vmwCpuEntry, vmwNetKbRx=vmwNetKbRx, vpxdNewStatus=vpxdNewStatus, vmwHbaIdx=vmwHbaIdx, vpxdTrap=vpxdTrap, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwKbRead=vmwKbRead, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwNumReads=vmwNumReads, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vmwObsoleteGroup=vmwObsoleteGroup, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemVMID=vmwMemVMID, vmPoweredOff=vmPoweredOff, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwNumWrites=vmwNumWrites, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares)
