...
Unsigned32, Counter32, MibIdentifier, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Bits, ModuleIdentity, NotificationType, Gauge32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "MibIdentifier", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Bits", "ModuleIdentity", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmwNumWrites=vmwNumWrites, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vpxdHostName=vpxdHostName, vmSuspended=vmSuspended, vmwNetIfAddr=vmwNetIfAddr, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vmwCpuShares=vmwCpuShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwHbaVMID=vmwHbaVMID, vmwHbaIdx=vmwHbaIdx, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vpxdNewStatus=vpxdNewStatus, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vpxdVMName=vpxdVMName, vmwNetPktsRx=vmwNetPktsRx, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx)
