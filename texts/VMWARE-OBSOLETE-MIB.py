...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:13:33 2022
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdVMName=vpxdVMName, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBDetected=vmHBDetected, vmwMemShares=vmwMemShares, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vpxdNewStatus=vpxdNewStatus, vmwHbaIdx=vmwHbaIdx, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaVMID=vmwHbaVMID, vmwKbRead=vmwKbRead, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetEntry=vmwNetEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuUtil=vmwCpuUtil, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetTable=vmwNetTable, vmwMemEntry=vmwMemEntry, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites)
