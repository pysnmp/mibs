...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:24:38 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwCpuTable=vmwCpuTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemShares=vmwMemShares, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vmwNetEntry=vmwNetEntry, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vmwCpuUtil=vmwCpuUtil, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmPoweredOn=vmPoweredOn, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
