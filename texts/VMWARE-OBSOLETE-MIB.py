...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:18:07 2022
...
ModuleIdentity, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Integer32, IpAddress, ObjectIdentity, Unsigned32, Gauge32, iso, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Integer32", "IpAddress", "ObjectIdentity", "Unsigned32", "Gauge32", "iso", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOn=vmPoweredOn, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vmwMemShares=vmwMemShares, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwNetName=vmwNetName, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry)
