...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:26:48 2024
...
Integer32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Unsigned32, Counter32, ModuleIdentity, Counter64, IpAddress, iso, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Unsigned32", "Counter32", "ModuleIdentity", "Counter64", "IpAddress", "iso", "MibIdentifier", "TimeTicks")
...
vmwResources, vmwNotifications, vmwTraps, vmwObsolete = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwResources", "vmwNotifications", "vmwTraps", "vmwObsolete")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBAEntry=vmwHBAEntry, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwDiskShares=vmwDiskShares, vmwCpuShares=vmwCpuShares, vmwMemEntry=vmwMemEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwNetKbRx=vmwNetKbRx, vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vpxdObjValue=vpxdObjValue, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vmPoweredOn=vmPoweredOn, vmwNetPktsRx=vmwNetPktsRx, vpxdTrap=vpxdTrap, vmwNetShares=vmwNetShares, vmkLoaded=vmkLoaded, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vpxdNewStatus=vpxdNewStatus, vmwNetPktsTx=vmwNetPktsTx, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vmwNetHCKbRx=vmwNetHCKbRx)
