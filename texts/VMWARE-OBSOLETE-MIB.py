...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:04:06 2023
...
iso, ObjectIdentity, MibIdentifier, Counter32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, IpAddress, ModuleIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "MibIdentifier", "Counter32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "ModuleIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, vmwKbRead=vmwKbRead, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrapType=vpxdTrapType, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmwMemShares=vmwMemShares, vpxdVMName=vpxdVMName, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmHBLost=vmHBLost, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuShares=vmwCpuShares, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmHBDetected=vmHBDetected, vmwHbaVMID=vmwHbaVMID, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwNetShares=vmwNetShares, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn)
