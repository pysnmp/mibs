...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:18:27 2022
...
ObjectIdentity, Counter32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, iso, Gauge32, Counter64, Bits, MibIdentifier, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "iso", "Gauge32", "Counter64", "Bits", "MibIdentifier", "Integer32", "ModuleIdentity")
...
vmwNotifications, vmwObsolete, vmwTraps, vmwResources = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwNotifications", "vmwObsolete", "vmwTraps", "vmwResources")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwCpuTable=vmwCpuTable, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vmwDiskShares=vmwDiskShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vpxdTrapType=vpxdTrapType, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwHbaVMID=vmwHbaVMID, vmwNetVMID=vmwNetVMID, vmwNetIdx=vmwNetIdx, vmwMemTable=vmwMemTable, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmSuspended=vmSuspended, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBAEntry=vmwHBAEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmwNumWrites=vmwNumWrites, vmPoweredOn=vmPoweredOn, vpxdVMName=vpxdVMName)
