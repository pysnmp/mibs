...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Unsigned32, iso, ObjectIdentity, Gauge32, Counter32, TimeTicks, ModuleIdentity, Counter64, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Unsigned32", "iso", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "ModuleIdentity", "Counter64", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdVMName=vpxdVMName, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwNetVMID=vmwNetVMID, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwHbaName=vmwHbaName, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwNetPktsRx=vmwNetPktsRx, vmwMemConfigured=vmwMemConfigured, vpxdHostName=vpxdHostName, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwObsoleteMIB=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry)
