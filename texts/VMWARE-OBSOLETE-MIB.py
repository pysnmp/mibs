...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vmHBLost=vmHBLost, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwNetVMID=vmwNetVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOff=vmPoweredOff, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten, vmwNumReads=vmwNumReads, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbRx=vmwNetKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vpxdObjValue=vpxdObjValue, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded, vmwNetIdx=vmwNetIdx, vmwMemConfigured=vmwMemConfigured, PYSNMP_MODULE_ID=vmwObsoleteMIB)
