...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:40:19 2024
...
Bits, IpAddress, Unsigned32, NotificationType, ModuleIdentity, Integer32, MibIdentifier, Counter32, ObjectIdentity, Gauge32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Unsigned32", "NotificationType", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter32", "ObjectIdentity", "Gauge32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmHBDetected=vmHBDetected, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwNumWrites=vmwNumWrites, vmPoweredOn=vmPoweredOn, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vpxdObjValue=vpxdObjValue, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuShares=vmwCpuShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbRead=vmwKbRead, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmwNetName=vmwNetName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vmwKbWritten=vmwKbWritten, vmkLoaded=vmkLoaded, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwHBAEntry=vmwHBAEntry, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable)
