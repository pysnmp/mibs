...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:56:10 2023
...
Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, TimeTicks, Integer32, IpAddress, Counter32, Bits, Unsigned32, Gauge32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "TimeTicks", "Integer32", "IpAddress", "Counter32", "Bits", "Unsigned32", "Gauge32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwCpuEntry=vmwCpuEntry, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwHBATable=vmwHBATable, vmwNumReads=vmwNumReads, vpxdTrapType=vpxdTrapType, vmwHBAEntry=vmwHBAEntry, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwNetPktsRx=vmwNetPktsRx, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmPoweredOn=vmPoweredOn, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOff=vmPoweredOff, vmwDiskShares=vmwDiskShares, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx)
