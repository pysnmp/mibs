...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:08:19 2022
...
MibIdentifier, IpAddress, NotificationType, Bits, iso, Counter32, Integer32, Counter64, TimeTicks, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "NotificationType", "Bits", "iso", "Counter32", "Integer32", "Counter64", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwNetPktsRx=vmwNetPktsRx, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwCpuUtil=vmwCpuUtil, vmwMemTable=vmwMemTable, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmwNetVMID=vmwNetVMID, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaName=vmwHbaName, vmwNetShares=vmwNetShares, vmwKbWritten=vmwKbWritten, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmSuspended=vmSuspended)
