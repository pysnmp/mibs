...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:30:58 2022
...
Counter32, iso, ModuleIdentity, Integer32, ObjectIdentity, Gauge32, TimeTicks, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ModuleIdentity", "Integer32", "ObjectIdentity", "Gauge32", "TimeTicks", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Bits", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOff=vmPoweredOff, vmwNetVMID=vmwNetVMID, vmwMemShares=vmwMemShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmPoweredOn=vmPoweredOn, vmwCpuVMID=vmwCpuVMID, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vpxdOldStatus=vpxdOldStatus, vmwMemTable=vmwMemTable, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwHBAEntry=vmwHBAEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuTable=vmwCpuTable, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbTx=vmwNetKbTx, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance)
