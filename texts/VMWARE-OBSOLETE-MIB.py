...
MibIdentifier, NotificationType, Unsigned32, TimeTicks, Gauge32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Bits, ObjectIdentity, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "Gauge32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Bits", "ObjectIdentity", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmPoweredOff=vmPoweredOff, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vmwHbaName=vmwHbaName, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOn=vmPoweredOn, vmwNetIfAddr=vmwNetIfAddr, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwKbRead=vmwKbRead, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemEntry=vmwMemEntry, vmwNetEntry=vmwNetEntry, vpxdHostName=vpxdHostName, vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumWrites=vmwNumWrites, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIdx=vmwNetIdx, vmwMemConfigured=vmwMemConfigured, vmwDiskShares=vmwDiskShares, vmwCpuEntry=vmwCpuEntry)
