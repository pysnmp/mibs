...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:49:33 2023
...
Counter64, ModuleIdentity, Unsigned32, iso, Counter32, NotificationType, ObjectIdentity, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Unsigned32", "iso", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmwNetEntry=vmwNetEntry, vmwNetShares=vmwNetShares, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNumWrites=vmwNumWrites, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemConfigured=vmwMemConfigured, vmPoweredOff=vmPoweredOff, vmwHbaIdx=vmwHbaIdx, vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vmwNumReads=vmwNumReads, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmkLoaded=vmkLoaded, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetTable=vmwNetTable, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmwNetPktsRx=vmwNetPktsRx)
