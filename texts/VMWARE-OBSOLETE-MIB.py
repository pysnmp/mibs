...
Counter32, Unsigned32, iso, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Bits, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "iso", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Bits", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetPktsTx=vmwNetPktsTx, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwNetIdx=vmwNetIdx, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwNumWrites=vmwNumWrites, vpxdHostName=vpxdHostName, vmwNetShares=vmwNetShares, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwNetName=vmwNetName, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vpxdTrap=vpxdTrap, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwDiskShares=vmwDiskShares, vmkLoaded=vmkLoaded, vmwNumReads=vmwNumReads, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetEntry=vmwNetEntry, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx)
