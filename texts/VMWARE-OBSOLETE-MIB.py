...
# Produced by pysmi-1.1.12 at Mon Oct 28 02:15:36 2024
...
Bits, MibIdentifier, NotificationType, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ModuleIdentity, Counter32, Integer32, iso, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter32", "Integer32", "iso", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmkLoaded=vmkLoaded, vmPoweredOn=vmPoweredOn, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaVMID=vmwHbaVMID, vpxdTrapType=vpxdTrapType, vmwNetEntry=vmwNetEntry, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vpxdObjValue=vpxdObjValue, vpxdHostName=vpxdHostName, vmwCpuTable=vmwCpuTable, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vpxdVMName=vpxdVMName, vmwNetVMID=vmwNetVMID, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmwNetName=vmwNetName, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwHBATable=vmwHBATable, vmwMemTable=vmwMemTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vmwHbaIdx=vmwHbaIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB)
