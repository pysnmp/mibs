...
Gauge32, NotificationType, Counter32, ObjectIdentity, Bits, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter64, Unsigned32, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "Bits", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter64", "Unsigned32", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vmwNetIdx=vmwNetIdx, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmwCpuUtil=vmwCpuUtil, vmwNetEntry=vmwNetEntry, vpxdHostName=vpxdHostName, vmwHBAEntry=vmwHBAEntry, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaVMID=vmwHbaVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances)
