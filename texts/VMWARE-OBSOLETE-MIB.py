...
# Produced by pysmi-1.1.8 at Mon Jan 17 10:11:05 2022
...
Integer32, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, IpAddress, Bits, Gauge32, ModuleIdentity, NotificationType, ObjectIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "IpAddress", "Bits", "Gauge32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vmwMemEntry=vmwMemEntry, vmHBDetected=vmHBDetected, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetKbTx=vmwNetKbTx, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIdx=vmwNetIdx, vpxdVMName=vpxdVMName, vmwMemTable=vmwMemTable, vmwNumReads=vmwNumReads, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaName=vmwHbaName, vmwNetName=vmwNetName, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemShares=vmwMemShares, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable)
