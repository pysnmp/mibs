...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:10:33 2023
...
NotificationType, ObjectIdentity, Bits, MibIdentifier, TimeTicks, Unsigned32, Counter64, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Bits", "MibIdentifier", "TimeTicks", "Unsigned32", "Counter64", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vmwNetHCPktsTx=vmwNetHCPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vpxdObjValue=vpxdObjValue, vmwHbaName=vmwHbaName, vmwCpuEntry=vmwCpuEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwNetEntry=vmwNetEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vpxdTrapType=vpxdTrapType, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vmwNetKbTx=vmwNetKbTx, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwMemVMID=vmwMemVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwCpuTable=vmwCpuTable, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsRx=vmwNetPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID)
