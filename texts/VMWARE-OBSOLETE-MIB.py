...
TimeTicks, Integer32, NotificationType, Bits, Counter32, ObjectIdentity, Gauge32, Unsigned32, Counter64, iso, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "Bits", "Counter32", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter64", "iso", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vpxdHostName=vpxdHostName, vmwHbaIdx=vmwHbaIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vmwNetKbRx=vmwNetKbRx, vmSuspended=vmSuspended, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwCpuEntry=vmwCpuEntry, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry)
