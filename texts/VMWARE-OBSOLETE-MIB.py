...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:16:32 2022
...
Integer32, IpAddress, ObjectIdentity, Counter64, Counter32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, MibIdentifier, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ObjectIdentity", "Counter64", "Counter32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwNumWrites=vmwNumWrites, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemEntry=vmwMemEntry, vmwNetKbRx=vmwNetKbRx, vmwMemConfigured=vmwMemConfigured, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwMemTable=vmwMemTable, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmwCpuVMID=vmwCpuVMID)
