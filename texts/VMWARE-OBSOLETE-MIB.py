...
# Produced by pysmi-1.1.12 at Tue Jun  4 02:45:54 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, NotificationType, iso, ObjectIdentity, Bits, MibIdentifier, TimeTicks, Counter64, Counter32, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "Bits", "MibIdentifier", "TimeTicks", "Counter64", "Counter32", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vmwCpuVMID=vmwCpuVMID, vmwKbRead=vmwKbRead, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vmwNetIdx=vmwNetIdx, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vpxdTrap=vpxdTrap, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwMemTable=vmwMemTable, vmwDiskShares=vmwDiskShares, vmwMemShares=vmwMemShares, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vmwCpuShares=vmwCpuShares, vmwHbaIdx=vmwHbaIdx, vpxdOldStatus=vpxdOldStatus, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwObsoleteMIB=vmwObsoleteMIB)
