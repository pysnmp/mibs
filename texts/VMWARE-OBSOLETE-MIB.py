...
# Produced by pysmi-1.1.12 at Wed May 29 10:28:14 2024
...
Gauge32, TimeTicks, NotificationType, Integer32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, IpAddress, ObjectIdentity, Counter64, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "NotificationType", "Integer32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter64", "MibIdentifier", "iso")
...
vmwResources, vmwTraps, vmwObsolete, vmwNotifications = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwResources", "vmwTraps", "vmwObsolete", "vmwNotifications")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBDetected=vmHBDetected, vmwNetIdx=vmwNetIdx, vmwNetPktsTx=vmwNetPktsTx, vmwMemEntry=vmwMemEntry, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetKbRx=vmwNetKbRx, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumWrites=vmwNumWrites, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwNumReads=vmwNumReads, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vpxdHostName=vpxdHostName, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuUtil=vmwCpuUtil, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuVMID=vmwCpuVMID, vmHBLost=vmHBLost, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName)
