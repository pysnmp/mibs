...
ModuleIdentity, ObjectIdentity, Counter32, MibIdentifier, Counter64, TimeTicks, NotificationType, IpAddress, Unsigned32, Gauge32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibIdentifier", "Counter64", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32", "Gauge32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaVMID=vmwHbaVMID, vmwHbaName=vmwHbaName, vmwKbRead=vmwKbRead, vmwNetEntry=vmwNetEntry, vmHBLost=vmHBLost, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vpxdObjValue=vpxdObjValue, vmwCpuShares=vmwCpuShares, vpxdOldStatus=vpxdOldStatus, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBAEntry=vmwHBAEntry, vmwNetIdx=vmwNetIdx, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwMemShares=vmwMemShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCKbRx=vmwNetHCKbRx)
