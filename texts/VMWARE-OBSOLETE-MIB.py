...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:20:15 2022
...
ObjectIdentity, iso, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, Bits, ModuleIdentity, TimeTicks, Unsigned32, IpAddress, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "Bits", "ModuleIdentity", "TimeTicks", "Unsigned32", "IpAddress", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmwHBATable=vmwHBATable, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuVMID=vmwCpuVMID, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwHbaIdx=vmwHbaIdx, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOff=vmPoweredOff, vmwHBAEntry=vmwHBAEntry, vmHBDetected=vmHBDetected, vmwMemConfigured=vmwMemConfigured, vpxdHostName=vpxdHostName, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwKbWritten=vmwKbWritten, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwNetShares=vmwNetShares, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwDiskShares=vmwDiskShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vpxdTrapType=vpxdTrapType, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup)
