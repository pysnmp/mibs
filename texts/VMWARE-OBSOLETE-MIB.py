...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:07:57 2024
...
Unsigned32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, IpAddress, ModuleIdentity, Gauge32, Counter32, Counter64, MibIdentifier, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "IpAddress", "ModuleIdentity", "Gauge32", "Counter32", "Counter64", "MibIdentifier", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwNumReads=vmwNumReads, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vpxdNewStatus=vpxdNewStatus, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmwMemShares=vmwMemShares, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuTable=vmwCpuTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuEntry=vmwCpuEntry)
