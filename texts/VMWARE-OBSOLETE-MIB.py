...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:32:31 2023
...
Unsigned32, Counter32, Integer32, ObjectIdentity, Gauge32, IpAddress, ModuleIdentity, MibIdentifier, Counter64, TimeTicks, NotificationType, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Integer32", "ObjectIdentity", "Gauge32", "IpAddress", "ModuleIdentity", "MibIdentifier", "Counter64", "TimeTicks", "NotificationType", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmSuspended=vmSuspended, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmHBLost=vmHBLost, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumReads=vmwNumReads, vmwHbaName=vmwHbaName, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwNetPktsRx=vmwNetPktsRx, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmkLoaded=vmkLoaded, vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbTx=vmwNetKbTx, vmwHbaVMID=vmwHbaVMID, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn, vmwMemConfigured=vmwMemConfigured, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vpxdObjValue=vpxdObjValue, vmwNetKbRx=vmwNetKbRx, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwMemUtil=vmwMemUtil)
