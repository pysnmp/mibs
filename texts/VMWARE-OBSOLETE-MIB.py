...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:16:21 2022
...
NotificationType, ModuleIdentity, TimeTicks, Unsigned32, Bits, ObjectIdentity, MibIdentifier, Gauge32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "TimeTicks", "Unsigned32", "Bits", "ObjectIdentity", "MibIdentifier", "Gauge32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Integer32")
...
vmwObsolete, vmwResources, vmwNotifications, vmwTraps = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwObsolete", "vmwResources", "vmwNotifications", "vmwTraps")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vmkLoaded=vmkLoaded, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBDetected=vmHBDetected, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwDiskShares=vmwDiskShares, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vpxdHostName=vpxdHostName, vmwMemTable=vmwMemTable, vmHBLost=vmHBLost, vmwKbWritten=vmwKbWritten, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmwCpuEntry=vmwCpuEntry, vpxdTrap=vpxdTrap, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vmwNetVMID=vmwNetVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwCpuVMID=vmwCpuVMID, vmwCpuUtil=vmwCpuUtil)
