...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, ObjectIdentity, NotificationType, MibIdentifier, Bits, ModuleIdentity, Counter64, Unsigned32, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "ObjectIdentity", "NotificationType", "MibIdentifier", "Bits", "ModuleIdentity", "Counter64", "Unsigned32", "Counter32", "Integer32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdNewStatus=vpxdNewStatus, vmwHbaName=vmwHbaName, vmwMemShares=vmwMemShares, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmkLoaded=vmkLoaded, vpxdObjValue=vpxdObjValue, vpxdTrapType=vpxdTrapType, vmwHBAEntry=vmwHBAEntry, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetEntry=vmwNetEntry, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmwHbaIdx=vmwHbaIdx, vpxdVMName=vpxdVMName, vmwNetIdx=vmwNetIdx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads)
