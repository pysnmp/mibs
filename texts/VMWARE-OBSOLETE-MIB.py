...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:08:03 2023
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmPoweredOff=vmPoweredOff, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vmHBDetected=vmHBDetected, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vmwCpuTable=vmwCpuTable, vmHBLost=vmHBLost, vmkLoaded=vmkLoaded, vmwNetEntry=vmwNetEntry, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwNetName=vmwNetName, vmwNumWrites=vmwNumWrites, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdNewStatus=vpxdNewStatus, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vpxdTrapType=vpxdTrapType, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vpxdOldStatus=vpxdOldStatus)
