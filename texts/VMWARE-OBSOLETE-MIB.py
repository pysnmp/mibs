...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:09:01 2023
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Integer32, ModuleIdentity, Counter64, MibIdentifier, NotificationType, TimeTicks, iso, ObjectIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Integer32", "ModuleIdentity", "Counter64", "MibIdentifier", "NotificationType", "TimeTicks", "iso", "ObjectIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, vpxdOldStatus=vpxdOldStatus, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmSuspended=vmSuspended, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwCpuUtil=vmwCpuUtil, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmHBDetected=vmHBDetected, vmwNetPktsRx=vmwNetPktsRx, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwNumWrites=vmwNumWrites, vmwMemConfigured=vmwMemConfigured, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumReads=vmwNumReads, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwKbWritten=vmwKbWritten, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vpxdHostName=vpxdHostName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmwCpuTable=vmwCpuTable)
