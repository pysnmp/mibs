...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:51:44 2024
...
Gauge32, Counter32, Integer32, IpAddress, iso, ModuleIdentity, TimeTicks, Bits, NotificationType, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Integer32", "IpAddress", "iso", "ModuleIdentity", "TimeTicks", "Bits", "NotificationType", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwMemEntry=vmwMemEntry, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vmwCpuEntry=vmwCpuEntry, vmwNetTable=vmwNetTable, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmkLoaded=vmkLoaded, vmHBLost=vmHBLost, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmSuspended=vmSuspended, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwNetIdx=vmwNetIdx, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumWrites=vmwNumWrites, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil)
