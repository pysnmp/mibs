...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetPktsTx=vmwNetPktsTx, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vpxdOldStatus=vpxdOldStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdHostName=vpxdHostName, vpxdTrap=vpxdTrap, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbTx=vmwNetHCKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwNetName=vmwNetName, vmHBDetected=vmHBDetected, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwMemEntry=vmwMemEntry, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmwCpuShares=vmwCpuShares, vmwDiskShares=vmwDiskShares)
