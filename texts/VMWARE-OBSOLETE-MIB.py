...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, ObjectIdentity, NotificationType, ModuleIdentity, iso, Gauge32, MibIdentifier, TimeTicks, Bits, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "ObjectIdentity", "NotificationType", "ModuleIdentity", "iso", "Gauge32", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vpxdHostName=vpxdHostName, vmwNetIfAddr=vmwNetIfAddr, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwNetName=vmwNetName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwNetVMID=vmwNetVMID, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vpxdNewStatus=vpxdNewStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vmwCpuShares=vmwCpuShares, vmwCpuUtil=vmwCpuUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmwMemConfigured=vmwMemConfigured, vmwMemShares=vmwMemShares, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmHBLost=vmHBLost)
