...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:31:37 2022
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwHBAEntry=vmwHBAEntry, vmwMemShares=vmwMemShares, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vpxdOldStatus=vpxdOldStatus, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbRead=vmwKbRead, vmwDiskShares=vmwDiskShares, vmwKbWritten=vmwKbWritten, vmSuspended=vmSuspended, vmPoweredOff=vmPoweredOff, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuShares=vmwCpuShares, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vpxdTrap=vpxdTrap, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName)
