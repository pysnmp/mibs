...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIdx=vmwNetIdx, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwMemTable=vmwMemTable, vmwHbaVMID=vmwHbaVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwHBATable=vmwHBATable, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuTable=vmwCpuTable, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vmwCpuEntry=vmwCpuEntry, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwKbWritten=vmwKbWritten)
