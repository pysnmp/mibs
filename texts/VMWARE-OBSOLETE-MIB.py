...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:40:15 2022
...
TimeTicks, Bits, Integer32, Unsigned32, ObjectIdentity, MibIdentifier, IpAddress, Gauge32, Counter32, Counter64, NotificationType, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Gauge32", "Counter32", "Counter64", "NotificationType", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vpxdTrap=vpxdTrap, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwCpuVMID=vmwCpuVMID, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuUtil=vmwCpuUtil, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmwMemTable=vmwMemTable, vmwNumReads=vmwNumReads, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOff=vmPoweredOff, vmHBDetected=vmHBDetected, vmwHbaName=vmwHbaName, vmwNetEntry=vmwNetEntry)
