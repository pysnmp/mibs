...
# Produced by pysmi-1.1.12 at Wed May 29 11:01:29 2024
...
ObjectIdentity, Counter64, Counter32, NotificationType, Gauge32, ModuleIdentity, iso, Bits, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "iso", "Bits", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwNetPktsRx=vmwNetPktsRx, vmwHbaName=vmwHbaName, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwMemShares=vmwMemShares, vmwNumReads=vmwNumReads, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vpxdVMName=vpxdVMName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vpxdOldStatus=vpxdOldStatus, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB)
