...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:44:34 2024
...
ModuleIdentity, Counter32, iso, IpAddress, MibIdentifier, Bits, ObjectIdentity, Integer32, Gauge32, Unsigned32, Counter64, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "iso", "IpAddress", "MibIdentifier", "Bits", "ObjectIdentity", "Integer32", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
vmwTraps, vmwNotifications, vmwObsolete, vmwResources = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwTraps", "vmwNotifications", "vmwObsolete", "vmwResources")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vpxdObjValue=vpxdObjValue, vmwNetVMID=vmwNetVMID, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
