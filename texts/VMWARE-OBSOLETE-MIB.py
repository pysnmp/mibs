...
Counter64, ModuleIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, iso, ObjectIdentity, Bits, Unsigned32, NotificationType, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "iso", "ObjectIdentity", "Bits", "Unsigned32", "NotificationType", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwMemUtil=vmwMemUtil, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmwCpuVMID=vmwCpuVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdNewStatus=vpxdNewStatus, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vpxdVMName=vpxdVMName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuShares=vmwCpuShares, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB)
