...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:03:00 2024
...
Gauge32, ModuleIdentity, Counter32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier, NotificationType, IpAddress, Counter64, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "Counter64", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrap=vpxdTrap, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vmSuspended=vmSuspended, vmwMemEntry=vmwMemEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vmwNetName=vmwNetName, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmkLoaded=vmkLoaded, vmwCpuShares=vmwCpuShares, vmwCpuTable=vmwCpuTable, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable, vmwNetIdx=vmwNetIdx, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwNetPktsRx=vmwNetPktsRx, vmwMemTable=vmwMemTable, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmPoweredOff=vmPoweredOff, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB)
