...
# Produced by pysmi-1.1.8 at Fri Oct 13 14:15:11 2023
...
IpAddress, NotificationType, iso, TimeTicks, Integer32, Bits, ModuleIdentity, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "iso", "TimeTicks", "Integer32", "Bits", "ModuleIdentity", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Counter64")
...
vmwTraps, vmwNotifications, vmwResources, vmwObsolete = mibBuilder.importSymbols("VMWARE-ROOT-MIB", "vmwTraps", "vmwNotifications", "vmwResources", "vmwObsolete")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIfAddr=vmwNetIfAddr, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwCpuShares=vmwCpuShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaIdx=vmwHbaIdx, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbRx=vmwNetKbRx, vmwMemUtil=vmwMemUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuUtil=vmwCpuUtil, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmkLoaded=vmkLoaded, vmwNetEntry=vmwNetEntry, vmHBDetected=vmHBDetected, vmwNetIdx=vmwNetIdx, vmwNetShares=vmwNetShares, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwHbaVMID=vmwHbaVMID, vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vpxdTrapType=vpxdTrapType)
