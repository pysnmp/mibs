...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:17:36 2024
...
iso, Counter32, Gauge32, Counter64, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, IpAddress, Integer32, TimeTicks, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Gauge32", "Counter64", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetEntry=vmwNetEntry, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vmwNetShares=vmwNetShares, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vpxdOldStatus=vpxdOldStatus, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmPoweredOn=vmPoweredOn, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwMemTable=vmwMemTable, vmwMemConfigured=vmwMemConfigured, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vpxdTrapType=vpxdTrapType, vmwHbaVMID=vmwHbaVMID)
