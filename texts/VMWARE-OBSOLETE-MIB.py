...
# Produced by pysmi-1.1.8 at Thu Sep 29 09:02:29 2022
...
Counter64, iso, Unsigned32, TimeTicks, MibIdentifier, Counter32, ModuleIdentity, Bits, ObjectIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter32", "ModuleIdentity", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vpxdTrap=vpxdTrap, vpxdHostName=vpxdHostName, vmwMemUtil=vmwMemUtil, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIdx=vmwNetIdx, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable, vmwCpuVMID=vmwCpuVMID, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsRx=vmwNetPktsRx, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID)
