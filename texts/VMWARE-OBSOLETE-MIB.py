...
Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, NotificationType, Bits, Integer32, IpAddress, iso, Gauge32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "Integer32", "IpAddress", "iso", "Gauge32", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwNetName=vmwNetName, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwKbRead=vmwKbRead, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vmwHbaName=vmwHbaName, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuShares=vmwCpuShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmkLoaded=vmkLoaded, vmHBLost=vmHBLost, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx)
