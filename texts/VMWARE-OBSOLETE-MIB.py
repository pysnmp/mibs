...
Counter32, Gauge32, ObjectIdentity, iso, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Integer32, TimeTicks, Bits, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Integer32", "TimeTicks", "Bits", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbRead=vmwKbRead, vmwMemVMID=vmwMemVMID, vpxdHostName=vpxdHostName, vmwMemUtil=vmwMemUtil, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdOldStatus=vpxdOldStatus, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetShares=vmwNetShares, vpxdNewStatus=vpxdNewStatus, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIfAddr=vmwNetIfAddr)
