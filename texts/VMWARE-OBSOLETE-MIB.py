...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:43:22 2023
...
Gauge32, iso, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, TimeTicks, Unsigned32, Counter64, IpAddress, ObjectIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Unsigned32", "Counter64", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vpxdTrapType=vpxdTrapType, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwKbWritten=vmwKbWritten, vmwCpuShares=vmwCpuShares, vmwNetShares=vmwNetShares, vmwNumReads=vmwNumReads, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vmHBDetected=vmHBDetected, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbRx=vmwNetKbRx, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx)
