...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:37:23 2024
...
Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, ObjectIdentity, NotificationType, Counter32, MibIdentifier, IpAddress, Integer32, Unsigned32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType", "Counter32", "MibIdentifier", "IpAddress", "Integer32", "Unsigned32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwNetHCKbTx=vmwNetHCKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vmPoweredOff=vmPoweredOff, vpxdTrapType=vpxdTrapType, vmwNetName=vmwNetName, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmwObsoleteGroup=vmwObsoleteGroup, vpxdObjValue=vpxdObjValue, vmwCpuShares=vmwCpuShares, vpxdOldStatus=vpxdOldStatus, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuTable=vmwCpuTable, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwNetIdx=vmwNetIdx, vmwCpuVMID=vmwCpuVMID, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vpxdHostName=vpxdHostName, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmHBLost=vmHBLost)
