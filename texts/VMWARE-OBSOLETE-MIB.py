...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:55:13 2024
...
Counter32, Counter64, TimeTicks, Integer32, ModuleIdentity, iso, MibIdentifier, NotificationType, Unsigned32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "Integer32", "ModuleIdentity", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIfAddr=vmwNetIfAddr, vmwHbaVMID=vmwHbaVMID, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIdx=vmwNetIdx, vmwHBATable=vmwHBATable, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbTx=vmwNetKbTx, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vpxdVMName=vpxdVMName, vmwMemEntry=vmwMemEntry, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vpxdNewStatus=vpxdNewStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmPoweredOff=vmPoweredOff, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmwCpuUtil=vmwCpuUtil, vmwCpuEntry=vmwCpuEntry)
