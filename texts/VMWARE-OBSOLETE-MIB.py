...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:36:23 2023
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Unsigned32, Counter32, iso, Counter64, NotificationType, ModuleIdentity, MibIdentifier, IpAddress, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "iso", "Counter64", "NotificationType", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuEntry=vmwCpuEntry, vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmkLoaded=vmkLoaded, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff, vmwMemShares=vmwMemShares, vmwObsMIBGroups=vmwObsMIBGroups, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemEntry=vmwMemEntry, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vpxdObjValue=vpxdObjValue, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwCpuVMID=vmwCpuVMID, vmwMemVMID=vmwMemVMID, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIfAddr=vmwNetIfAddr, vpxdHostName=vpxdHostName, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable)
