...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:23:03 2023
...
iso, Integer32, Bits, Counter32, TimeTicks, Counter64, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Bits", "Counter32", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwHbaIdx=vmwHbaIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vpxdHostName=vpxdHostName, vmwNetIdx=vmwNetIdx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemShares=vmwMemShares, vmwCpuEntry=vmwCpuEntry, vpxdTrap=vpxdTrap, vmwHBATable=vmwHBATable, vmwNetPktsTx=vmwNetPktsTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetName=vmwNetName, vmwHbaVMID=vmwHbaVMID, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumReads=vmwNumReads, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwMemVMID=vmwMemVMID, vpxdObjValue=vpxdObjValue, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmPoweredOff=vmPoweredOff)
