...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:51:06 2023
...
NotificationType, Counter32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, IpAddress, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, vmwHbaName=vmwHbaName, vmwMemConfigured=vmwMemConfigured, vmwNetPktsRx=vmwNetPktsRx, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmSuspended=vmSuspended, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwCpuUtil=vmwCpuUtil, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vmwNetIdx=vmwNetIdx, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaIdx=vmwHbaIdx, vmwNetName=vmwNetName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vmHBLost=vmHBLost, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, vmwNetPktsTx=vmwNetPktsTx, vmwCpuEntry=vmwCpuEntry, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBAEntry=vmwHBAEntry, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances)
