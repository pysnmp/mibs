...
# Produced by pysmi-1.1.11 at Wed Dec  6 03:07:24 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, NotificationType, Counter64, TimeTicks, Integer32, Counter32, MibIdentifier, Unsigned32, iso, IpAddress, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "NotificationType", "Counter64", "TimeTicks", "Integer32", "Counter32", "MibIdentifier", "Unsigned32", "iso", "IpAddress", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaName=vmwHbaName, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetVMID=vmwNetVMID, vpxdOldStatus=vpxdOldStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmHBDetected=vmHBDetected, vpxdNewStatus=vpxdNewStatus, vmkLoaded=vmkLoaded, vmwCpuTable=vmwCpuTable, vmwMemUtil=vmwMemUtil, vmwCpuUtil=vmwCpuUtil, vmwNumReads=vmwNumReads, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIdx=vmwNetIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdObjValue=vpxdObjValue, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwMemTable=vmwMemTable)
