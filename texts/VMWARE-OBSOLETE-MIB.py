...
# Produced by pysmi-1.1.12 at Tue Sep 17 10:06:22 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetKbTx=vmwNetKbTx, vmwNetKbRx=vmwNetKbRx, vmwCpuTable=vmwCpuTable, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmkLoaded=vmkLoaded, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmwHBAEntry=vmwHBAEntry, vmwMemTable=vmwMemTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vpxdVMName=vpxdVMName, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteGroup=vmwObsoleteGroup, vpxdObjValue=vpxdObjValue, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vpxdTrap=vpxdTrap, vmwHBATable=vmwHBATable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwCpuEntry=vmwCpuEntry, vmSuspended=vmSuspended, vmwNetShares=vmwNetShares, vmwNetIfAddr=vmwNetIfAddr, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIdx=vmwNetIdx, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx)
