...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:45:48 2023
...
Bits, Counter32, Unsigned32, Gauge32, iso, Integer32, Counter64, MibIdentifier, ModuleIdentity, ObjectIdentity, NotificationType, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Unsigned32", "Gauge32", "iso", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "NotificationType", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetVMID=vmwNetVMID, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwNumReads=vmwNumReads, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vpxdNewStatus=vpxdNewStatus, vmwNumWrites=vmwNumWrites, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwCpuTable=vmwCpuTable, vpxdHostName=vpxdHostName, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemShares=vmwMemShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdVMName=vpxdVMName, vmwCpuUtil=vmwCpuUtil, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsTx=vmwNetHCPktsTx)
