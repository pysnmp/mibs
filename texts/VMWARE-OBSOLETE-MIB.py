...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:58:12 2022
...
NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, IpAddress, ModuleIdentity, Counter32, Gauge32, iso, Integer32, ObjectIdentity, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32", "iso", "Integer32", "ObjectIdentity", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vpxdHostName=vpxdHostName, vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOff=vmPoweredOff, vmwHbaVMID=vmwHbaVMID, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwMemShares=vmwMemShares, vmwCpuUtil=vmwCpuUtil, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName)
