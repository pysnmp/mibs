...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:12:51 2024
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaVMID=vmwHbaVMID, vmwMemShares=vmwMemShares, vmwNetVMID=vmwNetVMID, vmHBDetected=vmHBDetected, vmwHbaName=vmwHbaName, vmkLoaded=vmkLoaded, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwCpuTable=vmwCpuTable, vmwMemVMID=vmwMemVMID, vmwNetName=vmwNetName, vmwMemEntry=vmwMemEntry, vmwHBAEntry=vmwHBAEntry, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwObsMIBGroups=vmwObsMIBGroups, vpxdHostName=vpxdHostName, vpxdNewStatus=vpxdNewStatus, vmwNetKbRx=vmwNetKbRx, vmwObsoleteGroup=vmwObsoleteGroup, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwNumReads=vmwNumReads, vmwCpuEntry=vmwCpuEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmHBLost=vmHBLost, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended)
