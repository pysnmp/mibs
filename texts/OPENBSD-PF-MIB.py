...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfTable=pfIfTable, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfCounters=pfCounters, pfTblAddrCleared=pfTblAddrCleared, pfDebug=pfDebug, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfTblInMatchBytes=pfTblInMatchBytes, pfLimitMaxTables=pfLimitMaxTables, pfCntStateMismatch=pfCntStateMismatch, PYSNMP_MODULE_ID=pfMIBObjects, pfLabelInBytes=pfLabelInBytes, pfIfOut6PassBytes=pfIfOut6PassBytes, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLimitStates=pfLimitStates, pfCntStateInsert=pfCntStateInsert, pfTblRuleRefs=pfTblRuleRefs, pfInterfaces=pfInterfaces, pfCntFragment=pfCntFragment, pfSrcTrackCount=pfSrcTrackCount, pfLabelEntry=pfLabelEntry, pfCntShort=pfCntShort, pfTimeoutFragment=pfTimeoutFragment, pfTblOutXPassPkts=pfTblOutXPassPkts, pfLabelEvals=pfLabelEvals, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfIfEntry=pfIfEntry, pfTblNumber=pfTblNumber, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblOutMatchBytes=pfTblOutMatchBytes, pfsyncIpPktsSent=pfsyncIpPktsSent, pfRunning=pfRunning, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfsyncNoMemory=pfsyncNoMemory, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfStateInserts=pfStateInserts, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTblInBlockBytes=pfTblInBlockBytes, pfTblOutPassBytes=pfTblOutPassBytes, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfIfIn4PassBytes=pfIfIn4PassBytes, pfLabelOutPkts=pfLabelOutPkts, pfInfo=pfInfo, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfIfType=pfIfType, pfsyncStats=pfsyncStats, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfRuntime=pfRuntime, pfTblIndex=pfTblIndex, pfIfRefs=pfIfRefs, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfCntSynproxy=pfCntSynproxy, pfLabelBytes=pfLabelBytes, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTblTable=pfTblTable, pfTblInPassBytes=pfTblInPassBytes, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfCntStateLimit=pfCntStateLimit, pfTblAnchorRefs=pfTblAnchorRefs, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfLimitFragments=pfLimitFragments, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblOutBlockPkts=pfTblOutBlockPkts, pfsyncOutputErrors=pfsyncOutputErrors, pfTables=pfTables, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfStateCount=pfStateCount, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfStateSearches=pfStateSearches, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfSrcTrackSearches=pfSrcTrackSearches, pfCntCongestion=pfCntCongestion, pfTimeouts=pfTimeouts, pfMIBObjects=pfMIBObjects, pfTblOutMatchPkts=pfTblOutMatchPkts, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfLabelOutBytes=pfLabelOutBytes, pfTimeoutInterval=pfTimeoutInterval, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfIfNumber=pfIfNumber, pfTblInXPassPkts=pfTblInXPassPkts, pfTblAddrMask=pfTblAddrMask, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfCntNoRoute=pfCntNoRoute, pfCntProtoCksum=pfCntProtoCksum, pfTblInBlockPkts=pfTblInBlockPkts, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblStatsCleared=pfTblStatsCleared, pfLogIfName=pfLogIfName, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfCntBadOffset=pfCntBadOffset, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfLimitSourceNodes=pfLimitSourceNodes, pfTblAddrEntry=pfTblAddrEntry, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfStateRemovals=pfStateRemovals, pfTblOutXPassBytes=pfTblOutXPassBytes, pfStateTable=pfStateTable, pfTblInPassPkts=pfTblInPassPkts, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTblEvalsMatch=pfTblEvalsMatch, pfLabelName=pfLabelName, pfHostid=pfHostid, pfTblOutPassPkts=pfTblOutPassPkts, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfLabelTable=pfLabelTable, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfCntMatch=pfCntMatch, pfIfDescr=pfIfDescr, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfLabelPkts=pfLabelPkts, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblAddrTable=pfTblAddrTable, pfIfRules=pfIfRules, pfLabelIndex=pfLabelIndex, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblName=pfTblName, pfIfIn6PassPkts=pfIfIn6PassPkts, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLimits=pfLimits, pfIfIn6PassBytes=pfIfIn6PassBytes, pfCntMemory=pfCntMemory, pfCntTranslate=pfCntTranslate, pfTblAddresses=pfTblAddresses, pfTblEntry=pfTblEntry, pfCntNormalize=pfCntNormalize, pfCntIpOption=pfCntIpOption, pfLabelInPkts=pfLabelInPkts, pfLabels=pfLabels, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfCntTimestamp=pfCntTimestamp, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfLabelNumber=pfLabelNumber, pfSrcTrackInserts=pfSrcTrackInserts, pfTblInXPassBytes=pfTblInXPassBytes, pfLabelTotalStates=pfLabelTotalStates, pfCntSrcLimit=pfCntSrcLimit, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblInMatchPkts=pfTblInMatchPkts, pfTblAddrTblIndex=pfTblAddrTblIndex, pfIfIndex=pfIfIndex, pfTblAddrNet=pfTblAddrNet, pfSrcTracking=pfSrcTracking, pfLogInterface=pfLogInterface, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfIfOut4PassPkts=pfIfOut4PassPkts, pfIfIn4PassPkts=pfIfIn4PassPkts)
