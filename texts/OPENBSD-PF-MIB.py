...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLogIfName=pfLogIfName, pfCounters=pfCounters, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfLabelEvals=pfLabelEvals, pfIfNumber=pfIfNumber, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfTblAnchorRefs=pfTblAnchorRefs, pfHostid=pfHostid, pfsyncNoMemory=pfsyncNoMemory, pfLabelInPkts=pfLabelInPkts, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfLabelEntry=pfLabelEntry, pfTblTable=pfTblTable, pfCntNoRoute=pfCntNoRoute, pfTimeoutFragment=pfTimeoutFragment, pfCntProtoCksum=pfCntProtoCksum, pfSrcTrackSearches=pfSrcTrackSearches, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfRunning=pfRunning, pfTblEvalsMatch=pfTblEvalsMatch, pfTblInPassBytes=pfTblInPassBytes, pfLabelIndex=pfLabelIndex, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTblAddresses=pfTblAddresses, pfStateTable=pfStateTable, pfTblStatsCleared=pfTblStatsCleared, pfLimits=pfLimits, pfTblOutMatchPkts=pfTblOutMatchPkts, pfLabelOutPkts=pfLabelOutPkts, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfIfType=pfIfType, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfIfDescr=pfIfDescr, pfsyncStats=pfsyncStats, pfInfo=pfInfo, pfStateRemovals=pfStateRemovals, pfIfEntry=pfIfEntry, pfIfIn6PassPkts=pfIfIn6PassPkts, pfStateInserts=pfStateInserts, pfLimitStates=pfLimitStates, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblOutMatchBytes=pfTblOutMatchBytes, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTimeouts=pfTimeouts, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTblOutXPassPkts=pfTblOutXPassPkts, pfCntMemory=pfCntMemory, pfTblIndex=pfTblIndex, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfIfOut6PassBytes=pfIfOut6PassBytes, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfCntFragment=pfCntFragment, pfCntSrcLimit=pfCntSrcLimit, pfTblAddrTblIndex=pfTblAddrTblIndex, pfIfOut6PassPkts=pfIfOut6PassPkts, pfCntBadOffset=pfCntBadOffset, pfSrcTrackCount=pfSrcTrackCount, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfLabelNumber=pfLabelNumber, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblOutXPassBytes=pfTblOutXPassBytes, pfStateSearches=pfStateSearches, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfDebug=pfDebug, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfCntStateMismatch=pfCntStateMismatch, pfCntNormalize=pfCntNormalize, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTblOutPassPkts=pfTblOutPassPkts, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblAddrNet=pfTblAddrNet, pfLabels=pfLabels, pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblOutBlockPkts=pfTblOutBlockPkts, pfCntCongestion=pfCntCongestion, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfLimitFragments=pfLimitFragments, pfIfIn4PassBytes=pfIfIn4PassBytes, pfLimitMaxTables=pfLimitMaxTables, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLabelName=pfLabelName, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblNumber=pfTblNumber, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfsyncOutputErrors=pfsyncOutputErrors, pfSrcTrackInserts=pfSrcTrackInserts, pfLabelInBytes=pfLabelInBytes, pfCntTranslate=pfCntTranslate, pfCntMatch=pfCntMatch, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfIfTable=pfIfTable, pfRuntime=pfRuntime, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblInXPassBytes=pfTblInXPassBytes, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfCntShort=pfCntShort, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfCntStateInsert=pfCntStateInsert, pfTblInMatchPkts=pfTblInMatchPkts, pfTblInBlockPkts=pfTblInBlockPkts, pfLimitSourceNodes=pfLimitSourceNodes, pfTblAddrEntry=pfTblAddrEntry, pfCntSynproxy=pfCntSynproxy, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutIcmpError=pfTimeoutIcmpError, pfIfRules=pfIfRules, pfIfIndex=pfIfIndex, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTblInXPassPkts=pfTblInXPassPkts, pfTblAddrTable=pfTblAddrTable, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblAddrMask=pfTblAddrMask, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfCntTimestamp=pfCntTimestamp, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfSrcTracking=pfSrcTracking, PYSNMP_MODULE_ID=pfMIBObjects, pfLabelOutBytes=pfLabelOutBytes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfInterfaces=pfInterfaces, pfLogInterface=pfLogInterface, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblInMatchBytes=pfTblInMatchBytes, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTblOutPassBytes=pfTblOutPassBytes, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfLabelBytes=pfLabelBytes, pfLabelTotalStates=pfLabelTotalStates, pfsyncIpPktsSent=pfsyncIpPktsSent, pfMIBObjects=pfMIBObjects, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfCntIpOption=pfCntIpOption, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfIfOut4PassPkts=pfIfOut4PassPkts, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfIfRefs=pfIfRefs, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfLabelPkts=pfLabelPkts, pfCntStateLimit=pfCntStateLimit, pfTblAddrCleared=pfTblAddrCleared, pfTimeoutInterval=pfTimeoutInterval, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfStateCount=pfStateCount, pfLabelTable=pfLabelTable, pfTblRuleRefs=pfTblRuleRefs, pfTables=pfTables, pfTblInBlockBytes=pfTblInBlockBytes, pfTblEntry=pfTblEntry, pfTblName=pfTblName, pfTblInPassPkts=pfTblInPassPkts)
