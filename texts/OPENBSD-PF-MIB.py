...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfSrcTrackInserts=pfSrcTrackInserts, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfCntShort=pfCntShort, pfRuntime=pfRuntime, pfIfType=pfIfType, pfIfDescr=pfIfDescr, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfCntSrcLimit=pfCntSrcLimit, pfIfIn4PassBytes=pfIfIn4PassBytes, pfCntSynproxy=pfCntSynproxy, pfTblAddrTable=pfTblAddrTable, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfCntMatch=pfCntMatch, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTblInXPassBytes=pfTblInXPassBytes, pfStateTable=pfStateTable, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfSrcTracking=pfSrcTracking, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLabelTable=pfLabelTable, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblNumber=pfTblNumber, pfLabelBytes=pfLabelBytes, pfCntMemory=pfCntMemory, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblOutPassPkts=pfTblOutPassPkts, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblAddrEntry=pfTblAddrEntry, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblName=pfTblName, pfTblOutMatchPkts=pfTblOutMatchPkts, pfCounters=pfCounters, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblAddrNet=pfTblAddrNet, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfStateCount=pfStateCount, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTblAddresses=pfTblAddresses, pfIfTable=pfIfTable, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfLabelInBytes=pfLabelInBytes, pfLabelEntry=pfLabelEntry, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTblEntry=pfTblEntry, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfIfRefs=pfIfRefs, pfLabelEvals=pfLabelEvals, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfLogInterface=pfLogInterface, pfTblAnchorRefs=pfTblAnchorRefs, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfLogIfName=pfLogIfName, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblOutPassBytes=pfTblOutPassBytes, pfHostid=pfHostid, pfTblInPassBytes=pfTblInPassBytes, pfIfIn6PassBytes=pfIfIn6PassBytes, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfStateSearches=pfStateSearches, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTblStatsCleared=pfTblStatsCleared, pfTblRuleRefs=pfTblRuleRefs, pfMIBObjects=pfMIBObjects, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfDebug=pfDebug, pfCntTranslate=pfCntTranslate, pfStateRemovals=pfStateRemovals, pfSrcTrackCount=pfSrcTrackCount, pfTimeoutFragment=pfTimeoutFragment, pfTblInPassPkts=pfTblInPassPkts, pfTimeoutInterval=pfTimeoutInterval, pfInfo=pfInfo, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLabelOutBytes=pfLabelOutBytes, pfLimitStates=pfLimitStates, pfTblInMatchPkts=pfTblInMatchPkts, pfsyncOutputErrors=pfsyncOutputErrors, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfSrcTrackSearches=pfSrcTrackSearches, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfIfIndex=pfIfIndex, pfsyncIpPktsSent=pfsyncIpPktsSent, pfTblAddrCleared=pfTblAddrCleared, pfTblIndex=pfTblIndex, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfLabels=pfLabels, pfLabelOutPkts=pfLabelOutPkts, pfIfRules=pfIfRules, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfCntStateMismatch=pfCntStateMismatch, pfRunning=pfRunning, pfIfOut6PassBytes=pfIfOut6PassBytes, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblInBlockBytes=pfTblInBlockBytes, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfStateInserts=pfStateInserts, pfTblTable=pfTblTable, pfLabelPkts=pfLabelPkts, pfCntStateLimit=pfCntStateLimit, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfLabelName=pfLabelName, pfIfOut6PassPkts=pfIfOut6PassPkts, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTimeouts=pfTimeouts, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfCntTimestamp=pfCntTimestamp, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfLimits=pfLimits, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTblEvalsMatch=pfTblEvalsMatch, pfCntBadOffset=pfCntBadOffset, pfCntNoRoute=pfCntNoRoute, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTables=pfTables, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfsyncNoMemory=pfsyncNoMemory, pfLimitFragments=pfLimitFragments, pfTblAddrMask=pfTblAddrMask, pfTblInXPassPkts=pfTblInXPassPkts, pfLabelIndex=pfLabelIndex, pfCntFragment=pfCntFragment, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfIfIn4PassPkts=pfIfIn4PassPkts, pfsyncStats=pfsyncStats, pfCntStateInsert=pfCntStateInsert, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfIfEntry=pfIfEntry, pfInterfaces=pfInterfaces, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfCntProtoCksum=pfCntProtoCksum, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfIfOut4PassPkts=pfIfOut4PassPkts, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfLimitMaxTables=pfLimitMaxTables, pfTblOutXPassPkts=pfTblOutXPassPkts, pfLabelInPkts=pfLabelInPkts, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblInMatchBytes=pfTblInMatchBytes, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfLabelNumber=pfLabelNumber, pfLimitSourceNodes=pfLimitSourceNodes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, PYSNMP_MODULE_ID=pfMIBObjects, pfIfNumber=pfIfNumber, pfCntIpOption=pfCntIpOption, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLabelTotalStates=pfLabelTotalStates, pfCntNormalize=pfCntNormalize, pfCntCongestion=pfCntCongestion, pfTblInBlockPkts=pfTblInBlockPkts, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop)
