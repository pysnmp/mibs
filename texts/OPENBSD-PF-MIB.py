...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfLogIfName=pfLogIfName, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblEvalsMatch=pfTblEvalsMatch, pfLimits=pfLimits, pfCntTranslate=pfCntTranslate, pfIfOut4PassBytes=pfIfOut4PassBytes, pfsyncStats=pfsyncStats, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTblOutMatchBytes=pfTblOutMatchBytes, pfMIBObjects=pfMIBObjects, pfStateInserts=pfStateInserts, pfCntStateMismatch=pfCntStateMismatch, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfCntCongestion=pfCntCongestion, pfCntSynproxy=pfCntSynproxy, pfCntProtoCksum=pfCntProtoCksum, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfCntIpOption=pfCntIpOption, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTblAddrNet=pfTblAddrNet, pfInfo=pfInfo, pfLabelBytes=pfLabelBytes, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfIfType=pfIfType, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblOutPassBytes=pfTblOutPassBytes, pfLimitStates=pfLimitStates, pfIfIn6PassBytes=pfIfIn6PassBytes, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfLimitSourceNodes=pfLimitSourceNodes, pfLabelIndex=pfLabelIndex, pfLabelName=pfLabelName, pfIfOut6PassPkts=pfIfOut6PassPkts, pfIfIn4PassPkts=pfIfIn4PassPkts, pfSrcTrackSearches=pfSrcTrackSearches, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfCntMemory=pfCntMemory, pfTblInBlockPkts=pfTblInBlockPkts, pfLimitMaxTables=pfLimitMaxTables, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfLabels=pfLabels, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfCntShort=pfCntShort, pfTblAddrEntry=pfTblAddrEntry, pfIfNumber=pfIfNumber, pfIfEntry=pfIfEntry, pfIfOut4PassPkts=pfIfOut4PassPkts, pfRuntime=pfRuntime, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfCounters=pfCounters, pfTblOutXPassBytes=pfTblOutXPassBytes, pfCntMatch=pfCntMatch, pfLabelOutBytes=pfLabelOutBytes, pfLabelInPkts=pfLabelInPkts, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblInPassBytes=pfTblInPassBytes, pfTblInBlockBytes=pfTblInBlockBytes, pfTimeoutInterval=pfTimeoutInterval, pfStateRemovals=pfStateRemovals, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfCntSrcLimit=pfCntSrcLimit, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTimeouts=pfTimeouts, pfCntNormalize=pfCntNormalize, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfIfDescr=pfIfDescr, pfTblName=pfTblName, pfInterfaces=pfInterfaces, pfSrcTrackCount=pfSrcTrackCount, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfSrcTrackInserts=pfSrcTrackInserts, pfsyncNoMemory=pfsyncNoMemory, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfStateSearches=pfStateSearches, pfTblAddresses=pfTblAddresses, pfLabelNumber=pfLabelNumber, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblOutXPassPkts=pfTblOutXPassPkts, pfStateTable=pfStateTable, pfTblAddrCleared=pfTblAddrCleared, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLabelEntry=pfLabelEntry, pfLabelEvals=pfLabelEvals, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfCntStateLimit=pfCntStateLimit, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTblInMatchBytes=pfTblInMatchBytes, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfLabelTable=pfLabelTable, pfIfOut6PassBytes=pfIfOut6PassBytes, pfIfRefs=pfIfRefs, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfCntFragment=pfCntFragment, pfTblAddrMask=pfTblAddrMask, pfTblInMatchPkts=pfTblInMatchPkts, pfLogInterface=pfLogInterface, pfCntTimestamp=pfCntTimestamp, pfTblAddrTable=pfTblAddrTable, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfSrcTracking=pfSrcTracking, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfsyncOutputErrors=pfsyncOutputErrors, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfLabelInBytes=pfLabelInBytes, pfTblOutMatchPkts=pfTblOutMatchPkts, PYSNMP_MODULE_ID=pfMIBObjects, pfTimeoutIcmpError=pfTimeoutIcmpError, pfLabelOutPkts=pfLabelOutPkts, pfStateCount=pfStateCount, pfTblOutBlockPkts=pfTblOutBlockPkts, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfCntStateInsert=pfCntStateInsert, pfTblTable=pfTblTable, pfTblStatsCleared=pfTblStatsCleared, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfLabelTotalStates=pfLabelTotalStates, pfLimitFragments=pfLimitFragments, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblEntry=pfTblEntry, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblIndex=pfTblIndex, pfsyncIpPktsSent=pfsyncIpPktsSent, pfDebug=pfDebug, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTblRuleRefs=pfTblRuleRefs, pfIfIndex=pfIfIndex, pfCntBadOffset=pfCntBadOffset, pfTblNumber=pfTblNumber, pfCntNoRoute=pfCntNoRoute, pfTblInXPassPkts=pfTblInXPassPkts, pfTblAnchorRefs=pfTblAnchorRefs, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblInPassPkts=pfTblInPassPkts, pfIfRules=pfIfRules, pfTables=pfTables, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTimeoutFragment=pfTimeoutFragment, pfTblOutPassPkts=pfTblOutPassPkts, pfLabelPkts=pfLabelPkts, pfHostid=pfHostid, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfRunning=pfRunning, pfIfTable=pfIfTable, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblInXPassBytes=pfTblInXPassBytes, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfIfIn4BlockPkts=pfIfIn4BlockPkts)
