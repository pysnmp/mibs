...
TimeTicks, ModuleIdentity, iso, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, NotificationType, IpAddress, Counter32, Unsigned32, Counter64, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "iso", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "NotificationType", "IpAddress", "Counter32", "Unsigned32", "Counter64", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfCntMatch=pfCntMatch, pfStateTable=pfStateTable, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTblAddrEntry=pfTblAddrEntry, pfLabelPkts=pfLabelPkts, pfCntSrcLimit=pfCntSrcLimit, pfCntFragment=pfCntFragment, pfTblName=pfTblName, pfStateCount=pfStateCount, pfIfIn6PassPkts=pfIfIn6PassPkts, pfCntIpOption=pfCntIpOption, pfCntStateInsert=pfCntStateInsert, pfTblRuleRefs=pfTblRuleRefs, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTblNumber=pfTblNumber, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfsyncNoMemory=pfsyncNoMemory, pfCounters=pfCounters, pfLabelEntry=pfLabelEntry, pfTblAddresses=pfTblAddresses, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblOutMatchPkts=pfTblOutMatchPkts, pfTblAnchorRefs=pfTblAnchorRefs, pfCntShort=pfCntShort, pfTblTable=pfTblTable, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfCntNoRoute=pfCntNoRoute, pfSrcTrackInserts=pfSrcTrackInserts, pfStateSearches=pfStateSearches, pfIfType=pfIfType, pfLabelTable=pfLabelTable, pfDebug=pfDebug, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfInterfaces=pfInterfaces, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfsyncOutputErrors=pfsyncOutputErrors, pfLimitStates=pfLimitStates, pfTblInXPassPkts=pfTblInXPassPkts, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfSrcTrackSearches=pfSrcTrackSearches, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfLimitSourceNodes=pfLimitSourceNodes, pfTblInBlockBytes=pfTblInBlockBytes, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfLabelTotalStates=pfLabelTotalStates, pfsyncIpPktsSent=pfsyncIpPktsSent, pfRunning=pfRunning, pfTblInPassBytes=pfTblInPassBytes, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfTblOutPassBytes=pfTblOutPassBytes, pfStateRemovals=pfStateRemovals, pfCntCongestion=pfCntCongestion, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfIfRefs=pfIfRefs, pfTblInXPassBytes=pfTblInXPassBytes, pfCntMemory=pfCntMemory, pfTblEntry=pfTblEntry, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTblAddrCleared=pfTblAddrCleared, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfCntBadOffset=pfCntBadOffset, pfCntStateLimit=pfCntStateLimit, pfIfOut6PassPkts=pfIfOut6PassPkts, pfIfOut6PassBytes=pfIfOut6PassBytes, pfIfTable=pfIfTable, pfLabelEvals=pfLabelEvals, pfTblOutBlockBytes=pfTblOutBlockBytes, pfMIBObjects=pfMIBObjects, pfTimeouts=pfTimeouts, pfCntTimestamp=pfCntTimestamp, pfIfDescr=pfIfDescr, pfLabelInBytes=pfLabelInBytes, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblIndex=pfTblIndex, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfLabelOutBytes=pfLabelOutBytes, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTblInMatchBytes=pfTblInMatchBytes, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTimeoutInterval=pfTimeoutInterval, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLimits=pfLimits, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfIfNumber=pfIfNumber, pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblInBlockPkts=pfTblInBlockPkts, pfSrcTracking=pfSrcTracking, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfIfIndex=pfIfIndex, pfLimitMaxTables=pfLimitMaxTables, pfTblAddrTable=pfTblAddrTable, pfStateInserts=pfStateInserts, pfLabels=pfLabels, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfHostid=pfHostid, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfsyncStats=pfsyncStats, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTblEvalsMatch=pfTblEvalsMatch, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblOutPassPkts=pfTblOutPassPkts, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfLabelOutPkts=pfLabelOutPkts, pfCntProtoCksum=pfCntProtoCksum, pfCntNormalize=pfCntNormalize, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfIfOut4PassBytes=pfIfOut4PassBytes, pfIfIn4BlockPkts=pfIfIn4BlockPkts, PYSNMP_MODULE_ID=pfMIBObjects, pfRuntime=pfRuntime, pfTblOutXPassBytes=pfTblOutXPassBytes, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfCntSynproxy=pfCntSynproxy, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfInfo=pfInfo, pfLogInterface=pfLogInterface, pfTblAddrMask=pfTblAddrMask, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTblAddrNet=pfTblAddrNet, pfLimitFragments=pfLimitFragments, pfCntTranslate=pfCntTranslate, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfSrcTrackCount=pfSrcTrackCount, pfTblInPassPkts=pfTblInPassPkts, pfLabelBytes=pfLabelBytes, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfLabelNumber=pfLabelNumber, pfTblStatsCleared=pfTblStatsCleared, pfTblInMatchPkts=pfTblInMatchPkts, pfTables=pfTables, pfLabelName=pfLabelName, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLogIfName=pfLogIfName, pfLabelIndex=pfLabelIndex, pfIfEntry=pfIfEntry, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfIfOut4PassPkts=pfIfOut4PassPkts, pfIfRules=pfIfRules, pfLabelInPkts=pfLabelInPkts, pfCntStateMismatch=pfCntStateMismatch, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTimeoutFragment=pfTimeoutFragment, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop)
