...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTblIndex=pfTblIndex, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfSrcTracking=pfSrcTracking, pfIfType=pfIfType, pfLabelTable=pfLabelTable, pfTblOutPassBytes=pfTblOutPassBytes, pfLabelEntry=pfLabelEntry, pfLabelInBytes=pfLabelInBytes, pfTblInXPassPkts=pfTblInXPassPkts, pfTblAddrTblIndex=pfTblAddrTblIndex, pfCntIpOption=pfCntIpOption, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfSrcTrackCount=pfSrcTrackCount, pfLimitStates=pfLimitStates, pfTblOutMatchPkts=pfTblOutMatchPkts, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTblAddrNet=pfTblAddrNet, pfStateTable=pfStateTable, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfLabelEvals=pfLabelEvals, pfStateInserts=pfStateInserts, pfsyncNoMemory=pfsyncNoMemory, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfCntNoRoute=pfCntNoRoute, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfIfRefs=pfIfRefs, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfIfOut6PassBytes=pfIfOut6PassBytes, pfLabelPkts=pfLabelPkts, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblNumber=pfTblNumber, pfTimeouts=pfTimeouts, pfInterfaces=pfInterfaces, pfIfNumber=pfIfNumber, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblInPassBytes=pfTblInPassBytes, PYSNMP_MODULE_ID=pfMIBObjects, pfsyncStats=pfsyncStats, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfLimitFragments=pfLimitFragments, pfLogInterface=pfLogInterface, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfIfDescr=pfIfDescr, pfTblInXPassBytes=pfTblInXPassBytes, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblOutMatchBytes=pfTblOutMatchBytes, pfLimitSourceNodes=pfLimitSourceNodes, pfTblRuleRefs=pfTblRuleRefs, pfRuntime=pfRuntime, pfCntProtoCksum=pfCntProtoCksum, pfLabelInPkts=pfLabelInPkts, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTblAddrEntry=pfTblAddrEntry, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblStatsCleared=pfTblStatsCleared, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblInBlockPkts=pfTblInBlockPkts, pfLabelOutPkts=pfLabelOutPkts, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTblAnchorRefs=pfTblAnchorRefs, pfCntSynproxy=pfCntSynproxy, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfIfOut4PassPkts=pfIfOut4PassPkts, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfCntNormalize=pfCntNormalize, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfIfEntry=pfIfEntry, pfCntStateMismatch=pfCntStateMismatch, pfTblInBlockBytes=pfTblInBlockBytes, pfIfIn4PassPkts=pfIfIn4PassPkts, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTblOutPassPkts=pfTblOutPassPkts, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfLabelNumber=pfLabelNumber, pfTimeoutIcmpError=pfTimeoutIcmpError, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfSrcTrackSearches=pfSrcTrackSearches, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfLabelIndex=pfLabelIndex, pfsyncIpPktsSent=pfsyncIpPktsSent, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfCntTranslate=pfCntTranslate, pfSrcTrackRemovals=pfSrcTrackRemovals, pfTblOutXPassBytes=pfTblOutXPassBytes, pfCntCongestion=pfCntCongestion, pfLabelTotalStates=pfLabelTotalStates, pfTblTable=pfTblTable, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblInMatchPkts=pfTblInMatchPkts, pfTimeoutFragment=pfTimeoutFragment, pfTblAddrTable=pfTblAddrTable, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfCntStateLimit=pfCntStateLimit, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTimeoutInterval=pfTimeoutInterval, pfCntFragment=pfCntFragment, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfMIBObjects=pfMIBObjects, pfSrcTrackInserts=pfSrcTrackInserts, pfTblAddrCleared=pfTblAddrCleared, pfLimitMaxTables=pfLimitMaxTables, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfRunning=pfRunning, pfDebug=pfDebug, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfLimits=pfLimits, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTblName=pfTblName, pfTblInMatchBytes=pfTblInMatchBytes, pfLabels=pfLabels, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfHostid=pfHostid, pfLabelOutBytes=pfLabelOutBytes, pfIfRules=pfIfRules, pfCntTimestamp=pfCntTimestamp, pfCntBadOffset=pfCntBadOffset, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfIfIn6PassBytes=pfIfIn6PassBytes, pfCounters=pfCounters, pfCntMemory=pfCntMemory, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfCntMatch=pfCntMatch, pfTblEntry=pfTblEntry, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfStateRemovals=pfStateRemovals, pfTblEvalsMatch=pfTblEvalsMatch, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLogIfName=pfLogIfName, pfStateCount=pfStateCount, pfLabelBytes=pfLabelBytes, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfLabelName=pfLabelName, pfTables=pfTables, pfIfIndex=pfIfIndex, pfCntStateInsert=pfCntStateInsert, pfIfTable=pfIfTable, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblAddresses=pfTblAddresses, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTblAddrMask=pfTblAddrMask, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblInPassPkts=pfTblInPassPkts, pfInfo=pfInfo, pfCntShort=pfCntShort, pfCntSrcLimit=pfCntSrcLimit, pfsyncOutputErrors=pfsyncOutputErrors, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfStateSearches=pfStateSearches, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfsyncIp6PktsSent=pfsyncIp6PktsSent)
