...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTblOutMatchBytes=pfTblOutMatchBytes, pfLabelInBytes=pfLabelInBytes, pfCntBadOffset=pfCntBadOffset, pfTblOutPassBytes=pfTblOutPassBytes, pfTblAnchorRefs=pfTblAnchorRefs, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTblAddrCleared=pfTblAddrCleared, pfCntShort=pfCntShort, pfLabelPkts=pfLabelPkts, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfLabelNumber=pfLabelNumber, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfSrcTracking=pfSrcTracking, pfCntNormalize=pfCntNormalize, pfIfDescr=pfIfDescr, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblOutPassPkts=pfTblOutPassPkts, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTblAddresses=pfTblAddresses, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfLogIfName=pfLogIfName, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTblStatsCleared=pfTblStatsCleared, pfIfEntry=pfIfEntry, pfCntStateMismatch=pfCntStateMismatch, pfCntNoRoute=pfCntNoRoute, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfTblAddrNet=pfTblAddrNet, pfLabels=pfLabels, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfLogInterface=pfLogInterface, pfRunning=pfRunning, pfCntMemory=pfCntMemory, pfCntCongestion=pfCntCongestion, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfSrcTrackRemovals=pfSrcTrackRemovals, pfRuntime=pfRuntime, pfStateSearches=pfStateSearches, pfTimeouts=pfTimeouts, pfIfRules=pfIfRules, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTblEntry=pfTblEntry, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblInPassBytes=pfTblInPassBytes, pfTimeoutIcmpError=pfTimeoutIcmpError, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfTblTable=pfTblTable, pfLabelOutPkts=pfLabelOutPkts, pfLimitFragments=pfLimitFragments, pfTblOutXPassPkts=pfTblOutXPassPkts, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfInterfaces=pfInterfaces, pfTblInMatchBytes=pfTblInMatchBytes, pfIfRefs=pfIfRefs, pfCntTimestamp=pfCntTimestamp, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblInMatchPkts=pfTblInMatchPkts, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfIfIn4PassBytes=pfIfIn4PassBytes, pfSrcTrackCount=pfSrcTrackCount, pfIfOut4PassBytes=pfIfOut4PassBytes, pfHostid=pfHostid, pfIfOut4PassPkts=pfIfOut4PassPkts, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTblInPassPkts=pfTblInPassPkts, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfIfIndex=pfIfIndex, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblInXPassPkts=pfTblInXPassPkts, pfCounters=pfCounters, pfTblAddrTblIndex=pfTblAddrTblIndex, pfIfIn4PassPkts=pfIfIn4PassPkts, pfInfo=pfInfo, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblAddrMask=pfTblAddrMask, pfTblIndex=pfTblIndex, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfLabelName=pfLabelName, pfIfIn6PassBytes=pfIfIn6PassBytes, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLimitSourceNodes=pfLimitSourceNodes, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblName=pfTblName, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTblEvalsMatch=pfTblEvalsMatch, PYSNMP_MODULE_ID=pfMIBObjects, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfMIBObjects=pfMIBObjects, pfLabelIndex=pfLabelIndex, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblAddrTable=pfTblAddrTable, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblOutMatchPkts=pfTblOutMatchPkts, pfCntSrcLimit=pfCntSrcLimit, pfLabelEvals=pfLabelEvals, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfsyncNoMemory=pfsyncNoMemory, pfDebug=pfDebug, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTimeoutInterval=pfTimeoutInterval, pfStateInserts=pfStateInserts, pfTblRuleRefs=pfTblRuleRefs, pfStateTable=pfStateTable, pfTblInXPassBytes=pfTblInXPassBytes, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfCntProtoCksum=pfCntProtoCksum, pfTblInBlockBytes=pfTblInBlockBytes, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfSrcTrackInserts=pfSrcTrackInserts, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTimeoutFragment=pfTimeoutFragment, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfLabelTable=pfLabelTable, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfStateRemovals=pfStateRemovals, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfLimitMaxTables=pfLimitMaxTables, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTables=pfTables, pfCntFragment=pfCntFragment, pfCntTranslate=pfCntTranslate, pfLabelInPkts=pfLabelInPkts, pfTblAddrEntry=pfTblAddrEntry, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfIfNumber=pfIfNumber, pfCntMatch=pfCntMatch, pfSrcTrackSearches=pfSrcTrackSearches, pfTblNumber=pfTblNumber, pfLabelOutBytes=pfLabelOutBytes, pfLabelEntry=pfLabelEntry, pfLabelBytes=pfLabelBytes, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfsyncStats=pfsyncStats, pfCntIpOption=pfCntIpOption, pfTblInBlockPkts=pfTblInBlockPkts, pfTblOutBlockBytes=pfTblOutBlockBytes, pfIfOut6PassPkts=pfIfOut6PassPkts, pfLabelTotalStates=pfLabelTotalStates, pfsyncOutputErrors=pfsyncOutputErrors, pfsyncIpPktsSent=pfsyncIpPktsSent, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfLimits=pfLimits, pfCntStateInsert=pfCntStateInsert, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfCntStateLimit=pfCntStateLimit, pfIfTable=pfIfTable, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfStateCount=pfStateCount, pfIfType=pfIfType, pfCntSynproxy=pfCntSynproxy, pfLimitStates=pfLimitStates)
