...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTblInMatchBytes=pfTblInMatchBytes, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfInfo=pfInfo, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfCntFragment=pfCntFragment, pfTblIndex=pfTblIndex, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTblInBlockPkts=pfTblInBlockPkts, pfLimits=pfLimits, pfLabelPkts=pfLabelPkts, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblOutXPassBytes=pfTblOutXPassBytes, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfHostid=pfHostid, pfLabelEvals=pfLabelEvals, pfCntTranslate=pfCntTranslate, pfTblAddrCleared=pfTblAddrCleared, pfTblOutBlockPkts=pfTblOutBlockPkts, pfCntMatch=pfCntMatch, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfSrcTrackCount=pfSrcTrackCount, pfLabelInBytes=pfLabelInBytes, pfLabelEntry=pfLabelEntry, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfCntSynproxy=pfCntSynproxy, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfLimitStates=pfLimitStates, pfTimeoutInterval=pfTimeoutInterval, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfsyncIpPktsSent=pfsyncIpPktsSent, pfIfDescr=pfIfDescr, pfMIBObjects=pfMIBObjects, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTblAddresses=pfTblAddresses, pfCntBadOffset=pfCntBadOffset, pfIfIndex=pfIfIndex, pfTblInMatchPkts=pfTblInMatchPkts, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfSrcTrackSearches=pfSrcTrackSearches, pfSrcTracking=pfSrcTracking, pfCntTimestamp=pfCntTimestamp, pfLabelOutBytes=pfLabelOutBytes, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblAddrMask=pfTblAddrMask, pfTblTable=pfTblTable, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfTblStatsCleared=pfTblStatsCleared, pfTblAddrNet=pfTblAddrNet, pfIfNumber=pfIfNumber, pfTblOutXPassPkts=pfTblOutXPassPkts, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTblAnchorRefs=pfTblAnchorRefs, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfLogInterface=pfLogInterface, pfLabelOutPkts=pfLabelOutPkts, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblName=pfTblName, pfTblInPassPkts=pfTblInPassPkts, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLogIfName=pfLogIfName, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfsyncOutputErrors=pfsyncOutputErrors, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTblOutPassBytes=pfTblOutPassBytes, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfIfOut4PassBytes=pfIfOut4PassBytes, pfSrcTrackRemovals=pfSrcTrackRemovals, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfCntMemory=pfCntMemory, pfInterfaces=pfInterfaces, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfIfIn4PassBytes=pfIfIn4PassBytes, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfCounters=pfCounters, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfLabelIndex=pfLabelIndex, pfCntStateMismatch=pfCntStateMismatch, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfCntNormalize=pfCntNormalize, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfIfRules=pfIfRules, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblRuleRefs=pfTblRuleRefs, pfLabelTable=pfLabelTable, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfIfType=pfIfType, pfIfRefs=pfIfRefs, pfLabelBytes=pfLabelBytes, pfSrcTrackInserts=pfSrcTrackInserts, pfTblEvalsMatch=pfTblEvalsMatch, pfRunning=pfRunning, pfTblAddrEntry=pfTblAddrEntry, pfLimitFragments=pfLimitFragments, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfCntProtoCksum=pfCntProtoCksum, pfLabelNumber=pfLabelNumber, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfCntStateLimit=pfCntStateLimit, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblOutPassPkts=pfTblOutPassPkts, pfCntCongestion=pfCntCongestion, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfCntShort=pfCntShort, pfLabelName=pfLabelName, pfTblInXPassPkts=pfTblInXPassPkts, pfCntIpOption=pfCntIpOption, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTables=pfTables, pfTblAddrTable=pfTblAddrTable, pfCntNoRoute=pfCntNoRoute, pfIfEntry=pfIfEntry, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLimitMaxTables=pfLimitMaxTables, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfStateRemovals=pfStateRemovals, pfLabelInPkts=pfLabelInPkts, pfIfOut6PassPkts=pfIfOut6PassPkts, pfIfOut4PassPkts=pfIfOut4PassPkts, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfsyncNoMemory=pfsyncNoMemory, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfStateCount=pfStateCount, pfStateTable=pfStateTable, pfCntSrcLimit=pfCntSrcLimit, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfsyncStats=pfsyncStats, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTblInXPassBytes=pfTblInXPassBytes, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfIfIn6PassPkts=pfIfIn6PassPkts, pfRuntime=pfRuntime, pfStateSearches=pfStateSearches, pfCntStateInsert=pfCntStateInsert, pfTblInPassBytes=pfTblInPassBytes, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfLimitSourceNodes=pfLimitSourceNodes, pfTblOutMatchPkts=pfTblOutMatchPkts, pfIfIn4PassPkts=pfIfIn4PassPkts, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblEntry=pfTblEntry, pfTblNumber=pfTblNumber, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTimeoutFragment=pfTimeoutFragment, pfLabels=pfLabels, pfLabelTotalStates=pfLabelTotalStates, pfTblInBlockBytes=pfTblInBlockBytes, PYSNMP_MODULE_ID=pfMIBObjects, pfStateInserts=pfStateInserts, pfIfTable=pfIfTable, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfDebug=pfDebug, pfTimeouts=pfTimeouts)
