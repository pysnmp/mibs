...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblOutBlockPkts=pfTblOutBlockPkts, pfIfIn6PassBytes=pfIfIn6PassBytes, pfMIBObjects=pfMIBObjects, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfLabelInPkts=pfLabelInPkts, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblEvalsMatch=pfTblEvalsMatch, pfsyncIpPktsSent=pfsyncIpPktsSent, pfTblTable=pfTblTable, pfTblOutPassPkts=pfTblOutPassPkts, pfSrcTrackInserts=pfSrcTrackInserts, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfSrcTrackSearches=pfSrcTrackSearches, pfTblInPassPkts=pfTblInPassPkts, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfLabelNumber=pfLabelNumber, pfLabels=pfLabels, pfCntSrcLimit=pfCntSrcLimit, pfIfEntry=pfIfEntry, pfTblName=pfTblName, pfCntCongestion=pfCntCongestion, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfStateInserts=pfStateInserts, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfSrcTrackRemovals=pfSrcTrackRemovals, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblInXPassPkts=pfTblInXPassPkts, pfLimitSourceNodes=pfLimitSourceNodes, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblOutPassBytes=pfTblOutPassBytes, pfTables=pfTables, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTblInPassBytes=pfTblInPassBytes, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfLimitStates=pfLimitStates, pfLabelOutPkts=pfLabelOutPkts, pfCntMemory=pfCntMemory, pfTblAddrMask=pfTblAddrMask, pfCntShort=pfCntShort, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfIfDescr=pfIfDescr, pfsyncOutputErrors=pfsyncOutputErrors, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfLabelPkts=pfLabelPkts, pfSrcTracking=pfSrcTracking, pfTblOutMatchPkts=pfTblOutMatchPkts, pfDebug=pfDebug, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfRunning=pfRunning, pfTblAddrTblIndex=pfTblAddrTblIndex, pfCntProtoCksum=pfCntProtoCksum, pfIfIndex=pfIfIndex, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfCntNoRoute=pfCntNoRoute, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTblAddrNet=pfTblAddrNet, pfCntSynproxy=pfCntSynproxy, pfLabelBytes=pfLabelBytes, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfLabelOutBytes=pfLabelOutBytes, pfHostid=pfHostid, pfTblInBlockBytes=pfTblInBlockBytes, pfStateTable=pfStateTable, pfLabelName=pfLabelName, pfLimits=pfLimits, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfRuntime=pfRuntime, pfTblAddrTable=pfTblAddrTable, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblStatsCleared=pfTblStatsCleared, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblAnchorRefs=pfTblAnchorRefs, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblInMatchPkts=pfTblInMatchPkts, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfLogInterface=pfLogInterface, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfIfTable=pfIfTable, pfCntMatch=pfCntMatch, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfTblIndex=pfTblIndex, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfLabelTable=pfLabelTable, pfTblEntry=pfTblEntry, pfTblAddrCleared=pfTblAddrCleared, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfStateSearches=pfStateSearches, pfTblOutMatchBytes=pfTblOutMatchBytes, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfIfType=pfIfType, pfTimeoutInterval=pfTimeoutInterval, pfCntTranslate=pfCntTranslate, pfTblInMatchBytes=pfTblInMatchBytes, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfCntStateMismatch=pfCntStateMismatch, pfsyncStats=pfsyncStats, pfSrcTrackCount=pfSrcTrackCount, pfCntIpOption=pfCntIpOption, pfIfNumber=pfIfNumber, pfInterfaces=pfInterfaces, pfTblOutXPassBytes=pfTblOutXPassBytes, pfLabelEntry=pfLabelEntry, pfLabelIndex=pfLabelIndex, pfIfRefs=pfIfRefs, pfLimitMaxTables=pfLimitMaxTables, pfTblInBlockPkts=pfTblInBlockPkts, pfsyncNoMemory=pfsyncNoMemory, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfCntBadOffset=pfCntBadOffset, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfCntStateInsert=pfCntStateInsert, pfTimeoutFragment=pfTimeoutFragment, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTblNumber=pfTblNumber, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfCounters=pfCounters, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblAddrEntry=pfTblAddrEntry, pfLabelInBytes=pfLabelInBytes, pfLabelTotalStates=pfLabelTotalStates, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfLabelEvals=pfLabelEvals, pfIfOut4PassBytes=pfIfOut4PassBytes, pfCntTimestamp=pfCntTimestamp, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfIfRules=pfIfRules, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblAddresses=pfTblAddresses, PYSNMP_MODULE_ID=pfMIBObjects, pfIfOut6PassPkts=pfIfOut6PassPkts, pfInfo=pfInfo, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfStateRemovals=pfStateRemovals, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblRuleRefs=pfTblRuleRefs, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfCntFragment=pfCntFragment, pfCntNormalize=pfCntNormalize, pfIfOut6PassBytes=pfIfOut6PassBytes, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTimeouts=pfTimeouts, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfCntStateLimit=pfCntStateLimit, pfLogIfName=pfLogIfName, pfIfOut4PassPkts=pfIfOut4PassPkts, pfStateCount=pfStateCount, pfTblInXPassBytes=pfTblInXPassBytes, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfLimitFragments=pfLimitFragments)
