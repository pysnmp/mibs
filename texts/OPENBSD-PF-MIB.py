...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfIndex=pfIfIndex, pfTblInPassPkts=pfTblInPassPkts, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfCntIpOption=pfCntIpOption, pfCntNormalize=pfCntNormalize, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfLabelIndex=pfLabelIndex, pfStateInserts=pfStateInserts, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblAddrTable=pfTblAddrTable, pfTblOutBlockPkts=pfTblOutBlockPkts, pfCntFragment=pfCntFragment, pfSrcTrackCount=pfSrcTrackCount, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTblEntry=pfTblEntry, pfTblInMatchPkts=pfTblInMatchPkts, pfLabelEntry=pfLabelEntry, pfLabelOutPkts=pfLabelOutPkts, pfDebug=pfDebug, pfLimitFragments=pfLimitFragments, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLabelNumber=pfLabelNumber, pfLimitStates=pfLimitStates, pfTblAddrCleared=pfTblAddrCleared, pfTblNumber=pfTblNumber, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfsyncNoMemory=pfsyncNoMemory, pfIfOut4PassBytes=pfIfOut4PassBytes, PYSNMP_MODULE_ID=pfMIBObjects, pfTblAnchorRefs=pfTblAnchorRefs, pfTblInPassBytes=pfTblInPassBytes, pfInterfaces=pfInterfaces, pfCntNoRoute=pfCntNoRoute, pfTblOutPassBytes=pfTblOutPassBytes, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfCntMemory=pfCntMemory, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfRunning=pfRunning, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfCntCongestion=pfCntCongestion, pfCounters=pfCounters, pfLabelTotalStates=pfLabelTotalStates, pfSrcTrackInserts=pfSrcTrackInserts, pfTblOutXPassBytes=pfTblOutXPassBytes, pfStateSearches=pfStateSearches, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfSrcTracking=pfSrcTracking, pfLabelOutBytes=pfLabelOutBytes, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfTblEvalsMatch=pfTblEvalsMatch, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfLabelTable=pfLabelTable, pfStateTable=pfStateTable, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfHostid=pfHostid, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfTblInBlockBytes=pfTblInBlockBytes, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfCntSrcLimit=pfCntSrcLimit, pfCntStateMismatch=pfCntStateMismatch, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTblOutMatchBytes=pfTblOutMatchBytes, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTblInXPassBytes=pfTblInXPassBytes, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfSrcTrackSearches=pfSrcTrackSearches, pfSrcTrackRemovals=pfSrcTrackRemovals, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfIfEntry=pfIfEntry, pfTblOutMatchPkts=pfTblOutMatchPkts, pfTblAddrEntry=pfTblAddrEntry, pfMIBObjects=pfMIBObjects, pfCntStateInsert=pfCntStateInsert, pfCntMatch=pfCntMatch, pfsyncIpPktsSent=pfsyncIpPktsSent, pfLabelInBytes=pfLabelInBytes, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblRuleRefs=pfTblRuleRefs, pfIfIn6PassBytes=pfIfIn6PassBytes, pfLimitMaxTables=pfLimitMaxTables, pfTables=pfTables, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTimeoutInterval=pfTimeoutInterval, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfLimits=pfLimits, pfIfRules=pfIfRules, pfRuntime=pfRuntime, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfLabelBytes=pfLabelBytes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfLogInterface=pfLogInterface, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfTblName=pfTblName, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTblInMatchBytes=pfTblInMatchBytes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfStateCount=pfStateCount, pfTblAddrMask=pfTblAddrMask, pfInfo=pfInfo, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTblOutBlockBytes=pfTblOutBlockBytes, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTblOutXPassPkts=pfTblOutXPassPkts, pfIfTable=pfIfTable, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfCntSynproxy=pfCntSynproxy, pfTblTable=pfTblTable, pfLabels=pfLabels, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfCntTranslate=pfCntTranslate, pfsyncStats=pfsyncStats, pfLabelEvals=pfLabelEvals, pfLabelPkts=pfLabelPkts, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfIfNumber=pfIfNumber, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfIfType=pfIfType, pfTblAddrTblIndex=pfTblAddrTblIndex, pfCntProtoCksum=pfCntProtoCksum, pfIfDescr=pfIfDescr, pfIfOut6PassPkts=pfIfOut6PassPkts, pfLabelInPkts=pfLabelInPkts, pfLabelName=pfLabelName, pfCntTimestamp=pfCntTimestamp, pfStateRemovals=pfStateRemovals, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTblStatsCleared=pfTblStatsCleared, pfIfRefs=pfIfRefs, pfTblAddrNet=pfTblAddrNet, pfLimitSourceNodes=pfLimitSourceNodes, pfTblInXPassPkts=pfTblInXPassPkts, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblAddresses=pfTblAddresses, pfTimeouts=pfTimeouts, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblInBlockPkts=pfTblInBlockPkts, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblOutPassPkts=pfTblOutPassPkts, pfTimeoutFragment=pfTimeoutFragment, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfLogIfName=pfLogIfName, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfIfOut4PassPkts=pfIfOut4PassPkts, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblIndex=pfTblIndex, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfCntBadOffset=pfCntBadOffset, pfCntStateLimit=pfCntStateLimit, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfIfIn6PassPkts=pfIfIn6PassPkts, pfsyncOutputErrors=pfsyncOutputErrors, pfIfIn4PassPkts=pfIfIn4PassPkts, pfIfOut6PassBytes=pfIfOut6PassBytes, pfCntShort=pfCntShort, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop)
