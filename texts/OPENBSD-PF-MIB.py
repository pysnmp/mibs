...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfStateCount=pfStateCount, pfCntNormalize=pfCntNormalize, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfCntMemory=pfCntMemory, pfsyncOutputErrors=pfsyncOutputErrors, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfsyncNoMemory=pfsyncNoMemory, pfLogIfName=pfLogIfName, pfTblInPassPkts=pfTblInPassPkts, pfTblOutXPassBytes=pfTblOutXPassBytes, pfIfEntry=pfIfEntry, pfCntStateInsert=pfCntStateInsert, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfLabelTotalStates=pfLabelTotalStates, pfIfIn4PassBytes=pfIfIn4PassBytes, pfRunning=pfRunning, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfSrcTrackRemovals=pfSrcTrackRemovals, pfCounters=pfCounters, pfIfTable=pfIfTable, pfCntShort=pfCntShort, pfCntNoRoute=pfCntNoRoute, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfTblInXPassBytes=pfTblInXPassBytes, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfIfIn6PassBytes=pfIfIn6PassBytes, pfLabelEvals=pfLabelEvals, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfRuntime=pfRuntime, pfLabelInPkts=pfLabelInPkts, pfTimeoutInterval=pfTimeoutInterval, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfLabelTable=pfLabelTable, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTblName=pfTblName, pfHostid=pfHostid, pfLabels=pfLabels, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfLabelPkts=pfLabelPkts, pfTblRuleRefs=pfTblRuleRefs, pfSrcTracking=pfSrcTracking, pfTblInPassBytes=pfTblInPassBytes, pfTblAddresses=pfTblAddresses, pfCntCongestion=pfCntCongestion, pfLimitMaxTables=pfLimitMaxTables, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTblTable=pfTblTable, pfInfo=pfInfo, pfCntTranslate=pfCntTranslate, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfIfDescr=pfIfDescr, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfLabelBytes=pfLabelBytes, pfCntProtoCksum=pfCntProtoCksum, pfLabelEntry=pfLabelEntry, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTblAddrMask=pfTblAddrMask, pfLabelInBytes=pfLabelInBytes, pfTblIndex=pfTblIndex, pfTblAnchorRefs=pfTblAnchorRefs, pfTblOutBlockBytes=pfTblOutBlockBytes, pfIfOut6PassBytes=pfIfOut6PassBytes, pfCntIpOption=pfCntIpOption, pfTblOutMatchBytes=pfTblOutMatchBytes, pfLimitSourceNodes=pfLimitSourceNodes, pfIfIndex=pfIfIndex, pfTimeoutIcmpError=pfTimeoutIcmpError, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTblOutPassBytes=pfTblOutPassBytes, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfIfRefs=pfIfRefs, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfStateInserts=pfStateInserts, pfTblInXPassPkts=pfTblInXPassPkts, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfStateRemovals=pfStateRemovals, pfCntBadOffset=pfCntBadOffset, pfsyncIpPktsSent=pfsyncIpPktsSent, pfCntStateMismatch=pfCntStateMismatch, pfTblNumber=pfTblNumber, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblInMatchPkts=pfTblInMatchPkts, pfTblInBlockPkts=pfTblInBlockPkts, pfStateSearches=pfStateSearches, pfInterfaces=pfInterfaces, pfIfIn4PassPkts=pfIfIn4PassPkts, pfDebug=pfDebug, pfCntStateLimit=pfCntStateLimit, pfTimeouts=pfTimeouts, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfSrcTrackSearches=pfSrcTrackSearches, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTblEvalsMatch=pfTblEvalsMatch, pfTblInMatchBytes=pfTblInMatchBytes, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfCntFragment=pfCntFragment, pfLabelName=pfLabelName, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfStateTable=pfStateTable, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfLimitFragments=pfLimitFragments, pfLabelNumber=pfLabelNumber, pfIfRules=pfIfRules, pfLimitStates=pfLimitStates, pfTblOutPassPkts=pfTblOutPassPkts, pfTblAddrCleared=pfTblAddrCleared, pfIfType=pfIfType, pfIfOut4PassBytes=pfIfOut4PassBytes, pfSrcTrackInserts=pfSrcTrackInserts, pfTblAddrNet=pfTblAddrNet, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfCntTimestamp=pfCntTimestamp, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTblAddrTable=pfTblAddrTable, pfTables=pfTables, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblStatsCleared=pfTblStatsCleared, pfTblOutMatchPkts=pfTblOutMatchPkts, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfMIBObjects=pfMIBObjects, pfCntMatch=pfCntMatch, pfTblOutXPassPkts=pfTblOutXPassPkts, pfIfNumber=pfIfNumber, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfCntSrcLimit=pfCntSrcLimit, pfTblAddrEntry=pfTblAddrEntry, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTimeoutFragment=pfTimeoutFragment, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfIfOut4PassPkts=pfIfOut4PassPkts, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTblOutBlockPkts=pfTblOutBlockPkts, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfLogInterface=pfLogInterface, pfLabelIndex=pfLabelIndex, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfCntSynproxy=pfCntSynproxy, pfTblEntry=pfTblEntry, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfsyncStats=pfsyncStats, pfLabelOutBytes=pfLabelOutBytes, pfIfIn6PassPkts=pfIfIn6PassPkts, pfSrcTrackCount=pfSrcTrackCount, pfTblInBlockBytes=pfTblInBlockBytes, PYSNMP_MODULE_ID=pfMIBObjects, pfLimits=pfLimits, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfLabelOutPkts=pfLabelOutPkts, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts)
