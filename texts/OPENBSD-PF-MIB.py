...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTblTable=pfTblTable, pfLabelIndex=pfLabelIndex, pfLabelName=pfLabelName, pfsyncStats=pfsyncStats, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTblEvalsMatch=pfTblEvalsMatch, pfInterfaces=pfInterfaces, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblOutPassPkts=pfTblOutPassPkts, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfIfOut4PassBytes=pfIfOut4PassBytes, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfDebug=pfDebug, pfLabelInBytes=pfLabelInBytes, pfIfEntry=pfIfEntry, pfHostid=pfHostid, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTblOutMatchPkts=pfTblOutMatchPkts, pfTblInXPassPkts=pfTblInXPassPkts, pfIfType=pfIfType, pfTblInPassPkts=pfTblInPassPkts, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblAddrCleared=pfTblAddrCleared, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfIfIndex=pfIfIndex, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfIfIn6PassPkts=pfIfIn6PassPkts, pfLabelOutPkts=pfLabelOutPkts, pfIfTable=pfIfTable, pfLabelBytes=pfLabelBytes, pfTblAnchorRefs=pfTblAnchorRefs, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblAddrEntry=pfTblAddrEntry, pfStateInserts=pfStateInserts, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfCntStateInsert=pfCntStateInsert, pfLabelPkts=pfLabelPkts, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfSrcTracking=pfSrcTracking, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfIfIn4PassPkts=pfIfIn4PassPkts, pfIfOut4PassPkts=pfIfOut4PassPkts, pfCntFragment=pfCntFragment, pfsyncIpPktsSent=pfsyncIpPktsSent, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTimeouts=pfTimeouts, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfLimitMaxTables=pfLimitMaxTables, pfIfIn6PassBytes=pfIfIn6PassBytes, pfLabelTotalStates=pfLabelTotalStates, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfCntSrcLimit=pfCntSrcLimit, pfLabelEvals=pfLabelEvals, pfCntMatch=pfCntMatch, pfTblRuleRefs=pfTblRuleRefs, pfTimeoutFragment=pfTimeoutFragment, pfTblAddrTable=pfTblAddrTable, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfCntIpOption=pfCntIpOption, pfTblInMatchBytes=pfTblInMatchBytes, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfCntProtoCksum=pfCntProtoCksum, pfTimeoutInterval=pfTimeoutInterval, pfTblAddrMask=pfTblAddrMask, pfTblAddrNet=pfTblAddrNet, pfTblIndex=pfTblIndex, pfTblOutXPassBytes=pfTblOutXPassBytes, pfIfRefs=pfIfRefs, pfLabelNumber=pfLabelNumber, PYSNMP_MODULE_ID=pfMIBObjects, pfStateTable=pfStateTable, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblInBlockPkts=pfTblInBlockPkts, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLabelTable=pfLabelTable, pfIfIn4PassBytes=pfIfIn4PassBytes, pfCntSynproxy=pfCntSynproxy, pfTblInBlockBytes=pfTblInBlockBytes, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfTblAddrTblIndex=pfTblAddrTblIndex, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfCntShort=pfCntShort, pfCntCongestion=pfCntCongestion, pfLogInterface=pfLogInterface, pfsyncNoMemory=pfsyncNoMemory, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfIfOut6PassBytes=pfIfOut6PassBytes, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblInXPassBytes=pfTblInXPassBytes, pfSrcTrackCount=pfSrcTrackCount, pfSrcTrackInserts=pfSrcTrackInserts, pfLabelOutBytes=pfLabelOutBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfLabels=pfLabels, pfTblInMatchPkts=pfTblInMatchPkts, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfSrcTrackSearches=pfSrcTrackSearches, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfCntStateLimit=pfCntStateLimit, pfLogIfName=pfLogIfName, pfTblName=pfTblName, pfCntNormalize=pfCntNormalize, pfMIBObjects=pfMIBObjects, pfRunning=pfRunning, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTblNumber=pfTblNumber, pfTblStatsCleared=pfTblStatsCleared, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfRuntime=pfRuntime, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTimeoutIcmpError=pfTimeoutIcmpError, pfLimits=pfLimits, pfIfRules=pfIfRules, pfIfDescr=pfIfDescr, pfStateCount=pfStateCount, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfLimitSourceNodes=pfLimitSourceNodes, pfCntBadOffset=pfCntBadOffset, pfCntStateMismatch=pfCntStateMismatch, pfCntTimestamp=pfCntTimestamp, pfCntTranslate=pfCntTranslate, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTblAddresses=pfTblAddresses, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfLimitFragments=pfLimitFragments, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfsyncOutputErrors=pfsyncOutputErrors, pfIfNumber=pfIfNumber, pfTblInPassBytes=pfTblInPassBytes, pfTblOutMatchBytes=pfTblOutMatchBytes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLabelInPkts=pfLabelInPkts, pfCounters=pfCounters, pfLimitStates=pfLimitStates, pfInfo=pfInfo, pfStateSearches=pfStateSearches, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblEntry=pfTblEntry, pfTables=pfTables, pfStateRemovals=pfStateRemovals, pfLabelEntry=pfLabelEntry, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfCntMemory=pfCntMemory, pfTblOutPassBytes=pfTblOutPassBytes, pfCntNoRoute=pfCntNoRoute)
