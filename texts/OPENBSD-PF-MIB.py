...
enterprises, Bits, ObjectIdentity, NotificationType, MibIdentifier, Counter64, iso, ModuleIdentity, Counter32, Integer32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "ObjectIdentity", "NotificationType", "MibIdentifier", "Counter64", "iso", "ModuleIdentity", "Counter32", "Integer32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfDebug=pfDebug, pfSrcTrackInserts=pfSrcTrackInserts, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfInfo=pfInfo, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfIfEntry=pfIfEntry, pfSrcTrackRemovals=pfSrcTrackRemovals, pfTblTable=pfTblTable, pfLogIfName=pfLogIfName, pfCntStateLimit=pfCntStateLimit, pfCntStateMismatch=pfCntStateMismatch, pfStateRemovals=pfStateRemovals, pfRuntime=pfRuntime, pfTblAddrNet=pfTblAddrNet, pfLabels=pfLabels, pfCntBadOffset=pfCntBadOffset, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTimeoutFragment=pfTimeoutFragment, pfTables=pfTables, pfTblInPassPkts=pfTblInPassPkts, pfIfIn6PassPkts=pfIfIn6PassPkts, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfsyncIpPktsSent=pfsyncIpPktsSent, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfSrcTrackSearches=pfSrcTrackSearches, pfIfIn6PassBytes=pfIfIn6PassBytes, pfCntSynproxy=pfCntSynproxy, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTblOutPassPkts=pfTblOutPassPkts, pfLabelEntry=pfLabelEntry, pfTblAnchorRefs=pfTblAnchorRefs, pfTblOutMatchPkts=pfTblOutMatchPkts, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfTblInMatchBytes=pfTblInMatchBytes, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTblInPassBytes=pfTblInPassBytes, pfLimits=pfLimits, pfCntShort=pfCntShort, pfLabelIndex=pfLabelIndex, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeouts=pfTimeouts, pfLabelBytes=pfLabelBytes, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLabelEvals=pfLabelEvals, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfCntIpOption=pfCntIpOption, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblAddrEntry=pfTblAddrEntry, pfIfDescr=pfIfDescr, pfTblEntry=pfTblEntry, pfTblName=pfTblName, pfMIBObjects=pfMIBObjects, pfTblInXPassPkts=pfTblInXPassPkts, pfLimitFragments=pfLimitFragments, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfCntFragment=pfCntFragment, pfTimeoutSrcTrack=pfTimeoutSrcTrack, PYSNMP_MODULE_ID=pfMIBObjects, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblIndex=pfTblIndex, pfTblAddrMask=pfTblAddrMask, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfSrcTrackCount=pfSrcTrackCount, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfStateInserts=pfStateInserts, pfTblInMatchPkts=pfTblInMatchPkts, pfTblNumber=pfTblNumber, pfLimitStates=pfLimitStates, pfTblAddrTable=pfTblAddrTable, pfCntMatch=pfCntMatch, pfsyncOutputErrors=pfsyncOutputErrors, pfLabelInBytes=pfLabelInBytes, pfsyncNoMemory=pfsyncNoMemory, pfIfNumber=pfIfNumber, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfStateTable=pfStateTable, pfLimitSourceNodes=pfLimitSourceNodes, pfSrcTracking=pfSrcTracking, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTblOutXPassPkts=pfTblOutXPassPkts, pfInterfaces=pfInterfaces, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfIfTable=pfIfTable, pfTblOutBlockBytes=pfTblOutBlockBytes, pfLabelNumber=pfLabelNumber, pfCntStateInsert=pfCntStateInsert, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfHostid=pfHostid, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfsyncStats=pfsyncStats, pfLogInterface=pfLogInterface, pfTblOutPassBytes=pfTblOutPassBytes, pfLabelTotalStates=pfLabelTotalStates, pfTblAddrCleared=pfTblAddrCleared, pfIfOut4PassPkts=pfIfOut4PassPkts, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblAddresses=pfTblAddresses, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTblInXPassBytes=pfTblInXPassBytes, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfIfRefs=pfIfRefs, pfCntMemory=pfCntMemory, pfLabelOutPkts=pfLabelOutPkts, pfIfIndex=pfIfIndex, pfCntNormalize=pfCntNormalize, pfCntCongestion=pfCntCongestion, pfCntSrcLimit=pfCntSrcLimit, pfRunning=pfRunning, pfTimeoutInterval=pfTimeoutInterval, pfCntTranslate=pfCntTranslate, pfTblEvalsMatch=pfTblEvalsMatch, pfIfType=pfIfType, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfLabelTable=pfLabelTable, pfIfIn4PassBytes=pfIfIn4PassBytes, pfLabelName=pfLabelName, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfCntProtoCksum=pfCntProtoCksum, pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblInBlockBytes=pfTblInBlockBytes, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfStateSearches=pfStateSearches, pfLabelPkts=pfLabelPkts, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfCounters=pfCounters, pfIfOut6PassPkts=pfIfOut6PassPkts, pfLimitMaxTables=pfLimitMaxTables, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfLabelOutBytes=pfLabelOutBytes, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTblStatsCleared=pfTblStatsCleared, pfTblInBlockPkts=pfTblInBlockPkts, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblOutXPassBytes=pfTblOutXPassBytes, pfCntTimestamp=pfCntTimestamp, pfIfOut6PassBytes=pfIfOut6PassBytes, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfCntNoRoute=pfCntNoRoute, pfLabelInPkts=pfLabelInPkts, pfTblAddrTblIndex=pfTblAddrTblIndex, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfStateCount=pfStateCount, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfIfRules=pfIfRules, pfTblRuleRefs=pfTblRuleRefs, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTimeoutTcpOpening=pfTimeoutTcpOpening)
