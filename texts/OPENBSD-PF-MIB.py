...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfOut6PassPkts=pfIfOut6PassPkts, pfTblInXPassBytes=pfTblInXPassBytes, pfIfIn4PassBytes=pfIfIn4PassBytes, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfSrcTrackInserts=pfSrcTrackInserts, pfIfOut4PassPkts=pfIfOut4PassPkts, pfIfIn4PassPkts=pfIfIn4PassPkts, pfCntStateInsert=pfCntStateInsert, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblTable=pfTblTable, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTimeouts=pfTimeouts, pfsyncOutputErrors=pfsyncOutputErrors, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfCntBadOffset=pfCntBadOffset, pfTblRuleRefs=pfTblRuleRefs, pfTimeoutInterval=pfTimeoutInterval, pfTblOutMatchBytes=pfTblOutMatchBytes, pfCntSrcLimit=pfCntSrcLimit, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfDebug=pfDebug, pfIfRules=pfIfRules, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLabels=pfLabels, pfCntMemory=pfCntMemory, pfCntNoRoute=pfCntNoRoute, pfTimeoutIcmpError=pfTimeoutIcmpError, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfCntStateMismatch=pfCntStateMismatch, pfLabelOutPkts=pfLabelOutPkts, pfsyncNoMemory=pfsyncNoMemory, pfHostid=pfHostid, pfMIBObjects=pfMIBObjects, pfLabelTotalStates=pfLabelTotalStates, pfsyncIpPktsSent=pfsyncIpPktsSent, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblEntry=pfTblEntry, pfTblInBlockPkts=pfTblInBlockPkts, pfLogIfName=pfLogIfName, pfTblInBlockBytes=pfTblInBlockBytes, pfLimits=pfLimits, pfIfIn6PassPkts=pfIfIn6PassPkts, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTables=pfTables, pfLabelBytes=pfLabelBytes, pfStateInserts=pfStateInserts, pfTblAddrNet=pfTblAddrNet, pfLimitStates=pfLimitStates, pfIfIn6PassBytes=pfIfIn6PassBytes, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfsyncStats=pfsyncStats, pfLabelInPkts=pfLabelInPkts, pfRunning=pfRunning, pfTblOutXPassPkts=pfTblOutXPassPkts, pfInterfaces=pfInterfaces, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTblOutPassPkts=pfTblOutPassPkts, pfLabelTable=pfLabelTable, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblStatsCleared=pfTblStatsCleared, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfStateCount=pfStateCount, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblOutPassBytes=pfTblOutPassBytes, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblNumber=pfTblNumber, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfStateRemovals=pfStateRemovals, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTblAddrTblIndex=pfTblAddrTblIndex, pfCntTranslate=pfCntTranslate, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfTblAnchorRefs=pfTblAnchorRefs, pfTblOutXPassBytes=pfTblOutXPassBytes, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfSrcTrackSearches=pfSrcTrackSearches, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfLimitMaxTables=pfLimitMaxTables, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfCntCongestion=pfCntCongestion, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTblAddrCleared=pfTblAddrCleared, PYSNMP_MODULE_ID=pfMIBObjects, pfIfDescr=pfIfDescr, pfTblInMatchBytes=pfTblInMatchBytes, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfLimitSourceNodes=pfLimitSourceNodes, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTblOutMatchPkts=pfTblOutMatchPkts, pfLabelEvals=pfLabelEvals, pfStateSearches=pfStateSearches, pfInfo=pfInfo, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblInPassBytes=pfTblInPassBytes, pfRuntime=pfRuntime, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfLabelInBytes=pfLabelInBytes, pfTblAddrMask=pfTblAddrMask, pfLogInterface=pfLogInterface, pfTblEvalsMatch=pfTblEvalsMatch, pfLabelEntry=pfLabelEntry, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLabelOutBytes=pfLabelOutBytes, pfIfIndex=pfIfIndex, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTblIndex=pfTblIndex, pfTblInXPassPkts=pfTblInXPassPkts, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfLabelIndex=pfLabelIndex, pfCntSynproxy=pfCntSynproxy, pfCntIpOption=pfCntIpOption, pfSrcTrackCount=pfSrcTrackCount, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfIfTable=pfIfTable, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfIfNumber=pfIfNumber, pfLabelPkts=pfLabelPkts, pfLabelNumber=pfLabelNumber, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLabelName=pfLabelName, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfIfEntry=pfIfEntry, pfCounters=pfCounters, pfLimitFragments=pfLimitFragments, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTblInPassPkts=pfTblInPassPkts, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfCntShort=pfCntShort, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfCntFragment=pfCntFragment, pfTblAddrTable=pfTblAddrTable, pfIfType=pfIfType, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfCntTimestamp=pfCntTimestamp, pfIfRefs=pfIfRefs, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTblInMatchPkts=pfTblInMatchPkts, pfCntStateLimit=pfCntStateLimit, pfSrcTracking=pfSrcTracking, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTblAddrEntry=pfTblAddrEntry, pfTblName=pfTblName, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfCntNormalize=pfCntNormalize, pfCntProtoCksum=pfCntProtoCksum, pfCntMatch=pfCntMatch, pfStateTable=pfStateTable, pfTimeoutFragment=pfTimeoutFragment, pfTblOutBlockPkts=pfTblOutBlockPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblAddresses=pfTblAddresses)
