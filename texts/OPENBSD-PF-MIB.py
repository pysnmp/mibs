...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTblOutXPassPkts=pfTblOutXPassPkts, pfCntIpOption=pfCntIpOption, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfIfDescr=pfIfDescr, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTimeoutIcmpError=pfTimeoutIcmpError, pfLimitSourceNodes=pfLimitSourceNodes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfCntShort=pfCntShort, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfLabelNumber=pfLabelNumber, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTblAddrTable=pfTblAddrTable, pfLabelInBytes=pfLabelInBytes, pfsyncOutputErrors=pfsyncOutputErrors, pfIfType=pfIfType, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTables=pfTables, pfTblInMatchPkts=pfTblInMatchPkts, pfTblTable=pfTblTable, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblEntry=pfTblEntry, pfLabels=pfLabels, pfIfRules=pfIfRules, pfHostid=pfHostid, pfCntNoRoute=pfCntNoRoute, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfCntNormalize=pfCntNormalize, pfTblInBlockBytes=pfTblInBlockBytes, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfCntTranslate=pfCntTranslate, pfLimitMaxTables=pfLimitMaxTables, pfIfIn6PassBytes=pfIfIn6PassBytes, pfInfo=pfInfo, pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblNumber=pfTblNumber, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfCntCongestion=pfCntCongestion, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfCntMatch=pfCntMatch, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfsyncStats=pfsyncStats, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTblAddrTblIndex=pfTblAddrTblIndex, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfTblAddresses=pfTblAddresses, pfTblOutPassBytes=pfTblOutPassBytes, pfTblOutBlockPkts=pfTblOutBlockPkts, pfLimits=pfLimits, pfTblEvalsMatch=pfTblEvalsMatch, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfsyncIpPktsSent=pfsyncIpPktsSent, pfLabelTable=pfLabelTable, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblInXPassPkts=pfTblInXPassPkts, pfLabelEntry=pfLabelEntry, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfRuntime=pfRuntime, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfDebug=pfDebug, pfTimeoutInterval=pfTimeoutInterval, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfIfTable=pfIfTable, pfStateRemovals=pfStateRemovals, pfTblOutPassPkts=pfTblOutPassPkts, pfInterfaces=pfInterfaces, pfIfRefs=pfIfRefs, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfIfIndex=pfIfIndex, pfCntTimestamp=pfCntTimestamp, pfTimeoutTcpClosed=pfTimeoutTcpClosed, PYSNMP_MODULE_ID=pfMIBObjects, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblOutBlockBytes=pfTblOutBlockBytes, pfCntBadOffset=pfCntBadOffset, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTimeoutFragment=pfTimeoutFragment, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfCntStateMismatch=pfCntStateMismatch, pfTblRuleRefs=pfTblRuleRefs, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblAddrNet=pfTblAddrNet, pfSrcTrackCount=pfSrcTrackCount, pfLabelName=pfLabelName, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTblInMatchBytes=pfTblInMatchBytes, pfCntSrcLimit=pfCntSrcLimit, pfTblInXPassBytes=pfTblInXPassBytes, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfLabelOutPkts=pfLabelOutPkts, pfCntStateInsert=pfCntStateInsert, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfLabelIndex=pfLabelIndex, pfIfEntry=pfIfEntry, pfLabelTotalStates=pfLabelTotalStates, pfStateInserts=pfStateInserts, pfLabelEvals=pfLabelEvals, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfLabelBytes=pfLabelBytes, pfsyncNoMemory=pfsyncNoMemory, pfIfOut4PassBytes=pfIfOut4PassBytes, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfLabelPkts=pfLabelPkts, pfRunning=pfRunning, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblName=pfTblName, pfCounters=pfCounters, pfLimitFragments=pfLimitFragments, pfTimeouts=pfTimeouts, pfTblInBlockPkts=pfTblInBlockPkts, pfTblAddrEntry=pfTblAddrEntry, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfSrcTrackSearches=pfSrcTrackSearches, pfIfOut4PassPkts=pfIfOut4PassPkts, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfCntStateLimit=pfCntStateLimit, pfCntSynproxy=pfCntSynproxy, pfMIBObjects=pfMIBObjects, pfIfNumber=pfIfNumber, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblAddrMask=pfTblAddrMask, pfStateCount=pfStateCount, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfSrcTrackRemovals=pfSrcTrackRemovals, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblInPassPkts=pfTblInPassPkts, pfCntProtoCksum=pfCntProtoCksum, pfTblInPassBytes=pfTblInPassBytes, pfStateTable=pfStateTable, pfTblAnchorRefs=pfTblAnchorRefs, pfCntMemory=pfCntMemory, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfLimitStates=pfLimitStates, pfStateSearches=pfStateSearches, pfSrcTrackInserts=pfSrcTrackInserts, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblStatsCleared=pfTblStatsCleared, pfSrcTracking=pfSrcTracking, pfTblIndex=pfTblIndex, pfTblOutMatchPkts=pfTblOutMatchPkts, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfLogIfName=pfLogIfName, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfLabelInPkts=pfLabelInPkts, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblAddrCleared=pfTblAddrCleared, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfCntFragment=pfCntFragment, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfLogInterface=pfLogInterface, pfIfIn6PassPkts=pfIfIn6PassPkts, pfLabelOutBytes=pfLabelOutBytes, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn)
