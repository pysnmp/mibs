...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfCntStateLimit=pfCntStateLimit, pfIfIndex=pfIfIndex, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfIfIn6PassPkts=pfIfIn6PassPkts, pfCntFragment=pfCntFragment, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblOutXPassPkts=pfTblOutXPassPkts, pfCntBadOffset=pfCntBadOffset, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfIfNumber=pfIfNumber, PYSNMP_MODULE_ID=pfMIBObjects, pfCntTranslate=pfCntTranslate, pfIfOut4PassPkts=pfIfOut4PassPkts, pfIfType=pfIfType, pfCntNoRoute=pfCntNoRoute, pfTblInXPassPkts=pfTblInXPassPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfLabels=pfLabels, pfTblOutMatchPkts=pfTblOutMatchPkts, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfsyncNoMemory=pfsyncNoMemory, pfLabelNumber=pfLabelNumber, pfLimitMaxTables=pfLimitMaxTables, pfTblAddrCleared=pfTblAddrCleared, pfLabelName=pfLabelName, pfsyncOutputErrors=pfsyncOutputErrors, pfLabelOutBytes=pfLabelOutBytes, pfHostid=pfHostid, pfIfRefs=pfIfRefs, pfTblAddrTable=pfTblAddrTable, pfLabelTable=pfLabelTable, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTblTable=pfTblTable, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfLabelOutPkts=pfLabelOutPkts, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfMIBObjects=pfMIBObjects, pfSrcTracking=pfSrcTracking, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblAddrEntry=pfTblAddrEntry, pfTblOutPassPkts=pfTblOutPassPkts, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTblAddrNet=pfTblAddrNet, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfInfo=pfInfo, pfTables=pfTables, pfsyncStats=pfsyncStats, pfCntStateInsert=pfCntStateInsert, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfSrcTrackInserts=pfSrcTrackInserts, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfIfTable=pfIfTable, pfCntProtoCksum=pfCntProtoCksum, pfSrcTrackRemovals=pfSrcTrackRemovals, pfTimeoutFragment=pfTimeoutFragment, pfTimeouts=pfTimeouts, pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblName=pfTblName, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblAddresses=pfTblAddresses, pfTblRuleRefs=pfTblRuleRefs, pfIfOut6PassPkts=pfIfOut6PassPkts, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfCntShort=pfCntShort, pfLimits=pfLimits, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfTblEntry=pfTblEntry, pfTblInPassPkts=pfTblInPassPkts, pfTblAnchorRefs=pfTblAnchorRefs, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfStateSearches=pfStateSearches, pfCntSynproxy=pfCntSynproxy, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfSrcTrackCount=pfSrcTrackCount, pfStateCount=pfStateCount, pfLabelIndex=pfLabelIndex, pfCntTimestamp=pfCntTimestamp, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfDebug=pfDebug, pfStateInserts=pfStateInserts, pfLabelBytes=pfLabelBytes, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfRunning=pfRunning, pfTblStatsCleared=pfTblStatsCleared, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfLogIfName=pfLogIfName, pfTblEvalsMatch=pfTblEvalsMatch, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTimeoutIcmpError=pfTimeoutIcmpError, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTblAddrTblIndex=pfTblAddrTblIndex, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTblOutPassBytes=pfTblOutPassBytes, pfTblInXPassBytes=pfTblInXPassBytes, pfTblInPassBytes=pfTblInPassBytes, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblIndex=pfTblIndex, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTimeoutInterval=pfTimeoutInterval, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfCntMemory=pfCntMemory, pfLabelEvals=pfLabelEvals, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfSrcTrackSearches=pfSrcTrackSearches, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfIfDescr=pfIfDescr, pfLimitStates=pfLimitStates, pfTblInMatchPkts=pfTblInMatchPkts, pfCntNormalize=pfCntNormalize, pfCntIpOption=pfCntIpOption, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLogInterface=pfLogInterface, pfRuntime=pfRuntime, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfLabelInBytes=pfLabelInBytes, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfLimitSourceNodes=pfLimitSourceNodes, pfTblNumber=pfTblNumber, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfLimitFragments=pfLimitFragments, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfLabelPkts=pfLabelPkts, pfsyncIpPktsSent=pfsyncIpPktsSent, pfCntStateMismatch=pfCntStateMismatch, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfLabelInPkts=pfLabelInPkts, pfCntMatch=pfCntMatch, pfStateTable=pfStateTable, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfCntCongestion=pfCntCongestion, pfCounters=pfCounters, pfCntSrcLimit=pfCntSrcLimit, pfInterfaces=pfInterfaces, pfTblAddrMask=pfTblAddrMask, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfLabelEntry=pfLabelEntry, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblInBlockPkts=pfTblInBlockPkts, pfTblInBlockBytes=pfTblInBlockBytes, pfStateRemovals=pfStateRemovals, pfIfRules=pfIfRules, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfIfEntry=pfIfEntry, pfTblInMatchBytes=pfTblInMatchBytes, pfLabelTotalStates=pfLabelTotalStates, pfTblOutBlockPkts=pfTblOutBlockPkts, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop)
