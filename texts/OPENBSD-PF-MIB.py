...
enterprises, Bits, Counter64, Unsigned32, MibIdentifier, ModuleIdentity, iso, ObjectIdentity, TimeTicks, IpAddress, Gauge32, Integer32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Counter64", "Unsigned32", "MibIdentifier", "ModuleIdentity", "iso", "ObjectIdentity", "TimeTicks", "IpAddress", "Gauge32", "Integer32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfType=pfIfType, pfTblAddrTable=pfTblAddrTable, pfTblName=pfTblName, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfStateTable=pfStateTable, pfTblAnchorRefs=pfTblAnchorRefs, pfTblOutBlockPkts=pfTblOutBlockPkts, pfLabelEvals=pfLabelEvals, pfLabelOutPkts=pfLabelOutPkts, pfLabelIndex=pfLabelIndex, pfCntSynproxy=pfCntSynproxy, pfLimitStates=pfLimitStates, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfDebug=pfDebug, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfTblEntry=pfTblEntry, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblAddrTblIndex=pfTblAddrTblIndex, pfCntIpOption=pfCntIpOption, pfLabelTotalStates=pfLabelTotalStates, pfIfRefs=pfIfRefs, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTblOutBlockBytes=pfTblOutBlockBytes, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfCntSrcLimit=pfCntSrcLimit, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfIfIndex=pfIfIndex, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfsyncStats=pfsyncStats, pfIfRules=pfIfRules, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblInMatchPkts=pfTblInMatchPkts, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfLabelName=pfLabelName, pfCntStateMismatch=pfCntStateMismatch, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfSrcTrackRemovals=pfSrcTrackRemovals, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblOutPassBytes=pfTblOutPassBytes, pfCntStateInsert=pfCntStateInsert, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfTimeoutIcmpError=pfTimeoutIcmpError, pfIfDescr=pfIfDescr, pfTblInBlockBytes=pfTblInBlockBytes, pfCntFragment=pfCntFragment, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLimitSourceNodes=pfLimitSourceNodes, pfStateRemovals=pfStateRemovals, pfCntMemory=pfCntMemory, pfTblInMatchBytes=pfTblInMatchBytes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfIfIn6PassBytes=pfIfIn6PassBytes, pfSrcTracking=pfSrcTracking, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfsyncNoMemory=pfsyncNoMemory, pfCntTranslate=pfCntTranslate, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfCntBadOffset=pfCntBadOffset, pfIfNumber=pfIfNumber, pfLimitFragments=pfLimitFragments, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTimeoutInterval=pfTimeoutInterval, pfCntTimestamp=pfCntTimestamp, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblInPassBytes=pfTblInPassBytes, pfIfEntry=pfIfEntry, pfIfIn4PassBytes=pfIfIn4PassBytes, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfLabelOutBytes=pfLabelOutBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTblAddrNet=pfTblAddrNet, pfsyncIpPktsSent=pfsyncIpPktsSent, pfLimitMaxTables=pfLimitMaxTables, pfStateCount=pfStateCount, pfTblRuleRefs=pfTblRuleRefs, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTblAddresses=pfTblAddresses, pfStateInserts=pfStateInserts, pfSrcTrackInserts=pfSrcTrackInserts, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfIfOut4PassPkts=pfIfOut4PassPkts, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfMIBObjects=pfMIBObjects, pfTables=pfTables, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfIfOut6PassPkts=pfIfOut6PassPkts, pfLabels=pfLabels, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfTblNumber=pfTblNumber, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfTblEvalsMatch=pfTblEvalsMatch, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblInBlockPkts=pfTblInBlockPkts, pfTblAddrEntry=pfTblAddrEntry, pfTblInPassPkts=pfTblInPassPkts, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, PYSNMP_MODULE_ID=pfMIBObjects, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTimeoutFragment=pfTimeoutFragment, pfLabelInPkts=pfLabelInPkts, pfCntMatch=pfCntMatch, pfIfIn4PassPkts=pfIfIn4PassPkts, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfLimits=pfLimits, pfCntProtoCksum=pfCntProtoCksum, pfCntNoRoute=pfCntNoRoute, pfInfo=pfInfo, pfCntShort=pfCntShort, pfTblIndex=pfTblIndex, pfInterfaces=pfInterfaces, pfTblTable=pfTblTable, pfLabelNumber=pfLabelNumber, pfTblAddrCleared=pfTblAddrCleared, pfLabelPkts=pfLabelPkts, pfTblAddrMask=pfTblAddrMask, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblInXPassBytes=pfTblInXPassBytes, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLogIfName=pfLogIfName, pfSrcTrackSearches=pfSrcTrackSearches, pfCntCongestion=pfCntCongestion, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfSrcTrackCount=pfSrcTrackCount, pfHostid=pfHostid, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfLabelEntry=pfLabelEntry, pfsyncOutputErrors=pfsyncOutputErrors, pfIfTable=pfIfTable, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTblInXPassPkts=pfTblInXPassPkts, pfTimeouts=pfTimeouts, pfLogInterface=pfLogInterface, pfStateSearches=pfStateSearches, pfLabelBytes=pfLabelBytes, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfCntStateLimit=pfCntStateLimit, pfIfIn6PassPkts=pfIfIn6PassPkts, pfRuntime=pfRuntime, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfLabelTable=pfLabelTable, pfRunning=pfRunning, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTblOutPassPkts=pfTblOutPassPkts, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblStatsCleared=pfTblStatsCleared, pfLabelInBytes=pfLabelInBytes, pfTblOutMatchPkts=pfTblOutMatchPkts, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfCntNormalize=pfCntNormalize, pfCounters=pfCounters)
