...
Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, NotificationType, iso, ModuleIdentity, Gauge32, ObjectIdentity, Counter64, Counter32, MibIdentifier, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "NotificationType", "iso", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "Counter32", "MibIdentifier", "enterprises", "Bits")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTblStatsCleared=pfTblStatsCleared, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfStateTable=pfStateTable, pfCntStateLimit=pfCntStateLimit, pfIfNumber=pfIfNumber, pfTblInXPassPkts=pfTblInXPassPkts, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfCntStateMismatch=pfCntStateMismatch, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTblRuleRefs=pfTblRuleRefs, pfLabelTable=pfLabelTable, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfStateSearches=pfStateSearches, pfIfOut4PassPkts=pfIfOut4PassPkts, pfCntNoRoute=pfCntNoRoute, pfIfOut6PassPkts=pfIfOut6PassPkts, pfLabelBytes=pfLabelBytes, pfTblInBlockPkts=pfTblInBlockPkts, pfsyncOutputErrors=pfsyncOutputErrors, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblAddrEntry=pfTblAddrEntry, pfLabelNumber=pfLabelNumber, pfIfIn6PassPkts=pfIfIn6PassPkts, pfStateRemovals=pfStateRemovals, pfTblOutPassPkts=pfTblOutPassPkts, pfLimits=pfLimits, pfCntFragment=pfCntFragment, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblAnchorRefs=pfTblAnchorRefs, pfLabelOutPkts=pfLabelOutPkts, pfLabelOutBytes=pfLabelOutBytes, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfMIBObjects=pfMIBObjects, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTblAddrNet=pfTblAddrNet, pfCntTimestamp=pfCntTimestamp, pfInterfaces=pfInterfaces, pfIfTable=pfIfTable, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfLimitMaxTables=pfLimitMaxTables, pfInfo=pfInfo, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfsyncNoMemory=pfsyncNoMemory, pfLabelName=pfLabelName, pfIfIn4PassBytes=pfIfIn4PassBytes, pfIfOut4PassBytes=pfIfOut4PassBytes, pfLimitFragments=pfLimitFragments, pfCounters=pfCounters, pfTblAddrCleared=pfTblAddrCleared, pfTblInPassBytes=pfTblInPassBytes, pfCntShort=pfCntShort, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTimeoutInterval=pfTimeoutInterval, pfLabelInBytes=pfLabelInBytes, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfSrcTracking=pfSrcTracking, pfLimitStates=pfLimitStates, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfCntProtoCksum=pfCntProtoCksum, pfCntMatch=pfCntMatch, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfLabelTotalStates=pfLabelTotalStates, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTblInMatchPkts=pfTblInMatchPkts, pfLabels=pfLabels, pfsyncStats=pfsyncStats, pfTimeoutFragment=pfTimeoutFragment, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfCntCongestion=pfCntCongestion, pfLimitSourceNodes=pfLimitSourceNodes, pfDebug=pfDebug, pfStateInserts=pfStateInserts, pfIfIn4PassPkts=pfIfIn4PassPkts, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfHostid=pfHostid, pfIfType=pfIfType, pfTblOutPassBytes=pfTblOutPassBytes, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfLogInterface=pfLogInterface, pfSrcTrackSearches=pfSrcTrackSearches, pfLabelEvals=pfLabelEvals, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfTblOutMatchPkts=pfTblOutMatchPkts, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTblEntry=pfTblEntry, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfSrcTrackInserts=pfSrcTrackInserts, pfTblIndex=pfTblIndex, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfCntNormalize=pfCntNormalize, pfTimeouts=pfTimeouts, pfTimeoutIcmpError=pfTimeoutIcmpError, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfRunning=pfRunning, pfRuntime=pfRuntime, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblInBlockBytes=pfTblInBlockBytes, pfTblOutXPassBytes=pfTblOutXPassBytes, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblTable=pfTblTable, pfsyncIpPktsSent=pfsyncIpPktsSent, pfIfIn4BlockPkts=pfIfIn4BlockPkts, PYSNMP_MODULE_ID=pfMIBObjects, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfTblNumber=pfTblNumber, pfLabelEntry=pfLabelEntry, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfStateCount=pfStateCount, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfCntMemory=pfCntMemory, pfCntSrcLimit=pfCntSrcLimit, pfIfDescr=pfIfDescr, pfIfIndex=pfIfIndex, pfTblName=pfTblName, pfCntTranslate=pfCntTranslate, pfCntStateInsert=pfCntStateInsert, pfTblAddresses=pfTblAddresses, pfCntIpOption=pfCntIpOption, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfTblInXPassBytes=pfTblInXPassBytes, pfLabelPkts=pfLabelPkts, pfSrcTrackRemovals=pfSrcTrackRemovals, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTblOutBlockPkts=pfTblOutBlockPkts, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfTblEvalsMatch=pfTblEvalsMatch, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfIfRules=pfIfRules, pfSrcTrackCount=pfSrcTrackCount, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfLogIfName=pfLogIfName, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblInMatchBytes=pfTblInMatchBytes, pfCntSynproxy=pfCntSynproxy, pfLabelIndex=pfLabelIndex, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfIfEntry=pfIfEntry, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfIfRefs=pfIfRefs, pfLabelInPkts=pfLabelInPkts, pfCntBadOffset=pfCntBadOffset, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTblAddrTable=pfTblAddrTable, pfTblOutBlockBytes=pfTblOutBlockBytes, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTblInPassPkts=pfTblInPassPkts, pfTables=pfTables, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblAddrMask=pfTblAddrMask, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes)
