...
Gauge32, enterprises, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, IpAddress, ObjectIdentity, Counter64, MibIdentifier, TimeTicks, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "IpAddress", "ObjectIdentity", "Counter64", "MibIdentifier", "TimeTicks", "iso", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfCntMemory=pfCntMemory, pfIfOut6PassBytes=pfIfOut6PassBytes, pfLabelInPkts=pfLabelInPkts, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfIfTable=pfIfTable, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTblInMatchPkts=pfTblInMatchPkts, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblTable=pfTblTable, pfCntBadOffset=pfCntBadOffset, pfIfDescr=pfIfDescr, pfsyncIpPktsSent=pfsyncIpPktsSent, pfTables=pfTables, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfIfRefs=pfIfRefs, pfCntStateLimit=pfCntStateLimit, pfIfIndex=pfIfIndex, pfTblAddresses=pfTblAddresses, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfLabelPkts=pfLabelPkts, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblStatsCleared=pfTblStatsCleared, pfHostid=pfHostid, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfLabelInBytes=pfLabelInBytes, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfTblAddrCleared=pfTblAddrCleared, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfLogInterface=pfLogInterface, pfLabelOutPkts=pfLabelOutPkts, pfCntProtoCksum=pfCntProtoCksum, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblName=pfTblName, pfLimitMaxTables=pfLimitMaxTables, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfCntSrcLimit=pfCntSrcLimit, pfCntMatch=pfCntMatch, pfTblAddrEntry=pfTblAddrEntry, pfCounters=pfCounters, pfTblNumber=pfTblNumber, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfInterfaces=pfInterfaces, pfLimits=pfLimits, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfCntTranslate=pfCntTranslate, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfLabelEvals=pfLabelEvals, pfStateRemovals=pfStateRemovals, pfTblAddrTable=pfTblAddrTable, pfTblInBlockBytes=pfTblInBlockBytes, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfIfType=pfIfType, pfLabelNumber=pfLabelNumber, pfTblOutPassBytes=pfTblOutPassBytes, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfIfOut6PassPkts=pfIfOut6PassPkts, pfSrcTrackInserts=pfSrcTrackInserts, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfCntNormalize=pfCntNormalize, pfLabelTotalStates=pfLabelTotalStates, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTblAddrNet=pfTblAddrNet, pfSrcTrackCount=pfSrcTrackCount, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfsyncStats=pfsyncStats, pfTimeoutInterval=pfTimeoutInterval, pfLabelOutBytes=pfLabelOutBytes, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfTblInMatchBytes=pfTblInMatchBytes, pfsyncNoMemory=pfsyncNoMemory, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfStateInserts=pfStateInserts, pfMIBObjects=pfMIBObjects, pfTblEntry=pfTblEntry, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfCntIpOption=pfCntIpOption, pfTblOutBlockBytes=pfTblOutBlockBytes, pfInfo=pfInfo, pfRuntime=pfRuntime, pfIfIn4PassBytes=pfIfIn4PassBytes, pfTblOutMatchPkts=pfTblOutMatchPkts, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfLabelTable=pfLabelTable, pfStateCount=pfStateCount, pfTblOutPassPkts=pfTblOutPassPkts, pfStateSearches=pfStateSearches, pfLogIfName=pfLogIfName, pfTimeouts=pfTimeouts, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTblAddrMask=pfTblAddrMask, pfIfRules=pfIfRules, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfTblAddrTblIndex=pfTblAddrTblIndex, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfTblEvalsMatch=pfTblEvalsMatch, pfSrcTrackRemovals=pfSrcTrackRemovals, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfTblInXPassBytes=pfTblInXPassBytes, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfIfEntry=pfIfEntry, pfTblRuleRefs=pfTblRuleRefs, pfTblAnchorRefs=pfTblAnchorRefs, pfStateTable=pfStateTable, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfCntSynproxy=pfCntSynproxy, pfLimitSourceNodes=pfLimitSourceNodes, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfCntNoRoute=pfCntNoRoute, pfCntShort=pfCntShort, pfIfNumber=pfIfNumber, pfTblOutBlockPkts=pfTblOutBlockPkts, PYSNMP_MODULE_ID=pfMIBObjects, pfLabelBytes=pfLabelBytes, pfTblInBlockPkts=pfTblInBlockPkts, pfDebug=pfDebug, pfIfOut4PassPkts=pfIfOut4PassPkts, pfCntCongestion=pfCntCongestion, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfSrcTrackSearches=pfSrcTrackSearches, pfIfIn4PassPkts=pfIfIn4PassPkts, pfCntTimestamp=pfCntTimestamp, pfLimitFragments=pfLimitFragments, pfCntStateMismatch=pfCntStateMismatch, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTblInPassBytes=pfTblInPassBytes, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfsyncOutputErrors=pfsyncOutputErrors, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfTblInPassPkts=pfTblInPassPkts, pfTblOutMatchBytes=pfTblOutMatchBytes, pfLimitStates=pfLimitStates, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTimeoutFragment=pfTimeoutFragment, pfLabelEntry=pfLabelEntry, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfTblInXPassPkts=pfTblInXPassPkts, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfRunning=pfRunning, pfCntStateInsert=pfCntStateInsert, pfLabelName=pfLabelName, pfLabels=pfLabels, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfLabelIndex=pfLabelIndex, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfCntFragment=pfCntFragment, pfTblIndex=pfTblIndex, pfSrcTracking=pfSrcTracking, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader)
