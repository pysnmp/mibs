...
Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Bits, Counter32, Unsigned32, TimeTicks, NotificationType, ModuleIdentity, Counter64, ObjectIdentity, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Bits", "Counter32", "Unsigned32", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfIfIn4PassPkts=pfIfIn4PassPkts, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfSrcTrackRemovals=pfSrcTrackRemovals, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfSrcTrackInserts=pfSrcTrackInserts, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfTblInBlockBytes=pfTblInBlockBytes, pfTimeoutIcmpError=pfTimeoutIcmpError, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfTblNumber=pfTblNumber, pfCntTimestamp=pfCntTimestamp, pfLimitFragments=pfLimitFragments, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfLimitStates=pfLimitStates, pfIfOut4PassBytes=pfIfOut4PassBytes, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfCntSynproxy=pfCntSynproxy, pfTblName=pfTblName, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfCntStateInsert=pfCntStateInsert, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfCounters=pfCounters, pfLogInterface=pfLogInterface, pfTblAddrEntry=pfTblAddrEntry, pfRuntime=pfRuntime, pfLabelPkts=pfLabelPkts, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfTimeoutFragment=pfTimeoutFragment, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblOutBlockPkts=pfTblOutBlockPkts, pfStateTable=pfStateTable, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfTblAnchorRefs=pfTblAnchorRefs, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfIfDescr=pfIfDescr, pfTblTable=pfTblTable, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTblOutXPassPkts=pfTblOutXPassPkts, pfLabels=pfLabels, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfTblAddrInPassBytes=pfTblAddrInPassBytes, PYSNMP_MODULE_ID=pfMIBObjects, pfsyncOutputErrors=pfsyncOutputErrors, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfTblAddrTable=pfTblAddrTable, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblInXPassBytes=pfTblInXPassBytes, pfIfNumber=pfIfNumber, pfTblOutMatchPkts=pfTblOutMatchPkts, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblOutBlockBytes=pfTblOutBlockBytes, pfCntMemory=pfCntMemory, pfCntStateMismatch=pfCntStateMismatch, pfLimitMaxTables=pfLimitMaxTables, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfLabelOutPkts=pfLabelOutPkts, pfIfIndex=pfIfIndex, pfTblInPassPkts=pfTblInPassPkts, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTables=pfTables, pfIfIn4PassBytes=pfIfIn4PassBytes, pfLabelOutBytes=pfLabelOutBytes, pfSrcTrackSearches=pfSrcTrackSearches, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfCntBadOffset=pfCntBadOffset, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblEntry=pfTblEntry, pfLimitSourceNodes=pfLimitSourceNodes, pfLabelEntry=pfLabelEntry, pfLabelEvals=pfLabelEvals, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfTblAddrCleared=pfTblAddrCleared, pfTblOutPassPkts=pfTblOutPassPkts, pfMIBObjects=pfMIBObjects, pfTblInMatchPkts=pfTblInMatchPkts, pfDebug=pfDebug, pfIfEntry=pfIfEntry, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfTimeoutInterval=pfTimeoutInterval, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfsyncNoMemory=pfsyncNoMemory, pfTblEvalsMatch=pfTblEvalsMatch, pfTblAddrMask=pfTblAddrMask, pfLabelInPkts=pfLabelInPkts, pfLabelInBytes=pfLabelInBytes, pfCntStateLimit=pfCntStateLimit, pfHostid=pfHostid, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfSrcTrackCount=pfSrcTrackCount, pfIfIn6PassPkts=pfIfIn6PassPkts, pfTblOutPassBytes=pfTblOutPassBytes, pfInterfaces=pfInterfaces, pfCntShort=pfCntShort, pfLabelIndex=pfLabelIndex, pfRunning=pfRunning, pfStateInserts=pfStateInserts, pfTblOutXPassBytes=pfTblOutXPassBytes, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfLimits=pfLimits, pfLabelTotalStates=pfLabelTotalStates, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfCntFragment=pfCntFragment, pfLabelName=pfLabelName, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfTblStatsCleared=pfTblStatsCleared, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfCntIpOption=pfCntIpOption, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfIfRefs=pfIfRefs, pfStateRemovals=pfStateRemovals, pfCntNormalize=pfCntNormalize, pfInfo=pfInfo, pfCntProtoCksum=pfCntProtoCksum, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfIfRules=pfIfRules, pfStateCount=pfStateCount, pfIfTable=pfIfTable, pfTblInXPassPkts=pfTblInXPassPkts, pfTimeouts=pfTimeouts, pfIfIn6PassBytes=pfIfIn6PassBytes, pfStateSearches=pfStateSearches, pfTblInPassBytes=pfTblInPassBytes, pfIfType=pfIfType, pfCntCongestion=pfCntCongestion, pfSrcTracking=pfSrcTracking, pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfLabelBytes=pfLabelBytes, pfTblAddrNet=pfTblAddrNet, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfCntTranslate=pfCntTranslate, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfCntNoRoute=pfCntNoRoute, pfLabelTable=pfLabelTable, pfTblIndex=pfTblIndex, pfTblRuleRefs=pfTblRuleRefs, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfsyncStats=pfsyncStats, pfCntSrcLimit=pfCntSrcLimit, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTblOutMatchBytes=pfTblOutMatchBytes, pfLogIfName=pfLogIfName, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTblAddresses=pfTblAddresses, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfLabelNumber=pfLabelNumber, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfIfOut4PassPkts=pfIfOut4PassPkts, pfCntMatch=pfCntMatch, pfTblInBlockPkts=pfTblInBlockPkts, pfTblInMatchBytes=pfTblInMatchBytes, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfsyncIpPktsSent=pfsyncIpPktsSent)
