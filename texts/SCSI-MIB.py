...
NotificationType, ModuleIdentity, Gauge32, MibIdentifier, Integer32, Bits, TimeTicks, Counter64, Unsigned32, Counter32, IpAddress, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "IpAddress", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TruthValue, DisplayString, RowPointer, AutonomousType, RowStatus, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowPointer", "AutonomousType", "RowStatus", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiObjects=scsiObjects, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstAlias=scsiInstAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliances=scsiCompliances, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortEntry=scsiPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSBP=scsiTransportSBP, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunTable=scsiDscLunTable, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatus=scsiLuStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValue=ScsiIndexValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiLuProductId=scsiLuProductId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, PYSNMP_MODULE_ID=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiGeneral=scsiGeneral, scsiTgtDevTable=scsiTgtDevTable, scsiLuEntry=scsiLuEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdType=ScsiIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiator=scsiInitiator, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiModule=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLun=scsiLunMapLun, ScsiIdValue=ScsiIdValue, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiInstIndex=scsiInstIndex, scsiPortTable=scsiPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuState=scsiLuState, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrName=scsiAuthIntrName, scsiTarget=scsiTarget, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier)
