...
MibIdentifier, Unsigned32, Bits, Integer32, ModuleIdentity, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, ObjectIdentity, IpAddress, Counter64, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Bits", "Integer32", "ModuleIdentity", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter64", "mib-2", "Gauge32")
TruthValue, RowPointer, DisplayString, RowStatus, AutonomousType, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "DisplayString", "RowStatus", "AutonomousType", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiCompliances=scsiCompliances, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatus=scsiLuStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuProductId=scsiLuProductId, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiNotifications=scsiNotifications, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdValue=scsiLuIdValue, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortEntry=scsiPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiModule=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiObjects=scsiObjects, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiTranportSPI=scsiTranportSPI, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTargetGroup=scsiTargetGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTarget=scsiTarget, scsiLuIdType=scsiLuIdType, scsiTgtPortName=scsiTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLun=scsiLunMapLun, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInResets=scsiLuInResets, scsiRemoteTarget=scsiRemoteTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTable=scsiIntrDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiCompliance=scsiCompliance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdValue=ScsiIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuState=scsiLuState, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSRP=scsiTransportSRP, scsiDeviceResets=scsiDeviceResets, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdType=ScsiIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstanceTable=scsiInstanceTable, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, scsiConformance=scsiConformance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex)
