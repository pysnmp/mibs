...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrName=scsiAuthIntrName, scsiLunMapEntry=scsiLunMapEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortName=scsiTgtPortName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceRole=scsiDeviceRole, scsiLuIdEntry=scsiLuIdEntry, scsiLuState=scsiLuState, scsiLuWwnName=scsiLuWwnName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdType=ScsiIdType, scsiGroups=scsiGroups, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapTable=scsiLunMapTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptTable=scsiTrnsptTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSBP=scsiTransportSBP, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiName=ScsiName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiInitiator=scsiInitiator, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuEntry=scsiLuEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, scsiCompliance=scsiCompliance, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunEntry=scsiDscLunEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdValue=scsiLuIdValue, scsiLuProductId=scsiLuProductId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuVendorId=scsiLuVendorId, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportFCP=scsiTransportFCP, ScsiIdValue=ScsiIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstAlias=scsiInstAlias, PYSNMP_MODULE_ID=scsiModule, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiObjects=scsiObjects, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliances=scsiCompliances, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptEntry=scsiTrnsptEntry, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiNotifications=scsiNotifications, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiInstIndex=scsiInstIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiPortIndex=scsiPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiPortEntry=scsiPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes)
