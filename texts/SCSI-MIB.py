...
MibIdentifier, Integer32, Gauge32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, iso, ObjectIdentity, ModuleIdentity, TimeTicks, IpAddress, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Gauge32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "Counter32")
TimeStamp, TruthValue, AutonomousType, RowPointer, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "RowPointer", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortTable=scsiTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiModule=scsiModule, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapTable=scsiLunMapTable, scsiTranportOther=scsiTranportOther, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortTable=scsiPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuState=scsiLuState, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuTable=scsiLuTable, scsiCompliance=scsiCompliance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGeneral=scsiGeneral, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSBP=scsiTransportSBP, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSRP=scsiTransportSRP, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatus=scsiLuStatus, ScsiIdentifier=ScsiIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiCompliances=scsiCompliances, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunLun=scsiDscLunLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortIndex=scsiPortIndex, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTarget=scsiTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptTable=scsiTrnsptTable, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiator=scsiInitiator, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdType=scsiLuIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuProductId=scsiLuProductId, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiPortRole=scsiPortRole, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInCommands=scsiLuInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiConformance=scsiConformance, scsiLuEntry=scsiLuEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiLuDefaultLun=scsiLuDefaultLun, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation)
