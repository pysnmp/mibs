...
iso, Unsigned32, Counter64, ModuleIdentity, MibIdentifier, Gauge32, TimeTicks, NotificationType, Bits, Integer32, Counter32, mib_2, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter64", "ModuleIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "NotificationType", "Bits", "Integer32", "Counter32", "mib-2", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, RowStatus, TextualConvention, RowPointer, TruthValue, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TextualConvention", "RowPointer", "TruthValue", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInResets=scsiLuInResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliance=scsiCompliance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSRP=scsiTransportSRP, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGeneral=scsiGeneral, scsiDeviceTable=scsiDeviceTable, scsiDscLunLun=scsiDscLunLun, scsiTgtPortName=scsiTgtPortName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdType=ScsiIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortIndex=scsiPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdType=scsiLuIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiObjects=scsiObjects, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIndex=scsiLuIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunTable=scsiDscLunTable, scsiLuStatus=scsiLuStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiInstAlias=scsiInstAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiConformance=scsiConformance, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuState=scsiLuState, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportTypes=scsiTransportTypes, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceTable=scsiInstanceTable, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuRevisionId=scsiLuRevisionId, scsiGroups=scsiGroups, scsiLuIdIndex=scsiLuIdIndex, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceResets=scsiDeviceResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSBP=scsiTransportSBP, scsiLuProductId=scsiLuProductId, scsiInitiator=scsiInitiator, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuTable=scsiLuTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatusChanged=scsiLuStatusChanged, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdTable=scsiDscLunIdTable)
