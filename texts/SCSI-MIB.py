...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, Bits, Gauge32, ModuleIdentity, Integer32, NotificationType, Counter64, IpAddress, ObjectIdentity, TimeTicks, MibIdentifier, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "Bits", "Gauge32", "ModuleIdentity", "Integer32", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "TimeTicks", "MibIdentifier", "iso", "Unsigned32")
TruthValue, TimeStamp, DisplayString, TextualConvention, AutonomousType, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention", "AutonomousType", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuState=scsiLuState, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiLuInCommands=scsiLuInCommands, scsiLuEntry=scsiLuEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceTable=scsiInstanceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiCompliances=scsiCompliances, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotifications=scsiNotifications, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuVendorId=scsiLuVendorId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTarget=scsiTarget, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatus=scsiLuStatus, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiDeviceResets=scsiDeviceResets, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiConformance=scsiConformance, scsiTgtPortName=scsiTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortRole=scsiPortRole, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstAlias=scsiInstAlias, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, ScsiName=ScsiName, scsiPortEntry=scsiPortEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiModule=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptType=scsiTrnsptType, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdValue=scsiLuIdValue, scsiInitiator=scsiInitiator, ScsiIndexValue=ScsiIndexValue, scsiLuIdTable=scsiLuIdTable, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiTransportFCP=scsiTransportFCP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdAssociation=ScsiIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstIndex=scsiInstIndex, scsiPortIndex=scsiPortIndex, scsiDeviceTable=scsiDeviceTable, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup)
