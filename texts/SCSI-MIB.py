...
NotificationType, Unsigned32, Counter32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, TimeTicks, IpAddress, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Bits")
TruthValue, RowPointer, DisplayString, TextualConvention, TimeStamp, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "DisplayString", "TextualConvention", "TimeStamp", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortRole=scsiPortRole, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuState=scsiLuState, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiModule=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdIndex=scsiLuIdIndex, scsiPortEntry=scsiPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTable=scsiPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportTypes=scsiTransportTypes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTranportOther=scsiTranportOther, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiConformance=scsiConformance, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceGroup=scsiDeviceGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevEntry=scsiTgtDevEntry, ScsiName=ScsiName, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiLuProductId=scsiLuProductId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTarget=scsiTarget, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiInstAlias=scsiInstAlias, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuInResets=scsiLuInResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdValue=scsiLuIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptType=scsiTrnsptType, scsiLuWwnName=scsiLuWwnName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapTable=scsiLunMapTable, scsiCompliance=scsiCompliance, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceResets=scsiDeviceResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortName=scsiTgtPortName, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiCompliances=scsiCompliances, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdValue=ScsiIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotifications=scsiNotifications, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuEntry=scsiLuEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, ScsiIdType=ScsiIdType, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuInCommands=scsiLuInCommands, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun)
