...
Counter64, Gauge32, iso, NotificationType, Bits, Counter32, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "iso", "NotificationType", "Bits", "Counter32", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity")
RowStatus, RowPointer, AutonomousType, TextualConvention, DisplayString, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "AutonomousType", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiConformance=scsiConformance, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIndexValue=ScsiIndexValue, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorGroup=scsiInitiatorGroup, scsiLogicalUnit=scsiLogicalUnit, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortName=scsiTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuInResets=scsiLuInResets, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliance=scsiCompliance, scsiLuWwnName=scsiLuWwnName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGeneral=scsiGeneral, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTarget=scsiTarget, scsiDscLunLun=scsiDscLunLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiLuIndex=scsiLuIndex, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiModule=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtName=scsiIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdType=scsiLuIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiNotifications=scsiNotifications, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceTable=scsiDeviceTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTable=scsiPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatus=scsiLuStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiGroups=scsiGroups, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdType=ScsiIdType, scsiPortRole=scsiPortRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdTable=scsiLuIdTable, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportOther=scsiTranportOther, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceRole=scsiDeviceRole, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiator=scsiInitiator, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuState=scsiLuState, scsiTargetGroup=scsiTargetGroup)
