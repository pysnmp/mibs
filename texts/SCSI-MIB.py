...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits, iso, MibIdentifier, Counter64, Unsigned32, ObjectIdentity, IpAddress, Integer32, Gauge32, NotificationType, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits", "iso", "MibIdentifier", "Counter64", "Unsigned32", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "NotificationType", "mib-2", "Counter32")
TimeStamp, TextualConvention, RowStatus, AutonomousType, RowPointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "AutonomousType", "RowPointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiCompliances=scsiCompliances, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiInstIndex=scsiInstIndex, scsiGroups=scsiGroups, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiator=scsiInitiator, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceRole=scsiDeviceRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptTable=scsiTrnsptTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotifications=scsiNotifications, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceResets=scsiDeviceResets, ScsiIndexValue=ScsiIndexValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuState=scsiLuState, scsiPortTable=scsiPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortName=scsiTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceAlias=scsiDeviceAlias, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiConformance=scsiConformance, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportSPI=scsiTranportSPI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortRole=scsiPortRole, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTarget=scsiTarget, scsiLunMapLun=scsiLunMapLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtName=scsiDscTgtName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, ScsiIdType=ScsiIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiModule=scsiModule, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIndex=scsiLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstAlias=scsiInstAlias, scsiInstanceTable=scsiInstanceTable, scsiTrnsptType=scsiTrnsptType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGeneral=scsiGeneral, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuInResets=scsiLuInResets, scsiTransportSBP=scsiTransportSBP, ScsiName=ScsiName, scsiLunMapTable=scsiLunMapTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscLunIdTable=scsiDscLunIdTable)
