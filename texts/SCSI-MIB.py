...
Gauge32, TimeTicks, Counter32, Integer32, Counter64, ObjectIdentity, ModuleIdentity, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, NotificationType, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Counter32", "Integer32", "Counter64", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "NotificationType", "Unsigned32", "iso")
RowPointer, TimeStamp, AutonomousType, TextualConvention, TruthValue, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention", "TruthValue", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuTable=scsiLuTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdValue=ScsiIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiLuIdValue=scsiLuIdValue, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, PYSNMP_MODULE_ID=scsiModule, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiInitiator=scsiInitiator, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetGroup=scsiTargetGroup, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSBP=scsiTransportSBP, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSRP=scsiTransportSRP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiLogicalUnit=scsiLogicalUnit, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiCompliance=scsiCompliance, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportTypes=scsiTransportTypes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstIndex=scsiInstIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiName=ScsiName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGeneral=scsiGeneral, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuProductId=scsiLuProductId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceResets=scsiDeviceResets, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceRole=scsiDeviceRole, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTranportOther=scsiTranportOther, scsiLuInResets=scsiLuInResets, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuEntry=scsiLuEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiDscLunLun=scsiDscLunLun, scsiInstAlias=scsiInstAlias, scsiIntrDevTable=scsiIntrDevTable, scsiPortTable=scsiPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiObjects=scsiObjects, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry)
