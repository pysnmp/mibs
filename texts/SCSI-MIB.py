...
ModuleIdentity, Counter32, Unsigned32, iso, Bits, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, mib_2, MibIdentifier, ObjectIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "Bits", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "mib-2", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Integer32")
TextualConvention, TimeStamp, TruthValue, RowStatus, RowPointer, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "RowStatus", "RowPointer", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuEntry=scsiLuEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliances=scsiCompliances, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunTable=scsiDscLunTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiator=scsiInitiator, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrName=scsiAuthIntrName, scsiTransportTypes=scsiTransportTypes, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdType=ScsiIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTranportOther=scsiTranportOther, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, ScsiIndexValue=ScsiIndexValue, scsiRemoteTarget=scsiRemoteTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiModule=scsiModule, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceTable=scsiDeviceTable, scsiTarget=scsiTarget, ScsiName=ScsiName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatus=scsiLuStatus, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiDeviceResets=scsiDeviceResets, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiObjects=scsiObjects, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdentifier=ScsiIdentifier, scsiPortIndex=scsiPortIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortName=scsiTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiInstAlias=scsiInstAlias, PYSNMP_MODULE_ID=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiConformance=scsiConformance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceRole=scsiDeviceRole, scsiLuState=scsiLuState, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiLuStatusChanged=scsiLuStatusChanged, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuTable=scsiLuTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtName=scsiAttIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes)
