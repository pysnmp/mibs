...
Bits, MibIdentifier, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, IpAddress, TimeTicks, Counter32, Counter64, iso, Gauge32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "IpAddress", "TimeTicks", "Counter32", "Counter64", "iso", "Gauge32", "ObjectIdentity", "Integer32")
RowPointer, RowStatus, TextualConvention, TimeStamp, DisplayString, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiName=ScsiName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortRole=scsiPortRole, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportSBP=scsiTransportSBP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiInstIndex=scsiInstIndex, scsiConformance=scsiConformance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuState=scsiLuState, scsiDeviceGroup=scsiDeviceGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortIndex=scsiPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTranportOther=scsiTranportOther, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrName=scsiAuthIntrName, scsiGeneral=scsiGeneral, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiLuTable=scsiLuTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiLuIdValue=scsiLuIdValue, scsiLuIndex=scsiLuIndex, scsiDeviceResets=scsiDeviceResets, scsiDeviceRole=scsiDeviceRole, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiator=scsiInitiator, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptDevName=scsiTrnsptDevName, scsiObjects=scsiObjects, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceTable=scsiInstanceTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapEntry=scsiLunMapEntry, scsiTranportSPI=scsiTranportSPI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiCompliances=scsiCompliances, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotifications=scsiNotifications, ScsiIdValue=ScsiIdValue, scsiLuProductId=scsiLuProductId, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue)
