...
mib_2, NotificationType, Counter32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Counter64, Integer32, Bits, ObjectIdentity, iso, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "Counter32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Counter64", "Integer32", "Bits", "ObjectIdentity", "iso", "Unsigned32", "IpAddress")
TimeStamp, TruthValue, AutonomousType, RowStatus, RowPointer, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "RowStatus", "RowPointer", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, PYSNMP_MODULE_ID=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortRole=scsiPortRole, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportSPI=scsiTranportSPI, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIndexValue=ScsiIndexValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportOther=scsiTranportOther, scsiDevicePortNumber=scsiDevicePortNumber, scsiTarget=scsiTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInCommands=scsiLuInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInResets=scsiLuInResets, ScsiIdentifier=ScsiIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuTable=scsiLuTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInstIndex=scsiInstIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTable=scsiPortTable, scsiGeneral=scsiGeneral, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiLuIndex=scsiLuIndex, ScsiName=ScsiName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiLuStatus=scsiLuStatus, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiConformance=scsiConformance, scsiModule=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiObjects=scsiObjects, ScsiIdType=ScsiIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportSRP=scsiTransportSRP, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstAlias=scsiInstAlias, scsiTransportTypes=scsiTransportTypes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdType=scsiLuIdType, scsiTargetGroup=scsiTargetGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuProductId=scsiLuProductId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceTable=scsiInstanceTable, scsiDscTgtName=scsiDscTgtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuWwnName=scsiLuWwnName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuState=scsiLuState, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex)
