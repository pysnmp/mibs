...
MibIdentifier, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Counter64, Integer32, ObjectIdentity, Bits, IpAddress, TimeTicks, NotificationType, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Counter64", "Integer32", "ObjectIdentity", "Bits", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32", "mib-2")
RowStatus, DisplayString, TextualConvention, AutonomousType, TimeStamp, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiInstIndex=scsiInstIndex, scsiPortRole=scsiPortRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportOther=scsiTranportOther, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuState=scsiLuState, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunLun=scsiDscLunLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdValue=scsiLuIdValue, scsiPortIndex=scsiPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuEntry=scsiLuEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdType=scsiLuIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGeneral=scsiGeneral, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiName=ScsiName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWwnName=scsiLuWwnName, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiTransportSBP=scsiTransportSBP, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiLuProductId=scsiLuProductId, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIndex=scsiLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortEntry=scsiPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuTable=scsiLuTable, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiDscTgtName=scsiDscTgtName, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptType=scsiTrnsptType, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, scsiConformance=scsiConformance, scsiObjects=scsiObjects, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliances=scsiCompliances, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliance=scsiCompliance, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, scsiDeviceGroup=scsiDeviceGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiModule=scsiModule, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValue=ScsiIndexValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceResets=scsiDeviceResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatus=scsiLuStatus, scsiLunMapIndex=scsiLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtName=scsiAttIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured)
