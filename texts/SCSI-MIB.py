...
Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter32, Unsigned32, mib_2, Integer32, Bits, ModuleIdentity, ObjectIdentity, MibIdentifier, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter32", "Unsigned32", "mib-2", "Integer32", "Bits", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "NotificationType", "IpAddress")
DisplayString, RowStatus, RowPointer, AutonomousType, TimeStamp, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "RowPointer", "AutonomousType", "TimeStamp", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiConformance=scsiConformance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptType=scsiTrnsptType, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortIndex=scsiPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiLuTable=scsiLuTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportTypes=scsiTransportTypes, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, scsiLuInResets=scsiLuInResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiGroups=scsiGroups, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiLunMapIndex=scsiLunMapIndex, ScsiName=ScsiName, scsiInitiator=scsiInitiator, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiInstanceTable=scsiInstanceTable, scsiPortRole=scsiPortRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSBP=scsiTransportSBP, scsiTranportOther=scsiTranportOther, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceRole=scsiDeviceRole, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotifications=scsiNotifications, ScsiIdentifier=ScsiIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceEntry=scsiDeviceEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdType=scsiLuIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiObjects=scsiObjects, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceTable=scsiDeviceTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, PYSNMP_MODULE_ID=scsiModule, scsiTransportFCP=scsiTransportFCP, ScsiIdValue=ScsiIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunTable=scsiDscLunTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiPortTable=scsiPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, ScsiIndexValue=ScsiIndexValue)
