...
Gauge32, ModuleIdentity, NotificationType, Counter64, Integer32, mib_2, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, ObjectIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "Integer32", "mib-2", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "ObjectIdentity", "TimeTicks", "MibIdentifier")
RowStatus, RowPointer, TimeStamp, TextualConvention, DisplayString, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TimeStamp", "TextualConvention", "DisplayString", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortName=scsiTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiCompliances=scsiCompliances, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdType=scsiLuIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiConformance=scsiConformance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuProductId=scsiLuProductId, scsiIntrDevTable=scsiIntrDevTable, scsiTarget=scsiTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuTable=scsiLuTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetGroup=scsiTargetGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiPortIndex=scsiPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuState=scsiLuState, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuPeripheralType=scsiLuPeripheralType, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortRole=scsiPortRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator, scsiLunMapLun=scsiLunMapLun, scsiTranportSPI=scsiTranportSPI, scsiLuRevisionId=scsiLuRevisionId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortEntry=scsiPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiTransportISCSI=scsiTransportISCSI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiInstanceTable=scsiInstanceTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuEntry=scsiLuEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTranportOther=scsiTranportOther, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiTrnsptType=scsiTrnsptType, scsiGroups=scsiGroups, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, ScsiName=ScsiName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstAlias=scsiInstAlias, scsiModule=scsiModule, scsiTransportSBP=scsiTransportSBP, ScsiIdType=ScsiIdType, scsiDeviceGroup=scsiDeviceGroup, scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit)
