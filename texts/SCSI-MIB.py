...
ModuleIdentity, Counter64, ObjectIdentity, Bits, mib_2, Gauge32, IpAddress, Unsigned32, Counter32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "ObjectIdentity", "Bits", "mib-2", "Gauge32", "IpAddress", "Unsigned32", "Counter32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "iso")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevTable=scsiTgtDevTable, scsiInitiator=scsiInitiator, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapTable=scsiLunMapTable, scsiLuStatus=scsiLuStatus, scsiGroups=scsiGroups, scsiLuIdTable=scsiLuIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSBP=scsiTransportSBP, scsiLunMapLun=scsiLunMapLun, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, scsiModule=scsiModule, scsiLunMapIndex=scsiLunMapIndex, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceIndex=scsiDeviceIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportTypes=scsiTransportTypes, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdentifier=ScsiIdentifier, scsiCompliance=scsiCompliance, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGeneral=scsiGeneral, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuTable=scsiLuTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiConformance=scsiConformance, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportFCP=scsiTransportFCP, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstAlias=scsiInstAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiPortIndex=scsiPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, scsiLuEntry=scsiLuEntry, ScsiName=ScsiName, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceEntry=scsiInstanceEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdType=scsiLuIdType, scsiLuWwnName=scsiLuWwnName, ScsiIdCodeSet=ScsiIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiLuState=scsiLuState, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiPortRole=scsiPortRole, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiDscTgtName=scsiDscTgtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIndex=scsiLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiInstIndex=scsiInstIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, ScsiIdValue=ScsiIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunLun=scsiDscLunLun, scsiLuProductId=scsiLuProductId, scsiLuInResets=scsiLuInResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero)
