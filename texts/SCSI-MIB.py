...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, Bits, iso, ModuleIdentity, Counter64, TimeTicks, ObjectIdentity, MibIdentifier, IpAddress, Unsigned32, NotificationType, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "Bits", "iso", "ModuleIdentity", "Counter64", "TimeTicks", "ObjectIdentity", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType", "Counter32", "Integer32")
DisplayString, RowPointer, TimeStamp, TextualConvention, TruthValue, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TimeStamp", "TextualConvention", "TruthValue", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGroups=scsiGroups, ScsiIdentifier=ScsiIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGeneral=scsiGeneral, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTable=scsiPortTable, scsiDeviceTable=scsiDeviceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportSPI=scsiTranportSPI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIndex=scsiLuIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiDscLunTable=scsiDscLunTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdValue=scsiLuIdValue, scsiDeviceEntry=scsiDeviceEntry, scsiConformance=scsiConformance, ScsiIdValue=ScsiIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSBP=scsiTransportSBP, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortEntry=scsiPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunEntry=scsiDscLunEntry, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, ScsiIdType=ScsiIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInResets=scsiLuInResets, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotifications=scsiNotifications, scsiInstanceTable=scsiInstanceTable, scsiDeviceResets=scsiDeviceResets, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportFCP=scsiTransportFCP, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiObjects=scsiObjects, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdEntry=scsiLuIdEntry, scsiModule=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiInitiator=scsiInitiator, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapGroup=scsiLunMapGroup, scsiCompliances=scsiCompliances, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdAssociation=ScsiIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdType=scsiLuIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTarget=scsiTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortRole=scsiPortRole, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, ScsiName=ScsiName, scsiLuIdTable=scsiLuIdTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuTable=scsiLuTable, scsiLuStatus=scsiLuStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiLuInCommands=scsiLuInCommands, scsiPortIndex=scsiPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportOther=scsiTranportOther, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId)
