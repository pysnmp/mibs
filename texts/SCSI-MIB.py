...
Bits, mib_2, TimeTicks, Integer32, Unsigned32, MibIdentifier, Counter64, ObjectIdentity, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "TimeTicks", "Integer32", "Unsigned32", "MibIdentifier", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "iso")
AutonomousType, RowPointer, TextualConvention, TruthValue, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtName=scsiDscTgtName, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunLun=scsiDscLunLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceTable=scsiInstanceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiLunMapTable=scsiLunMapTable, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetGroup=scsiTargetGroup, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTarget=scsiTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdType=scsiLuIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportSBP=scsiTransportSBP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuEntry=scsiLuEntry, scsiTranportSPI=scsiTranportSPI, scsiTgtPortTable=scsiTgtPortTable, scsiNotifications=scsiNotifications, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceResets=scsiDeviceResets, scsiLuTable=scsiLuTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdentifier=ScsiIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiName=ScsiName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValue=ScsiIndexValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, ScsiIdValue=ScsiIdValue, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportOther=scsiTranportOther, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiPortTable=scsiPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiCompliance=scsiCompliance, scsiInitiatorGroup=scsiInitiatorGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuState=scsiLuState, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstAlias=scsiInstAlias, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptType=scsiTrnsptType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiLuInResets=scsiLuInResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliances=scsiCompliances, scsiAuthIntrName=scsiAuthIntrName, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiInitiator=scsiInitiator, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtTable=scsiDscTgtTable)
