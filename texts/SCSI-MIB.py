...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, mib_2, ModuleIdentity, Bits, NotificationType, IpAddress, TimeTicks, MibIdentifier, ObjectIdentity, Counter32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "mib-2", "ModuleIdentity", "Bits", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter32", "iso", "Counter64")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiPortEntry=scsiPortEntry, scsiLuVendorId=scsiLuVendorId, scsiLunMapTable=scsiLunMapTable, scsiLuEntry=scsiLuEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTable=scsiPortTable, scsiTarget=scsiTarget, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInCommands=scsiLuInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSBP=scsiTransportSBP, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotifications=scsiNotifications, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiTargetGroup=scsiTargetGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGeneral=scsiGeneral, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstIndex=scsiInstIndex, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiDscLunEntry=scsiDscLunEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdValue=scsiLuIdValue, scsiLuIndex=scsiLuIndex, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliance=scsiCompliance, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtTable=scsiDscTgtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiObjects=scsiObjects, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiGroups=scsiGroups, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiCompliances=scsiCompliances, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiModule=scsiModule, scsiPortRole=scsiPortRole, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuTable=scsiLuTable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdType=ScsiIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdValue=ScsiIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdTable=scsiLuIdTable, scsiLuStatus=scsiLuStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiIntrDevOutResets=scsiIntrDevOutResets)
