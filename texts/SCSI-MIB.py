...
NotificationType, TimeTicks, Gauge32, ModuleIdentity, Counter64, Bits, mib_2, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Unsigned32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Gauge32", "ModuleIdentity", "Counter64", "Bits", "mib-2", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Unsigned32", "IpAddress", "MibIdentifier")
AutonomousType, TextualConvention, RowPointer, RowStatus, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "RowPointer", "RowStatus", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapIndex=scsiLunMapIndex, scsiCompliances=scsiCompliances, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiLuInResets=scsiLuInResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortName=scsiTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, ScsiName=ScsiName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceTable=scsiInstanceTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptType=scsiTrnsptType, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdValue=ScsiIdValue, scsiInstAlias=scsiInstAlias, scsiDscLunLun=scsiDscLunLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiModule=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuTable=scsiLuTable, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceIndex=scsiDeviceIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortEntry=scsiPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiTarget=scsiTarget, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstIndex=scsiInstIndex, scsiGroups=scsiGroups, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportFCP=scsiTransportFCP, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, scsiPortIndex=scsiPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuState=scsiLuState, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiPortRole=scsiPortRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSBP=scsiTransportSBP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiConformance=scsiConformance, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteTarget=scsiRemoteTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInitiator=scsiInitiator, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuRevisionId=scsiLuRevisionId, scsiNotifications=scsiNotifications, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets)
