...
mib_2, Integer32, Unsigned32, Gauge32, MibIdentifier, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ObjectIdentity, TimeTicks, Counter32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "Unsigned32", "Gauge32", "MibIdentifier", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "IpAddress", "NotificationType")
RowStatus, AutonomousType, TextualConvention, RowPointer, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "RowPointer", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuState=scsiLuState, ScsiIndexValue=ScsiIndexValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, ScsiName=ScsiName, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtName=scsiDscTgtName, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdType=scsiLuIdType, scsiLuInCommands=scsiLuInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuWwnName=scsiLuWwnName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGeneral=scsiGeneral, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiNotifications=scsiNotifications, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiConformance=scsiConformance, scsiTransportTypes=scsiTransportTypes, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, PYSNMP_MODULE_ID=scsiModule, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTarget=scsiTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortEntry=scsiPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteTarget=scsiRemoteTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstAlias=scsiInstAlias, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuVendorId=scsiLuVendorId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptType=scsiTrnsptType, scsiPortRole=scsiPortRole, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiLuIndex=scsiLuIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceResets=scsiDeviceResets, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceRole=scsiDeviceRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiLuTable=scsiLuTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrName=scsiAuthIntrName, scsiPortIndex=scsiPortIndex, scsiTargetGroup=scsiTargetGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiModule=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, ScsiIdType=ScsiIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatus=scsiLuStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuProductId=scsiLuProductId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber)
