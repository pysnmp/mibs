...
Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, iso, TimeTicks, IpAddress, MibIdentifier, Counter64, Counter32, ObjectIdentity, Integer32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "iso", "TimeTicks", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "ObjectIdentity", "Integer32", "NotificationType", "ModuleIdentity")
TruthValue, DisplayString, AutonomousType, TextualConvention, RowPointer, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "TextualConvention", "RowPointer", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportFCP=scsiTransportFCP, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuVendorId=scsiLuVendorId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiObjects=scsiObjects, scsiLuInCommands=scsiLuInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotifications=scsiNotifications, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtName=scsiDscTgtName, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapLun=scsiLunMapLun, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuState=scsiLuState, ScsiIdentifier=ScsiIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSRP=scsiTransportSRP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstIndex=scsiInstIndex, ScsiIdAssociation=ScsiIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiPortIndex=scsiPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiConformance=scsiConformance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortEntry=scsiPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliance=scsiCompliance, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuTable=scsiLuTable, ScsiIdType=ScsiIdType, scsiGeneral=scsiGeneral, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatus=scsiLuStatus, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdIndex=scsiLuIdIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiTranportOther=scsiTranportOther, scsiTrnsptType=scsiTrnsptType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, scsiPortTable=scsiPortTable, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstAlias=scsiInstAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiLunMapTable=scsiLunMapTable, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuEntry=scsiLuEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiName=ScsiName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGroups=scsiGroups, scsiInitiator=scsiInitiator, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes)
