...
Bits, TimeTicks, Gauge32, iso, ModuleIdentity, Integer32, IpAddress, MibIdentifier, Counter64, Counter32, NotificationType, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Gauge32", "iso", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
RowPointer, RowStatus, TextualConvention, DisplayString, TruthValue, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "DisplayString", "TruthValue", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuTable=scsiLuTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInCommands=scsiLuInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunEntry=scsiDscLunEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIndex=scsiLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTarget=scsiTarget, scsiLunMapIndex=scsiLunMapIndex, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiGroups=scsiGroups, scsiRemoteTarget=scsiRemoteTarget, scsiInstIndex=scsiInstIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportTypes=scsiTransportTypes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceTable=scsiInstanceTable, scsiDeviceResets=scsiDeviceResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiCompliance=scsiCompliance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiObjects=scsiObjects, scsiPortRole=scsiPortRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSRP=scsiTransportSRP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportFCP=scsiTransportFCP, scsiTransportSBP=scsiTransportSBP, scsiDeviceEntry=scsiDeviceEntry, scsiLuVendorId=scsiLuVendorId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunLun=scsiDscLunLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtName=scsiDscTgtName, scsiLuIdTable=scsiLuIdTable, ScsiIdValue=ScsiIdValue, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuStatus=scsiLuStatus, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunTable=scsiDscLunTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiInitiator=scsiInitiator, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiDscTgtTable=scsiDscTgtTable, scsiLogicalUnit=scsiLogicalUnit, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiAuthIntrName=scsiAuthIntrName, scsiCompliances=scsiCompliances, scsiPortEntry=scsiPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
