...
Integer32, iso, TimeTicks, ObjectIdentity, IpAddress, ModuleIdentity, Unsigned32, Counter64, Gauge32, NotificationType, Counter32, mib_2, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "Counter32", "mib-2", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, RowStatus, RowPointer, AutonomousType, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "RowPointer", "AutonomousType", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportSRP=scsiTransportSRP, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInCommands=scsiLuInCommands, scsiPortIndex=scsiPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGeneral=scsiGeneral, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuTable=scsiLuTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtTable=scsiDscTgtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtName=scsiDscTgtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceResets=scsiDeviceResets, scsiTranportSPI=scsiTranportSPI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuState=scsiLuState, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiPortEntry=scsiPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdType=scsiDscLunIdType, ScsiName=ScsiName, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapTable=scsiLunMapTable, ScsiIdValue=ScsiIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptType=scsiTrnsptType, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapEntry=scsiLunMapEntry, ScsiIdAssociation=ScsiIdAssociation, scsiObjects=scsiObjects, scsiTgtPortName=scsiTgtPortName, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstAlias=scsiInstAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortTable=scsiPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortRole=scsiPortRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdType=scsiLuIdType, scsiTarget=scsiTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdType=ScsiIdType, scsiConformance=scsiConformance, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiNotifications=scsiNotifications, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIndex=scsiLuIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuInResets=scsiLuInResets, scsiInstanceTable=scsiInstanceTable, ScsiIndexValue=ScsiIndexValue, scsiInitiator=scsiInitiator, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevTable=scsiTgtDevTable)
