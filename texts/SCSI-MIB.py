...
mib_2, IpAddress, Counter64, Unsigned32, Gauge32, TimeTicks, ModuleIdentity, NotificationType, Bits, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Counter64", "Unsigned32", "Gauge32", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "MibIdentifier")
TextualConvention, RowPointer, TruthValue, RowStatus, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSRP=scsiTransportSRP, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunTable=scsiDscLunTable, scsiGroups=scsiGroups, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdentifier=ScsiIdentifier, scsiDeviceGroup=scsiDeviceGroup, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortIndex=scsiPortIndex, scsiTgtPortName=scsiTgtPortName, scsiTarget=scsiTarget, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiator=scsiInitiator, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuState=scsiLuState, scsiTrnsptTable=scsiTrnsptTable, scsiConformance=scsiConformance, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdValue=scsiLuIdValue, ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortRole=scsiPortRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotifications=scsiNotifications, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiDeviceIndex=scsiDeviceIndex, scsiObjects=scsiObjects, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiModule=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiCompliance=scsiCompliance, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdEntry=scsiLuIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdType=scsiLuIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiName=ScsiName, scsiDscTgtInCommands=scsiDscTgtInCommands, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunLun=scsiDscLunLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWwnName=scsiLuWwnName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstIndex=scsiInstIndex, scsiLuIndex=scsiLuIndex, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtName=scsiIntrPrtName, scsiLuEntry=scsiLuEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTable=scsiPortTable, scsiLuInResets=scsiLuInResets, scsiLuIdTable=scsiLuIdTable, scsiTranportOther=scsiTranportOther, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGeneral=scsiGeneral, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdIndex=scsiLuIdIndex, scsiPortEntry=scsiPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable)
