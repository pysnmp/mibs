...
Counter64, Integer32, ObjectIdentity, MibIdentifier, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Unsigned32, iso, Counter32, NotificationType, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "ObjectIdentity", "MibIdentifier", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Unsigned32", "iso", "Counter32", "NotificationType", "ModuleIdentity", "mib-2")
RowPointer, RowStatus, TextualConvention, AutonomousType, TimeStamp, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuVendorId=scsiLuVendorId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuEntry=scsiLuEntry, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtName=scsiDscTgtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValue=ScsiIndexValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportFCP=scsiTransportFCP, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiator=scsiInitiator, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, scsiTranportSPI=scsiTranportSPI, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdValue=ScsiIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiObjects=scsiObjects, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstAlias=scsiInstAlias, scsiLuInCommands=scsiLuInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportSBP=scsiTransportSBP, scsiLunMapIndex=scsiLunMapIndex, scsiConformance=scsiConformance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiGroups=scsiGroups, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunLun=scsiDscLunLun, ScsiLUNOrZero=ScsiLUNOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuState=scsiLuState, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdType=ScsiIdType, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiDeviceTable=scsiDeviceTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuIndex=scsiLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiInstanceTable=scsiInstanceTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiTarget=scsiTarget, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuProductId=scsiLuProductId, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiTgtDevTable=scsiTgtDevTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatus=scsiLuStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceResets=scsiDeviceResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiModule=scsiModule, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportTypes=scsiTransportTypes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTable=scsiPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapTable=scsiLunMapTable)
