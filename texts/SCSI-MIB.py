...
MibIdentifier, Gauge32, Counter32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, IpAddress, TimeTicks, Counter64, ObjectIdentity, Bits, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Counter32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "IpAddress", "TimeTicks", "Counter64", "ObjectIdentity", "Bits", "NotificationType", "mib-2")
TimeStamp, TruthValue, DisplayString, RowPointer, AutonomousType, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "RowPointer", "AutonomousType", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, scsiModule=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiCompliances=scsiCompliances, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuProductId=scsiLuProductId, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiator=scsiInitiator, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdEntry=scsiLuIdEntry, scsiLuIndex=scsiLuIndex, scsiTarget=scsiTarget, scsiObjects=scsiObjects, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportISCSI=scsiTransportISCSI, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiGeneral=scsiGeneral, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiGroups=scsiGroups, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapEntry=scsiLunMapEntry, ScsiIndexValue=ScsiIndexValue, scsiTranportSPI=scsiTranportSPI, scsiDscLunTable=scsiDscLunTable, scsiCompliance=scsiCompliance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportOther=scsiTranportOther, ScsiIdValue=ScsiIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortRole=scsiPortRole, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdentifier=ScsiIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapLun=scsiLunMapLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuTable=scsiLuTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdType=ScsiIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiLuIdType=scsiLuIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortIndex=scsiPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiLuVendorId=scsiLuVendorId, scsiNotifications=scsiNotifications, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuEntry=scsiLuEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdValue=scsiLuIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiLuInResets=scsiLuInResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiName=ScsiName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup)
