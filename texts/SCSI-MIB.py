...
ModuleIdentity, Bits, NotificationType, Unsigned32, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, ObjectIdentity, MibIdentifier, Counter32, IpAddress, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "Unsigned32", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter32", "IpAddress", "iso", "Integer32")
TimeStamp, RowStatus, AutonomousType, TruthValue, RowPointer, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "AutonomousType", "TruthValue", "RowPointer", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdTable=scsiLuIdTable, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, ScsiIndexValue=ScsiIndexValue, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, scsiTransportTypes=scsiTransportTypes, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGroups=scsiGroups, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportSPI=scsiTranportSPI, scsiTargetGroup=scsiTargetGroup, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuProductId=scsiLuProductId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiator=scsiInitiator, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiTransportSRP=scsiTransportSRP, scsiLuStatus=scsiLuStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdEntry=scsiLuIdEntry, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceRole=scsiDeviceRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiLuIdValue=scsiLuIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtName=scsiDscTgtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiLuInCommands=scsiLuInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuTable=scsiLuTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuState=scsiLuState, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTable=scsiPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, ScsiIdType=ScsiIdType, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLuIndex=scsiLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes)
