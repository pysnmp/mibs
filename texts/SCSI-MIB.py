...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Integer32, iso, Bits, TimeTicks, ModuleIdentity, Counter32, Unsigned32, mib_2, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Integer32", "iso", "Bits", "TimeTicks", "ModuleIdentity", "Counter32", "Unsigned32", "mib-2", "Counter64", "MibIdentifier")
DisplayString, RowStatus, TimeStamp, TextualConvention, RowPointer, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TimeStamp", "TextualConvention", "RowPointer", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiCompliance=scsiCompliance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIndex=scsiLuIndex, scsiLunMapTable=scsiLunMapTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdValue=scsiLuIdValue, scsiGeneral=scsiGeneral, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceResets=scsiDeviceResets, ScsiIdValue=ScsiIdValue, scsiModule=scsiModule, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTranportSPI=scsiTranportSPI, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiTranportOther=scsiTranportOther, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, PYSNMP_MODULE_ID=scsiModule, scsiPortRole=scsiPortRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSBP=scsiTransportSBP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortName=scsiTgtPortName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportFCP=scsiTransportFCP, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTable=scsiPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTarget=scsiTarget, scsiTransportISCSI=scsiTransportISCSI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGroups=scsiGroups, scsiLuEntry=scsiLuEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiLuWwnName=scsiLuWwnName, scsiLuInResets=scsiLuInResets, ScsiIdAssociation=ScsiIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuProductId=scsiLuProductId, scsiDscLunTable=scsiDscLunTable, scsiInitiator=scsiInitiator, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiCompliances=scsiCompliances, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstAlias=scsiInstAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdType=ScsiIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiName=ScsiName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry)
