...
mib_2, ModuleIdentity, Bits, Counter32, MibIdentifier, IpAddress, Counter64, NotificationType, TimeTicks, Gauge32, iso, Unsigned32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "Bits", "Counter32", "MibIdentifier", "IpAddress", "Counter64", "NotificationType", "TimeTicks", "Gauge32", "iso", "Unsigned32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, DisplayString, TruthValue, RowPointer, AutonomousType, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "RowPointer", "AutonomousType", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortEntry=scsiPortEntry, scsiObjects=scsiObjects, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportOther=scsiTranportOther, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdValue=ScsiIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortRole=scsiPortRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdType=scsiLuIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiator=scsiInitiator, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiTransportFCP=scsiTransportFCP, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInCommands=scsiLuInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuTable=scsiLuTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuState=scsiLuState, scsiLuVendorId=scsiLuVendorId, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValue=ScsiIndexValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptType=scsiTrnsptType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdEntry=scsiLuIdEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTarget=scsiTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliances=scsiCompliances, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuProductId=scsiLuProductId, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdentifier=ScsiIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiInstAlias=scsiInstAlias, scsiLuEntry=scsiLuEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunEntry=scsiDscLunEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceRole=scsiDeviceRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapGroup=scsiLunMapGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunTable=scsiDscLunTable, scsiTransportSBP=scsiTransportSBP, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceEntry=scsiDeviceEntry, ScsiName=ScsiName, scsiConformance=scsiConformance, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiNotifications=scsiNotifications, scsiDeviceResets=scsiDeviceResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiModule=scsiModule, scsiLunMapLun=scsiLunMapLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtName=scsiIntrPrtName)
