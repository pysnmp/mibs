...
ModuleIdentity, Bits, NotificationType, Counter64, ObjectIdentity, MibIdentifier, Unsigned32, iso, Counter32, Integer32, Gauge32, mib_2, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier", "Unsigned32", "iso", "Counter32", "Integer32", "Gauge32", "mib-2", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, TimeStamp, TruthValue, RowStatus, DisplayString, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteTarget=scsiRemoteTarget, scsiLuInCommands=scsiLuInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiLunMapEntry=scsiLunMapEntry, ScsiIdCodeSet=ScsiIdCodeSet, ScsiName=ScsiName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuProductId=scsiLuProductId, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdValue=ScsiIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTarget=scsiTarget, scsiTransportFCP=scsiTransportFCP, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevEntry=scsiIntrDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiInstAlias=scsiInstAlias, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdType=scsiLuIdType, scsiPortRole=scsiPortRole, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiator=scsiInitiator, scsiLuIndex=scsiLuIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuVendorId=scsiLuVendorId, scsiGroups=scsiGroups, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotifications=scsiNotifications, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiConformance=scsiConformance, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportSRP=scsiTransportSRP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortName=scsiTgtPortName, scsiLuIdTable=scsiLuIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceResets=scsiDeviceResets, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceTable=scsiDeviceTable, ScsiIdAssociation=ScsiIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceIndex=scsiDeviceIndex, scsiLuState=scsiLuState, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunLun=scsiDscLunLun, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiLuInResets=scsiLuInResets, scsiCompliances=scsiCompliances, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtTable=scsiDscTgtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex)
