...
mib_2, IpAddress, Integer32, Counter32, TimeTicks, Bits, ObjectIdentity, MibIdentifier, Unsigned32, Gauge32, NotificationType, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Integer32", "Counter32", "TimeTicks", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
DisplayString, TruthValue, TimeStamp, AutonomousType, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortInCommands=scsiTgtPortInCommands, PYSNMP_MODULE_ID=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSBP=scsiTransportSBP, scsiTargetGroup=scsiTargetGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunLun=scsiDscLunLun, scsiLuIdValue=scsiLuIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortEntry=scsiPortEntry, ScsiName=ScsiName, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiObjects=scsiObjects, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuWwnName=scsiLuWwnName, scsiNotifications=scsiNotifications, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapTable=scsiLunMapTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSRP=scsiTransportSRP, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiator=scsiInitiator, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstIndex=scsiInstIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiGeneral=scsiGeneral, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIndexValue=ScsiIndexValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtName=scsiDscTgtName, scsiLuIdEntry=scsiLuIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceEntry=scsiDeviceEntry, ScsiIdValue=ScsiIdValue, scsiTarget=scsiTarget, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceRole=scsiDeviceRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdType=ScsiIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIndex=scsiLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportTypes=scsiTransportTypes, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuStatus=scsiLuStatus, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiInstAlias=scsiInstAlias, scsiInstanceTable=scsiInstanceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGroups=scsiGroups, scsiTransportFCP=scsiTransportFCP, scsiPortTable=scsiPortTable, scsiTranportSPI=scsiTranportSPI, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiLuProductId=scsiLuProductId, scsiModule=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdTable=scsiLuIdTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdType=scsiLuIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptTable=scsiTrnsptTable, ScsiDeviceOrPort=ScsiDeviceOrPort)
