...
Counter64, iso, Unsigned32, MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, ObjectIdentity, Gauge32, Integer32, Counter32, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Unsigned32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "ObjectIdentity", "Gauge32", "Integer32", "Counter32", "mib-2", "NotificationType")
AutonomousType, DisplayString, TimeStamp, RowStatus, TextualConvention, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceGroup=scsiDeviceGroup, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdType=ScsiIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSRP=scsiTransportSRP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuTable=scsiLuTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortEntry=scsiPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiModule=scsiModule, scsiInitiator=scsiInitiator, scsiDeviceRole=scsiDeviceRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceTable=scsiDeviceTable, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstanceTable=scsiInstanceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiName=ScsiName, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuState=scsiLuState, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTable=scsiPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIndex=scsiLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdTable=scsiLuIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTarget=scsiTarget, ScsiIdValue=ScsiIdValue, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliance=scsiCompliance, scsiTranportOther=scsiTranportOther, scsiGroups=scsiGroups, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiLuInResets=scsiLuInResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLuEntry=scsiLuEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliances=scsiCompliances, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSBP=scsiTransportSBP, scsiLuStatus=scsiLuStatus, scsiInstAlias=scsiInstAlias)
