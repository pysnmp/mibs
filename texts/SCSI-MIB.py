...
Bits, MibIdentifier, ModuleIdentity, ObjectIdentity, Integer32, Counter32, Gauge32, IpAddress, Counter64, mib_2, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Integer32", "Counter32", "Gauge32", "IpAddress", "Counter64", "mib-2", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32")
RowStatus, TextualConvention, AutonomousType, DisplayString, RowPointer, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "AutonomousType", "DisplayString", "RowPointer", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValue=ScsiIndexValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIndex=scsiLuIndex, scsiDeviceRole=scsiDeviceRole, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiLuVendorId=scsiLuVendorId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiConformance=scsiConformance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdValue=scsiLuIdValue, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiObjects=scsiObjects, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunLun=scsiDscLunLun, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiLuTable=scsiLuTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiLuEntry=scsiLuEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiInitiator=scsiInitiator, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWwnName=scsiLuWwnName, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatus=scsiLuStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTarget=scsiTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdValue=ScsiIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstAlias=scsiInstAlias, scsiLuInResets=scsiLuInResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunEntry=scsiDscLunEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGroups=scsiGroups, scsiPortRole=scsiPortRole, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortIndex=scsiPortIndex, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTable=scsiPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptTable=scsiTrnsptTable, scsiPortEntry=scsiPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdentifier=ScsiIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiModule=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInCommands=scsiLuInCommands, scsiTargetGroup=scsiTargetGroup, scsiCompliances=scsiCompliances, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiTranportOther=scsiTranportOther, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable)
