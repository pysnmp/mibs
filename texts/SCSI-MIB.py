...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, NotificationType, Gauge32, Integer32, mib_2, TimeTicks, ModuleIdentity, Counter32, MibIdentifier, ObjectIdentity, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "NotificationType", "Gauge32", "Integer32", "mib-2", "TimeTicks", "ModuleIdentity", "Counter32", "MibIdentifier", "ObjectIdentity", "Bits", "Unsigned32")
DisplayString, TextualConvention, RowPointer, TimeStamp, AutonomousType, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowPointer", "TimeStamp", "AutonomousType", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiModule=scsiModule, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiObjects=scsiObjects, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliances=scsiCompliances, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapIndex=scsiLunMapIndex, ScsiName=ScsiName, scsiLuProductId=scsiLuProductId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdEntry=scsiLuIdEntry, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiCompliance=scsiCompliance, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuEntry=scsiLuEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValue=ScsiIndexValue, scsiDscLunTable=scsiDscLunTable, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportTypes=scsiTransportTypes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLogicalUnit=scsiLogicalUnit, scsiGroups=scsiGroups, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstIndex=scsiInstIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdAssociation=ScsiIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiNotifications=scsiNotifications, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuState=scsiLuState, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdentifier=ScsiIdentifier, scsiInitiator=scsiInitiator, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiConformance=scsiConformance, scsiLuStatus=scsiLuStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceAlias=scsiDeviceAlias, scsiTarget=scsiTarget, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiTranportOther=scsiTranportOther, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdValue=ScsiIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunLun=scsiDscLunLun, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortName=scsiTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuInResets=scsiLuInResets)
