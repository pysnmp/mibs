...
iso, IpAddress, NotificationType, Unsigned32, Bits, mib_2, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Unsigned32", "Bits", "mib-2", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter64", "TimeTicks")
TextualConvention, TruthValue, DisplayString, RowStatus, AutonomousType, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "RowStatus", "AutonomousType", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSBP=scsiTransportSBP, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuEntry=scsiLuEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiator=scsiInitiator, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdType=ScsiIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunTable=scsiDscLunTable, scsiPortRole=scsiPortRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotifications=scsiNotifications, scsiTranportSPI=scsiTranportSPI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportTypes=scsiTransportTypes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiGroups=scsiGroups, scsiConformance=scsiConformance, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValue=ScsiIndexValue, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatus=scsiLuStatus, scsiObjects=scsiObjects, scsiLuTable=scsiLuTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdAssociation=ScsiIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdType=scsiLuIdType, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiTrnsptTable=scsiTrnsptTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiGeneral=scsiGeneral, scsiTrnsptType=scsiTrnsptType, scsiLuInResets=scsiLuInResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuProductId=scsiLuProductId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstAlias=scsiInstAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunLun=scsiDscLunLun, scsiLuState=scsiLuState, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTarget=scsiTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdValue=scsiLuIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiModule=scsiModule, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceRole=scsiDeviceRole, ScsiIdentifier=ScsiIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiCompliance=scsiCompliance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiInstIndex=scsiInstIndex, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortEntry=scsiPortEntry)
