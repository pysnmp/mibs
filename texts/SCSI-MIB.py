...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, ModuleIdentity, TimeTicks, MibIdentifier, mib_2, Gauge32, Integer32, iso, NotificationType, Counter32, Counter64, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibIdentifier", "mib-2", "Gauge32", "Integer32", "iso", "NotificationType", "Counter32", "Counter64", "IpAddress", "Unsigned32")
DisplayString, TruthValue, RowPointer, TimeStamp, AutonomousType, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTable=scsiPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceTable=scsiDeviceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLogicalUnit=scsiLogicalUnit, ScsiName=ScsiName, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdType=scsiLuIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdType=ScsiIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, scsiLuTable=scsiLuTable, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortName=scsiTgtPortName, scsiTarget=scsiTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortRole=scsiPortRole, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdTable=scsiLuIdTable, scsiNotifications=scsiNotifications, ScsiIdValue=ScsiIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportTypes=scsiTransportTypes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiModule=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, scsiGeneral=scsiGeneral, scsiLuState=scsiLuState, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportFCP=scsiTransportFCP, scsiTrnsptTable=scsiTrnsptTable, scsiCompliance=scsiCompliance, scsiLuVendorId=scsiLuVendorId, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportSRP=scsiTransportSRP, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuEntry=scsiLuEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
