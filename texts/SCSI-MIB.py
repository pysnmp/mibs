...
NotificationType, Integer32, MibIdentifier, Unsigned32, Counter64, TimeTicks, mib_2, Counter32, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibIdentifier", "Unsigned32", "Counter64", "TimeTicks", "mib-2", "Counter32", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "ObjectIdentity")
AutonomousType, DisplayString, RowStatus, TextualConvention, TruthValue, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "RowStatus", "TextualConvention", "TruthValue", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIndex=scsiLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdType=ScsiIdType, scsiLuInResets=scsiLuInResets, ScsiIdValue=ScsiIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortName=scsiTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdType=scsiLuIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportOther=scsiTranportOther, scsiModule=scsiModule, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTarget=scsiTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportSBP=scsiTransportSBP, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGeneral=scsiGeneral, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiName=ScsiName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiLuIdTable=scsiLuIdTable, scsiLuInCommands=scsiLuInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiLunMapTable=scsiLunMapTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstAlias=scsiInstAlias, scsiDeviceResets=scsiDeviceResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliance=scsiCompliance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTargetGroup=scsiTargetGroup, scsiConformance=scsiConformance, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortEntry=scsiPortEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLun=scsiLunMapLun, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiNameIdOrZero=ScsiNameIdOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiPortTable=scsiPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuTable=scsiLuTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiObjects=scsiObjects, scsiTrnsptType=scsiTrnsptType, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiPortRole=scsiPortRole, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdValue=scsiLuIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliances=scsiCompliances, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortIndex=scsiPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands)
