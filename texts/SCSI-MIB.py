...
Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Unsigned32, mib_2, TimeTicks, IpAddress, Gauge32, iso, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Unsigned32", "mib-2", "TimeTicks", "IpAddress", "Gauge32", "iso", "NotificationType", "ModuleIdentity", "Counter64")
RowPointer, AutonomousType, RowStatus, DisplayString, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "RowStatus", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWwnName=scsiLuWwnName, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiInstAlias=scsiInstAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiModule=scsiModule, scsiLuProductId=scsiLuProductId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceTable=scsiInstanceTable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiCompliance=scsiCompliance, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatus=scsiLuStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceRole=scsiDeviceRole, scsiLuState=scsiLuState, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstIndex=scsiInstIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuTable=scsiLuTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiName=ScsiName, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunLun=scsiDscLunLun, scsiDeviceTable=scsiDeviceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortRole=scsiPortRole, scsiTranportSPI=scsiTranportSPI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTarget=scsiTarget, scsiTransportFCP=scsiTransportFCP, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortName=scsiAttTgtPortName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdValue=ScsiIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortTable=scsiTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportISCSI=scsiTransportISCSI, ScsiIndexValue=ScsiIndexValue, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiLuIdEntry=scsiLuIdEntry, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunTable=scsiDscLunTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIndex=scsiLuIndex, scsiIntrPrtName=scsiIntrPrtName)
