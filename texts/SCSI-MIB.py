...
Unsigned32, Counter32, ModuleIdentity, iso, IpAddress, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, NotificationType, MibIdentifier, Integer32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "ModuleIdentity", "iso", "IpAddress", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "NotificationType", "MibIdentifier", "Integer32", "Gauge32", "Bits")
TruthValue, RowStatus, TextualConvention, RowPointer, DisplayString, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TextualConvention", "RowPointer", "DisplayString", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapEntry=scsiLunMapEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTranportSPI=scsiTranportSPI, scsiLuTable=scsiLuTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtName=scsiDscTgtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortEntry=scsiPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiConformance=scsiConformance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiRemoteTarget=scsiRemoteTarget, scsiPortIndex=scsiPortIndex, scsiTarget=scsiTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportSRP=scsiTransportSRP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunTable=scsiDscLunTable, scsiInstIndex=scsiInstIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatus=scsiLuStatus, scsiLunMapIndex=scsiLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTable=scsiIntrDevTable, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortTable=scsiTgtPortTable, scsiLuState=scsiLuState, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiator=scsiInitiator, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiName=ScsiName, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuEntry=scsiLuEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdType=ScsiIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIndex=scsiDscLunIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiCompliances=scsiCompliances, scsiModule=scsiModule, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdValue=ScsiIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiPortRole=scsiPortRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdType=scsiLuIdType, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportOther=scsiTranportOther, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdTable=scsiLuIdTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuProductId=scsiLuProductId, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceRole=scsiDeviceRole)
