...
TimeTicks, ModuleIdentity, Unsigned32, Counter32, NotificationType, IpAddress, Bits, MibIdentifier, Counter64, Integer32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "Bits", "MibIdentifier", "Counter64", "Integer32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2")
RowStatus, TruthValue, TimeStamp, AutonomousType, TextualConvention, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiDeviceTable=scsiDeviceTable, scsiLunMapIndex=scsiLunMapIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiModule=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptType=scsiTrnsptType, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstAlias=scsiInstAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportTypes=scsiTransportTypes, scsiGeneral=scsiGeneral, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliance=scsiCompliance, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuTable=scsiLuTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortEntry=scsiPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortIndex=scsiPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGroups=scsiGroups, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortTable=scsiTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, PYSNMP_MODULE_ID=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortRole=scsiPortRole, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdTable=scsiLuIdTable, scsiTranportOther=scsiTranportOther, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceTable=scsiInstanceTable, ScsiName=ScsiName, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdValue=scsiLuIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportFCP=scsiTransportFCP, scsiDeviceGroup=scsiDeviceGroup, scsiObjects=scsiObjects, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs)
