...
MibIdentifier, Counter32, mib_2, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, NotificationType, IpAddress, Bits, Counter64, Unsigned32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "mib-2", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "NotificationType", "IpAddress", "Bits", "Counter64", "Unsigned32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdTable=scsiLuIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuState=scsiLuState, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInCommands=scsiLuInCommands, scsiTranportOther=scsiTranportOther, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliances=scsiCompliances, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtName=scsiIntrPrtName, scsiLuInResets=scsiLuInResets, scsiCompliance=scsiCompliance, scsiDscLunLun=scsiDscLunLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceRole=scsiDeviceRole, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIndex=scsiLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuTable=scsiLuTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, PYSNMP_MODULE_ID=scsiModule, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiIntrDevTable=scsiIntrDevTable, ScsiIdType=ScsiIdType, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtName=scsiDscTgtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiTransportFCP=scsiTransportFCP, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortRole=scsiPortRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetGroup=scsiTargetGroup, ScsiIdCodeSet=ScsiIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiObjects=scsiObjects, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstAlias=scsiInstAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatus=scsiLuStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiGroups=scsiGroups, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiPortIndex=scsiPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdType=scsiLuIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceResets=scsiDeviceResets, scsiTransportSBP=scsiTransportSBP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, ScsiIdentifier=ScsiIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdEntry=scsiLuIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, ScsiIdValue=ScsiIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet)
