...
iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, NotificationType, Bits, TimeTicks, Gauge32, mib_2, Unsigned32, IpAddress, Integer32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "Gauge32", "mib-2", "Unsigned32", "IpAddress", "Integer32", "ObjectIdentity", "MibIdentifier")
RowStatus, TimeStamp, DisplayString, RowPointer, TextualConvention, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "RowPointer", "TextualConvention", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdType=ScsiIdType, scsiAuthIntrName=scsiAuthIntrName, scsiObjects=scsiObjects, scsiInstAlias=scsiInstAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, ScsiName=ScsiName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuInResets=scsiLuInResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetGroup=scsiTargetGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuState=scsiLuState, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunLun=scsiDscLunLun, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortEntry=scsiPortEntry, scsiInitiator=scsiInitiator, scsiTrnsptPointer=scsiTrnsptPointer, scsiGeneral=scsiGeneral, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliances=scsiCompliances, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuWwnName=scsiLuWwnName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortTable=scsiTgtPortTable, scsiModule=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiCompliance=scsiCompliance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapTable=scsiLunMapTable, scsiLuIdTable=scsiLuIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiNotifications=scsiNotifications, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiTransportSBP=scsiTransportSBP, scsiTrnsptEntry=scsiTrnsptEntry, scsiConformance=scsiConformance, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportOther=scsiTranportOther, scsiLuProductId=scsiLuProductId, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdentifier=ScsiIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortRole=scsiPortRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstanceEntry=scsiInstanceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdType=scsiLuIdType, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortTable=scsiPortTable, scsiLuInCommands=scsiLuInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTarget=scsiTarget, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatus=scsiLuStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiPortIndex=scsiPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, PYSNMP_MODULE_ID=scsiModule, ScsiIdValue=ScsiIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapEntry=scsiLunMapEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes)
