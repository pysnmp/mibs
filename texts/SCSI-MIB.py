...
Bits, iso, Gauge32, Counter64, TimeTicks, ObjectIdentity, Counter32, Integer32, NotificationType, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Gauge32", "Counter64", "TimeTicks", "ObjectIdentity", "Counter32", "Integer32", "NotificationType", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "ModuleIdentity")
TimeStamp, RowStatus, RowPointer, TruthValue, DisplayString, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "RowPointer", "TruthValue", "DisplayString", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceResets=scsiDeviceResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuEntry=scsiLuEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiObjects=scsiObjects, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, PYSNMP_MODULE_ID=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunLun=scsiDscLunLun, scsiTrnsptType=scsiTrnsptType, scsiPortEntry=scsiPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortRole=scsiPortRole, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceTable=scsiInstanceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportOther=scsiTranportOther, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiLuTable=scsiLuTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiLuProductId=scsiLuProductId, scsiInstAlias=scsiInstAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiTransportTypes=scsiTransportTypes, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuVendorId=scsiLuVendorId, scsiLuWwnName=scsiLuWwnName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdType=ScsiIdType, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliances=scsiCompliances, scsiTranportSPI=scsiTranportSPI, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, ScsiIdentifier=ScsiIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIndex=scsiLuIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTarget=scsiTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuState=scsiLuState, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGeneral=scsiGeneral, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTable=scsiPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtEntry=scsiDscTgtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceRole=scsiDeviceRole, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiTransportSBP=scsiTransportSBP, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiName=ScsiName, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdValue=ScsiIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtName=scsiIntrPrtName, scsiInitiator=scsiInitiator, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapTable=scsiLunMapTable, scsiTgtPortName=scsiTgtPortName)
