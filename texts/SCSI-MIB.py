...
Unsigned32, IpAddress, Integer32, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Counter32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Counter32", "Bits", "MibIdentifier")
RowStatus, RowPointer, TextualConvention, AutonomousType, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TextualConvention", "AutonomousType", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTable=scsiPortTable, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiGeneral=scsiGeneral, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdentifier=ScsiIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliance=scsiCompliance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapEntry=scsiLunMapEntry, ScsiIdValue=ScsiIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportOther=scsiTranportOther, scsiLuStatus=scsiLuStatus, scsiLuInCommands=scsiLuInCommands, scsiTranportSPI=scsiTranportSPI, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiNotifications=scsiNotifications, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportFCP=scsiTransportFCP, scsiGroups=scsiGroups, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuEntry=scsiLuEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiLuState=scsiLuState, scsiDeviceAlias=scsiDeviceAlias, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIndexValue=ScsiIndexValue, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiConformance=scsiConformance, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiator=scsiInitiator, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiModule=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortEntry=scsiPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceRole=scsiDeviceRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdEntry=scsiLuIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtName=scsiDscTgtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIndex=scsiLuIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiName=ScsiName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortName=scsiTgtPortName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapTable=scsiLunMapTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, PYSNMP_MODULE_ID=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetGroup=scsiTargetGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTarget=scsiTarget, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortRole=scsiPortRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSBP=scsiTransportSBP)
