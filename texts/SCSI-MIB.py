...
Counter64, NotificationType, Bits, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, IpAddress, Integer32, iso, Gauge32, Counter32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Bits", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "IpAddress", "Integer32", "iso", "Gauge32", "Counter32", "MibIdentifier", "ModuleIdentity")
TextualConvention, AutonomousType, DisplayString, TruthValue, RowStatus, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "TruthValue", "RowStatus", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGroups=scsiGroups, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtName=scsiDscTgtName, scsiDeviceResets=scsiDeviceResets, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTranportOther=scsiTranportOther, scsiGeneral=scsiGeneral, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteTarget=scsiRemoteTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiator=scsiInitiator, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSBP=scsiTransportSBP, scsiLuStatus=scsiLuStatus, scsiInstIndex=scsiInstIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliances=scsiCompliances, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrName=scsiAuthIntrName, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiConformance=scsiConformance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptType=scsiTrnsptType, ScsiIdType=ScsiIdType, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportTypes=scsiTransportTypes, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuState=scsiLuState, scsiCompliance=scsiCompliance, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiLuInResets=scsiLuInResets, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuEntry=scsiLuEntry, scsiIntrDevTable=scsiIntrDevTable, scsiPortIndex=scsiPortIndex, scsiTgtPortName=scsiTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtName=scsiIntrPrtName, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuTable=scsiLuTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdentifier=ScsiIdentifier, ScsiName=ScsiName, scsiLuWwnName=scsiLuWwnName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortRole=scsiPortRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunEntry=scsiDscLunEntry)
