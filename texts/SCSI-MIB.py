...
mib_2, Counter32, iso, TimeTicks, ObjectIdentity, ModuleIdentity, Bits, Gauge32, Counter64, MibIdentifier, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "iso", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Bits", "Gauge32", "Counter64", "MibIdentifier", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32")
AutonomousType, TruthValue, DisplayString, TextualConvention, TimeStamp, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "DisplayString", "TextualConvention", "TimeStamp", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiGroups=scsiGroups, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSBP=scsiTransportSBP, scsiLunMapGroup=scsiLunMapGroup, scsiInitiator=scsiInitiator, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdValue=scsiLuIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstAlias=scsiInstAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdTable=scsiLuIdTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuVendorId=scsiLuVendorId, scsiTgtPortTable=scsiTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtName=scsiDscTgtName, scsiLuRevisionId=scsiLuRevisionId, scsiCompliance=scsiCompliance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiDeviceEntry=scsiDeviceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportOther=scsiTranportOther, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliances=scsiCompliances, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdType=scsiLuIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiConformance=scsiConformance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuState=scsiLuState, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortEntry=scsiPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIndex=scsiLuIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstIndex=scsiInstIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdValue=ScsiIdValue, scsiLuProductId=scsiLuProductId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceTable=scsiInstanceTable, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapTable=scsiLunMapTable, scsiModule=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiGeneral=scsiGeneral, scsiTarget=scsiTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetGroup=scsiTargetGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInResets=scsiLuInResets, scsiLunMapLun=scsiLunMapLun, scsiLuWwnName=scsiLuWwnName, scsiNotifications=scsiNotifications, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuEntry=scsiLuEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, scsiDeviceRole=scsiDeviceRole, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunLun=scsiDscLunLun, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiName=ScsiName, scsiTransportFCP=scsiTransportFCP)
