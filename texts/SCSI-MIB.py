...
Bits, ModuleIdentity, iso, Gauge32, ObjectIdentity, IpAddress, Counter32, TimeTicks, MibIdentifier, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "iso", "Gauge32", "ObjectIdentity", "IpAddress", "Counter32", "TimeTicks", "MibIdentifier", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Unsigned32")
TruthValue, RowStatus, DisplayString, AutonomousType, TextualConvention, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportOther=scsiTranportOther, scsiTgtPortName=scsiTgtPortName, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtName=scsiDscTgtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstAlias=scsiInstAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiPortIndex=scsiPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtConfigured=scsiDscTgtConfigured, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInResets=scsiLuInResets, scsiInstIndex=scsiInstIndex, scsiLuWwnName=scsiLuWwnName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunTable=scsiDscLunTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdType=scsiLuIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliances=scsiCompliances, scsiTrnsptType=scsiTrnsptType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuProductId=scsiLuProductId, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiName=ScsiName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceRole=scsiDeviceRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetGroup=scsiTargetGroup, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, ScsiIdType=ScsiIdType, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIndex=scsiDscLunIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiLuIdTable=scsiLuIdTable, scsiInstanceTable=scsiInstanceTable, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortName=scsiAttTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuEntry=scsiLuEntry, scsiModule=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiGeneral=scsiGeneral, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTarget=scsiTarget, scsiLuIndex=scsiLuIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortTable=scsiPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands)
