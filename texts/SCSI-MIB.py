...
Counter32, iso, Integer32, TimeTicks, MibIdentifier, Counter64, Gauge32, NotificationType, Unsigned32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Integer32", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32", "NotificationType", "Unsigned32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "mib-2")
TextualConvention, RowPointer, TimeStamp, RowStatus, TruthValue, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "TimeStamp", "RowStatus", "TruthValue", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdentifier=ScsiIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiObjects=scsiObjects, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiLuState=scsiLuState, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceResets=scsiDeviceResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetGroup=scsiTargetGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortEntry=scsiPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatus=scsiLuStatus, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiConformance=scsiConformance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGeneral=scsiGeneral, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiModule=scsiModule, scsiPortIndex=scsiPortIndex, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunTable=scsiDscLunTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapLun=scsiLunMapLun, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiTarget=scsiTarget, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIndex=scsiLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportOther=scsiTranportOther, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdType=scsiLuIdType, scsiGroups=scsiGroups, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuVendorId=scsiLuVendorId, scsiPortTable=scsiPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiTranportSPI=scsiTranportSPI, scsiCompliance=scsiCompliance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportTypes=scsiTransportTypes, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiInstanceEntry=scsiInstanceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuProductId=scsiLuProductId, scsiDeviceIndex=scsiDeviceIndex, ScsiIdValue=ScsiIdValue, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortRole=scsiPortRole, ScsiName=ScsiName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort)
