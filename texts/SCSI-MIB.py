...
TextualConvention, RowPointer, TimeStamp, DisplayString, TruthValue, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "TimeStamp", "DisplayString", "TruthValue", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGroups=scsiGroups, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevEntry=scsiIntrDevEntry, ScsiName=ScsiName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapTable=scsiLunMapTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiObjects=scsiObjects, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapIndex=scsiLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortName=scsiTgtPortName, scsiTrnsptType=scsiTrnsptType, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiPortEntry=scsiPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtName=scsiDscTgtName, ScsiIdentifier=ScsiIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteTarget=scsiRemoteTarget, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiPortRole=scsiPortRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiLuInResets=scsiLuInResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiConformance=scsiConformance, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIndex=scsiLuIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotifications=scsiNotifications, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuState=scsiLuState, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceTable=scsiInstanceTable, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTable=scsiPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiLuStatus=scsiLuStatus, ScsiIdValue=ScsiIdValue)
