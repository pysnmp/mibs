...
NotificationType, Gauge32, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, TimeTicks, Counter32, Counter64, Bits, ObjectIdentity, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "TimeTicks", "Counter32", "Counter64", "Bits", "ObjectIdentity", "ModuleIdentity", "iso")
RowStatus, TruthValue, TimeStamp, DisplayString, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "DisplayString", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceResets=scsiDeviceResets, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiModule=scsiModule, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiConformance=scsiConformance, scsiLuProductId=scsiLuProductId, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuIdEntry=scsiLuIdEntry, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiGeneral=scsiGeneral, scsiLuWwnName=scsiLuWwnName, ScsiIdentifier=ScsiIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliances=scsiCompliances, scsiTargetGroup=scsiTargetGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptType=scsiTrnsptType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiCompliance=scsiCompliance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, scsiLuState=scsiLuState, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTable=scsiPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuEntry=scsiLuEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiLuIdType=scsiLuIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuPeripheralType=scsiLuPeripheralType, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiObjects=scsiObjects, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunLun=scsiDscLunLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiInstAlias=scsiInstAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortRole=scsiPortRole, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortBusyStatuses=scsiPortBusyStatuses, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortName=scsiTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiPortIndex=scsiPortIndex, scsiNotifications=scsiNotifications, scsiDeviceAlias=scsiDeviceAlias)
