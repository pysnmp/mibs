...
ModuleIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, TimeTicks, mib_2, ObjectIdentity, Unsigned32, Counter64, Bits, MibIdentifier, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "TimeTicks", "mib-2", "ObjectIdentity", "Unsigned32", "Counter64", "Bits", "MibIdentifier", "Integer32", "IpAddress")
TextualConvention, AutonomousType, RowPointer, RowStatus, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowPointer", "RowStatus", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortTable=scsiTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, scsiLuProductId=scsiLuProductId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptDevName=scsiTrnsptDevName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceIndex=scsiDeviceIndex, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptType=scsiTrnsptType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiConformance=scsiConformance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuState=scsiLuState, scsiPortIndex=scsiPortIndex, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceEntry=scsiDeviceEntry, scsiLuHSInCommands=scsiLuHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdType=ScsiIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInResets=scsiLuInResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptTable=scsiTrnsptTable, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiLuIdValue=scsiLuIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstIndex=scsiInstIndex, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiator=scsiInitiator, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuInCommands=scsiLuInCommands, scsiGroups=scsiGroups, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTable=scsiPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIndex=scsiLuIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunTable=scsiDscLunTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunEntry=scsiDscLunEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuTable=scsiLuTable, scsiTransportTypes=scsiTransportTypes, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtName=scsiIntrPrtName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuRevisionId=scsiLuRevisionId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceGroup=scsiDeviceGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatus=scsiLuStatus, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotifications=scsiNotifications, scsiLunMapLun=scsiLunMapLun, ScsiName=ScsiName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortRole=scsiPortRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiGeneral=scsiGeneral, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceRole=scsiDeviceRole, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry)
