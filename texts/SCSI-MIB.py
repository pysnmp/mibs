...
Counter32, Integer32, Counter64, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, TimeTicks, Bits, mib_2, Unsigned32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Counter64", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "TimeTicks", "Bits", "mib-2", "Unsigned32", "ObjectIdentity", "MibIdentifier")
TimeStamp, TextualConvention, AutonomousType, RowPointer, RowStatus, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "AutonomousType", "RowPointer", "RowStatus", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotifications=scsiNotifications, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiConformance=scsiConformance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuInResets=scsiLuInResets, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdTable=scsiDscLunIdTable, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiTarget=scsiTarget, scsiLuVendorId=scsiLuVendorId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportFCP=scsiTransportFCP, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiCompliances=scsiCompliances, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, ScsiIdentifier=ScsiIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiGeneral=scsiGeneral, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiObjects=scsiObjects, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptTable=scsiTrnsptTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuState=scsiLuState, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdType=scsiLuIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceAlias=scsiDeviceAlias, scsiLuWwnName=scsiLuWwnName, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunEntry=scsiDscLunEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstAlias=scsiInstAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiator=scsiInitiator, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceTable=scsiInstanceTable, scsiInstIndex=scsiInstIndex, scsiPortRole=scsiPortRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatus=scsiLuStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTable=scsiPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortIndex=scsiPortIndex, scsiDscTgtName=scsiDscTgtName, scsiLuEntry=scsiLuEntry, scsiDscLunIndex=scsiDscLunIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiModule=scsiModule, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiTranportOther=scsiTranportOther, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiGroups=scsiGroups, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue)
