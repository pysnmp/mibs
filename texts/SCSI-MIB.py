...
IpAddress, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, MibIdentifier, Counter32, mib_2, ObjectIdentity, NotificationType, ModuleIdentity, Bits, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "MibIdentifier", "Counter32", "mib-2", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Bits", "TimeTicks", "iso")
TextualConvention, RowPointer, RowStatus, TruthValue, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "RowStatus", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiGroups=scsiGroups, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstIndex=scsiInstIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdType=ScsiIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, scsiLuProductId=scsiLuProductId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstAlias=scsiInstAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiator=scsiInitiator, scsiLuEntry=scsiLuEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiTranportOther=scsiTranportOther, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiInstVendorVersion=scsiInstVendorVersion, scsiModule=scsiModule, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIndex=scsiLuIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGeneral=scsiGeneral, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliances=scsiCompliances, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceAlias=scsiDeviceAlias, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtTable=scsiDscTgtTable, scsiLuInCommands=scsiLuInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuTable=scsiLuTable, scsiLuState=scsiLuState, scsiDscLunIdType=scsiDscLunIdType, ScsiName=ScsiName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiObjects=scsiObjects, scsiDscLunTable=scsiDscLunTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, ScsiIdentifier=ScsiIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtName=scsiDscTgtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportFCP=scsiTransportFCP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiLunMapTable=scsiLunMapTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdTable=scsiLuIdTable, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, scsiLunMapGroup=scsiLunMapGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiLunMapLun=scsiLunMapLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatus=scsiLuStatus)
