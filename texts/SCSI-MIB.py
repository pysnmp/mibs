...
ModuleIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Bits, NotificationType, Counter32, Integer32, mib_2, Gauge32, Unsigned32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Bits", "NotificationType", "Counter32", "Integer32", "mib-2", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64")
AutonomousType, TruthValue, TimeStamp, RowPointer, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdEntry=scsiLuIdEntry, scsiLuInCommands=scsiLuInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIndexValue=ScsiIndexValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiator=scsiInitiator, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLun=scsiLunMapLun, scsiTransportSBP=scsiTransportSBP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdValue=scsiLuIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuState=scsiLuState, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIndex=scsiDscLunIndex, ScsiName=ScsiName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiTranportOther=scsiTranportOther, scsiLuProductId=scsiLuProductId, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatus=scsiLuStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTarget=scsiTarget, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdentifier=ScsiIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiInstAlias=scsiInstAlias, scsiConformance=scsiConformance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtName=scsiIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetGroup=scsiTargetGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunLun=scsiDscLunLun, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliances=scsiCompliances, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapEntry=scsiLunMapEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInResets=scsiLuInResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortIndex=scsiPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, scsiLuIdIndex=scsiLuIdIndex, ScsiIdType=ScsiIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortRole=scsiPortRole, scsiPortTable=scsiPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuRevisionId=scsiLuRevisionId, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuEntry=scsiLuEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortTable=scsiTgtPortTable)
