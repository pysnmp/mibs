...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Integer32, TimeTicks, ModuleIdentity, Unsigned32, NotificationType, Counter32, MibIdentifier, mib_2, Bits, iso, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Integer32", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter32", "MibIdentifier", "mib-2", "Bits", "iso", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, scsiPortTable=scsiPortTable, scsiLuIndex=scsiLuIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdTable=scsiLuIdTable, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuInResets=scsiLuInResets, scsiLuVendorId=scsiLuVendorId, scsiModule=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliance=scsiCompliance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiLuTable=scsiLuTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdType=scsiDscLunIdType, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdType=ScsiIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortIndex=scsiPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceTable=scsiDeviceTable, scsiObjects=scsiObjects, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiName=ScsiName, scsiInstanceEntry=scsiInstanceEntry, scsiInitiator=scsiInitiator, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGeneral=scsiGeneral, scsiTransportFCP=scsiTransportFCP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdType=scsiLuIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuState=scsiLuState, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportISCSI=scsiTransportISCSI, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiLunMapGroup=scsiLunMapGroup, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotifications=scsiNotifications, ScsiIndexValue=ScsiIndexValue, scsiLuEntry=scsiLuEntry, scsiCompliances=scsiCompliances, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiLunMapIndex=scsiLunMapIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiPortRole=scsiPortRole)
