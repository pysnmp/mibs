...
MibIdentifier, Unsigned32, Gauge32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, iso, mib_2, ModuleIdentity, ObjectIdentity, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Gauge32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "iso", "mib-2", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "IpAddress", "NotificationType")
RowStatus, TimeStamp, RowPointer, AutonomousType, DisplayString, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliance=scsiCompliance, scsiModule=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportFCP=scsiTransportFCP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSRP=scsiTransportSRP, scsiLuEntry=scsiLuEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportTypes=scsiTransportTypes, scsiDscTgtTable=scsiDscTgtTable, scsiConformance=scsiConformance, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiPortTable=scsiPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapGroup=scsiLunMapGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuProductId=scsiLuProductId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptDevName=scsiTrnsptDevName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiator=scsiInitiator, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiObjects=scsiObjects, scsiTrnsptType=scsiTrnsptType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuState=scsiLuState, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtTable=scsiIntrPrtTable, scsiGeneral=scsiGeneral, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIndex=scsiLuIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrName=scsiAuthIntrName, ScsiIdType=ScsiIdType, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiCompliances=scsiCompliances, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiTarget=scsiTarget, scsiLuIdType=scsiLuIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetGroup=scsiTargetGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortEntry=scsiPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiLuInResets=scsiLuInResets)
