...
Integer32, mib_2, iso, ModuleIdentity, Bits, MibIdentifier, Counter64, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ObjectIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "iso", "ModuleIdentity", "Bits", "MibIdentifier", "Counter64", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ObjectIdentity", "IpAddress", "TimeTicks")
RowPointer, TextualConvention, RowStatus, DisplayString, TruthValue, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuState=scsiLuState, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdEntry=scsiLuIdEntry, scsiPortEntry=scsiPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInitiator=scsiInitiator, scsiTgtDevEntry=scsiTgtDevEntry, scsiGroups=scsiGroups, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdType=ScsiIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdValue=ScsiIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiLuEntry=scsiLuEntry, scsiTransportSBP=scsiTransportSBP, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiNotifications=scsiNotifications, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTranportOther=scsiTranportOther, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiLuTable=scsiLuTable, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiObjects=scsiObjects, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiPortTable=scsiPortTable, scsiLogicalUnit=scsiLogicalUnit, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunLun=scsiDscLunLun, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdTable=scsiLuIdTable, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunTable=scsiDscLunTable, ScsiIndexValue=ScsiIndexValue, scsiLuVendorId=scsiLuVendorId, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtName=scsiDscTgtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiTarget=scsiTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliances=scsiCompliances, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstIndex=scsiInstIndex, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceEntry=scsiDeviceEntry)
