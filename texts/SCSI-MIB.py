...
IpAddress, Counter32, Gauge32, TimeTicks, ObjectIdentity, Unsigned32, NotificationType, Counter64, iso, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Gauge32", "TimeTicks", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter64", "iso", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Integer32")
RowPointer, TextualConvention, RowStatus, TruthValue, AutonomousType, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiRemoteInitiators=scsiRemoteInitiators, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, ScsiIndexValue=ScsiIndexValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuVendorId=scsiLuVendorId, scsiNotifications=scsiNotifications, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetStatsGroup=scsiTargetStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiLuProductId=scsiLuProductId, scsiPortRole=scsiPortRole, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtName=scsiDscTgtName, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTarget=scsiTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSBP=scsiTransportSBP, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortIndex=scsiPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLuWwnName=scsiLuWwnName, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdValue=ScsiIdValue, scsiTargetGroup=scsiTargetGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuStatus=scsiLuStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLuState=scsiLuState, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiConformance=scsiConformance, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdType=scsiLuIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiGroups=scsiGroups, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiObjects=scsiObjects, scsiCompliance=scsiCompliance, scsiPortTable=scsiPortTable, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstAlias=scsiInstAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiModule=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstIndex=scsiInstIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortName=scsiTgtPortName, scsiLuInResets=scsiLuInResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdTable=scsiLuIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptType=scsiTrnsptType, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiName=ScsiName, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdentifier=ScsiIdentifier, scsiLuEntry=scsiLuEntry, scsiDeviceResets=scsiDeviceResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero)
