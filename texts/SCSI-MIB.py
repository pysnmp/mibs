...
Integer32, Counter64, TimeTicks, NotificationType, iso, ModuleIdentity, IpAddress, Bits, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "TimeTicks", "NotificationType", "iso", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter32", "Unsigned32")
TextualConvention, TruthValue, DisplayString, RowPointer, TimeStamp, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "RowPointer", "TimeStamp", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortIndex=scsiPortIndex, scsiLuInCommands=scsiLuInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiPortRole=scsiPortRole, ScsiIdValue=ScsiIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportOther=scsiTranportOther, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstAlias=scsiInstAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliance=scsiCompliance, scsiInitiator=scsiInitiator, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, scsiCompliances=scsiCompliances, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiLunMapTable=scsiLunMapTable, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiObjects=scsiObjects, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiDscTgtTable=scsiDscTgtTable, ScsiName=ScsiName, scsiLuTable=scsiLuTable, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuProductId=scsiLuProductId, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportSRP=scsiTransportSRP, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuState=scsiLuState, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceGroup=scsiDeviceGroup, ScsiIdType=ScsiIdType, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapLun=scsiLunMapLun, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiNotifications=scsiNotifications, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdTable=scsiLuIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportISCSI=scsiTransportISCSI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuVendorId=scsiLuVendorId, scsiGeneral=scsiGeneral, scsiDscLunIdType=scsiDscLunIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes)
