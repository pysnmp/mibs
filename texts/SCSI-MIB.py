...
MibIdentifier, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Gauge32, Counter64, mib_2, iso, TimeTicks, Unsigned32, ObjectIdentity, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "mib-2", "iso", "TimeTicks", "Unsigned32", "ObjectIdentity", "Integer32", "Bits")
RowPointer, TimeStamp, RowStatus, TruthValue, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "RowStatus", "TruthValue", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptTable=scsiTrnsptTable, scsiLuInCommands=scsiLuInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiCompliances=scsiCompliances, scsiInstIndex=scsiInstIndex, scsiLuIdTable=scsiLuIdTable, scsiLuTable=scsiLuTable, scsiGroups=scsiGroups, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiModule=scsiModule, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiDscTgtName=scsiDscTgtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, ScsiIdValue=ScsiIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportSPI=scsiTranportSPI, ScsiIndexValue=ScsiIndexValue, scsiTranportOther=scsiTranportOther, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiConformance=scsiConformance, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortRole=scsiPortRole, scsiLuWwnName=scsiLuWwnName, scsiLuIdType=scsiLuIdType, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuVendorId=scsiLuVendorId, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportFCP=scsiTransportFCP, scsiTransportSBP=scsiTransportSBP, scsiGeneral=scsiGeneral, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuProductId=scsiLuProductId, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiTransportTypes=scsiTransportTypes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTarget=scsiTarget, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuState=scsiLuState, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortIndex=scsiPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotifications=scsiNotifications, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiator=scsiInitiator, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIndex=scsiLuIndex, ScsiIdType=ScsiIdType, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSRP=scsiTransportSRP, scsiDscTgtIndex=scsiDscTgtIndex)
