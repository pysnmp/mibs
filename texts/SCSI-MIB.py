...
IpAddress, Unsigned32, Counter64, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ObjectIdentity, Counter32, Bits, ModuleIdentity, mib_2, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Counter64", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32", "Bits", "ModuleIdentity", "mib-2", "TimeTicks", "iso")
DisplayString, TruthValue, RowPointer, RowStatus, TextualConvention, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowPointer", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTarget=scsiTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiPortTable=scsiPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiCompliance=scsiCompliance, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortIndex=scsiPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiGroups=scsiGroups, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuTable=scsiLuTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapTable=scsiLunMapTable, PYSNMP_MODULE_ID=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInCommands=scsiLuInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunTable=scsiDscLunTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSRP=scsiTransportSRP, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiDscTgtName=scsiDscTgtName, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiInitiator=scsiInitiator, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotifications=scsiNotifications, scsiTgtPortName=scsiTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportOther=scsiTranportOther, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTransportISCSI=scsiTransportISCSI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdType=ScsiIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiModule=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiLuInResets=scsiLuInResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured)
