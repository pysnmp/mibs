...
Integer32, Counter32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, ModuleIdentity, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, Unsigned32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "ModuleIdentity", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32", "iso", "Gauge32")
TextualConvention, AutonomousType, DisplayString, TimeStamp, RowPointer, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "TimeStamp", "RowPointer", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiLuState=scsiLuState, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiModule=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiTargetGroup=scsiTargetGroup, PYSNMP_MODULE_ID=scsiModule, scsiCompliance=scsiCompliance, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLun=scsiLunMapLun, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiator=scsiInitiator, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuTable=scsiLuTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstAlias=scsiInstAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdType=ScsiIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTable=scsiPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiGeneral=scsiGeneral, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIndex=scsiLuIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTranportOther=scsiTranportOther, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptTable=scsiTrnsptTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdType=scsiLuIdType, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstIndex=scsiInstIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInCommands=scsiLuInCommands, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiCompliances=scsiCompliances, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuEntry=scsiLuEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiObjects=scsiObjects, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatus=scsiTgtDeviceStatus)
