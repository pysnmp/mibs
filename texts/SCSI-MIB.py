...
TimeTicks, Bits, iso, IpAddress, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, MibIdentifier, Counter64, mib_2, Integer32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "iso", "IpAddress", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "MibIdentifier", "Counter64", "mib-2", "Integer32", "NotificationType", "ObjectIdentity")
RowPointer, TimeStamp, TextualConvention, AutonomousType, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, scsiInstIndex=scsiInstIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValue=ScsiIndexValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuTable=scsiLuTable, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetGroup=scsiTargetGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdValue=ScsiIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuProductId=scsiLuProductId, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceEntry=scsiDeviceEntry, scsiCompliances=scsiCompliances, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTranportOther=scsiTranportOther, scsiConformance=scsiConformance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiLuInResets=scsiLuInResets, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdEntry=scsiLuIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdType=scsiLuIdType, scsiDscLunIndex=scsiDscLunIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuEntry=scsiLuEntry, scsiObjects=scsiObjects, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSRP=scsiTransportSRP, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuState=scsiLuState, scsiDeviceResets=scsiDeviceResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortIndex=scsiPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteTarget=scsiRemoteTarget, scsiPortTable=scsiPortTable, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiDscLunLun=scsiDscLunLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevEntry=scsiIntrDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiator=scsiInitiator, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortRole=scsiPortRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiModule=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportTypes=scsiTransportTypes)
