...
iso, ObjectIdentity, Integer32, TimeTicks, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, IpAddress, Unsigned32, NotificationType, Counter64, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Integer32", "TimeTicks", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "IpAddress", "Unsigned32", "NotificationType", "Counter64", "MibIdentifier", "ModuleIdentity")
AutonomousType, RowStatus, TimeStamp, TextualConvention, TruthValue, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetGroup=scsiTargetGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportFCP=scsiTransportFCP, scsiLunMapEntry=scsiLunMapEntry, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortEntry=scsiPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdTable=scsiLuIdTable, scsiTarget=scsiTarget, ScsiName=ScsiName, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuVendorId=scsiLuVendorId, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSRP=scsiTransportSRP, scsiDscLunTable=scsiDscLunTable, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortTable=scsiPortTable, scsiConformance=scsiConformance, scsiDeviceResets=scsiDeviceResets, scsiInitiator=scsiInitiator, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiCompliance=scsiCompliance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdentifier=ScsiIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiObjects=scsiObjects, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportOther=scsiTranportOther, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiTrnsptType=scsiTrnsptType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstAlias=scsiInstAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortName=scsiTgtPortName)
