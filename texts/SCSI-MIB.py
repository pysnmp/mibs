...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, TimeTicks, mib_2, NotificationType, Bits, Unsigned32, ObjectIdentity, Integer32, IpAddress, MibIdentifier, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "TimeTicks", "mib-2", "NotificationType", "Bits", "Unsigned32", "ObjectIdentity", "Integer32", "IpAddress", "MibIdentifier", "Counter32", "ModuleIdentity")
TextualConvention, DisplayString, AutonomousType, TimeStamp, RowPointer, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "AutonomousType", "TimeStamp", "RowPointer", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSBP=scsiTransportSBP, scsiGroups=scsiGroups, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiModule=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunTable=scsiDscLunTable, scsiTransportISCSI=scsiTransportISCSI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortTable=scsiTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstAlias=scsiInstAlias, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuStatus=scsiLuStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIndex=scsiLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiTarget=scsiTarget, scsiTrnsptType=scsiTrnsptType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdType=scsiLuIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, scsiInstanceEntry=scsiInstanceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtName=scsiDscTgtName, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuState=scsiLuState, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportTypes=scsiTransportTypes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstIndex=scsiInstIndex, scsiDeviceEntry=scsiDeviceEntry, scsiPortTable=scsiPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiator=scsiInitiator, scsiDscLunIdTable=scsiDscLunIdTable, ScsiName=ScsiName, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdAssociation=ScsiIdAssociation, scsiGeneral=scsiGeneral, scsiLuIdValue=scsiLuIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortName=scsiTgtPortName, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuInResets=scsiLuInResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliance=scsiCompliance, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuEntry=scsiLuEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLuInCommands=scsiLuInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, PYSNMP_MODULE_ID=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortEntry=scsiPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportOther=scsiTranportOther, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiCompliances=scsiCompliances, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiObjects=scsiObjects, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunLun=scsiDscLunLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
