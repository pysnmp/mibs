...
TimeTicks, Gauge32, Integer32, ModuleIdentity, mib_2, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Counter64, ObjectIdentity, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Integer32", "ModuleIdentity", "mib-2", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Counter64", "ObjectIdentity", "iso", "Counter32", "Bits")
AutonomousType, RowPointer, TimeStamp, TextualConvention, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTarget=scsiTarget, scsiTransportTypes=scsiTransportTypes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceResets=scsiDeviceResets, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiGroups=scsiGroups, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstAlias=scsiInstAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiName=ScsiName, scsiDscLunTable=scsiDscLunTable, scsiGeneral=scsiGeneral, scsiTgtPortName=scsiTgtPortName, scsiCompliances=scsiCompliances, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceEntry=scsiDeviceEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIndex=scsiLuIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapEntry=scsiLunMapEntry, ScsiIdValue=ScsiIdValue, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLun=scsiLunMapLun, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuInResets=scsiLuInResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdType=scsiLuIdType, scsiLuIdEntry=scsiLuIdEntry, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiModule=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWwnName=scsiLuWwnName, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliance=scsiCompliance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortEntry=scsiPortEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiConformance=scsiConformance, scsiTransportFCP=scsiTransportFCP, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstIndex=scsiInstIndex, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiLuState=scsiLuState, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiObjects=scsiObjects, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiLuVendorId=scsiLuVendorId, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, scsiInitiator=scsiInitiator, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes)
