...
Unsigned32, ModuleIdentity, mib_2, ObjectIdentity, IpAddress, Integer32, TimeTicks, NotificationType, Counter64, Counter32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "mib-2", "ObjectIdentity", "IpAddress", "Integer32", "TimeTicks", "NotificationType", "Counter64", "Counter32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier")
AutonomousType, TruthValue, TextualConvention, RowStatus, DisplayString, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdAssociation=ScsiIdAssociation, scsiCompliances=scsiCompliances, scsiLuTable=scsiLuTable, scsiLuVendorId=scsiLuVendorId, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiator=scsiInitiator, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, scsiPortEntry=scsiPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatus=scsiLuStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportOther=scsiTranportOther, scsiInstIndex=scsiInstIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceEntry=scsiInstanceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiDeviceResets=scsiDeviceResets, scsiLuIdType=scsiLuIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptEntry=scsiTrnsptEntry, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGeneral=scsiGeneral, scsiConformance=scsiConformance, scsiPortIndex=scsiPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInCommands=scsiLuInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiGroups=scsiGroups, ScsiIdValue=ScsiIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLun=scsiLunMapLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiObjects=scsiObjects, scsiTarget=scsiTarget, ScsiName=ScsiName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiLuEntry=scsiLuEntry, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuProductId=scsiLuProductId, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, PYSNMP_MODULE_ID=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtTable=scsiDscTgtTable, scsiLuWwnName=scsiLuWwnName, scsiLuIdValue=scsiLuIdValue, scsiTransportSRP=scsiTransportSRP, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun)
