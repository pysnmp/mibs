...
mib_2, iso, ModuleIdentity, ObjectIdentity, MibIdentifier, Unsigned32, Gauge32, Bits, Counter32, TimeTicks, IpAddress, Counter64, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Gauge32", "Bits", "Counter32", "TimeTicks", "IpAddress", "Counter64", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, RowStatus, TruthValue, AutonomousType, DisplayString, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuTable=scsiLuTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotifications=scsiNotifications, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTable=scsiPortTable, scsiPortEntry=scsiPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiDscTgtName=scsiDscTgtName, scsiPortRole=scsiPortRole, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSBP=scsiTransportSBP, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiObjects=scsiObjects, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliance=scsiCompliance, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiGroups=scsiGroups, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatus=scsiLuStatus, ScsiIndexValue=ScsiIndexValue, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetGroup=scsiTargetGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiTarget=scsiTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportSPI=scsiTranportSPI, scsiLuProductId=scsiLuProductId, scsiTrnsptType=scsiTrnsptType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiCompliances=scsiCompliances, scsiLuIdIndex=scsiLuIdIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiConformance=scsiConformance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes)
