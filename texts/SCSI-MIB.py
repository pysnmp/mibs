...
Integer32, Bits, TimeTicks, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter32, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Gauge32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter32", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Gauge32", "NotificationType", "IpAddress")
TimeStamp, RowStatus, AutonomousType, DisplayString, TextualConvention, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "AutonomousType", "DisplayString", "TextualConvention", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiPortIndex=scsiPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdType=ScsiIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortRole=scsiPortRole, scsiLuIndex=scsiLuIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportTypes=scsiTransportTypes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotifications=scsiNotifications, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatus=scsiLuStatus, scsiLuIdEntry=scsiLuIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportSPI=scsiTranportSPI, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceTable=scsiDeviceTable, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGroups=scsiGroups, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliances=scsiCompliances, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiTransportFCP=scsiTransportFCP, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdValue=scsiLuIdValue, ScsiIndexValue=ScsiIndexValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiator=scsiInitiator, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiModule=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiCompliance=scsiCompliance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunLun=scsiDscLunLun, scsiLuTable=scsiLuTable, scsiTarget=scsiTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrName=scsiAuthIntrName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiName=ScsiName, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunEntry=scsiDscLunEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiConformance=scsiConformance, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdTable=scsiLuIdTable)
