...
MibIdentifier, NotificationType, TimeTicks, ObjectIdentity, Counter32, Bits, Gauge32, Integer32, IpAddress, iso, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter32", "Bits", "Gauge32", "Integer32", "IpAddress", "iso", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2")
TruthValue, TextualConvention, RowStatus, DisplayString, RowPointer, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "RowPointer", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", PYSNMP_MODULE_ID=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunTable=scsiDscLunTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiDeviceResets=scsiDeviceResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdType=ScsiIdType, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiTrnsptType=scsiTrnsptType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiModule=scsiModule, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuState=scsiLuState, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIndex=scsiLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTarget=scsiTarget, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotifications=scsiNotifications, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliances=scsiCompliances, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiGeneral=scsiGeneral, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiCompliance=scsiCompliance, scsiConformance=scsiConformance, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiDscTgtTable=scsiDscTgtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuInResets=scsiLuInResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, ScsiName=ScsiName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtName=scsiDscTgtName, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptTable=scsiTrnsptTable, ScsiIdAssociation=ScsiIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceGroup=scsiDeviceGroup, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiInstIndex=scsiInstIndex, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdType=scsiLuIdType, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiator=scsiInitiator, scsiDeviceAlias=scsiDeviceAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdValue=scsiLuIdValue, scsiLuTable=scsiLuTable, scsiIntrDevTable=scsiIntrDevTable, scsiInstAlias=scsiInstAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiLuEntry=scsiLuEntry, scsiObjects=scsiObjects, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiPortIndex=scsiPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtName=scsiIntrPrtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetGroup=scsiTargetGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevTable=scsiTgtDevTable)
