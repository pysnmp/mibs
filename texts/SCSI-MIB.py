...
IpAddress, Counter64, Gauge32, Integer32, MibIdentifier, mib_2, TimeTicks, Bits, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Gauge32", "Integer32", "MibIdentifier", "mib-2", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "iso", "NotificationType")
AutonomousType, TextualConvention, DisplayString, TruthValue, TimeStamp, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiPortRole=scsiPortRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWwnName=scsiLuWwnName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, scsiLuIdType=scsiLuIdType, scsiModule=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstAlias=scsiInstAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiRemoteTarget=scsiRemoteTarget, scsiCompliances=scsiCompliances, scsiTransportTypes=scsiTransportTypes, scsiDeviceAlias=scsiDeviceAlias, scsiTargetGroup=scsiTargetGroup, scsiObjects=scsiObjects, scsiInstIndex=scsiInstIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunTable=scsiDscLunTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, ScsiIdType=ScsiIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportFCP=scsiTransportFCP, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSRP=scsiTransportSRP, scsiInitiator=scsiInitiator, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTarget=scsiTarget, scsiConformance=scsiConformance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortName=scsiTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortEntry=scsiPortEntry, scsiLunMapLun=scsiLunMapLun, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportOther=scsiTranportOther, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIndex=scsiLuIndex, scsiLuVendorId=scsiLuVendorId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiLuState=scsiLuState, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdValue=scsiLuIdValue, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuProductId=scsiLuProductId, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiGeneral=scsiGeneral, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdIndex=scsiLuIdIndex, scsiPortTable=scsiPortTable, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuTable=scsiLuTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiNotifications=scsiNotifications, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportSPI=scsiTranportSPI, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceResets=scsiDeviceResets, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry)
