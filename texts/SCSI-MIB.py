...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, TimeTicks, Gauge32, MibIdentifier, ModuleIdentity, NotificationType, Bits, Counter32, IpAddress, ObjectIdentity, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "TimeTicks", "Gauge32", "MibIdentifier", "ModuleIdentity", "NotificationType", "Bits", "Counter32", "IpAddress", "ObjectIdentity", "iso", "Unsigned32")
AutonomousType, TruthValue, RowStatus, TimeStamp, TextualConvention, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotifications=scsiNotifications, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtName=scsiDscTgtName, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdentifier=ScsiIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdAssociation=ScsiIdAssociation, scsiPortRole=scsiPortRole, scsiTranportSPI=scsiTranportSPI, scsiDscTgtIndex=scsiDscTgtIndex, scsiModule=scsiModule, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtName=scsiIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTable=scsiPortTable, scsiPortIndex=scsiPortIndex, scsiLunMapLun=scsiLunMapLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortTable=scsiTgtPortTable, scsiObjects=scsiObjects, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiCompliances=scsiCompliances, scsiLuIdValue=scsiLuIdValue, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdValue=ScsiIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, ScsiIdType=ScsiIdType, scsiTgtPortName=scsiTgtPortName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdType=scsiLuIdType, scsiInstanceTable=scsiInstanceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIndex=scsiLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstIndex=scsiInstIndex, scsiTransportTypes=scsiTransportTypes, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuTable=scsiLuTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuProductId=scsiLuProductId, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiName=ScsiName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiPortEntry=scsiPortEntry, scsiLuInCommands=scsiLuInCommands, scsiLuStatus=scsiLuStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuInResets=scsiLuInResets, scsiLuEntry=scsiLuEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiGeneral=scsiGeneral, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptType=scsiTrnsptType, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, scsiLunMapTable=scsiLunMapTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTarget=scsiTarget, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiGroups=scsiGroups, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands)
