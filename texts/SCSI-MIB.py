...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32, mib_2, Bits, IpAddress, NotificationType, Counter64, TimeTicks, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32", "mib-2", "Bits", "IpAddress", "NotificationType", "Counter64", "TimeTicks", "Integer32", "Gauge32")
DisplayString, TimeStamp, RowPointer, AutonomousType, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowPointer", "AutonomousType", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunTable=scsiDscLunTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceResets=scsiDeviceResets, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdType=ScsiIdType, scsiLuIdEntry=scsiLuIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWwnName=scsiLuWwnName, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdentifier=ScsiIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportTypes=scsiTransportTypes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceTable=scsiInstanceTable, scsiDeviceAlias=scsiDeviceAlias, scsiLuInCommands=scsiLuInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotifications=scsiNotifications, scsiTranportOther=scsiTranportOther, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortRole=scsiPortRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetGroup=scsiTargetGroup, scsiDeviceTable=scsiDeviceTable, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiConformance=scsiConformance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapLun=scsiLunMapLun, scsiLuEntry=scsiLuEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTarget=scsiTarget, PYSNMP_MODULE_ID=scsiModule, ScsiIdValue=ScsiIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiObjects=scsiObjects, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiPortEntry=scsiPortEntry, scsiLuInResets=scsiLuInResets, scsiLuTable=scsiLuTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunLun=scsiDscLunLun, scsiPortTable=scsiPortTable, scsiLuProductId=scsiLuProductId, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtName=scsiIntrPrtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiator=scsiInitiator, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortTable=scsiTgtPortTable, scsiLuState=scsiLuState, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiTransportSRP=scsiTransportSRP, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
