...
Integer32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ObjectIdentity, Unsigned32, mib_2, MibIdentifier, iso, ModuleIdentity, TimeTicks, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "mib-2", "MibIdentifier", "iso", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter64")
AutonomousType, TextualConvention, TimeStamp, RowPointer, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TimeStamp", "RowPointer", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptType=scsiTrnsptType, ScsiIndexValue=ScsiIndexValue, scsiRemoteTarget=scsiRemoteTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapTable=scsiLunMapTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTransportFCP=scsiTransportFCP, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceRole=scsiDeviceRole, scsiLuState=scsiLuState, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiCompliance=scsiCompliance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortEntry=scsiPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiGroups=scsiGroups, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdType=scsiLuIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiInitiator=scsiInitiator, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapEntry=scsiLunMapEntry, scsiNotifications=scsiNotifications, scsiLogicalUnit=scsiLogicalUnit, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, ScsiIdAssociation=ScsiIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatus=scsiLuStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptDevName=scsiTrnsptDevName, PYSNMP_MODULE_ID=scsiModule, scsiConformance=scsiConformance, scsiTranportOther=scsiTranportOther, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiName=ScsiName, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliances=scsiCompliances, scsiLunMapGroup=scsiLunMapGroup, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetGroup=scsiTargetGroup, scsiLuProductId=scsiLuProductId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLuInCommands=scsiLuInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGeneral=scsiGeneral, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceResets=scsiDeviceResets, scsiLunMapLun=scsiLunMapLun)
