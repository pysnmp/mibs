...
Integer32, Counter64, TimeTicks, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, IpAddress, ObjectIdentity, MibIdentifier, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "TimeTicks", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "Bits", "ModuleIdentity")
TimeStamp, RowPointer, AutonomousType, RowStatus, TruthValue, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, scsiLuIdTable=scsiLuIdTable, ScsiIdentifier=ScsiIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortIndex=scsiPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdEntry=scsiLuIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportFCP=scsiTransportFCP, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliances=scsiCompliances, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdType=scsiLuIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportTypes=scsiTransportTypes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTarget=scsiTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatus=scsiLuStatus, scsiInstanceTable=scsiInstanceTable, scsiLuInResets=scsiLuInResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuVendorId=scsiLuVendorId, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSRP=scsiTransportSRP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIndex=scsiLuIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiConformance=scsiConformance, scsiCompliance=scsiCompliance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiInstAlias=scsiInstAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiGroups=scsiGroups, PYSNMP_MODULE_ID=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, scsiDeviceResets=scsiDeviceResets, scsiInitiator=scsiInitiator, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiObjects=scsiObjects, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, ScsiIdType=ScsiIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortEntry=scsiPortEntry, scsiDscLunTable=scsiDscLunTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuEntry=scsiLuEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdValue=ScsiIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTranportOther=scsiTranportOther, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuState=scsiLuState, scsiLuRevisionId=scsiLuRevisionId, scsiNotifications=scsiNotifications, scsiInstIndex=scsiInstIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs)
