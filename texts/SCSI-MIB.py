...
iso, Unsigned32, Bits, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, IpAddress, NotificationType, Counter32, MibIdentifier, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Bits", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "MibIdentifier", "Gauge32", "mib-2")
DisplayString, TruthValue, RowStatus, TimeStamp, AutonomousType, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "TimeStamp", "AutonomousType", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtName=scsiDscTgtName, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdTable=scsiLuIdTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtName=scsiIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiModule=scsiModule, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTable=scsiPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptType=scsiTrnsptType, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiCompliance=scsiCompliance, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortIndex=scsiPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTarget=scsiTarget, scsiCompliances=scsiCompliances, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiConformance=scsiConformance, scsiNotifications=scsiNotifications, scsiLuRevisionId=scsiLuRevisionId, scsiInstAlias=scsiInstAlias, scsiTransportFCP=scsiTransportFCP, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiName=ScsiName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuEntry=scsiLuEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdentifier=ScsiIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdType=ScsiIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiDeviceTable=scsiDeviceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiator=scsiInitiator, scsiPortRole=scsiPortRole, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuVendorId=scsiLuVendorId, ScsiIdValue=ScsiIdValue, scsiPortEntry=scsiPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuTable=scsiLuTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceEntry=scsiInstanceEntry, scsiTargetGroup=scsiTargetGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdType=scsiLuIdType, scsiTrnsptTable=scsiTrnsptTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGeneral=scsiGeneral, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiTranportSPI=scsiTranportSPI, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuProductId=scsiLuProductId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIndexValue=ScsiIndexValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex)
