...
mib_2, TimeTicks, Gauge32, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Counter32, Counter64, Bits, Integer32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "Gauge32", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Counter32", "Counter64", "Bits", "Integer32", "ObjectIdentity", "ModuleIdentity")
TextualConvention, AutonomousType, TruthValue, TimeStamp, RowStatus, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TruthValue", "TimeStamp", "RowStatus", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportSRP=scsiTransportSRP, scsiTransportFCP=scsiTransportFCP, scsiTranportOther=scsiTranportOther, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiModule=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportSPI=scsiTranportSPI, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatus=scsiLuStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliance=scsiCompliance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortTable=scsiPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceAlias=scsiDeviceAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdEntry=scsiLuIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstAlias=scsiInstAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdentifier=ScsiIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportTypes=scsiTransportTypes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuTable=scsiLuTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWwnName=scsiLuWwnName, scsiGroups=scsiGroups, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIndex=scsiLuIndex, scsiDeviceRole=scsiDeviceRole, scsiPortRole=scsiPortRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiCompliances=scsiCompliances, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, ScsiIndexValue=ScsiIndexValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstIndex=scsiInstIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiObjects=scsiObjects, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiRemoteTarget=scsiRemoteTarget, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuVendorId=scsiLuVendorId, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTarget=scsiTarget, scsiConformance=scsiConformance)
