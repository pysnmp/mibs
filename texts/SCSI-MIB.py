...
Bits, ModuleIdentity, TimeTicks, MibIdentifier, ObjectIdentity, IpAddress, Counter32, Gauge32, mib_2, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "TimeTicks", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter32", "Gauge32", "mib-2", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Counter64")
RowStatus, DisplayString, TimeStamp, TextualConvention, RowPointer, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention", "RowPointer", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIndexValue=ScsiIndexValue, scsiPortTable=scsiPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiPortEntry=scsiPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiConformance=scsiConformance, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTable=scsiIntrDevTable, scsiLuEntry=scsiLuEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuDefaultLun=scsiLuDefaultLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuStatus=scsiLuStatus, scsiLuProductId=scsiLuProductId, scsiCompliances=scsiCompliances, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdType=scsiLuIdType, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiPortIndex=scsiPortIndex, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGroups=scsiGroups, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiLuInResets=scsiLuInResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdValue=ScsiIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstIndex=scsiInstIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSBP=scsiTransportSBP, scsiLuIdTable=scsiLuIdTable, scsiDeviceAlias=scsiDeviceAlias, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInCommands=scsiLuInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiator=scsiInitiator, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuTable=scsiLuTable, scsiLunMapIndex=scsiLunMapIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunLun=scsiDscLunLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWwnName=scsiLuWwnName, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLun=scsiLunMapLun, scsiModule=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunEntry=scsiDscLunEntry, ScsiName=ScsiName, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortRole=scsiPortRole, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdValue=scsiLuIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet)
