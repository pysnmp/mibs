...
NotificationType, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, TimeTicks, iso, Counter64, mib_2, ModuleIdentity, Integer32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "TimeTicks", "iso", "Counter64", "mib-2", "ModuleIdentity", "Integer32", "Counter32", "Bits")
TruthValue, DisplayString, TextualConvention, TimeStamp, RowPointer, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "TimeStamp", "RowPointer", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuVendorId=scsiLuVendorId, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuIndex=scsiLuIndex, scsiTargetGroup=scsiTargetGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiator=scsiInitiator, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtTable=scsiDscTgtTable, scsiLuTable=scsiLuTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiDeviceResets=scsiDeviceResets, ScsiIdValue=ScsiIdValue, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunLun=scsiDscLunLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceRole=scsiDeviceRole, scsiModule=scsiModule, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceEntry=scsiDeviceEntry, scsiTranportOther=scsiTranportOther, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliance=scsiCompliance, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLogicalUnit=scsiLogicalUnit, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTarget=scsiTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiObjects=scsiObjects, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuState=scsiLuState, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstAlias=scsiInstAlias, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiLuInResets=scsiLuInResets, scsiCompliances=scsiCompliances, scsiTgtPortName=scsiTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuProductId=scsiLuProductId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceGroup=scsiDeviceGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiTrnsptType=scsiTrnsptType, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatus=scsiLuStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLun=scsiLunMapLun, ScsiIdType=ScsiIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiConformance=scsiConformance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry)
