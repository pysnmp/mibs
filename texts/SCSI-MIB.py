...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ObjectIdentity, Counter64, Counter32, mib_2, Unsigned32, ModuleIdentity, Gauge32, MibIdentifier, iso, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter64", "Counter32", "mib-2", "Unsigned32", "ModuleIdentity", "Gauge32", "MibIdentifier", "iso", "Integer32", "IpAddress")
TimeStamp, TextualConvention, DisplayString, RowStatus, AutonomousType, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiNotifications=scsiNotifications, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapGroup=scsiLunMapGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiTarget=scsiTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceTable=scsiDeviceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSBP=scsiTransportSBP, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortEntry=scsiPortEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliances=scsiCompliances, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiModule=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuState=scsiLuState, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, scsiLuVendorId=scsiLuVendorId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLuStatus=scsiLuStatus, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortIndex=scsiPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIndex=scsiLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiGroups=scsiGroups, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiInitiator=scsiInitiator, scsiLunMapTable=scsiLunMapTable, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportFCP=scsiTransportFCP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunLun=scsiDscLunLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiCompliance=scsiCompliance, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGeneral=scsiGeneral, ScsiIdType=ScsiIdType, scsiInstAlias=scsiInstAlias, scsiTgtPortName=scsiTgtPortName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuTable=scsiLuTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdType=scsiDscLunIdType)
