...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso, Gauge32, Bits, IpAddress, MibIdentifier, ObjectIdentity, Counter64, TimeTicks, Integer32, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso", "Gauge32", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "Counter64", "TimeTicks", "Integer32", "mib-2", "ModuleIdentity")
TextualConvention, TruthValue, DisplayString, RowPointer, RowStatus, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "RowPointer", "RowStatus", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiLuInResets=scsiLuInResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, scsiLunMapGroup=scsiLunMapGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliance=scsiCompliance, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortIndex=scsiPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiTransportTypes=scsiTransportTypes, scsiPortEntry=scsiPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportSPI=scsiTranportSPI, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuState=scsiLuState, scsiDeviceGroup=scsiDeviceGroup, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatus=scsiLuStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiGroups=scsiGroups, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrName=scsiAuthIntrName, scsiModule=scsiModule, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, scsiDscTgtName=scsiDscTgtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiPortTable=scsiPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportFCP=scsiTransportFCP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuTable=scsiLuTable, scsiTransportSBP=scsiTransportSBP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValue=ScsiIndexValue, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTarget=scsiTarget, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiInitiator=scsiInitiator, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, ScsiName=ScsiName, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName)
