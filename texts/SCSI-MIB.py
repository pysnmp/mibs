...
Counter64, mib_2, Counter32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, IpAddress, Gauge32, ObjectIdentity, Integer32, iso, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "Counter32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Integer32", "iso", "ModuleIdentity", "Bits")
TextualConvention, RowPointer, AutonomousType, RowStatus, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdType=ScsiIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortEntry=scsiPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiGeneral=scsiGeneral, scsiInitiatorGroup=scsiInitiatorGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiGroups=scsiGroups, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiTarget=scsiTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtName=scsiDscTgtName, scsiLuStatus=scsiLuStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuVendorId=scsiLuVendorId, ScsiName=ScsiName, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliance=scsiCompliance, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortIndex=scsiPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdType=scsiLuIdType, ScsiIndexValue=ScsiIndexValue, scsiTranportOther=scsiTranportOther, scsiTgtPortName=scsiTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIndex=scsiLuIndex, scsiInitiator=scsiInitiator, scsiLunMapTable=scsiLunMapTable, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteTarget=scsiRemoteTarget, scsiObjects=scsiObjects, scsiLuTable=scsiLuTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceRole=scsiDeviceRole, ScsiIdentifier=ScsiIdentifier, ScsiIdValue=ScsiIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdTable=scsiLuIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiCompliances=scsiCompliances, scsiDscLunLun=scsiDscLunLun, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes)
