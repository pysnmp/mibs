...
mib_2, Counter64, iso, TimeTicks, NotificationType, ObjectIdentity, Counter32, IpAddress, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter32", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "ModuleIdentity")
AutonomousType, DisplayString, RowStatus, RowPointer, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "RowStatus", "RowPointer", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceTable=scsiInstanceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSBP=scsiTransportSBP, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiObjects=scsiObjects, scsiTranportOther=scsiTranportOther, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotifications=scsiNotifications, scsiLunMapIndex=scsiLunMapIndex, scsiModule=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuProductId=scsiLuProductId, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatus=scsiLuStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdEntry=scsiLuIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTable=scsiPortTable, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortEntry=scsiPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiConformance=scsiConformance, ScsiIdType=ScsiIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiator=scsiInitiator, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiLuIdIndex=scsiLuIdIndex, ScsiName=ScsiName, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiCompliance=scsiCompliance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortRole=scsiPortRole, ScsiIndexValue=ScsiIndexValue, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWwnName=scsiLuWwnName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunEntry=scsiDscLunEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuState=scsiLuState, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtName=scsiDscTgtName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiCompliances=scsiCompliances, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortIndex=scsiPortIndex, scsiTranportSPI=scsiTranportSPI, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapEntry=scsiLunMapEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuTable=scsiLuTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdentifier=ScsiIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstAlias=scsiInstAlias, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTarget=scsiTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuEntry=scsiLuEntry)
