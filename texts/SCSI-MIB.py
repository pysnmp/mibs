...
ObjectIdentity, IpAddress, NotificationType, mib_2, MibIdentifier, ModuleIdentity, Gauge32, TimeTicks, Counter32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "NotificationType", "mib-2", "MibIdentifier", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Integer32")
TimeStamp, TextualConvention, DisplayString, AutonomousType, RowPointer, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "AutonomousType", "RowPointer", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiModule=scsiModule, scsiLuIdValue=scsiLuIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortRole=scsiPortRole, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTargetGroup=scsiTargetGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiObjects=scsiObjects, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdIndex=scsiDscLunIdIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapLun=scsiLunMapLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuTable=scsiLuTable, scsiDeviceRole=scsiDeviceRole, scsiInstanceTable=scsiInstanceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunEntry=scsiDscLunEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTransportISCSI=scsiTransportISCSI, scsiInstVendorVersion=scsiInstVendorVersion, scsiGeneral=scsiGeneral, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatus=scsiLuStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtName=scsiIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuState=scsiLuState, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiCompliances=scsiCompliances, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, scsiLunMapGroup=scsiLunMapGroup, scsiPortTable=scsiPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSRP=scsiTransportSRP, scsiDscTgtName=scsiDscTgtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuProductId=scsiLuProductId, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceResets=scsiDeviceResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValue=ScsiIndexValue, scsiTrnsptType=scsiTrnsptType, scsiInstAlias=scsiInstAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIndex=scsiLuIndex, scsiDeviceTable=scsiDeviceTable, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrName=scsiAuthIntrName, scsiPortIndex=scsiPortIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiator=scsiInitiator, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable)
