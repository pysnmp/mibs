...
TimeTicks, IpAddress, iso, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, ModuleIdentity, Integer32, Counter32, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "iso", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "ModuleIdentity", "Integer32", "Counter32", "mib-2", "Counter64")
TimeStamp, DisplayString, AutonomousType, TruthValue, RowPointer, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "AutonomousType", "TruthValue", "RowPointer", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportFCP=scsiTransportFCP, scsiPortTable=scsiPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptType=scsiTrnsptType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuEntry=scsiLuEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiLuState=scsiLuState, scsiInstanceTable=scsiInstanceTable, scsiPortRole=scsiPortRole, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTranportOther=scsiTranportOther, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiConformance=scsiConformance, scsiLuVendorId=scsiLuVendorId, scsiInstAlias=scsiInstAlias, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiInstIndex=scsiInstIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportISCSI=scsiTransportISCSI, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTable=scsiIntrDevTable, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdType=scsiDscLunIdType, ScsiIdType=ScsiIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSBP=scsiTransportSBP, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortTable=scsiTgtPortTable, ScsiIdValue=ScsiIdValue, scsiInitiator=scsiInitiator, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValue=ScsiIndexValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDeviceTable=scsiDeviceTable, scsiLuInCommands=scsiLuInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTarget=scsiTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliances=scsiCompliances, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuTable=scsiLuTable, scsiTrnsptTable=scsiTrnsptTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiObjects=scsiObjects, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortIndex=scsiPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuProductId=scsiLuProductId, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiName=ScsiName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTransportTypes=scsiTransportTypes, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdAssociation=ScsiIdAssociation)
