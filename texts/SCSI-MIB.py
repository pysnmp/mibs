...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, Bits, iso, TimeTicks, Counter32, Counter64, IpAddress, MibIdentifier, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "Bits", "iso", "TimeTicks", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Gauge32")
DisplayString, TextualConvention, RowStatus, TruthValue, AutonomousType, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSRP=scsiTransportSRP, scsiTargetGroup=scsiTargetGroup, scsiLuState=scsiLuState, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdType=scsiDscLunIdType, scsiInstIndex=scsiInstIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatus=scsiLuStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiCompliances=scsiCompliances, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapTable=scsiLunMapTable, ScsiIdType=ScsiIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunLun=scsiDscLunLun, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiObjects=scsiObjects, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdTable=scsiLuIdTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortIndex=scsiPortIndex, ScsiName=ScsiName, scsiPortTable=scsiPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLun=scsiLunMapLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuInCommands=scsiLuInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuTable=scsiLuTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortEntry=scsiPortEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTarget=scsiTarget, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, scsiLunMapEntry=scsiLunMapEntry, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiLuEntry=scsiLuEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiConformance=scsiConformance, scsiLogicalUnit=scsiLogicalUnit, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdType=scsiLuIdType, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiCompliance=scsiCompliance, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtTable=scsiAttIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunTable=scsiDscLunTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIndex=scsiLuIndex, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuVendorId=scsiLuVendorId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex)
