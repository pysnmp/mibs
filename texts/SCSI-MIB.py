...
TimeTicks, Unsigned32, iso, Counter32, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, MibIdentifier, IpAddress, ObjectIdentity, mib_2, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "iso", "Counter32", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "ObjectIdentity", "mib-2", "NotificationType", "Bits")
AutonomousType, TextualConvention, TruthValue, RowStatus, RowPointer, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TruthValue", "RowStatus", "RowPointer", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotifications=scsiNotifications, scsiLuIndex=scsiLuIndex, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiLuHSInCommands=scsiLuHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceRole=scsiDeviceRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTarget=scsiTarget, scsiTransportSBP=scsiTransportSBP, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuVendorId=scsiLuVendorId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTable=scsiPortTable, scsiModule=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiConformance=scsiConformance, scsiGeneral=scsiGeneral, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliances=scsiCompliances, scsiLuInResets=scsiLuInResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, scsiDeviceTable=scsiDeviceTable, scsiTransportFCP=scsiTransportFCP, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdType=scsiLuIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuState=scsiLuState, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliance=scsiCompliance, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportSPI=scsiTranportSPI, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuTable=scsiLuTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGroups=scsiGroups, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceAlias=scsiDeviceAlias, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex)
