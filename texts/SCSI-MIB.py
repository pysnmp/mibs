...
Bits, TimeTicks, iso, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, IpAddress, Counter64, MibIdentifier, mib_2, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "iso", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "MibIdentifier", "mib-2", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
TruthValue, TimeStamp, RowStatus, RowPointer, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "RowStatus", "RowPointer", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiator=scsiInitiator, scsiDscTgtName=scsiDscTgtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunLun=scsiDscLunLun, scsiLuTable=scsiLuTable, scsiLuIdEntry=scsiLuIdEntry, scsiPortTable=scsiPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceTable=scsiDeviceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdValue=ScsiIdValue, scsiConformance=scsiConformance, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIndex=scsiLuIndex, scsiLuProductId=scsiLuProductId, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiName=ScsiName, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTarget=scsiTarget, scsiInstIndex=scsiInstIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiModule=scsiModule, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdType=ScsiIdType, scsiTransportSBP=scsiTransportSBP, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortRole=scsiPortRole, scsiLuIdType=scsiLuIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdValue=scsiLuIdValue, scsiPortIndex=scsiPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportOther=scsiTranportOther, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunEntry=scsiDscLunEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceRole=scsiDeviceRole, scsiLunMapLun=scsiLunMapLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotifications=scsiNotifications, scsiCompliances=scsiCompliances, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortEntry=scsiPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiObjects=scsiObjects, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiInstAlias=scsiInstAlias, scsiTransportFCP=scsiTransportFCP, scsiDeviceAlias=scsiDeviceAlias, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceEntry=scsiInstanceEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGroups=scsiGroups, scsiLuStatus=scsiLuStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiTransportSRP=scsiTransportSRP, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuEntry=scsiLuEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetGroup=scsiTargetGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuState=scsiLuState, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunTable=scsiDscLunTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapTable=scsiLunMapTable, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes)
