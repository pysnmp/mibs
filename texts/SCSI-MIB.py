...
NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, ObjectIdentity, Counter64, Bits, MibIdentifier, ModuleIdentity, Gauge32, mib_2, Integer32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "ObjectIdentity", "Counter64", "Bits", "MibIdentifier", "ModuleIdentity", "Gauge32", "mib-2", "Integer32", "iso", "TimeTicks")
TextualConvention, TimeStamp, RowStatus, DisplayString, RowPointer, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "RowPointer", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiConformance=scsiConformance, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiPortEntry=scsiPortEntry, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiator=scsiInitiator, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortName=scsiAttTgtPortName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiPortIndex=scsiPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiObjects=scsiObjects, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSBP=scsiTransportSBP, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdValue=ScsiIdValue, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdType=ScsiIdType, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, scsiInstAlias=scsiInstAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdEntry=scsiLuIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuInResets=scsiLuInResets, scsiDeviceTable=scsiDeviceTable, scsiTarget=scsiTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiPortTable=scsiPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapTable=scsiLunMapTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportISCSI=scsiTransportISCSI, scsiModule=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiCompliances=scsiCompliances, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunTable=scsiDscLunTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiLuTable=scsiLuTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIndex=scsiLuIndex, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptType=scsiTrnsptType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatus=scsiLuStatus, scsiDeviceResets=scsiDeviceResets, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTable=scsiIntrDevTable, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiRemoteInitiators=scsiRemoteInitiators)
