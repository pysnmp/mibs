...
Counter64, ModuleIdentity, mib_2, MibIdentifier, NotificationType, TimeTicks, Counter32, Integer32, iso, IpAddress, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "mib-2", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "Integer32", "iso", "IpAddress", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
RowStatus, DisplayString, RowPointer, AutonomousType, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "RowPointer", "AutonomousType", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTransportFCP=scsiTransportFCP, scsiLuVendorId=scsiLuVendorId, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtTable=scsiDscTgtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuInResets=scsiLuInResets, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdValue=scsiDscLunIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuEntry=scsiLuEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDeviceAlias=scsiDeviceAlias, ScsiName=ScsiName, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliance=scsiCompliance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTarget=scsiTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotifications=scsiNotifications, scsiTranportSPI=scsiTranportSPI, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWwnName=scsiLuWwnName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstAlias=scsiInstAlias, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiLuTable=scsiLuTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, ScsiIdValue=ScsiIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortIndex=scsiPortIndex, ScsiIdAssociation=ScsiIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdType=ScsiIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapTable=scsiLunMapTable, scsiModule=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatus=scsiLuStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTranportOther=scsiTranportOther, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiConformance=scsiConformance, scsiLuProductId=scsiLuProductId, scsiTransportTypes=scsiTransportTypes, scsiPortEntry=scsiPortEntry, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtName=scsiDscTgtName, scsiDeviceTable=scsiDeviceTable, scsiLuIndex=scsiLuIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiInitiator=scsiInitiator, ScsiIndexValue=ScsiIndexValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrName=scsiAuthIntrName, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdCodeSet=ScsiIdCodeSet)
