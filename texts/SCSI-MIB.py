...
TimeTicks, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, Gauge32, ModuleIdentity, Counter32, Unsigned32, Counter64, Bits, MibIdentifier, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "Gauge32", "ModuleIdentity", "Counter32", "Unsigned32", "Counter64", "Bits", "MibIdentifier", "NotificationType", "iso")
TruthValue, RowPointer, TimeStamp, TextualConvention, RowStatus, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "TimeStamp", "TextualConvention", "RowStatus", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortRole=scsiPortRole, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiGroups=scsiGroups, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevTable=scsiTgtDevTable, scsiModule=scsiModule, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValue=ScsiIndexValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIndex=scsiLuIndex, scsiLuIdType=scsiLuIdType, scsiPortEntry=scsiPortEntry, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTable=scsiIntrDevTable, scsiLuWwnName=scsiLuWwnName, scsiLuProductId=scsiLuProductId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTarget=scsiTarget, scsiPortTable=scsiPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiLuInCommands=scsiLuInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiator=scsiInitiator, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportISCSI=scsiTransportISCSI, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliances=scsiCompliances, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiLuInResets=scsiLuInResets, scsiDscLunTable=scsiDscLunTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, PYSNMP_MODULE_ID=scsiModule, scsiNotifications=scsiNotifications, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtTable=scsiDscTgtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuTable=scsiLuTable, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceTable=scsiInstanceTable, scsiTgtPortName=scsiTgtPortName, scsiDscLunLun=scsiDscLunLun, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiName=ScsiName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGeneral=scsiGeneral, scsiLuState=scsiLuState, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceResets=scsiDeviceResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportSPI=scsiTranportSPI)
