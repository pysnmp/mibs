...
MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Counter64, mib_2, iso, IpAddress, NotificationType, Bits, ModuleIdentity, Integer32, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Counter64", "mib-2", "iso", "IpAddress", "NotificationType", "Bits", "ModuleIdentity", "Integer32", "Unsigned32", "Gauge32")
DisplayString, TextualConvention, RowPointer, TimeStamp, RowStatus, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowPointer", "TimeStamp", "RowStatus", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuVendorId=scsiLuVendorId, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortEntry=scsiPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuState=scsiLuState, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSRP=scsiTransportSRP, scsiLuProductId=scsiLuProductId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdType=ScsiIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiName=ScsiName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdValue=scsiLuIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSBP=scsiTransportSBP, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdValue=ScsiIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliances=scsiCompliances, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortTable=scsiPortTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotifications=scsiNotifications, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliance=scsiCompliance, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceRole=scsiDeviceRole, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTarget=scsiTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiGeneral=scsiGeneral, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuInCommands=scsiLuInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiInstAlias=scsiInstAlias, scsiObjects=scsiObjects, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIndex=scsiLuIndex, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortRole=scsiPortRole, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiModule=scsiModule, scsiConformance=scsiConformance, ScsiIdAssociation=ScsiIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortIndex=scsiPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiLuStatus=scsiLuStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes)
