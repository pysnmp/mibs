...
MibIdentifier, Counter64, IpAddress, Unsigned32, iso, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, Bits, mib_2, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "IpAddress", "Unsigned32", "iso", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "Bits", "mib-2", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, TimeStamp, AutonomousType, TextualConvention, RowStatus, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention", "RowStatus", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiConformance=scsiConformance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceResets=scsiDeviceResets, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceEntry=scsiDeviceEntry, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiModule=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceRole=scsiDeviceRole, scsiDeviceGroup=scsiDeviceGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuEntry=scsiLuEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdEntry=scsiLuIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdValue=ScsiIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiLuInCommands=scsiLuInCommands, scsiLuProductId=scsiLuProductId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, scsiInstAlias=scsiInstAlias, scsiInitiator=scsiInitiator, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportSPI=scsiTranportSPI, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiObjects=scsiObjects, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdType=ScsiIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLogicalUnit=scsiLogicalUnit, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortIndex=scsiPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGeneral=scsiGeneral, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunLun=scsiDscLunLun, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportTypes=scsiTransportTypes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuRevisionId=scsiLuRevisionId, ScsiIdentifier=ScsiIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSBP=scsiTransportSBP, scsiTransportFCP=scsiTransportFCP, scsiTransportSRP=scsiTransportSRP, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands)
