...
Counter32, ModuleIdentity, Unsigned32, mib_2, Bits, TimeTicks, NotificationType, Counter64, Integer32, ObjectIdentity, IpAddress, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Unsigned32", "mib-2", "Bits", "TimeTicks", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "IpAddress", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, RowStatus, DisplayString, TextualConvention, AutonomousType, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptTable=scsiTrnsptTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiInstAlias=scsiInstAlias, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiModule=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetGroup=scsiTargetGroup, ScsiIdValue=ScsiIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortIndex=scsiPortIndex, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdType=scsiLuIdType, scsiConformance=scsiConformance, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportTypes=scsiTransportTypes, scsiTarget=scsiTarget, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiCompliances=scsiCompliances, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunTable=scsiDscLunTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiPortRole=scsiPortRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiGroups=scsiGroups, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunLun=scsiDscLunLun, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdType=scsiDscLunIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceResets=scsiDeviceResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiObjects=scsiObjects, scsiLunMapIndex=scsiLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapTable=scsiLunMapTable, scsiTrnsptDevName=scsiTrnsptDevName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, scsiInstIndex=scsiInstIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdType=ScsiIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiNotifications=scsiNotifications, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTable=scsiPortTable, scsiLuEntry=scsiLuEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuProductId=scsiLuProductId, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, ScsiName=ScsiName, scsiInstanceTable=scsiInstanceTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, ScsiIdCodeSet=ScsiIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer)
