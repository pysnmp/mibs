...
ModuleIdentity, Bits, Unsigned32, MibIdentifier, ObjectIdentity, Counter32, Counter64, iso, IpAddress, Integer32, mib_2, TimeTicks, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Counter32", "Counter64", "iso", "IpAddress", "Integer32", "mib-2", "TimeTicks", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, DisplayString, TruthValue, TimeStamp, RowPointer, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "TimeStamp", "RowPointer", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptType=scsiTrnsptType, scsiModule=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDeviceIndex=scsiDeviceIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortRole=scsiPortRole, scsiConformance=scsiConformance, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiTransportSRP=scsiTransportSRP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliance=scsiCompliance, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiObjects=scsiObjects, scsiLunMapEntry=scsiLunMapEntry, scsiGeneral=scsiGeneral, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatus=scsiLuStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortEntry=scsiPortEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapIndex=scsiLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuTable=scsiLuTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceTable=scsiDeviceTable, scsiDscLunLun=scsiDscLunLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunTable=scsiDscLunTable, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstAlias=scsiInstAlias, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, ScsiIdentifier=ScsiIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtName=scsiIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGroups=scsiGroups, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiator=scsiInitiator, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliances=scsiCompliances, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdTable=scsiLuIdTable, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdValue=ScsiIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiTranportOther=scsiTranportOther, scsiDscTgtName=scsiDscTgtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuState=scsiLuState, ScsiName=ScsiName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTarget=scsiTarget, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, ScsiIdType=ScsiIdType, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId)
