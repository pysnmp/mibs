...
mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, iso, Bits, NotificationType, Integer32, ObjectIdentity, Unsigned32, TimeTicks, ModuleIdentity, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "iso", "Bits", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter32")
DisplayString, AutonomousType, RowPointer, RowStatus, TextualConvention, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowPointer", "RowStatus", "TextualConvention", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiNotifications=scsiNotifications, scsiTransportTypes=scsiTransportTypes, scsiTgtPortName=scsiTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatus=scsiLuStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortIndex=scsiPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiLuVendorId=scsiLuVendorId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiLunMapLun=scsiLunMapLun, ScsiIdentifier=ScsiIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuTable=scsiLuTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdType=scsiLuIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiator=scsiInitiator, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiInstAlias=scsiInstAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, ScsiIdType=ScsiIdType, scsiTrnsptType=scsiTrnsptType, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, ScsiIdValue=ScsiIdValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiGeneral=scsiGeneral, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportSPI=scsiTranportSPI, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiCompliance=scsiCompliance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapTable=scsiLunMapTable, scsiDeviceGroup=scsiDeviceGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportOther=scsiTranportOther, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInResets=scsiLuInResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTarget=scsiTarget, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValue=ScsiIndexValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, scsiGroups=scsiGroups, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiCompliances=scsiCompliances, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiModule=scsiModule, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
