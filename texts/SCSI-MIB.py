...
Gauge32, iso, Counter64, ObjectIdentity, MibIdentifier, Unsigned32, Integer32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Integer32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "Bits", "NotificationType", "Counter32")
RowStatus, DisplayString, RowPointer, TextualConvention, TruthValue, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "RowPointer", "TextualConvention", "TruthValue", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliances=scsiCompliances, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiator=scsiInitiator, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceResets=scsiDeviceResets, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiTranportOther=scsiTranportOther, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdValue=scsiLuIdValue, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceIndex=scsiDeviceIndex, scsiLuEntry=scsiLuEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, scsiInstAlias=scsiInstAlias, scsiLunMapTable=scsiLunMapTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiGeneral=scsiGeneral, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiName=ScsiName, scsiLuProductId=scsiLuProductId, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuVendorId=scsiLuVendorId, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiDeviceEntry=scsiDeviceEntry, scsiLuIndex=scsiLuIndex, scsiDscTgtName=scsiDscTgtName, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTarget=scsiTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiObjects=scsiObjects, scsiLuIdTable=scsiLuIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstIndex=scsiInstIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdValue=ScsiIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunTable=scsiDscLunTable, ScsiIdType=ScsiIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapGroup=scsiLunMapGroup, scsiGroups=scsiGroups, scsiLuDefaultLun=scsiLuDefaultLun, scsiModule=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortIndex=scsiPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiTransportTypes=scsiTransportTypes, scsiNotifications=scsiNotifications)
