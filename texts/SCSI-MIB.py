...
mib_2, Counter64, ObjectIdentity, TimeTicks, IpAddress, ModuleIdentity, NotificationType, Bits, Counter32, iso, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "ObjectIdentity", "TimeTicks", "IpAddress", "ModuleIdentity", "NotificationType", "Bits", "Counter32", "iso", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier")
TimeStamp, AutonomousType, RowPointer, TextualConvention, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowPointer", "TextualConvention", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstanceTable=scsiInstanceTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevTable=scsiTgtDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdentifier=ScsiIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscTgtIndex=scsiDscTgtIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLun=scsiLunMapLun, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdType=scsiLuIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiName=ScsiName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdType=ScsiIdType, scsiLunMapIndex=scsiLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunTable=scsiDscLunTable, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWwnName=scsiLuWwnName, scsiDscLunLun=scsiDscLunLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiLuHSInCommands=scsiLuHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiCompliances=scsiCompliances, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdValue=ScsiIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdAssociation=ScsiIdAssociation, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuState=scsiLuState, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortTable=scsiPortTable, scsiObjects=scsiObjects, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiInitiator=scsiInitiator, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiModule=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortRole=scsiPortRole, scsiNotifications=scsiNotifications, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtName=scsiAttIntrPrtName)
