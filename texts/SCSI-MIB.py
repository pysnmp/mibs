...
ObjectIdentity, Unsigned32, Counter64, NotificationType, MibIdentifier, ModuleIdentity, Gauge32, Integer32, Counter32, IpAddress, Bits, iso, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "ModuleIdentity", "Gauge32", "Integer32", "Counter32", "IpAddress", "Bits", "iso", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapEntry=scsiLunMapEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiPortIndex=scsiPortIndex, scsiDscTgtName=scsiDscTgtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevOutResets=scsiIntrDevOutResets, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, ScsiIdAssociation=ScsiIdAssociation, scsiPortRole=scsiPortRole, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, scsiTrnsptType=scsiTrnsptType, scsiDeviceTable=scsiDeviceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotifications=scsiNotifications, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWwnName=scsiLuWwnName, scsiLuIdValue=scsiLuIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliances=scsiCompliances, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuEntry=scsiLuEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTarget=scsiTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportTypes=scsiTransportTypes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuVendorId=scsiLuVendorId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiInitiator=scsiInitiator, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliance=scsiCompliance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceEntry=scsiDeviceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuRevisionId=scsiLuRevisionId, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInResets=scsiLuInResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortEntry=scsiPortEntry, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceRole=scsiDeviceRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiModule=scsiModule, scsiTranportSPI=scsiTranportSPI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstIndex=scsiInstIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuStatus=scsiLuStatus, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiTranportOther=scsiTranportOther, scsiConformance=scsiConformance, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiObjects=scsiObjects, scsiLuState=scsiLuState, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
