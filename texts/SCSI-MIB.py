...
Gauge32, TimeTicks, Bits, Counter32, Counter64, ObjectIdentity, Integer32, mib_2, IpAddress, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Bits", "Counter32", "Counter64", "ObjectIdentity", "Integer32", "mib-2", "IpAddress", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "MibIdentifier")
AutonomousType, RowPointer, TruthValue, TimeStamp, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, scsiLuStatus=scsiLuStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtTable=scsiDscTgtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuState=scsiLuState, scsiLunMapLun=scsiLunMapLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceTable=scsiDeviceTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortRole=scsiPortRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValue=ScsiIndexValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiModule=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiGroups=scsiGroups, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiObjects=scsiObjects, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceEntry=scsiDeviceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportOther=scsiTranportOther, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdType=scsiLuIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptType=scsiTrnsptType, scsiCompliance=scsiCompliance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType, scsiDscLunIdType=scsiDscLunIdType, scsiLuVendorId=scsiLuVendorId, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuEntry=scsiLuEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiCompliances=scsiCompliances, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup)
