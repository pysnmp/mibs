...
Integer32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, MibIdentifier, Unsigned32, TimeTicks, Counter64, Counter32, mib_2, ObjectIdentity, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter64", "Counter32", "mib-2", "ObjectIdentity", "ModuleIdentity", "Bits")
RowPointer, DisplayString, AutonomousType, RowStatus, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdType=ScsiIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiLunMapLun=scsiLunMapLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiModule=scsiModule, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuState=scsiLuState, scsiTrnsptIndex=scsiTrnsptIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstAlias=scsiInstAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTranportOther=scsiTranportOther, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotifications=scsiNotifications, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValue=ScsiIndexValue, scsiGroups=scsiGroups, scsiInstanceTable=scsiInstanceTable, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdValue=scsiLuIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiPortRole=scsiPortRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunLun=scsiDscLunLun, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapIndex=scsiLunMapIndex, scsiObjects=scsiObjects, scsiLuInResets=scsiLuInResets, scsiGeneral=scsiGeneral, scsiTranportSPI=scsiTranportSPI, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliance=scsiCompliance, scsiTrnsptTable=scsiTrnsptTable, scsiTransportTypes=scsiTransportTypes, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiConformance=scsiConformance, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiLuWwnName=scsiLuWwnName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator)
