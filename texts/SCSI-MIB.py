...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter64, MibIdentifier, Bits, mib_2, Counter32, iso, IpAddress, Unsigned32, TimeTicks, ModuleIdentity, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter64", "MibIdentifier", "Bits", "mib-2", "Counter32", "iso", "IpAddress", "Unsigned32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "NotificationType")
RowStatus, TextualConvention, RowPointer, DisplayString, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "RowPointer", "DisplayString", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliances=scsiCompliances, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuIndex=scsiLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIndex=scsiDscLunIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevTable=scsiTgtDevTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, ScsiName=ScsiName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortEntry=scsiPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuEntry=scsiLuEntry, scsiDscTgtName=scsiDscTgtName, scsiTarget=scsiTarget, scsiTransportTypes=scsiTransportTypes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuVendorId=scsiLuVendorId, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuInCommands=scsiLuInCommands, scsiNotifications=scsiNotifications, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiInitiator=scsiInitiator, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunTable=scsiDscLunTable, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapTable=scsiLunMapTable, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapIndex=scsiLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstAlias=scsiInstAlias, scsiLuProductId=scsiLuProductId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiObjects=scsiObjects, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdAssociation=ScsiIdAssociation, ScsiIdValue=ScsiIdValue, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiDeviceEntry=scsiDeviceEntry, scsiModule=scsiModule, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceEntry=scsiInstanceEntry, ScsiIdentifier=ScsiIdentifier, ScsiIndexValue=ScsiIndexValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortRole=scsiPortRole, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGroups=scsiGroups, scsiInitiatorGroup=scsiInitiatorGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands)
