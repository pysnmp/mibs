...
Gauge32, ModuleIdentity, mib_2, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, TimeTicks, ObjectIdentity, Unsigned32, IpAddress, NotificationType, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "mib-2", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress", "NotificationType", "Bits", "Counter32")
RowPointer, TextualConvention, DisplayString, RowStatus, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiInstAlias=scsiInstAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiTranportOther=scsiTranportOther, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiTransportTypes=scsiTransportTypes, scsiNotifications=scsiNotifications, scsiPortTable=scsiPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdValue=ScsiIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGeneral=scsiGeneral, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdType=scsiLuIdType, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiConformance=scsiConformance, scsiTranportSPI=scsiTranportSPI, PYSNMP_MODULE_ID=scsiModule, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceTable=scsiDeviceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunTable=scsiDscLunTable, scsiDeviceRole=scsiDeviceRole, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportISCSI=scsiTransportISCSI, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiator=scsiInitiator, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiInstIndex=scsiInstIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiModule=scsiModule, ScsiIdType=ScsiIdType, scsiLuInCommands=scsiLuInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuInResets=scsiLuInResets, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiName=ScsiName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortName=scsiTgtPortName, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuStatus=scsiLuStatus, scsiLuVendorId=scsiLuVendorId, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiPortIndex=scsiPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTarget=scsiTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex)
