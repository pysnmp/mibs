...
MibIdentifier, ModuleIdentity, Bits, mib_2, Counter64, IpAddress, Counter32, Integer32, Gauge32, Unsigned32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Bits", "mib-2", "Counter64", "IpAddress", "Counter32", "Integer32", "Gauge32", "Unsigned32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks")
TimeStamp, AutonomousType, TruthValue, TextualConvention, RowPointer, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowPointer", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, ScsiIndexValue=ScsiIndexValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapTable=scsiLunMapTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtName=scsiDscTgtName, scsiDeviceResets=scsiDeviceResets, scsiPortEntry=scsiPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuEntry=scsiLuEntry, scsiLuInResets=scsiLuInResets, scsiLuIdTable=scsiLuIdTable, scsiPortTable=scsiPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiConformance=scsiConformance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportFCP=scsiTransportFCP, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuState=scsiLuState, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, scsiDeviceTable=scsiDeviceTable, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdType=scsiDscLunIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdType=ScsiIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiGeneral=scsiGeneral, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportTypes=scsiTransportTypes, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, scsiCompliance=scsiCompliance, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportISCSI=scsiTransportISCSI, scsiLuWwnName=scsiLuWwnName, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTarget=scsiTarget, scsiPortIndex=scsiPortIndex, scsiObjects=scsiObjects, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstVendorVersion=scsiInstVendorVersion, ScsiName=ScsiName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiLunMapEntry=scsiLunMapEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiCompliances=scsiCompliances, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiNotifications=scsiNotifications, scsiLuStatus=scsiLuStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuProductId=scsiLuProductId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGroups=scsiGroups, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiator=scsiInitiator, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiDeviceGroup=scsiDeviceGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptType=scsiTrnsptType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceAlias=scsiDeviceAlias, ScsiIdentifier=ScsiIdentifier)
