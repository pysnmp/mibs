...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter32, Counter64, NotificationType, MibIdentifier, IpAddress, Integer32, ObjectIdentity, mib_2, ModuleIdentity, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter32", "Counter64", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "ObjectIdentity", "mib-2", "ModuleIdentity", "Bits", "Unsigned32")
TextualConvention, RowPointer, TruthValue, TimeStamp, DisplayString, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "TruthValue", "TimeStamp", "DisplayString", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValue=ScsiIndexValue, PYSNMP_MODULE_ID=scsiModule, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdentifier=ScsiIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportSPI=scsiTranportSPI, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdValue=ScsiIdValue, scsiTransportTypes=scsiTransportTypes, scsiDeviceAlias=scsiDeviceAlias, scsiLuEntry=scsiLuEntry, scsiTranportOther=scsiTranportOther, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuState=scsiLuState, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunLun=scsiDscLunLun, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiator=scsiInitiator, scsiLunMapLun=scsiLunMapLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiModule=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuTable=scsiLuTable, scsiTrnsptTable=scsiTrnsptTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuVendorId=scsiLuVendorId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiConformance=scsiConformance, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiObjects=scsiObjects, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTable=scsiPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiNotifications=scsiNotifications, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportFCP=scsiTransportFCP)
