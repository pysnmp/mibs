...
Counter64, TimeTicks, Gauge32, ObjectIdentity, Counter32, Bits, MibIdentifier, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, iso, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter32", "Bits", "MibIdentifier", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "iso", "Integer32", "IpAddress")
RowPointer, TruthValue, AutonomousType, TextualConvention, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "AutonomousType", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtName=scsiDscTgtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiator=scsiInitiator, scsiLuStatus=scsiLuStatus, scsiPortRole=scsiPortRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuEntry=scsiLuEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortName=scsiTgtPortName, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiObjects=scsiObjects, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotifications=scsiNotifications, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGroups=scsiGroups, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiLuProductId=scsiLuProductId, scsiDeviceIndex=scsiDeviceIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdType=scsiLuIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, ScsiIdType=ScsiIdType, scsiTrnsptTable=scsiTrnsptTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortEntry=scsiPortEntry, scsiModule=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiCompliances=scsiCompliances, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdTable=scsiLuIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiConformance=scsiConformance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiLuTable=scsiLuTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTranportOther=scsiTranportOther, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTransportTypes=scsiTransportTypes, scsiInstanceTable=scsiInstanceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInCommands=scsiLuInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstAlias=scsiInstAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliance=scsiCompliance, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiPortTable=scsiPortTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero)
