...
NotificationType, TimeTicks, Integer32, Counter64, Bits, iso, Counter32, ModuleIdentity, IpAddress, ObjectIdentity, Gauge32, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Integer32", "Counter64", "Bits", "iso", "Counter32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Gauge32", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
TimeStamp, TruthValue, DisplayString, RowStatus, AutonomousType, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstanceEntry=scsiInstanceEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapLun=scsiLunMapLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInResets=scsiLuInResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, scsiLuTable=scsiLuTable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceRole=scsiDeviceRole, scsiLuIndex=scsiLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiName=ScsiName, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptType=scsiTrnsptType, scsiConformance=scsiConformance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapIndex=scsiLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceEntry=scsiDeviceEntry, scsiTranportOther=scsiTranportOther, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdType=scsiLuIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuHSInCommands=scsiLuHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGeneral=scsiGeneral, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortEntry=scsiPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortIndex=scsiPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstIndex=scsiInstIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiTransportSRP=scsiTransportSRP, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuProductId=scsiLuProductId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceIndex=scsiDeviceIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotifications=scsiNotifications, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, scsiTransportSBP=scsiTransportSBP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGroups=scsiGroups, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuEntry=scsiLuEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiCompliance=scsiCompliance, ScsiIdAssociation=ScsiIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTarget=scsiTarget, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetGroup=scsiTargetGroup, scsiLuRevisionId=scsiLuRevisionId, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, PYSNMP_MODULE_ID=scsiModule)
