...
MibIdentifier, ObjectIdentity, Bits, ModuleIdentity, Counter32, Counter64, TimeTicks, IpAddress, Integer32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter32", "Counter64", "TimeTicks", "IpAddress", "Integer32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "mib-2")
TimeStamp, AutonomousType, RowPointer, RowStatus, DisplayString, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowPointer", "RowStatus", "DisplayString", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapEntry=scsiLunMapEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiPortTable=scsiPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdValue=scsiLuIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSRP=scsiTransportSRP, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortRole=scsiPortRole, scsiCompliance=scsiCompliance, ScsiIdentifier=ScsiIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiModule=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiName=ScsiName, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiInstAlias=scsiInstAlias, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuEntry=scsiLuEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuProductId=scsiLuProductId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, PYSNMP_MODULE_ID=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiGroups=scsiGroups, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTarget=scsiTarget, scsiPortEntry=scsiPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunLun=scsiDscLunLun, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportTypes=scsiTransportTypes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSBP=scsiTransportSBP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, ScsiIdType=ScsiIdType, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtName=scsiDscTgtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatus=scsiLuStatus, scsiTransportFCP=scsiTransportFCP, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiator=scsiInitiator, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceResets=scsiDeviceResets, scsiLunMapTable=scsiLunMapTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiLuTable=scsiLuTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdType=scsiLuIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotifications=scsiNotifications, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceTable=scsiInstanceTable)
