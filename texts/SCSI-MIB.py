...
NotificationType, Gauge32, Counter32, MibIdentifier, Counter64, ModuleIdentity, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, TimeTicks, Bits, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter32", "MibIdentifier", "Counter64", "ModuleIdentity", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "TimeTicks", "Bits", "IpAddress", "ObjectIdentity")
TimeStamp, TextualConvention, TruthValue, DisplayString, RowPointer, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TruthValue", "DisplayString", "RowPointer", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportOther=scsiTranportOther, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuState=scsiLuState, scsiGroups=scsiGroups, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiPortRole=scsiPortRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdValue=scsiLuIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiName=ScsiName, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiLuHSInCommands=scsiLuHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotifications=scsiNotifications, scsiRemoteTarget=scsiRemoteTarget, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, scsiLunMapTable=scsiLunMapTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInCommands=scsiLuInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdType=ScsiIdType, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliances=scsiCompliances, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiDscLunTable=scsiDscLunTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiObjects=scsiObjects, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceTable=scsiDeviceTable, ScsiIndexValue=ScsiIndexValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtName=scsiDscTgtName, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiCompliance=scsiCompliance, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiModule=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapLun=scsiLunMapLun, ScsiIdAssociation=ScsiIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuTable=scsiLuTable, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation)
