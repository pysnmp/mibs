...
ModuleIdentity, Counter64, Counter32, Integer32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Gauge32, iso, Bits, Unsigned32, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Counter32", "Integer32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Gauge32", "iso", "Bits", "Unsigned32", "IpAddress", "mib-2")
TextualConvention, DisplayString, TruthValue, AutonomousType, TimeStamp, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "AutonomousType", "TimeStamp", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiName=ScsiName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdType=ScsiIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuRevisionId=scsiLuRevisionId, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportFCP=scsiTransportFCP, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiPortTable=scsiPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiModule=scsiModule, scsiLuState=scsiLuState, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, ScsiIdentifier=ScsiIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiLuIdValue=scsiLuIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuWwnName=scsiLuWwnName, scsiNotifications=scsiNotifications, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstanceTable=scsiInstanceTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiCompliance=scsiCompliance, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuEntry=scsiLuEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLogicalUnit=scsiLogicalUnit, scsiLuTable=scsiLuTable, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuStatus=scsiLuStatus, ScsiIdValue=ScsiIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportSBP=scsiTransportSBP, scsiPortRole=scsiPortRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportSRP=scsiTransportSRP, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuProductId=scsiLuProductId, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportTypes=scsiTransportTypes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiCompliances=scsiCompliances, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiGeneral=scsiGeneral, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiConformance=scsiConformance, scsiInstIndex=scsiInstIndex, scsiLunMapTable=scsiLunMapTable, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiTransportISCSI=scsiTransportISCSI)
