...
mib_2, MibIdentifier, Bits, IpAddress, Gauge32, iso, Counter32, TimeTicks, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "iso", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Counter64")
TextualConvention, RowPointer, DisplayString, AutonomousType, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "DisplayString", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiDscTgtEntry=scsiDscTgtEntry, scsiGroups=scsiGroups, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, scsiPortIndex=scsiPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportOther=scsiTranportOther, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiConformance=scsiConformance, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuTable=scsiLuTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortEntry=scsiPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiInstanceTable=scsiInstanceTable, scsiTrnsptType=scsiTrnsptType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuVendorId=scsiLuVendorId, scsiModule=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortRole=scsiPortRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdType=scsiDscLunIdType, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceRole=scsiDeviceRole, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuInResets=scsiLuInResets, scsiTrnsptTable=scsiTrnsptTable, scsiObjects=scsiObjects, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceEntry=scsiDeviceEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiName=ScsiName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliances=scsiCompliances, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuEntry=scsiLuEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtPortName=scsiTgtPortName, scsiDscTgtName=scsiDscTgtName, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIndex=scsiLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiTargetGroup=scsiTargetGroup, scsiLuInCommands=scsiLuInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportSPI=scsiTranportSPI, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportSRP=scsiTransportSRP, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, scsiNotifications=scsiNotifications, scsiTarget=scsiTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdType=scsiLuIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiator=scsiInitiator, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTransportFCP=scsiTransportFCP, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceTable=scsiDeviceTable)
