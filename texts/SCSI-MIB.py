...
Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, mib_2, MibIdentifier, ModuleIdentity, iso, Bits, Gauge32, Counter32, ObjectIdentity, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "mib-2", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "Gauge32", "Counter32", "ObjectIdentity", "Integer32", "Unsigned32")
TextualConvention, AutonomousType, RowStatus, TruthValue, RowPointer, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowStatus", "TruthValue", "RowPointer", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiObjects=scsiObjects, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortIndex=scsiPortIndex, scsiLuEntry=scsiLuEntry, scsiLuStatus=scsiLuStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceIndex=scsiDeviceIndex, ScsiName=ScsiName, scsiTrnsptType=scsiTrnsptType, scsiLuProductId=scsiLuProductId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, ScsiIdType=ScsiIdType, scsiLuIdTable=scsiLuIdTable, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIndex=scsiDscLunIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortEntry=scsiPortEntry, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiator=scsiInitiator, scsiTgtPortName=scsiTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstIndex=scsiInstIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtName=scsiDscTgtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortEntry=scsiTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiInstanceTable=scsiInstanceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuInResets=scsiLuInResets, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTarget=scsiTarget, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiModule=scsiModule, scsiLuVendorId=scsiLuVendorId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, scsiRemoteTarget=scsiRemoteTarget, scsiGeneral=scsiGeneral, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSBP=scsiTransportSBP, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunTable=scsiDscLunTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, scsiCompliances=scsiCompliances, PYSNMP_MODULE_ID=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdType=scsiLuIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortRole=scsiPortRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapTable=scsiLunMapTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuState=scsiLuState, scsiInstanceEntry=scsiInstanceEntry, scsiConformance=scsiConformance, scsiTranportOther=scsiTranportOther)
