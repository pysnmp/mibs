...
iso, ObjectIdentity, NotificationType, Bits, MibIdentifier, mib_2, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Counter64, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "NotificationType", "Bits", "MibIdentifier", "mib-2", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Counter64", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLogicalUnit=scsiLogicalUnit, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceResets=scsiDeviceResets, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatus=scsiLuStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuState=scsiLuState, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortIndex=scsiPortIndex, ScsiIdValue=ScsiIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapTable=scsiLunMapTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInResets=scsiLuInResets, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortEntry=scsiPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuEntry=scsiLuEntry, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiGroups=scsiGroups, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiLUNOrZero=ScsiLUNOrZero, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotifications=scsiNotifications, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportSRP=scsiTransportSRP, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiModule=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiConformance=scsiConformance, scsiGeneral=scsiGeneral, scsiDeviceRole=scsiDeviceRole, scsiInitiator=scsiInitiator, scsiObjects=scsiObjects, scsiInstIndex=scsiInstIndex, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevTable=scsiTgtDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportSBP=scsiTransportSBP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiCompliances=scsiCompliances, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapLun=scsiLunMapLun, scsiTgtPortTable=scsiTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstanceTable=scsiInstanceTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuTable=scsiLuTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportOther=scsiTranportOther, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, scsiLuProductId=scsiLuProductId, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiPortTable=scsiPortTable, scsiDscLunLun=scsiDscLunLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdType=scsiDscLunIdType, ScsiName=ScsiName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx)
