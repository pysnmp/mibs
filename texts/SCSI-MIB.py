...
Gauge32, mib_2, ModuleIdentity, Integer32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Bits, iso, IpAddress, MibIdentifier, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "ModuleIdentity", "Integer32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Bits", "iso", "IpAddress", "MibIdentifier", "NotificationType", "Counter32")
TimeStamp, AutonomousType, TextualConvention, RowPointer, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TextualConvention", "RowPointer", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotifications=scsiNotifications, scsiPortRole=scsiPortRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrName=scsiAuthIntrName, ScsiIdValue=ScsiIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWwnName=scsiLuWwnName, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportSPI=scsiTranportSPI, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTable=scsiPortTable, scsiConformance=scsiConformance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTranportOther=scsiTranportOther, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunLun=scsiDscLunLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, PYSNMP_MODULE_ID=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceTable=scsiDeviceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunTable=scsiDscLunTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiCompliance=scsiCompliance, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, scsiLuTable=scsiLuTable, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuState=scsiLuState, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIndex=scsiLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSRP=scsiTransportSRP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiInstIndex=scsiInstIndex, scsiLuIdValue=scsiLuIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiObjects=scsiObjects, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortName=scsiTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtEntry=scsiDscTgtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceTable=scsiInstanceTable, scsiCompliances=scsiCompliances, scsiInitiator=scsiInitiator, scsiInstVendorVersion=scsiInstVendorVersion, ScsiName=ScsiName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapTable=scsiLunMapTable, ScsiIdentifier=ScsiIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
