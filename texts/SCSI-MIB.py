...
Unsigned32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, TimeTicks, Integer32, ObjectIdentity, MibIdentifier, Counter32, NotificationType, ModuleIdentity, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter32", "NotificationType", "ModuleIdentity", "mib-2", "Counter64")
TimeStamp, TruthValue, RowStatus, RowPointer, AutonomousType, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "RowPointer", "AutonomousType", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptTable=scsiTrnsptTable, scsiCompliance=scsiCompliance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstIndex=scsiInstIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGeneral=scsiGeneral, scsiLuVendorId=scsiLuVendorId, ScsiIdType=ScsiIdType, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLun=scsiLunMapLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceTable=scsiDeviceTable, scsiLunMapTable=scsiLunMapTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceResets=scsiDeviceResets, scsiLunMapGroup=scsiLunMapGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunTable=scsiDscLunTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortRole=scsiPortRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiInitiator=scsiInitiator, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortEntry=scsiPortEntry, scsiTransportFCP=scsiTransportFCP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportOther=scsiTranportOther, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIndex=scsiLuIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatus=scsiLuStatus, scsiPortTable=scsiPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiTarget=scsiTarget, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiPortIndex=scsiPortIndex, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunLun=scsiDscLunLun, scsiNotifications=scsiNotifications, scsiDscTgtTable=scsiDscTgtTable, scsiConformance=scsiConformance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiModule=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiInstanceTable=scsiInstanceTable, scsiInstAlias=scsiInstAlias, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuState=scsiLuState, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdType=scsiLuIdType, scsiDscTgtName=scsiDscTgtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx)
