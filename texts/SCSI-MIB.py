...
NotificationType, Gauge32, MibIdentifier, TimeTicks, Bits, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ObjectIdentity, ModuleIdentity, mib_2, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "TimeTicks", "Bits", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "mib-2", "IpAddress", "Integer32")
RowPointer, RowStatus, DisplayString, TruthValue, TextualConvention, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "DisplayString", "TruthValue", "TextualConvention", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtName=scsiDscTgtName, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliance=scsiCompliance, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuProductId=scsiLuProductId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiTrnsptType=scsiTrnsptType, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, ScsiIdValue=ScsiIdValue, scsiDscLunLun=scsiDscLunLun, scsiGeneral=scsiGeneral, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSBP=scsiTransportSBP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiLuIdType=scsiLuIdType, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTransportISCSI=scsiTransportISCSI, ScsiIdAssociation=ScsiIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiModule=scsiModule, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdTable=scsiLuIdTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiPortIndex=scsiPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiName=ScsiName, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatus=scsiLuStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIndex=scsiLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapLun=scsiLunMapLun, scsiInitiator=scsiInitiator, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportOther=scsiTranportOther, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortTable=scsiPortTable, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiLuInCommands=scsiLuInCommands, scsiLuState=scsiLuState, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdTable=scsiDscLunIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTarget=scsiTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrName=scsiAuthIntrName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWwnName=scsiLuWwnName)
