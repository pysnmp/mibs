...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Gauge32, Bits, Integer32, iso, IpAddress, Counter32, Unsigned32, NotificationType, ObjectIdentity, TimeTicks, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Gauge32", "Bits", "Integer32", "iso", "IpAddress", "Counter32", "Unsigned32", "NotificationType", "ObjectIdentity", "TimeTicks", "mib-2")
RowStatus, TimeStamp, AutonomousType, TruthValue, TextualConvention, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuState=scsiLuState, scsiInstanceEntry=scsiInstanceEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapTable=scsiLunMapTable, scsiLunMapLun=scsiLunMapLun, scsiTrnsptTable=scsiTrnsptTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportOther=scsiTranportOther, scsiLuStatusChanged=scsiLuStatusChanged, scsiGeneral=scsiGeneral, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortEntry=scsiPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiConformance=scsiConformance, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevTable=scsiTgtDevTable, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliances=scsiCompliances, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiObjects=scsiObjects, scsiPortIndex=scsiPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstAlias=scsiInstAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuTable=scsiLuTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceGroup=scsiDeviceGroup, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunTable=scsiDscLunTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuProductId=scsiLuProductId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuEntry=scsiLuEntry, scsiDeviceTable=scsiDeviceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIndex=scsiDscLunIndex, ScsiName=ScsiName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuRevisionId=scsiLuRevisionId, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, scsiTargetGroup=scsiTargetGroup, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtName=scsiDscTgtName, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdValue=scsiLuIdValue, scsiTrnsptType=scsiTrnsptType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, ScsiIdValue=ScsiIdValue, scsiModule=scsiModule, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiator=scsiInitiator, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTable=scsiPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortName=scsiTgtPortName, scsiGroups=scsiGroups, scsiCompliance=scsiCompliance, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiNotifications=scsiNotifications, scsiLuIdType=scsiLuIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunLun=scsiDscLunLun)
