...
NotificationType, Counter32, MibIdentifier, Unsigned32, ObjectIdentity, mib_2, Integer32, iso, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "MibIdentifier", "Unsigned32", "ObjectIdentity", "mib-2", "Integer32", "iso", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter64", "ModuleIdentity")
RowStatus, AutonomousType, TextualConvention, TimeStamp, RowPointer, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "TimeStamp", "RowPointer", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiInitiator=scsiInitiator, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, scsiTranportOther=scsiTranportOther, scsiLuProductId=scsiLuProductId, scsiCompliance=scsiCompliance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortEntry=scsiTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportTypes=scsiTransportTypes, scsiDeviceAlias=scsiDeviceAlias, ScsiName=ScsiName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdType=scsiLuIdType, ScsiIdType=ScsiIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiDscTgtName=scsiDscTgtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiConformance=scsiConformance, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortIndex=scsiPortIndex, scsiLuEntry=scsiLuEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstAlias=scsiInstAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInCommands=scsiLuInCommands, scsiPortRole=scsiPortRole, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportFCP=scsiTransportFCP, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGeneral=scsiGeneral, scsiDeviceRole=scsiDeviceRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiNotifications=scsiNotifications, scsiDscTgtTable=scsiDscTgtTable, scsiLuState=scsiLuState, ScsiIdValue=ScsiIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiPortTable=scsiPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiLuTable=scsiLuTable, scsiModule=scsiModule, scsiDscLunLun=scsiDscLunLun, PYSNMP_MODULE_ID=scsiModule, scsiLogicalUnit=scsiLogicalUnit, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiObjects=scsiObjects, scsiTarget=scsiTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstIndex=scsiInstIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtIndex=scsiDscTgtIndex)
