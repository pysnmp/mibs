...
Counter64, Gauge32, mib_2, TimeTicks, Integer32, iso, Counter32, Bits, IpAddress, ModuleIdentity, MibIdentifier, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "mib-2", "TimeTicks", "Integer32", "iso", "Counter32", "Bits", "IpAddress", "ModuleIdentity", "MibIdentifier", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
TextualConvention, AutonomousType, TimeStamp, DisplayString, RowStatus, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuProductId=scsiLuProductId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortName=scsiTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceTable=scsiInstanceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortIndex=scsiPortIndex, scsiLunMapIndex=scsiLunMapIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdValue=scsiLuIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, ScsiIdValue=ScsiIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDevicePortNumber=scsiDevicePortNumber, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortEntry=scsiPortEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuInCommands=scsiLuInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiGeneral=scsiGeneral, scsiRemoteTarget=scsiRemoteTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuWwnName=scsiLuWwnName, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiPortRole=scsiPortRole, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstIndex=scsiInstIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatus=scsiLuStatus, scsiLuEntry=scsiLuEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiInstanceEntry=scsiInstanceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdTable=scsiLuIdTable, scsiObjects=scsiObjects, scsiModule=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdType=ScsiIdType, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceGroup=scsiDeviceGroup, scsiInitiator=scsiInitiator, scsiCompliance=scsiCompliance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstAlias=scsiInstAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportOther=scsiTranportOther, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, scsiLuIdType=scsiLuIdType, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptType=scsiTrnsptType)
