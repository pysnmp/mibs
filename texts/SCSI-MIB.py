...
Counter32, NotificationType, Gauge32, Unsigned32, Integer32, mib_2, Bits, TimeTicks, IpAddress, ModuleIdentity, Counter64, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "mib-2", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, RowPointer, TextualConvention, RowStatus, AutonomousType, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus", "AutonomousType", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiLuIndex=scsiLuIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTarget=scsiTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiInstIndex=scsiInstIndex, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInCommands=scsiLuInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiTranportSPI=scsiTranportSPI, scsiLuStatus=scsiLuStatus, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIndexValue=ScsiIndexValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiNotifications=scsiNotifications, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliance=scsiCompliance, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiCompliances=scsiCompliances, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortRole=scsiPortRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdType=scsiDscLunIdType, scsiGroups=scsiGroups, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdValue=scsiDscLunIdValue, ScsiName=ScsiName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuTable=scsiLuTable, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiConformance=scsiConformance, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWwnName=scsiLuWwnName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiator=scsiInitiator, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiTransportTypes=scsiTransportTypes, scsiLuInResets=scsiLuInResets, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiObjects=scsiObjects, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapLun=scsiLunMapLun, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapIndex=scsiLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
