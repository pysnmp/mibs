...
Unsigned32, Gauge32, ObjectIdentity, Counter64, Integer32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, IpAddress, NotificationType, ModuleIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter64", "Integer32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "IpAddress", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks")
TimeStamp, DisplayString, TextualConvention, RowStatus, TruthValue, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevEntry=scsiIntrDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiObjects=scsiObjects, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiator=scsiInitiator, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIndexValue=ScsiIndexValue, scsiLuInCommands=scsiLuInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtTable=scsiDscTgtTable, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdTable=scsiLuIdTable, ScsiIdType=ScsiIdType, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, scsiCompliance=scsiCompliance, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLun=scsiLunMapLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportFCP=scsiTransportFCP, scsiLuVendorId=scsiLuVendorId, scsiLuEntry=scsiLuEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliances=scsiCompliances, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiName=ScsiName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiLunMapTable=scsiLunMapTable, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstAlias=scsiInstAlias, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptType=scsiTrnsptType, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdType=scsiLuIdType, scsiConformance=scsiConformance, scsiLuStatus=scsiLuStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportTypes=scsiTransportTypes, scsiLuIndex=scsiLuIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTable=scsiPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInResets=scsiLuInResets, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceRole=scsiDeviceRole, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceResets=scsiDeviceResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiModule=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiGroups=scsiGroups, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdValue=scsiLuIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTarget=scsiTarget, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry)
