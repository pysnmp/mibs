...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, MibIdentifier, mib_2, Gauge32, Unsigned32, iso, Bits, Counter32, NotificationType, TimeTicks, IpAddress, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "MibIdentifier", "mib-2", "Gauge32", "Unsigned32", "iso", "Bits", "Counter32", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64")
TextualConvention, AutonomousType, TruthValue, RowStatus, RowPointer, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TruthValue", "RowStatus", "RowPointer", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGroups=scsiGroups, scsiLuDefaultLun=scsiLuDefaultLun, PYSNMP_MODULE_ID=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiTgtPortName=scsiTgtPortName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiModule=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiLunMapLun=scsiLunMapLun, scsiDeviceEntry=scsiDeviceEntry, scsiObjects=scsiObjects, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiInitiator=scsiInitiator, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceRole=scsiDeviceRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuInResets=scsiLuInResets, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTransportFCP=scsiTransportFCP, ScsiIdentifier=ScsiIdentifier, scsiInstIndex=scsiInstIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiName=ScsiName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuTable=scsiLuTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotifications=scsiNotifications, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortRole=scsiPortRole, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptType=scsiTrnsptType, scsiLuEntry=scsiLuEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiLuIdTable=scsiLuIdTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstAlias=scsiInstAlias, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSRP=scsiTransportSRP, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuState=scsiLuState, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdValue=ScsiIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiPortEntry=scsiPortEntry, scsiLuStatus=scsiLuStatus, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiCompliances=scsiCompliances, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTarget=scsiTarget, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtName=scsiDscTgtName, scsiDscLunEntry=scsiDscLunEntry)
