...
Counter32, MibIdentifier, Integer32, Counter64, ObjectIdentity, mib_2, Unsigned32, ModuleIdentity, Bits, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "Counter64", "ObjectIdentity", "mib-2", "Unsigned32", "ModuleIdentity", "Bits", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Gauge32")
DisplayString, RowPointer, TextualConvention, RowStatus, TimeStamp, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TextualConvention", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGroups=scsiGroups, scsiDscLunTable=scsiDscLunTable, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiConformance=scsiConformance, scsiInstIndex=scsiInstIndex, scsiPortRole=scsiPortRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportSRP=scsiTransportSRP, scsiLuIdValue=scsiLuIdValue, scsiLuProductId=scsiLuProductId, scsiTgtPortName=scsiTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiTarget=scsiTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGeneral=scsiGeneral, scsiDeviceTable=scsiDeviceTable, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTable=scsiIntrDevTable, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInResets=scsiLuInResets, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtName=scsiDscTgtName, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuTable=scsiLuTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetGroup=scsiTargetGroup, scsiPortIndex=scsiPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiCompliance=scsiCompliance, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiLuVendorId=scsiLuVendorId, scsiNotifications=scsiNotifications, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceRole=scsiDeviceRole, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuState=scsiLuState, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceEntry=scsiDeviceEntry, scsiModule=scsiModule, scsiLuStatus=scsiLuStatus, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiInitiator=scsiInitiator, scsiTranportOther=scsiTranportOther, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapIndex=scsiLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortTable=scsiPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiName=ScsiName, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstAlias=scsiInstAlias)
