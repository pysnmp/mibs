...
ObjectIdentity, ModuleIdentity, Unsigned32, Gauge32, MibIdentifier, Counter32, IpAddress, Counter64, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Gauge32", "MibIdentifier", "Counter32", "IpAddress", "Counter64", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "mib-2", "Integer32")
TextualConvention, DisplayString, TruthValue, AutonomousType, RowPointer, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "AutonomousType", "RowPointer", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiGeneral=scsiGeneral, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiPortRole=scsiPortRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIndex=scsiLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunLun=scsiDscLunLun, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdType=scsiLuIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiConformance=scsiConformance, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiNotifications=scsiNotifications, scsiLunMapTable=scsiLunMapTable, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiInstanceTable=scsiInstanceTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiator=scsiInitiator, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiLuTable=scsiLuTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiModule=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortEntry=scsiPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTarget=scsiTarget, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiTranportSPI=scsiTranportSPI, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdValue=scsiLuIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIndexValue=ScsiIndexValue, scsiDeviceEntry=scsiDeviceEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptType=scsiTrnsptType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportFCP=scsiTransportFCP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuVendorId=scsiLuVendorId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceRole=scsiDeviceRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable)
