...
NotificationType, Counter64, IpAddress, MibIdentifier, Counter32, mib_2, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Integer32, ModuleIdentity, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "IpAddress", "MibIdentifier", "Counter32", "mib-2", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Integer32", "ModuleIdentity", "TimeTicks", "Bits")
AutonomousType, RowPointer, RowStatus, TextualConvention, TimeStamp, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortRole=scsiPortRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTranportOther=scsiTranportOther, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, scsiTarget=scsiTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortIndex=scsiPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtName=scsiDscTgtName, ScsiIdValue=ScsiIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortName=scsiTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunLun=scsiDscLunLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiGroups=scsiGroups, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLuEntry=scsiLuEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiName=ScsiName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceRole=scsiDeviceRole, scsiObjects=scsiObjects, scsiCompliances=scsiCompliances, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatus=scsiLuStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuProductId=scsiLuProductId, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdentifier=ScsiIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstIndex=scsiInstIndex, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdType=ScsiIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiConformance=scsiConformance, scsiDeviceIndex=scsiDeviceIndex, scsiLuTable=scsiLuTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSRP=scsiTransportSRP, scsiLunMapLun=scsiLunMapLun)
