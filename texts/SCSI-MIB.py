...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Counter32, TimeTicks, NotificationType, MibIdentifier, Bits, iso, ObjectIdentity, Integer32, mib_2, Unsigned32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Counter32", "TimeTicks", "NotificationType", "MibIdentifier", "Bits", "iso", "ObjectIdentity", "Integer32", "mib-2", "Unsigned32", "IpAddress", "ModuleIdentity")
TimeStamp, RowStatus, RowPointer, AutonomousType, TextualConvention, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "RowPointer", "AutonomousType", "TextualConvention", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiLuVendorId=scsiLuVendorId, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceResets=scsiDeviceResets, scsiCompliance=scsiCompliance, scsiLuProductId=scsiLuProductId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstAlias=scsiInstAlias, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortEntry=scsiPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstIndex=scsiInstIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiLuInCommands=scsiLuInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSRP=scsiTransportSRP, scsiInstanceEntry=scsiInstanceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiLuIdEntry=scsiLuIdEntry, scsiTargetGroup=scsiTargetGroup, scsiTrnsptType=scsiTrnsptType, scsiGroups=scsiGroups, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdType=scsiLuIdType, ScsiIdValue=ScsiIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdentifier=ScsiIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLun=scsiLunMapLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdType=scsiDscLunIdType, scsiTranportSPI=scsiTranportSPI, scsiDscLunEntry=scsiDscLunEntry, scsiLuState=scsiLuState, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuTable=scsiLuTable, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunLun=scsiDscLunLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiLuInResets=scsiLuInResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdValue=scsiLuIdValue, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiConformance=scsiConformance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortTable=scsiPortTable, scsiCompliances=scsiCompliances, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIndex=scsiLuIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtName=scsiDscTgtName, ScsiIdType=ScsiIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValue=ScsiIndexValue)
