...
Gauge32, Unsigned32, iso, Integer32, ObjectIdentity, Counter32, MibIdentifier, NotificationType, Counter64, ModuleIdentity, TimeTicks, Bits, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "iso", "Integer32", "ObjectIdentity", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "ModuleIdentity", "TimeTicks", "Bits", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, AutonomousType, RowStatus, DisplayString, TruthValue, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowStatus", "DisplayString", "TruthValue", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIndexValue=ScsiIndexValue, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLuEntry=scsiLuEntry, scsiGeneral=scsiGeneral, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapEntry=scsiLunMapEntry, ScsiName=ScsiName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiGroups=scsiGroups, scsiPortIndex=scsiPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportFCP=scsiTransportFCP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuInResets=scsiLuInResets, scsiLuState=scsiLuState, scsiTranportOther=scsiTranportOther, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdType=ScsiIdType, scsiAuthIntrName=scsiAuthIntrName, scsiTargetGroup=scsiTargetGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceTable=scsiDeviceTable, scsiTgtPortEntry=scsiTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuStatus=scsiLuStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortEntry=scsiPortEntry, scsiCompliance=scsiCompliance, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiObjects=scsiObjects, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptType=scsiTrnsptType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiCompliances=scsiCompliances, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiPortRole=scsiPortRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiTarget=scsiTarget, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuTable=scsiLuTable, scsiLuIdType=scsiLuIdType, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuProductId=scsiLuProductId, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceAlias=scsiDeviceAlias, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIndex=scsiDscLunIndex)
