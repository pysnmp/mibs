...
ModuleIdentity, IpAddress, mib_2, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, TimeTicks, Counter64, iso, MibIdentifier, Counter32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "mib-2", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "TimeTicks", "Counter64", "iso", "MibIdentifier", "Counter32", "Integer32", "NotificationType")
AutonomousType, TruthValue, RowPointer, TextualConvention, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowPointer", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstIndex=scsiInstIndex, scsiGeneral=scsiGeneral, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptType=scsiTrnsptType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortEntry=scsiPortEntry, scsiLuProductId=scsiLuProductId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstAlias=scsiInstAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiator=scsiInitiator, scsiPortIndex=scsiPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuEntry=scsiLuEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiNotifications=scsiNotifications, scsiTransportSRP=scsiTransportSRP, scsiObjects=scsiObjects, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtName=scsiDscTgtName, scsiConformance=scsiConformance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuState=scsiLuState, scsiTranportOther=scsiTranportOther, ScsiIdType=ScsiIdType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortRole=scsiPortRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdValue=ScsiIdValue, ScsiName=ScsiName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceRole=scsiDeviceRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiModule=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortTable=scsiPortTable, scsiLunMapEntry=scsiLunMapEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiLuWwnName=scsiLuWwnName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetGroup=scsiTargetGroup, scsiCompliances=scsiCompliances, scsiLuInResets=scsiLuInResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtName=scsiIntrPrtName, scsiLuIndex=scsiLuIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortTable=scsiTgtPortTable, scsiTransportFCP=scsiTransportFCP, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiLuTable=scsiLuTable, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceGroup=scsiDeviceGroup)
