...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, ModuleIdentity, TimeTicks, Unsigned32, iso, NotificationType, Counter32, Counter64, ObjectIdentity, mib_2, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32", "iso", "NotificationType", "Counter32", "Counter64", "ObjectIdentity", "mib-2", "IpAddress", "Bits")
RowPointer, TruthValue, TextualConvention, DisplayString, TimeStamp, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiDeviceResets=scsiDeviceResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTable=scsiPortTable, scsiDeviceRole=scsiDeviceRole, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetGroup=scsiTargetGroup, ScsiIndexValue=ScsiIndexValue, scsiLuIndex=scsiLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortIndex=scsiPortIndex, scsiLuWwnName=scsiLuWwnName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuState=scsiLuState, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstAlias=scsiInstAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdType=ScsiIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotifications=scsiNotifications, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, ScsiIdentifier=ScsiIdentifier, scsiTransportSRP=scsiTransportSRP, scsiLuIdValue=scsiLuIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTranportOther=scsiTranportOther, scsiLuIdIndex=scsiLuIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuTable=scsiLuTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortEntry=scsiPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiConformance=scsiConformance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevTable=scsiTgtDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptTable=scsiTrnsptTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGroups=scsiGroups, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInResets=scsiLuInResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiTarget=scsiTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiator=scsiInitiator, scsiObjects=scsiObjects, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliances=scsiCompliances, scsiDscTgtName=scsiDscTgtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiLuIdEntry=scsiLuIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiModule=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInCommands=scsiLuInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands)
