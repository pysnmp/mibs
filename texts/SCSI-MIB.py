...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter64, TimeTicks, mib_2, NotificationType, ModuleIdentity, Counter32, IpAddress, Bits, ObjectIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter64", "TimeTicks", "mib-2", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "Bits", "ObjectIdentity", "Gauge32", "iso")
TruthValue, DisplayString, TimeStamp, RowStatus, TextualConvention, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortRole=scsiPortRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiTrnsptTable=scsiTrnsptTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuState=scsiLuState, scsiDeviceRole=scsiDeviceRole, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiLuVendorId=scsiLuVendorId, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdTable=scsiLuIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, scsiLuIdEntry=scsiLuIdEntry, scsiLuEntry=scsiLuEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiConformance=scsiConformance, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTarget=scsiTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiLuProductId=scsiLuProductId, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiInstIndex=scsiInstIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliance=scsiCompliance, scsiInstanceTable=scsiInstanceTable, scsiTargetGroup=scsiTargetGroup, scsiDeviceResets=scsiDeviceResets, scsiTranportSPI=scsiTranportSPI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValue=ScsiIndexValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdentifier=ScsiIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTable=scsiPortTable, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuIndex=scsiLuIndex, scsiObjects=scsiObjects, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunLun=scsiDscLunLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdValue=scsiLuIdValue, ScsiName=ScsiName, scsiModule=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotifications=scsiNotifications, scsiTrnsptType=scsiTrnsptType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTranportOther=scsiTranportOther, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiator=scsiInitiator)
