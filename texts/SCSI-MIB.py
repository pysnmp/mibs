...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType, Counter32, mib_2, Bits, Counter64, IpAddress, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "Bits", "Counter64", "IpAddress", "Gauge32", "TimeTicks")
RowPointer, TextualConvention, RowStatus, AutonomousType, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "RowStatus", "AutonomousType", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstIndex=scsiInstIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuIdType=scsiLuIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuState=scsiLuState, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortRole=scsiPortRole, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdType=ScsiIdType, scsiPortTable=scsiPortTable, scsiDeviceAlias=scsiDeviceAlias, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, scsiLuInCommands=scsiLuInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiModule=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiObjects=scsiObjects, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiDeviceResets=scsiDeviceResets, scsiGeneral=scsiGeneral, scsiAttTgtPortIndex=scsiAttTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuStatus=scsiLuStatus, scsiLuInResets=scsiLuInResets, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiator=scsiInitiator, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceTable=scsiDeviceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSBP=scsiTransportSBP, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiInstanceTable=scsiInstanceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTarget=scsiTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValue=ScsiIndexValue, scsiTrnsptType=scsiTrnsptType, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevTable=scsiTgtDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstAlias=scsiInstAlias, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapIndex=scsiLunMapIndex, ScsiIdValue=ScsiIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGroups=scsiGroups, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiTranportOther=scsiTranportOther, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportSPI=scsiTranportSPI, scsiTgtPortName=scsiTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunLun=scsiDscLunLun, scsiPortIndex=scsiPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtName=scsiDscTgtName, scsiCompliance=scsiCompliance, scsiPortEntry=scsiPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable)
