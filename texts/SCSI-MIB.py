...
NotificationType, mib_2, Counter64, Bits, Gauge32, MibIdentifier, IpAddress, iso, TimeTicks, Integer32, ObjectIdentity, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "Counter64", "Bits", "Gauge32", "MibIdentifier", "IpAddress", "iso", "TimeTicks", "Integer32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, AutonomousType, RowStatus, TimeStamp, RowPointer, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowStatus", "TimeStamp", "RowPointer", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdType=ScsiIdType, scsiTransportTypes=scsiTransportTypes, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiName=ScsiName, scsiIntrDevTable=scsiIntrDevTable, scsiInstAlias=scsiInstAlias, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuState=scsiLuState, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWwnName=scsiLuWwnName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortEntry=scsiPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptType=scsiTrnsptType, scsiInitiator=scsiInitiator, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdIndex=scsiLuIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiCompliances=scsiCompliances, scsiLuPeripheralType=scsiLuPeripheralType, scsiConformance=scsiConformance, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTable=scsiPortTable, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiDscLunLun=scsiDscLunLun, scsiGroups=scsiGroups, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiGeneral=scsiGeneral, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstanceTable=scsiInstanceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotifications=scsiNotifications, scsiInstIndex=scsiInstIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdType=scsiLuIdType, scsiTranportSPI=scsiTranportSPI, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiModule=scsiModule, scsiObjects=scsiObjects, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiCompliance=scsiCompliance, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, PYSNMP_MODULE_ID=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtTable=scsiIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortIndex=scsiPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortRole=scsiPortRole, ScsiIdAssociation=ScsiIdAssociation, scsiTarget=scsiTarget, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevTable=scsiTgtDevTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValue=ScsiIndexValue, scsiDscTgtName=scsiDscTgtName, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged)
