...
TimeTicks, Gauge32, Bits, Counter32, ObjectIdentity, ModuleIdentity, MibIdentifier, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Bits", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Integer32", "iso", "NotificationType")
AutonomousType, RowStatus, TruthValue, TextualConvention, RowPointer, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "RowPointer", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiTranportSPI=scsiTranportSPI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliances=scsiCompliances, scsiTarget=scsiTarget, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdType=scsiLuIdType, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiTargetGroup=scsiTargetGroup, scsiModule=scsiModule, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGroups=scsiGroups, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiator=scsiInitiator, scsiDeviceIndex=scsiDeviceIndex, scsiLuVendorId=scsiLuVendorId, scsiPortTable=scsiPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWwnName=scsiLuWwnName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportTypes=scsiTransportTypes, scsiLuIndex=scsiLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiLuInResets=scsiLuInResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatus=scsiLuStatus, scsiDscTgtName=scsiDscTgtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiConformance=scsiConformance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdTable=scsiLuIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortRole=scsiPortRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceResets=scsiDeviceResets, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceRole=scsiDeviceRole, scsiLunMapTable=scsiLunMapTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortEntry=scsiPortEntry, scsiTrnsptType=scsiTrnsptType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiCompliance=scsiCompliance, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortIndex=scsiPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstAlias=scsiInstAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValue=ScsiIndexValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGeneral=scsiGeneral, scsiLuTable=scsiLuTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort)
