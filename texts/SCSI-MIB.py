...
Gauge32, Unsigned32, Bits, ObjectIdentity, IpAddress, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64, Integer32, mib_2, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64", "Integer32", "mib-2", "ModuleIdentity", "iso")
TimeStamp, RowPointer, AutonomousType, DisplayString, TextualConvention, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportISCSI=scsiTransportISCSI, scsiInitiator=scsiInitiator, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGroups=scsiGroups, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatus=scsiLuStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunLun=scsiDscLunLun, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortTable=scsiPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuTable=scsiLuTable, scsiTarget=scsiTarget, scsiTargetGroup=scsiTargetGroup, ScsiIdType=ScsiIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdValue=scsiLuIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, scsiLunMapGroup=scsiLunMapGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, ScsiIdValue=ScsiIdValue, scsiInstAlias=scsiInstAlias, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIndex=scsiDscLunIndex, scsiLuState=scsiLuState, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiConformance=scsiConformance, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptType=scsiTrnsptType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIndex=scsiLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuEntry=scsiLuEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliance=scsiCompliance, scsiDscLunEntry=scsiDscLunEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceRole=scsiDeviceRole, scsiLuWwnName=scsiLuWwnName, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstIndex=scsiInstIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInResets=scsiLuInResets, scsiObjects=scsiObjects, scsiTransportSBP=scsiTransportSBP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValue=ScsiIndexValue, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiModule=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdType=scsiDscLunIdType, scsiLuProductId=scsiLuProductId, ScsiIdAssociation=ScsiIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiPortRole=scsiPortRole, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiDeviceResets=scsiDeviceResets)
