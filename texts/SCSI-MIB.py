...
Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, ModuleIdentity, MibIdentifier, TimeTicks, NotificationType, Counter64, Gauge32, iso, IpAddress, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "Gauge32", "iso", "IpAddress", "mib-2", "Integer32")
RowStatus, DisplayString, TimeStamp, TruthValue, TextualConvention, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIdValue=scsiLuIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiObjects=scsiObjects, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, scsiInstIndex=scsiInstIndex, ScsiIdentifier=ScsiIdentifier, scsiLunMapTable=scsiLunMapTable, scsiLuIdType=scsiLuIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSBP=scsiTransportSBP, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliance=scsiCompliance, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceRole=scsiDeviceRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortIndex=scsiPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWwnName=scsiLuWwnName, scsiLuInCommands=scsiLuInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdTable=scsiLuIdTable, ScsiIdType=ScsiIdType, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGroups=scsiGroups, scsiLuIdAssociation=scsiLuIdAssociation, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstanceTable=scsiInstanceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceResets=scsiDeviceResets, scsiLunMapLun=scsiLunMapLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetGroup=scsiTargetGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiNotifications=scsiNotifications, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstAlias=scsiInstAlias, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, scsiTarget=scsiTarget, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValue=ScsiIndexValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiModule=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdValue=ScsiIdValue, scsiConformance=scsiConformance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuState=scsiLuState, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiName=ScsiName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTable=scsiPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIndex=scsiLuIndex, scsiIntrDevEntry=scsiIntrDevEntry)
