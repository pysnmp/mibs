...
Counter64, IpAddress, Bits, Counter32, NotificationType, ModuleIdentity, Unsigned32, iso, Gauge32, mib_2, TimeTicks, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Bits", "Counter32", "NotificationType", "ModuleIdentity", "Unsigned32", "iso", "Gauge32", "mib-2", "TimeTicks", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
RowStatus, RowPointer, AutonomousType, TextualConvention, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "AutonomousType", "TextualConvention", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapLun=scsiLunMapLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdValue=ScsiIdValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGeneral=scsiGeneral, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiCompliances=scsiCompliances, ScsiLUNOrZero=ScsiLUNOrZero, scsiModule=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortIndex=scsiPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuInCommands=scsiLuInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValue=ScsiIndexValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIndex=scsiLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuState=scsiLuState, ScsiName=ScsiName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdIndex=scsiLuIdIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevTable=scsiTgtDevTable, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstAlias=scsiInstAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetGroup=scsiTargetGroup, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortRole=scsiPortRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotifications=scsiNotifications, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuEntry=scsiLuEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortEntry=scsiPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunTable=scsiDscLunTable, scsiLuIdType=scsiLuIdType, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiTransportSRP=scsiTransportSRP, scsiInitiator=scsiInitiator, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortTable=scsiTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiLuTable=scsiLuTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup)
