...
ModuleIdentity, IpAddress, Integer32, mib_2, iso, ObjectIdentity, TimeTicks, NotificationType, Gauge32, Counter32, Counter64, Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Integer32", "mib-2", "iso", "ObjectIdentity", "TimeTicks", "NotificationType", "Gauge32", "Counter32", "Counter64", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, TimeStamp, TextualConvention, DisplayString, RowStatus, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortEntry=scsiPortEntry, scsiModule=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunLun=scsiDscLunLun, scsiNotifications=scsiNotifications, scsiIntrDevEntry=scsiIntrDevEntry, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdValue=scsiLuIdValue, scsiLuTable=scsiLuTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDeviceTable=scsiDeviceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetGroup=scsiTargetGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiGeneral=scsiGeneral, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiConformance=scsiConformance, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiNameIdOrZero=ScsiNameIdOrZero, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortIndex=scsiPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatus=scsiLuStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiLuIdType=scsiLuIdType, scsiTgtDevTable=scsiTgtDevTable, scsiTransportFCP=scsiTransportFCP, scsiLuState=scsiLuState, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTarget=scsiTarget, scsiLuEntry=scsiLuEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIndex=scsiLuIndex, scsiPortTable=scsiPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, ScsiIdValue=ScsiIdValue, scsiCompliances=scsiCompliances, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiator=scsiInitiator, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapEntry=scsiLunMapEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliance=scsiCompliance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortRole=scsiPortRole, scsiDscTgtName=scsiDscTgtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuProductId=scsiLuProductId, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValue=ScsiIndexValue, scsiTrnsptType=scsiTrnsptType)
