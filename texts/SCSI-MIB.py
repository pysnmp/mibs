...
TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, Counter64, Bits, IpAddress, Integer32, ModuleIdentity, Gauge32, MibIdentifier, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "Counter64", "Bits", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "mib-2")
TextualConvention, TruthValue, TimeStamp, DisplayString, RowPointer, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "RowPointer", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortIndex=scsiPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceResets=scsiDeviceResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdType=ScsiIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiLuState=scsiLuState, scsiLuInResets=scsiLuInResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportFCP=scsiTransportFCP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiTrnsptTable=scsiTrnsptTable, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrName=scsiAuthIntrName, scsiLuInCommands=scsiLuInCommands, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGeneral=scsiGeneral, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSBP=scsiTransportSBP, scsiInstIndex=scsiInstIndex, scsiLunMapLun=scsiLunMapLun, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiGroups=scsiGroups, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTarget=scsiTarget, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiName=ScsiName, scsiCompliances=scsiCompliances, scsiInitiator=scsiInitiator, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtName=scsiDscTgtName, scsiDeviceGroup=scsiDeviceGroup, scsiPortEntry=scsiPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiCompliance=scsiCompliance, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTable=scsiPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstAlias=scsiInstAlias, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiConformance=scsiConformance, scsiPortRole=scsiPortRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceTable=scsiInstanceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdTable=scsiLuIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiNotifications=scsiNotifications, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiObjects=scsiObjects, scsiDscLunTable=scsiDscLunTable, PYSNMP_MODULE_ID=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiModule=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceEntry=scsiDeviceEntry)
