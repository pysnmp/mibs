...
Gauge32, Counter64, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Bits, Counter32, NotificationType, Integer32, ModuleIdentity, Unsigned32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Bits", "Counter32", "NotificationType", "Integer32", "ModuleIdentity", "Unsigned32", "TimeTicks", "IpAddress")
RowPointer, TruthValue, AutonomousType, TimeStamp, DisplayString, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortRole=scsiPortRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunEntry=scsiDscLunEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiLuProductId=scsiLuProductId, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiLuInResets=scsiLuInResets, ScsiIdValue=ScsiIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuState=scsiLuState, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtIndex=scsiDscTgtIndex, scsiObjects=scsiObjects, scsiTrnsptType=scsiTrnsptType, scsiLuInCommands=scsiLuInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuTable=scsiLuTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLun=scsiLunMapLun, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiGroups=scsiGroups, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiTransportFCP=scsiTransportFCP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiator=scsiInitiator, scsiInstanceTable=scsiInstanceTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiCompliance=scsiCompliance, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTarget=scsiTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSBP=scsiTransportSBP, scsiTgtPortName=scsiTgtPortName, scsiLuVendorId=scsiLuVendorId, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTable=scsiPortTable, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiName=ScsiName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIndex=scsiDscLunIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapTable=scsiLunMapTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiConformance=scsiConformance, scsiPortIndex=scsiPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiLuIndex=scsiLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
