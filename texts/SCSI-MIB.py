...
TimeTicks, Counter64, ObjectIdentity, iso, ModuleIdentity, IpAddress, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, MibIdentifier, Integer32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ObjectIdentity", "iso", "ModuleIdentity", "IpAddress", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "MibIdentifier", "Integer32", "Gauge32", "NotificationType")
TruthValue, TextualConvention, AutonomousType, DisplayString, RowStatus, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSBP=scsiTransportSBP, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteTarget=scsiRemoteTarget, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdentifier=ScsiIdentifier, scsiLuTable=scsiLuTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtName=scsiIntrPrtName, scsiPortEntry=scsiPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdType=ScsiIdType, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportOther=scsiTranportOther, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstIndex=scsiInstIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotifications=scsiNotifications, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceTable=scsiDeviceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceResets=scsiDeviceResets, scsiLuIndex=scsiLuIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtName=scsiDscTgtName, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGeneral=scsiGeneral, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiator=scsiInitiator, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuState=scsiLuState, scsiPortRole=scsiPortRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliance=scsiCompliance, scsiTarget=scsiTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiCompliances=scsiCompliances, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuProductId=scsiLuProductId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdValue=ScsiIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiPortTable=scsiPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGroups=scsiGroups, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex)
