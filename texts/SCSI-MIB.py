...
ModuleIdentity, Counter32, MibIdentifier, Gauge32, TimeTicks, Integer32, ObjectIdentity, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibIdentifier", "Gauge32", "TimeTicks", "Integer32", "ObjectIdentity", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "Counter64", "IpAddress")
TimeStamp, RowPointer, TruthValue, TextualConvention, AutonomousType, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiNotifications=scsiNotifications, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiConformance=scsiConformance, scsiAuthIntrName=scsiAuthIntrName, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, scsiTransportTypes=scsiTransportTypes, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiLuTable=scsiLuTable, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatus=scsiLuStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiGeneral=scsiGeneral, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiModule=scsiModule, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuState=scsiLuState, scsiLuProductId=scsiLuProductId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortName=scsiTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliances=scsiCompliances, scsiLuInCommands=scsiLuInCommands, ScsiName=ScsiName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceResets=scsiDeviceResets, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdValue=scsiLuIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiator=scsiInitiator, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdValue=ScsiIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdIndex=scsiLuIdIndex, scsiGroups=scsiGroups, scsiTransportSBP=scsiTransportSBP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiCompliance=scsiCompliance, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtName=scsiDscTgtName, ScsiIndexValue=ScsiIndexValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLun=scsiLunMapLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuVendorId=scsiLuVendorId, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuInResets=scsiLuInResets, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiTarget=scsiTarget)
