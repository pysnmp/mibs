...
Counter32, Gauge32, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, Bits, iso, TimeTicks, IpAddress, Counter64, NotificationType, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "Bits", "iso", "TimeTicks", "IpAddress", "Counter64", "NotificationType", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TruthValue, AutonomousType, TextualConvention, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptType=scsiTrnsptType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorGroup=scsiInitiatorGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuStatus=scsiLuStatus, scsiLuWwnName=scsiLuWwnName, scsiCompliances=scsiCompliances, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceRole=scsiDeviceRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, scsiInstAlias=scsiInstAlias, ScsiName=ScsiName, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdentifier=ScsiIdentifier, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInResets=scsiLuInResets, scsiDeviceIndex=scsiDeviceIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortRole=scsiPortRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliance=scsiCompliance, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInCommands=scsiLuInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportISCSI=scsiTransportISCSI, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapTable=scsiLunMapTable, scsiLuEntry=scsiLuEntry, scsiLuState=scsiLuState, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiLuIdValue=scsiLuIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdType=scsiLuIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGroups=scsiGroups, scsiConformance=scsiConformance, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceTable=scsiInstanceTable, scsiTransportTypes=scsiTransportTypes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLogicalUnit=scsiLogicalUnit, scsiModule=scsiModule, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, PYSNMP_MODULE_ID=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiObjects=scsiObjects, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIndexValue=ScsiIndexValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdType=scsiDscLunIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiator=scsiInitiator, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdValue=ScsiIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuTable=scsiLuTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiTransportSBP=scsiTransportSBP, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiLuIdTable=scsiLuIdTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiLUNOrZero=ScsiLUNOrZero, scsiGeneral=scsiGeneral, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry)
