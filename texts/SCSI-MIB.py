...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ModuleIdentity, ObjectIdentity, mib_2, Integer32, Counter32, iso, TimeTicks, IpAddress, NotificationType, MibIdentifier, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "mib-2", "Integer32", "Counter32", "iso", "TimeTicks", "IpAddress", "NotificationType", "MibIdentifier", "Gauge32", "Bits")
RowPointer, AutonomousType, DisplayString, RowStatus, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "DisplayString", "RowStatus", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptTable=scsiTrnsptTable, scsiLunMapLun=scsiLunMapLun, scsiTarget=scsiTarget, scsiLunMapTable=scsiLunMapTable, ScsiIdentifier=ScsiIdentifier, scsiCompliances=scsiCompliances, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuState=scsiLuState, scsiLunMapIndex=scsiLunMapIndex, scsiLuProductId=scsiLuProductId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIndex=scsiLuIndex, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotifications=scsiNotifications, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuTable=scsiLuTable, scsiIntrPrtName=scsiIntrPrtName, scsiTransportFCP=scsiTransportFCP, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortRole=scsiPortRole, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdType=scsiLuIdType, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiTrnsptDevName=scsiTrnsptDevName, scsiConformance=scsiConformance, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInCommands=scsiLuInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiLuEntry=scsiLuEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportISCSI=scsiTransportISCSI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortTable=scsiPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceTable=scsiInstanceTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortIndex=scsiPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiModule=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiInstIndex=scsiInstIndex, scsiDeviceAlias=scsiDeviceAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdType=ScsiIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiLuIdValue=scsiLuIdValue, scsiDeviceResets=scsiDeviceResets, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiLuInResets=scsiLuInResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName)
