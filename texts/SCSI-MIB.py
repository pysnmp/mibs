...
Gauge32, ObjectIdentity, Bits, ModuleIdentity, NotificationType, Unsigned32, TimeTicks, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, iso, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "ModuleIdentity", "NotificationType", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "iso", "IpAddress", "Integer32")
DisplayString, TimeStamp, RowPointer, RowStatus, TextualConvention, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowPointer", "RowStatus", "TextualConvention", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptType=scsiTrnsptType, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiObjects=scsiObjects, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIndex=scsiLuIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiator=scsiInitiator, scsiPortEntry=scsiPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtName=scsiIntrPrtName, scsiTransportTypes=scsiTransportTypes, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTable=scsiPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevTable=scsiTgtDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInCommands=scsiLuInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceResets=scsiDeviceResets, scsiCompliance=scsiCompliance, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliances=scsiCompliances, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdentifier=ScsiIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortTable=scsiTgtPortTable, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiPortRole=scsiPortRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWwnName=scsiLuWwnName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTranportOther=scsiTranportOther, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdTable=scsiLuIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstAlias=scsiInstAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportFCP=scsiTransportFCP, scsiDeviceEntry=scsiDeviceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuDefaultLun=scsiLuDefaultLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, PYSNMP_MODULE_ID=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiTransportSRP=scsiTransportSRP, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiConformance=scsiConformance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunEntry=scsiDscLunEntry, ScsiIdAssociation=ScsiIdAssociation, scsiGeneral=scsiGeneral, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapTable=scsiLunMapTable, scsiRemoteTarget=scsiRemoteTarget)
