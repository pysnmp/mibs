...
iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType, ModuleIdentity, Counter32, Gauge32, mib_2, Bits, TimeTicks, Counter64, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter32", "Gauge32", "mib-2", "Bits", "TimeTicks", "Counter64", "Integer32", "Unsigned32")
RowPointer, DisplayString, TruthValue, RowStatus, TextualConvention, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TruthValue", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuState=scsiLuState, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiLuIndex=scsiLuIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiator=scsiInitiator, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotifications=scsiNotifications, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, scsiObjects=scsiObjects, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdAssociation=ScsiIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTranportOther=scsiTranportOther, scsiLuVendorId=scsiLuVendorId, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiPortIndex=scsiPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuStatus=scsiLuStatus, scsiCompliance=scsiCompliance, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiConformance=scsiConformance, scsiInstanceEntry=scsiInstanceEntry, scsiLuWwnName=scsiLuWwnName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiTgtPortName=scsiTgtPortName, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLuInResets=scsiLuInResets, scsiTargetGroup=scsiTargetGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiTransportTypes=scsiTransportTypes, ScsiIdentifier=ScsiIdentifier, scsiLuProductId=scsiLuProductId, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTranportSPI=scsiTranportSPI, scsiDeviceEntry=scsiDeviceEntry, scsiModule=scsiModule, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiName=ScsiName, scsiLuTable=scsiLuTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGeneral=scsiGeneral, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiGroups=scsiGroups, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdTable=scsiLuIdTable, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable)
