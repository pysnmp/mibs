...
mib_2, ModuleIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Integer32, Counter32, iso, Counter64, ObjectIdentity, MibIdentifier, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Integer32", "Counter32", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "NotificationType", "IpAddress")
TruthValue, TextualConvention, DisplayString, AutonomousType, RowStatus, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DisplayString", "AutonomousType", "RowStatus", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortName=scsiTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdType=ScsiIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiName=ScsiName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiPortIndex=scsiPortIndex, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuVendorId=scsiLuVendorId, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiObjects=scsiObjects, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIndex=scsiLuIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptType=scsiTrnsptType, scsiTransportISCSI=scsiTransportISCSI, scsiInitiator=scsiInitiator, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportSRP=scsiTransportSRP, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapEntry=scsiLunMapEntry, scsiConformance=scsiConformance, scsiTargetGroup=scsiTargetGroup, scsiTranportSPI=scsiTranportSPI, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapIndex=scsiLunMapIndex, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTarget=scsiTarget, scsiDeviceAlias=scsiDeviceAlias, scsiLuState=scsiLuState, scsiPortRole=scsiPortRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportFCP=scsiTransportFCP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTranportOther=scsiTranportOther, scsiModule=scsiModule, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliances=scsiCompliances, ScsiIdValue=ScsiIdValue, scsiDeviceRole=scsiDeviceRole, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstIndex=scsiInstIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSBP=scsiTransportSBP, scsiLuIdTable=scsiLuIdTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGroups=scsiGroups, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapGroup=scsiLunMapGroup)
