...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ObjectIdentity, MibIdentifier, Integer32, Bits, TimeTicks, Counter32, Unsigned32, ModuleIdentity, IpAddress, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity", "IpAddress", "iso", "NotificationType")
RowStatus, AutonomousType, DisplayString, RowPointer, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "DisplayString", "RowPointer", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunEntry=scsiDscLunEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiConformance=scsiConformance, scsiDeviceResets=scsiDeviceResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstIndex=scsiInstIndex, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevEntry=scsiTgtDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptType=scsiTrnsptType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdValue=ScsiIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdType=scsiLuIdType, scsiTranportOther=scsiTranportOther, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapEntry=scsiLunMapEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiModule=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuTable=scsiLuTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuStatus=scsiLuStatus, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, scsiPortRole=scsiPortRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIndex=scsiLuIndex, scsiTarget=scsiTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, ScsiIdType=ScsiIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotifications=scsiNotifications, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, scsiLuState=scsiLuState, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortTable=scsiPortTable, scsiLuInResets=scsiLuInResets, scsiObjects=scsiObjects, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup)
