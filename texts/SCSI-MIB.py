...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, ModuleIdentity, MibIdentifier, TimeTicks, Unsigned32, mib_2, NotificationType, iso, Gauge32, ObjectIdentity, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Unsigned32", "mib-2", "NotificationType", "iso", "Gauge32", "ObjectIdentity", "Counter32", "Counter64")
TimeStamp, RowPointer, TextualConvention, AutonomousType, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TextualConvention", "AutonomousType", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiLUNOrZero=ScsiLUNOrZero, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiCompliances=scsiCompliances, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiPortRole=scsiPortRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatus=scsiLuStatus, scsiRemoteTarget=scsiRemoteTarget, scsiModule=scsiModule, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiPortTable=scsiPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuInResets=scsiLuInResets, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstIndex=scsiInstIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportSRP=scsiTransportSRP, scsiDscLunLun=scsiDscLunLun, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLun=scsiLunMapLun, scsiInstAlias=scsiInstAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiLuInCommands=scsiLuInCommands, scsiTransportTypes=scsiTransportTypes, scsiTarget=scsiTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTranportSPI=scsiTranportSPI, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiConformance=scsiConformance, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiObjects=scsiObjects, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiLuTable=scsiLuTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiLuWwnName=scsiLuWwnName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuState=scsiLuState, ScsiIndexValue=ScsiIndexValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdValue=ScsiIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGeneral=scsiGeneral, scsiLuProductId=scsiLuProductId, scsiLuIdIndex=scsiLuIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiGroups=scsiGroups, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIndex=scsiLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptType=scsiTrnsptType, ScsiIdType=ScsiIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx)
