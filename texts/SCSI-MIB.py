...
Integer32, Counter32, Unsigned32, iso, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, NotificationType, IpAddress, ModuleIdentity, Counter64, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "iso", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "NotificationType", "IpAddress", "ModuleIdentity", "Counter64", "TimeTicks", "MibIdentifier")
RowStatus, AutonomousType, TimeStamp, TextualConvention, TruthValue, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TimeStamp", "TextualConvention", "TruthValue", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortRole=scsiPortRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiObjects=scsiObjects, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdType=scsiLuIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiName=ScsiName, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportOther=scsiTranportOther, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdValue=scsiLuIdValue, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTable=scsiPortTable, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInResets=scsiLuInResets, scsiTgtPortTable=scsiTgtPortTable, scsiLuIndex=scsiLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliances=scsiCompliances, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, scsiNotifications=scsiNotifications, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuProductId=scsiLuProductId, scsiTgtDevTable=scsiTgtDevTable, scsiTargetGroup=scsiTargetGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGroups=scsiGroups, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptType=scsiTrnsptType, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapGroup=scsiLunMapGroup, scsiInstIndex=scsiInstIndex, scsiTransportISCSI=scsiTransportISCSI, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrName=scsiAuthIntrName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiGeneral=scsiGeneral, scsiLuEntry=scsiLuEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceRole=scsiDeviceRole, scsiPortEntry=scsiPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTranportSPI=scsiTranportSPI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdAssociation=ScsiIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWwnName=scsiLuWwnName, scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiModule=scsiModule, scsiTarget=scsiTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptTable=scsiTrnsptTable, scsiConformance=scsiConformance, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtConfigured=scsiDscTgtConfigured)
