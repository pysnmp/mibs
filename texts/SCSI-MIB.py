...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, iso, Counter64, mib_2, ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Bits, Unsigned32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "iso", "Counter64", "mib-2", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Bits", "Unsigned32", "Gauge32", "TimeTicks")
RowStatus, TextualConvention, AutonomousType, RowPointer, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValue=ScsiIndexValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceTable=scsiInstanceTable, scsiTgtPortName=scsiTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstAlias=scsiInstAlias, scsiTrnsptType=scsiTrnsptType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortRole=scsiPortRole, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiTransportSBP=scsiTransportSBP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapIndex=scsiLunMapIndex, scsiLuWwnName=scsiLuWwnName, ScsiIdValue=ScsiIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotifications=scsiNotifications, scsiDeviceTable=scsiDeviceTable, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiConformance=scsiConformance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiator=scsiInitiator, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtName=scsiDscTgtName, scsiTranportOther=scsiTranportOther, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortTable=scsiTgtPortTable, scsiPortIndex=scsiPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiTargetGroup=scsiTargetGroup, scsiLuStatus=scsiLuStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiGroups=scsiGroups, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdValue=scsiLuIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportISCSI=scsiTransportISCSI, scsiGeneral=scsiGeneral, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiCompliances=scsiCompliances, ScsiName=ScsiName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapGroup=scsiLunMapGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiModule=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTable=scsiPortTable, scsiObjects=scsiObjects, scsiLuInResets=scsiLuInResets, scsiPortEntry=scsiPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiTarget=scsiTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuTable=scsiLuTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunTable=scsiDscLunTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, scsiLuIdType=scsiLuIdType, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuEntry=scsiLuEntry, ScsiIdType=ScsiIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuState=scsiLuState, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapLun=scsiLunMapLun)
