...
ModuleIdentity, TimeTicks, mib_2, Counter32, ObjectIdentity, Unsigned32, NotificationType, MibIdentifier, Gauge32, iso, IpAddress, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "mib-2", "Counter32", "ObjectIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "Gauge32", "iso", "IpAddress", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
TruthValue, AutonomousType, RowStatus, DisplayString, TimeStamp, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, scsiLuIdValue=scsiLuIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceTable=scsiDeviceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLun=scsiLunMapLun, scsiLuInResets=scsiLuInResets, scsiTarget=scsiTarget, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiPortRole=scsiPortRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTranportSPI=scsiTranportSPI, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdType=scsiDscLunIdType, scsiPortIndex=scsiPortIndex, ScsiIdValue=ScsiIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstIndex=scsiInstIndex, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiTransportSBP=scsiTransportSBP, scsiGeneral=scsiGeneral, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiObjects=scsiObjects, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstAlias=scsiInstAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunTable=scsiDscLunTable, ScsiIdType=ScsiIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiModule=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliance=scsiCompliance, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiPortTable=scsiPortTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportOther=scsiTranportOther, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiName=ScsiName, scsiNotifications=scsiNotifications, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiInitiator=scsiInitiator, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtName=scsiDscTgtName, scsiDscLunLun=scsiDscLunLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGroups=scsiGroups)
