...
mib_2, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Integer32, ObjectIdentity, Unsigned32, ModuleIdentity, Bits, TimeTicks, iso, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Bits", "TimeTicks", "iso", "IpAddress", "Gauge32")
RowPointer, TimeStamp, AutonomousType, TruthValue, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdCodeSet=ScsiIdCodeSet, scsiGroups=scsiGroups, scsiLuRevisionId=scsiLuRevisionId, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLun=scsiLunMapLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTargetGroup=scsiTargetGroup, scsiObjects=scsiObjects, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotifications=scsiNotifications, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuProductId=scsiLuProductId, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiDscLunTable=scsiDscLunTable, scsiPortIndex=scsiPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiLuIdType=scsiLuIdType, scsiInstAlias=scsiInstAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInCommands=scsiLuInCommands, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTarget=scsiTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGeneral=scsiGeneral, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiDscLunIndex=scsiDscLunIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdValue=ScsiIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortName=scsiTgtPortName, ScsiIndexValue=ScsiIndexValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLogicalUnit=scsiLogicalUnit, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuState=scsiLuState, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiator=scsiInitiator, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiTransportSBP=scsiTransportSBP, scsiLuIndex=scsiLuIndex, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiLuEntry=scsiLuEntry, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiConformance=scsiConformance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiName=ScsiName)
