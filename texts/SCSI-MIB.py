...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Gauge32, iso, NotificationType, Bits, mib_2, IpAddress, MibIdentifier, Counter64, Integer32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Gauge32", "iso", "NotificationType", "Bits", "mib-2", "IpAddress", "MibIdentifier", "Counter64", "Integer32", "Counter32", "TimeTicks")
TruthValue, TextualConvention, RowStatus, AutonomousType, TimeStamp, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "AutonomousType", "TimeStamp", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstAlias=scsiInstAlias, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatus=scsiLuStatus, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdentifier=ScsiIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiGeneral=scsiGeneral, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortIndex=scsiPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceResets=scsiDeviceResets, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliances=scsiCompliances, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuEntry=scsiLuEntry, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdType=ScsiIdType, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuRevisionId=scsiLuRevisionId, ScsiIdAssociation=ScsiIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWwnName=scsiLuWwnName, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuTable=scsiLuTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuState=scsiLuState, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdType=scsiLuIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiObjects=scsiObjects, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiName=ScsiName, scsiLunMapTable=scsiLunMapTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportOther=scsiTranportOther, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInCommands=scsiLuInCommands, scsiInitiator=scsiInitiator, scsiDscLunIndex=scsiDscLunIndex, scsiCompliance=scsiCompliance, scsiNotifications=scsiNotifications, scsiLogicalUnit=scsiLogicalUnit, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiConformance=scsiConformance, scsiTranportSPI=scsiTranportSPI, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtName=scsiDscTgtName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLuIndex=scsiLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes)
