...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, TimeTicks, Counter32, NotificationType, Bits, MibIdentifier, IpAddress, iso, mib_2, Unsigned32, Integer32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "TimeTicks", "Counter32", "NotificationType", "Bits", "MibIdentifier", "IpAddress", "iso", "mib-2", "Unsigned32", "Integer32", "ObjectIdentity", "ModuleIdentity")
RowStatus, AutonomousType, DisplayString, TimeStamp, TextualConvention, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapEntry=scsiLunMapEntry, scsiCompliance=scsiCompliance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatus=scsiLuStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapGroup=scsiLunMapGroup, scsiLuIndex=scsiLuIndex, scsiDscTgtName=scsiDscTgtName, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTable=scsiPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuInCommands=scsiLuInCommands, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunLun=scsiDscLunLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstAlias=scsiInstAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiName=ScsiName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuProductId=scsiLuProductId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceAlias=scsiDeviceAlias, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdType=scsiLuIdType, scsiTarget=scsiTarget, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, PYSNMP_MODULE_ID=scsiModule, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiator=scsiInitiator, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceTable=scsiDeviceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiPortRole=scsiPortRole, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiLuIdTable=scsiLuIdTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceResets=scsiDeviceResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, scsiConformance=scsiConformance, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuState=scsiLuState, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliances=scsiCompliances, ScsiIdValue=ScsiIdValue, scsiPortIndex=scsiPortIndex, scsiDeviceRole=scsiDeviceRole, scsiTranportSPI=scsiTranportSPI, scsiTargetGroup=scsiTargetGroup, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdType=ScsiIdType, scsiDscLunIndex=scsiDscLunIndex, scsiLuTable=scsiLuTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry)
