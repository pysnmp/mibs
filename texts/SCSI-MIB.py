...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Integer32, iso, MibIdentifier, ModuleIdentity, Bits, Counter32, Unsigned32, NotificationType, Counter64, ObjectIdentity, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Integer32", "iso", "MibIdentifier", "ModuleIdentity", "Bits", "Counter32", "Unsigned32", "NotificationType", "Counter64", "ObjectIdentity", "mib-2", "TimeTicks")
DisplayString, TruthValue, RowPointer, AutonomousType, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowPointer", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiLuInCommands=scsiLuInCommands, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceTable=scsiInstanceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiObjects=scsiObjects, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortIndex=scsiPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunTable=scsiDscLunTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdType=scsiDscLunIdType, scsiInstAlias=scsiInstAlias, ScsiIdValue=ScsiIdValue, ScsiIdType=ScsiIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuWwnName=scsiLuWwnName, scsiInitiator=scsiInitiator, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiModule=scsiModule, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiConformance=scsiConformance, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuEntry=scsiLuEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInResets=scsiLuInResets, scsiTranportSPI=scsiTranportSPI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortEntry=scsiPortEntry, scsiLunMapTable=scsiLunMapTable, ScsiIndexValue=ScsiIndexValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtName=scsiDscTgtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortTable=scsiPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatus=scsiLuStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGroups=scsiGroups, scsiLogicalUnit=scsiLogicalUnit, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuTable=scsiLuTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortName=scsiTgtPortName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuState=scsiLuState, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstIndex=scsiInstIndex)
