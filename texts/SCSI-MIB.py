...
ObjectIdentity, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, iso, Unsigned32, Gauge32, mib_2, ModuleIdentity, Integer32, NotificationType, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "mib-2", "ModuleIdentity", "Integer32", "NotificationType", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceTable=scsiInstanceTable, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIndex=scsiLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstAlias=scsiInstAlias, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptType=scsiTrnsptType, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportSBP=scsiTransportSBP, ScsiName=ScsiName, scsiPortEntry=scsiPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdValue=ScsiIdValue, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiInstIndex=scsiInstIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapTable=scsiLunMapTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapEntry=scsiLunMapEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, scsiCompliances=scsiCompliances, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuState=scsiLuState, scsiConformance=scsiConformance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatus=scsiLuStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotifications=scsiNotifications, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuWwnName=scsiLuWwnName, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiTransportTypes=scsiTransportTypes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceTable=scsiDeviceTable, ScsiIdType=ScsiIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetGroup=scsiTargetGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTable=scsiPortTable, ScsiIndexValue=ScsiIndexValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortRole=scsiPortRole, scsiLuIdType=scsiLuIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceEntry=scsiInstanceEntry, scsiPortIndex=scsiPortIndex, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiTranportOther=scsiTranportOther, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiRemoteTarget=scsiRemoteTarget, scsiInitiator=scsiInitiator, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTarget=scsiTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortName=scsiTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtTable=scsiDscTgtTable, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes)
