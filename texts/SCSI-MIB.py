...
ObjectIdentity, mib_2, Bits, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, NotificationType, IpAddress, Counter32, ModuleIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "Bits", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "NotificationType", "IpAddress", "Counter32", "ModuleIdentity", "Gauge32", "MibIdentifier")
RowPointer, TimeStamp, RowStatus, DisplayString, TruthValue, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "RowStatus", "DisplayString", "TruthValue", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuStatus=scsiLuStatus, scsiTransportSBP=scsiTransportSBP, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliance=scsiCompliance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiator=scsiInitiator, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiTarget=scsiTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTranportOther=scsiTranportOther, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapTable=scsiLunMapTable, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceRole=scsiDeviceRole, scsiLuIdType=scsiLuIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiGroups=scsiGroups, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiLuIdValue=scsiLuIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuEntry=scsiLuEntry, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTable=scsiPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuState=scsiLuState, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, ScsiIdType=ScsiIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtName=scsiDscTgtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevTable=scsiIntrDevTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiObjects=scsiObjects, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiTranportSPI=scsiTranportSPI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiLuProductId=scsiLuProductId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotifications=scsiNotifications, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortName=scsiTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiDscLunTable=scsiDscLunTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiPortRole=scsiPortRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiConformance=scsiConformance, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiName=ScsiName, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevTable=scsiTgtDevTable, scsiLuTable=scsiLuTable, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLogicalUnit=scsiLogicalUnit, scsiInstAlias=scsiInstAlias, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiInstIndex=scsiInstIndex, ScsiIdentifier=ScsiIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiCompliances=scsiCompliances, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceResets=scsiDeviceResets)
