...
MibIdentifier, Integer32, Unsigned32, Gauge32, Bits, ObjectIdentity, IpAddress, TimeTicks, Counter32, mib_2, iso, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Unsigned32", "Gauge32", "Bits", "ObjectIdentity", "IpAddress", "TimeTicks", "Counter32", "mib-2", "iso", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
TimeStamp, TruthValue, RowPointer, TextualConvention, AutonomousType, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowPointer", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuInCommands=scsiLuInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiTransportTypes=scsiTransportTypes, scsiConformance=scsiConformance, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortEntry=scsiPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIndexValue=ScsiIndexValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, scsiLuInResets=scsiLuInResets, scsiDscTgtName=scsiDscTgtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptTable=scsiTrnsptTable, scsiTranportOther=scsiTranportOther, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiModule=scsiModule, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortIndex=scsiPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiCompliance=scsiCompliance, scsiLuWwnName=scsiLuWwnName, scsiLunMapTable=scsiLunMapTable, scsiLunMapEntry=scsiLunMapEntry, scsiInstAlias=scsiInstAlias, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunLun=scsiDscLunLun, scsiLuIndex=scsiLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiName=ScsiName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdTable=scsiLuIdTable, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdValue=ScsiIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuStatus=scsiLuStatus, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdType=scsiLuIdType, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetGroup=scsiTargetGroup, scsiLuProductId=scsiLuProductId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotifications=scsiNotifications, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiGroups=scsiGroups, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuTable=scsiLuTable, scsiTrnsptType=scsiTrnsptType, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdType=ScsiIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiator=scsiInitiator, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuVendorId=scsiLuVendorId, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLun=scsiLunMapLun, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortRole=scsiPortRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSBP=scsiTransportSBP)
