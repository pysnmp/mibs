...
Unsigned32, MibIdentifier, mib_2, iso, TimeTicks, IpAddress, Gauge32, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "mib-2", "iso", "TimeTicks", "IpAddress", "Gauge32", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
DisplayString, TextualConvention, TimeStamp, RowPointer, RowStatus, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TimeStamp", "RowPointer", "RowStatus", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdentifier=ScsiIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceResets=scsiDeviceResets, scsiLuIdType=scsiLuIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiObjects=scsiObjects, scsiPortTable=scsiPortTable, scsiGeneral=scsiGeneral, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiLuProductId=scsiLuProductId, scsiTarget=scsiTarget, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiConformance=scsiConformance, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceGroup=scsiDeviceGroup, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunTable=scsiDscLunTable, ScsiIndexValue=ScsiIndexValue, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInCommands=scsiLuInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortEntry=scsiPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstIndex=scsiInstIndex, scsiDeviceRole=scsiDeviceRole, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiPortRole=scsiPortRole, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiCompliances=scsiCompliances, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceTable=scsiInstanceTable, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiTranportOther=scsiTranportOther, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuEntry=scsiLuEntry, scsiLuState=scsiLuState, scsiTgtPortName=scsiTgtPortName, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetGroup=scsiTargetGroup, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteTarget=scsiRemoteTarget, scsiNotifications=scsiNotifications, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdValue=scsiDscLunIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiInstAlias=scsiInstAlias, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName)
