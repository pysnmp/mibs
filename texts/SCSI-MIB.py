...
Counter32, Bits, Counter64, TimeTicks, iso, NotificationType, ObjectIdentity, IpAddress, Gauge32, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Counter64", "TimeTicks", "iso", "NotificationType", "ObjectIdentity", "IpAddress", "Gauge32", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Integer32")
TimeStamp, DisplayString, RowPointer, RowStatus, AutonomousType, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowPointer", "RowStatus", "AutonomousType", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuState=scsiLuState, scsiTranportOther=scsiTranportOther, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInCommands=scsiLuInCommands, scsiTgtPortName=scsiTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiGeneral=scsiGeneral, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWwnName=scsiLuWwnName, scsiPortTable=scsiPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatus=scsiLuStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiInitiator=scsiInitiator, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceTable=scsiDeviceTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptTable=scsiTrnsptTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuVendorId=scsiLuVendorId, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortRole=scsiPortRole, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiLuIdTable=scsiLuIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiLunMapLun=scsiLunMapLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIndex=scsiLuIndex, scsiNotifications=scsiNotifications, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceIndex=scsiDeviceIndex, scsiModule=scsiModule, scsiPortEntry=scsiPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliance=scsiCompliance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiConformance=scsiConformance, scsiTransportSBP=scsiTransportSBP, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiLuTable=scsiLuTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdentifier=ScsiIdentifier, ScsiIndexValue=ScsiIndexValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName)
