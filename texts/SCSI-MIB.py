...
TimeTicks, ObjectIdentity, Counter32, Integer32, NotificationType, mib_2, ModuleIdentity, Gauge32, Counter64, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter32", "Integer32", "NotificationType", "mib-2", "ModuleIdentity", "Gauge32", "Counter64", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "iso")
AutonomousType, TextualConvention, RowStatus, RowPointer, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "RowStatus", "RowPointer", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstVendorVersion=scsiInstVendorVersion, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuVendorId=scsiLuVendorId, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportSPI=scsiTranportSPI, scsiNotifications=scsiNotifications, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiGeneral=scsiGeneral, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtName=scsiDscTgtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiLuInResets=scsiLuInResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiLuIndex=scsiLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiPortRole=scsiPortRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportOther=scsiTranportOther, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunLun=scsiDscLunLun, scsiTargetGroup=scsiTargetGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuEntry=scsiLuEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdType=ScsiIdType, scsiTgtPortName=scsiTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiator=scsiInitiator, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatus=scsiLuStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, PYSNMP_MODULE_ID=scsiModule, scsiModule=scsiModule, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportFCP=scsiTransportFCP, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiLuWwnName=scsiLuWwnName, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceAlias=scsiDeviceAlias, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiCompliances=scsiCompliances, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstanceTable=scsiInstanceTable, scsiPortIndex=scsiPortIndex, scsiLuIdValue=scsiLuIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiTgtDevEntry=scsiTgtDevEntry, scsiGroups=scsiGroups, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiConformance=scsiConformance, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup)
