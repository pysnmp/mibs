...
Integer32, iso, TimeTicks, mib_2, Counter32, NotificationType, MibIdentifier, IpAddress, ObjectIdentity, Gauge32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "mib-2", "Counter32", "NotificationType", "MibIdentifier", "IpAddress", "ObjectIdentity", "Gauge32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity")
TruthValue, DisplayString, AutonomousType, TimeStamp, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "TimeStamp", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortIndex=scsiPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiDscTgtName=scsiDscTgtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdValue=ScsiIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGroups=scsiGroups, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatus=scsiLuStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetGroup=scsiTargetGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiLuWwnName=scsiLuWwnName, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiTranportOther=scsiTranportOther, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiLuProductId=scsiLuProductId, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiInitiator=scsiInitiator, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdTable=scsiLuIdTable, scsiLunMapLun=scsiLunMapLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortRole=scsiPortRole, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiCompliances=scsiCompliances, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiTranportSPI=scsiTranportSPI, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotifications=scsiNotifications, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceResets=scsiDeviceResets, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiCompliance=scsiCompliance, scsiTransportSBP=scsiTransportSBP, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptType=scsiTrnsptType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiPortBusyStatuses=scsiPortBusyStatuses)
