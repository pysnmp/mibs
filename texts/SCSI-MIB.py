...
Unsigned32, ObjectIdentity, iso, IpAddress, mib_2, Bits, TimeTicks, NotificationType, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "iso", "IpAddress", "mib-2", "Bits", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Gauge32", "ModuleIdentity")
RowPointer, TruthValue, AutonomousType, RowStatus, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIndex=scsiLuIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuTable=scsiLuTable, scsiLuState=scsiLuState, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, scsiTransportSRP=scsiTransportSRP, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdType=ScsiIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiator=scsiInitiator, scsiGeneral=scsiGeneral, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiCompliance=scsiCompliance, scsiDscLunIndex=scsiDscLunIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortEntry=scsiPortEntry, scsiGroups=scsiGroups, scsiLunMapLun=scsiLunMapLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiName=ScsiName, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiTransportFCP=scsiTransportFCP, scsiNotifications=scsiNotifications, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiCompliances=scsiCompliances, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortIndex=scsiPortIndex, scsiDeviceResets=scsiDeviceResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiModule=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiTargetGroup=scsiTargetGroup, scsiLuProductId=scsiLuProductId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTable=scsiPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, scsiLuVendorId=scsiLuVendorId, scsiTranportOther=scsiTranportOther, scsiDeviceRole=scsiDeviceRole, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptType=scsiTrnsptType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortRole=scsiPortRole)
