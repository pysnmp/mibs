...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, ModuleIdentity, Counter32, Counter64, Bits, NotificationType, Gauge32, mib_2, ObjectIdentity, iso, MibIdentifier, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "ModuleIdentity", "Counter32", "Counter64", "Bits", "NotificationType", "Gauge32", "mib-2", "ObjectIdentity", "iso", "MibIdentifier", "TimeTicks", "Unsigned32")
TextualConvention, TruthValue, RowPointer, RowStatus, AutonomousType, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowPointer", "RowStatus", "AutonomousType", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, ScsiName=ScsiName, scsiDeviceEntry=scsiDeviceEntry, scsiLuState=scsiLuState, scsiDscLunLun=scsiDscLunLun, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortIndex=scsiPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdentifier=ScsiIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiInstAlias=scsiInstAlias, scsiPortEntry=scsiPortEntry, scsiPortRole=scsiPortRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiGroups=scsiGroups, scsiAuthIntrName=scsiAuthIntrName, scsiConformance=scsiConformance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceResets=scsiDeviceResets, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiLuInResets=scsiLuInResets, scsiLunMapEntry=scsiLunMapEntry, scsiInitiator=scsiInitiator, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdValue=ScsiIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapTable=scsiLunMapTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLun=scsiLunMapLun, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotifications=scsiNotifications, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiDscLunEntry=scsiDscLunEntry, scsiPortTable=scsiPortTable, scsiDscLunIdTable=scsiDscLunIdTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstanceEntry=scsiInstanceEntry, scsiInstanceTable=scsiInstanceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiObjects=scsiObjects, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdType=scsiDscLunIdType, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGeneral=scsiGeneral, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortName=scsiTgtPortName, scsiLuIdTable=scsiLuIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdType=scsiLuIdType, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstIndex=scsiInstIndex)
