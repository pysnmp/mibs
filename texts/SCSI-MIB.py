...
Unsigned32, MibIdentifier, iso, Bits, Integer32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, ObjectIdentity, ModuleIdentity, Counter32, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "iso", "Bits", "Integer32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter32", "Counter64", "mib-2")
RowPointer, RowStatus, TruthValue, DisplayString, AutonomousType, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TruthValue", "DisplayString", "AutonomousType", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiCompliance=scsiCompliance, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDeviceResets=scsiDeviceResets, scsiLuIdTable=scsiLuIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortName=scsiTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportSRP=scsiTransportSRP, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceTable=scsiDeviceTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiLuIdEntry=scsiLuIdEntry, scsiCompliances=scsiCompliances, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptTable=scsiTrnsptTable, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiConformance=scsiConformance, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, scsiPortTable=scsiPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdType=ScsiIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTarget=scsiTarget, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuRevisionId=scsiLuRevisionId, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuTable=scsiLuTable, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdentifier=ScsiIdentifier, scsiTargetGroup=scsiTargetGroup, scsiModule=scsiModule, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdValue=ScsiIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceGroup=scsiDeviceGroup, scsiGeneral=scsiGeneral, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptType=scsiTrnsptType, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiLuState=scsiLuState, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdType=scsiLuIdType, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortRole=scsiPortRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiPortIndex=scsiPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiObjects=scsiObjects)
