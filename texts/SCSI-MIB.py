...
ObjectIdentity, mib_2, Gauge32, Bits, Counter32, NotificationType, TimeTicks, Integer32, ModuleIdentity, iso, IpAddress, MibIdentifier, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "Gauge32", "Bits", "Counter32", "NotificationType", "TimeTicks", "Integer32", "ModuleIdentity", "iso", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TimeStamp, RowStatus, AutonomousType, TruthValue, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "AutonomousType", "TruthValue", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGeneral=scsiGeneral, scsiDscLunLun=scsiDscLunLun, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdValue=scsiLuIdValue, scsiLuTable=scsiLuTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortRole=scsiPortRole, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportSBP=scsiTransportSBP, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportOther=scsiTranportOther, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceRole=scsiDeviceRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiNotifications=scsiNotifications, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdValue=ScsiIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiInitiator=scsiInitiator, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiObjects=scsiObjects, scsiDeviceResets=scsiDeviceResets, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTarget=scsiTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortEntry=scsiPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiLuState=scsiLuState, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdIndex=scsiLuIdIndex, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuEntry=scsiLuEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDeviceTable=scsiDeviceTable, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliance=scsiCompliance, scsiAuthIntrName=scsiAuthIntrName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstIndex=scsiInstIndex, ScsiIdentifier=ScsiIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortName=scsiTgtPortName, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTable=scsiPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuVendorId=scsiLuVendorId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiCompliances=scsiCompliances, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunTable=scsiDscLunTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevTable=scsiTgtDevTable, scsiPortIndex=scsiPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceAlias=scsiDeviceAlias, ScsiName=ScsiName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged)
