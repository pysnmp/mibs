...
iso, Gauge32, NotificationType, ObjectIdentity, mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Integer32, Bits, Counter64, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "NotificationType", "ObjectIdentity", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Integer32", "Bits", "Counter64", "IpAddress", "MibIdentifier", "TimeTicks")
TruthValue, TimeStamp, DisplayString, RowStatus, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "RowStatus", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, scsiLuVendorId=scsiLuVendorId, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportOther=scsiTranportOther, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, ScsiName=ScsiName, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstIndex=scsiInstIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportSBP=scsiTransportSBP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotifications=scsiNotifications, scsiGeneral=scsiGeneral, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunLun=scsiDscLunLun, scsiGroups=scsiGroups, scsiLuTable=scsiLuTable, scsiDscLunIdType=scsiDscLunIdType, scsiCompliances=scsiCompliances, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstAlias=scsiInstAlias, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapTable=scsiLunMapTable, scsiLuInCommands=scsiLuInCommands, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiCompliance=scsiCompliance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiator=scsiInitiator, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiConformance=scsiConformance, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdType=ScsiIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuStatus=scsiLuStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortRole=scsiPortRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuInResets=scsiLuInResets, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetGroup=scsiTargetGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiModule=scsiModule, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue)
