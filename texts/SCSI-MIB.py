...
TimeTicks, MibIdentifier, NotificationType, Unsigned32, Integer32, ModuleIdentity, ObjectIdentity, IpAddress, Counter32, iso, mib_2, Counter64, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "NotificationType", "Unsigned32", "Integer32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32", "iso", "mib-2", "Counter64", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, TextualConvention, RowPointer, TimeStamp, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "RowPointer", "TimeStamp", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiName=ScsiName, scsiLuIndex=scsiLuIndex, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuProductId=scsiLuProductId, scsiInitiator=scsiInitiator, scsiLuIdIndex=scsiLuIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuTable=scsiLuTable, ScsiIdType=ScsiIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceRole=scsiDeviceRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdentifier=ScsiIdentifier, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiObjects=scsiObjects, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiLuEntry=scsiLuEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliances=scsiCompliances, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdType=scsiLuIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTarget=scsiTarget, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiTransportISCSI=scsiTransportISCSI, ScsiIdValue=ScsiIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotifications=scsiNotifications, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunLun=scsiDscLunLun, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiTransportFCP=scsiTransportFCP, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiPortTable=scsiPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuState=scsiLuState, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSBP=scsiTransportSBP, scsiTransportTypes=scsiTransportTypes, scsiCompliance=scsiCompliance, scsiDeviceIndex=scsiDeviceIndex, scsiPortIndex=scsiPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortRole=scsiPortRole, scsiLunMapLun=scsiLunMapLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortEntry=scsiPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIndexValue=ScsiIndexValue, scsiInstAlias=scsiInstAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiModule=scsiModule, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortName=scsiTgtPortName, scsiInstanceEntry=scsiInstanceEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuVendorId=scsiLuVendorId, scsiGroups=scsiGroups, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteInitiators=scsiRemoteInitiators, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero)
