...
iso, mib_2, ModuleIdentity, Counter32, TimeTicks, Integer32, Unsigned32, Gauge32, Bits, MibIdentifier, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "ModuleIdentity", "Counter32", "TimeTicks", "Integer32", "Unsigned32", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64")
TimeStamp, RowPointer, AutonomousType, TextualConvention, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "AutonomousType", "TextualConvention", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptTable=scsiTrnsptTable, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortEntry=scsiPortEntry, scsiInstanceTable=scsiInstanceTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuState=scsiLuState, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDevicePortNumber=scsiDevicePortNumber, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceRole=scsiDeviceRole, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiator=scsiInitiator, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSBP=scsiTransportSBP, ScsiIndexValue=ScsiIndexValue, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiPortRole=scsiPortRole, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportSPI=scsiTranportSPI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdType=scsiLuIdType, scsiLuIdTable=scsiLuIdTable, scsiObjects=scsiObjects, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiCompliances=scsiCompliances, ScsiName=ScsiName, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuProductId=scsiLuProductId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiConformance=scsiConformance, scsiTarget=scsiTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdValue=ScsiIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdType=ScsiIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiLuInResets=scsiLuInResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliance=scsiCompliance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTable=scsiPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtName=scsiDscTgtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiLuRevisionId=scsiLuRevisionId, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
