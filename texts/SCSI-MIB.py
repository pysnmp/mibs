...
Counter32, NotificationType, Unsigned32, Gauge32, iso, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, TimeTicks, IpAddress, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Unsigned32", "Gauge32", "iso", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "TimeTicks", "IpAddress", "mib-2", "Integer32")
DisplayString, RowStatus, AutonomousType, RowPointer, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "AutonomousType", "RowPointer", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatus=scsiLuStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtTable=scsiDscTgtTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiGroups=scsiGroups, ScsiName=ScsiName, scsiInitiator=scsiInitiator, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdValue=scsiLuIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteTarget=scsiRemoteTarget, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortRole=scsiPortRole, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapEntry=scsiLunMapEntry, scsiTransportFCP=scsiTransportFCP, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortName=scsiTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliances=scsiCompliances, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdIndex=scsiLuIdIndex, scsiInstAlias=scsiInstAlias, scsiTrnsptType=scsiTrnsptType, scsiModule=scsiModule, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiCompliance=scsiCompliance, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuWwnName=scsiLuWwnName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTarget=scsiTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuProductId=scsiLuProductId, scsiTransportTypes=scsiTransportTypes, scsiPortTable=scsiPortTable, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIndex=scsiDscLunIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceEntry=scsiDeviceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiObjects=scsiObjects, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLuIndex=scsiLuIndex, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdTable=scsiLuIdTable)
