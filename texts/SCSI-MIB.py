...
Counter64, NotificationType, MibIdentifier, IpAddress, Bits, ModuleIdentity, mib_2, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "IpAddress", "Bits", "ModuleIdentity", "mib-2", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso", "Integer32", "Counter32")
DisplayString, TimeStamp, RowPointer, TruthValue, RowStatus, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowPointer", "TruthValue", "RowStatus", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceTable=scsiInstanceTable, scsiInitiator=scsiInitiator, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliances=scsiCompliances, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIndex=scsiDscLunIndex, scsiLuState=scsiLuState, scsiTargetGroup=scsiTargetGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTranportOther=scsiTranportOther, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiConformance=scsiConformance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdValue=scsiLuIdValue, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceTable=scsiDeviceTable, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapTable=scsiLunMapTable, scsiTransportTypes=scsiTransportTypes, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortIndex=scsiPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdType=ScsiIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTable=scsiIntrDevTable, scsiLuProductId=scsiLuProductId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuIdEntry=scsiLuIdEntry, scsiLuEntry=scsiLuEntry, scsiPortTable=scsiPortTable, scsiTransportISCSI=scsiTransportISCSI, ScsiIdentifier=ScsiIdentifier, scsiDeviceRole=scsiDeviceRole, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIndexValue=ScsiIndexValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiName=ScsiName, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdType=scsiDscLunIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuTable=scsiLuTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortRole=scsiPortRole, scsiInstIndex=scsiInstIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInResets=scsiLuInResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTarget=scsiTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiGroups=scsiGroups, scsiTranportSPI=scsiTranportSPI)
