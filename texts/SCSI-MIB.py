...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Bits, mib_2, ModuleIdentity, Counter64, IpAddress, Integer32, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Bits", "mib-2", "ModuleIdentity", "Counter64", "IpAddress", "Integer32", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "iso")
RowPointer, TimeStamp, DisplayString, TextualConvention, AutonomousType, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "TextualConvention", "AutonomousType", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetGroup=scsiTargetGroup, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdValue=ScsiIdValue, scsiDeviceTable=scsiDeviceTable, scsiTransportSRP=scsiTransportSRP, scsiLuInCommands=scsiLuInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtTable=scsiIntrPrtTable, scsiConformance=scsiConformance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiCompliance=scsiCompliance, scsiLuTable=scsiLuTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdEntry=scsiLuIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiDscLunEntry=scsiDscLunEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTable=scsiPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiTgtDevTable=scsiTgtDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuVendorId=scsiLuVendorId, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiPortEntry=scsiPortEntry, scsiInstanceTable=scsiInstanceTable, scsiNotifications=scsiNotifications, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, scsiTranportSPI=scsiTranportSPI, scsiRemoteTarget=scsiRemoteTarget, ScsiIdentifier=ScsiIdentifier, scsiLuIdType=scsiLuIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiator=scsiInitiator, scsiTgtPortTable=scsiTgtPortTable, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiInstIndex=scsiInstIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiPortIndex=scsiPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiPortRole=scsiPortRole, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiLuIndex=scsiLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiModule=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiTarget=scsiTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuState=scsiLuState, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiGroups=scsiGroups, scsiGeneral=scsiGeneral, scsiCompliances=scsiCompliances, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation)
