...
NotificationType, Bits, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, ObjectIdentity, Counter64, Gauge32, Counter32, MibIdentifier, Unsigned32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "ObjectIdentity", "Counter64", "Gauge32", "Counter32", "MibIdentifier", "Unsigned32", "iso", "Integer32")
TextualConvention, TimeStamp, TruthValue, RowStatus, AutonomousType, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "RowStatus", "AutonomousType", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportOther=scsiTranportOther, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiObjects=scsiObjects, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiTransportFCP=scsiTransportFCP, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtName=scsiDscTgtName, scsiNotifications=scsiNotifications, scsiTransportTypes=scsiTransportTypes, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortName=scsiTgtPortName, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIndex=scsiLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdType=scsiLuIdType, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdentifier=ScsiIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiInitiator=scsiInitiator, scsiPortIndex=scsiPortIndex, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGeneral=scsiGeneral, scsiLunMapLun=scsiLunMapLun, scsiLuIdTable=scsiLuIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiCompliance=scsiCompliance, scsiDeviceTable=scsiDeviceTable, scsiTarget=scsiTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuTable=scsiLuTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiGroups=scsiGroups, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdAssociation=scsiLuIdAssociation, scsiModule=scsiModule, scsiPortRole=scsiPortRole, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdType=ScsiIdType, scsiDeviceRole=scsiDeviceRole, scsiLuWwnName=scsiLuWwnName, scsiInstAlias=scsiInstAlias, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdIndex=scsiLuIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdAssociation=ScsiIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliances=scsiCompliances, scsiLuProductId=scsiLuProductId, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, scsiInitiatorGroup=scsiInitiatorGroup)
