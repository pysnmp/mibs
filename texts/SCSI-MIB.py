...
Gauge32, IpAddress, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Counter64, Integer32, mib_2, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Counter64", "Integer32", "mib-2", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32")
TruthValue, TimeStamp, RowStatus, AutonomousType, DisplayString, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "RowStatus", "AutonomousType", "DisplayString", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortRole=scsiPortRole, scsiTransportFCP=scsiTransportFCP, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiTranportOther=scsiTranportOther, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiLuTable=scsiLuTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiator=scsiInitiator, scsiLogicalUnit=scsiLogicalUnit, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdIndex=scsiLuIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiObjects=scsiObjects, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapEntry=scsiLunMapEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortEntry=scsiPortEntry, ScsiIdType=ScsiIdType, scsiCompliance=scsiCompliance, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWwnName=scsiLuWwnName, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiModule=scsiModule, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiGroups=scsiGroups, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiDeviceResets=scsiDeviceResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLun=scsiLunMapLun, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortIndex=scsiPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiName=ScsiName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunLun=scsiDscLunLun, scsiCompliances=scsiCompliances, scsiRemoteTarget=scsiRemoteTarget, scsiPortTable=scsiPortTable, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptType=scsiTrnsptType, scsiDeviceRole=scsiDeviceRole, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdTable=scsiLuIdTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuEntry=scsiLuEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtTable=scsiDscTgtTable, scsiTarget=scsiTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortTable=scsiTgtPortTable, scsiNotifications=scsiNotifications, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup)
