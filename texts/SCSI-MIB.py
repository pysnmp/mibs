...
mib_2, Unsigned32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, IpAddress, Gauge32, MibIdentifier, NotificationType, ObjectIdentity, Counter64, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "IpAddress", "Gauge32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "iso", "TimeTicks")
RowStatus, TextualConvention, DisplayString, TimeStamp, TruthValue, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuStatus=scsiLuStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceTable=scsiInstanceTable, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInCommands=scsiLuInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiInstIndex=scsiInstIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportOther=scsiTranportOther, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortTable=scsiPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdType=scsiLuIdType, scsiTgtPortTable=scsiTgtPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtTable=scsiDscTgtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiObjects=scsiObjects, ScsiName=ScsiName, scsiInitiator=scsiInitiator, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceGroup=scsiDeviceGroup, PYSNMP_MODULE_ID=scsiModule, scsiLuTable=scsiLuTable, scsiLuWwnName=scsiLuWwnName, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiGroups=scsiGroups, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuEntry=scsiLuEntry, scsiLuState=scsiLuState, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdType=ScsiIdType, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunLun=scsiDscLunLun, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiConformance=scsiConformance, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiModule=scsiModule, scsiPortEntry=scsiPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtName=scsiIntrPrtName, scsiCompliance=scsiCompliance, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuProductId=scsiLuProductId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortName=scsiTgtPortName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstAlias=scsiInstAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortIndex=scsiPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotifications=scsiNotifications)
