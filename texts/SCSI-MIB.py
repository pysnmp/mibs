...
Gauge32, iso, Bits, Counter32, IpAddress, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, mib_2, ObjectIdentity, Integer32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Bits", "Counter32", "IpAddress", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "mib-2", "ObjectIdentity", "Integer32", "TimeTicks", "MibIdentifier")
DisplayString, RowStatus, TruthValue, AutonomousType, TextualConvention, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TruthValue", "AutonomousType", "TextualConvention", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, ScsiIdentifier=ScsiIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuProductId=scsiLuProductId, scsiInstAlias=scsiInstAlias, scsiLuWwnName=scsiLuWwnName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceTable=scsiInstanceTable, scsiPortTable=scsiPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdType=scsiLuIdType, scsiLuVendorId=scsiLuVendorId, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrName=scsiAuthIntrName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdType=ScsiIdType, scsiDeviceRole=scsiDeviceRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliances=scsiCompliances, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiRemoteTarget=scsiRemoteTarget, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiInitiator=scsiInitiator, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuInResets=scsiLuInResets, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiConformance=scsiConformance, scsiPortIndex=scsiPortIndex, scsiPortRole=scsiPortRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIndex=scsiLuIndex, scsiTargetGroup=scsiTargetGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuTable=scsiLuTable, scsiModule=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdValue=ScsiIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGeneral=scsiGeneral, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtName=scsiDscTgtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportFCP=scsiTransportFCP, scsiDeviceAlias=scsiDeviceAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapTable=scsiLunMapTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotifications=scsiNotifications, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiTarget=scsiTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
