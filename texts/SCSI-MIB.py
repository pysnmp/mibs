...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter32, Bits, ModuleIdentity, Unsigned32, mib_2, ObjectIdentity, Counter64, Integer32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter32", "Bits", "ModuleIdentity", "Unsigned32", "mib-2", "ObjectIdentity", "Counter64", "Integer32", "Gauge32", "TimeTicks")
RowPointer, TruthValue, TextualConvention, TimeStamp, AutonomousType, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "TextualConvention", "TimeStamp", "AutonomousType", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliances=scsiCompliances, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstAlias=scsiInstAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiCompliance=scsiCompliance, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuProductId=scsiLuProductId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuState=scsiLuState, scsiLuEntry=scsiLuEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, scsiNotifications=scsiNotifications, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstIndex=scsiInstIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdType=scsiLuIdType, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiDscLunLun=scsiDscLunLun, scsiTarget=scsiTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdValue=scsiLuIdValue, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtName=scsiDscTgtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceResets=scsiDeviceResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortName=scsiTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiTranportOther=scsiTranportOther, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportFCP=scsiTransportFCP, scsiPortRole=scsiPortRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, scsiPortEntry=scsiPortEntry, scsiLunMapIndex=scsiLunMapIndex, ScsiIdValue=ScsiIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapTable=scsiLunMapTable, scsiInitiator=scsiInitiator, scsiLuStatus=scsiLuStatus, scsiLuWwnName=scsiLuWwnName, scsiRemoteInitiators=scsiRemoteInitiators, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiGroups=scsiGroups, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIndexValue=ScsiIndexValue, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceTable=scsiInstanceTable, scsiLuTable=scsiLuTable, scsiGeneral=scsiGeneral, scsiConformance=scsiConformance, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetGroup=scsiTargetGroup, scsiPortTable=scsiPortTable, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName)
