...
Counter64, Gauge32, IpAddress, Integer32, NotificationType, mib_2, Bits, TimeTicks, iso, MibIdentifier, ModuleIdentity, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "IpAddress", "Integer32", "NotificationType", "mib-2", "Bits", "TimeTicks", "iso", "MibIdentifier", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
TruthValue, TextualConvention, AutonomousType, RowStatus, DisplayString, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiator=scsiInitiator, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceTable=scsiInstanceTable, scsiTarget=scsiTarget, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportSPI=scsiTranportSPI, scsiLuIdValue=scsiLuIdValue, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuTable=scsiLuTable, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportFCP=scsiTransportFCP, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdValue=ScsiIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIndex=scsiLuIndex, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptType=scsiTrnsptType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliances=scsiCompliances, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiName=ScsiName, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiGeneral=scsiGeneral, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportTypes=scsiTransportTypes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtName=scsiIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstAlias=scsiInstAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuEntry=scsiLuEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGroups=scsiGroups, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortEntry=scsiPortEntry, scsiCompliance=scsiCompliance, scsiObjects=scsiObjects, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
