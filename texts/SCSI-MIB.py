...
Bits, TimeTicks, Counter32, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Gauge32, Unsigned32, ModuleIdentity, ObjectIdentity, Counter64, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter32", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Gauge32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType", "Integer32")
RowPointer, TimeStamp, TruthValue, DisplayString, RowStatus, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuInResets=scsiLuInResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiInitiator=scsiInitiator, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiTarget=scsiTarget, scsiLuProductId=scsiLuProductId, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWwnName=scsiLuWwnName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortName=scsiTgtPortName, scsiModule=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscLunLun=scsiDscLunLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceTable=scsiInstanceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiLunMapLun=scsiLunMapLun, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstIndex=scsiInstIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdentifier=ScsiIdentifier, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiName=ScsiName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdType=scsiDscLunIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortTable=scsiPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTranportSPI=scsiTranportSPI, scsiGeneral=scsiGeneral, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuEntry=scsiLuEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdType=scsiLuIdType, ScsiIdType=ScsiIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiConformance=scsiConformance, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstAlias=scsiInstAlias, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrName=scsiAuthIntrName, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiNotifications=scsiNotifications, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, scsiTranportOther=scsiTranportOther, scsiGroups=scsiGroups, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValue=ScsiIndexValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptType=scsiTrnsptType, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiTransportSBP=scsiTransportSBP, scsiLuIndex=scsiLuIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuVendorId=scsiLuVendorId, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdAssociation=ScsiIdAssociation)
