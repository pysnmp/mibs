...
NotificationType, Unsigned32, Gauge32, IpAddress, Integer32, Bits, MibIdentifier, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, TimeTicks, mib_2, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Gauge32", "IpAddress", "Integer32", "Bits", "MibIdentifier", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "TimeTicks", "mib-2", "ObjectIdentity")
RowStatus, RowPointer, TextualConvention, DisplayString, TimeStamp, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuVendorId=scsiLuVendorId, scsiDeviceRole=scsiDeviceRole, scsiGeneral=scsiGeneral, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatus=scsiLuStatus, scsiPortEntry=scsiPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiTrnsptType=scsiTrnsptType, scsiLuWwnName=scsiLuWwnName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceTable=scsiInstanceTable, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTable=scsiPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdValue=ScsiIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiCompliance=scsiCompliance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, ScsiIdentifier=ScsiIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdType=ScsiIdType, scsiNotifications=scsiNotifications, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtName=scsiDscTgtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtName=scsiIntrPrtName, scsiPortIndex=scsiPortIndex, ScsiIndexValue=ScsiIndexValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiGroups=scsiGroups, scsiDeviceTable=scsiDeviceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiModule=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiInitiator=scsiInitiator, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiPortRole=scsiPortRole, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort)
