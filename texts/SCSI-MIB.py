...
Counter64, mib_2, ObjectIdentity, ModuleIdentity, Integer32, iso, Bits, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Gauge32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "ObjectIdentity", "ModuleIdentity", "Integer32", "iso", "Bits", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Gauge32", "TimeTicks", "Counter32")
TextualConvention, TimeStamp, RowStatus, TruthValue, DisplayString, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "TruthValue", "DisplayString", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdType=scsiDscLunIdType, scsiPortEntry=scsiPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunTable=scsiDscLunTable, scsiLuWwnName=scsiLuWwnName, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiConformance=scsiConformance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuProductId=scsiLuProductId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiTarget=scsiTarget, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdType=scsiLuIdType, ScsiIdentifier=ScsiIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportTypes=scsiTransportTypes, scsiLunMapLun=scsiLunMapLun, scsiObjects=scsiObjects, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDeviceGroup=scsiDeviceGroup, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSRP=scsiTransportSRP, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInResets=scsiLuInResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiModule=scsiModule, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiLuStatus=scsiLuStatus, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdType=ScsiIdType, scsiRemoteTarget=scsiRemoteTarget, PYSNMP_MODULE_ID=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapTable=scsiLunMapTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiator=scsiInitiator, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortRole=scsiPortRole, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotifications=scsiNotifications, scsiLunMapGroup=scsiLunMapGroup, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiName=ScsiName, scsiLuIndex=scsiLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportSPI=scsiTranportSPI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGeneral=scsiGeneral, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliances=scsiCompliances, scsiLuState=scsiLuState, ScsiIdValue=ScsiIdValue, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
