...
Unsigned32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, NotificationType, ObjectIdentity, Bits, IpAddress, ModuleIdentity, Gauge32, mib_2, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "mib-2", "MibIdentifier", "TimeTicks")
RowStatus, RowPointer, DisplayString, AutonomousType, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "DisplayString", "AutonomousType", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliance=scsiCompliance, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiName=ScsiName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceResets=scsiDeviceResets, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiLuIdType=scsiLuIdType, scsiPortRole=scsiPortRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiCompliances=scsiCompliances, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortIndex=scsiPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiGroups=scsiGroups, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiator=scsiInitiator, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunLun=scsiDscLunLun, scsiLuProductId=scsiLuProductId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceTable=scsiInstanceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportTypes=scsiTransportTypes, ScsiIdAssociation=ScsiIdAssociation, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuTable=scsiLuTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptType=scsiTrnsptType, scsiTransportSBP=scsiTransportSBP, scsiLuInCommands=scsiLuInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdTable=scsiLuIdTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportOther=scsiTranportOther, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType)
