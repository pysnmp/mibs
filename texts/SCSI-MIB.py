...
Counter32, MibIdentifier, NotificationType, iso, TimeTicks, ObjectIdentity, IpAddress, mib_2, Gauge32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "NotificationType", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "mib-2", "Gauge32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Integer32")
RowStatus, RowPointer, TruthValue, DisplayString, TextualConvention, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TruthValue", "DisplayString", "TextualConvention", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliances=scsiCompliances, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiator=scsiInitiator, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdValue=ScsiIdValue, scsiLuTable=scsiLuTable, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtTable=scsiDscTgtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiTransportSRP=scsiTransportSRP, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportOther=scsiTranportOther, scsiGeneral=scsiGeneral, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuState=scsiLuState, ScsiName=ScsiName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtName=scsiDscTgtName, scsiLunMapLun=scsiLunMapLun, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiObjects=scsiObjects, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdType=ScsiIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceGroup=scsiDeviceGroup, scsiCompliance=scsiCompliance, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortName=scsiTgtPortName, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuWwnName=scsiLuWwnName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiNotifications=scsiNotifications, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuProductId=scsiLuProductId, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunLun=scsiDscLunLun, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiConformance=scsiConformance, scsiInstVendorVersion=scsiInstVendorVersion)
