...
iso, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Integer32, Counter64, ObjectIdentity, Bits, mib_2, MibIdentifier, Unsigned32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Integer32", "Counter64", "ObjectIdentity", "Bits", "mib-2", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter32")
TruthValue, AutonomousType, DisplayString, TimeStamp, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiObjects=scsiObjects, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdAssociation=ScsiIdAssociation, ScsiIdValue=ScsiIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLun=scsiLunMapLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValue=ScsiIndexValue, scsiLuStatus=scsiLuStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInResets=scsiLuInResets, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceResets=scsiDeviceResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapTable=scsiLunMapTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdType=scsiLuIdType, scsiPortIndex=scsiPortIndex, scsiCompliance=scsiCompliance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunEntry=scsiDscLunEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapEntry=scsiLunMapEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWwnName=scsiLuWwnName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, scsiDscLunTable=scsiDscLunTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceEntry=scsiInstanceEntry, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiGroups=scsiGroups, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuEntry=scsiLuEntry, scsiGeneral=scsiGeneral, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiConformance=scsiConformance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceTable=scsiInstanceTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportTypes=scsiTransportTypes, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiCompliances=scsiCompliances, ScsiName=ScsiName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortEntry=scsiPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiModule=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdTable=scsiLuIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIndex=scsiLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceTable=scsiDeviceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes)
