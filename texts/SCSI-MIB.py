...
Counter32, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, NotificationType, Counter64, mib_2, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "NotificationType", "Counter64", "mib-2", "IpAddress", "Gauge32")
DisplayString, AutonomousType, RowPointer, RowStatus, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowPointer", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiTrnsptTable=scsiTrnsptTable, scsiModule=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuState=scsiLuState, scsiLuIdValue=scsiLuIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiDeviceTable=scsiDeviceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortTable=scsiPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdType=scsiLuIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptType=scsiTrnsptType, scsiDscLunEntry=scsiDscLunEntry, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiLuInResets=scsiLuInResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, ScsiIdType=ScsiIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTarget=scsiTarget, scsiGeneral=scsiGeneral, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuTable=scsiLuTable, ScsiIdValue=ScsiIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceRole=scsiDeviceRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevTable=scsiTgtDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiLuEntry=scsiLuEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiator=scsiInitiator, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInCommands=scsiLuInCommands, scsiPortRole=scsiPortRole, scsiConformance=scsiConformance, scsiGroups=scsiGroups, scsiPortEntry=scsiPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstIndex=scsiInstIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliance=scsiCompliance, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet)
