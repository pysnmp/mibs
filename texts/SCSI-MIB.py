...
TimeTicks, NotificationType, ObjectIdentity, IpAddress, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, iso, MibIdentifier, Gauge32, Bits, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "iso", "MibIdentifier", "Gauge32", "Bits", "ModuleIdentity", "mib-2")
RowStatus, TruthValue, TimeStamp, AutonomousType, RowPointer, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "AutonomousType", "RowPointer", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdValue=scsiLuIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapTable=scsiLunMapTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdValue=ScsiIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIndexValue=ScsiIndexValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, scsiModule=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortRole=scsiPortRole, ScsiIdentifier=ScsiIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiator=scsiInitiator, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuState=scsiLuState, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuTable=scsiLuTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiConformance=scsiConformance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunLun=scsiDscLunLun, scsiIntrDevEntry=scsiIntrDevEntry, ScsiName=ScsiName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteTarget=scsiRemoteTarget, scsiInstAlias=scsiInstAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIndex=scsiLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, scsiTranportOther=scsiTranportOther, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortEntry=scsiPortEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLun=scsiLunMapLun, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstanceTable=scsiInstanceTable, scsiPortIndex=scsiPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortName=scsiTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSRP=scsiTransportSRP, ScsiIdType=ScsiIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatus=scsiLuStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiTrnsptType=scsiTrnsptType, scsiDscLunTable=scsiDscLunTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuEntry=scsiLuEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceRole=scsiDeviceRole, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName)
