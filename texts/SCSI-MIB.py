...
Gauge32, NotificationType, ObjectIdentity, Counter32, mib_2, Counter64, Integer32, Bits, Unsigned32, ModuleIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "mib-2", "Counter64", "Integer32", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso")
TextualConvention, TimeStamp, TruthValue, AutonomousType, RowPointer, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "AutonomousType", "RowPointer", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiator=scsiInitiator, scsiInstAlias=scsiInstAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapTable=scsiLunMapTable, scsiInstanceTable=scsiInstanceTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiNotifications=scsiNotifications, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGeneral=scsiGeneral, scsiInstIndex=scsiInstIndex, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdValue=ScsiIdValue, scsiTranportOther=scsiTranportOther, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapLun=scsiLunMapLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuPeripheralType=scsiLuPeripheralType, scsiDevicePortNumber=scsiDevicePortNumber, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiGroups=scsiGroups, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIndex=scsiLuIndex, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuState=scsiLuState, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdAssociation=ScsiIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuInResets=scsiLuInResets, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSRP=scsiTransportSRP, scsiTranportSPI=scsiTranportSPI, scsiLuStatus=scsiLuStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortEntry=scsiPortEntry, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdValue=scsiLuIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortIndex=scsiPortIndex, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiObjects=scsiObjects, scsiLuEntry=scsiLuEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiTarget=scsiTarget, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSBP=scsiTransportSBP, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunTable=scsiDscLunTable, scsiLuRevisionId=scsiLuRevisionId, scsiCompliance=scsiCompliance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevTable=scsiTgtDevTable, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiModule=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliances=scsiCompliances, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortInCommands=scsiTgtPortInCommands)
