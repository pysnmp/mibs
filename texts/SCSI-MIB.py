...
ModuleIdentity, Unsigned32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Gauge32, mib_2, ObjectIdentity, IpAddress, Integer32, Counter64, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Gauge32", "mib-2", "ObjectIdentity", "IpAddress", "Integer32", "Counter64", "Counter32", "iso")
DisplayString, TimeStamp, RowStatus, RowPointer, TruthValue, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "RowPointer", "TruthValue", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuReadMegaBytes=scsiLuReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceRole=scsiDeviceRole, scsiTransportTypes=scsiTransportTypes, scsiLuStatus=scsiLuStatus, scsiDscLunLun=scsiDscLunLun, scsiGeneral=scsiGeneral, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTarget=scsiTarget, ScsiIdentifier=ScsiIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdIndex=scsiLuIdIndex, scsiPortTable=scsiPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotifications=scsiNotifications, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuIndex=scsiLuIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuTable=scsiLuTable, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIndexValue=ScsiIndexValue, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, scsiDeviceTable=scsiDeviceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLun=scsiLunMapLun, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuProductId=scsiLuProductId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdType=ScsiIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtName=scsiIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdType=scsiLuIdType, scsiInstIndex=scsiInstIndex, scsiTargetGroup=scsiTargetGroup, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevTable=scsiIntrDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiTrnsptTable=scsiTrnsptTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliance=scsiCompliance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuRevisionId=scsiLuRevisionId, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapEntry=scsiLunMapEntry, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSBP=scsiTransportSBP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuState=scsiLuState, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiConformance=scsiConformance, scsiDscLunIdTable=scsiDscLunIdTable, scsiObjects=scsiObjects, scsiLogicalUnit=scsiLogicalUnit, scsiPortEntry=scsiPortEntry, scsiDevicePortNumber=scsiDevicePortNumber)
