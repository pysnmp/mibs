...
MibIdentifier, ObjectIdentity, ModuleIdentity, IpAddress, mib_2, Counter64, Unsigned32, iso, Gauge32, NotificationType, TimeTicks, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "IpAddress", "mib-2", "Counter64", "Unsigned32", "iso", "Gauge32", "NotificationType", "TimeTicks", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
TimeStamp, RowStatus, DisplayString, AutonomousType, RowPointer, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "DisplayString", "AutonomousType", "RowPointer", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, scsiTranportOther=scsiTranportOther, scsiGroups=scsiGroups, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiTarget=scsiTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiNotifications=scsiNotifications, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiPortRole=scsiPortRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstIndex=scsiInstIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceGroup=scsiDeviceGroup, ScsiName=ScsiName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdValue=scsiLuIdValue, scsiLuStatus=scsiLuStatus, scsiDscTgtName=scsiDscTgtName, scsiCompliance=scsiCompliance, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceEntry=scsiDeviceEntry, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiTransportTypes=scsiTransportTypes, scsiLuWwnName=scsiLuWwnName, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrName=scsiAuthIntrName, scsiTranportSPI=scsiTranportSPI, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiObjects=scsiObjects, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstAlias=scsiInstAlias, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportFCP=scsiTransportFCP, scsiLuInResets=scsiLuInResets, PYSNMP_MODULE_ID=scsiModule, scsiLuState=scsiLuState, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceTable=scsiDeviceTable, scsiPortIndex=scsiPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtTable=scsiDscTgtTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiRemoteTarget=scsiRemoteTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry, scsiTransportSBP=scsiTransportSBP, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiator=scsiInitiator, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun)
