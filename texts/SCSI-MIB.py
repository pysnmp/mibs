...
TimeTicks, ModuleIdentity, iso, mib_2, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, ObjectIdentity, Counter64, Counter32, Gauge32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "iso", "mib-2", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "Counter32", "Gauge32", "NotificationType", "MibIdentifier")
TruthValue, AutonomousType, RowPointer, RowStatus, DisplayString, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "RowPointer", "RowStatus", "DisplayString", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdTable=scsiLuIdTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiLuRevisionId=scsiLuRevisionId, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiTranportOther=scsiTranportOther, scsiLunMapTable=scsiLunMapTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiName=ScsiName, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLun=scsiLunMapLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiPortIndex=scsiPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortRole=scsiPortRole, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliances=scsiCompliances, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiLogicalUnit=scsiLogicalUnit, scsiLuIndex=scsiLuIndex, scsiObjects=scsiObjects, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiGroups=scsiGroups, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuEntry=scsiLuEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGeneral=scsiGeneral, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInResets=scsiLuInResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiLuProductId=scsiLuProductId, scsiInitiator=scsiInitiator, scsiLuStatus=scsiLuStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtName=scsiDscTgtName, scsiTarget=scsiTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiModule=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuInCommands=scsiLuInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuState=scsiLuState, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortTable=scsiTgtPortTable, ScsiIdValue=ScsiIdValue)
