...
Integer32, ModuleIdentity, Bits, NotificationType, Gauge32, Unsigned32, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, IpAddress, Counter32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "NotificationType", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "IpAddress", "Counter32", "MibIdentifier", "iso")
TruthValue, TimeStamp, DisplayString, TextualConvention, RowStatus, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiName=ScsiName, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiTransportSRP=scsiTransportSRP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtName=scsiDscTgtName, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiator=scsiInitiator, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiInstIndex=scsiInstIndex, scsiTranportOther=scsiTranportOther, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapEntry=scsiLunMapEntry, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportFCP=scsiTransportFCP, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiGeneral=scsiGeneral, scsiTargetGroup=scsiTargetGroup, scsiLuEntry=scsiLuEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceEntry=scsiInstanceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuState=scsiLuState, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceRole=scsiDeviceRole, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunLun=scsiDscLunLun, scsiTrnsptType=scsiTrnsptType, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDeviceGroup=scsiDeviceGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotifications=scsiNotifications, scsiLuInCommands=scsiLuInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGroups=scsiGroups, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiLuInResets=scsiLuInResets, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuTable=scsiLuTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortName=scsiTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, PYSNMP_MODULE_ID=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatus=scsiLuStatus, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWwnName=scsiLuWwnName, scsiLuIndex=scsiLuIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortRole=scsiPortRole, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiModule=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiObjects=scsiObjects, scsiIntrPrtName=scsiIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs)
