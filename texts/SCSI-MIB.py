...
TimeTicks, ModuleIdentity, NotificationType, ObjectIdentity, IpAddress, Gauge32, iso, mib_2, MibIdentifier, Counter64, Bits, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "NotificationType", "ObjectIdentity", "IpAddress", "Gauge32", "iso", "mib-2", "MibIdentifier", "Counter64", "Bits", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TextualConvention, TimeStamp, RowStatus, DisplayString, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdTable=scsiLuIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiNotifications=scsiNotifications, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuEntry=scsiLuEntry, scsiObjects=scsiObjects, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSRP=scsiTransportSRP, PYSNMP_MODULE_ID=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuState=scsiLuState, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIndex=scsiLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSBP=scsiTransportSBP, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptType=scsiTrnsptType, scsiLuVendorId=scsiLuVendorId, scsiInstanceTable=scsiInstanceTable, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapEntry=scsiLunMapEntry, ScsiIdType=ScsiIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuStatus=scsiLuStatus, scsiModule=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortIndex=scsiPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstAlias=scsiInstAlias, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValue=ScsiIndexValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliances=scsiCompliances, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTable=scsiPortTable, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiGeneral=scsiGeneral, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiGroups=scsiGroups, scsiTarget=scsiTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceRole=scsiDeviceRole, scsiLunMapLun=scsiLunMapLun, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTargetGroup=scsiTargetGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable)
