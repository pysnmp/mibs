...
Integer32, Counter64, ModuleIdentity, ObjectIdentity, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, Gauge32, TimeTicks, Unsigned32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "ObjectIdentity", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "Gauge32", "TimeTicks", "Unsigned32", "Counter32", "MibIdentifier")
RowStatus, TimeStamp, RowPointer, DisplayString, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "RowPointer", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliances=scsiCompliances, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, ScsiIdValue=ScsiIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiObjects=scsiObjects, scsiDeviceEntry=scsiDeviceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, ScsiIdAssociation=ScsiIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortRole=scsiPortRole, scsiDeviceResets=scsiDeviceResets, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceTable=scsiDeviceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, ScsiIdentifier=ScsiIdentifier, scsiInitiator=scsiInitiator, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptDevName=scsiTrnsptDevName, ScsiName=ScsiName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotifications=scsiNotifications, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSBP=scsiTransportSBP, scsiTransportISCSI=scsiTransportISCSI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdType=ScsiIdType, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTranportSPI=scsiTranportSPI, scsiLunMapGroup=scsiLunMapGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiGeneral=scsiGeneral, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuProductId=scsiLuProductId, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuEntry=scsiLuEntry, scsiPortIndex=scsiPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuState=scsiLuState, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapTable=scsiLunMapTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiLuInCommands=scsiLuInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiConformance=scsiConformance)
