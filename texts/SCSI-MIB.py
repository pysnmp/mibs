...
IpAddress, ObjectIdentity, MibIdentifier, TimeTicks, Counter32, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, NotificationType, Gauge32, Integer32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Counter32", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "NotificationType", "Gauge32", "Integer32", "Bits", "Counter64")
RowPointer, RowStatus, TextualConvention, TimeStamp, TruthValue, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuTable=scsiLuTable, scsiLuEntry=scsiLuEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, scsiPortRole=scsiPortRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortIndex=scsiPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuState=scsiLuState, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLuInResets=scsiLuInResets, ScsiIdentifier=ScsiIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTarget=scsiTarget, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceEntry=scsiInstanceEntry, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdType=scsiLuIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportOther=scsiTranportOther, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdTable=scsiLuIdTable, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdType=ScsiIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, scsiConformance=scsiConformance, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstAlias=scsiInstAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceTable=scsiDeviceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGroups=scsiGroups, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdValue=ScsiIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiModule=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInCommands=scsiLuInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuIndex=scsiLuIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiGeneral=scsiGeneral, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName)
