...
ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, mib_2, ObjectIdentity, MibIdentifier, NotificationType, Counter64, Counter32, Bits, Gauge32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "mib-2", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter64", "Counter32", "Bits", "Gauge32", "IpAddress", "Integer32")
AutonomousType, RowPointer, DisplayString, TextualConvention, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuHSInCommands=scsiLuHSInCommands, scsiInstIndex=scsiInstIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtRowStatus=scsiDscTgtRowStatus, PYSNMP_MODULE_ID=scsiModule, ScsiName=ScsiName, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiator=scsiInitiator, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTransportTypes=scsiTransportTypes, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiConformance=scsiConformance, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, ScsiIdentifier=ScsiIdentifier, scsiLuStatus=scsiLuStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceResets=scsiDeviceResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortRole=scsiPortRole, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiLuEntry=scsiLuEntry, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteTarget=scsiRemoteTarget, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, scsiLuInResets=scsiLuInResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunLun=scsiDscLunLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortName=scsiTgtPortName, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportSRP=scsiTransportSRP, scsiLuWwnName=scsiLuWwnName, scsiGeneral=scsiGeneral, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTarget=scsiTarget, scsiGroups=scsiGroups, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiObjects=scsiObjects, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuProductId=scsiLuProductId, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiLuIdTable=scsiLuIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTable=scsiIntrDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotifications=scsiNotifications, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, ScsiIdType=ScsiIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiCompliances=scsiCompliances, scsiLuTable=scsiLuTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortEntry=scsiPortEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSBP=scsiTransportSBP, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportFCP=scsiTransportFCP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceRole=scsiDeviceRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiModule=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex)
