...
TimeTicks, iso, Bits, Unsigned32, Counter64, mib_2, ObjectIdentity, ModuleIdentity, Integer32, NotificationType, Gauge32, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Bits", "Unsigned32", "Counter64", "mib-2", "ObjectIdentity", "ModuleIdentity", "Integer32", "NotificationType", "Gauge32", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TimeStamp, RowStatus, AutonomousType, TextualConvention, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, scsiTransportFCP=scsiTransportFCP, scsiLuInResets=scsiLuInResets, scsiTrnsptType=scsiTrnsptType, scsiObjects=scsiObjects, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortTable=scsiTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceTable=scsiDeviceTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiInstIndex=scsiInstIndex, PYSNMP_MODULE_ID=scsiModule, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiCompliances=scsiCompliances, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiPortEntry=scsiPortEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGeneral=scsiGeneral, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTranportOther=scsiTranportOther, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiInitiator=scsiInitiator, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuVendorId=scsiLuVendorId, scsiPortRole=scsiPortRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiTranportSPI=scsiTranportSPI, scsiInstAlias=scsiInstAlias, scsiLunMapEntry=scsiLunMapEntry, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName, scsiModule=scsiModule, scsiLuTable=scsiLuTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiDscLunLun=scsiDscLunLun, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuStatus=scsiLuStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdType=scsiLuIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuState=scsiLuState, scsiDscLunEntry=scsiDscLunEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInCommands=scsiLuInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiLunMapTable=scsiLunMapTable, scsiPortIndex=scsiPortIndex, scsiDscTgtName=scsiDscTgtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTarget=scsiTarget)
