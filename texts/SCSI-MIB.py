...
Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter32, Counter64, iso, TimeTicks, Bits, IpAddress, MibIdentifier, ObjectIdentity, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter32", "Counter64", "iso", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "mib-2", "Unsigned32")
TruthValue, TextualConvention, DisplayString, RowPointer, AutonomousType, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DisplayString", "RowPointer", "AutonomousType", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSRP=scsiTransportSRP, scsiDscLunTable=scsiDscLunTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdType=ScsiIdType, scsiLuRevisionId=scsiLuRevisionId, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdEntry=scsiLuIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuVendorId=scsiLuVendorId, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiPortIndex=scsiPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLunMapGroup=scsiLunMapGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceIndex=scsiDeviceIndex, scsiGeneral=scsiGeneral, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunLun=scsiDscLunLun, scsiDeviceResets=scsiDeviceResets, ScsiLUNOrZero=ScsiLUNOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiObjects=scsiObjects, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiName=ScsiName, scsiIntrPrtName=scsiIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIndexValue=ScsiIndexValue, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteTarget=scsiRemoteTarget, scsiLuState=scsiLuState, scsiLogicalUnit=scsiLogicalUnit, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiTransportFCP=scsiTransportFCP, scsiLuInResets=scsiLuInResets, scsiLuInCommands=scsiLuInCommands, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdTable=scsiLuIdTable, scsiModule=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIndex=scsiLuIndex, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTarget=scsiTarget, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTranportOther=scsiTranportOther, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstAlias=scsiInstAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapTable=scsiLunMapTable, scsiInstanceTable=scsiInstanceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiCompliance=scsiCompliance, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet)
