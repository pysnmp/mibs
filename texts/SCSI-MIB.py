...
ObjectIdentity, Counter32, mib_2, MibIdentifier, iso, Unsigned32, Gauge32, TimeTicks, ModuleIdentity, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "mib-2", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "TimeTicks", "ModuleIdentity", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64")
TimeStamp, DisplayString, RowPointer, RowStatus, TextualConvention, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowPointer", "RowStatus", "TextualConvention", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdEntry=scsiLuIdEntry, scsiLuTable=scsiLuTable, scsiCompliance=scsiCompliance, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiModule=scsiModule, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunLun=scsiDscLunLun, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLuProductId=scsiLuProductId, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiTranportSPI=scsiTranportSPI, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceGroup=scsiDeviceGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortName=scsiTgtPortName, scsiInstIndex=scsiInstIndex, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceRole=scsiDeviceRole, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotifications=scsiNotifications, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapTable=scsiLunMapTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortRole=scsiPortRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, scsiConformance=scsiConformance, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapLun=scsiLunMapLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortIndex=scsiPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstAlias=scsiInstAlias, ScsiIdentifier=ScsiIdentifier, scsiLuEntry=scsiLuEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiGroups=scsiGroups, PYSNMP_MODULE_ID=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiObjects=scsiObjects, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName)
