...
TextualConvention, AutonomousType, RowPointer, TimeStamp, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowPointer", "TimeStamp", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiGroups=scsiGroups, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceAlias=scsiDeviceAlias, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTarget=scsiTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuIndex=scsiLuIndex, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuEntry=scsiLuEntry, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceRole=scsiDeviceRole, ScsiName=ScsiName, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiInstAlias=scsiInstAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstanceTable=scsiInstanceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiModule=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunEntry=scsiDscLunEntry, scsiCompliances=scsiCompliances, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiLuState=scsiLuState, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortTable=scsiPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiator=scsiInitiator, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdType=scsiLuIdType, scsiLuTable=scsiLuTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, ScsiIndexValue=ScsiIndexValue, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtName=scsiDscTgtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapGroup=scsiLunMapGroup, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtTable=scsiDscTgtTable, ScsiLUNOrZero=ScsiLUNOrZero)
