...
ObjectIdentity, NotificationType, Bits, TimeTicks, Gauge32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, IpAddress, mib_2, Counter32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "TimeTicks", "Gauge32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "IpAddress", "mib-2", "Counter32", "Counter64", "MibIdentifier")
TruthValue, RowPointer, TimeStamp, RowStatus, TextualConvention, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "TimeStamp", "RowStatus", "TextualConvention", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtName=scsiDscTgtName, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiPortIndex=scsiPortIndex, scsiInstanceTable=scsiInstanceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstAlias=scsiInstAlias, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiTransportSBP=scsiTransportSBP, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdValue=ScsiIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiName=ScsiName, scsiTarget=scsiTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapIndex=scsiLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiModule=scsiModule, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiPortEntry=scsiPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceRole=scsiDeviceRole, scsiLuProductId=scsiLuProductId, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdEntry=scsiLuIdEntry, scsiTranportOther=scsiTranportOther, scsiPortTable=scsiPortTable, scsiLuState=scsiLuState, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiConformance=scsiConformance, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortRole=scsiPortRole, scsiLuIdValue=scsiLuIdValue, scsiDscLunLun=scsiDscLunLun, scsiLuIdType=scsiLuIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapTable=scsiLunMapTable, scsiDeviceResets=scsiDeviceResets, scsiGroups=scsiGroups, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceTable=scsiDeviceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliances=scsiCompliances, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiLuTable=scsiLuTable, scsiTrnsptType=scsiTrnsptType, scsiLuStatus=scsiLuStatus)
