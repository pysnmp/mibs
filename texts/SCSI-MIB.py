...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Counter64, IpAddress, Counter32, Bits, MibIdentifier, mib_2, Unsigned32, iso, TimeTicks, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Counter64", "IpAddress", "Counter32", "Bits", "MibIdentifier", "mib-2", "Unsigned32", "iso", "TimeTicks", "Gauge32", "NotificationType")
TextualConvention, AutonomousType, TruthValue, TimeStamp, RowPointer, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceIndex=scsiDeviceIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportSPI=scsiTranportSPI, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortName=scsiTgtPortName, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiName=ScsiName, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiGeneral=scsiGeneral, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiLuInResets=scsiLuInResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapEntry=scsiLunMapEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdType=scsiLuIdType, scsiInstanceEntry=scsiInstanceEntry, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiLuIndex=scsiLuIndex, scsiObjects=scsiObjects, scsiCompliance=scsiCompliance, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiCompliances=scsiCompliances, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortIndex=scsiPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiConformance=scsiConformance, ScsiIdType=ScsiIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTarget=scsiTarget, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuTable=scsiLuTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuEntry=scsiLuEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiInstIndex=scsiInstIndex, scsiLuStatus=scsiLuStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportOther=scsiTranportOther, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdentifier=ScsiIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuState=scsiLuState, scsiInstAlias=scsiInstAlias, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunTable=scsiDscLunTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiPortEntry=scsiPortEntry, scsiDeviceResets=scsiDeviceResets, scsiTargetGroup=scsiTargetGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuWwnName=scsiLuWwnName, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiTransportFCP=scsiTransportFCP, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiModule=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotifications=scsiNotifications, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapLuIndex=scsiLunMapLuIndex)
