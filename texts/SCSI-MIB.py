...
Counter32, IpAddress, ModuleIdentity, mib_2, NotificationType, iso, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Integer32, Gauge32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "ModuleIdentity", "mib-2", "NotificationType", "iso", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "Unsigned32", "ObjectIdentity")
AutonomousType, TextualConvention, TimeStamp, DisplayString, TruthValue, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportOther=scsiTranportOther, scsiCompliance=scsiCompliance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceTable=scsiDeviceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiDeviceAlias=scsiDeviceAlias, scsiTransportFCP=scsiTransportFCP, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSBP=scsiTransportSBP, scsiPortRole=scsiPortRole, ScsiIdType=ScsiIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, ScsiName=ScsiName, scsiLuIdTable=scsiLuIdTable, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGeneral=scsiGeneral, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiLuRevisionId=scsiLuRevisionId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceTable=scsiInstanceTable, scsiLunMapTable=scsiLunMapTable, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIndex=scsiLuIndex, scsiInitiator=scsiInitiator, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdType=scsiDscLunIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInResets=scsiLuInResets, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptDevName=scsiTrnsptDevName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiModule=scsiModule, scsiIntrPrtName=scsiIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiObjects=scsiObjects, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportTypes=scsiTransportTypes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSRP=scsiTransportSRP, scsiLuTable=scsiLuTable, scsiGroups=scsiGroups, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunLun=scsiDscLunLun, scsiPortEntry=scsiPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier)
