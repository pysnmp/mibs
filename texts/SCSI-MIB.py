...
Gauge32, MibIdentifier, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, iso, Bits, IpAddress, ModuleIdentity, ObjectIdentity, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "iso", "Bits", "IpAddress", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Integer32", "Counter64")
TimeStamp, TextualConvention, TruthValue, RowPointer, RowStatus, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TruthValue", "RowPointer", "RowStatus", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortIndex=scsiPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtName=scsiDscTgtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotifications=scsiNotifications, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortRole=scsiPortRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiLuTable=scsiLuTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstAlias=scsiInstAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiName=ScsiName, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstIndex=scsiInstIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInResets=scsiLuInResets, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceRole=scsiDeviceRole, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiator=scsiInitiator, ScsiIdValue=ScsiIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliance=scsiCompliance, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuState=scsiLuState, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunTable=scsiDscLunTable, scsiTranportOther=scsiTranportOther, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuEntry=scsiLuEntry, scsiTransportSBP=scsiTransportSBP, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiObjects=scsiObjects, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortName=scsiTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuWwnName=scsiLuWwnName, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapTable=scsiLunMapTable, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiGeneral=scsiGeneral, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortEntry=scsiPortEntry, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtName=scsiIntrPrtName, scsiModule=scsiModule, scsiGroups=scsiGroups, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiNameIdOrZero=ScsiNameIdOrZero)
