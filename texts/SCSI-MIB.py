...
Counter64, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, TimeTicks, iso, Gauge32, Integer32, IpAddress, Unsigned32, Counter32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "TimeTicks", "iso", "Gauge32", "Integer32", "IpAddress", "Unsigned32", "Counter32", "ObjectIdentity", "MibIdentifier")
TimeStamp, AutonomousType, TextualConvention, RowStatus, DisplayString, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortIndex=scsiPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportTypes=scsiTransportTypes, scsiDeviceResets=scsiDeviceResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiLunMapEntry=scsiLunMapEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, scsiInstanceEntry=scsiInstanceEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortRole=scsiPortRole, scsiGeneral=scsiGeneral, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiator=scsiInitiator, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiCompliances=scsiCompliances, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuState=scsiLuState, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiConformance=scsiConformance, scsiModule=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstIndex=scsiInstIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceEntry=scsiDeviceEntry, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, ScsiIdentifier=ScsiIdentifier, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuTable=scsiLuTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTarget=scsiTarget, scsiObjects=scsiObjects, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdAssociation=ScsiIdAssociation, scsiNotifications=scsiNotifications, scsiAuthIntrName=scsiAuthIntrName, scsiLuEntry=scsiLuEntry, scsiLuStatus=scsiLuStatus, scsiTranportOther=scsiTranportOther, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdValue=scsiLuIdValue, scsiLuIdType=scsiLuIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortTable=scsiTgtPortTable, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTable=scsiPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunEntry=scsiDscLunEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSRP=scsiTransportSRP, scsiLuIdIndex=scsiLuIdIndex)
