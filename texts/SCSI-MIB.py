...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Bits, Counter64, mib_2, Counter32, IpAddress, iso, TimeTicks, MibIdentifier, ModuleIdentity, NotificationType, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Bits", "Counter64", "mib-2", "Counter32", "IpAddress", "iso", "TimeTicks", "MibIdentifier", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Unsigned32")
TimeStamp, RowPointer, TextualConvention, DisplayString, AutonomousType, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TextualConvention", "DisplayString", "AutonomousType", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdValue=scsiLuIdValue, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstIndex=scsiInstIndex, scsiTransportFCP=scsiTransportFCP, scsiLunMapLun=scsiLunMapLun, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtName=scsiDscTgtName, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuProductId=scsiLuProductId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotifications=scsiNotifications, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceResets=scsiDeviceResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiConformance=scsiConformance, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportTypes=scsiTransportTypes, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiLuState=scsiLuState, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIndex=scsiLuIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiCompliance=scsiCompliance, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGroups=scsiGroups, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuEntry=scsiLuEntry, ScsiIdentifier=ScsiIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiModule=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortIndex=scsiPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunTable=scsiDscLunTable, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuVendorId=scsiLuVendorId, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, ScsiName=ScsiName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry)
