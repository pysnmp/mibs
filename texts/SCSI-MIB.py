...
IpAddress, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Gauge32, TimeTicks, Counter64, Integer32, Bits, ObjectIdentity, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "Counter64", "Integer32", "Bits", "ObjectIdentity", "iso", "ModuleIdentity", "Unsigned32")
TimeStamp, AutonomousType, RowPointer, TextualConvention, RowStatus, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowPointer", "TextualConvention", "RowStatus", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiCompliance=scsiCompliance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIndex=scsiLuIndex, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWwnName=scsiLuWwnName, scsiTranportSPI=scsiTranportSPI, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortTable=scsiPortTable, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiInstAlias=scsiInstAlias, ScsiName=ScsiName, scsiLuTable=scsiLuTable, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceEntry=scsiDeviceEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTarget=scsiTarget, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTable=scsiIntrDevTable, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportTypes=scsiTransportTypes, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdValue=scsiLuIdValue, scsiTargetGroup=scsiTargetGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceAlias=scsiDeviceAlias, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceRole=scsiDeviceRole, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortRole=scsiPortRole, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunTable=scsiDscLunTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiTranportOther=scsiTranportOther, scsiLuIdEntry=scsiLuIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuState=scsiLuState, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiModule=scsiModule, scsiPortIndex=scsiPortIndex, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiCompliances=scsiCompliances, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdType=ScsiIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunLun=scsiDscLunLun, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiator=scsiInitiator, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtName=scsiDscTgtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiLuProductId=scsiLuProductId, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortEntry=scsiTgtPortEntry, scsiGeneral=scsiGeneral, scsiRemoteInitiators=scsiRemoteInitiators, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex)
