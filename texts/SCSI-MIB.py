...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceTable=scsiDeviceTable, scsiLunMapLun=scsiLunMapLun, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuVendorId=scsiLuVendorId, scsiLuEntry=scsiLuEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGroups=scsiGroups, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliance=scsiCompliance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiTranportSPI=scsiTranportSPI, scsiPortRole=scsiPortRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportTypes=scsiTransportTypes, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtName=scsiDscTgtName, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceRole=scsiDeviceRole, scsiTransportFCP=scsiTransportFCP, scsiCompliances=scsiCompliances, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiConformance=scsiConformance, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiDscLunLun=scsiDscLunLun, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuProductId=scsiLuProductId, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotifications=scsiNotifications, scsiTransportSBP=scsiTransportSBP, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIndex=scsiLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValue=ScsiIndexValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuState=scsiLuState, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTable=scsiPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunTable=scsiDscLunTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiator=scsiInitiator, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdType=scsiLuIdType, scsiLuIdIndex=scsiLuIdIndex, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWwnName=scsiLuWwnName, scsiInstIndex=scsiInstIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortName=scsiTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortEntry=scsiPortEntry, scsiInstanceTable=scsiInstanceTable, scsiLuIdValue=scsiLuIdValue, scsiTarget=scsiTarget, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdValue=ScsiIdValue, scsiInstAlias=scsiInstAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes)
