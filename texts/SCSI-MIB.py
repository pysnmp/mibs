...
MibIdentifier, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter32, ObjectIdentity, NotificationType, Unsigned32, ModuleIdentity, Gauge32, TimeTicks, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter32", "ObjectIdentity", "NotificationType", "Unsigned32", "ModuleIdentity", "Gauge32", "TimeTicks", "IpAddress", "mib-2")
RowPointer, TruthValue, DisplayString, AutonomousType, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "DisplayString", "AutonomousType", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInCommands=scsiLuInCommands, scsiLuEntry=scsiLuEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWwnName=scsiLuWwnName, scsiDeviceResets=scsiDeviceResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSBP=scsiTransportSBP, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatus=scsiLuStatus, scsiLunMapIndex=scsiLunMapIndex, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtTable=scsiDscTgtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstIndex=scsiInstIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdTable=scsiLuIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLuTable=scsiLuTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstAlias=scsiInstAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortIndex=scsiPortIndex, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportOther=scsiTranportOther, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliance=scsiCompliance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortTable=scsiPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, ScsiIdValue=ScsiIdValue, PYSNMP_MODULE_ID=scsiModule, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortTable=scsiTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiInstanceTable=scsiInstanceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceTable=scsiDeviceTable, scsiLuIdIndex=scsiLuIdIndex, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptType=scsiTrnsptType, scsiTransportFCP=scsiTransportFCP, scsiLuState=scsiLuState, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuVendorId=scsiLuVendorId, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiConformance=scsiConformance, scsiLunMapTable=scsiLunMapTable, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName)
