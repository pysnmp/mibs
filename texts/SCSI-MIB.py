...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter32, ObjectIdentity, NotificationType, MibIdentifier, ModuleIdentity, Integer32, IpAddress, Counter64, mib_2, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter32", "ObjectIdentity", "NotificationType", "MibIdentifier", "ModuleIdentity", "Integer32", "IpAddress", "Counter64", "mib-2", "iso", "Bits")
RowPointer, AutonomousType, DisplayString, TextualConvention, TruthValue, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotifications=scsiNotifications, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTarget=scsiTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortIndex=scsiPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiCompliance=scsiCompliance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapTable=scsiLunMapTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiTransportFCP=scsiTransportFCP, ScsiLUNOrZero=ScsiLUNOrZero, scsiObjects=scsiObjects, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuVendorId=scsiLuVendorId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstIndex=scsiInstIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiLuIdTable=scsiLuIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortRole=scsiPortRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdValue=ScsiIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, scsiLuStatusChanged=scsiLuStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceAlias=scsiDeviceAlias, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiLuWwnName=scsiLuWwnName, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue, scsiLuIdType=scsiLuIdType, scsiTranportSPI=scsiTranportSPI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiGeneral=scsiGeneral, scsiGroups=scsiGroups, scsiInstanceTable=scsiInstanceTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIndex=scsiDscTgtIndex, scsiConformance=scsiConformance, ScsiIdType=ScsiIdType, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIndex=scsiDscLunIndex, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceTable=scsiDeviceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevTable=scsiTgtDevTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdValue=scsiLuIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTransportISCSI=scsiTransportISCSI, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuState=scsiLuState, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliances=scsiCompliances, scsiPortTable=scsiPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
