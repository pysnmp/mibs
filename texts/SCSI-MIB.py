...
Unsigned32, Counter32, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, Bits, Gauge32, Counter64, ModuleIdentity, Integer32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "Bits", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier")
TruthValue, TextualConvention, RowStatus, TimeStamp, AutonomousType, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "TimeStamp", "AutonomousType", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapTable=scsiLunMapTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceRole=scsiDeviceRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiObjects=scsiObjects, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceTable=scsiInstanceTable, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiLuEntry=scsiLuEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceResets=scsiDeviceResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiConformance=scsiConformance, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdType=scsiLuIdType, ScsiIdValue=ScsiIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGroups=scsiGroups, scsiDeviceGroup=scsiDeviceGroup, scsiTarget=scsiTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortIndex=scsiPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiTransportTypes=scsiTransportTypes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiInstIndex=scsiInstIndex, scsiLunMapLun=scsiLunMapLun, scsiTranportOther=scsiTranportOther, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstAlias=scsiInstAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiator=scsiInitiator, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuWwnName=scsiLuWwnName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdValue=scsiLuIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSBP=scsiTransportSBP, scsiTransportFCP=scsiTransportFCP, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiGeneral=scsiGeneral, ScsiIndexValue=ScsiIndexValue, scsiTranportSPI=scsiTranportSPI, scsiTgtDevTable=scsiTgtDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdentifier=ScsiIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiPortTable=scsiPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuTable=scsiLuTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortEntry=scsiPortEntry, scsiTgtPortTable=scsiTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptType=scsiTrnsptType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceIndex=scsiDeviceIndex, ScsiName=ScsiName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInResets=scsiLuInResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup)
