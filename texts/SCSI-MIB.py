...
NotificationType, ModuleIdentity, ObjectIdentity, MibIdentifier, TimeTicks, IpAddress, Counter32, Integer32, mib_2, Bits, Gauge32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "Counter32", "Integer32", "mib-2", "Bits", "Gauge32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
TextualConvention, RowPointer, RowStatus, AutonomousType, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "RowStatus", "AutonomousType", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceResets=scsiDeviceResets, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiInstAlias=scsiInstAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiTransportFCP=scsiTransportFCP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiPortRole=scsiPortRole, ScsiIndexValue=ScsiIndexValue, ScsiName=ScsiName, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatus=scsiLuStatus, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapGroup=scsiLunMapGroup, scsiTranportOther=scsiTranportOther, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGeneral=scsiGeneral, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptType=scsiTrnsptType, scsiConformance=scsiConformance, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetGroup=scsiTargetGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuVendorId=scsiLuVendorId, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiLuIdEntry=scsiLuIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliance=scsiCompliance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiTgtPortName=scsiTgtPortName, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliances=scsiCompliances, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiModule=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, scsiLuEntry=scsiLuEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotifications=scsiNotifications, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuProductId=scsiLuProductId, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiGroups=scsiGroups, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportSBP=scsiTransportSBP, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdentifier=ScsiIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdTable=scsiLuIdTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
