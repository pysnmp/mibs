...
MibIdentifier, Gauge32, NotificationType, IpAddress, ObjectIdentity, Counter32, Integer32, iso, Unsigned32, Counter64, mib_2, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress", "ObjectIdentity", "Counter32", "Integer32", "iso", "Unsigned32", "Counter64", "mib-2", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
TruthValue, TimeStamp, DisplayString, TextualConvention, RowStatus, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, PYSNMP_MODULE_ID=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSRP=scsiTransportSRP, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportTypes=scsiTransportTypes, ScsiName=ScsiName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunTable=scsiDscLunTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuStatus=scsiLuStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiInstAlias=scsiInstAlias, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuProductId=scsiLuProductId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceRole=scsiDeviceRole, scsiDscTgtName=scsiDscTgtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiDscTgtTable=scsiDscTgtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiRemoteTarget=scsiRemoteTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapGroup=scsiLunMapGroup, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortName=scsiTgtPortName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrName=scsiAuthIntrName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunLun=scsiDscLunLun, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, scsiIntrDevTable=scsiIntrDevTable, scsiLuInResets=scsiLuInResets, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, ScsiIdValue=ScsiIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGeneral=scsiGeneral, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInCommands=scsiLuInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiInstIndex=scsiInstIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiator=scsiInitiator, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiCompliances=scsiCompliances, scsiConformance=scsiConformance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets)
