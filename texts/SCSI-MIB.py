...
Counter64, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, NotificationType, Bits, ModuleIdentity, TimeTicks, IpAddress, Integer32, Counter32, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "NotificationType", "Bits", "ModuleIdentity", "TimeTicks", "IpAddress", "Integer32", "Counter32", "mib-2", "Gauge32")
RowPointer, TextualConvention, TimeStamp, RowStatus, TruthValue, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TimeStamp", "RowStatus", "TruthValue", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapEntry=scsiLunMapEntry, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunLun=scsiDscLunLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLuIdValue=scsiLuIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiModule=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceTable=scsiDeviceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortTable=scsiTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValue=ScsiIndexValue, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportOther=scsiTranportOther, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunTable=scsiDscLunTable, scsiCompliance=scsiCompliance, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuHSInCommands=scsiLuHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdValue=ScsiIdValue, scsiPortEntry=scsiPortEntry, scsiPortRole=scsiPortRole, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiLuEntry=scsiLuEntry, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportSBP=scsiTransportSBP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapLun=scsiLunMapLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstIndex=scsiInstIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiConformance=scsiConformance, scsiLuStatus=scsiLuStatus, scsiTargetGroup=scsiTargetGroup, scsiTransportISCSI=scsiTransportISCSI, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapTable=scsiLunMapTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceResets=scsiDeviceResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstAlias=scsiInstAlias, scsiObjects=scsiObjects, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiInitiator=scsiInitiator, scsiDeviceRole=scsiDeviceRole, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdentifier=ScsiIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInResets=scsiLuInResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortTable=scsiPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiLunMapIndex=scsiLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiGeneral=scsiGeneral, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdType=scsiLuIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtName=scsiDscTgtName, scsiDeviceEntry=scsiDeviceEntry)
