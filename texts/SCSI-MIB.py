...
Unsigned32, TimeTicks, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, MibIdentifier, IpAddress, NotificationType, iso, ObjectIdentity, Counter32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "MibIdentifier", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "Counter32", "Integer32", "Gauge32")
DisplayString, TimeStamp, TruthValue, AutonomousType, RowPointer, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "AutonomousType", "RowPointer", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdTable=scsiLuIdTable, scsiDeviceTable=scsiDeviceTable, scsiConformance=scsiConformance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIndex=scsiLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdValue=scsiLuIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdType=scsiLuIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortRole=scsiPortRole, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportTypes=scsiTransportTypes, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortTable=scsiPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuState=scsiLuState, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGroups=scsiGroups, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdEntry=scsiLuIdEntry, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTarget=scsiTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliance=scsiCompliance, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdType=ScsiIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliances=scsiCompliances, scsiTransportSRP=scsiTransportSRP, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiObjects=scsiObjects, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInResets=scsiLuInResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapIndex=scsiLunMapIndex, ScsiName=ScsiName, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotifications=scsiNotifications, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceRole=scsiDeviceRole, scsiLuWwnName=scsiLuWwnName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuStatus=scsiLuStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex)
