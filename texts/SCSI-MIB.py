...
IpAddress, mib_2, Integer32, ModuleIdentity, ObjectIdentity, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Counter64, Bits, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "mib-2", "Integer32", "ModuleIdentity", "ObjectIdentity", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Counter64", "Bits", "Unsigned32", "TimeTicks")
TimeStamp, RowPointer, TruthValue, TextualConvention, RowStatus, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIndex=scsiDscLunIndex, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSBP=scsiTransportSBP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuTable=scsiLuTable, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdEntry=scsiLuIdEntry, ScsiIdentifier=ScsiIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportSPI=scsiTranportSPI, ScsiIndexValue=ScsiIndexValue, scsiLuIdType=scsiLuIdType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortRole=scsiPortRole, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunLun=scsiDscLunLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliance=scsiCompliance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtName=scsiDscTgtName, scsiLuInResets=scsiLuInResets, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetGroup=scsiTargetGroup, ScsiIdValue=ScsiIdValue, scsiDeviceTable=scsiDeviceTable, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiPortIndex=scsiPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiLunMapLun=scsiLunMapLun, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceRole=scsiDeviceRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiObjects=scsiObjects, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiConformance=scsiConformance, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuEntry=scsiLuEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiNotifications=scsiNotifications, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiModule=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportOther=scsiTranportOther, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstanceTable=scsiInstanceTable, ScsiName=ScsiName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, scsiLuVendorId=scsiLuVendorId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIndex=scsiLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrIndex=scsiAuthIntrIndex)
