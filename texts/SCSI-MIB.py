...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, MibIdentifier, Unsigned32, NotificationType, Gauge32, Counter32, ModuleIdentity, IpAddress, Counter64, mib_2, ObjectIdentity, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "MibIdentifier", "Unsigned32", "NotificationType", "Gauge32", "Counter32", "ModuleIdentity", "IpAddress", "Counter64", "mib-2", "ObjectIdentity", "Integer32", "iso")
TruthValue, TextualConvention, AutonomousType, RowPointer, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "RowPointer", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortIndex=scsiPortIndex, scsiModule=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInResets=scsiLuInResets, scsiDeviceEntry=scsiDeviceEntry, scsiTransportFCP=scsiTransportFCP, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiLuWwnName=scsiLuWwnName, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportSPI=scsiTranportSPI, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiCompliance=scsiCompliance, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortEntry=scsiPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiCompliances=scsiCompliances, scsiPortTable=scsiPortTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdType=scsiLuIdType, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunEntry=scsiDscLunEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiator=scsiInitiator, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiLuInCommands=scsiLuInCommands, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuVendorId=scsiLuVendorId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiConformance=scsiConformance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiPortRole=scsiPortRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceTable=scsiInstanceTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTarget=scsiTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGroups=scsiGroups, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiNotifications=scsiNotifications, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName)
