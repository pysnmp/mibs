...
Bits, Counter64, Counter32, iso, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Counter32", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "NotificationType")
RowStatus, DisplayString, TimeStamp, RowPointer, TruthValue, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "RowPointer", "TruthValue", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtTable=scsiDscTgtTable, scsiTransportFCP=scsiTransportFCP, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIndex=scsiLuIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, ScsiIdValue=ScsiIdValue, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiLuTable=scsiLuTable, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstIndex=scsiInstIndex, ScsiName=ScsiName, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportTypes=scsiTransportTypes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiGroups=scsiGroups, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSBP=scsiTransportSBP, scsiLuState=scsiLuState, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortRole=scsiPortRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceTable=scsiDeviceTable, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiPortTable=scsiPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceRole=scsiDeviceRole, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortIndex=scsiPortIndex, scsiLuIdType=scsiLuIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, scsiTgtPortName=scsiTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdentifier=ScsiIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunLun=scsiDscLunLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiModule=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIndexValue=ScsiIndexValue, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiConformance=scsiConformance, ScsiIdType=ScsiIdType, scsiObjects=scsiObjects, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiNotifications=scsiNotifications, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliances=scsiCompliances, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTarget=scsiTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceTable=scsiInstanceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance)
