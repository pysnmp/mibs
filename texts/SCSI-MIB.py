...
Unsigned32, Integer32, Counter32, mib_2, ObjectIdentity, NotificationType, iso, MibIdentifier, Bits, IpAddress, ModuleIdentity, TimeTicks, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Counter32", "mib-2", "ObjectIdentity", "NotificationType", "iso", "MibIdentifier", "Bits", "IpAddress", "ModuleIdentity", "TimeTicks", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, RowPointer, TruthValue, TimeStamp, DisplayString, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TruthValue", "TimeStamp", "DisplayString", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapTable=scsiLunMapTable, scsiDeviceTable=scsiDeviceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiConformance=scsiConformance, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIndex=scsiLuIndex, scsiTransportSBP=scsiTransportSBP, scsiInstIndex=scsiInstIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTarget=scsiTarget, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdType=scsiLuIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiDeviceResets=scsiDeviceResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTranportSPI=scsiTranportSPI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValue=ScsiIndexValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiGroups=scsiGroups, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtName=scsiDscTgtName, scsiLuProductId=scsiLuProductId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortIndex=scsiPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortEntry=scsiPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuTable=scsiLuTable, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiModule=scsiModule, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdAssociation=ScsiIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiNotifications=scsiNotifications, ScsiName=ScsiName, ScsiIdValue=ScsiIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuState=scsiLuState, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortName=scsiTgtPortName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes)
