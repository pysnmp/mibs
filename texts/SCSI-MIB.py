...
TimeTicks, mib_2, iso, Counter64, MibIdentifier, ObjectIdentity, ModuleIdentity, Integer32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "iso", "Counter64", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Bits", "IpAddress")
DisplayString, TimeStamp, RowStatus, RowPointer, AutonomousType, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "RowPointer", "AutonomousType", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiModule=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceAlias=scsiDeviceAlias, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiName=ScsiName, scsiLuState=scsiLuState, scsiRemoteTarget=scsiRemoteTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdValue=scsiLuIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotifications=scsiNotifications, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLun=scsiLunMapLun, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortEntry=scsiPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiConformance=scsiConformance, scsiTransportTypes=scsiTransportTypes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdIndex=scsiLuIdIndex, ScsiIdType=ScsiIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortName=scsiTgtPortName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiDeviceGroup=scsiDeviceGroup, scsiLuProductId=scsiLuProductId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiInstAlias=scsiInstAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortIndex=scsiPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiObjects=scsiObjects, scsiCompliance=scsiCompliance, scsiInitiator=scsiInitiator, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiCompliances=scsiCompliances, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdAssociation=ScsiIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdTable=scsiLuIdTable, scsiLuWwnName=scsiLuWwnName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtName=scsiIntrPrtName, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuTable=scsiLuTable, scsiGeneral=scsiGeneral, scsiPortRole=scsiPortRole, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceResets=scsiDeviceResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportSPI=scsiTranportSPI, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuVendorId=scsiLuVendorId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdType=scsiLuIdType, scsiDeviceRole=scsiDeviceRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatus=scsiLuStatus, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdValue=ScsiIdValue, scsiDscLunLun=scsiDscLunLun, scsiTranportOther=scsiTranportOther, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunTable=scsiDscLunTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
