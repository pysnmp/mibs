...
NotificationType, Counter64, iso, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, mib_2, IpAddress, ModuleIdentity, Integer32, Counter32, Bits, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "iso", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "mib-2", "IpAddress", "ModuleIdentity", "Integer32", "Counter32", "Bits", "MibIdentifier", "Unsigned32")
DisplayString, RowStatus, AutonomousType, TruthValue, RowPointer, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "RowPointer", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportOther=scsiTranportOther, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiDeviceGroup=scsiDeviceGroup, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiDscLunTable=scsiDscLunTable, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuState=scsiLuState, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiPortTable=scsiPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuProductId=scsiLuProductId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatus=scsiLuStatus, ScsiIdValue=ScsiIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapTable=scsiLunMapTable, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceTable=scsiInstanceTable, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiLunMapGroup=scsiLunMapGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortName=scsiTgtPortName, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiModule=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiPortIndex=scsiPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuVendorId=scsiLuVendorId, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortRole=scsiPortRole, scsiConformance=scsiConformance, scsiPortEntry=scsiPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInResets=scsiLuInResets, ScsiLUNOrZero=ScsiLUNOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiCompliance=scsiCompliance, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiDeviceEntry=scsiDeviceEntry, ScsiIdType=ScsiIdType, scsiDeviceIndex=scsiDeviceIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetGroup=scsiTargetGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTarget=scsiTarget, scsiLuIdTable=scsiLuIdTable, scsiLuTable=scsiLuTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceResets=scsiDeviceResets, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotifications=scsiNotifications, scsiLunMapLun=scsiLunMapLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIndex=scsiLuIndex, scsiTransportSBP=scsiTransportSBP, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiGroups=scsiGroups)
