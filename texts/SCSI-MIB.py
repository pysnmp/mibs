...
Counter32, Counter64, MibIdentifier, Unsigned32, TimeTicks, iso, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Gauge32, Bits, Integer32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "MibIdentifier", "Unsigned32", "TimeTicks", "iso", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Gauge32", "Bits", "Integer32", "ModuleIdentity", "IpAddress")
RowPointer, TimeStamp, DisplayString, AutonomousType, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "AutonomousType", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdValue=scsiLuIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInCommands=scsiLuInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIndex=scsiDscLunIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportSPI=scsiTranportSPI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuTable=scsiLuTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportTypes=scsiTransportTypes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiInitiator=scsiInitiator, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIndex=scsiLuIndex, scsiDeviceTable=scsiDeviceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, ScsiIdentifier=ScsiIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapTable=scsiLunMapTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtName=scsiIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiConformance=scsiConformance, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiName=ScsiName, scsiTarget=scsiTarget, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiCompliance=scsiCompliance, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiDscTgtConfigured=scsiDscTgtConfigured, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, scsiPortEntry=scsiPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTable=scsiPortTable, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiPortRole=scsiPortRole, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceTable=scsiInstanceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortIndex=scsiPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuState=scsiLuState, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetGroup=scsiTargetGroup, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiCompliances=scsiCompliances, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdType=ScsiIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInResets=scsiLuInResets, scsiModule=scsiModule, scsiGroups=scsiGroups, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuProductId=scsiLuProductId, scsiLuWwnName=scsiLuWwnName)
