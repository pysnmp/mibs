...
IpAddress, Gauge32, Bits, MibIdentifier, Unsigned32, mib_2, TimeTicks, iso, ObjectIdentity, Counter32, ModuleIdentity, Integer32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "mib-2", "TimeTicks", "iso", "ObjectIdentity", "Counter32", "ModuleIdentity", "Integer32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, AutonomousType, TextualConvention, DisplayString, TruthValue, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "DisplayString", "TruthValue", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstAlias=scsiInstAlias, scsiInstanceTable=scsiInstanceTable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiModule=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiTransportTypes=scsiTransportTypes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuTable=scsiLuTable, scsiPortRole=scsiPortRole, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceRole=scsiDeviceRole, scsiLuStatus=scsiLuStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiObjects=scsiObjects, ScsiName=ScsiName, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiator=scsiInitiator, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiPortIndex=scsiPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGroups=scsiGroups, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunLun=scsiDscLunLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuState=scsiLuState, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTable=scsiPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdCodeSet=scsiLuIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiNotifications=scsiNotifications, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGeneral=scsiGeneral, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliances=scsiCompliances, scsiTarget=scsiTarget, scsiDeviceEntry=scsiDeviceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuEntry=scsiLuEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiLuVendorId=scsiLuVendorId, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdType=scsiLuIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetGroup=scsiTargetGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceTable=scsiDeviceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIndex=scsiLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTranportOther=scsiTranportOther, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes)
