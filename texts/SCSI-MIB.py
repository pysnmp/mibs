...
Integer32, Gauge32, Counter32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64, NotificationType, ObjectIdentity, ModuleIdentity, iso, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64", "NotificationType", "ObjectIdentity", "ModuleIdentity", "iso", "mib-2", "TimeTicks")
RowStatus, AutonomousType, TextualConvention, TruthValue, TimeStamp, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuVendorId=scsiLuVendorId, scsiDscLunTable=scsiDscLunTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdType=scsiDscLunIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdType=ScsiIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTable=scsiIntrDevTable, scsiLuState=scsiLuState, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiAuthIntrName=scsiAuthIntrName, scsiLuInCommands=scsiLuInCommands, scsiPortTable=scsiPortTable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuTable=scsiLuTable, scsiDeviceAlias=scsiDeviceAlias, scsiObjects=scsiObjects, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortEntry=scsiPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiConformance=scsiConformance, scsiPortIndex=scsiPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiGeneral=scsiGeneral, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptType=scsiTrnsptType, scsiCompliances=scsiCompliances, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportTypes=scsiTransportTypes, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptTable=scsiTrnsptTable, scsiTarget=scsiTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportISCSI=scsiTransportISCSI, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtName=scsiDscTgtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdValue=ScsiIdValue, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSRP=scsiTransportSRP, scsiTgtPortName=scsiTgtPortName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable)
