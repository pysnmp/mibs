...
Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Gauge32, Counter32, ModuleIdentity, Integer32, Counter64, TimeTicks, NotificationType, mib_2, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "Integer32", "Counter64", "TimeTicks", "NotificationType", "mib-2", "MibIdentifier", "Bits")
TruthValue, TextualConvention, AutonomousType, DisplayString, TimeStamp, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "TimeStamp", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, ScsiIdType=ScsiIdType, scsiInstIndex=scsiInstIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, scsiLunMapLun=scsiLunMapLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiLuInCommands=scsiLuInCommands, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiPortEntry=scsiPortEntry, scsiDeviceResets=scsiDeviceResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWwnName=scsiLuWwnName, scsiLuProductId=scsiLuProductId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortName=scsiTgtPortName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiator=scsiInitiator, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiName=ScsiName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotifications=scsiNotifications, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiDeviceTable=scsiDeviceTable, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInResets=scsiLuInResets, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiGeneral=scsiGeneral, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiConformance=scsiConformance, scsiLuVendorId=scsiLuVendorId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdValue=ScsiIdValue, scsiLuEntry=scsiLuEntry, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunLun=scsiDscLunLun, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevTable=scsiTgtDevTable, scsiTargetGroup=scsiTargetGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstAlias=scsiInstAlias, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiLuIdEntry=scsiLuIdEntry, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiObjects=scsiObjects, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdTable=scsiLuIdTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
