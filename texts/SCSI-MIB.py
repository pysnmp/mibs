...
Gauge32, NotificationType, iso, Bits, Integer32, mib_2, ObjectIdentity, IpAddress, MibIdentifier, Counter32, ModuleIdentity, TimeTicks, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "iso", "Bits", "Integer32", "mib-2", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter32", "ModuleIdentity", "TimeTicks", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, DisplayString, AutonomousType, TruthValue, RowStatus, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "AutonomousType", "TruthValue", "RowStatus", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstAlias=scsiInstAlias, scsiInitiator=scsiInitiator, scsiPortEntry=scsiPortEntry, scsiPortIndex=scsiPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptPointer=scsiTrnsptPointer, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdentifier=ScsiIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiLuTable=scsiLuTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiCompliances=scsiCompliances, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiModule=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdType=scsiLuIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiName=ScsiName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, ScsiIdValue=ScsiIdValue, scsiTrnsptType=scsiTrnsptType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportFCP=scsiTransportFCP, scsiLuWwnName=scsiLuWwnName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortTable=scsiPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuEntry=scsiLuEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportTypes=scsiTransportTypes, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapTable=scsiLunMapTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuProductId=scsiLuProductId, scsiConformance=scsiConformance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIndex=scsiLuIndex, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportOther=scsiTranportOther, scsiCompliance=scsiCompliance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceRole=scsiDeviceRole, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdType=ScsiIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuState=scsiLuState, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtTable=scsiDscTgtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotifications=scsiNotifications, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtName=scsiDscTgtName)
