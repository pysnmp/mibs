...
Gauge32, Counter64, NotificationType, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, iso, ModuleIdentity, TimeTicks, IpAddress, mib_2, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "NotificationType", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "IpAddress", "mib-2", "Counter32", "MibIdentifier")
DisplayString, TextualConvention, AutonomousType, TruthValue, RowStatus, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue", "RowStatus", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiLuStatus=scsiLuStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiModule=scsiModule, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportISCSI=scsiTransportISCSI, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetGroup=scsiTargetGroup, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdType=scsiLuIdType, scsiLunMapIndex=scsiLunMapIndex, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdEntry=scsiLuIdEntry, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSBP=scsiTransportSBP, scsiPortRole=scsiPortRole, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortName=scsiTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiGeneral=scsiGeneral, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteInitiators=scsiRemoteInitiators, scsiObjects=scsiObjects, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceTable=scsiInstanceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortEntry=scsiTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuVendorId=scsiLuVendorId, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuState=scsiLuState, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiName=ScsiName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdTable=scsiLuIdTable, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiConformance=scsiConformance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportOther=scsiTranportOther, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapTable=scsiLunMapTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiCompliances=scsiCompliances, scsiInstIndex=scsiInstIndex, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSRP=scsiTransportSRP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIndex=scsiLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiator=scsiInitiator, scsiAuthIntrIndex=scsiAuthIntrIndex)
