...
iso, MibIdentifier, Unsigned32, NotificationType, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, ObjectIdentity, IpAddress, TimeTicks, ModuleIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Unsigned32", "NotificationType", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "ObjectIdentity", "IpAddress", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter64")
TruthValue, RowStatus, TimeStamp, RowPointer, AutonomousType, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortName=scsiTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTarget=scsiTarget, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiTransportSRP=scsiTransportSRP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSBP=scsiTransportSBP, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortRole=scsiPortRole, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportSPI=scsiTranportSPI, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGroups=scsiGroups, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliance=scsiCompliance, scsiInitiator=scsiInitiator, scsiLuInResets=scsiLuInResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtName=scsiDscTgtName, scsiInstIndex=scsiInstIndex, scsiDeviceResets=scsiDeviceResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiGeneral=scsiGeneral, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapGroup=scsiLunMapGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportOther=scsiTranportOther, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliances=scsiCompliances, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdIndex=scsiLuIdIndex, scsiPortEntry=scsiPortEntry, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuVendorId=scsiLuVendorId, scsiConformance=scsiConformance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuEntry=scsiLuEntry, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValue=ScsiIndexValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuTable=scsiLuTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdType=ScsiIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiName=ScsiName, scsiRemoteTarget=scsiRemoteTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuState=scsiLuState, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuProductId=scsiLuProductId, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortIndex=scsiPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiLuIndex=scsiLuIndex, scsiModule=scsiModule, scsiLuStatus=scsiLuStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry)
