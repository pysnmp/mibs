...
mib_2, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType, TimeTicks, Bits, MibIdentifier, Counter32, Counter64, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType", "TimeTicks", "Bits", "MibIdentifier", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32")
TruthValue, RowStatus, TimeStamp, RowPointer, TextualConvention, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "RowPointer", "TextualConvention", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceResets=scsiDeviceResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevEntry=scsiIntrDevEntry, ScsiName=ScsiName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiDeviceTable=scsiDeviceTable, PYSNMP_MODULE_ID=scsiModule, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiator=scsiInitiator, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliances=scsiCompliances, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiLuVendorId=scsiLuVendorId, scsiInstAlias=scsiInstAlias, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiGroups=scsiGroups, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetGroup=scsiTargetGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGeneral=scsiGeneral, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuTable=scsiLuTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortIndex=scsiPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevTable=scsiTgtDevTable, scsiConformance=scsiConformance, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapTable=scsiLunMapTable, scsiLuIdType=scsiLuIdType, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdentifier=ScsiIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiInstIndex=scsiInstIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, ScsiIndexValue=ScsiIndexValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIndex=scsiLuIndex, scsiTarget=scsiTarget, scsiCompliance=scsiCompliance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName)
