...
ObjectIdentity, Counter32, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Bits, NotificationType, Integer32, IpAddress, TimeTicks, MibIdentifier, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Bits", "NotificationType", "Integer32", "IpAddress", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32")
TruthValue, DisplayString, RowStatus, AutonomousType, TimeStamp, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "AutonomousType", "TimeStamp", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiDeviceResets=scsiDeviceResets, ScsiName=ScsiName, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiTransportFCP=scsiTransportFCP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapIndex=scsiLunMapIndex, ScsiIdValue=ScsiIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiDscLunIndex=scsiDscLunIndex, scsiCompliances=scsiCompliances, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortName=scsiTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunLun=scsiDscLunLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuTable=scsiLuTable, scsiLuInCommands=scsiLuInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceRole=scsiDeviceRole, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiObjects=scsiObjects, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIndex=scsiLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuVendorId=scsiLuVendorId, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevTable=scsiTgtDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdType=scsiLuIdType, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdentifier=ScsiIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuInResets=scsiLuInResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuEntry=scsiLuEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLun=scsiLunMapLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiGroups=scsiGroups, scsiTranportOther=scsiTranportOther, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetGroup=scsiTargetGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuPeripheralType=scsiLuPeripheralType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiNotifications=scsiNotifications, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdAssociation=ScsiIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceTable=scsiDeviceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstIndex=scsiInstIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliance=scsiCompliance, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortRole=scsiPortRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiModule=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuStatus=scsiLuStatus, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes)
