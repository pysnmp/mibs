...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, iso, IpAddress, Integer32, NotificationType, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, Unsigned32, Bits, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "iso", "IpAddress", "Integer32", "NotificationType", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "MibIdentifier")
TextualConvention, DisplayString, RowStatus, AutonomousType, RowPointer, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiTrnsptType=scsiTrnsptType, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiCompliances=scsiCompliances, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtName=scsiDscTgtName, ScsiIdentifier=ScsiIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiLuEntry=scsiLuEntry, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportSPI=scsiTranportSPI, scsiLuStatus=scsiLuStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportFCP=scsiTransportFCP, scsiDscLunEntry=scsiDscLunEntry, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevTable=scsiTgtDevTable, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportOther=scsiTranportOther, scsiLuHSInCommands=scsiLuHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiLuIdValue=scsiLuIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiObjects=scsiObjects, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuTable=scsiLuTable, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTarget=scsiTarget, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValue=ScsiIndexValue, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdTable=scsiLuIdTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceEntry=scsiInstanceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceRole=scsiDeviceRole, scsiCompliance=scsiCompliance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiPortRole=scsiPortRole, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdValue=ScsiIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceResets=scsiDeviceResets, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortEntry=scsiPortEntry, scsiInstanceTable=scsiInstanceTable, scsiLuStatusChanged=scsiLuStatusChanged, PYSNMP_MODULE_ID=scsiModule, scsiLuInCommands=scsiLuInCommands, scsiTrnsptDevName=scsiTrnsptDevName)
