...
ObjectIdentity, IpAddress, Gauge32, ModuleIdentity, Bits, mib_2, TimeTicks, iso, NotificationType, Counter64, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Gauge32", "ModuleIdentity", "Bits", "mib-2", "TimeTicks", "iso", "NotificationType", "Counter64", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
RowStatus, TextualConvention, TruthValue, AutonomousType, DisplayString, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TruthValue", "AutonomousType", "DisplayString", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIndex=scsiLuIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLuEntry=scsiLuEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiInstIndex=scsiInstIndex, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotifications=scsiNotifications, scsiLuInResets=scsiLuInResets, scsiLuTable=scsiLuTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdValue=ScsiIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliance=scsiCompliance, scsiPortRole=scsiPortRole, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortIndex=scsiPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiTransportTypes=scsiTransportTypes, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceResets=scsiDeviceResets, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdType=scsiLuIdType, scsiLunMapIndex=scsiLunMapIndex, scsiPortEntry=scsiPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdType=ScsiIdType, scsiInitiator=scsiInitiator, scsiRemoteTarget=scsiRemoteTarget, scsiTarget=scsiTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunLun=scsiDscLunLun, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceEntry=scsiInstanceEntry, scsiTransportSBP=scsiTransportSBP, scsiLuStatus=scsiLuStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtName=scsiDscTgtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiCompliances=scsiCompliances, scsiDeviceRole=scsiDeviceRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiObjects=scsiObjects, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportOther=scsiTranportOther, scsiTransportFCP=scsiTransportFCP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuState=scsiLuState, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunTable=scsiDscLunTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstanceTable=scsiInstanceTable, scsiInstVendorVersion=scsiInstVendorVersion)
