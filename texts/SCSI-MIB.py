...
MibIdentifier, mib_2, Counter64, NotificationType, TimeTicks, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "Counter64", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "Counter32")
TimeStamp, RowPointer, DisplayString, AutonomousType, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "DisplayString", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdValue=scsiLuIdValue, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapTable=scsiLunMapTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatus=scsiLuStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdValue=ScsiIdValue, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiModule=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiGeneral=scsiGeneral, scsiTransportISCSI=scsiTransportISCSI, scsiTranportOther=scsiTranportOther, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuEntry=scsiLuEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortEntry=scsiTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLuTable=scsiLuTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiNotifications=scsiNotifications, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliance=scsiCompliance, scsiLunMapLun=scsiLunMapLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiPortRole=scsiPortRole, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortTable=scsiPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliances=scsiCompliances, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceTable=scsiDeviceTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTarget=scsiTarget, scsiTransportFCP=scsiTransportFCP, scsiTranportSPI=scsiTranportSPI, scsiInstAlias=scsiInstAlias, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdType=ScsiIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstIndex=scsiInstIndex, scsiLuIdEntry=scsiLuIdEntry)
