...
mib_2, Counter64, ObjectIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, TimeTicks, Counter32, Bits, Integer32, MibIdentifier, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "ObjectIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter32", "Bits", "Integer32", "MibIdentifier", "IpAddress", "Unsigned32")
DisplayString, TruthValue, TimeStamp, RowStatus, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiConformance=scsiConformance, scsiDscLunTable=scsiDscLunTable, scsiInstAlias=scsiInstAlias, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtName=scsiDscTgtName, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapLun=scsiLunMapLun, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdValue=ScsiIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortName=scsiTgtPortName, scsiModule=scsiModule, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceAlias=scsiDeviceAlias, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuVendorId=scsiLuVendorId, scsiLuProductId=scsiLuProductId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdEntry=scsiLuIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiTranportSPI=scsiTranportSPI, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIndexValue=ScsiIndexValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuInResets=scsiLuInResets, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceRole=scsiDeviceRole, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiName=ScsiName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportFCP=scsiTransportFCP, scsiLuInCommands=scsiLuInCommands, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiCompliances=scsiCompliances, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuRevisionId=scsiLuRevisionId, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuState=scsiLuState, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTarget=scsiTarget, scsiDeviceResets=scsiDeviceResets, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiGeneral=scsiGeneral, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotifications=scsiNotifications, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSRP=scsiTransportSRP, scsiTranportOther=scsiTranportOther, scsiRemoteTarget=scsiRemoteTarget, scsiPortIndex=scsiPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiGroups=scsiGroups, scsiLunMapGroup=scsiLunMapGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes)
