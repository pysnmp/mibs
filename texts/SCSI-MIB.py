...
Integer32, mib_2, Unsigned32, Bits, TimeTicks, IpAddress, Counter32, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "Counter32", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType")
RowStatus, TimeStamp, RowPointer, TextualConvention, DisplayString, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "RowPointer", "TextualConvention", "DisplayString", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceRole=scsiDeviceRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuTable=scsiLuTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapLun=scsiLunMapLun, ScsiIdType=ScsiIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdType=scsiLuIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortIndex=scsiPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuInResets=scsiLuInResets, scsiAuthIntrName=scsiAuthIntrName, scsiConformance=scsiConformance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunLun=scsiDscLunLun, scsiDscLunEntry=scsiDscLunEntry, scsiNotifications=scsiNotifications, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiator=scsiInitiator, scsiPortTable=scsiPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTarget=scsiTarget, scsiLuIdIndex=scsiLuIdIndex, scsiLuVendorId=scsiLuVendorId, scsiObjects=scsiObjects, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdValue=scsiLuIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceTable=scsiDeviceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuProductId=scsiLuProductId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortRole=scsiPortRole, scsiGeneral=scsiGeneral, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceTable=scsiInstanceTable, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatus=scsiLuStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuWwnName=scsiLuWwnName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, scsiCompliances=scsiCompliances, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuState=scsiLuState, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiModule=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuEntry=scsiLuEntry, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiName=ScsiName, scsiLuIdAssociation=scsiLuIdAssociation)
