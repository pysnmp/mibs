...
Bits, Gauge32, IpAddress, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Unsigned32, MibIdentifier, NotificationType, ObjectIdentity, mib_2, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "IpAddress", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Unsigned32", "MibIdentifier", "NotificationType", "ObjectIdentity", "mib-2", "Counter32", "iso")
AutonomousType, TruthValue, TextualConvention, RowPointer, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TextualConvention", "RowPointer", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiModule=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiTarget=scsiTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdTable=scsiDscLunIdTable, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapLun=scsiLunMapLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiTargetGroup=scsiTargetGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdType=scsiLuIdType, scsiGroups=scsiGroups, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGeneral=scsiGeneral, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiLuState=scsiLuState, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortIndex=scsiPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortEntry=scsiPortEntry, ScsiIdType=ScsiIdType, ScsiIdValue=ScsiIdValue, scsiObjects=scsiObjects, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdType=scsiDscLunIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportSBP=scsiTransportSBP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuEntry=scsiLuEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIndex=scsiDscLunIndex, scsiPortRole=scsiPortRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInCommands=scsiLuInCommands, scsiLuStatus=scsiLuStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceResets=scsiDeviceResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdTable=scsiLuIdTable, scsiLuIdEntry=scsiLuIdEntry, scsiInitiator=scsiInitiator, scsiLunMapTable=scsiLunMapTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier)
