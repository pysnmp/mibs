...
TimeTicks, Counter64, ObjectIdentity, ModuleIdentity, Bits, MibIdentifier, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, Counter32, Gauge32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ObjectIdentity", "ModuleIdentity", "Bits", "MibIdentifier", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "Counter32", "Gauge32", "IpAddress", "Integer32")
AutonomousType, TextualConvention, DisplayString, TruthValue, RowPointer, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "DisplayString", "TruthValue", "RowPointer", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortIndex=scsiPortIndex, scsiInitiator=scsiInitiator, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, ScsiName=ScsiName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, ScsiIdType=ScsiIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortEntry=scsiPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, ScsiIdentifier=ScsiIdentifier, scsiObjects=scsiObjects, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTransportISCSI=scsiTransportISCSI, scsiLuInResets=scsiLuInResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLuProductId=scsiLuProductId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiInstAlias=scsiInstAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiTransportSBP=scsiTransportSBP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatus=scsiLuStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapEntry=scsiLunMapEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdType=scsiDscLunIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptEntry=scsiTrnsptEntry, PYSNMP_MODULE_ID=scsiModule, scsiPortRole=scsiPortRole, scsiAuthIntrName=scsiAuthIntrName, scsiTransportFCP=scsiTransportFCP, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapTable=scsiLunMapTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceAlias=scsiDeviceAlias, scsiRemoteTarget=scsiRemoteTarget, scsiInstIndex=scsiInstIndex, scsiCompliance=scsiCompliance, scsiLunMapLun=scsiLunMapLun, scsiLuWwnName=scsiLuWwnName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportOther=scsiTranportOther, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIndex=scsiLuIndex, scsiCompliances=scsiCompliances, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiGroups=scsiGroups, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotifications=scsiNotifications, ScsiIdValue=ScsiIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceRole=scsiDeviceRole, scsiDscLunTable=scsiDscLunTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportTypes=scsiTransportTypes, scsiPortTable=scsiPortTable)
