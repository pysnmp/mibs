...
Unsigned32, NotificationType, mib_2, iso, ModuleIdentity, Integer32, Gauge32, IpAddress, MibIdentifier, ObjectIdentity, Bits, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "mib-2", "iso", "ModuleIdentity", "Integer32", "Gauge32", "IpAddress", "MibIdentifier", "ObjectIdentity", "Bits", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, RowPointer, DisplayString, RowStatus, TimeStamp, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "DisplayString", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuInResets=scsiLuInResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliances=scsiCompliances, scsiLuState=scsiLuState, scsiConformance=scsiConformance, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunTable=scsiDscLunTable, scsiTgtPortTable=scsiTgtPortTable, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiGeneral=scsiGeneral, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdType=ScsiIdType, scsiDscTgtName=scsiDscTgtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapTable=scsiLunMapTable, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstIndex=scsiInstIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGroups=scsiGroups, scsiTarget=scsiTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuProductId=scsiLuProductId, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiPortRole=scsiPortRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWwnName=scsiLuWwnName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, PYSNMP_MODULE_ID=scsiModule, ScsiIdValue=ScsiIdValue, scsiInitiator=scsiInitiator, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptType=scsiTrnsptType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrName=scsiAuthIntrName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuVendorId=scsiLuVendorId, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuRevisionId=scsiLuRevisionId, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, scsiPortTable=scsiPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiTgtDevTable=scsiTgtDevTable, scsiLuTable=scsiLuTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiModule=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTranportOther=scsiTranportOther, scsiDscLunLun=scsiDscLunLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuEntry=scsiLuEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortIndex=scsiPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
