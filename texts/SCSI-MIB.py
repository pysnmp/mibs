...
IpAddress, Gauge32, mib_2, ModuleIdentity, MibIdentifier, Integer32, Bits, iso, Unsigned32, TimeTicks, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "mib-2", "ModuleIdentity", "MibIdentifier", "Integer32", "Bits", "iso", "Unsigned32", "TimeTicks", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType")
DisplayString, TruthValue, RowStatus, AutonomousType, RowPointer, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "AutonomousType", "RowPointer", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiDscTgtName=scsiDscTgtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortRole=scsiPortRole, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiLuInResets=scsiLuInResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiObjects=scsiObjects, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiTranportOther=scsiTranportOther, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortTable=scsiPortTable, scsiLuTable=scsiLuTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIndexValue=ScsiIndexValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiInitiator=scsiInitiator, scsiTransportSBP=scsiTransportSBP, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiName=ScsiName, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiLuEntry=scsiLuEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuState=scsiLuState, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortName=scsiTgtPortName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSRP=scsiTransportSRP, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatus=scsiLuStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunLun=scsiDscLunLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptType=scsiTrnsptType, scsiDeviceRole=scsiDeviceRole, scsiDscLunTable=scsiDscLunTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInCommands=scsiLuInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIndex=scsiLuIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGroups=scsiGroups, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWwnName=scsiLuWwnName, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortIndex=scsiPortIndex, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtId=scsiAttIntrPrtId)
