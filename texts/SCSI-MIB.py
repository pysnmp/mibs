...
Bits, TimeTicks, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, mib_2, ObjectIdentity, IpAddress, Gauge32, Counter32, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "mib-2", "ObjectIdentity", "IpAddress", "Gauge32", "Counter32", "Integer32", "Unsigned32", "NotificationType")
TimeStamp, RowPointer, TruthValue, DisplayString, AutonomousType, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTarget=scsiTarget, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuEntry=scsiLuEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortTable=scsiPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdType=ScsiIdType, ScsiIdValue=ScsiIdValue, scsiLunMapTable=scsiLunMapTable, scsiLuIndex=scsiLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliance=scsiCompliance, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiGroups=scsiGroups, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiTrnsptTable=scsiTrnsptTable, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiObjects=scsiObjects, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiPortIndex=scsiPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInCommands=scsiLuInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiConformance=scsiConformance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrName=scsiAuthIntrName, scsiModule=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceResets=scsiDeviceResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuProductId=scsiLuProductId, scsiDeviceEntry=scsiDeviceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortName=scsiTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuTable=scsiLuTable, scsiTranportSPI=scsiTranportSPI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortEntry=scsiPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdValue=scsiLuIdValue, scsiLunMapIndex=scsiLunMapIndex, ScsiName=ScsiName, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiCompliances=scsiCompliances, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceAlias=scsiDeviceAlias)
