...
TimeTicks, Integer32, NotificationType, mib_2, Bits, Gauge32, ModuleIdentity, Counter64, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "mib-2", "Bits", "Gauge32", "ModuleIdentity", "Counter64", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ObjectIdentity", "MibIdentifier")
RowPointer, DisplayString, TimeStamp, AutonomousType, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TimeStamp", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetGroup=scsiTargetGroup, scsiLuProductId=scsiLuProductId, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptType=scsiTrnsptType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiConformance=scsiConformance, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliance=scsiCompliance, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuState=scsiLuState, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInResets=scsiLuInResets, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiRemoteTarget=scsiRemoteTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdType=scsiLuIdType, scsiTarget=scsiTarget, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiModule=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrName=scsiAuthIntrName, scsiPortTable=scsiPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstAlias=scsiInstAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceRole=scsiDeviceRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiGroups=scsiGroups, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportISCSI=scsiTransportISCSI, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGeneral=scsiGeneral, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, ScsiName=ScsiName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportTypes=scsiTransportTypes, scsiInstVendorVersion=scsiInstVendorVersion, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapTable=scsiLunMapTable, ScsiIndexValue=ScsiIndexValue, scsiPortEntry=scsiPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdValue=ScsiIdValue, scsiTgtPortName=scsiTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtName=scsiDscTgtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotifications=scsiNotifications, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortRole=scsiPortRole, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportOther=scsiTranportOther, ScsiIdType=ScsiIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliances=scsiCompliances, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiator=scsiInitiator, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuTable=scsiLuTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunLun=scsiDscLunLun, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtTable=scsiIntrPrtTable)
