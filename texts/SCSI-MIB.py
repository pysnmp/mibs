...
Gauge32, MibIdentifier, Bits, ObjectIdentity, Unsigned32, NotificationType, Counter32, iso, Integer32, ModuleIdentity, Counter64, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter32", "iso", "Integer32", "ModuleIdentity", "Counter64", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
RowStatus, AutonomousType, RowPointer, DisplayString, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "RowPointer", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIndex=scsiDscLunIndex, scsiLuIdType=scsiLuIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportSRP=scsiTransportSRP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiTarget=scsiTarget, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiNotifications=scsiNotifications, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportSBP=scsiTransportSBP, scsiLuInCommands=scsiLuInCommands, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuState=scsiLuState, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiCompliance=scsiCompliance, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatus=scsiLuStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiator=scsiInitiator, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWwnName=scsiLuWwnName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuEntry=scsiLuEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiName=ScsiName, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, scsiLuIdValue=scsiLuIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceTable=scsiDeviceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortRole=scsiPortRole, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiConformance=scsiConformance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiPortTable=scsiPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuProductId=scsiLuProductId, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportTypes=scsiTransportTypes, scsiLuIdIndex=scsiLuIdIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdentifier=ScsiIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, scsiDeviceResets=scsiDeviceResets, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiObjects=scsiObjects, scsiLuRevisionId=scsiLuRevisionId, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtTable=scsiDscTgtTable, ScsiIdType=ScsiIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion)
