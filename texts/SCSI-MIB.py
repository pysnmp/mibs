...
Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, mib_2, MibIdentifier, ModuleIdentity, Bits, IpAddress, Unsigned32, Integer32, Counter32, Counter64, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "mib-2", "MibIdentifier", "ModuleIdentity", "Bits", "IpAddress", "Unsigned32", "Integer32", "Counter32", "Counter64", "iso", "NotificationType")
RowStatus, DisplayString, TextualConvention, RowPointer, TruthValue, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TextualConvention", "RowPointer", "TruthValue", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiModule=scsiModule, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIndex=scsiLuIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTable=scsiPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdEntry=scsiLuIdEntry, scsiLuInResets=scsiLuInResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuEntry=scsiLuEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiConformance=scsiConformance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiTransportFCP=scsiTransportFCP, ScsiIdValue=ScsiIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortRole=scsiPortRole, scsiPortEntry=scsiPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, ScsiName=ScsiName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuState=scsiLuState, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSRP=scsiTransportSRP, scsiInitiator=scsiInitiator, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTarget=scsiTarget, scsiNotifications=scsiNotifications, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliance=scsiCompliance, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiPortIndex=scsiPortIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdentifier=ScsiIdentifier, scsiGeneral=scsiGeneral, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetGroup=scsiTargetGroup, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuTable=scsiLuTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuProductId=scsiLuProductId, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry)
