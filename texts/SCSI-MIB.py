...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Unsigned32, Counter32, mib_2, Bits, TimeTicks, IpAddress, Counter64, MibIdentifier, ObjectIdentity, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Unsigned32", "Counter32", "mib-2", "Bits", "TimeTicks", "IpAddress", "Counter64", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "NotificationType")
DisplayString, TruthValue, AutonomousType, TimeStamp, RowPointer, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "AutonomousType", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLuVendorId=scsiLuVendorId, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortTable=scsiPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, scsiLuIdValue=scsiLuIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatus=scsiLuStatus, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdType=scsiLuIdType, ScsiIndexValue=ScsiIndexValue, scsiCompliance=scsiCompliance, scsiDscLunIdValue=scsiDscLunIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiTgtPortTable=scsiTgtPortTable, scsiGeneral=scsiGeneral, scsiDscLunIdType=scsiDscLunIdType, ScsiIdentifier=ScsiIdentifier, scsiLuProductId=scsiLuProductId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, scsiLunMapIndex=scsiLunMapIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportOther=scsiTranportOther, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuState=scsiLuState, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWwnName=scsiLuWwnName, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiModule=scsiModule, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportTypes=scsiTransportTypes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInResets=scsiLuInResets, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuTable=scsiLuTable, ScsiNameIdOrZero=ScsiNameIdOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdValue=ScsiIdValue, scsiObjects=scsiObjects, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiNotifications=scsiNotifications, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapEntry=scsiLunMapEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiConformance=scsiConformance, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiator=scsiInitiator, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTarget=scsiTarget, scsiPortIndex=scsiPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetGroup=scsiTargetGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInCommands=scsiLuInCommands)
