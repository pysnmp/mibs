...
Counter64, Gauge32, Bits, IpAddress, Unsigned32, ObjectIdentity, TimeTicks, ModuleIdentity, NotificationType, Counter32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Bits", "IpAddress", "Unsigned32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "NotificationType", "Counter32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32")
AutonomousType, TruthValue, RowPointer, TextualConvention, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowPointer", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtName=scsiDscTgtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotifications=scsiNotifications, ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiGeneral=scsiGeneral, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortEntry=scsiPortEntry, scsiLuVendorId=scsiLuVendorId, scsiTranportOther=scsiTranportOther, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, ScsiIndexValue=ScsiIndexValue, scsiInitiator=scsiInitiator, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTarget=scsiTarget, scsiDeviceIndex=scsiDeviceIndex, scsiConformance=scsiConformance, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiLunMapTable=scsiLunMapTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunTable=scsiDscLunTable, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiInstIndex=scsiInstIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliance=scsiCompliance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportTypes=scsiTransportTypes, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportFCP=scsiTransportFCP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdTable=scsiLuIdTable, scsiModule=scsiModule, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptTable=scsiTrnsptTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuState=scsiLuState, scsiLuIdType=scsiLuIdType, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiName=ScsiName, scsiTgtDevTable=scsiTgtDevTable, scsiLuInResets=scsiLuInResets, scsiGroups=scsiGroups, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuTable=scsiLuTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortName=scsiTgtPortName)
