...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, NotificationType, Gauge32, Counter32, IpAddress, TimeTicks, mib_2, iso, Bits, Counter64, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "NotificationType", "Gauge32", "Counter32", "IpAddress", "TimeTicks", "mib-2", "iso", "Bits", "Counter64", "ObjectIdentity", "Unsigned32")
TruthValue, TextualConvention, AutonomousType, TimeStamp, RowPointer, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "RowPointer", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiModule=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTable=scsiPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiGroups=scsiGroups, scsiLuRevisionId=scsiLuRevisionId, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiLogicalUnit=scsiLogicalUnit, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValue=ScsiIndexValue, scsiLunMapTable=scsiLunMapTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceRole=scsiDeviceRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliance=scsiCompliance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotifications=scsiNotifications, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortRole=scsiPortRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiPortEntry=scsiPortEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuState=scsiLuState, scsiGeneral=scsiGeneral, scsiTransportISCSI=scsiTransportISCSI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunLun=scsiDscLunLun, ScsiName=ScsiName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInCommands=scsiLuInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliances=scsiCompliances, scsiDeviceTable=scsiDeviceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuEntry=scsiLuEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiator=scsiInitiator, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtName=scsiIntrPrtName, scsiConformance=scsiConformance, scsiTransportSRP=scsiTransportSRP, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatus=scsiLuStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiTargetGroup=scsiTargetGroup, scsiLuIdTable=scsiLuIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdentifier=ScsiIdentifier, scsiObjects=scsiObjects, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIndex=scsiLuIndex)
