...
Counter32, Counter64, TimeTicks, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Bits, IpAddress, MibIdentifier, NotificationType, Gauge32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "Gauge32", "Unsigned32", "ModuleIdentity")
DisplayString, AutonomousType, TruthValue, RowPointer, TimeStamp, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TruthValue", "RowPointer", "TimeStamp", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptType=scsiTrnsptType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuState=scsiLuState, scsiInstAlias=scsiInstAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiLuInResets=scsiLuInResets, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtTable=scsiDscTgtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiName=ScsiName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiDeviceIndex=scsiDeviceIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportFCP=scsiTransportFCP, scsiDeviceRole=scsiDeviceRole, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstIndex=scsiInstIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotifications=scsiNotifications, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortIndex=scsiPortIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdType=ScsiIdType, ScsiIndexValue=ScsiIndexValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSBP=scsiTransportSBP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, PYSNMP_MODULE_ID=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliance=scsiCompliance, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapIndex=scsiLunMapIndex, scsiInitiator=scsiInitiator, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuTable=scsiLuTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuProductId=scsiLuProductId, scsiDscLunTable=scsiDscLunTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportSPI=scsiTranportSPI, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdentifier=ScsiIdentifier, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiConformance=scsiConformance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstVendorVersion=scsiInstVendorVersion, scsiModule=scsiModule, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiObjects=scsiObjects, scsiCompliances=scsiCompliances, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLun=scsiLunMapLun, scsiPortTable=scsiPortTable, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun)
