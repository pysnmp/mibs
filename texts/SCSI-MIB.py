...
TimeTicks, Counter32, ModuleIdentity, Bits, NotificationType, IpAddress, Integer32, Counter64, MibIdentifier, ObjectIdentity, Gauge32, mib_2, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ModuleIdentity", "Bits", "NotificationType", "IpAddress", "Integer32", "Counter64", "MibIdentifier", "ObjectIdentity", "Gauge32", "mib-2", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, TruthValue, TextualConvention, RowPointer, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TextualConvention", "RowPointer", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortIndex=scsiPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiTgtPortName=scsiTgtPortName, scsiCompliances=scsiCompliances, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiTransportSBP=scsiTransportSBP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, ScsiName=ScsiName, scsiObjects=scsiObjects, scsiLuState=scsiLuState, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportOther=scsiTranportOther, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatus=scsiLuStatus, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdEntry=scsiLuIdEntry, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, scsiLuInCommands=scsiLuInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotifications=scsiNotifications, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdType=ScsiIdType, PYSNMP_MODULE_ID=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdType=scsiLuIdType, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtEntry=scsiDscTgtEntry, scsiModule=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLunMapLun=scsiLunMapLun, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdentifier=ScsiIdentifier, scsiPortEntry=scsiPortEntry, scsiDscLunLun=scsiDscLunLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdValue=ScsiIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGroups=scsiGroups, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtTable=scsiDscTgtTable, scsiTranportSPI=scsiTranportSPI, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet)
