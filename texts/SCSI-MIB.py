...
iso, MibIdentifier, Counter64, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ModuleIdentity, ObjectIdentity, mib_2, IpAddress, TimeTicks, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Counter64", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ModuleIdentity", "ObjectIdentity", "mib-2", "IpAddress", "TimeTicks", "Counter32", "Unsigned32")
TimeStamp, TextualConvention, RowStatus, AutonomousType, TruthValue, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "AutonomousType", "TruthValue", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIndex=scsiDscTgtIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportSRP=scsiTransportSRP, scsiObjects=scsiObjects, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, ScsiIdValue=ScsiIdValue, scsiLuIdValue=scsiLuIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdType=scsiLuIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdType=ScsiIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuVendorId=scsiLuVendorId, ScsiIndexValue=ScsiIndexValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, ScsiName=ScsiName, scsiGroups=scsiGroups, scsiLuStatus=scsiLuStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortRole=scsiPortRole, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuTable=scsiLuTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportSPI=scsiTranportSPI, scsiLuIndex=scsiLuIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLogicalUnit=scsiLogicalUnit, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortIndex=scsiPortIndex, scsiLuProductId=scsiLuProductId, ScsiLUNOrZero=ScsiLUNOrZero, scsiCompliance=scsiCompliance, scsiDscLunTable=scsiDscLunTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdType=scsiDscLunIdType, scsiTransportISCSI=scsiTransportISCSI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGeneral=scsiGeneral, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiNotifications=scsiNotifications, scsiAttTgtPortName=scsiAttTgtPortName, scsiConformance=scsiConformance, scsiTargetGroup=scsiTargetGroup, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiModule=scsiModule, scsiTrnsptTable=scsiTrnsptTable)
