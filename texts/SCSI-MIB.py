...
iso, TimeTicks, IpAddress, Counter32, Counter64, Gauge32, ModuleIdentity, Unsigned32, ObjectIdentity, MibIdentifier, mib_2, Integer32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "Counter32", "Counter64", "Gauge32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibIdentifier", "mib-2", "Integer32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, TimeStamp, RowPointer, TextualConvention, RowStatus, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortIndex=scsiPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiTarget=scsiTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdentifier=ScsiIdentifier, scsiDscTgtName=scsiDscTgtName, scsiLuInResets=scsiLuInResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportFCP=scsiTransportFCP, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdType=scsiLuIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiator=scsiInitiator, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTable=scsiPortTable, scsiLuIdValue=scsiLuIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortName=scsiTgtPortName, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiModule=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuTable=scsiLuTable, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptType=scsiTrnsptType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportTypes=scsiTransportTypes, scsiTransportISCSI=scsiTransportISCSI, scsiPortEntry=scsiPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceTable=scsiInstanceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdValue=ScsiIdValue, scsiTranportSPI=scsiTranportSPI, scsiNotifications=scsiNotifications, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiObjects=scsiObjects, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiConformance=scsiConformance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiLuWwnName=scsiLuWwnName, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiLunMapGroup=scsiLunMapGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuEntry=scsiLuEntry, scsiInstAlias=scsiInstAlias, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuState=scsiLuState, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdIndex=scsiLuIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrName=scsiAuthIntrName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapTable=scsiLunMapTable, scsiDeviceResets=scsiDeviceResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGeneral=scsiGeneral, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, ScsiName=ScsiName, scsiTargetGroup=scsiTargetGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable)
