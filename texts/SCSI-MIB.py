...
ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, TimeTicks, IpAddress, iso, NotificationType, ModuleIdentity, Gauge32, MibIdentifier, Integer32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "TimeTicks", "IpAddress", "iso", "NotificationType", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "mib-2")
TimeStamp, DisplayString, TextualConvention, RowStatus, AutonomousType, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevTable=scsiTgtDevTable, scsiGeneral=scsiGeneral, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiCompliance=scsiCompliance, ScsiIdValue=ScsiIdValue, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiDeviceGroup=scsiDeviceGroup, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiLuState=scsiLuState, scsiInstAlias=scsiInstAlias, scsiLuStatus=scsiLuStatus, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiModule=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIndex=scsiLuIndex, scsiLuInCommands=scsiLuInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtName=scsiDscTgtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdValue=scsiLuIdValue, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSBP=scsiTransportSBP, scsiLuIdTable=scsiLuIdTable, scsiPortEntry=scsiPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceTable=scsiInstanceTable, scsiLuInResets=scsiLuInResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiConformance=scsiConformance, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceTable=scsiDeviceTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceRole=scsiDeviceRole, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGroups=scsiGroups, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiNotifications=scsiNotifications, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTranportSPI=scsiTranportSPI, scsiTgtPortTable=scsiTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, ScsiName=ScsiName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTransportISCSI=scsiTransportISCSI, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtTable=scsiDscTgtTable, ScsiDeviceOrPort=ScsiDeviceOrPort)
