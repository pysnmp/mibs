...
iso, ObjectIdentity, TimeTicks, Counter32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, Bits, Counter64, MibIdentifier, Gauge32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "TimeTicks", "Counter32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "Bits", "Counter64", "MibIdentifier", "Gauge32", "NotificationType", "Integer32")
AutonomousType, TruthValue, RowStatus, RowPointer, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowStatus", "RowPointer", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportOther=scsiTranportOther, scsiLuStatus=scsiLuStatus, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGeneral=scsiGeneral, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiObjects=scsiObjects, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapTable=scsiLunMapTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSBP=scsiTransportSBP, scsiPortEntry=scsiPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiTarget=scsiTarget, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliance=scsiCompliance, scsiLuTable=scsiLuTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstAlias=scsiInstAlias, scsiLuWwnName=scsiLuWwnName, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIndexValue=ScsiIndexValue, scsiModule=scsiModule, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuInResets=scsiLuInResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuVendorId=scsiLuVendorId, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiator=scsiInitiator, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortIndex=scsiPortIndex, scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiCompliances=scsiCompliances, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, ScsiName=ScsiName, scsiGroups=scsiGroups, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiInstIndex=scsiInstIndex, scsiLuProductId=scsiLuProductId, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdValue=ScsiIdValue, ScsiIdAssociation=ScsiIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceRole=scsiDeviceRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, PYSNMP_MODULE_ID=scsiModule)
