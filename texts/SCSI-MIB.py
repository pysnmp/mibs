...
MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Gauge32, iso, Unsigned32, IpAddress, NotificationType, ObjectIdentity, Bits, TimeTicks, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Gauge32", "iso", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "Bits", "TimeTicks", "mib-2", "Counter64")
TimeStamp, DisplayString, TruthValue, RowStatus, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuState=scsiLuState, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdType=scsiLuIdType, scsiNotifications=scsiNotifications, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiLuStatus=scsiLuStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscTgtName=scsiDscTgtName, scsiTransportSRP=scsiTransportSRP, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiGroups=scsiGroups, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortRole=scsiPortRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiName=ScsiName, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiConformance=scsiConformance, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiDeviceRole=scsiDeviceRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportOther=scsiTranportOther, scsiCompliances=scsiCompliances, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuEntry=scsiLuEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiator=scsiInitiator, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdValue=ScsiIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiModule=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortEntry=scsiPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiGeneral=scsiGeneral, scsiDscLunTable=scsiDscLunTable, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWwnName=scsiLuWwnName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuProductId=scsiLuProductId, scsiLuIndex=scsiLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdTable=scsiLuIdTable, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorGroup=scsiInitiatorGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetGroup=scsiTargetGroup, scsiLunMapLun=scsiLunMapLun, scsiObjects=scsiObjects, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiLuInResets=scsiLuInResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiCompliance=scsiCompliance, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup)
