...
mib_2, IpAddress, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, Counter64, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "Counter64", "TimeTicks", "Integer32", "iso")
TimeStamp, RowPointer, TruthValue, RowStatus, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TruthValue", "RowStatus", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiLuEntry=scsiLuEntry, scsiTargetGroup=scsiTargetGroup, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportOther=scsiTranportOther, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunLun=scsiDscLunLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuState=scsiLuState, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiDeviceRole=scsiDeviceRole, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiObjects=scsiObjects, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstanceTable=scsiInstanceTable, scsiPortRole=scsiPortRole, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdAssociation=ScsiIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdType=scsiLuIdType, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdValue=ScsiIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiModule=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdTable=scsiLuIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceTable=scsiDeviceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatus=scsiLuStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiConformance=scsiConformance, scsiCompliance=scsiCompliance, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportFCP=scsiTransportFCP, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiLuInCommands=scsiLuInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortEntry=scsiPortEntry, ScsiIdentifier=ScsiIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiPortIndex=scsiPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero)
