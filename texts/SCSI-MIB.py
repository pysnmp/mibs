...
Counter64, Counter32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, mib_2, Gauge32, iso, TimeTicks, MibIdentifier, Unsigned32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "mib-2", "Gauge32", "iso", "TimeTicks", "MibIdentifier", "Unsigned32", "IpAddress", "Integer32")
DisplayString, RowStatus, TruthValue, RowPointer, TimeStamp, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TruthValue", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdAssociation=ScsiIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuEntry=scsiLuEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiGroups=scsiGroups, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, scsiCompliances=scsiCompliances, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiGeneral=scsiGeneral, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstAlias=scsiInstAlias, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceEntry=scsiDeviceEntry, scsiObjects=scsiObjects, scsiDscTgtName=scsiDscTgtName, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiTarget=scsiTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportISCSI=scsiTransportISCSI, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotifications=scsiNotifications, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuTable=scsiLuTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdTable=scsiLuIdTable, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceTable=scsiDeviceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiator=scsiInitiator, ScsiName=ScsiName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiLuInResets=scsiLuInResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceRole=scsiDeviceRole, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstIndex=scsiInstIndex, scsiLuState=scsiLuState, scsiLuWwnName=scsiLuWwnName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTranportOther=scsiTranportOther, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable)
