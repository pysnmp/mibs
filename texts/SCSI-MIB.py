...
MibIdentifier, mib_2, TimeTicks, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, Counter32, IpAddress, ObjectIdentity, Unsigned32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "TimeTicks", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "Counter32", "IpAddress", "ObjectIdentity", "Unsigned32", "Integer32", "NotificationType")
TextualConvention, AutonomousType, DisplayString, RowPointer, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "RowPointer", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuEntry=scsiLuEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstAlias=scsiInstAlias, scsiLuIdType=scsiLuIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInResets=scsiLuInResets, ScsiIdValue=ScsiIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuVendorId=scsiLuVendorId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiTranportOther=scsiTranportOther, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiModule=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSRP=scsiTransportSRP, scsiDscLunTable=scsiDscLunTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuIndex=scsiLuIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiator=scsiInitiator, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiConformance=scsiConformance, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptTable=scsiTrnsptTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortRole=scsiPortRole, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLun=scsiLunMapLun, ScsiIdType=ScsiIdType, scsiInstIndex=scsiInstIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGeneral=scsiGeneral, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiObjects=scsiObjects, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuStatus=scsiLuStatus, scsiPortEntry=scsiPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptType=scsiTrnsptType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWwnName=scsiLuWwnName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, scsiPortTable=scsiPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportFCP=scsiTransportFCP, scsiDscLunEntry=scsiDscLunEntry, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuTable=scsiLuTable, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGroups=scsiGroups, scsiLuRevisionId=scsiLuRevisionId)
