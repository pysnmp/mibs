...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, MibIdentifier, mib_2, Integer32, Gauge32, Unsigned32, Bits, ObjectIdentity, iso, IpAddress, ModuleIdentity, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "MibIdentifier", "mib-2", "Integer32", "Gauge32", "Unsigned32", "Bits", "ObjectIdentity", "iso", "IpAddress", "ModuleIdentity", "Counter32", "Counter64")
DisplayString, TextualConvention, AutonomousType, TruthValue, RowPointer, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue", "RowPointer", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiGeneral=scsiGeneral, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptTable=scsiTrnsptTable, ScsiName=ScsiName, scsiCompliances=scsiCompliances, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdType=scsiLuIdType, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTarget=scsiTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiPortRole=scsiPortRole, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuTable=scsiLuTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstAlias=scsiInstAlias, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiTrnsptEntry=scsiTrnsptEntry, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortName=scsiTgtPortName, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtName=scsiDscTgtName, PYSNMP_MODULE_ID=scsiModule, scsiLuVendorId=scsiLuVendorId, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliance=scsiCompliance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunLun=scsiDscLunLun, scsiLuIdValue=scsiLuIdValue, scsiTransportSBP=scsiTransportSBP, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiPortTable=scsiPortTable, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuState=scsiLuState, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiator=scsiInitiator, scsiLuIndex=scsiLuIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValue=ScsiIndexValue, scsiInstIndex=scsiInstIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLuRevisionId=scsiLuRevisionId, scsiModule=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiConformance=scsiConformance)
