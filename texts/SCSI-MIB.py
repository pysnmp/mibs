...
Gauge32, Counter32, Counter64, Bits, Unsigned32, mib_2, ObjectIdentity, IpAddress, iso, MibIdentifier, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Counter64", "Bits", "Unsigned32", "mib-2", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
DisplayString, TextualConvention, TimeStamp, RowPointer, AutonomousType, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TimeStamp", "RowPointer", "AutonomousType", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiTransportFCP=scsiTransportFCP, scsiLuWwnName=scsiLuWwnName, scsiLuInCommands=scsiLuInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortIndex=scsiPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiModule=scsiModule, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortTable=scsiTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiLuIdTable=scsiLuIdTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuEntry=scsiLuEntry, scsiCompliance=scsiCompliance, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliances=scsiCompliances, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiGroups=scsiGroups, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceTable=scsiDeviceTable, scsiLuTable=scsiLuTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdValue=scsiLuIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunTable=scsiDscLunTable, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGeneral=scsiGeneral, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortName=scsiTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtName=scsiDscTgtName, scsiDeviceRole=scsiDeviceRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSRP=scsiTransportSRP, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiObjects=scsiObjects, scsiLogicalUnit=scsiLogicalUnit, scsiTarget=scsiTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiConformance=scsiConformance, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiator=scsiInitiator, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, scsiPortTable=scsiPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdType=ScsiIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiLuIndex=scsiLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstIndex=scsiInstIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortEntry=scsiPortEntry, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuState=scsiLuState, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuStatus=scsiLuStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiLuInResets=scsiLuInResets, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiNotifications=scsiNotifications, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands)
