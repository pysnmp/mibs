...
Counter32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, IpAddress, mib_2, Unsigned32, Counter64, iso, TimeTicks, Integer32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "IpAddress", "mib-2", "Unsigned32", "Counter64", "iso", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier")
TimeStamp, AutonomousType, DisplayString, TruthValue, RowStatus, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "RowStatus", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiObjects=scsiObjects, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiConformance=scsiConformance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiModule=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceEntry=scsiDeviceEntry, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiTgtDevEntry=scsiTgtDevEntry, ScsiName=ScsiName, scsiTrnsptTable=scsiTrnsptTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportOther=scsiTranportOther, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotifications=scsiNotifications, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortEntry=scsiPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliances=scsiCompliances, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, scsiDscLunIdType=scsiDscLunIdType, scsiPortTable=scsiPortTable, scsiDscLunLun=scsiDscLunLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtTable=scsiDscTgtTable, scsiLuWwnName=scsiLuWwnName, scsiInitiator=scsiInitiator, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceResets=scsiDeviceResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiCompliance=scsiCompliance, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceGroup=scsiDeviceGroup, scsiLuEntry=scsiLuEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtName=scsiDscTgtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValue=ScsiIndexValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuState=scsiLuState, scsiDscLunEntry=scsiDscLunEntry, scsiInstIndex=scsiInstIndex, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTarget=scsiTarget, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuInResets=scsiLuInResets, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, ScsiIdType=ScsiIdType, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiPortRole=scsiPortRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiLuIndex=scsiLuIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup)
