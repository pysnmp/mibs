...
mib_2, ModuleIdentity, iso, MibIdentifier, Counter64, NotificationType, Integer32, Gauge32, Counter32, IpAddress, Unsigned32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "iso", "MibIdentifier", "Counter64", "NotificationType", "Integer32", "Gauge32", "Counter32", "IpAddress", "Unsigned32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
TimeStamp, DisplayString, AutonomousType, TextualConvention, RowStatus, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "AutonomousType", "TextualConvention", "RowStatus", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdType=scsiDscLunIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, PYSNMP_MODULE_ID=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiPortIndex=scsiPortIndex, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuTable=scsiLuTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuEntry=scsiLuEntry, scsiInstAlias=scsiInstAlias, scsiCompliance=scsiCompliance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortTable=scsiPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInCommands=scsiLuInCommands, scsiGroups=scsiGroups, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTarget=scsiTarget, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, ScsiIdValue=ScsiIdValue, scsiLuStatus=scsiLuStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIndex=scsiLuIndex, scsiTransportSBP=scsiTransportSBP, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTargetGroup=scsiTargetGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWwnName=scsiLuWwnName, scsiGeneral=scsiGeneral, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiConformance=scsiConformance, scsiModule=scsiModule, scsiLuIdType=scsiLuIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortEntry=scsiPortEntry, scsiLuIdValue=scsiLuIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotifications=scsiNotifications, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiLuInResets=scsiLuInResets, scsiIntrPrtName=scsiIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliances=scsiCompliances, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceTable=scsiDeviceTable)
