...
NotificationType, IpAddress, mib_2, Counter32, iso, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Unsigned32, ModuleIdentity, Gauge32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "mib-2", "Counter32", "iso", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32", "TimeTicks")
RowPointer, RowStatus, TextualConvention, TruthValue, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceAlias=scsiDeviceAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunLun=scsiDscLunLun, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstAlias=scsiInstAlias, scsiCompliance=scsiCompliance, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiLuIdType=scsiLuIdType, scsiLuTable=scsiLuTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiModule=scsiModule, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortRole=scsiPortRole, scsiGroups=scsiGroups, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtTable=scsiDscTgtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdType=ScsiIdType, scsiLuIdTable=scsiLuIdTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTarget=scsiTarget, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuState=scsiLuState, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiTransportTypes=scsiTransportTypes, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceRole=scsiDeviceRole, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdAssociation=ScsiIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiName=ScsiName, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortEntry=scsiPortEntry, scsiDeviceResets=scsiDeviceResets, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiConformance=scsiConformance, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiCompliances=scsiCompliances, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatus=scsiLuStatus, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdValue=ScsiIdValue, scsiTranportSPI=scsiTranportSPI, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiLunMapTable=scsiLunMapTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceEntry=scsiDeviceEntry)
