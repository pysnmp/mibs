...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, mib_2, Integer32, iso, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, TimeTicks, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "mib-2", "Integer32", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "TimeTicks", "Counter64", "NotificationType")
RowStatus, TimeStamp, RowPointer, TruthValue, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "RowPointer", "TruthValue", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiConformance=scsiConformance, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiLuWwnName=scsiLuWwnName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiInitiator=scsiInitiator, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTarget=scsiTarget, scsiLunMapEntry=scsiLunMapEntry, scsiCompliances=scsiCompliances, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdValue=scsiLuIdValue, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatus=scsiLuStatus, scsiPortEntry=scsiPortEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortName=scsiTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuProductId=scsiLuProductId, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceRole=scsiDeviceRole, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportOther=scsiTranportOther, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunTable=scsiDscLunTable, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIndex=scsiLuIndex, scsiLuTable=scsiLuTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdType=ScsiIdType, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuEntry=scsiLuEntry, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuState=scsiLuState, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstIndex=scsiInstIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiName=ScsiName, scsiPortRole=scsiPortRole, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInCommands=scsiLuInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdType=scsiLuIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiObjects=scsiObjects, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapTable=scsiLunMapTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGeneral=scsiGeneral, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes)
