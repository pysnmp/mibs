...
mib_2, ObjectIdentity, Integer32, Bits, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Gauge32, MibIdentifier, Counter64, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "Integer32", "Bits", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "Counter64", "iso", "TimeTicks")
TextualConvention, AutonomousType, RowPointer, RowStatus, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowPointer", "RowStatus", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotifications=scsiNotifications, scsiTrnsptDevName=scsiTrnsptDevName, scsiGeneral=scsiGeneral, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliance=scsiCompliance, scsiModule=scsiModule, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiTarget=scsiTarget, scsiTranportSPI=scsiTranportSPI, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatus=scsiLuStatus, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, scsiDscTgtTable=scsiDscTgtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptType=scsiTrnsptType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiator=scsiInitiator, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceResets=scsiDeviceResets, scsiLuInResets=scsiLuInResets, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetGroup=scsiTargetGroup, scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiName=ScsiName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTranportOther=scsiTranportOther, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdentifier=ScsiIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdType=scsiLuIdType, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTransportTypes=scsiTransportTypes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdTable=scsiLuIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSBP=scsiTransportSBP, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiLuEntry=scsiLuEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrName=scsiAuthIntrName, ScsiIdType=ScsiIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuRevisionId=scsiLuRevisionId, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceTable=scsiDeviceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdValue=ScsiIdValue, scsiTgtPortEntry=scsiTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGroups=scsiGroups, scsiPortEntry=scsiPortEntry, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured)
