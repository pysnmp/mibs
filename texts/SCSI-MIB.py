...
TimeTicks, MibIdentifier, Counter32, Gauge32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Integer32, Bits, IpAddress, ObjectIdentity, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Counter32", "Gauge32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Integer32", "Bits", "IpAddress", "ObjectIdentity", "mib-2", "NotificationType")
RowStatus, TextualConvention, TimeStamp, DisplayString, RowPointer, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "RowPointer", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTable=scsiPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdValue=scsiLuIdValue, scsiTargetGroup=scsiTargetGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiLuEntry=scsiLuEntry, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdType=ScsiIdType, scsiInstAlias=scsiInstAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotifications=scsiNotifications, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiLuTable=scsiLuTable, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTransportTypes=scsiTransportTypes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuVendorId=scsiLuVendorId, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiPortIndex=scsiPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapEntry=scsiLunMapEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTarget=scsiTarget, scsiLuInResets=scsiLuInResets, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuProductId=scsiLuProductId, scsiLuState=scsiLuState, scsiAttTgtPortIndex=scsiAttTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstanceTable=scsiInstanceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLun=scsiLunMapLun, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiName=ScsiName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiObjects=scsiObjects, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportSPI=scsiTranportSPI, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiCompliance=scsiCompliance, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportOther=scsiTranportOther, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes)
