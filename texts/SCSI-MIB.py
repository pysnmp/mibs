...
Unsigned32, Counter64, ObjectIdentity, Gauge32, Bits, TimeTicks, MibIdentifier, Counter32, ModuleIdentity, mib_2, IpAddress, NotificationType, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "ObjectIdentity", "Gauge32", "Bits", "TimeTicks", "MibIdentifier", "Counter32", "ModuleIdentity", "mib-2", "IpAddress", "NotificationType", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, RowPointer, AutonomousType, TimeStamp, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "AutonomousType", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInResets=scsiLuInResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiPortTable=scsiPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiator=scsiInitiator, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, scsiLuInCommands=scsiLuInCommands, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdValue=ScsiIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtName=scsiIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiConformance=scsiConformance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiCompliance=scsiCompliance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiName=ScsiName, scsiLuWwnName=scsiLuWwnName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapGroup=scsiLunMapGroup, scsiPortEntry=scsiPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiModule=scsiModule, scsiCompliances=scsiCompliances, scsiTrnsptTable=scsiTrnsptTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunLun=scsiDscLunLun, scsiDeviceGroup=scsiDeviceGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdentifier=ScsiIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiLunMapTable=scsiLunMapTable, scsiInstIndex=scsiInstIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdType=scsiLuIdType, scsiPortIndex=scsiPortIndex, scsiTgtPortName=scsiTgtPortName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiPortRole=scsiPortRole, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiObjects=scsiObjects, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuVendorId=scsiLuVendorId, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable)
