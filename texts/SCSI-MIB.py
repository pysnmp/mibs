...
iso, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, Counter32, mib_2, ObjectIdentity, IpAddress, TimeTicks, NotificationType, Integer32, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "Counter32", "mib-2", "ObjectIdentity", "IpAddress", "TimeTicks", "NotificationType", "Integer32", "Bits", "Unsigned32")
DisplayString, TimeStamp, RowStatus, TextualConvention, AutonomousType, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "AutonomousType", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotifications=scsiNotifications, scsiTarget=scsiTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiLuTable=scsiLuTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiTgtPortName=scsiTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportOther=scsiTranportOther, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiLunMapTable=scsiLunMapTable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuEntry=scsiLuEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdType=scsiLuIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiCompliances=scsiCompliances, scsiGroups=scsiGroups, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLun=scsiLunMapLun, scsiLuIdCodeSet=scsiLuIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportTypes=scsiTransportTypes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiInitiator=scsiInitiator, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIndex=scsiLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdTable=scsiDscLunIdTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSRP=scsiTransportSRP, scsiLuVendorId=scsiLuVendorId, scsiModule=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTable=scsiPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortRole=scsiPortRole, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiCompliance=scsiCompliance, scsiPortIndex=scsiPortIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiPortEntry=scsiPortEntry, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuState=scsiLuState, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunLun=scsiDscLunLun, scsiDeviceResets=scsiDeviceResets, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstAlias=scsiInstAlias, scsiLuWwnName=scsiLuWwnName, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiObjects=scsiObjects)
