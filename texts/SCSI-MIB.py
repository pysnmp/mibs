...
iso, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Gauge32, Counter64, Integer32, IpAddress, MibIdentifier, Counter32, Bits, NotificationType, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Gauge32", "Counter64", "Integer32", "IpAddress", "MibIdentifier", "Counter32", "Bits", "NotificationType", "Unsigned32", "TimeTicks")
AutonomousType, TimeStamp, TruthValue, DisplayString, RowPointer, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TruthValue", "DisplayString", "RowPointer", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtName=scsiDscTgtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportTypes=scsiTransportTypes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiLunMapTable=scsiLunMapTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTarget=scsiTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiCompliances=scsiCompliances, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTable=scsiPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, scsiIntrDevTable=scsiIntrDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets, ScsiName=ScsiName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuTable=scsiLuTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiPortRole=scsiPortRole, scsiGroups=scsiGroups, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdAssociation=ScsiIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiator=scsiInitiator, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiInstAlias=scsiInstAlias, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortName=scsiTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportSBP=scsiTransportSBP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiLuIdEntry=scsiLuIdEntry, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGeneral=scsiGeneral, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstIndex=scsiInstIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIndex=scsiLuIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier)
