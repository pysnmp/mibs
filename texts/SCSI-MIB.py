...
TimeTicks, Counter64, Bits, NotificationType, mib_2, Integer32, ModuleIdentity, ObjectIdentity, Unsigned32, Counter32, Gauge32, MibIdentifier, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Bits", "NotificationType", "mib-2", "Integer32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "MibIdentifier", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TimeStamp, TextualConvention, RowStatus, TruthValue, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuProductId=scsiLuProductId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiModule=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceEntry=scsiInstanceEntry, scsiNotifications=scsiNotifications, scsiInstanceTable=scsiInstanceTable, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiLuIndex=scsiLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGroups=scsiGroups, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptType=scsiTrnsptType, scsiLuIdIndex=scsiLuIdIndex, scsiLuInCommands=scsiLuInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuEntry=scsiLuEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSBP=scsiTransportSBP, scsiLunMapLun=scsiLunMapLun, scsiTranportOther=scsiTranportOther, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiConformance=scsiConformance, scsiObjects=scsiObjects, scsiInstVendorVersion=scsiInstVendorVersion, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, PYSNMP_MODULE_ID=scsiModule, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTarget=scsiTarget, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiCompliance=scsiCompliance, scsiGeneral=scsiGeneral, scsiLuVendorId=scsiLuVendorId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceRole=scsiDeviceRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiLunMapTable=scsiLunMapTable, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdTable=scsiLuIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortName=scsiTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiDscLunTable=scsiDscLunTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortEntry=scsiPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptTable=scsiTrnsptTable, ScsiIdType=ScsiIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevEntry=scsiIntrDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunLun=scsiDscLunLun, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun)
