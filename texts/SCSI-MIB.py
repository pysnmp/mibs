...
Counter32, ModuleIdentity, Bits, MibIdentifier, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, ObjectIdentity, Counter64, Unsigned32, iso, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Bits", "MibIdentifier", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "ObjectIdentity", "Counter64", "Unsigned32", "iso", "NotificationType", "IpAddress")
TruthValue, RowStatus, TimeStamp, TextualConvention, AutonomousType, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "TextualConvention", "AutonomousType", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliances=scsiCompliances, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuState=scsiLuState, scsiDeviceGroup=scsiDeviceGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunTable=scsiDscLunTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTable=scsiPortTable, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapTable=scsiLunMapTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportTypes=scsiTransportTypes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdType=scsiLuIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdValue=ScsiIdValue, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceResets=scsiDeviceResets, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiModule=scsiModule, scsiNotifications=scsiNotifications, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortIndex=scsiPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTable=scsiIntrDevTable, scsiInstAlias=scsiInstAlias, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiGroups=scsiGroups, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevEntry=scsiTgtDevEntry, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuVendorId=scsiLuVendorId, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuEntry=scsiLuEntry, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiConformance=scsiConformance, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdType=ScsiIdType, scsiDscLunEntry=scsiDscLunEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet)
