...
Counter32, iso, Unsigned32, Gauge32, IpAddress, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, ObjectIdentity, Bits, MibIdentifier, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Unsigned32", "Gauge32", "IpAddress", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "ObjectIdentity", "Bits", "MibIdentifier", "NotificationType", "Counter64")
TimeStamp, DisplayString, AutonomousType, RowStatus, TextualConvention, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "AutonomousType", "RowStatus", "TextualConvention", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiator=scsiInitiator, scsiDscTgtTable=scsiDscTgtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliances=scsiCompliances, scsiLuVendorId=scsiLuVendorId, scsiPortTable=scsiPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdType=ScsiIdType, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiModule=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuState=scsiLuState, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiDscTgtName=scsiDscTgtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortRole=scsiPortRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTranportSPI=scsiTranportSPI, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtName=scsiIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiLuStatus=scsiLuStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGroups=scsiGroups, scsiDeviceGroup=scsiDeviceGroup, scsiCompliance=scsiCompliance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiObjects=scsiObjects, scsiConformance=scsiConformance, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTranportOther=scsiTranportOther, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiLuEntry=scsiLuEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportFCP=scsiTransportFCP, scsiTrnsptType=scsiTrnsptType, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuTable=scsiLuTable, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiName=ScsiName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuProductId=scsiLuProductId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportTypes=scsiTransportTypes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiRemoteTarget=scsiRemoteTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortEntry=scsiPortEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable)
