...
ModuleIdentity, Gauge32, Counter32, MibIdentifier, Unsigned32, Integer32, mib_2, ObjectIdentity, Counter64, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Counter32", "MibIdentifier", "Unsigned32", "Integer32", "mib-2", "ObjectIdentity", "Counter64", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "NotificationType")
AutonomousType, TimeStamp, RowPointer, TextualConvention, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiLuIdTable=scsiLuIdTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportTypes=scsiTransportTypes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapLun=scsiLunMapLun, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuStatus=scsiLuStatus, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGroups=scsiGroups, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdValue=ScsiIdValue, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdAssociation=scsiLuIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdType=scsiLuIdType, scsiCompliances=scsiCompliances, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstAlias=scsiInstAlias, ScsiIdentifier=ScsiIdentifier, scsiPortEntry=scsiPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuState=scsiLuState, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiator=scsiInitiator, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValue=ScsiIndexValue, scsiNotifications=scsiNotifications, scsiModule=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtName=scsiDscTgtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiTgtPortName=scsiTgtPortName, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGeneral=scsiGeneral, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiConformance=scsiConformance, scsiLuTable=scsiLuTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiName=ScsiName, scsiDeviceResets=scsiDeviceResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiPortRole=scsiPortRole, scsiLuIdValue=scsiLuIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiLunMapTable=scsiLunMapTable, scsiLuInCommands=scsiLuInCommands, ScsiIdType=ScsiIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdType=scsiDscLunIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSBP=scsiTransportSBP, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiTgtPortTable=scsiTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstIndex=scsiInstIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTarget=scsiTarget, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunLun=scsiDscLunLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP)
