...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Gauge32, Counter64, Bits, MibIdentifier, iso, NotificationType, Unsigned32, ModuleIdentity, ObjectIdentity, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Gauge32", "Counter64", "Bits", "MibIdentifier", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "mib-2", "Counter32")
TextualConvention, DisplayString, RowStatus, RowPointer, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "RowPointer", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapGroup=scsiLunMapGroup, scsiConformance=scsiConformance, scsiDscLunTable=scsiDscLunTable, scsiLuInCommands=scsiLuInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapTable=scsiLunMapTable, scsiLuIndex=scsiLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiLuWwnName=scsiLuWwnName, ScsiIdType=ScsiIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdType=scsiLuIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuTable=scsiLuTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatus=scsiLuStatus, scsiLuRevisionId=scsiLuRevisionId, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdTable=scsiLuIdTable, ScsiIdValue=ScsiIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiLuVendorId=scsiLuVendorId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortEntry=scsiPortEntry, scsiInstanceTable=scsiInstanceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGroups=scsiGroups, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTarget=scsiTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortTable=scsiTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiTransportTypes=scsiTransportTypes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiModule=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiGeneral=scsiGeneral, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiTranportOther=scsiTranportOther, scsiPortIndex=scsiPortIndex, scsiTargetGroup=scsiTargetGroup, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuState=scsiLuState, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiDscTgtName=scsiDscTgtName, scsiLuEntry=scsiLuEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiName=ScsiName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdEntry=scsiLuIdEntry, scsiObjects=scsiObjects, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiator=scsiInitiator, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP)
