...
mib_2, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Counter32, Bits, ObjectIdentity, TimeTicks, iso, MibIdentifier, IpAddress, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Counter32", "Bits", "ObjectIdentity", "TimeTicks", "iso", "MibIdentifier", "IpAddress", "Gauge32", "Counter64")
RowPointer, RowStatus, TimeStamp, DisplayString, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TimeStamp", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiTargetGroup=scsiTargetGroup, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdentifier=ScsiIdentifier, scsiPortIndex=scsiPortIndex, scsiLuVendorId=scsiLuVendorId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceTable=scsiDeviceTable, scsiLuInCommands=scsiLuInCommands, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuState=scsiLuState, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdValue=ScsiIdValue, PYSNMP_MODULE_ID=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiNotifications=scsiNotifications, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstanceTable=scsiInstanceTable, scsiInstIndex=scsiInstIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiator=scsiInitiator, scsiTransportSRP=scsiTransportSRP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLuProductId=scsiLuProductId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLuIndex=scsiLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortRole=scsiPortRole, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiName=ScsiName, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptTable=scsiTrnsptTable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdType=scsiLuIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTranportOther=scsiTranportOther, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTarget=scsiTarget, ScsiIdType=ScsiIdType, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunTable=scsiDscLunTable, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiCompliance=scsiCompliance, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, scsiPortEntry=scsiPortEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapTable=scsiLunMapTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIndex=scsiDscTgtIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiObjects=scsiObjects, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiInstAlias=scsiInstAlias, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdIndex=scsiLuIdIndex, scsiCompliances=scsiCompliances, scsiModule=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry)
