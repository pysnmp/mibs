...
Counter32, Bits, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, ModuleIdentity, Unsigned32, Gauge32, iso, IpAddress, MibIdentifier, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "ModuleIdentity", "Unsigned32", "Gauge32", "iso", "IpAddress", "MibIdentifier", "Integer32", "Counter64")
TimeStamp, TruthValue, AutonomousType, DisplayString, RowPointer, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "DisplayString", "RowPointer", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuStatus=scsiLuStatus, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGeneral=scsiGeneral, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotifications=scsiNotifications, scsiPortEntry=scsiPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTable=scsiPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliances=scsiCompliances, scsiLuPeripheralType=scsiLuPeripheralType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, ScsiIdValue=ScsiIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdIndex=scsiLuIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiLuIdType=scsiLuIdType, scsiLuState=scsiLuState, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiTranportOther=scsiTranportOther, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuEntry=scsiLuEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliance=scsiCompliance, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuVendorId=scsiLuVendorId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiDscTgtName=scsiDscTgtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdType=ScsiIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportSPI=scsiTranportSPI, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceTable=scsiDeviceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiModule=scsiModule, scsiLuIdValue=scsiLuIdValue, scsiLuProductId=scsiLuProductId, scsiPortRole=scsiPortRole, scsiInstanceTable=scsiInstanceTable, scsiTarget=scsiTarget, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtTable=scsiDscTgtTable, scsiObjects=scsiObjects, scsiRemoteInitiators=scsiRemoteInitiators, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, scsiInitiator=scsiInitiator, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiLuTable=scsiLuTable, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportFCP=scsiTransportFCP, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation)
