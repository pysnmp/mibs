...
MibIdentifier, Counter64, Gauge32, TimeTicks, IpAddress, NotificationType, Unsigned32, mib_2, iso, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "mib-2", "iso", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Integer32")
TimeStamp, RowPointer, AutonomousType, DisplayString, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuWwnName=scsiLuWwnName, scsiGroups=scsiGroups, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstAlias=scsiInstAlias, scsiLunMapTable=scsiLunMapTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortIndex=scsiPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiModule=scsiModule, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtName=scsiIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLun=scsiLunMapLun, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotifications=scsiNotifications, scsiPortTable=scsiPortTable, scsiDscLunTable=scsiDscLunTable, ScsiIdValue=ScsiIdValue, scsiDscTgtName=scsiDscTgtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInResets=scsiLuInResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortRole=scsiPortRole, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdType=scsiLuIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiLuIdIndex=scsiLuIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiator=scsiInitiator, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstanceTable=scsiInstanceTable, scsiGeneral=scsiGeneral, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiLuState=scsiLuState, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuProductId=scsiLuProductId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiTarget=scsiTarget, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdType=ScsiIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptTable=scsiTrnsptTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiCompliance=scsiCompliance, scsiLuVendorId=scsiLuVendorId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSBP=scsiTransportSBP, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
