...
Integer32, Unsigned32, NotificationType, mib_2, Counter64, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, iso, IpAddress, Bits, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "mib-2", "Counter64", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "iso", "IpAddress", "Bits", "MibIdentifier", "Gauge32")
RowPointer, AutonomousType, RowStatus, DisplayString, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "RowStatus", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiName=ScsiName, scsiDeviceEntry=scsiDeviceEntry, scsiLuTable=scsiLuTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuProductId=scsiLuProductId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdentifier=ScsiIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiTargetGroup=scsiTargetGroup, scsiLuState=scsiLuState, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapLun=scsiLunMapLun, scsiInstAlias=scsiInstAlias, scsiPortRole=scsiPortRole, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValue=ScsiIndexValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiObjects=scsiObjects, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceTable=scsiDeviceTable, scsiPortEntry=scsiPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTable=scsiPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiLuInCommands=scsiLuInCommands, scsiCompliances=scsiCompliances, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevTable=scsiTgtDevTable, scsiModule=scsiModule, scsiLuInResets=scsiLuInResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceRole=scsiDeviceRole, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportOther=scsiTranportOther, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapGroup=scsiLunMapGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdEntry=scsiLuIdEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSBP=scsiTransportSBP, scsiLunMapTable=scsiLunMapTable, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortIndex=scsiPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdValue=scsiLuIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdType=scsiLuIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdIndex=scsiLuIdIndex, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiLuWwnName=scsiLuWwnName, scsiConformance=scsiConformance, scsiTgtPortTable=scsiTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapEntry=scsiLunMapEntry, scsiNotifications=scsiNotifications, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceTable=scsiInstanceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
