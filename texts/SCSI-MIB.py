...
Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Counter64, Bits, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, NotificationType, mib_2, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Counter64", "Bits", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "NotificationType", "mib-2", "iso", "TimeTicks")
TextualConvention, AutonomousType, RowStatus, TimeStamp, DisplayString, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowStatus", "TimeStamp", "DisplayString", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiInstAlias=scsiInstAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiModule=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiGroups=scsiGroups, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiIntrPrtTable=scsiIntrPrtTable, ScsiName=ScsiName, scsiConformance=scsiConformance, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdType=scsiLuIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliance=scsiCompliance, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuEntry=scsiLuEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatus=scsiLuStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuWwnName=scsiLuWwnName, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTable=scsiPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapTable=scsiLunMapTable, scsiDscLunTable=scsiDscLunTable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiObjects=scsiObjects, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, ScsiIdType=ScsiIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiTransportTypes=scsiTransportTypes, scsiInstanceEntry=scsiInstanceEntry, scsiTargetGroup=scsiTargetGroup, scsiPortRole=scsiPortRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiDscTgtName=scsiDscTgtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuState=scsiLuState, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIndexValue=ScsiIndexValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdValue=scsiLuIdValue, scsiDeviceResets=scsiDeviceResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunEntry=scsiDscLunEntry, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, scsiGeneral=scsiGeneral, scsiLunMapLun=scsiLunMapLun, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdTable=scsiLuIdTable, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstanceTable=scsiInstanceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable)
