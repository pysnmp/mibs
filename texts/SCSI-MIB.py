...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, Integer32, iso, Counter32, MibIdentifier, TimeTicks, Unsigned32, Counter64, Gauge32, ObjectIdentity, NotificationType, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "Integer32", "iso", "Counter32", "MibIdentifier", "TimeTicks", "Unsigned32", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "Bits", "IpAddress")
DisplayString, RowStatus, TruthValue, TimeStamp, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TruthValue", "TimeStamp", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdTable=scsiLuIdTable, scsiInitiator=scsiInitiator, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, ScsiName=ScsiName, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiTransportFCP=scsiTransportFCP, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuRevisionId=scsiLuRevisionId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstanceEntry=scsiInstanceEntry, scsiPortTable=scsiPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInResets=scsiLuInResets, scsiPortEntry=scsiPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptType=scsiTrnsptType, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapEntry=scsiLunMapEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdIndex=scsiLuIdIndex, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuEntry=scsiLuEntry, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiCompliances=scsiCompliances, ScsiIndexValue=ScsiIndexValue, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuStatus=scsiLuStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortName=scsiTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapTable=scsiLunMapTable, scsiDscLunLun=scsiDscLunLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiLuWwnName=scsiLuWwnName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdentifier=ScsiIdentifier, scsiLuInCommands=scsiLuInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdValue=ScsiIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtName=scsiDscTgtName, scsiConformance=scsiConformance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, scsiLuIndex=scsiLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportSPI=scsiTranportSPI)
