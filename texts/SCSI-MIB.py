...
IpAddress, Counter32, iso, ObjectIdentity, TimeTicks, Bits, MibIdentifier, NotificationType, Gauge32, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "iso", "ObjectIdentity", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "Unsigned32")
RowPointer, RowStatus, TruthValue, AutonomousType, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TruthValue", "AutonomousType", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiDeviceTable=scsiDeviceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTranportOther=scsiTranportOther, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdValue=scsiLuIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInResets=scsiLuInResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSRP=scsiTransportSRP, scsiCompliances=scsiCompliances, scsiLuIdType=scsiLuIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatus=scsiLuStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdValue=ScsiIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceResets=scsiDeviceResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiLuTable=scsiLuTable, scsiLuInCommands=scsiLuInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuState=scsiLuState, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtTable=scsiDscTgtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapEntry=scsiLunMapEntry, scsiModule=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunTable=scsiDscLunTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteTarget=scsiRemoteTarget, scsiInitiator=scsiInitiator, scsiLunMapIndex=scsiLunMapIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdentifier=ScsiIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, scsiTgtPortEntry=scsiTgtPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdType=scsiDscLunIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuVendorId=scsiLuVendorId, ScsiIdType=ScsiIdType, scsiDscTgtName=scsiDscTgtName, scsiLuProductId=scsiLuProductId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWwnName=scsiLuWwnName, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiName=ScsiName, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapTable=scsiLunMapTable, scsiPortIndex=scsiPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportTypes=scsiTransportTypes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGroups=scsiGroups, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets)
