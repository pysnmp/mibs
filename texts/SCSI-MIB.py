...
iso, TimeTicks, IpAddress, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, Counter64, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "Counter64", "Bits", "NotificationType")
DisplayString, TimeStamp, TextualConvention, RowPointer, TruthValue, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "RowPointer", "TruthValue", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportSRP=scsiTransportSRP, scsiConformance=scsiConformance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTarget=scsiTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceResets=scsiDeviceResets, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiNotifications=scsiNotifications, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdType=scsiLuIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiInstIndex=scsiInstIndex, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtName=scsiDscTgtName, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceIndex=scsiDeviceIndex, scsiLuInResets=scsiLuInResets, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiator=scsiInitiator, scsiGroups=scsiGroups, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliances=scsiCompliances, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportOther=scsiTranportOther, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatus=scsiLuStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtName=scsiIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportTypes=scsiTransportTypes, ScsiIndexValue=ScsiIndexValue, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiInstanceTable=scsiInstanceTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdValue=ScsiIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunEntry=scsiDscLunEntry, scsiPortRole=scsiPortRole)
