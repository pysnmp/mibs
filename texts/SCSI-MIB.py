...
NotificationType, ModuleIdentity, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32, TimeTicks, IpAddress, mib_2, iso, Unsigned32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32", "TimeTicks", "IpAddress", "mib-2", "iso", "Unsigned32", "ObjectIdentity", "Gauge32")
TimeStamp, RowStatus, TextualConvention, TruthValue, RowPointer, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "RowPointer", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, ScsiIdValue=ScsiIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdType=scsiLuIdType, scsiLunMapLun=scsiLunMapLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInCommands=scsiLuInCommands, scsiPortTable=scsiPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceTable=scsiInstanceTable, PYSNMP_MODULE_ID=scsiModule, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdType=ScsiIdType, scsiNotifications=scsiNotifications, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiModule=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiObjects=scsiObjects, scsiTransportSBP=scsiTransportSBP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportOther=scsiTranportOther, scsiLogicalUnit=scsiLogicalUnit, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiConformance=scsiConformance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliances=scsiCompliances, ScsiName=ScsiName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuProductId=scsiLuProductId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortEntry=scsiPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceIndex=scsiDeviceIndex, scsiInitiator=scsiInitiator, scsiPortRole=scsiPortRole, scsiLuVendorId=scsiLuVendorId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiLuInResets=scsiLuInResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortName=scsiTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuState=scsiLuState, scsiPortIndex=scsiPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTarget=scsiTarget)
