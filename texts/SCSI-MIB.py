...
Counter32, NotificationType, Gauge32, MibIdentifier, Unsigned32, mib_2, TimeTicks, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, ModuleIdentity, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "MibIdentifier", "Unsigned32", "mib-2", "TimeTicks", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter64")
TimeStamp, DisplayString, RowStatus, TextualConvention, TruthValue, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "TextualConvention", "TruthValue", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuStatus=scsiLuStatus, scsiLuProductId=scsiLuProductId, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportFCP=scsiTransportFCP, scsiInstanceTable=scsiInstanceTable, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiPortIndex=scsiPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIndex=scsiLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuState=scsiLuState, scsiLuIdType=scsiLuIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSBP=scsiTransportSBP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdType=ScsiIdType, scsiPortEntry=scsiPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIndex=scsiDscTgtIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiObjects=scsiObjects, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstIndex=scsiInstIndex, scsiDeviceTable=scsiDeviceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetGroup=scsiTargetGroup, ScsiName=ScsiName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiCompliance=scsiCompliance, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuEntry=scsiLuEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdentifier=ScsiIdentifier, scsiCompliances=scsiCompliances, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTarget=scsiTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, scsiTranportOther=scsiTranportOther, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiModule=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiPortTable=scsiPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiGroups=scsiGroups, scsiInstAlias=scsiInstAlias, scsiDscLunTable=scsiDscLunTable, scsiDscLunEntry=scsiDscLunEntry, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGeneral=scsiGeneral, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiConformance=scsiConformance, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportTypes=scsiTransportTypes, scsiTrnsptIndex=scsiTrnsptIndex)
