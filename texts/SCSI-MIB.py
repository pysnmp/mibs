...
mib_2, IpAddress, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, TimeTicks, ModuleIdentity, Counter32, Bits, NotificationType, Gauge32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "TimeTicks", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "Gauge32", "iso", "Unsigned32")
RowStatus, AutonomousType, TextualConvention, TimeStamp, TruthValue, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "TimeStamp", "TruthValue", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatus=scsiLuStatus, scsiObjects=scsiObjects, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuState=scsiLuState, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortRole=scsiPortRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSBP=scsiTransportSBP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptIndex=scsiTrnsptIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSRP=scsiTransportSRP, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdentifier=ScsiIdentifier, scsiLunMapLun=scsiLunMapLun, ScsiIdValue=ScsiIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstAlias=scsiInstAlias, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiDscTgtName=scsiDscTgtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiName=ScsiName, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiLuIdTable=scsiLuIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportOther=scsiTranportOther, scsiLogicalUnit=scsiLogicalUnit, scsiCompliance=scsiCompliance, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceTable=scsiDeviceTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuEntry=scsiLuEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiNotifications=scsiNotifications, scsiDeviceEntry=scsiDeviceEntry, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportTypes=scsiTransportTypes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiModule=scsiModule, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetGroup=scsiTargetGroup, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportSPI=scsiTranportSPI, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuIndex=scsiLuIndex, scsiTrnsptType=scsiTrnsptType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiInitiator=scsiInitiator, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstIndex=scsiInstIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortIndex=scsiPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId)
