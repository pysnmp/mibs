...
Integer32, ObjectIdentity, MibIdentifier, Bits, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso, TimeTicks, Gauge32, Counter64, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso", "TimeTicks", "Gauge32", "Counter64", "ModuleIdentity", "mib-2")
TruthValue, TimeStamp, AutonomousType, TextualConvention, DisplayString, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiPortRole=scsiPortRole, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiConformance=scsiConformance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiInstAlias=scsiInstAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliance=scsiCompliance, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliances=scsiCompliances, scsiModule=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceRole=scsiDeviceRole, scsiLuIdType=scsiLuIdType, scsiLuInResets=scsiLuInResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdTable=scsiLuIdTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuTable=scsiLuTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTable=scsiPortTable, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortName=scsiTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptIndex=scsiTrnsptIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWwnName=scsiLuWwnName, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdValue=ScsiIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiTargetGroup=scsiTargetGroup, scsiGroups=scsiGroups, scsiLuIndex=scsiLuIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunLun=scsiDscLunLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatus=scsiLuStatus, scsiDeviceResets=scsiDeviceResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtTable=scsiDscTgtTable, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdentifier=ScsiIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTarget=scsiTarget, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiNotifications=scsiNotifications, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuState=scsiLuState, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLun=scsiLunMapLun, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptType=scsiTrnsptType, scsiTransportTypes=scsiTransportTypes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortIndex=scsiPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortEntry=scsiPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapTable=scsiLunMapTable, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSBP=scsiTransportSBP)
