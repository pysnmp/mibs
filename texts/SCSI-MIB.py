...
Gauge32, Counter32, iso, mib_2, ModuleIdentity, Bits, ObjectIdentity, Integer32, NotificationType, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "iso", "mib-2", "ModuleIdentity", "Bits", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32")
AutonomousType, RowPointer, TruthValue, DisplayString, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TruthValue", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiLuIdType=scsiLuIdType, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuState=scsiLuState, scsiTranportSPI=scsiTranportSPI, scsiPortEntry=scsiPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceTable=scsiDeviceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportFCP=scsiTransportFCP, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceRole=scsiDeviceRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiName=ScsiName, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstAlias=scsiInstAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiObjects=scsiObjects, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, scsiLuProductId=scsiLuProductId, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, ScsiIdentifier=ScsiIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiCompliances=scsiCompliances, scsiGroups=scsiGroups, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiConformance=scsiConformance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDevicePortNumber=scsiDevicePortNumber, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetGroup=scsiTargetGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiLuInResets=scsiLuInResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstIndex=scsiInstIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiTransportTypes=scsiTransportTypes, scsiLuTable=scsiLuTable, scsiGeneral=scsiGeneral, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorGroup=scsiInitiatorGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInitiator=scsiInitiator, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiPortTable=scsiPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunLun=scsiDscLunLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliance=scsiCompliance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators)
