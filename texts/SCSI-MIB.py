...
ModuleIdentity, Bits, MibIdentifier, iso, NotificationType, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, TimeTicks, Counter32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "MibIdentifier", "iso", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress")
RowPointer, TextualConvention, TimeStamp, TruthValue, AutonomousType, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TimeStamp", "TruthValue", "AutonomousType", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdTable=scsiLuIdTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiLUNOrZero=ScsiLUNOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiCompliances=scsiCompliances, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdValue=scsiLuIdValue, scsiInitiator=scsiInitiator, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuVendorId=scsiLuVendorId, ScsiName=ScsiName, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, scsiLuTable=scsiLuTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLogicalUnit=scsiLogicalUnit, scsiTransportSRP=scsiTransportSRP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValue=ScsiIndexValue, scsiLuIndex=scsiLuIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, scsiPortEntry=scsiPortEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuProductId=scsiLuProductId, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstAlias=scsiInstAlias, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiCompliance=scsiCompliance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, ScsiIdType=ScsiIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuState=scsiLuState, scsiLuStatus=scsiLuStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiModule=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuEntry=scsiLuEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunLun=scsiDscLunLun, scsiDscLunTable=scsiDscLunTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceRole=scsiDeviceRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGroups=scsiGroups, scsiDeviceResets=scsiDeviceResets, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTargetGroup=scsiTargetGroup, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex)
