...
Gauge32, mib_2, Integer32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Counter64, ObjectIdentity, Bits, Unsigned32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "Integer32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "ObjectIdentity", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks")
RowPointer, RowStatus, AutonomousType, TextualConvention, TimeStamp, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdType=scsiDscLunIdType, scsiTransportISCSI=scsiTransportISCSI, scsiConformance=scsiConformance, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIndex=scsiLuIndex, scsiLuEntry=scsiLuEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiName=ScsiName, scsiTransportTypes=scsiTransportTypes, scsiGeneral=scsiGeneral, scsiLuIdType=scsiLuIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstIndex=scsiInstIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportOther=scsiTranportOther, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiCompliance=scsiCompliance, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuProductId=scsiLuProductId, scsiObjects=scsiObjects, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLun=scsiLunMapLun, scsiTransportSBP=scsiTransportSBP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiLuVendorId=scsiLuVendorId, scsiDscLunLun=scsiDscLunLun, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortName=scsiTgtPortName, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuState=scsiLuState, scsiLuInResets=scsiLuInResets, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiModule=scsiModule, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptType=scsiTrnsptType, scsiLuIdTable=scsiLuIdTable, scsiDeviceTable=scsiDeviceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdValue=scsiLuIdValue, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiDscTgtTable=scsiDscTgtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortRole=scsiPortRole, scsiPortTable=scsiPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiator=scsiInitiator, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTarget=scsiTarget, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiLuTable=scsiLuTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportFCP=scsiTransportFCP, ScsiIdType=ScsiIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGroups=scsiGroups, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiCompliances=scsiCompliances, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs)
