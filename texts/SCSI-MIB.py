...
ModuleIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64, iso, Counter32, IpAddress, TimeTicks, ObjectIdentity, Integer32, Gauge32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64", "iso", "Counter32", "IpAddress", "TimeTicks", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "MibIdentifier")
TextualConvention, TruthValue, DisplayString, AutonomousType, RowStatus, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiName=ScsiName, scsiDeviceResets=scsiDeviceResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiModule=scsiModule, scsiLuStatus=scsiLuStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGeneral=scsiGeneral, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuProductId=scsiLuProductId, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiLuIdType=scsiLuIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstAlias=scsiInstAlias, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliances=scsiCompliances, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstIndex=scsiInstIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiLuWwnName=scsiLuWwnName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdValue=ScsiIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValue=ScsiIndexValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiDscTgtName=scsiDscTgtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtTable=scsiDscTgtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapGroup=scsiLunMapGroup, ScsiIdAssociation=ScsiIdAssociation, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortEntry=scsiPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiCompliance=scsiCompliance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiTargetGroup=scsiTargetGroup, scsiRemoteTarget=scsiRemoteTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTable=scsiPortTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiObjects=scsiObjects, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex)
