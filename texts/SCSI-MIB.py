...
MibIdentifier, NotificationType, Unsigned32, IpAddress, TimeTicks, Integer32, Gauge32, ModuleIdentity, Counter64, mib_2, Counter32, ObjectIdentity, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "IpAddress", "TimeTicks", "Integer32", "Gauge32", "ModuleIdentity", "Counter64", "mib-2", "Counter32", "ObjectIdentity", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, TextualConvention, TruthValue, DisplayString, AutonomousType, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TruthValue", "DisplayString", "AutonomousType", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", PYSNMP_MODULE_ID=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiModule=scsiModule, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiCompliance=scsiCompliance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiator=scsiInitiator, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdTable=scsiLuIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiObjects=scsiObjects, scsiCompliances=scsiCompliances, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdValue=ScsiIdValue, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWwnName=scsiLuWwnName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorGroup=scsiInitiatorGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIndex=scsiLuIndex, scsiPortRole=scsiPortRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstAlias=scsiInstAlias, scsiLuIdEntry=scsiLuIdEntry, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapIndex=scsiLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportSPI=scsiTranportSPI, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceResets=scsiDeviceResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortEntry=scsiPortEntry, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiConformance=scsiConformance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuVendorId=scsiLuVendorId, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdType=ScsiIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiLuTable=scsiLuTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapGroup=scsiLunMapGroup)
