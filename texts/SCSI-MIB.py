...
Gauge32, IpAddress, NotificationType, Integer32, TimeTicks, ModuleIdentity, Unsigned32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter64, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "NotificationType", "Integer32", "TimeTicks", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter64", "mib-2", "MibIdentifier")
DisplayString, RowPointer, AutonomousType, TimeStamp, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "AutonomousType", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiator=scsiInitiator, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiNotifications=scsiNotifications, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportTypes=scsiTransportTypes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceRole=scsiDeviceRole, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliance=scsiCompliance, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapTable=scsiLunMapTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstIndex=scsiInstIndex, ScsiName=ScsiName, scsiTranportOther=scsiTranportOther, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuInResets=scsiLuInResets, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptType=scsiTrnsptType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiLuIndex=scsiLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiDeviceTable=scsiDeviceTable, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLuVendorId=scsiLuVendorId, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdentifier=ScsiIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSRP=scsiTransportSRP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdValue=ScsiIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWwnName=scsiLuWwnName, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuProductId=scsiLuProductId, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiPortTable=scsiPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiPortEntry=scsiPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTarget=scsiTarget, scsiDscLunLun=scsiDscLunLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTransportISCSI=scsiTransportISCSI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiConformance=scsiConformance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortName=scsiTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiModule=scsiModule, scsiPortRole=scsiPortRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuEntry=scsiLuEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes)
