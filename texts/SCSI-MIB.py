...
mib_2, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, TimeTicks, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, Integer32, Counter32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "TimeTicks", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Integer32", "Counter32", "IpAddress", "Gauge32")
TimeStamp, TextualConvention, RowStatus, DisplayString, AutonomousType, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtName=scsiIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportISCSI=scsiTransportISCSI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportOther=scsiTranportOther, scsiLuIndex=scsiLuIndex, ScsiIdentifier=ScsiIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstAlias=scsiInstAlias, scsiCompliances=scsiCompliances, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdType=ScsiIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportFCP=scsiTransportFCP, scsiPortEntry=scsiPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortRole=scsiPortRole, scsiTransportTypes=scsiTransportTypes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdAssociation=scsiLuIdAssociation, ScsiName=ScsiName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapGroup=scsiLunMapGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTarget=scsiTarget, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdType=scsiLuIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiConformance=scsiConformance, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotifications=scsiNotifications, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuState=scsiLuState, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptTable=scsiTrnsptTable, scsiLuInResets=scsiLuInResets, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdValue=ScsiIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunLun=scsiDscLunLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiCompliance=scsiCompliance, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGeneral=scsiGeneral, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiator=scsiInitiator, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuProductId=scsiLuProductId, scsiTranportSPI=scsiTranportSPI, scsiLuStatus=scsiLuStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIndex=scsiDscLunIndex, scsiGroups=scsiGroups, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstIndex=scsiInstIndex, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands)
