...
Unsigned32, ModuleIdentity, Gauge32, Counter64, mib_2, MibIdentifier, Counter32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ObjectIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter64", "mib-2", "MibIdentifier", "Counter32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ObjectIdentity", "Bits", "NotificationType")
RowStatus, RowPointer, TruthValue, AutonomousType, TextualConvention, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TruthValue", "AutonomousType", "TextualConvention", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdValue=ScsiIdValue, scsiTransportSRP=scsiTransportSRP, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiDeviceRole=scsiDeviceRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiModule=scsiModule, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuProductId=scsiLuProductId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiCompliances=scsiCompliances, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdIndex=scsiLuIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportSPI=scsiTranportSPI, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIndex=scsiLuIndex, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTable=scsiIntrDevTable, scsiInitiator=scsiInitiator, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstAlias=scsiInstAlias, scsiDeviceTable=scsiDeviceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiNotifications=scsiNotifications, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiObjects=scsiObjects, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiGeneral=scsiGeneral, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiPortRole=scsiPortRole, scsiLuTable=scsiLuTable, scsiDscLunEntry=scsiDscLunEntry, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuState=scsiLuState, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiLuInCommands=scsiLuInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiLunMapTable=scsiLunMapTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdType=ScsiIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdValue=scsiLuIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiPortEntry=scsiPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTable=scsiPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiPortIndex=scsiPortIndex)
