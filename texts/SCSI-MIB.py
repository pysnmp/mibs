...
IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, MibIdentifier, Integer32, Unsigned32, Gauge32, mib_2, iso, ObjectIdentity, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "MibIdentifier", "Integer32", "Unsigned32", "Gauge32", "mib-2", "iso", "ObjectIdentity", "Bits", "TimeTicks")
DisplayString, RowPointer, AutonomousType, TimeStamp, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "AutonomousType", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiLuState=scsiLuState, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapLun=scsiLunMapLun, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiNotifications=scsiNotifications, scsiTranportOther=scsiTranportOther, scsiPortIndex=scsiPortIndex, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportSPI=scsiTranportSPI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuTable=scsiLuTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiModule=scsiModule, scsiInitiator=scsiInitiator, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportSRP=scsiTransportSRP, scsiLuInResets=scsiLuInResets, scsiGroups=scsiGroups, scsiDeviceTable=scsiDeviceTable, scsiPortEntry=scsiPortEntry, scsiLuEntry=scsiLuEntry, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevTable=scsiIntrDevTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiLuProductId=scsiLuProductId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiCompliances=scsiCompliances, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, ScsiIndexValue=ScsiIndexValue, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdType=ScsiIdType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTable=scsiPortTable, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptType=scsiTrnsptType, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiObjects=scsiObjects, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstAlias=scsiInstAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGeneral=scsiGeneral, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtName=scsiDscTgtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx)
