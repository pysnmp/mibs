...
Counter64, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, iso, TimeTicks, ObjectIdentity, ModuleIdentity, NotificationType, Unsigned32, Counter32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "iso", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Unsigned32", "Counter32", "Integer32", "Gauge32")
TruthValue, AutonomousType, TextualConvention, TimeStamp, RowPointer, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "TextualConvention", "TimeStamp", "RowPointer", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTarget=scsiTarget, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiGeneral=scsiGeneral, scsiLunMapTable=scsiLunMapTable, scsiInitiator=scsiInitiator, scsiTargetGroup=scsiTargetGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiLuProductId=scsiLuProductId, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuTable=scsiLuTable, scsiCompliances=scsiCompliances, scsiLuEntry=scsiLuEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunTable=scsiDscLunTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortEntry=scsiPortEntry, scsiConformance=scsiConformance, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuVendorId=scsiLuVendorId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGroups=scsiGroups, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuRevisionId=scsiLuRevisionId, scsiModule=scsiModule, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceResets=scsiDeviceResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdType=scsiLuIdType, scsiInstanceEntry=scsiInstanceEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuPeripheralType=scsiLuPeripheralType, scsiObjects=scsiObjects, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtTable=scsiIntrPrtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotifications=scsiNotifications, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunLun=scsiDscLunLun, scsiPortTable=scsiPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortName=scsiTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportTypes=scsiTransportTypes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceRole=scsiDeviceRole, scsiTransportSRP=scsiTransportSRP, scsiTrnsptType=scsiTrnsptType, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportOther=scsiTranportOther, scsiLuIdValue=scsiLuIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIndex=scsiLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceTable=scsiInstanceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstAlias=scsiInstAlias, scsiRemoteTarget=scsiRemoteTarget, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevOutResets=scsiIntrDevOutResets)
