...
ModuleIdentity, mib_2, Counter64, Integer32, Counter32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ObjectIdentity, iso, Unsigned32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "Counter64", "Integer32", "Counter32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ObjectIdentity", "iso", "Unsigned32", "NotificationType", "IpAddress")
TimeStamp, AutonomousType, DisplayString, TruthValue, RowStatus, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "RowStatus", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuVendorId=scsiLuVendorId, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInCommands=scsiLuInCommands, ScsiIdentifier=ScsiIdentifier, scsiTranportOther=scsiTranportOther, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiInstAlias=scsiInstAlias, scsiLuIndex=scsiLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortName=scsiTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevTable=scsiTgtDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapTable=scsiLunMapTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatus=scsiLuStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortRole=scsiPortRole, scsiConformance=scsiConformance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortTable=scsiTgtPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdValue=scsiLuIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdIndex=scsiLuIdIndex, ScsiIdType=ScsiIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiNotifications=scsiNotifications, scsiLuIdType=scsiLuIdType, scsiGroups=scsiGroups, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapGroup=scsiLunMapGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetGroup=scsiTargetGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLunMapLun=scsiLunMapLun, scsiModule=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSBP=scsiTransportSBP, scsiLuIdTable=scsiLuIdTable, scsiPortTable=scsiPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiGeneral=scsiGeneral, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptType=scsiTrnsptType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, scsiCompliances=scsiCompliances, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiInitiator=scsiInitiator, scsiTarget=scsiTarget, scsiDeviceRole=scsiDeviceRole, scsiInstIndex=scsiInstIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuTable=scsiLuTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSRP=scsiTransportSRP, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapEntry=scsiLunMapEntry, ScsiIdValue=ScsiIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiTranportSPI=scsiTranportSPI, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuProductId=scsiLuProductId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuEntry=scsiLuEntry, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
