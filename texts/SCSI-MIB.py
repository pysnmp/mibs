...
ModuleIdentity, Counter64, Bits, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, TimeTicks, Counter32, iso, MibIdentifier, mib_2, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "TimeTicks", "Counter32", "iso", "MibIdentifier", "mib-2", "Gauge32", "IpAddress")
AutonomousType, TruthValue, TimeStamp, RowPointer, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunLun=scsiDscLunLun, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdValue=ScsiIdValue, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTable=scsiPortTable, scsiLuTable=scsiLuTable, scsiModule=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstIndex=scsiInstIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLun=scsiLunMapLun, scsiConformance=scsiConformance, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliances=scsiCompliances, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtEntry=scsiDscTgtEntry, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiLuWwnName=scsiLuWwnName, scsiTransportSBP=scsiTransportSBP, scsiNotifications=scsiNotifications, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, scsiDeviceRole=scsiDeviceRole, scsiLuIdIndex=scsiLuIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTarget=scsiTarget, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunTable=scsiDscLunTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiGroups=scsiGroups, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetGroup=scsiTargetGroup, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiObjects=scsiObjects, scsiPortRole=scsiPortRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatus=scsiLuStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIndex=scsiLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstAlias=scsiInstAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtName=scsiDscTgtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortIndex=scsiPortIndex)
