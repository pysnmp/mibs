...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity, Gauge32, iso, Integer32, Unsigned32, ObjectIdentity, mib_2, MibIdentifier, Counter64, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity", "Gauge32", "iso", "Integer32", "Unsigned32", "ObjectIdentity", "mib-2", "MibIdentifier", "Counter64", "Counter32", "NotificationType")
RowPointer, TextualConvention, TimeStamp, RowStatus, AutonomousType, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TimeStamp", "RowStatus", "AutonomousType", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuTable=scsiLuTable, scsiDscLunLun=scsiDscLunLun, scsiPortIndex=scsiPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortEntry=scsiPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstIndex=scsiInstIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdTable=scsiLuIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotifications=scsiNotifications, ScsiIdType=ScsiIdType, scsiAuthIntrName=scsiAuthIntrName, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiGroups=scsiGroups, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTransportSRP=scsiTransportSRP, scsiModule=scsiModule, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLuIdValue=scsiLuIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliance=scsiCompliance, scsiLuStatus=scsiLuStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortTable=scsiTgtPortTable, ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdType=scsiLuIdType, scsiInitiator=scsiInitiator, ScsiName=ScsiName, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTranportOther=scsiTranportOther, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIndex=scsiLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdAssociation=ScsiIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstAlias=scsiInstAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiConformance=scsiConformance, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuEntry=scsiLuEntry, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceTable=scsiInstanceTable, scsiPortTable=scsiPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuState=scsiLuState, scsiGeneral=scsiGeneral, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapTable=scsiLunMapTable, scsiTrnsptType=scsiTrnsptType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInResets=scsiLuInResets, scsiTgtPortName=scsiTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliances=scsiCompliances, scsiTargetGroup=scsiTargetGroup, scsiLuVendorId=scsiLuVendorId, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP)
