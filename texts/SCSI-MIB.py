...
TimeTicks, Gauge32, Counter32, Unsigned32, NotificationType, Bits, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Integer32, MibIdentifier, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter32", "Unsigned32", "NotificationType", "Bits", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Integer32", "MibIdentifier", "IpAddress", "mib-2")
DisplayString, AutonomousType, RowStatus, TextualConvention, TruthValue, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowStatus", "TextualConvention", "TruthValue", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTransportTypes=scsiTransportTypes, scsiDeviceRole=scsiDeviceRole, scsiPortRole=scsiPortRole, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiName=ScsiName, scsiLuProductId=scsiLuProductId, scsiDscLunTable=scsiDscLunTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapEntry=scsiLunMapEntry, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortIndex=scsiPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdTable=scsiLuIdTable, scsiLuInResets=scsiLuInResets, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliances=scsiCompliances, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiPortTable=scsiPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotifications=scsiNotifications, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtTable=scsiDscTgtTable, scsiTranportOther=scsiTranportOther, scsiLuStatus=scsiLuStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiObjects=scsiObjects, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportSRP=scsiTransportSRP, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiModule=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiLuEntry=scsiLuEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunLun=scsiDscLunLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGroups=scsiGroups, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiTransportFCP=scsiTransportFCP, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapIndex=scsiLunMapIndex, scsiInstAlias=scsiInstAlias, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiTarget=scsiTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliance=scsiCompliance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuTable=scsiLuTable, scsiLuIdType=scsiLuIdType, scsiIntrDevTable=scsiIntrDevTable, PYSNMP_MODULE_ID=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdType=ScsiIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiator=scsiInitiator, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceTable=scsiInstanceTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiGeneral=scsiGeneral, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable)
