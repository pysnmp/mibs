...
Integer32, Counter64, Unsigned32, Bits, IpAddress, MibIdentifier, NotificationType, ModuleIdentity, TimeTicks, Gauge32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Unsigned32", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "ModuleIdentity", "TimeTicks", "Gauge32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32")
DisplayString, RowStatus, RowPointer, TruthValue, TimeStamp, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteTarget=scsiRemoteTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiTranportOther=scsiTranportOther, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiModule=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiCompliance=scsiCompliance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTable=scsiPortTable, scsiGeneral=scsiGeneral, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiator=scsiInitiator, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdType=scsiLuIdType, scsiTransportTypes=scsiTransportTypes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuEntry=scsiLuEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliances=scsiCompliances, scsiLuIndex=scsiLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdType=scsiDscLunIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuStatus=scsiLuStatus, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInResets=scsiLuInResets, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLuWwnName=scsiLuWwnName, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, ScsiIdentifier=ScsiIdentifier, scsiInstIndex=scsiInstIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceRole=scsiDeviceRole, scsiObjects=scsiObjects, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuVendorId=scsiLuVendorId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiLuProductId=scsiLuProductId, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIdType=ScsiIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceGroup=scsiDeviceGroup, scsiNotifications=scsiNotifications, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceEntry=scsiDeviceEntry, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTransportFCP=scsiTransportFCP, scsiDscTgtTable=scsiDscTgtTable, scsiConformance=scsiConformance, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptType=scsiTrnsptType, scsiTarget=scsiTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex)
