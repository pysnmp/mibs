...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Counter64, Counter32, NotificationType, Gauge32, Bits, MibIdentifier, mib_2, TimeTicks, iso, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Counter64", "Counter32", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "mib-2", "TimeTicks", "iso", "ObjectIdentity", "Unsigned32")
AutonomousType, RowStatus, DisplayString, TimeStamp, RowPointer, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "RowPointer", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiModule=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTranportOther=scsiTranportOther, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuTable=scsiLuTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdentifier=ScsiIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiCompliances=scsiCompliances, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapLun=scsiLunMapLun, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSRP=scsiTransportSRP, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValue=ScsiIndexValue, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiGroups=scsiGroups, scsiGeneral=scsiGeneral, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiLuStatus=scsiLuStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiNotifications=scsiNotifications, scsiLuInResets=scsiLuInResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportTypes=scsiTransportTypes, scsiTarget=scsiTarget, ScsiName=ScsiName, scsiLuState=scsiLuState, scsiInstAlias=scsiInstAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrName=scsiAuthIntrName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdType=ScsiIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, PYSNMP_MODULE_ID=scsiModule, scsiLuEntry=scsiLuEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstIndex=scsiInstIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIndex=scsiLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtName=scsiIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiator=scsiInitiator, scsiTargetGroup=scsiTargetGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortEntry=scsiTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup)
