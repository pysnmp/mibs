...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, ObjectIdentity, TimeTicks, IpAddress, Counter32, mib_2, NotificationType, Unsigned32, ModuleIdentity, Integer32, Gauge32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter32", "mib-2", "NotificationType", "Unsigned32", "ModuleIdentity", "Integer32", "Gauge32", "MibIdentifier", "Counter64")
TimeStamp, TruthValue, RowStatus, DisplayString, TextualConvention, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiInstIndex=scsiInstIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapGroup=scsiLunMapGroup, ScsiIdAssociation=ScsiIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiObjects=scsiObjects, scsiLuEntry=scsiLuEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportTypes=scsiTransportTypes, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiTranportOther=scsiTranportOther, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliance=scsiCompliance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportSPI=scsiTranportSPI, scsiLuIndex=scsiLuIndex, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortName=scsiTgtPortName, scsiPortTable=scsiPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdValue=ScsiIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetGroup=scsiTargetGroup, scsiLuState=scsiLuState, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceEntry=scsiInstanceEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportSBP=scsiTransportSBP, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGroups=scsiGroups, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapLun=scsiLunMapLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiConformance=scsiConformance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportFCP=scsiTransportFCP, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstVendorVersion=scsiInstVendorVersion, scsiCompliances=scsiCompliances, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuTable=scsiLuTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatus=scsiLuStatus, scsiLuWwnName=scsiLuWwnName, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiNotifications=scsiNotifications, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapTable=scsiLunMapTable, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, ScsiName=ScsiName, scsiModule=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuProductId=scsiLuProductId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunTable=scsiDscLunTable, scsiPortRole=scsiPortRole, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSRP=scsiTransportSRP, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiInitiator=scsiInitiator, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceTable=scsiInstanceTable, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGeneral=scsiGeneral, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceRole=scsiDeviceRole)
