...
Integer32, Counter32, Bits, IpAddress, Gauge32, mib_2, Counter64, NotificationType, ModuleIdentity, iso, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Bits", "IpAddress", "Gauge32", "mib-2", "Counter64", "NotificationType", "ModuleIdentity", "iso", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32")
AutonomousType, TextualConvention, RowStatus, TruthValue, DisplayString, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "RowStatus", "TruthValue", "DisplayString", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortTrnsptPtr=scsiPortTrnsptPtr, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunTable=scsiDscLunTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuProductId=scsiLuProductId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, scsiLunMapLun=scsiLunMapLun, scsiTargetGroup=scsiTargetGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTransportFCP=scsiTransportFCP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiator=scsiInitiator, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceTable=scsiInstanceTable, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportISCSI=scsiTransportISCSI, scsiLuWwnName=scsiLuWwnName, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiGroups=scsiGroups, scsiTgtDevEntry=scsiTgtDevEntry, scsiModule=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiPortEntry=scsiPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiLuRevisionId=scsiLuRevisionId, scsiLuInCommands=scsiLuInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIndex=scsiLuIndex, ScsiIdValue=ScsiIdValue, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiConformance=scsiConformance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuStatus=scsiLuStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtTable=scsiDscTgtTable, scsiNotifications=scsiNotifications, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTable=scsiPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuState=scsiLuState, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInResets=scsiLuInResets, scsiGeneral=scsiGeneral, scsiDeviceTable=scsiDeviceTable, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, scsiTransportTypes=scsiTransportTypes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, ScsiIdCodeSet=ScsiIdCodeSet)
