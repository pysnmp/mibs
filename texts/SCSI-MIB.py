...
mib_2, iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Counter32, Bits, IpAddress, NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Counter32", "Bits", "IpAddress", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Integer32")
RowPointer, TimeStamp, TextualConvention, DisplayString, RowStatus, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLuIndex=scsiLuIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiConformance=scsiConformance, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiCompliances=scsiCompliances, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatus=scsiLuStatus, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuTable=scsiLuTable, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuState=scsiLuState, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGroups=scsiGroups, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceTable=scsiInstanceTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTable=scsiIntrDevTable, scsiPortTable=scsiPortTable, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortIndex=scsiPortIndex, scsiInstIndex=scsiInstIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdIndex=scsiLuIdIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdType=ScsiIdType, ScsiIdValue=ScsiIdValue, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiator=scsiInitiator, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliance=scsiCompliance, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuInResets=scsiLuInResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiInstAlias=scsiInstAlias, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptType=scsiTrnsptType, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceAlias=scsiDeviceAlias, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiGeneral=scsiGeneral, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuEntry=scsiLuEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
