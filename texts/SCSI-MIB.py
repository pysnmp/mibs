...
ObjectIdentity, mib_2, NotificationType, MibIdentifier, Gauge32, Bits, IpAddress, iso, Unsigned32, ModuleIdentity, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "NotificationType", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "iso", "Unsigned32", "ModuleIdentity", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
TextualConvention, TimeStamp, AutonomousType, RowStatus, DisplayString, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "AutonomousType", "RowStatus", "DisplayString", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuState=scsiLuState, scsiPortIndex=scsiPortIndex, scsiInitiator=scsiInitiator, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTarget=scsiTarget, scsiGroups=scsiGroups, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuVendorId=scsiLuVendorId, ScsiIdentifier=ScsiIdentifier, scsiDscLunLun=scsiDscLunLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceIndex=scsiDeviceIndex, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdValue=ScsiIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportTypes=scsiTransportTypes, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValue=ScsiIndexValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliance=scsiCompliance, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdValue=scsiLuIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuTable=scsiLuTable, scsiLuInResets=scsiLuInResets, scsiNotifications=scsiNotifications, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiName=ScsiName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuProductId=scsiLuProductId, scsiCompliances=scsiCompliances, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortName=scsiTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiLuEntry=scsiLuEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuIndex=scsiLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiObjects=scsiObjects, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceRole=scsiDeviceRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiPortRole=scsiPortRole, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstAlias=scsiInstAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdType=scsiLuIdType, scsiPortBusyStatuses=scsiPortBusyStatuses)
