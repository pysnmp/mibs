...
IpAddress, NotificationType, ModuleIdentity, mib_2, ObjectIdentity, Counter32, TimeTicks, MibIdentifier, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "ModuleIdentity", "mib-2", "ObjectIdentity", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Gauge32", "iso")
RowStatus, TimeStamp, AutonomousType, DisplayString, TruthValue, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtName=scsiDscTgtName, scsiTranportOther=scsiTranportOther, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortEntry=scsiPortEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiLuVendorId=scsiLuVendorId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiCompliance=scsiCompliance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortName=scsiTgtPortName, scsiLuStatus=scsiLuStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiLuIndex=scsiLuIndex, scsiLuState=scsiLuState, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiGroups=scsiGroups, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSRP=scsiTransportSRP, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTarget=scsiTarget, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiName=ScsiName, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdType=ScsiIdType, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortRole=scsiPortRole, scsiTargetGroup=scsiTargetGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiDscLunIndex=scsiDscLunIndex, scsiLuWwnName=scsiLuWwnName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGeneral=scsiGeneral, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceIndex=scsiDeviceIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiInitiator=scsiInitiator, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdValue=ScsiIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiObjects=scsiObjects, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdType=scsiLuIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLogicalUnit=scsiLogicalUnit, scsiPortIndex=scsiPortIndex, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiTransportFCP=scsiTransportFCP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuEntry=scsiLuEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiPortTable=scsiPortTable, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunEntry=scsiDscLunEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiConformance=scsiConformance, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInCommands=scsiLuInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup)
