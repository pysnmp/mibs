...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, ObjectIdentity, IpAddress, NotificationType, Integer32, Counter64, MibIdentifier, Counter32, Bits, TimeTicks, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "Integer32", "Counter64", "MibIdentifier", "Counter32", "Bits", "TimeTicks", "Unsigned32", "Gauge32")
RowPointer, AutonomousType, DisplayString, TruthValue, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdType=scsiLuIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdAssociation=ScsiIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLun=scsiLunMapLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiDscLunTable=scsiDscLunTable, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, scsiDscTgtName=scsiDscTgtName, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceGroup=scsiDeviceGroup, scsiLuState=scsiLuState, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotifications=scsiNotifications, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuInResets=scsiLuInResets, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuTable=scsiLuTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTable=scsiIntrDevTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiObjects=scsiObjects, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiCompliance=scsiCompliance, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportOther=scsiTranportOther, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdType=ScsiIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSBP=scsiTransportSBP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiator=scsiInitiator, scsiTranportSPI=scsiTranportSPI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiPortRole=scsiPortRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTable=scsiPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiCompliances=scsiCompliances, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiTransportSRP=scsiTransportSRP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiModule=scsiModule, scsiGeneral=scsiGeneral, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue)
