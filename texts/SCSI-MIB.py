...
Integer32, Counter32, IpAddress, TimeTicks, Bits, NotificationType, iso, ObjectIdentity, MibIdentifier, Counter64, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "IpAddress", "TimeTicks", "Bits", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity")
TruthValue, TimeStamp, DisplayString, RowPointer, RowStatus, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "RowPointer", "RowStatus", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTarget=scsiTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiLuIdAssociation=scsiLuIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliances=scsiCompliances, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdentifier=ScsiIdentifier, ScsiName=ScsiName, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiLuWwnName=scsiLuWwnName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportISCSI=scsiTransportISCSI, scsiPortIndex=scsiPortIndex, scsiTransportSBP=scsiTransportSBP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiPortRole=scsiPortRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiator=scsiInitiator, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdTable=scsiLuIdTable, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuHSInCommands=scsiLuHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuInResets=scsiLuInResets, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiInstanceEntry=scsiInstanceEntry, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuTable=scsiLuTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceIndex=scsiDeviceIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunLun=scsiDscLunLun, ScsiIdAssociation=ScsiIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceResets=scsiDeviceResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuEntry=scsiLuEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiCompliance=scsiCompliance, ScsiIndexValue=ScsiIndexValue, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdType=ScsiIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstIndex=scsiInstIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLuRevisionId=scsiLuRevisionId, scsiGroups=scsiGroups, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortEntry=scsiPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTable=scsiPortTable, scsiDeviceRole=scsiDeviceRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdType=scsiLuIdType)
