...
Unsigned32, TimeTicks, ModuleIdentity, iso, Integer32, Bits, Gauge32, ObjectIdentity, Counter64, IpAddress, NotificationType, MibIdentifier, mib_2, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "ModuleIdentity", "iso", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "mib-2", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, RowPointer, DisplayString, TimeStamp, TextualConvention, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "DisplayString", "TimeStamp", "TextualConvention", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapEntry=scsiLunMapEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdEntry=scsiLuIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuInCommands=scsiLuInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSRP=scsiTransportSRP, ScsiIdType=ScsiIdType, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdType=scsiLuIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstIndex=scsiInstIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiLuInResets=scsiLuInResets, scsiLuEntry=scsiLuEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortTable=scsiAttTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiator=scsiInitiator, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunTable=scsiDscLunTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiObjects=scsiObjects, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGroups=scsiGroups, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLun=scsiLunMapLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuProductId=scsiLuProductId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportFCP=scsiTransportFCP, scsiLuTable=scsiLuTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdValue=ScsiIdValue, scsiTarget=scsiTarget, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiName=ScsiName, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiPortTable=scsiPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWwnName=scsiLuWwnName, PYSNMP_MODULE_ID=scsiModule, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortIndex=scsiPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiConformance=scsiConformance, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdentifier=ScsiIdentifier, scsiTrnsptType=scsiTrnsptType, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiModule=scsiModule, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiCompliance=scsiCompliance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup)
