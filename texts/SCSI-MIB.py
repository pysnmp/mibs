...
Integer32, ObjectIdentity, Bits, MibIdentifier, Counter64, TimeTicks, IpAddress, mib_2, Unsigned32, ModuleIdentity, Counter32, Gauge32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Bits", "MibIdentifier", "Counter64", "TimeTicks", "IpAddress", "mib-2", "Unsigned32", "ModuleIdentity", "Counter32", "Gauge32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, DisplayString, TruthValue, RowPointer, TimeStamp, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiLuState=scsiLuState, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiConformance=scsiConformance, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiGroups=scsiGroups, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliances=scsiCompliances, scsiDscTgtIndex=scsiDscTgtIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiCompliance=scsiCompliance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiObjects=scsiObjects, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportSPI=scsiTranportSPI, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiator=scsiInitiator, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSRP=scsiTransportSRP, scsiLuProductId=scsiLuProductId, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiTransportFCP=scsiTransportFCP, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTargetGroup=scsiTargetGroup, scsiLuInCommands=scsiLuInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTarget=scsiTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstIndex=scsiInstIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuEntry=scsiLuEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGeneral=scsiGeneral, scsiDscLunIdType=scsiDscLunIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuInResets=scsiLuInResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiLuIndex=scsiLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiName=ScsiName, scsiLuWwnName=scsiLuWwnName, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdTable=scsiLuIdTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunLun=scsiDscLunLun, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiNotifications=scsiNotifications, scsiDscTgtName=scsiDscTgtName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiInstAlias=scsiInstAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuVendorId=scsiLuVendorId, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdType=ScsiIdType, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable)
