...
NotificationType, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, ModuleIdentity, MibIdentifier, Bits, ObjectIdentity, Unsigned32, iso, TimeTicks, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "ModuleIdentity", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "iso", "TimeTicks", "Gauge32", "Counter64")
TruthValue, DisplayString, AutonomousType, RowStatus, TextualConvention, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "TextualConvention", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportFCP=scsiTransportFCP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiTarget=scsiTarget, scsiDscTgtTable=scsiDscTgtTable, scsiLuIndex=scsiLuIndex, scsiGeneral=scsiGeneral, scsiTgtDevTable=scsiTgtDevTable, scsiObjects=scsiObjects, scsiPortTable=scsiPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiDscLunEntry=scsiDscLunEntry, scsiLuProductId=scsiLuProductId, scsiLuIdTable=scsiLuIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortEntry=scsiPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuInResets=scsiLuInResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiName=ScsiName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliance=scsiCompliance, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiGroups=scsiGroups, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, ScsiIdentifier=ScsiIdentifier, scsiInstAlias=scsiInstAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstIndex=scsiInstIndex, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTranportOther=scsiTranportOther, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiModule=scsiModule, scsiLuInCommands=scsiLuInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiConformance=scsiConformance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, ScsiIdType=ScsiIdType, scsiPortRole=scsiPortRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuTable=scsiLuTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiInstanceTable=scsiInstanceTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuEntry=scsiLuEntry, scsiCompliances=scsiCompliances, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiLunMapLun=scsiLunMapLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortIndex=scsiPortIndex, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex)
