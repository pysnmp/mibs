...
Gauge32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, TimeTicks, Counter32, mib_2, ModuleIdentity, MibIdentifier, NotificationType, IpAddress, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "TimeTicks", "Counter32", "mib-2", "ModuleIdentity", "MibIdentifier", "NotificationType", "IpAddress", "Unsigned32", "Counter64")
DisplayString, RowPointer, AutonomousType, RowStatus, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "AutonomousType", "RowStatus", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunTable=scsiDscLunTable, scsiLuTable=scsiLuTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdValue=ScsiIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdType=ScsiIdType, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceEntry=scsiInstanceEntry, scsiPortEntry=scsiPortEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunLun=scsiDscLunLun, scsiConformance=scsiConformance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiPortIndex=scsiPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdTable=scsiLuIdTable, scsiInitiator=scsiInitiator, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliance=scsiCompliance, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportOther=scsiTranportOther, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortRole=scsiPortRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuState=scsiLuState, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuEntry=scsiLuEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIndex=scsiLuIndex, ScsiIndexValue=ScsiIndexValue, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiLunMapLun=scsiLunMapLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceTable=scsiDeviceTable, scsiGroups=scsiGroups, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTarget=scsiTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdType=scsiDscLunIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiCompliances=scsiCompliances, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSBP=scsiTransportSBP, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdType=scsiLuIdType, scsiModule=scsiModule)
