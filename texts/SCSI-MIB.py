...
ModuleIdentity, Counter64, iso, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ObjectIdentity, Integer32, IpAddress, Gauge32, Bits, MibIdentifier, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "iso", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ObjectIdentity", "Integer32", "IpAddress", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "NotificationType")
AutonomousType, TimeStamp, DisplayString, TextualConvention, RowPointer, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "DisplayString", "TextualConvention", "RowPointer", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiConformance=scsiConformance, scsiNotifications=scsiNotifications, ScsiIdentifier=ScsiIdentifier, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortEntry=scsiPortEntry, scsiLunMapTable=scsiLunMapTable, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiRemoteInitiators=scsiRemoteInitiators, PYSNMP_MODULE_ID=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatus=scsiLuStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdType=scsiLuIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptTable=scsiTrnsptTable, ScsiIdAssociation=ScsiIdAssociation, scsiPortIndex=scsiPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunEntry=scsiDscLunEntry, scsiInitiatorGroup=scsiInitiatorGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuProductId=scsiLuProductId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuEntry=scsiLuEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortTable=scsiTgtPortTable, scsiPortTable=scsiPortTable, scsiPortRole=scsiPortRole, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdEntry=scsiLuIdEntry, scsiTransportFCP=scsiTransportFCP, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortName=scsiTgtPortName, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInResets=scsiLuInResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtName=scsiDscTgtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLun=scsiLunMapLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiLuInCommands=scsiLuInCommands, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdTable=scsiDscLunIdTable, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunTable=scsiDscLunTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiName=ScsiName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiModule=scsiModule, scsiLunMapIndex=scsiLunMapIndex, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceEntry=scsiDeviceEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdValue=ScsiIdValue, ScsiIdType=ScsiIdType, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceResets=scsiDeviceResets, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
