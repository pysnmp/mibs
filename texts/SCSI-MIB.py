...
ModuleIdentity, Unsigned32, ObjectIdentity, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, MibIdentifier, Bits, NotificationType, Integer32, Gauge32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "MibIdentifier", "Bits", "NotificationType", "Integer32", "Gauge32", "iso", "Counter64")
RowStatus, RowPointer, TextualConvention, AutonomousType, DisplayString, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TextualConvention", "AutonomousType", "DisplayString", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, ScsiIdValue=ScsiIdValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunEntry=scsiDscLunEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiCompliances=scsiCompliances, scsiDscTgtName=scsiDscTgtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiGeneral=scsiGeneral, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdType=scsiDscLunIdType, scsiLuEntry=scsiLuEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceTable=scsiInstanceTable, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevTable=scsiTgtDevTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGroups=scsiGroups, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiTargetGroup=scsiTargetGroup, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortEntry=scsiPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTranportSPI=scsiTranportSPI, ScsiIdType=ScsiIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrName=scsiAuthIntrName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuInResets=scsiLuInResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortTable=scsiPortTable, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotifications=scsiNotifications, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceTable=scsiDeviceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstIndex=scsiInstIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuWwnName=scsiLuWwnName, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortRole=scsiPortRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuProductId=scsiLuProductId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiLuState=scsiLuState, scsiDeviceAlias=scsiDeviceAlias, scsiPortIndex=scsiPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiCompliance=scsiCompliance, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs)
