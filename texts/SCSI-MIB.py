...
Unsigned32, Counter64, TimeTicks, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, iso, ModuleIdentity, Bits, NotificationType, Gauge32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "TimeTicks", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "iso", "ModuleIdentity", "Bits", "NotificationType", "Gauge32", "ObjectIdentity", "IpAddress")
RowPointer, TextualConvention, AutonomousType, TimeStamp, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdIndex=scsiLuIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliances=scsiCompliances, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunLun=scsiDscLunLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdType=scsiDscLunIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdEntry=scsiLuIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceEntry=scsiDeviceEntry, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTarget=scsiTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapTable=scsiLunMapTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunTable=scsiDscLunTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceRole=scsiDeviceRole, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiNotifications=scsiNotifications, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiTrnsptPointer=scsiTrnsptPointer, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdType=ScsiIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiator=scsiInitiator, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptType=scsiTrnsptType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiTgtPortName=scsiTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIndex=scsiLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportFCP=scsiTransportFCP, scsiLuVendorId=scsiLuVendorId, scsiGroups=scsiGroups, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiModule=scsiModule, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTransportSRP=scsiTransportSRP, scsiInstAlias=scsiInstAlias, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuState=scsiLuState, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortEntry=scsiPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuTable=scsiLuTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiCompliance=scsiCompliance, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiObjects=scsiObjects, scsiInstIndex=scsiInstIndex, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdTable=scsiLuIdTable, scsiLuInResets=scsiLuInResets, scsiInstanceEntry=scsiInstanceEntry, scsiTranportOther=scsiTranportOther, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdType=scsiLuIdType, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceTable=scsiInstanceTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId)
