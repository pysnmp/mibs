...
ObjectIdentity, IpAddress, NotificationType, Gauge32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, TimeTicks, MibIdentifier, iso, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "NotificationType", "Gauge32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "TimeTicks", "MibIdentifier", "iso", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptType=scsiTrnsptType, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdTable=scsiLuIdTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuRevisionId=scsiLuRevisionId, scsiInstVendorVersion=scsiInstVendorVersion, ScsiName=ScsiName, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiGroups=scsiGroups, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuTable=scsiLuTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapEntry=scsiLunMapEntry, scsiCompliance=scsiCompliance, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetGroup=scsiTargetGroup, scsiTrnsptTable=scsiTrnsptTable, scsiModule=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportFCP=scsiTransportFCP, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunTable=scsiDscLunTable, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiLuVendorId=scsiLuVendorId, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTable=scsiPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiInstanceTable=scsiInstanceTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdValue=ScsiIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiInstAlias=scsiInstAlias, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortIndex=scsiPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGeneral=scsiGeneral, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuProductId=scsiLuProductId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceIndex=scsiDeviceIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapTable=scsiLunMapTable, ScsiIdType=ScsiIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportTypes=scsiTransportTypes, scsiCompliances=scsiCompliances, scsiLuIndex=scsiLuIndex, scsiInitiator=scsiInitiator, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuEntry=scsiLuEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortName=scsiAttTgtPortName)
