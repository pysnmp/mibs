...
ObjectIdentity, mib_2, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Gauge32, Counter32, Bits, Counter64, ModuleIdentity, Unsigned32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Gauge32", "Counter32", "Bits", "Counter64", "ModuleIdentity", "Unsigned32", "Integer32", "TimeTicks")
RowStatus, TimeStamp, TruthValue, DisplayString, TextualConvention, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceAlias=scsiDeviceAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTarget=scsiTarget, scsiLuState=scsiLuState, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortEntry=scsiPortEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportOther=scsiTranportOther, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortName=scsiTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunLun=scsiDscLunLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuEntry=scsiLuEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiLunMapGroup=scsiLunMapGroup, ScsiIdType=ScsiIdType, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapEntry=scsiLunMapEntry, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, PYSNMP_MODULE_ID=scsiModule, scsiLuTable=scsiLuTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInCommands=scsiLuInCommands, scsiInstAlias=scsiInstAlias, scsiGroups=scsiGroups, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdTable=scsiLuIdTable, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapLun=scsiLunMapLun, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortRole=scsiPortRole, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiModule=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstIndex=scsiInstIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuInResets=scsiLuInResets, scsiConformance=scsiConformance, scsiNotifications=scsiNotifications, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliance=scsiCompliance, scsiInstanceTable=scsiInstanceTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunTable=scsiDscLunTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiTransportTypes=scsiTransportTypes, scsiDeviceResets=scsiDeviceResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiTranportSPI=scsiTranportSPI, scsiLuIdIndex=scsiLuIdIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceRole=scsiDeviceRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuVendorId=scsiLuVendorId, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTable=scsiPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIndex=scsiLuIndex, scsiLuIdType=scsiLuIdType, scsiInstanceEntry=scsiInstanceEntry, scsiObjects=scsiObjects, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName)
