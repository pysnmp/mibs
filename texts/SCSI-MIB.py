...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, NotificationType, ModuleIdentity, ObjectIdentity, Counter64, mib_2, MibIdentifier, Unsigned32, TimeTicks, IpAddress, Bits, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter64", "mib-2", "MibIdentifier", "Unsigned32", "TimeTicks", "IpAddress", "Bits", "Integer32", "Counter32")
DisplayString, TruthValue, RowPointer, TextualConvention, AutonomousType, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowPointer", "TextualConvention", "AutonomousType", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteTarget=scsiRemoteTarget, ScsiName=ScsiName, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, ScsiIdValue=ScsiIdValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptType=scsiTrnsptType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiGroups=scsiGroups, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWwnName=scsiLuWwnName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuEntry=scsiLuEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, ScsiIdAssociation=ScsiIdAssociation, scsiLuProductId=scsiLuProductId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunLun=scsiDscLunLun, scsiDeviceEntry=scsiDeviceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiTransportSBP=scsiTransportSBP, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiLuIdTable=scsiLuIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdType=ScsiIdType, scsiCompliances=scsiCompliances, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuVendorId=scsiLuVendorId, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrName=scsiAuthIntrName, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiDscLunEntry=scsiDscLunEntry, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiModule=scsiModule, scsiLunMapGroup=scsiLunMapGroup, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTranportSPI=scsiTranportSPI, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiRemoteInitiators=scsiRemoteInitiators, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTable=scsiPortTable, scsiTransportTypes=scsiTransportTypes, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLuIndex=scsiLuIndex, scsiObjects=scsiObjects, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuTable=scsiLuTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiLunMapTable=scsiLunMapTable, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevTable=scsiTgtDevTable, scsiPortRole=scsiPortRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiInstAlias=scsiInstAlias, scsiConformance=scsiConformance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes)
