...
Counter32, ModuleIdentity, TimeTicks, Integer32, MibIdentifier, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Bits, Gauge32, NotificationType, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "TimeTicks", "Integer32", "MibIdentifier", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Bits", "Gauge32", "NotificationType", "ObjectIdentity", "Unsigned32")
TruthValue, AutonomousType, DisplayString, TextualConvention, RowPointer, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "RowPointer", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortName=scsiTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiLuTable=scsiLuTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstAlias=scsiInstAlias, scsiDeviceTable=scsiDeviceTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiModule=scsiModule, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiNotifications=scsiNotifications, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiObjects=scsiObjects, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiCompliances=scsiCompliances, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuVendorId=scsiLuVendorId, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortTable=scsiPortTable, scsiLuInResets=scsiLuInResets, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceRole=scsiDeviceRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapTable=scsiLunMapTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, ScsiIdType=ScsiIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdTable=scsiLuIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDeviceGroup=scsiDeviceGroup, scsiInstIndex=scsiInstIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceTable=scsiInstanceTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortRole=scsiPortRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuState=scsiLuState, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiGeneral=scsiGeneral, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdEntry=scsiLuIdEntry, ScsiName=ScsiName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtName=scsiDscTgtName, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable)
