...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, IpAddress, MibIdentifier, Gauge32, Counter64, Bits, iso, NotificationType, Integer32, mib_2, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "IpAddress", "MibIdentifier", "Gauge32", "Counter64", "Bits", "iso", "NotificationType", "Integer32", "mib-2", "ModuleIdentity", "Unsigned32")
DisplayString, RowPointer, TimeStamp, RowStatus, AutonomousType, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TimeStamp", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiator=scsiInitiator, scsiTarget=scsiTarget, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstIndex=scsiInstIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortRole=scsiPortRole, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortEntry=scsiPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, ScsiName=ScsiName, scsiTranportSPI=scsiTranportSPI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliance=scsiCompliance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuVendorId=scsiLuVendorId, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiTransportFCP=scsiTransportFCP, scsiLuInResets=scsiLuInResets, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdCodeSet=ScsiIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdentifier=ScsiIdentifier, scsiLuStatus=scsiLuStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiTargetGroup=scsiTargetGroup, scsiLuIdType=scsiLuIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuTable=scsiLuTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiModule=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLun=scsiLunMapLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiLogicalUnit=scsiLogicalUnit, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstAlias=scsiInstAlias, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportOther=scsiTranportOther, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceTable=scsiDeviceTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiLUNOrZero=ScsiLUNOrZero, scsiObjects=scsiObjects, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortName=scsiTgtPortName, scsiConformance=scsiConformance, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceTable=scsiInstanceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortIndex=scsiPortIndex, scsiLunMapTable=scsiLunMapTable, scsiCompliances=scsiCompliances, scsiGeneral=scsiGeneral, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunTable=scsiDscLunTable, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdTable=scsiDscLunIdTable)
