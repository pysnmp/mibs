...
Integer32, TimeTicks, ModuleIdentity, Gauge32, Bits, MibIdentifier, Unsigned32, ObjectIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "ObjectIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "mib-2", "Counter32")
RowStatus, DisplayString, TimeStamp, TruthValue, RowPointer, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "RowPointer", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceResets=scsiDeviceResets, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdValue=ScsiIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatus=scsiLuStatus, scsiAuthIntrName=scsiAuthIntrName, ScsiIdentifier=ScsiIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptType=scsiTrnsptType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuTable=scsiLuTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdValue=scsiLuIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdType=ScsiIdType, scsiTranportSPI=scsiTranportSPI, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiConformance=scsiConformance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiDeviceTable=scsiDeviceTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceEntry=scsiDeviceEntry, scsiLuInResets=scsiLuInResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiGeneral=scsiGeneral, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuProductId=scsiLuProductId, scsiLuEntry=scsiLuEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuState=scsiLuState, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdIndex=scsiLuIdIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiModule=scsiModule, scsiLuWwnName=scsiLuWwnName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiPortIndex=scsiPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTarget=scsiTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValue=ScsiIndexValue, scsiDscTgtName=scsiDscTgtName, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliance=scsiCompliance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier)
