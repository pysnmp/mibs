...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, TimeTicks, MibIdentifier, ModuleIdentity, Bits, IpAddress, iso, Gauge32, mib_2, Unsigned32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Bits", "IpAddress", "iso", "Gauge32", "mib-2", "Unsigned32", "Integer32", "NotificationType")
TextualConvention, DisplayString, RowStatus, AutonomousType, TimeStamp, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "AutonomousType", "TimeStamp", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapTable=scsiLunMapTable, scsiLuProductId=scsiLuProductId, scsiLuInCommands=scsiLuInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatus=scsiLuStatus, ScsiIndexValue=ScsiIndexValue, scsiDeviceEntry=scsiDeviceEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInResets=scsiLuInResets, scsiTranportOther=scsiTranportOther, ScsiName=ScsiName, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdIndex=scsiLuIdIndex, scsiCompliances=scsiCompliances, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapLun=scsiLunMapLun, scsiDscTgtTable=scsiDscTgtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiTargetGroup=scsiTargetGroup, scsiLuIndex=scsiLuIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWwnName=scsiLuWwnName, scsiLuEntry=scsiLuEntry, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstIndex=scsiInstIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortRole=scsiPortRole, scsiTrnsptType=scsiTrnsptType, scsiPortTable=scsiPortTable, ScsiIdentifier=ScsiIdentifier, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGroups=scsiGroups, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiator=scsiInitiator, scsiInstAlias=scsiInstAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtName=scsiDscTgtName, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuState=scsiLuState, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdType=scsiLuIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceTable=scsiInstanceTable, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, PYSNMP_MODULE_ID=scsiModule, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortEntry=scsiPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTarget=scsiTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiConformance=scsiConformance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtConfigured=scsiDscTgtConfigured)
