...
Gauge32, ModuleIdentity, iso, Counter64, mib_2, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter32, TimeTicks, ObjectIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "iso", "Counter64", "mib-2", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter32", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32")
TimeStamp, TruthValue, DisplayString, TextualConvention, RowStatus, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "RowStatus", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuState=scsiLuState, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevEntry=scsiIntrDevEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdTable=scsiLuIdTable, scsiLuInResets=scsiLuInResets, scsiConformance=scsiConformance, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortEntry=scsiPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIndex=scsiLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptType=scsiTrnsptType, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdentifier=ScsiIdentifier, scsiObjects=scsiObjects, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortName=scsiTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetGroup=scsiTargetGroup, PYSNMP_MODULE_ID=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiGroups=scsiGroups, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstIndex=scsiInstIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiName=ScsiName, scsiDeviceIndex=scsiDeviceIndex, ScsiIdValue=ScsiIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTarget=scsiTarget, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiNotifications=scsiNotifications, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSRP=scsiTransportSRP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstAlias=scsiInstAlias, scsiLuInCommands=scsiLuInCommands, scsiDeviceRole=scsiDeviceRole, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportISCSI=scsiTransportISCSI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuTable=scsiLuTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdType=scsiLuIdType, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiInitiator=scsiInitiator, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliance=scsiCompliance, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiLuWwnName=scsiLuWwnName, scsiPortTable=scsiPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortIndex=scsiPortIndex)
