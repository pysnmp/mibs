...
iso, IpAddress, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, Bits, Counter64, Gauge32, Counter32, NotificationType, TimeTicks, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "Bits", "Counter64", "Gauge32", "Counter32", "NotificationType", "TimeTicks", "Unsigned32", "ObjectIdentity")
TextualConvention, TruthValue, AutonomousType, RowStatus, DisplayString, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunTable=scsiDscLunTable, scsiPortIndex=scsiPortIndex, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiNotifications=scsiNotifications, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorGroup=scsiInitiatorGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdType=scsiDscLunIdType, ScsiIdentifier=ScsiIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdValue=ScsiIdValue, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValue=ScsiIndexValue, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrName=scsiAuthIntrName, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuPeripheralType=scsiLuPeripheralType, scsiObjects=scsiObjects, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiName=ScsiName, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceResets=scsiDeviceResets, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIndex=scsiDscLunIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, ScsiIdCodeSet=ScsiIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdType=scsiLuIdType, scsiDscLunLun=scsiDscLunLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunEntry=scsiDscLunEntry, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuInCommands=scsiLuInCommands, scsiLuInResets=scsiLuInResets, scsiDeviceAlias=scsiDeviceAlias, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiModule=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiRemoteTarget=scsiRemoteTarget, scsiLuWwnName=scsiLuWwnName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceIndex=scsiDeviceIndex, scsiTranportOther=scsiTranportOther, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiConformance=scsiConformance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceTable=scsiDeviceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuProductId=scsiLuProductId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatus=scsiLuStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTable=scsiPortTable, scsiInstIndex=scsiInstIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiGroups=scsiGroups, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGeneral=scsiGeneral, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdType=ScsiIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuEntry=scsiLuEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType)
