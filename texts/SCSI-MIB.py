...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, IpAddress, MibIdentifier, ModuleIdentity, mib_2, Bits, TimeTicks, Gauge32, iso, ObjectIdentity, Unsigned32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "IpAddress", "MibIdentifier", "ModuleIdentity", "mib-2", "Bits", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType")
TruthValue, RowPointer, TimeStamp, RowStatus, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "TimeStamp", "RowStatus", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiNotifications=scsiNotifications, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortTable=scsiPortTable, scsiDeviceTable=scsiDeviceTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiLuState=scsiLuState, scsiDeviceRole=scsiDeviceRole, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortTable=scsiTgtPortTable, scsiGroups=scsiGroups, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtName=scsiIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiLuInResets=scsiLuInResets, scsiDscLunIndex=scsiDscLunIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuProductId=scsiLuProductId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstIndex=scsiInstIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiGeneral=scsiGeneral, scsiDscLunLun=scsiDscLunLun, PYSNMP_MODULE_ID=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuTable=scsiLuTable, scsiLuInCommands=scsiLuInCommands, scsiRemoteTarget=scsiRemoteTarget, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiLuWwnName=scsiLuWwnName, scsiInstanceTable=scsiInstanceTable, ScsiName=ScsiName, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortName=scsiTgtPortName, ScsiIdValue=ScsiIdValue, scsiConformance=scsiConformance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiCompliances=scsiCompliances, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapTable=scsiLunMapTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliance=scsiCompliance, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiObjects=scsiObjects, scsiInitiator=scsiInitiator, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, scsiDeviceResets=scsiDeviceResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportSBP=scsiTransportSBP, scsiTranportOther=scsiTranportOther, scsiTransportISCSI=scsiTransportISCSI, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiModule=scsiModule, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdType=ScsiIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSRP=scsiTransportSRP)
