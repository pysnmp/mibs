...
TimeTicks, ObjectIdentity, NotificationType, Gauge32, Counter64, Unsigned32, Bits, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Integer32, iso, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "Counter64", "Unsigned32", "Bits", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Integer32", "iso", "mib-2")
RowStatus, DisplayString, AutonomousType, TimeStamp, RowPointer, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "AutonomousType", "TimeStamp", "RowPointer", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdTable=scsiLuIdTable, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, scsiTransportSRP=scsiTransportSRP, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiTrnsptDevName=scsiTrnsptDevName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceEntry=scsiInstanceEntry, scsiPortTable=scsiPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuProductId=scsiLuProductId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiGeneral=scsiGeneral, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdType=scsiLuIdType, scsiTrnsptTable=scsiTrnsptTable, scsiTransportFCP=scsiTransportFCP, ScsiName=ScsiName, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiPortEntry=scsiPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiConformance=scsiConformance, scsiDeviceResets=scsiDeviceResets, scsiDeviceRole=scsiDeviceRole, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTable=scsiIntrDevTable, scsiInitiator=scsiInitiator, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceIndex=scsiDeviceIndex, scsiLuTable=scsiLuTable, scsiModule=scsiModule, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdType=ScsiIdType, ScsiIdValue=ScsiIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetGroup=scsiTargetGroup, scsiNotifications=scsiNotifications, scsiTarget=scsiTarget, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuVendorId=scsiLuVendorId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceTable=scsiDeviceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevEntry=scsiTgtDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGroups=scsiGroups, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdValue=scsiLuIdValue, scsiPortRole=scsiPortRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliance=scsiCompliance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLunMapTable=scsiLunMapTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportSPI=scsiTranportSPI, scsiCompliances=scsiCompliances, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportSBP=scsiTransportSBP)
