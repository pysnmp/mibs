...
Counter32, Bits, ObjectIdentity, MibIdentifier, ModuleIdentity, TimeTicks, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Unsigned32, Gauge32, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Unsigned32", "Gauge32", "mib-2", "iso")
TruthValue, RowStatus, AutonomousType, TextualConvention, DisplayString, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "AutonomousType", "TextualConvention", "DisplayString", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunTable=scsiDscLunTable, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTable=scsiIntrDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdType=ScsiIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetGroup=scsiTargetGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdTable=scsiLuIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiAuthIntrName=scsiAuthIntrName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuState=scsiLuState, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdIndex=scsiLuIdIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtName=scsiDscTgtName, scsiLuInCommands=scsiLuInCommands, scsiTrnsptType=scsiTrnsptType, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdentifier=ScsiIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, PYSNMP_MODULE_ID=scsiModule, scsiLuInResets=scsiLuInResets, scsiGeneral=scsiGeneral, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtTable=scsiDscTgtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiName=ScsiName, scsiGroups=scsiGroups, scsiLuPeripheralType=scsiLuPeripheralType, scsiModule=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, scsiPortEntry=scsiPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiCompliances=scsiCompliances, ScsiIdValue=ScsiIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiCompliance=scsiCompliance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWwnName=scsiLuWwnName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiNotifications=scsiNotifications, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatus=scsiLuStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdEntry=scsiLuIdEntry, scsiLuIndex=scsiLuIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteInitiators=scsiRemoteInitiators, scsiObjects=scsiObjects, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortRole=scsiPortRole, scsiInstanceTable=scsiInstanceTable, scsiInitiator=scsiInitiator)
