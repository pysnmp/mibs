...
Integer32, mib_2, TimeTicks, Counter64, ModuleIdentity, iso, Unsigned32, NotificationType, Counter32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "TimeTicks", "Counter64", "ModuleIdentity", "iso", "Unsigned32", "NotificationType", "Counter32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Gauge32")
AutonomousType, DisplayString, RowStatus, TimeStamp, RowPointer, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "RowStatus", "TimeStamp", "RowPointer", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDevicePortNumber=scsiDevicePortNumber, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiTarget=scsiTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, scsiTransportFCP=scsiTransportFCP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuRevisionId=scsiLuRevisionId, scsiCompliances=scsiCompliances, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapLun=scsiLunMapLun, scsiTgtPortTable=scsiTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIndex=scsiLuIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortRole=scsiPortRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunTable=scsiDscLunTable, scsiDeviceResets=scsiDeviceResets, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdType=ScsiIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiTransportSBP=scsiTransportSBP, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiConformance=scsiConformance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLuTable=scsiLuTable, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiPortEntry=scsiPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstAlias=scsiInstAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIdValue=ScsiIdValue, scsiLuIdType=scsiLuIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuVendorId=scsiLuVendorId, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdTable=scsiLuIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdAssociation=scsiDscLunIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstIndex=scsiInstIndex, scsiDscLunLun=scsiDscLunLun, scsiDeviceRole=scsiDeviceRole, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiName=ScsiName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportOther=scsiTranportOther, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortIndex=scsiPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiator=scsiInitiator, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportSPI=scsiTranportSPI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiObjects=scsiObjects)
