...
Integer32, Unsigned32, NotificationType, MibIdentifier, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, TimeTicks, IpAddress, ModuleIdentity, iso, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "iso", "Gauge32", "ObjectIdentity")
DisplayString, AutonomousType, RowStatus, TruthValue, RowPointer, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowStatus", "TruthValue", "RowPointer", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuProductId=scsiLuProductId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdentifier=ScsiIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapEntry=scsiLunMapEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportTypes=scsiTransportTypes, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotifications=scsiNotifications, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTranportOther=scsiTranportOther, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLogicalUnit=scsiLogicalUnit, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuInCommands=scsiLuInCommands, scsiLuState=scsiLuState, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuVendorId=scsiLuVendorId, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdValue=ScsiIdValue, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdType=scsiLuIdType, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiTranportSPI=scsiTranportSPI, scsiCompliances=scsiCompliances, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiator=scsiInitiator, scsiDscLunEntry=scsiDscLunEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortRole=scsiPortRole, scsiTransportFCP=scsiTransportFCP, scsiTarget=scsiTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, PYSNMP_MODULE_ID=scsiModule, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceRole=scsiDeviceRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatus=scsiLuStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGroups=scsiGroups, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIndex=scsiLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiPortTable=scsiPortTable, ScsiName=ScsiName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiLunMapTable=scsiLunMapTable, scsiPortEntry=scsiPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstAlias=scsiInstAlias, scsiPortIndex=scsiPortIndex, scsiInstIndex=scsiInstIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptType=scsiTrnsptType, scsiLuTable=scsiLuTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiModule=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId)
