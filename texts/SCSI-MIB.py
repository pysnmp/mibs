...
Integer32, mib_2, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, NotificationType, iso, TimeTicks, Counter64, Gauge32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "NotificationType", "iso", "TimeTicks", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity")
RowStatus, AutonomousType, RowPointer, DisplayString, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "RowPointer", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdType=ScsiIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetGroup=scsiTargetGroup, scsiLunMapTable=scsiLunMapTable, scsiDeviceEntry=scsiDeviceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuEntry=scsiLuEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliance=scsiCompliance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdentifier=ScsiIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiTarget=scsiTarget, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiNotifications=scsiNotifications, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiModule=scsiModule, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapLun=scsiLunMapLun, scsiInstIndex=scsiInstIndex, scsiTransportFCP=scsiTransportFCP, scsiGroups=scsiGroups, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptType=scsiTrnsptType, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportSBP=scsiTransportSBP, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuWwnName=scsiLuWwnName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiConformance=scsiConformance, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortIndex=scsiPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortTable=scsiPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInCommands=scsiLuInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdType=scsiLuIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdTable=scsiLuIdTable, scsiDscTgtName=scsiDscTgtName, scsiLuIdEntry=scsiLuIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, ScsiName=ScsiName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevEntry=scsiTgtDevEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceRole=scsiDeviceRole, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportOther=scsiTranportOther, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuState=scsiLuState, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLuTable=scsiLuTable, scsiLuStatus=scsiLuStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiObjects=scsiObjects)
