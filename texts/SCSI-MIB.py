...
Gauge32, ObjectIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, NotificationType, ModuleIdentity, MibIdentifier, Integer32, Counter64, Bits, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "NotificationType", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter64", "Bits", "TimeTicks", "iso")
RowPointer, DisplayString, TimeStamp, AutonomousType, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiConformance=scsiConformance, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiModule=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSBP=scsiTransportSBP, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiTransportFCP=scsiTransportFCP, scsiPortEntry=scsiPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTranportOther=scsiTranportOther, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdIndex=scsiLuIdIndex, scsiLuInCommands=scsiLuInCommands, ScsiName=ScsiName, scsiLuIdEntry=scsiLuIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuRevisionId=scsiLuRevisionId, scsiLuInResets=scsiLuInResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortRole=scsiPortRole, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdType=scsiDscLunIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdType=ScsiIdType, scsiTranportSPI=scsiTranportSPI, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliances=scsiCompliances, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptType=scsiTrnsptType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdType=scsiLuIdType, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortIndex=scsiPortIndex, scsiLuStatus=scsiLuStatus, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuTable=scsiLuTable, scsiInstAlias=scsiInstAlias, scsiDeviceGroup=scsiDeviceGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuState=scsiLuState, scsiRemoteTarget=scsiRemoteTarget, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGroups=scsiGroups, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiator=scsiInitiator, scsiDeviceAlias=scsiDeviceAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtName=scsiDscTgtName, scsiGeneral=scsiGeneral, scsiLunMapTable=scsiLunMapTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceTable=scsiInstanceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunLun=scsiDscLunLun, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLuEntry=scsiLuEntry, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry)
