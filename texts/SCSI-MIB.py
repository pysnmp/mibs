...
IpAddress, Counter64, NotificationType, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, Counter32, iso, Unsigned32, Bits, TimeTicks, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "NotificationType", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "Counter32", "iso", "Unsigned32", "Bits", "TimeTicks", "ModuleIdentity", "ObjectIdentity")
DisplayString, TruthValue, RowStatus, AutonomousType, TextualConvention, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "AutonomousType", "TextualConvention", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuEntry=scsiLuEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuInCommands=scsiLuInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuVendorId=scsiLuVendorId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdIndex=scsiLuIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportFCP=scsiTransportFCP, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtName=scsiDscTgtName, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiPortEntry=scsiPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiConformance=scsiConformance, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTable=scsiIntrDevTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIndex=scsiLuIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, scsiCompliance=scsiCompliance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstanceTable=scsiInstanceTable, scsiLuIdType=scsiLuIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiLuWwnName=scsiLuWwnName, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, scsiLuProductId=scsiLuProductId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrName=scsiAuthIntrName, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, PYSNMP_MODULE_ID=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInResets=scsiLuInResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiPortTable=scsiPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunLun=scsiDscLunLun, scsiTranportOther=scsiTranportOther, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry)
