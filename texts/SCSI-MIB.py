...
Counter64, mib_2, MibIdentifier, NotificationType, Gauge32, Counter32, TimeTicks, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "MibIdentifier", "NotificationType", "Gauge32", "Counter32", "TimeTicks", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits", "ModuleIdentity", "Integer32")
DisplayString, TextualConvention, RowStatus, AutonomousType, RowPointer, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortRole=scsiPortRole, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuEntry=scsiLuEntry, scsiLunMapTable=scsiLunMapTable, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatus=scsiLuStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDevTable=scsiTgtDevTable, ScsiIdentifier=ScsiIdentifier, scsiTransportFCP=scsiTransportFCP, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdType=ScsiIdType, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtName=scsiDscTgtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGeneral=scsiGeneral, scsiLuIdValue=scsiLuIdValue, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiInstanceTable=scsiInstanceTable, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuState=scsiLuState, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInResets=scsiLuInResets, scsiInstAlias=scsiInstAlias, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiConformance=scsiConformance, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortIndex=scsiPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortEntry=scsiPortEntry, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, ScsiIdValue=ScsiIdValue, scsiTransportSBP=scsiTransportSBP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTransportTypes=scsiTransportTypes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTranportOther=scsiTranportOther, scsiTarget=scsiTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, scsiLunMapGroup=scsiLunMapGroup, scsiGroups=scsiGroups, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiModule=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunLun=scsiDscLunLun, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuTable=scsiLuTable, ScsiName=ScsiName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapEntry=scsiLunMapEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiCompliances=scsiCompliances, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuProductId=scsiLuProductId)
