...
iso, NotificationType, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, mib_2, MibIdentifier, IpAddress, Gauge32, TimeTicks, Counter64, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "mib-2", "MibIdentifier", "IpAddress", "Gauge32", "TimeTicks", "Counter64", "Integer32", "ModuleIdentity")
DisplayString, RowPointer, TimeStamp, AutonomousType, TextualConvention, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiCompliance=scsiCompliance, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdType=scsiDscLunIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTarget=scsiTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportISCSI=scsiTransportISCSI, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevTable=scsiTgtDevTable, ScsiIdentifier=ScsiIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetGroup=scsiTargetGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunTable=scsiDscLunTable, scsiInstanceTable=scsiInstanceTable, scsiLuTable=scsiLuTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportOther=scsiTranportOther, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiLunMapTable=scsiLunMapTable, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIndexValue=ScsiIndexValue, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, ScsiIdType=ScsiIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdValue=ScsiIdValue, scsiDeviceRole=scsiDeviceRole, scsiGroups=scsiGroups, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInResets=scsiLuInResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuState=scsiLuState, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiName=ScsiName, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtName=scsiDscTgtName, scsiCompliances=scsiCompliances, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiLuIndex=scsiLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdValue=scsiLuIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiPortTable=scsiPortTable, scsiLuIdType=scsiLuIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortEntry=scsiPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiModule=scsiModule, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiPortIndex=scsiPortIndex, scsiPortRole=scsiPortRole, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses)
