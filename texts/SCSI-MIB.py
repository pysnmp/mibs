...
NotificationType, ModuleIdentity, TimeTicks, Integer32, IpAddress, Unsigned32, ObjectIdentity, MibIdentifier, Counter32, iso, mib_2, Counter64, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "TimeTicks", "Integer32", "IpAddress", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "mib-2", "Counter64", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, RowPointer, TimeStamp, AutonomousType, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiator=scsiInitiator, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstanceEntry=scsiInstanceEntry, scsiTransportSRP=scsiTransportSRP, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuTable=scsiLuTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTable=scsiPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, scsiLuProductId=scsiLuProductId, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdValue=scsiLuIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIndex=scsiLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiLuIdIndex=scsiLuIdIndex, scsiNotifications=scsiNotifications, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiConformance=scsiConformance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdType=ScsiIdType, ScsiName=ScsiName, scsiRemoteTarget=scsiRemoteTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiGeneral=scsiGeneral, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatus=scsiLuStatus, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiModule=scsiModule, scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuState=scsiLuState, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiPortIndex=scsiPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValue=ScsiIndexValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiGroups=scsiGroups, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdentifier=ScsiIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiPortEntry=scsiPortEntry, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceAlias=scsiDeviceAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiObjects=scsiObjects, scsiDeviceGroup=scsiDeviceGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportFCP=scsiTransportFCP, scsiDscTgtName=scsiDscTgtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceTable=scsiDeviceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortRole=scsiPortRole, ScsiIdValue=ScsiIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiCompliance=scsiCompliance, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstIndex=scsiInstIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes)
