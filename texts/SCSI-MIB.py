...
Unsigned32, Counter32, Bits, TimeTicks, Counter64, MibIdentifier, Gauge32, mib_2, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Bits", "TimeTicks", "Counter64", "MibIdentifier", "Gauge32", "mib-2", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "IpAddress", "NotificationType")
TimeStamp, RowStatus, TextualConvention, TruthValue, RowPointer, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "RowPointer", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdType=ScsiIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliances=scsiCompliances, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuProductId=scsiLuProductId, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptType=scsiTrnsptType, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotifications=scsiNotifications, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdentifier=ScsiIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiTarget=scsiTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiName=ScsiName, scsiInstIndex=scsiInstIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGeneral=scsiGeneral, scsiLuVendorId=scsiLuVendorId, scsiDeviceRole=scsiDeviceRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuRevisionId=scsiLuRevisionId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortRole=scsiPortRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortIndex=scsiPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLuDefaultLun=scsiLuDefaultLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiPortTable=scsiPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortEntry=scsiTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuIndex=scsiLuIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInResets=scsiLuInResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiTrnsptTable=scsiTrnsptTable, scsiLuTable=scsiLuTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceGroup=scsiDeviceGroup, scsiCompliance=scsiCompliance, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunLun=scsiDscLunLun, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiTrnsptEntry=scsiTrnsptEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiModule=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiPortEntry=scsiPortEntry, ScsiIdValue=ScsiIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapLun=scsiLunMapLun, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes)
