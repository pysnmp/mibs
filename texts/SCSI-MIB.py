...
TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, MibIdentifier, NotificationType, Unsigned32, Gauge32, Integer32, ObjectIdentity, Counter64, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "Gauge32", "Integer32", "ObjectIdentity", "Counter64", "iso", "Counter32", "Bits")
TruthValue, TextualConvention, AutonomousType, DisplayString, TimeStamp, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "TimeStamp", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, scsiDscTgtName=scsiDscTgtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstanceEntry=scsiInstanceEntry, scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportOther=scsiTranportOther, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptType=scsiTrnsptType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTarget=scsiTarget, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiModule=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiGeneral=scsiGeneral, scsiLuProductId=scsiLuProductId, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLun=scsiLunMapLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiObjects=scsiObjects, scsiLuIdEntry=scsiLuIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceAlias=scsiDeviceAlias, scsiLuInCommands=scsiLuInCommands, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSBP=scsiTransportSBP, ScsiIdValue=ScsiIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceTable=scsiDeviceTable, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportSPI=scsiTranportSPI, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiator=scsiInitiator, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiPortTable=scsiPortTable, scsiLuTable=scsiLuTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuVendorId=scsiLuVendorId, scsiPortIndex=scsiPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIndex=scsiLuIndex, ScsiName=ScsiName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevTable=scsiTgtDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuInResets=scsiLuInResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry)
