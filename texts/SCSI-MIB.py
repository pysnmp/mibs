...
Gauge32, MibIdentifier, Counter32, iso, NotificationType, Unsigned32, ModuleIdentity, Counter64, Integer32, mib_2, TimeTicks, IpAddress, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Counter32", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter64", "Integer32", "mib-2", "TimeTicks", "IpAddress", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, RowPointer, DisplayString, TextualConvention, TimeStamp, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "DisplayString", "TextualConvention", "TimeStamp", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiator=scsiInitiator, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiName=ScsiName, scsiLunMapGroup=scsiLunMapGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLuTable=scsiLuTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunLun=scsiDscLunLun, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiDscTgtTable=scsiDscTgtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortEntry=scsiPortEntry, scsiLuInResets=scsiLuInResets, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLogicalUnit=scsiLogicalUnit, ScsiIdAssociation=ScsiIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiObjects=scsiObjects, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtName=scsiDscTgtName, ScsiIdCodeSet=ScsiIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortTable=scsiTgtPortTable, scsiCompliance=scsiCompliance, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdValue=ScsiIdValue, scsiTranportSPI=scsiTranportSPI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortRole=scsiPortRole, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiConformance=scsiConformance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSRP=scsiTransportSRP, scsiInstanceTable=scsiInstanceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrName=scsiAuthIntrName, scsiGroups=scsiGroups, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTarget=scsiTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuInCommands=scsiLuInCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortIndex=scsiPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptTable=scsiTrnsptTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdType=ScsiIdType, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIndex=scsiLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtName=scsiIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiPortTable=scsiPortTable, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceAlias=scsiDeviceAlias)
