...
Counter64, ObjectIdentity, Bits, Counter32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, MibIdentifier, NotificationType, ModuleIdentity, Integer32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "MibIdentifier", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "iso")
AutonomousType, TextualConvention, TimeStamp, TruthValue, DisplayString, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatus=scsiLuStatus, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiConformance=scsiConformance, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportSRP=scsiTransportSRP, scsiGroups=scsiGroups, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdType=ScsiIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiObjects=scsiObjects, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdValue=scsiLuIdValue, scsiLuTable=scsiLuTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiGeneral=scsiGeneral, scsiPortRole=scsiPortRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliance=scsiCompliance, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInCommands=scsiLuInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuProductId=scsiLuProductId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceTable=scsiDeviceTable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceRole=scsiDeviceRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunLun=scsiDscLunLun, scsiLuIdIndex=scsiLuIdIndex, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTarget=scsiTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliances=scsiCompliances, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuVendorId=scsiLuVendorId, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdValue=ScsiIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSBP=scsiTransportSBP, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapTable=scsiLunMapTable, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrName=scsiAuthIntrName, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteInitiators=scsiRemoteInitiators, ScsiName=ScsiName, scsiLunMapIndex=scsiLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortEntry=scsiPortEntry, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiInstAlias=scsiInstAlias, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotifications=scsiNotifications, scsiTrnsptType=scsiTrnsptType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortIndex=scsiPortIndex)
