...
ObjectIdentity, Gauge32, Integer32, Counter64, iso, NotificationType, Unsigned32, TimeTicks, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, mib_2, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Integer32", "Counter64", "iso", "NotificationType", "Unsigned32", "TimeTicks", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "mib-2", "IpAddress", "Bits")
RowStatus, DisplayString, RowPointer, TruthValue, TimeStamp, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "RowPointer", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuTable=scsiLuTable, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtTable=scsiIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiInitiator=scsiInitiator, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotifications=scsiNotifications, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiDscTgtName=scsiDscTgtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValue=ScsiIndexValue, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiName=ScsiName, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrName=scsiAuthIntrName, ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiObjects=scsiObjects, ScsiIdType=ScsiIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortIndex=scsiPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiPortRole=scsiPortRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGroups=scsiGroups, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuEntry=scsiLuEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuProductId=scsiLuProductId, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliance=scsiCompliance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiModule=scsiModule, scsiLunMapLun=scsiLunMapLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiCompliances=scsiCompliances, scsiDeviceGroup=scsiDeviceGroup, scsiInstIndex=scsiInstIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiTargetGroup=scsiTargetGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportOther=scsiTranportOther, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiConformance=scsiConformance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortEntry=scsiPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuState=scsiLuState, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiDscLunIndex=scsiDscLunIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGeneral=scsiGeneral, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTarget=scsiTarget, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceRole=scsiDeviceRole, scsiLuIdEntry=scsiLuIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuInResets=scsiLuInResets, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry)
