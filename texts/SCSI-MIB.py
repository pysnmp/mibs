...
Counter32, iso, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Bits, IpAddress, TimeTicks, Counter64, NotificationType, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Bits", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "Unsigned32", "Gauge32", "MibIdentifier")
RowStatus, TextualConvention, AutonomousType, TimeStamp, DisplayString, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdValue=scsiLuIdValue, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceTable=scsiInstanceTable, scsiNotifications=scsiNotifications, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuState=scsiLuState, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdType=ScsiIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuTable=scsiLuTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuHSInCommands=scsiLuHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiLunMapTable=scsiLunMapTable, scsiLuProductId=scsiLuProductId, scsiTgtPortName=scsiTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiInstAlias=scsiInstAlias, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportTypes=scsiTransportTypes, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdType=scsiLuIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapGroup=scsiLunMapGroup, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceResets=scsiDeviceResets, scsiTransportFCP=scsiTransportFCP, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteTarget=scsiRemoteTarget, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGroups=scsiGroups, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceRole=scsiDeviceRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiName=ScsiName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLun=scsiLunMapLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortRole=scsiPortRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtName=scsiDscTgtName, scsiLuRevisionId=scsiLuRevisionId, scsiLuVendorId=scsiLuVendorId, scsiTransportSBP=scsiTransportSBP, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiator=scsiInitiator, scsiLuIdAssociation=scsiLuIdAssociation, scsiTarget=scsiTarget, scsiPortIndex=scsiPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliance=scsiCompliance, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiModule=scsiModule, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatus=scsiLuStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands)
