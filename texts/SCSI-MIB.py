...
Counter64, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, TimeTicks, Unsigned32, ObjectIdentity, MibIdentifier, iso, mib_2, Gauge32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibIdentifier", "iso", "mib-2", "Gauge32", "Integer32", "NotificationType")
RowStatus, RowPointer, AutonomousType, TruthValue, TextualConvention, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "AutonomousType", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiModule=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiLuIndex=scsiLuIndex, scsiNotifications=scsiNotifications, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiConformance=scsiConformance, scsiTgtPortName=scsiTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceResets=scsiDeviceResets, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstAlias=scsiInstAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTarget=scsiTarget, scsiLuState=scsiLuState, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiIdentifier=ScsiIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortTable=scsiPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapIndex=scsiLunMapIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiLuIdValue=scsiLuIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiName=ScsiName, scsiLuEntry=scsiLuEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiator=scsiInitiator, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGroups=scsiGroups, scsiInstanceTable=scsiInstanceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiInstIndex=scsiInstIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuTable=scsiLuTable, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortRole=scsiPortRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTranportOther=scsiTranportOther, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, PYSNMP_MODULE_ID=scsiModule, scsiLuProductId=scsiLuProductId, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiCompliances=scsiCompliances, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapLun=scsiLunMapLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiTranportSPI=scsiTranportSPI, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportTypes=scsiTransportTypes, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortEntry=scsiPortEntry, ScsiIdValue=ScsiIdValue, scsiGeneral=scsiGeneral, scsiLuIdTable=scsiLuIdTable, scsiDeviceRole=scsiDeviceRole, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup)
