...
Integer32, mib_2, Counter32, Gauge32, iso, ObjectIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Counter64, MibIdentifier, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "Counter32", "Gauge32", "iso", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Counter64", "MibIdentifier", "NotificationType", "IpAddress")
TextualConvention, TimeStamp, TruthValue, AutonomousType, DisplayString, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "AutonomousType", "DisplayString", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiRemoteInitiators=scsiRemoteInitiators, ScsiDeviceOrPort=ScsiDeviceOrPort, PYSNMP_MODULE_ID=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiLuTable=scsiLuTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiPortTable=scsiPortTable, scsiGroups=scsiGroups, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdTable=scsiLuIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiCompliances=scsiCompliances, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiName=ScsiName, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliance=scsiCompliance, scsiPortIndex=scsiPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapEntry=scsiLunMapEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiInitiator=scsiInitiator, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatus=scsiLuStatus, ScsiIdType=ScsiIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, ScsiIndexValue=ScsiIndexValue, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiLuIndex=scsiLuIndex, scsiPortRole=scsiPortRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceTable=scsiDeviceTable, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdValue=ScsiIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLun=scsiLunMapLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiNotifications=scsiNotifications, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunTable=scsiDscLunTable, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportSPI=scsiTranportSPI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapTable=scsiLunMapTable, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiConformance=scsiConformance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGeneral=scsiGeneral, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptType=scsiTrnsptType, scsiTranportOther=scsiTranportOther)
