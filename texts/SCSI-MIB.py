...
mib_2, Unsigned32, NotificationType, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, iso, Counter32, ModuleIdentity, Gauge32, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "NotificationType", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "ModuleIdentity", "Gauge32", "Bits", "Counter64", "Integer32")
TruthValue, AutonomousType, DisplayString, TextualConvention, TimeStamp, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "TimeStamp", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiConformance=scsiConformance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiObjects=scsiObjects, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdType=scsiLuIdType, scsiGeneral=scsiGeneral, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTranportSPI=scsiTranportSPI, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiNotifications=scsiNotifications, scsiLuIndex=scsiLuIndex, scsiLunMapTable=scsiLunMapTable, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSRP=scsiTransportSRP, scsiCompliance=scsiCompliance, scsiLuInResets=scsiLuInResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdValue=scsiLuIdValue, scsiTarget=scsiTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapLun=scsiLunMapLun, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliances=scsiCompliances, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiLuState=scsiLuState, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiLuIdTable=scsiLuIdTable, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportTypes=scsiTransportTypes, scsiInitiator=scsiInitiator, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortRole=scsiPortRole, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdentifier=ScsiIdentifier, scsiTargetGroup=scsiTargetGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiGroups=scsiGroups, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuEntry=scsiLuEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuStatus=scsiLuStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortEntry=scsiPortEntry, scsiInstIndex=scsiInstIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses)
