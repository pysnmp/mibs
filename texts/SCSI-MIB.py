...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Integer32, Unsigned32, IpAddress, iso, Counter64, mib_2, Bits, MibIdentifier, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Integer32", "Unsigned32", "IpAddress", "iso", "Counter64", "mib-2", "Bits", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType")
RowStatus, TimeStamp, TextualConvention, DisplayString, RowPointer, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "RowPointer", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTranportSPI=scsiTranportSPI, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdentifier=ScsiIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiCompliance=scsiCompliance, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrName=scsiAuthIntrName, scsiPortIndex=scsiPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuState=scsiLuState, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuTable=scsiLuTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiGeneral=scsiGeneral, scsiConformance=scsiConformance, scsiTranportOther=scsiTranportOther, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiObjects=scsiObjects, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSBP=scsiTransportSBP, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstIndex=scsiInstIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdType=ScsiIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuInCommands=scsiLuInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportTypes=scsiTransportTypes, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiInstAlias=scsiInstAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortRole=scsiPortRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdTable=scsiLuIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiTargetGroup=scsiTargetGroup, scsiTransportFCP=scsiTransportFCP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceTable=scsiDeviceTable, scsiLuIdType=scsiLuIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceTable=scsiInstanceTable, scsiLunMapTable=scsiLunMapTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGroups=scsiGroups, scsiLuIdIndex=scsiLuIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIndex=scsiLuIndex, scsiTgtPortName=scsiTgtPortName, scsiLuEntry=scsiLuEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatus=scsiLuStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdValue=ScsiIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortName=scsiAttTgtPortName)
