...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, TimeTicks, Unsigned32, iso, MibIdentifier, mib_2, Integer32, IpAddress, ModuleIdentity, Bits, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "mib-2", "Integer32", "IpAddress", "ModuleIdentity", "Bits", "ObjectIdentity", "Gauge32")
TextualConvention, AutonomousType, TimeStamp, TruthValue, DisplayString, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiName=ScsiName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceRole=scsiDeviceRole, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevTable=scsiTgtDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstAlias=scsiInstAlias, scsiLuInCommands=scsiLuInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiPortTable=scsiPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiPortIndex=scsiPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuVendorId=scsiLuVendorId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuTable=scsiLuTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunTable=scsiDscLunTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiModule=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdValue=ScsiIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiPortEntry=scsiPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliance=scsiCompliance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportSPI=scsiTranportSPI, scsiTransportSBP=scsiTransportSBP, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuStatus=scsiLuStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotifications=scsiNotifications, scsiPortRole=scsiPortRole, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrName=scsiAuthIntrName, scsiInstIndex=scsiInstIndex, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiGeneral=scsiGeneral, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtName=scsiDscTgtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiLuProductId=scsiLuProductId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiInitiator=scsiInitiator, scsiLuState=scsiLuState, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiLuEntry=scsiLuEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus)
