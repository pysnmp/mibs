...
ObjectIdentity, MibIdentifier, Gauge32, ModuleIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Bits, Integer32, Counter32, Counter64, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Gauge32", "ModuleIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Bits", "Integer32", "Counter32", "Counter64", "mib-2", "NotificationType")
AutonomousType, TimeStamp, DisplayString, RowPointer, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "DisplayString", "RowPointer", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortTable=scsiPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliance=scsiCompliance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuState=scsiLuState, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdIndex=scsiLuIdIndex, scsiPortRole=scsiPortRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiator=scsiInitiator, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuInResets=scsiLuInResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiModule=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiObjects=scsiObjects, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiInstAlias=scsiInstAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiLunMapTable=scsiLunMapTable, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTarget=scsiTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdentifier=ScsiIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGroups=scsiGroups, scsiDeviceRole=scsiDeviceRole, ScsiIdValue=ScsiIdValue, scsiTransportTypes=scsiTransportTypes, scsiTgtPortName=scsiTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiGeneral=scsiGeneral, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceTable=scsiDeviceTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiTranportSPI=scsiTranportSPI, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIndex=scsiLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstIndex=scsiInstIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceAlias=scsiDeviceAlias, ScsiIdType=ScsiIdType, scsiTransportSRP=scsiTransportSRP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuTable=scsiLuTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiDeviceGroup=scsiDeviceGroup, scsiTranportOther=scsiTranportOther, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportFCP=scsiTransportFCP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiConformance=scsiConformance, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIndexValue=ScsiIndexValue, scsiTransportSBP=scsiTransportSBP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunEntry=scsiDscLunEntry)
