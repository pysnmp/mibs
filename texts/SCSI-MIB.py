...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Counter64, mib_2, IpAddress, NotificationType, ObjectIdentity, TimeTicks, MibIdentifier, Gauge32, Counter32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Counter64", "mib-2", "IpAddress", "NotificationType", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Gauge32", "Counter32", "iso", "Bits")
RowStatus, RowPointer, DisplayString, AutonomousType, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "DisplayString", "AutonomousType", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValue=ScsiIndexValue, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiInstAlias=scsiInstAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetGroup=scsiTargetGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDscLunEntry=scsiDscLunEntry, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGroups=scsiGroups, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiator=scsiInitiator, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, scsiModule=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiDeviceRole=scsiDeviceRole, scsiLuProductId=scsiLuProductId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceResets=scsiDeviceResets, scsiPortRole=scsiPortRole, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiGeneral=scsiGeneral, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatus=scsiLuStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiTranportOther=scsiTranportOther, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuEntry=scsiLuEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, scsiTgtPortName=scsiTgtPortName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuState=scsiLuState, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuTable=scsiLuTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiCompliances=scsiCompliances, scsiAuthIntrName=scsiAuthIntrName, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiTarget=scsiTarget, scsiLogicalUnit=scsiLogicalUnit, scsiPortTable=scsiPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiObjects=scsiObjects, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotifications=scsiNotifications, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiCompliance=scsiCompliance)
