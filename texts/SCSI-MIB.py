...
NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, TimeTicks, Counter32, Counter64, Integer32, iso, MibIdentifier, mib_2, Unsigned32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "Integer32", "iso", "MibIdentifier", "mib-2", "Unsigned32", "Gauge32", "Bits")
TextualConvention, RowPointer, TruthValue, DisplayString, AutonomousType, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdEntry=scsiLuIdEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSRP=scsiTransportSRP, scsiDeviceRole=scsiDeviceRole, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTarget=scsiTarget, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, scsiDscLunTable=scsiDscLunTable, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetGroup=scsiTargetGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdType=scsiLuIdType, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstAlias=scsiInstAlias, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiConformance=scsiConformance, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdValue=scsiLuIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortEntry=scsiPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunEntry=scsiDscLunEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceTable=scsiInstanceTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiLunMapTable=scsiLunMapTable, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiInstIndex=scsiInstIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportSPI=scsiTranportSPI, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunLun=scsiDscLunLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortName=scsiTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuProductId=scsiLuProductId, scsiCompliance=scsiCompliance, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, ScsiIdAssociation=ScsiIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuEntry=scsiLuEntry, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup)
