...
Unsigned32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, ObjectIdentity, iso, ModuleIdentity, mib_2, Integer32, Counter64, TimeTicks, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "ModuleIdentity", "mib-2", "Integer32", "Counter64", "TimeTicks", "Gauge32", "NotificationType")
TimeStamp, AutonomousType, TruthValue, TextualConvention, RowStatus, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTarget=scsiTarget, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiModule=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiCompliance=scsiCompliance, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIndex=scsiLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceGroup=scsiDeviceGroup, scsiLuInCommands=scsiLuInCommands, scsiInstanceEntry=scsiInstanceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortRole=scsiPortRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuEntry=scsiLuEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiTargetGroup=scsiTargetGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIndex=scsiDscLunIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiNotifications=scsiNotifications, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGroups=scsiGroups, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunLun=scsiDscLunLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdValue=ScsiIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstAlias=scsiInstAlias, scsiCompliances=scsiCompliances, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiDeviceEntry=scsiDeviceEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTranportOther=scsiTranportOther, scsiTranportSPI=scsiTranportSPI, scsiDeviceIndex=scsiDeviceIndex, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdType=ScsiIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiName=ScsiName, scsiIntrPrtTable=scsiIntrPrtTable, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiObjects=scsiObjects, scsiLuVendorId=scsiLuVendorId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtTable=scsiDscTgtTable, scsiLuTable=scsiLuTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuProductId=scsiLuProductId, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValue=ScsiIndexValue, scsiPortIndex=scsiPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable)
