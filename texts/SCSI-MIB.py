...
NotificationType, Bits, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, iso, ObjectIdentity, MibIdentifier, Counter32, mib_2, Gauge32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "iso", "ObjectIdentity", "MibIdentifier", "Counter32", "mib-2", "Gauge32", "Counter64", "TimeTicks")
TimeStamp, AutonomousType, DisplayString, TextualConvention, TruthValue, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdValue=scsiDscLunIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTable=scsiPortTable, scsiLuStatus=scsiLuStatus, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptType=scsiTrnsptType, scsiLunMapLun=scsiLunMapLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiLogicalUnit=scsiLogicalUnit, scsiTransportFCP=scsiTransportFCP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIndex=scsiDscLunIndex, scsiCompliances=scsiCompliances, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTarget=scsiTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiLuIdValue=scsiLuIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuTable=scsiLuTable, scsiTranportSPI=scsiTranportSPI, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiGeneral=scsiGeneral, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuEntry=scsiLuEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuInCommands=scsiLuInCommands, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWwnName=scsiLuWwnName, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiPortRole=scsiPortRole, scsiDeviceTable=scsiDeviceTable, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiGroups=scsiGroups, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotifications=scsiNotifications, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiator=scsiInitiator, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiName=ScsiName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiModule=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSRP=scsiTransportSRP, scsiObjects=scsiObjects, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiPortIndex=scsiPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIndex=scsiLuIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdType=scsiLuIdType, ScsiIdValue=ScsiIdValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation)
