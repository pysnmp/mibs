...
TimeTicks, Unsigned32, NotificationType, Gauge32, ObjectIdentity, Counter64, Counter32, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "NotificationType", "Gauge32", "ObjectIdentity", "Counter64", "Counter32", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Integer32", "iso", "MibIdentifier")
RowPointer, DisplayString, AutonomousType, TimeStamp, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "AutonomousType", "TimeStamp", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportSBP=scsiTransportSBP, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuState=scsiLuState, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortEntry=scsiPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLuProductId=scsiLuProductId, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiator=scsiInitiator, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstAlias=scsiInstAlias, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunEntry=scsiDscLunEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdValue=scsiLuIdValue, scsiGeneral=scsiGeneral, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdValue=ScsiIdValue, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortIndex=scsiPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetGroup=scsiTargetGroup, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuEntry=scsiLuEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdType=scsiLuIdType, ScsiIdType=ScsiIdType, scsiDeviceResets=scsiDeviceResets, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortTable=scsiPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiConformance=scsiConformance, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWwnName=scsiLuWwnName, scsiObjects=scsiObjects, scsiLuVendorId=scsiLuVendorId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiGroups=scsiGroups, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInResets=scsiLuInResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValue=ScsiIndexValue, scsiDscTgtName=scsiDscTgtName, scsiTransportFCP=scsiTransportFCP, scsiTarget=scsiTarget, scsiCompliance=scsiCompliance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiModule=scsiModule, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceTable=scsiDeviceTable, ScsiName=ScsiName, scsiPortRole=scsiPortRole)
