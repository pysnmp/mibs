...
mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, NotificationType, ObjectIdentity, Integer32, iso, MibIdentifier, IpAddress, Gauge32, Counter64, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "NotificationType", "ObjectIdentity", "Integer32", "iso", "MibIdentifier", "IpAddress", "Gauge32", "Counter64", "Bits", "Counter32")
TruthValue, DisplayString, TimeStamp, AutonomousType, RowStatus, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType", "RowStatus", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdEntry=scsiDscLunIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdType=ScsiIdType, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiModule=scsiModule, ScsiIdValue=ScsiIdValue, ScsiIndexValue=ScsiIndexValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiGroups=scsiGroups, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdType=scsiLuIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportTypes=scsiTransportTypes, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiLogicalUnit=scsiLogicalUnit, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIndex=scsiLuIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuProductId=scsiLuProductId, scsiDscLunLun=scsiDscLunLun, scsiObjects=scsiObjects, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapGroup=scsiLunMapGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuTable=scsiLuTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportISCSI=scsiTransportISCSI, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiNotifications=scsiNotifications, scsiDscLunTable=scsiDscLunTable, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiTarget=scsiTarget, scsiLuWwnName=scsiLuWwnName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuState=scsiLuState, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiConformance=scsiConformance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetGroup=scsiTargetGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliances=scsiCompliances, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiLuStatus=scsiLuStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuEntry=scsiLuEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLun=scsiLunMapLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGeneral=scsiGeneral, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLuInResets=scsiLuInResets, scsiTransportSBP=scsiTransportSBP, scsiTranportSPI=scsiTranportSPI, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry)
