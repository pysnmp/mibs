...
Integer32, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, iso, Gauge32, TimeTicks, Unsigned32, Counter64, NotificationType, Counter32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "iso", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "NotificationType", "Counter32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, TruthValue, TimeStamp, RowPointer, DisplayString, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "DisplayString", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTable=scsiPortTable, scsiCompliance=scsiCompliance, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunEntry=scsiDscLunEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValue=ScsiIndexValue, scsiLuTable=scsiLuTable, scsiPortEntry=scsiPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdType=ScsiIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiConformance=scsiConformance, scsiLuInCommands=scsiLuInCommands, scsiLuIdTable=scsiLuIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdentifier=ScsiIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiTransportFCP=scsiTransportFCP, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuState=scsiLuState, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiLuIdValue=scsiLuIdValue, scsiLuIdEntry=scsiLuIdEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdType=scsiDscLunIdType, scsiInstIndex=scsiInstIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunLun=scsiDscLunLun, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdValue=scsiDscLunIdValue, scsiObjects=scsiObjects, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiGroups=scsiGroups, scsiLuProductId=scsiLuProductId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuEntry=scsiLuEntry, scsiLuIdType=scsiLuIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiNotifications=scsiNotifications, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiPortIndex=scsiPortIndex, scsiLuStatus=scsiLuStatus, scsiCompliances=scsiCompliances, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiName=ScsiName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortName=scsiTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevEntry=scsiIntrDevEntry)
