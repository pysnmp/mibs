...
ObjectIdentity, Counter64, Gauge32, Bits, MibIdentifier, Integer32, Unsigned32, NotificationType, ModuleIdentity, Counter32, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Gauge32", "Bits", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
TruthValue, TextualConvention, TimeStamp, RowStatus, AutonomousType, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TimeStamp", "RowStatus", "AutonomousType", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptType=scsiTrnsptType, ScsiIndexValue=ScsiIndexValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiObjects=scsiObjects, scsiModule=scsiModule, scsiDscLunLun=scsiDscLunLun, scsiLogicalUnit=scsiLogicalUnit, scsiCompliance=scsiCompliance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdValue=ScsiIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortIndex=scsiPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, scsiDeviceTable=scsiDeviceTable, scsiNotifications=scsiNotifications, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiGeneral=scsiGeneral, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIndex=scsiLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstAlias=scsiInstAlias, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiLuTable=scsiLuTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuState=scsiLuState, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLun=scsiLunMapLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapIndex=scsiLunMapIndex, scsiPortEntry=scsiPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiTransportISCSI=scsiTransportISCSI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLuEntry=scsiLuEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTable=scsiPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtName=scsiIntrPrtName, ScsiName=ScsiName, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiConformance=scsiConformance, scsiDscLunIdType=scsiDscLunIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliances=scsiCompliances, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGroups=scsiGroups, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdValue=scsiLuIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiTarget=scsiTarget, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortName=scsiTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiDeviceRole=scsiDeviceRole, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiInstIndex=scsiInstIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIndex=scsiDscLunIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdType=scsiLuIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiRemoteTarget=scsiRemoteTarget, scsiLuVendorId=scsiLuVendorId, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportOther=scsiTranportOther, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex)
