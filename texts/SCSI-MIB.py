...
iso, Counter32, Unsigned32, TimeTicks, IpAddress, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, ModuleIdentity, Integer32, mib_2, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Unsigned32", "TimeTicks", "IpAddress", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Integer32", "mib-2", "Gauge32", "MibIdentifier")
DisplayString, TruthValue, RowPointer, RowStatus, TimeStamp, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowPointer", "RowStatus", "TimeStamp", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiConformance=scsiConformance, scsiLuTable=scsiLuTable, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuStatus=scsiLuStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiName=ScsiName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdValue=ScsiIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, scsiCompliance=scsiCompliance, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdType=ScsiIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValue=ScsiIndexValue, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTarget=scsiTarget, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceTable=scsiInstanceTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiTransportFCP=scsiTransportFCP, scsiPortRole=scsiPortRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiLuInCommands=scsiLuInCommands, scsiTargetGroup=scsiTargetGroup, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortIndex=scsiPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuProductId=scsiLuProductId, scsiLuEntry=scsiLuEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceAlias=scsiDeviceAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiPortTable=scsiPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportTypes=scsiTransportTypes, scsiTrnsptType=scsiTrnsptType, scsiGroups=scsiGroups, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInResets=scsiLuInResets, scsiTransportSBP=scsiTransportSBP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceTable=scsiDeviceTable, scsiLuStatusChanged=scsiLuStatusChanged)
