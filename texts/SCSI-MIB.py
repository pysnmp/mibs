...
Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, mib_2, IpAddress, NotificationType, ModuleIdentity, ObjectIdentity, Gauge32, Counter32, TimeTicks, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "mib-2", "IpAddress", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "Bits", "MibIdentifier")
TruthValue, RowStatus, DisplayString, TextualConvention, TimeStamp, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "TimeStamp", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuEntry=scsiLuEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdType=scsiLuIdType, scsiNotifications=scsiNotifications, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, scsiInstIndex=scsiInstIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLun=scsiLunMapLun, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuTable=scsiLuTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdType=ScsiIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSBP=scsiTransportSBP, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiModule=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuWwnName=scsiLuWwnName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGroups=scsiGroups, ScsiName=ScsiName, scsiTgtPortName=scsiTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunTable=scsiDscLunTable, scsiTransportSRP=scsiTransportSRP, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiator=scsiInitiator, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdValue=scsiLuIdValue, scsiLuProductId=scsiLuProductId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiCompliances=scsiCompliances, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetGroup=scsiTargetGroup, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdValue=ScsiIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, ScsiIdentifier=ScsiIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceRole=scsiDeviceRole, scsiDeviceAlias=scsiDeviceAlias, scsiLuInResets=scsiLuInResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTable=scsiPortTable, scsiDscTgtName=scsiDscTgtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceResets=scsiDeviceResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue)
