...
TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, MibIdentifier, ObjectIdentity, iso, IpAddress, Gauge32, Counter32, ModuleIdentity, Integer32, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "MibIdentifier", "ObjectIdentity", "iso", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "mib-2")
RowPointer, TextualConvention, TruthValue, TimeStamp, RowStatus, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdValue=scsiLuIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiPortTable=scsiPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiCompliances=scsiCompliances, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTarget=scsiTarget, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatus=scsiLuStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportOther=scsiTranportOther, scsiDeviceRole=scsiDeviceRole, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetGroup=scsiTargetGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInResets=scsiLuInResets, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstAlias=scsiInstAlias, scsiPortIndex=scsiPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiName=ScsiName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiator=scsiInitiator, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdType=scsiLuIdType, scsiLuWwnName=scsiLuWwnName, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiPortEntry=scsiPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiModule=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportTypes=scsiTransportTypes, scsiLuState=scsiLuState, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, scsiAuthIntrName=scsiAuthIntrName, scsiConformance=scsiConformance, scsiNotifications=scsiNotifications, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiObjects=scsiObjects, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportISCSI=scsiTransportISCSI, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstanceEntry=scsiInstanceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiInstanceTable=scsiInstanceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuInCommands=scsiLuInCommands, scsiLunMapTable=scsiLunMapTable, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiGroups=scsiGroups, scsiLuIdEntry=scsiLuIdEntry, scsiPortRole=scsiPortRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets)
