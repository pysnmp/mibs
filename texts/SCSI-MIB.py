...
IpAddress, MibIdentifier, iso, Integer32, mib_2, Counter64, TimeTicks, Unsigned32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "iso", "Integer32", "mib-2", "Counter64", "TimeTicks", "Unsigned32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter32")
TruthValue, AutonomousType, DisplayString, RowStatus, TextualConvention, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "RowStatus", "TextualConvention", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortTable=scsiTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiGroups=scsiGroups, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiModule=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortIndex=scsiPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliances=scsiCompliances, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, scsiLuState=scsiLuState, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliance=scsiCompliance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevTable=scsiTgtDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceResets=scsiDeviceResets, ScsiIdValue=ScsiIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportTypes=scsiTransportTypes, scsiNotifications=scsiNotifications, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValue=ScsiIndexValue, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortRole=scsiPortRole, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiConformance=scsiConformance, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiGeneral=scsiGeneral, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiLuIndex=scsiLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, ScsiName=ScsiName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiInitiator=scsiInitiator, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapTable=scsiLunMapTable, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdType=scsiLuIdType, scsiObjects=scsiObjects, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortEntry=scsiTgtPortEntry)
