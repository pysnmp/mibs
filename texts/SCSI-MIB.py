...
MibIdentifier, ModuleIdentity, Integer32, Gauge32, TimeTicks, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, iso, Counter32, Counter64, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Integer32", "Gauge32", "TimeTicks", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "iso", "Counter32", "Counter64", "ObjectIdentity", "IpAddress")
TimeStamp, TruthValue, RowStatus, RowPointer, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "RowPointer", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTranportSPI=scsiTranportSPI, scsiLunMapTable=scsiLunMapTable, scsiDeviceTable=scsiDeviceTable, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptType=scsiTrnsptType, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuRevisionId=scsiLuRevisionId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdValue=scsiLuIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTable=scsiPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliance=scsiCompliance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliances=scsiCompliances, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiLuIdIndex=scsiLuIdIndex, ScsiIndexValue=ScsiIndexValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTarget=scsiTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunLun=scsiDscLunLun, scsiLuInCommands=scsiLuInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiGroups=scsiGroups, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTargetGroup=scsiTargetGroup, ScsiIdType=ScsiIdType, ScsiIdAssociation=ScsiIdAssociation, scsiLuEntry=scsiLuEntry, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceTable=scsiInstanceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstIndex=scsiInstIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportOther=scsiTranportOther, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiDscLunIdType=scsiDscLunIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdValue=ScsiIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptDevName=scsiTrnsptDevName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiConformance=scsiConformance, scsiPortRole=scsiPortRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuTable=scsiLuTable, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiInstAlias=scsiInstAlias, scsiLuWwnName=scsiLuWwnName, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiInitiator=scsiInitiator, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGeneral=scsiGeneral, scsiLuState=scsiLuState, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuProductId=scsiLuProductId, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands)
