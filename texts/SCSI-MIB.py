...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter64, Bits, NotificationType, ModuleIdentity, mib_2, Gauge32, TimeTicks, ObjectIdentity, Counter32, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "mib-2", "Gauge32", "TimeTicks", "ObjectIdentity", "Counter32", "IpAddress", "Unsigned32")
DisplayString, AutonomousType, TruthValue, TimeStamp, RowPointer, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiModule=scsiModule, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuProductId=scsiLuProductId, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdTable=scsiLuIdTable, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdType=ScsiIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiCompliance=scsiCompliance, ScsiIdValue=ScsiIdValue, scsiDscTgtEntry=scsiDscTgtEntry, ScsiName=ScsiName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotifications=scsiNotifications, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTarget=scsiTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrName=scsiAuthIntrName, scsiPortTable=scsiPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiTransportTypes=scsiTransportTypes, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiConformance=scsiConformance, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortRole=scsiPortRole, scsiLuTable=scsiLuTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiObjects=scsiObjects, scsiDeviceResets=scsiDeviceResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortIndex=scsiPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuEntry=scsiLuEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunEntry=scsiDscLunEntry, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceEntry=scsiDeviceEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIndex=scsiLuIndex, scsiInstanceEntry=scsiInstanceEntry, scsiGeneral=scsiGeneral, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdType=scsiDscLunIdType, scsiTranportSPI=scsiTranportSPI, scsiLuStatus=scsiLuStatus, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValue=ScsiIndexValue, scsiTranportOther=scsiTranportOther, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtName=scsiIntrPrtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptTable=scsiTrnsptTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceRole=scsiDeviceRole, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuHSInCommands=scsiLuHSInCommands)
