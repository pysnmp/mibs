...
IpAddress, ObjectIdentity, Bits, NotificationType, Unsigned32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64, mib_2, iso, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Bits", "NotificationType", "Unsigned32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64", "mib-2", "iso", "MibIdentifier", "Integer32")
TimeStamp, TextualConvention, DisplayString, RowStatus, RowPointer, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "RowPointer", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortEntry=scsiPortEntry, scsiPortIndex=scsiPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdValue=scsiLuIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortName=scsiTgtPortName, scsiModule=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdentifier=ScsiIdentifier, ScsiName=ScsiName, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiLuInCommands=scsiLuInCommands, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiator=scsiInitiator, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiGeneral=scsiGeneral, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortTable=scsiPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiConformance=scsiConformance, scsiPortRole=scsiPortRole, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdType=scsiLuIdType, scsiLuStatus=scsiLuStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiLunMapIndex=scsiLunMapIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevEntry=scsiIntrDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteTarget=scsiRemoteTarget, scsiCompliance=scsiCompliance, ScsiIdType=ScsiIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliances=scsiCompliances, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTranportOther=scsiTranportOther)
