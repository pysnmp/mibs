...
TimeTicks, iso, Bits, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, Integer32, Gauge32, Unsigned32, mib_2, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "Integer32", "Gauge32", "Unsigned32", "mib-2", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64")
RowPointer, RowStatus, TimeStamp, TruthValue, AutonomousType, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunLun=scsiDscLunLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapTable=scsiLunMapTable, scsiLuProductId=scsiLuProductId, scsiLuIdIndex=scsiLuIdIndex, scsiTranportOther=scsiTranportOther, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetGroup=scsiTargetGroup, scsiGeneral=scsiGeneral, scsiInstIndex=scsiInstIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortEntry=scsiPortEntry, scsiLuIdValue=scsiLuIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptType=scsiTrnsptType, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiLUNOrZero=ScsiLUNOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInitiator=scsiInitiator, scsiLunMapEntry=scsiLunMapEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdTable=scsiLuIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptTable=scsiTrnsptTable, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuStatus=scsiLuStatus, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiPortTable=scsiPortTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiNotifications=scsiNotifications, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortRole=scsiPortRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdType=ScsiIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptEntry=scsiTrnsptEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiName=ScsiName, PYSNMP_MODULE_ID=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiModule=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuInCommands=scsiLuInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiGroups=scsiGroups, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIndex=scsiLuIndex, scsiDeviceTable=scsiDeviceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiCompliances=scsiCompliances, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, ScsiIdValue=ScsiIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortIndex=scsiPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortName=scsiTgtPortName, scsiLuVendorId=scsiLuVendorId, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInResets=scsiLuInResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType)
