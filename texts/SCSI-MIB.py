...
NotificationType, IpAddress, Counter64, Bits, mib_2, Unsigned32, Integer32, ObjectIdentity, Gauge32, ModuleIdentity, MibIdentifier, TimeTicks, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "Bits", "mib-2", "Unsigned32", "Integer32", "ObjectIdentity", "Gauge32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TextualConvention, TruthValue, TimeStamp, DisplayString, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLuEntry=scsiLuEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuState=scsiLuState, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiPortEntry=scsiPortEntry, scsiTranportOther=scsiTranportOther, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceRole=scsiDeviceRole, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiInstAlias=scsiInstAlias, scsiLuVendorId=scsiLuVendorId, ScsiIdValue=ScsiIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiLuInResets=scsiLuInResets, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapTable=scsiLunMapTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportFCP=scsiTransportFCP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTarget=scsiTarget, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiGeneral=scsiGeneral, scsiDeviceEntry=scsiDeviceEntry, ScsiName=ScsiName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdType=scsiLuIdType, scsiIntrPrtName=scsiIntrPrtName, ScsiIdType=ScsiIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiObjects=scsiObjects, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuProductId=scsiLuProductId, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetGroup=scsiTargetGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiCompliances=scsiCompliances, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptType=scsiTrnsptType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiator=scsiInitiator, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiConformance=scsiConformance, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortIndex=scsiPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortRole=scsiPortRole)
