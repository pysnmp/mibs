...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, MibIdentifier, Integer32, ObjectIdentity, iso, TimeTicks, mib_2, Counter32, Counter64, NotificationType, IpAddress, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "MibIdentifier", "Integer32", "ObjectIdentity", "iso", "TimeTicks", "mib-2", "Counter32", "Counter64", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32")
AutonomousType, TimeStamp, TextualConvention, RowPointer, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TextualConvention", "RowPointer", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunLun=scsiDscLunLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstIndex=scsiInstIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortRole=scsiPortRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTarget=scsiTarget, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiCompliances=scsiCompliances, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdValue=ScsiIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdIndex=scsiLuIdIndex, scsiTransportFCP=scsiTransportFCP, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiObjects=scsiObjects, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiInstAlias=scsiInstAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtName=scsiIntrPrtName, scsiLuTable=scsiLuTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortIndex=scsiPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInResets=scsiLuInResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotifications=scsiNotifications, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptIndex=scsiTrnsptIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWwnName=scsiLuWwnName, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapLun=scsiLunMapLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiModule=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiLuIndex=scsiLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdType=ScsiIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceTable=scsiDeviceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtName=scsiDscTgtName, scsiDscLunEntry=scsiDscLunEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiGroups=scsiGroups, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiator=scsiInitiator, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
