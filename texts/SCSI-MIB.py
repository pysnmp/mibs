...
Unsigned32, ModuleIdentity, Counter32, Integer32, ObjectIdentity, Counter64, mib_2, TimeTicks, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter32", "Integer32", "ObjectIdentity", "Counter64", "mib-2", "TimeTicks", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "MibIdentifier", "Bits")
RowStatus, TextualConvention, TimeStamp, RowPointer, AutonomousType, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuProductId=scsiLuProductId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiObjects=scsiObjects, scsiDeviceIndex=scsiDeviceIndex, scsiTransportTypes=scsiTransportTypes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunTable=scsiDscLunTable, scsiTransportFCP=scsiTransportFCP, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceEntry=scsiDeviceEntry, scsiCompliances=scsiCompliances, scsiLuIdValue=scsiLuIdValue, scsiInstAlias=scsiInstAlias, scsiDeviceRole=scsiDeviceRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdType=scsiLuIdType, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiator=scsiInitiator, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdTable=scsiLuIdTable, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiNotifications=scsiNotifications, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiLogicalUnit=scsiLogicalUnit, scsiTransportSRP=scsiTransportSRP, scsiPortTable=scsiPortTable, scsiTgtPortTable=scsiTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuTable=scsiLuTable, scsiPortEntry=scsiPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuStatus=scsiLuStatus, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiLuState=scsiLuState, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGroups=scsiGroups, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtName=scsiDscTgtName, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdType=ScsiIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdValue=ScsiIdValue, scsiTranportOther=scsiTranportOther, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGeneral=scsiGeneral, scsiAttTgtPortName=scsiAttTgtPortName, scsiModule=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportSPI=scsiTranportSPI, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapTable=scsiLunMapTable, ScsiName=ScsiName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiInstIndex=scsiInstIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName)
