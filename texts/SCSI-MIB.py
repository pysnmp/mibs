...
iso, Counter64, mib_2, Integer32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, TimeTicks, ObjectIdentity, Gauge32, Unsigned32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "mib-2", "Integer32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "TimeTicks", "ObjectIdentity", "Gauge32", "Unsigned32", "NotificationType", "MibIdentifier")
TruthValue, DisplayString, RowStatus, TimeStamp, AutonomousType, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "TimeStamp", "AutonomousType", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportTypes=scsiTransportTypes, scsiTgtPortName=scsiTgtPortName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortIndex=scsiPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiLuTable=scsiLuTable, scsiLuWwnName=scsiLuWwnName, scsiGroups=scsiGroups, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, ScsiName=ScsiName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdValue=scsiLuIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, ScsiIdType=ScsiIdType, scsiDeviceResets=scsiDeviceResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun, scsiInstIndex=scsiInstIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTranportSPI=scsiTranportSPI, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuRevisionId=scsiLuRevisionId, ScsiIndexValue=ScsiIndexValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceRole=scsiDeviceRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuProductId=scsiLuProductId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiObjects=scsiObjects, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortTable=scsiPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiTargetGroup=scsiTargetGroup, scsiInstAlias=scsiInstAlias, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortEntry=scsiPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSRP=scsiTransportSRP, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdValue=ScsiIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliances=scsiCompliances, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapEntry=scsiLunMapEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInResets=scsiLuInResets, ScsiNameIdOrZero=ScsiNameIdOrZero)
