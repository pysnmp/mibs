...
mib_2, iso, Bits, Unsigned32, MibIdentifier, Integer32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, NotificationType, ModuleIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Bits", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter32")
TextualConvention, TruthValue, RowPointer, DisplayString, RowStatus, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowPointer", "DisplayString", "RowStatus", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevTable=scsiTgtDevTable, scsiConformance=scsiConformance, scsiLuEntry=scsiLuEntry, scsiLuState=scsiLuState, scsiLuIdType=scsiLuIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIndex=scsiDscLunIndex, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiTgtPortTable=scsiTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiLuIndex=scsiLuIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiator=scsiInitiator, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuProductId=scsiLuProductId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliances=scsiCompliances, scsiDeviceRole=scsiDeviceRole, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtTable=scsiIntrPrtTable, PYSNMP_MODULE_ID=scsiModule, scsiLuTable=scsiLuTable, scsiGroups=scsiGroups, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, scsiPortTable=scsiPortTable, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiObjects=scsiObjects, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatus=scsiLuStatus, scsiTransportSRP=scsiTransportSRP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotifications=scsiNotifications, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, ScsiName=ScsiName, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInCommands=scsiLuInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiModule=scsiModule, scsiDscLunLun=scsiDscLunLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, ScsiIdValue=ScsiIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiGeneral=scsiGeneral, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex)
