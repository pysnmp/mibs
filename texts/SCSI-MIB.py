...
ObjectIdentity, Bits, MibIdentifier, Gauge32, Counter32, iso, IpAddress, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "MibIdentifier", "Gauge32", "Counter32", "iso", "IpAddress", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType")
DisplayString, TruthValue, TextualConvention, RowPointer, RowStatus, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TextualConvention", "RowPointer", "RowStatus", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGroups=scsiGroups, scsiLuIdEntry=scsiLuIdEntry, scsiModule=scsiModule, scsiLuState=scsiLuState, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportFCP=scsiTransportFCP, ScsiLUNOrZero=ScsiLUNOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtName=scsiIntrPrtName, scsiPortIndex=scsiPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdTable=scsiDscLunIdTable, ScsiName=ScsiName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtTable=scsiDscTgtTable, ScsiIdentifier=ScsiIdentifier, scsiLuInResets=scsiLuInResets, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTranportSPI=scsiTranportSPI, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTarget=scsiTarget, scsiPortRole=scsiPortRole, ScsiIdValue=ScsiIdValue, scsiLuIdType=scsiLuIdType, scsiTrnsptType=scsiTrnsptType, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstAlias=scsiInstAlias, scsiInitiator=scsiInitiator, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiGeneral=scsiGeneral, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiObjects=scsiObjects, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliance=scsiCompliance, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuTable=scsiLuTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiDeviceAlias=scsiDeviceAlias, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdType=ScsiIdType, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValue=ScsiIndexValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiConformance=scsiConformance, scsiLuEntry=scsiLuEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex)
