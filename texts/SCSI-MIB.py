...
MibIdentifier, TimeTicks, Integer32, NotificationType, mib_2, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Counter64, Unsigned32, ObjectIdentity, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Integer32", "NotificationType", "mib-2", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Counter64", "Unsigned32", "ObjectIdentity", "IpAddress", "ModuleIdentity")
TruthValue, RowStatus, TextualConvention, RowPointer, AutonomousType, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TextualConvention", "RowPointer", "AutonomousType", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiObjects=scsiObjects, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLuEntry=scsiLuEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdType=ScsiIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, PYSNMP_MODULE_ID=scsiModule, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLun=scsiLunMapLun, scsiDscLunTable=scsiDscLunTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSRP=scsiTransportSRP, scsiPortIndex=scsiPortIndex, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIndexValue=ScsiIndexValue, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, scsiLuIdTable=scsiLuIdTable, scsiTargetGroup=scsiTargetGroup, scsiDeviceRole=scsiDeviceRole, scsiPortRole=scsiPortRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, scsiDeviceEntry=scsiDeviceEntry, scsiLuProductId=scsiLuProductId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuInCommands=scsiLuInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiGroups=scsiGroups, scsiLuIdValue=scsiLuIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIndex=scsiLuIndex, scsiInstIndex=scsiInstIndex, scsiDscLunLun=scsiDscLunLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrName=scsiAuthIntrName, scsiTranportOther=scsiTranportOther, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiPortTable=scsiPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliance=scsiCompliance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortEntry=scsiPortEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtName=scsiDscTgtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuWwnName=scsiLuWwnName, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiTranportSPI=scsiTranportSPI, scsiLuIdIndex=scsiLuIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiRemoteTarget=scsiRemoteTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliances=scsiCompliances, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportFCP=scsiTransportFCP, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiModule=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortName=scsiTgtPortName)
