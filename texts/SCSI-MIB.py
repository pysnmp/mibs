...
Counter32, iso, Bits, MibIdentifier, IpAddress, Counter64, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Gauge32, mib_2, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Bits", "MibIdentifier", "IpAddress", "Counter64", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Gauge32", "mib-2", "Unsigned32", "NotificationType")
DisplayString, TextualConvention, RowStatus, TruthValue, TimeStamp, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowStatus", "TruthValue", "TimeStamp", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiTarget=scsiTarget, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortRole=scsiPortRole, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdValue=scsiLuIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuTable=scsiLuTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtName=scsiDscTgtName, scsiLuStatus=scsiLuStatus, scsiPortTable=scsiPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliances=scsiCompliances, scsiLunMapGroup=scsiLunMapGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunTable=scsiDscLunTable, scsiInstIndex=scsiInstIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLun=scsiLunMapLun, scsiTranportOther=scsiTranportOther, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdTable=scsiLuIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiLuProductId=scsiLuProductId, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortName=scsiTgtPortName, scsiObjects=scsiObjects, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuState=scsiLuState, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortIndex=scsiPortIndex, scsiLuInCommands=scsiLuInCommands, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, scsiGroups=scsiGroups, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGeneral=scsiGeneral, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiator=scsiInitiator, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotifications=scsiNotifications, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuEntry=scsiLuEntry, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportTypes=scsiTransportTypes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdType=ScsiIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevEntry=scsiTgtDevEntry, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup)
