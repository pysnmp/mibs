...
NotificationType, Integer32, mib_2, TimeTicks, Gauge32, iso, ObjectIdentity, ModuleIdentity, IpAddress, Counter64, Bits, Counter32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "mib-2", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Counter64", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, TextualConvention, DisplayString, TruthValue, RowPointer, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DisplayString", "TruthValue", "RowPointer", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiTargetGroup=scsiTargetGroup, scsiModule=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptTable=scsiTrnsptTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiConformance=scsiConformance, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceAlias=scsiDeviceAlias, ScsiName=ScsiName, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortEntry=scsiPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiTarget=scsiTarget, scsiCompliance=scsiCompliance, scsiPortTable=scsiPortTable, scsiCompliances=scsiCompliances, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGeneral=scsiGeneral, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuStatusChanged=scsiLuStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortRole=scsiPortRole, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdType=ScsiIdType, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstAlias=scsiInstAlias, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceGroup=scsiDeviceGroup, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLuInCommands=scsiLuInCommands, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportSBP=scsiTransportSBP, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotifications=scsiNotifications, scsiGroups=scsiGroups, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportSPI=scsiTranportSPI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstIndex=scsiInstIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInResets=scsiLuInResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdentifier=ScsiIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiObjects=scsiObjects, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtName=scsiDscTgtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuTable=scsiLuTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuState=scsiLuState, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiLuIdType=scsiLuIdType)
