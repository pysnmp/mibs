...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Counter64, mib_2, IpAddress, MibIdentifier, Unsigned32, Integer32, iso, ModuleIdentity, TimeTicks, Counter32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Counter64", "mib-2", "IpAddress", "MibIdentifier", "Unsigned32", "Integer32", "iso", "ModuleIdentity", "TimeTicks", "Counter32", "Gauge32", "Bits")
DisplayString, TimeStamp, TextualConvention, TruthValue, AutonomousType, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue", "AutonomousType", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiObjects=scsiObjects, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiModule=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLun=scsiLunMapLun, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuProductId=scsiLuProductId, ScsiIdentifier=ScsiIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtTable=scsiIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceResets=scsiDeviceResets, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapTable=scsiLunMapTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, ScsiIdValue=ScsiIdValue, scsiInstAlias=scsiInstAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInResets=scsiLuInResets, scsiAuthIntrName=scsiAuthIntrName, scsiLuEntry=scsiLuEntry, scsiTranportSPI=scsiTranportSPI, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdType=scsiLuIdType, scsiLuStatus=scsiLuStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiPortTable=scsiPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliance=scsiCompliance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuState=scsiLuState, scsiInstIndex=scsiInstIndex, scsiDeviceTable=scsiDeviceTable, scsiLuRevisionId=scsiLuRevisionId, scsiDevicePortNumber=scsiDevicePortNumber, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortName=scsiTgtPortName, scsiPortRole=scsiPortRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliances=scsiCompliances, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportTypes=scsiTransportTypes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevTable=scsiTgtDevTable, scsiConformance=scsiConformance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGroups=scsiGroups, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuTable=scsiLuTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiator=scsiInitiator, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTable=scsiIntrDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortIndex=scsiPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInCommands=scsiLuInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup)
