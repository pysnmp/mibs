...
NotificationType, ModuleIdentity, MibIdentifier, Integer32, TimeTicks, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, ObjectIdentity, Gauge32, iso, transmission = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibIdentifier", "Integer32", "TimeTicks", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "ObjectIdentity", "Gauge32", "iso", "transmission")
...
mibBuilder.exportSymbols("DOCS-IF-MIB", docsIfUpChannelFrequency=docsIfUpChannelFrequency, docsIfCmtsCmStatusTable=docsIfCmtsCmStatusTable, docsIfQosProfMaxUpBandwidth=docsIfQosProfMaxUpBandwidth, docsIfGroups=docsIfGroups, docsIfCmtsStatusEntry=docsIfCmtsStatusEntry, docsIfCmMacEntry=docsIfCmMacEntry, docsIfUpChannelModulationProfile=docsIfUpChannelModulationProfile, docsIfObsoleteGroup=docsIfObsoleteGroup, docsIfCmtsModLastCodewordShortened=docsIfCmtsModLastCodewordShortened, docsIfSignalQualityTable=docsIfSignalQualityTable, docsIfCmtsCmStatusSignalNoise=docsIfCmtsCmStatusSignalNoise, docsIfCmtsMacTable=docsIfCmtsMacTable, docsIfQosProfMaxTxBurst=docsIfQosProfMaxTxBurst, docsIfCmServiceRqExceededs=docsIfCmServiceRqExceededs, docsIfCmtsModScrambler=docsIfCmtsModScrambler, docsIfCmServiceRqRetries=docsIfCmServiceRqRetries, docsIfCmServiceEntry=docsIfCmServiceEntry, docsIfCmtsCmStatusValue=docsIfCmtsCmStatusValue, docsIfCmServiceId=docsIfCmServiceId, docsIfCmtsCmStatusIpAddress=docsIfCmtsCmStatusIpAddress, docsIfCmtsModulationEntry=docsIfCmtsModulationEntry, docsIfUpChannelRangingBackoffStart=docsIfUpChannelRangingBackoffStart, docsIfUpstreamChannelEntry=docsIfUpstreamChannelEntry, docsIfCmtsCmStatusDownChannelIfIndex=docsIfCmtsCmStatusDownChannelIfIndex, docsIfCmtsCmStatusTimingOffset=docsIfCmtsCmStatusTimingOffset, docsIfCmtsServiceInPackets=docsIfCmtsServiceInPackets, docsIfCmServiceQosProfile=docsIfCmServiceQosProfile, docsIfSigQSignalNoise=docsIfSigQSignalNoise, docsIfCmtsStatusRangingAborteds=docsIfCmtsStatusRangingAborteds, docsIfCmStatusTxPower=docsIfCmStatusTxPower, docsIfCmtsModMaxBurstSize=docsIfCmtsModMaxBurstSize, docsIfCmMacTable=docsIfCmMacTable, docsIfCmtsCmStatusIndex=docsIfCmtsCmStatusIndex, docsIfCmStatusEntry=docsIfCmStatusEntry, docsIfCmtsServiceEntry=docsIfCmtsServiceEntry, docsIfQosProfileEntry=docsIfQosProfileEntry, docsIfDownChannelWidth=docsIfDownChannelWidth, docsIfUpChannelTxBackoffEnd=docsIfUpChannelTxBackoffEnd, docsIfCmStatusLostSyncs=docsIfCmStatusLostSyncs, docsIfCmtsModIndex=docsIfCmtsModIndex, docsIfCmtsServiceCmStatusIndex=docsIfCmtsServiceCmStatusIndex, docsIfCmStatusTable=docsIfCmStatusTable, docsIfNotification=docsIfNotification, docsIfQosProfStatus=docsIfQosProfStatus, docsIfCmStatusT2Timeouts=docsIfCmStatusT2Timeouts, docsIfCmtsCmStatusMacAddress=docsIfCmtsCmStatusMacAddress, docsIfCmtsMacToCmTable=docsIfCmtsMacToCmTable, docsIfCmtsMacEntry=docsIfCmtsMacEntry, docsIfDownChannelId=docsIfDownChannelId, docsIfCmObjects=docsIfCmObjects, docsIfCmtsServiceCreateTime=docsIfCmtsServiceCreateTime, docsIfCmtsCmPtr=docsIfCmtsCmPtr, docsIfCmtsModulationTable=docsIfCmtsModulationTable, docsIfCmtsCmStatusRxPower=docsIfCmtsCmStatusRxPower, docsIfBaseObjects=docsIfBaseObjects, docsIfMib=docsIfMib, docsIfDownChannelInterleave=docsIfDownChannelInterleave, docsIfCmtsStatusInvalidDataReqs=docsIfCmtsStatusInvalidDataReqs, docsIfQosProfBaselinePrivacy=docsIfQosProfBaselinePrivacy, docsIfDownChannelModulation=docsIfDownChannelModulation, docsIfCmtsStatusTable=docsIfCmtsStatusTable, docsIfSignalQualityEntry=docsIfSignalQualityEntry, docsIfCmtsModDifferentialEncoding=docsIfCmtsModDifferentialEncoding, docsIfQosProfIndex=docsIfQosProfIndex, docsIfBasicGroup=docsIfBasicGroup, docsIfCmtsStatusInvalidRangeReqs=docsIfCmtsStatusInvalidRangeReqs, docsIfCmtsServiceAdminStatus=docsIfCmtsServiceAdminStatus, docsIfDownstreamChannelEntry=docsIfDownstreamChannelEntry, docsIfQosProfMaxDownBandwidth=docsIfQosProfMaxDownBandwidth, docsIfCmtsServiceInOctets=docsIfCmtsServiceInOctets, docsIfCmtsModType=docsIfCmtsModType, docsIfSigQMicroreflections=docsIfSigQMicroreflections, docsIfCmServiceTxRetries=docsIfCmServiceTxRetries, docsIfCmtsServiceId=docsIfCmtsServiceId, docsIfCmStatusResets=docsIfCmStatusResets, docsIfCmtsInsertionInterval=docsIfCmtsInsertionInterval, docsIfCmtsCmMac=docsIfCmtsCmMac, docsIfCmtsQosProfilePermissions=docsIfCmtsQosProfilePermissions, docsIfCmtsCmStatusCorrecteds=docsIfCmtsCmStatusCorrecteds, docsIfCmtsModControl=docsIfCmtsModControl, docsIfCmtsInvitedRangingAttempts=docsIfCmtsInvitedRangingAttempts, docsIfCmStatusInvalidMaps=docsIfCmStatusInvalidMaps, docsIfCmtsStatusT5Timeouts=docsIfCmtsStatusT5Timeouts, docsIfCmtsCmStatusUncorrectables=docsIfCmtsCmStatusUncorrectables, docsIfCmStatusInvalidUcds=docsIfCmStatusInvalidUcds, docsIfCmtsCmStatusEqualizationData=docsIfCmtsCmStatusEqualizationData, docsIfCmGroup=docsIfCmGroup, docsIfCmtsCmStatusMicroreflections=docsIfCmtsCmStatusMicroreflections, docsIfCmServiceTxSlotsImmed=docsIfCmServiceTxSlotsImmed, docsIfCmStatusT1Timeouts=docsIfCmStatusT1Timeouts, docsIfCompliances=docsIfCompliances, docsIfCmtsInsertInterval=docsIfCmtsInsertInterval, docsIfCmServiceTxSlotsDed=docsIfCmServiceTxSlotsDed, docsIfBasicCompliance=docsIfBasicCompliance, docsIfCmtsGroup=docsIfCmtsGroup, docsIfCmtsCmStatusEntry=docsIfCmtsCmStatusEntry, TenthdB=TenthdB, docsIfSigQEqualizationData=docsIfSigQEqualizationData, docsIfSigQUncorrectables=docsIfSigQUncorrectables, PYSNMP_MODULE_ID=docsIfMib, docsIfCmtsModScramblerSeed=docsIfCmtsModScramblerSeed, docsIfCmServiceTable=docsIfCmServiceTable, docsIfCmtsServiceQosProfile=docsIfCmtsServiceQosProfile, docsIfCmRangingRespTimeout=docsIfCmRangingRespTimeout, docsIfCmStatusT4Timeouts=docsIfCmStatusT4Timeouts, docsIfCmtsModFECErrorCorrection=docsIfCmtsModFECErrorCorrection, docsIfCmtsSyncInterval=docsIfCmtsSyncInterval, docsIfConformance=docsIfConformance, docsIfCmtsModFECCodewordLength=docsIfCmtsModFECCodewordLength, docsIfSigQCorrecteds=docsIfSigQCorrecteds, docsIfCmtsCapabilities=docsIfCmtsCapabilities, TenthdBmV=TenthdBmV, docsIfCmCmtsAddress=docsIfCmCmtsAddress, docsIfCmCapabilities=docsIfCmCapabilities, docsIfCmtsCmStatusUpChannelIfIndex=docsIfCmtsCmStatusUpChannelIfIndex, docsIfCmtsStatusInvalidRegReqs=docsIfCmtsStatusInvalidRegReqs, docsIfCmtsMacToCmEntry=docsIfCmtsMacToCmEntry, docsIfCmServiceTxExceededs=docsIfCmServiceTxExceededs, docsIfCmtsModPreambleLen=docsIfCmtsModPreambleLen, docsIfCmtsCmStatusUnerroreds=docsIfCmtsCmStatusUnerroreds, docsIfUpChannelSlotSize=docsIfUpChannelSlotSize, docsIfCmtsMaxServiceIds=docsIfCmtsMaxServiceIds, docsIfDownstreamChannelTable=docsIfDownstreamChannelTable, docsIfCmStatusInvalidRegistrationResponses=docsIfCmStatusInvalidRegistrationResponses, docsIfDownChannelFrequency=docsIfDownChannelFrequency, docsIfCmtsStatusFailedRegReqs=docsIfCmtsStatusFailedRegReqs, docsIfUpstreamChannelTable=docsIfUpstreamChannelTable, docsIfCmtsModIntervalUsageCode=docsIfCmtsModIntervalUsageCode, docsIfCmStatusT3Timeouts=docsIfCmStatusT3Timeouts, docsIfUpChannelTxTimingOffset=docsIfUpChannelTxTimingOffset, docsIfCmRangingTimeout=docsIfCmRangingTimeout, docsIfSigQIncludesContention=docsIfSigQIncludesContention, docsIfUpChannelId=docsIfUpChannelId, docsIfCmtsUcdInterval=docsIfCmtsUcdInterval, docsIfCmtsServiceTable=docsIfCmtsServiceTable, docsIfQosProfPriority=docsIfQosProfPriority, docsIfSigQUnerroreds=docsIfSigQUnerroreds, docsIfCmStatusCode=docsIfCmStatusCode, docsIfUpChannelTxBackoffStart=docsIfUpChannelTxBackoffStart, docsIfMibObjects=docsIfMibObjects, docsIfCmStatusInvalidRangingResponses=docsIfCmStatusInvalidRangingResponses, docsIfCmtsObjects=docsIfCmtsObjects, docsIfCmStatusRangingAborteds=docsIfCmStatusRangingAborteds, docsIfQosProfileTable=docsIfQosProfileTable, docsIfDownChannelPower=docsIfDownChannelPower, docsIfQosProfGuarUpBandwidth=docsIfQosProfGuarUpBandwidth, docsIfUpChannelRangingBackoffEnd=docsIfUpChannelRangingBackoffEnd, docsIfCmtsModGuardTimeSize=docsIfCmtsModGuardTimeSize, docsIfUpChannelWidth=docsIfUpChannelWidth, docsIfCmStatusValue=docsIfCmStatusValue)
