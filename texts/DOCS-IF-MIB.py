...
iso, TimeTicks, Unsigned32, Gauge32, MibIdentifier, Bits, Counter64, NotificationType, IpAddress, Counter32, Integer32, ObjectIdentity, transmission, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Unsigned32", "Gauge32", "MibIdentifier", "Bits", "Counter64", "NotificationType", "IpAddress", "Counter32", "Integer32", "ObjectIdentity", "transmission", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, RowStatus, MacAddress, TruthValue, DisplayString, TextualConvention, TimeInterval = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "MacAddress", "TruthValue", "DisplayString", "TextualConvention", "TimeInterval")
...
mibBuilder.exportSymbols("DOCS-IF-MIB", docsIfUpstreamChannelTable=docsIfUpstreamChannelTable, docsIfSigQCorrecteds=docsIfSigQCorrecteds, docsIfCmtsCmStatusTimingOffset=docsIfCmtsCmStatusTimingOffset, docsIfCmServiceQosProfile=docsIfCmServiceQosProfile, docsIfCmtsCmStatusEqualizationData=docsIfCmtsCmStatusEqualizationData, docsIfCmtsModulationEntry=docsIfCmtsModulationEntry, docsIfCmStatusInvalidRegistrationResponses=docsIfCmStatusInvalidRegistrationResponses, docsIfUpChannelTxBackoffEnd=docsIfUpChannelTxBackoffEnd, TenthdB=TenthdB, docsIfDownstreamChannelEntry=docsIfDownstreamChannelEntry, docsIfQosProfPriority=docsIfQosProfPriority, docsIfCmtsStatusInvalidRangeReqs=docsIfCmtsStatusInvalidRangeReqs, docsIfSigQUnerroreds=docsIfSigQUnerroreds, docsIfQosProfMaxTxBurst=docsIfQosProfMaxTxBurst, docsIfCmtsCmStatusRxPower=docsIfCmtsCmStatusRxPower, docsIfSigQIncludesContention=docsIfSigQIncludesContention, docsIfSigQUncorrectables=docsIfSigQUncorrectables, docsIfCmtsModIndex=docsIfCmtsModIndex, docsIfCmRangingRespTimeout=docsIfCmRangingRespTimeout, docsIfCmtsCmStatusValue=docsIfCmtsCmStatusValue, docsIfCmtsServiceEntry=docsIfCmtsServiceEntry, docsIfCmtsModPreambleLen=docsIfCmtsModPreambleLen, docsIfCmtsInsertInterval=docsIfCmtsInsertInterval, docsIfCmtsStatusTable=docsIfCmtsStatusTable, docsIfQosProfGuarUpBandwidth=docsIfQosProfGuarUpBandwidth, docsIfCmStatusRangingAborteds=docsIfCmStatusRangingAborteds, docsIfCmStatusInvalidRangingResponses=docsIfCmStatusInvalidRangingResponses, docsIfCmtsCmStatusSignalNoise=docsIfCmtsCmStatusSignalNoise, docsIfCmGroup=docsIfCmGroup, docsIfUpstreamChannelEntry=docsIfUpstreamChannelEntry, docsIfCmtsServiceTable=docsIfCmtsServiceTable, docsIfUpChannelWidth=docsIfUpChannelWidth, docsIfCmtsMacTable=docsIfCmtsMacTable, docsIfCmStatusTable=docsIfCmStatusTable, docsIfCmServiceRqRetries=docsIfCmServiceRqRetries, docsIfQosProfMaxUpBandwidth=docsIfQosProfMaxUpBandwidth, docsIfQosProfIndex=docsIfQosProfIndex, docsIfCmtsQosProfilePermissions=docsIfCmtsQosProfilePermissions, docsIfCmtsModulationTable=docsIfCmtsModulationTable, docsIfCmtsServiceId=docsIfCmtsServiceId, docsIfConformance=docsIfConformance, docsIfUpChannelModulationProfile=docsIfUpChannelModulationProfile, docsIfDownstreamChannelTable=docsIfDownstreamChannelTable, docsIfCmtsServiceInOctets=docsIfCmtsServiceInOctets, docsIfUpChannelTxTimingOffset=docsIfUpChannelTxTimingOffset, docsIfCmtsModLastCodewordShortened=docsIfCmtsModLastCodewordShortened, docsIfCmtsModMaxBurstSize=docsIfCmtsModMaxBurstSize, docsIfCmStatusResets=docsIfCmStatusResets, docsIfCmtsObjects=docsIfCmtsObjects, docsIfCmtsMacEntry=docsIfCmtsMacEntry, docsIfCmtsSyncInterval=docsIfCmtsSyncInterval, docsIfCmtsMacToCmTable=docsIfCmtsMacToCmTable, docsIfCmStatusLostSyncs=docsIfCmStatusLostSyncs, docsIfBaseObjects=docsIfBaseObjects, docsIfCmStatusT4Timeouts=docsIfCmStatusT4Timeouts, docsIfCmServiceTxSlotsImmed=docsIfCmServiceTxSlotsImmed, docsIfCmtsStatusEntry=docsIfCmtsStatusEntry, docsIfUpChannelId=docsIfUpChannelId, docsIfDownChannelFrequency=docsIfDownChannelFrequency, docsIfSigQMicroreflections=docsIfSigQMicroreflections, docsIfCmtsInsertionInterval=docsIfCmtsInsertionInterval, docsIfCmServiceRqExceededs=docsIfCmServiceRqExceededs, docsIfCmMacTable=docsIfCmMacTable, docsIfCmtsGroup=docsIfCmtsGroup, docsIfCmtsServiceInPackets=docsIfCmtsServiceInPackets, docsIfUpChannelSlotSize=docsIfUpChannelSlotSize, docsIfCmtsModFECErrorCorrection=docsIfCmtsModFECErrorCorrection, docsIfQosProfileEntry=docsIfQosProfileEntry, docsIfCmtsCmMac=docsIfCmtsCmMac, docsIfCmStatusInvalidUcds=docsIfCmStatusInvalidUcds, docsIfQosProfileTable=docsIfQosProfileTable, docsIfQosProfBaselinePrivacy=docsIfQosProfBaselinePrivacy, docsIfCmtsCapabilities=docsIfCmtsCapabilities, docsIfCmtsServiceCmStatusIndex=docsIfCmtsServiceCmStatusIndex, docsIfBasicCompliance=docsIfBasicCompliance, docsIfCmStatusCode=docsIfCmStatusCode, docsIfDownChannelInterleave=docsIfDownChannelInterleave, docsIfCmServiceId=docsIfCmServiceId, docsIfNotification=docsIfNotification, docsIfMibObjects=docsIfMibObjects, docsIfCmtsModType=docsIfCmtsModType, docsIfCmtsStatusInvalidDataReqs=docsIfCmtsStatusInvalidDataReqs, docsIfCmServiceTxSlotsDed=docsIfCmServiceTxSlotsDed, docsIfCmtsMaxServiceIds=docsIfCmtsMaxServiceIds, docsIfCmStatusTxPower=docsIfCmStatusTxPower, docsIfCmtsCmStatusIpAddress=docsIfCmtsCmStatusIpAddress, docsIfCmtsModDifferentialEncoding=docsIfCmtsModDifferentialEncoding, docsIfCmtsModGuardTimeSize=docsIfCmtsModGuardTimeSize, docsIfCmtsCmStatusIndex=docsIfCmtsCmStatusIndex, docsIfCmObjects=docsIfCmObjects, docsIfCmtsCmStatusUpChannelIfIndex=docsIfCmtsCmStatusUpChannelIfIndex, docsIfCmServiceEntry=docsIfCmServiceEntry, docsIfDownChannelPower=docsIfDownChannelPower, docsIfCmtsCmStatusDownChannelIfIndex=docsIfCmtsCmStatusDownChannelIfIndex, docsIfUpChannelRangingBackoffStart=docsIfUpChannelRangingBackoffStart, docsIfDownChannelWidth=docsIfDownChannelWidth, docsIfCmStatusInvalidMaps=docsIfCmStatusInvalidMaps, docsIfCmtsCmStatusEntry=docsIfCmtsCmStatusEntry, docsIfCmtsStatusT5Timeouts=docsIfCmtsStatusT5Timeouts, docsIfUpChannelTxBackoffStart=docsIfUpChannelTxBackoffStart, docsIfCmtsStatusInvalidRegReqs=docsIfCmtsStatusInvalidRegReqs, docsIfCmtsServiceQosProfile=docsIfCmtsServiceQosProfile, docsIfCmtsModFECCodewordLength=docsIfCmtsModFECCodewordLength, docsIfCmCapabilities=docsIfCmCapabilities, PYSNMP_MODULE_ID=docsIfMib, docsIfCmtsModScrambler=docsIfCmtsModScrambler, docsIfCmMacEntry=docsIfCmMacEntry, docsIfCmtsCmStatusCorrecteds=docsIfCmtsCmStatusCorrecteds, docsIfCmtsMacToCmEntry=docsIfCmtsMacToCmEntry, docsIfCmtsCmStatusMicroreflections=docsIfCmtsCmStatusMicroreflections, docsIfCmtsModIntervalUsageCode=docsIfCmtsModIntervalUsageCode, TenthdBmV=TenthdBmV, docsIfCmServiceTxExceededs=docsIfCmServiceTxExceededs, docsIfUpChannelFrequency=docsIfUpChannelFrequency, docsIfQosProfStatus=docsIfQosProfStatus, docsIfCmtsServiceAdminStatus=docsIfCmtsServiceAdminStatus, docsIfCmRangingTimeout=docsIfCmRangingTimeout, docsIfSignalQualityEntry=docsIfSignalQualityEntry, docsIfObsoleteGroup=docsIfObsoleteGroup, docsIfBasicGroup=docsIfBasicGroup, docsIfCmtsStatusRangingAborteds=docsIfCmtsStatusRangingAborteds, docsIfCompliances=docsIfCompliances, docsIfSigQSignalNoise=docsIfSigQSignalNoise, docsIfUpChannelRangingBackoffEnd=docsIfUpChannelRangingBackoffEnd, docsIfCmServiceTxRetries=docsIfCmServiceTxRetries, docsIfDownChannelModulation=docsIfDownChannelModulation, docsIfCmCmtsAddress=docsIfCmCmtsAddress, docsIfCmtsCmStatusUncorrectables=docsIfCmtsCmStatusUncorrectables, docsIfCmStatusT3Timeouts=docsIfCmStatusT3Timeouts, docsIfCmtsModControl=docsIfCmtsModControl, docsIfGroups=docsIfGroups, docsIfQosProfMaxDownBandwidth=docsIfQosProfMaxDownBandwidth, docsIfCmtsStatusFailedRegReqs=docsIfCmtsStatusFailedRegReqs, docsIfCmtsServiceCreateTime=docsIfCmtsServiceCreateTime, docsIfCmtsCmStatusMacAddress=docsIfCmtsCmStatusMacAddress, docsIfCmStatusEntry=docsIfCmStatusEntry, docsIfCmtsInvitedRangingAttempts=docsIfCmtsInvitedRangingAttempts, docsIfCmtsCmPtr=docsIfCmtsCmPtr, docsIfCmStatusT1Timeouts=docsIfCmStatusT1Timeouts, docsIfCmtsCmStatusTable=docsIfCmtsCmStatusTable, docsIfDownChannelId=docsIfDownChannelId, docsIfCmStatusT2Timeouts=docsIfCmStatusT2Timeouts, docsIfSigQEqualizationData=docsIfSigQEqualizationData, docsIfCmStatusValue=docsIfCmStatusValue, docsIfCmtsModScramblerSeed=docsIfCmtsModScramblerSeed, docsIfCmServiceTable=docsIfCmServiceTable, docsIfCmtsCmStatusUnerroreds=docsIfCmtsCmStatusUnerroreds, docsIfSignalQualityTable=docsIfSignalQualityTable, docsIfCmtsUcdInterval=docsIfCmtsUcdInterval, docsIfMib=docsIfMib)
