...
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanIfaceDot11nSMPSMode=wlanIfaceDot11nSMPSMode, wlanIfaceTdmaSlot=wlanIfaceTdmaSlot, wlanStatsRxDefragFailed=wlanStatsRxDefragFailed, wlanIfacePeerFrequency=wlanIfacePeerFrequency, wlanIfaceBgScanIdle=wlanIfaceBgScanIdle, wlanLastDeauthReason=wlanLastDeauthReason, WlanMgmtMeshReasonCode=WlanMgmtMeshReasonCode, wlanScanFlags=wlanScanFlags, wlanIfaceDot11h=wlanIfaceDot11h, wlanMeshHWMPInterface=wlanMeshHWMPInterface, wlanIfaceStatus=wlanIfaceStatus, wlanIfParentDriverCapabilities=wlanIfParentDriverCapabilities, wlanStatsRxDeauthenticate=wlanStatsRxDeauthenticate, wlanStatsAMPDURxOor=wlanStatsAMPDURxOor, begemotWlanWep=begemotWlanWep, wlanIfaceDturbo=wlanIfaceDturbo, begemotWlanMACAccessControl=begemotWlanMACAccessControl, wlanIfaceStatisticsEntry=wlanIfaceStatisticsEntry, begemotWlanStatistics=begemotWlanStatistics, wlanIfacePeerTxPower=wlanIfacePeerTxPower, wlanIfaceDot11nAmpduDensity=wlanIfaceDot11nAmpduDensity, wlanStatsRxElemTooBig=wlanStatsRxElemTooBig, wlanMeshNoFwdTtl=wlanMeshNoFwdTtl, wlanMeshNeighborPeerId=wlanMeshNeighborPeerId, wlanMeshDroppedBadAE=wlanMeshDroppedBadAE, wlanMeshMetric=wlanMeshMetric, wlanStatsTxFFEncap=wlanStatsTxFFEncap, wlanLastDissasocReason=wlanLastDissasocReason, wlanStatsRxDisassociate=wlanStatsRxDisassociate, wlanIfaceTxPower=wlanIfaceTxPower, WlanRegDomainCode=WlanRegDomainCode, wlanHWMPMaxHops=wlanHWMPMaxHops, WlanMgmtStatusCode=WlanMgmtStatusCode, wlanMeshNeighborLocalId=wlanMeshNeighborLocalId, wlanStatsSwCryptoTKIP=wlanStatsSwCryptoTKIP, wlanIfParentEntry=wlanIfParentEntry, wlanStatsRxAuthFailed=wlanStatsRxAuthFailed, wlanStatsRxWrongBssid=wlanStatsRxWrongBssid, wlanMeshRoutesFlush=wlanMeshRoutesFlush, wlanIfRoamRxSignalStrength=wlanIfRoamRxSignalStrength, wlanStatsAMPDUBadBAR=wlanStatsAMPDUBadBAR, wlanStatsCryptoTKIPCM=wlanStatsCryptoTKIPCM, wlanIfaceDot11nHTCompatible=wlanIfaceDot11nHTCompatible, wlanIfaceBeaconMissedThreshold=wlanIfaceBeaconMissedThreshold, wlanWepKeyID=wlanWepKeyID, wlanStatsRxDiscardNoAssoc=wlanStatsRxDiscardNoAssoc, wlanStatsActiveScans=wlanStatsActiveScans, wlanMeshRouteTable=wlanMeshRouteTable, wlanIfaceBssid=wlanIfaceBssid, wlanMeshNeighborEntry=wlanMeshNeighborEntry, wlanMeshRouteDestination=wlanMeshRouteDestination, wlanStatsSwCryptoTKIPDeMIC=wlanStatsSwCryptoTKIPDeMIC, wlanMeshRouteEntry=wlanMeshRouteEntry, wlanMeshNeighborIdleTimer=wlanMeshNeighborIdleTimer, wlanMeshNoFwdTooShort=wlanMeshNoFwdTooShort, wlanIfaceConfigTable=wlanIfaceConfigTable, wlanIfaceChannelTable=wlanIfaceChannelTable, wlanStatsRxWepFailed=wlanStatsRxWepFailed, wlanStatsRxCCMPFailedMIC=wlanStatsRxCCMPFailedMIC, wlanIfaceDesiredBssid=wlanIfaceDesiredBssid, wlanStatsAMPDUStopFailed=wlanStatsAMPDUStopFailed, wlanMeshPath=wlanMeshPath, wlanStatsCryptoEnMICFailed=wlanStatsCryptoEnMICFailed, wlanStatsTxControlFrames=wlanStatsTxControlFrames, wlanStatsCryptoCipherKeyRejected=wlanStatsCryptoCipherKeyRejected, wlanIfTxPhyMode=wlanIfTxPhyMode, wlanMeshNeighborFrequency=wlanMeshNeighborFrequency, wlanParentIfName=wlanParentIfName, wlanWepMode=wlanWepMode, wlanIfaceDot11nPureMode=wlanIfaceDot11nPureMode, wlanStatsHTAssocRejectNoHT=wlanStatsHTAssocRejectNoHT, wlanStatsRxFFSplitError=wlanStatsRxFFSplitError, wlanIfacePeerFlags=wlanIfacePeerFlags, wlanStatsRxTooShort=wlanStatsRxTooShort, wlanStatsRxFFTooShort=wlanStatsRxFFTooShort, wlanStatsRxAMSDUTooShort=wlanStatsRxAMSDUTooShort, wlanIfacePeerRxSignalStrength=wlanIfacePeerRxSignalStrength, wlanStatsPassiveScans=wlanStatsPassiveScans, wlanStatsEmptyPSPoll=wlanStatsEmptyPSPoll, wlanIfTxMcastRate=wlanIfTxMcastRate, wlanIfaceDot11nAmsdu=wlanIfaceDot11nAmsdu, wlanStatsADDBANoRequest=wlanStatsADDBANoRequest, wlanMACAccessControlPolicy=wlanMACAccessControlPolicy, wlanWepKeyStatus=wlanWepKeyStatus, wlanScanResultRate=wlanScanResultRate, wlanStatsRxCCMPBadFormat=wlanStatsRxCCMPBadFormat, wlanIfaceRTSThreshold=wlanIfaceRTSThreshold, begemotWlan=begemotWlan, wlanMeshNeighborTable=wlanMeshNeighborTable, wlanIfacePeerEntry=wlanIfacePeerEntry, wlanIfTxParamsTable=wlanIfTxParamsTable, begemotWlanMeshRouting=begemotWlanMeshRouting, wlanIfaceState=wlanIfaceState, wlanMACAccessControlMACTable=wlanMACAccessControlMACTable, wlanStatsUnassocStaPSPoll=wlanStatsUnassocStaPSPoll, wlanIfacePeerCapabilities=wlanIfacePeerCapabilities, wlanIfaceLocalAddress=wlanIfaceLocalAddress, wlanStatsTxFailedNoNode=wlanStatsTxFailedNoNode, wlanMeshForwardingEnabled=wlanMeshForwardingEnabled, wlanIfTxMaxRetryCount=wlanIfTxMaxRetryCount, wlanStatsAMPDURxCopied=wlanStatsAMPDURxCopied, wlanStatsCryptoUnknownCipher=wlanStatsCryptoUnknownCipher, wlanStatsRxBadBintval=wlanStatsRxBadBintval, wlanStatsAMPDUOowBar=wlanStatsAMPDUOowBar, wlanStatsRxFailedNoBuf=wlanStatsRxFailedNoBuf, wlanStatsRxFFDecap=wlanStatsRxFFDecap, wlanIfacePeerVlanTag=wlanIfacePeerVlanTag, wlanScanResultCapabilities=wlanScanResultCapabilities, wlanStatsAMPDUStopped=wlanStatsAMPDUStopped, wlanIfaceCountryCode=wlanIfaceCountryCode, begemotWlanInterface=begemotWlanInterface, wlanHWMPTargetOnlyBit=wlanHWMPTargetOnlyBit, wlanStatsRxDiscardACL=wlanStatsRxDiscardACL, wlanStatsRxAuthCM=wlanStatsRxAuthCM, wlanWepKeyHash=wlanWepKeyHash, wlanMeshTTL=wlanMeshTTL, wlanScanResultBeaconInterval=wlanScanResultBeaconInterval, wlanMACAccessControlMAC=wlanMACAccessControlMAC, wlanStatsCryptoAttachFailed=wlanStatsCryptoAttachFailed, wlanStatsRxTKIPSeqViolation=wlanStatsRxTKIPSeqViolation, begemotWlanScanning=begemotWlanScanning, wlanMeshHWMPConfig=wlanMeshHWMPConfig, wlanHWMPPathLifetime=wlanHWMPPathLifetime, WlanPeerCapabilityFlags=WlanPeerCapabilityFlags, wlanIfRoamParamsEntry=wlanIfRoamParamsEntry, wlanIfaceDynamicWds=wlanIfaceDynamicWds, wlanMeshPeeringEnabled=wlanMeshPeeringEnabled, wlanScanConfigEntry=wlanScanConfigEntry, wlanStatsRxAssocWrongBssid=wlanStatsRxAssocWrongBssid, wlanStatsRxFFBadHdr=wlanStatsRxFFBadHdr, wlanMeshRetryTimeout=wlanMeshRetryTimeout, wlanStatsBeaconMissedEvents=wlanStatsBeaconMissedEvents, wlanStatsHTAssocRateMismatch=wlanStatsHTAssocRateMismatch, WlanIfaceDot11nPduType=WlanIfaceDot11nPduType, wlanIfRoamParamsTable=wlanIfRoamParamsTable, wlanStatsTxUnknownMgmt=wlanStatsTxUnknownMgmt, wlanIfaceChannelMaxAntennaGain=wlanIfaceChannelMaxAntennaGain, wlanScanResultNoise=wlanScanResultNoise, wlanStatsRxDropped=wlanStatsRxDropped, wlanStatsRxMgmt=wlanStatsRxMgmt, wlanIfacePeerCurrentTXRate=wlanIfacePeerCurrentTXRate, wlanMeshId=wlanMeshId, wlanMeshDroppedNoLink=wlanMeshDroppedNoLink, wlanIfaceDot11nRIFS=wlanIfaceDot11nRIFS, wlanMeshRouteMetric=wlanMeshRouteMetric, wlanMACAccessControlTable=wlanMACAccessControlTable, wlanStatsRxChannelMismatch=wlanStatsRxChannelMismatch, wlanMeshDroppedNoProxy=wlanMeshDroppedNoProxy, wlanStatsScansBackground=wlanStatsScansBackground, wlanScanResultID=wlanScanResultID, wlanStatsAMPDURxReorder=wlanStatsAMPDURxReorder, wlanIfaceChannelMaxTxPower=wlanIfaceChannelMaxTxPower, wlanScanMaxChannelDwellTime=wlanScanMaxChannelDwellTime, wlanStatsRxRateSetTooBig=wlanStatsRxRateSetTooBig, wlanMACAccessControlMACStatus=wlanMACAccessControlMACStatus, wlanMeshNeighborCurrentTXRate=wlanMeshNeighborCurrentTXRate, wlanIfacePeerRxSequenceNo=wlanIfacePeerRxSequenceNo, wlanScanResultsEntry=wlanScanResultsEntry, wlanStatsRxBadAuthRequest=wlanStatsRxBadAuthRequest, WlanIfPhyMode=WlanIfPhyMode, wlanStatsRxBadKeyId=wlanStatsRxBadKeyId, wlanIfTxMgmtRate=wlanIfTxMgmtRate, wlanStatsHTAssocDowngrade=wlanStatsHTAssocDowngrade, wlanMeshHWMPStatistics=wlanMeshHWMPStatistics, wlanScanResultBssid=wlanScanResultBssid, wlanMeshRouteFlags=wlanMeshRouteFlags, wlanIfaceBgScanInterval=wlanIfaceBgScanInterval, wlanIfaceChannelMinTxPower=wlanIfaceChannelMinTxPower, wlanStatsDwdsMcastDiscard=wlanStatsDwdsMcastDiscard, wlanStatsAMPDUMovedBAR=wlanStatsAMPDUMovedBAR, wlanMACAccessControlEntry=wlanMACAccessControlEntry, wlanIfaceWlanPrivacySubscribe=wlanIfaceWlanPrivacySubscribe, wlanHWMPReplyForwardBit=wlanHWMPReplyForwardBit, wlanIfaceIndex=wlanIfaceIndex, wlanHWMPRootMode=wlanHWMPRootMode, wlanStatsRxWepUnencrypted=wlanStatsRxWepUnencrypted, wlanIfTxUnicastRate=wlanIfTxUnicastRate, wlanStatsCryptoKeyFailed=wlanStatsCryptoKeyFailed, wlanStatsAMPDURexmtFailed=wlanStatsAMPDURexmtFailed, wlanScanResultChannel=wlanScanResultChannel, wlanMeshRouteAddFailed=wlanMeshRouteAddFailed, wlanIfaceDtimPeriod=wlanIfaceDtimPeriod, wlanIfaceChannelHTExtension=wlanIfaceChannelHTExtension, wlanScanResultsTable=wlanScanResultsTable, wlanHWMPInterfaceTable=wlanHWMPInterfaceTable, wlanStatsAMPDURxBAR=wlanStatsAMPDURxBAR, wlanStatsRxDiscardMcastEcho=wlanStatsRxDiscardMcastEcho, wlanStatsRxElemTooSmall=wlanStatsRxElemTooSmall, wlanStatsRxAMSDUSplitError=wlanStatsRxAMSDUSplitError, wlanStatsAMPDURxAge=wlanStatsAMPDURxAge, wlanStatsRxBadVersion=wlanStatsRxBadVersion, wlanStatsBadAidPSPoll=wlanStatsBadAidPSPoll, wlanIfaceHideSsid=wlanIfaceHideSsid, wlanLastAuthFailReason=wlanLastAuthFailReason, wlanStatsRxDemicFailed=wlanStatsRxDemicFailed, wlanIfaceRoamingMode=wlanIfaceRoamingMode, wlanInterfaceTable=wlanInterfaceTable, wlanIfRoamTxRateThreshold=wlanIfRoamTxRateThreshold, wlanStatsRxAssocCapMismatch=wlanStatsRxAssocCapMismatch, wlanStatsTxClassifyFailed=wlanStatsTxClassifyFailed, wlanStatsReset=wlanStatsReset, wlanMeshRouteHops=wlanMeshRouteHops, wlanMeshRouteStatus=wlanMeshRouteStatus, wlanStatsADDBADisabledReject=wlanStatsADDBADisabledReject, wlanIfRoamPhyMode=wlanIfRoamPhyMode, wlanMeshNeighborTxSequenceNo=wlanMeshNeighborTxSequenceNo, wlanIfaceConfigEntry=wlanIfaceConfigEntry, wlanStatsTxDiscardBadState=wlanStatsTxDiscardBadState, wlanMeshRoutingConfig=wlanMeshRoutingConfig, wlanMeshDroppedMisaligned=wlanMeshDroppedMisaligned, wlanStatsTxAMSDUEncap=wlanStatsTxAMSDUEncap, wlanMeshNeighborAddress=wlanMeshNeighborAddress, wlanMeshHWMPWrongSeqNo=wlanMeshHWMPWrongSeqNo, wlanMeshRouteProtocols=wlanMeshRouteProtocols, wlanMeshInterfaceEntry=wlanMeshInterfaceEntry, wlanStatsIBSSCapMismatch=wlanStatsIBSSCapMismatch, wlanIfaceChannelType=wlanIfaceChannelType, wlanMeshHWMPTxRootPREQ=wlanMeshHWMPTxRootPREQ, wlanIfacePeerIdleTimer=wlanIfacePeerIdleTimer, wlanStatsADDBABadToken=wlanStatsADDBABadToken, wlanIfaceDot11nShortGI=wlanIfaceDot11nShortGI, wlanIfParentTable=wlanIfParentTable, wlanWepKeyTable=wlanWepKeyTable, wlanStatsRxAssocNoRateMatch=wlanStatsRxAssocNoRateMatch, wlanMeshRouteLifeTime=wlanMeshRouteLifeTime, wlanIfaceChannelFlags=wlanIfaceChannelFlags, wlanIfaceChannelIeeeId=wlanIfaceChannelIeeeId, wlanMeshStatistics=wlanMeshStatistics, wlanStatsTxFailedNoBuf=wlanStatsTxFailedNoBuf, wlanStatsCryptoDeleteKeyFailed=wlanStatsCryptoDeleteKeyFailed, wlanMeshHWMPStatsTable=wlanMeshHWMPStatsTable, WlanMgmtReasonCode=WlanMgmtReasonCode, wlanIfaceDynamicFreqSelection=wlanIfaceDynamicFreqSelection, wlanStatsAMPDURexmt=wlanStatsAMPDURexmt, wlanIfaceDot11nHTProtMode=wlanIfaceDot11nHTProtMode, wlanMeshConfirmTimeout=wlanMeshConfirmTimeout, wlanStatsRxBeacon=wlanStatsRxBeacon, wlanStatsRxUnknownSubtype=wlanStatsRxUnknownSubtype, wlanHWMPInterfaceEntry=wlanHWMPInterfaceEntry, wlanStatsFFFlushed=wlanStatsFFFlushed, wlanStatsRxAssocNoAuth=wlanStatsRxAssocNoAuth, wlanMeshProtoHWMP=wlanMeshProtoHWMP, wlanIfaceChannelFrequency=wlanIfaceChannelFrequency, wlanStatsTxFragmented=wlanStatsTxFragmented, wlanMACAccessControlNacl=wlanMACAccessControlNacl, wlanStatsRxTKIPFailedMIC=wlanStatsRxTKIPFailedMIC, wlanMACAccessControlMACEntry=wlanMACAccessControlMACEntry, wlanStatsAMPDURxDropped=wlanStatsAMPDURxDropped, wlanMeshInterface=wlanMeshInterface, wlanWepKeyEntry=wlanWepKeyEntry, wlanMACAccessControlFlush=wlanMACAccessControlFlush, wlanMeshInterfaceTable=wlanMeshInterfaceTable, wlanStatsRxWrongDir=wlanStatsRxWrongDir, wlanWepKeyLength=wlanWepKeyLength)
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanIfaceDot11gPureMode=wlanIfaceDot11gPureMode, wlanMeshNeighborRxSequenceNo=wlanMeshNeighborRxSequenceNo, wlanStatsCryptoNoKey=wlanStatsCryptoNoKey, wlanIfacePowerSave=wlanIfacePowerSave, wlanIfaceDot11nAmpdu=wlanIfaceDot11nAmpdu, wlanIfacePeerTxSequenceNo=wlanIfacePeerTxSequenceNo, wlanScanConfigStatus=wlanScanConfigStatus, wlanIfaceDot11nHighThroughput=wlanIfaceDot11nHighThroughput, wlanIfaceDot11nAmsduLimit=wlanIfaceDot11nAmsduLimit, wlanStatsRxElemMissing=wlanStatsRxElemMissing, wlanMeshRoute=wlanMeshRoute, wlanIfaceChannelId=wlanIfaceChannelId, wlanMeshHWMPProxy=wlanMeshHWMPProxy, wlanStatsRxDiscardedDups=wlanStatsRxDiscardedDups, wlanMeshDroppedBadSta=wlanMeshDroppedBadSta, wlanStatsSwCryptoCCMP=wlanStatsSwCryptoCCMP, wlanIfacePeerAssociationId=wlanIfacePeerAssociationId, wlanStatsRxBadWpaIE=wlanStatsRxBadWpaIE, wlanIfaceFragmentThreshold=wlanIfaceFragmentThreshold, wlanStatsRxTKIPBadFormat=wlanStatsRxTKIPBadFormat, wlanMeshNeighborPeerState=wlanMeshNeighborPeerState, wlanIfaceDot11d=wlanIfaceDot11d, PYSNMP_MODULE_ID=begemotWlan, wlanIfaceChannelState=wlanIfaceChannelState, wlanStatsRxDiscardMgmt=wlanStatsRxDiscardMgmt, wlanIfParentHTCapabilities=wlanIfParentHTCapabilities, wlanHWMPRouteInactiveTimeout=wlanHWMPRouteInactiveTimeout, wlanStatsCryptoNoMem=wlanStatsCryptoNoMem, wlanHWMPRootTimeout=wlanHWMPRootTimeout, wlanStatsSwCryptoWEP=wlanStatsSwCryptoWEP, wlanScanMinChannelDwellTime=wlanScanMinChannelDwellTime, wlanStatsRxSsidMismatch=wlanStatsRxSsidMismatch, wlanScanDuration=wlanScanDuration, wlanIfaceDesiredSsid=wlanIfaceDesiredSsid, wlanIfaceDesiredChannel=wlanIfaceDesiredChannel, wlanWepInterfaceTable=wlanWepInterfaceTable, wlanIfaceName=wlanIfaceName, wlanIfaceBgScan=wlanIfaceBgScan, wlanStatsADDBABadPolicy=wlanStatsADDBABadPolicy, wlanStatsRxDiscardBadStates=wlanStatsRxDiscardBadStates, wlanIfaceInactivityProccess=wlanIfaceInactivityProccess, wlanStatsTxFailedNoAssoc=wlanStatsTxFailedNoAssoc, wlanMeshMaxRetries=wlanMeshMaxRetries, wlanMeshNoFwdBuf=wlanMeshNoFwdBuf, wlanIfaceTdmaSlotCount=wlanIfaceTdmaSlotCount, wlanIfacePacketBurst=wlanIfacePacketBurst, wlanIfaceRegDomain=wlanIfaceRegDomain, wlanIfacePeerAddress=wlanIfacePeerAddress, wlanIfacePeerTable=wlanIfacePeerTable, wlanStatsRxElemUnknown=wlanStatsRxElemUnknown, wlanStatsRxTKIPFailedICV=wlanStatsRxTKIPFailedICV, wlanStatsTxNoDefKey=wlanStatsTxNoDefKey, wlanScanConfigTable=wlanScanConfigTable, wlanStatsTxFragmentsCreated=wlanStatsTxFragmentsCreated, wlanStatsRxUnAuthorized=wlanStatsRxUnAuthorized, wlanMeshNoFwdDisabled=wlanMeshNoFwdDisabled, wlanStatsRxAuthNotSupported=wlanStatsRxAuthNotSupported, wlanIfaceDot11gProtMode=wlanIfaceDot11gProtMode, wlanMeshStatsTable=wlanMeshStatsTable, wlanIfaceDot11nAmpduLimit=wlanIfaceDot11nAmpduLimit, wlanIfaceApBridge=wlanIfaceApBridge, wlanIfaceTdmaBeaconInterval=wlanIfaceTdmaBeaconInterval, wlanHWMPRootAnnounceInterval=wlanHWMPRootAnnounceInterval, wlanStatsRxAMSDUDecap=wlanStatsRxAMSDUDecap, wlanMeshHWMPStatsEntry=wlanMeshHWMPStatsEntry, wlanStatsRxActionMgmt=wlanStatsRxActionMgmt, wlanIfaceFastFrames=wlanIfaceFastFrames, wlanInterfaceEntry=wlanInterfaceEntry, wlanMeshHoldingTimeout=wlanMeshHoldingTimeout, wlanIfaceChannelMaxRegPower=wlanIfaceChannelMaxRegPower, wlanWepDefTxKey=wlanWepDefTxKey, wlanIfaceOperatingMode=wlanIfaceOperatingMode, wlanStatsAMPDUMoved=wlanStatsAMPDUMoved, begemotWlanNotifications=begemotWlanNotifications, wlanStatsSwCryptoTKIPEnMIC=wlanStatsSwCryptoTKIPEnMIC, wlanStatsRxControl=wlanStatsRxControl, wlanMeshHWMPTxRootRANN=wlanMeshHWMPTxRootRANN, wlanIfParentCryptoCapabilities=wlanIfParentCryptoCapabilities, wlanMeshNeighborRxSignalStrength=wlanMeshNeighborRxSignalStrength, wlanStatsTimeoutInactivity=wlanStatsTimeoutInactivity, wlanIfTxParamsEntry=wlanIfTxParamsEntry, wlanMeshRouteLastMseq=wlanMeshRouteLastMseq, wlanIfaceChannelEntry=wlanIfaceChannelEntry, wlanIfaceTdmaSlotLength=wlanIfaceTdmaSlotLength, wlanMeshStatsEntry=wlanMeshStatsEntry, wlanStatsRxCCMPSeqViolation=wlanStatsRxCCMPSeqViolation, wlanStatsRxDecapsulationFailed=wlanStatsRxDecapsulationFailed, wlanStatsTxBadCipher=wlanStatsTxBadCipher, wlanMeshNoFwdPathUnknown=wlanMeshNoFwdPathUnknown, wlanHWMPRootInterval=wlanHWMPRootInterval, wlanWepInterfaceEntry=wlanWepInterfaceEntry, wlanWepKeySet=wlanWepKeySet, wlanStatsRxWepNoPrivacy=wlanStatsRxWepNoPrivacy, wlanIfaceStatisticsTable=wlanIfaceStatisticsTable, wlanMeshRouteNextHop=wlanMeshRouteNextHop, wlanIfaceFlags=wlanIfaceFlags, wlanIfaceBeaconInterval=wlanIfaceBeaconInterval)
