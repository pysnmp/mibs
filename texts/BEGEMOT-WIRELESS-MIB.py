...
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanIfacePeerTxPower=wlanIfacePeerTxPower, wlanWepKeyHash=wlanWepKeyHash, wlanScanConfigStatus=wlanScanConfigStatus, wlanMeshNeighborLocalId=wlanMeshNeighborLocalId, wlanMACAccessControlMAC=wlanMACAccessControlMAC, wlanIfaceRTSThreshold=wlanIfaceRTSThreshold, wlanStatsTxControlFrames=wlanStatsTxControlFrames, wlanStatsAMPDURxReorder=wlanStatsAMPDURxReorder, wlanIfaceLocalAddress=wlanIfaceLocalAddress, wlanStatsHTAssocRateMismatch=wlanStatsHTAssocRateMismatch, wlanWepKeyEntry=wlanWepKeyEntry, wlanMeshRouteHops=wlanMeshRouteHops, wlanIfaceTdmaSlotLength=wlanIfaceTdmaSlotLength, wlanHWMPInterfaceTable=wlanHWMPInterfaceTable, wlanScanFlags=wlanScanFlags, wlanStatsRxControl=wlanStatsRxControl, wlanStatsIBSSCapMismatch=wlanStatsIBSSCapMismatch, wlanMeshRouteEntry=wlanMeshRouteEntry, wlanStatsRxAMSDUSplitError=wlanStatsRxAMSDUSplitError, wlanStatsRxElemTooBig=wlanStatsRxElemTooBig, wlanMeshRouteStatus=wlanMeshRouteStatus, wlanIfaceRegDomain=wlanIfaceRegDomain, wlanIfacePeerFrequency=wlanIfacePeerFrequency, wlanMeshNeighborEntry=wlanMeshNeighborEntry, wlanIfaceDot11nHTProtMode=wlanIfaceDot11nHTProtMode, wlanIfaceFragmentThreshold=wlanIfaceFragmentThreshold, wlanMeshNoFwdDisabled=wlanMeshNoFwdDisabled, wlanStatsAMPDUStopped=wlanStatsAMPDUStopped, wlanStatsRxDeauthenticate=wlanStatsRxDeauthenticate, wlanWepDefTxKey=wlanWepDefTxKey, wlanStatsRxFFSplitError=wlanStatsRxFFSplitError, wlanIfaceDot11nAmsduLimit=wlanIfaceDot11nAmsduLimit, wlanHWMPRootTimeout=wlanHWMPRootTimeout, wlanMeshRoutesFlush=wlanMeshRoutesFlush, wlanStatsBeaconMissedEvents=wlanStatsBeaconMissedEvents, wlanStatsRxBeacon=wlanStatsRxBeacon, wlanStatsTxAMSDUEncap=wlanStatsTxAMSDUEncap, wlanMeshNeighborAddress=wlanMeshNeighborAddress, wlanIfTxParamsTable=wlanIfTxParamsTable, wlanStatsRxChannelMismatch=wlanStatsRxChannelMismatch, wlanIfaceChannelMaxTxPower=wlanIfaceChannelMaxTxPower, wlanMeshForwardingEnabled=wlanMeshForwardingEnabled, wlanIfTxMcastRate=wlanIfTxMcastRate, wlanStatsRxCCMPSeqViolation=wlanStatsRxCCMPSeqViolation, wlanIfaceDot11nRIFS=wlanIfaceDot11nRIFS, wlanStatsRxElemTooSmall=wlanStatsRxElemTooSmall, WlanIfPhyMode=WlanIfPhyMode, wlanStatsTxBadCipher=wlanStatsTxBadCipher, wlanHWMPMaxHops=wlanHWMPMaxHops, wlanMeshRouteLastMseq=wlanMeshRouteLastMseq, wlanIfacePeerIdleTimer=wlanIfacePeerIdleTimer, begemotWlanNotifications=begemotWlanNotifications, wlanIfaceChannelIeeeId=wlanIfaceChannelIeeeId, wlanIfaceDot11nShortGI=wlanIfaceDot11nShortGI, wlanStatsCryptoCipherKeyRejected=wlanStatsCryptoCipherKeyRejected, wlanMeshRouteDestination=wlanMeshRouteDestination, wlanStatsAMPDURxBAR=wlanStatsAMPDURxBAR, wlanIfacePeerCurrentTXRate=wlanIfacePeerCurrentTXRate, wlanIfRoamParamsTable=wlanIfRoamParamsTable, wlanStatsAMPDUBadBAR=wlanStatsAMPDUBadBAR, WlanPeerCapabilityFlags=WlanPeerCapabilityFlags, wlanIfacePeerRxSignalStrength=wlanIfacePeerRxSignalStrength, wlanStatsRxSsidMismatch=wlanStatsRxSsidMismatch, WlanMgmtMeshReasonCode=WlanMgmtMeshReasonCode, wlanIfacePeerCapabilities=wlanIfacePeerCapabilities, wlanStatsRxBadAuthRequest=wlanStatsRxBadAuthRequest, wlanHWMPRootInterval=wlanHWMPRootInterval, wlanIfacePeerVlanTag=wlanIfacePeerVlanTag, wlanMeshRoute=wlanMeshRoute, wlanStatsCryptoAttachFailed=wlanStatsCryptoAttachFailed, wlanIfTxPhyMode=wlanIfTxPhyMode, wlanStatsSwCryptoWEP=wlanStatsSwCryptoWEP, wlanIfParentTable=wlanIfParentTable, wlanStatsRxDisassociate=wlanStatsRxDisassociate, wlanStatsRxUnAuthorized=wlanStatsRxUnAuthorized, wlanIfaceChannelFlags=wlanIfaceChannelFlags, wlanScanMinChannelDwellTime=wlanScanMinChannelDwellTime, wlanStatsRxMgmt=wlanStatsRxMgmt, begemotWlanScanning=begemotWlanScanning, wlanIfParentHTCapabilities=wlanIfParentHTCapabilities, wlanScanResultBeaconInterval=wlanScanResultBeaconInterval, wlanStatsRxAssocNoAuth=wlanStatsRxAssocNoAuth, wlanWepInterfaceTable=wlanWepInterfaceTable, wlanIfaceChannelType=wlanIfaceChannelType, begemotWlan=begemotWlan, wlanScanDuration=wlanScanDuration, wlanStatsCryptoEnMICFailed=wlanStatsCryptoEnMICFailed, wlanMeshNeighborRxSignalStrength=wlanMeshNeighborRxSignalStrength, wlanIfaceStatisticsEntry=wlanIfaceStatisticsEntry, wlanStatsSwCryptoTKIPEnMIC=wlanStatsSwCryptoTKIPEnMIC, wlanLastAuthFailReason=wlanLastAuthFailReason, wlanMACAccessControlMACEntry=wlanMACAccessControlMACEntry, wlanIfRoamPhyMode=wlanIfRoamPhyMode, wlanMeshMetric=wlanMeshMetric, wlanInterfaceEntry=wlanInterfaceEntry, wlanStatsRxWepUnencrypted=wlanStatsRxWepUnencrypted, wlanMeshDroppedBadAE=wlanMeshDroppedBadAE, wlanStatsTxFragmented=wlanStatsTxFragmented, wlanStatsAMPDURxCopied=wlanStatsAMPDURxCopied, wlanMeshNoFwdPathUnknown=wlanMeshNoFwdPathUnknown, wlanParentIfName=wlanParentIfName, wlanMeshHWMPProxy=wlanMeshHWMPProxy, wlanStatsADDBADisabledReject=wlanStatsADDBADisabledReject, wlanStatsCryptoNoMem=wlanStatsCryptoNoMem, wlanMeshRouteAddFailed=wlanMeshRouteAddFailed, wlanStatsCryptoNoKey=wlanStatsCryptoNoKey, begemotWlanInterface=begemotWlanInterface, wlanStatsRxTooShort=wlanStatsRxTooShort, wlanIfTxMgmtRate=wlanIfTxMgmtRate, wlanLastDissasocReason=wlanLastDissasocReason, wlanScanResultID=wlanScanResultID, wlanMACAccessControlEntry=wlanMACAccessControlEntry, wlanStatsSwCryptoTKIP=wlanStatsSwCryptoTKIP, wlanStatsAMPDUOowBar=wlanStatsAMPDUOowBar, wlanMeshHWMPTxRootRANN=wlanMeshHWMPTxRootRANN, wlanIfaceDot11d=wlanIfaceDot11d, wlanStatsRxDiscardNoAssoc=wlanStatsRxDiscardNoAssoc, wlanIfaceDot11nAmsdu=wlanIfaceDot11nAmsdu, wlanMeshInterfaceEntry=wlanMeshInterfaceEntry, begemotWlanStatistics=begemotWlanStatistics, wlanIfTxParamsEntry=wlanIfTxParamsEntry, wlanIfaceIndex=wlanIfaceIndex, wlanStatsAMPDURexmtFailed=wlanStatsAMPDURexmtFailed, wlanStatsTxDiscardBadState=wlanStatsTxDiscardBadState, wlanMACAccessControlPolicy=wlanMACAccessControlPolicy, wlanStatsRxWrongBssid=wlanStatsRxWrongBssid, wlanMeshStatsTable=wlanMeshStatsTable, wlanIfaceChannelState=wlanIfaceChannelState, wlanStatsTxFFEncap=wlanStatsTxFFEncap, wlanMeshNoFwdTtl=wlanMeshNoFwdTtl, wlanMeshHWMPConfig=wlanMeshHWMPConfig, wlanIfRoamParamsEntry=wlanIfRoamParamsEntry, wlanStatsRxTKIPFailedMIC=wlanStatsRxTKIPFailedMIC, wlanScanConfigTable=wlanScanConfigTable, wlanMeshNeighborRxSequenceNo=wlanMeshNeighborRxSequenceNo, wlanIfParentEntry=wlanIfParentEntry, wlanMeshHWMPWrongSeqNo=wlanMeshHWMPWrongSeqNo, wlanHWMPReplyForwardBit=wlanHWMPReplyForwardBit, wlanScanResultChannel=wlanScanResultChannel, wlanIfaceName=wlanIfaceName, wlanStatsEmptyPSPoll=wlanStatsEmptyPSPoll, wlanStatsRxAMSDUDecap=wlanStatsRxAMSDUDecap, wlanStatsRxAssocNoRateMatch=wlanStatsRxAssocNoRateMatch, wlanStatsRxDiscardMcastEcho=wlanStatsRxDiscardMcastEcho, wlanStatsRxDiscardACL=wlanStatsRxDiscardACL, wlanMeshNeighborIdleTimer=wlanMeshNeighborIdleTimer, wlanHWMPRouteInactiveTimeout=wlanHWMPRouteInactiveTimeout, wlanIfaceChannelMaxAntennaGain=wlanIfaceChannelMaxAntennaGain, WlanMgmtReasonCode=WlanMgmtReasonCode, wlanStatsTxUnknownMgmt=wlanStatsTxUnknownMgmt, wlanStatsRxWepNoPrivacy=wlanStatsRxWepNoPrivacy, wlanStatsRxDemicFailed=wlanStatsRxDemicFailed, wlanIfaceConfigEntry=wlanIfaceConfigEntry, wlanStatsRxTKIPSeqViolation=wlanStatsRxTKIPSeqViolation, wlanWepKeySet=wlanWepKeySet, wlanMeshNeighborPeerState=wlanMeshNeighborPeerState, wlanStatsAMPDUStopFailed=wlanStatsAMPDUStopFailed, wlanMeshHWMPStatsEntry=wlanMeshHWMPStatsEntry, wlanIfacePeerTable=wlanIfacePeerTable, wlanHWMPPathLifetime=wlanHWMPPathLifetime, wlanIfaceDot11gPureMode=wlanIfaceDot11gPureMode, wlanStatsRxBadKeyId=wlanStatsRxBadKeyId, wlanIfaceChannelId=wlanIfaceChannelId, begemotWlanMACAccessControl=begemotWlanMACAccessControl, wlanMeshHoldingTimeout=wlanMeshHoldingTimeout, wlanStatsRxBadWpaIE=wlanStatsRxBadWpaIE, wlanIfaceTdmaSlotCount=wlanIfaceTdmaSlotCount, wlanStatsTimeoutInactivity=wlanStatsTimeoutInactivity, wlanMeshDroppedNoProxy=wlanMeshDroppedNoProxy, wlanStatsReset=wlanStatsReset, wlanStatsSwCryptoCCMP=wlanStatsSwCryptoCCMP, wlanStatsRxDiscardMgmt=wlanStatsRxDiscardMgmt, wlanMeshHWMPStatistics=wlanMeshHWMPStatistics, wlanStatsADDBABadPolicy=wlanStatsADDBABadPolicy, wlanMeshHWMPInterface=wlanMeshHWMPInterface, wlanIfacePeerTxSequenceNo=wlanIfacePeerTxSequenceNo, wlanIfaceApBridge=wlanIfaceApBridge, wlanIfaceDot11nAmpduLimit=wlanIfaceDot11nAmpduLimit, wlanIfaceDturbo=wlanIfaceDturbo, wlanStatsRxElemUnknown=wlanStatsRxElemUnknown, wlanIfTxUnicastRate=wlanIfTxUnicastRate, wlanMeshId=wlanMeshId, wlanIfaceDot11nPureMode=wlanIfaceDot11nPureMode, wlanStatsRxAuthFailed=wlanStatsRxAuthFailed, wlanIfacePeerRxSequenceNo=wlanIfacePeerRxSequenceNo, wlanMeshDroppedBadSta=wlanMeshDroppedBadSta, wlanIfaceBssid=wlanIfaceBssid, wlanMACAccessControlMACStatus=wlanMACAccessControlMACStatus, wlanMeshStatsEntry=wlanMeshStatsEntry, wlanMeshInterfaceTable=wlanMeshInterfaceTable, wlanMeshNeighborFrequency=wlanMeshNeighborFrequency, wlanStatsActiveScans=wlanStatsActiveScans, wlanIfaceStatus=wlanIfaceStatus, wlanStatsRxDiscardBadStates=wlanStatsRxDiscardBadStates, wlanMeshInterface=wlanMeshInterface, wlanStatsRxAssocCapMismatch=wlanStatsRxAssocCapMismatch, wlanScanResultsEntry=wlanScanResultsEntry, wlanStatsADDBABadToken=wlanStatsADDBABadToken, wlanMeshRouteTable=wlanMeshRouteTable, wlanStatsRxAuthCM=wlanStatsRxAuthCM, wlanMeshRoutingConfig=wlanMeshRoutingConfig, wlanStatsAMPDUMoved=wlanStatsAMPDUMoved, begemotWlanMeshRouting=begemotWlanMeshRouting, wlanStatsRxTKIPFailedICV=wlanStatsRxTKIPFailedICV, PYSNMP_MODULE_ID=begemotWlan, wlanStatsRxDropped=wlanStatsRxDropped, wlanIfaceBeaconMissedThreshold=wlanIfaceBeaconMissedThreshold, wlanHWMPRootMode=wlanHWMPRootMode, wlanStatsDwdsMcastDiscard=wlanStatsDwdsMcastDiscard, wlanIfaceDynamicFreqSelection=wlanIfaceDynamicFreqSelection, wlanStatsRxWrongDir=wlanStatsRxWrongDir, wlanIfaceChannelTable=wlanIfaceChannelTable, wlanWepKeyLength=wlanWepKeyLength, wlanScanResultRate=wlanScanResultRate, WlanRegDomainCode=WlanRegDomainCode, wlanMeshPath=wlanMeshPath, wlanScanConfigEntry=wlanScanConfigEntry, wlanMeshNeighborTxSequenceNo=wlanMeshNeighborTxSequenceNo, wlanStatsCryptoDeleteKeyFailed=wlanStatsCryptoDeleteKeyFailed, wlanStatsRxCCMPFailedMIC=wlanStatsRxCCMPFailedMIC, wlanIfaceDot11h=wlanIfaceDot11h, wlanIfaceChannelEntry=wlanIfaceChannelEntry, wlanIfaceBgScan=wlanIfaceBgScan, wlanIfaceDesiredChannel=wlanIfaceDesiredChannel, wlanIfacePeerFlags=wlanIfacePeerFlags, wlanStatsRxElemMissing=wlanStatsRxElemMissing, wlanMeshRouteProtocols=wlanMeshRouteProtocols, wlanMACAccessControlMACTable=wlanMACAccessControlMACTable, wlanMeshRouteFlags=wlanMeshRouteFlags, wlanStatsFFFlushed=wlanStatsFFFlushed, wlanStatsRxBadVersion=wlanStatsRxBadVersion, wlanMeshRouteMetric=wlanMeshRouteMetric, wlanHWMPInterfaceEntry=wlanHWMPInterfaceEntry, wlanMeshMaxRetries=wlanMeshMaxRetries, wlanMeshNoFwdBuf=wlanMeshNoFwdBuf, wlanMeshProtoHWMP=wlanMeshProtoHWMP, wlanIfaceBgScanIdle=wlanIfaceBgScanIdle, wlanStatsSwCryptoTKIPDeMIC=wlanStatsSwCryptoTKIPDeMIC, wlanIfParentCryptoCapabilities=wlanIfParentCryptoCapabilities, wlanMeshPeeringEnabled=wlanMeshPeeringEnabled, wlanIfaceFlags=wlanIfaceFlags, wlanMeshRouteLifeTime=wlanMeshRouteLifeTime, wlanStatsCryptoTKIPCM=wlanStatsCryptoTKIPCM, wlanStatsCryptoUnknownCipher=wlanStatsCryptoUnknownCipher, wlanLastDeauthReason=wlanLastDeauthReason, wlanStatsRxFFDecap=wlanStatsRxFFDecap, wlanIfaceConfigTable=wlanIfaceConfigTable, wlanIfaceDot11nHTCompatible=wlanIfaceDot11nHTCompatible, wlanMeshRouteNextHop=wlanMeshRouteNextHop, wlanIfaceChannelMaxRegPower=wlanIfaceChannelMaxRegPower, wlanIfaceChannelHTExtension=wlanIfaceChannelHTExtension, wlanScanMaxChannelDwellTime=wlanScanMaxChannelDwellTime, wlanStatsTxFragmentsCreated=wlanStatsTxFragmentsCreated, wlanIfaceRoamingMode=wlanIfaceRoamingMode)
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanMACAccessControlTable=wlanMACAccessControlTable, wlanMeshDroppedNoLink=wlanMeshDroppedNoLink, wlanIfaceDesiredBssid=wlanIfaceDesiredBssid, wlanIfaceHideSsid=wlanIfaceHideSsid, wlanIfRoamRxSignalStrength=wlanIfRoamRxSignalStrength, wlanStatsAMPDURxOor=wlanStatsAMPDURxOor, wlanWepKeyStatus=wlanWepKeyStatus, wlanStatsRxWepFailed=wlanStatsRxWepFailed, wlanScanResultNoise=wlanScanResultNoise, wlanIfaceChannelFrequency=wlanIfaceChannelFrequency, wlanStatsTxFailedNoNode=wlanStatsTxFailedNoNode, wlanWepInterfaceEntry=wlanWepInterfaceEntry, wlanIfaceInactivityProccess=wlanIfaceInactivityProccess, wlanStatsRxAssocWrongBssid=wlanStatsRxAssocWrongBssid, wlanWepKeyID=wlanWepKeyID, wlanStatsRxFFTooShort=wlanStatsRxFFTooShort, wlanStatsAMPDUMovedBAR=wlanStatsAMPDUMovedBAR, wlanStatsAMPDURxAge=wlanStatsAMPDURxAge, wlanStatsTxFailedNoBuf=wlanStatsTxFailedNoBuf, wlanHWMPRootAnnounceInterval=wlanHWMPRootAnnounceInterval, wlanMeshDroppedMisaligned=wlanMeshDroppedMisaligned, wlanStatsBadAidPSPoll=wlanStatsBadAidPSPoll, wlanStatsADDBANoRequest=wlanStatsADDBANoRequest, wlanIfaceDot11nAmpduDensity=wlanIfaceDot11nAmpduDensity, wlanWepKeyTable=wlanWepKeyTable, wlanStatsRxUnknownSubtype=wlanStatsRxUnknownSubtype, wlanInterfaceTable=wlanInterfaceTable, wlanMeshNoFwdTooShort=wlanMeshNoFwdTooShort, wlanMACAccessControlNacl=wlanMACAccessControlNacl, wlanIfacePacketBurst=wlanIfacePacketBurst, WlanMgmtStatusCode=WlanMgmtStatusCode, wlanMeshStatistics=wlanMeshStatistics, wlanStatsRxDecapsulationFailed=wlanStatsRxDecapsulationFailed, wlanStatsHTAssocRejectNoHT=wlanStatsHTAssocRejectNoHT, wlanStatsRxRateSetTooBig=wlanStatsRxRateSetTooBig, wlanIfParentDriverCapabilities=wlanIfParentDriverCapabilities, wlanStatsTxNoDefKey=wlanStatsTxNoDefKey, wlanScanResultBssid=wlanScanResultBssid, wlanScanResultsTable=wlanScanResultsTable, wlanMeshRetryTimeout=wlanMeshRetryTimeout, wlanIfaceDot11gProtMode=wlanIfaceDot11gProtMode, wlanIfaceTxPower=wlanIfaceTxPower, wlanMeshConfirmTimeout=wlanMeshConfirmTimeout, begemotWlanWep=begemotWlanWep, wlanIfaceWlanPrivacySubscribe=wlanIfaceWlanPrivacySubscribe, wlanStatsAMPDURexmt=wlanStatsAMPDURexmt, WlanIfaceDot11nPduType=WlanIfaceDot11nPduType, wlanIfacePowerSave=wlanIfacePowerSave, wlanStatsUnassocStaPSPoll=wlanStatsUnassocStaPSPoll, wlanIfaceDynamicWds=wlanIfaceDynamicWds, wlanStatsRxActionMgmt=wlanStatsRxActionMgmt, wlanMeshNeighborCurrentTXRate=wlanMeshNeighborCurrentTXRate, wlanStatsScansBackground=wlanStatsScansBackground, wlanStatsTxFailedNoAssoc=wlanStatsTxFailedNoAssoc, wlanStatsRxDefragFailed=wlanStatsRxDefragFailed, wlanStatsRxCCMPBadFormat=wlanStatsRxCCMPBadFormat, wlanIfacePeerAssociationId=wlanIfacePeerAssociationId, wlanIfaceOperatingMode=wlanIfaceOperatingMode, wlanIfaceState=wlanIfaceState, wlanStatsHTAssocDowngrade=wlanStatsHTAssocDowngrade, wlanStatsCryptoKeyFailed=wlanStatsCryptoKeyFailed, wlanMeshTTL=wlanMeshTTL, wlanIfaceDot11nAmpdu=wlanIfaceDot11nAmpdu, wlanStatsRxFFBadHdr=wlanStatsRxFFBadHdr, wlanMACAccessControlFlush=wlanMACAccessControlFlush, wlanStatsRxDiscardedDups=wlanStatsRxDiscardedDups, wlanScanResultCapabilities=wlanScanResultCapabilities, wlanMeshHWMPStatsTable=wlanMeshHWMPStatsTable, wlanIfacePeerEntry=wlanIfacePeerEntry, wlanMeshNeighborTable=wlanMeshNeighborTable, wlanIfaceDot11nSMPSMode=wlanIfaceDot11nSMPSMode, wlanIfaceTdmaBeaconInterval=wlanIfaceTdmaBeaconInterval, wlanIfacePeerAddress=wlanIfacePeerAddress, wlanMeshNeighborPeerId=wlanMeshNeighborPeerId, wlanStatsRxBadBintval=wlanStatsRxBadBintval, wlanStatsAMPDURxDropped=wlanStatsAMPDURxDropped, wlanIfaceCountryCode=wlanIfaceCountryCode, wlanIfaceDtimPeriod=wlanIfaceDtimPeriod, wlanStatsPassiveScans=wlanStatsPassiveScans, wlanIfaceChannelMinTxPower=wlanIfaceChannelMinTxPower, wlanIfaceBgScanInterval=wlanIfaceBgScanInterval, wlanIfRoamTxRateThreshold=wlanIfRoamTxRateThreshold, wlanIfaceFastFrames=wlanIfaceFastFrames, wlanStatsTxClassifyFailed=wlanStatsTxClassifyFailed, wlanMeshHWMPTxRootPREQ=wlanMeshHWMPTxRootPREQ, wlanWepMode=wlanWepMode, wlanStatsRxFailedNoBuf=wlanStatsRxFailedNoBuf, wlanIfaceTdmaSlot=wlanIfaceTdmaSlot, wlanStatsRxTKIPBadFormat=wlanStatsRxTKIPBadFormat, wlanStatsRxAMSDUTooShort=wlanStatsRxAMSDUTooShort, wlanIfaceBeaconInterval=wlanIfaceBeaconInterval, wlanIfTxMaxRetryCount=wlanIfTxMaxRetryCount, wlanStatsRxAuthNotSupported=wlanStatsRxAuthNotSupported, wlanHWMPTargetOnlyBit=wlanHWMPTargetOnlyBit, wlanIfaceDesiredSsid=wlanIfaceDesiredSsid, wlanIfaceDot11nHighThroughput=wlanIfaceDot11nHighThroughput, wlanIfaceStatisticsTable=wlanIfaceStatisticsTable)
