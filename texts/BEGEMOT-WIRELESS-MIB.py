...
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanIfTxPhyMode=wlanIfTxPhyMode, wlanIfaceTdmaSlotLength=wlanIfaceTdmaSlotLength, wlanIfacePeerFrequency=wlanIfacePeerFrequency, wlanIfaceDot11nHTCompatible=wlanIfaceDot11nHTCompatible, wlanMeshRoute=wlanMeshRoute, wlanIfacePeerRxSignalStrength=wlanIfacePeerRxSignalStrength, wlanMeshHWMPStatistics=wlanMeshHWMPStatistics, wlanIfaceDesiredSsid=wlanIfaceDesiredSsid, wlanScanResultCapabilities=wlanScanResultCapabilities, wlanStatsTxClassifyFailed=wlanStatsTxClassifyFailed, wlanStatsRxBadVersion=wlanStatsRxBadVersion, wlanStatsAMPDURxDropped=wlanStatsAMPDURxDropped, wlanIfParentEntry=wlanIfParentEntry, wlanStatsAMPDUMoved=wlanStatsAMPDUMoved, wlanMeshDroppedNoLink=wlanMeshDroppedNoLink, wlanIfacePeerVlanTag=wlanIfacePeerVlanTag, WlanRegDomainCode=WlanRegDomainCode, wlanIfacePeerRxSequenceNo=wlanIfacePeerRxSequenceNo, wlanStatsAMPDURxAge=wlanStatsAMPDURxAge, wlanStatsSwCryptoTKIP=wlanStatsSwCryptoTKIP, wlanStatsRxWepUnencrypted=wlanStatsRxWepUnencrypted, wlanIfaceBgScanIdle=wlanIfaceBgScanIdle, wlanStatsRxBadAuthRequest=wlanStatsRxBadAuthRequest, wlanIfaceDesiredChannel=wlanIfaceDesiredChannel, wlanIfaceCountryCode=wlanIfaceCountryCode, wlanStatsRxElemMissing=wlanStatsRxElemMissing, wlanMeshTTL=wlanMeshTTL, wlanIfaceDot11nAmsduLimit=wlanIfaceDot11nAmsduLimit, wlanMeshDroppedNoProxy=wlanMeshDroppedNoProxy, WlanMgmtReasonCode=WlanMgmtReasonCode, wlanIfaceName=wlanIfaceName, wlanIfaceDot11h=wlanIfaceDot11h, wlanStatsRxDecapsulationFailed=wlanStatsRxDecapsulationFailed, wlanMeshHWMPTxRootPREQ=wlanMeshHWMPTxRootPREQ, wlanMeshRouteFlags=wlanMeshRouteFlags, wlanIfRoamParamsEntry=wlanIfRoamParamsEntry, wlanWepInterfaceEntry=wlanWepInterfaceEntry, wlanStatsRxMgmt=wlanStatsRxMgmt, wlanIfaceDesiredBssid=wlanIfaceDesiredBssid, wlanIfacePeerFlags=wlanIfacePeerFlags, wlanIfaceWlanPrivacySubscribe=wlanIfaceWlanPrivacySubscribe, wlanStatsTxNoDefKey=wlanStatsTxNoDefKey, wlanMACAccessControlMACEntry=wlanMACAccessControlMACEntry, wlanLastDissasocReason=wlanLastDissasocReason, wlanIfaceDturbo=wlanIfaceDturbo, wlanWepKeyEntry=wlanWepKeyEntry, wlanStatsRxTKIPSeqViolation=wlanStatsRxTKIPSeqViolation, wlanStatsCryptoAttachFailed=wlanStatsCryptoAttachFailed, wlanHWMPInterfaceEntry=wlanHWMPInterfaceEntry, wlanParentIfName=wlanParentIfName, wlanIfaceDot11nAmpduDensity=wlanIfaceDot11nAmpduDensity, wlanStatsRxWrongDir=wlanStatsRxWrongDir, wlanIfaceOperatingMode=wlanIfaceOperatingMode, wlanStatsAMPDUStopFailed=wlanStatsAMPDUStopFailed, wlanIfaceFastFrames=wlanIfaceFastFrames, wlanStatsAMPDUBadBAR=wlanStatsAMPDUBadBAR, wlanIfaceChannelTable=wlanIfaceChannelTable, wlanStatsRxAssocCapMismatch=wlanStatsRxAssocCapMismatch, wlanIfTxParamsTable=wlanIfTxParamsTable, wlanMeshRouteStatus=wlanMeshRouteStatus, wlanStatsRxChannelMismatch=wlanStatsRxChannelMismatch, wlanStatsRxUnknownSubtype=wlanStatsRxUnknownSubtype, wlanMeshHWMPWrongSeqNo=wlanMeshHWMPWrongSeqNo, wlanIfaceDot11nPureMode=wlanIfaceDot11nPureMode, wlanIfaceBgScanInterval=wlanIfaceBgScanInterval, wlanStatsAMPDUStopped=wlanStatsAMPDUStopped, wlanMeshNeighborPeerState=wlanMeshNeighborPeerState, wlanStatsBadAidPSPoll=wlanStatsBadAidPSPoll, wlanIfacePeerCurrentTXRate=wlanIfacePeerCurrentTXRate, wlanScanConfigTable=wlanScanConfigTable, wlanIfTxUnicastRate=wlanIfTxUnicastRate, wlanWepKeyLength=wlanWepKeyLength, wlanMeshNeighborLocalId=wlanMeshNeighborLocalId, wlanIfaceTdmaBeaconInterval=wlanIfaceTdmaBeaconInterval, wlanStatsRxDefragFailed=wlanStatsRxDefragFailed, wlanStatsHTAssocRateMismatch=wlanStatsHTAssocRateMismatch, wlanIfaceFragmentThreshold=wlanIfaceFragmentThreshold, wlanIfaceDot11nAmpduLimit=wlanIfaceDot11nAmpduLimit, wlanMeshDroppedMisaligned=wlanMeshDroppedMisaligned, wlanStatsTxFFEncap=wlanStatsTxFFEncap, wlanStatsAMPDURxCopied=wlanStatsAMPDURxCopied, wlanMeshHWMPStatsTable=wlanMeshHWMPStatsTable, wlanStatsRxSsidMismatch=wlanStatsRxSsidMismatch, wlanStatsRxDropped=wlanStatsRxDropped, wlanStatsRxDiscardNoAssoc=wlanStatsRxDiscardNoAssoc, wlanStatsPassiveScans=wlanStatsPassiveScans, wlanIfacePeerTxSequenceNo=wlanIfacePeerTxSequenceNo, wlanStatsRxDeauthenticate=wlanStatsRxDeauthenticate, wlanStatsCryptoTKIPCM=wlanStatsCryptoTKIPCM, wlanIfaceChannelMaxAntennaGain=wlanIfaceChannelMaxAntennaGain, begemotWlanInterface=begemotWlanInterface, wlanMeshForwardingEnabled=wlanMeshForwardingEnabled, wlanIfaceHideSsid=wlanIfaceHideSsid, WlanPeerCapabilityFlags=WlanPeerCapabilityFlags, wlanWepKeyTable=wlanWepKeyTable, wlanStatsRxElemTooBig=wlanStatsRxElemTooBig, wlanStatsIBSSCapMismatch=wlanStatsIBSSCapMismatch, wlanIfaceChannelEntry=wlanIfaceChannelEntry, wlanIfRoamPhyMode=wlanIfRoamPhyMode, wlanStatsRxAMSDUSplitError=wlanStatsRxAMSDUSplitError, wlanIfaceDot11nSMPSMode=wlanIfaceDot11nSMPSMode, wlanStatsSwCryptoTKIPDeMIC=wlanStatsSwCryptoTKIPDeMIC, wlanMeshHWMPTxRootRANN=wlanMeshHWMPTxRootRANN, wlanStatsUnassocStaPSPoll=wlanStatsUnassocStaPSPoll, wlanMeshInterface=wlanMeshInterface, wlanIfaceApBridge=wlanIfaceApBridge, wlanMeshRouteAddFailed=wlanMeshRouteAddFailed, wlanStatsRxDisassociate=wlanStatsRxDisassociate, wlanMeshNeighborRxSignalStrength=wlanMeshNeighborRxSignalStrength, wlanIfaceDtimPeriod=wlanIfaceDtimPeriod, wlanIfaceChannelIeeeId=wlanIfaceChannelIeeeId, wlanScanResultID=wlanScanResultID, wlanStatsADDBADisabledReject=wlanStatsADDBADisabledReject, wlanMACAccessControlNacl=wlanMACAccessControlNacl, wlanStatsRxFFBadHdr=wlanStatsRxFFBadHdr, wlanStatsRxTKIPFailedMIC=wlanStatsRxTKIPFailedMIC, wlanStatsRxTKIPFailedICV=wlanStatsRxTKIPFailedICV, wlanStatsRxTKIPBadFormat=wlanStatsRxTKIPBadFormat, wlanStatsTxFailedNoNode=wlanStatsTxFailedNoNode, wlanStatsRxActionMgmt=wlanStatsRxActionMgmt, wlanMeshNoFwdTtl=wlanMeshNoFwdTtl, wlanIfaceChannelType=wlanIfaceChannelType, wlanIfaceTdmaSlot=wlanIfaceTdmaSlot, wlanIfaceBeaconInterval=wlanIfaceBeaconInterval, wlanMeshNeighborCurrentTXRate=wlanMeshNeighborCurrentTXRate, begemotWlanMeshRouting=begemotWlanMeshRouting, wlanStatsRxCCMPFailedMIC=wlanStatsRxCCMPFailedMIC, WlanIfPhyMode=WlanIfPhyMode, wlanIfaceChannelMaxRegPower=wlanIfaceChannelMaxRegPower, wlanInterfaceTable=wlanInterfaceTable, wlanIfaceLocalAddress=wlanIfaceLocalAddress, wlanStatsTxBadCipher=wlanStatsTxBadCipher, wlanStatsRxAssocNoAuth=wlanStatsRxAssocNoAuth, wlanMeshRouteMetric=wlanMeshRouteMetric, wlanScanResultBeaconInterval=wlanScanResultBeaconInterval, wlanStatsSwCryptoWEP=wlanStatsSwCryptoWEP, wlanStatsRxFFTooShort=wlanStatsRxFFTooShort, wlanScanMinChannelDwellTime=wlanScanMinChannelDwellTime, wlanHWMPInterfaceTable=wlanHWMPInterfaceTable, wlanStatsSwCryptoCCMP=wlanStatsSwCryptoCCMP, wlanHWMPMaxHops=wlanHWMPMaxHops, wlanIfaceTdmaSlotCount=wlanIfaceTdmaSlotCount, wlanWepKeyID=wlanWepKeyID, wlanMeshRouteNextHop=wlanMeshRouteNextHop, wlanStatsRxFailedNoBuf=wlanStatsRxFailedNoBuf, wlanHWMPRootAnnounceInterval=wlanHWMPRootAnnounceInterval, wlanScanResultsEntry=wlanScanResultsEntry, wlanStatsRxDiscardedDups=wlanStatsRxDiscardedDups, wlanHWMPRouteInactiveTimeout=wlanHWMPRouteInactiveTimeout, wlanIfTxParamsEntry=wlanIfTxParamsEntry, wlanMeshNoFwdTooShort=wlanMeshNoFwdTooShort, wlanIfTxMgmtRate=wlanIfTxMgmtRate, wlanStatsRxElemTooSmall=wlanStatsRxElemTooSmall, wlanMACAccessControlEntry=wlanMACAccessControlEntry, wlanIfaceDot11nHighThroughput=wlanIfaceDot11nHighThroughput, wlanStatsRxAMSDUDecap=wlanStatsRxAMSDUDecap, wlanScanResultRate=wlanScanResultRate, wlanScanMaxChannelDwellTime=wlanScanMaxChannelDwellTime, wlanStatsRxRateSetTooBig=wlanStatsRxRateSetTooBig, wlanStatsDwdsMcastDiscard=wlanStatsDwdsMcastDiscard, wlanStatsRxWrongBssid=wlanStatsRxWrongBssid, wlanIfaceDot11nHTProtMode=wlanIfaceDot11nHTProtMode, wlanStatsRxTooShort=wlanStatsRxTooShort, wlanIfaceState=wlanIfaceState, wlanInterfaceEntry=wlanInterfaceEntry, wlanIfaceDot11nAmpdu=wlanIfaceDot11nAmpdu, wlanWepKeyStatus=wlanWepKeyStatus, wlanStatsHTAssocRejectNoHT=wlanStatsHTAssocRejectNoHT, wlanStatsRxBeacon=wlanStatsRxBeacon, wlanStatsADDBABadPolicy=wlanStatsADDBABadPolicy, wlanMeshRoutingConfig=wlanMeshRoutingConfig, wlanStatsTxFragmentsCreated=wlanStatsTxFragmentsCreated, wlanIfacePeerAssociationId=wlanIfacePeerAssociationId, wlanIfaceChannelId=wlanIfaceChannelId, wlanIfacePeerTxPower=wlanIfacePeerTxPower, wlanMeshInterfaceTable=wlanMeshInterfaceTable, wlanStatsAMPDURexmt=wlanStatsAMPDURexmt, wlanIfaceChannelFrequency=wlanIfaceChannelFrequency, wlanMeshDroppedBadSta=wlanMeshDroppedBadSta, wlanMeshNoFwdPathUnknown=wlanMeshNoFwdPathUnknown, wlanMeshRouteHops=wlanMeshRouteHops, wlanIfaceBssid=wlanIfaceBssid, wlanIfTxMcastRate=wlanIfTxMcastRate, wlanIfaceBgScan=wlanIfaceBgScan, wlanScanDuration=wlanScanDuration, wlanIfParentTable=wlanIfParentTable, wlanIfParentDriverCapabilities=wlanIfParentDriverCapabilities, wlanStatsRxBadBintval=wlanStatsRxBadBintval, wlanMeshRoutesFlush=wlanMeshRoutesFlush, wlanStatsRxWepNoPrivacy=wlanStatsRxWepNoPrivacy, wlanMeshNoFwdDisabled=wlanMeshNoFwdDisabled, wlanIfaceStatus=wlanIfaceStatus, wlanIfaceIndex=wlanIfaceIndex, begemotWlanWep=begemotWlanWep, wlanMeshNeighborPeerId=wlanMeshNeighborPeerId, wlanMeshMaxRetries=wlanMeshMaxRetries, wlanLastAuthFailReason=wlanLastAuthFailReason, WlanMgmtMeshReasonCode=WlanMgmtMeshReasonCode, wlanMeshDroppedBadAE=wlanMeshDroppedBadAE, wlanScanResultsTable=wlanScanResultsTable, wlanIfaceChannelMaxTxPower=wlanIfaceChannelMaxTxPower, wlanStatsRxBadKeyId=wlanStatsRxBadKeyId, wlanIfaceDot11nRIFS=wlanIfaceDot11nRIFS, wlanMeshNoFwdBuf=wlanMeshNoFwdBuf, wlanMeshHWMPProxy=wlanMeshHWMPProxy, wlanIfRoamParamsTable=wlanIfRoamParamsTable, wlanStatsRxWepFailed=wlanStatsRxWepFailed, wlanIfRoamRxSignalStrength=wlanIfRoamRxSignalStrength, wlanMeshHWMPInterface=wlanMeshHWMPInterface, wlanIfaceRoamingMode=wlanIfaceRoamingMode, wlanIfParentHTCapabilities=wlanIfParentHTCapabilities, wlanStatsAMPDUMovedBAR=wlanStatsAMPDUMovedBAR, wlanIfaceConfigTable=wlanIfaceConfigTable, wlanStatsRxAuthCM=wlanStatsRxAuthCM, wlanScanResultNoise=wlanScanResultNoise, wlanStatsTxFailedNoAssoc=wlanStatsTxFailedNoAssoc, wlanStatsCryptoCipherKeyRejected=wlanStatsCryptoCipherKeyRejected, wlanMeshConfirmTimeout=wlanMeshConfirmTimeout, begemotWlan=begemotWlan, wlanStatsTimeoutInactivity=wlanStatsTimeoutInactivity, wlanStatsTxAMSDUEncap=wlanStatsTxAMSDUEncap, wlanMeshRouteTable=wlanMeshRouteTable, wlanStatsRxDiscardACL=wlanStatsRxDiscardACL, begemotWlanNotifications=begemotWlanNotifications, wlanStatsAMPDURxOor=wlanStatsAMPDURxOor, wlanHWMPPathLifetime=wlanHWMPPathLifetime, wlanMeshNeighborEntry=wlanMeshNeighborEntry, wlanMeshNeighborRxSequenceNo=wlanMeshNeighborRxSequenceNo, wlanStatsRxBadWpaIE=wlanStatsRxBadWpaIE, wlanMeshRouteLifeTime=wlanMeshRouteLifeTime, wlanIfaceTxPower=wlanIfaceTxPower, wlanStatsBeaconMissedEvents=wlanStatsBeaconMissedEvents, wlanStatsRxCCMPBadFormat=wlanStatsRxCCMPBadFormat, wlanMACAccessControlTable=wlanMACAccessControlTable, wlanMeshPeeringEnabled=wlanMeshPeeringEnabled, wlanMeshRouteDestination=wlanMeshRouteDestination, wlanHWMPTargetOnlyBit=wlanHWMPTargetOnlyBit, wlanMeshMetric=wlanMeshMetric, wlanStatsRxCCMPSeqViolation=wlanStatsRxCCMPSeqViolation, wlanIfacePeerIdleTimer=wlanIfacePeerIdleTimer, wlanStatsRxAssocWrongBssid=wlanStatsRxAssocWrongBssid, wlanMeshRouteLastMseq=wlanMeshRouteLastMseq, wlanWepDefTxKey=wlanWepDefTxKey, wlanScanFlags=wlanScanFlags, wlanStatsRxElemUnknown=wlanStatsRxElemUnknown, wlanIfParentCryptoCapabilities=wlanIfParentCryptoCapabilities, wlanMeshInterfaceEntry=wlanMeshInterfaceEntry, wlanMeshHWMPStatsEntry=wlanMeshHWMPStatsEntry, wlanIfaceInactivityProccess=wlanIfaceInactivityProccess, wlanMeshRouteEntry=wlanMeshRouteEntry, wlanStatsTxControlFrames=wlanStatsTxControlFrames, wlanIfaceConfigEntry=wlanIfaceConfigEntry, wlanIfTxMaxRetryCount=wlanIfTxMaxRetryCount, PYSNMP_MODULE_ID=begemotWlan)
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanStatsCryptoEnMICFailed=wlanStatsCryptoEnMICFailed, wlanMeshNeighborFrequency=wlanMeshNeighborFrequency, WlanMgmtStatusCode=WlanMgmtStatusCode, wlanMeshHoldingTimeout=wlanMeshHoldingTimeout, wlanStatsRxDemicFailed=wlanStatsRxDemicFailed, wlanWepMode=wlanWepMode, wlanStatsRxAuthFailed=wlanStatsRxAuthFailed, wlanIfaceDot11gPureMode=wlanIfaceDot11gPureMode, wlanIfaceDynamicWds=wlanIfaceDynamicWds, wlanIfaceStatisticsEntry=wlanIfaceStatisticsEntry, wlanStatsTxDiscardBadState=wlanStatsTxDiscardBadState, wlanIfacePeerEntry=wlanIfacePeerEntry, wlanIfacePeerAddress=wlanIfacePeerAddress, wlanStatsRxControl=wlanStatsRxControl, wlanStatsActiveScans=wlanStatsActiveScans, wlanStatsADDBANoRequest=wlanStatsADDBANoRequest, wlanIfaceRegDomain=wlanIfaceRegDomain, wlanStatsAMPDURxBAR=wlanStatsAMPDURxBAR, wlanMeshRouteProtocols=wlanMeshRouteProtocols, wlanHWMPRootMode=wlanHWMPRootMode, wlanWepKeyHash=wlanWepKeyHash, wlanWepInterfaceTable=wlanWepInterfaceTable, wlanStatsAMPDURexmtFailed=wlanStatsAMPDURexmtFailed, wlanStatsTxFailedNoBuf=wlanStatsTxFailedNoBuf, wlanScanResultChannel=wlanScanResultChannel, wlanStatsFFFlushed=wlanStatsFFFlushed, wlanStatsRxAuthNotSupported=wlanStatsRxAuthNotSupported, wlanStatsCryptoUnknownCipher=wlanStatsCryptoUnknownCipher, wlanIfaceStatisticsTable=wlanIfaceStatisticsTable, wlanMeshRetryTimeout=wlanMeshRetryTimeout, wlanScanConfigEntry=wlanScanConfigEntry, wlanMeshHWMPConfig=wlanMeshHWMPConfig, wlanStatsCryptoNoKey=wlanStatsCryptoNoKey, wlanScanConfigStatus=wlanScanConfigStatus, wlanStatsEmptyPSPoll=wlanStatsEmptyPSPoll, wlanMeshNeighborIdleTimer=wlanMeshNeighborIdleTimer, wlanIfacePeerTable=wlanIfacePeerTable, wlanStatsRxDiscardMcastEcho=wlanStatsRxDiscardMcastEcho, wlanStatsTxFragmented=wlanStatsTxFragmented, wlanStatsCryptoKeyFailed=wlanStatsCryptoKeyFailed, wlanMeshStatsTable=wlanMeshStatsTable, begemotWlanScanning=begemotWlanScanning, wlanMeshStatsEntry=wlanMeshStatsEntry, wlanStatsRxFFDecap=wlanStatsRxFFDecap, wlanIfaceChannelHTExtension=wlanIfaceChannelHTExtension, wlanStatsRxAMSDUTooShort=wlanStatsRxAMSDUTooShort, wlanMeshId=wlanMeshId, wlanMeshNeighborAddress=wlanMeshNeighborAddress, wlanIfaceFlags=wlanIfaceFlags, wlanWepKeySet=wlanWepKeySet, wlanIfaceBeaconMissedThreshold=wlanIfaceBeaconMissedThreshold, wlanIfacePowerSave=wlanIfacePowerSave, wlanStatsAMPDUOowBar=wlanStatsAMPDUOowBar, wlanMeshProtoHWMP=wlanMeshProtoHWMP, wlanIfaceDot11nAmsdu=wlanIfaceDot11nAmsdu, wlanIfaceChannelFlags=wlanIfaceChannelFlags, wlanHWMPReplyForwardBit=wlanHWMPReplyForwardBit, wlanStatsCryptoDeleteKeyFailed=wlanStatsCryptoDeleteKeyFailed, wlanLastDeauthReason=wlanLastDeauthReason, wlanStatsRxDiscardBadStates=wlanStatsRxDiscardBadStates, wlanStatsRxDiscardMgmt=wlanStatsRxDiscardMgmt, wlanMeshPath=wlanMeshPath, wlanHWMPRootTimeout=wlanHWMPRootTimeout, wlanIfacePacketBurst=wlanIfacePacketBurst, wlanStatsAMPDURxReorder=wlanStatsAMPDURxReorder, wlanIfaceChannelState=wlanIfaceChannelState, wlanIfaceDot11d=wlanIfaceDot11d, wlanMACAccessControlFlush=wlanMACAccessControlFlush, wlanMeshNeighborTable=wlanMeshNeighborTable, wlanMACAccessControlPolicy=wlanMACAccessControlPolicy, wlanStatsRxAssocNoRateMatch=wlanStatsRxAssocNoRateMatch, wlanStatsADDBABadToken=wlanStatsADDBABadToken, wlanMeshStatistics=wlanMeshStatistics, wlanStatsScansBackground=wlanStatsScansBackground, begemotWlanStatistics=begemotWlanStatistics, wlanIfacePeerCapabilities=wlanIfacePeerCapabilities, wlanMACAccessControlMACTable=wlanMACAccessControlMACTable, wlanIfaceDynamicFreqSelection=wlanIfaceDynamicFreqSelection, wlanStatsCryptoNoMem=wlanStatsCryptoNoMem, wlanStatsRxFFSplitError=wlanStatsRxFFSplitError, wlanMeshNeighborTxSequenceNo=wlanMeshNeighborTxSequenceNo, wlanStatsHTAssocDowngrade=wlanStatsHTAssocDowngrade, wlanStatsReset=wlanStatsReset, wlanIfaceRTSThreshold=wlanIfaceRTSThreshold, wlanIfaceChannelMinTxPower=wlanIfaceChannelMinTxPower, wlanStatsSwCryptoTKIPEnMIC=wlanStatsSwCryptoTKIPEnMIC, wlanStatsRxUnAuthorized=wlanStatsRxUnAuthorized, wlanIfaceDot11nShortGI=wlanIfaceDot11nShortGI, wlanHWMPRootInterval=wlanHWMPRootInterval, wlanMACAccessControlMACStatus=wlanMACAccessControlMACStatus, begemotWlanMACAccessControl=begemotWlanMACAccessControl, wlanScanResultBssid=wlanScanResultBssid, wlanIfRoamTxRateThreshold=wlanIfRoamTxRateThreshold, wlanIfaceDot11gProtMode=wlanIfaceDot11gProtMode, wlanMACAccessControlMAC=wlanMACAccessControlMAC, WlanIfaceDot11nPduType=WlanIfaceDot11nPduType, wlanStatsTxUnknownMgmt=wlanStatsTxUnknownMgmt)
