...
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanStatsTxFailedNoAssoc=wlanStatsTxFailedNoAssoc, wlanStatsRxAMSDUDecap=wlanStatsRxAMSDUDecap, wlanStatsRxWepUnencrypted=wlanStatsRxWepUnencrypted, wlanIfaceDesiredSsid=wlanIfaceDesiredSsid, wlanMACAccessControlPolicy=wlanMACAccessControlPolicy, wlanIfaceDot11nHTCompatible=wlanIfaceDot11nHTCompatible, wlanParentIfName=wlanParentIfName, wlanIfTxMaxRetryCount=wlanIfTxMaxRetryCount, wlanStatsAMPDURxCopied=wlanStatsAMPDURxCopied, wlanIfaceDot11gProtMode=wlanIfaceDot11gProtMode, wlanStatsRxBadAuthRequest=wlanStatsRxBadAuthRequest, wlanIfaceDesiredChannel=wlanIfaceDesiredChannel, wlanScanFlags=wlanScanFlags, wlanMeshDroppedNoLink=wlanMeshDroppedNoLink, wlanStatsHTAssocDowngrade=wlanStatsHTAssocDowngrade, wlanStatsRxWrongDir=wlanStatsRxWrongDir, wlanLastAuthFailReason=wlanLastAuthFailReason, wlanStatsRxBeacon=wlanStatsRxBeacon, wlanStatsScansBackground=wlanStatsScansBackground, wlanHWMPRootInterval=wlanHWMPRootInterval, wlanInterfaceTable=wlanInterfaceTable, wlanIfParentCryptoCapabilities=wlanIfParentCryptoCapabilities, wlanStatsRxFFBadHdr=wlanStatsRxFFBadHdr, wlanIfaceDot11nAmpduLimit=wlanIfaceDot11nAmpduLimit, wlanIfacePowerSave=wlanIfacePowerSave, wlanStatsRxActionMgmt=wlanStatsRxActionMgmt, wlanIfacePeerFlags=wlanIfacePeerFlags, wlanStatsCryptoNoMem=wlanStatsCryptoNoMem, wlanHWMPReplyForwardBit=wlanHWMPReplyForwardBit, wlanIfaceChannelEntry=wlanIfaceChannelEntry, wlanMACAccessControlTable=wlanMACAccessControlTable, wlanStatsRxRateSetTooBig=wlanStatsRxRateSetTooBig, wlanStatsRxDemicFailed=wlanStatsRxDemicFailed, wlanStatsAMPDURxAge=wlanStatsAMPDURxAge, wlanMACAccessControlMAC=wlanMACAccessControlMAC, PYSNMP_MODULE_ID=begemotWlan, wlanScanResultBssid=wlanScanResultBssid, wlanIfaceDot11nSMPSMode=wlanIfaceDot11nSMPSMode, wlanMeshNoFwdTooShort=wlanMeshNoFwdTooShort, WlanIfaceDot11nPduType=WlanIfaceDot11nPduType, wlanStatsHTAssocRateMismatch=wlanStatsHTAssocRateMismatch, wlanWepInterfaceTable=wlanWepInterfaceTable, wlanMeshDroppedNoProxy=wlanMeshDroppedNoProxy, wlanIfaceDot11nRIFS=wlanIfaceDot11nRIFS, wlanStatsRxAMSDUTooShort=wlanStatsRxAMSDUTooShort, wlanIfRoamRxSignalStrength=wlanIfRoamRxSignalStrength, wlanIfaceRegDomain=wlanIfaceRegDomain, wlanIfaceChannelHTExtension=wlanIfaceChannelHTExtension, wlanStatsRxAssocNoRateMatch=wlanStatsRxAssocNoRateMatch, wlanStatsCryptoCipherKeyRejected=wlanStatsCryptoCipherKeyRejected, wlanIfTxParamsTable=wlanIfTxParamsTable, wlanStatsRxElemTooBig=wlanStatsRxElemTooBig, wlanIfaceConfigEntry=wlanIfaceConfigEntry, wlanMeshNeighborAddress=wlanMeshNeighborAddress, wlanIfRoamTxRateThreshold=wlanIfRoamTxRateThreshold, wlanIfaceDynamicFreqSelection=wlanIfaceDynamicFreqSelection, wlanMeshRoute=wlanMeshRoute, wlanStatsRxTKIPFailedMIC=wlanStatsRxTKIPFailedMIC, wlanMeshNoFwdTtl=wlanMeshNoFwdTtl, wlanScanResultNoise=wlanScanResultNoise, WlanRegDomainCode=WlanRegDomainCode, wlanIfaceChannelType=wlanIfaceChannelType, wlanStatsRxTKIPBadFormat=wlanStatsRxTKIPBadFormat, wlanMeshNoFwdBuf=wlanMeshNoFwdBuf, wlanStatsCryptoTKIPCM=wlanStatsCryptoTKIPCM, wlanStatsAMPDUMoved=wlanStatsAMPDUMoved, wlanIfaceDtimPeriod=wlanIfaceDtimPeriod, wlanStatsActiveScans=wlanStatsActiveScans, wlanStatsRxDiscardBadStates=wlanStatsRxDiscardBadStates, wlanStatsTxUnknownMgmt=wlanStatsTxUnknownMgmt, wlanWepKeyLength=wlanWepKeyLength, wlanStatsRxBadKeyId=wlanStatsRxBadKeyId, wlanHWMPInterfaceEntry=wlanHWMPInterfaceEntry, wlanIfaceHideSsid=wlanIfaceHideSsid, wlanIfaceRTSThreshold=wlanIfaceRTSThreshold, wlanInterfaceEntry=wlanInterfaceEntry, wlanStatsAMPDURexmtFailed=wlanStatsAMPDURexmtFailed, wlanStatsRxChannelMismatch=wlanStatsRxChannelMismatch, wlanMeshNeighborEntry=wlanMeshNeighborEntry, wlanMeshStatistics=wlanMeshStatistics, wlanIfaceBgScanIdle=wlanIfaceBgScanIdle, wlanMeshPath=wlanMeshPath, wlanScanResultID=wlanScanResultID, wlanMeshStatsEntry=wlanMeshStatsEntry, wlanIfaceFlags=wlanIfaceFlags, wlanIfaceChannelId=wlanIfaceChannelId, wlanStatsAMPDURxOor=wlanStatsAMPDURxOor, wlanIfaceBeaconMissedThreshold=wlanIfaceBeaconMissedThreshold, wlanStatsSwCryptoWEP=wlanStatsSwCryptoWEP, wlanMACAccessControlNacl=wlanMACAccessControlNacl, wlanStatsRxTooShort=wlanStatsRxTooShort, wlanIfaceLocalAddress=wlanIfaceLocalAddress, wlanIfParentEntry=wlanIfParentEntry, wlanStatsRxTKIPFailedICV=wlanStatsRxTKIPFailedICV, wlanIfaceState=wlanIfaceState, wlanStatsRxBadWpaIE=wlanStatsRxBadWpaIE, wlanStatsTimeoutInactivity=wlanStatsTimeoutInactivity, begemotWlanMACAccessControl=begemotWlanMACAccessControl, wlanMeshHWMPStatistics=wlanMeshHWMPStatistics, wlanMeshRouteProtocols=wlanMeshRouteProtocols, wlanIfTxUnicastRate=wlanIfTxUnicastRate, wlanStatsAMPDUOowBar=wlanStatsAMPDUOowBar, begemotWlanNotifications=begemotWlanNotifications, wlanStatsFFFlushed=wlanStatsFFFlushed, wlanMeshRouteNextHop=wlanMeshRouteNextHop, wlanIfacePeerTxPower=wlanIfacePeerTxPower, wlanStatsTxFailedNoNode=wlanStatsTxFailedNoNode, wlanMeshRouteMetric=wlanMeshRouteMetric, wlanIfaceTdmaSlot=wlanIfaceTdmaSlot, wlanIfaceBeaconInterval=wlanIfaceBeaconInterval, wlanStatsRxDiscardNoAssoc=wlanStatsRxDiscardNoAssoc, wlanMeshNeighborTable=wlanMeshNeighborTable, wlanMeshHWMPTxRootPREQ=wlanMeshHWMPTxRootPREQ, wlanIfaceTdmaSlotLength=wlanIfaceTdmaSlotLength, wlanIfaceIndex=wlanIfaceIndex, wlanStatsRxDecapsulationFailed=wlanStatsRxDecapsulationFailed, wlanScanResultRate=wlanScanResultRate, wlanStatsAMPDUMovedBAR=wlanStatsAMPDUMovedBAR, wlanStatsADDBABadToken=wlanStatsADDBABadToken, wlanMeshHWMPWrongSeqNo=wlanMeshHWMPWrongSeqNo, wlanStatsRxFFTooShort=wlanStatsRxFFTooShort, wlanStatsTxBadCipher=wlanStatsTxBadCipher, wlanStatsTxFailedNoBuf=wlanStatsTxFailedNoBuf, WlanPeerCapabilityFlags=WlanPeerCapabilityFlags, wlanMeshHWMPTxRootRANN=wlanMeshHWMPTxRootRANN, wlanStatsCryptoNoKey=wlanStatsCryptoNoKey, wlanStatsAMPDURxReorder=wlanStatsAMPDURxReorder, wlanStatsBeaconMissedEvents=wlanStatsBeaconMissedEvents, wlanIfaceDot11nPureMode=wlanIfaceDot11nPureMode, wlanMeshInterfaceTable=wlanMeshInterfaceTable, wlanMeshDroppedBadSta=wlanMeshDroppedBadSta, wlanScanMinChannelDwellTime=wlanScanMinChannelDwellTime, wlanMeshForwardingEnabled=wlanMeshForwardingEnabled, wlanIfaceBssid=wlanIfaceBssid, wlanStatsRxWrongBssid=wlanStatsRxWrongBssid, wlanStatsSwCryptoTKIP=wlanStatsSwCryptoTKIP, wlanStatsRxAssocNoAuth=wlanStatsRxAssocNoAuth, wlanMeshStatsTable=wlanMeshStatsTable, wlanIfRoamParamsTable=wlanIfRoamParamsTable, wlanIfacePeerCurrentTXRate=wlanIfacePeerCurrentTXRate, wlanStatsTxControlFrames=wlanStatsTxControlFrames, wlanStatsRxElemUnknown=wlanStatsRxElemUnknown, begemotWlanWep=begemotWlanWep, wlanIfTxMgmtRate=wlanIfTxMgmtRate, wlanStatsPassiveScans=wlanStatsPassiveScans, wlanScanDuration=wlanScanDuration, wlanIfTxMcastRate=wlanIfTxMcastRate, WlanMgmtStatusCode=WlanMgmtStatusCode, wlanStatsRxSsidMismatch=wlanStatsRxSsidMismatch, wlanStatsRxElemMissing=wlanStatsRxElemMissing, wlanIfTxPhyMode=wlanIfTxPhyMode, wlanStatsRxAuthNotSupported=wlanStatsRxAuthNotSupported, wlanScanResultChannel=wlanScanResultChannel, wlanIfacePeerTable=wlanIfacePeerTable, wlanIfaceDot11nShortGI=wlanIfaceDot11nShortGI, wlanMeshNeighborLocalId=wlanMeshNeighborLocalId, wlanStatsRxBadBintval=wlanStatsRxBadBintval, wlanMeshMaxRetries=wlanMeshMaxRetries, wlanIfaceChannelIeeeId=wlanIfaceChannelIeeeId, wlanIfacePeerTxSequenceNo=wlanIfacePeerTxSequenceNo, wlanMACAccessControlEntry=wlanMACAccessControlEntry, wlanStatsSwCryptoCCMP=wlanStatsSwCryptoCCMP, wlanMeshRouteTable=wlanMeshRouteTable, wlanMeshRouteLifeTime=wlanMeshRouteLifeTime, wlanWepInterfaceEntry=wlanWepInterfaceEntry, wlanScanConfigEntry=wlanScanConfigEntry, wlanIfaceBgScanInterval=wlanIfaceBgScanInterval, wlanMeshNeighborPeerState=wlanMeshNeighborPeerState, wlanStatsRxMgmt=wlanStatsRxMgmt, wlanIfaceChannelMaxAntennaGain=wlanIfaceChannelMaxAntennaGain, wlanWepMode=wlanWepMode, wlanIfaceStatus=wlanIfaceStatus, wlanStatsRxFFDecap=wlanStatsRxFFDecap, wlanMACAccessControlMACTable=wlanMACAccessControlMACTable, wlanIfacePeerCapabilities=wlanIfacePeerCapabilities, wlanStatsRxDropped=wlanStatsRxDropped, wlanIfParentTable=wlanIfParentTable, wlanIfaceChannelFlags=wlanIfaceChannelFlags, wlanIfaceConfigTable=wlanIfaceConfigTable, wlanIfParentHTCapabilities=wlanIfParentHTCapabilities, wlanMeshNeighborTxSequenceNo=wlanMeshNeighborTxSequenceNo, wlanStatsIBSSCapMismatch=wlanStatsIBSSCapMismatch, wlanMeshRouteHops=wlanMeshRouteHops, wlanStatsCryptoDeleteKeyFailed=wlanStatsCryptoDeleteKeyFailed, wlanMeshRouteAddFailed=wlanMeshRouteAddFailed, wlanStatsRxDeauthenticate=wlanStatsRxDeauthenticate, wlanMeshNeighborRxSequenceNo=wlanMeshNeighborRxSequenceNo, wlanStatsTxNoDefKey=wlanStatsTxNoDefKey, wlanIfaceDot11nHTProtMode=wlanIfaceDot11nHTProtMode, wlanMeshNoFwdDisabled=wlanMeshNoFwdDisabled, wlanIfaceChannelTable=wlanIfaceChannelTable, WlanMgmtMeshReasonCode=WlanMgmtMeshReasonCode, wlanStatsEmptyPSPoll=wlanStatsEmptyPSPoll, begemotWlanStatistics=begemotWlanStatistics, wlanHWMPMaxHops=wlanHWMPMaxHops, wlanIfaceChannelMinTxPower=wlanIfaceChannelMinTxPower, wlanStatsCryptoAttachFailed=wlanStatsCryptoAttachFailed, wlanScanConfigTable=wlanScanConfigTable, wlanMeshHWMPInterface=wlanMeshHWMPInterface, wlanStatsRxBadVersion=wlanStatsRxBadVersion, wlanMeshRouteLastMseq=wlanMeshRouteLastMseq, wlanMeshDroppedBadAE=wlanMeshDroppedBadAE, wlanScanResultsTable=wlanScanResultsTable, wlanStatsRxAssocWrongBssid=wlanStatsRxAssocWrongBssid, wlanMeshRouteFlags=wlanMeshRouteFlags, wlanStatsCryptoUnknownCipher=wlanStatsCryptoUnknownCipher, wlanMeshMetric=wlanMeshMetric, wlanIfaceTxPower=wlanIfaceTxPower, wlanStatsRxFFSplitError=wlanStatsRxFFSplitError, wlanScanResultsEntry=wlanScanResultsEntry, wlanWepKeyID=wlanWepKeyID, wlanMeshConfirmTimeout=wlanMeshConfirmTimeout, wlanIfaceDot11nAmpduDensity=wlanIfaceDot11nAmpduDensity, wlanStatsRxTKIPSeqViolation=wlanStatsRxTKIPSeqViolation, wlanStatsTxFFEncap=wlanStatsTxFFEncap, wlanStatsRxDiscardMcastEcho=wlanStatsRxDiscardMcastEcho, wlanWepKeyStatus=wlanWepKeyStatus, wlanStatsRxDiscardedDups=wlanStatsRxDiscardedDups, wlanStatsRxCCMPSeqViolation=wlanStatsRxCCMPSeqViolation, wlanMeshNeighborPeerId=wlanMeshNeighborPeerId, wlanStatsAMPDUBadBAR=wlanStatsAMPDUBadBAR, wlanStatsRxControl=wlanStatsRxControl, wlanWepKeyTable=wlanWepKeyTable, wlanIfaceInactivityProccess=wlanIfaceInactivityProccess, wlanStatsCryptoEnMICFailed=wlanStatsCryptoEnMICFailed, wlanStatsDwdsMcastDiscard=wlanStatsDwdsMcastDiscard, wlanStatsSwCryptoTKIPDeMIC=wlanStatsSwCryptoTKIPDeMIC, wlanIfaceDot11nAmpdu=wlanIfaceDot11nAmpdu, wlanStatsHTAssocRejectNoHT=wlanStatsHTAssocRejectNoHT, wlanStatsAMPDURexmt=wlanStatsAMPDURexmt, wlanMACAccessControlFlush=wlanMACAccessControlFlush, wlanMeshHoldingTimeout=wlanMeshHoldingTimeout, wlanMeshTTL=wlanMeshTTL, wlanMeshNeighborCurrentTXRate=wlanMeshNeighborCurrentTXRate, wlanStatsADDBABadPolicy=wlanStatsADDBABadPolicy, wlanIfaceDot11nAmsduLimit=wlanIfaceDot11nAmsduLimit, wlanIfaceStatisticsTable=wlanIfaceStatisticsTable, wlanStatsRxFailedNoBuf=wlanStatsRxFailedNoBuf, wlanHWMPPathLifetime=wlanHWMPPathLifetime, wlanStatsTxClassifyFailed=wlanStatsTxClassifyFailed, wlanMeshRetryTimeout=wlanMeshRetryTimeout, wlanMeshHWMPStatsTable=wlanMeshHWMPStatsTable, begemotWlanScanning=begemotWlanScanning, wlanStatsReset=wlanStatsReset, wlanMeshDroppedMisaligned=wlanMeshDroppedMisaligned, wlanHWMPRootAnnounceInterval=wlanHWMPRootAnnounceInterval, wlanStatsUnassocStaPSPoll=wlanStatsUnassocStaPSPoll, wlanMeshProtoHWMP=wlanMeshProtoHWMP, wlanIfaceDot11nHighThroughput=wlanIfaceDot11nHighThroughput, wlanMeshInterfaceEntry=wlanMeshInterfaceEntry, wlanIfRoamParamsEntry=wlanIfRoamParamsEntry, wlanIfRoamPhyMode=wlanIfRoamPhyMode, wlanIfTxParamsEntry=wlanIfTxParamsEntry, wlanStatsRxDisassociate=wlanStatsRxDisassociate)
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanMeshNoFwdPathUnknown=wlanMeshNoFwdPathUnknown, wlanIfaceDot11gPureMode=wlanIfaceDot11gPureMode, wlanStatsRxCCMPBadFormat=wlanStatsRxCCMPBadFormat, WlanIfPhyMode=WlanIfPhyMode, wlanIfaceCountryCode=wlanIfaceCountryCode, wlanStatsRxAuthCM=wlanStatsRxAuthCM, wlanMeshHWMPStatsEntry=wlanMeshHWMPStatsEntry, wlanScanResultBeaconInterval=wlanScanResultBeaconInterval, wlanStatsRxDiscardMgmt=wlanStatsRxDiscardMgmt, wlanIfaceStatisticsEntry=wlanIfaceStatisticsEntry, wlanStatsAMPDUStopFailed=wlanStatsAMPDUStopFailed, wlanIfaceChannelMaxTxPower=wlanIfaceChannelMaxTxPower, wlanIfParentDriverCapabilities=wlanIfParentDriverCapabilities, wlanIfaceDesiredBssid=wlanIfaceDesiredBssid, wlanMeshRouteDestination=wlanMeshRouteDestination, wlanMeshRouteEntry=wlanMeshRouteEntry, wlanIfaceApBridge=wlanIfaceApBridge, wlanMeshRoutesFlush=wlanMeshRoutesFlush, wlanIfacePacketBurst=wlanIfacePacketBurst, wlanMeshHWMPConfig=wlanMeshHWMPConfig, wlanStatsRxWepFailed=wlanStatsRxWepFailed, wlanMeshNeighborFrequency=wlanMeshNeighborFrequency, wlanIfacePeerIdleTimer=wlanIfacePeerIdleTimer, wlanStatsAMPDURxDropped=wlanStatsAMPDURxDropped, wlanIfaceOperatingMode=wlanIfaceOperatingMode, wlanMeshId=wlanMeshId, wlanIfacePeerAssociationId=wlanIfacePeerAssociationId, begemotWlan=begemotWlan, wlanMeshHWMPProxy=wlanMeshHWMPProxy, wlanHWMPRootTimeout=wlanHWMPRootTimeout, wlanIfaceDot11d=wlanIfaceDot11d, wlanStatsTxDiscardBadState=wlanStatsTxDiscardBadState, wlanMeshRouteStatus=wlanMeshRouteStatus, wlanWepDefTxKey=wlanWepDefTxKey, WlanMgmtReasonCode=WlanMgmtReasonCode, wlanScanResultCapabilities=wlanScanResultCapabilities, wlanScanConfigStatus=wlanScanConfigStatus, wlanIfaceDot11h=wlanIfaceDot11h, wlanHWMPInterfaceTable=wlanHWMPInterfaceTable, wlanIfaceRoamingMode=wlanIfaceRoamingMode, wlanIfaceTdmaSlotCount=wlanIfaceTdmaSlotCount, wlanStatsCryptoKeyFailed=wlanStatsCryptoKeyFailed, wlanMACAccessControlMACEntry=wlanMACAccessControlMACEntry, wlanStatsAMPDURxBAR=wlanStatsAMPDURxBAR, wlanHWMPRouteInactiveTimeout=wlanHWMPRouteInactiveTimeout, wlanStatsRxUnAuthorized=wlanStatsRxUnAuthorized, wlanStatsTxFragmentsCreated=wlanStatsTxFragmentsCreated, wlanIfaceChannelState=wlanIfaceChannelState, wlanStatsADDBADisabledReject=wlanStatsADDBADisabledReject, wlanLastDeauthReason=wlanLastDeauthReason, begemotWlanMeshRouting=begemotWlanMeshRouting, wlanIfacePeerAddress=wlanIfacePeerAddress, wlanIfaceName=wlanIfaceName, wlanMeshNeighborIdleTimer=wlanMeshNeighborIdleTimer, wlanStatsRxAuthFailed=wlanStatsRxAuthFailed, wlanIfacePeerVlanTag=wlanIfacePeerVlanTag, wlanIfaceChannelMaxRegPower=wlanIfaceChannelMaxRegPower, wlanStatsRxDefragFailed=wlanStatsRxDefragFailed, wlanWepKeySet=wlanWepKeySet, wlanIfaceFragmentThreshold=wlanIfaceFragmentThreshold, wlanMeshNeighborRxSignalStrength=wlanMeshNeighborRxSignalStrength, wlanIfaceWlanPrivacySubscribe=wlanIfaceWlanPrivacySubscribe, wlanStatsRxWepNoPrivacy=wlanStatsRxWepNoPrivacy, wlanStatsRxUnknownSubtype=wlanStatsRxUnknownSubtype, wlanWepKeyEntry=wlanWepKeyEntry, wlanStatsRxDiscardACL=wlanStatsRxDiscardACL, wlanIfaceBgScan=wlanIfaceBgScan, wlanStatsADDBANoRequest=wlanStatsADDBANoRequest, wlanWepKeyHash=wlanWepKeyHash, wlanIfaceDynamicWds=wlanIfaceDynamicWds, wlanScanMaxChannelDwellTime=wlanScanMaxChannelDwellTime, wlanHWMPRootMode=wlanHWMPRootMode, wlanStatsRxAssocCapMismatch=wlanStatsRxAssocCapMismatch, wlanMACAccessControlMACStatus=wlanMACAccessControlMACStatus, wlanStatsRxElemTooSmall=wlanStatsRxElemTooSmall, wlanStatsAMPDUStopped=wlanStatsAMPDUStopped, wlanMeshInterface=wlanMeshInterface, wlanStatsRxCCMPFailedMIC=wlanStatsRxCCMPFailedMIC, wlanIfacePeerRxSequenceNo=wlanIfacePeerRxSequenceNo, wlanIfaceDturbo=wlanIfaceDturbo, wlanLastDissasocReason=wlanLastDissasocReason, wlanMeshPeeringEnabled=wlanMeshPeeringEnabled, wlanMeshRoutingConfig=wlanMeshRoutingConfig, wlanIfaceFastFrames=wlanIfaceFastFrames, wlanHWMPTargetOnlyBit=wlanHWMPTargetOnlyBit, wlanIfacePeerFrequency=wlanIfacePeerFrequency, wlanStatsTxFragmented=wlanStatsTxFragmented, wlanIfaceDot11nAmsdu=wlanIfaceDot11nAmsdu, begemotWlanInterface=begemotWlanInterface, wlanIfaceTdmaBeaconInterval=wlanIfaceTdmaBeaconInterval, wlanStatsBadAidPSPoll=wlanStatsBadAidPSPoll, wlanIfaceChannelFrequency=wlanIfaceChannelFrequency, wlanStatsRxAMSDUSplitError=wlanStatsRxAMSDUSplitError, wlanStatsSwCryptoTKIPEnMIC=wlanStatsSwCryptoTKIPEnMIC, wlanStatsTxAMSDUEncap=wlanStatsTxAMSDUEncap, wlanIfacePeerEntry=wlanIfacePeerEntry, wlanIfacePeerRxSignalStrength=wlanIfacePeerRxSignalStrength)
