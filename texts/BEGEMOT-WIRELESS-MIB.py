...
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanIfRoamParamsTable=wlanIfRoamParamsTable, wlanStatsTxFailedNoBuf=wlanStatsTxFailedNoBuf, wlanStatsRxDiscardMcastEcho=wlanStatsRxDiscardMcastEcho, wlanIfaceIndex=wlanIfaceIndex, wlanIfaceOperatingMode=wlanIfaceOperatingMode, wlanMeshInterfaceEntry=wlanMeshInterfaceEntry, wlanHWMPRouteInactiveTimeout=wlanHWMPRouteInactiveTimeout, wlanStatsIBSSCapMismatch=wlanStatsIBSSCapMismatch, wlanWepKeyEntry=wlanWepKeyEntry, begemotWlanNotifications=begemotWlanNotifications, wlanIfacePeerTxPower=wlanIfacePeerTxPower, begemotWlanWep=begemotWlanWep, wlanIfTxParamsTable=wlanIfTxParamsTable, wlanMeshNeighborFrequency=wlanMeshNeighborFrequency, wlanMeshNeighborRxSignalStrength=wlanMeshNeighborRxSignalStrength, wlanScanConfigStatus=wlanScanConfigStatus, wlanStatsRxWrongDir=wlanStatsRxWrongDir, wlanMeshRouteHops=wlanMeshRouteHops, wlanIfaceChannelFrequency=wlanIfaceChannelFrequency, wlanStatsTxControlFrames=wlanStatsTxControlFrames, wlanWepKeyLength=wlanWepKeyLength, wlanIfParentCryptoCapabilities=wlanIfParentCryptoCapabilities, wlanStatsRxAuthFailed=wlanStatsRxAuthFailed, wlanStatsRxElemTooBig=wlanStatsRxElemTooBig, wlanMeshNoFwdTooShort=wlanMeshNoFwdTooShort, wlanStatsCryptoDeleteKeyFailed=wlanStatsCryptoDeleteKeyFailed, wlanIfaceDot11gProtMode=wlanIfaceDot11gProtMode, wlanIfaceDtimPeriod=wlanIfaceDtimPeriod, wlanInterfaceEntry=wlanInterfaceEntry, wlanScanFlags=wlanScanFlags, wlanStatsRxActionMgmt=wlanStatsRxActionMgmt, wlanStatsRxWepNoPrivacy=wlanStatsRxWepNoPrivacy, wlanIfaceRegDomain=wlanIfaceRegDomain, wlanMeshProtoHWMP=wlanMeshProtoHWMP, begemotWlanMACAccessControl=begemotWlanMACAccessControl, wlanStatsCryptoCipherKeyRejected=wlanStatsCryptoCipherKeyRejected, wlanStatsRxElemTooSmall=wlanStatsRxElemTooSmall, wlanIfaceDot11nSMPSMode=wlanIfaceDot11nSMPSMode, wlanParentIfName=wlanParentIfName, wlanMeshStatsEntry=wlanMeshStatsEntry, wlanWepInterfaceTable=wlanWepInterfaceTable, wlanIfaceBeaconInterval=wlanIfaceBeaconInterval, wlanIfaceDot11gPureMode=wlanIfaceDot11gPureMode, wlanStatsAMPDUStopFailed=wlanStatsAMPDUStopFailed, wlanIfaceDesiredBssid=wlanIfaceDesiredBssid, wlanIfParentEntry=wlanIfParentEntry, wlanStatsRxElemMissing=wlanStatsRxElemMissing, wlanMeshInterfaceTable=wlanMeshInterfaceTable, wlanStatsAMPDUBadBAR=wlanStatsAMPDUBadBAR, wlanIfaceDot11nHTCompatible=wlanIfaceDot11nHTCompatible, wlanStatsRxDecapsulationFailed=wlanStatsRxDecapsulationFailed, wlanStatsReset=wlanStatsReset, begemotWlanInterface=begemotWlanInterface, wlanIfaceCountryCode=wlanIfaceCountryCode, wlanIfaceDot11nAmpduDensity=wlanIfaceDot11nAmpduDensity, wlanScanMaxChannelDwellTime=wlanScanMaxChannelDwellTime, wlanIfaceApBridge=wlanIfaceApBridge, wlanIfaceDot11nHighThroughput=wlanIfaceDot11nHighThroughput, wlanMeshRouteLifeTime=wlanMeshRouteLifeTime, wlanStatsSwCryptoWEP=wlanStatsSwCryptoWEP, wlanStatsAMPDURxReorder=wlanStatsAMPDURxReorder, wlanIfacePeerFrequency=wlanIfacePeerFrequency, wlanWepInterfaceEntry=wlanWepInterfaceEntry, wlanMACAccessControlNacl=wlanMACAccessControlNacl, wlanStatsSwCryptoTKIP=wlanStatsSwCryptoTKIP, wlanMeshMaxRetries=wlanMeshMaxRetries, begemotWlanScanning=begemotWlanScanning, wlanIfRoamParamsEntry=wlanIfRoamParamsEntry, wlanMACAccessControlMACTable=wlanMACAccessControlMACTable, wlanIfaceDturbo=wlanIfaceDturbo, WlanMgmtMeshReasonCode=WlanMgmtMeshReasonCode, wlanStatsADDBADisabledReject=wlanStatsADDBADisabledReject, WlanMgmtReasonCode=WlanMgmtReasonCode, wlanIfacePeerCapabilities=wlanIfacePeerCapabilities, wlanIfaceDesiredChannel=wlanIfaceDesiredChannel, wlanMeshRouteMetric=wlanMeshRouteMetric, wlanStatsAMPDURxCopied=wlanStatsAMPDURxCopied, wlanStatsTxUnknownMgmt=wlanStatsTxUnknownMgmt, wlanStatsUnassocStaPSPoll=wlanStatsUnassocStaPSPoll, wlanIfacePeerRxSequenceNo=wlanIfacePeerRxSequenceNo, wlanIfaceFlags=wlanIfaceFlags, wlanStatsRxCCMPBadFormat=wlanStatsRxCCMPBadFormat, wlanMeshNeighborIdleTimer=wlanMeshNeighborIdleTimer, wlanMeshHWMPTxRootPREQ=wlanMeshHWMPTxRootPREQ, wlanWepKeyTable=wlanWepKeyTable, wlanMeshForwardingEnabled=wlanMeshForwardingEnabled, wlanStatsRxTKIPBadFormat=wlanStatsRxTKIPBadFormat, wlanStatsAMPDURxBAR=wlanStatsAMPDURxBAR, wlanIfaceDot11nAmsdu=wlanIfaceDot11nAmsdu, wlanIfacePeerVlanTag=wlanIfacePeerVlanTag, wlanStatsAMPDUStopped=wlanStatsAMPDUStopped, wlanMeshNeighborLocalId=wlanMeshNeighborLocalId, wlanHWMPInterfaceTable=wlanHWMPInterfaceTable, wlanIfParentTable=wlanIfParentTable, wlanStatsRxDiscardBadStates=wlanStatsRxDiscardBadStates, wlanStatsTxDiscardBadState=wlanStatsTxDiscardBadState, wlanScanResultBssid=wlanScanResultBssid, wlanIfacePeerAddress=wlanIfacePeerAddress, wlanStatsTxFailedNoNode=wlanStatsTxFailedNoNode, WlanPeerCapabilityFlags=WlanPeerCapabilityFlags, wlanScanConfigTable=wlanScanConfigTable, wlanHWMPRootMode=wlanHWMPRootMode, wlanIfaceChannelFlags=wlanIfaceChannelFlags, wlanMeshNeighborTxSequenceNo=wlanMeshNeighborTxSequenceNo, wlanStatsAMPDUMovedBAR=wlanStatsAMPDUMovedBAR, wlanStatsRxBadVersion=wlanStatsRxBadVersion, wlanHWMPRootInterval=wlanHWMPRootInterval, wlanStatsRxUnAuthorized=wlanStatsRxUnAuthorized, wlanStatsADDBABadToken=wlanStatsADDBABadToken, wlanStatsRxFFTooShort=wlanStatsRxFFTooShort, wlanMeshRoutesFlush=wlanMeshRoutesFlush, wlanMeshDroppedNoProxy=wlanMeshDroppedNoProxy, wlanStatsRxWepFailed=wlanStatsRxWepFailed, WlanIfPhyMode=WlanIfPhyMode, wlanStatsRxDiscardMgmt=wlanStatsRxDiscardMgmt, wlanStatsCryptoAttachFailed=wlanStatsCryptoAttachFailed, wlanMeshHWMPConfig=wlanMeshHWMPConfig, wlanStatsRxWepUnencrypted=wlanStatsRxWepUnencrypted, wlanMeshRouteNextHop=wlanMeshRouteNextHop, wlanStatsBadAidPSPoll=wlanStatsBadAidPSPoll, wlanIfaceTxPower=wlanIfaceTxPower, wlanHWMPMaxHops=wlanHWMPMaxHops, wlanMeshStatsTable=wlanMeshStatsTable, wlanHWMPRootAnnounceInterval=wlanHWMPRootAnnounceInterval, wlanMeshDroppedMisaligned=wlanMeshDroppedMisaligned, wlanIfacePeerRxSignalStrength=wlanIfacePeerRxSignalStrength, wlanIfParentHTCapabilities=wlanIfParentHTCapabilities, wlanStatsActiveScans=wlanStatsActiveScans, wlanMeshRouteTable=wlanMeshRouteTable, wlanStatsCryptoKeyFailed=wlanStatsCryptoKeyFailed, wlanStatsRxDemicFailed=wlanStatsRxDemicFailed, wlanStatsCryptoNoKey=wlanStatsCryptoNoKey, wlanMeshConfirmTimeout=wlanMeshConfirmTimeout, wlanStatsAMPDURxAge=wlanStatsAMPDURxAge, wlanScanResultsTable=wlanScanResultsTable, wlanMeshHWMPStatsEntry=wlanMeshHWMPStatsEntry, wlanIfaceChannelIeeeId=wlanIfaceChannelIeeeId, wlanIfTxUnicastRate=wlanIfTxUnicastRate, wlanStatsRxAMSDUDecap=wlanStatsRxAMSDUDecap, wlanStatsCryptoNoMem=wlanStatsCryptoNoMem, wlanStatsTimeoutInactivity=wlanStatsTimeoutInactivity, wlanStatsRxAssocNoAuth=wlanStatsRxAssocNoAuth, wlanMACAccessControlEntry=wlanMACAccessControlEntry, wlanIfRoamRxSignalStrength=wlanIfRoamRxSignalStrength, wlanIfaceDot11nRIFS=wlanIfaceDot11nRIFS, begemotWlan=begemotWlan, wlanScanResultCapabilities=wlanScanResultCapabilities, wlanIfaceInactivityProccess=wlanIfaceInactivityProccess, wlanInterfaceTable=wlanInterfaceTable, wlanStatsDwdsMcastDiscard=wlanStatsDwdsMcastDiscard, wlanIfacePeerAssociationId=wlanIfacePeerAssociationId, wlanStatsCryptoTKIPCM=wlanStatsCryptoTKIPCM, wlanHWMPRootTimeout=wlanHWMPRootTimeout, begemotWlanStatistics=begemotWlanStatistics, wlanIfaceDot11nHTProtMode=wlanIfaceDot11nHTProtMode, wlanIfaceFragmentThreshold=wlanIfaceFragmentThreshold, wlanMeshNeighborCurrentTXRate=wlanMeshNeighborCurrentTXRate, wlanStatsHTAssocRateMismatch=wlanStatsHTAssocRateMismatch, wlanIfaceName=wlanIfaceName, wlanIfaceRTSThreshold=wlanIfaceRTSThreshold, wlanStatsFFFlushed=wlanStatsFFFlushed, wlanMACAccessControlMACEntry=wlanMACAccessControlMACEntry, wlanStatsRxUnknownSubtype=wlanStatsRxUnknownSubtype, wlanIfTxMcastRate=wlanIfTxMcastRate, wlanStatsRxTooShort=wlanStatsRxTooShort, wlanIfaceBssid=wlanIfaceBssid, wlanScanMinChannelDwellTime=wlanScanMinChannelDwellTime, wlanStatsRxDefragFailed=wlanStatsRxDefragFailed, wlanScanResultBeaconInterval=wlanScanResultBeaconInterval, wlanIfaceChannelEntry=wlanIfaceChannelEntry, wlanStatsRxAssocWrongBssid=wlanStatsRxAssocWrongBssid, wlanStatsRxDiscardACL=wlanStatsRxDiscardACL, wlanStatsRxRateSetTooBig=wlanStatsRxRateSetTooBig, wlanScanResultNoise=wlanScanResultNoise, wlanStatsSwCryptoTKIPEnMIC=wlanStatsSwCryptoTKIPEnMIC, wlanIfaceStatus=wlanIfaceStatus, wlanMeshRoutingConfig=wlanMeshRoutingConfig, wlanStatsAMPDURexmt=wlanStatsAMPDURexmt, wlanIfaceChannelMaxTxPower=wlanIfaceChannelMaxTxPower, wlanIfTxMaxRetryCount=wlanIfTxMaxRetryCount, wlanScanResultID=wlanScanResultID, wlanIfaceDot11nAmsduLimit=wlanIfaceDot11nAmsduLimit, wlanMeshRouteEntry=wlanMeshRouteEntry, wlanStatsAMPDURxOor=wlanStatsAMPDURxOor, wlanWepMode=wlanWepMode, wlanScanResultsEntry=wlanScanResultsEntry, wlanStatsRxBadWpaIE=wlanStatsRxBadWpaIE, wlanIfaceChannelState=wlanIfaceChannelState, wlanIfacePacketBurst=wlanIfacePacketBurst, wlanIfTxPhyMode=wlanIfTxPhyMode, wlanStatsRxSsidMismatch=wlanStatsRxSsidMismatch, wlanStatsTxAMSDUEncap=wlanStatsTxAMSDUEncap, wlanIfaceBgScanInterval=wlanIfaceBgScanInterval, wlanIfTxParamsEntry=wlanIfTxParamsEntry, wlanStatsRxDiscardedDups=wlanStatsRxDiscardedDups, wlanStatsRxBadBintval=wlanStatsRxBadBintval, wlanIfaceState=wlanIfaceState, wlanHWMPPathLifetime=wlanHWMPPathLifetime, wlanHWMPReplyForwardBit=wlanHWMPReplyForwardBit, wlanIfaceHideSsid=wlanIfaceHideSsid, wlanIfaceDot11nShortGI=wlanIfaceDot11nShortGI, wlanMACAccessControlTable=wlanMACAccessControlTable, wlanIfaceDot11nAmpdu=wlanIfaceDot11nAmpdu, wlanMeshHWMPStatistics=wlanMeshHWMPStatistics, wlanIfacePeerTable=wlanIfacePeerTable, wlanStatsTxFFEncap=wlanStatsTxFFEncap, wlanStatsRxMgmt=wlanStatsRxMgmt, wlanIfaceLocalAddress=wlanIfaceLocalAddress, wlanMeshRouteFlags=wlanMeshRouteFlags, wlanMeshHWMPTxRootRANN=wlanMeshHWMPTxRootRANN, wlanMeshDroppedNoLink=wlanMeshDroppedNoLink, wlanStatsRxAssocNoRateMatch=wlanStatsRxAssocNoRateMatch, wlanIfaceDynamicWds=wlanIfaceDynamicWds, wlanStatsPassiveScans=wlanStatsPassiveScans, wlanStatsRxFFDecap=wlanStatsRxFFDecap, wlanMACAccessControlMAC=wlanMACAccessControlMAC, wlanIfaceDot11nPureMode=wlanIfaceDot11nPureMode, wlanMACAccessControlFlush=wlanMACAccessControlFlush, begemotWlanMeshRouting=begemotWlanMeshRouting, wlanMeshHWMPProxy=wlanMeshHWMPProxy, wlanMeshRouteStatus=wlanMeshRouteStatus, wlanHWMPTargetOnlyBit=wlanHWMPTargetOnlyBit, wlanIfaceBeaconMissedThreshold=wlanIfaceBeaconMissedThreshold, wlanMeshMetric=wlanMeshMetric, wlanMeshInterface=wlanMeshInterface, wlanStatsRxFFSplitError=wlanStatsRxFFSplitError, wlanScanConfigEntry=wlanScanConfigEntry, wlanMeshRouteLastMseq=wlanMeshRouteLastMseq, wlanMeshRouteDestination=wlanMeshRouteDestination, wlanMeshRoute=wlanMeshRoute, wlanIfaceChannelTable=wlanIfaceChannelTable, wlanStatsRxCCMPSeqViolation=wlanStatsRxCCMPSeqViolation, wlanMeshNeighborTable=wlanMeshNeighborTable, wlanStatsADDBABadPolicy=wlanStatsADDBABadPolicy, wlanIfRoamTxRateThreshold=wlanIfRoamTxRateThreshold, wlanIfaceChannelHTExtension=wlanIfaceChannelHTExtension, wlanScanDuration=wlanScanDuration, wlanIfaceWlanPrivacySubscribe=wlanIfaceWlanPrivacySubscribe, wlanLastAuthFailReason=wlanLastAuthFailReason, wlanStatsRxDropped=wlanStatsRxDropped, WlanMgmtStatusCode=WlanMgmtStatusCode, wlanIfaceDot11nAmpduLimit=wlanIfaceDot11nAmpduLimit, wlanIfaceChannelMaxAntennaGain=wlanIfaceChannelMaxAntennaGain, wlanIfaceConfigEntry=wlanIfaceConfigEntry, WlanIfaceDot11nPduType=WlanIfaceDot11nPduType, wlanStatsRxAMSDUSplitError=wlanStatsRxAMSDUSplitError, wlanIfaceTdmaSlot=wlanIfaceTdmaSlot, wlanIfaceDot11d=wlanIfaceDot11d, wlanIfaceDynamicFreqSelection=wlanIfaceDynamicFreqSelection, wlanStatsRxWrongBssid=wlanStatsRxWrongBssid, wlanMeshNoFwdDisabled=wlanMeshNoFwdDisabled, wlanStatsRxTKIPSeqViolation=wlanStatsRxTKIPSeqViolation, wlanIfaceFastFrames=wlanIfaceFastFrames, wlanStatsAMPDUMoved=wlanStatsAMPDUMoved)
mibBuilder.exportSymbols("BEGEMOT-WIRELESS-MIB", wlanStatsRxTKIPFailedMIC=wlanStatsRxTKIPFailedMIC, wlanStatsAMPDUOowBar=wlanStatsAMPDUOowBar, wlanStatsSwCryptoTKIPDeMIC=wlanStatsSwCryptoTKIPDeMIC, wlanIfaceBgScan=wlanIfaceBgScan, wlanScanResultRate=wlanScanResultRate, wlanIfacePeerTxSequenceNo=wlanIfacePeerTxSequenceNo, wlanStatsTxFailedNoAssoc=wlanStatsTxFailedNoAssoc, PYSNMP_MODULE_ID=begemotWlan, wlanWepDefTxKey=wlanWepDefTxKey, wlanIfaceChannelMaxRegPower=wlanIfaceChannelMaxRegPower, wlanStatsRxAssocCapMismatch=wlanStatsRxAssocCapMismatch, wlanStatsRxAuthCM=wlanStatsRxAuthCM, wlanStatsHTAssocRejectNoHT=wlanStatsHTAssocRejectNoHT, wlanIfacePeerCurrentTXRate=wlanIfacePeerCurrentTXRate, wlanIfaceChannelMinTxPower=wlanIfaceChannelMinTxPower, wlanIfacePowerSave=wlanIfacePowerSave, wlanMeshStatistics=wlanMeshStatistics, wlanMeshTTL=wlanMeshTTL, wlanStatsTxFragmented=wlanStatsTxFragmented, wlanStatsRxFailedNoBuf=wlanStatsRxFailedNoBuf, wlanIfacePeerFlags=wlanIfacePeerFlags, wlanIfRoamPhyMode=wlanIfRoamPhyMode, wlanStatsADDBANoRequest=wlanStatsADDBANoRequest, wlanMACAccessControlMACStatus=wlanMACAccessControlMACStatus, wlanStatsCryptoUnknownCipher=wlanStatsCryptoUnknownCipher, wlanStatsTxFragmentsCreated=wlanStatsTxFragmentsCreated, wlanStatsRxChannelMismatch=wlanStatsRxChannelMismatch, wlanStatsRxCCMPFailedMIC=wlanStatsRxCCMPFailedMIC, wlanLastDeauthReason=wlanLastDeauthReason, wlanIfTxMgmtRate=wlanIfTxMgmtRate, wlanStatsAMPDURxDropped=wlanStatsAMPDURxDropped, wlanStatsRxBadKeyId=wlanStatsRxBadKeyId, wlanStatsTxBadCipher=wlanStatsTxBadCipher, wlanMeshDroppedBadAE=wlanMeshDroppedBadAE, wlanMeshId=wlanMeshId, wlanMeshNoFwdPathUnknown=wlanMeshNoFwdPathUnknown, wlanMeshHWMPWrongSeqNo=wlanMeshHWMPWrongSeqNo, wlanStatsAMPDURexmtFailed=wlanStatsAMPDURexmtFailed, wlanStatsEmptyPSPoll=wlanStatsEmptyPSPoll, wlanIfaceStatisticsEntry=wlanIfaceStatisticsEntry, wlanStatsBeaconMissedEvents=wlanStatsBeaconMissedEvents, wlanMeshNeighborAddress=wlanMeshNeighborAddress, wlanMeshPath=wlanMeshPath, wlanMeshNeighborRxSequenceNo=wlanMeshNeighborRxSequenceNo, wlanIfaceChannelId=wlanIfaceChannelId, wlanStatsRxAMSDUTooShort=wlanStatsRxAMSDUTooShort, wlanMeshHoldingTimeout=wlanMeshHoldingTimeout, wlanMeshNeighborPeerId=wlanMeshNeighborPeerId, wlanStatsSwCryptoCCMP=wlanStatsSwCryptoCCMP, wlanMeshPeeringEnabled=wlanMeshPeeringEnabled, wlanStatsRxFFBadHdr=wlanStatsRxFFBadHdr, wlanWepKeySet=wlanWepKeySet, wlanMeshRouteAddFailed=wlanMeshRouteAddFailed, wlanIfaceConfigTable=wlanIfaceConfigTable, wlanMeshHWMPStatsTable=wlanMeshHWMPStatsTable, wlanScanResultChannel=wlanScanResultChannel, wlanStatsRxControl=wlanStatsRxControl, wlanMACAccessControlPolicy=wlanMACAccessControlPolicy, wlanIfaceDot11h=wlanIfaceDot11h, wlanStatsRxDeauthenticate=wlanStatsRxDeauthenticate, wlanStatsRxDisassociate=wlanStatsRxDisassociate, wlanStatsRxDiscardNoAssoc=wlanStatsRxDiscardNoAssoc, wlanStatsTxClassifyFailed=wlanStatsTxClassifyFailed, wlanStatsTxNoDefKey=wlanStatsTxNoDefKey, wlanStatsRxElemUnknown=wlanStatsRxElemUnknown, wlanMeshRetryTimeout=wlanMeshRetryTimeout, wlanMeshDroppedBadSta=wlanMeshDroppedBadSta, wlanIfaceDesiredSsid=wlanIfaceDesiredSsid, WlanRegDomainCode=WlanRegDomainCode, wlanIfaceTdmaBeaconInterval=wlanIfaceTdmaBeaconInterval, wlanStatsRxBadAuthRequest=wlanStatsRxBadAuthRequest, wlanIfParentDriverCapabilities=wlanIfParentDriverCapabilities, wlanMeshNeighborPeerState=wlanMeshNeighborPeerState, wlanMeshRouteProtocols=wlanMeshRouteProtocols, wlanIfacePeerIdleTimer=wlanIfacePeerIdleTimer, wlanStatsHTAssocDowngrade=wlanStatsHTAssocDowngrade, wlanWepKeyHash=wlanWepKeyHash, wlanStatsRxAuthNotSupported=wlanStatsRxAuthNotSupported, wlanMeshNeighborEntry=wlanMeshNeighborEntry, wlanMeshHWMPInterface=wlanMeshHWMPInterface, wlanHWMPInterfaceEntry=wlanHWMPInterfaceEntry, wlanIfacePeerEntry=wlanIfacePeerEntry, wlanMeshNoFwdBuf=wlanMeshNoFwdBuf, wlanMeshNoFwdTtl=wlanMeshNoFwdTtl, wlanIfaceBgScanIdle=wlanIfaceBgScanIdle, wlanStatsScansBackground=wlanStatsScansBackground, wlanLastDissasocReason=wlanLastDissasocReason, wlanIfaceTdmaSlotCount=wlanIfaceTdmaSlotCount, wlanIfaceStatisticsTable=wlanIfaceStatisticsTable, wlanStatsRxTKIPFailedICV=wlanStatsRxTKIPFailedICV, wlanStatsRxBeacon=wlanStatsRxBeacon, wlanWepKeyStatus=wlanWepKeyStatus, wlanWepKeyID=wlanWepKeyID, wlanIfaceRoamingMode=wlanIfaceRoamingMode, wlanIfaceChannelType=wlanIfaceChannelType, wlanIfaceTdmaSlotLength=wlanIfaceTdmaSlotLength, wlanStatsCryptoEnMICFailed=wlanStatsCryptoEnMICFailed)
