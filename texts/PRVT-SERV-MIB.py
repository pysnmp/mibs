...
DisplayString, TextualConvention, RowStatus, TimeStamp, TruthValue, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue", "MacAddress")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpAdminStatus=sdpAdminStatus, sdpOperFlags=sdpOperFlags, sdpNextFreeId=sdpNextFreeId, sdpLdpEnabled=sdpLdpEnabled, serviceNumSdps=serviceNumSdps, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpPwActivate=sdpPwActivate, serviceLastMgmtChange=serviceLastMgmtChange, serviceVpnId=serviceVpnId, sdpGroupIdentifier=sdpGroupIdentifier, serviceVlanEtherType=serviceVlanEtherType, sapType=sapType, sapDeleted=sapDeleted, serviceRevertTimer=serviceRevertTimer, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpLabelSignaling=sdpLabelSignaling, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sapCreated=sapCreated, sapProfileName=sapProfileName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtServicesMIBObjects=prvtServicesMIBObjects, PYSNMP_MODULE_ID=prvtServicesMIB, sapLearnMode=sapLearnMode, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpDeleted=sdpDeleted, sapLearnEnable=sapLearnEnable, customerTable=customerTable, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpEntry=sdpEntry, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpLearnEnable=sdpLearnEnable, sdpTable=sdpTable, sapUntaggedMode=sapUntaggedMode, serviceType=serviceType, sdpRowStatus=sdpRowStatus, sdpDescription=sdpDescription, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, serviceMacAddressSdpId=serviceMacAddressSdpId, sapMacLearningProfileState=sapMacLearningProfileState, serviceCreated=serviceCreated, sdpMtu=sdpMtu, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sapRowStatus=sapRowStatus, customerEntry=customerEntry, sapAdminStatus=sapAdminStatus, customerRowStatus=customerRowStatus, customerPhone=customerPhone, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpCreated=sdpCreated, serviceEntry=serviceEntry, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceMtu=serviceMtu, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceMacAddressSapPortId=serviceMacAddressSapPortId, serviceDeleted=serviceDeleted, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sdpVCType=sdpVCType, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceId=serviceId, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceTable=serviceTable, sdpSecuredEnable=sdpSecuredEnable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, customerDeleted=customerDeleted, serviceOperStatus=serviceOperStatus, sdpPwPrecedence=sdpPwPrecedence, sdpSignalPwStatus=sdpSignalPwStatus, customerCreated=customerCreated, sapCurrentMacCount=sapCurrentMacCount, sapPortId=sapPortId, serviceCustName=serviceCustName, sdpOperStatus=sdpOperStatus, prvtServicesMIB=prvtServicesMIB, sdpBindVlanTag=sdpBindVlanTag, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceEnableSecureSaps=serviceEnableSecureSaps, sapOperStatus=sapOperStatus, serviceDescription=serviceDescription, sapTable=sapTable, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, customerContact=customerContact, sdpDelivery=sdpDelivery, serviceMacAddressSapEntry=serviceMacAddressSapEntry, serviceVlanAction=serviceVlanAction, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceAdminStatus=serviceAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, serviceRowStatus=serviceRowStatus, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sapLastMgmtChange=sapLastMgmtChange, sapEntry=sapEntry, sapOperFlags=sapOperFlags, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, customerName=customerName, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpOutInterface=sdpOutInterface, sdpType=sdpType, sdpId=sdpId, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sapDescription=sapDescription, sapEncapValue=sapEncapValue, sdpTransportTunnelName=sdpTransportTunnelName, serviceNumSaps=serviceNumSaps)
