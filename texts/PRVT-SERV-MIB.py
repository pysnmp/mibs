...
TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TNamedItem, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TNamedItem", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpNumEntries=sdpNumEntries, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSvcCompliance=prvtTMSvcCompliance, sapLearnMode=sapLearnMode, prvtSdpDeleted=prvtSdpDeleted, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtCustCreated=prvtCustCreated, custInfoTable=custInfoTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcVplsMode=svcVplsMode, prvtTMSvcGroups=prvtTMSvcGroups, sdpAdminStatus=sdpAdminStatus, prvtSvcStatusChanged=prvtSvcStatusChanged, svcNumEntries=svcNumEntries, custRowStatus=custRowStatus, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, ServObjName=ServObjName, sdpTransportTunnelName=sdpTransportTunnelName, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosCustName=sapIngQosCustName, sapNumEntries=sapNumEntries, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSdpCreated=prvtSdpCreated, TMEncapVal=TMEncapVal, svcNumSdps=svcNumSdps, sdpLabelSignaling=sdpLabelSignaling, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSvcCompliances=prvtTMSvcCompliances, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMServObjs=prvtTMServObjs, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMCustGroups=prvtTMCustGroups, prvtTMSdpCompliance=prvtTMSdpCompliance, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpOutInterface=sdpOutInterface, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSdpConformance=prvtTMSdpConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpLdpEnabled=sdpLdpEnabled, sdpOperStatus=sdpOperStatus, sapOperStatus=sapOperStatus, sapBaseInfoTable=sapBaseInfoTable, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtServicesMIB=prvtServicesMIB, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcCustName=svcCustName, sapLastMgmtChange=sapLastMgmtChange, prvtCustNotif=prvtCustNotif, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEgrQosCustName=sapEgrQosCustName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSvcCreated=prvtSvcCreated, prvtSvcDeleted=prvtSvcDeleted, custMultiServiceSiteTable=custMultiServiceSiteTable, svcOperStatus=svcOperStatus, prvtSapNotif=prvtSapNotif, prvtSvcNotif=prvtSvcNotif, svcId=svcId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, TSapIngQueueId=TSapIngQueueId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapBaseInfoEntry=sapBaseInfoEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapAdminStatus=sapAdminStatus, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcLastStatusChange=svcLastStatusChange, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpBindVlanTag=sdpBindVlanTag, custInfoEntry=custInfoEntry, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpInfoTable=sdpInfoTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, svcRowStatus=svcRowStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpDescription=sdpDescription, sdpMtu=sdpMtu, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpInfoEntry=sdpInfoEntry, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcType=svcType, svcDescription=svcDescription, svcRevertTimer=svcRevertTimer, sapOperFlags=sapOperFlags, sapDescription=sapDescription, prvtSdpTraps=prvtSdpTraps, sdpId=sdpId, ServType=ServType, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSapGroups=prvtTMSapGroups, ServiceOperStatus=ServiceOperStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpType=sdpType, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSapConformance=prvtTMSapConformance, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMTstpConformance=prvtTMTstpConformance, custIngQosSchedName=custIngQosSchedName, custNumEntries=custNumEntries, SdpIdType=SdpIdType, sapPortId=sapPortId, ServiceAdminStatus=ServiceAdminStatus, sdpRowStatus=sdpRowStatus, VpnId=VpnId, svcBaseInfoTable=svcBaseInfoTable, prvtTMSapObjs=prvtTMSapObjs, svcMtu=svcMtu, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpNextFreeId=sdpNextFreeId, prvtSdpStatusChanged=prvtSdpStatusChanged, custPhone=custPhone, sdpDelivery=sdpDelivery, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosSchedName=sapIngQosSchedName, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosQueueId=sapEgrQosQueueId, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtCustTraps=prvtCustTraps, svcBaseInfoEntry=svcBaseInfoEntry, sapEncapValue=sapEncapValue, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custContact=custContact, prvtTMSapCompliance=prvtTMSapCompliance, custName=custName, sdpLastStatusChange=sdpLastStatusChange, custLastMgmtChange=custLastMgmtChange, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueId=sapIngQosQueueId, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcVpnId=svcVpnId, sdpOperIsBackup=sdpOperIsBackup, prvtTMCustObjs=prvtTMCustObjs, prvtServNotifications=prvtServNotifications, sdpVCType=sdpVCType, prvtSapDeleted=prvtSapDeleted, prvtTMCustCompliance=prvtTMCustCompliance, custEgrQosSchedName=custEgrQosSchedName, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSapCompliances=prvtTMSapCompliances, sdpGroupIdentifier=sdpGroupIdentifier, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, ServObjDesc=ServObjDesc, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSapStatusChanged=prvtSapStatusChanged, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtCustDeleted=prvtCustDeleted, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcAdminStatus=svcAdminStatus, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcLastMgmtChange=svcLastMgmtChange, prvtTMServConformance=prvtTMServConformance, sapType=sapType, prvtTMCustConformance=prvtTMCustConformance, prvtSdpNotif=prvtSdpNotif, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSapCreated=prvtSapCreated, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSvcTraps=prvtSvcTraps, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSapTraps=prvtSapTraps, sapRowStatus=sapRowStatus)
