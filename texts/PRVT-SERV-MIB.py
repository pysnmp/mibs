...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSvcCreated=prvtSvcCreated, svcNumSdps=svcNumSdps, TSapEgrQueueId=TSapEgrQueueId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcRevertTimer=svcRevertTimer, prvtTMCustGroups=prvtTMCustGroups, prvtTMCustCompliances=prvtTMCustCompliances, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSvcObjs=prvtTMSvcObjs, ServObjName=ServObjName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapLastMgmtChange=sapLastMgmtChange, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSapTraps=prvtSapTraps, prvtTMSdpObjs=prvtTMSdpObjs, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, VpnId=VpnId, svcDescription=svcDescription, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcId=svcId, svcAdminStatus=svcAdminStatus, prvtSdpDeleted=prvtSdpDeleted, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtSapStatusChanged=prvtSapStatusChanged, custName=custName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcVpnId=svcVpnId, prvtTMCustCompliance=prvtTMCustCompliance, sapNumEntries=sapNumEntries, prvtSapCreated=prvtSapCreated, prvtTMServObjs=prvtTMServObjs, svcNumEntries=svcNumEntries, prvtSvcTraps=prvtSvcTraps, TSapIngQueueId=TSapIngQueueId, prvtSdpTraps=prvtSdpTraps, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSapObjs=prvtTMSapObjs, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapDescription=sapDescription, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosCustName=sapIngQosCustName, sdpNumEntries=sdpNumEntries, custInfoTable=custInfoTable, sdpId=sdpId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custNumEntries=custNumEntries, sdpType=sdpType, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSdpConformance=prvtTMSdpConformance, sdpVCType=sdpVCType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSvcDeleted=prvtSvcDeleted, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcLastMgmtChange=svcLastMgmtChange, prvtTMCustObjs=prvtTMCustObjs, sapEgressQosPolicyId=sapEgressQosPolicyId, custInfoEntry=custInfoEntry, svcCustName=svcCustName, svcVplsMode=svcVplsMode, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpOperFlags=sdpOperFlags, prvtSvcNotif=prvtSvcNotif, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcLastStatusChange=svcLastStatusChange, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpLastStatusChange=sdpLastStatusChange, sdpGroupIdentifier=sdpGroupIdentifier, prvtServicesMIB=prvtServicesMIB, sdpTransportTunnelName=sdpTransportTunnelName, sdpLastMgmtChange=sdpLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpLabelSignaling=sdpLabelSignaling, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapPortId=sapPortId, prvtTMSdpCompliance=prvtTMSdpCompliance, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtSapNotif=prvtSapNotif, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapAdminStatus=sapAdminStatus, prvtTMSapConformance=prvtTMSapConformance, sdpMtu=sdpMtu, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtCustCreated=prvtCustCreated, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpAdminStatus=sdpAdminStatus, svcType=svcType, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcVPLSUplinkTable=svcVPLSUplinkTable, svcMtu=svcMtu, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapEncapValue=sapEncapValue, prvtTMSvcGroups=prvtTMSvcGroups, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSapGroups=prvtTMSapGroups, custContact=custContact, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcRowStatus=svcRowStatus, prvtSdpCreated=prvtSdpCreated, prvtSdpNotif=prvtSdpNotif, SdpIdType=SdpIdType, prvtServNotifications=prvtServNotifications, sdpNextFreeId=sdpNextFreeId, custMultSvcSiteDescription=custMultSvcSiteDescription, svcBaseInfoTable=svcBaseInfoTable, ServiceAdminStatus=ServiceAdminStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcBaseInfoEntry=svcBaseInfoEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpOperIsBackup=sdpOperIsBackup, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapOperFlags=sapOperFlags, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, ServiceOperStatus=ServiceOperStatus, prvtCustDeleted=prvtCustDeleted, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapEgrQosQueueId=sapEgrQosQueueId, sdpInfoTable=sdpInfoTable, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapEgrQosCustName=sapEgrQosCustName, sdpBindVlanTag=sdpBindVlanTag, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpLdpEnabled=sdpLdpEnabled, ServType=ServType, prvtTMServConformance=prvtTMServConformance, sdpOutInterface=sdpOutInterface, sapIngQosSchedName=sapIngQosSchedName, custRowStatus=custRowStatus, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpRowStatus=sdpRowStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custPhone=custPhone, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sdpInfoEntry=sdpInfoEntry, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, TMEncapVal=TMEncapVal, sapLearnMode=sapLearnMode, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSapDeleted=prvtSapDeleted, prvtCustTraps=prvtCustTraps, custMultiServiceSiteTable=custMultiServiceSiteTable, custEgrQosSchedName=custEgrQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapRowStatus=sapRowStatus, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosQueueId=sapIngQosQueueId, sapOperStatus=sapOperStatus, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpDelivery=sdpDelivery, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapBaseInfoTable=sapBaseInfoTable, ServObjDesc=ServObjDesc, prvtSdpStatusChanged=prvtSdpStatusChanged, custLastMgmtChange=custLastMgmtChange, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcOperStatus=svcOperStatus, svcEnableSecureSaps=svcEnableSecureSaps, sapType=sapType, sapBaseInfoEntry=sapBaseInfoEntry, sdpAdminIsBackup=sdpAdminIsBackup, sdpDescription=sdpDescription, svcNumSaps=svcNumSaps, custIngQosSchedName=custIngQosSchedName, prvtTMCustConformance=prvtTMCustConformance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry)
