...
TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem, serviceAccessSwitch, TNetworkPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcDescription=svcDescription, sapOperStatus=sapOperStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMCustCompliance=prvtTMCustCompliance, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtSdpStatusChanged=prvtSdpStatusChanged, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapLearnMode=sapLearnMode, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custLastMgmtChange=custLastMgmtChange, svcLastStatusChange=svcLastStatusChange, sapEncapValue=sapEncapValue, sdpLastStatusChange=sdpLastStatusChange, sdpNumEntries=sdpNumEntries, prvtSvcDeleted=prvtSvcDeleted, sapNumEntries=sapNumEntries, svcNumSaps=svcNumSaps, svcVpnId=svcVpnId, sapPortId=sapPortId, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, TMEncapVal=TMEncapVal, prvtSdpCreated=prvtSdpCreated, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtServNotifications=prvtServNotifications, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpRowStatus=sdpRowStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpVCType=sdpVCType, svcOperStatus=svcOperStatus, sdpId=sdpId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custContact=custContact, sdpDelivery=sdpDelivery, svcMtu=svcMtu, sdpOperIsBackup=sdpOperIsBackup, prvtTMSvcCompliance=prvtTMSvcCompliance, SdpIdType=SdpIdType, sdpAdminIngressLabel=sdpAdminIngressLabel, svcType=svcType, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, svcVplsMode=svcVplsMode, prvtTMCustObjs=prvtTMCustObjs, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMTstpConformance=prvtTMTstpConformance, prvtCustNotif=prvtCustNotif, sapEgrQosQueueId=sapEgrQosQueueId, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSapObjs=prvtTMSapObjs, prvtSvcNotif=prvtSvcNotif, sdpLabelSignaling=sdpLabelSignaling, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpLdpEnabled=sdpLdpEnabled, custIngQosSchedName=custIngQosSchedName, sapOperFlags=sapOperFlags, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custName=custName, custMultSvcSiteName=custMultSvcSiteName, svcNumEntries=svcNumEntries, sapRowStatus=sapRowStatus, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSdpConformance=prvtTMSdpConformance, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosQueueId=sapIngQosQueueId, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcNumSdps=svcNumSdps, prvtSdpDeleted=prvtSdpDeleted, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcAdminStatus=svcAdminStatus, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, TSapIngQueueId=TSapIngQueueId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpOperFlags=sdpOperFlags, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMCustCompliances=prvtTMCustCompliances, prvtSapTraps=prvtSapTraps, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custMultSvcSiteDescription=custMultSvcSiteDescription, PYSNMP_MODULE_ID=prvtServicesMIB, TSapEgrQueueId=TSapEgrQueueId, prvtTMSdpObjs=prvtTMSdpObjs, ServObjName=ServObjName, prvtTMCustGroups=prvtTMCustGroups, ServiceAdminStatus=ServiceAdminStatus, sdpAdminIsBackup=sdpAdminIsBackup, sapAdminStatus=sapAdminStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcLastMgmtChange=svcLastMgmtChange, sdpTransportTunnelName=sdpTransportTunnelName, sdpInfoEntry=sdpInfoEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtSapCreated=prvtSapCreated, custPhone=custPhone, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosCustName=sapEgrQosCustName, sdpBindVlanTag=sdpBindVlanTag, svcRevertTimer=svcRevertTimer, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtCustDeleted=prvtCustDeleted, prvtCustTraps=prvtCustTraps, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosSchedName=custEgrQosSchedName, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtSvcCreated=prvtSvcCreated, sdpNextFreeId=sdpNextFreeId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMSapConformance=prvtTMSapConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSvcCompliances=prvtTMSvcCompliances, ServObjDesc=ServObjDesc, svcBaseInfoTable=svcBaseInfoTable, sapEgrQosSchedCustName=sapEgrQosSchedCustName, VpnId=VpnId, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpLastMgmtChange=sdpLastMgmtChange, sdpGroupIdentifier=sdpGroupIdentifier, sdpType=sdpType, prvtCustCreated=prvtCustCreated, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpOperStatus=sdpOperStatus, svcId=svcId, custInfoEntry=custInfoEntry, sapIngQosCustName=sapIngQosCustName, sapType=sapType, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtSapNotif=prvtSapNotif, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpInfoTable=sdpInfoTable, sdpOutInterface=sdpOutInterface, prvtTMSvcConformance=prvtTMSvcConformance, custInfoTable=custInfoTable, sdpAdminStatus=sdpAdminStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSdpTraps=prvtSdpTraps, prvtTMSapCompliance=prvtTMSapCompliance, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMServConformance=prvtTMServConformance, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtSapDeleted=prvtSapDeleted, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMCustConformance=prvtTMCustConformance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSvcObjs=prvtTMSvcObjs, ServiceOperStatus=ServiceOperStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMServObjs=prvtTMServObjs, sapEgressQosPolicyId=sapEgressQosPolicyId, svcRowStatus=svcRowStatus, prvtSapStatusChanged=prvtSapStatusChanged, custRowStatus=custRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpDescription=sdpDescription, ServType=ServType, prvtSdpNotif=prvtSdpNotif, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSapCompliances=prvtTMSapCompliances, svcEnableSecureSaps=svcEnableSecureSaps, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpMtu=sdpMtu, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtSvcTraps=prvtSvcTraps, sapIngQosSchedName=sapIngQosSchedName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtServicesMIB=prvtServicesMIB, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcCustName=svcCustName, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSdpGroups=prvtTMSdpGroups, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapDescription=sapDescription, custNumEntries=custNumEntries)
