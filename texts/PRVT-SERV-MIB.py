...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceTable=serviceTable, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sapUntaggedMode=sapUntaggedMode, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, serviceLastMgmtChange=serviceLastMgmtChange, customerContact=customerContact, sdpRowStatus=sdpRowStatus, serviceCreated=serviceCreated, sapMacLearningProfileState=sapMacLearningProfileState, sapTable=sapTable, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpOutInterface=sdpOutInterface, sapIngressQosPolicyId=sapIngressQosPolicyId, PYSNMP_MODULE_ID=prvtServicesMIB, sdpSecuredEnable=sdpSecuredEnable, sapLearnMode=sapLearnMode, sapOperStatus=sapOperStatus, sapDescription=sapDescription, sdpNextFreeId=sdpNextFreeId, sdpDescription=sdpDescription, sdpOperStatus=sdpOperStatus, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSdpTable=serviceMacAddressSdpTable, customerPhone=customerPhone, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sdpType=sdpType, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sapCreated=sapCreated, customerName=customerName, sapEncapValue=sapEncapValue, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapType=sapType, serviceVlanEtherType=serviceVlanEtherType, customerEntry=customerEntry, serviceVpnId=serviceVpnId, sapLastMgmtChange=sapLastMgmtChange, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sapProfileName=sapProfileName, serviceNumSdps=serviceNumSdps, sdpEntry=sdpEntry, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpPwActivate=sdpPwActivate, sdpDeleted=sdpDeleted, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, serviceDeleted=serviceDeleted, serviceEnableSecureSaps=serviceEnableSecureSaps, sapLearnEnable=sapLearnEnable, sapDeleted=sapDeleted, customerCreated=customerCreated, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpOperFlags=sdpOperFlags, serviceMacAddressSdpId=serviceMacAddressSdpId, serviceNumSaps=serviceNumSaps, sapCurrentMacCount=sapCurrentMacCount, sdpSignalPwStatus=sdpSignalPwStatus, serviceOperStatus=serviceOperStatus, serviceAdminStatus=serviceAdminStatus, sdpCreated=sdpCreated, serviceCustName=serviceCustName, serviceVlanAction=serviceVlanAction, sdpDelivery=sdpDelivery, sdpLearnEnable=sdpLearnEnable, sapOperFlags=sapOperFlags, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, customerRowStatus=customerRowStatus, sdpBindVlanTag=sdpBindVlanTag, sdpLdpEnabled=sdpLdpEnabled, prvtServicesMIB=prvtServicesMIB, sdpTransportTunnelName=sdpTransportTunnelName, sapPortId=sapPortId, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceRowStatus=serviceRowStatus, sdpId=sdpId, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpMtu=sdpMtu, serviceMacAddressSapEntry=serviceMacAddressSapEntry, serviceDescription=serviceDescription, sdpTable=sdpTable, sdpAdminStatus=sdpAdminStatus, customerTable=customerTable, serviceId=serviceId, customerDeleted=customerDeleted, sdpLastMgmtChange=sdpLastMgmtChange, sdpPwPrecedence=sdpPwPrecedence, serviceType=serviceType, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sapAdminStatus=sapAdminStatus, sdpGroupIdentifier=sdpGroupIdentifier, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, prvtServicesMIBObjects=prvtServicesMIBObjects, sdpVCType=sdpVCType, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpLabelSignaling=sdpLabelSignaling, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceEntry=serviceEntry, serviceRevertTimer=serviceRevertTimer, serviceMtu=serviceMtu, sapRowStatus=sapRowStatus, sapEntry=sapEntry)
